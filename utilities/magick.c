# 0 "utilities/magick.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utilities/magick.c"
# 44 "utilities/magick.c"
...
# 47 "utilities/magick.c" 2
# 62 "utilities/magick.c"
static int MagickMain(int argc,char **argv)
{
  ...
  const CommandInfo
    MagickCommands[] =
    {
      { ("magick"), sizeof("magick")-1, (MagickFalse), (MagickImageCommand) },
      { ("convert"), sizeof("convert")-1, (MagickFalse), (ConvertImageCommand) },
      { ("composite"), sizeof("composite")-1, (MagickFalse), (CompositeImageCommand) },
      { ("identify"), sizeof("identify")-1, (MagickTrue), (IdentifyImageCommand) },
      { ("animate"), sizeof("animate")-1, (MagickFalse), (AnimateImageCommand) },
      { ("compare"), sizeof("compare")-1, (MagickTrue), (CompareImagesCommand) },
      { ("conjure"), sizeof("conjure")-1, (MagickFalse), (ConjureImageCommand) },
      { ("display"), sizeof("display")-1, (MagickFalse), (DisplayImageCommand) },
      { ("import"), sizeof("import")-1, (MagickFalse), (ImportImageCommand) },
      { ("mogrify"), sizeof("mogrify")-1, (MagickFalse), (MogrifyImageCommand) },
      { ("montage"), sizeof("montage")-1, (MagickFalse), (MontageImageCommand) },
      { ("stream"), sizeof("stream")-1, (MagickFalse), (StreamImageCommand) }
    };
  ...
  metadata=(char *) 
# 150 "utilities/magick.c" 3 4
                   ((void *)0)
# 150 "utilities/magick.c"
                       ;
  status=MagickCommandGenesis(image_info,MagickCommands[i].command,argc,argv,
    MagickCommands[i].use_metadata ? &metadata : (char **) 
# 152 "utilities/magick.c" 3 4
                                                          ((void *)0)
# 152 "utilities/magick.c"
                                                              ,exception);
  if (metadata != (char *) 
# 153 "utilities/magick.c" 3 4
                          ((void *)0)
# 153 "utilities/magick.c"
                              )
    {
      (void) fputs(metadata,
# 155 "utilities/magick.c" 3 4
                           stdout
# 155 "utilities/magick.c"
                                 );
