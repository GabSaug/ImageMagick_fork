# 0 "MagickWand/animate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/animate.c"
# 43 "MagickWand/animate.c"
...
# 46 "MagickWand/animate.c" 2
# 1 "./MagickCore/animate-private.h" 1
# 22 "./MagickCore/animate-private.h"
...
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
  XRenderImage(Image *,const DrawInfo *,const PointInfo *,TypeMetric *,
    ExceptionInfo *);
# 23 "./MagickCore/animate-private.h" 2
...
# 48 "MagickWand/animate.c" 2
# 93 "MagickWand/animate.c"
static MagickBooleanType AnimateUsage(void)
{
  ...
  ListMagickVersion(
# 175 "MagickWand/animate.c" 3 4
                   stdout
# 175 "MagickWand/animate.c"
                         );
...
__attribute__ ((visibility ("default"))) MagickBooleanType AnimateImageCommand(ImageInfo *image_info,
  int argc,char **argv,char **wand_unused_metadata __attribute__((unused)),ExceptionInfo *exception)
{
# 240 "MagickWand/animate.c"
  char
    *resource_value,
    *server_name;
...
# 283 "MagickWand/animate.c" 3 4
 ((void) sizeof ((
# 283 "MagickWand/animate.c"
...
# 283 "MagickWand/animate.c" 3 4
 , "MagickWand/animate.c", 283, __extension__ __PRETTY_FUNCTION__); }))
# 283 "MagickWand/animate.c"
                                         ;
  
# 284 "MagickWand/animate.c" 3 4
 ((void) sizeof ((
# 284 "MagickWand/animate.c"
...
# 284 "MagickWand/animate.c" 3 4
 , "MagickWand/animate.c", 284, __extension__ __PRETTY_FUNCTION__); }))
# 284 "MagickWand/animate.c"
                                                     ;
  
# 285 "MagickWand/animate.c" 3 4
 ((void) sizeof ((
# 285 "MagickWand/animate.c"
...
# 285 "MagickWand/animate.c" 3 4
 , "MagickWand/animate.c", 285, __extension__ __PRETTY_FUNCTION__); }))
# 285 "MagickWand/animate.c"
                                            ;
  ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickWand/animate.c",__func__,(unsigned long) 288,"...");
  if (argc == 2)
    {
      option=argv[1];
      if ((LocaleCompare("version",option+1) == 0) ||
        ...
        {
          ListMagickVersion(
# 295 "MagickWand/animate.c" 3 4
                           stdout
# 295 "MagickWand/animate.c"
                                 );
          return(MagickTrue);
        }
    }
  ...
  ;
  display=(Display *) 
# 301 "MagickWand/animate.c" 3 4
                     ((void *)0)
# 301 "MagickWand/animate.c"
                         ;
  j=1;
  k=0;
  ...
  option=(char *) 
# 305 "MagickWand/animate.c" 3 4
                 ((void *)0)
# 305 "MagickWand/animate.c"
                     ;
  pend=MagickFalse;
  respect_parenthesis=MagickFalse;
  resource_database=(XrmDatabase) 
# 308 "MagickWand/animate.c" 3 4
                                 ((void *)0)
# 308 "MagickWand/animate.c"
                                     ;
  (void) memset(&resource_info,0,sizeof(XResourceInfo));
  server_name=(char *) 
# 310 "MagickWand/animate.c" 3 4
                      ((void *)0)
# 310 "MagickWand/animate.c"
                          ;
  status=MagickTrue;
  ...
  if (status == MagickFalse)
    { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 318,ResourceLimitError,"MemoryAllocationFailed","`%s'", image_info->filename); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 318 "MagickWand/animate.c" 3 4
   ((void *)0)
# 318 "MagickWand/animate.c"
    ...
    if (LocaleCompare("display",option+1) == 0)
      {
        ...
        i++;
        if (i == (ssize_t) argc)
          { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 335,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 335 "MagickWand/animate.c" 3 4
         ((void *)0)
# 335 "MagickWand/animate.c"
         ) { XCloseDisplay(display); display=(Display *) 
# 335 "MagickWand/animate.c" 3 4
         ((void *)0)
# 335 "MagickWand/animate.c"
    ...
    if ((LocaleCompare("help",option+1) == 0) ||
      ...
      {
        { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 341 "MagickWand/animate.c" 3 4
       ((void *)0)
# 341 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 341 "MagickWand/animate.c" 3 4
       ((void *)0)
# 341 "MagickWand/animate.c"
  ...
  if (display == (Display *) 
# 349 "MagickWand/animate.c" 3 4
                            ((void *)0)
# 349 "MagickWand/animate.c"
                                )
    { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 350,XServerError,"UnableToOpenXServer","`%s'", XDisplayName(server_name)); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 350 "MagickWand/animate.c" 3 4
   ((void *)0)
# 350 "MagickWand/animate.c"
   ) { XCloseDisplay(display); display=(Display *) 
# 350 "MagickWand/animate.c" 3 4
   ((void *)0)
# 350 "MagickWand/animate.c"
  ...
  image_info->density=XGetResourceInstance(resource_database,GetClientName(),
    "density",(char *) 
# 358 "MagickWand/animate.c" 3 4
                      ((void *)0)
# 358 "MagickWand/animate.c"
                          );
  if (image_info->density == (char *) 
# 359 "MagickWand/animate.c" 3 4
                                     ((void *)0)
# 359 "MagickWand/animate.c"
                                         )
  ...
  for (i=1; i <= (ssize_t) argc; i++)
  {
    if (i < (ssize_t) argc)
      ...
      if (image != (Image *) 
# 380 "MagickWand/animate.c" 3 4
                            ((void *)0)
# 380 "MagickWand/animate.c"
                                )
        break;
      else
        if (isatty(
# 383 "MagickWand/animate.c" 3 4
                  0
# 383 "MagickWand/animate.c"
                              ) != MagickFalse)
          option="logo:";
        else
          option="-";
...
# 389 "MagickWand/animate.c" 3 4
       ((void *)0)
# 389 "MagickWand/animate.c"
        ...
        if (k == 128)
          { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 391,OptionError,"ParenthesisNestedTooDeeply","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 391 "MagickWand/animate.c" 3 4
         ((void *)0)
# 391 "MagickWand/animate.c"
         ) { XCloseDisplay(display); display=(Display *) 
# 391 "MagickWand/animate.c" 3 4
         ((void *)0)
# 391 "MagickWand/animate.c"
    ...
    if (LocaleCompare(option,")") == 0)
      {
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 398 "MagickWand/animate.c" 3 4
       ((void *)0)
# 398 "MagickWand/animate.c"
        ...
        if (k == 0)
          { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 400,OptionError,"UnableToParseExpression","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 400 "MagickWand/animate.c" 3 4
         ((void *)0)
# 400 "MagickWand/animate.c"
         ) { XCloseDisplay(display); display=(Display *) 
# 400 "MagickWand/animate.c" 3 4
         ((void *)0)
# 400 "MagickWand/animate.c"
    ...
    if (IsCommandOption(option) == MagickFalse)
      {
        ...
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 415 "MagickWand/animate.c" 3 4
       ((void *)0)
# 415 "MagickWand/animate.c"
...
# 426 "MagickWand/animate.c" 3 4
                                                       ((void *)0)
# 426 "MagickWand/animate.c"
                                                           ) &&
          (exception->severity < ErrorException);
        if (images == (Image *) 
# 428 "MagickWand/animate.c" 3 4
                               ((void *)0)
# 428 "MagickWand/animate.c"
                                   )
          continue;
    ...
    pend=image != (Image *) 
# 433 "MagickWand/animate.c" 3 4
                           ((void *)0) 
# 433 "MagickWand/animate.c"
        ...
        if (LocaleCompare("alpha",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 447,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 447 "MagickWand/animate.c" 3 4
             ((void *)0)
# 447 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 447 "MagickWand/animate.c" 3 4
             ((void *)0)
# 447 "MagickWand/animate.c"
            ...
            type=ParseCommandOption(MagickAlphaChannelOptions,MagickFalse,
              argv[i]);
            if (type < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 451,OptionError,"UnrecognizedAlphaChannelOption","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 451 "MagickWand/animate.c" 3 4
             ((void *)0)
# 451 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 451 "MagickWand/animate.c" 3 4
             ((void *)0)
# 451 "MagickWand/animate.c"
        ...
        if (LocaleCompare("authenticate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 461,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 461 "MagickWand/animate.c" 3 4
             ((void *)0)
# 461 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 461 "MagickWand/animate.c" 3 4
             ((void *)0)
# 461 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 464,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 464 "MagickWand/animate.c" 3 4
       ((void *)0)
# 464 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 464 "MagickWand/animate.c" 3 4
       ((void *)0)
# 464 "MagickWand/animate.c"
        ...
        if (LocaleCompare("background",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 479,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 479 "MagickWand/animate.c" 3 4
             ((void *)0)
# 479 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 479 "MagickWand/animate.c" 3 4
             ((void *)0)
# 479 "MagickWand/animate.c"
        ...
        if (LocaleCompare("bordercolor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 489,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 489 "MagickWand/animate.c" 3 4
             ((void *)0)
# 489 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 489 "MagickWand/animate.c" 3 4
             ((void *)0)
# 489 "MagickWand/animate.c"
        ...
        if (LocaleCompare("borderwidth",option+1) == 0)
          {
            ...
            if ((i == (ssize_t) argc) || (IsGeometry(argv[i]) == MagickFalse))
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 500,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 500 "MagickWand/animate.c" 3 4
             ((void *)0)
# 500 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 500 "MagickWand/animate.c" 3 4
             ((void *)0)
# 500 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 505,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 505 "MagickWand/animate.c" 3 4
       ((void *)0)
# 505 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 505 "MagickWand/animate.c" 3 4
       ((void *)0)
# 505 "MagickWand/animate.c"
        ...
        if (LocaleCompare("cache",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 515,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 515 "MagickWand/animate.c" 3 4
             ((void *)0)
# 515 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 515 "MagickWand/animate.c" 3 4
             ((void *)0)
# 515 "MagickWand/animate.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 517,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 517 "MagickWand/animate.c" 3 4
             ((void *)0)
# 517 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 517 "MagickWand/animate.c" 3 4
             ((void *)0)
# 517 "MagickWand/animate.c"
        ...
        if (LocaleCompare("channel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 529,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 529 "MagickWand/animate.c" 3 4
             ((void *)0)
# 529 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 529 "MagickWand/animate.c" 3 4
             ((void *)0)
# 529 "MagickWand/animate.c"
            ...
            if (channel < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 532,OptionError,"UnrecognizedChannelType","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 532 "MagickWand/animate.c" 3 4
             ((void *)0)
# 532 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 532 "MagickWand/animate.c" 3 4
             ((void *)0)
# 532 "MagickWand/animate.c"
...
# 544 "MagickWand/animate.c" 3 4
                                         ((void *)0)
# 544 "MagickWand/animate.c"
                                             )
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 545,ImageError,"UnableToCloneImage","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 545 "MagickWand/animate.c" 3 4
             ((void *)0)
# 545 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 545 "MagickWand/animate.c" 3 4
             ((void *)0)
# 545 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 546 "MagickWand/animate.c" 3 4
           ((void *)0)
# 546 "MagickWand/animate.c"
           ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickFalse,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
            if (*option == '+')
            ...
            else
              {
                i++;
                if (i == (ssize_t) argc)
                  { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 553,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 553 "MagickWand/animate.c" 3 4
                 ((void *)0)
# 553 "MagickWand/animate.c"
                 ) { XCloseDisplay(display); display=(Display *) 
# 553 "MagickWand/animate.c" 3 4
                 ((void *)0)
# 553 "MagickWand/animate.c"
                ...
                if (IsSceneGeometry(argv[i],MagickFalse) == MagickFalse)
                  { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 555,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 555 "MagickWand/animate.c" 3 4
                 ((void *)0)
# 555 "MagickWand/animate.c"
                 ) { XCloseDisplay(display); display=(Display *) 
# 555 "MagickWand/animate.c" 3 4
                 ((void *)0)
# 555 "MagickWand/animate.c"
            ...
            if (clone_images == (Image *) 
# 558 "MagickWand/animate.c" 3 4
                                         ((void *)0)
# 558 "MagickWand/animate.c"
                                             )
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 559,OptionError,"NoSuchImage","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 559 "MagickWand/animate.c" 3 4
             ((void *)0)
# 559 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 559 "MagickWand/animate.c" 3 4
             ((void *)0)
# 559 "MagickWand/animate.c"
        ...
        if (LocaleCompare("colormap",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 572,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 572 "MagickWand/animate.c" 3 4
             ((void *)0)
# 572 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 572 "MagickWand/animate.c" 3 4
             ((void *)0)
# 572 "MagickWand/animate.c"
            ...
            if (resource_info.colormap == UndefinedColormap)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 579,OptionError,"UnrecognizedColormapType","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 579 "MagickWand/animate.c" 3 4
             ((void *)0)
# 579 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 579 "MagickWand/animate.c" 3 4
             ((void *)0)
# 579 "MagickWand/animate.c"
        ...
        if (LocaleCompare("colors",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 590,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 590 "MagickWand/animate.c" 3 4
             ((void *)0)
# 590 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 590 "MagickWand/animate.c" 3 4
             ((void *)0)
# 590 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 592,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 592 "MagickWand/animate.c" 3 4
             ((void *)0)
# 592 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 592 "MagickWand/animate.c" 3 4
             ((void *)0)
# 592 "MagickWand/animate.c"
        ...
        if (LocaleCompare("colorspace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 605,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 605 "MagickWand/animate.c" 3 4
             ((void *)0)
# 605 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 605 "MagickWand/animate.c" 3 4
             ((void *)0)
# 605 "MagickWand/animate.c"
            ...
            colorspace=ParseCommandOption(MagickColorspaceOptions,
              MagickFalse,argv[i]);
            if (colorspace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 609,OptionError,"UnrecognizedColorspace","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 609 "MagickWand/animate.c" 3 4
             ((void *)0)
# 609 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 609 "MagickWand/animate.c" 3 4
             ((void *)0)
# 609 "MagickWand/animate.c"
        ...
        if (LocaleCompare("crop",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 621,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 621 "MagickWand/animate.c" 3 4
             ((void *)0)
# 621 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 621 "MagickWand/animate.c" 3 4
             ((void *)0)
# 621 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 623,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 623 "MagickWand/animate.c" 3 4
             ((void *)0)
# 623 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 623 "MagickWand/animate.c" 3 4
             ((void *)0)
# 623 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 626,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 626 "MagickWand/animate.c" 3 4
       ((void *)0)
# 626 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 626 "MagickWand/animate.c" 3 4
       ((void *)0)
# 626 "MagickWand/animate.c"
        ...
        if (LocaleCompare("debug",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 639,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 639 "MagickWand/animate.c" 3 4
             ((void *)0)
# 639 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 639 "MagickWand/animate.c" 3 4
             ((void *)0)
# 639 "MagickWand/animate.c"
            ...
            if (event < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 642,OptionError,"UnrecognizedEventType","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 642 "MagickWand/animate.c" 3 4
             ((void *)0)
# 642 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 642 "MagickWand/animate.c" 3 4
             ((void *)0)
# 642 "MagickWand/animate.c"
        ...
        if (LocaleCompare("decipher",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 653,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 653 "MagickWand/animate.c" 3 4
             ((void *)0)
# 653 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 653 "MagickWand/animate.c" 3 4
             ((void *)0)
# 653 "MagickWand/animate.c"
        ...
        if (LocaleCompare("define",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 660,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 660 "MagickWand/animate.c" 3 4
             ((void *)0)
# 660 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 660 "MagickWand/animate.c" 3 4
             ((void *)0)
# 660 "MagickWand/animate.c"
...
# 667 "MagickWand/animate.c" 3 4
                                            ((void *)0)
# 667 "MagickWand/animate.c"
                                                )
                  { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 668,OptionError,"NoSuchOption","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 668 "MagickWand/animate.c" 3 4
                 ((void *)0)
# 668 "MagickWand/animate.c"
                 ) { XCloseDisplay(display); display=(Display *) 
# 668 "MagickWand/animate.c" 3 4
                 ((void *)0)
# 668 "MagickWand/animate.c"
        ...
        if (LocaleCompare("delay",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 679,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 679 "MagickWand/animate.c" 3 4
             ((void *)0)
# 679 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 679 "MagickWand/animate.c" 3 4
             ((void *)0)
# 679 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 681,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 681 "MagickWand/animate.c" 3 4
             ((void *)0)
# 681 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 681 "MagickWand/animate.c" 3 4
             ((void *)0)
# 681 "MagickWand/animate.c"
        ...
        if (LocaleCompare("density",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 690,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 690 "MagickWand/animate.c" 3 4
             ((void *)0)
# 690 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 690 "MagickWand/animate.c" 3 4
             ((void *)0)
# 690 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 692,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 692 "MagickWand/animate.c" 3 4
             ((void *)0)
# 692 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 692 "MagickWand/animate.c" 3 4
             ((void *)0)
# 692 "MagickWand/animate.c"
        ...
        if (LocaleCompare("depth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 701,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 701 "MagickWand/animate.c" 3 4
             ((void *)0)
# 701 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 701 "MagickWand/animate.c" 3 4
             ((void *)0)
# 701 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 703,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 703 "MagickWand/animate.c" 3 4
             ((void *)0)
# 703 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 703 "MagickWand/animate.c" 3 4
             ((void *)0)
# 703 "MagickWand/animate.c"
        ...
        if (LocaleCompare("display",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 712,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 712 "MagickWand/animate.c" 3 4
             ((void *)0)
# 712 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 712 "MagickWand/animate.c" 3 4
             ((void *)0)
# 712 "MagickWand/animate.c"
        ...
        if (LocaleCompare("dispose",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 724,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 724 "MagickWand/animate.c" 3 4
             ((void *)0)
# 724 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 724 "MagickWand/animate.c" 3 4
             ((void *)0)
# 724 "MagickWand/animate.c"
            ...
            if (dispose < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 727,OptionError,"UnrecognizedDisposeMethod","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 727 "MagickWand/animate.c" 3 4
             ((void *)0)
# 727 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 727 "MagickWand/animate.c" 3 4
             ((void *)0)
# 727 "MagickWand/animate.c"
        ...
        if (LocaleCompare("dither",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 741,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 741 "MagickWand/animate.c" 3 4
             ((void *)0)
# 741 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 741 "MagickWand/animate.c" 3 4
             ((void *)0)
# 741 "MagickWand/animate.c"
            ...
            if (method < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 744,OptionError,"UnrecognizedDitherMethod","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 744 "MagickWand/animate.c" 3 4
             ((void *)0)
# 744 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 744 "MagickWand/animate.c" 3 4
             ((void *)0)
# 744 "MagickWand/animate.c"
        ...
        if (LocaleCompare("duration",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 755,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 755 "MagickWand/animate.c" 3 4
             ((void *)0)
# 755 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 755 "MagickWand/animate.c" 3 4
             ((void *)0)
# 755 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 757,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 757 "MagickWand/animate.c" 3 4
             ((void *)0)
# 757 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 757 "MagickWand/animate.c" 3 4
             ((void *)0)
# 757 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 760,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 760 "MagickWand/animate.c" 3 4
       ((void *)0)
# 760 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 760 "MagickWand/animate.c" 3 4
       ((void *)0)
# 760 "MagickWand/animate.c"
        ...
        if (LocaleCompare("extent",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 770,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 770 "MagickWand/animate.c" 3 4
             ((void *)0)
# 770 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 770 "MagickWand/animate.c" 3 4
             ((void *)0)
# 770 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 772,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 772 "MagickWand/animate.c" 3 4
             ((void *)0)
# 772 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 772 "MagickWand/animate.c" 3 4
             ((void *)0)
# 772 "MagickWand/animate.c"
        ...
        if (LocaleCompare("extract",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 781,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 781 "MagickWand/animate.c" 3 4
             ((void *)0)
# 781 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 781 "MagickWand/animate.c" 3 4
             ((void *)0)
# 781 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 783,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 783 "MagickWand/animate.c" 3 4
             ((void *)0)
# 783 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 783 "MagickWand/animate.c" 3 4
             ((void *)0)
# 783 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 786,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 786 "MagickWand/animate.c" 3 4
       ((void *)0)
# 786 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 786 "MagickWand/animate.c" 3 4
       ((void *)0)
# 786 "MagickWand/animate.c"
        ...
        if (LocaleCompare("filter",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 799,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 799 "MagickWand/animate.c" 3 4
             ((void *)0)
# 799 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 799 "MagickWand/animate.c" 3 4
             ((void *)0)
# 799 "MagickWand/animate.c"
            ...
            if (filter < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 802,OptionError,"UnrecognizedImageFilter","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 802 "MagickWand/animate.c" 3 4
             ((void *)0)
# 802 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 802 "MagickWand/animate.c" 3 4
             ((void *)0)
# 802 "MagickWand/animate.c"
        ...
        if (LocaleCompare("font",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 814,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 814 "MagickWand/animate.c" 3 4
             ((void *)0)
# 814 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 814 "MagickWand/animate.c" 3 4
             ((void *)0)
# 814 "MagickWand/animate.c"
        ...
        if (LocaleCompare("foreground",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 825,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 825 "MagickWand/animate.c" 3 4
             ((void *)0)
# 825 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 825 "MagickWand/animate.c" 3 4
             ((void *)0)
# 825 "MagickWand/animate.c"
        ...
        if (LocaleCompare("format",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 835,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 835 "MagickWand/animate.c" 3 4
             ((void *)0)
# 835 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 835 "MagickWand/animate.c" 3 4
             ((void *)0)
# 835 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 838,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 838 "MagickWand/animate.c" 3 4
       ((void *)0)
# 838 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 838 "MagickWand/animate.c" 3 4
       ((void *)0)
# 838 "MagickWand/animate.c"
        ...
        if (LocaleCompare("gamma",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 846,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 846 "MagickWand/animate.c" 3 4
             ((void *)0)
# 846 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 846 "MagickWand/animate.c" 3 4
             ((void *)0)
# 846 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 848,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 848 "MagickWand/animate.c" 3 4
             ((void *)0)
# 848 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 848 "MagickWand/animate.c" 3 4
             ((void *)0)
# 848 "MagickWand/animate.c"
...
# 853 "MagickWand/animate.c" 3 4
                                                 ((void *)0)
# 853 "MagickWand/animate.c"
                                                     ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 858,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 858 "MagickWand/animate.c" 3 4
             ((void *)0)
# 858 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 858 "MagickWand/animate.c" 3 4
             ((void *)0)
# 858 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 860,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 860 "MagickWand/animate.c" 3 4
             ((void *)0)
# 860 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 860 "MagickWand/animate.c" 3 4
             ((void *)0)
# 860 "MagickWand/animate.c"
        ...
        if (LocaleCompare("gravity",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 873,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 873 "MagickWand/animate.c" 3 4
             ((void *)0)
# 873 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 873 "MagickWand/animate.c" 3 4
             ((void *)0)
# 873 "MagickWand/animate.c"
            ...
            gravity=ParseCommandOption(MagickGravityOptions,MagickFalse,
              argv[i]);
            if (gravity < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 877,OptionError,"UnrecognizedGravityType","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 877 "MagickWand/animate.c" 3 4
             ((void *)0)
# 877 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 877 "MagickWand/animate.c" 3 4
             ((void *)0)
# 877 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 881,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 881 "MagickWand/animate.c" 3 4
       ((void *)0)
# 881 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 881 "MagickWand/animate.c" 3 4
       ((void *)0)
# 881 "MagickWand/animate.c"
      ...
      case 'h':
      {
        if ((LocaleCompare("help",option+1) == 0) ||
            (LocaleCompare("-help",option+1) == 0))
          break;
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 888,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 888 "MagickWand/animate.c" 3 4
       ((void *)0)
# 888 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 888 "MagickWand/animate.c" 3 4
       ((void *)0)
# 888 "MagickWand/animate.c"
...
# 894 "MagickWand/animate.c" 3 4
                                                ((void *)0)
# 894 "MagickWand/animate.c"
                                                    ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 899,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 899 "MagickWand/animate.c" 3 4
             ((void *)0)
# 899 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 899 "MagickWand/animate.c" 3 4
             ((void *)0)
# 899 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 901,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 901 "MagickWand/animate.c" 3 4
             ((void *)0)
# 901 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 901 "MagickWand/animate.c" 3 4
             ((void *)0)
# 901 "MagickWand/animate.c"
        ...
        if (LocaleCompare("interlace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 926,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 926 "MagickWand/animate.c" 3 4
             ((void *)0)
# 926 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 926 "MagickWand/animate.c" 3 4
             ((void *)0)
# 926 "MagickWand/animate.c"
            ...
            interlace=ParseCommandOption(MagickInterlaceOptions,MagickFalse,
              argv[i]);
            if (interlace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 930,OptionError,"UnrecognizedInterlaceType","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 930 "MagickWand/animate.c" 3 4
             ((void *)0)
# 930 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 930 "MagickWand/animate.c" 3 4
             ((void *)0)
# 930 "MagickWand/animate.c"
        ...
        if (LocaleCompare("interpolate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 943,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 943 "MagickWand/animate.c" 3 4
             ((void *)0)
# 943 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 943 "MagickWand/animate.c" 3 4
             ((void *)0)
# 943 "MagickWand/animate.c"
            ...
            interpolate=ParseCommandOption(MagickInterpolateOptions,MagickFalse,
              argv[i]);
            if (interpolate < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 947,OptionError,"UnrecognizedInterpolateMethod","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 947 "MagickWand/animate.c" 3 4
             ((void *)0)
# 947 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 947 "MagickWand/animate.c" 3 4
             ((void *)0)
# 947 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 951,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 951 "MagickWand/animate.c" 3 4
       ((void *)0)
# 951 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 951 "MagickWand/animate.c" 3 4
       ((void *)0)
# 951 "MagickWand/animate.c"
        ...
        if (LocaleCompare("label",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 961,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 961 "MagickWand/animate.c" 3 4
             ((void *)0)
# 961 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 961 "MagickWand/animate.c" 3 4
             ((void *)0)
# 961 "MagickWand/animate.c"
        ...
        if (LocaleCompare("limit",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 979,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 979 "MagickWand/animate.c" 3 4
             ((void *)0)
# 979 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 979 "MagickWand/animate.c" 3 4
             ((void *)0)
# 979 "MagickWand/animate.c"
            ...
            resource=ParseCommandOption(MagickResourceOptions,MagickFalse,
              argv[i]);
            if (resource < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 983,OptionError,"UnrecognizedResourceType","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 983 "MagickWand/animate.c" 3 4
             ((void *)0)
# 983 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 983 "MagickWand/animate.c" 3 4
             ((void *)0)
# 983 "MagickWand/animate.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 987,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 987 "MagickWand/animate.c" 3 4
             ((void *)0)
# 987 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 987 "MagickWand/animate.c" 3 4
             ((void *)0)
# 987 "MagickWand/animate.c"
            ...
            if ((p == argv[i]) && (LocaleCompare("unlimited",argv[i]) != 0))
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 991,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 991 "MagickWand/animate.c" 3 4
             ((void *)0)
# 991 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 991 "MagickWand/animate.c" 3 4
             ((void *)0)
# 991 "MagickWand/animate.c"
        ...
        if (LocaleCompare("list",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1003,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1003 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1003 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1003 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1003 "MagickWand/animate.c"
            ...
            if (list < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1006,OptionError,"UnrecognizedListType","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1006 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1006 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1006 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1006 "MagickWand/animate.c"
            ...
            status=MogrifyImageInfo(image_info,(int) (i-j+1),(const char **)
              argv+j,exception);
            { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1009 "MagickWand/animate.c" 3 4
           ((void *)0)
# 1009 "MagickWand/animate.c"
           ) { XCloseDisplay(display); display=(Display *) 
# 1009 "MagickWand/animate.c" 3 4
           ((void *)0)
# 1009 "MagickWand/animate.c"
        ...
        if (LocaleCompare("log",option+1) == 0)
          {
            ...
            if ((i == (ssize_t) argc) ||
                (strchr(argv[i],'%') == (char *) 
# 1018 "MagickWand/animate.c" 3 4
                                                ((void *)0)
# 1018 "MagickWand/animate.c"
                                                    ))
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1019,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1019 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1019 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1019 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1019 "MagickWand/animate.c"
        ...
        if (LocaleCompare("loop",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1028,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1028 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1028 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1028 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1028 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1030,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1030 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1030 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1030 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1030 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1033,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1033 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1033 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1033 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1033 "MagickWand/animate.c"
...
# 1039 "MagickWand/animate.c" 3 4
                                           ((void *)0)
# 1039 "MagickWand/animate.c"
                                               ;
            if (*option == '+')
              break;
            (void) CopyMagickString(argv[i]+1,"san",4096);
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1045,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1045 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1045 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1045 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1045 "MagickWand/animate.c"
        ...
        if (LocaleCompare("mattecolor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1057,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1057 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1057 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1057 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1057 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1071,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1071 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1071 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1071 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1071 "MagickWand/animate.c"
...
# 1077 "MagickWand/animate.c" 3 4
                                       ((void *)0)
# 1077 "MagickWand/animate.c"
                                           ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1082,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1082 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1082 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1082 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1082 "MagickWand/animate.c"
        ...
        if (LocaleCompare("noop",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1088,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1088 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1088 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1088 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1088 "MagickWand/animate.c"
        ...
        if (LocaleCompare("pause",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1099,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1099 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1099 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1099 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1099 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1101,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1101 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1101 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1101 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1101 "MagickWand/animate.c"
        ...
        if (LocaleCompare("page",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1111,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1111 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1111 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1111 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1111 "MagickWand/animate.c"
        ...
        if (LocaleCompare("profile",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1118,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1118 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1118 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1118 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1118 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1121,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1121 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1121 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1121 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1121 "MagickWand/animate.c"
        ...
        if (LocaleCompare("quantize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1134,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1134 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1134 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1134 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1134 "MagickWand/animate.c"
            ...
            colorspace=ParseCommandOption(MagickColorspaceOptions,
              MagickFalse,argv[i]);
            if (colorspace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1138,OptionError,"UnrecognizedColorspace","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1138 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1138 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1138 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1138 "MagickWand/animate.c"
        ...
        if (LocaleCompare("quiet",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1144,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1144 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1144 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1144 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1144 "MagickWand/animate.c"
        ...
        if (LocaleCompare("remote",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1154,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1154 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1154 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1154 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1154 "MagickWand/animate.c"
            ...
            if (XRemoteCommand(display,resource_info.window_id,argv[i]) != 0)
              {
                { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1157 "MagickWand/animate.c" 3 4
               ((void *)0)
# 1157 "MagickWand/animate.c"
               ) { XCloseDisplay(display); display=(Display *) 
# 1157 "MagickWand/animate.c" 3 4
               ((void *)0)
# 1157 "MagickWand/animate.c"
        ...
        if (LocaleCompare("repage",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1169,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1169 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1169 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1169 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1169 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1171,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1171 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1171 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1171 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1171 "MagickWand/animate.c"
        ...
        if (LocaleCompare("resample",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1180,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1180 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1180 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1180 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1180 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1182,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1182 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1182 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1182 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1182 "MagickWand/animate.c"
        ...
        if (LocaleCompare("resize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1191,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1191 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1191 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1191 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1191 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1193,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1193 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1193 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1193 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1193 "MagickWand/animate.c"
        ...
        if (LocaleCompare("rotate",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1205,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1205 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1205 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1205 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1205 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1207,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1207 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1207 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1207 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1207 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1210,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1210 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1210 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1210 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1210 "MagickWand/animate.c"
        ...
        if (LocaleCompare("sampling-factor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1220,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1220 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1220 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1220 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1220 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1222,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1222 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1222 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1222 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1222 "MagickWand/animate.c"
        ...
        if (LocaleCompare("seed",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1231,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1231 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1231 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1231 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1231 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1233,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1233 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1233 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1233 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1233 "MagickWand/animate.c"
        ...
        if (LocaleCompare("scenes",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1242,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1242 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1242 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1242 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1242 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsSceneGeometry(argv[i],MagickFalse) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1244,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1244 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1244 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1244 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1244 "MagickWand/animate.c"
        ...
        if (LocaleCompare("set",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1251,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1251 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1251 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1251 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1251 "MagickWand/animate.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1256,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1256 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1256 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1256 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1256 "MagickWand/animate.c"
        ...
        if (LocaleCompare("size",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1271,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1271 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1271 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1271 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1271 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1273,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1273 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1273 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1273 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1273 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1283,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1283 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1283 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1283 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1283 "MagickWand/animate.c"
...
# 1289 "MagickWand/animate.c" 3 4
                                            ((void *)0)
# 1289 "MagickWand/animate.c"
                                                ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1294,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1294 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1294 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1294 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1294 "MagickWand/animate.c"
        ...
        if (LocaleCompare("thumbnail",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1305,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1305 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1305 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1305 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1305 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1307,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1307 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1307 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1307 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1307 "MagickWand/animate.c"
...
# 1312 "MagickWand/animate.c" 3 4
                                        ((void *)0)
# 1312 "MagickWand/animate.c"
                                            ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1317,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1317 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1317 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1317 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1317 "MagickWand/animate.c"
        ...
        if (LocaleCompare("transparent-color",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1327,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1327 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1327 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1327 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1327 "MagickWand/animate.c"
        ...
        if (LocaleCompare("treedepth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1337,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1337 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1337 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1337 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1337 "MagickWand/animate.c"
             ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1339,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1339 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1339 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1339 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1339 "MagickWand/animate.c"
        ...
        if (LocaleCompare("trim",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1345,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1345 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1345 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1345 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1345 "MagickWand/animate.c"
      ...
      case 'v':
      {
        ...
        if ((LocaleCompare("version",option+1) == 0) ||
          ...
          {
            ListMagickVersion(
# 1354 "MagickWand/animate.c" 3 4
                             stdout
# 1354 "MagickWand/animate.c"
                                   );
            break;
          }
        if (LocaleCompare("virtual-pixel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1366,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1366 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1366 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1366 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1366 "MagickWand/animate.c"
            ...
            method=ParseCommandOption(MagickVirtualPixelOptions,MagickFalse,
              argv[i]);
            if (method < 0)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1370,OptionError,"UnrecognizedVirtualPixelMethod","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1370 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1370 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1370 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1370 "MagickWand/animate.c"
...
# 1376 "MagickWand/animate.c" 3 4
                                              ((void *)0)
# 1376 "MagickWand/animate.c"
                                                  ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1381,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1381 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1381 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1381 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1381 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1385,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1385 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1385 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1385 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1385 "MagickWand/animate.c"
...
# 1391 "MagickWand/animate.c" 3 4
                                            ((void *)0)
# 1391 "MagickWand/animate.c"
                                                ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1396,OptionError,"MissingArgument","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1396 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1396 "MagickWand/animate.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1396 "MagickWand/animate.c" 3 4
             ((void *)0)
# 1396 "MagickWand/animate.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1400,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1400 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1400 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1400 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1400 "MagickWand/animate.c"
      ...
      case '?':
        break;
      default:
        { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1405,OptionError,"UnrecognizedOption","`%s'", option); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1405 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1405 "MagickWand/animate.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1405 "MagickWand/animate.c" 3 4
       ((void *)0)
# 1405 "MagickWand/animate.c"
    ...
    if (fire != MagickFalse)
      if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 1410 "MagickWand/animate.c" 3 4
     ((void *)0)
# 1410 "MagickWand/animate.c"
     ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickFalse,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
  }
  i--;
  if (k != 0)
    { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1414,OptionError,"UnbalancedParenthesis","`%s'", argv[i]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1414 "MagickWand/animate.c" 3 4
   ((void *)0)
# 1414 "MagickWand/animate.c"
   ) { XCloseDisplay(display); display=(Display *) 
# 1414 "MagickWand/animate.c" 3 4
   ((void *)0)
# 1414 "MagickWand/animate.c"
   ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
  if (image == (Image *) 
# 1415 "MagickWand/animate.c" 3 4
                        ((void *)0)
# 1415 "MagickWand/animate.c"
                            )
    { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1416,OptionError,"MissingAnImageFilename","`%s'", argv[argc-1]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1416 "MagickWand/animate.c" 3 4
   ((void *)0)
# 1416 "MagickWand/animate.c"
   ) { XCloseDisplay(display); display=(Display *) 
# 1416 "MagickWand/animate.c" 3 4
   ((void *)0)
# 1416 "MagickWand/animate.c"
   ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
  { if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 1417 "MagickWand/animate.c" 3 4
 ((void *)0)
# 1417 "MagickWand/animate.c"
...
# 1417 "MagickWand/animate.c"
  ...
  if (image == (Image *) 
# 1418 "MagickWand/animate.c" 3 4
                        ((void *)0)
# 1418 "MagickWand/animate.c"
                            )
    { (void) ThrowMagickException(exception,"MagickWand/animate.c",__func__,(unsigned long) 1419,OptionError,"MissingAnImageFilename","`%s'", argv[argc-1]); { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1419 "MagickWand/animate.c" 3 4
   ((void *)0)
# 1419 "MagickWand/animate.c"
   ) { XCloseDisplay(display); display=(Display *) 
# 1419 "MagickWand/animate.c" 3 4
   ((void *)0)
# 1419 "MagickWand/animate.c"
...
# 1420 "MagickWand/animate.c" 3 4
                                         ((void *)0)
# 1420 "MagickWand/animate.c"
                                             )
    {
  ...
  else
    {
      ...
      animate_image=XAnimateImages(display,&resource_info,argv,argc,image,
        exception);
      while (animate_image != (Image *) 
# 1435 "MagickWand/animate.c" 3 4
                                       ((void *)0)
# 1435 "MagickWand/animate.c"
                                           )
      {
        image=animate_image;
        animate_image=XAnimateImages(display,&resource_info,argv,argc,image,
  ...
  { XDestroyResourceInfo(&resource_info); if (display != (Display *) 
# 1444 "MagickWand/animate.c" 3 4
 ((void *)0)
# 1444 "MagickWand/animate.c"
 ) { XCloseDisplay(display); display=(Display *) 
# 1444 "MagickWand/animate.c" 3 4
 ((void *)0)
# 1444 "MagickWand/animate.c"
