# 0 "MagickWand/script-token.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/script-token.c"
# 175 "MagickWand/script-token.c"
...
# 176 "MagickWand/script-token.c" 2
...
# 178 "MagickWand/script-token.c" 2
...
# 179 "MagickWand/script-token.c" 2
...
# 180 "MagickWand/script-token.c" 2
# 205 "MagickWand/script-token.c"
__attribute__ ((visibility ("default"))) ScriptTokenInfo *AcquireScriptTokenInfo(const char *filename)
{
  ScriptTokenInfo
    *token_info;
...
# 211 "MagickWand/script-token.c" 3 4
                                       ((void *)0)
# 211 "MagickWand/script-token.c"
                                           )
    return token_info;
  ...
  if ( LocaleCompare(filename,"-") == 0 ) {
    token_info->stream=
# 217 "MagickWand/script-token.c" 3 4
                      stdin
# 217 "MagickWand/script-token.c"
                           ;
    token_info->opened=MagickFalse;
  }
  ...
  if ( token_info->stream == (FILE *) 
# 227 "MagickWand/script-token.c" 3 4
                                     ((void *)0) 
# 227 "MagickWand/script-token.c"
                                          ) {
  ...
  token_info->length=64;
  token_info->token=(char *) AcquireQuantumMemory(1,token_info->length);

  token_info->status=(token_info->token != (char *) 
# 236 "MagickWand/script-token.c" 3 4
                                                   ((void *)0)
# 236 "MagickWand/script-token.c"
                                                       )
                      ? TokenStatusOK : TokenStatusMemoryFailed;
  token_info->signature=0xabacadabUL;

  return token_info;
}
# 266 "MagickWand/script-token.c"
__attribute__ ((visibility ("default"))) ScriptTokenInfo * DestroyScriptTokenInfo(ScriptTokenInfo *token_info)
{
  
# 268 "MagickWand/script-token.c" 3 4
 ((void) sizeof ((
# 268 "MagickWand/script-token.c"
...
# 268 "MagickWand/script-token.c"
 "token_info != (ScriptTokenInfo *) NULL"
# 268 "MagickWand/script-token.c" 3 4
 , "MagickWand/script-token.c", 268, __extension__ __PRETTY_FUNCTION__); }))
# 268 "MagickWand/script-token.c"
                                               ;
  
# 269 "MagickWand/script-token.c" 3 4
 ((void) sizeof ((
# 269 "MagickWand/script-token.c"
 token_info->signature == 0xabacadabUL
# 269 "MagickWand/script-token.c" 3 4
...
# 269 "MagickWand/script-token.c" 3 4
 , "MagickWand/script-token.c", 269, __extension__ __PRETTY_FUNCTION__); }))
# 269 "MagickWand/script-token.c"
                                                     ;
  ...
  if (token_info->token != (char *) 
# 274 "MagickWand/script-token.c" 3 4
                                   ((void *)0) 
# 274 "MagickWand/script-token.c"
                                        )
    token_info->token=(char *) RelinquishMagickMemory(token_info->token);
  token_info=(ScriptTokenInfo *) RelinquishMagickMemory(token_info);
  return(token_info);
}
# 359 "MagickWand/script-token.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetScriptToken(ScriptTokenInfo *token_info)
{
  int
    quote,
    c;
  ...
  if (token_info == (ScriptTokenInfo *) 
# 372 "MagickWand/script-token.c" 3 4
                                       ((void *)0)
# 372 "MagickWand/script-token.c"
                                           )
    return(MagickFalse);
...

  {
    ...
    { c=fgetc(token_info->stream); token_info->curr_column++; if ( c == '\r' ) { c=fgetc(token_info->stream); ungetc(c,token_info->stream); c = (c!='\n')?'\n':'\r'; } if ( c == '\n' ) token_info->curr_line++, token_info->curr_column=0; if (c == 
# 387 "MagickWand/script-token.c" 3 4
   (-1) 
# 387 "MagickWand/script-token.c"
   ) break; if ( (c>='\0' && c<'\a') || (c>'\r' && c<' ' && c!='\033') ) { token_info->status=TokenStatusBinary; break; } };
    ...
    if (strchr(" \n\r\t",c) != (char *) 
# 401 "MagickWand/script-token.c" 3 4
                                       ((void *)0)
# 401 "MagickWand/script-token.c"
                                           ) {
      switch (state) {
        case 1:
          ...
          return(MagickTrue);
        case 2:
          { if ((size_t) offset >= (token_info->length-1)) { if (token_info == (ScriptTokenInfo *) 
# 407 "MagickWand/script-token.c" 3 4
         ((void *)0)
# 407 "MagickWand/script-token.c"
         ) break; if ( token_info->length >= 4096 ) token_info->length += 4096; else token_info->length *= 4; token_info->token=(char *) ResizeQuantumMemory(token_info->token, token_info->length,sizeof(*token_info->token)); if ( token_info->token == (char *) 
# 407 "MagickWand/script-token.c" 3 4
         ((void *)0) 
# 407 "MagickWand/script-token.c"
         ) { token_info->status=TokenStatusMemoryFailed; break; } } if ( token_info->token == (char *) 
# 407 "MagickWand/script-token.c" 3 4
         ((void *)0) 
# 407 "MagickWand/script-token.c"
         ) token_info->status=TokenStatusMemoryFailed; else token_info->token[offset++]=(char) (c); };
          break;
      }
      continue;
    }
      ...
      switch (state) {
        ...
        case 2:
          if (c == quote)
            ...
            { if ((size_t) offset >= (token_info->length-1)) { if (token_info == (ScriptTokenInfo *) 
# 430 "MagickWand/script-token.c" 3 4
           ((void *)0)
# 430 "MagickWand/script-token.c"
           ) break; if ( token_info->length >= 4096 ) token_info->length += 4096; else token_info->length *= 4; token_info->token=(char *) ResizeQuantumMemory(token_info->token, token_info->length,sizeof(*token_info->token)); if ( token_info->token == (char *) 
# 430 "MagickWand/script-token.c" 3 4
           ((void *)0) 
# 430 "MagickWand/script-token.c"
    ...
    if (c == '\\')
      {
        if ( state==2 && quote == '\'' ) {
            { if ((size_t) offset >= (token_info->length-1)) { if (token_info == (ScriptTokenInfo *) 
# 439 "MagickWand/script-token.c" 3 4
           ((void *)0)
# 439 "MagickWand/script-token.c"
           ) break; if ( token_info->length >= 4096 ) token_info->length += 4096; else token_info->length *= 4; token_info->token=(char *) ResizeQuantumMemory(token_info->token, token_info->length,sizeof(*token_info->token)); if ( token_info->token == (char *) 
# 439 "MagickWand/script-token.c" 3 4
           ((void *)0) 
# 439 "MagickWand/script-token.c"
...
# 439 "MagickWand/script-token.c" 3 4
           ((void *)0) 
# 439 "MagickWand/script-token.c"
           ) token_info->status=TokenStatusMemoryFailed; else token_info->token[offset++]=(char) ('\\'); };
            continue;
          }
        { c=fgetc(token_info->stream); token_info->curr_column++; if ( c == '\r' ) { c=fgetc(token_info->stream); ungetc(c,token_info->stream); c = (c!='\n')?'\n':'\r'; } if ( c == '\n' ) token_info->curr_line++, token_info->curr_column=0; if (c == 
# 442 "MagickWand/script-token.c" 3 4
       (-1) 
# 442 "MagickWand/script-token.c"
       ) break; if ( (c>='\0' && c<'\a') || (c>'\r' && c<' ' && c!='\033') ) { token_info->status=TokenStatusBinary; break; } };
        if (c == '\n')
          switch (state) {
            case 3:
        ...
        switch (state) {
          ...
          case 2:
            if (c != quote && c != '\\')
              { if ((size_t) offset >= (token_info->length-1)) { if (token_info == (ScriptTokenInfo *) 
# 464 "MagickWand/script-token.c" 3 4
             ((void *)0)
# 464 "MagickWand/script-token.c"
             ) break; if ( token_info->length >= 4096 ) token_info->length += 4096; else token_info->length *= 4; token_info->token=(char *) ResizeQuantumMemory(token_info->token, token_info->length,sizeof(*token_info->token)); if ( token_info->token == (char *) 
# 464 "MagickWand/script-token.c" 3 4
             ((void *)0) 
# 464 "MagickWand/script-token.c"
...
# 464 "MagickWand/script-token.c"
        ...
        { if ((size_t) offset >= (token_info->length-1)) { if (token_info == (ScriptTokenInfo *) 
# 467 "MagickWand/script-token.c" 3 4
       ((void *)0)
# 467 "MagickWand/script-token.c"
       ) break; if ( token_info->length >= 4096 ) token_info->length += 4096; else token_info->length *= 4; token_info->token=(char *) ResizeQuantumMemory(token_info->token, token_info->length,sizeof(*token_info->token)); if ( token_info->token == (char *) 
# 467 "MagickWand/script-token.c" 3 4
       ((void *)0) 
# 467 "MagickWand/script-token.c"
...
# 467 "MagickWand/script-token.c"
    ...
    switch (state) {
      ...
      case 2:
        { if ((size_t) offset >= (token_info->length-1)) { if (token_info == (ScriptTokenInfo *) 
# 479 "MagickWand/script-token.c" 3 4
       ((void *)0)
# 479 "MagickWand/script-token.c"
       ) break; if ( token_info->length >= 4096 ) token_info->length += 4096; else token_info->length *= 4; token_info->token=(char *) ResizeQuantumMemory(token_info->token, token_info->length,sizeof(*token_info->token)); if ( token_info->token == (char *) 
# 479 "MagickWand/script-token.c" 3 4
       ((void *)0) 
# 479 "MagickWand/script-token.c"
