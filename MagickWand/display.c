# 0 "MagickWand/display.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/display.c"
# 44 "MagickWand/display.c"
...
# 45 "MagickWand/display.c" 2

# 1 "./MagickWand/mogrify-private.h" 1
# 113 "./MagickWand/mogrify-private.h"
...
# 34 "./MagickCore/xwindow-private.h"
...
# 49 "MagickWand/display.c" 2
# 94 "MagickWand/display.c"
static MagickBooleanType DisplayUsage(void)
{
  ...
  ListMagickVersion(
# 212 "MagickWand/display.c" 3 4
                   stdout
# 212 "MagickWand/display.c"
                         );
...
__attribute__ ((visibility ("default"))) MagickBooleanType DisplayImageCommand(ImageInfo *image_info,
  int argc,char **argv,char **wand_unused_metadata __attribute__((unused)),ExceptionInfo *exception)
{
# 280 "MagickWand/display.c"
  char
    *resource_value,
    *server_name;
...
# 333 "MagickWand/display.c" 3 4
 ((void) sizeof ((
# 333 "MagickWand/display.c"
...
# 333 "MagickWand/display.c" 3 4
 , "MagickWand/display.c", 333, __extension__ __PRETTY_FUNCTION__); }))
# 333 "MagickWand/display.c"
                                         ;
  
# 334 "MagickWand/display.c" 3 4
 ((void) sizeof ((
# 334 "MagickWand/display.c"
...
# 334 "MagickWand/display.c" 3 4
 , "MagickWand/display.c", 334, __extension__ __PRETTY_FUNCTION__); }))
# 334 "MagickWand/display.c"
                                                     ;
  
# 335 "MagickWand/display.c" 3 4
 ((void) sizeof ((
# 335 "MagickWand/display.c"
...
# 335 "MagickWand/display.c" 3 4
 , "MagickWand/display.c", 335, __extension__ __PRETTY_FUNCTION__); }))
# 335 "MagickWand/display.c"
                                            ;
  ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickWand/display.c",__func__,(unsigned long) 338,"...");
  if (argc == 2)
    {
      option=argv[1];
      if ((LocaleCompare("version",option+1) == 0) ||
        ...
        {
          ListMagickVersion(
# 345 "MagickWand/display.c" 3 4
                           stdout
# 345 "MagickWand/display.c"
                                 );
          return(MagickTrue);
        }
    }
  ;
  display=(Display *) 
# 350 "MagickWand/display.c" 3 4
                     ((void *)0)
# 350 "MagickWand/display.c"
                         ;
  j=1;
  k=0;
  image_marker=(size_t *) 
# 353 "MagickWand/display.c" 3 4
                         ((void *)0)
# 353 "MagickWand/display.c"
                             ;
  image_number=0;
  last_image=0;
  { image_stack[128].image_info=image_info; image_stack[0].image_info=CloneImageInfo(image_info); image_stack[0].image=NewImageList(); image_info=image_stack[0].image_info; image=image_stack[0].image; };
  option=(char *) 
# 357 "MagickWand/display.c" 3 4
                 ((void *)0)
# 357 "MagickWand/display.c"
                     ;
  pend=MagickFalse;
  respect_parenthesis=MagickFalse;
  nostdin=MagickFalse;
  resource_database=(XrmDatabase) 
# 361 "MagickWand/display.c" 3 4
                                 ((void *)0)
# 361 "MagickWand/display.c"
                                     ;
  (void) memset(&resource_info,0,sizeof(resource_info));
  server_name=(char *) 
# 363 "MagickWand/display.c" 3 4
                      ((void *)0)
# 363 "MagickWand/display.c"
                          ;
  state=0;
  status=MagickTrue;
  ;
  ...
  if (status == MagickFalse)
    { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 369,ResourceLimitError,"MemoryAllocationFailed","`%s'", GetExceptionMessage(
# 369 "MagickWand/display.c" 3 4
   (*__errno_location ())
# 369 "MagickWand/display.c"
   )); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 369 "MagickWand/display.c" 3 4
   ((void *)0)
# 369 "MagickWand/display.c"
...
# 369 "MagickWand/display.c" 3 4
   ((void *)0)
# 369 "MagickWand/display.c"
   ; } XDestroyResourceInfo(&resource_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; if (image_marker != (size_t *) 
# 369 "MagickWand/display.c" 3 4
   ((void *)0)
# 369 "MagickWand/display.c"
   ) image_marker=(size_t *) RelinquishMagickMemory(image_marker); for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                                 ;
  image_marker=(size_t *) AcquireQuantumMemory((size_t) argc+1UL,
    sizeof(*image_marker));
  if (image_marker == (size_t *) 
# 373 "MagickWand/display.c" 3 4
                                ((void *)0)
# 373 "MagickWand/display.c"
                                    )
    { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 374,ResourceLimitError,"MemoryAllocationFailed","`%s'", GetExceptionMessage(
# 374 "MagickWand/display.c" 3 4
   (*__errno_location ())
# 374 "MagickWand/display.c"
   )); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 374 "MagickWand/display.c" 3 4
   ((void *)0)
# 374 "MagickWand/display.c"
    ...
    if (LocaleCompare("display",option+1) == 0)
      {
        ...
        i++;
        if (i == (ssize_t) argc)
          { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 396,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 396 "MagickWand/display.c" 3 4
         ((void *)0)
# 396 "MagickWand/display.c"
         ) { XCloseDisplay(display); display=(Display *) 
# 396 "MagickWand/display.c" 3 4
         ((void *)0)
# 396 "MagickWand/display.c"
...
# 396 "MagickWand/display.c"
    ...
    if ((LocaleCompare("help",option+1) == 0) ||
      ...
      {
        { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 404 "MagickWand/display.c" 3 4
       ((void *)0)
# 404 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 404 "MagickWand/display.c" 3 4
       ((void *)0)
# 404 "MagickWand/display.c"
...
# 404 "MagickWand/display.c" 3 4
       ((void *)0)
# 404 "MagickWand/display.c"
       ) image_marker=(size_t *) RelinquishMagickMemory(image_marker); for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); };
        return(DisplayUsage());
      }
  }
  ...
  if (display == (Display *) 
# 412 "MagickWand/display.c" 3 4
                            ((void *)0)
# 412 "MagickWand/display.c"
                                )
    { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 413,XServerError,"UnableToOpenXServer","`%s'", XDisplayName(server_name)); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 413 "MagickWand/display.c" 3 4
   ((void *)0)
# 413 "MagickWand/display.c"
   ) { XCloseDisplay(display); display=(Display *) 
# 413 "MagickWand/display.c" 3 4
   ((void *)0)
# 413 "MagickWand/display.c"
...
# 413 "MagickWand/display.c"
  ...
  image_info->density=XGetResourceInstance(resource_database,GetClientName(),
    "density",(char *) 
# 421 "MagickWand/display.c" 3 4
                      ((void *)0)
# 421 "MagickWand/display.c"
                          );
  if (image_info->density == (char *) 
# 422 "MagickWand/display.c" 3 4
                                     ((void *)0)
# 422 "MagickWand/display.c"
                                         )
  ...
  image_info->page=XGetResourceInstance(resource_database,GetClientName(),
    "pageGeometry",(char *) 
# 429 "MagickWand/display.c" 3 4
                           ((void *)0)
# 429 "MagickWand/display.c"
                               );
  resource_value=XGetResourceInstance(resource_database,GetClientName(),
    "quality","75");
  ...
  for (i=1; ((i <= (ssize_t) argc) && ((state & ExitState) == 0)); i++)
  {
    if (i < (ssize_t) argc)
      ...
      if (image != (Image *) 
# 449 "MagickWand/display.c" 3 4
                            ((void *)0)
# 449 "MagickWand/display.c"
                                )
        break;
      else
        if (isatty(
# 452 "MagickWand/display.c" 3 4
                  0
# 452 "MagickWand/display.c"
                              ) != MagickFalse || (nostdin != MagickFalse))
          option="logo:";
        else
          option="-";
    if (LocaleCompare(option,"(") == 0)
      {
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 458 "MagickWand/display.c" 3 4
       ((void *)0)
# 458 "MagickWand/display.c"
       ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((pend) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickFalse,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
        if (k == 128)
          { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 460,OptionError,"ParenthesisNestedTooDeeply","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 460 "MagickWand/display.c" 3 4
         ((void *)0)
# 460 "MagickWand/display.c"
         ) { XCloseDisplay(display); display=(Display *) 
# 460 "MagickWand/display.c" 3 4
         ((void *)0)
# 460 "MagickWand/display.c"
...
# 460 "MagickWand/display.c"
                   ...
                   ;
        { k++; image_stack[k].image_info=CloneImageInfo(image_stack[k-1].image_info); image_stack[k].image=NewImageList(); image_info=image_stack[k].image_info; image=image_stack[k].image; };
        continue;
      }
    if (LocaleCompare(option,")") == 0)
      {
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 467 "MagickWand/display.c" 3 4
       ((void *)0)
# 467 "MagickWand/display.c"
       ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickFalse,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
        if (k == 0)
          { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 469,OptionError,"UnableToParseExpression","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 469 "MagickWand/display.c" 3 4
         ((void *)0)
# 469 "MagickWand/display.c"
         ) { XCloseDisplay(display); display=(Display *) 
# 469 "MagickWand/display.c" 3 4
         ((void *)0)
# 469 "MagickWand/display.c"
...
# 469 "MagickWand/display.c"
        ...
        { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; };
        continue;
      }
    if (IsCommandOption(option) == MagickFalse)
      {
        ...
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 486 "MagickWand/display.c" 3 4
       ((void *)0)
# 486 "MagickWand/display.c"
       ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((pend) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickFalse,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickFalse) != MagickFalse) j=i+1; pend=MagickFalse; } };
        filename=option;
        ...
        status&=(MagickStatusType) (images != (Image *) 
# 496 "MagickWand/display.c" 3 4
                                                       ((void *)0)
# 496 "MagickWand/display.c"
                                                           ) &&
          (exception->severity < ErrorException);
        if (images == (Image *) 
# 498 "MagickWand/display.c" 3 4
                               ((void *)0)
# 498 "MagickWand/display.c"
                                   )
          continue;
        { (void) SyncImagesSettings(image_info,images,exception); AppendImageToList(&image_stack[k].image,images); image=image_stack[k].image; };
        { if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 501 "MagickWand/display.c" 3 4
       ((void *)0)
# 501 "MagickWand/display.c"
       ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickTrue,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickFalse) != MagickFalse) j=i+1; pend=MagickFalse; } }; if (image != (Image *) 
# 501 "MagickWand/display.c" 3 4
       ((void *)0)
# 501 "MagickWand/display.c"
        ...
        if (image_list == (Image *) 
# 504 "MagickWand/display.c" 3 4
                                   ((void *)0)
# 504 "MagickWand/display.c"
                                       )
          { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 505,ResourceLimitError,"MemoryAllocationFailed","`%s'", GetExceptionMessage(
# 505 "MagickWand/display.c" 3 4
         (*__errno_location ())
# 505 "MagickWand/display.c"
         )); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 505 "MagickWand/display.c" 3 4
         ((void *)0)
# 505 "MagickWand/display.c"
...
# 505 "MagickWand/display.c"
        ...
        do
        {
          ...
          if (resource_info.window_id != (char *) 
# 514 "MagickWand/display.c" 3 4
                                                 ((void *)0)
# 514 "MagickWand/display.c"
                                                     )
            {
              ...
              if (GetNextImageInList(display_image) == (Image *) 
# 526 "MagickWand/display.c" 3 4
                                                                ((void *)0)
# 526 "MagickWand/display.c"
                                                                    )
                state|=ExitState;
            }
          else
            do
            {
              ...
              if (nexus == (Image *) 
# 542 "MagickWand/display.c" 3 4
                                    ((void *)0)
# 542 "MagickWand/display.c"
                                        )
                break;
              while ((nexus != (Image *) 
# 544 "MagickWand/display.c" 3 4
                                        ((void *)0)
# 544 "MagickWand/display.c"
                                            ) && ((state & ExitState) == 0))
              {
                Image
                  *next;

                if (nexus->montage != (char *) 
# 549 "MagickWand/display.c" 3 4
                                              ((void *)0)
# 549 "MagickWand/display.c"
                                                  )
                  {
                ...
                next=XDisplayImage(display,&resource_info,argv,argc,&nexus,
                  &state,exception);
                if ((next == (Image *) 
# 559 "MagickWand/display.c" 3 4
                                      ((void *)0)
# 559 "MagickWand/display.c"
                                          ) &&
                    (GetNextImageInList(nexus) != (Image *) 
# 560 "MagickWand/display.c" 3 4
                                                           ((void *)0)
# 560 "MagickWand/display.c"
                                                               ))
                  {
...
# 573 "MagickWand/display.c" 3 4
                                                      ((void *)0)
# 573 "MagickWand/display.c"
                                                          )
            {
              ...
              (void) CopyMagickString(display_image->filename,
                resource_info.write_filename,4096);
          ...
          if ((state & FormerImageState) != 0)
            ...
            {
              if (GetPreviousImageInList(display_image) == (Image *) 
# 590 "MagickWand/display.c" 3 4
                                                                    ((void *)0)
# 590 "MagickWand/display.c"
                                                                        )
                break;
            ...
            {
              if (GetNextImageInList(display_image) == (Image *) 
# 597 "MagickWand/display.c" 3 4
                                                                ((void *)0)
# 597 "MagickWand/display.c"
                                                                    )
                break;
          ...
          if (l < (ssize_t) resource_info.quantum)
            break;
        } while ((display_image != (Image *) 
# 603 "MagickWand/display.c" 3 4
                                            ((void *)0)
# 603 "MagickWand/display.c"
                                                ) && ((state & ExitState) == 0));
        ...
        if (resource_info.window_id != (char *) 
# 642 "MagickWand/display.c" 3 4
                                               ((void *)0)
# 642 "MagickWand/display.c"
                                                   )
          state|=ExitState;
        if (iterations != 0)
          {
        ...
        if (LocaleCompare(filename,"-") == 0)
          state|=ExitState;
        { if (image_stack[k].image != (Image *) 
# 652 "MagickWand/display.c" 3 4
       ((void *)0)
# 652 "MagickWand/display.c"
       ) image_stack[k].image=DestroyImageList(image_stack[k].image); };
        continue;
      }
    pend=image != (Image *) 
# 655 "MagickWand/display.c" 3 4
                           ((void *)0) 
# 655 "MagickWand/display.c"
        ...
        if (LocaleCompare("alpha",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 669,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 669 "MagickWand/display.c" 3 4
             ((void *)0)
# 669 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 669 "MagickWand/display.c" 3 4
             ((void *)0)
# 669 "MagickWand/display.c"
...
# 669 "MagickWand/display.c"
            ...
            type=ParseCommandOption(MagickAlphaChannelOptions,MagickFalse,
              argv[i]);
            if (type < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 673,OptionError,"UnrecognizedAlphaChannelOption","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 673 "MagickWand/display.c" 3 4
             ((void *)0)
# 673 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 673 "MagickWand/display.c" 3 4
             ((void *)0)
# 673 "MagickWand/display.c"
        ...
        if (LocaleCompare("authenticate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 685,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 685 "MagickWand/display.c" 3 4
             ((void *)0)
# 685 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 685 "MagickWand/display.c" 3 4
             ((void *)0)
# 685 "MagickWand/display.c"
...
# 685 "MagickWand/display.c"
        ...
        if (LocaleCompare("auto-orient",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 692,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 692 "MagickWand/display.c" 3 4
       ((void *)0)
# 692 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 692 "MagickWand/display.c" 3 4
       ((void *)0)
# 692 "MagickWand/display.c"
        ...
        if (LocaleCompare("background",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 707,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 707 "MagickWand/display.c" 3 4
             ((void *)0)
# 707 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 707 "MagickWand/display.c" 3 4
             ((void *)0)
# 707 "MagickWand/display.c"
        ...
        if (LocaleCompare("border",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 717,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 717 "MagickWand/display.c" 3 4
             ((void *)0)
# 717 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 717 "MagickWand/display.c" 3 4
             ((void *)0)
# 717 "MagickWand/display.c"
...
# 717 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 719,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 719 "MagickWand/display.c" 3 4
             ((void *)0)
# 719 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 719 "MagickWand/display.c" 3 4
             ((void *)0)
# 719 "MagickWand/display.c"
        ...
        if (LocaleCompare("bordercolor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 728,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 728 "MagickWand/display.c" 3 4
             ((void *)0)
# 728 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 728 "MagickWand/display.c" 3 4
             ((void *)0)
# 728 "MagickWand/display.c"
        ...
        if (LocaleCompare("borderwidth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 739,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 739 "MagickWand/display.c" 3 4
             ((void *)0)
# 739 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 739 "MagickWand/display.c" 3 4
             ((void *)0)
# 739 "MagickWand/display.c"
...
# 739 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 741,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 741 "MagickWand/display.c" 3 4
             ((void *)0)
# 741 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 741 "MagickWand/display.c" 3 4
             ((void *)0)
# 741 "MagickWand/display.c"
...
# 741 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 746,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 746 "MagickWand/display.c" 3 4
       ((void *)0)
# 746 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 746 "MagickWand/display.c" 3 4
       ((void *)0)
# 746 "MagickWand/display.c"
        ...
        if (LocaleCompare("cache",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 756,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 756 "MagickWand/display.c" 3 4
             ((void *)0)
# 756 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 756 "MagickWand/display.c" 3 4
             ((void *)0)
# 756 "MagickWand/display.c"
...
# 756 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 758,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 758 "MagickWand/display.c" 3 4
             ((void *)0)
# 758 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 758 "MagickWand/display.c" 3 4
             ((void *)0)
# 758 "MagickWand/display.c"
        ...
        if (LocaleCompare("channel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 770,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 770 "MagickWand/display.c" 3 4
             ((void *)0)
# 770 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 770 "MagickWand/display.c" 3 4
             ((void *)0)
# 770 "MagickWand/display.c"
...
# 770 "MagickWand/display.c"
            ...
            if (channel < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 773,OptionError,"UnrecognizedChannelType","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 773 "MagickWand/display.c" 3 4
             ((void *)0)
# 773 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 773 "MagickWand/display.c" 3 4
             ((void *)0)
# 773 "MagickWand/display.c"
        ...
        if (LocaleCompare("clip-path",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 783,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 783 "MagickWand/display.c" 3 4
             ((void *)0)
# 783 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 783 "MagickWand/display.c" 3 4
             ((void *)0)
# 783 "MagickWand/display.c"
        ...
        if (LocaleCompare("colormap",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 795,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 795 "MagickWand/display.c" 3 4
             ((void *)0)
# 795 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 795 "MagickWand/display.c" 3 4
             ((void *)0)
# 795 "MagickWand/display.c"
...
# 795 "MagickWand/display.c"
            ...
            if (resource_info.colormap == UndefinedColormap)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 802,OptionError,"UnrecognizedColormapType","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 802 "MagickWand/display.c" 3 4
             ((void *)0)
# 802 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 802 "MagickWand/display.c" 3 4
             ((void *)0)
# 802 "MagickWand/display.c"
        ...
        if (LocaleCompare("colors",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 813,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 813 "MagickWand/display.c" 3 4
             ((void *)0)
# 813 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 813 "MagickWand/display.c" 3 4
             ((void *)0)
# 813 "MagickWand/display.c"
...
# 813 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 815,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 815 "MagickWand/display.c" 3 4
             ((void *)0)
# 815 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 815 "MagickWand/display.c" 3 4
             ((void *)0)
# 815 "MagickWand/display.c"
        ...
        if (LocaleCompare("colorspace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 828,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 828 "MagickWand/display.c" 3 4
             ((void *)0)
# 828 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 828 "MagickWand/display.c" 3 4
             ((void *)0)
# 828 "MagickWand/display.c"
...
# 828 "MagickWand/display.c"
            ...
            colorspace=ParseCommandOption(MagickColorspaceOptions,
              MagickFalse,argv[i]);
            if (colorspace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 832,OptionError,"UnrecognizedColorspace","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 832 "MagickWand/display.c" 3 4
             ((void *)0)
# 832 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 832 "MagickWand/display.c" 3 4
             ((void *)0)
# 832 "MagickWand/display.c"
        ...
        if (LocaleCompare("comment",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 842,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 842 "MagickWand/display.c" 3 4
             ((void *)0)
# 842 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 842 "MagickWand/display.c" 3 4
             ((void *)0)
# 842 "MagickWand/display.c"
        ...
        if (LocaleCompare("compress",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 854,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 854 "MagickWand/display.c" 3 4
             ((void *)0)
# 854 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 854 "MagickWand/display.c" 3 4
             ((void *)0)
# 854 "MagickWand/display.c"
...
# 854 "MagickWand/display.c"
            ...
            compress=ParseCommandOption(MagickCompressOptions,MagickFalse,
              argv[i]);
            if (compress < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 858,OptionError,"UnrecognizedImageCompression","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 858 "MagickWand/display.c" 3 4
             ((void *)0)
# 858 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 858 "MagickWand/display.c" 3 4
             ((void *)0)
# 858 "MagickWand/display.c"
        ...
        if (LocaleCompare("crop",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 872,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 872 "MagickWand/display.c" 3 4
             ((void *)0)
# 872 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 872 "MagickWand/display.c" 3 4
             ((void *)0)
# 872 "MagickWand/display.c"
...
# 872 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 874,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 874 "MagickWand/display.c" 3 4
             ((void *)0)
# 874 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 874 "MagickWand/display.c" 3 4
             ((void *)0)
# 874 "MagickWand/display.c"
...
# 874 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 877,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 877 "MagickWand/display.c" 3 4
       ((void *)0)
# 877 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 877 "MagickWand/display.c" 3 4
       ((void *)0)
# 877 "MagickWand/display.c"
        ...
        if (LocaleCompare("debug",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 890,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 890 "MagickWand/display.c" 3 4
             ((void *)0)
# 890 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 890 "MagickWand/display.c" 3 4
             ((void *)0)
# 890 "MagickWand/display.c"
...
# 890 "MagickWand/display.c"
            ...
            if (event < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 893,OptionError,"UnrecognizedEventType","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 893 "MagickWand/display.c" 3 4
             ((void *)0)
# 893 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 893 "MagickWand/display.c" 3 4
             ((void *)0)
# 893 "MagickWand/display.c"
        ...
        if (LocaleCompare("decipher",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 904,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 904 "MagickWand/display.c" 3 4
             ((void *)0)
# 904 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 904 "MagickWand/display.c" 3 4
             ((void *)0)
# 904 "MagickWand/display.c"
        ...
        if (LocaleCompare("define",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 911,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 911 "MagickWand/display.c" 3 4
             ((void *)0)
# 911 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 911 "MagickWand/display.c" 3 4
             ((void *)0)
# 911 "MagickWand/display.c"
            ...
            if (*option == '+')
              {
                ...
                if (define == (const char *) 
# 918 "MagickWand/display.c" 3 4
                                            ((void *)0)
# 918 "MagickWand/display.c"
                                                )
                  { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 919,OptionError,"NoSuchOption","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 919 "MagickWand/display.c" 3 4
                 ((void *)0)
# 919 "MagickWand/display.c"
                 ) { XCloseDisplay(display); display=(Display *) 
# 919 "MagickWand/display.c" 3 4
                 ((void *)0)
# 919 "MagickWand/display.c"
        ...
        if (LocaleCompare("delay",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 930,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 930 "MagickWand/display.c" 3 4
             ((void *)0)
# 930 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 930 "MagickWand/display.c" 3 4
             ((void *)0)
# 930 "MagickWand/display.c"
...
# 930 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 932,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 932 "MagickWand/display.c" 3 4
             ((void *)0)
# 932 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 932 "MagickWand/display.c" 3 4
             ((void *)0)
# 932 "MagickWand/display.c"
        ...
        if (LocaleCompare("density",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 941,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 941 "MagickWand/display.c" 3 4
             ((void *)0)
# 941 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 941 "MagickWand/display.c" 3 4
             ((void *)0)
# 941 "MagickWand/display.c"
...
# 941 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 943,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 943 "MagickWand/display.c" 3 4
             ((void *)0)
# 943 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 943 "MagickWand/display.c" 3 4
             ((void *)0)
# 943 "MagickWand/display.c"
        ...
        if (LocaleCompare("depth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 952,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 952 "MagickWand/display.c" 3 4
             ((void *)0)
# 952 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 952 "MagickWand/display.c" 3 4
             ((void *)0)
# 952 "MagickWand/display.c"
...
# 952 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 954,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 954 "MagickWand/display.c" 3 4
             ((void *)0)
# 954 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 954 "MagickWand/display.c" 3 4
             ((void *)0)
# 954 "MagickWand/display.c"
        ...
        if (LocaleCompare("deskew",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 963,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 963 "MagickWand/display.c" 3 4
             ((void *)0)
# 963 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 963 "MagickWand/display.c" 3 4
             ((void *)0)
# 963 "MagickWand/display.c"
...
# 963 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 965,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 965 "MagickWand/display.c" 3 4
             ((void *)0)
# 965 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 965 "MagickWand/display.c" 3 4
             ((void *)0)
# 965 "MagickWand/display.c"
        ...
        if (LocaleCompare("display",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 976,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 976 "MagickWand/display.c" 3 4
             ((void *)0)
# 976 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 976 "MagickWand/display.c" 3 4
             ((void *)0)
# 976 "MagickWand/display.c"
        ...
        if (LocaleCompare("dispose",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 988,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 988 "MagickWand/display.c" 3 4
             ((void *)0)
# 988 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 988 "MagickWand/display.c" 3 4
             ((void *)0)
# 988 "MagickWand/display.c"
...
# 988 "MagickWand/display.c"
            ...
            if (dispose < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 991,OptionError,"UnrecognizedDisposeMethod","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 991 "MagickWand/display.c" 3 4
             ((void *)0)
# 991 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 991 "MagickWand/display.c" 3 4
             ((void *)0)
# 991 "MagickWand/display.c"
        ...
        if (LocaleCompare("dither",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1005,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1005 "MagickWand/display.c" 3 4
             ((void *)0)
# 1005 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1005 "MagickWand/display.c" 3 4
             ((void *)0)
# 1005 "MagickWand/display.c"
...
# 1005 "MagickWand/display.c"
            ...
            if (method < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1008,OptionError,"UnrecognizedDitherMethod","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1008 "MagickWand/display.c" 3 4
             ((void *)0)
# 1008 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1008 "MagickWand/display.c" 3 4
             ((void *)0)
# 1008 "MagickWand/display.c"
        ...
        if (LocaleCompare("duration",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1019,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1019 "MagickWand/display.c" 3 4
             ((void *)0)
# 1019 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1019 "MagickWand/display.c" 3 4
             ((void *)0)
# 1019 "MagickWand/display.c"
...
# 1019 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1021,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1021 "MagickWand/display.c" 3 4
             ((void *)0)
# 1021 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1021 "MagickWand/display.c" 3 4
             ((void *)0)
# 1021 "MagickWand/display.c"
...
# 1021 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1024,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1024 "MagickWand/display.c" 3 4
       ((void *)0)
# 1024 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1024 "MagickWand/display.c" 3 4
       ((void *)0)
# 1024 "MagickWand/display.c"
        ...
        if (LocaleCompare("edge",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1034,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1034 "MagickWand/display.c" 3 4
             ((void *)0)
# 1034 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1034 "MagickWand/display.c" 3 4
             ((void *)0)
# 1034 "MagickWand/display.c"
...
# 1034 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1036,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1036 "MagickWand/display.c" 3 4
             ((void *)0)
# 1036 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1036 "MagickWand/display.c" 3 4
             ((void *)0)
# 1036 "MagickWand/display.c"
        ...
        if (LocaleCompare("endian",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1048,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1048 "MagickWand/display.c" 3 4
             ((void *)0)
# 1048 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1048 "MagickWand/display.c" 3 4
             ((void *)0)
# 1048 "MagickWand/display.c"
...
# 1048 "MagickWand/display.c"
            ...
            endian=ParseCommandOption(MagickEndianOptions,MagickFalse,
              argv[i]);
            if (endian < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1052,OptionError,"UnrecognizedEndianType","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1052 "MagickWand/display.c" 3 4
             ((void *)0)
# 1052 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1052 "MagickWand/display.c" 3 4
             ((void *)0)
# 1052 "MagickWand/display.c"
        ...
        if (LocaleCompare("extent",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1066,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1066 "MagickWand/display.c" 3 4
             ((void *)0)
# 1066 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1066 "MagickWand/display.c" 3 4
             ((void *)0)
# 1066 "MagickWand/display.c"
...
# 1066 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1068,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1068 "MagickWand/display.c" 3 4
             ((void *)0)
# 1068 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1068 "MagickWand/display.c" 3 4
             ((void *)0)
# 1068 "MagickWand/display.c"
        ...
        if (LocaleCompare("extract",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1077,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1077 "MagickWand/display.c" 3 4
             ((void *)0)
# 1077 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1077 "MagickWand/display.c" 3 4
             ((void *)0)
# 1077 "MagickWand/display.c"
...
# 1077 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1079,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1079 "MagickWand/display.c" 3 4
             ((void *)0)
# 1079 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1079 "MagickWand/display.c" 3 4
             ((void *)0)
# 1079 "MagickWand/display.c"
...
# 1079 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1082,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1082 "MagickWand/display.c" 3 4
       ((void *)0)
# 1082 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1082 "MagickWand/display.c" 3 4
       ((void *)0)
# 1082 "MagickWand/display.c"
        ...
        if (LocaleCompare("filter",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1095,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1095 "MagickWand/display.c" 3 4
             ((void *)0)
# 1095 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1095 "MagickWand/display.c" 3 4
             ((void *)0)
# 1095 "MagickWand/display.c"
...
# 1095 "MagickWand/display.c"
            ...
            if (filter < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1098,OptionError,"UnrecognizedImageFilter","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1098 "MagickWand/display.c" 3 4
             ((void *)0)
# 1098 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1098 "MagickWand/display.c" 3 4
             ((void *)0)
# 1098 "MagickWand/display.c"
        ...
        if (LocaleCompare("font",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1114,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1114 "MagickWand/display.c" 3 4
             ((void *)0)
# 1114 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1114 "MagickWand/display.c" 3 4
             ((void *)0)
# 1114 "MagickWand/display.c"
        ...
        if (LocaleCompare("foreground",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1125,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1125 "MagickWand/display.c" 3 4
             ((void *)0)
# 1125 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1125 "MagickWand/display.c" 3 4
             ((void *)0)
# 1125 "MagickWand/display.c"
        ...
        if (LocaleCompare("format",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1135,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1135 "MagickWand/display.c" 3 4
             ((void *)0)
# 1135 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1135 "MagickWand/display.c" 3 4
             ((void *)0)
# 1135 "MagickWand/display.c"
        ...
        if (LocaleCompare("frame",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1144,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1144 "MagickWand/display.c" 3 4
             ((void *)0)
# 1144 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1144 "MagickWand/display.c" 3 4
             ((void *)0)
# 1144 "MagickWand/display.c"
...
# 1144 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1146,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1146 "MagickWand/display.c" 3 4
             ((void *)0)
# 1146 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1146 "MagickWand/display.c" 3 4
             ((void *)0)
# 1146 "MagickWand/display.c"
        ...
        if (LocaleCompare("fuzz",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1155,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1155 "MagickWand/display.c" 3 4
             ((void *)0)
# 1155 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1155 "MagickWand/display.c" 3 4
             ((void *)0)
# 1155 "MagickWand/display.c"
...
# 1155 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1157,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1157 "MagickWand/display.c" 3 4
             ((void *)0)
# 1157 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1157 "MagickWand/display.c" 3 4
             ((void *)0)
# 1157 "MagickWand/display.c"
...
# 1157 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1160,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1160 "MagickWand/display.c" 3 4
       ((void *)0)
# 1160 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1160 "MagickWand/display.c" 3 4
       ((void *)0)
# 1160 "MagickWand/display.c"
        ...
        if (LocaleCompare("gamma",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1168,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1168 "MagickWand/display.c" 3 4
             ((void *)0)
# 1168 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1168 "MagickWand/display.c" 3 4
             ((void *)0)
# 1168 "MagickWand/display.c"
...
# 1168 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1170,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1170 "MagickWand/display.c" 3 4
             ((void *)0)
# 1170 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1170 "MagickWand/display.c" 3 4
             ((void *)0)
# 1170 "MagickWand/display.c"
...
# 1175 "MagickWand/display.c" 3 4
                                                 ((void *)0)
# 1175 "MagickWand/display.c"
                                                     ;
            if (*option == '+')
              break;
            (void) CopyMagickString(argv[i]+1,"sans",4096);
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1181,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1181 "MagickWand/display.c" 3 4
             ((void *)0)
# 1181 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1181 "MagickWand/display.c" 3 4
             ((void *)0)
# 1181 "MagickWand/display.c"
...
# 1181 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1183,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1183 "MagickWand/display.c" 3 4
             ((void *)0)
# 1183 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1183 "MagickWand/display.c" 3 4
             ((void *)0)
# 1183 "MagickWand/display.c"
        ...
        if (LocaleCompare("gravity",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1196,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1196 "MagickWand/display.c" 3 4
             ((void *)0)
# 1196 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1196 "MagickWand/display.c" 3 4
             ((void *)0)
# 1196 "MagickWand/display.c"
...
# 1196 "MagickWand/display.c"
            ...
            gravity=ParseCommandOption(MagickGravityOptions,MagickFalse,
              argv[i]);
            if (gravity < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1200,OptionError,"UnrecognizedGravityType","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1200 "MagickWand/display.c" 3 4
             ((void *)0)
# 1200 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1200 "MagickWand/display.c" 3 4
             ((void *)0)
# 1200 "MagickWand/display.c"
...
# 1200 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1204,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1204 "MagickWand/display.c" 3 4
       ((void *)0)
# 1204 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1204 "MagickWand/display.c" 3 4
       ((void *)0)
# 1204 "MagickWand/display.c"
...
# 1204 "MagickWand/display.c"
      ...
      case 'h':
      {
        if ((LocaleCompare("help",option+1) == 0) ||
            (LocaleCompare("-help",option+1) == 0))
          break;
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1211,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1211 "MagickWand/display.c" 3 4
       ((void *)0)
# 1211 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1211 "MagickWand/display.c" 3 4
       ((void *)0)
# 1211 "MagickWand/display.c"
...
# 1211 "MagickWand/display.c"
      ...
      case 'i':
      {
        ...
        if (LocaleCompare("iconGeometry",option+1) == 0)
          {
            resource_info.icon_geometry=(char *) 
# 1219 "MagickWand/display.c" 3 4
                                                ((void *)0)
# 1219 "MagickWand/display.c"
                                                    ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1224,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1224 "MagickWand/display.c" 3 4
             ((void *)0)
# 1224 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1224 "MagickWand/display.c" 3 4
             ((void *)0)
# 1224 "MagickWand/display.c"
...
# 1224 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1226,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1226 "MagickWand/display.c" 3 4
             ((void *)0)
# 1226 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1226 "MagickWand/display.c" 3 4
             ((void *)0)
# 1226 "MagickWand/display.c"
        ...
        if (LocaleCompare("interlace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1249,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1249 "MagickWand/display.c" 3 4
             ((void *)0)
# 1249 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1249 "MagickWand/display.c" 3 4
             ((void *)0)
# 1249 "MagickWand/display.c"
...
# 1249 "MagickWand/display.c"
            ...
            interlace=ParseCommandOption(MagickInterlaceOptions,MagickFalse,
              argv[i]);
            if (interlace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1253,OptionError,"UnrecognizedInterlaceType","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1253 "MagickWand/display.c" 3 4
             ((void *)0)
# 1253 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1253 "MagickWand/display.c" 3 4
             ((void *)0)
# 1253 "MagickWand/display.c"
        ...
        if (LocaleCompare("interpolate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1266,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1266 "MagickWand/display.c" 3 4
             ((void *)0)
# 1266 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1266 "MagickWand/display.c" 3 4
             ((void *)0)
# 1266 "MagickWand/display.c"
...
# 1266 "MagickWand/display.c"
            ...
            interpolate=ParseCommandOption(MagickInterpolateOptions,MagickFalse,
              argv[i]);
            if (interpolate < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1270,OptionError,"UnrecognizedInterpolateMethod","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1270 "MagickWand/display.c" 3 4
             ((void *)0)
# 1270 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1270 "MagickWand/display.c" 3 4
             ((void *)0)
# 1270 "MagickWand/display.c"
...
# 1270 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1274,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1274 "MagickWand/display.c" 3 4
       ((void *)0)
# 1274 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1274 "MagickWand/display.c" 3 4
       ((void *)0)
# 1274 "MagickWand/display.c"
        ...
        if (LocaleCompare("label",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1284,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1284 "MagickWand/display.c" 3 4
             ((void *)0)
# 1284 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1284 "MagickWand/display.c" 3 4
             ((void *)0)
# 1284 "MagickWand/display.c"
        ...
        if (LocaleCompare("limit",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1302,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1302 "MagickWand/display.c" 3 4
             ((void *)0)
# 1302 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1302 "MagickWand/display.c" 3 4
             ((void *)0)
# 1302 "MagickWand/display.c"
...
# 1302 "MagickWand/display.c"
            ...
            resource=ParseCommandOption(MagickResourceOptions,MagickFalse,
              argv[i]);
            if (resource < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1306,OptionError,"UnrecognizedResourceType","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1306 "MagickWand/display.c" 3 4
             ((void *)0)
# 1306 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1306 "MagickWand/display.c" 3 4
             ((void *)0)
# 1306 "MagickWand/display.c"
...
# 1306 "MagickWand/display.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1310,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1310 "MagickWand/display.c" 3 4
             ((void *)0)
# 1310 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1310 "MagickWand/display.c" 3 4
             ((void *)0)
# 1310 "MagickWand/display.c"
...
# 1310 "MagickWand/display.c"
            ...
            if ((p == argv[i]) && (LocaleCompare("unlimited",argv[i]) != 0))
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1314,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1314 "MagickWand/display.c" 3 4
             ((void *)0)
# 1314 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1314 "MagickWand/display.c" 3 4
             ((void *)0)
# 1314 "MagickWand/display.c"
        ...
        if (LocaleCompare("list",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1326,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1326 "MagickWand/display.c" 3 4
             ((void *)0)
# 1326 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1326 "MagickWand/display.c" 3 4
             ((void *)0)
# 1326 "MagickWand/display.c"
...
# 1326 "MagickWand/display.c"
            ...
            if (list < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1329,OptionError,"UnrecognizedListType","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1329 "MagickWand/display.c" 3 4
             ((void *)0)
# 1329 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1329 "MagickWand/display.c" 3 4
             ((void *)0)
# 1329 "MagickWand/display.c"
...
# 1329 "MagickWand/display.c"
            ...
            status=MogrifyImageInfo(image_info,(int) (i-j+1),(const char **)
              argv+j,exception);
            { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1332 "MagickWand/display.c" 3 4
           ((void *)0)
# 1332 "MagickWand/display.c"
           ) { XCloseDisplay(display); display=(Display *) 
# 1332 "MagickWand/display.c" 3 4
           ((void *)0)
# 1332 "MagickWand/display.c"
        ...
        if (LocaleCompare("log",option+1) == 0)
          {
            ...
            if ((i == (ssize_t) argc) ||
                (strchr(argv[i],'%') == (char *) 
# 1341 "MagickWand/display.c" 3 4
                                                ((void *)0)
# 1341 "MagickWand/display.c"
                                                    ))
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1342,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1342 "MagickWand/display.c" 3 4
             ((void *)0)
# 1342 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1342 "MagickWand/display.c" 3 4
             ((void *)0)
# 1342 "MagickWand/display.c"
        ...
        if (LocaleCompare("loop",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1351,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1351 "MagickWand/display.c" 3 4
             ((void *)0)
# 1351 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1351 "MagickWand/display.c" 3 4
             ((void *)0)
# 1351 "MagickWand/display.c"
...
# 1351 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1353,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1353 "MagickWand/display.c" 3 4
             ((void *)0)
# 1353 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1353 "MagickWand/display.c" 3 4
             ((void *)0)
# 1353 "MagickWand/display.c"
...
# 1353 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1357,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1357 "MagickWand/display.c" 3 4
       ((void *)0)
# 1357 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1357 "MagickWand/display.c" 3 4
       ((void *)0)
# 1357 "MagickWand/display.c"
        ...
        if (LocaleCompare("magnify",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1368,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1368 "MagickWand/display.c" 3 4
             ((void *)0)
# 1368 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1368 "MagickWand/display.c" 3 4
             ((void *)0)
# 1368 "MagickWand/display.c"
...
# 1368 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1370,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1370 "MagickWand/display.c" 3 4
             ((void *)0)
# 1370 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1370 "MagickWand/display.c" 3 4
             ((void *)0)
# 1370 "MagickWand/display.c"
...
# 1370 "MagickWand/display.c"
        ...
        if (LocaleCompare("map",option+1) == 0)
          {
            resource_info.map_type=(char *) 
# 1376 "MagickWand/display.c" 3 4
                                           ((void *)0)
# 1376 "MagickWand/display.c"
                                               ;
            if (*option == '+')
              break;
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1382,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1382 "MagickWand/display.c" 3 4
             ((void *)0)
# 1382 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1382 "MagickWand/display.c" 3 4
             ((void *)0)
# 1382 "MagickWand/display.c"
        ...
        if (LocaleCompare("mattecolor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1394,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1394 "MagickWand/display.c" 3 4
             ((void *)0)
# 1394 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1394 "MagickWand/display.c" 3 4
             ((void *)0)
# 1394 "MagickWand/display.c"
...
# 1394 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1408,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1408 "MagickWand/display.c" 3 4
       ((void *)0)
# 1408 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1408 "MagickWand/display.c" 3 4
       ((void *)0)
# 1408 "MagickWand/display.c"
...
# 1408 "MagickWand/display.c"
      ...
      case 'n':
      {
        if (LocaleCompare("name",option+1) == 0)
          {
            resource_info.name=(char *) 
# 1414 "MagickWand/display.c" 3 4
                                       ((void *)0)
# 1414 "MagickWand/display.c"
                                           ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1419,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1419 "MagickWand/display.c" 3 4
             ((void *)0)
# 1419 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1419 "MagickWand/display.c" 3 4
             ((void *)0)
# 1419 "MagickWand/display.c"
...
# 1419 "MagickWand/display.c"
        ...
        if (LocaleCompare("nostdin",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1431,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1431 "MagickWand/display.c" 3 4
       ((void *)0)
# 1431 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1431 "MagickWand/display.c" 3 4
       ((void *)0)
# 1431 "MagickWand/display.c"
...
# 1431 "MagickWand/display.c"
      ...
      case 'p':
      {
        if (LocaleCompare("page",option+1) == 0)
          {
            resource_info.image_geometry=(char *) 
# 1437 "MagickWand/display.c" 3 4
                                                 ((void *)0)
# 1437 "MagickWand/display.c"
                                                     ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1442,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1442 "MagickWand/display.c" 3 4
             ((void *)0)
# 1442 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1442 "MagickWand/display.c" 3 4
             ((void *)0)
# 1442 "MagickWand/display.c"
        ...
        if (LocaleCompare("profile",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1450,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1450 "MagickWand/display.c" 3 4
             ((void *)0)
# 1450 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1450 "MagickWand/display.c" 3 4
             ((void *)0)
# 1450 "MagickWand/display.c"
...
# 1450 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1453,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1453 "MagickWand/display.c" 3 4
       ((void *)0)
# 1453 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1453 "MagickWand/display.c" 3 4
       ((void *)0)
# 1453 "MagickWand/display.c"
        ...
        if (LocaleCompare("quality",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1463,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1463 "MagickWand/display.c" 3 4
             ((void *)0)
# 1463 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1463 "MagickWand/display.c" 3 4
             ((void *)0)
# 1463 "MagickWand/display.c"
...
# 1463 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1465,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1465 "MagickWand/display.c" 3 4
             ((void *)0)
# 1465 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1465 "MagickWand/display.c" 3 4
             ((void *)0)
# 1465 "MagickWand/display.c"
        ...
        if (LocaleCompare("quantize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1477,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1477 "MagickWand/display.c" 3 4
             ((void *)0)
# 1477 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1477 "MagickWand/display.c" 3 4
             ((void *)0)
# 1477 "MagickWand/display.c"
...
# 1477 "MagickWand/display.c"
            ...
            colorspace=ParseCommandOption(MagickColorspaceOptions,
              MagickFalse,argv[i]);
            if (colorspace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1481,OptionError,"UnrecognizedColorspace","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1481 "MagickWand/display.c" 3 4
             ((void *)0)
# 1481 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1481 "MagickWand/display.c" 3 4
             ((void *)0)
# 1481 "MagickWand/display.c"
...
# 1481 "MagickWand/display.c"
        ...
        if (LocaleCompare("quiet",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1487,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1487 "MagickWand/display.c" 3 4
       ((void *)0)
# 1487 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1487 "MagickWand/display.c" 3 4
       ((void *)0)
# 1487 "MagickWand/display.c"
        ...
        if (LocaleCompare("raise",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1495,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1495 "MagickWand/display.c" 3 4
             ((void *)0)
# 1495 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1495 "MagickWand/display.c" 3 4
             ((void *)0)
# 1495 "MagickWand/display.c"
...
# 1495 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1497,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1497 "MagickWand/display.c" 3 4
             ((void *)0)
# 1497 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1497 "MagickWand/display.c" 3 4
             ((void *)0)
# 1497 "MagickWand/display.c"
        ...
        if (LocaleCompare("remote",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1506,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1506 "MagickWand/display.c" 3 4
             ((void *)0)
# 1506 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1506 "MagickWand/display.c" 3 4
             ((void *)0)
# 1506 "MagickWand/display.c"
...
# 1506 "MagickWand/display.c"
            ...
            if (XRemoteCommand(display,resource_info.window_id,argv[i]) != 0)
              {
                { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1509 "MagickWand/display.c" 3 4
               ((void *)0)
# 1509 "MagickWand/display.c"
               ) { XCloseDisplay(display); display=(Display *) 
# 1509 "MagickWand/display.c" 3 4
               ((void *)0)
# 1509 "MagickWand/display.c"
        ...
        if (LocaleCompare("repage",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1521,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1521 "MagickWand/display.c" 3 4
             ((void *)0)
# 1521 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1521 "MagickWand/display.c" 3 4
             ((void *)0)
# 1521 "MagickWand/display.c"
...
# 1521 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1523,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1523 "MagickWand/display.c" 3 4
             ((void *)0)
# 1523 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1523 "MagickWand/display.c" 3 4
             ((void *)0)
# 1523 "MagickWand/display.c"
        ...
        if (LocaleCompare("resample",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1532,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1532 "MagickWand/display.c" 3 4
             ((void *)0)
# 1532 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1532 "MagickWand/display.c" 3 4
             ((void *)0)
# 1532 "MagickWand/display.c"
...
# 1532 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1534,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1534 "MagickWand/display.c" 3 4
             ((void *)0)
# 1534 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1534 "MagickWand/display.c" 3 4
             ((void *)0)
# 1534 "MagickWand/display.c"
        ...
        if (LocaleCompare("resize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1543,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1543 "MagickWand/display.c" 3 4
             ((void *)0)
# 1543 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1543 "MagickWand/display.c" 3 4
             ((void *)0)
# 1543 "MagickWand/display.c"
...
# 1543 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1545,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1545 "MagickWand/display.c" 3 4
             ((void *)0)
# 1545 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1545 "MagickWand/display.c" 3 4
             ((void *)0)
# 1545 "MagickWand/display.c"
        ...
        if (LocaleCompare("roll",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1559,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1559 "MagickWand/display.c" 3 4
             ((void *)0)
# 1559 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1559 "MagickWand/display.c" 3 4
             ((void *)0)
# 1559 "MagickWand/display.c"
...
# 1559 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1561,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1561 "MagickWand/display.c" 3 4
             ((void *)0)
# 1561 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1561 "MagickWand/display.c" 3 4
             ((void *)0)
# 1561 "MagickWand/display.c"
        ...
        if (LocaleCompare("rotate",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1568,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1568 "MagickWand/display.c" 3 4
             ((void *)0)
# 1568 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1568 "MagickWand/display.c" 3 4
             ((void *)0)
# 1568 "MagickWand/display.c"
...
# 1568 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1570,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1570 "MagickWand/display.c" 3 4
             ((void *)0)
# 1570 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1570 "MagickWand/display.c" 3 4
             ((void *)0)
# 1570 "MagickWand/display.c"
...
# 1570 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1573,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1573 "MagickWand/display.c" 3 4
       ((void *)0)
# 1573 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1573 "MagickWand/display.c" 3 4
       ((void *)0)
# 1573 "MagickWand/display.c"
        ...
        if (LocaleCompare("sample",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1583,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1583 "MagickWand/display.c" 3 4
             ((void *)0)
# 1583 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1583 "MagickWand/display.c" 3 4
             ((void *)0)
# 1583 "MagickWand/display.c"
...
# 1583 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1585,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1585 "MagickWand/display.c" 3 4
             ((void *)0)
# 1585 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1585 "MagickWand/display.c" 3 4
             ((void *)0)
# 1585 "MagickWand/display.c"
        ...
        if (LocaleCompare("sampling-factor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1594,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1594 "MagickWand/display.c" 3 4
             ((void *)0)
# 1594 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1594 "MagickWand/display.c" 3 4
             ((void *)0)
# 1594 "MagickWand/display.c"
...
# 1594 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1596,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1596 "MagickWand/display.c" 3 4
             ((void *)0)
# 1596 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1596 "MagickWand/display.c" 3 4
             ((void *)0)
# 1596 "MagickWand/display.c"
        ...
        if (LocaleCompare("scenes",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1605,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1605 "MagickWand/display.c" 3 4
             ((void *)0)
# 1605 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1605 "MagickWand/display.c" 3 4
             ((void *)0)
# 1605 "MagickWand/display.c"
...
# 1605 "MagickWand/display.c"
            ...
            if (IsSceneGeometry(argv[i],MagickFalse) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1607,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1607 "MagickWand/display.c" 3 4
             ((void *)0)
# 1607 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1607 "MagickWand/display.c" 3 4
             ((void *)0)
# 1607 "MagickWand/display.c"
        ...
        if (LocaleCompare("seed",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1616,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1616 "MagickWand/display.c" 3 4
             ((void *)0)
# 1616 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1616 "MagickWand/display.c" 3 4
             ((void *)0)
# 1616 "MagickWand/display.c"
...
# 1616 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1618,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1618 "MagickWand/display.c" 3 4
             ((void *)0)
# 1618 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1618 "MagickWand/display.c" 3 4
             ((void *)0)
# 1618 "MagickWand/display.c"
        ...
        if (LocaleCompare("segment",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1627,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1627 "MagickWand/display.c" 3 4
             ((void *)0)
# 1627 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1627 "MagickWand/display.c" 3 4
             ((void *)0)
# 1627 "MagickWand/display.c"
...
# 1627 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1629,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1629 "MagickWand/display.c" 3 4
             ((void *)0)
# 1629 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1629 "MagickWand/display.c" 3 4
             ((void *)0)
# 1629 "MagickWand/display.c"
        ...
        if (LocaleCompare("set",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1636,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1636 "MagickWand/display.c" 3 4
             ((void *)0)
# 1636 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1636 "MagickWand/display.c" 3 4
             ((void *)0)
# 1636 "MagickWand/display.c"
...
# 1636 "MagickWand/display.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1641,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1641 "MagickWand/display.c" 3 4
             ((void *)0)
# 1641 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1641 "MagickWand/display.c" 3 4
             ((void *)0)
# 1641 "MagickWand/display.c"
        ...
        if (LocaleCompare("sharpen",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1650,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1650 "MagickWand/display.c" 3 4
             ((void *)0)
# 1650 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1650 "MagickWand/display.c" 3 4
             ((void *)0)
# 1650 "MagickWand/display.c"
...
# 1650 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1652,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1652 "MagickWand/display.c" 3 4
             ((void *)0)
# 1652 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1652 "MagickWand/display.c" 3 4
             ((void *)0)
# 1652 "MagickWand/display.c"
        ...
        if (LocaleCompare("size",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1667,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1667 "MagickWand/display.c" 3 4
             ((void *)0)
# 1667 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1667 "MagickWand/display.c" 3 4
             ((void *)0)
# 1667 "MagickWand/display.c"
...
# 1667 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1669,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1669 "MagickWand/display.c" 3 4
             ((void *)0)
# 1669 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1669 "MagickWand/display.c" 3 4
             ((void *)0)
# 1669 "MagickWand/display.c"
...
# 1669 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1679,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1679 "MagickWand/display.c" 3 4
       ((void *)0)
# 1679 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1679 "MagickWand/display.c" 3 4
       ((void *)0)
# 1679 "MagickWand/display.c"
...
# 1679 "MagickWand/display.c"
      ...
      case 't':
      {
        if (LocaleCompare("text-font",option+1) == 0)
          {
            resource_info.text_font=(char *) 
# 1685 "MagickWand/display.c" 3 4
                                            ((void *)0)
# 1685 "MagickWand/display.c"
                                                ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1690,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1690 "MagickWand/display.c" 3 4
             ((void *)0)
# 1690 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1690 "MagickWand/display.c" 3 4
             ((void *)0)
# 1690 "MagickWand/display.c"
        ...
        if (LocaleCompare("texture",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1701,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1701 "MagickWand/display.c" 3 4
             ((void *)0)
# 1701 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1701 "MagickWand/display.c" 3 4
             ((void *)0)
# 1701 "MagickWand/display.c"
        ...
        if (LocaleCompare("threshold",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1710,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1710 "MagickWand/display.c" 3 4
             ((void *)0)
# 1710 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1710 "MagickWand/display.c" 3 4
             ((void *)0)
# 1710 "MagickWand/display.c"
...
# 1710 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1712,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1712 "MagickWand/display.c" 3 4
             ((void *)0)
# 1712 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1712 "MagickWand/display.c" 3 4
             ((void *)0)
# 1712 "MagickWand/display.c"
        ...
        if (LocaleCompare("thumbnail",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1721,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1721 "MagickWand/display.c" 3 4
             ((void *)0)
# 1721 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1721 "MagickWand/display.c" 3 4
             ((void *)0)
# 1721 "MagickWand/display.c"
...
# 1721 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1723,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1723 "MagickWand/display.c" 3 4
             ((void *)0)
# 1723 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1723 "MagickWand/display.c" 3 4
             ((void *)0)
# 1723 "MagickWand/display.c"
...
# 1723 "MagickWand/display.c"
        ...
        if (LocaleCompare("title",option+1) == 0)
          {
            resource_info.title=(char *) 
# 1728 "MagickWand/display.c" 3 4
                                        ((void *)0)
# 1728 "MagickWand/display.c"
                                            ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1733,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1733 "MagickWand/display.c" 3 4
             ((void *)0)
# 1733 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1733 "MagickWand/display.c" 3 4
             ((void *)0)
# 1733 "MagickWand/display.c"
        ...
        if (LocaleCompare("transparent-color",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1743,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1743 "MagickWand/display.c" 3 4
             ((void *)0)
# 1743 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1743 "MagickWand/display.c" 3 4
             ((void *)0)
# 1743 "MagickWand/display.c"
        ...
        if (LocaleCompare("treedepth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1753,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1753 "MagickWand/display.c" 3 4
             ((void *)0)
# 1753 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1753 "MagickWand/display.c" 3 4
             ((void *)0)
# 1753 "MagickWand/display.c"
...
# 1753 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1755,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1755 "MagickWand/display.c" 3 4
             ((void *)0)
# 1755 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1755 "MagickWand/display.c" 3 4
             ((void *)0)
# 1755 "MagickWand/display.c"
...
# 1755 "MagickWand/display.c"
        ...
        if (LocaleCompare("trim",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1761,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1761 "MagickWand/display.c" 3 4
       ((void *)0)
# 1761 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1761 "MagickWand/display.c" 3 4
       ((void *)0)
# 1761 "MagickWand/display.c"
        ...
        if (LocaleCompare("update",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1772,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1772 "MagickWand/display.c" 3 4
             ((void *)0)
# 1772 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1772 "MagickWand/display.c" 3 4
             ((void *)0)
# 1772 "MagickWand/display.c"
...
# 1772 "MagickWand/display.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1774,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1774 "MagickWand/display.c" 3 4
             ((void *)0)
# 1774 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1774 "MagickWand/display.c" 3 4
             ((void *)0)
# 1774 "MagickWand/display.c"
...
# 1774 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1784,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1784 "MagickWand/display.c" 3 4
       ((void *)0)
# 1784 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1784 "MagickWand/display.c" 3 4
       ((void *)0)
# 1784 "MagickWand/display.c"
...
# 1784 "MagickWand/display.c"
      ...
      case 'v':
      {
        ...
        if ((LocaleCompare("version",option+1) == 0) ||
          ...
          {
            ListMagickVersion(
# 1793 "MagickWand/display.c" 3 4
                             stdout
# 1793 "MagickWand/display.c"
                                   );
            break;
          }
        if (LocaleCompare("visual",option+1) == 0)
          {
            resource_info.visual_type=(char *) 
# 1798 "MagickWand/display.c" 3 4
                                              ((void *)0)
# 1798 "MagickWand/display.c"
                                                  ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1803,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1803 "MagickWand/display.c" 3 4
             ((void *)0)
# 1803 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1803 "MagickWand/display.c" 3 4
             ((void *)0)
# 1803 "MagickWand/display.c"
        ...
        if (LocaleCompare("virtual-pixel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1816,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1816 "MagickWand/display.c" 3 4
             ((void *)0)
# 1816 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1816 "MagickWand/display.c" 3 4
             ((void *)0)
# 1816 "MagickWand/display.c"
...
# 1816 "MagickWand/display.c"
            ...
            method=ParseCommandOption(MagickVirtualPixelOptions,MagickFalse,
              argv[i]);
            if (method < 0)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1820,OptionError,"UnrecognizedVirtualPixelMethod","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1820 "MagickWand/display.c" 3 4
             ((void *)0)
# 1820 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1820 "MagickWand/display.c" 3 4
             ((void *)0)
# 1820 "MagickWand/display.c"
...
# 1820 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1824,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1824 "MagickWand/display.c" 3 4
       ((void *)0)
# 1824 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1824 "MagickWand/display.c" 3 4
       ((void *)0)
# 1824 "MagickWand/display.c"
...
# 1824 "MagickWand/display.c"
      ...
      case 'w':
      {
        if (LocaleCompare("window",option+1) == 0)
          {
            resource_info.window_id=(char *) 
# 1830 "MagickWand/display.c" 3 4
                                            ((void *)0)
# 1830 "MagickWand/display.c"
                                                ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1835,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1835 "MagickWand/display.c" 3 4
             ((void *)0)
# 1835 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1835 "MagickWand/display.c" 3 4
             ((void *)0)
# 1835 "MagickWand/display.c"
...
# 1835 "MagickWand/display.c"
        ...
        if (LocaleCompare("window-group",option+1) == 0)
          {
            resource_info.window_group=(char *) 
# 1841 "MagickWand/display.c" 3 4
                                               ((void *)0)
# 1841 "MagickWand/display.c"
                                                   ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1846,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1846 "MagickWand/display.c" 3 4
             ((void *)0)
# 1846 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1846 "MagickWand/display.c" 3 4
             ((void *)0)
# 1846 "MagickWand/display.c"
...
# 1846 "MagickWand/display.c"
            ...
            if (StringToDouble(argv[i],(char **) 
# 1847 "MagickWand/display.c" 3 4
                                                ((void *)0)
# 1847 "MagickWand/display.c"
                                                    ) != 0)
        ...
        if (LocaleCompare("write",option+1) == 0)
          {
            resource_info.write_filename=(char *) 
# 1853 "MagickWand/display.c" 3 4
                                                 ((void *)0)
# 1853 "MagickWand/display.c"
                                                     ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1858,OptionError,"MissingArgument","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1858 "MagickWand/display.c" 3 4
             ((void *)0)
# 1858 "MagickWand/display.c"
             ) { XCloseDisplay(display); display=(Display *) 
# 1858 "MagickWand/display.c" 3 4
             ((void *)0)
# 1858 "MagickWand/display.c"
...
# 1866 "MagickWand/display.c" 3 4
                                       stderr
# 1866 "MagickWand/display.c"
                                             ,"Overwrite %s? ",
                  resource_info.write_filename);
                p=fgets(answer,(int) sizeof(answer),
# 1868 "MagickWand/display.c" 3 4
                                                   stdin
# 1868 "MagickWand/display.c"
                                                        );
                (void) p;
                if (((*answer != 'y') && (*answer != 'Y')))
                  {
                    { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1872 "MagickWand/display.c" 3 4
                   ((void *)0)
# 1872 "MagickWand/display.c"
                   ) { XCloseDisplay(display); display=(Display *) 
# 1872 "MagickWand/display.c" 3 4
                   ((void *)0)
# 1872 "MagickWand/display.c"
...
# 1872 "MagickWand/display.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1878,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1878 "MagickWand/display.c" 3 4
       ((void *)0)
# 1878 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1878 "MagickWand/display.c" 3 4
       ((void *)0)
# 1878 "MagickWand/display.c"
...
# 1878 "MagickWand/display.c"
      ...
      case '?':
        break;
      default:
        { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1883,OptionError,"UnrecognizedOption","`%s'", option); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1883 "MagickWand/display.c" 3 4
       ((void *)0)
# 1883 "MagickWand/display.c"
       ) { XCloseDisplay(display); display=(Display *) 
# 1883 "MagickWand/display.c" 3 4
       ((void *)0)
# 1883 "MagickWand/display.c"
...
# 1883 "MagickWand/display.c"
    ...
    if (fire != MagickFalse)
      if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 1888 "MagickWand/display.c" 3 4
     ((void *)0)
# 1888 "MagickWand/display.c"
     ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickFalse,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
  }
  if (k != 0)
    { (void) ThrowMagickException(exception,"MagickWand/display.c",__func__,(unsigned long) 1891,OptionError,"UnbalancedParenthesis","`%s'", argv[i]); { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1891 "MagickWand/display.c" 3 4
   ((void *)0)
# 1891 "MagickWand/display.c"
   ) { XCloseDisplay(display); display=(Display *) 
# 1891 "MagickWand/display.c" 3 4
   ((void *)0)
# 1891 "MagickWand/display.c"
...
# 1891 "MagickWand/display.c"
  ...
  { if ((state & ExitState) == 0) DestroyXResources(); if (display != (Display *) 
# 1897 "MagickWand/display.c" 3 4
 ((void *)0)
# 1897 "MagickWand/display.c"
 ) { XCloseDisplay(display); display=(Display *) 
# 1897 "MagickWand/display.c" 3 4
 ((void *)0)
# 1897 "MagickWand/display.c"
