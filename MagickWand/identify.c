# 0 "MagickWand/identify.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/identify.c"
# 50 "MagickWand/identify.c"
...
# 54 "MagickWand/identify.c" 2
# 93 "MagickWand/identify.c"
static MagickBooleanType IdentifyUsage(void)
{
  ...
  ListMagickVersion(
# 151 "MagickWand/identify.c" 3 4
                   stdout
# 151 "MagickWand/identify.c"
                         );
...
__attribute__ ((visibility ("default"))) MagickBooleanType IdentifyImageCommand(ImageInfo *image_info,
  int argc,char **argv,char **metadata,ExceptionInfo *exception)
{
# 197 "MagickWand/identify.c"
  const char
    *format,
    *option;
...
# 228 "MagickWand/identify.c" 3 4
 ((void) sizeof ((
# 228 "MagickWand/identify.c"
...
# 228 "MagickWand/identify.c" 3 4
 , "MagickWand/identify.c", 228, __extension__ __PRETTY_FUNCTION__); }))
# 228 "MagickWand/identify.c"
                                         ;
  
# 229 "MagickWand/identify.c" 3 4
 ((void) sizeof ((
# 229 "MagickWand/identify.c"
...
# 229 "MagickWand/identify.c" 3 4
 , "MagickWand/identify.c", 229, __extension__ __PRETTY_FUNCTION__); }))
# 229 "MagickWand/identify.c"
                                                     ;
  
# 230 "MagickWand/identify.c" 3 4
 ((void) sizeof ((
# 230 "MagickWand/identify.c"
...
# 230 "MagickWand/identify.c" 3 4
 , "MagickWand/identify.c", 230, __extension__ __PRETTY_FUNCTION__); }))
# 230 "MagickWand/identify.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickWand/identify.c",__func__,(unsigned long) 232,"...");
  if (argc == 2)
    {
      option=argv[1];
      if ((LocaleCompare("version",option+1) == 0) ||
        ...
        {
          ListMagickVersion(
# 239 "MagickWand/identify.c" 3 4
                           stdout
# 239 "MagickWand/identify.c"
                                 );
          return(MagickTrue);
        }
    }
  if (argc < 2)
    {
      (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 245,OptionError,
        "MissingArgument","%s","");
      (void) IdentifyUsage();
      return(MagickFalse);
    }
  count=0;
  format=
# 251 "MagickWand/identify.c" 3 4
        ((void *)0)
# 251 "MagickWand/identify.c"
            ;
  j=1;
  k=0;
  ...
  option=(char *) 
# 255 "MagickWand/identify.c" 3 4
                 ((void *)0)
# 255 "MagickWand/identify.c"
                     ;
  pend=MagickFalse;
  ...
  if (status == MagickFalse)
    { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 265,ResourceLimitError,"MemoryAllocationFailed","`%s'", GetExceptionMessage(
# 265 "MagickWand/identify.c" 3 4
   (*__errno_location ())
# 265 "MagickWand/identify.c"
...
# 273 "MagickWand/identify.c" 3 4
       ((void *)0)
# 273 "MagickWand/identify.c"
        ...
        if (k == 128)
          { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 275,OptionError,"ParenthesisNestedTooDeeply","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                   ;
    ...
    if (LocaleCompare(option,")") == 0)
      {
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 282 "MagickWand/identify.c" 3 4
       ((void *)0)
# 282 "MagickWand/identify.c"
        ...
        if (k == 0)
          { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 284,OptionError,"UnableToParseExpression","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
    ...
    if (IsCommandOption(option) == MagickFalse)
      {
        ...
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 302 "MagickWand/identify.c" 3 4
       ((void *)0)
# 302 "MagickWand/identify.c"
...
# 313 "MagickWand/identify.c" 3 4
                                                       ((void *)0)
# 313 "MagickWand/identify.c"
                                                           ) &&
          (exception->severity < ErrorException);
        if (images == (Image *) 
# 315 "MagickWand/identify.c" 3 4
                               ((void *)0)
# 315 "MagickWand/identify.c"
                                   )
          continue;
        ...
        { if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 318 "MagickWand/identify.c" 3 4
       ((void *)0)
# 318 "MagickWand/identify.c"
...
# 318 "MagickWand/identify.c"
        ...
        count=0;
        for ( ; image != (Image *) 
# 320 "MagickWand/identify.c" 3 4
                                  ((void *)0)
# 320 "MagickWand/identify.c"
                                      ; image=GetNextImageInList(image))
        {
          if (image->scene == 0)
            image->scene=count++;
          if (format == (char *) 
# 324 "MagickWand/identify.c" 3 4
                                ((void *)0)
# 324 "MagickWand/identify.c"
                                    )
            {
              (void) IdentifyImage(image,
# 326 "MagickWand/identify.c" 3 4
                                        stdout
# 326 "MagickWand/identify.c"
                                              ,image_info->verbose,exception);
              continue;
            }
          if (metadata != (char **) 
# 329 "MagickWand/identify.c" 3 4
                                   ((void *)0)
# 329 "MagickWand/identify.c"
                                       )
            {
              char
                *text;
              ...
              if (text == (char *) 
# 335 "MagickWand/identify.c" 3 4
                                  ((void *)0)
# 335 "MagickWand/identify.c"
                                      )
                { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 336,ResourceLimitError,"MemoryAllocationFailed","`%s'", GetExceptionMessage(
# 336 "MagickWand/identify.c" 3 4
               (*__errno_location ())
# 336 "MagickWand/identify.c"
               )); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                                                                      ;
...
# 342 "MagickWand/identify.c" 3 4
       ((void *)0)
# 342 "MagickWand/identify.c"
       ) image_stack[k].image=DestroyImageList(image_stack[k].image); };
        continue;
      }
    pend=image != (Image *) 
# 345 "MagickWand/identify.c" 3 4
                           ((void *)0) 
# 345 "MagickWand/identify.c"
        ...
        if (LocaleCompare("alpha",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 360,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            type=ParseCommandOption(MagickAlphaChannelOptions,MagickFalse,
              argv[i]);
            if (type < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 364,OptionError,"UnrecognizedAlphaChannelOption","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                                                         ;
            break;
          }
        ...
        if (LocaleCompare("authenticate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 376,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("auto-orient",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 381,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'c':
      {
        if (LocaleCompare("cache",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 391,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 393,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("channel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 405,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            channel=ParseChannelOption(argv[i]);
            if (channel < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 408,OptionError,"UnrecognizedChannelType","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                        ;
            break;
          }
        ...
        if (LocaleCompare("clip-mask",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 420,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("clip-path",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 427,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("colorspace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 439,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            colorspace=ParseCommandOption(MagickColorspaceOptions,
              MagickFalse,argv[i]);
            if (colorspace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 443,OptionError,"UnrecognizedColorspace","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                        ;
            break;
          }
        if (LocaleCompare("crop",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 453,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 455,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("concurrent",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 460,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'd':
      {
        if (LocaleCompare("debug",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 473,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            event=ParseCommandOption(MagickLogEventOptions,MagickFalse,argv[i]);
            if (event < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 476,OptionError,"UnrecognizedEventType","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                        ;
        ...
        if (LocaleCompare("define",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 485,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (*option == '+')
              {
                const char
                  *define;
...
# 492 "MagickWand/identify.c" 3 4
                                            ((void *)0)
# 492 "MagickWand/identify.c"
                                                )
                  { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 493,OptionError,"NoSuchOption","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
                break;
              }
            break;
          }
        if (LocaleCompare("density",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 504,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 506,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("depth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 515,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 517,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("duration",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 526,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 528,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 531,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'e':
      {
        if (LocaleCompare("endian",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 544,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            endian=ParseCommandOption(MagickEndianOptions,MagickFalse,
              argv[i]);
            if (endian < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 548,OptionError,"UnrecognizedEndianType","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                        ;
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 552,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'f':
      {
        if (LocaleCompare("features",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 562,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 564,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("format",option+1) == 0)
          {
            format=(char *) 
# 569 "MagickWand/identify.c" 3 4
                           ((void *)0)
# 569 "MagickWand/identify.c"
                               ;
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 574,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            format=argv[i];
            break;
          }
        if (LocaleCompare("fuzz",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 584,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 586,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 589,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'g':
      {
        if (LocaleCompare("gamma",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 597,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 599,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("grayscale",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 611,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            method=ParseCommandOption(MagickPixelIntensityOptions,MagickFalse,
              argv[i]);
            if (method < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 615,OptionError,"UnrecognizedIntensityMethod","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                        ;
            break;
          }
        if (LocaleCompare("green-primary",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 625,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 627,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 630,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'h':
      {
        ...
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 640,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'i':
      {
        if (LocaleCompare("interlace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 653,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            interlace=ParseCommandOption(MagickInterlaceOptions,MagickFalse,
              argv[i]);
            if (interlace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 657,OptionError,"UnrecognizedInterlaceType","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                        ;
            break;
          }
        if (LocaleCompare("interpolate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 670,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            interpolate=ParseCommandOption(MagickInterpolateOptions,MagickFalse,
              argv[i]);
            if (interpolate < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 674,OptionError,"UnrecognizedInterpolateMethod","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                                                        ;
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 678,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'l':
      {
        if (LocaleCompare("limit",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 697,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            resource=ParseCommandOption(MagickResourceOptions,MagickFalse,
              argv[i]);
            if (resource < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 701,OptionError,"UnrecognizedResourceType","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                        ;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 705,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            value=StringToDouble(argv[i],&p);
            (void) value;
            if ((p == argv[i]) && (LocaleCompare("unlimited",argv[i]) != 0))
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 709,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("list",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 721,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            list=ParseCommandOption(MagickListOptions,MagickFalse,argv[i]);
            if (list < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 724,OptionError,"UnrecognizedListType","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                        ;
        ...
        if (LocaleCompare("log",option+1) == 0)
          {
            ...
            if ((i == (ssize_t) argc) ||
                (strchr(argv[i],'%') == (char *) 
# 737 "MagickWand/identify.c" 3 4
                                                ((void *)0)
# 737 "MagickWand/identify.c"
                                                    ))
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 738,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 741,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'm':
      {
        if (LocaleCompare("mask",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 751,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        ...
        if (LocaleCompare("monitor",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 760,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'n':
      {
        if (LocaleCompare("negate",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 766,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'p':
      {
        ...
        if (LocaleCompare("precision",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 781,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 783,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 786,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'q':
      {
        if (LocaleCompare("quiet",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 792,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'r':
      {
        ...
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 803,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 's':
      {
        if (LocaleCompare("sampling-factor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 813,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 815,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("seed",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 824,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 826,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("set",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 833,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 838,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("size",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 847,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 849,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        ...
        if (LocaleCompare("support",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 860,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 862,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 865,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'u':
      {
        ...
        if (LocaleCompare("units",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 880,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            units=ParseCommandOption(MagickResolutionOptions,MagickFalse,
              argv[i]);
            if (units < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 884,OptionError,"UnrecognizedUnitsType","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                        ;
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 888,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case 'v':
      {
        ...
        if (LocaleCompare("virtual-pixel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 903,OptionError,"MissingArgument","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            method=ParseCommandOption(MagickVirtualPixelOptions,MagickFalse,
              argv[i]);
            if (method < 0)
              { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 907,OptionError,"UnrecognizedVirtualPixelMethod","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                                                         ;
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 911,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
      }
      case '?':
        break;
      default:
        { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 916,OptionError,"UnrecognizedOption","`%s'", option); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
    }
    fire=(GetCommandOptionFlags(MagickCommandOptions,MagickFalse,option) &
      FireOptionFlag) == 0 ? MagickFalse : MagickTrue;
    if (fire != MagickFalse)
      if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 921 "MagickWand/identify.c" 3 4
     ((void *)0)
# 921 "MagickWand/identify.c"
     ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickFalse,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
  }
  if (k != 0)
    { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 924,OptionError,"UnbalancedParenthesis","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
  if (i != (ssize_t) argc)
    { (void) ThrowMagickException(exception,"MagickWand/identify.c",__func__,(unsigned long) 926,OptionError,"MissingAnImageFilename","`%s'", argv[i]); { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
  { { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); };
