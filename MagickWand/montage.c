# 0 "MagickWand/montage.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/montage.c"
# 45 "MagickWand/montage.c"
...
# 49 "MagickWand/montage.c" 2
# 84 "MagickWand/montage.c"
static MagickBooleanType MontageUsage(void)
{
  ...
  ListMagickVersion(
# 214 "MagickWand/montage.c" 3 4
                   stdout
# 214 "MagickWand/montage.c"
                         );
...
__attribute__ ((visibility ("default"))) MagickBooleanType MontageImageCommand(ImageInfo *image_info,
  int argc,char **argv,char **metadata,ExceptionInfo *exception)
{
# 274 "MagickWand/montage.c"
  char
    *option,
    *transparent_color;
  ...
  Image
    *image = (Image *) 
# 282 "MagickWand/montage.c" 3 4
                      ((void *)0)
# 282 "MagickWand/montage.c"
                          ,
    *montage_image;
...
# 314 "MagickWand/montage.c" 3 4
 ((void) sizeof ((
# 314 "MagickWand/montage.c"
...
# 314 "MagickWand/montage.c" 3 4
 , "MagickWand/montage.c", 314, __extension__ __PRETTY_FUNCTION__); }))
# 314 "MagickWand/montage.c"
                                         ;
  
# 315 "MagickWand/montage.c" 3 4
 ((void) sizeof ((
# 315 "MagickWand/montage.c"
...
# 315 "MagickWand/montage.c" 3 4
 , "MagickWand/montage.c", 315, __extension__ __PRETTY_FUNCTION__); }))
# 315 "MagickWand/montage.c"
                                                     ;
  
# 316 "MagickWand/montage.c" 3 4
 ((void) sizeof ((
# 316 "MagickWand/montage.c"
...
# 316 "MagickWand/montage.c" 3 4
 , "MagickWand/montage.c", 316, __extension__ __PRETTY_FUNCTION__); }))
# 316 "MagickWand/montage.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickWand/montage.c",__func__,(unsigned long) 318,"...");
  if (argc == 2)
    {
      option=argv[1];
      ...
      if ((LocaleCompare("version",option+1) == 0) ||
        ...
        {
          ListMagickVersion(
# 328 "MagickWand/montage.c" 3 4
                           stdout
# 328 "MagickWand/montage.c"
                                 );
          return(MagickTrue);
        }
    }
  if (argc < 3)
    {
      (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 334,OptionError,
        "MissingArgument","%s","");
      (void) MontageUsage();
      return(MagickFalse);
    }
  ...
  montage_info=CloneMontageInfo(image_info,(MontageInfo *) 
# 345 "MagickWand/montage.c" 3 4
                                                          ((void *)0)
# 345 "MagickWand/montage.c"
                                                              );
  ...
  option=(char *) 
# 347 "MagickWand/montage.c" 3 4
                 ((void *)0)
# 347 "MagickWand/montage.c"
                     ;
  pend=MagickFalse;
  respect_parenthesis=MagickFalse;
  scene=0;
  status=MagickFalse;
  transparent_color=(char *) 
# 352 "MagickWand/montage.c" 3 4
                            ((void *)0)
# 352 "MagickWand/montage.c"
                                ;
  ...
  if (status == MagickFalse)
    { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 359,ResourceLimitError,"MemoryAllocationFailed","`%s'", GetExceptionMessage(
# 359 "MagickWand/montage.c" 3 4
   (*__errno_location ())
# 359 "MagickWand/montage.c"
   )); { if (montage_image != (Image *) 
# 359 "MagickWand/montage.c" 3 4
   ((void *)0)
# 359 "MagickWand/montage.c"
   ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 359 "MagickWand/montage.c" 3 4
   ((void *)0)
# 359 "MagickWand/montage.c"
   ) montage_info=DestroyMontageInfo(montage_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                                 ;
...
# 366 "MagickWand/montage.c" 3 4
       ((void *)0)
# 366 "MagickWand/montage.c"
       ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((pend) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickTrue,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
        if (k == 128)
          { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 368,OptionError,"ParenthesisNestedTooDeeply","`%s'", option); { if (montage_image != (Image *) 
# 368 "MagickWand/montage.c" 3 4
         ((void *)0)
# 368 "MagickWand/montage.c"
         ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 368 "MagickWand/montage.c" 3 4
         ((void *)0)
# 368 "MagickWand/montage.c"
    ...
    if (LocaleCompare(option,")") == 0)
      {
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 375 "MagickWand/montage.c" 3 4
       ((void *)0)
# 375 "MagickWand/montage.c"
        ...
        if (k == 0)
          { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 377,OptionError,"UnableToParseExpression","`%s'", option); { if (montage_image != (Image *) 
# 377 "MagickWand/montage.c" 3 4
         ((void *)0)
# 377 "MagickWand/montage.c"
         ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 377 "MagickWand/montage.c" 3 4
         ((void *)0)
# 377 "MagickWand/montage.c"
    ...
    if (IsCommandOption(option) == MagickFalse)
      {
        ...
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 386 "MagickWand/montage.c" 3 4
       ((void *)0)
# 386 "MagickWand/montage.c"
        ...
        for (scene=(ssize_t) first_scene; scene <= (ssize_t) last_scene ; scene++)
        {
          ...
          if (first_scene == last_scene)
          ...
          else
            {
              ...
              (void) InterpretImageFilename(image_info,(Image *) 
# 409 "MagickWand/montage.c" 3 4
                                                                ((void *)0)
# 409 "MagickWand/montage.c"
                                                                    ,
                image_info->filename,(int) scene,scene_filename,exception);
              if (LocaleCompare(filename,image_info->filename) == 0)
                (void) FormatLocaleString(scene_filename,4096,
...
# 416 "MagickWand/montage.c" 3 4
                                                         ((void *)0)
# 416 "MagickWand/montage.c"
                                                             ) &&
            (exception->severity < ErrorException);
          if (images == (Image *) 
# 418 "MagickWand/montage.c" 3 4
                                 ((void *)0)
# 418 "MagickWand/montage.c"
                                     )
            continue;
    ...
    pend=image != (Image *) 
# 424 "MagickWand/montage.c" 3 4
                           ((void *)0) 
# 424 "MagickWand/montage.c"
        ...
        if (LocaleCompare("adaptive-sharpen",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 433,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 433 "MagickWand/montage.c" 3 4
             ((void *)0)
# 433 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 433 "MagickWand/montage.c" 3 4
             ((void *)0)
# 433 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 435,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 435 "MagickWand/montage.c" 3 4
             ((void *)0)
# 435 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 435 "MagickWand/montage.c" 3 4
             ((void *)0)
# 435 "MagickWand/montage.c"
        ...
        if (LocaleCompare("affine",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 446,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 446 "MagickWand/montage.c" 3 4
             ((void *)0)
# 446 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 446 "MagickWand/montage.c" 3 4
             ((void *)0)
# 446 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 448,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 448 "MagickWand/montage.c" 3 4
             ((void *)0)
# 448 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 448 "MagickWand/montage.c" 3 4
             ((void *)0)
# 448 "MagickWand/montage.c"
        ...
        if (LocaleCompare("alpha",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 460,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 460 "MagickWand/montage.c" 3 4
             ((void *)0)
# 460 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 460 "MagickWand/montage.c" 3 4
             ((void *)0)
# 460 "MagickWand/montage.c"
            ...
            type=ParseCommandOption(MagickAlphaChannelOptions,MagickFalse,
              argv[i]);
            if (type < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 464,OptionError,"UnrecognizedAlphaChannelOption","`%s'", argv[i]); { if (montage_image != (Image *) 
# 464 "MagickWand/montage.c" 3 4
             ((void *)0)
# 464 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 464 "MagickWand/montage.c" 3 4
             ((void *)0)
# 464 "MagickWand/montage.c"
        ...
        if (LocaleCompare("annotate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 474,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 474 "MagickWand/montage.c" 3 4
             ((void *)0)
# 474 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 474 "MagickWand/montage.c" 3 4
             ((void *)0)
# 474 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 476,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 476 "MagickWand/montage.c" 3 4
             ((void *)0)
# 476 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 476 "MagickWand/montage.c" 3 4
             ((void *)0)
# 476 "MagickWand/montage.c"
            ...
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 478,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 478 "MagickWand/montage.c" 3 4
             ((void *)0)
# 478 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 478 "MagickWand/montage.c" 3 4
             ((void *)0)
# 478 "MagickWand/montage.c"
        ...
        if (LocaleCompare("authenticate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 490,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 490 "MagickWand/montage.c" 3 4
             ((void *)0)
# 490 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 490 "MagickWand/montage.c" 3 4
             ((void *)0)
# 490 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 493,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 493 "MagickWand/montage.c" 3 4
       ((void *)0)
# 493 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 493 "MagickWand/montage.c" 3 4
       ((void *)0)
# 493 "MagickWand/montage.c"
        ...
        if (LocaleCompare("background",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 503,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 503 "MagickWand/montage.c" 3 4
             ((void *)0)
# 503 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 503 "MagickWand/montage.c" 3 4
             ((void *)0)
# 503 "MagickWand/montage.c"
        ...
        if (LocaleCompare("blue-primary",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 514,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 514 "MagickWand/montage.c" 3 4
             ((void *)0)
# 514 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 514 "MagickWand/montage.c" 3 4
             ((void *)0)
# 514 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 516,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 516 "MagickWand/montage.c" 3 4
             ((void *)0)
# 516 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 516 "MagickWand/montage.c" 3 4
             ((void *)0)
# 516 "MagickWand/montage.c"
        ...
        if (LocaleCompare("blur",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 525,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 525 "MagickWand/montage.c" 3 4
             ((void *)0)
# 525 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 525 "MagickWand/montage.c" 3 4
             ((void *)0)
# 525 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 527,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 527 "MagickWand/montage.c" 3 4
             ((void *)0)
# 527 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 527 "MagickWand/montage.c" 3 4
             ((void *)0)
# 527 "MagickWand/montage.c"
        ...
        if (LocaleCompare("border",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 541,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 541 "MagickWand/montage.c" 3 4
             ((void *)0)
# 541 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 541 "MagickWand/montage.c" 3 4
             ((void *)0)
# 541 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 543,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 543 "MagickWand/montage.c" 3 4
             ((void *)0)
# 543 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 543 "MagickWand/montage.c" 3 4
             ((void *)0)
# 543 "MagickWand/montage.c"
        ...
        if (LocaleCompare("bordercolor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 554,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 554 "MagickWand/montage.c" 3 4
             ((void *)0)
# 554 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 554 "MagickWand/montage.c" 3 4
             ((void *)0)
# 554 "MagickWand/montage.c"
        ...
        if (LocaleCompare("borderwidth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 566,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 566 "MagickWand/montage.c" 3 4
             ((void *)0)
# 566 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 566 "MagickWand/montage.c" 3 4
             ((void *)0)
# 566 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 568,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 568 "MagickWand/montage.c" 3 4
             ((void *)0)
# 568 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 568 "MagickWand/montage.c" 3 4
             ((void *)0)
# 568 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 572,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 572 "MagickWand/montage.c" 3 4
       ((void *)0)
# 572 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 572 "MagickWand/montage.c" 3 4
       ((void *)0)
# 572 "MagickWand/montage.c"
        ...
        if (LocaleCompare("cache",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 582,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 582 "MagickWand/montage.c" 3 4
             ((void *)0)
# 582 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 582 "MagickWand/montage.c" 3 4
             ((void *)0)
# 582 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 584,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 584 "MagickWand/montage.c" 3 4
             ((void *)0)
# 584 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 584 "MagickWand/montage.c" 3 4
             ((void *)0)
# 584 "MagickWand/montage.c"
        ...
        if (LocaleCompare("caption",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 593,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 593 "MagickWand/montage.c" 3 4
             ((void *)0)
# 593 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 593 "MagickWand/montage.c" 3 4
             ((void *)0)
# 593 "MagickWand/montage.c"
        ...
        if (LocaleCompare("channel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 605,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 605 "MagickWand/montage.c" 3 4
             ((void *)0)
# 605 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 605 "MagickWand/montage.c" 3 4
             ((void *)0)
# 605 "MagickWand/montage.c"
            ...
            if (channel < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 608,OptionError,"UnrecognizedChannelType","`%s'", argv[i]); { if (montage_image != (Image *) 
# 608 "MagickWand/montage.c" 3 4
             ((void *)0)
# 608 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 608 "MagickWand/montage.c" 3 4
             ((void *)0)
# 608 "MagickWand/montage.c"
        ...
        if (LocaleCompare("clone",option+1) == 0)
          {
            ...
            if (clone_list == (Image *) 
# 621 "MagickWand/montage.c" 3 4
                                       ((void *)0)
# 621 "MagickWand/montage.c"
                                           )
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 622,ImageError,"ImageSequenceRequired","`%s'", option); { if (montage_image != (Image *) 
# 622 "MagickWand/montage.c" 3 4
             ((void *)0)
# 622 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 622 "MagickWand/montage.c" 3 4
             ((void *)0)
# 622 "MagickWand/montage.c"
            ...
            if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 623 "MagickWand/montage.c" 3 4
           ((void *)0)
# 623 "MagickWand/montage.c"
           ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickTrue,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
            if (*option == '+')
            ...
            else
              {
                i++;
                if (i == (ssize_t) argc)
                  { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 630,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 630 "MagickWand/montage.c" 3 4
                 ((void *)0)
# 630 "MagickWand/montage.c"
                 ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 630 "MagickWand/montage.c" 3 4
                 ((void *)0)
# 630 "MagickWand/montage.c"
                ...
                if (IsSceneGeometry(argv[i],MagickFalse) == MagickFalse)
                  { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 632,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 632 "MagickWand/montage.c" 3 4
                 ((void *)0)
# 632 "MagickWand/montage.c"
                 ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 632 "MagickWand/montage.c" 3 4
                 ((void *)0)
# 632 "MagickWand/montage.c"
            ...
            if (clone_images == (Image *) 
# 635 "MagickWand/montage.c" 3 4
                                         ((void *)0)
# 635 "MagickWand/montage.c"
                                             )
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 636,OptionError,"NoSuchImage","`%s'", option); { if (montage_image != (Image *) 
# 636 "MagickWand/montage.c" 3 4
             ((void *)0)
# 636 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 636 "MagickWand/montage.c" 3 4
             ((void *)0)
# 636 "MagickWand/montage.c"
             ) montage_info=DestroyMontageInfo(montage_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            { (void) SyncImagesSettings(image_info,clone_images,exception); AppendImageToList(&image_stack[k].image,clone_images); image=image_stack[k].image; };
        ...
        if (LocaleCompare("colors",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 649,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 649 "MagickWand/montage.c" 3 4
             ((void *)0)
# 649 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 649 "MagickWand/montage.c" 3 4
             ((void *)0)
# 649 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 651,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 651 "MagickWand/montage.c" 3 4
             ((void *)0)
# 651 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 651 "MagickWand/montage.c" 3 4
             ((void *)0)
# 651 "MagickWand/montage.c"
        ...
        if (LocaleCompare("colorspace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 663,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 663 "MagickWand/montage.c" 3 4
             ((void *)0)
# 663 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 663 "MagickWand/montage.c" 3 4
             ((void *)0)
# 663 "MagickWand/montage.c"
            ...
            colorspace=ParseCommandOption(MagickColorspaceOptions,
              MagickFalse,argv[i]);
            if (colorspace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 667,OptionError,"UnrecognizedColorspace","`%s'", argv[i]); { if (montage_image != (Image *) 
# 667 "MagickWand/montage.c" 3 4
             ((void *)0)
# 667 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 667 "MagickWand/montage.c" 3 4
             ((void *)0)
# 667 "MagickWand/montage.c"
        ...
        if (LocaleCompare("comment",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 677,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 677 "MagickWand/montage.c" 3 4
             ((void *)0)
# 677 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 677 "MagickWand/montage.c" 3 4
             ((void *)0)
# 677 "MagickWand/montage.c"
        ...
        if (LocaleCompare("compose",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 689,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 689 "MagickWand/montage.c" 3 4
             ((void *)0)
# 689 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 689 "MagickWand/montage.c" 3 4
             ((void *)0)
# 689 "MagickWand/montage.c"
            ...
            if (compose < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 692,OptionError,"UnrecognizedComposeOperator","`%s'", argv[i]); { if (montage_image != (Image *) 
# 692 "MagickWand/montage.c" 3 4
             ((void *)0)
# 692 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 692 "MagickWand/montage.c" 3 4
             ((void *)0)
# 692 "MagickWand/montage.c"
        ...
        if (LocaleCompare("compress",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 707,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 707 "MagickWand/montage.c" 3 4
             ((void *)0)
# 707 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 707 "MagickWand/montage.c" 3 4
             ((void *)0)
# 707 "MagickWand/montage.c"
            ...
            compress=ParseCommandOption(MagickCompressOptions,MagickFalse,
              argv[i]);
            if (compress < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 711,OptionError,"UnrecognizedCompressType","`%s'", argv[i]); { if (montage_image != (Image *) 
# 711 "MagickWand/montage.c" 3 4
             ((void *)0)
# 711 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 711 "MagickWand/montage.c" 3 4
             ((void *)0)
# 711 "MagickWand/montage.c"
        ...
        if (LocaleCompare("crop",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 723,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 723 "MagickWand/montage.c" 3 4
             ((void *)0)
# 723 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 723 "MagickWand/montage.c" 3 4
             ((void *)0)
# 723 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 725,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 725 "MagickWand/montage.c" 3 4
             ((void *)0)
# 725 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 725 "MagickWand/montage.c" 3 4
             ((void *)0)
# 725 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 728,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 728 "MagickWand/montage.c" 3 4
       ((void *)0)
# 728 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 728 "MagickWand/montage.c" 3 4
       ((void *)0)
# 728 "MagickWand/montage.c"
        ...
        if (LocaleCompare("debug",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 741,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 741 "MagickWand/montage.c" 3 4
             ((void *)0)
# 741 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 741 "MagickWand/montage.c" 3 4
             ((void *)0)
# 741 "MagickWand/montage.c"
            ...
            if (event < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 744,OptionError,"UnrecognizedEventType","`%s'", argv[i]); { if (montage_image != (Image *) 
# 744 "MagickWand/montage.c" 3 4
             ((void *)0)
# 744 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 744 "MagickWand/montage.c" 3 4
             ((void *)0)
# 744 "MagickWand/montage.c"
        ...
        if (LocaleCompare("define",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 753,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 753 "MagickWand/montage.c" 3 4
             ((void *)0)
# 753 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 753 "MagickWand/montage.c" 3 4
             ((void *)0)
# 753 "MagickWand/montage.c"
...
# 760 "MagickWand/montage.c" 3 4
                                            ((void *)0)
# 760 "MagickWand/montage.c"
                                                )
                  { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 761,OptionError,"NoSuchOption","`%s'", argv[i]); { if (montage_image != (Image *) 
# 761 "MagickWand/montage.c" 3 4
                 ((void *)0)
# 761 "MagickWand/montage.c"
                 ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 761 "MagickWand/montage.c" 3 4
                 ((void *)0)
# 761 "MagickWand/montage.c"
        ...
        if (LocaleCompare("delay",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 772,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 772 "MagickWand/montage.c" 3 4
             ((void *)0)
# 772 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 772 "MagickWand/montage.c" 3 4
             ((void *)0)
# 772 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 774,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 774 "MagickWand/montage.c" 3 4
             ((void *)0)
# 774 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 774 "MagickWand/montage.c" 3 4
             ((void *)0)
# 774 "MagickWand/montage.c"
        ...
        if (LocaleCompare("delete",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 783,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 783 "MagickWand/montage.c" 3 4
             ((void *)0)
# 783 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 783 "MagickWand/montage.c" 3 4
             ((void *)0)
# 783 "MagickWand/montage.c"
            ...
            if (IsSceneGeometry(argv[i],MagickFalse) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 785,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 785 "MagickWand/montage.c" 3 4
             ((void *)0)
# 785 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 785 "MagickWand/montage.c" 3 4
             ((void *)0)
# 785 "MagickWand/montage.c"
        ...
        if (LocaleCompare("density",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 794,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 794 "MagickWand/montage.c" 3 4
             ((void *)0)
# 794 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 794 "MagickWand/montage.c" 3 4
             ((void *)0)
# 794 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 796,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 796 "MagickWand/montage.c" 3 4
             ((void *)0)
# 796 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 796 "MagickWand/montage.c" 3 4
             ((void *)0)
# 796 "MagickWand/montage.c"
        ...
        if (LocaleCompare("depth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 805,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 805 "MagickWand/montage.c" 3 4
             ((void *)0)
# 805 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 805 "MagickWand/montage.c" 3 4
             ((void *)0)
# 805 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 807,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 807 "MagickWand/montage.c" 3 4
             ((void *)0)
# 807 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 807 "MagickWand/montage.c" 3 4
             ((void *)0)
# 807 "MagickWand/montage.c"
        ...
        if (LocaleCompare("display",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 816,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 816 "MagickWand/montage.c" 3 4
             ((void *)0)
# 816 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 816 "MagickWand/montage.c" 3 4
             ((void *)0)
# 816 "MagickWand/montage.c"
        ...
        if (LocaleCompare("dispose",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 828,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 828 "MagickWand/montage.c" 3 4
             ((void *)0)
# 828 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 828 "MagickWand/montage.c" 3 4
             ((void *)0)
# 828 "MagickWand/montage.c"
            ...
            dispose=ParseCommandOption(MagickDisposeOptions,MagickFalse,
              argv[i]);
            if (dispose < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 832,OptionError,"UnrecognizedDisposeMethod","`%s'", argv[i]); { if (montage_image != (Image *) 
# 832 "MagickWand/montage.c" 3 4
             ((void *)0)
# 832 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 832 "MagickWand/montage.c" 3 4
             ((void *)0)
# 832 "MagickWand/montage.c"
        ...
        if (LocaleCompare("distort",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 843,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 843 "MagickWand/montage.c" 3 4
             ((void *)0)
# 843 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 843 "MagickWand/montage.c" 3 4
             ((void *)0)
# 843 "MagickWand/montage.c"
            ...
            if (op < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 846,OptionError,"UnrecognizedDistortMethod","`%s'", argv[i]); { if (montage_image != (Image *) 
# 846 "MagickWand/montage.c" 3 4
             ((void *)0)
# 846 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 846 "MagickWand/montage.c" 3 4
             ((void *)0)
# 846 "MagickWand/montage.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 850,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 850 "MagickWand/montage.c" 3 4
             ((void *)0)
# 850 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 850 "MagickWand/montage.c" 3 4
             ((void *)0)
# 850 "MagickWand/montage.c"
        ...
        if (LocaleCompare("dither",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 862,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 862 "MagickWand/montage.c" 3 4
             ((void *)0)
# 862 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 862 "MagickWand/montage.c" 3 4
             ((void *)0)
# 862 "MagickWand/montage.c"
            ...
            if (method < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 865,OptionError,"UnrecognizedDitherMethod","`%s'", argv[i]); { if (montage_image != (Image *) 
# 865 "MagickWand/montage.c" 3 4
             ((void *)0)
# 865 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 865 "MagickWand/montage.c" 3 4
             ((void *)0)
# 865 "MagickWand/montage.c"
        ...
        if (LocaleCompare("draw",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 875,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 875 "MagickWand/montage.c" 3 4
             ((void *)0)
# 875 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 875 "MagickWand/montage.c" 3 4
             ((void *)0)
# 875 "MagickWand/montage.c"
        ...
        if (LocaleCompare("duplicate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 884,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 884 "MagickWand/montage.c" 3 4
             ((void *)0)
# 884 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 884 "MagickWand/montage.c" 3 4
             ((void *)0)
# 884 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 886,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 886 "MagickWand/montage.c" 3 4
             ((void *)0)
# 886 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 886 "MagickWand/montage.c" 3 4
             ((void *)0)
# 886 "MagickWand/montage.c"
        ...
        if (LocaleCompare("duration",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 895,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 895 "MagickWand/montage.c" 3 4
             ((void *)0)
# 895 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 895 "MagickWand/montage.c" 3 4
             ((void *)0)
# 895 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 897,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 897 "MagickWand/montage.c" 3 4
             ((void *)0)
# 897 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 897 "MagickWand/montage.c" 3 4
             ((void *)0)
# 897 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 900,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 900 "MagickWand/montage.c" 3 4
       ((void *)0)
# 900 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 900 "MagickWand/montage.c" 3 4
       ((void *)0)
# 900 "MagickWand/montage.c"
        ...
        if (LocaleCompare("encoding",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 910,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 910 "MagickWand/montage.c" 3 4
             ((void *)0)
# 910 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 910 "MagickWand/montage.c" 3 4
             ((void *)0)
# 910 "MagickWand/montage.c"
        ...
        if (LocaleCompare("endian",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 922,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 922 "MagickWand/montage.c" 3 4
             ((void *)0)
# 922 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 922 "MagickWand/montage.c" 3 4
             ((void *)0)
# 922 "MagickWand/montage.c"
            ...
            endian=ParseCommandOption(MagickEndianOptions,MagickFalse,
              argv[i]);
            if (endian < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 926,OptionError,"UnrecognizedEndianType","`%s'", argv[i]); { if (montage_image != (Image *) 
# 926 "MagickWand/montage.c" 3 4
             ((void *)0)
# 926 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 926 "MagickWand/montage.c" 3 4
             ((void *)0)
# 926 "MagickWand/montage.c"
        ...
        if (LocaleCompare("extent",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 936,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 936 "MagickWand/montage.c" 3 4
             ((void *)0)
# 936 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 936 "MagickWand/montage.c" 3 4
             ((void *)0)
# 936 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 938,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 938 "MagickWand/montage.c" 3 4
             ((void *)0)
# 938 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 938 "MagickWand/montage.c" 3 4
             ((void *)0)
# 938 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 941,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 941 "MagickWand/montage.c" 3 4
       ((void *)0)
# 941 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 941 "MagickWand/montage.c" 3 4
       ((void *)0)
# 941 "MagickWand/montage.c"
        ...
        if (LocaleCompare("family",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 951,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 951 "MagickWand/montage.c" 3 4
             ((void *)0)
# 951 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 951 "MagickWand/montage.c" 3 4
             ((void *)0)
# 951 "MagickWand/montage.c"
        ...
        if (LocaleCompare("fill",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 962,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 962 "MagickWand/montage.c" 3 4
             ((void *)0)
# 962 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 962 "MagickWand/montage.c" 3 4
             ((void *)0)
# 962 "MagickWand/montage.c"
        ...
        if (LocaleCompare("filter",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 976,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 976 "MagickWand/montage.c" 3 4
             ((void *)0)
# 976 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 976 "MagickWand/montage.c" 3 4
             ((void *)0)
# 976 "MagickWand/montage.c"
            ...
            if (filter < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 979,OptionError,"UnrecognizedImageFilter","`%s'", argv[i]); { if (montage_image != (Image *) 
# 979 "MagickWand/montage.c" 3 4
             ((void *)0)
# 979 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 979 "MagickWand/montage.c" 3 4
             ((void *)0)
# 979 "MagickWand/montage.c"
        ...
        if (LocaleCompare("font",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 995,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 995 "MagickWand/montage.c" 3 4
             ((void *)0)
# 995 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 995 "MagickWand/montage.c" 3 4
             ((void *)0)
# 995 "MagickWand/montage.c"
        ...
        if (LocaleCompare("format",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1005,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1005 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1005 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1005 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1005 "MagickWand/montage.c"
        ...
        if (LocaleCompare("frame",option+1) == 0)
          {
            if (k == 0)
              {
                (void) CopyMagickString(argv[i]+1,"sans",4096);
                (void) CloneString(&montage_info->frame,(char *) 
# 1014 "MagickWand/montage.c" 3 4
                                                                ((void *)0)
# 1014 "MagickWand/montage.c"
                                                                    );
              }
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1020,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1020 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1020 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1020 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1020 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1022,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1022 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1022 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1022 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1022 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1027,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1027 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1027 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1027 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1027 "MagickWand/montage.c"
        ...
        if (LocaleCompare("gamma",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1035,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1035 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1035 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1035 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1035 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1037,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1037 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1037 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1037 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1037 "MagickWand/montage.c"
        ...
        if (LocaleCompare("geometry",option+1) == 0)
          {
            (void) CloneString(&montage_info->geometry,(char *) 
# 1042 "MagickWand/montage.c" 3 4
                                                               ((void *)0)
# 1042 "MagickWand/montage.c"
                                                                   );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1047,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1047 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1047 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1047 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1047 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1049,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1049 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1049 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1049 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1049 "MagickWand/montage.c"
        ...
        if (LocaleCompare("gravity",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1063,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1063 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1063 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1063 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1063 "MagickWand/montage.c"
            ...
            gravity=ParseCommandOption(MagickGravityOptions,MagickFalse,
              argv[i]);
            if (gravity < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1067,OptionError,"UnrecognizedGravityType","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1067 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1067 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1067 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1067 "MagickWand/montage.c"
        ...
        if (LocaleCompare("green-primary",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1078,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1078 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1078 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1078 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1078 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1080,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1080 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1080 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1080 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1080 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1083,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1083 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1083 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1083 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1083 "MagickWand/montage.c"
      ...
      case 'h':
      {
        if ((LocaleCompare("help",option+1) == 0) ||
          ...
          {
            { if (montage_image != (Image *) 
# 1090 "MagickWand/montage.c" 3 4
           ((void *)0)
# 1090 "MagickWand/montage.c"
           ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1090 "MagickWand/montage.c" 3 4
           ((void *)0)
# 1090 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1093,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1093 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1093 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1093 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1093 "MagickWand/montage.c"
        ...
        if (LocaleCompare("insert",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1105,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1105 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1105 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1105 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1105 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1107,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1107 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1107 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1107 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1107 "MagickWand/montage.c"
        ...
        if (LocaleCompare("interlace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1119,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1119 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1119 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1119 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1119 "MagickWand/montage.c"
            ...
            interlace=ParseCommandOption(MagickInterlaceOptions,MagickFalse,
              argv[i]);
            if (interlace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1123,OptionError,"UnrecognizedInterlaceType","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1123 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1123 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1123 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1123 "MagickWand/montage.c"
        ...
        if (LocaleCompare("interpolate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1136,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1136 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1136 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1136 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1136 "MagickWand/montage.c"
            ...
            interpolate=ParseCommandOption(MagickInterpolateOptions,MagickFalse,
              argv[i]);
            if (interpolate < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1140,OptionError,"UnrecognizedInterpolateMethod","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1140 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1140 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1140 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1140 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1144,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1144 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1144 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1144 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1144 "MagickWand/montage.c"
        ...
        if (LocaleCompare("kerning",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1154,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1154 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1154 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1154 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1154 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1156,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1156 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1156 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1156 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1156 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1159,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1159 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1159 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1159 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1159 "MagickWand/montage.c"
        ...
        if (LocaleCompare("label",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1169,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1169 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1169 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1169 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1169 "MagickWand/montage.c"
        ...
        if (LocaleCompare("layers",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1181,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1181 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1181 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1181 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1181 "MagickWand/montage.c"
            ...
            if (type < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1184,OptionError,"UnrecognizedLayerMethod","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1184 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1184 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1184 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1184 "MagickWand/montage.c"
        ...
        if (LocaleCompare("limit",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1203,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1203 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1203 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1203 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1203 "MagickWand/montage.c"
            ...
            resource=ParseCommandOption(MagickResourceOptions,MagickFalse,
              argv[i]);
            if (resource < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1207,OptionError,"UnrecognizedResourceType","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1207 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1207 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1207 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1207 "MagickWand/montage.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1211,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1211 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1211 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1211 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1211 "MagickWand/montage.c"
            ...
            if ((p == argv[i]) && (LocaleCompare("unlimited",argv[i]) != 0))
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1215,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1215 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1215 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1215 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1215 "MagickWand/montage.c"
        ...
        if (LocaleCompare("list",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1227,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1227 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1227 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1227 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1227 "MagickWand/montage.c"
            ...
            if (list < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1230,OptionError,"UnrecognizedListType","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1230 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1230 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1230 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1230 "MagickWand/montage.c"
            ...
            status=MogrifyImageInfo(image_info,(int) (i-j+1),(const char **)
              argv+j,exception);
            { if (montage_image != (Image *) 
# 1233 "MagickWand/montage.c" 3 4
           ((void *)0)
# 1233 "MagickWand/montage.c"
           ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1233 "MagickWand/montage.c" 3 4
           ((void *)0)
# 1233 "MagickWand/montage.c"
        ...
        if (LocaleCompare("log",option+1) == 0)
          {
            ...
            if ((i == (ssize_t) argc) ||
                (strchr(argv[i],'%') == (char *) 
# 1242 "MagickWand/montage.c" 3 4
                                                ((void *)0)
# 1242 "MagickWand/montage.c"
                                                    ))
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1243,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1243 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1243 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1243 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1243 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1246,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1246 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1246 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1246 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1246 "MagickWand/montage.c"
        ...
        if (LocaleCompare("mattecolor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1258,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1258 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1258 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1258 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1258 "MagickWand/montage.c"
        ...
        if (LocaleCompare("mode",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1273,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1273 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1273 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1273 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1273 "MagickWand/montage.c"
            ...
            if (LocaleCompare("unframe",argv[i]) == 0)
              {
                mode=UnframeMode;
                montage_info->frame=(char *) 
# 1285 "MagickWand/montage.c" 3 4
                                            ((void *)0)
# 1285 "MagickWand/montage.c"
                                                ;
            ...
            if (LocaleCompare("concatenate",argv[i]) == 0)
              {
                ...
                montage_info->frame=(char *) 
# 1293 "MagickWand/montage.c" 3 4
                                            ((void *)0)
# 1293 "MagickWand/montage.c"
                                                ;
                montage_info->shadow=MagickFalse;
            ...
            if (mode == UndefinedMode)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1301,OptionError,"UnrecognizedImageMode","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1301 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1301 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1301 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1301 "MagickWand/montage.c"
        ...
        if (LocaleCompare("monochrome",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1309,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1309 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1309 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1309 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1309 "MagickWand/montage.c"
      ...
      case 'n':
      {
        if (LocaleCompare("noop",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1315,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1315 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1315 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1315 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1315 "MagickWand/montage.c"
        ...
        if (LocaleCompare("page",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1325,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1325 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1325 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1325 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1325 "MagickWand/montage.c"
        ...
        if (LocaleCompare("pointsize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1335,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1335 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1335 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1335 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1335 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1337,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1337 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1337 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1337 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1337 "MagickWand/montage.c"
             ) montage_info=DestroyMontageInfo(montage_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            montage_info->pointsize=StringToDouble(argv[i],(char **) 
# 1338 "MagickWand/montage.c" 3 4
                                                                    ((void *)0)
# 1338 "MagickWand/montage.c"
                                                                        );
            break;
          }
        if (LocaleCompare("polaroid",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1347,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1347 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1347 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1347 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1347 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1349,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1349 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1349 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1349 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1349 "MagickWand/montage.c"
        ...
        if (LocaleCompare("profile",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1356,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1356 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1356 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1356 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1356 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1359,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1359 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1359 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1359 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1359 "MagickWand/montage.c"
        ...
        if (LocaleCompare("quality",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1369,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1369 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1369 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1369 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1369 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1371,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1371 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1371 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1371 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1371 "MagickWand/montage.c"
        ...
        if (LocaleCompare("quantize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1383,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1383 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1383 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1383 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1383 "MagickWand/montage.c"
            ...
            colorspace=ParseCommandOption(MagickColorspaceOptions,
              MagickFalse,argv[i]);
            if (colorspace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1387,OptionError,"UnrecognizedColorspace","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1387 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1387 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1387 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1387 "MagickWand/montage.c"
        ...
        if (LocaleCompare("quiet",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1393,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1393 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1393 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1393 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1393 "MagickWand/montage.c"
        ...
        if (LocaleCompare("red-primary",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1403,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1403 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1403 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1403 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1403 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1405,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1405 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1405 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1405 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1405 "MagickWand/montage.c"
        ...
        if (LocaleCompare("repage",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1418,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1418 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1418 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1418 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1418 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1420,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1420 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1420 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1420 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1420 "MagickWand/montage.c"
        ...
        if (LocaleCompare("resize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1429,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1429 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1429 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1429 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1429 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1431,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1431 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1431 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1431 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1431 "MagickWand/montage.c"
        ...
        if (LocaleCompare("rotate",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1445,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1445 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1445 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1445 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1445 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1447,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1447 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1447 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1447 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1447 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1450,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1450 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1450 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1450 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1450 "MagickWand/montage.c"
        ...
        if (LocaleCompare("sampling-factor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1460,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1460 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1460 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1460 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1460 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1462,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1462 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1462 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1462 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1462 "MagickWand/montage.c"
        ...
        if (LocaleCompare("scale",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1471,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1471 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1471 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1471 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1471 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1473,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1473 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1473 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1473 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1473 "MagickWand/montage.c"
        ...
        if (LocaleCompare("scenes",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1484,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1484 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1484 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1484 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1484 "MagickWand/montage.c"
            ...
            if (IsSceneGeometry(argv[i],MagickFalse) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1486,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1486 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1486 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1486 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1486 "MagickWand/montage.c"
        ...
        if (LocaleCompare("seed",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1498,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1498 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1498 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1498 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1498 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1500,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1500 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1500 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1500 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1500 "MagickWand/montage.c"
        ...
        if (LocaleCompare("set",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1507,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1507 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1507 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1507 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1507 "MagickWand/montage.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1512,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1512 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1512 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1512 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1512 "MagickWand/montage.c"
        ...
        if (LocaleCompare("shadow",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1528,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1528 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1528 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1528 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1528 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1530,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1530 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1530 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1530 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1530 "MagickWand/montage.c"
        ...
        if (LocaleCompare("sharpen",option+1) == 0)
          {
            ...
            if ((i == (ssize_t) argc) || (IsGeometry(argv[i]) == MagickFalse))
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1539,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1539 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1539 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1539 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1539 "MagickWand/montage.c"
        ...
        if (LocaleCompare("size",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1548,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1548 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1548 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1548 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1548 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1550,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1550 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1550 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1550 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1550 "MagickWand/montage.c"
        ...
        if (LocaleCompare("stroke",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1561,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1561 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1561 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1561 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1561 "MagickWand/montage.c"
        ...
        if (LocaleCompare("strokewidth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1574,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1574 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1574 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1574 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1574 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1576,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1576 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1576 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1576 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1576 "MagickWand/montage.c"
        ...
        if (LocaleCompare("swap",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1590,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1590 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1590 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1590 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1590 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1592,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1592 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1592 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1592 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1592 "MagickWand/montage.c"
        ...
        if (LocaleCompare("synchronize",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1597,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1597 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1597 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1597 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1597 "MagickWand/montage.c"
      ...
      case 't':
      {
        ...
        if (LocaleCompare("texture",option+1) == 0)
          {
            (void) CloneString(&montage_info->texture,(char *) 
# 1605 "MagickWand/montage.c" 3 4
                                                              ((void *)0)
# 1605 "MagickWand/montage.c"
                                                                  );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1610,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1610 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1610 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1610 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1610 "MagickWand/montage.c"
        ...
        if (LocaleCompare("thumbnail",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1620,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1620 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1620 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1620 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1620 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1622,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1622 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1622 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1622 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1622 "MagickWand/montage.c"
        ...
        if (LocaleCompare("tile",option+1) == 0)
          {
            if (k == 0)
              {
                (void) CopyMagickString(argv[i]+1,"sans",4096);
                (void) CloneString(&montage_info->tile,(char *) 
# 1630 "MagickWand/montage.c" 3 4
                                                               ((void *)0)
# 1630 "MagickWand/montage.c"
                                                                   );
              }
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1636,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1636 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1636 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1636 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1636 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1638,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1638 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1638 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1638 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1638 "MagickWand/montage.c"
        ...
        if (LocaleCompare("tile-offset",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1649,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1649 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1649 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1649 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1649 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1651,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1651 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1651 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1651 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1651 "MagickWand/montage.c"
        ...
        if (LocaleCompare("tint",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1660,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1660 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1660 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1660 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1660 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1662,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1662 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1662 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1662 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1662 "MagickWand/montage.c"
        ...
        if (LocaleCompare("title",option+1) == 0)
          {
            (void) CloneString(&montage_info->title,(char *) 
# 1671 "MagickWand/montage.c" 3 4
                                                            ((void *)0)
# 1671 "MagickWand/montage.c"
                                                                );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1676,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1676 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1676 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1676 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1676 "MagickWand/montage.c"
        ...
        if (LocaleCompare("transparent",option+1) == 0)
          {
            transparent_color=(char *) 
# 1684 "MagickWand/montage.c" 3 4
                                      ((void *)0)
# 1684 "MagickWand/montage.c"
                                          ;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1687,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1687 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1687 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1687 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1687 "MagickWand/montage.c"
        ...
        if (LocaleCompare("transparent-color",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1697,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1697 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1697 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1697 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1697 "MagickWand/montage.c"
        ...
        if (LocaleCompare("treedepth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1706,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1706 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1706 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1706 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1706 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1708,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1708 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1708 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1708 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1708 "MagickWand/montage.c"
        ...
        if (LocaleCompare("type",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1722,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1722 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1722 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1722 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1722 "MagickWand/montage.c"
            ...
            if (type < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1725,OptionError,"UnrecognizedImageType","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1725 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1725 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1725 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1725 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1729,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1729 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1729 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1729 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1729 "MagickWand/montage.c"
        ...
        if (LocaleCompare("units",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1742,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1742 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1742 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1742 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1742 "MagickWand/montage.c"
            ...
            units=ParseCommandOption(MagickResolutionOptions,MagickFalse,
              argv[i]);
            if (units < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1746,OptionError,"UnrecognizedUnitsType","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1746 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1746 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1746 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1746 "MagickWand/montage.c"
        ...
        if (LocaleCompare("unsharp",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1756,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1756 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1756 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1756 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1756 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1758,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1758 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1758 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1758 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1758 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1761,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1761 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1761 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1761 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1761 "MagickWand/montage.c"
      ...
      case 'v':
      {
        ...
        if ((LocaleCompare("version",option+1) == 0) ||
          ...
          {
            ListMagickVersion(
# 1772 "MagickWand/montage.c" 3 4
                             stdout
# 1772 "MagickWand/montage.c"
                                   );
            break;
          }
        if (LocaleCompare("virtual-pixel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1784,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1784 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1784 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1784 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1784 "MagickWand/montage.c"
            ...
            method=ParseCommandOption(MagickVirtualPixelOptions,MagickFalse,
              argv[i]);
            if (method < 0)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1788,OptionError,"UnrecognizedVirtualPixelMethod","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1788 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1788 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1788 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1788 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1792,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1792 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1792 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1792 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1792 "MagickWand/montage.c"
        ...
        if (LocaleCompare("white-point",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1802,OptionError,"MissingArgument","`%s'", option); { if (montage_image != (Image *) 
# 1802 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1802 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1802 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1802 "MagickWand/montage.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1804,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (montage_image != (Image *) 
# 1804 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1804 "MagickWand/montage.c"
             ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1804 "MagickWand/montage.c" 3 4
             ((void *)0)
# 1804 "MagickWand/montage.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1807,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1807 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1807 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1807 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1807 "MagickWand/montage.c"
      ...
      case '?':
        break;
      default:
        { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1812,OptionError,"UnrecognizedOption","`%s'", option); { if (montage_image != (Image *) 
# 1812 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1812 "MagickWand/montage.c"
       ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1812 "MagickWand/montage.c" 3 4
       ((void *)0)
# 1812 "MagickWand/montage.c"
    ...
    if (fire != MagickFalse)
      if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 1817 "MagickWand/montage.c" 3 4
     ((void *)0)
# 1817 "MagickWand/montage.c"
     ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickTrue,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
  }
  if (k != 0)
    { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1820,OptionError,"UnbalancedParenthesis","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1820 "MagickWand/montage.c" 3 4
   ((void *)0)
# 1820 "MagickWand/montage.c"
   ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1820 "MagickWand/montage.c" 3 4
   ((void *)0)
# 1820 "MagickWand/montage.c"
  ...
  if (i-- != (ssize_t) (argc-1))
    { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1822,OptionError,"MissingAnImageFilename","`%s'", argv[i]); { if (montage_image != (Image *) 
# 1822 "MagickWand/montage.c" 3 4
   ((void *)0)
# 1822 "MagickWand/montage.c"
   ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1822 "MagickWand/montage.c" 3 4
   ((void *)0)
# 1822 "MagickWand/montage.c"
  ...
  if (image == (Image *) 
# 1823 "MagickWand/montage.c" 3 4
                        ((void *)0)
# 1823 "MagickWand/montage.c"
                            )
    { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1824,OptionError,"MissingAnImageFilename","`%s'", argv[argc-1]); { if (montage_image != (Image *) 
# 1824 "MagickWand/montage.c" 3 4
   ((void *)0)
# 1824 "MagickWand/montage.c"
   ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1824 "MagickWand/montage.c" 3 4
   ((void *)0)
# 1824 "MagickWand/montage.c"
  ...
  { if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 1825 "MagickWand/montage.c" 3 4
 ((void *)0)
# 1825 "MagickWand/montage.c"
 ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickTrue,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } }; if (image != (Image *) 
# 1825 "MagickWand/montage.c" 3 4
 ((void *)0)
# 1825 "MagickWand/montage.c"
 ) (void) SyncImagesSettings(image_info,image,exception); };
  if (image == (Image *) 
# 1826 "MagickWand/montage.c" 3 4
                        ((void *)0)
# 1826 "MagickWand/montage.c"
                            )
    { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1827,OptionError,"MissingAnImageFilename","`%s'", argv[argc-1]); { if (montage_image != (Image *) 
# 1827 "MagickWand/montage.c" 3 4
   ((void *)0)
# 1827 "MagickWand/montage.c"
   ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1827 "MagickWand/montage.c" 3 4
   ((void *)0)
# 1827 "MagickWand/montage.c"
   ) montage_info=DestroyMontageInfo(montage_info); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
  (void) CopyMagickString(montage_info->filename,argv[argc-1],4096);
  montage_image=MontageImageList(image_info,montage_info,image,exception);
  if (montage_image == (Image *) 
# 1830 "MagickWand/montage.c" 3 4
                                ((void *)0)
# 1830 "MagickWand/montage.c"
                                    )
    status=MagickFalse;
  else
    {
      ...
      if (metadata != (char **) 
# 1846 "MagickWand/montage.c" 3 4
                               ((void *)0)
# 1846 "MagickWand/montage.c"
                                   )
        {
          char
            *text;
          ...
          text=InterpretImageProperties(image_info,montage_image,format,
            exception);
          if (text == (char *) 
# 1853 "MagickWand/montage.c" 3 4
                              ((void *)0)
# 1853 "MagickWand/montage.c"
                                  )
            { (void) ThrowMagickException(exception,"MagickWand/montage.c",__func__,(unsigned long) 1854,ResourceLimitError,"MemoryAllocationFailed","`%s'", GetExceptionMessage(
# 1854 "MagickWand/montage.c" 3 4
           (*__errno_location ())
# 1854 "MagickWand/montage.c"
           )); { if (montage_image != (Image *) 
# 1854 "MagickWand/montage.c" 3 4
           ((void *)0)
# 1854 "MagickWand/montage.c"
...
# 1854 "MagickWand/montage.c"
  ...
  { if (montage_image != (Image *) 
# 1860 "MagickWand/montage.c" 3 4
 ((void *)0)
# 1860 "MagickWand/montage.c"
 ) montage_image=DestroyImageList(montage_image); if (montage_info != (MontageInfo *) 
# 1860 "MagickWand/montage.c" 3 4
 ((void *)0)
# 1860 "MagickWand/montage.c"
