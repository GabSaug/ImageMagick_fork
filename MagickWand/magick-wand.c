# 0 "MagickWand/magick-wand.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/magick-wand.c"
# 49 "MagickWand/magick-wand.c"
...
# 53 "MagickWand/magick-wand.c" 2
# 77 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) void ClearMagickWand(MagickWand *wand)
{
  
# 79 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 79 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 79 "MagickWand/magick-wand.c" 3 4
...
# 79 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 79, __extension__ __PRETTY_FUNCTION__); }))
# 79 "MagickWand/magick-wand.c"
                                    ;
  
# 80 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 80 "MagickWand/magick-wand.c"
...
# 80 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 80, __extension__ __PRETTY_FUNCTION__); }))
# 80 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 82,"%s",wand->name);
...
# 114 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) MagickWand *CloneMagickWand(const MagickWand *wand)
{
  MagickWand
    *clone_wand;

  
# 119 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 119 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 119 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 119 "MagickWand/magick-wand.c"
...
# 119 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 119 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 119, __extension__ __PRETTY_FUNCTION__); }))
# 119 "MagickWand/magick-wand.c"
                                    ;
  
# 120 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 120 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 120 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 120 "MagickWand/magick-wand.c"
...
# 120 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 120 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 120, __extension__ __PRETTY_FUNCTION__); }))
# 120 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 122,"%s",wand->name);
  ...
  (void) FormatLocaleString(clone_wand->name,4096,"%s-%.20g",
    "MagickWand",(double) clone_wand->id);
  ...
  if (clone_wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 136,"%s",clone_wand->name);
  clone_wand->signature=0xabacadabUL;
  return(clone_wand);
}
# 163 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) MagickWand *DestroyMagickWand(MagickWand *wand)
{
  
# 165 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 165 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 165 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 165 "MagickWand/magick-wand.c"
...
# 165 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 165 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 165, __extension__ __PRETTY_FUNCTION__); }))
# 165 "MagickWand/magick-wand.c"
                                    ;
  
# 166 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 166 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 166 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 166 "MagickWand/magick-wand.c"
...
# 166 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 166 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 166, __extension__ __PRETTY_FUNCTION__); }))
# 166 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 168,"%s",wand->name);
  wand->images=DestroyImageList(wand->images);
  if (wand->image_info != (ImageInfo *) 
# 170 "MagickWand/magick-wand.c" 3 4
                                       ((void *)0) 
# 170 "MagickWand/magick-wand.c"
                                            )
    wand->image_info=DestroyImageInfo(wand->image_info);
  if (wand->exception != (ExceptionInfo *) 
# 172 "MagickWand/magick-wand.c" 3 4
                                          ((void *)0) 
# 172 "MagickWand/magick-wand.c"
                                               )
...
# 202 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsMagickWand(const MagickWand *wand)
{
  if (wand == (const MagickWand *) 
# 204 "MagickWand/magick-wand.c" 3 4
                                  ((void *)0)
# 204 "MagickWand/magick-wand.c"
                                      )
    return(MagickFalse);
  if (wand->signature != 0xabacadabUL)
    return(MagickFalse);
  if (LocaleNCompare(wand->name,"MagickWand",strlen("MagickWand")) != 0)
    return(MagickFalse);
  return(MagickTrue);
}
# 235 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType MagickClearException(MagickWand *wand)
{
  
# 237 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 237 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 237 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 237 "MagickWand/magick-wand.c"
...
# 237 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 237 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 237, __extension__ __PRETTY_FUNCTION__); }))
# 237 "MagickWand/magick-wand.c"
                                    ;
  
# 238 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 238 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 238 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 238 "MagickWand/magick-wand.c"
...
# 238 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 238 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 238, __extension__ __PRETTY_FUNCTION__); }))
# 238 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 240,"%s",wand->name);
  ClearMagickException(wand->exception);
  return(MagickTrue);
}
# 273 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) char *MagickGetException(const MagickWand *wand,
...
# 279 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 279 "MagickWand/magick-wand.c"
...
# 279 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 279, __extension__ __PRETTY_FUNCTION__); }))
# 279 "MagickWand/magick-wand.c"
                                          ;
  
# 280 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 280 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 280 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 280 "MagickWand/magick-wand.c"
...
# 280 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 280 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 280, __extension__ __PRETTY_FUNCTION__); }))
# 280 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 282,"%s",wand->name);
  
# 283 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 283 "MagickWand/magick-wand.c"
...
# 283 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 283, __extension__ __PRETTY_FUNCTION__); }))
# 283 "MagickWand/magick-wand.c"
                                           ;
  *severity=wand->exception->severity;
  description=(char *) AcquireQuantumMemory(2UL*4096,
    sizeof(*description));
  if (description == (char *) 
# 287 "MagickWand/magick-wand.c" 3 4
                             ((void *)0)
# 287 "MagickWand/magick-wand.c"
                                 )
    {
      (void) ThrowMagickException(wand->exception,"MagickWand/magick-wand.c",__func__,(unsigned long) 289,WandError,
        "MemoryAllocationFailed","`%s'",wand->name);
      return((char *) 
# 291 "MagickWand/magick-wand.c" 3 4
                     ((void *)0)
# 291 "MagickWand/magick-wand.c"
                         );
    }
  *description='\0';
  if (wand->exception->reason != (char *) 
# 294 "MagickWand/magick-wand.c" 3 4
                                         ((void *)0)
# 294 "MagickWand/magick-wand.c"
                                             )
    (void) CopyMagickString(description,GetLocaleExceptionMessage(
      wand->exception->severity,wand->exception->reason),4096);
  if (wand->exception->description != (char *) 
# 297 "MagickWand/magick-wand.c" 3 4
                                              ((void *)0)
# 297 "MagickWand/magick-wand.c"
                                                  )
    {
      (void) ConcatenateMagickString(description," (",4096);
      (void) ConcatenateMagickString(description,GetLocaleExceptionMessage(
        wand->exception->severity,wand->exception->description),4096);
      (void) ConcatenateMagickString(description,")",4096);
    }
  return(description);
}
# 330 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) ExceptionType MagickGetExceptionType(const MagickWand *wand)
{
  
# 332 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 332 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 332 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 332 "MagickWand/magick-wand.c"
...
# 332 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 332 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 332, __extension__ __PRETTY_FUNCTION__); }))
# 332 "MagickWand/magick-wand.c"
                                    ;
  
# 333 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 333 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 333 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 333 "MagickWand/magick-wand.c"
...
# 333 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 333 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 333, __extension__ __PRETTY_FUNCTION__); }))
# 333 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 335,"%s",wand->name);
  return(wand->exception->severity);
}
# 362 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) ssize_t MagickGetIteratorIndex(MagickWand *wand)
{
  
# 364 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 364 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 364 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 364 "MagickWand/magick-wand.c"
...
# 364 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 364 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 364, __extension__ __PRETTY_FUNCTION__); }))
# 364 "MagickWand/magick-wand.c"
                                    ;
  
# 365 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 365 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 365 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 365 "MagickWand/magick-wand.c"
...
# 365 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 365 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 365, __extension__ __PRETTY_FUNCTION__); }))
# 365 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 367,"%s",wand->name);
  if (wand->images == (Image *) 
# 368 "MagickWand/magick-wand.c" 3 4
                               ((void *)0)
# 368 "MagickWand/magick-wand.c"
                                   )
    {
      (void) ThrowMagickException(wand->exception,"MagickWand/magick-wand.c",__func__,(unsigned long) 370,WandError,
        "ContainsNoIterators","`%s'",wand->name);
      return(-1);
    }
  return(GetImageIndexInList(wand->images));
}
# 400 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) char *MagickQueryConfigureOption(const char *option)
{
  char
    *value;
  ...
  if (configure_info == (const ConfigureInfo **) 
# 417 "MagickWand/magick-wand.c" 3 4
                                                ((void *)0)
# 417 "MagickWand/magick-wand.c"
                                                    )
    return((char *) 
# 418 "MagickWand/magick-wand.c" 3 4
                   ((void *)0)
# 418 "MagickWand/magick-wand.c"
                       );
  value=(char *) 
# 419 "MagickWand/magick-wand.c" 3 4
                ((void *)0)
# 419 "MagickWand/magick-wand.c"
                    ;
  if (number_options != 0)
...
# 454 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) char **MagickQueryConfigureOptions(const char *pattern,
...
# 513 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) double *MagickQueryFontMetrics(MagickWand *wand,
...
# 528 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 528 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 528 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 528 "MagickWand/magick-wand.c"
...
# 528 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 528 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 528, __extension__ __PRETTY_FUNCTION__); }))
# 528 "MagickWand/magick-wand.c"
                                    ;
  
# 529 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 529 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 529 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 529 "MagickWand/magick-wand.c"
...
# 529 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 529 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 529, __extension__ __PRETTY_FUNCTION__); }))
# 529 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 531,"%s",wand->name);
  
# 532 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 532 "MagickWand/magick-wand.c"
 drawing_wand != (const DrawingWand *) 
# 532 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 532 "MagickWand/magick-wand.c"
 drawing_wand != (const DrawingWand *) 
# 532 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 532 "MagickWand/magick-wand.c"
 "drawing_wand != (const DrawingWand *) NULL"
# 532 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 532, __extension__ __PRETTY_FUNCTION__); }))
# 532 "MagickWand/magick-wand.c"
                                                   ;
  if (wand->images == (Image *) 
# 533 "MagickWand/magick-wand.c" 3 4
                               ((void *)0)
# 533 "MagickWand/magick-wand.c"
                                   )
    {
      (void) ThrowMagickException(wand->exception,"MagickWand/magick-wand.c",__func__,(unsigned long) 535,WandError,
        "ContainsNoImages","`%s'",wand->name);
      return((double *) 
# 537 "MagickWand/magick-wand.c" 3 4
                       ((void *)0)
# 537 "MagickWand/magick-wand.c"
                           );
    }
  font_metrics=(double *) AcquireQuantumMemory(13UL,sizeof(*font_metrics));
  if (font_metrics == (double *) 
# 540 "MagickWand/magick-wand.c" 3 4
                                ((void *)0)
# 540 "MagickWand/magick-wand.c"
                                    )
    return((double *) 
# 541 "MagickWand/magick-wand.c" 3 4
                     ((void *)0)
# 541 "MagickWand/magick-wand.c"
                         );
  draw_info=PeekDrawingWand(drawing_wand);
  if (draw_info == (DrawInfo *) 
# 543 "MagickWand/magick-wand.c" 3 4
                               ((void *)0)
# 543 "MagickWand/magick-wand.c"
                                   )
    {
      font_metrics=(double *) RelinquishMagickMemory(font_metrics);
      return((double *) 
# 546 "MagickWand/magick-wand.c" 3 4
                       ((void *)0)
# 546 "MagickWand/magick-wand.c"
                           );
    }
  ...
  if (status == MagickFalse)
    {
      font_metrics=(double *) RelinquishMagickMemory(font_metrics);
      return((double *) 
# 555 "MagickWand/magick-wand.c" 3 4
                       ((void *)0)
# 555 "MagickWand/magick-wand.c"
                           );
    }
...
# 620 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) double *MagickQueryMultilineFontMetrics(MagickWand *wand,
  const DrawingWand *drawing_wand,const char *text)
{
  double
    *font_metrics;
...
# 635 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 635 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 635 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 635 "MagickWand/magick-wand.c"
...
# 635 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 635 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 635, __extension__ __PRETTY_FUNCTION__); }))
# 635 "MagickWand/magick-wand.c"
                                    ;
  
# 636 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 636 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 636 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 636 "MagickWand/magick-wand.c"
...
# 636 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 636 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 636, __extension__ __PRETTY_FUNCTION__); }))
# 636 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 638,"%s",wand->name);
  
# 639 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 639 "MagickWand/magick-wand.c"
 drawing_wand != (const DrawingWand *) 
# 639 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 639 "MagickWand/magick-wand.c"
...
# 639 "MagickWand/magick-wand.c"
 "drawing_wand != (const DrawingWand *) NULL"
# 639 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 639, __extension__ __PRETTY_FUNCTION__); }))
# 639 "MagickWand/magick-wand.c"
                                                   ;
  if (wand->images == (Image *) 
# 640 "MagickWand/magick-wand.c" 3 4
                               ((void *)0)
# 640 "MagickWand/magick-wand.c"
                                   )
    {
      (void) ThrowMagickException(wand->exception,"MagickWand/magick-wand.c",__func__,(unsigned long) 642,WandError,
        "ContainsNoImages","`%s'",wand->name);
      return((double *) 
# 644 "MagickWand/magick-wand.c" 3 4
                       ((void *)0)
# 644 "MagickWand/magick-wand.c"
                           );
    }
  font_metrics=(double *) AcquireQuantumMemory(13UL,sizeof(*font_metrics));
  if (font_metrics == (double *) 
# 647 "MagickWand/magick-wand.c" 3 4
                                ((void *)0)
# 647 "MagickWand/magick-wand.c"
                                    )
    return((double *) 
# 648 "MagickWand/magick-wand.c" 3 4
                     ((void *)0)
# 648 "MagickWand/magick-wand.c"
                         );
  draw_info=PeekDrawingWand(drawing_wand);
  if (draw_info == (DrawInfo *) 
# 650 "MagickWand/magick-wand.c" 3 4
                               ((void *)0)
# 650 "MagickWand/magick-wand.c"
                                   )
    {
      font_metrics=(double *) RelinquishMagickMemory(font_metrics);
      return((double *) 
# 653 "MagickWand/magick-wand.c" 3 4
                       ((void *)0)
# 653 "MagickWand/magick-wand.c"
                           );
    }
  (void) CloneString(&draw_info->text,text);
  (void) memset(&metrics,0,sizeof(metrics));
  ...
  if (status == MagickFalse)
    {
      font_metrics=(double *) RelinquishMagickMemory(font_metrics);
      return((double *) 
# 663 "MagickWand/magick-wand.c" 3 4
                       ((void *)0)
# 663 "MagickWand/magick-wand.c"
                           );
    }
  font_metrics[0]=metrics.pixels_per_em.x;
  font_metrics[1]=metrics.pixels_per_em.y;
...
# 706 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) char **MagickQueryFonts(const char *pattern,
  size_t *number_fonts)
{
  char
    **fonts;
...
# 747 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) char **MagickQueryFormats(const char *pattern,
...
# 785 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) void *MagickRelinquishMemory(void *memory)
{
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 788,"...");
  return(RelinquishMagickMemory(memory));
}
# 824 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) void MagickResetIterator(MagickWand *wand)
{
  
# 826 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 826 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 826 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 826 "MagickWand/magick-wand.c"
...
# 826 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 826 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 826, __extension__ __PRETTY_FUNCTION__); }))
# 826 "MagickWand/magick-wand.c"
                                    ;
  
# 827 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 827 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 827 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 827 "MagickWand/magick-wand.c"
...
# 827 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 827 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 827, __extension__ __PRETTY_FUNCTION__); }))
# 827 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 829,"%s",wand->name);
  wand->images=GetFirstImageInList(wand->images);
  wand->insert_before=MagickFalse;
  wand->image_pending=MagickTrue;
}
# 868 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) void MagickSetFirstIterator(MagickWand *wand)
{
  
# 870 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 870 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 870 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 870 "MagickWand/magick-wand.c"
...
# 870 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 870 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 870, __extension__ __PRETTY_FUNCTION__); }))
# 870 "MagickWand/magick-wand.c"
                                    ;
  
# 871 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 871 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 871 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 871 "MagickWand/magick-wand.c"
...
# 871 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 871 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 871, __extension__ __PRETTY_FUNCTION__); }))
# 871 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 873,"%s",wand->name);
  wand->images=GetFirstImageInList(wand->images);
  wand->insert_before=MagickTrue;
  wand->image_pending=MagickFalse;
}
# 920 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType MagickSetIteratorIndex(MagickWand *wand,
  const ssize_t index)
{
  Image
    *image;
...
# 926 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 926 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 926 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 926 "MagickWand/magick-wand.c"
...
# 926 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 926 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 926, __extension__ __PRETTY_FUNCTION__); }))
# 926 "MagickWand/magick-wand.c"
                                    ;
  
# 927 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 927 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 927 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 927 "MagickWand/magick-wand.c"
...
# 927 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 927 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 927, __extension__ __PRETTY_FUNCTION__); }))
# 927 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 929,"%s",wand->name);
  if (wand->images == (Image *) 
# 930 "MagickWand/magick-wand.c" 3 4
                               ((void *)0)
# 930 "MagickWand/magick-wand.c"
                                   )
    return(MagickFalse);
  image=GetImageFromList(wand->images,index);
  if (image == (Image *) 
# 933 "MagickWand/magick-wand.c" 3 4
                        ((void *)0)
# 933 "MagickWand/magick-wand.c"
                            )
    return(MagickFalse);
  wand->images=image;
  wand->insert_before=MagickFalse;
...
# 971 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) void MagickSetLastIterator(MagickWand *wand)
{
  
# 973 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 973 "MagickWand/magick-wand.c"
 wand != (MagickWand *) 
# 973 "MagickWand/magick-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 973 "MagickWand/magick-wand.c"
...
# 973 "MagickWand/magick-wand.c"
 "wand != (MagickWand *) NULL"
# 973 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 973, __extension__ __PRETTY_FUNCTION__); }))
# 973 "MagickWand/magick-wand.c"
                                    ;
  
# 974 "MagickWand/magick-wand.c" 3 4
 ((void) sizeof ((
# 974 "MagickWand/magick-wand.c"
 wand->signature == 0xabacadabUL
# 974 "MagickWand/magick-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 974 "MagickWand/magick-wand.c"
...
# 974 "MagickWand/magick-wand.c"
 "wand->signature == MagickWandSignature"
# 974 "MagickWand/magick-wand.c" 3 4
 , "MagickWand/magick-wand.c", 974, __extension__ __PRETTY_FUNCTION__); }))
# 974 "MagickWand/magick-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 976,"%s",wand->name);
  wand->images=GetLastImageInList(wand->images);
  wand->insert_before=MagickFalse;
  wand->image_pending=MagickTrue;
}
# 1000 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) void MagickWandGenesis(void)
{
  if (IsMagickCoreInstantiated() == MagickFalse)
    MagickCoreGenesis((char *) 
# 1003 "MagickWand/magick-wand.c" 3 4
                              ((void *)0)
# 1003 "MagickWand/magick-wand.c"
                                  ,MagickFalse);
}
# 1046 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) void MagickWandTerminus(void)
{
  DestroyWandIds();
  MagickCoreTerminus();
}
# 1073 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) MagickWand *NewMagickWand(void)
{
  MagickWand
    *wand;
  ...
  if (wand == (MagickWand *) 
# 1080 "MagickWand/magick-wand.c" 3 4
                            ((void *)0)
# 1080 "MagickWand/magick-wand.c"
                                )
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/magick-wand.c",__func__,(unsigned long) 1081,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",GetExceptionMessage(
# 1081 "MagickWand/magick-wand.c" 3 4
   (*__errno_location ())
# 1081 "MagickWand/magick-wand.c"
  ...
  (void) FormatLocaleString(wand->name,4096,"%s-%.20g","MagickWand",
    (double) wand->id);
  ...
  wand->debug=IsEventLogging();
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/magick-wand.c",__func__,(unsigned long) 1092,"%s",wand->name);
  wand->signature=0xabacadabUL;
  return(wand);
}
# 1119 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) MagickWand *NewMagickWandFromImage(const Image *image)
{
  MagickWand
    *wand;
...
# 1149 "MagickWand/magick-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsMagickWandInstantiated(void)
{
