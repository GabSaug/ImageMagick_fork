# 0 "MagickWand/wandcli.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/wandcli.c"
# 42 "MagickWand/wandcli.c"
...
# 48 "MagickWand/wandcli.c" 2
# 73 "MagickWand/wandcli.c"
__attribute__ ((visibility ("default"))) MagickCLI *AcquireMagickCLI(ImageInfo *image_info,
...
# 89 "MagickWand/wandcli.c"
  ...
  cli_wand->draw_info=CloneDrawInfo(cli_wand->wand.image_info,(DrawInfo *) 
# 97 "MagickWand/wandcli.c" 3 4
                                                                          ((void *)0)
# 97 "MagickWand/wandcli.c"
                                                                              );
  cli_wand->quantize_info=AcquireQuantizeInfo(cli_wand->wand.image_info);
  cli_wand->process_flags=MagickCommandOptionFlags;
  cli_wand->command=(const OptionInfo *) 
# 100 "MagickWand/wandcli.c" 3 4
                                        ((void *)0)
# 100 "MagickWand/wandcli.c"
                                            ;
  cli_wand->image_list_stack=(CLIStack *) 
# 101 "MagickWand/wandcli.c" 3 4
                                         ((void *)0)
# 101 "MagickWand/wandcli.c"
                                             ;
  cli_wand->image_info_stack=(CLIStack *) 
# 102 "MagickWand/wandcli.c" 3 4
                                         ((void *)0)
# 102 "MagickWand/wandcli.c"
                                             ;




  cli_wand->location="from \"%s\"";

  cli_wand->filename="unknown";
  cli_wand->line=0;
  cli_wand->column=0;

  cli_wand->signature=0xabacadabUL;
  if (cli_wand->wand.debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/wandcli.c",__func__,(unsigned long) 115,"%s",cli_wand->wand.name);
  return(cli_wand);
}
# 139 "MagickWand/wandcli.c"
__attribute__ ((visibility ("default"))) MagickCLI *DestroyMagickCLI(MagickCLI *cli_wand)
{
  CLIStack
    *node;

  
# 144 "MagickWand/wandcli.c" 3 4
 ((void) sizeof ((
# 144 "MagickWand/wandcli.c"
 cli_wand != (MagickCLI *) 
# 144 "MagickWand/wandcli.c" 3 4
...
# 144 "MagickWand/wandcli.c" 3 4
 , "MagickWand/wandcli.c", 144, __extension__ __PRETTY_FUNCTION__); }))
# 144 "MagickWand/wandcli.c"
                                       ;
  
# 145 "MagickWand/wandcli.c" 3 4
 ((void) sizeof ((
# 145 "MagickWand/wandcli.c"
 cli_wand->signature == 0xabacadabUL
# 145 "MagickWand/wandcli.c" 3 4
...
# 145 "MagickWand/wandcli.c" 3 4
 , "MagickWand/wandcli.c", 145, __extension__ __PRETTY_FUNCTION__); }))
# 145 "MagickWand/wandcli.c"
                                                   ;
  
# 146 "MagickWand/wandcli.c" 3 4
 ((void) sizeof ((
# 146 "MagickWand/wandcli.c"
 cli_wand->wand.signature == 0xabacadabUL
# 146 "MagickWand/wandcli.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 146 "MagickWand/wandcli.c"
...
# 146 "MagickWand/wandcli.c" 3 4
 , "MagickWand/wandcli.c", 146, __extension__ __PRETTY_FUNCTION__); }))
# 146 "MagickWand/wandcli.c"
                                                        ;
  if (cli_wand->wand.debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/wandcli.c",__func__,(unsigned long) 148,"%s",cli_wand->wand.name);


  if (cli_wand->draw_info != (DrawInfo *) 
# 151 "MagickWand/wandcli.c" 3 4
                                         ((void *)0) 
# 151 "MagickWand/wandcli.c"
                                              )
    cli_wand->draw_info=DestroyDrawInfo(cli_wand->draw_info);
  if (cli_wand->quantize_info != (QuantizeInfo *) 
# 153 "MagickWand/wandcli.c" 3 4
                                                 ((void *)0) 
# 153 "MagickWand/wandcli.c"
                                                      )
    cli_wand->quantize_info=DestroyQuantizeInfo(cli_wand->quantize_info);
  while(cli_wand->image_list_stack != (CLIStack *) 
# 155 "MagickWand/wandcli.c" 3 4
                                                  ((void *)0)
# 155 "MagickWand/wandcli.c"
                                                      )
    {
...
# 162 "MagickWand/wandcli.c" 3 4
                                                  ((void *)0)
# 162 "MagickWand/wandcli.c"
                                                      )
    {
...
# 173 "MagickWand/wandcli.c" 3 4
                                                ((void *)0) 
# 173 "MagickWand/wandcli.c"
                                                     )
    cli_wand->wand.image_info=DestroyImageInfo(cli_wand->wand.image_info);
  if (cli_wand->wand.exception != (ExceptionInfo *) 
# 175 "MagickWand/wandcli.c" 3 4
                                                   ((void *)0) 
# 175 "MagickWand/wandcli.c"
                                                        )
  ...
  return((MagickCLI *) 
# 180 "MagickWand/wandcli.c" 3 4
                      ((void *)0)
# 180 "MagickWand/wandcli.c"
                          );
}
# 216 "MagickWand/wandcli.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CLICatchException(MagickCLI *cli_wand,
...
# 222 "MagickWand/wandcli.c" 3 4
 ((void) sizeof ((
# 222 "MagickWand/wandcli.c"
 cli_wand != (MagickCLI *) 
# 222 "MagickWand/wandcli.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 222 "MagickWand/wandcli.c"
...
# 222 "MagickWand/wandcli.c"
 "cli_wand != (MagickCLI *) NULL"
# 222 "MagickWand/wandcli.c" 3 4
 , "MagickWand/wandcli.c", 222, __extension__ __PRETTY_FUNCTION__); }))
# 222 "MagickWand/wandcli.c"
                                       ;
  
# 223 "MagickWand/wandcli.c" 3 4
 ((void) sizeof ((
# 223 "MagickWand/wandcli.c"
 cli_wand->signature == 0xabacadabUL
# 223 "MagickWand/wandcli.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 223 "MagickWand/wandcli.c"
...
# 223 "MagickWand/wandcli.c"
 "cli_wand->signature == MagickWandSignature"
# 223 "MagickWand/wandcli.c" 3 4
 , "MagickWand/wandcli.c", 223, __extension__ __PRETTY_FUNCTION__); }))
# 223 "MagickWand/wandcli.c"
                                                   ;
  
# 224 "MagickWand/wandcli.c" 3 4
 ((void) sizeof ((
# 224 "MagickWand/wandcli.c"
 cli_wand->wand.signature == 0xabacadabUL
# 224 "MagickWand/wandcli.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 224 "MagickWand/wandcli.c"
...
# 224 "MagickWand/wandcli.c"
 "cli_wand->wand.signature == MagickWandSignature"
# 224 "MagickWand/wandcli.c" 3 4
 , "MagickWand/wandcli.c", 224, __extension__ __PRETTY_FUNCTION__); }))
# 224 "MagickWand/wandcli.c"
                                                        ;
  if (cli_wand->wand.debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/wandcli.c",__func__,(unsigned long) 226,"%s",cli_wand->wand.name);
  ...
  if ((status == MagickFalse) || (all_exceptions != MagickFalse))
    CatchException(cli_wand->wand.exception);

  return(status);
}
# 257 "MagickWand/wandcli.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CLILogEvent(MagickCLI *cli_wand,
     ...
     const size_t line,const char *format,...)
{
  ...
  (void) FormatLocaleString(new_format,4096,cli_wand->location,
       cli_wand->filename, cli_wand->line, cli_wand->column);
  (void) ConcatenateMagickString(new_format," ",4096);
  (void) ConcatenateMagickString(new_format,format,4096);

  
# 283 "MagickWand/wandcli.c" 3 4
 __builtin_va_start(
# 283 "MagickWand/wandcli.c"
 operands
# 283 "MagickWand/wandcli.c" 3 4
 ,
# 283 "MagickWand/wandcli.c"
...
# 283 "MagickWand/wandcli.c"
                          ;
  status=LogMagickEventList(type,module,function,line,new_format,
    operands);
  
# 286 "MagickWand/wandcli.c" 3 4
 __builtin_va_end(
# 286 "MagickWand/wandcli.c"
 operands
# 286 "MagickWand/wandcli.c" 3 4
 )
# 286 "MagickWand/wandcli.c"
...
# 305 "MagickWand/wandcli.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CLIThrowException(MagickCLI *cli_wand,
  ...
  const ExceptionType severity,const char *tag,const char *format,...)
{
  ...
  (void) CopyMagickString(new_format,format,4096);
  (void) ConcatenateMagickString(new_format," ",4096);

  len=strlen(new_format);
  (void) FormatLocaleString(new_format+len,4096 -len,
    cli_wand->location,cli_wand->filename,cli_wand->line,cli_wand->column);

  
# 333 "MagickWand/wandcli.c" 3 4
 __builtin_va_start(
# 333 "MagickWand/wandcli.c"
 operands
# 333 "MagickWand/wandcli.c" 3 4
 ,
# 333 "MagickWand/wandcli.c"
...
# 333 "MagickWand/wandcli.c"
                          ;
  status=ThrowMagickExceptionList(cli_wand->wand.exception,module,
    function,line,severity,tag,new_format,operands);
  
# 336 "MagickWand/wandcli.c" 3 4
 __builtin_va_end(
# 336 "MagickWand/wandcli.c"
 operands
# 336 "MagickWand/wandcli.c" 3 4
 )
# 336 "MagickWand/wandcli.c"
