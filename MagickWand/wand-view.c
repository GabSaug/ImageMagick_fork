# 0 "MagickWand/wand-view.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/wand-view.c"
# 48 "MagickWand/wand-view.c"
...
# 54 "MagickWand/wand-view.c" 2
# 62 "MagickWand/wand-view.c"
struct _WandView
{
  size_t
    id;
...
# 118 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) WandView *CloneWandView(const WandView *wand_view)
{
  ssize_t
    i;
...
# 126 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 126 "MagickWand/wand-view.c"
 wand_view != (WandView *) 
# 126 "MagickWand/wand-view.c" 3 4
...
# 126 "MagickWand/wand-view.c"
 "wand_view != (WandView *) NULL"
# 126 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 126, __extension__ __PRETTY_FUNCTION__); }))
# 126 "MagickWand/wand-view.c"
                                       ;
  
# 127 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 127 "MagickWand/wand-view.c"
 wand_view->signature == 0xabacadabUL
# 127 "MagickWand/wand-view.c" 3 4
...
# 127 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 127, __extension__ __PRETTY_FUNCTION__); }))
# 127 "MagickWand/wand-view.c"
                                                    ;
  if (wand_view->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/wand-view.c",__func__,(unsigned long) 129,"%s",wand_view->name);
  clone_view=(WandView *) AcquireCriticalMemory(sizeof(*clone_view));
  (void) memset(clone_view,0,sizeof(*clone_view));
  clone_view->id=AcquireWandId();
  (void) FormatLocaleString(clone_view->name,4096,"%s-%.20g",
    "WandView",(double) clone_view->id);
  ...
  if (clone_view->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/wand-view.c",__func__,(unsigned long) 147,"%s",clone_view->name);
  clone_view->signature=0xabacadabUL;
  return(clone_view);
}
# 175 "MagickWand/wand-view.c"
...
# 181 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 181 "MagickWand/wand-view.c"
...
# 181 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 181 "MagickWand/wand-view.c"
 "pixel_wands != (PixelWand ***) NULL"
# 181 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 181, __extension__ __PRETTY_FUNCTION__); }))
# 181 "MagickWand/wand-view.c"
                                            ;
  for (i=0; i < (ssize_t) GetMagickResourceLimit(ThreadResource); i++)
    if (pixel_wands[i] != (PixelWand **) 
# 183 "MagickWand/wand-view.c" 3 4
                                        ((void *)0)
# 183 "MagickWand/wand-view.c"
                                            )
...
__attribute__ ((visibility ("default"))) WandView *DestroyWandView(WandView *wand_view)
{
  
# 191 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 191 "MagickWand/wand-view.c"
 wand_view != (WandView *) 
# 191 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 191 "MagickWand/wand-view.c"
...
# 191 "MagickWand/wand-view.c"
 "wand_view != (WandView *) NULL"
# 191 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 191, __extension__ __PRETTY_FUNCTION__); }))
# 191 "MagickWand/wand-view.c"
                                       ;
  
# 192 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 192 "MagickWand/wand-view.c"
 wand_view->signature == 0xabacadabUL
# 192 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 192 "MagickWand/wand-view.c"
...
# 192 "MagickWand/wand-view.c"
 "wand_view->signature == MagickWandSignature"
# 192 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 192, __extension__ __PRETTY_FUNCTION__); }))
# 192 "MagickWand/wand-view.c"
                                                    ;
...
# 254 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DuplexTransferWandViewIterator(WandView *source,
...
# 276 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 276 "MagickWand/wand-view.c"
 source != (WandView *) 
# 276 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 276 "MagickWand/wand-view.c"
...
# 276 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 276 "MagickWand/wand-view.c"
 "source != (WandView *) NULL"
# 276 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 276, __extension__ __PRETTY_FUNCTION__); }))
# 276 "MagickWand/wand-view.c"
                                    ;
  
# 277 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 277 "MagickWand/wand-view.c"
...
# 277 "MagickWand/wand-view.c"
 "source->signature == MagickWandSignature"
# 277 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 277, __extension__ __PRETTY_FUNCTION__); }))
# 277 "MagickWand/wand-view.c"
                                                 ;
  if (transfer == (DuplexTransferWandViewMethod) 
# 278 "MagickWand/wand-view.c" 3 4
                                                ((void *)0)
# 278 "MagickWand/wand-view.c"
                                                    )
    return(MagickFalse);
...
# 315 "MagickWand/wand-view.c" 3 4
                                   ((void *)0)
# 315 "MagickWand/wand-view.c"
                                       )
      {
        status=MagickFalse;
        continue;
    ...
    if (duplex_pixels == (const Quantum *) 
# 327 "MagickWand/wand-view.c" 3 4
                                          ((void *)0)
# 327 "MagickWand/wand-view.c"
                                              )
      {
        status=MagickFalse;
        continue;
    ...
    destination_pixels=GetCacheViewAuthenticPixels(destination->view,
      ...
      destination->exception);
    if (destination_pixels == (Quantum *) 
# 341 "MagickWand/wand-view.c" 3 4
                                         ((void *)0)
# 341 "MagickWand/wand-view.c"
                                             )
      {
        status=MagickFalse;
        continue;
    ...
    if (sync == MagickFalse)
      status=MagickFalse;
    if (source_image->progress_monitor != (MagickProgressMonitor) 
# 366 "MagickWand/wand-view.c" 3 4
                                                                 ((void *)0)
# 366 "MagickWand/wand-view.c"
                                                                     )
      {
        MagickBooleanType
          proceed;
...
# 410 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) char *GetWandViewException(const WandView *wand_view,
...
# 416 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 416 "MagickWand/wand-view.c"
 wand_view != (const WandView *) 
# 416 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 416 "MagickWand/wand-view.c"
 wand_view != (const WandView *) 
# 416 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 416 "MagickWand/wand-view.c"
 "wand_view != (const WandView *) NULL"
# 416 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 416, __extension__ __PRETTY_FUNCTION__); }))
# 416 "MagickWand/wand-view.c"
                                             ;
  
# 417 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 417 "MagickWand/wand-view.c"
 wand_view->signature == 0xabacadabUL
# 417 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 417 "MagickWand/wand-view.c"
...
# 417 "MagickWand/wand-view.c"
 "wand_view->signature == MagickWandSignature"
# 417 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 417, __extension__ __PRETTY_FUNCTION__); }))
# 417 "MagickWand/wand-view.c"
                                                    ;
  if (wand_view->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/wand-view.c",__func__,(unsigned long) 419,"%s",wand_view->name);
  
# 420 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 420 "MagickWand/wand-view.c"
...
# 420 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 420, __extension__ __PRETTY_FUNCTION__); }))
# 420 "MagickWand/wand-view.c"
                                           ;
  *severity=wand_view->exception->severity;
  description=(char *) AcquireQuantumMemory(2UL*4096,
    sizeof(*description));
  if (description == (char *) 
# 424 "MagickWand/wand-view.c" 3 4
                             ((void *)0)
# 424 "MagickWand/wand-view.c"
                                 )
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/wand-view.c",__func__,(unsigned long) 425,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",wand_view->name); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                      ;
  *description='\0';
  if (wand_view->exception->reason != (char *) 
# 428 "MagickWand/wand-view.c" 3 4
                                              ((void *)0)
# 428 "MagickWand/wand-view.c"
                                                  )
    (void) CopyMagickString(description,GetLocaleExceptionMessage(
      wand_view->exception->severity,wand_view->exception->reason),
        4096);
  if (wand_view->exception->description != (char *) 
# 432 "MagickWand/wand-view.c" 3 4
                                                   ((void *)0)
# 432 "MagickWand/wand-view.c"
                                                       )
    {
...
# 465 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) RectangleInfo GetWandViewExtent(const WandView *wand_view)
{
  
# 467 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 467 "MagickWand/wand-view.c"
 wand_view != (WandView *) 
# 467 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 467 "MagickWand/wand-view.c"
...
# 467 "MagickWand/wand-view.c"
 "wand_view != (WandView *) NULL"
# 467 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 467, __extension__ __PRETTY_FUNCTION__); }))
# 467 "MagickWand/wand-view.c"
                                       ;
  
# 468 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 468 "MagickWand/wand-view.c"
 wand_view->signature == 0xabacadabUL
# 468 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 468 "MagickWand/wand-view.c"
...
# 468 "MagickWand/wand-view.c"
 "wand_view->signature == MagickWandSignature"
# 468 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 468, __extension__ __PRETTY_FUNCTION__); }))
# 468 "MagickWand/wand-view.c"
                                                    ;
  return(wand_view->extent);
}
# 515 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetWandViewIterator(WandView *source,
...
# 535 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 535 "MagickWand/wand-view.c"
 source != (WandView *) 
# 535 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 535 "MagickWand/wand-view.c"
...
# 535 "MagickWand/wand-view.c"
 "source != (WandView *) NULL"
# 535 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 535, __extension__ __PRETTY_FUNCTION__); }))
# 535 "MagickWand/wand-view.c"
                                    ;
  
# 536 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 536 "MagickWand/wand-view.c"
 source->signature == 0xabacadabUL
# 536 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 536 "MagickWand/wand-view.c"
...
# 536 "MagickWand/wand-view.c"
 "source->signature == MagickWandSignature"
# 536 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 536, __extension__ __PRETTY_FUNCTION__); }))
# 536 "MagickWand/wand-view.c"
                                                 ;
  if (get == (GetWandViewMethod) 
# 537 "MagickWand/wand-view.c" 3 4
                                ((void *)0)
# 537 "MagickWand/wand-view.c"
                                    )
    return(MagickFalse);
  source_image=source->wand->images;
  status=MagickTrue;
  ...
  for (y=source->extent.y; y < (ssize_t) source->extent.height; y++)
  {
    ...
    pixels=GetCacheViewVirtualPixels(source->view,source->extent.x,y,
      source->extent.width,1,source->exception);
    if (pixels == (const Quantum *) 
# 562 "MagickWand/wand-view.c" 3 4
                                   ((void *)0)
# 562 "MagickWand/wand-view.c"
                                       )
      {
        status=MagickFalse;
        continue;
    ...
    if (get(source,y,id,context) == MagickFalse)
      status=MagickFalse;
    if (source_image->progress_monitor != (MagickProgressMonitor) 
# 574 "MagickWand/wand-view.c" 3 4
                                                                 ((void *)0)
# 574 "MagickWand/wand-view.c"
                                                                     )
      {
        MagickBooleanType
          proceed;
...
# 614 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) PixelWand **GetWandViewPixels(const WandView *wand_view)
{
  const int
    id = GetOpenMPThreadId();

  
# 619 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 619 "MagickWand/wand-view.c"
 wand_view != (WandView *) 
# 619 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 619 "MagickWand/wand-view.c"
...
# 619 "MagickWand/wand-view.c"
 "wand_view != (WandView *) NULL"
# 619 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 619, __extension__ __PRETTY_FUNCTION__); }))
# 619 "MagickWand/wand-view.c"
                                       ;
  
# 620 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 620 "MagickWand/wand-view.c"
 wand_view->signature == 0xabacadabUL
# 620 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 620 "MagickWand/wand-view.c"
...
# 620 "MagickWand/wand-view.c"
 "wand_view->signature == MagickWandSignature"
# 620 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 620, __extension__ __PRETTY_FUNCTION__); }))
# 620 "MagickWand/wand-view.c"
                                                    ;
  return(wand_view->pixel_wands[id]);
}
# 646 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) MagickWand *GetWandViewWand(const WandView *wand_view)
{
  
# 648 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 648 "MagickWand/wand-view.c"
 wand_view != (WandView *) 
# 648 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 648 "MagickWand/wand-view.c"
...
# 648 "MagickWand/wand-view.c"
 "wand_view != (WandView *) NULL"
# 648 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 648, __extension__ __PRETTY_FUNCTION__); }))
# 648 "MagickWand/wand-view.c"
                                       ;
  
# 649 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 649 "MagickWand/wand-view.c"
 wand_view->signature == 0xabacadabUL
# 649 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 649 "MagickWand/wand-view.c"
...
# 649 "MagickWand/wand-view.c"
 "wand_view->signature == MagickWandSignature"
# 649 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 649, __extension__ __PRETTY_FUNCTION__); }))
# 649 "MagickWand/wand-view.c"
                                                    ;
  return(wand_view->wand);
}
# 676 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsWandView(const WandView *wand_view)
{
  size_t
    length;

  if (wand_view == (const WandView *) 
# 681 "MagickWand/wand-view.c" 3 4
                                     ((void *)0)
# 681 "MagickWand/wand-view.c"
                                         )
    return(MagickFalse);
  if (wand_view->signature != 0xabacadabUL)
    return(MagickFalse);
  length=strlen("WandView");
  if (LocaleNCompare(wand_view->name,"WandView",length) != 0)
    return(MagickFalse);
  return(MagickTrue);
}
# 715 "MagickWand/wand-view.c"
static PixelWand ***AcquirePixelsTLS(const size_t number_wands)
{
  ...
  pixel_wands=(PixelWand ***) AcquireQuantumMemory(number_threads,
    sizeof(*pixel_wands));
  if (pixel_wands == (PixelWand ***) 
# 729 "MagickWand/wand-view.c" 3 4
                                    ((void *)0)
# 729 "MagickWand/wand-view.c"
                                        )
    return((PixelWand ***) 
# 730 "MagickWand/wand-view.c" 3 4
                          ((void *)0)
# 730 "MagickWand/wand-view.c"
                              );
  ...
  for (i=0; i < (ssize_t) number_threads; i++)
  {
    ...
    if (pixel_wands[i] == (PixelWand **) 
# 735 "MagickWand/wand-view.c" 3 4
                                        ((void *)0)
# 735 "MagickWand/wand-view.c"
                                            )
...
__attribute__ ((visibility ("default"))) WandView *NewWandView(MagickWand *wand)
{
  ExceptionInfo
    *exception;
...
# 749 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 749 "MagickWand/wand-view.c"
 wand != (MagickWand *) 
# 749 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 749 "MagickWand/wand-view.c"
...
# 749 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 749, __extension__ __PRETTY_FUNCTION__); }))
# 749 "MagickWand/wand-view.c"
                                    ;
  
# 750 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 750 "MagickWand/wand-view.c"
...
# 750 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 750, __extension__ __PRETTY_FUNCTION__); }))
# 750 "MagickWand/wand-view.c"
                                               ;
  ...
  (void) FormatLocaleString(wand_view->name,4096,"%s-%.20g",
    "WandView",(double) wand_view->id);
  ...
  if (wand_view->pixel_wands == (PixelWand ***) 
# 765 "MagickWand/wand-view.c" 3 4
                                               ((void *)0)
# 765 "MagickWand/wand-view.c"
                                                   )
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/wand-view.c",__func__,(unsigned long) 766,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",GetExceptionMessage(
# 766 "MagickWand/wand-view.c" 3 4
   (*__errno_location ())
# 766 "MagickWand/wand-view.c"
...
# 800 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) WandView *NewWandViewExtent(MagickWand *wand,const ssize_t x,
...
# 809 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 809 "MagickWand/wand-view.c"
 wand != (MagickWand *) 
# 809 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 809 "MagickWand/wand-view.c"
...
# 809 "MagickWand/wand-view.c"
 "wand != (MagickWand *) NULL"
# 809 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 809, __extension__ __PRETTY_FUNCTION__); }))
# 809 "MagickWand/wand-view.c"
                                    ;
  
# 810 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 810 "MagickWand/wand-view.c"
 wand->signature == 0xabacadabUL
# 810 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 810 "MagickWand/wand-view.c"
...
# 810 "MagickWand/wand-view.c"
 "wand->signature == MagickWandSignature"
# 810 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 810, __extension__ __PRETTY_FUNCTION__); }))
# 810 "MagickWand/wand-view.c"
                                               ;
  wand_view=(WandView *) AcquireCriticalMemory(sizeof(*wand_view));
  (void) memset(wand_view,0,sizeof(*wand_view));
  ...
  wand_view->pixel_wands=AcquirePixelsTLS(wand_view->extent.width);
  if (wand_view->pixel_wands == (PixelWand ***) 
# 826 "MagickWand/wand-view.c" 3 4
                                               ((void *)0)
# 826 "MagickWand/wand-view.c"
                                                   )
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/wand-view.c",__func__,(unsigned long) 827,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",GetExceptionMessage(
# 827 "MagickWand/wand-view.c" 3 4
   (*__errno_location ())
# 827 "MagickWand/wand-view.c"
   )); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                                 ;
  wand_view->debug=IsEventLogging();
  wand_view->signature=0xabacadabUL;
...
# 858 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) void SetWandViewDescription(WandView *wand_view,
  const char *description)
{
  
# 861 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 861 "MagickWand/wand-view.c"
 wand_view != (WandView *) 
# 861 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 861 "MagickWand/wand-view.c"
...
# 861 "MagickWand/wand-view.c"
 "wand_view != (WandView *) NULL"
# 861 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 861, __extension__ __PRETTY_FUNCTION__); }))
# 861 "MagickWand/wand-view.c"
                                       ;
  
# 862 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 862 "MagickWand/wand-view.c"
 wand_view->signature == 0xabacadabUL
# 862 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 862 "MagickWand/wand-view.c"
...
# 862 "MagickWand/wand-view.c"
 "wand_view->signature == MagickWandSignature"
# 862 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 862, __extension__ __PRETTY_FUNCTION__); }))
# 862 "MagickWand/wand-view.c"
                                                    ;
  wand_view->description=ConstantString(description);
}
# 910 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetWandViewIterator(WandView *destination,
...
# 930 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 930 "MagickWand/wand-view.c"
 destination != (WandView *) 
# 930 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 930 "MagickWand/wand-view.c"
 destination != (WandView *) 
# 930 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 930 "MagickWand/wand-view.c"
 "destination != (WandView *) NULL"
# 930 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 930, __extension__ __PRETTY_FUNCTION__); }))
# 930 "MagickWand/wand-view.c"
                                         ;
  
# 931 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 931 "MagickWand/wand-view.c"
 destination->signature == 0xabacadabUL
# 931 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 931 "MagickWand/wand-view.c"
 destination->signature == 0xabacadabUL
...
# 931 "MagickWand/wand-view.c"
 "destination->signature == MagickWandSignature"
# 931 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 931, __extension__ __PRETTY_FUNCTION__); }))
# 931 "MagickWand/wand-view.c"
                                                      ;
  if (set == (SetWandViewMethod) 
# 932 "MagickWand/wand-view.c" 3 4
                                ((void *)0)
# 932 "MagickWand/wand-view.c"
                                    )
    return(MagickFalse);
  destination_image=destination->wand->images;
  status=SetImageStorageClass(destination_image,DirectClass,
  ...
  for (y=destination->extent.y; y < (ssize_t) destination->extent.height; y++)
  {
    ...
    if (pixels == (Quantum *) 
# 964 "MagickWand/wand-view.c" 3 4
                             ((void *)0)
# 964 "MagickWand/wand-view.c"
                                 )
      {
        status=MagickFalse;
        continue;
    ...
    if (sync == MagickFalse)
      status=MagickFalse;
    if (destination_image->progress_monitor != (MagickProgressMonitor) 
# 980 "MagickWand/wand-view.c" 3 4
                                                                      ((void *)0)
# 980 "MagickWand/wand-view.c"
                                                                          )
      {
        MagickBooleanType
          proceed;
...
# 1046 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType TransferWandViewIterator(WandView *source,
...
# 1067 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 1067 "MagickWand/wand-view.c"
 source != (WandView *) 
# 1067 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1067 "MagickWand/wand-view.c"
...
# 1067 "MagickWand/wand-view.c"
 "source != (WandView *) NULL"
# 1067 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 1067, __extension__ __PRETTY_FUNCTION__); }))
# 1067 "MagickWand/wand-view.c"
                                    ;
  
# 1068 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 1068 "MagickWand/wand-view.c"
 source->signature == 0xabacadabUL
# 1068 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1068 "MagickWand/wand-view.c"
...
# 1068 "MagickWand/wand-view.c"
 "source->signature == MagickWandSignature"
# 1068 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 1068, __extension__ __PRETTY_FUNCTION__); }))
# 1068 "MagickWand/wand-view.c"
                                                 ;
  if (transfer == (TransferWandViewMethod) 
# 1069 "MagickWand/wand-view.c" 3 4
                                          ((void *)0)
# 1069 "MagickWand/wand-view.c"
                                              )
    return(MagickFalse);
  source_image=source->wand->images;
  destination_image=destination->wand->images;
  ...
  for (y=source->extent.y; y < (ssize_t) source->extent.height; y++)
  {
    ...
    pixels=GetCacheViewVirtualPixels(source->view,source->extent.x,y,
      source->extent.width,1,source->exception);
    if (pixels == (const Quantum *) 
# 1105 "MagickWand/wand-view.c" 3 4
                                   ((void *)0)
# 1105 "MagickWand/wand-view.c"
                                       )
      {
        status=MagickFalse;
        continue;
    ...
    destination_pixels=GetCacheViewAuthenticPixels(destination->view,
      ...
      destination->exception);
    if (destination_pixels == (Quantum *) 
# 1118 "MagickWand/wand-view.c" 3 4
                                         ((void *)0)
# 1118 "MagickWand/wand-view.c"
                                             )
      {
        status=MagickFalse;
        continue;
    ...
    if (sync == MagickFalse)
      status=MagickFalse;
    if (source_image->progress_monitor != (MagickProgressMonitor) 
# 1143 "MagickWand/wand-view.c" 3 4
                                                                 ((void *)0)
# 1143 "MagickWand/wand-view.c"
                                                                     )
      {
        MagickBooleanType
          proceed;
...
# 1204 "MagickWand/wand-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType UpdateWandViewIterator(WandView *source,
...
# 1224 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 1224 "MagickWand/wand-view.c"
 source != (WandView *) 
# 1224 "MagickWand/wand-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1224 "MagickWand/wand-view.c"
...
# 1224 "MagickWand/wand-view.c"
 "source != (WandView *) NULL"
# 1224 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 1224, __extension__ __PRETTY_FUNCTION__); }))
# 1224 "MagickWand/wand-view.c"
                                    ;
  
# 1225 "MagickWand/wand-view.c" 3 4
 ((void) sizeof ((
# 1225 "MagickWand/wand-view.c"
 source->signature == 0xabacadabUL
# 1225 "MagickWand/wand-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1225 "MagickWand/wand-view.c"
...
# 1225 "MagickWand/wand-view.c"
 "source->signature == MagickWandSignature"
# 1225 "MagickWand/wand-view.c" 3 4
 , "MagickWand/wand-view.c", 1225, __extension__ __PRETTY_FUNCTION__); }))
# 1225 "MagickWand/wand-view.c"
                                                 ;
  if (update == (UpdateWandViewMethod) 
# 1226 "MagickWand/wand-view.c" 3 4
                                      ((void *)0)
# 1226 "MagickWand/wand-view.c"
                                          )
    return(MagickFalse);
  source_image=source->wand->images;
  ...
  for (y=source->extent.y; y < (ssize_t) source->extent.height; y++)
  {
    ...
    pixels=GetCacheViewAuthenticPixels(source->view,source->extent.x,y,
      source->extent.width,1,source->exception);
    if (pixels == (Quantum *) 
# 1261 "MagickWand/wand-view.c" 3 4
                             ((void *)0)
# 1261 "MagickWand/wand-view.c"
                                 )
      {
        status=MagickFalse;
        continue;
    ...
    if (sync == MagickFalse)
      status=MagickFalse;
    if (source_image->progress_monitor != (MagickProgressMonitor) 
# 1283 "MagickWand/wand-view.c" 3 4
                                                                 ((void *)0)
# 1283 "MagickWand/wand-view.c"
                                                                     )
      {
        MagickBooleanType
          proceed;
