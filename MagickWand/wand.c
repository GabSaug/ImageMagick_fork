...
# 49 "MagickWand/wand.c" 2

static SplayTreeInfo
  *wand_ids = (SplayTreeInfo *) 
# 51 "MagickWand/wand.c" 3 4
                               ((void *)0)
# 51 "MagickWand/wand.c"
                                   ;
...
static SemaphoreInfo
  *wand_semaphore = (SemaphoreInfo *) 
# 57 "MagickWand/wand.c" 3 4
                                     ((void *)0)
# 57 "MagickWand/wand.c"
                                         ;
# 77 "MagickWand/wand.c"
__attribute__ ((visibility ("default"))) size_t AcquireWandId(void)
{
  MagickAddressType
    wand_id;
  ...
  if (wand_semaphore == (SemaphoreInfo *) 
# 85 "MagickWand/wand.c" 3 4
                                         ((void *)0)
# 85 "MagickWand/wand.c"
                                             )
    ActivateSemaphoreInfo(&wand_semaphore);
  LockSemaphoreInfo(wand_semaphore);
  if (wand_ids == (SplayTreeInfo *) 
# 88 "MagickWand/wand.c" 3 4
                                   ((void *)0)
# 88 "MagickWand/wand.c"
                                       )
    wand_ids=NewSplayTree((int (*)(const void *,const void *)) 
# 89 "MagickWand/wand.c" 3 4
                                                              ((void *)0)
# 89 "MagickWand/wand.c"
                                                                  ,
      (void *(*)(void *)) 
# 90 "MagickWand/wand.c" 3 4
                         ((void *)0)
# 90 "MagickWand/wand.c"
                             ,(void *(*)(void *)) 
# 90 "MagickWand/wand.c" 3 4
                                                  ((void *)0)
# 90 "MagickWand/wand.c"
...
# 119 "MagickWand/wand.c"
__attribute__ ((visibility ("default"))) void DestroyWandIds(void)
{
  if (wand_semaphore == (SemaphoreInfo *) 
# 121 "MagickWand/wand.c" 3 4
                                         ((void *)0)
# 121 "MagickWand/wand.c"
                                             )
    ActivateSemaphoreInfo(&wand_semaphore);
  LockSemaphoreInfo(wand_semaphore);
  if (wand_ids != (SplayTreeInfo *) 
# 124 "MagickWand/wand.c" 3 4
                                   ((void *)0)
# 124 "MagickWand/wand.c"
                                       )
...
# 153 "MagickWand/wand.c"
__attribute__ ((visibility ("default"))) void RelinquishWandId(const size_t id)
{
  MagickAddressType
  ...
  LockSemaphoreInfo(wand_semaphore);
  if (wand_ids != (SplayTreeInfo *) 
# 159 "MagickWand/wand.c" 3 4
                                   ((void *)0)
# 159 "MagickWand/wand.c"
                                       )
