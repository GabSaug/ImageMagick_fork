# 0 "MagickWand/drawing-wand.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/drawing-wand.c"
# 49 "MagickWand/drawing-wand.c"
# 1 "./MagickWand/studio.h" 1
# 35 "./MagickWand/studio.h"
...
# 36 "./MagickWand/studio.h" 2
# 59 "./MagickWand/studio.h"
...
# 67 "./MagickWand/studio.h" 2
# 83 "./MagickWand/studio.h"
...
# 125 "./MagickWand/studio.h" 2
# 156 "./MagickWand/studio.h"
...
# 164 "./MagickWand/studio.h" 2
# 182 "./MagickWand/studio.h"
...
# 208 "./MagickWand/studio.h" 2
# 50 "MagickWand/drawing-wand.c" 2

# 1 "./MagickWand/magick-wand-private.h" 1
...
static inline void CheckMagickCoreCompatibility(void)
{
  ...
  if (depth != 16)
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"./MagickWand/magick-wand-private.h",__func__,(unsigned long) 59,WandError,"QuantumDepthMismatch", "`%s'",quantum); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (WandError-FatalErrorException)+1); };
}
...
# 52 "MagickWand/drawing-wand.c" 2
# 1 "./MagickWand/wand.h" 1
# 25 "./MagickWand/wand.h"
extern __attribute__ ((visibility ("default"))) size_t
  AcquireWandId(void);
...
# 53 "MagickWand/drawing-wand.c" 2
# 1 "./MagickCore/image-private.h" 1
# 29 "./MagickCore/image-private.h"
...
# 54 "MagickWand/drawing-wand.c" 2
...
# 55 "MagickWand/drawing-wand.c" 2
# 69 "MagickWand/drawing-wand.c"
typedef enum
{
...
static int
  MVGPrintf(DrawingWand *,const char *,...) __attribute__((format
    (printf,2,3))),
  MVGAutoWrapPrintf(DrawingWand *,const char *,...) __attribute__((format
    (printf,2,3)));
...
# 176 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 176 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 176 "MagickWand/drawing-wand.c" 3 4
...
# 176 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 176 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 176, __extension__ __PRETTY_FUNCTION__); }))
# 176 "MagickWand/drawing-wand.c"
                                     ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 178,"%s",format);
  
# 179 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 179 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 179 "MagickWand/drawing-wand.c" 3 4
...
# 179 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 179, __extension__ __PRETTY_FUNCTION__); }))
# 179 "MagickWand/drawing-wand.c"
                                               ;
  extent=20UL*4096;
  if (wand->mvg == (char *) 
# 181 "MagickWand/drawing-wand.c" 3 4
                           ((void *)0)
# 181 "MagickWand/drawing-wand.c"
                               )
    {
      wand->mvg=(char *) AcquireQuantumMemory(extent,sizeof(*wand->mvg));
      if (wand->mvg == (char *) 
# 184 "MagickWand/drawing-wand.c" 3 4
                               ((void *)0)
# 184 "MagickWand/drawing-wand.c"
                                   )
        {
          (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 186,ResourceLimitError,"MemoryAllocationFailed","`%s'",wand->name);
                       ;
          return(-1);
        }
  ...
  if (wand->mvg_alloc < (wand->mvg_length+10*4096))
    {
      extent+=wand->mvg_alloc;
      wand->mvg=(char *) ResizeQuantumMemory(wand->mvg,extent,
        sizeof(*wand->mvg));
      if (wand->mvg == (char *) 
# 198 "MagickWand/drawing-wand.c" 3 4
                               ((void *)0)
# 198 "MagickWand/drawing-wand.c"
                                   )
        {
          (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 200,ResourceLimitError,"MemoryAllocationFailed","`%s'",wand->name);
                       ;
          return(-1);
        }
      wand->mvg_alloc=extent;
...
# 227 "MagickWand/drawing-wand.c" 3 4
       __builtin_va_start(
# 227 "MagickWand/drawing-wand.c"
       argp
# 227 "MagickWand/drawing-wand.c" 3 4
       ,
# 227 "MagickWand/drawing-wand.c"
...
# 233 "MagickWand/drawing-wand.c" 3 4
       __builtin_va_end(
# 233 "MagickWand/drawing-wand.c"
       argp
# 233 "MagickWand/drawing-wand.c" 3 4
       )
# 233 "MagickWand/drawing-wand.c"
    ...
    if ((count < 0) || (count > (int) offset))
      (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 236,DrawError,"UnableToPrint","`%s'",format);
    else
      {
...
# 245 "MagickWand/drawing-wand.c" 3 4
   ((void) sizeof ((
# 245 "MagickWand/drawing-wand.c"
   (wand->mvg_length+1) < wand->mvg_alloc
# 245 "MagickWand/drawing-wand.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 245 "MagickWand/drawing-wand.c"
   (wand->mvg_length+1) < wand->mvg_alloc
...
# 245 "MagickWand/drawing-wand.c"
   "(wand->mvg_length+1) < wand->mvg_alloc"
# 245 "MagickWand/drawing-wand.c" 3 4
   , "MagickWand/drawing-wand.c", 245, __extension__ __PRETTY_FUNCTION__); }))
# 245 "MagickWand/drawing-wand.c"
                                                 ;
    return(count);
  }
...
# 261 "MagickWand/drawing-wand.c" 3 4
 __builtin_va_start(
# 261 "MagickWand/drawing-wand.c"
 argp
# 261 "MagickWand/drawing-wand.c" 3 4
 ,
# 261 "MagickWand/drawing-wand.c"
...
# 267 "MagickWand/drawing-wand.c" 3 4
 __builtin_va_end(
# 267 "MagickWand/drawing-wand.c"
 argp
# 267 "MagickWand/drawing-wand.c" 3 4
 )
# 267 "MagickWand/drawing-wand.c"
  ...
  if (count < 0)
    (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 270,DrawError,"UnableToPrint","`%s'",format);
  else
    {
...
static void MVGAppendColor(DrawingWand *wand,const PixelInfo *packet)
{
  if ((packet->red == 0) && (packet->green == 0) && (packet->blue == 0) &&
  ...
  else
    {
      ...
      pixel.alpha_trait=packet->alpha != (double) ((Quantum) ((Quantum) 65535.0)) ?
...
# 326 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 326 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 326 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 326 "MagickWand/drawing-wand.c"
...
# 326 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 326 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 326, __extension__ __PRETTY_FUNCTION__); }))
# 326 "MagickWand/drawing-wand.c"
                                     ;
  
# 327 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 327 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 327 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 327 "MagickWand/drawing-wand.c"
...
# 327 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 327 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 327, __extension__ __PRETTY_FUNCTION__); }))
# 327 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 329,"%s",wand->name);
  if ((affine->sx != 1.0) || (affine->rx != 0.0) || (affine->ry != 0.0) ||
      (affine->sy != 1.0) || (affine->tx != 0.0) || (affine->ty != 0.0))
    {
      ...
      current=(wand->graphic_context[wand->index])->affine;
      (wand->graphic_context[wand->index])->affine.sx=affine->sx*current.sx+affine->ry*current.rx;
      (wand->graphic_context[wand->index])->affine.rx=affine->rx*current.sx+affine->sy*current.rx;
      (wand->graphic_context[wand->index])->affine.ry=affine->sx*current.ry+affine->ry*current.sy;
      (wand->graphic_context[wand->index])->affine.sy=affine->rx*current.ry+affine->sy*current.sy;
      (wand->graphic_context[wand->index])->affine.tx=affine->sx*current.tx+affine->ry*current.ty+
        affine->tx;
      (wand->graphic_context[wand->index])->affine.ty=affine->rx*current.tx+affine->sy*current.ty+
        affine->ty;
    }
}
# 373 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) DrawingWand *AcquireDrawingWand(const DrawInfo *draw_info,
  Image *image)
{
  DrawingWand
    *wand;
  ...
  wand=NewDrawingWand();
  if (draw_info != (const DrawInfo *) 
# 380 "MagickWand/drawing-wand.c" 3 4
                                     ((void *)0)
# 380 "MagickWand/drawing-wand.c"
                                         )
    {
      (wand->graphic_context[wand->index])=DestroyDrawInfo((wand->graphic_context[wand->index]));
      (wand->graphic_context[wand->index])=CloneDrawInfo((ImageInfo *) 
# 383 "MagickWand/drawing-wand.c" 3 4
                                                ((void *)0)
# 383 "MagickWand/drawing-wand.c"
                                                    ,draw_info);
    }
  wand->image=DestroyImage(wand->image);
  if (image != (Image *) 
# 386 "MagickWand/drawing-wand.c" 3 4
                        ((void *)0)
# 386 "MagickWand/drawing-wand.c"
                            )
    wand->destroy=MagickFalse;
  wand->image=image;
  return(wand);
}
# 414 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void ClearDrawingWand(DrawingWand *wand)
{
  
# 416 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 416 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 416 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 416 "MagickWand/drawing-wand.c"
...
# 416 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 416 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 416, __extension__ __PRETTY_FUNCTION__); }))
# 416 "MagickWand/drawing-wand.c"
                                     ;
  
# 417 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 417 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 417 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 417 "MagickWand/drawing-wand.c"
...
# 417 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 417 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 417, __extension__ __PRETTY_FUNCTION__); }))
# 417 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 419,"%s",wand->name);
  for ( ; wand->index > 0; wand->index--)
    (wand->graphic_context[wand->index])=DestroyDrawInfo((wand->graphic_context[wand->index]));
  (wand->graphic_context[wand->index])=DestroyDrawInfo((wand->graphic_context[wand->index]));
  wand->graphic_context=(DrawInfo **) RelinquishMagickMemory(
    wand->graphic_context);
  if (wand->pattern_id != (char *) 
# 425 "MagickWand/drawing-wand.c" 3 4
                                  ((void *)0)
# 425 "MagickWand/drawing-wand.c"
                                      )
    wand->pattern_id=DestroyString(wand->pattern_id);
  wand->mvg=DestroyString(wand->mvg);
  if ((wand->destroy != MagickFalse) && (wand->image != (Image *) 
# 428 "MagickWand/drawing-wand.c" 3 4
                                                                 ((void *)0)
# 428 "MagickWand/drawing-wand.c"
                                                                     ))
    wand->image=DestroyImage(wand->image);
  else
    wand->image=(Image *) 
# 431 "MagickWand/drawing-wand.c" 3 4
                         ((void *)0)
# 431 "MagickWand/drawing-wand.c"
                             ;
  wand->mvg=(char *) 
# 432 "MagickWand/drawing-wand.c" 3 4
                    ((void *)0)
# 432 "MagickWand/drawing-wand.c"
                        ;
  wand->mvg_alloc=0;
  wand->mvg_length=0;
  wand->mvg_width=0;
  wand->pattern_id=(char *) 
# 436 "MagickWand/drawing-wand.c" 3 4
                           ((void *)0)
# 436 "MagickWand/drawing-wand.c"
                               ;
  ...
  if (wand->graphic_context == (DrawInfo **) 
# 445 "MagickWand/drawing-wand.c" 3 4
                                            ((void *)0)
# 445 "MagickWand/drawing-wand.c"
                                                )
    {
      (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 447,ResourceLimitError,"MemoryAllocationFailed","`%s'",wand->name);
                   ;
      return;
    }
  (wand->graphic_context[wand->index])=CloneDrawInfo((ImageInfo *) 
# 451 "MagickWand/drawing-wand.c" 3 4
                                            ((void *)0)
# 451 "MagickWand/drawing-wand.c"
                                                ,(DrawInfo *) 
# 451 "MagickWand/drawing-wand.c" 3 4
                                                              ((void *)0)
# 451 "MagickWand/drawing-wand.c"
  ...
  wand->image=AcquireImage((const ImageInfo *) 
# 456 "MagickWand/drawing-wand.c" 3 4
                                              ((void *)0)
# 456 "MagickWand/drawing-wand.c"
                                                  ,wand->exception);
  ClearMagickException(wand->exception);
  wand->destroy=MagickTrue;
  wand->debug=IsEventLogging();
}
# 484 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) DrawingWand *CloneDrawingWand(const DrawingWand *wand)
{
  DrawingWand
    *clone_wand;
...
# 492 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 492 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 492 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 492 "MagickWand/drawing-wand.c"
...
# 492 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 492 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 492, __extension__ __PRETTY_FUNCTION__); }))
# 492 "MagickWand/drawing-wand.c"
                                     ;
  
# 493 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 493 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 493 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 493 "MagickWand/drawing-wand.c"
...
# 493 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 493 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 493, __extension__ __PRETTY_FUNCTION__); }))
# 493 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 495,"%s",wand->name);
  clone_wand=(DrawingWand *) AcquireMagickMemory(sizeof(*clone_wand));
  if (clone_wand == (DrawingWand *) 
# 497 "MagickWand/drawing-wand.c" 3 4
                                   ((void *)0)
# 497 "MagickWand/drawing-wand.c"
                                       )
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 498,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",GetExceptionMessage(
# 498 "MagickWand/drawing-wand.c" 3 4
   (*__errno_location ())
# 498 "MagickWand/drawing-wand.c"
   )); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                                                          ;
  (void) memset(clone_wand,0,sizeof(*clone_wand));
  clone_wand->id=AcquireWandId();
  (void) FormatLocaleString(clone_wand->name,4096,
  ...
  if (clone_wand->graphic_context == (DrawInfo **) 
# 516 "MagickWand/drawing-wand.c" 3 4
                                                  ((void *)0)
# 516 "MagickWand/drawing-wand.c"
                                                      )
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 517,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",GetExceptionMessage(
# 517 "MagickWand/drawing-wand.c" 3 4
   (*__errno_location ())
# 517 "MagickWand/drawing-wand.c"
   )); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                                 ;
  for (i=0; i <= (ssize_t) wand->index; i++)
    clone_wand->graphic_context[i]=CloneDrawInfo((ImageInfo *) 
# 520 "MagickWand/drawing-wand.c" 3 4
                                                              ((void *)0)
# 520 "MagickWand/drawing-wand.c"
                                                                  ,
  ...
  if (wand->image != (Image *) 
# 527 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 527 "MagickWand/drawing-wand.c"
                                  )
  ...
  if (clone_wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 533,"%s",clone_wand->name);
  clone_wand->signature=0xabacadabUL;
  return(clone_wand);
}
# 562 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) DrawingWand *DestroyDrawingWand(DrawingWand *wand)
{
  
# 564 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 564 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 564 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 564 "MagickWand/drawing-wand.c"
...
# 564 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 564 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 564, __extension__ __PRETTY_FUNCTION__); }))
# 564 "MagickWand/drawing-wand.c"
                                     ;
  
# 565 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 565 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 565 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 565 "MagickWand/drawing-wand.c"
...
# 565 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 565 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 565, __extension__ __PRETTY_FUNCTION__); }))
# 565 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 567,"%s",wand->name);
  for ( ; wand->index > 0; wand->index--)
    (wand->graphic_context[wand->index])=DestroyDrawInfo((wand->graphic_context[wand->index]));
  (wand->graphic_context[wand->index])=DestroyDrawInfo((wand->graphic_context[wand->index]));
  wand->graphic_context=(DrawInfo **) RelinquishMagickMemory(
    wand->graphic_context);
  if (wand->pattern_id != (char *) 
# 573 "MagickWand/drawing-wand.c" 3 4
                                  ((void *)0)
# 573 "MagickWand/drawing-wand.c"
                                      )
    wand->pattern_id=DestroyString(wand->pattern_id);
  wand->mvg=DestroyString(wand->mvg);
  if ((wand->destroy != MagickFalse) && (wand->image != (Image *) 
# 576 "MagickWand/drawing-wand.c" 3 4
                                                                 ((void *)0)
# 576 "MagickWand/drawing-wand.c"
                                                                     ))
    wand->image=DestroyImage(wand->image);
  wand->image=(Image *) 
# 578 "MagickWand/drawing-wand.c" 3 4
                       ((void *)0)
# 578 "MagickWand/drawing-wand.c"
                           ;
...
# 612 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawAffine(DrawingWand *wand,const AffineMatrix *affine)
{
  
# 614 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 614 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 614 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 614 "MagickWand/drawing-wand.c"
...
# 614 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 614 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 614, __extension__ __PRETTY_FUNCTION__); }))
# 614 "MagickWand/drawing-wand.c"
                                     ;
  
# 615 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 615 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 615 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 615 "MagickWand/drawing-wand.c"
...
# 615 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 615 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 615, __extension__ __PRETTY_FUNCTION__); }))
# 615 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 617,"%s",wand->name);
  
# 618 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 618 "MagickWand/drawing-wand.c"
 affine != (const AffineMatrix *) 
# 618 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 618 "MagickWand/drawing-wand.c"
 affine != (const AffineMatrix *) 
# 618 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 618 "MagickWand/drawing-wand.c"
 "affine != (const AffineMatrix *) NULL"
# 618 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 618, __extension__ __PRETTY_FUNCTION__); }))
# 618 "MagickWand/drawing-wand.c"
                                              ;
...
# 661 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawAlpha(DrawingWand *wand,const double x,const double y,
  const PaintMethod paint_method)
{
  
# 664 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 664 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 664 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 664 "MagickWand/drawing-wand.c"
...
# 664 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 664 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 664, __extension__ __PRETTY_FUNCTION__); }))
# 664 "MagickWand/drawing-wand.c"
                                     ;
  
# 665 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 665 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 665 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 665 "MagickWand/drawing-wand.c"
...
# 665 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 665 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 665, __extension__ __PRETTY_FUNCTION__); }))
# 665 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 667,"%s",wand->name);
  (void) MVGPrintf(wand,"alpha %.20g %.20g '%s'\n",x,y,CommandOptionToMnemonic(
    MagickMethodOptions,(ssize_t) paint_method));
}
# 701 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawAnnotation(DrawingWand *wand,const double x,const double y,
...
# 707 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 707 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 707 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 707 "MagickWand/drawing-wand.c"
...
# 707 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 707 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 707, __extension__ __PRETTY_FUNCTION__); }))
# 707 "MagickWand/drawing-wand.c"
                                     ;
  
# 708 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 708 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 708 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 708 "MagickWand/drawing-wand.c"
...
# 708 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 708 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 708, __extension__ __PRETTY_FUNCTION__); }))
# 708 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 710,"%s",wand->name);
  
# 711 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 711 "MagickWand/drawing-wand.c"
...
# 711 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 711 "MagickWand/drawing-wand.c"
 "text != (const unsigned char *) NULL"
# 711 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 711, __extension__ __PRETTY_FUNCTION__); }))
# 711 "MagickWand/drawing-wand.c"
                                             ;
  escaped_text=EscapeString((const char *) text,'\'');
  if (escaped_text != (char *) 
# 713 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 713 "MagickWand/drawing-wand.c"
                                  )
    {
...
# 756 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawArc(DrawingWand *wand,const double sx,const double sy,
  const double ex,const double ey,const double sd,const double ed)
{
  
# 759 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 759 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 759 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 759 "MagickWand/drawing-wand.c"
...
# 759 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 759 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 759, __extension__ __PRETTY_FUNCTION__); }))
# 759 "MagickWand/drawing-wand.c"
                                     ;
  
# 760 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 760 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 760 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 760 "MagickWand/drawing-wand.c"
...
# 760 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 760 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 760, __extension__ __PRETTY_FUNCTION__); }))
# 760 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 762,"%s",wand->name);
  (void) MVGPrintf(wand,"arc %.20g %.20g %.20g %.20g %.20g %.20g\n",sx,sy,ex,
    ey,sd,ed);
}
# 794 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawBezier(DrawingWand *wand,
  const size_t number_coordinates,const PointInfo *coordinates)
{
  
# 797 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 797 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 797 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 797 "MagickWand/drawing-wand.c"
...
# 797 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 797 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 797, __extension__ __PRETTY_FUNCTION__); }))
# 797 "MagickWand/drawing-wand.c"
                                     ;
  
# 798 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 798 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 798 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 798 "MagickWand/drawing-wand.c"
...
# 798 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 798 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 798, __extension__ __PRETTY_FUNCTION__); }))
# 798 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 800,"%s",wand->name);
  
# 801 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 801 "MagickWand/drawing-wand.c"
...
# 801 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 801 "MagickWand/drawing-wand.c"
 "coordinates != (const PointInfo *) NULL"
# 801 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 801, __extension__ __PRETTY_FUNCTION__); }))
# 801 "MagickWand/drawing-wand.c"
                                                ;
  MVGAppendPointsCommand(wand,"bezier",number_coordinates,coordinates);
}
# 836 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawCircle(DrawingWand *wand,const double ox,const double oy,
  const double px,const double py)
{
  
# 839 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 839 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 839 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 839 "MagickWand/drawing-wand.c"
...
# 839 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 839 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 839, __extension__ __PRETTY_FUNCTION__); }))
# 839 "MagickWand/drawing-wand.c"
                                     ;
  
# 840 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 840 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 840 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 840 "MagickWand/drawing-wand.c"
...
# 840 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 840 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 840, __extension__ __PRETTY_FUNCTION__); }))
# 840 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 842,"%s",wand->name);
  (void) MVGPrintf(wand,"circle %.20g %.20g %.20g %.20g\n",ox,oy,px,py);
}
# 868 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawClearException(DrawingWand *wand)
{
  
# 870 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 870 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 870 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 870 "MagickWand/drawing-wand.c"
...
# 870 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 870 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 870, __extension__ __PRETTY_FUNCTION__); }))
# 870 "MagickWand/drawing-wand.c"
                                     ;
  
# 871 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 871 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 871 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 871 "MagickWand/drawing-wand.c"
...
# 871 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 871 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 871, __extension__ __PRETTY_FUNCTION__); }))
# 871 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 873,"%s",wand->name);
  ClearMagickException(wand->exception);
  return(MagickTrue);
}
# 900 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) ExceptionInfo *DrawCloneExceptionInfo(const DrawingWand *wand)
{
  
# 902 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 902 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 902 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 902 "MagickWand/drawing-wand.c"
...
# 902 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 902 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 902, __extension__ __PRETTY_FUNCTION__); }))
# 902 "MagickWand/drawing-wand.c"
                                     ;
  
# 903 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 903 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 903 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 903 "MagickWand/drawing-wand.c"
...
# 903 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 903 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 903, __extension__ __PRETTY_FUNCTION__); }))
# 903 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->exception == (ExceptionInfo*) 
# 904 "MagickWand/drawing-wand.c" 3 4
                                         ((void *)0)
# 904 "MagickWand/drawing-wand.c"
                                             )
    return (ExceptionInfo*) 
# 905 "MagickWand/drawing-wand.c" 3 4
                           ((void *)0)
# 905 "MagickWand/drawing-wand.c"
                               ;
  return CloneExceptionInfo(wand->exception);
}
# 945 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawColor(DrawingWand *wand, const double x, const double y,
  const PaintMethod paint_method)
{
  
# 948 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 948 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *)
# 948 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 948 "MagickWand/drawing-wand.c"
...
# 948 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *)NULL"
# 948 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 948, __extension__ __PRETTY_FUNCTION__); }))
# 948 "MagickWand/drawing-wand.c"
                                    ;
  
# 949 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 949 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 949 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 949 "MagickWand/drawing-wand.c"
...
# 949 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 949 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 949, __extension__ __PRETTY_FUNCTION__); }))
# 949 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent, "MagickWand/drawing-wand.c",__func__,(unsigned long) 951, "%s", wand->name);
  (void) MVGPrintf(wand, "color %.20g %.20g '%s'\n",x,y,CommandOptionToMnemonic(
    MagickMethodOptions,(ssize_t) paint_method));
}
# 997 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawComposite(DrawingWand *wand,
...
# 1028 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1028 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 1028 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1028 "MagickWand/drawing-wand.c"
...
# 1028 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 1028 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1028, __extension__ __PRETTY_FUNCTION__); }))
# 1028 "MagickWand/drawing-wand.c"
                                     ;
  
# 1029 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1029 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1029 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1029 "MagickWand/drawing-wand.c"
...
# 1029 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1029 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1029, __extension__ __PRETTY_FUNCTION__); }))
# 1029 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1031,"%s",wand->name);
  
# 1032 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1032 "MagickWand/drawing-wand.c"
...
# 1032 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1032 "MagickWand/drawing-wand.c"
 "magick_wand != (MagickWand *) NULL"
# 1032 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1032, __extension__ __PRETTY_FUNCTION__); }))
# 1032 "MagickWand/drawing-wand.c"
                                           ;
  image=GetImageFromMagickWand(magick_wand);
  if (image == (Image *) 
# 1034 "MagickWand/drawing-wand.c" 3 4
                        ((void *)0)
# 1034 "MagickWand/drawing-wand.c"
                            )
    return(MagickFalse);
  clone_image=CloneImage(image,0,0,MagickTrue,wand->exception);
  if (clone_image == (Image *) 
# 1037 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 1037 "MagickWand/drawing-wand.c"
                                  )
    return(MagickFalse);
  image_info=AcquireImageInfo();
  (void) CopyMagickString(image_info->magick,"MIFF",4096);
  blob_length=2048;
  ...
  if (blob == (void *) 
# 1046 "MagickWand/drawing-wand.c" 3 4
                      ((void *)0)
# 1046 "MagickWand/drawing-wand.c"
                          )
    return(MagickFalse);
  encoded_length=0;
  ...
  if (base64 == (char *) 
# 1051 "MagickWand/drawing-wand.c" 3 4
                        ((void *)0)
# 1051 "MagickWand/drawing-wand.c"
                            )
    {
      char
        buffer[4096];

      (void) FormatLocaleString(buffer,4096,"%.20g bytes",(double)
        (4L*blob_length/3L+4L));
      (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1058,ResourceLimitWarning,"MemoryAllocationFailed","`%s'",wand->name);
                   ;
      return(MagickFalse);
    }
...
# 1104 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawComment(DrawingWand *wand,const char *comment)
{
  (void) MVGPrintf(wand,"#%s\n",comment);
}
# 1144 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawEllipse(DrawingWand *wand,const double ox,const double oy,
  const double rx,const double ry,const double start,const double end)
{
  
# 1147 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1147 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 1147 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1147 "MagickWand/drawing-wand.c"
...
# 1147 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 1147 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1147, __extension__ __PRETTY_FUNCTION__); }))
# 1147 "MagickWand/drawing-wand.c"
                                     ;
  
# 1148 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1148 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1148 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1148 "MagickWand/drawing-wand.c"
...
# 1148 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1148 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1148, __extension__ __PRETTY_FUNCTION__); }))
# 1148 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1150,"%s",wand->name);
  (void) MVGPrintf(wand,"ellipse %.20g %.20g %.20g %.20g %.20g %.20g\n",ox,oy,
    rx,ry,start,end);
}
# 1181 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawGetBorderColor(const DrawingWand *wand,
  PixelWand *border_color)
{
  
# 1184 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1184 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1184 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1184 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1184 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1184 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1184 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1184, __extension__ __PRETTY_FUNCTION__); }))
# 1184 "MagickWand/drawing-wand.c"
                                           ;
  
# 1185 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1185 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1185 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1185 "MagickWand/drawing-wand.c"
...
# 1185 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1185 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1185, __extension__ __PRETTY_FUNCTION__); }))
# 1185 "MagickWand/drawing-wand.c"
                                               ;
  
# 1186 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1186 "MagickWand/drawing-wand.c"
...
# 1186 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1186 "MagickWand/drawing-wand.c"
 "border_color != (PixelWand *) NULL"
# 1186 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1186, __extension__ __PRETTY_FUNCTION__); }))
# 1186 "MagickWand/drawing-wand.c"
                                           ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1188,"%s",wand->name);
  PixelSetPixelColor(border_color,&(wand->graphic_context[wand->index])->border_color);
}
# 1215 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) char *DrawGetClipPath(const DrawingWand *wand)
{
  
# 1217 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1217 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1217 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1217 "MagickWand/drawing-wand.c"
...
# 1217 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1217 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1217, __extension__ __PRETTY_FUNCTION__); }))
# 1217 "MagickWand/drawing-wand.c"
                                           ;
  
# 1218 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1218 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1218 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1218 "MagickWand/drawing-wand.c"
...
# 1218 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1218 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1218, __extension__ __PRETTY_FUNCTION__); }))
# 1218 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1220,"%s",wand->name);
  if ((wand->graphic_context[wand->index])->clip_mask != (char *) 
# 1221 "MagickWand/drawing-wand.c" 3 4
                                           ((void *)0)
# 1221 "MagickWand/drawing-wand.c"
                                               )
    return((char *) AcquireString((wand->graphic_context[wand->index])->clip_mask));
  return((char *) 
# 1223 "MagickWand/drawing-wand.c" 3 4
                 ((void *)0)
# 1223 "MagickWand/drawing-wand.c"
                     );
}
# 1249 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) FillRule DrawGetClipRule(const DrawingWand *wand)
{
  
# 1251 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1251 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1251 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1251 "MagickWand/drawing-wand.c"
...
# 1251 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1251 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1251, __extension__ __PRETTY_FUNCTION__); }))
# 1251 "MagickWand/drawing-wand.c"
                                           ;
  
# 1252 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1252 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1252 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1252 "MagickWand/drawing-wand.c"
...
# 1252 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1252 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1252, __extension__ __PRETTY_FUNCTION__); }))
# 1252 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1254,"%s",wand->name);
  return((wand->graphic_context[wand->index])->fill_rule);
}
# 1280 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) ClipPathUnits DrawGetClipUnits(const DrawingWand *wand)
{
  
# 1282 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1282 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1282 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1282 "MagickWand/drawing-wand.c"
...
# 1282 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1282 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1282, __extension__ __PRETTY_FUNCTION__); }))
# 1282 "MagickWand/drawing-wand.c"
                                           ;
  
# 1283 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1283 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1283 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1283 "MagickWand/drawing-wand.c"
...
# 1283 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1283 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1283, __extension__ __PRETTY_FUNCTION__); }))
# 1283 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1285,"%s",wand->name);
  return((wand->graphic_context[wand->index])->clip_units);
}
# 1312 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) char *DrawGetDensity(const DrawingWand *wand)
{
  
# 1314 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1314 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1314 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1314 "MagickWand/drawing-wand.c"
...
# 1314 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1314 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1314, __extension__ __PRETTY_FUNCTION__); }))
# 1314 "MagickWand/drawing-wand.c"
                                           ;
  
# 1315 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1315 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1315 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1315 "MagickWand/drawing-wand.c"
...
# 1315 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1315 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1315, __extension__ __PRETTY_FUNCTION__); }))
# 1315 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1317,"%s",wand->name);
  if ((wand->graphic_context[wand->index])->density != (char *) 
# 1318 "MagickWand/drawing-wand.c" 3 4
                                         ((void *)0)
# 1318 "MagickWand/drawing-wand.c"
                                             )
    return((char *) AcquireString((wand->graphic_context[wand->index])->density));
  return((char *) 
# 1320 "MagickWand/drawing-wand.c" 3 4
                 ((void *)0)
# 1320 "MagickWand/drawing-wand.c"
                     );
}
# 1349 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) char *DrawGetException(const DrawingWand *wand,
...
# 1355 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1355 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1355 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1355 "MagickWand/drawing-wand.c"
...
# 1355 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1355 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1355, __extension__ __PRETTY_FUNCTION__); }))
# 1355 "MagickWand/drawing-wand.c"
                                           ;
  
# 1356 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1356 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1356 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1356 "MagickWand/drawing-wand.c"
...
# 1356 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1356 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1356, __extension__ __PRETTY_FUNCTION__); }))
# 1356 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1358,"%s",wand->name);
  
# 1359 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1359 "MagickWand/drawing-wand.c"
...
# 1359 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1359 "MagickWand/drawing-wand.c"
 "severity != (ExceptionType *) NULL"
# 1359 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1359, __extension__ __PRETTY_FUNCTION__); }))
# 1359 "MagickWand/drawing-wand.c"
                                           ;
  *severity=wand->exception->severity;
  description=(char *) AcquireQuantumMemory(2UL*4096,
    sizeof(*description));
  if (description == (char *) 
# 1363 "MagickWand/drawing-wand.c" 3 4
                             ((void *)0)
# 1363 "MagickWand/drawing-wand.c"
                                 )
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1364,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",wand->name); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                 ;
  *description='\0';
  if (wand->exception->reason != (char *) 
# 1367 "MagickWand/drawing-wand.c" 3 4
                                         ((void *)0)
# 1367 "MagickWand/drawing-wand.c"
                                             )
    (void) CopyMagickString(description,GetLocaleExceptionMessage(
      wand->exception->severity,wand->exception->reason),
      4096);
  if (wand->exception->description != (char *) 
# 1371 "MagickWand/drawing-wand.c" 3 4
                                              ((void *)0)
# 1371 "MagickWand/drawing-wand.c"
                                                  )
    {
      (void) ConcatenateMagickString(description," (",4096);
...
# 1405 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) ExceptionType DrawGetExceptionType(const DrawingWand *wand)
{
  
# 1407 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1407 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1407 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1407 "MagickWand/drawing-wand.c"
...
# 1407 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1407 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1407, __extension__ __PRETTY_FUNCTION__); }))
# 1407 "MagickWand/drawing-wand.c"
                                           ;
  
# 1408 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1408 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1408 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1408 "MagickWand/drawing-wand.c"
...
# 1408 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1408 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1408, __extension__ __PRETTY_FUNCTION__); }))
# 1408 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1410,"%s",wand->name);
  return(wand->exception->severity);
}
# 1439 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawGetFillColor(const DrawingWand *wand,PixelWand *fill_color)
{
  
# 1441 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1441 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1441 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1441 "MagickWand/drawing-wand.c"
...
# 1441 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1441 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1441, __extension__ __PRETTY_FUNCTION__); }))
# 1441 "MagickWand/drawing-wand.c"
                                           ;
  
# 1442 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1442 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1442 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1442 "MagickWand/drawing-wand.c"
...
# 1442 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1442 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1442, __extension__ __PRETTY_FUNCTION__); }))
# 1442 "MagickWand/drawing-wand.c"
                                               ;
  
# 1443 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1443 "MagickWand/drawing-wand.c"
...
# 1443 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1443 "MagickWand/drawing-wand.c"
 "fill_color != (PixelWand *) NULL"
# 1443 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1443, __extension__ __PRETTY_FUNCTION__); }))
# 1443 "MagickWand/drawing-wand.c"
                                         ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1445,"%s",wand->name);
  PixelSetPixelColor(fill_color,&(wand->graphic_context[wand->index])->fill);
}
# 1472 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) double DrawGetFillOpacity(const DrawingWand *wand)
{
  double
    alpha;

  
# 1477 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1477 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1477 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1477 "MagickWand/drawing-wand.c"
...
# 1477 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1477 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1477, __extension__ __PRETTY_FUNCTION__); }))
# 1477 "MagickWand/drawing-wand.c"
                                           ;
  
# 1478 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1478 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1478 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1478 "MagickWand/drawing-wand.c"
...
# 1478 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1478 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1478, __extension__ __PRETTY_FUNCTION__); }))
# 1478 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1480,"%s",wand->name);
  alpha=(double) ((double) 1.0/(double) ((Quantum) 65535.0))*(wand->graphic_context[wand->index])->fill.alpha;
  return(alpha);
}
# 1507 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) FillRule DrawGetFillRule(const DrawingWand *wand)
{
  
# 1509 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1509 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1509 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1509 "MagickWand/drawing-wand.c"
...
# 1509 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1509 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1509, __extension__ __PRETTY_FUNCTION__); }))
# 1509 "MagickWand/drawing-wand.c"
                                           ;
  
# 1510 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1510 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1510 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1510 "MagickWand/drawing-wand.c"
...
# 1510 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1510 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1510, __extension__ __PRETTY_FUNCTION__); }))
# 1510 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1512,"%s",wand->name);
  return((wand->graphic_context[wand->index])->fill_rule);
}
# 1540 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) char *DrawGetFont(const DrawingWand *wand)
{
  
# 1542 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1542 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1542 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1542 "MagickWand/drawing-wand.c"
...
# 1542 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1542 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1542, __extension__ __PRETTY_FUNCTION__); }))
# 1542 "MagickWand/drawing-wand.c"
                                           ;
  
# 1543 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1543 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1543 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1543 "MagickWand/drawing-wand.c"
...
# 1543 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1543 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1543, __extension__ __PRETTY_FUNCTION__); }))
# 1543 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1545,"%s",wand->name);
  if ((wand->graphic_context[wand->index])->font != (char *) 
# 1546 "MagickWand/drawing-wand.c" 3 4
                                      ((void *)0)
# 1546 "MagickWand/drawing-wand.c"
                                          )
    return(AcquireString((wand->graphic_context[wand->index])->font));
  return((char *) 
# 1548 "MagickWand/drawing-wand.c" 3 4
                 ((void *)0)
# 1548 "MagickWand/drawing-wand.c"
                     );
}
# 1574 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) char *DrawGetFontFamily(const DrawingWand *wand)
{
  
# 1576 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1576 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1576 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1576 "MagickWand/drawing-wand.c"
...
# 1576 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1576 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1576, __extension__ __PRETTY_FUNCTION__); }))
# 1576 "MagickWand/drawing-wand.c"
                                           ;
  
# 1577 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1577 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1577 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1577 "MagickWand/drawing-wand.c"
...
# 1577 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1577 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1577, __extension__ __PRETTY_FUNCTION__); }))
# 1577 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1579,"%s",wand->name);
  if ((wand->graphic_context[wand->index])->family != 
# 1580 "MagickWand/drawing-wand.c" 3 4
                               ((void *)0)
# 1580 "MagickWand/drawing-wand.c"
                                   )
    return(AcquireString((wand->graphic_context[wand->index])->family));
  return((char *) 
# 1582 "MagickWand/drawing-wand.c" 3 4
                 ((void *)0)
# 1582 "MagickWand/drawing-wand.c"
                     );
}
# 1612 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawGetFontResolution(const DrawingWand *wand,
  double *x,double *y)
{
  
# 1615 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1615 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 1615 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1615 "MagickWand/drawing-wand.c"
...
# 1615 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 1615 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1615, __extension__ __PRETTY_FUNCTION__); }))
# 1615 "MagickWand/drawing-wand.c"
                                     ;
  
# 1616 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1616 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1616 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1616 "MagickWand/drawing-wand.c"
...
# 1616 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1616 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1616, __extension__ __PRETTY_FUNCTION__); }))
# 1616 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1618,"%s",wand->name);
  *x=72.0;
  *y=72.0;
  if ((wand->graphic_context[wand->index])->density != (char *) 
# 1621 "MagickWand/drawing-wand.c" 3 4
                                         ((void *)0)
# 1621 "MagickWand/drawing-wand.c"
                                             )
    {
      GeometryInfo
        geometry_info;
      ...
      flags=ParseGeometry((wand->graphic_context[wand->index])->density,&geometry_info);
      *x=geometry_info.rho;
...
# 1660 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) double DrawGetFontSize(const DrawingWand *wand)
{
  
# 1662 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1662 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1662 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1662 "MagickWand/drawing-wand.c"
...
# 1662 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1662 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1662, __extension__ __PRETTY_FUNCTION__); }))
# 1662 "MagickWand/drawing-wand.c"
                                           ;
  
# 1663 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1663 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1663 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1663 "MagickWand/drawing-wand.c"
...
# 1663 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1663 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1663, __extension__ __PRETTY_FUNCTION__); }))
# 1663 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1665,"%s",wand->name);
  return((wand->graphic_context[wand->index])->pointsize);
}
# 1691 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) StretchType DrawGetFontStretch(const DrawingWand *wand)
{
  
# 1693 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1693 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1693 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1693 "MagickWand/drawing-wand.c"
...
# 1693 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1693 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1693, __extension__ __PRETTY_FUNCTION__); }))
# 1693 "MagickWand/drawing-wand.c"
                                           ;
  
# 1694 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1694 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1694 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1694 "MagickWand/drawing-wand.c"
...
# 1694 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1694 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1694, __extension__ __PRETTY_FUNCTION__); }))
# 1694 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1696,"%s",wand->name);
  return((wand->graphic_context[wand->index])->stretch);
}
# 1722 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) StyleType DrawGetFontStyle(const DrawingWand *wand)
{
  
# 1724 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1724 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1724 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1724 "MagickWand/drawing-wand.c"
...
# 1724 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1724 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1724, __extension__ __PRETTY_FUNCTION__); }))
# 1724 "MagickWand/drawing-wand.c"
                                           ;
  
# 1725 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1725 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1725 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1725 "MagickWand/drawing-wand.c"
...
# 1725 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1725 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1725, __extension__ __PRETTY_FUNCTION__); }))
# 1725 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1727,"%s",wand->name);
  return((wand->graphic_context[wand->index])->style);
}
# 1753 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) size_t DrawGetFontWeight(const DrawingWand *wand)
{
  
# 1755 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1755 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1755 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1755 "MagickWand/drawing-wand.c"
...
# 1755 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1755 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1755, __extension__ __PRETTY_FUNCTION__); }))
# 1755 "MagickWand/drawing-wand.c"
                                           ;
  
# 1756 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1756 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1756 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1756 "MagickWand/drawing-wand.c"
...
# 1756 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1756 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1756, __extension__ __PRETTY_FUNCTION__); }))
# 1756 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1758,"%s",wand->name);
  return((wand->graphic_context[wand->index])->weight);
}
# 1785 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) GravityType DrawGetGravity(const DrawingWand *wand)
{
  
# 1787 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1787 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1787 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1787 "MagickWand/drawing-wand.c"
...
# 1787 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1787 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1787, __extension__ __PRETTY_FUNCTION__); }))
# 1787 "MagickWand/drawing-wand.c"
                                           ;
  
# 1788 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1788 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1788 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1788 "MagickWand/drawing-wand.c"
...
# 1788 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1788 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1788, __extension__ __PRETTY_FUNCTION__); }))
# 1788 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1790,"%s",wand->name);
  return((wand->graphic_context[wand->index])->gravity);
}
# 1817 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) double DrawGetOpacity(const DrawingWand *wand)
{
  double
    alpha;

  
# 1822 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1822 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1822 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1822 "MagickWand/drawing-wand.c"
...
# 1822 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1822 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1822, __extension__ __PRETTY_FUNCTION__); }))
# 1822 "MagickWand/drawing-wand.c"
                                           ;
  
# 1823 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1823 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1823 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1823 "MagickWand/drawing-wand.c"
...
# 1823 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1823 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1823, __extension__ __PRETTY_FUNCTION__); }))
# 1823 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1825,"%s",wand->name);
  alpha=((double) 1.0/(double) ((Quantum) 65535.0))*(double) (wand->graphic_context[wand->index])->alpha;
  return(alpha);
}
# 1855 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawGetStrokeAntialias(const DrawingWand *wand)
{
  
# 1857 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1857 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1857 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1857 "MagickWand/drawing-wand.c"
...
# 1857 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1857 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1857, __extension__ __PRETTY_FUNCTION__); }))
# 1857 "MagickWand/drawing-wand.c"
                                           ;
  
# 1858 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1858 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1858 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1858 "MagickWand/drawing-wand.c"
...
# 1858 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1858 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1858, __extension__ __PRETTY_FUNCTION__); }))
# 1858 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1860,"%s",wand->name);
  return((wand->graphic_context[wand->index])->stroke_antialias);
}
# 1889 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawGetStrokeColor(const DrawingWand *wand,
  PixelWand *stroke_color)
{
  
# 1892 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1892 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1892 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1892 "MagickWand/drawing-wand.c"
...
# 1892 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1892 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1892, __extension__ __PRETTY_FUNCTION__); }))
# 1892 "MagickWand/drawing-wand.c"
                                           ;
  
# 1893 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1893 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1893 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1893 "MagickWand/drawing-wand.c"
...
# 1893 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1893 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1893, __extension__ __PRETTY_FUNCTION__); }))
# 1893 "MagickWand/drawing-wand.c"
                                               ;
  
# 1894 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1894 "MagickWand/drawing-wand.c"
...
# 1894 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1894 "MagickWand/drawing-wand.c"
 "stroke_color != (PixelWand *) NULL"
# 1894 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1894, __extension__ __PRETTY_FUNCTION__); }))
# 1894 "MagickWand/drawing-wand.c"
                                           ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1896,"%s",wand->name);
  PixelSetPixelColor(stroke_color,&(wand->graphic_context[wand->index])->stroke);
}
# 1927 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) double *DrawGetStrokeDashArray(const DrawingWand *wand,
...
# 1945 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1945 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1945 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1945 "MagickWand/drawing-wand.c"
...
# 1945 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1945 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1945, __extension__ __PRETTY_FUNCTION__); }))
# 1945 "MagickWand/drawing-wand.c"
                                           ;
  
# 1946 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1946 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1946 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1946 "MagickWand/drawing-wand.c"
...
# 1946 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1946 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1946, __extension__ __PRETTY_FUNCTION__); }))
# 1946 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 1948,"%s",wand->name);
  
# 1949 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1949 "MagickWand/drawing-wand.c"
 number_elements != (size_t *) 
# 1949 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1949 "MagickWand/drawing-wand.c"
 number_elements != (size_t *) 
# 1949 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1949 "MagickWand/drawing-wand.c"
 "number_elements != (size_t *) NULL"
# 1949 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1949, __extension__ __PRETTY_FUNCTION__); }))
# 1949 "MagickWand/drawing-wand.c"
                                           ;
  n=0;
  p=(wand->graphic_context[wand->index])->dash_pattern;
  if (p != (const double *) 
# 1952 "MagickWand/drawing-wand.c" 3 4
                           ((void *)0)
# 1952 "MagickWand/drawing-wand.c"
                               )
    while (fabs(*p++) >= 1.0e-12)
      n++;
  *number_elements=n;
  dasharray=(double *) 
# 1956 "MagickWand/drawing-wand.c" 3 4
                      ((void *)0)
# 1956 "MagickWand/drawing-wand.c"
                          ;
  if (n != 0)
    {
      dasharray=(double *) AcquireQuantumMemory((size_t) n+1UL,
        sizeof(*dasharray));
      if (dasharray != (double *) 
# 1961 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 1961 "MagickWand/drawing-wand.c"
                                     )
        {
          p=(wand->graphic_context[wand->index])->dash_pattern;
          q=dasharray;
...
# 1996 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) double DrawGetStrokeDashOffset(const DrawingWand *wand)
{
  
# 1998 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1998 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 1998 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1998 "MagickWand/drawing-wand.c"
...
# 1998 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 1998 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1998, __extension__ __PRETTY_FUNCTION__); }))
# 1998 "MagickWand/drawing-wand.c"
                                           ;
  
# 1999 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 1999 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 1999 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1999 "MagickWand/drawing-wand.c"
...
# 1999 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 1999 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 1999, __extension__ __PRETTY_FUNCTION__); }))
# 1999 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2001,"%s",wand->name);
  return((wand->graphic_context[wand->index])->dash_offset);
}
# 2029 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) LineCap DrawGetStrokeLineCap(const DrawingWand *wand)
{
  
# 2031 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2031 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2031 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2031 "MagickWand/drawing-wand.c"
...
# 2031 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2031 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2031, __extension__ __PRETTY_FUNCTION__); }))
# 2031 "MagickWand/drawing-wand.c"
                                           ;
  
# 2032 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2032 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2032 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2032 "MagickWand/drawing-wand.c"
...
# 2032 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2032 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2032, __extension__ __PRETTY_FUNCTION__); }))
# 2032 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2034,"%s",wand->name);
  return((wand->graphic_context[wand->index])->linecap);
}
# 2063 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) LineJoin DrawGetStrokeLineJoin(const DrawingWand *wand)
{
  
# 2065 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2065 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2065 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2065 "MagickWand/drawing-wand.c"
...
# 2065 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2065 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2065, __extension__ __PRETTY_FUNCTION__); }))
# 2065 "MagickWand/drawing-wand.c"
                                           ;
  
# 2066 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2066 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2066 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2066 "MagickWand/drawing-wand.c"
...
# 2066 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2066 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2066, __extension__ __PRETTY_FUNCTION__); }))
# 2066 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2068,"%s",wand->name);
  return((wand->graphic_context[wand->index])->linejoin);
}
# 2098 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) size_t DrawGetStrokeMiterLimit(const DrawingWand *wand)
{
  
# 2100 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2100 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2100 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2100 "MagickWand/drawing-wand.c"
...
# 2100 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2100 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2100, __extension__ __PRETTY_FUNCTION__); }))
# 2100 "MagickWand/drawing-wand.c"
                                           ;
  
# 2101 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2101 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2101 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2101 "MagickWand/drawing-wand.c"
...
# 2101 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2101 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2101, __extension__ __PRETTY_FUNCTION__); }))
# 2101 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2103,"%s",wand->name);
  return (wand->graphic_context[wand->index])->miterlimit;
}
# 2129 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) double DrawGetStrokeOpacity(const DrawingWand *wand)
{
  double
    alpha;

  
# 2134 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2134 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2134 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2134 "MagickWand/drawing-wand.c"
...
# 2134 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2134 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2134, __extension__ __PRETTY_FUNCTION__); }))
# 2134 "MagickWand/drawing-wand.c"
                                           ;
  
# 2135 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2135 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2135 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2135 "MagickWand/drawing-wand.c"
...
# 2135 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2135 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2135, __extension__ __PRETTY_FUNCTION__); }))
# 2135 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2137,"%s",wand->name);
  alpha=(double) ((double) 1.0/(double) ((Quantum) 65535.0))*(wand->graphic_context[wand->index])->stroke.alpha;
  return(alpha);
}
# 2165 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) double DrawGetStrokeWidth(const DrawingWand *wand)
{
  
# 2167 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2167 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2167 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2167 "MagickWand/drawing-wand.c"
...
# 2167 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2167 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2167, __extension__ __PRETTY_FUNCTION__); }))
# 2167 "MagickWand/drawing-wand.c"
                                           ;
  
# 2168 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2168 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2168 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2168 "MagickWand/drawing-wand.c"
...
# 2168 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2168 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2168, __extension__ __PRETTY_FUNCTION__); }))
# 2168 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2170,"%s",wand->name);
  return((wand->graphic_context[wand->index])->stroke_width);
}
# 2197 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) AlignType DrawGetTextAlignment(const DrawingWand *wand)
{
  
# 2199 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2199 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2199 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2199 "MagickWand/drawing-wand.c"
...
# 2199 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2199 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2199, __extension__ __PRETTY_FUNCTION__); }))
# 2199 "MagickWand/drawing-wand.c"
                                           ;
  
# 2200 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2200 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2200 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2200 "MagickWand/drawing-wand.c"
...
# 2200 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2200 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2200, __extension__ __PRETTY_FUNCTION__); }))
# 2200 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2202,"%s",wand->name);
  return((wand->graphic_context[wand->index])->align);
}
# 2229 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawGetTextAntialias(const DrawingWand *wand)
{
  
# 2231 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2231 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2231 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2231 "MagickWand/drawing-wand.c"
...
# 2231 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2231 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2231, __extension__ __PRETTY_FUNCTION__); }))
# 2231 "MagickWand/drawing-wand.c"
                                           ;
  
# 2232 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2232 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2232 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2232 "MagickWand/drawing-wand.c"
...
# 2232 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2232 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2232, __extension__ __PRETTY_FUNCTION__); }))
# 2232 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2234,"%s",wand->name);
  return((wand->graphic_context[wand->index])->text_antialias);
}
# 2261 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) DecorationType DrawGetTextDecoration(const DrawingWand *wand)
{
  
# 2263 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2263 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2263 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2263 "MagickWand/drawing-wand.c"
...
# 2263 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2263 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2263, __extension__ __PRETTY_FUNCTION__); }))
# 2263 "MagickWand/drawing-wand.c"
                                           ;
  
# 2264 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2264 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2264 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2264 "MagickWand/drawing-wand.c"
...
# 2264 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2264 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2264, __extension__ __PRETTY_FUNCTION__); }))
# 2264 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2266,"%s",wand->name);
  return((wand->graphic_context[wand->index])->decorate);
}
# 2293 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) DirectionType DrawGetTextDirection(const DrawingWand *wand)
{
  
# 2295 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2295 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2295 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2295 "MagickWand/drawing-wand.c"
...
# 2295 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2295 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2295, __extension__ __PRETTY_FUNCTION__); }))
# 2295 "MagickWand/drawing-wand.c"
                                           ;
  
# 2296 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2296 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2296 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2296 "MagickWand/drawing-wand.c"
...
# 2296 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2296 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2296, __extension__ __PRETTY_FUNCTION__); }))
# 2296 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2298,"%s",wand->name);
  return((wand->graphic_context[wand->index])->direction);
}
# 2326 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) char *DrawGetTextEncoding(const DrawingWand *wand)
{
  
# 2328 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2328 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2328 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2328 "MagickWand/drawing-wand.c"
...
# 2328 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2328 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2328, __extension__ __PRETTY_FUNCTION__); }))
# 2328 "MagickWand/drawing-wand.c"
                                           ;
  
# 2329 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2329 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2329 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2329 "MagickWand/drawing-wand.c"
...
# 2329 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2329 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2329, __extension__ __PRETTY_FUNCTION__); }))
# 2329 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2331,"%s",wand->name);
  if ((wand->graphic_context[wand->index])->encoding != (char *) 
# 2332 "MagickWand/drawing-wand.c" 3 4
                                          ((void *)0)
# 2332 "MagickWand/drawing-wand.c"
                                              )
    return((char *) AcquireString((wand->graphic_context[wand->index])->encoding));
  return((char *) 
# 2334 "MagickWand/drawing-wand.c" 3 4
                 ((void *)0)
# 2334 "MagickWand/drawing-wand.c"
                     );
}
# 2359 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) double DrawGetTextKerning(DrawingWand *wand)
{
  
# 2361 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2361 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 2361 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2361 "MagickWand/drawing-wand.c"
...
# 2361 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 2361 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2361, __extension__ __PRETTY_FUNCTION__); }))
# 2361 "MagickWand/drawing-wand.c"
                                     ;
  
# 2362 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2362 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2362 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2362 "MagickWand/drawing-wand.c"
...
# 2362 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2362 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2362, __extension__ __PRETTY_FUNCTION__); }))
# 2362 "MagickWand/drawing-wand.c"
                                               ;

  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2365,"%s",wand->name);
  return((wand->graphic_context[wand->index])->kerning);
}
# 2391 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) double DrawGetTextInterlineSpacing(DrawingWand *wand)
{
  
# 2393 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2393 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 2393 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2393 "MagickWand/drawing-wand.c"
...
# 2393 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 2393 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2393, __extension__ __PRETTY_FUNCTION__); }))
# 2393 "MagickWand/drawing-wand.c"
                                     ;
  
# 2394 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2394 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2394 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2394 "MagickWand/drawing-wand.c"
...
# 2394 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2394 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2394, __extension__ __PRETTY_FUNCTION__); }))
# 2394 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2396,"%s",wand->name);
  return((wand->graphic_context[wand->index])->interline_spacing);
}
# 2422 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) double DrawGetTextInterwordSpacing(DrawingWand *wand)
{
  
# 2424 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2424 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 2424 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2424 "MagickWand/drawing-wand.c"
...
# 2424 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 2424 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2424, __extension__ __PRETTY_FUNCTION__); }))
# 2424 "MagickWand/drawing-wand.c"
                                     ;
  
# 2425 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2425 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2425 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2425 "MagickWand/drawing-wand.c"
...
# 2425 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2425 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2425, __extension__ __PRETTY_FUNCTION__); }))
# 2425 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2427,"%s",wand->name);
  return((wand->graphic_context[wand->index])->interword_spacing);
}
# 2480 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawGetTypeMetrics(const DrawingWand *wand,
...
# 2489 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2489 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2489 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2489 "MagickWand/drawing-wand.c"
...
# 2489 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2489 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2489, __extension__ __PRETTY_FUNCTION__); }))
# 2489 "MagickWand/drawing-wand.c"
                                           ;
  
# 2490 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2490 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2490 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2490 "MagickWand/drawing-wand.c"
...
# 2490 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2490 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2490, __extension__ __PRETTY_FUNCTION__); }))
# 2490 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2492,"%s",wand->name);
  draw_info=PeekDrawingWand(wand);
  if (draw_info == (DrawInfo *) 
# 2494 "MagickWand/drawing-wand.c" 3 4
                               ((void *)0)
# 2494 "MagickWand/drawing-wand.c"
                                   )
    return(MagickFalse);
...
# 2531 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) char *DrawGetVectorGraphics(DrawingWand *wand)
{
  char
    value[4096],
    *xml;
...
# 2547 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2547 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2547 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2547 "MagickWand/drawing-wand.c"
...
# 2547 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2547 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2547, __extension__ __PRETTY_FUNCTION__); }))
# 2547 "MagickWand/drawing-wand.c"
                                           ;
  
# 2548 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2548 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2548 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2548 "MagickWand/drawing-wand.c"
...
# 2548 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2548 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2548, __extension__ __PRETTY_FUNCTION__); }))
# 2548 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2550,"%s",wand->name);
  xml_info=NewXMLTreeTag("drawing-wand");
  if (xml_info == (XMLTreeInfo *) 
# 2552 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 2552 "MagickWand/drawing-wand.c"
                                     )
    return((char *) 
# 2553 "MagickWand/drawing-wand.c" 3 4
                   ((void *)0)
# 2553 "MagickWand/drawing-wand.c"
                       );
  (void) SetXMLTreeContent(xml_info," ");
  GetPixelInfo(wand->image,&pixel);
  child=AddChildToXMLTree(xml_info,"clip-path",0);
  if (child != (XMLTreeInfo *) 
# 2557 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2557 "MagickWand/drawing-wand.c"
                                  )
    (void) SetXMLTreeContent(child,(wand->graphic_context[wand->index])->clip_mask);
  child=AddChildToXMLTree(xml_info,"clip-units",0);
  if (child != (XMLTreeInfo *) 
# 2560 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2560 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) CopyMagickString(value,CommandOptionToMnemonic(
        MagickClipPathOptions,(ssize_t) (wand->graphic_context[wand->index])->clip_units),
        4096);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"decorate",0);
  if (child != (XMLTreeInfo *) 
# 2568 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2568 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) CopyMagickString(value,CommandOptionToMnemonic(
        MagickDecorateOptions,(ssize_t) (wand->graphic_context[wand->index])->decorate),
        4096);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"encoding",0);
  if (child != (XMLTreeInfo *) 
# 2576 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2576 "MagickWand/drawing-wand.c"
                                  )
    (void) SetXMLTreeContent(child,(wand->graphic_context[wand->index])->encoding);
  child=AddChildToXMLTree(xml_info,"fill",0);
  if (child != (XMLTreeInfo *) 
# 2579 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2579 "MagickWand/drawing-wand.c"
                                  )
    {
      if ((wand->graphic_context[wand->index])->fill.alpha != (double) ((Quantum) ((Quantum) 65535.0)))
        pixel.alpha_trait=(wand->graphic_context[wand->index])->fill.alpha != (double) ((Quantum) ((Quantum) 65535.0)) ?
          BlendPixelTrait : UndefinedPixelTrait;
      pixel=(wand->graphic_context[wand->index])->fill;
      GetColorTuple(&pixel,MagickTrue,value);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"fill-opacity",0);
  if (child != (XMLTreeInfo *) 
# 2589 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2589 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) FormatLocaleString(value,4096,"%.20g",
        (double) (((double) 1.0/(double) ((Quantum) 65535.0))*(wand->graphic_context[wand->index])->fill.alpha));
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"fill-rule",0);
  if (child != (XMLTreeInfo *) 
# 2596 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2596 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) CopyMagickString(value,CommandOptionToMnemonic(
        MagickFillRuleOptions,(ssize_t) (wand->graphic_context[wand->index])->fill_rule),
        4096);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"font",0);
  if (child != (XMLTreeInfo *) 
# 2604 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2604 "MagickWand/drawing-wand.c"
                                  )
    (void) SetXMLTreeContent(child,(wand->graphic_context[wand->index])->font);
  child=AddChildToXMLTree(xml_info,"font-family",0);
  if (child != (XMLTreeInfo *) 
# 2607 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2607 "MagickWand/drawing-wand.c"
                                  )
    (void) SetXMLTreeContent(child,(wand->graphic_context[wand->index])->family);
  child=AddChildToXMLTree(xml_info,"font-size",0);
  if (child != (XMLTreeInfo *) 
# 2610 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2610 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) FormatLocaleString(value,4096,"%.20g",
        (wand->graphic_context[wand->index])->pointsize);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"font-stretch",0);
  if (child != (XMLTreeInfo *) 
# 2617 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2617 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) CopyMagickString(value,CommandOptionToMnemonic(
        MagickStretchOptions,(ssize_t) (wand->graphic_context[wand->index])->stretch),
        4096);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"font-style",0);
  if (child != (XMLTreeInfo *) 
# 2625 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2625 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) CopyMagickString(value,CommandOptionToMnemonic(
        MagickStyleOptions,(ssize_t) (wand->graphic_context[wand->index])->style),4096);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"font-weight",0);
  if (child != (XMLTreeInfo *) 
# 2632 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2632 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) FormatLocaleString(value,4096,"%.20g",(double)
        (wand->graphic_context[wand->index])->weight);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"gravity",0);
  if (child != (XMLTreeInfo *) 
# 2639 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2639 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) CopyMagickString(value,CommandOptionToMnemonic(
        MagickGravityOptions,(ssize_t) (wand->graphic_context[wand->index])->gravity),
        4096);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"stroke",0);
  if (child != (XMLTreeInfo *) 
# 2647 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2647 "MagickWand/drawing-wand.c"
                                  )
    {
      if ((wand->graphic_context[wand->index])->stroke.alpha != (double) ((Quantum) ((Quantum) 65535.0)))
        pixel.alpha_trait=(wand->graphic_context[wand->index])->stroke.alpha != (double) ((Quantum) ((Quantum) 65535.0)) ?
          BlendPixelTrait : UndefinedPixelTrait;
      pixel=(wand->graphic_context[wand->index])->stroke;
      GetColorTuple(&pixel,MagickTrue,value);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"stroke-antialias",0);
  if (child != (XMLTreeInfo *) 
# 2657 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2657 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) FormatLocaleString(value,4096,"%d",
        (wand->graphic_context[wand->index])->stroke_antialias != MagickFalse ? 1 : 0);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"stroke-dasharray",0);
  if ((child != (XMLTreeInfo *) 
# 2664 "MagickWand/drawing-wand.c" 3 4
                               ((void *)0)
# 2664 "MagickWand/drawing-wand.c"
                                   ) &&
      ((wand->graphic_context[wand->index])->dash_pattern != (double *) 
# 2665 "MagickWand/drawing-wand.c" 3 4
                                                 ((void *)0)
# 2665 "MagickWand/drawing-wand.c"
                                                     ))
    {
      char
        *dash_pattern;

      dash_pattern=AcquireString((char *) 
# 2670 "MagickWand/drawing-wand.c" 3 4
                                         ((void *)0)
# 2670 "MagickWand/drawing-wand.c"
                                             );
      for (i=0; fabs((wand->graphic_context[wand->index])->dash_pattern[i]) >= 1.0e-12; i++)
      {
        if (i != 0)
          (void) ConcatenateString(&dash_pattern,",");
        (void) FormatLocaleString(value,4096,"%.20g",
          (wand->graphic_context[wand->index])->dash_pattern[i]);
  ...
  if (child != (XMLTreeInfo *) 
# 2683 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2683 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) FormatLocaleString(value,4096,"%.20g",
        (wand->graphic_context[wand->index])->dash_offset);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"stroke-linecap",0);
  if (child != (XMLTreeInfo *) 
# 2690 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2690 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) CopyMagickString(value,CommandOptionToMnemonic(
        MagickLineCapOptions,(ssize_t) (wand->graphic_context[wand->index])->linecap),
        4096);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"stroke-linejoin",0);
  if (child != (XMLTreeInfo *) 
# 2698 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2698 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) CopyMagickString(value,CommandOptionToMnemonic(
        MagickLineJoinOptions,(ssize_t) (wand->graphic_context[wand->index])->linejoin),
        4096);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"stroke-miterlimit",0);
  if (child != (XMLTreeInfo *) 
# 2706 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2706 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) FormatLocaleString(value,4096,"%.20g",(double)
        (wand->graphic_context[wand->index])->miterlimit);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"stroke-opacity",0);
  if (child != (XMLTreeInfo *) 
# 2713 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2713 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) FormatLocaleString(value,4096,"%.20g",
        (double) (((double) 1.0/(double) ((Quantum) 65535.0))*(wand->graphic_context[wand->index])->stroke.alpha));
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"stroke-width",0);
  if (child != (XMLTreeInfo *) 
# 2720 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2720 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) FormatLocaleString(value,4096,"%.20g",
        (wand->graphic_context[wand->index])->stroke_width);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"text-align",0);
  if (child != (XMLTreeInfo *) 
# 2727 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2727 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) CopyMagickString(value,CommandOptionToMnemonic(MagickAlignOptions,
        (ssize_t) (wand->graphic_context[wand->index])->align),4096);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"text-antialias",0);
  if (child != (XMLTreeInfo *) 
# 2734 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2734 "MagickWand/drawing-wand.c"
                                  )
    {
      (void) FormatLocaleString(value,4096,"%d",
        (wand->graphic_context[wand->index])->text_antialias != MagickFalse ? 1 : 0);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"text-undercolor",0);
  if (child != (XMLTreeInfo *) 
# 2741 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2741 "MagickWand/drawing-wand.c"
                                  )
    {
      if ((wand->graphic_context[wand->index])->undercolor.alpha != (double) ((Quantum) ((Quantum) 65535.0)))
        pixel.alpha_trait=(wand->graphic_context[wand->index])->undercolor.alpha != (double) ((Quantum) ((Quantum) 65535.0)) ?
          BlendPixelTrait : UndefinedPixelTrait;
      pixel=(wand->graphic_context[wand->index])->undercolor;
      GetColorTuple(&pixel,MagickTrue,value);
      (void) SetXMLTreeContent(child,value);
    }
  child=AddChildToXMLTree(xml_info,"vector-graphics",0);
  if (child != (XMLTreeInfo *) 
# 2751 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 2751 "MagickWand/drawing-wand.c"
                                  )
...
# 2784 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawGetTextUnderColor(const DrawingWand *wand,
  PixelWand *under_color)
{
  
# 2787 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2787 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 2787 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2787 "MagickWand/drawing-wand.c"
...
# 2787 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 2787 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2787, __extension__ __PRETTY_FUNCTION__); }))
# 2787 "MagickWand/drawing-wand.c"
                                           ;
  
# 2788 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2788 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2788 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2788 "MagickWand/drawing-wand.c"
...
# 2788 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2788 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2788, __extension__ __PRETTY_FUNCTION__); }))
# 2788 "MagickWand/drawing-wand.c"
                                               ;
  
# 2789 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2789 "MagickWand/drawing-wand.c"
...
# 2789 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 2789 "MagickWand/drawing-wand.c"
 "under_color != (PixelWand *) NULL"
# 2789 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2789, __extension__ __PRETTY_FUNCTION__); }))
# 2789 "MagickWand/drawing-wand.c"
                                          ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2791,"%s",wand->name);
  PixelSetPixelColor(under_color,&(wand->graphic_context[wand->index])->undercolor);
}
# 2827 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawLine(DrawingWand *wand,const double sx,const double sy,
  const double ex,const double ey)
{
  
# 2830 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2830 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 2830 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2830 "MagickWand/drawing-wand.c"
...
# 2830 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 2830 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2830, __extension__ __PRETTY_FUNCTION__); }))
# 2830 "MagickWand/drawing-wand.c"
                                     ;
  
# 2831 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2831 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2831 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2831 "MagickWand/drawing-wand.c"
...
# 2831 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2831 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2831, __extension__ __PRETTY_FUNCTION__); }))
# 2831 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2833,"%s",wand->name);
  (void) MVGPrintf(wand,"line %.20g %.20g %.20g %.20g\n",sx,sy,ex,ey);
}
# 2862 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathClose(DrawingWand *wand)
{
  
# 2864 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2864 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 2864 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2864 "MagickWand/drawing-wand.c"
...
# 2864 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 2864 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2864, __extension__ __PRETTY_FUNCTION__); }))
# 2864 "MagickWand/drawing-wand.c"
                                     ;
  
# 2865 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2865 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2865 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2865 "MagickWand/drawing-wand.c"
...
# 2865 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2865 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2865, __extension__ __PRETTY_FUNCTION__); }))
# 2865 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2867,"%s",wand->name);
  (void) MVGAutoWrapPrintf(wand,"%s",wand->path_mode == AbsolutePathMode ?
    "Z" : "z");
}
# 2913 "MagickWand/drawing-wand.c"
static void DrawPathCurveTo(DrawingWand *wand,const PathMode mode,
  const double x1,const double y1,const double x2,const double y2,
  const double x,const double y)
{
  
# 2917 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2917 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 2917 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2917 "MagickWand/drawing-wand.c"
...
# 2917 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 2917 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2917, __extension__ __PRETTY_FUNCTION__); }))
# 2917 "MagickWand/drawing-wand.c"
                                     ;
  
# 2918 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2918 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2918 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2918 "MagickWand/drawing-wand.c"
...
# 2918 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2918 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2918, __extension__ __PRETTY_FUNCTION__); }))
# 2918 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2920,"%s",wand->name);
...
__attribute__ ((visibility ("default"))) void DrawPathCurveToAbsolute(DrawingWand *wand,const double x1,
  const double y1,const double x2,const double y2,const double x,const double y)
{
  
# 2937 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2937 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 2937 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2937 "MagickWand/drawing-wand.c"
...
# 2937 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 2937 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2937, __extension__ __PRETTY_FUNCTION__); }))
# 2937 "MagickWand/drawing-wand.c"
                                     ;
  
# 2938 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2938 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2938 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2938 "MagickWand/drawing-wand.c"
...
# 2938 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2938 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2938, __extension__ __PRETTY_FUNCTION__); }))
# 2938 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2940,"%s",wand->name);
  DrawPathCurveTo(wand,AbsolutePathMode,x1,y1,x2,y2,x,y);
}
# 2984 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathCurveToRelative(DrawingWand *wand,const double x1,
  const double y1,const double x2,const double y2,const double x,const double y)
{
  
# 2987 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2987 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 2987 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2987 "MagickWand/drawing-wand.c"
...
# 2987 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 2987 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2987, __extension__ __PRETTY_FUNCTION__); }))
# 2987 "MagickWand/drawing-wand.c"
                                     ;
  
# 2988 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 2988 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 2988 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2988 "MagickWand/drawing-wand.c"
...
# 2988 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 2988 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 2988, __extension__ __PRETTY_FUNCTION__); }))
# 2988 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 2990,"%s",wand->name);
  DrawPathCurveTo(wand,RelativePathMode,x1,y1,x2,y2,x,y);
}
# 3029 "MagickWand/drawing-wand.c"
...
# 3032 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3032 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3032 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3032 "MagickWand/drawing-wand.c"
...
# 3032 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3032 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3032, __extension__ __PRETTY_FUNCTION__); }))
# 3032 "MagickWand/drawing-wand.c"
                                     ;
  
# 3033 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3033 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3033 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3033 "MagickWand/drawing-wand.c"
...
# 3033 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3033 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3033, __extension__ __PRETTY_FUNCTION__); }))
# 3033 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3035,"%s",wand->name);
...
__attribute__ ((visibility ("default"))) void DrawPathCurveToQuadraticBezierAbsolute(DrawingWand *wand,
  const double x1,const double y1,const double x,const double y)
{
  
# 3051 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3051 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3051 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3051 "MagickWand/drawing-wand.c"
...
# 3051 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3051 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3051, __extension__ __PRETTY_FUNCTION__); }))
# 3051 "MagickWand/drawing-wand.c"
                                     ;
  
# 3052 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3052 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3052 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3052 "MagickWand/drawing-wand.c"
...
# 3052 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3052 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3052, __extension__ __PRETTY_FUNCTION__); }))
# 3052 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3054,"%s",wand->name);
  DrawPathCurveToQuadraticBezier(wand,AbsolutePathMode,x1,y1,x,y);
}
# 3092 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathCurveToQuadraticBezierRelative(DrawingWand *wand,
  const double x1,const double y1,const double x,const double y)
{
  
# 3095 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3095 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3095 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3095 "MagickWand/drawing-wand.c"
...
# 3095 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3095 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3095, __extension__ __PRETTY_FUNCTION__); }))
# 3095 "MagickWand/drawing-wand.c"
                                     ;
  
# 3096 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3096 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3096 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3096 "MagickWand/drawing-wand.c"
...
# 3096 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3096 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3096, __extension__ __PRETTY_FUNCTION__); }))
# 3096 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3098,"%s",wand->name);
  DrawPathCurveToQuadraticBezier(wand,RelativePathMode,x1,y1,x,y);
}
# 3141 "MagickWand/drawing-wand.c"
static void DrawPathCurveToQuadraticBezierSmooth(DrawingWand *wand,
  const PathMode mode,const double x,const double y)
{
  
# 3144 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3144 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3144 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3144 "MagickWand/drawing-wand.c"
...
# 3144 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3144 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3144, __extension__ __PRETTY_FUNCTION__); }))
# 3144 "MagickWand/drawing-wand.c"
                                     ;
  
# 3145 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3145 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3145 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3145 "MagickWand/drawing-wand.c"
...
# 3145 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3145 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3145, __extension__ __PRETTY_FUNCTION__); }))
# 3145 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3147,"%s",wand->name);
...
__attribute__ ((visibility ("default"))) void DrawPathCurveToQuadraticBezierSmoothAbsolute(DrawingWand *wand,
  const double x,const double y)
{
  
# 3163 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3163 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3163 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3163 "MagickWand/drawing-wand.c"
...
# 3163 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3163 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3163, __extension__ __PRETTY_FUNCTION__); }))
# 3163 "MagickWand/drawing-wand.c"
                                     ;
  
# 3164 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3164 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3164 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3164 "MagickWand/drawing-wand.c"
...
# 3164 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3164 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3164, __extension__ __PRETTY_FUNCTION__); }))
# 3164 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3166,"%s",wand->name);
  DrawPathCurveToQuadraticBezierSmooth(wand,AbsolutePathMode,x,y);
}
# 3207 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathCurveToQuadraticBezierSmoothRelative(DrawingWand *wand,
  const double x,const double y)
{
  DrawPathCurveToQuadraticBezierSmooth(wand,RelativePathMode,x,y);
}
# 3255 "MagickWand/drawing-wand.c"
...
# 3258 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3258 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3258 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3258 "MagickWand/drawing-wand.c"
...
# 3258 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3258 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3258, __extension__ __PRETTY_FUNCTION__); }))
# 3258 "MagickWand/drawing-wand.c"
                                     ;
  
# 3259 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3259 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3259 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3259 "MagickWand/drawing-wand.c"
...
# 3259 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3259 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3259, __extension__ __PRETTY_FUNCTION__); }))
# 3259 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3261,"%s",wand->name);
...
__attribute__ ((visibility ("default"))) void DrawPathCurveToSmoothAbsolute(DrawingWand *wand,const double x2,
  const double y2,const double x,const double y)
{
  
# 3277 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3277 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3277 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3277 "MagickWand/drawing-wand.c"
...
# 3277 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3277 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3277, __extension__ __PRETTY_FUNCTION__); }))
# 3277 "MagickWand/drawing-wand.c"
                                     ;
  
# 3278 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3278 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3278 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3278 "MagickWand/drawing-wand.c"
...
# 3278 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3278 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3278, __extension__ __PRETTY_FUNCTION__); }))
# 3278 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3280,"%s",wand->name);
  DrawPathCurveToSmooth(wand,AbsolutePathMode,x2,y2,x,y);
}
# 3324 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathCurveToSmoothRelative(DrawingWand *wand,const double x2,
  const double y2,const double x,const double y)
{
  
# 3327 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3327 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3327 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3327 "MagickWand/drawing-wand.c"
...
# 3327 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3327 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3327, __extension__ __PRETTY_FUNCTION__); }))
# 3327 "MagickWand/drawing-wand.c"
                                     ;
  
# 3328 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3328 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3328 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3328 "MagickWand/drawing-wand.c"
...
# 3328 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3328 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3328, __extension__ __PRETTY_FUNCTION__); }))
# 3328 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3330,"%s",wand->name);
  DrawPathCurveToSmooth(wand,RelativePathMode,x2,y2,x,y);
}
# 3383 "MagickWand/drawing-wand.c"
...
# 3388 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3388 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3388 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3388 "MagickWand/drawing-wand.c"
...
# 3388 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3388 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3388, __extension__ __PRETTY_FUNCTION__); }))
# 3388 "MagickWand/drawing-wand.c"
                                     ;
  
# 3389 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3389 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3389 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3389 "MagickWand/drawing-wand.c"
...
# 3389 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3389 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3389, __extension__ __PRETTY_FUNCTION__); }))
# 3389 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3391,"%s",wand->name);
...
__attribute__ ((visibility ("default"))) void DrawPathEllipticArcAbsolute(DrawingWand *wand,const double rx,
  const double ry,const double x_axis_rotation,
  const MagickBooleanType large_arc_flag,const MagickBooleanType sweep_flag,
  const double x,const double y)
{
  
# 3411 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3411 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3411 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3411 "MagickWand/drawing-wand.c"
...
# 3411 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3411 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3411, __extension__ __PRETTY_FUNCTION__); }))
# 3411 "MagickWand/drawing-wand.c"
                                     ;
  
# 3412 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3412 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3412 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3412 "MagickWand/drawing-wand.c"
...
# 3412 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3412 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3412, __extension__ __PRETTY_FUNCTION__); }))
# 3412 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3414,"%s",wand->name);
  DrawPathEllipticArc(wand,AbsolutePathMode,rx,ry,x_axis_rotation,
    large_arc_flag,sweep_flag,x,y);
}
# 3466 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathEllipticArcRelative(DrawingWand *wand,const double rx,
  const double ry,const double x_axis_rotation,
  const MagickBooleanType large_arc_flag,const MagickBooleanType sweep_flag,
  const double x,const double y)
{
...
# 3497 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathFinish(DrawingWand *wand)
{
  
# 3499 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3499 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3499 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3499 "MagickWand/drawing-wand.c"
...
# 3499 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3499 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3499, __extension__ __PRETTY_FUNCTION__); }))
# 3499 "MagickWand/drawing-wand.c"
                                     ;
  
# 3500 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3500 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3500 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3500 "MagickWand/drawing-wand.c"
...
# 3500 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3500 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3500, __extension__ __PRETTY_FUNCTION__); }))
# 3500 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3502,"%s",wand->name);
  (void) MVGPrintf(wand,"'\n");
  wand->path_operation=PathDefaultOperation;
  wand->path_mode=DefaultPathMode;
}
# 3537 "MagickWand/drawing-wand.c"
static void DrawPathLineTo(DrawingWand *wand,const PathMode mode,
  const double x,const double y)
{
  
# 3540 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3540 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3540 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3540 "MagickWand/drawing-wand.c"
...
# 3540 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3540 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3540, __extension__ __PRETTY_FUNCTION__); }))
# 3540 "MagickWand/drawing-wand.c"
                                     ;
  
# 3541 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3541 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3541 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3541 "MagickWand/drawing-wand.c"
...
# 3541 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3541 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3541, __extension__ __PRETTY_FUNCTION__); }))
# 3541 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3543,"%s",wand->name);
...
__attribute__ ((visibility ("default"))) void DrawPathLineToAbsolute(DrawingWand *wand,const double x,
  const double y)
{
  
# 3559 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3559 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3559 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3559 "MagickWand/drawing-wand.c"
...
# 3559 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3559 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3559, __extension__ __PRETTY_FUNCTION__); }))
# 3559 "MagickWand/drawing-wand.c"
                                     ;
  
# 3560 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3560 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3560 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3560 "MagickWand/drawing-wand.c"
...
# 3560 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3560 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3560, __extension__ __PRETTY_FUNCTION__); }))
# 3560 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3562,"%s",wand->name);
  DrawPathLineTo(wand,AbsolutePathMode,x,y);
}
# 3595 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathLineToRelative(DrawingWand *wand,const double x,
  const double y)
{
  
# 3598 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3598 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3598 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3598 "MagickWand/drawing-wand.c"
...
# 3598 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3598 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3598, __extension__ __PRETTY_FUNCTION__); }))
# 3598 "MagickWand/drawing-wand.c"
                                     ;
  
# 3599 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3599 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3599 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3599 "MagickWand/drawing-wand.c"
...
# 3599 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3599 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3599, __extension__ __PRETTY_FUNCTION__); }))
# 3599 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3601,"%s",wand->name);
  DrawPathLineTo(wand,RelativePathMode,x,y);
}
# 3632 "MagickWand/drawing-wand.c"
static void DrawPathLineToHorizontal(DrawingWand *wand,const PathMode mode,
  const double x)
{
  
# 3635 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3635 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3635 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3635 "MagickWand/drawing-wand.c"
...
# 3635 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3635 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3635, __extension__ __PRETTY_FUNCTION__); }))
# 3635 "MagickWand/drawing-wand.c"
                                     ;
  
# 3636 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3636 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3636 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3636 "MagickWand/drawing-wand.c"
...
# 3636 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3636 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3636, __extension__ __PRETTY_FUNCTION__); }))
# 3636 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3638,"%s",wand->name);
...
__attribute__ ((visibility ("default"))) void DrawPathLineToHorizontalAbsolute(DrawingWand *wand,
  const double x)
{
  
# 3654 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3654 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3654 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3654 "MagickWand/drawing-wand.c"
...
# 3654 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3654 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3654, __extension__ __PRETTY_FUNCTION__); }))
# 3654 "MagickWand/drawing-wand.c"
                                     ;
  
# 3655 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3655 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3655 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3655 "MagickWand/drawing-wand.c"
...
# 3655 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3655 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3655, __extension__ __PRETTY_FUNCTION__); }))
# 3655 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3657,"%s",wand->name);
  DrawPathLineToHorizontal(wand,AbsolutePathMode,x);
}
# 3688 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathLineToHorizontalRelative(DrawingWand *wand,
  const double x)
{
  DrawPathLineToHorizontal(wand,RelativePathMode,x);
}
# 3722 "MagickWand/drawing-wand.c"
static void DrawPathLineToVertical(DrawingWand *wand,const PathMode mode,
  const double y)
{
  
# 3725 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3725 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3725 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3725 "MagickWand/drawing-wand.c"
...
# 3725 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3725 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3725, __extension__ __PRETTY_FUNCTION__); }))
# 3725 "MagickWand/drawing-wand.c"
                                     ;
  
# 3726 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3726 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3726 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3726 "MagickWand/drawing-wand.c"
...
# 3726 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3726 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3726, __extension__ __PRETTY_FUNCTION__); }))
# 3726 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3728,"%s",wand->name);
...
__attribute__ ((visibility ("default"))) void DrawPathLineToVerticalAbsolute(DrawingWand *wand,const double y)
{
  
# 3743 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3743 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3743 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3743 "MagickWand/drawing-wand.c"
...
# 3743 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3743 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3743, __extension__ __PRETTY_FUNCTION__); }))
# 3743 "MagickWand/drawing-wand.c"
                                     ;
  
# 3744 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3744 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3744 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3744 "MagickWand/drawing-wand.c"
...
# 3744 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3744 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3744, __extension__ __PRETTY_FUNCTION__); }))
# 3744 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3746,"%s",wand->name);
  DrawPathLineToVertical(wand,AbsolutePathMode,y);
}
# 3777 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathLineToVerticalRelative(DrawingWand *wand,const double y)
{
  
# 3779 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3779 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3779 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3779 "MagickWand/drawing-wand.c"
...
# 3779 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3779 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3779, __extension__ __PRETTY_FUNCTION__); }))
# 3779 "MagickWand/drawing-wand.c"
                                     ;
  
# 3780 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3780 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3780 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3780 "MagickWand/drawing-wand.c"
...
# 3780 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3780 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3780, __extension__ __PRETTY_FUNCTION__); }))
# 3780 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3782,"%s",wand->name);
  DrawPathLineToVertical(wand,RelativePathMode,y);
}
# 3815 "MagickWand/drawing-wand.c"
static void DrawPathMoveTo(DrawingWand *wand,const PathMode mode,const double x,
  const double y)
{
  
# 3818 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3818 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3818 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3818 "MagickWand/drawing-wand.c"
...
# 3818 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3818 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3818, __extension__ __PRETTY_FUNCTION__); }))
# 3818 "MagickWand/drawing-wand.c"
                                     ;
  
# 3819 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3819 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3819 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3819 "MagickWand/drawing-wand.c"
...
# 3819 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3819 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3819, __extension__ __PRETTY_FUNCTION__); }))
# 3819 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3821,"%s",wand->name);
...
__attribute__ ((visibility ("default"))) void DrawPathMoveToAbsolute(DrawingWand *wand,const double x,
  const double y)
{
  
# 3837 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3837 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3837 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3837 "MagickWand/drawing-wand.c"
...
# 3837 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3837 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3837, __extension__ __PRETTY_FUNCTION__); }))
# 3837 "MagickWand/drawing-wand.c"
                                     ;
  
# 3838 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3838 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3838 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3838 "MagickWand/drawing-wand.c"
...
# 3838 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3838 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3838, __extension__ __PRETTY_FUNCTION__); }))
# 3838 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3840,"%s",wand->name);
  DrawPathMoveTo(wand,AbsolutePathMode,x,y);
}
# 3873 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathMoveToRelative(DrawingWand *wand,const double x,
  const double y)
{
  
# 3876 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3876 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3876 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3876 "MagickWand/drawing-wand.c"
...
# 3876 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3876 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3876, __extension__ __PRETTY_FUNCTION__); }))
# 3876 "MagickWand/drawing-wand.c"
                                     ;
  
# 3877 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3877 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3877 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3877 "MagickWand/drawing-wand.c"
...
# 3877 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3877 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3877, __extension__ __PRETTY_FUNCTION__); }))
# 3877 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3879,"%s",wand->name);
  DrawPathMoveTo(wand,RelativePathMode,x,y);
}
# 3909 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPathStart(DrawingWand *wand)
{
  
# 3911 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3911 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3911 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3911 "MagickWand/drawing-wand.c"
...
# 3911 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3911 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3911, __extension__ __PRETTY_FUNCTION__); }))
# 3911 "MagickWand/drawing-wand.c"
                                     ;
  
# 3912 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3912 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3912 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3912 "MagickWand/drawing-wand.c"
...
# 3912 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3912 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3912, __extension__ __PRETTY_FUNCTION__); }))
# 3912 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3914,"%s",wand->name);
  (void) MVGPrintf(wand,"path '");
  wand->path_operation=PathDefaultOperation;
  wand->path_mode=DefaultPathMode;
}
# 3946 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPoint(DrawingWand *wand,const double x,const double y)
{
  
# 3948 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3948 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3948 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3948 "MagickWand/drawing-wand.c"
...
# 3948 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3948 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3948, __extension__ __PRETTY_FUNCTION__); }))
# 3948 "MagickWand/drawing-wand.c"
                                     ;
  
# 3949 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3949 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3949 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3949 "MagickWand/drawing-wand.c"
...
# 3949 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3949 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3949, __extension__ __PRETTY_FUNCTION__); }))
# 3949 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3951,"%s",wand->name);
  (void) MVGPrintf(wand,"point %.20g %.20g\n",x,y);
}
# 3983 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPolygon(DrawingWand *wand,
  const size_t number_coordinates,const PointInfo *coordinates)
{
  
# 3986 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3986 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 3986 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3986 "MagickWand/drawing-wand.c"
...
# 3986 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 3986 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3986, __extension__ __PRETTY_FUNCTION__); }))
# 3986 "MagickWand/drawing-wand.c"
                                     ;
  
# 3987 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 3987 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 3987 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3987 "MagickWand/drawing-wand.c"
...
# 3987 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 3987 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 3987, __extension__ __PRETTY_FUNCTION__); }))
# 3987 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 3989,"%s",wand->name);
  MVGAppendPointsCommand(wand,"polygon",number_coordinates,coordinates);
}
# 4021 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPolyline(DrawingWand *wand,
  const size_t number_coordinates,const PointInfo *coordinates)
{
  
# 4024 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4024 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4024 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4024 "MagickWand/drawing-wand.c"
...
# 4024 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4024 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4024, __extension__ __PRETTY_FUNCTION__); }))
# 4024 "MagickWand/drawing-wand.c"
                                     ;
  
# 4025 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4025 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4025 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4025 "MagickWand/drawing-wand.c"
...
# 4025 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4025 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4025, __extension__ __PRETTY_FUNCTION__); }))
# 4025 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4027,"%s",wand->name);
  MVGAppendPointsCommand(wand,"polyline",number_coordinates,coordinates);
}
# 4053 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPopClipPath(DrawingWand *wand)
{
  
# 4055 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4055 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4055 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4055 "MagickWand/drawing-wand.c"
...
# 4055 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4055 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4055, __extension__ __PRETTY_FUNCTION__); }))
# 4055 "MagickWand/drawing-wand.c"
                                     ;
  
# 4056 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4056 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4056 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4056 "MagickWand/drawing-wand.c"
...
# 4056 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4056 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4056, __extension__ __PRETTY_FUNCTION__); }))
# 4056 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4058,"%s",wand->name);
  if (wand->indent_depth > 0)
    wand->indent_depth--;
  (void) MVGPrintf(wand,"pop clip-path\n");
}
# 4086 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPopDefs(DrawingWand *wand)
{
  
# 4088 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4088 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4088 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4088 "MagickWand/drawing-wand.c"
...
# 4088 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4088 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4088, __extension__ __PRETTY_FUNCTION__); }))
# 4088 "MagickWand/drawing-wand.c"
                                     ;
  
# 4089 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4089 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4089 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4089 "MagickWand/drawing-wand.c"
...
# 4089 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4089 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4089, __extension__ __PRETTY_FUNCTION__); }))
# 4089 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4091,"%s",wand->name);
  if (wand->indent_depth > 0)
    wand->indent_depth--;
  (void) MVGPrintf(wand,"pop defs\n");
}
# 4119 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawPopPattern(DrawingWand *wand)
{
  char
    geometry[4096],
    key[4096];
...
# 4125 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4125 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4125 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4125 "MagickWand/drawing-wand.c"
...
# 4125 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4125 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4125, __extension__ __PRETTY_FUNCTION__); }))
# 4125 "MagickWand/drawing-wand.c"
                                     ;
  
# 4126 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4126 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4126 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4126 "MagickWand/drawing-wand.c"
...
# 4126 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4126 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4126, __extension__ __PRETTY_FUNCTION__); }))
# 4126 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4128,"%s",wand->name);
  if (wand->image == (Image *) 
# 4129 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 4129 "MagickWand/drawing-wand.c"
                                  )
    (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4130,WandError,"ContainsNoImages","`%s'",wand->name);;
  if (wand->pattern_id == (const char *) 
# 4131 "MagickWand/drawing-wand.c" 3 4
                                        ((void *)0)
# 4131 "MagickWand/drawing-wand.c"
                                            )
    {
      (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4133,DrawWarning,"NotCurrentlyPushingPatternDefinition","`%s'",wand->name);
                   ;
      return(MagickFalse);
    }
  (void) FormatLocaleString(key,4096,"%s",wand->pattern_id);
  (void) SetImageArtifact(wand->image,key,wand->mvg+wand->pattern_offset);
  (void) FormatLocaleString(geometry,4096,"%.20gx%.20g%+.20g%+.20g",
...
# 4182 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPushClipPath(DrawingWand *wand,const char *clip_mask_id)
{
  
# 4184 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4184 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4184 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4184 "MagickWand/drawing-wand.c"
...
# 4184 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4184 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4184, __extension__ __PRETTY_FUNCTION__); }))
# 4184 "MagickWand/drawing-wand.c"
                                     ;
  
# 4185 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4185 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4185 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4185 "MagickWand/drawing-wand.c"
...
# 4185 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4185 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4185, __extension__ __PRETTY_FUNCTION__); }))
# 4185 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4187,"%s",wand->name);
  
# 4188 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4188 "MagickWand/drawing-wand.c"
 clip_mask_id != (const char *) 
# 4188 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4188 "MagickWand/drawing-wand.c"
 clip_mask_id != (const char *) 
# 4188 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 4188 "MagickWand/drawing-wand.c"
 "clip_mask_id != (const char *) NULL"
# 4188 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4188, __extension__ __PRETTY_FUNCTION__); }))
# 4188 "MagickWand/drawing-wand.c"
                                            ;
  (void) MVGPrintf(wand,"push clip-path \"%s\"\n",clip_mask_id);
  wand->indent_depth++;
}
# 4217 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawPushDefs(DrawingWand *wand)
{
  
# 4219 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4219 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4219 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4219 "MagickWand/drawing-wand.c"
...
# 4219 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4219 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4219, __extension__ __PRETTY_FUNCTION__); }))
# 4219 "MagickWand/drawing-wand.c"
                                     ;
  
# 4220 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4220 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4220 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4220 "MagickWand/drawing-wand.c"
...
# 4220 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4220 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4220, __extension__ __PRETTY_FUNCTION__); }))
# 4220 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4222,"%s",wand->name);
  (void) MVGPrintf(wand,"push defs\n");
  wand->indent_depth++;
}
# 4266 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawPushPattern(DrawingWand *wand,
  const char *pattern_id,const double x,const double y,const double width,
  const double height)
{
  
# 4270 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4270 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4270 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4270 "MagickWand/drawing-wand.c"
...
# 4270 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4270 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4270, __extension__ __PRETTY_FUNCTION__); }))
# 4270 "MagickWand/drawing-wand.c"
                                     ;
  
# 4271 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4271 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4271 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4271 "MagickWand/drawing-wand.c"
...
# 4271 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4271 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4271, __extension__ __PRETTY_FUNCTION__); }))
# 4271 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4273,"%s",wand->name);
  
# 4274 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4274 "MagickWand/drawing-wand.c"
 pattern_id != (const char *) 
# 4274 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4274 "MagickWand/drawing-wand.c"
 pattern_id != (const char *) 
# 4274 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 4274 "MagickWand/drawing-wand.c"
 "pattern_id != (const char *) NULL"
# 4274 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4274, __extension__ __PRETTY_FUNCTION__); }))
# 4274 "MagickWand/drawing-wand.c"
                                          ;
  if (wand->pattern_id != 
# 4275 "MagickWand/drawing-wand.c" 3 4
                         ((void *)0)
# 4275 "MagickWand/drawing-wand.c"
                             )
    {
      (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4277,DrawError,"AlreadyPushingPatternDefinition","`%s'",wand->pattern_id);
                         ;
      return(MagickFalse);
    }
  wand->filter_off=MagickTrue;
...
# 4324 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawRectangle(DrawingWand *wand,const double x1,const double y1,
  const double x2,const double y2)
{
  
# 4327 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4327 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4327 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4327 "MagickWand/drawing-wand.c"
...
# 4327 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4327 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4327, __extension__ __PRETTY_FUNCTION__); }))
# 4327 "MagickWand/drawing-wand.c"
                                     ;
  
# 4328 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4328 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4328 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4328 "MagickWand/drawing-wand.c"
...
# 4328 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4328 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4328, __extension__ __PRETTY_FUNCTION__); }))
# 4328 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4330,"%s",wand->name);
  if ((fabs(x2-x1) < 1.0e-12) && (fabs(y2-y1) < 1.0e-12))
    (void) MVGPrintf(wand,"point %.20g %.20g\n",x1,y1);
  else
   (void) MVGPrintf(wand,"rectangle %.20g %.20g %.20g %.20g\n",x1,y1,x2,y2);
}
# 4359 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawRender(DrawingWand *wand)
{
  MagickBooleanType
    status;

  
# 4364 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4364 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 4364 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4364 "MagickWand/drawing-wand.c"
...
# 4364 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 4364 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4364, __extension__ __PRETTY_FUNCTION__); }))
# 4364 "MagickWand/drawing-wand.c"
                                           ;
  
# 4365 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4365 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4365 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4365 "MagickWand/drawing-wand.c"
...
# 4365 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4365 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4365, __extension__ __PRETTY_FUNCTION__); }))
# 4365 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4367,"%s",wand->name);
  (wand->graphic_context[wand->index])->primitive=wand->mvg;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(DrawEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4370,"MVG:\n'%s'\n",wand->mvg);
  if (wand->image == (Image *) 
# 4371 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 4371 "MagickWand/drawing-wand.c"
                                  )
    (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4372,WandError,"ContainsNoImages","`%s'",wand->name);;
  status=DrawImage(wand->image,(wand->graphic_context[wand->index]),wand->exception);
  (wand->graphic_context[wand->index])->primitive=(char *) 
# 4374 "MagickWand/drawing-wand.c" 3 4
                                    ((void *)0)
# 4374 "MagickWand/drawing-wand.c"
                                        ;
  return(status);
}
# 4401 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawResetVectorGraphics(DrawingWand *wand)
{
  
# 4403 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4403 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4403 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4403 "MagickWand/drawing-wand.c"
...
# 4403 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4403 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4403, __extension__ __PRETTY_FUNCTION__); }))
# 4403 "MagickWand/drawing-wand.c"
                                     ;
  
# 4404 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4404 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4404 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4404 "MagickWand/drawing-wand.c"
...
# 4404 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4404 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4404, __extension__ __PRETTY_FUNCTION__); }))
# 4404 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4406,"%s",wand->name);
  if (wand->mvg != (char *) 
# 4407 "MagickWand/drawing-wand.c" 3 4
                           ((void *)0)
# 4407 "MagickWand/drawing-wand.c"
                               )
    wand->mvg=DestroyString(wand->mvg);
  wand->mvg_alloc=0;
  wand->mvg_length=0;
...
# 4438 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawRotate(DrawingWand *wand,const double degrees)
{
  
# 4440 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4440 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4440 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4440 "MagickWand/drawing-wand.c"
...
# 4440 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4440 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4440, __extension__ __PRETTY_FUNCTION__); }))
# 4440 "MagickWand/drawing-wand.c"
                                     ;
  
# 4441 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4441 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4441 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4441 "MagickWand/drawing-wand.c"
...
# 4441 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4441 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4441, __extension__ __PRETTY_FUNCTION__); }))
# 4441 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4443,"%s",wand->name);
  (void) MVGPrintf(wand,"rotate %.20g\n",degrees);
}
# 4484 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawRoundRectangle(DrawingWand *wand,double x1,double y1,
  double x2,double y2,double rx,double ry)
{
  
# 4487 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4487 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4487 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4487 "MagickWand/drawing-wand.c"
...
# 4487 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4487 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4487, __extension__ __PRETTY_FUNCTION__); }))
# 4487 "MagickWand/drawing-wand.c"
                                     ;
  
# 4488 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4488 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4488 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4488 "MagickWand/drawing-wand.c"
...
# 4488 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4488 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4488, __extension__ __PRETTY_FUNCTION__); }))
# 4488 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4490,"%s",wand->name);
  (void) MVGPrintf(wand,"roundrectangle %.20g %.20g %.20g %.20g %.20g %.20g\n",
    x1,y1,x2,y2,rx,ry);
}
# 4522 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawScale(DrawingWand *wand,const double x,const double y)
{
  
# 4524 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4524 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4524 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4524 "MagickWand/drawing-wand.c"
...
# 4524 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4524 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4524, __extension__ __PRETTY_FUNCTION__); }))
# 4524 "MagickWand/drawing-wand.c"
                                     ;
  
# 4525 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4525 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4525 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4525 "MagickWand/drawing-wand.c"
...
# 4525 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4525 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4525, __extension__ __PRETTY_FUNCTION__); }))
# 4525 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4527,"%s",wand->name);
  (void) MVGPrintf(wand,"scale %.20g %.20g\n",x,y);
}
# 4556 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetBorderColor(DrawingWand *wand,
...
# 4564 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4564 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4564 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4564 "MagickWand/drawing-wand.c"
...
# 4564 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4564 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4564, __extension__ __PRETTY_FUNCTION__); }))
# 4564 "MagickWand/drawing-wand.c"
                                     ;
  
# 4565 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4565 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4565 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4565 "MagickWand/drawing-wand.c"
...
# 4565 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4565 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4565, __extension__ __PRETTY_FUNCTION__); }))
# 4565 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4567,"%s",wand->name);
  
# 4568 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4568 "MagickWand/drawing-wand.c"
 border_wand != (const PixelWand *) 
# 4568 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4568 "MagickWand/drawing-wand.c"
 border_wand != (const PixelWand *) 
# 4568 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 4568 "MagickWand/drawing-wand.c"
 "border_wand != (const PixelWand *) NULL"
# 4568 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4568, __extension__ __PRETTY_FUNCTION__); }))
# 4568 "MagickWand/drawing-wand.c"
                                                ;
  PixelGetQuantumPacket(border_wand,&border_color);
  new_border=border_color;
  current_border=(&(wand->graphic_context[wand->index])->border_color);
  if ((wand->filter_off != MagickFalse) ||
      (IsPixelInfoEquivalent(current_border,&new_border) == MagickFalse))
    {
      (wand->graphic_context[wand->index])->border_color=new_border;
      (void) MVGPrintf(wand,"border-color '");
      MVGAppendColor(wand,&border_color);
      (void) MVGPrintf(wand,"'\n");
    }
}
# 4609 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawSetClipPath(DrawingWand *wand,
  const char *clip_mask)
{
  
# 4612 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4612 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4612 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4612 "MagickWand/drawing-wand.c"
...
# 4612 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4612 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4612, __extension__ __PRETTY_FUNCTION__); }))
# 4612 "MagickWand/drawing-wand.c"
                                     ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4614,"%s",clip_mask);
  
# 4615 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4615 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4615 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4615 "MagickWand/drawing-wand.c"
...
# 4615 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4615 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4615, __extension__ __PRETTY_FUNCTION__); }))
# 4615 "MagickWand/drawing-wand.c"
                                               ;
  
# 4616 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4616 "MagickWand/drawing-wand.c"
...
# 4616 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 4616 "MagickWand/drawing-wand.c"
 "clip_mask != (const char *) NULL"
# 4616 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4616, __extension__ __PRETTY_FUNCTION__); }))
# 4616 "MagickWand/drawing-wand.c"
                                         ;
  if (((wand->graphic_context[wand->index])->clip_mask == (const char *) 
# 4617 "MagickWand/drawing-wand.c" 3 4
                                                  ((void *)0)
# 4617 "MagickWand/drawing-wand.c"
                                                      ) ||
      (wand->filter_off != MagickFalse) ||
      (LocaleCompare((wand->graphic_context[wand->index])->clip_mask,clip_mask) != 0))
    {
      (void) CloneString(&(wand->graphic_context[wand->index])->clip_mask,clip_mask);
...
# 4657 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetClipRule(DrawingWand *wand,const FillRule fill_rule)
{
  
# 4659 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4659 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4659 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4659 "MagickWand/drawing-wand.c"
...
# 4659 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4659 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4659, __extension__ __PRETTY_FUNCTION__); }))
# 4659 "MagickWand/drawing-wand.c"
                                     ;
  
# 4660 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4660 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4660 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4660 "MagickWand/drawing-wand.c"
...
# 4660 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4660 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4660, __extension__ __PRETTY_FUNCTION__); }))
# 4660 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4662,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->fill_rule != fill_rule))
    {
      (wand->graphic_context[wand->index])->fill_rule=fill_rule;
...
# 4698 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetClipUnits(DrawingWand *wand,
  const ClipPathUnits clip_units)
{
  
# 4701 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4701 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4701 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4701 "MagickWand/drawing-wand.c"
...
# 4701 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4701 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4701, __extension__ __PRETTY_FUNCTION__); }))
# 4701 "MagickWand/drawing-wand.c"
                                     ;
  
# 4702 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4702 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4702 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4702 "MagickWand/drawing-wand.c"
...
# 4702 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4702 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4702, __extension__ __PRETTY_FUNCTION__); }))
# 4702 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4704,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->clip_units != clip_units))
    {
      (wand->graphic_context[wand->index])->clip_units=clip_units;
      if (clip_units == ObjectBoundingBox)
        {
          ...
          affine.sx=(wand->graphic_context[wand->index])->bounds.x2;
          affine.sy=(wand->graphic_context[wand->index])->bounds.y2;
          affine.tx=(wand->graphic_context[wand->index])->bounds.x1;
          affine.ty=(wand->graphic_context[wand->index])->bounds.y1;
          AdjustAffine(wand,&affine);
        }
...
# 4751 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawSetDensity(DrawingWand *wand,
  const char *density)
{
  
# 4754 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4754 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4754 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4754 "MagickWand/drawing-wand.c"
...
# 4754 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4754 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4754, __extension__ __PRETTY_FUNCTION__); }))
# 4754 "MagickWand/drawing-wand.c"
                                     ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4756,"%s",density);
  
# 4757 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4757 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4757 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4757 "MagickWand/drawing-wand.c"
...
# 4757 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4757 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4757, __extension__ __PRETTY_FUNCTION__); }))
# 4757 "MagickWand/drawing-wand.c"
                                               ;
  
# 4758 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4758 "MagickWand/drawing-wand.c"
 density != (const char *) 
# 4758 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4758 "MagickWand/drawing-wand.c"
...
# 4758 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 4758 "MagickWand/drawing-wand.c"
 "density != (const char *) NULL"
# 4758 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4758, __extension__ __PRETTY_FUNCTION__); }))
# 4758 "MagickWand/drawing-wand.c"
                                       ;
  if (((wand->graphic_context[wand->index])->density == (const char *) 
# 4759 "MagickWand/drawing-wand.c" 3 4
                                                ((void *)0)
# 4759 "MagickWand/drawing-wand.c"
                                                    ) ||
      (wand->filter_off != MagickFalse) ||
      (LocaleCompare((wand->graphic_context[wand->index])->density,density) != 0))
    {
      (void) CloneString(&(wand->graphic_context[wand->index])->density,density);
      (void) MVGPrintf(wand,"density '%s'\n",density);
    }
  return(MagickTrue);
}
# 4793 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetFillColor(DrawingWand *wand,const PixelWand *fill_wand)
{
  PixelInfo
    *current_fill,
    fill_color,
...
# 4800 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4800 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4800 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4800 "MagickWand/drawing-wand.c"
...
# 4800 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4800 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4800, __extension__ __PRETTY_FUNCTION__); }))
# 4800 "MagickWand/drawing-wand.c"
                                     ;
  
# 4801 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4801 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4801 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4801 "MagickWand/drawing-wand.c"
...
# 4801 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4801 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4801, __extension__ __PRETTY_FUNCTION__); }))
# 4801 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4803,"%s",wand->name);
  
# 4804 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4804 "MagickWand/drawing-wand.c"
 fill_wand != (const PixelWand *) 
# 4804 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4804 "MagickWand/drawing-wand.c"
 fill_wand != (const PixelWand *) 
# 4804 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 4804 "MagickWand/drawing-wand.c"
 "fill_wand != (const PixelWand *) NULL"
# 4804 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4804, __extension__ __PRETTY_FUNCTION__); }))
# 4804 "MagickWand/drawing-wand.c"
                                              ;
  PixelGetQuantumPacket(fill_wand,&fill_color);
  new_fill=fill_color;
  current_fill=(&(wand->graphic_context[wand->index])->fill);
  if ((wand->filter_off != MagickFalse) ||
      (IsPixelInfoEquivalent(current_fill,&new_fill) == MagickFalse))
    {
      (wand->graphic_context[wand->index])->fill=new_fill;
      (void) MVGPrintf(wand,"fill '");
      MVGAppendColor(wand,&fill_color);
      (void) MVGPrintf(wand,"'\n");
    }
}
# 4843 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetFillOpacity(DrawingWand *wand,const double fill_opacity)
{
  double
    alpha;

  
# 4848 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4848 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4848 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4848 "MagickWand/drawing-wand.c"
...
# 4848 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4848 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4848, __extension__ __PRETTY_FUNCTION__); }))
# 4848 "MagickWand/drawing-wand.c"
                                     ;
  
# 4849 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4849 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4849 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4849 "MagickWand/drawing-wand.c"
...
# 4849 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4849 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4849, __extension__ __PRETTY_FUNCTION__); }))
# 4849 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4851,"%s",wand->name);
  alpha=(double) ClampToQuantum((double) ((Quantum) 65535.0)*fill_opacity);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->fill.alpha != alpha))
    {
      (wand->graphic_context[wand->index])->fill.alpha=alpha;
      (void) MVGPrintf(wand,"fill-opacity %.20g\n",fill_opacity);
    }
}
# 4888 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawSetFontResolution(DrawingWand *wand,
...
# 4894 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4894 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4894 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4894 "MagickWand/drawing-wand.c"
...
# 4894 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4894 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4894, __extension__ __PRETTY_FUNCTION__); }))
# 4894 "MagickWand/drawing-wand.c"
                                     ;
  
# 4895 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4895 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4895 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4895 "MagickWand/drawing-wand.c"
...
# 4895 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4895 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4895, __extension__ __PRETTY_FUNCTION__); }))
# 4895 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4897,"%s",wand->name);
  (void) FormatLocaleString(density,4096,"%.20gx%.20g",x_resolution,
    y_resolution);
  (void) CloneString(&(wand->graphic_context[wand->index])->density,density);
  return(MagickTrue);
}
# 4929 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetOpacity(DrawingWand *wand,const double opacity)
{
  Quantum
    quantum_alpha;

  
# 4934 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4934 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4934 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4934 "MagickWand/drawing-wand.c"
...
# 4934 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4934 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4934, __extension__ __PRETTY_FUNCTION__); }))
# 4934 "MagickWand/drawing-wand.c"
                                     ;
  
# 4935 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4935 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4935 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4935 "MagickWand/drawing-wand.c"
...
# 4935 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4935 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4935, __extension__ __PRETTY_FUNCTION__); }))
# 4935 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4937,"%s",wand->name);
  quantum_alpha=ClampToQuantum((double) ((Quantum) 65535.0)*opacity);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->alpha != quantum_alpha))
    {
      (wand->graphic_context[wand->index])->alpha=quantum_alpha;
      (void) MVGPrintf(wand,"opacity %.20g\n",opacity);
    }
}
# 4975 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawSetFillPatternURL(DrawingWand *wand,
  const char *fill_url)
{
  char
    pattern[4096],
...
# 4982 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4982 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 4982 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4982 "MagickWand/drawing-wand.c"
...
# 4982 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 4982 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4982, __extension__ __PRETTY_FUNCTION__); }))
# 4982 "MagickWand/drawing-wand.c"
                                     ;
  
# 4983 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4983 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 4983 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4983 "MagickWand/drawing-wand.c"
...
# 4983 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 4983 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4983, __extension__ __PRETTY_FUNCTION__); }))
# 4983 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4985,"%s",fill_url);
  if (wand->image == (Image *) 
# 4986 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 4986 "MagickWand/drawing-wand.c"
                                  )
    (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4987,WandError,"ContainsNoImages","`%s'",wand->name);;
  
# 4988 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 4988 "MagickWand/drawing-wand.c"
 fill_url != (const char *) 
# 4988 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4988 "MagickWand/drawing-wand.c"
...
# 4988 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 4988 "MagickWand/drawing-wand.c"
 "fill_url != (const char *) NULL"
# 4988 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 4988, __extension__ __PRETTY_FUNCTION__); }))
# 4988 "MagickWand/drawing-wand.c"
                                        ;
  if (*fill_url != '#')
    {
      (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4991,DrawError,"NotARelativeURL","`%s'",fill_url);;
      return(MagickFalse);
    }
  (void) FormatLocaleString(pattern,4096,"%s",fill_url+1);
  if (GetImageArtifact(wand->image,pattern) == (const char *) 
# 4995 "MagickWand/drawing-wand.c" 3 4
                                                             ((void *)0)
# 4995 "MagickWand/drawing-wand.c"
                                                                 )
    {
      (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 4997,DrawError,"URLNotFound","`%s'",fill_url);
      return(MagickFalse);
    }
  (void) FormatLocaleString(pattern_spec,4096,"url(%s)",fill_url);




  if ((wand->graphic_context[wand->index])->fill.alpha != (double) ((Quantum) 0))
    (wand->graphic_context[wand->index])->fill.alpha=(double) (wand->graphic_context[wand->index])->alpha;
  (void) MVGPrintf(wand,"fill %s\n",pattern_spec);
  return(MagickTrue);
}
# 5035 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetFillRule(DrawingWand *wand,const FillRule fill_rule)
{
  
# 5037 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5037 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5037 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5037 "MagickWand/drawing-wand.c"
...
# 5037 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5037 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5037, __extension__ __PRETTY_FUNCTION__); }))
# 5037 "MagickWand/drawing-wand.c"
                                     ;
  
# 5038 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5038 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5038 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5038 "MagickWand/drawing-wand.c"
...
# 5038 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5038 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5038, __extension__ __PRETTY_FUNCTION__); }))
# 5038 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5040,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->fill_rule != fill_rule))
    {
      (wand->graphic_context[wand->index])->fill_rule=fill_rule;
...
# 5075 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawSetFont(DrawingWand *wand,
  const char *font_name)
{
  
# 5078 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5078 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5078 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5078 "MagickWand/drawing-wand.c"
...
# 5078 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5078 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5078, __extension__ __PRETTY_FUNCTION__); }))
# 5078 "MagickWand/drawing-wand.c"
                                     ;
  
# 5079 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5079 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5079 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5079 "MagickWand/drawing-wand.c"
...
# 5079 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5079 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5079, __extension__ __PRETTY_FUNCTION__); }))
# 5079 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5081,"%s",wand->name);
  
# 5082 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5082 "MagickWand/drawing-wand.c"
...
# 5082 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 5082 "MagickWand/drawing-wand.c"
 "font_name != (const char *) NULL"
# 5082 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5082, __extension__ __PRETTY_FUNCTION__); }))
# 5082 "MagickWand/drawing-wand.c"
                                         ;
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->font == (char *) 
# 5084 "MagickWand/drawing-wand.c" 3 4
                                       ((void *)0)
# 5084 "MagickWand/drawing-wand.c"
                                           ) ||
      (LocaleCompare((wand->graphic_context[wand->index])->font,font_name) != 0))
    {
      (void) CloneString(&(wand->graphic_context[wand->index])->font,font_name);
      (void) MVGPrintf(wand,"font '%s'\n",font_name);
    }
  return(MagickTrue);
}
# 5118 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawSetFontFamily(DrawingWand *wand,
  const char *font_family)
{
  
# 5121 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5121 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5121 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5121 "MagickWand/drawing-wand.c"
...
# 5121 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5121 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5121, __extension__ __PRETTY_FUNCTION__); }))
# 5121 "MagickWand/drawing-wand.c"
                                     ;
  
# 5122 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5122 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5122 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5122 "MagickWand/drawing-wand.c"
...
# 5122 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5122 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5122, __extension__ __PRETTY_FUNCTION__); }))
# 5122 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5124,"%s",wand->name);
  
# 5125 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5125 "MagickWand/drawing-wand.c"
...
# 5125 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 5125 "MagickWand/drawing-wand.c"
 "font_family != (const char *) NULL"
# 5125 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5125, __extension__ __PRETTY_FUNCTION__); }))
# 5125 "MagickWand/drawing-wand.c"
                                           ;
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->family == (const char *) 
# 5127 "MagickWand/drawing-wand.c" 3 4
                                               ((void *)0)
# 5127 "MagickWand/drawing-wand.c"
                                                   ) ||
      (LocaleCompare((wand->graphic_context[wand->index])->family,font_family) != 0))
    {
      (void) CloneString(&(wand->graphic_context[wand->index])->family,font_family);
      (void) MVGPrintf(wand,"font-family '%s'\n",font_family);
    }
  return(MagickTrue);
}
# 5160 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetFontSize(DrawingWand *wand,const double pointsize)
{
  
# 5162 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5162 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5162 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5162 "MagickWand/drawing-wand.c"
...
# 5162 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5162 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5162, __extension__ __PRETTY_FUNCTION__); }))
# 5162 "MagickWand/drawing-wand.c"
                                     ;
  
# 5163 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5163 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5163 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5163 "MagickWand/drawing-wand.c"
...
# 5163 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5163 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5163, __extension__ __PRETTY_FUNCTION__); }))
# 5163 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5165,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      (fabs((wand->graphic_context[wand->index])->pointsize-pointsize) >= 1.0e-12))
    {
      (wand->graphic_context[wand->index])->pointsize=pointsize;
      (void) MVGPrintf(wand,"font-size %.20g\n",pointsize);
    }
}
# 5203 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetFontStretch(DrawingWand *wand,
  const StretchType font_stretch)
{
  
# 5206 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5206 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5206 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5206 "MagickWand/drawing-wand.c"
...
# 5206 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5206 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5206, __extension__ __PRETTY_FUNCTION__); }))
# 5206 "MagickWand/drawing-wand.c"
                                     ;
  
# 5207 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5207 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5207 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5207 "MagickWand/drawing-wand.c"
...
# 5207 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5207 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5207, __extension__ __PRETTY_FUNCTION__); }))
# 5207 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5209,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->stretch != font_stretch))
    {
      (wand->graphic_context[wand->index])->stretch=font_stretch;
...
# 5244 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetFontStyle(DrawingWand *wand,const StyleType style)
{
  
# 5246 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5246 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5246 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5246 "MagickWand/drawing-wand.c"
...
# 5246 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5246 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5246, __extension__ __PRETTY_FUNCTION__); }))
# 5246 "MagickWand/drawing-wand.c"
                                     ;
  
# 5247 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5247 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5247 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5247 "MagickWand/drawing-wand.c"
...
# 5247 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5247 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5247, __extension__ __PRETTY_FUNCTION__); }))
# 5247 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5249,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->style != style))
    {
      (wand->graphic_context[wand->index])->style=style;
...
# 5284 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetFontWeight(DrawingWand *wand,
  const size_t font_weight)
{
  
# 5287 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5287 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5287 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5287 "MagickWand/drawing-wand.c"
...
# 5287 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5287 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5287, __extension__ __PRETTY_FUNCTION__); }))
# 5287 "MagickWand/drawing-wand.c"
                                     ;
  
# 5288 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5288 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5288 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5288 "MagickWand/drawing-wand.c"
...
# 5288 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5288 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5288, __extension__ __PRETTY_FUNCTION__); }))
# 5288 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5290,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->weight != font_weight))
    {
      (wand->graphic_context[wand->index])->weight=font_weight;
      (void) MVGPrintf(wand,"font-weight %.20g\n",(double) font_weight);
    }
}
# 5327 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetGravity(DrawingWand *wand,const GravityType gravity)
{
  
# 5329 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5329 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5329 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5329 "MagickWand/drawing-wand.c"
...
# 5329 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5329 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5329, __extension__ __PRETTY_FUNCTION__); }))
# 5329 "MagickWand/drawing-wand.c"
                                     ;
  
# 5330 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5330 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5330 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5330 "MagickWand/drawing-wand.c"
...
# 5330 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5330 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5330, __extension__ __PRETTY_FUNCTION__); }))
# 5330 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5332,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->gravity != gravity) || (gravity != ForgetGravity))
    {
      (wand->graphic_context[wand->index])->gravity=gravity;
      (void) MVGPrintf(wand,"gravity '%s'\n",CommandOptionToMnemonic(
        MagickGravityOptions,(ssize_t) gravity));
    }
}
# 5367 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetStrokeColor(DrawingWand *wand,
...
# 5375 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5375 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5375 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5375 "MagickWand/drawing-wand.c"
...
# 5375 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5375 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5375, __extension__ __PRETTY_FUNCTION__); }))
# 5375 "MagickWand/drawing-wand.c"
                                     ;
  
# 5376 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5376 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5376 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5376 "MagickWand/drawing-wand.c"
...
# 5376 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5376 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5376, __extension__ __PRETTY_FUNCTION__); }))
# 5376 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5378,"%s",wand->name);
  
# 5379 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5379 "MagickWand/drawing-wand.c"
 stroke_wand != (const PixelWand *) 
# 5379 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5379 "MagickWand/drawing-wand.c"
 stroke_wand != (const PixelWand *) 
# 5379 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 5379 "MagickWand/drawing-wand.c"
 "stroke_wand != (const PixelWand *) NULL"
# 5379 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5379, __extension__ __PRETTY_FUNCTION__); }))
# 5379 "MagickWand/drawing-wand.c"
                                                ;
  PixelGetQuantumPacket(stroke_wand,&stroke_color);
  new_stroke=stroke_color;
  current_stroke=(&(wand->graphic_context[wand->index])->stroke);
  if ((wand->filter_off != MagickFalse) ||
      (IsPixelInfoEquivalent(current_stroke,&new_stroke) == MagickFalse))
    {
      (wand->graphic_context[wand->index])->stroke=new_stroke;
      (void) MVGPrintf(wand,"stroke '");
      MVGAppendColor(wand,&stroke_color);
      (void) MVGPrintf(wand,"'\n");
    }
}
# 5418 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawSetStrokePatternURL(DrawingWand *wand,
...
# 5425 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5425 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5425 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5425 "MagickWand/drawing-wand.c"
...
# 5425 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5425 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5425, __extension__ __PRETTY_FUNCTION__); }))
# 5425 "MagickWand/drawing-wand.c"
                                     ;
  
# 5426 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5426 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5426 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5426 "MagickWand/drawing-wand.c"
...
# 5426 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5426 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5426, __extension__ __PRETTY_FUNCTION__); }))
# 5426 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5428,"%s",wand->name);
  if (wand->image == (Image *) 
# 5429 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 5429 "MagickWand/drawing-wand.c"
                                  )
    (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5430,WandError,"ContainsNoImages","`%s'",wand->name);;
  
# 5431 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5431 "MagickWand/drawing-wand.c"
 stroke_url != 
# 5431 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5431 "MagickWand/drawing-wand.c"
...
# 5431 "MagickWand/drawing-wand.c"
 "stroke_url != NULL"
# 5431 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5431, __extension__ __PRETTY_FUNCTION__); }))
# 5431 "MagickWand/drawing-wand.c"
                           ;
  if (stroke_url[0] != '#')
    (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5433,DrawError,"NotARelativeURL","`%s'",stroke_url);;
  (void) FormatLocaleString(pattern,4096,"%s",stroke_url+1);
  if (GetImageArtifact(wand->image,pattern) == (const char *) 
# 5435 "MagickWand/drawing-wand.c" 3 4
                                                             ((void *)0)
# 5435 "MagickWand/drawing-wand.c"
                                                                 )
    {
      (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5437,DrawError,"URLNotFound","`%s'",stroke_url);
      return(MagickFalse);
    }
  (void) FormatLocaleString(pattern_spec,4096,"url(%s)",stroke_url);




  if ((wand->graphic_context[wand->index])->stroke.alpha != (double) ((Quantum) 0))
    (wand->graphic_context[wand->index])->stroke.alpha=(double) (wand->graphic_context[wand->index])->alpha;
  (void) MVGPrintf(wand,"stroke %s\n",pattern_spec);
  return(MagickTrue);
}
# 5479 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetStrokeAntialias(DrawingWand *wand,
  const MagickBooleanType stroke_antialias)
{
  
# 5482 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5482 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5482 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5482 "MagickWand/drawing-wand.c"
...
# 5482 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5482 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5482, __extension__ __PRETTY_FUNCTION__); }))
# 5482 "MagickWand/drawing-wand.c"
                                     ;
  
# 5483 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5483 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5483 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5483 "MagickWand/drawing-wand.c"
...
# 5483 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5483 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5483, __extension__ __PRETTY_FUNCTION__); }))
# 5483 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5485,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->stroke_antialias != stroke_antialias))
    {
      (wand->graphic_context[wand->index])->stroke_antialias=stroke_antialias;
...
# 5528 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DrawSetStrokeDashArray(DrawingWand *wand,
...
# 5547 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5547 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5547 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5547 "MagickWand/drawing-wand.c"
...
# 5547 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5547 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5547, __extension__ __PRETTY_FUNCTION__); }))
# 5547 "MagickWand/drawing-wand.c"
                                     ;
  
# 5548 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5548 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5548 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5548 "MagickWand/drawing-wand.c"
...
# 5548 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5548 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5548, __extension__ __PRETTY_FUNCTION__); }))
# 5548 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5550,"%s",wand->name);
  n_new=number_elements;
  if (dasharray == (const double *) 
# 5552 "MagickWand/drawing-wand.c" 3 4
                                   ((void *)0)
# 5552 "MagickWand/drawing-wand.c"
                                       )
    n_new=0;
  n_old=0;
  update=MagickFalse;
  q=(wand->graphic_context[wand->index])->dash_pattern;
  if (q != (const double *) 
# 5557 "MagickWand/drawing-wand.c" 3 4
                           ((void *)0)
# 5557 "MagickWand/drawing-wand.c"
                               )
    while (fabs(*q++) < 1.0e-12)
      n_old++;
  if ((n_old == 0) && (n_new == 0))
    update=MagickFalse;
  else
    if (n_old != n_new)
      ...
      if (((wand->graphic_context[wand->index])->dash_pattern != (double *) 
# 5566 "MagickWand/drawing-wand.c" 3 4
                                                     ((void *)0)
# 5566 "MagickWand/drawing-wand.c"
                                                         ) &&
          (dasharray != (double *) 
# 5567 "MagickWand/drawing-wand.c" 3 4
                                  ((void *)0)
# 5567 "MagickWand/drawing-wand.c"
                                      ))
        {
          p=dasharray;
          q=(wand->graphic_context[wand->index])->dash_pattern;
  ...
  if ((wand->filter_off != MagickFalse) || (update != MagickFalse))
    {
      if ((wand->graphic_context[wand->index])->dash_pattern != (double *) 
# 5584 "MagickWand/drawing-wand.c" 3 4
                                                    ((void *)0)
# 5584 "MagickWand/drawing-wand.c"
                                                        )
        (wand->graphic_context[wand->index])->dash_pattern=(double *)
          RelinquishMagickMemory((wand->graphic_context[wand->index])->dash_pattern);
      if (n_new != 0)
        {
          (wand->graphic_context[wand->index])->dash_pattern=(double *) AcquireQuantumMemory((size_t)
            n_new+1UL,sizeof(*(wand->graphic_context[wand->index])->dash_pattern));
          if ((wand->graphic_context[wand->index])->dash_pattern == (double *) 
# 5591 "MagickWand/drawing-wand.c" 3 4
                                                        ((void *)0)
# 5591 "MagickWand/drawing-wand.c"
                                                            )
            {
              (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5593,ResourceLimitError,"MemoryAllocationFailed","`%s'",wand->name);
                           ;
              return(MagickFalse);
            }
          for (i=0; i < (ssize_t) n_new; i++)
          {
            (wand->graphic_context[wand->index])->dash_pattern[i]=0.0;
            if (dasharray != (double *) 
# 5600 "MagickWand/drawing-wand.c" 3 4
                                       ((void *)0)
# 5600 "MagickWand/drawing-wand.c"
                                           )
              (wand->graphic_context[wand->index])->dash_pattern[i]=dasharray[i];
          }
          (wand->graphic_context[wand->index])->dash_pattern[n_new]=0.0;
        }
      ...
      if (n_new == 0)
        ...
        if (dasharray != (double *) 
# 5609 "MagickWand/drawing-wand.c" 3 4
                                   ((void *)0)
# 5609 "MagickWand/drawing-wand.c"
                                       )
          {
            for (i=0; i < (ssize_t) n_new; i++)
            {
...
# 5649 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetStrokeDashOffset(DrawingWand *wand,
  const double dash_offset)
{
  
# 5652 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5652 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5652 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5652 "MagickWand/drawing-wand.c"
...
# 5652 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5652 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5652, __extension__ __PRETTY_FUNCTION__); }))
# 5652 "MagickWand/drawing-wand.c"
                                     ;
  
# 5653 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5653 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5653 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5653 "MagickWand/drawing-wand.c"
...
# 5653 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5653 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5653, __extension__ __PRETTY_FUNCTION__); }))
# 5653 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5655,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
     (fabs((wand->graphic_context[wand->index])->dash_offset-dash_offset) >= 1.0e-12))
    {
      (wand->graphic_context[wand->index])->dash_offset=dash_offset;
      (void) MVGPrintf(wand,"stroke-dashoffset %.20g\n",dash_offset);
    }
}
# 5691 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetStrokeLineCap(DrawingWand *wand,const LineCap linecap)
{
  
# 5693 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5693 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5693 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5693 "MagickWand/drawing-wand.c"
...
# 5693 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5693 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5693, __extension__ __PRETTY_FUNCTION__); }))
# 5693 "MagickWand/drawing-wand.c"
                                     ;
  
# 5694 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5694 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5694 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5694 "MagickWand/drawing-wand.c"
...
# 5694 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5694 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5694, __extension__ __PRETTY_FUNCTION__); }))
# 5694 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5696,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) || ((wand->graphic_context[wand->index])->linecap != linecap))
    {
      (wand->graphic_context[wand->index])->linecap=linecap;
      (void) MVGPrintf(wand,"stroke-linecap '%s'\n",CommandOptionToMnemonic(
        MagickLineCapOptions,(ssize_t) linecap));
    }
}
# 5732 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetStrokeLineJoin(DrawingWand *wand,const LineJoin linejoin)
{
  
# 5734 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5734 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5734 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5734 "MagickWand/drawing-wand.c"
...
# 5734 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5734 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5734, __extension__ __PRETTY_FUNCTION__); }))
# 5734 "MagickWand/drawing-wand.c"
                                     ;
  
# 5735 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5735 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5735 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5735 "MagickWand/drawing-wand.c"
...
# 5735 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5735 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5735, __extension__ __PRETTY_FUNCTION__); }))
# 5735 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5737,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->linejoin != linejoin))
    {
      (wand->graphic_context[wand->index])->linejoin=linejoin;
...
# 5776 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetStrokeMiterLimit(DrawingWand *wand,
  const size_t miterlimit)
{
  
# 5779 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5779 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5779 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5779 "MagickWand/drawing-wand.c"
...
# 5779 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5779 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5779, __extension__ __PRETTY_FUNCTION__); }))
# 5779 "MagickWand/drawing-wand.c"
                                     ;
  
# 5780 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5780 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5780 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5780 "MagickWand/drawing-wand.c"
...
# 5780 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5780 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5780, __extension__ __PRETTY_FUNCTION__); }))
# 5780 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5782,"%s",wand->name);
  if ((wand->graphic_context[wand->index])->miterlimit != miterlimit)
    {
      (wand->graphic_context[wand->index])->miterlimit=miterlimit;
      (void) MVGPrintf(wand,"stroke-miterlimit %.20g\n",(double) miterlimit);
    }
}
# 5815 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetStrokeOpacity(DrawingWand *wand,
...
# 5821 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5821 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5821 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5821 "MagickWand/drawing-wand.c"
...
# 5821 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5821 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5821, __extension__ __PRETTY_FUNCTION__); }))
# 5821 "MagickWand/drawing-wand.c"
                                     ;
  
# 5822 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5822 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5822 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5822 "MagickWand/drawing-wand.c"
...
# 5822 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5822 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5822, __extension__ __PRETTY_FUNCTION__); }))
# 5822 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5824,"%s",wand->name);
  alpha=(double) ClampToQuantum((double) ((Quantum) 65535.0)*opacity);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->stroke.alpha != alpha))
    {
      (wand->graphic_context[wand->index])->stroke.alpha=alpha;
      (void) MVGPrintf(wand,"stroke-opacity %.20g\n",opacity);
    }
}
# 5860 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetStrokeWidth(DrawingWand *wand,const double stroke_width)
{
  
# 5862 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5862 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5862 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5862 "MagickWand/drawing-wand.c"
...
# 5862 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5862 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5862, __extension__ __PRETTY_FUNCTION__); }))
# 5862 "MagickWand/drawing-wand.c"
                                     ;
  
# 5863 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5863 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5863 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5863 "MagickWand/drawing-wand.c"
...
# 5863 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5863 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5863, __extension__ __PRETTY_FUNCTION__); }))
# 5863 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5865,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      (fabs((wand->graphic_context[wand->index])->stroke_width-stroke_width) >= 1.0e-12))
    {
      (wand->graphic_context[wand->index])->stroke_width=stroke_width;
      (void) MVGPrintf(wand,"stroke-width %.20g\n",stroke_width);
    }
}
# 5900 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetTextAlignment(DrawingWand *wand,
  const AlignType alignment)
{
  
# 5903 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5903 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5903 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5903 "MagickWand/drawing-wand.c"
...
# 5903 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5903 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5903, __extension__ __PRETTY_FUNCTION__); }))
# 5903 "MagickWand/drawing-wand.c"
                                     ;
  
# 5904 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5904 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5904 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5904 "MagickWand/drawing-wand.c"
...
# 5904 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5904 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5904, __extension__ __PRETTY_FUNCTION__); }))
# 5904 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5906,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->align != alignment))
    {
      (wand->graphic_context[wand->index])->align=alignment;
...
# 5943 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetTextAntialias(DrawingWand *wand,
  const MagickBooleanType text_antialias)
{
  
# 5946 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5946 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5946 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5946 "MagickWand/drawing-wand.c"
...
# 5946 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5946 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5946, __extension__ __PRETTY_FUNCTION__); }))
# 5946 "MagickWand/drawing-wand.c"
                                     ;
  
# 5947 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5947 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5947 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5947 "MagickWand/drawing-wand.c"
...
# 5947 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5947 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5947, __extension__ __PRETTY_FUNCTION__); }))
# 5947 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5949,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->text_antialias != text_antialias))
    {
      (wand->graphic_context[wand->index])->text_antialias=text_antialias;
      (void) MVGPrintf(wand,"text-antialias %i\n",text_antialias != 0 ? 1 : 0);
    }
}
# 5985 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetTextDecoration(DrawingWand *wand,
  const DecorationType decoration)
{
  
# 5988 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5988 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 5988 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5988 "MagickWand/drawing-wand.c"
...
# 5988 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 5988 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5988, __extension__ __PRETTY_FUNCTION__); }))
# 5988 "MagickWand/drawing-wand.c"
                                     ;
  
# 5989 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 5989 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 5989 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5989 "MagickWand/drawing-wand.c"
...
# 5989 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 5989 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 5989, __extension__ __PRETTY_FUNCTION__); }))
# 5989 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 5991,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->decorate != decoration))
    {
      (wand->graphic_context[wand->index])->decorate=decoration;
...
# 6028 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetTextDirection(DrawingWand *wand,
  const DirectionType direction)
{
  
# 6031 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6031 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6031 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6031 "MagickWand/drawing-wand.c"
...
# 6031 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6031 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6031, __extension__ __PRETTY_FUNCTION__); }))
# 6031 "MagickWand/drawing-wand.c"
                                     ;
  
# 6032 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6032 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6032 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6032 "MagickWand/drawing-wand.c"
...
# 6032 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6032 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6032, __extension__ __PRETTY_FUNCTION__); }))
# 6032 "MagickWand/drawing-wand.c"
                                               ;

  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6035,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->direction != direction))
    {
      (wand->graphic_context[wand->index])->direction=direction;
...
# 6074 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetTextEncoding(DrawingWand *wand,const char *encoding)
{
  
# 6076 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6076 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6076 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6076 "MagickWand/drawing-wand.c"
...
# 6076 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6076 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6076, __extension__ __PRETTY_FUNCTION__); }))
# 6076 "MagickWand/drawing-wand.c"
                                     ;
  
# 6077 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6077 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6077 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6077 "MagickWand/drawing-wand.c"
...
# 6077 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6077 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6077, __extension__ __PRETTY_FUNCTION__); }))
# 6077 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6079,"%s",wand->name);
  
# 6080 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6080 "MagickWand/drawing-wand.c"
 encoding != (char *) 
# 6080 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6080 "MagickWand/drawing-wand.c"
...
# 6080 "MagickWand/drawing-wand.c"
 "encoding != (char *) NULL"
# 6080 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6080, __extension__ __PRETTY_FUNCTION__); }))
# 6080 "MagickWand/drawing-wand.c"
                                  ;
  if ((wand->filter_off != MagickFalse) ||
      ((wand->graphic_context[wand->index])->encoding == (char *) 
# 6082 "MagickWand/drawing-wand.c" 3 4
                                           ((void *)0)
# 6082 "MagickWand/drawing-wand.c"
                                               ) ||
      (LocaleCompare((wand->graphic_context[wand->index])->encoding,encoding) != 0))
    {
      (void) CloneString(&(wand->graphic_context[wand->index])->encoding,encoding);
      (void) MVGPrintf(wand,"encoding '%s'\n",encoding);
    }
}
# 6114 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetTextKerning(DrawingWand *wand,const double kerning)
{
  
# 6116 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6116 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6116 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6116 "MagickWand/drawing-wand.c"
...
# 6116 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6116 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6116, __extension__ __PRETTY_FUNCTION__); }))
# 6116 "MagickWand/drawing-wand.c"
                                     ;
  
# 6117 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6117 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6117 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6117 "MagickWand/drawing-wand.c"
...
# 6117 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6117 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6117, __extension__ __PRETTY_FUNCTION__); }))
# 6117 "MagickWand/drawing-wand.c"
                                               ;

  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6120,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) &&
      (fabs(((wand->graphic_context[wand->index])->kerning-kerning)) >= 1.0e-12))
    {
      (wand->graphic_context[wand->index])->kerning=kerning;
      (void) MVGPrintf(wand,"kerning %lf\n",kerning);
    }
}
# 6154 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetTextInterlineSpacing(DrawingWand *wand,
  const double interline_spacing)
{
  
# 6157 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6157 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6157 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6157 "MagickWand/drawing-wand.c"
...
# 6157 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6157 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6157, __extension__ __PRETTY_FUNCTION__); }))
# 6157 "MagickWand/drawing-wand.c"
                                     ;
  
# 6158 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6158 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6158 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6158 "MagickWand/drawing-wand.c"
...
# 6158 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6158 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6158, __extension__ __PRETTY_FUNCTION__); }))
# 6158 "MagickWand/drawing-wand.c"
                                               ;

  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6161,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      (fabs(((wand->graphic_context[wand->index])->interline_spacing-
        interline_spacing)) >= 1.0e-12))
    {
      (wand->graphic_context[wand->index])->interline_spacing=interline_spacing;
      (void) MVGPrintf(wand,"interline-spacing %lf\n",interline_spacing);
    }
}
# 6196 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetTextInterwordSpacing(DrawingWand *wand,
  const double interword_spacing)
{
  
# 6199 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6199 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6199 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6199 "MagickWand/drawing-wand.c"
...
# 6199 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6199 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6199, __extension__ __PRETTY_FUNCTION__); }))
# 6199 "MagickWand/drawing-wand.c"
                                     ;
  
# 6200 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6200 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6200 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6200 "MagickWand/drawing-wand.c"
...
# 6200 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6200 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6200, __extension__ __PRETTY_FUNCTION__); }))
# 6200 "MagickWand/drawing-wand.c"
                                               ;

  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6203,"%s",wand->name);
  if ((wand->filter_off != MagickFalse) ||
      (fabs(((wand->graphic_context[wand->index])->interword_spacing-
        interword_spacing)) >= 1.0e-12))
    {
      (wand->graphic_context[wand->index])->interword_spacing=interword_spacing;
      (void) MVGPrintf(wand,"interword-spacing %lf\n",interword_spacing);
    }
}
# 6239 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetTextUnderColor(DrawingWand *wand,
...
# 6245 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6245 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6245 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6245 "MagickWand/drawing-wand.c"
...
# 6245 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6245 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6245, __extension__ __PRETTY_FUNCTION__); }))
# 6245 "MagickWand/drawing-wand.c"
                                     ;
  
# 6246 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6246 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6246 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6246 "MagickWand/drawing-wand.c"
...
# 6246 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6246 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6246, __extension__ __PRETTY_FUNCTION__); }))
# 6246 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6248,"%s",wand->name);
  
# 6249 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6249 "MagickWand/drawing-wand.c"
 under_wand != (const PixelWand *) 
# 6249 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6249 "MagickWand/drawing-wand.c"
 under_wand != (const PixelWand *) 
# 6249 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 6249 "MagickWand/drawing-wand.c"
 "under_wand != (const PixelWand *) NULL"
# 6249 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6249, __extension__ __PRETTY_FUNCTION__); }))
# 6249 "MagickWand/drawing-wand.c"
                                               ;
  PixelGetQuantumPacket(under_wand,&under_color);
  if ((wand->filter_off != MagickFalse) ||
      (IsPixelInfoEquivalent(&(wand->graphic_context[wand->index])->undercolor,&under_color) == MagickFalse))
    {
      (wand->graphic_context[wand->index])->undercolor=under_color;
      (void) MVGPrintf(wand,"text-undercolor '");
      MVGAppendColor(wand,&under_color);
      (void) MVGPrintf(wand,"'\n");
    }
}
# 6289 "MagickWand/drawing-wand.c"
...
__attribute__ ((visibility ("default"))) MagickBooleanType DrawSetVectorGraphics(DrawingWand *wand,
  const char *xml)
{
  const char
    *value;
...
# 6312 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6312 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6312 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6312 "MagickWand/drawing-wand.c"
...
# 6312 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6312 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6312, __extension__ __PRETTY_FUNCTION__); }))
# 6312 "MagickWand/drawing-wand.c"
                                     ;
  
# 6313 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6313 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6313 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6313 "MagickWand/drawing-wand.c"
...
# 6313 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6313 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6313, __extension__ __PRETTY_FUNCTION__); }))
# 6313 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6315,"%s",wand->name);
  (wand->graphic_context[wand->index])=DestroyDrawInfo((wand->graphic_context[wand->index]));
  (wand->graphic_context[wand->index])=CloneDrawInfo((ImageInfo *) 
# 6317 "MagickWand/drawing-wand.c" 3 4
                                            ((void *)0)
# 6317 "MagickWand/drawing-wand.c"
                                                ,(DrawInfo *) 
# 6317 "MagickWand/drawing-wand.c" 3 4
                                                              ((void *)0)
# 6317 "MagickWand/drawing-wand.c"
  ...
  if (xml == (const char *) 
# 6318 "MagickWand/drawing-wand.c" 3 4
                           ((void *)0)
# 6318 "MagickWand/drawing-wand.c"
                               )
    return(MagickFalse);
  xml_info=NewXMLTree(xml,wand->exception);
  if (xml_info == (XMLTreeInfo *) 
# 6321 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6321 "MagickWand/drawing-wand.c"
                                     )
    return(MagickFalse);
  child=GetXMLTreeChild(xml_info,"clip-path");
  if (child != (XMLTreeInfo *) 
# 6324 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6324 "MagickWand/drawing-wand.c"
                                  )
    (void) CloneString(&(wand->graphic_context[wand->index])->clip_mask,GetXMLTreeContent(child));
  child=GetXMLTreeChild(xml_info,"clip-units");
  if (child != (XMLTreeInfo *) 
# 6327 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6327 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6330 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6330 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->clip_units=(ClipPathUnits) ParseCommandOption(
          MagickClipPathOptions,MagickFalse,value);
    }
  child=GetXMLTreeChild(xml_info,"decorate");
  if (child != (XMLTreeInfo *) 
# 6335 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6335 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6338 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6338 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->decorate=(DecorationType) ParseCommandOption(
          MagickDecorateOptions,MagickFalse,value);
    }
  child=GetXMLTreeChild(xml_info,"encoding");
  if (child != (XMLTreeInfo *) 
# 6343 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6343 "MagickWand/drawing-wand.c"
                                  )
    (void) CloneString(&(wand->graphic_context[wand->index])->encoding,GetXMLTreeContent(child));
  child=GetXMLTreeChild(xml_info,"fill");
  if (child != (XMLTreeInfo *) 
# 6346 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6346 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6349 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6349 "MagickWand/drawing-wand.c"
                                     )
        (void) QueryColorCompliance(value,AllCompliance,&(wand->graphic_context[wand->index])->fill,
          wand->exception);
    }
  child=GetXMLTreeChild(xml_info,"fill-opacity");
  if (child != (XMLTreeInfo *) 
# 6354 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6354 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6357 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6357 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->fill.alpha=(double) ClampToQuantum((double)
          ((Quantum) 65535.0)*(1.0-StringToDouble(value,(char **) 
# 6359 "MagickWand/drawing-wand.c" 3 4
                                                          ((void *)0)
# 6359 "MagickWand/drawing-wand.c"
                                                              )));
    }
  child=GetXMLTreeChild(xml_info,"fill-rule");
  if (child != (XMLTreeInfo *) 
# 6362 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6362 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6365 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6365 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->fill_rule=(FillRule) ParseCommandOption(
          MagickFillRuleOptions,MagickFalse,value);
    }
  child=GetXMLTreeChild(xml_info,"font");
  if (child != (XMLTreeInfo *) 
# 6370 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6370 "MagickWand/drawing-wand.c"
                                  )
    (void) CloneString(&(wand->graphic_context[wand->index])->font,GetXMLTreeContent(child));
  child=GetXMLTreeChild(xml_info,"font-family");
  if (child != (XMLTreeInfo *) 
# 6373 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6373 "MagickWand/drawing-wand.c"
                                  )
    (void) CloneString(&(wand->graphic_context[wand->index])->family,GetXMLTreeContent(child));
  child=GetXMLTreeChild(xml_info,"font-size");
  if (child != (XMLTreeInfo *) 
# 6376 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6376 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6379 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6379 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->pointsize=StringToDouble(value,(char **) 
# 6380 "MagickWand/drawing-wand.c" 3 4
                                                                ((void *)0)
# 6380 "MagickWand/drawing-wand.c"
                                                                    );
    }
  child=GetXMLTreeChild(xml_info,"font-stretch");
  if (child != (XMLTreeInfo *) 
# 6383 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6383 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6386 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6386 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->stretch=(StretchType) ParseCommandOption(
          MagickStretchOptions,MagickFalse,value);
    }
  child=GetXMLTreeChild(xml_info,"font-style");
  if (child != (XMLTreeInfo *) 
# 6391 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6391 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6394 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6394 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->style=(StyleType) ParseCommandOption(MagickStyleOptions,
          MagickFalse,value);
    }
  child=GetXMLTreeChild(xml_info,"font-weight");
  if (child != (XMLTreeInfo *) 
# 6399 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6399 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6402 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6402 "MagickWand/drawing-wand.c"
                                     )
        {
          ssize_t
            weight;
          ...
          (wand->graphic_context[wand->index])->weight=(size_t) weight;
        }
    }
  child=GetXMLTreeChild(xml_info,"gravity");
  if (child != (XMLTreeInfo *) 
# 6414 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6414 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6417 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6417 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->gravity=(GravityType) ParseCommandOption(
          MagickGravityOptions,MagickFalse,value);
    }
  child=GetXMLTreeChild(xml_info,"stroke");
  if (child != (XMLTreeInfo *) 
# 6422 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6422 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6425 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6425 "MagickWand/drawing-wand.c"
                                     )
        (void) QueryColorCompliance(value,AllCompliance,&(wand->graphic_context[wand->index])->stroke,
          wand->exception);
    }
  child=GetXMLTreeChild(xml_info,"stroke-antialias");
  if (child != (XMLTreeInfo *) 
# 6430 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6430 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6433 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6433 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->stroke_antialias=StringToLong(value) != 0 ? MagickTrue :
          MagickFalse;
    }
  child=GetXMLTreeChild(xml_info,"stroke-dasharray");
  if (child != (XMLTreeInfo *) 
# 6438 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6438 "MagickWand/drawing-wand.c"
                                  )
    {
      char
        token[4096];
      ...
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6453 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6453 "MagickWand/drawing-wand.c"
                                     )
        {
          if ((wand->graphic_context[wand->index])->dash_pattern != (double *) 
# 6455 "MagickWand/drawing-wand.c" 3 4
                                                        ((void *)0)
# 6455 "MagickWand/drawing-wand.c"
                                                            )
            (wand->graphic_context[wand->index])->dash_pattern=(double *) RelinquishMagickMemory(
              (wand->graphic_context[wand->index])->dash_pattern);
          q=(char *) value;
          if (IsPoint(q) != MagickFalse)
            {
              ...
              p=q;
              (void) GetNextToken(p,&p,4096,token);
              if (*token == ',')
                (void) GetNextToken(p,&p,4096,token);
              ...
              (wand->graphic_context[wand->index])->dash_pattern=(double *) AcquireQuantumMemory(
                (size_t) (2*x)+1UL,sizeof(*(wand->graphic_context[wand->index])->dash_pattern));
              if ((wand->graphic_context[wand->index])->dash_pattern == (double *) 
# 6476 "MagickWand/drawing-wand.c" 3 4
                                                            ((void *)0)
# 6476 "MagickWand/drawing-wand.c"
                                                                )
                { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6477,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",wand->name); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                                                      ;
              for (j=0; j < x; j++)
              {
                (void) GetNextToken(q,&q,4096,token);
                if (*token == ',')
                  (void) GetNextToken(q,&q,4096,token);
                (wand->graphic_context[wand->index])->dash_pattern[j]=StringToDouble(token,
                  (char **) 
# 6485 "MagickWand/drawing-wand.c" 3 4
                           ((void *)0)
# 6485 "MagickWand/drawing-wand.c"
                               );
              }
              if ((x & 0x01) != 0)
                for ( ; j < (2*x); j++)
                  (wand->graphic_context[wand->index])->dash_pattern[j]=
                    (wand->graphic_context[wand->index])->dash_pattern[j-x];
              (wand->graphic_context[wand->index])->dash_pattern[j]=0.0;
            }
        }
    }
  child=GetXMLTreeChild(xml_info,"stroke-dashoffset");
  if (child != (XMLTreeInfo *) 
# 6496 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6496 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6499 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6499 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->dash_offset=StringToDouble(value,(char **) 
# 6500 "MagickWand/drawing-wand.c" 3 4
                                                                  ((void *)0)
# 6500 "MagickWand/drawing-wand.c"
                                                                      );
    }
  child=GetXMLTreeChild(xml_info,"stroke-linecap");
  if (child != (XMLTreeInfo *) 
# 6503 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6503 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6506 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6506 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->linecap=(LineCap) ParseCommandOption(
          MagickLineCapOptions,MagickFalse,value);
    }
  child=GetXMLTreeChild(xml_info,"stroke-linejoin");
  if (child != (XMLTreeInfo *) 
# 6511 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6511 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6514 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6514 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->linejoin=(LineJoin) ParseCommandOption(
          MagickLineJoinOptions,MagickFalse,value);
    }
  child=GetXMLTreeChild(xml_info,"stroke-miterlimit");
  if (child != (XMLTreeInfo *) 
# 6519 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6519 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6522 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6522 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->miterlimit=StringToUnsignedLong(value);
    }
  child=GetXMLTreeChild(xml_info,"stroke-opacity");
  if (child != (XMLTreeInfo *) 
# 6526 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6526 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6529 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6529 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->stroke.alpha=(double) ClampToQuantum((double)
          ((Quantum) 65535.0)*(1.0-StringToDouble(value,(char **) 
# 6531 "MagickWand/drawing-wand.c" 3 4
                                                          ((void *)0)
# 6531 "MagickWand/drawing-wand.c"
                                                              )));
    }
  child=GetXMLTreeChild(xml_info,"stroke-width");
  if (child != (XMLTreeInfo *) 
# 6534 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6534 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6537 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6537 "MagickWand/drawing-wand.c"
                                     )
        {
          ssize_t
            weight;
          ...
          if (weight == -1)
            weight=(ssize_t) StringToUnsignedLong(value);
          (wand->graphic_context[wand->index])->stroke_width=(double) weight;
        }
    }
  child=GetXMLTreeChild(xml_info,"text-align");
  if (child != (XMLTreeInfo *) 
# 6549 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6549 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6552 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6552 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->align=(AlignType) ParseCommandOption(MagickAlignOptions,
          MagickFalse,value);
    }
  child=GetXMLTreeChild(xml_info,"text-antialias");
  if (child != (XMLTreeInfo *) 
# 6557 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6557 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6560 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6560 "MagickWand/drawing-wand.c"
                                     )
        (wand->graphic_context[wand->index])->text_antialias=StringToLong(value) != 0 ? MagickTrue :
          MagickFalse;
    }
  child=GetXMLTreeChild(xml_info,"text-undercolor");
  if (child != (XMLTreeInfo *) 
# 6565 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6565 "MagickWand/drawing-wand.c"
                                  )
    {
      value=GetXMLTreeContent(child);
      if (value != (const char *) 
# 6568 "MagickWand/drawing-wand.c" 3 4
                                 ((void *)0)
# 6568 "MagickWand/drawing-wand.c"
                                     )
        (void) QueryColorCompliance(value,AllCompliance,
          &(wand->graphic_context[wand->index])->undercolor,wand->exception);
    }
  child=GetXMLTreeChild(xml_info,"vector-graphics");
  if (child != (XMLTreeInfo *) 
# 6573 "MagickWand/drawing-wand.c" 3 4
                              ((void *)0)
# 6573 "MagickWand/drawing-wand.c"
                                  )
    {
...
# 6608 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSkewX(DrawingWand *wand,const double degrees)
{
  
# 6610 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6610 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6610 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6610 "MagickWand/drawing-wand.c"
...
# 6610 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6610 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6610, __extension__ __PRETTY_FUNCTION__); }))
# 6610 "MagickWand/drawing-wand.c"
                                     ;
  
# 6611 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6611 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6611 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6611 "MagickWand/drawing-wand.c"
...
# 6611 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6611 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6611, __extension__ __PRETTY_FUNCTION__); }))
# 6611 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6613,"%s",wand->name);
  (void) MVGPrintf(wand,"skewX %.20g\n",degrees);
}
# 6642 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSkewY(DrawingWand *wand,const double degrees)
{
  
# 6644 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6644 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6644 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6644 "MagickWand/drawing-wand.c"
...
# 6644 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6644 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6644, __extension__ __PRETTY_FUNCTION__); }))
# 6644 "MagickWand/drawing-wand.c"
                                     ;
  
# 6645 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6645 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6645 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6645 "MagickWand/drawing-wand.c"
...
# 6645 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6645 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6645, __extension__ __PRETTY_FUNCTION__); }))
# 6645 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6647,"%s",wand->name);
  (void) MVGPrintf(wand,"skewY %.20g\n",degrees);
}
# 6680 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawTranslate(DrawingWand *wand,const double x,const double y)
{
  
# 6682 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6682 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6682 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6682 "MagickWand/drawing-wand.c"
...
# 6682 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6682 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6682, __extension__ __PRETTY_FUNCTION__); }))
# 6682 "MagickWand/drawing-wand.c"
                                     ;
  
# 6683 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6683 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6683 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6683 "MagickWand/drawing-wand.c"
...
# 6683 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6683 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6683, __extension__ __PRETTY_FUNCTION__); }))
# 6683 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6685,"%s",wand->name);
  (void) MVGPrintf(wand,"translate %.20g %.20g\n",x,y);
}
# 6724 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) void DrawSetViewbox(DrawingWand *wand,const double x1,
  const double y1,const double x2,const double y2)
{
  
# 6727 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6727 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6727 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6727 "MagickWand/drawing-wand.c"
...
# 6727 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6727 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6727, __extension__ __PRETTY_FUNCTION__); }))
# 6727 "MagickWand/drawing-wand.c"
                                     ;
  
# 6728 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6728 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6728 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6728 "MagickWand/drawing-wand.c"
...
# 6728 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6728 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6728, __extension__ __PRETTY_FUNCTION__); }))
# 6728 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6730,"%s",wand->name);
  (void) MVGPrintf(wand,"viewbox %.20g %.20g %.20g %.20g\n",x1,y1,x2,y2);
}
# 6756 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsDrawingWand(const DrawingWand *wand)
{
  if (wand == (const DrawingWand *) 
# 6758 "MagickWand/drawing-wand.c" 3 4
                                   ((void *)0)
# 6758 "MagickWand/drawing-wand.c"
                                       )
    return(MagickFalse);
  if (wand->signature != 0xabacadabUL)
    return(MagickFalse);
  if (LocaleNCompare(wand->name,"DrawingWand",strlen("DrawingWand")) != 0)
    return(MagickFalse);
  return(MagickTrue);
}
# 6786 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) DrawingWand *NewDrawingWand(void)
{
  DrawingWand
    *wand;
  ...
  if (wand == (DrawingWand *) 
# 6793 "MagickWand/drawing-wand.c" 3 4
                             ((void *)0)
# 6793 "MagickWand/drawing-wand.c"
                                 )
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6794,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",GetExceptionMessage(
# 6794 "MagickWand/drawing-wand.c" 3 4
   (*__errno_location ())
# 6794 "MagickWand/drawing-wand.c"
   )); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                                 ;
  (void) memset(wand,0,sizeof(*wand));
  wand->id=AcquireWandId();
  (void) FormatLocaleString(wand->name,4096,"%s-%.20g",
    "DrawingWand",(double) wand->id);
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6801,"%s",wand->name);
  wand->mvg=(char *) 
# 6802 "MagickWand/drawing-wand.c" 3 4
                    ((void *)0)
# 6802 "MagickWand/drawing-wand.c"
                        ;
  wand->mvg_alloc=0;
  wand->mvg_length=0;
  wand->mvg_width=0;
  wand->pattern_id=(char *) 
# 6806 "MagickWand/drawing-wand.c" 3 4
                           ((void *)0)
# 6806 "MagickWand/drawing-wand.c"
                               ;
  wand->pattern_offset=0;
  wand->pattern_bounds.x=0;
  wand->pattern_bounds.y=0;
  ...
  wand->graphic_context=(DrawInfo **) AcquireMagickMemory(sizeof(
    *wand->graphic_context));
  if (wand->graphic_context == (DrawInfo **) 
# 6815 "MagickWand/drawing-wand.c" 3 4
                                            ((void *)0)
# 6815 "MagickWand/drawing-wand.c"
                                                )
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6816,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",GetExceptionMessage(
# 6816 "MagickWand/drawing-wand.c" 3 4
   (*__errno_location ())
# 6816 "MagickWand/drawing-wand.c"
   )); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                                 ;
  wand->filter_off=MagickTrue;
  wand->indent_depth=0;
  ...
  wand->image=AcquireImage((const ImageInfo *) 
# 6823 "MagickWand/drawing-wand.c" 3 4
                                              ((void *)0)
# 6823 "MagickWand/drawing-wand.c"
                                                  ,wand->exception);
  wand->destroy=MagickTrue;
  wand->debug=IsEventLogging();
  wand->signature=0xabacadabUL;
  (wand->graphic_context[wand->index])=CloneDrawInfo((ImageInfo *) 
# 6827 "MagickWand/drawing-wand.c" 3 4
                                            ((void *)0)
# 6827 "MagickWand/drawing-wand.c"
                                                ,(DrawInfo *) 
# 6827 "MagickWand/drawing-wand.c" 3 4
                                                              ((void *)0)
# 6827 "MagickWand/drawing-wand.c"
...
# 6853 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) DrawInfo *PeekDrawingWand(const DrawingWand *wand)
{
  DrawInfo
    *draw_info;

  
# 6858 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6858 "MagickWand/drawing-wand.c"
 wand != (const DrawingWand *) 
# 6858 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6858 "MagickWand/drawing-wand.c"
...
# 6858 "MagickWand/drawing-wand.c"
 "wand != (const DrawingWand *) NULL"
# 6858 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6858, __extension__ __PRETTY_FUNCTION__); }))
# 6858 "MagickWand/drawing-wand.c"
                                           ;
  
# 6859 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6859 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6859 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6859 "MagickWand/drawing-wand.c"
...
# 6859 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6859 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6859, __extension__ __PRETTY_FUNCTION__); }))
# 6859 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6861,"%s",wand->name);
  draw_info=CloneDrawInfo((ImageInfo *) 
# 6862 "MagickWand/drawing-wand.c" 3 4
                                       ((void *)0)
# 6862 "MagickWand/drawing-wand.c"
                                           ,(wand->graphic_context[wand->index]));
  (void) CloneString(&draw_info->primitive,wand->mvg);
  return(draw_info);
}
# 6892 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType PopDrawingWand(DrawingWand *wand)
{
  
# 6894 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6894 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6894 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6894 "MagickWand/drawing-wand.c"
...
# 6894 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6894 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6894, __extension__ __PRETTY_FUNCTION__); }))
# 6894 "MagickWand/drawing-wand.c"
                                     ;
  
# 6895 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6895 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6895 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6895 "MagickWand/drawing-wand.c"
...
# 6895 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6895 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6895, __extension__ __PRETTY_FUNCTION__); }))
# 6895 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6897,"%s",wand->name);
  if (wand->index == 0)
    {
      (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6900,DrawError,"UnbalancedGraphicContextPushPop","`%s'",wand->name);
      return(MagickFalse);
    }
# 6915 "MagickWand/drawing-wand.c"
  (wand->graphic_context[wand->index])=DestroyDrawInfo((wand->graphic_context[wand->index]));
  wand->index--;
  if (wand->indent_depth > 0)
    wand->indent_depth--;
...
# 6948 "MagickWand/drawing-wand.c"
__attribute__ ((visibility ("default"))) MagickBooleanType PushDrawingWand(DrawingWand *wand)
{
  
# 6950 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6950 "MagickWand/drawing-wand.c"
 wand != (DrawingWand *) 
# 6950 "MagickWand/drawing-wand.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 6950 "MagickWand/drawing-wand.c"
...
# 6950 "MagickWand/drawing-wand.c"
 "wand != (DrawingWand *) NULL"
# 6950 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6950, __extension__ __PRETTY_FUNCTION__); }))
# 6950 "MagickWand/drawing-wand.c"
                                     ;
  
# 6951 "MagickWand/drawing-wand.c" 3 4
 ((void) sizeof ((
# 6951 "MagickWand/drawing-wand.c"
 wand->signature == 0xabacadabUL
# 6951 "MagickWand/drawing-wand.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 6951 "MagickWand/drawing-wand.c"
...
# 6951 "MagickWand/drawing-wand.c"
 "wand->signature == MagickWandSignature"
# 6951 "MagickWand/drawing-wand.c" 3 4
 , "MagickWand/drawing-wand.c", 6951, __extension__ __PRETTY_FUNCTION__); }))
# 6951 "MagickWand/drawing-wand.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6953,"%s",wand->name);
  wand->index++;
  wand->graphic_context=(DrawInfo **) ResizeQuantumMemory(wand->graphic_context,
    (size_t) wand->index+1UL,sizeof(*wand->graphic_context));
  if (wand->graphic_context == (DrawInfo **) 
# 6957 "MagickWand/drawing-wand.c" 3 4
                                            ((void *)0)
# 6957 "MagickWand/drawing-wand.c"
                                                )
    {
      wand->index--;
      (void) ThrowMagickException( wand->exception,"MagickWand/drawing-wand.c",__func__,(unsigned long) 6960,ResourceLimitError,"MemoryAllocationFailed","`%s'",wand->name);
                   ;
      return(MagickFalse);
    }
  (wand->graphic_context[wand->index])=CloneDrawInfo((ImageInfo *) 
# 6964 "MagickWand/drawing-wand.c" 3 4
                                            ((void *)0)
# 6964 "MagickWand/drawing-wand.c"
                                                ,
