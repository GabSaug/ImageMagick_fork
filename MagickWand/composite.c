# 0 "MagickWand/composite.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/composite.c"
# 43 "MagickWand/composite.c"
...
# 46 "MagickWand/composite.c" 2
# 1 "./MagickCore/composite-private.h" 1
# 25 "./MagickCore/composite-private.h"
...
# 26 "./MagickCore/composite-private.h" 2
...
# 122 "MagickWand/composite.c" 3 4
 ((void) sizeof ((
# 122 "MagickWand/composite.c"
...
# 122 "MagickWand/composite.c" 3 4
 , "MagickWand/composite.c", 122, __extension__ __PRETTY_FUNCTION__); }))
# 122 "MagickWand/composite.c"
                                         ;
  
# 123 "MagickWand/composite.c" 3 4
 ((void) sizeof ((
# 123 "MagickWand/composite.c"
...
# 123 "MagickWand/composite.c" 3 4
 , "MagickWand/composite.c", 123, __extension__ __PRETTY_FUNCTION__); }))
# 123 "MagickWand/composite.c"
                                                     ;
  
# 124 "MagickWand/composite.c" 3 4
 ((void) sizeof ((
# 124 "MagickWand/composite.c"
 image != (Image **) 
# 124 "MagickWand/composite.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 124 "MagickWand/composite.c"
...
# 124 "MagickWand/composite.c"
 "image != (Image **) NULL"
# 124 "MagickWand/composite.c" 3 4
 , "MagickWand/composite.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "MagickWand/composite.c"
                                 ;
  
# 125 "MagickWand/composite.c" 3 4
 ((void) sizeof ((
# 125 "MagickWand/composite.c"
...
# 125 "MagickWand/composite.c" 3 4
 , "MagickWand/composite.c", 125, __extension__ __PRETTY_FUNCTION__); }))
# 125 "MagickWand/composite.c"
                                                   ;
  
# 126 "MagickWand/composite.c" 3 4
 ((void) sizeof ((
# 126 "MagickWand/composite.c"
...
# 126 "MagickWand/composite.c" 3 4
 , "MagickWand/composite.c", 126, __extension__ __PRETTY_FUNCTION__); }))
# 126 "MagickWand/composite.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickWand/composite.c",__func__,(unsigned long) 128,"%s",(*image)->filename);
  (void) image_info;
  status=MagickTrue;
  ...
  if (value != (const char *) 
# 134 "MagickWand/composite.c" 3 4
                             ((void *)0)
# 134 "MagickWand/composite.c"
                                 )
    composite_options->clip_to_self=IsStringTrue(value);
  value=GetImageOption(image_info,"compose:outside-overlay");
  if (value != (const char *) 
# 137 "MagickWand/composite.c" 3 4
                             ((void *)0)
# 137 "MagickWand/composite.c"
                                 )
    composite_options->clip_to_self=IsStringFalse(value);
  if (composite_image != (Image *) 
# 139 "MagickWand/composite.c" 3 4
                                  ((void *)0)
# 139 "MagickWand/composite.c"
                                      )
    {
      ChannelType
        channel_mask;
...
# 146 "MagickWand/composite.c" 3 4
     ((void) sizeof ((
# 146 "MagickWand/composite.c"
     composite_image->signature == 0xabacadabUL
# 146 "MagickWand/composite.c" 3 4
     ) ? 1 : 0), __extension__ ({ if (
# 146 "MagickWand/composite.c"
     composite_image->signature == 0xabacadabUL
...
# 146 "MagickWand/composite.c"
     "composite_image->signature == MagickCoreSignature"
# 146 "MagickWand/composite.c" 3 4
     , "MagickWand/composite.c", 146, __extension__ __PRETTY_FUNCTION__); }))
# 146 "MagickWand/composite.c"
                                                              ;
      ...
      if (composite_options->stegano != 0)
        {
          ...
          if (stegano_image != (Image *) 
# 176 "MagickWand/composite.c" 3 4
                                        ((void *)0)
# 176 "MagickWand/composite.c"
                                            )
            {
        ...
        if (composite_options->stereo != MagickFalse)
          {
            ...
            stereo_image=StereoAnaglyphImage(*image,composite_image,
              ...
              exception);
            if (stereo_image != (Image *) 
# 191 "MagickWand/composite.c" 3 4
                                         ((void *)0)
# 191 "MagickWand/composite.c"
                                             )
              {
                *image=DestroyImageList(*image);
                *image=stereo_image;
          ...
          if (composite_options->tile != MagickFalse)
          ...
          else
            {
              ...
              if (mask_image == (Image *) 
# 236 "MagickWand/composite.c" 3 4
                                         ((void *)0)
# 236 "MagickWand/composite.c"
                                             )
                status&=(MagickStatusType) CompositeImage(*image,
...
# 247 "MagickWand/composite.c" 3 4
                                              ((void *)0)
# 247 "MagickWand/composite.c"
                                                  )
                    {
                      status&=(MagickStatusType) CompositeImage(*image,
                        composite_image,composite_options->compose,
...
static MagickBooleanType CompositeUsage(void)
{
  ...
  ListMagickVersion(
# 368 "MagickWand/composite.c" 3 4
                   stdout
# 368 "MagickWand/composite.c"
                         );
...
{
  if (composite_options->compose_args != (char *) 
# 403 "MagickWand/composite.c" 3 4
                                                 ((void *)0)
# 403 "MagickWand/composite.c"
                                                     )
    composite_options->compose_args=(char *)
      RelinquishMagickMemory(composite_options->compose_args);
  if (composite_options->geometry != (char *) 
# 406 "MagickWand/composite.c" 3 4
                                             ((void *)0)
# 406 "MagickWand/composite.c"
                                                 )
    composite_options->geometry=(char *)
      RelinquishMagickMemory(composite_options->geometry);
}

__attribute__ ((visibility ("default"))) MagickBooleanType CompositeImageCommand(ImageInfo *image_info,
  int argc,char **argv,char **metadata,ExceptionInfo *exception)
{
# 438 "MagickWand/composite.c"
  char
    *filename,
    *option;
...
# 475 "MagickWand/composite.c" 3 4
 ((void) sizeof ((
# 475 "MagickWand/composite.c"
 image_info != (ImageInfo *) 
# 475 "MagickWand/composite.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 475 "MagickWand/composite.c"
...
# 475 "MagickWand/composite.c"
 "image_info != (ImageInfo *) NULL"
# 475 "MagickWand/composite.c" 3 4
 , "MagickWand/composite.c", 475, __extension__ __PRETTY_FUNCTION__); }))
# 475 "MagickWand/composite.c"
                                         ;
  
# 476 "MagickWand/composite.c" 3 4
 ((void) sizeof ((
# 476 "MagickWand/composite.c"
 image_info->signature == 0xabacadabUL
# 476 "MagickWand/composite.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 476 "MagickWand/composite.c"
...
# 476 "MagickWand/composite.c"
 "image_info->signature == MagickCoreSignature"
# 476 "MagickWand/composite.c" 3 4
 , "MagickWand/composite.c", 476, __extension__ __PRETTY_FUNCTION__); }))
# 476 "MagickWand/composite.c"
                                                     ;
  
# 477 "MagickWand/composite.c" 3 4
 ((void) sizeof ((
# 477 "MagickWand/composite.c"
 exception != (ExceptionInfo *) 
# 477 "MagickWand/composite.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 477 "MagickWand/composite.c"
...
# 477 "MagickWand/composite.c"
 "exception != (ExceptionInfo *) NULL"
# 477 "MagickWand/composite.c" 3 4
 , "MagickWand/composite.c", 477, __extension__ __PRETTY_FUNCTION__); }))
# 477 "MagickWand/composite.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickWand/composite.c",__func__,(unsigned long) 479,"...");
  if (argc == 2)
    {
      option=argv[1];
      if ((LocaleCompare("version",option+1) == 0) ||
        ...
        {
          ListMagickVersion(
# 486 "MagickWand/composite.c" 3 4
                           stdout
# 486 "MagickWand/composite.c"
                                 );
          return(MagickTrue);
        }
    }
  if (argc < 4)
    {
      (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 492,OptionError,
        "MissingArgument","%s","");
      (void) CompositeUsage();
      return(MagickFalse);
    }
  ...
  filename=(char *) 
# 498 "MagickWand/composite.c" 3 4
                   ((void *)0)
# 498 "MagickWand/composite.c"
                       ;
  format="%w,%h,%m";
  j=1;
  k=0;
  ...
  option=(char *) 
# 503 "MagickWand/composite.c" 3 4
                 ((void *)0)
# 503 "MagickWand/composite.c"
                     ;
  pend=MagickFalse;
  ...
  if (status == MagickFalse)
    { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 516,ResourceLimitError,"MemoryAllocationFailed","`%s'", GetExceptionMessage(
# 516 "MagickWand/composite.c" 3 4
   (*__errno_location ())
# 516 "MagickWand/composite.c"
   ) == (char *) 
# 516 "MagickWand/composite.c" 3 4
   ((void *)0) 
# 516 "MagickWand/composite.c"
...
# 523 "MagickWand/composite.c" 3 4
       ((void *)0)
# 523 "MagickWand/composite.c"
        ...
        if (k == 128)
          { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 525,OptionError,"ParenthesisNestedTooDeeply","`%s'", option == (char *) 
# 525 "MagickWand/composite.c" 3 4
         ((void *)0) 
# 525 "MagickWand/composite.c"
         ? GetExceptionMessage(
# 525 "MagickWand/composite.c" 3 4
         (*__errno_location ())
# 525 "MagickWand/composite.c"
         ) : option); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                   ;
    ...
    if (LocaleCompare(option,")") == 0)
      {
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 532 "MagickWand/composite.c" 3 4
       ((void *)0)
# 532 "MagickWand/composite.c"
        ...
        if (k == 0)
          { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 534,OptionError,"UnableToParseExpression","`%s'", option == (char *) 
# 534 "MagickWand/composite.c" 3 4
         ((void *)0) 
# 534 "MagickWand/composite.c"
         ? GetExceptionMessage(
# 534 "MagickWand/composite.c" 3 4
         (*__errno_location ())
# 534 "MagickWand/composite.c"
    ...
    if (IsCommandOption(option) == MagickFalse)
      {
        ...
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 543 "MagickWand/composite.c" 3 4
       ((void *)0)
# 543 "MagickWand/composite.c"
...
# 548 "MagickWand/composite.c" 3 4
                                                       ((void *)0)
# 548 "MagickWand/composite.c"
                                                           ) &&
          (exception->severity < ErrorException);
        if (images == (Image *) 
# 550 "MagickWand/composite.c" 3 4
                               ((void *)0)
# 550 "MagickWand/composite.c"
                                   )
          continue;
    ...
    pend=image != (Image *) 
# 555 "MagickWand/composite.c" 3 4
                           ((void *)0) 
# 555 "MagickWand/composite.c"
        ...
        if (LocaleCompare("affine",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 566,OptionError,"MissingArgument","`%s'", option == (char *) 
# 566 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 566 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 566 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 566 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 568,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("alpha",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 580,OptionError,"MissingArgument","`%s'", option == (char *) 
# 580 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 580 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 580 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 580 "MagickWand/composite.c"
            ...
            if (type < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 583,OptionError,"UnrecognizedAlphaChannelOption","`%s'", argv[i] == (char *) 
# 583 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 583 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 583 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 583 "MagickWand/composite.c"
             ) : argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); }
                                                         ;
            break;
          }
        if (LocaleCompare("authenticate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 593,OptionError,"MissingArgument","`%s'", option == (char *) 
# 593 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 593 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 593 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 593 "MagickWand/composite.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 596,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 596 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 596 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 596 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 596 "MagickWand/composite.c"
        ...
        if (LocaleCompare("background",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 606,OptionError,"MissingArgument","`%s'", option == (char *) 
# 606 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 606 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 606 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 606 "MagickWand/composite.c"
        ...
        if (LocaleCompare("blend",option+1) == 0)
          {
            (void) CloneString(&composite_options.compose_args,(char *) 
# 611 "MagickWand/composite.c" 3 4
                                                                       ((void *)0)
# 611 "MagickWand/composite.c"
                                                                           );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 616,OptionError,"MissingArgument","`%s'", option == (char *) 
# 616 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 616 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 616 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 616 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 618,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
        ...
        if (LocaleCompare("blur",option+1) == 0)
          {
            (void) CloneString(&composite_options.compose_args,(char *) 
# 625 "MagickWand/composite.c" 3 4
                                                                       ((void *)0)
# 625 "MagickWand/composite.c"
                                                                           );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 630,OptionError,"MissingArgument","`%s'", option == (char *) 
# 630 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 630 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 630 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 630 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 632,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            (void) CloneString(&composite_options.compose_args,argv[i]);
        ...
        if (LocaleCompare("blue-primary",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 643,OptionError,"MissingArgument","`%s'", option == (char *) 
# 643 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 643 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 643 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 643 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 645,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("border",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 654,OptionError,"MissingArgument","`%s'", option == (char *) 
# 654 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 654 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 654 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 654 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 656,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("bordercolor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 665,OptionError,"MissingArgument","`%s'", option == (char *) 
# 665 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 665 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 665 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 665 "MagickWand/composite.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 668,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 668 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 668 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 668 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 668 "MagickWand/composite.c"
        ...
        if (LocaleCompare("cache",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 678,OptionError,"MissingArgument","`%s'", option == (char *) 
# 678 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 678 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 678 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 678 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 680,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("channel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 695,OptionError,"MissingArgument","`%s'", option == (char *) 
# 695 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 695 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 695 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 695 "MagickWand/composite.c"
            ...
            if (channel < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 698,OptionError,"UnrecognizedChannelType","`%s'", argv[i] == (char *) 
# 698 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 698 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 698 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 698 "MagickWand/composite.c"
        ...
        if (LocaleCompare("colors",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 709,OptionError,"MissingArgument","`%s'", option == (char *) 
# 709 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 709 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 709 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 709 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 711,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("colorspace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 723,OptionError,"MissingArgument","`%s'", option == (char *) 
# 723 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 723 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 723 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 723 "MagickWand/composite.c"
            ...
            colorspace=ParseCommandOption(MagickColorspaceOptions,
              MagickFalse,argv[i]);
            if (colorspace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 727,OptionError,"UnrecognizedColorspace","`%s'", argv[i] == (char *) 
# 727 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 727 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 727 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 727 "MagickWand/composite.c"
        ...
        if (LocaleCompare("comment",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 737,OptionError,"MissingArgument","`%s'", option == (char *) 
# 737 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 737 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 737 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 737 "MagickWand/composite.c"
        ...
        if (LocaleCompare("compose",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 750,OptionError,"MissingArgument","`%s'", option == (char *) 
# 750 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 750 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 750 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 750 "MagickWand/composite.c"
            ...
            compose=ParseCommandOption(MagickComposeOptions,MagickFalse,
              argv[i]);
            if (compose < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 754,OptionError,"UnrecognizedComposeOperator","`%s'", argv[i] == (char *) 
# 754 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 754 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 754 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 754 "MagickWand/composite.c"
        ...
        if (LocaleCompare("compress",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 768,OptionError,"MissingArgument","`%s'", option == (char *) 
# 768 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 768 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 768 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 768 "MagickWand/composite.c"
            ...
            compress=ParseCommandOption(MagickCompressOptions,MagickFalse,
              argv[i]);
            if (compress < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 772,OptionError,"UnrecognizedImageCompression","`%s'", argv[i] == (char *) 
# 772 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 772 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 772 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 772 "MagickWand/composite.c"
        ...
        if (LocaleCompare("concurrent",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 778,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 778 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 778 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 778 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 778 "MagickWand/composite.c"
        ...
        if (LocaleCompare("debug",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 791,OptionError,"MissingArgument","`%s'", option == (char *) 
# 791 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 791 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 791 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 791 "MagickWand/composite.c"
            ...
            if (event < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 794,OptionError,"UnrecognizedEventType","`%s'", argv[i] == (char *) 
# 794 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 794 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 794 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 794 "MagickWand/composite.c"
        ...
        if (LocaleCompare("decipher",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 805,OptionError,"MissingArgument","`%s'", option == (char *) 
# 805 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 805 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 805 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 805 "MagickWand/composite.c"
        ...
        if (LocaleCompare("define",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 812,OptionError,"MissingArgument","`%s'", option == (char *) 
# 812 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 812 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 812 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 812 "MagickWand/composite.c"
...
# 819 "MagickWand/composite.c" 3 4
                                            ((void *)0)
# 819 "MagickWand/composite.c"
                                                )
                  { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 820,OptionError,"NoSuchOption","`%s'", argv[i] == (char *) 
# 820 "MagickWand/composite.c" 3 4
                 ((void *)0) 
# 820 "MagickWand/composite.c"
                 ? GetExceptionMessage(
# 820 "MagickWand/composite.c" 3 4
                 (*__errno_location ())
# 820 "MagickWand/composite.c"
        ...
        if (LocaleCompare("density",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 831,OptionError,"MissingArgument","`%s'", option == (char *) 
# 831 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 831 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 831 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 831 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 833,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("depth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 842,OptionError,"MissingArgument","`%s'", option == (char *) 
# 842 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 842 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 842 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 842 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 844,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("displace",option+1) == 0)
          {
            (void) CloneString(&composite_options.compose_args,(char *) 
# 849 "MagickWand/composite.c" 3 4
                                                                       ((void *)0)
# 849 "MagickWand/composite.c"
                                                                           );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 854,OptionError,"MissingArgument","`%s'", option == (char *) 
# 854 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 854 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 854 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 854 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 856,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            (void) CloneString(&composite_options.compose_args,argv[i]);
        ...
        if (LocaleCompare("display",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 867,OptionError,"MissingArgument","`%s'", option == (char *) 
# 867 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 867 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 867 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 867 "MagickWand/composite.c"
        ...
        if (LocaleCompare("dispose",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 879,OptionError,"MissingArgument","`%s'", option == (char *) 
# 879 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 879 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 879 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 879 "MagickWand/composite.c"
            ...
            if (dispose < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 882,OptionError,"UnrecognizedDisposeMethod","`%s'", argv[i] == (char *) 
# 882 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 882 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 882 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 882 "MagickWand/composite.c"
        ...
        if (LocaleCompare("dissolve",option+1) == 0)
          {
            (void) CloneString(&composite_options.compose_args,(char *) 
# 888 "MagickWand/composite.c" 3 4
                                                                       ((void *)0)
# 888 "MagickWand/composite.c"
                                                                           );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 893,OptionError,"MissingArgument","`%s'", option == (char *) 
# 893 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 893 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 893 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 893 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 895,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            (void) CloneString(&composite_options.compose_args,argv[i]);
        ...
        if (LocaleCompare("distort",option+1) == 0)
          {
            (void) CloneString(&composite_options.compose_args,(char *) 
# 902 "MagickWand/composite.c" 3 4
                                                                       ((void *)0)
# 902 "MagickWand/composite.c"
                                                                           );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 907,OptionError,"MissingArgument","`%s'", option == (char *) 
# 907 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 907 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 907 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 907 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 909,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            (void) CloneString(&composite_options.compose_args,argv[i]);
        ...
        if (LocaleCompare("dither",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 923,OptionError,"MissingArgument","`%s'", option == (char *) 
# 923 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 923 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 923 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 923 "MagickWand/composite.c"
            ...
            if (method < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 926,OptionError,"UnrecognizedDitherMethod","`%s'", argv[i] == (char *) 
# 926 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 926 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 926 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 926 "MagickWand/composite.c"
        ...
        if (LocaleCompare("duration",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 936,OptionError,"MissingArgument","`%s'", option == (char *) 
# 936 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 936 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 936 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 936 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 938,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 941,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 941 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 941 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 941 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 941 "MagickWand/composite.c"
        ...
        if (LocaleCompare("encipher",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 951,OptionError,"MissingArgument","`%s'", option == (char *) 
# 951 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 951 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 951 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 951 "MagickWand/composite.c"
        ...
        if (LocaleCompare("encoding",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 960,OptionError,"MissingArgument","`%s'", option == (char *) 
# 960 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 960 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 960 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 960 "MagickWand/composite.c"
        ...
        if (LocaleCompare("endian",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 972,OptionError,"MissingArgument","`%s'", option == (char *) 
# 972 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 972 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 972 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 972 "MagickWand/composite.c"
            ...
            endian=ParseCommandOption(MagickEndianOptions,MagickFalse,
              argv[i]);
            if (endian < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 976,OptionError,"UnrecognizedEndianType","`%s'", argv[i] == (char *) 
# 976 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 976 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 976 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 976 "MagickWand/composite.c"
        ...
        if (LocaleCompare("extract",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 986,OptionError,"MissingArgument","`%s'", option == (char *) 
# 986 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 986 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 986 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 986 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 988,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 991,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 991 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 991 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 991 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 991 "MagickWand/composite.c"
        ...
        if (LocaleCompare("filter",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1004,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1004 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1004 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1004 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1004 "MagickWand/composite.c"
            ...
            if (filter < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1007,OptionError,"UnrecognizedImageFilter","`%s'", argv[i] == (char *) 
# 1007 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1007 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1007 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1007 "MagickWand/composite.c"
        ...
        if (LocaleCompare("font",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1017,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1017 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1017 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1017 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1017 "MagickWand/composite.c"
        ...
        if (LocaleCompare("format",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1026,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1026 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1026 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1026 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1026 "MagickWand/composite.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1030,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1030 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1030 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1030 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1030 "MagickWand/composite.c"
      ...
      case 'g':
      {
        if (LocaleCompare("geometry",option+1) == 0)
          {
            (void) CloneString(&composite_options.geometry,(char *) 
# 1036 "MagickWand/composite.c" 3 4
                                                                   ((void *)0)
# 1036 "MagickWand/composite.c"
                                                                       );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1041,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1041 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1041 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1041 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1041 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1043,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
        ...
        if (LocaleCompare("gravity",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1057,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1057 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1057 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1057 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1057 "MagickWand/composite.c"
            ...
            gravity=ParseCommandOption(MagickGravityOptions,MagickFalse,
              argv[i]);
            if (gravity < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1061,OptionError,"UnrecognizedGravityType","`%s'", argv[i] == (char *) 
# 1061 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1061 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1061 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1061 "MagickWand/composite.c"
        ...
        if (LocaleCompare("green-primary",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1072,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1072 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1072 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1072 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1072 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1074,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1077,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1077 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1077 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1077 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1077 "MagickWand/composite.c"
      ...
      case 'h':
      {
        ...
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1087,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1087 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1087 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1087 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1087 "MagickWand/composite.c"
        ...
        if (LocaleCompare("interlace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1102,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1102 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1102 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1102 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1102 "MagickWand/composite.c"
            ...
            interlace=ParseCommandOption(MagickInterlaceOptions,MagickFalse,
              argv[i]);
            if (interlace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1106,OptionError,"UnrecognizedInterlaceType","`%s'", argv[i] == (char *) 
# 1106 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1106 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1106 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1106 "MagickWand/composite.c"
        ...
        if (LocaleCompare("interpolate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1119,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1119 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1119 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1119 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1119 "MagickWand/composite.c"
            ...
            interpolate=ParseCommandOption(MagickInterpolateOptions,MagickFalse,
              argv[i]);
            if (interpolate < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1123,OptionError,"UnrecognizedInterpolateMethod","`%s'", argv[i] == (char *) 
# 1123 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1123 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1123 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1123 "MagickWand/composite.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1127,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1127 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1127 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1127 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1127 "MagickWand/composite.c"
        ...
        if (LocaleCompare("label",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1137,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1137 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1137 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1137 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1137 "MagickWand/composite.c"
        ...
        if (LocaleCompare("limit",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1155,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1155 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1155 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1155 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1155 "MagickWand/composite.c"
            ...
            resource=ParseCommandOption(MagickResourceOptions,MagickFalse,
              argv[i]);
            if (resource < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1159,OptionError,"UnrecognizedResourceType","`%s'", argv[i] == (char *) 
# 1159 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1159 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1159 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1159 "MagickWand/composite.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1163,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1163 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1163 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1163 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1163 "MagickWand/composite.c"
            ...
            if ((p == argv[i]) && (LocaleCompare("unlimited",argv[i]) != 0))
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1167,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("list",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1179,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1179 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1179 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1179 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1179 "MagickWand/composite.c"
            ...
            if (list < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1182,OptionError,"UnrecognizedListType","`%s'", argv[i] == (char *) 
# 1182 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1182 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1182 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1182 "MagickWand/composite.c"
        ...
        if (LocaleCompare("log",option+1) == 0)
          {
            if (*option == '+')
              break;
            i++;
            if ((i == (ssize_t) argc) || (strchr(argv[i],'%') == (char *) 
# 1194 "MagickWand/composite.c" 3 4
                                                                         ((void *)0)
# 1194 "MagickWand/composite.c"
                                                                             ))
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1195,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1195 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1195 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1195 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1195 "MagickWand/composite.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1198,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1198 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1198 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1198 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1198 "MagickWand/composite.c"
      ...
      case 'm':
      {
        ...
        if (LocaleCompare("monochrome",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1208,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1208 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1208 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1208 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1208 "MagickWand/composite.c"
      ...
      case 'n':
      {
        ...
        if (LocaleCompare("noop",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1216,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1216 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1216 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1216 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1216 "MagickWand/composite.c"
        ...
        if (LocaleCompare("page",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1226,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1226 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1226 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1226 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1226 "MagickWand/composite.c"
        ...
        if (LocaleCompare("pointsize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1235,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1235 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1235 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1235 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1235 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1237,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("process",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1246,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1246 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1246 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1246 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1246 "MagickWand/composite.c"
        ...
        if (LocaleCompare("profile",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1253,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1253 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1253 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1253 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1253 "MagickWand/composite.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1256,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1256 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1256 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1256 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1256 "MagickWand/composite.c"
        ...
        if (LocaleCompare("quality",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1266,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1266 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1266 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1266 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1266 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1268,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("quantize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1280,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1280 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1280 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1280 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1280 "MagickWand/composite.c"
            ...
            colorspace=ParseCommandOption(MagickColorspaceOptions,
              MagickFalse,argv[i]);
            if (colorspace < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1284,OptionError,"UnrecognizedColorspace","`%s'", argv[i] == (char *) 
# 1284 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1284 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1284 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1284 "MagickWand/composite.c"
        ...
        if (LocaleCompare("quiet",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1290,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1290 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1290 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1290 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1290 "MagickWand/composite.c"
        ...
        if (LocaleCompare("red-primary",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1300,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1300 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1300 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1300 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1300 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1302,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        ...
        if (LocaleCompare("repage",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1315,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1315 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1315 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1315 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1315 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1317,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        ...
        if (LocaleCompare("resize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1331,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1331 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1331 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1331 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1331 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1333,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("rotate",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1340,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1340 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1340 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1340 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1340 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1342,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1345,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1345 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1345 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1345 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1345 "MagickWand/composite.c"
        ...
        if (LocaleCompare("sampling-factor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1355,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1355 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1355 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1355 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1355 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1357,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("scene",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1366,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1366 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1366 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1366 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1366 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1368,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("seed",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1377,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1377 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1377 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1377 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1377 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1379,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("sharpen",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1386,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1386 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1386 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1386 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1386 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1388,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("shave",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1397,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1397 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1397 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1397 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1397 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1399,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("size",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1408,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1408 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1408 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1408 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1408 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1410,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("stegano",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1420,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1420 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1420 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1420 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1420 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1422,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
        ...
        if (LocaleCompare("stereo",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1436,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1436 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1436 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1436 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1436 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1438,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
        ...
        if (LocaleCompare("swap",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1458,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1458 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1458 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1458 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1458 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1460,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("synchronize",option+1) == 0)
          break;
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1465,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1465 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1465 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1465 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1465 "MagickWand/composite.c"
        ...
        if (LocaleCompare("thumbnail",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1477,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1477 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1477 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1477 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1477 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1479,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        ...
        if (LocaleCompare("transparent-color",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1496,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1496 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1496 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1496 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1496 "MagickWand/composite.c"
        ...
        if (LocaleCompare("treedepth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1505,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1505 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1505 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1505 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1505 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1507,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("type",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1519,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1519 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1519 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1519 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1519 "MagickWand/composite.c"
            ...
            if (type < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1522,OptionError,"UnrecognizedImageType","`%s'", argv[i] == (char *) 
# 1522 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1522 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1522 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1522 "MagickWand/composite.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1526,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1526 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1526 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1526 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1526 "MagickWand/composite.c"
        ...
        if (LocaleCompare("units",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1539,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1539 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1539 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1539 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1539 "MagickWand/composite.c"
            ...
            units=ParseCommandOption(MagickResolutionOptions,MagickFalse,
              argv[i]);
            if (units < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1543,OptionError,"UnrecognizedUnitsType","`%s'", argv[i] == (char *) 
# 1543 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1543 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1543 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1543 "MagickWand/composite.c"
        ...
        if (LocaleCompare("unsharp",option+1) == 0)
          {
            (void) CloneString(&composite_options.compose_args,(char *) 
# 1549 "MagickWand/composite.c" 3 4
                                                                       ((void *)0)
# 1549 "MagickWand/composite.c"
                                                                           );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1554,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1554 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1554 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1554 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1554 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1556,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            (void) CloneString(&composite_options.compose_args,argv[i]);
            composite_options.compose=ThresholdCompositeOp;
            break;
          }
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1561,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1561 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1561 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1561 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1561 "MagickWand/composite.c"
      ...
      case 'v':
      {
        ...
        if ((LocaleCompare("version",option+1) == 0) ||
          ...
          {
            ListMagickVersion(
# 1570 "MagickWand/composite.c" 3 4
                             stdout
# 1570 "MagickWand/composite.c"
                                   );
            break;
          }
        if (LocaleCompare("virtual-pixel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1582,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1582 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1582 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1582 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1582 "MagickWand/composite.c"
            ...
            method=ParseCommandOption(MagickVirtualPixelOptions,MagickFalse,
              argv[i]);
            if (method < 0)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1586,OptionError,"UnrecognizedVirtualPixelMethod","`%s'", argv[i] == (char *) 
# 1586 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1586 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1586 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1586 "MagickWand/composite.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1590,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1590 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1590 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1590 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1590 "MagickWand/composite.c"
      ...
      case 'w':
      {
        if (LocaleCompare("watermark",option+1) == 0)
          {
            (void) CloneString(&composite_options.compose_args,(char *) 
# 1596 "MagickWand/composite.c" 3 4
                                                                       ((void *)0)
# 1596 "MagickWand/composite.c"
                                                                           );
            if (*option == '+')
              break;
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1601,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1601 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1601 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1601 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1601 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1603,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            (void) CloneString(&composite_options.compose_args,argv[i]);
        ...
        if (LocaleCompare("white-point",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1614,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1614 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1614 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1614 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1614 "MagickWand/composite.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1616,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
            break;
          }
        if (LocaleCompare("write",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1623,OptionError,"MissingArgument","`%s'", option == (char *) 
# 1623 "MagickWand/composite.c" 3 4
             ((void *)0) 
# 1623 "MagickWand/composite.c"
             ? GetExceptionMessage(
# 1623 "MagickWand/composite.c" 3 4
             (*__errno_location ())
# 1623 "MagickWand/composite.c"
        ...
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1626,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1626 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1626 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1626 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1626 "MagickWand/composite.c"
      ...
      case '?':
        break;
      default:
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1631,OptionError,"UnrecognizedOption","`%s'", option == (char *) 
# 1631 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1631 "MagickWand/composite.c"
       ? GetExceptionMessage(
# 1631 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1631 "MagickWand/composite.c"
    ...
    if (fire != MagickFalse)
      if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 1636 "MagickWand/composite.c" 3 4
     ((void *)0)
# 1636 "MagickWand/composite.c"
     ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickFalse,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
  }
  if (k != 0)
    { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1639,OptionError,"UnbalancedParenthesis","`%s'", argv[i] == (char *) 
# 1639 "MagickWand/composite.c" 3 4
   ((void *)0) 
# 1639 "MagickWand/composite.c"
   ? GetExceptionMessage(
# 1639 "MagickWand/composite.c" 3 4
   (*__errno_location ())
# 1639 "MagickWand/composite.c"
  ...
  if (i-- != (ssize_t) (argc-1))
    { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1641,OptionError,"MissingAnImageFilename","`%s'", argv[i] == (char *) 
# 1641 "MagickWand/composite.c" 3 4
   ((void *)0) 
# 1641 "MagickWand/composite.c"
   ? GetExceptionMessage(
# 1641 "MagickWand/composite.c" 3 4
   (*__errno_location ())
# 1641 "MagickWand/composite.c"
  ...
  if ((image == (Image *) 
# 1642 "MagickWand/composite.c" 3 4
                         ((void *)0)
# 1642 "MagickWand/composite.c"
                             ) || (GetImageListLength(image) < 2))
    { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1643,OptionError,"MissingAnImageFilename","`%s'", argv[argc-1] == (char *) 
# 1643 "MagickWand/composite.c" 3 4
   ((void *)0) 
# 1643 "MagickWand/composite.c"
   ? GetExceptionMessage(
# 1643 "MagickWand/composite.c" 3 4
   (*__errno_location ())
# 1643 "MagickWand/composite.c"
   ) : argv[argc-1]); { RelinquishCompositeOptions(&composite_options); { while (k > 0) { if (respect_parenthesis == MagickFalse) { image_stack[k-1].image_info=DestroyImageInfo(image_stack[k-1].image_info); image_stack[k-1].image_info=CloneImageInfo(image_stack[k].image_info); } image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); AppendImageToList(&image_stack[k-1].image,image_stack[k].image); k--; image_info=image_stack[k].image_info; image=image_stack[k].image; }; image_stack[k].image=DestroyImageList(image_stack[k].image); image_stack[k].image_info=DestroyImageInfo(image_stack[k].image_info); image_info=image_stack[128].image_info; }; for (i=0; i < (ssize_t) argc; i++) argv[i]=DestroyString(argv[i]); argv=(char **) RelinquishMagickMemory(argv); }; return(MagickFalse); };
  { if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 1644 "MagickWand/composite.c" 3 4
 ((void *)0)
# 1644 "MagickWand/composite.c"
...
# 1644 "MagickWand/composite.c"
  ...
  if ((image == (Image *) 
# 1645 "MagickWand/composite.c" 3 4
                         ((void *)0)
# 1645 "MagickWand/composite.c"
                             ) || (GetImageListLength(image) < 2))
    { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1646,OptionError,"MissingAnImageFilename","`%s'", argv[argc-1] == (char *) 
# 1646 "MagickWand/composite.c" 3 4
   ((void *)0) 
# 1646 "MagickWand/composite.c"
   ? GetExceptionMessage(
# 1646 "MagickWand/composite.c" 3 4
   (*__errno_location ())
# 1646 "MagickWand/composite.c"
  ...
  { composite_image=RemoveFirstImageFromList(&image_stack[k].image); image=image_stack[k].image; };
  { images=RemoveFirstImageFromList(&image_stack[k].image); image=image_stack[k].image; };
  if (composite_image->geometry != (char *) 
# 1652 "MagickWand/composite.c" 3 4
                                           ((void *)0)
# 1652 "MagickWand/composite.c"
                                               )
    {
      RectangleInfo
        resize_geometry;
...
# 1667 "MagickWand/composite.c" 3 4
                                       ((void *)0)
# 1667 "MagickWand/composite.c"
                                           )
            {
  ...
  { mask_image=RemoveFirstImageFromList(&image_stack[k].image); image=image_stack[k].image; };
  ...
  status&=(MagickStatusType) WriteImages(image_info,images,argv[argc-1],
    exception);
  if (metadata != (char **) 
# 1683 "MagickWand/composite.c" 3 4
                           ((void *)0)
# 1683 "MagickWand/composite.c"
                               )
    {
      char
        *text;
      ...
      if (text == (char *) 
# 1689 "MagickWand/composite.c" 3 4
                          ((void *)0)
# 1689 "MagickWand/composite.c"
                              )
        { (void) ThrowMagickException(exception,"MagickWand/composite.c",__func__,(unsigned long) 1690,ResourceLimitError,"MemoryAllocationFailed","`%s'", GetExceptionMessage(
# 1690 "MagickWand/composite.c" 3 4
       (*__errno_location ())
# 1690 "MagickWand/composite.c"
       ) == (char *) 
# 1690 "MagickWand/composite.c" 3 4
       ((void *)0) 
# 1690 "MagickWand/composite.c"
