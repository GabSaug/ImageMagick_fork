# 0 "MagickWand/operation.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/operation.c"
# 53 "MagickWand/operation.c"
...
# 59 "MagickWand/operation.c" 2

# 1 "./MagickWand/wandcli-private.h" 1
# 60 "./MagickWand/wandcli-private.h"
typedef enum
{

  ProcessImplicitRead = 0x0001,



  ProcessInterpretProperties = 0x0010,
...
# 62 "MagickWand/operation.c" 2
# 1 "./MagickCore/composite-private.h" 1
# 35 "./MagickCore/composite-private.h"
  ...
  const double q,const double beta)
{
  ...
  Sa=((double) 1.0/(double) ((Quantum) 65535.0))*alpha;
  Da=((double) 1.0/(double) ((Quantum) 65535.0))*beta;
  ...
  const double alpha,const Quantum *q,const double beta,Quantum *composite)
{
  ...
  for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
  {
    ...
    switch (channel)
    {
      ...
      case AlphaPixelChannel:
      {
        composite[i]=ClampToQuantum((double) ((Quantum) 65535.0)*
  ...
  const PixelInfo *q,const double beta,PixelInfo *composite)
{
  ...
  Da=((double) 1.0/(double) ((Quantum) 65535.0))*beta,
  gamma=Sa+Da-Sa*Da;
  composite->alpha=(double) ((Quantum) 65535.0)*RoundToUnity(gamma);
  gamma=PerceptibleReciprocal(gamma);
...
{
  if (GetImageArtifact(image,"compose:clamp") == (const char *) 
# 192 "./MagickCore/composite-private.h" 3 4
                                                               ((void *)0)
# 192 "./MagickCore/composite-private.h"
                                                                   )
...
# 63 "MagickWand/operation.c" 2
# 1 "./MagickCore/geometry-private.h" 1
# 25 "./MagickCore/geometry-private.h"
extern __attribute__ ((visibility ("default"))) MagickBooleanType
  ListPagesizes(FILE *,ExceptionInfo *);
# 64 "MagickWand/operation.c" 2
...
# 67 "MagickWand/operation.c" 2
# 1 "./MagickCore/thread-private.h" 1
# 24 "./MagickCore/thread-private.h"
...
# 69 "MagickWand/operation.c" 2




static const char
  MogrifyAlphaColor[] = "#bdbdbd",
  MogrifyBackgroundColor[] = "#fff",
  MogrifyBorderColor[] = "#dfdfdf";
# 96 "MagickWand/operation.c"
static MagickBooleanType MonitorProgress(const char *text,
  const MagickOffsetType offset,const MagickSizeType extent,
  void *wand_unused_client_data __attribute__((unused)))
{
  char
    message[4096],
    tag[4096];
  ...
  (void) CopyMagickString(tag,text == (const char *) 
# 112 "MagickWand/operation.c" 3 4
                                                    ((void *)0) 
# 112 "MagickWand/operation.c"
                                                         ? "null" : text,
    4096);
  p=strrchr(tag,'/');
  if (p != (char *) 
# 115 "MagickWand/operation.c" 3 4
                   ((void *)0)
# 115 "MagickWand/operation.c"
                       )
    *p='\0';
  (void) FormatLocaleString(message,4096,"Monitor/%s",tag);
  locale_message=GetLocaleMessage(message);
  if (locale_message == message)
    locale_message=tag;
  if (p == (char *) 
# 121 "MagickWand/operation.c" 3 4
                   ((void *)0)
# 121 "MagickWand/operation.c"
                       )
    (void) FormatLocaleFile(
# 122 "MagickWand/operation.c" 3 4
                           stderr
# 122 "MagickWand/operation.c"
    ...
    (void) FormatLocaleFile(
# 126 "MagickWand/operation.c" 3 4
                           stderr
# 126 "MagickWand/operation.c"
                                 ,"%s[%s]: %ld of %lu, %02ld%% complete\r",
      locale_message,p+1,(long) offset,(unsigned long) extent,(long)
      (100.0*offset*PerceptibleReciprocal(extent-1.0)));
  if (offset == (MagickOffsetType) (extent-1))
    (void) FormatLocaleFile(
# 130 "MagickWand/operation.c" 3 4
                           stderr
# 130 "MagickWand/operation.c"
                                 ,"\n");
  (void) fflush(
# 131 "MagickWand/operation.c" 3 4
               stderr
# 131 "MagickWand/operation.c"
                     );
  return(MagickTrue);
}
  ...
  ExceptionInfo *exception)
{
  ...
  (void) FormatLocaleString(key,4096,"cache:%s",path);
  sans_exception=AcquireExceptionInfo();
  image=(Image *) GetImageRegistry(ImageRegistryType,key,sans_exception);
  sans_exception=DestroyExceptionInfo(sans_exception);
  if (image != (Image *) 
# 158 "MagickWand/operation.c" 3 4
                        ((void *)0)
# 158 "MagickWand/operation.c"
                            )
    return(image);
  read_info=CloneImageInfo(image_info);
  if (path != (const char *) 
# 161 "MagickWand/operation.c" 3 4
                            ((void *)0)
# 161 "MagickWand/operation.c"
                                )
    (void) CopyMagickString(read_info->filename,path,4096);
  image=ReadImage(read_info,exception);
  read_info=DestroyImageInfo(read_info);
  if (image != (Image *) 
# 165 "MagickWand/operation.c" 3 4
                        ((void *)0)
# 165 "MagickWand/operation.c"
                            )
    (void) SetImageRegistry(ImageRegistryType,key,image,exception);
  return(image);
}
# 180 "MagickWand/operation.c"
...
# 206 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 206 "MagickWand/operation.c"
 image != (Image *) 
# 206 "MagickWand/operation.c" 3 4
...
# 206 "MagickWand/operation.c"
 "image != (Image *) NULL"
# 206 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 206, __extension__ __PRETTY_FUNCTION__); }))
# 206 "MagickWand/operation.c"
                                ;
  
# 207 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 207 "MagickWand/operation.c"
...
# 207 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 207, __extension__ __PRETTY_FUNCTION__); }))
# 207 "MagickWand/operation.c"
                                                ;
  
# 208 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 208 "MagickWand/operation.c"
...
# 208 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 208, __extension__ __PRETTY_FUNCTION__); }))
# 208 "MagickWand/operation.c"
                                            ;
  
# 209 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 209 "MagickWand/operation.c"
...
# 209 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 209, __extension__ __PRETTY_FUNCTION__); }))
# 209 "MagickWand/operation.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickWand/operation.c",__func__,(unsigned long) 211,"%s",image->filename);
  ...
  while( *p != '\0' )
  {
    ...
    if (*token == ',') continue;
    if ( 
# 239 "MagickWand/operation.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 239 "MagickWand/operation.c"
...
# 239 "MagickWand/operation.c"
  ...
  if ((x % (2+number_colors)) != 0)
    {
      (void) ThrowMagickException(exception,"MagickWand/operation.c",__func__,(unsigned long) 247,OptionError,
        "InvalidArgument","'%s': %s", "sparse-color",
        "Invalid number of Arguments");
      return( (Image *) 
# 250 "MagickWand/operation.c" 3 4
                       ((void *)0)
# 250 "MagickWand/operation.c"
                           );
    }
  error=MagickFalse;
  number_arguments=x;
  ...
  if (sparse_arguments == (double *) 
# 258 "MagickWand/operation.c" 3 4
                                    ((void *)0)
# 258 "MagickWand/operation.c"
                                        ) {
    (void) ThrowMagickException(exception,"MagickWand/operation.c",__func__,(unsigned long) 259,ResourceLimitError,
      "MemoryAllocationFailed","%s","SparseColorOption");
    return( (Image *) 
# 261 "MagickWand/operation.c" 3 4
                     ((void *)0)
# 261 "MagickWand/operation.c"
                         );
  }
  ...
  while ((*p != '\0') && (x < number_arguments))
  {
    ...
    *token=',';
    ...
    if (*token == '\0')
      break;
    if ( 
# 275 "MagickWand/operation.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 275 "MagickWand/operation.c"
        (int) ((unsigned char) *token)
# 275 "MagickWand/operation.c" 3 4
        ))] & (unsigned short int) _ISalpha) 
# 275 "MagickWand/operation.c"
                                                || *token == '#' ) {
      (void) ThrowMagickException(exception,"MagickWand/operation.c",__func__,(unsigned long) 276,
            OptionError, "InvalidArgument", "'%s': %s", "sparse-color",
            "Color found, instead of X-coord");
      error=MagickTrue;
      break;
    }
    sparse_arguments[x++]=StringToDouble(token,(char **) 
# 282 "MagickWand/operation.c" 3 4
                                                        ((void *)0)
# 282 "MagickWand/operation.c"
                                                            );
    ...
    *token=',';
    ...
    if (*token == '\0')
      break;
    if ( 
# 289 "MagickWand/operation.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 289 "MagickWand/operation.c"
        (int) ((unsigned char) *token)
# 289 "MagickWand/operation.c" 3 4
        ))] & (unsigned short int) _ISalpha) 
# 289 "MagickWand/operation.c"
                                                || *token == '#' ) {
      (void) ThrowMagickException(exception,"MagickWand/operation.c",__func__,(unsigned long) 290,
            OptionError, "InvalidArgument", "'%s': %s", "sparse-color",
    ...
    sparse_arguments[x++]=StringToDouble(token,(char **) 
# 296 "MagickWand/operation.c" 3 4
                                                        ((void *)0)
# 296 "MagickWand/operation.c"
                                                            );
    ...
    *token=',';
    ...
    if (*token == '\0') break;
    if ( 
# 302 "MagickWand/operation.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 302 "MagickWand/operation.c"
        (int) ((unsigned char) *token)
# 302 "MagickWand/operation.c" 3 4
        ))] & (unsigned short int) _ISalpha) 
# 302 "MagickWand/operation.c"
      ...
      (void) QueryColorCompliance(token,AllCompliance,&color,
                exception);
      if ((GetPixelRedTraits(image) & UpdatePixelTrait) != 0)
        sparse_arguments[x++] = ((double) 1.0/(double) ((Quantum) 65535.0))*color.red;
      if ((GetPixelGreenTraits(image) & UpdatePixelTrait) != 0)
        sparse_arguments[x++] = ((double) 1.0/(double) ((Quantum) 65535.0))*color.green;
      if ((GetPixelBlueTraits(image) & UpdatePixelTrait) != 0)
        sparse_arguments[x++] = ((double) 1.0/(double) ((Quantum) 65535.0))*color.blue;
      if (((GetPixelBlackTraits(image) & UpdatePixelTrait) != 0) &&
          (image->colorspace == CMYKColorspace))
        sparse_arguments[x++] = ((double) 1.0/(double) ((Quantum) 65535.0))*color.black;
      if (((GetPixelAlphaTraits(image) & UpdatePixelTrait) != 0) &&
          image->alpha_trait != UndefinedPixelTrait)
        sparse_arguments[x++] = ((double) 1.0/(double) ((Quantum) 65535.0))*color.alpha;
    }
    else {
      ...
      if ((GetPixelRedTraits(image) & UpdatePixelTrait) != 0)
        {
          while (*token == ',')
            (void) GetNextToken(p,&p,4096,token);
          if ((*token == '\0') || 
# 326 "MagickWand/operation.c" 3 4
                                 ((*__ctype_b_loc ())[(int) ((
# 326 "MagickWand/operation.c"
                                 (int) ((unsigned char) *token)
# 326 "MagickWand/operation.c" 3 4
                                 ))] & (unsigned short int) _ISalpha) 
# 326 "MagickWand/operation.c"
            ...
            break;
          sparse_arguments[x++]=StringToDouble(token,(char **) 
# 328 "MagickWand/operation.c" 3 4
                                                              ((void *)0)
# 328 "MagickWand/operation.c"
                                                                  );
          *token=',';
        }
      if ((GetPixelGreenTraits(image) & UpdatePixelTrait) != 0)
        {
          while (*token == ',')
            (void) GetNextToken(p,&p,4096,token);
          if ((*token == '\0') || 
# 335 "MagickWand/operation.c" 3 4
                                 ((*__ctype_b_loc ())[(int) ((
# 335 "MagickWand/operation.c"
                                 (int) ((unsigned char) *token)
# 335 "MagickWand/operation.c" 3 4
                                 ))] & (unsigned short int) _ISalpha) 
# 335 "MagickWand/operation.c"
            ...
            break;
          sparse_arguments[x++]=StringToDouble(token,(char **) 
# 337 "MagickWand/operation.c" 3 4
                                                              ((void *)0)
# 337 "MagickWand/operation.c"
                                                                  );
          *token=',';
        }
      if ((GetPixelBlueTraits(image) & UpdatePixelTrait) != 0)
        {
          while (*token == ',')
           (void) GetNextToken(p,&p,4096,token);
          if ((*token == '\0') || 
# 344 "MagickWand/operation.c" 3 4
                                 ((*__ctype_b_loc ())[(int) ((
# 344 "MagickWand/operation.c"
                                 (int) ((unsigned char) *token)
# 344 "MagickWand/operation.c" 3 4
                                 ))] & (unsigned short int) _ISalpha) 
# 344 "MagickWand/operation.c"
            ...
            break;
          sparse_arguments[x++]=StringToDouble(token,(char **) 
# 346 "MagickWand/operation.c" 3 4
                                                              ((void *)0)
# 346 "MagickWand/operation.c"
                                                                  );
          *token = ',';
        }
      if (((GetPixelBlackTraits(image) & UpdatePixelTrait) != 0) &&
          (image->colorspace == CMYKColorspace))
        {
          while (*token == ',')
            (void) GetNextToken(p,&p,4096,token);
          if ((*token == '\0') || 
# 354 "MagickWand/operation.c" 3 4
                                 ((*__ctype_b_loc ())[(int) ((
# 354 "MagickWand/operation.c"
                                 (int) ((unsigned char) *token)
# 354 "MagickWand/operation.c" 3 4
                                 ))] & (unsigned short int) _ISalpha) 
# 354 "MagickWand/operation.c"
            ...
            break;
          sparse_arguments[x++]=StringToDouble(token,(char **) 
# 356 "MagickWand/operation.c" 3 4
                                                              ((void *)0)
# 356 "MagickWand/operation.c"
                                                                  );
          *token=',';
        }
      if (((GetPixelAlphaTraits(image) & UpdatePixelTrait) != 0) &&
          image->alpha_trait != UndefinedPixelTrait)
        {
          while (*token == ',')
            (void) GetNextToken(p,&p,4096,token);
          if ((*token == '\0') || 
# 364 "MagickWand/operation.c" 3 4
                                 ((*__ctype_b_loc ())[(int) ((
# 364 "MagickWand/operation.c"
                                 (int) ((unsigned char) *token)
# 364 "MagickWand/operation.c" 3 4
                                 ))] & (unsigned short int) _ISalpha) 
# 364 "MagickWand/operation.c"
            ...
            break;
          sparse_arguments[x++]=StringToDouble(token,(char **) 
# 366 "MagickWand/operation.c" 3 4
                                                              ((void *)0)
# 366 "MagickWand/operation.c"
                                                                  );
          *token = ',';
        }
    }
  ...
  if (error != MagickFalse)
    {
      ...
      return((Image *) 
# 374 "MagickWand/operation.c" 3 4
                      ((void *)0)
# 374 "MagickWand/operation.c"
                          );
    }
  if (number_arguments != x)
    {
      sparse_arguments=(double *) RelinquishMagickMemory(sparse_arguments);
      (void) ThrowMagickException(exception,"MagickWand/operation.c",__func__,(unsigned long) 379,OptionError,
        "InvalidArgument","'%s': %s","sparse-color","Argument Parsing Error");
      return((Image *) 
# 381 "MagickWand/operation.c" 3 4
                      ((void *)0)
# 381 "MagickWand/operation.c"
                          );
    }
     ...
     const char *option,const char *arg1n, const char *arg2n)
{
  ...
  const char
    *arg1,
    *arg2;
# 448 "MagickWand/operation.c"
  
# 448 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 448 "MagickWand/operation.c"
 cli_wand != (MagickCLI *) 
# 448 "MagickWand/operation.c" 3 4
...
# 448 "MagickWand/operation.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 448 "MagickWand/operation.c"
 "cli_wand != (MagickCLI *) NULL"
# 448 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 448, __extension__ __PRETTY_FUNCTION__); }))
# 448 "MagickWand/operation.c"
                                       ;
  
# 449 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 449 "MagickWand/operation.c"
 cli_wand->signature == 0xabacadabUL
# 449 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 449 "MagickWand/operation.c"
 cli_wand->signature == 0xabacadabUL
...
# 449 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 449, __extension__ __PRETTY_FUNCTION__); }))
# 449 "MagickWand/operation.c"
                                                   ;
  
# 450 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 450 "MagickWand/operation.c"
 cli_wand->wand.signature == 0xabacadabUL
# 450 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 450 "MagickWand/operation.c"
 cli_wand->wand.signature == 0xabacadabUL
...
# 450 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 450, __extension__ __PRETTY_FUNCTION__); }))
# 450 "MagickWand/operation.c"
                                                        ;

  if (cli_wand->wand.debug != MagickFalse)
    (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/operation.c",__func__,(unsigned long) 453,
  ...
  if ( ((((cli_wand->process_flags) & ProcessInterpretProperties) != 0 )
        || ((((CommandOptionFlags) cli_wand->command->flags) & AlwaysInterpretArgsFlag) != 0)
       ) && ((((CommandOptionFlags) cli_wand->command->flags) & NeverInterpretArgsFlag) == 0) ) {

    if (arg1n != (char *) 
# 467 "MagickWand/operation.c" 3 4
                         ((void *)0)
# 467 "MagickWand/operation.c"
                             ) {
      arg1=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg1n,(cli_wand->wand.exception));
      if (arg1 == (char *) 
# 469 "MagickWand/operation.c" 3 4
                          ((void *)0)
# 469 "MagickWand/operation.c"
                              ) {
        (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 470,OptionWarning,"InterpretPropertyFailure", "`%s'",option);
        arg1=arg1n;
      }
    }
    if (arg2n != (char *) 
# 474 "MagickWand/operation.c" 3 4
                         ((void *)0)
# 474 "MagickWand/operation.c"
                             ) {
      arg2=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg2n,(cli_wand->wand.exception));
      if (arg2 == (char *) 
# 476 "MagickWand/operation.c" 3 4
                          ((void *)0)
# 476 "MagickWand/operation.c"
                              ) {
        (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 477,OptionWarning,"InterpretPropertyFailure", "`%s'",option);
        arg2=arg2n;
      }
    }
  }
  ...
  switch (*(option+1))
  {
    case 'a':
    {
      if (LocaleCompare("adjoin",option+1) == 0)
        {
          (cli_wand->wand.image_info)->adjoin = (*option=='-') ? MagickTrue : MagickFalse;
          break;
        }
      if (LocaleCompare("affine",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 497,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-draw 'affine ...'");
          if ((*option=='-'))
            (void) ParseAffineGeometry(arg1,&(cli_wand->draw_info)->affine,(cli_wand->wand.exception));
          else
            GetAffineMatrix(&(cli_wand->draw_info)->affine);
          break;
        }
      if (LocaleCompare("antialias",option+1) == 0)
        {
          (cli_wand->wand.image_info)->antialias =
            (cli_wand->draw_info)->stroke_antialias =
              (cli_wand->draw_info)->text_antialias = (*option=='-') ? MagickTrue : MagickFalse;
          break;
        }
      if (LocaleCompare("attenuate",option+1) == 0)
        {
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 514,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)("1.0")));
          break;
        }
      if (LocaleCompare("authenticate",option+1) == 0)
        {
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 520 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 520 "MagickWand/operation.c"
                                                    )));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 523,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'b':
    {
      if (LocaleCompare("background",option+1) == 0)
        {
# 541 "MagickWand/operation.c"
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 541 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 541 "MagickWand/operation.c"
                                                    )));
          (void) QueryColorCompliance(((*option=='-')?arg1:(const char *)(MogrifyBackgroundColor)),AllCompliance,
             &(cli_wand->wand.image_info)->background_color,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("bias",option+1) == 0)
        {
          ...
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 555,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),"convolve:bias",((*option=='-')?arg1:(const char *)(
# 556 "MagickWand/operation.c" 3 4
                                                           ((void *)0)
# 556 "MagickWand/operation.c"
                                                           )));
          break;
        }
      if (LocaleCompare("black-point-compensation",option+1) == 0)
        {
          ...
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?"true":"false"));
          break;
        }
      if (LocaleCompare("blue-primary",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("0.0"));
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 575,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
          ...
          if ((*option=='-'))
            {
              ...
              (void) QueryColorCompliance(arg1,AllCompliance,
                  &(cli_wand->wand.image_info)->border_color,(cli_wand->wand.exception));
              (void) QueryColorCompliance(arg1,AllCompliance,
                  &(cli_wand->draw_info)->border_color,(cli_wand->wand.exception));
              break;
            }
          (void) DeleteImageOption((cli_wand->wand.image_info),option+1);
      ...
      if (LocaleCompare("box",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 603,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-undercolor");
          CLISettingOptionInfo(cli_wand,"-undercolor",arg1, arg2);
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 607,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'c':
    {
      if (LocaleCompare("cache",option+1) == 0)
        {
          ...
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 617,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          limit=(((MagickSizeType) (~0ULL)) >> 1);
      ...
      if (LocaleCompare("caption",option+1) == 0)
        {
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 627 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 627 "MagickWand/operation.c"
                                                    )));
          break;
        }
      if (LocaleCompare("colorspace",option+1) == 0)
        {
          ...
          parse=ParseCommandOption(MagickColorspaceOptions,MagickFalse,
             ((*option=='-')?arg1:(const char *)("undefined")));
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 639,OptionError,"UnrecognizedColorspace", "'%s' '%s'",option, arg1); break; }
                   ;
          (cli_wand->wand.image_info)->colorspace=(ColorspaceType) parse;
          break;
        }
      if (LocaleCompare("comment",option+1) == 0)
        {
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 646 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 646 "MagickWand/operation.c"
                                                    )));
          break;
        }
      if (LocaleCompare("compose",option+1) == 0)
        {
          ...
          parse = ParseCommandOption(MagickComposeOptions,MagickFalse,
                          ((*option=='-')?arg1:(const char *)("undefined")));
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 661,OptionError,"UnrecognizedComposeOperator", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (cli_wand->wand.image_info)->compose=(CompositeOperator) parse;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 664 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 664 "MagickWand/operation.c"
                                                    )));
          break;
        }
      if (LocaleCompare("compress",option+1) == 0)
        {
# 679 "MagickWand/operation.c"
          parse = ParseCommandOption(MagickCompressOptions,MagickFalse,
                     ((*option=='-')?arg1:(const char *)("undefined")));
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 682,OptionError,"UnrecognizedImageCompression", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (cli_wand->wand.image_info)->compression=(CompressionType) parse;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 685 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 685 "MagickWand/operation.c"
                                                    )));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 688,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'd':
    {
      if (LocaleCompare("debug",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("none"));
          parse = ParseCommandOption(MagickLogEventOptions,MagickFalse,arg1);
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 698,OptionError,"UnrecognizedEventType", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (void) SetLogEventMask(arg1);
          (cli_wand->wand.image_info)->debug=IsEventLogging();
      ...
      if (LocaleCompare("define",option+1) == 0)
        {
          if (LocaleNCompare(arg1,"registry:",9) == 0)
            {
              if ((*option=='-'))
                (void) DefineImageRegistry(StringRegistryType,arg1+9,(cli_wand->wand.exception));
              else
          ...
          if ((*option=='-'))
            (void) DefineImageOption((cli_wand->wand.image_info),arg1);
          else if (DeleteImageOption((cli_wand->wand.image_info),arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 719,OptionError,"NoSuchOption", "'%s' '%s'",option, arg1); break; };
          break;
        }
      if (LocaleCompare("delay",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("0"));
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 729,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("density",option+1) == 0)
        {
          ...
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 741,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 742 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 742 "MagickWand/operation.c"
                                                    )));
          (void) CloneString(&(cli_wand->wand.image_info)->density,((*option=='-')?arg1:(const char *)(
# 743 "MagickWand/operation.c" 3 4
                                                  ((void *)0)
# 743 "MagickWand/operation.c"
                                                  )));
          (void) CloneString(&(cli_wand->draw_info)->density,(cli_wand->wand.image_info)->density);
          break;
        }
      if (LocaleCompare("depth",option+1) == 0)
        {
          ...
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 753,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (cli_wand->wand.image_info)->depth=(*option=='-')?StringToUnsignedLong(arg1)
                                       :16;
          break;
        }
      if (LocaleCompare("direction",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("undefined"));
          parse = ParseCommandOption(MagickDirectionOptions,MagickFalse,arg1);
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 764,OptionError,"UnrecognizedDirectionType", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (cli_wand->draw_info)->direction=(DirectionType) parse;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("display",option+1) == 0)
        {
          (void) CloneString(&(cli_wand->wand.image_info)->server_name,((*option=='-')?arg1:(const char *)(
# 772 "MagickWand/operation.c" 3 4
                                                      ((void *)0)
# 772 "MagickWand/operation.c"
                                                      )));
          (void) CloneString(&(cli_wand->draw_info)->server_name,(cli_wand->wand.image_info)->server_name);
          break;
        }
      if (LocaleCompare("dispose",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 782,OptionError,"UnrecognizedDisposeMethod", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)("undefined")));
          break;
        }
      if (LocaleCompare("dissimilarity-threshold",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("0.31830988618379067154"));
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 793,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("dither",option+1) == 0)
        {
          ...
          (cli_wand->wand.image_info)->dither = (*option=='-') ? MagickTrue : MagickFalse;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)("none")));
          (cli_wand->quantize_info)->dither_method=(DitherMethod) ParseCommandOption(
             MagickDitherOptions,MagickFalse,((*option=='-')?arg1:(const char *)("none")));
          if ((cli_wand->quantize_info)->dither_method == NoDitherMethod)
            (cli_wand->wand.image_info)->dither = MagickFalse;
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 811,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'e':
    {
      if (LocaleCompare("encoding",option+1) == 0)
        {
          (void) CloneString(&(cli_wand->draw_info)->encoding,((*option=='-')?arg1:(const char *)("undefined")));
          (void) SetImageOption((cli_wand->wand.image_info),option+1,(cli_wand->draw_info)->encoding);
          break;
        }
      if (LocaleCompare("endian",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 827,OptionError,"UnrecognizedEndianType", "'%s' '%s'",option, arg1); break; }
                                                  ;

          (cli_wand->wand.image_info)->endian=(EndianType) (*arg1);
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("extract",option+1) == 0)
        {
          (void) CloneString(&(cli_wand->wand.image_info)->extract,((*option=='-')?arg1:(const char *)(
# 836 "MagickWand/operation.c" 3 4
                                                  ((void *)0)
# 836 "MagickWand/operation.c"
                                                  )));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 839,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'f':
    {
      if (LocaleCompare("family",option+1) == 0)
        {
          (void) SetImageOption((cli_wand->wand.image_info),option+1, ((*option=='-')?arg1:(const char *)(
# 845 "MagickWand/operation.c" 3 4
                                                     ((void *)0)
# 845 "MagickWand/operation.c"
                                                     )));
          (void) CloneString(&(cli_wand->draw_info)->family,((*option=='-')?arg1:(const char *)(
# 846 "MagickWand/operation.c" 3 4
                                                ((void *)0)
# 846 "MagickWand/operation.c"
                                                )));
          break;
        }
      if (LocaleCompare("features",option+1) == 0)
        {
          (void) SetImageOption((cli_wand->wand.image_info),"identify:features",
            ((*option=='-')?"true":"false"));
          if ((*option=='-'))
            (void) SetImageArtifact((cli_wand->wand.images),"verbose","true");
          break;
        }
      if (LocaleCompare("fill",option+1) == 0)
        {
          ...
          arg1 = ((*option=='-')?arg1:(const char *)("none"));
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          if ((cli_wand->draw_info)->fill_pattern != (Image *) 
# 875 "MagickWand/operation.c" 3 4
                                                   ((void *)0)
# 875 "MagickWand/operation.c"
                                                       )
            (cli_wand->draw_info)->fill_pattern=DestroyImage((cli_wand->draw_info)->fill_pattern);
          ...
          if (status == MagickFalse)
            (cli_wand->draw_info)->fill_pattern=GetImageCache((cli_wand->wand.image_info),arg1,(cli_wand->wand.exception));
          else
            (cli_wand->draw_info)->fill=color;
          break;
        }
      if (LocaleCompare("filter",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 895,OptionError,"UnrecognizedImageFilter", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("font",option+1) == 0)
        {
          (void) CloneString(&(cli_wand->draw_info)->font,((*option=='-')?arg1:(const char *)(
# 902 "MagickWand/operation.c" 3 4
                                              ((void *)0)
# 902 "MagickWand/operation.c"
                                              )));
          (void) CloneString(&(cli_wand->wand.image_info)->font,(cli_wand->draw_info)->font);
          break;
        }
      if (LocaleCompare("format",option+1) == 0)
        {
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 908 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 908 "MagickWand/operation.c"
                                                    )));
          break;
        }
      if (LocaleCompare("fuzz",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("0"));
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 922,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (cli_wand->wand.image_info)->fuzz=StringToDoubleInterval(arg1,(double)
                ((Quantum) 65535.0)+1.0);
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 928,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'g':
    {
      if (LocaleCompare("gravity",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 938,OptionError,"UnrecognizedGravityType", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (cli_wand->draw_info)->gravity=(GravityType) parse;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("green-primary",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("0.0"));
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 952,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 956,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'h':
    {
      if (LocaleCompare("highlight-color",option+1) == 0)
        {
          ...
          (void) SetImageOption((cli_wand->wand.image_info),"compare:highlight-color",
            ((*option=='-')?arg1:(const char *)(
# 965 "MagickWand/operation.c" 3 4
           ((void *)0)
# 965 "MagickWand/operation.c"
           )));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 968,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'i':
    {
      if (LocaleCompare("illuminant",option+1) == 0)
        {
          (void) SetImageOption((cli_wand->wand.image_info),"color:illuminant",
            ((*option=='-')?arg1:(const char *)(
# 975 "MagickWand/operation.c" 3 4
           ((void *)0)
# 975 "MagickWand/operation.c"
           )));
          break;
        }
      if (LocaleCompare("intensity",option+1) == 0)
        {
          ...
          parse = ParseCommandOption(MagickPixelIntensityOptions,MagickFalse,
            arg1);
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 984,OptionError,"UnrecognizedIntensityType", "'%s' '%s'",option, arg1); break; }
                          ;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("intent",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 998,OptionError,"UnrecognizedIntentType", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("interlace",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1011,OptionError,"UnrecognizedInterlaceType", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (cli_wand->wand.image_info)->interlace=(InterlaceType) parse;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("interline-spacing",option+1) == 0)
        {
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1020,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1, ((*option=='-')?arg1:(const char *)(
# 1021 "MagickWand/operation.c" 3 4
                                                     ((void *)0)
# 1021 "MagickWand/operation.c"
                                                     )));
          (cli_wand->draw_info)->interline_spacing=StringToDouble(((*option=='-')?arg1:(const char *)("0")),
               (char **) 
# 1023 "MagickWand/operation.c" 3 4
                        ((void *)0)
# 1023 "MagickWand/operation.c"
                            );
          break;
        }
      if (LocaleCompare("interpolate",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1032,OptionError,"UnrecognizedInterpolateMethod", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("interword-spacing",option+1) == 0)
        {
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1040,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1, ((*option=='-')?arg1:(const char *)(
# 1041 "MagickWand/operation.c" 3 4
                                                     ((void *)0)
# 1041 "MagickWand/operation.c"
                                                     )));
          (cli_wand->draw_info)->interword_spacing=StringToDouble(((*option=='-')?arg1:(const char *)("0")),(char **) 
# 1042 "MagickWand/operation.c" 3 4
                                                                               ((void *)0)
# 1042 "MagickWand/operation.c"
                                                                                   );
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1045,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'k':
    {
      if (LocaleCompare("kerning",option+1) == 0)
        {
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1052,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1053 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1053 "MagickWand/operation.c"
                                                    )));
          (cli_wand->draw_info)->kerning=StringToDouble(((*option=='-')?arg1:(const char *)("0")),(char **) 
# 1054 "MagickWand/operation.c" 3 4
                                                                     ((void *)0)
# 1054 "MagickWand/operation.c"
                                                                         );
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1057,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'l':
    {
      if (LocaleCompare("label",option+1) == 0)
        {
          ...
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1064 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1064 "MagickWand/operation.c"
                                                    )));
          break;
        }
      if (LocaleCompare("limit",option+1) == 0)
        {
          ...
          if ( parse < 0 )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1075,OptionError,"UnrecognizedResourceType", "'%s' '%s'",option, arg1); break; }
                          ;
      ...
      if (LocaleCompare("log",option+1) == 0)
        {
          if ((*option=='-')) {
            if (arg1 == (char *) 
# 1087 "MagickWand/operation.c" 3 4
                                ((void *)0)
# 1087 "MagickWand/operation.c"
                                    )
              break;
            if ((strchr(arg1,'%') == (char *) 
# 1089 "MagickWand/operation.c" 3 4
                                             ((void *)0)
# 1089 "MagickWand/operation.c"
                                                 ))
              { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1090,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
      ...
      if (LocaleCompare("lowlight-color",option+1) == 0)
        {
          ...
          (void) SetImageOption((cli_wand->wand.image_info),"compare:lowlight-color",
            ((*option=='-')?arg1:(const char *)(
# 1100 "MagickWand/operation.c" 3 4
           ((void *)0)
# 1100 "MagickWand/operation.c"
           )));
          break;
        }
      if (LocaleCompare("loop",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("0"));
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1108,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1112,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'm':
    {
      if (LocaleCompare("mattecolor",option+1) == 0)
        {
          ...
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1119 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1119 "MagickWand/operation.c"
                                                    )));
          (void) QueryColorCompliance(((*option=='-')?arg1:(const char *)(MogrifyAlphaColor)),
            AllCompliance,&(cli_wand->wand.image_info)->matte_color,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("metric",option+1) == 0)
        {
          ...
          if ( parse < 0 )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1130,OptionError,"UnrecognizedMetricType", "'%s' '%s'",option, arg1); break; }
                            ;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1132 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1132 "MagickWand/operation.c"
                                                    )));
          break;
        }
      if (LocaleCompare("moments",option+1) == 0)
        {
          (void) SetImageOption((cli_wand->wand.image_info),"identify:moments",
            ((*option=='-')?"true":"false"));
          if ((*option=='-'))
            (void) SetImageArtifact((cli_wand->wand.images),"verbose","true");
          break;
      ...
      if (LocaleCompare("monitor",option+1) == 0)
        {
          (void) SetImageInfoProgressMonitor((cli_wand->wand.image_info),(*option=='-') ?
            MonitorProgress: (MagickProgressMonitor) 
# 1146 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1146 "MagickWand/operation.c"
                                                        ,(void *) 
# 1146 "MagickWand/operation.c" 3 4
                                                                  ((void *)0)
# 1146 "MagickWand/operation.c"
      ...
      if (LocaleCompare("monochrome",option+1) == 0)
        {
          ...
          (cli_wand->wand.image_info)->monochrome= (*option=='-') ? MagickTrue : MagickFalse;
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1157,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'o':
    {
      if (LocaleCompare("orient",option+1) == 0)
        {
          ...
          parse=ParseCommandOption(MagickOrientationOptions,MagickFalse,
               ((*option=='-')?arg1:(const char *)("undefined")));
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1171,OptionError,"UnrecognizedImageOrientation", "'%s' '%s'",option, arg1); break; }
                                                  ;
          (cli_wand->wand.image_info)->orientation=(OrientationType)parse;
          (void) SetImageOption((cli_wand->wand.image_info),option+1, ((*option=='-')?arg1:(const char *)(
# 1174 "MagickWand/operation.c" 3 4
                                                     ((void *)0)
# 1174 "MagickWand/operation.c"
                                                     )));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1177,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'p':
    {
      if (LocaleCompare("page",option+1) == 0)
        {
          ...
          if (!(*option=='-'))
            {
              (void) DeleteImageOption((cli_wand->wand.image_info),option+1);
              (void) CloneString(&(cli_wand->wand.image_info)->page,(char *) 
# 1204 "MagickWand/operation.c" 3 4
                                                            ((void *)0)
# 1204 "MagickWand/operation.c"
                                                                );
              break;
            }
          (void) memset(&geometry,0,sizeof(geometry));
          image_option=GetImageOption((cli_wand->wand.image_info),"page");
          if (image_option != (const char *) 
# 1209 "MagickWand/operation.c" 3 4
                                            ((void *)0)
# 1209 "MagickWand/operation.c"
                                                )
          ...
          (void) FormatLocaleString(page,4096,"%lux%lu",
            (unsigned long) geometry.width,(unsigned long) geometry.height);
          if (((flags & XValue) != 0) || ((flags & YValue) != 0))
            (void) FormatLocaleString(page,4096,"%lux%lu%+ld%+ld",
              (unsigned long) geometry.width,(unsigned long) geometry.height,
              (long) geometry.x,(long) geometry.y);
          (void) SetImageOption((cli_wand->wand.image_info),option+1,page);
          (void) CloneString(&(cli_wand->wand.image_info)->page,page);
          break;
        }
      if (LocaleCompare("ping",option+1) == 0)
        {
          (cli_wand->wand.image_info)->ping=(*option=='-') ? MagickTrue : MagickFalse;
          break;
        }
      if (LocaleCompare("pointsize",option+1) == 0)
        {
          if ((*option=='-')) {
            if (IsGeometry(arg1) == MagickFalse)
              { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1233,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
            (cli_wand->wand.image_info)->pointsize =
            (cli_wand->draw_info)->pointsize =
              StringToDouble(arg1,(char **) 
# 1236 "MagickWand/operation.c" 3 4
                                           ((void *)0)
# 1236 "MagickWand/operation.c"
                                               );
          }
          else {
            (cli_wand->wand.image_info)->pointsize=0.0;
            (cli_wand->draw_info)->pointsize=12.0;
          }
          break;
        }
      if (LocaleCompare("precision",option+1) == 0)
        {
          arg1=((*option=='-')?arg1:(const char *)("-1"));
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1248,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetMagickPrecision(StringToInteger(arg1));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1252,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'q':
    {
      if (LocaleCompare("quality",option+1) == 0)
        {
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1259,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (cli_wand->wand.image_info)->quality= (*option=='-') ? StringToUnsignedLong(arg1)
                                            : 0UL;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)("0")));
          break;
        }
      if (LocaleCompare("quantize",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1271,OptionError,"UnrecognizedColorspace", "'%s' '%s'",option, arg1); break; }
                             ;
          (cli_wand->quantize_info)->colorspace=(ColorspaceType)parse;
          break;
        }
...
# 1282 "MagickWand/operation.c" 3 4
                                              ((void *)0)
# 1282 "MagickWand/operation.c"
                                                  ;

          WarningHandler
            tmp = SetWarningHandler((WarningHandler) 
# 1285 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1285 "MagickWand/operation.c"
                                                        );

          if ( tmp != (WarningHandler) 
# 1287 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 1287 "MagickWand/operation.c"
                                          )
            warning_handler = tmp;
          if (!(*option=='-'))
      ...
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1293,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'r':
    {
      if (LocaleCompare("red-primary",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("0.0"));
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1305,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      ...
      if (LocaleCompare("render",option+1) == 0)
        {
          ...
          (cli_wand->draw_info)->render= (*option=='-') ? MagickFalse : MagickTrue;
          break;
        }
      ...
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1324,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 's':
    {
      if (LocaleCompare("sampling-factor",option+1) == 0)
        {
          ...
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1332,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) CloneString(&(cli_wand->wand.image_info)->sampling_factor,((*option=='-')?arg1:(const char *)(
# 1333 "MagickWand/operation.c" 3 4
                                                          ((void *)0)
# 1333 "MagickWand/operation.c"
                                                          )));
          break;
        }
      if (LocaleCompare("scene",option+1) == 0)
        {
          ...
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1342,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1343 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1343 "MagickWand/operation.c"
                                                    )));
          (cli_wand->wand.image_info)->scene=StringToUnsignedLong(((*option=='-')?arg1:(const char *)("0")));
          break;
        }
      if (LocaleCompare("seed",option+1) == 0)
        {
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1350,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          SetRandomSecretKey(
               (*option=='-') ? (unsigned long) StringToUnsignedLong(arg1)
                           : (unsigned long) time((time_t *) 
# 1353 "MagickWand/operation.c" 3 4
                                                            ((void *)0)
# 1353 "MagickWand/operation.c"
                                                                ));
          break;
        }
      if (LocaleCompare("size",option+1) == 0)
        {
          ...
          (void) CloneString(&(cli_wand->wand.image_info)->size,((*option=='-')?arg1:(const char *)(
# 1361 "MagickWand/operation.c" 3 4
                                               ((void *)0)
# 1361 "MagickWand/operation.c"
                                               )));
          break;
        }
      if (LocaleCompare("stretch",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1369,OptionError,"UnrecognizedStretchType", "'%s' '%s'",option, arg1); break; }
                             ;
          (cli_wand->draw_info)->stretch=(StretchType) parse;
          break;
        }
      if (LocaleCompare("stroke",option+1) == 0)
        {
          ...
          arg1 = ((*option=='-')?arg1:(const char *)("none"));
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          if ((cli_wand->draw_info)->stroke_pattern != (Image *) 
# 1391 "MagickWand/operation.c" 3 4
                                                     ((void *)0)
# 1391 "MagickWand/operation.c"
                                                         )
            (cli_wand->draw_info)->stroke_pattern=DestroyImage((cli_wand->draw_info)->stroke_pattern);
          ...
          if (status == MagickFalse)
            (cli_wand->draw_info)->stroke_pattern=GetImageCache((cli_wand->wand.image_info),arg1,(cli_wand->wand.exception));
          else
            (cli_wand->draw_info)->stroke=color;
          break;
        }
      if (LocaleCompare("strokewidth",option+1) == 0)
        {
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1408,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1409 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1409 "MagickWand/operation.c"
                                                    )));
          (cli_wand->draw_info)->stroke_width=StringToDouble(((*option=='-')?arg1:(const char *)("1.0")),
               (char **) 
# 1411 "MagickWand/operation.c" 3 4
                        ((void *)0)
# 1411 "MagickWand/operation.c"
                            );
          break;
        }
      if (LocaleCompare("style",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1419,OptionError,"UnrecognizedStyleType", "'%s' '%s'",option, arg1); break; }
                             ;
          (cli_wand->draw_info)->style=(StyleType) parse;
          break;
        }
# 1433 "MagickWand/operation.c"
      if (LocaleCompare("synchronize",option+1) == 0)
        {

          (cli_wand->wand.image_info)->synchronize = (*option=='-') ? MagickTrue : MagickFalse;
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1439,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 't':
    {
      ...
      if (LocaleCompare("texture",option+1) == 0)
        {
          ...
          (void) CloneString(&(cli_wand->wand.image_info)->texture,((*option=='-')?arg1:(const char *)(
# 1455 "MagickWand/operation.c" 3 4
                                                  ((void *)0)
# 1455 "MagickWand/operation.c"
                                                  )));
          break;
        }
      if (LocaleCompare("tile",option+1) == 0)
        {
          ...
          (cli_wand->draw_info)->fill_pattern=(*option=='-')
                                 ?GetImageCache((cli_wand->wand.image_info),arg1,(cli_wand->wand.exception))
                                 :DestroyImage((cli_wand->draw_info)->fill_pattern);
          break;
        }
      if (LocaleCompare("tile-offset",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("0"));
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1471,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("transparent-color",option+1) == 0)
        {
          ...
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1484 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1484 "MagickWand/operation.c"
                                                    )));
          (void) QueryColorCompliance(((*option=='-')?arg1:(const char *)("none")),AllCompliance,
              &(cli_wand->wand.image_info)->transparent_color,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("treedepth",option+1) == 0)
        {
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1491 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1491 "MagickWand/operation.c"
                                                    )));
          (cli_wand->quantize_info)->tree_depth=StringToUnsignedLong(((*option=='-')?arg1:(const char *)("0")));
          break;
        }
      if (LocaleCompare("type",option+1) == 0)
        {
          ...
          parse=ParseCommandOption(MagickTypeOptions,MagickFalse,
               ((*option=='-')?arg1:(const char *)("undefined")));
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1501,OptionError,"UnrecognizedImageType", "'%s' '%s'",option, arg1); break; }
                             ;
          (cli_wand->wand.image_info)->type=(ImageType) parse;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1504 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1504 "MagickWand/operation.c"
                                                    )));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1507,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'u':
    {
      if (LocaleCompare("undercolor",option+1) == 0)
        {
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1513 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1513 "MagickWand/operation.c"
                                                    )));
          (void) QueryColorCompliance(((*option=='-')?arg1:(const char *)("none")),AllCompliance,
               &(cli_wand->draw_info)->undercolor,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("units",option+1) == 0)
        {
          ...
          parse=ParseCommandOption(MagickResolutionOptions,MagickFalse,
               ((*option=='-')?arg1:(const char *)("undefined")));
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1527,OptionError,"UnrecognizedUnitsType", "'%s' '%s'",option, arg1); break; }
                             ;
          (cli_wand->wand.image_info)->units=(ResolutionType) parse;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1530 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1530 "MagickWand/operation.c"
                                                    )));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1533,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'v':
    {
      if (LocaleCompare("verbose",option+1) == 0)
        {
          ...
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?"true":"false"));
          (cli_wand->wand.image_info)->verbose= (*option=='-') ? MagickTrue : MagickFalse;
          (cli_wand->wand.image_info)->ping=MagickFalse;
          break;
        }
      if (LocaleCompare("virtual-pixel",option+1) == 0)
        {
          ...
          parse=ParseCommandOption(MagickVirtualPixelOptions,MagickFalse,
               ((*option=='-')?arg1:(const char *)("undefined")));
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1555,OptionError,"UnrecognizedVirtualPixelMethod", "'%s' '%s'",option, arg1); break; }
                             ;
          (void) SetImageOption((cli_wand->wand.image_info),option+1,((*option=='-')?arg1:(const char *)(
# 1557 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 1557 "MagickWand/operation.c"
                                                    )));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1560,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'w':
    {
      if (LocaleCompare("weight",option+1) == 0)
        {
          ...
          (cli_wand->draw_info)->weight=(size_t) weight;
          break;
        }
      if (LocaleCompare("white-point",option+1) == 0)
        {
          ...
          arg1=((*option=='-')?arg1:(const char *)("0.0"));
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1582,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1,arg1);
          break;
        }
      if (LocaleCompare("word-break",option+1) == 0)
        {
          parse=ParseCommandOption(MagickWordBreakOptions,MagickFalse,
            ((*option=='-')?arg1:(const char *)("undefined")));
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1591,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SetImageOption((cli_wand->wand.image_info),option+1, ((*option=='-')?arg1:(const char *)(
# 1592 "MagickWand/operation.c" 3 4
                                                     ((void *)0)
# 1592 "MagickWand/operation.c"
                                                     )));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1595,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    default:
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1598,OptionError,"UnrecognizedOption", "`%s'",option); break; };
  }
...
# 1617 "MagickWand/operation.c"
  return;
}
# 1669 "MagickWand/operation.c"
  ...
  ExceptionInfo *exception)
{
  ...
  const char
    *arg1,
    *arg2;
# 1704 "MagickWand/operation.c"
  
# 1704 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 1704 "MagickWand/operation.c"
 cli_wand != (MagickCLI *) 
# 1704 "MagickWand/operation.c" 3 4
...
# 1704 "MagickWand/operation.c"
 "cli_wand != (MagickCLI *) NULL"
# 1704 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 1704, __extension__ __PRETTY_FUNCTION__); }))
# 1704 "MagickWand/operation.c"
                                       ;
  
# 1705 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 1705 "MagickWand/operation.c"
 cli_wand->signature == 0xabacadabUL
# 1705 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1705 "MagickWand/operation.c"
...
# 1705 "MagickWand/operation.c"
 "cli_wand->signature == MagickWandSignature"
# 1705 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 1705, __extension__ __PRETTY_FUNCTION__); }))
# 1705 "MagickWand/operation.c"
                                                   ;
  
# 1706 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 1706 "MagickWand/operation.c"
 cli_wand->wand.signature == 0xabacadabUL
# 1706 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1706 "MagickWand/operation.c"
...
# 1706 "MagickWand/operation.c"
 "cli_wand->wand.signature == MagickWandSignature"
# 1706 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 1706, __extension__ __PRETTY_FUNCTION__); }))
# 1706 "MagickWand/operation.c"
                                                        ;
  
# 1707 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 1707 "MagickWand/operation.c"
...
# 1707 "MagickWand/operation.c"
 "_image != (Image *) NULL"
# 1707 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 1707, __extension__ __PRETTY_FUNCTION__); }))
# 1707 "MagickWand/operation.c"
                                 ;
  if (cli_wand->wand.debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/operation.c",__func__,(unsigned long) 1709,"%s",cli_wand->wand.name);
  ...
  if ( ((((cli_wand->process_flags) & ProcessInterpretProperties) != 0 )
    ...
    if (arg1n != (char *) 
# 1719 "MagickWand/operation.c" 3 4
                         ((void *)0)
# 1719 "MagickWand/operation.c"
                             ) {
      arg1=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg1n,(cli_wand->wand.exception));
      if (arg1 == (char *) 
# 1721 "MagickWand/operation.c" 3 4
                          ((void *)0)
# 1721 "MagickWand/operation.c"
                              ) {
        (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1722,OptionWarning,"InterpretPropertyFailure", "`%s'",option);
        arg1=arg1n;
      }
    }
    if (arg2n != (char *) 
# 1726 "MagickWand/operation.c" 3 4
                         ((void *)0)
# 1726 "MagickWand/operation.c"
                             ) {
      arg2=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg2n,(cli_wand->wand.exception));
      if (arg2 == (char *) 
# 1728 "MagickWand/operation.c" 3 4
                          ((void *)0)
# 1728 "MagickWand/operation.c"
                              ) {
        (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1729,OptionWarning,"InterpretPropertyFailure", "`%s'",option);
        arg2=arg2n;
      }
    }
  }
# 1742 "MagickWand/operation.c"
  new_image = (Image *) 
# 1742 "MagickWand/operation.c" 3 4
                       ((void *)0)
# 1742 "MagickWand/operation.c"
                           ;
      ...
      if (LocaleCompare("adaptive-blur",option+1) == 0)
        {
          ...
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1753,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          new_image=AdaptiveBlurImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("adaptive-resize",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1764,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ParseRegionGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          new_image=AdaptiveResizeImage((cli_wand->wand.images),geometry.width,geometry.height,
      ...
      if (LocaleCompare("adaptive-sharpen",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1774,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          new_image=AdaptiveSharpenImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("alpha",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1785,OptionError,"UnrecognizedAlphaChannelOption", "'%s' '%s'",option, arg1); break; }
                          ;
          (void) SetImageAlphaChannel((cli_wand->wand.images),(AlphaChannelOption) parse,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("annotate",option+1) == 0)
        {
          ...
          flags=ParseGeometry(arg1,&geometry_info);
          if (flags == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1799,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=geometry_info.rho;
          (void) CloneString(&(cli_wand->draw_info)->text,arg2);
          (void) FormatLocaleString(buffer,4096,"%+f%+f",
            geometry_info.xi,geometry_info.psi);
          (void) CloneString(&(cli_wand->draw_info)->geometry,buffer);
          (cli_wand->draw_info)->affine.sx=cos(DegreesToRadians(
            fmod(geometry_info.rho,360.0)));
          (cli_wand->draw_info)->affine.rx=sin(DegreesToRadians(
            fmod(geometry_info.rho,360.0)));
          (cli_wand->draw_info)->affine.ry=(-sin(DegreesToRadians(
            fmod(geometry_info.sigma,360.0))));
          (cli_wand->draw_info)->affine.sy=cos(DegreesToRadians(
            fmod(geometry_info.sigma,360.0)));
          (void) AnnotateImage((cli_wand->wand.images),(cli_wand->draw_info),(cli_wand->wand.exception));
          GetAffineMatrix(&(cli_wand->draw_info)->affine);
          break;
        }
      if (LocaleCompare("auto-gamma",option+1) == 0)
        {
          (void) AutoGammaImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("auto-level",option+1) == 0)
        {
          (void) AutoLevelImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("auto-orient",option+1) == 0)
        {
          new_image=AutoOrientImage((cli_wand->wand.images),(cli_wand->wand.images)->orientation,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("auto-threshold",option+1) == 0)
        {
          ...
          (void) AutoThresholdImage((cli_wand->wand.images),method,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1843,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'b':
    {
      if (LocaleCompare("bilateral-blur",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1851,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=geometry_info.rho;
          if ((flags & XiValue) == 0)
          ...
          if ((flags & PsiValue) == 0)
            geometry_info.psi=0.25*sqrt(geometry_info.rho*geometry_info.rho+
              geometry_info.sigma*geometry_info.sigma);
          new_image=BilateralBlurImage((cli_wand->wand.images),(size_t) geometry_info.rho,
      ...
      if (LocaleCompare("black-threshold",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1868,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) BlackThresholdImage((cli_wand->wand.images),arg1,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("blue-shift",option+1) == 0)
        {
          ...
          if ((*option=='-')) {
            flags=ParseGeometry(arg1,&geometry_info);
            if ((flags & RhoValue) == 0)
              { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1878,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          }
          new_image=BlueShiftImage((cli_wand->wand.images),geometry_info.rho,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("blur",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1887,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          new_image=BlurImage((cli_wand->wand.images),geometry_info.rho,geometry_info.sigma,
           (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("border",option+1) == 0)
        {
          ...
          flags=ParsePageGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          if ((flags & (WidthValue | HeightValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1904,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          compose=OverCompositeOp;
          value=GetImageOption((cli_wand->wand.image_info),"compose");
          if (value != (const char *) 
# 1907 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 1907 "MagickWand/operation.c"
                                         )
            compose=(CompositeOperator) ParseCommandOption(MagickComposeOptions,
              MagickFalse,value);
          new_image=BorderImage((cli_wand->wand.images),&geometry,compose,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("brightness-contrast",option+1) == 0)
        {
          ...
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1921,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          brightness=geometry_info.rho;
          contrast=0.0;
          if ((flags & SigmaValue) != 0)
            contrast=geometry_info.sigma;
          (void) BrightnessContrastImage((cli_wand->wand.images),brightness,contrast,
            (cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1930,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'c':
    {
      if (LocaleCompare("canny",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1938,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          if ((flags & XiValue) == 0)
            geometry_info.xi=10;
          ...
          new_image=CannyEdgeImage((cli_wand->wand.images),geometry_info.rho,geometry_info.sigma,
            geometry_info.xi,geometry_info.psi,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("cdl",option+1) == 0)
        {
          ...
          color_correction_collection=FileToString(arg1,~0UL,(cli_wand->wand.exception));
          if (color_correction_collection == (char *) 
# 1963 "MagickWand/operation.c" 3 4
                                                     ((void *)0)
# 1963 "MagickWand/operation.c"
                                                         )
            break;
          (void) ColorDecisionListImage((cli_wand->wand.images),color_correction_collection,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("channel",option+1) == 0)
        {
          if ((*option!='-'))
            {
              (void) SetPixelChannelMask((cli_wand->wand.images),DefaultChannels);
              break;
            }
          parse=ParseChannelOption(arg1);
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1978,OptionError,"UnrecognizedChannelType", "'%s' '%s'",option, arg1); break; }
                   ;
          (void) SetPixelChannelMask((cli_wand->wand.images),(ChannelType) parse);
          break;
        }
      if (LocaleCompare("charcoal",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1987,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          if ((flags & XiValue) == 0)
            geometry_info.xi=1.0;
          new_image=CharcoalImage((cli_wand->wand.images),geometry_info.rho,geometry_info.sigma,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("chop",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 1999,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ParseGravityGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          new_image=ChopImage((cli_wand->wand.images),&geometry,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("clahe",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2007,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          flags=ParseGeometry(arg1,&geometry_info);
          flags=ParseRegionGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          (void) CLAHEImage((cli_wand->wand.images),geometry.width,geometry.height,
            (size_t) geometry.x,geometry_info.psi,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("clamp",option+1) == 0)
        {
          (void) ClampImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("clip",option+1) == 0)
        {
          if ((*option=='-'))
            (void) ClipImage((cli_wand->wand.images),(cli_wand->wand.exception));
          else
            (void) SetImageMask((cli_wand->wand.images),WritePixelMask,(const Image *) 
# 2024 "MagickWand/operation.c" 3 4
                                                                     ((void *)0)
# 2024 "MagickWand/operation.c"
                                                                         ,
              (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("clip-mask",option+1) == 0)
        {
          ...
          if ((*option!='-')) {
            ...
            (void) SetImageMask((cli_wand->wand.images),WritePixelMask,(const Image *) 
# 2035 "MagickWand/operation.c" 3 4
                                                                     ((void *)0)
# 2035 "MagickWand/operation.c"
                                                                         ,
             (cli_wand->wand.exception));
            break;
          }
          clip_mask=GetImageCache((cli_wand->wand.image_info),arg1,(cli_wand->wand.exception));
          if (clip_mask == (Image *) 
# 2040 "MagickWand/operation.c" 3 4
                                    ((void *)0)
# 2040 "MagickWand/operation.c"
                                        )
            break;
          (void) SetImageMask((cli_wand->wand.images),WritePixelMask,clip_mask,(cli_wand->wand.exception));
          clip_mask=DestroyImage(clip_mask);
          break;
        }
      if (LocaleCompare("clip-path",option+1) == 0)
        {
          (void) ClipImagePath((cli_wand->wand.images),arg1,(*option=='-') ? MagickTrue : MagickFalse,(cli_wand->wand.exception));
      ...
      if (LocaleCompare("colorize",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2055,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=ColorizeImage((cli_wand->wand.images),arg1,&(cli_wand->draw_info)->fill,(cli_wand->wand.exception));
          break;
        }
...
# 2065 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 2065 "MagickWand/operation.c"
                                          )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2066,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=ColorMatrixImage((cli_wand->wand.images),kernel,(cli_wand->wand.exception));
      ...
      if (LocaleCompare("colors",option+1) == 0)
        {
          ...
          (cli_wand->quantize_info)->number_colors=StringToUnsignedLong(arg1);
          (cli_wand->quantize_info)->measure_error=(cli_wand->wand.image_info)->verbose;
          if ((cli_wand->quantize_info)->number_colors == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2079,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if (((cli_wand->wand.images)->storage_class == DirectClass) ||
              (cli_wand->wand.images)->colors > (cli_wand->quantize_info)->number_colors)
            (void) QuantizeImage((cli_wand->quantize_info),(cli_wand->wand.images),(cli_wand->wand.exception));
          else
            (void) CompressImageColormap((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("colorspace",option+1) == 0)
        {
# 2099 "MagickWand/operation.c"
          (void) TransformImageColorspace((cli_wand->wand.images),
                    (*option=='-') ? (cli_wand->wand.image_info)->colorspace : sRGBColorspace,
                    (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("color-threshold",option+1) == 0)
        {
          ...
          if (*option == '+')
            (void) GetColorRange("white-black",&start,&stop,(cli_wand->wand.exception));
          else
            (void) GetColorRange(arg1,&start,&stop,(cli_wand->wand.exception));
          (void) ColorThresholdImage((cli_wand->wand.images),&start,&stop,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("connected-components",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2123,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=ConnectedComponentsImage((cli_wand->wand.images),(size_t)
            StringToInteger(arg1),(CCObjectInfo **) 
# 2125 "MagickWand/operation.c" 3 4
                                                   ((void *)0)
# 2125 "MagickWand/operation.c"
                                                       ,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("contrast",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2130,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,(*option=='-')?"-level":"+level");
          (void) ContrastImage((cli_wand->wand.images),(*option=='-') ? MagickTrue : MagickFalse,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("contrast-stretch",option+1) == 0)
        {
          ...
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2142,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          black_point=geometry_info.rho;
          white_point=(flags & SigmaValue) != 0 ? geometry_info.sigma :
            black_point;
          if ((flags & PercentValue) != 0)
            {
              black_point*=(double) (cli_wand->wand.images)->columns*(cli_wand->wand.images)->rows/100.0;
              white_point*=(double) (cli_wand->wand.images)->columns*(cli_wand->wand.images)->rows/100.0;
            }
          white_point=(double) (cli_wand->wand.images)->columns*(cli_wand->wand.images)->rows-white_point;
          (void) ContrastStretchImage((cli_wand->wand.images),black_point,white_point,
            (cli_wand->wand.exception));
          break;
        }
...
# 2168 "MagickWand/operation.c" 3 4
                                           ((void *)0)
# 2168 "MagickWand/operation.c"
                                               )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2169,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          gamma=0.0;
          for (j=0; j < (ssize_t) (kernel_info->width*kernel_info->height); j++)
            gamma+=kernel_info->values[j];
          gamma=1.0/(fabs((double) gamma) <= 1.0e-12 ? 1.0 : gamma);
          for (j=0; j < (ssize_t) (kernel_info->width*kernel_info->height); j++)
            kernel_info->values[j]*=gamma;
          new_image=MorphologyImage((cli_wand->wand.images),CorrelateMorphology,1,kernel_info,
            (cli_wand->wand.exception));
      ...
      if (LocaleCompare("crop",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2185,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=CropImageToTiles((cli_wand->wand.images),arg1,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("cycle",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2192,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) CycleColormapImage((cli_wand->wand.images),(ssize_t) StringToLong(arg1),
            (cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2197,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'd':
    {
      if (LocaleCompare("decipher",option+1) == 0)
        {
          ...
          passkey=FileToStringInfo(arg1,~0UL,(cli_wand->wand.exception));
          if (passkey == (StringInfo *) 
# 2208 "MagickWand/operation.c" 3 4
                                       ((void *)0)
# 2208 "MagickWand/operation.c"
                                           )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2209,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };

          (void) PasskeyDecipherImage((cli_wand->wand.images),passkey,(cli_wand->wand.exception));
          passkey=DestroyStringInfo(passkey);
          break;
        }
      if (LocaleCompare("depth",option+1) == 0)
        {
# 2225 "MagickWand/operation.c"
          (void) SetImageDepth((cli_wand->wand.images),(cli_wand->wand.image_info)->depth,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("deskew",option+1) == 0)
        {
          ...
          if ((*option=='-')) {
            if (IsGeometry(arg1) == MagickFalse)
              { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2235,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
            threshold=StringToDoubleInterval(arg1,(double) ((Quantum) 65535.0)+1.0);
          }
          else
            threshold=40.0*(double) ((Quantum) 65535.0)/100.0;
          new_image=DeskewImage((cli_wand->wand.images),threshold,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("despeckle",option+1) == 0)
        {
          new_image=DespeckleImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("distort",option+1) == 0)
        {
          ...
          if ( parse < 0 )
             { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2258,OptionError,"UnrecognizedDistortMethod", "'%s' '%s'",option, arg1); break; }
                                                  ;
          if ((DistortMethod) parse == ResizeDistortion)
            {
               ...
               if (IsGeometry(arg2) == MagickFalse)
                 { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2269,OptionError,"InvalidGeometry", "'%s' '%s'",option, arg2); break; }
                                                       ;
               (void) ParseRegionGeometry((cli_wand->wand.images),arg2,&geometry,(cli_wand->wand.exception));
               resize_args[0]=(double) geometry.width;
               resize_args[1]=(double) geometry.height;
               new_image=DistortImage((cli_wand->wand.images),(DistortMethod) parse,
                    (size_t)2,resize_args,MagickTrue,(cli_wand->wand.exception));
               break;
            }

          args = StringToArrayOfDoubles(arg2,&count,(cli_wand->wand.exception));
          if (args == (double *) 
# 2280 "MagickWand/operation.c" 3 4
                                ((void *)0) 
# 2280 "MagickWand/operation.c"
                                     )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2281,OptionError,"InvalidNumberList", "'%s' '%s'",option, arg2); break; };

          new_image=DistortImage((cli_wand->wand.images),(DistortMethod) parse,(size_t)
             count,args,(*option=='-') ? MagickFalse : MagickTrue,(cli_wand->wand.exception));
          args=(double *) RelinquishMagickMemory(args);
          break;
        }
      if (LocaleCompare("draw",option+1) == 0)
        {
          (void) CloneString(&(cli_wand->draw_info)->primitive,arg1);
          (void) DrawImage((cli_wand->wand.images),(cli_wand->draw_info),(cli_wand->wand.exception));
          (void) CloneString(&(cli_wand->draw_info)->primitive,(char *) 
# 2292 "MagickWand/operation.c" 3 4
                                                            ((void *)0)
# 2292 "MagickWand/operation.c"
                                                                );
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2295,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'e':
    {
      if (LocaleCompare("edge",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2303,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=EdgeImage((cli_wand->wand.images),geometry_info.rho,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("emboss",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2311,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          new_image=EmbossImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("encipher",option+1) == 0)
        {
          ...
          passkey=FileToStringInfo(arg1,~0UL,(cli_wand->wand.exception));
          if (passkey != (StringInfo *) 
# 2325 "MagickWand/operation.c" 3 4
                                       ((void *)0)
# 2325 "MagickWand/operation.c"
                                           )
            {
              (void) PasskeyEncipherImage((cli_wand->wand.images),passkey,(cli_wand->wand.exception));
              passkey=DestroyStringInfo(passkey);
            }
          break;
        }
      if (LocaleCompare("enhance",option+1) == 0)
        {
          new_image=EnhanceImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("equalize",option+1) == 0)
        {
          (void) EqualizeImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("evaluate",option+1) == 0)
        {
          ...
          if ( parse < 0 )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2349,OptionError,"UnrecognizedEvaluateOperator", "'%s' '%s'",option, arg1); break; }
                             ;
          if (IsGeometry(arg2) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2352,OptionError,"InvalidArgument", "'%s' '%s'",option, arg2); break; };
          constant=StringToDoubleInterval(arg2,(double) ((Quantum) 65535.0)+1.0);
          (void) EvaluateImage((cli_wand->wand.images),(MagickEvaluateOperator)parse,constant,
               (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("extent",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2361,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          flags=ParseGravityGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          if (geometry.width == 0)
            geometry.width=(cli_wand->wand.images)->columns;
          if (geometry.height == 0)
            geometry.height=(cli_wand->wand.images)->rows;
          new_image=ExtentImage((cli_wand->wand.images),&geometry,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2370,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'f':
    {
      if (LocaleCompare("features",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2376,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-verbose -define identify:features=");
          if (*option == '+')
            {
              (void) DeleteImageArtifact((cli_wand->wand.images),"identify:features");
              break;
            }
          (void) SetImageArtifact((cli_wand->wand.images),"identify:features",arg1);
          (void) SetImageArtifact((cli_wand->wand.images),"verbose","true");
          break;
        }
      if (LocaleCompare("flip",option+1) == 0)
        {
          new_image=FlipImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("flop",option+1) == 0)
        {
          new_image=FlopImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("floodfill",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2402,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ParsePageGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          (void) QueryColorCompliance(arg2,AllCompliance,&target,(cli_wand->wand.exception));
          (void) FloodfillPaintImage((cli_wand->wand.images),(cli_wand->draw_info),&target,geometry.x,
            geometry.y,(*option=='-') ? MagickFalse : MagickTrue,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("frame",option+1) == 0)
        {
          ...
          value=GetImageOption((cli_wand->wand.image_info),"compose");
            compose=OverCompositeOp;
          if (value != (const char *) 
# 2422 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 2422 "MagickWand/operation.c"
                                         )
            compose=(CompositeOperator) ParseCommandOption(MagickComposeOptions,
              MagickFalse,value);
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2426,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          flags=ParsePageGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          ...
          frame_info.width=(cli_wand->wand.images)->columns+2*frame_info.width;
          frame_info.height=(cli_wand->wand.images)->rows+2*frame_info.height;
          new_image=FrameImage((cli_wand->wand.images),&frame_info,compose,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("function",option+1) == 0)
        {
          ...
          if ( parse < 0 )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2449,OptionError,"UnrecognizedFunction", "'%s' '%s'",option, arg1); break; }
                             ;

          args = StringToArrayOfDoubles(arg2,&count,(cli_wand->wand.exception));
          if (args == (double *) 
# 2453 "MagickWand/operation.c" 3 4
                                ((void *)0) 
# 2453 "MagickWand/operation.c"
                                     )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2454,OptionError,"InvalidNumberList", "'%s' '%s'",option, arg2); break; };

          (void) FunctionImage((cli_wand->wand.images),(MagickFunction)parse,(size_t) count,args,
               (cli_wand->wand.exception));
          args=(double *) RelinquishMagickMemory(args);
          break;
        }
      if (LocaleCompare("fx",option+1) == 0)
        {
          new_image=FxImage((cli_wand->wand.images),arg1,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2466,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'g':
    {
      if (LocaleCompare("gamma",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2476,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          constant=StringToDouble(arg1,(char **) 
# 2477 "MagickWand/operation.c" 3 4
                                                ((void *)0)
# 2477 "MagickWand/operation.c"
                                                    );
          ...
          (void) EvaluateImage((cli_wand->wand.images),PowEvaluateOperator,constant,(cli_wand->wand.exception));
          (cli_wand->wand.images)->gamma*=StringToDouble(arg1,(char **) 
# 2488 "MagickWand/operation.c" 3 4
                                                      ((void *)0)
# 2488 "MagickWand/operation.c"
                                                          );
      ...
      if (LocaleCompare("gaussian-blur",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2499,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          new_image=GaussianBlurImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("gaussian",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2508,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-gaussian-blur");
          (void) CLISimpleOperatorImage(cli_wand,"-gaussian-blur",arg1,
# 2509 "MagickWand/operation.c" 3 4
                                                                      ((void *)0)
# 2509 "MagickWand/operation.c"
                                                                          ,exception);
        }
      if (LocaleCompare("geometry",option+1) == 0)
        {
          ...
          if ((*option!='-'))
            {
              if ((cli_wand->wand.images)->geometry != (char *) 
# 2521 "MagickWand/operation.c" 3 4
                                              ((void *)0)
# 2521 "MagickWand/operation.c"
                                                  )
                (cli_wand->wand.images)->geometry=DestroyString((cli_wand->wand.images)->geometry);
              break;
            }
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2526,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          flags=ParseRegionGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          if (((flags & XValue) != 0) || ((flags & YValue) != 0))
            (void) CloneString(&(cli_wand->wand.images)->geometry,arg1);
          else
            new_image=ResizeImage((cli_wand->wand.images),geometry.width,geometry.height,
              (cli_wand->wand.images)->filter,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("grayscale",option+1) == 0)
        {
          parse=ParseCommandOption(MagickPixelIntensityOptions,
            MagickFalse,arg1);
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2540,OptionError,"UnrecognizedIntensityMethod", "'%s' '%s'",option, arg1); break; }
                          ;
          (void) GrayscaleImage((cli_wand->wand.images),(PixelIntensityMethod) parse,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2545,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'h':
    {
      if (LocaleCompare("hough-lines",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2553,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=geometry_info.rho;
          if ((flags & XiValue) == 0)
            geometry_info.xi=40;
          new_image=HoughLineImage((cli_wand->wand.images),(size_t) geometry_info.rho,
            (size_t) geometry_info.sigma,(size_t) geometry_info.xi,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2562,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'i':
    {
      if (LocaleCompare("identify",option+1) == 0)
        {
          ...
          format=GetImageOption((cli_wand->wand.image_info),"format");
          if (format == (char *) 
# 2573 "MagickWand/operation.c" 3 4
                                ((void *)0)
# 2573 "MagickWand/operation.c"
                                    )
            {
              (void) IdentifyImage((cli_wand->wand.images),
# 2575 "MagickWand/operation.c" 3 4
                                         stdout
# 2575 "MagickWand/operation.c"
                                               ,(cli_wand->wand.image_info)->verbose,
                (cli_wand->wand.exception));
              break;
            }
          text=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),format,(cli_wand->wand.exception));
          if (text == (char *) 
# 2580 "MagickWand/operation.c" 3 4
                              ((void *)0)
# 2580 "MagickWand/operation.c"
                                  )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2581,OptionWarning,"InterpretPropertyFailure", "`%s'",option); break; }
                     ;
          (void) fputs(text,
# 2583 "MagickWand/operation.c" 3 4
                           stdout
# 2583 "MagickWand/operation.c"
                                 );
      ...
      if (LocaleCompare("implode",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2591,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=ImplodeImage((cli_wand->wand.images),geometry_info.rho,(cli_wand->wand.images)->interpolate,
               (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("integral",option+1) == 0)
        {
          new_image=IntegralImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("interpolative-resize",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2606,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ParseRegionGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          new_image=InterpolativeResizeImage((cli_wand->wand.images),geometry.width,
            geometry.height,(cli_wand->wand.images)->interpolate,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2612,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'k':
    {
      if (LocaleCompare("kmeans",option+1) == 0)
        {
          ...
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2623,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=300.0;
          if ((flags & XiValue) == 0)
            geometry_info.xi=0.0001;
          (void) KmeansImage((cli_wand->wand.images),(size_t) geometry_info.rho,(size_t)
           geometry_info.sigma,geometry_info.xi,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("kuwahara",option+1) == 0)
        {
          ...
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2639,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=geometry_info.rho-0.5;
          new_image=KuwaharaImage((cli_wand->wand.images),geometry_info.rho,geometry_info.sigma,
           (cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2646,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'l':
    {
      if (LocaleCompare("lat",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2654,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          if ((flags & PercentValue) != 0)
            geometry_info.xi=(double) ((Quantum) 65535.0)*geometry_info.xi/100.0;
          new_image=AdaptiveThresholdImage((cli_wand->wand.images),(size_t) geometry_info.rho,
      ...
      if (LocaleCompare("level",option+1) == 0)
        {
          ...
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2673,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          black_point=geometry_info.rho;
          white_point=(double) ((Quantum) 65535.0);
          if ((flags & SigmaValue) != 0)
          ...
          if ((flags & PercentValue) != 0)
            {
              black_point*=(double) ((Quantum) 65535.0)/100.0;
              white_point*=(double) ((Quantum) 65535.0)/100.0;
            }
          if ((flags & SigmaValue) == 0)
            white_point=(double) ((Quantum) 65535.0)-black_point;
          if ((*option!='-') || ((flags & AspectValue) != 0))
            (void) LevelizeImage((cli_wand->wand.images),black_point,white_point,gamma,(cli_wand->wand.exception));
          else
            (void) LevelImage((cli_wand->wand.images),black_point,white_point,gamma,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("level-colors",option+1) == 0)
        {
          ...
          (void) GetNextToken(p,&p,4096,token);
          if ((
# 2708 "MagickWand/operation.c" 3 4
              ((*__ctype_b_loc ())[(int) ((
# 2708 "MagickWand/operation.c"
              (int) ((unsigned char) *token)
# 2708 "MagickWand/operation.c" 3 4
              ))] & (unsigned short int) _ISalpha) 
# 2708 "MagickWand/operation.c"
            ...
            (void) QueryColorCompliance(token,AllCompliance,
                      &black_point,(cli_wand->wand.exception));
          else
            (void) QueryColorCompliance("#000000",AllCompliance,
                      &black_point,(cli_wand->wand.exception));
          if (
# 2714 "MagickWand/operation.c" 3 4
             ((*__ctype_b_loc ())[(int) ((
# 2714 "MagickWand/operation.c"
             (int) ((unsigned char) *token)
# 2714 "MagickWand/operation.c" 3 4
             ))] & (unsigned short int) _ISalpha) 
# 2714 "MagickWand/operation.c"
          ...
          if (*token == '\0')
            ...
            {
              if ((
# 2720 "MagickWand/operation.c" 3 4
                  ((*__ctype_b_loc ())[(int) ((
# 2720 "MagickWand/operation.c"
                  (int) ((unsigned char) *token)
# 2720 "MagickWand/operation.c" 3 4
                  ))] & (unsigned short int) _ISalpha) 
# 2720 "MagickWand/operation.c"
                ...
                (void) GetNextToken(p,&p,4096,token);
              if ((
# 2722 "MagickWand/operation.c" 3 4
                  ((*__ctype_b_loc ())[(int) ((
# 2722 "MagickWand/operation.c"
                  (int) ((unsigned char) *token)
# 2722 "MagickWand/operation.c" 3 4
                  ))] & (unsigned short int) _ISalpha) 
# 2722 "MagickWand/operation.c"
                                                          != 0) || ((*token == '#') != 0))
                (void) QueryColorCompliance(token,AllCompliance,
                           &white_point,(cli_wand->wand.exception));
              else
                (void) QueryColorCompliance("#ffffff",AllCompliance,
                           &white_point,(cli_wand->wand.exception));
            }
          (void) LevelImageColors((cli_wand->wand.images),&black_point,&white_point,
                     (*option=='-') ? MagickFalse : MagickTrue,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("linear-stretch",option+1) == 0)
        {
          ...
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2741,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          black_point=geometry_info.rho;
          white_point=(double) (cli_wand->wand.images)->columns*(cli_wand->wand.images)->rows;
          if ((flags & SigmaValue) != 0)
            white_point=geometry_info.sigma;
          if ((flags & PercentValue) != 0)
            {
          ...
          if ((flags & SigmaValue) == 0)
            white_point=(double) (cli_wand->wand.images)->columns*(cli_wand->wand.images)->rows-
              black_point;
          (void) LinearStretchImage((cli_wand->wand.images),black_point,white_point,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("liquid-rescale",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2761,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          flags=ParseRegionGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          if ((flags & XValue) == 0)
            geometry.x=1;
          if ((flags & YValue) == 0)
            geometry.y=0;
          new_image=LiquidRescaleImage((cli_wand->wand.images),geometry.width,
            geometry.height,1.0*geometry.x,1.0*geometry.y,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("local-contrast",option+1) == 0)
        {
          ...
          new_image=LocalContrastImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,exception);
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2782,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'm':
    {
      if (LocaleCompare("magnify",option+1) == 0)
        {
          new_image=MagnifyImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("map",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2793,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-remap");
          (void) CLISimpleOperatorImage(cli_wand,"-remap",arg1,
# 2794 "MagickWand/operation.c" 3 4
                                                              ((void *)0)
# 2794 "MagickWand/operation.c"
                                                                  ,exception);
          break;
        }
          ...
          if ((*option!='-'))
            {
              ...
              (void) SetImageMask((cli_wand->wand.images),WritePixelMask,(const Image *) 
# 2807 "MagickWand/operation.c" 3 4
                                                                       ((void *)0)
# 2807 "MagickWand/operation.c"
                                                                           ,
                (cli_wand->wand.exception));
              break;
            }
          ...
          mask=GetImageCache((cli_wand->wand.image_info),arg1,(cli_wand->wand.exception));
          if (mask == (Image *) 
# 2815 "MagickWand/operation.c" 3 4
                               ((void *)0)
# 2815 "MagickWand/operation.c"
                                   )
            break;
          (void) SetImageMask((cli_wand->wand.images),WritePixelMask,mask,(cli_wand->wand.exception));
          mask=DestroyImage(mask);
          break;
        }
      if (LocaleCompare("matte",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2823,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,(*option=='-')?"-alpha Set":"-alpha Off");
          (void) SetImageAlphaChannel((cli_wand->wand.images),(*option=='-') ? SetAlphaChannel :
            DeactivateAlphaChannel, (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("mean-shift",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2832,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          if ((flags & XiValue) == 0)
            geometry_info.xi=0.10*(double) ((Quantum) 65535.0);
          if ((flags & PercentValue) != 0)
            geometry_info.xi=(double) ((Quantum) 65535.0)*geometry_info.xi/100.0;
          new_image=MeanShiftImage((cli_wand->wand.images),(size_t) geometry_info.rho,
            (size_t) geometry_info.sigma,geometry_info.xi,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("median",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2845,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-statistic Median");
      ...
      if (LocaleCompare("mode",option+1) == 0)
        {
          ...
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2852,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-statistic Mode");
      ...
      if (LocaleCompare("modulate",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2860,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ModulateImage((cli_wand->wand.images),arg1,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("monitor",option+1) == 0)
        {
          (void) SetImageProgressMonitor((cli_wand->wand.images), (*option=='-') ? MonitorProgress :
            (MagickProgressMonitor) 
# 2867 "MagickWand/operation.c" 3 4
                                   ((void *)0)
# 2867 "MagickWand/operation.c"
                                       ,(void *) 
# 2867 "MagickWand/operation.c" 3 4
                                                 ((void *)0)
# 2867 "MagickWand/operation.c"
      ...
      if (LocaleCompare("moments",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2872,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-verbose -define identify:moments=");
          if (*option == '+')
            {
              (void) DeleteImageArtifact((cli_wand->wand.images),"identify:moments");
              break;
            }
          (void) SetImageArtifact((cli_wand->wand.images),"identify:moments","true");
          (void) SetImageArtifact((cli_wand->wand.images),"verbose","true");
          break;
        }
      if (LocaleCompare("monochrome",option+1) == 0)
        {
          (void) SetImageType((cli_wand->wand.images),BilevelType,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("morphology",option+1) == 0)
        {
          ...
          if ( parse < 0 )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2905,OptionError,"UnrecognizedFunction", "'%s' '%s'",option, arg1); break; }
                   ;
          iterations=1L;
          (void) GetNextToken(p,&p,4096,token);
          if ((*p == ':') || (*p == ','))
          ...
          if (kernel == (KernelInfo *) 
# 2914 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 2914 "MagickWand/operation.c"
                                          )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2915,OptionError,"UnabletoParseKernel", "'%s' '%s'",option, arg2); break; };
          new_image=MorphologyImage((cli_wand->wand.images),(MorphologyMethod)parse,iterations,
            kernel,(cli_wand->wand.exception));
          kernel=DestroyKernelInfo(kernel);
          break;
        }
      if (LocaleCompare("motion-blur",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2925,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          new_image=MotionBlurImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,geometry_info.xi,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2932,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'n':
    {
      if (LocaleCompare("negate",option+1) == 0)
        {
          (void) NegateImage((cli_wand->wand.images), (*option=='-') ? MagickFalse : MagickTrue, (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("noise",option+1) == 0)
        {
          ...
          if ((*option=='-'))
            {
              if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2951,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-statistic NonPeak");
          ...
          if ( parse < 0 )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2957,OptionError,"UnrecognizedNoiseType", "'%s' '%s'",option, arg1); break; }
                            ;
          attenuate=1.0;
          value=GetImageOption((cli_wand->wand.image_info),"attenuate");
          if (value != (const char *) 
# 2961 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 2961 "MagickWand/operation.c"
                                          )
            attenuate=StringToDouble(value,(char **) 
# 2962 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 2962 "MagickWand/operation.c"
                                                        );
          new_image=AddNoiseImage((cli_wand->wand.images),(NoiseType)parse,attenuate,
               (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("normalize",option+1) == 0)
        {
          (void) NormalizeImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2972,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'o':
    {
      if (LocaleCompare("opaque",option+1) == 0)
        {
          ...
          (void) QueryColorCompliance(arg1,AllCompliance,&target,(cli_wand->wand.exception));
          (void) OpaquePaintImage((cli_wand->wand.images),&target,&(cli_wand->draw_info)->fill,(*option=='-') ? MagickFalse : MagickTrue,
               (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("ordered-dither",option+1) == 0)
        {
          (void) OrderedDitherImage((cli_wand->wand.images),arg1,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2991,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'p':
    {
      if (LocaleCompare("paint",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 2999,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=OilPaintImage((cli_wand->wand.images),geometry_info.rho,geometry_info.sigma,
               (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("perceptible",option+1) == 0)
        {
          (void) PerceptibleImage((cli_wand->wand.images),StringToDouble(arg1,(char **) 
# 3006 "MagickWand/operation.c" 3 4
                                                                      ((void *)0)
# 3006 "MagickWand/operation.c"
                                                                          ),
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("polaroid",option+1) == 0)
        {
          ...
          if ((*option!='-')) {
            ...
            flags=ParseGeometry(arg1,&geometry_info);
            if ((flags & RhoValue) == 0)
              { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3029,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
            angle=geometry_info.rho;
          }
          caption=GetImageProperty((cli_wand->wand.images),"caption",(cli_wand->wand.exception));
          new_image=PolaroidImage((cli_wand->wand.images),(cli_wand->draw_info),caption,angle,
            (cli_wand->wand.images)->interpolate,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("posterize",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3041,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) PosterizeImage((cli_wand->wand.images),(size_t) geometry_info.rho,
            (cli_wand->quantize_info)->dither_method,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("preview",option+1) == 0)
        {
          ...
          if ( parse < 0 )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3054,OptionError,"UnrecognizedPreviewType", "'%s' '%s'",option, arg1); break; }
                            ;
          new_image=PreviewImage((cli_wand->wand.images),(PreviewType)parse,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("profile",option+1) == 0)
        {
          ...
          if ((*option!='-'))
            {
              (void) ProfileImage((cli_wand->wand.images),arg1,(const unsigned char *)
                
# 3077 "MagickWand/operation.c" 3 4
               ((void *)0)
# 3077 "MagickWand/operation.c"
                   ,0,(cli_wand->wand.exception));
              break;
            }

          profile_info=CloneImageInfo((cli_wand->wand.image_info));
          profile=GetImageProfile((cli_wand->wand.images),"iptc");
          if (profile != (const StringInfo *) 
# 3083 "MagickWand/operation.c" 3 4
                                             ((void *)0)
# 3083 "MagickWand/operation.c"
                                                 )
            profile_info->profile=(void *) CloneStringInfo(profile);
          profile_image=GetImageCache(profile_info,arg1,(cli_wand->wand.exception));
          profile_info=DestroyImageInfo(profile_info);
          if (profile_image == (Image *) 
# 3087 "MagickWand/operation.c" 3 4
                                        ((void *)0)
# 3087 "MagickWand/operation.c"
                                            )
            {
              StringInfo
                *new_profile;
              ...
              new_profile=FileToStringInfo(profile_info->filename,~0UL,
                (cli_wand->wand.exception));
              if (new_profile != (StringInfo *) 
# 3097 "MagickWand/operation.c" 3 4
                                               ((void *)0)
# 3097 "MagickWand/operation.c"
                                                   )
                {
                  (void) SetImageInfo(profile_info,0,(cli_wand->wand.exception));
                  (void) ProfileImage((cli_wand->wand.images),profile_info->magick,
                    GetStringInfoDatum(new_profile),(size_t)
                    GetStringInfoLength(new_profile),(cli_wand->wand.exception));
          ...
          while (name != (const char *) 
# 3110 "MagickWand/operation.c" 3 4
                                       ((void *)0)
# 3110 "MagickWand/operation.c"
                                           )
          {
            profile=GetImageProfile(profile_image,name);
            if (profile != (const StringInfo *) 
# 3113 "MagickWand/operation.c" 3 4
                                               ((void *)0)
# 3113 "MagickWand/operation.c"
                                                   )
              (void) ProfileImage((cli_wand->wand.images),name,GetStringInfoDatum(profile),
                (size_t) GetStringInfoLength(profile),(cli_wand->wand.exception));
            name=GetNextImageProfile(profile_image);
          }
          profile_image=DestroyImage(profile_image);
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3121,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'r':
    {
      if (LocaleCompare("raise",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3128,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          flags=ParsePageGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          (void) RaiseImage((cli_wand->wand.images),&geometry,(*option=='-') ? MagickTrue : MagickFalse,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("random-threshold",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3140,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          min_threshold=0.0;
          max_threshold=(double) ((Quantum) 65535.0);
          flags=ParseGeometry(arg1,&geometry_info);
          ...
          if (arg1 == (char *) 
# 3148 "MagickWand/operation.c" 3 4
                              ((void *)0)
# 3148 "MagickWand/operation.c"
                                  )
            break;
          if (strchr(arg1,'%') != (char *) 
# 3150 "MagickWand/operation.c" 3 4
                                          ((void *)0)
# 3150 "MagickWand/operation.c"
                                              )
            {
              max_threshold*=(0.01*(double) ((Quantum) 65535.0));
              min_threshold*=(0.01*(double) ((Quantum) 65535.0));
            }
          (void) RandomThresholdImage((cli_wand->wand.images),min_threshold,max_threshold,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("range-threshold",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3165,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=geometry_info.rho;
          if ((flags & XiValue) == 0)
          ...
          if (strchr(arg1,'%') != (char *) 
# 3173 "MagickWand/operation.c" 3 4
                                          ((void *)0)
# 3173 "MagickWand/operation.c"
                                              )
            {
              geometry_info.rho*=(0.01*(double) ((Quantum) 65535.0));
              geometry_info.sigma*=(0.01*(double) ((Quantum) 65535.0));
              geometry_info.xi*=(0.01*(double) ((Quantum) 65535.0));
              geometry_info.psi*=(0.01*(double) ((Quantum) 65535.0));
            }
          (void) RangeThresholdImage((cli_wand->wand.images),geometry_info.rho,
      ...
      if (LocaleCompare("read-mask",option+1) == 0)
        {
          ...
          if ((*option!='-'))
            {
              (void) SetImageMask((cli_wand->wand.images),ReadPixelMask,(const Image *) 
# 3192 "MagickWand/operation.c" 3 4
                                                                      ((void *)0)
# 3192 "MagickWand/operation.c"
                                                                          ,
                (cli_wand->wand.exception));
              break;
            }
          ...
          mask=GetImageCache((cli_wand->wand.image_info),arg1,(cli_wand->wand.exception));
          if (mask == (Image *) 
# 3198 "MagickWand/operation.c" 3 4
                               ((void *)0)
# 3198 "MagickWand/operation.c"
                                   )
            break;
          (void) SetImageMask((cli_wand->wand.images),ReadPixelMask,mask,(cli_wand->wand.exception));
          mask=DestroyImage(mask);
          break;
        }
      if (LocaleCompare("recolor",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3206,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-color-matrix");
          (void) CLISimpleOperatorImage(cli_wand,"-color-matrix",arg1,
# 3207 "MagickWand/operation.c" 3 4
                                                                     ((void *)0)
# 3207 "MagickWand/operation.c"
                                                                         ,
            exception);
        }
      if (LocaleCompare("region",option+1) == 0)
        {
          if (*option == '+')
            {
              (void) SetImageRegionMask((cli_wand->wand.images),WritePixelMask,
                (const RectangleInfo *) 
# 3215 "MagickWand/operation.c" 3 4
                                       ((void *)0)
# 3215 "MagickWand/operation.c"
                                           ,(cli_wand->wand.exception));
              break;
            }
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3219,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ParseGravityGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          (void) SetImageRegionMask((cli_wand->wand.images),WritePixelMask,&geometry,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("remap",option+1) == 0)
        {
          ...
          remap_image=GetImageCache((cli_wand->wand.image_info),arg1,(cli_wand->wand.exception));
          if (remap_image == (Image *) 
# 3231 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 3231 "MagickWand/operation.c"
                                          )
            break;
          (void) RemapImage((cli_wand->quantize_info),(cli_wand->wand.images),remap_image,(cli_wand->wand.exception));
      ...
      if (LocaleCompare("repage",option+1) == 0)
        {
          if ((*option=='-'))
            {
              if (IsGeometry(arg1) == MagickFalse)
                { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3242,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; }
                       ;
              (void) ResetImagePage((cli_wand->wand.images),arg1);
            }
          else
            (void) ParseAbsoluteGeometry("0x0+0+0",&(cli_wand->wand.images)->page);
          break;
        }
      if (LocaleCompare("resample",option+1) == 0)
        {
          ...
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3255,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=geometry_info.rho;
          new_image=ResampleImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,(cli_wand->wand.images)->filter,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("reshape",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3265,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ParseRegionGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          (void) ReshapePixelCache((cli_wand->wand.images),geometry.width,geometry.height,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("resize",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3274,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ParseRegionGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          new_image=ResizeImage((cli_wand->wand.images),geometry.width,geometry.height,
            (cli_wand->wand.images)->filter,(cli_wand->wand.exception));
          break;
      ...
      if (LocaleCompare("roll",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3283,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          flags=ParsePageGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          if ((flags & PercentValue) != 0)
            {
              geometry.x*=(double) (cli_wand->wand.images)->columns/100.0;
              geometry.y*=(double) (cli_wand->wand.images)->rows/100.0;
            }
          new_image=RollImage((cli_wand->wand.images),geometry.x,geometry.y,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("rotate",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3297,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & GreaterValue) != 0 && ((cli_wand->wand.images)->columns <= (cli_wand->wand.images)->rows))
            break;
          if ((flags & LessValue) != 0 && ((cli_wand->wand.images)->columns >= (cli_wand->wand.images)->rows))
            break;
          new_image=RotateImage((cli_wand->wand.images),geometry_info.rho,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("rotational-blur",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3309,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=RotationalBlurImage((cli_wand->wand.images),geometry_info.rho,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3313,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 's':
    {
      if (LocaleCompare("sample",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3321,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ParseRegionGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          new_image=SampleImage((cli_wand->wand.images),geometry.width,geometry.height,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("scale",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3331,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ParseRegionGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          new_image=ScaleImage((cli_wand->wand.images),geometry.width,geometry.height,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("segment",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3341,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          (void) SegmentImage((cli_wand->wand.images),(cli_wand->wand.images)->colorspace,
            (cli_wand->wand.image_info)->verbose,geometry_info.rho,geometry_info.sigma,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("selective-blur",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3353,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          if ((flags & PercentValue) != 0)
            geometry_info.xi=(double) ((Quantum) 65535.0)*geometry_info.xi/100.0;
          new_image=SelectiveBlurImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,geometry_info.xi,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("separate",option+1) == 0)
        {
          ...
          new_image=SeparateImages((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("sepia-tone",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3372,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=SepiaToneImage((cli_wand->wand.images),StringToDoubleInterval(arg1,
                 (double) ((Quantum) 65535.0)+1.0),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("shade",option+1) == 0)
        {
          ...
          if (((flags & RhoValue) == 0) || ((flags & SigmaValue) == 0))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3381,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=ShadeImage((cli_wand->wand.images),(*option=='-') ? MagickTrue : MagickFalse,geometry_info.rho,
               geometry_info.sigma,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("shadow",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3390,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          if ((flags & XiValue) == 0)
          ...
          new_image=ShadowImage((cli_wand->wand.images),geometry_info.rho,geometry_info.sigma,
            (ssize_t) ceil(geometry_info.xi-0.5),(ssize_t)
            ceil(geometry_info.psi-0.5),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("sharpen",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3406,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          if ((flags & XiValue) == 0)
            geometry_info.xi=0.0;
          new_image=SharpenImage((cli_wand->wand.images),geometry_info.rho,geometry_info.sigma,
           (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("shave",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3418,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          flags=ParsePageGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          new_image=ShaveImage((cli_wand->wand.images),&geometry,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("shear",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3427,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=geometry_info.rho;
          new_image=ShearImage((cli_wand->wand.images),geometry_info.rho,geometry_info.sigma,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("sigmoidal-contrast",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3438,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=(double) ((Quantum) 65535.0)/2.0;
          if ((flags & PercentValue) != 0)
            geometry_info.sigma=(double) ((Quantum) 65535.0)*geometry_info.sigma/
              100.0;
          (void) SigmoidalContrastImage((cli_wand->wand.images),(*option=='-') ? MagickTrue : MagickFalse,geometry_info.rho,
               geometry_info.sigma,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("sketch",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3452,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          new_image=SketchImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,geometry_info.xi,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("solarize",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3462,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) SolarizeImage((cli_wand->wand.images),StringToDoubleInterval(arg1,(double)
             ((Quantum) 65535.0)+1.0),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("sort-pixels",option+1) == 0)
        {
          (void) SortImagePixels((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("sparse-color",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3476,OptionError,"UnrecognizedSparseColorMethod", "'%s' '%s'",option, arg1); break; }
                          ;
          new_image=SparseColorOption((cli_wand->wand.images),(SparseColorMethod)parse,arg2,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("splice",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3485,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          flags=ParseGravityGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          new_image=SpliceImage((cli_wand->wand.images),&geometry,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("spread",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3494,OptionError,"InvalidArgument", "'%s' '%s'",option, arg2); break; };
          new_image=SpreadImage((cli_wand->wand.images),(cli_wand->wand.images)->interpolate,geometry_info.rho,
           (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("statistic",option+1) == 0)
        {
          ...
          if ( parse < 0 )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3503,OptionError,"UnrecognizedStatisticType", "'%s' '%s'",option, arg1); break; }
                             ;
          flags=ParseGeometry(arg2,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3507,OptionError,"InvalidArgument", "'%s' '%s'",option, arg2); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=geometry_info.rho;
          new_image=StatisticImage((cli_wand->wand.images),(StatisticType)parse,
      ...
      if (LocaleCompare("strip",option+1) == 0)
        {
          (void) StripImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("swirl",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3524,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=SwirlImage((cli_wand->wand.images),geometry_info.rho,
            (cli_wand->wand.images)->interpolate,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3529,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 't':
    {
      if (LocaleCompare("threshold",option+1) == 0)
        {
          ...
          threshold=(double) ((Quantum) 65535.0)/2;
          if ((*option=='-')) {
            if (IsGeometry(arg1) == MagickFalse)
              { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3541,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
            threshold=StringToDoubleInterval(arg1,(double) ((Quantum) 65535.0)+1.0);
          }
          (void) BilevelImage((cli_wand->wand.images),threshold,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("thumbnail",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3550,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) ParseRegionGeometry((cli_wand->wand.images),arg1,&geometry,(cli_wand->wand.exception));
          new_image=ThumbnailImage((cli_wand->wand.images),geometry.width,geometry.height,
            (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("tint",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3559,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          new_image=TintImage((cli_wand->wand.images),arg1,&(cli_wand->draw_info)->fill,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("transform",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3565,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"+distort AffineProjection");
          new_image=AffineTransformImage((cli_wand->wand.images),&(cli_wand->draw_info)->affine,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("transparent",option+1) == 0)
        {
          ...
          (void) QueryColorCompliance(arg1,AllCompliance,&target,(cli_wand->wand.exception));
          (void) TransparentPaintImage((cli_wand->wand.images),&target,(Quantum)
            ((Quantum) 0),(*option=='-') ? MagickFalse : MagickTrue,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("transpose",option+1) == 0)
        {
          new_image=TransposeImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("transverse",option+1) == 0)
        {
          new_image=TransverseImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("trim",option+1) == 0)
        {
          new_image=TrimImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("type",option+1) == 0)
        {

          (void) SetImageType((cli_wand->wand.images),(cli_wand->wand.image_info)->type,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3600,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'u':
    {
      if (LocaleCompare("unique",option+1) == 0)
        {
          ...
          if ((*option=='-') ? MagickFalse : MagickTrue) {
              (void) DeleteImageArtifact((cli_wand->wand.images),"identify:unique-colors");
              break;
            }
          (void) SetImageArtifact((cli_wand->wand.images),"identify:unique-colors","true");
          (void) SetImageArtifact((cli_wand->wand.images),"verbose","true");
          break;
        }
      if (LocaleCompare("unique-colors",option+1) == 0)
        {
          new_image=UniqueImageColors((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("unsharp",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3627,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          if ((flags & XiValue) == 0)
            geometry_info.xi=1.0;
          ...
          new_image=UnsharpMaskImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,geometry_info.xi,geometry_info.psi,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3638,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'v':
    {
      if (LocaleCompare("verbose",option+1) == 0)
        {
          ...
          (void) SetImageArtifact((cli_wand->wand.images),option+1,(*option=='-') ? "true" :
            "false" );
          break;
        }
      if (LocaleCompare("vignette",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3656,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          if ((flags & XiValue) == 0)
            geometry_info.xi=0.1*(cli_wand->wand.images)->columns;
          if ((flags & PsiValue) == 0)
            geometry_info.psi=0.1*(cli_wand->wand.images)->rows;
          if ((flags & PercentValue) != 0)
            {
              geometry_info.xi*=(double) (cli_wand->wand.images)->columns/100.0;
              geometry_info.psi*=(double) (cli_wand->wand.images)->rows/100.0;
            }
          new_image=VignetteImage((cli_wand->wand.images),geometry_info.rho,geometry_info.sigma,
            (ssize_t) ceil(geometry_info.xi-0.5),(ssize_t)
            ceil(geometry_info.psi-0.5),(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3673,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'w':
    {
      if (LocaleCompare("wave",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & (RhoValue|SigmaValue)) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3681,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=1.0;
          new_image=WaveImage((cli_wand->wand.images),geometry_info.rho,geometry_info.sigma,
            (cli_wand->wand.images)->interpolate,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("wavelet-denoise",option+1) == 0)
        {
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3692,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          if ((flags & PercentValue) != 0)
            {
              geometry_info.rho=(double) ((Quantum) 65535.0)*geometry_info.rho/100.0;
              geometry_info.sigma=(double) ((Quantum) 65535.0)*geometry_info.sigma/
                100.0;
            }
          if ((flags & SigmaValue) == 0)
            geometry_info.sigma=0.0;
          new_image=WaveletDenoiseImage((cli_wand->wand.images),geometry_info.rho,
            geometry_info.sigma,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("white-balance",option+1) == 0)
        {
          (void) WhiteBalanceImage((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("white-threshold",option+1) == 0)
        {
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3713,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          (void) WhiteThresholdImage((cli_wand->wand.images),arg1,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("write-mask",option+1) == 0)
        {
          ...
          if ((*option!='-'))
            {
              (void) SetImageMask((cli_wand->wand.images),WritePixelMask,(const Image *) 
# 3725 "MagickWand/operation.c" 3 4
                                                                       ((void *)0)
# 3725 "MagickWand/operation.c"
                                                                           ,
                (cli_wand->wand.exception));
              break;
            }
          ...
          mask=GetImageCache((cli_wand->wand.image_info),arg1,(cli_wand->wand.exception));
          if (mask == (Image *) 
# 3731 "MagickWand/operation.c" 3 4
                               ((void *)0)
# 3731 "MagickWand/operation.c"
                                   )
            break;
          (void) SetImageMask((cli_wand->wand.images),WritePixelMask,mask,(cli_wand->wand.exception));
          mask=DestroyImage(mask);
      ...
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3737,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    default:
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3740,OptionError,"UnrecognizedOption", "`%s'",option); break; };
  }
  ...
  if (new_image != (Image *) 
# 3750 "MagickWand/operation.c" 3 4
                            ((void *)0)
# 3750 "MagickWand/operation.c"
                                )
    ReplaceImageInListReturnLast(&(cli_wand->wand.images),new_image);

  return(MagickTrue);
# 3763 "MagickWand/operation.c"
}
...
# 3774 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 3774 "MagickWand/operation.c"
 cli_wand != (MagickCLI *) 
# 3774 "MagickWand/operation.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3774 "MagickWand/operation.c"
...
# 3774 "MagickWand/operation.c"
 "cli_wand != (MagickCLI *) NULL"
# 3774 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 3774, __extension__ __PRETTY_FUNCTION__); }))
# 3774 "MagickWand/operation.c"
                                       ;
  
# 3775 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 3775 "MagickWand/operation.c"
 cli_wand->signature == 0xabacadabUL
# 3775 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3775 "MagickWand/operation.c"
...
# 3775 "MagickWand/operation.c"
 "cli_wand->signature == MagickWandSignature"
# 3775 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 3775, __extension__ __PRETTY_FUNCTION__); }))
# 3775 "MagickWand/operation.c"
                                                   ;
  
# 3776 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 3776 "MagickWand/operation.c"
 cli_wand->wand.signature == 0xabacadabUL
# 3776 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3776 "MagickWand/operation.c"
...
# 3776 "MagickWand/operation.c"
 "cli_wand->wand.signature == MagickWandSignature"
# 3776 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 3776, __extension__ __PRETTY_FUNCTION__); }))
# 3776 "MagickWand/operation.c"
                                                        ;
  
# 3777 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 3777 "MagickWand/operation.c"
 cli_wand->wand.images != (Image *) 
# 3777 "MagickWand/operation.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3777 "MagickWand/operation.c"
...
# 3777 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 3777, __extension__ __PRETTY_FUNCTION__); }))
# 3777 "MagickWand/operation.c"
                                                ;

  if (cli_wand->wand.debug != MagickFalse)
    (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/operation.c",__func__,(unsigned long) 3780,
         "- Simple Operator: %s \"%s\" \"%s\"", option,arg1,arg2);
# 3798 "MagickWand/operation.c"
  ...
  const char *option,const char *arg1n,const char *arg2n)
{
  ...
  ssize_t
    parse;
# 3864 "MagickWand/operation.c"
  
# 3864 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 3864 "MagickWand/operation.c"
 cli_wand != (MagickCLI *) 
# 3864 "MagickWand/operation.c" 3 4
...
# 3864 "MagickWand/operation.c"
 "cli_wand != (MagickCLI *) NULL"
# 3864 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 3864, __extension__ __PRETTY_FUNCTION__); }))
# 3864 "MagickWand/operation.c"
                                       ;
  
# 3865 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 3865 "MagickWand/operation.c"
 cli_wand->signature == 0xabacadabUL
# 3865 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3865 "MagickWand/operation.c"
...
# 3865 "MagickWand/operation.c"
 "cli_wand->signature == MagickWandSignature"
# 3865 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 3865, __extension__ __PRETTY_FUNCTION__); }))
# 3865 "MagickWand/operation.c"
                                                   ;
  
# 3866 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 3866 "MagickWand/operation.c"
 cli_wand->wand.signature == 0xabacadabUL
# 3866 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3866 "MagickWand/operation.c"
...
# 3866 "MagickWand/operation.c"
 "cli_wand->wand.signature == MagickWandSignature"
# 3866 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 3866, __extension__ __PRETTY_FUNCTION__); }))
# 3866 "MagickWand/operation.c"
                                                        ;
  
# 3867 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 3867 "MagickWand/operation.c"
 (cli_wand->wand.images) != (Image *) 
# 3867 "MagickWand/operation.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3867 "MagickWand/operation.c"
...
# 3867 "MagickWand/operation.c"
 "_images != (Image *) NULL"
# 3867 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 3867, __extension__ __PRETTY_FUNCTION__); }))
# 3867 "MagickWand/operation.c"
                                  ;

  if (cli_wand->wand.debug != MagickFalse)
    (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/operation.c",__func__,(unsigned long) 3870,
       "- List Operator: %s \"%s\" \"%s\"", option,
       arg1n == (const char *) 
# 3872 "MagickWand/operation.c" 3 4
                              ((void *)0) 
# 3872 "MagickWand/operation.c"
                                   ? "null" : arg1n,
       arg2n == (const char *) 
# 3873 "MagickWand/operation.c" 3 4
                              ((void *)0) 
# 3873 "MagickWand/operation.c"
                                   ? "null" : arg2n);
  ...
  if ( ((((cli_wand->process_flags) & ProcessInterpretProperties) != 0 )
    ...
    if (arg1n != (char *) 
# 3883 "MagickWand/operation.c" 3 4
                         ((void *)0)
# 3883 "MagickWand/operation.c"
                             ) {
      arg1=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg1n,(cli_wand->wand.exception));
      if (arg1 == (char *) 
# 3885 "MagickWand/operation.c" 3 4
                          ((void *)0)
# 3885 "MagickWand/operation.c"
                              ) {
        (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3886,OptionWarning,"InterpretPropertyFailure", "`%s'",option);
        arg1=arg1n;
      }
    }
    if (arg2n != (char *) 
# 3890 "MagickWand/operation.c" 3 4
                         ((void *)0)
# 3890 "MagickWand/operation.c"
                             ) {
      arg2=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg2n,(cli_wand->wand.exception));
      if (arg2 == (char *) 
# 3892 "MagickWand/operation.c" 3 4
                          ((void *)0)
# 3892 "MagickWand/operation.c"
                              ) {
        (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3893,OptionWarning,"InterpretPropertyFailure", "`%s'",option);
        arg2=arg2n;
      }
    }
  }
  ...
  switch (*(option+1))
  {
    case 'a':
    {
      if (LocaleCompare("append",option+1) == 0)
        {
          new_images=AppendImages((cli_wand->wand.images),(*option=='-') ? MagickTrue : MagickFalse,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("average",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3915,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-evaluate-sequence Mean");
          (void) CLIListOperatorImages(cli_wand,"-evaluate-sequence","Mean",
            
# 3917 "MagickWand/operation.c" 3 4
           ((void *)0)
# 3917 "MagickWand/operation.c"
               );
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3920,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'c':
    {
      if (LocaleCompare("channel-fx",option+1) == 0)
        {
          new_images=ChannelFxImage((cli_wand->wand.images),arg1,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("clut",option+1) == 0)
        {
          ...
          new_images=RemoveFirstImageFromList(&(cli_wand->wand.images));
          clut_image=RemoveFirstImageFromList(&(cli_wand->wand.images));

          if (clut_image == (Image *) 
# 3941 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 3941 "MagickWand/operation.c"
                                         )
            {
              (void) ThrowMagickException((cli_wand->wand.exception),"MagickWand/operation.c",__func__,(unsigned long) 3943,
      ...
      if (LocaleCompare("coalesce",option+1) == 0)
        {
          new_images=CoalesceImages((cli_wand->wand.images),(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("combine",option+1) == 0)
        {
          parse=(ssize_t) (cli_wand->wand.images)->colorspace;
          if ((cli_wand->wand.images)->number_channels < GetImageListLength((cli_wand->wand.images)))
            parse=sRGBColorspace;
          if ( (*option!='-') )
            parse=ParseCommandOption(MagickColorspaceOptions,MagickFalse,arg1);
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 3967,OptionError,"UnrecognizedColorspace", "'%s' '%s'",option, arg1); break; }
                   ;
          new_images=CombineImages((cli_wand->wand.images),(ColorspaceType) parse,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("compare",option+1) == 0)
        {
          ...
          image=RemoveFirstImageFromList(&(cli_wand->wand.images));
          reconstruct_image=RemoveFirstImageFromList(&(cli_wand->wand.images));

          if (reconstruct_image == (Image *) 
# 3991 "MagickWand/operation.c" 3 4
                                            ((void *)0)
# 3991 "MagickWand/operation.c"
                                                )
            {
              (void) ThrowMagickException((cli_wand->wand.exception),"MagickWand/operation.c",__func__,(unsigned long) 3993,
                OptionError,"ImageSequenceRequired","`%s'",option);
          ...
          option=GetImageOption((cli_wand->wand.image_info),"metric");
          if (option != (const char *) 
# 4001 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 4001 "MagickWand/operation.c"
                                          )
      ...
      if (LocaleCompare("complex",option+1) == 0)
        {
          ...
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4015,OptionError,"UnrecognizedEvaluateOperator", "'%s' '%s'",option, arg1); break; }
                          ;
          new_images=ComplexImages((cli_wand->wand.images),(ComplexOperator) parse,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("composite",option+1) == 0)
        {
          ...
          value=GetImageOption((cli_wand->wand.image_info),"compose");
          if (value == (const char *) 
# 4040 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4040 "MagickWand/operation.c"
                                         )
            compose=OverCompositeOp;
          else
            compose=(CompositeOperator) ParseCommandOption(MagickComposeOptions,
          ...
          value=GetImageOption((cli_wand->wand.image_info),"compose:clip-to-self");
          if (value != (const char *) 
# 4049 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4049 "MagickWand/operation.c"
                                         )
            clip_to_self=IsStringTrue(value);
          value=GetImageOption((cli_wand->wand.image_info),"compose:outside-overlay");
          if (value != (const char *) 
# 4052 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4052 "MagickWand/operation.c"
                                         )
            clip_to_self=IsStringFalse(value);

          new_images=RemoveFirstImageFromList(&(cli_wand->wand.images));
          source_image=RemoveFirstImageFromList(&(cli_wand->wand.images));
          if (source_image == (Image *) 
# 4057 "MagickWand/operation.c" 3 4
                                       ((void *)0)
# 4057 "MagickWand/operation.c"
                                           )
            {
              (void) ThrowMagickException((cli_wand->wand.exception),"MagickWand/operation.c",__func__,(unsigned long) 4059,
                OptionError,"ImageSequenceRequired","`%s'",option);
              new_images=DestroyImage(new_images);
              status=MagickFalse;
              break;
          ...
          if (source_image->geometry != (char *) 
# 4067 "MagickWand/operation.c" 3 4
                                                ((void *)0)
# 4067 "MagickWand/operation.c"
                                                    )
            {
              RectangleInfo
                resize_geometry;
              ...
              (void) ParseRegionGeometry(source_image,source_image->geometry,
                &resize_geometry,(cli_wand->wand.exception));
              if ((source_image->columns != resize_geometry.width) ||
                  (source_image->rows != resize_geometry.height))
                {
                  ...
                  resize_image=ResizeImage(source_image,resize_geometry.width,
                    resize_geometry.height,source_image->filter,(cli_wand->wand.exception));
                  if (resize_image != (Image *) 
# 4082 "MagickWand/operation.c" 3 4
                                               ((void *)0)
# 4082 "MagickWand/operation.c"
                                                   )
                    {
          ...
          mask_image=RemoveFirstImageFromList(&(cli_wand->wand.images));
          if (mask_image == (Image *) 
# 4094 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4094 "MagickWand/operation.c"
                                         )
            status&=(MagickStatusType) CompositeImage(new_images,source_image,
              compose,clip_to_self,geometry.x,geometry.y,(cli_wand->wand.exception));
          else
            {
              Image
                *canvas_image;

              canvas_image=CloneImage(new_images,0,0,MagickTrue,(cli_wand->wand.exception));
              if (canvas_image == (Image *) 
# 4103 "MagickWand/operation.c" 3 4
                                           ((void *)0)
# 4103 "MagickWand/operation.c"
                                               )
                break;
              switch (compose)
              {
                case BlendCompositeOp:
                {
                  status&=(MagickStatusType) CompositeImage(new_images,
                    ...
                    (cli_wand->wand.exception));
                  status&=(MagickStatusType) CompositeImage(new_images,
                    mask_image,CopyAlphaCompositeOp,MagickTrue,0,0,(cli_wand->wand.exception));
                  break;
                }
                ...
                case DistortCompositeOp:
                {
                  status&=(MagickStatusType) CompositeImage(source_image,
                    mask_image,CopyGreenCompositeOp,MagickTrue,0,0,(cli_wand->wand.exception));
                ...
                default:
                {
                  ...
                  clone_image=CloneImage(new_images,0,0,MagickTrue,(cli_wand->wand.exception));
                  if (clone_image == (Image *) 
# 4144 "MagickWand/operation.c" 3 4
                                              ((void *)0)
# 4144 "MagickWand/operation.c"
                                                  )
                    break;
                  status&=(MagickStatusType) CompositeImage(new_images,
                    source_image,compose,clip_to_self,geometry.x,geometry.y,
                  ...
                  status&=(MagickStatusType) CompositeImage(clone_image,
                    new_images,OverCompositeOp,clip_to_self,0,0,(cli_wand->wand.exception));
              ...
              switch (compose)
              {
                ...
                case DistortCompositeOp:
                {
                  status&=(MagickStatusType) CompositeImage(canvas_image,
                    new_images,CopyCompositeOp,clip_to_self,0,0,(cli_wand->wand.exception));
                  break;
                }
                default:
                {
        ...
        if (LocaleCompare("copy",option+1) == 0)
          {
            ...
            if (IsGeometry(arg1) == MagickFalse)
              { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4196,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
            if (IsGeometry(arg2) == MagickFalse)
              { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4198,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
            (void) ParsePageGeometry((cli_wand->wand.images),arg2,&geometry,(cli_wand->wand.exception));
            offset.x=geometry.x;
            offset.y=geometry.y;
            source_image=(cli_wand->wand.images);
            if (source_image->next != (Image *) 
# 4203 "MagickWand/operation.c" 3 4
                                               ((void *)0)
# 4203 "MagickWand/operation.c"
                                                   )
              source_image=source_image->next;
            (void) ParsePageGeometry(source_image,arg1,&geometry,(cli_wand->wand.exception));
            (void) CopyImagePixels((cli_wand->wand.images),source_image,&geometry,&offset,
              (cli_wand->wand.exception));
            break;
          }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4210,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'd':
    {
      if (LocaleCompare("deconstruct",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4216,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"-layers CompareAny");
          (void) CLIListOperatorImages(cli_wand,"-layers","CompareAny",
# 4217 "MagickWand/operation.c" 3 4
                                                                      ((void *)0)
# 4217 "MagickWand/operation.c"
                                                                          );
          break;
        }
      if (LocaleCompare("delete",option+1) == 0)
        {
          if (!(*option=='-'))
            {
              DeleteImages(&(cli_wand->wand.images),"-1",(cli_wand->wand.exception));
              break;
            }
          if (LocaleNCompare(arg1,"registry:",9) == 0)
            {
          ...
          if (IsSceneGeometry(arg1,MagickFalse) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4233,OptionError,"InvalidArgument", "`%s'",option); break; };
          DeleteImages(&(cli_wand->wand.images),arg1,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("duplicate",option+1) == 0)
        {
          if (!(*option=='-'))
            new_images=DuplicateImages((cli_wand->wand.images),1,"-1",(cli_wand->wand.exception));
          else
            {
              const char
                *p;
              ...
              if (IsGeometry(arg1) == MagickFalse)
                { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4250,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; }
                       ;
              number_duplicates=(size_t) StringToLong(arg1);
              if (arg1 == (char *) 
# 4253 "MagickWand/operation.c" 3 4
                                  ((void *)0)
# 4253 "MagickWand/operation.c"
                                      )
                break;
              p=strchr(arg1,',');
              if (p == (const char *) 
# 4256 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4256 "MagickWand/operation.c"
                                         )
                new_images=DuplicateImages((cli_wand->wand.images),number_duplicates,"-1",
                  (cli_wand->wand.exception));
              else
                new_images=DuplicateImages((cli_wand->wand.images),number_duplicates,p+1,
                  (cli_wand->wand.exception));
            }
          AppendImageToList(&(cli_wand->wand.images), new_images);
          new_images=(Image *) 
# 4264 "MagickWand/operation.c" 3 4
                              ((void *)0)
# 4264 "MagickWand/operation.c"
                                  ;
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4267,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'e':
    {
      if (LocaleCompare("evaluate-sequence",option+1) == 0)
        {
          parse=ParseCommandOption(MagickEvaluateOptions,MagickFalse,arg1);
          if (parse < 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4275,OptionError,"UnrecognizedEvaluateOperator", "'%s' '%s'",option, arg1); break; }
                          ;
          new_images=EvaluateImages((cli_wand->wand.images),(MagickEvaluateOperator) parse,
            (cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4281,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'f':
    {
      if (LocaleCompare("fft",option+1) == 0)
        {
          new_images=ForwardFourierTransformImage((cli_wand->wand.images),(*option=='-') ? MagickTrue : MagickFalse,
           (cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("flatten",option+1) == 0)
        {
          ...
          (void) CLIListOperatorImages(cli_wand,"-layers",option+1,
# 4294 "MagickWand/operation.c" 3 4
                                                                  ((void *)0)
# 4294 "MagickWand/operation.c"
                                                                      );
          break;
        }
      if (LocaleCompare("fx",option+1) == 0)
        {
          new_images=FxImage((cli_wand->wand.images),arg1,(cli_wand->wand.exception));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4302,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'h':
    {
      if (LocaleCompare("hald-clut",option+1) == 0)
        {
          ...
          new_images=RemoveFirstImageFromList(&(cli_wand->wand.images));
          hald_image=RemoveLastImageFromList(&(cli_wand->wand.images));
          if (hald_image == (Image *) 
# 4316 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4316 "MagickWand/operation.c"
                                         )
            {
              (void) ThrowMagickException((cli_wand->wand.exception),"MagickWand/operation.c",__func__,(unsigned long) 4318,
                OptionError,"ImageSequenceRequired","`%s'",option);
              new_images=DestroyImage(new_images);
              status=MagickFalse;
              break;
            }
          (void) HaldClutImage(new_images,hald_image,(cli_wand->wand.exception));
          hald_image=DestroyImage(hald_image);
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4328,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'i':
    {
      if (LocaleCompare("ift",option+1) == 0)
        {
          ...
          magnitude_image=RemoveFirstImageFromList(&(cli_wand->wand.images));
          phase_image=RemoveFirstImageFromList(&(cli_wand->wand.images));
          if (phase_image == (Image *) 
# 4340 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 4340 "MagickWand/operation.c"
                                          )
            {
              (void) ThrowMagickException((cli_wand->wand.exception),"MagickWand/operation.c",__func__,(unsigned long) 4342,
                OptionError,"ImageSequenceRequired","`%s'",option);
          ...
          new_images=InverseFourierTransformImage(magnitude_image,phase_image,
            (*option=='-') ? MagickTrue : MagickFalse,(cli_wand->wand.exception));
          magnitude_image=DestroyImage(magnitude_image);
      ...
      if (LocaleCompare("insert",option+1) == 0)
        {
          ...
          if ((*option=='-') && (IsGeometry(arg1) == MagickFalse))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4364,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          index=0;
          insert_image=RemoveLastImageFromList(&(cli_wand->wand.images));
          if ((*option=='-'))
            index=(ssize_t) StringToLong(arg1);
          index_image=insert_image;
          if (index == 0)
            PrependImageToList(&(cli_wand->wand.images),insert_image);
          else if (index == (ssize_t) GetImageListLength((cli_wand->wand.images)))
            AppendImageToList(&(cli_wand->wand.images),insert_image);
          else
            {
               index_image=GetImageFromList((cli_wand->wand.images),index-1);
               if (index_image == (Image *) 
# 4377 "MagickWand/operation.c" 3 4
                                           ((void *)0)
# 4377 "MagickWand/operation.c"
                                               )
                 {
                   insert_image=DestroyImage(insert_image);
                   { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4380,OptionError,"NoSuchImage", "'%s' '%s'",option, arg1); break; };
                 }
              InsertImageInList(&index_image,insert_image);
            }
          (cli_wand->wand.images)=GetFirstImageInList(index_image);
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4387,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'l':
    {
      if (LocaleCompare("layers",option+1) == 0)
        {
          ...
          if ( parse < 0 )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4395,OptionError,"UnrecognizedLayerMethod", "'%s' '%s'",option, arg1); break; }
                             ;
          switch ((LayerMethod) parse)
          {
            ...
            default:
            {
              new_images=CompareImagesLayers((cli_wand->wand.images),(LayerMethod) parse,
                   (cli_wand->wand.exception));
              break;
            }
            case MergeLayer:
            ...
            {
              new_images=MergeImageLayers((cli_wand->wand.images),(LayerMethod) parse,
                (cli_wand->wand.exception));
              break;
            }
            case DisposeLayer:
            {
              new_images=DisposeImages((cli_wand->wand.images),(cli_wand->wand.exception));
              break;
            }
            case OptimizeImageLayer:
            {
              new_images=OptimizeImageLayers((cli_wand->wand.images),(cli_wand->wand.exception));
              break;
            }
            case OptimizePlusLayer:
            {
              new_images=OptimizePlusImageLayers((cli_wand->wand.images),(cli_wand->wand.exception));
              break;
            }
            case OptimizeTransLayer:
            {
              OptimizeImageTransparency((cli_wand->wand.images),(cli_wand->wand.exception));
              break;
            }
            case RemoveDupsLayer:
            {
              RemoveDuplicateLayers(&(cli_wand->wand.images),(cli_wand->wand.exception));
              break;
            }
            case RemoveZeroLayer:
            {
              RemoveZeroDelayLayers(&(cli_wand->wand.images),(cli_wand->wand.exception));
              break;
            }
            case OptimizeLayer:
            {
              new_images=CoalesceImages((cli_wand->wand.images),(cli_wand->wand.exception));
              if (new_images == (Image *) 
# 4455 "MagickWand/operation.c" 3 4
                                         ((void *)0)
# 4455 "MagickWand/operation.c"
                                             )
                break;
              (cli_wand->wand.images)=DestroyImageList((cli_wand->wand.images));
              (cli_wand->wand.images)=OptimizeImageLayers(new_images,(cli_wand->wand.exception));
              if ((cli_wand->wand.images) == (Image *) 
# 4459 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 4459 "MagickWand/operation.c"
                                          )
                break;
              new_images=DestroyImageList(new_images);
              OptimizeImageTransparency((cli_wand->wand.images),(cli_wand->wand.exception));
              (void) RemapImages((cli_wand->quantize_info),(cli_wand->wand.images),(Image *) 
# 4463 "MagickWand/operation.c" 3 4
                                                                 ((void *)0)
# 4463 "MagickWand/operation.c"
                                                                     ,
                (cli_wand->wand.exception));
              break;
            }
            case CompositeLayer:
            {
              ...
              compose=OverCompositeOp;
              if (value != (const char *) 
# 4483 "MagickWand/operation.c" 3 4
                                         ((void *)0)
# 4483 "MagickWand/operation.c"
                                             )
                compose=(CompositeOperator) ParseCommandOption(
                      MagickComposeOptions,MagickFalse,value);


              source=(cli_wand->wand.images);
              while (source != (Image *) 
# 4489 "MagickWand/operation.c" 3 4
                                        ((void *)0)
# 4489 "MagickWand/operation.c"
                                            )
              {
                source=GetNextImageInList(source);
                if ((source != (Image *) 
# 4492 "MagickWand/operation.c" 3 4
                                        ((void *)0)
# 4492 "MagickWand/operation.c"
                                            ) &&
                    (LocaleCompare(source->magick,"NULL") == 0))
                  break;
              }
              if (source != (Image *) 
# 4496 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4496 "MagickWand/operation.c"
                                         )
                {
                  if ((GetPreviousImageInList(source) == (Image *) 
# 4498 "MagickWand/operation.c" 3 4
                                                                  ((void *)0)
# 4498 "MagickWand/operation.c"
                                                                      ) ||
                      (GetNextImageInList(source) == (Image *) 
# 4499 "MagickWand/operation.c" 3 4
                                                              ((void *)0)
# 4499 "MagickWand/operation.c"
                                                                  ))
                    source=(Image *) 
# 4500 "MagickWand/operation.c" 3 4
                                    ((void *)0)
# 4500 "MagickWand/operation.c"
                                        ;
                  else
                    {
              ...
              if (source == (Image *) 
# 4507 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4507 "MagickWand/operation.c"
                                         )
                {
                  (void) ThrowMagickException((cli_wand->wand.exception),"MagickWand/operation.c",__func__,(unsigned long) 4509,
                    OptionError,"MissingNullSeparator","layers Composite");
                  break;
                }

              SetGeometry((cli_wand->wand.images),&geometry);
              (void) ParseAbsoluteGeometry((cli_wand->wand.images)->geometry,&geometry);
              geometry.width=source->page.width != 0 ?
                source->page.width : source->columns;
              geometry.height=source->page.height != 0 ?
               source->page.height : source->rows;
              GravityAdjustGeometry((cli_wand->wand.images)->page.width != 0 ?
                (cli_wand->wand.images)->page.width : (cli_wand->wand.images)->columns,
                (cli_wand->wand.images)->page.height != 0 ? (cli_wand->wand.images)->page.height :
                (cli_wand->wand.images)->rows,(cli_wand->wand.images)->gravity,&geometry);


              CompositeLayers((cli_wand->wand.images),compose,source,geometry.x,geometry.y,
                (cli_wand->wand.exception));
      ...
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4534,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'm':
    {
      if (LocaleCompare("map",option+1) == 0)
        {
          if ( (cli_wand->process_flags & ProcessWarnDeprecated) != 0 ) (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4540,OptionWarning, "ReplacedOption", "'%s', use \"%s\"",option,"+remap");
          (void) RemapImages((cli_wand->quantize_info),(cli_wand->wand.images),(Image *) 
# 4541 "MagickWand/operation.c" 3 4
                                                             ((void *)0)
# 4541 "MagickWand/operation.c"
                                                                 ,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("metric",option+1) == 0)
      ...
      if (LocaleCompare("morph",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4555,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          morph_image=MorphImages((cli_wand->wand.images),StringToUnsignedLong(arg1),
            (cli_wand->wand.exception));
          if (morph_image == (Image *) 
# 4558 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 4558 "MagickWand/operation.c"
                                          )
            break;
          (cli_wand->wand.images)=DestroyImageList((cli_wand->wand.images));
          (cli_wand->wand.images)=morph_image;
          break;
        }
      if (LocaleCompare("mosaic",option+1) == 0)
        {
          ...
          (void) CLIListOperatorImages(cli_wand,"-layers",option+1,
# 4567 "MagickWand/operation.c" 3 4
                                                                  ((void *)0)
# 4567 "MagickWand/operation.c"
                                                                      );
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4570,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'p':
    {
      if (LocaleCompare("poly",option+1) == 0)
        {
          ...
          args = StringToArrayOfDoubles(arg1,&count,(cli_wand->wand.exception));
          if (args == (double *) 
# 4584 "MagickWand/operation.c" 3 4
                                ((void *)0) 
# 4584 "MagickWand/operation.c"
                                     )
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4585,OptionError,"InvalidNumberList", "'%s' '%s'",option, arg1); break; };
          new_images=PolynomialImage((cli_wand->wand.images),(size_t) (count >> 1),args,
           (cli_wand->wand.exception));
          args=(double *) RelinquishMagickMemory(args);
          break;
        }
      if (LocaleCompare("process",option+1) == 0)
        {
          ...
          if ((arguments == (char **) 
# 4602 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4602 "MagickWand/operation.c"
                                         ) || (number_arguments == 1))
            break;
          if (strchr(arguments[1],'=') != (char *) 
# 4604 "MagickWand/operation.c" 3 4
                                                  ((void *)0)
# 4604 "MagickWand/operation.c"
                                                      )
            {
              char
                breaker,
...
# 4627 "MagickWand/operation.c" 3 4
             ((void) sizeof ((
# 4627 "MagickWand/operation.c"
             arg1 != (const char *) 
# 4627 "MagickWand/operation.c" 3 4
             ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4627 "MagickWand/operation.c"
...
# 4627 "MagickWand/operation.c" 3 4
             ((void *)0)) ; else __assert_fail (
# 4627 "MagickWand/operation.c"
             "arg1 != (const char *) NULL"
# 4627 "MagickWand/operation.c" 3 4
             , "MagickWand/operation.c", 4627, __extension__ __PRETTY_FUNCTION__); }))
# 4627 "MagickWand/operation.c"
                                                ;
              length=strlen(arg1);
              token=(char *) 
# 4629 "MagickWand/operation.c" 3 4
                            ((void *)0)
# 4629 "MagickWand/operation.c"
                                ;
              if (~length >= (4096 -1))
                token=(char *) AcquireQuantumMemory(length+4096,
                  sizeof(*token));
              if (token == (char *) 
# 4633 "MagickWand/operation.c" 3 4
                                   ((void *)0)
# 4633 "MagickWand/operation.c"
                                       )
                break;
              next=0;
              p=arg1;
              ...
              if (tokenizer_status == 0)
                {
                  ...
                  argv=(&(p[next]));
                  (void) InvokeDynamicImageFilter(token,&(cli_wand->wand.images),1,&argv,
                    (cli_wand->wand.exception));
                }
          ...
          (void) InvokeDynamicImageFilter(arguments[1],&(cli_wand->wand.images),
            number_arguments-2,(const char **) arguments+2,(cli_wand->wand.exception));
          for (j=0; j < number_arguments; j++)
            arguments[j]=DestroyString(arguments[j]);
          arguments=(char **) RelinquishMagickMemory(arguments);
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4661,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 'r':
    {
      if (LocaleCompare("remap",option+1) == 0)
        {
          (void) RemapImages((cli_wand->quantize_info),(cli_wand->wand.images),(Image *) 
# 4667 "MagickWand/operation.c" 3 4
                                                             ((void *)0)
# 4667 "MagickWand/operation.c"
                                                                 ,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("reverse",option+1) == 0)
        {
          ReverseImageList(&(cli_wand->wand.images));
          break;
        }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4675,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    case 's':
    {
      if (LocaleCompare("smush",option+1) == 0)
        {
          ...
          if (IsGeometry(arg1) == MagickFalse)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4686,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          offset=(ssize_t) StringToLong(arg1);
          new_images=SmushImages((cli_wand->wand.images),(*option=='-') ? MagickTrue : MagickFalse,offset,(cli_wand->wand.exception));
          break;
        }
      if (LocaleCompare("subimage",option+1) == 0)
        {
          ...
          base_image=GetImageFromList((cli_wand->wand.images),0);
          compare_image=GetImageFromList((cli_wand->wand.images),1);


          metric=UndefinedErrorMetric;
          value=GetImageOption((cli_wand->wand.image_info),"metric");
          if (value != (const char *) 
# 4715 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4715 "MagickWand/operation.c"
                                         )
            metric=(MetricType) ParseCommandOption(MagickMetricOptions,
              MagickFalse,value);

          new_images=SimilarityImage(base_image,compare_image,metric,0.0,
            &offset,&similarity,(cli_wand->wand.exception));

          if (new_images != (Image *) 
# 4722 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 4722 "MagickWand/operation.c"
                                         )
            {
      ...
      if (LocaleCompare("swap",option+1) == 0)
        ...
        if ((*option=='-')) {
          ...
          flags=ParseGeometry(arg1,&geometry_info);
          if ((flags & RhoValue) == 0)
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4759,OptionError,"InvalidArgument", "'%s' '%s'",option, arg1); break; };
          index=(ssize_t) geometry_info.rho;
          if ((flags & SigmaValue) != 0)
            swap_index=(ssize_t) geometry_info.sigma;
        }
        p=GetImageFromList((cli_wand->wand.images),index);
        q=GetImageFromList((cli_wand->wand.images),swap_index);
        if ((p == (Image *) 
# 4766 "MagickWand/operation.c" 3 4
                           ((void *)0)
# 4766 "MagickWand/operation.c"
                               ) || (q == (Image *) 
# 4766 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 4766 "MagickWand/operation.c"
          ...
          if ((*option=='-'))
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4768,OptionError,"InvalidImageIndex", "'%s' '%s'",option, arg1); break; }
          else
            { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4770,OptionError,"TwoOrMoreImagesRequired", "`%s'",option); break; };
        }
        if (p == q)
          { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4773,OptionError,"InvalidImageIndex", "'%s' '%s'",option, arg1); break; };
        swap=CloneImage(p,0,0,MagickTrue,(cli_wand->wand.exception));
        if (swap == (Image *) 
# 4775 "MagickWand/operation.c" 3 4
                             ((void *)0)
# 4775 "MagickWand/operation.c"
                                 )
          { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4776,ResourceLimitError,"MemoryAllocationFailed", "'%s' '%s'",option, GetExceptionMessage(
# 4776 "MagickWand/operation.c" 3 4
         (*__errno_location ())
# 4776 "MagickWand/operation.c"
         )); break; }
                                              ;
        ReplaceImageInList(&p,CloneImage(q,0,0,MagickTrue,(cli_wand->wand.exception)));
        ReplaceImageInList(&q,swap);
        (cli_wand->wand.images)=GetFirstImageInList(q);
        break;
      }
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4783,OptionError,"UnrecognizedOption", "`%s'",option); break; };
    }
    default:
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4786,OptionError,"UnrecognizedOption", "`%s'",option); break; };
  }
  ...
  if (new_images == (Image *) 
# 4796 "MagickWand/operation.c" 3 4
                             ((void *)0)
# 4796 "MagickWand/operation.c"
                                 )
    return(status == 0 ? MagickFalse : MagickTrue);
  (cli_wand->wand.images)=DestroyImageList((cli_wand->wand.images));
  (cli_wand->wand.images)=GetFirstImageInList(new_images);
  return(status == 0 ? MagickFalse : MagickTrue);
# 4810 "MagickWand/operation.c"
}
# 4848 "MagickWand/operation.c"
  ...
  const char *option,const char *arg1n,const char *arg2n)
{
  const char
    *arg1,
    *arg2;
# 4863 "MagickWand/operation.c"
  
# 4863 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 4863 "MagickWand/operation.c"
 cli_wand != (MagickCLI *) 
# 4863 "MagickWand/operation.c" 3 4
...
# 4863 "MagickWand/operation.c"
 "cli_wand != (MagickCLI *) NULL"
# 4863 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 4863, __extension__ __PRETTY_FUNCTION__); }))
# 4863 "MagickWand/operation.c"
                                       ;
  
# 4864 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 4864 "MagickWand/operation.c"
 cli_wand->signature == 0xabacadabUL
# 4864 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4864 "MagickWand/operation.c"
...
# 4864 "MagickWand/operation.c"
 "cli_wand->signature == MagickWandSignature"
# 4864 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 4864, __extension__ __PRETTY_FUNCTION__); }))
# 4864 "MagickWand/operation.c"
                                                   ;
  
# 4865 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 4865 "MagickWand/operation.c"
 cli_wand->wand.signature == 0xabacadabUL
# 4865 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4865 "MagickWand/operation.c"
...
# 4865 "MagickWand/operation.c"
 "cli_wand->wand.signature == MagickWandSignature"
# 4865 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 4865, __extension__ __PRETTY_FUNCTION__); }))
# 4865 "MagickWand/operation.c"
                                                        ;

  if (cli_wand->wand.debug != MagickFalse)
    (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/operation.c",__func__,(unsigned long) 4868,
      "- NoImage Operator: %s \"%s\" \"%s\"", option,
      arg1n != (char *) 
# 4870 "MagickWand/operation.c" 3 4
                       ((void *)0) 
# 4870 "MagickWand/operation.c"
                            ? arg1n : "",
      arg2n != (char *) 
# 4871 "MagickWand/operation.c" 3 4
                       ((void *)0) 
# 4871 "MagickWand/operation.c"
                            ? arg2n : "");
  ...
  if ( ((((cli_wand->process_flags) & ProcessInterpretProperties) != 0 )
    ...
    if (arg1n != (char *) 
# 4881 "MagickWand/operation.c" 3 4
                         ((void *)0)
# 4881 "MagickWand/operation.c"
                             ) {
      arg1=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg1n,(cli_wand->wand.exception));
      if (arg1 == (char *) 
# 4883 "MagickWand/operation.c" 3 4
                          ((void *)0)
# 4883 "MagickWand/operation.c"
                              ) {
        (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4884,OptionWarning,"InterpretPropertyFailure", "`%s'",option);
        arg1=arg1n;
      }
    }
    if (arg2n != (char *) 
# 4888 "MagickWand/operation.c" 3 4
                         ((void *)0)
# 4888 "MagickWand/operation.c"
                             ) {
      arg2=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg2n,(cli_wand->wand.exception));
      if (arg2 == (char *) 
# 4890 "MagickWand/operation.c" 3 4
                          ((void *)0)
# 4890 "MagickWand/operation.c"
                              ) {
        (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4891,OptionWarning,"InterpretPropertyFailure", "`%s'",option);
        arg2=arg2n;
      }
    }
  }
...
# 4935 "MagickWand/operation.c"
      ...
      if (ExpandFilenames(&argc,&argv) == MagickFalse)
        { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4947,ResourceLimitError,"MemoryAllocationFailed", "'%s' '%s'",option, GetExceptionMessage(
# 4947 "MagickWand/operation.c" 3 4
       (*__errno_location ())
# 4947 "MagickWand/operation.c"
       )); break; }
                                              ;
      ...
      for (i=0; i < (ssize_t) argc; i++) {
        ...
        if ((cli_wand->wand.image_info)->ping != MagickFalse)
          new_images=PingImages((cli_wand->wand.image_info),argv[i],(cli_wand->wand.exception));
        else
          new_images=ReadImages((cli_wand->wand.image_info),argv[i],(cli_wand->wand.exception));
        AppendImageToList(&(cli_wand->wand.images), new_images);
    ...
    if (LocaleCompare("write",option+1) == 0) {
      ...
      if ( (cli_wand->wand.images) == (Image *) 
# 4980 "MagickWand/operation.c" 3 4
                               ((void *)0) 
# 4980 "MagickWand/operation.c"
                                    ) {
        if ( LocaleCompare(arg1,"null:") == 0 )
          break;
        { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 4983,OptionError,"NoImagesForWrite", "'%s' '%s'",option, arg1); break; };
      }

      (void) FormatLocaleString(key,4096,"cache:%s",arg1);
      (void) DeleteImageRegistry(key);
      write_images=CloneImageList((cli_wand->wand.images),(cli_wand->wand.exception));
      write_info=CloneImageInfo((cli_wand->wand.image_info));
      if (write_images != (Image *) 
# 4990 "MagickWand/operation.c" 3 4
                                   ((void *)0)
# 4990 "MagickWand/operation.c"
                                       )
        (void) WriteImages(write_info,write_images,arg1,(cli_wand->wand.exception));
    ...
    if (LocaleCompare("(",option) == 0) {
      ...
      for ( ; node != (CLIStack *) 
# 5009 "MagickWand/operation.c" 3 4
                                  ((void *)0)
# 5009 "MagickWand/operation.c"
                                      ; node=node->next)
        size++;
      if ( size >= 32 )
        { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5012,OptionError,"ParenthesisNestedTooDeeply", "`%s'",option); break; };
      node=(CLIStack *) AcquireMagickMemory(sizeof(*node));
      if (node == (CLIStack *) 
# 5014 "MagickWand/operation.c" 3 4
                              ((void *)0)
# 5014 "MagickWand/operation.c"
                                  )
        { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5015,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",option); break; }
                                            ;
    ...
    if (LocaleCompare("{",option) == 0) {
      ...
      for ( ; node != (CLIStack *) 
# 5040 "MagickWand/operation.c" 3 4
                                  ((void *)0)
# 5040 "MagickWand/operation.c"
                                      ; node=node->next)
        size++;
      if ( size >= 32 )
        { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5043,OptionError,"CurlyBracesNestedTooDeeply", "`%s'",option); break; };
      node=(CLIStack *) AcquireMagickMemory(sizeof(*node));
      if (node == (CLIStack *) 
# 5045 "MagickWand/operation.c" 3 4
                              ((void *)0)
# 5045 "MagickWand/operation.c"
                                  )
        { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5046,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",option); break; }
                                            ;
      ...
      if (cli_wand->wand.image_info == (ImageInfo *) 
# 5054 "MagickWand/operation.c" 3 4
                                                    ((void *)0)
# 5054 "MagickWand/operation.c"
                                                        ) {
        (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5055,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",option)
                   ;
    ...
    if (LocaleCompare(")",option) == 0) {
      ...
      if ( node == (CLIStack *) 
# 5070 "MagickWand/operation.c" 3 4
                               ((void *)0)
# 5070 "MagickWand/operation.c"
                                   )
        { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5071,OptionError,"UnbalancedParenthesis", "`%s'",option); break; };
      ...
      node = cli_wand->image_info_stack;
      if ( node != (CLIStack *) 
# 5080 "MagickWand/operation.c" 3 4
                               ((void *)0)
# 5080 "MagickWand/operation.c"
                                   )
        {
    ...
    if (LocaleCompare("}",option) == 0) {
      ...
      if ( node == (CLIStack *) 
# 5098 "MagickWand/operation.c" 3 4
                               ((void *)0)
# 5098 "MagickWand/operation.c"
                                   )
        { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5099,OptionError,"UnbalancedCurlyBraces", "`%s'",option); break; };
      ...
      if (LocaleCompare("print",option+1) == 0)
        {
          (void) FormatLocaleFile(
# 5114 "MagickWand/operation.c" 3 4
                                 stdout
# 5114 "MagickWand/operation.c"
                                       ,"%s",arg1);
          break;
        }
    if (LocaleCompare("set",option+1) == 0)
      {
        ...
        StringInfo *profile = (StringInfo *) 
# 5126 "MagickWand/operation.c" 3 4
                                            ((void *)0)
# 5126 "MagickWand/operation.c"
                                                ;
        arg1=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg1n,(cli_wand->wand.exception));
        if (arg1 == (char *) 
# 5128 "MagickWand/operation.c" 3 4
                            ((void *)0)
# 5128 "MagickWand/operation.c"
                                )
          { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5129,OptionWarning,"InterpretPropertyFailure", "`%s'",option); break; }
                       ;
        ...
        if (LocaleNCompare(arg1,"registry:",9) == 0)
          {
            ...
            arg2=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg2n,(cli_wand->wand.exception));
            if (arg2 == (char *) 
# 5141 "MagickWand/operation.c" 3 4
                                ((void *)0)
# 5141 "MagickWand/operation.c"
                                    ) {
              arg1=DestroyString((char *)arg1);
              { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5143,OptionWarning,"InterpretPropertyFailure", "`%s'",option); break; }
                           ;
            }
            (void) SetImageRegistry(StringRegistryType,arg1+9,arg2,(cli_wand->wand.exception));
            arg1=DestroyString((char *)arg1);
            arg2=DestroyString((char *)arg2);
            break;
          }
        if (LocaleNCompare(arg1,"option:",7) == 0)
          {
            ...
            if ((cli_wand->wand.images) != (Image *) 
# 5154 "MagickWand/operation.c" 3 4
                                    ((void *)0)
# 5154 "MagickWand/operation.c"
                                        )
              {
                MagickResetIterator(&cli_wand->wand);
                while (MagickNextImage(&cli_wand->wand) != MagickFalse)
                  (void) DeleteImageArtifact((cli_wand->wand.images),arg1+7);
                MagickResetIterator(&cli_wand->wand);
              }


            arg2=(char *) 
# 5163 "MagickWand/operation.c" 3 4
                         ((void *)0)
# 5163 "MagickWand/operation.c"
                             ;
            if ((*option=='-'))
              {
                arg2=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg2n,(cli_wand->wand.exception));
                if (arg2 == (char *) 
# 5167 "MagickWand/operation.c" 3 4
                                    ((void *)0)
# 5167 "MagickWand/operation.c"
                                        )
                  { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5168,OptionWarning,"InterpretPropertyFailure", "`%s'",option); break; }
                                                         ;
              }
            (void) SetImageOption((cli_wand->wand.image_info),arg1+7,arg2);
            arg1=DestroyString((char *) arg1);
            arg2=DestroyString((char *) arg2);
            break;
          }
        if (LocaleCompare(arg1,"profile") == 0)
          {
            if (arg2 != (char *) 
# 5178 "MagickWand/operation.c" 3 4
                                ((void *)0)
# 5178 "MagickWand/operation.c"
                                    )
              (void) CopyMagickString((cli_wand->wand.image_info)->filename,arg2,
                4096);
            (void) SetImageInfo((cli_wand->wand.image_info),1,(cli_wand->wand.exception));
            if (LocaleCompare((cli_wand->wand.image_info)->filename,"-") != 0)
              profile=FileToStringInfo((cli_wand->wand.image_info)->filename,~0UL,(cli_wand->wand.exception));
          }

        if ( (cli_wand->wand.images) == (Image *) 
# 5186 "MagickWand/operation.c" 3 4
                                 ((void *)0) 
# 5186 "MagickWand/operation.c"
                                      )
          { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5187,OptionWarning,"NoImageForProperty", "'%s' '%s'",option, arg1); break; };

        MagickResetIterator(&cli_wand->wand);
        while (MagickNextImage(&cli_wand->wand) != MagickFalse)
          {
            arg2=(char *) 
# 5192 "MagickWand/operation.c" 3 4
                         ((void *)0)
# 5192 "MagickWand/operation.c"
                             ;
            if ((*option=='-'))
              {
                arg2=InterpretImageProperties((cli_wand->wand.image_info),(cli_wand->wand.images),arg2n,(cli_wand->wand.exception));
                if (arg2 == (char *) 
# 5196 "MagickWand/operation.c" 3 4
                                    ((void *)0)
# 5196 "MagickWand/operation.c"
                                        )
                  { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5197,OptionWarning,"InterpretPropertyFailure", "`%s'",option); break; }
                                                         ;
              }
            if (LocaleNCompare(arg1,"artifact:",9) == 0)
              (void) SetImageArtifact((cli_wand->wand.images),arg1+9,arg2);
            else if (LocaleNCompare(arg1,"property:",9) == 0)
              (void) SetImageProperty((cli_wand->wand.images),arg1+9,arg2,(cli_wand->wand.exception));
            else
              (void) SetImageProperty((cli_wand->wand.images),arg1,arg2,(cli_wand->wand.exception));
            if (profile != (StringInfo *) 
# 5206 "MagickWand/operation.c" 3 4
                                         ((void *)0)
# 5206 "MagickWand/operation.c"
                                             )
              (void) SetImageProfile((cli_wand->wand.images),(cli_wand->wand.image_info)->magick,profile,(cli_wand->wand.exception));
            arg2=DestroyString((char *)arg2);
          }
        if (profile != (StringInfo *) 
# 5210 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 5210 "MagickWand/operation.c"
                                         )
    ...
    if (LocaleCompare("clone",option+1) == 0) {
        ...
        if (IsSceneGeometry(arg1,MagickFalse) == MagickFalse)
          { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5223,OptionError,"InvalidArgument", "`%s'",option); break; };
        if ( cli_wand->image_list_stack == (CLIStack *) 
# 5224 "MagickWand/operation.c" 3 4
                                                       ((void *)0)
# 5224 "MagickWand/operation.c"
                                                           )
          { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5225,OptionError,"UnableToCloneImage", "`%s'",option); break; };
        new_images = (Image *)cli_wand->image_list_stack->data;
        if (new_images == (Image *) 
# 5227 "MagickWand/operation.c" 3 4
                                   ((void *)0)
# 5227 "MagickWand/operation.c"
                                       )
          { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5228,OptionError,"UnableToCloneImage", "`%s'",option); break; };
        new_images=CloneImages(new_images,arg1,(cli_wand->wand.exception));
        if (new_images == (Image *) 
# 5230 "MagickWand/operation.c" 3 4
                                   ((void *)0)
# 5230 "MagickWand/operation.c"
                                       )
          { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5231,OptionError,"NoSuchImage", "`%s'",option); break; };
        AppendImageToList(&(cli_wand->wand.images),new_images);
        break;
      }
    ...
    if (LocaleCompare("version",option+1) == 0)
      {
        ListMagickVersion(
# 5243 "MagickWand/operation.c" 3 4
                         stdout
# 5243 "MagickWand/operation.c"
                               );
        break;
      }
    if (LocaleCompare("list",option+1) == 0)
      ...
      if (list < 0)
        {
          (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5257,OptionError,"UnrecognizedListType", "'%s' '%s'",option, arg1);
          break;
        }
      switch (list)
      {
...
# 5264 "MagickWand/operation.c" 3 4
                                       ((void *)0)
# 5264 "MagickWand/operation.c"
                                           ,(cli_wand->wand.exception));
          break;
        }
        case MagickColorOptions:
        {
          (void) ListColorInfo((FILE *) 
# 5269 "MagickWand/operation.c" 3 4
                                       ((void *)0)
# 5269 "MagickWand/operation.c"
                                           ,(cli_wand->wand.exception));
          break;
        }
        case MagickConfigureOptions:
        {
          (void) ListConfigureInfo((FILE *) 
# 5274 "MagickWand/operation.c" 3 4
                                           ((void *)0)
# 5274 "MagickWand/operation.c"
                                               ,(cli_wand->wand.exception));
          break;
        }
...
# 5279 "MagickWand/operation.c" 3 4
                                          ((void *)0)
# 5279 "MagickWand/operation.c"
                                              ,(cli_wand->wand.exception));
          break;
        }
        case MagickFontOptions:
        {
          (void) ListTypeInfo((FILE *) 
# 5284 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 5284 "MagickWand/operation.c"
                                          ,(cli_wand->wand.exception));
          break;
        }
        case MagickFormatOptions:
          (void) ListMagickInfo((FILE *) 
# 5288 "MagickWand/operation.c" 3 4
                                        ((void *)0)
# 5288 "MagickWand/operation.c"
                                            ,(cli_wand->wand.exception));
          break;
        case MagickLocaleOptions:
          (void) ListLocaleInfo((FILE *) 
# 5291 "MagickWand/operation.c" 3 4
                                        ((void *)0)
# 5291 "MagickWand/operation.c"
                                            ,(cli_wand->wand.exception));
          break;
        case MagickLogOptions:
          (void) ListLogInfo((FILE *) 
# 5294 "MagickWand/operation.c" 3 4
                                     ((void *)0)
# 5294 "MagickWand/operation.c"
                                         ,(cli_wand->wand.exception));
          break;
        case MagickMagicOptions:
          (void) ListMagicInfo((FILE *) 
# 5297 "MagickWand/operation.c" 3 4
                                       ((void *)0)
# 5297 "MagickWand/operation.c"
                                           ,(cli_wand->wand.exception));
          break;
        case MagickMimeOptions:
          (void) ListMimeInfo((FILE *) 
# 5300 "MagickWand/operation.c" 3 4
                                      ((void *)0)
# 5300 "MagickWand/operation.c"
                                          ,(cli_wand->wand.exception));
          break;
        case MagickModuleOptions:
          (void) ListModuleInfo((FILE *) 
# 5303 "MagickWand/operation.c" 3 4
                                        ((void *)0)
# 5303 "MagickWand/operation.c"
                                            ,(cli_wand->wand.exception));
          break;
        case MagickPagesizeOptions:
          (void) ListPagesizes((FILE *) 
# 5306 "MagickWand/operation.c" 3 4
                                       ((void *)0)
# 5306 "MagickWand/operation.c"
                                           ,(cli_wand->wand.exception));
          break;
        case MagickPolicyOptions:
          (void) ListPolicyInfo((FILE *) 
# 5309 "MagickWand/operation.c" 3 4
                                        ((void *)0)
# 5309 "MagickWand/operation.c"
                                            ,(cli_wand->wand.exception));
          break;
        case MagickResourceOptions:
          (void) ListMagickResourceInfo((FILE *) 
# 5312 "MagickWand/operation.c" 3 4
                                                ((void *)0)
# 5312 "MagickWand/operation.c"
                                                    ,(cli_wand->wand.exception));
          break;
        case MagickThresholdOptions:
          (void) ListThresholdMaps((FILE *) 
# 5315 "MagickWand/operation.c" 3 4
                                           ((void *)0)
# 5315 "MagickWand/operation.c"
                                               ,(cli_wand->wand.exception));
          break;
        default:
          (void) ListCommandOptions((FILE *) 
# 5318 "MagickWand/operation.c" 3 4
                                            ((void *)0)
# 5318 "MagickWand/operation.c"
                                                ,(CommandOption) list,
            (cli_wand->wand.exception));
          break;
      }
    ...
    (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5325,OptionError,"UnrecognizedOption", "`%s'",option);
...
# 5389 "MagickWand/operation.c"
__attribute__ ((visibility ("default"))) void CLIOption(MagickCLI *cli_wand,const char *option,...)
{
  const char
    *arg1,
    *arg2;
...
# 5398 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 5398 "MagickWand/operation.c"
 cli_wand != (MagickCLI *) 
# 5398 "MagickWand/operation.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5398 "MagickWand/operation.c"
...
# 5398 "MagickWand/operation.c"
 "cli_wand != (MagickCLI *) NULL"
# 5398 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 5398, __extension__ __PRETTY_FUNCTION__); }))
# 5398 "MagickWand/operation.c"
                                       ;
  
# 5399 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 5399 "MagickWand/operation.c"
 cli_wand->signature == 0xabacadabUL
# 5399 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5399 "MagickWand/operation.c"
...
# 5399 "MagickWand/operation.c"
 "cli_wand->signature == MagickWandSignature"
# 5399 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 5399, __extension__ __PRETTY_FUNCTION__); }))
# 5399 "MagickWand/operation.c"
                                                   ;
  
# 5400 "MagickWand/operation.c" 3 4
 ((void) sizeof ((
# 5400 "MagickWand/operation.c"
 cli_wand->wand.signature == 0xabacadabUL
# 5400 "MagickWand/operation.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5400 "MagickWand/operation.c"
...
# 5400 "MagickWand/operation.c"
 "cli_wand->wand.signature == MagickWandSignature"
# 5400 "MagickWand/operation.c" 3 4
 , "MagickWand/operation.c", 5400, __extension__ __PRETTY_FUNCTION__); }))
# 5400 "MagickWand/operation.c"
                                                        ;
  ...
  do {
    ...
    if ( cli_wand->command == (const OptionInfo *) 
# 5405 "MagickWand/operation.c" 3 4
                                                  ((void *)0) 
# 5405 "MagickWand/operation.c"
                                                       )
    ...
    if ( option_type == UndefinedOptionFlag )
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5414,OptionFatalError,"UnrecognizedOption", "`%s'",option); return; };

    
# 5416 "MagickWand/operation.c" 3 4
   ((void) sizeof ((
# 5416 "MagickWand/operation.c"
   LocaleCompare(cli_wand->command->mnemonic,option) == 0
# 5416 "MagickWand/operation.c" 3 4
   ) ? 1 : 0), __extension__ ({ if (
# 5416 "MagickWand/operation.c"
   LocaleCompare(cli_wand->command->mnemonic,option) == 0
...
# 5416 "MagickWand/operation.c"
   "LocaleCompare(cli_wand->command->mnemonic,option) == 0"
# 5416 "MagickWand/operation.c" 3 4
   , "MagickWand/operation.c", 5416, __extension__ __PRETTY_FUNCTION__); }))
# 5416 "MagickWand/operation.c"
                                                                   ;


    if ( (option_type & DeprecateOptionFlag) != 0 )
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5420,OptionError,"DeprecatedOptionNoCode", "`%s'",option); break; };


    if ((option_type & (SpecialOptionFlag|GenesisOptionFlag)) != 0 )
      { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5424,OptionFatalError,"InvalidUseOfOption", "`%s'",option); break; };
...
# 5436 "MagickWand/operation.c" 3 4
     __builtin_va_start(
# 5436 "MagickWand/operation.c"
     operands
# 5436 "MagickWand/operation.c" 3 4
     ,
# 5436 "MagickWand/operation.c"
...
# 5436 "MagickWand/operation.c"
      ...
      arg1=arg2=
# 5438 "MagickWand/operation.c" 3 4
               ((void *)0)
# 5438 "MagickWand/operation.c"
                   ;
      if ( count >= 1 )
        arg1=(const char *) 
# 5440 "MagickWand/operation.c" 3 4
                           __builtin_va_arg(
# 5440 "MagickWand/operation.c"
                           operands
# 5440 "MagickWand/operation.c" 3 4
                           ,
# 5440 "MagickWand/operation.c"
...
# 5440 "MagickWand/operation.c"
      ...
      if ( count >= 2 )
        arg2=(const char *) 
# 5442 "MagickWand/operation.c" 3 4
                           __builtin_va_arg(
# 5442 "MagickWand/operation.c"
                           operands
# 5442 "MagickWand/operation.c" 3 4
                           ,
# 5442 "MagickWand/operation.c"
...
# 5444 "MagickWand/operation.c" 3 4
     __builtin_va_end(
# 5444 "MagickWand/operation.c"
     operands
# 5444 "MagickWand/operation.c" 3 4
     )
# 5444 "MagickWand/operation.c"
    ...
    if ( cli_wand->wand.images != (Image *) 
# 5458 "MagickWand/operation.c" 3 4
                                           ((void *)0) 
# 5458 "MagickWand/operation.c"
                                                )
    ...
    if ( cli_wand->wand.images == (Image *) 
# 5476 "MagickWand/operation.c" 3 4
                                           ((void *)0) 
# 5476 "MagickWand/operation.c"
                                                )
      if ( ((option_type & (SimpleOperatorFlag|ListOperatorFlag)) != 0 ) &&
          ((option_type & SettingOptionFlags) == 0 ))
        { (void) CLIThrowException(cli_wand,"MagickWand/operation.c",__func__,(unsigned long) 5479,OptionError,"NoImagesFound", "`%s'",option); break; };


    if ( (option_type & SimpleOperatorFlag) != 0 &&
         cli_wand->wand.images != (Image *) 
# 5483 "MagickWand/operation.c" 3 4
                                           ((void *)0)
# 5483 "MagickWand/operation.c"
                                               )
      {
  ...
  cli_wand->command = (const OptionInfo *) 
# 5498 "MagickWand/operation.c" 3 4
                                          ((void *)0)
# 5498 "MagickWand/operation.c"
                                              ;
}
