# 0 "MagickWand/compare.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/compare.c"
# 44 "MagickWand/compare.c"
...
# 48 "MagickWand/compare.c" 2
# 83 "MagickWand/compare.c"
static MagickBooleanType CompareUsage(void)
{
  ...
  ListMagickVersion(
# 172 "MagickWand/compare.c" 3 4
                   stdout
# 172 "MagickWand/compare.c"
                         );
...
__attribute__ ((visibility ("default"))) MagickBooleanType CompareImagesCommand(ImageInfo *image_info,
  int argc,char **argv,char **metadata,ExceptionInfo *exception)
{
# 232 "MagickWand/compare.c"
  char
    *filename,
    *option;
  ...
  Image
    *difference_image,
    *image = (Image *) 
# 247 "MagickWand/compare.c" 3 4
                      ((void *)0)
# 247 "MagickWand/compare.c"
                          ,
    *reconstruct_image,
    *similarity_image;
...
# 279 "MagickWand/compare.c" 3 4
 ((void) sizeof ((
# 279 "MagickWand/compare.c"
...
# 279 "MagickWand/compare.c" 3 4
 , "MagickWand/compare.c", 279, __extension__ __PRETTY_FUNCTION__); }))
# 279 "MagickWand/compare.c"
                                         ;
  
# 280 "MagickWand/compare.c" 3 4
 ((void) sizeof ((
# 280 "MagickWand/compare.c"
...
# 280 "MagickWand/compare.c" 3 4
 , "MagickWand/compare.c", 280, __extension__ __PRETTY_FUNCTION__); }))
# 280 "MagickWand/compare.c"
                                                     ;
  
# 281 "MagickWand/compare.c" 3 4
 ((void) sizeof ((
# 281 "MagickWand/compare.c"
...
# 281 "MagickWand/compare.c" 3 4
 , "MagickWand/compare.c", 281, __extension__ __PRETTY_FUNCTION__); }))
# 281 "MagickWand/compare.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickWand/compare.c",__func__,(unsigned long) 283,"...");
  if (argc == 2)
    {
      option=argv[1];
      if ((LocaleCompare("version",option+1) == 0) ||
        ...
        {
          ListMagickVersion(
# 290 "MagickWand/compare.c" 3 4
                           stdout
# 290 "MagickWand/compare.c"
                                 );
          return(MagickTrue);
        }
    }
  if (argc < 3)
    {
      (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 296,OptionError,
        "MissingArgument","%s","");
      (void) CompareUsage();
      return(MagickFalse);
    }
  ...
  dissimilarity_threshold=0.31830988618379067154;
  similarity_threshold=(-1.0);
  distortion=0.0;
  format=(char *) 
# 306 "MagickWand/compare.c" 3 4
                 ((void *)0)
# 306 "MagickWand/compare.c"
                     ;
  j=1;
  k=0;
  ...
  option=(char *) 
# 311 "MagickWand/compare.c" 3 4
                 ((void *)0)
# 311 "MagickWand/compare.c"
                     ;
  pend=MagickFalse;
...
# 330 "MagickWand/compare.c" 3 4
       ((void *)0)
# 330 "MagickWand/compare.c"
        ...
        if (k == 128)
          { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 332,OptionError,"ParenthesisNestedTooDeeply", "`%s'",option); { if (similarity_image != (Image *) 
# 332 "MagickWand/compare.c" 3 4
         ((void *)0)
# 332 "MagickWand/compare.c"
         ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 332 "MagickWand/compare.c" 3 4
         ((void *)0)
# 332 "MagickWand/compare.c"
    ...
    if (LocaleCompare(option,")") == 0)
      {
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 339 "MagickWand/compare.c" 3 4
       ((void *)0)
# 339 "MagickWand/compare.c"
        ...
        if (k == 0)
          { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 341,OptionError,"UnableToParseExpression", "`%s'",option); { if (similarity_image != (Image *) 
# 341 "MagickWand/compare.c" 3 4
         ((void *)0)
# 341 "MagickWand/compare.c"
         ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 341 "MagickWand/compare.c" 3 4
         ((void *)0)
# 341 "MagickWand/compare.c"
    ...
    if (IsCommandOption(option) == MagickFalse)
      {
        ...
        if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 353 "MagickWand/compare.c" 3 4
       ((void *)0)
# 353 "MagickWand/compare.c"
...
# 358 "MagickWand/compare.c" 3 4
                                                       ((void *)0)
# 358 "MagickWand/compare.c"
                                                           ) &&
          (exception->severity < ErrorException);
        if (images == (Image *) 
# 360 "MagickWand/compare.c" 3 4
                               ((void *)0)
# 360 "MagickWand/compare.c"
                                   )
          continue;
    ...
    pend=image != (Image *) 
# 365 "MagickWand/compare.c" 3 4
                           ((void *)0) 
# 365 "MagickWand/compare.c"
        ...
        if (LocaleCompare("alpha",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 379,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 379 "MagickWand/compare.c" 3 4
             ((void *)0)
# 379 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 379 "MagickWand/compare.c" 3 4
             ((void *)0)
# 379 "MagickWand/compare.c"
            ...
            type=ParseCommandOption(MagickAlphaChannelOptions,MagickFalse,
              argv[i]);
            if (type < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 383,OptionError,"UnrecognizedAlphaChannelOption", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 383 "MagickWand/compare.c" 3 4
             ((void *)0)
# 383 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 383 "MagickWand/compare.c" 3 4
             ((void *)0)
# 383 "MagickWand/compare.c"
        ...
        if (LocaleCompare("authenticate",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 395,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 395 "MagickWand/compare.c" 3 4
             ((void *)0)
# 395 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 395 "MagickWand/compare.c" 3 4
             ((void *)0)
# 395 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 398,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 398 "MagickWand/compare.c" 3 4
       ((void *)0)
# 398 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 398 "MagickWand/compare.c" 3 4
       ((void *)0)
# 398 "MagickWand/compare.c"
        ...
        if (LocaleCompare("background",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 408,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 408 "MagickWand/compare.c" 3 4
             ((void *)0)
# 408 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 408 "MagickWand/compare.c" 3 4
             ((void *)0)
# 408 "MagickWand/compare.c"
        ...
        if (LocaleCompare("brightness-contrast",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 415,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 415 "MagickWand/compare.c" 3 4
             ((void *)0)
# 415 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 415 "MagickWand/compare.c" 3 4
             ((void *)0)
# 415 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 417,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 417 "MagickWand/compare.c" 3 4
             ((void *)0)
# 417 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 417 "MagickWand/compare.c" 3 4
             ((void *)0)
# 417 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 420,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 420 "MagickWand/compare.c" 3 4
       ((void *)0)
# 420 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 420 "MagickWand/compare.c" 3 4
       ((void *)0)
# 420 "MagickWand/compare.c"
        ...
        if (LocaleCompare("cache",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 430,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 430 "MagickWand/compare.c" 3 4
             ((void *)0)
# 430 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 430 "MagickWand/compare.c" 3 4
             ((void *)0)
# 430 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 432,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 432 "MagickWand/compare.c" 3 4
             ((void *)0)
# 432 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 432 "MagickWand/compare.c" 3 4
             ((void *)0)
# 432 "MagickWand/compare.c"
        ...
        if (LocaleCompare("channel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 444,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 444 "MagickWand/compare.c" 3 4
             ((void *)0)
# 444 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 444 "MagickWand/compare.c" 3 4
             ((void *)0)
# 444 "MagickWand/compare.c"
            ...
            if (channel < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 447,OptionError,"UnrecognizedChannelType", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 447 "MagickWand/compare.c" 3 4
             ((void *)0)
# 447 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 447 "MagickWand/compare.c" 3 4
             ((void *)0)
# 447 "MagickWand/compare.c"
        ...
        if (LocaleCompare("colorspace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 460,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 460 "MagickWand/compare.c" 3 4
             ((void *)0)
# 460 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 460 "MagickWand/compare.c" 3 4
             ((void *)0)
# 460 "MagickWand/compare.c"
            ...
            colorspace=ParseCommandOption(MagickColorspaceOptions,MagickFalse,
              argv[i]);
            if (colorspace < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 464,OptionError,"UnrecognizedColorspace", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 464 "MagickWand/compare.c" 3 4
             ((void *)0)
# 464 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 464 "MagickWand/compare.c" 3 4
             ((void *)0)
# 464 "MagickWand/compare.c"
        ...
        if (LocaleCompare("compose",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 477,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 477 "MagickWand/compare.c" 3 4
             ((void *)0)
# 477 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 477 "MagickWand/compare.c" 3 4
             ((void *)0)
# 477 "MagickWand/compare.c"
            ...
            compose=ParseCommandOption(MagickComposeOptions,MagickFalse,
              argv[i]);
            if (compose < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 481,OptionError,"UnrecognizedComposeOperator", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 481 "MagickWand/compare.c" 3 4
             ((void *)0)
# 481 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 481 "MagickWand/compare.c" 3 4
             ((void *)0)
# 481 "MagickWand/compare.c"
        ...
        if (LocaleCompare("compress",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 494,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 494 "MagickWand/compare.c" 3 4
             ((void *)0)
# 494 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 494 "MagickWand/compare.c" 3 4
             ((void *)0)
# 494 "MagickWand/compare.c"
            ...
            compress=ParseCommandOption(MagickCompressOptions,MagickFalse,
              argv[i]);
            if (compress < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 498,OptionError,"UnrecognizedImageCompression", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 498 "MagickWand/compare.c" 3 4
             ((void *)0)
# 498 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 498 "MagickWand/compare.c" 3 4
             ((void *)0)
# 498 "MagickWand/compare.c"
        ...
        if (LocaleCompare("crop",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 510,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 510 "MagickWand/compare.c" 3 4
             ((void *)0)
# 510 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 510 "MagickWand/compare.c" 3 4
             ((void *)0)
# 510 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 512,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 512 "MagickWand/compare.c" 3 4
             ((void *)0)
# 512 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 512 "MagickWand/compare.c" 3 4
             ((void *)0)
# 512 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 515,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 515 "MagickWand/compare.c" 3 4
       ((void *)0)
# 515 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 515 "MagickWand/compare.c" 3 4
       ((void *)0)
# 515 "MagickWand/compare.c"
        ...
        if (LocaleCompare("debug",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 528,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 528 "MagickWand/compare.c" 3 4
             ((void *)0)
# 528 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 528 "MagickWand/compare.c" 3 4
             ((void *)0)
# 528 "MagickWand/compare.c"
            ...
            if (event_mask == UndefinedEvents)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 531,OptionError,"UnrecognizedEventType", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 531 "MagickWand/compare.c" 3 4
             ((void *)0)
# 531 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 531 "MagickWand/compare.c" 3 4
             ((void *)0)
# 531 "MagickWand/compare.c"
        ...
        if (LocaleCompare("decipher",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 541,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 541 "MagickWand/compare.c" 3 4
             ((void *)0)
# 541 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 541 "MagickWand/compare.c" 3 4
             ((void *)0)
# 541 "MagickWand/compare.c"
        ...
        if (LocaleCompare("define",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 548,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 548 "MagickWand/compare.c" 3 4
             ((void *)0)
# 548 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 548 "MagickWand/compare.c" 3 4
             ((void *)0)
# 548 "MagickWand/compare.c"
...
# 555 "MagickWand/compare.c" 3 4
                                            ((void *)0)
# 555 "MagickWand/compare.c"
                                                )
                  { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 556,OptionError,"NoSuchOption", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 556 "MagickWand/compare.c" 3 4
                 ((void *)0)
# 556 "MagickWand/compare.c"
                 ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 556 "MagickWand/compare.c" 3 4
                 ((void *)0)
# 556 "MagickWand/compare.c"
        ...
        if (LocaleCompare("delete",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 567,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 567 "MagickWand/compare.c" 3 4
             ((void *)0)
# 567 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 567 "MagickWand/compare.c" 3 4
             ((void *)0)
# 567 "MagickWand/compare.c"
            ...
            if (IsSceneGeometry(argv[i],MagickFalse) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 569,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 569 "MagickWand/compare.c" 3 4
             ((void *)0)
# 569 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 569 "MagickWand/compare.c" 3 4
             ((void *)0)
# 569 "MagickWand/compare.c"
        ...
        if (LocaleCompare("density",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 578,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 578 "MagickWand/compare.c" 3 4
             ((void *)0)
# 578 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 578 "MagickWand/compare.c" 3 4
             ((void *)0)
# 578 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 580,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 580 "MagickWand/compare.c" 3 4
             ((void *)0)
# 580 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 580 "MagickWand/compare.c" 3 4
             ((void *)0)
# 580 "MagickWand/compare.c"
        ...
        if (LocaleCompare("depth",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 589,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 589 "MagickWand/compare.c" 3 4
             ((void *)0)
# 589 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 589 "MagickWand/compare.c" 3 4
             ((void *)0)
# 589 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 591,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 591 "MagickWand/compare.c" 3 4
             ((void *)0)
# 591 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 591 "MagickWand/compare.c" 3 4
             ((void *)0)
# 591 "MagickWand/compare.c"
        ...
        if (LocaleCompare("dissimilarity-threshold",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 600,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 600 "MagickWand/compare.c" 3 4
             ((void *)0)
# 600 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 600 "MagickWand/compare.c" 3 4
             ((void *)0)
# 600 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 602,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 602 "MagickWand/compare.c" 3 4
             ((void *)0)
# 602 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 602 "MagickWand/compare.c" 3 4
             ((void *)0)
# 602 "MagickWand/compare.c"
            ...
            if (*option == '+')
              ...
              dissimilarity_threshold=StringToDouble(argv[i],(char **) 
# 606 "MagickWand/compare.c" 3 4
                                                                      ((void *)0)
# 606 "MagickWand/compare.c"
                                                                          );
            break;
          }
        if (LocaleCompare("distort",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 616,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 616 "MagickWand/compare.c" 3 4
             ((void *)0)
# 616 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 616 "MagickWand/compare.c" 3 4
             ((void *)0)
# 616 "MagickWand/compare.c"
            ...
            if (op < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 619,OptionError,"UnrecognizedDistortMethod", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 619 "MagickWand/compare.c" 3 4
             ((void *)0)
# 619 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 619 "MagickWand/compare.c" 3 4
             ((void *)0)
# 619 "MagickWand/compare.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 623,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 623 "MagickWand/compare.c" 3 4
             ((void *)0)
# 623 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 623 "MagickWand/compare.c" 3 4
             ((void *)0)
# 623 "MagickWand/compare.c"
        ...
        if (LocaleCompare("duration",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 632,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 632 "MagickWand/compare.c" 3 4
             ((void *)0)
# 632 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 632 "MagickWand/compare.c" 3 4
             ((void *)0)
# 632 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 634,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 634 "MagickWand/compare.c" 3 4
             ((void *)0)
# 634 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 634 "MagickWand/compare.c" 3 4
             ((void *)0)
# 634 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 637,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 637 "MagickWand/compare.c" 3 4
       ((void *)0)
# 637 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 637 "MagickWand/compare.c" 3 4
       ((void *)0)
# 637 "MagickWand/compare.c"
        ...
        if (LocaleCompare("encipher",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 647,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 647 "MagickWand/compare.c" 3 4
             ((void *)0)
# 647 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 647 "MagickWand/compare.c" 3 4
             ((void *)0)
# 647 "MagickWand/compare.c"
        ...
        if (LocaleCompare("extract",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 656,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 656 "MagickWand/compare.c" 3 4
             ((void *)0)
# 656 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 656 "MagickWand/compare.c" 3 4
             ((void *)0)
# 656 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 658,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 658 "MagickWand/compare.c" 3 4
             ((void *)0)
# 658 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 658 "MagickWand/compare.c" 3 4
             ((void *)0)
# 658 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 661,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 661 "MagickWand/compare.c" 3 4
       ((void *)0)
# 661 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 661 "MagickWand/compare.c" 3 4
       ((void *)0)
# 661 "MagickWand/compare.c"
        ...
        if (LocaleCompare("format",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 671,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 671 "MagickWand/compare.c" 3 4
             ((void *)0)
# 671 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 671 "MagickWand/compare.c" 3 4
             ((void *)0)
# 671 "MagickWand/compare.c"
        ...
        if (LocaleCompare("fuzz",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 681,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 681 "MagickWand/compare.c" 3 4
             ((void *)0)
# 681 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 681 "MagickWand/compare.c" 3 4
             ((void *)0)
# 681 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 683,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 683 "MagickWand/compare.c" 3 4
             ((void *)0)
# 683 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 683 "MagickWand/compare.c" 3 4
             ((void *)0)
# 683 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 686,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 686 "MagickWand/compare.c" 3 4
       ((void *)0)
# 686 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 686 "MagickWand/compare.c" 3 4
       ((void *)0)
# 686 "MagickWand/compare.c"
        ...
        if (LocaleCompare("gravity",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 699,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 699 "MagickWand/compare.c" 3 4
             ((void *)0)
# 699 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 699 "MagickWand/compare.c" 3 4
             ((void *)0)
# 699 "MagickWand/compare.c"
            ...
            gravity=ParseCommandOption(MagickGravityOptions,MagickFalse,
              argv[i]);
            if (gravity < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 703,OptionError,"UnrecognizedGravityType", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 703 "MagickWand/compare.c" 3 4
             ((void *)0)
# 703 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 703 "MagickWand/compare.c" 3 4
             ((void *)0)
# 703 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 707,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 707 "MagickWand/compare.c" 3 4
       ((void *)0)
# 707 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 707 "MagickWand/compare.c" 3 4
       ((void *)0)
# 707 "MagickWand/compare.c"
      ...
      case 'h':
      {
        if ((LocaleCompare("help",option+1) == 0) ||
          ...
          {
            { if (similarity_image != (Image *) 
# 714 "MagickWand/compare.c" 3 4
           ((void *)0)
# 714 "MagickWand/compare.c"
           ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 714 "MagickWand/compare.c" 3 4
           ((void *)0)
# 714 "MagickWand/compare.c"
        ...
        if (LocaleCompare("highlight-color",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 723,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 723 "MagickWand/compare.c" 3 4
             ((void *)0)
# 723 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 723 "MagickWand/compare.c" 3 4
             ((void *)0)
# 723 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 726,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 726 "MagickWand/compare.c" 3 4
       ((void *)0)
# 726 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 726 "MagickWand/compare.c" 3 4
       ((void *)0)
# 726 "MagickWand/compare.c"
        ...
        if (LocaleCompare("interlace",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 741,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 741 "MagickWand/compare.c" 3 4
             ((void *)0)
# 741 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 741 "MagickWand/compare.c" 3 4
             ((void *)0)
# 741 "MagickWand/compare.c"
            ...
            interlace=ParseCommandOption(MagickInterlaceOptions,MagickFalse,
              argv[i]);
            if (interlace < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 745,OptionError,"UnrecognizedInterlaceType", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 745 "MagickWand/compare.c" 3 4
             ((void *)0)
# 745 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 745 "MagickWand/compare.c" 3 4
             ((void *)0)
# 745 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 749,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 749 "MagickWand/compare.c" 3 4
       ((void *)0)
# 749 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 749 "MagickWand/compare.c" 3 4
       ((void *)0)
# 749 "MagickWand/compare.c"
        ...
        if (LocaleCompare("level",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 757,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 757 "MagickWand/compare.c" 3 4
             ((void *)0)
# 757 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 757 "MagickWand/compare.c" 3 4
             ((void *)0)
# 757 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 759,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 759 "MagickWand/compare.c" 3 4
             ((void *)0)
# 759 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 759 "MagickWand/compare.c" 3 4
             ((void *)0)
# 759 "MagickWand/compare.c"
        ...
        if (LocaleCompare("limit",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 777,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 777 "MagickWand/compare.c" 3 4
             ((void *)0)
# 777 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 777 "MagickWand/compare.c" 3 4
             ((void *)0)
# 777 "MagickWand/compare.c"
            ...
            resource=ParseCommandOption(MagickResourceOptions,MagickFalse,
              argv[i]);
            if (resource < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 781,OptionError,"UnrecognizedResourceType", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 781 "MagickWand/compare.c" 3 4
             ((void *)0)
# 781 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 781 "MagickWand/compare.c" 3 4
             ((void *)0)
# 781 "MagickWand/compare.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 785,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 785 "MagickWand/compare.c" 3 4
             ((void *)0)
# 785 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 785 "MagickWand/compare.c" 3 4
             ((void *)0)
# 785 "MagickWand/compare.c"
            ...
            if ((p == argv[i]) && (LocaleCompare("unlimited",argv[i]) != 0))
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 789,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 789 "MagickWand/compare.c" 3 4
             ((void *)0)
# 789 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 789 "MagickWand/compare.c" 3 4
             ((void *)0)
# 789 "MagickWand/compare.c"
        ...
        if (LocaleCompare("list",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 801,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 801 "MagickWand/compare.c" 3 4
             ((void *)0)
# 801 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 801 "MagickWand/compare.c" 3 4
             ((void *)0)
# 801 "MagickWand/compare.c"
            ...
            if (list < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 804,OptionError,"UnrecognizedListType", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 804 "MagickWand/compare.c" 3 4
             ((void *)0)
# 804 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 804 "MagickWand/compare.c" 3 4
             ((void *)0)
# 804 "MagickWand/compare.c"
            ...
            status=MogrifyImageInfo(image_info,(int) (i-j+1),(const char **)
              argv+j,exception);
            { if (similarity_image != (Image *) 
# 807 "MagickWand/compare.c" 3 4
           ((void *)0)
# 807 "MagickWand/compare.c"
           ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 807 "MagickWand/compare.c" 3 4
           ((void *)0)
# 807 "MagickWand/compare.c"
...
# 815 "MagickWand/compare.c" 3 4
                                                                         ((void *)0)
# 815 "MagickWand/compare.c"
                                                                             ))
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 816,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 816 "MagickWand/compare.c" 3 4
             ((void *)0)
# 816 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 816 "MagickWand/compare.c" 3 4
             ((void *)0)
# 816 "MagickWand/compare.c"
        ...
        if (LocaleCompare("lowlight-color",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 825,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 825 "MagickWand/compare.c" 3 4
             ((void *)0)
# 825 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 825 "MagickWand/compare.c" 3 4
             ((void *)0)
# 825 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 828,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 828 "MagickWand/compare.c" 3 4
       ((void *)0)
# 828 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 828 "MagickWand/compare.c" 3 4
       ((void *)0)
# 828 "MagickWand/compare.c"
        ...
        if (LocaleCompare("metric",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 843,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 843 "MagickWand/compare.c" 3 4
             ((void *)0)
# 843 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 843 "MagickWand/compare.c" 3 4
             ((void *)0)
# 843 "MagickWand/compare.c"
            ...
            if (type < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 846,OptionError,"UnrecognizedMetricType", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 846 "MagickWand/compare.c" 3 4
             ((void *)0)
# 846 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 846 "MagickWand/compare.c" 3 4
             ((void *)0)
# 846 "MagickWand/compare.c"
        ...
        if (LocaleCompare("monitor",option+1) == 0)
          break;
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 853,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 853 "MagickWand/compare.c" 3 4
       ((void *)0)
# 853 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 853 "MagickWand/compare.c" 3 4
       ((void *)0)
# 853 "MagickWand/compare.c"
      ...
      case 'n':
      {
        if (LocaleCompare("negate",option+1) == 0)
          break;
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 859,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 859 "MagickWand/compare.c" 3 4
       ((void *)0)
# 859 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 859 "MagickWand/compare.c" 3 4
       ((void *)0)
# 859 "MagickWand/compare.c"
        ...
        if (LocaleCompare("passphrase",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 869,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 869 "MagickWand/compare.c" 3 4
             ((void *)0)
# 869 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 869 "MagickWand/compare.c" 3 4
             ((void *)0)
# 869 "MagickWand/compare.c"
        ...
        if (LocaleCompare("precision",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 878,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 878 "MagickWand/compare.c" 3 4
             ((void *)0)
# 878 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 878 "MagickWand/compare.c" 3 4
             ((void *)0)
# 878 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 880,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 880 "MagickWand/compare.c" 3 4
             ((void *)0)
# 880 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 880 "MagickWand/compare.c" 3 4
             ((void *)0)
# 880 "MagickWand/compare.c"
        ...
        if (LocaleCompare("profile",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 887,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 887 "MagickWand/compare.c" 3 4
             ((void *)0)
# 887 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 887 "MagickWand/compare.c" 3 4
             ((void *)0)
# 887 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 890,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 890 "MagickWand/compare.c" 3 4
       ((void *)0)
# 890 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 890 "MagickWand/compare.c" 3 4
       ((void *)0)
# 890 "MagickWand/compare.c"
        ...
        if (LocaleCompare("quality",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 900,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 900 "MagickWand/compare.c" 3 4
             ((void *)0)
# 900 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 900 "MagickWand/compare.c" 3 4
             ((void *)0)
# 900 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 902,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 902 "MagickWand/compare.c" 3 4
             ((void *)0)
# 902 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 902 "MagickWand/compare.c" 3 4
             ((void *)0)
# 902 "MagickWand/compare.c"
        ...
        if (LocaleCompare("quantize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 914,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 914 "MagickWand/compare.c" 3 4
             ((void *)0)
# 914 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 914 "MagickWand/compare.c" 3 4
             ((void *)0)
# 914 "MagickWand/compare.c"
            ...
            colorspace=ParseCommandOption(MagickColorspaceOptions,
              MagickFalse,argv[i]);
            if (colorspace < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 918,OptionError,"UnrecognizedColorspace", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 918 "MagickWand/compare.c" 3 4
             ((void *)0)
# 918 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 918 "MagickWand/compare.c" 3 4
             ((void *)0)
# 918 "MagickWand/compare.c"
        ...
        if (LocaleCompare("quiet",option+1) == 0)
          break;
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 924,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 924 "MagickWand/compare.c" 3 4
       ((void *)0)
# 924 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 924 "MagickWand/compare.c" 3 4
       ((void *)0)
# 924 "MagickWand/compare.c"
        ...
        if (LocaleCompare("read-mask",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 934,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 934 "MagickWand/compare.c" 3 4
             ((void *)0)
# 934 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 934 "MagickWand/compare.c" 3 4
             ((void *)0)
# 934 "MagickWand/compare.c"
        ...
        if (LocaleCompare("repage",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 945,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 945 "MagickWand/compare.c" 3 4
             ((void *)0)
# 945 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 945 "MagickWand/compare.c" 3 4
             ((void *)0)
# 945 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 947,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 947 "MagickWand/compare.c" 3 4
             ((void *)0)
# 947 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 947 "MagickWand/compare.c" 3 4
             ((void *)0)
# 947 "MagickWand/compare.c"
        ...
        if (LocaleCompare("resize",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 956,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 956 "MagickWand/compare.c" 3 4
             ((void *)0)
# 956 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 956 "MagickWand/compare.c" 3 4
             ((void *)0)
# 956 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 958,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 958 "MagickWand/compare.c" 3 4
             ((void *)0)
# 958 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 958 "MagickWand/compare.c" 3 4
             ((void *)0)
# 958 "MagickWand/compare.c"
        ...
        if (LocaleCompare("rotate",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 970,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 970 "MagickWand/compare.c" 3 4
             ((void *)0)
# 970 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 970 "MagickWand/compare.c" 3 4
             ((void *)0)
# 970 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 972,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 972 "MagickWand/compare.c" 3 4
             ((void *)0)
# 972 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 972 "MagickWand/compare.c" 3 4
             ((void *)0)
# 972 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 975,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 975 "MagickWand/compare.c" 3 4
       ((void *)0)
# 975 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 975 "MagickWand/compare.c" 3 4
       ((void *)0)
# 975 "MagickWand/compare.c"
        ...
        if (LocaleCompare("sampling-factor",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 985,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 985 "MagickWand/compare.c" 3 4
             ((void *)0)
# 985 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 985 "MagickWand/compare.c" 3 4
             ((void *)0)
# 985 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 987,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 987 "MagickWand/compare.c" 3 4
             ((void *)0)
# 987 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 987 "MagickWand/compare.c" 3 4
             ((void *)0)
# 987 "MagickWand/compare.c"
        ...
        if (LocaleCompare("seed",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 996,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 996 "MagickWand/compare.c" 3 4
             ((void *)0)
# 996 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 996 "MagickWand/compare.c" 3 4
             ((void *)0)
# 996 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 998,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 998 "MagickWand/compare.c" 3 4
             ((void *)0)
# 998 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 998 "MagickWand/compare.c" 3 4
             ((void *)0)
# 998 "MagickWand/compare.c"
        ...
        if (LocaleCompare("set",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1007,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 1007 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1007 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1007 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1007 "MagickWand/compare.c"
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1012,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 1012 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1012 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1012 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1012 "MagickWand/compare.c"
        ...
        if (LocaleCompare("sigmoidal-contrast",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1019,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 1019 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1019 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1019 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1019 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1021,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 1021 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1021 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1021 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1021 "MagickWand/compare.c"
        ...
        if (LocaleCompare("similarity-threshold",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1030,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 1030 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1030 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1030 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1030 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1032,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 1032 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1032 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1032 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1032 "MagickWand/compare.c"
            ...
            if (*option == '+')
              ...
              similarity_threshold=StringToDouble(argv[i],(char **) 
# 1036 "MagickWand/compare.c" 3 4
                                                                   ((void *)0)
# 1036 "MagickWand/compare.c"
                                                                       );
            break;
          }
        if (LocaleCompare("size",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1045,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 1045 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1045 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1045 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1045 "MagickWand/compare.c"
            ...
            if (IsGeometry(argv[i]) == MagickFalse)
              { (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1047,OptionError, "InvalidArgument","'%s': %s",option,argv[i]); { if (similarity_image != (Image *) 
# 1047 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1047 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1047 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1047 "MagickWand/compare.c"
        ...
        if (LocaleCompare("synchronize",option+1) == 0)
          break;
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1062,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 1062 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1062 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1062 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1062 "MagickWand/compare.c"
        ...
        if (LocaleCompare("transparent-color",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1074,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 1074 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1074 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1074 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1074 "MagickWand/compare.c"
        ...
        if (LocaleCompare("type",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1088,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 1088 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1088 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1088 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1088 "MagickWand/compare.c"
            ...
            if (type < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1091,OptionError,"UnrecognizedImageType", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 1091 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1091 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1091 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1091 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1095,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 1095 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1095 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1095 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1095 "MagickWand/compare.c"
      ...
      case 'v':
      {
        ...
        if ((LocaleCompare("version",option+1) == 0) ||
          ...
          {
            ListMagickVersion(
# 1104 "MagickWand/compare.c" 3 4
                             stdout
# 1104 "MagickWand/compare.c"
                                   );
            break;
          }
        if (LocaleCompare("virtual-pixel",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1116,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 1116 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1116 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1116 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1116 "MagickWand/compare.c"
            ...
            method=ParseCommandOption(MagickVirtualPixelOptions,MagickFalse,
              argv[i]);
            if (method < 0)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1120,OptionError,"UnrecognizedVirtualPixelMethod", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 1120 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1120 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1120 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1120 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1124,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 1124 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1124 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1124 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1124 "MagickWand/compare.c"
        ...
        if (LocaleCompare("write",option+1) == 0)
          {
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1132,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 1132 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1132 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1132 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1132 "MagickWand/compare.c"
        ...
        if (LocaleCompare("write-mask",option+1) == 0)
          {
            ...
            i++;
            if (i == (ssize_t) argc)
              { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1141,OptionError,"MissingArgument", "`%s'",option); { if (similarity_image != (Image *) 
# 1141 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1141 "MagickWand/compare.c"
             ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1141 "MagickWand/compare.c" 3 4
             ((void *)0)
# 1141 "MagickWand/compare.c"
        ...
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1144,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 1144 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1144 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1144 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1144 "MagickWand/compare.c"
      ...
      case '?':
        break;
      default:
        { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1149,OptionError,"UnrecognizedOption", "`%s'",option); { if (similarity_image != (Image *) 
# 1149 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1149 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1149 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1149 "MagickWand/compare.c"
    ...
    if (fire != MagickFalse)
      if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 1154 "MagickWand/compare.c" 3 4
     ((void *)0)
# 1154 "MagickWand/compare.c"
     ) status&=(MagickStatusType) MogrifyImageInfo(image_stack[k].image_info, (int) (i-j+1),(const char **) (argv+j),exception); else if ((MagickTrue) != MagickFalse) { status&=(MagickStatusType) MogrifyImages(image_stack[k].image_info, MagickTrue,(int) (i-j+1),(const char **) (argv+j), &image_stack[k].image,exception); image=image_stack[k].image; if ((MagickTrue) != MagickFalse) j=i+1; pend=MagickFalse; } };
  }
  if (k != 0)
    { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1157,OptionError,"UnbalancedParenthesis", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 1157 "MagickWand/compare.c" 3 4
   ((void *)0)
# 1157 "MagickWand/compare.c"
   ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1157 "MagickWand/compare.c" 3 4
   ((void *)0)
# 1157 "MagickWand/compare.c"
  ...
  if (i-- != (ssize_t) (argc-1))
    { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1159,OptionError,"MissingAnImageFilename", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 1159 "MagickWand/compare.c" 3 4
   ((void *)0)
# 1159 "MagickWand/compare.c"
   ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1159 "MagickWand/compare.c" 3 4
   ((void *)0)
# 1159 "MagickWand/compare.c"
  ...
  if ((image == (Image *) 
# 1160 "MagickWand/compare.c" 3 4
                         ((void *)0)
# 1160 "MagickWand/compare.c"
                             ) || (GetImageListLength(image) < 2))
    { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1161,OptionError,"MissingAnImageFilename", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 1161 "MagickWand/compare.c" 3 4
   ((void *)0)
# 1161 "MagickWand/compare.c"
   ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1161 "MagickWand/compare.c" 3 4
   ((void *)0)
# 1161 "MagickWand/compare.c"
  ...
  { if ((j <= i) && (i < (ssize_t) argc)) { if (image_stack[k].image == (Image *) 
# 1162 "MagickWand/compare.c" 3 4
 ((void *)0)
# 1162 "MagickWand/compare.c"
...
# 1162 "MagickWand/compare.c"
  ...
  if ((image == (Image *) 
# 1163 "MagickWand/compare.c" 3 4
                         ((void *)0)
# 1163 "MagickWand/compare.c"
                             ) || (GetImageListLength(image) < 2))
    { if (exception->severity < (OptionError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1164,OptionError,"MissingAnImageFilename", "`%s'",argv[i]); { if (similarity_image != (Image *) 
# 1164 "MagickWand/compare.c" 3 4
   ((void *)0)
# 1164 "MagickWand/compare.c"
   ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1164 "MagickWand/compare.c" 3 4
   ((void *)0)
# 1164 "MagickWand/compare.c"
  ...
  if (subimage_search != MagickFalse)
    {
      ...
      if (similarity_metric > dissimilarity_threshold)
        { if (exception->severity < (ImageError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1174,ImageError,"ImagesTooDissimilar", "`%s'",image->filename); { if (similarity_image != (Image *) 
# 1174 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1174 "MagickWand/compare.c"
       ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1174 "MagickWand/compare.c" 3 4
       ((void *)0)
# 1174 "MagickWand/compare.c"
  ...
  if ((reconstruct_image->columns == image->columns) &&
    ...
    if (similarity_image == (Image *) 
# 1181 "MagickWand/compare.c" 3 4
                                     ((void *)0)
# 1181 "MagickWand/compare.c"
                                         )
      difference_image=CompareImages(image,reconstruct_image,metric,&distortion,
        exception);
    else
...
# 1193 "MagickWand/compare.c" 3 4
                                        ((void *)0)
# 1193 "MagickWand/compare.c"
                                            )
        ...
        else
          {
            ...
            difference_image=CompareImages(image,composite_image,metric,
              &distortion,exception);
            if (difference_image != (Image *) 
# 1208 "MagickWand/compare.c" 3 4
                                             ((void *)0)
# 1208 "MagickWand/compare.c"
                                                 )
              {
            ...
            if (distort_image != (Image *) 
# 1219 "MagickWand/compare.c" 3 4
                                          ((void *)0)
# 1219 "MagickWand/compare.c"
                                              )
              {
                Image
                  *sans_image;
                ...
                if (sans_image != (Image *) 
# 1227 "MagickWand/compare.c" 3 4
                                           ((void *)0)
# 1227 "MagickWand/compare.c"
                                               )
                  sans_image=DestroyImage(sans_image);
              }
          }
        if (difference_image != (Image *) 
# 1231 "MagickWand/compare.c" 3 4
                                         ((void *)0)
# 1231 "MagickWand/compare.c"
                                             )
          {
            AppendImageToList(&difference_image,similarity_image);
            similarity_image=(Image *) 
# 1234 "MagickWand/compare.c" 3 4
                                      ((void *)0)
# 1234 "MagickWand/compare.c"
                                          ;
          }
      }
  if (difference_image == (Image *) 
# 1237 "MagickWand/compare.c" 3 4
                                   ((void *)0)
# 1237 "MagickWand/compare.c"
                                       )
    status=0;
  else
    {
...
# 1256 "MagickWand/compare.c" 3 4
                                     stderr
# 1256 "MagickWand/compare.c"
                                           ,"%.*g (%.*g)",GetMagickPrecision(),
                (double) ((Quantum) 65535.0)*distortion,GetMagickPrecision(),
                distortion);
              break;
            }
            ...
            {
              (void) FormatLocaleFile(
# 1263 "MagickWand/compare.c" 3 4
                                     stderr
# 1263 "MagickWand/compare.c"
                                           ,"%.*g (%.*g)",GetMagickPrecision(),
            ...
            {
              (void) FormatLocaleFile(
# 1273 "MagickWand/compare.c" 3 4
                                     stderr
# 1273 "MagickWand/compare.c"
            ...
            {
              (void) FormatLocaleFile(
# 1279 "MagickWand/compare.c" 3 4
                                     stderr
# 1279 "MagickWand/compare.c"
                                           ,"%.*g (%.*g, %.*g)",
          ...
          if (subimage_search != MagickFalse)
            (void) FormatLocaleFile(
# 1289 "MagickWand/compare.c" 3 4
                                   stderr
# 1289 "MagickWand/compare.c"
                                         ," @ %.20g,%.20g",
      ...
      else
        {
          ...
          channel_distortion=GetImageDistortions(image,reconstruct_image,
            metric,exception);
          (void) FormatLocaleFile(
# 1300 "MagickWand/compare.c" 3 4
                                 stderr
# 1300 "MagickWand/compare.c"
                                       ,"Image: %s\n",image->filename);
          if ((reconstruct_image->columns != image->columns) ||
              (reconstruct_image->rows != image->rows))
            (void) FormatLocaleFile(
# 1303 "MagickWand/compare.c" 3 4
                                   stderr
# 1303 "MagickWand/compare.c"
                                         ,"Offset: %.20g,%.20g\n",(double)
              difference_image->page.x,(double) difference_image->page.y);
          (void) FormatLocaleFile(
# 1305 "MagickWand/compare.c" 3 4
                                 stderr
# 1305 "MagickWand/compare.c"
          ...
          switch (metric)
          {
            ...
            case RootMeanSquaredErrorMetric:
            {
              switch (image->colorspace)
              {
                ...
                {
                  (void) FormatLocaleFile(
# 1320 "MagickWand/compare.c" 3 4
                                         stderr
# 1320 "MagickWand/compare.c"
                                               ,"    red: %.*g (%.*g)\n",
                    GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                    channel_distortion[RedPixelChannel],GetMagickPrecision(),
                    channel_distortion[RedPixelChannel]);
                  (void) FormatLocaleFile(
# 1324 "MagickWand/compare.c" 3 4
                                         stderr
# 1324 "MagickWand/compare.c"
                                               ,"    green: %.*g (%.*g)\n",
                    GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                    channel_distortion[GreenPixelChannel],GetMagickPrecision(),
                    channel_distortion[GreenPixelChannel]);
                  (void) FormatLocaleFile(
# 1328 "MagickWand/compare.c" 3 4
                                         stderr
# 1328 "MagickWand/compare.c"
                                               ,"    blue: %.*g (%.*g)\n",
                    GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                  ...
                  if (image->alpha_trait != UndefinedPixelTrait)
                    (void) FormatLocaleFile(
# 1333 "MagickWand/compare.c" 3 4
                                           stderr
# 1333 "MagickWand/compare.c"
                                                 ,"    alpha: %.*g (%.*g)\n",
                      GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                ...
                {
                  (void) FormatLocaleFile(
# 1342 "MagickWand/compare.c" 3 4
                                         stderr
# 1342 "MagickWand/compare.c"
                                               ,"    cyan: %.*g (%.*g)\n",
                    GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                    channel_distortion[CyanPixelChannel],GetMagickPrecision(),
                    channel_distortion[CyanPixelChannel]);
                  (void) FormatLocaleFile(
# 1346 "MagickWand/compare.c" 3 4
                                         stderr
# 1346 "MagickWand/compare.c"
                                               ,"    magenta: %.*g (%.*g)\n",
                    GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                    ...
                    channel_distortion[MagentaPixelChannel]);
                  (void) FormatLocaleFile(
# 1351 "MagickWand/compare.c" 3 4
                                         stderr
# 1351 "MagickWand/compare.c"
                                               ,"    yellow: %.*g (%.*g)\n",
                    GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                    channel_distortion[YellowPixelChannel],GetMagickPrecision(),
                    channel_distortion[YellowPixelChannel]);
                  (void) FormatLocaleFile(
# 1355 "MagickWand/compare.c" 3 4
                                         stderr
# 1355 "MagickWand/compare.c"
                                               ,"    black: %.*g (%.*g)\n",
                    GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                  ...
                  if (image->alpha_trait != UndefinedPixelTrait)
                    (void) FormatLocaleFile(
# 1360 "MagickWand/compare.c" 3 4
                                           stderr
# 1360 "MagickWand/compare.c"
                                                 ,"    alpha: %.*g (%.*g)\n",
                      GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                      channel_distortion[AlphaPixelChannel],
                      GetMagickPrecision(),
                ...
                {
                  (void) FormatLocaleFile(
# 1370 "MagickWand/compare.c" 3 4
                                         stderr
# 1370 "MagickWand/compare.c"
                                               ,"    gray: %.*g (%.*g)\n",
                    GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                  ...
                  if (image->alpha_trait != UndefinedPixelTrait)
                    (void) FormatLocaleFile(
# 1375 "MagickWand/compare.c" 3 4
                                           stderr
# 1375 "MagickWand/compare.c"
                                                 ,"    alpha: %.*g (%.*g)\n",
                      GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                      channel_distortion[AlphaPixelChannel],
                      GetMagickPrecision(),
              ...
              (void) FormatLocaleFile(
# 1383 "MagickWand/compare.c" 3 4
                                     stderr
# 1383 "MagickWand/compare.c"
                                           ,"    all: %.*g (%.*g)\n",
                GetMagickPrecision(),(double) ((Quantum) 65535.0)*
                channel_distortion[64],GetMagickPrecision(),
                channel_distortion[64]);
              break;
            }
            case AbsoluteErrorMetric:
            case NormalizedCrossCorrelationErrorMetric:
            ...
            case StructuralDissimilarityErrorMetric:
            {
              switch (image->colorspace)
              {
                ...
                {
                  (void) FormatLocaleFile(
# 1401 "MagickWand/compare.c" 3 4
                                         stderr
# 1401 "MagickWand/compare.c"
                                               ,"    red: %.*g\n",
                    GetMagickPrecision(),channel_distortion[RedPixelChannel]);
                  (void) FormatLocaleFile(
# 1403 "MagickWand/compare.c" 3 4
                                         stderr
# 1403 "MagickWand/compare.c"
                                               ,"    green: %.*g\n",
                    GetMagickPrecision(),channel_distortion[GreenPixelChannel]);
                  (void) FormatLocaleFile(
# 1405 "MagickWand/compare.c" 3 4
                                         stderr
# 1405 "MagickWand/compare.c"
                                               ,"    blue: %.*g\n",
                    GetMagickPrecision(),channel_distortion[BluePixelChannel]);
                  if (image->alpha_trait != UndefinedPixelTrait)
                    (void) FormatLocaleFile(
# 1408 "MagickWand/compare.c" 3 4
                                           stderr
# 1408 "MagickWand/compare.c"
                                                 ,"    alpha: %.*g\n",
                      GetMagickPrecision(),
                       channel_distortion[AlphaPixelChannel]);
                  break;
                ...
                {
                  (void) FormatLocaleFile(
# 1415 "MagickWand/compare.c" 3 4
                                         stderr
# 1415 "MagickWand/compare.c"
                                               ,"    cyan: %.*g\n",
                    GetMagickPrecision(),channel_distortion[CyanPixelChannel]);
                  (void) FormatLocaleFile(
# 1417 "MagickWand/compare.c" 3 4
                                         stderr
# 1417 "MagickWand/compare.c"
                                               ,"    magenta: %.*g\n",
                    GetMagickPrecision(),
                    channel_distortion[MagentaPixelChannel]);
                  (void) FormatLocaleFile(
# 1420 "MagickWand/compare.c" 3 4
                                         stderr
# 1420 "MagickWand/compare.c"
                                               ,"    yellow: %.*g\n",
                    GetMagickPrecision(),
                    channel_distortion[YellowPixelChannel]);
                  (void) FormatLocaleFile(
# 1423 "MagickWand/compare.c" 3 4
                                         stderr
# 1423 "MagickWand/compare.c"
                                               ,"    black: %.*g\n",
                    GetMagickPrecision(),
                    channel_distortion[BlackPixelChannel]);
                  if (image->alpha_trait != UndefinedPixelTrait)
                    (void) FormatLocaleFile(
# 1427 "MagickWand/compare.c" 3 4
                                           stderr
# 1427 "MagickWand/compare.c"
                                                 ,"    alpha: %.*g\n",
                      GetMagickPrecision(),
                      channel_distortion[AlphaPixelChannel]);
                  break;
                ...
                {
                  (void) FormatLocaleFile(
# 1435 "MagickWand/compare.c" 3 4
                                         stderr
# 1435 "MagickWand/compare.c"
                                               ,"    gray: %.*g\n",
                    GetMagickPrecision(),channel_distortion[GrayPixelChannel]);
                  if (image->alpha_trait != UndefinedPixelTrait)
                    (void) FormatLocaleFile(
# 1438 "MagickWand/compare.c" 3 4
                                           stderr
# 1438 "MagickWand/compare.c"
                                                 ,"    alpha: %.*g\n",
                      GetMagickPrecision(),
                      channel_distortion[AlphaPixelChannel]);
                  break;
              ...
              (void) FormatLocaleFile(
# 1444 "MagickWand/compare.c" 3 4
                                     stderr
# 1444 "MagickWand/compare.c"
                                           ,"    all: %.*g\n",
                GetMagickPrecision(),channel_distortion[64]);
              break;
            }
            case MeanErrorPerPixelErrorMetric:
            {
              (void) FormatLocaleFile(
# 1450 "MagickWand/compare.c" 3 4
                                     stderr
# 1450 "MagickWand/compare.c"
                                           ,"    %.*g (%.*g, %.*g)\n",
                GetMagickPrecision(),channel_distortion[64],
                GetMagickPrecision(),image->error.normalized_mean_error,
                GetMagickPrecision(),image->error.normalized_maximum_error);
          ...
          if (subimage_search != MagickFalse)
            (void) FormatLocaleFile(
# 1462 "MagickWand/compare.c" 3 4
                                   stderr
# 1462 "MagickWand/compare.c"
                                         ,"   Offset: %.20g,%.20g\n",(double)
              difference_image->page.x,(double) difference_image->page.y);
        }
      (void) ResetImagePage(difference_image,"0x0+0+0");
      if (difference_image->next != (Image *) 
# 1466 "MagickWand/compare.c" 3 4
                                             ((void *)0)
# 1466 "MagickWand/compare.c"
                                                 )
      ...
      if ((metadata != (char **) 
# 1470 "MagickWand/compare.c" 3 4
                                ((void *)0)
# 1470 "MagickWand/compare.c"
                                    ) && (format != (char *) 
# 1470 "MagickWand/compare.c" 3 4
                                                             ((void *)0)
# 1470 "MagickWand/compare.c"
                                                                 ))
        {
          ...
          text=InterpretImageProperties(image_info,difference_image,format,
            exception);
          if (text == (char *) 
# 1477 "MagickWand/compare.c" 3 4
                              ((void *)0)
# 1477 "MagickWand/compare.c"
                                  )
            { if (exception->severity < (ResourceLimitError)) (void) ThrowMagickException(exception,"MagickWand/compare.c",__func__,(unsigned long) 1478,ResourceLimitError,"MemoryAllocationFailed", "`%s'",GetExceptionMessage(
# 1478 "MagickWand/compare.c" 3 4
           (*__errno_location ())
# 1478 "MagickWand/compare.c"
           )); { if (similarity_image != (Image *) 
# 1478 "MagickWand/compare.c" 3 4
           ((void *)0)
# 1478 "MagickWand/compare.c"
...
# 1478 "MagickWand/compare.c"
  ...
  { if (similarity_image != (Image *) 
# 1485 "MagickWand/compare.c" 3 4
 ((void *)0)
# 1485 "MagickWand/compare.c"
 ) similarity_image=DestroyImageList(similarity_image); if (difference_image != (Image *) 
# 1485 "MagickWand/compare.c" 3 4
 ((void *)0)
# 1485 "MagickWand/compare.c"
  ...
  if ((metric == NormalizedCrossCorrelationErrorMetric) ||
      (metric == UndefinedErrorMetric))
    {
      if (fabs(distortion-1.0) > (1.0e-06))
        (void) SetImageOption(image_info,"compare:dissimilar","true");
    }
  else
    if (fabs(distortion) > (1.0e-06))
      (void) SetImageOption(image_info,"compare:dissimilar","true");
