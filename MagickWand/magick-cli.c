# 0 "MagickWand/magick-cli.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/magick-cli.c"
# 49 "MagickWand/magick-cli.c"
...
# 54 "MagickWand/magick-cli.c" 2


# 1 "./MagickWand/script-token.h" 1
# 26 "./MagickWand/script-token.h"
typedef enum {
  TokenStatusOK = 0,
  TokenStatusEOF,
...
# 61 "MagickWand/magick-cli.c" 2
# 116 "MagickWand/magick-cli.c"
__attribute__ ((visibility ("default"))) MagickBooleanType MagickCommandGenesis(ImageInfo *image_info,
  ...
  ExceptionInfo *exception)
{
  ...
  (void) setlocale(
# 141 "MagickWand/magick-cli.c" 3 4
                  6
# 141 "MagickWand/magick-cli.c"
                        ,"");
  (void) setlocale(
# 142 "MagickWand/magick-cli.c" 3 4
                  1
# 142 "MagickWand/magick-cli.c"
                            ,"C");
  ...
  for (i=1; i < (ssize_t) (argc-1); i++)
  {
    ...
    if (LocaleCompare("-duration",option) == 0)
      duration=StringToDouble(argv[++i],(char **) 
# 167 "MagickWand/magick-cli.c" 3 4
                                                 ((void *)0)
# 167 "MagickWand/magick-cli.c"
                                                     );
  ...
  if (iterations == 1)
    {
      ...
      text=(char *) 
# 176 "MagickWand/magick-cli.c" 3 4
                   ((void *)0)
# 176 "MagickWand/magick-cli.c"
                       ;
      ...
      if (text != (char *) 
# 185 "MagickWand/magick-cli.c" 3 4
                          ((void *)0)
# 185 "MagickWand/magick-cli.c"
                              )
        {
          if (metadata != (char **) 
# 187 "MagickWand/magick-cli.c" 3 4
                                   ((void *)0)
# 187 "MagickWand/magick-cli.c"
                                       )
    ...
    if (concurrent == MagickFalse)
      {
        for (i=0; i < (ssize_t) iterations; i++)
        {
          ...
          text=(char *) 
# 214 "MagickWand/magick-cli.c" 3 4
                       ((void *)0)
# 214 "MagickWand/magick-cli.c"
                           ;
          ...
          if (text != (char *) 
# 231 "MagickWand/magick-cli.c" 3 4
                              ((void *)0)
# 231 "MagickWand/magick-cli.c"
                                  )
            {
              if (metadata != (char **) 
# 233 "MagickWand/magick-cli.c" 3 4
                                       ((void *)0)
# 233 "MagickWand/magick-cli.c"
                                           )
                (void) ConcatenateString(&(*metadata),text);
              text=DestroyString(text);
            }
    ...
    else
      {
        ...
        for (i=0; i < (ssize_t) iterations; i++)
        {
          ...
          text=(char *) 
# 250 "MagickWand/magick-cli.c" 3 4
                       ((void *)0)
# 250 "MagickWand/magick-cli.c"
                           ;
          if (status == MagickFalse)
            continue;
          if (duration > 0)
...

          {
            ...
            if (text != (char *) 
# 271 "MagickWand/magick-cli.c" 3 4
                                ((void *)0)
# 271 "MagickWand/magick-cli.c"
                                    )
              {
                if (metadata != (char **) 
# 273 "MagickWand/magick-cli.c" 3 4
                                         ((void *)0)
# 273 "MagickWand/magick-cli.c"
                                             )
                  (void) ConcatenateString(&(*metadata),text);
                text=DestroyString(text);
              }
...
# 288 "MagickWand/magick-cli.c" 3 4
                           stderr
# 288 "MagickWand/magick-cli.c"
                                 ,
...
# 340 "MagickWand/magick-cli.c"
__attribute__ ((visibility ("default"))) void ProcessScriptOptions(MagickCLI *cli_wand,const char *filename,
  int magick_unused_argc __attribute__((unused)),char **magick_unused_argv __attribute__((unused)),int magick_unused_index __attribute__((unused)))
{
  ScriptTokenInfo
    *token_info;
...
# 360 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 360 "MagickWand/magick-cli.c"
 filename != (char *) 
# 360 "MagickWand/magick-cli.c" 3 4
...
# 360 "MagickWand/magick-cli.c"
 "filename != (char *) NULL"
# 360 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 360, __extension__ __PRETTY_FUNCTION__); }))
# 360 "MagickWand/magick-cli.c"
                                   ;
  
# 361 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 361 "MagickWand/magick-cli.c"
 cli_wand != (MagickCLI *) 
# 361 "MagickWand/magick-cli.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 361 "MagickWand/magick-cli.c"
...
# 361 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 361, __extension__ __PRETTY_FUNCTION__); }))
# 361 "MagickWand/magick-cli.c"
                                       ;
  
# 362 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 362 "MagickWand/magick-cli.c"
...
# 362 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 362, __extension__ __PRETTY_FUNCTION__); }))
# 362 "MagickWand/magick-cli.c"
                                                   ;
  if (cli_wand->wand.debug != MagickFalse)
    (void) LogMagickEvent(CommandEvent,"MagickWand/magick-cli.c",__func__,(unsigned long) 364,
         "Processing script \"%s\"", filename);


  token_info = AcquireScriptTokenInfo(filename);
  if (token_info == (ScriptTokenInfo *) 
# 369 "MagickWand/magick-cli.c" 3 4
                                       ((void *)0)
# 369 "MagickWand/magick-cli.c"
                                           ) {
    { char *message=GetExceptionMessage(
# 370 "MagickWand/magick-cli.c" 3 4
   (*__errno_location ())
# 370 "MagickWand/magick-cli.c"
   ); (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 370,OptionFatalError,"UnableToOpenScript", "'%s': %s",filename,message); message=DestroyString(message); };
    return;
  }
  ...
  option = arg1 = arg2 = (char*) 
# 383 "MagickWand/magick-cli.c" 3 4
                                ((void *)0)
# 383 "MagickWand/magick-cli.c"
                                    ;
...
# 418 "MagickWand/magick-cli.c" 3 4
                                                ((void *)0)
# 418 "MagickWand/magick-cli.c"
                                                    ;
          CLIOption(cli_wand,"-read",option);
          break;
        }
        (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 422,OptionFatalError,"UnrecognizedOption", "`%s'",option);
        break;
      }

      if ( count >= 1 ) {
        if (GetScriptToken(token_info) == MagickFalse)
          (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 428,OptionFatalError,"MissingArgument", "`%s'",option);
        CloneString(&arg1,token_info->token);
      }
      else
        CloneString(&arg1,(char *) 
# 432 "MagickWand/magick-cli.c" 3 4
                                  ((void *)0)
# 432 "MagickWand/magick-cli.c"
                                      );

      if ( count >= 2 ) {
        if (GetScriptToken(token_info) == MagickFalse)
          { (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 436,OptionFatalError,"MissingArgument", "`%s'",option); break; };
        CloneString(&arg2,token_info->token);
      }
      else
        CloneString(&arg2,(char *) 
# 440 "MagickWand/magick-cli.c" 3 4
                                  ((void *)0)
# 440 "MagickWand/magick-cli.c"
                                      );
# 451 "MagickWand/magick-cli.c"
      if ( (option_type & DeprecateOptionFlag) != 0 ) {
        (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 452,OptionError,"DeprecatedOptionNoCode", "`%s'",option);
        break;
      }


      if ( (option_type & GenesisOptionFlag) != 0 ) {
        (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 458,OptionError,"InvalidUseOfOption", "`%s'",option);
        break;
      }
      ...
      if ( (option_type & SpecialOptionFlag) != 0 ) {
        ...
        if ( LocaleCompare(option,"-script") == 0 ) {
          ...
          (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 469,OptionError,"InvalidUseOfOption", "`%s'",option);
          break;
        }


        (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 474,OptionError,"InvalidUseOfOption", "`%s'",option);
        break;
      }
      ...
      (void) fflush(
# 480 "MagickWand/magick-cli.c" 3 4
                   stdout
# 480 "MagickWand/magick-cli.c"
                         );
      (void) fflush(
# 481 "MagickWand/magick-cli.c" 3 4
                   stderr
# 481 "MagickWand/magick-cli.c"
                         );
...
# 505 "MagickWand/magick-cli.c" 3 4
                                                    ((void *)0)
# 505 "MagickWand/magick-cli.c"
                                                        )
        (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 506,OptionError,"UnbalancedParenthesis", "`%s'","(eof)");
      else if (cli_wand->image_info_stack != (CLIStack *) 
# 507 "MagickWand/magick-cli.c" 3 4
                                                         ((void *)0)
# 507 "MagickWand/magick-cli.c"
                                                             )
        (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 508,OptionError,"UnbalancedBraces", "`%s'","(eof)");
      break;
    case TokenStatusBadQuotes:

      if( strlen(token_info->token) > 64 -1 ) {
        token_info->token[64 -4] = '.';
        token_info->token[64 -3] = '.';
        token_info->token[64 -2] = '.';
        token_info->token[64 -1] = '\0';
      }
      (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 518,OptionFatalError,"ScriptUnbalancedQuotes", "`%s'",token_info->token)
                             ;
      break;
    case TokenStatusMemoryFailed:
      (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 522,OptionFatalError,"ScriptTokenMemoryFailed", "`%s'","");
      break;
    case TokenStatusBinary:
      (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 525,OptionFatalError,"ScriptIsBinary", "`%s'","");
      break;
  }
  (void) fflush(
# 528 "MagickWand/magick-cli.c" 3 4
               stdout
# 528 "MagickWand/magick-cli.c"
                     );
  (void) fflush(
# 529 "MagickWand/magick-cli.c" 3 4
               stderr
# 529 "MagickWand/magick-cli.c"
                     );
  if (cli_wand->wand.debug != MagickFalse)
    (void) LogMagickEvent(CommandEvent,"MagickWand/magick-cli.c",__func__,(unsigned long) 531,
         "Script End \"%s\"", filename);


  token_info = DestroyScriptTokenInfo(token_info);

  CloneString(&option,(char *) 
# 537 "MagickWand/magick-cli.c" 3 4
                              ((void *)0)
# 537 "MagickWand/magick-cli.c"
                                  );
  CloneString(&arg1,(char *) 
# 538 "MagickWand/magick-cli.c" 3 4
                            ((void *)0)
# 538 "MagickWand/magick-cli.c"
                                );
  CloneString(&arg2,(char *) 
# 539 "MagickWand/magick-cli.c" 3 4
                            ((void *)0)
# 539 "MagickWand/magick-cli.c"
                                );

  return;
}
# 587 "MagickWand/magick-cli.c"
__attribute__ ((visibility ("default"))) int ProcessCommandOptions(MagickCLI *cli_wand,int argc,char **argv,
  int index)
{
  const char
    *option,
...
# 603 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 603 "MagickWand/magick-cli.c"
 argc>=index
# 603 "MagickWand/magick-cli.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 603 "MagickWand/magick-cli.c"
...
# 603 "MagickWand/magick-cli.c"
 "argc>=index"
# 603 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 603, __extension__ __PRETTY_FUNCTION__); }))
# 603 "MagickWand/magick-cli.c"
                    ;
  
# 604 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 604 "MagickWand/magick-cli.c"
 argv != (char **) 
# 604 "MagickWand/magick-cli.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 604 "MagickWand/magick-cli.c"
...
# 604 "MagickWand/magick-cli.c"
 "argv != (char **) NULL"
# 604 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 604, __extension__ __PRETTY_FUNCTION__); }))
# 604 "MagickWand/magick-cli.c"
                               ;
  
# 605 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 605 "MagickWand/magick-cli.c"
 argv[index] != (char *) 
# 605 "MagickWand/magick-cli.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 605 "MagickWand/magick-cli.c"
...
# 605 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 605, __extension__ __PRETTY_FUNCTION__); }))
# 605 "MagickWand/magick-cli.c"
                                     ;
  
# 606 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 606 "MagickWand/magick-cli.c"
 argv[argc-1] != (char *) 
# 606 "MagickWand/magick-cli.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 606 "MagickWand/magick-cli.c"
...
# 606 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 606, __extension__ __PRETTY_FUNCTION__); }))
# 606 "MagickWand/magick-cli.c"
                                      ;
  
# 607 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 607 "MagickWand/magick-cli.c"
 cli_wand != (MagickCLI *) 
# 607 "MagickWand/magick-cli.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 607 "MagickWand/magick-cli.c"
...
# 607 "MagickWand/magick-cli.c"
 "cli_wand != (MagickCLI *) NULL"
# 607 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 607, __extension__ __PRETTY_FUNCTION__); }))
# 607 "MagickWand/magick-cli.c"
                                       ;
  
# 608 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 608 "MagickWand/magick-cli.c"
 cli_wand->signature == 0xabacadabUL
# 608 "MagickWand/magick-cli.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 608 "MagickWand/magick-cli.c"
...
# 608 "MagickWand/magick-cli.c"
 "cli_wand->signature == MagickWandSignature"
# 608 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 608, __extension__ __PRETTY_FUNCTION__); }))
# 608 "MagickWand/magick-cli.c"
                                                   ;
  ...
  cli_wand->line=(size_t) index;

  if (cli_wand->wand.debug != MagickFalse)
    (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/magick-cli.c",__func__,(unsigned long) 617,
      ...
      if ( option_type == UndefinedOptionFlag ||
        ...
        if (IsCommandOption(option) == MagickFalse) {
          if ( (cli_wand->process_flags & ProcessImplicitRead) != 0 ) {
            ...
            cli_wand->command=(const OptionInfo *) 
# 652 "MagickWand/magick-cli.c" 3 4
                                                  ((void *)0)
# 652 "MagickWand/magick-cli.c"
                                                      ;
            CLIOption(cli_wand,"-read",option);
            break;
          }
        }
        (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 657,OptionFatalError,"UnrecognizedOption", "`%s'",option);
        break;
      }
      ...
      if ( ((option_type & SpecialOptionFlag) != 0 ) &&
        ...
        if ( (i+count) >= argc )
          (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 669,OptionFatalError,"MissingArgument", "`%s'",option);
      ...
      if ((i+count) >= end ) {
        (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 676,OptionFatalError,"MissingArgument", "`%s'",option);
        if ( CLICatchException(cli_wand, MagickFalse) != MagickFalse )
          return(end);
        break;
      }

      arg1 = ( count >= 1 ) ? argv[i+1] : (char *) 
# 682 "MagickWand/magick-cli.c" 3 4
                                                  ((void *)0)
# 682 "MagickWand/magick-cli.c"
                                                      ;
      arg2 = ( count >= 2 ) ? argv[i+2] : (char *) 
# 683 "MagickWand/magick-cli.c" 3 4
                                                  ((void *)0)
# 683 "MagickWand/magick-cli.c"
                                                      ;
# 694 "MagickWand/magick-cli.c"
      if ( (option_type & GenesisOptionFlag) != 0 )
        break;
...
# 719 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 719 "MagickWand/magick-cli.c"
 i==end
# 719 "MagickWand/magick-cli.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 719 "MagickWand/magick-cli.c"
...
# 719 "MagickWand/magick-cli.c"
 "i==end"
# 719 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 719, __extension__ __PRETTY_FUNCTION__); }))
# 719 "MagickWand/magick-cli.c"
               ;
...
# 724 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 724 "MagickWand/magick-cli.c"
 end==argc-1
# 724 "MagickWand/magick-cli.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 724 "MagickWand/magick-cli.c"
...
# 724 "MagickWand/magick-cli.c"
 "end==argc-1"
# 724 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 724, __extension__ __PRETTY_FUNCTION__); }))
# 724 "MagickWand/magick-cli.c"
                    ;
  ...
  if (cli_wand->image_list_stack != (CLIStack *) 
# 733 "MagickWand/magick-cli.c" 3 4
                                                ((void *)0)
# 733 "MagickWand/magick-cli.c"
                                                    )
    (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 734,OptionError,"UnbalancedParenthesis", "`%s'","(end of cli)");
  else if (cli_wand->image_info_stack != (CLIStack *) 
# 735 "MagickWand/magick-cli.c" 3 4
                                                     ((void *)0)
# 735 "MagickWand/magick-cli.c"
                                                         )
    (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 736,OptionError,"UnbalancedBraces", "`%s'","(end of cli)");
  if ( CLICatchException(cli_wand, MagickFalse) != MagickFalse )
    return(argc);
  ...
  if (IsCommandOption(option) != MagickFalse ||
      (option[0] == ' ' && option[1] == '\0') ) {
    (void) CLIThrowException(cli_wand,"MagickWand/magick-cli.c",__func__,(unsigned long) 753,OptionError,"MissingOutputFilename", "`%s'",option);
    return(argc);
  }

  cli_wand->command=(const OptionInfo *) 
# 757 "MagickWand/magick-cli.c" 3 4
                                        ((void *)0)
# 757 "MagickWand/magick-cli.c"
                                            ;
  CLIOption(cli_wand,"-write",option);
  return(argc);
}
# 801 "MagickWand/magick-cli.c"
static void MagickUsage(MagickBooleanType verbose)
{
  ...
  if (len>=7 && LocaleCompare("convert",name+len-7) == 0) {
    ...
    (void) FormatLocaleFile(
# 814 "MagickWand/magick-cli.c" 3 4
                           stdout
# 814 "MagickWand/magick-cli.c"
                                 ,
       "Usage: %s [ {option} | {image} ... ] {output_image}\n",name);
    (void) FormatLocaleFile(
# 816 "MagickWand/magick-cli.c" 3 4
                           stdout
# 816 "MagickWand/magick-cli.c"
                                 ,
    ...
    (void) FormatLocaleFile(
# 822 "MagickWand/magick-cli.c" 3 4
                           stdout
# 822 "MagickWand/magick-cli.c"
                                 ,
    ...
    (void) FormatLocaleFile(
# 827 "MagickWand/magick-cli.c" 3 4
                           stdout
# 827 "MagickWand/magick-cli.c"
                                 ,
       "Usage: %s tool [ {option} | {image} ... ] {output_image}\n",name);
    (void) FormatLocaleFile(
# 829 "MagickWand/magick-cli.c" 3 4
                           stdout
# 829 "MagickWand/magick-cli.c"
                                 ,
       "Usage: %s [ {option} | {image} ... ] {output_image}\n",name);
    (void) FormatLocaleFile(
# 831 "MagickWand/magick-cli.c" 3 4
                           stdout
# 831 "MagickWand/magick-cli.c"
                                 ,
       "       %s [ {option} | {image} ... ] -script {filename} [ {script_args} ...]\n",
       name);
  }
  (void) FormatLocaleFile(
# 835 "MagickWand/magick-cli.c" 3 4
                         stdout
# 835 "MagickWand/magick-cli.c"
                               ,
    "       %s -help | -version | -usage | -list {option}\n\n",name);
  ...
  (void) FormatLocaleFile(
# 841 "MagickWand/magick-cli.c" 3 4
                         stdout
# 841 "MagickWand/magick-cli.c"
...
# 889 "MagickWand/magick-cli.c" 3 4
   (*__errno_location ())
# 889 "MagickWand/magick-cli.c"
   ); (void) ThrowMagickException(exception,"MagickWand/magick-cli.c",__func__,(unsigned long) 889,ResourceLimitError,"MemoryAllocationFailed", "'%s': %s",GetExceptionMessage(
# 889 "MagickWand/magick-cli.c" 3 4
   (*__errno_location ())
# 889 "MagickWand/magick-cli.c"
   ),file_message); file_message=DestroyString(file_message); }
                                 ;
  output=fopen_utf8(argv[argc-1],"wb");
  if (output == (FILE *) 
# 892 "MagickWand/magick-cli.c" 3 4
                        ((void *)0)
# 892 "MagickWand/magick-cli.c"
                            )
    {
      { char *file_message; file_message=GetExceptionMessage(
# 894 "MagickWand/magick-cli.c" 3 4
     (*__errno_location ())
# 894 "MagickWand/magick-cli.c"
     ); (void) ThrowMagickException(exception,"MagickWand/magick-cli.c",__func__,(unsigned long) 894,FileOpenError,"UnableToOpenFile", "'%s': %s",argv[argc-1],file_message); file_message=DestroyString(file_message); }
                     ;
      return(MagickFalse);
    }
  status=MagickTrue;
  for (i=2; i < (ssize_t) (argc-1); i++)
  {
    ...
    if (input == (FILE *) 
# 902 "MagickWand/magick-cli.c" 3 4
                         ((void *)0)
# 902 "MagickWand/magick-cli.c"
                             )
      {
        { char *file_message; file_message=GetExceptionMessage(
# 904 "MagickWand/magick-cli.c" 3 4
       (*__errno_location ())
# 904 "MagickWand/magick-cli.c"
       ); (void) ThrowMagickException(exception,"MagickWand/magick-cli.c",__func__,(unsigned long) 904,FileOpenError,"UnableToOpenFile", "'%s': %s",argv[i],file_message); file_message=DestroyString(file_message); };
        continue;
      }
    for (c=fgetc(input); c != 
# 907 "MagickWand/magick-cli.c" 3 4
                             (-1)
# 907 "MagickWand/magick-cli.c"
                                ; c=fgetc(input))
...
__attribute__ ((visibility ("default"))) MagickBooleanType MagickImageCommand(ImageInfo *image_info,int argc,
...
# 926 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 926 "MagickWand/magick-cli.c"
...
# 926 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 926, __extension__ __PRETTY_FUNCTION__); }))
# 926 "MagickWand/magick-cli.c"
                                         ;
  ...
  if (cli_wand->wand.debug != MagickFalse)
    (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/magick-cli.c",__func__,(unsigned long) 938,
         "\"%s\"",argv[0]);


  GetPathComponent(argv[0],TailPath,cli_wand->wand.name);
  SetClientName(cli_wand->wand.name);
  ConcatenateMagickString(cli_wand->wand.name,"-CLI",4096);
  ...
  if (len>=7 && LocaleCompare("convert",argv[0]+len-7) == 0) {
    ...
    (void) FormatLocaleFile(
# 951 "MagickWand/magick-cli.c" 3 4
                           stderr
# 951 "MagickWand/magick-cli.c"
                                 ,"WARNING: %s\n",
  ...
  if (argc == 2) {
    ...
    if ((LocaleCompare("-help",argv[1]) == 0) ||
      ...
      if (cli_wand->wand.debug != MagickFalse)
        (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/magick-cli.c",__func__,(unsigned long) 974,
    ...
    if (LocaleCompare("-usage",argv[1]) == 0) {
      if (cli_wand->wand.debug != MagickFalse)
        (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/magick-cli.c",__func__,(unsigned long) 981,
            "- Special Option \"%s\"", argv[1]);
      CLIOption(cli_wand, "-version" );
  ...
  if (argc < 3) {
    (void) ThrowMagickException(exception,"MagickWand/magick-cli.c",__func__,(unsigned long) 991,OptionError,
  ...
  if (LocaleCompare("-concatenate",argv[1]) == 0) {
    if (cli_wand->wand.debug != MagickFalse)
        (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/magick-cli.c",__func__,(unsigned long) 1000,
            "- Special Option \"%s\"", argv[1]);
...
Magick_Command_Cleanup:
  ...
  cli_wand->filename=argv[0];
  if (cli_wand->wand.debug != MagickFalse)
    (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/magick-cli.c",__func__,(unsigned long) 1033,
         "\"%s\"",argv[0]);



  while ((cli_wand->image_list_stack != (CLIStack *) 
# 1038 "MagickWand/magick-cli.c" 3 4
                                                    ((void *)0)
# 1038 "MagickWand/magick-cli.c"
                                                        ) &&
         (cli_wand->image_list_stack->next != (CLIStack *) 
# 1039 "MagickWand/magick-cli.c" 3 4
                                                          ((void *)0)
# 1039 "MagickWand/magick-cli.c"
                                                              ))
    CLIOption(cli_wand,")");
  while ((cli_wand->image_info_stack != (CLIStack *) 
# 1041 "MagickWand/magick-cli.c" 3 4
                                                    ((void *)0)
# 1041 "MagickWand/magick-cli.c"
                                                        ) &&
         (cli_wand->image_info_stack->next != (CLIStack *) 
# 1042 "MagickWand/magick-cli.c" 3 4
                                                          ((void *)0)
# 1042 "MagickWand/magick-cli.c"
                                                              ))
    CLIOption(cli_wand,"}");


  
# 1046 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 1046 "MagickWand/magick-cli.c"
...
# 1046 "MagickWand/magick-cli.c"
 "cli_wand->wand.image_info == image_info"
# 1046 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 1046, __extension__ __PRETTY_FUNCTION__); }))
# 1046 "MagickWand/magick-cli.c"
                                                ;
  
# 1047 "MagickWand/magick-cli.c" 3 4
 ((void) sizeof ((
# 1047 "MagickWand/magick-cli.c"
...
# 1047 "MagickWand/magick-cli.c"
 "cli_wand->wand.exception == exception"
# 1047 "MagickWand/magick-cli.c" 3 4
 , "MagickWand/magick-cli.c", 1047, __extension__ __PRETTY_FUNCTION__); }))
# 1047 "MagickWand/magick-cli.c"
                                              ;


  if ((cli_wand->wand.images != (Image *) 
# 1050 "MagickWand/magick-cli.c" 3 4
                                         ((void *)0)
# 1050 "MagickWand/magick-cli.c"
                                             ) &&
      (metadata != (char **) 
# 1051 "MagickWand/magick-cli.c" 3 4
                            ((void *)0)
# 1051 "MagickWand/magick-cli.c"
                                ))
    {
      const char
        *format;
      ...
      text=InterpretImageProperties(image_info,cli_wand->wand.images,format,
        exception);
      if (text == (char *) 
# 1062 "MagickWand/magick-cli.c" 3 4
                          ((void *)0)
# 1062 "MagickWand/magick-cli.c"
                              )
        ThrowMagickException(exception,"MagickWand/magick-cli.c",__func__,(unsigned long) 1063,ResourceLimitError,
          "MemoryAllocationFailed","`%s'", GetExceptionMessage(
# 1064 "MagickWand/magick-cli.c" 3 4
                                                              (*__errno_location ())
# 1064 "MagickWand/magick-cli.c"
                                                                   ));
      else
        {
          (void) ConcatenateString(&(*metadata),text);
...
Magick_Command_Exit:
  ...
  cli_wand->filename=argv[0];
  if (cli_wand->wand.debug != MagickFalse)
    (void) CLILogEvent(cli_wand,CommandEvent,"MagickWand/magick-cli.c",__func__,(unsigned long) 1076,
         "\"%s\"",argv[0]);


  cli_wand->wand.image_info = (ImageInfo *) 
# 1080 "MagickWand/magick-cli.c" 3 4
                                           ((void *)0)
# 1080 "MagickWand/magick-cli.c"
                                               ;
  cli_wand->wand.exception = (ExceptionInfo *) 
# 1081 "MagickWand/magick-cli.c" 3 4
                                              ((void *)0)
# 1081 "MagickWand/magick-cli.c"
                                                  ;
