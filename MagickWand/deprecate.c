# 0 "MagickWand/deprecate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/deprecate.c"
# 43 "MagickWand/deprecate.c"
...
# 49 "MagickWand/deprecate.c" 2
# 77 "MagickWand/deprecate.c"
__attribute__ ((visibility ("default"))) MagickBooleanType MagickGetImageAlphaColor(MagickWand *wand,
  PixelWand *alpha_color)
{
  
# 80 "MagickWand/deprecate.c" 3 4
 ((void) sizeof ((
# 80 "MagickWand/deprecate.c"
 wand != (MagickWand *)
# 80 "MagickWand/deprecate.c" 3 4
...
# 80 "MagickWand/deprecate.c" 3 4
 , "MagickWand/deprecate.c", 80, __extension__ __PRETTY_FUNCTION__); }))
# 80 "MagickWand/deprecate.c"
                                   ;
  
# 81 "MagickWand/deprecate.c" 3 4
 ((void) sizeof ((
# 81 "MagickWand/deprecate.c"
...
# 81 "MagickWand/deprecate.c" 3 4
 , "MagickWand/deprecate.c", 81, __extension__ __PRETTY_FUNCTION__); }))
# 81 "MagickWand/deprecate.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/deprecate.c",__func__,(unsigned long) 83,"%s",wand->name);
  if (wand->images == (Image *)
# 84 "MagickWand/deprecate.c" 3 4
                              ((void *)0)
# 84 "MagickWand/deprecate.c"
                                  )
    { (void) ThrowMagickException(wand->exception,"MagickWand/deprecate.c",__func__,(unsigned long) 85,WandError, "ContainsNoImages","`%s'",wand->name); return(MagickFalse); };
  PixelSetPixelColor(alpha_color,&wand->images->matte_color);
  return(MagickTrue);
}
# 115 "MagickWand/deprecate.c"
__attribute__ ((visibility ("default"))) MagickBooleanType MagickSetImageAlphaColor(MagickWand *wand,
  const PixelWand *alpha)
{
  
# 118 "MagickWand/deprecate.c" 3 4
 ((void) sizeof ((
# 118 "MagickWand/deprecate.c"
 wand != (MagickWand *)
# 118 "MagickWand/deprecate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 118 "MagickWand/deprecate.c"
...
# 118 "MagickWand/deprecate.c"
 "wand != (MagickWand *)NULL"
# 118 "MagickWand/deprecate.c" 3 4
 , "MagickWand/deprecate.c", 118, __extension__ __PRETTY_FUNCTION__); }))
# 118 "MagickWand/deprecate.c"
                                   ;
  
# 119 "MagickWand/deprecate.c" 3 4
 ((void) sizeof ((
# 119 "MagickWand/deprecate.c"
 wand->signature == 0xabacadabUL
# 119 "MagickWand/deprecate.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 119 "MagickWand/deprecate.c"
...
# 119 "MagickWand/deprecate.c"
 "wand->signature == MagickWandSignature"
# 119 "MagickWand/deprecate.c" 3 4
 , "MagickWand/deprecate.c", 119, __extension__ __PRETTY_FUNCTION__); }))
# 119 "MagickWand/deprecate.c"
                                               ;
  if (wand->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/deprecate.c",__func__,(unsigned long) 121,"%s",wand->name);
  if (wand->images == (Image *)
# 122 "MagickWand/deprecate.c" 3 4
                              ((void *)0)
# 122 "MagickWand/deprecate.c"
                                  )
    { (void) ThrowMagickException(wand->exception,"MagickWand/deprecate.c",__func__,(unsigned long) 123,WandError, "ContainsNoImages","`%s'",wand->name); return(MagickFalse); };
