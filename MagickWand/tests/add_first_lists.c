# 0 "MagickWand/tests/add_first_lists.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/tests/add_first_lists.c"
...
# 2 "MagickWand/tests/add_first_lists.c" 2
...
# 3 "MagickWand/tests/add_first_lists.c" 2
...
{ char
  *description;
  ...
  (void) fprintf(
# 16 "MagickWand/tests/add_first_lists.c" 3 4
                stderr
# 16 "MagickWand/tests/add_first_lists.c"
                      ,"%s %s %lu %s\n","MagickWand/tests/add_first_lists.c",__func__,(unsigned long) 16,description);
