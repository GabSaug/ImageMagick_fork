# 0 "MagickWand/tests/loop_over_lists.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/tests/loop_over_lists.c"
...
# 2 "MagickWand/tests/loop_over_lists.c" 2
...
# 3 "MagickWand/tests/loop_over_lists.c" 2
# 11 "MagickWand/tests/loop_over_lists.c"
...
{ char
  *description;
  ...
  (void) fprintf(
# 19 "MagickWand/tests/loop_over_lists.c" 3 4
                stderr
# 19 "MagickWand/tests/loop_over_lists.c"
                      ,"%s %s %lu %s\n","MagickWand/tests/loop_over_lists.c",__func__,(unsigned long) 19,description);
