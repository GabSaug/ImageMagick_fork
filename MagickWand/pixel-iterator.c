# 0 "MagickWand/pixel-iterator.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickWand/pixel-iterator.c"
# 49 "MagickWand/pixel-iterator.c"
...
# 50 "MagickWand/pixel-iterator.c" 2
...
# 52 "MagickWand/pixel-iterator.c" 2
...
# 55 "MagickWand/pixel-iterator.c" 2
# 64 "MagickWand/pixel-iterator.c"
...
# 119 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) void ClearPixelIterator(PixelIterator *iterator)
{
  
# 121 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 121 "MagickWand/pixel-iterator.c"
...
# 121 "MagickWand/pixel-iterator.c"
 "iterator != (const PixelIterator *) NULL"
# 121 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 121, __extension__ __PRETTY_FUNCTION__); }))
# 121 "MagickWand/pixel-iterator.c"
                                                 ;
  
# 122 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 122 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 122 "MagickWand/pixel-iterator.c" 3 4
...
# 122 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 122, __extension__ __PRETTY_FUNCTION__); }))
# 122 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 124,"%s",iterator->name);
...
# 156 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) PixelIterator *ClonePixelIterator(const PixelIterator *iterator)
{
  PixelIterator
    *clone_iterator;

  
# 161 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 161 "MagickWand/pixel-iterator.c"
...
# 161 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 161 "MagickWand/pixel-iterator.c"
 "iterator != (PixelIterator *) NULL"
# 161 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 161, __extension__ __PRETTY_FUNCTION__); }))
# 161 "MagickWand/pixel-iterator.c"
                                           ;
  
# 162 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 162 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 162 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 162 "MagickWand/pixel-iterator.c"
...
# 162 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 162 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 162, __extension__ __PRETTY_FUNCTION__); }))
# 162 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 164,"%s",iterator->name);
  ...
  (void) FormatLocaleString(clone_iterator->name,4096,"%s-%.20g",
    "PixelIterator",(double) clone_iterator->id);
  ...
  if (clone_iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 181,"%s",
      clone_iterator->name);
  clone_iterator->signature=0xabacadabUL;
  return(clone_iterator);
}
# 209 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) PixelIterator *DestroyPixelIterator(PixelIterator *iterator)
{
  
# 211 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 211 "MagickWand/pixel-iterator.c"
 iterator != (const PixelIterator *) 
# 211 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 211 "MagickWand/pixel-iterator.c"
...
# 211 "MagickWand/pixel-iterator.c"
 "iterator != (const PixelIterator *) NULL"
# 211 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 211, __extension__ __PRETTY_FUNCTION__); }))
# 211 "MagickWand/pixel-iterator.c"
                                                 ;
  
# 212 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 212 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 212 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 212 "MagickWand/pixel-iterator.c"
...
# 212 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 212 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 212, __extension__ __PRETTY_FUNCTION__); }))
# 212 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 214,"%s",iterator->name);
...
# 248 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsPixelIterator(const PixelIterator *iterator)
{
  size_t
    length;

  if (iterator == (const PixelIterator *) 
# 253 "MagickWand/pixel-iterator.c" 3 4
                                         ((void *)0)
# 253 "MagickWand/pixel-iterator.c"
                                             )
    return(MagickFalse);
  if (iterator->signature != 0xabacadabUL)
    return(MagickFalse);
  length=strlen("PixelIterator");
  if (LocaleNCompare(iterator->name,"PixelIterator",length) != 0)
    return(MagickFalse);
  return(MagickTrue);
}
# 285 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) PixelIterator *NewPixelIterator(MagickWand *wand)
{
  ExceptionInfo
    *exception;
...
# 299 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 299 "MagickWand/pixel-iterator.c"
 wand != (MagickWand *) 
# 299 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 299 "MagickWand/pixel-iterator.c"
...
# 299 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 299, __extension__ __PRETTY_FUNCTION__); }))
# 299 "MagickWand/pixel-iterator.c"
                                    ;
  image=GetImageFromMagickWand(wand);
  if (image == (Image *) 
# 301 "MagickWand/pixel-iterator.c" 3 4
                        ((void *)0)
# 301 "MagickWand/pixel-iterator.c"
                            )
    return((PixelIterator *) 
# 302 "MagickWand/pixel-iterator.c" 3 4
                            ((void *)0)
# 302 "MagickWand/pixel-iterator.c"
                                );
  exception=AcquireExceptionInfo();
  view=AcquireVirtualCacheView(image,exception);
  if (view == (CacheView *) 
# 305 "MagickWand/pixel-iterator.c" 3 4
                           ((void *)0)
# 305 "MagickWand/pixel-iterator.c"
                               )
    return((PixelIterator *) 
# 306 "MagickWand/pixel-iterator.c" 3 4
                            ((void *)0)
# 306 "MagickWand/pixel-iterator.c"
                                );
  ...
  (void) FormatLocaleString(iterator->name,4096,"%s-%.20g",
    "PixelIterator",(double) iterator->id);
  ...
  iterator->debug=IsEventLogging();
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 323,"%s",iterator->name);
  iterator->signature=0xabacadabUL;
  return(iterator);
}
# 351 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) MagickBooleanType PixelClearIteratorException(
  PixelIterator *iterator)
{
  
# 354 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 354 "MagickWand/pixel-iterator.c"
 iterator != (PixelIterator *) 
# 354 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 354 "MagickWand/pixel-iterator.c"
...
# 354 "MagickWand/pixel-iterator.c"
 "iterator != (PixelIterator *) NULL"
# 354 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 354, __extension__ __PRETTY_FUNCTION__); }))
# 354 "MagickWand/pixel-iterator.c"
                                           ;
  
# 355 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 355 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 355 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 355 "MagickWand/pixel-iterator.c"
...
# 355 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 355 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 355, __extension__ __PRETTY_FUNCTION__); }))
# 355 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 357,"%s",iterator->name);
  ClearMagickException(iterator->exception);
  return(MagickTrue);
}
# 388 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) PixelIterator *NewPixelRegionIterator(MagickWand *wand,
...
# 403 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 403 "MagickWand/pixel-iterator.c"
 wand != (MagickWand *) 
# 403 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 403 "MagickWand/pixel-iterator.c"
...
# 403 "MagickWand/pixel-iterator.c"
 "wand != (MagickWand *) NULL"
# 403 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 403, __extension__ __PRETTY_FUNCTION__); }))
# 403 "MagickWand/pixel-iterator.c"
                                    ;
  if ((width == 0) || (height == 0))
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 405,WandError,"ZeroRegionSize", "`%s'",wand->name); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (WandError-FatalErrorException)+1); };
  image=GetImageFromMagickWand(wand);
  if (image == (Image *) 
# 407 "MagickWand/pixel-iterator.c" 3 4
                        ((void *)0)
# 407 "MagickWand/pixel-iterator.c"
                            )
    return((PixelIterator *) 
# 408 "MagickWand/pixel-iterator.c" 3 4
                            ((void *)0)
# 408 "MagickWand/pixel-iterator.c"
                                );
  exception=AcquireExceptionInfo();
  view=AcquireVirtualCacheView(image,exception);
  if (view == (CacheView *) 
# 411 "MagickWand/pixel-iterator.c" 3 4
                           ((void *)0)
# 411 "MagickWand/pixel-iterator.c"
                               )
    return((PixelIterator *) 
# 412 "MagickWand/pixel-iterator.c" 3 4
                            ((void *)0)
# 412 "MagickWand/pixel-iterator.c"
                                );
  iterator=(PixelIterator *) AcquireCriticalMemory(sizeof(*iterator));
  (void) memset(iterator,0,sizeof(*iterator));
  iterator->id=AcquireWandId();
  ...
  iterator->debug=IsEventLogging();
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 429,"%s",iterator->name);
  iterator->signature=0xabacadabUL;
  return(iterator);
}
# 460 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) PixelWand **PixelGetCurrentIteratorRow(PixelIterator *iterator,
  size_t *number_wands)
{
  const Quantum
    *pixels;
...
# 469 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 469 "MagickWand/pixel-iterator.c"
 iterator != (PixelIterator *) 
# 469 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 469 "MagickWand/pixel-iterator.c"
...
# 469 "MagickWand/pixel-iterator.c"
 "iterator != (PixelIterator *) NULL"
# 469 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 469, __extension__ __PRETTY_FUNCTION__); }))
# 469 "MagickWand/pixel-iterator.c"
                                           ;
  
# 470 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 470 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 470 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 470 "MagickWand/pixel-iterator.c"
...
# 470 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 470 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 470, __extension__ __PRETTY_FUNCTION__); }))
# 470 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 472,"%s",iterator->name);
  *number_wands=0;
  ...
  pixels=GetCacheViewVirtualPixels(iterator->view,iterator->region.x,
    ...
    iterator->exception);
  if (pixels == (const Quantum *) 
# 478 "MagickWand/pixel-iterator.c" 3 4
                                 ((void *)0)
# 478 "MagickWand/pixel-iterator.c"
                                     )
    return((PixelWand **) 
# 479 "MagickWand/pixel-iterator.c" 3 4
                         ((void *)0)
# 479 "MagickWand/pixel-iterator.c"
                             );
...
# 516 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) char *PixelGetIteratorException(const PixelIterator *iterator,
...
# 522 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 522 "MagickWand/pixel-iterator.c"
 iterator != (const PixelIterator *) 
# 522 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 522 "MagickWand/pixel-iterator.c"
...
# 522 "MagickWand/pixel-iterator.c"
 "iterator != (const PixelIterator *) NULL"
# 522 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 522, __extension__ __PRETTY_FUNCTION__); }))
# 522 "MagickWand/pixel-iterator.c"
                                                 ;
  
# 523 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 523 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 523 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 523 "MagickWand/pixel-iterator.c"
...
# 523 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 523 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 523, __extension__ __PRETTY_FUNCTION__); }))
# 523 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 525,"%s",iterator->name);
  
# 526 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 526 "MagickWand/pixel-iterator.c"
...
# 526 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 526, __extension__ __PRETTY_FUNCTION__); }))
# 526 "MagickWand/pixel-iterator.c"
                                           ;
  *severity=iterator->exception->severity;
  description=(char *) AcquireQuantumMemory(2UL*4096,
    sizeof(*description));
  if (description == (char *) 
# 530 "MagickWand/pixel-iterator.c" 3 4
                             ((void *)0)
# 530 "MagickWand/pixel-iterator.c"
                                 )
    { ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); (void) ThrowMagickException(fatal_exception,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 531,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",iterator->name); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickWandTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                     ;
  *description='\0';
  if (iterator->exception->reason != (char *) 
# 534 "MagickWand/pixel-iterator.c" 3 4
                                             ((void *)0)
# 534 "MagickWand/pixel-iterator.c"
                                                 )
    (void) CopyMagickString(description,GetLocaleExceptionMessage(
      iterator->exception->severity,iterator->exception->reason),
      4096);
  if (iterator->exception->description != (char *) 
# 538 "MagickWand/pixel-iterator.c" 3 4
                                                  ((void *)0)
# 538 "MagickWand/pixel-iterator.c"
                                                      )
    {
...
# 573 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) ExceptionType PixelGetIteratorExceptionType(
  const PixelIterator *iterator)
{
  
# 576 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 576 "MagickWand/pixel-iterator.c"
 iterator != (const PixelIterator *) 
# 576 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 576 "MagickWand/pixel-iterator.c"
...
# 576 "MagickWand/pixel-iterator.c"
 "iterator != (const PixelIterator *) NULL"
# 576 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 576, __extension__ __PRETTY_FUNCTION__); }))
# 576 "MagickWand/pixel-iterator.c"
                                                 ;
  
# 577 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 577 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 577 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 577 "MagickWand/pixel-iterator.c"
...
# 577 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 577 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 577, __extension__ __PRETTY_FUNCTION__); }))
# 577 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 579,"%s",iterator->name);
  return(iterator->exception->severity);
}
# 605 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) ssize_t PixelGetIteratorRow(PixelIterator *iterator)
{
  
# 607 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 607 "MagickWand/pixel-iterator.c"
 iterator != (const PixelIterator *) 
# 607 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 607 "MagickWand/pixel-iterator.c"
...
# 607 "MagickWand/pixel-iterator.c"
 "iterator != (const PixelIterator *) NULL"
# 607 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 607, __extension__ __PRETTY_FUNCTION__); }))
# 607 "MagickWand/pixel-iterator.c"
                                                 ;
  
# 608 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 608 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 608 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 608 "MagickWand/pixel-iterator.c"
...
# 608 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 608 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 608, __extension__ __PRETTY_FUNCTION__); }))
# 608 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 610,"%s",iterator->name);
  return(iterator->y);
}
# 640 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) PixelWand **PixelGetNextIteratorRow(PixelIterator *iterator,
  size_t *number_wands)
{
  const Quantum
    *pixels;
...
# 649 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 649 "MagickWand/pixel-iterator.c"
 iterator != (PixelIterator *) 
# 649 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 649 "MagickWand/pixel-iterator.c"
...
# 649 "MagickWand/pixel-iterator.c"
 "iterator != (PixelIterator *) NULL"
# 649 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 649, __extension__ __PRETTY_FUNCTION__); }))
# 649 "MagickWand/pixel-iterator.c"
                                           ;
  
# 650 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 650 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 650 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 650 "MagickWand/pixel-iterator.c"
...
# 650 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 650 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 650, __extension__ __PRETTY_FUNCTION__); }))
# 650 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 652,"%s",iterator->name);
  *number_wands=0;
  if (iterator->active != MagickFalse)
    iterator->y++;
  if (PixelSetIteratorRow(iterator,iterator->y) == MagickFalse)
    return((PixelWand **) 
# 657 "MagickWand/pixel-iterator.c" 3 4
                         ((void *)0)
# 657 "MagickWand/pixel-iterator.c"
                             );
  pixels=GetCacheViewVirtualPixels(iterator->view,iterator->region.x,
    iterator->region.y+iterator->y,iterator->region.width,1,
    iterator->exception);
  if (pixels == (const Quantum *) 
# 661 "MagickWand/pixel-iterator.c" 3 4
                                 ((void *)0)
# 661 "MagickWand/pixel-iterator.c"
                                     )
    return((PixelWand **) 
# 662 "MagickWand/pixel-iterator.c" 3 4
                         ((void *)0)
# 662 "MagickWand/pixel-iterator.c"
                             );
  for (x=0; x < (ssize_t) iterator->region.width; x++)
  {
    PixelSetQuantumPixel(GetCacheViewImage(iterator->view),pixels,
...
# 699 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) PixelWand **PixelGetPreviousIteratorRow(PixelIterator *iterator,
  size_t *number_wands)
{
  const Quantum
    *pixels;
...
# 708 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 708 "MagickWand/pixel-iterator.c"
 iterator != (PixelIterator *) 
# 708 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 708 "MagickWand/pixel-iterator.c"
...
# 708 "MagickWand/pixel-iterator.c"
 "iterator != (PixelIterator *) NULL"
# 708 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 708, __extension__ __PRETTY_FUNCTION__); }))
# 708 "MagickWand/pixel-iterator.c"
                                           ;
  
# 709 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 709 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 709 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 709 "MagickWand/pixel-iterator.c"
...
# 709 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 709 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 709, __extension__ __PRETTY_FUNCTION__); }))
# 709 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 711,"%s",iterator->name);
  *number_wands=0;
  if (iterator->active != MagickFalse)
    iterator->y--;
  if (PixelSetIteratorRow(iterator,iterator->y) == MagickFalse)
    return((PixelWand **) 
# 716 "MagickWand/pixel-iterator.c" 3 4
                         ((void *)0)
# 716 "MagickWand/pixel-iterator.c"
                             );
  pixels=GetCacheViewVirtualPixels(iterator->view,iterator->region.x,
    iterator->region.y+iterator->y,iterator->region.width,1,
    iterator->exception);
  if (pixels == (const Quantum *) 
# 720 "MagickWand/pixel-iterator.c" 3 4
                                 ((void *)0)
# 720 "MagickWand/pixel-iterator.c"
                                     )
    return((PixelWand **) 
# 721 "MagickWand/pixel-iterator.c" 3 4
                         ((void *)0)
# 721 "MagickWand/pixel-iterator.c"
                             );
  for (x=0; x < (ssize_t) iterator->region.width; x++)
  {
    PixelSetQuantumPixel(GetCacheViewImage(iterator->view),pixels,
...
# 756 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) void PixelResetIterator(PixelIterator *iterator)
{
  
# 758 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 758 "MagickWand/pixel-iterator.c"
 iterator != (PixelIterator *) 
# 758 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 758 "MagickWand/pixel-iterator.c"
...
# 758 "MagickWand/pixel-iterator.c"
 "iterator != (PixelIterator *) NULL"
# 758 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 758, __extension__ __PRETTY_FUNCTION__); }))
# 758 "MagickWand/pixel-iterator.c"
                                           ;
  
# 759 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 759 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 759 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 759 "MagickWand/pixel-iterator.c"
...
# 759 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 759 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 759, __extension__ __PRETTY_FUNCTION__); }))
# 759 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 761,"%s",iterator->name);
  iterator->active=MagickFalse;
  iterator->y=0;
}
# 788 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) void PixelSetFirstIteratorRow(PixelIterator *iterator)
{
  
# 790 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 790 "MagickWand/pixel-iterator.c"
 iterator != (PixelIterator *) 
# 790 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 790 "MagickWand/pixel-iterator.c"
...
# 790 "MagickWand/pixel-iterator.c"
 "iterator != (PixelIterator *) NULL"
# 790 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 790, __extension__ __PRETTY_FUNCTION__); }))
# 790 "MagickWand/pixel-iterator.c"
                                           ;
  
# 791 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 791 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 791 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 791 "MagickWand/pixel-iterator.c"
...
# 791 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 791 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 791, __extension__ __PRETTY_FUNCTION__); }))
# 791 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 793,"%s",iterator->name);
  iterator->active=MagickFalse;
  iterator->y=iterator->region.y;
}
# 821 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) MagickBooleanType PixelSetIteratorRow(PixelIterator *iterator,
  const ssize_t row)
{
  
# 824 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 824 "MagickWand/pixel-iterator.c"
 iterator != (const PixelIterator *) 
# 824 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 824 "MagickWand/pixel-iterator.c"
...
# 824 "MagickWand/pixel-iterator.c"
 "iterator != (const PixelIterator *) NULL"
# 824 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 824, __extension__ __PRETTY_FUNCTION__); }))
# 824 "MagickWand/pixel-iterator.c"
                                                 ;
  
# 825 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 825 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 825 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 825 "MagickWand/pixel-iterator.c"
...
# 825 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 825 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 825, __extension__ __PRETTY_FUNCTION__); }))
# 825 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 827,"%s",iterator->name);
...
# 857 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) void PixelSetLastIteratorRow(PixelIterator *iterator)
{
  
# 859 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 859 "MagickWand/pixel-iterator.c"
 iterator != (PixelIterator *) 
# 859 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 859 "MagickWand/pixel-iterator.c"
...
# 859 "MagickWand/pixel-iterator.c"
 "iterator != (PixelIterator *) NULL"
# 859 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 859, __extension__ __PRETTY_FUNCTION__); }))
# 859 "MagickWand/pixel-iterator.c"
                                           ;
  
# 860 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 860 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 860 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 860 "MagickWand/pixel-iterator.c"
...
# 860 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 860 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 860, __extension__ __PRETTY_FUNCTION__); }))
# 860 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 862,"%s",iterator->name);
  iterator->active=MagickFalse;
  iterator->y=(ssize_t) iterator->region.height-1;
}
# 889 "MagickWand/pixel-iterator.c"
__attribute__ ((visibility ("default"))) MagickBooleanType PixelSyncIterator(PixelIterator *iterator)
{
  MagickBooleanType
    status;
...
# 900 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 900 "MagickWand/pixel-iterator.c"
 iterator != (const PixelIterator *) 
# 900 "MagickWand/pixel-iterator.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 900 "MagickWand/pixel-iterator.c"
...
# 900 "MagickWand/pixel-iterator.c"
 "iterator != (const PixelIterator *) NULL"
# 900 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 900, __extension__ __PRETTY_FUNCTION__); }))
# 900 "MagickWand/pixel-iterator.c"
                                                 ;
  
# 901 "MagickWand/pixel-iterator.c" 3 4
 ((void) sizeof ((
# 901 "MagickWand/pixel-iterator.c"
 iterator->signature == 0xabacadabUL
# 901 "MagickWand/pixel-iterator.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 901 "MagickWand/pixel-iterator.c"
...
# 901 "MagickWand/pixel-iterator.c"
 "iterator->signature == MagickWandSignature"
# 901 "MagickWand/pixel-iterator.c" 3 4
 , "MagickWand/pixel-iterator.c", 901, __extension__ __PRETTY_FUNCTION__); }))
# 901 "MagickWand/pixel-iterator.c"
                                                   ;
  if (iterator->debug != MagickFalse)
    (void) LogMagickEvent(WandEvent,"MagickWand/pixel-iterator.c",__func__,(unsigned long) 903,"%s",iterator->name);
  ...
  pixels=GetCacheViewAuthenticPixels(iterator->view,iterator->region.x,
    ...
    iterator->exception);
  if (pixels == (Quantum *) 
# 911 "MagickWand/pixel-iterator.c" 3 4
                           ((void *)0)
# 911 "MagickWand/pixel-iterator.c"
                               )
    return(MagickFalse);
  for (x=0; x < (ssize_t) iterator->region.width; x++)
  {
