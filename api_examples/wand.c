# 0 "api_examples/wand.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "api_examples/wand.c"
# 22 "api_examples/wand.c"
...
{ char
  *description;
  ...
  (void) fprintf(
# 37 "api_examples/wand.c" 3 4
                stderr
# 37 "api_examples/wand.c"
                      ,"%s %s %lu %s\n","api_examples/wand.c",__func__,(unsigned long) 37,description);
