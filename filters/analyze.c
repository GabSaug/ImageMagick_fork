...
# 47 "filters/analyze.c" 2
# 82 "filters/analyze.c"
...
# 118 "filters/analyze.c"
__attribute__ ((visibility ("default"))) size_t analyzeImage(Image **images,const int argc,
...
# 135 "filters/analyze.c" 3 4
 ((void) sizeof ((
# 135 "filters/analyze.c"
 images != (Image **) 
# 135 "filters/analyze.c" 3 4
...
# 135 "filters/analyze.c"
 "images != (Image **) NULL"
# 135 "filters/analyze.c" 3 4
 , "filters/analyze.c", 135, __extension__ __PRETTY_FUNCTION__); }))
# 135 "filters/analyze.c"
                                  ;
  
# 136 "filters/analyze.c" 3 4
 ((void) sizeof ((
# 136 "filters/analyze.c"
 *images != (Image *) 
# 136 "filters/analyze.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 136 "filters/analyze.c"
...
# 136 "filters/analyze.c"
 "*images != (Image *) NULL"
# 136 "filters/analyze.c" 3 4
 , "filters/analyze.c", 136, __extension__ __PRETTY_FUNCTION__); }))
# 136 "filters/analyze.c"
                                  ;
  
# 137 "filters/analyze.c" 3 4
 ((void) sizeof ((
# 137 "filters/analyze.c"
...
# 137 "filters/analyze.c" 3 4
 , "filters/analyze.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "filters/analyze.c"
                                                    ;
  (void) argc;
  (void) argv;
  ...
  progress=0;
  for ( ; image != (Image *) 
# 143 "filters/analyze.c" 3 4
                            ((void *)0)
# 143 "filters/analyze.c"
                                ; image=GetNextImageInList(image))
  {
    ...
    for (y=0; y < (ssize_t) image->rows; y++)
    {
      ...
      if (p == (const Quantum *) 
# 185 "filters/analyze.c" 3 4
                                ((void *)0)
# 185 "filters/analyze.c"
                                    )
        {
          status=MagickFalse;
          continue;
      ...
      for (x=0; x < (ssize_t) image->columns; x++)
      {
        ...
        b*=(double) ((Quantum) 65535.0);
        for (i=1; i <= 4; i++)
          local_brightness.sum[i]+=pow(b,(double) i);
        s*=(double) ((Quantum) 65535.0);
        for (i=1; i <= 4; i++)
    ...
    (void) FormatLocaleString(text,4096,"%g",brightness.mean);
    ...
    (void) SetImageProperty(image,"filter:brightness:standard-deviation",text,
      exception);
    if (fabs(brightness.standard_deviation) >= 1.0e-12)
    ...
    (void) FormatLocaleString(text,4096,"%g",brightness.kurtosis);
    ...
    if (brightness.standard_deviation != 0)
      brightness.skewness=(brightness.sum[3]/area-3.0*brightness.mean*
        ...
        brightness.standard_deviation*brightness.standard_deviation);
    (void) FormatLocaleString(text,4096,"%g",brightness.skewness);
    (void) SetImageProperty(image,"filter:brightness:skewness",text,exception);
    saturation.mean=saturation.sum[1]/area;
    (void) FormatLocaleString(text,4096,"%g",saturation.mean);
    ...
    (void) SetImageProperty(image,"filter:saturation:standard-deviation",text,
      exception);
    if (fabs(saturation.standard_deviation) >= 1.0e-12)
    ...
    (void) FormatLocaleString(text,4096,"%g",saturation.kurtosis);
...
# 270 "filters/analyze.c"
                                                              )
      {
        ...
        progress++;
        proceed=SetImageProgress(image,"Filter/Analyze",progress,
