...
# 135 "coders/vid.c" 3 4
 , "coders/vid.c", 135, __extension__ __PRETTY_FUNCTION__); }))
# 135 "coders/vid.c"
                                               ;
  
# 136 "coders/vid.c" 3 4
 ((void) sizeof ((
# 136 "coders/vid.c"
...
# 136 "coders/vid.c" 3 4
 , "coders/vid.c", 136, __extension__ __PRETTY_FUNCTION__); }))
# 136 "coders/vid.c"
                                                     ;
  
# 137 "coders/vid.c" 3 4
 ((void) sizeof ((
# 137 "coders/vid.c"
...
# 137 "coders/vid.c" 3 4
 , "coders/vid.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "coders/vid.c"
                                            ;
  
# 138 "coders/vid.c" 3 4
 ((void) sizeof ((
# 138 "coders/vid.c"
...
# 138 "coders/vid.c" 3 4
 , "coders/vid.c", 138, __extension__ __PRETTY_FUNCTION__); }))
# 138 "coders/vid.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/vid.c",__func__,(unsigned long) 140,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  list=(char **) AcquireMagickMemory(sizeof(*filelist));
  if (list == (char **) 
# 144 "coders/vid.c" 3 4
                       ((void *)0)
# 144 "coders/vid.c"
                           )
    { (void) ThrowMagickException(exception,"coders/vid.c",__func__,(unsigned long) 145,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 145 "coders/vid.c" 3 4
   ((void *)0)
# 145 "coders/vid.c"
...
# 145 "coders/vid.c"
  ...
  if ((status == MagickFalse) || (number_files == 0))
    { (void) ThrowMagickException(exception,"coders/vid.c",__func__,(unsigned long) 153,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 153 "coders/vid.c" 3 4
   ((void *)0)
# 153 "coders/vid.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 153 "coders/vid.c" 3 4
...
# 160 "coders/vid.c" 3 4
                                     ((void *)0)
# 160 "coders/vid.c"
                                         ,0);
  (void) SetImageInfoProgressMonitor(read_info,(MagickProgressMonitor) 
# 161 "coders/vid.c" 3 4
                                                                      ((void *)0)
# 161 "coders/vid.c"
                                                                          ,
    (void *) 
# 162 "coders/vid.c" 3 4
            ((void *)0)
# 162 "coders/vid.c"
                );
  if (read_info->size == (char *) 
# 163 "coders/vid.c" 3 4
                                 ((void *)0)
# 163 "coders/vid.c"
                                     )
  ...
  for (i=0; i < (ssize_t) number_files; i++)
  {
    ...
    if (IsEventLogging() != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/vid.c",__func__,(unsigned long) 171,"name: %s",
        filelist[i]);
...
# 186 "coders/vid.c"
    ...
    if (IsEventLogging() != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/vid.c",__func__,(unsigned long) 192,
...
# 200 "coders/vid.c"
    ...
    if (IsEventLogging() != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/vid.c",__func__,(unsigned long) 206,
        "thumbnail geometry: %.20gx%.20g",(double) next_image->columns,(double)
        next_image->rows);
    AppendImageToList(&images,next_image);
    status=SetImageProgress(images,"Load/Images",i,(MagickSizeType)
      number_files);
  ...
  if (images == (Image *) 
# 219 "coders/vid.c" 3 4
                         ((void *)0)
# 219 "coders/vid.c"
                             )
    { (void) ThrowMagickException(exception,"coders/vid.c",__func__,(unsigned long) 220,CorruptImageError,"ImageFileDoesNotContainAnyImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 220 "coders/vid.c" 3 4
   ((void *)0)
# 220 "coders/vid.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 220 "coders/vid.c" 3 4
...
# 225 "coders/vid.c" 3 4
                                                          ((void *)0)
# 225 "coders/vid.c"
                                                              );
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/vid.c",__func__,(unsigned long) 227,"creating montage");
...
# 258 "coders/vid.c"
__attribute__ ((visibility ("default"))) size_t RegisterVIDImage(void)
{
  MagickInfo
    *entry;
...
# 290 "coders/vid.c"
__attribute__ ((visibility ("default"))) void UnregisterVIDImage(void)
{
  ...
  ExceptionInfo *exception)
{
  ...
  for (p=image; p != (Image *) 
# 346 "coders/vid.c" 3 4
                              ((void *)0)
# 346 "coders/vid.c"
                                  ; p=GetNextImageInList(p))
    (void) SetImageProperty(p,"label","%f\n%G\n%b",exception);
  montage_info=CloneMontageInfo(image_info,(MontageInfo *) 
# 348 "coders/vid.c" 3 4
                                                          ((void *)0)
# 348 "coders/vid.c"
                                                              );
...
# 359 "coders/vid.c" 3 4
                                         ((void *)0)
# 359 "coders/vid.c"
                                             ) ||
      (LocaleCompare(magick_info->module,"VID") == 0))
    (void) FormatLocaleString(montage_image->filename,4096,
