...
# 188 "coders/qoi.c" 3 4
 , "coders/qoi.c", 188, __extension__ __PRETTY_FUNCTION__); }))
# 188 "coders/qoi.c"
                                               ;
  
# 189 "coders/qoi.c" 3 4
 ((void) sizeof ((
# 189 "coders/qoi.c"
...
# 189 "coders/qoi.c" 3 4
 , "coders/qoi.c", 189, __extension__ __PRETTY_FUNCTION__); }))
# 189 "coders/qoi.c"
                                                     ;
  
# 190 "coders/qoi.c" 3 4
 ((void) sizeof ((
# 190 "coders/qoi.c"
...
# 190 "coders/qoi.c" 3 4
 , "coders/qoi.c", 190, __extension__ __PRETTY_FUNCTION__); }))
# 190 "coders/qoi.c"
                                            ;
  
# 191 "coders/qoi.c" 3 4
 ((void) sizeof ((
# 191 "coders/qoi.c"
...
# 191 "coders/qoi.c" 3 4
 , "coders/qoi.c", 191, __extension__ __PRETTY_FUNCTION__); }))
# 191 "coders/qoi.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/qoi.c",__func__,(unsigned long) 193,"%s",
      image_info->filename);
...
# 200 "coders/qoi.c"
  ...
  if ((count != 4) || (LocaleNCompare((char *) magick, "qoif", 4) != 0))
    { (void) ThrowMagickException(exception,"coders/qoi.c",__func__,(unsigned long) 209,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 209 "coders/qoi.c" 3 4
   ((void *)0)
# 209 "coders/qoi.c"
...
# 209 "coders/qoi.c"
  ...
  if (image->columns == 0 || image->rows == 0)
    { (void) ThrowMagickException(exception,"coders/qoi.c",__func__,(unsigned long) 213,CorruptImageError,"NegativeOrZeroImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 213 "coders/qoi.c" 3 4
   ((void *)0)
# 213 "coders/qoi.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 213 "coders/qoi.c" 3 4
...
# 213 "coders/qoi.c"
  ...
  if (channels == 3)
    ...
    { (void) ThrowMagickException(exception,"coders/qoi.c",__func__,(unsigned long) 223,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 223 "coders/qoi.c" 3 4
   ((void *)0)
# 223 "coders/qoi.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 223 "coders/qoi.c" 3 4
...
# 223 "coders/qoi.c"
  ...
  if (colorspace == 0)
    ...
    { (void) ThrowMagickException(exception,"coders/qoi.c",__func__,(unsigned long) 230,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 230 "coders/qoi.c" 3 4
   ((void *)0)
# 230 "coders/qoi.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 230 "coders/qoi.c" 3 4
...
# 230 "coders/qoi.c"
  ...
  if (q == (Quantum *) 
# 243 "coders/qoi.c" 3 4
                      ((void *)0)
# 243 "coders/qoi.c"
                          )
    { (void) ThrowMagickException(exception,"coders/qoi.c",__func__,(unsigned long) 244,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 244 "coders/qoi.c" 3 4
   ((void *)0)
# 244 "coders/qoi.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 244 "coders/qoi.c" 3 4
...
# 244 "coders/qoi.c"
  ...
  for (i=0; i < (ssize_t) (image->rows * image->columns);)
  {
    ...
    if ((b=ReadBlobByte(image)) == 
# 260 "coders/qoi.c" 3 4
                                  (-1)
# 260 "coders/qoi.c"
                                     )
      break;
...
# 302 "coders/qoi.c"
    ...
    lut[(px.rgba.r*3 + px.rgba.g*5 + px.rgba.b*7 + px.rgba.a*11) % 64]=px;
    do
    {
    ...
    status=SetImageProgress(image,"Load/Image",(MagickOffsetType) i,
  ...
  if (i < (ssize_t) (image->columns*image->rows))
    { (void) ThrowMagickException(exception,"coders/qoi.c",__func__,(unsigned long) 333,CorruptImageError,"NotEnoughPixelData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 333 "coders/qoi.c" 3 4
   ((void *)0)
# 333 "coders/qoi.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 333 "coders/qoi.c" 3 4
...
# 335 "coders/qoi.c" 3 4
   (*__errno_location ())
# 335 "coders/qoi.c"
   ); (void) ThrowMagickException(exception,"coders/qoi.c",__func__,(unsigned long) 335,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                            ;
...
# 367 "coders/qoi.c"
__attribute__ ((visibility ("default"))) size_t RegisterQOIImage(void)
{
  MagickInfo
    *entry;
...
# 400 "coders/qoi.c"
__attribute__ ((visibility ("default"))) void UnregisterQOIImage(void)
{
...
# 462 "coders/qoi.c"
 "image_info != (const ImageInfo *) NULL"
# 462 "coders/qoi.c" 3 4
 , "coders/qoi.c", 462, __extension__ __PRETTY_FUNCTION__); }))
# 462 "coders/qoi.c"
                                               ;
  
# 463 "coders/qoi.c" 3 4
 ((void) sizeof ((
# 463 "coders/qoi.c"
 image_info->signature == 0xabacadabUL
# 463 "coders/qoi.c" 3 4
...
# 463 "coders/qoi.c"
 "image_info->signature == MagickCoreSignature"
# 463 "coders/qoi.c" 3 4
 , "coders/qoi.c", 463, __extension__ __PRETTY_FUNCTION__); }))
# 463 "coders/qoi.c"
                                                     ;
  
# 464 "coders/qoi.c" 3 4
 ((void) sizeof ((
# 464 "coders/qoi.c"
 image != (Image *) 
# 464 "coders/qoi.c" 3 4
...
# 464 "coders/qoi.c"
 "image != (Image *) NULL"
# 464 "coders/qoi.c" 3 4
 , "coders/qoi.c", 464, __extension__ __PRETTY_FUNCTION__); }))
# 464 "coders/qoi.c"
                                ;
  
# 465 "coders/qoi.c" 3 4
 ((void) sizeof ((
# 465 "coders/qoi.c"
...
# 465 "coders/qoi.c" 3 4
 , "coders/qoi.c", 465, __extension__ __PRETTY_FUNCTION__); }))
# 465 "coders/qoi.c"
                                                ;
  
# 466 "coders/qoi.c" 3 4
 ((void) sizeof ((
# 466 "coders/qoi.c"
 exception != (ExceptionInfo *) 
# 466 "coders/qoi.c" 3 4
...
# 466 "coders/qoi.c"
 "exception != (ExceptionInfo *) NULL"
# 466 "coders/qoi.c" 3 4
 , "coders/qoi.c", 466, __extension__ __PRETTY_FUNCTION__); }))
# 466 "coders/qoi.c"
                                            ;
  
# 467 "coders/qoi.c" 3 4
 ((void) sizeof ((
# 467 "coders/qoi.c"
 exception->signature == 0xabacadabUL
# 467 "coders/qoi.c" 3 4
...
# 467 "coders/qoi.c"
 "exception->signature == MagickCoreSignature"
# 467 "coders/qoi.c" 3 4
 , "coders/qoi.c", 467, __extension__ __PRETTY_FUNCTION__); }))
# 467 "coders/qoi.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/qoi.c",__func__,(unsigned long) 469,"%s",image->filename);
  ...
  if ((quantum_type == RGBQuantum) || (quantum_type == GrayQuantum) ||
    ...
    if ((quantum_type == RGBAQuantum) || (quantum_type == GrayAlphaQuantum) ||
      ...
      { (void) ThrowMagickException(exception,"coders/qoi.c",__func__,(unsigned long) 490,CoderError,"ImageTypeNotSupported", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 490 "coders/qoi.c" 3 4
     ((void *)0)
# 490 "coders/qoi.c"
  ...
  if (p == (const Quantum *) 
# 509 "coders/qoi.c" 3 4
                            ((void *)0)
# 509 "coders/qoi.c"
                                )
    { (void) ThrowMagickException(exception,"coders/qoi.c",__func__,(unsigned long) 510,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 510 "coders/qoi.c" 3 4
   ((void *)0)
# 510 "coders/qoi.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  ...
  for (i=0; i < (ssize_t) end; i++) {
    ...
    if (pp.v == px.v)
      {
        ...
        if (run == 62)
          {
            (void) WriteBlobByte(image,0xc0 | (unsigned char) (run - 1));
            run=0;
          }
        continue;
      }
    ...
    idx=(px.rgba.r*3 + px.rgba.g*5 + px.rgba.b*7 + px.rgba.a*11) % 64;
    if (lut[idx].v == px.v)
      {
        (void) WriteBlobByte(image,0x00 | (unsigned char) idx);
        continue;
      }
    lut[(px.rgba.r*3 + px.rgba.g*5 + px.rgba.b*7 + px.rgba.a*11) % 64]=px;
    if (pp.rgba.a == px.rgba.a)
      {
        ...
        if ((vr > -3) && (vr < 2) && (vg > -3) && (vg < 2) &&
            (vb > -3) && (vb < 2))
          {
            ...
            (void) WriteBlobByte(image,0x40 | diff);
          }
        else if ((vg_r > -9) && (vg_r < 8) && (vg > -33) && (vg < 32) &&
                 (vg_b > -9) && (vg_b < 8))
          {
            luma=(unsigned char) (vg + 32);
            (void) WriteBlobByte(image,0x80 | luma);
