...
# 92 "coders/kernel.c"
__attribute__ ((visibility ("default"))) size_t RegisterKERNELImage(void)
{
  MagickInfo
    *entry;
...
# 123 "coders/kernel.c"
__attribute__ ((visibility ("default"))) void UnregisterKERNELImage(void)
{
...
# 170 "coders/kernel.c" 3 4
 , "coders/kernel.c", 170, __extension__ __PRETTY_FUNCTION__); }))
# 170 "coders/kernel.c"
                                               ;
  
# 171 "coders/kernel.c" 3 4
 ((void) sizeof ((
# 171 "coders/kernel.c"
...
# 171 "coders/kernel.c" 3 4
 , "coders/kernel.c", 171, __extension__ __PRETTY_FUNCTION__); }))
# 171 "coders/kernel.c"
                                                     ;
  
# 172 "coders/kernel.c" 3 4
 ((void) sizeof ((
# 172 "coders/kernel.c"
 image != (Image *) 
# 172 "coders/kernel.c" 3 4
...
# 172 "coders/kernel.c"
 "image != (Image *) NULL"
# 172 "coders/kernel.c" 3 4
 , "coders/kernel.c", 172, __extension__ __PRETTY_FUNCTION__); }))
# 172 "coders/kernel.c"
                                ;
  
# 173 "coders/kernel.c" 3 4
 ((void) sizeof ((
# 173 "coders/kernel.c"
...
# 173 "coders/kernel.c" 3 4
 , "coders/kernel.c", 173, __extension__ __PRETTY_FUNCTION__); }))
# 173 "coders/kernel.c"
                                                ;
  
# 174 "coders/kernel.c" 3 4
 ((void) sizeof ((
# 174 "coders/kernel.c"
...
# 174 "coders/kernel.c" 3 4
 , "coders/kernel.c", 174, __extension__ __PRETTY_FUNCTION__); }))
# 174 "coders/kernel.c"
                                            ;
  
# 175 "coders/kernel.c" 3 4
 ((void) sizeof ((
# 175 "coders/kernel.c"
...
# 175 "coders/kernel.c" 3 4
 , "coders/kernel.c", 175, __extension__ __PRETTY_FUNCTION__); }))
# 175 "coders/kernel.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/kernel.c",__func__,(unsigned long) 177,"%s",image->filename);
  ...
  (void) FormatLocaleString(buffer,4096,"%gx%g:",(double)
...
# 201 "coders/kernel.c"
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      if (((image->alpha_trait != BlendPixelTrait) != 0) &&
          (GetPixelAlpha(image,p) < ((Quantum) ((Quantum) 65535.0))/2))
        (void) WriteBlobString(image,"-");
      else
        {
          (void) FormatLocaleString(buffer,4096,"%.*g",
            GetMagickPrecision(),((double) 1.0/(double) ((Quantum) 65535.0))*GetPixelIntensity(image,p));
          (void) WriteBlobString(image,buffer);
        }
      p+=GetPixelChannels(image);
    }
    if (image->previous == (Image *) 
# 218 "coders/kernel.c" 3 4
                                    ((void *)0)
# 218 "coders/kernel.c"
                                        )
      {
