...
# 137 "coders/rgb.c" 3 4
 , "coders/rgb.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "coders/rgb.c"
                                               ;
  
# 138 "coders/rgb.c" 3 4
 ((void) sizeof ((
# 138 "coders/rgb.c"
...
# 138 "coders/rgb.c" 3 4
 , "coders/rgb.c", 138, __extension__ __PRETTY_FUNCTION__); }))
# 138 "coders/rgb.c"
                                                     ;
  
# 139 "coders/rgb.c" 3 4
 ((void) sizeof ((
# 139 "coders/rgb.c"
...
# 139 "coders/rgb.c" 3 4
 , "coders/rgb.c", 139, __extension__ __PRETTY_FUNCTION__); }))
# 139 "coders/rgb.c"
                                            ;
  
# 140 "coders/rgb.c" 3 4
 ((void) sizeof ((
# 140 "coders/rgb.c"
...
# 140 "coders/rgb.c" 3 4
 , "coders/rgb.c", 140, __extension__ __PRETTY_FUNCTION__); }))
# 140 "coders/rgb.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/rgb.c",__func__,(unsigned long) 142,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 146,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 146 "coders/rgb.c" 3 4
   ((void *)0)
# 146 "coders/rgb.c"
...
# 159 "coders/rgb.c" 3 4
       (*__errno_location ())
# 159 "coders/rgb.c"
       ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 159,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
    }
...
# 167 "coders/rgb.c" 3 4
                               ((void *)0)
# 167 "coders/rgb.c"
                                   )
    { (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 168,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 168 "coders/rgb.c" 3 4
   ((void *)0)
# 168 "coders/rgb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 168 "coders/rgb.c" 3 4
...
# 183 "coders/rgb.c" 3 4
                                     ((void *)0)
# 183 "coders/rgb.c"
                                         )
    {
      canvas_image=DestroyImage(canvas_image);
      { (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 186,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 186 "coders/rgb.c" 3 4
     ((void *)0)
# 186 "coders/rgb.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 186 "coders/rgb.c" 3 4
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 248 "coders/rgb.c" 3 4
             (*__errno_location ())
# 248 "coders/rgb.c"
             ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 248,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 254 "coders/rgb.c" 3 4
                              ((void *)0)
# 254 "coders/rgb.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 256 "coders/rgb.c" 3 4
                                                               ((void *)0)
# 256 "coders/rgb.c"
                                                                   ,
            ...
            if (count != (ssize_t) length)
              {
                status=MagickFalse;
                { char *file_message; file_message=GetExceptionMessage(
# 331 "coders/rgb.c" 3 4
               (*__errno_location ())
# 331 "coders/rgb.c"
               ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 331,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                        ;
                break;
              }
            ...
            q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
              exception);
            if (q == (Quantum *) 
# 338 "coders/rgb.c" 3 4
                                ((void *)0)
# 338 "coders/rgb.c"
                                    )
              break;
            length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 340 "coders/rgb.c" 3 4
                                                                 ((void *)0)
# 340 "coders/rgb.c"
                                                                     ,
              quantum_info,quantum_type,(unsigned char *) stream,exception);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 427 "coders/rgb.c" 3 4
             (*__errno_location ())
# 427 "coders/rgb.c"
             ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 427,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 433 "coders/rgb.c" 3 4
                              ((void *)0)
# 433 "coders/rgb.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 435 "coders/rgb.c" 3 4
                                                               ((void *)0)
# 435 "coders/rgb.c"
                                                                   ,
...
# 446 "coders/rgb.c"
        ...
        if (image->previous == (Image *) 
# 459 "coders/rgb.c" 3 4
                                        ((void *)0)
# 459 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Load/Image",1,6);
            if (status == MagickFalse)
              break;
          }
        for (y=0; y < (ssize_t) image->extract_info.height; y++)
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 479 "coders/rgb.c" 3 4
             (*__errno_location ())
# 479 "coders/rgb.c"
             ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 479,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 485 "coders/rgb.c" 3 4
                              ((void *)0)
# 485 "coders/rgb.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 487 "coders/rgb.c" 3 4
                                                               ((void *)0)
# 487 "coders/rgb.c"
                                                                   ,
...
# 498 "coders/rgb.c"
        ...
        if (image->previous == (Image *) 
# 511 "coders/rgb.c" 3 4
                                        ((void *)0)
# 511 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Load/Image",2,6);
            if (status == MagickFalse)
              break;
          }
        for (y=0; y < (ssize_t) image->extract_info.height; y++)
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 531 "coders/rgb.c" 3 4
             (*__errno_location ())
# 531 "coders/rgb.c"
             ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 531,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 537 "coders/rgb.c" 3 4
                              ((void *)0)
# 537 "coders/rgb.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 539 "coders/rgb.c" 3 4
                                                               ((void *)0)
# 539 "coders/rgb.c"
                                                                   ,
...
# 550 "coders/rgb.c"
        ...
        if (image->previous == (Image *) 
# 563 "coders/rgb.c" 3 4
                                        ((void *)0)
# 563 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Load/Image",4,6);
            if (status == MagickFalse)
              break;
          }
        if (image->alpha_trait != UndefinedPixelTrait)
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 585 "coders/rgb.c" 3 4
                 (*__errno_location ())
# 585 "coders/rgb.c"
                 ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 585,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
              q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
                exception);
              if (q == (Quantum *) 
# 591 "coders/rgb.c" 3 4
                                  ((void *)0)
# 591 "coders/rgb.c"
                                      )
                break;
              length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 593 "coders/rgb.c" 3 4
                                                                   ((void *)0)
# 593 "coders/rgb.c"
                                                                       ,
...
# 604 "coders/rgb.c"
            ...
            if (image->previous == (Image *) 
# 617 "coders/rgb.c" 3 4
                                            ((void *)0)
# 617 "coders/rgb.c"
                                                )
              {
                status=SetImageProgress(image,"Load/Image",5,6);
                if (status == MagickFalse)
                  break;
              }
          }
        if (image->previous == (Image *) 
# 624 "coders/rgb.c" 3 4
                                        ((void *)0)
# 624 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Load/Image",6,6);
            if (status == MagickFalse)
              break;
          }
        break;
        ...
        if (DiscardBlobBytes(image,(MagickSizeType) image->offset) == MagickFalse)
          {
            status=MagickFalse;
            { char *file_message; file_message=GetExceptionMessage(
# 644 "coders/rgb.c" 3 4
           (*__errno_location ())
# 644 "coders/rgb.c"
           ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 644,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                    ;
            break;
          }
        length=GetQuantumExtent(canvas_image,quantum_info,RedQuantum);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 675 "coders/rgb.c" 3 4
             (*__errno_location ())
# 675 "coders/rgb.c"
             ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 675,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 681 "coders/rgb.c" 3 4
                              ((void *)0)
# 681 "coders/rgb.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 683 "coders/rgb.c" 3 4
                                                               ((void *)0)
# 683 "coders/rgb.c"
                                                                   ,
            quantum_info,RedQuantum,(unsigned char *) stream,exception);
...
# 694 "coders/rgb.c"
        ...
        if (image->previous == (Image *) 
# 707 "coders/rgb.c" 3 4
                                        ((void *)0)
# 707 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Load/Image",1,5);
            if (status == MagickFalse)
              break;
          }
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 746 "coders/rgb.c" 3 4
             (*__errno_location ())
# 746 "coders/rgb.c"
             ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 746,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 752 "coders/rgb.c" 3 4
                              ((void *)0)
# 752 "coders/rgb.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 754 "coders/rgb.c" 3 4
                                                               ((void *)0)
# 754 "coders/rgb.c"
                                                                   ,
            quantum_info,GreenQuantum,(unsigned char *) stream,exception);
...
# 765 "coders/rgb.c"
        ...
        if (image->previous == (Image *) 
# 778 "coders/rgb.c" 3 4
                                        ((void *)0)
# 778 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Load/Image",2,5);
            if (status == MagickFalse)
              break;
          }
        if (CloseBlob(image) == MagickFalse)
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 817 "coders/rgb.c" 3 4
             (*__errno_location ())
# 817 "coders/rgb.c"
             ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 817,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 823 "coders/rgb.c" 3 4
                              ((void *)0)
# 823 "coders/rgb.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 825 "coders/rgb.c" 3 4
                                                               ((void *)0)
# 825 "coders/rgb.c"
                                                                   ,
            quantum_info,BlueQuantum,(unsigned char *) stream,exception);
...
# 836 "coders/rgb.c"
        ...
        if (image->previous == (Image *) 
# 849 "coders/rgb.c" 3 4
                                        ((void *)0)
# 849 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Load/Image",3,5);
            if (status == MagickFalse)
              break;
          }
        if (image->alpha_trait != UndefinedPixelTrait)
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 890 "coders/rgb.c" 3 4
                 (*__errno_location ())
# 890 "coders/rgb.c"
                 ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 890,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
              q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
                exception);
              if (q == (Quantum *) 
# 896 "coders/rgb.c" 3 4
                                  ((void *)0)
# 896 "coders/rgb.c"
                                      )
                break;
              length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 898 "coders/rgb.c" 3 4
                                                                   ((void *)0)
# 898 "coders/rgb.c"
                                                                       ,
                quantum_info,BlueQuantum,(unsigned char *) stream,exception);
...
# 909 "coders/rgb.c"
            ...
            if (image->previous == (Image *) 
# 922 "coders/rgb.c" 3 4
                                            ((void *)0)
# 922 "coders/rgb.c"
                                                )
              {
                status=SetImageProgress(image,"Load/Image",4,5);
                if (status == MagickFalse)
                  break;
              }
          }
        if (image->previous == (Image *) 
# 929 "coders/rgb.c" 3 4
                                        ((void *)0)
# 929 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Load/Image",5,5);
            if (status == MagickFalse)
              break;
          }
        break;
...
# 1037 "coders/rgb.c"
 "image_info != (const ImageInfo *) NULL"
# 1037 "coders/rgb.c" 3 4
 , "coders/rgb.c", 1037, __extension__ __PRETTY_FUNCTION__); }))
# 1037 "coders/rgb.c"
                                               ;
  
# 1038 "coders/rgb.c" 3 4
 ((void) sizeof ((
# 1038 "coders/rgb.c"
 image_info->signature == 0xabacadabUL
# 1038 "coders/rgb.c" 3 4
...
# 1038 "coders/rgb.c"
 "image_info->signature == MagickCoreSignature"
# 1038 "coders/rgb.c" 3 4
 , "coders/rgb.c", 1038, __extension__ __PRETTY_FUNCTION__); }))
# 1038 "coders/rgb.c"
                                                     ;
  
# 1039 "coders/rgb.c" 3 4
 ((void) sizeof ((
# 1039 "coders/rgb.c"
 exception != (ExceptionInfo *) 
# 1039 "coders/rgb.c" 3 4
...
# 1039 "coders/rgb.c"
 "exception != (ExceptionInfo *) NULL"
# 1039 "coders/rgb.c" 3 4
 , "coders/rgb.c", 1039, __extension__ __PRETTY_FUNCTION__); }))
# 1039 "coders/rgb.c"
                                            ;
  
# 1040 "coders/rgb.c" 3 4
 ((void) sizeof ((
# 1040 "coders/rgb.c"
 exception->signature == 0xabacadabUL
# 1040 "coders/rgb.c" 3 4
...
# 1040 "coders/rgb.c"
 "exception->signature == MagickCoreSignature"
# 1040 "coders/rgb.c" 3 4
 , "coders/rgb.c", 1040, __extension__ __PRETTY_FUNCTION__); }))
# 1040 "coders/rgb.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/rgb.c",__func__,(unsigned long) 1042,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 1046,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1046 "coders/rgb.c" 3 4
   ((void *)0)
# 1046 "coders/rgb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1046 "coders/rgb.c" 3 4
...
# 1054 "coders/rgb.c"
      ...
      if (DiscardBlobBytes(image,(MagickSizeType) image->offset) == MagickFalse)
        { char *file_message; file_message=GetExceptionMessage(
# 1057 "coders/rgb.c" 3 4
       (*__errno_location ())
# 1057 "coders/rgb.c"
       ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 1057,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
    }
  ...
  canvas_image=CloneImage(image,image->extract_info.width,1,MagickFalse,
    exception);
  if(canvas_image == (Image *) 
# 1065 "coders/rgb.c" 3 4
                              ((void *)0)
# 1065 "coders/rgb.c"
                                  )
    { (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 1066,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1066 "coders/rgb.c" 3 4
   ((void *)0)
# 1066 "coders/rgb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1066 "coders/rgb.c" 3 4
...
# 1066 "coders/rgb.c"
  ...
  quantum_info=AcquireQuantumInfo(image_info,canvas_image);
  if (quantum_info == (QuantumInfo *) 
# 1070 "coders/rgb.c" 3 4
                                     ((void *)0)
# 1070 "coders/rgb.c"
                                         )
    {
      canvas_image=DestroyImage(canvas_image);
      { (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 1073,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1073 "coders/rgb.c" 3 4
     ((void *)0)
# 1073 "coders/rgb.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1073 "coders/rgb.c" 3 4
      ...
      if (count != (ssize_t) length)
        {
          status=MagickFalse;
          { char *file_message; file_message=GetExceptionMessage(
# 1130 "coders/rgb.c" 3 4
         (*__errno_location ())
# 1130 "coders/rgb.c"
         ); (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 1130,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                  ;
          break;
        }
      q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,exception);
      if (q == (Quantum *) 
# 1135 "coders/rgb.c" 3 4
                          ((void *)0)
# 1135 "coders/rgb.c"
                              )
        break;
      length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 1137 "coders/rgb.c" 3 4
                                                           ((void *)0)
# 1137 "coders/rgb.c"
                                                               ,
        quantum_info,quantum_type,(unsigned char *) stream,exception);
...
# 1235 "coders/rgb.c"
__attribute__ ((visibility ("default"))) size_t RegisterRGBImage(void)
{
  MagickInfo
    *entry;
...
# 1289 "coders/rgb.c"
__attribute__ ((visibility ("default"))) void UnregisterRGBImage(void)
{
...
# 1353 "coders/rgb.c"
 "image_info != (const ImageInfo *) NULL"
# 1353 "coders/rgb.c" 3 4
 , "coders/rgb.c", 1353, __extension__ __PRETTY_FUNCTION__); }))
# 1353 "coders/rgb.c"
                                               ;
  
# 1354 "coders/rgb.c" 3 4
 ((void) sizeof ((
# 1354 "coders/rgb.c"
 image_info->signature == 0xabacadabUL
# 1354 "coders/rgb.c" 3 4
...
# 1354 "coders/rgb.c"
 "image_info->signature == MagickCoreSignature"
# 1354 "coders/rgb.c" 3 4
 , "coders/rgb.c", 1354, __extension__ __PRETTY_FUNCTION__); }))
# 1354 "coders/rgb.c"
                                                     ;
  
# 1355 "coders/rgb.c" 3 4
 ((void) sizeof ((
# 1355 "coders/rgb.c"
 image != (Image *) 
# 1355 "coders/rgb.c" 3 4
...
# 1355 "coders/rgb.c"
 "image != (Image *) NULL"
# 1355 "coders/rgb.c" 3 4
 , "coders/rgb.c", 1355, __extension__ __PRETTY_FUNCTION__); }))
# 1355 "coders/rgb.c"
                                ;
  
# 1356 "coders/rgb.c" 3 4
 ((void) sizeof ((
# 1356 "coders/rgb.c"
...
# 1356 "coders/rgb.c" 3 4
 , "coders/rgb.c", 1356, __extension__ __PRETTY_FUNCTION__); }))
# 1356 "coders/rgb.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/rgb.c",__func__,(unsigned long) 1358,"%s",image->filename);
  if (image_info->interlace != PartitionInterlace)
    {
  ...
  do
  {
    ...
    if (quantum_info == (QuantumInfo *) 
# 1386 "coders/rgb.c" 3 4
                                       ((void *)0)
# 1386 "coders/rgb.c"
                                           )
      { (void) ThrowMagickException(exception,"coders/rgb.c",__func__,(unsigned long) 1387,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1387 "coders/rgb.c" 3 4
     ((void *)0)
# 1387 "coders/rgb.c"
    ...
    switch (image_info->interlace)
    {
      ...
      default:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          if (p == (const Quantum *) 
# 1403 "coders/rgb.c" 3 4
                                    ((void *)0)
# 1403 "coders/rgb.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1405 "coders/rgb.c" 3 4
                                                        ((void *)0)
# 1405 "coders/rgb.c"
                                                            ,quantum_info,
...
# 1410 "coders/rgb.c"
      ...
      case LineInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1431 "coders/rgb.c" 3 4
                                    ((void *)0)
# 1431 "coders/rgb.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1433 "coders/rgb.c" 3 4
                                                        ((void *)0)
# 1433 "coders/rgb.c"
                                                            ,quantum_info,
...
# 1464 "coders/rgb.c"
      ...
      case PlaneInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1485 "coders/rgb.c" 3 4
                                    ((void *)0)
# 1485 "coders/rgb.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1487 "coders/rgb.c" 3 4
                                                        ((void *)0)
# 1487 "coders/rgb.c"
                                                            ,quantum_info,
            RedQuantum,pixels,exception);
        ...
        if (image->previous == (Image *) 
# 1493 "coders/rgb.c" 3 4
                                        ((void *)0)
# 1493 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",1,6);
            if (status == MagickFalse)
              break;
          }
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1505 "coders/rgb.c" 3 4
                                    ((void *)0)
# 1505 "coders/rgb.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1507 "coders/rgb.c" 3 4
                                                        ((void *)0)
# 1507 "coders/rgb.c"
                                                            ,quantum_info,
            GreenQuantum,pixels,exception);
        ...
        if (image->previous == (Image *) 
# 1513 "coders/rgb.c" 3 4
                                        ((void *)0)
# 1513 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",2,6);
            if (status == MagickFalse)
              break;
          }
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1525 "coders/rgb.c" 3 4
                                    ((void *)0)
# 1525 "coders/rgb.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1527 "coders/rgb.c" 3 4
                                                        ((void *)0)
# 1527 "coders/rgb.c"
                                                            ,quantum_info,
            BlueQuantum,pixels,exception);
        ...
        if (image->previous == (Image *) 
# 1533 "coders/rgb.c" 3 4
                                        ((void *)0)
# 1533 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",3,6);
            if (status == MagickFalse)
              break;
          }
        if (quantum_type == RGBAQuantum)
          {
            for (y=0; y < (ssize_t) image->rows; y++)
            {
              ...
              p=GetVirtualPixels(image,0,y,image->columns,1,exception);
              if (p == (const Quantum *) 
# 1547 "coders/rgb.c" 3 4
                                        ((void *)0)
# 1547 "coders/rgb.c"
                                            )
                break;
              length=ExportQuantumPixels(image,(CacheView *) 
# 1549 "coders/rgb.c" 3 4
                                                            ((void *)0)
# 1549 "coders/rgb.c"
                                                                ,quantum_info,
                AlphaQuantum,pixels,exception);
            ...
            if (image->previous == (Image *) 
# 1555 "coders/rgb.c" 3 4
                                            ((void *)0)
# 1555 "coders/rgb.c"
                                                )
              {
                status=SetImageProgress(image,"Save/Image",5,6);
                if (status == MagickFalse)
                  break;
              }
          }
        if (image_info->interlace == PartitionInterlace)
          (void) CopyMagickString(image->filename,image_info->filename,
            4096);
        if (image->previous == (Image *) 
# 1565 "coders/rgb.c" 3 4
                                        ((void *)0)
# 1565 "coders/rgb.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",6,6);
            if (status == MagickFalse)
              break;
          }
        break;
      ...
      case PartitionInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1589 "coders/rgb.c" 3 4
                                    ((void *)0)
# 1589 "coders/rgb.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1591 "coders/rgb.c" 3 4
                                                        ((void *)0)
# 1591 "coders/rgb.c"
                                                            ,quantum_info,
            RedQuantum,pixels,exception);
...
# 1597 "coders/rgb.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1616 "coders/rgb.c" 3 4
                                    ((void *)0)
# 1616 "coders/rgb.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1618 "coders/rgb.c" 3 4
                                                        ((void *)0)
# 1618 "coders/rgb.c"
                                                            ,quantum_info,
            GreenQuantum,pixels,exception);
...
# 1624 "coders/rgb.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1643 "coders/rgb.c" 3 4
                                    ((void *)0)
# 1643 "coders/rgb.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1645 "coders/rgb.c" 3 4
                                                        ((void *)0)
# 1645 "coders/rgb.c"
                                                            ,quantum_info,
            BlueQuantum,pixels,exception);
        ...
        if (quantum_type == RGBAQuantum)
          {
            ...
            for (y=0; y < (ssize_t) image->rows; y++)
            {
              ...
              p=GetVirtualPixels(image,0,y,image->columns,1,exception);
              if (p == (const Quantum *) 
# 1672 "coders/rgb.c" 3 4
                                        ((void *)0)
# 1672 "coders/rgb.c"
                                            )
                break;
              length=ExportQuantumPixels(image,(CacheView *) 
# 1674 "coders/rgb.c" 3 4
                                                            ((void *)0)
# 1674 "coders/rgb.c"
                                                                ,quantum_info,
                AlphaQuantum,pixels,exception);
