...
# 427 "coders/cin.c" 3 4
 , "coders/cin.c", 427, __extension__ __PRETTY_FUNCTION__); }))
# 427 "coders/cin.c"
                                               ;
  
# 428 "coders/cin.c" 3 4
 ((void) sizeof ((
# 428 "coders/cin.c"
...
# 428 "coders/cin.c" 3 4
 , "coders/cin.c", 428, __extension__ __PRETTY_FUNCTION__); }))
# 428 "coders/cin.c"
                                                     ;
  
# 429 "coders/cin.c" 3 4
 ((void) sizeof ((
# 429 "coders/cin.c"
...
# 429 "coders/cin.c" 3 4
 , "coders/cin.c", 429, __extension__ __PRETTY_FUNCTION__); }))
# 429 "coders/cin.c"
                                            ;
  
# 430 "coders/cin.c" 3 4
 ((void) sizeof ((
# 430 "coders/cin.c"
...
# 430 "coders/cin.c" 3 4
 , "coders/cin.c", 430, __extension__ __PRETTY_FUNCTION__); }))
# 430 "coders/cin.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/cin.c",__func__,(unsigned long) 432,"%s",
      image_info->filename);
...
# 439 "coders/cin.c"
  ...
  if ((count != 4) ||
    ...
    { (void) ThrowMagickException(exception,"coders/cin.c",__func__,(unsigned long) 449,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 449 "coders/cin.c" 3 4
   ((void *)0)
# 449 "coders/cin.c"
...
# 449 "coders/cin.c"
  ...
  if (cin.file.image_offset < 712)
    { (void) ThrowMagickException(exception,"coders/cin.c",__func__,(unsigned long) 455,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 455 "coders/cin.c" 3 4
   ((void *)0)
# 455 "coders/cin.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 455 "coders/cin.c" 3 4
  ...
  if ((cin.file.image_offset > 2048) && (cin.file.user_length != 0))
    {
      ...
      if (cin.file.user_length > GetBlobSize(image))
        { (void) ThrowMagickException(exception,"coders/cin.c",__func__,(unsigned long) 713,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 713 "coders/cin.c" 3 4
       ((void *)0)
# 713 "coders/cin.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 713 "coders/cin.c" 3 4
...
# 714 "coders/cin.c" 3 4
                                                      ((void *)0)
# 714 "coders/cin.c"
                                                          ,
        cin.file.user_length);
      if (profile == (StringInfo *) 
# 716 "coders/cin.c" 3 4
                                   ((void *)0)
# 716 "coders/cin.c"
                                       )
        { (void) ThrowMagickException(exception,"coders/cin.c",__func__,(unsigned long) 717,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 717 "coders/cin.c" 3 4
       ((void *)0)
# 717 "coders/cin.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 717 "coders/cin.c" 3 4
...
# 717 "coders/cin.c"
  ...
  if (((MagickSizeType) image->columns*image->rows/8) > GetBlobSize(image))
    { (void) ThrowMagickException(exception,"coders/cin.c",__func__,(unsigned long) 732,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 732 "coders/cin.c" 3 4
   ((void *)0)
# 732 "coders/cin.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 732 "coders/cin.c" 3 4
...
# 739 "coders/cin.c"
  ...
  if (offset < (MagickOffsetType) cin.file.image_offset)
    { (void) ThrowMagickException(exception,"coders/cin.c",__func__,(unsigned long) 743,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 743 "coders/cin.c" 3 4
   ((void *)0)
# 743 "coders/cin.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 743 "coders/cin.c" 3 4
...
# 752 "coders/cin.c" 3 4
                                     ((void *)0)
# 752 "coders/cin.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/cin.c",__func__,(unsigned long) 753,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 753 "coders/cin.c" 3 4
   ((void *)0)
# 753 "coders/cin.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 753 "coders/cin.c" 3 4
...
# 790 "coders/cin.c" 3 4
   (*__errno_location ())
# 790 "coders/cin.c"
   ); (void) ThrowMagickException(exception,"coders/cin.c",__func__,(unsigned long) 790,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 822 "coders/cin.c"
__attribute__ ((visibility ("default"))) size_t RegisterCINImage(void)
{
  MagickInfo
    *entry;
...
# 856 "coders/cin.c"
__attribute__ ((visibility ("default"))) void UnregisterCINImage(void)
{
...
# 953 "coders/cin.c"
 "image_info != (const ImageInfo *) NULL"
# 953 "coders/cin.c" 3 4
 , "coders/cin.c", 953, __extension__ __PRETTY_FUNCTION__); }))
# 953 "coders/cin.c"
                                               ;
  
# 954 "coders/cin.c" 3 4
 ((void) sizeof ((
# 954 "coders/cin.c"
 image_info->signature == 0xabacadabUL
# 954 "coders/cin.c" 3 4
...
# 954 "coders/cin.c"
 "image_info->signature == MagickCoreSignature"
# 954 "coders/cin.c" 3 4
 , "coders/cin.c", 954, __extension__ __PRETTY_FUNCTION__); }))
# 954 "coders/cin.c"
                                                     ;
  
# 955 "coders/cin.c" 3 4
 ((void) sizeof ((
# 955 "coders/cin.c"
 image != (Image *) 
# 955 "coders/cin.c" 3 4
...
# 955 "coders/cin.c"
 "image != (Image *) NULL"
# 955 "coders/cin.c" 3 4
 , "coders/cin.c", 955, __extension__ __PRETTY_FUNCTION__); }))
# 955 "coders/cin.c"
                                ;
  
# 956 "coders/cin.c" 3 4
 ((void) sizeof ((
# 956 "coders/cin.c"
...
# 956 "coders/cin.c" 3 4
 , "coders/cin.c", 956, __extension__ __PRETTY_FUNCTION__); }))
# 956 "coders/cin.c"
                                                ;
  
# 957 "coders/cin.c" 3 4
 ((void) sizeof ((
# 957 "coders/cin.c"
 exception != (ExceptionInfo *) 
# 957 "coders/cin.c" 3 4
...
# 957 "coders/cin.c"
 "exception != (ExceptionInfo *) NULL"
# 957 "coders/cin.c" 3 4
 , "coders/cin.c", 957, __extension__ __PRETTY_FUNCTION__); }))
# 957 "coders/cin.c"
                                            ;
  
# 958 "coders/cin.c" 3 4
 ((void) sizeof ((
# 958 "coders/cin.c"
 exception->signature == 0xabacadabUL
# 958 "coders/cin.c" 3 4
...
# 958 "coders/cin.c"
 "exception->signature == MagickCoreSignature"
# 958 "coders/cin.c" 3 4
 , "coders/cin.c", 958, __extension__ __PRETTY_FUNCTION__); }))
# 958 "coders/cin.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/cin.c",__func__,(unsigned long) 960,"%s",image->filename);
...
# 993 "coders/cin.c"
  ...
  (void) strftime(timestamp,4096,"%Y:%m:%d:%H:%M:%SUTC",&utc_time);
...
# 1124 "coders/cin.c"
  ...
  if (value != (const char *) 
# 1131 "coders/cin.c" 3 4
                             ((void *)0)
# 1131 "coders/cin.c"
                                 )
    cin.origination.x_pitch=StringToDouble(value,(char **) 
# 1132 "coders/cin.c" 3 4
                                                          ((void *)0)
# 1132 "coders/cin.c"
                                                              );
  ...
  if (value != (const char *) 
# 1136 "coders/cin.c" 3 4
                             ((void *)0)
# 1136 "coders/cin.c"
                                 )
    cin.origination.y_pitch=StringToDouble(value,(char **) 
# 1137 "coders/cin.c" 3 4
                                                          ((void *)0)
# 1137 "coders/cin.c"
                                                              );
...
# 1179 "coders/cin.c"
  ...
  if (value != (const char *) 
# 1184 "coders/cin.c" 3 4
                             ((void *)0)
# 1184 "coders/cin.c"
                                 )
    cin.film.frame_rate=StringToDouble(value,(char **) 
# 1185 "coders/cin.c" 3 4
                                                      ((void *)0)
# 1185 "coders/cin.c"
                                                          );
...
# 1200 "coders/cin.c"
  ...
  quantum_info=AcquireQuantumInfo(image_info,image);
  if (quantum_info == (QuantumInfo *) 
# 1209 "coders/cin.c" 3 4
                                     ((void *)0)
# 1209 "coders/cin.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/cin.c",__func__,(unsigned long) 1210,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1210 "coders/cin.c" 3 4
   ((void *)0)
# 1210 "coders/cin.c"
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 1219 "coders/cin.c" 3 4
                              ((void *)0)
# 1219 "coders/cin.c"
                                  )
      break;
    (void) ExportQuantumPixels(image,(CacheView *) 
# 1221 "coders/cin.c" 3 4
                                                  ((void *)0)
# 1221 "coders/cin.c"
                                                      ,quantum_info,
