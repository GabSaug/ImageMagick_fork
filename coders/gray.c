...
# 138 "coders/gray.c" 3 4
 , "coders/gray.c", 138, __extension__ __PRETTY_FUNCTION__); }))
# 138 "coders/gray.c"
                                               ;
  
# 139 "coders/gray.c" 3 4
 ((void) sizeof ((
# 139 "coders/gray.c"
...
# 139 "coders/gray.c" 3 4
 , "coders/gray.c", 139, __extension__ __PRETTY_FUNCTION__); }))
# 139 "coders/gray.c"
                                                     ;
  
# 140 "coders/gray.c" 3 4
 ((void) sizeof ((
# 140 "coders/gray.c"
...
# 140 "coders/gray.c" 3 4
 , "coders/gray.c", 140, __extension__ __PRETTY_FUNCTION__); }))
# 140 "coders/gray.c"
                                            ;
  
# 141 "coders/gray.c" 3 4
 ((void) sizeof ((
# 141 "coders/gray.c"
...
# 141 "coders/gray.c" 3 4
 , "coders/gray.c", 141, __extension__ __PRETTY_FUNCTION__); }))
# 141 "coders/gray.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/gray.c",__func__,(unsigned long) 143,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 147,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 147 "coders/gray.c" 3 4
   ((void *)0)
# 147 "coders/gray.c"
...
# 161 "coders/gray.c" 3 4
       (*__errno_location ())
# 161 "coders/gray.c"
       ); (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 161,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
    }
...
# 169 "coders/gray.c" 3 4
                               ((void *)0)
# 169 "coders/gray.c"
                                   )
    { (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 170,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 170 "coders/gray.c" 3 4
   ((void *)0)
# 170 "coders/gray.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 170 "coders/gray.c" 3 4
...
# 180 "coders/gray.c" 3 4
                                     ((void *)0)
# 180 "coders/gray.c"
                                         )
    {
      canvas_image=DestroyImage(canvas_image);
      { (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 183,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 183 "coders/gray.c" 3 4
     ((void *)0)
# 183 "coders/gray.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 183 "coders/gray.c" 3 4
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 245 "coders/gray.c" 3 4
             (*__errno_location ())
# 245 "coders/gray.c"
             ); (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 245,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
            ...
            if (count != (ssize_t) length)
              {
                status=MagickFalse;
                { char *file_message; file_message=GetExceptionMessage(
# 324 "coders/gray.c" 3 4
               (*__errno_location ())
# 324 "coders/gray.c"
               ); (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 324,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                        ;
                break;
              }
            ...
            q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
              exception);
            if (q == (Quantum *) 
# 331 "coders/gray.c" 3 4
                                ((void *)0)
# 331 "coders/gray.c"
                                    )
              break;
            length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 333 "coders/gray.c" 3 4
                                                                 ((void *)0)
# 333 "coders/gray.c"
                                                                     ,
              quantum_info,quantum_type,(unsigned char *) stream,exception);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 405 "coders/gray.c" 3 4
             (*__errno_location ())
# 405 "coders/gray.c"
             ); (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 405,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 411 "coders/gray.c" 3 4
                              ((void *)0)
# 411 "coders/gray.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 413 "coders/gray.c" 3 4
                                                               ((void *)0)
# 413 "coders/gray.c"
                                                                   ,
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 459 "coders/gray.c" 3 4
                 (*__errno_location ())
# 459 "coders/gray.c"
                 ); (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 459,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
              q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
                exception);
              if (q == (Quantum *) 
# 465 "coders/gray.c" 3 4
                                  ((void *)0)
# 465 "coders/gray.c"
                                      )
                break;
              length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 467 "coders/gray.c" 3 4
                                                                   ((void *)0)
# 467 "coders/gray.c"
                                                                       ,
        ...
        if (DiscardBlobBytes(image,(MagickSizeType) image->offset) == MagickFalse)
          {
            status=MagickFalse;
            { char *file_message; file_message=GetExceptionMessage(
# 519 "coders/gray.c" 3 4
           (*__errno_location ())
# 519 "coders/gray.c"
           ); (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 519,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                    ;
            break;
          }
        length=GetQuantumExtent(canvas_image,quantum_info,RedQuantum);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 550 "coders/gray.c" 3 4
             (*__errno_location ())
# 550 "coders/gray.c"
             ); (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 550,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 556 "coders/gray.c" 3 4
                              ((void *)0)
# 556 "coders/gray.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 558 "coders/gray.c" 3 4
                                                               ((void *)0)
# 558 "coders/gray.c"
                                                                   ,
            quantum_info,RedQuantum,(unsigned char *) stream,exception);
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 624 "coders/gray.c" 3 4
                 (*__errno_location ())
# 624 "coders/gray.c"
                 ); (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 624,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
              q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
                exception);
              if (q == (Quantum *) 
# 630 "coders/gray.c" 3 4
                                  ((void *)0)
# 630 "coders/gray.c"
                                      )
                break;
              length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 632 "coders/gray.c" 3 4
                                                                   ((void *)0)
# 632 "coders/gray.c"
                                                                       ,
...
# 733 "coders/gray.c"
__attribute__ ((visibility ("default"))) size_t RegisterGRAYImage(void)
{
  MagickInfo
    *entry;
...
# 772 "coders/gray.c"
__attribute__ ((visibility ("default"))) void UnregisterGRAYImage(void)
{
...
# 835 "coders/gray.c"
 "image_info != (const ImageInfo *) NULL"
# 835 "coders/gray.c" 3 4
 , "coders/gray.c", 835, __extension__ __PRETTY_FUNCTION__); }))
# 835 "coders/gray.c"
                                               ;
  
# 836 "coders/gray.c" 3 4
 ((void) sizeof ((
# 836 "coders/gray.c"
 image_info->signature == 0xabacadabUL
# 836 "coders/gray.c" 3 4
...
# 836 "coders/gray.c"
 "image_info->signature == MagickCoreSignature"
# 836 "coders/gray.c" 3 4
 , "coders/gray.c", 836, __extension__ __PRETTY_FUNCTION__); }))
# 836 "coders/gray.c"
                                                     ;
  
# 837 "coders/gray.c" 3 4
 ((void) sizeof ((
# 837 "coders/gray.c"
 image != (Image *) 
# 837 "coders/gray.c" 3 4
...
# 837 "coders/gray.c"
 "image != (Image *) NULL"
# 837 "coders/gray.c" 3 4
 , "coders/gray.c", 837, __extension__ __PRETTY_FUNCTION__); }))
# 837 "coders/gray.c"
                                ;
  
# 838 "coders/gray.c" 3 4
 ((void) sizeof ((
# 838 "coders/gray.c"
...
# 838 "coders/gray.c" 3 4
 , "coders/gray.c", 838, __extension__ __PRETTY_FUNCTION__); }))
# 838 "coders/gray.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/gray.c",__func__,(unsigned long) 840,"%s",image->filename);
  if (image_info->interlace != PartitionInterlace)
    {
  ...
  do
  {
    ...
    if (quantum_info == (QuantumInfo *) 
# 865 "coders/gray.c" 3 4
                                       ((void *)0)
# 865 "coders/gray.c"
                                           )
      { (void) ThrowMagickException(exception,"coders/gray.c",__func__,(unsigned long) 866,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 866 "coders/gray.c" 3 4
     ((void *)0)
# 866 "coders/gray.c"
    ...
    switch (image_info->interlace)
    {
      ...
      default:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          if (p == (const Quantum *) 
# 882 "coders/gray.c" 3 4
                                    ((void *)0)
# 882 "coders/gray.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 884 "coders/gray.c" 3 4
                                                        ((void *)0)
# 884 "coders/gray.c"
                                                            ,quantum_info,
...
# 889 "coders/gray.c"
      ...
      case LineInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 910 "coders/gray.c" 3 4
                                    ((void *)0)
# 910 "coders/gray.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 912 "coders/gray.c" 3 4
                                                        ((void *)0)
# 912 "coders/gray.c"
                                                            ,quantum_info,
...
# 925 "coders/gray.c"
      ...
      case PlaneInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 946 "coders/gray.c" 3 4
                                    ((void *)0)
# 946 "coders/gray.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 948 "coders/gray.c" 3 4
                                                        ((void *)0)
# 948 "coders/gray.c"
                                                            ,quantum_info,
            GrayQuantum,pixels,exception);
        ...
        if (quantum_type == GrayAlphaQuantum)
          {
            for (y=0; y < (ssize_t) image->rows; y++)
            {
              ...
              p=GetVirtualPixels(image,0,y,image->columns,1,exception);
              if (p == (const Quantum *) 
# 968 "coders/gray.c" 3 4
                                        ((void *)0)
# 968 "coders/gray.c"
                                            )
                break;
              length=ExportQuantumPixels(image,(CacheView *) 
# 970 "coders/gray.c" 3 4
                                                            ((void *)0)
# 970 "coders/gray.c"
                                                                ,quantum_info,
                AlphaQuantum,pixels,exception);
...
# 986 "coders/gray.c"
      ...
      case PartitionInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1010 "coders/gray.c" 3 4
                                    ((void *)0)
# 1010 "coders/gray.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1012 "coders/gray.c" 3 4
                                                        ((void *)0)
# 1012 "coders/gray.c"
                                                            ,quantum_info,
        ...
        if (quantum_type == GrayAlphaQuantum)
          {
            ...
            for (y=0; y < (ssize_t) image->rows; y++)
            {
              ...
              p=GetVirtualPixels(image,0,y,image->columns,1,exception);
              if (p == (const Quantum *) 
# 1040 "coders/gray.c" 3 4
                                        ((void *)0)
# 1040 "coders/gray.c"
                                            )
                break;
              length=ExportQuantumPixels(image,(CacheView *) 
# 1042 "coders/gray.c" 3 4
                                                            ((void *)0)
# 1042 "coders/gray.c"
                                                                ,quantum_info,
                AlphaQuantum,pixels,exception);
