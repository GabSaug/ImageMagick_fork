...
# 185 "coders/ept.c" 3 4
 , "coders/ept.c", 185, __extension__ __PRETTY_FUNCTION__); }))
# 185 "coders/ept.c"
                                               ;
  
# 186 "coders/ept.c" 3 4
 ((void) sizeof ((
# 186 "coders/ept.c"
...
# 186 "coders/ept.c" 3 4
 , "coders/ept.c", 186, __extension__ __PRETTY_FUNCTION__); }))
# 186 "coders/ept.c"
                                                     ;
  
# 187 "coders/ept.c" 3 4
 ((void) sizeof ((
# 187 "coders/ept.c"
...
# 187 "coders/ept.c" 3 4
 , "coders/ept.c", 187, __extension__ __PRETTY_FUNCTION__); }))
# 187 "coders/ept.c"
                                            ;
  
# 188 "coders/ept.c" 3 4
 ((void) sizeof ((
# 188 "coders/ept.c"
...
# 188 "coders/ept.c" 3 4
 , "coders/ept.c", 188, __extension__ __PRETTY_FUNCTION__); }))
# 188 "coders/ept.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ept.c",__func__,(unsigned long) 190,"%s",
      image_info->filename);
...
# 197 "coders/ept.c"
  ...
  if (ept_info.magick != 0xc6d3d0c5ul)
    { (void) ThrowMagickException(exception,"coders/ept.c",__func__,(unsigned long) 201,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 201 "coders/ept.c" 3 4
   ((void *)0)
# 201 "coders/ept.c"
...
# 201 "coders/ept.c"
  ...
  if ((MagickSizeType) ept_info.postscript_length > GetBlobSize(image))
    { (void) ThrowMagickException(exception,"coders/ept.c",__func__,(unsigned long) 205,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 205 "coders/ept.c" 3 4
   ((void *)0)
# 205 "coders/ept.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 205 "coders/ept.c" 3 4
...
# 205 "coders/ept.c"
  ...
  if ((ept_info.postscript_length+ept_info.tiff_length) == 0)
    { (void) ThrowMagickException(exception,"coders/ept.c",__func__,(unsigned long) 211,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 211 "coders/ept.c" 3 4
   ((void *)0)
# 211 "coders/ept.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 211 "coders/ept.c" 3 4
...
# 211 "coders/ept.c"
  ...
  if ((MagickSizeType) ept_info.tiff_length > GetBlobSize(image))
    { (void) ThrowMagickException(exception,"coders/ept.c",__func__,(unsigned long) 213,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 213 "coders/ept.c" 3 4
   ((void *)0)
# 213 "coders/ept.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 213 "coders/ept.c" 3 4
...
# 213 "coders/ept.c"
  ...
  if (ept_info.postscript == (unsigned char *) 
# 217 "coders/ept.c" 3 4
                                              ((void *)0)
# 217 "coders/ept.c"
                                                  )
    { (void) ThrowMagickException(exception,"coders/ept.c",__func__,(unsigned long) 218,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 218 "coders/ept.c" 3 4
   ((void *)0)
# 218 "coders/ept.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 218 "coders/ept.c" 3 4
...
# 218 "coders/ept.c"
  ...
  if (ept_info.tiff == (unsigned char *) 
# 223 "coders/ept.c" 3 4
                                        ((void *)0)
# 223 "coders/ept.c"
                                            )
    {
      ept_info.postscript=(unsigned char *) RelinquishMagickMemory(
        ept_info.postscript);
      { (void) ThrowMagickException(exception,"coders/ept.c",__func__,(unsigned long) 227,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 227 "coders/ept.c" 3 4
     ((void *)0)
# 227 "coders/ept.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 227 "coders/ept.c" 3 4
...
# 227 "coders/ept.c"
  ...
  (void) memset(ept_info.tiff,0,(ept_info.tiff_length+1)*
    sizeof(*ept_info.tiff));
  offset=SeekBlob(image,ept_info.tiff_offset,
# 231 "coders/ept.c" 3 4
                                            0
# 231 "coders/ept.c"
                                                    );
  if ((ept_info.tiff_length != 0) && (offset < 30))
    {
      ...
      ept_info.postscript=(unsigned char *) RelinquishMagickMemory(
        ept_info.postscript);
      { (void) ThrowMagickException(exception,"coders/ept.c",__func__,(unsigned long) 237,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 237 "coders/ept.c" 3 4
     ((void *)0)
# 237 "coders/ept.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 237 "coders/ept.c" 3 4
...
# 237 "coders/ept.c"
  ...
  if (count != (ssize_t) (ept_info.tiff_length))
    (void) ThrowMagickException(exception,"coders/ept.c",__func__,(unsigned long) 241,CorruptImageWarning,
      "InsufficientImageDataInFile","`%s'",image->filename);
  offset=SeekBlob(image,ept_info.postscript_offset,
# 243 "coders/ept.c" 3 4
                                                  0
# 243 "coders/ept.c"
                                                          );
  if ((ept_info.postscript_length != 0) && (offset < 30))
    {
      ...
      ept_info.postscript=(unsigned char *) RelinquishMagickMemory(
        ept_info.postscript);
      { (void) ThrowMagickException(exception,"coders/ept.c",__func__,(unsigned long) 249,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 249 "coders/ept.c" 3 4
     ((void *)0)
# 249 "coders/ept.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 249 "coders/ept.c" 3 4
  ...
  if (count != (ssize_t) (ept_info.postscript_length))
    {
      ...
      ept_info.postscript=(unsigned char *) RelinquishMagickMemory(
        ept_info.postscript);
      { (void) ThrowMagickException(exception,"coders/ept.c",__func__,(unsigned long) 258,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 258 "coders/ept.c" 3 4
     ((void *)0)
# 258 "coders/ept.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 258 "coders/ept.c" 3 4
...
# 258 "coders/ept.c"
  ...
  read_info->scene=0;
  (void) CopyMagickString(read_info->magick,"EPS",4096);
...
# 273 "coders/ept.c"
                                )
        {
          (void) CopyMagickString(image->filename,image_info->filename,
            4096);
          (void) CopyMagickString(image->magick,"EPT",4096);
        }
    }
  if (ept_info.tiff_length != 0)
    {
      ...
      (void) CopyMagickString(read_info->magick,"TIFF",4096);
      tiff_image=BlobToImage(read_info,tiff_data,ept_info.tiff_length,
        exception);
      if (tiff_image != (Image *) 
# 288 "coders/ept.c" 3 4
                                 ((void *)0)
# 288 "coders/ept.c"
                                     )
        {
          if (image == (Image *) 
# 290 "coders/ept.c" 3 4
                                ((void *)0)
# 290 "coders/ept.c"
                                    )
            image=tiff_image;
...
# 326 "coders/ept.c"
__attribute__ ((visibility ("default"))) size_t RegisterEPTImage(void)
{
  MagickInfo
    *entry;
...
# 379 "coders/ept.c"
__attribute__ ((visibility ("default"))) void UnregisterEPTImage(void)
{
...
# 433 "coders/ept.c"
 "image_info != (const ImageInfo *) NULL"
# 433 "coders/ept.c" 3 4
 , "coders/ept.c", 433, __extension__ __PRETTY_FUNCTION__); }))
# 433 "coders/ept.c"
                                               ;
  
# 434 "coders/ept.c" 3 4
 ((void) sizeof ((
# 434 "coders/ept.c"
 image_info->signature == 0xabacadabUL
# 434 "coders/ept.c" 3 4
...
# 434 "coders/ept.c"
 "image_info->signature == MagickCoreSignature"
# 434 "coders/ept.c" 3 4
 , "coders/ept.c", 434, __extension__ __PRETTY_FUNCTION__); }))
# 434 "coders/ept.c"
                                                     ;
  
# 435 "coders/ept.c" 3 4
 ((void) sizeof ((
# 435 "coders/ept.c"
 image != (Image *) 
# 435 "coders/ept.c" 3 4
...
# 435 "coders/ept.c"
 "image != (Image *) NULL"
# 435 "coders/ept.c" 3 4
 , "coders/ept.c", 435, __extension__ __PRETTY_FUNCTION__); }))
# 435 "coders/ept.c"
                                ;
  
# 436 "coders/ept.c" 3 4
 ((void) sizeof ((
# 436 "coders/ept.c"
...
# 436 "coders/ept.c" 3 4
 , "coders/ept.c", 436, __extension__ __PRETTY_FUNCTION__); }))
# 436 "coders/ept.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ept.c",__func__,(unsigned long) 438,"%s",image->filename);
  
# 439 "coders/ept.c" 3 4
 ((void) sizeof ((
# 439 "coders/ept.c"
 exception != (ExceptionInfo *) 
# 439 "coders/ept.c" 3 4
...
# 439 "coders/ept.c"
 "exception != (ExceptionInfo *) NULL"
# 439 "coders/ept.c" 3 4
 , "coders/ept.c", 439, __extension__ __PRETTY_FUNCTION__); }))
# 439 "coders/ept.c"
                                            ;
  
# 440 "coders/ept.c" 3 4
 ((void) sizeof ((
# 440 "coders/ept.c"
 exception->signature == 0xabacadabUL
# 440 "coders/ept.c" 3 4
...
# 440 "coders/ept.c"
 "exception->signature == MagickCoreSignature"
# 440 "coders/ept.c" 3 4
 , "coders/ept.c", 440, __extension__ __PRETTY_FUNCTION__); }))
# 440 "coders/ept.c"
                                                    ;
...
# 445 "coders/ept.c" 3 4
                              ((void *)0)
# 445 "coders/ept.c"
                                  )
    return(MagickFalse);
  write_info=CloneImageInfo(image_info);
  (void) CopyMagickString(write_info->filename,"EPS:",4096);
  (void) CopyMagickString(write_info->magick,"EPS",4096);
  if (LocaleCompare(image_info->magick,"EPT2") == 0)
    {
      (void) CopyMagickString(write_info->filename,"EPS2:",4096);
      (void) CopyMagickString(write_info->magick,"EPS2",4096);
    }
  if (LocaleCompare(image_info->magick,"EPT3") == 0)
    {
      (void) CopyMagickString(write_info->filename,"EPS3:",4096);
      (void) CopyMagickString(write_info->magick,"EPS3",4096);
    }
  ...
  if (ept_info.postscript == (void *) 
# 466 "coders/ept.c" 3 4
                                     ((void *)0)
# 466 "coders/ept.c"
                                         )
    return(MagickFalse);
  write_image=CloneImage(image,0,0,MagickTrue,exception);
  if (write_image == (Image *) 
# 469 "coders/ept.c" 3 4
                              ((void *)0)
# 469 "coders/ept.c"
                                  )
    return(MagickFalse);
  write_info=CloneImageInfo(image_info);
  (void) CopyMagickString(write_info->magick,"TIFF",4096);
  (void) FormatLocaleString(filename,4096,"tiff:%s",
    write_info->filename);
  (void) CopyMagickString(write_info->filename,filename,4096);
...
# 483 "coders/ept.c"
  ...
  write_image=DestroyImage(write_image);
  write_info=DestroyImageInfo(write_info);
  if (ept_info.tiff == (void *) 
# 508 "coders/ept.c" 3 4
                               ((void *)0)
# 508 "coders/ept.c"
                                   )
    {
