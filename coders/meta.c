...
static int stringnicmp(const char *p,const char *q,size_t n)
{
  ...
  if (p == q)
    return(0);
  if (p == (char *) 
# 171 "coders/meta.c" 3 4
                   ((void *)0)
# 171 "coders/meta.c"
                       )
    return(-1);
  if (q == (char *) 
# 173 "coders/meta.c" 3 4
                   ((void *)0)
# 173 "coders/meta.c"
                       )
    return(1);
...
static ssize_t parse8BIM(Image *ifile, Image *ofile)
{
  ...
  if (line == (char *) 
# 342 "coders/meta.c" 3 4
                      ((void *)0)
# 342 "coders/meta.c"
                          )
    return(-1);
  newstr = name = token = (char *) 
# 344 "coders/meta.c" 3 4
                                  ((void *)0)
# 344 "coders/meta.c"
                                      ;
  savedpos = 0;
  token_info=AcquireTokenInfo();
  while (super_fgets(&line,&inputlen,ifile)!=
# 347 "coders/meta.c" 3 4
                                            ((void *)0)
# 347 "coders/meta.c"
                                                )
  {
      ...
      if (state == 0)
        {
            ...
            "", 0,&brkused,&n,&quoted)==0)
          {
            switch (s)
            {
              ...
              case 2:
              {
                size_t extent = strlen(newstr)+4096;
                name=(char *) AcquireQuantumMemory(extent,sizeof(*name));
                if (name != (char *) 
# 387 "coders/meta.c" 3 4
                                    ((void *)0)
# 387 "coders/meta.c"
                                        )
                ...
                if (savedolen > 0)
                  {
                    ...
                    offset=SeekBlob(ofile,savedpos,
# 445 "coders/meta.c" 3 4
                                                  0
# 445 "coders/meta.c"
                                                          );
                    if (offset < 0)
                    ...
                    offset=SeekBlob(ofile,currentpos,
# 452 "coders/meta.c" 3 4
                                                    0
# 452 "coders/meta.c"
                                                            );
                    if (offset < 0)
    ...
    if (token != (char *) 
# 525 "coders/meta.c" 3 4
                         ((void *)0)
# 525 "coders/meta.c"
                             )
      token=DestroyString(token);
    if (newstr != (char *) 
# 527 "coders/meta.c" 3 4
                          ((void *)0)
# 527 "coders/meta.c"
                              )
      newstr=DestroyString(newstr);
    if (name != (char *) 
# 529 "coders/meta.c" 3 4
                        ((void *)0)
# 529 "coders/meta.c"
                            )
  ...
  if (token != (char *) 
# 533 "coders/meta.c" 3 4
                       ((void *)0)
# 533 "coders/meta.c"
                           )
    token=DestroyString(token);
  if (newstr != (char *) 
# 535 "coders/meta.c" 3 4
                        ((void *)0)
# 535 "coders/meta.c"
                            )
    newstr=DestroyString(newstr);
  if (name != (char *) 
# 537 "coders/meta.c" 3 4
                      ((void *)0)
# 537 "coders/meta.c"
                          )
    name=DestroyString(name);
...
static ssize_t parse8BIMW(Image *ifile, Image *ofile)
{
  ...
  line=(char *) AcquireQuantumMemory(inputlen,sizeof(*line));
  if (line == (char *) 
# 654 "coders/meta.c" 3 4
                      ((void *)0)
# 654 "coders/meta.c"
                          )
    return(-1);
  newstr = name = token = (char *) 
# 656 "coders/meta.c" 3 4
                                  ((void *)0)
# 656 "coders/meta.c"
                                      ;
  savedpos = 0;
  token_info=AcquireTokenInfo();
  while (super_fgets_w(&line,&inputlen,ifile) != 
# 659 "coders/meta.c" 3 4
                                                ((void *)0)
# 659 "coders/meta.c"
                                                    )
  {
            ...
            "",0,&brkused,&n,&quoted)==0)
          {
            switch (s)
            {
              ...
              case 1:
                ...
                break;
              case 2:
                name=(char *) AcquireQuantumMemory(strlen(newstr)+4096,
                  sizeof(*name));
                if (name)
                  (void) CopyMagickString(name,newstr,strlen(newstr)+4096);
                break;
            }
            s++;
          }
...
# 756 "coders/meta.c"
    ...
    if (token != (char *) 
# 826 "coders/meta.c" 3 4
                         ((void *)0)
# 826 "coders/meta.c"
                             )
      token=DestroyString(token);
    if (newstr != (char *) 
# 828 "coders/meta.c" 3 4
                          ((void *)0)
# 828 "coders/meta.c"
                              )
      newstr=DestroyString(newstr);
    if (name != (char *) 
# 830 "coders/meta.c" 3 4
                        ((void *)0)
# 830 "coders/meta.c"
                            )
      name=DestroyString(name);
  ...
  token_info=DestroyTokenInfo(token_info);
  if (token != (char *) 
# 834 "coders/meta.c" 3 4
                       ((void *)0)
# 834 "coders/meta.c"
                           )
    token=DestroyString(token);
  if (newstr != (char *) 
# 836 "coders/meta.c" 3 4
                        ((void *)0)
# 836 "coders/meta.c"
                            )
    newstr=DestroyString(newstr);
  if (name != (char *) 
# 838 "coders/meta.c" 3 4
                      ((void *)0)
# 838 "coders/meta.c"
                          )
    name=DestroyString(name);
...
static int jpeg_transfer_1(Image *ifile, Image *ofile)
{
  ...
  if (c == 
# 902 "coders/meta.c" 3 4
          (-1)
# 902 "coders/meta.c"
             )
    return 
# 903 "coders/meta.c" 3 4
          (-1)
# 903 "coders/meta.c"
             ;
...
static int jpeg_read_remaining(Image *ifile, Image *ofile)
{
  ...
  while ((c = jpeg_transfer_1(ifile, ofile)) != 
# 924 "coders/meta.c" 3 4
                                               (-1)
# 924 "coders/meta.c"
                                                  )
    continue;
...
static int jpeg_skip_variable(Image *ifile, Image *ofile)
{
  ...
  if ((c1 = jpeg_transfer_1(ifile, ofile)) == 
# 934 "coders/meta.c" 3 4
                                             (-1)
# 934 "coders/meta.c"
                                                )
    return 0xD9;
  if ((c2 = jpeg_transfer_1(ifile, ofile)) == 
# 936 "coders/meta.c" 3 4
                                             (-1)
# 936 "coders/meta.c"
                                                )
    return 0xD9;
  ...
  while (length--)
    if (jpeg_transfer_1(ifile, ofile) == 
# 943 "coders/meta.c" 3 4
                                        (-1)
# 943 "coders/meta.c"
                                           )
      return 0xD9;
...
static int jpeg_skip_variable2(Image *ifile, Image *ofile)
{
  ...
  (void) ofile;
  if ((c1 = ReadBlobByte(ifile)) == 
# 955 "coders/meta.c" 3 4
                                   (-1)
# 955 "coders/meta.c"
                                      ) return 0xD9;
  if ((c2 = ReadBlobByte(ifile)) == 
# 956 "coders/meta.c" 3 4
                                   (-1)
# 956 "coders/meta.c"
                                      ) return 0xD9;
  ...
  while (length--)
    if (ReadBlobByte(ifile) == 
# 962 "coders/meta.c" 3 4
                              (-1)
# 962 "coders/meta.c"
                                 )
      return 0xD9;
...
static int jpeg_embed(Image *ifile, Image *ofile, Image *iptc)
{
  ...
  if (jpeg_transfer_1(ifile, ofile) != 0xFF)
    return 0;
  if (jpeg_transfer_1(ifile, ofile) != 0xD8)
    return 0;
...
static inline void CopyBlob(Image *source,Image *destination)
{
  ...
  buffer=(unsigned char *) AcquireQuantumMemory(81920,
    sizeof(*buffer));
  if (buffer != (unsigned char *) 
# 1149 "coders/meta.c" 3 4
                                 ((void *)0)
# 1149 "coders/meta.c"
                                     )
    {
      (void) memset(buffer,0,81920*sizeof(*buffer));
      i=0;
      while ((length=ReadBlob(source,81920,buffer)) != 0)
      {
        count=0;
...
# 1191 "coders/meta.c" 3 4
 , "coders/meta.c", 1191, __extension__ __PRETTY_FUNCTION__); }))
# 1191 "coders/meta.c"
                                               ;
  
# 1192 "coders/meta.c" 3 4
 ((void) sizeof ((
# 1192 "coders/meta.c"
...
# 1192 "coders/meta.c" 3 4
 , "coders/meta.c", 1192, __extension__ __PRETTY_FUNCTION__); }))
# 1192 "coders/meta.c"
                                                     ;
  
# 1193 "coders/meta.c" 3 4
 ((void) sizeof ((
# 1193 "coders/meta.c"
...
# 1193 "coders/meta.c" 3 4
 , "coders/meta.c", 1193, __extension__ __PRETTY_FUNCTION__); }))
# 1193 "coders/meta.c"
                                            ;
  
# 1194 "coders/meta.c" 3 4
 ((void) sizeof ((
# 1194 "coders/meta.c"
...
# 1194 "coders/meta.c" 3 4
 , "coders/meta.c", 1194, __extension__ __PRETTY_FUNCTION__); }))
# 1194 "coders/meta.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/meta.c",__func__,(unsigned long) 1196,"%s",
      image_info->filename);
...
# 1218 "coders/meta.c" 3 4
                                     ((void *)0)
# 1218 "coders/meta.c"
                                         ,exception);
      if (buff == (Image *) 
# 1219 "coders/meta.c" 3 4
                           ((void *)0)
# 1219 "coders/meta.c"
                               )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1220,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1220 "coders/meta.c" 3 4
       ((void *)0)
# 1220 "coders/meta.c"
...
# 1222 "coders/meta.c" 3 4
                                   ((void *)0)
# 1222 "coders/meta.c"
                                       )
        {
          buff=DestroyImage(buff);
          { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1225,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1225 "coders/meta.c" 3 4
         ((void *)0)
# 1225 "coders/meta.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1225 "coders/meta.c" 3 4
          ...
          if (length == 0)
            {
              ...
              buff=DestroyImage(buff);
              { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1237,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1237 "coders/meta.c" 3 4
             ((void *)0)
# 1237 "coders/meta.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1237 "coders/meta.c" 3 4
          ...
          if (length == 0)
            {
              ...
              blob=(unsigned char *) RelinquishMagickMemory(blob);
              buff=DestroyImage(buff);
              { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1250,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1250 "coders/meta.c" 3 4
             ((void *)0)
# 1250 "coders/meta.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1250 "coders/meta.c" 3 4
...
# 1259 "coders/meta.c"
                                       )
        {
          ...
          blob=(unsigned char *) RelinquishMagickMemory(blob);
          buff=DestroyImage(buff);
          { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1264,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1264 "coders/meta.c" 3 4
         ((void *)0)
# 1264 "coders/meta.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1264 "coders/meta.c" 3 4
...
# 1264 "coders/meta.c"
      ...
      buff=DestroyImage(buff);
      if (status == MagickFalse)
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1272,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1272 "coders/meta.c" 3 4
       ((void *)0)
# 1272 "coders/meta.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1272 "coders/meta.c" 3 4
  ...
  if (LocaleNCompare(image_info->magick,"APP1",4) == 0)
    {
      ...
      (void) FormatLocaleString(name,4096,"APP%d",1);
      buff=AcquireImage((ImageInfo *) 
# 1280 "coders/meta.c" 3 4
                                     ((void *)0)
# 1280 "coders/meta.c"
                                         ,exception);
      if (buff == (Image *) 
# 1281 "coders/meta.c" 3 4
                           ((void *)0)
# 1281 "coders/meta.c"
                               )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1282,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1282 "coders/meta.c" 3 4
       ((void *)0)
# 1282 "coders/meta.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1282 "coders/meta.c" 3 4
...
# 1282 "coders/meta.c"
      ...
      blob=(unsigned char *) AcquireQuantumMemory(length,sizeof(unsigned char));
      if (blob == (unsigned char *) 
# 1284 "coders/meta.c" 3 4
                                   ((void *)0)
# 1284 "coders/meta.c"
                                       )
        {
          buff=DestroyImage(buff);
          { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1287,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1287 "coders/meta.c" 3 4
         ((void *)0)
# 1287 "coders/meta.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1287 "coders/meta.c" 3 4
...
# 1298 "coders/meta.c"
                                                 )
            {
              ...
              blob=(unsigned char *) RelinquishMagickMemory(blob);
              buff=DestroyImage(buff);
              { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1303,CoderError,"NoIPTCProfileAvailable", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1303 "coders/meta.c" 3 4
             ((void *)0)
# 1303 "coders/meta.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1303 "coders/meta.c" 3 4
...
# 1303 "coders/meta.c"
          ...
          iptc=AcquireImage((ImageInfo *) 
# 1306 "coders/meta.c" 3 4
                                         ((void *)0)
# 1306 "coders/meta.c"
                                             ,exception);
          if (iptc == (Image *) 
# 1307 "coders/meta.c" 3 4
                               ((void *)0)
# 1307 "coders/meta.c"
                                   )
            {
              ...
              blob=(unsigned char *) RelinquishMagickMemory(blob);
              buff=DestroyImage(buff);
              { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1312,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1312 "coders/meta.c" 3 4
             ((void *)0)
# 1312 "coders/meta.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1312 "coders/meta.c" 3 4
...
# 1312 "coders/meta.c"
          ...
          if (result == 0)
            {
              buff=DestroyImage(buff);
              { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1323,CoderError,"JPEGEmbeddingFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1323 "coders/meta.c" 3 4
             ((void *)0)
# 1323 "coders/meta.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1323 "coders/meta.c" 3 4
...
# 1330 "coders/meta.c"
                                       )
        {
          ...
          blob=(unsigned char *) RelinquishMagickMemory(blob);
          buff=DestroyImage(buff);
          { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1335,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1335 "coders/meta.c" 3 4
         ((void *)0)
# 1335 "coders/meta.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1335 "coders/meta.c" 3 4
...
# 1335 "coders/meta.c"
      ...
      buff=DestroyImage(buff);
      if (status == MagickFalse)
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1343,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1343 "coders/meta.c" 3 4
       ((void *)0)
# 1343 "coders/meta.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1343 "coders/meta.c" 3 4
...
# 1343 "coders/meta.c"
  ...
  if ((LocaleCompare(image_info->magick,"ICC") == 0) ||
    ...
    {
      buff=AcquireImage((ImageInfo *) 
# 1348 "coders/meta.c" 3 4
                                     ((void *)0)
# 1348 "coders/meta.c"
                                         ,exception);
      if (buff == (Image *) 
# 1349 "coders/meta.c" 3 4
                           ((void *)0)
# 1349 "coders/meta.c"
                               )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1350,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1350 "coders/meta.c" 3 4
       ((void *)0)
# 1350 "coders/meta.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1350 "coders/meta.c" 3 4
...
# 1350 "coders/meta.c"
      ...
      blob=(unsigned char *) AcquireQuantumMemory(length,sizeof(unsigned char));
      if (blob == (unsigned char *) 
# 1352 "coders/meta.c" 3 4
                                   ((void *)0)
# 1352 "coders/meta.c"
                                       )
        {
          buff=DestroyImage(buff);
          { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1355,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1355 "coders/meta.c" 3 4
         ((void *)0)
# 1355 "coders/meta.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1355 "coders/meta.c" 3 4
...
# 1361 "coders/meta.c"
                                       )
        {
          ...
          blob=(unsigned char *) RelinquishMagickMemory(blob);
          buff=DestroyImage(buff);
          { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1366,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1366 "coders/meta.c" 3 4
         ((void *)0)
# 1366 "coders/meta.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1366 "coders/meta.c" 3 4
...
# 1366 "coders/meta.c"
  ...
  if (LocaleCompare(image_info->magick,"IPTC") == 0)
    {
      buff=AcquireImage((ImageInfo *) 
# 1376 "coders/meta.c" 3 4
                                     ((void *)0)
# 1376 "coders/meta.c"
                                         ,exception);
      if (buff == (Image *) 
# 1377 "coders/meta.c" 3 4
                           ((void *)0)
# 1377 "coders/meta.c"
                               )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1378,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1378 "coders/meta.c" 3 4
       ((void *)0)
# 1378 "coders/meta.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1378 "coders/meta.c" 3 4
...
# 1378 "coders/meta.c"
      ...
      blob=(unsigned char *) AcquireQuantumMemory(length,sizeof(unsigned char));
      if (blob == (unsigned char *) 
# 1380 "coders/meta.c" 3 4
                                   ((void *)0)
# 1380 "coders/meta.c"
                                       )
        {
          buff=DestroyImage(buff);
          { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1383,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1383 "coders/meta.c" 3 4
         ((void *)0)
# 1383 "coders/meta.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1383 "coders/meta.c" 3 4
...
# 1389 "coders/meta.c"
                                       )
        {
          ...
          blob=(unsigned char *) RelinquishMagickMemory(blob);
          buff=DestroyImage(buff);
          { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1394,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1394 "coders/meta.c" 3 4
         ((void *)0)
# 1394 "coders/meta.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1394 "coders/meta.c" 3 4
...
# 1394 "coders/meta.c"
  ...
  if (LocaleCompare(image_info->magick,"XMP") == 0)
    {
      buff=AcquireImage((ImageInfo *) 
# 1404 "coders/meta.c" 3 4
                                     ((void *)0)
# 1404 "coders/meta.c"
                                         ,exception);
      if (buff == (Image *) 
# 1405 "coders/meta.c" 3 4
                           ((void *)0)
# 1405 "coders/meta.c"
                               )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1406,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1406 "coders/meta.c" 3 4
       ((void *)0)
# 1406 "coders/meta.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1406 "coders/meta.c" 3 4
...
# 1406 "coders/meta.c"
      ...
      blob=(unsigned char *) AcquireQuantumMemory(length,sizeof(unsigned char));
      if (blob == (unsigned char *) 
# 1408 "coders/meta.c" 3 4
                                   ((void *)0)
# 1408 "coders/meta.c"
                                       )
        {
          buff=DestroyImage(buff);
          { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1411,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1411 "coders/meta.c" 3 4
         ((void *)0)
# 1411 "coders/meta.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1411 "coders/meta.c" 3 4
...
# 1417 "coders/meta.c"
                                       )
        {
          ...
          blob=(unsigned char *) RelinquishMagickMemory(blob);
          buff=DestroyImage(buff);
          { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 1422,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1422 "coders/meta.c" 3 4
         ((void *)0)
# 1422 "coders/meta.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1422 "coders/meta.c" 3 4
...
# 1460 "coders/meta.c"
__attribute__ ((visibility ("default"))) size_t RegisterMETAImage(void)
{
  MagickInfo
    *entry;
...
# 1572 "coders/meta.c"
__attribute__ ((visibility ("default"))) void UnregisterMETAImage(void)
{
...
# 1806 "coders/meta.c"
        ...
        {
          (void) FormatLocaleString(temp,4096,"&#%d;", c & 255);
...
# 1983 "coders/meta.c"
    ...
    if (strlen((char *)readable) > 0)
      (void) FormatLocaleString(temp,4096,"%d#%d#%s=",
        (unsigned int) dataset, (unsigned int) recnum, readable);
    else
      (void) FormatLocaleString(temp,4096,"%d#%d=",
...
# 2206 "coders/meta.c"
      ...
      PString=(unsigned char *) AcquireQuantumMemory((size_t) (plen+
        4096),sizeof(*PString));
      if (PString == (unsigned char *) 
# 2211 "coders/meta.c" 3 4
                                      ((void *)0)
# 2211 "coders/meta.c"
                                          )
        return 0;
    ...
    if (ID != 1033)
      {
        ...
        if (strlen((const char *)PString) > 0)
          (void) FormatLocaleString(temp,4096,"8BIM#%d#%s=",ID,
            PString);
        else
          (void) FormatLocaleString(temp,4096,"8BIM#%d=",ID);
        (void) WriteBlobString(ofile,temp);
        if (ID == 1028)
          {
...
# 2304 "coders/meta.c"
 "image_info != (const ImageInfo *) NULL"
# 2304 "coders/meta.c" 3 4
 , "coders/meta.c", 2304, __extension__ __PRETTY_FUNCTION__); }))
# 2304 "coders/meta.c"
                                               ;
  
# 2305 "coders/meta.c" 3 4
 ((void) sizeof ((
# 2305 "coders/meta.c"
 image_info->signature == 0xabacadabUL
# 2305 "coders/meta.c" 3 4
...
# 2305 "coders/meta.c"
 "image_info->signature == MagickCoreSignature"
# 2305 "coders/meta.c" 3 4
 , "coders/meta.c", 2305, __extension__ __PRETTY_FUNCTION__); }))
# 2305 "coders/meta.c"
                                                     ;
  
# 2306 "coders/meta.c" 3 4
 ((void) sizeof ((
# 2306 "coders/meta.c"
 image != (Image *) 
# 2306 "coders/meta.c" 3 4
...
# 2306 "coders/meta.c"
 "image != (Image *) NULL"
# 2306 "coders/meta.c" 3 4
 , "coders/meta.c", 2306, __extension__ __PRETTY_FUNCTION__); }))
# 2306 "coders/meta.c"
                                ;
  
# 2307 "coders/meta.c" 3 4
 ((void) sizeof ((
# 2307 "coders/meta.c"
...
# 2307 "coders/meta.c" 3 4
 , "coders/meta.c", 2307, __extension__ __PRETTY_FUNCTION__); }))
# 2307 "coders/meta.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/meta.c",__func__,(unsigned long) 2309,"%s",image->filename);
  if (LocaleCompare(image_info->magick,"8BIM") == 0)
    {
      ...
      if (profile == (StringInfo *) 
# 2316 "coders/meta.c" 3 4
                                   ((void *)0)
# 2316 "coders/meta.c"
                                       )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 2317,CoderError,"No8BIMDataIsAvailable", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2317 "coders/meta.c" 3 4
       ((void *)0)
# 2317 "coders/meta.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      
# 2318 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2318 "coders/meta.c"
     exception != (ExceptionInfo *) 
# 2318 "coders/meta.c" 3 4
...
# 2318 "coders/meta.c"
     "exception != (ExceptionInfo *) NULL"
# 2318 "coders/meta.c" 3 4
     , "coders/meta.c", 2318, __extension__ __PRETTY_FUNCTION__); }))
# 2318 "coders/meta.c"
                                                ;
      
# 2319 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2319 "coders/meta.c"
     exception->signature == 0xabacadabUL
# 2319 "coders/meta.c" 3 4
...
# 2319 "coders/meta.c"
     "exception->signature == MagickCoreSignature"
# 2319 "coders/meta.c" 3 4
     , "coders/meta.c", 2319, __extension__ __PRETTY_FUNCTION__); }))
# 2319 "coders/meta.c"
                                                        ;
  ...
  if (LocaleCompare(image_info->magick,"iptc") == 0)
    {
      ...
      if (profile == (StringInfo *) 
# 2334 "coders/meta.c" 3 4
                                   ((void *)0)
# 2334 "coders/meta.c"
                                       )
        profile=GetImageProfile(image,"8bim");
      if (profile == (StringInfo *) 
# 2336 "coders/meta.c" 3 4
                                   ((void *)0)
# 2336 "coders/meta.c"
                                       )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 2337,CoderError,"No8BIMDataIsAvailable", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2337 "coders/meta.c" 3 4
       ((void *)0)
# 2337 "coders/meta.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      
# 2338 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2338 "coders/meta.c"
     exception != (ExceptionInfo *) 
# 2338 "coders/meta.c" 3 4
...
# 2338 "coders/meta.c"
     "exception != (ExceptionInfo *) NULL"
# 2338 "coders/meta.c" 3 4
     , "coders/meta.c", 2338, __extension__ __PRETTY_FUNCTION__); }))
# 2338 "coders/meta.c"
                                                ;
      
# 2339 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2339 "coders/meta.c"
     exception->signature == 0xabacadabUL
# 2339 "coders/meta.c" 3 4
...
# 2339 "coders/meta.c"
     "exception->signature == MagickCoreSignature"
# 2339 "coders/meta.c" 3 4
     , "coders/meta.c", 2339, __extension__ __PRETTY_FUNCTION__); }))
# 2339 "coders/meta.c"
                                                        ;
      status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
      if (status == MagickFalse)
      ...
      if (length == 0)
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 2347,CoderError,"NoIPTCProfileAvailable", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2347 "coders/meta.c" 3 4
       ((void *)0)
# 2347 "coders/meta.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  ...
  if (LocaleCompare(image_info->magick,"8BIMTEXT") == 0)
    {
      ...
      profile=GetImageProfile(image,"8bim");
      if (profile == (StringInfo *) 
# 2358 "coders/meta.c" 3 4
                                   ((void *)0)
# 2358 "coders/meta.c"
                                       )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 2359,CoderError,"No8BIMDataIsAvailable", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2359 "coders/meta.c" 3 4
       ((void *)0)
# 2359 "coders/meta.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      
# 2360 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2360 "coders/meta.c"
     exception != (ExceptionInfo *) 
# 2360 "coders/meta.c" 3 4
...
# 2360 "coders/meta.c"
     "exception != (ExceptionInfo *) NULL"
# 2360 "coders/meta.c" 3 4
     , "coders/meta.c", 2360, __extension__ __PRETTY_FUNCTION__); }))
# 2360 "coders/meta.c"
                                                ;
      
# 2361 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2361 "coders/meta.c"
     exception->signature == 0xabacadabUL
# 2361 "coders/meta.c" 3 4
...
# 2361 "coders/meta.c"
     "exception->signature == MagickCoreSignature"
# 2361 "coders/meta.c" 3 4
     , "coders/meta.c", 2361, __extension__ __PRETTY_FUNCTION__); }))
# 2361 "coders/meta.c"
                                                        ;
      status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
      if (status == MagickFalse)
        return(status);
      buff=AcquireImage((ImageInfo *) 
# 2365 "coders/meta.c" 3 4
                                     ((void *)0)
# 2365 "coders/meta.c"
                                         ,exception);
      if (buff == (Image *) 
# 2366 "coders/meta.c" 3 4
                           ((void *)0)
# 2366 "coders/meta.c"
                               )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 2367,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2367 "coders/meta.c" 3 4
       ((void *)0)
# 2367 "coders/meta.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  ...
  if (LocaleCompare(image_info->magick,"IPTCTEXT") == 0)
    {
      ...
      profile=GetImageProfile(image,"8bim");
      if (profile == (StringInfo *) 
# 2387 "coders/meta.c" 3 4
                                   ((void *)0)
# 2387 "coders/meta.c"
                                       )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 2388,CoderError,"No8BIMDataIsAvailable", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2388 "coders/meta.c" 3 4
       ((void *)0)
# 2388 "coders/meta.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      info=GetStringInfoDatum(profile);
      ...
      length=GetIPTCStream(&info,length);
      if (length == 0)
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 2393,CoderError,"NoIPTCProfileAvailable", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2393 "coders/meta.c" 3 4
       ((void *)0)
# 2393 "coders/meta.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      
# 2394 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2394 "coders/meta.c"
     exception != (ExceptionInfo *) 
# 2394 "coders/meta.c" 3 4
...
# 2394 "coders/meta.c"
     "exception != (ExceptionInfo *) NULL"
# 2394 "coders/meta.c" 3 4
     , "coders/meta.c", 2394, __extension__ __PRETTY_FUNCTION__); }))
# 2394 "coders/meta.c"
                                                ;
      
# 2395 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2395 "coders/meta.c"
     exception->signature == 0xabacadabUL
# 2395 "coders/meta.c" 3 4
...
# 2395 "coders/meta.c"
     "exception->signature == MagickCoreSignature"
# 2395 "coders/meta.c" 3 4
     , "coders/meta.c", 2395, __extension__ __PRETTY_FUNCTION__); }))
# 2395 "coders/meta.c"
                                                        ;
      status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
      if (status == MagickFalse)
        return(status);
      buff=AcquireImage((ImageInfo *) 
# 2399 "coders/meta.c" 3 4
                                     ((void *)0)
# 2399 "coders/meta.c"
                                         ,exception);
      if (buff == (Image *) 
# 2400 "coders/meta.c" 3 4
                           ((void *)0)
# 2400 "coders/meta.c"
                               )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 2401,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2401 "coders/meta.c" 3 4
       ((void *)0)
# 2401 "coders/meta.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  ...
  if ((LocaleCompare(image_info->magick,"APP1") == 0) ||
      ...
      (LocaleCompare(image_info->magick,"XMP") == 0))
    {
      ...
      if (profile == (StringInfo *) 
# 2419 "coders/meta.c" 3 4
                                   ((void *)0)
# 2419 "coders/meta.c"
                                       )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 2420,CoderError,"NoAPP1DataIsAvailable", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2420 "coders/meta.c" 3 4
       ((void *)0)
# 2420 "coders/meta.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      
# 2421 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2421 "coders/meta.c"
     exception != (ExceptionInfo *) 
# 2421 "coders/meta.c" 3 4
...
# 2421 "coders/meta.c"
     "exception != (ExceptionInfo *) NULL"
# 2421 "coders/meta.c" 3 4
     , "coders/meta.c", 2421, __extension__ __PRETTY_FUNCTION__); }))
# 2421 "coders/meta.c"
                                                ;
      
# 2422 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2422 "coders/meta.c"
     exception->signature == 0xabacadabUL
# 2422 "coders/meta.c" 3 4
...
# 2422 "coders/meta.c"
     "exception->signature == MagickCoreSignature"
# 2422 "coders/meta.c" 3 4
     , "coders/meta.c", 2422, __extension__ __PRETTY_FUNCTION__); }))
# 2422 "coders/meta.c"
                                                        ;
      status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
      if (status == MagickFalse)
  ...
  if ((LocaleCompare(image_info->magick,"ICC") == 0) ||
      (LocaleCompare(image_info->magick,"ICM") == 0))
    {
      ...
      if (profile == (StringInfo *) 
# 2438 "coders/meta.c" 3 4
                                   ((void *)0)
# 2438 "coders/meta.c"
                                       )
        { (void) ThrowMagickException(exception,"coders/meta.c",__func__,(unsigned long) 2439,CoderError,"NoColorProfileIsAvailable", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2439 "coders/meta.c" 3 4
       ((void *)0)
# 2439 "coders/meta.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      
# 2440 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2440 "coders/meta.c"
     exception != (ExceptionInfo *) 
# 2440 "coders/meta.c" 3 4
...
# 2440 "coders/meta.c"
     "exception != (ExceptionInfo *) NULL"
# 2440 "coders/meta.c" 3 4
     , "coders/meta.c", 2440, __extension__ __PRETTY_FUNCTION__); }))
# 2440 "coders/meta.c"
                                                ;
      
# 2441 "coders/meta.c" 3 4
     ((void) sizeof ((
# 2441 "coders/meta.c"
     exception->signature == 0xabacadabUL
# 2441 "coders/meta.c" 3 4
...
# 2441 "coders/meta.c"
     "exception->signature == MagickCoreSignature"
# 2441 "coders/meta.c" 3 4
     , "coders/meta.c", 2441, __extension__ __PRETTY_FUNCTION__); }))
# 2441 "coders/meta.c"
                                                        ;
      status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
      if (status == MagickFalse)
