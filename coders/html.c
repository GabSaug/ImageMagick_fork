...
# 127 "coders/html.c"
__attribute__ ((visibility ("default"))) size_t RegisterHTMLImage(void)
{
  MagickInfo
    *entry;
...
# 172 "coders/html.c"
__attribute__ ((visibility ("default"))) void UnregisterHTMLImage(void)
{
...
# 213 "coders/html.c"
    ...
    (c == ')') ? c : 0;
  if (html5 != 0)
    (void) FormatLocaleString(encoding,4096,"%c",html5);
  else
    (void) FormatLocaleString(encoding,4096,"%%%02X",c);
...
# 251 "coders/html.c" 3 4
 , "coders/html.c", 251, __extension__ __PRETTY_FUNCTION__); }))
# 251 "coders/html.c"
                                               ;
  
# 252 "coders/html.c" 3 4
 ((void) sizeof ((
# 252 "coders/html.c"
...
# 252 "coders/html.c" 3 4
 , "coders/html.c", 252, __extension__ __PRETTY_FUNCTION__); }))
# 252 "coders/html.c"
                                                     ;
  
# 253 "coders/html.c" 3 4
 ((void) sizeof ((
# 253 "coders/html.c"
 image != (Image *) 
# 253 "coders/html.c" 3 4
...
# 253 "coders/html.c"
 "image != (Image *) NULL"
# 253 "coders/html.c" 3 4
 , "coders/html.c", 253, __extension__ __PRETTY_FUNCTION__); }))
# 253 "coders/html.c"
                                ;
  
# 254 "coders/html.c" 3 4
 ((void) sizeof ((
# 254 "coders/html.c"
...
# 254 "coders/html.c" 3 4
 , "coders/html.c", 254, __extension__ __PRETTY_FUNCTION__); }))
# 254 "coders/html.c"
                                                ;
  
# 255 "coders/html.c" 3 4
 ((void) sizeof ((
# 255 "coders/html.c"
...
# 255 "coders/html.c" 3 4
 , "coders/html.c", 255, __extension__ __PRETTY_FUNCTION__); }))
# 255 "coders/html.c"
                                            ;
  
# 256 "coders/html.c" 3 4
 ((void) sizeof ((
# 256 "coders/html.c"
...
# 256 "coders/html.c" 3 4
 , "coders/html.c", 256, __extension__ __PRETTY_FUNCTION__); }))
# 256 "coders/html.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/html.c",__func__,(unsigned long) 258,"%s",
      image_info->filename);
  ...
  *url='\0';
  if ((LocaleCompare(image_info->magick,"FTP") == 0) ||
      (LocaleCompare(image_info->magick,"HTTP") == 0))
    {
      ...
      if (p != (char *) 
# 274 "coders/html.c" 3 4
                       ((void *)0)
# 274 "coders/html.c"
                           )
        {
          p++;
          (void) CopyMagickString(url,image_info->magick,4096);
          (void) ConcatenateMagickString(url,":",4096);
          url[strlen(url)+p-image->filename]='\0';
          (void) ConcatenateMagickString(url,image->filename,(size_t)
            (p-image->filename+2));
          (void) CopyMagickString(image->filename,p,4096);
        }
    }
  ...
  (void) CopyMagickString(mapname,basename,4096);
...
# 307 "coders/html.c"
     "exception != (ExceptionInfo *) NULL"
# 307 "coders/html.c" 3 4
     , "coders/html.c", 307, __extension__ __PRETTY_FUNCTION__); }))
# 307 "coders/html.c"
                                                ;
      status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
      if (status == MagickFalse)
...
# 322 "coders/html.c"
      ...
      (void) FormatLocaleString(buffer,4096,"<h1>%s</h1>\n",
        image->filename);
      (void) WriteBlobString(image,buffer);
      (void) WriteBlobString(image,"<div>\n");
      (void) CopyMagickString(filename,image->filename,4096);
      AppendImageFormat("png",filename);
      (void) FormatLocaleString(buffer,4096,"<img usemap=\"#%s\" "
...
# 348 "coders/html.c"
      ...
      (void) FormatLocaleString(buffer,4096,
        "<map id=\"%s\" name=\"%s\">\n",mapname,mapname);
      (void) WriteBlobString(image,buffer);
      (void) FormatLocaleString(buffer,4096,"  <area href=\"%s",
        url);
      (void) WriteBlobString(image,buffer);
      if (image->directory == (char *) 
# 359 "coders/html.c" 3 4
                                      ((void *)0)
# 359 "coders/html.c"
                                          )
        {
        ...
        for (p=image->directory; *p != '\0'; p++)
          if (*p != '\xff')
            ...
            {
              (void) FormatLocaleString(buffer,4096,"\" shape="
      ...
      (void) CopyMagickString(image->magick,"PNG",4096);
      ...
      (void) ConcatenateMagickString(filename,"_map.shtml",4096);
      (void) CopyMagickString(image->filename,filename,4096);
    }
...
# 426 "coders/html.c"
  ...
  (void) FormatLocaleString(buffer,4096,
    "<map id=\"%s\" name=\"%s\">\n",mapname,mapname);
  (void) WriteBlobString(image,buffer);
  (void) FormatLocaleString(buffer,4096,"  <area href=\"%s",url);
  (void) WriteBlobString(image,buffer);
  if (image->directory == (char *) 
# 436 "coders/html.c" 3 4
                                  ((void *)0)
# 436 "coders/html.c"
                                      )
    {
    ...
    for (p=image->directory; *p != '\0'; p++)
      if (*p != '\xff')
        ...
        {
          (void) FormatLocaleString(buffer,4096,"\" shape=\"rect\""
