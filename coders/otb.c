...
# 128 "coders/otb.c" 3 4
 , "coders/otb.c", 128, __extension__ __PRETTY_FUNCTION__); }))
# 128 "coders/otb.c"
                                               ;
  
# 129 "coders/otb.c" 3 4
 ((void) sizeof ((
# 129 "coders/otb.c"
...
# 129 "coders/otb.c" 3 4
 , "coders/otb.c", 129, __extension__ __PRETTY_FUNCTION__); }))
# 129 "coders/otb.c"
                                                     ;
  
# 130 "coders/otb.c" 3 4
 ((void) sizeof ((
# 130 "coders/otb.c"
...
# 130 "coders/otb.c" 3 4
 , "coders/otb.c", 130, __extension__ __PRETTY_FUNCTION__); }))
# 130 "coders/otb.c"
                                            ;
  
# 131 "coders/otb.c" 3 4
 ((void) sizeof ((
# 131 "coders/otb.c"
...
# 131 "coders/otb.c" 3 4
 , "coders/otb.c", 131, __extension__ __PRETTY_FUNCTION__); }))
# 131 "coders/otb.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/otb.c",__func__,(unsigned long) 133,"%s",
      image_info->filename);
...
# 140 "coders/otb.c"
  ...
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/otb.c",__func__,(unsigned long) 157,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 157 "coders/otb.c" 3 4
   ((void *)0)
# 157 "coders/otb.c"
...
# 157 "coders/otb.c"
  ...
  if (depth != 1)
    { (void) ThrowMagickException(exception,"coders/otb.c",__func__,(unsigned long) 160,CoderError,"OnlyLevelZerofilesSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 160 "coders/otb.c" 3 4
   ((void *)0)
# 160 "coders/otb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 160 "coders/otb.c" 3 4
...
# 160 "coders/otb.c"
  ...
  if (AcquireImageColormap(image,2,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/otb.c",__func__,(unsigned long) 162,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 162 "coders/otb.c" 3 4
   ((void *)0)
# 162 "coders/otb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 162 "coders/otb.c" 3 4
      ...
      if (bit == 0)
        {
          ...
          if (byte == 
# 186 "coders/otb.c" 3 4
                     (-1)
# 186 "coders/otb.c"
                        )
            { (void) ThrowMagickException(exception,"coders/otb.c",__func__,(unsigned long) 187,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 187 "coders/otb.c" 3 4
           ((void *)0)
# 187 "coders/otb.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 187 "coders/otb.c" 3 4
...
# 207 "coders/otb.c" 3 4
   (*__errno_location ())
# 207 "coders/otb.c"
   ); (void) ThrowMagickException(exception,"coders/otb.c",__func__,(unsigned long) 207,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 239 "coders/otb.c"
__attribute__ ((visibility ("default"))) size_t RegisterOTBImage(void)
{
  MagickInfo
    *entry;
...
# 271 "coders/otb.c"
__attribute__ ((visibility ("default"))) void UnregisterOTBImage(void)
{
...
# 330 "coders/otb.c"
 "image_info != (const ImageInfo *) NULL"
# 330 "coders/otb.c" 3 4
 , "coders/otb.c", 330, __extension__ __PRETTY_FUNCTION__); }))
# 330 "coders/otb.c"
                                               ;
  
# 331 "coders/otb.c" 3 4
 ((void) sizeof ((
# 331 "coders/otb.c"
 image_info->signature == 0xabacadabUL
# 331 "coders/otb.c" 3 4
...
# 331 "coders/otb.c"
 "image_info->signature == MagickCoreSignature"
# 331 "coders/otb.c" 3 4
 , "coders/otb.c", 331, __extension__ __PRETTY_FUNCTION__); }))
# 331 "coders/otb.c"
                                                     ;
  
# 332 "coders/otb.c" 3 4
 ((void) sizeof ((
# 332 "coders/otb.c"
 image != (Image *) 
# 332 "coders/otb.c" 3 4
...
# 332 "coders/otb.c"
 "image != (Image *) NULL"
# 332 "coders/otb.c" 3 4
 , "coders/otb.c", 332, __extension__ __PRETTY_FUNCTION__); }))
# 332 "coders/otb.c"
                                ;
  
# 333 "coders/otb.c" 3 4
 ((void) sizeof ((
# 333 "coders/otb.c"
...
# 333 "coders/otb.c" 3 4
 , "coders/otb.c", 333, __extension__ __PRETTY_FUNCTION__); }))
# 333 "coders/otb.c"
                                                ;
  
# 334 "coders/otb.c" 3 4
 ((void) sizeof ((
# 334 "coders/otb.c"
 exception != (ExceptionInfo *) 
# 334 "coders/otb.c" 3 4
...
# 334 "coders/otb.c"
 "exception != (ExceptionInfo *) NULL"
# 334 "coders/otb.c" 3 4
 , "coders/otb.c", 334, __extension__ __PRETTY_FUNCTION__); }))
# 334 "coders/otb.c"
                                            ;
  
# 335 "coders/otb.c" 3 4
 ((void) sizeof ((
# 335 "coders/otb.c"
 exception->signature == 0xabacadabUL
# 335 "coders/otb.c" 3 4
...
# 335 "coders/otb.c"
 "exception->signature == MagickCoreSignature"
# 335 "coders/otb.c" 3 4
 , "coders/otb.c", 335, __extension__ __PRETTY_FUNCTION__); }))
# 335 "coders/otb.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/otb.c",__func__,(unsigned long) 337,"%s",image->filename);
  ...
  if ((image->columns >= 256) || (image->rows >= 256))
    info=(unsigned char) ((1) ? (info) | (1L << (4)) : (info) & ~(1L << (4)));
