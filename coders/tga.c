...
# 191 "coders/tga.c" 3 4
 , "coders/tga.c", 191, __extension__ __PRETTY_FUNCTION__); }))
# 191 "coders/tga.c"
                                               ;
  
# 192 "coders/tga.c" 3 4
 ((void) sizeof ((
# 192 "coders/tga.c"
...
# 192 "coders/tga.c" 3 4
 , "coders/tga.c", 192, __extension__ __PRETTY_FUNCTION__); }))
# 192 "coders/tga.c"
                                                     ;
  
# 193 "coders/tga.c" 3 4
 ((void) sizeof ((
# 193 "coders/tga.c"
...
# 193 "coders/tga.c" 3 4
 , "coders/tga.c", 193, __extension__ __PRETTY_FUNCTION__); }))
# 193 "coders/tga.c"
                                            ;
  
# 194 "coders/tga.c" 3 4
 ((void) sizeof ((
# 194 "coders/tga.c"
...
# 194 "coders/tga.c" 3 4
 , "coders/tga.c", 194, __extension__ __PRETTY_FUNCTION__); }))
# 194 "coders/tga.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/tga.c",__func__,(unsigned long) 196,"%s",
      image_info->filename);
...
# 203 "coders/tga.c"
  ...
  if ((count != 1) ||
    ...
    { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 221,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 221 "coders/tga.c" 3 4
   ((void *)0)
# 221 "coders/tga.c"
...
# 221 "coders/tga.c"
  ...
  if (EOFBlob(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 232,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 232 "coders/tga.c" 3 4
   ((void *)0)
# 232 "coders/tga.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 232 "coders/tga.c" 3 4
...
# 232 "coders/tga.c"
  ...
  if ((((tga_info.bits_per_pixel < 1) || (tga_info.bits_per_pixel >= 17)) &&
    ...
    { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 235,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 235 "coders/tga.c" 3 4
   ((void *)0)
# 235 "coders/tga.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 235 "coders/tga.c" 3 4
      ...
      if (tga_info.colormap_type != 0)
      ...
      else
        {
          ...
          if ((MagickSizeType) image->colors > GetBlobSize(image))
            { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 281,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 281 "coders/tga.c" 3 4
           ((void *)0)
# 281 "coders/tga.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 281 "coders/tga.c" 3 4
...
# 281 "coders/tga.c"
          ...
          if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
            { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 284,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 284 "coders/tga.c" 3 4
           ((void *)0)
# 284 "coders/tga.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 284 "coders/tga.c" 3 4
  ...
  if (tga_info.id_length != 0)
    {
      ...
      comment=(char *) 
# 299 "coders/tga.c" 3 4
                      ((void *)0)
# 299 "coders/tga.c"
                          ;
      if (~length >= (4096 -1))
        comment=(char *) AcquireQuantumMemory(length+4096,
          sizeof(*comment));
      if (comment == (char *) 
# 303 "coders/tga.c" 3 4
                             ((void *)0)
# 303 "coders/tga.c"
                                 )
        { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 304,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 304 "coders/tga.c" 3 4
       ((void *)0)
# 304 "coders/tga.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 304 "coders/tga.c" 3 4
  ...
  if (tga_info.colormap_type != 0)
    {
      ...
      if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
        { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 362,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 362 "coders/tga.c" 3 4
       ((void *)0)
# 362 "coders/tga.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 362 "coders/tga.c" 3 4
          ...
          (tga_info.image_type == TGARLEMonochrome))
        {
          if (runlength != 0)
          ...
          else
            {
              ...
              if (count != 1)
                { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 470,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 470 "coders/tga.c" 3 4
               ((void *)0)
# 470 "coders/tga.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 470 "coders/tga.c" 3 4
            ...
            if ((x & 0x07) == 0)
              {
                if (ReadBlob(image,1,pixels) != 1)
                  { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 485,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 485 "coders/tga.c" 3 4
                 ((void *)0)
# 485 "coders/tga.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 485 "coders/tga.c" 3 4
...
# 485 "coders/tga.c"
          ...
          default:
          {
            ...
            if (ReadBlob(image,1,pixels) != 1)
              { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 510,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 510 "coders/tga.c" 3 4
             ((void *)0)
# 510 "coders/tga.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 510 "coders/tga.c" 3 4
...
# 510 "coders/tga.c"
          ...
          case 16:
          {
            ...
            if (ReadBlob(image,2,pixels) != 2)
              { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 534,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 534 "coders/tga.c" 3 4
             ((void *)0)
# 534 "coders/tga.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 534 "coders/tga.c" 3 4
...
# 534 "coders/tga.c"
            ...
            if (image->alpha_trait != UndefinedPixelTrait)
              pixel.alpha=(MagickRealType) ((k & 0x80) == 0 ? (Quantum)
                ((Quantum) 0) : (Quantum) ((Quantum) ((Quantum) 65535.0)));
            if (image->storage_class == PseudoClass)
          ...
          case 24:
          {
            ...
            if (ReadBlob(image,3,pixels) != 3)
              { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 557,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 557 "coders/tga.c" 3 4
             ((void *)0)
# 557 "coders/tga.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 557 "coders/tga.c" 3 4
...
# 557 "coders/tga.c"
          ...
          case 32:
          {
            ...
            if (ReadBlob(image,4,pixels) != 4)
              { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 569,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 569 "coders/tga.c" 3 4
             ((void *)0)
# 569 "coders/tga.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 569 "coders/tga.c" 3 4
...
# 569 "coders/tga.c"
      ...
      if (status == MagickFalse)
        { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 578,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 578 "coders/tga.c" 3 4
       ((void *)0)
# 578 "coders/tga.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 578 "coders/tga.c" 3 4
...
# 608 "coders/tga.c" 3 4
   (*__errno_location ())
# 608 "coders/tga.c"
   ); (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 608,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
  if (SeekBlob(image,-26,
# 610 "coders/tga.c" 3 4
                        2
# 610 "coders/tga.c"
                                ) >= 18)
    {
      ...
      if ((count == 18) && (extension > 3) &&
          ...
          (SeekBlob(image,(MagickOffsetType) extension,
# 626 "coders/tga.c" 3 4
                                                      0
# 626 "coders/tga.c"
                                                              ) == (MagickOffsetType) extension) &&
...
# 681 "coders/tga.c"
__attribute__ ((visibility ("default"))) size_t RegisterTGAImage(void)
{
  MagickInfo
    *entry;
...
# 732 "coders/tga.c"
__attribute__ ((visibility ("default"))) void UnregisterTGAImage(void)
{
  ...
  ExceptionInfo *exception)
{
  ...
  const double
    midpoint = (double) ((Quantum) 65535.0)/2.0;
...
# 852 "coders/tga.c"
 "image_info != (const ImageInfo *) NULL"
# 852 "coders/tga.c" 3 4
 , "coders/tga.c", 852, __extension__ __PRETTY_FUNCTION__); }))
# 852 "coders/tga.c"
                                               ;
  
# 853 "coders/tga.c" 3 4
 ((void) sizeof ((
# 853 "coders/tga.c"
 image_info->signature == 0xabacadabUL
# 853 "coders/tga.c" 3 4
...
# 853 "coders/tga.c"
 "image_info->signature == MagickCoreSignature"
# 853 "coders/tga.c" 3 4
 , "coders/tga.c", 853, __extension__ __PRETTY_FUNCTION__); }))
# 853 "coders/tga.c"
                                                     ;
  
# 854 "coders/tga.c" 3 4
 ((void) sizeof ((
# 854 "coders/tga.c"
 image != (Image *) 
# 854 "coders/tga.c" 3 4
...
# 854 "coders/tga.c"
 "image != (Image *) NULL"
# 854 "coders/tga.c" 3 4
 , "coders/tga.c", 854, __extension__ __PRETTY_FUNCTION__); }))
# 854 "coders/tga.c"
                                ;
  
# 855 "coders/tga.c" 3 4
 ((void) sizeof ((
# 855 "coders/tga.c"
...
# 855 "coders/tga.c" 3 4
 , "coders/tga.c", 855, __extension__ __PRETTY_FUNCTION__); }))
# 855 "coders/tga.c"
                                                ;
  
# 856 "coders/tga.c" 3 4
 ((void) sizeof ((
# 856 "coders/tga.c"
 exception != (ExceptionInfo *) 
# 856 "coders/tga.c" 3 4
...
# 856 "coders/tga.c"
 "exception != (ExceptionInfo *) NULL"
# 856 "coders/tga.c" 3 4
 , "coders/tga.c", 856, __extension__ __PRETTY_FUNCTION__); }))
# 856 "coders/tga.c"
                                            ;
  
# 857 "coders/tga.c" 3 4
 ((void) sizeof ((
# 857 "coders/tga.c"
 exception->signature == 0xabacadabUL
# 857 "coders/tga.c" 3 4
...
# 857 "coders/tga.c"
 "exception->signature == MagickCoreSignature"
# 857 "coders/tga.c" 3 4
 , "coders/tga.c", 857, __extension__ __PRETTY_FUNCTION__); }))
# 857 "coders/tga.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/tga.c",__func__,(unsigned long) 859,"%s",image->filename);
  ...
  if ((image->columns > 65535L) || (image->rows > 65535L))
    { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 867,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 867 "coders/tga.c" 3 4
   ((void *)0)
# 867 "coders/tga.c"
...
# 876 "coders/tga.c" 3 4
                               ((void *)0)
# 876 "coders/tga.c"
                                   )
    tga_info.id_length=(unsigned char) (((strlen(comment)) < (255)) ? (strlen(comment)) : (255));
  tga_info.colormap_type=0;
  ...
  if ((image->columns > 65535) || (image->rows > 65535))
    { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 942,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 942 "coders/tga.c" 3 4
   ((void *)0)
# 942 "coders/tga.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  ...
  if (tga_info.colormap_type != 0)
    {
      ...
      if (targa_colormap == (unsigned char *) 
# 972 "coders/tga.c" 3 4
                                             ((void *)0)
# 972 "coders/tga.c"
                                                 )
        { (void) ThrowMagickException(exception,"coders/tga.c",__func__,(unsigned long) 973,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 973 "coders/tga.c" 3 4
       ((void *)0)
# 973 "coders/tga.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      q=targa_colormap;
