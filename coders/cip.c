...
# 96 "coders/cip.c"
__attribute__ ((visibility ("default"))) size_t RegisterCIPImage(void)
{
  MagickInfo
    *entry;
...
# 127 "coders/cip.c"
__attribute__ ((visibility ("default"))) void UnregisterCIPImage(void)
{
...
# 188 "coders/cip.c" 3 4
 , "coders/cip.c", 188, __extension__ __PRETTY_FUNCTION__); }))
# 188 "coders/cip.c"
                                               ;
  
# 189 "coders/cip.c" 3 4
 ((void) sizeof ((
# 189 "coders/cip.c"
...
# 189 "coders/cip.c" 3 4
 , "coders/cip.c", 189, __extension__ __PRETTY_FUNCTION__); }))
# 189 "coders/cip.c"
                                                     ;
  
# 190 "coders/cip.c" 3 4
 ((void) sizeof ((
# 190 "coders/cip.c"
 image != (Image *) 
# 190 "coders/cip.c" 3 4
...
# 190 "coders/cip.c"
 "image != (Image *) NULL"
# 190 "coders/cip.c" 3 4
 , "coders/cip.c", 190, __extension__ __PRETTY_FUNCTION__); }))
# 190 "coders/cip.c"
                                ;
  
# 191 "coders/cip.c" 3 4
 ((void) sizeof ((
# 191 "coders/cip.c"
...
# 191 "coders/cip.c" 3 4
 , "coders/cip.c", 191, __extension__ __PRETTY_FUNCTION__); }))
# 191 "coders/cip.c"
                                                ;
  
# 192 "coders/cip.c" 3 4
 ((void) sizeof ((
# 192 "coders/cip.c"
...
# 192 "coders/cip.c" 3 4
 , "coders/cip.c", 192, __extension__ __PRETTY_FUNCTION__); }))
# 192 "coders/cip.c"
                                            ;
  
# 193 "coders/cip.c" 3 4
 ((void) sizeof ((
# 193 "coders/cip.c"
...
# 193 "coders/cip.c" 3 4
 , "coders/cip.c", 193, __extension__ __PRETTY_FUNCTION__); }))
# 193 "coders/cip.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/cip.c",__func__,(unsigned long) 195,"%s",image->filename);
  ...
  if (value != (const char *) 
# 201 "coders/cip.c" 3 4
                             ((void *)0)
# 201 "coders/cip.c"
                                 )
    (void) FormatLocaleString(buffer,4096,"<Title>%s</Title>\n",
      value);
  else
    {
      char
  ...
  (void) WriteBlobString(image,buffer);
  (void) FormatLocaleString(buffer,4096,"<Width>%.20g</Width>\n",
    (double) (image->columns+(image->columns % 2)));
  (void) WriteBlobString(image,buffer);
  (void) FormatLocaleString(buffer,4096,"<Height>%.20g</Height>\n",
    (double) image->rows);
  (void) WriteBlobString(image,buffer);
  (void) FormatLocaleString(buffer,4096,"<Depth>2</Depth>\n");
  (void) WriteBlobString(image,buffer);
...
# 234 "coders/cip.c"
    ...
    {
      byte=(unsigned char)
        ((((size_t) (3*ClampToQuantum(GetPixelLuma(image,p+3*GetPixelChannels(image)))/((Quantum) 65535.0)) & 0x03) << 6) |
         (((size_t) (3*ClampToQuantum(GetPixelLuma(image,p+2*GetPixelChannels(image)))/((Quantum) 65535.0)) & 0x03) << 4) |
         (((size_t) (3*ClampToQuantum(GetPixelLuma(image,p+1*GetPixelChannels(image)))/((Quantum) 65535.0)) & 0x03) << 2) |
         (((size_t) (3*ClampToQuantum(GetPixelLuma(image,p+0*GetPixelChannels(image)))/((Quantum) 65535.0)) & 0x03) << 0));
      (void) FormatLocaleString(buffer,4096,"%02x",byte);
      (void) WriteBlobString(image,buffer);
          ...
          switch (i)
          {
            case 0:
            {
              byte|=(unsigned char) (((size_t) (3*ClampToQuantum(GetPixelLuma(
                image,p+(((i) < (3)) ? (i) : (3))*(ssize_t) GetPixelChannels(image)))/
                ((Quantum) 65535.0)) & 0x03) << 6);
              break;
            }
            case 1:
            {
              byte|=(unsigned char) (((size_t) (3*ClampToQuantum(GetPixelLuma(
                image,p+(((i) < (2)) ? (i) : (2))*(ssize_t) GetPixelChannels(image)))/
                ((Quantum) 65535.0)) & 0x03) << 4);
              break;
            }
            case 2:
            {
              byte|=(unsigned char) (((size_t) (3*ClampToQuantum(GetPixelLuma(
                image,p+(((i) < (1)) ? (i) : (1))*(ssize_t) GetPixelChannels(image)))/
                ((Quantum) 65535.0)) & 0x03) << 2);
              break;
            }
            case 3:
            {
              byte|=(unsigned char) (((size_t) (3*ClampToQuantum(GetPixelLuma(
                image,p+(((i) < (0)) ? (i) : (0))*(ssize_t) GetPixelChannels(image)))/
                ((Quantum) 65535.0)) & 0x03) << 0);
              break;
            }
          }
        }
