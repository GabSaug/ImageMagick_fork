...
# 130 "coders/ps3.c"
__attribute__ ((visibility ("default"))) size_t RegisterPS3Image(void)
{
  MagickInfo
    *entry;
...
# 169 "coders/ps3.c"
__attribute__ ((visibility ("default"))) void UnregisterPS3Image(void)
{
...
# 261 "coders/ps3.c"
 "image != (Image *) NULL"
# 261 "coders/ps3.c" 3 4
 , "coders/ps3.c", 261, __extension__ __PRETTY_FUNCTION__); }))
# 261 "coders/ps3.c"
                                ;
  
# 262 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 262 "coders/ps3.c"
...
# 262 "coders/ps3.c" 3 4
 , "coders/ps3.c", 262, __extension__ __PRETTY_FUNCTION__); }))
# 262 "coders/ps3.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ps3.c",__func__,(unsigned long) 264,"%s",image->filename);
  status=MagickTrue;
...
# 269 "coders/ps3.c" 3 4
                                   ((void *)0)
# 269 "coders/ps3.c"
                                       )
    { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 270,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 270 "coders/ps3.c" 3 4
   ((void *)0)
# 270 "coders/ps3.c"
...
# 334 "coders/ps3.c"
 "image != (Image *) NULL"
# 334 "coders/ps3.c" 3 4
 , "coders/ps3.c", 334, __extension__ __PRETTY_FUNCTION__); }))
# 334 "coders/ps3.c"
                                ;
  
# 335 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 335 "coders/ps3.c"
 image->signature == 0xabacadabUL
# 335 "coders/ps3.c" 3 4
...
# 335 "coders/ps3.c"
 "image->signature == MagickCoreSignature"
# 335 "coders/ps3.c" 3 4
 , "coders/ps3.c", 335, __extension__ __PRETTY_FUNCTION__); }))
# 335 "coders/ps3.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ps3.c",__func__,(unsigned long) 337,"%s",image->filename);
  status=MagickTrue;
  ...
  *pixel_info=AcquireVirtualMemory(*length,sizeof(*q));
  if (*pixel_info == (MemoryInfo *) 
# 343 "coders/ps3.c" 3 4
                                   ((void *)0)
# 343 "coders/ps3.c"
                                       )
    { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 344,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 344 "coders/ps3.c" 3 4
   ((void *)0)
# 344 "coders/ps3.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  q=(unsigned char *) GetVirtualMemoryBlob(*pixel_info);
...
# 403 "coders/ps3.c"
 "image != (Image *) NULL"
# 403 "coders/ps3.c" 3 4
 , "coders/ps3.c", 403, __extension__ __PRETTY_FUNCTION__); }))
# 403 "coders/ps3.c"
                                ;
  
# 404 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 404 "coders/ps3.c"
 image->signature == 0xabacadabUL
# 404 "coders/ps3.c" 3 4
...
# 404 "coders/ps3.c"
 "image->signature == MagickCoreSignature"
# 404 "coders/ps3.c" 3 4
 , "coders/ps3.c", 404, __extension__ __PRETTY_FUNCTION__); }))
# 404 "coders/ps3.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ps3.c",__func__,(unsigned long) 406,"%s",image->filename);
  status=MagickTrue;
  *length=(size_t) image->columns*image->rows;
  *pixel_info=AcquireVirtualMemory(*length,sizeof(*q));
  if (*pixel_info == (MemoryInfo *) 
# 410 "coders/ps3.c" 3 4
                                   ((void *)0)
# 410 "coders/ps3.c"
                                       )
    { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 411,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 411 "coders/ps3.c" 3 4
   ((void *)0)
# 411 "coders/ps3.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  q=(unsigned char *) GetVirtualMemoryBlob(*pixel_info);
...
# 465 "coders/ps3.c" 3 4
 , "coders/ps3.c", 465, __extension__ __PRETTY_FUNCTION__); }))
# 465 "coders/ps3.c"
                                         ;
  
# 466 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 466 "coders/ps3.c"
...
# 466 "coders/ps3.c" 3 4
 , "coders/ps3.c", 466, __extension__ __PRETTY_FUNCTION__); }))
# 466 "coders/ps3.c"
                                                     ;
  
# 467 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 467 "coders/ps3.c"
 image != (Image *) 
# 467 "coders/ps3.c" 3 4
...
# 467 "coders/ps3.c"
 "image != (Image *) NULL"
# 467 "coders/ps3.c" 3 4
 , "coders/ps3.c", 467, __extension__ __PRETTY_FUNCTION__); }))
# 467 "coders/ps3.c"
                                ;
  
# 468 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 468 "coders/ps3.c"
 image->signature == 0xabacadabUL
# 468 "coders/ps3.c" 3 4
...
# 468 "coders/ps3.c"
 "image->signature == MagickCoreSignature"
# 468 "coders/ps3.c" 3 4
 , "coders/ps3.c", 468, __extension__ __PRETTY_FUNCTION__); }))
# 468 "coders/ps3.c"
                                                ;
  
# 469 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 469 "coders/ps3.c"
...
# 469 "coders/ps3.c"
 "image->alpha_trait != UndefinedPixelTrait"
# 469 "coders/ps3.c" 3 4
 , "coders/ps3.c", 469, __extension__ __PRETTY_FUNCTION__); }))
# 469 "coders/ps3.c"
                                                  ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ps3.c",__func__,(unsigned long) 471,"%s",image->filename);
  status=MagickTrue;
  ...
  if (start < 0)
    { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 478,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 478 "coders/ps3.c" 3 4
   ((void *)0)
# 478 "coders/ps3.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  ...
  stop=TellBlob(image);
  if (stop < 0)
    { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 485,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 485 "coders/ps3.c" 3 4
   ((void *)0)
# 485 "coders/ps3.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  ...
  if (mask_image == (Image *) 
# 537 "coders/ps3.c" 3 4
                             ((void *)0)
# 537 "coders/ps3.c"
                                 )
    { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 538,CoderError,exception->reason, "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 538 "coders/ps3.c" 3 4
   ((void *)0)
# 538 "coders/ps3.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
...
# 542 "coders/ps3.c"
  ...
  stop=TellBlob(image);
  if (stop < 0)
    { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 610,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 610 "coders/ps3.c" 3 4
   ((void *)0)
# 610 "coders/ps3.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  offset=SeekBlob(image,start,
# 611 "coders/ps3.c" 3 4
                             0
# 611 "coders/ps3.c"
                                     );
  if (offset < 0)
    { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 613,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 613 "coders/ps3.c" 3 4
   ((void *)0)
# 613 "coders/ps3.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  (void) FormatLocaleString(buffer,4096,
  ...
  (void) WriteBlobString(image,buffer);
  offset=SeekBlob(image,stop,
# 618 "coders/ps3.c" 3 4
                            0
# 618 "coders/ps3.c"
                                    );
  if (offset < 0)
    { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 620,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 620 "coders/ps3.c" 3 4
   ((void *)0)
# 620 "coders/ps3.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
...
# 883 "coders/ps3.c" 3 4
 , "coders/ps3.c", 883, __extension__ __PRETTY_FUNCTION__); }))
# 883 "coders/ps3.c"
                                               ;
  
# 884 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 884 "coders/ps3.c"
 image_info->signature == 0xabacadabUL
# 884 "coders/ps3.c" 3 4
...
# 884 "coders/ps3.c"
 "image_info->signature == MagickCoreSignature"
# 884 "coders/ps3.c" 3 4
 , "coders/ps3.c", 884, __extension__ __PRETTY_FUNCTION__); }))
# 884 "coders/ps3.c"
                                                     ;
  
# 885 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 885 "coders/ps3.c"
 image != (Image *) 
# 885 "coders/ps3.c" 3 4
...
# 885 "coders/ps3.c"
 "image != (Image *) NULL"
# 885 "coders/ps3.c" 3 4
 , "coders/ps3.c", 885, __extension__ __PRETTY_FUNCTION__); }))
# 885 "coders/ps3.c"
                                ;
  
# 886 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 886 "coders/ps3.c"
 image->signature == 0xabacadabUL
# 886 "coders/ps3.c" 3 4
...
# 886 "coders/ps3.c"
 "image->signature == MagickCoreSignature"
# 886 "coders/ps3.c" 3 4
 , "coders/ps3.c", 886, __extension__ __PRETTY_FUNCTION__); }))
# 886 "coders/ps3.c"
                                                ;
  
# 887 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 887 "coders/ps3.c"
...
# 887 "coders/ps3.c" 3 4
 , "coders/ps3.c", 887, __extension__ __PRETTY_FUNCTION__); }))
# 887 "coders/ps3.c"
                                            ;
  
# 888 "coders/ps3.c" 3 4
 ((void) sizeof ((
# 888 "coders/ps3.c"
...
# 888 "coders/ps3.c" 3 4
 , "coders/ps3.c", 888, __extension__ __PRETTY_FUNCTION__); }))
# 888 "coders/ps3.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ps3.c",__func__,(unsigned long) 890,"%s",image->filename);
  ...
  switch (compression)
  {
    ...
    {
      compression=RLECompression;
      (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 911,
...
# 955 "coders/ps3.c"
    ...
    (void) FormatLocaleString(page_geometry,4096,"%.20gx%.20g",
      (double) image->columns,(double) image->rows);
    if (image_info->page != (char *) 
# 972 "coders/ps3.c" 3 4
                                    ((void *)0)
# 972 "coders/ps3.c"
                                        )
      (void) CopyMagickString(page_geometry,image_info->page,4096);
    else
      if ((image->page.width != 0) && (image->page.height != 0))
        (void) FormatLocaleString(page_geometry,4096,
          "%.20gx%.20g%+.20g%+.20g",(double) image->page.width,(double)
          image->page.height,(double) image->page.x,(double) image->page.y);
      else
        if ((image->gravity != UndefinedGravity) &&
            (LocaleCompare(image_info->magick,"PS") == 0))
          (void) CopyMagickString(page_geometry,"612x792",
            4096);
    (void) ConcatenateMagickString(page_geometry,">",4096);
    ...
    if (page == 1)
      {
        ...
        (void) WriteBlobString(image,buffer);
        (void) FormatLocaleString(buffer,4096,"%%%%Title: %s\n",
          image->filename);
        (void) WriteBlobString(image,buffer);
        timer=GetMagickTime();
...
# 1095 "coders/ps3.c"
    ...
    (void) FormatLocaleString(buffer,4096,"%%%%Page: 1 %.20g\n",
      (double) page);
    (void) WriteBlobString(image,buffer);
...
# 1160 "coders/ps3.c"
    ...
    start=TellBlob(image);
    if (start < 0)
      { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 1184,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1184 "coders/ps3.c" 3 4
     ((void *)0)
# 1184 "coders/ps3.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    (void) FormatLocaleString(buffer,4096,
    ...
    stop=TellBlob(image);
    if (stop < 0)
      { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 1191,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1191 "coders/ps3.c" 3 4
     ((void *)0)
# 1191 "coders/ps3.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    ...
    labels=(char **) 
# 1202 "coders/ps3.c" 3 4
                    ((void *)0)
# 1202 "coders/ps3.c"
                        ;
    value=GetImageProperty(image,"label",exception);
    if (value != (const char *) 
# 1204 "coders/ps3.c" 3 4
                               ((void *)0)
# 1204 "coders/ps3.c"
                                   )
      labels=StringToList(value);
    if (labels != (char **) 
# 1206 "coders/ps3.c" 3 4
                           ((void *)0)
# 1206 "coders/ps3.c"
                               )
      {
        for (i=0; labels[i] != (char *) 
# 1208 "coders/ps3.c" 3 4
                                       ((void *)0)
# 1208 "coders/ps3.c"
                                           ; i++)
        {
    ...
    (void) WriteBlobString(image,((option != (const char *) 
# 1257 "coders/ps3.c" 3 4
                                                           ((void *)0)
# 1257 "coders/ps3.c"
                                                               ) &&
...
# 1263 "coders/ps3.c"
    ...
    if ((image_info->type != TrueColorType) &&
        ...
        (is_gray != MagickFalse))
      {
        ...
        switch (compression)
        {
          ...
          case JPEGCompression:
          {
            (void) WriteBlobString(image,"2""\n");
            break;
          }
          case LZWCompression:
          {
            (void) WriteBlobString(image,"3""\n");
            break;
          }
          case RLECompression:
          {
            (void) WriteBlobString(image,"4""\n");
            break;
          }
          case ZipCompression:
          {
            (void) WriteBlobString(image,"5""\n");
            break;
          }
        }
        ...
        (void) FormatLocaleString(buffer,4096,"%d\n",
    ...
    stop=TellBlob(image);
    if (stop < 0)
      { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 1578,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1578 "coders/ps3.c" 3 4
     ((void *)0)
# 1578 "coders/ps3.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    offset=SeekBlob(image,start,
# 1579 "coders/ps3.c" 3 4
                               0
# 1579 "coders/ps3.c"
                                       );
    if (offset < 0)
      { (void) ThrowMagickException(exception,"coders/ps3.c",__func__,(unsigned long) 1581,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1581 "coders/ps3.c" 3 4
     ((void *)0)
# 1581 "coders/ps3.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    (void) FormatLocaleString(buffer,4096,
