...
# 167 "coders/pgx.c" 3 4
 , "coders/pgx.c", 167, __extension__ __PRETTY_FUNCTION__); }))
# 167 "coders/pgx.c"
                                               ;
  
# 168 "coders/pgx.c" 3 4
 ((void) sizeof ((
# 168 "coders/pgx.c"
...
# 168 "coders/pgx.c" 3 4
 , "coders/pgx.c", 168, __extension__ __PRETTY_FUNCTION__); }))
# 168 "coders/pgx.c"
                                                     ;
  
# 169 "coders/pgx.c" 3 4
 ((void) sizeof ((
# 169 "coders/pgx.c"
...
# 169 "coders/pgx.c" 3 4
 , "coders/pgx.c", 169, __extension__ __PRETTY_FUNCTION__); }))
# 169 "coders/pgx.c"
                                            ;
  
# 170 "coders/pgx.c" 3 4
 ((void) sizeof ((
# 170 "coders/pgx.c"
...
# 170 "coders/pgx.c" 3 4
 , "coders/pgx.c", 170, __extension__ __PRETTY_FUNCTION__); }))
# 170 "coders/pgx.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pgx.c",__func__,(unsigned long) 172,"%s",
      image_info->filename);
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 179 "coders/pgx.c" 3 4
                      ((void *)0)
# 179 "coders/pgx.c"
                          );
    }
  if (ReadBlobString(image,buffer) == (char *) 
# 181 "coders/pgx.c" 3 4
                                              ((void *)0)
# 181 "coders/pgx.c"
                                                  )
    { (void) ThrowMagickException(exception,"coders/pgx.c",__func__,(unsigned long) 182,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 182 "coders/pgx.c" 3 4
   ((void *)0)
# 182 "coders/pgx.c"
...
# 182 "coders/pgx.c"
  ...
  if (count != 8)
    { (void) ThrowMagickException(exception,"coders/pgx.c",__func__,(unsigned long) 186,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 186 "coders/pgx.c" 3 4
   ((void *)0)
# 186 "coders/pgx.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 186 "coders/pgx.c" 3 4
...
# 186 "coders/pgx.c"
  ...
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/pgx.c",__func__,(unsigned long) 193,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 193 "coders/pgx.c" 3 4
   ((void *)0)
# 193 "coders/pgx.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 193 "coders/pgx.c" 3 4
...
# 207 "coders/pgx.c" 3 4
                                     ((void *)0)
# 207 "coders/pgx.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/pgx.c",__func__,(unsigned long) 208,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 208 "coders/pgx.c" 3 4
   ((void *)0)
# 208 "coders/pgx.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 208 "coders/pgx.c" 3 4
...
# 235 "coders/pgx.c" 3 4
   (*__errno_location ())
# 235 "coders/pgx.c"
   ); (void) ThrowMagickException(exception,"coders/pgx.c",__func__,(unsigned long) 235,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 267 "coders/pgx.c"
__attribute__ ((visibility ("default"))) size_t RegisterPGXImage(void)
{
  MagickInfo
    *entry;
...
# 301 "coders/pgx.c"
__attribute__ ((visibility ("default"))) void UnregisterPGXImage(void)
{
...
# 361 "coders/pgx.c"
 "image_info != (const ImageInfo *) NULL"
# 361 "coders/pgx.c" 3 4
 , "coders/pgx.c", 361, __extension__ __PRETTY_FUNCTION__); }))
# 361 "coders/pgx.c"
                                               ;
  
# 362 "coders/pgx.c" 3 4
 ((void) sizeof ((
# 362 "coders/pgx.c"
 image_info->signature == 0xabacadabUL
# 362 "coders/pgx.c" 3 4
...
# 362 "coders/pgx.c"
 "image_info->signature == MagickCoreSignature"
# 362 "coders/pgx.c" 3 4
 , "coders/pgx.c", 362, __extension__ __PRETTY_FUNCTION__); }))
# 362 "coders/pgx.c"
                                                     ;
  
# 363 "coders/pgx.c" 3 4
 ((void) sizeof ((
# 363 "coders/pgx.c"
 image != (Image *) 
# 363 "coders/pgx.c" 3 4
...
# 363 "coders/pgx.c"
 "image != (Image *) NULL"
# 363 "coders/pgx.c" 3 4
 , "coders/pgx.c", 363, __extension__ __PRETTY_FUNCTION__); }))
# 363 "coders/pgx.c"
                                ;
  
# 364 "coders/pgx.c" 3 4
 ((void) sizeof ((
# 364 "coders/pgx.c"
...
# 364 "coders/pgx.c" 3 4
 , "coders/pgx.c", 364, __extension__ __PRETTY_FUNCTION__); }))
# 364 "coders/pgx.c"
                                                ;
  
# 365 "coders/pgx.c" 3 4
 ((void) sizeof ((
# 365 "coders/pgx.c"
 exception != (ExceptionInfo *) 
# 365 "coders/pgx.c" 3 4
...
# 365 "coders/pgx.c"
 "exception != (ExceptionInfo *) NULL"
# 365 "coders/pgx.c" 3 4
 , "coders/pgx.c", 365, __extension__ __PRETTY_FUNCTION__); }))
# 365 "coders/pgx.c"
                                            ;
  
# 366 "coders/pgx.c" 3 4
 ((void) sizeof ((
# 366 "coders/pgx.c"
 exception->signature == 0xabacadabUL
# 366 "coders/pgx.c" 3 4
...
# 366 "coders/pgx.c"
 "exception->signature == MagickCoreSignature"
# 366 "coders/pgx.c" 3 4
 , "coders/pgx.c", 366, __extension__ __PRETTY_FUNCTION__); }))
# 366 "coders/pgx.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pgx.c",__func__,(unsigned long) 368,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  (void) FormatLocaleString(buffer,4096,"PG ML + %g %g %g\n",
  ...
  quantum_info=AcquireQuantumInfo(image_info,image);
  if (quantum_info == (QuantumInfo *) 
# 378 "coders/pgx.c" 3 4
                                     ((void *)0)
# 378 "coders/pgx.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/pgx.c",__func__,(unsigned long) 379,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 379 "coders/pgx.c" 3 4
   ((void *)0)
# 379 "coders/pgx.c"
...
# 386 "coders/pgx.c"
  ...
  if (y < (ssize_t) image->rows)
    { (void) ThrowMagickException(exception,"coders/pgx.c",__func__,(unsigned long) 399,CorruptImageError,"UnableToWriteImageData", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 399 "coders/pgx.c" 3 4
   ((void *)0)
# 399 "coders/pgx.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  if (CloseBlob(image) == MagickFalse)
