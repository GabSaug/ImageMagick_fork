...
# 201 "coders/pcl.c" 3 4
 , "coders/pcl.c", 201, __extension__ __PRETTY_FUNCTION__); }))
# 201 "coders/pcl.c"
                                               ;
  
# 202 "coders/pcl.c" 3 4
 ((void) sizeof ((
# 202 "coders/pcl.c"
...
# 202 "coders/pcl.c" 3 4
 , "coders/pcl.c", 202, __extension__ __PRETTY_FUNCTION__); }))
# 202 "coders/pcl.c"
                                                     ;
  
# 203 "coders/pcl.c" 3 4
 ((void) sizeof ((
# 203 "coders/pcl.c"
...
# 203 "coders/pcl.c" 3 4
 , "coders/pcl.c", 203, __extension__ __PRETTY_FUNCTION__); }))
# 203 "coders/pcl.c"
                                            ;
  
# 204 "coders/pcl.c" 3 4
 ((void) sizeof ((
# 204 "coders/pcl.c"
...
# 204 "coders/pcl.c" 3 4
 , "coders/pcl.c", 204, __extension__ __PRETTY_FUNCTION__); }))
# 204 "coders/pcl.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pcl.c",__func__,(unsigned long) 206,"%s",
      image_info->filename);
...
# 221 "coders/pcl.c" 3 4
     (*__errno_location ())
# 221 "coders/pcl.c"
     ); (void) ThrowMagickException(exception,"coders/pcl.c",__func__,(unsigned long) 221,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",image_info->filename,file_message); file_message=DestroyString(file_message); }
                             ;
      image=DestroyImageList(image);
      return((Image *) 
# 224 "coders/pcl.c" 3 4
                      ((void *)0)
# 224 "coders/pcl.c"
                          );
    }
...
# 256 "coders/pcl.c" 3 4
                                  (-1)
# 256 "coders/pcl.c"
                                     ; c=ReadBlobByte(image))
  {
    if (image_info->page != (char *) 
# 258 "coders/pcl.c" 3 4
                                    ((void *)0)
# 258 "coders/pcl.c"
                                        )
      continue;
...
# 314 "coders/pcl.c"
  ...
  if (image_info->monochrome != MagickFalse)
    delegate_info=GetDelegateInfo("pcl:mono",(char *) 
# 319 "coders/pcl.c" 3 4
                                                     ((void *)0)
# 319 "coders/pcl.c"
                                                         ,exception);
  else
     if (cmyk != MagickFalse)
       delegate_info=GetDelegateInfo("pcl:cmyk",(char *) 
# 322 "coders/pcl.c" 3 4
                                                        ((void *)0)
# 322 "coders/pcl.c"
                                                            ,exception);
     else
       delegate_info=GetDelegateInfo("pcl:color",(char *) 
# 324 "coders/pcl.c" 3 4
                                                         ((void *)0)
# 324 "coders/pcl.c"
                                                             ,exception);
  if (delegate_info == (const DelegateInfo *) 
# 325 "coders/pcl.c" 3 4
                                             ((void *)0)
# 325 "coders/pcl.c"
                                                 )
    {
...
# 332 "coders/pcl.c"
  ...
  (void) FormatLocaleString(options,4096,"-g%.20gx%.20g ",(double)
    page.width,(double) page.height);
  image=DestroyImage(image);
  ...
  if (read_info->number_scenes != 0)
    {
      if (read_info->number_scenes != 1)
        (void) FormatLocaleString(options,4096,"-dLastPage=%.20g",
          (double) (read_info->scene+read_info->number_scenes));
      else
        (void) FormatLocaleString(options,4096,
          "-dFirstPage=%.20g -dLastPage=%.20g",(double) read_info->scene+1,
          (double) (read_info->scene+read_info->number_scenes));
      read_info->number_scenes=0;
      if (read_info->scenes != (char *) 
# 357 "coders/pcl.c" 3 4
                                       ((void *)0)
# 357 "coders/pcl.c"
                                           )
        *read_info->scenes='\0';
  ...
  if (exit_code != 0)
    {
      ...
      { (void) ThrowMagickException(exception,"coders/pcl.c",__func__,(unsigned long) 374,DelegateError,"PCLDelegateFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 374 "coders/pcl.c" 3 4
     ((void *)0)
# 374 "coders/pcl.c"
...
# 374 "coders/pcl.c"
  ...
  read_info=DestroyImageInfo(read_info);
  if (image == (Image *) 
# 380 "coders/pcl.c" 3 4
                        ((void *)0)
# 380 "coders/pcl.c"
                            )
    { (void) ThrowMagickException(exception,"coders/pcl.c",__func__,(unsigned long) 381,DelegateError,"PCLDelegateFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 381 "coders/pcl.c" 3 4
   ((void *)0)
# 381 "coders/pcl.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 381 "coders/pcl.c" 3 4
...
# 388 "coders/pcl.c"
  ...
  do
  {
    ...
    if (next_image != (Image *) 
# 406 "coders/pcl.c" 3 4
                               ((void *)0)
# 406 "coders/pcl.c"
                                   )
      image=next_image;
  } while (next_image != (Image *) 
# 408 "coders/pcl.c" 3 4
                                  ((void *)0)
# 408 "coders/pcl.c"
                                      );
...
# 435 "coders/pcl.c"
__attribute__ ((visibility ("default"))) size_t RegisterPCLImage(void)
{
  MagickInfo
    *entry;
...
# 469 "coders/pcl.c"
__attribute__ ((visibility ("default"))) void UnregisterPCLImage(void)
{
...
# 718 "coders/pcl.c"
 "image_info != (const ImageInfo *) NULL"
# 718 "coders/pcl.c" 3 4
 , "coders/pcl.c", 718, __extension__ __PRETTY_FUNCTION__); }))
# 718 "coders/pcl.c"
                                               ;
  
# 719 "coders/pcl.c" 3 4
 ((void) sizeof ((
# 719 "coders/pcl.c"
 image_info->signature == 0xabacadabUL
# 719 "coders/pcl.c" 3 4
...
# 719 "coders/pcl.c"
 "image_info->signature == MagickCoreSignature"
# 719 "coders/pcl.c" 3 4
 , "coders/pcl.c", 719, __extension__ __PRETTY_FUNCTION__); }))
# 719 "coders/pcl.c"
                                                     ;
  
# 720 "coders/pcl.c" 3 4
 ((void) sizeof ((
# 720 "coders/pcl.c"
 image != (Image *) 
# 720 "coders/pcl.c" 3 4
...
# 720 "coders/pcl.c"
 "image != (Image *) NULL"
# 720 "coders/pcl.c" 3 4
 , "coders/pcl.c", 720, __extension__ __PRETTY_FUNCTION__); }))
# 720 "coders/pcl.c"
                                ;
  
# 721 "coders/pcl.c" 3 4
 ((void) sizeof ((
# 721 "coders/pcl.c"
...
# 721 "coders/pcl.c" 3 4
 , "coders/pcl.c", 721, __extension__ __PRETTY_FUNCTION__); }))
# 721 "coders/pcl.c"
                                                ;
  
# 722 "coders/pcl.c" 3 4
 ((void) sizeof ((
# 722 "coders/pcl.c"
 exception != (ExceptionInfo *) 
# 722 "coders/pcl.c" 3 4
...
# 722 "coders/pcl.c"
 "exception != (ExceptionInfo *) NULL"
# 722 "coders/pcl.c" 3 4
 , "coders/pcl.c", 722, __extension__ __PRETTY_FUNCTION__); }))
# 722 "coders/pcl.c"
                                            ;
  
# 723 "coders/pcl.c" 3 4
 ((void) sizeof ((
# 723 "coders/pcl.c"
 exception->signature == 0xabacadabUL
# 723 "coders/pcl.c" 3 4
...
# 723 "coders/pcl.c"
 "exception->signature == MagickCoreSignature"
# 723 "coders/pcl.c" 3 4
 , "coders/pcl.c", 723, __extension__ __PRETTY_FUNCTION__); }))
# 723 "coders/pcl.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pcl.c",__func__,(unsigned long) 725,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  density=75;
  if (image_info->density != (char *) 
# 730 "coders/pcl.c" 3 4
                                     ((void *)0)
# 730 "coders/pcl.c"
                                         )
    {
  ...
  do
  {
    ...
    (void) WriteBlobString(image,"\033*r3F");
    (void) FormatLocaleString(buffer,4096,"\033*r%.20gs%.20gT",
      (double) image->columns,(double) image->rows);
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,"\033*t%.20gR",(double)
      density);
    (void) WriteBlobString(image,buffer);
    (void) WriteBlobString(image,"\033&l0E");
    if (SetImageMonochrome(image,exception) != MagickFalse)
      ...
      if (image->storage_class == DirectClass)
      ...
      else
        {
          ...
          {
            (void) FormatLocaleString(buffer,4096,"\033*v%.20gI",
              (double) i);
            (void) WriteBlobString(image,buffer);
          }
        }
    ...
    if (IsStringTrue(option) != MagickFalse)
      ...
      (void) WriteBlobString(image,"\033*r1A");
    (void) WriteBlobString(image,"\033*b0Y");
...
# 816 "coders/pcl.c" 3 4
                                   ((void *)0)
# 816 "coders/pcl.c"
                                       )
      { (void) ThrowMagickException(exception,"coders/pcl.c",__func__,(unsigned long) 817,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 817 "coders/pcl.c" 3 4
     ((void *)0)
# 817 "coders/pcl.c"
...
# 819 "coders/pcl.c" 3 4
                                     ((void *)0)
# 819 "coders/pcl.c"
                                         ;
    previous_pixels=(unsigned char *) 
# 820 "coders/pcl.c" 3 4
                                     ((void *)0)
# 820 "coders/pcl.c"
                                         ;
    ...
    switch (compression)
    {
      case NoCompression:
      {
        (void) FormatLocaleString(buffer,4096,"\033*b0M");
        (void) WriteBlobString(image,buffer);
        break;
      }
      case RLECompression:
...
# 837 "coders/pcl.c" 3 4
                                                ((void *)0)
# 837 "coders/pcl.c"
                                                    )
          {
            pixels=(unsigned char *) RelinquishMagickMemory(pixels);
            { (void) ThrowMagickException(exception,"coders/pcl.c",__func__,(unsigned long) 840,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 840 "coders/pcl.c" 3 4
           ((void *)0)
# 840 "coders/pcl.c"
           ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
          }
        (void) memset(compress_pixels,0,(length+256)*
          sizeof(*compress_pixels));
        (void) FormatLocaleString(buffer,4096,"\033*b2M");
        (void) WriteBlobString(image,buffer);
        break;
      }
      default:
      {
        compress_pixels=(unsigned char *) AcquireQuantumMemory(3*length+256,
          sizeof(*compress_pixels));
        if (compress_pixels == (unsigned char *) 
# 852 "coders/pcl.c" 3 4
                                                ((void *)0)
# 852 "coders/pcl.c"
                                                    )
          {
            pixels=(unsigned char *) RelinquishMagickMemory(pixels);
            { (void) ThrowMagickException(exception,"coders/pcl.c",__func__,(unsigned long) 855,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 855 "coders/pcl.c" 3 4
           ((void *)0)
# 855 "coders/pcl.c"
           ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
          }
        ...
        if (previous_pixels == (unsigned char *) 
# 861 "coders/pcl.c" 3 4
                                                ((void *)0)
# 861 "coders/pcl.c"
                                                    )
          {
            compress_pixels=(unsigned char *) RelinquishMagickMemory(
              compress_pixels);
            pixels=(unsigned char *) RelinquishMagickMemory(pixels);
            { (void) ThrowMagickException(exception,"coders/pcl.c",__func__,(unsigned long) 866,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 866 "coders/pcl.c" 3 4
           ((void *)0)
# 866 "coders/pcl.c"
           ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
          }
        (void) memset(previous_pixels,0,(length+1)*
          sizeof(*previous_pixels));
        (void) FormatLocaleString(buffer,4096,"\033*b3M");
        (void) WriteBlobString(image,buffer);
        break;
      }
    }
...
# 878 "coders/pcl.c"
      ...
      switch (compression)
      {
        case NoCompression:
        {
          (void) FormatLocaleString(buffer,4096,"\033*b%.20gW",
            (double) length);
          (void) WriteBlobString(image,buffer);
    ...
    (void) WriteBlobString(image,"\033*rB");
    switch (compression)
    {
      case NoCompression:
        break;
