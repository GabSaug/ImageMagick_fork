...
# 221 "coders/bmp.c"
 "image != (Image *) NULL"
# 221 "coders/bmp.c" 3 4
 , "coders/bmp.c", 221, __extension__ __PRETTY_FUNCTION__); }))
# 221 "coders/bmp.c"
                                ;
  
# 222 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 222 "coders/bmp.c"
...
# 222 "coders/bmp.c" 3 4
 , "coders/bmp.c", 222, __extension__ __PRETTY_FUNCTION__); }))
# 222 "coders/bmp.c"
                                                ;
  
# 223 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 223 "coders/bmp.c"
...
# 223 "coders/bmp.c" 3 4
 , "coders/bmp.c", 223, __extension__ __PRETTY_FUNCTION__); }))
# 223 "coders/bmp.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/bmp.c",__func__,(unsigned long) 225,"%s",image->filename);
    ...
    if (count > 0)
      {
        ...
        count=(int) ((((ssize_t) count) < ((ssize_t) (q-p))) ? ((ssize_t) count) : ((ssize_t) (q-p)));
        byte=ReadBlobByte(image);
        if (byte == 
# 248 "coders/bmp.c" 3 4
                   (-1)
# 248 "coders/bmp.c"
                      )
          break;
...
# 341 "coders/bmp.c"
    ...
    status=SetImageProgress(image,"Load/Image",(MagickOffsetType) y,
      image->rows);
    if (status == MagickFalse)
      break;
  }
...
# 411 "coders/bmp.c"
 "image != (Image *) NULL"
# 411 "coders/bmp.c" 3 4
 , "coders/bmp.c", 411, __extension__ __PRETTY_FUNCTION__); }))
# 411 "coders/bmp.c"
                                ;
  
# 412 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 412 "coders/bmp.c"
 image->signature == 0xabacadabUL
# 412 "coders/bmp.c" 3 4
...
# 412 "coders/bmp.c"
 "image->signature == MagickCoreSignature"
# 412 "coders/bmp.c" 3 4
 , "coders/bmp.c", 412, __extension__ __PRETTY_FUNCTION__); }))
# 412 "coders/bmp.c"
                                                ;
  
# 413 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 413 "coders/bmp.c"
...
# 413 "coders/bmp.c" 3 4
 , "coders/bmp.c", 413, __extension__ __PRETTY_FUNCTION__); }))
# 413 "coders/bmp.c"
                                               ;
  
# 414 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 414 "coders/bmp.c"
...
# 414 "coders/bmp.c" 3 4
 , "coders/bmp.c", 414, __extension__ __PRETTY_FUNCTION__); }))
# 414 "coders/bmp.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/bmp.c",__func__,(unsigned long) 416,"%s",image->filename);
  p=pixels;
  q=compressed_pixels;
  i=0;
...
# 548 "coders/bmp.c" 3 4
                                  ((void *)0)
# 548 "coders/bmp.c"
                                      )
    {
      (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 550,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",image->filename);
      return((Image *) 
# 552 "coders/bmp.c" 3 4
                      ((void *)0)
# 552 "coders/bmp.c"
                          );
    }
  ...
  if (count != (ssize_t) length)
    {
      ...
      (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 559,CorruptImageError,
        "ImproperImageHeader","`%s'",image->filename);
      return((Image *) 
# 561 "coders/bmp.c" 3 4
                      ((void *)0)
# 561 "coders/bmp.c"
                          );
    }
  embed_info=AcquireImageInfo();
  (void) FormatLocaleString(embed_info->filename,4096,
  ...
  pixel_info=RelinquishVirtualMemory(pixel_info);
  if (embed_image != (Image *) 
# 569 "coders/bmp.c" 3 4
                              ((void *)0)
# 569 "coders/bmp.c"
                                  )
    {
...
# 633 "coders/bmp.c" 3 4
 , "coders/bmp.c", 633, __extension__ __PRETTY_FUNCTION__); }))
# 633 "coders/bmp.c"
                                               ;
  
# 634 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 634 "coders/bmp.c"
...
# 634 "coders/bmp.c" 3 4
 , "coders/bmp.c", 634, __extension__ __PRETTY_FUNCTION__); }))
# 634 "coders/bmp.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/bmp.c",__func__,(unsigned long) 636,"%s",
      image_info->filename);
  
# 638 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 638 "coders/bmp.c"
...
# 638 "coders/bmp.c" 3 4
 , "coders/bmp.c", 638, __extension__ __PRETTY_FUNCTION__); }))
# 638 "coders/bmp.c"
                                            ;
  
# 639 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 639 "coders/bmp.c"
...
# 639 "coders/bmp.c" 3 4
 , "coders/bmp.c", 639, __extension__ __PRETTY_FUNCTION__); }))
# 639 "coders/bmp.c"
                                                    ;
...
# 647 "coders/bmp.c"
  ...
  if (count != 2)
    { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 658,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 658 "coders/bmp.c" 3 4
   ((void *)0)
# 658 "coders/bmp.c"
...
# 658 "coders/bmp.c"
  ...
  do
  {
    ...
    if (image->debug != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 683,"  Magick: %c%c",
        magick[0],magick[1]);
    if ((count != 2) || ((LocaleNCompare((char *) magick,"BM",2) != 0) &&
        (LocaleNCompare((char *) magick,"CI",2) != 0)))
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 687,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 687 "coders/bmp.c" 3 4
     ((void *)0)
# 687 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 687 "coders/bmp.c" 3 4
...
# 687 "coders/bmp.c"
    ...
    if (image->debug != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 693,
        "  BMP header size: %u",bmp_info.size);
    if (LocaleNCompare((char *) magick,"CI",2) == 0)
      {
        if ((bmp_info.size != 12) && (bmp_info.size != 40) &&
            (bmp_info.size != 64))
          { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 699,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 699 "coders/bmp.c" 3 4
         ((void *)0)
# 699 "coders/bmp.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 699 "coders/bmp.c" 3 4
...
# 699 "coders/bmp.c"
    ...
    if (bmp_info.size > 124)
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 702,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 702 "coders/bmp.c" 3 4
     ((void *)0)
# 702 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 702 "coders/bmp.c" 3 4
...
# 702 "coders/bmp.c"
    ...
    if ((bmp_info.file_size != 0) &&
      ...
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 705,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 705 "coders/bmp.c" 3 4
     ((void *)0)
# 705 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 705 "coders/bmp.c" 3 4
...
# 705 "coders/bmp.c"
    ...
    if (bmp_info.offset_bits < bmp_info.size)
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 707,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 707 "coders/bmp.c" 3 4
     ((void *)0)
# 707 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 707 "coders/bmp.c" 3 4
...
# 707 "coders/bmp.c"
    ...
    bmp_info.offset_bits=(((14+bmp_info.size) > (bmp_info.offset_bits)) ? (14+bmp_info.size) : (bmp_info.offset_bits));
    profile_data=0;
    profile_size=0;
    if (bmp_info.size == 12)
      {
        ...
        (void) CopyMagickString(image->magick,"BMP2",4096);
        ...
        if (image->debug != MagickFalse)
          {
            (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 729,
              "  Format: OS/2 Bitmap");
            (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 731,
    ...
    else
      {
        ...
        switch (bmp_info.size)
        {
          ...
          {
            if (bmp_info.size < 64)
              { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 750,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 750 "coders/bmp.c" 3 4
             ((void *)0)
# 750 "coders/bmp.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 750 "coders/bmp.c" 3 4
...
# 750 "coders/bmp.c"
        ...
        if (image->debug != MagickFalse)
          {
            (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 769,
              "  Format: MS Windows bitmap");
            (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 771,
              "  Geometry: %.20gx%.20g",(double) bmp_info.width,(double)
              bmp_info.height);
            (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 774,
              "  Bits per pixel: %.20g",(double) bmp_info.bits_per_pixel);
            switch (bmp_info.compression)
            {
              case 0:
              {
                (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 780,
                  "  Compression: BI_RGB");
                break;
              }
              case 2:
              {
                (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 786,
                  "  Compression: BI_RLE4");
                break;
              }
              case 1:
              {
                (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 792,
                  "  Compression: BI_RLE8");
                break;
              }
              case 3:
              {
                (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 798,
                  "  Compression: BI_BITFIELDS");
                break;
              }
              case 6:
              {
                (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 804,
                  "  Compression: BI_ALPHABITFIELDS");
                break;
              }
              case 5:
              {
                (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 810,
                  "  Compression: BI_PNG");
                break;
              }
              case 4:
              {
                (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 816,
                  "  Compression: BI_JPEG");
                break;
              }
              default:
              {
                (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 822,
                  "  Compression: UNKNOWN (%u)",bmp_info.compression);
              }
            }
            (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 826,
              "  Number of colors: %u",bmp_info.number_colors);
          }
        if ((bmp_info.size > 40) || (bmp_info.compression == 3) ||
            (bmp_info.compression == 6))

          {
            bmp_info.red_mask=ReadBlobLSBLong(image);
            bmp_info.green_mask=ReadBlobLSBLong(image);
            bmp_info.blue_mask=ReadBlobLSBLong(image);
            if (bmp_info.compression == 6)
        ...
        if (bmp_info.size > 40)
          {
            ...
            bmp_info.red_primary.x=(double) ReadBlobLSBLong(image)/((double) 0x40000000);
            bmp_info.red_primary.y=(double) ReadBlobLSBLong(image)/((double) 0x40000000);
            bmp_info.red_primary.z=(double) ReadBlobLSBLong(image)/((double) 0x40000000);
            bmp_info.green_primary.x=(double) ReadBlobLSBLong(image)/((double) 0x40000000);
            bmp_info.green_primary.y=(double) ReadBlobLSBLong(image)/((double) 0x40000000);
            bmp_info.green_primary.z=(double) ReadBlobLSBLong(image)/((double) 0x40000000);
            bmp_info.blue_primary.x=(double) ReadBlobLSBLong(image)/((double) 0x40000000);
            bmp_info.blue_primary.y=(double) ReadBlobLSBLong(image)/((double) 0x40000000);
            bmp_info.blue_primary.z=(double) ReadBlobLSBLong(image)/((double) 0x40000000);
          ...
          (void) CopyMagickString(image->magick,"BMP3",4096);
    ...
    if ((MagickSizeType) bmp_info.file_size != blob_size)
      {
        ...
        if (IsStringTrue(option) == MagickFalse)
          (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 950,
            CorruptImageError,"LengthAndFilesizeDoNotMatch","`%s'",
            image->filename);
      }
    if (bmp_info.width <= 0)
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 955,CorruptImageError,"NegativeOrZeroImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 955 "coders/bmp.c" 3 4
     ((void *)0)
# 955 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 955 "coders/bmp.c" 3 4
...
# 955 "coders/bmp.c"
    ...
    if (bmp_info.height == 0)
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 957,CorruptImageError,"NegativeOrZeroImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 957 "coders/bmp.c" 3 4
     ((void *)0)
# 957 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 957 "coders/bmp.c" 3 4
...
# 957 "coders/bmp.c"
    ...
    if (bmp_info.planes != 1)
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 979,CorruptImageError,"StaticPlanesValueNotEqualToOne", "`%s'",image_info->filename); if ((image) != (Image *) 
# 979 "coders/bmp.c" 3 4
     ((void *)0)
# 979 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 979 "coders/bmp.c" 3 4
...
# 979 "coders/bmp.c"
    ...
    switch (bmp_info.bits_per_pixel)
    {
      ...
      default:
        { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 987,CorruptImageError,"UnsupportedBitsPerPixel", "`%s'",image_info->filename); if ((image) != (Image *) 
# 987 "coders/bmp.c" 3 4
       ((void *)0)
# 987 "coders/bmp.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 987 "coders/bmp.c" 3 4
...
# 987 "coders/bmp.c"
    ...
    if ((bmp_info.bits_per_pixel < 16) &&
      ...
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 991,CorruptImageError,"UnrecognizedNumberOfColors", "`%s'",image_info->filename); if ((image) != (Image *) 
# 991 "coders/bmp.c" 3 4
     ((void *)0)
# 991 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 991 "coders/bmp.c" 3 4
...
# 991 "coders/bmp.c"
    ...
    if ((MagickSizeType) bmp_info.number_colors > blob_size)
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 993,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 993 "coders/bmp.c" 3 4
     ((void *)0)
# 993 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 993 "coders/bmp.c" 3 4
...
# 993 "coders/bmp.c"
    ...
    if ((bmp_info.compression == 1) && (bmp_info.bits_per_pixel != 8))
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 995,CorruptImageError,"UnsupportedBitsPerPixel", "`%s'",image_info->filename); if ((image) != (Image *) 
# 995 "coders/bmp.c" 3 4
     ((void *)0)
# 995 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 995 "coders/bmp.c" 3 4
...
# 995 "coders/bmp.c"
    ...
    if ((bmp_info.compression == 2) && (bmp_info.bits_per_pixel != 4))
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 997,CorruptImageError,"UnsupportedBitsPerPixel", "`%s'",image_info->filename); if ((image) != (Image *) 
# 997 "coders/bmp.c" 3 4
     ((void *)0)
# 997 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 997 "coders/bmp.c" 3 4
...
# 997 "coders/bmp.c"
    ...
    if ((bmp_info.compression == 3) &&
      ...
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1000,CorruptImageError,"UnsupportedBitsPerPixel", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1000 "coders/bmp.c" 3 4
     ((void *)0)
# 1000 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1000 "coders/bmp.c" 3 4
...
# 1000 "coders/bmp.c"
    ...
    switch (bmp_info.compression)
    {
      ...
      case 6:
        break;
      case 4:
        { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1015,CoderError,"JPEGCompressNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1015 "coders/bmp.c" 3 4
       ((void *)0)
# 1015 "coders/bmp.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1015 "coders/bmp.c" 3 4
...
# 1015 "coders/bmp.c"
      ...
      case 5:
        { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1017,CoderError,"PNGCompressNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1017 "coders/bmp.c" 3 4
       ((void *)0)
# 1017 "coders/bmp.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1017 "coders/bmp.c" 3 4
...
# 1017 "coders/bmp.c"
      ...
      default:
        { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1019,CorruptImageError,"UnrecognizedImageCompression", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1019 "coders/bmp.c" 3 4
       ((void *)0)
# 1019 "coders/bmp.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1019 "coders/bmp.c" 3 4
...
# 1019 "coders/bmp.c"
    ...
    image->columns=(size_t) ((bmp_info.width) < 0 ? -(bmp_info.width) : (bmp_info.width));
    image->rows=(size_t) ((bmp_info.height) < 0 ? -(bmp_info.height) : (bmp_info.height));
    image->depth=bmp_info.bits_per_pixel <= 8 ? bmp_info.bits_per_pixel : 8;
    image->alpha_trait=((bmp_info.alpha_mask != 0) &&
      (bmp_info.compression == 3)) ? BlendPixelTrait :
      UndefinedPixelTrait;
    if (bmp_info.bits_per_pixel < 16)
      {
        size_t
    ...
    if (image->storage_class == PseudoClass)
      {
        ...
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 1059,
            "  Reading colormap of %.20g colors",(double) image->colors);
        if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
          { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1062,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1062 "coders/bmp.c" 3 4
         ((void *)0)
# 1062 "coders/bmp.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1062 "coders/bmp.c" 3 4
...
# 1062 "coders/bmp.c"
        ...
        if (bmp_colormap == (unsigned char *) 
# 1065 "coders/bmp.c" 3 4
                                             ((void *)0)
# 1065 "coders/bmp.c"
                                                 )
          { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1066,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1066 "coders/bmp.c" 3 4
         ((void *)0)
# 1066 "coders/bmp.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1066 "coders/bmp.c" 3 4
...
# 1066 "coders/bmp.c"
        ...
        if ((bmp_info.size == 12) || (bmp_info.size == 64))
          ...
          packet_size=4;
        offset=SeekBlob(image,start_position+14+bmp_info.size,
# 1071 "coders/bmp.c" 3 4
                                                             0
# 1071 "coders/bmp.c"
                                                                     );
        if (offset < 0)
          {
            ...
            { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1075,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1075 "coders/bmp.c" 3 4
           ((void *)0)
# 1075 "coders/bmp.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1075 "coders/bmp.c" 3 4
...
# 1075 "coders/bmp.c"
        ...
        if (count != (ssize_t) (packet_size*image->colors))
          {
            bmp_colormap=(unsigned char *) RelinquishMagickMemory(bmp_colormap);
            { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1081,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1081 "coders/bmp.c" 3 4
           ((void *)0)
# 1081 "coders/bmp.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1081 "coders/bmp.c" 3 4
...
# 1081 "coders/bmp.c"
    ...
    if (bmp_info.offset_bits == offset_bits)
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1099,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1099 "coders/bmp.c" 3 4
     ((void *)0)
# 1099 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1099 "coders/bmp.c" 3 4
...
# 1099 "coders/bmp.c"
    ...
    offset=SeekBlob(image,start_position+bmp_info.offset_bits,
# 1101 "coders/bmp.c" 3 4
                                                             0
# 1101 "coders/bmp.c"
                                                                     );
    if (offset < 0)
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1103,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1103 "coders/bmp.c" 3 4
     ((void *)0)
# 1103 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1103 "coders/bmp.c" 3 4
...
# 1103 "coders/bmp.c"
    ...
    if ((MagickSizeType) (length/256) > blob_size)
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1109,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1109 "coders/bmp.c" 3 4
     ((void *)0)
# 1109 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1109 "coders/bmp.c" 3 4
...
# 1109 "coders/bmp.c"
    ...
    pixel_info=AcquireVirtualMemory(image->rows,
      (((bytes_per_line) > (image->columns+1UL)) ? (bytes_per_line) : (image->columns+1UL))*sizeof(*pixels));
    if (pixel_info == (MemoryInfo *) 
# 1112 "coders/bmp.c" 3 4
                                    ((void *)0)
# 1112 "coders/bmp.c"
                                        )
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1113,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1113 "coders/bmp.c" 3 4
     ((void *)0)
# 1113 "coders/bmp.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1113 "coders/bmp.c" 3 4
...
# 1113 "coders/bmp.c"
    ...
    if ((bmp_info.compression == 0) ||
        (bmp_info.compression == 3) ||
        (bmp_info.compression == 6))
      {
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 1120,
            "  Reading pixels (%.20g bytes)",(double) length);
        count=ReadBlob(image,length,pixels);
        if (count != (ssize_t) length)
          {
            pixel_info=RelinquishVirtualMemory(pixel_info);
            { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1126,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1126 "coders/bmp.c" 3 4
           ((void *)0)
# 1126 "coders/bmp.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1126 "coders/bmp.c" 3 4
...
# 1126 "coders/bmp.c"
    ...
    else
      {
        ...
        if (status == MagickFalse)
          {
            pixel_info=RelinquishVirtualMemory(pixel_info);
            { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1140,CorruptImageError,"UnableToRunlengthDecodeImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1140 "coders/bmp.c" 3 4
           ((void *)0)
# 1140 "coders/bmp.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1140 "coders/bmp.c" 3 4
...
# 1296 "coders/bmp.c" 3 4
                                          ((void *)0)
# 1296 "coders/bmp.c"
                                              )
            {
              status=SetImageProgress(image,"Load/Image",((MagickOffsetType)
...
# 1376 "coders/bmp.c"
      ...
      case 16:
      {
        ...
        if ((bmp_info.compression != 0) &&
          ...
          {
            pixel_info=RelinquishVirtualMemory(pixel_info);
            { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1400,CorruptImageError,"UnrecognizedImageCompression", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1400 "coders/bmp.c" 3 4
           ((void *)0)
# 1400 "coders/bmp.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1400 "coders/bmp.c" 3 4
...
# 1409 "coders/bmp.c"
          ...
          for (x=0; x < (ssize_t) image->columns; x++)
          {
            ...
            SetPixelAlpha(image,((Quantum) ((Quantum) 65535.0)),q);
...
# 1482 "coders/bmp.c"
      ...
      case 32:
      {
        ...
        if ((bmp_info.compression != 0) &&
          ...
          {
            pixel_info=RelinquishVirtualMemory(pixel_info);
            { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1501,CorruptImageError,"UnrecognizedImageCompression", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1501 "coders/bmp.c" 3 4
           ((void *)0)
# 1501 "coders/bmp.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1501 "coders/bmp.c" 3 4
...
# 1584 "coders/bmp.c"
      ...
      {
        pixel_info=RelinquishVirtualMemory(pixel_info);
        { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1597,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1597 "coders/bmp.c" 3 4
       ((void *)0)
# 1597 "coders/bmp.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1597 "coders/bmp.c" 3 4
...
# 1605 "coders/bmp.c" 3 4
       (*__errno_location ())
# 1605 "coders/bmp.c"
       ); (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1605,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
    if (bmp_info.height < 0)
      {
        ...
        if (flipped_image != (Image *) 
# 1618 "coders/bmp.c" 3 4
                                      ((void *)0)
# 1618 "coders/bmp.c"
                                          )
          {
    ...
    if ((bmp_info.colorspace == 0x4D424544L) && (profile_data > 0) &&
        (profile_size > 0))
      {
        ...
        if ((offset < TellBlob(image)) ||
            (SeekBlob(image,offset,
# 1639 "coders/bmp.c" 3 4
                                  0
# 1639 "coders/bmp.c"
                                          ) != offset) ||
            (blob_size < (MagickSizeType) (offset+profile_size)))
          { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1641,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1641 "coders/bmp.c" 3 4
         ((void *)0)
# 1641 "coders/bmp.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1641 "coders/bmp.c" 3 4
...
# 1643 "coders/bmp.c" 3 4
                                     ((void *)0)
# 1643 "coders/bmp.c"
                                         )
          { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1644,CorruptImageError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1644 "coders/bmp.c" 3 4
         ((void *)0)
# 1644 "coders/bmp.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1644 "coders/bmp.c" 3 4
...
# 1644 "coders/bmp.c"
        ...
        if (ReadBlob(image,(size_t) profile_size,datum) == (ssize_t) profile_size)
          {
            ...
            if (image->debug != MagickFalse)
              (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 1661,
    ...
    if (offset != 0)
      if ((offset < TellBlob(image)) ||
          (SeekBlob(image,offset,
# 1676 "coders/bmp.c" 3 4
                                0
# 1676 "coders/bmp.c"
                                        ) != offset))
        { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1677,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1677 "coders/bmp.c" 3 4
       ((void *)0)
# 1677 "coders/bmp.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1677 "coders/bmp.c" 3 4
...
# 1686 "coders/bmp.c"
        ...
        status=SetImageProgress(image,"Load/Images",TellBlob(image),blob_size);
        if (status == MagickFalse)
          break;
      }
...
# 1727 "coders/bmp.c"
__attribute__ ((visibility ("default"))) size_t RegisterBMPImage(void)
{
  MagickInfo
    *entry;
...
# 1778 "coders/bmp.c"
__attribute__ ((visibility ("default"))) void UnregisterBMPImage(void)
{
  ...
  ExceptionInfo *exception)
{
  ...
  const StringInfo
    *profile = (const StringInfo *) 
# 1830 "coders/bmp.c" 3 4
                                   ((void *)0)
# 1830 "coders/bmp.c"
                                       ;
...
# 1863 "coders/bmp.c"
 "image_info != (const ImageInfo *) NULL"
# 1863 "coders/bmp.c" 3 4
 , "coders/bmp.c", 1863, __extension__ __PRETTY_FUNCTION__); }))
# 1863 "coders/bmp.c"
                                               ;
  
# 1864 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 1864 "coders/bmp.c"
 image_info->signature == 0xabacadabUL
# 1864 "coders/bmp.c" 3 4
...
# 1864 "coders/bmp.c"
 "image_info->signature == MagickCoreSignature"
# 1864 "coders/bmp.c" 3 4
 , "coders/bmp.c", 1864, __extension__ __PRETTY_FUNCTION__); }))
# 1864 "coders/bmp.c"
                                                     ;
  
# 1865 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 1865 "coders/bmp.c"
 image != (Image *) 
# 1865 "coders/bmp.c" 3 4
...
# 1865 "coders/bmp.c"
 "image != (Image *) NULL"
# 1865 "coders/bmp.c" 3 4
 , "coders/bmp.c", 1865, __extension__ __PRETTY_FUNCTION__); }))
# 1865 "coders/bmp.c"
                                ;
  
# 1866 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 1866 "coders/bmp.c"
 image->signature == 0xabacadabUL
# 1866 "coders/bmp.c" 3 4
...
# 1866 "coders/bmp.c"
 "image->signature == MagickCoreSignature"
# 1866 "coders/bmp.c" 3 4
 , "coders/bmp.c", 1866, __extension__ __PRETTY_FUNCTION__); }))
# 1866 "coders/bmp.c"
                                                ;
  
# 1867 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 1867 "coders/bmp.c"
 exception != (ExceptionInfo *) 
# 1867 "coders/bmp.c" 3 4
...
# 1867 "coders/bmp.c"
 "exception != (ExceptionInfo *) NULL"
# 1867 "coders/bmp.c" 3 4
 , "coders/bmp.c", 1867, __extension__ __PRETTY_FUNCTION__); }))
# 1867 "coders/bmp.c"
                                            ;
  
# 1868 "coders/bmp.c" 3 4
 ((void) sizeof ((
# 1868 "coders/bmp.c"
 exception->signature == 0xabacadabUL
# 1868 "coders/bmp.c" 3 4
...
# 1868 "coders/bmp.c"
 "exception->signature == MagickCoreSignature"
# 1868 "coders/bmp.c" 3 4
 , "coders/bmp.c", 1868, __extension__ __PRETTY_FUNCTION__); }))
# 1868 "coders/bmp.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/bmp.c",__func__,(unsigned long) 1870,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  if (((image->columns << 3) != (size_t) ((int) (image->columns << 3))) ||
      ((image->rows << 3) != (size_t) ((int) (image->rows << 3))))
    { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 1876,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1876 "coders/bmp.c" 3 4
   ((void *)0)
# 1876 "coders/bmp.c"
  ...
  if (option != (char *) 
# 1884 "coders/bmp.c" 3 4
                        ((void *)0)
# 1884 "coders/bmp.c"
                            )
    {
      (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 1886,
          "  Format=%s",option);
...
# 1957 "coders/bmp.c"
        ...
        if (bmp_subtype != UndefinedSubtype)
        ...
        else
          {
            ...
            bmp_info.compression=(unsigned int) ((type > 3) &&
              (image->alpha_trait != UndefinedPixelTrait) ? 3 : 0);
    ...
    have_color_info=(image->rendering_intent != UndefinedIntent) ||
      (profile != (StringInfo *) 
# 2022 "coders/bmp.c" 3 4
                                ((void *)0)
# 2022 "coders/bmp.c"
                                    ) || (image->gamma != 0.0) ? MagickTrue :
      MagickFalse;
    if (type == 2)
      bmp_info.size=12;
    else
...
# 2041 "coders/bmp.c"
    ...
    if (((ssize_t) image->columns != (ssize_t) ((signed int) image->columns)) ||
      ...
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 2051,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2051 "coders/bmp.c" 3 4
     ((void *)0)
# 2051 "coders/bmp.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    ...
    pixel_info=AcquireVirtualMemory(image->rows,(((bytes_per_line) > (image->columns+256UL)) ? (bytes_per_line) : (image->columns+256UL))
                           *sizeof(*pixels));
    if (pixel_info == (MemoryInfo *) 
# 2081 "coders/bmp.c" 3 4
                                    ((void *)0)
# 2081 "coders/bmp.c"
                                        )
      { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 2082,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2082 "coders/bmp.c" 3 4
     ((void *)0)
# 2082 "coders/bmp.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    pixels=(unsigned char *) GetVirtualMemoryBlob(pixel_info);
      ...
      if (image_info->compression != NoCompression)
        {
          ...
          if (rle_info == (MemoryInfo *) 
# 2363 "coders/bmp.c" 3 4
                                        ((void *)0)
# 2363 "coders/bmp.c"
                                            )
            {
              pixel_info=RelinquishVirtualMemory(pixel_info);
              { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 2366,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2366 "coders/bmp.c" 3 4
             ((void *)0)
# 2366 "coders/bmp.c"
             ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
            }
    ...
    if (image->debug != MagickFalse)
      {
        (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2383,
          "   Writing BMP version %.20g datastream",(double) type);
        if (image->storage_class == DirectClass)
          (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2386,
            "   Storage class=DirectClass");
        else
          (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2389,
            "   Storage class=PseudoClass");
        (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2391,
          "   Image depth=%.20g",(double) image->depth);
        if (image->alpha_trait != UndefinedPixelTrait)
          (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2394,
            "   Matte=True");
        else
          (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2397,
            "   Matte=MagickFalse");
        (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2399,
          "   BMP bits_per_pixel=%.20g",(double) bmp_info.bits_per_pixel);
        switch ((int) bmp_info.compression)
        {
           case 0:
           {
             (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2405,
               "   Compression=BI_RGB");
             break;
           }
           case 1:
           {
             (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2411,
               "   Compression=BI_RLE8");
             break;
           }
           case 3:
           {
             (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2417,
               "   Compression=BI_BITFIELDS");
             break;
           }
           case 6:
           {
             (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2423,
               "   Compression=BI_BITFIELDS");
             break;
           }
           default:
           {
             (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2429,
               "   Compression=UNKNOWN (%u)",bmp_info.compression);
             break;
           }
        }
        if (bmp_info.number_colors == 0)
          (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2435,
            "   Number_colors=unspecified");
        else
          (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2438,
...
# 2516 "coders/bmp.c"
        ...
        if (
# 2518 "coders/bmp.c" 3 4
           __builtin_isgreater(
# 2518 "coders/bmp.c"
           bmp_info.gamma_scale.x
# 2518 "coders/bmp.c" 3 4
           , 
# 2518 "coders/bmp.c"
           1.0
    ...
    if (image->storage_class == PseudoClass)
      {
        ...
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2605,
        ...
        if (bmp_colormap == (unsigned char *) 
# 2609 "coders/bmp.c" 3 4
                                             ((void *)0)
# 2609 "coders/bmp.c"
                                                 )
          {
            pixel_info=RelinquishVirtualMemory(pixel_info);
            { (void) ThrowMagickException(exception,"coders/bmp.c",__func__,(unsigned long) 2612,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2612 "coders/bmp.c" 3 4
           ((void *)0)
# 2612 "coders/bmp.c"
           ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
          }
        q=bmp_colormap;
        for (i=0; i < ((((ssize_t) image->colors) < ((ssize_t) bmp_info.number_colors)) ? ((ssize_t) image->colors) : ((ssize_t) bmp_info.number_colors)); i++)
        {
    ...
    if (image->debug != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2640,
        "  Pixels:  %u bytes",bmp_info.image_size);
    (void) WriteBlob(image,(size_t) bmp_info.image_size,pixels);
    if (profile != (StringInfo *) 
# 2643 "coders/bmp.c" 3 4
                                 ((void *)0)
# 2643 "coders/bmp.c"
                                     )
      {
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/bmp.c",__func__,(unsigned long) 2646,
