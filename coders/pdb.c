...
# 320 "coders/pdb.c" 3 4
 , "coders/pdb.c", 320, __extension__ __PRETTY_FUNCTION__); }))
# 320 "coders/pdb.c"
                                               ;
  
# 321 "coders/pdb.c" 3 4
 ((void) sizeof ((
# 321 "coders/pdb.c"
...
# 321 "coders/pdb.c" 3 4
 , "coders/pdb.c", 321, __extension__ __PRETTY_FUNCTION__); }))
# 321 "coders/pdb.c"
                                                     ;
  
# 322 "coders/pdb.c" 3 4
 ((void) sizeof ((
# 322 "coders/pdb.c"
...
# 322 "coders/pdb.c" 3 4
 , "coders/pdb.c", 322, __extension__ __PRETTY_FUNCTION__); }))
# 322 "coders/pdb.c"
                                            ;
  
# 323 "coders/pdb.c" 3 4
 ((void) sizeof ((
# 323 "coders/pdb.c"
...
# 323 "coders/pdb.c" 3 4
 , "coders/pdb.c", 323, __extension__ __PRETTY_FUNCTION__); }))
# 323 "coders/pdb.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pdb.c",__func__,(unsigned long) 325,"%s",
      image_info->filename);
...
# 332 "coders/pdb.c"
  ...
  if (count != sizeof(pdb_info.name))
    { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 340,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 340 "coders/pdb.c" 3 4
   ((void *)0)
# 340 "coders/pdb.c"
...
# 340 "coders/pdb.c"
  ...
  if ((memcmp(pdb_info.type,"vIMG",4) != 0) ||
    ...
    { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 356,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 356 "coders/pdb.c" 3 4
   ((void *)0)
# 356 "coders/pdb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 356 "coders/pdb.c" 3 4
...
# 356 "coders/pdb.c"
  ...
  if (pdb_info.next_record != 0)
    { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 358,CoderError,"MultipleRecordListNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 358 "coders/pdb.c" 3 4
   ((void *)0)
# 358 "coders/pdb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 358 "coders/pdb.c" 3 4
...
# 358 "coders/pdb.c"
  ...
  if (count != 3 || memcmp(tag,"\x6f\x80\x00",3) != 0)
    { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 367,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 367 "coders/pdb.c" 3 4
   ((void *)0)
# 367 "coders/pdb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 367 "coders/pdb.c" 3 4
  ...
  if (pdb_info.number_records > 1)
    {
      ...
      if (count != 3 || memcmp(tag,"\x6f\x80\x01",3) != 0)
        { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 374,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 374 "coders/pdb.c" 3 4
       ((void *)0)
# 374 "coders/pdb.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 374 "coders/pdb.c" 3 4
...
# 383 "coders/pdb.c"
  ...
  if (count != sizeof(pdb_image.name))
    { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 391,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 391 "coders/pdb.c" 3 4
   ((void *)0)
# 391 "coders/pdb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 391 "coders/pdb.c" 3 4
...
# 391 "coders/pdb.c"
  ...
  if (AcquireImageColormap(image,one << bits_per_pixel,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 413,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 413 "coders/pdb.c" 3 4
   ((void *)0)
# 413 "coders/pdb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 413 "coders/pdb.c" 3 4
...
# 427 "coders/pdb.c" 3 4
                                 ((void *)0)
# 427 "coders/pdb.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 428,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 428 "coders/pdb.c" 3 4
   ((void *)0)
# 428 "coders/pdb.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 428 "coders/pdb.c" 3 4
      ...
      if (count != (ssize_t) (packets*image->rows))
        {
          ...
          { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 439,CorruptImageError,"RLEDecoderError", "`%s'",image_info->filename); if ((image) != (Image *) 
# 439 "coders/pdb.c" 3 4
         ((void *)0)
# 439 "coders/pdb.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 439 "coders/pdb.c" 3 4
...
# 439 "coders/pdb.c"
    ...
    case 1:
    {
      ...
      if (DecodeImage(image,pixels,packets*image->rows) == MagickFalse)
        {
          pixels=(unsigned char *) RelinquishMagickMemory(pixels);
          { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 449,CorruptImageError,"RLEDecoderError", "`%s'",image_info->filename); if ((image) != (Image *) 
# 449 "coders/pdb.c" 3 4
         ((void *)0)
# 449 "coders/pdb.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 449 "coders/pdb.c" 3 4
...
# 449 "coders/pdb.c"
    ...
    {
      pixels=(unsigned char *) RelinquishMagickMemory(pixels);
      { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 456,CorruptImageError,"UnrecognizedImageCompressionType", "`%s'",image_info->filename); if ((image) != (Image *) 
# 456 "coders/pdb.c" 3 4
     ((void *)0)
# 456 "coders/pdb.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 456 "coders/pdb.c" 3 4
...
# 547 "coders/pdb.c"
    ...
    {
      pixels=(unsigned char *) RelinquishMagickMemory(pixels);
      { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 576,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 576 "coders/pdb.c" 3 4
     ((void *)0)
# 576 "coders/pdb.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 576 "coders/pdb.c" 3 4
...
# 581 "coders/pdb.c" 3 4
   (*__errno_location ())
# 581 "coders/pdb.c"
   ); (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 581,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
  if (pdb_info.number_records > 1)
    {
      char
...
# 610 "coders/pdb.c" 3 4
                                    ((void *)0)
# 610 "coders/pdb.c"
                                        );
      for (r=comment; c != 
# 611 "coders/pdb.c" 3 4
                          (-1)
# 611 "coders/pdb.c"
                             ; r++)
      {
        if ((size_t) (r-comment+4096) >= length)
          {
            *r='\0';
            length<<=1;
            length+=4096;
...
# 620 "coders/pdb.c"
      ...
      *r='\0';
      if (comment == (char *) 
# 628 "coders/pdb.c" 3 4
                             ((void *)0)
# 628 "coders/pdb.c"
                                 )
        { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 629,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 629 "coders/pdb.c" 3 4
       ((void *)0)
# 629 "coders/pdb.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 629 "coders/pdb.c" 3 4
...
# 663 "coders/pdb.c"
__attribute__ ((visibility ("default"))) size_t RegisterPDBImage(void)
{
  MagickInfo
    *entry;
...
# 695 "coders/pdb.c"
__attribute__ ((visibility ("default"))) void UnregisterPDBImage(void)
{
...
# 794 "coders/pdb.c"
 "image_info != (const ImageInfo *) NULL"
# 794 "coders/pdb.c" 3 4
 , "coders/pdb.c", 794, __extension__ __PRETTY_FUNCTION__); }))
# 794 "coders/pdb.c"
                                               ;
  
# 795 "coders/pdb.c" 3 4
 ((void) sizeof ((
# 795 "coders/pdb.c"
 image_info->signature == 0xabacadabUL
# 795 "coders/pdb.c" 3 4
...
# 795 "coders/pdb.c"
 "image_info->signature == MagickCoreSignature"
# 795 "coders/pdb.c" 3 4
 , "coders/pdb.c", 795, __extension__ __PRETTY_FUNCTION__); }))
# 795 "coders/pdb.c"
                                                     ;
  
# 796 "coders/pdb.c" 3 4
 ((void) sizeof ((
# 796 "coders/pdb.c"
 image != (Image *) 
# 796 "coders/pdb.c" 3 4
...
# 796 "coders/pdb.c"
 "image != (Image *) NULL"
# 796 "coders/pdb.c" 3 4
 , "coders/pdb.c", 796, __extension__ __PRETTY_FUNCTION__); }))
# 796 "coders/pdb.c"
                                ;
  
# 797 "coders/pdb.c" 3 4
 ((void) sizeof ((
# 797 "coders/pdb.c"
...
# 797 "coders/pdb.c" 3 4
 , "coders/pdb.c", 797, __extension__ __PRETTY_FUNCTION__); }))
# 797 "coders/pdb.c"
                                                ;
  
# 798 "coders/pdb.c" 3 4
 ((void) sizeof ((
# 798 "coders/pdb.c"
 exception != (ExceptionInfo *) 
# 798 "coders/pdb.c" 3 4
...
# 798 "coders/pdb.c"
 "exception != (ExceptionInfo *) NULL"
# 798 "coders/pdb.c" 3 4
 , "coders/pdb.c", 798, __extension__ __PRETTY_FUNCTION__); }))
# 798 "coders/pdb.c"
                                            ;
  
# 799 "coders/pdb.c" 3 4
 ((void) sizeof ((
# 799 "coders/pdb.c"
 exception->signature == 0xabacadabUL
# 799 "coders/pdb.c" 3 4
...
# 799 "coders/pdb.c"
 "exception->signature == MagickCoreSignature"
# 799 "coders/pdb.c" 3 4
 , "coders/pdb.c", 799, __extension__ __PRETTY_FUNCTION__); }))
# 799 "coders/pdb.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pdb.c",__func__,(unsigned long) 801,"%s",image->filename);
  ...
  pdb_info.number_records=(comment == (const char *) 
# 833 "coders/pdb.c" 3 4
                                                    ((void *)0) 
# 833 "coders/pdb.c"
                                                         ? 1 : 2);
  ...
  scanline=(unsigned char *) AcquireQuantumMemory(image->columns,packet_size*
    sizeof(*scanline));
  if ((runlength == (unsigned char *) 
# 874 "coders/pdb.c" 3 4
                                     ((void *)0)
# 874 "coders/pdb.c"
                                         ) ||
      (buffer == (unsigned char *) 
# 875 "coders/pdb.c" 3 4
                                  ((void *)0)
# 875 "coders/pdb.c"
                                      ) ||
      (scanline == (unsigned char *) 
# 876 "coders/pdb.c" 3 4
                                    ((void *)0)
# 876 "coders/pdb.c"
                                        ))
    {
      if (runlength != (unsigned char *) 
# 878 "coders/pdb.c" 3 4
                                        ((void *)0)
# 878 "coders/pdb.c"
                                            )
        runlength=(unsigned char *) RelinquishMagickMemory(runlength);
      if (buffer != (unsigned char *) 
# 880 "coders/pdb.c" 3 4
                                     ((void *)0)
# 880 "coders/pdb.c"
                                         )
        buffer=(unsigned char *) RelinquishMagickMemory(buffer);
      if (scanline != (unsigned char *) 
# 882 "coders/pdb.c" 3 4
                                       ((void *)0)
# 882 "coders/pdb.c"
                                           )
        scanline=(unsigned char *) RelinquishMagickMemory(scanline);
      { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 884,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 884 "coders/pdb.c" 3 4
     ((void *)0)
# 884 "coders/pdb.c"
...
# 895 "coders/pdb.c" 3 4
                                     ((void *)0)
# 895 "coders/pdb.c"
                                         )
    {
      if (runlength != (unsigned char *) 
# 897 "coders/pdb.c" 3 4
                                        ((void *)0)
# 897 "coders/pdb.c"
                                            )
        runlength=(unsigned char *) RelinquishMagickMemory(runlength);
      if (buffer != (unsigned char *) 
# 899 "coders/pdb.c" 3 4
                                     ((void *)0)
# 899 "coders/pdb.c"
                                         )
        buffer=(unsigned char *) RelinquishMagickMemory(buffer);
      if (scanline != (unsigned char *) 
# 901 "coders/pdb.c" 3 4
                                       ((void *)0)
# 901 "coders/pdb.c"
                                           )
        scanline=(unsigned char *) RelinquishMagickMemory(scanline);
      { (void) ThrowMagickException(exception,"coders/pdb.c",__func__,(unsigned long) 903,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 903 "coders/pdb.c" 3 4
     ((void *)0)
# 903 "coders/pdb.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    }
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 914 "coders/pdb.c" 3 4
                              ((void *)0)
# 914 "coders/pdb.c"
                                  )
      break;
    (void) ExportQuantumPixels(image,(CacheView *) 
# 916 "coders/pdb.c" 3 4
                                                  ((void *)0)
# 916 "coders/pdb.c"
                                                      ,quantum_info,
