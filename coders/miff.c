...
# 51 "coders/miff.c" 2
# 1 "./MagickCore/colormap-private.h" 1
# 23 "./MagickCore/colormap-private.h"
...
# 24 "./MagickCore/colormap-private.h" 2
  ...
  if ((index < 0) || (index >= (ssize_t) image->colors))
    {
      if (exception->severity != CorruptImageError)
        (void) ThrowMagickException(exception,"./MagickCore/colormap-private.h",__func__,(unsigned long) 35,
  ...
  Quantum *target,ExceptionInfo *exception)
{
  if ((index < 0) || (index >= (ssize_t) image->colors))
    {
      if (exception->severity != CorruptImageError)
        (void) ThrowMagickException(exception,"./MagickCore/colormap-private.h",__func__,(unsigned long) 48,
          CorruptImageError,"InvalidColormapIndex","`%s'",image->filename);
      *target=(Quantum) 0;
    }
  else
...
# 77 "/usr/include/lzma.h" 3 4
# 1 "/usr/lib/gcc/x86_64-linux-gnu/13/include/stddef.h" 1 3 4
# 78 "/usr/include/lzma.h" 2 3 4
# 295 "/usr/include/lzma.h" 3 4
# 1 "/usr/include/lzma/version.h" 1 3 4
# 120 "/usr/include/lzma/version.h" 3 4
extern uint32_t lzma_version_number(void)
  __attribute__((__nothrow__)) __attribute__((__const__));
# 132 "/usr/include/lzma/version.h" 3 4
extern const char * lzma_version_string(void)
  __attribute__((__nothrow__)) __attribute__((__const__));
# 296 "/usr/include/lzma.h" 2 3 4
# 1 "/usr/include/lzma/base.h" 1 3 4
# 28 "/usr/include/lzma/base.h" 3 4
typedef unsigned char lzma_bool;
# 43 "/usr/include/lzma/base.h" 3 4
typedef enum {
 LZMA_RESERVED_ENUM = 0
} lzma_reserved_enum;
# 56 "/usr/include/lzma/base.h" 3 4
typedef enum {
 LZMA_OK = 0,
 ...
 LZMA_STREAM_END = 1,
# 74 "/usr/include/lzma/base.h" 3 4
 LZMA_NO_CHECK = 2,
# 89 "/usr/include/lzma/base.h" 3 4
 LZMA_UNSUPPORTED_CHECK = 3,
# 114 "/usr/include/lzma/base.h" 3 4
 LZMA_GET_CHECK = 4,
# 127 "/usr/include/lzma/base.h" 3 4
 LZMA_MEM_ERROR = 5,
# 139 "/usr/include/lzma/base.h" 3 4
 LZMA_MEMLIMIT_ERROR = 6,
# 155 "/usr/include/lzma/base.h" 3 4
 LZMA_FORMAT_ERROR = 7,
# 165 "/usr/include/lzma/base.h" 3 4
 LZMA_OPTIONS_ERROR = 8,
# 177 "/usr/include/lzma/base.h" 3 4
 LZMA_DATA_ERROR = 9,
# 196 "/usr/include/lzma/base.h" 3 4
 LZMA_BUF_ERROR = 10,
# 223 "/usr/include/lzma/base.h" 3 4
 LZMA_PROG_ERROR = 11,
# 243 "/usr/include/lzma/base.h" 3 4
 LZMA_SEEK_NEEDED = 12,
# 264 "/usr/include/lzma/base.h" 3 4
...
# 285 "/usr/include/lzma/base.h" 3 4
typedef enum {
 LZMA_RUN = 0,
# 300 "/usr/include/lzma/base.h" 3 4
 LZMA_SYNC_FLUSH = 1,
# 325 "/usr/include/lzma/base.h" 3 4
 LZMA_FULL_FLUSH = 2,
# 340 "/usr/include/lzma/base.h" 3 4
 LZMA_FULL_BARRIER = 4,
# 363 "/usr/include/lzma/base.h" 3 4
 LZMA_FINISH = 3
# 380 "/usr/include/lzma/base.h" 3 4
} lzma_action;
# 407 "/usr/include/lzma/base.h" 3 4
typedef struct {
# 442 "/usr/include/lzma/base.h" 3 4
 void *( *alloc)(void *opaque, size_t nmemb, size_t size);
# 456 "/usr/include/lzma/base.h" 3 4
 void ( *free)(void *opaque, void *ptr);
# 467 "/usr/include/lzma/base.h" 3 4
 void *opaque;
...
# 520 "/usr/include/lzma/base.h" 3 4
typedef struct {
...
# 550 "/usr/include/lzma/base.h" 3 4
 void *reserved_ptr1;
 ...
 void *reserved_ptr4;
# 571 "/usr/include/lzma/base.h" 3 4
 uint64_t seek_pos;
...
# 58 "/usr/include/lzma/delta.h" 3 4
 uint32_t dist;
# 79 "/usr/include/lzma/delta.h" 3 4
...
# 304 "/usr/include/lzma.h" 2 3 4
# 1 "/usr/include/lzma/lzma12.h" 1 3 4
# 80 "/usr/include/lzma/lzma12.h" 3 4
typedef enum {
 LZMA_MF_HC3 = 0x03,
# 92 "/usr/include/lzma/lzma12.h" 3 4
 LZMA_MF_HC4 = 0x04,
# 103 "/usr/include/lzma/lzma12.h" 3 4
 LZMA_MF_BT2 = 0x12,
# 112 "/usr/include/lzma/lzma12.h" 3 4
 LZMA_MF_BT3 = 0x13,
# 123 "/usr/include/lzma/lzma12.h" 3 4
 LZMA_MF_BT4 = 0x14
# 133 "/usr/include/lzma/lzma12.h" 3 4
} lzma_match_finder;
# 154 "/usr/include/lzma/lzma12.h" 3 4
extern lzma_bool lzma_mf_is_supported(lzma_match_finder match_finder)
  __attribute__((__nothrow__)) __attribute__((__const__));
# 164 "/usr/include/lzma/lzma12.h" 3 4
typedef enum {
 LZMA_MODE_FAST = 1,
...
# 202 "/usr/include/lzma/lzma12.h" 3 4
extern lzma_bool lzma_mode_is_supported(lzma_mode mode)
  __attribute__((__nothrow__)) __attribute__((__const__));
# 217 "/usr/include/lzma/lzma12.h" 3 4
typedef struct {
# 249 "/usr/include/lzma/lzma12.h" 3 4
 uint32_t dict_size;
# 272 "/usr/include/lzma/lzma12.h" 3 4
 const uint8_t *preset_dict;
# 286 "/usr/include/lzma/lzma12.h" 3 4
 uint32_t preset_dict_size;
# 313 "/usr/include/lzma/lzma12.h" 3 4
 uint32_t lc;
# 325 "/usr/include/lzma/lzma12.h" 3 4
 uint32_t lp;
# 348 "/usr/include/lzma/lzma12.h" 3 4
 uint32_t pb;
 ...
 lzma_mode mode;
# 374 "/usr/include/lzma/lzma12.h" 3 4
 uint32_t nice_len;


 lzma_match_finder mf;
# 407 "/usr/include/lzma/lzma12.h" 3 4
 uint32_t depth;
# 445 "/usr/include/lzma/lzma12.h" 3 4
 uint32_t ext_flags;
# 476 "/usr/include/lzma/lzma12.h" 3 4
...
# 494 "/usr/include/lzma/lzma12.h" 3 4
 uint32_t reserved_int4;
...
# 568 "/usr/include/lzma/lzma12.h" 3 4
...
# 65 "/usr/include/lzma/container.h" 3 4
typedef struct {
# 81 "/usr/include/lzma/container.h" 3 4
 uint32_t flags;
 ...
 uint32_t threads;
# 111 "/usr/include/lzma/container.h" 3 4
 uint64_t block_size;
# 141 "/usr/include/lzma/container.h" 3 4
 uint32_t timeout;
...
# 166 "/usr/include/lzma/container.h" 3 4
 lzma_check check;
# 176 "/usr/include/lzma/container.h" 3 4
 lzma_reserved_enum reserved_enum1;
 ...
 uint32_t reserved_int4;
# 226 "/usr/include/lzma/container.h" 3 4
 uint64_t memlimit_threading;
# 237 "/usr/include/lzma/container.h" 3 4
...
extern lzma_ret lzma_stream_buffer_encode(
  ...
  uint8_t *out, size_t *out_pos, size_t out_size)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 589 "/usr/include/lzma/container.h" 3 4
extern lzma_ret lzma_microlzma_encoder(
  lzma_stream *strm, const lzma_options_lzma *options)
  __attribute__((__nothrow__));
# 715 "/usr/include/lzma/container.h" 3 4
extern lzma_ret lzma_stream_decoder(
  lzma_stream *strm, uint64_t memlimit, uint32_t flags)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 747 "/usr/include/lzma/container.h" 3 4
extern lzma_ret lzma_stream_decoder_mt(
  lzma_stream *strm, const lzma_mt *options)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 786 "/usr/include/lzma/container.h" 3 4
extern lzma_ret lzma_auto_decoder(
  lzma_stream *strm, uint64_t memlimit, uint32_t flags)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 811 "/usr/include/lzma/container.h" 3 4
extern lzma_ret lzma_alone_decoder(
  lzma_stream *strm, uint64_t memlimit)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 871 "/usr/include/lzma/container.h" 3 4
extern lzma_ret lzma_lzip_decoder(
  lzma_stream *strm, uint64_t memlimit, uint32_t flags)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 916 "/usr/include/lzma/container.h" 3 4
extern lzma_ret lzma_stream_buffer_decode(
  ...
  uint8_t *out, size_t *out_pos, size_t out_size)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 965 "/usr/include/lzma/container.h" 3 4
extern lzma_ret lzma_microlzma_decoder(
  lzma_stream *strm, uint64_t comp_size,
  uint64_t uncomp_size, lzma_bool uncomp_size_is_exact,
  uint32_t dict_size) __attribute__((__nothrow__));
# 308 "/usr/include/lzma.h" 2 3 4


# 1 "/usr/include/lzma/stream_flags.h" 1 3 4
# 32 "/usr/include/lzma/stream_flags.h" 3 4
typedef struct {
# 50 "/usr/include/lzma/stream_flags.h" 3 4
 uint32_t version;
# 68 "/usr/include/lzma/stream_flags.h" 3 4
 lzma_vli backward_size;
# 86 "/usr/include/lzma/stream_flags.h" 3 4
 lzma_check check;
# 99 "/usr/include/lzma/stream_flags.h" 3 4
 lzma_reserved_enum reserved_enum1;
...
# 158 "/usr/include/lzma/stream_flags.h" 3 4
extern lzma_ret lzma_stream_header_encode(
  const lzma_stream_flags *options, uint8_t *out)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 176 "/usr/include/lzma/stream_flags.h" 3 4
extern lzma_ret lzma_stream_footer_encode(
  const lzma_stream_flags *options, uint8_t *out)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 212 "/usr/include/lzma/stream_flags.h" 3 4
extern lzma_ret lzma_stream_header_decode(
  lzma_stream_flags *options, const uint8_t *in)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 240 "/usr/include/lzma/stream_flags.h" 3 4
extern lzma_ret lzma_stream_footer_decode(
  lzma_stream_flags *options, const uint8_t *in)
  __attribute__((__nothrow__)) __attribute__((__warn_unused_result__));
# 264 "/usr/include/lzma/stream_flags.h" 3 4
extern lzma_ret lzma_stream_flags_compare(
  const lzma_stream_flags *a, const lzma_stream_flags *b)
  __attribute__((__nothrow__)) __attribute__((__pure__));
# 311 "/usr/include/lzma.h" 2 3 4
# 1 "/usr/include/lzma/block.h" 1 3 4
# 29 "/usr/include/lzma/block.h" 3 4
typedef struct {
# 60 "/usr/include/lzma/block.h" 3 4
 uint32_t version;
# 81 "/usr/include/lzma/block.h" 3 4
 uint32_t header_size;
# 102 "/usr/include/lzma/block.h" 3 4
 lzma_check check;
# 158 "/usr/include/lzma/block.h" 3 4
 lzma_vli compressed_size;
# 183 "/usr/include/lzma/block.h" 3 4
 lzma_vli uncompressed_size;
# 211 "/usr/include/lzma/block.h" 3 4
 lzma_filter *filters;
# 229 "/usr/include/lzma/block.h" 3 4
 uint8_t raw_check[64];
# 240 "/usr/include/lzma/block.h" 3 4
 void *reserved_ptr1;
 ...
 lzma_reserved_enum reserved_enum4;
# 303 "/usr/include/lzma/block.h" 3 4
...
# 368 "/usr/include/lzma/block.h" 3 4
...
# 36 "/usr/include/lzma/index.h" 3 4
...
typedef struct {
 struct {
  ...
  lzma_vli uncompressed_size;
# 112 "/usr/include/lzma/index.h" 3 4
  lzma_vli padding;
...
# 144 "/usr/include/lzma/index.h" 3 4
  lzma_vli compressed_file_offset;
# 159 "/usr/include/lzma/index.h" 3 4
...
# 191 "/usr/include/lzma/index.h" 3 4
  lzma_vli uncompressed_size;
# 200 "/usr/include/lzma/index.h" 3 4
  lzma_vli unpadded_size;
# 209 "/usr/include/lzma/index.h" 3 4
  lzma_vli total_size;
...
# 243 "/usr/include/lzma/index.h" 3 4
 union {
...
# 271 "/usr/include/lzma/index.h" 3 4
 LZMA_INDEX_ITER_STREAM = 1,
# 282 "/usr/include/lzma/index.h" 3 4
 LZMA_INDEX_ITER_BLOCK = 2,
# 293 "/usr/include/lzma/index.h" 3 4
  ...
  const size_t size)
{
  ...
  if (HeapOverflowSanityCheckGetSize(items,size,&extent) != MagickFalse)
    return((void *) 
# 174 "coders/miff.c" 3 4
                   ((void *)0)
# 174 "coders/miff.c"
                       );
  if (extent > GetMaxMemoryRequest())
    return((void *) 
# 176 "coders/miff.c" 3 4
                   ((void *)0)
# 176 "coders/miff.c"
                       );
...
static void *AcquireBZIPMemory(void *,int,int) __attribute__((__malloc__));
...
# 515 "coders/miff.c" 3 4
 , "coders/miff.c", 515, __extension__ __PRETTY_FUNCTION__); }))
# 515 "coders/miff.c"
                                               ;
  
# 516 "coders/miff.c" 3 4
 ((void) sizeof ((
# 516 "coders/miff.c"
...
# 516 "coders/miff.c" 3 4
 , "coders/miff.c", 516, __extension__ __PRETTY_FUNCTION__); }))
# 516 "coders/miff.c"
                                                     ;
  
# 517 "coders/miff.c" 3 4
 ((void) sizeof ((
# 517 "coders/miff.c"
...
# 517 "coders/miff.c" 3 4
 , "coders/miff.c", 517, __extension__ __PRETTY_FUNCTION__); }))
# 517 "coders/miff.c"
                                            ;
  
# 518 "coders/miff.c" 3 4
 ((void) sizeof ((
# 518 "coders/miff.c"
...
# 518 "coders/miff.c" 3 4
 , "coders/miff.c", 518, __extension__ __PRETTY_FUNCTION__); }))
# 518 "coders/miff.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/miff.c",__func__,(unsigned long) 520,"%s",
      image_info->filename);
...
# 527 "coders/miff.c"
  ...
  if (c == 
# 533 "coders/miff.c" 3 4
          (-1)
# 533 "coders/miff.c"
             )
    { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 534,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 534 "coders/miff.c" 3 4
   ((void *)0)
# 534 "coders/miff.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 534 "coders/miff.c" 3 4
   ((void *)0)
# 534 "coders/miff.c"
   ); };
...
# 536 "coders/miff.c" 3 4
                                   ((void *)0)
# 536 "coders/miff.c"
                                       ;
  quantum_info=(QuantumInfo *) 
# 537 "coders/miff.c" 3 4
                              ((void *)0)
# 537 "coders/miff.c"
                                  ;
  ...
  do
  {
    ...
    length=4096;
    options=AcquireString((char *) 
# 548 "coders/miff.c" 3 4
                                  ((void *)0)
# 548 "coders/miff.c"
                                      );
    quantum_format=UndefinedQuantumFormat;
    profiles=(LinkedListInfo *) 
# 550 "coders/miff.c" 3 4
                               ((void *)0)
# 550 "coders/miff.c"
                                   ;
    colors=0;
      ...
      if (c == (int) '{')
        {
          ...
          length=4096;
          comment=AcquireString((char *) 
# 568 "coders/miff.c" 3 4
                                        ((void *)0)
# 568 "coders/miff.c"
                                            );
          for (p=comment; comment != (char *) 
# 569 "coders/miff.c" 3 4
                                             ((void *)0)
# 569 "coders/miff.c"
                                                 ; p++)
          {
            ...
            if ((size_t) (p-comment+1) >= length)
              {
                *p='\0';
                ...
                comment=(char *) ResizeQuantumMemory(comment,
                  OverAllocateMemory(length+4096),sizeof(*comment));
                if (comment == (char *) 
# 583 "coders/miff.c" 3 4
                                       ((void *)0)
# 583 "coders/miff.c"
                                           )
                  break;
...
# 592 "coders/miff.c" 3 4
             ((void *)0)
# 592 "coders/miff.c"
             ) quantum_info=DestroyQuantumInfo(quantum_info); if (compress_pixels != (unsigned char *) 
# 592 "coders/miff.c" 3 4
             ((void *)0)
# 592 "coders/miff.c"
             ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 592,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 592 "coders/miff.c" 3 4
             ((void *)0)
# 592 "coders/miff.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 600 "coders/miff.c"
                                              != MagickFalse)
          {
            ...
            do
            {
              if (c == (int) '=')
                break;
              if ((size_t) (p-keyword) < (4096 -1))
                *p++=(char) c;
              c=ReadBlobByte(image);
            } while (c != 
# 614 "coders/miff.c" 3 4
                         (-1)
# 614 "coders/miff.c"
                            );
            *p='\0';
...
# 649 "coders/miff.c"
                ...
                if (options == (char *) 
# 652 "coders/miff.c" 3 4
                                       ((void *)0)
# 652 "coders/miff.c"
                                           )
                  { if (quantum_info != (QuantumInfo *) 
# 653 "coders/miff.c" 3 4
                 ((void *)0)
# 653 "coders/miff.c"
                 ) quantum_info=DestroyQuantumInfo(quantum_info); if (compress_pixels != (unsigned char *) 
# 653 "coders/miff.c" 3 4
                 ((void *)0)
# 653 "coders/miff.c"
                 ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 653,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 653 "coders/miff.c" 3 4
                 ((void *)0)
# 653 "coders/miff.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 716 "coders/miff.c"
              ...
              case 'G':
              {
                if (LocaleCompare(keyword,"gamma") == 0)
                  {
                    image->gamma=StringToDouble(options,(char **) 
# 819 "coders/miff.c" 3 4
                                                                 ((void *)0)
# 819 "coders/miff.c"
                                                                     );
                    break;
                ...
                if (LocaleCompare(keyword,"id") == 0)
                  {
                    if (*id != '\0')
                      {
                        options=DestroyString(options);
                        if (profiles != (LinkedListInfo *) 
# 855 "coders/miff.c" 3 4
                                                          ((void *)0)
# 855 "coders/miff.c"
                                                              )
...
# 858 "coders/miff.c" 3 4
                       ((void *)0)
# 858 "coders/miff.c"
                       ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 858,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 858 "coders/miff.c" 3 4
                       ((void *)0)
# 858 "coders/miff.c"
                       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 858 "coders/miff.c"
                    ...
                    (void) CopyMagickString(id,options,4096);
                    break;
                  }
...
# 962 "coders/miff.c"
              ...
              case 'V':
              {
                if (LocaleCompare(keyword,"version") == 0)
                  {
                    version=StringToDouble(options,(char **) 
# 1104 "coders/miff.c" 3 4
                                                            ((void *)0)
# 1104 "coders/miff.c"
                                                                );
                    break;
...
# 1135 "coders/miff.c"
    ...
    if ((LocaleCompare(id,"ImageMagick") != 0) ||
        ...
        (image->number_meta_channels > (size_t) (64 -MetaPixelChannels)) ||
        ((image->number_channels+image->number_meta_channels) >= 64) ||
        (image->depth == 0) || (image->depth > 64))
      {
        if (profiles != (LinkedListInfo *) 
# 1152 "coders/miff.c" 3 4
                                          ((void *)0)
# 1152 "coders/miff.c"
                                              )
          profiles=DestroyLinkedList(profiles,RelinquishMagickMemory);
        if (image->previous == (Image *) 
# 1154 "coders/miff.c" 3 4
                                        ((void *)0)
# 1154 "coders/miff.c"
                                            )
          { if (quantum_info != (QuantumInfo *) 
# 1155 "coders/miff.c" 3 4
         ((void *)0)
# 1155 "coders/miff.c"
         ) quantum_info=DestroyQuantumInfo(quantum_info); if (compress_pixels != (unsigned char *) 
# 1155 "coders/miff.c" 3 4
         ((void *)0)
# 1155 "coders/miff.c"
         ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1155,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1155 "coders/miff.c" 3 4
         ((void *)0)
# 1155 "coders/miff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1155 "coders/miff.c"
        ...
        DeleteImageFromList(&image);
        (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1157,
          CorruptImageError,"ImproperImageHeader","`%s'",image->filename);
        break;
      }
    *id='\0';
    if (image->montage != (char *) 
# 1162 "coders/miff.c" 3 4
                                  ((void *)0)
# 1162 "coders/miff.c"
                                      )
      {
        ...
        extent=4096;
        image->directory=AcquireString((char *) 
# 1171 "coders/miff.c" 3 4
                                               ((void *)0)
# 1171 "coders/miff.c"
                                                   );
        p=image->directory;
          ...
          if ((length+4096) >= extent)
            {
              ...
              image->directory=(char *) ResizeQuantumMemory(image->directory,
                extent+4096,sizeof(*image->directory));
              if (image->directory == (char *) 
# 1185 "coders/miff.c" 3 4
                                              ((void *)0)
# 1185 "coders/miff.c"
                                                  )
                { if (quantum_info != (QuantumInfo *) 
# 1186 "coders/miff.c" 3 4
               ((void *)0)
# 1186 "coders/miff.c"
               ) quantum_info=DestroyQuantumInfo(quantum_info); if (compress_pixels != (unsigned char *) 
# 1186 "coders/miff.c" 3 4
               ((void *)0)
# 1186 "coders/miff.c"
               ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1186,(CorruptImageError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1186 "coders/miff.c" 3 4
               ((void *)0)
# 1186 "coders/miff.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1242 "coders/miff.c" 3 4
         ((void *)0)
# 1242 "coders/miff.c"
         ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1242,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1242 "coders/miff.c" 3 4
         ((void *)0)
# 1242 "coders/miff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1244 "coders/miff.c" 3 4
         ((void *)0)
# 1244 "coders/miff.c"
         ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1244,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1244 "coders/miff.c" 3 4
         ((void *)0)
# 1244 "coders/miff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1247 "coders/miff.c" 3 4
         ((void *)0)
# 1247 "coders/miff.c"
         ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1247,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1247 "coders/miff.c" 3 4
         ((void *)0)
# 1247 "coders/miff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
        ...
        if (colors != 0)
          {
            ...
            if (colormap == (unsigned char *) 
# 1258 "coders/miff.c" 3 4
                                             ((void *)0)
# 1258 "coders/miff.c"
                                                 )
              { if (quantum_info != (QuantumInfo *) 
# 1259 "coders/miff.c" 3 4
             ((void *)0)
# 1259 "coders/miff.c"
             ) quantum_info=DestroyQuantumInfo(quantum_info); if (compress_pixels != (unsigned char *) 
# 1259 "coders/miff.c" 3 4
             ((void *)0)
# 1259 "coders/miff.c"
             ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1259,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1259 "coders/miff.c" 3 4
             ((void *)0)
# 1259 "coders/miff.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1259 "coders/miff.c"
    ...
    if (quantum_info == (QuantumInfo *) 
# 1339 "coders/miff.c" 3 4
                                       ((void *)0)
# 1339 "coders/miff.c"
                                           )
      { if (quantum_info != (QuantumInfo *) 
# 1340 "coders/miff.c" 3 4
     ((void *)0)
# 1340 "coders/miff.c"
     ) quantum_info=DestroyQuantumInfo(quantum_info); if (compress_pixels != (unsigned char *) 
# 1340 "coders/miff.c" 3 4
     ((void *)0)
# 1340 "coders/miff.c"
     ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1340,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1340 "coders/miff.c" 3 4
     ((void *)0)
# 1340 "coders/miff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1345 "coders/miff.c" 3 4
         ((void *)0)
# 1345 "coders/miff.c"
         ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1345,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1345 "coders/miff.c" 3 4
         ((void *)0)
# 1345 "coders/miff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1345 "coders/miff.c"
    ...
    compress_extent=((((((((packet_size* image->columns)+((packet_size* image->columns)/100)+600)) > (((packet_size*image->columns)+((packet_size*image->columns)/3)+128))) ? (((packet_size* image->columns)+((packet_size* image->columns)/100)+600)) : (((packet_size*image->columns)+((packet_size*image->columns)/3)+128)))) > (((packet_size*image->columns)+(((packet_size*image->columns)+7) >> 3)+(((packet_size*image->columns)+63) >> 6)+11))) ? ((((((packet_size* image->columns)+((packet_size* image->columns)/100)+600)) > (((packet_size*image->columns)+((packet_size*image->columns)/3)+128))) ? (((packet_size* image->columns)+((packet_size* image->columns)/100)+600)) : (((packet_size*image->columns)+((packet_size*image->columns)/3)+128)))) : (((packet_size*image->columns)+(((packet_size*image->columns)+7) >> 3)+(((packet_size*image->columns)+63) >> 6)+11)))

                                               ;
    if (compress_extent < (packet_size*image->columns))
      { if (quantum_info != (QuantumInfo *) 
# 1364 "coders/miff.c" 3 4
     ((void *)0)
# 1364 "coders/miff.c"
     ) quantum_info=DestroyQuantumInfo(quantum_info); if (compress_pixels != (unsigned char *) 
# 1364 "coders/miff.c" 3 4
     ((void *)0)
# 1364 "coders/miff.c"
     ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1364,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1364 "coders/miff.c" 3 4
     ((void *)0)
# 1364 "coders/miff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1364 "coders/miff.c"
    ...
    if (compress_pixels == (unsigned char *) 
# 1367 "coders/miff.c" 3 4
                                            ((void *)0)
# 1367 "coders/miff.c"
                                                )
      { if (quantum_info != (QuantumInfo *) 
# 1368 "coders/miff.c" 3 4
     ((void *)0)
# 1368 "coders/miff.c"
     ) quantum_info=DestroyQuantumInfo(quantum_info); if (compress_pixels != (unsigned char *) 
# 1368 "coders/miff.c" 3 4
     ((void *)0)
# 1368 "coders/miff.c"
     ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1368,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1368 "coders/miff.c" 3 4
     ((void *)0)
# 1368 "coders/miff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
            ...
            if (bzip_info.avail_in == 0)
              {
                ...
                length=(size_t) ((packet_size*image->columns)+((packet_size*image->columns)/100)+600);
                if (version != 0.0)
...
# 1503 "coders/miff.c" 3 4
                   ((void *)0)
# 1503 "coders/miff.c"
                   ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1503,(CorruptImageError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1503 "coders/miff.c" 3 4
                   ((void *)0)
# 1503 "coders/miff.c"
                   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1508 "coders/miff.c"
            ...
            if (code == 
# 1513 "coders/miff.c" 3 4
                       4
# 1513 "coders/miff.c"
                                    )
              break;
          } while (bzip_info.avail_out != 0);
          extent=ImportQuantumPixels(image,(CacheView *) 
# 1516 "coders/miff.c" 3 4
                                                        ((void *)0)
# 1516 "coders/miff.c"
                                                            ,quantum_info,
...
# 1542 "coders/miff.c" 3 4
                   ((void *)0)
# 1542 "coders/miff.c"
                   ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1542,(CorruptImageError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1542 "coders/miff.c" 3 4
                   ((void *)0)
# 1542 "coders/miff.c"
                   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1542 "coders/miff.c"
            ...
            if ((code != 0) && (code != LZMA_STREAM_END))
              {
                status=MagickFalse;
                break;
              }
            ...
            if (zip_info.avail_in == 0)
              {
                ...
                length=(size_t) ((packet_size*image->columns)+(((packet_size*image->columns)+7) >> 3)+(((packet_size*image->columns)+63) >> 6)+11);
                if (version != 0.0)
                  length=(size_t) ReadBlobMSBLong(image);
                if (length <= compress_extent)
...
# 1584 "coders/miff.c" 3 4
                   ((void *)0)
# 1584 "coders/miff.c"
                   ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1584,(CorruptImageError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1584 "coders/miff.c" 3 4
                   ((void *)0)
# 1584 "coders/miff.c"
                   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1584 "coders/miff.c"
            ...
            code=inflate(&zip_info,
# 1588 "coders/miff.c" 3 4
                                  2
# 1588 "coders/miff.c"
                                              );
            if ((code != 
# 1589 "coders/miff.c" 3 4
                        0
# 1589 "coders/miff.c"
                            ) && (code != 
# 1589 "coders/miff.c" 3 4
...
# 1610 "coders/miff.c" 3 4
                 ((void *)0)
# 1610 "coders/miff.c"
                 ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1610,(CorruptImageError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1610 "coders/miff.c" 3 4
                 ((void *)0)
# 1610 "coders/miff.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1638 "coders/miff.c" 3 4
           ((void *)0)
# 1638 "coders/miff.c"
           ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1638,(CorruptImageError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1638 "coders/miff.c" 3 4
           ((void *)0)
# 1638 "coders/miff.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1668 "coders/miff.c" 3 4
               ((void *)0)
# 1668 "coders/miff.c"
               ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1668,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1668 "coders/miff.c" 3 4
               ((void *)0)
# 1668 "coders/miff.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1672 "coders/miff.c"
      ...
      case LZMACompression:
      {
        ...
        if ((code != LZMA_STREAM_END) && (code != 0))
          status=MagickFalse;
        lzma_end(&lzma_info);
        break;
      }
...
# 1707 "coders/miff.c" 3 4
               ((void *)0)
# 1707 "coders/miff.c"
               ) compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels); { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1707,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1707 "coders/miff.c" 3 4
               ((void *)0)
# 1707 "coders/miff.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1728 "coders/miff.c" 3 4
       (*__errno_location ())
# 1728 "coders/miff.c"
       ); (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 1728,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 1748 "coders/miff.c"
        ...
        status=SetImageProgress(image,"Load/Images",TellBlob(image),
          GetBlobSize(image));
        if (status == MagickFalse)
          break;
      }
  } while (c != 
# 1759 "coders/miff.c" 3 4
               (-1) 
# 1759 "coders/miff.c"
                   && ((c == 'i') || (c == 'I')));
...
# 1789 "coders/miff.c"
__attribute__ ((visibility ("default"))) size_t RegisterMIFFImage(void)
{
  char
    version[4096];
...
# 1838 "coders/miff.c"
__attribute__ ((visibility ("default"))) void UnregisterMIFFImage(void)
{
...
# 2100 "coders/miff.c"
 "image_info != (const ImageInfo *) NULL"
# 2100 "coders/miff.c" 3 4
 , "coders/miff.c", 2100, __extension__ __PRETTY_FUNCTION__); }))
# 2100 "coders/miff.c"
                                               ;
  
# 2101 "coders/miff.c" 3 4
 ((void) sizeof ((
# 2101 "coders/miff.c"
 image_info->signature == 0xabacadabUL
# 2101 "coders/miff.c" 3 4
...
# 2101 "coders/miff.c"
 "image_info->signature == MagickCoreSignature"
# 2101 "coders/miff.c" 3 4
 , "coders/miff.c", 2101, __extension__ __PRETTY_FUNCTION__); }))
# 2101 "coders/miff.c"
                                                     ;
  
# 2102 "coders/miff.c" 3 4
 ((void) sizeof ((
# 2102 "coders/miff.c"
 image != (Image *) 
# 2102 "coders/miff.c" 3 4
...
# 2102 "coders/miff.c"
 "image != (Image *) NULL"
# 2102 "coders/miff.c" 3 4
 , "coders/miff.c", 2102, __extension__ __PRETTY_FUNCTION__); }))
# 2102 "coders/miff.c"
                                ;
  
# 2103 "coders/miff.c" 3 4
 ((void) sizeof ((
# 2103 "coders/miff.c"
...
# 2103 "coders/miff.c" 3 4
 , "coders/miff.c", 2103, __extension__ __PRETTY_FUNCTION__); }))
# 2103 "coders/miff.c"
                                                ;
  
# 2104 "coders/miff.c" 3 4
 ((void) sizeof ((
# 2104 "coders/miff.c"
 exception != (ExceptionInfo *) 
# 2104 "coders/miff.c" 3 4
...
# 2104 "coders/miff.c"
 "exception != (ExceptionInfo *) NULL"
# 2104 "coders/miff.c" 3 4
 , "coders/miff.c", 2104, __extension__ __PRETTY_FUNCTION__); }))
# 2104 "coders/miff.c"
                                            ;
  
# 2105 "coders/miff.c" 3 4
 ((void) sizeof ((
# 2105 "coders/miff.c"
 exception->signature == 0xabacadabUL
# 2105 "coders/miff.c" 3 4
...
# 2105 "coders/miff.c"
 "exception->signature == MagickCoreSignature"
# 2105 "coders/miff.c" 3 4
 , "coders/miff.c", 2105, __extension__ __PRETTY_FUNCTION__); }))
# 2105 "coders/miff.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/miff.c",__func__,(unsigned long) 2107,"%s",image->filename);
  ...
  do
  {
    ...
    quantum_info=AcquireQuantumInfo(image_info,image);
    if (quantum_info == (QuantumInfo *) 
# 2123 "coders/miff.c" 3 4
                                       ((void *)0)
# 2123 "coders/miff.c"
                                           )
      { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 2124,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2124 "coders/miff.c" 3 4
     ((void *)0)
# 2124 "coders/miff.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    if ((image->storage_class != PseudoClass) && (image->depth >= 16) &&
        ...
        (IsHighDynamicRangeImage(image,exception) != MagickFalse))
      {
        ...
        if (status == MagickFalse)
          {
            quantum_info=DestroyQuantumInfo(quantum_info);
            { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 2133,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2133 "coders/miff.c" 3 4
           ((void *)0)
# 2133 "coders/miff.c"
           ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
          }
...
# 2158 "coders/miff.c"
    ...
    if (image->number_meta_channels != 0)
      packet_size+=image->number_meta_channels*image->depth/8;
    length=(((((packet_size*image->columns)+((packet_size*image->columns)/100)+600)) > (((packet_size*image->columns)+(((packet_size*image->columns)+7) >> 3)+(((packet_size*image->columns)+63) >> 6)+11))) ? (((packet_size*image->columns)+((packet_size*image->columns)/100)+600)) : (((packet_size*image->columns)+(((packet_size*image->columns)+7) >> 3)+(((packet_size*image->columns)+63) >> 6)+11)))
                                  ;
    ...
    compress_pixels=(unsigned char *) AcquireQuantumMemory(length,
      sizeof(*compress_pixels));
    if (compress_pixels == (unsigned char *) 
# 2188 "coders/miff.c" 3 4
                                            ((void *)0)
# 2188 "coders/miff.c"
                                                )
      { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 2189,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2189 "coders/miff.c" 3 4
     ((void *)0)
# 2189 "coders/miff.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    ...
    if (image->type != UndefinedType)
      {
        (void) FormatLocaleString(buffer,4096,"type=%s\n",
          CommandOptionToMnemonic(MagickTypeOptions,image->type));
        (void) WriteBlobString(image,buffer);
      }
    if (image->colorspace != UndefinedColorspace)
      {
        (void) FormatLocaleString(buffer,4096,"colorspace=%s\n",
    ...
    if (image->endian != UndefinedEndian)
      {
        (void) FormatLocaleString(buffer,4096,"endian=%s\n",
          CommandOptionToMnemonic(MagickEndianOptions,image->endian));
        (void) WriteBlobString(image,buffer);
      }
    if (compression != UndefinedCompression)
      {
        (void) FormatLocaleString(buffer,4096,"compression=%s  "
    ...
    if (image->units != UndefinedResolution)
      {
        (void) FormatLocaleString(buffer,4096,"units=%s\n",
    ...
    if ((image->page.width != 0) || (image->page.height != 0))
      ...
      if ((image->page.x != 0) || (image->page.y != 0))
        {
          (void) FormatLocaleString(buffer,4096,"page=%+ld%+ld\n",
    ...
    if ((GetNextImageInList(image) != (Image *) 
# 2276 "coders/miff.c" 3 4
                                               ((void *)0)
# 2276 "coders/miff.c"
                                                   ) ||
        (GetPreviousImageInList(image) != (Image *) 
# 2277 "coders/miff.c" 3 4
                                                   ((void *)0)
# 2277 "coders/miff.c"
                                                       ))
      {
        if (image->scene == 0)
          (void) FormatLocaleString(buffer,4096,"iterations=%.20g "
            "delay=%.20g ticks-per-second=%.20g\n",(double) image->iterations,
            (double) image->delay,(double) image->ticks_per_second);
        else
          (void) FormatLocaleString(buffer,4096,"scene=%.20g  "
    ...
    else
      {
        ...
        if (image->delay != 0)
          {
            (void) FormatLocaleString(buffer,4096,"delay=%.20g\n",
              (double) image->delay);
            (void) WriteBlobString(image,buffer);
          }
        if (image->ticks_per_second != 100L)
          {
            (void) FormatLocaleString(buffer,4096,
    ...
    if (image->gravity != UndefinedGravity)
      {
        (void) FormatLocaleString(buffer,4096,"gravity=%s\n",
          CommandOptionToMnemonic(MagickGravityOptions,image->gravity));
        (void) WriteBlobString(image,buffer);
      }
    if (image->dispose != UndefinedDispose)
      {
        (void) FormatLocaleString(buffer,4096,"dispose=%s\n",
    ...
    if (image->gamma != 0.0)
      {
        (void) FormatLocaleString(buffer,4096,"gamma=%g\n",
          image->gamma);
        (void) WriteBlobString(image,buffer);
      }
    if (image->chromaticity.white_point.x != 0.0)
      {
        ...
        (void) FormatLocaleString(buffer,4096,"red-primary=%g,%g "
    ...
    if (image->orientation != UndefinedOrientation)
      {
        (void) FormatLocaleString(buffer,4096,"orientation=%s\n",
          CommandOptionToMnemonic(MagickOrientationOptions,image->orientation));
        (void) WriteBlobString(image,buffer);
      }
    if (image->profiles != (void *) 
# 2366 "coders/miff.c" 3 4
                                   ((void *)0)
# 2366 "coders/miff.c"
                                       )
      {
        ...
        for (name=GetNextImageProfile(image); name != (const char *) 
# 2378 "coders/miff.c" 3 4
                                                                    ((void *)0)
# 2378 "coders/miff.c"
                                                                        ; )
        {
          ...
          if (profile != (StringInfo *) 
# 2381 "coders/miff.c" 3 4
                                       ((void *)0)
# 2381 "coders/miff.c"
                                           )
            {
              (void) FormatLocaleString(buffer,4096,"profile=%s\n",
                name);
              (void) WriteBlobString(image,buffer);
            }
    ...
    if (image->montage != (char *) 
# 2390 "coders/miff.c" 3 4
                                  ((void *)0)
# 2390 "coders/miff.c"
                                      )
      {
        (void) FormatLocaleString(buffer,4096,"montage=%s\n",
          image->montage);
        (void) WriteBlobString(image,buffer);
      }
    if (quantum_info->format == FloatingPointQuantumFormat)
    ...
    while (property != (const char *) 
# 2401 "coders/miff.c" 3 4
                                     ((void *)0)
# 2401 "coders/miff.c"
                                         )
    {
      (void) FormatLocaleString(buffer,4096,"%s=",property);
      (void) WriteBlobString(image,buffer);
      value=GetImageProperty(image,property,exception);
      if (value != (const char *) 
# 2406 "coders/miff.c" 3 4
                                 ((void *)0)
# 2406 "coders/miff.c"
                                     )
        {
...
# 2410 "coders/miff.c"
          ...
          if ((i == (ssize_t) length) && (i != 0))
          ...
          else
            {
              ...
              if (strchr(value,'}') == (char *) 
# 2418 "coders/miff.c" 3 4
                                               ((void *)0)
# 2418 "coders/miff.c"
                                                   )
                (void) WriteBlob(image,length,(const unsigned char *) value);
    ...
    if (image->storage_class == PseudoClass)
      {
        ...
        if (colormap == (unsigned char *) 
# 2481 "coders/miff.c" 3 4
                                         ((void *)0)
# 2481 "coders/miff.c"
                                             )
          { (void) ThrowMagickException(exception,"coders/miff.c",__func__,(unsigned long) 2482,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2482 "coders/miff.c" 3 4
         ((void *)0)
# 2482 "coders/miff.c"
         ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    ...
    switch (compression)
    {
      ...
      case BZipCompression:
      {
        ...
        bzip_info.bzalloc=AcquireBZIPMemory;
        bzip_info.bzfree=RelinquishBZIPMemory;
        bzip_info.opaque=(void *) 
# 2560 "coders/miff.c" 3 4
                                 ((void *)0)
# 2560 "coders/miff.c"
                                     ;
        code=BZ2_bzCompressInit(&bzip_info,(int) (image->quality ==
          0UL ? 7 : (((image->quality/10) < (9)) ? (image->quality/10) : (9))),
          (int) image_info->verbose,0);
        if (code != 
# 2564 "coders/miff.c" 3 4
                   0
# 2564 "coders/miff.c"
                        )
          status=MagickFalse;
      ...
      case LZMACompression:
      {
        ...
        allocator.alloc=AcquireLZMAMemory;
        allocator.free=RelinquishLZMAMemory;
        allocator.opaque=(void *) 
# 2577 "coders/miff.c" 3 4
                                 ((void *)0)
# 2577 "coders/miff.c"
                                     ;
        lzma_info=initialize_lzma;
      ...
      case ZipCompression:
      {
        ...
        zip_info.zalloc=AcquireZIPMemory;
        zip_info.zfree=RelinquishZIPMemory;
        zip_info.opaque=(void *) 
# 2596 "coders/miff.c" 3 4
                                ((void *)0)
# 2596 "coders/miff.c"
                                    ;
        code=
# 2597 "coders/miff.c" 3 4
            deflateInit_((
# 2597 "coders/miff.c"
            &zip_info
# 2597 "coders/miff.c" 3 4
...
# 2597 "coders/miff.c"
            (int) (image->quality == 0UL ? 7 : (((image->quality/10) < (9)) ? (image->quality/10) : (9)))
# 2597 "coders/miff.c" 3 4
            ), "1.3.1", (int)sizeof(z_stream))
...
# 2622 "coders/miff.c"
      ...
      switch (compression)
      {
        ...
        case BZipCompression:
        {
          ...
          (void) ExportQuantumPixels(image,(CacheView *) 
# 2632 "coders/miff.c" 3 4
                                                        ((void *)0)
# 2632 "coders/miff.c"
                                                            ,quantum_info,
            quantum_type,pixels,exception);
          do
          {
            ...
            bzip_info.avail_out=(unsigned int) ((packet_size* image->columns)+((packet_size* image->columns)/100)+600)
                             ;
            code=BZ2_bzCompress(&bzip_info,
# 2642 "coders/miff.c" 3 4
                                          1
# 2642 "coders/miff.c"
                                                  );
            if (code < 0)
...
# 2661 "coders/miff.c"
          ...
          do
          {
            ...
            lzma_info.avail_out=((packet_size*image->columns)+((packet_size*image->columns)/3)+128);
            code=(int) lzma_code(&lzma_info,LZMA_RUN);
            if (code != 0)
              status=MagickFalse;
...
# 2690 "coders/miff.c"
          ...
          do
          {
            ...
            zip_info.avail_out=(uInt) ((packet_size*image->columns)+(((packet_size*image->columns)+7) >> 3)+(((packet_size*image->columns)+63) >> 6)+11);
            code=deflate(&zip_info,
# 2699 "coders/miff.c" 3 4
                                  2
# 2699 "coders/miff.c"
                                              );
            if (code != 
# 2700 "coders/miff.c" 3 4
                       0
# 2700 "coders/miff.c"
                           )
              status=MagickFalse;
...
# 2739 "coders/miff.c"
      ...
      if (image->previous == (Image *) 
# 2751 "coders/miff.c" 3 4
                                      ((void *)0)
# 2751 "coders/miff.c"
                                          )
        {
          status=SetImageProgress(image,"Save/Image",(MagickOffsetType) y,
            image->rows);
          if (status == MagickFalse)
            break;
        }
...
# 2840 "coders/miff.c"
    ...
    compress_pixels=(unsigned char *) RelinquishMagickMemory(compress_pixels);
    if (GetNextImageInList(image) == (Image *) 
# 2850 "coders/miff.c" 3 4
                                              ((void *)0)
# 2850 "coders/miff.c"
                                                  )
      break;
    image=SyncNextImageInList(image);
    status=SetImageProgress(image,"Save/Images",scene++,number_scenes);
    if (status == MagickFalse)
      break;
