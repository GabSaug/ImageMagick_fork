  ...
  MagickBooleanType *err)
{
  ...
  if (chIn == 
# 191 "coders/ftxt.c" 3 4
             (-1)
# 191 "coders/ftxt.c"
                )
    *eofInp = MagickTrue;
  while (
# 193 "coders/ftxt.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 193 "coders/ftxt.c"
        chIn
# 193 "coders/ftxt.c" 3 4
...
# 216 "coders/ftxt.c" 3 4
 (*__errno_location ())
# 216 "coders/ftxt.c"
      =0;
  val=strtol(buffer,&tail,10);
  if (
# 218 "coders/ftxt.c" 3 4
     (*__errno_location ()) 
# 218 "coders/ftxt.c"
           || *tail)
    {
...
# 273 "coders/ftxt.c" 3 4
     (*__errno_location ())
# 273 "coders/ftxt.c"
          =0;
      val=strtold(buffer,tail);
      if (
# 275 "coders/ftxt.c" 3 4
         (*__errno_location ())
# 275 "coders/ftxt.c"
              )
        *err=MagickTrue;
      if (**tail=='%')
        {
          (*tail)++;
          val*=(double) ((Quantum) 65535.0)/100.0;
...
# 297 "coders/ftxt.c"
  ...
  while ((chIn != UntilChar) && (chIn != 
# 303 "coders/ftxt.c" 3 4
                                        (-1)
# 303 "coders/ftxt.c"
                                           ))
    chIn=ReadChar(image,chPushed);
  if (chIn == 
# 305 "coders/ftxt.c" 3 4
             (-1)
# 305 "coders/ftxt.c"
                )
    {
...
# 400 "coders/ftxt.c" 3 4
 , "coders/ftxt.c", 400, __extension__ __PRETTY_FUNCTION__); }))
# 400 "coders/ftxt.c"
                                               ;
  
# 401 "coders/ftxt.c" 3 4
 ((void) sizeof ((
# 401 "coders/ftxt.c"
...
# 401 "coders/ftxt.c" 3 4
 , "coders/ftxt.c", 401, __extension__ __PRETTY_FUNCTION__); }))
# 401 "coders/ftxt.c"
                                                     ;
  
# 402 "coders/ftxt.c" 3 4
 ((void) sizeof ((
# 402 "coders/ftxt.c"
...
# 402 "coders/ftxt.c" 3 4
 , "coders/ftxt.c", 402, __extension__ __PRETTY_FUNCTION__); }))
# 402 "coders/ftxt.c"
                                            ;
  
# 403 "coders/ftxt.c" 3 4
 ((void) sizeof ((
# 403 "coders/ftxt.c"
...
# 403 "coders/ftxt.c" 3 4
 , "coders/ftxt.c", 403, __extension__ __PRETTY_FUNCTION__); }))
# 403 "coders/ftxt.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ftxt.c",__func__,(unsigned long) 405,"%s",
      image_info->filename);
...
# 412 "coders/ftxt.c"
  ...
  if (sFmt == (const char *) 
# 417 "coders/ftxt.c" 3 4
                            ((void *)0)
# 417 "coders/ftxt.c"
                                )
    sFmt="\\x,\\y:\\c\\n";
  sChSep=GetImageArtifact(image,"ftxt:chsep");
  if (sChSep == (const char *) 
# 420 "coders/ftxt.c" 3 4
                              ((void *)0)
# 420 "coders/ftxt.c"
                                  )
    sChSep=",";
  if ((sChSep[0] == '\\') && ((sChSep[1] == 'n' || sChSep[1] == 'N')))
    chSep='\n';
  else
    chSep=sChSep[0];
  ...
  if (sNumMeta != (const char *) 
# 429 "coders/ftxt.c" 3 4
                                ((void *)0)
# 429 "coders/ftxt.c"
                                    )
  ...
  if (hasAlpha)
    {
      if (SetImageAlphaChannel(image,OpaqueAlphaChannel,exception) == MagickFalse)
        { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 434,OptionError,"SetImageAlphaChannelFailure", "`%s'",image_info->filename); if ((image) != (Image *) 
# 434 "coders/ftxt.c" 3 4
       ((void *)0)
# 434 "coders/ftxt.c"
  ...
  if (numMeta)
    {
      if (SetPixelMetaChannels (image, (size_t) numMeta, exception) == MagickFalse)
        { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 439,OptionError,"SetPixelMetaChannelsFailure", "`%s'",image_info->filename); if ((image) != (Image *) 
# 439 "coders/ftxt.c" 3 4
       ((void *)0)
# 439 "coders/ftxt.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 439 "coders/ftxt.c" 3 4
    ...
    if (*pf == '\\')
      {
        ...
        switch (*pf) {
          case '\\':
            if (++i >= 4096)
              { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 457,DelegateFatalError,"ppf bust", "`%s'",image_info->filename); if ((image) != (Image *) 
# 457 "coders/ftxt.c" 3 4
             ((void *)0)
# 457 "coders/ftxt.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 457 "coders/ftxt.c" 3 4
...
# 457 "coders/ftxt.c"
          ...
          case 'n':
            if (++i >= 4096)
              { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 463,DelegateFatalError,"ppf bust", "`%s'",image_info->filename); if ((image) != (Image *) 
# 463 "coders/ftxt.c" 3 4
             ((void *)0)
# 463 "coders/ftxt.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 463 "coders/ftxt.c" 3 4
...
# 463 "coders/ftxt.c"
          ...
          case 'j':
            if (*(pf+1)=='\0')
              { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 469,DelegateFatalError,"EscapeJproblem", "`%s'",image_info->filename); if ((image) != (Image *) 
# 469 "coders/ftxt.c" 3 4
             ((void *)0)
# 469 "coders/ftxt.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 469 "coders/ftxt.c" 3 4
...
# 469 "coders/ftxt.c"
          ...
          default:
            if ((i+=2) >= 4096)
              { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 473,DelegateFatalError,"ppf bust", "`%s'",image_info->filename); if ((image) != (Image *) 
# 473 "coders/ftxt.c" 3 4
             ((void *)0)
# 473 "coders/ftxt.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 473 "coders/ftxt.c" 3 4
...
# 473 "coders/ftxt.c"
    ...
    else
      {
        ...
        if (++i >= 4096)
          { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 485,DelegateFatalError,"ppf bust", "`%s'",image_info->filename); if ((image) != (Image *) 
# 485 "coders/ftxt.c" 3 4
         ((void *)0)
# 485 "coders/ftxt.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 485 "coders/ftxt.c" 3 4
...
# 485 "coders/ftxt.c"
  ...
  *ppf='\0';
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 493,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 493 "coders/ftxt.c" 3 4
   ((void *)0)
# 493 "coders/ftxt.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 493 "coders/ftxt.c" 3 4
...
# 630 "coders/ftxt.c"
            ...
            case 's':
            {
              ...
              if (eofInp != MagickFalse)
                break;
              if (*buffer == 0)
                { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 660,CorruptImageError,"No input for escape 'H' or 's'.", "`%s'",image_info->filename); if ((image) != (Image *) 
# 660 "coders/ftxt.c" 3 4
               ((void *)0)
# 660 "coders/ftxt.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 660 "coders/ftxt.c" 3 4
...
# 668 "coders/ftxt.c"
      ...
      else
        {
          ...
          chIn=ReadChar(image,&chPushed);
          if (chIn == 
# 684 "coders/ftxt.c" 3 4
                     (-1)
# 684 "coders/ftxt.c"
                        )
            {
              if (ppf != procFmt)
                { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 687,CorruptImageError,"EOFduringFormat", "`%s'",image_info->filename); if ((image) != (Image *) 
# 687 "coders/ftxt.c" 3 4
               ((void *)0)
# 687 "coders/ftxt.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 687 "coders/ftxt.c" 3 4
              ...
              if ((chIn == '\r') && (*ppf == '\n'))
                {
                  chIn=ReadChar(image,&chPushed);
                  if (chIn != '\n')
                    { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 696,CorruptImageError,"BackslashRbad", "`%s'",image_info->filename); if ((image) != (Image *) 
# 696 "coders/ftxt.c" 3 4
                   ((void *)0)
# 696 "coders/ftxt.c"
                   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 696 "coders/ftxt.c" 3 4
...
# 696 "coders/ftxt.c"
              ...
              if (chIn != *ppf)
                { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 699,CorruptImageError,"UnexpectedInputChar", "`%s'",image_info->filename); if ((image) != (Image *) 
# 699 "coders/ftxt.c" 3 4
               ((void *)0)
# 699 "coders/ftxt.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 699 "coders/ftxt.c" 3 4
...
# 699 "coders/ftxt.c"
  ...
  if (intErr != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 723,CorruptImageError,"ParseIntegerError", "`%s'",image_info->filename); if ((image) != (Image *) 
# 723 "coders/ftxt.c" 3 4
   ((void *)0)
# 723 "coders/ftxt.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 723 "coders/ftxt.c" 3 4
...
# 723 "coders/ftxt.c"
  ...
  if (typeErr != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 725,CorruptImageError,"TypeError", "`%s'",image_info->filename); if ((image) != (Image *) 
# 725 "coders/ftxt.c" 3 4
   ((void *)0)
# 725 "coders/ftxt.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 725 "coders/ftxt.c" 3 4
...
# 725 "coders/ftxt.c"
  ...
  if (chPushed != 0)
    { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 727,CorruptImageError,"UnusedPushedChar", "`%s'",image_info->filename); if ((image) != (Image *) 
# 727 "coders/ftxt.c" 3 4
   ((void *)0)
# 727 "coders/ftxt.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 727 "coders/ftxt.c" 3 4
...
# 727 "coders/ftxt.c"
  ...
  if ((maxX < 0) && (maxY < 0))
    { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 729,CorruptImageError,"UnexpectedEof", "`%s'",image_info->filename); if ((image) != (Image *) 
# 729 "coders/ftxt.c" 3 4
   ((void *)0)
# 729 "coders/ftxt.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 729 "coders/ftxt.c" 3 4
...
# 729 "coders/ftxt.c"
  ...
  if (nChErr != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 731,CorruptImageError,"NumChannelsError", "`%s'",image_info->filename); if ((image) != (Image *) 
# 731 "coders/ftxt.c" 3 4
   ((void *)0)
# 731 "coders/ftxt.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 731 "coders/ftxt.c" 3 4
...
# 731 "coders/ftxt.c"
  ...
  if (nPix > (ssize_t) (image->columns * image->rows))
    ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 733,CorruptImageWarning,
      "TooManyPixels","`%s'",image_info->filename);
  else if ((maxX >= (ssize_t) image->columns) ||
           (maxY >= (ssize_t) image->rows))
    ThrowMagickException(exception,"coders/ftxt.c",__func__,(unsigned long) 737,CorruptImageWarning,
...
# 769 "coders/ftxt.c"
__attribute__ ((visibility ("default"))) size_t RegisterFTXTImage(void)
{
  MagickInfo
    *entry;
...
# 802 "coders/ftxt.c"
__attribute__ ((visibility ("default"))) void UnregisterFTXTImage(void)
{
...
# 861 "coders/ftxt.c"
 "image_info != (const ImageInfo *) NULL"
# 861 "coders/ftxt.c" 3 4
 , "coders/ftxt.c", 861, __extension__ __PRETTY_FUNCTION__); }))
# 861 "coders/ftxt.c"
                                               ;
  
# 862 "coders/ftxt.c" 3 4
 ((void) sizeof ((
# 862 "coders/ftxt.c"
 image_info->signature == 0xabacadabUL
# 862 "coders/ftxt.c" 3 4
...
# 862 "coders/ftxt.c"
 "image_info->signature == MagickCoreSignature"
# 862 "coders/ftxt.c" 3 4
 , "coders/ftxt.c", 862, __extension__ __PRETTY_FUNCTION__); }))
# 862 "coders/ftxt.c"
                                                     ;
  
# 863 "coders/ftxt.c" 3 4
 ((void) sizeof ((
# 863 "coders/ftxt.c"
 image != (Image *) 
# 863 "coders/ftxt.c" 3 4
...
# 863 "coders/ftxt.c"
 "image != (Image *) NULL"
# 863 "coders/ftxt.c" 3 4
 , "coders/ftxt.c", 863, __extension__ __PRETTY_FUNCTION__); }))
# 863 "coders/ftxt.c"
                                ;
  
# 864 "coders/ftxt.c" 3 4
 ((void) sizeof ((
# 864 "coders/ftxt.c"
...
# 864 "coders/ftxt.c" 3 4
 , "coders/ftxt.c", 864, __extension__ __PRETTY_FUNCTION__); }))
# 864 "coders/ftxt.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ftxt.c",__func__,(unsigned long) 866,"%s",image->filename);
        ...
        while (*pFmt)
        {
          if (*pFmt == '\\')
          {
            ...
            switch (*pFmt)
            {
              case 'x':
              {
                FormatLocaleString(buffer,4096,"%li",x);
                WriteBlobString(image,buffer);
                break;
              }
              case 'y':
              {
                FormatLocaleString (buffer,4096,"%li",y);
                WriteBlobString(image,buffer);
                break;
              }
              case 'n':
              ...
              case '\\':
              {
                FormatLocaleString(buffer,4096,"%c%c",'\\','\\');
                WriteBlobString(image,buffer);
                break;
              }
              case 'c':
              ...
              case 'f':
              {
                ...
                if (*pFmt == 'c')
                  ...
                  {
                    valMult=100*((double) 1.0/(double) ((Quantum) 65535.0));
                    sSuff[0]='%';
                  }
                else if (*pFmt == 'o')
                  valMult=((double) 1.0/(double) ((Quantum) 65535.0));
                else if (*pFmt == 'h')
                  {
                    valMult=1.0;
                    hexFmt=MagickTrue;
                ...
                for (i=0; i < (ssize_t) GetPixelChannels (image); i++)
                {
                  ...
                  if ((traits & UpdatePixelTrait) != UpdatePixelTrait)
                    continue;
                  if (hexFmt)
                    FormatLocaleString(buffer,4096,"%s#%llx",sSep,
                      (signed long long)(((long double) p[i])+0.5));
                  else if (fltHexFmt)
                    FormatLocaleString(buffer,4096,"%s%a",sSep,
                      (double) p[i]);
                  else
                    FormatLocaleString(buffer,4096,"%s%.*g%s",sSep,
...
# 1045 "coders/ftxt.c" 3 4
                                       ((void *)0)
# 1045 "coders/ftxt.c"
                                           ) &&
          (image->progress_monitor != (MagickProgressMonitor) 
# 1046 "coders/ftxt.c" 3 4
                                                             ((void *)0)
# 1046 "coders/ftxt.c"
                                                                 ) &&
          (QuantumTick(y,image->rows) != MagickFalse))
        {
          status=image->progress_monitor("Save/Image",y,image->rows,
            image->client_data);
          if (status == MagickFalse)
            break;
        }
...
# 1055 "coders/ftxt.c" 3 4
                                              ((void *)0)
# 1055 "coders/ftxt.c"
                                                  )
      break;
    image=SyncNextImageInList(image);
    status=SetImageProgress(image,"Save/Images",scene,
