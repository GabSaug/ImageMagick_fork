...
# 195 "coders/rle.c" 3 4
 , "coders/rle.c", 195, __extension__ __PRETTY_FUNCTION__); }))
# 195 "coders/rle.c"
                                               ;
  
# 196 "coders/rle.c" 3 4
 ((void) sizeof ((
# 196 "coders/rle.c"
...
# 196 "coders/rle.c" 3 4
 , "coders/rle.c", 196, __extension__ __PRETTY_FUNCTION__); }))
# 196 "coders/rle.c"
                                                     ;
  
# 197 "coders/rle.c" 3 4
 ((void) sizeof ((
# 197 "coders/rle.c"
...
# 197 "coders/rle.c" 3 4
 , "coders/rle.c", 197, __extension__ __PRETTY_FUNCTION__); }))
# 197 "coders/rle.c"
                                            ;
  
# 198 "coders/rle.c" 3 4
 ((void) sizeof ((
# 198 "coders/rle.c"
...
# 198 "coders/rle.c" 3 4
 , "coders/rle.c", 198, __extension__ __PRETTY_FUNCTION__); }))
# 198 "coders/rle.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/rle.c",__func__,(unsigned long) 200,"%s",
      image_info->filename);
...
# 209 "coders/rle.c" 3 4
                            ((void *)0)
# 209 "coders/rle.c"
                                ;
  pixel_info=(MemoryInfo *) 
# 210 "coders/rle.c" 3 4
                           ((void *)0)
# 210 "coders/rle.c"
                               ;
...
# 213 "coders/rle.c" 3 4
   ((void *)0)
# 213 "coders/rle.c"
   ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 213 "coders/rle.c" 3 4
   ((void *)0)
# 213 "coders/rle.c"
   ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 213,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 213 "coders/rle.c" 3 4
   ((void *)0)
# 213 "coders/rle.c"
...
# 230 "coders/rle.c" 3 4
     ((void *)0)
# 230 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 230,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 230 "coders/rle.c" 3 4
     ((void *)0)
# 230 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 232 "coders/rle.c" 3 4
     ((void *)0)
# 232 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 232,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 232 "coders/rle.c" 3 4
     ((void *)0)
# 232 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 237 "coders/rle.c" 3 4
     ((void *)0)
# 237 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 237,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 237 "coders/rle.c" 3 4
     ((void *)0)
# 237 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 239 "coders/rle.c" 3 4
     ((void *)0)
# 239 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 239,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 239 "coders/rle.c" 3 4
     ((void *)0)
# 239 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 242 "coders/rle.c" 3 4
     ((void *)0)
# 242 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 242,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 242 "coders/rle.c" 3 4
     ((void *)0)
# 242 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 264 "coders/rle.c" 3 4
     ((void *)0)
# 264 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 264,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 264 "coders/rle.c" 3 4
     ((void *)0)
# 264 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 270 "coders/rle.c" 3 4
     ((void *)0)
# 270 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 270,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 270 "coders/rle.c" 3 4
     ((void *)0)
# 270 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 272 "coders/rle.c" 3 4
     ((void *)0)
# 272 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 272,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 272 "coders/rle.c" 3 4
     ((void *)0)
# 272 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
    ...
    if (number_colormaps != 0)
      {
        ...
        if (colormap == (unsigned char *) 
# 280 "coders/rle.c" 3 4
                                         ((void *)0)
# 280 "coders/rle.c"
                                             )
          { if (colormap != (unsigned char *) 
# 281 "coders/rle.c" 3 4
         ((void *)0)
# 281 "coders/rle.c"
         ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 281 "coders/rle.c" 3 4
         ((void *)0)
# 281 "coders/rle.c"
         ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 281,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 281 "coders/rle.c" 3 4
         ((void *)0)
# 281 "coders/rle.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 291 "coders/rle.c" 3 4
             ((void *)0)
# 291 "coders/rle.c"
             ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 291,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 291 "coders/rle.c" 3 4
             ((void *)0)
# 291 "coders/rle.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
        ...
        if (length != 0)
          {
            ...
            if (comment == (char *) 
# 309 "coders/rle.c" 3 4
                                   ((void *)0)
# 309 "coders/rle.c"
                                       )
              { if (colormap != (unsigned char *) 
# 310 "coders/rle.c" 3 4
             ((void *)0)
# 310 "coders/rle.c"
             ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 310 "coders/rle.c" 3 4
             ((void *)0)
# 310 "coders/rle.c"
             ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 310,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 310 "coders/rle.c" 3 4
             ((void *)0)
# 310 "coders/rle.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 315 "coders/rle.c" 3 4
               ((void *)0)
# 315 "coders/rle.c"
               ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 315,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 315 "coders/rle.c" 3 4
               ((void *)0)
# 315 "coders/rle.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 325 "coders/rle.c" 3 4
     ((void *)0)
# 325 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 325,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 325 "coders/rle.c" 3 4
     ((void *)0)
# 325 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 325 "coders/rle.c"
    ...
    if (status == MagickFalse)
      {
        if (colormap != (unsigned char *) 
# 332 "coders/rle.c" 3 4
                                         ((void *)0)
# 332 "coders/rle.c"
                                             )
          colormap=(unsigned char *) RelinquishMagickMemory(colormap);
        if (pixel_info != (MemoryInfo *) 
# 334 "coders/rle.c" 3 4
                                        ((void *)0)
# 334 "coders/rle.c"
                                            )
...
# 344 "coders/rle.c" 3 4
     ((void *)0)
# 344 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 344,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 344 "coders/rle.c" 3 4
     ((void *)0)
# 344 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 344 "coders/rle.c"
    ...
    pixel_info=AcquireVirtualMemory(image->columns,image->rows*
      (((number_planes_filled) > (4)) ? (number_planes_filled) : (4))*sizeof(*pixels));
    if (pixel_info == (MemoryInfo *) 
# 347 "coders/rle.c" 3 4
                                    ((void *)0)
# 347 "coders/rle.c"
                                        )
      { if (colormap != (unsigned char *) 
# 348 "coders/rle.c" 3 4
     ((void *)0)
# 348 "coders/rle.c"
     ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 348 "coders/rle.c" 3 4
     ((void *)0)
# 348 "coders/rle.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 348,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 348 "coders/rle.c" 3 4
     ((void *)0)
# 348 "coders/rle.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 348 "coders/rle.c"
    ...
    pixel_info_length=image->columns*image->rows*
      (((number_planes_filled) > (4)) ? (number_planes_filled) : (4));
...
# 386 "coders/rle.c" 3 4
       ((void *)0)
# 386 "coders/rle.c"
       ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 386,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 386 "coders/rle.c" 3 4
       ((void *)0)
# 386 "coders/rle.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
    ...
    do
    {
      switch (opcode & 0x3f)
      {
        case 0x01:
        {
          ...
          if (operand == 
# 395 "coders/rle.c" 3 4
                        (-1)
# 395 "coders/rle.c"
                           )
            { if (colormap != (unsigned char *) 
# 396 "coders/rle.c" 3 4
           ((void *)0)
# 396 "coders/rle.c"
           ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 396 "coders/rle.c" 3 4
           ((void *)0)
# 396 "coders/rle.c"
           ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 396,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 396 "coders/rle.c" 3 4
           ((void *)0)
# 396 "coders/rle.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
          ...
          if (opcode & 0x40)
            {
              ...
              if (operand == 
# 400 "coders/rle.c" 3 4
                            (-1)
# 400 "coders/rle.c"
                               )
                { if (colormap != (unsigned char *) 
# 401 "coders/rle.c" 3 4
               ((void *)0)
# 401 "coders/rle.c"
               ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 401 "coders/rle.c" 3 4
               ((void *)0)
# 401 "coders/rle.c"
               ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 401,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 401 "coders/rle.c" 3 4
               ((void *)0)
# 401 "coders/rle.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 401 "coders/rle.c"
        ...
        case 0x02:
        {
          operand=ReadBlobByte(image);
          if (operand == 
# 410 "coders/rle.c" 3 4
                        (-1)
# 410 "coders/rle.c"
                           )
            { if (colormap != (unsigned char *) 
# 411 "coders/rle.c" 3 4
           ((void *)0)
# 411 "coders/rle.c"
           ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 411 "coders/rle.c" 3 4
           ((void *)0)
# 411 "coders/rle.c"
           ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 411,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 411 "coders/rle.c" 3 4
           ((void *)0)
# 411 "coders/rle.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 411 "coders/rle.c"
        ...
        case 0x03:
        {
          operand=ReadBlobByte(image);
          if (operand == 
# 421 "coders/rle.c" 3 4
                        (-1)
# 421 "coders/rle.c"
                           )
            { if (colormap != (unsigned char *) 
# 422 "coders/rle.c" 3 4
           ((void *)0)
# 422 "coders/rle.c"
           ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 422 "coders/rle.c" 3 4
           ((void *)0)
# 422 "coders/rle.c"
           ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 422,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 422 "coders/rle.c" 3 4
           ((void *)0)
# 422 "coders/rle.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
          ...
          if (opcode & 0x40)
            {
              operand=ReadBlobLSBSignedShort(image);
              if (operand == 
# 426 "coders/rle.c" 3 4
                            (-1)
# 426 "coders/rle.c"
                               )
                { if (colormap != (unsigned char *) 
# 427 "coders/rle.c" 3 4
               ((void *)0)
# 427 "coders/rle.c"
               ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 427 "coders/rle.c" 3 4
               ((void *)0)
# 427 "coders/rle.c"
               ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 427,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 427 "coders/rle.c" 3 4
               ((void *)0)
# 427 "coders/rle.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 427 "coders/rle.c"
        ...
        case 0x05:
        {
          operand=ReadBlobByte(image);
          if (operand == 
# 435 "coders/rle.c" 3 4
                        (-1)
# 435 "coders/rle.c"
                           )
            { if (colormap != (unsigned char *) 
# 436 "coders/rle.c" 3 4
           ((void *)0)
# 436 "coders/rle.c"
           ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 436 "coders/rle.c" 3 4
           ((void *)0)
# 436 "coders/rle.c"
           ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 436,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 436 "coders/rle.c" 3 4
           ((void *)0)
# 436 "coders/rle.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
          ...
          if (opcode & 0x40)
            {
              operand=ReadBlobLSBSignedShort(image);
              if (operand == 
# 440 "coders/rle.c" 3 4
                            (-1)
# 440 "coders/rle.c"
                               )
                { if (colormap != (unsigned char *) 
# 441 "coders/rle.c" 3 4
               ((void *)0)
# 441 "coders/rle.c"
               ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 441 "coders/rle.c" 3 4
               ((void *)0)
# 441 "coders/rle.c"
               ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 441,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 441 "coders/rle.c" 3 4
               ((void *)0)
# 441 "coders/rle.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 449 "coders/rle.c" 3 4
           ((void *)0)
# 449 "coders/rle.c"
           ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 449,(CorruptImageError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 449 "coders/rle.c" 3 4
           ((void *)0)
# 449 "coders/rle.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 449 "coders/rle.c"
        ...
        case 0x06:
        {
          operand=ReadBlobByte(image);
          if (operand == 
# 467 "coders/rle.c" 3 4
                        (-1)
# 467 "coders/rle.c"
                           )
            { if (colormap != (unsigned char *) 
# 468 "coders/rle.c" 3 4
           ((void *)0)
# 468 "coders/rle.c"
           ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 468 "coders/rle.c" 3 4
           ((void *)0)
# 468 "coders/rle.c"
           ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 468,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 468 "coders/rle.c" 3 4
           ((void *)0)
# 468 "coders/rle.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
          ...
          if (opcode & 0x40)
            {
              operand=ReadBlobLSBSignedShort(image);
              if (operand == 
# 472 "coders/rle.c" 3 4
                            (-1)
# 472 "coders/rle.c"
                               )
                { if (colormap != (unsigned char *) 
# 473 "coders/rle.c" 3 4
               ((void *)0)
# 473 "coders/rle.c"
               ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 473 "coders/rle.c" 3 4
               ((void *)0)
# 473 "coders/rle.c"
               ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 473,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 473 "coders/rle.c" 3 4
               ((void *)0)
# 473 "coders/rle.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 482 "coders/rle.c" 3 4
           ((void *)0)
# 482 "coders/rle.c"
           ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 482,(CorruptImageError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 482 "coders/rle.c" 3 4
           ((void *)0)
# 482 "coders/rle.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 482 "coders/rle.c"
      ...
      opcode=ReadBlobByte(image);
      if (opcode == 
# 498 "coders/rle.c" 3 4
                   (-1)
# 498 "coders/rle.c"
                      )
        { if (colormap != (unsigned char *) 
# 499 "coders/rle.c" 3 4
       ((void *)0)
# 499 "coders/rle.c"
       ) colormap=(unsigned char *) RelinquishMagickMemory(colormap); if (pixel_info != (MemoryInfo *) 
# 499 "coders/rle.c" 3 4
       ((void *)0)
# 499 "coders/rle.c"
       ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 499,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 499 "coders/rle.c" 3 4
       ((void *)0)
# 499 "coders/rle.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 499 "coders/rle.c"
    ...
    } while (((opcode & 0x3f) != 0x07) && (opcode != 
# 500 "coders/rle.c" 3 4
                                                     (-1)
# 500 "coders/rle.c"
                                                        ));
    if (number_colormaps != 0)
...
# 530 "coders/rle.c" 3 4
         ((void *)0)
# 530 "coders/rle.c"
         ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 530,(CorruptImageError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 530 "coders/rle.c" 3 4
         ((void *)0)
# 530 "coders/rle.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 574 "coders/rle.c" 3 4
         ((void *)0)
# 574 "coders/rle.c"
         ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 574,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 574 "coders/rle.c" 3 4
         ((void *)0)
# 574 "coders/rle.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 676 "coders/rle.c" 3 4
       (*__errno_location ())
# 676 "coders/rle.c"
       ); (void) ThrowMagickException(exception,"coders/rle.c",__func__,(unsigned long) 676,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 738 "coders/rle.c"
__attribute__ ((visibility ("default"))) size_t RegisterRLEImage(void)
{
  MagickInfo
    *entry;
...
# 771 "coders/rle.c"
__attribute__ ((visibility ("default"))) void UnregisterRLEImage(void)
{
