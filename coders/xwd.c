...
# 208 "coders/xwd.c" 3 4
 , "coders/xwd.c", 208, __extension__ __PRETTY_FUNCTION__); }))
# 208 "coders/xwd.c"
                                               ;
  
# 209 "coders/xwd.c" 3 4
 ((void) sizeof ((
# 209 "coders/xwd.c"
...
# 209 "coders/xwd.c" 3 4
 , "coders/xwd.c", 209, __extension__ __PRETTY_FUNCTION__); }))
# 209 "coders/xwd.c"
                                                     ;
  
# 210 "coders/xwd.c" 3 4
 ((void) sizeof ((
# 210 "coders/xwd.c"
...
# 210 "coders/xwd.c" 3 4
 , "coders/xwd.c", 210, __extension__ __PRETTY_FUNCTION__); }))
# 210 "coders/xwd.c"
                                            ;
  
# 211 "coders/xwd.c" 3 4
 ((void) sizeof ((
# 211 "coders/xwd.c"
...
# 211 "coders/xwd.c" 3 4
 , "coders/xwd.c", 211, __extension__ __PRETTY_FUNCTION__); }))
# 211 "coders/xwd.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/xwd.c",__func__,(unsigned long) 213,"%s",
      image_info->filename);
...
# 220 "coders/xwd.c"
  ...
  count=ReadBlob(image,
# 225 "coders/xwd.c" 3 4
                      100
# 225 "coders/xwd.c"
                                  ,(unsigned char *) &header);
  if (count != 
# 226 "coders/xwd.c" 3 4
              100
# 226 "coders/xwd.c"
                          )
    { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 227,CorruptImageError,"UnableToReadImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 227 "coders/xwd.c" 3 4
   ((void *)0)
# 227 "coders/xwd.c"
...
# 227 "coders/xwd.c"
  ...
  if ((int) (*(char *) &lsb_first) != 0)
    MSBOrderLong((unsigned char *) &header,
# 233 "coders/xwd.c" 3 4
                                          100
# 233 "coders/xwd.c"
                                                      );
...
# 237 "coders/xwd.c" 3 4
                            7
# 237 "coders/xwd.c"
                                            )
    { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 238,CorruptImageError,"FileFormatVersionMismatch", "`%s'",image_info->filename); if ((image) != (Image *) 
# 238 "coders/xwd.c" 3 4
   ((void *)0)
# 238 "coders/xwd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 238 "coders/xwd.c" 3 4
...
# 239 "coders/xwd.c" 3 4
                          100
# 239 "coders/xwd.c"
                                      )
    { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 240,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 240 "coders/xwd.c" 3 4
   ((void *)0)
# 240 "coders/xwd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 240 "coders/xwd.c" 3 4
...
# 240 "coders/xwd.c"
  ...
  if (header.xoffset >= header.pixmap_width)
    { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 242,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 242 "coders/xwd.c" 3 4
   ((void *)0)
# 242 "coders/xwd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 242 "coders/xwd.c" 3 4
...
# 242 "coders/xwd.c"
  ...
  {
    case 
# 245 "coders/xwd.c" 3 4
        0
# 245 "coders/xwd.c"
                  :
    case 
# 246 "coders/xwd.c" 3 4
        1
# 246 "coders/xwd.c"
                 :
    {
      if (header.bits_per_pixel != 1)
        { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 249,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 249 "coders/xwd.c" 3 4
       ((void *)0)
# 249 "coders/xwd.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 249 "coders/xwd.c" 3 4
...
# 249 "coders/xwd.c"
    ...
    case 
# 252 "coders/xwd.c" 3 4
        2
# 252 "coders/xwd.c"
                   :
    case 
# 253 "coders/xwd.c" 3 4
        3
# 253 "coders/xwd.c"
                   :
    {
      if ((header.bits_per_pixel < 1) || (header.bits_per_pixel > 15) ||
        ...
        { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 257,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 257 "coders/xwd.c" 3 4
       ((void *)0)
# 257 "coders/xwd.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 257 "coders/xwd.c" 3 4
...
# 257 "coders/xwd.c"
    ...
    case 
# 260 "coders/xwd.c" 3 4
        4
# 260 "coders/xwd.c"
                 :
    case 
# 261 "coders/xwd.c" 3 4
        5
# 261 "coders/xwd.c"
                   :
    {
      if ((header.bits_per_pixel != 16) && (header.bits_per_pixel != 24) &&
        ...
        { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 265,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 265 "coders/xwd.c" 3 4
       ((void *)0)
# 265 "coders/xwd.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 265 "coders/xwd.c" 3 4
...
# 265 "coders/xwd.c"
    ...
    default:
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 269,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 269 "coders/xwd.c" 3 4
     ((void *)0)
# 269 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 269 "coders/xwd.c" 3 4
...
# 269 "coders/xwd.c"
  ...
  {
    case 
# 273 "coders/xwd.c" 3 4
        0
# 273 "coders/xwd.c"
                :
    {
      if (header.pixmap_depth != 1)
        { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 276,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 276 "coders/xwd.c" 3 4
       ((void *)0)
# 276 "coders/xwd.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 276 "coders/xwd.c" 3 4
...
# 276 "coders/xwd.c"
    ...
    case 
# 279 "coders/xwd.c" 3 4
        1
# 279 "coders/xwd.c"
                :
    case 
# 280 "coders/xwd.c" 3 4
        2
# 280 "coders/xwd.c"
               :
    {
      if ((header.pixmap_depth < 1) || (header.pixmap_depth > 32))
        { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 283,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 283 "coders/xwd.c" 3 4
       ((void *)0)
# 283 "coders/xwd.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 283 "coders/xwd.c" 3 4
...
# 283 "coders/xwd.c"
      ...
      switch (header.bitmap_pad)
      {
        ...
        case 32:
          break;
        default:
          { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 291,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 291 "coders/xwd.c" 3 4
         ((void *)0)
# 291 "coders/xwd.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 291 "coders/xwd.c" 3 4
...
# 291 "coders/xwd.c"
    ...
    default:
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 296,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 296 "coders/xwd.c" 3 4
     ((void *)0)
# 296 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 296 "coders/xwd.c" 3 4
...
# 296 "coders/xwd.c"
  ...
  switch (header.bitmap_unit)
  {
    ...
    case 32:
      break;
    default:
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 305,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 305 "coders/xwd.c" 3 4
     ((void *)0)
# 305 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 305 "coders/xwd.c" 3 4
...
# 305 "coders/xwd.c"
  ...
  {
    case 
# 309 "coders/xwd.c" 3 4
        0
# 309 "coders/xwd.c"
                :
    case 
# 310 "coders/xwd.c" 3 4
        1
# 310 "coders/xwd.c"
                :
      break;
    default:
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 313,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 313 "coders/xwd.c" 3 4
     ((void *)0)
# 313 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 313 "coders/xwd.c" 3 4
...
# 313 "coders/xwd.c"
  ...
  {
    case 
# 317 "coders/xwd.c" 3 4
        0
# 317 "coders/xwd.c"
                :
    case 
# 318 "coders/xwd.c" 3 4
        1
# 318 "coders/xwd.c"
                :
      break;
    default:
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 321,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 321 "coders/xwd.c" 3 4
     ((void *)0)
# 321 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 321 "coders/xwd.c" 3 4
...
# 321 "coders/xwd.c"
  ...
  if (((header.bitmap_pad % 8) != 0) || (header.bitmap_pad > 32))
    { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 324,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 324 "coders/xwd.c" 3 4
   ((void *)0)
# 324 "coders/xwd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 324 "coders/xwd.c" 3 4
...
# 324 "coders/xwd.c"
  ...
  length=(size_t) (header.header_size-
# 325 "coders/xwd.c" 3 4
                                     100
# 325 "coders/xwd.c"
                                                 );
  comment=(char *) AcquireQuantumMemory(length+1,sizeof(*comment));
  if (comment == (char *) 
# 327 "coders/xwd.c" 3 4
                         ((void *)0)
# 327 "coders/xwd.c"
                             )
    { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 328,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 328 "coders/xwd.c" 3 4
   ((void *)0)
# 328 "coders/xwd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 328 "coders/xwd.c" 3 4
...
# 328 "coders/xwd.c"
  ...
  if (count != (ssize_t) length)
    { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 334,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 334 "coders/xwd.c" 3 4
   ((void *)0)
# 334 "coders/xwd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 334 "coders/xwd.c" 3 4
...
# 334 "coders/xwd.c"
  ...
  if (ximage == (XImage *) 
# 339 "coders/xwd.c" 3 4
                          ((void *)0)
# 339 "coders/xwd.c"
                              )
    { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 340,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 340 "coders/xwd.c" 3 4
   ((void *)0)
# 340 "coders/xwd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 340 "coders/xwd.c" 3 4
...
# 344 "coders/xwd.c"
  ...
  if ((ximage->depth < 0) || (ximage->format < 0) || (ximage->xoffset < 0) ||
      ...
      (ximage->bits_per_pixel < 0))
    {
      ...
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 363,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 363 "coders/xwd.c" 3 4
     ((void *)0)
# 363 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 363 "coders/xwd.c" 3 4
...
# 363 "coders/xwd.c"
  ...
  if ((ximage->width > 65535) || (ximage->height > 65535))
    {
      ximage=(XImage *) RelinquishMagickMemory(ximage);
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 368,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 368 "coders/xwd.c" 3 4
     ((void *)0)
# 368 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 368 "coders/xwd.c" 3 4
...
# 368 "coders/xwd.c"
  ...
  if ((ximage->bits_per_pixel > 32) || (ximage->bitmap_unit > 32))
    {
      ximage=(XImage *) RelinquishMagickMemory(ximage);
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 373,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 373 "coders/xwd.c" 3 4
     ((void *)0)
# 373 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 373 "coders/xwd.c" 3 4
...
# 373 "coders/xwd.c"
  ...
  if (x_status == 0)
    {
      ximage=(XImage *) RelinquishMagickMemory(ximage);
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 379,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 379 "coders/xwd.c" 3 4
     ((void *)0)
# 379 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 379 "coders/xwd.c" 3 4
  ...
  if (header.ncolors != 0)
    {
      ...
      if (length > ((~0UL)/sizeof(*colors)))
        { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 393,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 393 "coders/xwd.c" 3 4
       ((void *)0)
# 393 "coders/xwd.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 393 "coders/xwd.c" 3 4
...
# 393 "coders/xwd.c"
      ...
      if (colors == (XColor *) 
# 395 "coders/xwd.c" 3 4
                              ((void *)0)
# 395 "coders/xwd.c"
                                  )
        {
          ximage=(XImage *) RelinquishMagickMemory(ximage);
          { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 398,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 398 "coders/xwd.c" 3 4
         ((void *)0)
# 398 "coders/xwd.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 398 "coders/xwd.c" 3 4
...
# 398 "coders/xwd.c"
      ...
      {
        count=ReadBlob(image,
# 402 "coders/xwd.c" 3 4
                            12
# 402 "coders/xwd.c"
                                       ,(unsigned char *) &color);
        if (count != 
# 403 "coders/xwd.c" 3 4
                    12
# 403 "coders/xwd.c"
                               )
          {
            ...
            ximage=(XImage *) RelinquishMagickMemory(ximage);
            { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 407,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 407 "coders/xwd.c" 3 4
           ((void *)0)
# 407 "coders/xwd.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 407 "coders/xwd.c" 3 4
...
# 407 "coders/xwd.c"
  ...
  if ((((ximage->height) != 0) && ((length)/((size_t) ximage->height) != ((size_t) ximage->bytes_per_line))))
    {
      if (header.ncolors != 0)
        colors=(XColor *) RelinquishMagickMemory(colors);
      ximage=(XImage *) RelinquishMagickMemory(ximage);
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 439,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 439 "coders/xwd.c" 3 4
     ((void *)0)
# 439 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 439 "coders/xwd.c" 3 4
...
# 441 "coders/xwd.c"
                              )
    {
      ...
      if ((((ximage->depth) != 0) && ((length)/((size_t) ximage->depth) != ((size_t) extent))))
        {
          if (header.ncolors != 0)
            colors=(XColor *) RelinquishMagickMemory(colors);
          ximage=(XImage *) RelinquishMagickMemory(ximage);
          { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 453,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 453 "coders/xwd.c" 3 4
         ((void *)0)
# 453 "coders/xwd.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 453 "coders/xwd.c" 3 4
...
# 457 "coders/xwd.c"
                                  )
    {
      if (header.ncolors != 0)
        colors=(XColor *) RelinquishMagickMemory(colors);
      ximage=(XImage *) RelinquishMagickMemory(ximage);
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 462,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 462 "coders/xwd.c" 3 4
     ((void *)0)
# 462 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 462 "coders/xwd.c" 3 4
  ...
  if (count != (ssize_t) length)
    {
      ...
      ximage=(XImage *) RelinquishMagickMemory(ximage);
      { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 471,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 471 "coders/xwd.c" 3 4
     ((void *)0)
# 471 "coders/xwd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 471 "coders/xwd.c" 3 4
        ...
        if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
          {
            ...
            ximage->data=DestroyString(ximage->data);
            ximage=(XImage *) RelinquishMagickMemory(ximage);
            { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 612,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 612 "coders/xwd.c" 3 4
           ((void *)0)
# 612 "coders/xwd.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 612 "coders/xwd.c" 3 4
...
# 654 "coders/xwd.c" 3 4
   (*__errno_location ())
# 654 "coders/xwd.c"
   ); (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 654,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 687 "coders/xwd.c"
__attribute__ ((visibility ("default"))) size_t RegisterXWDImage(void)
{
  MagickInfo
    *entry;
...
# 722 "coders/xwd.c"
__attribute__ ((visibility ("default"))) void UnregisterXWDImage(void)
{
...
# 796 "coders/xwd.c"
 "image_info != (const ImageInfo *) NULL"
# 796 "coders/xwd.c" 3 4
 , "coders/xwd.c", 796, __extension__ __PRETTY_FUNCTION__); }))
# 796 "coders/xwd.c"
                                               ;
  
# 797 "coders/xwd.c" 3 4
 ((void) sizeof ((
# 797 "coders/xwd.c"
 image_info->signature == 0xabacadabUL
# 797 "coders/xwd.c" 3 4
...
# 797 "coders/xwd.c"
 "image_info->signature == MagickCoreSignature"
# 797 "coders/xwd.c" 3 4
 , "coders/xwd.c", 797, __extension__ __PRETTY_FUNCTION__); }))
# 797 "coders/xwd.c"
                                                     ;
  
# 798 "coders/xwd.c" 3 4
 ((void) sizeof ((
# 798 "coders/xwd.c"
 image != (Image *) 
# 798 "coders/xwd.c" 3 4
...
# 798 "coders/xwd.c"
 "image != (Image *) NULL"
# 798 "coders/xwd.c" 3 4
 , "coders/xwd.c", 798, __extension__ __PRETTY_FUNCTION__); }))
# 798 "coders/xwd.c"
                                ;
  
# 799 "coders/xwd.c" 3 4
 ((void) sizeof ((
# 799 "coders/xwd.c"
...
# 799 "coders/xwd.c" 3 4
 , "coders/xwd.c", 799, __extension__ __PRETTY_FUNCTION__); }))
# 799 "coders/xwd.c"
                                                ;
  
# 800 "coders/xwd.c" 3 4
 ((void) sizeof ((
# 800 "coders/xwd.c"
 exception != (ExceptionInfo *) 
# 800 "coders/xwd.c" 3 4
...
# 800 "coders/xwd.c"
 "exception != (ExceptionInfo *) NULL"
# 800 "coders/xwd.c" 3 4
 , "coders/xwd.c", 800, __extension__ __PRETTY_FUNCTION__); }))
# 800 "coders/xwd.c"
                                            ;
  
# 801 "coders/xwd.c" 3 4
 ((void) sizeof ((
# 801 "coders/xwd.c"
 exception->signature == 0xabacadabUL
# 801 "coders/xwd.c" 3 4
...
# 801 "coders/xwd.c"
 "exception->signature == MagickCoreSignature"
# 801 "coders/xwd.c" 3 4
 , "coders/xwd.c", 801, __extension__ __PRETTY_FUNCTION__); }))
# 801 "coders/xwd.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/xwd.c",__func__,(unsigned long) 803,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  if ((image->columns != (CARD32) image->columns) ||
      (image->rows != (CARD32) image->rows))
    { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 809,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 809 "coders/xwd.c" 3 4
   ((void *)0)
# 809 "coders/xwd.c"
  ...
  xwd_info.header_size=(CARD32) 
# 818 "coders/xwd.c" 3 4
                               100
# 818 "coders/xwd.c"
                                           ;
  value=GetImageProperty(image,"comment",exception);
  if (value != (const char *) 
# 820 "coders/xwd.c" 3 4
                             ((void *)0)
# 820 "coders/xwd.c"
                                 )
    xwd_info.header_size+=(CARD32) strlen(value);
  xwd_info.header_size++;
  xwd_info.file_version=(CARD32) 
# 823 "coders/xwd.c" 3 4
                                7
# 823 "coders/xwd.c"
                                                ;
  xwd_info.pixmap_format=(CARD32) 
# 824 "coders/xwd.c" 3 4
                                 2
# 824 "coders/xwd.c"
                                        ;
  ...
  xwd_info.byte_order=(CARD32) 
# 829 "coders/xwd.c" 3 4
                              1
# 829 "coders/xwd.c"
                                      ;
  xwd_info.bitmap_unit=(CARD32) (image->storage_class == DirectClass ? 32 : 8);
  xwd_info.bitmap_bit_order=(CARD32) 
# 831 "coders/xwd.c" 3 4
                                    1
# 831 "coders/xwd.c"
                                            ;
...
# 840 "coders/xwd.c"
  ...
  (void) WriteBlob(image,
# 862 "coders/xwd.c" 3 4
                        100
# 862 "coders/xwd.c"
                                    ,(unsigned char *) &xwd_info);
  if (value != (const char *) 
# 863 "coders/xwd.c" 3 4
                             ((void *)0)
# 863 "coders/xwd.c"
                                 )
  ...
  if (image->storage_class == PseudoClass)
    {
      ...
      colors=(XColor *) AcquireQuantumMemory((size_t) image->colors,
        sizeof(*colors));
      if (colors == (XColor *) 
# 883 "coders/xwd.c" 3 4
                              ((void *)0)
# 883 "coders/xwd.c"
                                  )
        { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 884,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 884 "coders/xwd.c" 3 4
       ((void *)0)
# 884 "coders/xwd.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      for (i=0; i < (ssize_t) image->colors; i++)
...
# 894 "coders/xwd.c"
      ...
      for (i=0; i < (ssize_t) image->colors; i++)
      {
        ...
        count=WriteBlob(image,
# 911 "coders/xwd.c" 3 4
                             12
# 911 "coders/xwd.c"
                                        ,(unsigned char *) &color);
        if (count != (ssize_t) 
# 912 "coders/xwd.c" 3 4
                              12
# 912 "coders/xwd.c"
                                         )
          break;
...
# 924 "coders/xwd.c" 3 4
                                 ((void *)0)
# 924 "coders/xwd.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/xwd.c",__func__,(unsigned long) 925,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 925 "coders/xwd.c" 3 4
   ((void *)0)
# 925 "coders/xwd.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
