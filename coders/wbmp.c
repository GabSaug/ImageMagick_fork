...
# 148 "coders/wbmp.c" 3 4
 , "coders/wbmp.c", 148, __extension__ __PRETTY_FUNCTION__); }))
# 148 "coders/wbmp.c"
                                               ;
  
# 149 "coders/wbmp.c" 3 4
 ((void) sizeof ((
# 149 "coders/wbmp.c"
...
# 149 "coders/wbmp.c" 3 4
 , "coders/wbmp.c", 149, __extension__ __PRETTY_FUNCTION__); }))
# 149 "coders/wbmp.c"
                                                     ;
  
# 150 "coders/wbmp.c" 3 4
 ((void) sizeof ((
# 150 "coders/wbmp.c"
...
# 150 "coders/wbmp.c" 3 4
 , "coders/wbmp.c", 150, __extension__ __PRETTY_FUNCTION__); }))
# 150 "coders/wbmp.c"
                                            ;
  
# 151 "coders/wbmp.c" 3 4
 ((void) sizeof ((
# 151 "coders/wbmp.c"
...
# 151 "coders/wbmp.c" 3 4
 , "coders/wbmp.c", 151, __extension__ __PRETTY_FUNCTION__); }))
# 151 "coders/wbmp.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/wbmp.c",__func__,(unsigned long) 153,"%s",
      image_info->filename);
...
# 160 "coders/wbmp.c"
  ...
  if (ReadBlob(image,2,(unsigned char *) &header) != 2)
    { (void) ThrowMagickException(exception,"coders/wbmp.c",__func__,(unsigned long) 164,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 164 "coders/wbmp.c" 3 4
   ((void *)0)
# 164 "coders/wbmp.c"
...
# 164 "coders/wbmp.c"
  ...
  if (header != 0)
    { (void) ThrowMagickException(exception,"coders/wbmp.c",__func__,(unsigned long) 166,CoderError,"OnlyLevelZerofilesSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 166 "coders/wbmp.c" 3 4
   ((void *)0)
# 166 "coders/wbmp.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 166 "coders/wbmp.c" 3 4
...
# 166 "coders/wbmp.c"
  ...
  if (WBMPReadInteger(image,&image->columns) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/wbmp.c",__func__,(unsigned long) 171,CorruptImageError,"CorruptWBMPimage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 171 "coders/wbmp.c" 3 4
   ((void *)0)
# 171 "coders/wbmp.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 171 "coders/wbmp.c" 3 4
...
# 171 "coders/wbmp.c"
  ...
  if (WBMPReadInteger(image,&image->rows) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/wbmp.c",__func__,(unsigned long) 173,CorruptImageError,"CorruptWBMPimage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 173 "coders/wbmp.c" 3 4
   ((void *)0)
# 173 "coders/wbmp.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 173 "coders/wbmp.c" 3 4
...
# 173 "coders/wbmp.c"
  ...
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/wbmp.c",__func__,(unsigned long) 175,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 175 "coders/wbmp.c" 3 4
   ((void *)0)
# 175 "coders/wbmp.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 175 "coders/wbmp.c" 3 4
...
# 177 "coders/wbmp.c" 3 4
   (*__errno_location ())
# 177 "coders/wbmp.c"
   ); (void) ThrowMagickException(exception,"coders/wbmp.c",__func__,(unsigned long) 177,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
  ...
  if (AcquireImageColormap(image,2,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/wbmp.c",__func__,(unsigned long) 189,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 189 "coders/wbmp.c" 3 4
   ((void *)0)
# 189 "coders/wbmp.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 189 "coders/wbmp.c" 3 4
      ...
      if (bit == 0)
        {
          byte=ReadBlobByte(image);
          if (byte == 
# 205 "coders/wbmp.c" 3 4
                     (-1)
# 205 "coders/wbmp.c"
                        )
            { (void) ThrowMagickException(exception,"coders/wbmp.c",__func__,(unsigned long) 206,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 206 "coders/wbmp.c" 3 4
           ((void *)0)
# 206 "coders/wbmp.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 206 "coders/wbmp.c" 3 4
...
# 206 "coders/wbmp.c"
  ...
  if (EOFBlob(image) != MagickFalse)
    { char *file_message; file_message=GetExceptionMessage(
# 223 "coders/wbmp.c" 3 4
   (*__errno_location ())
# 223 "coders/wbmp.c"
   ); (void) ThrowMagickException(exception,"coders/wbmp.c",__func__,(unsigned long) 223,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 255 "coders/wbmp.c"
__attribute__ ((visibility ("default"))) size_t RegisterWBMPImage(void)
{
  MagickInfo
    *entry;
...
# 288 "coders/wbmp.c"
__attribute__ ((visibility ("default"))) void UnregisterWBMPImage(void)
{
...
# 377 "coders/wbmp.c"
 "image_info != (const ImageInfo *) NULL"
# 377 "coders/wbmp.c" 3 4
 , "coders/wbmp.c", 377, __extension__ __PRETTY_FUNCTION__); }))
# 377 "coders/wbmp.c"
                                               ;
  
# 378 "coders/wbmp.c" 3 4
 ((void) sizeof ((
# 378 "coders/wbmp.c"
 image_info->signature == 0xabacadabUL
# 378 "coders/wbmp.c" 3 4
...
# 378 "coders/wbmp.c"
 "image_info->signature == MagickCoreSignature"
# 378 "coders/wbmp.c" 3 4
 , "coders/wbmp.c", 378, __extension__ __PRETTY_FUNCTION__); }))
# 378 "coders/wbmp.c"
                                                     ;
  
# 379 "coders/wbmp.c" 3 4
 ((void) sizeof ((
# 379 "coders/wbmp.c"
 image != (Image *) 
# 379 "coders/wbmp.c" 3 4
...
# 379 "coders/wbmp.c"
 "image != (Image *) NULL"
# 379 "coders/wbmp.c" 3 4
 , "coders/wbmp.c", 379, __extension__ __PRETTY_FUNCTION__); }))
# 379 "coders/wbmp.c"
                                ;
  
# 380 "coders/wbmp.c" 3 4
 ((void) sizeof ((
# 380 "coders/wbmp.c"
...
# 380 "coders/wbmp.c" 3 4
 , "coders/wbmp.c", 380, __extension__ __PRETTY_FUNCTION__); }))
# 380 "coders/wbmp.c"
                                                ;
  
# 381 "coders/wbmp.c" 3 4
 ((void) sizeof ((
# 381 "coders/wbmp.c"
 exception != (ExceptionInfo *) 
# 381 "coders/wbmp.c" 3 4
...
# 381 "coders/wbmp.c"
 "exception != (ExceptionInfo *) NULL"
# 381 "coders/wbmp.c" 3 4
 , "coders/wbmp.c", 381, __extension__ __PRETTY_FUNCTION__); }))
# 381 "coders/wbmp.c"
                                            ;
  
# 382 "coders/wbmp.c" 3 4
 ((void) sizeof ((
# 382 "coders/wbmp.c"
 exception->signature == 0xabacadabUL
# 382 "coders/wbmp.c" 3 4
...
# 382 "coders/wbmp.c"
 "exception->signature == MagickCoreSignature"
# 382 "coders/wbmp.c" 3 4
 , "coders/wbmp.c", 382, __extension__ __PRETTY_FUNCTION__); }))
# 382 "coders/wbmp.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/wbmp.c",__func__,(unsigned long) 384,"%s",image->filename);
