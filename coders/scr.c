...
# 143 "coders/scr.c" 3 4
 , "coders/scr.c", 143, __extension__ __PRETTY_FUNCTION__); }))
# 143 "coders/scr.c"
                                               ;
  
# 144 "coders/scr.c" 3 4
 ((void) sizeof ((
# 144 "coders/scr.c"
...
# 144 "coders/scr.c" 3 4
 , "coders/scr.c", 144, __extension__ __PRETTY_FUNCTION__); }))
# 144 "coders/scr.c"
                                                     ;
  
# 145 "coders/scr.c" 3 4
 ((void) sizeof ((
# 145 "coders/scr.c"
...
# 145 "coders/scr.c" 3 4
 , "coders/scr.c", 145, __extension__ __PRETTY_FUNCTION__); }))
# 145 "coders/scr.c"
                                            ;
  
# 146 "coders/scr.c" 3 4
 ((void) sizeof ((
# 146 "coders/scr.c"
...
# 146 "coders/scr.c" 3 4
 , "coders/scr.c", 146, __extension__ __PRETTY_FUNCTION__); }))
# 146 "coders/scr.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/scr.c",__func__,(unsigned long) 148,"%s",
      image_info->filename);
...
# 155 "coders/scr.c"
  ...
  if (count != 6144)
    { (void) ThrowMagickException(exception,"coders/scr.c",__func__,(unsigned long) 164,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 164 "coders/scr.c" 3 4
   ((void *)0)
# 164 "coders/scr.c"
...
# 164 "coders/scr.c"
  ...
  if (count != 768)
    { (void) ThrowMagickException(exception,"coders/scr.c",__func__,(unsigned long) 167,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 167 "coders/scr.c" 3 4
   ((void *)0)
# 167 "coders/scr.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 167 "coders/scr.c" 3 4
...
# 278 "coders/scr.c"
__attribute__ ((visibility ("default"))) size_t RegisterSCRImage(void)
{
  MagickInfo
    *entry;
...
# 309 "coders/scr.c"
__attribute__ ((visibility ("default"))) void UnregisterSCRImage(void)
{
