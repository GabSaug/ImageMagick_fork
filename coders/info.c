...
# 94 "coders/info.c"
__attribute__ ((visibility ("default"))) size_t RegisterINFOImage(void)
{
  MagickInfo
    *entry;
...
# 125 "coders/info.c"
__attribute__ ((visibility ("default"))) void UnregisterINFOImage(void)
{
...
# 175 "coders/info.c" 3 4
 , "coders/info.c", 175, __extension__ __PRETTY_FUNCTION__); }))
# 175 "coders/info.c"
                                               ;
  
# 176 "coders/info.c" 3 4
 ((void) sizeof ((
# 176 "coders/info.c"
...
# 176 "coders/info.c" 3 4
 , "coders/info.c", 176, __extension__ __PRETTY_FUNCTION__); }))
# 176 "coders/info.c"
                                                     ;
  
# 177 "coders/info.c" 3 4
 ((void) sizeof ((
# 177 "coders/info.c"
 image != (Image *) 
# 177 "coders/info.c" 3 4
...
# 177 "coders/info.c"
 "image != (Image *) NULL"
# 177 "coders/info.c" 3 4
 , "coders/info.c", 177, __extension__ __PRETTY_FUNCTION__); }))
# 177 "coders/info.c"
                                ;
  
# 178 "coders/info.c" 3 4
 ((void) sizeof ((
# 178 "coders/info.c"
...
# 178 "coders/info.c" 3 4
 , "coders/info.c", 178, __extension__ __PRETTY_FUNCTION__); }))
# 178 "coders/info.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/info.c",__func__,(unsigned long) 180,"%s",image->filename);
