# 0 "coders/histogram.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "coders/histogram.c"
# 42 "coders/histogram.c"
...
# 100 "coders/histogram.c"
__attribute__ ((visibility ("default"))) size_t RegisterHISTOGRAMImage(void)
{
  MagickInfo
    *entry;
...
# 132 "coders/histogram.c"
__attribute__ ((visibility ("default"))) void UnregisterHISTOGRAMImage(void)
{
  (void) UnregisterMagickInfo("HISTOGRAM");
}
# 172 "coders/histogram.c"
...
# 224 "coders/histogram.c" 3 4
 ((void) sizeof ((
# 224 "coders/histogram.c"
...
# 224 "coders/histogram.c" 3 4
 , "coders/histogram.c", 224, __extension__ __PRETTY_FUNCTION__); }))
# 224 "coders/histogram.c"
                                               ;
  
# 225 "coders/histogram.c" 3 4
 ((void) sizeof ((
# 225 "coders/histogram.c"
...
# 225 "coders/histogram.c" 3 4
 , "coders/histogram.c", 225, __extension__ __PRETTY_FUNCTION__); }))
# 225 "coders/histogram.c"
                                                     ;
  
# 226 "coders/histogram.c" 3 4
 ((void) sizeof ((
# 226 "coders/histogram.c"
 image != (Image *) 
# 226 "coders/histogram.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 226 "coders/histogram.c"
...
# 226 "coders/histogram.c"
 "image != (Image *) NULL"
# 226 "coders/histogram.c" 3 4
 , "coders/histogram.c", 226, __extension__ __PRETTY_FUNCTION__); }))
# 226 "coders/histogram.c"
                                ;
  
# 227 "coders/histogram.c" 3 4
 ((void) sizeof ((
# 227 "coders/histogram.c"
...
# 227 "coders/histogram.c" 3 4
 , "coders/histogram.c", 227, __extension__ __PRETTY_FUNCTION__); }))
# 227 "coders/histogram.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/histogram.c",__func__,(unsigned long) 229,"%s",
      image_info->filename);
  SetGeometry(image,&geometry);
  if (image_info->density == (char *) 
# 232 "coders/histogram.c" 3 4
                                     ((void *)0)
# 232 "coders/histogram.c"
                                         )
    (void) ParseAbsoluteGeometry("256x200",&geometry);
  else
...
# 238 "coders/histogram.c" 3 4
                                  ((void *)0)
# 238 "coders/histogram.c"
                                      )
    { (void) ThrowMagickException(exception,"coders/histogram.c",__func__,(unsigned long) 239,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 239 "coders/histogram.c" 3 4
   ((void *)0)
# 239 "coders/histogram.c"
  ...
  length=((((size_t) ScaleQuantumToChar(((Quantum) 65535.0))+1UL) > (histogram_image->columns)) ? ((size_t) ScaleQuantumToChar(((Quantum) 65535.0))+1UL) : (histogram_image->columns))
                             ;
  histogram=(PixelInfo *) AcquireQuantumMemory(length,sizeof(*histogram));
  if (histogram == (PixelInfo *) 
# 247 "coders/histogram.c" 3 4
                                ((void *)0)
# 247 "coders/histogram.c"
                                    )
    {
      histogram_image=DestroyImage(histogram_image);
      { (void) ThrowMagickException(exception,"coders/histogram.c",__func__,(unsigned long) 250,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 250 "coders/histogram.c" 3 4
     ((void *)0)
# 250 "coders/histogram.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    }
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 259 "coders/histogram.c" 3 4
                              ((void *)0)
# 259 "coders/histogram.c"
                                  )
      break;
  ...
  scale=0.0;
  if (fabs((double) maximum) >= 1.0e-12)
  ...
  for (x=0; x < (ssize_t) histogram_image->columns; x++)
  {
    ...
    if (q == (Quantum *) 
# 297 "coders/histogram.c" 3 4
                        ((void *)0)
# 297 "coders/histogram.c"
                            )
      break;
    if ((GetPixelRedTraits(image) & UpdatePixelTrait) != 0)
      {
        ...
        {
          SetPixelRed(histogram_image,((Quantum) 65535.0),r);
    ...
    if ((GetPixelGreenTraits(image) & UpdatePixelTrait) != 0)
      {
        ...
        for ( ; y < (ssize_t) histogram_image->rows; y++)
        {
          SetPixelGreen(histogram_image,((Quantum) 65535.0),r);
          r+=GetPixelChannels(histogram_image);
        }
      }
    if ((GetPixelBlueTraits(image) & UpdatePixelTrait) != 0)
      {
        ...
        for ( ; y < (ssize_t) histogram_image->rows; y++)
        {
          SetPixelBlue(histogram_image,((Quantum) 65535.0),r);
          r+=GetPixelChannels(histogram_image);
        }
      }
  ...
  if ((IsHistogramImage(image,exception) != MagickFalse) ||
      ...
      (GetImageOption(image_info,"format") != (const char *) 
# 343 "coders/histogram.c" 3 4
                                                            ((void *)0)
# 343 "coders/histogram.c"
                                                                ))
    {
      FILE
        *file;
      ...
      file=(FILE *) 
# 354 "coders/histogram.c" 3 4
                   ((void *)0)
# 354 "coders/histogram.c"
                       ;
      unique_file=AcquireUniqueFileResource(filename);
      if (unique_file != -1)
        file=fdopen(unique_file,"wb");
      if ((unique_file != -1) && (file != (FILE *) 
# 358 "coders/histogram.c" 3 4
                                                  ((void *)0)
# 358 "coders/histogram.c"
                                                      ))
        {
          char
            *property;
          ...
          if (property != (char *) 
# 366 "coders/histogram.c" 3 4
                                  ((void *)0)
# 366 "coders/histogram.c"
                                      )
            {
...
# 385 "coders/histogram.c" 3 4
                                         ((void *)0)
# 385 "coders/histogram.c"
                                             ) ||
