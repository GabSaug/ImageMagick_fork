...
# 132 "coders/label.c" 3 4
 , "coders/label.c", 132, __extension__ __PRETTY_FUNCTION__); }))
# 132 "coders/label.c"
                                               ;
  
# 133 "coders/label.c" 3 4
 ((void) sizeof ((
# 133 "coders/label.c"
...
# 133 "coders/label.c" 3 4
 , "coders/label.c", 133, __extension__ __PRETTY_FUNCTION__); }))
# 133 "coders/label.c"
                                                     ;
  
# 134 "coders/label.c" 3 4
 ((void) sizeof ((
# 134 "coders/label.c"
...
# 134 "coders/label.c" 3 4
 , "coders/label.c", 134, __extension__ __PRETTY_FUNCTION__); }))
# 134 "coders/label.c"
                                            ;
  
# 135 "coders/label.c" 3 4
 ((void) sizeof ((
# 135 "coders/label.c"
...
# 135 "coders/label.c" 3 4
 , "coders/label.c", 135, __extension__ __PRETTY_FUNCTION__); }))
# 135 "coders/label.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/label.c",__func__,(unsigned long) 137,"%s",
      image_info->filename);
  ...
  if (AcquireMagickResource(WidthResource,width) == MagickFalse)
    {
      ...
      { (void) ThrowMagickException(exception,"coders/label.c",__func__,(unsigned long) 159,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image_info->filename); if ((image) != (Image *) 
# 159 "coders/label.c" 3 4
     ((void *)0)
# 159 "coders/label.c"
  ...
  if ((image->columns == 0) && (image->rows == 0))
    ...
    if ((status != MagickFalse) && (strlen(label) > 0) &&
        (((image->columns == 0) || (image->rows == 0)) ||
         (fabs(image_info->pointsize) < 1.0e-12)))
      {
        const char
          *option;
...
# 190 "coders/label.c" 3 4
                                   ((void *)0)
# 190 "coders/label.c"
                                       )
          {
            high=StringToDouble(option,(char**) 
# 192 "coders/label.c" 3 4
                                               ((void *)0)
# 192 "coders/label.c"
                                                   );
            if (high < 1.0)
...
# 358 "coders/label.c"
__attribute__ ((visibility ("default"))) size_t RegisterLABELImage(void)
{
  MagickInfo
    *entry;
...
# 390 "coders/label.c"
__attribute__ ((visibility ("default"))) void UnregisterLABELImage(void)
{
