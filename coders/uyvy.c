...
# 123 "coders/uyvy.c" 3 4
 , "coders/uyvy.c", 123, __extension__ __PRETTY_FUNCTION__); }))
# 123 "coders/uyvy.c"
                                               ;
  
# 124 "coders/uyvy.c" 3 4
 ((void) sizeof ((
# 124 "coders/uyvy.c"
...
# 124 "coders/uyvy.c" 3 4
 , "coders/uyvy.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "coders/uyvy.c"
                                                     ;
  
# 125 "coders/uyvy.c" 3 4
 ((void) sizeof ((
# 125 "coders/uyvy.c"
...
# 125 "coders/uyvy.c" 3 4
 , "coders/uyvy.c", 125, __extension__ __PRETTY_FUNCTION__); }))
# 125 "coders/uyvy.c"
                                            ;
  
# 126 "coders/uyvy.c" 3 4
 ((void) sizeof ((
# 126 "coders/uyvy.c"
...
# 126 "coders/uyvy.c" 3 4
 , "coders/uyvy.c", 126, __extension__ __PRETTY_FUNCTION__); }))
# 126 "coders/uyvy.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/uyvy.c",__func__,(unsigned long) 128,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/uyvy.c",__func__,(unsigned long) 132,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 132 "coders/uyvy.c" 3 4
   ((void *)0)
# 132 "coders/uyvy.c"
...
# 141 "coders/uyvy.c" 3 4
   (*__errno_location ())
# 141 "coders/uyvy.c"
   ); (void) ThrowMagickException(exception,"coders/uyvy.c",__func__,(unsigned long) 141,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
  image->depth=8;
...
# 158 "coders/uyvy.c"
  ...
  if (EOFBlob(image) != MagickFalse)
    { char *file_message; file_message=GetExceptionMessage(
# 184 "coders/uyvy.c" 3 4
   (*__errno_location ())
# 184 "coders/uyvy.c"
   ); (void) ThrowMagickException(exception,"coders/uyvy.c",__func__,(unsigned long) 184,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 216 "coders/uyvy.c"
__attribute__ ((visibility ("default"))) size_t RegisterUYVYImage(void)
{
  MagickInfo
    *entry;
...
# 257 "coders/uyvy.c"
__attribute__ ((visibility ("default"))) void UnregisterUYVYImage(void)
{
...
# 317 "coders/uyvy.c"
 "image_info != (const ImageInfo *) NULL"
# 317 "coders/uyvy.c" 3 4
 , "coders/uyvy.c", 317, __extension__ __PRETTY_FUNCTION__); }))
# 317 "coders/uyvy.c"
                                               ;
  
# 318 "coders/uyvy.c" 3 4
 ((void) sizeof ((
# 318 "coders/uyvy.c"
 image_info->signature == 0xabacadabUL
# 318 "coders/uyvy.c" 3 4
...
# 318 "coders/uyvy.c"
 "image_info->signature == MagickCoreSignature"
# 318 "coders/uyvy.c" 3 4
 , "coders/uyvy.c", 318, __extension__ __PRETTY_FUNCTION__); }))
# 318 "coders/uyvy.c"
                                                     ;
  
# 319 "coders/uyvy.c" 3 4
 ((void) sizeof ((
# 319 "coders/uyvy.c"
 image != (Image *) 
# 319 "coders/uyvy.c" 3 4
...
# 319 "coders/uyvy.c"
 "image != (Image *) NULL"
# 319 "coders/uyvy.c" 3 4
 , "coders/uyvy.c", 319, __extension__ __PRETTY_FUNCTION__); }))
# 319 "coders/uyvy.c"
                                ;
  
# 320 "coders/uyvy.c" 3 4
 ((void) sizeof ((
# 320 "coders/uyvy.c"
...
# 320 "coders/uyvy.c" 3 4
 , "coders/uyvy.c", 320, __extension__ __PRETTY_FUNCTION__); }))
# 320 "coders/uyvy.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/uyvy.c",__func__,(unsigned long) 322,"%s",image->filename);
  if ((image->columns % 2) != 0)
    image->columns++;
  
# 325 "coders/uyvy.c" 3 4
 ((void) sizeof ((
# 325 "coders/uyvy.c"
 exception != (ExceptionInfo *) 
# 325 "coders/uyvy.c" 3 4
...
# 325 "coders/uyvy.c"
 "exception != (ExceptionInfo *) NULL"
# 325 "coders/uyvy.c" 3 4
 , "coders/uyvy.c", 325, __extension__ __PRETTY_FUNCTION__); }))
# 325 "coders/uyvy.c"
                                            ;
  
# 326 "coders/uyvy.c" 3 4
 ((void) sizeof ((
# 326 "coders/uyvy.c"
 exception->signature == 0xabacadabUL
# 326 "coders/uyvy.c" 3 4
...
# 326 "coders/uyvy.c"
 "exception->signature == MagickCoreSignature"
# 326 "coders/uyvy.c" 3 4
 , "coders/uyvy.c", 326, __extension__ __PRETTY_FUNCTION__); }))
# 326 "coders/uyvy.c"
                                                    ;
