...
# 93 "coders/mpr.c" 3 4
 , "coders/mpr.c", 93, __extension__ __PRETTY_FUNCTION__); }))
# 93 "coders/mpr.c"
                                               ;
...
# 94 "coders/mpr.c" 3 4
 , "coders/mpr.c", 94, __extension__ __PRETTY_FUNCTION__); }))
# 94 "coders/mpr.c"
                                                     ;
...
# 95 "coders/mpr.c" 3 4
 , "coders/mpr.c", 95, __extension__ __PRETTY_FUNCTION__); }))
# 95 "coders/mpr.c"
                                            ;
...
# 96 "coders/mpr.c" 3 4
 , "coders/mpr.c", 96, __extension__ __PRETTY_FUNCTION__); }))
# 96 "coders/mpr.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mpr.c",__func__,(unsigned long) 98,"%s",
      image_info->filename);
  image=(Image *) GetImageRegistry(ImageRegistryType,image_info->filename,
    exception);
  if (image == (Image *) 
# 102 "coders/mpr.c" 3 4
                        ((void *)0)
# 102 "coders/mpr.c"
                            )
    {
      (void) ThrowMagickException(exception,"coders/mpr.c",__func__,(unsigned long) 104,FileOpenError,
...
# 135 "coders/mpr.c"
__attribute__ ((visibility ("default"))) size_t RegisterMPRImage(void)
{
  MagickInfo
    *entry;
...
# 176 "coders/mpr.c"
__attribute__ ((visibility ("default"))) void UnregisterMPRImage(void)
{
...
# 217 "coders/mpr.c"
 "image_info != (const ImageInfo *) NULL"
# 217 "coders/mpr.c" 3 4
 , "coders/mpr.c", 217, __extension__ __PRETTY_FUNCTION__); }))
# 217 "coders/mpr.c"
                                               ;
  
# 218 "coders/mpr.c" 3 4
 ((void) sizeof ((
# 218 "coders/mpr.c"
 image_info->signature == 0xabacadabUL
# 218 "coders/mpr.c" 3 4
...
# 218 "coders/mpr.c"
 "image_info->signature == MagickCoreSignature"
# 218 "coders/mpr.c" 3 4
 , "coders/mpr.c", 218, __extension__ __PRETTY_FUNCTION__); }))
# 218 "coders/mpr.c"
                                                     ;
  
# 219 "coders/mpr.c" 3 4
 ((void) sizeof ((
# 219 "coders/mpr.c"
 image != (Image *) 
# 219 "coders/mpr.c" 3 4
...
# 219 "coders/mpr.c"
 "image != (Image *) NULL"
# 219 "coders/mpr.c" 3 4
 , "coders/mpr.c", 219, __extension__ __PRETTY_FUNCTION__); }))
# 219 "coders/mpr.c"
                                ;
  
# 220 "coders/mpr.c" 3 4
 ((void) sizeof ((
# 220 "coders/mpr.c"
...
# 220 "coders/mpr.c" 3 4
 , "coders/mpr.c", 220, __extension__ __PRETTY_FUNCTION__); }))
# 220 "coders/mpr.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mpr.c",__func__,(unsigned long) 222,"%s",image->filename);
  ;
