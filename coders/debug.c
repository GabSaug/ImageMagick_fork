...
# 100 "coders/debug.c"
__attribute__ ((visibility ("default"))) size_t RegisterDEBUGImage(void)
{
  MagickInfo
    *entry;
...
# 132 "coders/debug.c"
__attribute__ ((visibility ("default"))) void UnregisterDEBUGImage(void)
{
...
# 194 "coders/debug.c" 3 4
 , "coders/debug.c", 194, __extension__ __PRETTY_FUNCTION__); }))
# 194 "coders/debug.c"
                                               ;
  
# 195 "coders/debug.c" 3 4
 ((void) sizeof ((
# 195 "coders/debug.c"
...
# 195 "coders/debug.c" 3 4
 , "coders/debug.c", 195, __extension__ __PRETTY_FUNCTION__); }))
# 195 "coders/debug.c"
                                                     ;
  
# 196 "coders/debug.c" 3 4
 ((void) sizeof ((
# 196 "coders/debug.c"
 image != (Image *) 
# 196 "coders/debug.c" 3 4
...
# 196 "coders/debug.c"
 "image != (Image *) NULL"
# 196 "coders/debug.c" 3 4
 , "coders/debug.c", 196, __extension__ __PRETTY_FUNCTION__); }))
# 196 "coders/debug.c"
                                ;
  
# 197 "coders/debug.c" 3 4
 ((void) sizeof ((
# 197 "coders/debug.c"
...
# 197 "coders/debug.c" 3 4
 , "coders/debug.c", 197, __extension__ __PRETTY_FUNCTION__); }))
# 197 "coders/debug.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/debug.c",__func__,(unsigned long) 199,"%s",image->filename);
...
# 222 "coders/debug.c"
      ...
      {
        (void) FormatLocaleString(buffer,4096,"%.20g,%.20g: ",(double)
          x,(double) y);
        (void) WriteBlobString(image,buffer);
        GetPixelInfoPixel(image,p,&pixel);
        (void) FormatLocaleString(tuple,4096,"%.20g,%.20g,%.20g ",
        ...
        if (pixel.colorspace == CMYKColorspace)
          {
            ...
            (void) FormatLocaleString(black,4096,",%.20g ",
              (double) pixel.black);
            (void) ConcatenateMagickString(tuple,black,4096);
          }
        if (pixel.alpha_trait != UndefinedPixelTrait)
          {
            ...
            (void) FormatLocaleString(alpha,4096,",%.20g ",
              (double) pixel.alpha);
            (void) ConcatenateMagickString(tuple,alpha,4096);
          }
