...
# 208 "coders/ttf.c" 3 4
 , "coders/ttf.c", 208, __extension__ __PRETTY_FUNCTION__); }))
# 208 "coders/ttf.c"
                                               ;
  
# 209 "coders/ttf.c" 3 4
 ((void) sizeof ((
# 209 "coders/ttf.c"
...
# 209 "coders/ttf.c" 3 4
 , "coders/ttf.c", 209, __extension__ __PRETTY_FUNCTION__); }))
# 209 "coders/ttf.c"
                                                     ;
  
# 210 "coders/ttf.c" 3 4
 ((void) sizeof ((
# 210 "coders/ttf.c"
...
# 210 "coders/ttf.c" 3 4
 , "coders/ttf.c", 210, __extension__ __PRETTY_FUNCTION__); }))
# 210 "coders/ttf.c"
                                            ;
  
# 211 "coders/ttf.c" 3 4
 ((void) sizeof ((
# 211 "coders/ttf.c"
...
# 211 "coders/ttf.c" 3 4
 , "coders/ttf.c", 211, __extension__ __PRETTY_FUNCTION__); }))
# 211 "coders/ttf.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ttf.c",__func__,(unsigned long) 213,"%s",
      image_info->filename);
...
# 219 "coders/ttf.c" 3 4
                                      ((void *)0)
# 219 "coders/ttf.c"
                                          ) &&
      (type_info->glyphs != (char *) 
# 220 "coders/ttf.c" 3 4
                                    ((void *)0)
# 220 "coders/ttf.c"
                                        ))
    (void) CopyMagickString(image->filename,type_info->glyphs,4096);
  status=OpenBlob(image_info,image,ReadBinaryBlobMode,exception);
  if (status == MagickFalse)
    {
      image=DestroyImageList(image);
      return((Image *) 
# 226 "coders/ttf.c" 3 4
                      ((void *)0)
# 226 "coders/ttf.c"
                          );
    }
...
# 255 "coders/ttf.c"
  ...
  (void) FormatLocaleString(buffer,4096," text 10,%.20g '",
    (double) y);
  ConcatenateString(&draw_info->primitive,buffer);
  ...
  for (i=12; i <= 72; i+=6)
  {
    ...
    (void) FormatLocaleString(buffer,4096,
      " text 10,%.20g '%.20g'\n",(double) y,(double) i);
    ConcatenateString(&draw_info->primitive,buffer);
    (void) FormatLocaleString(buffer,4096," font-size %.20g\n",
      (double) i);
    ConcatenateString(&draw_info->primitive,buffer);
    (void) FormatLocaleString(buffer,4096," text 50,%.20g "
...
# 326 "coders/ttf.c"
__attribute__ ((visibility ("default"))) size_t RegisterTTFImage(void)
{
  char
    version[4096];
  ...
  *version='\0';
  ...
  (void) FormatLocaleString(version,4096,"Freetype %d.%d.%d",
    2,13,2);
...
# 415 "coders/ttf.c"
__attribute__ ((visibility ("default"))) void UnregisterTTFImage(void)
{
