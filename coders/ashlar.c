...
# 96 "coders/ashlar.c"
__attribute__ ((visibility ("default"))) size_t RegisterASHLARImage(void)
{
  MagickInfo
    *entry;
...
# 127 "coders/ashlar.c"
__attribute__ ((visibility ("default"))) void UnregisterASHLARImage(void)
{
  ...
  const size_t width,size_t const height)
{
  ...
  tile.previous=(NodeInfo **) 
# 278 "coders/ashlar.c" 3 4
                             ((void *)0)
# 278 "coders/ashlar.c"
                                 ;
  ...
  tile.x=(ssize_t) (0x7fffffffffffffffL
# 290 "coders/ashlar.c"
                  );
  tile.y=(ssize_t) (0x7fffffffffffffffL
# 291 "coders/ashlar.c"
                  );
  min_excess=(ssize_t) (0x7fffffffffffffffL
# 292 "coders/ashlar.c"
                      );
  ...
  tile.x=(tile.previous == (NodeInfo **) 
# 323 "coders/ashlar.c" 3 4
                                        ((void *)0)
# 323 "coders/ashlar.c"
                                            ) ? 0 : (*tile.previous)->x;
  if (ashlar_info->best_fit != MagickFalse)
  ...
  const size_t width,const size_t height)
{
  ...
  if ((tile.previous == (NodeInfo **) 
# 380 "coders/ashlar.c" 3 4
                                     ((void *)0)
# 380 "coders/ashlar.c"
                                         ) ||
      ((tile.y+(ssize_t) height) > (ssize_t) ashlar_info->height) ||
      (ashlar_info->free == (NodeInfo *) 
# 382 "coders/ashlar.c" 3 4
                                        ((void *)0)
# 382 "coders/ashlar.c"
                                            ))
    {
      tile.previous=(NodeInfo **) 
# 384 "coders/ashlar.c" 3 4
                                 ((void *)0)
# 384 "coders/ashlar.c"
                                     ;
      return(tile);
   ...
   while ((current->next != (NodeInfo *) 
# 406 "coders/ashlar.c" 3 4
                                        ((void *)0)
# 406 "coders/ashlar.c"
                                            ) &&
    ...
    if ((tiles[i].width != 0) && (tiles[i].height != 0))
      {
        ...
        if (tile_info.previous == (NodeInfo **) 
# 477 "coders/ashlar.c" 3 4
                                               ((void *)0)
# 477 "coders/ashlar.c"
                                                   )
          {
            tiles[i].x=(ssize_t) (0x7fffffffffffffffL
# 479 "coders/ashlar.c"
                                );
            tiles[i].y=(ssize_t) (0x7fffffffffffffffL
# 480 "coders/ashlar.c"
                                );
          }
      }
  ...
  for (i=0; i < (ssize_t) number_tiles; i++)
  {
    tiles[i].order=(ssize_t) ((tiles[i].x != (ssize_t) (0x7fffffffffffffffL
# 488 "coders/ashlar.c"
                                                      )) ||
      (tiles[i].y != (ssize_t) (0x7fffffffffffffffL
# 489 "coders/ashlar.c"
...
# 537 "coders/ashlar.c"
      ...
      if (image_info->extract != (char *) 
# 547 "coders/ashlar.c" 3 4
                                         ((void *)0)
# 547 "coders/ashlar.c"
                                             )
        (void) FormatLocaleString(image_info->extract,4096,
...
# 568 "coders/ashlar.c"
    ...
    {
      if (tiles != (CanvasInfo *) 
# 570 "coders/ashlar.c" 3 4
                                 ((void *)0)
# 570 "coders/ashlar.c"
                                     )
        tiles=(CanvasInfo *) RelinquishMagickMemory(tiles);
      if (nodes != (NodeInfo *) 
# 572 "coders/ashlar.c" 3 4
                               ((void *)0)
# 572 "coders/ashlar.c"
                                   )
        nodes=(NodeInfo *) RelinquishMagickMemory(tiles);
      ashlar_image=DestroyImageList(ashlar_image);
      { (void) ThrowMagickException(exception,"coders/ashlar.c",__func__,(unsigned long) 575,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 575 "coders/ashlar.c" 3 4
     ((void *)0)
# 575 "coders/ashlar.c"
     ); };
    }
...
# 587 "coders/ashlar.c"
    ...
    nodes[j].next=(NodeInfo *) 
# 596 "coders/ashlar.c" 3 4
                              ((void *)0)
# 596 "coders/ashlar.c"
                                  ;
    ...
    ashlar_info.sentinel.y=(ssize_t) (0x7fffffffffffffffL
# 609 "coders/ashlar.c"
                                    );
    ashlar_info.sentinel.next=(NodeInfo *) 
# 610 "coders/ashlar.c" 3 4
                                          ((void *)0)
# 610 "coders/ashlar.c"
                                              ;
  ...
  for (i=0; i < n; i++)
  {
    ...
    if ((tiles[i].x == (ssize_t) (0x7fffffffffffffffL
# 626 "coders/ashlar.c"
                                )) ||
        (tiles[i].y == (ssize_t) (0x7fffffffffffffffL
# 627 "coders/ashlar.c"
...
# 647 "coders/ashlar.c"
                                       )
          {
            ...
            (void) FormatLocaleString(offset,4096,"%+g%+g",(double)
...
# 698 "coders/ashlar.c" 3 4
 , "coders/ashlar.c", 698, __extension__ __PRETTY_FUNCTION__); }))
# 698 "coders/ashlar.c"
                                               ;
  
# 699 "coders/ashlar.c" 3 4
 ((void) sizeof ((
# 699 "coders/ashlar.c"
...
# 699 "coders/ashlar.c" 3 4
 , "coders/ashlar.c", 699, __extension__ __PRETTY_FUNCTION__); }))
# 699 "coders/ashlar.c"
                                                     ;
  
# 700 "coders/ashlar.c" 3 4
 ((void) sizeof ((
# 700 "coders/ashlar.c"
 image != (Image *) 
# 700 "coders/ashlar.c" 3 4
...
# 700 "coders/ashlar.c"
 "image != (Image *) NULL"
# 700 "coders/ashlar.c" 3 4
 , "coders/ashlar.c", 700, __extension__ __PRETTY_FUNCTION__); }))
# 700 "coders/ashlar.c"
                                ;
  
# 701 "coders/ashlar.c" 3 4
 ((void) sizeof ((
# 701 "coders/ashlar.c"
...
# 701 "coders/ashlar.c" 3 4
 , "coders/ashlar.c", 701, __extension__ __PRETTY_FUNCTION__); }))
# 701 "coders/ashlar.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ashlar.c",__func__,(unsigned long) 703,"%s",image->filename);
  tiles_per_page=GetImageListLength(image);
  value=GetImageOption(image_info,"ashlar:tiles");
  if (value != (const char *) 
# 706 "coders/ashlar.c" 3 4
                             ((void *)0)
# 706 "coders/ashlar.c"
                                 )
    tiles_per_page=(size_t) (((StringToInteger(value)) > (1)) ? (StringToInteger(value)) : (1));
  ...
  for (i=0; i < (ssize_t) GetImageListLength(image); i+=(ssize_t) tiles_per_page)
  {
    ...
    (void) FormatLocaleString(scenes,4096,"%g-%g",(double) i,
      (double) (i+(ssize_t) tiles_per_page-1));
    clone_images=CloneImages(image,scenes,exception);
    if (clone_images == (Image *) 
# 722 "coders/ashlar.c" 3 4
                                 ((void *)0)
# 722 "coders/ashlar.c"
                                     )
      {
        if (ashlar_images != (Image *) 
# 724 "coders/ashlar.c" 3 4
                                      ((void *)0)
# 724 "coders/ashlar.c"
                                          )
    ...
    if (ashlar_image == (Image *) 
# 730 "coders/ashlar.c" 3 4
                                 ((void *)0)
# 730 "coders/ashlar.c"
                                     )
      {
        if (ashlar_images != (Image *) 
# 732 "coders/ashlar.c" 3 4
                                      ((void *)0)
# 732 "coders/ashlar.c"
                                          )
          ashlar_images=DestroyImageList(ashlar_images);
...
# 747 "coders/ashlar.c" 3 4
                                         ((void *)0)
# 747 "coders/ashlar.c"
                                             ) ||
      (LocaleCompare(magick_info->module,"ASHLAR") == 0))
    (void) FormatLocaleString(ashlar_images->filename,4096,
