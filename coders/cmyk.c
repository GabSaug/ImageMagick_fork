...
# 137 "coders/cmyk.c" 3 4
 , "coders/cmyk.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "coders/cmyk.c"
                                               ;
  
# 138 "coders/cmyk.c" 3 4
 ((void) sizeof ((
# 138 "coders/cmyk.c"
...
# 138 "coders/cmyk.c" 3 4
 , "coders/cmyk.c", 138, __extension__ __PRETTY_FUNCTION__); }))
# 138 "coders/cmyk.c"
                                                     ;
  
# 139 "coders/cmyk.c" 3 4
 ((void) sizeof ((
# 139 "coders/cmyk.c"
...
# 139 "coders/cmyk.c" 3 4
 , "coders/cmyk.c", 139, __extension__ __PRETTY_FUNCTION__); }))
# 139 "coders/cmyk.c"
                                            ;
  
# 140 "coders/cmyk.c" 3 4
 ((void) sizeof ((
# 140 "coders/cmyk.c"
...
# 140 "coders/cmyk.c" 3 4
 , "coders/cmyk.c", 140, __extension__ __PRETTY_FUNCTION__); }))
# 140 "coders/cmyk.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/cmyk.c",__func__,(unsigned long) 142,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 146,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 146 "coders/cmyk.c" 3 4
   ((void *)0)
# 146 "coders/cmyk.c"
...
# 160 "coders/cmyk.c" 3 4
       (*__errno_location ())
# 160 "coders/cmyk.c"
       ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 160,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
    }
...
# 168 "coders/cmyk.c" 3 4
                               ((void *)0)
# 168 "coders/cmyk.c"
                                   )
    { (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 169,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 169 "coders/cmyk.c" 3 4
   ((void *)0)
# 169 "coders/cmyk.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 169 "coders/cmyk.c" 3 4
...
# 179 "coders/cmyk.c" 3 4
                                     ((void *)0)
# 179 "coders/cmyk.c"
                                         )
    {
      canvas_image=DestroyImage(canvas_image);
      { (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 182,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 182 "coders/cmyk.c" 3 4
     ((void *)0)
# 182 "coders/cmyk.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 182 "coders/cmyk.c" 3 4
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 246 "coders/cmyk.c" 3 4
             (*__errno_location ())
# 246 "coders/cmyk.c"
             ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 246,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
            ...
            if (count != (ssize_t) length)
              {
                status=MagickFalse;
                { char *file_message; file_message=GetExceptionMessage(
# 329 "coders/cmyk.c" 3 4
               (*__errno_location ())
# 329 "coders/cmyk.c"
               ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 329,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                        ;
                break;
              }
            ...
            q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
              exception);
            if (q == (Quantum *) 
# 336 "coders/cmyk.c" 3 4
                                ((void *)0)
# 336 "coders/cmyk.c"
                                    )
              break;
            length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 338 "coders/cmyk.c" 3 4
                                                                 ((void *)0)
# 338 "coders/cmyk.c"
                                                                     ,
              quantum_info,quantum_type,(unsigned char *) stream,exception);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 425 "coders/cmyk.c" 3 4
             (*__errno_location ())
# 425 "coders/cmyk.c"
             ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 425,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 431 "coders/cmyk.c" 3 4
                              ((void *)0)
# 431 "coders/cmyk.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 433 "coders/cmyk.c" 3 4
                                                               ((void *)0)
# 433 "coders/cmyk.c"
                                                                   ,
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 477 "coders/cmyk.c" 3 4
             (*__errno_location ())
# 477 "coders/cmyk.c"
             ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 477,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 483 "coders/cmyk.c" 3 4
                              ((void *)0)
# 483 "coders/cmyk.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 485 "coders/cmyk.c" 3 4
                                                               ((void *)0)
# 485 "coders/cmyk.c"
                                                                   ,
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 529 "coders/cmyk.c" 3 4
             (*__errno_location ())
# 529 "coders/cmyk.c"
             ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 529,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 535 "coders/cmyk.c" 3 4
                              ((void *)0)
# 535 "coders/cmyk.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 537 "coders/cmyk.c" 3 4
                                                               ((void *)0)
# 537 "coders/cmyk.c"
                                                                   ,
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 581 "coders/cmyk.c" 3 4
             (*__errno_location ())
# 581 "coders/cmyk.c"
             ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 581,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 587 "coders/cmyk.c" 3 4
                              ((void *)0)
# 587 "coders/cmyk.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 589 "coders/cmyk.c" 3 4
                                                               ((void *)0)
# 589 "coders/cmyk.c"
                                                                   ,
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 635 "coders/cmyk.c" 3 4
                 (*__errno_location ())
# 635 "coders/cmyk.c"
                 ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 635,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
              q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
                exception);
              if (q == (Quantum *) 
# 641 "coders/cmyk.c" 3 4
                                  ((void *)0)
# 641 "coders/cmyk.c"
                                      )
                break;
              length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 643 "coders/cmyk.c" 3 4
                                                                   ((void *)0)
# 643 "coders/cmyk.c"
                                                                       ,
        ...
        if (DiscardBlobBytes(image,(MagickSizeType) image->offset) == MagickFalse)
          {
            status=MagickFalse;
            { char *file_message; file_message=GetExceptionMessage(
# 695 "coders/cmyk.c" 3 4
           (*__errno_location ())
# 695 "coders/cmyk.c"
           ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 695,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                    ;
            break;
          }
        length=GetQuantumExtent(canvas_image,quantum_info,CyanQuantum);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 726 "coders/cmyk.c" 3 4
             (*__errno_location ())
# 726 "coders/cmyk.c"
             ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 726,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 732 "coders/cmyk.c" 3 4
                              ((void *)0)
# 732 "coders/cmyk.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 734 "coders/cmyk.c" 3 4
                                                               ((void *)0)
# 734 "coders/cmyk.c"
                                                                   ,
            quantum_info,CyanQuantum,(unsigned char *) stream,exception);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 797 "coders/cmyk.c" 3 4
             (*__errno_location ())
# 797 "coders/cmyk.c"
             ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 797,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 803 "coders/cmyk.c" 3 4
                              ((void *)0)
# 803 "coders/cmyk.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 805 "coders/cmyk.c" 3 4
                                                               ((void *)0)
# 805 "coders/cmyk.c"
                                                                   ,
            quantum_info,MagentaQuantum,(unsigned char *) stream,exception);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 868 "coders/cmyk.c" 3 4
             (*__errno_location ())
# 868 "coders/cmyk.c"
             ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 868,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 874 "coders/cmyk.c" 3 4
                              ((void *)0)
# 874 "coders/cmyk.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 876 "coders/cmyk.c" 3 4
                                                               ((void *)0)
# 876 "coders/cmyk.c"
                                                                   ,
            quantum_info,YellowQuantum,(unsigned char *) stream,exception);
          ...
          if (((y-image->extract_info.y) >= 0) &&
              ((y-image->extract_info.y) < (ssize_t) image->rows))
            {
              ...
              q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                image->columns,1,exception);
              if ((p == (const Quantum *) 
# 887 "coders/cmyk.c" 3 4
                                         ((void *)0)
# 887 "coders/cmyk.c"
                                             ) ||
                  (q == (Quantum *) 
# 888 "coders/cmyk.c" 3 4
                                   ((void *)0)
# 888 "coders/cmyk.c"
                                       ))
                break;
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 940 "coders/cmyk.c" 3 4
             (*__errno_location ())
# 940 "coders/cmyk.c"
             ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 940,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 946 "coders/cmyk.c" 3 4
                              ((void *)0)
# 946 "coders/cmyk.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 948 "coders/cmyk.c" 3 4
                                                               ((void *)0)
# 948 "coders/cmyk.c"
                                                                   ,
            quantum_info,BlackQuantum,(unsigned char *) stream,exception);
          ...
          if (((y-image->extract_info.y) >= 0) &&
              ((y-image->extract_info.y) < (ssize_t) image->rows))
            {
              ...
              q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                image->columns,1,exception);
              if ((p == (const Quantum *) 
# 959 "coders/cmyk.c" 3 4
                                         ((void *)0)
# 959 "coders/cmyk.c"
                                             ) ||
                  (q == (Quantum *) 
# 960 "coders/cmyk.c" 3 4
                                   ((void *)0)
# 960 "coders/cmyk.c"
                                       ))
                break;
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 1014 "coders/cmyk.c" 3 4
                 (*__errno_location ())
# 1014 "coders/cmyk.c"
                 ); (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 1014,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
              q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
                exception);
              if (q == (Quantum *) 
# 1020 "coders/cmyk.c" 3 4
                                  ((void *)0)
# 1020 "coders/cmyk.c"
                                      )
                break;
              length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 1022 "coders/cmyk.c" 3 4
                                                                   ((void *)0)
# 1022 "coders/cmyk.c"
                                                                       ,
                quantum_info,YellowQuantum,(unsigned char *) stream,exception);
              ...
              if (((y-image->extract_info.y) >= 0) &&
                  ((y-image->extract_info.y) < (ssize_t) image->rows))
                {
                  ...
                  q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                    image->columns,1,exception);
                  if ((p == (const Quantum *) 
# 1033 "coders/cmyk.c" 3 4
                                             ((void *)0)
# 1033 "coders/cmyk.c"
                                                 ) ||
                      (q == (Quantum *) 
# 1034 "coders/cmyk.c" 3 4
                                       ((void *)0)
# 1034 "coders/cmyk.c"
                                           ))
                    break;
...
# 1123 "coders/cmyk.c"
__attribute__ ((visibility ("default"))) size_t RegisterCMYKImage(void)
{
  MagickInfo
    *entry;
...
# 1164 "coders/cmyk.c"
__attribute__ ((visibility ("default"))) void UnregisterCMYKImage(void)
{
...
# 1227 "coders/cmyk.c"
 "image_info != (const ImageInfo *) NULL"
# 1227 "coders/cmyk.c" 3 4
 , "coders/cmyk.c", 1227, __extension__ __PRETTY_FUNCTION__); }))
# 1227 "coders/cmyk.c"
                                               ;
  
# 1228 "coders/cmyk.c" 3 4
 ((void) sizeof ((
# 1228 "coders/cmyk.c"
 image_info->signature == 0xabacadabUL
# 1228 "coders/cmyk.c" 3 4
...
# 1228 "coders/cmyk.c"
 "image_info->signature == MagickCoreSignature"
# 1228 "coders/cmyk.c" 3 4
 , "coders/cmyk.c", 1228, __extension__ __PRETTY_FUNCTION__); }))
# 1228 "coders/cmyk.c"
                                                     ;
  
# 1229 "coders/cmyk.c" 3 4
 ((void) sizeof ((
# 1229 "coders/cmyk.c"
 image != (Image *) 
# 1229 "coders/cmyk.c" 3 4
...
# 1229 "coders/cmyk.c"
 "image != (Image *) NULL"
# 1229 "coders/cmyk.c" 3 4
 , "coders/cmyk.c", 1229, __extension__ __PRETTY_FUNCTION__); }))
# 1229 "coders/cmyk.c"
                                ;
  
# 1230 "coders/cmyk.c" 3 4
 ((void) sizeof ((
# 1230 "coders/cmyk.c"
...
# 1230 "coders/cmyk.c" 3 4
 , "coders/cmyk.c", 1230, __extension__ __PRETTY_FUNCTION__); }))
# 1230 "coders/cmyk.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/cmyk.c",__func__,(unsigned long) 1232,"%s",image->filename);
  if (image_info->interlace != PartitionInterlace)
    {
  ...
  do
  {
    ...
    if (quantum_info == (QuantumInfo *) 
# 1259 "coders/cmyk.c" 3 4
                                       ((void *)0)
# 1259 "coders/cmyk.c"
                                           )
      { (void) ThrowMagickException(exception,"coders/cmyk.c",__func__,(unsigned long) 1260,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1260 "coders/cmyk.c" 3 4
     ((void *)0)
# 1260 "coders/cmyk.c"
    ...
    switch (image_info->interlace)
    {
      ...
      default:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          if (p == (const Quantum *) 
# 1276 "coders/cmyk.c" 3 4
                                    ((void *)0)
# 1276 "coders/cmyk.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1278 "coders/cmyk.c" 3 4
                                                        ((void *)0)
# 1278 "coders/cmyk.c"
                                                            ,quantum_info,
...
# 1283 "coders/cmyk.c"
      ...
      case LineInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1304 "coders/cmyk.c" 3 4
                                    ((void *)0)
# 1304 "coders/cmyk.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1306 "coders/cmyk.c" 3 4
                                                        ((void *)0)
# 1306 "coders/cmyk.c"
                                                            ,quantum_info,
...
# 1334 "coders/cmyk.c"
      ...
      case PlaneInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1355 "coders/cmyk.c" 3 4
                                    ((void *)0)
# 1355 "coders/cmyk.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1357 "coders/cmyk.c" 3 4
                                                        ((void *)0)
# 1357 "coders/cmyk.c"
                                                            ,quantum_info,
            CyanQuantum,pixels,exception);
...
# 1363 "coders/cmyk.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1375 "coders/cmyk.c" 3 4
                                    ((void *)0)
# 1375 "coders/cmyk.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1377 "coders/cmyk.c" 3 4
                                                        ((void *)0)
# 1377 "coders/cmyk.c"
                                                            ,quantum_info,
            MagentaQuantum,pixels,exception);
...
# 1383 "coders/cmyk.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1395 "coders/cmyk.c" 3 4
                                    ((void *)0)
# 1395 "coders/cmyk.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1397 "coders/cmyk.c" 3 4
                                                        ((void *)0)
# 1397 "coders/cmyk.c"
                                                            ,quantum_info,
            YellowQuantum,pixels,exception);
...
# 1403 "coders/cmyk.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1415 "coders/cmyk.c" 3 4
                                    ((void *)0)
# 1415 "coders/cmyk.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1417 "coders/cmyk.c" 3 4
                                                        ((void *)0)
# 1417 "coders/cmyk.c"
                                                            ,quantum_info,
            BlackQuantum,pixels,exception);
        ...
        if (image->previous == (Image *) 
# 1423 "coders/cmyk.c" 3 4
                                        ((void *)0)
# 1423 "coders/cmyk.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",4,6);
            if (status == MagickFalse)
              break;
          }
        if (quantum_type == CMYKAQuantum)
          {
            for (y=0; y < (ssize_t) image->rows; y++)
            {
              ...
              p=GetVirtualPixels(image,0,y,image->columns,1,exception);
              if (p == (const Quantum *) 
# 1437 "coders/cmyk.c" 3 4
                                        ((void *)0)
# 1437 "coders/cmyk.c"
                                            )
                break;
              length=ExportQuantumPixels(image,(CacheView *) 
# 1439 "coders/cmyk.c" 3 4
                                                            ((void *)0)
# 1439 "coders/cmyk.c"
                                                                ,quantum_info,
                AlphaQuantum,pixels,exception);
...
# 1455 "coders/cmyk.c"
      ...
      case PartitionInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1479 "coders/cmyk.c" 3 4
                                    ((void *)0)
# 1479 "coders/cmyk.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1481 "coders/cmyk.c" 3 4
                                                        ((void *)0)
# 1481 "coders/cmyk.c"
                                                            ,quantum_info,
            CyanQuantum,pixels,exception);
...
# 1487 "coders/cmyk.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1506 "coders/cmyk.c" 3 4
                                    ((void *)0)
# 1506 "coders/cmyk.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1508 "coders/cmyk.c" 3 4
                                                        ((void *)0)
# 1508 "coders/cmyk.c"
                                                            ,quantum_info,
            MagentaQuantum,pixels,exception);
...
# 1514 "coders/cmyk.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1533 "coders/cmyk.c" 3 4
                                    ((void *)0)
# 1533 "coders/cmyk.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1535 "coders/cmyk.c" 3 4
                                                        ((void *)0)
# 1535 "coders/cmyk.c"
                                                            ,quantum_info,
            YellowQuantum,pixels,exception);
...
# 1541 "coders/cmyk.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1560 "coders/cmyk.c" 3 4
                                    ((void *)0)
# 1560 "coders/cmyk.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1562 "coders/cmyk.c" 3 4
                                                        ((void *)0)
# 1562 "coders/cmyk.c"
                                                            ,quantum_info,
            BlackQuantum,pixels,exception);
        ...
        if (quantum_type == CMYKAQuantum)
          {
            ...
            for (y=0; y < (ssize_t) image->rows; y++)
            {
              ...
              p=GetVirtualPixels(image,0,y,image->columns,1,exception);
              if (p == (const Quantum *) 
# 1589 "coders/cmyk.c" 3 4
                                        ((void *)0)
# 1589 "coders/cmyk.c"
                                            )
                break;
              length=ExportQuantumPixels(image,(CacheView *) 
# 1591 "coders/cmyk.c" 3 4
                                                            ((void *)0)
# 1591 "coders/cmyk.c"
                                                                ,quantum_info,
                AlphaQuantum,pixels,exception);
