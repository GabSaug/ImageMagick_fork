...
# 164 "coders/fl32.c" 3 4
 , "coders/fl32.c", 164, __extension__ __PRETTY_FUNCTION__); }))
# 164 "coders/fl32.c"
                                               ;
  
# 165 "coders/fl32.c" 3 4
 ((void) sizeof ((
# 165 "coders/fl32.c"
...
# 165 "coders/fl32.c" 3 4
 , "coders/fl32.c", 165, __extension__ __PRETTY_FUNCTION__); }))
# 165 "coders/fl32.c"
                                                     ;
  
# 166 "coders/fl32.c" 3 4
 ((void) sizeof ((
# 166 "coders/fl32.c"
...
# 166 "coders/fl32.c" 3 4
 , "coders/fl32.c", 166, __extension__ __PRETTY_FUNCTION__); }))
# 166 "coders/fl32.c"
                                            ;
  
# 167 "coders/fl32.c" 3 4
 ((void) sizeof ((
# 167 "coders/fl32.c"
...
# 167 "coders/fl32.c" 3 4
 , "coders/fl32.c", 167, __extension__ __PRETTY_FUNCTION__); }))
# 167 "coders/fl32.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/fl32.c",__func__,(unsigned long) 169,"%s",
      image_info->filename);
...
# 176 "coders/fl32.c"
  ...
  if (magic != 842222662)
    { (void) ThrowMagickException(exception,"coders/fl32.c",__func__,(unsigned long) 180,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 180 "coders/fl32.c" 3 4
   ((void *)0)
# 180 "coders/fl32.c"
...
# 180 "coders/fl32.c"
  ...
  if ((image->columns == 0) || (image->rows == 0) ||
    ...
    { (void) ThrowMagickException(exception,"coders/fl32.c",__func__,(unsigned long) 189,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 189 "coders/fl32.c" 3 4
   ((void *)0)
# 189 "coders/fl32.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 189 "coders/fl32.c" 3 4
...
# 237 "coders/fl32.c" 3 4
                                     ((void *)0)
# 237 "coders/fl32.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/fl32.c",__func__,(unsigned long) 238,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 238 "coders/fl32.c" 3 4
   ((void *)0)
# 238 "coders/fl32.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 238 "coders/fl32.c" 3 4
...
# 256 "coders/fl32.c"
  ...
  if (y < (ssize_t) image->rows)
    { (void) ThrowMagickException(exception,"coders/fl32.c",__func__,(unsigned long) 266,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 266 "coders/fl32.c" 3 4
   ((void *)0)
# 266 "coders/fl32.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 266 "coders/fl32.c" 3 4
...
# 268 "coders/fl32.c" 3 4
   (*__errno_location ())
# 268 "coders/fl32.c"
   ); (void) ThrowMagickException(exception,"coders/fl32.c",__func__,(unsigned long) 268,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 300 "coders/fl32.c"
__attribute__ ((visibility ("default"))) size_t RegisterFL32Image(void)
{
  MagickInfo
    *entry;
...
# 334 "coders/fl32.c"
__attribute__ ((visibility ("default"))) void UnregisterFL32Image(void)
{
...
# 395 "coders/fl32.c"
 "image_info != (const ImageInfo *) NULL"
# 395 "coders/fl32.c" 3 4
 , "coders/fl32.c", 395, __extension__ __PRETTY_FUNCTION__); }))
# 395 "coders/fl32.c"
                                               ;
  
# 396 "coders/fl32.c" 3 4
 ((void) sizeof ((
# 396 "coders/fl32.c"
 image_info->signature == 0xabacadabUL
# 396 "coders/fl32.c" 3 4
...
# 396 "coders/fl32.c"
 "image_info->signature == MagickCoreSignature"
# 396 "coders/fl32.c" 3 4
 , "coders/fl32.c", 396, __extension__ __PRETTY_FUNCTION__); }))
# 396 "coders/fl32.c"
                                                     ;
  
# 397 "coders/fl32.c" 3 4
 ((void) sizeof ((
# 397 "coders/fl32.c"
 image != (Image *) 
# 397 "coders/fl32.c" 3 4
...
# 397 "coders/fl32.c"
 "image != (Image *) NULL"
# 397 "coders/fl32.c" 3 4
 , "coders/fl32.c", 397, __extension__ __PRETTY_FUNCTION__); }))
# 397 "coders/fl32.c"
                                ;
  
# 398 "coders/fl32.c" 3 4
 ((void) sizeof ((
# 398 "coders/fl32.c"
...
# 398 "coders/fl32.c" 3 4
 , "coders/fl32.c", 398, __extension__ __PRETTY_FUNCTION__); }))
# 398 "coders/fl32.c"
                                                ;
  
# 399 "coders/fl32.c" 3 4
 ((void) sizeof ((
# 399 "coders/fl32.c"
 exception != (ExceptionInfo *) 
# 399 "coders/fl32.c" 3 4
...
# 399 "coders/fl32.c"
 "exception != (ExceptionInfo *) NULL"
# 399 "coders/fl32.c" 3 4
 , "coders/fl32.c", 399, __extension__ __PRETTY_FUNCTION__); }))
# 399 "coders/fl32.c"
                                            ;
  
# 400 "coders/fl32.c" 3 4
 ((void) sizeof ((
# 400 "coders/fl32.c"
 exception->signature == 0xabacadabUL
# 400 "coders/fl32.c" 3 4
...
# 400 "coders/fl32.c"
 "exception->signature == MagickCoreSignature"
# 400 "coders/fl32.c" 3 4
 , "coders/fl32.c", 400, __extension__ __PRETTY_FUNCTION__); }))
# 400 "coders/fl32.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/fl32.c",__func__,(unsigned long) 402,"%s",image->filename);
  ...
  quantum_info=AcquireQuantumInfo(image_info,image);
  if (quantum_info == (QuantumInfo *) 
# 452 "coders/fl32.c" 3 4
                                     ((void *)0)
# 452 "coders/fl32.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/fl32.c",__func__,(unsigned long) 453,ImageError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 453 "coders/fl32.c" 3 4
   ((void *)0)
# 453 "coders/fl32.c"
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 459 "coders/fl32.c" 3 4
                              ((void *)0)
# 459 "coders/fl32.c"
                                  )
      break;
    extent=ExportQuantumPixels(image,(CacheView *) 
# 461 "coders/fl32.c" 3 4
                                                  ((void *)0)
# 461 "coders/fl32.c"
                                                      ,quantum_info,
  ...
  quantum_info=DestroyQuantumInfo(quantum_info);
  if (y < (ssize_t) image->rows)
    { (void) ThrowMagickException(exception,"coders/fl32.c",__func__,(unsigned long) 473,CorruptImageError,"UnableToWriteImageData", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 473 "coders/fl32.c" 3 4
   ((void *)0)
# 473 "coders/fl32.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  if (CloseBlob(image) == MagickFalse)
