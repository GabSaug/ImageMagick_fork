...
# 141 "coders/mvg.c" 3 4
 , "coders/mvg.c", 141, __extension__ __PRETTY_FUNCTION__); }))
# 141 "coders/mvg.c"
                                               ;
  
# 142 "coders/mvg.c" 3 4
 ((void) sizeof ((
# 142 "coders/mvg.c"
...
# 142 "coders/mvg.c" 3 4
 , "coders/mvg.c", 142, __extension__ __PRETTY_FUNCTION__); }))
# 142 "coders/mvg.c"
                                                     ;
  
# 143 "coders/mvg.c" 3 4
 ((void) sizeof ((
# 143 "coders/mvg.c"
...
# 143 "coders/mvg.c" 3 4
 , "coders/mvg.c", 143, __extension__ __PRETTY_FUNCTION__); }))
# 143 "coders/mvg.c"
                                            ;
  
# 144 "coders/mvg.c" 3 4
 ((void) sizeof ((
# 144 "coders/mvg.c"
...
# 144 "coders/mvg.c" 3 4
 , "coders/mvg.c", 144, __extension__ __PRETTY_FUNCTION__); }))
# 144 "coders/mvg.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mvg.c",__func__,(unsigned long) 146,"%s",
      image_info->filename);
  ...
  if ((image->columns == 0) || (image->rows == 0))
    {
      ...
      while (ReadBlobString(image,primitive) != (char *) 
# 170 "coders/mvg.c" 3 4
                                                        ((void *)0)
# 170 "coders/mvg.c"
                                                            )
      {
  ...
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/mvg.c",__func__,(unsigned long) 186,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 186 "coders/mvg.c" 3 4
   ((void *)0)
# 186 "coders/mvg.c"
...
# 187 "coders/mvg.c" 3 4
                                                 ((void *)0)
# 187 "coders/mvg.c"
                                                     );
  if (draw_info->density != (char *) 
# 188 "coders/mvg.c" 3 4
                                    ((void *)0)
# 188 "coders/mvg.c"
                                        )
...
# 229 "coders/mvg.c"
  ...
  if (*draw_info->primitive == '@')
    {
      draw_info=DestroyDrawInfo(draw_info);
      { (void) ThrowMagickException(exception,"coders/mvg.c",__func__,(unsigned long) 237,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 237 "coders/mvg.c" 3 4
     ((void *)0)
# 237 "coders/mvg.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 237 "coders/mvg.c" 3 4
...
# 272 "coders/mvg.c"
__attribute__ ((visibility ("default"))) size_t RegisterMVGImage(void)
{
  MagickInfo
    *entry;
...
# 307 "coders/mvg.c"
__attribute__ ((visibility ("default"))) void UnregisterMVGImage(void)
{
...
# 351 "coders/mvg.c"
 "image_info != (const ImageInfo *) NULL"
# 351 "coders/mvg.c" 3 4
 , "coders/mvg.c", 351, __extension__ __PRETTY_FUNCTION__); }))
# 351 "coders/mvg.c"
                                               ;
  
# 352 "coders/mvg.c" 3 4
 ((void) sizeof ((
# 352 "coders/mvg.c"
 image_info->signature == 0xabacadabUL
# 352 "coders/mvg.c" 3 4
...
# 352 "coders/mvg.c"
 "image_info->signature == MagickCoreSignature"
# 352 "coders/mvg.c" 3 4
 , "coders/mvg.c", 352, __extension__ __PRETTY_FUNCTION__); }))
# 352 "coders/mvg.c"
                                                     ;
  
# 353 "coders/mvg.c" 3 4
 ((void) sizeof ((
# 353 "coders/mvg.c"
 image != (Image *) 
# 353 "coders/mvg.c" 3 4
...
# 353 "coders/mvg.c"
 "image != (Image *) NULL"
# 353 "coders/mvg.c" 3 4
 , "coders/mvg.c", 353, __extension__ __PRETTY_FUNCTION__); }))
# 353 "coders/mvg.c"
                                ;
  
# 354 "coders/mvg.c" 3 4
 ((void) sizeof ((
# 354 "coders/mvg.c"
...
# 354 "coders/mvg.c" 3 4
 , "coders/mvg.c", 354, __extension__ __PRETTY_FUNCTION__); }))
# 354 "coders/mvg.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mvg.c",__func__,(unsigned long) 356,"%s",image->filename);
  value=GetImageArtifact(image,"mvg:vector-graphics");
  if (value == (const char *) 
# 358 "coders/mvg.c" 3 4
                             ((void *)0)
# 358 "coders/mvg.c"
                                 )
    { (void) ThrowMagickException(exception,"coders/mvg.c",__func__,(unsigned long) 359,OptionError,"NoImageVectorGraphics", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 359 "coders/mvg.c" 3 4
   ((void *)0)
# 359 "coders/mvg.c"
