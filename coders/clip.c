...
# 102 "coders/clip.c" 3 4
 , "coders/clip.c", 102, __extension__ __PRETTY_FUNCTION__); }))
# 102 "coders/clip.c"
                                               ;
  
# 103 "coders/clip.c" 3 4
 ((void) sizeof ((
# 103 "coders/clip.c"
...
# 103 "coders/clip.c" 3 4
 , "coders/clip.c", 103, __extension__ __PRETTY_FUNCTION__); }))
# 103 "coders/clip.c"
                                                     ;
  
# 104 "coders/clip.c" 3 4
 ((void) sizeof ((
# 104 "coders/clip.c"
...
# 104 "coders/clip.c" 3 4
 , "coders/clip.c", 104, __extension__ __PRETTY_FUNCTION__); }))
# 104 "coders/clip.c"
                                            ;
  
# 105 "coders/clip.c" 3 4
 ((void) sizeof ((
# 105 "coders/clip.c"
...
# 105 "coders/clip.c" 3 4
 , "coders/clip.c", 105, __extension__ __PRETTY_FUNCTION__); }))
# 105 "coders/clip.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/clip.c",__func__,(unsigned long) 107,"%s",
      image_info->filename);
  read_info=CloneImageInfo(image_info);
  SetImageInfoBlob(read_info,(void *) 
# 110 "coders/clip.c" 3 4
                                     ((void *)0)
# 110 "coders/clip.c"
                                         ,0);
  (void) CopyMagickString(read_info->magick,"MIFF",4096);
  image=ReadImage(read_info,exception);
  read_info=DestroyImageInfo(read_info);
  if (image != (Image *) 
# 114 "coders/clip.c" 3 4
                        ((void *)0)
# 114 "coders/clip.c"
                            )
    {
      ...
      if (clip_image == (Image *) 
# 121 "coders/clip.c" 3 4
                                 ((void *)0)
# 121 "coders/clip.c"
                                     )
        { (void) ThrowMagickException(exception,"coders/clip.c",__func__,(unsigned long) 122,CoderError,"ImageDoesNotHaveAClipMask", "`%s'",image_info->filename); if ((image) != (Image *) 
# 122 "coders/clip.c" 3 4
       ((void *)0)
# 122 "coders/clip.c"
...
# 152 "coders/clip.c"
__attribute__ ((visibility ("default"))) size_t RegisterCLIPImage(void)
{
  MagickInfo
    *entry;
...
# 183 "coders/clip.c"
__attribute__ ((visibility ("default"))) void UnregisterCLIPImage(void)
{
  ...
  Image *image,ExceptionInfo *exception)
{
  ...
  if ((image->channels & WriteMaskChannel) == 0)
    { (void) ThrowMagickException(exception,"coders/clip.c",__func__,(unsigned long) 234,CoderError,"ImageDoesNotHaveAClipMask", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 234 "coders/clip.c" 3 4
   ((void *)0)
# 234 "coders/clip.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  clip_image=GetImageMask(image,WritePixelMask,exception);
  if (clip_image == (Image *) 
# 236 "coders/clip.c" 3 4
                             ((void *)0)
# 236 "coders/clip.c"
                                 )
    return(MagickFalse);
...
# 244 "coders/clip.c" 3 4
                                         ((void *)0)
# 244 "coders/clip.c"
                                             ) ||
      (LocaleCompare(magick_info->module,"CLIP") == 0))
    (void) FormatLocaleString(clip_image->filename,4096,"miff:%s",
      write_info->filename);
