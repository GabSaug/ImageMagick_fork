...
{
  if (lzw_info->table[0] != (size_t *) 
# 172 "coders/gif.c" 3 4
                                      ((void *)0)
# 172 "coders/gif.c"
                                          )
    lzw_info->table[0]=(size_t *) RelinquishMagickMemory(
      lzw_info->table[0]);
  if (lzw_info->table[1] != (size_t *) 
# 175 "coders/gif.c" 3 4
                                      ((void *)0)
# 175 "coders/gif.c"
                                          )
    lzw_info->table[1]=(size_t *) RelinquishMagickMemory(
      lzw_info->table[1]);
  if (lzw_info->stack != (LZWStack *) 
# 178 "coders/gif.c" 3 4
                                     ((void *)0)
# 178 "coders/gif.c"
                                         )
    {
      if (lzw_info->stack->codes != (size_t *) 
# 180 "coders/gif.c" 3 4
                                              ((void *)0)
# 180 "coders/gif.c"
                                                  )
...
static LZWInfo *AcquireLZWInfo(Image *image,const size_t data_size)
{
  ...
  if (lzw_info == (LZWInfo *) 
# 213 "coders/gif.c" 3 4
                             ((void *)0)
# 213 "coders/gif.c"
                                 )
    return((LZWInfo *) 
# 214 "coders/gif.c" 3 4
                      ((void *)0)
# 214 "coders/gif.c"
                          );
  ...
  lzw_info->table[0]=(size_t *) AcquireQuantumMemory((1UL << 12),
    sizeof(**lzw_info->table));
  lzw_info->table[1]=(size_t *) AcquireQuantumMemory((1UL << 12),
    sizeof(**lzw_info->table));
  if ((lzw_info->table[0] == (size_t *) 
# 226 "coders/gif.c" 3 4
                                       ((void *)0)
# 226 "coders/gif.c"
                                           ) ||
      (lzw_info->table[1] == (size_t *) 
# 227 "coders/gif.c" 3 4
                                       ((void *)0)
# 227 "coders/gif.c"
                                           ))
    {
      ...
      return((LZWInfo *) 
# 230 "coders/gif.c" 3 4
                        ((void *)0)
# 230 "coders/gif.c"
                            );
    }
  (void) memset(lzw_info->table[0],0,(1UL << 12)*sizeof(**lzw_info->table));
  (void) memset(lzw_info->table[1],0,(1UL << 12)*sizeof(**lzw_info->table));
...
# 247 "coders/gif.c"
                                         )
    {
      lzw_info=RelinquishLZWInfo(lzw_info);
      return((LZWInfo *) 
# 250 "coders/gif.c" 3 4
                        ((void *)0)
# 250 "coders/gif.c"
                            );
    }
  lzw_info->stack->codes=(size_t *) AcquireQuantumMemory(2UL*
    (1UL << 12),sizeof(*lzw_info->stack->codes));
  if (lzw_info->stack->codes == (size_t *) 
# 254 "coders/gif.c" 3 4
                                          ((void *)0)
# 254 "coders/gif.c"
                                              )
    {
      lzw_info=RelinquishLZWInfo(lzw_info);
      return((LZWInfo *) 
# 257 "coders/gif.c" 3 4
                        ((void *)0)
# 257 "coders/gif.c"
                            );
    }
  lzw_info->stack->index=lzw_info->stack->codes;
  lzw_info->stack->top=lzw_info->stack->codes+2*(1UL << 12);
  return(lzw_info);
}
...
static int ReadBlobLZWByte(LZWInfo *lzw_info)
{
  ...
  {
    if ((size_t) count > (1UL << 12))
      return(-1);
    count++;
    if ((size_t) value > (1UL << 12))
      return(-1);
...
# 417 "coders/gif.c"
 "image != (Image *) NULL"
# 417 "coders/gif.c" 3 4
 , "coders/gif.c", 417, __extension__ __PRETTY_FUNCTION__); }))
# 417 "coders/gif.c"
                                ;
  
# 418 "coders/gif.c" 3 4
 ((void) sizeof ((
# 418 "coders/gif.c"
...
# 418 "coders/gif.c" 3 4
 , "coders/gif.c", 418, __extension__ __PRETTY_FUNCTION__); }))
# 418 "coders/gif.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/gif.c",__func__,(unsigned long) 420,"%s",image->filename);
  data_size=(unsigned char) ReadBlobByte(image);
  if (data_size > 12)
    { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 423,CorruptImageError,"CorruptImage", "`%s'",image->filename); return(MagickFalse); };
  lzw_info=AcquireLZWInfo(image,data_size);
  if (lzw_info == (LZWInfo *) 
# 425 "coders/gif.c" 3 4
                             ((void *)0)
# 425 "coders/gif.c"
                                 )
    { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 426,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  pass=0;
  offset=0;
...
# 439 "coders/gif.c"
    ...
    for (x=0; x < (ssize_t) image->columns; )
    {
      ...
      SetPixelAlpha(image,index == opacity ? ((Quantum) 0) : ((Quantum) ((Quantum) 65535.0)),q);
      x++;
  ...
  if (y < (ssize_t) image->rows)
    { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 504,CorruptImageError,"CorruptImage", "`%s'",image->filename); return(MagickFalse); };
  return(MagickTrue);
}
# 535 "coders/gif.c"
...
# 611 "coders/gif.c"
 "image != (Image *) NULL"
# 611 "coders/gif.c" 3 4
 , "coders/gif.c", 611, __extension__ __PRETTY_FUNCTION__); }))
# 611 "coders/gif.c"
                                ;
  one=1;
  packet=(unsigned char *) AcquireQuantumMemory(256,sizeof(*packet));
  hash_code=(short *) AcquireQuantumMemory(5003,sizeof(*hash_code));
  hash_prefix=(short *) AcquireQuantumMemory(5003,sizeof(*hash_prefix));
  hash_suffix=(unsigned char *) AcquireQuantumMemory(5003,
    sizeof(*hash_suffix));
  if ((packet == (unsigned char *) 
# 618 "coders/gif.c" 3 4
                                  ((void *)0)
# 618 "coders/gif.c"
                                      ) || (hash_code == (short *) 
# 618 "coders/gif.c" 3 4
...
# 628 "coders/gif.c"
  ...
  (void) memset(hash_code,0,5003*sizeof(*hash_code));
  (void) memset(hash_prefix,0,5003*sizeof(*hash_prefix));
  (void) memset(hash_suffix,0,5003*sizeof(*hash_suffix));
  number_bits=data_size;
  max_code=((one << (number_bits))-1);
  ...
  datum=0;
  bits=0;
  { if (bits > 0) datum|=(size_t) (clear_code) << bits; else datum=(size_t) (clear_code); bits+=number_bits; while (bits >= 8) { packet[length++]=(unsigned char) (datum & 0xff); if (length == 255) { (void) WriteBlobByte(image,(unsigned char) length); (void) WriteBlob(image,length,packet); length=0; } datum>>=8; bits-=8; } if (free_code > max_code) { number_bits++; if (number_bits == 12UL) max_code=(1UL << 12UL); else max_code=((one << (number_bits))-1); } };
...
# 663 "coders/gif.c"
    ...
    for (x=(ssize_t) (y == 0 ? 1 : 0); x < (ssize_t) image->columns; x++)
    {
      ...
      p+=GetPixelChannels(image);
      k=(ssize_t) (((size_t) index << (12UL -8))+(size_t) waiting_code);
      if (k >= 5003)
        k-=5003;
      if (k < 0)
        continue;
      ...
      { if (bits > 0) datum|=(size_t) (waiting_code) << bits; else datum=(size_t) (waiting_code); bits+=number_bits; while (bits >= 8) { packet[length++]=(unsigned char) (datum & 0xff); if (length == 255) { (void) WriteBlobByte(image,(unsigned char) length); (void) WriteBlob(image,length,packet); length=0; } datum>>=8; bits-=8; } if (free_code > max_code) { number_bits++; if (number_bits == 12UL) max_code=(1UL << 12UL); else max_code=((one << (number_bits))-1); } };
      if (free_code < (1UL << 12UL))
        {
  ...
  { if (bits > 0) datum|=(size_t) (waiting_code) << bits; else datum=(size_t) (waiting_code); bits+=number_bits; while (bits >= 8) { packet[length++]=(unsigned char) (datum & 0xff); if (length == 255) { (void) WriteBlobByte(image,(unsigned char) length); (void) WriteBlob(image,length,packet); length=0; } datum>>=8; bits-=8; } if (free_code > max_code) { number_bits++; if (number_bits == 12UL) max_code=(1UL << 12UL); else max_code=((one << (number_bits))-1); } };
  { if (bits > 0) datum|=(size_t) (end_of_information_code) << bits; else datum=(size_t) (end_of_information_code); bits+=number_bits; while (bits >= 8) { packet[length++]=(unsigned char) (datum & 0xff); if (length == 255) { (void) WriteBlobByte(image,(unsigned char) length); (void) WriteBlob(image,length,packet); length=0; } datum>>=8; bits-=8; } if (free_code > max_code) { number_bits++; if (number_bits == 12UL) max_code=(1UL << 12UL); else max_code=((one << (number_bits))-1); } };
  if (bits > 0)
    {
...
# 884 "coders/gif.c"
 "image != (Image *) NULL"
# 884 "coders/gif.c" 3 4
 , "coders/gif.c", 884, __extension__ __PRETTY_FUNCTION__); }))
# 884 "coders/gif.c"
                                ;
  
# 885 "coders/gif.c" 3 4
 ((void) sizeof ((
# 885 "coders/gif.c"
 image->signature == 0xabacadabUL
# 885 "coders/gif.c" 3 4
...
# 885 "coders/gif.c"
 "image->signature == MagickCoreSignature"
# 885 "coders/gif.c" 3 4
 , "coders/gif.c", 885, __extension__ __PRETTY_FUNCTION__); }))
# 885 "coders/gif.c"
                                                ;
  
# 886 "coders/gif.c" 3 4
 ((void) sizeof ((
# 886 "coders/gif.c"
 data != (unsigned char *) 
# 886 "coders/gif.c" 3 4
...
# 886 "coders/gif.c" 3 4
 , "coders/gif.c", 886, __extension__ __PRETTY_FUNCTION__); }))
# 886 "coders/gif.c"
                                       ;
...
# 935 "coders/gif.c"
 "image != (Image *) NULL"
# 935 "coders/gif.c" 3 4
 , "coders/gif.c", 935, __extension__ __PRETTY_FUNCTION__); }))
# 935 "coders/gif.c"
                                ;
  
# 936 "coders/gif.c" 3 4
 ((void) sizeof ((
# 936 "coders/gif.c"
 image->signature == 0xabacadabUL
# 936 "coders/gif.c" 3 4
...
# 936 "coders/gif.c"
 "image->signature == MagickCoreSignature"
# 936 "coders/gif.c" 3 4
 , "coders/gif.c", 936, __extension__ __PRETTY_FUNCTION__); }))
# 936 "coders/gif.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/gif.c",__func__,(unsigned long) 938,"%s",image->filename);
  if (ReadBlob(image,1,&data_size) != 1)
    { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 940,CorruptImageError,"CorruptImage", "`%s'",image->filename); return(MagickFalse); };
  if (data_size > 12)
    { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 942,CorruptImageError,"CorruptImage", "`%s'",image->filename); return(MagickFalse); };
  if (ReadBlob(image,1,&length) != 1)
    { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 944,CorruptImageError,"CorruptImage", "`%s'",image->filename); return(MagickFalse); };
  while (length != 0)
  {
    if (ReadBlob(image,length,buffer) != (ssize_t) length)
      { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 948,CorruptImageError,"CorruptImage", "`%s'",image->filename); return(MagickFalse); };
    if (ReadBlob(image,1,&length) != 1)
      { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 950,CorruptImageError,"CorruptImage", "`%s'",image->filename); return(MagickFalse); };
  }
  return(MagickTrue);
}
...
# 1007 "coders/gif.c" 3 4
 , "coders/gif.c", 1007, __extension__ __PRETTY_FUNCTION__); }))
# 1007 "coders/gif.c"
                                               ;
  
# 1008 "coders/gif.c" 3 4
 ((void) sizeof ((
# 1008 "coders/gif.c"
...
# 1008 "coders/gif.c" 3 4
 , "coders/gif.c", 1008, __extension__ __PRETTY_FUNCTION__); }))
# 1008 "coders/gif.c"
                                                     ;
  
# 1009 "coders/gif.c" 3 4
 ((void) sizeof ((
# 1009 "coders/gif.c"
...
# 1009 "coders/gif.c" 3 4
 , "coders/gif.c", 1009, __extension__ __PRETTY_FUNCTION__); }))
# 1009 "coders/gif.c"
                                            ;
  
# 1010 "coders/gif.c" 3 4
 ((void) sizeof ((
# 1010 "coders/gif.c"
...
# 1010 "coders/gif.c" 3 4
 , "coders/gif.c", 1010, __extension__ __PRETTY_FUNCTION__); }))
# 1010 "coders/gif.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/gif.c",__func__,(unsigned long) 1012,"%s",
      image_info->filename);
...
# 1019 "coders/gif.c"
  ...
  if ((count != 6) || ((LocaleNCompare((char *) buffer,"GIF87",5) != 0) &&
    ...
    { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1027,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1027 "coders/gif.c" 3 4
   ((void *)0)
# 1027 "coders/gif.c"
...
# 1034 "coders/gif.c"
  ...
  global_colormap=(unsigned char *) AcquireQuantumMemory((size_t)
    (((global_colors) > (256)) ? (global_colors) : (256)),3UL*sizeof(*global_colormap));
  if (global_colormap == (unsigned char *) 
# 1041 "coders/gif.c" 3 4
                                          ((void *)0)
# 1041 "coders/gif.c"
                                              )
    { if (profiles != (LinkedListInfo *) 
# 1042 "coders/gif.c" 3 4
   ((void *)0)
# 1042 "coders/gif.c"
   ) profiles=DestroyLinkedList(profiles,DestroyGIFProfile); if (global_colormap != (unsigned char *) 
# 1042 "coders/gif.c" 3 4
   ((void *)0)
# 1042 "coders/gif.c"
   ) global_colormap=(unsigned char *) RelinquishMagickMemory(global_colormap); if (meta_image != (Image *) 
# 1042 "coders/gif.c" 3 4
   ((void *)0)
# 1042 "coders/gif.c"
   ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1042,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1042 "coders/gif.c" 3 4
   ((void *)0)
# 1042 "coders/gif.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1042 "coders/gif.c"
  ...
  (void) memset(global_colormap,0,3*(((global_colors) > (256)) ? (global_colors) : (256))*
    sizeof(*global_colormap));
  if (((((int) flag) & (0x80)) == (0x80)) != 0)
    {
      count=ReadBlob(image,(size_t) (3*global_colors),global_colormap);
      if (count != (ssize_t) (3*global_colors))
        { if (profiles != (LinkedListInfo *) 
# 1049 "coders/gif.c" 3 4
       ((void *)0)
# 1049 "coders/gif.c"
       ) profiles=DestroyLinkedList(profiles,DestroyGIFProfile); if (global_colormap != (unsigned char *) 
# 1049 "coders/gif.c" 3 4
...
# 1049 "coders/gif.c" 3 4
       ((void *)0)
# 1049 "coders/gif.c"
       ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1049,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1049 "coders/gif.c" 3 4
       ((void *)0)
# 1049 "coders/gif.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1069 "coders/gif.c" 3 4
         ((void *)0)
# 1069 "coders/gif.c"
         ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1069,(CorruptImageError),("UnableToReadExtensionBlock"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1069 "coders/gif.c" 3 4
         ((void *)0)
# 1069 "coders/gif.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1069 "coders/gif.c"
        ...
        switch (c)
        {
          ...
          case 0xfe:
          {
            ...
            comments=AcquireString((char *) 
# 1093 "coders/gif.c" 3 4
                                           ((void *)0)
# 1093 "coders/gif.c"
                                               );
            extent=4096;
            for (offset=0; ; offset+=(size_t) count)
            {
              ...
              if (count == 0)
                break;
              buffer[count]='\0';
              if ((count+(ssize_t) offset+4096) >= (ssize_t) extent)
                {
                  extent<<=1;
                  comments=(char *) ResizeQuantumMemory(comments,
                    OverAllocateMemory(extent+4096),
                    sizeof(*comments));
                  if (comments == (char *) 
# 1107 "coders/gif.c" 3 4
                                          ((void *)0)
# 1107 "coders/gif.c"
                                              )
                    { if (profiles != (LinkedListInfo *) 
# 1108 "coders/gif.c" 3 4
                   ((void *)0)
# 1108 "coders/gif.c"
                   ) profiles=DestroyLinkedList(profiles,DestroyGIFProfile); if (global_colormap != (unsigned char *) 
# 1108 "coders/gif.c" 3 4
...
# 1108 "coders/gif.c" 3 4
                   ((void *)0)
# 1108 "coders/gif.c"
                   ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1108,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1108 "coders/gif.c" 3 4
                   ((void *)0)
# 1108 "coders/gif.c"
                   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
            ...
            if (loop != MagickFalse)
            ...
            else
              {
                ...
                iptc=LocaleNCompare((char *) buffer,"MGKIPTC0000",11) == 0 ?
                  MagickTrue : MagickFalse;
                (void) LogMagickEvent(CoderEvent,"coders/gif.c",__func__,(unsigned long) 1170,
...
# 1175 "coders/gif.c" 3 4
                                             ((void *)0)
# 1175 "coders/gif.c"
                                                 )
                  { if (profiles != (LinkedListInfo *) 
# 1176 "coders/gif.c" 3 4
                 ((void *)0)
# 1176 "coders/gif.c"
                 ) profiles=DestroyLinkedList(profiles,DestroyGIFProfile); if (global_colormap != (unsigned char *) 
# 1176 "coders/gif.c" 3 4
...
# 1176 "coders/gif.c" 3 4
                 ((void *)0)
# 1176 "coders/gif.c"
                 ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1176,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1176 "coders/gif.c" 3 4
                 ((void *)0)
# 1176 "coders/gif.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1193 "coders/gif.c" 3 4
                         ((void *)0)
# 1193 "coders/gif.c"
                         ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1193,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1193 "coders/gif.c" 3 4
                         ((void *)0)
# 1193 "coders/gif.c"
                         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1202 "coders/gif.c" 3 4
                   ((void *)0)
# 1202 "coders/gif.c"
                   ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1202,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1202 "coders/gif.c" 3 4
                   ((void *)0)
# 1202 "coders/gif.c"
                   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1215 "coders/gif.c"
                  ...
                  (void) FormatLocaleString(name,sizeof(name),"gif:%.11s",
                    buffer);
                (void) LogMagickEvent(CoderEvent,"coders/gif.c",__func__,(unsigned long) 1220,
                  "      profile name=%s",name);
                info=(unsigned char *) RelinquishMagickMemory(info);
...
# 1251 "coders/gif.c"
    ...
    image->depth=8;
    flag=(unsigned char) ReadBlobByte(image);
    image->interlace=((((int) flag) & (0x40)) == (0x40)) != 0 ? GIFInterlace : NoInterlace;
    local_colors=((((int) flag) & (0x80)) == (0x80)) == 0 ? global_colors : one <<
      ((size_t) (flag & 0x07)+1);
...
# 1283 "coders/gif.c" 3 4
     ((void *)0)
# 1283 "coders/gif.c"
     ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1283,(CorruptImageError),("NegativeOrZeroImageSize"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1283 "coders/gif.c" 3 4
     ((void *)0)
# 1283 "coders/gif.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1288 "coders/gif.c" 3 4
     ((void *)0)
# 1288 "coders/gif.c"
     ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1288,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1288 "coders/gif.c" 3 4
     ((void *)0)
# 1288 "coders/gif.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
    ...
    if (((((int) flag) & (0x80)) == (0x80)) == 0)
      {
        ...
        for (i=0; i < (ssize_t) image->colors; i++)
        {
          ...
          if (i == opacity)
            {
              image->colormap[i].alpha=(double) ((Quantum) 0);
              image->transparent_color=image->colormap[opacity];
            }
        }
        image->background_color=image->colormap[((((ssize_t) background) < ((ssize_t) image->colors-1)) ? ((ssize_t) background) : ((ssize_t) image->colors-1))
                                    ];
      }
    else
      {
        ...
        colormap=(unsigned char *) AcquireQuantumMemory((size_t)
          (((local_colors) > (256)) ? (local_colors) : (256)),3UL*sizeof(*colormap));
        if (colormap == (unsigned char *) 
# 1319 "coders/gif.c" 3 4
                                         ((void *)0)
# 1319 "coders/gif.c"
                                             )
          { if (profiles != (LinkedListInfo *) 
# 1320 "coders/gif.c" 3 4
         ((void *)0)
# 1320 "coders/gif.c"
         ) profiles=DestroyLinkedList(profiles,DestroyGIFProfile); if (global_colormap != (unsigned char *) 
# 1320 "coders/gif.c" 3 4
...
# 1320 "coders/gif.c" 3 4
         ((void *)0)
# 1320 "coders/gif.c"
         ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1320,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1320 "coders/gif.c" 3 4
         ((void *)0)
# 1320 "coders/gif.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1320 "coders/gif.c"
        ...
        (void) memset(colormap,0,3*(((local_colors) > (256)) ? (local_colors) : (256))*
          sizeof(*colormap));
...
# 1327 "coders/gif.c" 3 4
           ((void *)0)
# 1327 "coders/gif.c"
           ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1327,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1327 "coders/gif.c" 3 4
           ((void *)0)
# 1327 "coders/gif.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1369 "coders/gif.c" 3 4
     ((void *)0)
# 1369 "coders/gif.c"
     ) meta_image=DestroyImage(meta_image); { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1369,(CorruptImageError),("CorruptImage"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1369 "coders/gif.c" 3 4
     ((void *)0)
# 1369 "coders/gif.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1370 "coders/gif.c"
                                          )
      {
        ...
        while (profile != (StringInfo *) 
# 1380 "coders/gif.c" 3 4
                                        ((void *)0)
# 1380 "coders/gif.c"
                                            )
        {
...
# 1399 "coders/gif.c"
  ...
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1404,CorruptImageError,"NegativeOrZeroImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1404 "coders/gif.c" 3 4
   ((void *)0)
# 1404 "coders/gif.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1404 "coders/gif.c" 3 4
...
# 1435 "coders/gif.c"
__attribute__ ((visibility ("default"))) size_t RegisterGIFImage(void)
{
  MagickInfo
    *entry;
...
# 1478 "coders/gif.c"
__attribute__ ((visibility ("default"))) void UnregisterGIFImage(void)
{
...
# 1550 "coders/gif.c"
 "image_info != (const ImageInfo *) NULL"
# 1550 "coders/gif.c" 3 4
 , "coders/gif.c", 1550, __extension__ __PRETTY_FUNCTION__); }))
# 1550 "coders/gif.c"
                                               ;
  
# 1551 "coders/gif.c" 3 4
 ((void) sizeof ((
# 1551 "coders/gif.c"
 image_info->signature == 0xabacadabUL
# 1551 "coders/gif.c" 3 4
...
# 1551 "coders/gif.c"
 "image_info->signature == MagickCoreSignature"
# 1551 "coders/gif.c" 3 4
 , "coders/gif.c", 1551, __extension__ __PRETTY_FUNCTION__); }))
# 1551 "coders/gif.c"
                                                     ;
  
# 1552 "coders/gif.c" 3 4
 ((void) sizeof ((
# 1552 "coders/gif.c"
 image != (Image *) 
# 1552 "coders/gif.c" 3 4
...
# 1552 "coders/gif.c"
 "image != (Image *) NULL"
# 1552 "coders/gif.c" 3 4
 , "coders/gif.c", 1552, __extension__ __PRETTY_FUNCTION__); }))
# 1552 "coders/gif.c"
                                ;
  
# 1553 "coders/gif.c" 3 4
 ((void) sizeof ((
# 1553 "coders/gif.c"
 image->signature == 0xabacadabUL
# 1553 "coders/gif.c" 3 4
...
# 1553 "coders/gif.c"
 "image->signature == MagickCoreSignature"
# 1553 "coders/gif.c" 3 4
 , "coders/gif.c", 1553, __extension__ __PRETTY_FUNCTION__); }))
# 1553 "coders/gif.c"
                                                ;
  
# 1554 "coders/gif.c" 3 4
 ((void) sizeof ((
# 1554 "coders/gif.c"
 exception != (ExceptionInfo *) 
# 1554 "coders/gif.c" 3 4
...
# 1554 "coders/gif.c"
 "exception != (ExceptionInfo *) NULL"
# 1554 "coders/gif.c" 3 4
 , "coders/gif.c", 1554, __extension__ __PRETTY_FUNCTION__); }))
# 1554 "coders/gif.c"
                                            ;
  
# 1555 "coders/gif.c" 3 4
 ((void) sizeof ((
# 1555 "coders/gif.c"
 exception->signature == 0xabacadabUL
# 1555 "coders/gif.c" 3 4
...
# 1555 "coders/gif.c"
 "exception->signature == MagickCoreSignature"
# 1555 "coders/gif.c" 3 4
 , "coders/gif.c", 1555, __extension__ __PRETTY_FUNCTION__); }))
# 1555 "coders/gif.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/gif.c",__func__,(unsigned long) 1557,"%s",image->filename);
  ...
  if ((global_colormap == (unsigned char *) 
# 1567 "coders/gif.c" 3 4
                                           ((void *)0)
# 1567 "coders/gif.c"
                                               ) ||
      (colormap == (unsigned char *) 
# 1568 "coders/gif.c" 3 4
                                    ((void *)0)
# 1568 "coders/gif.c"
                                        ))
    {
      if (global_colormap != (unsigned char *) 
# 1570 "coders/gif.c" 3 4
                                              ((void *)0)
# 1570 "coders/gif.c"
                                                  )
        global_colormap=(unsigned char *) RelinquishMagickMemory(
          global_colormap);
      if (colormap != (unsigned char *) 
# 1573 "coders/gif.c" 3 4
                                       ((void *)0)
# 1573 "coders/gif.c"
                                           )
        colormap=(unsigned char *) RelinquishMagickMemory(colormap);
      { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1575,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1575 "coders/gif.c" 3 4
     ((void *)0)
# 1575 "coders/gif.c"
  ...
  do
  {
    ...
    if (IsImageOpaque(image,exception) != MagickFalse)
    ...
    else
      {
        ...
        for (i=0; i < (ssize_t) image->colors; i++)
          if (image->colormap[i].alpha != (double) ((Quantum) ((Quantum) 65535.0)))
            {
              if (opacity < 0)
                {
                  opacity=i;
              ...
              alpha=fabs(image->colormap[i].alpha-(double) ((Quantum) 0));
    ...
    if ((image->storage_class == DirectClass) || (image->colors > 256))
      { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1671,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1671 "coders/gif.c" 3 4
     ((void *)0)
# 1671 "coders/gif.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    ...
    if (LocaleCompare(write_info->magick,"GIF87") != 0)
      {
        ...
        if ((GetPreviousImageInList(image) == (Image *) 
# 1714 "coders/gif.c" 3 4
                                                       ((void *)0)
# 1714 "coders/gif.c"
                                                           ) &&
            (GetNextImageInList(image) != (Image *) 
# 1715 "coders/gif.c" 3 4
                                                   ((void *)0)
# 1715 "coders/gif.c"
                                                       ) &&
            (image->iterations != 1))
          {
            ...
            (void) LogMagickEvent(CoderEvent,"coders/gif.c",__func__,(unsigned long) 1721,
        ...
        if (opacity >= 0)
          c|=0x01;
        (void) WriteBlobByte(image,(unsigned char) c);
        delay=(size_t) (100*image->delay/((((size_t) image->ticks_per_second) > (1)) ? ((size_t) image->ticks_per_second) : (1))
                                    );
        (void) WriteBlobLSBShort(image,(unsigned short) delay);
        (void) WriteBlobByte(image,(unsigned char) (opacity >= 0 ? opacity :
          0));
        (void) WriteBlobByte(image,(unsigned char) 0x00);
        if (fabs(image->gamma-1.0/2.2) > 1.0e-12)
          {
            char
              attributes[4096];
            ...
            (void) LogMagickEvent(CoderEvent,"coders/gif.c",__func__,(unsigned long) 1760,
               "  Writing GIF Extension %s","ImageMagick");
            (void) WriteBlobByte(image,(unsigned char) 0x21);
            (void) WriteBlobByte(image,(unsigned char) 0xff);
            (void) WriteBlobByte(image,(unsigned char) 0x0b);
            (void) WriteBlob(image,11,(unsigned char *) "ImageMagick");
            count=FormatLocaleString(attributes,4096,"gamma=%g",
              image->gamma);
...
# 1773 "coders/gif.c"
                                       )
          {
            ...
            for (p=value; *p != '\0'; )
            {
              count=(((strlen(p)) < (255)) ? (strlen(p)) : (255));
              (void) WriteBlobByte(image,(unsigned char) count);
...
# 1808 "coders/gif.c"
                ...
                (LocaleNCompare(name,"gif:",4) == 0))
            {
               ...
               if ((LocaleCompare(name,"ICC") == 0) ||
                   (LocaleCompare(name,"ICM") == 0))
                 {
                   ...
                   (void) LogMagickEvent(CoderEvent,"coders/gif.c",__func__,(unsigned long) 1834,
                 ...
                 if ((LocaleCompare(name,"IPTC") == 0))
                   {
                     ...
                     (void) LogMagickEvent(CoderEvent,"coders/gif.c",__func__,(unsigned long) 1844,
                   ...
                   if ((LocaleCompare(name,"8BIM") == 0))
                     {
                        ...
                        (void) WriteBlob(image,11,(unsigned char *)
                          "MGK8BIM0000");
                        (void) LogMagickEvent(CoderEvent,"coders/gif.c",__func__,(unsigned long) 1855,
                   ...
                   else
                     {
                       ...
                       (void) LogMagickEvent(CoderEvent,"coders/gif.c",__func__,(unsigned long) 1870,
    ...
    c=(int) (((bits_per_pixel) > (2)) ? (bits_per_pixel) : (2));
    (void) WriteBlobByte(image,(unsigned char) c);
    status=EncodeImage(write_info,image,(size_t) (((bits_per_pixel) > (2)) ? (bits_per_pixel) : (2))+1,
      exception);
    if (status == MagickFalse)
      {
        global_colormap=(unsigned char *) RelinquishMagickMemory(
        ...
        { (void) ThrowMagickException(exception,"coders/gif.c",__func__,(unsigned long) 1933,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1933 "coders/gif.c" 3 4
       ((void *)0)
# 1933 "coders/gif.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      }
