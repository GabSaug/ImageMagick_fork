...
# 121 "coders/null.c" 3 4
 , "coders/null.c", 121, __extension__ __PRETTY_FUNCTION__); }))
# 121 "coders/null.c"
                                               ;
  
# 122 "coders/null.c" 3 4
 ((void) sizeof ((
# 122 "coders/null.c"
...
# 122 "coders/null.c" 3 4
 , "coders/null.c", 122, __extension__ __PRETTY_FUNCTION__); }))
# 122 "coders/null.c"
                                                     ;
  
# 123 "coders/null.c" 3 4
 ((void) sizeof ((
# 123 "coders/null.c"
...
# 123 "coders/null.c" 3 4
 , "coders/null.c", 123, __extension__ __PRETTY_FUNCTION__); }))
# 123 "coders/null.c"
                                            ;
  
# 124 "coders/null.c" 3 4
 ((void) sizeof ((
# 124 "coders/null.c"
...
# 124 "coders/null.c" 3 4
 , "coders/null.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "coders/null.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/null.c",__func__,(unsigned long) 126,"%s",
      image_info->filename);
  ...
  background.alpha=(double) ((Quantum) 0);
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    q=QueueAuthenticPixels(image,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 142 "coders/null.c" 3 4
                        ((void *)0)
# 142 "coders/null.c"
                            )
      break;
...
# 178 "coders/null.c"
__attribute__ ((visibility ("default"))) size_t RegisterNULLImage(void)
{
  MagickInfo
    *entry;
...
# 211 "coders/null.c"
__attribute__ ((visibility ("default"))) void UnregisterNULLImage(void)
{
...
# 247 "coders/null.c"
 "image_info != (const ImageInfo *) NULL"
# 247 "coders/null.c" 3 4
 , "coders/null.c", 247, __extension__ __PRETTY_FUNCTION__); }))
# 247 "coders/null.c"
                                               ;
  
# 248 "coders/null.c" 3 4
 ((void) sizeof ((
# 248 "coders/null.c"
 image_info->signature == 0xabacadabUL
# 248 "coders/null.c" 3 4
...
# 248 "coders/null.c"
 "image_info->signature == MagickCoreSignature"
# 248 "coders/null.c" 3 4
 , "coders/null.c", 248, __extension__ __PRETTY_FUNCTION__); }))
# 248 "coders/null.c"
                                                     ;
  
# 249 "coders/null.c" 3 4
 ((void) sizeof ((
# 249 "coders/null.c"
 image != (Image *) 
# 249 "coders/null.c" 3 4
...
# 249 "coders/null.c"
 "image != (Image *) NULL"
# 249 "coders/null.c" 3 4
 , "coders/null.c", 249, __extension__ __PRETTY_FUNCTION__); }))
# 249 "coders/null.c"
                                ;
  
# 250 "coders/null.c" 3 4
 ((void) sizeof ((
# 250 "coders/null.c"
...
# 250 "coders/null.c" 3 4
 , "coders/null.c", 250, __extension__ __PRETTY_FUNCTION__); }))
# 250 "coders/null.c"
                                                ;
  
# 251 "coders/null.c" 3 4
 ((void) sizeof ((
# 251 "coders/null.c"
 exception != (ExceptionInfo *) 
# 251 "coders/null.c" 3 4
...
# 251 "coders/null.c"
 "exception != (ExceptionInfo *) NULL"
# 251 "coders/null.c" 3 4
 , "coders/null.c", 251, __extension__ __PRETTY_FUNCTION__); }))
# 251 "coders/null.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/null.c",__func__,(unsigned long) 253,"%s",image->filename);
  (void) image_info;
  (void) exception;
  return(MagickTrue);
}
