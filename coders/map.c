...
# 133 "coders/map.c" 3 4
 , "coders/map.c", 133, __extension__ __PRETTY_FUNCTION__); }))
# 133 "coders/map.c"
                                               ;
  
# 134 "coders/map.c" 3 4
 ((void) sizeof ((
# 134 "coders/map.c"
...
# 134 "coders/map.c" 3 4
 , "coders/map.c", 134, __extension__ __PRETTY_FUNCTION__); }))
# 134 "coders/map.c"
                                                     ;
  
# 135 "coders/map.c" 3 4
 ((void) sizeof ((
# 135 "coders/map.c"
...
# 135 "coders/map.c" 3 4
 , "coders/map.c", 135, __extension__ __PRETTY_FUNCTION__); }))
# 135 "coders/map.c"
                                            ;
  
# 136 "coders/map.c" 3 4
 ((void) sizeof ((
# 136 "coders/map.c"
...
# 136 "coders/map.c" 3 4
 , "coders/map.c", 136, __extension__ __PRETTY_FUNCTION__); }))
# 136 "coders/map.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/map.c",__func__,(unsigned long) 138,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/map.c",__func__,(unsigned long) 142,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 142 "coders/map.c" 3 4
   ((void *)0)
# 142 "coders/map.c"
...
# 142 "coders/map.c"
  ...
  if (image_info->depth == 0)
    { (void) ThrowMagickException(exception,"coders/map.c",__func__,(unsigned long) 144,OptionError,"MustSpecifyImageDepth", "`%s'",image_info->filename); if ((image) != (Image *) 
# 144 "coders/map.c" 3 4
   ((void *)0)
# 144 "coders/map.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 144 "coders/map.c" 3 4
...
# 149 "coders/map.c"
  ...
  if (status == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/map.c",__func__,(unsigned long) 158,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 158 "coders/map.c" 3 4
   ((void *)0)
# 158 "coders/map.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 158 "coders/map.c" 3 4
...
# 166 "coders/map.c" 3 4
                                  ((void *)0)
# 166 "coders/map.c"
                                      ) ||
      (colormap == (unsigned char *) 
# 167 "coders/map.c" 3 4
                                    ((void *)0)
# 167 "coders/map.c"
                                        ))
    {
      ...
      { (void) ThrowMagickException(exception,"coders/map.c",__func__,(unsigned long) 171,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 171 "coders/map.c" 3 4
     ((void *)0)
# 171 "coders/map.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 171 "coders/map.c" 3 4
  ...
  if (count != (ssize_t) (packet_size*image->colors))
    {
      pixels=(unsigned char *) RelinquishMagickMemory(pixels);
      colormap=(unsigned char *) RelinquishMagickMemory(colormap);
      { (void) ThrowMagickException(exception,"coders/map.c",__func__,(unsigned long) 181,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 181 "coders/map.c" 3 4
     ((void *)0)
# 181 "coders/map.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 181 "coders/map.c" 3 4
...
# 249 "coders/map.c" 3 4
   (*__errno_location ())
# 249 "coders/map.c"
   ); (void) ThrowMagickException(exception,"coders/map.c",__func__,(unsigned long) 249,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 281 "coders/map.c"
__attribute__ ((visibility ("default"))) size_t RegisterMAPImage(void)
{
  MagickInfo
    *entry;
...
# 316 "coders/map.c"
__attribute__ ((visibility ("default"))) void UnregisterMAPImage(void)
{
...
# 379 "coders/map.c"
 "image_info != (const ImageInfo *) NULL"
# 379 "coders/map.c" 3 4
 , "coders/map.c", 379, __extension__ __PRETTY_FUNCTION__); }))
# 379 "coders/map.c"
                                               ;
  
# 380 "coders/map.c" 3 4
 ((void) sizeof ((
# 380 "coders/map.c"
 image_info->signature == 0xabacadabUL
# 380 "coders/map.c" 3 4
...
# 380 "coders/map.c"
 "image_info->signature == MagickCoreSignature"
# 380 "coders/map.c" 3 4
 , "coders/map.c", 380, __extension__ __PRETTY_FUNCTION__); }))
# 380 "coders/map.c"
                                                     ;
  
# 381 "coders/map.c" 3 4
 ((void) sizeof ((
# 381 "coders/map.c"
 image != (Image *) 
# 381 "coders/map.c" 3 4
...
# 381 "coders/map.c"
 "image != (Image *) NULL"
# 381 "coders/map.c" 3 4
 , "coders/map.c", 381, __extension__ __PRETTY_FUNCTION__); }))
# 381 "coders/map.c"
                                ;
  
# 382 "coders/map.c" 3 4
 ((void) sizeof ((
# 382 "coders/map.c"
...
# 382 "coders/map.c" 3 4
 , "coders/map.c", 382, __extension__ __PRETTY_FUNCTION__); }))
# 382 "coders/map.c"
                                                ;
  
# 383 "coders/map.c" 3 4
 ((void) sizeof ((
# 383 "coders/map.c"
 exception != (ExceptionInfo *) 
# 383 "coders/map.c" 3 4
...
# 383 "coders/map.c"
 "exception != (ExceptionInfo *) NULL"
# 383 "coders/map.c" 3 4
 , "coders/map.c", 383, __extension__ __PRETTY_FUNCTION__); }))
# 383 "coders/map.c"
                                            ;
  
# 384 "coders/map.c" 3 4
 ((void) sizeof ((
# 384 "coders/map.c"
 exception->signature == 0xabacadabUL
# 384 "coders/map.c" 3 4
...
# 384 "coders/map.c"
 "exception->signature == MagickCoreSignature"
# 384 "coders/map.c" 3 4
 , "coders/map.c", 384, __extension__ __PRETTY_FUNCTION__); }))
# 384 "coders/map.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/map.c",__func__,(unsigned long) 386,"%s",image->filename);
  ...
  if (SetImageType(image,PaletteType,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/map.c",__func__,(unsigned long) 396,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 396 "coders/map.c" 3 4
   ((void *)0)
# 396 "coders/map.c"
  ...
  colormap=(unsigned char *) AcquireQuantumMemory(image->colors,packet_size*
    sizeof(*colormap));
  if ((pixels == (unsigned char *) 
# 404 "coders/map.c" 3 4
                                  ((void *)0)
# 404 "coders/map.c"
                                      ) ||
      (colormap == (unsigned char *) 
# 405 "coders/map.c" 3 4
                                    ((void *)0)
# 405 "coders/map.c"
                                        ))
    {
      if (colormap != (unsigned char *) 
# 407 "coders/map.c" 3 4
                                       ((void *)0)
# 407 "coders/map.c"
                                           )
        colormap=(unsigned char *) RelinquishMagickMemory(colormap);
      if (pixels != (unsigned char *) 
# 409 "coders/map.c" 3 4
                                     ((void *)0)
# 409 "coders/map.c"
                                         )
        pixels=(unsigned char *) RelinquishMagickMemory(pixels);
      { (void) ThrowMagickException(exception,"coders/map.c",__func__,(unsigned long) 411,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 411 "coders/map.c" 3 4
     ((void *)0)
# 411 "coders/map.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    }
