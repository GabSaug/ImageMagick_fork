...
# 117 "coders/inline.c" 3 4
 , "coders/inline.c", 117, __extension__ __PRETTY_FUNCTION__); }))
# 117 "coders/inline.c"
                                               ;
  
# 118 "coders/inline.c" 3 4
 ((void) sizeof ((
# 118 "coders/inline.c"
...
# 118 "coders/inline.c" 3 4
 , "coders/inline.c", 118, __extension__ __PRETTY_FUNCTION__); }))
# 118 "coders/inline.c"
                                                     ;
  
# 119 "coders/inline.c" 3 4
 ((void) sizeof ((
# 119 "coders/inline.c"
...
# 119 "coders/inline.c" 3 4
 , "coders/inline.c", 119, __extension__ __PRETTY_FUNCTION__); }))
# 119 "coders/inline.c"
                                            ;
  
# 120 "coders/inline.c" 3 4
 ((void) sizeof ((
# 120 "coders/inline.c"
...
# 120 "coders/inline.c" 3 4
 , "coders/inline.c", 120, __extension__ __PRETTY_FUNCTION__); }))
# 120 "coders/inline.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/inline.c",__func__,(unsigned long) 122,"%s",
      image_info->filename);
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 144 "coders/inline.c" 3 4
                      ((void *)0)
# 144 "coders/inline.c"
                          );
    }
  quantum=((((size_t) GetBlobSize(image)) < (81920)) ? ((size_t) GetBlobSize(image)) : (81920));
  if (quantum == 0)
    quantum=81920;
  inline_image=(unsigned char *) AcquireQuantumMemory(quantum,
    sizeof(*inline_image));
  count=0;
  for (i=0; inline_image != (unsigned char *) 
# 152 "coders/inline.c" 3 4
                                             ((void *)0)
# 152 "coders/inline.c"
                                                 ; i+=count)
  {
...
# 158 "coders/inline.c"
  ...
  if (inline_image == (unsigned char *) 
# 169 "coders/inline.c" 3 4
                                       ((void *)0)
# 169 "coders/inline.c"
                                           )
    {
      (void) ThrowMagickException(exception,"coders/inline.c",__func__,(unsigned long) 171,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",image->filename);
      return((Image *) 
# 173 "coders/inline.c" 3 4
                      ((void *)0)
# 173 "coders/inline.c"
                          );
    }
...
# 205 "coders/inline.c"
__attribute__ ((visibility ("default"))) size_t RegisterINLINEImage(void)
{
  MagickInfo
    *entry;
...
# 242 "coders/inline.c"
__attribute__ ((visibility ("default"))) void UnregisterINLINEImage(void)
{
...
# 304 "coders/inline.c"
 "image_info != (const ImageInfo *) NULL"
# 304 "coders/inline.c" 3 4
 , "coders/inline.c", 304, __extension__ __PRETTY_FUNCTION__); }))
# 304 "coders/inline.c"
                                               ;
  
# 305 "coders/inline.c" 3 4
 ((void) sizeof ((
# 305 "coders/inline.c"
 image_info->signature == 0xabacadabUL
# 305 "coders/inline.c" 3 4
...
# 305 "coders/inline.c"
 "image_info->signature == MagickCoreSignature"
# 305 "coders/inline.c" 3 4
 , "coders/inline.c", 305, __extension__ __PRETTY_FUNCTION__); }))
# 305 "coders/inline.c"
                                                     ;
  
# 306 "coders/inline.c" 3 4
 ((void) sizeof ((
# 306 "coders/inline.c"
 image != (Image *) 
# 306 "coders/inline.c" 3 4
...
# 306 "coders/inline.c"
 "image != (Image *) NULL"
# 306 "coders/inline.c" 3 4
 , "coders/inline.c", 306, __extension__ __PRETTY_FUNCTION__); }))
# 306 "coders/inline.c"
                                ;
  
# 307 "coders/inline.c" 3 4
 ((void) sizeof ((
# 307 "coders/inline.c"
...
# 307 "coders/inline.c" 3 4
 , "coders/inline.c", 307, __extension__ __PRETTY_FUNCTION__); }))
# 307 "coders/inline.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/inline.c",__func__,(unsigned long) 309,"%s",image->filename);
...
# 318 "coders/inline.c" 3 4
                                          ((void *)0)
# 318 "coders/inline.c"
                                              ) ||
      (GetMagickMimeType(magick_info) == (const char *) 
# 319 "coders/inline.c" 3 4
                                                       ((void *)0)
# 319 "coders/inline.c"
                                                           ))
    {
      write_info=DestroyImageInfo(write_info);
      { (void) ThrowMagickException(exception,"coders/inline.c",__func__,(unsigned long) 322,CorruptImageError,"ImageTypeNotSupported", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 322 "coders/inline.c" 3 4
     ((void *)0)
# 322 "coders/inline.c"
...
# 338 "coders/inline.c"
  ...
  if (base64 == (char *) 
# 343 "coders/inline.c" 3 4
                        ((void *)0)
# 343 "coders/inline.c"
                            )
    { (void) ThrowMagickException(exception,"coders/inline.c",__func__,(unsigned long) 344,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 344 "coders/inline.c" 3 4
   ((void *)0)
# 344 "coders/inline.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  ...
  (void) FormatLocaleString(message,4096,"data:%s;base64,",
