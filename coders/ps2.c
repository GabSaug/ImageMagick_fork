...
# 114 "coders/ps2.c"
__attribute__ ((visibility ("default"))) size_t RegisterPS2Image(void)
{
  MagickInfo
    *entry;
...
# 154 "coders/ps2.c"
__attribute__ ((visibility ("default"))) void UnregisterPS2Image(void)
{
...
# 452 "coders/ps2.c" 3 4
 , "coders/ps2.c", 452, __extension__ __PRETTY_FUNCTION__); }))
# 452 "coders/ps2.c"
                                               ;
  
# 453 "coders/ps2.c" 3 4
 ((void) sizeof ((
# 453 "coders/ps2.c"
...
# 453 "coders/ps2.c" 3 4
 , "coders/ps2.c", 453, __extension__ __PRETTY_FUNCTION__); }))
# 453 "coders/ps2.c"
                                                     ;
  
# 454 "coders/ps2.c" 3 4
 ((void) sizeof ((
# 454 "coders/ps2.c"
 image != (Image *) 
# 454 "coders/ps2.c" 3 4
...
# 454 "coders/ps2.c"
 "image != (Image *) NULL"
# 454 "coders/ps2.c" 3 4
 , "coders/ps2.c", 454, __extension__ __PRETTY_FUNCTION__); }))
# 454 "coders/ps2.c"
                                ;
  
# 455 "coders/ps2.c" 3 4
 ((void) sizeof ((
# 455 "coders/ps2.c"
...
# 455 "coders/ps2.c" 3 4
 , "coders/ps2.c", 455, __extension__ __PRETTY_FUNCTION__); }))
# 455 "coders/ps2.c"
                                                ;
  
# 456 "coders/ps2.c" 3 4
 ((void) sizeof ((
# 456 "coders/ps2.c"
...
# 456 "coders/ps2.c" 3 4
 , "coders/ps2.c", 456, __extension__ __PRETTY_FUNCTION__); }))
# 456 "coders/ps2.c"
                                            ;
  
# 457 "coders/ps2.c" 3 4
 ((void) sizeof ((
# 457 "coders/ps2.c"
...
# 457 "coders/ps2.c" 3 4
 , "coders/ps2.c", 457, __extension__ __PRETTY_FUNCTION__); }))
# 457 "coders/ps2.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ps2.c",__func__,(unsigned long) 459,"%s",image->filename);
  ...
  if (compression == JPEGCompression)
    {
      ...
      (void) ThrowMagickException(exception,"coders/ps2.c",__func__,(unsigned long) 470,
...
# 588 "coders/ps2.c"
        ...
        (void) FormatLocaleString(buffer,4096,PostscriptProlog,
          filter,filter,filter,filter,filter,filter,filter,filter);
        (void) WriteBlob(image,strlen(buffer),buffer);
        value=GetImageProperty(image,"label",exception);
        if (value != (const char *) 
# 647 "coders/ps2.c" 3 4
                                   ((void *)0)
# 647 "coders/ps2.c"
                                       )
          {
...
# 686 "coders/ps2.c"
    ...
    (void) WriteBlobString(image,buffer);
    labels=(char **) 
# 704 "coders/ps2.c" 3 4
                    ((void *)0)
# 704 "coders/ps2.c"
                        ;
    value=GetImageProperty(image,"label",exception);
    if (value != (const char *) 
# 706 "coders/ps2.c" 3 4
                               ((void *)0)
# 706 "coders/ps2.c"
                                   )
      labels=StringToList(value);
    if (labels != (char **) 
# 708 "coders/ps2.c" 3 4
                           ((void *)0)
# 708 "coders/ps2.c"
                               )
      {
        for (i=0; labels[i] != (char *) 
# 710 "coders/ps2.c" 3 4
                                       ((void *)0)
# 710 "coders/ps2.c"
                                           ; i++)
        {
    ...
    if (number_pixels != (MagickSizeType) ((size_t) number_pixels))
      { (void) ThrowMagickException(exception,"coders/ps2.c",__func__,(unsigned long) 721,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 721 "coders/ps2.c" 3 4
     ((void *)0)
# 721 "coders/ps2.c"
...
# 776 "coders/ps2.c" 3 4
                                            ((void *)0)
# 776 "coders/ps2.c"
                                                )
              { (void) ThrowMagickException(exception,"coders/ps2.c",__func__,(unsigned long) 777,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 777 "coders/ps2.c" 3 4
             ((void *)0)
# 777 "coders/ps2.c"
             ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
...
# 786 "coders/ps2.c"
              ...
              progress=SetImageProgress(image,"Save/Image",(MagickOffsetType) y,
                image->rows);
...
# 820 "coders/ps2.c"
              ...
              progress=SetImageProgress(image,"Save/Image",(MagickOffsetType)
                y,image->rows);
              if (progress == MagickFalse)
                break;
            }
          ...
          (compression == JPEGCompression) || (image->alpha_trait != UndefinedPixelTrait))
        {
          ...
          switch (compression)
          {
            ...
            default:
            {
              ...
              if (pixel_info == (MemoryInfo *) 
# 875 "coders/ps2.c" 3 4
                                              ((void *)0)
# 875 "coders/ps2.c"
                                                  )
                { (void) ThrowMagickException(exception,"coders/ps2.c",__func__,(unsigned long) 876,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 876 "coders/ps2.c" 3 4
               ((void *)0)
# 876 "coders/ps2.c"
               ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }
                                           ;
      ...
      else
        {
          ...
          switch (compression)
          {
            ...
            default:
            {
              ...
              pixel_info=AcquireVirtualMemory(length,sizeof(*pixels));
              if (pixel_info == (MemoryInfo *) 
# 1026 "coders/ps2.c" 3 4
                                              ((void *)0)
# 1026 "coders/ps2.c"
                                                  )
                { (void) ThrowMagickException(exception,"coders/ps2.c",__func__,(unsigned long) 1027,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1027 "coders/ps2.c" 3 4
               ((void *)0)
# 1027 "coders/ps2.c"
               ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }
                                           ;
...
# 1091 "coders/ps2.c" 3 4
                               0
# 1091 "coders/ps2.c"
                                       );
    if (offset < 0)
      { (void) ThrowMagickException(exception,"coders/ps2.c",__func__,(unsigned long) 1093,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1093 "coders/ps2.c" 3 4
     ((void *)0)
# 1093 "coders/ps2.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    (void) FormatLocaleString(buffer,4096,
