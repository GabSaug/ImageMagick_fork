...
# 137 "coders/yuv.c" 3 4
 , "coders/yuv.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "coders/yuv.c"
                                               ;
  
# 138 "coders/yuv.c" 3 4
 ((void) sizeof ((
# 138 "coders/yuv.c"
...
# 138 "coders/yuv.c" 3 4
 , "coders/yuv.c", 138, __extension__ __PRETTY_FUNCTION__); }))
# 138 "coders/yuv.c"
                                                     ;
  
# 139 "coders/yuv.c" 3 4
 ((void) sizeof ((
# 139 "coders/yuv.c"
...
# 139 "coders/yuv.c" 3 4
 , "coders/yuv.c", 139, __extension__ __PRETTY_FUNCTION__); }))
# 139 "coders/yuv.c"
                                            ;
  
# 140 "coders/yuv.c" 3 4
 ((void) sizeof ((
# 140 "coders/yuv.c"
...
# 140 "coders/yuv.c" 3 4
 , "coders/yuv.c", 140, __extension__ __PRETTY_FUNCTION__); }))
# 140 "coders/yuv.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/yuv.c",__func__,(unsigned long) 142,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 146,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 146 "coders/yuv.c" 3 4
   ((void *)0)
# 146 "coders/yuv.c"
...
# 154 "coders/yuv.c"
                                                 )
    {
      ...
      if ((horizontal_factor != 1) && (horizontal_factor != 2) &&
        ...
        { (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 170,CorruptImageError,"UnexpectedSamplingFactor", "`%s'",image_info->filename); if ((image) != (Image *) 
# 170 "coders/yuv.c" 3 4
       ((void *)0)
# 170 "coders/yuv.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 170 "coders/yuv.c" 3 4
...
# 191 "coders/yuv.c" 3 4
       (*__errno_location ())
# 191 "coders/yuv.c"
       ); (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 191,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
    }
...
# 203 "coders/yuv.c" 3 4
                                   ((void *)0)
# 203 "coders/yuv.c"
                                       )
    { (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 204,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 204 "coders/yuv.c" 3 4
   ((void *)0)
# 204 "coders/yuv.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 204 "coders/yuv.c" 3 4
...
# 204 "coders/yuv.c"
  ...
  do
  {
    ...
    if (chroma_image == (Image *) 
# 212 "coders/yuv.c" 3 4
                                 ((void *)0)
# 212 "coders/yuv.c"
                                     )
      {
        scanline=(unsigned char *) RelinquishMagickMemory(scanline);
        { (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 215,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 215 "coders/yuv.c" 3 4
       ((void *)0)
# 215 "coders/yuv.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 215 "coders/yuv.c" 3 4
...
# 234 "coders/yuv.c"
    ...
    for (y=0; y < (ssize_t) image->rows; y++)
    {
      ...
      if (interlace == NoInterlace)
        {
          if ((y > 0) || (GetPreviousImageInList(image) == (Image *) 
# 244 "coders/yuv.c" 3 4
                                                                    ((void *)0)
# 244 "coders/yuv.c"
                                                                        ))
            {
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 251 "coders/yuv.c" 3 4
                 (*__errno_location ())
# 251 "coders/yuv.c"
                 ); (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 251,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
            }
...
# 258 "coders/yuv.c"
          ...
          if (chroma_pixels == (Quantum *) 
# 262 "coders/yuv.c" 3 4
                                          ((void *)0)
# 262 "coders/yuv.c"
                                              )
            break;
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 316 "coders/yuv.c" 3 4
                 (*__errno_location ())
# 316 "coders/yuv.c"
                 ); (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 316,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
            }
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 374 "coders/yuv.c" 3 4
             (*__errno_location ())
# 374 "coders/yuv.c"
             ); (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 374,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          p=scanline;
        ...
        if (count != (ssize_t) length)
          {
            status=MagickFalse;
            { char *file_message; file_message=GetExceptionMessage(
# 420 "coders/yuv.c" 3 4
           (*__errno_location ())
# 420 "coders/yuv.c"
           ); (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 420,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                    ;
            break;
          }
        p=scanline;
...
# 451 "coders/yuv.c" 3 4
                                 ((void *)0)
# 451 "coders/yuv.c"
                                     )
      {
        scanline=(unsigned char *) RelinquishMagickMemory(scanline);
        { (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 454,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 454 "coders/yuv.c" 3 4
       ((void *)0)
# 454 "coders/yuv.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 454 "coders/yuv.c" 3 4
...
# 454 "coders/yuv.c"
    ...
    for (y=0; y < (ssize_t) image->rows; y++)
    {
      ...
      chroma_pixels=GetVirtualPixels(resize_image,0,y,resize_image->columns,1,
        exception);
      if ((q == (Quantum *) 
# 464 "coders/yuv.c" 3 4
                           ((void *)0)
# 464 "coders/yuv.c"
                               ) ||
          (chroma_pixels == (const Quantum *) 
# 465 "coders/yuv.c" 3 4
                                             ((void *)0)
# 465 "coders/yuv.c"
                                                 ))
        break;
    ...
    if (EOFBlob(image) != MagickFalse)
      {
        { char *file_message; file_message=GetExceptionMessage(
# 485 "coders/yuv.c" 3 4
       (*__errno_location ())
# 485 "coders/yuv.c"
       ); (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 485,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 548 "coders/yuv.c"
__attribute__ ((visibility ("default"))) size_t RegisterYUVImage(void)
{
  MagickInfo
    *entry;
...
# 581 "coders/yuv.c"
__attribute__ ((visibility ("default"))) void UnregisterYUVImage(void)
{
...
# 649 "coders/yuv.c"
 "image_info != (const ImageInfo *) NULL"
# 649 "coders/yuv.c" 3 4
 , "coders/yuv.c", 649, __extension__ __PRETTY_FUNCTION__); }))
# 649 "coders/yuv.c"
                                               ;
  
# 650 "coders/yuv.c" 3 4
 ((void) sizeof ((
# 650 "coders/yuv.c"
 image_info->signature == 0xabacadabUL
# 650 "coders/yuv.c" 3 4
...
# 650 "coders/yuv.c"
 "image_info->signature == MagickCoreSignature"
# 650 "coders/yuv.c" 3 4
 , "coders/yuv.c", 650, __extension__ __PRETTY_FUNCTION__); }))
# 650 "coders/yuv.c"
                                                     ;
  
# 651 "coders/yuv.c" 3 4
 ((void) sizeof ((
# 651 "coders/yuv.c"
 image != (Image *) 
# 651 "coders/yuv.c" 3 4
...
# 651 "coders/yuv.c"
 "image != (Image *) NULL"
# 651 "coders/yuv.c" 3 4
 , "coders/yuv.c", 651, __extension__ __PRETTY_FUNCTION__); }))
# 651 "coders/yuv.c"
                                ;
  
# 652 "coders/yuv.c" 3 4
 ((void) sizeof ((
# 652 "coders/yuv.c"
...
# 652 "coders/yuv.c" 3 4
 , "coders/yuv.c", 652, __extension__ __PRETTY_FUNCTION__); }))
# 652 "coders/yuv.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/yuv.c",__func__,(unsigned long) 654,"%s",image->filename);
  quantum=(size_t) (image->depth <= 8 ? 1 : 2);
  interlace=image->interlace;
  horizontal_factor=2;
  vertical_factor=2;
  if (image_info->sampling_factor != (char *) 
# 659 "coders/yuv.c" 3 4
                                             ((void *)0)
# 659 "coders/yuv.c"
                                                 )
    {
      ...
      if ((horizontal_factor != 1) && (horizontal_factor != 2) &&
          (vertical_factor != 1) && (vertical_factor != 2))
        { (void) ThrowMagickException(exception,"coders/yuv.c",__func__,(unsigned long) 675,CorruptImageError,"UnexpectedSamplingFactor", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 675 "coders/yuv.c" 3 4
       ((void *)0)
# 675 "coders/yuv.c"
...
# 802 "coders/yuv.c"
        ...
        yuv_image=DestroyImage(yuv_image);
        if (image->previous == (Image *) 
# 811 "coders/yuv.c" 3 4
                                        ((void *)0)
# 811 "coders/yuv.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",1,3);
            if (status == MagickFalse)
              break;
          }
...
# 833 "coders/yuv.c"
        ...
        if (image->previous == (Image *) 
# 846 "coders/yuv.c" 3 4
                                        ((void *)0)
# 846 "coders/yuv.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",2,3);
            if (status == MagickFalse)
              break;
          }
