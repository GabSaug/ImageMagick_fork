...
# 75 "coders/dng.c" 2
# 151 "coders/dng.c"
static void InitializeDcrawOpenCL(ExceptionInfo *magick_unused_exception __attribute__((unused)))
{
  ;
...
# 245 "coders/dng.c" 3 4
                                     ((void *)0)
# 245 "coders/dng.c"
                                         ,0);
  (void) InvokeDelegate(read_info,image,"dng:decode",(char *) 
# 246 "coders/dng.c" 3 4
                                                             ((void *)0)
# 246 "coders/dng.c"
                                                                 ,exception);
  image=DestroyImage(image);
  (void) FormatLocaleString(read_info->filename,4096,"%s.png",
    read_info->unique);
  sans_exception=AcquireExceptionInfo();
  image=ReadImage(read_info,sans_exception);
  sans_exception=DestroyExceptionInfo(sans_exception);
  if (image == (Image *) 
# 253 "coders/dng.c" 3 4
                        ((void *)0)
# 253 "coders/dng.c"
                            )
    {
      (void) FormatLocaleString(read_info->filename,4096,"%s.ppm",
        read_info->unique);
      image=ReadImage(read_info,exception);
    }
  (void) RelinquishUniqueFileResource(read_info->filename);
  if (image != (Image *) 
# 260 "coders/dng.c" 3 4
                        ((void *)0)
# 260 "coders/dng.c"
                            )
    {
      ...
      (void) CopyMagickString(image->magick,read_info->magick,
        4096);
      (void) FormatLocaleString(filename,4096,"%s.ufraw",
        read_info->unique);
      sans=AcquireExceptionInfo();
      xml=FileToString(filename,4096,sans);
      (void) RelinquishUniqueFileResource(filename);
      if (xml != (char *) 
# 276 "coders/dng.c" 3 4
                         ((void *)0)
# 276 "coders/dng.c"
                             )
        {
          ...
          if (ufraw != (XMLTreeInfo *) 
# 285 "coders/dng.c" 3 4
                                      ((void *)0)
# 285 "coders/dng.c"
                                          )
            {
...
# 297 "coders/dng.c" 3 4
                                               ((void *)0)
# 297 "coders/dng.c"
                                                   )
                image->properties=NewSplayTree(CompareSplayTreeString,
                  RelinquishMagickMemory,RelinquishMagickMemory);
              next=GetXMLTreeChild(ufraw,(const char *) 
# 300 "coders/dng.c" 3 4
                                                       ((void *)0)
# 300 "coders/dng.c"
                                                           );
              while (next != (XMLTreeInfo *) 
# 301 "coders/dng.c" 3 4
                                            ((void *)0)
# 301 "coders/dng.c"
                                                )
              {
                ...
                if (tag == (char *) 
# 304 "coders/dng.c" 3 4
                                   ((void *)0)
# 304 "coders/dng.c"
                                       )
                  tag="unknown";
                (void) FormatLocaleString(property,4096,"dng:%s",
                  tag);
...
# 492 "coders/dng.c" 3 4
 , "coders/dng.c", 492, __extension__ __PRETTY_FUNCTION__); }))
# 492 "coders/dng.c"
                                               ;
  
# 493 "coders/dng.c" 3 4
 ((void) sizeof ((
# 493 "coders/dng.c"
...
# 493 "coders/dng.c" 3 4
 , "coders/dng.c", 493, __extension__ __PRETTY_FUNCTION__); }))
# 493 "coders/dng.c"
                                                     ;
  
# 494 "coders/dng.c" 3 4
 ((void) sizeof ((
# 494 "coders/dng.c"
...
# 494 "coders/dng.c" 3 4
 , "coders/dng.c", 494, __extension__ __PRETTY_FUNCTION__); }))
# 494 "coders/dng.c"
                                            ;
  
# 495 "coders/dng.c" 3 4
 ((void) sizeof ((
# 495 "coders/dng.c"
...
# 495 "coders/dng.c" 3 4
 , "coders/dng.c", 495, __extension__ __PRETTY_FUNCTION__); }))
# 495 "coders/dng.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/dng.c",__func__,(unsigned long) 497,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
...
# 724 "coders/dng.c"
__attribute__ ((visibility ("default"))) size_t RegisterDNGImage(void)
{
  char
    version[4096];
...
# 960 "coders/dng.c"
__attribute__ ((visibility ("default"))) void UnregisterDNGImage(void)
{
