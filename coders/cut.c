...
# 348 "coders/cut.c" 3 4
 , "coders/cut.c", 348, __extension__ __PRETTY_FUNCTION__); }))
# 348 "coders/cut.c"
                                               ;
  
# 349 "coders/cut.c" 3 4
 ((void) sizeof ((
# 349 "coders/cut.c"
...
# 349 "coders/cut.c" 3 4
 , "coders/cut.c", 349, __extension__ __PRETTY_FUNCTION__); }))
# 349 "coders/cut.c"
                                                     ;
  
# 350 "coders/cut.c" 3 4
 ((void) sizeof ((
# 350 "coders/cut.c"
...
# 350 "coders/cut.c" 3 4
 , "coders/cut.c", 350, __extension__ __PRETTY_FUNCTION__); }))
# 350 "coders/cut.c"
                                            ;
  
# 351 "coders/cut.c" 3 4
 ((void) sizeof ((
# 351 "coders/cut.c"
...
# 351 "coders/cut.c" 3 4
 , "coders/cut.c", 351, __extension__ __PRETTY_FUNCTION__); }))
# 351 "coders/cut.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/cut.c",__func__,(unsigned long) 353,"%s",
      image_info->filename);
...
# 360 "coders/cut.c"
  ...
  palette=
# 365 "coders/cut.c" 3 4
         ((void *)0)
# 365 "coders/cut.c"
             ;
  clone_info=
# 366 "coders/cut.c" 3 4
            ((void *)0)
# 366 "coders/cut.c"
                ;
  ...
  if (Header.Width==0 || Header.Height==0 || Header.Reserved!=0)
    CUT_KO: { if (palette != 
# 372 "coders/cut.c" 3 4
            ((void *)0)
# 372 "coders/cut.c"
            ) palette=DestroyImage(palette); if (clone_info != 
# 372 "coders/cut.c" 3 4
            ((void *)0)
# 372 "coders/cut.c"
            ) clone_info=DestroyImageInfo(clone_info); { (void) ThrowMagickException(exception,"coders/cut.c",__func__,(unsigned long) 372,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 372 "coders/cut.c" 3 4
            ((void *)0)
# 372 "coders/cut.c"
  ...
  while((int) RunCountMasked!=0)
    {
      ...
      offset=SeekBlob(image,TellBlob(image)+i,
# 383 "coders/cut.c" 3 4
                                             0
# 383 "coders/cut.c"
                                                     );
      if (offset < 0)
        { if (palette != 
# 385 "coders/cut.c" 3 4
       ((void *)0)
# 385 "coders/cut.c"
       ) palette=DestroyImage(palette); if (clone_info != 
# 385 "coders/cut.c" 3 4
       ((void *)0)
# 385 "coders/cut.c"
       ) clone_info=DestroyImageInfo(clone_info); { (void) ThrowMagickException(exception,"coders/cut.c",__func__,(unsigned long) 385,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 385 "coders/cut.c" 3 4
       ((void *)0)
# 385 "coders/cut.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 413 "coders/cut.c"
  ...
  (void) CopyMagickString(clone_info->filename+i,".PAL",(size_t)
    (4096 -i));
  if((clone_info->file=fopen_utf8(clone_info->filename,"rb"))==
# 434 "coders/cut.c" 3 4
                                                              ((void *)0)
# 434 "coders/cut.c"
                                                                  )
    {
...
# 444 "coders/cut.c"
  ...
  if( (palette=AcquireImage(clone_info,exception))==
# 450 "coders/cut.c" 3 4
                                                   ((void *)0) 
# 450 "coders/cut.c"
                                                        ) goto NoPalette;
...
# 477 "coders/cut.c" 3 4
       ((void *)0)
# 477 "coders/cut.c"
       ) clone_info=DestroyImageInfo(clone_info); { (void) ThrowMagickException(exception,"coders/cut.c",__func__,(unsigned long) 477,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 477 "coders/cut.c" 3 4
       ((void *)0)
# 477 "coders/cut.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 477 "coders/cut.c"
      ...
      if(PalHeader.MaxRed==0) PalHeader.MaxRed=(unsigned int) ((Quantum) 65535.0);
      if(PalHeader.MaxGreen==0) PalHeader.MaxGreen=(unsigned int) ((Quantum) 65535.0);
      if(PalHeader.MaxBlue==0) PalHeader.MaxBlue=(unsigned int) ((Quantum) 65535.0);
      ...
      for(i=0;i<=(int) PalHeader.MaxIndex;i++)
        {
          ...
          if((j % 512)>512-6)
            {
              j=((j / 512)+1)*512;
              offset=SeekBlob(palette,j,
# 493 "coders/cut.c" 3 4
                                       0
# 493 "coders/cut.c"
                                               );
              if (offset < 0)
                { (void) ThrowMagickException(exception,"coders/cut.c",__func__,(unsigned long) 495,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 495 "coders/cut.c" 3 4
               ((void *)0)
# 495 "coders/cut.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 495 "coders/cut.c" 3 4
...
# 521 "coders/cut.c" 3 4
       ((void *)0)
# 521 "coders/cut.c"
       ) clone_info=DestroyImageInfo(clone_info); { (void) ThrowMagickException(exception,"coders/cut.c",__func__,(unsigned long) 521,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 521 "coders/cut.c" 3 4
       ((void *)0)
# 521 "coders/cut.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 534 "coders/cut.c" 3 4
         ((void *)0)
# 534 "coders/cut.c"
         ) clone_info=DestroyImageInfo(clone_info); { (void) ThrowMagickException(exception,"coders/cut.c",__func__,(unsigned long) 534,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 534 "coders/cut.c" 3 4
         ((void *)0)
# 534 "coders/cut.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 534 "coders/cut.c"
  ...
  BImgBuff=(unsigned char *) AcquireQuantumMemory((size_t) ldblk,
    sizeof(*BImgBuff));
  if(BImgBuff==
# 549 "coders/cut.c" 3 4
              ((void *)0)
# 549 "coders/cut.c"
                  ) goto NoMemory;
  (void) memset(BImgBuff,0,(size_t) ldblk*sizeof(*BImgBuff));

  offset=SeekBlob(image,6 ,
# 552 "coders/cut.c" 3 4
                                            0
# 552 "coders/cut.c"
                                                    );
  if (offset < 0)
    {
      if (palette != 
# 555 "coders/cut.c" 3 4
                    ((void *)0)
# 555 "coders/cut.c"
                        )
        palette=DestroyImage(palette);
      if (clone_info != 
# 557 "coders/cut.c" 3 4
                       ((void *)0)
# 557 "coders/cut.c"
                           )
        clone_info=DestroyImageInfo(clone_info);
      BImgBuff=(unsigned char *) RelinquishMagickMemory(BImgBuff);
      { (void) ThrowMagickException(exception,"coders/cut.c",__func__,(unsigned long) 560,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 560 "coders/cut.c" 3 4
     ((void *)0)
# 560 "coders/cut.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 560 "coders/cut.c" 3 4
...
# 630 "coders/cut.c"
                      ...
                      if (GetPixelRed(image,q) == ScaleCharToQuantum(1))
                        {
                          ...
                          SetPixelGreen(image,((Quantum) 65535.0),q);
 ...
 Finish:
  if (BImgBuff != 
# 649 "coders/cut.c" 3 4
                 ((void *)0)
# 649 "coders/cut.c"
                     )
    BImgBuff=(unsigned char *) RelinquishMagickMemory(BImgBuff);
  if (palette != 
# 651 "coders/cut.c" 3 4
                ((void *)0)
# 651 "coders/cut.c"
                    )
    palette=DestroyImage(palette);
  if (clone_info != 
# 653 "coders/cut.c" 3 4
                   ((void *)0)
# 653 "coders/cut.c"
                       )
    clone_info=DestroyImageInfo(clone_info);
...
# 656 "coders/cut.c" 3 4
   (*__errno_location ())
# 656 "coders/cut.c"
   ); (void) ThrowMagickException(exception,"coders/cut.c",__func__,(unsigned long) 656,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 688 "coders/cut.c"
__attribute__ ((visibility ("default"))) size_t RegisterCUTImage(void)
{
  MagickInfo
    *entry;
...
# 719 "coders/cut.c"
__attribute__ ((visibility ("default"))) void UnregisterCUTImage(void)
{
