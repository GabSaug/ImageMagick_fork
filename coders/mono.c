...
# 124 "coders/mono.c" 3 4
 , "coders/mono.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "coders/mono.c"
                                               ;
  
# 125 "coders/mono.c" 3 4
 ((void) sizeof ((
# 125 "coders/mono.c"
...
# 125 "coders/mono.c" 3 4
 , "coders/mono.c", 125, __extension__ __PRETTY_FUNCTION__); }))
# 125 "coders/mono.c"
                                                     ;
  
# 126 "coders/mono.c" 3 4
 ((void) sizeof ((
# 126 "coders/mono.c"
...
# 126 "coders/mono.c" 3 4
 , "coders/mono.c", 126, __extension__ __PRETTY_FUNCTION__); }))
# 126 "coders/mono.c"
                                            ;
  
# 127 "coders/mono.c" 3 4
 ((void) sizeof ((
# 127 "coders/mono.c"
...
# 127 "coders/mono.c" 3 4
 , "coders/mono.c", 127, __extension__ __PRETTY_FUNCTION__); }))
# 127 "coders/mono.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mono.c",__func__,(unsigned long) 129,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/mono.c",__func__,(unsigned long) 133,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 133 "coders/mono.c" 3 4
   ((void *)0)
# 133 "coders/mono.c"
...
# 141 "coders/mono.c" 3 4
   (*__errno_location ())
# 141 "coders/mono.c"
   ); (void) ThrowMagickException(exception,"coders/mono.c",__func__,(unsigned long) 141,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
  ...
  if (AcquireImageColormap(image,2,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/mono.c",__func__,(unsigned long) 148,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 148 "coders/mono.c" 3 4
   ((void *)0)
# 148 "coders/mono.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 148 "coders/mono.c" 3 4
...
# 163 "coders/mono.c"
  ...
  if (EOFBlob(image) != MagickFalse)
    { char *file_message; file_message=GetExceptionMessage(
# 190 "coders/mono.c" 3 4
   (*__errno_location ())
# 190 "coders/mono.c"
   ); (void) ThrowMagickException(exception,"coders/mono.c",__func__,(unsigned long) 190,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 222 "coders/mono.c"
__attribute__ ((visibility ("default"))) size_t RegisterMONOImage(void)
{
  MagickInfo
    *entry;
...
# 256 "coders/mono.c"
__attribute__ ((visibility ("default"))) void UnregisterMONOImage(void)
{
...
# 310 "coders/mono.c"
 "image_info != (const ImageInfo *) NULL"
# 310 "coders/mono.c" 3 4
 , "coders/mono.c", 310, __extension__ __PRETTY_FUNCTION__); }))
# 310 "coders/mono.c"
                                               ;
  
# 311 "coders/mono.c" 3 4
 ((void) sizeof ((
# 311 "coders/mono.c"
 image_info->signature == 0xabacadabUL
# 311 "coders/mono.c" 3 4
...
# 311 "coders/mono.c"
 "image_info->signature == MagickCoreSignature"
# 311 "coders/mono.c" 3 4
 , "coders/mono.c", 311, __extension__ __PRETTY_FUNCTION__); }))
# 311 "coders/mono.c"
                                                     ;
  
# 312 "coders/mono.c" 3 4
 ((void) sizeof ((
# 312 "coders/mono.c"
 image != (Image *) 
# 312 "coders/mono.c" 3 4
...
# 312 "coders/mono.c"
 "image != (Image *) NULL"
# 312 "coders/mono.c" 3 4
 , "coders/mono.c", 312, __extension__ __PRETTY_FUNCTION__); }))
# 312 "coders/mono.c"
                                ;
  
# 313 "coders/mono.c" 3 4
 ((void) sizeof ((
# 313 "coders/mono.c"
...
# 313 "coders/mono.c" 3 4
 , "coders/mono.c", 313, __extension__ __PRETTY_FUNCTION__); }))
# 313 "coders/mono.c"
                                                ;
  
# 314 "coders/mono.c" 3 4
 ((void) sizeof ((
# 314 "coders/mono.c"
 exception != (ExceptionInfo *) 
# 314 "coders/mono.c" 3 4
...
# 314 "coders/mono.c"
 "exception != (ExceptionInfo *) NULL"
# 314 "coders/mono.c" 3 4
 , "coders/mono.c", 314, __extension__ __PRETTY_FUNCTION__); }))
# 314 "coders/mono.c"
                                            ;
  
# 315 "coders/mono.c" 3 4
 ((void) sizeof ((
# 315 "coders/mono.c"
 exception->signature == 0xabacadabUL
# 315 "coders/mono.c" 3 4
...
# 315 "coders/mono.c"
 "exception->signature == MagickCoreSignature"
# 315 "coders/mono.c" 3 4
 , "coders/mono.c", 315, __extension__ __PRETTY_FUNCTION__); }))
# 315 "coders/mono.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mono.c",__func__,(unsigned long) 317,"%s",image->filename);
