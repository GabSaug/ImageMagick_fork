...
# 182 "coders/xps.c" 3 4
 , "coders/xps.c", 182, __extension__ __PRETTY_FUNCTION__); }))
# 182 "coders/xps.c"
                                               ;
  
# 183 "coders/xps.c" 3 4
 ((void) sizeof ((
# 183 "coders/xps.c"
...
# 183 "coders/xps.c" 3 4
 , "coders/xps.c", 183, __extension__ __PRETTY_FUNCTION__); }))
# 183 "coders/xps.c"
                                                     ;
  
# 184 "coders/xps.c" 3 4
 ((void) sizeof ((
# 184 "coders/xps.c"
...
# 184 "coders/xps.c" 3 4
 , "coders/xps.c", 184, __extension__ __PRETTY_FUNCTION__); }))
# 184 "coders/xps.c"
                                            ;
  
# 185 "coders/xps.c" 3 4
 ((void) sizeof ((
# 185 "coders/xps.c"
...
# 185 "coders/xps.c" 3 4
 , "coders/xps.c", 185, __extension__ __PRETTY_FUNCTION__); }))
# 185 "coders/xps.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/xps.c",__func__,(unsigned long) 187,"%s",
      image_info->filename);
...
# 199 "coders/xps.c" 3 4
     (*__errno_location ())
# 199 "coders/xps.c"
     ); (void) ThrowMagickException(exception,"coders/xps.c",__func__,(unsigned long) 199,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",image_info->filename,file_message); file_message=DestroyString(file_message); }
                             ;
      image=DestroyImageList(image);
      return((Image *) 
# 202 "coders/xps.c" 3 4
                      ((void *)0)
# 202 "coders/xps.c"
                          );
    }
...
# 237 "coders/xps.c"
                            )
    {
      ...
      if (flags == NoValue)
        {
          (void) ThrowMagickException(exception,"coders/xps.c",__func__,(unsigned long) 247,OptionError,
            "InvalidGeometry","`%s'",option);
          page_geometry=DestroyString(page_geometry);
          image=DestroyImage(image);
          return((Image *) 
# 251 "coders/xps.c" 3 4
                          ((void *)0)
# 251 "coders/xps.c"
                              );
        }
  ...
  delegate_info=GetDelegateInfo("xps:color",(char *) 
# 263 "coders/xps.c" 3 4
                                                    ((void *)0)
# 263 "coders/xps.c"
                                                        ,exception);
  if (delegate_info == (const DelegateInfo *) 
# 264 "coders/xps.c" 3 4
                                             ((void *)0)
# 264 "coders/xps.c"
                                                 )
    {
...
# 296 "coders/xps.c"
  ...
  (void) ConcatenateMagickString(read_info->filename,"%d",4096);
...
# 336 "coders/xps.c" 3 4
                                   ((void *)0)
# 336 "coders/xps.c"
                                       )
    {
      if (*message != '\0')
        (void) ThrowMagickException(exception,"coders/xps.c",__func__,(unsigned long) 339,
          DelegateError,"PostscriptDelegateFailed","`%s'",message);
      image=DestroyImageList(image);
      return((Image *) 
# 342 "coders/xps.c" 3 4
                      ((void *)0)
# 342 "coders/xps.c"
                          );
    }
...
# 367 "coders/xps.c"
  ...
  do
  {
    ...
    if (next != (Image *) 
# 388 "coders/xps.c" 3 4
                         ((void *)0)
# 388 "coders/xps.c"
                             )
      postscript_image=next;
  } while (next != (Image *) 
# 390 "coders/xps.c" 3 4
                            ((void *)0)
# 390 "coders/xps.c"
                                );
  image=DestroyImageList(image);
...
# 424 "coders/xps.c"
__attribute__ ((visibility ("default"))) size_t RegisterXPSImage(void)
{
  MagickInfo
    *entry;
...
# 458 "coders/xps.c"
__attribute__ ((visibility ("default"))) void UnregisterXPSImage(void)
{
