...
# 133 "coders/stegano.c" 3 4
 ((void) sizeof ((
# 133 "coders/stegano.c"
...
# 133 "coders/stegano.c" 3 4
 , "coders/stegano.c", 133, __extension__ __PRETTY_FUNCTION__); }))
# 133 "coders/stegano.c"
                                               ;
  
# 134 "coders/stegano.c" 3 4
 ((void) sizeof ((
# 134 "coders/stegano.c"
...
# 134 "coders/stegano.c" 3 4
 , "coders/stegano.c", 134, __extension__ __PRETTY_FUNCTION__); }))
# 134 "coders/stegano.c"
                                                     ;
  
# 135 "coders/stegano.c" 3 4
 ((void) sizeof ((
# 135 "coders/stegano.c"
...
# 135 "coders/stegano.c" 3 4
 , "coders/stegano.c", 135, __extension__ __PRETTY_FUNCTION__); }))
# 135 "coders/stegano.c"
                                            ;
  
# 136 "coders/stegano.c" 3 4
 ((void) sizeof ((
# 136 "coders/stegano.c"
...
# 136 "coders/stegano.c" 3 4
 , "coders/stegano.c", 136, __extension__ __PRETTY_FUNCTION__); }))
# 136 "coders/stegano.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/stegano.c",__func__,(unsigned long) 138,"%s",
      image_info->filename);
  one=1;
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/stegano.c",__func__,(unsigned long) 143,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 143 "coders/stegano.c" 3 4
   ((void *)0)
# 143 "coders/stegano.c"
...
# 145 "coders/stegano.c"
  ...
  *read_info->magick='\0';
  ...
  if (watermark == (Image *) 
# 149 "coders/stegano.c" 3 4
                            ((void *)0)
# 149 "coders/stegano.c"
                                )
    return(DestroyImage(image));
  watermark->depth=16;
  if (AcquireImageColormap(image,65536UL,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/stegano.c",__func__,(unsigned long) 153,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 153 "coders/stegano.c" 3 4
   ((void *)0)
  ...
  for (k=image->offset; (i >= 0) && (j < (ssize_t) depth); i--)
  {
    for (y=0; (y < (ssize_t) image->rows) && (j < (ssize_t) depth); y++)
    {
      ...
      for ( ; (x < (ssize_t) image->columns) && (j < (ssize_t) depth); x++)
      {
        ...
        if (q == (Quantum *) 
# 196 "coders/stegano.c" 3 4
                            ((void *)0)
# 196 "coders/stegano.c"
                                )
          break;
        switch (c)
        {
          case 0:
          {
            SetPixelIndex(image,(Quantum) (((((size_t) (pixel.red) >> (size_t) (j)) & 0x01)) != 0 ? (size_t) GetPixelIndex(image,q) | (one << (size_t) (i)) : (size_t) GetPixelIndex(image,q) & ~(one << (size_t) (i))),q);
            break;
          }
          case 1:
          {
            SetPixelIndex(image,(Quantum) (((((size_t) (pixel.green) >> (size_t) (j)) & 0x01)) != 0 ? (size_t) GetPixelIndex(image,q) | (one << (size_t) (i)) : (size_t) GetPixelIndex(image,q) & ~(one << (size_t) (i))),q);
            break;
          }
          case 2:
          {
            SetPixelIndex(image,(Quantum) (((((size_t) (pixel.blue) >> (size_t) (j)) & 0x01)) != 0 ? (size_t) GetPixelIndex(image,q) | (one << (size_t) (i)) : (size_t) GetPixelIndex(image,q) & ~(one << (size_t) (i))),q);
            break;
          }
        }
        if (SyncAuthenticPixels(image,exception) == MagickFalse)
    ...
    status=SetImageProgress(image,"Load/Images",(MagickOffsetType) i,depth);
    if (status == MagickFalse)
      break;
  }
...
# 260 "coders/stegano.c"
__attribute__ ((visibility ("default"))) size_t RegisterSTEGANOImage(void)
{
  MagickInfo
    *entry;
...
# 291 "coders/stegano.c"
__attribute__ ((visibility ("default"))) void UnregisterSTEGANOImage(void)
{
