...
# 103 "coders/tile.c" 3 4
 , "coders/tile.c", 103, __extension__ __PRETTY_FUNCTION__); }))
# 103 "coders/tile.c"
                                               ;
  
# 104 "coders/tile.c" 3 4
 ((void) sizeof ((
# 104 "coders/tile.c"
...
# 104 "coders/tile.c" 3 4
 , "coders/tile.c", 104, __extension__ __PRETTY_FUNCTION__); }))
# 104 "coders/tile.c"
                                                     ;
  
# 105 "coders/tile.c" 3 4
 ((void) sizeof ((
# 105 "coders/tile.c"
...
# 105 "coders/tile.c" 3 4
 , "coders/tile.c", 105, __extension__ __PRETTY_FUNCTION__); }))
# 105 "coders/tile.c"
                                            ;
  
# 106 "coders/tile.c" 3 4
 ((void) sizeof ((
# 106 "coders/tile.c"
...
# 106 "coders/tile.c" 3 4
 , "coders/tile.c", 106, __extension__ __PRETTY_FUNCTION__); }))
# 106 "coders/tile.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/tile.c",__func__,(unsigned long) 108,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/tile.c",__func__,(unsigned long) 112,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 112 "coders/tile.c" 3 4
   ((void *)0)
# 112 "coders/tile.c"
...
# 112 "coders/tile.c"
  ...
  if (*image_info->filename == '\0')
    { (void) ThrowMagickException(exception,"coders/tile.c",__func__,(unsigned long) 114,OptionError,"MustSpecifyAnImageName", "`%s'",image_info->filename); if ((image) != (Image *) 
# 114 "coders/tile.c" 3 4
   ((void *)0)
# 114 "coders/tile.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 114 "coders/tile.c" 3 4
...
# 119 "coders/tile.c" 3 4
                                     ((void *)0)
# 119 "coders/tile.c"
                                         ,0);
  *read_info->magick='\0';
  if (read_info->size != (char *) 
# 121 "coders/tile.c" 3 4
                                 ((void *)0)
# 121 "coders/tile.c"
                                     )
...
# 167 "coders/tile.c"
__attribute__ ((visibility ("default"))) size_t RegisterTILEImage(void)
{
  MagickInfo
    *entry;
...
# 200 "coders/tile.c"
__attribute__ ((visibility ("default"))) void UnregisterTILEImage(void)
{
