...
# 65 "coders/gradient.c" 2
# 96 "coders/gradient.c"
...
# 119 "coders/gradient.c" 3 4
 , "coders/gradient.c", 119, __extension__ __PRETTY_FUNCTION__); }))
# 119 "coders/gradient.c"
                                               ;
  
# 120 "coders/gradient.c" 3 4
 ((void) sizeof ((
# 120 "coders/gradient.c"
...
# 120 "coders/gradient.c" 3 4
 , "coders/gradient.c", 120, __extension__ __PRETTY_FUNCTION__); }))
# 120 "coders/gradient.c"
                                                     ;
  
# 121 "coders/gradient.c" 3 4
 ((void) sizeof ((
# 121 "coders/gradient.c"
...
# 121 "coders/gradient.c" 3 4
 , "coders/gradient.c", 121, __extension__ __PRETTY_FUNCTION__); }))
# 121 "coders/gradient.c"
                                            ;
  
# 122 "coders/gradient.c" 3 4
 ((void) sizeof ((
# 122 "coders/gradient.c"
...
# 122 "coders/gradient.c" 3 4
 , "coders/gradient.c", 122, __extension__ __PRETTY_FUNCTION__); }))
# 122 "coders/gradient.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/gradient.c",__func__,(unsigned long) 124,"%s",
      image_info->filename);
      ...
      if (status == MagickFalse)
        {
          ...
          return((Image *) 
# 145 "coders/gradient.c" 3 4
                          ((void *)0)
# 145 "coders/gradient.c"
                              );
        }
    }
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (q == (Quantum *) 
# 153 "coders/gradient.c" 3 4
                        ((void *)0)
# 153 "coders/gradient.c"
                            )
      break;
...
# 188 "coders/gradient.c" 3 4
 ((void) sizeof ((
# 188 "coders/gradient.c"
 image_info != (const ImageInfo *) 
# 188 "coders/gradient.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 188 "coders/gradient.c"
...
# 188 "coders/gradient.c"
 "image_info != (const ImageInfo *) NULL"
# 188 "coders/gradient.c" 3 4
 , "coders/gradient.c", 188, __extension__ __PRETTY_FUNCTION__); }))
# 188 "coders/gradient.c"
                                               ;
  
# 189 "coders/gradient.c" 3 4
 ((void) sizeof ((
# 189 "coders/gradient.c"
 image_info->signature == 0xabacadabUL
# 189 "coders/gradient.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 189 "coders/gradient.c"
...
# 189 "coders/gradient.c"
 "image_info->signature == MagickCoreSignature"
# 189 "coders/gradient.c" 3 4
 , "coders/gradient.c", 189, __extension__ __PRETTY_FUNCTION__); }))
# 189 "coders/gradient.c"
                                                     ;
  
# 190 "coders/gradient.c" 3 4
 ((void) sizeof ((
# 190 "coders/gradient.c"
 exception != (ExceptionInfo *) 
# 190 "coders/gradient.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 190 "coders/gradient.c"
...
# 190 "coders/gradient.c"
 "exception != (ExceptionInfo *) NULL"
# 190 "coders/gradient.c" 3 4
 , "coders/gradient.c", 190, __extension__ __PRETTY_FUNCTION__); }))
# 190 "coders/gradient.c"
                                            ;
  
# 191 "coders/gradient.c" 3 4
 ((void) sizeof ((
# 191 "coders/gradient.c"
 exception->signature == 0xabacadabUL
# 191 "coders/gradient.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 191 "coders/gradient.c"
...
# 191 "coders/gradient.c"
 "exception->signature == MagickCoreSignature"
# 191 "coders/gradient.c" 3 4
 , "coders/gradient.c", 191, __extension__ __PRETTY_FUNCTION__); }))
# 191 "coders/gradient.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/gradient.c",__func__,(unsigned long) 193,"%s",
      image_info->filename);
  (void) CopyMagickString(start_color,"white",4096);
  (void) CopyMagickString(stop_color,"black",4096);
  if (*image_info->filename != '\0')
    {
      char
        *p;
...
# 219 "coders/gradient.c" 3 4
                                     ((void *)0)
# 219 "coders/gradient.c"
                                         ,0);
  (void) CopyMagickString(read_info->filename,start_color,4096);
  image=ReadXCImage(read_info,exception);
  read_info=DestroyImageInfo(read_info);
  if (image == (Image *) 
# 223 "coders/gradient.c" 3 4
                        ((void *)0)
# 223 "coders/gradient.c"
                            )
    return((Image *) 
# 224 "coders/gradient.c" 3 4
                    ((void *)0)
# 224 "coders/gradient.c"
                        );
  ...
  if (stops == (StopInfo *) 
# 229 "coders/gradient.c" 3 4
                           ((void *)0)
# 229 "coders/gradient.c"
                               )
    { (void) ThrowMagickException(exception,"coders/gradient.c",__func__,(unsigned long) 230,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 230 "coders/gradient.c" 3 4
   ((void *)0)
# 230 "coders/gradient.c"
  ...
  if (status == MagickFalse)
    {
      ...
      image=DestroyImage(image);
      return((Image *) 
# 242 "coders/gradient.c" 3 4
                      ((void *)0)
# 242 "coders/gradient.c"
                          );
    }
  ...
  if ((stops[0].color.alpha_trait != UndefinedPixelTrait) ||
    ...
    SetImageAlpha(image,((Quantum) 0),exception);
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 257 "coders/gradient.c" 3 4
                      ((void *)0)
# 257 "coders/gradient.c"
                          );
    }
  return(GetFirstImageInList(image));
}
# 285 "coders/gradient.c"
__attribute__ ((visibility ("default"))) size_t RegisterGRADIENTImage(void)
{
  MagickInfo
    *entry;
...
# 326 "coders/gradient.c"
__attribute__ ((visibility ("default"))) void UnregisterGRADIENTImage(void)
{
