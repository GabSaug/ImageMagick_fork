...
# 178 "coders/pcd.c" 3 4
 , "coders/pcd.c", 178, __extension__ __PRETTY_FUNCTION__); }))
# 178 "coders/pcd.c"
                                      ;
  
# 179 "coders/pcd.c" 3 4
 ((void) sizeof ((
# 179 "coders/pcd.c"
...
# 179 "coders/pcd.c" 3 4
 , "coders/pcd.c", 179, __extension__ __PRETTY_FUNCTION__); }))
# 179 "coders/pcd.c"
                                                ;
  
# 180 "coders/pcd.c" 3 4
 ((void) sizeof ((
# 180 "coders/pcd.c"
 luma != (unsigned char *) 
# 180 "coders/pcd.c" 3 4
...
# 180 "coders/pcd.c" 3 4
 , "coders/pcd.c", 180, __extension__ __PRETTY_FUNCTION__); }))
# 180 "coders/pcd.c"
                                       ;
  
# 181 "coders/pcd.c" 3 4
 ((void) sizeof ((
# 181 "coders/pcd.c"
...
# 181 "coders/pcd.c" 3 4
 , "coders/pcd.c", 181, __extension__ __PRETTY_FUNCTION__); }))
# 181 "coders/pcd.c"
                                          ;
  
# 182 "coders/pcd.c" 3 4
 ((void) sizeof ((
# 182 "coders/pcd.c"
...
# 182 "coders/pcd.c" 3 4
 , "coders/pcd.c", 182, __extension__ __PRETTY_FUNCTION__); }))
# 182 "coders/pcd.c"
                                          ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pcd.c",__func__,(unsigned long) 184,"%s",image->filename);
  buffer=(unsigned char *) AcquireQuantumMemory(0x800,sizeof(*buffer));
  if (buffer == (unsigned char *) 
# 186 "coders/pcd.c" 3 4
                                 ((void *)0)
# 186 "coders/pcd.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 187,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  sum=0;
  bits=32;
  p=buffer+0x800;
  for (i=0; i < 3; i++)
  {
    pcd_table[i]=(PCDTable *) 
# 194 "coders/pcd.c" 3 4
                             ((void *)0)
# 194 "coders/pcd.c"
                                 ;
    pcd_length[i]=0;
  ...
  {
    { sum=(sum << 8) & 0xffffffff; bits-=8; while (bits <= 24) { if (p >= (buffer+0x800)) { (void) ReadBlob(image,0x800,buffer); p=buffer; } sum|=(((unsigned int) (*p)) << (24-bits)); bits+=8; p++; } };
    length=(sum & 0xff)+1;
    pcd_table[i]=(PCDTable *) AcquireQuantumMemory(length,
      sizeof(*pcd_table[i]));
    if (pcd_table[i] == (PCDTable *) 
# 203 "coders/pcd.c" 3 4
                                    ((void *)0)
# 203 "coders/pcd.c"
                                        )
      {
        ...
        { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 208,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                          ;
      }
    r=pcd_table[i];
    for (j=0; j < (ssize_t) length; j++)
    {
      ...
      { sum=(sum << 16) & 0xffffffff; bits-=16; while (bits <= 24) { if (p >= (buffer+0x800)) { (void) ReadBlob(image,0x800,buffer); p=buffer; } sum|=(((unsigned int) (*p)) << (24-bits)); bits+=8; p++; } };
  ...
  if (EOFBlob(image) == MagickFalse)
    {
      ...
      while ((sum & 0x00fff000UL) != 0x00fff000UL)
        { sum=(sum << 8) & 0xffffffff; bits-=8; while (bits <= 24) { if (p >= (buffer+0x800)) { (void) ReadBlob(image,0x800,buffer); p=buffer; } sum|=(((unsigned int) (*p)) << (24-bits)); bits+=8; p++; } };
      while (((sum & 0xffffff00UL) == 0xfffffe00UL) == 0)
        { sum=(sum << 1) & 0xffffffff; bits-=1; while (bits <= 24) { if (p >= (buffer+0x800)) { (void) ReadBlob(image,0x800,buffer); p=buffer; } sum|=(((unsigned int) (*p)) << (24-bits)); bits+=8; p++; } };
    }
  ...
  {
    if (((sum & 0xffffff00UL) == 0xfffffe00UL) != 0)
      {
        ...
        switch (plane)
        {
          ...
          default:
          {
            ...
            buffer=(unsigned char *) RelinquishMagickMemory(buffer);
            { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 290,CorruptImageError,"CorruptImage", "`%s'",image->filename); return(MagickFalse); }
                              ;
          }
        }
    ...
    for (i=0; ((i < (ssize_t) length) && ((sum & r->mask) != r->sequence)); i++)
      r++;
    if ((row > image->rows) || (r == (PCDTable *) 
# 303 "coders/pcd.c" 3 4
                                                 ((void *)0)
# 303 "coders/pcd.c"
                                                     ))
      {
        (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 305,
    ...
    *q=(unsigned char) ((quantum < 0) ? 0 : (quantum > 255) ? 255 : quantum);
    q++;
    { sum=(sum << r->length) & 0xffffffff; bits-=r->length; while (bits <= 24) { if (p >= (buffer+0x800)) { (void) ReadBlob(image,0x800,buffer); p=buffer; } sum|=(((unsigned int) (*p)) << (24-bits)); bits+=8; p++; } };
  }
...
# 417 "coders/pcd.c" 3 4
                                ((void *)0)
# 417 "coders/pcd.c"
                                    )
    { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 418,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 418 "coders/pcd.c" 3 4
   ((void *)0)
# 418 "coders/pcd.c"
...
# 438 "coders/pcd.c" 3 4
 , "coders/pcd.c", 438, __extension__ __PRETTY_FUNCTION__); }))
# 438 "coders/pcd.c"
                                         ;
...
# 534 "coders/pcd.c" 3 4
 , "coders/pcd.c", 534, __extension__ __PRETTY_FUNCTION__); }))
# 534 "coders/pcd.c"
                                               ;
  
# 535 "coders/pcd.c" 3 4
 ((void) sizeof ((
# 535 "coders/pcd.c"
...
# 535 "coders/pcd.c" 3 4
 , "coders/pcd.c", 535, __extension__ __PRETTY_FUNCTION__); }))
# 535 "coders/pcd.c"
                                                     ;
  
# 536 "coders/pcd.c" 3 4
 ((void) sizeof ((
# 536 "coders/pcd.c"
...
# 536 "coders/pcd.c" 3 4
 , "coders/pcd.c", 536, __extension__ __PRETTY_FUNCTION__); }))
# 536 "coders/pcd.c"
                                            ;
  
# 537 "coders/pcd.c" 3 4
 ((void) sizeof ((
# 537 "coders/pcd.c"
...
# 537 "coders/pcd.c" 3 4
 , "coders/pcd.c", 537, __extension__ __PRETTY_FUNCTION__); }))
# 537 "coders/pcd.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pcd.c",__func__,(unsigned long) 539,"%s",
      image_info->filename);
...
# 546 "coders/pcd.c"
  ...
  if (header == (unsigned char *) 
# 552 "coders/pcd.c" 3 4
                                 ((void *)0)
# 552 "coders/pcd.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 553,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 553 "coders/pcd.c" 3 4
   ((void *)0)
# 553 "coders/pcd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 553 "coders/pcd.c" 3 4
...
# 554 "coders/pcd.c"
  ...
  if (count != (3*0x800))
    { if (header != (unsigned char *) 
# 557 "coders/pcd.c" 3 4
   ((void *)0)
# 557 "coders/pcd.c"
   ) header=(unsigned char *) RelinquishMagickMemory(header); if (pixel_info != (MemoryInfo *) 
# 557 "coders/pcd.c" 3 4
   ((void *)0)
# 557 "coders/pcd.c"
   ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 557,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 557 "coders/pcd.c" 3 4
   ((void *)0)
# 557 "coders/pcd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 560 "coders/pcd.c" 3 4
   ((void *)0)
# 560 "coders/pcd.c"
   ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 560,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 560 "coders/pcd.c" 3 4
   ((void *)0)
# 560 "coders/pcd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 566 "coders/pcd.c" 3 4
   ((void *)0)
# 566 "coders/pcd.c"
   ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 566,(ResourceLimitError),("ListLengthExceedsLimit"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 566 "coders/pcd.c" 3 4
   ((void *)0)
# 566 "coders/pcd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 566 "coders/pcd.c"
  ...
  if (image_info->number_scenes != 0)
    scene=(size_t) (((image_info->scene) < (6)) ? (image_info->scene) : (6));
  if (overview != 0)
    scene=1;
...
# 617 "coders/pcd.c" 3 4
                                  ((void *)0)
# 617 "coders/pcd.c"
                                      )
    { if (header != (unsigned char *) 
# 618 "coders/pcd.c" 3 4
   ((void *)0)
# 618 "coders/pcd.c"
   ) header=(unsigned char *) RelinquishMagickMemory(header); if (pixel_info != (MemoryInfo *) 
# 618 "coders/pcd.c" 3 4
   ((void *)0)
# 618 "coders/pcd.c"
   ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 618,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 618 "coders/pcd.c" 3 4
   ((void *)0)
# 618 "coders/pcd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 637 "coders/pcd.c" 3 4
                              (-1)
# 637 "coders/pcd.c"
                                 )
      { if (header != (unsigned char *) 
# 638 "coders/pcd.c" 3 4
     ((void *)0)
# 638 "coders/pcd.c"
     ) header=(unsigned char *) RelinquishMagickMemory(header); if (pixel_info != (MemoryInfo *) 
# 638 "coders/pcd.c" 3 4
     ((void *)0)
# 638 "coders/pcd.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 638,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 638 "coders/pcd.c" 3 4
     ((void *)0)
# 638 "coders/pcd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
  ...
  if (overview != 0)
    {
      ...
      for (j=1; j <= (ssize_t) number_images; j++)
      {
        progress_monitor=SetImageProgressMonitor(image,
          (MagickProgressMonitor) 
# 653 "coders/pcd.c" 3 4
                                 ((void *)0)
# 653 "coders/pcd.c"
                                     ,image->client_data);
        (void) FormatLocaleString(image->filename,4096,
          "images/img%04ld.pcd",(long) j);
        (void) FormatLocaleString(image->magick_filename,4096,
          "images/img%04ld.pcd",(long) j);
...
# 676 "coders/pcd.c" 3 4
           ((void *)0)
# 676 "coders/pcd.c"
           ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 676,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 676 "coders/pcd.c" 3 4
           ((void *)0)
# 676 "coders/pcd.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 721 "coders/pcd.c" 3 4
                                        ((void *)0)
# 721 "coders/pcd.c"
                                            )
          {
            status=SetImageProgress(image,"Load/Image",j-1,number_images);
            if (status == MagickFalse)
              break;
          }
      }
...
# 750 "coders/pcd.c" 3 4
     ((void *)0)
# 750 "coders/pcd.c"
     ) pixel_info=RelinquishVirtualMemory(pixel_info); { (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 750,(CorruptImageError),("UnexpectedEndOfFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 750 "coders/pcd.c" 3 4
     ((void *)0)
# 750 "coders/pcd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
      ...
      if ((scene >= 5) && status)
        {
          ...
          offset=SeekBlob(image,offset*0x800,
# 774 "coders/pcd.c" 3 4
                                            0
# 774 "coders/pcd.c"
                                                    );
          status=DecodeImage(image,luma,chroma1,chroma2,exception);
...
# 820 "coders/pcd.c" 3 4
   (*__errno_location ())
# 820 "coders/pcd.c"
   ); (void) ThrowMagickException(exception,"coders/pcd.c",__func__,(unsigned long) 820,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 887 "coders/pcd.c"
__attribute__ ((visibility ("default"))) size_t RegisterPCDImage(void)
{
  MagickInfo
    *entry;
...
# 927 "coders/pcd.c"
__attribute__ ((visibility ("default"))) void UnregisterPCDImage(void)
{
  ...
  const size_t tile_columns,const size_t tile_rows,ExceptionInfo *exception)
{
  ...
  if ((geometry.width % 2) != 0)
    geometry.width=(((geometry.width-1) > (1)) ? (geometry.width-1) : (1));
  if ((geometry.height % 2) != 0)
    geometry.height=(((geometry.height-1) > (1)) ? (geometry.height-1) : (1));
  tile_image=ResizeImage(image,geometry.width,geometry.height,TriangleFilter,
    exception);
  if (tile_image == (Image *) 
# 1003 "coders/pcd.c" 3 4
                             ((void *)0)
# 1003 "coders/pcd.c"
                                 )
    return(MagickFalse);
  ...
  if ((tile_image->columns != geometry.width) ||
      (tile_image->rows != geometry.height))
    {
      ...
      bordered_image=BorderImage(tile_image,&border_info,image->compose,
        exception);
      if (bordered_image == (Image *) 
# 1026 "coders/pcd.c" 3 4
                                     ((void *)0)
# 1026 "coders/pcd.c"
                                         )
        return(MagickFalse);
...
# 1038 "coders/pcd.c"
  ...
  if (downsample_image == (Image *) 
# 1047 "coders/pcd.c" 3 4
                                   ((void *)0)
# 1047 "coders/pcd.c"
                                       )
    return(MagickFalse);
...
# 1106 "coders/pcd.c"
 "image_info != (const ImageInfo *) NULL"
# 1106 "coders/pcd.c" 3 4
 , "coders/pcd.c", 1106, __extension__ __PRETTY_FUNCTION__); }))
# 1106 "coders/pcd.c"
                                               ;
  
# 1107 "coders/pcd.c" 3 4
 ((void) sizeof ((
# 1107 "coders/pcd.c"
 image_info->signature == 0xabacadabUL
# 1107 "coders/pcd.c" 3 4
...
# 1107 "coders/pcd.c"
 "image_info->signature == MagickCoreSignature"
# 1107 "coders/pcd.c" 3 4
 , "coders/pcd.c", 1107, __extension__ __PRETTY_FUNCTION__); }))
# 1107 "coders/pcd.c"
                                                     ;
  
# 1108 "coders/pcd.c" 3 4
 ((void) sizeof ((
# 1108 "coders/pcd.c"
 image != (Image *) 
# 1108 "coders/pcd.c" 3 4
...
# 1108 "coders/pcd.c"
 "image != (Image *) NULL"
# 1108 "coders/pcd.c" 3 4
 , "coders/pcd.c", 1108, __extension__ __PRETTY_FUNCTION__); }))
# 1108 "coders/pcd.c"
                                ;
  
# 1109 "coders/pcd.c" 3 4
 ((void) sizeof ((
# 1109 "coders/pcd.c"
 image->signature == 0xabacadabUL
# 1109 "coders/pcd.c" 3 4
...
# 1109 "coders/pcd.c"
 "image->signature == MagickCoreSignature"
# 1109 "coders/pcd.c" 3 4
 , "coders/pcd.c", 1109, __extension__ __PRETTY_FUNCTION__); }))
# 1109 "coders/pcd.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pcd.c",__func__,(unsigned long) 1111,"%s",image->filename);
  pcd_image=image;
