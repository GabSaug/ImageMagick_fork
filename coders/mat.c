...
# 192 "coders/mat.c"
  ...
  for (x = 0; x < (ssize_t) image->columns; x++)
  {
    if (*p > 0)
      {
        f=(*p/MaxVal)*((double) ((Quantum) 65535.0)-(double) GetPixelRed(image,q));
        if (
# 199 "coders/mat.c" 3 4
           __builtin_isnan (
# 199 "coders/mat.c"
           f
# 199 "coders/mat.c" 3 4
...
# 199 "coders/mat.c"
                    != 0)
          f=0.0;
        if ((f+(double) GetPixelRed(image,q)) >= (double) ((Quantum) 65535.0))
          SetPixelRed(image,((Quantum) 65535.0),q);
        else
          SetPixelRed(image,(double) GetPixelRed(image,q)+ClampToQuantum(f),q);
        f=(double) GetPixelGreen(image,q)-f/2.0;
        if (
# 206 "coders/mat.c" 3 4
           __builtin_isnan (
# 206 "coders/mat.c"
           f
# 206 "coders/mat.c" 3 4
...
# 206 "coders/mat.c"
    ...
    if (*p < 0)
      {
        f=(*p/MinVal)*(Quantum) (((Quantum) 65535.0)-GetPixelBlue(image,q));
        if (
# 222 "coders/mat.c" 3 4
           __builtin_isnan (
# 222 "coders/mat.c"
           f
# 222 "coders/mat.c" 3 4
...
# 222 "coders/mat.c"
                    != 0)
          f=0.0;
        if ((f+(double) GetPixelBlue(image,q)) >= (double) ((Quantum) 65535.0))
          SetPixelBlue(image,((Quantum) 65535.0),q);
        else
...
# 261 "coders/mat.c"
  ...
  for (x = 0; x < (ssize_t) image->columns; x++)
  {
    if (*p > 0)
      {
        f=((double) *p/MaxVal)*((double) ((Quantum) 65535.0)-(double)
          GetPixelRed(image,q));
        if (
# 269 "coders/mat.c" 3 4
           __builtin_isnan (
# 269 "coders/mat.c"
           f
# 269 "coders/mat.c" 3 4
...
# 269 "coders/mat.c"
                    != 0)
          f=0.0;
        if ((f+GetPixelRed(image,q)) < ((Quantum) 65535.0))
    ...
    if (*p < 0)
      {
        f=(*p/MaxVal)*(Quantum) (((Quantum) 65535.0)-GetPixelBlue(image,q));
        if (
# 290 "coders/mat.c" 3 4
           __builtin_isnan (
# 290 "coders/mat.c"
           f
# 290 "coders/mat.c" 3 4
...
# 290 "coders/mat.c"
                    != 0)
          f=0.0;
        if ((f+GetPixelBlue(image,q)) < ((Quantum) 65535.0))
          SetPixelBlue(image,GetPixelBlue(image,q)+ClampToQuantum(f),q);
        else
          SetPixelBlue(image,((Quantum) 65535.0),q);
        f/=2.0;
...
static void ReadBlobFloatsLSB(Image * image, size_t len, float *data)
{
  ...
  if (len > 0)
    (void) SeekBlob(image, (MagickOffsetType) len, 
# 328 "coders/mat.c" 3 4
                                                  1
# 328 "coders/mat.c"
                                                          );
}
...
float *fltrow;
  ...
  (void) SeekBlob(image, (MagickOffsetType) filepos, 
# 424 "coders/mat.c" 3 4
                                                    0
# 424 "coders/mat.c"
                                                            );
}
...
static void FixSignedValues(const Image *image,Quantum *q, ssize_t y)
{
  while(y-->0)
  {
    ...
    SetPixelRed(image,GetPixelRed(image,q)+((Quantum) 65535.0)/2+1,q);
    SetPixelGreen(image,GetPixelGreen(image,q)+((Quantum) 65535.0)/2+1,q);
    SetPixelBlue(image,GetPixelBlue(image,q)+((Quantum) 65535.0)/2+1,q);
    q++;
  }
}
...
# 516 "coders/mat.c"
  ...
  if(!mat_file)
  {
    ...
    (void) LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 527,"Cannot create file stream for decompressed image");
    return 
# 528 "coders/mat.c" 3 4
          ((void *)0)
# 528 "coders/mat.c"
              ;
  }
  ...
  zip_info.opaque = (voidpf) 
# 534 "coders/mat.c" 3 4
                            ((void *)0)
# 534 "coders/mat.c"
                                ;
  zip_status = 
# 535 "coders/mat.c" 3 4
              inflateInit_((
# 535 "coders/mat.c"
              &zip_info
# 535 "coders/mat.c" 3 4
...
# 536 "coders/mat.c"
                       )
    {
      RelinquishMagickMemory(cache_block);
      RelinquishMagickMemory(decompress_block);
      (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 540,CorruptImageError,
        "UnableToUncompressImage","`%s'",clone_info->filename);
      (void) fclose(mat_file);
      RelinquishUniqueFileResource(clone_info->filename);
      return 
# 544 "coders/mat.c" 3 4
            ((void *)0)
# 544 "coders/mat.c"
                ;
    }
  ...
  while(*Size>0 && !EOFBlob(orig))
  {
    ...
    while(zip_info.avail_in>0)
    {
      ...
      zip_status = inflate(&zip_info,
# 562 "coders/mat.c" 3 4
                                    0
# 562 "coders/mat.c"
                                              );
      if ((zip_status != 
# 563 "coders/mat.c" 3 4
                        0
# 563 "coders/mat.c"
                            ) && (zip_status != 
# 563 "coders/mat.c" 3 4
...
# 563 "coders/mat.c"
      ...
      if(zip_status == 
# 569 "coders/mat.c" 3 4
                      1
# 569 "coders/mat.c"
                                  ) goto DblBreak;
    }
    if ((zip_status != 
# 571 "coders/mat.c" 3 4
                      0
# 571 "coders/mat.c"
                          ) && (zip_status != 
# 571 "coders/mat.c" 3 4
...
DblBreak:
  ...
  *Size = TotalSize;
  ...
  if((clone_info->file=fopen(clone_info->filename,"rb"))==
# 584 "coders/mat.c" 3 4
                                                         ((void *)0)
# 584 "coders/mat.c"
                                                             ) goto UnlinkFile;
  if( (image2 = AcquireImage(clone_info,exception))==
# 585 "coders/mat.c" 3 4
                                                    ((void *)0) 
# 585 "coders/mat.c"
                                                         ) goto EraseFile;
  image2->columns=0;
...
# 645 "coders/mat.c" 3 4
                              ((void *)0)
# 645 "coders/mat.c"
                                  ;
  (void) SeekBlob(image,0,
# 646 "coders/mat.c" 3 4
                         0
# 646 "coders/mat.c"
                                 );
  status=MagickTrue;
  while (EOFBlob(image) == MagickFalse)
  {
    ...
    if ((ldblk > 9999) || (ldblk < 0))
      break;
    HDR.Type[3]=(unsigned char) (ldblk % 10); ldblk /= 10;
    HDR.Type[2]=(unsigned char) (ldblk % 10); ldblk /= 10;
    HDR.Type[1]=(unsigned char) (ldblk % 10); ldblk /= 10;
    HDR.Type[0]=(unsigned char) (ldblk);
    if (HDR.Type[3] != 0)
      break;
    if (HDR.Type[2] != 0)
      break;
    ...
    for (i=0; i < (ssize_t) HDR.nameLen; i++)
    {
      ...
      if (byte == 
# 694 "coders/mat.c" 3 4
                 (-1)
# 694 "coders/mat.c"
                    )
        {
          { char *file_message; file_message=GetExceptionMessage(
# 696 "coders/mat.c" 3 4
         (*__errno_location ())
# 696 "coders/mat.c"
         ); (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 696,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                            ;
          break;
        }
    }
    ...
    if (image_info->ping != MagickFalse)
      {
        ((image->columns)^=(image->rows), (image->rows)^=(image->columns), (image->columns)^=(image->rows));
        if(HDR.imagf==1) ldblk *= 2;
        SeekBlob(image, (MagickOffsetType) HDR.nCols*ldblk, 
# 709 "coders/mat.c" 3 4
                                                           1
# 709 "coders/mat.c"
                                                                   );
        if ((image->columns == 0) || (image->rows == 0))
          return(image->previous == (Image *) 
# 711 "coders/mat.c" 3 4
                                             ((void *)0) 
# 711 "coders/mat.c"
                                                  ? DestroyImageList(image)
            : image);
...
# 721 "coders/mat.c"
    ...
    for (y=0; y < (ssize_t) image->rows; y++)
    {
      ...
      q=QueueAuthenticPixels(image,0,(ssize_t) image->rows-y-1,image->columns,1,
        exception);
      if (q == (Quantum *) 
# 768 "coders/mat.c" 3 4
                          ((void *)0)
# 768 "coders/mat.c"
                              )
        break;
      (void) ImportQuantumPixels(image,(CacheView *) 
# 770 "coders/mat.c" 3 4
                                                    ((void *)0)
# 770 "coders/mat.c"
                                                        ,quantum_info,
...
# 798 "coders/mat.c"
    ...
    if (EOFBlob(image) != MagickFalse)
      {
        { char *file_message; file_message=GetExceptionMessage(
# 802 "coders/mat.c" 3 4
       (*__errno_location ())
# 802 "coders/mat.c"
       ); (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 802,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
    rotated_image=RotateImage(image,90.0,exception);
    if (rotated_image != (Image *) 
# 807 "coders/mat.c" 3 4
                                  ((void *)0)
# 807 "coders/mat.c"
                                      )
      {
...
# 907 "coders/mat.c" 3 4
 , "coders/mat.c", 907, __extension__ __PRETTY_FUNCTION__); }))
# 907 "coders/mat.c"
                                               ;
  
# 908 "coders/mat.c" 3 4
 ((void) sizeof ((
# 908 "coders/mat.c"
...
# 908 "coders/mat.c" 3 4
 , "coders/mat.c", 908, __extension__ __PRETTY_FUNCTION__); }))
# 908 "coders/mat.c"
                                                     ;
  
# 909 "coders/mat.c" 3 4
 ((void) sizeof ((
# 909 "coders/mat.c"
...
# 909 "coders/mat.c" 3 4
 , "coders/mat.c", 909, __extension__ __PRETTY_FUNCTION__); }))
# 909 "coders/mat.c"
                                            ;
  
# 910 "coders/mat.c" 3 4
 ((void) sizeof ((
# 910 "coders/mat.c"
...
# 910 "coders/mat.c" 3 4
 , "coders/mat.c", 910, __extension__ __PRETTY_FUNCTION__); }))
# 910 "coders/mat.c"
                                                    ;
  logging = LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 911,"enter");
...
# 923 "coders/mat.c"
  ...
  quantum_info=(QuantumInfo *) 
# 928 "coders/mat.c" 3 4
                              ((void *)0)
# 928 "coders/mat.c"
                                  ;
  clone_info=(ImageInfo *) 
# 929 "coders/mat.c" 3 4
                          ((void *)0)
# 929 "coders/mat.c"
                              ;
  if (ReadBlob(image,124,(unsigned char *) &MATLAB_HDR.identific) != 124)
    { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 931,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 931 "coders/mat.c" 3 4
   ((void *)0)
# 931 "coders/mat.c"
  ...
  if (strncmp(MATLAB_HDR.identific,"MATLAB",6) != 0)
    {
      ...
      if (image == 
# 935 "coders/mat.c" 3 4
                  ((void *)0)
# 935 "coders/mat.c"
                      )
        {
          if ((image != image2) && (image2 != (Image *) 
# 937 "coders/mat.c" 3 4
                                                       ((void *)0)
# 937 "coders/mat.c"
                                                           ))
            image2=DestroyImage(image2);
          if (clone_info != (ImageInfo *) 
# 939 "coders/mat.c" 3 4
                                         ((void *)0)
# 939 "coders/mat.c"
                                             )
            clone_info=DestroyImageInfo(clone_info);
          return((Image *) 
# 941 "coders/mat.c" 3 4
                          ((void *)0)
# 941 "coders/mat.c"
                              );
        }
  ...
  if(ReadBlob(image,2,(unsigned char *) &MATLAB_HDR.EndianIndicator) != 2)
    { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 947,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 947 "coders/mat.c" 3 4
   ((void *)0)
# 947 "coders/mat.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 947 "coders/mat.c" 3 4
...
# 947 "coders/mat.c"
  ...
  if (logging)
    (void) LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 950,"  Endian %c%c",
...
MATLAB_KO:
      if ((image != image2) && (image2 != (Image *) 
# 971 "coders/mat.c" 3 4
                                                   ((void *)0)
# 971 "coders/mat.c"
                                                       ))
        image2=DestroyImage(image2);
      if (clone_info != (ImageInfo *) 
# 973 "coders/mat.c" 3 4
                                     ((void *)0)
# 973 "coders/mat.c"
                                         )
        clone_info=DestroyImageInfo(clone_info);
      { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 975,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 975 "coders/mat.c" 3 4
     ((void *)0)
# 975 "coders/mat.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 975 "coders/mat.c" 3 4
...
# 975 "coders/mat.c"
  ...
  filepos = TellBlob(image);
  while(filepos < (MagickOffsetType) GetBlobSize(image) && !EOFBlob(image))
  {
    Frames = 1;
    if(filepos > (MagickOffsetType) GetBlobSize(image) || filepos < 0)
      break;
    if(SeekBlob(image,(MagickOffsetType) filepos,
# 984 "coders/mat.c" 3 4
                                                0
# 984 "coders/mat.c"
                                                        ) != filepos) break;
    ...
    switch(MATLAB_HDR.DimFlag)
    {
      ...
      case 12: z2=z = ReadBlobXXXLong(image2);
         ...
         if(z!=3)
           {
             if (clone_info != (ImageInfo *) 
# 1043 "coders/mat.c" 3 4
                                            ((void *)0)
# 1043 "coders/mat.c"
                                                )
               clone_info=DestroyImageInfo(clone_info);
             if ((image != image2) && (image2 != (Image *) 
# 1045 "coders/mat.c" 3 4
                                                          ((void *)0)
# 1045 "coders/mat.c"
                                                              ))
               image2=DestroyImage(image2);
             { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1047,CoderError,"MultidimensionalMatricesAreNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1047 "coders/mat.c" 3 4
            ((void *)0)
# 1047 "coders/mat.c"
            ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1047 "coders/mat.c" 3 4
...
# 1047 "coders/mat.c"
      ...
      case 16: z2=z = ReadBlobXXXLong(image2);
         if(z!=3 && z!=1)
           {
             if (clone_info != (ImageInfo *) 
# 1054 "coders/mat.c" 3 4
                                            ((void *)0)
# 1054 "coders/mat.c"
                                                )
               clone_info=DestroyImageInfo(clone_info);
             if ((image != image2) && (image2 != (Image *) 
# 1056 "coders/mat.c" 3 4
                                                          ((void *)0)
# 1056 "coders/mat.c"
                                                              ))
               image2=DestroyImage(image2);
             { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1058,CoderError,"MultidimensionalMatricesAreNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1058 "coders/mat.c" 3 4
            ((void *)0)
# 1058 "coders/mat.c"
            ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1058 "coders/mat.c" 3 4
...
# 1058 "coders/mat.c"
          ...
          if (Frames == 0)
            {
              if (clone_info != (ImageInfo *) 
# 1064 "coders/mat.c" 3 4
                                             ((void *)0)
# 1064 "coders/mat.c"
                                                 )
                clone_info=DestroyImageInfo(clone_info);
              if ((image != image2) && (image2 != (Image *) 
# 1066 "coders/mat.c" 3 4
                                                           ((void *)0)
# 1066 "coders/mat.c"
                                                               ))
                image2=DestroyImage(image2);
              { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1068,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1068 "coders/mat.c" 3 4
             ((void *)0)
# 1068 "coders/mat.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1068 "coders/mat.c" 3 4
...
# 1068 "coders/mat.c"
          ...
          if (AcquireMagickResource(ListLengthResource,Frames) == MagickFalse)
            {
              if (clone_info != (ImageInfo *) 
# 1072 "coders/mat.c" 3 4
                                             ((void *)0)
# 1072 "coders/mat.c"
                                                 )
                clone_info=DestroyImageInfo(clone_info);
              if ((image != image2) && (image2 != (Image *) 
# 1074 "coders/mat.c" 3 4
                                                           ((void *)0)
# 1074 "coders/mat.c"
                                                               ))
                image2=DestroyImage(image2);
              { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1076,ResourceLimitError,"ListLengthExceedsLimit", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1076 "coders/mat.c" 3 4
             ((void *)0)
# 1076 "coders/mat.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1076 "coders/mat.c" 3 4
...
# 1076 "coders/mat.c"
      ...
      default:
        if (clone_info != (ImageInfo *) 
# 1080 "coders/mat.c" 3 4
                                       ((void *)0)
# 1080 "coders/mat.c"
                                           )
          clone_info=DestroyImageInfo(clone_info);
        if ((image != image2) && (image2 != (Image *) 
# 1082 "coders/mat.c" 3 4
                                                     ((void *)0)
# 1082 "coders/mat.c"
                                                         ))
          image2=DestroyImage(image2);
        { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1084,CoderError,"MultidimensionalMatricesAreNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1084 "coders/mat.c" 3 4
       ((void *)0)
# 1084 "coders/mat.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1084 "coders/mat.c" 3 4
...
# 1084 "coders/mat.c"
    ...
    if (logging) (void)LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 1090,
...
# 1104 "coders/mat.c"
        ...
        if (clone_info != (ImageInfo *) 
# 1109 "coders/mat.c" 3 4
                                       ((void *)0)
# 1109 "coders/mat.c"
                                           )
          clone_info=DestroyImageInfo(clone_info);
        { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1111,CoderError,"UnsupportedCellTypeInTheMatrix", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1111 "coders/mat.c" 3 4
       ((void *)0)
# 1111 "coders/mat.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1111 "coders/mat.c" 3 4
...
# 1111 "coders/mat.c"
    ...
    switch (MATLAB_HDR.NameFlag)
    {
      case 0:
        ...
        (void) SeekBlob(image2, (MagickOffsetType) size, 
# 1119 "coders/mat.c" 3 4
                                                        1
# 1119 "coders/mat.c"
                                                                );
        break;
    ...
    if (logging)
      (void) LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 1133,
    ...
    switch (CellType)
    {
      ...
      case miUINT8:
        sample_size = 8;
        if(MATLAB_HDR.StructureFlag & 0x2)
          image->depth = 1;
        else
          image->depth = 8;
      ...
      case miSINGLE:
        ...
        if (MATLAB_HDR.StructureFlag & 0x8)
          {
          }
        ldblk = (ssize_t) (4 * MATLAB_HDR.SizeX);
        break;
      case miDOUBLE:
        ...
        if (sizeof(double) != 8)
          ...
          {
            if (clone_info != (ImageInfo *) 
# 1187 "coders/mat.c" 3 4
                                           ((void *)0)
# 1187 "coders/mat.c"
                                               )
              clone_info=DestroyImageInfo(clone_info);
            if ((image != image2) && (image2 != (Image *) 
# 1189 "coders/mat.c" 3 4
                                                         ((void *)0)
# 1189 "coders/mat.c"
                                                             ))
              image2=DestroyImage(image2);
            { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1191,CoderError,"IncompatibleSizeOfDouble", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1191 "coders/mat.c" 3 4
           ((void *)0)
# 1191 "coders/mat.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1191 "coders/mat.c" 3 4
...
# 1199 "coders/mat.c"
        ...
        if (clone_info)
          clone_info=DestroyImageInfo(clone_info);
        { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1203,CoderError,"UnsupportedCellTypeInTheMatrix", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1203 "coders/mat.c" 3 4
       ((void *)0)
# 1203 "coders/mat.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1203 "coders/mat.c" 3 4
...
# 1203 "coders/mat.c"
    ...
    if ((MATLAB_HDR.DimFlag == 8) &&
        ((MATLAB_HDR.StructureFlag & 0x8) == 0))
      {
    ...
    if (status == MagickFalse)
      {
        if (clone_info != (ImageInfo *) 
# 1236 "coders/mat.c" 3 4
                                       ((void *)0)
# 1236 "coders/mat.c"
                                           )
          clone_info=DestroyImageInfo(clone_info);
        if ((image != image2) && (image2 != (Image *) 
# 1238 "coders/mat.c" 3 4
                                                     ((void *)0)
# 1238 "coders/mat.c"
                                                         ))
          image2=DestroyImage(image2);
    ...
    if (quantum_info == (QuantumInfo *) 
# 1244 "coders/mat.c" 3 4
                                       ((void *)0)
# 1244 "coders/mat.c"
                                           )
      {
        if (clone_info != (ImageInfo *) 
# 1246 "coders/mat.c" 3 4
                                       ((void *)0)
# 1246 "coders/mat.c"
                                           )
          clone_info=DestroyImageInfo(clone_info);
        if ((image != image2) && (image2 != (Image *) 
# 1248 "coders/mat.c" 3 4
                                                     ((void *)0)
# 1248 "coders/mat.c"
                                                         ))
          image2=DestroyImage(image2);
        { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1250,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1250 "coders/mat.c" 3 4
       ((void *)0)
# 1250 "coders/mat.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1250 "coders/mat.c" 3 4
...
# 1250 "coders/mat.c"
    ...
    if (BImgBuff == 
# 1255 "coders/mat.c" 3 4
                   ((void *)0)
# 1255 "coders/mat.c"
                       )
      {
        if (clone_info != (ImageInfo *) 
# 1257 "coders/mat.c" 3 4
                                       ((void *)0)
# 1257 "coders/mat.c"
                                           )
          clone_info=DestroyImageInfo(clone_info);
        if ((image != image2) && (image2 != (Image *) 
# 1259 "coders/mat.c" 3 4
                                                     ((void *)0)
# 1259 "coders/mat.c"
                                                         ))
          image2=DestroyImage(image2);
        if (quantum_info != (QuantumInfo *) 
# 1261 "coders/mat.c" 3 4
                                           ((void *)0)
# 1261 "coders/mat.c"
                                               )
          quantum_info=DestroyQuantumInfo(quantum_info);
        { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1263,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1263 "coders/mat.c" 3 4
       ((void *)0)
# 1263 "coders/mat.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1263 "coders/mat.c" 3 4
...
# 1263 "coders/mat.c"
    ...
    do
    {
      for (i = 0; i < (ssize_t) MATLAB_HDR.SizeY; i++)
      {
        ...
        if (q == (Quantum *) 
# 1284 "coders/mat.c" 3 4
                            ((void *)0)
# 1284 "coders/mat.c"
                                )
          {
            if (logging) (void)LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 1286,
              "  MAT set image pixels returns unexpected NULL on a row %u.", (unsigned)(MATLAB_HDR.SizeY-i-1));
            goto done_reading;
          }
        if(ReadBlob(image2,(size_t) ldblk,(unsigned char *) BImgBuff) != (ssize_t) ldblk)
          {
            if (logging) (void)LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 1292,
              "  MAT cannot read scanrow %u from a file.", (unsigned)(MATLAB_HDR.SizeY-i-1));
           if ((image != image2) && (image2 != (Image *) 
# 1294 "coders/mat.c" 3 4
                                                        ((void *)0)
# 1294 "coders/mat.c"
                                                            ))
              image2=DestroyImage(image2);
            if (clone_info != (ImageInfo *) 
# 1296 "coders/mat.c" 3 4
                                           ((void *)0)
# 1296 "coders/mat.c"
                                               )
              clone_info=DestroyImageInfo(clone_info);
            if (quantum_info != (QuantumInfo *) 
# 1298 "coders/mat.c" 3 4
                                               ((void *)0)
# 1298 "coders/mat.c"
                                                   )
              quantum_info=DestroyQuantumInfo(quantum_info);
            BImgBuff=(unsigned char *) RelinquishMagickMemory(BImgBuff);
            { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1301,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1301 "coders/mat.c" 3 4
           ((void *)0)
# 1301 "coders/mat.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1301 "coders/mat.c" 3 4
...
# 1301 "coders/mat.c"
        ...
        if((CellType==miINT8 || CellType==miUINT8) && (MATLAB_HDR.StructureFlag & 0x2))
        {
          FixLogical((unsigned char *)BImgBuff,ldblk);
          if(ImportQuantumPixels(image,(CacheView *) 
# 1306 "coders/mat.c" 3 4
                                                    ((void *)0)
# 1306 "coders/mat.c"
                                                        ,quantum_info,z2qtype[z],BImgBuff,exception) <= 0)
            {
ImportQuantumPixelsFailed:
              if (logging) (void)LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 1309,
...
# 1316 "coders/mat.c"
        ...
        if (!SyncAuthenticPixels(image,exception))
          {
            if (logging) (void)LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 1327,
...
# 1418 "coders/mat.c"
    ...
    BImgBuff = 
# 1425 "coders/mat.c" 3 4
              ((void *)0)
# 1425 "coders/mat.c"
                  ;
    if (quantum_info != (QuantumInfo *) 
# 1426 "coders/mat.c" 3 4
                                       ((void *)0)
# 1426 "coders/mat.c"
                                           )
      quantum_info=DestroyQuantumInfo(quantum_info);
...
# 1457 "coders/mat.c"
...

  {
    ...
    p=image;
    image=
# 1470 "coders/mat.c" 3 4
         ((void *)0)
# 1470 "coders/mat.c"
             ;
    while (p != (Image *) 
# 1471 "coders/mat.c" 3 4
                         ((void *)0)
# 1471 "coders/mat.c"
                             )
      {
...
# 1497 "coders/mat.c"
    ...
    clone_info = 
# 1501 "coders/mat.c" 3 4
                ((void *)0)
# 1501 "coders/mat.c"
                    ;
  }
  if (logging) (void)LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 1503,"return");
  if ((image != image2) && (image2 != (Image *) 
# 1504 "coders/mat.c" 3 4
                                               ((void *)0)
# 1504 "coders/mat.c"
                                                   ))
    image2=DestroyImage(image2);
  if (image == (Image *) 
# 1506 "coders/mat.c" 3 4
                        ((void *)0)
# 1506 "coders/mat.c"
                            )
    { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1507,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1507 "coders/mat.c" 3 4
   ((void *)0)
# 1507 "coders/mat.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1507 "coders/mat.c" 3 4
...
# 1534 "coders/mat.c"
__attribute__ ((visibility ("default"))) size_t RegisterMATImage(void)
{
  MagickInfo
    *entry;
...
# 1567 "coders/mat.c"
__attribute__ ((visibility ("default"))) void UnregisterMATImage(void)
{
...
# 1623 "coders/mat.c"
 "image_info != (const ImageInfo *) NULL"
# 1623 "coders/mat.c" 3 4
 , "coders/mat.c", 1623, __extension__ __PRETTY_FUNCTION__); }))
# 1623 "coders/mat.c"
                                               ;
  
# 1624 "coders/mat.c" 3 4
 ((void) sizeof ((
# 1624 "coders/mat.c"
 image_info->signature == 0xabacadabUL
# 1624 "coders/mat.c" 3 4
...
# 1624 "coders/mat.c"
 "image_info->signature == MagickCoreSignature"
# 1624 "coders/mat.c" 3 4
 , "coders/mat.c", 1624, __extension__ __PRETTY_FUNCTION__); }))
# 1624 "coders/mat.c"
                                                     ;
  
# 1625 "coders/mat.c" 3 4
 ((void) sizeof ((
# 1625 "coders/mat.c"
 image != (Image *) 
# 1625 "coders/mat.c" 3 4
...
# 1625 "coders/mat.c"
 "image != (Image *) NULL"
# 1625 "coders/mat.c" 3 4
 , "coders/mat.c", 1625, __extension__ __PRETTY_FUNCTION__); }))
# 1625 "coders/mat.c"
                                ;
  
# 1626 "coders/mat.c" 3 4
 ((void) sizeof ((
# 1626 "coders/mat.c"
...
# 1626 "coders/mat.c" 3 4
 , "coders/mat.c", 1626, __extension__ __PRETTY_FUNCTION__); }))
# 1626 "coders/mat.c"
                                                ;
  (void) LogMagickEvent(CoderEvent,"coders/mat.c",__func__,(unsigned long) 1627,"enter MAT");
  
# 1628 "coders/mat.c" 3 4
 ((void) sizeof ((
# 1628 "coders/mat.c"
 exception != (ExceptionInfo *) 
# 1628 "coders/mat.c" 3 4
...
# 1628 "coders/mat.c"
 "exception != (ExceptionInfo *) NULL"
# 1628 "coders/mat.c" 3 4
 , "coders/mat.c", 1628, __extension__ __PRETTY_FUNCTION__); }))
# 1628 "coders/mat.c"
                                            ;
  
# 1629 "coders/mat.c" 3 4
 ((void) sizeof ((
# 1629 "coders/mat.c"
 exception->signature == 0xabacadabUL
# 1629 "coders/mat.c" 3 4
...
# 1629 "coders/mat.c"
 "exception->signature == MagickCoreSignature"
# 1629 "coders/mat.c" 3 4
 , "coders/mat.c", 1629, __extension__ __PRETTY_FUNCTION__); }))
# 1629 "coders/mat.c"
                                                    ;
  ...
  (void) memset(MATLAB_HDR,' ',(((sizeof(MATLAB_HDR)) < (124)) ? (sizeof(MATLAB_HDR)) : (124)));
  ...
  do
  {
    ...
    quantum_info=AcquireQuantumInfo(image_info,image);
    if (quantum_info == (QuantumInfo *) 
# 1709 "coders/mat.c" 3 4
                                       ((void *)0)
# 1709 "coders/mat.c"
                                           )
      { (void) ThrowMagickException(exception,"coders/mat.c",__func__,(unsigned long) 1710,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1710 "coders/mat.c" 3 4
     ((void *)0)
# 1710 "coders/mat.c"
    ...
    do
    {
      ...
      for (y=0; y < (ssize_t) image->columns; y++)
      {
        ...
        if (p == (const Quantum *) 
# 1726 "coders/mat.c" 3 4
                                  ((void *)0)
# 1726 "coders/mat.c"
                                      )
          break;
        length=ExportQuantumPixels(image,(CacheView *) 
# 1728 "coders/mat.c" 3 4
                                                      ((void *)0)
# 1728 "coders/mat.c"
                                                          ,quantum_info,
