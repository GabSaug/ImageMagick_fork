...
# 204 "coders/ipl.c" 3 4
 , "coders/ipl.c", 204, __extension__ __PRETTY_FUNCTION__); }))
# 204 "coders/ipl.c"
                                               ;
  
# 205 "coders/ipl.c" 3 4
 ((void) sizeof ((
# 205 "coders/ipl.c"
...
# 205 "coders/ipl.c" 3 4
 , "coders/ipl.c", 205, __extension__ __PRETTY_FUNCTION__); }))
# 205 "coders/ipl.c"
                                                     ;
  
# 206 "coders/ipl.c" 3 4
 ((void) sizeof ((
# 206 "coders/ipl.c"
...
# 206 "coders/ipl.c" 3 4
 , "coders/ipl.c", 206, __extension__ __PRETTY_FUNCTION__); }))
# 206 "coders/ipl.c"
                                            ;
  
# 207 "coders/ipl.c" 3 4
 ((void) sizeof ((
# 207 "coders/ipl.c"
...
# 207 "coders/ipl.c" 3 4
 , "coders/ipl.c", 207, __extension__ __PRETTY_FUNCTION__); }))
# 207 "coders/ipl.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ipl.c",__func__,(unsigned long) 209,"%s",
      image_info->filename);
...
# 227 "coders/ipl.c"
  ...
  if (count != 4)
    { (void) ThrowMagickException(exception,"coders/ipl.c",__func__,(unsigned long) 229,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 229 "coders/ipl.c" 3 4
   ((void *)0)
# 229 "coders/ipl.c"
...
# 229 "coders/ipl.c"
  ...
  if((LocaleNCompare((char *) magick,"iiii",4) == 0))
    ...
    if((LocaleNCompare((char *) magick,"mmmm",4) == 0))
      ...
      { (void) ThrowMagickException(exception,"coders/ipl.c",__func__,(unsigned long) 236,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 236 "coders/ipl.c" 3 4
     ((void *)0)
# 236 "coders/ipl.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 236 "coders/ipl.c" 3 4
...
# 236 "coders/ipl.c"
  ...
  if((count != 4) || (LocaleNCompare((char *) magick,"data",4) != 0))
    { (void) ThrowMagickException(exception,"coders/ipl.c",__func__,(unsigned long) 246,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 246 "coders/ipl.c" 3 4
   ((void *)0)
# 246 "coders/ipl.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 246 "coders/ipl.c" 3 4
...
# 246 "coders/ipl.c"
  ...
  if((ipl_info.width == 0UL) || (ipl_info.height == 0UL))
    { (void) ThrowMagickException(exception,"coders/ipl.c",__func__,(unsigned long) 251,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 251 "coders/ipl.c" 3 4
   ((void *)0)
# 251 "coders/ipl.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 251 "coders/ipl.c" 3 4
...
# 251 "coders/ipl.c"
  ...
  if (extent > GetBlobSize(image))
    { (void) ThrowMagickException(exception,"coders/ipl.c",__func__,(unsigned long) 305,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 305 "coders/ipl.c" 3 4
   ((void *)0)
# 305 "coders/ipl.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 305 "coders/ipl.c" 3 4
...
# 335 "coders/ipl.c" 3 4
                                        ((void *)0)
# 335 "coders/ipl.c"
                                            )
       { (void) ThrowMagickException(exception,"coders/ipl.c",__func__,(unsigned long) 336,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 336 "coders/ipl.c" 3 4
      ((void *)0)
# 336 "coders/ipl.c"
      ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 336 "coders/ipl.c" 3 4
...
# 336 "coders/ipl.c"
     ...
     if (status == MagickFalse)
       { (void) ThrowMagickException(exception,"coders/ipl.c",__func__,(unsigned long) 339,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 339 "coders/ipl.c" 3 4
      ((void *)0)
# 339 "coders/ipl.c"
      ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 339 "coders/ipl.c" 3 4
...
# 339 "coders/ipl.c"
  ...
  if(ipl_info.colors == 1){
      for(y = 0; y < (ssize_t) image->rows; y++){
        ...
        if (q == (Quantum *) 
# 356 "coders/ipl.c" 3 4
                            ((void *)0)
# 356 "coders/ipl.c"
                                )
                break;
        (void) ImportQuantumPixels(image,(CacheView *) 
# 358 "coders/ipl.c" 3 4
                                                      ((void *)0)
# 358 "coders/ipl.c"
                                                          ,quantum_info,
      ...
      for(y = 0; y < (ssize_t) image->rows; y++){
        ...
        q=QueueAuthenticPixels(image,0,y,image->columns,1,exception);
        if (q == (Quantum *) 
# 368 "coders/ipl.c" 3 4
                            ((void *)0)
# 368 "coders/ipl.c"
                                )
                break;
        (void) ImportQuantumPixels(image,(CacheView *) 
# 370 "coders/ipl.c" 3 4
                                                      ((void *)0)
# 370 "coders/ipl.c"
                                                          ,quantum_info,
      ...
      for(y = 0; y < (ssize_t) image->rows; y++){
        ...
        q=QueueAuthenticPixels(image,0,y,image->columns,1,exception);
        if (q == (Quantum *) 
# 378 "coders/ipl.c" 3 4
                            ((void *)0)
# 378 "coders/ipl.c"
                                )
          break;
        (void) ImportQuantumPixels(image,(CacheView *) 
# 380 "coders/ipl.c" 3 4
                                                      ((void *)0)
# 380 "coders/ipl.c"
                                                          ,quantum_info,
      ...
      for(y = 0; y < (ssize_t) image->rows; y++){
        ...
        q=QueueAuthenticPixels(image,0,y,image->columns,1,exception);
        if (q == (Quantum *) 
# 388 "coders/ipl.c" 3 4
                            ((void *)0)
# 388 "coders/ipl.c"
                                )
          break;
        (void) ImportQuantumPixels(image,(CacheView *) 
# 390 "coders/ipl.c" 3 4
                                                      ((void *)0)
# 390 "coders/ipl.c"
                                                          ,quantum_info,
...
# 403 "coders/ipl.c" 3 4
     (*__errno_location ())
# 403 "coders/ipl.c"
     ); (void) ThrowMagickException(exception,"coders/ipl.c",__func__,(unsigned long) 403,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                 ;
      break;
    }
...
# 447 "coders/ipl.c"
__attribute__ ((visibility ("default"))) size_t RegisterIPLImage(void)
{
  MagickInfo
    *entry;
...
# 481 "coders/ipl.c"
__attribute__ ((visibility ("default"))) void UnregisterIPLImage(void)
{
...
# 543 "coders/ipl.c"
 "image_info != (const ImageInfo *) NULL"
# 543 "coders/ipl.c" 3 4
 , "coders/ipl.c", 543, __extension__ __PRETTY_FUNCTION__); }))
# 543 "coders/ipl.c"
                                               ;
  
# 544 "coders/ipl.c" 3 4
 ((void) sizeof ((
# 544 "coders/ipl.c"
 image_info->signature == 0xabacadabUL
# 544 "coders/ipl.c" 3 4
...
# 544 "coders/ipl.c"
 "image_info->signature == MagickCoreSignature"
# 544 "coders/ipl.c" 3 4
 , "coders/ipl.c", 544, __extension__ __PRETTY_FUNCTION__); }))
# 544 "coders/ipl.c"
                                                     ;
  
# 545 "coders/ipl.c" 3 4
 ((void) sizeof ((
# 545 "coders/ipl.c"
 image != (Image *) 
# 545 "coders/ipl.c" 3 4
...
# 545 "coders/ipl.c"
 "image != (Image *) NULL"
# 545 "coders/ipl.c" 3 4
 , "coders/ipl.c", 545, __extension__ __PRETTY_FUNCTION__); }))
# 545 "coders/ipl.c"
                                ;
  
# 546 "coders/ipl.c" 3 4
 ((void) sizeof ((
# 546 "coders/ipl.c"
...
# 546 "coders/ipl.c" 3 4
 , "coders/ipl.c", 546, __extension__ __PRETTY_FUNCTION__); }))
# 546 "coders/ipl.c"
                                                ;
  
# 547 "coders/ipl.c" 3 4
 ((void) sizeof ((
# 547 "coders/ipl.c"
 exception != (ExceptionInfo *) 
# 547 "coders/ipl.c" 3 4
...
# 547 "coders/ipl.c"
 "exception != (ExceptionInfo *) NULL"
# 547 "coders/ipl.c" 3 4
 , "coders/ipl.c", 547, __extension__ __PRETTY_FUNCTION__); }))
# 547 "coders/ipl.c"
                                            ;
  
# 548 "coders/ipl.c" 3 4
 ((void) sizeof ((
# 548 "coders/ipl.c"
 exception->signature == 0xabacadabUL
# 548 "coders/ipl.c" 3 4
...
# 548 "coders/ipl.c"
 "exception->signature == MagickCoreSignature"
# 548 "coders/ipl.c" 3 4
 , "coders/ipl.c", 548, __extension__ __PRETTY_FUNCTION__); }))
# 548 "coders/ipl.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ipl.c",__func__,(unsigned long) 550,"%s",image->filename);
  ...
  quantum_info=AcquireQuantumInfo(image_info,image);
  if (quantum_info == (QuantumInfo *) 
# 557 "coders/ipl.c" 3 4
                                     ((void *)0)
# 557 "coders/ipl.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/ipl.c",__func__,(unsigned long) 558,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 558 "coders/ipl.c" 3 4
   ((void *)0)
# 558 "coders/ipl.c"
...
# 613 "coders/ipl.c"
  ...
  for(y = 0; y < (ssize_t) ipl_info.height; y++){
    ...
    if (p == (const Quantum *) 
# 643 "coders/ipl.c" 3 4
                              ((void *)0)
# 643 "coders/ipl.c"
                                  )
      break;
    (void) ExportQuantumPixels(image,(CacheView *) 
# 645 "coders/ipl.c" 3 4
                                                  ((void *)0)
# 645 "coders/ipl.c"
                                                      , quantum_info,
      GrayQuantum, pixels,exception);
  ...
  for(y = 0; y < (ssize_t) ipl_info.height; y++){
    p=GetVirtualPixels(image,0,y,image->columns,1,exception);
    if (p == (const Quantum *) 
# 655 "coders/ipl.c" 3 4
                              ((void *)0)
# 655 "coders/ipl.c"
                                  )
      break;
    (void) ExportQuantumPixels(image,(CacheView *) 
# 657 "coders/ipl.c" 3 4
                                                  ((void *)0)
# 657 "coders/ipl.c"
                                                      , quantum_info,
      RedQuantum, pixels,exception);
    ...
    for(y = 0; y < (ssize_t) ipl_info.height; y++){
      p=GetVirtualPixels(image,0,y,image->columns,1,exception);
      if (p == (const Quantum *) 
# 665 "coders/ipl.c" 3 4
                                ((void *)0)
# 665 "coders/ipl.c"
                                    )
        break;
      (void) ExportQuantumPixels(image,(CacheView *) 
# 667 "coders/ipl.c" 3 4
                                                    ((void *)0)
# 667 "coders/ipl.c"
                                                        , quantum_info,
        GreenQuantum, pixels,exception);
    ...
    for(y = 0; y < (ssize_t) ipl_info.height; y++){
      p=GetVirtualPixels(image,0,y,image->columns,1,exception);
      if (p == (const Quantum *) 
# 674 "coders/ipl.c" 3 4
                                ((void *)0)
# 674 "coders/ipl.c"
                                    )
        break;
      (void) ExportQuantumPixels(image,(CacheView *) 
# 676 "coders/ipl.c" 3 4
                                                    ((void *)0)
# 676 "coders/ipl.c"
                                                        , quantum_info,
        BlueQuantum, pixels,exception);
