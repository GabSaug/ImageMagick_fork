...
# 142 "coders/cube.c" 3 4
 , "coders/cube.c", 142, __extension__ __PRETTY_FUNCTION__); }))
# 142 "coders/cube.c"
                                               ;
  
# 143 "coders/cube.c" 3 4
 ((void) sizeof ((
# 143 "coders/cube.c"
...
# 143 "coders/cube.c" 3 4
 , "coders/cube.c", 143, __extension__ __PRETTY_FUNCTION__); }))
# 143 "coders/cube.c"
                                                     ;
  
# 144 "coders/cube.c" 3 4
 ((void) sizeof ((
# 144 "coders/cube.c"
...
# 144 "coders/cube.c" 3 4
 , "coders/cube.c", 144, __extension__ __PRETTY_FUNCTION__); }))
# 144 "coders/cube.c"
                                            ;
  
# 145 "coders/cube.c" 3 4
 ((void) sizeof ((
# 145 "coders/cube.c"
...
# 145 "coders/cube.c" 3 4
 , "coders/cube.c", 145, __extension__ __PRETTY_FUNCTION__); }))
# 145 "coders/cube.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/cube.c",__func__,(unsigned long) 147,"%s",
      image_info->filename);
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 154 "coders/cube.c" 3 4
                      ((void *)0)
# 154 "coders/cube.c"
                          );
    }
  cube_level=0;
  cube_info=(MemoryInfo *) 
# 157 "coders/cube.c" 3 4
                          ((void *)0)
# 157 "coders/cube.c"
                              ;
  cube=(CubePixel *) 
# 158 "coders/cube.c" 3 4
                    ((void *)0)
# 158 "coders/cube.c"
                        ;
  n=0;
...
# 163 "coders/cube.c"
                                                )
  {
    ...
    if (((LocaleCompare(token,"LUT_1D_SIZE") == 0) ||
        ...
        (cube_info == (MemoryInfo *) 
# 174 "coders/cube.c" 3 4
                                    ((void *)0)
# 174 "coders/cube.c"
                                        ))
      {
        (void) GetNextToken(q,&q,4096,value);
        ...
        if ((cube_level < 2) || (cube_level > 256))
          {
            ...
            { (void) ThrowMagickException(exception,"coders/cube.c",__func__,(unsigned long) 183,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 183 "coders/cube.c" 3 4
           ((void *)0)
# 183 "coders/cube.c"
...
# 183 "coders/cube.c"
        ...
        cube_info=AcquireVirtualMemory(cube_level*cube_level,cube_level*
          sizeof(*cube));
        if (cube_info == (MemoryInfo *) 
# 187 "coders/cube.c" 3 4
                                       ((void *)0)
# 187 "coders/cube.c"
                                           )
          {
            buffer=DestroyString(buffer);
            { (void) ThrowMagickException(exception,"coders/cube.c",__func__,(unsigned long) 190,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 190 "coders/cube.c" 3 4
           ((void *)0)
# 190 "coders/cube.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 190 "coders/cube.c" 3 4
...
# 190 "coders/cube.c"
  ...
  if (cube_level == 0)
    {
      if (cube_info != (MemoryInfo *) 
# 222 "coders/cube.c" 3 4
                                     ((void *)0)
# 222 "coders/cube.c"
                                         )
        cube_info=RelinquishVirtualMemory(cube_info);
      { (void) ThrowMagickException(exception,"coders/cube.c",__func__,(unsigned long) 224,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 224 "coders/cube.c" 3 4
     ((void *)0)
# 224 "coders/cube.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 224 "coders/cube.c" 3 4
...
# 262 "coders/cube.c"
      ...
      for (r=0; r < (ssize_t) (hald_level*hald_level); r++)
      {
        ...
        if ((size_t) index.b == (cube_level-1))
          next.b=index.b;
        SetPixelRed(image,ClampToQuantum(((Quantum) 65535.0)*(
          cube[((ssize_t) ((index.b)*(cube_level)*(cube_level)+(index.g)*(cube_level)+(index.r)))].r+scale.r*(
          cube[((ssize_t) ((index.b)*(cube_level)*(cube_level)+(index.g)*(cube_level)+(next.r)))].r-
          cube[((ssize_t) ((index.b)*(cube_level)*(cube_level)+(index.g)*(cube_level)+(index.r)))].r))),q);
        SetPixelGreen(image,ClampToQuantum(((Quantum) 65535.0)*(
          cube[((ssize_t) ((index.b)*(cube_level)*(cube_level)+(index.g)*(cube_level)+(index.r)))].g+scale.g*(
          cube[((ssize_t) ((index.b)*(cube_level)*(cube_level)+(next.g)*(cube_level)+(index.r)))].g-
          cube[((ssize_t) ((index.b)*(cube_level)*(cube_level)+(index.g)*(cube_level)+(index.r)))].g))),q);
        SetPixelBlue(image,ClampToQuantum(((Quantum) 65535.0)*(
          cube[((ssize_t) ((index.b)*(cube_level)*(cube_level)+(index.g)*(cube_level)+(index.r)))].b+scale.b*(
          cube[((ssize_t) ((next.b)*(cube_level)*(cube_level)+(index.g)*(cube_level)+(index.r)))].b-
          cube[((ssize_t) ((index.b)*(cube_level)*(cube_level)+(index.g)*(cube_level)+(index.r)))].b))),q);
...
# 348 "coders/cube.c"
__attribute__ ((visibility ("default"))) size_t RegisterCUBEImage(void)
{
  MagickInfo
    *entry;
...
# 382 "coders/cube.c"
__attribute__ ((visibility ("default"))) void UnregisterCUBEImage(void)
{
