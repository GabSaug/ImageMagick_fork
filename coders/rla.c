...
# 193 "coders/rla.c" 3 4
 , "coders/rla.c", 193, __extension__ __PRETTY_FUNCTION__); }))
# 193 "coders/rla.c"
                                               ;
  
# 194 "coders/rla.c" 3 4
 ((void) sizeof ((
# 194 "coders/rla.c"
...
# 194 "coders/rla.c" 3 4
 , "coders/rla.c", 194, __extension__ __PRETTY_FUNCTION__); }))
# 194 "coders/rla.c"
                                                     ;
  
# 195 "coders/rla.c" 3 4
 ((void) sizeof ((
# 195 "coders/rla.c"
...
# 195 "coders/rla.c" 3 4
 , "coders/rla.c", 195, __extension__ __PRETTY_FUNCTION__); }))
# 195 "coders/rla.c"
                                            ;
  
# 196 "coders/rla.c" 3 4
 ((void) sizeof ((
# 196 "coders/rla.c"
...
# 196 "coders/rla.c" 3 4
 , "coders/rla.c", 196, __extension__ __PRETTY_FUNCTION__); }))
# 196 "coders/rla.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/rla.c",__func__,(unsigned long) 198,"%s",
      image_info->filename);
...
# 205 "coders/rla.c"
  ...
  if (rla_info.number_channels < 0)
    { (void) ThrowMagickException(exception,"coders/rla.c",__func__,(unsigned long) 220,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 220 "coders/rla.c" 3 4
   ((void *)0)
# 220 "coders/rla.c"
...
# 220 "coders/rla.c"
  ...
  if (rla_info.number_matte_channels < 0)
    { (void) ThrowMagickException(exception,"coders/rla.c",__func__,(unsigned long) 223,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 223 "coders/rla.c" 3 4
   ((void *)0)
# 223 "coders/rla.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 223 "coders/rla.c" 3 4
...
# 223 "coders/rla.c"
  ...
  if ((rla_info.number_channels > 3) || (rla_info.number_matte_channels > 3))
    { (void) ThrowMagickException(exception,"coders/rla.c",__func__,(unsigned long) 225,CoderError,"Unsupported number of channels", "`%s'",image_info->filename); if ((image) != (Image *) 
# 225 "coders/rla.c" 3 4
   ((void *)0)
# 225 "coders/rla.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 225 "coders/rla.c" 3 4
...
# 225 "coders/rla.c"
  ...
  if ((size_t) count != 36)
    { (void) ThrowMagickException(exception,"coders/rla.c",__func__,(unsigned long) 258,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 258 "coders/rla.c" 3 4
   ((void *)0)
# 258 "coders/rla.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 258 "coders/rla.c" 3 4
...
# 258 "coders/rla.c"
  ...
  scanlines=(MagickOffsetType *) AcquireQuantumMemory(image->rows,
    sizeof(*scanlines));
  if (scanlines == (MagickOffsetType *) 
# 279 "coders/rla.c" 3 4
                                       ((void *)0)
# 279 "coders/rla.c"
                                           )
    { (void) ThrowMagickException(exception,"coders/rla.c",__func__,(unsigned long) 280,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 280 "coders/rla.c" 3 4
   ((void *)0)
# 280 "coders/rla.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 280 "coders/rla.c" 3 4
  ...
  if (EOFBlob(image) != MagickFalse)
    {
      ...
      { (void) ThrowMagickException(exception,"coders/rla.c",__func__,(unsigned long) 291,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 291 "coders/rla.c" 3 4
     ((void *)0)
# 291 "coders/rla.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 291 "coders/rla.c" 3 4
...
# 291 "coders/rla.c"
  ...
  {
    offset=SeekBlob(image,scanlines[(ssize_t) image->rows-y-1],
# 298 "coders/rla.c" 3 4
                                                              0
# 298 "coders/rla.c"
                                                                      );
    if (offset < 0)
      {
        scanlines=(MagickOffsetType *) RelinquishMagickMemory(scanlines);
        { (void) ThrowMagickException(exception,"coders/rla.c",__func__,(unsigned long) 302,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 302 "coders/rla.c" 3 4
       ((void *)0)
# 302 "coders/rla.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 302 "coders/rla.c" 3 4
...
# 365 "coders/rla.c"
    ...
    if ((x/(ssize_t) rla_info.number_channels) > (ssize_t) image->columns)
      {
        scanlines=(MagickOffsetType *) RelinquishMagickMemory(scanlines);
        { (void) ThrowMagickException(exception,"coders/rla.c",__func__,(unsigned long) 402,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 402 "coders/rla.c" 3 4
       ((void *)0)
# 402 "coders/rla.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 402 "coders/rla.c" 3 4
...
# 413 "coders/rla.c" 3 4
   (*__errno_location ())
# 413 "coders/rla.c"
   ); (void) ThrowMagickException(exception,"coders/rla.c",__func__,(unsigned long) 413,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 445 "coders/rla.c"
__attribute__ ((visibility ("default"))) size_t RegisterRLAImage(void)
{
  MagickInfo
    *entry;
...
# 477 "coders/rla.c"
__attribute__ ((visibility ("default"))) void UnregisterRLAImage(void)
{
