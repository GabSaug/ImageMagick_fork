...
# 219 "coders/xbm.c" 3 4
 , "coders/xbm.c", 219, __extension__ __PRETTY_FUNCTION__); }))
# 219 "coders/xbm.c"
                                               ;
  
# 220 "coders/xbm.c" 3 4
 ((void) sizeof ((
# 220 "coders/xbm.c"
...
# 220 "coders/xbm.c" 3 4
 , "coders/xbm.c", 220, __extension__ __PRETTY_FUNCTION__); }))
# 220 "coders/xbm.c"
                                                     ;
  
# 221 "coders/xbm.c" 3 4
 ((void) sizeof ((
# 221 "coders/xbm.c"
...
# 221 "coders/xbm.c" 3 4
 , "coders/xbm.c", 221, __extension__ __PRETTY_FUNCTION__); }))
# 221 "coders/xbm.c"
                                            ;
  
# 222 "coders/xbm.c" 3 4
 ((void) sizeof ((
# 222 "coders/xbm.c"
...
# 222 "coders/xbm.c" 3 4
 , "coders/xbm.c", 222, __extension__ __PRETTY_FUNCTION__); }))
# 222 "coders/xbm.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/xbm.c",__func__,(unsigned long) 224,"%s",
      image_info->filename);
...
# 231 "coders/xbm.c"
  ...
  height=0;
  *name='\0';
  while (ReadBlobString(image,buffer) != (char *) 
# 239 "coders/xbm.c" 3 4
                                                 ((void *)0)
# 239 "coders/xbm.c"
                                                     )
...
# 244 "coders/xbm.c"
  ...
  if ((width <= 0) || (height <= 0) || (EOFBlob(image) != MagickFalse))
    { (void) ThrowMagickException(exception,"coders/xbm.c",__func__,(unsigned long) 250,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 250 "coders/xbm.c" 3 4
   ((void *)0)
# 250 "coders/xbm.c"
...
# 282 "coders/xbm.c" 3 4
                                    ((void *)0)
# 282 "coders/xbm.c"
                                        )
    (void) SeekBlob(image,offset+(strchr(buffer,'{')-buffer)+1,
# 283 "coders/xbm.c" 3 4
                                                              0
# 283 "coders/xbm.c"
                                                                      );
  ...
  if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/xbm.c",__func__,(unsigned long) 288,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 288 "coders/xbm.c" 3 4
   ((void *)0)
# 288 "coders/xbm.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 288 "coders/xbm.c" 3 4
...
# 288 "coders/xbm.c"
  ...
  image->colormap[0].red=(MagickRealType) ((Quantum) 65535.0);
  image->colormap[0].green=(MagickRealType) ((Quantum) 65535.0);
  image->colormap[0].blue=(MagickRealType) ((Quantum) 65535.0);
...
# 350 "coders/xbm.c" 3 4
                               ((void *)0)
# 350 "coders/xbm.c"
                                   )
    { (void) ThrowMagickException(exception,"coders/xbm.c",__func__,(unsigned long) 351,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 351 "coders/xbm.c" 3 4
   ((void *)0)
# 351 "coders/xbm.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 351 "coders/xbm.c" 3 4
      ...
      if (c < 0)
        {
          ...
          { (void) ThrowMagickException(exception,"coders/xbm.c",__func__,(unsigned long) 360,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 360 "coders/xbm.c" 3 4
         ((void *)0)
# 360 "coders/xbm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 360 "coders/xbm.c" 3 4
...
# 360 "coders/xbm.c"
    ...
    for (i=0; i < (ssize_t) (bytes_per_line*image->rows); i++)
    {
      ...
      if (c < 0)
        {
          data=(unsigned char *) RelinquishMagickMemory(data);
          { (void) ThrowMagickException(exception,"coders/xbm.c",__func__,(unsigned long) 373,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 373 "coders/xbm.c" 3 4
         ((void *)0)
# 373 "coders/xbm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 373 "coders/xbm.c" 3 4
...
# 373 "coders/xbm.c"
  ...
  if (EOFBlob(image) != MagickFalse)
    {
      data=(unsigned char *) RelinquishMagickMemory(data);
      { (void) ThrowMagickException(exception,"coders/xbm.c",__func__,(unsigned long) 380,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 380 "coders/xbm.c" 3 4
     ((void *)0)
# 380 "coders/xbm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 380 "coders/xbm.c" 3 4
...
# 443 "coders/xbm.c"
__attribute__ ((visibility ("default"))) size_t RegisterXBMImage(void)
{
  MagickInfo
    *entry;
...
# 478 "coders/xbm.c"
__attribute__ ((visibility ("default"))) void UnregisterXBMImage(void)
{
...
# 537 "coders/xbm.c"
 "image_info != (const ImageInfo *) NULL"
# 537 "coders/xbm.c" 3 4
 , "coders/xbm.c", 537, __extension__ __PRETTY_FUNCTION__); }))
# 537 "coders/xbm.c"
                                               ;
  
# 538 "coders/xbm.c" 3 4
 ((void) sizeof ((
# 538 "coders/xbm.c"
 image_info->signature == 0xabacadabUL
# 538 "coders/xbm.c" 3 4
...
# 538 "coders/xbm.c"
 "image_info->signature == MagickCoreSignature"
# 538 "coders/xbm.c" 3 4
 , "coders/xbm.c", 538, __extension__ __PRETTY_FUNCTION__); }))
# 538 "coders/xbm.c"
                                                     ;
  
# 539 "coders/xbm.c" 3 4
 ((void) sizeof ((
# 539 "coders/xbm.c"
 image != (Image *) 
# 539 "coders/xbm.c" 3 4
...
# 539 "coders/xbm.c"
 "image != (Image *) NULL"
# 539 "coders/xbm.c" 3 4
 , "coders/xbm.c", 539, __extension__ __PRETTY_FUNCTION__); }))
# 539 "coders/xbm.c"
                                ;
  
# 540 "coders/xbm.c" 3 4
 ((void) sizeof ((
# 540 "coders/xbm.c"
...
# 540 "coders/xbm.c" 3 4
 , "coders/xbm.c", 540, __extension__ __PRETTY_FUNCTION__); }))
# 540 "coders/xbm.c"
                                                ;
  
# 541 "coders/xbm.c" 3 4
 ((void) sizeof ((
# 541 "coders/xbm.c"
 exception != (ExceptionInfo *) 
# 541 "coders/xbm.c" 3 4
...
# 541 "coders/xbm.c"
 "exception != (ExceptionInfo *) NULL"
# 541 "coders/xbm.c" 3 4
 , "coders/xbm.c", 541, __extension__ __PRETTY_FUNCTION__); }))
# 541 "coders/xbm.c"
                                            ;
  
# 542 "coders/xbm.c" 3 4
 ((void) sizeof ((
# 542 "coders/xbm.c"
 exception->signature == 0xabacadabUL
# 542 "coders/xbm.c" 3 4
...
# 542 "coders/xbm.c"
 "exception->signature == MagickCoreSignature"
# 542 "coders/xbm.c" 3 4
 , "coders/xbm.c", 542, __extension__ __PRETTY_FUNCTION__); }))
# 542 "coders/xbm.c"
                                                    ;
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/xbm.c",__func__,(unsigned long) 544,"%s",image->filename);
...
# 579 "coders/xbm.c"
    ...
    {
      byte>>=1;
      if (GetPixelLuma(image,p) < ((double) ((Quantum) 65535.0)/2))
        byte|=0x80;
      bit++;
      if (bit == 8)
        {
          ...
          (void) FormatLocaleString(buffer,4096,"0x%02X, ",
