...
# 182 "coders/cals.c" 3 4
 , "coders/cals.c", 182, __extension__ __PRETTY_FUNCTION__); }))
# 182 "coders/cals.c"
                                               ;
  
# 183 "coders/cals.c" 3 4
 ((void) sizeof ((
# 183 "coders/cals.c"
...
# 183 "coders/cals.c" 3 4
 , "coders/cals.c", 183, __extension__ __PRETTY_FUNCTION__); }))
# 183 "coders/cals.c"
                                                     ;
  
# 184 "coders/cals.c" 3 4
 ((void) sizeof ((
# 184 "coders/cals.c"
...
# 184 "coders/cals.c" 3 4
 , "coders/cals.c", 184, __extension__ __PRETTY_FUNCTION__); }))
# 184 "coders/cals.c"
                                            ;
  
# 185 "coders/cals.c" 3 4
 ((void) sizeof ((
# 185 "coders/cals.c"
...
# 185 "coders/cals.c" 3 4
 , "coders/cals.c", 185, __extension__ __PRETTY_FUNCTION__); }))
# 185 "coders/cals.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/cals.c",__func__,(unsigned long) 187,"%s",
      image_info->filename);
...
# 257 "coders/cals.c" 3 4
                                              ((void *)0)
# 257 "coders/cals.c"
                                                  ))
    { (void) ThrowMagickException(exception,"coders/cals.c",__func__,(unsigned long) 258,FileOpenError,"UnableToCreateTemporaryFile", "`%s'",image->filename); return((Image *) 
# 258 "coders/cals.c" 3 4
   ((void *)0)
# 258 "coders/cals.c"
   ); };
  while ((c=ReadBlobByte(image)) != 
# 259 "coders/cals.c" 3 4
                                   (-1)
# 259 "coders/cals.c"
                                      )
    if (fputc(c,file) != c)
...
# 275 "coders/cals.c"
                            )
    {
      ...
      (void) CopyMagickString(image->magick_filename,image_info->filename,
        4096);
      (void) CopyMagickString(image->magick,"CALS",4096);
    }
...
# 311 "coders/cals.c"
__attribute__ ((visibility ("default"))) size_t RegisterCALSImage(void)
{
  ...
  entry=AcquireMagickInfo("CALS","CAL","Continuous Acquisition and Life-cycle Support Type 1");
  ...
  entry->note=ConstantString("Specified in MIL-R-28002 and MIL-PRF-28002");
  (void) RegisterMagickInfo(entry);
  entry=AcquireMagickInfo("CALS","CALS","Continuous Acquisition and Life-cycle Support Type 1");
  entry->decoder=(DecodeImageHandler *) ReadCALSImage;
...
# 359 "coders/cals.c"
__attribute__ ((visibility ("default"))) void UnregisterCALSImage(void)
{
