...
# 121 "coders/pix.c" 3 4
 , "coders/pix.c", 121, __extension__ __PRETTY_FUNCTION__); }))
# 121 "coders/pix.c"
                                               ;
  
# 122 "coders/pix.c" 3 4
 ((void) sizeof ((
# 122 "coders/pix.c"
...
# 122 "coders/pix.c" 3 4
 , "coders/pix.c", 122, __extension__ __PRETTY_FUNCTION__); }))
# 122 "coders/pix.c"
                                                     ;
  
# 123 "coders/pix.c" 3 4
 ((void) sizeof ((
# 123 "coders/pix.c"
...
# 123 "coders/pix.c" 3 4
 , "coders/pix.c", 123, __extension__ __PRETTY_FUNCTION__); }))
# 123 "coders/pix.c"
                                            ;
  
# 124 "coders/pix.c" 3 4
 ((void) sizeof ((
# 124 "coders/pix.c"
...
# 124 "coders/pix.c" 3 4
 , "coders/pix.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "coders/pix.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pix.c",__func__,(unsigned long) 126,"%s",
      image_info->filename);
...
# 133 "coders/pix.c"
  ...
  if ((width == 0UL) || (height == 0UL) || ((bits_per_pixel != 8) &&
      (bits_per_pixel != 24)))
    { (void) ThrowMagickException(exception,"coders/pix.c",__func__,(unsigned long) 145,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 145 "coders/pix.c" 3 4
   ((void *)0)
# 145 "coders/pix.c"
  ...
  do
  {
    ...
    if (bits_per_pixel == 8)
      if (AcquireImageColormap(image,256,exception) == MagickFalse)
        { (void) ThrowMagickException(exception,"coders/pix.c",__func__,(unsigned long) 155,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 155 "coders/pix.c" 3 4
       ((void *)0)
# 155 "coders/pix.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 155 "coders/pix.c" 3 4
...
# 222 "coders/pix.c" 3 4
       (*__errno_location ())
# 222 "coders/pix.c"
       ); (void) ThrowMagickException(exception,"coders/pix.c",__func__,(unsigned long) 222,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 287 "coders/pix.c"
__attribute__ ((visibility ("default"))) size_t RegisterPIXImage(void)
{
  MagickInfo
    *entry;
...
# 317 "coders/pix.c"
__attribute__ ((visibility ("default"))) void UnregisterPIXImage(void)
{
