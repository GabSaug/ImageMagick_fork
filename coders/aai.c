...
# 128 "coders/aai.c" 3 4
 , "coders/aai.c", 128, __extension__ __PRETTY_FUNCTION__); }))
# 128 "coders/aai.c"
                                               ;
  
# 129 "coders/aai.c" 3 4
 ((void) sizeof ((
# 129 "coders/aai.c"
...
# 129 "coders/aai.c" 3 4
 , "coders/aai.c", 129, __extension__ __PRETTY_FUNCTION__); }))
# 129 "coders/aai.c"
                                                     ;
  
# 130 "coders/aai.c" 3 4
 ((void) sizeof ((
# 130 "coders/aai.c"
...
# 130 "coders/aai.c" 3 4
 , "coders/aai.c", 130, __extension__ __PRETTY_FUNCTION__); }))
# 130 "coders/aai.c"
                                            ;
  
# 131 "coders/aai.c" 3 4
 ((void) sizeof ((
# 131 "coders/aai.c"
...
# 131 "coders/aai.c" 3 4
 , "coders/aai.c", 131, __extension__ __PRETTY_FUNCTION__); }))
# 131 "coders/aai.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/aai.c",__func__,(unsigned long) 133,"%s",
      image_info->filename);
...
# 140 "coders/aai.c"
  ...
  if (EOFBlob(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/aai.c",__func__,(unsigned long) 148,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 148 "coders/aai.c" 3 4
   ((void *)0)
# 148 "coders/aai.c"
...
# 148 "coders/aai.c"
  ...
  if ((width == 0UL) || (height == 0UL))
    { (void) ThrowMagickException(exception,"coders/aai.c",__func__,(unsigned long) 150,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 150 "coders/aai.c" 3 4
   ((void *)0)
# 150 "coders/aai.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 150 "coders/aai.c" 3 4
...
# 167 "coders/aai.c" 3 4
                                   ((void *)0)
# 167 "coders/aai.c"
                                       )
      { (void) ThrowMagickException(exception,"coders/aai.c",__func__,(unsigned long) 168,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 168 "coders/aai.c" 3 4
     ((void *)0)
# 168 "coders/aai.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 168 "coders/aai.c" 3 4
      ...
      if (count != (ssize_t) length)
        {
          ...
          { (void) ThrowMagickException(exception,"coders/aai.c",__func__,(unsigned long) 176,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 176 "coders/aai.c" 3 4
         ((void *)0)
# 176 "coders/aai.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 176 "coders/aai.c" 3 4
...
# 180 "coders/aai.c"
      ...
      for (x=0; x < (ssize_t) image->columns; x++)
      {
        ...
        if (GetPixelAlpha(image,q) != ((Quantum) ((Quantum) 65535.0)))
...
# 207 "coders/aai.c" 3 4
       (*__errno_location ())
# 207 "coders/aai.c"
       ); (void) ThrowMagickException(exception,"coders/aai.c",__func__,(unsigned long) 207,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 266 "coders/aai.c"
__attribute__ ((visibility ("default"))) size_t RegisterAAIImage(void)
{
  MagickInfo
    *entry;
...
# 297 "coders/aai.c"
__attribute__ ((visibility ("default"))) void UnregisterAAIImage(void)
{
...
# 356 "coders/aai.c"
 "image_info != (const ImageInfo *) NULL"
# 356 "coders/aai.c" 3 4
 , "coders/aai.c", 356, __extension__ __PRETTY_FUNCTION__); }))
# 356 "coders/aai.c"
                                               ;
  
# 357 "coders/aai.c" 3 4
 ((void) sizeof ((
# 357 "coders/aai.c"
 image_info->signature == 0xabacadabUL
# 357 "coders/aai.c" 3 4
...
# 357 "coders/aai.c"
 "image_info->signature == MagickCoreSignature"
# 357 "coders/aai.c" 3 4
 , "coders/aai.c", 357, __extension__ __PRETTY_FUNCTION__); }))
# 357 "coders/aai.c"
                                                     ;
  
# 358 "coders/aai.c" 3 4
 ((void) sizeof ((
# 358 "coders/aai.c"
 image != (Image *) 
# 358 "coders/aai.c" 3 4
...
# 358 "coders/aai.c"
 "image != (Image *) NULL"
# 358 "coders/aai.c" 3 4
 , "coders/aai.c", 358, __extension__ __PRETTY_FUNCTION__); }))
# 358 "coders/aai.c"
                                ;
  
# 359 "coders/aai.c" 3 4
 ((void) sizeof ((
# 359 "coders/aai.c"
...
# 359 "coders/aai.c" 3 4
 , "coders/aai.c", 359, __extension__ __PRETTY_FUNCTION__); }))
# 359 "coders/aai.c"
                                                ;
  
# 360 "coders/aai.c" 3 4
 ((void) sizeof ((
# 360 "coders/aai.c"
 exception != (ExceptionInfo *) 
# 360 "coders/aai.c" 3 4
...
# 360 "coders/aai.c"
 "exception != (ExceptionInfo *) NULL"
# 360 "coders/aai.c" 3 4
 , "coders/aai.c", 360, __extension__ __PRETTY_FUNCTION__); }))
# 360 "coders/aai.c"
                                            ;
  
# 361 "coders/aai.c" 3 4
 ((void) sizeof ((
# 361 "coders/aai.c"
 exception->signature == 0xabacadabUL
# 361 "coders/aai.c" 3 4
...
# 361 "coders/aai.c"
 "exception->signature == MagickCoreSignature"
# 361 "coders/aai.c" 3 4
 , "coders/aai.c", 361, __extension__ __PRETTY_FUNCTION__); }))
# 361 "coders/aai.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/aai.c",__func__,(unsigned long) 363,"%s",image->filename);
  ...
  do
  {
    ...
    pixels=(unsigned char *) AcquireQuantumMemory(image->columns,
      4*sizeof(*pixels));
    if (pixels == (unsigned char *) 
# 383 "coders/aai.c" 3 4
                                   ((void *)0)
# 383 "coders/aai.c"
                                       )
      { (void) ThrowMagickException(exception,"coders/aai.c",__func__,(unsigned long) 384,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 384 "coders/aai.c" 3 4
     ((void *)0)
# 384 "coders/aai.c"
...
# 391 "coders/aai.c"
      ...
      for (x=0; x < (ssize_t) image->columns; x++)
      {
        ...
        *q=ScaleQuantumToChar((Quantum) (image->alpha_trait !=
          UndefinedPixelTrait ? GetPixelAlpha(image,p) : ((Quantum) ((Quantum) 65535.0))));
        if (*q == 255)
          *q=254;
