...
# 143 "coders/caption.c" 3 4
 ((void) sizeof ((
# 143 "coders/caption.c"
...
# 143 "coders/caption.c" 3 4
 , "coders/caption.c", 143, __extension__ __PRETTY_FUNCTION__); }))
# 143 "coders/caption.c"
                                               ;
  
# 144 "coders/caption.c" 3 4
 ((void) sizeof ((
# 144 "coders/caption.c"
...
# 144 "coders/caption.c" 3 4
 , "coders/caption.c", 144, __extension__ __PRETTY_FUNCTION__); }))
# 144 "coders/caption.c"
                                                     ;
  
# 145 "coders/caption.c" 3 4
 ((void) sizeof ((
# 145 "coders/caption.c"
...
# 145 "coders/caption.c" 3 4
 , "coders/caption.c", 145, __extension__ __PRETTY_FUNCTION__); }))
# 145 "coders/caption.c"
                                            ;
  
# 146 "coders/caption.c" 3 4
 ((void) sizeof ((
# 146 "coders/caption.c"
...
# 146 "coders/caption.c" 3 4
 , "coders/caption.c", 146, __extension__ __PRETTY_FUNCTION__); }))
# 146 "coders/caption.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/caption.c",__func__,(unsigned long) 148,"%s",
      image_info->filename);
...
# 158 "coders/caption.c" 3 4
                              ((void *)0)
# 158 "coders/caption.c"
                                  )
  ...
  if (AcquireMagickResource(WidthResource,width) == MagickFalse)
    {
      ...
      { (void) ThrowMagickException(exception,"coders/caption.c",__func__,(unsigned long) 177,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image_info->filename); if ((image) != (Image *) 
# 177 "coders/caption.c" 3 4
     ((void *)0)
# 177 "coders/caption.c"
...
# 177 "coders/caption.c"
  ...
  if (gravity != (char *) 
# 181 "coders/caption.c" 3 4
                         ((void *)0)
# 181 "coders/caption.c"
                             )
  ...
  if (image->columns == 0)
    {
      ...
      (void) FormatLocaleString(geometry,4096,"%+g%+g",
  ...
  if (SetImageBackgroundColor(image,exception) == MagickFalse)
    {
      ...
      return((Image *) 
# 232 "coders/caption.c" 3 4
                      ((void *)0)
# 232 "coders/caption.c"
                          );
    }
  if ((fabs(image_info->pointsize) < 1.0e-12) && (strlen(caption) > 0))
    {
      double
        high,
        low;
      ...
      if (option != (const char*) 
# 248 "coders/caption.c" 3 4
                                 ((void *)0)
# 248 "coders/caption.c"
                                     )
        {
          high=StringToDouble(option,(char**) 
# 250 "coders/caption.c" 3 4
                                             ((void *)0)
# 250 "coders/caption.c"
                                                 );
          if (high < 1.0)
            high=1.0;
          high+=1.0;
      ...
      else
        {
          ...
          if (option != (const char *) 
# 258 "coders/caption.c" 3 4
                                      ((void *)0)
# 258 "coders/caption.c"
                                          )
            {
              draw_info->pointsize=StringToDouble(option,(char**) 
# 260 "coders/caption.c" 3 4
                                                                 ((void *)0)
# 260 "coders/caption.c"
                                                                     );
  ...
  (void) FormatLocaleString(geometry,4096,"%+g%+g",
    ...
    (((metrics.ascent) > (metrics.bounds.y2)) ? (metrics.ascent) : (metrics.bounds.y2)) : 0.0));
  (void) CloneString(&draw_info->geometry,geometry);
  ...
  if (status == MagickFalse)
    {
      image=DestroyImageList(image);
      return((Image *) 
# 363 "coders/caption.c" 3 4
                      ((void *)0)
# 363 "coders/caption.c"
                          );
    }
  return(GetFirstImageInList(image));
}
# 391 "coders/caption.c"
__attribute__ ((visibility ("default"))) size_t RegisterCAPTIONImage(void)
{
  MagickInfo
    *entry;
...
# 422 "coders/caption.c"
__attribute__ ((visibility ("default"))) void UnregisterCAPTIONImage(void)
{
