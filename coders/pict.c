...
static const PICTCode
  codes[] =
  {
               { "NOP", 0, "nop" },
               { "ClipRgn", 0, "clip" },
               { "BkPat", 8, "background pattern" },
               { "TxFont", 2, "text font (word)" },
               { "TxFace", 1, "text face (byte)" },
               { "TxMode", 2, "text mode (word)" },
               { "SpExtra", 4, "space extra (fixed point)" },
               { "PnSize", 4, "pen size (point)" },
               { "PnMode", 2, "pen mode (word)" },
               { "PnPat", 8, "pen pattern" },
               { "FillPat", 8, "fill pattern" },
               { "OvSize", 4, "oval size (point)" },
               { "Origin", 4, "dh, dv (word)" },
               { "TxSize", 2, "text size (word)" },
               { "FgColor", 4, "foreground color (ssize_tword)" },
               { "BkColor", 4, "background color (ssize_tword)" },
               { "TxRatio", 8, "numerator (point), denominator (point)" },
               { "Version", 1, "version (byte)" },
               { "BkPixPat", 0, "color background pattern" },
               { "PnPixPat", 0, "color pen pattern" },
               { "FillPixPat", 0, "color fill pattern" },
               { "PnLocHFrac", 2, "fractional pen position" },
               { "ChExtra", 2, "extra for each character" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "RGBFgCol", 6, "RGB foreColor" },
               { "RGBBkCol", 6, "RGB backColor" },
               { "HiliteMode", 0, "hilite mode flag" },
               { "HiliteColor", 6, "RGB hilite color" },
               { "DefHilite", 0, "Use default hilite color" },
               { "OpColor", 6, "RGB OpColor for arithmetic modes" },
               { "Line", 8, "pnLoc (point), newPt (point)" },
               { "LineFrom", 4, "newPt (point)" },
               { "ShortLine", 6, "pnLoc (point, dh, dv (-128 .. 127))" },
               { "ShortLineFrom", 2, "dh, dv (-128 .. 127)" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "LongText", 0, "txLoc (point), count (0..255), text" },
               { "DHText", 0, "dh (0..255), count (0..255), text" },
               { "DVText", 0, "dv (0..255), count (0..255), text" },
               { "DHDVText", 0, "dh, dv (0..255), count (0..255), text" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               ...
               { "invertRect", 8, "rect" },
               { "fillRect", 8, "rect" },
               { "reserved", 8, "reserved for Apple use" },
               { "reserved", 8, "reserved for Apple use" },
               { "reserved", 8, "reserved for Apple use" },
               { "frameSameRect", 0, "rect" },
               { "paintSameRect", 0, "rect" },
               { "eraseSameRect", 0, "rect" },
               { "invertSameRect", 0, "rect" },
               { "fillSameRect", 0, "rect" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               ...
               { "reserved", 8, "reserved for Apple use" },
               { "reserved", 8, "reserved for Apple use" },
               { "frameSameRRect", 0, "rect" },
               { "paintSameRRect", 0, "rect" },
               { "eraseSameRRect", 0, "rect" },
               { "invertSameRRect", 0, "rect" },
               { "fillSameRRect", 0, "rect" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "frameOval", 8, "rect" },
               ...
               { "reserved", 8, "reserved for Apple use" },
               { "reserved", 8, "reserved for Apple use" },
               { "frameSameOval", 0, "rect" },
               { "paintSameOval", 0, "rect" },
               { "eraseSameOval", 0, "rect" },
               { "invertSameOval", 0, "rect" },
               { "fillSameOval", 0, "rect" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "frameArc", 12, "rect, startAngle, arcAngle" },
               { "paintArc", 12, "rect, startAngle, arcAngle" },
               { "eraseArc", 12, "rect, startAngle, arcAngle" },
               { "invertArc", 12, "rect, startAngle, arcAngle" },
               { "fillArc", 12, "rect, startAngle, arcAngle" },
               { "reserved", 12, "reserved for Apple use" },
               { "reserved", 12, "reserved for Apple use" },
               { "reserved", 12, "reserved for Apple use" },
               { "frameSameArc", 4, "rect, startAngle, arcAngle" },
               { "paintSameArc", 4, "rect, startAngle, arcAngle" },
               { "eraseSameArc", 4, "rect, startAngle, arcAngle" },
               { "invertSameArc", 4, "rect, startAngle, arcAngle" },
               { "fillSameArc", 4, "rect, startAngle, arcAngle" },
               { "reserved", 4, "reserved for Apple use" },
               { "reserved", 4, "reserved for Apple use" },
               { "reserved", 4, "reserved for Apple use" },
               { "framePoly", 0, "poly" },
               { "paintPoly", 0, "poly" },
               ...
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "frameSamePoly", 0, "poly (NYI)" },
               { "paintSamePoly", 0, "poly (NYI)" },
               { "eraseSamePoly", 0, "poly (NYI)" },
               { "invertSamePoly", 0, "poly (NYI)" },
               { "fillSamePoly", 0, "poly (NYI)" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "frameRgn", 0, "region" },
               ...
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "frameSameRgn", 0, "region (NYI)" },
               { "paintSameRgn", 0, "region (NYI)" },
               { "eraseSameRgn", 0, "region (NYI)" },
               { "invertSameRgn", 0, "region (NYI)" },
               { "fillSameRgn", 0, "region (NYI)" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "reserved", 0, "reserved for Apple use" },
               { "BitsRect", 0, "copybits, rect clipped" },
               { "BitsRgn", 0, "copybits, rgn clipped" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "PackBitsRect", 0, "packed copybits, rect clipped" },
               { "PackBitsRgn", 0, "packed copybits, rgn clipped" },
               { "DirectBitsRect", 0, "PixMap, srcRect, dstRect, mode, PixData" },
               { "DirectBitsRgn", 0, "PixMap, srcRect, dstRect, mode, maskRgn, PixData" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "reserved", -1, "reserved for Apple use" },
               { "ShortComment", 2, "kind (word)" },
               { "LongComment", 0, "kind (word), size (word), data" }
  };
...
static const unsigned char *UnpackScanline(
  const unsigned char *__restrict__ pixels,const unsigned int bits_per_pixel,
...
# 456 "coders/pict.c" 3 4
                                 ((void *)0)
# 456 "coders/pict.c"
                                     )
    return((unsigned char *) 
# 457 "coders/pict.c" 3 4
                            ((void *)0)
# 457 "coders/pict.c"
                                );
  *extent=row_bytes*image->rows*sizeof(*pixels);
  ...
  scanline=(unsigned char *) AcquireQuantumMemory(row_bytes,2*
    sizeof(*scanline));
  if (scanline == (unsigned char *) 
# 462 "coders/pict.c" 3 4
                                   ((void *)0)
# 462 "coders/pict.c"
                                       )
    {
...
# 612 "coders/pict.c"
 "image != (Image *) NULL"
# 612 "coders/pict.c" 3 4
 , "coders/pict.c", 612, __extension__ __PRETTY_FUNCTION__); }))
# 612 "coders/pict.c"
                                ;
  
# 613 "coders/pict.c" 3 4
 ((void) sizeof ((
# 613 "coders/pict.c"
...
# 613 "coders/pict.c" 3 4
 , "coders/pict.c", 613, __extension__ __PRETTY_FUNCTION__); }))
# 613 "coders/pict.c"
                                                ;
  
# 614 "coders/pict.c" 3 4
 ((void) sizeof ((
# 614 "coders/pict.c"
...
# 614 "coders/pict.c" 3 4
 , "coders/pict.c", 614, __extension__ __PRETTY_FUNCTION__); }))
# 614 "coders/pict.c"
                                           ;
  
# 615 "coders/pict.c" 3 4
 ((void) sizeof ((
# 615 "coders/pict.c"
...
# 615 "coders/pict.c" 3 4
 , "coders/pict.c", 615, __extension__ __PRETTY_FUNCTION__); }))
# 615 "coders/pict.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pict.c",__func__,(unsigned long) 617,"%s",image->filename);
  count=0;
  runlength=0;
...
# 883 "coders/pict.c" 3 4
 , "coders/pict.c", 883, __extension__ __PRETTY_FUNCTION__); }))
# 883 "coders/pict.c"
                                               ;
  
# 884 "coders/pict.c" 3 4
 ((void) sizeof ((
# 884 "coders/pict.c"
...
# 884 "coders/pict.c" 3 4
 , "coders/pict.c", 884, __extension__ __PRETTY_FUNCTION__); }))
# 884 "coders/pict.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pict.c",__func__,(unsigned long) 886,"%s",
      image_info->filename);
  
# 888 "coders/pict.c" 3 4
 ((void) sizeof ((
# 888 "coders/pict.c"
...
# 888 "coders/pict.c" 3 4
 , "coders/pict.c", 888, __extension__ __PRETTY_FUNCTION__); }))
# 888 "coders/pict.c"
                                            ;
  
# 889 "coders/pict.c" 3 4
 ((void) sizeof ((
# 889 "coders/pict.c"
...
# 889 "coders/pict.c" 3 4
 , "coders/pict.c", 889, __extension__ __PRETTY_FUNCTION__); }))
# 889 "coders/pict.c"
                                                    ;
...
# 895 "coders/pict.c"
  ...
  read_info=(ImageInfo *) 
# 900 "coders/pict.c" 3 4
                         ((void *)0)
# 900 "coders/pict.c"
                             ;
  tile_image=(Image *) 
# 901 "coders/pict.c" 3 4
                      ((void *)0)
# 901 "coders/pict.c"
                          ;
...
# 914 "coders/pict.c"
  ...
  if (ReadRectangle(image,&frame) == MagickFalse)
    { if (tile_image != (Image *) 
# 918 "coders/pict.c" 3 4
   ((void *)0)
# 918 "coders/pict.c"
   ) tile_image=DestroyImage(tile_image); if (read_info != (ImageInfo *) 
# 918 "coders/pict.c" 3 4
   ((void *)0)
# 918 "coders/pict.c"
   ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 918,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 918 "coders/pict.c" 3 4
   ((void *)0)
# 918 "coders/pict.c"
...
# 921 "coders/pict.c" 3 4
   ((void *)0)
# 921 "coders/pict.c"
   ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 921,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 921 "coders/pict.c" 3 4
   ((void *)0)
# 921 "coders/pict.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 927 "coders/pict.c" 3 4
       ((void *)0)
# 927 "coders/pict.c"
       ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 927,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 927 "coders/pict.c" 3 4
       ((void *)0)
# 927 "coders/pict.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 931 "coders/pict.c" 3 4
     ((void *)0)
# 931 "coders/pict.c"
     ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 931,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 931 "coders/pict.c" 3 4
     ((void *)0)
# 931 "coders/pict.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 935 "coders/pict.c" 3 4
   ((void *)0)
# 935 "coders/pict.c"
   ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 935,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 935 "coders/pict.c" 3 4
   ((void *)0)
# 935 "coders/pict.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
    ...
    if (code > 0xa1)
      {
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/pict.c",__func__,(unsigned long) 978,"%04X:",code);
      }
    else
      {
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/pict.c",__func__,(unsigned long) 983,
...
# 994 "coders/pict.c" 3 4
             ((void *)0)
# 994 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 994,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 994 "coders/pict.c" 3 4
             ((void *)0)
# 994 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1004 "coders/pict.c" 3 4
             ((void *)0)
# 1004 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1004,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1004 "coders/pict.c" 3 4
             ((void *)0)
# 1004 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1044 "coders/pict.c" 3 4
             ((void *)0)
# 1044 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1044,(CorruptImageError),("UnknownPatternType"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1044 "coders/pict.c" 3 4
             ((void *)0)
# 1044 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1047 "coders/pict.c" 3 4
             ((void *)0)
# 1047 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1047,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1047 "coders/pict.c" 3 4
             ((void *)0)
# 1047 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1050 "coders/pict.c" 3 4
             ((void *)0)
# 1050 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1050,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1050 "coders/pict.c" 3 4
             ((void *)0)
# 1050 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1052 "coders/pict.c" 3 4
             ((void *)0)
# 1052 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1052,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1052 "coders/pict.c" 3 4
             ((void *)0)
# 1052 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1061 "coders/pict.c" 3 4
             ((void *)0)
# 1061 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1061,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1061 "coders/pict.c" 3 4
             ((void *)0)
# 1061 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1092 "coders/pict.c" 3 4
                 ((void *)0)
# 1092 "coders/pict.c"
                 ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1092,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1092 "coders/pict.c" 3 4
                 ((void *)0)
# 1092 "coders/pict.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1127 "coders/pict.c" 3 4
             ((void *)0)
# 1127 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1127,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1127 "coders/pict.c" 3 4
             ((void *)0)
# 1127 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1170 "coders/pict.c" 3 4
             ((void *)0)
# 1170 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1170,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1170 "coders/pict.c" 3 4
             ((void *)0)
# 1170 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1170 "coders/pict.c"
            ...
            if (tile_image == (Image *) 
# 1176 "coders/pict.c" 3 4
                                       ((void *)0)
# 1176 "coders/pict.c"
                                           )
              { if (tile_image != (Image *) 
# 1177 "coders/pict.c" 3 4
             ((void *)0)
# 1177 "coders/pict.c"
             ) tile_image=DestroyImage(tile_image); if (read_info != (ImageInfo *) 
# 1177 "coders/pict.c" 3 4
             ((void *)0)
# 1177 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1177,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1177 "coders/pict.c" 3 4
             ((void *)0)
# 1177 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1183 "coders/pict.c" 3 4
                 ((void *)0)
# 1183 "coders/pict.c"
                 ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1183,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1183 "coders/pict.c" 3 4
                 ((void *)0)
# 1183 "coders/pict.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1183 "coders/pict.c"
                ...
                if (tile_image->alpha_trait != UndefinedPixelTrait)
                  (void) SetImageAlpha(tile_image,((Quantum) ((Quantum) 65535.0)),exception);
              }
            if ((code != 0x9a) && (code != 0x9b))
              {
...
# 1208 "coders/pict.c" 3 4
                 ((void *)0)
# 1208 "coders/pict.c"
                 ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1208,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1208 "coders/pict.c" 3 4
                 ((void *)0)
# 1208 "coders/pict.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1208 "coders/pict.c"
                ...
                if ((bytes_per_line & 0x8000) != 0)
                ...
                else
                  {
                    for (i=0; i < (ssize_t) tile_image->colors; i++)
                    {
                      tile_image->colormap[i].red=((double) ((Quantum) 65535.0)-
                        tile_image->colormap[i].red);
                      tile_image->colormap[i].green=((double) ((Quantum) 65535.0)-
                        tile_image->colormap[i].green);
                      tile_image->colormap[i].blue=((double) ((Quantum) 65535.0)-
...
# 1239 "coders/pict.c" 3 4
             ((void *)0)
# 1239 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1239,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1239 "coders/pict.c" 3 4
             ((void *)0)
# 1239 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1242 "coders/pict.c" 3 4
             ((void *)0)
# 1242 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1242,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1242 "coders/pict.c" 3 4
             ((void *)0)
# 1242 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1244 "coders/pict.c" 3 4
             ((void *)0)
# 1244 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1244,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1244 "coders/pict.c" 3 4
             ((void *)0)
# 1244 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1253 "coders/pict.c" 3 4
                 ((void *)0)
# 1253 "coders/pict.c"
                 ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1253,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1253 "coders/pict.c" 3 4
                 ((void *)0)
# 1253 "coders/pict.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1256 "coders/pict.c"
            ...
            if (pixels == (unsigned char *) 
# 1266 "coders/pict.c" 3 4
                                           ((void *)0)
# 1266 "coders/pict.c"
                                               )
              { if (tile_image != (Image *) 
# 1267 "coders/pict.c" 3 4
             ((void *)0)
# 1267 "coders/pict.c"
             ) tile_image=DestroyImage(tile_image); if (read_info != (ImageInfo *) 
# 1267 "coders/pict.c" 3 4
             ((void *)0)
# 1267 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1267,(CorruptImageError),("UnableToUncompressImage"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1267 "coders/pict.c" 3 4
             ((void *)0)
# 1267 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1277 "coders/pict.c" 3 4
                 ((void *)0)
# 1277 "coders/pict.c"
                 ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1277,(CorruptImageError),("NotEnoughPixelData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1277 "coders/pict.c" 3 4
                 ((void *)0)
# 1277 "coders/pict.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1315 "coders/pict.c" 3 4
                           ((void *)0)
# 1315 "coders/pict.c"
                           ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1315,(CorruptImageError),("NotEnoughPixelData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1315 "coders/pict.c" 3 4
                           ((void *)0)
# 1315 "coders/pict.c"
                           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1326 "coders/pict.c" 3 4
                           ((void *)0)
# 1326 "coders/pict.c"
                           ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1326,(CorruptImageError),("NotEnoughPixelData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1326 "coders/pict.c" 3 4
                           ((void *)0)
# 1326 "coders/pict.c"
                           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1378 "coders/pict.c" 3 4
             ((void *)0)
# 1378 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1378,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1378 "coders/pict.c" 3 4
             ((void *)0)
# 1378 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1393 "coders/pict.c" 3 4
               ((void *)0)
# 1393 "coders/pict.c"
               ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1393,(ResourceLimitError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1393 "coders/pict.c" 3 4
               ((void *)0)
# 1393 "coders/pict.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1393 "coders/pict.c"
            ...
            switch (type)
            {
              case 0xe0:
              {
                profile=BlobToStringInfo((const void *) 
# 1399 "coders/pict.c" 3 4
                                                       ((void *)0)
# 1399 "coders/pict.c"
                                                           ,length);
...
# 1406 "coders/pict.c" 3 4
                   ((void *)0)
# 1406 "coders/pict.c"
                   ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1406,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1406 "coders/pict.c" 3 4
                   ((void *)0)
# 1406 "coders/pict.c"
                   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1419 "coders/pict.c" 3 4
                   ((void *)0)
# 1419 "coders/pict.c"
                   ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1419,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1419 "coders/pict.c" 3 4
                   ((void *)0)
# 1419 "coders/pict.c"
                   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1466 "coders/pict.c" 3 4
         ((void *)0)
# 1466 "coders/pict.c"
         ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1466,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1466 "coders/pict.c" 3 4
         ((void *)0)
# 1466 "coders/pict.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1478 "coders/pict.c" 3 4
             ((void *)0)
# 1478 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1478,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1478 "coders/pict.c" 3 4
             ((void *)0)
# 1478 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1480 "coders/pict.c"
            ...
            pixels=(unsigned char *) AcquireQuantumMemory(length,
              sizeof(*pixels));
            if (pixels == (unsigned char *) 
# 1485 "coders/pict.c" 3 4
                                           ((void *)0)
# 1485 "coders/pict.c"
                                               )
              { if (tile_image != (Image *) 
# 1486 "coders/pict.c" 3 4
             ((void *)0)
# 1486 "coders/pict.c"
             ) tile_image=DestroyImage(tile_image); if (read_info != (ImageInfo *) 
# 1486 "coders/pict.c" 3 4
             ((void *)0)
# 1486 "coders/pict.c"
             ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1486,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1486 "coders/pict.c" 3 4
             ((void *)0)
# 1486 "coders/pict.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1491 "coders/pict.c" 3 4
               ((void *)0)
# 1491 "coders/pict.c"
               ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1491,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1491 "coders/pict.c" 3 4
               ((void *)0)
# 1491 "coders/pict.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1491 "coders/pict.c"
            ...
            (void) FormatLocaleString(read_info->filename,4096,
        ...
        if (tile_image == (Image *) 
# 1500 "coders/pict.c" 3 4
                                   ((void *)0)
# 1500 "coders/pict.c"
                                       )
          continue;
        (void) FormatLocaleString(geometry,4096,"%.20gx%.20g",
          (double) (((image->columns) > (tile_image->columns)) ? (image->columns) : (tile_image->columns)),
          (double) (((image->rows) > (tile_image->rows)) ? (image->rows) : (tile_image->rows)));
        (void) SetImageExtent(image,
          (((image->columns) > (tile_image->columns)) ? (image->columns) : (tile_image->columns)),
          (((image->rows) > (tile_image->rows)) ? (image->rows) : (tile_image->rows)),exception);
...
# 1525 "coders/pict.c" 3 4
         ((void *)0)
# 1525 "coders/pict.c"
         ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1525,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1525 "coders/pict.c" 3 4
         ((void *)0)
# 1525 "coders/pict.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1539 "coders/pict.c" 3 4
         ((void *)0)
# 1539 "coders/pict.c"
         ) read_info=DestroyImageInfo(read_info); { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1539,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1539 "coders/pict.c" 3 4
         ((void *)0)
# 1539 "coders/pict.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1577 "coders/pict.c"
__attribute__ ((visibility ("default"))) size_t RegisterPICTImage(void)
{
  MagickInfo
    *entry;
...
# 1618 "coders/pict.c"
__attribute__ ((visibility ("default"))) void UnregisterPICTImage(void)
{
...
# 1715 "coders/pict.c"
 "image_info != (const ImageInfo *) NULL"
# 1715 "coders/pict.c" 3 4
 , "coders/pict.c", 1715, __extension__ __PRETTY_FUNCTION__); }))
# 1715 "coders/pict.c"
                                               ;
  
# 1716 "coders/pict.c" 3 4
 ((void) sizeof ((
# 1716 "coders/pict.c"
 image_info->signature == 0xabacadabUL
# 1716 "coders/pict.c" 3 4
...
# 1716 "coders/pict.c"
 "image_info->signature == MagickCoreSignature"
# 1716 "coders/pict.c" 3 4
 , "coders/pict.c", 1716, __extension__ __PRETTY_FUNCTION__); }))
# 1716 "coders/pict.c"
                                                     ;
  
# 1717 "coders/pict.c" 3 4
 ((void) sizeof ((
# 1717 "coders/pict.c"
 image != (Image *) 
# 1717 "coders/pict.c" 3 4
...
# 1717 "coders/pict.c"
 "image != (Image *) NULL"
# 1717 "coders/pict.c" 3 4
 , "coders/pict.c", 1717, __extension__ __PRETTY_FUNCTION__); }))
# 1717 "coders/pict.c"
                                ;
  
# 1718 "coders/pict.c" 3 4
 ((void) sizeof ((
# 1718 "coders/pict.c"
 image->signature == 0xabacadabUL
# 1718 "coders/pict.c" 3 4
...
# 1718 "coders/pict.c"
 "image->signature == MagickCoreSignature"
# 1718 "coders/pict.c" 3 4
 , "coders/pict.c", 1718, __extension__ __PRETTY_FUNCTION__); }))
# 1718 "coders/pict.c"
                                                ;
  
# 1719 "coders/pict.c" 3 4
 ((void) sizeof ((
# 1719 "coders/pict.c"
 exception != (ExceptionInfo *) 
# 1719 "coders/pict.c" 3 4
...
# 1719 "coders/pict.c"
 "exception != (ExceptionInfo *) NULL"
# 1719 "coders/pict.c" 3 4
 , "coders/pict.c", 1719, __extension__ __PRETTY_FUNCTION__); }))
# 1719 "coders/pict.c"
                                            ;
  
# 1720 "coders/pict.c" 3 4
 ((void) sizeof ((
# 1720 "coders/pict.c"
 exception->signature == 0xabacadabUL
# 1720 "coders/pict.c" 3 4
...
# 1720 "coders/pict.c"
 "exception->signature == MagickCoreSignature"
# 1720 "coders/pict.c" 3 4
 , "coders/pict.c", 1720, __extension__ __PRETTY_FUNCTION__); }))
# 1720 "coders/pict.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pict.c",__func__,(unsigned long) 1722,"%s",image->filename);
  if ((image->columns > 65535L) || (image->rows > 65535L))
    { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1724,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1724 "coders/pict.c" 3 4
   ((void *)0)
# 1724 "coders/pict.c"
  ...
  pixmap.reserved=0;
  transfer_mode=0;
  if ((image->resolution.x > 1.0e-12) &&
      (image->resolution.y > 1.0e-12))
    {
  ...
  if ((bytes_per_line == 0) || (bytes_per_line > 0x7FFFU) ||
      ((row_bytes+128*2U) >= 0x7FFFU))
    { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1789,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1789 "coders/pict.c" 3 4
   ((void *)0)
# 1789 "coders/pict.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  buffer=(unsigned char *) AcquireQuantumMemory(512,sizeof(*buffer));
  packed_scanline=(unsigned char *) AcquireQuantumMemory((size_t)
   (row_bytes+2*128),sizeof(*packed_scanline));
  scanline=(unsigned char *) AcquireQuantumMemory(row_bytes,sizeof(*scanline));
  if ((buffer == (unsigned char *) 
# 1794 "coders/pict.c" 3 4
                                  ((void *)0)
# 1794 "coders/pict.c"
                                      ) ||
      (packed_scanline == (unsigned char *) 
# 1795 "coders/pict.c" 3 4
                                           ((void *)0)
# 1795 "coders/pict.c"
                                               ) ||
      (scanline == (unsigned char *) 
# 1796 "coders/pict.c" 3 4
                                    ((void *)0)
# 1796 "coders/pict.c"
                                        ))
    {
      if (scanline != (unsigned char *) 
# 1798 "coders/pict.c" 3 4
                                       ((void *)0)
# 1798 "coders/pict.c"
                                           )
        scanline=(unsigned char *) RelinquishMagickMemory(scanline);
      if (packed_scanline != (unsigned char *) 
# 1800 "coders/pict.c" 3 4
                                              ((void *)0)
# 1800 "coders/pict.c"
                                                  )
        packed_scanline=(unsigned char *) RelinquishMagickMemory(
          packed_scanline);
      if (buffer != (unsigned char *) 
# 1803 "coders/pict.c" 3 4
                                     ((void *)0)
# 1803 "coders/pict.c"
                                         )
        buffer=(unsigned char *) RelinquishMagickMemory(buffer);
      { (void) ThrowMagickException(exception,"coders/pict.c",__func__,(unsigned long) 1805,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1805 "coders/pict.c" 3 4
     ((void *)0)
# 1805 "coders/pict.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    }
  (void) memset(scanline,0,row_bytes);
  (void) memset(packed_scanline,0,(size_t) (row_bytes+2*128)*
    sizeof(*packed_scanline));



  (void) memset(buffer,0,512);
  (void) WriteBlob(image,512,buffer);
  ...
  (void) WriteBlobMSBShort(image,0x11);
  (void) WriteBlobMSBShort(image,0x02ff);
  (void) WriteBlobMSBShort(image,0x0C00);
...
# 1848 "coders/pict.c"
  ...
  (void) WriteBlobMSBShort(image,0x01);
...
# 1886 "coders/pict.c"
      ...
      (void) CopyMagickString(jpeg_info->magick,"JPEG",4096);
      length=0;
      blob=(unsigned char *) ImageToBlob(jpeg_info,jpeg_image,&length,
        exception);
      jpeg_info=DestroyImageInfo(jpeg_info);
      if (blob == (unsigned char *) 
# 1897 "coders/pict.c" 3 4
                                   ((void *)0)
# 1897 "coders/pict.c"
                                       )
        return(MagickFalse);
      jpeg_image=DestroyImage(jpeg_image);
      (void) WriteBlobMSBShort(image,0x8200);
  ...
  if (storage_class == PseudoClass)
    (void) WriteBlobMSBShort(image,0x98);
  else
    {
      (void) WriteBlobMSBShort(image,0x9A);
...
# 2089 "coders/pict.c"
  ...
  if ((count & 0x01) != 0)
    (void) WriteBlobByte(image,'\0');
  (void) WriteBlobMSBShort(image,0xff);
  offset=TellBlob(image);
  offset=SeekBlob(image,512,
# 2102 "coders/pict.c" 3 4
                           0
# 2102 "coders/pict.c"
                                   );
