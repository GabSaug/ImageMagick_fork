...
# 130 "coders/rgf.c" 3 4
 , "coders/rgf.c", 130, __extension__ __PRETTY_FUNCTION__); }))
# 130 "coders/rgf.c"
                                               ;
  
# 131 "coders/rgf.c" 3 4
 ((void) sizeof ((
# 131 "coders/rgf.c"
...
# 131 "coders/rgf.c" 3 4
 , "coders/rgf.c", 131, __extension__ __PRETTY_FUNCTION__); }))
# 131 "coders/rgf.c"
                                                     ;
  
# 132 "coders/rgf.c" 3 4
 ((void) sizeof ((
# 132 "coders/rgf.c"
...
# 132 "coders/rgf.c" 3 4
 , "coders/rgf.c", 132, __extension__ __PRETTY_FUNCTION__); }))
# 132 "coders/rgf.c"
                                            ;
  
# 133 "coders/rgf.c" 3 4
 ((void) sizeof ((
# 133 "coders/rgf.c"
...
# 133 "coders/rgf.c" 3 4
 , "coders/rgf.c", 133, __extension__ __PRETTY_FUNCTION__); }))
# 133 "coders/rgf.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/rgf.c",__func__,(unsigned long) 135,"%s",
      image_info->filename);
...
# 142 "coders/rgf.c"
  ...
  if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/rgf.c",__func__,(unsigned long) 156,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 156 "coders/rgf.c" 3 4
   ((void *)0)
# 156 "coders/rgf.c"
...
# 179 "coders/rgf.c" 3 4
                               ((void *)0)
# 179 "coders/rgf.c"
                                   )
    { (void) ThrowMagickException(exception,"coders/rgf.c",__func__,(unsigned long) 180,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 180 "coders/rgf.c" 3 4
   ((void *)0)
# 180 "coders/rgf.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 180 "coders/rgf.c" 3 4
...
# 248 "coders/rgf.c"
__attribute__ ((visibility ("default"))) size_t RegisterRGFImage(void)
{
  MagickInfo
    *entry;
...
# 281 "coders/rgf.c"
__attribute__ ((visibility ("default"))) void UnregisterRGFImage(void)
{
...
# 335 "coders/rgf.c"
 "image_info != (const ImageInfo *) NULL"
# 335 "coders/rgf.c" 3 4
 , "coders/rgf.c", 335, __extension__ __PRETTY_FUNCTION__); }))
# 335 "coders/rgf.c"
                                               ;
  
# 336 "coders/rgf.c" 3 4
 ((void) sizeof ((
# 336 "coders/rgf.c"
 image_info->signature == 0xabacadabUL
# 336 "coders/rgf.c" 3 4
...
# 336 "coders/rgf.c"
 "image_info->signature == MagickCoreSignature"
# 336 "coders/rgf.c" 3 4
 , "coders/rgf.c", 336, __extension__ __PRETTY_FUNCTION__); }))
# 336 "coders/rgf.c"
                                                     ;
  
# 337 "coders/rgf.c" 3 4
 ((void) sizeof ((
# 337 "coders/rgf.c"
 image != (Image *) 
# 337 "coders/rgf.c" 3 4
...
# 337 "coders/rgf.c"
 "image != (Image *) NULL"
# 337 "coders/rgf.c" 3 4
 , "coders/rgf.c", 337, __extension__ __PRETTY_FUNCTION__); }))
# 337 "coders/rgf.c"
                                ;
  
# 338 "coders/rgf.c" 3 4
 ((void) sizeof ((
# 338 "coders/rgf.c"
...
# 338 "coders/rgf.c" 3 4
 , "coders/rgf.c", 338, __extension__ __PRETTY_FUNCTION__); }))
# 338 "coders/rgf.c"
                                                ;
  
# 339 "coders/rgf.c" 3 4
 ((void) sizeof ((
# 339 "coders/rgf.c"
 exception != (ExceptionInfo *) 
# 339 "coders/rgf.c" 3 4
...
# 339 "coders/rgf.c"
 "exception != (ExceptionInfo *) NULL"
# 339 "coders/rgf.c" 3 4
 , "coders/rgf.c", 339, __extension__ __PRETTY_FUNCTION__); }))
# 339 "coders/rgf.c"
                                            ;
  
# 340 "coders/rgf.c" 3 4
 ((void) sizeof ((
# 340 "coders/rgf.c"
 exception->signature == 0xabacadabUL
# 340 "coders/rgf.c" 3 4
...
# 340 "coders/rgf.c"
 "exception->signature == MagickCoreSignature"
# 340 "coders/rgf.c" 3 4
 , "coders/rgf.c", 340, __extension__ __PRETTY_FUNCTION__); }))
# 340 "coders/rgf.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/rgf.c",__func__,(unsigned long) 342,"%s",image->filename);
  ...
  if ((image->columns > 255L) || (image->rows > 255L))
    { (void) ThrowMagickException(exception,"coders/rgf.c",__func__,(unsigned long) 349,ImageError,"Dimensions must be less than 255x255", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 349 "coders/rgf.c" 3 4
   ((void *)0)
# 349 "coders/rgf.c"
