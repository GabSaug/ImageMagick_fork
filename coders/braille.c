...
# 94 "coders/braille.c"
__attribute__ ((visibility ("default"))) size_t RegisterBRAILLEImage(void)
{
  MagickInfo
    *entry;
...
# 141 "coders/braille.c"
__attribute__ ((visibility ("default"))) void UnregisterBRAILLEImage(void)
{
...
# 221 "coders/braille.c" 3 4
 ((void) sizeof ((
# 221 "coders/braille.c"
...
# 221 "coders/braille.c" 3 4
 , "coders/braille.c", 221, __extension__ __PRETTY_FUNCTION__); }))
# 221 "coders/braille.c"
                                               ;
  
# 222 "coders/braille.c" 3 4
 ((void) sizeof ((
# 222 "coders/braille.c"
...
# 222 "coders/braille.c" 3 4
 , "coders/braille.c", 222, __extension__ __PRETTY_FUNCTION__); }))
# 222 "coders/braille.c"
                                                     ;
  
# 223 "coders/braille.c" 3 4
 ((void) sizeof ((
# 223 "coders/braille.c"
 image != (Image *) 
# 223 "coders/braille.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 223 "coders/braille.c"
...
# 223 "coders/braille.c"
 "image != (Image *) NULL"
# 223 "coders/braille.c" 3 4
 , "coders/braille.c", 223, __extension__ __PRETTY_FUNCTION__); }))
# 223 "coders/braille.c"
                                ;
  
# 224 "coders/braille.c" 3 4
 ((void) sizeof ((
# 224 "coders/braille.c"
...
# 224 "coders/braille.c" 3 4
 , "coders/braille.c", 224, __extension__ __PRETTY_FUNCTION__); }))
# 224 "coders/braille.c"
                                                ;
  
# 225 "coders/braille.c" 3 4
 ((void) sizeof ((
# 225 "coders/braille.c"
...
# 225 "coders/braille.c" 3 4
 , "coders/braille.c", 225, __extension__ __PRETTY_FUNCTION__); }))
# 225 "coders/braille.c"
                                            ;
  
# 226 "coders/braille.c" 3 4
 ((void) sizeof ((
# 226 "coders/braille.c"
...
# 226 "coders/braille.c" 3 4
 , "coders/braille.c", 226, __extension__ __PRETTY_FUNCTION__); }))
# 226 "coders/braille.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/braille.c",__func__,(unsigned long) 228,"%s",image->filename);
  ...
  if (iso_11548_1 == 0)
    {
      ...
      if (value != (const char *) 
# 254 "coders/braille.c" 3 4
                                 ((void *)0)
# 254 "coders/braille.c"
                                     )
        {
      ...
      if (image->page.x != 0)
        {
          (void) FormatLocaleString(buffer,4096,"X: %.20g\n",
            (double) image->page.x);
          (void) WriteBlobString(image,buffer);
        }
      if (image->page.y != 0)
        {
          (void) FormatLocaleString(buffer,4096,"Y: %.20g\n",
            (double) image->page.y);
          (void) WriteBlobString(image,buffer);
        }
  ...
  for (y=0; y < (ssize_t) image->rows; y+=(ssize_t) cell_height)
  {
    ...
    if (p == (const Quantum *) 
# 295 "coders/braille.c" 3 4
                              ((void *)0)
# 295 "coders/braille.c"
                                  )
      break;
    for (x=0; x < (ssize_t) image->columns; x+=2)
    {
      ...
      { if (image->storage_class == PseudoClass) cell|=(GetPixelIndex(image,p+(x+(ssize_t) (0))*(ssize_t) GetImageChannels(image)+(0)*(ssize_t) (image->columns* GetImageChannels(image))) == polarity) << 0; else cell|=(GetPixelGreen(image,p+(x+(ssize_t) (0))*(ssize_t) GetImageChannels(image)+(0)*((ssize_t) image->columns*(ssize_t) GetImageChannels(image))) == 0) << 0; }
      if (two_columns != MagickFalse)
        { if (image->storage_class == PseudoClass) cell|=(GetPixelIndex(image,p+(x+(ssize_t) (1))*(ssize_t) GetImageChannels(image)+(0)*(ssize_t) (image->columns* GetImageChannels(image))) == polarity) << 3; else cell|=(GetPixelGreen(image,p+(x+(ssize_t) (1))*(ssize_t) GetImageChannels(image)+(0)*((ssize_t) image->columns*(ssize_t) GetImageChannels(image))) == 0) << 3; }
      if (cell_height > 1)
        {
          { if (image->storage_class == PseudoClass) cell|=(GetPixelIndex(image,p+(x+(ssize_t) (0))*(ssize_t) GetImageChannels(image)+(1)*(ssize_t) (image->columns* GetImageChannels(image))) == polarity) << 1; else cell|=(GetPixelGreen(image,p+(x+(ssize_t) (0))*(ssize_t) GetImageChannels(image)+(1)*((ssize_t) image->columns*(ssize_t) GetImageChannels(image))) == 0) << 1; }
          if (two_columns != MagickFalse)
            { if (image->storage_class == PseudoClass) cell|=(GetPixelIndex(image,p+(x+(ssize_t) (1))*(ssize_t) GetImageChannels(image)+(1)*(ssize_t) (image->columns* GetImageChannels(image))) == polarity) << 4; else cell|=(GetPixelGreen(image,p+(x+(ssize_t) (1))*(ssize_t) GetImageChannels(image)+(1)*((ssize_t) image->columns*(ssize_t) GetImageChannels(image))) == 0) << 4; }
          if (cell_height > 2)
            {
              { if (image->storage_class == PseudoClass) cell|=(GetPixelIndex(image,p+(x+(ssize_t) (0))*(ssize_t) GetImageChannels(image)+(2)*(ssize_t) (image->columns* GetImageChannels(image))) == polarity) << 2; else cell|=(GetPixelGreen(image,p+(x+(ssize_t) (0))*(ssize_t) GetImageChannels(image)+(2)*((ssize_t) image->columns*(ssize_t) GetImageChannels(image))) == 0) << 2; }
              if (two_columns != MagickFalse)
                { if (image->storage_class == PseudoClass) cell|=(GetPixelIndex(image,p+(x+(ssize_t) (1))*(ssize_t) GetImageChannels(image)+(2)*(ssize_t) (image->columns* GetImageChannels(image))) == polarity) << 5; else cell|=(GetPixelGreen(image,p+(x+(ssize_t) (1))*(ssize_t) GetImageChannels(image)+(2)*((ssize_t) image->columns*(ssize_t) GetImageChannels(image))) == 0) << 5; }
              if (cell_height > 3)
                {
                  { if (image->storage_class == PseudoClass) cell|=(GetPixelIndex(image,p+(x+(ssize_t) (0))*(ssize_t) GetImageChannels(image)+(3)*(ssize_t) (image->columns* GetImageChannels(image))) == polarity) << 6; else cell|=(GetPixelGreen(image,p+(x+(ssize_t) (0))*(ssize_t) GetImageChannels(image)+(3)*((ssize_t) image->columns*(ssize_t) GetImageChannels(image))) == 0) << 6; }
                  if (two_columns != MagickFalse)
                    { if (image->storage_class == PseudoClass) cell|=(GetPixelIndex(image,p+(x+(ssize_t) (1))*(ssize_t) GetImageChannels(image)+(3)*(ssize_t) (image->columns* GetImageChannels(image))) == polarity) << 7; else cell|=(GetPixelGreen(image,p+(x+(ssize_t) (1))*(ssize_t) GetImageChannels(image)+(3)*((ssize_t) image->columns*(ssize_t) GetImageChannels(image))) == 0) << 7; }
                }
            }
        }
      if (unicode != 0)
