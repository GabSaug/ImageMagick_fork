# 0 "coders/screenshot.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "coders/screenshot.c"
# 42 "coders/screenshot.c"
...
# 43 "coders/screenshot.c" 2
# 55 "coders/screenshot.c"
...
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
  XRenderImage(Image *,const DrawInfo *,const PointInfo *,TypeMetric *,
    ExceptionInfo *);
# 77 "coders/screenshot.c" 2
# 102 "coders/screenshot.c"
...
# 108 "coders/screenshot.c" 3 4
 ((void) sizeof ((
# 108 "coders/screenshot.c"
...
# 108 "coders/screenshot.c" 3 4
 , "coders/screenshot.c", 108, __extension__ __PRETTY_FUNCTION__); }))
# 108 "coders/screenshot.c"
                                                     ;
  
# 109 "coders/screenshot.c" 3 4
 ((void) sizeof ((
# 109 "coders/screenshot.c"
...
# 109 "coders/screenshot.c" 3 4
 , "coders/screenshot.c", 109, __extension__ __PRETTY_FUNCTION__); }))
# 109 "coders/screenshot.c"
                                            ;
  
# 110 "coders/screenshot.c" 3 4
 ((void) sizeof ((
# 110 "coders/screenshot.c"
...
# 110 "coders/screenshot.c" 3 4
 , "coders/screenshot.c", 110, __extension__ __PRETTY_FUNCTION__); }))
# 110 "coders/screenshot.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/screenshot.c",__func__,(unsigned long) 112,"%s",
      image_info->filename);
  image=(Image *) 
# 114 "coders/screenshot.c" 3 4
                 ((void *)0)
# 114 "coders/screenshot.c"
                     ;
# 269 "coders/screenshot.c"
  {
    const char
      *option;
...
# 278 "coders/screenshot.c" 3 4
                                ((void *)0)
# 278 "coders/screenshot.c"
                                    )
      ximage_info.screen=IsStringTrue(option);
    option=GetImageOption(image_info,"x:silent");
    if (option != (const char *) 
# 281 "coders/screenshot.c" 3 4
                                ((void *)0)
# 281 "coders/screenshot.c"
                                    )
      ximage_info.silent=IsStringTrue(option);
    image=XImportImage(image_info,&ximage_info,exception);
    if ((image != (Image *) 
# 284 "coders/screenshot.c" 3 4
                           ((void *)0)
# 284 "coders/screenshot.c"
                               ) && (image_info->extract != (char *) 
# 284 "coders/screenshot.c" 3 4
                                                                     ((void *)0)
# 284 "coders/screenshot.c"
                                                                         ))
      {
        ...
        if (crop_image != (Image *) 
# 298 "coders/screenshot.c" 3 4
                                   ((void *)0)
# 298 "coders/screenshot.c"
                                       )
          {
...
# 332 "coders/screenshot.c"
__attribute__ ((visibility ("default"))) size_t RegisterSCREENSHOTImage(void)
{
  MagickInfo
    *entry;
...
# 363 "coders/screenshot.c"
__attribute__ ((visibility ("default"))) void UnregisterSCREENSHOTImage(void)
{
