...
# 137 "coders/bgr.c" 3 4
 , "coders/bgr.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "coders/bgr.c"
                                               ;
  
# 138 "coders/bgr.c" 3 4
 ((void) sizeof ((
# 138 "coders/bgr.c"
...
# 138 "coders/bgr.c" 3 4
 , "coders/bgr.c", 138, __extension__ __PRETTY_FUNCTION__); }))
# 138 "coders/bgr.c"
                                                     ;
  
# 139 "coders/bgr.c" 3 4
 ((void) sizeof ((
# 139 "coders/bgr.c"
...
# 139 "coders/bgr.c" 3 4
 , "coders/bgr.c", 139, __extension__ __PRETTY_FUNCTION__); }))
# 139 "coders/bgr.c"
                                            ;
  
# 140 "coders/bgr.c" 3 4
 ((void) sizeof ((
# 140 "coders/bgr.c"
...
# 140 "coders/bgr.c" 3 4
 , "coders/bgr.c", 140, __extension__ __PRETTY_FUNCTION__); }))
# 140 "coders/bgr.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/bgr.c",__func__,(unsigned long) 142,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 146,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 146 "coders/bgr.c" 3 4
   ((void *)0)
# 146 "coders/bgr.c"
...
# 156 "coders/bgr.c" 3 4
       (*__errno_location ())
# 156 "coders/bgr.c"
       ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 156,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
    }
...
# 164 "coders/bgr.c" 3 4
                               ((void *)0)
# 164 "coders/bgr.c"
                                   )
    { (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 165,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 165 "coders/bgr.c" 3 4
   ((void *)0)
# 165 "coders/bgr.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 165 "coders/bgr.c" 3 4
...
# 180 "coders/bgr.c" 3 4
                                     ((void *)0)
# 180 "coders/bgr.c"
                                         )
    {
      canvas_image=DestroyImage(canvas_image);
      { (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 183,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 183 "coders/bgr.c" 3 4
     ((void *)0)
# 183 "coders/bgr.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 183 "coders/bgr.c" 3 4
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 245 "coders/bgr.c" 3 4
             (*__errno_location ())
# 245 "coders/bgr.c"
             ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 245,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
...
# 253 "coders/bgr.c"
          ...
          if (((y-image->extract_info.y) >= 0) &&
              ((y-image->extract_info.y) < (ssize_t) image->rows))
            {
              ...
              if ((p == (const Quantum *) 
# 264 "coders/bgr.c" 3 4
                                         ((void *)0)
# 264 "coders/bgr.c"
                                             ) ||
                  (q == (Quantum *) 
# 265 "coders/bgr.c" 3 4
                                   ((void *)0)
# 265 "coders/bgr.c"
                                       ))
                break;
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 325 "coders/bgr.c" 3 4
             (*__errno_location ())
# 325 "coders/bgr.c"
             ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 325,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          for (i=0; i < (ssize_t) (image->alpha_trait != UndefinedPixelTrait ? 4 : 3); i++)
          {
            ...
            q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
              exception);
            if (q == (Quantum *) 
# 334 "coders/bgr.c" 3 4
                                ((void *)0)
# 334 "coders/bgr.c"
                                    )
              break;
            length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 336 "coders/bgr.c" 3 4
                                                                 ((void *)0)
# 336 "coders/bgr.c"
                                                                     ,
              quantum_info,quantum_type,(unsigned char *) stream,exception);
            ...
            if (((y-image->extract_info.y) >= 0) &&
                ((y-image->extract_info.y) < (ssize_t) image->rows))
              {
                ...
                q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                  image->columns,1,exception);
                if ((p == (const Quantum *) 
# 347 "coders/bgr.c" 3 4
                                           ((void *)0)
# 347 "coders/bgr.c"
                                               ) ||
                    (q == (Quantum *) 
# 348 "coders/bgr.c" 3 4
                                     ((void *)0)
# 348 "coders/bgr.c"
                                         ))
                  break;
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 424 "coders/bgr.c" 3 4
             (*__errno_location ())
# 424 "coders/bgr.c"
             ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 424,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 430 "coders/bgr.c" 3 4
                              ((void *)0)
# 430 "coders/bgr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 432 "coders/bgr.c" 3 4
                                                               ((void *)0)
# 432 "coders/bgr.c"
                                                                   ,
          ...
          if (((y-image->extract_info.y) >= 0) &&
              ((y-image->extract_info.y) < (ssize_t) image->rows))
            {
              ...
              q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                image->columns,1,exception);
              if ((p == (const Quantum *) 
# 443 "coders/bgr.c" 3 4
                                         ((void *)0)
# 443 "coders/bgr.c"
                                             ) ||
                  (q == (Quantum *) 
# 444 "coders/bgr.c" 3 4
                                   ((void *)0)
# 444 "coders/bgr.c"
                                       ))
                break;
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 477 "coders/bgr.c" 3 4
             (*__errno_location ())
# 477 "coders/bgr.c"
             ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 477,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 483 "coders/bgr.c" 3 4
                              ((void *)0)
# 483 "coders/bgr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 485 "coders/bgr.c" 3 4
                                                               ((void *)0)
# 485 "coders/bgr.c"
                                                                   ,
          ...
          if (((y-image->extract_info.y) >= 0) &&
              ((y-image->extract_info.y) < (ssize_t) image->rows))
            {
              ...
              q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                image->columns,1,exception);
              if ((p == (const Quantum *) 
# 496 "coders/bgr.c" 3 4
                                         ((void *)0)
# 496 "coders/bgr.c"
                                             ) ||
                  (q == (Quantum *) 
# 497 "coders/bgr.c" 3 4
                                   ((void *)0)
# 497 "coders/bgr.c"
                                       ))
                break;
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 530 "coders/bgr.c" 3 4
             (*__errno_location ())
# 530 "coders/bgr.c"
             ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 530,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 536 "coders/bgr.c" 3 4
                              ((void *)0)
# 536 "coders/bgr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 538 "coders/bgr.c" 3 4
                                                               ((void *)0)
# 538 "coders/bgr.c"
                                                                   ,
          ...
          if (((y-image->extract_info.y) >= 0) &&
              ((y-image->extract_info.y) < (ssize_t) image->rows))
            {
              ...
              q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                image->columns,1,exception);
              if ((p == (const Quantum *) 
# 549 "coders/bgr.c" 3 4
                                         ((void *)0)
# 549 "coders/bgr.c"
                                             ) ||
                  (q == (Quantum *) 
# 550 "coders/bgr.c" 3 4
                                   ((void *)0)
# 550 "coders/bgr.c"
                                       ))
                break;
        ...
        if (image->previous == (Image *) 
# 563 "coders/bgr.c" 3 4
                                        ((void *)0)
# 563 "coders/bgr.c"
                                            )
          {
            status=SetImageProgress(image,"Load/Image",3,6);
            if (status == MagickFalse)
              break;
          }
        if (image->previous == (Image *) 
# 569 "coders/bgr.c" 3 4
                                        ((void *)0)
# 569 "coders/bgr.c"
                                            )
          {
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 591 "coders/bgr.c" 3 4
                 (*__errno_location ())
# 591 "coders/bgr.c"
                 ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 591,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
              q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
                exception);
              if (q == (Quantum *) 
# 597 "coders/bgr.c" 3 4
                                  ((void *)0)
# 597 "coders/bgr.c"
                                      )
                break;
              length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 599 "coders/bgr.c" 3 4
                                                                   ((void *)0)
# 599 "coders/bgr.c"
                                                                       ,
              ...
              if (((y-image->extract_info.y) >= 0) &&
                  ((y-image->extract_info.y) < (ssize_t) image->rows))
                {
                  ...
                  q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                    image->columns,1,exception);
                  if ((p == (const Quantum *) 
# 611 "coders/bgr.c" 3 4
                                             ((void *)0)
# 611 "coders/bgr.c"
                                                 ) ||
                      (q == (Quantum *) 
# 612 "coders/bgr.c" 3 4
                                       ((void *)0)
# 612 "coders/bgr.c"
                                           ))
                    break;
        ...
        if (DiscardBlobBytes(image,(MagickSizeType) image->offset) == MagickFalse)
          {
            status=MagickFalse;
            { char *file_message; file_message=GetExceptionMessage(
# 652 "coders/bgr.c" 3 4
           (*__errno_location ())
# 652 "coders/bgr.c"
           ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 652,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                    ;
            break;
          }
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 683 "coders/bgr.c" 3 4
             (*__errno_location ())
# 683 "coders/bgr.c"
             ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 683,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 689 "coders/bgr.c" 3 4
                              ((void *)0)
# 689 "coders/bgr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 691 "coders/bgr.c" 3 4
                                                               ((void *)0)
# 691 "coders/bgr.c"
                                                                   ,
            quantum_info,BlueQuantum,(unsigned char *) stream,exception);
          ...
          if (((y-image->extract_info.y) >= 0) &&
              ((y-image->extract_info.y) < (ssize_t) image->rows))
            {
              ...
              q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                image->columns,1,exception);
              if ((p == (const Quantum *) 
# 702 "coders/bgr.c" 3 4
                                         ((void *)0)
# 702 "coders/bgr.c"
                                             ) ||
                  (q == (Quantum *) 
# 703 "coders/bgr.c" 3 4
                                   ((void *)0)
# 703 "coders/bgr.c"
                                       ))
                break;
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 755 "coders/bgr.c" 3 4
             (*__errno_location ())
# 755 "coders/bgr.c"
             ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 755,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 761 "coders/bgr.c" 3 4
                              ((void *)0)
# 761 "coders/bgr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 763 "coders/bgr.c" 3 4
                                                               ((void *)0)
# 763 "coders/bgr.c"
                                                                   ,
            quantum_info,GreenQuantum,(unsigned char *) stream,exception);
          ...
          if (((y-image->extract_info.y) >= 0) &&
              ((y-image->extract_info.y) < (ssize_t) image->rows))
            {
              ...
              q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                image->columns,1,exception);
              if ((p == (const Quantum *) 
# 774 "coders/bgr.c" 3 4
                                         ((void *)0)
# 774 "coders/bgr.c"
                                             ) ||
                  (q == (Quantum *) 
# 775 "coders/bgr.c" 3 4
                                   ((void *)0)
# 775 "coders/bgr.c"
                                       ))
                break;
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 827 "coders/bgr.c" 3 4
             (*__errno_location ())
# 827 "coders/bgr.c"
             ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 827,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 833 "coders/bgr.c" 3 4
                              ((void *)0)
# 833 "coders/bgr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 835 "coders/bgr.c" 3 4
                                                               ((void *)0)
# 835 "coders/bgr.c"
                                                                   ,
            quantum_info,RedQuantum,(unsigned char *) stream,exception);
          ...
          if (((y-image->extract_info.y) >= 0) &&
              ((y-image->extract_info.y) < (ssize_t) image->rows))
            {
              ...
              q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                image->columns,1,exception);
              if ((p == (const Quantum *) 
# 846 "coders/bgr.c" 3 4
                                         ((void *)0)
# 846 "coders/bgr.c"
                                             ) ||
                  (q == (Quantum *) 
# 847 "coders/bgr.c" 3 4
                                   ((void *)0)
# 847 "coders/bgr.c"
                                       ))
                break;
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 901 "coders/bgr.c" 3 4
                 (*__errno_location ())
# 901 "coders/bgr.c"
                 ); (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 901,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
              q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
                exception);
              if (q == (Quantum *) 
# 907 "coders/bgr.c" 3 4
                                  ((void *)0)
# 907 "coders/bgr.c"
                                      )
                break;
              length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 909 "coders/bgr.c" 3 4
                                                                   ((void *)0)
# 909 "coders/bgr.c"
                                                                       ,
                quantum_info,BlueQuantum,(unsigned char *) stream,exception);
              ...
              if (((y-image->extract_info.y) >= 0) &&
                  ((y-image->extract_info.y) < (ssize_t) image->rows))
                {
                  ...
                  q=GetAuthenticPixels(image,0,y-image->extract_info.y,
                    image->columns,1,exception);
                  if ((p == (const Quantum *) 
# 920 "coders/bgr.c" 3 4
                                             ((void *)0)
# 920 "coders/bgr.c"
                                                 ) ||
                      (q == (Quantum *) 
# 921 "coders/bgr.c" 3 4
                                       ((void *)0)
# 921 "coders/bgr.c"
                                           ))
                    break;
...
# 1011 "coders/bgr.c"
__attribute__ ((visibility ("default"))) size_t RegisterBGRImage(void)
{
  MagickInfo
    *entry;
...
# 1058 "coders/bgr.c"
__attribute__ ((visibility ("default"))) void UnregisterBGRImage(void)
{
...
# 1121 "coders/bgr.c"
 "image_info != (const ImageInfo *) NULL"
# 1121 "coders/bgr.c" 3 4
 , "coders/bgr.c", 1121, __extension__ __PRETTY_FUNCTION__); }))
# 1121 "coders/bgr.c"
                                               ;
  
# 1122 "coders/bgr.c" 3 4
 ((void) sizeof ((
# 1122 "coders/bgr.c"
 image_info->signature == 0xabacadabUL
# 1122 "coders/bgr.c" 3 4
...
# 1122 "coders/bgr.c"
 "image_info->signature == MagickCoreSignature"
# 1122 "coders/bgr.c" 3 4
 , "coders/bgr.c", 1122, __extension__ __PRETTY_FUNCTION__); }))
# 1122 "coders/bgr.c"
                                                     ;
  
# 1123 "coders/bgr.c" 3 4
 ((void) sizeof ((
# 1123 "coders/bgr.c"
 image != (Image *) 
# 1123 "coders/bgr.c" 3 4
...
# 1123 "coders/bgr.c"
 "image != (Image *) NULL"
# 1123 "coders/bgr.c" 3 4
 , "coders/bgr.c", 1123, __extension__ __PRETTY_FUNCTION__); }))
# 1123 "coders/bgr.c"
                                ;
  
# 1124 "coders/bgr.c" 3 4
 ((void) sizeof ((
# 1124 "coders/bgr.c"
...
# 1124 "coders/bgr.c" 3 4
 , "coders/bgr.c", 1124, __extension__ __PRETTY_FUNCTION__); }))
# 1124 "coders/bgr.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/bgr.c",__func__,(unsigned long) 1126,"%s",image->filename);
  if (image_info->interlace != PartitionInterlace)
    {
...
# 1132 "coders/bgr.c"
     "exception != (ExceptionInfo *) NULL"
# 1132 "coders/bgr.c" 3 4
     , "coders/bgr.c", 1132, __extension__ __PRETTY_FUNCTION__); }))
# 1132 "coders/bgr.c"
                                                ;
      
# 1133 "coders/bgr.c" 3 4
     ((void) sizeof ((
# 1133 "coders/bgr.c"
     exception->signature == 0xabacadabUL
# 1133 "coders/bgr.c" 3 4
...
# 1133 "coders/bgr.c"
     "exception->signature == MagickCoreSignature"
# 1133 "coders/bgr.c" 3 4
     , "coders/bgr.c", 1133, __extension__ __PRETTY_FUNCTION__); }))
# 1133 "coders/bgr.c"
                                                        ;
  ...
  do
  {
    ...
    if (quantum_info == (QuantumInfo *) 
# 1157 "coders/bgr.c" 3 4
                                       ((void *)0)
# 1157 "coders/bgr.c"
                                           )
      { (void) ThrowMagickException(exception,"coders/bgr.c",__func__,(unsigned long) 1158,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1158 "coders/bgr.c" 3 4
     ((void *)0)
# 1158 "coders/bgr.c"
    ...
    switch (image_info->interlace)
    {
      ...
      default:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          if (p == (const Quantum *) 
# 1174 "coders/bgr.c" 3 4
                                    ((void *)0)
# 1174 "coders/bgr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1176 "coders/bgr.c" 3 4
                                                        ((void *)0)
# 1176 "coders/bgr.c"
                                                            ,quantum_info,
...
# 1181 "coders/bgr.c"
      ...
      case LineInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1202 "coders/bgr.c" 3 4
                                    ((void *)0)
# 1202 "coders/bgr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1204 "coders/bgr.c" 3 4
                                                        ((void *)0)
# 1204 "coders/bgr.c"
                                                            ,quantum_info,
...
# 1227 "coders/bgr.c"
      ...
      case PlaneInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1248 "coders/bgr.c" 3 4
                                    ((void *)0)
# 1248 "coders/bgr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1250 "coders/bgr.c" 3 4
                                                        ((void *)0)
# 1250 "coders/bgr.c"
                                                            ,quantum_info,
            RedQuantum,pixels,exception);
...
# 1256 "coders/bgr.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1268 "coders/bgr.c" 3 4
                                    ((void *)0)
# 1268 "coders/bgr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1270 "coders/bgr.c" 3 4
                                                        ((void *)0)
# 1270 "coders/bgr.c"
                                                            ,quantum_info,
            GreenQuantum,pixels,exception);
...
# 1276 "coders/bgr.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1288 "coders/bgr.c" 3 4
                                    ((void *)0)
# 1288 "coders/bgr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1290 "coders/bgr.c" 3 4
                                                        ((void *)0)
# 1290 "coders/bgr.c"
                                                            ,quantum_info,
            BlueQuantum,pixels,exception);
        ...
        if (quantum_type == BGRAQuantum)
          {
            for (y=0; y < (ssize_t) image->rows; y++)
            {
              ...
              p=GetVirtualPixels(image,0,y,image->columns,1,exception);
              if (p == (const Quantum *) 
# 1310 "coders/bgr.c" 3 4
                                        ((void *)0)
# 1310 "coders/bgr.c"
                                            )
                break;
              length=ExportQuantumPixels(image,(CacheView *) 
# 1312 "coders/bgr.c" 3 4
                                                            ((void *)0)
# 1312 "coders/bgr.c"
                                                                ,quantum_info,
                AlphaQuantum,pixels,exception);
...
# 1328 "coders/bgr.c"
      ...
      case PartitionInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1352 "coders/bgr.c" 3 4
                                    ((void *)0)
# 1352 "coders/bgr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1354 "coders/bgr.c" 3 4
                                                        ((void *)0)
# 1354 "coders/bgr.c"
                                                            ,quantum_info,
            BlueQuantum,pixels,exception);
...
# 1360 "coders/bgr.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1379 "coders/bgr.c" 3 4
                                    ((void *)0)
# 1379 "coders/bgr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1381 "coders/bgr.c" 3 4
                                                        ((void *)0)
# 1381 "coders/bgr.c"
                                                            ,quantum_info,
            GreenQuantum,pixels,exception);
...
# 1387 "coders/bgr.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1406 "coders/bgr.c" 3 4
                                    ((void *)0)
# 1406 "coders/bgr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1408 "coders/bgr.c" 3 4
                                                        ((void *)0)
# 1408 "coders/bgr.c"
                                                            ,quantum_info,
            RedQuantum,pixels,exception);
        ...
        if (quantum_type == BGRAQuantum)
          {
            ...
            for (y=0; y < (ssize_t) image->rows; y++)
            {
              ...
              p=GetVirtualPixels(image,0,y,image->columns,1,exception);
              if (p == (const Quantum *) 
# 1436 "coders/bgr.c" 3 4
                                        ((void *)0)
# 1436 "coders/bgr.c"
                                            )
                break;
              length=ExportQuantumPixels(image,(CacheView *) 
# 1438 "coders/bgr.c" 3 4
                                                            ((void *)0)
# 1438 "coders/bgr.c"
                                                                ,quantum_info,
                AlphaQuantum,pixels,exception);
