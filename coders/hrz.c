...
# 125 "coders/hrz.c" 3 4
 , "coders/hrz.c", 125, __extension__ __PRETTY_FUNCTION__); }))
# 125 "coders/hrz.c"
                                               ;
  
# 126 "coders/hrz.c" 3 4
 ((void) sizeof ((
# 126 "coders/hrz.c"
...
# 126 "coders/hrz.c" 3 4
 , "coders/hrz.c", 126, __extension__ __PRETTY_FUNCTION__); }))
# 126 "coders/hrz.c"
                                                     ;
  
# 127 "coders/hrz.c" 3 4
 ((void) sizeof ((
# 127 "coders/hrz.c"
...
# 127 "coders/hrz.c" 3 4
 , "coders/hrz.c", 127, __extension__ __PRETTY_FUNCTION__); }))
# 127 "coders/hrz.c"
                                            ;
  
# 128 "coders/hrz.c" 3 4
 ((void) sizeof ((
# 128 "coders/hrz.c"
...
# 128 "coders/hrz.c" 3 4
 , "coders/hrz.c", 128, __extension__ __PRETTY_FUNCTION__); }))
# 128 "coders/hrz.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/hrz.c",__func__,(unsigned long) 130,"%s",
      image_info->filename);
...
# 150 "coders/hrz.c" 3 4
                                 ((void *)0)
# 150 "coders/hrz.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/hrz.c",__func__,(unsigned long) 151,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 151 "coders/hrz.c" 3 4
   ((void *)0)
# 151 "coders/hrz.c"
    ...
    if ((size_t) count != length)
      {
        ...
        { (void) ThrowMagickException(exception,"coders/hrz.c",__func__,(unsigned long) 159,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 159 "coders/hrz.c" 3 4
       ((void *)0)
# 159 "coders/hrz.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 159 "coders/hrz.c" 3 4
...
# 180 "coders/hrz.c" 3 4
   (*__errno_location ())
# 180 "coders/hrz.c"
   ); (void) ThrowMagickException(exception,"coders/hrz.c",__func__,(unsigned long) 180,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 211 "coders/hrz.c"
__attribute__ ((visibility ("default"))) size_t RegisterHRZImage(void)
{
  MagickInfo
    *entry;
...
# 243 "coders/hrz.c"
__attribute__ ((visibility ("default"))) void UnregisterHRZImage(void)
{
...
# 303 "coders/hrz.c"
 "image_info != (const ImageInfo *) NULL"
# 303 "coders/hrz.c" 3 4
 , "coders/hrz.c", 303, __extension__ __PRETTY_FUNCTION__); }))
# 303 "coders/hrz.c"
                                               ;
  
# 304 "coders/hrz.c" 3 4
 ((void) sizeof ((
# 304 "coders/hrz.c"
 image_info->signature == 0xabacadabUL
# 304 "coders/hrz.c" 3 4
...
# 304 "coders/hrz.c"
 "image_info->signature == MagickCoreSignature"
# 304 "coders/hrz.c" 3 4
 , "coders/hrz.c", 304, __extension__ __PRETTY_FUNCTION__); }))
# 304 "coders/hrz.c"
                                                     ;
  
# 305 "coders/hrz.c" 3 4
 ((void) sizeof ((
# 305 "coders/hrz.c"
 image != (Image *) 
# 305 "coders/hrz.c" 3 4
...
# 305 "coders/hrz.c"
 "image != (Image *) NULL"
# 305 "coders/hrz.c" 3 4
 , "coders/hrz.c", 305, __extension__ __PRETTY_FUNCTION__); }))
# 305 "coders/hrz.c"
                                ;
  
# 306 "coders/hrz.c" 3 4
 ((void) sizeof ((
# 306 "coders/hrz.c"
...
# 306 "coders/hrz.c" 3 4
 , "coders/hrz.c", 306, __extension__ __PRETTY_FUNCTION__); }))
# 306 "coders/hrz.c"
                                                ;
  
# 307 "coders/hrz.c" 3 4
 ((void) sizeof ((
# 307 "coders/hrz.c"
 exception != (ExceptionInfo *) 
# 307 "coders/hrz.c" 3 4
...
# 307 "coders/hrz.c"
 "exception != (ExceptionInfo *) NULL"
# 307 "coders/hrz.c" 3 4
 , "coders/hrz.c", 307, __extension__ __PRETTY_FUNCTION__); }))
# 307 "coders/hrz.c"
                                            ;
  
# 308 "coders/hrz.c" 3 4
 ((void) sizeof ((
# 308 "coders/hrz.c"
 exception->signature == 0xabacadabUL
# 308 "coders/hrz.c" 3 4
...
# 308 "coders/hrz.c"
 "exception->signature == MagickCoreSignature"
# 308 "coders/hrz.c" 3 4
 , "coders/hrz.c", 308, __extension__ __PRETTY_FUNCTION__); }))
# 308 "coders/hrz.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/hrz.c",__func__,(unsigned long) 310,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  hrz_image=ResizeImage(image,256,240,image->filter,exception);
  if (hrz_image == (Image *) 
# 315 "coders/hrz.c" 3 4
                            ((void *)0)
# 315 "coders/hrz.c"
                                )
    return(MagickFalse);
  ...
  pixels=(unsigned char *) AcquireQuantumMemory((size_t) hrz_image->columns,
    3*sizeof(*pixels));
  if (pixels == (unsigned char *) 
# 323 "coders/hrz.c" 3 4
                                 ((void *)0)
# 323 "coders/hrz.c"
                                     )
    {
      hrz_image=DestroyImage(hrz_image);
      { (void) ThrowMagickException(exception,"coders/hrz.c",__func__,(unsigned long) 326,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 326 "coders/hrz.c" 3 4
     ((void *)0)
# 326 "coders/hrz.c"
...
# 334 "coders/hrz.c"
    ...
    if (count != (ssize_t) (q-pixels))
      break;
    status=SetImageProgress(image,"Save/Image",y,hrz_image->rows);
    if (status == MagickFalse)
      break;
  }
  pixels=(unsigned char *) RelinquishMagickMemory(pixels);
