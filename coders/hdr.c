...
# 179 "coders/hdr.c" 3 4
 , "coders/hdr.c", 179, __extension__ __PRETTY_FUNCTION__); }))
# 179 "coders/hdr.c"
                                               ;
  
# 180 "coders/hdr.c" 3 4
 ((void) sizeof ((
# 180 "coders/hdr.c"
...
# 180 "coders/hdr.c" 3 4
 , "coders/hdr.c", 180, __extension__ __PRETTY_FUNCTION__); }))
# 180 "coders/hdr.c"
                                                     ;
  
# 181 "coders/hdr.c" 3 4
 ((void) sizeof ((
# 181 "coders/hdr.c"
...
# 181 "coders/hdr.c" 3 4
 , "coders/hdr.c", 181, __extension__ __PRETTY_FUNCTION__); }))
# 181 "coders/hdr.c"
                                            ;
  
# 182 "coders/hdr.c" 3 4
 ((void) sizeof ((
# 182 "coders/hdr.c"
...
# 182 "coders/hdr.c" 3 4
 , "coders/hdr.c", 182, __extension__ __PRETTY_FUNCTION__); }))
# 182 "coders/hdr.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/hdr.c",__func__,(unsigned long) 184,"%s",
      image_info->filename);
...
# 200 "coders/hdr.c"
             )
    {
      ...
      return((Image *) 
# 203 "coders/hdr.c" 3 4
                      ((void *)0)
# 203 "coders/hdr.c"
                          );
    }
  while (
# 205 "coders/hdr.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 205 "coders/hdr.c"
        (int) ((unsigned char) c)
# 205 "coders/hdr.c" 3 4
...
# 222 "coders/hdr.c" 3 4
                                      ((void *)0)
# 222 "coders/hdr.c"
                                          );
        for (p=comment; comment != (char *) 
# 223 "coders/hdr.c" 3 4
                                           ((void *)0)
# 223 "coders/hdr.c"
                                               ; p++)
        {
...
# 234 "coders/hdr.c"
        ...
        if (comment == (char *) 
# 240 "coders/hdr.c" 3 4
                               ((void *)0)
# 240 "coders/hdr.c"
                                   )
          { (void) ThrowMagickException(exception,"coders/hdr.c",__func__,(unsigned long) 241,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 241 "coders/hdr.c" 3 4
         ((void *)0)
# 241 "coders/hdr.c"
          ...
          switch (*keyword)
          {
            ...
            case 'f':
            {
              if (LocaleCompare(keyword,"format") == 0)
                {
                  (void) CopyMagickString(format,value,4096);
                  break;
                }
              (void) FormatLocaleString(tag,4096,"hdr:%s",keyword);
...
# 361 "coders/hdr.c"
  ...
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/hdr.c",__func__,(unsigned long) 365,CorruptImageError,"NegativeOrZeroImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 365 "coders/hdr.c" 3 4
   ((void *)0)
# 365 "coders/hdr.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 365 "coders/hdr.c" 3 4
...
# 365 "coders/hdr.c"
  ...
  if (LocaleCompare(format,"32-bit_rle_rgbe") == 0)
    ...
    { (void) ThrowMagickException(exception,"coders/hdr.c",__func__,(unsigned long) 371,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 371 "coders/hdr.c" 3 4
   ((void *)0)
# 371 "coders/hdr.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 371 "coders/hdr.c" 3 4
...
# 398 "coders/hdr.c" 3 4
                                 ((void *)0)
# 398 "coders/hdr.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/hdr.c",__func__,(unsigned long) 399,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 399 "coders/hdr.c" 3 4
   ((void *)0)
# 399 "coders/hdr.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 399 "coders/hdr.c" 3 4
      ...
      if (pixel[3] != 0)
        {
          ...
          SetPixelRed(image,ClampToQuantum((double) ((Quantum) 65535.0)*gamma*
            (double) pixel[0]),q);
          SetPixelGreen(image,ClampToQuantum((double) ((Quantum) 65535.0)*gamma*
            (double) pixel[1]),q);
          SetPixelBlue(image,ClampToQuantum((double) ((Quantum) 65535.0)*gamma*
            (double) pixel[2]),q);
        }
...
# 507 "coders/hdr.c" 3 4
   (*__errno_location ())
# 507 "coders/hdr.c"
   ); (void) ThrowMagickException(exception,"coders/hdr.c",__func__,(unsigned long) 507,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 538 "coders/hdr.c"
__attribute__ ((visibility ("default"))) size_t RegisterHDRImage(void)
{
  MagickInfo
    *entry;
...
# 570 "coders/hdr.c"
__attribute__ ((visibility ("default"))) void UnregisterHDRImage(void)
{
...
static size_t HDRWriteRunlengthPixels(Image *image,unsigned char *pixels)
{
  ...
  for (p=0; p < image->columns; )
  {
    ...
    runlength=0;
    previous_count=0;
    while ((runlength < 4) && (q < image->columns))
    {
      q+=runlength;
...
# 698 "coders/hdr.c"
 "image_info != (const ImageInfo *) NULL"
# 698 "coders/hdr.c" 3 4
 , "coders/hdr.c", 698, __extension__ __PRETTY_FUNCTION__); }))
# 698 "coders/hdr.c"
                                               ;
  
# 699 "coders/hdr.c" 3 4
 ((void) sizeof ((
# 699 "coders/hdr.c"
 image_info->signature == 0xabacadabUL
# 699 "coders/hdr.c" 3 4
...
# 699 "coders/hdr.c"
 "image_info->signature == MagickCoreSignature"
# 699 "coders/hdr.c" 3 4
 , "coders/hdr.c", 699, __extension__ __PRETTY_FUNCTION__); }))
# 699 "coders/hdr.c"
                                                     ;
  
# 700 "coders/hdr.c" 3 4
 ((void) sizeof ((
# 700 "coders/hdr.c"
 image != (Image *) 
# 700 "coders/hdr.c" 3 4
...
# 700 "coders/hdr.c"
 "image != (Image *) NULL"
# 700 "coders/hdr.c" 3 4
 , "coders/hdr.c", 700, __extension__ __PRETTY_FUNCTION__); }))
# 700 "coders/hdr.c"
                                ;
  
# 701 "coders/hdr.c" 3 4
 ((void) sizeof ((
# 701 "coders/hdr.c"
...
# 701 "coders/hdr.c" 3 4
 , "coders/hdr.c", 701, __extension__ __PRETTY_FUNCTION__); }))
# 701 "coders/hdr.c"
                                                ;
  
# 702 "coders/hdr.c" 3 4
 ((void) sizeof ((
# 702 "coders/hdr.c"
 exception != (ExceptionInfo *) 
# 702 "coders/hdr.c" 3 4
...
# 702 "coders/hdr.c"
 "exception != (ExceptionInfo *) NULL"
# 702 "coders/hdr.c" 3 4
 , "coders/hdr.c", 702, __extension__ __PRETTY_FUNCTION__); }))
# 702 "coders/hdr.c"
                                            ;
  
# 703 "coders/hdr.c" 3 4
 ((void) sizeof ((
# 703 "coders/hdr.c"
 exception->signature == 0xabacadabUL
# 703 "coders/hdr.c" 3 4
...
# 703 "coders/hdr.c"
 "exception->signature == MagickCoreSignature"
# 703 "coders/hdr.c" 3 4
 , "coders/hdr.c", 703, __extension__ __PRETTY_FUNCTION__); }))
# 703 "coders/hdr.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/hdr.c",__func__,(unsigned long) 705,"%s",image->filename);
  ...
  (void) memset(header,' ',4096);
  length=CopyMagickString(header,"#?RADIANCE\n",4096);
  (void) WriteBlob(image,length,(unsigned char *) header);
  property=GetImageProperty(image,"comment",exception);
  if ((property != (const char *) 
# 718 "coders/hdr.c" 3 4
                                 ((void *)0)
# 718 "coders/hdr.c"
                                     ) &&
      (strchr(property,'\n') == (char *) 
# 719 "coders/hdr.c" 3 4
                                        ((void *)0)
# 719 "coders/hdr.c"
                                            ))
    {
      count=FormatLocaleString(header,4096,"#%.*s\n",
        4096 -3,property);
      (void) WriteBlob(image,(size_t) count,(unsigned char *) header);
    }
  property=GetImageProperty(image,"hdr:exposure",exception);
  if (property != (const char *) 
# 726 "coders/hdr.c" 3 4
                                ((void *)0)
# 726 "coders/hdr.c"
                                    )
    {
      count=FormatLocaleString(header,4096,"EXPOSURE=%g\n",
        strtod(property,(char **) 
# 729 "coders/hdr.c" 3 4
                                 ((void *)0)
# 729 "coders/hdr.c"
                                     ));
      (void) WriteBlob(image,(size_t) count,(unsigned char *) header);
  ...
  if (image->gamma != 0.0)
    {
      count=FormatLocaleString(header,4096,"GAMMA=%g\n",
        image->gamma);
      (void) WriteBlob(image,(size_t) count,(unsigned char *) header);
    }
  count=FormatLocaleString(header,4096,
  ...
  (void) WriteBlob(image,length,(unsigned char *) header);
  count=FormatLocaleString(header,4096,"-Y %.20g +X %.20g\n",
  ...
  pixels=(unsigned char *) AcquireQuantumMemory(image->columns+128,4*
    sizeof(*pixels));
  if (pixels == (unsigned char *) 
# 755 "coders/hdr.c" 3 4
                                 ((void *)0)
# 755 "coders/hdr.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/hdr.c",__func__,(unsigned long) 756,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 756 "coders/hdr.c" 3 4
   ((void *)0)
# 756 "coders/hdr.c"
...
# 761 "coders/hdr.c"
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      pixel[2]=0;
      pixel[3]=0;
      gamma=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelRed(image,p);
      if ((((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelGreen(image,p)) > gamma)
        gamma=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelGreen(image,p);
      if ((((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelBlue(image,p)) > gamma)
        gamma=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelBlue(image,p);
      if (gamma > 1.0e-12)
        {
          int
            exponent;
          ...
          if (GetPixelRed(image,p) > 0)
            pixel[0]=(unsigned char) (gamma*((double) 1.0/(double) ((Quantum) 65535.0))*(double)
              GetPixelRed(image,p));
          if (GetPixelGreen(image,p) > 0)
            pixel[1]=(unsigned char) (gamma*((double) 1.0/(double) ((Quantum) 65535.0))*
              (double) GetPixelGreen(image,p));
          if (GetPixelBlue(image,p) > 0)
            pixel[2]=(unsigned char) (gamma*((double) 1.0/(double) ((Quantum) 65535.0))*(double)
