...
# 130 "coders/avs.c" 3 4
 , "coders/avs.c", 130, __extension__ __PRETTY_FUNCTION__); }))
# 130 "coders/avs.c"
                                               ;
  
# 131 "coders/avs.c" 3 4
 ((void) sizeof ((
# 131 "coders/avs.c"
...
# 131 "coders/avs.c" 3 4
 , "coders/avs.c", 131, __extension__ __PRETTY_FUNCTION__); }))
# 131 "coders/avs.c"
                                                     ;
  
# 132 "coders/avs.c" 3 4
 ((void) sizeof ((
# 132 "coders/avs.c"
...
# 132 "coders/avs.c" 3 4
 , "coders/avs.c", 132, __extension__ __PRETTY_FUNCTION__); }))
# 132 "coders/avs.c"
                                            ;
  
# 133 "coders/avs.c" 3 4
 ((void) sizeof ((
# 133 "coders/avs.c"
...
# 133 "coders/avs.c" 3 4
 , "coders/avs.c", 133, __extension__ __PRETTY_FUNCTION__); }))
# 133 "coders/avs.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/avs.c",__func__,(unsigned long) 135,"%s",
      image_info->filename);
...
# 142 "coders/avs.c"
  ...
  if (EOFBlob(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/avs.c",__func__,(unsigned long) 150,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 150 "coders/avs.c" 3 4
   ((void *)0)
# 150 "coders/avs.c"
...
# 150 "coders/avs.c"
  ...
  if ((width == 0UL) || (height == 0UL))
    { (void) ThrowMagickException(exception,"coders/avs.c",__func__,(unsigned long) 152,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 152 "coders/avs.c" 3 4
   ((void *)0)
# 152 "coders/avs.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 152 "coders/avs.c" 3 4
...
# 169 "coders/avs.c" 3 4
                                    ((void *)0)
# 169 "coders/avs.c"
                                        )
      { (void) ThrowMagickException(exception,"coders/avs.c",__func__,(unsigned long) 170,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 170 "coders/avs.c" 3 4
     ((void *)0)
# 170 "coders/avs.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 170 "coders/avs.c" 3 4
      ...
      if ((size_t) count != length)
        {
          ...
          { (void) ThrowMagickException(exception,"coders/avs.c",__func__,(unsigned long) 179,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 179 "coders/avs.c" 3 4
         ((void *)0)
# 179 "coders/avs.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 179 "coders/avs.c" 3 4
...
# 206 "coders/avs.c" 3 4
       (*__errno_location ())
# 206 "coders/avs.c"
       ); (void) ThrowMagickException(exception,"coders/avs.c",__func__,(unsigned long) 206,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 265 "coders/avs.c"
__attribute__ ((visibility ("default"))) size_t RegisterAVSImage(void)
{
  MagickInfo
    *entry;
...
# 296 "coders/avs.c"
__attribute__ ((visibility ("default"))) void UnregisterAVSImage(void)
{
...
# 358 "coders/avs.c"
 "image_info != (const ImageInfo *) NULL"
# 358 "coders/avs.c" 3 4
 , "coders/avs.c", 358, __extension__ __PRETTY_FUNCTION__); }))
# 358 "coders/avs.c"
                                               ;
  
# 359 "coders/avs.c" 3 4
 ((void) sizeof ((
# 359 "coders/avs.c"
 image_info->signature == 0xabacadabUL
# 359 "coders/avs.c" 3 4
...
# 359 "coders/avs.c"
 "image_info->signature == MagickCoreSignature"
# 359 "coders/avs.c" 3 4
 , "coders/avs.c", 359, __extension__ __PRETTY_FUNCTION__); }))
# 359 "coders/avs.c"
                                                     ;
  
# 360 "coders/avs.c" 3 4
 ((void) sizeof ((
# 360 "coders/avs.c"
 image != (Image *) 
# 360 "coders/avs.c" 3 4
...
# 360 "coders/avs.c"
 "image != (Image *) NULL"
# 360 "coders/avs.c" 3 4
 , "coders/avs.c", 360, __extension__ __PRETTY_FUNCTION__); }))
# 360 "coders/avs.c"
                                ;
  
# 361 "coders/avs.c" 3 4
 ((void) sizeof ((
# 361 "coders/avs.c"
...
# 361 "coders/avs.c" 3 4
 , "coders/avs.c", 361, __extension__ __PRETTY_FUNCTION__); }))
# 361 "coders/avs.c"
                                                ;
  
# 362 "coders/avs.c" 3 4
 ((void) sizeof ((
# 362 "coders/avs.c"
 exception != (ExceptionInfo *) 
# 362 "coders/avs.c" 3 4
...
# 362 "coders/avs.c"
 "exception != (ExceptionInfo *) NULL"
# 362 "coders/avs.c" 3 4
 , "coders/avs.c", 362, __extension__ __PRETTY_FUNCTION__); }))
# 362 "coders/avs.c"
                                            ;
  
# 363 "coders/avs.c" 3 4
 ((void) sizeof ((
# 363 "coders/avs.c"
 exception->signature == 0xabacadabUL
# 363 "coders/avs.c" 3 4
...
# 363 "coders/avs.c"
 "exception->signature == MagickCoreSignature"
# 363 "coders/avs.c" 3 4
 , "coders/avs.c", 363, __extension__ __PRETTY_FUNCTION__); }))
# 363 "coders/avs.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/avs.c",__func__,(unsigned long) 365,"%s",image->filename);
  ...
  do
  {
    ...
    pixel_info=AcquireVirtualMemory(image->columns,4*sizeof(*pixels));
    if (pixel_info == (MemoryInfo *) 
# 384 "coders/avs.c" 3 4
                                    ((void *)0)
# 384 "coders/avs.c"
                                        )
      { (void) ThrowMagickException(exception,"coders/avs.c",__func__,(unsigned long) 385,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 385 "coders/avs.c" 3 4
     ((void *)0)
# 385 "coders/avs.c"
...
# 393 "coders/avs.c"
      ...
      for (x=0; x < (ssize_t) image->columns; x++)
      {
        *q++=ScaleQuantumToChar((Quantum) (image->alpha_trait ==
          BlendPixelTrait ? GetPixelAlpha(image,p) : ((Quantum) ((Quantum) 65535.0))));
