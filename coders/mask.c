...
# 105 "coders/mask.c" 3 4
 , "coders/mask.c", 105, __extension__ __PRETTY_FUNCTION__); }))
# 105 "coders/mask.c"
                                               ;
  
# 106 "coders/mask.c" 3 4
 ((void) sizeof ((
# 106 "coders/mask.c"
...
# 106 "coders/mask.c" 3 4
 , "coders/mask.c", 106, __extension__ __PRETTY_FUNCTION__); }))
# 106 "coders/mask.c"
                                                     ;
  
# 107 "coders/mask.c" 3 4
 ((void) sizeof ((
# 107 "coders/mask.c"
...
# 107 "coders/mask.c" 3 4
 , "coders/mask.c", 107, __extension__ __PRETTY_FUNCTION__); }))
# 107 "coders/mask.c"
                                            ;
  
# 108 "coders/mask.c" 3 4
 ((void) sizeof ((
# 108 "coders/mask.c"
...
# 108 "coders/mask.c" 3 4
 , "coders/mask.c", 108, __extension__ __PRETTY_FUNCTION__); }))
# 108 "coders/mask.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mask.c",__func__,(unsigned long) 110,"%s",
      image_info->filename);
  read_info=CloneImageInfo(image_info);
  SetImageInfoBlob(read_info,(void *) 
# 113 "coders/mask.c" 3 4
                                     ((void *)0)
# 113 "coders/mask.c"
                                         ,0);
...
# 153 "coders/mask.c"
__attribute__ ((visibility ("default"))) size_t RegisterMASKImage(void)
{
  MagickInfo
    *entry;
...
# 184 "coders/mask.c"
__attribute__ ((visibility ("default"))) void UnregisterMASKImage(void)
{
  ...
  ExceptionInfo *exception)
{
  ...
  if (mask_image == (Image *) 
# 234 "coders/mask.c" 3 4
                             ((void *)0)
# 234 "coders/mask.c"
                                 )
    return((Image *) 
# 235 "coders/mask.c" 3 4
                    ((void *)0)
# 235 "coders/mask.c"
                        );
...
# 352 "coders/mask.c" 3 4
                              ((void *)0)
# 352 "coders/mask.c"
                                  )
    { (void) ThrowMagickException(exception,"coders/mask.c",__func__,(unsigned long) 353,CoderError,"ImageDoesNotHaveAMaskChannel", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 353 "coders/mask.c" 3 4
   ((void *)0)
# 353 "coders/mask.c"
  ...
  *write_info->magick='\0';
  ...
  if ((*write_info->magick == '\0') ||
    ...
    (void) FormatLocaleString(write_image->filename,4096,"miff:%s",
      write_info->filename);
