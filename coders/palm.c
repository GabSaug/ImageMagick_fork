...
# 292 "coders/palm.c" 3 4
 , "coders/palm.c", 292, __extension__ __PRETTY_FUNCTION__); }))
# 292 "coders/palm.c"
                                               ;
  
# 293 "coders/palm.c" 3 4
 ((void) sizeof ((
# 293 "coders/palm.c"
...
# 293 "coders/palm.c" 3 4
 , "coders/palm.c", 293, __extension__ __PRETTY_FUNCTION__); }))
# 293 "coders/palm.c"
                                                     ;
  
# 294 "coders/palm.c" 3 4
 ((void) sizeof ((
# 294 "coders/palm.c"
...
# 294 "coders/palm.c" 3 4
 , "coders/palm.c", 294, __extension__ __PRETTY_FUNCTION__); }))
# 294 "coders/palm.c"
                                            ;
  
# 295 "coders/palm.c" 3 4
 ((void) sizeof ((
# 295 "coders/palm.c"
...
# 295 "coders/palm.c" 3 4
 , "coders/palm.c", 295, __extension__ __PRETTY_FUNCTION__); }))
# 295 "coders/palm.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/palm.c",__func__,(unsigned long) 297,"%s",
      image_info->filename);
...
# 304 "coders/palm.c"
  ...
  do
  {
    ...
    if (EOFBlob(image) != MagickFalse)
      { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 312,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 312 "coders/palm.c" 3 4
     ((void *)0)
# 312 "coders/palm.c"
...
# 312 "coders/palm.c"
    ...
    if ((image->columns == 0) || (image->rows == 0))
      { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 314,CorruptImageError,"NegativeOrZeroImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 314 "coders/palm.c" 3 4
     ((void *)0)
# 314 "coders/palm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 314 "coders/palm.c" 3 4
...
# 314 "coders/palm.c"
    ...
    if ((bits_per_pixel != 1) && (bits_per_pixel != 2) &&
        ...
        (bits_per_pixel != 16))
      { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 325,CorruptImageError,"UnsupportedBitsPerPixel", "`%s'",image_info->filename); if ((image) != (Image *) 
# 325 "coders/palm.c" 3 4
     ((void *)0)
# 325 "coders/palm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 325 "coders/palm.c" 3 4
...
# 325 "coders/palm.c"
    ...
    if ((version != 0) && (version != 1) && (version != 2))
      { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 328,CorruptImageError,"FileFormatVersionMismatch", "`%s'",image_info->filename); if ((image) != (Image *) 
# 328 "coders/palm.c" 3 4
     ((void *)0)
# 328 "coders/palm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 328 "coders/palm.c" 3 4
...
# 328 "coders/palm.c"
    ...
    if ((compressionType != 0xFF) &&
      ...
      { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 335,CorruptImageError,"UnrecognizedImageCompression", "`%s'",image_info->filename); if ((image) != (Image *) 
# 335 "coders/palm.c" 3 4
     ((void *)0)
# 335 "coders/palm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 335 "coders/palm.c" 3 4
...
# 335 "coders/palm.c"
    ...
    if ((bits_per_pixel < 16) &&
      ...
      { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 343,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 343 "coders/palm.c" 3 4
     ((void *)0)
# 343 "coders/palm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 343 "coders/palm.c" 3 4
...
# 343 "coders/palm.c"
    ...
    if (bits_per_pixel == 16)
      {
        ...
        ReadBlobByte(image);
        ReadBlobByte(image);
        transpix.red=(double) (((Quantum) 65535.0)*ReadBlobByte(image)/31);
        transpix.green=(double) (((Quantum) 65535.0)*ReadBlobByte(image)/63);
        transpix.blue=(double) (((Quantum) 65535.0)*ReadBlobByte(image)/31);
      }
    if (bits_per_pixel == 8)
      {
        ssize_t
    ...
    if (status == MagickFalse)
      return(DestroyImageList(image));
    extent=(((bytes_per_row) > (2*image->columns)) ? (bytes_per_row) : (2*image->columns));
    one_row=(unsigned char *) AcquireQuantumMemory(extent,sizeof(*one_row));
    if (one_row == (unsigned char *) 
# 410 "coders/palm.c" 3 4
                                    ((void *)0)
# 410 "coders/palm.c"
                                        )
      { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 411,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 411 "coders/palm.c" 3 4
     ((void *)0)
# 411 "coders/palm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 411 "coders/palm.c" 3 4
...
# 411 "coders/palm.c"
    ...
    last_row=(unsigned char *) 
# 413 "coders/palm.c" 3 4
                              ((void *)0)
# 413 "coders/palm.c"
                                  ;
    if (compressionType == 0x00)
      {
        last_row=(unsigned char *) AcquireQuantumMemory((((bytes_per_row) > (2*image->columns)) ? (bytes_per_row) : (2*image->columns))
                           ,sizeof(*last_row));
        if (last_row == (unsigned char *) 
# 418 "coders/palm.c" 3 4
                                         ((void *)0)
# 418 "coders/palm.c"
                                             )
          {
            one_row=(unsigned char *) RelinquishMagickMemory(one_row);
            { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 421,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 421 "coders/palm.c" 3 4
           ((void *)0)
# 421 "coders/palm.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 421 "coders/palm.c" 3 4
...
# 421 "coders/palm.c"
         ...
         (void) memset(last_row,0,(((bytes_per_row) > (2*image->columns)) ? (bytes_per_row) : (2*image->columns))*
           sizeof(*last_row));
      }
          ...
          if (compressionType == 0x01)
            {
              ...
              for (i=0; i < (ssize_t) bytes_per_row; )
              {
                ...
                if (count < 0)
                  break;
                count=(((count) < ((ssize_t) bytes_per_row-i)) ? (count) : ((ssize_t) bytes_per_row-i));
          ...
          if (compressionType == 0x00)
            {
              ...
              for (i=0; i < (ssize_t) bytes_per_row; i+=8)
              {
                ...
                if (count < 0)
                  break;
                byte=(size_t) ((((ssize_t) bytes_per_row-i) < (8)) ? ((ssize_t) bytes_per_row-i) : (8));
          ...
          if (image->columns > (2*bytes_per_row))
            {
              ...
              { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 488,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 488 "coders/palm.c" 3 4
             ((void *)0)
# 488 "coders/palm.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 488 "coders/palm.c" 3 4
...
# 488 "coders/palm.c"
          ...
          for (x=0; x < (ssize_t) image->columns; x++)
          {
            color16=(*ptr++ << 8);
            color16|=(*ptr++);
            SetPixelRed(image,(Quantum) ((((Quantum) 65535.0)*((color16 >> 11) &
              0x1f))/0x1f),q);
            SetPixelGreen(image,(Quantum) ((((Quantum) 65535.0)*((color16 >> 5) &
              0x3f))/0x3f),q);
            SetPixelBlue(image,(Quantum) ((((Quantum) 65535.0)*((color16 >> 0) &
              0x1f))/0x1f),q);
            ...
            if ((size_t) (ptr-one_row) >= bytes_per_row)
              {
                ...
                if (compressionType == 0x00)
                  last_row=(unsigned char *) RelinquishMagickMemory(last_row);
                { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 514,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 514 "coders/palm.c" 3 4
               ((void *)0)
# 514 "coders/palm.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 514 "coders/palm.c" 3 4
    ...
    if (flags & 0x2000)
      {
        ...
        (void) TransparentPaintImage(image,&transpix,(Quantum) ((Quantum) 0),
...
# 555 "coders/palm.c" 3 4
       (*__errno_location ())
# 555 "coders/palm.c"
       ); (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 555,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
    ...
    if (nextDepthOffset != 0)
      {
        ...
        if (totalOffset >= (MagickOffsetType) GetBlobSize(image))
          { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 572,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 572 "coders/palm.c" 3 4
         ((void *)0)
# 572 "coders/palm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 572 "coders/palm.c" 3 4
...
# 572 "coders/palm.c"
          ...
          seekNextDepth=SeekBlob(image,totalOffset,
# 574 "coders/palm.c" 3 4
                                                  0
# 574 "coders/palm.c"
                                                          );
        if (seekNextDepth != totalOffset)
          { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 576,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 576 "coders/palm.c" 3 4
         ((void *)0)
# 576 "coders/palm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 576 "coders/palm.c" 3 4
...
# 622 "coders/palm.c"
__attribute__ ((visibility ("default"))) size_t RegisterPALMImage(void)
{
  MagickInfo
    *entry;
...
# 655 "coders/palm.c"
__attribute__ ((visibility ("default"))) void UnregisterPALMImage(void)
{
...
# 746 "coders/palm.c"
 "image_info != (const ImageInfo *) NULL"
# 746 "coders/palm.c" 3 4
 , "coders/palm.c", 746, __extension__ __PRETTY_FUNCTION__); }))
# 746 "coders/palm.c"
                                               ;
  
# 747 "coders/palm.c" 3 4
 ((void) sizeof ((
# 747 "coders/palm.c"
 image_info->signature == 0xabacadabUL
# 747 "coders/palm.c" 3 4
...
# 747 "coders/palm.c"
 "image_info->signature == MagickCoreSignature"
# 747 "coders/palm.c" 3 4
 , "coders/palm.c", 747, __extension__ __PRETTY_FUNCTION__); }))
# 747 "coders/palm.c"
                                                     ;
  
# 748 "coders/palm.c" 3 4
 ((void) sizeof ((
# 748 "coders/palm.c"
 image != (Image *) 
# 748 "coders/palm.c" 3 4
...
# 748 "coders/palm.c"
 "image != (Image *) NULL"
# 748 "coders/palm.c" 3 4
 , "coders/palm.c", 748, __extension__ __PRETTY_FUNCTION__); }))
# 748 "coders/palm.c"
                                ;
  
# 749 "coders/palm.c" 3 4
 ((void) sizeof ((
# 749 "coders/palm.c"
...
# 749 "coders/palm.c" 3 4
 , "coders/palm.c", 749, __extension__ __PRETTY_FUNCTION__); }))
# 749 "coders/palm.c"
                                                ;
  
# 750 "coders/palm.c" 3 4
 ((void) sizeof ((
# 750 "coders/palm.c"
 exception != (ExceptionInfo *) 
# 750 "coders/palm.c" 3 4
...
# 750 "coders/palm.c"
 "exception != (ExceptionInfo *) NULL"
# 750 "coders/palm.c" 3 4
 , "coders/palm.c", 750, __extension__ __PRETTY_FUNCTION__); }))
# 750 "coders/palm.c"
                                            ;
  
# 751 "coders/palm.c" 3 4
 ((void) sizeof ((
# 751 "coders/palm.c"
 exception->signature == 0xabacadabUL
# 751 "coders/palm.c" 3 4
...
# 751 "coders/palm.c"
 "exception->signature == MagickCoreSignature"
# 751 "coders/palm.c" 3 4
 , "coders/palm.c", 751, __extension__ __PRETTY_FUNCTION__); }))
# 751 "coders/palm.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/palm.c",__func__,(unsigned long) 753,"%s",image->filename);
  ...
  do
  {
    ...
    count=GetNumberColors(image,
# 773 "coders/palm.c" 3 4
                               ((void *)0)
# 773 "coders/palm.c"
                                   ,exception);
    ...
    if (image_info->compression == FaxCompression)
      {
        last_row=(unsigned char *) AcquireQuantumMemory(bytes_per_row+256,
          sizeof(*last_row));
        if (last_row == (unsigned char *) 
# 881 "coders/palm.c" 3 4
                                         ((void *)0)
# 881 "coders/palm.c"
                                             )
          {
            quantize_info=DestroyQuantizeInfo(quantize_info);
            { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 884,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 884 "coders/palm.c" 3 4
           ((void *)0)
# 884 "coders/palm.c"
    ...
    one_row=(unsigned char *) AcquireQuantumMemory(bytes_per_row+256,
      sizeof(*one_row));
    if (one_row == (unsigned char *) 
# 889 "coders/palm.c" 3 4
                                    ((void *)0)
# 889 "coders/palm.c"
                                        )
      {
        if (last_row != (unsigned char *) 
# 891 "coders/palm.c" 3 4
                                         ((void *)0)
# 891 "coders/palm.c"
                                             )
          last_row=(unsigned char *) RelinquishMagickMemory(last_row);
        quantize_info=DestroyQuantizeInfo(quantize_info);
        { (void) ThrowMagickException(exception,"coders/palm.c",__func__,(unsigned long) 894,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 894 "coders/palm.c" 3 4
       ((void *)0)
# 894 "coders/palm.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      }
...
# 901 "coders/palm.c"
      ...
      if (bits_per_pixel == 16)
        {
          for (x=0; x < (ssize_t) image->columns; x++)
          {
            color16=(unsigned short) ((((31*(ssize_t) GetPixelRed(image,p))/
              (ssize_t) ((Quantum) 65535.0)) << 11) | (((63*(ssize_t)
              GetPixelGreen(image,p))/(ssize_t) ((Quantum) 65535.0)) << 5) |
              ((31*(ssize_t) GetPixelBlue(image,p))/(ssize_t) ((Quantum) 65535.0)));
          ...
          for (x=0; x < (ssize_t) image->columns; x++)
          {
            if (bits_per_pixel >= 8)
              ...
              color=(unsigned char) (GetPixelIndex(image,p)*
                ((one << bits_per_pixel)-1)/(((1*image->colors-1) > (1)) ? (1*image->colors-1) : (1)));
            byte|=color << bit;
            if (bit != 0)
        ...
        if (image_info->compression == FaxCompression)
          {
            ...
            {
              tptr = tmpbuf;
              for (bit=0, byte=0; bit < (int) (((8L) < ((ssize_t) bytes_per_row-x)) ? (8L) : ((ssize_t) bytes_per_row-x)); bit++)
              {
    ...
    if (flags & 0x2000)
      {
        offset=SeekBlob(image,currentOffset+6,
# 992 "coders/palm.c" 3 4
                                             0
# 992 "coders/palm.c"
                                                     );
        (void) WriteBlobMSBShort(image,flags);
        offset=SeekBlob(image,currentOffset+12,
# 994 "coders/palm.c" 3 4
                                              0
# 994 "coders/palm.c"
                                                      );
        (void) WriteBlobByte(image,(unsigned char) transparentIndex);
    ...
    if (bits_per_pixel == 16)
      {
        offset=SeekBlob(image,currentOffset+20,
# 999 "coders/palm.c" 3 4
                                              0
# 999 "coders/palm.c"
                                                      );
        (void) WriteBlobByte(image,0);
    ...
    if (flags & 0x8000)
      {
        offset=SeekBlob(image,currentOffset+offset,
# 1010 "coders/palm.c" 3 4
                                                  0
# 1010 "coders/palm.c"
                                                          );
    ...
    if (one_row != (unsigned char *) 
# 1014 "coders/palm.c" 3 4
                                    ((void *)0)
# 1014 "coders/palm.c"
                                        )
      one_row=(unsigned char *) RelinquishMagickMemory(one_row);
    if (last_row != (unsigned char *) 
# 1016 "coders/palm.c" 3 4
                                     ((void *)0)
# 1016 "coders/palm.c"
                                         )
      last_row=(unsigned char *) RelinquishMagickMemory(last_row);
    if (GetNextImageInList(image) == (Image *) 
# 1018 "coders/palm.c" 3 4
                                              ((void *)0)
# 1018 "coders/palm.c"
                                                  )
      break;
    ...
    offset=SeekBlob(image,currentOffset+10,
# 1024 "coders/palm.c" 3 4
                                          0
# 1024 "coders/palm.c"
                                                  );
    ...
    offset=SeekBlob(image,currentOffset,
# 1029 "coders/palm.c" 3 4
                                       0
# 1029 "coders/palm.c"
                                               );
    image=SyncNextImageInList(image);
