...
static Image *Read1XImage(Image *image,ExceptionInfo *exception)
{
  ...
  if ((rows != 32 && rows != 64) || (columns != 32 && columns != 64))
    { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 190,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); return((Image *) 
# 190 "coders/icon.c" 3 4
   ((void *)0)
# 190 "coders/icon.c"
   ); };
  ...
  if (AcquireImageColormap(image,3,exception) == MagickFalse)
    return(DestroyImage(image));
  image->colormap[1].alpha=((Quantum) 0);
  for (i=0; i < 2; i++)
  {
    ssize_t
      y;
...
# 288 "coders/icon.c" 3 4
 , "coders/icon.c", 288, __extension__ __PRETTY_FUNCTION__); }))
# 288 "coders/icon.c"
                                               ;
  
# 289 "coders/icon.c" 3 4
 ((void) sizeof ((
# 289 "coders/icon.c"
...
# 289 "coders/icon.c" 3 4
 , "coders/icon.c", 289, __extension__ __PRETTY_FUNCTION__); }))
# 289 "coders/icon.c"
                                                     ;
  (void) LogMagickEvent(CoderEvent,"coders/icon.c",__func__,(unsigned long) 290,"%s",image_info->filename);
  
# 291 "coders/icon.c" 3 4
 ((void) sizeof ((
# 291 "coders/icon.c"
...
# 291 "coders/icon.c" 3 4
 , "coders/icon.c", 291, __extension__ __PRETTY_FUNCTION__); }))
# 291 "coders/icon.c"
                                            ;
  
# 292 "coders/icon.c" 3 4
 ((void) sizeof ((
# 292 "coders/icon.c"
...
# 292 "coders/icon.c" 3 4
 , "coders/icon.c", 292, __extension__ __PRETTY_FUNCTION__); }))
# 292 "coders/icon.c"
                                                    ;
...
# 298 "coders/icon.c"
  ...
  if ((icon_file.reserved != 0) ||
      ...
      (icon_file.count > 1024))
    { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 310,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 310 "coders/icon.c" 3 4
   ((void *)0)
# 310 "coders/icon.c"
...
# 310 "coders/icon.c"
  ...
  for (i=0; i < icon_file.count; i++)
  {
    ...
    if (EOFBlob(image) != MagickFalse)
      break;
    extent=(((extent) > (icon_file.directory[i].size)) ? (extent) : (icon_file.directory[i].size));
  }
  if ((EOFBlob(image) != MagickFalse) || (extent > GetBlobSize(image)))
    { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 328,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 328 "coders/icon.c" 3 4
   ((void *)0)
# 328 "coders/icon.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 328 "coders/icon.c" 3 4
...
# 336 "coders/icon.c" 3 4
                                   0
# 336 "coders/icon.c"
                                           );
    if (offset < 0)
      { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 338,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 338 "coders/icon.c" 3 4
     ((void *)0)
# 338 "coders/icon.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 338 "coders/icon.c" 3 4
...
# 346 "coders/icon.c" 3 4
       (*__errno_location ())
# 346 "coders/icon.c"
       ); (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 346,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
    if (((icon_info.planes == 18505) && (icon_info.bits_per_pixel == 21060)) ||
        (icon_info.size == 0x474e5089))
      {
        ...
        if ((length < 16) || (~length < 16))
          { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 370,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 370 "coders/icon.c" 3 4
         ((void *)0)
# 370 "coders/icon.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 370 "coders/icon.c" 3 4
...
# 370 "coders/icon.c"
        ...
        if (png == (unsigned char *) 
# 372 "coders/icon.c" 3 4
                                    ((void *)0)
# 372 "coders/icon.c"
                                        )
          { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 373,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 373 "coders/icon.c" 3 4
         ((void *)0)
# 373 "coders/icon.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 373 "coders/icon.c" 3 4
        ...
        if (count != (ssize_t) (length-16))
          {
            ...
            { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 383,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 383 "coders/icon.c" 3 4
           ((void *)0)
# 383 "coders/icon.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 383 "coders/icon.c" 3 4
...
# 383 "coders/icon.c"
        ...
        (void) CopyMagickString(read_info->magick,"PNG",4096);
        icon_image=BlobToImage(read_info,png,length,exception);
        read_info=DestroyImageInfo(read_info);
        png=(unsigned char *) RelinquishMagickMemory(png);
        if (icon_image == (Image *) 
# 391 "coders/icon.c" 3 4
                                   ((void *)0)
# 391 "coders/icon.c"
                                       )
          return(DestroyImageList(image));
    ...
    else
      {
        if (icon_info.bits_per_pixel > 32)
          { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 400,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 400 "coders/icon.c" 3 4
         ((void *)0)
# 400 "coders/icon.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 400 "coders/icon.c" 3 4
...
# 400 "coders/icon.c"
        ...
        if (icon_info.number_colors > GetBlobSize(image))
          { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 407,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 407 "coders/icon.c" 3 4
         ((void *)0)
# 407 "coders/icon.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 407 "coders/icon.c" 3 4
...
# 407 "coders/icon.c"
        ...
        if (image->debug != MagickFalse)
          {
            (void) LogMagickEvent(CoderEvent,"coders/icon.c",__func__,(unsigned long) 425,
              " scene    = %.20g",(double) i);
            (void) LogMagickEvent(CoderEvent,"coders/icon.c",__func__,(unsigned long) 427,
              "   size   = %.20g",(double) icon_info.size);
            (void) LogMagickEvent(CoderEvent,"coders/icon.c",__func__,(unsigned long) 429,
              "   width  = %.20g",(double) icon_file.directory[i].width);
            (void) LogMagickEvent(CoderEvent,"coders/icon.c",__func__,(unsigned long) 431,
              "   height = %.20g",(double) icon_file.directory[i].height);
            (void) LogMagickEvent(CoderEvent,"coders/icon.c",__func__,(unsigned long) 433,
              "   colors = %.20g",(double ) icon_info.number_colors);
            (void) LogMagickEvent(CoderEvent,"coders/icon.c",__func__,(unsigned long) 435,
              "   planes = %.20g",(double) icon_info.planes);
            (void) LogMagickEvent(CoderEvent,"coders/icon.c",__func__,(unsigned long) 437,
      ...
      if (image->storage_class == PseudoClass)
        {
          ...
          if (image->colors > GetBlobSize(image))
            { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 459,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 459 "coders/icon.c" 3 4
           ((void *)0)
# 459 "coders/icon.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 459 "coders/icon.c" 3 4
...
# 459 "coders/icon.c"
          ...
          if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
            { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 462,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 462 "coders/icon.c" 3 4
           ((void *)0)
# 462 "coders/icon.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 462 "coders/icon.c" 3 4
...
# 462 "coders/icon.c"
          ...
          if (icon_colormap == (unsigned char *) 
# 465 "coders/icon.c" 3 4
                                                ((void *)0)
# 465 "coders/icon.c"
                                                    )
            { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 466,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 466 "coders/icon.c" 3 4
           ((void *)0)
# 466 "coders/icon.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 466 "coders/icon.c" 3 4
          ...
          if (count != (ssize_t) (4*image->colors))
            {
              icon_colormap=(unsigned char *) RelinquishMagickMemory(
                icon_colormap);
              { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 472,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 472 "coders/icon.c" 3 4
             ((void *)0)
# 472 "coders/icon.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 472 "coders/icon.c" 3 4
...
# 674 "coders/icon.c"
          ...
          default:
            { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 685,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 685 "coders/icon.c" 3 4
           ((void *)0)
# 685 "coders/icon.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 685 "coders/icon.c" 3 4
...
# 699 "coders/icon.c"
              ...
              for (x=0; x < ((ssize_t) image->columns-7); x+=8)
              {
                ...
                for (bit=0; bit < 8; bit++)
                {
                  SetPixelAlpha(image,(((byte & (0x80 >> bit)) != 0) ?
                    ((Quantum) 0) : ((Quantum) ((Quantum) 65535.0))),q);
                  q+=GetPixelChannels(image);
                }
              }
              if ((image->columns % 8) != 0)
        ...
        if (EOFBlob(image) != MagickFalse)
          {
            { char *file_message; file_message=GetExceptionMessage(
# 730 "coders/icon.c" 3 4
           (*__errno_location ())
# 730 "coders/icon.c"
           ); (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 730,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                    ;
            break;
          }
      }
...
# 788 "coders/icon.c"
__attribute__ ((visibility ("default"))) size_t RegisterICONImage(void)
{
  MagickInfo
    *entry;
...
# 835 "coders/icon.c"
__attribute__ ((visibility ("default"))) void UnregisterICONImage(void)
{
  ...
  MagickOffsetType *count,ExceptionInfo *exception)
{
  ...
  size_t
    sizes[16]={256, 192, 128, 96, 64, 48, 40, 32, 24, 16};

  ssize_t
    i;

  images=
# 897 "coders/icon.c" 3 4
        ((void *)0)
# 897 "coders/icon.c"
            ;
  *count=0;
...
# 913 "coders/icon.c"
  ...
  *count=i;
  for (i=0; i < *count; i++)
  {
    ...
    if (resized == (Image *) 
# 922 "coders/icon.c" 3 4
                            ((void *)0)
# 922 "coders/icon.c"
                                )
      return(DestroyImageList(images));
    if (images == (Image *) 
# 924 "coders/icon.c" 3 4
                           ((void *)0)
# 924 "coders/icon.c"
                               )
      images=resized;
...
# 976 "coders/icon.c"
 "image_info != (const ImageInfo *) NULL"
# 976 "coders/icon.c" 3 4
 , "coders/icon.c", 976, __extension__ __PRETTY_FUNCTION__); }))
# 976 "coders/icon.c"
                                               ;
  
# 977 "coders/icon.c" 3 4
 ((void) sizeof ((
# 977 "coders/icon.c"
 image_info->signature == 0xabacadabUL
# 977 "coders/icon.c" 3 4
...
# 977 "coders/icon.c"
 "image_info->signature == MagickCoreSignature"
# 977 "coders/icon.c" 3 4
 , "coders/icon.c", 977, __extension__ __PRETTY_FUNCTION__); }))
# 977 "coders/icon.c"
                                                     ;
  
# 978 "coders/icon.c" 3 4
 ((void) sizeof ((
# 978 "coders/icon.c"
 image != (Image *) 
# 978 "coders/icon.c" 3 4
...
# 978 "coders/icon.c"
 "image != (Image *) NULL"
# 978 "coders/icon.c" 3 4
 , "coders/icon.c", 978, __extension__ __PRETTY_FUNCTION__); }))
# 978 "coders/icon.c"
                                ;
  
# 979 "coders/icon.c" 3 4
 ((void) sizeof ((
# 979 "coders/icon.c"
...
# 979 "coders/icon.c" 3 4
 , "coders/icon.c", 979, __extension__ __PRETTY_FUNCTION__); }))
# 979 "coders/icon.c"
                                                ;
    (void) LogMagickEvent(CoderEvent,"coders/icon.c",__func__,(unsigned long) 980,"%s",image->filename);
  
# 981 "coders/icon.c" 3 4
 ((void) sizeof ((
# 981 "coders/icon.c"
 exception != (ExceptionInfo *) 
# 981 "coders/icon.c" 3 4
...
# 981 "coders/icon.c"
 "exception != (ExceptionInfo *) NULL"
# 981 "coders/icon.c" 3 4
 , "coders/icon.c", 981, __extension__ __PRETTY_FUNCTION__); }))
# 981 "coders/icon.c"
                                            ;
  
# 982 "coders/icon.c" 3 4
 ((void) sizeof ((
# 982 "coders/icon.c"
 exception->signature == 0xabacadabUL
# 982 "coders/icon.c" 3 4
...
# 982 "coders/icon.c"
 "exception->signature == MagickCoreSignature"
# 982 "coders/icon.c" 3 4
 , "coders/icon.c", 982, __extension__ __PRETTY_FUNCTION__); }))
# 982 "coders/icon.c"
                                                    ;
...
# 989 "coders/icon.c"
                                  )
    {
      ...
      if (images == (Image *) 
# 992 "coders/icon.c" 3 4
                             ((void *)0)
# 992 "coders/icon.c"
                                 )
        { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 993,ImageError,"InvalidDimensions", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 993 "coders/icon.c" 3 4
       ((void *)0)
# 993 "coders/icon.c"
  ...
  else
    {
      ...
      do
      {
        if ((image->columns > 256L) || (image->rows > 256L))
          { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 1003,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1003 "coders/icon.c" 3 4
         ((void *)0)
# 1003 "coders/icon.c"
         ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
        scene++;
...
# 1032 "coders/icon.c" 3 4
                             ((void *)0)
# 1032 "coders/icon.c"
                                 ) && (adjoin != MagickFalse));
  scene=0;
  next=(images != (Image *) 
# 1034 "coders/icon.c" 3 4
                           ((void *)0)
# 1034 "coders/icon.c"
                               ) ? images : image;
...
# 1055 "coders/icon.c"
        ...
        (void) CopyMagickString(write_info->magick,"PNG32",4096);
        length=0;
...
# 1076 "coders/icon.c"
    ...
    else
      {
        ...
        icon_info.compression=(size_t) 0;
...
# 1180 "coders/icon.c" 3 4
                                       ((void *)0)
# 1180 "coders/icon.c"
                                           )
          {
            images=DestroyImageList(images);
            { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 1183,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1183 "coders/icon.c" 3 4
           ((void *)0)
# 1183 "coders/icon.c"
           ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
          }
...
# 1220 "coders/icon.c" 3 4
                                             ((void *)0)
# 1220 "coders/icon.c"
                                                 )
                {
                  status=SetImageProgress(next,"Save/Image",y,next->rows);
                  if (status == MagickFalse)
                    break;
                }
            }
              ...
              for (x=0; x < (ssize_t) next->columns; x++)
              {
                ...
                *q++=ScaleQuantumToChar(GetPixelRed(next,p));
                if (next->alpha_trait == UndefinedPixelTrait)
                  *q++=ScaleQuantumToChar(((Quantum) 65535.0));
                else
        ...
        if (next->storage_class == PseudoClass)
          {
            ...
            if (icon_colormap == (unsigned char *) 
# 1365 "coders/icon.c" 3 4
                                                  ((void *)0)
# 1365 "coders/icon.c"
                                                      )
              {
                images=DestroyImageList(images);
                { (void) ThrowMagickException(exception,"coders/icon.c",__func__,(unsigned long) 1368,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1368 "coders/icon.c" 3 4
               ((void *)0)
# 1368 "coders/icon.c"
               ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }
                                           ;
...
# 1404 "coders/icon.c"
          ...
          for (x=0; x < (ssize_t) next->columns; x++)
          {
            byte<<=1;
            if ((next->alpha_trait != UndefinedPixelTrait) &&
                (GetPixelAlpha(next,p) == (Quantum) ((Quantum) 0)))
              byte|=0x01;
            bit++;
            if (bit == 8)
              {
...
# 1429 "coders/icon.c" 3 4
                                             ((void *)0)
# 1429 "coders/icon.c"
                                                 )
      break;
    status=SetImageProgress(next,"Save/Images",scene++,number_scenes);
    if (status == MagickFalse)
      break;
    next=SyncNextImageInList(next);
  } while ((next != (Image *) 
# 1435 "coders/icon.c" 3 4
                             ((void *)0)
# 1435 "coders/icon.c"
                                 ) && (adjoin != MagickFalse));
  offset=SeekBlob(image,0,
# 1436 "coders/icon.c" 3 4
                         0
# 1436 "coders/icon.c"
                                 );
  (void) offset;
