...
typedef enum
{
  ...
  VIPSBandFormatUCHAR = 0,
  VIPSBandFormatCHAR = 1,
  VIPSBandFormatUSHORT = 2,
  VIPSBandFormatSHORT = 3,
  VIPSBandFormatUINT = 4,
  VIPSBandFormatINT = 5,
  VIPSBandFormatFLOAT = 6,
  VIPSBandFormatCOMPLEX = 7,
  VIPSBandFormatDOUBLE = 8,
  VIPSBandFormatDPCOMPLEX = 9
} VIPSBandFormat;
  ...
  switch(type)
  {
    ...
    case VIPSTypesRGB:
      switch(format)
      {
        ...
        case VIPSBandFormatFLOAT:
          return((Quantum) ((double) ((Quantum) 65535.0)*((double)
            ReadBlobFloat(image)/1.0)));
        case VIPSBandFormatDOUBLE:
          return((Quantum) ((double) ((Quantum) 65535.0)*(ReadBlobDouble(
            image)/1.0)));
        default:
          return((Quantum) 0);
      }
...
# 394 "coders/vips.c" 3 4
 , "coders/vips.c", 394, __extension__ __PRETTY_FUNCTION__); }))
# 394 "coders/vips.c"
                                               ;
  
# 395 "coders/vips.c" 3 4
 ((void) sizeof ((
# 395 "coders/vips.c"
...
# 395 "coders/vips.c" 3 4
 , "coders/vips.c", 395, __extension__ __PRETTY_FUNCTION__); }))
# 395 "coders/vips.c"
                                                     ;
  
# 396 "coders/vips.c" 3 4
 ((void) sizeof ((
# 396 "coders/vips.c"
...
# 396 "coders/vips.c" 3 4
 , "coders/vips.c", 396, __extension__ __PRETTY_FUNCTION__); }))
# 396 "coders/vips.c"
                                            ;
  
# 397 "coders/vips.c" 3 4
 ((void) sizeof ((
# 397 "coders/vips.c"
...
# 397 "coders/vips.c" 3 4
 , "coders/vips.c", 397, __extension__ __PRETTY_FUNCTION__); }))
# 397 "coders/vips.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/vips.c",__func__,(unsigned long) 399,"%s",
      image_info->filename);
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 406 "coders/vips.c" 3 4
                      ((void *)0)
# 406 "coders/vips.c"
                          );
    }
  marker=ReadBlobLSBLong(image);
  if (marker == 0x08f2a6b6U)
    image->endian=LSBEndian;
  else
    if (marker == 0xb6a6f208U)
      image->endian=MSBEndian;
    else
      { (void) ThrowMagickException(exception,"coders/vips.c",__func__,(unsigned long) 415,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 415 "coders/vips.c" 3 4
     ((void *)0)
# 415 "coders/vips.c"
...
# 415 "coders/vips.c"
  ...
  switch(format)
  {
    ...
    case VIPSBandFormatNOTSET:
      { (void) ThrowMagickException(exception,"coders/vips.c",__func__,(unsigned long) 446,CoderError,"Unsupported band format", "`%s'",image_info->filename); if ((image) != (Image *) 
# 446 "coders/vips.c" 3 4
     ((void *)0)
# 446 "coders/vips.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 446 "coders/vips.c" 3 4
...
# 446 "coders/vips.c"
  ...
  switch(type)
  {
    ...
    case VIPSTypeXYZ:
    case VIPSTypeYXY:
      { (void) ThrowMagickException(exception,"coders/vips.c",__func__,(unsigned long) 485,CoderError,"Unsupported colorspace", "`%s'",image_info->filename); if ((image) != (Image *) 
# 485 "coders/vips.c" 3 4
     ((void *)0)
# 485 "coders/vips.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 485 "coders/vips.c" 3 4
...
# 485 "coders/vips.c"
  ...
  if (IsSupportedCombination(format,type) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/vips.c",__func__,(unsigned long) 500,CoderError,"Unsupported combination of band format and colorspace", "`%s'",image_info->filename); if ((image) != (Image *) 
# 500 "coders/vips.c" 3 4
   ((void *)0)
# 500 "coders/vips.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 500 "coders/vips.c" 3 4
...
# 500 "coders/vips.c"
  ...
  if (channels == 0 || channels > 5)
    { (void) ThrowMagickException(exception,"coders/vips.c",__func__,(unsigned long) 503,CoderError,"Unsupported number of channels", "`%s'",image_info->filename); if ((image) != (Image *) 
# 503 "coders/vips.c" 3 4
   ((void *)0)
# 503 "coders/vips.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 503 "coders/vips.c" 3 4
...
# 503 "coders/vips.c"
  ...
  if (coding == VIPSCodingNONE)
    ...
    { (void) ThrowMagickException(exception,"coders/vips.c",__func__,(unsigned long) 507,CoderError,"Unsupported coding", "`%s'",image_info->filename); if ((image) != (Image *) 
# 507 "coders/vips.c" 3 4
   ((void *)0)
# 507 "coders/vips.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 507 "coders/vips.c" 3 4
...
# 507 "coders/vips.c"
  ...
  metadata=(char *) 
# 508 "coders/vips.c" 3 4
                   ((void *)0)
# 508 "coders/vips.c"
                       ;
  while ((n=ReadBlob(image,4096 -1,(unsigned char *) buffer)) != 0)
  {
    buffer[n]='\0';
    if (metadata == (char *) 
# 512 "coders/vips.c" 3 4
                            ((void *)0)
# 512 "coders/vips.c"
                                )
...
# 551 "coders/vips.c"
__attribute__ ((visibility ("default"))) size_t RegisterVIPSImage(void)
{
  MagickInfo
    *entry;
...
# 584 "coders/vips.c"
__attribute__ ((visibility ("default"))) void UnregisterVIPSImage(void)
{
...
# 643 "coders/vips.c"
 "image_info != (const ImageInfo *) NULL"
# 643 "coders/vips.c" 3 4
 , "coders/vips.c", 643, __extension__ __PRETTY_FUNCTION__); }))
# 643 "coders/vips.c"
                                               ;
  
# 644 "coders/vips.c" 3 4
 ((void) sizeof ((
# 644 "coders/vips.c"
 image_info->signature == 0xabacadabUL
# 644 "coders/vips.c" 3 4
...
# 644 "coders/vips.c"
 "image_info->signature == MagickCoreSignature"
# 644 "coders/vips.c" 3 4
 , "coders/vips.c", 644, __extension__ __PRETTY_FUNCTION__); }))
# 644 "coders/vips.c"
                                                     ;
  
# 645 "coders/vips.c" 3 4
 ((void) sizeof ((
# 645 "coders/vips.c"
 image != (Image *) 
# 645 "coders/vips.c" 3 4
...
# 645 "coders/vips.c"
 "image != (Image *) NULL"
# 645 "coders/vips.c" 3 4
 , "coders/vips.c", 645, __extension__ __PRETTY_FUNCTION__); }))
# 645 "coders/vips.c"
                                ;
  
# 646 "coders/vips.c" 3 4
 ((void) sizeof ((
# 646 "coders/vips.c"
...
# 646 "coders/vips.c" 3 4
 , "coders/vips.c", 646, __extension__ __PRETTY_FUNCTION__); }))
# 646 "coders/vips.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/vips.c",__func__,(unsigned long) 648,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  if (image->endian == LSBEndian)
    (void) WriteBlobLSBLong(image,0x08f2a6b6U);
  else
    (void) WriteBlobLSBLong(image,0xb6a6f208U);
...
# 734 "coders/vips.c"
  ...
  if (metadata != (const char*) 
# 766 "coders/vips.c" 3 4
                               ((void *)0)
# 766 "coders/vips.c"
                                   )
