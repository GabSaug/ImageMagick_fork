...
# 2361 "coders/tiff.c"
__attribute__ ((visibility ("default"))) size_t RegisterTIFFImage(void)
{
...
# 2447 "coders/tiff.c"
  ...
  entry->note=ConstantString(TIFFNote);
  (void) RegisterMagickInfo(entry);
  entry=AcquireMagickInfo("TIFF","TIF","Tagged Image File Format");
  ...
  entry->note=ConstantString(TIFFNote);
  (void) RegisterMagickInfo(entry);
  entry=AcquireMagickInfo("TIFF","TIFF","Tagged Image File Format");
...
# 2540 "coders/tiff.c"
__attribute__ ((visibility ("default"))) void UnregisterTIFFImage(void)
{
