...
# 392 "coders/xcf.c"
 "image != (Image *) NULL"
# 392 "coders/xcf.c" 3 4
 , "coders/xcf.c", 392, __extension__ __PRETTY_FUNCTION__); }))
# 392 "coders/xcf.c"
                                ;
  
# 393 "coders/xcf.c" 3 4
 ((void) sizeof ((
# 393 "coders/xcf.c"
...
# 393 "coders/xcf.c" 3 4
 , "coders/xcf.c", 393, __extension__ __PRETTY_FUNCTION__); }))
# 393 "coders/xcf.c"
                                                ;
  
# 394 "coders/xcf.c" 3 4
 ((void) sizeof ((
# 394 "coders/xcf.c"
 max != 0
# 394 "coders/xcf.c" 3 4
...
# 394 "coders/xcf.c"
 "max != 0"
# 394 "coders/xcf.c" 3 4
 , "coders/xcf.c", 394, __extension__ __PRETTY_FUNCTION__); }))
# 394 "coders/xcf.c"
                 ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/xcf.c",__func__,(unsigned long) 396,"%s",image->filename);
  length=ReadBlobMSBLong(image);
  for (i=0; i < (ssize_t) (((length) < (max-1)) ? (length) : (max-1)); i++)
  {
    c=ReadBlobByte(image);
    if (c == 
# 401 "coders/xcf.c" 3 4
            (-1)
# 401 "coders/xcf.c"
               )
      return((char *) 
# 402 "coders/xcf.c" 3 4
                     ((void *)0)
# 402 "coders/xcf.c"
                         );
    string[i]=(char) c;
  ...
  string[i]='\0';
  offset=SeekBlob(image,((MagickOffsetType) length-i),
# 406 "coders/xcf.c" 3 4
                                                     1
# 406 "coders/xcf.c"
                                                             );
  if (offset < 0)
    (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 408,
  ...
  ExceptionInfo *exception)
{
  ...
  if (extent > data_length)
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 454,CorruptImageError,"NotEnoughPixelData", "`%s'",image->filename); return(MagickFalse); }
                      ;
  xcfdata=(XCFPixelInfo *) AcquireQuantumMemory((((data_length) > (tile_image->columns*tile_image->rows)) ? (data_length) : (tile_image->columns*tile_image->rows))
                                         ,sizeof(*xcfdata));
  if (xcfdata == (XCFPixelInfo *) 
# 458 "coders/xcf.c" 3 4
                                 ((void *)0)
# 458 "coders/xcf.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 459,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  xcfodata=xcfdata;
  ...
  if (count != (ssize_t) data_length)
    {
      ...
      { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 467,CorruptImageError,"NotEnoughPixelData", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
      ...
      if (inDocInfo->image_type == GIMP_RGB)
        {
          for (x=0; x < (ssize_t) tile_image->columns; x++)
          {
            ...
            SetPixelAlpha(tile_image,xcfdata->alpha == 255U ? ((Quantum) 0) :
  ...
  ExceptionInfo *exception)
{
  ...
  if (xcfdata == (unsigned char *) 
# 538 "coders/xcf.c" 3 4
                                  ((void *)0)
# 538 "coders/xcf.c"
                                      )
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 539,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
...
# 550 "coders/xcf.c"
  ...
  bogus_rle:
  if (xcfodata != (unsigned char *) 
# 680 "coders/xcf.c" 3 4
                                   ((void *)0)
# 680 "coders/xcf.c"
                                       )
    xcfodata=(unsigned char *) RelinquishMagickMemory(xcfodata);
  ...
  XCFLayerInfo *inLayerInfo,ExceptionInfo *exception)
{
  ...
  if (EOFBlob(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 725,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image->filename); return(MagickFalse); }
                      ;
  if (offset == 0)
    {
  ...
  ntile_rows=(height+64 -1)/64;
  ntile_cols=(width+64 -1)/64;
  ntiles=ntile_rows*ntile_cols;
  for (i = 0; i < (ssize_t) ntiles; i++)
  {
    status=MagickFalse;
    if (offset == 0)
      { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 742,CorruptImageError,"NotEnoughTiles", "`%s'",image->filename); return(MagickFalse); };
    ...
    if ((MagickSizeType) offset2 >= inDocInfo->file_size)
      { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 751,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image->filename); return(MagickFalse); }
                        ;


    if (offset2 == 0)
      offset2=(MagickOffsetType) (offset + 64 * 64 * 4* 1.5);

    if ((offset > offset2) || (SeekBlob(image, offset, 
# 758 "coders/xcf.c" 3 4
                                                      0
# 758 "coders/xcf.c"
                                                              ) != offset))
      { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 759,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image->filename); return(MagickFalse); }
                        ;
      ...
      if (tile_image == (Image *) 
# 776 "coders/xcf.c" 3 4
                                 ((void *)0)
# 776 "coders/xcf.c"
                                     )
        { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 777,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                          ;
      ...
      switch (inDocInfo->compression)
      {
        ...
        case COMPRESS_ZLIB:
          ...
          { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 794,CoderError,"ZipCompressNotSupported", "`%s'",image->filename); return(MagickFalse); }

        case COMPRESS_FRACTAL:
          tile_image=DestroyImage(tile_image);
          { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 798,CoderError,"FractalCompressNotSupported", "`%s'",image->filename); return(MagickFalse); }
      ...
      if (status != MagickFalse)
        (void) CompositeImage(inLayerInfo->image,tile_image,CopyCompositeOp,
          MagickTrue,destLeft * 64,destTop*64,exception);
      tile_image=DestroyImage(tile_image);
      ...
      offset=SeekBlob(image, saved_pos, 
# 820 "coders/xcf.c" 3 4
                                       0
# 820 "coders/xcf.c"
                                               );
  ...
  if (offset != 0)
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 825,CorruptImageError,"CorruptImage", "`%s'",image->filename); return(MagickFalse); }
  return(MagickTrue);
}
   ...
   XCFLayerInfo *inLayer, ExceptionInfo *exception)
{
  ...
  if ((MagickSizeType) offset >= GetBlobSize(image))
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 847,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image->filename); return(MagickFalse); }
                      ;
...
# 864 "coders/xcf.c" 3 4
                             0
# 864 "coders/xcf.c"
                                     ) != offset)
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 865,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image->filename); return(MagickFalse); }
                      ;
  ...
  ExceptionInfo *exception)
{
  ...
  if (EOFBlob(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 914,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image->filename); return(MagickFalse); }
                      ;
  if ((outLayer->width == 0) || (outLayer->height == 0))
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 917,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); return(MagickFalse); }
                      ;
...
# 969 "coders/xcf.c" 3 4
        (*__errno_location ())
# 969 "coders/xcf.c"
        ); (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 969,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                 ;
# 984 "coders/xcf.c"
     }
     break;
    default:
      ...
      while ((prop_size > 0) && (EOFBlob(image) == MagickFalse))
        {
        amount = (ssize_t) (((16) < (prop_size)) ? (16) : (prop_size));
        amount = ReadBlob(image, (size_t) amount, (unsigned char *) &buf);
        if (!amount)
          { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1000,CorruptImageError,"CorruptImage", "`%s'",image->filename); return(MagickFalse); }
                            ;
        prop_size -= (size_t) (((16) < ((size_t) amount)) ? (16) : ((size_t) amount));
        }
      }
      break;
    }
  ...
  if (EOFBlob(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1009,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image->filename); return(MagickFalse); }
                      ;
      ...
      if (scene > (ssize_t) (image_info->scene+image_info->number_scenes-1))
        {
          ...
          if (outLayer->image == (Image *) 
# 1023 "coders/xcf.c" 3 4
                                          ((void *)0)
# 1023 "coders/xcf.c"
                                              )
            return(MagickFalse);
...
# 1031 "coders/xcf.c"
  ...
  offset=SeekBlob(image, hierarchy_offset, 
# 1068 "coders/xcf.c" 3 4
                                          0
# 1068 "coders/xcf.c"
                                                  );
  if (offset != hierarchy_offset)
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1070,CorruptImageError,"InvalidImageHeader", "`%s'",image->filename); return(MagickFalse); }
                      ;
  ...
  if (layer_mask_offset != 0)
    {
      offset=SeekBlob(image, (MagickOffsetType) layer_mask_offset, 
# 1078 "coders/xcf.c" 3 4
                                                                  0
# 1078 "coders/xcf.c"
                                                                          );
# 1095 "coders/xcf.c"
...
# 1171 "coders/xcf.c" 3 4
 , "coders/xcf.c", 1171, __extension__ __PRETTY_FUNCTION__); }))
# 1171 "coders/xcf.c"
                                               ;
  
# 1172 "coders/xcf.c" 3 4
 ((void) sizeof ((
# 1172 "coders/xcf.c"
...
# 1172 "coders/xcf.c" 3 4
 , "coders/xcf.c", 1172, __extension__ __PRETTY_FUNCTION__); }))
# 1172 "coders/xcf.c"
                                                     ;
  
# 1173 "coders/xcf.c" 3 4
 ((void) sizeof ((
# 1173 "coders/xcf.c"
...
# 1173 "coders/xcf.c" 3 4
 , "coders/xcf.c", 1173, __extension__ __PRETTY_FUNCTION__); }))
# 1173 "coders/xcf.c"
                                            ;
  
# 1174 "coders/xcf.c" 3 4
 ((void) sizeof ((
# 1174 "coders/xcf.c"
...
# 1174 "coders/xcf.c" 3 4
 , "coders/xcf.c", 1174, __extension__ __PRETTY_FUNCTION__); }))
# 1174 "coders/xcf.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/xcf.c",__func__,(unsigned long) 1176,"%s",
      image_info->filename);
...
# 1183 "coders/xcf.c"
  ...
  if ((count != sizeof(magick)) ||
    ...
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1188,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1188 "coders/xcf.c" 3 4
   ((void *)0)
# 1188 "coders/xcf.c"
...
# 1188 "coders/xcf.c"
  ...
  if ((doc_info.width > 262144) || (doc_info.height > 262144))
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1194,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1194 "coders/xcf.c" 3 4
   ((void *)0)
# 1194 "coders/xcf.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1194 "coders/xcf.c" 3 4
  ...
  if (doc_info.version >= 4)
    {
      ...
      if (precision == 0)
        precision=150;
      if (precision != 150)
        { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1203,CoderError,"DataStorageTypeIsNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1203 "coders/xcf.c" 3 4
       ((void *)0)
# 1203 "coders/xcf.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1203 "coders/xcf.c" 3 4
...
# 1203 "coders/xcf.c"
  ...
  if (image_type == GIMP_INDEXED)
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1220,CoderError,"ColormapTypeNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1220 "coders/xcf.c" 3 4
   ((void *)0)
# 1220 "coders/xcf.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1220 "coders/xcf.c" 3 4
...
# 1220 "coders/xcf.c"
  ...
  if (image_type == GIMP_RGB)
    ...
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1226,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1226 "coders/xcf.c" 3 4
   ((void *)0)
# 1226 "coders/xcf.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1226 "coders/xcf.c" 3 4
    ...
    switch (prop_type)
    {
      ...
      case PROP_COLORMAP:
      {
        ...
        if (DiscardBlobBytes(image,3*num_colors) == MagickFalse)
          { char *file_message; file_message=GetExceptionMessage(
# 1249 "coders/xcf.c" 3 4
         (*__errno_location ())
# 1249 "coders/xcf.c"
         ); (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1249,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                  ;
# 1280 "coders/xcf.c"
        break;
      }
      case PROP_COMPRESSION:
      {
        ...
        if ((doc_info.compression != COMPRESS_NONE) &&
          ...
          { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1289,CorruptImageError,"UnrecognizedImageCompression", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1289 "coders/xcf.c" 3 4
         ((void *)0)
# 1289 "coders/xcf.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1289 "coders/xcf.c" 3 4
...
# 1289 "coders/xcf.c"
      ...
      case PROP_GUIDES:
      {
        ...
        if (DiscardBlobBytes(image,prop_size) == MagickFalse)
          { char *file_message; file_message=GetExceptionMessage(
# 1297 "coders/xcf.c" 3 4
         (*__errno_location ())
# 1297 "coders/xcf.c"
         ); (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1297,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                  ;
      }
      break;
    ...
    case PROP_PARASITES:
      {
        ...
        if (DiscardBlobBytes(image,prop_size) == MagickFalse)
          { char *file_message; file_message=GetExceptionMessage(
# 1331 "coders/xcf.c" 3 4
         (*__errno_location ())
# 1331 "coders/xcf.c"
         ); (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1331,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                  ;
# 1346 "coders/xcf.c"
          }
      break;
    ...
    case PROP_PATHS:
      {
        ...
        if (DiscardBlobBytes(image,prop_size) == MagickFalse)
          { char *file_message; file_message=GetExceptionMessage(
# 1360 "coders/xcf.c" 3 4
         (*__errno_location ())
# 1360 "coders/xcf.c"
         ); (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1360,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                            ;
    ...
    case PROP_USER_UNIT:
     ...
     break;
      ...
      while ((prop_size > 0) && (EOFBlob(image) == MagickFalse))
      {
        ...
        if (!amount)
          { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1393,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1393 "coders/xcf.c" 3 4
         ((void *)0)
# 1393 "coders/xcf.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1393 "coders/xcf.c" 3 4
...
# 1393 "coders/xcf.c"
  ...
  if (foundPropEnd == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1401,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1401 "coders/xcf.c" 3 4
   ((void *)0)
# 1401 "coders/xcf.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1401 "coders/xcf.c" 3 4
        ...
        if (offset == 0)
        ...
        else
          {
            ...
            if (AcquireMagickResource(ListLengthResource,number_layers) == MagickFalse)
              { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1436,ResourceLimitError,"ListLengthExceedsLimit", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1436 "coders/xcf.c" 3 4
             ((void *)0)
# 1436 "coders/xcf.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1436 "coders/xcf.c" 3 4
...
# 1436 "coders/xcf.c"
        ...
        if (EOFBlob(image) != MagickFalse)
          {
            { char *file_message; file_message=GetExceptionMessage(
# 1440 "coders/xcf.c" 3 4
           (*__errno_location ())
# 1440 "coders/xcf.c"
           ); (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1440,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                    ;
            break;
          }
    } while (foundAllLayers == MagickFalse);
    doc_info.number_layers=number_layers;
    offset=SeekBlob(image,oldPos,
# 1446 "coders/xcf.c" 3 4
                                0
# 1446 "coders/xcf.c"
                                        );
    if (offset < 0)
      { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1448,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1448 "coders/xcf.c" 3 4
     ((void *)0)
# 1448 "coders/xcf.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1448 "coders/xcf.c" 3 4
...
# 1448 "coders/xcf.c"
    ...
    layer_info=(XCFLayerInfo *) AcquireQuantumMemory(length,
      sizeof(*layer_info));
    if (layer_info == (XCFLayerInfo *) 
# 1453 "coders/xcf.c" 3 4
                                      ((void *)0)
# 1453 "coders/xcf.c"
                                          )
      { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1454,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1454 "coders/xcf.c" 3 4
     ((void *)0)
# 1454 "coders/xcf.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1454 "coders/xcf.c" 3 4
      ...
      if (layer_ok == MagickFalse)
        {
          ...
          for (j=0; j <= current_layer; j++)
            if (layer_info[j].image != (Image *) 
# 1488 "coders/xcf.c" 3 4
                                                ((void *)0)
# 1488 "coders/xcf.c"
                                                    )
              layer_info[j].image=DestroyImage(layer_info[j].image);
          layer_info=(XCFLayerInfo *) RelinquishMagickMemory(layer_info);
          { (void) ThrowMagickException(exception,"coders/xcf.c",__func__,(unsigned long) 1491,CorruptImageError,"NotEnoughPixelData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1491 "coders/xcf.c" 3 4
         ((void *)0)
# 1491 "coders/xcf.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1491 "coders/xcf.c" 3 4
...
# 1606 "coders/xcf.c"
__attribute__ ((visibility ("default"))) size_t RegisterXCFImage(void)
{
  MagickInfo
    *entry;
...
# 1638 "coders/xcf.c"
__attribute__ ((visibility ("default"))) void UnregisterXCFImage(void)
{
