...
# 129 "coders/mtv.c" 3 4
 , "coders/mtv.c", 129, __extension__ __PRETTY_FUNCTION__); }))
# 129 "coders/mtv.c"
                                               ;
  
# 130 "coders/mtv.c" 3 4
 ((void) sizeof ((
# 130 "coders/mtv.c"
...
# 130 "coders/mtv.c" 3 4
 , "coders/mtv.c", 130, __extension__ __PRETTY_FUNCTION__); }))
# 130 "coders/mtv.c"
                                                     ;
  
# 131 "coders/mtv.c" 3 4
 ((void) sizeof ((
# 131 "coders/mtv.c"
...
# 131 "coders/mtv.c" 3 4
 , "coders/mtv.c", 131, __extension__ __PRETTY_FUNCTION__); }))
# 131 "coders/mtv.c"
                                            ;
  
# 132 "coders/mtv.c" 3 4
 ((void) sizeof ((
# 132 "coders/mtv.c"
...
# 132 "coders/mtv.c" 3 4
 , "coders/mtv.c", 132, __extension__ __PRETTY_FUNCTION__); }))
# 132 "coders/mtv.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mtv.c",__func__,(unsigned long) 134,"%s",
      image_info->filename);
...
# 141 "coders/mtv.c"
  ...
  if (count != 2)
    { (void) ThrowMagickException(exception,"coders/mtv.c",__func__,(unsigned long) 150,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 150 "coders/mtv.c" 3 4
   ((void *)0)
# 150 "coders/mtv.c"
...
# 170 "coders/mtv.c" 3 4
                                   ((void *)0)
# 170 "coders/mtv.c"
                                       )
      { (void) ThrowMagickException(exception,"coders/mtv.c",__func__,(unsigned long) 171,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 171 "coders/mtv.c" 3 4
     ((void *)0)
# 171 "coders/mtv.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 171 "coders/mtv.c" 3 4
      ...
      if (count != (ssize_t) (3*image->columns))
        {
          ...
          { (void) ThrowMagickException(exception,"coders/mtv.c",__func__,(unsigned long) 178,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 178 "coders/mtv.c" 3 4
         ((void *)0)
# 178 "coders/mtv.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 178 "coders/mtv.c" 3 4
...
# 205 "coders/mtv.c" 3 4
       (*__errno_location ())
# 205 "coders/mtv.c"
       ); (void) ThrowMagickException(exception,"coders/mtv.c",__func__,(unsigned long) 205,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 267 "coders/mtv.c"
__attribute__ ((visibility ("default"))) size_t RegisterMTVImage(void)
{
  MagickInfo
    *entry;
...
# 298 "coders/mtv.c"
__attribute__ ((visibility ("default"))) void UnregisterMTVImage(void)
{
...
# 360 "coders/mtv.c"
 "image_info != (const ImageInfo *) NULL"
# 360 "coders/mtv.c" 3 4
 , "coders/mtv.c", 360, __extension__ __PRETTY_FUNCTION__); }))
# 360 "coders/mtv.c"
                                               ;
  
# 361 "coders/mtv.c" 3 4
 ((void) sizeof ((
# 361 "coders/mtv.c"
 image_info->signature == 0xabacadabUL
# 361 "coders/mtv.c" 3 4
...
# 361 "coders/mtv.c"
 "image_info->signature == MagickCoreSignature"
# 361 "coders/mtv.c" 3 4
 , "coders/mtv.c", 361, __extension__ __PRETTY_FUNCTION__); }))
# 361 "coders/mtv.c"
                                                     ;
  
# 362 "coders/mtv.c" 3 4
 ((void) sizeof ((
# 362 "coders/mtv.c"
 image != (Image *) 
# 362 "coders/mtv.c" 3 4
...
# 362 "coders/mtv.c"
 "image != (Image *) NULL"
# 362 "coders/mtv.c" 3 4
 , "coders/mtv.c", 362, __extension__ __PRETTY_FUNCTION__); }))
# 362 "coders/mtv.c"
                                ;
  
# 363 "coders/mtv.c" 3 4
 ((void) sizeof ((
# 363 "coders/mtv.c"
...
# 363 "coders/mtv.c" 3 4
 , "coders/mtv.c", 363, __extension__ __PRETTY_FUNCTION__); }))
# 363 "coders/mtv.c"
                                                ;
  
# 364 "coders/mtv.c" 3 4
 ((void) sizeof ((
# 364 "coders/mtv.c"
 exception != (ExceptionInfo *) 
# 364 "coders/mtv.c" 3 4
...
# 364 "coders/mtv.c"
 "exception != (ExceptionInfo *) NULL"
# 364 "coders/mtv.c" 3 4
 , "coders/mtv.c", 364, __extension__ __PRETTY_FUNCTION__); }))
# 364 "coders/mtv.c"
                                            ;
  
# 365 "coders/mtv.c" 3 4
 ((void) sizeof ((
# 365 "coders/mtv.c"
 exception->signature == 0xabacadabUL
# 365 "coders/mtv.c" 3 4
...
# 365 "coders/mtv.c"
 "exception->signature == MagickCoreSignature"
# 365 "coders/mtv.c" 3 4
 , "coders/mtv.c", 365, __extension__ __PRETTY_FUNCTION__); }))
# 365 "coders/mtv.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mtv.c",__func__,(unsigned long) 367,"%s",image->filename);
  ...
  do
  {
    ...
    pixels=(unsigned char *) AcquireQuantumMemory(image->columns,
      3UL*sizeof(*pixels));
    if (pixels == (unsigned char *) 
# 382 "coders/mtv.c" 3 4
                                   ((void *)0)
# 382 "coders/mtv.c"
                                       )
      { (void) ThrowMagickException(exception,"coders/mtv.c",__func__,(unsigned long) 383,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 383 "coders/mtv.c" 3 4
     ((void *)0)
# 383 "coders/mtv.c"
