  ...
  ExceptionInfo *exception)
{
  ...
  image=(Image *) 
# 959 "coders/pattern.c" 3 4
                 ((void *)0)
# 959 "coders/pattern.c"
                     ;
  blob=(const void *) 
# 960 "coders/pattern.c" 3 4
                     ((void *)0)
# 960 "coders/pattern.c"
                         ;
  extent=0;
  ...
  if (blob == (const void *) 
# 971 "coders/pattern.c" 3 4
                            ((void *)0)
# 971 "coders/pattern.c"
                                )
    {
      blob_info=DestroyImageInfo(blob_info);
      { (void) ThrowMagickException(exception,"coders/pattern.c",__func__,(unsigned long) 974,OptionError,"UnrecognizedImageFormat", "`%s'",image_info->filename); if ((image) != (Image *) 
# 974 "coders/pattern.c" 3 4
     ((void *)0)
# 974 "coders/pattern.c"
...
# 977 "coders/pattern.c" 3 4
                                  ((void *)0)
# 977 "coders/pattern.c"
                                      )
    {
      Image
        *pattern_image;
      ...
      (void) SetImageAlpha(pattern_image,((Quantum) ((Quantum) 65535.0)),exception);
...
# 1018 "coders/pattern.c"
__attribute__ ((visibility ("default"))) size_t RegisterPATTERNImage(void)
{
  MagickInfo
    *entry;
...
# 1049 "coders/pattern.c"
__attribute__ ((visibility ("default"))) void UnregisterPATTERNImage(void)
{
