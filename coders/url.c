...
# 1 "/usr/include/libxml2/libxml/nanoftp.h" 1
# 61 "/usr/include/libxml2/libxml/nanoftp.h"
typedef void (*ftpListCallback) (void *userData,
     ...
     int minute);
# 75 "/usr/include/libxml2/libxml/nanoftp.h"
...
# 1 "/usr/include/libxml2/libxml/nanohttp.h" 1
# 21 "/usr/include/libxml2/libxml/nanohttp.h"
 void
  ...
  if (LocaleCompare(read_info->magick,"https") == 0)
    {
      ...
      status=InvokeDelegate(read_info,image,"https:decode",(char *) 
# 161 "coders/url.c" 3 4
                                                                   ((void *)0)
# 161 "coders/url.c"
                                                                       ,
        exception);
      if (status != MagickFalse)
        {
          ...
          *read_info->magick='\0';
          ...
          if (images != (Image *) 
# 170 "coders/url.c" 3 4
                                 ((void *)0)
# 170 "coders/url.c"
                                     )
            for (next=images; next != (Image *) 
# 171 "coders/url.c" 3 4
                                               ((void *)0)
# 171 "coders/url.c"
                                                   ; next=next->next)
...
# 194 "coders/url.c" 3 4
                                              ((void *)0)
# 194 "coders/url.c"
                                                  ))
    {
      { char *file_message; file_message=GetExceptionMessage(
# 196 "coders/url.c" 3 4
     (*__errno_location ())
# 196 "coders/url.c"
     ); (void) ThrowMagickException(exception,"coders/url.c",__func__,(unsigned long) 196,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",read_info->filename,file_message); file_message=DestroyString(file_message); }
                            ;
      read_info=DestroyImageInfo(read_info);
      image=DestroyImage(image);
      return((Image *) 
# 200 "coders/url.c" 3 4
                      ((void *)0)
# 200 "coders/url.c"
                          );
    }
  (void) CopyMagickString(filename,image_info->magick,4096);
  (void) ConcatenateMagickString(filename,":",4096);
  ...
  if (LocaleCompare(read_info->magick,"http") == 0)
    {
      ...
      type=(char *) 
# 249 "coders/url.c" 3 4
                   ((void *)0)
# 249 "coders/url.c"
                       ;
      context=xmlNanoHTTPMethod(filename,(const char *) 
# 250 "coders/url.c" 3 4
                                                       ((void *)0)
# 250 "coders/url.c"
                                                           ,
        (const char *) 
# 251 "coders/url.c" 3 4
                      ((void *)0)
# 251 "coders/url.c"
                          ,&type,(const char *) 
# 251 "coders/url.c" 3 4
...
# 252 "coders/url.c"
  ...
  *read_info->magick='\0';
  ...
  (void) RelinquishUniqueFileResource(read_info->filename);
  if (images != (Image *) 
# 271 "coders/url.c" 3 4
                         ((void *)0)
# 271 "coders/url.c"
                             )
    for (next=images; next != (Image *) 
# 272 "coders/url.c" 3 4
                                       ((void *)0)
# 272 "coders/url.c"
                                           ; next=next->next)
      (void) CopyMagickString(next->filename,image->filename,4096);
  read_info=DestroyImageInfo(read_info);
  image=DestroyImage(image);
  if (images != (Image *) 
# 276 "coders/url.c" 3 4
                         ((void *)0)
# 276 "coders/url.c"
                             )
    ...
    {
      (void) ThrowMagickException(exception,"coders/url.c",__func__,(unsigned long) 280,CoderError,
        "NoDataReturned","`%s'",filename);
      return((Image *) 
# 282 "coders/url.c" 3 4
                      ((void *)0)
# 282 "coders/url.c"
                          );
    }
...
# 310 "coders/url.c"
__attribute__ ((visibility ("default"))) size_t RegisterURLImage(void)
{
  MagickInfo
    *entry;
...
# 359 "coders/url.c"
__attribute__ ((visibility ("default"))) void UnregisterURLImage(void)
{
