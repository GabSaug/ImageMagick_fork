...
# 164 "coders/pwp.c" 3 4
 , "coders/pwp.c", 164, __extension__ __PRETTY_FUNCTION__); }))
# 164 "coders/pwp.c"
                                               ;
  
# 165 "coders/pwp.c" 3 4
 ((void) sizeof ((
# 165 "coders/pwp.c"
...
# 165 "coders/pwp.c" 3 4
 , "coders/pwp.c", 165, __extension__ __PRETTY_FUNCTION__); }))
# 165 "coders/pwp.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pwp.c",__func__,(unsigned long) 167,"%s",
      image_info->filename);
  
# 169 "coders/pwp.c" 3 4
 ((void) sizeof ((
# 169 "coders/pwp.c"
...
# 169 "coders/pwp.c" 3 4
 , "coders/pwp.c", 169, __extension__ __PRETTY_FUNCTION__); }))
# 169 "coders/pwp.c"
                                            ;
  
# 170 "coders/pwp.c" 3 4
 ((void) sizeof ((
# 170 "coders/pwp.c"
...
# 170 "coders/pwp.c" 3 4
 , "coders/pwp.c", 170, __extension__ __PRETTY_FUNCTION__); }))
# 170 "coders/pwp.c"
                                                    ;
...
# 176 "coders/pwp.c"
  ...
  if ((count != 5) || (LocaleNCompare((char *) magick,"SFW95",5) != 0))
    { (void) ThrowMagickException(exception,"coders/pwp.c",__func__,(unsigned long) 182,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 182 "coders/pwp.c" 3 4
   ((void *)0)
# 182 "coders/pwp.c"
...
# 184 "coders/pwp.c" 3 4
                                                                      ((void *)0)
# 184 "coders/pwp.c"
                                                                          ,
    (void *) 
# 185 "coders/pwp.c" 3 4
            ((void *)0)
# 185 "coders/pwp.c"
                );
  SetImageInfoBlob(read_info,(void *) 
# 186 "coders/pwp.c" 3 4
                                     ((void *)0)
# 186 "coders/pwp.c"
                                         ,0);
  unique_file=AcquireUniqueFileResource(filename);
  (void) FormatLocaleString(read_info->filename,4096,"sfw:%s",
    filename);
  for ( ; ; )
  {
    (void) memset(magick,0,sizeof(magick));
    for (c=ReadBlobByte(pwp_image); c != 
# 193 "coders/pwp.c" 3 4
                                        (-1)
# 193 "coders/pwp.c"
...
# 201 "coders/pwp.c"
               )
      {
        ...
        { (void) ThrowMagickException(exception,"coders/pwp.c",__func__,(unsigned long) 205,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 205 "coders/pwp.c" 3 4
       ((void *)0)
# 205 "coders/pwp.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 205 "coders/pwp.c" 3 4
    ...
    if (LocaleNCompare((char *) (magick+12),"SFW94A",6) != 0)
      {
        (void) RelinquishUniqueFileResource(filename);
        read_info=DestroyImageInfo(read_info);
        { (void) ThrowMagickException(exception,"coders/pwp.c",__func__,(unsigned long) 211,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 211 "coders/pwp.c" 3 4
       ((void *)0)
# 211 "coders/pwp.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 211 "coders/pwp.c" 3 4
...
# 223 "coders/pwp.c" 3 4
       (*__errno_location ())
# 223 "coders/pwp.c"
       ); (void) ThrowMagickException(exception,"coders/pwp.c",__func__,(unsigned long) 223,FileOpenError,"UnableToWriteFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        image=DestroyImageList(image);
        return((Image *) 
# 226 "coders/pwp.c" 3 4
                        ((void *)0)
# 226 "coders/pwp.c"
                            );
      }
...
# 240 "coders/pwp.c"
               )
      {
        (void) RelinquishUniqueFileResource(filename);
        read_info=DestroyImageInfo(read_info);
        { (void) ThrowMagickException(exception,"coders/pwp.c",__func__,(unsigned long) 244,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 244 "coders/pwp.c" 3 4
       ((void *)0)
# 244 "coders/pwp.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 244 "coders/pwp.c" 3 4
...
# 244 "coders/pwp.c"
    ...
    if (next_image == (Image *) 
# 247 "coders/pwp.c" 3 4
                               ((void *)0)
# 247 "coders/pwp.c"
                                   )
      break;
    (void) FormatLocaleString(next_image->filename,4096,
      "slide_%02ld.sfw",(long) next_image->scene);
    if (image == (Image *) 
# 251 "coders/pwp.c" 3 4
                          ((void *)0)
# 251 "coders/pwp.c"
                              )
      image=next_image;
    else
      {
        ...
        for (p=image; p->next != (Image *) 
# 258 "coders/pwp.c" 3 4
                                          ((void *)0)
# 258 "coders/pwp.c"
    ...
    if (image_info->number_scenes != 0)
      if (next_image->scene >= (image_info->scene+image_info->number_scenes-1))
        break;
    status=SetImageProgress(image,"Load/Images",TellBlob(pwp_image),
...
# 282 "coders/pwp.c" 3 4
                                     (*__errno_location ())
# 282 "coders/pwp.c"
                                          );
          (void) ThrowMagickException(exception,"coders/pwp.c",__func__,(unsigned long) 283,
...
# 316 "coders/pwp.c"
__attribute__ ((visibility ("default"))) size_t RegisterPWPImage(void)
{
  MagickInfo
    *entry;
...
# 347 "coders/pwp.c"
__attribute__ ((visibility ("default"))) void UnregisterPWPImage(void)
{
