# 0 "coders/thumbnail.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "coders/thumbnail.c"
# 42 "coders/thumbnail.c"
...
# 56 "coders/thumbnail.c" 2
# 1 "./MagickCore/quantum-private.h" 1
# 22 "./MagickCore/quantum-private.h"
...
# 23 "./MagickCore/quantum-private.h" 2
...
# 90 "coders/thumbnail.c"
__attribute__ ((visibility ("default"))) size_t RegisterTHUMBNAILImage(void)
{
  MagickInfo
    *entry;
...
# 120 "coders/thumbnail.c"
__attribute__ ((visibility ("default"))) void UnregisterTHUMBNAILImage(void)
{
  (void) UnregisterMagickInfo("THUMBNAIL");
}
# 152 "coders/thumbnail.c"
...
# 186 "coders/thumbnail.c" 3 4
                                     ((void *)0)
# 186 "coders/thumbnail.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/thumbnail.c",__func__,(unsigned long) 187,CoderError,"ImageDoesNotHaveAThumbnail", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 187 "coders/thumbnail.c" 3 4
   ((void *)0)
# 187 "coders/thumbnail.c"
...
# 189 "coders/thumbnail.c" 3 4
                                ((void *)0)
# 189 "coders/thumbnail.c"
                                    )
    { (void) ThrowMagickException(exception,"coders/thumbnail.c",__func__,(unsigned long) 190,CoderError,"ImageDoesNotHaveAThumbnail", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 190 "coders/thumbnail.c" 3 4
   ((void *)0)
# 190 "coders/thumbnail.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  offset=(ssize_t) StringToLong(property);
  if (offset < 0)
    { (void) ThrowMagickException(exception,"coders/thumbnail.c",__func__,(unsigned long) 193,CoderError,"ImageDoesNotHaveAThumbnail", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 193 "coders/thumbnail.c" 3 4
   ((void *)0)
# 193 "coders/thumbnail.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  property=GetImageProperty(image,"exif:JPEGInterchangeFormatLength",exception);
  if (property == (const char *) 
# 195 "coders/thumbnail.c" 3 4
                                ((void *)0)
# 195 "coders/thumbnail.c"
                                    )
    { (void) ThrowMagickException(exception,"coders/thumbnail.c",__func__,(unsigned long) 196,CoderError,"ImageDoesNotHaveAThumbnail", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 196 "coders/thumbnail.c" 3 4
   ((void *)0)
# 196 "coders/thumbnail.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  ...
  if ((q > (GetStringInfoDatum(profile)+GetStringInfoLength(profile))) ||
    ...
    { (void) ThrowMagickException(exception,"coders/thumbnail.c",__func__,(unsigned long) 207,CoderError,"ImageDoesNotHaveAThumbnail", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 207 "coders/thumbnail.c" 3 4
   ((void *)0)
# 207 "coders/thumbnail.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  thumbnail_image=BlobToImage(image_info,q,length,exception);
  if (thumbnail_image == (Image *) 
# 209 "coders/thumbnail.c" 3 4
                                  ((void *)0)
# 209 "coders/thumbnail.c"
                                      )
    return(MagickFalse);
...
# 219 "coders/thumbnail.c" 3 4
                                         ((void *)0)
# 219 "coders/thumbnail.c"
                                             ) ||
      (LocaleCompare(magick_info->module,"THUMBNAIL") == 0))
    (void) FormatLocaleString(thumbnail_image->filename,4096,
