...
# 122 "coders/mac.c" 3 4
 , "coders/mac.c", 122, __extension__ __PRETTY_FUNCTION__); }))
# 122 "coders/mac.c"
                                               ;
  
# 123 "coders/mac.c" 3 4
 ((void) sizeof ((
# 123 "coders/mac.c"
...
# 123 "coders/mac.c" 3 4
 , "coders/mac.c", 123, __extension__ __PRETTY_FUNCTION__); }))
# 123 "coders/mac.c"
                                                     ;
  
# 124 "coders/mac.c" 3 4
 ((void) sizeof ((
# 124 "coders/mac.c"
...
# 124 "coders/mac.c" 3 4
 , "coders/mac.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "coders/mac.c"
                                            ;
  
# 125 "coders/mac.c" 3 4
 ((void) sizeof ((
# 125 "coders/mac.c"
...
# 125 "coders/mac.c" 3 4
 , "coders/mac.c", 125, __extension__ __PRETTY_FUNCTION__); }))
# 125 "coders/mac.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mac.c",__func__,(unsigned long) 127,"%s",
      image_info->filename);
...
# 134 "coders/mac.c"
  ...
  if ((length & 0xff) != 0)
    { (void) ThrowMagickException(exception,"coders/mac.c",__func__,(unsigned long) 141,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 141 "coders/mac.c" 3 4
   ((void *)0)
# 141 "coders/mac.c"
...
# 145 "coders/mac.c" 3 4
                                  (-1)
# 145 "coders/mac.c"
                                     )
          { (void) ThrowMagickException(exception,"coders/mac.c",__func__,(unsigned long) 146,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 146 "coders/mac.c" 3 4
         ((void *)0)
# 146 "coders/mac.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 146 "coders/mac.c" 3 4
...
# 146 "coders/mac.c"
    ...
    for (x=0; x < (ssize_t) 638; x++)
      if (ReadBlobByte(image) == 
# 150 "coders/mac.c" 3 4
                                (-1)
# 150 "coders/mac.c"
                                   )
        { (void) ThrowMagickException(exception,"coders/mac.c",__func__,(unsigned long) 151,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 151 "coders/mac.c" 3 4
       ((void *)0)
# 151 "coders/mac.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 151 "coders/mac.c" 3 4
...
# 151 "coders/mac.c"
  ...
  if (AcquireImageColormap(image,2,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/mac.c",__func__,(unsigned long) 156,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 156 "coders/mac.c" 3 4
   ((void *)0)
# 156 "coders/mac.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 156 "coders/mac.c" 3 4
...
# 173 "coders/mac.c" 3 4
                                 ((void *)0)
# 173 "coders/mac.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/mac.c",__func__,(unsigned long) 174,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 174 "coders/mac.c" 3 4
   ((void *)0)
# 174 "coders/mac.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 174 "coders/mac.c" 3 4
...
# 285 "coders/mac.c"
__attribute__ ((visibility ("default"))) size_t RegisterMACImage(void)
{
  MagickInfo
    *entry;
...
# 315 "coders/mac.c"
__attribute__ ((visibility ("default"))) void UnregisterMACImage(void)
{
