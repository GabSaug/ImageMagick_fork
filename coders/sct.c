...
# 161 "coders/sct.c" 3 4
 , "coders/sct.c", 161, __extension__ __PRETTY_FUNCTION__); }))
# 161 "coders/sct.c"
                                               ;
  
# 162 "coders/sct.c" 3 4
 ((void) sizeof ((
# 162 "coders/sct.c"
...
# 162 "coders/sct.c" 3 4
 , "coders/sct.c", 162, __extension__ __PRETTY_FUNCTION__); }))
# 162 "coders/sct.c"
                                                     ;
  
# 163 "coders/sct.c" 3 4
 ((void) sizeof ((
# 163 "coders/sct.c"
...
# 163 "coders/sct.c" 3 4
 , "coders/sct.c", 163, __extension__ __PRETTY_FUNCTION__); }))
# 163 "coders/sct.c"
                                            ;
  
# 164 "coders/sct.c" 3 4
 ((void) sizeof ((
# 164 "coders/sct.c"
...
# 164 "coders/sct.c" 3 4
 , "coders/sct.c", 164, __extension__ __PRETTY_FUNCTION__); }))
# 164 "coders/sct.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/sct.c",__func__,(unsigned long) 166,"%s",
      image_info->filename);
...
# 173 "coders/sct.c"
  ...
  if ((LocaleNCompare((char *) magick,"CT",2) != 0) &&
    ...
    { (void) ThrowMagickException(exception,"coders/sct.c",__func__,(unsigned long) 188,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 188 "coders/sct.c" 3 4
   ((void *)0)
# 188 "coders/sct.c"
...
# 188 "coders/sct.c"
  ...
  if ((LocaleNCompare((char *) magick,"LW",2) == 0) ||
      ...
      (LocaleNCompare((char *) magick,"PG",2) == 0) ||
      (LocaleNCompare((char *) magick,"TX",2) == 0))
    { (void) ThrowMagickException(exception,"coders/sct.c",__func__,(unsigned long) 193,CoderError,"OnlyContinuousTonePictureSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 193 "coders/sct.c" 3 4
   ((void *)0)
# 193 "coders/sct.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 193 "coders/sct.c" 3 4
...
# 193 "coders/sct.c"
  ...
  buffer[14]='\0';
  height=StringToDouble((char *) buffer,(char **) 
# 206 "coders/sct.c" 3 4
                                                 ((void *)0)
# 206 "coders/sct.c"
                                                     );
  count=ReadBlob(image,14,buffer);
  width=StringToDouble((char *) buffer,(char **) 
# 208 "coders/sct.c" 3 4
                                                ((void *)0)
# 208 "coders/sct.c"
                                                    );
  ...
  if ((image->columns < 1) || (image->rows < 1) ||
      (width < 1.0e-12) || (height < 1.0e-12))
    { (void) ThrowMagickException(exception,"coders/sct.c",__func__,(unsigned long) 220,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 220 "coders/sct.c" 3 4
   ((void *)0)
# 220 "coders/sct.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 220 "coders/sct.c" 3 4
...
# 220 "coders/sct.c"
  ...
  if (EOFBlob(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/sct.c",__func__,(unsigned long) 222,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 222 "coders/sct.c" 3 4
   ((void *)0)
# 222 "coders/sct.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 222 "coders/sct.c" 3 4
...
# 248 "coders/sct.c"
        ...
        if (image->colorspace == CMYKColorspace)
          pixel=(Quantum) (((Quantum) 65535.0)-pixel);
        switch (i)
        {
          case 0:
          {
...
# 296 "coders/sct.c" 3 4
   (*__errno_location ())
# 296 "coders/sct.c"
   ); (void) ThrowMagickException(exception,"coders/sct.c",__func__,(unsigned long) 296,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 328 "coders/sct.c"
__attribute__ ((visibility ("default"))) size_t RegisterSCTImage(void)
{
  MagickInfo
    *entry;
...
# 360 "coders/sct.c"
__attribute__ ((visibility ("default"))) void UnregisterSCTImage(void)
{
