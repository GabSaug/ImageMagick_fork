...
# 191 "coders/video.c" 3 4
 , "coders/video.c", 191, __extension__ __PRETTY_FUNCTION__); }))
# 191 "coders/video.c"
                                               ;
  
# 192 "coders/video.c" 3 4
 ((void) sizeof ((
# 192 "coders/video.c"
...
# 192 "coders/video.c" 3 4
 , "coders/video.c", 192, __extension__ __PRETTY_FUNCTION__); }))
# 192 "coders/video.c"
                                                     ;
  
# 193 "coders/video.c" 3 4
 ((void) sizeof ((
# 193 "coders/video.c"
...
# 193 "coders/video.c" 3 4
 , "coders/video.c", 193, __extension__ __PRETTY_FUNCTION__); }))
# 193 "coders/video.c"
                                            ;
  
# 194 "coders/video.c" 3 4
 ((void) sizeof ((
# 194 "coders/video.c"
...
# 194 "coders/video.c" 3 4
 , "coders/video.c", 194, __extension__ __PRETTY_FUNCTION__); }))
# 194 "coders/video.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/video.c",__func__,(unsigned long) 196,"%s",
      image_info->filename);
...
# 203 "coders/video.c"
  ...
  images=(Image *) 
# 210 "coders/video.c" 3 4
                  ((void *)0)
# 210 "coders/video.c"
                      ;
  read_info=CloneImageInfo(image_info);
  delegate_info=GetDelegateInfo("video:decode",(char *) 
# 212 "coders/video.c" 3 4
                                                       ((void *)0)
# 212 "coders/video.c"
                                                           ,exception);
  if (delegate_info != (const DelegateInfo *) 
# 213 "coders/video.c" 3 4
                                             ((void *)0)
# 213 "coders/video.c"
                                                 )
    {
      ...
      if (image_info->number_scenes > 0)
        (void) FormatLocaleString(options,4096,"-vframes %i",
          (int) image_info->number_scenes);
      option=GetImageOption(image_info,"video:vsync");
      if (option != (const char *) 
# 232 "coders/video.c" 3 4
                                  ((void *)0)
# 232 "coders/video.c"
                                      )
        {
          FormatSanitizedDelegateOption(command,4096,
            " -vsync \"%s\""," -vsync '%s'",option);
          (void) ConcatenateMagickString(options,command,4096);
        }
      option=GetImageOption(image_info,"video:pixel-format");
      if (option != (const char *) 
# 239 "coders/video.c" 3 4
                                  ((void *)0)
# 239 "coders/video.c"
                                      )
        {
        ...
        if (LocaleNCompare(image_info->magick,"APNG",4096) == 0)
      ...
      if (exit_code == 0)
        ...
        if (*message != '\0')
          (void) ThrowMagickException(exception,"coders/video.c",__func__,(unsigned long) 270,DelegateError,
            "VideoDelegateFailed","`%s'",message);
      (void) RelinquishUniqueFileResource(read_info->filename);
      (void) RelinquishUniqueFileResource(read_info->unique);
      if (images != (Image *) 
# 274 "coders/video.c" 3 4
                             ((void *)0)
# 274 "coders/video.c"
                                 )
        for (next=images; next != (Image *) 
# 275 "coders/video.c" 3 4
                                           ((void *)0)
# 275 "coders/video.c"
                                               ; next=next->next)
        {
...
# 310 "coders/video.c"
__attribute__ ((visibility ("default"))) size_t RegisterVIDEOImage(void)
{
  MagickInfo
    *entry;
...
# 428 "coders/video.c"
__attribute__ ((visibility ("default"))) void UnregisterVIDEOImage(void)
{
...
# 495 "coders/video.c" 3 4
 , "coders/video.c", 495, __extension__ __PRETTY_FUNCTION__); }))
# 495 "coders/video.c"
                                      ;
  
# 496 "coders/video.c" 3 4
 ((void) sizeof ((
# 496 "coders/video.c"
 destination != (char *) 
# 496 "coders/video.c" 3 4
...
# 496 "coders/video.c" 3 4
 , "coders/video.c", 496, __extension__ __PRETTY_FUNCTION__); }))
# 496 "coders/video.c"
                                     ;
...
# 501 "coders/video.c" 3 4
                           stdout
# 501 "coders/video.c"
                                 );
  else
    destination_file=open_utf8(destination,
# 503 "coders/video.c" 3 4
                                          01 
# 503 "coders/video.c"
                                                   | 0x00 | 
# 503 "coders/video.c" 3 4
...
# 507 "coders/video.c"
  ...
  if ((fstat(source_file,&attributes) == 0) && (attributes.st_size > 0))
    quantum=(size_t) ((((double) attributes.st_size) < (81920)) ? ((double) attributes.st_size) : (81920))
                            ;
  buffer=(unsigned char *) AcquireQuantumMemory(quantum,sizeof(*buffer));
  if (buffer == (unsigned char *) 
# 518 "coders/video.c" 3 4
                                 ((void *)0)
# 518 "coders/video.c"
                                     )
    {
...
# 585 "coders/video.c"
 "image_info != (const ImageInfo *) NULL"
# 585 "coders/video.c" 3 4
 , "coders/video.c", 585, __extension__ __PRETTY_FUNCTION__); }))
# 585 "coders/video.c"
                                               ;
  
# 586 "coders/video.c" 3 4
 ((void) sizeof ((
# 586 "coders/video.c"
 image_info->signature == 0xabacadabUL
# 586 "coders/video.c" 3 4
...
# 586 "coders/video.c"
 "image_info->signature == MagickCoreSignature"
# 586 "coders/video.c" 3 4
 , "coders/video.c", 586, __extension__ __PRETTY_FUNCTION__); }))
# 586 "coders/video.c"
                                                     ;
  
# 587 "coders/video.c" 3 4
 ((void) sizeof ((
# 587 "coders/video.c"
 image != (Image *) 
# 587 "coders/video.c" 3 4
...
# 587 "coders/video.c"
 "image != (Image *) NULL"
# 587 "coders/video.c" 3 4
 , "coders/video.c", 587, __extension__ __PRETTY_FUNCTION__); }))
# 587 "coders/video.c"
                                ;
  
# 588 "coders/video.c" 3 4
 ((void) sizeof ((
# 588 "coders/video.c"
...
# 588 "coders/video.c" 3 4
 , "coders/video.c", 588, __extension__ __PRETTY_FUNCTION__); }))
# 588 "coders/video.c"
                                                ;
  
# 589 "coders/video.c" 3 4
 ((void) sizeof ((
# 589 "coders/video.c"
 exception != (ExceptionInfo *) 
# 589 "coders/video.c" 3 4
...
# 589 "coders/video.c"
 "exception != (ExceptionInfo *) NULL"
# 589 "coders/video.c" 3 4
 , "coders/video.c", 589, __extension__ __PRETTY_FUNCTION__); }))
# 589 "coders/video.c"
                                            ;
  
# 590 "coders/video.c" 3 4
 ((void) sizeof ((
# 590 "coders/video.c"
 exception->signature == 0xabacadabUL
# 590 "coders/video.c" 3 4
...
# 590 "coders/video.c"
 "exception->signature == MagickCoreSignature"
# 590 "coders/video.c" 3 4
 , "coders/video.c", 590, __extension__ __PRETTY_FUNCTION__); }))
# 590 "coders/video.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/video.c",__func__,(unsigned long) 592,"%s",image->filename);



  clone_images=CloneImageList(image,exception);
  if (clone_images == (Image *) 
# 597 "coders/video.c" 3 4
                               ((void *)0)
# 597 "coders/video.c"
                                   )
    return(MagickFalse);
  ...
  if (file != -1)
    file=close(file)-1;
  (void) FormatLocaleString(clone_images->filename,4096,"%s",
    basename);
  count=0;
  write_info=CloneImageInfo(image_info);
  write_info->file=(FILE *) 
# 606 "coders/video.c" 3 4
                           ((void *)0)
# 606 "coders/video.c"
                               ;
  *write_info->magick='\0';
  status=MagickTrue;
  intermediate_format=GetIntermediateFormat(image_info);
  for (p=clone_images; p != (Image *) 
# 610 "coders/video.c" 3 4
                                     ((void *)0)
# 610 "coders/video.c"
                                         ; p=GetNextImageInList(p))
  {
    ...
    blob=(unsigned char *) 
# 615 "coders/video.c" 3 4
                          ((void *)0)
# 615 "coders/video.c"
                              ;
    length=0;
    scene=p->scene;
    delay=100.0*p->delay/(((1.0*p->ticks_per_second) > (1.0)) ? (1.0*p->ticks_per_second) : (1.0));
    for (i=0; i < (ssize_t) ((((1.0*delay+1.0)/3.0) > (1.0)) ? ((1.0*delay+1.0)/3.0) : (1.0)); i++)
    {
      p->scene=count;
      count++;
      status=MagickFalse;
      switch (i)
      {
        case 0:
        {
          ...
          (void) FormatLocaleString(p->filename,4096,"%s%.20g.%s",
            basename,(double) p->scene,intermediate_format);
          (void) FormatLocaleString(filename,4096,"%s%.20g.%s",
            basename,(double) p->scene,intermediate_format);
          (void) FormatLocaleString(previous_image,4096,
            "%s%.20g.%s",basename,(double) p->scene,intermediate_format);
          frame=CloneImage(p,0,0,MagickTrue,exception);
          if (frame == (Image *) 
# 638 "coders/video.c" 3 4
                                ((void *)0)
# 638 "coders/video.c"
                                    )
            break;
        ...
        case 1:
        {
          blob=(unsigned char *) FileToBlob(previous_image,
# 646 "coders/video.c" 3 4
                                                          (18446744073709551615UL)
# 646 "coders/video.c"
                                                                  ,&length,
            exception);
      ...
      if (image->debug != MagickFalse)
        {
          if (status != MagickFalse)
            (void) LogMagickEvent(CoderEvent,"coders/video.c",__func__,(unsigned long) 662,
              "%.20g. Wrote %s file for scene %.20g:",(double) i,
              intermediate_format,(double) p->scene);
          else
            (void) LogMagickEvent(CoderEvent,"coders/video.c",__func__,(unsigned long) 666,
              "%.20g. Failed to write %s file for scene %.20g:",(double) i,
              intermediate_format,(double) p->scene);
          (void) LogMagickEvent(CoderEvent,"coders/video.c",__func__,(unsigned long) 669,"%s",filename);
        }
    }
    p->scene=scene;
    if (blob != (unsigned char *) 
# 673 "coders/video.c" 3 4
                                 ((void *)0)
# 673 "coders/video.c"
                                     )
...
# 681 "coders/video.c" 3 4
                                        ((void *)0)
# 681 "coders/video.c"
                                            ,"video:encode",exception);
  if (delegate_info != (const DelegateInfo *) 
# 682 "coders/video.c" 3 4
                                             ((void *)0)
# 682 "coders/video.c"
                                                 )
    {
      ...
      options=AcquireString("");
      (void) FormatLocaleString(options,4096,"-plays %i",
        (int) clone_images->iterations);
      option=GetImageOption(image_info,"video:pixel-format");
      if (option != (const char *) 
# 699 "coders/video.c" 3 4
                                  ((void *)0)
# 699 "coders/video.c"
                                      )
        {
      ...
      if (status != MagickFalse)
        ...
        if (*message != '\0')
          (void) ThrowMagickException(exception,"coders/video.c",__func__,(unsigned long) 722,
...
# 731 "coders/video.c"
                                         ; p=GetNextImageInList(p))
  {
    ...
    (void) CopyMagickString(p->filename,image_info->filename,4096);
  }
