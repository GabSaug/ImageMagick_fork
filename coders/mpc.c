...
# 200 "coders/mpc.c" 3 4
 , "coders/mpc.c", 200, __extension__ __PRETTY_FUNCTION__); }))
# 200 "coders/mpc.c"
                                               ;
  
# 201 "coders/mpc.c" 3 4
 ((void) sizeof ((
# 201 "coders/mpc.c"
...
# 201 "coders/mpc.c" 3 4
 , "coders/mpc.c", 201, __extension__ __PRETTY_FUNCTION__); }))
# 201 "coders/mpc.c"
                                                     ;
  
# 202 "coders/mpc.c" 3 4
 ((void) sizeof ((
# 202 "coders/mpc.c"
...
# 202 "coders/mpc.c" 3 4
 , "coders/mpc.c", 202, __extension__ __PRETTY_FUNCTION__); }))
# 202 "coders/mpc.c"
                                            ;
  
# 203 "coders/mpc.c" 3 4
 ((void) sizeof ((
# 203 "coders/mpc.c"
...
# 203 "coders/mpc.c" 3 4
 , "coders/mpc.c", 203, __extension__ __PRETTY_FUNCTION__); }))
# 203 "coders/mpc.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mpc.c",__func__,(unsigned long) 205,"%s",
      image_info->filename);
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 212 "coders/mpc.c" 3 4
                      ((void *)0)
# 212 "coders/mpc.c"
                          );
    }
  (void) CopyMagickString(cache_filename,image->filename,4096 -6);
  AppendImageFormat("cache",cache_filename);
  c=ReadBlobByte(image);
  if (c == 
# 217 "coders/mpc.c" 3 4
          (-1)
# 217 "coders/mpc.c"
             )
    {
...
# 231 "coders/mpc.c" 3 4
                               ((void *)0)
# 231 "coders/mpc.c"
                                   ;
    length=4096;
    options=AcquireString((char *) 
# 233 "coders/mpc.c" 3 4
                                  ((void *)0)
# 233 "coders/mpc.c"
                                      );
    nonce=StringToStringInfo("MagickPixelCache");
    signature=GetMagickSignature(nonce);
    nonce=DestroyStringInfo(nonce);
    image->depth=8;
    image->compression=NoCompression;
    while ((
# 239 "coders/mpc.c" 3 4
           ((*__ctype_b_loc ())[(int) ((
# 239 "coders/mpc.c"
           (int) ((unsigned char) c)
# 239 "coders/mpc.c" 3 4
...
# 253 "coders/mpc.c" 3 4
                                        ((void *)0)
# 253 "coders/mpc.c"
                                            );
          for (p=comment; comment != (char *) 
# 254 "coders/mpc.c" 3 4
                                             ((void *)0)
# 254 "coders/mpc.c"
                                                 ; p++)
          {
...
# 268 "coders/mpc.c"
          ...
          if (comment == (char *) 
# 274 "coders/mpc.c" 3 4
                                 ((void *)0)
# 274 "coders/mpc.c"
                                     )
            {
              options=DestroyString(options);
              { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 277,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 277 "coders/mpc.c" 3 4
             ((void *)0)
# 277 "coders/mpc.c"
...
# 334 "coders/mpc.c"
                ...
                if (options == (char *) 
# 337 "coders/mpc.c" 3 4
                                       ((void *)0)
# 337 "coders/mpc.c"
                                           )
                  { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 338,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 338 "coders/mpc.c" 3 4
                 ((void *)0)
# 338 "coders/mpc.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 338 "coders/mpc.c" 3 4
...
# 782 "coders/mpc.c"
    ...
    if ((LocaleCompare(id,"MagickPixelCache") != 0) ||
      ...
      {
        if (profiles != (LinkedListInfo *) 
# 799 "coders/mpc.c" 3 4
                                          ((void *)0)
# 799 "coders/mpc.c"
                                              )
          profiles=DestroyLinkedList(profiles,RelinquishMagickMemory);
        { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 801,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 801 "coders/mpc.c" 3 4
       ((void *)0)
# 801 "coders/mpc.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 801 "coders/mpc.c" 3 4
    ...
    if (signature != GetMagickSignature(nonce))
      {
        nonce=DestroyStringInfo(nonce);
        if (profiles != (LinkedListInfo *) 
# 807 "coders/mpc.c" 3 4
                                          ((void *)0)
# 807 "coders/mpc.c"
                                              )
          profiles=DestroyLinkedList(profiles,RelinquishMagickMemory);
        { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 809,CacheError,"IncompatibleAPI", "`%s'",image_info->filename); if ((image) != (Image *) 
# 809 "coders/mpc.c" 3 4
       ((void *)0)
# 809 "coders/mpc.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 809 "coders/mpc.c" 3 4
...
# 835 "coders/mpc.c" 3 4
                                              ((void *)0)
# 835 "coders/mpc.c"
                                                  )
                {
                  if (profiles != (LinkedListInfo *) 
# 837 "coders/mpc.c" 3 4
                                                    ((void *)0)
# 837 "coders/mpc.c"
                                                        )
                    profiles=DestroyLinkedList(profiles,RelinquishMagickMemory);
                  { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 839,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 839 "coders/mpc.c" 3 4
                 ((void *)0)
# 839 "coders/mpc.c"
                 ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 839 "coders/mpc.c" 3 4
    ...
    if (image->storage_class == PseudoClass)
      {
        ...
        if ((MagickSizeType) (packet_size*image->colors) > GetBlobSize(image))
          { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 903,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 903 "coders/mpc.c" 3 4
         ((void *)0)
# 903 "coders/mpc.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 903 "coders/mpc.c" 3 4
...
# 906 "coders/mpc.c" 3 4
                                            ((void *)0)
# 906 "coders/mpc.c"
                                                )
          { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 907,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 907 "coders/mpc.c" 3 4
         ((void *)0)
# 907 "coders/mpc.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 907 "coders/mpc.c" 3 4
...
# 915 "coders/mpc.c" 3 4
                                             ((void *)0)
# 915 "coders/mpc.c"
                                                 )
              { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 916,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 916 "coders/mpc.c" 3 4
             ((void *)0)
# 916 "coders/mpc.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 916 "coders/mpc.c" 3 4
            ...
            if (count != (ssize_t) (packet_size*image->colors))
              {
                ...
                { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 921,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 921 "coders/mpc.c" 3 4
               ((void *)0)
# 921 "coders/mpc.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 921 "coders/mpc.c" 3 4
...
# 921 "coders/mpc.c"
            ...
            switch (depth)
            {
              default:
                colormap=(unsigned char *) RelinquishMagickMemory(colormap);
                { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 929,CorruptImageError,"ImageDepthNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 929 "coders/mpc.c" 3 4
               ((void *)0)
# 929 "coders/mpc.c"
               ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 929 "coders/mpc.c" 3 4
...
# 929 "coders/mpc.c"
    ...
    if ((AcquireMagickResource(WidthResource,image->columns) == MagickFalse) ||
      ...
      { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 997,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image_info->filename); if ((image) != (Image *) 
# 997 "coders/mpc.c" 3 4
     ((void *)0)
# 997 "coders/mpc.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 997 "coders/mpc.c" 3 4
    ...
    if (status == MagickFalse)
      {
        ...
        { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 1005,CacheError,"UnableToPersistPixelCache", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1005 "coders/mpc.c" 3 4
       ((void *)0)
# 1005 "coders/mpc.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1005 "coders/mpc.c" 3 4
...
# 1009 "coders/mpc.c" 3 4
       (*__errno_location ())
# 1009 "coders/mpc.c"
       ); (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 1009,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 1068 "coders/mpc.c"
__attribute__ ((visibility ("default"))) size_t RegisterMPCImage(void)
{
  MagickInfo
    *entry;
...
# 1104 "coders/mpc.c"
__attribute__ ((visibility ("default"))) void UnregisterMPCImage(void)
{
...
# 1165 "coders/mpc.c"
 "image_info != (const ImageInfo *) NULL"
# 1165 "coders/mpc.c" 3 4
 , "coders/mpc.c", 1165, __extension__ __PRETTY_FUNCTION__); }))
# 1165 "coders/mpc.c"
                                               ;
  
# 1166 "coders/mpc.c" 3 4
 ((void) sizeof ((
# 1166 "coders/mpc.c"
 image_info->signature == 0xabacadabUL
# 1166 "coders/mpc.c" 3 4
...
# 1166 "coders/mpc.c"
 "image_info->signature == MagickCoreSignature"
# 1166 "coders/mpc.c" 3 4
 , "coders/mpc.c", 1166, __extension__ __PRETTY_FUNCTION__); }))
# 1166 "coders/mpc.c"
                                                     ;
  
# 1167 "coders/mpc.c" 3 4
 ((void) sizeof ((
# 1167 "coders/mpc.c"
 image != (Image *) 
# 1167 "coders/mpc.c" 3 4
...
# 1167 "coders/mpc.c"
 "image != (Image *) NULL"
# 1167 "coders/mpc.c" 3 4
 , "coders/mpc.c", 1167, __extension__ __PRETTY_FUNCTION__); }))
# 1167 "coders/mpc.c"
                                ;
  
# 1168 "coders/mpc.c" 3 4
 ((void) sizeof ((
# 1168 "coders/mpc.c"
...
# 1168 "coders/mpc.c" 3 4
 , "coders/mpc.c", 1168, __extension__ __PRETTY_FUNCTION__); }))
# 1168 "coders/mpc.c"
                                                ;
  
# 1169 "coders/mpc.c" 3 4
 ((void) sizeof ((
# 1169 "coders/mpc.c"
 exception != (ExceptionInfo *) 
# 1169 "coders/mpc.c" 3 4
...
# 1169 "coders/mpc.c"
 "exception != (ExceptionInfo *) NULL"
# 1169 "coders/mpc.c" 3 4
 , "coders/mpc.c", 1169, __extension__ __PRETTY_FUNCTION__); }))
# 1169 "coders/mpc.c"
                                            ;
  
# 1170 "coders/mpc.c" 3 4
 ((void) sizeof ((
# 1170 "coders/mpc.c"
 exception->signature == 0xabacadabUL
# 1170 "coders/mpc.c" 3 4
...
# 1170 "coders/mpc.c"
 "exception->signature == MagickCoreSignature"
# 1170 "coders/mpc.c" 3 4
 , "coders/mpc.c", 1170, __extension__ __PRETTY_FUNCTION__); }))
# 1170 "coders/mpc.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/mpc.c",__func__,(unsigned long) 1172,"%s",image->filename);
  ...
  do
  {
    ...
    nonce=StringToStringInfo("MagickPixelCache");
    (void) FormatLocaleString(buffer,4096,"magick-signature=%u\n",
    ...
    if ((GetNextImageInList(image) != (Image *) 
# 1279 "coders/mpc.c" 3 4
                                               ((void *)0)
# 1279 "coders/mpc.c"
                                                   ) ||
        (GetPreviousImageInList(image) != (Image *) 
# 1280 "coders/mpc.c" 3 4
                                                   ((void *)0)
# 1280 "coders/mpc.c"
                                                       ))
      {
...
# 1485 "coders/mpc.c"
        ...
        for (i=0; i < (ssize_t) image->colors; i++)
        {
          switch (depth)
          {
            ...
            {
              colormap=(unsigned char *) RelinquishMagickMemory(colormap);
              { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 1498,CorruptImageError,"ImageDepthNotSupported", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1498 "coders/mpc.c" 3 4
             ((void *)0)
# 1498 "coders/mpc.c"
    ...
    status=PersistPixelCache(image,cache_filename,MagickFalse,&offset,
      exception);
    if (status == MagickFalse)
      { (void) ThrowMagickException(exception,"coders/mpc.c",__func__,(unsigned long) 1557,CacheError,"UnableToPersistPixelCache", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1557 "coders/mpc.c" 3 4
     ((void *)0)
# 1557 "coders/mpc.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    if (GetNextImageInList(image) == (Image *) 
# 1558 "coders/mpc.c" 3 4
                                              ((void *)0)
# 1558 "coders/mpc.c"
                                                  )
      break;
...
# 1561 "coders/mpc.c" 3 4
                                                          ((void *)0)
# 1561 "coders/mpc.c"
                                                              )
      {
        status=image->progress_monitor("Save/Images",scene,
