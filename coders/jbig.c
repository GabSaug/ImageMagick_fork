...
# 69 "coders/jbig.c" 2
# 301 "coders/jbig.c"
__attribute__ ((visibility ("default"))) size_t RegisterJBIGImage(void)
{
  ...
  *version='\0';
  ...
  entry=AcquireMagickInfo("JBIG","BIE","Joint Bi-level Image experts Group interchange format");
  ...
  entry=AcquireMagickInfo("JBIG","JBG","Joint Bi-level Image experts Group interchange format");
  ...
  if (*version != '\0')
    entry->version=ConstantString(version);
  (void) RegisterMagickInfo(entry);
  entry=AcquireMagickInfo("JBIG","JBIG","Joint Bi-level Image experts Group interchange format");
...
# 362 "coders/jbig.c"
__attribute__ ((visibility ("default"))) void UnregisterJBIGImage(void)
{
