...
# 300 "coders/sgi.c" 3 4
 , "coders/sgi.c", 300, __extension__ __PRETTY_FUNCTION__); }))
# 300 "coders/sgi.c"
                                               ;
  
# 301 "coders/sgi.c" 3 4
 ((void) sizeof ((
# 301 "coders/sgi.c"
...
# 301 "coders/sgi.c" 3 4
 , "coders/sgi.c", 301, __extension__ __PRETTY_FUNCTION__); }))
# 301 "coders/sgi.c"
                                                     ;
  
# 302 "coders/sgi.c" 3 4
 ((void) sizeof ((
# 302 "coders/sgi.c"
...
# 302 "coders/sgi.c" 3 4
 , "coders/sgi.c", 302, __extension__ __PRETTY_FUNCTION__); }))
# 302 "coders/sgi.c"
                                            ;
  
# 303 "coders/sgi.c" 3 4
 ((void) sizeof ((
# 303 "coders/sgi.c"
...
# 303 "coders/sgi.c" 3 4
 , "coders/sgi.c", 303, __extension__ __PRETTY_FUNCTION__); }))
# 303 "coders/sgi.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/sgi.c",__func__,(unsigned long) 305,"%s",
      image_info->filename);
...
# 312 "coders/sgi.c"
  ...
  do
  {
    ...
    if (iris_info.magic != 0x01DA)
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 325,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 325 "coders/sgi.c" 3 4
     ((void *)0)
# 325 "coders/sgi.c"
...
# 325 "coders/sgi.c"
    ...
    switch (iris_info.storage)
    {
      ...
      default:
        { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 332,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 332 "coders/sgi.c" 3 4
       ((void *)0)
# 332 "coders/sgi.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 332 "coders/sgi.c" 3 4
...
# 332 "coders/sgi.c"
    ...
    if ((iris_info.bytes_per_pixel == 0) || (iris_info.bytes_per_pixel > 2))
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 336,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 336 "coders/sgi.c" 3 4
     ((void *)0)
# 336 "coders/sgi.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 336 "coders/sgi.c" 3 4
...
# 336 "coders/sgi.c"
    ...
    if ((iris_info.dimension == 0) || (iris_info.dimension > 3))
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 339,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 339 "coders/sgi.c" 3 4
     ((void *)0)
# 339 "coders/sgi.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 339 "coders/sgi.c" 3 4
...
# 339 "coders/sgi.c"
    ...
    if ((iris_info.depth == 0) || (iris_info.depth > 4))
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 344,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 344 "coders/sgi.c" 3 4
     ((void *)0)
# 344 "coders/sgi.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 344 "coders/sgi.c" 3 4
...
# 344 "coders/sgi.c"
    ...
    if ((size_t) count != sizeof(iris_info.name))
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 351,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 351 "coders/sgi.c" 3 4
     ((void *)0)
# 351 "coders/sgi.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 351 "coders/sgi.c" 3 4
...
# 351 "coders/sgi.c"
    ...
    if (iris_info.pixel_format != 0)
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 357,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 357 "coders/sgi.c" 3 4
     ((void *)0)
# 357 "coders/sgi.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 357 "coders/sgi.c" 3 4
...
# 357 "coders/sgi.c"
    ...
    if ((size_t) count != sizeof(iris_info.filler))
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 360,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 360 "coders/sgi.c" 3 4
     ((void *)0)
# 360 "coders/sgi.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 360 "coders/sgi.c" 3 4
...
# 360 "coders/sgi.c"
    ...
    image->alpha_trait=iris_info.depth == 4 ? BlendPixelTrait :
      UndefinedPixelTrait;
    image->depth=(size_t) (((iris_info.depth) < (16)) ? (iris_info.depth) : (16));
    if (iris_info.pixel_format == 0)
      image->depth=(size_t) ((((size_t) 8*iris_info.bytes_per_pixel) < (16)) ? ((size_t) 8*iris_info.bytes_per_pixel) : (16))
                                 ;
    ...
    if ((MagickSizeType) (image->columns*image->rows/255) > GetBlobSize(image))
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 378,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 378 "coders/sgi.c" 3 4
     ((void *)0)
# 378 "coders/sgi.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 378 "coders/sgi.c" 3 4
...
# 378 "coders/sgi.c"
    ...
    if ((4*bytes_per_pixel*number_pixels) != ((MagickSizeType) (size_t)
      ...
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 391,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 391 "coders/sgi.c" 3 4
     ((void *)0)
# 391 "coders/sgi.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 391 "coders/sgi.c" 3 4
...
# 394 "coders/sgi.c" 3 4
                                    ((void *)0)
# 394 "coders/sgi.c"
                                        )
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 395,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 395 "coders/sgi.c" 3 4
     ((void *)0)
# 395 "coders/sgi.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 395 "coders/sgi.c" 3 4
...
# 409 "coders/sgi.c" 3 4
                                         ((void *)0)
# 409 "coders/sgi.c"
                                             )
          {
            pixel_info=RelinquishVirtualMemory(pixel_info);
            { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 412,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 412 "coders/sgi.c" 3 4
           ((void *)0)
# 412 "coders/sgi.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 412 "coders/sgi.c" 3 4
...
# 468 "coders/sgi.c"
            ...
            (packet_info == (MemoryInfo *) 
# 469 "coders/sgi.c" 3 4
                                          ((void *)0)
# 469 "coders/sgi.c"
                                              ))
          {
            ...
            if (packet_info != (MemoryInfo *) 
# 473 "coders/sgi.c" 3 4
                                             ((void *)0)
# 473 "coders/sgi.c"
                                                 )
              packet_info=RelinquishVirtualMemory(packet_info);
            pixel_info=RelinquishVirtualMemory(pixel_info);
            { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 476,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 476 "coders/sgi.c" 3 4
           ((void *)0)
# 476 "coders/sgi.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 476 "coders/sgi.c" 3 4
          ...
          if (runlength[i] > (4*(size_t) iris_info.columns+10))
            {
              ...
              offsets=(ssize_t *) RelinquishMagickMemory(offsets);
              pixel_info=RelinquishVirtualMemory(pixel_info);
              { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 490,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 490 "coders/sgi.c" 3 4
             ((void *)0)
# 490 "coders/sgi.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 490 "coders/sgi.c" 3 4
                ...
                if (status == MagickFalse)
                  {
                    ...
                    offsets=(ssize_t *) RelinquishMagickMemory(offsets);
                    pixel_info=RelinquishVirtualMemory(pixel_info);
                    { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 533,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 533 "coders/sgi.c" 3 4
                   ((void *)0)
# 533 "coders/sgi.c"
                   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 533 "coders/sgi.c" 3 4
                ...
                if (status == MagickFalse)
                  {
                    ...
                    offsets=(ssize_t *) RelinquishMagickMemory(offsets);
                    pixel_info=RelinquishVirtualMemory(pixel_info);
                    { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 573,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 573 "coders/sgi.c" 3 4
                   ((void *)0)
# 573 "coders/sgi.c"
                   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 573 "coders/sgi.c" 3 4
...
# 573 "coders/sgi.c"
            ...
            offset=(ssize_t) SeekBlob(image,position,
# 581 "coders/sgi.c" 3 4
                                                    0
# 581 "coders/sgi.c"
                                                            );
          }
...
# 649 "coders/sgi.c"
    ...
    else
      {
        ...
        if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
          {
            pixel_info=RelinquishVirtualMemory(pixel_info);
            { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 666,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 666 "coders/sgi.c" 3 4
           ((void *)0)
# 666 "coders/sgi.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 666 "coders/sgi.c" 3 4
...
# 726 "coders/sgi.c" 3 4
       (*__errno_location ())
# 726 "coders/sgi.c"
       ); (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 726,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 785 "coders/sgi.c"
__attribute__ ((visibility ("default"))) size_t RegisterSGIImage(void)
{
  MagickInfo
    *entry;
...
# 818 "coders/sgi.c"
__attribute__ ((visibility ("default"))) void UnregisterSGIImage(void)
{
...
# 947 "coders/sgi.c"
 "image_info != (const ImageInfo *) NULL"
# 947 "coders/sgi.c" 3 4
 , "coders/sgi.c", 947, __extension__ __PRETTY_FUNCTION__); }))
# 947 "coders/sgi.c"
                                               ;
  
# 948 "coders/sgi.c" 3 4
 ((void) sizeof ((
# 948 "coders/sgi.c"
 image_info->signature == 0xabacadabUL
# 948 "coders/sgi.c" 3 4
...
# 948 "coders/sgi.c"
 "image_info->signature == MagickCoreSignature"
# 948 "coders/sgi.c" 3 4
 , "coders/sgi.c", 948, __extension__ __PRETTY_FUNCTION__); }))
# 948 "coders/sgi.c"
                                                     ;
  
# 949 "coders/sgi.c" 3 4
 ((void) sizeof ((
# 949 "coders/sgi.c"
 image != (Image *) 
# 949 "coders/sgi.c" 3 4
...
# 949 "coders/sgi.c"
 "image != (Image *) NULL"
# 949 "coders/sgi.c" 3 4
 , "coders/sgi.c", 949, __extension__ __PRETTY_FUNCTION__); }))
# 949 "coders/sgi.c"
                                ;
  
# 950 "coders/sgi.c" 3 4
 ((void) sizeof ((
# 950 "coders/sgi.c"
...
# 950 "coders/sgi.c" 3 4
 , "coders/sgi.c", 950, __extension__ __PRETTY_FUNCTION__); }))
# 950 "coders/sgi.c"
                                                ;
  
# 951 "coders/sgi.c" 3 4
 ((void) sizeof ((
# 951 "coders/sgi.c"
 exception != (ExceptionInfo *) 
# 951 "coders/sgi.c" 3 4
...
# 951 "coders/sgi.c"
 "exception != (ExceptionInfo *) NULL"
# 951 "coders/sgi.c" 3 4
 , "coders/sgi.c", 951, __extension__ __PRETTY_FUNCTION__); }))
# 951 "coders/sgi.c"
                                            ;
  
# 952 "coders/sgi.c" 3 4
 ((void) sizeof ((
# 952 "coders/sgi.c"
 exception->signature == 0xabacadabUL
# 952 "coders/sgi.c" 3 4
...
# 952 "coders/sgi.c"
 "exception->signature == MagickCoreSignature"
# 952 "coders/sgi.c" 3 4
 , "coders/sgi.c", 952, __extension__ __PRETTY_FUNCTION__); }))
# 952 "coders/sgi.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/sgi.c",__func__,(unsigned long) 954,"%s",image->filename);
  ...
  do
  {
    ...
    if ((image->columns > 65535UL) || (image->rows > 65535UL))
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 966,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 966 "coders/sgi.c" 3 4
     ((void *)0)
# 966 "coders/sgi.c"
    ...
    iris_info.maximum_value=(size_t) (image->depth <= 8 ?
      1UL*ScaleQuantumToChar(((Quantum) 65535.0)) :
      1UL*ScaleQuantumToShort(((Quantum) 65535.0)));
...
# 1015 "coders/sgi.c"
    ...
    if ((4*iris_info.bytes_per_pixel*number_pixels) !=
      ...
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 1027,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1027 "coders/sgi.c" 3 4
     ((void *)0)
# 1027 "coders/sgi.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    ...
    if (pixel_info == (MemoryInfo *) 
# 1030 "coders/sgi.c" 3 4
                                    ((void *)0)
# 1030 "coders/sgi.c"
                                        )
      { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 1031,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1031 "coders/sgi.c" 3 4
     ((void *)0)
# 1031 "coders/sgi.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    pixels=(unsigned char *) GetVirtualMemoryBlob(pixel_info);
...
# 1069 "coders/sgi.c"
    ...
    switch (compression)
    {
      ...
      default:
      {
        ...
        if ((offsets == (ssize_t *) 
# 1138 "coders/sgi.c" 3 4
                                   ((void *)0)
# 1138 "coders/sgi.c"
                                       ) ||
            (runlength == (size_t *) 
# 1139 "coders/sgi.c" 3 4
                                    ((void *)0)
# 1139 "coders/sgi.c"
                                        ) ||
            (packet_info == (MemoryInfo *) 
# 1140 "coders/sgi.c" 3 4
                                          ((void *)0)
# 1140 "coders/sgi.c"
                                              ))
          {
            if (offsets != (ssize_t *) 
# 1142 "coders/sgi.c" 3 4
                                      ((void *)0)
# 1142 "coders/sgi.c"
                                          )
              offsets=(ssize_t *) RelinquishMagickMemory(offsets);
            if (runlength != (size_t *) 
# 1144 "coders/sgi.c" 3 4
                                       ((void *)0)
# 1144 "coders/sgi.c"
                                           )
              runlength=(size_t *) RelinquishMagickMemory(runlength);
            if (packet_info != (MemoryInfo *) 
# 1146 "coders/sgi.c" 3 4
                                             ((void *)0)
# 1146 "coders/sgi.c"
                                                 )
              packet_info=RelinquishVirtualMemory(packet_info);
            pixel_info=RelinquishVirtualMemory(pixel_info);
            { (void) ThrowMagickException(exception,"coders/sgi.c",__func__,(unsigned long) 1149,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1149 "coders/sgi.c" 3 4
           ((void *)0)
# 1149 "coders/sgi.c"
           ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
          }
