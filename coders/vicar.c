...
# 187 "coders/vicar.c" 3 4
 , "coders/vicar.c", 187, __extension__ __PRETTY_FUNCTION__); }))
# 187 "coders/vicar.c"
                                               ;
  
# 188 "coders/vicar.c" 3 4
 ((void) sizeof ((
# 188 "coders/vicar.c"
...
# 188 "coders/vicar.c" 3 4
 , "coders/vicar.c", 188, __extension__ __PRETTY_FUNCTION__); }))
# 188 "coders/vicar.c"
                                                     ;
  
# 189 "coders/vicar.c" 3 4
 ((void) sizeof ((
# 189 "coders/vicar.c"
...
# 189 "coders/vicar.c" 3 4
 , "coders/vicar.c", 189, __extension__ __PRETTY_FUNCTION__); }))
# 189 "coders/vicar.c"
                                            ;
  
# 190 "coders/vicar.c" 3 4
 ((void) sizeof ((
# 190 "coders/vicar.c"
...
# 190 "coders/vicar.c" 3 4
 , "coders/vicar.c", 190, __extension__ __PRETTY_FUNCTION__); }))
# 190 "coders/vicar.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/vicar.c",__func__,(unsigned long) 192,"%s",
      image_info->filename);
...
# 313 "coders/vicar.c"
        ...
        *p='\0';
        ...
        (void) FormatLocaleString(property,4096,"vicar:%s",keyword);
    ...
    if (c == 
# 342 "coders/vicar.c" 3 4
            (-1)
# 342 "coders/vicar.c"
               )
      break;
    while (
# 344 "coders/vicar.c" 3 4
          ((*__ctype_b_loc ())[(int) ((
# 344 "coders/vicar.c"
          (int) ((unsigned char) c)
# 344 "coders/vicar.c" 3 4
...
# 355 "coders/vicar.c"
  ...
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/vicar.c",__func__,(unsigned long) 360,CorruptImageError,"NegativeOrZeroImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 360 "coders/vicar.c" 3 4
   ((void *)0)
# 360 "coders/vicar.c"
...
# 387 "coders/vicar.c" 3 4
                                     ((void *)0)
# 387 "coders/vicar.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/vicar.c",__func__,(unsigned long) 388,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 388 "coders/vicar.c" 3 4
   ((void *)0)
# 388 "coders/vicar.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 388 "coders/vicar.c" 3 4
...
# 421 "coders/vicar.c" 3 4
   (*__errno_location ())
# 421 "coders/vicar.c"
   ); (void) ThrowMagickException(exception,"coders/vicar.c",__func__,(unsigned long) 421,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 453 "coders/vicar.c"
__attribute__ ((visibility ("default"))) size_t RegisterVICARImage(void)
{
  MagickInfo
    *entry;
...
# 487 "coders/vicar.c"
__attribute__ ((visibility ("default"))) void UnregisterVICARImage(void)
{
...
# 555 "coders/vicar.c"
 "image_info != (const ImageInfo *) NULL"
# 555 "coders/vicar.c" 3 4
 , "coders/vicar.c", 555, __extension__ __PRETTY_FUNCTION__); }))
# 555 "coders/vicar.c"
                                               ;
  
# 556 "coders/vicar.c" 3 4
 ((void) sizeof ((
# 556 "coders/vicar.c"
 image_info->signature == 0xabacadabUL
# 556 "coders/vicar.c" 3 4
...
# 556 "coders/vicar.c"
 "image_info->signature == MagickCoreSignature"
# 556 "coders/vicar.c" 3 4
 , "coders/vicar.c", 556, __extension__ __PRETTY_FUNCTION__); }))
# 556 "coders/vicar.c"
                                                     ;
  
# 557 "coders/vicar.c" 3 4
 ((void) sizeof ((
# 557 "coders/vicar.c"
 image != (Image *) 
# 557 "coders/vicar.c" 3 4
...
# 557 "coders/vicar.c"
 "image != (Image *) NULL"
# 557 "coders/vicar.c" 3 4
 , "coders/vicar.c", 557, __extension__ __PRETTY_FUNCTION__); }))
# 557 "coders/vicar.c"
                                ;
  
# 558 "coders/vicar.c" 3 4
 ((void) sizeof ((
# 558 "coders/vicar.c"
...
# 558 "coders/vicar.c" 3 4
 , "coders/vicar.c", 558, __extension__ __PRETTY_FUNCTION__); }))
# 558 "coders/vicar.c"
                                                ;
  
# 559 "coders/vicar.c" 3 4
 ((void) sizeof ((
# 559 "coders/vicar.c"
 exception != (ExceptionInfo *) 
# 559 "coders/vicar.c" 3 4
...
# 559 "coders/vicar.c"
 "exception != (ExceptionInfo *) NULL"
# 559 "coders/vicar.c" 3 4
 , "coders/vicar.c", 559, __extension__ __PRETTY_FUNCTION__); }))
# 559 "coders/vicar.c"
                                            ;
  
# 560 "coders/vicar.c" 3 4
 ((void) sizeof ((
# 560 "coders/vicar.c"
 exception->signature == 0xabacadabUL
# 560 "coders/vicar.c" 3 4
...
# 560 "coders/vicar.c"
 "exception->signature == MagickCoreSignature"
# 560 "coders/vicar.c" 3 4
 , "coders/vicar.c", 560, __extension__ __PRETTY_FUNCTION__); }))
# 560 "coders/vicar.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/vicar.c",__func__,(unsigned long) 562,"%s",image->filename);
  ...
  (void) FormatLocaleString(header,4096,
    ...
    "NLB=0 TASK='ImageMagick'",(double) 4096,(double)
    image->columns,(double) image->rows,(double) image->columns);
  (void) WriteBlob(image,4096,(unsigned char *) header);
  ...
  quantum_info=AcquireQuantumInfo(image_info,image);
  if (quantum_info == (QuantumInfo *) 
# 583 "coders/vicar.c" 3 4
                                     ((void *)0)
# 583 "coders/vicar.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/vicar.c",__func__,(unsigned long) 584,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 584 "coders/vicar.c" 3 4
   ((void *)0)
# 584 "coders/vicar.c"
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 589 "coders/vicar.c" 3 4
                              ((void *)0)
# 589 "coders/vicar.c"
                                  )
      break;
    length=ExportQuantumPixels(image,(CacheView *) 
# 591 "coders/vicar.c" 3 4
                                                  ((void *)0)
# 591 "coders/vicar.c"
                                                      ,quantum_info,
