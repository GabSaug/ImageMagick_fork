...
# 141 "coders/bayer.c" 3 4
 , "coders/bayer.c", 141, __extension__ __PRETTY_FUNCTION__); }))
# 141 "coders/bayer.c"
                                               ;
  
# 142 "coders/bayer.c" 3 4
 ((void) sizeof ((
# 142 "coders/bayer.c"
...
# 142 "coders/bayer.c" 3 4
 , "coders/bayer.c", 142, __extension__ __PRETTY_FUNCTION__); }))
# 142 "coders/bayer.c"
                                                     ;
  
# 143 "coders/bayer.c" 3 4
 ((void) sizeof ((
# 143 "coders/bayer.c"
...
# 143 "coders/bayer.c" 3 4
 , "coders/bayer.c", 143, __extension__ __PRETTY_FUNCTION__); }))
# 143 "coders/bayer.c"
                                            ;
  
# 144 "coders/bayer.c" 3 4
 ((void) sizeof ((
# 144 "coders/bayer.c"
...
# 144 "coders/bayer.c" 3 4
 , "coders/bayer.c", 144, __extension__ __PRETTY_FUNCTION__); }))
# 144 "coders/bayer.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/bayer.c",__func__,(unsigned long) 146,"%s",
      image_info->filename);
  read_info=CloneImageInfo(image_info);
  (void) FormatLocaleString(read_info->filename,4096,"gray:%.1024s",
    image_info->filename);
  (void) CopyMagickString(read_info->magick,"GRAY",4096);
  read_info->verbose=MagickFalse;
  image=ReadImage(read_info,exception);
  read_info=DestroyImageInfo(read_info);
  if (image == (Image *) 
# 155 "coders/bayer.c" 3 4
                        ((void *)0)
# 155 "coders/bayer.c"
                            )
    return((Image *) 
# 156 "coders/bayer.c" 3 4
                    ((void *)0)
# 156 "coders/bayer.c"
                        );
...
# 225 "coders/bayer.c"
__attribute__ ((visibility ("default"))) size_t RegisterBAYERImage(void)
{
  MagickInfo
    *entry;
...
# 262 "coders/bayer.c"
__attribute__ ((visibility ("default"))) void UnregisterBAYERImage(void)
{
...
# 316 "coders/bayer.c" 3 4
                               ((void *)0)
# 316 "coders/bayer.c"
                                   )
    return((Image *) 
# 317 "coders/bayer.c" 3 4
                    ((void *)0)
# 317 "coders/bayer.c"
                        );
  draw_info->fill_pattern=AcquireImage((ImageInfo *) 
# 318 "coders/bayer.c" 3 4
                                                    ((void *)0)
# 318 "coders/bayer.c"
                                                        ,exception);
  if (draw_info->fill_pattern == (Image *) 
# 319 "coders/bayer.c" 3 4
                                          ((void *)0)
# 319 "coders/bayer.c"
                                              )
    {
  ...
  Image *image,ExceptionInfo *exception)
{
  Image
    *bayer_image=(Image *) 
# 374 "coders/bayer.c" 3 4
                          ((void *)0)
# 374 "coders/bayer.c"
                              ,
    *images=(Image *) 
# 375 "coders/bayer.c" 3 4
                     ((void *)0)
# 375 "coders/bayer.c"
                         ;
...
# 383 "coders/bayer.c"
 "image_info != (const ImageInfo *) NULL"
# 383 "coders/bayer.c" 3 4
 , "coders/bayer.c", 383, __extension__ __PRETTY_FUNCTION__); }))
# 383 "coders/bayer.c"
                                               ;
  
# 384 "coders/bayer.c" 3 4
 ((void) sizeof ((
# 384 "coders/bayer.c"
 image_info->signature == 0xabacadabUL
# 384 "coders/bayer.c" 3 4
...
# 384 "coders/bayer.c"
 "image_info->signature == MagickCoreSignature"
# 384 "coders/bayer.c" 3 4
 , "coders/bayer.c", 384, __extension__ __PRETTY_FUNCTION__); }))
# 384 "coders/bayer.c"
                                                     ;
  
# 385 "coders/bayer.c" 3 4
 ((void) sizeof ((
# 385 "coders/bayer.c"
 image != (Image *) 
# 385 "coders/bayer.c" 3 4
...
# 385 "coders/bayer.c"
 "image != (Image *) NULL"
# 385 "coders/bayer.c" 3 4
 , "coders/bayer.c", 385, __extension__ __PRETTY_FUNCTION__); }))
# 385 "coders/bayer.c"
                                ;
  
# 386 "coders/bayer.c" 3 4
 ((void) sizeof ((
# 386 "coders/bayer.c"
...
# 386 "coders/bayer.c" 3 4
 , "coders/bayer.c", 386, __extension__ __PRETTY_FUNCTION__); }))
# 386 "coders/bayer.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/bayer.c",__func__,(unsigned long) 388,"%s",image->filename);
  bayer_image=CloneImage(image,0,0,MagickTrue,exception);
  status=MagickFalse;
  if (bayer_image == (Image *) 
# 391 "coders/bayer.c" 3 4
                              ((void *)0)
# 391 "coders/bayer.c"
                                  )
    return(MagickFalse);
...
# 419 "coders/bayer.c"
                                  )
    {
      ...
      (void) CopyMagickString(write_info->magick,"GRAY",4096);
