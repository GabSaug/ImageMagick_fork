...
typedef enum
{
  ...
  TransferCharacteristicSMTPE274M = 5,
  TransferCharacteristicITU_R709 = 6,
  TransferCharacteristicITU_R601_625L = 7,
  TransferCharacteristicITU_R601_525L = 8,
...
static void TimeCodeToString(const size_t timestamp,char *code)
{
  ...
  *code='\0';
  ...
  for (i=0; i <= 7; i++)
  {
    (void) FormatLocaleString(code,4096 -strlen(code),"%x",
...
# 699 "coders/dpx.c" 3 4
 , "coders/dpx.c", 699, __extension__ __PRETTY_FUNCTION__); }))
# 699 "coders/dpx.c"
                                               ;
  
# 700 "coders/dpx.c" 3 4
 ((void) sizeof ((
# 700 "coders/dpx.c"
...
# 700 "coders/dpx.c" 3 4
 , "coders/dpx.c", 700, __extension__ __PRETTY_FUNCTION__); }))
# 700 "coders/dpx.c"
                                                     ;
  
# 701 "coders/dpx.c" 3 4
 ((void) sizeof ((
# 701 "coders/dpx.c"
...
# 701 "coders/dpx.c" 3 4
 , "coders/dpx.c", 701, __extension__ __PRETTY_FUNCTION__); }))
# 701 "coders/dpx.c"
                                            ;
  
# 702 "coders/dpx.c" 3 4
 ((void) sizeof ((
# 702 "coders/dpx.c"
...
# 702 "coders/dpx.c" 3 4
 , "coders/dpx.c", 702, __extension__ __PRETTY_FUNCTION__); }))
# 702 "coders/dpx.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/dpx.c",__func__,(unsigned long) 704,"%s",
      image_info->filename);
...
# 711 "coders/dpx.c"
  ...
  if ((count != 4) || ((LocaleNCompare(magick,"SDPX",4) != 0) &&
    ...
    { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 721,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 721 "coders/dpx.c" 3 4
   ((void *)0)
# 721 "coders/dpx.c"
...
# 721 "coders/dpx.c"
  ...
  if (dpx.image.orientation > 7)
    { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 791,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 791 "coders/dpx.c" 3 4
   ((void *)0)
# 791 "coders/dpx.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 791 "coders/dpx.c" 3 4
...
# 791 "coders/dpx.c"
  ...
  if ((dpx.image.number_elements < 1) ||
      (dpx.image.number_elements > 8))
    { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 811,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 811 "coders/dpx.c" 3 4
   ((void *)0)
# 811 "coders/dpx.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 811 "coders/dpx.c" 3 4
          ...
          ((size_t) dpx.file.user_size > sizeof(dpx.user.id)))
        {
          StringInfo
           ...
           if ((MagickSizeType) dpx.file.user_size > GetBlobSize(image))
             { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1114,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1114 "coders/dpx.c" 3 4
            ((void *)0)
# 1114 "coders/dpx.c"
            ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1114 "coders/dpx.c" 3 4
...
# 1116 "coders/dpx.c" 3 4
                                                           ((void *)0)
# 1116 "coders/dpx.c"
                                                               ,
             dpx.file.user_size-sizeof(dpx.user.id));
           if (profile == (StringInfo *) 
# 1118 "coders/dpx.c" 3 4
                                        ((void *)0)
# 1118 "coders/dpx.c"
                                            )
             { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1119,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1119 "coders/dpx.c" 3 4
            ((void *)0)
# 1119 "coders/dpx.c"
            ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1119 "coders/dpx.c" 3 4
...
# 1132 "coders/dpx.c" 3 4
     (*__errno_location ())
# 1132 "coders/dpx.c"
     ); (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1132,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                        ;
    ...
    if ((dpx.image.image_element[n].data_offset != ~0U) &&
        (dpx.image.image_element[n].data_offset != 0U))
      {
         ...
         if (data_offset < offset)
           offset=SeekBlob(image,data_offset,
# 1163 "coders/dpx.c" 3 4
                                            0
# 1163 "coders/dpx.c"
                                                    );
         else
           for ( ; offset < data_offset; offset++)
             if (ReadBlobByte(image) == 
# 1166 "coders/dpx.c" 3 4
                                       (-1)
# 1166 "coders/dpx.c"
                                          )
               break;
          if (offset != data_offset)
            { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1169,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1169 "coders/dpx.c" 3 4
           ((void *)0)
# 1169 "coders/dpx.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1169 "coders/dpx.c" 3 4
...
# 1169 "coders/dpx.c"
    ...
    if ((image->depth == 0) || (image->depth > 32))
      { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1175,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1175 "coders/dpx.c" 3 4
     ((void *)0)
# 1175 "coders/dpx.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1175 "coders/dpx.c" 3 4
...
# 1242 "coders/dpx.c" 3 4
                                       ((void *)0)
# 1242 "coders/dpx.c"
                                           )
      { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1243,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1243 "coders/dpx.c" 3 4
     ((void *)0)
# 1243 "coders/dpx.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1243 "coders/dpx.c" 3 4
...
# 1268 "coders/dpx.c" 3 4
                                                             ((void *)0)
# 1268 "coders/dpx.c"
                                                                 ) &&
          (image->previous == (Image *) 
# 1269 "coders/dpx.c" 3 4
                                       ((void *)0)
# 1269 "coders/dpx.c"
                                           ))
        {
          ...
          proceed=SetImageProgress(image,"Load/Image",(MagickOffsetType) row,
            image->rows);
      ...
      if (q == (Quantum *) 
# 1281 "coders/dpx.c" 3 4
                          ((void *)0)
# 1281 "coders/dpx.c"
                              )
        break;
      length=ImportQuantumPixels(image,(CacheView *) 
# 1283 "coders/dpx.c" 3 4
                                                    ((void *)0)
# 1283 "coders/dpx.c"
                                                        ,quantum_info,
    ...
    if (y < (ssize_t) image->rows)
      { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1292,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1292 "coders/dpx.c" 3 4
     ((void *)0)
# 1292 "coders/dpx.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1292 "coders/dpx.c" 3 4
...
# 1292 "coders/dpx.c"
    ...
    if (EOFBlob(image) != MagickFalse)
      { char *file_message; file_message=GetExceptionMessage(
# 1295 "coders/dpx.c" 3 4
     (*__errno_location ())
# 1295 "coders/dpx.c"
     ); (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1295,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                        ;
...
# 1347 "coders/dpx.c"
__attribute__ ((visibility ("default"))) size_t RegisterDPXImage(void)
{
  MagickInfo
    *entry;
...
# 1390 "coders/dpx.c"
__attribute__ ((visibility ("default"))) void UnregisterDPXImage(void)
{
...
# 1440 "coders/dpx.c"
    ...
    buffer[0]=(*key++);
    value|=(unsigned int) ((strtol(buffer,(char **) 
# 1446 "coders/dpx.c" 3 4
                                                   ((void *)0)
# 1446 "coders/dpx.c"
                                                       ,16)) << shift);
    shift-=4;
...
# 1521 "coders/dpx.c"
 "image_info != (const ImageInfo *) NULL"
# 1521 "coders/dpx.c" 3 4
 , "coders/dpx.c", 1521, __extension__ __PRETTY_FUNCTION__); }))
# 1521 "coders/dpx.c"
                                               ;
  
# 1522 "coders/dpx.c" 3 4
 ((void) sizeof ((
# 1522 "coders/dpx.c"
 image_info->signature == 0xabacadabUL
# 1522 "coders/dpx.c" 3 4
...
# 1522 "coders/dpx.c"
 "image_info->signature == MagickCoreSignature"
# 1522 "coders/dpx.c" 3 4
 , "coders/dpx.c", 1522, __extension__ __PRETTY_FUNCTION__); }))
# 1522 "coders/dpx.c"
                                                     ;
  
# 1523 "coders/dpx.c" 3 4
 ((void) sizeof ((
# 1523 "coders/dpx.c"
 image != (Image *) 
# 1523 "coders/dpx.c" 3 4
...
# 1523 "coders/dpx.c"
 "image != (Image *) NULL"
# 1523 "coders/dpx.c" 3 4
 , "coders/dpx.c", 1523, __extension__ __PRETTY_FUNCTION__); }))
# 1523 "coders/dpx.c"
                                ;
  
# 1524 "coders/dpx.c" 3 4
 ((void) sizeof ((
# 1524 "coders/dpx.c"
...
# 1524 "coders/dpx.c" 3 4
 , "coders/dpx.c", 1524, __extension__ __PRETTY_FUNCTION__); }))
# 1524 "coders/dpx.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/dpx.c",__func__,(unsigned long) 1526,"%s",image->filename);
  horizontal_factor=4;
  vertical_factor=4;
  if (image_info->sampling_factor != (char *) 
# 1529 "coders/dpx.c" 3 4
                                             ((void *)0)
# 1529 "coders/dpx.c"
                                                 )
    {
      ...
      if ((horizontal_factor != 1) && (horizontal_factor != 2) &&
        ...
        { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1540,CorruptImageError,"UnexpectedSamplingFactor", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1540 "coders/dpx.c" 3 4
       ((void *)0)
# 1540 "coders/dpx.c"
...
# 1546 "coders/dpx.c"
 "exception != (ExceptionInfo *) NULL"
# 1546 "coders/dpx.c" 3 4
 , "coders/dpx.c", 1546, __extension__ __PRETTY_FUNCTION__); }))
# 1546 "coders/dpx.c"
                                            ;
  
# 1547 "coders/dpx.c" 3 4
 ((void) sizeof ((
# 1547 "coders/dpx.c"
 exception->signature == 0xabacadabUL
# 1547 "coders/dpx.c" 3 4
...
# 1547 "coders/dpx.c"
 "exception->signature == MagickCoreSignature"
# 1547 "coders/dpx.c" 3 4
 , "coders/dpx.c", 1547, __extension__ __PRETTY_FUNCTION__); }))
# 1547 "coders/dpx.c"
                                                    ;
  ...
  if (profile != (StringInfo *) 
# 1560 "coders/dpx.c" 3 4
                               ((void *)0)
# 1560 "coders/dpx.c"
                                   )
    {
      if (GetStringInfoLength(profile) > 1048576)
        { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1563,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1563 "coders/dpx.c" 3 4
       ((void *)0)
# 1563 "coders/dpx.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
...
# 1592 "coders/dpx.c"
  ...
  offset+=WriteBlob(image,sizeof(dpx.file.timestamp),(unsigned char *)
    dpx.file.timestamp);
  (void) CopyMagickString(dpx.file.creator,"https://imagemagick.org",
    sizeof(dpx.file.creator));
  value=GetDPXProperty(image,"dpx:file.creator",exception);
  if (value != (const char *) 
# 1604 "coders/dpx.c" 3 4
                             ((void *)0)
# 1604 "coders/dpx.c"
                                 )
...
# 1614 "coders/dpx.c"
  ...
  if ((image->columns != (unsigned int) image->columns) ||
    ...
    { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1643,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1643 "coders/dpx.c" 3 4
   ((void *)0)
# 1643 "coders/dpx.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
...
# 1738 "coders/dpx.c"
  ...
  if (value != (const char *) 
# 1743 "coders/dpx.c" 3 4
                             ((void *)0)
# 1743 "coders/dpx.c"
                                 )
    dpx.orientation.x_center=StringToDouble(value,(char **) 
# 1744 "coders/dpx.c" 3 4
                                                           ((void *)0)
# 1744 "coders/dpx.c"
                                                               );
  ...
  if (value != (const char *) 
# 1748 "coders/dpx.c" 3 4
                             ((void *)0)
# 1748 "coders/dpx.c"
                                 )
    dpx.orientation.y_center=StringToDouble(value,(char **) 
# 1749 "coders/dpx.c" 3 4
                                                           ((void *)0)
# 1749 "coders/dpx.c"
                                                               );
...
# 1861 "coders/dpx.c"
  ...
  if (value != (const char *) 
# 1866 "coders/dpx.c" 3 4
                             ((void *)0)
# 1866 "coders/dpx.c"
                                 )
    dpx.film.frame_rate=StringToDouble(value,(char **) 
# 1867 "coders/dpx.c" 3 4
                                                      ((void *)0)
# 1867 "coders/dpx.c"
                                                          );
  ...
  if (value != (const char *) 
# 1871 "coders/dpx.c" 3 4
                             ((void *)0)
# 1871 "coders/dpx.c"
                                 )
    dpx.film.shutter_angle=StringToDouble(value,(char **) 
# 1872 "coders/dpx.c" 3 4
                                                         ((void *)0)
# 1872 "coders/dpx.c"
                                                             );
...
# 1913 "coders/dpx.c"
  ...
  value=GetDPXProperty(image,"dpx:television.horizontal_sample_rate",
    exception);
  if (value != (const char *) 
# 1919 "coders/dpx.c" 3 4
                             ((void *)0)
# 1919 "coders/dpx.c"
                                 )
    dpx.television.horizontal_sample_rate=StringToDouble(value,(char **) 
# 1920 "coders/dpx.c" 3 4
                                                                        ((void *)0)
# 1920 "coders/dpx.c"
                                                                            );
  ...
  if (value != (const char *) 
# 1924 "coders/dpx.c" 3 4
                             ((void *)0)
# 1924 "coders/dpx.c"
                                 )
    dpx.television.vertical_sample_rate=StringToDouble(value,(char **) 
# 1925 "coders/dpx.c" 3 4
                                                                      ((void *)0)
# 1925 "coders/dpx.c"
                                                                          );
  ...
  if (value != (const char *) 
# 1929 "coders/dpx.c" 3 4
                             ((void *)0)
# 1929 "coders/dpx.c"
                                 )
    dpx.television.frame_rate=StringToDouble(value,(char **) 
# 1930 "coders/dpx.c" 3 4
                                                            ((void *)0)
# 1930 "coders/dpx.c"
                                                                );
  ...
  if (value != (const char *) 
# 1934 "coders/dpx.c" 3 4
                             ((void *)0)
# 1934 "coders/dpx.c"
                                 )
    dpx.television.time_offset=StringToDouble(value,(char **) 
# 1935 "coders/dpx.c" 3 4
                                                             ((void *)0)
# 1935 "coders/dpx.c"
                                                                 );
  ...
  if (value != (const char *) 
# 1939 "coders/dpx.c" 3 4
                             ((void *)0)
# 1939 "coders/dpx.c"
                                 )
    dpx.television.gamma=StringToDouble(value,(char **) 
# 1940 "coders/dpx.c" 3 4
                                                       ((void *)0)
# 1940 "coders/dpx.c"
                                                           );
  ...
  if (value != (const char *) 
# 1944 "coders/dpx.c" 3 4
                             ((void *)0)
# 1944 "coders/dpx.c"
                                 )
    dpx.television.black_level=StringToDouble(value,(char **) 
# 1945 "coders/dpx.c" 3 4
                                                             ((void *)0)
# 1945 "coders/dpx.c"
                                                                 );
  ...
  if (value != (const char *) 
# 1949 "coders/dpx.c" 3 4
                             ((void *)0)
# 1949 "coders/dpx.c"
                                 )
    dpx.television.black_gain=StringToDouble(value,(char **) 
# 1950 "coders/dpx.c" 3 4
                                                            ((void *)0)
# 1950 "coders/dpx.c"
                                                                );
  ...
  if (value != (const char *) 
# 1954 "coders/dpx.c" 3 4
                             ((void *)0)
# 1954 "coders/dpx.c"
                                 )
    dpx.television.break_point=StringToDouble(value,(char **) 
# 1955 "coders/dpx.c" 3 4
                                                             ((void *)0)
# 1955 "coders/dpx.c"
                                                                 );
  ...
  if (value != (const char *) 
# 1959 "coders/dpx.c" 3 4
                             ((void *)0)
# 1959 "coders/dpx.c"
                                 )
    dpx.television.white_level=StringToDouble(value,(char **) 
# 1960 "coders/dpx.c" 3 4
                                                             ((void *)0)
# 1960 "coders/dpx.c"
                                                                 );
  ...
  if (value != (const char *) 
# 1964 "coders/dpx.c" 3 4
                             ((void *)0)
# 1964 "coders/dpx.c"
                                 )
    dpx.television.integration_times=StringToDouble(value,(char **) 
# 1965 "coders/dpx.c" 3 4
                                                                   ((void *)0)
# 1965 "coders/dpx.c"
                                                                       );
...
# 1976 "coders/dpx.c"
  ...
  while (offset < (MagickOffsetType) dpx.image.image_element[0].data_offset)
  {
    ...
    if (count != 1)
      {
        { char *file_message; file_message=GetExceptionMessage(
# 1984 "coders/dpx.c" 3 4
       (*__errno_location ())
# 1984 "coders/dpx.c"
       ); (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1984,FileOpenError,"UnableToWriteFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
    offset+=count;
  ...
  quantum_info=AcquireQuantumInfo(image_info,image);
  if (quantum_info == (QuantumInfo *) 
# 1994 "coders/dpx.c" 3 4
                                     ((void *)0)
# 1994 "coders/dpx.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 1995,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1995 "coders/dpx.c" 3 4
   ((void *)0)
# 1995 "coders/dpx.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  SetQuantumQuantum(quantum_info,32);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 2057 "coders/dpx.c" 3 4
                              ((void *)0)
# 2057 "coders/dpx.c"
                                  )
      break;
    length=ExportQuantumPixels(image,(CacheView *) 
# 2059 "coders/dpx.c" 3 4
                                                  ((void *)0)
# 2059 "coders/dpx.c"
                                                      ,quantum_info,
  ...
  quantum_info=DestroyQuantumInfo(quantum_info);
  if (y < (ssize_t) image->rows)
    { (void) ThrowMagickException(exception,"coders/dpx.c",__func__,(unsigned long) 2073,CorruptImageError,"UnableToWriteImageData", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2073 "coders/dpx.c" 3 4
   ((void *)0)
# 2073 "coders/dpx.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  if (CloseBlob(image) == MagickFalse)
