...
# 178 "coders/dib.c"
 "image != (Image *) NULL"
# 178 "coders/dib.c" 3 4
 , "coders/dib.c", 178, __extension__ __PRETTY_FUNCTION__); }))
# 178 "coders/dib.c"
                                ;
  
# 179 "coders/dib.c" 3 4
 ((void) sizeof ((
# 179 "coders/dib.c"
...
# 179 "coders/dib.c" 3 4
 , "coders/dib.c", 179, __extension__ __PRETTY_FUNCTION__); }))
# 179 "coders/dib.c"
                                                ;
  
# 180 "coders/dib.c" 3 4
 ((void) sizeof ((
# 180 "coders/dib.c"
...
# 180 "coders/dib.c" 3 4
 , "coders/dib.c", 180, __extension__ __PRETTY_FUNCTION__); }))
# 180 "coders/dib.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/dib.c",__func__,(unsigned long) 182,"%s",image->filename);
    ...
    if (count > 0)
      {
        ...
        count=(int) ((((size_t) count) < ((size_t) (q-p))) ? ((size_t) count) : ((size_t) (q-p)));
        byte=ReadBlobByte(image);
        if (byte == 
# 205 "coders/dib.c" 3 4
                   (-1)
# 205 "coders/dib.c"
                      )
          break;
...
# 363 "coders/dib.c"
 "image != (Image *) NULL"
# 363 "coders/dib.c" 3 4
 , "coders/dib.c", 363, __extension__ __PRETTY_FUNCTION__); }))
# 363 "coders/dib.c"
                                ;
  
# 364 "coders/dib.c" 3 4
 ((void) sizeof ((
# 364 "coders/dib.c"
 image->signature == 0xabacadabUL
# 364 "coders/dib.c" 3 4
...
# 364 "coders/dib.c"
 "image->signature == MagickCoreSignature"
# 364 "coders/dib.c" 3 4
 , "coders/dib.c", 364, __extension__ __PRETTY_FUNCTION__); }))
# 364 "coders/dib.c"
                                                ;
  
# 365 "coders/dib.c" 3 4
 ((void) sizeof ((
# 365 "coders/dib.c"
...
# 365 "coders/dib.c" 3 4
 , "coders/dib.c", 365, __extension__ __PRETTY_FUNCTION__); }))
# 365 "coders/dib.c"
                                               ;
  
# 366 "coders/dib.c" 3 4
 ((void) sizeof ((
# 366 "coders/dib.c"
...
# 366 "coders/dib.c" 3 4
 , "coders/dib.c", 366, __extension__ __PRETTY_FUNCTION__); }))
# 366 "coders/dib.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/dib.c",__func__,(unsigned long) 368,"%s",image->filename);
  p=pixels;
  q=compressed_pixels;
  i=0;
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    *q++=0x00;
    *q++=0x00;
    if (SetImageProgress(image,"Load/Image",(MagickOffsetType) y,image->rows) == MagickFalse)
      break;
  }
...
# 507 "coders/dib.c" 3 4
 , "coders/dib.c", 507, __extension__ __PRETTY_FUNCTION__); }))
# 507 "coders/dib.c"
                                               ;
  
# 508 "coders/dib.c" 3 4
 ((void) sizeof ((
# 508 "coders/dib.c"
...
# 508 "coders/dib.c" 3 4
 , "coders/dib.c", 508, __extension__ __PRETTY_FUNCTION__); }))
# 508 "coders/dib.c"
                                                     ;
  
# 509 "coders/dib.c" 3 4
 ((void) sizeof ((
# 509 "coders/dib.c"
...
# 509 "coders/dib.c" 3 4
 , "coders/dib.c", 509, __extension__ __PRETTY_FUNCTION__); }))
# 509 "coders/dib.c"
                                            ;
  
# 510 "coders/dib.c" 3 4
 ((void) sizeof ((
# 510 "coders/dib.c"
...
# 510 "coders/dib.c" 3 4
 , "coders/dib.c", 510, __extension__ __PRETTY_FUNCTION__); }))
# 510 "coders/dib.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/dib.c",__func__,(unsigned long) 512,"%s",
      image_info->filename);
...
# 519 "coders/dib.c"
  ...
  if (dib_info.size != 40)
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 527,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 527 "coders/dib.c" 3 4
   ((void *)0)
# 527 "coders/dib.c"
...
# 527 "coders/dib.c"
  ...
  if (dib_info.bits_per_pixel > 32)
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 536,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 536 "coders/dib.c" 3 4
   ((void *)0)
# 536 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 536 "coders/dib.c" 3 4
...
# 536 "coders/dib.c"
  ...
  if ((dib_info.bits_per_pixel != 1) && (dib_info.bits_per_pixel != 4) &&
    ...
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 546,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 546 "coders/dib.c" 3 4
   ((void *)0)
# 546 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 546 "coders/dib.c" 3 4
...
# 546 "coders/dib.c"
  ...
  if (EOFBlob(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 555,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 555 "coders/dib.c" 3 4
   ((void *)0)
# 555 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 555 "coders/dib.c" 3 4
...
# 555 "coders/dib.c"
  ...
  if (dib_info.width <= 0)
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 557,CorruptImageError,"NegativeOrZeroImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 557 "coders/dib.c" 3 4
   ((void *)0)
# 557 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 557 "coders/dib.c" 3 4
...
# 557 "coders/dib.c"
  ...
  if (dib_info.height == 0)
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 559,CorruptImageError,"NegativeOrZeroImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 559 "coders/dib.c" 3 4
   ((void *)0)
# 559 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 559 "coders/dib.c" 3 4
...
# 559 "coders/dib.c"
  ...
  if (dib_info.planes != 1)
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 561,CorruptImageError,"StaticPlanesValueNotEqualToOne", "`%s'",image_info->filename); if ((image) != (Image *) 
# 561 "coders/dib.c" 3 4
   ((void *)0)
# 561 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 561 "coders/dib.c" 3 4
...
# 561 "coders/dib.c"
  ...
  if ((dib_info.bits_per_pixel != 1) && (dib_info.bits_per_pixel != 4) &&
      (dib_info.bits_per_pixel != 8) && (dib_info.bits_per_pixel != 16) &&
      (dib_info.bits_per_pixel != 24) && (dib_info.bits_per_pixel != 32))
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 565,CorruptImageError,"UnsupportedBitsPerPixel", "`%s'",image_info->filename); if ((image) != (Image *) 
# 565 "coders/dib.c" 3 4
   ((void *)0)
# 565 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 565 "coders/dib.c" 3 4
...
# 565 "coders/dib.c"
  ...
  if ((dib_info.bits_per_pixel < 16) &&
    ...
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 568,CorruptImageError,"UnrecognizedNumberOfColors", "`%s'",image_info->filename); if ((image) != (Image *) 
# 568 "coders/dib.c" 3 4
   ((void *)0)
# 568 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 568 "coders/dib.c" 3 4
...
# 568 "coders/dib.c"
  ...
  if ((dib_info.compression == 1) && (dib_info.bits_per_pixel != 8))
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 570,CorruptImageError,"UnsupportedBitsPerPixel", "`%s'",image_info->filename); if ((image) != (Image *) 
# 570 "coders/dib.c" 3 4
   ((void *)0)
# 570 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 570 "coders/dib.c" 3 4
...
# 570 "coders/dib.c"
  ...
  if ((dib_info.compression == 2) && (dib_info.bits_per_pixel != 4))
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 572,CorruptImageError,"UnsupportedBitsPerPixel", "`%s'",image_info->filename); if ((image) != (Image *) 
# 572 "coders/dib.c" 3 4
   ((void *)0)
# 572 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 572 "coders/dib.c" 3 4
...
# 572 "coders/dib.c"
  ...
  if ((dib_info.compression == 3) && (dib_info.bits_per_pixel < 16))
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 574,CorruptImageError,"UnsupportedBitsPerPixel", "`%s'",image_info->filename); if ((image) != (Image *) 
# 574 "coders/dib.c" 3 4
   ((void *)0)
# 574 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 574 "coders/dib.c" 3 4
...
# 574 "coders/dib.c"
  ...
  switch (dib_info.compression)
  {
    ...
    case 3:
      break;
    case 4:
      { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 583,CoderError,"JPEGCompressNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 583 "coders/dib.c" 3 4
     ((void *)0)
# 583 "coders/dib.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 583 "coders/dib.c" 3 4
...
# 583 "coders/dib.c"
    ...
    case 5:
      { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 585,CoderError,"PNGCompressNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 585 "coders/dib.c" 3 4
     ((void *)0)
# 585 "coders/dib.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 585 "coders/dib.c" 3 4
...
# 585 "coders/dib.c"
    ...
    default:
      { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 587,CorruptImageError,"UnrecognizedImageCompression", "`%s'",image_info->filename); if ((image) != (Image *) 
# 587 "coders/dib.c" 3 4
     ((void *)0)
# 587 "coders/dib.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 587 "coders/dib.c" 3 4
...
# 587 "coders/dib.c"
  ...
  image->columns=(size_t) (((ssize_t) dib_info.width) < 0 ? -((ssize_t) dib_info.width) : ((ssize_t) dib_info.width));
  image->rows=(size_t) (((ssize_t) dib_info.height) < 0 ? -((ssize_t) dib_info.height) : ((ssize_t) dib_info.height));
  image->depth=8;
  image->alpha_trait=dib_info.bits_per_pixel == 32 ? BlendPixelTrait :
    UndefinedPixelTrait;
  if ((dib_info.number_colors > 256) || (dib_info.colors_important > 256))
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 595,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 595 "coders/dib.c" 3 4
   ((void *)0)
# 595 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 595 "coders/dib.c" 3 4
...
# 595 "coders/dib.c"
  ...
  if ((dib_info.number_colors != 0) && (dib_info.bits_per_pixel > 8))
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 597,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 597 "coders/dib.c" 3 4
   ((void *)0)
# 597 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 597 "coders/dib.c" 3 4
...
# 597 "coders/dib.c"
  ...
  if ((dib_info.image_size != 0U) && (dib_info.image_size > GetBlobSize(image)))
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 599,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 599 "coders/dib.c" 3 4
   ((void *)0)
# 599 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 599 "coders/dib.c" 3 4
  ...
  if (image->storage_class == PseudoClass)
    {
      ...
      if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
        { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 642,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 642 "coders/dib.c" 3 4
       ((void *)0)
# 642 "coders/dib.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 642 "coders/dib.c" 3 4
...
# 642 "coders/dib.c"
      ...
      if (dib_colormap == (unsigned char *) 
# 646 "coders/dib.c" 3 4
                                           ((void *)0)
# 646 "coders/dib.c"
                                               )
        { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 647,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 647 "coders/dib.c" 3 4
       ((void *)0)
# 647 "coders/dib.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 647 "coders/dib.c" 3 4
      ...
      if (count != (ssize_t) (packet_size*image->colors))
        {
          ...
          { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 653,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 653 "coders/dib.c" 3 4
         ((void *)0)
# 653 "coders/dib.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 653 "coders/dib.c" 3 4
...
# 653 "coders/dib.c"
  ...
  if ((MagickSizeType) length > (256*GetBlobSize(image)))
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 674,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 674 "coders/dib.c" 3 4
   ((void *)0)
# 674 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 674 "coders/dib.c" 3 4
...
# 677 "coders/dib.c" 3 4
                                  ((void *)0)
# 677 "coders/dib.c"
                                      )
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 678,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 678 "coders/dib.c" 3 4
   ((void *)0)
# 678 "coders/dib.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 678 "coders/dib.c" 3 4
...
# 678 "coders/dib.c"
  ...
  if ((dib_info.compression == 0) ||
      (dib_info.compression == 3))
    {
      count=ReadBlob(image,length,pixels);
      if (count != (ssize_t) (length))
        {
          pixel_info=RelinquishVirtualMemory(pixel_info);
          { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 687,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 687 "coders/dib.c" 3 4
         ((void *)0)
# 687 "coders/dib.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 687 "coders/dib.c" 3 4
...
# 687 "coders/dib.c"
  ...
  else
    {
      ...
      if (status == MagickFalse)
        {
          pixel_info=RelinquishVirtualMemory(pixel_info);
          { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 700,CorruptImageError,"UnableToRunlengthDecodeImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 700 "coders/dib.c" 3 4
         ((void *)0)
# 700 "coders/dib.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 700 "coders/dib.c" 3 4
...
# 913 "coders/dib.c"
    ...
    default:
      pixel_info=RelinquishVirtualMemory(pixel_info);
      { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 925,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 925 "coders/dib.c" 3 4
     ((void *)0)
# 925 "coders/dib.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 925 "coders/dib.c" 3 4
...
# 939 "coders/dib.c"
        ...
        for (x=0; x < ((ssize_t) image->columns-7); x+=8)
        {
          ...
          for (bit=0; bit < 8; bit++)
          {
            ...
            SetPixelAlpha(image,c & (0x80 >> bit) ? ((Quantum) 0) :
              ((Quantum) ((Quantum) 65535.0)),q+x*(ssize_t) GetPixelChannels(image)+bit);
          }
        }
        if ((image->columns % 8) != 0)
          {
...
# 971 "coders/dib.c" 3 4
   (*__errno_location ())
# 971 "coders/dib.c"
   ); (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 971,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
  if (dib_info.height < 0)
    {
      Image
...
# 1019 "coders/dib.c"
__attribute__ ((visibility ("default"))) size_t RegisterDIBImage(void)
{
  MagickInfo
    *entry;
...
# 1063 "coders/dib.c"
__attribute__ ((visibility ("default"))) void UnregisterDIBImage(void)
{
...
# 1129 "coders/dib.c"
 "image_info != (const ImageInfo *) NULL"
# 1129 "coders/dib.c" 3 4
 , "coders/dib.c", 1129, __extension__ __PRETTY_FUNCTION__); }))
# 1129 "coders/dib.c"
                                               ;
  
# 1130 "coders/dib.c" 3 4
 ((void) sizeof ((
# 1130 "coders/dib.c"
 image_info->signature == 0xabacadabUL
# 1130 "coders/dib.c" 3 4
...
# 1130 "coders/dib.c"
 "image_info->signature == MagickCoreSignature"
# 1130 "coders/dib.c" 3 4
 , "coders/dib.c", 1130, __extension__ __PRETTY_FUNCTION__); }))
# 1130 "coders/dib.c"
                                                     ;
  
# 1131 "coders/dib.c" 3 4
 ((void) sizeof ((
# 1131 "coders/dib.c"
 image != (Image *) 
# 1131 "coders/dib.c" 3 4
...
# 1131 "coders/dib.c"
 "image != (Image *) NULL"
# 1131 "coders/dib.c" 3 4
 , "coders/dib.c", 1131, __extension__ __PRETTY_FUNCTION__); }))
# 1131 "coders/dib.c"
                                ;
  
# 1132 "coders/dib.c" 3 4
 ((void) sizeof ((
# 1132 "coders/dib.c"
 image->signature == 0xabacadabUL
# 1132 "coders/dib.c" 3 4
...
# 1132 "coders/dib.c"
 "image->signature == MagickCoreSignature"
# 1132 "coders/dib.c" 3 4
 , "coders/dib.c", 1132, __extension__ __PRETTY_FUNCTION__); }))
# 1132 "coders/dib.c"
                                                ;
  
# 1133 "coders/dib.c" 3 4
 ((void) sizeof ((
# 1133 "coders/dib.c"
 exception != (ExceptionInfo *) 
# 1133 "coders/dib.c" 3 4
...
# 1133 "coders/dib.c"
 "exception != (ExceptionInfo *) NULL"
# 1133 "coders/dib.c" 3 4
 , "coders/dib.c", 1133, __extension__ __PRETTY_FUNCTION__); }))
# 1133 "coders/dib.c"
                                            ;
  
# 1134 "coders/dib.c" 3 4
 ((void) sizeof ((
# 1134 "coders/dib.c"
 exception->signature == 0xabacadabUL
# 1134 "coders/dib.c" 3 4
...
# 1134 "coders/dib.c"
 "exception->signature == MagickCoreSignature"
# 1134 "coders/dib.c" 3 4
 , "coders/dib.c", 1134, __extension__ __PRETTY_FUNCTION__); }))
# 1134 "coders/dib.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/dib.c",__func__,(unsigned long) 1136,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  if (((image->columns << 3) != (size_t) ((int) (image->columns << 3))) ||
      ((image->rows << 3) != (size_t) ((int) (image->rows << 3))))
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 1142,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1142 "coders/dib.c" 3 4
   ((void *)0)
# 1142 "coders/dib.c"
  ...
  pixels=(unsigned char *) AcquireQuantumMemory(image->rows,(((bytes_per_line) > (image->columns+256UL)) ? (bytes_per_line) : (image->columns+256UL))
                                        *sizeof(*pixels));
  if (pixels == (unsigned char *) 
# 1201 "coders/dib.c" 3 4
                                 ((void *)0)
# 1201 "coders/dib.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 1202,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1202 "coders/dib.c" 3 4
   ((void *)0)
# 1202 "coders/dib.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    ...
    if (image_info->compression != NoCompression)
      {
        ...
        if (dib_data == (unsigned char *) 
# 1352 "coders/dib.c" 3 4
                                         ((void *)0)
# 1352 "coders/dib.c"
                                             )
          {
            pixels=(unsigned char *) RelinquishMagickMemory(pixels);
            { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 1355,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1355 "coders/dib.c" 3 4
           ((void *)0)
# 1355 "coders/dib.c"
           ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
          }
      ...
      if (dib_info.bits_per_pixel <= 8)
        {
          ...
          if (dib_colormap == (unsigned char *) 
# 1389 "coders/dib.c" 3 4
                                               ((void *)0)
# 1389 "coders/dib.c"
                                                   )
            {
              pixels=(unsigned char *) RelinquishMagickMemory(pixels);
              { (void) ThrowMagickException(exception,"coders/dib.c",__func__,(unsigned long) 1392,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1392 "coders/dib.c" 3 4
             ((void *)0)
# 1392 "coders/dib.c"
             ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
            }
          q=dib_colormap;
          for (i=0; i < (ssize_t) (((image->colors) < (dib_info.number_colors)) ? (image->colors) : (dib_info.number_colors)); i++)
          {
