...
# 25 "./MagickCore/xml-tree-private.h"
...
# 26 "./MagickCore/xml-tree-private.h" 2
...
# 88 "coders/pdf.c" 2
# 1 "./coders/bytebuffer-private.h" 1
# 22 "./coders/bytebuffer-private.h"
  ...
  if ((buffer->offset == buffer->count) && (buffer->offset > 0))
    {
      if (buffer->count != (ssize_t) sizeof(buffer->data)-1)
        return(
# 40 "./coders/bytebuffer-private.h" 3 4
              (-1)
# 40 "./coders/bytebuffer-private.h"
                 );
      buffer->offset=0;
      buffer->count=0;
    }
  if ((buffer->offset == 0) && (buffer->count == 0))
    {
      ...
      if (buffer->count < 1)
        return(
# 49 "./coders/bytebuffer-private.h" 3 4
              (-1)
# 49 "./coders/bytebuffer-private.h"
                 );
    }
...
static inline int ReadMagickByteBuffer(MagickByteBuffer *buffer)
{
  ...
  if (result != 
# 60 "./coders/bytebuffer-private.h" 3 4
               (-1)
# 60 "./coders/bytebuffer-private.h"
                  )
    buffer->offset++;
  return(result);
}
  ...
  MagickByteBuffer *buffer)
{
  ...
  while ((c != '\n') && (c != '\r'))
  {
    c=ReadMagickByteBuffer(buffer);
    if (c == 
# 124 "./coders/bytebuffer-private.h" 3 4
            (-1)
# 124 "./coders/bytebuffer-private.h"
               )
      return(MagickFalse);
  }
  return(MagickTrue);
...
# 90 "coders/pdf.c" 2
# 1 "./coders/ghostscript-private.h" 1
# 61 "./coders/ghostscript-private.h"
  ...
  ExceptionInfo *exception)
{
  ...
  if (status < 0)
    return(MagickFalse);
  (void) ThrowMagickException(exception,"./coders/ghostscript-private.h",__func__,(unsigned long) 74,DelegateError,
...
static inline MagickBooleanType InvokeGhostscriptDelegate(
  ...
  ExceptionInfo *exception)
{
# 199 "./coders/ghostscript-private.h"
...
static MagickBooleanType IsGhostscriptRendered(const char *path)
{
  ...
  if ((path == (const char *) 
# 211 "./coders/ghostscript-private.h" 3 4
                             ((void *)0)
# 211 "./coders/ghostscript-private.h"
                                 ) || (*path == '\0'))
    return(MagickFalse);
  status=GetPathAttributes(path,&attributes);
  if ((status != MagickFalse) && 
# 214 "./coders/ghostscript-private.h" 3 4
                                ((((
# 214 "./coders/ghostscript-private.h"
                                attributes.st_mode
# 214 "./coders/ghostscript-private.h" 3 4
                                )) & 0170000) == (0100000)) 
# 214 "./coders/ghostscript-private.h"
...
# 242 "./coders/ghostscript-private.h" 3 4
                                ((void *)0)
# 242 "./coders/ghostscript-private.h"
                                    )
    return;
  status=CompareMagickByteBuffer(buffer,"?xpacket begin=",strlen("?xpacket begin="));
  if (status == MagickFalse)
    return;
  length=8192;
  ...
  *p++='<';
  count=1;
  for (c=ReadMagickByteBuffer(buffer); c != 
# 253 "./coders/ghostscript-private.h" 3 4
                                           (-1)
# 253 "./coders/ghostscript-private.h"
                                              ; c=ReadMagickByteBuffer(buffer))
  {
    ...
    *p++=(char) c;
    if (found_end == MagickFalse)
      found_end=CompareMagickByteBuffer(buffer,"<?xpacket end=",
        strlen("<?xpacket end="));
    else
      {
        if (c == (int) '>')
...
# 252 "coders/pdf.c"
    ...
    if (CompareMagickByteBuffer(&buffer,"Rotate",strlen("Rotate")) != MagickFalse)
      {
        p=GetMagickByteBufferDatum(&buffer);
        (void) sscanf(p,"Rotate"" %lf",&pdf_info->angle);
      }
    ...
    if (CompareMagickByteBuffer(&buffer,"Separation",strlen("Separation")) != MagickFalse)
      {
        char
          name[4096],
          property[4096],
        ...
        (void) FormatLocaleString(property,4096,
          "pdf:SpotColor-%.20g",(double) spotcolor++);
        i=0;
        SkipMagickByteBuffer(&buffer,strlen("Separation")+1);
        for (c=ReadMagickByteBuffer(&buffer); c != 
# 305 "coders/pdf.c" 3 4
                                                  (-1)
# 305 "coders/pdf.c"
                                                     ; c=ReadMagickByteBuffer(&buffer))
        {
          if ((
# 307 "coders/pdf.c" 3 4
              ((*__ctype_b_loc ())[(int) ((
# 307 "coders/pdf.c"
              (int) ((unsigned char) c)
# 307 "coders/pdf.c" 3 4
...
# 438 "coders/pdf.c" 3 4
 , "coders/pdf.c", 438, __extension__ __PRETTY_FUNCTION__); }))
# 438 "coders/pdf.c"
                                               ;
  
# 439 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 439 "coders/pdf.c"
...
# 439 "coders/pdf.c" 3 4
 , "coders/pdf.c", 439, __extension__ __PRETTY_FUNCTION__); }))
# 439 "coders/pdf.c"
                                                     ;
  
# 440 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 440 "coders/pdf.c"
...
# 440 "coders/pdf.c" 3 4
 , "coders/pdf.c", 440, __extension__ __PRETTY_FUNCTION__); }))
# 440 "coders/pdf.c"
                                            ;
  
# 441 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 441 "coders/pdf.c"
...
# 441 "coders/pdf.c" 3 4
 , "coders/pdf.c", 441, __extension__ __PRETTY_FUNCTION__); }))
# 441 "coders/pdf.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pdf.c",__func__,(unsigned long) 443,"%s",
      image_info->filename);
...
# 458 "coders/pdf.c" 3 4
     (*__errno_location ())
# 458 "coders/pdf.c"
     ); (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 458,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",image_info->filename,file_message); file_message=DestroyString(file_message); }
                             ;
      image=DestroyImageList(image);
      return((Image *) 
# 461 "coders/pdf.c" 3 4
                      ((void *)0)
# 461 "coders/pdf.c"
                          );
    }
  ...
  if ((image->resolution.x == 0.0) || (image->resolution.y == 0.0))
    {
      flags=ParseGeometry("72.0x72.0",&geometry_info);
      if ((flags & RhoValue) != 0)
...
# 478 "coders/pdf.c"
  ...
  (void) ParseAbsoluteGeometry("612x792",&page);
  if (image_info->page != (char *) 
# 488 "coders/pdf.c" 3 4
                                  ((void *)0)
# 488 "coders/pdf.c"
                                      )
  ...
  if ((fabs(pdf_info.bounds.x2-pdf_info.bounds.x1) >= 1.0e-12) &&
      (fabs(pdf_info.bounds.y2-pdf_info.bounds.y1) >= 1.0e-12))
    {
...
# 516 "coders/pdf.c"
                            )
    {
      ...
      if (flags == NoValue)
        {
          (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 527,OptionError,
            "InvalidGeometry","`%s'",option);
          CleanupPDFInfo(&pdf_info);
          image=DestroyImage(image);
          return((Image *) 
# 531 "coders/pdf.c" 3 4
                          ((void *)0)
# 531 "coders/pdf.c"
                              );
        }
  ...
  if (file == -1)
    {
      ...
      { char *file_message; file_message=GetExceptionMessage(
# 557 "coders/pdf.c" 3 4
     (*__errno_location ())
# 557 "coders/pdf.c"
     ); (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 557,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",image_info->filename,file_message); file_message=DestroyString(file_message); }
                             ;
      CleanupPDFInfo(&pdf_info);
      image=DestroyImage(image);
      return((Image *) 
# 561 "coders/pdf.c" 3 4
                      ((void *)0)
# 561 "coders/pdf.c"
                          );
    }
...
# 570 "coders/pdf.c"
  ...
  if (image_info->monochrome != MagickFalse)
    delegate_info=GetDelegateInfo("ps:mono",(char *) 
# 577 "coders/pdf.c" 3 4
                                                    ((void *)0)
# 577 "coders/pdf.c"
                                                        ,exception);
  else
     if (pdf_info.cmyk != MagickFalse)
       delegate_info=GetDelegateInfo("ps:cmyk",(char *) 
# 580 "coders/pdf.c" 3 4
                                                       ((void *)0)
# 580 "coders/pdf.c"
                                                           ,exception);
     else
       delegate_info=GetDelegateInfo("ps:alpha",(char *) 
# 582 "coders/pdf.c" 3 4
                                                        ((void *)0)
# 582 "coders/pdf.c"
                                                            ,exception);
  if (delegate_info == (const DelegateInfo *) 
# 583 "coders/pdf.c" 3 4
                                             ((void *)0)
# 583 "coders/pdf.c"
                                                 )
    {
...
# 589 "coders/pdf.c"
  ...
  (void) FormatLocaleString(density,4096,"%gx%g",
    image->resolution.x,image->resolution.y);
  if (image_info->ping != MagickFalse)
    (void) FormatLocaleString(density,4096,"2.0x2.0");
  else
    if ((image_info->page != (char *) 
# 598 "coders/pdf.c" 3 4
                                     ((void *)0)
# 598 "coders/pdf.c"
                                         ) || (fitPage != MagickFalse))
      (void) FormatLocaleString(options,4096,"-g%.20gx%.20g ",
        (double) page.width,(double) page.height);
  option=GetImageOption(image_info,"pdf:printed");
  if (IsStringTrue(option) != MagickFalse)
    (void) ConcatenateMagickString(options,"-dPrinted=true ",4096);
  else
    (void) ConcatenateMagickString(options,"-dPrinted=false ",4096);
  if (fitPage != MagickFalse)
    (void) ConcatenateMagickString(options,"-dPSFitPage ",4096);
  if (pdf_info.cropbox != MagickFalse)
    (void) ConcatenateMagickString(options,"-dUseCropBox ",4096);
  if (pdf_info.trimbox != MagickFalse)
    (void) ConcatenateMagickString(options,"-dUseTrimBox ",4096);
...
# 625 "coders/pdf.c"
                            )
    {
      ...
      FormatSanitizedDelegateOption(passphrase,4096,
        "\"-sPDFPassword=%s\" ","-sPDFPassword='%s' ",option);
      (void) ConcatenateMagickString(options,passphrase,4096);
    }
  ...
  if (read_info->number_scenes != 0)
    {
      ...
      (void) FormatLocaleString(pages,4096,"-dFirstPage=%.20g "
        "-dLastPage=%.20g",(double) read_info->scene+1,(double)
        (read_info->scene+read_info->number_scenes));
      (void) ConcatenateMagickString(options,pages,4096);
      read_info->number_scenes=0;
      if (read_info->scenes != (char *) 
# 646 "coders/pdf.c" 3 4
                                       ((void *)0)
# 646 "coders/pdf.c"
                                           )
        *read_info->scenes='\0';
  ...
  (void) ConcatenateMagickString(filename,"%d",4096);
...
# 693 "coders/pdf.c"
  ...
  if (pdf_image == (Image *) 
# 709 "coders/pdf.c" 3 4
                            ((void *)0)
# 709 "coders/pdf.c"
                                )
    {
      if (*message != '\0')
        (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 712,DelegateError,
          "PDFDelegateFailed","`%s'",message);
      CleanupPDFInfo(&pdf_info);
      image=DestroyImage(image);
      return((Image *) 
# 716 "coders/pdf.c" 3 4
                      ((void *)0)
# 716 "coders/pdf.c"
                          );
    }
...
# 730 "coders/pdf.c"
                                            )
    {
      ...
      if (strstr(profile,"Adobe Illustrator") != (char *) 
# 737 "coders/pdf.c" 3 4
                                                         ((void *)0)
# 737 "coders/pdf.c"
                                                             )
        (void) CopyMagickString(image->magick,"AI",4096);
    }
  CleanupPDFInfo(&pdf_info);
...
# 752 "coders/pdf.c"
  ...
  do
  {
    (void) CopyMagickString(pdf_image->filename,filename,4096);
    (void) CopyMagickString(pdf_image->magick,image->magick,4096);
    pdf_image->page=page;
    if (image_info->ping != MagickFalse)
      {
    ...
    if (next != (Image *) 
# 771 "coders/pdf.c" 3 4
                         ((void *)0)
# 771 "coders/pdf.c"
                             )
      pdf_image=next;
  } while (next != (Image *) 
# 773 "coders/pdf.c" 3 4
                            ((void *)0)
# 773 "coders/pdf.c"
                                );
  image=DestroyImage(image);
  scene=0;
  for (next=GetFirstImageInList(pdf_image); next != (Image *) 
# 776 "coders/pdf.c" 3 4
                                                             ((void *)0)
# 776 "coders/pdf.c"
                                                                 ; )
  {
...
# 807 "coders/pdf.c"
__attribute__ ((visibility ("default"))) size_t RegisterPDFImage(void)
{
  MagickInfo
    *entry;
...
# 880 "coders/pdf.c"
__attribute__ ((visibility ("default"))) void UnregisterPDFImage(void)
{
...
# 931 "coders/pdf.c" 3 4
 , "coders/pdf.c", 931, __extension__ __PRETTY_FUNCTION__); }))
# 931 "coders/pdf.c"
                                      ;
  length=0;
  for (p=source; *p != '\0'; p++)
...
# 943 "coders/pdf.c"
  ...
  if (~length >= (4096 -1))
    destination=(char *) AcquireQuantumMemory(length+4096,
      sizeof(*destination));
  if (destination == (char *) 
# 947 "coders/pdf.c" 3 4
                             ((void *)0)
# 947 "coders/pdf.c"
                                 )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 948 "coders/pdf.c" 3 4
   (*__errno_location ())
# 948 "coders/pdf.c"
   ); (void) ThrowMagickException(fatal_exception,"coders/pdf.c",__func__,(unsigned long) 948,ResourceLimitFatalError,"UnableToEscapeString", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  *destination='\0';
  q=destination;
  for (p=source; *p != '\0'; p++)
  {
...
static wchar_t *ConvertUTF8ToUTF16(const unsigned char *source,size_t *length)
{
  ...
  *length=UTF8ToUTF16(source,(wchar_t *) 
# 1049 "coders/pdf.c" 3 4
                                        ((void *)0)
# 1049 "coders/pdf.c"
                                            );
  if (*length == 0)
    {
      ...
      *length=strlen((const char *) source);
      ...
      if (utf16 == (wchar_t *) 
# 1060 "coders/pdf.c" 3 4
                              ((void *)0)
# 1060 "coders/pdf.c"
                                  )
        return((wchar_t *) 
# 1061 "coders/pdf.c" 3 4
                          ((void *)0)
# 1061 "coders/pdf.c"
                              );
  ...
  utf16=(wchar_t *) AcquireQuantumMemory(*length+1,sizeof(*utf16));
  if (utf16 == (wchar_t *) 
# 1067 "coders/pdf.c" 3 4
                          ((void *)0)
# 1067 "coders/pdf.c"
                              )
    return((wchar_t *) 
# 1068 "coders/pdf.c" 3 4
                      ((void *)0)
# 1068 "coders/pdf.c"
                          );
  ...
  Image *image,Image *inject_image,ExceptionInfo *exception)
{
  ...
  if (group4_image == (Image *) 
# 1092 "coders/pdf.c" 3 4
                               ((void *)0)
# 1092 "coders/pdf.c"
                                   )
    return(MagickFalse);
  ...
  (void) CopyMagickString(write_info->filename,"GROUP4:",4096);
  (void) CopyMagickString(write_info->magick,"GROUP4",4096);
  (void) SetImageArtifact(group4_image,"tiff:photometric","min-is-white");
  group4=(unsigned char *) ImageToBlob(write_info,group4_image,&length,
    exception);
  group4_image=DestroyImage(group4_image);
  write_info=DestroyImageInfo(write_info);
  if (group4 == (unsigned char *) 
# 1103 "coders/pdf.c" 3 4
                                 ((void *)0)
# 1103 "coders/pdf.c"
                                     )
    return(MagickFalse);
...
# 1129 "coders/pdf.c"
 "image_info != (const ImageInfo *) NULL"
# 1129 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1129, __extension__ __PRETTY_FUNCTION__); }))
# 1129 "coders/pdf.c"
                                               ;
  
# 1130 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 1130 "coders/pdf.c"
 image_info->signature == 0xabacadabUL
# 1130 "coders/pdf.c" 3 4
...
# 1130 "coders/pdf.c"
 "image_info->signature == MagickCoreSignature"
# 1130 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1130, __extension__ __PRETTY_FUNCTION__); }))
# 1130 "coders/pdf.c"
                                                     ;
  
# 1131 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 1131 "coders/pdf.c"
 image != (Image *) 
# 1131 "coders/pdf.c" 3 4
...
# 1131 "coders/pdf.c"
 "image != (Image *) NULL"
# 1131 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1131, __extension__ __PRETTY_FUNCTION__); }))
# 1131 "coders/pdf.c"
                                ;
  
# 1132 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 1132 "coders/pdf.c"
...
# 1132 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1132, __extension__ __PRETTY_FUNCTION__); }))
# 1132 "coders/pdf.c"
                                                ;
  
# 1133 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 1133 "coders/pdf.c"
 exception != (ExceptionInfo *) 
# 1133 "coders/pdf.c" 3 4
...
# 1133 "coders/pdf.c"
 "exception != (ExceptionInfo *) NULL"
# 1133 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1133, __extension__ __PRETTY_FUNCTION__); }))
# 1133 "coders/pdf.c"
                                            ;
  
# 1134 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 1134 "coders/pdf.c"
 exception->signature == 0xabacadabUL
# 1134 "coders/pdf.c" 3 4
...
# 1134 "coders/pdf.c"
 "exception->signature == MagickCoreSignature"
# 1134 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1134, __extension__ __PRETTY_FUNCTION__); }))
# 1134 "coders/pdf.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pdf.c",__func__,(unsigned long) 1136,"%s",image->filename);
  pocket_mod=NewImageList();
  pages=NewImageList();
  i=0;
  for (next=image; next != (Image *) 
# 1140 "coders/pdf.c" 3 4
                                    ((void *)0)
# 1140 "coders/pdf.c"
                                        ; next=GetNextImageInList(next))
  {
...
# 1149 "coders/pdf.c"
    ...
    if ((i == 8) || (GetNextImageInList(next) == (Image *) 
# 1154 "coders/pdf.c" 3 4
                                                          ((void *)0)
# 1154 "coders/pdf.c"
                                                              ))
      {
...
# 1179 "coders/pdf.c"
        ...
        if (page_layout == (Image *) 
# 1188 "coders/pdf.c" 3 4
                                    ((void *)0)
# 1188 "coders/pdf.c"
                                        )
          break;
...
# 1252 "coders/pdf.c"
                                  )
    {
      ...
      epoch=(time_t) StringToDouble(option,(char **) 
# 1257 "coders/pdf.c" 3 4
                                                    ((void *)0)
# 1257 "coders/pdf.c"
                                                        );
      if (epoch > 0)
  ...
  return(GetBlobProperties(image)->
# 1261 "coders/pdf.c" 3 4
                                  st_ctim.tv_sec
# 1261 "coders/pdf.c"
                                          );
}
...
# 1379 "coders/pdf.c" 3 4
                                         ((void *)0)
# 1379 "coders/pdf.c"
                                             )
    return((const StringInfo *) 
# 1380 "coders/pdf.c" 3 4
                               ((void *)0)
# 1380 "coders/pdf.c"
                                   );
...
# 1564 "coders/pdf.c"
 "image_info != (const ImageInfo *) NULL"
# 1564 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1564, __extension__ __PRETTY_FUNCTION__); }))
# 1564 "coders/pdf.c"
                                               ;
  
# 1565 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 1565 "coders/pdf.c"
 image_info->signature == 0xabacadabUL
# 1565 "coders/pdf.c" 3 4
...
# 1565 "coders/pdf.c"
 "image_info->signature == MagickCoreSignature"
# 1565 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1565, __extension__ __PRETTY_FUNCTION__); }))
# 1565 "coders/pdf.c"
                                                     ;
  
# 1566 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 1566 "coders/pdf.c"
 image != (Image *) 
# 1566 "coders/pdf.c" 3 4
...
# 1566 "coders/pdf.c"
 "image != (Image *) NULL"
# 1566 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1566, __extension__ __PRETTY_FUNCTION__); }))
# 1566 "coders/pdf.c"
                                ;
  
# 1567 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 1567 "coders/pdf.c"
 image->signature == 0xabacadabUL
# 1567 "coders/pdf.c" 3 4
...
# 1567 "coders/pdf.c"
 "image->signature == MagickCoreSignature"
# 1567 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1567, __extension__ __PRETTY_FUNCTION__); }))
# 1567 "coders/pdf.c"
                                                ;
  
# 1568 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 1568 "coders/pdf.c"
 exception != (ExceptionInfo *) 
# 1568 "coders/pdf.c" 3 4
...
# 1568 "coders/pdf.c"
 "exception != (ExceptionInfo *) NULL"
# 1568 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1568, __extension__ __PRETTY_FUNCTION__); }))
# 1568 "coders/pdf.c"
                                            ;
  
# 1569 "coders/pdf.c" 3 4
 ((void) sizeof ((
# 1569 "coders/pdf.c"
 exception->signature == 0xabacadabUL
# 1569 "coders/pdf.c" 3 4
...
# 1569 "coders/pdf.c"
 "exception->signature == MagickCoreSignature"
# 1569 "coders/pdf.c" 3 4
 , "coders/pdf.c", 1569, __extension__ __PRETTY_FUNCTION__); }))
# 1569 "coders/pdf.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pdf.c",__func__,(unsigned long) 1571,"%s",image->filename);
  ...
  if (xref == (MagickOffsetType *) 
# 1579 "coders/pdf.c" 3 4
                                  ((void *)0)
# 1579 "coders/pdf.c"
                                      )
    { (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 1580,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1580 "coders/pdf.c" 3 4
   ((void *)0)
# 1580 "coders/pdf.c"
...
# 1610 "coders/pdf.c"
                                  )
    {
      ...
      preferred_version=StringToDouble(option,(char**) 
# 1615 "coders/pdf.c" 3 4
                                                      ((void *)0)
# 1615 "coders/pdf.c"
                                                          );
      version=(((version) > ((((1.7) < (preferred_version)) ? (1.7) : (preferred_version)))) ? (version) : ((((1.7) < (preferred_version)) ? (1.7) : (preferred_version))));
    }
  (void) FormatLocaleString(buffer,4096,"%%PDF-%.2g \n",version);
  ...
  root_id=object;
  (void) FormatLocaleString(buffer,4096,"%.20g 0 obj\n",(double)
    object);
  (void) WriteBlobString(image,buffer);
  (void) WriteBlobString(image,"<<\n");
  if (is_pdfa == MagickFalse)
    (void) FormatLocaleString(buffer,4096,"/Pages %.20g 0 R\n",
      (double) object+1);
  else
    {
      (void) FormatLocaleString(buffer,4096,"/Metadata %.20g 0 R\n",
        (double) object+1);
      (void) WriteBlobString(image,buffer);
      (void) FormatLocaleString(buffer,4096,"/Pages %.20g 0 R\n",
        (double) object+2);
...
# 1652 "coders/pdf.c"
  ...
  if (is_pdfa != MagickFalse)
    {
      ...
      i=FormatLocaleString(temp,4096,XMPProfile,XMPProfileMagick,
      ...
      (void) FormatLocaleString(buffer,4096,"/Length %.20g\n",
        (double) i);
      (void) WriteBlobString(image,buffer);
  ...
  (void) FormatLocaleString(buffer,4096,"/Kids [ %.20g 0 R ",
    (double) object+1);
  (void) WriteBlobString(image,buffer);
  count=(ssize_t) (pages_id+14 +1);
  page_count=1;
  if (image_info->adjoin != MagickFalse)
    {
      ...
      kid_image=image;
      for ( ; GetNextImageInList(kid_image) != (Image *) 
# 1727 "coders/pdf.c" 3 4
                                                        ((void *)0)
# 1727 "coders/pdf.c"
                                                            ; count+=14)
      {
        ...
        if (icc_profile != (StringInfo *) 
# 1731 "coders/pdf.c" 3 4
                                         ((void *)0)
# 1731 "coders/pdf.c"
                                             )
          count+=2;
        (void) FormatLocaleString(buffer,4096,"%.20g 0 R ",(double)
          count);
        (void) WriteBlobString(image,buffer);
      ...
      xref=(MagickOffsetType *) ResizeQuantumMemory(xref,(size_t) count+2048UL,
        sizeof(*xref));
      if (xref == (MagickOffsetType *) 
# 1740 "coders/pdf.c" 3 4
                                      ((void *)0)
# 1740 "coders/pdf.c"
                                          )
        { (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 1741,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1741 "coders/pdf.c" 3 4
       ((void *)0)
# 1741 "coders/pdf.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    }
  (void) WriteBlobString(image,"]\n");
  (void) FormatLocaleString(buffer,4096,"/Count %.20g\n",(double)
    page_count);
  (void) WriteBlobString(image,buffer);
  (void) WriteBlobString(image,">>\n");
  (void) WriteBlobString(image,"endobj\n");
  ...
  do
  {
    ...
    switch (compression)
    {
      ...
      {
        compression=RLECompression;
        (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 1777,
      ...
      {
        compression=RLECompression;
        (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 1787,
...
# 1837 "coders/pdf.c"
    ...
    (void) FormatLocaleString(temp,4096,"%.20gx%.20g",
      (double) image->columns,(double) image->rows);
    if (image_info->page != (char *) 
# 1854 "coders/pdf.c" 3 4
                                    ((void *)0)
# 1854 "coders/pdf.c"
                                        )
      (void) CopyMagickString(temp,image_info->page,4096);
    else
      if ((image->page.width != 0) && (image->page.height != 0))
        (void) FormatLocaleString(temp,4096,
          "%.20gx%.20g%+.20g%+.20g",(double) image->page.width,(double)
          image->page.height,(double) image->page.x,(double) image->page.y);
      else
        if ((image->gravity != UndefinedGravity) &&
            (LocaleCompare(image_info->magick,"PDF") == 0))
          (void) CopyMagickString(temp,"612x792",
            4096);
    (void) ConcatenateMagickString(temp,">",4096);
...
# 1886 "coders/pdf.c"
    ...
    (void) FormatLocaleString(buffer,4096,"/Parent %.20g 0 R\n",
      (double) pages_id);
    (void) WriteBlobString(image,buffer);
    (void) WriteBlobString(image,"/Resources <<\n");
    labels=(char **) 
# 1902 "coders/pdf.c" 3 4
                    ((void *)0)
# 1902 "coders/pdf.c"
                        ;
    value=GetImageProperty(image,"label",exception);
    if (value != (const char *) 
# 1904 "coders/pdf.c" 3 4
                               ((void *)0)
# 1904 "coders/pdf.c"
                                   )
      labels=StringToList(value);
    if (labels != (char **) 
# 1906 "coders/pdf.c" 3 4
                           ((void *)0)
# 1906 "coders/pdf.c"
                               )
      {
    ...
    (void) FormatLocaleString(buffer,4096,
      ...
      object+5);
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,"/ProcSet %.20g 0 R >>\n",
      (double) object+3);
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,
      "/MediaBox [0 0 %g %g]\n",72.0*media_info.width*
      (double) PerceptibleReciprocal(resolution.x),(double) (
      72.0*media_info.height*PerceptibleReciprocal(resolution.y)));
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,
      "/CropBox [0 0 %g %g]\n",72.0*media_info.width*(double)
      PerceptibleReciprocal(resolution.x),(double) (72.0*
      media_info.height*PerceptibleReciprocal(resolution.y)));
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,"/Contents %.20g 0 R\n",
      (double) object+1);
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,"/Thumb %.20g 0 R\n",
      (double) object+(icc_profile != (StringInfo *) 
# 1934 "coders/pdf.c" 3 4
                                                    ((void *)0) 
# 1934 "coders/pdf.c"
                                                         ? 10 : 8));
    (void) WriteBlobString(image,buffer);
    ...
    (void) WriteBlobString(image,buffer);
    (void) WriteBlobString(image,"<<\n");
    (void) FormatLocaleString(buffer,4096,"/Length %.20g 0 R\n",
      (double) object+1);
    (void) WriteBlobString(image,buffer);
    (void) WriteBlobString(image,">>\n");
    ...
    if (labels != (char **) 
# 1953 "coders/pdf.c" 3 4
                           ((void *)0)
# 1953 "coders/pdf.c"
                               )
      for (i=0; labels[i] != (char *) 
# 1954 "coders/pdf.c" 3 4
                                     ((void *)0)
# 1954 "coders/pdf.c"
                                         ; i++)
      {
        (void) WriteBlobString(image,"BT\n");
        (void) FormatLocaleString(buffer,4096,"/F%.20g %g Tf\n",
          (double) image->scene,pointsize);
        (void) WriteBlobString(image,buffer);
        (void) FormatLocaleString(buffer,4096,"%.20g %.20g Td\n",
          (double) geometry.x,(double) (geometry.y+(ssize_t) geometry.height+
          i*pointsize+12));
        (void) WriteBlobString(image,buffer);
        (void) FormatLocaleString(buffer,4096,"(%s) Tj\n",
           labels[i]);
        (void) WriteBlobString(image,buffer);
    ...
    (void) FormatLocaleString(buffer,4096,
      ...
      (double) geometry.y);
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,"/Im%.20g Do\n",(double)
      image->scene);
    (void) WriteBlobString(image,buffer);
    (void) WriteBlobString(image,"Q\n");
    ...
    (void) FormatLocaleString(buffer,4096,"%.20g 0 obj\n",(double)
      object);
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,"%.20g\n",(double)
      offset);
    (void) WriteBlobString(image,buffer);
    (void) WriteBlobString(image,"endobj\n");
    ...
    if ((compression == FaxCompression) || (compression == Group4Compression))
      (void) CopyMagickString(buffer,"[ /PDF /Text /ImageB",4096);
    else
      if ((image->storage_class == DirectClass) || (image->colors > 256))
        (void) CopyMagickString(buffer,"[ /PDF /Text /ImageC",4096);
      else
        (void) CopyMagickString(buffer,"[ /PDF /Text /ImageI",4096);
    (void) WriteBlobString(image,buffer);
    (void) WriteBlobString(image," ]\n");
    (void) WriteBlobString(image,"endobj\n");
...
# 2017 "coders/pdf.c"
                               )
      {
        ...
        (void) FormatLocaleString(buffer,4096,"/Name /F%.20g\n",
          (double) image->scene);
        (void) WriteBlobString(image,buffer);
    ...
    (void) FormatLocaleString(buffer,4096,"/Name /Im%.20g\n",
      (double) image->scene);
    (void) WriteBlobString(image,buffer);
    switch (compression)
    {
      case NoCompression:
      {
        (void) FormatLocaleString(buffer,4096,"/Filter [ /%s ]\n",
          "ASCII85Decode");
        break;
      }
      case JPEGCompression:
      ...
      case Group4Compression:
      {
        (void) CopyMagickString(buffer,"/Filter [ /CCITTFaxDecode ]\n",
          4096);
        (void) WriteBlobString(image,buffer);
        (void) FormatLocaleString(buffer,4096,"/DecodeParms [ << "
    ...
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,"/Width %.20g\n",(double)
      image->columns);
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,"/Height %.20g\n",(double)
      image->rows);
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,"/ColorSpace %.20g 0 R\n",
      (double) object+2);
    (void) WriteBlobString(image,buffer);
    (void) FormatLocaleString(buffer,4096,"/BitsPerComponent %d\n",
      (compression == FaxCompression) || (compression == Group4Compression) ?
      1 : 8);
    (void) WriteBlobString(image,buffer);
    if (image->alpha_trait != UndefinedPixelTrait)
      {
        (void) FormatLocaleString(buffer,4096,"/SMask %.20g 0 R\n",
          (double) object+(icc_profile != (StringInfo *) 
# 2117 "coders/pdf.c" 3 4
                                                        ((void *)0) 
# 2117 "coders/pdf.c"
                                                             ? 9 : 7));
        (void) WriteBlobString(image,buffer);
    ...
    if ((4*number_pixels) != (MagickSizeType) ((size_t) (4*number_pixels)))
      { if (xref != (MagickOffsetType *) 
# 2128 "coders/pdf.c" 3 4
     ((void *)0)
# 2128 "coders/pdf.c"
     ) xref=(MagickOffsetType *) RelinquishMagickMemory(xref); { (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 2128,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2128 "coders/pdf.c" 3 4
     ((void *)0)
# 2128 "coders/pdf.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }; };
...
# 2178 "coders/pdf.c" 3 4
                                            ((void *)0)
# 2178 "coders/pdf.c"
                                                )
              { if (xref != (MagickOffsetType *) 
# 2179 "coders/pdf.c" 3 4
             ((void *)0)
# 2179 "coders/pdf.c"
             ) xref=(MagickOffsetType *) RelinquishMagickMemory(xref); { (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 2179,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2179 "coders/pdf.c" 3 4
             ((void *)0)
# 2179 "coders/pdf.c"
             ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }; };
...
# 2195 "coders/pdf.c" 3 4
                                              ((void *)0)
# 2195 "coders/pdf.c"
                                                  )
                {
                  status=SetImageProgress(image,"Save/Image",(MagickOffsetType)
                    y,image->rows);
                  if (status == MagickFalse)
                    break;
                }
      ...
      if ((image->storage_class == DirectClass) || (image->colors > 256) ||
        ...
        switch (compression)
        {
          ...
          default:
          {
            ...
            pixel_info=AcquireVirtualMemory(length,sizeof(*pixels));
            if (pixel_info == (MemoryInfo *) 
# 2291 "coders/pdf.c" 3 4
                                            ((void *)0)
# 2291 "coders/pdf.c"
                                                )
              { if (xref != (MagickOffsetType *) 
# 2292 "coders/pdf.c" 3 4
             ((void *)0)
# 2292 "coders/pdf.c"
             ) xref=(MagickOffsetType *) RelinquishMagickMemory(xref); { (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 2292,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2292 "coders/pdf.c" 3 4
             ((void *)0)
# 2292 "coders/pdf.c"
             ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }; };
      ...
      else
        {
          ...
          switch (compression)
          {
            ...
            default:
            {
              ...
              pixel_info=AcquireVirtualMemory(length,sizeof(*pixels));
              if (pixel_info == (MemoryInfo *) 
# 2389 "coders/pdf.c" 3 4
                                              ((void *)0)
# 2389 "coders/pdf.c"
                                                  )
                { if (xref != (MagickOffsetType *) 
# 2390 "coders/pdf.c" 3 4
               ((void *)0)
# 2390 "coders/pdf.c"
               ) xref=(MagickOffsetType *) RelinquishMagickMemory(xref); { (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 2390,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2390 "coders/pdf.c" 3 4
               ((void *)0)
# 2390 "coders/pdf.c"
               ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }; };
...
# 2399 "coders/pdf.c"
                ...
                if (image->previous == (Image *) 
# 2406 "coders/pdf.c" 3 4
                                                ((void *)0)
# 2406 "coders/pdf.c"
                                                    )
                  {
                    status=SetImageProgress(image,"Save/Image",
...
# 2449 "coders/pdf.c"
    ...
    if (icc_profile == (StringInfo *) 
# 2506 "coders/pdf.c" 3 4
                                     ((void *)0)
# 2506 "coders/pdf.c"
                                         )
      {
        if (channels != 0)
          (void) FormatLocaleString(buffer,4096,"/%s\n",device);
        else
          (void) FormatLocaleString(buffer,4096,
...
# 2569 "coders/pdf.c"
    ...
    switch (compression)
    {
      ...
      case Group4Compression:
      {
        ...
        (void) FormatLocaleString(buffer,4096,"/DecodeParms [ "
          "<< /K %s /BlackIs1 false /Columns %.20g /Rows %.20g >> ]\n",
          "0",(double) tile_image->columns,(double) tile_image->rows);
        break;
      }
      default:
      {
...
# 2713 "coders/pdf.c"
                                                )
              {
                tile_image=DestroyImage(tile_image);
                { if (xref != (MagickOffsetType *) 
# 2716 "coders/pdf.c" 3 4
               ((void *)0)
# 2716 "coders/pdf.c"
               ) xref=(MagickOffsetType *) RelinquishMagickMemory(xref); { (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 2716,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2716 "coders/pdf.c" 3 4
               ((void *)0)
# 2716 "coders/pdf.c"
               ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }; };
...
# 2822 "coders/pdf.c"
                                                )
              {
                tile_image=DestroyImage(tile_image);
                { if (xref != (MagickOffsetType *) 
# 2825 "coders/pdf.c" 3 4
               ((void *)0)
# 2825 "coders/pdf.c"
               ) xref=(MagickOffsetType *) RelinquishMagickMemory(xref); { (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 2825,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2825 "coders/pdf.c" 3 4
               ((void *)0)
# 2825 "coders/pdf.c"
               ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }; };
...
# 2915 "coders/pdf.c"
                                                  )
                {
                  tile_image=DestroyImage(tile_image);
                  { if (xref != (MagickOffsetType *) 
# 2918 "coders/pdf.c" 3 4
                 ((void *)0)
# 2918 "coders/pdf.c"
                 ) xref=(MagickOffsetType *) RelinquishMagickMemory(xref); { (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 2918,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2918 "coders/pdf.c" 3 4
                 ((void *)0)
# 2918 "coders/pdf.c"
                 ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }; }
...
# 2967 "coders/pdf.c"
    ...
    if ((image->alpha_trait & BlendPixelTrait) == 0)
    ...
    else
      {
        (void) WriteBlobString(image,"/Type /XObject\n");
        (void) WriteBlobString(image,"/Subtype /Image\n");
        (void) FormatLocaleString(buffer,4096,"/Name /Ma%.20g\n",
          (double) image->scene);
        (void) WriteBlobString(image,buffer);
        switch (compression)
        {
...
# 3131 "coders/pdf.c"
                                                )
              {
                image=DestroyImage(image);
                { if (xref != (MagickOffsetType *) 
# 3134 "coders/pdf.c" 3 4
               ((void *)0)
# 3134 "coders/pdf.c"
               ) xref=(MagickOffsetType *) RelinquishMagickMemory(xref); { (void) ThrowMagickException(exception,"coders/pdf.c",__func__,(unsigned long) 3134,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 3134 "coders/pdf.c" 3 4
               ((void *)0)
# 3134 "coders/pdf.c"
               ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); }; };
...
# 3206 "coders/pdf.c"
  ...
  (void) FormatLocaleString(temp,4096,"D:%04d%02d%02d%02d%02d%02d",
    utc_time.tm_year+1900,utc_time.tm_mon+1,utc_time.tm_mday,
    utc_time.tm_hour,utc_time.tm_min,utc_time.tm_sec);
  (void) FormatLocaleString(buffer,4096,"/CreationDate (%s)\n",
    temp);
  (void) WriteBlobString(image,buffer);
  ...
  (void) FormatLocaleString(temp,4096,"D:%04d%02d%02d%02d%02d%02d",
    utc_time.tm_year+1900,utc_time.tm_mon+1,utc_time.tm_mday,
    utc_time.tm_hour,utc_time.tm_min,utc_time.tm_sec);
  (void) FormatLocaleString(buffer,4096,"/ModDate (%s)\n",temp);
  (void) WriteBlobString(image,buffer);
  (void) WriteBlobString(image,">>\n");
  (void) WriteBlobString(image,"endobj\n");
  ...
  (void) FormatLocaleString(buffer,4096,"0 %.20g\n",(double)
    object+1);
  (void) WriteBlobString(image,buffer);
  (void) WriteBlobString(image,"0000000000 65535 f \n");
  for (i=0; i < (ssize_t) object; i++)
  {
    (void) FormatLocaleString(buffer,4096,"%010lu 00000 n \n",
      (unsigned long) xref[i]);
    (void) WriteBlobString(image,buffer);
  }
  (void) WriteBlobString(image,"trailer\n");
  (void) WriteBlobString(image,"<<\n");
  (void) FormatLocaleString(buffer,4096,"/Size %.20g\n",(double)
    object+1);
  (void) WriteBlobString(image,buffer);
  (void) FormatLocaleString(buffer,4096,"/Info %.20g 0 R\n",(double)
    info_id);
  (void) WriteBlobString(image,buffer);
  (void) FormatLocaleString(buffer,4096,"/Root %.20g 0 R\n",(double)
    root_id);
  (void) WriteBlobString(image,buffer);
  (void) SignatureImage(image,exception);
  (void) FormatLocaleString(buffer,4096,"/ID [<%s> <%s>]\n",
