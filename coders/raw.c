...
# 131 "coders/raw.c" 3 4
 , "coders/raw.c", 131, __extension__ __PRETTY_FUNCTION__); }))
# 131 "coders/raw.c"
                                               ;
  
# 132 "coders/raw.c" 3 4
 ((void) sizeof ((
# 132 "coders/raw.c"
...
# 132 "coders/raw.c" 3 4
 , "coders/raw.c", 132, __extension__ __PRETTY_FUNCTION__); }))
# 132 "coders/raw.c"
                                                     ;
  
# 133 "coders/raw.c" 3 4
 ((void) sizeof ((
# 133 "coders/raw.c"
...
# 133 "coders/raw.c" 3 4
 , "coders/raw.c", 133, __extension__ __PRETTY_FUNCTION__); }))
# 133 "coders/raw.c"
                                            ;
  
# 134 "coders/raw.c" 3 4
 ((void) sizeof ((
# 134 "coders/raw.c"
...
# 134 "coders/raw.c" 3 4
 , "coders/raw.c", 134, __extension__ __PRETTY_FUNCTION__); }))
# 134 "coders/raw.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/raw.c",__func__,(unsigned long) 136,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/raw.c",__func__,(unsigned long) 140,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 140 "coders/raw.c" 3 4
   ((void *)0)
# 140 "coders/raw.c"
...
# 151 "coders/raw.c" 3 4
   (*__errno_location ())
# 151 "coders/raw.c"
   ); (void) ThrowMagickException(exception,"coders/raw.c",__func__,(unsigned long) 151,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 158 "coders/raw.c" 3 4
                               ((void *)0)
# 158 "coders/raw.c"
                                   )
    { (void) ThrowMagickException(exception,"coders/raw.c",__func__,(unsigned long) 159,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 159 "coders/raw.c" 3 4
   ((void *)0)
# 159 "coders/raw.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 159 "coders/raw.c" 3 4
...
# 164 "coders/raw.c" 3 4
                                     ((void *)0)
# 164 "coders/raw.c"
                                         )
    {
      canvas_image=DestroyImage(canvas_image);
      { (void) ThrowMagickException(exception,"coders/raw.c",__func__,(unsigned long) 167,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 167 "coders/raw.c" 3 4
     ((void *)0)
# 167 "coders/raw.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 167 "coders/raw.c" 3 4
      ...
      if (count != (ssize_t) length)
        {
          status=MagickFalse;
          { char *file_message; file_message=GetExceptionMessage(
# 222 "coders/raw.c" 3 4
         (*__errno_location ())
# 222 "coders/raw.c"
         ); (void) ThrowMagickException(exception,"coders/raw.c",__func__,(unsigned long) 222,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                            ;
          break;
        }
      q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,exception);
      if (q == (Quantum *) 
# 227 "coders/raw.c" 3 4
                          ((void *)0)
# 227 "coders/raw.c"
                              )
        break;
      length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 229 "coders/raw.c" 3 4
                                                           ((void *)0)
# 229 "coders/raw.c"
                                                               ,quantum_info,
...
# 321 "coders/raw.c"
__attribute__ ((visibility ("default"))) size_t RegisterRAWImage(void)
{
  MagickInfo
    *entry;
...
# 411 "coders/raw.c"
__attribute__ ((visibility ("default"))) void UnregisterRAWImage(void)
{
...
# 483 "coders/raw.c"
 "image_info != (const ImageInfo *) NULL"
# 483 "coders/raw.c" 3 4
 , "coders/raw.c", 483, __extension__ __PRETTY_FUNCTION__); }))
# 483 "coders/raw.c"
                                               ;
  
# 484 "coders/raw.c" 3 4
 ((void) sizeof ((
# 484 "coders/raw.c"
 image_info->signature == 0xabacadabUL
# 484 "coders/raw.c" 3 4
...
# 484 "coders/raw.c"
 "image_info->signature == MagickCoreSignature"
# 484 "coders/raw.c" 3 4
 , "coders/raw.c", 484, __extension__ __PRETTY_FUNCTION__); }))
# 484 "coders/raw.c"
                                                     ;
  
# 485 "coders/raw.c" 3 4
 ((void) sizeof ((
# 485 "coders/raw.c"
 image != (Image *) 
# 485 "coders/raw.c" 3 4
...
# 485 "coders/raw.c"
 "image != (Image *) NULL"
# 485 "coders/raw.c" 3 4
 , "coders/raw.c", 485, __extension__ __PRETTY_FUNCTION__); }))
# 485 "coders/raw.c"
                                ;
  
# 486 "coders/raw.c" 3 4
 ((void) sizeof ((
# 486 "coders/raw.c"
...
# 486 "coders/raw.c" 3 4
 , "coders/raw.c", 486, __extension__ __PRETTY_FUNCTION__); }))
# 486 "coders/raw.c"
                                                ;
  
# 487 "coders/raw.c" 3 4
 ((void) sizeof ((
# 487 "coders/raw.c"
 exception != (ExceptionInfo *) 
# 487 "coders/raw.c" 3 4
...
# 487 "coders/raw.c"
 "exception != (ExceptionInfo *) NULL"
# 487 "coders/raw.c" 3 4
 , "coders/raw.c", 487, __extension__ __PRETTY_FUNCTION__); }))
# 487 "coders/raw.c"
                                            ;
  
# 488 "coders/raw.c" 3 4
 ((void) sizeof ((
# 488 "coders/raw.c"
 exception->signature == 0xabacadabUL
# 488 "coders/raw.c" 3 4
...
# 488 "coders/raw.c"
 "exception->signature == MagickCoreSignature"
# 488 "coders/raw.c" 3 4
 , "coders/raw.c", 488, __extension__ __PRETTY_FUNCTION__); }))
# 488 "coders/raw.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/raw.c",__func__,(unsigned long) 490,"%s",image->filename);
  ...
  switch (*image->magick)
  {
    ...
    case 'c':
    {
      ...
      if (image->colorspace == CMYKColorspace)
        break;
      { (void) ThrowMagickException(exception,"coders/raw.c",__func__,(unsigned long) 514,ImageError,"ColorSeparatedImageRequired", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 514 "coders/raw.c" 3 4
     ((void *)0)
# 514 "coders/raw.c"
    ...
    case 'k':
    {
      ...
      if (image->colorspace == CMYKColorspace)
        break;
      { (void) ThrowMagickException(exception,"coders/raw.c",__func__,(unsigned long) 534,ImageError,"ColorSeparatedImageRequired", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 534 "coders/raw.c" 3 4
     ((void *)0)
# 534 "coders/raw.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    }
    ...
    case 'm':
    {
      ...
      if (image->colorspace == CMYKColorspace)
        break;
      { (void) ThrowMagickException(exception,"coders/raw.c",__func__,(unsigned long) 542,ImageError,"ColorSeparatedImageRequired", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 542 "coders/raw.c" 3 4
     ((void *)0)
# 542 "coders/raw.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    }
    ...
    case 'y':
    {
      ...
      if (image->colorspace == CMYKColorspace)
        break;
      { (void) ThrowMagickException(exception,"coders/raw.c",__func__,(unsigned long) 562,ImageError,"ColorSeparatedImageRequired", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 562 "coders/raw.c" 3 4
     ((void *)0)
# 562 "coders/raw.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    }
  ...
  do
  {
    ...
    if (quantum_info == (QuantumInfo *) 
# 578 "coders/raw.c" 3 4
                                       ((void *)0)
# 578 "coders/raw.c"
                                           )
      { (void) ThrowMagickException(exception,"coders/raw.c",__func__,(unsigned long) 579,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 579 "coders/raw.c" 3 4
     ((void *)0)
# 579 "coders/raw.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
