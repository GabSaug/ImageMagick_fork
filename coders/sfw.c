...
static void TranslateSFWMarker(unsigned char *marker)
{
  switch (marker[1])
  {
    case 0xc8: marker[1]=0xd8; break;
    case 0xd0: marker[1]=0xe0; break;
    case 0xcb: marker[1]=0xdb; break;
    case 0xa0: marker[1]=0xc0; break;
    case 0xa4: marker[1]=0xc4; break;
    case 0xca: marker[1]=0xda; break;
    case 0xc9: marker[1]=0xd9; break;
    default: break;
  }
}
...
# 236 "coders/sfw.c" 3 4
 , "coders/sfw.c", 236, __extension__ __PRETTY_FUNCTION__); }))
# 236 "coders/sfw.c"
                                               ;
  
# 237 "coders/sfw.c" 3 4
 ((void) sizeof ((
# 237 "coders/sfw.c"
...
# 237 "coders/sfw.c" 3 4
 , "coders/sfw.c", 237, __extension__ __PRETTY_FUNCTION__); }))
# 237 "coders/sfw.c"
                                                     ;
  
# 238 "coders/sfw.c" 3 4
 ((void) sizeof ((
# 238 "coders/sfw.c"
...
# 238 "coders/sfw.c" 3 4
 , "coders/sfw.c", 238, __extension__ __PRETTY_FUNCTION__); }))
# 238 "coders/sfw.c"
                                            ;
  
# 239 "coders/sfw.c" 3 4
 ((void) sizeof ((
# 239 "coders/sfw.c"
...
# 239 "coders/sfw.c" 3 4
 , "coders/sfw.c", 239, __extension__ __PRETTY_FUNCTION__); }))
# 239 "coders/sfw.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/sfw.c",__func__,(unsigned long) 241,"%s",
      image_info->filename);
...
# 248 "coders/sfw.c"
  ...
  if (GetBlobSize(image) != (size_t) GetBlobSize(image))
    { (void) ThrowMagickException(exception,"coders/sfw.c",__func__,(unsigned long) 254,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 254 "coders/sfw.c" 3 4
   ((void *)0)
# 254 "coders/sfw.c"
...
# 254 "coders/sfw.c"
  ...
  if (GetBlobSize(image) < 141)
    { (void) ThrowMagickException(exception,"coders/sfw.c",__func__,(unsigned long) 256,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 256 "coders/sfw.c" 3 4
   ((void *)0)
# 256 "coders/sfw.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 256 "coders/sfw.c" 3 4
...
# 259 "coders/sfw.c" 3 4
                                 ((void *)0)
# 259 "coders/sfw.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/sfw.c",__func__,(unsigned long) 260,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 260 "coders/sfw.c" 3 4
   ((void *)0)
# 260 "coders/sfw.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 260 "coders/sfw.c" 3 4
...
# 260 "coders/sfw.c"
  ...
  if ((count != (ssize_t) GetBlobSize(image)) ||
      (LocaleNCompare((char *) buffer,"SFW",3) != 0))
    {
      ...
      { (void) ThrowMagickException(exception,"coders/sfw.c",__func__,(unsigned long) 266,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 266 "coders/sfw.c" 3 4
     ((void *)0)
# 266 "coders/sfw.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 266 "coders/sfw.c" 3 4
...
# 274 "coders/sfw.c"
    ...
    {
      buffer=(unsigned char *) RelinquishMagickMemory(buffer);
      { (void) ThrowMagickException(exception,"coders/sfw.c",__func__,(unsigned long) 278,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 278 "coders/sfw.c" 3 4
     ((void *)0)
# 278 "coders/sfw.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 278 "coders/sfw.c" 3 4
...
# 278 "coders/sfw.c"
  ...
  (void) memcpy(header+6,"JFIF\0\001\0",7);
  ...
  for ( ; ; )
  {
    if ((offset+4) > (buffer+count-1))
      {
        buffer=(unsigned char *) RelinquishMagickMemory(buffer);
        { (void) ThrowMagickException(exception,"coders/sfw.c",__func__,(unsigned long) 293,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 293 "coders/sfw.c" 3 4
       ((void *)0)
# 293 "coders/sfw.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 293 "coders/sfw.c" 3 4
...
# 302 "coders/sfw.c" 3 4
                               ((void *)0)
# 302 "coders/sfw.c"
                                   )
    {
      buffer=(unsigned char *) RelinquishMagickMemory(buffer);
      { (void) ThrowMagickException(exception,"coders/sfw.c",__func__,(unsigned long) 305,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 305 "coders/sfw.c" 3 4
     ((void *)0)
# 305 "coders/sfw.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 305 "coders/sfw.c" 3 4
...
# 312 "coders/sfw.c" 3 4
                                     ((void *)0)
# 312 "coders/sfw.c"
                                         ,0);
  file=(FILE *) 
# 313 "coders/sfw.c" 3 4
               ((void *)0)
# 313 "coders/sfw.c"
                   ;
...
# 323 "coders/sfw.c" 3 4
     (*__errno_location ())
# 323 "coders/sfw.c"
     ); (void) ThrowMagickException(exception,"coders/sfw.c",__func__,(unsigned long) 323,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                        ;
      image=DestroyImageList(image);
      return((Image *) 
# 326 "coders/sfw.c" 3 4
                      ((void *)0)
# 326 "coders/sfw.c"
                          );
    }
...
# 343 "coders/sfw.c" 3 4
                                 (*__errno_location ())
# 343 "coders/sfw.c"
                                      );
      (void) ThrowMagickException(exception,"coders/sfw.c",__func__,(unsigned long) 344,FileOpenError,
        "UnableToWriteFile","`%s': %s",image->filename,message);
      message=DestroyString(message);
      image=DestroyImageList(image);
      return((Image *) 
# 348 "coders/sfw.c" 3 4
                      ((void *)0)
# 348 "coders/sfw.c"
                          );
    }
...
# 357 "coders/sfw.c"
  ...
  (void) CopyMagickString(jpeg_image->filename,image->filename,
    4096);
  (void) CopyMagickString(jpeg_image->magick,image->magick,4096);
  image=DestroyImageList(image);
  image=jpeg_image;
...
# 403 "coders/sfw.c"
__attribute__ ((visibility ("default"))) size_t RegisterSFWImage(void)
{
  MagickInfo
    *entry;
...
# 436 "coders/sfw.c"
__attribute__ ((visibility ("default"))) void UnregisterSFWImage(void)
{
