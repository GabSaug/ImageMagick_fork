...
# 254 "coders/viff.c" 3 4
 , "coders/viff.c", 254, __extension__ __PRETTY_FUNCTION__); }))
# 254 "coders/viff.c"
                                               ;
  
# 255 "coders/viff.c" 3 4
 ((void) sizeof ((
# 255 "coders/viff.c"
...
# 255 "coders/viff.c" 3 4
 , "coders/viff.c", 255, __extension__ __PRETTY_FUNCTION__); }))
# 255 "coders/viff.c"
                                                     ;
  
# 256 "coders/viff.c" 3 4
 ((void) sizeof ((
# 256 "coders/viff.c"
...
# 256 "coders/viff.c" 3 4
 , "coders/viff.c", 256, __extension__ __PRETTY_FUNCTION__); }))
# 256 "coders/viff.c"
                                            ;
  
# 257 "coders/viff.c" 3 4
 ((void) sizeof ((
# 257 "coders/viff.c"
...
# 257 "coders/viff.c" 3 4
 , "coders/viff.c", 257, __extension__ __PRETTY_FUNCTION__); }))
# 257 "coders/viff.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/viff.c",__func__,(unsigned long) 259,"%s",
      image_info->filename);
...
# 266 "coders/viff.c"
  ...
  do
  {
    ...
    if ((count != 1) || ((unsigned char) viff_info.identifier != 0xab))
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 278,CorruptImageError,"NotAVIFFImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 278 "coders/viff.c" 3 4
     ((void *)0)
# 278 "coders/viff.c"
...
# 278 "coders/viff.c"
    ...
    if (count != 512)
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 290,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 290 "coders/viff.c" 3 4
     ((void *)0)
# 290 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 290 "coders/viff.c" 3 4
...
# 290 "coders/viff.c"
    ...
    if ((viff_info.machine_dependency == 0x4) ||
        (viff_info.machine_dependency == 0x8))
    ...
    if (EOFBlob(image) != MagickFalse)
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 323,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 323 "coders/viff.c" 3 4
     ((void *)0)
# 323 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 323 "coders/viff.c" 3 4
...
# 323 "coders/viff.c"
    ...
    if (number_pixels > 8*GetBlobSize(image))
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 326,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 326 "coders/viff.c" 3 4
     ((void *)0)
# 326 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 326 "coders/viff.c" 3 4
...
# 326 "coders/viff.c"
    ...
    if (number_pixels != (size_t) number_pixels)
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 328,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 328 "coders/viff.c" 3 4
     ((void *)0)
# 328 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 328 "coders/viff.c" 3 4
...
# 328 "coders/viff.c"
    ...
    if (number_pixels == 0)
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 330,CoderError,"ImageColumnOrRowSizeIsNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 330 "coders/viff.c" 3 4
     ((void *)0)
# 330 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 330 "coders/viff.c" 3 4
...
# 330 "coders/viff.c"
    ...
    if ((viff_info.number_data_bands < 1) || (viff_info.number_data_bands > 4))
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 345,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 345 "coders/viff.c" 3 4
     ((void *)0)
# 345 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 345 "coders/viff.c" 3 4
...
# 345 "coders/viff.c"
    ...
    if ((viff_info.data_storage_type != 0) &&
        (viff_info.data_storage_type != 1) &&
        (viff_info.data_storage_type != 2) &&
        (viff_info.data_storage_type != 4) &&
        (viff_info.data_storage_type != 5) &&
        (viff_info.data_storage_type != 9))
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 352,CoderError,"DataStorageTypeIsNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 352 "coders/viff.c" 3 4
     ((void *)0)
# 352 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 352 "coders/viff.c" 3 4
...
# 352 "coders/viff.c"
    ...
    if (viff_info.data_encode_scheme != 0)
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 354,CoderError,"DataEncodingSchemeIsNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 354 "coders/viff.c" 3 4
     ((void *)0)
# 354 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 354 "coders/viff.c" 3 4
...
# 354 "coders/viff.c"
    ...
    if ((viff_info.map_storage_type != 0) &&
        (viff_info.map_storage_type != 1) &&
        (viff_info.map_storage_type != 2) &&
        (viff_info.map_storage_type != 4) &&
        (viff_info.map_storage_type != 5) &&
        (viff_info.map_storage_type != 7))
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 361,CoderError,"MapStorageTypeIsNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 361 "coders/viff.c" 3 4
     ((void *)0)
# 361 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 361 "coders/viff.c" 3 4
...
# 361 "coders/viff.c"
    ...
    if ((viff_info.color_space_model != 0) &&
        (viff_info.color_space_model != 1) &&
        (viff_info.color_space_model != 15))
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 365,CoderError,"ColorspaceModelIsNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 365 "coders/viff.c" 3 4
     ((void *)0)
# 365 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 365 "coders/viff.c" 3 4
...
# 365 "coders/viff.c"
    ...
    if (viff_info.location_type != 1)
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 367,CoderError,"LocationTypeIsNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 367 "coders/viff.c" 3 4
     ((void *)0)
# 367 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 367 "coders/viff.c" 3 4
...
# 367 "coders/viff.c"
    ...
    if (viff_info.number_of_images != 1)
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 369,CoderError,"NumberOfImagesIsNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 369 "coders/viff.c" 3 4
     ((void *)0)
# 369 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 369 "coders/viff.c" 3 4
        ...
        if (viff_info.number_data_bands < 3)
          {
            ...
            if (viff_info.data_storage_type == 0)
              ...
              if (viff_info.data_storage_type == 1)
                image->colors=256UL;
              else
                image->colors=image->depth <= 8 ? 256UL : 65536UL;
            status=AcquireImageColormap(image,image->colors,exception);
            if (status == MagickFalse)
              { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 390,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 390 "coders/viff.c" 3 4
             ((void *)0)
# 390 "coders/viff.c"
             ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 390 "coders/viff.c" 3 4
...
# 390 "coders/viff.c"
      ...
      case 3:
      {
        ...
        switch ((int) viff_info.map_storage_type)
        {
          ...
          case 2: bytes_per_pixel=2; break;
          case 4: bytes_per_pixel=4; break;
          case 5: bytes_per_pixel=4; break;
          case 7: bytes_per_pixel=8; break;
          default: bytes_per_pixel=1; break;
        }
        image->colors=viff_info.map_columns;
        count=(ssize_t) (bytes_per_pixel*image->colors*viff_info.map_rows);
        if ((MagickSizeType) count > GetBlobSize(image))
          { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 415,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 415 "coders/viff.c" 3 4
         ((void *)0)
# 415 "coders/viff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 415 "coders/viff.c" 3 4
...
# 415 "coders/viff.c"
        ...
        if ((MagickSizeType) viff_info.map_rows >
          ...
          { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 418,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 418 "coders/viff.c" 3 4
         ((void *)0)
# 418 "coders/viff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 418 "coders/viff.c" 3 4
...
# 418 "coders/viff.c"
        ...
        if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
          { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 420,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 420 "coders/viff.c" 3 4
         ((void *)0)
# 420 "coders/viff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 420 "coders/viff.c" 3 4
...
# 420 "coders/viff.c"
        ...
        viff_colormap=(unsigned char *) AcquireQuantumMemory(image->colors,
          viff_info.map_rows*bytes_per_pixel*sizeof(*viff_colormap));
        if (viff_colormap == (unsigned char *) 
# 423 "coders/viff.c" 3 4
                                              ((void *)0)
# 423 "coders/viff.c"
                                                  )
          { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 424,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 424 "coders/viff.c" 3 4
         ((void *)0)
# 424 "coders/viff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 424 "coders/viff.c" 3 4
        ...
        if (ReadBlob(image,(size_t) count,viff_colormap) != count)
          {
            viff_colormap=(unsigned char *) RelinquishMagickMemory(
              viff_colormap);
            { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 432,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 432 "coders/viff.c" 3 4
           ((void *)0)
# 432 "coders/viff.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 432 "coders/viff.c" 3 4
...
# 432 "coders/viff.c"
        ...
        lsb_first=1;
        if (*(char *) &lsb_first &&
            ((viff_info.machine_dependency != 0x4) &&
             (viff_info.machine_dependency != 0x8)))
          switch ((int) viff_info.map_storage_type)
          {
            case 2:
        ...
        for (i=0; i < (ssize_t) (viff_info.map_rows*image->colors); i++)
        {
          switch ((int) viff_info.map_storage_type)
          {
            case 2: value=1.0*((short *) viff_colormap)[i]; break;
            case 4: value=1.0*((int *) viff_colormap)[i]; break;
            case 5: value=((float *) viff_colormap)[i]; break;
            case 7: value=((double *) viff_colormap)[i]; break;
      ...
      default:
        { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 488,CoderError,"ColormapTypeNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 488 "coders/viff.c" 3 4
       ((void *)0)
# 488 "coders/viff.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 488 "coders/viff.c" 3 4
    ...
    if (viff_info.data_storage_type == 0)
      {
        ...
        image->colors=2;
        if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
          { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 500,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 500 "coders/viff.c" 3 4
         ((void *)0)
# 500 "coders/viff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 500 "coders/viff.c" 3 4
...
# 500 "coders/viff.c"
    ...
    switch ((int) viff_info.data_storage_type)
    {
      ...
      case 4: bytes_per_pixel=4; break;
      case 5: bytes_per_pixel=4; break;
      case 9: bytes_per_pixel=8; break;
      default: bytes_per_pixel=1; break;
    }
    if (viff_info.data_storage_type == 0)
      {
        if (HeapOverflowSanityCheckGetSize((image->columns+7UL) >> 3UL,image->rows,&max_packets) != MagickFalse)
          { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 517,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 517 "coders/viff.c" 3 4
         ((void *)0)
# 517 "coders/viff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 517 "coders/viff.c" 3 4
...
# 517 "coders/viff.c"
    ...
    else
      {
        if (HeapOverflowSanityCheckGetSize((size_t) number_pixels,viff_info.number_data_bands,&max_packets) != MagickFalse)
          { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 522,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 522 "coders/viff.c" 3 4
         ((void *)0)
# 522 "coders/viff.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 522 "coders/viff.c" 3 4
...
# 522 "coders/viff.c"
    ...
    if ((MagickSizeType) count > GetBlobSize(image))
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 526,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 526 "coders/viff.c" 3 4
     ((void *)0)
# 526 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 526 "coders/viff.c" 3 4
...
# 526 "coders/viff.c"
    ...
    pixels=(unsigned char *) AcquireQuantumMemory((size_t) (((number_pixels) > (max_packets)) ? (number_pixels) : (max_packets))
                                ,bytes_per_pixel*sizeof(*pixels));
    if (pixels == (unsigned char *) 
# 529 "coders/viff.c" 3 4
                                   ((void *)0)
# 529 "coders/viff.c"
                                       )
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 530,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 530 "coders/viff.c" 3 4
     ((void *)0)
# 530 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 530 "coders/viff.c" 3 4
...
# 530 "coders/viff.c"
    ...
    (void) memset(pixels,0,(((number_pixels) > (max_packets)) ? (number_pixels) : (max_packets))*
      bytes_per_pixel*sizeof(*pixels));
    if (ReadBlob(image,(size_t) count,pixels) != count)
      {
        pixels=(unsigned char *) RelinquishMagickMemory(pixels);
        { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 536,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 536 "coders/viff.c" 3 4
       ((void *)0)
# 536 "coders/viff.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 536 "coders/viff.c" 3 4
...
# 536 "coders/viff.c"
    ...
    if ((viff_info.data_storage_type != 1) &&
        (viff_info.map_scheme == 0))
      {
        ...
        switch ((int) viff_info.data_storage_type)
        {
          case 2: value=1.0*((short *) pixels)[0]; break;
          case 4: value=1.0*((int *) pixels)[0]; break;
          case 5: value=((float *) pixels)[0]; break;
          case 9: value=((double *) pixels)[0]; break;
        ...
        for (i=0; i < (ssize_t) max_packets; i++)
        {
          switch ((int) viff_info.data_storage_type)
          {
            case 2: value=1.0*((short *) pixels)[i]; break;
            case 4: value=1.0*((int *) pixels)[i]; break;
            case 5: value=((float *) pixels)[i]; break;
            case 9: value=((double *) pixels)[i]; break;
        ...
        if ((min_value == 0) && (max_value == 0))
          ...
          if (min_value == max_value)
            {
              scale_factor=(double) ((Quantum) 65535.0)/min_value;
              min_value=0;
            }
          else
            scale_factor=(double) ((Quantum) 65535.0)/(max_value-min_value);
      }
...
# 636 "coders/viff.c"
          ...
          for (x=0; x < (ssize_t) (image->columns-7); x+=8)
          {
            for (bit=0; bit < 8; bit++)
            {
              ...
              SetPixelRed(image,quantum == 0 ? 0 : ((Quantum) 65535.0),q);
              SetPixelGreen(image,quantum == 0 ? 0 : ((Quantum) 65535.0),q);
              SetPixelBlue(image,quantum == 0 ? 0 : ((Quantum) 65535.0),q);
...
# 708 "coders/viff.c"
            ...
            for (x=0; x < (ssize_t) image->columns; x++)
            {
              ...
              SetPixelAlpha(image,image->alpha_trait != UndefinedPixelTrait ?
                ScaleCharToQuantum(*(p+number_pixels*3)) : ((Quantum) ((Quantum) 65535.0)),q);
              p++;
              q+=GetPixelChannels(image);
            }
            if (SyncAuthenticPixels(image,exception) == MagickFalse)
...
# 737 "coders/viff.c"
    ...
    if (EOFBlob(image) != MagickFalse)
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 750,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 750 "coders/viff.c" 3 4
     ((void *)0)
# 750 "coders/viff.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 750 "coders/viff.c" 3 4
...
# 806 "coders/viff.c"
__attribute__ ((visibility ("default"))) size_t RegisterVIFFImage(void)
{
  MagickInfo
    *entry;
...
# 844 "coders/viff.c"
__attribute__ ((visibility ("default"))) void UnregisterVIFFImage(void)
{
...
# 968 "coders/viff.c"
 "image_info != (const ImageInfo *) NULL"
# 968 "coders/viff.c" 3 4
 , "coders/viff.c", 968, __extension__ __PRETTY_FUNCTION__); }))
# 968 "coders/viff.c"
                                               ;
  
# 969 "coders/viff.c" 3 4
 ((void) sizeof ((
# 969 "coders/viff.c"
 image_info->signature == 0xabacadabUL
# 969 "coders/viff.c" 3 4
...
# 969 "coders/viff.c"
 "image_info->signature == MagickCoreSignature"
# 969 "coders/viff.c" 3 4
 , "coders/viff.c", 969, __extension__ __PRETTY_FUNCTION__); }))
# 969 "coders/viff.c"
                                                     ;
  
# 970 "coders/viff.c" 3 4
 ((void) sizeof ((
# 970 "coders/viff.c"
 image != (Image *) 
# 970 "coders/viff.c" 3 4
...
# 970 "coders/viff.c"
 "image != (Image *) NULL"
# 970 "coders/viff.c" 3 4
 , "coders/viff.c", 970, __extension__ __PRETTY_FUNCTION__); }))
# 970 "coders/viff.c"
                                ;
  
# 971 "coders/viff.c" 3 4
 ((void) sizeof ((
# 971 "coders/viff.c"
...
# 971 "coders/viff.c" 3 4
 , "coders/viff.c", 971, __extension__ __PRETTY_FUNCTION__); }))
# 971 "coders/viff.c"
                                                ;
  
# 972 "coders/viff.c" 3 4
 ((void) sizeof ((
# 972 "coders/viff.c"
 exception != (ExceptionInfo *) 
# 972 "coders/viff.c" 3 4
...
# 972 "coders/viff.c"
 "exception != (ExceptionInfo *) NULL"
# 972 "coders/viff.c" 3 4
 , "coders/viff.c", 972, __extension__ __PRETTY_FUNCTION__); }))
# 972 "coders/viff.c"
                                            ;
  
# 973 "coders/viff.c" 3 4
 ((void) sizeof ((
# 973 "coders/viff.c"
 exception->signature == 0xabacadabUL
# 973 "coders/viff.c" 3 4
...
# 973 "coders/viff.c"
 "exception->signature == MagickCoreSignature"
# 973 "coders/viff.c" 3 4
 , "coders/viff.c", 973, __extension__ __PRETTY_FUNCTION__); }))
# 973 "coders/viff.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/viff.c",__func__,(unsigned long) 975,"%s",image->filename);
  ...
  do
  {
    ...
    viff_info.release=1;
    viff_info.version=3;
    viff_info.machine_dependency=0x2;
    *viff_info.comment='\0';
    value=GetImageProperty(image,"comment",exception);
    if (value != (const char *) 
# 998 "coders/viff.c" 3 4
                               ((void *)0)
# 998 "coders/viff.c"
                                   )
      (void) CopyMagickString(viff_info.comment,value,(((strlen(value)) < (511)) ? (strlen(value)) : (511))
            +1);
    ...
    viff_info.location_type=1;
    viff_info.location_dimension=0;
    viff_info.number_of_images=1;
    viff_info.data_encode_scheme=0;
    viff_info.map_scheme=0;
    viff_info.map_storage_type=0;
...
# 1102 "coders/viff.c" 3 4
                                    ((void *)0)
# 1102 "coders/viff.c"
                                        )
      { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 1103,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1103 "coders/viff.c" 3 4
     ((void *)0)
# 1103 "coders/viff.c"
      ...
      if (is_gray == MagickFalse)
        {
          ...
          if (viff_colormap == (unsigned char *) 
# 1148 "coders/viff.c" 3 4
                                                ((void *)0)
# 1148 "coders/viff.c"
                                                    )
            { (void) ThrowMagickException(exception,"coders/viff.c",__func__,(unsigned long) 1149,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1149 "coders/viff.c" 3 4
           ((void *)0)
# 1149 "coders/viff.c"
           ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
          q=viff_colormap;
