...
# 125 "coders/json.c"
__attribute__ ((visibility ("default"))) size_t RegisterJSONImage(void)
{
  MagickInfo
    *entry;
...
# 158 "coders/json.c"
__attribute__ ((visibility ("default"))) void UnregisterJSONImage(void)
{
...
# 206 "coders/json.c" 3 4
 , "coders/json.c", 206, __extension__ __PRETTY_FUNCTION__); }))
# 206 "coders/json.c"
                                      ;
  if ((value == (char *) 
# 207 "coders/json.c" 3 4
                        ((void *)0)
# 207 "coders/json.c"
                            ) || (*value == '\0'))
    {
  ...
  escaped_json=(char *) 
# 241 "coders/json.c" 3 4
                       ((void *)0)
# 241 "coders/json.c"
                           ;
  if (~length >= (4096 -1))
    escaped_json=(char *) AcquireQuantumMemory(length+4096,
      sizeof(*escaped_json));
  if (escaped_json == (char *) 
# 245 "coders/json.c" 3 4
                              ((void *)0)
# 245 "coders/json.c"
                                  )
    {
...
# 329 "coders/json.c"
 "image != (Image *) NULL"
# 329 "coders/json.c" 3 4
 , "coders/json.c", 329, __extension__ __PRETTY_FUNCTION__); }))
# 329 "coders/json.c"
                                ;
  
# 330 "coders/json.c" 3 4
 ((void) sizeof ((
# 330 "coders/json.c"
  ...
  const ChannelStatistics *channel_statistics)
{
  ...
  (void) FormatLocaleFile(file,"      \"%s\": {\n        \"intensity\": "
    "%.*g,\n",name,GetMagickPrecision(),((double) 1.0/(double) ((Quantum) 65535.0))*target);
  ...
  const ChannelStatistics *channel_statistics)
{
  ...
  n=FormatLocaleFile(file,"      \"%s\": {\n        \"min\": %.*g,\n" "        \"max\": %.*g,\n        \"mean\": %.*g,\n        \"median\": %.*g,\n        " "\"standardDeviation\": %.*g,\n        \"kurtosis\": %.*g,\n        " "\"skewness\": %.*g,\n        \"entropy\": %.*g\n      }",name,GetMagickPrecision(),
    channel_statistics[channel].minima == 1.79769313486231570E+308 ? 0.0 :
    (double) ClampToQuantum(scale*channel_statistics[channel].minima),
    GetMagickPrecision(),
    channel_statistics[channel].maxima == -1.79769313486231570E+308 ? 0.0 :
...
# 870 "coders/json.c"
                                           )
          {
            value->values=(char ***) ResizeQuantumMemory(value->values,
              ...
              sizeof(*value->values));
            if (value->values == (char ***) 
# 875 "coders/json.c" 3 4
                                           ((void *)0)
# 875 "coders/json.c"
                                               )
              break;
      ...
      for (i=0; i < (ssize_t) count; i++)
      {
        ...
        if (value->values_length == 0)
        ...
        else
          {
            ...
            {
              for (k=0; value->values[j][k] != (char *) 
# 896 "coders/json.c" 3 4
                                                       ((void *)0)
# 896 "coders/json.c"
                                                           ; k++)
              {
...
# 971 "coders/json.c"
 "image != (Image *) NULL"
# 971 "coders/json.c" 3 4
 , "coders/json.c", 971, __extension__ __PRETTY_FUNCTION__); }))
# 971 "coders/json.c"
                                ;
  
# 972 "coders/json.c" 3 4
 ((void) sizeof ((
# 972 "coders/json.c"
 image->signature == 0xabacadabUL
# 972 "coders/json.c" 3 4
...
# 972 "coders/json.c"
 "image->signature == MagickCoreSignature"
# 972 "coders/json.c" 3 4
 , "coders/json.c", 972, __extension__ __PRETTY_FUNCTION__); }))
# 972 "coders/json.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/json.c",__func__,(unsigned long) 974,"%s",image->filename);
  *format='\0';
  elapsed_time=GetElapsedTime(&image->timer);
  user_time=GetUserTime(&image->timer);
  GetTimerInfo(&image->timer);
  ping=MagickTrue;
  if (GetVirtualPixels(image,0,0,1,1,exception) != (const Quantum *) 
# 980 "coders/json.c" 3 4
                                                                    ((void *)0)
# 980 "coders/json.c"
                                                                        )
    ping=MagickFalse;
...
# 987 "coders/json.c" 3 4
                                ((void *)0)
# 987 "coders/json.c"
                                    )
    version=StringToDouble(artifact,(char **) 
# 988 "coders/json.c" 3 4
                                             ((void *)0)
# 988 "coders/json.c"
                                                 );
  if (version >= 1.0)
...
# 1014 "coders/json.c" 3 4
                                          ((void *)0)
# 1014 "coders/json.c"
                                              ) &&
      (GetMagickDescription(magick_info) != (const char *) 
# 1015 "coders/json.c" 3 4
                                                          ((void *)0)
# 1015 "coders/json.c"
                                                              ))
  ...
  if ((magick_info != (const MagickInfo *) 
# 1018 "coders/json.c" 3 4
                                          ((void *)0)
# 1018 "coders/json.c"
                                              ) &&
      (GetMagickMimeType(magick_info) != (const char *) 
# 1019 "coders/json.c" 3 4
                                                       ((void *)0)
# 1019 "coders/json.c"
                                                           ))
...
# 1060 "coders/json.c" 3 4
                              ((void *)0)
# 1060 "coders/json.c"
                                  )
    locate=GetImageArtifact(image,"json:locate");
  if (locate != (const char *) 
# 1062 "coders/json.c" 3 4
                              ((void *)0)
# 1062 "coders/json.c"
                                  )
    {
...
# 1135 "coders/json.c" 3 4
                                          ((void *)0)
# 1135 "coders/json.c"
                                              ;
  channel_moments=(ChannelMoments *) 
# 1136 "coders/json.c" 3 4
                                    ((void *)0)
# 1136 "coders/json.c"
                                        ;
  channel_phash=(ChannelPerceptualHash *) 
# 1137 "coders/json.c" 3 4
                                         ((void *)0)
# 1137 "coders/json.c"
                                             ;
  channel_features=(ChannelFeatures *) 
# 1138 "coders/json.c" 3 4
                                      ((void *)0)
# 1138 "coders/json.c"
                                          ;
  scale=1;
...
# 1141 "coders/json.c"
  ...
  if (artifact == (const char *) 
# 1144 "coders/json.c" 3 4
                                ((void *)0)
# 1144 "coders/json.c"
                                    )
    artifact=GetImageArtifact(image,"json:moments");
  if (artifact != (const char *) 
# 1146 "coders/json.c" 3 4
                                ((void *)0)
# 1146 "coders/json.c"
                                    )
    {
...
# 1154 "coders/json.c"
  ...
  scale=1;
  if (image->depth <= 16)
    scale=((Quantum) 65535.0)/((size_t) ((Quantum) 65535.0) >> ((size_t)
      16 -image->depth));
  if (channel_statistics != (ChannelStatistics *) 
# 1205 "coders/json.c" 3 4
                                                 ((void *)0)
# 1205 "coders/json.c"
                                                     )
    {
      ...
      if ((image->colorspace != LinearGRAYColorspace) &&
          (image->colorspace != GRAYColorspace))
        {
          ...
          (void) PrintChannelStatistics(file,(PixelChannel) 64,
...
# 1716 "coders/json.c" 3 4
 , "coders/json.c", 1716, __extension__ __PRETTY_FUNCTION__); }))
# 1716 "coders/json.c"
                                               ;
  
# 1717 "coders/json.c" 3 4
 ((void) sizeof ((
# 1717 "coders/json.c"
...
# 1717 "coders/json.c" 3 4
 , "coders/json.c", 1717, __extension__ __PRETTY_FUNCTION__); }))
# 1717 "coders/json.c"
                                                     ;
  
# 1718 "coders/json.c" 3 4
 ((void) sizeof ((
# 1718 "coders/json.c"
 image != (Image *) 
# 1718 "coders/json.c" 3 4
...
# 1718 "coders/json.c"
 "image != (Image *) NULL"
# 1718 "coders/json.c" 3 4
 , "coders/json.c", 1718, __extension__ __PRETTY_FUNCTION__); }))
# 1718 "coders/json.c"
                                ;
  
# 1719 "coders/json.c" 3 4
 ((void) sizeof ((
# 1719 "coders/json.c"
 image->signature == 0xabacadabUL
# 1719 "coders/json.c" 3 4
...
# 1719 "coders/json.c"
 "image->signature == MagickCoreSignature"
# 1719 "coders/json.c" 3 4
 , "coders/json.c", 1719, __extension__ __PRETTY_FUNCTION__); }))
# 1719 "coders/json.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/json.c",__func__,(unsigned long) 1721,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  file=GetBlobFileHandle(image);
  if (file == (FILE *) 
# 1726 "coders/json.c" 3 4
                      ((void *)0)
# 1726 "coders/json.c"
                          )
    file=
# 1727 "coders/json.c" 3 4
        stdout
# 1727 "coders/json.c"
              ;
  scene=0;
