...
# 1732 "coders/jpeg.c"
__attribute__ ((visibility ("default"))) size_t RegisterJPEGImage(void)
{
  ...
  *version='\0';
  ...
  entry=AcquireMagickInfo("JPEG","JPEG","Joint Photographic Experts Group JFIF format");
  ...
  entry->mime_type=ConstantString("image/jpeg");
  (void) RegisterMagickInfo(entry);
  entry=AcquireMagickInfo("JPEG","JPG","Joint Photographic Experts Group JFIF format");
  ...
  entry->mime_type=ConstantString("image/jpeg");
  (void) RegisterMagickInfo(entry);
  entry=AcquireMagickInfo("JPEG","JPS","Joint Photographic Experts Group JFIF format");
  ...
  entry->mime_type=ConstantString("image/jpeg");
  (void) RegisterMagickInfo(entry);
  entry=AcquireMagickInfo("JPEG","MPO","Joint Photographic Experts Group JFIF format");
  ...
  entry->mime_type=ConstantString("image/jpeg");
  (void) RegisterMagickInfo(entry);
  entry=AcquireMagickInfo("JPEG","PJPEG","Joint Photographic Experts Group JFIF format");
...
# 1863 "coders/jpeg.c"
__attribute__ ((visibility ("default"))) void UnregisterJPEGImage(void)
{
