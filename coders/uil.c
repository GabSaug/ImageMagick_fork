...
# 94 "coders/uil.c"
__attribute__ ((visibility ("default"))) size_t RegisterUILImage(void)
{
  MagickInfo
    *entry;
...
# 125 "coders/uil.c"
__attribute__ ((visibility ("default"))) void UnregisterUILImage(void)
{
...
# 204 "coders/uil.c" 3 4
 , "coders/uil.c", 204, __extension__ __PRETTY_FUNCTION__); }))
# 204 "coders/uil.c"
                                               ;
  
# 205 "coders/uil.c" 3 4
 ((void) sizeof ((
# 205 "coders/uil.c"
...
# 205 "coders/uil.c" 3 4
 , "coders/uil.c", 205, __extension__ __PRETTY_FUNCTION__); }))
# 205 "coders/uil.c"
                                                     ;
  
# 206 "coders/uil.c" 3 4
 ((void) sizeof ((
# 206 "coders/uil.c"
 image != (Image *) 
# 206 "coders/uil.c" 3 4
...
# 206 "coders/uil.c"
 "image != (Image *) NULL"
# 206 "coders/uil.c" 3 4
 , "coders/uil.c", 206, __extension__ __PRETTY_FUNCTION__); }))
# 206 "coders/uil.c"
                                ;
  
# 207 "coders/uil.c" 3 4
 ((void) sizeof ((
# 207 "coders/uil.c"
...
# 207 "coders/uil.c" 3 4
 , "coders/uil.c", 207, __extension__ __PRETTY_FUNCTION__); }))
# 207 "coders/uil.c"
                                                ;
  
# 208 "coders/uil.c" 3 4
 ((void) sizeof ((
# 208 "coders/uil.c"
...
# 208 "coders/uil.c" 3 4
 , "coders/uil.c", 208, __extension__ __PRETTY_FUNCTION__); }))
# 208 "coders/uil.c"
                                            ;
  
# 209 "coders/uil.c" 3 4
 ((void) sizeof ((
# 209 "coders/uil.c"
...
# 209 "coders/uil.c" 3 4
 , "coders/uil.c", 209, __extension__ __PRETTY_FUNCTION__); }))
# 209 "coders/uil.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/uil.c",__func__,(unsigned long) 211,"%s",image->filename);
      ...
      if (image->alpha_trait != UndefinedPixelTrait)
        {
          ...
          if (number_pixels != ((MagickSizeType) (size_t) number_pixels))
            { (void) ThrowMagickException(exception,"coders/uil.c",__func__,(unsigned long) 238,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 238 "coders/uil.c" 3 4
           ((void *)0)
# 238 "coders/uil.c"
          ...
          if (matte_image == (unsigned char *) 
# 241 "coders/uil.c" 3 4
                                              ((void *)0)
# 241 "coders/uil.c"
                                                  )
            { (void) ThrowMagickException(exception,"coders/uil.c",__func__,(unsigned long) 242,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 242 "coders/uil.c" 3 4
           ((void *)0)
# 242 "coders/uil.c"
           ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  ...
  for (i=0; i < (ssize_t) colors; i++)
  {
    ...
    if (LocaleCompare(name,"None") == 0)
      ...
      (void) FormatLocaleString(buffer,4096,
        ...
        ((double) ((Quantum) 65535.0)/2.0) ? "background" : "foreground",symbol);
    (void) WriteBlobString(image,buffer);
...
# 349 "coders/uil.c"
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      for (j=1; j < (int) characters_per_pixel; j++)
      {
        k=(((int) GetPixelIndex(image,p)-k)/92) %
          92;
        symbol[j]=Cixel[k];
      }
      symbol[j]='\0';
