  ...
  const size_t length,unsigned char *pixels,size_t extent)
{
  ...
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/sun.c",__func__,(unsigned long) 157,"...");
  
# 158 "coders/sun.c" 3 4
 ((void) sizeof ((
# 158 "coders/sun.c"
...
# 158 "coders/sun.c" 3 4
 , "coders/sun.c", 158, __extension__ __PRETTY_FUNCTION__); }))
# 158 "coders/sun.c"
                                                    ;
  
# 159 "coders/sun.c" 3 4
 ((void) sizeof ((
# 159 "coders/sun.c"
...
# 159 "coders/sun.c" 3 4
 , "coders/sun.c", 159, __extension__ __PRETTY_FUNCTION__); }))
# 159 "coders/sun.c"
                                         ;
  p=compressed_pixels;
  q=pixels;
...
# 283 "coders/sun.c" 3 4
 , "coders/sun.c", 283, __extension__ __PRETTY_FUNCTION__); }))
# 283 "coders/sun.c"
                                               ;
  
# 284 "coders/sun.c" 3 4
 ((void) sizeof ((
# 284 "coders/sun.c"
...
# 284 "coders/sun.c" 3 4
 , "coders/sun.c", 284, __extension__ __PRETTY_FUNCTION__); }))
# 284 "coders/sun.c"
                                                     ;
  
# 285 "coders/sun.c" 3 4
 ((void) sizeof ((
# 285 "coders/sun.c"
...
# 285 "coders/sun.c" 3 4
 , "coders/sun.c", 285, __extension__ __PRETTY_FUNCTION__); }))
# 285 "coders/sun.c"
                                            ;
  
# 286 "coders/sun.c" 3 4
 ((void) sizeof ((
# 286 "coders/sun.c"
...
# 286 "coders/sun.c" 3 4
 , "coders/sun.c", 286, __extension__ __PRETTY_FUNCTION__); }))
# 286 "coders/sun.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/sun.c",__func__,(unsigned long) 288,"%s",
      image_info->filename);
...
# 295 "coders/sun.c"
  ...
  do
  {
    ...
    if (sun_info.magic != 0x59a66a95)
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 308,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 308 "coders/sun.c" 3 4
     ((void *)0)
# 308 "coders/sun.c"
...
# 308 "coders/sun.c"
    ...
    if (sun_info.maplength > GetBlobSize(image))
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 317,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 317 "coders/sun.c" 3 4
     ((void *)0)
# 317 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 317 "coders/sun.c" 3 4
...
# 317 "coders/sun.c"
    ...
    if ((sun_info.height != 0) && (sun_info.width != (extent/sun_info.height)))
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 320,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 320 "coders/sun.c" 3 4
     ((void *)0)
# 320 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 320 "coders/sun.c" 3 4
...
# 320 "coders/sun.c"
    ...
    if ((sun_info.type != 1) && (sun_info.type != 2) &&
        (sun_info.type != 3))
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 323,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 323 "coders/sun.c" 3 4
     ((void *)0)
# 323 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 323 "coders/sun.c" 3 4
...
# 323 "coders/sun.c"
    ...
    if ((sun_info.maptype == 0) && (sun_info.maplength != 0))
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 325,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 325 "coders/sun.c" 3 4
     ((void *)0)
# 325 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 325 "coders/sun.c" 3 4
...
# 325 "coders/sun.c"
    ...
    if ((sun_info.depth != 1) && (sun_info.depth != 8) &&
      ...
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 328,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 328 "coders/sun.c" 3 4
     ((void *)0)
# 328 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 328 "coders/sun.c" 3 4
...
# 328 "coders/sun.c"
    ...
    if ((sun_info.maptype != 0) && (sun_info.maptype != 1) &&
        (sun_info.maptype != 2))
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 331,CoderError,"ColormapTypeNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 331 "coders/sun.c" 3 4
     ((void *)0)
# 331 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 331 "coders/sun.c" 3 4
    ...
    if (sun_info.depth < 24)
      {
        ...
        one=1;
        if (sun_info.maptype == 0)
          image->colors=one << sun_info.depth;
        if (sun_info.maptype == 1)
          image->colors=sun_info.maplength/3;
        if (image->colors == 0)
          { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 348,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 348 "coders/sun.c" 3 4
         ((void *)0)
# 348 "coders/sun.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 348 "coders/sun.c" 3 4
...
# 348 "coders/sun.c"
        ...
        if (AcquireImageColormap(image,image->colors,exception) == MagickFalse)
          { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 350,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 350 "coders/sun.c" 3 4
         ((void *)0)
# 350 "coders/sun.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 350 "coders/sun.c" 3 4
    ...
    switch (sun_info.maptype)
    {
      ...
      case 1:
      {
        ...
        sun_colormap=(unsigned char *) AcquireQuantumMemory(image->colors,
          sizeof(*sun_colormap));
        if (sun_colormap == (unsigned char *) 
# 366 "coders/sun.c" 3 4
                                             ((void *)0)
# 366 "coders/sun.c"
                                                 )
          { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 367,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 367 "coders/sun.c" 3 4
         ((void *)0)
# 367 "coders/sun.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 367 "coders/sun.c" 3 4
        ...
        if (count != (ssize_t) image->colors)
          {
            ...
            { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 372,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 372 "coders/sun.c" 3 4
           ((void *)0)
# 372 "coders/sun.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 372 "coders/sun.c" 3 4
...
# 372 "coders/sun.c"
        ...
        if (count != (ssize_t) image->colors)
          {
            sun_colormap=(unsigned char *) RelinquishMagickMemory(sun_colormap);
            { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 381,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 381 "coders/sun.c" 3 4
           ((void *)0)
# 381 "coders/sun.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 381 "coders/sun.c" 3 4
...
# 381 "coders/sun.c"
        ...
        if (count != (ssize_t) image->colors)
          {
            sun_colormap=(unsigned char *) RelinquishMagickMemory(sun_colormap);
            { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 390,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 390 "coders/sun.c" 3 4
           ((void *)0)
# 390 "coders/sun.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 390 "coders/sun.c" 3 4
...
# 390 "coders/sun.c"
      ...
      case 2:
      {
        ...
        sun_colormap=(unsigned char *) AcquireQuantumMemory(sun_info.maplength,
          sizeof(*sun_colormap));
        if (sun_colormap == (unsigned char *) 
# 408 "coders/sun.c" 3 4
                                             ((void *)0)
# 408 "coders/sun.c"
                                                 )
          { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 409,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 409 "coders/sun.c" 3 4
         ((void *)0)
# 409 "coders/sun.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 409 "coders/sun.c" 3 4
...
# 409 "coders/sun.c"
        ...
        if (count != (ssize_t) sun_info.maplength)
          { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 413,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 413 "coders/sun.c" 3 4
         ((void *)0)
# 413 "coders/sun.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 413 "coders/sun.c" 3 4
...
# 413 "coders/sun.c"
      ...
      default:
        { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 417,CoderError,"ColormapTypeNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 417 "coders/sun.c" 3 4
       ((void *)0)
# 417 "coders/sun.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 417 "coders/sun.c" 3 4
...
# 417 "coders/sun.c"
    ...
    if (sun_info.length == 0)
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 432,ResourceLimitError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 432 "coders/sun.c" 3 4
     ((void *)0)
# 432 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 432 "coders/sun.c" 3 4
...
# 432 "coders/sun.c"
    ...
    if ((sun_info.type != 2) &&
      ...
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 436,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 436 "coders/sun.c" 3 4
     ((void *)0)
# 436 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 436 "coders/sun.c" 3 4
...
# 436 "coders/sun.c"
    ...
    if (HeapOverflowSanityCheckGetSize(sun_info.width,sun_info.depth,&bytes_per_line) != MagickFalse)
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 438,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 438 "coders/sun.c" 3 4
     ((void *)0)
# 438 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 438 "coders/sun.c" 3 4
...
# 438 "coders/sun.c"
    ...
    if ((sun_info.type != 2) && (sun_info.length > GetBlobSize(image)))
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 440,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 440 "coders/sun.c" 3 4
     ((void *)0)
# 440 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 440 "coders/sun.c" 3 4
...
# 440 "coders/sun.c"
    ...
    sun_data=(unsigned char *) AcquireQuantumMemory(sun_info.length,
      sizeof(*sun_data));
    if (sun_data == (unsigned char *) 
# 443 "coders/sun.c" 3 4
                                     ((void *)0)
# 443 "coders/sun.c"
                                         )
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 444,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 444 "coders/sun.c" 3 4
     ((void *)0)
# 444 "coders/sun.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 444 "coders/sun.c" 3 4
...
# 444 "coders/sun.c"
    ...
    if ((sun_info.type != 2) && (count != (ssize_t) sun_info.length))
      {
        sun_data=(unsigned char *) RelinquishMagickMemory(sun_data);
        { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 450,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 450 "coders/sun.c" 3 4
       ((void *)0)
# 450 "coders/sun.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 450 "coders/sun.c" 3 4
...
# 450 "coders/sun.c"
    ...
    if ((height == 0) || (sun_info.width == 0) || (sun_info.depth == 0) ||
      ...
      {
        sun_data=(unsigned char *) RelinquishMagickMemory(sun_data);
        { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 457,ResourceLimitError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 457 "coders/sun.c" 3 4
       ((void *)0)
# 457 "coders/sun.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 457 "coders/sun.c" 3 4
...
# 457 "coders/sun.c"
    ...
    if ((bytes_per_line >> 1) != ((size_t) sun_info.width*sun_info.depth+quantum))
      {
        sun_data=(unsigned char *) RelinquishMagickMemory(sun_data);
        { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 465,ResourceLimitError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 465 "coders/sun.c" 3 4
       ((void *)0)
# 465 "coders/sun.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 465 "coders/sun.c" 3 4
...
# 465 "coders/sun.c"
    ...
    if (HeapOverflowSanityCheckGetSize(height,bytes_per_line,&pixels_length) != MagickFalse)
      {
        sun_data=(unsigned char *) RelinquishMagickMemory(sun_data);
        { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 471,ResourceLimitError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 471 "coders/sun.c" 3 4
       ((void *)0)
# 471 "coders/sun.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 471 "coders/sun.c" 3 4
...
# 471 "coders/sun.c"
    ...
    sun_pixels=(unsigned char *) AcquireQuantumMemory(pixels_length+image->rows,
      sizeof(*sun_pixels));
    if (sun_pixels == (unsigned char *) 
# 475 "coders/sun.c" 3 4
                                       ((void *)0)
# 475 "coders/sun.c"
                                           )
      {
        sun_data=(unsigned char *) RelinquishMagickMemory(sun_data);
        { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 478,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 478 "coders/sun.c" 3 4
       ((void *)0)
# 478 "coders/sun.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 478 "coders/sun.c" 3 4
        ...
        if (status == MagickFalse)
          {
            ...
            { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 488,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 488 "coders/sun.c" 3 4
           ((void *)0)
# 488 "coders/sun.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 488 "coders/sun.c" 3 4
...
# 495 "coders/sun.c" 3 4
           (*__errno_location ())
# 495 "coders/sun.c"
           ); (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 495,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                              ;
            break;
          }
        if (sun_info.length > (pixels_length+image->rows))
          {
            sun_data=(unsigned char *) RelinquishMagickMemory(sun_data);
            sun_pixels=(unsigned char *) RelinquishMagickMemory(sun_pixels);
            { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 503,ResourceLimitError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 503 "coders/sun.c" 3 4
           ((void *)0)
# 503 "coders/sun.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 503 "coders/sun.c" 3 4
...
# 690 "coders/sun.c"
__attribute__ ((visibility ("default"))) size_t RegisterSUNImage(void)
{
  MagickInfo
    *entry;
...
# 728 "coders/sun.c"
__attribute__ ((visibility ("default"))) void UnregisterSUNImage(void)
{
...
# 809 "coders/sun.c"
 "image_info != (const ImageInfo *) NULL"
# 809 "coders/sun.c" 3 4
 , "coders/sun.c", 809, __extension__ __PRETTY_FUNCTION__); }))
# 809 "coders/sun.c"
                                               ;
  
# 810 "coders/sun.c" 3 4
 ((void) sizeof ((
# 810 "coders/sun.c"
 image_info->signature == 0xabacadabUL
# 810 "coders/sun.c" 3 4
...
# 810 "coders/sun.c"
 "image_info->signature == MagickCoreSignature"
# 810 "coders/sun.c" 3 4
 , "coders/sun.c", 810, __extension__ __PRETTY_FUNCTION__); }))
# 810 "coders/sun.c"
                                                     ;
  
# 811 "coders/sun.c" 3 4
 ((void) sizeof ((
# 811 "coders/sun.c"
 image != (Image *) 
# 811 "coders/sun.c" 3 4
...
# 811 "coders/sun.c"
 "image != (Image *) NULL"
# 811 "coders/sun.c" 3 4
 , "coders/sun.c", 811, __extension__ __PRETTY_FUNCTION__); }))
# 811 "coders/sun.c"
                                ;
  
# 812 "coders/sun.c" 3 4
 ((void) sizeof ((
# 812 "coders/sun.c"
...
# 812 "coders/sun.c" 3 4
 , "coders/sun.c", 812, __extension__ __PRETTY_FUNCTION__); }))
# 812 "coders/sun.c"
                                                ;
  
# 813 "coders/sun.c" 3 4
 ((void) sizeof ((
# 813 "coders/sun.c"
 exception != (ExceptionInfo *) 
# 813 "coders/sun.c" 3 4
...
# 813 "coders/sun.c"
 "exception != (ExceptionInfo *) NULL"
# 813 "coders/sun.c" 3 4
 , "coders/sun.c", 813, __extension__ __PRETTY_FUNCTION__); }))
# 813 "coders/sun.c"
                                            ;
  
# 814 "coders/sun.c" 3 4
 ((void) sizeof ((
# 814 "coders/sun.c"
 exception->signature == 0xabacadabUL
# 814 "coders/sun.c" 3 4
...
# 814 "coders/sun.c"
 "exception->signature == MagickCoreSignature"
# 814 "coders/sun.c" 3 4
 , "coders/sun.c", 814, __extension__ __PRETTY_FUNCTION__); }))
# 814 "coders/sun.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/sun.c",__func__,(unsigned long) 816,"%s",image->filename);
  ...
  do
  {
    ...
    if ((image->columns != (unsigned int) image->columns) ||
      ...
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 832,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 832 "coders/sun.c" 3 4
     ((void *)0)
# 832 "coders/sun.c"
    ...
    sun_info.type=(unsigned int)
      (image->storage_class == DirectClass ? 3 : 1);
    sun_info.maptype=0;
    sun_info.maplength=0;
    number_pixels=(MagickSizeType) image->columns*image->rows;
    if ((4*number_pixels) != (size_t) (4*number_pixels))
      { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 841,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 841 "coders/sun.c" 3 4
     ((void *)0)
# 841 "coders/sun.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
...
# 914 "coders/sun.c" 3 4
                                       ((void *)0)
# 914 "coders/sun.c"
                                           )
          { (void) ThrowMagickException(exception,"coders/sun.c",__func__,(unsigned long) 915,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 915 "coders/sun.c" 3 4
         ((void *)0)
# 915 "coders/sun.c"
         ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
