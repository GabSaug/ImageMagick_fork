...
# 114 "coders/hald.c" 3 4
 , "coders/hald.c", 114, __extension__ __PRETTY_FUNCTION__); }))
# 114 "coders/hald.c"
                                               ;
  
# 115 "coders/hald.c" 3 4
 ((void) sizeof ((
# 115 "coders/hald.c"
...
# 115 "coders/hald.c" 3 4
 , "coders/hald.c", 115, __extension__ __PRETTY_FUNCTION__); }))
# 115 "coders/hald.c"
                                                     ;
  
# 116 "coders/hald.c" 3 4
 ((void) sizeof ((
# 116 "coders/hald.c"
...
# 116 "coders/hald.c" 3 4
 , "coders/hald.c", 116, __extension__ __PRETTY_FUNCTION__); }))
# 116 "coders/hald.c"
                                            ;
  
# 117 "coders/hald.c" 3 4
 ((void) sizeof ((
# 117 "coders/hald.c"
...
# 117 "coders/hald.c" 3 4
 , "coders/hald.c", 117, __extension__ __PRETTY_FUNCTION__); }))
# 117 "coders/hald.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/hald.c",__func__,(unsigned long) 119,"%s",
      image_info->filename);
  ...
  if (((MagickSizeType) image->columns*image->rows) <= 65536UL)
...
# 153 "coders/hald.c"
    ...
    for (green=0; green < (ssize_t) cube_size; green++)
    {
      ...
      {
        SetPixelRed(image,ClampToQuantum((double) ((Quantum) 65535.0)*red/
          (cube_size-1.0)),q);
        SetPixelGreen(image,ClampToQuantum((double) ((Quantum) 65535.0)*green/
          (cube_size-1.0)),q);
        SetPixelBlue(image,ClampToQuantum((double) ((Quantum) 65535.0)*blue/
          (cube_size-1.0)),q);
        SetPixelAlpha(image,((Quantum) ((Quantum) 65535.0)),q);
        if (image->storage_class == PseudoClass)
          {
            image->colormap[index].red=
              ClampToQuantum((double) ((Quantum) 65535.0)*red/(cube_size-1.0));
            image->colormap[index].green=
              ClampToQuantum((double) ((Quantum) 65535.0)*green/(cube_size-1.0));
            image->colormap[index].blue=
              ClampToQuantum((double) ((Quantum) 65535.0)*blue/(cube_size-1.0));
            image->colormap[index].alpha=((Quantum) ((Quantum) 65535.0));
...
# 220 "coders/hald.c"
__attribute__ ((visibility ("default"))) size_t RegisterHALDImage(void)
{
  MagickInfo
    *entry;
...
# 255 "coders/hald.c"
__attribute__ ((visibility ("default"))) void UnregisterHALDImage(void)
{
