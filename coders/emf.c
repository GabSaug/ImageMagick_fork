...
# 18 "./coders/emf.h" 2
# 31 "./coders/emf.h"
extern __attribute__ ((visibility ("default"))) size_t RegisterEMFImage(void); extern __attribute__ ((visibility ("default"))) void UnregisterEMFImage(void);
# 76 "coders/emf.c" 2
# 102 "coders/emf.c"
...
# 855 "coders/emf.c"
__attribute__ ((visibility ("default"))) size_t RegisterEMFImage(void)
{
  MagickInfo
    *entry;
...
# 896 "coders/emf.c"
__attribute__ ((visibility ("default"))) void UnregisterEMFImage(void)
{
