...
# 148 "coders/jnx.c" 3 4
 , "coders/jnx.c", 148, __extension__ __PRETTY_FUNCTION__); }))
# 148 "coders/jnx.c"
                                               ;
  
# 149 "coders/jnx.c" 3 4
 ((void) sizeof ((
# 149 "coders/jnx.c"
...
# 149 "coders/jnx.c" 3 4
 , "coders/jnx.c", 149, __extension__ __PRETTY_FUNCTION__); }))
# 149 "coders/jnx.c"
                                                     ;
  
# 150 "coders/jnx.c" 3 4
 ((void) sizeof ((
# 150 "coders/jnx.c"
...
# 150 "coders/jnx.c" 3 4
 , "coders/jnx.c", 150, __extension__ __PRETTY_FUNCTION__); }))
# 150 "coders/jnx.c"
                                            ;
  
# 151 "coders/jnx.c" 3 4
 ((void) sizeof ((
# 151 "coders/jnx.c"
...
# 151 "coders/jnx.c" 3 4
 , "coders/jnx.c", 151, __extension__ __PRETTY_FUNCTION__); }))
# 151 "coders/jnx.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/jnx.c",__func__,(unsigned long) 153,"%s",
      image_info->filename);
...
# 162 "coders/jnx.c"
  ...
  if ((jnx_info.version != 3) && (jnx_info.version != 4))
    { (void) ThrowMagickException(exception,"coders/jnx.c",__func__,(unsigned long) 170,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 170 "coders/jnx.c" 3 4
   ((void *)0)
# 170 "coders/jnx.c"
...
# 170 "coders/jnx.c"
  ...
  if (jnx_info.levels > 20)
    { (void) ThrowMagickException(exception,"coders/jnx.c",__func__,(unsigned long) 178,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 178 "coders/jnx.c" 3 4
   ((void *)0)
# 178 "coders/jnx.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 178 "coders/jnx.c" 3 4
...
# 178 "coders/jnx.c"
  ...
  if (EOFBlob(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/jnx.c",__func__,(unsigned long) 190,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 190 "coders/jnx.c" 3 4
   ((void *)0)
# 190 "coders/jnx.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 190 "coders/jnx.c" 3 4
...
# 190 "coders/jnx.c"
  ...
  for (i=0; i < (ssize_t) jnx_info.levels; i++)
  {
    ...
    if (jnx_level_info[i].count > 50000)
      { (void) ThrowMagickException(exception,"coders/jnx.c",__func__,(unsigned long) 200,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 200 "coders/jnx.c" 3 4
     ((void *)0)
# 200 "coders/jnx.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 200 "coders/jnx.c" 3 4
...
# 200 "coders/jnx.c"
    ...
    if (EOFBlob(image) != MagickFalse)
      { (void) ThrowMagickException(exception,"coders/jnx.c",__func__,(unsigned long) 211,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 211 "coders/jnx.c" 3 4
     ((void *)0)
# 211 "coders/jnx.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 211 "coders/jnx.c" 3 4
...
# 211 "coders/jnx.c"
  ...
  if (AcquireMagickResource(ListLengthResource,num_images) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/jnx.c",__func__,(unsigned long) 215,ResourceLimitError,"ListLengthExceedsLimit", "`%s'",image_info->filename); if ((image) != (Image *) 
# 215 "coders/jnx.c" 3 4
   ((void *)0)
# 215 "coders/jnx.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 215 "coders/jnx.c" 3 4
...
# 215 "coders/jnx.c"
  ...
  for (i=0; i < (ssize_t) jnx_info.levels; i++)
  {
    ...
    offset=SeekBlob(image,(MagickOffsetType) jnx_level_info[i].offset,
# 228 "coders/jnx.c" 3 4
                                                                     0
# 228 "coders/jnx.c"
                                                                             );
      ...
      if (EOFBlob(image) != MagickFalse)
        {
          ...
          { (void) ThrowMagickException(exception,"coders/jnx.c",__func__,(unsigned long) 267,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 267 "coders/jnx.c" 3 4
         ((void *)0)
# 267 "coders/jnx.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 267 "coders/jnx.c" 3 4
...
# 267 "coders/jnx.c"
      ...
      if (restore_offset < 0)
        continue;
      offset=SeekBlob(image,(MagickOffsetType) tile_offset,
# 276 "coders/jnx.c" 3 4
                                                          0
# 276 "coders/jnx.c"
                                                                  );
      ...
      if (((MagickSizeType) tile_length) > GetBlobSize(image))
        {
          images=DestroyImageList(images);
          { (void) ThrowMagickException(exception,"coders/jnx.c",__func__,(unsigned long) 285,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 285 "coders/jnx.c" 3 4
         ((void *)0)
# 285 "coders/jnx.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 285 "coders/jnx.c" 3 4
...
# 289 "coders/jnx.c" 3 4
                                   ((void *)0)
# 289 "coders/jnx.c"
                                       )
        {
          images=DestroyImageList(images);
          { (void) ThrowMagickException(exception,"coders/jnx.c",__func__,(unsigned long) 292,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 292 "coders/jnx.c" 3 4
         ((void *)0)
# 292 "coders/jnx.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 292 "coders/jnx.c" 3 4
      ...
      if (count != (ssize_t) tile_length)
        {
          ...
          { (void) ThrowMagickException(exception,"coders/jnx.c",__func__,(unsigned long) 301,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 301 "coders/jnx.c" 3 4
         ((void *)0)
# 301 "coders/jnx.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 301 "coders/jnx.c" 3 4
...
# 301 "coders/jnx.c"
      ...
      (void) CopyMagickString(read_info->magick,"JPEG",4096);
      tile_image=BlobToImage(read_info,blob,tile_length+2,exception);
      read_info=DestroyImageInfo(read_info);
      blob=(unsigned char *) RelinquishMagickMemory(blob);
      offset=SeekBlob(image,restore_offset,
# 308 "coders/jnx.c" 3 4
                                          0
# 308 "coders/jnx.c"
                                                  );
      if (tile_image == (Image *) 
# 309 "coders/jnx.c" 3 4
                                 ((void *)0)
# 309 "coders/jnx.c"
                                     )
        continue;
...
# 320 "coders/jnx.c"
                                                              )
      {
        ...
        proceed=SetImageProgress(image,"Load/Image",(MagickOffsetType) i,
...
# 358 "coders/jnx.c"
__attribute__ ((visibility ("default"))) size_t RegisterJNXImage(void)
{
  MagickInfo
    *entry;
...
# 389 "coders/jnx.c"
__attribute__ ((visibility ("default"))) void UnregisterJNXImage(void)
{
