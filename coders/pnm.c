    ...
    if ((size_t) (p-comment_info->comment+1) >= comment_info->extent)
      {
        ...
        if (comment_info->comment == (char *) 
# 175 "coders/pnm.c" 3 4
                                             ((void *)0)
# 175 "coders/pnm.c"
                                                 )
          return(-1);
...
# 215 "coders/pnm.c"
                                           != 0)
  {
    if (value <= (unsigned int) (0x7fffffff
# 217 "coders/pnm.c"
                                       /10))
      {
        value*=10;
...
# 315 "coders/pnm.c" 3 4
 , "coders/pnm.c", 315, __extension__ __PRETTY_FUNCTION__); }))
# 315 "coders/pnm.c"
                                               ;
  
# 316 "coders/pnm.c" 3 4
 ((void) sizeof ((
# 316 "coders/pnm.c"
...
# 316 "coders/pnm.c" 3 4
 , "coders/pnm.c", 316, __extension__ __PRETTY_FUNCTION__); }))
# 316 "coders/pnm.c"
                                                     ;
  
# 317 "coders/pnm.c" 3 4
 ((void) sizeof ((
# 317 "coders/pnm.c"
...
# 317 "coders/pnm.c" 3 4
 , "coders/pnm.c", 317, __extension__ __PRETTY_FUNCTION__); }))
# 317 "coders/pnm.c"
                                            ;
  
# 318 "coders/pnm.c" 3 4
 ((void) sizeof ((
# 318 "coders/pnm.c"
...
# 318 "coders/pnm.c" 3 4
 , "coders/pnm.c", 318, __extension__ __PRETTY_FUNCTION__); }))
# 318 "coders/pnm.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pnm.c",__func__,(unsigned long) 320,"%s",
      image_info->filename);
...
# 327 "coders/pnm.c"
  ...
  comment_info.comment=(char *) 
# 332 "coders/pnm.c" 3 4
                               ((void *)0)
# 332 "coders/pnm.c"
                                   ;
  quantum_info=(QuantumInfo *) 
# 333 "coders/pnm.c" 3 4
                              ((void *)0)
# 333 "coders/pnm.c"
                                  ;
  ...
  do
  {
    ...
    comment_info.comment=AcquireString(
# 340 "coders/pnm.c" 3 4
                                      ((void *)0)
# 340 "coders/pnm.c"
                                          );
    comment_info.extent=4096;
    if ((count != 1) || (format != 'P'))
      { if (comment_info.comment != (char *) 
# 343 "coders/pnm.c" 3 4
     ((void *)0)
# 343 "coders/pnm.c"
     ) comment_info.comment=DestroyString(comment_info.comment); if (quantum_info != (QuantumInfo *) 
# 343 "coders/pnm.c" 3 4
     ((void *)0)
# 343 "coders/pnm.c"
     ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 343,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 343 "coders/pnm.c" 3 4
     ((void *)0)
# 343 "coders/pnm.c"
    ...
    if (format != '7')
      {
        ...
        if ((format == 'f') || (format == 'F') || (format == 'h') ||
            (format == 'H'))
          {
            ...
            if (PNMString(image,scale,sizeof(scale)) != (char *) 
# 364 "coders/pnm.c" 3 4
                                                                ((void *)0)
# 364 "coders/pnm.c"
                                                                    )
              quantum_scale=StringToDouble(scale,(char **) 
# 365 "coders/pnm.c" 3 4
                                                          ((void *)0)
# 365 "coders/pnm.c"
                                                              );
          }
    ...
    else
      {
        ...
        for (c=ReadBlobByte(image); c != 
# 391 "coders/pnm.c" 3 4
                                        (-1)
# 391 "coders/pnm.c"
                                           ; c=ReadBlobByte(image))
        {
          while (
# 393 "coders/pnm.c" 3 4
                ((*__ctype_b_loc ())[(int) ((
# 393 "coders/pnm.c"
                (int) ((unsigned char) c)
# 393 "coders/pnm.c" 3 4
...
# 486 "coders/pnm.c" 3 4
     ((void *)0)
# 486 "coders/pnm.c"
     ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 486,(CorruptImageError),("NegativeOrZeroImageSize"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 486 "coders/pnm.c" 3 4
     ((void *)0)
# 486 "coders/pnm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 488 "coders/pnm.c" 3 4
     ((void *)0)
# 488 "coders/pnm.c"
     ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 488,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 488 "coders/pnm.c" 3 4
     ((void *)0)
# 488 "coders/pnm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 495 "coders/pnm.c" 3 4
     ((void *)0)
# 495 "coders/pnm.c"
     ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 495,(CorruptImageError),("InsufficientImageDataInFile"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 495 "coders/pnm.c" 3 4
     ((void *)0)
# 495 "coders/pnm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 641 "coders/pnm.c"
      ...
      case '4':
      {
        ...
        if (quantum_info == (QuantumInfo *) 
# 667 "coders/pnm.c" 3 4
                                           ((void *)0)
# 667 "coders/pnm.c"
                                               )
          { if (comment_info.comment != (char *) 
# 668 "coders/pnm.c" 3 4
         ((void *)0)
# 668 "coders/pnm.c"
         ) comment_info.comment=DestroyString(comment_info.comment); if (quantum_info != (QuantumInfo *) 
# 668 "coders/pnm.c" 3 4
         ((void *)0)
# 668 "coders/pnm.c"
         ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 668,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 668 "coders/pnm.c" 3 4
         ((void *)0)
# 668 "coders/pnm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 689 "coders/pnm.c" 3 4
                                                                 ((void *)0)
# 689 "coders/pnm.c"
                                                                     ) &&
              (image->previous == (Image *) 
# 690 "coders/pnm.c" 3 4
                                           ((void *)0)
# 690 "coders/pnm.c"
                                               ))
            {
              ...
              proceed=SetImageProgress(image,"Load/Image",(MagickOffsetType)
                row,image->rows);
          ...
          if (q == (Quantum *) 
# 702 "coders/pnm.c" 3 4
                              ((void *)0)
# 702 "coders/pnm.c"
                                  )
            break;
          length=ImportQuantumPixels(image,(CacheView *) 
# 704 "coders/pnm.c" 3 4
                                                        ((void *)0)
# 704 "coders/pnm.c"
                                                            ,quantum_info,
      ...
      case '5':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 726 "coders/pnm.c" 3 4
                                           ((void *)0)
# 726 "coders/pnm.c"
                                               )
          { if (comment_info.comment != (char *) 
# 727 "coders/pnm.c" 3 4
         ((void *)0)
# 727 "coders/pnm.c"
         ) comment_info.comment=DestroyString(comment_info.comment); if (quantum_info != (QuantumInfo *) 
# 727 "coders/pnm.c" 3 4
         ((void *)0)
# 727 "coders/pnm.c"
         ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 727,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 727 "coders/pnm.c" 3 4
         ((void *)0)
# 727 "coders/pnm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 727 "coders/pnm.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          if (count != (ssize_t) extent)
            break;
          if ((image->progress_monitor != (MagickProgressMonitor) 
# 747 "coders/pnm.c" 3 4
                                                                 ((void *)0)
# 747 "coders/pnm.c"
                                                                     ) &&
              (image->previous == (Image *) 
# 748 "coders/pnm.c" 3 4
                                           ((void *)0)
# 748 "coders/pnm.c"
                                               ))
            {
...
# 769 "coders/pnm.c"
      ...
      case '6':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 849 "coders/pnm.c" 3 4
                                           ((void *)0)
# 849 "coders/pnm.c"
                                               )
          { if (comment_info.comment != (char *) 
# 850 "coders/pnm.c" 3 4
         ((void *)0)
# 850 "coders/pnm.c"
         ) comment_info.comment=DestroyString(comment_info.comment); if (quantum_info != (QuantumInfo *) 
# 850 "coders/pnm.c" 3 4
         ((void *)0)
# 850 "coders/pnm.c"
         ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 850,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 850 "coders/pnm.c" 3 4
         ((void *)0)
# 850 "coders/pnm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 850 "coders/pnm.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          if (count != (ssize_t) extent)
            break;
          if ((image->progress_monitor != (MagickProgressMonitor) 
# 871 "coders/pnm.c" 3 4
                                                                 ((void *)0)
# 871 "coders/pnm.c"
                                                                     ) &&
              (image->previous == (Image *) 
# 872 "coders/pnm.c" 3 4
                                           ((void *)0)
# 872 "coders/pnm.c"
                                               ))
            {
...
# 884 "coders/pnm.c"
      ...
      case '7':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 1084 "coders/pnm.c" 3 4
                                           ((void *)0)
# 1084 "coders/pnm.c"
                                               )
          { if (comment_info.comment != (char *) 
# 1085 "coders/pnm.c" 3 4
         ((void *)0)
# 1085 "coders/pnm.c"
         ) comment_info.comment=DestroyString(comment_info.comment); if (quantum_info != (QuantumInfo *) 
# 1085 "coders/pnm.c" 3 4
         ((void *)0)
# 1085 "coders/pnm.c"
         ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 1085,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1085 "coders/pnm.c" 3 4
         ((void *)0)
# 1085 "coders/pnm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1085 "coders/pnm.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          if (count != (ssize_t) extent)
            break;
          if ((image->progress_monitor != (MagickProgressMonitor) 
# 1105 "coders/pnm.c" 3 4
                                                                 ((void *)0)
# 1105 "coders/pnm.c"
                                                                     ) &&
              (image->previous == (Image *) 
# 1106 "coders/pnm.c" 3 4
                                           ((void *)0)
# 1106 "coders/pnm.c"
                                               ))
            {
...
# 1127 "coders/pnm.c"
                        ...
                        if (image->alpha_trait != UndefinedPixelTrait)
                          {
                            ...
                            if (image->depth != 1)
                              ...
                              SetPixelAlpha(image,((Quantum) 65535.0)-
      ...
      case 'f':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 1461 "coders/pnm.c" 3 4
                                           ((void *)0)
# 1461 "coders/pnm.c"
                                               )
          { if (comment_info.comment != (char *) 
# 1462 "coders/pnm.c" 3 4
         ((void *)0)
# 1462 "coders/pnm.c"
         ) comment_info.comment=DestroyString(comment_info.comment); if (quantum_info != (QuantumInfo *) 
# 1462 "coders/pnm.c" 3 4
         ((void *)0)
# 1462 "coders/pnm.c"
         ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 1462,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1462 "coders/pnm.c" 3 4
         ((void *)0)
# 1462 "coders/pnm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1465 "coders/pnm.c" 3 4
         ((void *)0)
# 1465 "coders/pnm.c"
         ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 1465,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1465 "coders/pnm.c" 3 4
         ((void *)0)
# 1465 "coders/pnm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1465 "coders/pnm.c"
        ...
        SetQuantumScale(quantum_info,(double) ((Quantum) 65535.0)*fabs(quantum_scale));
        extent=GetQuantumExtent(image,quantum_info,quantum_type);
        pixels=GetQuantumPixels(quantum_info);
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          if (count != (ssize_t) extent)
            break;
          if ((image->progress_monitor != (MagickProgressMonitor) 
# 1486 "coders/pnm.c" 3 4
                                                                 ((void *)0)
# 1486 "coders/pnm.c"
                                                                     ) &&
              (image->previous == (Image *) 
# 1487 "coders/pnm.c" 3 4
                                           ((void *)0)
# 1487 "coders/pnm.c"
                                               ))
            {
          ...
          if (q == (Quantum *) 
# 1500 "coders/pnm.c" 3 4
                              ((void *)0)
# 1500 "coders/pnm.c"
                                  )
            break;
          length=ImportQuantumPixels(image,(CacheView *) 
# 1502 "coders/pnm.c" 3 4
                                                        ((void *)0)
# 1502 "coders/pnm.c"
                                                            ,quantum_info,
            quantum_type,(unsigned char *) stream,exception);
      ...
      case 'h':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 1531 "coders/pnm.c" 3 4
                                           ((void *)0)
# 1531 "coders/pnm.c"
                                               )
          { if (comment_info.comment != (char *) 
# 1532 "coders/pnm.c" 3 4
         ((void *)0)
# 1532 "coders/pnm.c"
         ) comment_info.comment=DestroyString(comment_info.comment); if (quantum_info != (QuantumInfo *) 
# 1532 "coders/pnm.c" 3 4
         ((void *)0)
# 1532 "coders/pnm.c"
         ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 1532,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1532 "coders/pnm.c" 3 4
         ((void *)0)
# 1532 "coders/pnm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1535 "coders/pnm.c" 3 4
         ((void *)0)
# 1535 "coders/pnm.c"
         ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 1535,(ResourceLimitError),("MemoryAllocationFailed"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1535 "coders/pnm.c" 3 4
         ((void *)0)
# 1535 "coders/pnm.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1535 "coders/pnm.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          if (count != (ssize_t) extent)
            break;
          if ((image->progress_monitor != (MagickProgressMonitor) 
# 1556 "coders/pnm.c" 3 4
                                                                 ((void *)0)
# 1556 "coders/pnm.c"
                                                                     ) &&
              (image->previous == (Image *) 
# 1557 "coders/pnm.c" 3 4
                                           ((void *)0)
# 1557 "coders/pnm.c"
                                               ))
            {
          ...
          q=QueueAuthenticPixels(image,0,((ssize_t) image->rows-offset-1),
            image->columns,1,exception);
          if (q == (Quantum *) 
# 1570 "coders/pnm.c" 3 4
                              ((void *)0)
# 1570 "coders/pnm.c"
                                  )
            break;
          length=ImportQuantumPixels(image,(CacheView *) 
# 1572 "coders/pnm.c" 3 4
                                                        ((void *)0)
# 1572 "coders/pnm.c"
                                                            ,quantum_info,
            quantum_type,(unsigned char *) stream,exception);
...
# 1585 "coders/pnm.c" 3 4
       ((void *)0)
# 1585 "coders/pnm.c"
       ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 1585,(CorruptImageError),("ImproperImageHeader"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1585 "coders/pnm.c" 3 4
       ((void *)0)
# 1585 "coders/pnm.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1591 "coders/pnm.c" 3 4
     ((void *)0)
# 1591 "coders/pnm.c"
     ) quantum_info=DestroyQuantumInfo(quantum_info); { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 1591,(CorruptImageError),("UnableToReadImageData"), "`%s'",image_info->filename); if ((image) != (Image *) 
# 1591 "coders/pnm.c" 3 4
     ((void *)0)
# 1591 "coders/pnm.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
...
# 1591 "coders/pnm.c"
    ...
    if (EOFBlob(image) != MagickFalse)
      {
        (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 1594,
...
# 1623 "coders/pnm.c"
  ...
  if (comment_info.comment != (char *) 
# 1636 "coders/pnm.c" 3 4
                                      ((void *)0)
# 1636 "coders/pnm.c"
                                          )
    comment_info.comment=DestroyString(comment_info.comment);
  if (quantum_info != (QuantumInfo *) 
# 1638 "coders/pnm.c" 3 4
                                     ((void *)0)
# 1638 "coders/pnm.c"
                                         )
    quantum_info=DestroyQuantumInfo(quantum_info);
...
# 1668 "coders/pnm.c"
__attribute__ ((visibility ("default"))) size_t RegisterPNMImage(void)
{
  MagickInfo
    *entry;
...
# 1739 "coders/pnm.c"
__attribute__ ((visibility ("default"))) void UnregisterPNMImage(void)
{
...
# 1819 "coders/pnm.c"
 "image_info != (const ImageInfo *) NULL"
# 1819 "coders/pnm.c" 3 4
 , "coders/pnm.c", 1819, __extension__ __PRETTY_FUNCTION__); }))
# 1819 "coders/pnm.c"
                                               ;
  
# 1820 "coders/pnm.c" 3 4
 ((void) sizeof ((
# 1820 "coders/pnm.c"
 image_info->signature == 0xabacadabUL
# 1820 "coders/pnm.c" 3 4
...
# 1820 "coders/pnm.c"
 "image_info->signature == MagickCoreSignature"
# 1820 "coders/pnm.c" 3 4
 , "coders/pnm.c", 1820, __extension__ __PRETTY_FUNCTION__); }))
# 1820 "coders/pnm.c"
                                                     ;
  
# 1821 "coders/pnm.c" 3 4
 ((void) sizeof ((
# 1821 "coders/pnm.c"
 image != (Image *) 
# 1821 "coders/pnm.c" 3 4
...
# 1821 "coders/pnm.c"
 "image != (Image *) NULL"
# 1821 "coders/pnm.c" 3 4
 , "coders/pnm.c", 1821, __extension__ __PRETTY_FUNCTION__); }))
# 1821 "coders/pnm.c"
                                ;
  
# 1822 "coders/pnm.c" 3 4
 ((void) sizeof ((
# 1822 "coders/pnm.c"
...
# 1822 "coders/pnm.c" 3 4
 , "coders/pnm.c", 1822, __extension__ __PRETTY_FUNCTION__); }))
# 1822 "coders/pnm.c"
                                                ;
  
# 1823 "coders/pnm.c" 3 4
 ((void) sizeof ((
# 1823 "coders/pnm.c"
 exception != (ExceptionInfo *) 
# 1823 "coders/pnm.c" 3 4
...
# 1823 "coders/pnm.c"
 "exception != (ExceptionInfo *) NULL"
# 1823 "coders/pnm.c" 3 4
 , "coders/pnm.c", 1823, __extension__ __PRETTY_FUNCTION__); }))
# 1823 "coders/pnm.c"
                                            ;
  
# 1824 "coders/pnm.c" 3 4
 ((void) sizeof ((
# 1824 "coders/pnm.c"
 exception->signature == 0xabacadabUL
# 1824 "coders/pnm.c" 3 4
...
# 1824 "coders/pnm.c"
 "exception->signature == MagickCoreSignature"
# 1824 "coders/pnm.c" 3 4
 , "coders/pnm.c", 1824, __extension__ __PRETTY_FUNCTION__); }))
# 1824 "coders/pnm.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/pnm.c",__func__,(unsigned long) 1826,"%s",image->filename);
  ...
  do
  {
    ...
    packet_size=3;
    quantum_type=RGBQuantum;
    (void) CopyMagickString(magick,image_info->magick,4096);
    ...
    (void) FormatLocaleString(buffer,4096,"P%c\n",format);
    (void) WriteBlobString(image,buffer);
    value=GetImageProperty(image,"comment",exception);
    if (value != (const char *) 
# 1923 "coders/pnm.c" 3 4
                               ((void *)0)
# 1923 "coders/pnm.c"
                                   )
      {
    ...
    if (format != '7')
      {
        (void) FormatLocaleString(buffer,4096,"%.20g %.20g\n",
    ...
    else
      {
        ...
        switch (quantum_type)
        {
          ...
          {
            packet_size=4;
            (void) CopyMagickString(type,"CMYK",4096);
            break;
          }
          case GrayQuantum:
          case GrayAlphaQuantum:
          {
            packet_size=1;
            (void) CopyMagickString(type,"GRAYSCALE",4096);
            if (GetQuantumRange(image->depth) == 1)
              (void) CopyMagickString(type,"BLACKANDWHITE",4096);
            break;
          }
          default:
          {
            ...
            if (image->alpha_trait != UndefinedPixelTrait)
              quantum_type=RGBAQuantum;
            packet_size=3;
            (void) CopyMagickString(type,"RGB",4096);
            break;
          }
        }
        if (image->alpha_trait != UndefinedPixelTrait)
          {
            packet_size++;
            (void) ConcatenateMagickString(type,"_ALPHA",4096);
          }
        if (image->depth > 32)
          image->depth=32;
        (void) FormatLocaleString(buffer,4096,
...
# 2084 "coders/pnm.c"
          ...
          for (x=0; x < (ssize_t) image->columns; x++)
          {
            ...
            if (image->depth <= 8)
              count=(ssize_t) FormatLocaleString(buffer,4096,"%u ",
                ScaleQuantumToChar(index));
            else
              if (image->depth <= 16)
                count=(ssize_t) FormatLocaleString(buffer,4096,
...
# 2189 "coders/pnm.c"
      ...
      case '4':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 2215 "coders/pnm.c" 3 4
                                           ((void *)0)
# 2215 "coders/pnm.c"
                                               )
          { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 2216,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2216 "coders/pnm.c" 3 4
         ((void *)0)
# 2216 "coders/pnm.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 2226 "coders/pnm.c" 3 4
                                    ((void *)0)
# 2226 "coders/pnm.c"
                                        )
            break;
          extent=ExportQuantumPixels(image,(CacheView *) 
# 2228 "coders/pnm.c" 3 4
                                                        ((void *)0)
# 2228 "coders/pnm.c"
                                                            ,quantum_info,
...
# 2233 "coders/pnm.c"
      ...
      case '5':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 2258 "coders/pnm.c" 3 4
                                           ((void *)0)
# 2258 "coders/pnm.c"
                                               )
          { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 2259,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2259 "coders/pnm.c" 3 4
         ((void *)0)
# 2259 "coders/pnm.c"
         ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
        (void) SetQuantumEndian(image,quantum_info,MSBEndian);
...
# 2351 "coders/pnm.c"
      ...
      case '6':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 2378 "coders/pnm.c" 3 4
                                           ((void *)0)
# 2378 "coders/pnm.c"
                                               )
          { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 2379,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2379 "coders/pnm.c" 3 4
         ((void *)0)
# 2379 "coders/pnm.c"
         ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
        (void) SetQuantumEndian(image,quantum_info,MSBEndian);
...
# 2454 "coders/pnm.c"
      ...
      case '7':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 2476 "coders/pnm.c" 3 4
                                           ((void *)0)
# 2476 "coders/pnm.c"
                                               )
          { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 2477,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2477 "coders/pnm.c" 3 4
         ((void *)0)
# 2477 "coders/pnm.c"
         ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
        (void) SetQuantumEndian(image,quantum_info,MSBEndian);
...
# 2703 "coders/pnm.c"
      ...
      case 'f':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 2725 "coders/pnm.c" 3 4
                                           ((void *)0)
# 2725 "coders/pnm.c"
                                               )
          { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 2726,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2726 "coders/pnm.c" 3 4
         ((void *)0)
# 2726 "coders/pnm.c"
         ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
        status=SetQuantumFormat(image,quantum_info,FloatingPointQuantumFormat);
        if (status == MagickFalse)
          { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 2729,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2729 "coders/pnm.c" 3 4
         ((void *)0)
# 2729 "coders/pnm.c"
         ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
        pixels=GetQuantumPixels(quantum_info);
        for (y=(ssize_t) image->rows-1; y >= 0; y--)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 2737 "coders/pnm.c" 3 4
                                    ((void *)0)
# 2737 "coders/pnm.c"
                                        )
            break;
          extent=ExportQuantumPixels(image,(CacheView *) 
# 2739 "coders/pnm.c" 3 4
                                                        ((void *)0)
# 2739 "coders/pnm.c"
                                                            ,quantum_info,
            quantum_type,pixels,exception);
...
# 2742 "coders/pnm.c"
      ...
      case 'h':
      {
        ...
        quantum_info=AcquireQuantumInfo(image_info,image);
        if (quantum_info == (QuantumInfo *) 
# 2764 "coders/pnm.c" 3 4
                                           ((void *)0)
# 2764 "coders/pnm.c"
                                               )
          { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 2765,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2765 "coders/pnm.c" 3 4
         ((void *)0)
# 2765 "coders/pnm.c"
         ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
        status=SetQuantumFormat(image,quantum_info,FloatingPointQuantumFormat);
        if (status == MagickFalse)
          { (void) ThrowMagickException(exception,"coders/pnm.c",__func__,(unsigned long) 2768,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 2768 "coders/pnm.c" 3 4
         ((void *)0)
# 2768 "coders/pnm.c"
         ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
        pixels=GetQuantumPixels(quantum_info);
        for (y=(ssize_t) image->rows-1; y >= 0; y--)
        {
          ...
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 2776 "coders/pnm.c" 3 4
                                    ((void *)0)
# 2776 "coders/pnm.c"
                                        )
            break;
          extent=ExportQuantumPixels(image,(CacheView *) 
# 2778 "coders/pnm.c" 3 4
                                                        ((void *)0)
# 2778 "coders/pnm.c"
                                                            ,quantum_info,
            quantum_type,pixels,exception);
