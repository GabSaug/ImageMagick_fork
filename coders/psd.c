...
# 1 "coders/psd-private.h" 1
# 25 "coders/psd-private.h"
...
# 342 "coders/psd.c"
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      gamma=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelAlpha(image, q);
  ...
  const Quantum opacity,const MagickBooleanType revert,ExceptionInfo *exception)
{
  ...
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 400,
      "  applying layer opacity %.20g", (double) opacity);
  if (opacity == ((Quantum) ((Quantum) 65535.0)))
    return(MagickTrue);
  if (image->alpha_trait != BlendPixelTrait)
...
# 422 "coders/psd.c"
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      if (revert == MagickFalse)
        SetPixelAlpha(image,ClampToQuantum(((double) 1.0/(double) ((Quantum) 65535.0))*(double)
  ...
  ExceptionInfo *exception)
{
  ...
  if ((image->alpha_trait & BlendPixelTrait) == 0)
    return(MagickTrue);
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 463,
      "  applying opacity mask");
  complete_mask=CloneImage(image,0,0,MagickTrue,exception);
  if (complete_mask == (Image *) 
# 466 "coders/psd.c" 3 4
                                ((void *)0)
# 466 "coders/psd.c"
                                    )
    return(MagickFalse);
...
# 499 "coders/psd.c"
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      if (revert == MagickFalse)
        SetPixelAlpha(image,ClampToQuantum(intensity*(((double) 1.0/(double) ((Quantum) 65535.0))*alpha)),q);
      else
        if (intensity > 0)
  ...
  ExceptionInfo *exception)
{
  ...
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 541,
    ...
    if (length > 128)
      {
        ...
        for (j=0; j < (ssize_t) length; j++)
        {
          switch (depth)
          {
            case 1:
            {
              if (((ssize_t) i + 8) > (ssize_t) number_pixels) return(i); i+=8;
            ...
            case 2:
            {
              if (((ssize_t) i + 4) > (ssize_t) number_pixels) return(i); i+=4;
            ...
            case 4:
            {
              if (((ssize_t) i + 2) > (ssize_t) number_pixels) return(i); i+=2;
            ...
            default:
            {
              if (((ssize_t) i + 1) > (ssize_t) number_pixels) return(i); i+=1;
  ...
  const ssize_t number_layers)
{
  ...
  {
    if (layer_info[i].image != (Image *) 
# 696 "coders/psd.c" 3 4
                                        ((void *)0)
# 696 "coders/psd.c"
                                            )
      layer_info[i].image=DestroyImage(layer_info[i].image);
    if (layer_info[i].mask.image != (Image *) 
# 698 "coders/psd.c" 3 4
                                             ((void *)0)
# 698 "coders/psd.c"
                                                 )
      layer_info[i].mask.image=DestroyImage(layer_info[i].mask.image);
    if (layer_info[i].info != (StringInfo *) 
# 700 "coders/psd.c" 3 4
                                            ((void *)0)
# 700 "coders/psd.c"
                                                )
  ...
  const unsigned char *blocks,size_t length)
{
  ...
  if (length < 16)
    return((StringInfo *) 
# 790 "coders/psd.c" 3 4
                         ((void *)0)
# 790 "coders/psd.c"
                             );
  profile=BlobToStringInfo((const unsigned char *) 
# 791 "coders/psd.c" 3 4
                                                  ((void *)0)
# 791 "coders/psd.c"
                                                      ,length);
    ...
    if (packet_size == 1)
      ...
      if (packet_size == 2)
      ...
      else
        {
          ...
          pixel=ClampToQuantum((double) ((Quantum) 65535.0)*(double) nibble);
        }
    if (image->depth > 1)
      {
    ...
    else
      {
        ...
        for (bit = 0; bit < (ssize_t) number_bits; bit++)
        {
          SetPSDPixel(image,channel,packet_size,(((unsigned char)
            ...
            (double) ((Quantum) 65535.0),q,exception);
          q+=GetPixelChannels(image);
          x++;
        }
  ...
  const PixelChannel channel,ExceptionInfo *exception)
{
  ...
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 1059,
       "      layer data is RAW");

  row_size=GetPSDRowSize(image);
  pixels=(unsigned char *) AcquireQuantumMemory(row_size,sizeof(*pixels));
  if (pixels == (unsigned char *) 
# 1064 "coders/psd.c" 3 4
                                 ((void *)0)
# 1064 "coders/psd.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1065,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  ...
  const PSDInfo *psd_info,const size_t size)
{
  ...
  if(sizes != (MagickOffsetType *) 
# 1097 "coders/psd.c" 3 4
                                  ((void *)0)
# 1097 "coders/psd.c"
                                      )
    {
  ...
  ExceptionInfo *exception)
{
  ...
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 1130,
       "      layer data is RLE compressed");

  row_size=GetPSDRowSize(image);
  pixels=(unsigned char *) AcquireQuantumMemory(row_size,sizeof(*pixels));
  if (pixels == (unsigned char *) 
# 1135 "coders/psd.c" 3 4
                                 ((void *)0)
# 1135 "coders/psd.c"
                                     )
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1136,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  ...
  if (length > (row_size+2048))
    {
      pixels=(unsigned char *) RelinquishMagickMemory(pixels);
      { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1147,ResourceLimitError,"InvalidLength", "`%s'",image->filename); return(MagickFalse); };
    }

  compact_pixels=(unsigned char *) AcquireQuantumMemory(length,sizeof(*pixels));
  if (compact_pixels == (unsigned char *) 
# 1151 "coders/psd.c" 3 4
                                         ((void *)0)
# 1151 "coders/psd.c"
                                             )
    {
      pixels=(unsigned char *) RelinquishMagickMemory(pixels);
      { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1154,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  ...
  const size_t compact_size,ExceptionInfo *exception)
{
  ...
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 1311,
       "      layer data is ZIP compressed");

  if ((MagickSizeType) compact_size > GetBlobSize(image))
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1315,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image->filename); return(MagickFalse); }
                      ;
  compact_pixels=(unsigned char *) AcquireQuantumMemory(compact_size,
    sizeof(*compact_pixels));
  if (compact_pixels == (unsigned char *) 
# 1319 "coders/psd.c" 3 4
                                         ((void *)0)
# 1319 "coders/psd.c"
                                             )
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1320,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  ...
  if (pixels == (unsigned char *) 
# 1328 "coders/psd.c" 3 4
                                 ((void *)0)
# 1328 "coders/psd.c"
                                     )
    {
      compact_pixels=(unsigned char *) RelinquishMagickMemory(compact_pixels);
      { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1331,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  if (ReadBlob(image,compact_size,compact_pixels) != (ssize_t) compact_size)
    {
      pixels=(unsigned char *) RelinquishMagickMemory(pixels);
      compact_pixels=(unsigned char *) RelinquishMagickMemory(compact_pixels);
      { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1338,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }

  memset(&stream,0,sizeof(stream));
  stream.data_type=
# 1343 "coders/psd.c" 3 4
                  0
# 1343 "coders/psd.c"
                          ;
...
# 1349 "coders/psd.c"
                                 )
    {
      ...
      {
        ret=inflate(&stream,
# 1356 "coders/psd.c" 3 4
                           2
# 1356 "coders/psd.c"
                                       );
        if ((ret != 
# 1357 "coders/psd.c" 3 4
                   0
# 1357 "coders/psd.c"
                       ) && (ret != 
# 1357 "coders/psd.c" 3 4
  ...
  if (compression == ZipWithPrediction)
    {
      ...
      else if (packet_size == 4)
      {
        ...
        if (output_pixels == (unsigned char *) 
# 1384 "coders/psd.c" 3 4
                                              ((void *)0)
# 1384 "coders/psd.c"
                                                  )
          {
            compact_pixels=(unsigned char *) RelinquishMagickMemory(
              compact_pixels);
            pixels=(unsigned char *) RelinquishMagickMemory(pixels);
            { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1389,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                                                       ;
          }
  ...
  ExceptionInfo *exception)
{
  ...
  if (layer_info->channel_info[channel_index].supported == MagickFalse)
    {
      (void) SeekBlob(image,end_offset,
# 1437 "coders/psd.c" 3 4
                                      1
# 1437 "coders/psd.c"
                                              );
      return(MagickTrue);
    ...
    case RLE:
      {
        ...
        if (sizes == (MagickOffsetType *) 
# 1485 "coders/psd.c" 3 4
                                         ((void *)0)
# 1485 "coders/psd.c"
                                             )
          { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1486,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                            ;
    ...
    case ZipWithoutPrediction:
      ...
      break;
    default:
      (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1504,TypeWarning,
        "CompressionNotSupported","'%.20g'",(double) compression);
      break;
  }

  (void) SeekBlob(image,offset+end_offset,
# 1509 "coders/psd.c" 3 4
                                         0
# 1509 "coders/psd.c"
                                                 );
  if (status == MagickFalse)
    {
      if (mask != (Image *) 
# 1512 "coders/psd.c" 3 4
                           ((void *)0)
# 1512 "coders/psd.c"
                               )
        (void) DestroyImage(mask);
      { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1514,CoderError,"UnableToDecompressImage", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  if (mask != (Image *) 
# 1517 "coders/psd.c" 3 4
                       ((void *)0)
# 1517 "coders/psd.c"
                           )
    {
      if (layer_info->mask.image != (Image *) 
# 1519 "coders/psd.c" 3 4
                                             ((void *)0)
# 1519 "coders/psd.c"
                                                 )
  ...
  const PSDInfo *psd_info,LayerInfo* layer_info,ExceptionInfo *exception)
{
  ...
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 1601,
  ...
  (void) FormatLocaleString(message,4096,"%.20g",
    (double) layer_info->page.x);
  (void) SetImageArtifact(layer_info->image,"psd:layer.x",message);
  (void) FormatLocaleString(message,4096,"%.20g",
    (double) layer_info->page.y);
  (void) SetImageArtifact(layer_info->image,"psd:layer.y",message);
  (void) FormatLocaleString(message,4096,"%.20g",(double)
    layer_info->opacity);
  ...
  {
    if (image->debug != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 1629,
  ...
  if ((status != MagickFalse) && (layer_info->mask.image != (Image *) 
# 1650 "coders/psd.c" 3 4
                                                                     ((void *)0)
# 1650 "coders/psd.c"
                                                                         ))
    {
      ...
      if ((layer_info->mask.flags & 0x02) == 0x02)
        ...
        status=ApplyPSDOpacityMask(layer_info->image,layer_info->mask.image,
          layer_info->mask.background == 0 ? 0 : ((Quantum) 65535.0),MagickFalse,
          exception);
      option=GetImageOption(image_info,"psd:preserve-opacity-mask");
...
# 1936 "coders/psd.c"
  ...
  if (number_layers < 0)
    {
      ...
      number_layers=((number_layers) < 0 ? -(number_layers) : (number_layers));
      if (image->debug != MagickFalse)
        (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 1947,
  ...
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 1959,
      "  image contains %.20g layers",(double) number_layers);

  if (number_layers == 0)
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1963,CorruptImageError,"InvalidNumberOfLayers", "`%s'",image->filename); return(MagickFalse); }
                      ;

  layer_info=(LayerInfo *) AcquireQuantumMemory((size_t) number_layers,
    sizeof(*layer_info));
  if (layer_info == (LayerInfo *) 
# 1968 "coders/psd.c" 3 4
                                 ((void *)0)
# 1968 "coders/psd.c"
                                     )
    {
      if (image->debug != MagickFalse)
        (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 1971,
          "  allocation of LayerInfo failed");
      { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1973,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  ...
  for (i=0; i < number_layers; i++)
  {
    ...
    if (image->debug != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 1987,
    ...
    if ((right < left) || (bottom < top))
      {
        ...
        { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 1996,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); return(MagickFalse); }
                          ;
      }
    ...
    if (layer_info[i].channels > 56)
      {
        layer_info=DestroyLayerInfo(layer_info,number_layers);
        { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2007,CorruptImageError,"MaximumChannelsExceeded", "`%s'",image->filename); return(MagickFalse); }
                          ;
      }
    if (image->debug != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2011,
    ...
    for (j=0; j < (ssize_t) layer_info[i].channels; j++)
    {
      ...
      layer_info[i].channel_info[j].size=(size_t) GetPSDSize(psd_info,
        image);
      if (image->debug != MagickFalse)
        (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2024,
    ...
    if (CheckPSDChannels(image,psd_info,&layer_info[i]) == MagickFalse)
      {
        layer_info=DestroyLayerInfo(layer_info,number_layers);
        { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2032,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); return(MagickFalse); }
                          ;
      }
    count=ReadPSDString(image,type,4);
    if ((count != 4) || (LocaleNCompare(type,"8BIM",4) != 0))
      {
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2039,
            "  layer type was %.4s instead of 8BIM", type);
        layer_info=DestroyLayerInfo(layer_info,number_layers);
        { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2042,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); return(MagickFalse); }
                          ;
      }
    ...
    if (count != 4)
      {
        layer_info=DestroyLayerInfo(layer_info,number_layers);
        { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2049,CorruptImageError,"ImproperImageHeader", "`%s'",image->filename); return(MagickFalse); }
                          ;
      }
    ...
    if (image->debug != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2058,
    ...
    if (size != 0)
      {
        ...
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2073,
        ...
        if (length != 0)
          {
            ...
            if (image->debug != MagickFalse)
              (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2099,
            ...
            if (DiscardBlobBytes(image,(MagickSizeType) (length-18)) == MagickFalse)
              {
                layer_info=DestroyLayerInfo(layer_info,number_layers);
                { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2112,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image->filename); return(MagickFalse); }
                                                        ;
              }
          }
        length=ReadBlobLong(image);
        ...
        if (length != 0)
          {
            ...
            if (image->debug != MagickFalse)
              (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2124,
                "      layer blending ranges: length=%.20g",(double)
                ((MagickOffsetType) length));
            if (DiscardBlobBytes(image,length) == MagickFalse)
              {
                layer_info=DestroyLayerInfo(layer_info,number_layers);
                { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2130,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image->filename); return(MagickFalse); }
                                                        ;
              }
          }
        ...
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2143,
        ...
        if ((length % 4) != 0)
          {
            ...
            if (DiscardBlobBytes(image,length) == MagickFalse)
              {
                layer_info=DestroyLayerInfo(layer_info,number_layers);
                { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2153,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image->filename); return(MagickFalse); }
                                                        ;
              }
          }
        ...
        if (length > 0)
          {
            ...
            if (length > GetBlobSize(image))
              {
                layer_info=DestroyLayerInfo(layer_info,number_layers);
                { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2166,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image->filename); return(MagickFalse); }
                                                                ;
              }
  ...
  for (i=0; i < number_layers; i++)
  {
    if (IsEmptyPSDLayer(&layer_info[i]) != MagickFalse)
      {
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2182,
            "      layer data is empty");
        if (layer_info[i].info != (StringInfo *) 
# 2184 "coders/psd.c" 3 4
                                                ((void *)0)
# 2184 "coders/psd.c"
                                                    )
          layer_info[i].info=DestroyStringInfo(layer_info[i].info);
...
# 2194 "coders/psd.c"
                                            )
      {
        layer_info=DestroyLayerInfo(layer_info,number_layers);
        if (image->debug != MagickFalse)
          (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2198,
            "  allocation of image for layer %.20g failed",(double) i);
        { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2200,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                          ;
      }
    for (j=0; j < (ssize_t) layer_info[i].channels; j++)
    {
...
# 2227 "coders/psd.c"
        ...
        (PSDSkipImage(psd_info, image_info,(size_t) ++index) != MagickFalse))
      {
        for (j=0; j < (ssize_t) layer_info[i].channels; j++)
        {
          if (DiscardBlobBytes(image,(MagickSizeType)
            ...
            {
              layer_info=DestroyLayerInfo(layer_info,number_layers);
              { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2236,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image->filename); return(MagickFalse); }
                                                      ;
            }
        }
        continue;
    ...
    if (image->debug != MagickFalse)
      (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2244,
    ...
    status=SetImageProgress(image,"Load/Images",(MagickOffsetType) i,
...
__attribute__ ((visibility ("default"))) MagickBooleanType ReadPSDLayers(Image *image,
  ...
  Image *image,const PSDInfo *psd_info,ExceptionInfo *exception)
{
  ...
  if (compression != Raw && compression != RLE)
    {
      (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2301,
        TypeWarning,"CompressionNotSupported","'%.20g'",(double) compression);
      return(MagickFalse);
    }

  sizes=(MagickOffsetType *) 
# 2306 "coders/psd.c" 3 4
                            ((void *)0)
# 2306 "coders/psd.c"
                                ;
  if (compression == RLE)
    {
      ...
      if (sizes == (MagickOffsetType *) 
# 2310 "coders/psd.c" 3 4
                                       ((void *)0)
# 2310 "coders/psd.c"
                                           )
        { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2311,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                          ;
    }
  ...
  for (i=0; i < (ssize_t) psd_info->channels; i++)
  {
    ...
    if (status == MagickFalse)
      {
        (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2325,
...
# 2390 "coders/psd.c" 3 4
 , "coders/psd.c", 2390, __extension__ __PRETTY_FUNCTION__); }))
# 2390 "coders/psd.c"
                                               ;
  
# 2391 "coders/psd.c" 3 4
 ((void) sizeof ((
# 2391 "coders/psd.c"
...
# 2391 "coders/psd.c" 3 4
 , "coders/psd.c", 2391, __extension__ __PRETTY_FUNCTION__); }))
# 2391 "coders/psd.c"
                                                     ;
  
# 2392 "coders/psd.c" 3 4
 ((void) sizeof ((
# 2392 "coders/psd.c"
...
# 2392 "coders/psd.c" 3 4
 , "coders/psd.c", 2392, __extension__ __PRETTY_FUNCTION__); }))
# 2392 "coders/psd.c"
                                            ;
  
# 2393 "coders/psd.c" 3 4
 ((void) sizeof ((
# 2393 "coders/psd.c"
...
# 2393 "coders/psd.c" 3 4
 , "coders/psd.c", 2393, __extension__ __PRETTY_FUNCTION__); }))
# 2393 "coders/psd.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/psd.c",__func__,(unsigned long) 2395,"%s",
      image_info->filename);
...
# 2402 "coders/psd.c"
  ...
  if ((count != 4) || (LocaleNCompare(psd_info.signature,"8BPS",4) != 0) ||
    ...
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2412,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2412 "coders/psd.c" 3 4
   ((void *)0)
# 2412 "coders/psd.c"
...
# 2412 "coders/psd.c"
  ...
  if (psd_info.channels < 1)
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2416,CorruptImageError,"MissingImageChannel", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2416 "coders/psd.c" 3 4
   ((void *)0)
# 2416 "coders/psd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2416 "coders/psd.c" 3 4
...
# 2416 "coders/psd.c"
  ...
  if (psd_info.channels > 56)
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2418,CorruptImageError,"MaximumChannelsExceeded", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2418 "coders/psd.c" 3 4
   ((void *)0)
# 2418 "coders/psd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2418 "coders/psd.c" 3 4
...
# 2418 "coders/psd.c"
  ...
  if ((psd_info.version == 1) && ((psd_info.rows > 30000) ||
    ...
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2423,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2423 "coders/psd.c" 3 4
   ((void *)0)
# 2423 "coders/psd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2423 "coders/psd.c" 3 4
...
# 2423 "coders/psd.c"
  ...
  if ((psd_info.depth != 1) && (psd_info.depth != 8) &&
    ...
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2427,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2427 "coders/psd.c" 3 4
   ((void *)0)
# 2427 "coders/psd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2427 "coders/psd.c" 3 4
...
# 2427 "coders/psd.c"
  ...
  if ((psd_info.mode == IndexedMode) && (psd_info.channels > 3))
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2430,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2430 "coders/psd.c" 3 4
   ((void *)0)
# 2430 "coders/psd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2430 "coders/psd.c" 3 4
...
# 2430 "coders/psd.c"
  ...
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2432,
      "  Image is %.20g x %.20g with channels=%.20g, depth=%.20g, mode=%s",
      (double) psd_info.columns,(double) psd_info.rows,(double)
      psd_info.channels,(double) psd_info.depth,ModeToString((PSDImageType)
      psd_info.mode));
  if (EOFBlob(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2438,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2438 "coders/psd.c" 3 4
   ((void *)0)
# 2438 "coders/psd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2438 "coders/psd.c" 3 4
  ...
  switch (psd_info.mode)
  {
    ...
    case DuotoneMode:
    {
      if (psd_info.depth != 32)
        {
          status=AcquireImageColormap(image,((((size_t) (psd_info.depth < 16 ? 256 : 65536)) < (65536UL)) ? ((size_t) (psd_info.depth < 16 ? 256 : 65536)) : (65536UL))
                                                                 ,exception);
          if (status == MagickFalse)
            { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2474,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2474 "coders/psd.c" 3 4
           ((void *)0)
# 2474 "coders/psd.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2474 "coders/psd.c" 3 4
...
# 2474 "coders/psd.c"
          ...
          if (image->debug != MagickFalse)
            (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2476,
  ...
  if (psd_info.channels < psd_info.min_channels)
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2499,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2499 "coders/psd.c" 3 4
   ((void *)0)
# 2499 "coders/psd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2499 "coders/psd.c" 3 4
...
# 2499 "coders/psd.c"
  ...
  if ((psd_info.mode == IndexedMode) && (length < 3))
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2505,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2505 "coders/psd.c" 3 4
   ((void *)0)
# 2505 "coders/psd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2505 "coders/psd.c" 3 4
...
# 2505 "coders/psd.c"
  ...
  if (length != 0)
    {
      if (image->debug != MagickFalse)
        (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2509,
          "  reading colormap");
      if ((psd_info.mode == DuotoneMode) || (psd_info.depth == 32))
        {
          ...
          (void) SeekBlob(image,(MagickOffsetType) length,
# 2517 "coders/psd.c" 3 4
                                                         1
# 2517 "coders/psd.c"
                                                                 );
        }
      else
        {
          ...
          if (number_colors > 65536)
            { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2529,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2529 "coders/psd.c" 3 4
           ((void *)0)
# 2529 "coders/psd.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2529 "coders/psd.c" 3 4
...
# 2529 "coders/psd.c"
          ...
          if (AcquireImageColormap(image,number_colors,exception) == MagickFalse)
            { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2531,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2531 "coders/psd.c" 3 4
           ((void *)0)
# 2531 "coders/psd.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2531 "coders/psd.c" 3 4
...
# 2531 "coders/psd.c"
  ...
  if ((image->depth == 1) && (image->storage_class != PseudoClass))
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2545,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2545 "coders/psd.c" 3 4
   ((void *)0)
# 2545 "coders/psd.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2545 "coders/psd.c" 3 4
  ...
  if (length != 0)
    {
      ...
      if (image->debug != MagickFalse)
        (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2558,
          "  reading image resource blocks - %.20g bytes",(double)
          ((MagickOffsetType) length));
      if (length > GetBlobSize(image))
        { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2562,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2562 "coders/psd.c" 3 4
       ((void *)0)
# 2562 "coders/psd.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2562 "coders/psd.c" 3 4
...
# 2562 "coders/psd.c"
      ...
      blocks=(unsigned char *) AcquireQuantumMemory((size_t) length,
        sizeof(*blocks));
      if (blocks == (unsigned char *) 
# 2565 "coders/psd.c" 3 4
                                     ((void *)0)
# 2565 "coders/psd.c"
                                         )
        { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2566,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2566 "coders/psd.c" 3 4
       ((void *)0)
# 2566 "coders/psd.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2566 "coders/psd.c" 3 4
...
# 2566 "coders/psd.c"
      ...
      if ((count != (ssize_t) length) || (length < 4) ||
          (LocaleNCompare((char *) blocks,"8BIM",4) != 0))
        {
          ...
          { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2572,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2572 "coders/psd.c" 3 4
         ((void *)0)
# 2572 "coders/psd.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2572 "coders/psd.c" 3 4
...
# 2572 "coders/psd.c"
  ...
  if ((image_info->number_scenes == 1) && (image_info->scene == 0) &&
    ...
    {
      if (image->debug != MagickFalse)
        (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2592,
          "  read composite only");
  ...
  if (length == 0)
    {
      if (image->debug != MagickFalse)
        (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2599,
          "  image has no layers");
    }
  else
    {
...
# 2610 "coders/psd.c"
      ...
      (void) SeekBlob(image,offset+(MagickOffsetType) length,
# 2616 "coders/psd.c" 3 4
                                                            0
# 2616 "coders/psd.c"
                                                                    );
    }
  ...
  if (EOFBlob(image) != MagickFalse)
    {
      if (profile != (StringInfo *) 
# 2623 "coders/psd.c" 3 4
                                   ((void *)0)
# 2623 "coders/psd.c"
                                       )
        profile=DestroyStringInfo(profile);
      { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2625,CorruptImageError,"UnexpectedEndOfFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2625 "coders/psd.c" 3 4
     ((void *)0)
# 2625 "coders/psd.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2625 "coders/psd.c" 3 4
...
# 2629 "coders/psd.c"
  ...
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(CoderEvent,"coders/psd.c",__func__,(unsigned long) 2638,
  ...
  if ((psd_info.has_merged_image == MagickFalse) && (image_list_length == 1) &&
      (length != 0))
    {
      (void) SeekBlob(image,offset,
# 2647 "coders/psd.c" 3 4
                                  0
# 2647 "coders/psd.c"
                                          );
  ...
  if (psd_info.has_merged_image == MagickFalse)
    {
      ...
      if (image_list_length == 1)
        {
          if (profile != (StringInfo *) 
# 2667 "coders/psd.c" 3 4
                                       ((void *)0)
# 2667 "coders/psd.c"
                                           )
            profile=DestroyStringInfo(profile);
          { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2669,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 2669 "coders/psd.c" 3 4
         ((void *)0)
# 2669 "coders/psd.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 2669 "coders/psd.c" 3 4
...
# 2669 "coders/psd.c"
      ...
      image->background_color.alpha=(MagickRealType) ((Quantum) 0);
      image->background_color.alpha_trait=BlendPixelTrait;
      (void) SetImageBackgroundColor(image,exception);
      merged=MergeImageLayers(image,FlattenLayer,exception);
      if (merged == (Image *) 
# 2675 "coders/psd.c" 3 4
                             ((void *)0)
# 2675 "coders/psd.c"
                                 )
        {
          if (profile != (StringInfo *) 
# 2677 "coders/psd.c" 3 4
                                       ((void *)0)
# 2677 "coders/psd.c"
                                           )
            profile=DestroyStringInfo(profile);
...
# 2743 "coders/psd.c"
__attribute__ ((visibility ("default"))) size_t RegisterPSDImage(void)
{
  MagickInfo
    *entry;
...
# 2784 "coders/psd.c"
__attribute__ ((visibility ("default"))) void UnregisterPSDImage(void)
{
...
# 2836 "coders/psd.c"
  ...
  (void) SeekBlob(image,current_offset,
# 2841 "coders/psd.c" 3 4
                                      0
# 2841 "coders/psd.c"
                                              );
  return(result);
  ...
  const MagickSizeType size,const MagickOffsetType offset)
{
  ...
  current_offset=TellBlob(image);
  (void) SeekBlob(image,offset,
# 2863 "coders/psd.c" 3 4
                              0
# 2863 "coders/psd.c"
                                      );
  result=SetPSDSize(psd_info,image,size);
  (void) SeekBlob(image,current_offset,
# 2865 "coders/psd.c" 3 4
                                      0
# 2865 "coders/psd.c"
                                              );
  return(result);
...
# 2889 "coders/psd.c"
 "image != (Image *) NULL"
# 2889 "coders/psd.c" 3 4
 , "coders/psd.c", 2889, __extension__ __PRETTY_FUNCTION__); }))
# 2889 "coders/psd.c"
                                ;
  
# 2890 "coders/psd.c" 3 4
 ((void) sizeof ((
# 2890 "coders/psd.c"
...
# 2890 "coders/psd.c" 3 4
 , "coders/psd.c", 2890, __extension__ __PRETTY_FUNCTION__); }))
# 2890 "coders/psd.c"
                                                ;
  
# 2891 "coders/psd.c" 3 4
 ((void) sizeof ((
# 2891 "coders/psd.c"
...
# 2891 "coders/psd.c" 3 4
 , "coders/psd.c", 2891, __extension__ __PRETTY_FUNCTION__); }))
# 2891 "coders/psd.c"
                                         ;
  
# 2892 "coders/psd.c" 3 4
 ((void) sizeof ((
# 2892 "coders/psd.c"
...
# 2892 "coders/psd.c" 3 4
 , "coders/psd.c", 2892, __extension__ __PRETTY_FUNCTION__); }))
# 2892 "coders/psd.c"
                                                 ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/psd.c",__func__,(unsigned long) 2894,"%s",image->filename);
  packbits=(unsigned char *) AcquireQuantumMemory(128UL,sizeof(*packbits));
  if (packbits == (unsigned char *) 
# 2896 "coders/psd.c" 3 4
                                   ((void *)0)
# 2896 "coders/psd.c"
                                       )
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 2897,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  q=compact_pixels;
...
# 3045 "coders/psd.c" 3 4
                                     ((void *)0)
# 3045 "coders/psd.c"
                                         ;
  flush=
# 3046 "coders/psd.c" 3 4
       0
# 3046 "coders/psd.c"
                 ;
  ...
  if (compression == ZipCompression)
    {
      compressed_pixels=(unsigned char *) AcquireQuantumMemory(
        16384,sizeof(*compressed_pixels));
      if (compressed_pixels == (unsigned char *) 
# 3068 "coders/psd.c" 3 4
                                                ((void *)0)
# 3068 "coders/psd.c"
                                                    )
        {
      ...
      memset(&stream,0,sizeof(stream));
      stream.data_type=
# 3074 "coders/psd.c" 3 4
                      0
# 3074 "coders/psd.c"
                              ;
      level=
# 3075 "coders/psd.c" 3 4
           (-1)
# 3075 "coders/psd.c"
                                ;
...
# 3078 "coders/psd.c"
  ...
  for (y=0; y < (ssize_t) next_image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 3090 "coders/psd.c" 3 4
                              ((void *)0)
# 3090 "coders/psd.c"
                                  )
      break;
    length=ExportQuantumPixels(next_image,(CacheView *) 
# 3092 "coders/psd.c" 3 4
                                                       ((void *)0)
# 3092 "coders/psd.c"
                                                           ,quantum_info,
...
# 3110 "coders/psd.c"
        ...
        do {
            ...
            if (deflate(&stream,flush) == 
# 3114 "coders/psd.c" 3 4
                                         (-2)
# 3114 "coders/psd.c"
                                                       )
              break;
            length=(size_t) 16384 -stream.avail_out;
            if (length > 0)
  ...
  ExceptionInfo *exception)
{
  ...
  if (compact_pixels == (unsigned char *) 
# 3149 "coders/psd.c" 3 4
                                         ((void *)0)
# 3149 "coders/psd.c"
                                             )
    {
      (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 3151,
  ...
  Image *image,ExceptionInfo *exception)
{
  ...
  if (info == (const StringInfo *) 
# 3553 "coders/psd.c" 3 4
                                  ((void *)0)
# 3553 "coders/psd.c"
                                      )
    return((const StringInfo *) 
# 3554 "coders/psd.c" 3 4
                               ((void *)0)
# 3554 "coders/psd.c"
                                   );
...
# 3646 "coders/psd.c"
 "image != (Image *) NULL"
# 3646 "coders/psd.c" 3 4
 , "coders/psd.c", 3646, __extension__ __PRETTY_FUNCTION__); }))
# 3646 "coders/psd.c"
                                ;
  status=MagickTrue;
  base_image=GetNextImageInList(image);
  if (base_image == (Image *) 
# 3649 "coders/psd.c" 3 4
                             ((void *)0)
# 3649 "coders/psd.c"
                                 )
    base_image=image;
  ...
  layer_count=0;
  for (next_image=base_image; next_image != 
# 3655 "coders/psd.c" 3 4
                                           ((void *)0)
# 3655 "coders/psd.c"
                                               ; )
  {
...
# 3666 "coders/psd.c" 3 4
                                                ((void *)0)
# 3666 "coders/psd.c"
                                                    )
    { (void) ThrowMagickException(exception,"coders/psd.c",__func__,(unsigned long) 3667,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 3667 "coders/psd.c" 3 4
   ((void *)0)
# 3667 "coders/psd.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  layer_index=0;
  for (next_image=base_image; next_image != 
# 3669 "coders/psd.c" 3 4
                                           ((void *)0)
# 3669 "coders/psd.c"
                                               ; )
  {
...
# 3718 "coders/psd.c"
    ...
    size+=(size_t) WriteBlobByte(image,(unsigned char) (next_image->compose ==
      NoCompositeOp ? 1 << 0x02 : 1));
    size+=(size_t) WriteBlobByte(image,0);
    info=GetAdditionalInformation(image_info,next_image,exception);
    property=(const char *) GetImageProperty(next_image,"label",exception);
    if (property == (const char *) 
# 3735 "coders/psd.c" 3 4
                                  ((void *)0)
# 3735 "coders/psd.c"
                                      )
      {
        (void) FormatLocaleString(layer_name,4096,"L%.20g",
          (double) layer_index);
        property=layer_name;
      }
...
# 3783 "coders/psd.c"
  ...
  if (layers_size != (size_t*) 
# 3798 "coders/psd.c" 3 4
                              ((void *)0)
# 3798 "coders/psd.c"
                                  )
    *layers_size=size;
...
__attribute__ ((visibility ("default"))) MagickBooleanType WritePSDLayers(Image * image,
  const ImageInfo *image_info,const PSDInfo *psd_info,ExceptionInfo *exception)
{
  MagickBooleanType
    status;
  ...
  if (status == MagickFalse)
    return(MagickTrue);
  return WritePSDLayersInternal(image,image_info,psd_info,(size_t*) 
# 3830 "coders/psd.c" 3 4
                                                                   ((void *)0)
# 3830 "coders/psd.c"
                                                                       ,
    exception);
...
# 3859 "coders/psd.c"
 "image_info != (const ImageInfo *) NULL"
# 3859 "coders/psd.c" 3 4
 , "coders/psd.c", 3859, __extension__ __PRETTY_FUNCTION__); }))
# 3859 "coders/psd.c"
                                               ;
  
# 3860 "coders/psd.c" 3 4
 ((void) sizeof ((
# 3860 "coders/psd.c"
 image_info->signature == 0xabacadabUL
# 3860 "coders/psd.c" 3 4
...
# 3860 "coders/psd.c"
 "image_info->signature == MagickCoreSignature"
# 3860 "coders/psd.c" 3 4
 , "coders/psd.c", 3860, __extension__ __PRETTY_FUNCTION__); }))
# 3860 "coders/psd.c"
                                                     ;
  
# 3861 "coders/psd.c" 3 4
 ((void) sizeof ((
# 3861 "coders/psd.c"
 image != (Image *) 
# 3861 "coders/psd.c" 3 4
...
# 3861 "coders/psd.c"
 "image != (Image *) NULL"
# 3861 "coders/psd.c" 3 4
 , "coders/psd.c", 3861, __extension__ __PRETTY_FUNCTION__); }))
# 3861 "coders/psd.c"
                                ;
  
# 3862 "coders/psd.c" 3 4
 ((void) sizeof ((
# 3862 "coders/psd.c"
 image->signature == 0xabacadabUL
# 3862 "coders/psd.c" 3 4
...
# 3862 "coders/psd.c"
 "image->signature == MagickCoreSignature"
# 3862 "coders/psd.c" 3 4
 , "coders/psd.c", 3862, __extension__ __PRETTY_FUNCTION__); }))
# 3862 "coders/psd.c"
                                                ;
  
# 3863 "coders/psd.c" 3 4
 ((void) sizeof ((
# 3863 "coders/psd.c"
 exception != (ExceptionInfo *) 
# 3863 "coders/psd.c" 3 4
...
# 3863 "coders/psd.c"
 "exception != (ExceptionInfo *) NULL"
# 3863 "coders/psd.c" 3 4
 , "coders/psd.c", 3863, __extension__ __PRETTY_FUNCTION__); }))
# 3863 "coders/psd.c"
                                            ;
  
# 3864 "coders/psd.c" 3 4
 ((void) sizeof ((
# 3864 "coders/psd.c"
 exception->signature == 0xabacadabUL
# 3864 "coders/psd.c" 3 4
...
# 3864 "coders/psd.c"
 "exception->signature == MagickCoreSignature"
# 3864 "coders/psd.c" 3 4
 , "coders/psd.c", 3864, __extension__ __PRETTY_FUNCTION__); }))
# 3864 "coders/psd.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/psd.c",__func__,(unsigned long) 3866,"%s",image->filename);
  ...
  if ((GetImageProfile(image,"icc") == (StringInfo *) 
# 3878 "coders/psd.c" 3 4
                                                     ((void *)0)
# 3878 "coders/psd.c"
                                                         ) &&
  ...
  if (bim_profile != (StringInfo *) 
# 3964 "coders/psd.c" 3 4
                                   ((void *)0)
# 3964 "coders/psd.c"
                                       )
    {
      bim_profile=CloneStringInfo(bim_profile);
      if (icc_profile != (StringInfo *) 
# 3967 "coders/psd.c" 3 4
                                       ((void *)0)
# 3967 "coders/psd.c"
                                           )
        RemoveICCProfileFromResourceBlock(bim_profile);
      RemoveResolutionFromResourceBlock(bim_profile);
      length+=(size_t) (((ssize_t) (GetStringInfoLength(bim_profile))+1) & -2);
    }
  if (icc_profile != (const StringInfo *) 
# 3972 "coders/psd.c" 3 4
                                         ((void *)0)
# 3972 "coders/psd.c"
                                             )
    length+=(size_t) (((ssize_t) (GetStringInfoLength(icc_profile))+1) & -2)+12;
...
# 3985 "coders/psd.c"
                                       )
    {
      ...
      if ((ssize_t) GetStringInfoLength(icc_profile) != (((ssize_t) (GetStringInfoLength(icc_profile))+1) & -2))
        (void) WriteBlobByte(image,0);
    }
  if (status != MagickFalse)
    {
