...
# 122 "coders/art.c" 3 4
 , "coders/art.c", 122, __extension__ __PRETTY_FUNCTION__); }))
# 122 "coders/art.c"
                                               ;
  
# 123 "coders/art.c" 3 4
 ((void) sizeof ((
# 123 "coders/art.c"
...
# 123 "coders/art.c" 3 4
 , "coders/art.c", 123, __extension__ __PRETTY_FUNCTION__); }))
# 123 "coders/art.c"
                                                     ;
  
# 124 "coders/art.c" 3 4
 ((void) sizeof ((
# 124 "coders/art.c"
...
# 124 "coders/art.c" 3 4
 , "coders/art.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "coders/art.c"
                                            ;
  
# 125 "coders/art.c" 3 4
 ((void) sizeof ((
# 125 "coders/art.c"
...
# 125 "coders/art.c" 3 4
 , "coders/art.c", 125, __extension__ __PRETTY_FUNCTION__); }))
# 125 "coders/art.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/art.c",__func__,(unsigned long) 127,"%s",
      image_info->filename);
...
# 134 "coders/art.c"
  ...
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/art.c",__func__,(unsigned long) 143,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 143 "coders/art.c" 3 4
   ((void *)0)
# 143 "coders/art.c"
...
# 157 "coders/art.c" 3 4
                                     ((void *)0)
# 157 "coders/art.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/art.c",__func__,(unsigned long) 158,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 158 "coders/art.c" 3 4
   ((void *)0)
# 158 "coders/art.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 158 "coders/art.c" 3 4
...
# 175 "coders/art.c"
  ...
  if (y < (ssize_t) image->rows)
    { (void) ThrowMagickException(exception,"coders/art.c",__func__,(unsigned long) 187,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 187 "coders/art.c" 3 4
   ((void *)0)
# 187 "coders/art.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 187 "coders/art.c" 3 4
...
# 189 "coders/art.c" 3 4
   (*__errno_location ())
# 189 "coders/art.c"
   ); (void) ThrowMagickException(exception,"coders/art.c",__func__,(unsigned long) 189,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 221 "coders/art.c"
__attribute__ ((visibility ("default"))) size_t RegisterARTImage(void)
{
  MagickInfo
    *entry;
...
# 254 "coders/art.c"
__attribute__ ((visibility ("default"))) void UnregisterARTImage(void)
{
...
# 311 "coders/art.c"
 "image_info != (const ImageInfo *) NULL"
# 311 "coders/art.c" 3 4
 , "coders/art.c", 311, __extension__ __PRETTY_FUNCTION__); }))
# 311 "coders/art.c"
                                               ;
  
# 312 "coders/art.c" 3 4
 ((void) sizeof ((
# 312 "coders/art.c"
 image_info->signature == 0xabacadabUL
# 312 "coders/art.c" 3 4
...
# 312 "coders/art.c"
 "image_info->signature == MagickCoreSignature"
# 312 "coders/art.c" 3 4
 , "coders/art.c", 312, __extension__ __PRETTY_FUNCTION__); }))
# 312 "coders/art.c"
                                                     ;
  
# 313 "coders/art.c" 3 4
 ((void) sizeof ((
# 313 "coders/art.c"
 image != (Image *) 
# 313 "coders/art.c" 3 4
...
# 313 "coders/art.c"
 "image != (Image *) NULL"
# 313 "coders/art.c" 3 4
 , "coders/art.c", 313, __extension__ __PRETTY_FUNCTION__); }))
# 313 "coders/art.c"
                                ;
  
# 314 "coders/art.c" 3 4
 ((void) sizeof ((
# 314 "coders/art.c"
...
# 314 "coders/art.c" 3 4
 , "coders/art.c", 314, __extension__ __PRETTY_FUNCTION__); }))
# 314 "coders/art.c"
                                                ;
  
# 315 "coders/art.c" 3 4
 ((void) sizeof ((
# 315 "coders/art.c"
 exception != (ExceptionInfo *) 
# 315 "coders/art.c" 3 4
...
# 315 "coders/art.c"
 "exception != (ExceptionInfo *) NULL"
# 315 "coders/art.c" 3 4
 , "coders/art.c", 315, __extension__ __PRETTY_FUNCTION__); }))
# 315 "coders/art.c"
                                            ;
  
# 316 "coders/art.c" 3 4
 ((void) sizeof ((
# 316 "coders/art.c"
 exception->signature == 0xabacadabUL
# 316 "coders/art.c" 3 4
...
# 316 "coders/art.c"
 "exception->signature == MagickCoreSignature"
# 316 "coders/art.c" 3 4
 , "coders/art.c", 316, __extension__ __PRETTY_FUNCTION__); }))
# 316 "coders/art.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/art.c",__func__,(unsigned long) 318,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  if ((image->columns > 65535UL) || (image->rows > 65535UL))
    { (void) ThrowMagickException(exception,"coders/art.c",__func__,(unsigned long) 323,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 323 "coders/art.c" 3 4
   ((void *)0)
# 323 "coders/art.c"
  ...
  quantum_info=AcquireQuantumInfo(image_info,image);
  if (quantum_info == (QuantumInfo *) 
# 334 "coders/art.c" 3 4
                                     ((void *)0)
# 334 "coders/art.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/art.c",__func__,(unsigned long) 335,ImageError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 335 "coders/art.c" 3 4
   ((void *)0)
# 335 "coders/art.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
...
# 342 "coders/art.c"
  ...
  quantum_info=DestroyQuantumInfo(quantum_info);
  if (y < (ssize_t) image->rows)
    { (void) ThrowMagickException(exception,"coders/art.c",__func__,(unsigned long) 355,CorruptImageError,"UnableToWriteImageData", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 355 "coders/art.c" 3 4
   ((void *)0)
# 355 "coders/art.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  if (CloseBlob(image) == MagickFalse)
