...
# 137 "coders/ycbcr.c" 3 4
 , "coders/ycbcr.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "coders/ycbcr.c"
                                               ;
  
# 138 "coders/ycbcr.c" 3 4
 ((void) sizeof ((
# 138 "coders/ycbcr.c"
...
# 138 "coders/ycbcr.c" 3 4
 , "coders/ycbcr.c", 138, __extension__ __PRETTY_FUNCTION__); }))
# 138 "coders/ycbcr.c"
                                                     ;
  
# 139 "coders/ycbcr.c" 3 4
 ((void) sizeof ((
# 139 "coders/ycbcr.c"
...
# 139 "coders/ycbcr.c" 3 4
 , "coders/ycbcr.c", 139, __extension__ __PRETTY_FUNCTION__); }))
# 139 "coders/ycbcr.c"
                                            ;
  
# 140 "coders/ycbcr.c" 3 4
 ((void) sizeof ((
# 140 "coders/ycbcr.c"
...
# 140 "coders/ycbcr.c" 3 4
 , "coders/ycbcr.c", 140, __extension__ __PRETTY_FUNCTION__); }))
# 140 "coders/ycbcr.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ycbcr.c",__func__,(unsigned long) 142,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 146,OptionError,"MustSpecifyImageSize", "`%s'",image_info->filename); if ((image) != (Image *) 
# 146 "coders/ycbcr.c" 3 4
   ((void *)0)
# 146 "coders/ycbcr.c"
...
# 160 "coders/ycbcr.c" 3 4
       (*__errno_location ())
# 160 "coders/ycbcr.c"
       ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 160,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
    }
...
# 168 "coders/ycbcr.c" 3 4
                               ((void *)0)
# 168 "coders/ycbcr.c"
                                   )
    { (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 169,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 169 "coders/ycbcr.c" 3 4
   ((void *)0)
# 169 "coders/ycbcr.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 169 "coders/ycbcr.c" 3 4
...
# 173 "coders/ycbcr.c" 3 4
                                     ((void *)0)
# 173 "coders/ycbcr.c"
                                         )
    {
      canvas_image=DestroyImage(canvas_image);
      { (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 176,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 176 "coders/ycbcr.c" 3 4
     ((void *)0)
# 176 "coders/ycbcr.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 176 "coders/ycbcr.c" 3 4
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 246 "coders/ycbcr.c" 3 4
             (*__errno_location ())
# 246 "coders/ycbcr.c"
             ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 246,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
            ...
            if (count != (ssize_t) length)
              {
                status=MagickFalse;
                { char *file_message; file_message=GetExceptionMessage(
# 327 "coders/ycbcr.c" 3 4
               (*__errno_location ())
# 327 "coders/ycbcr.c"
               ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 327,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                        ;
                break;
              }
            ...
            q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
              exception);
            if (q == (Quantum *) 
# 334 "coders/ycbcr.c" 3 4
                                ((void *)0)
# 334 "coders/ycbcr.c"
                                    )
              break;
            length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 336 "coders/ycbcr.c" 3 4
                                                                 ((void *)0)
# 336 "coders/ycbcr.c"
                                                                     ,
              quantum_info,quantum_type,(unsigned char *) stream,exception);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 418 "coders/ycbcr.c" 3 4
             (*__errno_location ())
# 418 "coders/ycbcr.c"
             ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 418,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 424 "coders/ycbcr.c" 3 4
                              ((void *)0)
# 424 "coders/ycbcr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 426 "coders/ycbcr.c" 3 4
                                                               ((void *)0)
# 426 "coders/ycbcr.c"
                                                                   ,
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 470 "coders/ycbcr.c" 3 4
             (*__errno_location ())
# 470 "coders/ycbcr.c"
             ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 470,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 476 "coders/ycbcr.c" 3 4
                              ((void *)0)
# 476 "coders/ycbcr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 478 "coders/ycbcr.c" 3 4
                                                               ((void *)0)
# 478 "coders/ycbcr.c"
                                                                   ,
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 522 "coders/ycbcr.c" 3 4
             (*__errno_location ())
# 522 "coders/ycbcr.c"
             ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 522,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 528 "coders/ycbcr.c" 3 4
                              ((void *)0)
# 528 "coders/ycbcr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 530 "coders/ycbcr.c" 3 4
                                                               ((void *)0)
# 530 "coders/ycbcr.c"
                                                                   ,
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 576 "coders/ycbcr.c" 3 4
                 (*__errno_location ())
# 576 "coders/ycbcr.c"
                 ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 576,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
              q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
                exception);
              if (q == (Quantum *) 
# 582 "coders/ycbcr.c" 3 4
                                  ((void *)0)
# 582 "coders/ycbcr.c"
                                      )
                break;
              length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 584 "coders/ycbcr.c" 3 4
                                                                   ((void *)0)
# 584 "coders/ycbcr.c"
                                                                       ,
        ...
        if (DiscardBlobBytes(image,(MagickSizeType) image->offset) == MagickFalse)
          {
            status=MagickFalse;
            { char *file_message; file_message=GetExceptionMessage(
# 635 "coders/ycbcr.c" 3 4
           (*__errno_location ())
# 635 "coders/ycbcr.c"
           ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 635,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                    ;
            break;
          }
        length=GetQuantumExtent(canvas_image,quantum_info,RedQuantum);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 666 "coders/ycbcr.c" 3 4
             (*__errno_location ())
# 666 "coders/ycbcr.c"
             ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 666,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 672 "coders/ycbcr.c" 3 4
                              ((void *)0)
# 672 "coders/ycbcr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 674 "coders/ycbcr.c" 3 4
                                                               ((void *)0)
# 674 "coders/ycbcr.c"
                                                                   ,
            quantum_info,RedQuantum,(unsigned char *) stream,exception);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 737 "coders/ycbcr.c" 3 4
             (*__errno_location ())
# 737 "coders/ycbcr.c"
             ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 737,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 743 "coders/ycbcr.c" 3 4
                              ((void *)0)
# 743 "coders/ycbcr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 745 "coders/ycbcr.c" 3 4
                                                               ((void *)0)
# 745 "coders/ycbcr.c"
                                                                   ,
            quantum_info,GreenQuantum,(unsigned char *) stream,exception);
          ...
          if (count != (ssize_t) length)
            {
              status=MagickFalse;
              { char *file_message; file_message=GetExceptionMessage(
# 808 "coders/ycbcr.c" 3 4
             (*__errno_location ())
# 808 "coders/ycbcr.c"
             ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 808,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                      ;
              break;
            }
          q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
            exception);
          if (q == (Quantum *) 
# 814 "coders/ycbcr.c" 3 4
                              ((void *)0)
# 814 "coders/ycbcr.c"
                                  )
            break;
          length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 816 "coders/ycbcr.c" 3 4
                                                               ((void *)0)
# 816 "coders/ycbcr.c"
                                                                   ,
            quantum_info,BlueQuantum,(unsigned char *) stream,exception);
              ...
              if (count != (ssize_t) length)
                {
                  status=MagickFalse;
                  { char *file_message; file_message=GetExceptionMessage(
# 882 "coders/ycbcr.c" 3 4
                 (*__errno_location ())
# 882 "coders/ycbcr.c"
                 ); (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 882,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                                                          ;
                  break;
                }
              q=GetAuthenticPixels(canvas_image,0,0,canvas_image->columns,1,
                exception);
              if (q == (Quantum *) 
# 888 "coders/ycbcr.c" 3 4
                                  ((void *)0)
# 888 "coders/ycbcr.c"
                                      )
                break;
              length=ImportQuantumPixels(canvas_image,(CacheView *) 
# 890 "coders/ycbcr.c" 3 4
                                                                   ((void *)0)
# 890 "coders/ycbcr.c"
                                                                       ,
                quantum_info,BlueQuantum,(unsigned char *) stream,exception);
...
# 990 "coders/ycbcr.c"
__attribute__ ((visibility ("default"))) size_t RegisterYCBCRImage(void)
{
  MagickInfo
    *entry;
...
# 1029 "coders/ycbcr.c"
__attribute__ ((visibility ("default"))) void UnregisterYCBCRImage(void)
{
...
# 1095 "coders/ycbcr.c"
 "image_info != (const ImageInfo *) NULL"
# 1095 "coders/ycbcr.c" 3 4
 , "coders/ycbcr.c", 1095, __extension__ __PRETTY_FUNCTION__); }))
# 1095 "coders/ycbcr.c"
                                               ;
  
# 1096 "coders/ycbcr.c" 3 4
 ((void) sizeof ((
# 1096 "coders/ycbcr.c"
 image_info->signature == 0xabacadabUL
# 1096 "coders/ycbcr.c" 3 4
...
# 1096 "coders/ycbcr.c"
 "image_info->signature == MagickCoreSignature"
# 1096 "coders/ycbcr.c" 3 4
 , "coders/ycbcr.c", 1096, __extension__ __PRETTY_FUNCTION__); }))
# 1096 "coders/ycbcr.c"
                                                     ;
  
# 1097 "coders/ycbcr.c" 3 4
 ((void) sizeof ((
# 1097 "coders/ycbcr.c"
 image != (Image *) 
# 1097 "coders/ycbcr.c" 3 4
...
# 1097 "coders/ycbcr.c"
 "image != (Image *) NULL"
# 1097 "coders/ycbcr.c" 3 4
 , "coders/ycbcr.c", 1097, __extension__ __PRETTY_FUNCTION__); }))
# 1097 "coders/ycbcr.c"
                                ;
  
# 1098 "coders/ycbcr.c" 3 4
 ((void) sizeof ((
# 1098 "coders/ycbcr.c"
...
# 1098 "coders/ycbcr.c" 3 4
 , "coders/ycbcr.c", 1098, __extension__ __PRETTY_FUNCTION__); }))
# 1098 "coders/ycbcr.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/ycbcr.c",__func__,(unsigned long) 1100,"%s",image->filename);
  if (image_info->interlace != PartitionInterlace)
    {
...
# 1106 "coders/ycbcr.c"
     "exception != (ExceptionInfo *) NULL"
# 1106 "coders/ycbcr.c" 3 4
     , "coders/ycbcr.c", 1106, __extension__ __PRETTY_FUNCTION__); }))
# 1106 "coders/ycbcr.c"
                                                ;
      
# 1107 "coders/ycbcr.c" 3 4
     ((void) sizeof ((
# 1107 "coders/ycbcr.c"
     exception->signature == 0xabacadabUL
# 1107 "coders/ycbcr.c" 3 4
...
# 1107 "coders/ycbcr.c"
     "exception->signature == MagickCoreSignature"
# 1107 "coders/ycbcr.c" 3 4
     , "coders/ycbcr.c", 1107, __extension__ __PRETTY_FUNCTION__); }))
# 1107 "coders/ycbcr.c"
                                                        ;
  ...
  do
  {
    ...
    if (quantum_info == (QuantumInfo *) 
# 1128 "coders/ycbcr.c" 3 4
                                       ((void *)0)
# 1128 "coders/ycbcr.c"
                                           )
      { (void) ThrowMagickException(exception,"coders/ycbcr.c",__func__,(unsigned long) 1129,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1129 "coders/ycbcr.c" 3 4
     ((void *)0)
# 1129 "coders/ycbcr.c"
    ...
    switch (image_info->interlace)
    {
      ...
      default:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          ...
          if (p == (const Quantum *) 
# 1142 "coders/ycbcr.c" 3 4
                                    ((void *)0)
# 1142 "coders/ycbcr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1144 "coders/ycbcr.c" 3 4
                                                        ((void *)0)
# 1144 "coders/ycbcr.c"
                                                            ,quantum_info,
...
# 1149 "coders/ycbcr.c"
      ...
      case LineInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1167 "coders/ycbcr.c" 3 4
                                    ((void *)0)
# 1167 "coders/ycbcr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1169 "coders/ycbcr.c" 3 4
                                                        ((void *)0)
# 1169 "coders/ycbcr.c"
                                                            ,quantum_info,
...
# 1192 "coders/ycbcr.c"
      ...
      case PlaneInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1210 "coders/ycbcr.c" 3 4
                                    ((void *)0)
# 1210 "coders/ycbcr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1212 "coders/ycbcr.c" 3 4
                                                        ((void *)0)
# 1212 "coders/ycbcr.c"
                                                            ,quantum_info,
            RedQuantum,pixels,exception);
        ...
        if (image->previous == (Image *) 
# 1218 "coders/ycbcr.c" 3 4
                                        ((void *)0)
# 1218 "coders/ycbcr.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",1,5);
            if (status == MagickFalse)
              break;
          }
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1227 "coders/ycbcr.c" 3 4
                                    ((void *)0)
# 1227 "coders/ycbcr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1229 "coders/ycbcr.c" 3 4
                                                        ((void *)0)
# 1229 "coders/ycbcr.c"
                                                            ,quantum_info,
            GreenQuantum,pixels,exception);
        ...
        if (image->previous == (Image *) 
# 1235 "coders/ycbcr.c" 3 4
                                        ((void *)0)
# 1235 "coders/ycbcr.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",2,5);
            if (status == MagickFalse)
              break;
          }
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1244 "coders/ycbcr.c" 3 4
                                    ((void *)0)
# 1244 "coders/ycbcr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1246 "coders/ycbcr.c" 3 4
                                                        ((void *)0)
# 1246 "coders/ycbcr.c"
                                                            ,quantum_info,
            BlueQuantum,pixels,exception);
        ...
        if (image->previous == (Image *) 
# 1252 "coders/ycbcr.c" 3 4
                                        ((void *)0)
# 1252 "coders/ycbcr.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",3,5);
            if (status == MagickFalse)
              break;
          }
        if (quantum_type == RGBAQuantum)
          {
            for (y=0; y < (ssize_t) image->rows; y++)
            {
              p=GetVirtualPixels(image,0,y,image->columns,1,exception);
              if (p == (const Quantum *) 
# 1263 "coders/ycbcr.c" 3 4
                                        ((void *)0)
# 1263 "coders/ycbcr.c"
                                            )
                break;
              length=ExportQuantumPixels(image,(CacheView *) 
# 1265 "coders/ycbcr.c" 3 4
                                                            ((void *)0)
# 1265 "coders/ycbcr.c"
                                                                ,quantum_info,
                AlphaQuantum,pixels,exception);
        ...
        if (image_info->interlace == PartitionInterlace)
          (void) CopyMagickString(image->filename,image_info->filename,
            4096);
        if (image->previous == (Image *) 
# 1275 "coders/ycbcr.c" 3 4
                                        ((void *)0)
# 1275 "coders/ycbcr.c"
                                            )
          {
            status=SetImageProgress(image,"Save/Image",5,5);
            if (status == MagickFalse)
              break;
          }
        break;
      ...
      case PartitionInterlace:
      {
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1296 "coders/ycbcr.c" 3 4
                                    ((void *)0)
# 1296 "coders/ycbcr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1298 "coders/ycbcr.c" 3 4
                                                        ((void *)0)
# 1298 "coders/ycbcr.c"
                                                            ,quantum_info,
            RedQuantum,pixels,exception);
...
# 1304 "coders/ycbcr.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1320 "coders/ycbcr.c" 3 4
                                    ((void *)0)
# 1320 "coders/ycbcr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1322 "coders/ycbcr.c" 3 4
                                                        ((void *)0)
# 1322 "coders/ycbcr.c"
                                                            ,quantum_info,
            GreenQuantum,pixels,exception);
...
# 1328 "coders/ycbcr.c"
        ...
        for (y=0; y < (ssize_t) image->rows; y++)
        {
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 1344 "coders/ycbcr.c" 3 4
                                    ((void *)0)
# 1344 "coders/ycbcr.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 1346 "coders/ycbcr.c" 3 4
                                                        ((void *)0)
# 1346 "coders/ycbcr.c"
                                                            ,quantum_info,
            BlueQuantum,pixels,exception);
        ...
        if (quantum_type == RGBAQuantum)
          {
            ...
            for (y=0; y < (ssize_t) image->rows; y++)
            {
              p=GetVirtualPixels(image,0,y,image->columns,1,exception);
              if (p == (const Quantum *) 
# 1370 "coders/ycbcr.c" 3 4
                                        ((void *)0)
# 1370 "coders/ycbcr.c"
                                            )
                break;
              length=ExportQuantumPixels(image,(CacheView *) 
# 1372 "coders/ycbcr.c" 3 4
                                                            ((void *)0)
# 1372 "coders/ycbcr.c"
                                                                ,quantum_info,
                AlphaQuantum,pixels,exception);
            ...
            if (image->previous == (Image *) 
# 1378 "coders/ycbcr.c" 3 4
                                            ((void *)0)
# 1378 "coders/ycbcr.c"
                                                )
              {
                status=SetImageProgress(image,"Save/Image",4,5);
                if (status == MagickFalse)
                  break;
              }
          }
