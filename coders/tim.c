...
# 144 "coders/tim.c" 3 4
 , "coders/tim.c", 144, __extension__ __PRETTY_FUNCTION__); }))
# 144 "coders/tim.c"
                                               ;
  
# 145 "coders/tim.c" 3 4
 ((void) sizeof ((
# 145 "coders/tim.c"
...
# 145 "coders/tim.c" 3 4
 , "coders/tim.c", 145, __extension__ __PRETTY_FUNCTION__); }))
# 145 "coders/tim.c"
                                                     ;
  
# 146 "coders/tim.c" 3 4
 ((void) sizeof ((
# 146 "coders/tim.c"
...
# 146 "coders/tim.c" 3 4
 , "coders/tim.c", 146, __extension__ __PRETTY_FUNCTION__); }))
# 146 "coders/tim.c"
                                            ;
  
# 147 "coders/tim.c" 3 4
 ((void) sizeof ((
# 147 "coders/tim.c"
...
# 147 "coders/tim.c" 3 4
 , "coders/tim.c", 147, __extension__ __PRETTY_FUNCTION__); }))
# 147 "coders/tim.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/tim.c",__func__,(unsigned long) 149,"%s",
      image_info->filename);
...
# 156 "coders/tim.c"
  ...
  do
  {
    ...
    if (tim_info.id != 0x00000010)
      { (void) ThrowMagickException(exception,"coders/tim.c",__func__,(unsigned long) 168,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 168 "coders/tim.c" 3 4
     ((void *)0)
# 168 "coders/tim.c"
    ...
    if (has_clut)
      {
        ...
        if (AcquireImageColormap(image,pixel_mode == 1 ? 256UL : 16UL,exception) == MagickFalse)
          { (void) ThrowMagickException(exception,"coders/tim.c",__func__,(unsigned long) 197,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 197 "coders/tim.c" 3 4
         ((void *)0)
# 197 "coders/tim.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 197 "coders/tim.c" 3 4
...
# 197 "coders/tim.c"
        ...
        if (tim_colormap == (unsigned char *) 
# 200 "coders/tim.c" 3 4
                                             ((void *)0)
# 200 "coders/tim.c"
                                                 )
          { (void) ThrowMagickException(exception,"coders/tim.c",__func__,(unsigned long) 201,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 201 "coders/tim.c" 3 4
         ((void *)0)
# 201 "coders/tim.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 201 "coders/tim.c" 3 4
        ...
        if (count != (ssize_t) (2*image->colors))
          {
            ...
            { (void) ThrowMagickException(exception,"coders/tim.c",__func__,(unsigned long) 206,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 206 "coders/tim.c" 3 4
           ((void *)0)
# 206 "coders/tim.c"
           ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 206 "coders/tim.c" 3 4
...
# 206 "coders/tim.c"
    ...
    if (image_size > GetBlobSize(image))
      { (void) ThrowMagickException(exception,"coders/tim.c",__func__,(unsigned long) 236,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 236 "coders/tim.c" 3 4
     ((void *)0)
# 236 "coders/tim.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 236 "coders/tim.c" 3 4
...
# 236 "coders/tim.c"
    ...
    tim_pixels=(unsigned char *) AcquireQuantumMemory(image_size,
      sizeof(*tim_pixels));
    if (tim_pixels == (unsigned char *) 
# 249 "coders/tim.c" 3 4
                                       ((void *)0)
# 249 "coders/tim.c"
                                           )
      { (void) ThrowMagickException(exception,"coders/tim.c",__func__,(unsigned long) 250,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 250 "coders/tim.c" 3 4
     ((void *)0)
# 250 "coders/tim.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 250 "coders/tim.c" 3 4
    ...
    if (count != (ssize_t) (image_size))
      {
        ...
        { (void) ThrowMagickException(exception,"coders/tim.c",__func__,(unsigned long) 255,CorruptImageError,"InsufficientImageDataInFile", "`%s'",image_info->filename); if ((image) != (Image *) 
# 255 "coders/tim.c" 3 4
       ((void *)0)
# 255 "coders/tim.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 255 "coders/tim.c" 3 4
...
# 382 "coders/tim.c"
      ...
      {
        tim_pixels=(unsigned char *) RelinquishMagickMemory(tim_pixels);
        { (void) ThrowMagickException(exception,"coders/tim.c",__func__,(unsigned long) 395,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 395 "coders/tim.c" 3 4
       ((void *)0)
# 395 "coders/tim.c"
       ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 395 "coders/tim.c" 3 4
...
# 403 "coders/tim.c" 3 4
       (*__errno_location ())
# 403 "coders/tim.c"
       ); (void) ThrowMagickException(exception,"coders/tim.c",__func__,(unsigned long) 403,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 462 "coders/tim.c"
__attribute__ ((visibility ("default"))) size_t RegisterTIMImage(void)
{
  MagickInfo
    *entry;
...
# 492 "coders/tim.c"
__attribute__ ((visibility ("default"))) void UnregisterTIMImage(void)
{
