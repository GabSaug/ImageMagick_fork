...
# 140 "coders/fax.c" 3 4
   (*__errno_location ())
# 140 "coders/fax.c"
   ); (void) ThrowMagickException(exception,"coders/fax.c",__func__,(unsigned long) 140,CorruptImageError,"UnableToReadImageData", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
  if (EOFBlob(image) != MagickFalse)
    { char *file_message; file_message=GetExceptionMessage(
# 143 "coders/fax.c" 3 4
   (*__errno_location ())
# 143 "coders/fax.c"
   ); (void) ThrowMagickException(exception,"coders/fax.c",__func__,(unsigned long) 143,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
  ...
  ExceptionInfo *exception)
{
  ...
  if (ImageToFile(image,filename,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/fax.c",__func__,(unsigned long) 163,FileOpenError,"UnableToCreateTemporaryFile", "`%s'",image->filename); return((Image *) 
# 163 "coders/fax.c" 3 4
   ((void *)0)
# 163 "coders/fax.c"
   ); };
...
# 167 "coders/fax.c" 3 4
                                     ((void *)0)
# 167 "coders/fax.c"
                                         ,0);
  (void) FormatLocaleString(read_info->filename,4096,"group4:%s",
    filename);
  read_info->orientation=TopLeftOrientation;
  image=ReadImage(read_info,exception);
  if (image != (Image *) 
# 172 "coders/fax.c" 3 4
                        ((void *)0)
# 172 "coders/fax.c"
                            )
    {
      ...
      (void) CopyMagickString(image->magick_filename,image_info->filename,
        4096);
      (void) CopyMagickString(image->magick,"G4",4096);
    }
...
# 196 "coders/fax.c" 3 4
 , "coders/fax.c", 196, __extension__ __PRETTY_FUNCTION__); }))
# 196 "coders/fax.c"
                                               ;
  
# 197 "coders/fax.c" 3 4
 ((void) sizeof ((
# 197 "coders/fax.c"
...
# 197 "coders/fax.c" 3 4
 , "coders/fax.c", 197, __extension__ __PRETTY_FUNCTION__); }))
# 197 "coders/fax.c"
                                                     ;
  
# 198 "coders/fax.c" 3 4
 ((void) sizeof ((
# 198 "coders/fax.c"
...
# 198 "coders/fax.c" 3 4
 , "coders/fax.c", 198, __extension__ __PRETTY_FUNCTION__); }))
# 198 "coders/fax.c"
                                            ;
  
# 199 "coders/fax.c" 3 4
 ((void) sizeof ((
# 199 "coders/fax.c"
...
# 199 "coders/fax.c" 3 4
 , "coders/fax.c", 199, __extension__ __PRETTY_FUNCTION__); }))
# 199 "coders/fax.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/fax.c",__func__,(unsigned long) 201,"%s",
      image_info->filename);
...
# 208 "coders/fax.c"
  ...
  if (AcquireImageColormap(image,2,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"coders/fax.c",__func__,(unsigned long) 220,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 220 "coders/fax.c" 3 4
   ((void *)0)
# 220 "coders/fax.c"
...
# 220 "coders/fax.c"
  ...
  image->colormap[0].red=((Quantum) 65535.0);
  image->colormap[0].green=((Quantum) 65535.0);
  image->colormap[0].blue=((Quantum) 65535.0);
...
# 267 "coders/fax.c"
__attribute__ ((visibility ("default"))) size_t RegisterFAXImage(void)
{
  MagickInfo
    *entry;
...
# 321 "coders/fax.c"
__attribute__ ((visibility ("default"))) void UnregisterFAXImage(void)
{
...
# 374 "coders/fax.c"
 "image_info != (const ImageInfo *) NULL"
# 374 "coders/fax.c" 3 4
 , "coders/fax.c", 374, __extension__ __PRETTY_FUNCTION__); }))
# 374 "coders/fax.c"
                                               ;
  
# 375 "coders/fax.c" 3 4
 ((void) sizeof ((
# 375 "coders/fax.c"
 image_info->signature == 0xabacadabUL
# 375 "coders/fax.c" 3 4
...
# 375 "coders/fax.c"
 "image_info->signature == MagickCoreSignature"
# 375 "coders/fax.c" 3 4
 , "coders/fax.c", 375, __extension__ __PRETTY_FUNCTION__); }))
# 375 "coders/fax.c"
                                                     ;
  
# 376 "coders/fax.c" 3 4
 ((void) sizeof ((
# 376 "coders/fax.c"
 image != (Image *) 
# 376 "coders/fax.c" 3 4
...
# 376 "coders/fax.c"
 "image != (Image *) NULL"
# 376 "coders/fax.c" 3 4
 , "coders/fax.c", 376, __extension__ __PRETTY_FUNCTION__); }))
# 376 "coders/fax.c"
                                ;
  
# 377 "coders/fax.c" 3 4
 ((void) sizeof ((
# 377 "coders/fax.c"
...
# 377 "coders/fax.c" 3 4
 , "coders/fax.c", 377, __extension__ __PRETTY_FUNCTION__); }))
# 377 "coders/fax.c"
                                                ;
  
# 378 "coders/fax.c" 3 4
 ((void) sizeof ((
# 378 "coders/fax.c"
 exception != (ExceptionInfo *) 
# 378 "coders/fax.c" 3 4
...
# 378 "coders/fax.c"
 "exception != (ExceptionInfo *) NULL"
# 378 "coders/fax.c" 3 4
 , "coders/fax.c", 378, __extension__ __PRETTY_FUNCTION__); }))
# 378 "coders/fax.c"
                                            ;
  
# 379 "coders/fax.c" 3 4
 ((void) sizeof ((
# 379 "coders/fax.c"
 exception->signature == 0xabacadabUL
# 379 "coders/fax.c" 3 4
...
# 379 "coders/fax.c"
 "exception->signature == MagickCoreSignature"
# 379 "coders/fax.c" 3 4
 , "coders/fax.c", 379, __extension__ __PRETTY_FUNCTION__); }))
# 379 "coders/fax.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/fax.c",__func__,(unsigned long) 381,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  write_info=CloneImageInfo(image_info);
  (void) CopyMagickString(write_info->magick,"FAX",4096);
  scene=0;
