...
# 121 "coders/strimg.c" 3 4
 , "coders/strimg.c", 121, __extension__ __PRETTY_FUNCTION__); }))
# 121 "coders/strimg.c"
                                               ;
  
# 122 "coders/strimg.c" 3 4
 ((void) sizeof ((
# 122 "coders/strimg.c"
...
# 122 "coders/strimg.c" 3 4
 , "coders/strimg.c", 122, __extension__ __PRETTY_FUNCTION__); }))
# 122 "coders/strimg.c"
                                                     ;
  
# 123 "coders/strimg.c" 3 4
 ((void) sizeof ((
# 123 "coders/strimg.c"
...
# 123 "coders/strimg.c" 3 4
 , "coders/strimg.c", 123, __extension__ __PRETTY_FUNCTION__); }))
# 123 "coders/strimg.c"
                                            ;
  
# 124 "coders/strimg.c" 3 4
 ((void) sizeof ((
# 124 "coders/strimg.c"
...
# 124 "coders/strimg.c" 3 4
 , "coders/strimg.c", 124, __extension__ __PRETTY_FUNCTION__); }))
# 124 "coders/strimg.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/strimg.c",__func__,(unsigned long) 126,"%s",
      image_info->filename);
  image=AcquireImage(image_info,exception);
  string=InterpretImageProperties((ImageInfo *) image_info,image,
    image_info->filename,exception);
  if (string == (char *) 
# 131 "coders/strimg.c" 3 4
                        ((void *)0)
# 131 "coders/strimg.c"
                            )
...
# 198 "coders/strimg.c"
__attribute__ ((visibility ("default"))) size_t RegisterSTRIMGImage(void)
{
  MagickInfo
    *entry;
...
# 231 "coders/strimg.c"
__attribute__ ((visibility ("default"))) void UnregisterSTRIMGImage(void)
{
...
# 281 "coders/strimg.c"
 "image_info != (const ImageInfo *) NULL"
# 281 "coders/strimg.c" 3 4
 , "coders/strimg.c", 281, __extension__ __PRETTY_FUNCTION__); }))
# 281 "coders/strimg.c"
                                               ;
  
# 282 "coders/strimg.c" 3 4
 ((void) sizeof ((
# 282 "coders/strimg.c"
 image_info->signature == 0xabacadabUL
# 282 "coders/strimg.c" 3 4
...
# 282 "coders/strimg.c"
 "image_info->signature == MagickCoreSignature"
# 282 "coders/strimg.c" 3 4
 , "coders/strimg.c", 282, __extension__ __PRETTY_FUNCTION__); }))
# 282 "coders/strimg.c"
                                                     ;
  
# 283 "coders/strimg.c" 3 4
 ((void) sizeof ((
# 283 "coders/strimg.c"
 image != (Image *) 
# 283 "coders/strimg.c" 3 4
...
# 283 "coders/strimg.c"
 "image != (Image *) NULL"
# 283 "coders/strimg.c" 3 4
 , "coders/strimg.c", 283, __extension__ __PRETTY_FUNCTION__); }))
# 283 "coders/strimg.c"
                                ;
  
# 284 "coders/strimg.c" 3 4
 ((void) sizeof ((
# 284 "coders/strimg.c"
...
# 284 "coders/strimg.c" 3 4
 , "coders/strimg.c", 284, __extension__ __PRETTY_FUNCTION__); }))
# 284 "coders/strimg.c"
                                                ;
  
# 285 "coders/strimg.c" 3 4
 ((void) sizeof ((
# 285 "coders/strimg.c"
 exception != (ExceptionInfo *) 
# 285 "coders/strimg.c" 3 4
...
# 285 "coders/strimg.c"
 "exception != (ExceptionInfo *) NULL"
# 285 "coders/strimg.c" 3 4
 , "coders/strimg.c", 285, __extension__ __PRETTY_FUNCTION__); }))
# 285 "coders/strimg.c"
                                            ;
  
# 286 "coders/strimg.c" 3 4
 ((void) sizeof ((
# 286 "coders/strimg.c"
 exception->signature == 0xabacadabUL
# 286 "coders/strimg.c" 3 4
...
# 286 "coders/strimg.c"
 "exception->signature == MagickCoreSignature"
# 286 "coders/strimg.c" 3 4
 , "coders/strimg.c", 286, __extension__ __PRETTY_FUNCTION__); }))
# 286 "coders/strimg.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/strimg.c",__func__,(unsigned long) 288,"%s",image->filename);
...
# 296 "coders/strimg.c" 3 4
                                     ((void *)0)
# 296 "coders/strimg.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/strimg.c",__func__,(unsigned long) 297,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 297 "coders/strimg.c" 3 4
   ((void *)0)
# 297 "coders/strimg.c"
  ...
  if (SetQuantumDepth(image,quantum_info,8) == MagickFalse)
    {
      ...
      { (void) ThrowMagickException(exception,"coders/strimg.c",__func__,(unsigned long) 301,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 301 "coders/strimg.c" 3 4
     ((void *)0)
# 301 "coders/strimg.c"
     ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
    }
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 316 "coders/strimg.c" 3 4
                              ((void *)0)
# 316 "coders/strimg.c"
                                  )
      break;
    length=ExportQuantumPixels(image,(CacheView *) 
# 318 "coders/strimg.c" 3 4
                                                  ((void *)0)
# 318 "coders/strimg.c"
                                                      ,quantum_info,
...
# 323 "coders/strimg.c"
  ...
  if (y < (ssize_t) image->rows)
    { (void) ThrowMagickException(exception,"coders/strimg.c",__func__,(unsigned long) 333,CorruptImageError,"UnableToWriteImageData", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 333 "coders/strimg.c" 3 4
   ((void *)0)
# 333 "coders/strimg.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  if (CloseBlob(image) == MagickFalse)
