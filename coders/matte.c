...
# 91 "coders/matte.c"
__attribute__ ((visibility ("default"))) size_t RegisterMATTEImage(void)
{
  MagickInfo
    *entry;
...
# 122 "coders/matte.c"
__attribute__ ((visibility ("default"))) void UnregisterMATTEImage(void)
{
  ...
  Image *image,ExceptionInfo *exception)
{
  ...
  if ((image->alpha_trait & BlendPixelTrait) == 0)
    { (void) ThrowMagickException(exception,"coders/matte.c",__func__,(unsigned long) 180,CoderError,"ImageDoesNotHaveAnAlphaChannel", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 180 "coders/matte.c" 3 4
   ((void *)0)
# 180 "coders/matte.c"
...
# 193 "coders/matte.c"
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      SetPixelAlpha(matte_image,((Quantum) ((Quantum) 65535.0)),q);
