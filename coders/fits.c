  ...
  const int bits_per_pixel,double *minima,double *maxima)
{
  ...
  *minima=((double)1.79769313486231570814527423731704357e+308L)
# 190 "coders/fits.c"
                ;
  *maxima=((double)2.22507385850720138309023271733240406e-308L)
# 191 "coders/fits.c"
                ;
  ...
  return(SeekBlob(image,offset,
# 200 "coders/fits.c" 3 4
                              0
# 200 "coders/fits.c"
                                      ));
}
...
# 289 "coders/fits.c" 3 4
 , "coders/fits.c", 289, __extension__ __PRETTY_FUNCTION__); }))
# 289 "coders/fits.c"
                                               ;
  
# 290 "coders/fits.c" 3 4
 ((void) sizeof ((
# 290 "coders/fits.c"
...
# 290 "coders/fits.c" 3 4
 , "coders/fits.c", 290, __extension__ __PRETTY_FUNCTION__); }))
# 290 "coders/fits.c"
                                                     ;
  
# 291 "coders/fits.c" 3 4
 ((void) sizeof ((
# 291 "coders/fits.c"
...
# 291 "coders/fits.c" 3 4
 , "coders/fits.c", 291, __extension__ __PRETTY_FUNCTION__); }))
# 291 "coders/fits.c"
                                            ;
  
# 292 "coders/fits.c" 3 4
 ((void) sizeof ((
# 292 "coders/fits.c"
...
# 292 "coders/fits.c" 3 4
 , "coders/fits.c", 292, __extension__ __PRETTY_FUNCTION__); }))
# 292 "coders/fits.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/fits.c",__func__,(unsigned long) 294,"%s",
      image_info->filename);
...
# 326 "coders/fits.c"
                             ; EOFBlob(image) == MagickFalse; )
    {
      for ( ; EOFBlob(image) == MagickFalse; )
      {
        ...
        {
          if (
# 338 "coders/fits.c" 3 4
             ((*__ctype_b_loc ())[(int) ((
# 338 "coders/fits.c"
             (int) ((unsigned char) keyword[i])
# 338 "coders/fits.c" 3 4
...
# 351 "coders/fits.c"
        ...
        if (LocaleCompare(keyword,"datamax") == 0)
          fits_info.max_data=StringToDouble(p,(char **) 
# 373 "coders/fits.c" 3 4
                                                       ((void *)0)
# 373 "coders/fits.c"
                                                           );
        if (LocaleCompare(keyword,"datamin") == 0)
          fits_info.min_data=StringToDouble(p,(char **) 
# 375 "coders/fits.c" 3 4
                                                       ((void *)0)
# 375 "coders/fits.c"
                                                           );
        if (LocaleCompare(keyword,"bzero") == 0)
          fits_info.zero=StringToDouble(p,(char **) 
# 377 "coders/fits.c" 3 4
                                                   ((void *)0)
# 377 "coders/fits.c"
                                                       );
        if (LocaleCompare(keyword,"bscale") == 0)
          fits_info.scale=StringToDouble(p,(char **) 
# 379 "coders/fits.c" 3 4
                                                    ((void *)0)
# 379 "coders/fits.c"
                                                        );
...
# 382 "coders/fits.c"
        ...
        (void) FormatLocaleString(property,4096,"fits:%s",keyword);
        (void) SetImageProperty(image,property,p,exception);
      }
      c=0;
      while (((TellBlob(image) % 2880L) != 0) && (c != 
# 398 "coders/fits.c" 3 4
                                                              (-1)
# 398 "coders/fits.c"
                                                                 ))
      ...
      if ((fits_info.bits_per_pixel != 8) &&
        ...
        {
          if (comment != (char *) 
# 409 "coders/fits.c" 3 4
                                 ((void *)0)
# 409 "coders/fits.c"
                                     )
            comment=DestroyString(comment);
          { (void) ThrowMagickException(exception,"coders/fits.c",__func__,(unsigned long) 411,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 411 "coders/fits.c" 3 4
         ((void *)0)
# 411 "coders/fits.c"
...
# 411 "coders/fits.c"
      ...
      if ((fits_info.columns <= 0) || (fits_info.rows <= 0) ||
        ...
        {
          if (comment != (char *) 
# 416 "coders/fits.c" 3 4
                                 ((void *)0)
# 416 "coders/fits.c"
                                     )
            comment=DestroyString(comment);
          { (void) ThrowMagickException(exception,"coders/fits.c",__func__,(unsigned long) 418,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 418 "coders/fits.c" 3 4
         ((void *)0)
# 418 "coders/fits.c"
         ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 418 "coders/fits.c" 3 4
...
# 434 "coders/fits.c" 3 4
     (*__errno_location ())
# 434 "coders/fits.c"
     ); (void) ThrowMagickException(exception,"coders/fits.c",__func__,(unsigned long) 434,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                        ;
    number_pixels=(MagickSizeType) (fits_info.columns*fits_info.rows);
    if ((fits_info.simple == MagickFalse) || (fits_info.number_axes < 1) ||
        (fits_info.number_axes > 4) || (number_pixels == 0) ||
        (fits_info.number_planes <= 0))
      { (void) ThrowMagickException(exception,"coders/fits.c",__func__,(unsigned long) 440,CorruptImageError,"ImageTypeNotSupported", "`%s'",image_info->filename); if ((image) != (Image *) 
# 440 "coders/fits.c" 3 4
     ((void *)0)
# 440 "coders/fits.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 440 "coders/fits.c" 3 4
...
# 440 "coders/fits.c"
    ...
    for (scene=0; scene < (ssize_t) fits_info.number_planes; scene++)
    {
      ...
      scale=(double) ((Quantum) 65535.0)*PerceptibleReciprocal(fits_info.max_data-
        fits_info.min_data);
      for (y=(ssize_t) image->rows-1; y >= 0; y--)
      {
        q=QueueAuthenticPixels(image,0,y,image->columns,1,exception);
        if (q == (Quantum *) 
# 479 "coders/fits.c" 3 4
                            ((void *)0)
# 479 "coders/fits.c"
                                )
          break;
...
# 494 "coders/fits.c"
      ...
      if (EOFBlob(image) != MagickFalse)
        {
          { char *file_message; file_message=GetExceptionMessage(
# 504 "coders/fits.c" 3 4
         (*__errno_location ())
# 504 "coders/fits.c"
         ); (void) ThrowMagickException(exception,"coders/fits.c",__func__,(unsigned long) 504,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                            ;
          break;
        }
...
# 533 "coders/fits.c"
    ...
    if (EOFBlob(image) != MagickFalse)
      {
        { char *file_message; file_message=GetExceptionMessage(
# 539 "coders/fits.c" 3 4
       (*__errno_location ())
# 539 "coders/fits.c"
       ); (void) ThrowMagickException(exception,"coders/fits.c",__func__,(unsigned long) 539,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                          ;
        break;
      }
...
# 594 "coders/fits.c"
__attribute__ ((visibility ("default"))) size_t RegisterFITSImage(void)
{
  MagickInfo
    *entry;
...
# 633 "coders/fits.c"
__attribute__ ((visibility ("default"))) void UnregisterFITSImage(void)
{
  ...
  const ssize_t offset)
{
  ...
  if (data == (char *) 
# 674 "coders/fits.c" 3 4
                      ((void *)0)
# 674 "coders/fits.c"
                          )
    return(0);
  length=(((strlen(data)) < (80)) ? (strlen(data)) : (80));
  if (length > (size_t) (2880L -offset))
    length=(size_t) (2880L -offset);
...
# 718 "coders/fits.c"
 "image_info != (const ImageInfo *) NULL"
# 718 "coders/fits.c" 3 4
 , "coders/fits.c", 718, __extension__ __PRETTY_FUNCTION__); }))
# 718 "coders/fits.c"
                                               ;
  
# 719 "coders/fits.c" 3 4
 ((void) sizeof ((
# 719 "coders/fits.c"
 image_info->signature == 0xabacadabUL
# 719 "coders/fits.c" 3 4
...
# 719 "coders/fits.c"
 "image_info->signature == MagickCoreSignature"
# 719 "coders/fits.c" 3 4
 , "coders/fits.c", 719, __extension__ __PRETTY_FUNCTION__); }))
# 719 "coders/fits.c"
                                                     ;
  
# 720 "coders/fits.c" 3 4
 ((void) sizeof ((
# 720 "coders/fits.c"
 image != (Image *) 
# 720 "coders/fits.c" 3 4
...
# 720 "coders/fits.c"
 "image != (Image *) NULL"
# 720 "coders/fits.c" 3 4
 , "coders/fits.c", 720, __extension__ __PRETTY_FUNCTION__); }))
# 720 "coders/fits.c"
                                ;
  
# 721 "coders/fits.c" 3 4
 ((void) sizeof ((
# 721 "coders/fits.c"
...
# 721 "coders/fits.c" 3 4
 , "coders/fits.c", 721, __extension__ __PRETTY_FUNCTION__); }))
# 721 "coders/fits.c"
                                                ;
  
# 722 "coders/fits.c" 3 4
 ((void) sizeof ((
# 722 "coders/fits.c"
 exception != (ExceptionInfo *) 
# 722 "coders/fits.c" 3 4
...
# 722 "coders/fits.c"
 "exception != (ExceptionInfo *) NULL"
# 722 "coders/fits.c" 3 4
 , "coders/fits.c", 722, __extension__ __PRETTY_FUNCTION__); }))
# 722 "coders/fits.c"
                                            ;
  
# 723 "coders/fits.c" 3 4
 ((void) sizeof ((
# 723 "coders/fits.c"
 exception->signature == 0xabacadabUL
# 723 "coders/fits.c" 3 4
...
# 723 "coders/fits.c"
 "exception->signature == MagickCoreSignature"
# 723 "coders/fits.c" 3 4
 , "coders/fits.c", 723, __extension__ __PRETTY_FUNCTION__); }))
# 723 "coders/fits.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/fits.c",__func__,(unsigned long) 725,"%s",image->filename);
  ...
  fits_info=(char *) AcquireQuantumMemory(30*2880L,sizeof(*fits_info));
  if (fits_info == (char *) 
# 735 "coders/fits.c" 3 4
                           ((void *)0)
# 735 "coders/fits.c"
                               )
    { (void) ThrowMagickException(exception,"coders/fits.c",__func__,(unsigned long) 736,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 736 "coders/fits.c" 3 4
   ((void *)0)
# 736 "coders/fits.c"
...
# 747 "coders/fits.c" 3 4
                                       ((void *)0)
# 747 "coders/fits.c"
                                           )
      {
        fits_info=DestroyString(fits_info);
        { (void) ThrowMagickException(exception,"coders/fits.c",__func__,(unsigned long) 750,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 750 "coders/fits.c" 3 4
       ((void *)0)
# 750 "coders/fits.c"
       ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
      }
    (void) memset(fits_info,' ',2880L*sizeof(*fits_info));
    offset=0;
    (void) FormatLocaleString(header,2880L,
      "SIMPLE  =                    T");
    offset+=CopyFITSRecord(fits_info,header,offset);
    (void) FormatLocaleString(header,2880L,"BITPIX  =           %10ld",
      (long) ((quantum_info->format == FloatingPointQuantumFormat ? -1L : 1L)*
      (ssize_t) image->depth));
    offset+=CopyFITSRecord(fits_info,header,offset);
    is_gray=IdentifyImageCoderGray(image,exception);
    (void) FormatLocaleString(header,2880L,"NAXIS   =           %10lu",
      (is_gray != MagickFalse) ? 2UL : 3UL);
    offset+=CopyFITSRecord(fits_info,header,offset);
    (void) FormatLocaleString(header,2880L,"NAXIS1  =           %10lu",
      (unsigned long) image->columns);
    offset+=CopyFITSRecord(fits_info,header,offset);
    (void) FormatLocaleString(header,2880L,"NAXIS2  =           %10lu",
    ...
    (void) FormatLocaleString(header,2880L,"BSCALE  =         %E",1.0);
    offset+=CopyFITSRecord(fits_info,header,offset);
    (void) FormatLocaleString(header,2880L,"BZERO   =         %E",
      image->depth > 8 ? (GetFITSPixelRange(image->depth)+1)/2.0 : 0.0);
    offset+=CopyFITSRecord(fits_info,header,offset);
    (void) FormatLocaleString(header,2880L,"DATAMAX =         %E",
      1.0*((MagickOffsetType) GetQuantumRange(image->depth)));
    offset+=CopyFITSRecord(fits_info,header,offset);
    (void) FormatLocaleString(header,2880L,"DATAMIN =         %E",0.0);
    offset+=CopyFITSRecord(fits_info,header,offset);
    if (image->endian == LSBEndian)
      {
        (void) FormatLocaleString(header,2880L,"XENDIAN = 'SMALL'");
        offset+=CopyFITSRecord(fits_info,header,offset);
      }
    (void) FormatLocaleString(header,2880L,"HISTORY %.72s",
      "https://imagemagick.org");
    offset+=CopyFITSRecord(fits_info,header,offset);
    (void) strncpy(header,"END",2880L);
    offset+=CopyFITSRecord(fits_info,header,offset);
    (void) WriteBlob(image,2880L,(unsigned char *) fits_info);
    ...
    if (is_gray != MagickFalse)
      {
        ...
        for (y=(ssize_t) image->rows-1; y >= 0; y--)
        {
          ...
          if (p == (const Quantum *) 
# 808 "coders/fits.c" 3 4
                                    ((void *)0)
# 808 "coders/fits.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 810 "coders/fits.c" 3 4
                                                        ((void *)0)
# 810 "coders/fits.c"
                                                            ,quantum_info,
    ...
    else
      {
        ...
        for (y=(ssize_t) image->rows-1; y >= 0; y--)
        {
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 834 "coders/fits.c" 3 4
                                    ((void *)0)
# 834 "coders/fits.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 836 "coders/fits.c" 3 4
                                                        ((void *)0)
# 836 "coders/fits.c"
                                                            ,quantum_info,
        ...
        for (y=(ssize_t) image->rows-1; y >= 0; y--)
        {
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 857 "coders/fits.c" 3 4
                                    ((void *)0)
# 857 "coders/fits.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 859 "coders/fits.c" 3 4
                                                        ((void *)0)
# 859 "coders/fits.c"
                                                            ,quantum_info,
        ...
        for (y=(ssize_t) image->rows-1; y >= 0; y--)
        {
          p=GetVirtualPixels(image,0,y,image->columns,1,exception);
          if (p == (const Quantum *) 
# 880 "coders/fits.c" 3 4
                                    ((void *)0)
# 880 "coders/fits.c"
                                        )
            break;
          length=ExportQuantumPixels(image,(CacheView *) 
# 882 "coders/fits.c" 3 4
                                                        ((void *)0)
# 882 "coders/fits.c"
                                                            ,quantum_info,
    ...
    length=(size_t) (2880L -TellBlob(image) % 2880L);
    if (length != 2880L)
      {
