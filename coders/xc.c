...
# 115 "coders/xc.c" 3 4
 , "coders/xc.c", 115, __extension__ __PRETTY_FUNCTION__); }))
# 115 "coders/xc.c"
                                               ;
...
# 116 "coders/xc.c" 3 4
 , "coders/xc.c", 116, __extension__ __PRETTY_FUNCTION__); }))
# 116 "coders/xc.c"
                                                     ;
...
# 117 "coders/xc.c" 3 4
 , "coders/xc.c", 117, __extension__ __PRETTY_FUNCTION__); }))
# 117 "coders/xc.c"
                                            ;
...
# 118 "coders/xc.c" 3 4
 , "coders/xc.c", 118, __extension__ __PRETTY_FUNCTION__); }))
# 118 "coders/xc.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/xc.c",__func__,(unsigned long) 120,"%s",
      image_info->filename);
...
# 185 "coders/xc.c"
__attribute__ ((visibility ("default"))) size_t RegisterXCImage(void)
{
  MagickInfo
    *entry;
...
# 226 "coders/xc.c"
__attribute__ ((visibility ("default"))) void UnregisterXCImage(void)
{
