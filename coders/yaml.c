...
# 124 "coders/yaml.c"
__attribute__ ((visibility ("default"))) size_t RegisterYAMLImage(void)
{
  MagickInfo
    *entry;
...
# 157 "coders/yaml.c"
__attribute__ ((visibility ("default"))) void UnregisterYAMLImage(void)
{
...
# 205 "coders/yaml.c" 3 4
 , "coders/yaml.c", 205, __extension__ __PRETTY_FUNCTION__); }))
# 205 "coders/yaml.c"
                                      ;
  if ((value == (char *) 
# 206 "coders/yaml.c" 3 4
                        ((void *)0)
# 206 "coders/yaml.c"
                            ) || (*value == '\0'))
    {
...
# 330 "coders/yaml.c"
 "image != (Image *) NULL"
# 330 "coders/yaml.c" 3 4
 , "coders/yaml.c", 330, __extension__ __PRETTY_FUNCTION__); }))
# 330 "coders/yaml.c"
                                ;
  
# 331 "coders/yaml.c" 3 4
 ((void) sizeof ((
# 331 "coders/yaml.c"
...
# 965 "coders/yaml.c"
 "image != (Image *) NULL"
# 965 "coders/yaml.c" 3 4
 , "coders/yaml.c", 965, __extension__ __PRETTY_FUNCTION__); }))
# 965 "coders/yaml.c"
                                ;
  
# 966 "coders/yaml.c" 3 4
 ((void) sizeof ((
# 966 "coders/yaml.c"
 image->signature == 0xabacadabUL
# 966 "coders/yaml.c" 3 4
...
# 966 "coders/yaml.c"
 "image->signature == MagickCoreSignature"
# 966 "coders/yaml.c" 3 4
 , "coders/yaml.c", 966, __extension__ __PRETTY_FUNCTION__); }))
# 966 "coders/yaml.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/yaml.c",__func__,(unsigned long) 968,"%s",image->filename);
  *format='\0';
...
# 981 "coders/yaml.c" 3 4
                                ((void *)0)
# 981 "coders/yaml.c"
                                    )
    version=StringToDouble(artifact,(char **) 
# 982 "coders/yaml.c" 3 4
                                             ((void *)0)
# 982 "coders/yaml.c"
                                                 );
  if (version >= 1.0)
...
# 1008 "coders/yaml.c" 3 4
                                          ((void *)0)
# 1008 "coders/yaml.c"
                                              ) &&
      (GetMagickDescription(magick_info) != (const char *) 
# 1009 "coders/yaml.c" 3 4
                                                          ((void *)0)
# 1009 "coders/yaml.c"
                                                              ))
  ...
  if ((magick_info != (const MagickInfo *) 
# 1012 "coders/yaml.c" 3 4
                                          ((void *)0)
# 1012 "coders/yaml.c"
                                              ) &&
      (GetMagickMimeType(magick_info) != (const char *) 
# 1013 "coders/yaml.c" 3 4
                                                       ((void *)0)
# 1013 "coders/yaml.c"
                                                           ))
...
# 1054 "coders/yaml.c" 3 4
                              ((void *)0)
# 1054 "coders/yaml.c"
                                  )
    locate=GetImageArtifact(image,"yaml:locate");
  if (locate != (const char *) 
# 1056 "coders/yaml.c" 3 4
                              ((void *)0)
# 1056 "coders/yaml.c"
                                  )
    {
...
# 1129 "coders/yaml.c" 3 4
                                          ((void *)0)
# 1129 "coders/yaml.c"
                                              ;
  channel_moments=(ChannelMoments *) 
# 1130 "coders/yaml.c" 3 4
                                    ((void *)0)
# 1130 "coders/yaml.c"
                                        ;
  channel_phash=(ChannelPerceptualHash *) 
# 1131 "coders/yaml.c" 3 4
                                         ((void *)0)
# 1131 "coders/yaml.c"
                                             ;
  channel_features=(ChannelFeatures *) 
# 1132 "coders/yaml.c" 3 4
                                      ((void *)0)
# 1132 "coders/yaml.c"
                                          ;
  scale=1;
...
# 1135 "coders/yaml.c"
  ...
  if (artifact == (const char *) 
# 1138 "coders/yaml.c" 3 4
                                ((void *)0)
# 1138 "coders/yaml.c"
                                    )
    artifact=GetImageArtifact(image,"yaml:moments");
  if (artifact != (const char *) 
# 1140 "coders/yaml.c" 3 4
                                ((void *)0)
# 1140 "coders/yaml.c"
                                    )
    {
...
# 1705 "coders/yaml.c" 3 4
 , "coders/yaml.c", 1705, __extension__ __PRETTY_FUNCTION__); }))
# 1705 "coders/yaml.c"
                                               ;
  
# 1706 "coders/yaml.c" 3 4
 ((void) sizeof ((
# 1706 "coders/yaml.c"
...
# 1706 "coders/yaml.c" 3 4
 , "coders/yaml.c", 1706, __extension__ __PRETTY_FUNCTION__); }))
# 1706 "coders/yaml.c"
                                                     ;
  
# 1707 "coders/yaml.c" 3 4
 ((void) sizeof ((
# 1707 "coders/yaml.c"
 image != (Image *) 
# 1707 "coders/yaml.c" 3 4
...
# 1707 "coders/yaml.c"
 "image != (Image *) NULL"
# 1707 "coders/yaml.c" 3 4
 , "coders/yaml.c", 1707, __extension__ __PRETTY_FUNCTION__); }))
# 1707 "coders/yaml.c"
                                ;
  
# 1708 "coders/yaml.c" 3 4
 ((void) sizeof ((
# 1708 "coders/yaml.c"
 image->signature == 0xabacadabUL
# 1708 "coders/yaml.c" 3 4
...
# 1708 "coders/yaml.c"
 "image->signature == MagickCoreSignature"
# 1708 "coders/yaml.c" 3 4
 , "coders/yaml.c", 1708, __extension__ __PRETTY_FUNCTION__); }))
# 1708 "coders/yaml.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/yaml.c",__func__,(unsigned long) 1710,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  file=GetBlobFileHandle(image);
  if (file == (FILE *) 
# 1715 "coders/yaml.c" 3 4
                      ((void *)0)
# 1715 "coders/yaml.c"
                          )
    file=
# 1716 "coders/yaml.c" 3 4
        stdout
# 1716 "coders/yaml.c"
              ;
  scene=0;
