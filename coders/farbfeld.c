...
# 163 "coders/farbfeld.c" 3 4
 ((void) sizeof ((
# 163 "coders/farbfeld.c"
...
# 163 "coders/farbfeld.c" 3 4
 , "coders/farbfeld.c", 163, __extension__ __PRETTY_FUNCTION__); }))
# 163 "coders/farbfeld.c"
                                               ;
  
# 164 "coders/farbfeld.c" 3 4
 ((void) sizeof ((
# 164 "coders/farbfeld.c"
...
# 164 "coders/farbfeld.c" 3 4
 , "coders/farbfeld.c", 164, __extension__ __PRETTY_FUNCTION__); }))
# 164 "coders/farbfeld.c"
                                                     ;
  
# 165 "coders/farbfeld.c" 3 4
 ((void) sizeof ((
# 165 "coders/farbfeld.c"
...
# 165 "coders/farbfeld.c" 3 4
 , "coders/farbfeld.c", 165, __extension__ __PRETTY_FUNCTION__); }))
# 165 "coders/farbfeld.c"
                                            ;
  
# 166 "coders/farbfeld.c" 3 4
 ((void) sizeof ((
# 166 "coders/farbfeld.c"
...
# 166 "coders/farbfeld.c" 3 4
 , "coders/farbfeld.c", 166, __extension__ __PRETTY_FUNCTION__); }))
# 166 "coders/farbfeld.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/farbfeld.c",__func__,(unsigned long) 168,"%s",
      image_info->filename);
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 175 "coders/farbfeld.c" 3 4
                      ((void *)0)
# 175 "coders/farbfeld.c"
                          );
    }
  image->depth=16;
  image->endian=MSBEndian;
  magic=ReadBlobLongLong(image);
  if (magic != ((MagickSizeType) (7377303431559867492ULL)))
    { (void) ThrowMagickException(exception,"coders/farbfeld.c",__func__,(unsigned long) 181,CorruptImageError,"ImproperImageHeader", "`%s'",image_info->filename); if ((image) != (Image *) 
# 181 "coders/farbfeld.c" 3 4
   ((void *)0)
# 181 "coders/farbfeld.c"
...
# 194 "coders/farbfeld.c" 3 4
                                     ((void *)0)
# 194 "coders/farbfeld.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/farbfeld.c",__func__,(unsigned long) 195,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image_info->filename); if ((image) != (Image *) 
# 195 "coders/farbfeld.c" 3 4
   ((void *)0)
# 195 "coders/farbfeld.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 195 "coders/farbfeld.c" 3 4
   ((void *)0)
# 195 "coders/farbfeld.c"
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (q == (Quantum *) 
# 208 "coders/farbfeld.c" 3 4
                        ((void *)0)
# 208 "coders/farbfeld.c"
                            )
      break;
...
# 213 "coders/farbfeld.c" 3 4
                                                  ((void *)0)
# 213 "coders/farbfeld.c"
                                                      ,quantum_info,
      RGBAQuantum,(unsigned char *) stream,exception);
    if (SyncAuthenticPixels(image,exception) == MagickFalse)
      break;
    if (SetImageProgress(image,"Load/Image",y,image->rows) == MagickFalse)
      break;
  }
  SetQuantumImageType(image,RGBAQuantum);
  quantum_info=DestroyQuantumInfo(quantum_info);
  if (y < (ssize_t) image->rows)
    { (void) ThrowMagickException(exception,"coders/farbfeld.c",__func__,(unsigned long) 223,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 223 "coders/farbfeld.c" 3 4
   ((void *)0)
# 223 "coders/farbfeld.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 223 "coders/farbfeld.c" 3 4
   ((void *)0)
# 223 "coders/farbfeld.c"
...
# 225 "coders/farbfeld.c" 3 4
   (*__errno_location ())
# 225 "coders/farbfeld.c"
   ); (void) ThrowMagickException(exception,"coders/farbfeld.c",__func__,(unsigned long) 225,CorruptImageError,"UnexpectedEndOfFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                      ;
...
# 257 "coders/farbfeld.c"
__attribute__ ((visibility ("default"))) size_t RegisterFARBFELDImage(void)
{
  MagickInfo
    *entry;
...
# 298 "coders/farbfeld.c"
__attribute__ ((visibility ("default"))) void UnregisterFARBFELDImage(void)
{
  (void) UnregisterMagickInfo("FARBFELD");
}
# 330 "coders/farbfeld.c"
...
# 355 "coders/farbfeld.c" 3 4
 ((void) sizeof ((
# 355 "coders/farbfeld.c"
 image_info != (const ImageInfo *) 
# 355 "coders/farbfeld.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 355 "coders/farbfeld.c"
...
# 355 "coders/farbfeld.c"
 "image_info != (const ImageInfo *) NULL"
# 355 "coders/farbfeld.c" 3 4
 , "coders/farbfeld.c", 355, __extension__ __PRETTY_FUNCTION__); }))
# 355 "coders/farbfeld.c"
                                               ;
  
# 356 "coders/farbfeld.c" 3 4
 ((void) sizeof ((
# 356 "coders/farbfeld.c"
 image_info->signature == 0xabacadabUL
# 356 "coders/farbfeld.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 356 "coders/farbfeld.c"
...
# 356 "coders/farbfeld.c"
 "image_info->signature == MagickCoreSignature"
# 356 "coders/farbfeld.c" 3 4
 , "coders/farbfeld.c", 356, __extension__ __PRETTY_FUNCTION__); }))
# 356 "coders/farbfeld.c"
                                                     ;
  
# 357 "coders/farbfeld.c" 3 4
 ((void) sizeof ((
# 357 "coders/farbfeld.c"
 image != (Image *) 
# 357 "coders/farbfeld.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 357 "coders/farbfeld.c"
...
# 357 "coders/farbfeld.c"
 "image != (Image *) NULL"
# 357 "coders/farbfeld.c" 3 4
 , "coders/farbfeld.c", 357, __extension__ __PRETTY_FUNCTION__); }))
# 357 "coders/farbfeld.c"
                                ;
  
# 358 "coders/farbfeld.c" 3 4
 ((void) sizeof ((
# 358 "coders/farbfeld.c"
...
# 358 "coders/farbfeld.c" 3 4
 , "coders/farbfeld.c", 358, __extension__ __PRETTY_FUNCTION__); }))
# 358 "coders/farbfeld.c"
                                                ;
  
# 359 "coders/farbfeld.c" 3 4
 ((void) sizeof ((
# 359 "coders/farbfeld.c"
 exception != (ExceptionInfo *) 
# 359 "coders/farbfeld.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 359 "coders/farbfeld.c"
...
# 359 "coders/farbfeld.c"
 "exception != (ExceptionInfo *) NULL"
# 359 "coders/farbfeld.c" 3 4
 , "coders/farbfeld.c", 359, __extension__ __PRETTY_FUNCTION__); }))
# 359 "coders/farbfeld.c"
                                            ;
  
# 360 "coders/farbfeld.c" 3 4
 ((void) sizeof ((
# 360 "coders/farbfeld.c"
 exception->signature == 0xabacadabUL
# 360 "coders/farbfeld.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 360 "coders/farbfeld.c"
...
# 360 "coders/farbfeld.c"
 "exception->signature == MagickCoreSignature"
# 360 "coders/farbfeld.c" 3 4
 , "coders/farbfeld.c", 360, __extension__ __PRETTY_FUNCTION__); }))
# 360 "coders/farbfeld.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"coders/farbfeld.c",__func__,(unsigned long) 362,"%s",image->filename);
  status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
  if (status == MagickFalse)
    return(status);
  image->endian=MSBEndian;
  (void) WriteBlobLongLong(image,((MagickSizeType) (7377303431559867492ULL)));
  (void) WriteBlobLong(image,(unsigned int) image->columns);
  (void) WriteBlobLong(image,(unsigned int) image->rows);
  image->depth=16;
  quantum_info=AcquireQuantumInfo(image_info,image);
  if (quantum_info == (QuantumInfo *) 
# 372 "coders/farbfeld.c" 3 4
                                     ((void *)0)
# 372 "coders/farbfeld.c"
                                         )
    { (void) ThrowMagickException(exception,"coders/farbfeld.c",__func__,(unsigned long) 373,ImageError,"MemoryAllocationFailed", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 373 "coders/farbfeld.c" 3 4
   ((void *)0)
# 373 "coders/farbfeld.c"
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 379 "coders/farbfeld.c" 3 4
                              ((void *)0)
# 379 "coders/farbfeld.c"
                                  )
      break;
    extent=ExportQuantumPixels(image,(CacheView *) 
# 381 "coders/farbfeld.c" 3 4
                                                  ((void *)0)
# 381 "coders/farbfeld.c"
                                                      ,quantum_info,
  ...
  quantum_info=DestroyQuantumInfo(quantum_info);
  if (y < (ssize_t) image->rows)
    { (void) ThrowMagickException(exception,"coders/farbfeld.c",__func__,(unsigned long) 393,CorruptImageError,"UnableToWriteImageData", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 393 "coders/farbfeld.c" 3 4
   ((void *)0)
# 393 "coders/farbfeld.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  if (CloseBlob(image) == MagickFalse)
    status=MagickFalse;
  return(status);
