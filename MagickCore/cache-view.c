# 0 "MagickCore/cache-view.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/cache-view.c"
# 49 "MagickCore/cache-view.c"
...
# 57 "MagickCore/cache-view.c" 2
# 65 "MagickCore/cache-view.c"
struct _CacheView
{
  Image
    *image;
...
# 112 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) CacheView *AcquireAuthenticCacheView(const Image *image,
  ExceptionInfo *exception)
{
  CacheView
    *__restrict__ cache_view;

  cache_view=AcquireVirtualCacheView(image,exception);
  return(cache_view);
}
# 149 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) CacheView *AcquireVirtualCacheView(const Image *image,
...
# 156 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 156 "MagickCore/cache-view.c"
 image != (Image *) 
# 156 "MagickCore/cache-view.c" 3 4
...
# 156 "MagickCore/cache-view.c"
 "image != (Image *) NULL"
# 156 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 156, __extension__ __PRETTY_FUNCTION__); }))
# 156 "MagickCore/cache-view.c"
                                ;
  
# 157 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 157 "MagickCore/cache-view.c"
...
# 157 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 157, __extension__ __PRETTY_FUNCTION__); }))
# 157 "MagickCore/cache-view.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache-view.c",__func__,(unsigned long) 159,"%s",image->filename);



  cache_view=(CacheView *) __builtin_assume_aligned((AcquireAlignedMemory(1, sizeof(*cache_view))),(8 * 8))
                         ;
  if (cache_view == (CacheView *) 
# 165 "MagickCore/cache-view.c" 3 4
                                 ((void *)0)
# 165 "MagickCore/cache-view.c"
                                     )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 166 "MagickCore/cache-view.c" 3 4
   (*__errno_location ())
# 166 "MagickCore/cache-view.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/cache-view.c",__func__,(unsigned long) 166,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  ...
  cache_view->debug=(GetLogEventMask() & CacheEvent) != 0 ? MagickTrue :
    MagickFalse;
  cache_view->signature=0xabacadabUL;
  if (cache_view->nexus_info == (NexusInfo **) 
# 179 "MagickCore/cache-view.c" 3 4
                                              ((void *)0)
# 179 "MagickCore/cache-view.c"
                                                  )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 180 "MagickCore/cache-view.c" 3 4
   (*__errno_location ())
# 180 "MagickCore/cache-view.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/cache-view.c",__func__,(unsigned long) 180,CacheFatalError,"UnableToAcquireCacheView", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (CacheFatalError-FatalErrorException)+1); };
  return(cache_view);
}
# 206 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) CacheView *CloneCacheView(const CacheView *cache_view)
{
  CacheView
    *__restrict__ clone_view;

  
# 211 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 211 "MagickCore/cache-view.c"
...
# 211 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 211, __extension__ __PRETTY_FUNCTION__); }))
# 211 "MagickCore/cache-view.c"
                                         ;
  
# 212 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 212 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 212 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 212 "MagickCore/cache-view.c"
...
# 212 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 212, __extension__ __PRETTY_FUNCTION__); }))
# 212 "MagickCore/cache-view.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache-view.c",__func__,(unsigned long) 214,"%s",
      cache_view->image->filename);
  clone_view=(CacheView *) __builtin_assume_aligned((AcquireAlignedMemory(1, sizeof(*clone_view))),(8 * 8))
                         ;
  if (clone_view == (CacheView *) 
# 218 "MagickCore/cache-view.c" 3 4
                                 ((void *)0)
# 218 "MagickCore/cache-view.c"
                                     )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 219 "MagickCore/cache-view.c" 3 4
   (*__errno_location ())
# 219 "MagickCore/cache-view.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/cache-view.c",__func__,(unsigned long) 219,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
...
# 253 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) CacheView *DestroyCacheView(CacheView *cache_view)
{
  
# 255 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 255 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 255 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 255 "MagickCore/cache-view.c"
...
# 255 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 255 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 255, __extension__ __PRETTY_FUNCTION__); }))
# 255 "MagickCore/cache-view.c"
                                         ;
  
# 256 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 256 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 256 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 256 "MagickCore/cache-view.c"
...
# 256 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 256 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 256, __extension__ __PRETTY_FUNCTION__); }))
# 256 "MagickCore/cache-view.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache-view.c",__func__,(unsigned long) 258,"%s",
      cache_view->image->filename);
  if (cache_view->nexus_info != (NexusInfo **) 
# 260 "MagickCore/cache-view.c" 3 4
                                              ((void *)0)
# 260 "MagickCore/cache-view.c"
                                                  )
...
# 300 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) Quantum *GetCacheViewAuthenticPixels(CacheView *cache_view,
...
# 310 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 310 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 310 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 310 "MagickCore/cache-view.c"
...
# 310 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 310 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 310, __extension__ __PRETTY_FUNCTION__); }))
# 310 "MagickCore/cache-view.c"
                                         ;
  
# 311 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 311 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 311 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 311 "MagickCore/cache-view.c"
...
# 311 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 311 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 311, __extension__ __PRETTY_FUNCTION__); }))
# 311 "MagickCore/cache-view.c"
                                                     ;
  
# 312 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 312 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 312 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 312 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
...
# 312 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 312 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 312, __extension__ __PRETTY_FUNCTION__); }))
# 312 "MagickCore/cache-view.c"
                                              ;
...
# 343 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) void *GetCacheViewAuthenticMetacontent(CacheView *cache_view)
{
  const int
    id = GetOpenMPThreadId();

  
# 348 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 348 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 348 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 348 "MagickCore/cache-view.c"
...
# 348 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 348 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 348, __extension__ __PRETTY_FUNCTION__); }))
# 348 "MagickCore/cache-view.c"
                                         ;
  
# 349 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 349 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 349 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 349 "MagickCore/cache-view.c"
...
# 349 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 349 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 349, __extension__ __PRETTY_FUNCTION__); }))
# 349 "MagickCore/cache-view.c"
                                                     ;
  
# 350 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 350 "MagickCore/cache-view.c"
 cache_view->image->cache != (Cache) 
# 350 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 350 "MagickCore/cache-view.c"
 cache_view->image->cache != (Cache) 
# 350 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 350 "MagickCore/cache-view.c"
 "cache_view->image->cache != (Cache) NULL"
# 350 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 350, __extension__ __PRETTY_FUNCTION__); }))
# 350 "MagickCore/cache-view.c"
                                                 ;
  
# 351 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 351 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 351 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 351 "MagickCore/cache-view.c"
...
# 351 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 351 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 351, __extension__ __PRETTY_FUNCTION__); }))
# 351 "MagickCore/cache-view.c"
                                              ;
  return(cache_view->nexus_info[id]->metacontent);
}
# 380 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) Quantum *GetCacheViewAuthenticPixelQueue(CacheView *cache_view)
{
  const int
    id = GetOpenMPThreadId();

  
# 385 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 385 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 385 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 385 "MagickCore/cache-view.c"
...
# 385 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 385 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 385, __extension__ __PRETTY_FUNCTION__); }))
# 385 "MagickCore/cache-view.c"
                                         ;
  
# 386 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 386 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 386 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 386 "MagickCore/cache-view.c"
...
# 386 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 386 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 386, __extension__ __PRETTY_FUNCTION__); }))
# 386 "MagickCore/cache-view.c"
                                                     ;
  
# 387 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 387 "MagickCore/cache-view.c"
 cache_view->image->cache != (Cache) 
# 387 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 387 "MagickCore/cache-view.c"
...
# 387 "MagickCore/cache-view.c"
 "cache_view->image->cache != (Cache) NULL"
# 387 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 387, __extension__ __PRETTY_FUNCTION__); }))
# 387 "MagickCore/cache-view.c"
                                                 ;
  
# 388 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 388 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 388 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 388 "MagickCore/cache-view.c"
...
# 388 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 388 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 388, __extension__ __PRETTY_FUNCTION__); }))
# 388 "MagickCore/cache-view.c"
                                              ;
  return(cache_view->nexus_info[id]->pixels);
}
# 415 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) ColorspaceType GetCacheViewColorspace(const CacheView *cache_view)
{
  
# 417 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 417 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 417 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 417 "MagickCore/cache-view.c"
...
# 417 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 417 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 417, __extension__ __PRETTY_FUNCTION__); }))
# 417 "MagickCore/cache-view.c"
                                         ;
  
# 418 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 418 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 418 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 418 "MagickCore/cache-view.c"
...
# 418 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 418 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 418, __extension__ __PRETTY_FUNCTION__); }))
# 418 "MagickCore/cache-view.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache-view.c",__func__,(unsigned long) 420,"%s",
      cache_view->image->filename);
  return(GetPixelCacheColorspace(cache_view->image->cache));
}
# 449 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) MagickSizeType GetCacheViewExtent(const CacheView *cache_view)
{
  const int
    id = GetOpenMPThreadId();
...
# 457 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 457 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 457 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 457 "MagickCore/cache-view.c"
...
# 457 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 457 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 457, __extension__ __PRETTY_FUNCTION__); }))
# 457 "MagickCore/cache-view.c"
                                         ;
  
# 458 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 458 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 458 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 458 "MagickCore/cache-view.c"
...
# 458 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 458 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 458, __extension__ __PRETTY_FUNCTION__); }))
# 458 "MagickCore/cache-view.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache-view.c",__func__,(unsigned long) 460,"%s",
      cache_view->image->filename);
  
# 462 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 462 "MagickCore/cache-view.c"
 cache_view->image->cache != (Cache) 
# 462 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 462 "MagickCore/cache-view.c"
...
# 462 "MagickCore/cache-view.c"
 "cache_view->image->cache != (Cache) NULL"
# 462 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 462, __extension__ __PRETTY_FUNCTION__); }))
# 462 "MagickCore/cache-view.c"
                                                 ;
  
# 463 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 463 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 463 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 463 "MagickCore/cache-view.c"
...
# 463 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 463 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 463, __extension__ __PRETTY_FUNCTION__); }))
# 463 "MagickCore/cache-view.c"
                                              ;
...
# 491 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) const Image *GetCacheViewImage(const CacheView *cache_view)
{
  
# 493 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 493 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 493 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 493 "MagickCore/cache-view.c"
...
# 493 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 493 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 493, __extension__ __PRETTY_FUNCTION__); }))
# 493 "MagickCore/cache-view.c"
                                         ;
  
# 494 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 494 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 494 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 494 "MagickCore/cache-view.c"
...
# 494 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 494 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 494, __extension__ __PRETTY_FUNCTION__); }))
# 494 "MagickCore/cache-view.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache-view.c",__func__,(unsigned long) 496,"%s",
      cache_view->image->filename);
  return(cache_view->image);
}
# 524 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) ClassType GetCacheViewStorageClass(const CacheView *cache_view)
{
  
# 526 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 526 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 526 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 526 "MagickCore/cache-view.c"
...
# 526 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 526 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 526, __extension__ __PRETTY_FUNCTION__); }))
# 526 "MagickCore/cache-view.c"
                                         ;
  
# 527 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 527 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 527 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 527 "MagickCore/cache-view.c"
...
# 527 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 527 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 527, __extension__ __PRETTY_FUNCTION__); }))
# 527 "MagickCore/cache-view.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache-view.c",__func__,(unsigned long) 529,"%s",
      cache_view->image->filename);
  return(GetPixelCacheStorageClass(cache_view->image->cache));
}
# 559 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) const void *GetCacheViewVirtualMetacontent(
...
# 568 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 568 "MagickCore/cache-view.c"
 cache_view != (const CacheView *) 
# 568 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 568 "MagickCore/cache-view.c"
 cache_view != (const CacheView *) 
# 568 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 568 "MagickCore/cache-view.c"
 "cache_view != (const CacheView *) NULL"
# 568 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 568, __extension__ __PRETTY_FUNCTION__); }))
# 568 "MagickCore/cache-view.c"
                                               ;
  
# 569 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 569 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 569 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 569 "MagickCore/cache-view.c"
...
# 569 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 569 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 569, __extension__ __PRETTY_FUNCTION__); }))
# 569 "MagickCore/cache-view.c"
                                                     ;
  
# 570 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 570 "MagickCore/cache-view.c"
 cache_view->image->cache != (Cache) 
# 570 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 570 "MagickCore/cache-view.c"
...
# 570 "MagickCore/cache-view.c"
 "cache_view->image->cache != (Cache) NULL"
# 570 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 570, __extension__ __PRETTY_FUNCTION__); }))
# 570 "MagickCore/cache-view.c"
                                                 ;
  
# 571 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 571 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 571 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 571 "MagickCore/cache-view.c"
...
# 571 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 571 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 571, __extension__ __PRETTY_FUNCTION__); }))
# 571 "MagickCore/cache-view.c"
                                              ;
...
# 602 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) const Quantum *GetCacheViewVirtualPixelQueue(
  const CacheView *cache_view)
{
  const int
    id = GetOpenMPThreadId();
...
# 611 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 611 "MagickCore/cache-view.c"
 cache_view != (const CacheView *) 
# 611 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 611 "MagickCore/cache-view.c"
...
# 611 "MagickCore/cache-view.c"
 "cache_view != (const CacheView *) NULL"
# 611 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 611, __extension__ __PRETTY_FUNCTION__); }))
# 611 "MagickCore/cache-view.c"
                                               ;
  
# 612 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 612 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 612 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 612 "MagickCore/cache-view.c"
...
# 612 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 612 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 612, __extension__ __PRETTY_FUNCTION__); }))
# 612 "MagickCore/cache-view.c"
                                                     ;
  
# 613 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 613 "MagickCore/cache-view.c"
 cache_view->image->cache != (Cache) 
# 613 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 613 "MagickCore/cache-view.c"
...
# 613 "MagickCore/cache-view.c"
 "cache_view->image->cache != (Cache) NULL"
# 613 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 613, __extension__ __PRETTY_FUNCTION__); }))
# 613 "MagickCore/cache-view.c"
                                                 ;
  
# 614 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 614 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 614 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 614 "MagickCore/cache-view.c"
...
# 614 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 614 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 614, __extension__ __PRETTY_FUNCTION__); }))
# 614 "MagickCore/cache-view.c"
                                              ;
...
# 652 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) const Quantum *GetCacheViewVirtualPixels(
...
# 662 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 662 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 662 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 662 "MagickCore/cache-view.c"
...
# 662 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 662 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 662, __extension__ __PRETTY_FUNCTION__); }))
# 662 "MagickCore/cache-view.c"
                                         ;
  
# 663 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 663 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 663 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 663 "MagickCore/cache-view.c"
...
# 663 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 663 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 663, __extension__ __PRETTY_FUNCTION__); }))
# 663 "MagickCore/cache-view.c"
                                                     ;
  
# 664 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 664 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 664 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 664 "MagickCore/cache-view.c"
...
# 664 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 664 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 664, __extension__ __PRETTY_FUNCTION__); }))
# 664 "MagickCore/cache-view.c"
                                              ;
...
# 702 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetOneCacheViewAuthenticPixel(
...
# 715 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 715 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 715 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 715 "MagickCore/cache-view.c"
...
# 715 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 715 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 715, __extension__ __PRETTY_FUNCTION__); }))
# 715 "MagickCore/cache-view.c"
                                         ;
  
# 716 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 716 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 716 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 716 "MagickCore/cache-view.c"
...
# 716 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 716 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 716, __extension__ __PRETTY_FUNCTION__); }))
# 716 "MagickCore/cache-view.c"
                                                     ;
  
# 717 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 717 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 717 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 717 "MagickCore/cache-view.c"
...
# 717 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 717 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 717, __extension__ __PRETTY_FUNCTION__); }))
# 717 "MagickCore/cache-view.c"
                                              ;
  ...
  q=GetAuthenticPixelCacheNexus(cache_view->image,x,y,1,1,
    cache_view->nexus_info[id],exception);
  if (q == (const Quantum *) 
# 721 "MagickCore/cache-view.c" 3 4
                            ((void *)0)
# 721 "MagickCore/cache-view.c"
                                )
    {
      PixelInfo
        background_color;
...
# 774 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetOneCacheViewVirtualPixel(
  const CacheView *cache_view,const ssize_t x,const ssize_t y,Quantum *pixel,
  ExceptionInfo *exception)
{
  const int
...
# 787 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 787 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 787 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 787 "MagickCore/cache-view.c"
...
# 787 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 787 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 787, __extension__ __PRETTY_FUNCTION__); }))
# 787 "MagickCore/cache-view.c"
                                         ;
  
# 788 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 788 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 788 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 788 "MagickCore/cache-view.c"
...
# 788 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 788 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 788, __extension__ __PRETTY_FUNCTION__); }))
# 788 "MagickCore/cache-view.c"
                                                     ;
  
# 789 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 789 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 789 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 789 "MagickCore/cache-view.c"
...
# 789 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 789 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 789, __extension__ __PRETTY_FUNCTION__); }))
# 789 "MagickCore/cache-view.c"
                                              ;
  (void) memset(pixel,0,64*sizeof(*pixel));
  p=GetVirtualPixelCacheNexus(cache_view->image,
    ...
    exception);
  if (p == (const Quantum *) 
# 794 "MagickCore/cache-view.c" 3 4
                            ((void *)0)
# 794 "MagickCore/cache-view.c"
                                )
    {
      PixelInfo
        background_color;
...
# 847 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetOneCacheViewVirtualPixelInfo(
...
# 857 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 857 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 857 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 857 "MagickCore/cache-view.c"
...
# 857 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 857 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 857, __extension__ __PRETTY_FUNCTION__); }))
# 857 "MagickCore/cache-view.c"
                                         ;
  
# 858 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 858 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 858 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 858 "MagickCore/cache-view.c"
...
# 858 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 858 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 858, __extension__ __PRETTY_FUNCTION__); }))
# 858 "MagickCore/cache-view.c"
                                                     ;
  
# 859 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 859 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 859 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 859 "MagickCore/cache-view.c"
...
# 859 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 859 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 859, __extension__ __PRETTY_FUNCTION__); }))
# 859 "MagickCore/cache-view.c"
                                              ;
  ...
  p=GetVirtualPixelCacheNexus(cache_view->image,
    ...
    exception);
  if (p == (const Quantum *) 
# 864 "MagickCore/cache-view.c" 3 4
                            ((void *)0)
# 864 "MagickCore/cache-view.c"
                                )
    return(MagickFalse);
  GetPixelInfoPixel(cache_view->image,p,pixel);
  return(MagickTrue);
}
# 906 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetOneCacheViewVirtualMethodPixel(
...
# 919 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 919 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 919 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 919 "MagickCore/cache-view.c"
...
# 919 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 919 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 919, __extension__ __PRETTY_FUNCTION__); }))
# 919 "MagickCore/cache-view.c"
                                         ;
  
# 920 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 920 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 920 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 920 "MagickCore/cache-view.c"
...
# 920 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 920 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 920, __extension__ __PRETTY_FUNCTION__); }))
# 920 "MagickCore/cache-view.c"
                                                     ;
  
# 921 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 921 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 921 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 921 "MagickCore/cache-view.c"
...
# 921 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 921 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 921, __extension__ __PRETTY_FUNCTION__); }))
# 921 "MagickCore/cache-view.c"
                                              ;
  (void) memset(pixel,0,64*sizeof(*pixel));
  p=GetVirtualPixelCacheNexus(cache_view->image,virtual_pixel_method,x,y,1,1,
    cache_view->nexus_info[id],exception);
  if (p == (const Quantum *) 
# 925 "MagickCore/cache-view.c" 3 4
                            ((void *)0)
# 925 "MagickCore/cache-view.c"
                                )
    {
      PixelInfo
        background_color;
...
# 978 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) Quantum *QueueCacheViewAuthenticPixels(CacheView *cache_view,
  const ssize_t x,const ssize_t y,const size_t columns,const size_t rows,
  ExceptionInfo *exception)
{
  const int
...
# 988 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 988 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 988 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 988 "MagickCore/cache-view.c"
...
# 988 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 988 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 988, __extension__ __PRETTY_FUNCTION__); }))
# 988 "MagickCore/cache-view.c"
                                         ;
  
# 989 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 989 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 989 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 989 "MagickCore/cache-view.c"
...
# 989 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 989 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 989, __extension__ __PRETTY_FUNCTION__); }))
# 989 "MagickCore/cache-view.c"
                                                     ;
  
# 990 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 990 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 990 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 990 "MagickCore/cache-view.c"
...
# 990 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 990 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 990, __extension__ __PRETTY_FUNCTION__); }))
# 990 "MagickCore/cache-view.c"
                                              ;
...
# 1024 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetCacheViewStorageClass(CacheView *cache_view,
  const ClassType storage_class,ExceptionInfo *exception)
{
  
# 1027 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 1027 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 1027 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1027 "MagickCore/cache-view.c"
...
# 1027 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 1027 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 1027, __extension__ __PRETTY_FUNCTION__); }))
# 1027 "MagickCore/cache-view.c"
                                         ;
  
# 1028 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 1028 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 1028 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1028 "MagickCore/cache-view.c"
...
# 1028 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 1028 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 1028, __extension__ __PRETTY_FUNCTION__); }))
# 1028 "MagickCore/cache-view.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache-view.c",__func__,(unsigned long) 1030,"%s",
      cache_view->image->filename);
  return(SetImageStorageClass(cache_view->image,storage_class,exception));
}
# 1061 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetCacheViewVirtualPixelMethod(
  CacheView *__restrict__ cache_view,
  const VirtualPixelMethod virtual_pixel_method)
{
  
# 1065 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 1065 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 1065 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1065 "MagickCore/cache-view.c"
...
# 1065 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 1065 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 1065, __extension__ __PRETTY_FUNCTION__); }))
# 1065 "MagickCore/cache-view.c"
                                         ;
  
# 1066 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 1066 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 1066 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1066 "MagickCore/cache-view.c"
...
# 1066 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 1066 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 1066, __extension__ __PRETTY_FUNCTION__); }))
# 1066 "MagickCore/cache-view.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache-view.c",__func__,(unsigned long) 1068,"%s",
      cache_view->image->filename);
  cache_view->virtual_pixel_method=virtual_pixel_method;
  return(MagickTrue);
}
# 1101 "MagickCore/cache-view.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SyncCacheViewAuthenticPixels(
  CacheView *__restrict__ cache_view,ExceptionInfo *exception)
{
  const int
    id = GetOpenMPThreadId();
...
# 1110 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 1110 "MagickCore/cache-view.c"
 cache_view != (CacheView *) 
# 1110 "MagickCore/cache-view.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1110 "MagickCore/cache-view.c"
...
# 1110 "MagickCore/cache-view.c"
 "cache_view != (CacheView *) NULL"
# 1110 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 1110, __extension__ __PRETTY_FUNCTION__); }))
# 1110 "MagickCore/cache-view.c"
                                         ;
  
# 1111 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 1111 "MagickCore/cache-view.c"
 cache_view->signature == 0xabacadabUL
# 1111 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1111 "MagickCore/cache-view.c"
...
# 1111 "MagickCore/cache-view.c"
 "cache_view->signature == MagickCoreSignature"
# 1111 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 1111, __extension__ __PRETTY_FUNCTION__); }))
# 1111 "MagickCore/cache-view.c"
                                                     ;
  
# 1112 "MagickCore/cache-view.c" 3 4
 ((void) sizeof ((
# 1112 "MagickCore/cache-view.c"
 id < (int) cache_view->number_threads
# 1112 "MagickCore/cache-view.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1112 "MagickCore/cache-view.c"
...
# 1112 "MagickCore/cache-view.c"
 "id < (int) cache_view->number_threads"
# 1112 "MagickCore/cache-view.c" 3 4
 , "MagickCore/cache-view.c", 1112, __extension__ __PRETTY_FUNCTION__); }))
# 1112 "MagickCore/cache-view.c"
                                              ;
