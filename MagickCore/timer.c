# 0 "MagickCore/timer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/timer.c"
# 43 "MagickCore/timer.c"
...
# 57 "MagickCore/timer.c" 2
# 68 "MagickCore/timer.c"
static double
  UserTime(void);
...
static ssize_t
  date_precision = -1;
# 99 "MagickCore/timer.c"
__attribute__ ((visibility ("default"))) TimerInfo *AcquireTimerInfo(void)
{
  TimerInfo
    *timer_info;
  ...
  timer_info->signature=0xabacadabUL;
  GetTimerInfo(timer_info);
  return(timer_info);
}
# 134 "MagickCore/timer.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ContinueTimer(TimerInfo *time_info)
{
  
# 136 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 136 "MagickCore/timer.c"
 time_info != (TimerInfo *) 
# 136 "MagickCore/timer.c" 3 4
...
# 136 "MagickCore/timer.c"
 "time_info != (TimerInfo *) NULL"
# 136 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 136, __extension__ __PRETTY_FUNCTION__); }))
# 136 "MagickCore/timer.c"
                                        ;
  
# 137 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 137 "MagickCore/timer.c"
 time_info->signature == 0xabacadabUL
# 137 "MagickCore/timer.c" 3 4
...
# 137 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "MagickCore/timer.c"
                                                    ;
...
# 172 "MagickCore/timer.c"
__attribute__ ((visibility ("default"))) TimerInfo *DestroyTimerInfo(TimerInfo *timer_info)
{
  
# 174 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 174 "MagickCore/timer.c"
...
# 174 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 174, __extension__ __PRETTY_FUNCTION__); }))
# 174 "MagickCore/timer.c"
                                         ;
  
# 175 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 175 "MagickCore/timer.c"
 timer_info->signature == 0xabacadabUL
# 175 "MagickCore/timer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 175 "MagickCore/timer.c"
...
# 175 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 175, __extension__ __PRETTY_FUNCTION__); }))
# 175 "MagickCore/timer.c"
                                                     ;
  timer_info->signature=(~0xabacadabUL);
...
# 200 "MagickCore/timer.c"
static double ElapsedTime(void)
{
# 216 "MagickCore/timer.c"
  struct timespec
    timer;

  (void) clock_gettime(
# 219 "MagickCore/timer.c" 3 4
                      4
# 219 "MagickCore/timer.c"
                              ,&timer);
  return((double) timer.tv_sec+timer.tv_nsec/1000000000.0);
# 233 "MagickCore/timer.c"
}
# 264 "MagickCore/timer.c"
__attribute__ ((visibility ("default"))) ssize_t FormatMagickTime(const time_t time,const size_t length,
  char *timestamp)
{
  ssize_t
    count;
...
# 273 "MagickCore/timer.c"
 "timestamp != (char *) NULL"
# 273 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 273, __extension__ __PRETTY_FUNCTION__); }))
# 273 "MagickCore/timer.c"
                                   ;
  if (date_precision == -1)
    {
      ...
      if (limit != (char *) 
# 281 "MagickCore/timer.c" 3 4
                           ((void *)0)
# 281 "MagickCore/timer.c"
                               )
        {
...
# 321 "MagickCore/timer.c"
__attribute__ ((visibility ("default"))) double GetElapsedTime(TimerInfo *time_info)
{
  
# 323 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 323 "MagickCore/timer.c"
 time_info != (TimerInfo *) 
# 323 "MagickCore/timer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 323 "MagickCore/timer.c"
...
# 323 "MagickCore/timer.c"
 "time_info != (TimerInfo *) NULL"
# 323 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 323, __extension__ __PRETTY_FUNCTION__); }))
# 323 "MagickCore/timer.c"
                                        ;
  
# 324 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 324 "MagickCore/timer.c"
 time_info->signature == 0xabacadabUL
# 324 "MagickCore/timer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 324 "MagickCore/timer.c"
...
# 324 "MagickCore/timer.c"
 "time_info->signature == MagickCoreSignature"
# 324 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 324, __extension__ __PRETTY_FUNCTION__); }))
# 324 "MagickCore/timer.c"
                                                    ;
  if (time_info->state == UndefinedTimerState)
    return(0.0);
...
# 350 "MagickCore/timer.c"
__attribute__ ((visibility ("default"))) time_t GetMagickTime(void)
{
  static time_t
...
# 364 "MagickCore/timer.c" 3 4
                                             ((void *)0)
# 364 "MagickCore/timer.c"
                                                 )
        {
          time_t
            epoch;
          ...
          if ((epoch > 0) && (epoch <= time((time_t *) 
# 370 "MagickCore/timer.c" 3 4
                                                      ((void *)0)
# 370 "MagickCore/timer.c"
                                                          )))
            magick_epoch=epoch;
        }
  ...
  if (magick_epoch != 0)
    return(magick_epoch);
  return(time((time_t *) 
# 377 "MagickCore/timer.c" 3 4
                        ((void *)0)
# 377 "MagickCore/timer.c"
                            ));
}
# 402 "MagickCore/timer.c"
__attribute__ ((visibility ("default"))) void GetTimerInfo(TimerInfo *time_info)
{



  
# 407 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 407 "MagickCore/timer.c"
 time_info != (TimerInfo *) 
# 407 "MagickCore/timer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 407 "MagickCore/timer.c"
...
# 407 "MagickCore/timer.c"
 "time_info != (TimerInfo *) NULL"
# 407 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 407, __extension__ __PRETTY_FUNCTION__); }))
# 407 "MagickCore/timer.c"
                                        ;
...
# 438 "MagickCore/timer.c"
__attribute__ ((visibility ("default"))) double GetUserTime(TimerInfo *time_info)
{
  
# 440 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 440 "MagickCore/timer.c"
 time_info != (TimerInfo *) 
# 440 "MagickCore/timer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 440 "MagickCore/timer.c"
...
# 440 "MagickCore/timer.c"
 "time_info != (TimerInfo *) NULL"
# 440 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 440, __extension__ __PRETTY_FUNCTION__); }))
# 440 "MagickCore/timer.c"
                                        ;
  
# 441 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 441 "MagickCore/timer.c"
 time_info->signature == 0xabacadabUL
# 441 "MagickCore/timer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 441 "MagickCore/timer.c"
...
# 441 "MagickCore/timer.c"
 "time_info->signature == MagickCoreSignature"
# 441 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 441, __extension__ __PRETTY_FUNCTION__); }))
# 441 "MagickCore/timer.c"
                                                    ;
  if (time_info->state == UndefinedTimerState)
    return(0.0);
...
# 471 "MagickCore/timer.c"
__attribute__ ((visibility ("default"))) void ResetTimer(TimerInfo *time_info)
{
  
# 473 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 473 "MagickCore/timer.c"
 time_info != (TimerInfo *) 
# 473 "MagickCore/timer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 473 "MagickCore/timer.c"
...
# 473 "MagickCore/timer.c"
 "time_info != (TimerInfo *) NULL"
# 473 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 473, __extension__ __PRETTY_FUNCTION__); }))
# 473 "MagickCore/timer.c"
                                        ;
  
# 474 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 474 "MagickCore/timer.c"
 time_info->signature == 0xabacadabUL
# 474 "MagickCore/timer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 474 "MagickCore/timer.c"
...
# 474 "MagickCore/timer.c"
 "time_info->signature == MagickCoreSignature"
# 474 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 474, __extension__ __PRETTY_FUNCTION__); }))
# 474 "MagickCore/timer.c"
                                                    ;
  StopTimer(time_info);
...
# 502 "MagickCore/timer.c"
__attribute__ ((visibility ("hidden"))) void SetMagickDatePrecision(const unsigned long precision)
{
  date_precision=(ssize_t) precision;
}
# 533 "MagickCore/timer.c"
__attribute__ ((visibility ("default"))) void StartTimer(TimerInfo *time_info,const MagickBooleanType reset)
{
  
# 535 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 535 "MagickCore/timer.c"
 time_info != (TimerInfo *) 
# 535 "MagickCore/timer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 535 "MagickCore/timer.c"
...
# 535 "MagickCore/timer.c"
 "time_info != (TimerInfo *) NULL"
# 535 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 535, __extension__ __PRETTY_FUNCTION__); }))
# 535 "MagickCore/timer.c"
                                        ;
  
# 536 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 536 "MagickCore/timer.c"
 time_info->signature == 0xabacadabUL
# 536 "MagickCore/timer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 536 "MagickCore/timer.c"
...
# 536 "MagickCore/timer.c"
 "time_info->signature == MagickCoreSignature"
# 536 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 536, __extension__ __PRETTY_FUNCTION__); }))
# 536 "MagickCore/timer.c"
                                                    ;
...
# 575 "MagickCore/timer.c"
static void StopTimer(TimerInfo *time_info)
{
  
# 577 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 577 "MagickCore/timer.c"
 time_info != (TimerInfo *) 
# 577 "MagickCore/timer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 577 "MagickCore/timer.c"
...
# 577 "MagickCore/timer.c"
 "time_info != (TimerInfo *) NULL"
# 577 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 577, __extension__ __PRETTY_FUNCTION__); }))
# 577 "MagickCore/timer.c"
                                        ;
  
# 578 "MagickCore/timer.c" 3 4
 ((void) sizeof ((
# 578 "MagickCore/timer.c"
 time_info->signature == 0xabacadabUL
# 578 "MagickCore/timer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 578 "MagickCore/timer.c"
...
# 578 "MagickCore/timer.c"
 "time_info->signature == MagickCoreSignature"
# 578 "MagickCore/timer.c" 3 4
 , "MagickCore/timer.c", 578, __extension__ __PRETTY_FUNCTION__); }))
# 578 "MagickCore/timer.c"
                                                    ;
  ...
  if (time_info->state == RunningTimerState)
    {
      time_info->user.total+=time_info->user.stop-
        time_info->user.start+1.0e-12;
      time_info->elapsed.total+=time_info->elapsed.stop-
        time_info->elapsed.start+1.0e-12;
    }
  time_info->state=StoppedTimerState;
}
# 610 "MagickCore/timer.c"
static double UserTime(void)
{
  ...
  (void) times(&timer);
  return((double) (timer.tms_utime+timer.tms_stime)/sysconf(
# 617 "MagickCore/timer.c" 3 4
                                                           _SC_CLK_TCK
# 617 "MagickCore/timer.c"
                                                                      ));
