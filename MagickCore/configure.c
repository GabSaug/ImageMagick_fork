# 0 "MagickCore/configure.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/configure.c"
# 42 "MagickCore/configure.c"
...
# 62 "MagickCore/configure.c" 2
# 71 "MagickCore/configure.c"
...
static LinkedListInfo
  *configure_cache = (LinkedListInfo *) 
# 83 "MagickCore/configure.c" 3 4
                                       ((void *)0)
# 83 "MagickCore/configure.c"
                                           ;

static SemaphoreInfo
  *configure_semaphore = (SemaphoreInfo *) 
# 86 "MagickCore/configure.c" 3 4
                                          ((void *)0)
# 86 "MagickCore/configure.c"
                                              ;
  ...
  const char *name,const char *value,MagickBooleanType exempt)
{
  ...
  if (configure_info == (ConfigureInfo *) 
# 133 "MagickCore/configure.c" 3 4
                                         ((void *)0)
# 133 "MagickCore/configure.c"
                                             )
    return;
  ...
  configure_info->signature=0xabacadabUL;
...
# 180 "MagickCore/configure.c" 3 4
                                         ((void *)0)
# 180 "MagickCore/configure.c"
                                             )
    {
  ...
  AddConfigureKey(cache,"[built-in]","QuantumDepth",GetMagickQuantumDepth(
    (size_t *)
# 202 "MagickCore/configure.c" 3 4
             ((void *)0)
# 202 "MagickCore/configure.c"
                 ),MagickTrue);
...
# 232 "MagickCore/configure.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType ConfigureComponentGenesis(void)
{
  if (configure_semaphore == (SemaphoreInfo *) 
# 234 "MagickCore/configure.c" 3 4
                                              ((void *)0)
# 234 "MagickCore/configure.c"
                                                  )
    configure_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 258 "MagickCore/configure.c"
static void *DestroyConfigureElement(void *configure_info)
{
  ...
  if (p->exempt == MagickFalse)
    {
      if (p->value != (char *) 
# 266 "MagickCore/configure.c" 3 4
                              ((void *)0)
# 266 "MagickCore/configure.c"
                                  )
        p->value=DestroyString(p->value);
      if (p->name != (char *) 
# 268 "MagickCore/configure.c" 3 4
                             ((void *)0)
# 268 "MagickCore/configure.c"
                                 )
        p->name=DestroyString(p->name);
      if (p->path != (char *) 
# 270 "MagickCore/configure.c" 3 4
                             ((void *)0)
# 270 "MagickCore/configure.c"
                                 )
        p->path=DestroyString(p->path);
    }
  p=(ConfigureInfo *) RelinquishMagickMemory(p);
  return((void *) 
# 274 "MagickCore/configure.c" 3 4
                 ((void *)0)
# 274 "MagickCore/configure.c"
                     );
}

__attribute__ ((visibility ("hidden"))) void ConfigureComponentTerminus(void)
{
  if (configure_semaphore == (SemaphoreInfo *) 
# 279 "MagickCore/configure.c" 3 4
                                              ((void *)0)
# 279 "MagickCore/configure.c"
                                                  )
    ActivateSemaphoreInfo(&configure_semaphore);
  LockSemaphoreInfo(configure_semaphore);
  if (configure_cache != (LinkedListInfo *) 
# 282 "MagickCore/configure.c" 3 4
                                           ((void *)0)
# 282 "MagickCore/configure.c"
                                               )
    configure_cache=DestroyLinkedList(configure_cache,DestroyConfigureElement);
  configure_cache=(LinkedListInfo *) 
# 284 "MagickCore/configure.c" 3 4
                                    ((void *)0)
# 284 "MagickCore/configure.c"
                                        ;
  UnlockSemaphoreInfo(configure_semaphore);
  RelinquishSemaphoreInfo(&configure_semaphore);
}
# 313 "MagickCore/configure.c"
static void *DestroyOptions(void *option)
{
  return(DestroyStringInfo((StringInfo *) option));
}

__attribute__ ((visibility ("default"))) LinkedListInfo *DestroyConfigureOptions(LinkedListInfo *options)
{
  
# 320 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 320 "MagickCore/configure.c"
 options != (LinkedListInfo *) 
# 320 "MagickCore/configure.c" 3 4
...
# 320 "MagickCore/configure.c"
 "options != (LinkedListInfo *) NULL"
# 320 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 320, __extension__ __PRETTY_FUNCTION__); }))
# 320 "MagickCore/configure.c"
                                           ;
  return(DestroyLinkedList(options,DestroyOptions));
}
# 353 "MagickCore/configure.c"
__attribute__ ((visibility ("default"))) const ConfigureInfo *GetConfigureInfo(const char *name,
  ExceptionInfo *exception)
{
  const ConfigureInfo
    *option;
...
# 362 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 362 "MagickCore/configure.c"
...
# 362 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 362, __extension__ __PRETTY_FUNCTION__); }))
# 362 "MagickCore/configure.c"
                                            ;
  if (IsConfigureCacheInstantiated(exception) == MagickFalse)
    return((const ConfigureInfo *) 
# 364 "MagickCore/configure.c" 3 4
                                  ((void *)0)
# 364 "MagickCore/configure.c"
                                      );



  option=(const ConfigureInfo *) 
# 368 "MagickCore/configure.c" 3 4
                                ((void *)0)
# 368 "MagickCore/configure.c"
                                    ;
  LockSemaphoreInfo(configure_semaphore);
  p=GetHeadElementInLinkedList(configure_cache);
  if ((name == (const char *) 
# 371 "MagickCore/configure.c" 3 4
                             ((void *)0)
# 371 "MagickCore/configure.c"
                                 ) || (LocaleCompare(name,"*") == 0))
    {
      UnlockSemaphoreInfo(configure_semaphore);
      if (p != (ElementInfo *) 
# 374 "MagickCore/configure.c" 3 4
                              ((void *)0)
# 374 "MagickCore/configure.c"
                                  )
        option=(const ConfigureInfo *) p->value;
      return(option);
    }
  while (p != (ElementInfo *) 
# 378 "MagickCore/configure.c" 3 4
                             ((void *)0)
# 378 "MagickCore/configure.c"
                                 )
  {
    option=(const ConfigureInfo *) p->value;
  ...
  if (p == (ElementInfo *) 
# 385 "MagickCore/configure.c" 3 4
                          ((void *)0)
# 385 "MagickCore/configure.c"
                              )
    option=(const ConfigureInfo *) 
# 386 "MagickCore/configure.c" 3 4
                                  ((void *)0)
# 386 "MagickCore/configure.c"
                                      ;
  else
...
__attribute__ ((visibility ("default"))) const ConfigureInfo **GetConfigureInfoList(const char *pattern,
...
# 456 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 456 "MagickCore/configure.c"
 pattern != (char *) 
# 456 "MagickCore/configure.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 456 "MagickCore/configure.c"
...
# 456 "MagickCore/configure.c"
 "pattern != (char *) NULL"
# 456 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 456, __extension__ __PRETTY_FUNCTION__); }))
# 456 "MagickCore/configure.c"
                                 ;
  
# 457 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 457 "MagickCore/configure.c"
 number_options != (size_t *) 
# 457 "MagickCore/configure.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 457 "MagickCore/configure.c"
 number_options != (size_t *) 
# 457 "MagickCore/configure.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 457 "MagickCore/configure.c"
 "number_options != (size_t *) NULL"
# 457 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 457, __extension__ __PRETTY_FUNCTION__); }))
# 457 "MagickCore/configure.c"
                                          ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/configure.c",__func__,(unsigned long) 459,"%s",pattern);
  *number_options=0;
  if (IsConfigureCacheInstantiated(exception) == MagickFalse)
    return((const ConfigureInfo **) 
# 462 "MagickCore/configure.c" 3 4
                                   ((void *)0)
# 462 "MagickCore/configure.c"
                                       );
  ...
  if (options == (const ConfigureInfo **) 
# 465 "MagickCore/configure.c" 3 4
                                         ((void *)0)
# 465 "MagickCore/configure.c"
                                             )
    return((const ConfigureInfo **) 
# 466 "MagickCore/configure.c" 3 4
                                   ((void *)0)
# 466 "MagickCore/configure.c"
                                       );
  LockSemaphoreInfo(configure_semaphore);
  p=GetHeadElementInLinkedList(configure_cache);
  for (i=0; p != (ElementInfo *) 
# 469 "MagickCore/configure.c" 3 4
                                ((void *)0)
# 469 "MagickCore/configure.c"
                                    ; )
  {
    const ConfigureInfo
      *option;
  ...
  if (i == 0)
  ...
  else
    {
      ...
      options[i]=(ConfigureInfo *) 
# 486 "MagickCore/configure.c" 3 4
                                  ((void *)0)
# 486 "MagickCore/configure.c"
                                      ;
    }
  *number_options=(size_t) i;
  return(options);
}
# 525 "MagickCore/configure.c"
...
__attribute__ ((visibility ("default"))) char **GetConfigureList(const char *pattern,
  size_t *number_options,ExceptionInfo *exception)
{
  char
    **options;
...
# 552 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 552 "MagickCore/configure.c"
 pattern != (char *) 
# 552 "MagickCore/configure.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 552 "MagickCore/configure.c"
...
# 552 "MagickCore/configure.c"
 "pattern != (char *) NULL"
# 552 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 552, __extension__ __PRETTY_FUNCTION__); }))
# 552 "MagickCore/configure.c"
                                 ;
  
# 553 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 553 "MagickCore/configure.c"
 number_options != (size_t *) 
# 553 "MagickCore/configure.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 553 "MagickCore/configure.c"
...
# 553 "MagickCore/configure.c"
 "number_options != (size_t *) NULL"
# 553 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 553, __extension__ __PRETTY_FUNCTION__); }))
# 553 "MagickCore/configure.c"
                                          ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/configure.c",__func__,(unsigned long) 555,"%s",pattern);
  *number_options=0;
  if (IsConfigureCacheInstantiated(exception) == MagickFalse)
    return((char **) 
# 558 "MagickCore/configure.c" 3 4
                    ((void *)0)
# 558 "MagickCore/configure.c"
                        );
  options=(char **) AcquireQuantumMemory((size_t)
    GetNumberOfElementsInLinkedList(configure_cache)+1UL,sizeof(*options));
  if (options == (char **) 
# 561 "MagickCore/configure.c" 3 4
                          ((void *)0)
# 561 "MagickCore/configure.c"
                              )
    return((char **) 
# 562 "MagickCore/configure.c" 3 4
                    ((void *)0)
# 562 "MagickCore/configure.c"
                        );
  LockSemaphoreInfo(configure_semaphore);
  p=GetHeadElementInLinkedList(configure_cache);
  for (i=0; p != (ElementInfo *) 
# 565 "MagickCore/configure.c" 3 4
                                ((void *)0)
# 565 "MagickCore/configure.c"
                                    ; )
  {
    const ConfigureInfo
      *option;
  ...
  if (i == 0)
  ...
  else
    {
      ...
      options[i]=(char *) 
# 582 "MagickCore/configure.c" 3 4
                         ((void *)0)
# 582 "MagickCore/configure.c"
                             ;
    }
  *number_options=(size_t) i;
  return(options);
}
# 610 "MagickCore/configure.c"
__attribute__ ((visibility ("default"))) char *GetConfigureOption(const char *option)
{
  const char
    *value;
...
# 621 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 621 "MagickCore/configure.c"
 option != (const char *) 
# 621 "MagickCore/configure.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 621 "MagickCore/configure.c"
...
# 621 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 621, __extension__ __PRETTY_FUNCTION__); }))
# 621 "MagickCore/configure.c"
                                      ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/configure.c",__func__,(unsigned long) 623,"%s",option);
  exception=AcquireExceptionInfo();
  configure_info=GetConfigureInfo(option,exception);
  exception=DestroyExceptionInfo(exception);
  if (configure_info == (ConfigureInfo *) 
# 627 "MagickCore/configure.c" 3 4
                                         ((void *)0)
# 627 "MagickCore/configure.c"
                                             )
    return((char *) 
# 628 "MagickCore/configure.c" 3 4
                   ((void *)0)
# 628 "MagickCore/configure.c"
                       );
  value=GetConfigureValue(configure_info);
  if ((value == (const char *) 
# 630 "MagickCore/configure.c" 3 4
                              ((void *)0)
# 630 "MagickCore/configure.c"
                                  ) || (*value == '\0'))
    return((char *) 
# 631 "MagickCore/configure.c" 3 4
                   ((void *)0)
# 631 "MagickCore/configure.c"
                       );
  return(ConstantString(value));
}
# 661 "MagickCore/configure.c"
__attribute__ ((visibility ("default"))) LinkedListInfo *GetConfigureOptions(const char *filename,
  ExceptionInfo *exception)
{
  char
    path[4096];
...
# 677 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 677 "MagickCore/configure.c"
 filename != (const char *) 
# 677 "MagickCore/configure.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 677 "MagickCore/configure.c"
...
# 677 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 677, __extension__ __PRETTY_FUNCTION__); }))
# 677 "MagickCore/configure.c"
                                        ;
  
# 678 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 678 "MagickCore/configure.c"
 exception != (ExceptionInfo *) 
# 678 "MagickCore/configure.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 678 "MagickCore/configure.c"
...
# 678 "MagickCore/configure.c"
 "exception != (ExceptionInfo *) NULL"
# 678 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 678, __extension__ __PRETTY_FUNCTION__); }))
# 678 "MagickCore/configure.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/configure.c",__func__,(unsigned long) 680,"%s",filename);
...
# 687 "MagickCore/configure.c" 3 4
                                 ((void *)0)
# 687 "MagickCore/configure.c"
                                     )
    {
      ResetLinkedListIterator(paths);
      element=(const char *) GetNextValueInLinkedList(paths);
      while (element != (const char *) 
# 691 "MagickCore/configure.c" 3 4
                                      ((void *)0)
# 691 "MagickCore/configure.c"
                                          )
      {
        (void) FormatLocaleString(path,4096,"%s%s",element,
          filename);
        (void) LogMagickEvent(ConfigureEvent,"MagickCore/configure.c",__func__,(unsigned long) 695,
          "Searching for configure file: \"%s\"",path);
        xml=ConfigureFileToStringInfo(path);
        if (xml != (StringInfo *) 
# 698 "MagickCore/configure.c" 3 4
                                 ((void *)0)
# 698 "MagickCore/configure.c"
                                     )
...
# 721 "MagickCore/configure.c"
  if (GetNumberOfElementsInLinkedList(options) == 0)
    (void) ThrowMagickException(exception,"MagickCore/configure.c",__func__,(unsigned long) 722,ConfigureWarning,
      "UnableToOpenConfigureFile","`%s'",filename);
  ResetLinkedListIterator(options);
  return(options);
}
# 754 "MagickCore/configure.c"
__attribute__ ((visibility ("default"))) LinkedListInfo *GetConfigurePaths(const char *filename,
  ExceptionInfo *exception)
{
  char
    path[4096];
...
# 763 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 763 "MagickCore/configure.c"
 filename != (const char *) 
# 763 "MagickCore/configure.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 763 "MagickCore/configure.c"
...
# 763 "MagickCore/configure.c"
 "filename != (const char *) NULL"
# 763 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 763, __extension__ __PRETTY_FUNCTION__); }))
# 763 "MagickCore/configure.c"
                                        ;
  
# 764 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 764 "MagickCore/configure.c"
 exception != (ExceptionInfo *) 
# 764 "MagickCore/configure.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 764 "MagickCore/configure.c"
...
# 764 "MagickCore/configure.c"
 "exception != (ExceptionInfo *) NULL"
# 764 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 764, __extension__ __PRETTY_FUNCTION__); }))
# 764 "MagickCore/configure.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/configure.c",__func__,(unsigned long) 766,"%s",filename);
  (void) CopyMagickString(path,filename,4096);
  paths=NewLinkedList(0);
  {
    ...
    if (configure_path != (char *) 
# 777 "MagickCore/configure.c" 3 4
                                  ((void *)0)
# 777 "MagickCore/configure.c"
                                      )
      {
        char
          *p,
        ...
        for (p=configure_path-1; p != (char *) 
# 783 "MagickCore/configure.c" 3 4
                                              ((void *)0)
# 783 "MagickCore/configure.c"
                                                  ; )
        {
          (void) CopyMagickString(path,p+1,4096);
          q=strchr(path,':');
          if (q != (char *) 
# 787 "MagickCore/configure.c" 3 4
                           ((void *)0)
# 787 "MagickCore/configure.c"
                               )
            *q='\0';
  ...
  (void) AppendValueToLinkedList(paths,ConstantString("/home/gabriel/ImageMagick/build/share/ImageMagick-7/"));


  (void) AppendValueToLinkedList(paths,ConstantString(
    "/home/gabriel/ImageMagick/build/lib/ImageMagick-7.1.1/" "/" "config" "-" "Q" "16" "HDRI" "/"));


  (void) AppendValueToLinkedList(paths,ConstantString(
    "/home/gabriel/ImageMagick/build/etc/ImageMagick-7/"));


  (void) AppendValueToLinkedList(paths,ConstantString(
    "/home/gabriel/ImageMagick/build/share/doc/ImageMagick-7/"));
# 893 "MagickCore/configure.c"
  {
    char
      *home;

    home=GetEnvironmentValue("XDG_CONFIG_HOME");
# 906 "MagickCore/configure.c"
    if (home != (char *) 
# 906 "MagickCore/configure.c" 3 4
                        ((void *)0)
# 906 "MagickCore/configure.c"
                            )
      {
        ...
        (void) FormatLocaleString(path,4096,"%s%sImageMagick%s",
          home,"/","/");
        (void) AppendValueToLinkedList(paths,ConstantString(path));
    ...
    if (home != (char *) 
# 917 "MagickCore/configure.c" 3 4
                        ((void *)0)
# 917 "MagickCore/configure.c"
                            )
      {
        ...
        (void) FormatLocaleString(path,4096,
          "%s%s.config%sImageMagick%s",home,"/",
          "/","/");
        (void) AppendValueToLinkedList(paths,ConstantString(path));
        home=DestroyString(home);
      }
  }
# 967 "MagickCore/configure.c"
  if (GetNumberOfElementsInLinkedList(paths) == 0)
    (void) ThrowMagickException(exception,"MagickCore/configure.c",__func__,(unsigned long) 968,ConfigureWarning,
      "no configuration paths found","`%s'",filename);
  return(paths);
}
# 995 "MagickCore/configure.c"
__attribute__ ((visibility ("default"))) const char *GetConfigureValue(const ConfigureInfo *configure_info)
{
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/configure.c",__func__,(unsigned long) 998,"...");
  
# 999 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 999 "MagickCore/configure.c"
...
# 999 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 999, __extension__ __PRETTY_FUNCTION__); }))
# 999 "MagickCore/configure.c"
                                                 ;
  
# 1000 "MagickCore/configure.c" 3 4
 ((void) sizeof ((
# 1000 "MagickCore/configure.c"
 configure_info->signature == 0xabacadabUL
# 1000 "MagickCore/configure.c" 3 4
...
# 1000 "MagickCore/configure.c" 3 4
 , "MagickCore/configure.c", 1000, __extension__ __PRETTY_FUNCTION__); }))
# 1000 "MagickCore/configure.c"
                                                         ;
  return(configure_info->value);
}
# 1027 "MagickCore/configure.c"
static MagickBooleanType IsConfigureCacheInstantiated(ExceptionInfo *exception)
{
  if (configure_cache == (LinkedListInfo *) 
# 1029 "MagickCore/configure.c" 3 4
                                           ((void *)0)
# 1029 "MagickCore/configure.c"
                                               )
    {
      if (configure_semaphore == (SemaphoreInfo *) 
# 1031 "MagickCore/configure.c" 3 4
                                                  ((void *)0)
# 1031 "MagickCore/configure.c"
                                                      )
        ActivateSemaphoreInfo(&configure_semaphore);
      LockSemaphoreInfo(configure_semaphore);
      if (configure_cache == (LinkedListInfo *) 
# 1034 "MagickCore/configure.c" 3 4
                                               ((void *)0)
# 1034 "MagickCore/configure.c"
                                                   )
        configure_cache=AcquireConfigureCache("configure.xml",exception);
      UnlockSemaphoreInfo(configure_semaphore);
    }
  return(configure_cache != (LinkedListInfo *) 
# 1038 "MagickCore/configure.c" 3 4
                                              ((void *)0) 
# 1038 "MagickCore/configure.c"
                                                   ? MagickTrue : MagickFalse);
}
# 1065 "MagickCore/configure.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListConfigureInfo(FILE *file,
  ExceptionInfo *exception)
{
  const char
    *name,
  ...
  if (file == (const FILE *) 
# 1085 "MagickCore/configure.c" 3 4
                            ((void *)0)
# 1085 "MagickCore/configure.c"
                                )
    file=
# 1086 "MagickCore/configure.c" 3 4
        stdout
# 1086 "MagickCore/configure.c"
              ;
  configure_info=GetConfigureInfoList("*",&number_options,exception);
  if (configure_info == (const ConfigureInfo **) 
# 1088 "MagickCore/configure.c" 3 4
                                                ((void *)0)
# 1088 "MagickCore/configure.c"
                                                    )
    return(MagickFalse);
  path=(const char *) 
# 1090 "MagickCore/configure.c" 3 4
                     ((void *)0)
# 1090 "MagickCore/configure.c"
                         ;
  for (i=0; i < (ssize_t) number_options; i++)
  {
    if (configure_info[i]->stealth != MagickFalse)
      continue;
    if ((path == (const char *) 
# 1095 "MagickCore/configure.c" 3 4
                               ((void *)0)
# 1095 "MagickCore/configure.c"
                                   ) ||
        (LocaleCompare(path,configure_info[i]->path) != 0))
      {
        if (configure_info[i]->path != (char *) 
# 1098 "MagickCore/configure.c" 3 4
                                               ((void *)0)
# 1098 "MagickCore/configure.c"
                                                   )
    ...
    name="unknown";
    if (configure_info[i]->name != (char *) 
# 1108 "MagickCore/configure.c" 3 4
                                           ((void *)0)
# 1108 "MagickCore/configure.c"
                                               )
    ...
    (void) FormatLocaleFile(file," ");
    value="unknown";
    if (configure_info[i]->value != (char *) 
# 1115 "MagickCore/configure.c" 3 4
                                            ((void *)0)
# 1115 "MagickCore/configure.c"
                                                )
  ...
  ExceptionInfo *exception)
{
  ...
  (void) LogMagickEvent(ConfigureEvent,"MagickCore/configure.c",__func__,(unsigned long) 1181,
    "Loading configure file \"%s\" ...",filename);
  status=MagickTrue;
  configure_info=(ConfigureInfo *) 
# 1184 "MagickCore/configure.c" 3 4
                                  ((void *)0)
# 1184 "MagickCore/configure.c"
                                      ;
    ...
    if (LocaleCompare(keyword,"<include") == 0)
      {
        ...
        while (((*token != '/') && (*(token+1) != '>')) && (*q != '\0'))
        {
          ...
          if (LocaleCompare(keyword,"file") == 0)
            {
              if (depth > 600)
                (void) ThrowMagickException(exception,"MagickCore/configure.c",__func__,(unsigned long) 1229,
              ...
              else
                {
                  ...
                  if (file_xml != (char *) 
# 1246 "MagickCore/configure.c" 3 4
                                          ((void *)0)
# 1246 "MagickCore/configure.c"
                                              )
                    {
    ...
    if (configure_info == (ConfigureInfo *) 
# 1270 "MagickCore/configure.c" 3 4
                                           ((void *)0)
# 1270 "MagickCore/configure.c"
                                               )
      continue;
    if ((LocaleCompare(keyword,"/>") == 0) ||
        (LocaleCompare(keyword,"</policy>") == 0))
      {
        ...
        if (status == MagickFalse)
          (void) ThrowMagickException(exception,"MagickCore/configure.c",__func__,(unsigned long) 1277,
            ResourceLimitError,"MemoryAllocationFailed","`%s'",
            configure_info->name);
        configure_info=(ConfigureInfo *) 
# 1280 "MagickCore/configure.c" 3 4
                                        ((void *)0)
# 1280 "MagickCore/configure.c"
                                            ;
        continue;
      }
...
# 1286 "MagickCore/configure.c" 3 4
                                         ((void *)0)
# 1286 "MagickCore/configure.c"
                                             ,extent,token);
    if (*token != '=')
      continue;
    (void) GetNextToken(q,&q,extent,token);
