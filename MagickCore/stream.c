# 0 "MagickCore/stream.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/stream.c"
# 43 "MagickCore/stream.c"
...
static Quantum
  *QueueAuthenticPixelsStream(Image *,const ssize_t,const ssize_t,const size_t,
    const size_t,ExceptionInfo *);
# 156 "MagickCore/stream.c"
__attribute__ ((visibility ("default"))) StreamInfo *AcquireStreamInfo(const ImageInfo *image_info,
  ExceptionInfo *exception)
{
  ...
  stream_info->pixels=(unsigned char *) __builtin_assume_aligned((AcquireAlignedMemory(1,sizeof(*stream_info->pixels))),(8 * 8))
                                                         ;
  if (stream_info->pixels == (unsigned char *) 
# 166 "MagickCore/stream.c" 3 4
                                              ((void *)0)
# 166 "MagickCore/stream.c"
                                                  )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 167 "MagickCore/stream.c" 3 4
   (*__errno_location ())
# 167 "MagickCore/stream.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/stream.c",__func__,(unsigned long) 167,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  stream_info->map=ConstantString("RGB");
  stream_info->storage_type=CharPixel;
  stream_info->stream=AcquireImage(image_info,exception);
  stream_info->signature=0xabacadabUL;
  return(stream_info);
}
# 198 "MagickCore/stream.c"
static inline void RelinquishStreamPixels(CacheInfo *cache_info)
{
  
# 200 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 200 "MagickCore/stream.c"
...
# 200 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 200, __extension__ __PRETTY_FUNCTION__); }))
# 200 "MagickCore/stream.c"
                                         ;
  if (cache_info->pixels != (Quantum *) 
# 201 "MagickCore/stream.c" 3 4
                                       ((void *)0)
# 201 "MagickCore/stream.c"
                                           )
    {
...
# 209 "MagickCore/stream.c" 3 4
                                        ((void *)0)
# 209 "MagickCore/stream.c"
                                            ;
        }
    }
  cache_info->mapped=MagickFalse;
  cache_info->metacontent=(void *) 
# 213 "MagickCore/stream.c" 3 4
                                  ((void *)0)
# 213 "MagickCore/stream.c"
                                      ;
  cache_info->length=0;
}
...
# 225 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 225 "MagickCore/stream.c"
 image != (Image *) 
# 225 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 225 "MagickCore/stream.c"
...
# 225 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 225 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 225, __extension__ __PRETTY_FUNCTION__); }))
# 225 "MagickCore/stream.c"
                                ;
  
# 226 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 226 "MagickCore/stream.c"
...
# 226 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 226, __extension__ __PRETTY_FUNCTION__); }))
# 226 "MagickCore/stream.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 228,"%s",image->filename);
  cache_info=(CacheInfo *) image->cache;
  
# 230 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 230 "MagickCore/stream.c"
...
# 230 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 230, __extension__ __PRETTY_FUNCTION__); }))
# 230 "MagickCore/stream.c"
                                                     ;
  destroy=MagickFalse;
...
# 240 "MagickCore/stream.c" 3 4
                                              ((void *)0)
# 240 "MagickCore/stream.c"
                                                  )
    cache_info->nexus_info=DestroyPixelCacheNexus(cache_info->nexus_info,
      cache_info->number_threads);
  if (cache_info->file_semaphore != (SemaphoreInfo *) 
# 243 "MagickCore/stream.c" 3 4
                                                     ((void *)0)
# 243 "MagickCore/stream.c"
                                                         )
    RelinquishSemaphoreInfo(&cache_info->file_semaphore);
  if (cache_info->semaphore != (SemaphoreInfo *) 
# 245 "MagickCore/stream.c" 3 4
                                                ((void *)0)
# 245 "MagickCore/stream.c"
                                                    )
    RelinquishSemaphoreInfo(&cache_info->semaphore);
  cache_info=(CacheInfo *) RelinquishAlignedMemory(cache_info);
}
# 273 "MagickCore/stream.c"
__attribute__ ((visibility ("default"))) StreamInfo *DestroyStreamInfo(StreamInfo *stream_info)
{
  
# 275 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 275 "MagickCore/stream.c"
...
# 275 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 275, __extension__ __PRETTY_FUNCTION__); }))
# 275 "MagickCore/stream.c"
                                           ;
  
# 276 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 276 "MagickCore/stream.c"
 stream_info->signature == 0xabacadabUL
# 276 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 276 "MagickCore/stream.c"
...
# 276 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 276, __extension__ __PRETTY_FUNCTION__); }))
# 276 "MagickCore/stream.c"
                                                      ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 278,"...");
  if (stream_info->map != (char *) 
# 279 "MagickCore/stream.c" 3 4
                                  ((void *)0)
# 279 "MagickCore/stream.c"
                                      )
    stream_info->map=DestroyString(stream_info->map);
  if (stream_info->pixels != (unsigned char *) 
# 281 "MagickCore/stream.c" 3 4
                                              ((void *)0)
# 281 "MagickCore/stream.c"
                                                  )
    stream_info->pixels=(unsigned char *) RelinquishAlignedMemory(
      stream_info->pixels);
  if (stream_info->stream != (Image *) 
# 284 "MagickCore/stream.c" 3 4
                                      ((void *)0)
# 284 "MagickCore/stream.c"
                                          )
    {
      (void) CloseBlob(stream_info->stream);
      stream_info->stream=DestroyImage(stream_info->stream);
    }
  if (stream_info->quantum_info != (QuantumInfo *) 
# 289 "MagickCore/stream.c" 3 4
                                                  ((void *)0)
# 289 "MagickCore/stream.c"
                                                      )
...
# 325 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 325 "MagickCore/stream.c"
 image != (Image *) 
# 325 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 325 "MagickCore/stream.c"
...
# 325 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 325 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 325, __extension__ __PRETTY_FUNCTION__); }))
# 325 "MagickCore/stream.c"
                                ;
  
# 326 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 326 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 326 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 326 "MagickCore/stream.c"
...
# 326 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 326 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 326, __extension__ __PRETTY_FUNCTION__); }))
# 326 "MagickCore/stream.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 328,"%s",image->filename);
  cache_info=(CacheInfo *) image->cache;
  
# 330 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 330 "MagickCore/stream.c"
 cache_info->signature == 0xabacadabUL
# 330 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 330 "MagickCore/stream.c"
...
# 330 "MagickCore/stream.c"
 "cache_info->signature == MagickCoreSignature"
# 330 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 330, __extension__ __PRETTY_FUNCTION__); }))
# 330 "MagickCore/stream.c"
                                                     ;
  return(cache_info->metacontent);
}
# 366 "MagickCore/stream.c"
...
# 373 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 373 "MagickCore/stream.c"
 image != (Image *) 
# 373 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 373 "MagickCore/stream.c"
...
# 373 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 373 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 373, __extension__ __PRETTY_FUNCTION__); }))
# 373 "MagickCore/stream.c"
                                ;
  
# 374 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 374 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 374 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 374 "MagickCore/stream.c"
...
# 374 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 374 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 374, __extension__ __PRETTY_FUNCTION__); }))
# 374 "MagickCore/stream.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 376,"%s",image->filename);
  pixels=QueueAuthenticPixelsStream(image,x,y,columns,rows,exception);
  return(pixels);
}
# 404 "MagickCore/stream.c"
...
# 409 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 409 "MagickCore/stream.c"
 image != (Image *) 
# 409 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 409 "MagickCore/stream.c"
...
# 409 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 409 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 409, __extension__ __PRETTY_FUNCTION__); }))
# 409 "MagickCore/stream.c"
                                ;
  
# 410 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 410 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 410 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 410 "MagickCore/stream.c"
...
# 410 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 410 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 410, __extension__ __PRETTY_FUNCTION__); }))
# 410 "MagickCore/stream.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 412,"%s",image->filename);
  cache_info=(CacheInfo *) image->cache;
  
# 414 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 414 "MagickCore/stream.c"
 cache_info->signature == 0xabacadabUL
# 414 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 414 "MagickCore/stream.c"
...
# 414 "MagickCore/stream.c"
 "cache_info->signature == MagickCoreSignature"
# 414 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 414, __extension__ __PRETTY_FUNCTION__); }))
# 414 "MagickCore/stream.c"
                                                     ;
  return(cache_info->pixels);
}
# 449 "MagickCore/stream.c"
...
# 458 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 458 "MagickCore/stream.c"
 image != (Image *) 
# 458 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 458 "MagickCore/stream.c"
...
# 458 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 458 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 458, __extension__ __PRETTY_FUNCTION__); }))
# 458 "MagickCore/stream.c"
                                ;
  
# 459 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 459 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 459 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 459 "MagickCore/stream.c"
...
# 459 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 459 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 459, __extension__ __PRETTY_FUNCTION__); }))
# 459 "MagickCore/stream.c"
                                                ;
  (void) memset(pixel,0,64*sizeof(*pixel));
  p=GetAuthenticPixelsStream(image,x,y,1,1,exception);
  if (p == (Quantum *) 
# 462 "MagickCore/stream.c" 3 4
                      ((void *)0)
# 462 "MagickCore/stream.c"
                          )
    {
...
# 522 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 522 "MagickCore/stream.c"
 image != (Image *) 
# 522 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 522 "MagickCore/stream.c"
...
# 522 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 522 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 522, __extension__ __PRETTY_FUNCTION__); }))
# 522 "MagickCore/stream.c"
                                ;
  
# 523 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 523 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 523 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 523 "MagickCore/stream.c"
...
# 523 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 523 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 523, __extension__ __PRETTY_FUNCTION__); }))
# 523 "MagickCore/stream.c"
                                                ;
  (void) memset(pixel,0,64*sizeof(*pixel));
  p=GetVirtualPixelStream(image,virtual_pixel_method,x,y,1,1,exception);
  if (p == (const Quantum *) 
# 526 "MagickCore/stream.c" 3 4
                            ((void *)0)
# 526 "MagickCore/stream.c"
                                )
    {
      pixel[RedPixelChannel]=ClampToQuantum(image->background_color.red);
      pixel[GreenPixelChannel]=ClampToQuantum(image->background_color.green);
...
# 565 "MagickCore/stream.c"
__attribute__ ((visibility ("hidden"))) const void *GetStreamInfoClientData(StreamInfo *stream_info)
{
  
# 567 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 567 "MagickCore/stream.c"
 stream_info != (StreamInfo *) 
# 567 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 567 "MagickCore/stream.c"
...
# 567 "MagickCore/stream.c"
 "stream_info != (StreamInfo *) NULL"
# 567 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 567, __extension__ __PRETTY_FUNCTION__); }))
# 567 "MagickCore/stream.c"
                                           ;
  
# 568 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 568 "MagickCore/stream.c"
 stream_info->signature == 0xabacadabUL
# 568 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 568 "MagickCore/stream.c"
...
# 568 "MagickCore/stream.c"
 "stream_info->signature == MagickCoreSignature"
# 568 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 568, __extension__ __PRETTY_FUNCTION__); }))
# 568 "MagickCore/stream.c"
                                                      ;
  return(stream_info->client_data);
}
# 598 "MagickCore/stream.c"
...
# 603 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 603 "MagickCore/stream.c"
 image != (Image *) 
# 603 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 603 "MagickCore/stream.c"
...
# 603 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 603 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 603, __extension__ __PRETTY_FUNCTION__); }))
# 603 "MagickCore/stream.c"
                                ;
  
# 604 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 604 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 604 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 604 "MagickCore/stream.c"
...
# 604 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 604 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 604, __extension__ __PRETTY_FUNCTION__); }))
# 604 "MagickCore/stream.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 606,"%s",image->filename);
  cache_info=(CacheInfo *) image->cache;
  
# 608 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 608 "MagickCore/stream.c"
 cache_info->signature == 0xabacadabUL
# 608 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 608 "MagickCore/stream.c"
...
# 608 "MagickCore/stream.c"
 "cache_info->signature == MagickCoreSignature"
# 608 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 608, __extension__ __PRETTY_FUNCTION__); }))
# 608 "MagickCore/stream.c"
                                                     ;
  return(cache_info->pixels);
}
# 636 "MagickCore/stream.c"
...
# 641 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 641 "MagickCore/stream.c"
 image != (Image *) 
# 641 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 641 "MagickCore/stream.c"
...
# 641 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 641 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 641, __extension__ __PRETTY_FUNCTION__); }))
# 641 "MagickCore/stream.c"
                                ;
  
# 642 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 642 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 642 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 642 "MagickCore/stream.c"
...
# 642 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 642 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 642, __extension__ __PRETTY_FUNCTION__); }))
# 642 "MagickCore/stream.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 644,"%s",image->filename);
  cache_info=(CacheInfo *) image->cache;
  
# 646 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 646 "MagickCore/stream.c"
 cache_info->signature == 0xabacadabUL
# 646 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 646 "MagickCore/stream.c"
...
# 646 "MagickCore/stream.c"
 "cache_info->signature == MagickCoreSignature"
# 646 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 646, __extension__ __PRETTY_FUNCTION__); }))
# 646 "MagickCore/stream.c"
                                                     ;
  return(cache_info->metacontent);
}
# 686 "MagickCore/stream.c"
  ...
  ExceptionInfo *exception)
{
  ...
  cache_info->pixels=(Quantum *) __builtin_assume_aligned((AcquireAlignedMemory(1, (size_t) cache_info->length)),(8 * 8))
                                 ;
  if (cache_info->pixels != (Quantum *) 
# 693 "MagickCore/stream.c" 3 4
                                       ((void *)0)
# 693 "MagickCore/stream.c"
                                           )
    (void) memset(cache_info->pixels,0,(size_t) cache_info->length);
  else
    {
      (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 697,
...
static const Quantum *GetVirtualPixelStream(const Image *image,
  const VirtualPixelMethod magick_unused_virtual_pixel_method __attribute__((unused)),const ssize_t x,
  const ssize_t y,const size_t columns,const size_t rows,
  ExceptionInfo *exception)
{
  CacheInfo
...
# 727 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 727 "MagickCore/stream.c"
 image != (const Image *) 
# 727 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 727 "MagickCore/stream.c"
...
# 727 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 727, __extension__ __PRETTY_FUNCTION__); }))
# 727 "MagickCore/stream.c"
                                      ;
  
# 728 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 728 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 728 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 728 "MagickCore/stream.c"
...
# 728 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 728 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 728, __extension__ __PRETTY_FUNCTION__); }))
# 728 "MagickCore/stream.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 730,"%s",image->filename);
  if ((x < 0) || (y < 0) ||
      ((x+(ssize_t) columns) > (ssize_t) image->columns) ||
      ((y+(ssize_t) rows) > (ssize_t) image->rows) ||
      (columns == 0) || (rows == 0))
    {
      (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 736,StreamError,
        "ImageDoesNotContainTheStreamGeometry","`%s'",image->filename);
      return((Quantum *) 
# 738 "MagickCore/stream.c" 3 4
                        ((void *)0)
# 738 "MagickCore/stream.c"
                            );
    }
  cache_info=(CacheInfo *) image->cache;
  
# 741 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 741 "MagickCore/stream.c"
 cache_info->signature == 0xabacadabUL
# 741 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 741 "MagickCore/stream.c"
...
# 741 "MagickCore/stream.c"
 "cache_info->signature == MagickCoreSignature"
# 741 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 741, __extension__ __PRETTY_FUNCTION__); }))
# 741 "MagickCore/stream.c"
                                                     ;
  ...
  if (cache_info->pixels == (Quantum *) 
# 751 "MagickCore/stream.c" 3 4
                                       ((void *)0)
# 751 "MagickCore/stream.c"
                                           )
    {
      ...
      if (status == MagickFalse)
        {
          cache_info->length=0;
          return((Quantum *) 
# 758 "MagickCore/stream.c" 3 4
                            ((void *)0)
# 758 "MagickCore/stream.c"
                                );
        }
    }
  else
        ...
        if (status == MagickFalse)
          {
            cache_info->length=0;
            return((Quantum *) 
# 770 "MagickCore/stream.c" 3 4
                              ((void *)0)
# 770 "MagickCore/stream.c"
                                  );
          }
      }
  cache_info->metacontent=(void *) 
# 773 "MagickCore/stream.c" 3 4
                                  ((void *)0)
# 773 "MagickCore/stream.c"
                                      ;
  if (cache_info->metacontent_extent != 0)
...
# 809 "MagickCore/stream.c"
__attribute__ ((visibility ("default"))) MagickBooleanType OpenStream(const ImageInfo *image_info,
...
# 878 "MagickCore/stream.c" 3 4
                                               ((void *)0)
# 878 "MagickCore/stream.c"
                                                   ))
    return(MagickFalse);
  return(MagickTrue);
}
...
# 905 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 905 "MagickCore/stream.c"
 image != (Image *) 
# 905 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 905 "MagickCore/stream.c"
...
# 905 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 905 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 905, __extension__ __PRETTY_FUNCTION__); }))
# 905 "MagickCore/stream.c"
                                ;
  if ((image->columns == 0) || (image->rows == 0) || (x < 0) ||
    ...
    {
      (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 910,StreamError,
        "ImageDoesNotContainTheStreamGeometry","`%s'",image->filename);
      return((Quantum *) 
# 912 "MagickCore/stream.c" 3 4
                        ((void *)0)
# 912 "MagickCore/stream.c"
                            );
    }
  stream_handler=GetBlobStreamHandler(image);
  if (stream_handler == (StreamHandler) 
# 915 "MagickCore/stream.c" 3 4
                                       ((void *)0)
# 915 "MagickCore/stream.c"
                                           )
    {
      (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 917,StreamError,
        "NoStreamHandlerIsDefined","`%s'",image->filename);
      return((Quantum *) 
# 919 "MagickCore/stream.c" 3 4
                        ((void *)0)
# 919 "MagickCore/stream.c"
                            );
    }
  cache_info=(CacheInfo *) image->cache;
  
# 922 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 922 "MagickCore/stream.c"
 cache_info->signature == 0xabacadabUL
# 922 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 922 "MagickCore/stream.c"
...
# 922 "MagickCore/stream.c"
 "cache_info->signature == MagickCoreSignature"
# 922 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 922, __extension__ __PRETTY_FUNCTION__); }))
# 922 "MagickCore/stream.c"
                                                     ;
  if (ValidatePixelCacheMorphology(image) == MagickFalse)
    {
      if (cache_info->storage_class == UndefinedClass)
        (void) stream_handler(image,(const void *) 
# 926 "MagickCore/stream.c" 3 4
                                                  ((void *)0)
# 926 "MagickCore/stream.c"
                                                      ,(size_t)
          cache_info->columns);
  ...
  if (cache_info->metacontent_extent != 0)
    length+=number_pixels*cache_info->metacontent_extent;
  if (cache_info->pixels == (Quantum *) 
# 950 "MagickCore/stream.c" 3 4
                                       ((void *)0)
# 950 "MagickCore/stream.c"
                                           )
    {
      cache_info->length=length;
      status=AcquireStreamPixels(cache_info,exception);
      if (status == MagickFalse)
        {
          cache_info->length=0;
          return((Quantum *) 
# 957 "MagickCore/stream.c" 3 4
                            ((void *)0)
# 957 "MagickCore/stream.c"
                                );
        }
    }
  else
        ...
        if (status == MagickFalse)
          {
            cache_info->length=0;
            return((Quantum *) 
# 969 "MagickCore/stream.c" 3 4
                              ((void *)0)
# 969 "MagickCore/stream.c"
                                  );
          }
      }
  cache_info->metacontent=(void *) 
# 972 "MagickCore/stream.c" 3 4
                                  ((void *)0)
# 972 "MagickCore/stream.c"
                                      ;
  if (cache_info->metacontent_extent != 0)
    cache_info->metacontent=(void *) (cache_info->pixels+number_pixels*
      cache_info->number_channels);
...
# 1007 "MagickCore/stream.c"
__attribute__ ((visibility ("default"))) Image *ReadStream(const ImageInfo *image_info,StreamHandler stream,
  ExceptionInfo *exception)
{
  CacheMethods
    cache_methods;
...
# 1022 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1022 "MagickCore/stream.c"
...
# 1022 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1022, __extension__ __PRETTY_FUNCTION__); }))
# 1022 "MagickCore/stream.c"
                                         ;
  
# 1023 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1023 "MagickCore/stream.c"
...
# 1023 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1023, __extension__ __PRETTY_FUNCTION__); }))
# 1023 "MagickCore/stream.c"
                                                     ;
  
# 1024 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1024 "MagickCore/stream.c"
...
# 1024 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1024, __extension__ __PRETTY_FUNCTION__); }))
# 1024 "MagickCore/stream.c"
                                            ;
  
# 1025 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1025 "MagickCore/stream.c"
...
# 1025 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1025, __extension__ __PRETTY_FUNCTION__); }))
# 1025 "MagickCore/stream.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 1027,"%s",
      image_info->filename);
  ...
  if (image != (Image *) 
# 1049 "MagickCore/stream.c" 3 4
                        ((void *)0)
# 1049 "MagickCore/stream.c"
                            )
    {
      InitializePixelChannelMap(image);
      ResetPixelCacheChannels(image);
...
# 1076 "MagickCore/stream.c"
__attribute__ ((visibility ("hidden"))) void ResetStreamAnonymousMemory(void)
{
}
# 1105 "MagickCore/stream.c"
__attribute__ ((visibility ("hidden"))) void SetStreamInfoClientData(StreamInfo *stream_info,
  const void *client_data)
{
  
# 1108 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1108 "MagickCore/stream.c"
 stream_info != (StreamInfo *) 
# 1108 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1108 "MagickCore/stream.c"
...
# 1108 "MagickCore/stream.c"
 "stream_info != (StreamInfo *) NULL"
# 1108 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1108, __extension__ __PRETTY_FUNCTION__); }))
# 1108 "MagickCore/stream.c"
                                           ;
  
# 1109 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1109 "MagickCore/stream.c"
 stream_info->signature == 0xabacadabUL
# 1109 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1109 "MagickCore/stream.c"
...
# 1109 "MagickCore/stream.c"
 "stream_info->signature == MagickCoreSignature"
# 1109 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1109, __extension__ __PRETTY_FUNCTION__); }))
# 1109 "MagickCore/stream.c"
                                                      ;
  stream_info->client_data=client_data;
}
# 1137 "MagickCore/stream.c"
__attribute__ ((visibility ("default"))) void SetStreamInfoMap(StreamInfo *stream_info,const char *map)
{
  
# 1139 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1139 "MagickCore/stream.c"
 stream_info != (StreamInfo *) 
# 1139 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1139 "MagickCore/stream.c"
...
# 1139 "MagickCore/stream.c"
 "stream_info != (StreamInfo *) NULL"
# 1139 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1139, __extension__ __PRETTY_FUNCTION__); }))
# 1139 "MagickCore/stream.c"
                                           ;
  
# 1140 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1140 "MagickCore/stream.c"
 stream_info->signature == 0xabacadabUL
# 1140 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1140 "MagickCore/stream.c"
...
# 1140 "MagickCore/stream.c"
 "stream_info->signature == MagickCoreSignature"
# 1140 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1140, __extension__ __PRETTY_FUNCTION__); }))
# 1140 "MagickCore/stream.c"
                                                      ;
  (void) CloneString(&stream_info->map,map);
}
# 1169 "MagickCore/stream.c"
__attribute__ ((visibility ("default"))) void SetStreamInfoStorageType(StreamInfo *stream_info,
  const StorageType storage_type)
{
  
# 1172 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1172 "MagickCore/stream.c"
 stream_info != (StreamInfo *) 
# 1172 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1172 "MagickCore/stream.c"
...
# 1172 "MagickCore/stream.c"
 "stream_info != (StreamInfo *) NULL"
# 1172 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1172, __extension__ __PRETTY_FUNCTION__); }))
# 1172 "MagickCore/stream.c"
                                           ;
  
# 1173 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1173 "MagickCore/stream.c"
 stream_info->signature == 0xabacadabUL
# 1173 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1173 "MagickCore/stream.c"
...
# 1173 "MagickCore/stream.c"
 "stream_info->signature == MagickCoreSignature"
# 1173 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1173, __extension__ __PRETTY_FUNCTION__); }))
# 1173 "MagickCore/stream.c"
                                                      ;
  stream_info->storage_type=storage_type;
}
# 1210 "MagickCore/stream.c"
...
# 1243 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1243 "MagickCore/stream.c"
 cache_info->signature == 0xabacadabUL
# 1243 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1243 "MagickCore/stream.c"
...
# 1243 "MagickCore/stream.c"
 "cache_info->signature == MagickCoreSignature"
# 1243 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1243, __extension__ __PRETTY_FUNCTION__); }))
# 1243 "MagickCore/stream.c"
                                                     ;
  ...
  if (image != stream_info->image)
    {
      ...
      if (stream_info->pixels == (unsigned char *) 
# 1256 "MagickCore/stream.c" 3 4
                                                  ((void *)0)
# 1256 "MagickCore/stream.c"
                                                      )
        return(0);
      ...
      if (write_info->extract != (char *) 
# 1262 "MagickCore/stream.c" 3 4
                                         ((void *)0)
# 1262 "MagickCore/stream.c"
                                             )
...
__attribute__ ((visibility ("default"))) Image *StreamImage(const ImageInfo *image_info,
...
# 1309 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1309 "MagickCore/stream.c"
...
# 1309 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1309, __extension__ __PRETTY_FUNCTION__); }))
# 1309 "MagickCore/stream.c"
                                               ;
  
# 1310 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1310 "MagickCore/stream.c"
 image_info->signature == 0xabacadabUL
# 1310 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1310 "MagickCore/stream.c"
...
# 1310 "MagickCore/stream.c"
 "image_info->signature == MagickCoreSignature"
# 1310 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1310, __extension__ __PRETTY_FUNCTION__); }))
# 1310 "MagickCore/stream.c"
                                                     ;
  
# 1311 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1311 "MagickCore/stream.c"
 stream_info != (StreamInfo *) 
# 1311 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1311 "MagickCore/stream.c"
...
# 1311 "MagickCore/stream.c"
 "stream_info != (StreamInfo *) NULL"
# 1311 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1311, __extension__ __PRETTY_FUNCTION__); }))
# 1311 "MagickCore/stream.c"
                                           ;
  
# 1312 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1312 "MagickCore/stream.c"
 stream_info->signature == 0xabacadabUL
# 1312 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1312 "MagickCore/stream.c"
...
# 1312 "MagickCore/stream.c"
 "stream_info->signature == MagickCoreSignature"
# 1312 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1312, __extension__ __PRETTY_FUNCTION__); }))
# 1312 "MagickCore/stream.c"
                                                      ;
  
# 1313 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1313 "MagickCore/stream.c"
 exception != (ExceptionInfo *) 
# 1313 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1313 "MagickCore/stream.c"
...
# 1313 "MagickCore/stream.c"
 "exception != (ExceptionInfo *) NULL"
# 1313 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1313, __extension__ __PRETTY_FUNCTION__); }))
# 1313 "MagickCore/stream.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 1315,"%s",
      image_info->filename);
  read_info=CloneImageInfo(image_info);
  stream_info->image_info=image_info;
  stream_info->quantum_info=AcquireQuantumInfo(image_info,(Image *) 
# 1319 "MagickCore/stream.c" 3 4
                                                                   ((void *)0)
# 1319 "MagickCore/stream.c"
                                                                       );
  if (stream_info->quantum_info == (QuantumInfo *) 
# 1320 "MagickCore/stream.c" 3 4
                                                  ((void *)0)
# 1320 "MagickCore/stream.c"
                                                      )
    {
      read_info=DestroyImageInfo(read_info);
      return((Image *) 
# 1323 "MagickCore/stream.c" 3 4
                      ((void *)0)
# 1323 "MagickCore/stream.c"
                          );
    }
  ...
  stream_info->quantum_info=AcquireQuantumInfo(image_info,image);
  if (stream_info->quantum_info == (QuantumInfo *) 
# 1331 "MagickCore/stream.c" 3 4
                                                  ((void *)0)
# 1331 "MagickCore/stream.c"
                                                      )
    image=DestroyImage(image);
  return(image);
}
# 1365 "MagickCore/stream.c"
...
# 1384 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1384 "MagickCore/stream.c"
 stream_info != (StreamInfo *) 
# 1384 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1384 "MagickCore/stream.c"
...
# 1384 "MagickCore/stream.c"
 "stream_info != (StreamInfo *) NULL"
# 1384 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1384, __extension__ __PRETTY_FUNCTION__); }))
# 1384 "MagickCore/stream.c"
                                           ;
  
# 1385 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1385 "MagickCore/stream.c"
 stream_info->signature == 0xabacadabUL
# 1385 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1385 "MagickCore/stream.c"
...
# 1385 "MagickCore/stream.c"
 "stream_info->signature == MagickCoreSignature"
# 1385 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1385, __extension__ __PRETTY_FUNCTION__); }))
# 1385 "MagickCore/stream.c"
                                                      ;
  
# 1386 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1386 "MagickCore/stream.c"
 image != (Image *) 
# 1386 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1386 "MagickCore/stream.c"
...
# 1386 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 1386 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1386, __extension__ __PRETTY_FUNCTION__); }))
# 1386 "MagickCore/stream.c"
                                ;
  
# 1387 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 1387 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 1387 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1387 "MagickCore/stream.c"
...
# 1387 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 1387 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 1387, __extension__ __PRETTY_FUNCTION__); }))
# 1387 "MagickCore/stream.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 1389,"%s",image->filename);
...
# 1392 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1392 "MagickCore/stream.c"
                                        )
    {
      (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 1394,
  ...
  for (i=0; i < (ssize_t) length; i++)
  {
    switch (stream_info->map[i])
    {
      ...
      case 'c':
      {
        ...
        (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 1422,ImageError,
      ...
      case 'k':
      {
        ...
        if (image->colorspace == CMYKColorspace)
          break;
        quantum_map=(QuantumType *) RelinquishMagickMemory(quantum_map);
        (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 1445,ImageError,
          "ColorSeparatedImageRequired","`%s'",stream_info->map);
        return(MagickFalse);
      }
      case 'M':
      case 'm':
      {
        ...
        if (image->colorspace == CMYKColorspace)
          break;
        quantum_map=(QuantumType *) RelinquishMagickMemory(quantum_map);
        (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 1456,ImageError,
          "ColorSeparatedImageRequired","`%s'",stream_info->map);
        return(MagickFalse);
      }
      case 'o':
      ...
      case 'y':
      {
        ...
        if (image->colorspace == CMYKColorspace)
          break;
        quantum_map=(QuantumType *) RelinquishMagickMemory(quantum_map);
        (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 1485,ImageError,
          "ColorSeparatedImageRequired","`%s'",stream_info->map);
        return(MagickFalse);
      }
      default:
      {
        quantum_map=(QuantumType *) RelinquishMagickMemory(quantum_map);
        (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 1492,OptionError,
      ...
      if (LocaleCompare(stream_info->map,"BGR") == 0)
        {
          ...
          if (p == (const Quantum *) 
# 1510 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1510 "MagickCore/stream.c"
                                        )
            break;
      ...
      if (LocaleCompare(stream_info->map,"BGRA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1524 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1524 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1539 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1539 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"I") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1554 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1554 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGB") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1566 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1566 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1580 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1580 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1595 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1595 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      p=GetAuthenticPixelQueue(image);
      if (p == (const Quantum *) 
# 1608 "MagickCore/stream.c" 3 4
                                ((void *)0)
# 1608 "MagickCore/stream.c"
                                    )
        break;
      for (x=0; x < (ssize_t) GetImageExtent(image); x++)
      {
      ...
      if (LocaleCompare(stream_info->map,"BGR") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1674 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1674 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
            *q++=(double) ((((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelBlue(image,p))*
              quantum_info->scale+quantum_info->minimum);
            *q++=(double) ((((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelGreen(image,p))*
              quantum_info->scale+quantum_info->minimum);
            *q++=(double) ((((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelRed(image,p))*
              quantum_info->scale+quantum_info->minimum);
            p+=GetPixelChannels(image);
          }
          break;
      ...
      if (LocaleCompare(stream_info->map,"BGRA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1691 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1691 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
            ...
            *q++=(double) ((((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelRed(image,p))*
              quantum_info->scale+quantum_info->minimum);
            *q++=(double) ((((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelAlpha(image,p))*
              quantum_info->scale+quantum_info->minimum);
            p+=GetPixelChannels(image);
          }
          break;
      ...
      if (LocaleCompare(stream_info->map,"BGRP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1710 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1710 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"I") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1728 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1728 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGB") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1741 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1741 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1758 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1758 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1777 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1777 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      p=GetAuthenticPixelQueue(image);
      if (p == (const Quantum *) 
# 1793 "MagickCore/stream.c" 3 4
                                ((void *)0)
# 1793 "MagickCore/stream.c"
                                    )
        break;
      for (x=0; x < (ssize_t) GetImageExtent(image); x++)
      {
        for (i=0; i < (ssize_t) length; i++)
        {
          *q=0;
          switch (quantum_map[i])
          {
            ...
            case OpacityQuantum:
            {
              *q=(double) ((((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelOpacity(image,p))*
                quantum_info->scale+quantum_info->minimum);
              break;
            }
            case BlackQuantum:
            {
              if (image->colorspace == CMYKColorspace)
                *q=(double) ((((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelBlack(image,p))*
                  quantum_info->scale+quantum_info->minimum);
              break;
            }
            case IndexQuantum:
      ...
      if (LocaleCompare(stream_info->map,"BGR") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1866 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1866 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1883 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1883 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1902 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1902 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"I") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1920 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1920 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGB") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1933 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1933 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1950 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1950 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 1969 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 1969 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      p=GetAuthenticPixelQueue(image);
      if (p == (const Quantum *) 
# 1985 "MagickCore/stream.c" 3 4
                                ((void *)0)
# 1985 "MagickCore/stream.c"
                                    )
        break;
      for (x=0; x < (ssize_t) GetImageExtent(image); x++)
      {
        for (i=0; i < (ssize_t) length; i++)
        {
          *q=0;
          switch (quantum_map[i])
          {
            ...
            case OpacityQuantum:
            {
              *q=(float) ((((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelOpacity(image,p))*
                quantum_info->scale+quantum_info->minimum);
              break;
            }
            case BlackQuantum:
      ...
      if (LocaleCompare(stream_info->map,"BGR") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2058 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2058 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2072 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2072 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2087 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2087 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"I") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2102 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2102 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGB") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2114 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2114 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2128 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2128 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2143 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2143 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      p=GetAuthenticPixelQueue(image);
      if (p == (const Quantum *) 
# 2156 "MagickCore/stream.c" 3 4
                                ((void *)0)
# 2156 "MagickCore/stream.c"
                                    )
        break;
      for (x=0; x < (ssize_t) GetImageExtent(image); x++)
      {
      ...
      if (LocaleCompare(stream_info->map,"BGR") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2222 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2222 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2236 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2236 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2251 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2251 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"I") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2266 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2266 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGB") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2279 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2279 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2293 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2293 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2308 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2308 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      p=GetAuthenticPixelQueue(image);
      if (p == (const Quantum *) 
# 2321 "MagickCore/stream.c" 3 4
                                ((void *)0)
# 2321 "MagickCore/stream.c"
                                    )
        break;
      for (x=0; x < (ssize_t) GetImageExtent(image); x++)
      {
      ...
      if (LocaleCompare(stream_info->map,"BGR") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2388 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2388 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2402 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2402 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2417 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2417 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"I") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2432 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2432 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGB") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2444 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2444 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2458 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2458 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2473 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2473 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      p=GetAuthenticPixelQueue(image);
      if (p == (const Quantum *) 
# 2486 "MagickCore/stream.c" 3 4
                                ((void *)0)
# 2486 "MagickCore/stream.c"
                                    )
        break;
      for (x=0; x < (ssize_t) GetImageExtent(image); x++)
      {
      ...
      if (LocaleCompare(stream_info->map,"BGR") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2552 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2552 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2566 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2566 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"BGRP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
            if (p == (const Quantum *) 
# 2581 "MagickCore/stream.c" 3 4
                                      ((void *)0)
# 2581 "MagickCore/stream.c"
                                          )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"I") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2596 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2596 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGB") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2609 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2609 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBA") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2623 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2623 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      if (LocaleCompare(stream_info->map,"RGBP") == 0)
        {
          p=GetAuthenticPixelQueue(image);
          if (p == (const Quantum *) 
# 2638 "MagickCore/stream.c" 3 4
                                    ((void *)0)
# 2638 "MagickCore/stream.c"
                                        )
            break;
          for (x=0; x < (ssize_t) GetImageExtent(image); x++)
          {
      ...
      p=GetAuthenticPixelQueue(image);
      if (p == (const Quantum *) 
# 2651 "MagickCore/stream.c" 3 4
                                ((void *)0)
# 2651 "MagickCore/stream.c"
                                    )
        break;
      for (x=0; x < (ssize_t) GetImageExtent(image); x++)
      {
    ...
    {
      quantum_map=(QuantumType *) RelinquishMagickMemory(quantum_map);
      (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 2712,OptionError,
        "UnrecognizedPixelMap","`%s'",stream_info->map);
      break;
    }
  }
...
# 2759 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 2759 "MagickCore/stream.c"
 image != (Image *) 
# 2759 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2759 "MagickCore/stream.c"
...
# 2759 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 2759 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 2759, __extension__ __PRETTY_FUNCTION__); }))
# 2759 "MagickCore/stream.c"
                                ;
  
# 2760 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 2760 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 2760 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2760 "MagickCore/stream.c"
...
# 2760 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 2760 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 2760, __extension__ __PRETTY_FUNCTION__); }))
# 2760 "MagickCore/stream.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 2762,"%s",image->filename);
  cache_info=(CacheInfo *) image->cache;
  
# 2764 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 2764 "MagickCore/stream.c"
 cache_info->signature == 0xabacadabUL
# 2764 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2764 "MagickCore/stream.c"
...
# 2764 "MagickCore/stream.c"
 "cache_info->signature == MagickCoreSignature"
# 2764 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 2764, __extension__ __PRETTY_FUNCTION__); }))
# 2764 "MagickCore/stream.c"
                                                     ;
  stream_handler=GetBlobStreamHandler(image);
  if (stream_handler == (StreamHandler) 
# 2766 "MagickCore/stream.c" 3 4
                                       ((void *)0)
# 2766 "MagickCore/stream.c"
                                           )
    {
      (void) ThrowMagickException(exception,"MagickCore/stream.c",__func__,(unsigned long) 2768,StreamError,
        "NoStreamHandlerIsDefined","`%s'",image->filename);
      return(MagickFalse);
    }
...
# 2804 "MagickCore/stream.c"
__attribute__ ((visibility ("default"))) MagickBooleanType WriteStream(const ImageInfo *image_info,
...
# 2813 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 2813 "MagickCore/stream.c"
 image_info != (ImageInfo *) 
# 2813 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2813 "MagickCore/stream.c"
...
# 2813 "MagickCore/stream.c"
 "image_info != (ImageInfo *) NULL"
# 2813 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 2813, __extension__ __PRETTY_FUNCTION__); }))
# 2813 "MagickCore/stream.c"
                                         ;
  
# 2814 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 2814 "MagickCore/stream.c"
 image_info->signature == 0xabacadabUL
# 2814 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2814 "MagickCore/stream.c"
...
# 2814 "MagickCore/stream.c"
 "image_info->signature == MagickCoreSignature"
# 2814 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 2814, __extension__ __PRETTY_FUNCTION__); }))
# 2814 "MagickCore/stream.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/stream.c",__func__,(unsigned long) 2816,"%s",
      image_info->filename);
  
# 2818 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 2818 "MagickCore/stream.c"
 image != (Image *) 
# 2818 "MagickCore/stream.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2818 "MagickCore/stream.c"
...
# 2818 "MagickCore/stream.c"
 "image != (Image *) NULL"
# 2818 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 2818, __extension__ __PRETTY_FUNCTION__); }))
# 2818 "MagickCore/stream.c"
                                ;
  
# 2819 "MagickCore/stream.c" 3 4
 ((void) sizeof ((
# 2819 "MagickCore/stream.c"
 image->signature == 0xabacadabUL
# 2819 "MagickCore/stream.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2819 "MagickCore/stream.c"
...
# 2819 "MagickCore/stream.c"
 "image->signature == MagickCoreSignature"
# 2819 "MagickCore/stream.c" 3 4
 , "MagickCore/stream.c", 2819, __extension__ __PRETTY_FUNCTION__); }))
# 2819 "MagickCore/stream.c"
                                                ;
