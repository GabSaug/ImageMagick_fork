# 0 "MagickCore/coder.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/coder.c"
# 42 "MagickCore/coder.c"
...
# 46 "MagickCore/coder.c" 2
# 1 "./MagickCore/coder-private.h" 1
# 25 "./MagickCore/coder-private.h"
...
# 62 "MagickCore/coder.c" 2
# 71 "MagickCore/coder.c"
...
{ "BGRA", "BGR" }, { "BGRO", "BGR" },
{ "BMP2", "BMP" }, { "BMP3", "BMP" },
{ "BRF", "BRAILLE" }, { "UBRL", "BRAILLE" }, { "UBRL6", "BRAILLE" }, { "ISOBRL", "BRAILLE" }, { "ISOBRL6", "BRAILLE" },
{ "CAL", "CALS" },
...
{ "3FR", "DNG" }, { "ARW", "DNG" }, { "CR2", "DNG" }, { "CR3", "DNG" }, { "CRW", "DNG" }, { "DCR", "DNG" }, { "DCRAW", "DNG" }, { "ERF", "DNG" }, { "IIQ", "DNG" }, { "KDC", "DNG" }, { "K25", "DNG" }, { "MEF", "DNG" }, { "MRW", "DNG" }, { "NEF", "DNG" }, { "NRW", "DNG" }, { "ORF", "DNG" }, { "PEF", "DNG" }, { "RAF", "DNG" }, { "RAW", "DNG" }, { "RMF", "DNG" }, { "RW2", "DNG" }, { "SRF", "DNG" }, { "SR2", "DNG" }, { "X3F", "DNG" },
...
{ "GRANITE", "MAGICK" }, { "H", "MAGICK" }, { "LOGO", "MAGICK" }, { "NETSCAPE", "MAGICK" }, { "ROSE", "MAGICK" }, { "WIZARD", "MAGICK" },




{ "8BIM", "META" }, { "8BIMTEXT", "META" }, { "8BIMWTEXT", "META" }, { "APP1", "META" }, { "APP1JPEG", "META" }, { "EXIF", "META" }, { "XMP", "META" }, { "ICM", "META" }, { "ICC", "META" }, { "IPTC", "META" }, { "IPTCTEXT", "META" }, { "IPTCWTEXT", "META" },
...
{ "AI", "PDF" }, { "EPDF", "PDF" }, { "PDFA", "PDF" }, { "POCKETMOD", "PDF" },
...
{ "FRACTAL", "PLASMA" },
  ...
  { "MNG", "PNG" }, { "PNG8", "PNG" }, { "PNG24", "PNG" }, { "PNG32", "PNG" }, { "PNG48", "PNG" }, { "PNG64", "PNG" }, { "PNG00", "PNG" }, { "JNG", "PNG" },

{ "PAM", "PNM" }, { "PBM", "PNM" }, { "PFM", "PNM" }, { "PHM", "PNM" }, { "PGM", "PNM" }, { "PPM", "PNM" },
{ "EPS2", "PS2" },
{ "EPS3", "PS3" },
{ "EPI", "PS" }, { "EPS", "PS" }, { "EPSF", "PS" }, { "EPSI", "PS" },
{ "PSB", "PSD" },


{ "R", "RAW" }, { "C", "RAW" }, { "G", "RAW" }, { "M", "RAW" }, { "B", "RAW" }, { "Y", "RAW" }, { "A", "RAW" }, { "O", "RAW" }, { "K", "RAW" },
{ "RGBA", "RGB" }, { "RGBO", "RGB" }, { "RGB565", "RGB" },
...
{ "RAS", "SUN" },
{ "SVGZ", "SVG" }, { "RSVG", "SVG" }, { "MSVG", "SVG" },
{ "ICB", "TGA" }, { "VDA", "TGA" }, { "VST", "TGA" },
...
{ "TM2", "TIM2" },
  ...
  { "DFONT", "TTF" }, { "PFA", "TTF" }, { "PFB", "TTF" }, { "OTF", "TTF" }, { "TTC", "TTF" },

{ "SPARSE-COLOR", "TXT" }, { "TEXT", "TXT" },

{ "HTTP", "URL" }, { "HTTPS", "URL" }, { "FTP", "URL" }, { "FILE", "URL" },
{ "PAL", "UYVY" },


{ "3GP", "VIDEO" }, { "3G2", "VIDEO" }, { "APNG", "VIDEO" }, { "AVI", "VIDEO" }, { "FLV", "VIDEO" }, { "MKV", "VIDEO" }, { "MOV", "VIDEO" }, { "MPEG", "VIDEO" }, { "MPG", "VIDEO" }, { "MP4", "VIDEO" }, { "M2V", "VIDEO" }, { "M4V", "VIDEO" }, { "WEBM", "VIDEO" }, { "WMV", "VIDEO" },
{ "XV", "VIFF" },
...
# 85 "MagickCore/coder.c" 2
  };

static SemaphoreInfo
  *coder_semaphore = (SemaphoreInfo *) 
# 88 "MagickCore/coder.c" 3 4
                                      ((void *)0)
# 88 "MagickCore/coder.c"
                                          ;

static SplayTreeInfo
  *coder_cache = (SplayTreeInfo *) 
# 91 "MagickCore/coder.c" 3 4
                                  ((void *)0)
# 91 "MagickCore/coder.c"
                                      ;
...
static void *DestroyCoderNode(void *coder_info)
{
  ...
  if (p->exempt == MagickFalse)
    {
      if (p->path != (char *) 
# 131 "MagickCore/coder.c" 3 4
                             ((void *)0)
# 131 "MagickCore/coder.c"
                                 )
        p->path=DestroyString(p->path);
      if (p->name != (char *) 
# 133 "MagickCore/coder.c" 3 4
                             ((void *)0)
# 133 "MagickCore/coder.c"
                                 )
        p->name=DestroyString(p->name);
      if (p->magick != (char *) 
# 135 "MagickCore/coder.c" 3 4
                               ((void *)0)
# 135 "MagickCore/coder.c"
                                   )
...
# 168 "MagickCore/coder.c" 3 4
                                   ((void *)0)
# 168 "MagickCore/coder.c"
                                       )
      {
        (void) ThrowMagickException(exception,"MagickCore/coder.c",__func__,(unsigned long) 170,
    ...
    coder_info->signature=0xabacadabUL;
    status&=(MagickStatusType) AddValueToSplayTree(cache,
      ConstantString(coder_info->magick),coder_info);
    if (status == MagickFalse)
      (void) ThrowMagickException(exception,"MagickCore/coder.c",__func__,(unsigned long) 183,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",coder_info->name);
  }
  return(cache);
}
# 207 "MagickCore/coder.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType CoderComponentGenesis(void)
{
  if (coder_semaphore == (SemaphoreInfo *) 
# 209 "MagickCore/coder.c" 3 4
                                          ((void *)0)
# 209 "MagickCore/coder.c"
                                              )
    coder_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 232 "MagickCore/coder.c"
__attribute__ ((visibility ("hidden"))) void CoderComponentTerminus(void)
{
  if (coder_semaphore == (SemaphoreInfo *) 
# 234 "MagickCore/coder.c" 3 4
                                          ((void *)0)
# 234 "MagickCore/coder.c"
                                              )
    ActivateSemaphoreInfo(&coder_semaphore);
  LockSemaphoreInfo(coder_semaphore);
  if (coder_cache != (SplayTreeInfo *) 
# 237 "MagickCore/coder.c" 3 4
                                      ((void *)0)
# 237 "MagickCore/coder.c"
                                          )
    coder_cache=DestroySplayTree(coder_cache);
  UnlockSemaphoreInfo(coder_semaphore);
  RelinquishSemaphoreInfo(&coder_semaphore);
}
# 268 "MagickCore/coder.c"
__attribute__ ((visibility ("default"))) const CoderInfo *GetCoderInfo(const char *name,
  ExceptionInfo *exception)
{
  
# 271 "MagickCore/coder.c" 3 4
 ((void) sizeof ((
# 271 "MagickCore/coder.c"
...
# 271 "MagickCore/coder.c" 3 4
 , "MagickCore/coder.c", 271, __extension__ __PRETTY_FUNCTION__); }))
# 271 "MagickCore/coder.c"
                                            ;
  if (IsCoderTreeInstantiated(exception) == MagickFalse)
    return((const CoderInfo *) 
# 273 "MagickCore/coder.c" 3 4
                              ((void *)0)
# 273 "MagickCore/coder.c"
                                  );
  if ((name == (const char *) 
# 274 "MagickCore/coder.c" 3 4
                             ((void *)0)
# 274 "MagickCore/coder.c"
...
__attribute__ ((visibility ("default"))) const CoderInfo **GetCoderInfoList(const char *pattern,
...
# 334 "MagickCore/coder.c" 3 4
 ((void) sizeof ((
# 334 "MagickCore/coder.c"
 pattern != (char *) 
# 334 "MagickCore/coder.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 334 "MagickCore/coder.c"
...
# 334 "MagickCore/coder.c"
 "pattern != (char *) NULL"
# 334 "MagickCore/coder.c" 3 4
 , "MagickCore/coder.c", 334, __extension__ __PRETTY_FUNCTION__); }))
# 334 "MagickCore/coder.c"
                                 ;
  
# 335 "MagickCore/coder.c" 3 4
 ((void) sizeof ((
# 335 "MagickCore/coder.c"
 number_coders != (size_t *) 
# 335 "MagickCore/coder.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 335 "MagickCore/coder.c"
 number_coders != (size_t *) 
# 335 "MagickCore/coder.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 335 "MagickCore/coder.c"
 "number_coders != (size_t *) NULL"
# 335 "MagickCore/coder.c" 3 4
 , "MagickCore/coder.c", 335, __extension__ __PRETTY_FUNCTION__); }))
# 335 "MagickCore/coder.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/coder.c",__func__,(unsigned long) 337,"%s",pattern);
  *number_coders=0;
  p=GetCoderInfo("*",exception);
  if (p == (const CoderInfo *) 
# 340 "MagickCore/coder.c" 3 4
                              ((void *)0)
# 340 "MagickCore/coder.c"
                                  )
    return((const CoderInfo **) 
# 341 "MagickCore/coder.c" 3 4
                               ((void *)0)
# 341 "MagickCore/coder.c"
                                   );
  coder_map=(const CoderInfo **) AcquireQuantumMemory((size_t)
    GetNumberOfNodesInSplayTree(coder_cache)+1UL,sizeof(*coder_map));
  if (coder_map == (const CoderInfo **) 
# 344 "MagickCore/coder.c" 3 4
                                       ((void *)0)
# 344 "MagickCore/coder.c"
                                           )
    return((const CoderInfo **) 
# 345 "MagickCore/coder.c" 3 4
                               ((void *)0)
# 345 "MagickCore/coder.c"
                                   );
  ...
  for (i=0; p != (const CoderInfo *) 
# 352 "MagickCore/coder.c" 3 4
                                    ((void *)0)
# 352 "MagickCore/coder.c"
                                        ; )
  {
  ...
  coder_map[i]=(CoderInfo *) 
# 361 "MagickCore/coder.c" 3 4
                            ((void *)0)
# 361 "MagickCore/coder.c"
                                ;
  *number_coders=(size_t) i;
  return(coder_map);
}
# 394 "MagickCore/coder.c"
...
__attribute__ ((visibility ("default"))) char **GetCoderList(const char *pattern,
  size_t *number_coders,ExceptionInfo *exception)
{
  char
    **coder_map;
...
# 420 "MagickCore/coder.c" 3 4
 ((void) sizeof ((
# 420 "MagickCore/coder.c"
 pattern != (char *) 
# 420 "MagickCore/coder.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 420 "MagickCore/coder.c"
...
# 420 "MagickCore/coder.c"
 "pattern != (char *) NULL"
# 420 "MagickCore/coder.c" 3 4
 , "MagickCore/coder.c", 420, __extension__ __PRETTY_FUNCTION__); }))
# 420 "MagickCore/coder.c"
                                 ;
  
# 421 "MagickCore/coder.c" 3 4
 ((void) sizeof ((
# 421 "MagickCore/coder.c"
 number_coders != (size_t *) 
# 421 "MagickCore/coder.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 421 "MagickCore/coder.c"
...
# 421 "MagickCore/coder.c"
 "number_coders != (size_t *) NULL"
# 421 "MagickCore/coder.c" 3 4
 , "MagickCore/coder.c", 421, __extension__ __PRETTY_FUNCTION__); }))
# 421 "MagickCore/coder.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/coder.c",__func__,(unsigned long) 423,"%s",pattern);
  *number_coders=0;
  p=GetCoderInfo("*",exception);
  if (p == (const CoderInfo *) 
# 426 "MagickCore/coder.c" 3 4
                              ((void *)0)
# 426 "MagickCore/coder.c"
                                  )
    return((char **) 
# 427 "MagickCore/coder.c" 3 4
                    ((void *)0)
# 427 "MagickCore/coder.c"
                        );
  coder_map=(char **) AcquireQuantumMemory((size_t)
    GetNumberOfNodesInSplayTree(coder_cache)+1UL,sizeof(*coder_map));
  if (coder_map == (char **) 
# 430 "MagickCore/coder.c" 3 4
                            ((void *)0)
# 430 "MagickCore/coder.c"
                                )
    return((char **) 
# 431 "MagickCore/coder.c" 3 4
                    ((void *)0)
# 431 "MagickCore/coder.c"
                        );
  ...
  p=(const CoderInfo *) GetNextValueInSplayTree(coder_cache);
  for (i=0; p != (const CoderInfo *) 
# 438 "MagickCore/coder.c" 3 4
                                    ((void *)0)
# 438 "MagickCore/coder.c"
                                        ; )
  {
    if ((p->stealth == MagickFalse) &&
        (GlobExpression(p->name,pattern,MagickFalse) != MagickFalse))
  ...
  coder_map[i]=(char *) 
# 447 "MagickCore/coder.c" 3 4
                       ((void *)0)
# 447 "MagickCore/coder.c"
                           ;
  *number_coders=(size_t) i;
  return(coder_map);
}
# 475 "MagickCore/coder.c"
static MagickBooleanType IsCoderTreeInstantiated(ExceptionInfo *exception)
{
  if (coder_cache == (SplayTreeInfo *) 
# 477 "MagickCore/coder.c" 3 4
                                      ((void *)0)
# 477 "MagickCore/coder.c"
                                          )
    {
      if (coder_semaphore == (SemaphoreInfo *) 
# 479 "MagickCore/coder.c" 3 4
                                              ((void *)0)
# 479 "MagickCore/coder.c"
                                                  )
        ActivateSemaphoreInfo(&coder_semaphore);
      LockSemaphoreInfo(coder_semaphore);
      if (coder_cache == (SplayTreeInfo *) 
# 482 "MagickCore/coder.c" 3 4
                                          ((void *)0)
# 482 "MagickCore/coder.c"
                                              )
        coder_cache=AcquireCoderCache(exception);
      UnlockSemaphoreInfo(coder_semaphore);
    }
  return(coder_cache != (SplayTreeInfo *) 
# 486 "MagickCore/coder.c" 3 4
                                         ((void *)0) 
# 486 "MagickCore/coder.c"
                                              ? MagickTrue : MagickFalse);
}
# 513 "MagickCore/coder.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListCoderInfo(FILE *file,
  ExceptionInfo *exception)
{
  const char
    *path;
  ...
  if (file == (const FILE *) 
# 531 "MagickCore/coder.c" 3 4
                            ((void *)0)
# 531 "MagickCore/coder.c"
                                )
    file=
# 532 "MagickCore/coder.c" 3 4
        stdout
# 532 "MagickCore/coder.c"
              ;
  coder_info=GetCoderInfoList("*",&number_coders,exception);
  if (coder_info == (const CoderInfo **) 
# 534 "MagickCore/coder.c" 3 4
                                        ((void *)0)
# 534 "MagickCore/coder.c"
                                            )
    return(MagickFalse);
  path=(const char *) 
# 536 "MagickCore/coder.c" 3 4
                     ((void *)0)
# 536 "MagickCore/coder.c"
                         ;
  for (i=0; i < (ssize_t) number_coders; i++)
  {
    if (coder_info[i]->stealth != MagickFalse)
      continue;
    if ((path == (const char *) 
# 541 "MagickCore/coder.c" 3 4
                               ((void *)0)
# 541 "MagickCore/coder.c"
                                   ) ||
        (LocaleCompare(path,coder_info[i]->path) != 0))
      {
        if (coder_info[i]->path != (char *) 
# 544 "MagickCore/coder.c" 3 4
                                           ((void *)0)
# 544 "MagickCore/coder.c"
                                               )
    ...
    for (j=(ssize_t) strlen(coder_info[i]->magick); j <= 15; j++)
      (void) FormatLocaleFile(file," ");
    if (coder_info[i]->name != (char *) 
# 555 "MagickCore/coder.c" 3 4
                                       ((void *)0)
# 555 "MagickCore/coder.c"
                                           )
