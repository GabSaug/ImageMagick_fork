# 0 "MagickCore/identify.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/identify.c"
# 45 "MagickCore/identify.c"
...
# 100 "MagickCore/identify.c" 2
# 134 "MagickCore/identify.c"
...
# 146 "MagickCore/identify.c" 3 4
 ((void) sizeof ((
# 146 "MagickCore/identify.c"
 image != (Image *) 
# 146 "MagickCore/identify.c" 3 4
...
# 146 "MagickCore/identify.c"
 "image != (Image *) NULL"
# 146 "MagickCore/identify.c" 3 4
 , "MagickCore/identify.c", 146, __extension__ __PRETTY_FUNCTION__); }))
# 146 "MagickCore/identify.c"
                                ;
  
# 147 "MagickCore/identify.c" 3 4
 ((void) sizeof ((
# 147 "MagickCore/identify.c"
...
# 147 "MagickCore/identify.c" 3 4
 , "MagickCore/identify.c", 147, __extension__ __PRETTY_FUNCTION__); }))
# 147 "MagickCore/identify.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/identify.c",__func__,(unsigned long) 149,"%s",image->filename);
  channel_statistics=(ChannelStatistics *) AcquireQuantumMemory(
    64 +1,sizeof(*channel_statistics));
  if (channel_statistics == (ChannelStatistics *) 
# 152 "MagickCore/identify.c" 3 4
                                                 ((void *)0)
# 152 "MagickCore/identify.c"
                                                     )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 153 "MagickCore/identify.c" 3 4
   (*__errno_location ())
# 153 "MagickCore/identify.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/identify.c",__func__,(unsigned long) 153,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  (void) memset(channel_statistics,0,(64 +1)*
  ...
  for (i=0; i <= (ssize_t) 64; i++)
  {
    switch (type)
    {
      ...
      default:
      {
        channel_statistics[i].maxima=(-1.79769313486231570E+308);
        break;
      }
      case MinimumStatistic:
      {
        channel_statistics[i].minima=1.79769313486231570E+308;
        break;
      }
    }
  }
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 182 "MagickCore/identify.c" 3 4
                              ((void *)0)
# 182 "MagickCore/identify.c"
                                  )
      break;
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      if (GetPixelReadMask(image,p) <= (((Quantum) 65535.0)/2))
        {
...
{
# 260 "MagickCore/identify.c"
  ssize_t
    n;

  n=FormatLocaleFile(file,"    %s:\n" "      Angular Second Moment:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Contrast:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Correlation:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Sum of Squares Variance:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Inverse Difference Moment:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Sum Average:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Sum Variance:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Sum Entropy:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Entropy:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Difference Variance:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Difference Entropy:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Information Measure of Correlation 1:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Information Measure of Correlation 2:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n" "      Maximum Correlation Coefficient:\n" "        %.*g, %.*g, %.*g, %.*g, %.*g\n",name,
    GetMagickPrecision(),(channel_features[channel].angular_second_moment)[0], GetMagickPrecision(),(channel_features[channel].angular_second_moment)[1], GetMagickPrecision(),(channel_features[channel].angular_second_moment)[2], GetMagickPrecision(),(channel_features[channel].angular_second_moment)[3], GetMagickPrecision(),((channel_features[channel].angular_second_moment)[0]+(channel_features[channel].angular_second_moment)[1]+(channel_features[channel].angular_second_moment)[2]+(channel_features[channel].angular_second_moment)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].contrast)[0], GetMagickPrecision(),(channel_features[channel].contrast)[1], GetMagickPrecision(),(channel_features[channel].contrast)[2], GetMagickPrecision(),(channel_features[channel].contrast)[3], GetMagickPrecision(),((channel_features[channel].contrast)[0]+(channel_features[channel].contrast)[1]+(channel_features[channel].contrast)[2]+(channel_features[channel].contrast)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].correlation)[0], GetMagickPrecision(),(channel_features[channel].correlation)[1], GetMagickPrecision(),(channel_features[channel].correlation)[2], GetMagickPrecision(),(channel_features[channel].correlation)[3], GetMagickPrecision(),((channel_features[channel].correlation)[0]+(channel_features[channel].correlation)[1]+(channel_features[channel].correlation)[2]+(channel_features[channel].correlation)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].variance_sum_of_squares)[0], GetMagickPrecision(),(channel_features[channel].variance_sum_of_squares)[1], GetMagickPrecision(),(channel_features[channel].variance_sum_of_squares)[2], GetMagickPrecision(),(channel_features[channel].variance_sum_of_squares)[3], GetMagickPrecision(),((channel_features[channel].variance_sum_of_squares)[0]+(channel_features[channel].variance_sum_of_squares)[1]+(channel_features[channel].variance_sum_of_squares)[2]+(channel_features[channel].variance_sum_of_squares)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].inverse_difference_moment)[0], GetMagickPrecision(),(channel_features[channel].inverse_difference_moment)[1], GetMagickPrecision(),(channel_features[channel].inverse_difference_moment)[2], GetMagickPrecision(),(channel_features[channel].inverse_difference_moment)[3], GetMagickPrecision(),((channel_features[channel].inverse_difference_moment)[0]+(channel_features[channel].inverse_difference_moment)[1]+(channel_features[channel].inverse_difference_moment)[2]+(channel_features[channel].inverse_difference_moment)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].sum_average)[0], GetMagickPrecision(),(channel_features[channel].sum_average)[1], GetMagickPrecision(),(channel_features[channel].sum_average)[2], GetMagickPrecision(),(channel_features[channel].sum_average)[3], GetMagickPrecision(),((channel_features[channel].sum_average)[0]+(channel_features[channel].sum_average)[1]+(channel_features[channel].sum_average)[2]+(channel_features[channel].sum_average)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].sum_variance)[0], GetMagickPrecision(),(channel_features[channel].sum_variance)[1], GetMagickPrecision(),(channel_features[channel].sum_variance)[2], GetMagickPrecision(),(channel_features[channel].sum_variance)[3], GetMagickPrecision(),((channel_features[channel].sum_variance)[0]+(channel_features[channel].sum_variance)[1]+(channel_features[channel].sum_variance)[2]+(channel_features[channel].sum_variance)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].sum_entropy)[0], GetMagickPrecision(),(channel_features[channel].sum_entropy)[1], GetMagickPrecision(),(channel_features[channel].sum_entropy)[2], GetMagickPrecision(),(channel_features[channel].sum_entropy)[3], GetMagickPrecision(),((channel_features[channel].sum_entropy)[0]+(channel_features[channel].sum_entropy)[1]+(channel_features[channel].sum_entropy)[2]+(channel_features[channel].sum_entropy)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].entropy)[0], GetMagickPrecision(),(channel_features[channel].entropy)[1], GetMagickPrecision(),(channel_features[channel].entropy)[2], GetMagickPrecision(),(channel_features[channel].entropy)[3], GetMagickPrecision(),((channel_features[channel].entropy)[0]+(channel_features[channel].entropy)[1]+(channel_features[channel].entropy)[2]+(channel_features[channel].entropy)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].difference_variance)[0], GetMagickPrecision(),(channel_features[channel].difference_variance)[1], GetMagickPrecision(),(channel_features[channel].difference_variance)[2], GetMagickPrecision(),(channel_features[channel].difference_variance)[3], GetMagickPrecision(),((channel_features[channel].difference_variance)[0]+(channel_features[channel].difference_variance)[1]+(channel_features[channel].difference_variance)[2]+(channel_features[channel].difference_variance)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].difference_entropy)[0], GetMagickPrecision(),(channel_features[channel].difference_entropy)[1], GetMagickPrecision(),(channel_features[channel].difference_entropy)[2], GetMagickPrecision(),(channel_features[channel].difference_entropy)[3], GetMagickPrecision(),((channel_features[channel].difference_entropy)[0]+(channel_features[channel].difference_entropy)[1]+(channel_features[channel].difference_entropy)[2]+(channel_features[channel].difference_entropy)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].measure_of_correlation_1)[0], GetMagickPrecision(),(channel_features[channel].measure_of_correlation_1)[1], GetMagickPrecision(),(channel_features[channel].measure_of_correlation_1)[2], GetMagickPrecision(),(channel_features[channel].measure_of_correlation_1)[3], GetMagickPrecision(),((channel_features[channel].measure_of_correlation_1)[0]+(channel_features[channel].measure_of_correlation_1)[1]+(channel_features[channel].measure_of_correlation_1)[2]+(channel_features[channel].measure_of_correlation_1)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].measure_of_correlation_2)[0], GetMagickPrecision(),(channel_features[channel].measure_of_correlation_2)[1], GetMagickPrecision(),(channel_features[channel].measure_of_correlation_2)[2], GetMagickPrecision(),(channel_features[channel].measure_of_correlation_2)[3], GetMagickPrecision(),((channel_features[channel].measure_of_correlation_2)[0]+(channel_features[channel].measure_of_correlation_2)[1]+(channel_features[channel].measure_of_correlation_2)[2]+(channel_features[channel].measure_of_correlation_2)[3])/4.0,
    GetMagickPrecision(),(channel_features[channel].maximum_correlation_coefficient)[0], GetMagickPrecision(),(channel_features[channel].maximum_correlation_coefficient)[1], GetMagickPrecision(),(channel_features[channel].maximum_correlation_coefficient)[2], GetMagickPrecision(),(channel_features[channel].maximum_correlation_coefficient)[3], GetMagickPrecision(),((channel_features[channel].maximum_correlation_coefficient)[0]+(channel_features[channel].maximum_correlation_coefficient)[1]+(channel_features[channel].maximum_correlation_coefficient)[2]+(channel_features[channel].maximum_correlation_coefficient)[3])/4.0);
  return(n);
}
  ...
  const size_t max_locations,const ChannelStatistics *channel_statistics)
{
  ...
  (void) FormatLocaleFile(file,"  %s: %.*g (%.*g)",name,GetMagickPrecision(),
    target,GetMagickPrecision(),((double) 1.0/(double) ((Quantum) 65535.0))*target);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    p=GetVirtualPixels(image,0,y,image->columns,1,exception);
    if (p == (const Quantum *) 
# 323 "MagickCore/identify.c" 3 4
                              ((void *)0)
# 323 "MagickCore/identify.c"
                                  )
      break;
    for (x=0; x < (ssize_t) image->columns; x++)
    {
  ...
  const ChannelStatistics *channel_statistics)
{
  ...
  n=FormatLocaleFile(file,"    %s:\n      min: %.*g  (%.*g)\n      " "max: %.*g (%.*g)\n      mean: %.*g (%.*g)\n      median: %.*g (%.*g)\n      " "standard deviation: %.*g (%.*g)\n      kurtosis: %.*g\n      " "skewness: %.*g\n      entropy: %.*g\n",name,GetMagickPrecision(),
    ...
    (double) ((Quantum) 65535.0),GetMagickPrecision(),
...
__attribute__ ((visibility ("default"))) MagickBooleanType IdentifyImage(Image *image,FILE *file,
...
# 541 "MagickCore/identify.c" 3 4
 ((void) sizeof ((
# 541 "MagickCore/identify.c"
 image != (Image *) 
# 541 "MagickCore/identify.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 541 "MagickCore/identify.c"
...
# 541 "MagickCore/identify.c"
 "image != (Image *) NULL"
# 541 "MagickCore/identify.c" 3 4
 , "MagickCore/identify.c", 541, __extension__ __PRETTY_FUNCTION__); }))
# 541 "MagickCore/identify.c"
                                ;
  
# 542 "MagickCore/identify.c" 3 4
 ((void) sizeof ((
# 542 "MagickCore/identify.c"
 image->signature == 0xabacadabUL
# 542 "MagickCore/identify.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 542 "MagickCore/identify.c"
...
# 542 "MagickCore/identify.c"
 "image->signature == MagickCoreSignature"
# 542 "MagickCore/identify.c" 3 4
 , "MagickCore/identify.c", 542, __extension__ __PRETTY_FUNCTION__); }))
# 542 "MagickCore/identify.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/identify.c",__func__,(unsigned long) 544,"%s",image->filename);
  if (file == (FILE *) 
# 545 "MagickCore/identify.c" 3 4
                      ((void *)0)
# 545 "MagickCore/identify.c"
                          )
    file=
# 546 "MagickCore/identify.c" 3 4
        stdout
# 546 "MagickCore/identify.c"
              ;
  colorspace=image->colorspace;
  locate=GetImageArtifact(image,"identify:locate");
  if (locate != (const char *) 
# 549 "MagickCore/identify.c" 3 4
                              ((void *)0)
# 549 "MagickCore/identify.c"
                                  )
    {
      const char
        *limit;
  ...
  if (verbose == MagickFalse)
    {
      ...
      if (*image->magick_filename != '\0')
       ...
       if ((GetPreviousImageInList(image) == (Image *) 
# 644 "MagickCore/identify.c" 3 4
                                                      ((void *)0)
# 644 "MagickCore/identify.c"
                                                          ) &&
           (GetNextImageInList(image) == (Image *) 
# 645 "MagickCore/identify.c" 3 4
                                                  ((void *)0)
# 645 "MagickCore/identify.c"
                                                      ) &&
           (image->scene == 0))
  ...
  ping=p == (const Quantum *) 
# 710 "MagickCore/identify.c" 3 4
                             ((void *)0) 
# 710 "MagickCore/identify.c"
                                  ? MagickTrue : MagickFalse;
  (void) SignatureImage(image,exception);
  channel_statistics=(ChannelStatistics *) 
# 712 "MagickCore/identify.c" 3 4
                                          ((void *)0)
# 712 "MagickCore/identify.c"
                                              ;
  channel_moments=(ChannelMoments *) 
# 713 "MagickCore/identify.c" 3 4
                                    ((void *)0)
# 713 "MagickCore/identify.c"
                                        ;
  channel_phash=(ChannelPerceptualHash *) 
# 714 "MagickCore/identify.c" 3 4
                                         ((void *)0)
# 714 "MagickCore/identify.c"
                                             ;
  channel_features=(ChannelFeatures *) 
# 715 "MagickCore/identify.c" 3 4
                                      ((void *)0)
# 715 "MagickCore/identify.c"
                                          ;
  depth=0;
  if (ping == MagickFalse)
    {
...
# 722 "MagickCore/identify.c" 3 4
                                    ((void *)0)
# 722 "MagickCore/identify.c"
                                        )
        {
      ...
      if (artifact != (const char *) 
# 728 "MagickCore/identify.c" 3 4
                                    ((void *)0)
# 728 "MagickCore/identify.c"
                                        )
        {
...
# 755 "MagickCore/identify.c" 3 4
                                          ((void *)0)
# 755 "MagickCore/identify.c"
                                              ) ||
      (GetMagickDescription(magick_info) == (const char *) 
# 756 "MagickCore/identify.c" 3 4
                                                          ((void *)0)
# 756 "MagickCore/identify.c"
                                                              ))
  ...
  if ((magick_info != (const MagickInfo *) 
# 761 "MagickCore/identify.c" 3 4
                                          ((void *)0)
# 761 "MagickCore/identify.c"
                                              ) &&
      (GetMagickMimeType(magick_info) != (const char *) 
# 762 "MagickCore/identify.c" 3 4
                                                       ((void *)0)
# 762 "MagickCore/identify.c"
                                                           ))
  ...
  if (channel_statistics != (ChannelStatistics *) 
# 806 "MagickCore/identify.c" 3 4
                                                 ((void *)0)
# 806 "MagickCore/identify.c"
                                                     )
    {
      ...
      scale=1.0;
      if (image->depth <= 16)
        scale=(double) (((Quantum) 65535.0)/((size_t) ((Quantum) 65535.0) >> ((size_t)
          16 -image->depth)));
  ...
  if (channel_moments != (ChannelMoments *) 
# 989 "MagickCore/identify.c" 3 4
                                           ((void *)0)
# 989 "MagickCore/identify.c"
                                               )
    {
  ...
  if (channel_phash != (ChannelPerceptualHash *) 
# 1064 "MagickCore/identify.c" 3 4
                                                ((void *)0)
# 1064 "MagickCore/identify.c"
                                                    )
    {
  ...
  if (channel_features != (ChannelFeatures *) 
# 1070 "MagickCore/identify.c" 3 4
                                             ((void *)0)
# 1070 "MagickCore/identify.c"
                                                 )
    {
      ...
      if (image->alpha_trait != UndefinedPixelTrait)
        {
          ...
          p=(const Quantum *) 
# 1151 "MagickCore/identify.c" 3 4
                             ((void *)0)
# 1151 "MagickCore/identify.c"
                                 ;
          for (y=0; y < (ssize_t) image->rows; y++)
          {
            p=GetVirtualPixels(image,0,y,image->columns,1,exception);
            if (p == (const Quantum *) 
# 1155 "MagickCore/identify.c" 3 4
                                      ((void *)0)
# 1155 "MagickCore/identify.c"
                                          )
              break;
            for (x=0; x < (ssize_t) image->columns; x++)
            {
              if (GetPixelAlpha(image,p) == (Quantum) ((Quantum) 0))
                {
                  found=MagickTrue;
                  break;
                }
...
# 1189 "MagickCore/identify.c" 3 4
                                          ((void *)0)
# 1189 "MagickCore/identify.c"
                                              ,exception));
      ...
      else
        {
          ...
          if (IsStringTrue(artifact) != MagickFalse)
            (void) FormatLocaleFile(file,"  Colors: %.20g\n",(double)
              GetNumberColors(image,(FILE *) 
# 1198 "MagickCore/identify.c" 3 4
                                            ((void *)0)
# 1198 "MagickCore/identify.c"
                                                ,exception));
        }
    }
      ...
      if (image->colors <= 1024)
        {
          ...
          {
            pixel=(*c);
            (void) CopyMagickString(tuple,"(",4096);
            ConcatenateColorComponent(&pixel,RedPixelChannel,X11Compliance,
              tuple);
            (void) ConcatenateMagickString(tuple,",",4096);
  ...
  if (image->duration != 0)
    (void) FormatLocaleFile(file,"  Duration: %.20g\n",(double)
      image->duration);
  if ((image->next != (Image *) 
# 1331 "MagickCore/identify.c" 3 4
                               ((void *)0)
# 1331 "MagickCore/identify.c"
...
# 1343 "MagickCore/identify.c" 3 4
                                ((void *)0)
# 1343 "MagickCore/identify.c"
                                    )
    (void) FormatLocaleFile(file,"  Montage: %s\n",image->montage);
  if (image->directory != (char *) 
# 1345 "MagickCore/identify.c" 3 4
                                  ((void *)0)
# 1345 "MagickCore/identify.c"
                                      )
    {
      Image
        *tile;
      ...
      for (d=image->directory; *d != '\0'; d++)
      {
        ...
        handler=SetWarningHandler((WarningHandler) 
# 1375 "MagickCore/identify.c" 3 4
                                                  ((void *)0)
# 1375 "MagickCore/identify.c"
                                                      );
        tile=ReadImage(image_info,exception);
        (void) SetWarningHandler(handler);
        if (tile == (Image *) 
# 1378 "MagickCore/identify.c" 3 4
                             ((void *)0)
# 1378 "MagickCore/identify.c"
                                 )
          {
            (void) FormatLocaleFile(file,"\n");
            continue;
...
# 1388 "MagickCore/identify.c" 3 4
                                         ((void *)0)
# 1388 "MagickCore/identify.c"
                                             )
        {
          (void) FormatLocaleFile(file,"  %s:\n",property);
          value=GetImageProperty(tile,property,exception);
          if (value != (const char *) 
# 1392 "MagickCore/identify.c" 3 4
                                     ((void *)0)
# 1392 "MagickCore/identify.c"
                                         )
            (void) FormatLocaleFile(file,"%s\n",value);
          property=GetNextImageProperty(tile);
        }
  ...
  (void) FormatLocaleString(key,4096,"8BIM:1999,2998:#1");
  value=GetImageProperty(image,key,exception);
  if (value != (const char *) 
# 1402 "MagickCore/identify.c" 3 4
                             ((void *)0)
# 1402 "MagickCore/identify.c"
                                 )
    {
...
# 1432 "MagickCore/identify.c" 3 4
                                      ((void *)0)
# 1432 "MagickCore/identify.c"
                                          )
        {
          points=AcquireString("");
          for (n=0; n < (ssize_t) number_points; n++)
          {
            (void) FormatLocaleString(buffer,4096,"%g,%g ",
...
# 1447 "MagickCore/identify.c" 3 4
                                       ((void *)0)
# 1447 "MagickCore/identify.c"
                                           )
        {
          points=AcquireString("");
          for (n=0; n < (ssize_t) number_points; n++)
  ...
  if (name != (char *) 
# 1464 "MagickCore/identify.c" 3 4
                      ((void *)0)
# 1464 "MagickCore/identify.c"
                          )
    {
      const StringInfo
        *profile;
      ...
      while (name != (char *) 
# 1473 "MagickCore/identify.c" 3 4
                             ((void *)0)
# 1473 "MagickCore/identify.c"
                                 )
      {
        profile=GetImageProfile(image,name);
        if (profile == (StringInfo *) 
# 1476 "MagickCore/identify.c" 3 4
                                     ((void *)0)
# 1476 "MagickCore/identify.c"
                                         )
          continue;
        ...
        if (LocaleCompare(name,"iptc") == 0)
          {
            ...
            for (i=0; i < (ssize_t) profile_length-5; i+=(ssize_t) length)
            {
              ...
              length=(((length) < (profile_length-(size_t) i)) ? (length) : (profile_length-(size_t) i));
              attribute=(char *) 
# 1572 "MagickCore/identify.c" 3 4
                                ((void *)0)
# 1572 "MagickCore/identify.c"
                                    ;
              if (~length >= (4096 -1))
                attribute=(char *) AcquireQuantumMemory(length+4096,
                  sizeof(*attribute));
              if (attribute != (char *) 
# 1576 "MagickCore/identify.c" 3 4
                                       ((void *)0)
# 1576 "MagickCore/identify.c"
                                           )
                {
                  (void) CopyMagickString(attribute,(char *)
                    GetStringInfoDatum(profile)+i,length+1);
                  attribute_list=StringToList(attribute);
                  if (attribute_list != (char **) 
# 1581 "MagickCore/identify.c" 3 4
                                                 ((void *)0)
# 1581 "MagickCore/identify.c"
                                                     )
                    {
                      for (j=0; attribute_list[j] != (char *) 
# 1583 "MagickCore/identify.c" 3 4
                                                             ((void *)0)
# 1583 "MagickCore/identify.c"
                                                                 ; j++)
                      {
...
# 1604 "MagickCore/identify.c" 3 4
                                ((void *)0)
# 1604 "MagickCore/identify.c"
                                    )
    {
      ...
      while (property != (const char *) 
# 1610 "MagickCore/identify.c" 3 4
                                       ((void *)0)
# 1610 "MagickCore/identify.c"
                                           )
      {
        (void) FormatLocaleFile(file,"    %s: ",property);
        value=GetImageProperty(image,property,exception);
        if (value != (const char *) 
# 1614 "MagickCore/identify.c" 3 4
                                   ((void *)0)
# 1614 "MagickCore/identify.c"
                                       )
          (void) FormatLocaleFile(file,"%s\n",value);
        property=GetNextImageProperty(image);
      }
  ...
  if (artifact != (const char *) 
# 1621 "MagickCore/identify.c" 3 4
                                ((void *)0)
# 1621 "MagickCore/identify.c"
                                    )
    {
      ...
      while (artifact != (const char *) 
# 1627 "MagickCore/identify.c" 3 4
                                       ((void *)0)
# 1627 "MagickCore/identify.c"
                                           )
      {
        (void) FormatLocaleFile(file,"    %s: ",artifact);
        value=GetImageArtifact(image,artifact);
        if (value != (const char *) 
# 1631 "MagickCore/identify.c" 3 4
                                   ((void *)0)
# 1631 "MagickCore/identify.c"
                                       )
          (void) FormatLocaleFile(file,"%s\n",value);
        artifact=GetNextImageArtifact(image);
      }
  ...
  if (registry != (const char *) 
# 1638 "MagickCore/identify.c" 3 4
                                ((void *)0)
# 1638 "MagickCore/identify.c"
                                    )
    {
      ...
      while (registry != (const char *) 
# 1644 "MagickCore/identify.c" 3 4
                                       ((void *)0)
# 1644 "MagickCore/identify.c"
                                           )
      {
        ...
        value=(const char *) GetImageRegistry(StringRegistryType,registry,
          exception);
        if (value != (const char *) 
# 1649 "MagickCore/identify.c" 3 4
                                   ((void *)0)
# 1649 "MagickCore/identify.c"
                                       )
          (void) FormatLocaleFile(file,"%s\n",value);
        registry=GetNextImageRegistry();
      }
  ...
  (void) FormatMagickSize(image->extent,MagickTrue,"B",4096,buffer);
  (void) FormatLocaleFile(file,"  Filesize: %s\n",buffer);
  (void) FormatMagickSize((MagickSizeType) image->columns*image->rows,
    MagickFalse,"P",4096,buffer);
  if (strlen(buffer) > 1)
  ...
  if (elapsed_time > 1.0e-12)
    {
      (void) FormatMagickSize((MagickSizeType) ((double) image->columns*
        image->rows/elapsed_time+0.5),MagickFalse,"P",4096,buffer);
...
# 1687 "MagickCore/identify.c" 3 4
   ((void *)0)
# 1687 "MagickCore/identify.c"
       ));
  (void) fflush(file);
  return(ferror(file) != 0 ? MagickFalse : MagickTrue);
}
