# 0 "MagickCore/delegate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/delegate.c"
# 48 "MagickCore/delegate.c"
...
# 66 "MagickCore/delegate.c" 2
# 1 "./MagickCore/nt-base-private.h" 1
# 25 "./MagickCore/nt-base-private.h"
...
# 80 "MagickCore/delegate.c" 2
# 97 "MagickCore/delegate.c"
static const char
...
static LinkedListInfo
  *delegate_cache = (LinkedListInfo *) 
# 167 "MagickCore/delegate.c" 3 4
                                      ((void *)0)
# 167 "MagickCore/delegate.c"
                                          ;

static SemaphoreInfo
  *delegate_semaphore = (SemaphoreInfo *) 
# 170 "MagickCore/delegate.c" 3 4
                                         ((void *)0)
# 170 "MagickCore/delegate.c"
                                             ;
  ...
  ExceptionInfo *exception)
{
...

  {
    ...
    while (option != (const StringInfo *) 
# 223 "MagickCore/delegate.c" 3 4
                                         ((void *)0)
# 223 "MagickCore/delegate.c"
                                             )
    {
...
# 257 "MagickCore/delegate.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType DelegateComponentGenesis(void)
{
  if (delegate_semaphore == (SemaphoreInfo *) 
# 259 "MagickCore/delegate.c" 3 4
                                             ((void *)0)
# 259 "MagickCore/delegate.c"
                                                 )
    delegate_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 283 "MagickCore/delegate.c"
static void *DestroyDelegate(void *delegate_info)
{
  ...
  if (p->path != (char *) 
# 289 "MagickCore/delegate.c" 3 4
                         ((void *)0)
# 289 "MagickCore/delegate.c"
                             )
    p->path=DestroyString(p->path);
  if (p->decode != (char *) 
# 291 "MagickCore/delegate.c" 3 4
                           ((void *)0)
# 291 "MagickCore/delegate.c"
                               )
    p->decode=DestroyString(p->decode);
  if (p->encode != (char *) 
# 293 "MagickCore/delegate.c" 3 4
                           ((void *)0)
# 293 "MagickCore/delegate.c"
                               )
    p->encode=DestroyString(p->encode);
  if (p->commands != (char *) 
# 295 "MagickCore/delegate.c" 3 4
                             ((void *)0)
# 295 "MagickCore/delegate.c"
                                 )
    p->commands=DestroyString(p->commands);
  if (p->semaphore != (SemaphoreInfo *) 
# 297 "MagickCore/delegate.c" 3 4
                                       ((void *)0)
# 297 "MagickCore/delegate.c"
                                           )
    RelinquishSemaphoreInfo(&p->semaphore);
  p=(DelegateInfo *) RelinquishMagickMemory(p);
  return((void *) 
# 300 "MagickCore/delegate.c" 3 4
                 ((void *)0)
# 300 "MagickCore/delegate.c"
                     );
}

__attribute__ ((visibility ("hidden"))) void DelegateComponentTerminus(void)
{
  if (delegate_semaphore == (SemaphoreInfo *) 
# 305 "MagickCore/delegate.c" 3 4
                                             ((void *)0)
# 305 "MagickCore/delegate.c"
                                                 )
    ActivateSemaphoreInfo(&delegate_semaphore);
  LockSemaphoreInfo(delegate_semaphore);
  if (delegate_cache != (LinkedListInfo *) 
# 308 "MagickCore/delegate.c" 3 4
                                          ((void *)0)
# 308 "MagickCore/delegate.c"
                                              )
...
# 350 "MagickCore/delegate.c"
__attribute__ ((visibility ("default"))) int ExternalDelegateCommand(const MagickBooleanType asynchronous,
  ...
  ExceptionInfo *exception)
{
  ...
  if (arguments == (char **) 
# 373 "MagickCore/delegate.c" 3 4
                            ((void *)0)
# 373 "MagickCore/delegate.c"
                                )
    return(status);
  if (*arguments[1] == '\0')
    {
...
# 386 "MagickCore/delegate.c" 3 4
     (*__errno_location ())
# 386 "MagickCore/delegate.c"
          =
# 386 "MagickCore/delegate.c" 3 4
           1
# 386 "MagickCore/delegate.c"
                ;
      (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 387,PolicyError,
...
# 396 "MagickCore/delegate.c" 3 4
                             stderr
# 396 "MagickCore/delegate.c"
                                   ,"%s\n",command);
      (void) fflush(
# 397 "MagickCore/delegate.c" 3 4
                   stderr
# 397 "MagickCore/delegate.c"
                         );
    }
  sanitize_command=SanitizeString(command);
  if (asynchronous != MagickFalse)
    (void) ConcatenateMagickString(sanitize_command,"&",4096);
  if (message != (char *) 
# 402 "MagickCore/delegate.c" 3 4
                         ((void *)0)
# 402 "MagickCore/delegate.c"
                             )
    *message='\0';


  if ((asynchronous == MagickFalse) && (message != (char *) 
# 406 "MagickCore/delegate.c" 3 4
                                                            ((void *)0)
# 406 "MagickCore/delegate.c"
                                                                ))
    {
      char
        buffer[4096];
      ...
      if (file == (FILE *) 
# 419 "MagickCore/delegate.c" 3 4
                          ((void *)0)
# 419 "MagickCore/delegate.c"
                              )
        status=system(sanitize_command);
      else
        {
          while (fgets(buffer,(int) sizeof(buffer),file) != 
# 423 "MagickCore/delegate.c" 3 4
                                                           ((void *)0)
# 423 "MagickCore/delegate.c"
                                                               )
          {
            size_t
              length;

            length=(((4096 -offset) < (strlen(buffer)+1)) ? (4096 -offset) : (strlen(buffer)+1));
            if (length > 0)
              {
...

    {
      ...
      if ((asynchronous != MagickFalse) ||
          (strpbrk(sanitize_command,"&;<>|") != (char *) 
# 445 "MagickCore/delegate.c" 3 4
                                                        ((void *)0)
# 445 "MagickCore/delegate.c"
                                                            ))
        status=system(sanitize_command);
      else
        {
            ...
            if (child_pid == 0)
            ...
            else
              {
                ...
                if (pid == -1)
                  ...
                  {
                    if (
# 478 "MagickCore/delegate.c" 3 4
                       (((
# 478 "MagickCore/delegate.c"
                       child_status
# 478 "MagickCore/delegate.c" 3 4
                       ) & 0x7f) == 0) 
# 478 "MagickCore/delegate.c"
                                               != 0)
                      status=
# 479 "MagickCore/delegate.c" 3 4
                            (((
# 479 "MagickCore/delegate.c"
                            child_status
# 479 "MagickCore/delegate.c" 3 4
                            ) & 0xff00) >> 8)
# 479 "MagickCore/delegate.c"
                      ...
                      if (
# 481 "MagickCore/delegate.c" 3 4
                         (((signed char) (((
# 481 "MagickCore/delegate.c"
                         child_status
# 481 "MagickCore/delegate.c" 3 4
                         ) & 0x7f) + 1) >> 1) > 0)
# 481 "MagickCore/delegate.c"
...
# 516 "MagickCore/delegate.c"
  if (status < 0)
    {
      if ((message != (char *) 
# 518 "MagickCore/delegate.c" 3 4
                              ((void *)0)
# 518 "MagickCore/delegate.c"
                                  ) && (*message != '\0'))
        (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 519,DelegateError,
          "FailedToExecuteCommand","`%s' (%s)",sanitize_command,message);
      else
        (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 522,DelegateError,
...
# 588 "MagickCore/delegate.c"
  ...
  if ((image != (Image *) 
# 594 "MagickCore/delegate.c" 3 4
                         ((void *)0)
# 594 "MagickCore/delegate.c"
                             ) && (IsEventLogging() != MagickFalse))
    (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 595,"%s",image->filename);
  else
    if ((image_info != (ImageInfo *) 
# 597 "MagickCore/delegate.c" 3 4
                                    ((void *)0)
# 597 "MagickCore/delegate.c"
                                        ) && (IsEventLogging() != MagickFalse))
      (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 598,"%s","no-images");
  ...
  *value='\0';
  ...
  switch (letter)
  {
    ...
    {
      if (image_info == (ImageInfo *) 
# 608 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 608 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 608,OptionWarning, "NoImageInfoForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 614 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 614 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 614,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 624 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 624 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 624,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 630 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 630 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 630,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 636 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 636 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 636,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 642 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 642 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 642,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 650 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 650 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 650,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 657 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 657 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 657,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 663 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 663 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 663,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      string=image->magick;
      break;
    }
    case 'n':
    {
      if (image != (Image *) 
# 669 "MagickCore/delegate.c" 3 4
                            ((void *)0)
# 669 "MagickCore/delegate.c"
                                )
        (void) FormatLocaleString(value,4096,"%.20g",(double)
    ...
    {
      if (image_info == (ImageInfo *) 
# 676 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 676 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 676,OptionWarning, "NoImageInfoForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 682 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 682 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 682,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",(double)
    ...
    {
      if (image == (Image *) 
# 689 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 689 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 689,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",(double)
        16);
      break;
    }
    case 'r':
    {
      ...
      if (image == (Image *) 
# 699 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 699 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 699,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 710 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 710 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 710,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",(double)
        image->scene);
      break;
    }
    ...
    {
      if (image == (Image *) 
# 717 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 717 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 717,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image_info == (ImageInfo *) 
# 723 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 723 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 723,OptionWarning, "NoImageInfoForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 729 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 729 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 729,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",(double)
    ...
    {
      if (image == (Image *) 
# 736 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 736 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 736,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 745 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 745 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 745,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",
    ...
    {
      if (image == (Image *) 
# 754 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 754 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 754,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",
        (double) image->depth);
      break;
    }
    ...
    {
      if (image == (Image *) 
# 761 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 761 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 761,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 768 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 768 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 768,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 775 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 775 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 775,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    case 'F':
    {
      ...
      if (image == (Image *) 
# 785 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 785 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 785,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 791 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 791 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 791,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 798 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 798 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 798,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",
    ...
    {
      if (image == (Image *) 
# 805 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 805 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 805,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",(double)
        image->iterations);
      break;
    }
    ...
    {
      if (image == (Image *) 
# 812 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 812 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 812,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 818 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 818 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 818,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 825 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 825 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 825,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20gx%.20g",
    ...
    {
      if (image == (Image *) 
# 832 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 832 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 832,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",(double)
    ...
    {
      if (image == (Image *) 
# 839 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 839 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 839,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",(double)
    ...
    {
      if (image_info == (ImageInfo *) 
# 846 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 846 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 846,OptionWarning, "NoImageInfoForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",(double)
    ...
    {
      if (image == (Image *) 
# 854 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 854 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 854,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",(double)
        image->delay);
      break;
    }
    ...
    {
      if (image == (Image *) 
# 861 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 861 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 861,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    {
      if (image == (Image *) 
# 868 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 868 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 868,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%.20g",(double)
        image->page.width);
      break;
    }
    ...
    {
      if (image == (Image *) 
# 875 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 875 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 875,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%+.20g",(double)
        image->page.x);
      break;
    }
    ...
    {
      if (image == (Image *) 
# 882 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 882 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 882,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
      (void) FormatLocaleString(value,4096,"%+.20g",(double)
        image->page.y);
      break;
    }
    ...
    case '@':
    {
      ...
      if (image == (Image *) 
# 897 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 897 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 897,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
    ...
    case '#':
    {
      ...
      if (image == (Image *) 
# 909 "MagickCore/delegate.c" 3 4
     ((void *)0)
# 909 "MagickCore/delegate.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 909,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); break; };
...
# 982 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 982 "MagickCore/delegate.c"
 image == 
# 982 "MagickCore/delegate.c" 3 4
 ((void *)0) 
# 982 "MagickCore/delegate.c"
...
# 982 "MagickCore/delegate.c"
 "image == NULL || image->signature == MagickCoreSignature"
# 982 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 982, __extension__ __PRETTY_FUNCTION__); }))
# 982 "MagickCore/delegate.c"
                                                                 ;
  
# 983 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 983 "MagickCore/delegate.c"
 image_info == 
# 983 "MagickCore/delegate.c" 3 4
 ((void *)0) 
# 983 "MagickCore/delegate.c"
...
# 983 "MagickCore/delegate.c"
 "image_info == NULL || image_info->signature == MagickCoreSignature"
# 983 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 983, __extension__ __PRETTY_FUNCTION__); }))
# 983 "MagickCore/delegate.c"
                                                                           ;
  if ((image != (Image *) 
# 984 "MagickCore/delegate.c" 3 4
                         ((void *)0)
# 984 "MagickCore/delegate.c"
                             ) && (IsEventLogging() != MagickFalse))
    (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 985,"%s",image->filename);
  else
   if ((image_info != (ImageInfo *) 
# 987 "MagickCore/delegate.c" 3 4
                                   ((void *)0)
# 987 "MagickCore/delegate.c"
                                       ) && (IsEventLogging() != MagickFalse))
     (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 988,"%s","no-image");
  if (embed_text == (const char *) 
# 989 "MagickCore/delegate.c" 3 4
                                  ((void *)0)
# 989 "MagickCore/delegate.c"
                                      )
    return(ConstantString(""));
  p=embed_text;
  while ((
# 992 "MagickCore/delegate.c" 3 4
         ((*__ctype_b_loc ())[(int) ((
# 992 "MagickCore/delegate.c"
         (int) ((unsigned char) *p)
# 992 "MagickCore/delegate.c" 3 4
...
# 992 "MagickCore/delegate.c"
  ...
  for (q=interpret_text; *p!='\0';
    number=
# 1003 "MagickCore/delegate.c" 3 4
          ((*__ctype_b_loc ())[(int) ((
# 1003 "MagickCore/delegate.c"
          (int) ((unsigned char) *p)
# 1003 "MagickCore/delegate.c" 3 4
...
# 1009 "MagickCore/delegate.c" 3 4
   ((void *)0)
# 1009 "MagickCore/delegate.c"
   ) return((char *) 
# 1009 "MagickCore/delegate.c" 3 4
   ((void *)0)
# 1009 "MagickCore/delegate.c"
    ...
    if (string != (char *) 
# 1105 "MagickCore/delegate.c" 3 4
                          ((void *)0)
# 1105 "MagickCore/delegate.c"
                              )
      {
...
# 1107 "MagickCore/delegate.c" 3 4
       ((void *)0)
# 1107 "MagickCore/delegate.c"
       ) return((char *) 
# 1107 "MagickCore/delegate.c" 3 4
       ((void *)0)
# 1107 "MagickCore/delegate.c"
    ...
    (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1111,OptionWarning,
...
__attribute__ ((visibility ("default"))) char *GetDelegateCommand(const ImageInfo *image_info,Image *image,
...
# 1131 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1131 "MagickCore/delegate.c"
...
# 1131 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1131, __extension__ __PRETTY_FUNCTION__); }))
# 1131 "MagickCore/delegate.c"
                                         ;
  
# 1132 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1132 "MagickCore/delegate.c"
 image_info->signature == 0xabacadabUL
# 1132 "MagickCore/delegate.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1132 "MagickCore/delegate.c"
...
# 1132 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1132, __extension__ __PRETTY_FUNCTION__); }))
# 1132 "MagickCore/delegate.c"
                                                     ;
  
# 1133 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1133 "MagickCore/delegate.c"
 image != (Image *) 
# 1133 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1133 "MagickCore/delegate.c"
...
# 1133 "MagickCore/delegate.c"
 "image != (Image *) NULL"
# 1133 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1133, __extension__ __PRETTY_FUNCTION__); }))
# 1133 "MagickCore/delegate.c"
                                ;
  
# 1134 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1134 "MagickCore/delegate.c"
 image->signature == 0xabacadabUL
# 1134 "MagickCore/delegate.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1134 "MagickCore/delegate.c"
...
# 1134 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1134, __extension__ __PRETTY_FUNCTION__); }))
# 1134 "MagickCore/delegate.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 1136,"%s",image->filename);
  delegate_info=GetDelegateInfo(decode,encode,exception);
  if (delegate_info == (const DelegateInfo *) 
# 1138 "MagickCore/delegate.c" 3 4
                                             ((void *)0)
# 1138 "MagickCore/delegate.c"
                                                 )
    {
      (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1140,DelegateError,
        "NoTagFound","`%s'",decode ? decode : encode);
      return((char *) 
# 1142 "MagickCore/delegate.c" 3 4
                     ((void *)0)
# 1142 "MagickCore/delegate.c"
                         );
    }
  commands=StringToList(delegate_info->commands);
  if (commands == (char **) 
# 1145 "MagickCore/delegate.c" 3 4
                           ((void *)0)
# 1145 "MagickCore/delegate.c"
                               )
    {
      (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1147,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",decode ? decode :
        encode);
      return((char *) 
# 1150 "MagickCore/delegate.c" 3 4
                     ((void *)0)
# 1150 "MagickCore/delegate.c"
                         );
    }
  command=InterpretDelegateProperties((ImageInfo *) image_info,image,
    commands[0],exception);
  if (command == (char *) 
# 1154 "MagickCore/delegate.c" 3 4
                         ((void *)0)
# 1154 "MagickCore/delegate.c"
                             )
    (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1155,ResourceLimitError,
      "MemoryAllocationFailed","`%s'",commands[0]);



  for (i=0; commands[i] != (char *) 
# 1160 "MagickCore/delegate.c" 3 4
                                   ((void *)0)
# 1160 "MagickCore/delegate.c"
                                       ; i++)
    commands[i]=DestroyString(commands[i]);
  commands=(char **) RelinquishMagickMemory(commands);
  return(command);
}
# 1188 "MagickCore/delegate.c"
__attribute__ ((visibility ("default"))) const char *GetDelegateCommands(const DelegateInfo *delegate_info)
{
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 1191,"...");
  
# 1192 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1192 "MagickCore/delegate.c"
...
# 1192 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1192, __extension__ __PRETTY_FUNCTION__); }))
# 1192 "MagickCore/delegate.c"
                                               ;
  
# 1193 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1193 "MagickCore/delegate.c"
 delegate_info->signature == 0xabacadabUL
# 1193 "MagickCore/delegate.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1193 "MagickCore/delegate.c"
 delegate_info->signature == 0xabacadabUL
...
# 1193 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1193, __extension__ __PRETTY_FUNCTION__); }))
# 1193 "MagickCore/delegate.c"
                                                        ;
  return(delegate_info->commands);
}
# 1226 "MagickCore/delegate.c"
__attribute__ ((visibility ("default"))) const DelegateInfo *GetDelegateInfo(const char *decode,
...
# 1235 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1235 "MagickCore/delegate.c"
...
# 1235 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1235, __extension__ __PRETTY_FUNCTION__); }))
# 1235 "MagickCore/delegate.c"
                                            ;
  if (IsDelegateCacheInstantiated(exception) == MagickFalse)
    return((const DelegateInfo *) 
# 1237 "MagickCore/delegate.c" 3 4
                                 ((void *)0)
# 1237 "MagickCore/delegate.c"
                                     );



  delegate_info=(const DelegateInfo *) 
# 1241 "MagickCore/delegate.c" 3 4
                                      ((void *)0)
# 1241 "MagickCore/delegate.c"
                                          ;
  LockSemaphoreInfo(delegate_semaphore);
  ...
  if ((LocaleCompare(decode,"*") == 0) && (LocaleCompare(encode,"*") == 0))
    {
      UnlockSemaphoreInfo(delegate_semaphore);
      if (p != (ElementInfo *) 
# 1247 "MagickCore/delegate.c" 3 4
                              ((void *)0)
# 1247 "MagickCore/delegate.c"
                                  )
        delegate_info=(const DelegateInfo* ) p->value;
      return(delegate_info);
    }
  while (p != (ElementInfo *) 
# 1251 "MagickCore/delegate.c" 3 4
                             ((void *)0)
# 1251 "MagickCore/delegate.c"
                                 )
  {
    delegate_info=(const DelegateInfo* ) p->value;
  ...
  if (p == (ElementInfo *) 
# 1279 "MagickCore/delegate.c" 3 4
                          ((void *)0)
# 1279 "MagickCore/delegate.c"
                              )
    delegate_info=(const DelegateInfo *) 
# 1280 "MagickCore/delegate.c" 3 4
                                        ((void *)0)
# 1280 "MagickCore/delegate.c"
                                            ;
  else
...
static int DelegateInfoCompare(const void *x,const void *y)
{
  ...
  if (cmp == 0)
    {
      if ((*p)->decode == (char *) 
# 1334 "MagickCore/delegate.c" 3 4
                                  ((void *)0)
# 1334 "MagickCore/delegate.c"
                                      )
        if (((*p)->encode != (char *) 
# 1335 "MagickCore/delegate.c" 3 4
                                     ((void *)0)
# 1335 "MagickCore/delegate.c"
                                         ) &&
            ((*q)->encode != (char *) 
# 1336 "MagickCore/delegate.c" 3 4
                                     ((void *)0)
# 1336 "MagickCore/delegate.c"
                                         ))
          return(strcmp((*p)->encode,(*q)->encode));
      if (((*p)->decode != (char *) 
# 1338 "MagickCore/delegate.c" 3 4
                                   ((void *)0)
# 1338 "MagickCore/delegate.c"
                                       ) &&
          ((*q)->decode != (char *) 
# 1339 "MagickCore/delegate.c" 3 4
                                   ((void *)0)
# 1339 "MagickCore/delegate.c"
                                       ))
...
__attribute__ ((visibility ("default"))) const DelegateInfo **GetDelegateInfoList(const char *pattern,
...
# 1361 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1361 "MagickCore/delegate.c"
 number_delegates != (size_t *) 
# 1361 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1361 "MagickCore/delegate.c"
 number_delegates != (size_t *) 
# 1361 "MagickCore/delegate.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1361 "MagickCore/delegate.c"
 "number_delegates != (size_t *) NULL"
# 1361 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1361, __extension__ __PRETTY_FUNCTION__); }))
# 1361 "MagickCore/delegate.c"
                                            ;
  
# 1362 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1362 "MagickCore/delegate.c"
 pattern != (char *) 
# 1362 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1362 "MagickCore/delegate.c"
...
# 1362 "MagickCore/delegate.c"
 "pattern != (char *) NULL"
# 1362 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1362, __extension__ __PRETTY_FUNCTION__); }))
# 1362 "MagickCore/delegate.c"
                                 ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 1364,"%s",pattern);
  *number_delegates=0;
  if (IsDelegateCacheInstantiated(exception) == MagickFalse)
    return((const DelegateInfo **) 
# 1367 "MagickCore/delegate.c" 3 4
                                  ((void *)0)
# 1367 "MagickCore/delegate.c"
                                      );
  ...
  if (delegates == (const DelegateInfo **) 
# 1370 "MagickCore/delegate.c" 3 4
                                          ((void *)0)
# 1370 "MagickCore/delegate.c"
                                              )
    return((const DelegateInfo **) 
# 1371 "MagickCore/delegate.c" 3 4
                                  ((void *)0)
# 1371 "MagickCore/delegate.c"
                                      );
  LockSemaphoreInfo(delegate_semaphore);
  p=GetHeadElementInLinkedList(delegate_cache);
  for (i=0; p != (ElementInfo *) 
# 1374 "MagickCore/delegate.c" 3 4
                                ((void *)0)
# 1374 "MagickCore/delegate.c"
                                    ; )
  {
    const DelegateInfo
      *delegate_info;
  ...
  if (i == 0)
  ...
  else
    {
      ...
      delegates[i]=(DelegateInfo *) 
# 1392 "MagickCore/delegate.c" 3 4
                                   ((void *)0)
# 1392 "MagickCore/delegate.c"
                                       ;
    }
  *number_delegates=(size_t) i;
  return(delegates);
}
# 1432 "MagickCore/delegate.c"
...
__attribute__ ((visibility ("default"))) char **GetDelegateList(const char *pattern,
  size_t *number_delegates,ExceptionInfo *exception)
{
  char
    **delegates;
...
# 1459 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1459 "MagickCore/delegate.c"
 pattern != (char *) 
# 1459 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1459 "MagickCore/delegate.c"
...
# 1459 "MagickCore/delegate.c"
 "pattern != (char *) NULL"
# 1459 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1459, __extension__ __PRETTY_FUNCTION__); }))
# 1459 "MagickCore/delegate.c"
                                 ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 1461,"%s",pattern);
  
# 1462 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1462 "MagickCore/delegate.c"
 number_delegates != (size_t *) 
# 1462 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1462 "MagickCore/delegate.c"
...
# 1462 "MagickCore/delegate.c"
 "number_delegates != (size_t *) NULL"
# 1462 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1462, __extension__ __PRETTY_FUNCTION__); }))
# 1462 "MagickCore/delegate.c"
                                            ;
  *number_delegates=0;
  if (IsDelegateCacheInstantiated(exception) == MagickFalse)
    return((char **) 
# 1465 "MagickCore/delegate.c" 3 4
                    ((void *)0)
# 1465 "MagickCore/delegate.c"
                        );
  delegates=(char **) AcquireQuantumMemory((size_t)
    GetNumberOfElementsInLinkedList(delegate_cache)+1UL,sizeof(*delegates));
  if (delegates == (char **) 
# 1468 "MagickCore/delegate.c" 3 4
                            ((void *)0)
# 1468 "MagickCore/delegate.c"
                                )
    return((char **) 
# 1469 "MagickCore/delegate.c" 3 4
                    ((void *)0)
# 1469 "MagickCore/delegate.c"
                        );
  LockSemaphoreInfo(delegate_semaphore);
  p=GetHeadElementInLinkedList(delegate_cache);
  for (i=0; p != (ElementInfo *) 
# 1472 "MagickCore/delegate.c" 3 4
                                ((void *)0)
# 1472 "MagickCore/delegate.c"
                                    ; )
  {
    const DelegateInfo
      *delegate_info;
  ...
  if (i == 0)
  ...
  else
    {
      ...
      delegates[i]=(char *) 
# 1492 "MagickCore/delegate.c" 3 4
                           ((void *)0)
# 1492 "MagickCore/delegate.c"
                               ;
    }
  *number_delegates=(size_t) i;
  return(delegates);
}
# 1520 "MagickCore/delegate.c"
__attribute__ ((visibility ("default"))) ssize_t GetDelegateMode(const DelegateInfo *delegate_info)
{
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 1523,"...");
  
# 1524 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1524 "MagickCore/delegate.c"
 delegate_info != (DelegateInfo *) 
# 1524 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1524 "MagickCore/delegate.c"
...
# 1524 "MagickCore/delegate.c"
 "delegate_info != (DelegateInfo *) NULL"
# 1524 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1524, __extension__ __PRETTY_FUNCTION__); }))
# 1524 "MagickCore/delegate.c"
                                               ;
  
# 1525 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1525 "MagickCore/delegate.c"
 delegate_info->signature == 0xabacadabUL
# 1525 "MagickCore/delegate.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1525 "MagickCore/delegate.c"
...
# 1525 "MagickCore/delegate.c"
 "delegate_info->signature == MagickCoreSignature"
# 1525 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1525, __extension__ __PRETTY_FUNCTION__); }))
# 1525 "MagickCore/delegate.c"
                                                        ;
  return(delegate_info->mode);
}
# 1553 "MagickCore/delegate.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetDelegateThreadSupport(
  const DelegateInfo *delegate_info)
{
  
# 1556 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1556 "MagickCore/delegate.c"
 delegate_info != (DelegateInfo *) 
# 1556 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1556 "MagickCore/delegate.c"
...
# 1556 "MagickCore/delegate.c"
 "delegate_info != (DelegateInfo *) NULL"
# 1556 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1556, __extension__ __PRETTY_FUNCTION__); }))
# 1556 "MagickCore/delegate.c"
                                               ;
  
# 1557 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1557 "MagickCore/delegate.c"
 delegate_info->signature == 0xabacadabUL
# 1557 "MagickCore/delegate.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1557 "MagickCore/delegate.c"
...
# 1557 "MagickCore/delegate.c"
 "delegate_info->signature == MagickCoreSignature"
# 1557 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1557, __extension__ __PRETTY_FUNCTION__); }))
# 1557 "MagickCore/delegate.c"
                                                        ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 1559,"...");
  return(delegate_info->thread_support);
}
# 1586 "MagickCore/delegate.c"
static MagickBooleanType IsDelegateCacheInstantiated(ExceptionInfo *exception)
{
  if (delegate_cache == (LinkedListInfo *) 
# 1588 "MagickCore/delegate.c" 3 4
                                          ((void *)0)
# 1588 "MagickCore/delegate.c"
                                              )
    {
      if (delegate_semaphore == (SemaphoreInfo *) 
# 1590 "MagickCore/delegate.c" 3 4
                                                 ((void *)0)
# 1590 "MagickCore/delegate.c"
                                                     )
        ActivateSemaphoreInfo(&delegate_semaphore);
      LockSemaphoreInfo(delegate_semaphore);
      if (delegate_cache == (LinkedListInfo *) 
# 1593 "MagickCore/delegate.c" 3 4
                                              ((void *)0)
# 1593 "MagickCore/delegate.c"
                                                  )
        delegate_cache=AcquireDelegateCache("delegates.xml",exception);
      UnlockSemaphoreInfo(delegate_semaphore);
    }
  return(delegate_cache != (LinkedListInfo *) 
# 1597 "MagickCore/delegate.c" 3 4
                                             ((void *)0) 
# 1597 "MagickCore/delegate.c"
                                                  ? MagickTrue : MagickFalse);
}
# 1630 "MagickCore/delegate.c"
...
# 1657 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1657 "MagickCore/delegate.c"
 source != (const char *) 
# 1657 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1657 "MagickCore/delegate.c"
...
# 1657 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1657, __extension__ __PRETTY_FUNCTION__); }))
# 1657 "MagickCore/delegate.c"
                                      ;
  
# 1658 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1658 "MagickCore/delegate.c"
 destination != (char *) 
# 1658 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1658 "MagickCore/delegate.c"
...
# 1658 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1658, __extension__ __PRETTY_FUNCTION__); }))
# 1658 "MagickCore/delegate.c"
                                     ;
  ...
  destination_file=open_utf8(destination,
# 1665 "MagickCore/delegate.c" 3 4
                                        01 
# 1665 "MagickCore/delegate.c"
                                                 | 0x00 | 
# 1665 "MagickCore/delegate.c" 3 4
                                                              0100
# 1665 "MagickCore/delegate.c"
...
# 1665 "MagickCore/delegate.c"
  ...
  if (destination_file == -1)
    return(MagickFalse);
  source_file=open_utf8(source,
# 1668 "MagickCore/delegate.c" 3 4
                              00 
# 1668 "MagickCore/delegate.c"
                                       | 0x00,0);
  if (source_file == -1)
    {
  ...
  if ((fstat(source_file,&attributes) == 0) && (attributes.st_size > 0))
    quantum=((((size_t) attributes.st_size) < (81920)) ? ((size_t) attributes.st_size) : (81920));
  buffer=(unsigned char *) AcquireQuantumMemory(quantum,sizeof(*buffer));
  if (buffer == (unsigned char *) 
# 1678 "MagickCore/delegate.c" 3 4
                                 ((void *)0)
# 1678 "MagickCore/delegate.c"
                                     )
    {
...
__attribute__ ((visibility ("default"))) MagickBooleanType InvokeDelegate(ImageInfo *image_info,
...
# 1726 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1726 "MagickCore/delegate.c"
 image_info != (ImageInfo *) 
# 1726 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1726 "MagickCore/delegate.c"
...
# 1726 "MagickCore/delegate.c"
 "image_info != (ImageInfo *) NULL"
# 1726 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1726, __extension__ __PRETTY_FUNCTION__); }))
# 1726 "MagickCore/delegate.c"
                                         ;
  
# 1727 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1727 "MagickCore/delegate.c"
 image_info->signature == 0xabacadabUL
# 1727 "MagickCore/delegate.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1727 "MagickCore/delegate.c"
...
# 1727 "MagickCore/delegate.c"
 "image_info->signature == MagickCoreSignature"
# 1727 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1727, __extension__ __PRETTY_FUNCTION__); }))
# 1727 "MagickCore/delegate.c"
                                                     ;
  
# 1728 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1728 "MagickCore/delegate.c"
 image != (Image *) 
# 1728 "MagickCore/delegate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1728 "MagickCore/delegate.c"
...
# 1728 "MagickCore/delegate.c"
 "image != (Image *) NULL"
# 1728 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1728, __extension__ __PRETTY_FUNCTION__); }))
# 1728 "MagickCore/delegate.c"
                                ;
  
# 1729 "MagickCore/delegate.c" 3 4
 ((void) sizeof ((
# 1729 "MagickCore/delegate.c"
 image->signature == 0xabacadabUL
# 1729 "MagickCore/delegate.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1729 "MagickCore/delegate.c"
...
# 1729 "MagickCore/delegate.c"
 "image->signature == MagickCoreSignature"
# 1729 "MagickCore/delegate.c" 3 4
 , "MagickCore/delegate.c", 1729, __extension__ __PRETTY_FUNCTION__); }))
# 1729 "MagickCore/delegate.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/delegate.c",__func__,(unsigned long) 1731,"%s",image->filename);
  rights=ExecutePolicyRights;
  if ((decode != (const char *) 
# 1733 "MagickCore/delegate.c" 3 4
                               ((void *)0)
# 1733 "MagickCore/delegate.c"
                                   ) &&
      (IsRightsAuthorized(DelegatePolicyDomain,rights,decode) == MagickFalse))
    {
      
# 1736 "MagickCore/delegate.c" 3 4
     (*__errno_location ())
# 1736 "MagickCore/delegate.c"
          =
# 1736 "MagickCore/delegate.c" 3 4
           1
# 1736 "MagickCore/delegate.c"
                ;
      (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1737,PolicyError,
        "NotAuthorized","`%s'",decode);
      return(MagickFalse);
    }
  if ((encode != (const char *) 
# 1741 "MagickCore/delegate.c" 3 4
                               ((void *)0)
# 1741 "MagickCore/delegate.c"
                                   ) &&
      (IsRightsAuthorized(DelegatePolicyDomain,rights,encode) == MagickFalse))
    {
      
# 1744 "MagickCore/delegate.c" 3 4
     (*__errno_location ())
# 1744 "MagickCore/delegate.c"
          =
# 1744 "MagickCore/delegate.c" 3 4
           1
# 1744 "MagickCore/delegate.c"
                ;
      (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1745,PolicyError,
...
# 1753 "MagickCore/delegate.c" 3 4
     (*__errno_location ())
# 1753 "MagickCore/delegate.c"
     ); (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1753,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                        ;
      return(MagickFalse);
    }
  delegate_info=GetDelegateInfo(decode,encode,exception);
  if (delegate_info == (DelegateInfo *) 
# 1758 "MagickCore/delegate.c" 3 4
                                       ((void *)0)
# 1758 "MagickCore/delegate.c"
                                           )
    {
      if (temporary != MagickFalse)
        (void) RelinquishUniqueFileResource(image->filename);
      (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1762,DelegateError,
        "NoTagFound","`%s'",decode ? decode : encode);
      return(MagickFalse);
    }
      ...
      if (AcquireUniqueFilename(image_info->filename) == MagickFalse)
        {
          if (temporary != MagickFalse)
            (void) RelinquishUniqueFileResource(image->filename);
          { char *file_message; file_message=GetExceptionMessage(
# 1772 "MagickCore/delegate.c" 3 4
         (*__errno_location ())
# 1772 "MagickCore/delegate.c"
         ); (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1772,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",image_info->filename,file_message); file_message=DestroyString(file_message); }
                                                               ;
          return(MagickFalse);
        }
      image_info->temporary=MagickTrue;
    }
  if ((delegate_info->mode != 0) && (((decode != (const char *) 
# 1778 "MagickCore/delegate.c" 3 4
                                                               ((void *)0)
# 1778 "MagickCore/delegate.c"
                                                                   ) &&
        (delegate_info->encode != (char *) 
# 1779 "MagickCore/delegate.c" 3 4
                                          ((void *)0)
# 1779 "MagickCore/delegate.c"
                                              )) ||
       ((encode != (const char *) 
# 1780 "MagickCore/delegate.c" 3 4
                                 ((void *)0)
# 1780 "MagickCore/delegate.c"
                                     ) &&
        (delegate_info->decode != (char *) 
# 1781 "MagickCore/delegate.c" 3 4
                                          ((void *)0)
# 1781 "MagickCore/delegate.c"
                                              ))))
    {
      char
        *magick;
      ...
      if (AcquireUniqueFilename(image_info->unique) == MagickFalse)
        {
          { char *file_message; file_message=GetExceptionMessage(
# 1797 "MagickCore/delegate.c" 3 4
         (*__errno_location ())
# 1797 "MagickCore/delegate.c"
         ); (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1797,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",image_info->unique,file_message); file_message=DestroyString(file_message); }
                                                             ;
          return(MagickFalse);
        }
      magick=InterpretImageProperties(image_info,image,decode != (char *) 
# 1801 "MagickCore/delegate.c" 3 4
                                                                         ((void *)0) 
# 1801 "MagickCore/delegate.c"
                                                                              ?
        delegate_info->encode : delegate_info->decode,exception);
      if (magick == (char *) 
# 1803 "MagickCore/delegate.c" 3 4
                            ((void *)0)
# 1803 "MagickCore/delegate.c"
                                )
        {
          (void) RelinquishUniqueFileResource(image_info->unique);
          if (temporary != MagickFalse)
            (void) RelinquishUniqueFileResource(image->filename);
          (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1808,
      ...
      if (LocaleCompare(magick,"NULL") != 0)
        (void) CopyMagickString(image->magick,magick,4096);
      magick=DestroyString(magick);
      (void) FormatLocaleString(clone_info->filename,4096,"%s:",
      ...
      (void) CopyMagickString(image_info->filename,image->filename,
        4096);
      for (p=image; p != (Image *) 
# 1827 "MagickCore/delegate.c" 3 4
                                  ((void *)0)
# 1827 "MagickCore/delegate.c"
                                      ; p=GetNextImageInList(p))
      {
        (void) FormatLocaleString(p->filename,4096,"%s:%s",
        ...
        if (status == MagickFalse)
          {
            ...
            (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1838,
              DelegateError,"DelegateFailed","`%s'",decode ? decode : encode);
            return(MagickFalse);
          }
  ...
  commands=StringToList(delegate_info->commands);
  if (commands == (char **) 
# 1852 "MagickCore/delegate.c" 3 4
                           ((void *)0)
# 1852 "MagickCore/delegate.c"
                               )
    {
      if (temporary != MagickFalse)
        (void) RelinquishUniqueFileResource(image->filename);
      (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1856,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",
        decode ? decode : encode);
      return(MagickFalse);
    }
  command=(char *) 
# 1861 "MagickCore/delegate.c" 3 4
                  ((void *)0)
# 1861 "MagickCore/delegate.c"
                      ;
  status=MagickTrue;
  (void) CopyMagickString(output_filename,image_info->filename,
    4096);
  (void) CopyMagickString(input_filename,image->filename,4096);
  for (i=0; commands[i] != (char *) 
# 1866 "MagickCore/delegate.c" 3 4
                                   ((void *)0)
# 1866 "MagickCore/delegate.c"
                                       ; i++)
  {
    ...
    if (AcquireUniqueFilename(image_info->unique) == MagickFalse)
      {
        { char *file_message; file_message=GetExceptionMessage(
# 1871 "MagickCore/delegate.c" 3 4
       (*__errno_location ())
# 1871 "MagickCore/delegate.c"
       ); (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1871,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",image_info->unique,file_message); file_message=DestroyString(file_message); }
                                                           ;
        break;
      }
    if (LocaleCompare(decode,"SCAN") != 0)
      {
        ...
        if (status == MagickFalse)
          {
            { char *file_message; file_message=GetExceptionMessage(
# 1880 "MagickCore/delegate.c" 3 4
           (*__errno_location ())
# 1880 "MagickCore/delegate.c"
           ); (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1880,FileOpenError,"UnableToCreateTemporaryFile", "'%s': %s",input_filename,file_message); file_message=DestroyString(file_message); }
                                                           ;
            break;
          }
      }
    ...
    if (command != (char *) 
# 1887 "MagickCore/delegate.c" 3 4
                           ((void *)0)
# 1887 "MagickCore/delegate.c"
                               )
      {
        ...
        if (ExternalDelegateCommand(delegate_info->spawn,image_info->verbose,
          command,(char *) 
# 1893 "MagickCore/delegate.c" 3 4
                          ((void *)0)
# 1893 "MagickCore/delegate.c"
                              ,exception) != 0)
          status=MagickFalse;
        if (delegate_info->spawn != MagickFalse)
          {
            ...
            count=20;
            while ((count-- > 0) && (access_utf8(image->filename,
# 1904 "MagickCore/delegate.c" 3 4
                                                                0
# 1904 "MagickCore/delegate.c"
                                                                    ) == 0))
              (void) MagickDelay(100);
          }
    ...
    if (status == MagickFalse)
      {
        (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 1924,DelegateError,
  ...
  (void) CopyMagickString(image_info->filename,output_filename,
    4096);
  (void) CopyMagickString(image->filename,input_filename,4096);



  for ( ; commands[i] != (char *) 
# 1936 "MagickCore/delegate.c" 3 4
                                 ((void *)0)
# 1936 "MagickCore/delegate.c"
                                     ; i++)
    commands[i]=DestroyString(commands[i]);
  commands=(char **) RelinquishMagickMemory(commands);
  if (temporary != MagickFalse)
...
# 1968 "MagickCore/delegate.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListDelegateInfo(FILE *file,
  ExceptionInfo *exception)
{
  const DelegateInfo
    **delegate_info;
  ...
  if (file == (const FILE *) 
# 1990 "MagickCore/delegate.c" 3 4
                            ((void *)0)
# 1990 "MagickCore/delegate.c"
                                )
    file=
# 1991 "MagickCore/delegate.c" 3 4
        stdout
# 1991 "MagickCore/delegate.c"
              ;
  delegate_info=GetDelegateInfoList("*",&number_delegates,exception);
  if (delegate_info == (const DelegateInfo **) 
# 1993 "MagickCore/delegate.c" 3 4
                                              ((void *)0)
# 1993 "MagickCore/delegate.c"
                                                  )
    return(MagickFalse);
  path=(const char *) 
# 1995 "MagickCore/delegate.c" 3 4
                     ((void *)0)
# 1995 "MagickCore/delegate.c"
                         ;
  for (i=0; i < (ssize_t) number_delegates; i++)
  {
    if (delegate_info[i]->stealth != MagickFalse)
      continue;
    if ((path == (const char *) 
# 2000 "MagickCore/delegate.c" 3 4
                               ((void *)0)
# 2000 "MagickCore/delegate.c"
                                   ) ||
        (LocaleCompare(path,delegate_info[i]->path) != 0))
      {
        if (delegate_info[i]->path != (char *) 
# 2003 "MagickCore/delegate.c" 3 4
                                              ((void *)0)
# 2003 "MagickCore/delegate.c"
                                                  )
    ...
    *delegate='\0';
    if (delegate_info[i]->encode != (char *) 
# 2012 "MagickCore/delegate.c" 3 4
                                            ((void *)0)
# 2012 "MagickCore/delegate.c"
                                                )
      (void) CopyMagickString(delegate,delegate_info[i]->encode,
        4096);
    (void) ConcatenateMagickString(delegate,"        ",4096);
    delegate[8]='\0';
    commands=StringToList(delegate_info[i]->commands);
    if (commands == (char **) 
# 2018 "MagickCore/delegate.c" 3 4
                             ((void *)0)
# 2018 "MagickCore/delegate.c"
                                 )
      continue;
    ...
    for (j=1; commands[j] != (char *) 
# 2025 "MagickCore/delegate.c" 3 4
                                     ((void *)0)
# 2025 "MagickCore/delegate.c"
                                         ; j++)
    {
      (void) StripMagickString(commands[j]);
      (void) FormatLocaleFile(file,"                     \"%s\"\n",commands[j]);
    }
    for (j=0; commands[j] != (char *) 
# 2030 "MagickCore/delegate.c" 3 4
                                     ((void *)0)
# 2030 "MagickCore/delegate.c"
                                         ; j++)
  ...
  ExceptionInfo *exception)
{
  ...
  (void) LogMagickEvent(ConfigureEvent,"MagickCore/delegate.c",__func__,(unsigned long) 2094,
    "Loading delegate configuration file \"%s\" ...",filename);
  if (xml == (const char *) 
# 2096 "MagickCore/delegate.c" 3 4
                           ((void *)0)
# 2096 "MagickCore/delegate.c"
                               )
    return(MagickFalse);
  status=MagickTrue;
  delegate_info=(DelegateInfo *) 
# 2099 "MagickCore/delegate.c" 3 4
                                ((void *)0)
# 2099 "MagickCore/delegate.c"
                                    ;
  ...
  for (q=(const char *) xml; *q != '\0'; )
  {
    ...
    if (*token == '\0')
      break;
    (void) CopyMagickString(keyword,token,4096);
    ...
    if (LocaleCompare(keyword,"<include") == 0)
      {
        ...
        while (((*token != '/') && (*(token+1) != '>')) && (*q != '\0'))
        {
          ...
          if (LocaleCompare(keyword,"file") == 0)
            {
              if (depth > 600)
                (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 2144,
              ...
              else
                {
                  ...
                  if (*path != '\0')
                    (void) ConcatenateMagickString(path,"/",
                      4096);
                  if (*token == *"/")
                    (void) CopyMagickString(path,token,4096);
                  else
                    (void) ConcatenateMagickString(path,token,4096);
                  file_xml=FileToXML(path,~0UL);
                  if (file_xml != (char *) 
# 2161 "MagickCore/delegate.c" 3 4
                                          ((void *)0)
# 2161 "MagickCore/delegate.c"
                                              )
                    {
    ...
    if (delegate_info == (DelegateInfo *) 
# 2185 "MagickCore/delegate.c" 3 4
                                         ((void *)0)
# 2185 "MagickCore/delegate.c"
                                             )
      continue;
    if ((LocaleCompare(keyword,"/>") == 0) ||
        (LocaleCompare(keyword,"</policy>") == 0))
      {
        ...
        if (status == MagickFalse)
          (void) ThrowMagickException(exception,"MagickCore/delegate.c",__func__,(unsigned long) 2192,
            ResourceLimitError,"MemoryAllocationFailed","`%s'",
            delegate_info->commands);
        delegate_info=(DelegateInfo *) 
# 2195 "MagickCore/delegate.c" 3 4
                                      ((void *)0)
# 2195 "MagickCore/delegate.c"
                                          ;
        continue;
      }
    (void) GetNextToken(q,(const char **) 
# 2198 "MagickCore/delegate.c" 3 4
                                         ((void *)0)
# 2198 "MagickCore/delegate.c"
                                             ,extent,token);
    if (*token != '=')
      continue;
    (void) GetNextToken(q,&q,extent,token);
...
# 2227 "MagickCore/delegate.c"
            (void) SubstituteString((char **) &commands,"&quot;","'");

            (void) SubstituteString((char **) &commands,"&amp;","&");
            (void) SubstituteString((char **) &commands,"&gt;",">");
            (void) SubstituteString((char **) &commands,"&lt;","<");
            if (delegate_info->commands != (char *) 
# 2232 "MagickCore/delegate.c" 3 4
                                                   ((void *)0)
# 2232 "MagickCore/delegate.c"
                                                       )
