# 0 "MagickCore/constitute.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/constitute.c"
# 42 "MagickCore/constitute.c"
...
# 53 "MagickCore/constitute.c" 2
# 1 "./MagickCore/constitute-private.h" 1
# 54 "MagickCore/constitute.c" 2
...
# 84 "MagickCore/constitute.c" 2
# 93 "MagickCore/constitute.c"
...
# 164 "MagickCore/constitute.c"
__attribute__ ((visibility ("default"))) Image *ConstituteImage(const size_t columns,const size_t rows,
...
# 183 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 183 "MagickCore/constitute.c"
 map != (const char *) 
# 183 "MagickCore/constitute.c" 3 4
...
# 183 "MagickCore/constitute.c"
 "map != (const char *) NULL"
# 183 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 183, __extension__ __PRETTY_FUNCTION__); }))
# 183 "MagickCore/constitute.c"
                                   ;
  
# 184 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 184 "MagickCore/constitute.c"
 pixels != (void *) 
# 184 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 184 "MagickCore/constitute.c"
...
# 184 "MagickCore/constitute.c"
 "pixels != (void *) NULL"
# 184 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 184, __extension__ __PRETTY_FUNCTION__); }))
# 184 "MagickCore/constitute.c"
                                ;
  
# 185 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 185 "MagickCore/constitute.c"
...
# 185 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 185, __extension__ __PRETTY_FUNCTION__); }))
# 185 "MagickCore/constitute.c"
                                            ;
  
# 186 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 186 "MagickCore/constitute.c"
...
# 186 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 186, __extension__ __PRETTY_FUNCTION__); }))
# 186 "MagickCore/constitute.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/constitute.c",__func__,(unsigned long) 188,"%s",map);
  image=AcquireImage((ImageInfo *) 
# 189 "MagickCore/constitute.c" 3 4
                                  ((void *)0)
# 189 "MagickCore/constitute.c"
                                      ,exception);
  if (image == (Image *) 
# 190 "MagickCore/constitute.c" 3 4
                        ((void *)0)
# 190 "MagickCore/constitute.c"
                            )
    return((Image *) 
# 191 "MagickCore/constitute.c" 3 4
                    ((void *)0)
# 191 "MagickCore/constitute.c"
                        );
  switch (storage)
  {
...
__attribute__ ((visibility ("default"))) Image *PingImage(const ImageInfo *image_info,
  ExceptionInfo *exception)
{
  Image
    *image;
...
# 307 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 307 "MagickCore/constitute.c"
...
# 307 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 307, __extension__ __PRETTY_FUNCTION__); }))
# 307 "MagickCore/constitute.c"
                                         ;
  
# 308 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 308 "MagickCore/constitute.c"
...
# 308 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 308, __extension__ __PRETTY_FUNCTION__); }))
# 308 "MagickCore/constitute.c"
                                                     ;
  
# 309 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 309 "MagickCore/constitute.c"
 exception != (ExceptionInfo *) 
# 309 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 309 "MagickCore/constitute.c"
...
# 309 "MagickCore/constitute.c"
 "exception != (ExceptionInfo *) NULL"
# 309 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 309, __extension__ __PRETTY_FUNCTION__); }))
# 309 "MagickCore/constitute.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/constitute.c",__func__,(unsigned long) 311,"%s",
      image_info->filename);
  ping_info=CloneImageInfo(image_info);
  ping_info->ping=MagickTrue;
  image=ReadStream(ping_info,&PingStream,exception);
  if (image != (Image *) 
# 316 "MagickCore/constitute.c" 3 4
                        ((void *)0)
# 316 "MagickCore/constitute.c"
                            )
    {
      ResetTimer(&image->timer);
      if (ping_info->verbose != MagickFalse)
        (void) IdentifyImage(image,
# 320 "MagickCore/constitute.c" 3 4
                                  stdout
# 320 "MagickCore/constitute.c"
                                        ,MagickFalse,exception);
    }
  ping_info=DestroyImageInfo(ping_info);
  return(image);
}
# 353 "MagickCore/constitute.c"
__attribute__ ((visibility ("default"))) Image *PingImages(ImageInfo *image_info,const char *filename,
  ExceptionInfo *exception)
{
  char
    ping_filename[4096];
...
# 369 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 369 "MagickCore/constitute.c"
 image_info != (ImageInfo *) 
# 369 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 369 "MagickCore/constitute.c"
...
# 369 "MagickCore/constitute.c"
 "image_info != (ImageInfo *) NULL"
# 369 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 369, __extension__ __PRETTY_FUNCTION__); }))
# 369 "MagickCore/constitute.c"
                                         ;
  
# 370 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 370 "MagickCore/constitute.c"
 image_info->signature == 0xabacadabUL
# 370 "MagickCore/constitute.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 370 "MagickCore/constitute.c"
...
# 370 "MagickCore/constitute.c"
 "image_info->signature == MagickCoreSignature"
# 370 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 370, __extension__ __PRETTY_FUNCTION__); }))
# 370 "MagickCore/constitute.c"
                                                     ;
  
# 371 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 371 "MagickCore/constitute.c"
 exception != (ExceptionInfo *) 
# 371 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 371 "MagickCore/constitute.c"
...
# 371 "MagickCore/constitute.c"
 "exception != (ExceptionInfo *) NULL"
# 371 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 371, __extension__ __PRETTY_FUNCTION__); }))
# 371 "MagickCore/constitute.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/constitute.c",__func__,(unsigned long) 373,"%s",
      image_info->filename);
...
# 377 "MagickCore/constitute.c" 3 4
                                                    ((void *)0)
# 377 "MagickCore/constitute.c"
                                                        ,image_info->filename,
  ...
  if (LocaleCompare(ping_filename,image_info->filename) != 0)
    {
      ...
      {
        (void) InterpretImageFilename(image_info,(Image *) 
# 406 "MagickCore/constitute.c" 3 4
                                                          ((void *)0)
# 406 "MagickCore/constitute.c"
                                                              ,ping_filename,
          (int) scene,read_info->filename,exception);
        image=PingImage(read_info,exception);
        if (image == (Image *) 
# 409 "MagickCore/constitute.c" 3 4
                              ((void *)0)
# 409 "MagickCore/constitute.c"
                                  )
          continue;
...
# 453 "MagickCore/constitute.c" 3 4
     (*__errno_location ())
# 453 "MagickCore/constitute.c"
          =
# 453 "MagickCore/constitute.c" 3 4
           1
# 453 "MagickCore/constitute.c"
                ;
      (void) ThrowMagickException(exception,"MagickCore/constitute.c",__func__,(unsigned long) 454,PolicyError,
...
# 480 "MagickCore/constitute.c" 3 4
                              ((void *)0)
# 480 "MagickCore/constitute.c"
                                  )
    {
      GeometryInfo
        geometry_info;
  ...
  ConstituteInfo *constitute_info,ExceptionInfo *exception)
{
  ...
  orientation=(const char *) 
# 502 "MagickCore/constitute.c" 3 4
                            ((void *)0)
# 502 "MagickCore/constitute.c"
                                ;
  if (constitute_info->sync_from_exif != MagickFalse)
    {
      orientation=GetImageProperty(image,"exif:Orientation",exception);
      if (orientation != (const char *) 
# 506 "MagickCore/constitute.c" 3 4
                                       ((void *)0)
# 506 "MagickCore/constitute.c"
                                           )
        {
  ...
  if ((orientation == (const char *) 
# 512 "MagickCore/constitute.c" 3 4
                                    ((void *)0)
# 512 "MagickCore/constitute.c"
                                        ) &&
      (constitute_info->sync_from_tiff != MagickFalse))
    {
      orientation=GetImageProperty(image,"tiff:Orientation",exception);
      if (orientation != (const char *) 
# 516 "MagickCore/constitute.c" 3 4
                                       ((void *)0)
# 516 "MagickCore/constitute.c"
                                           )
        {
          image->orientation=(OrientationType) StringToLong(orientation);
  ...
  ConstituteInfo *constitute_info, ExceptionInfo *exception)
{
  ...
  resolution_x=(const char *) 
# 535 "MagickCore/constitute.c" 3 4
                             ((void *)0)
# 535 "MagickCore/constitute.c"
                                 ;
  resolution_y=(const char *) 
# 536 "MagickCore/constitute.c" 3 4
                             ((void *)0)
# 536 "MagickCore/constitute.c"
                                 ;
  resolution_units=(const char *) 
# 537 "MagickCore/constitute.c" 3 4
                                 ((void *)0)
# 537 "MagickCore/constitute.c"
                                     ;
  ...
  if (constitute_info->sync_from_exif != MagickFalse)
    {
      ...
      if ((resolution_x != (const char *) 
# 543 "MagickCore/constitute.c" 3 4
                                         ((void *)0)
# 543 "MagickCore/constitute.c"
                                             ) &&
          (resolution_y != (const char *) 
# 544 "MagickCore/constitute.c" 3 4
                                         ((void *)0)
# 544 "MagickCore/constitute.c"
                                             ))
        resolution_units=GetImageProperty(image,"exif:ResolutionUnit",
          exception);
    }
  if ((resolution_x == (const char *) 
# 548 "MagickCore/constitute.c" 3 4
                                     ((void *)0)
# 548 "MagickCore/constitute.c"
                                         ) &&
      (resolution_y == (const char *) 
# 549 "MagickCore/constitute.c" 3 4
                                     ((void *)0)
# 549 "MagickCore/constitute.c"
                                         ) &&
      (constitute_info->sync_from_tiff != MagickFalse))
    {
      ...
      if ((resolution_x != (const char *) 
# 554 "MagickCore/constitute.c" 3 4
                                         ((void *)0)
# 554 "MagickCore/constitute.c"
                                             ) &&
          (resolution_y != (const char *) 
# 555 "MagickCore/constitute.c" 3 4
                                         ((void *)0)
# 555 "MagickCore/constitute.c"
                                             ))
        {
  ...
  if ((resolution_x != (const char *) 
# 562 "MagickCore/constitute.c" 3 4
                                     ((void *)0)
# 562 "MagickCore/constitute.c"
                                         ) &&
      (resolution_y != (const char *) 
# 563 "MagickCore/constitute.c" 3 4
                                     ((void *)0)
# 563 "MagickCore/constitute.c"
                                         ))
    {
      GeometryInfo
        geometry_info;
      ...
      if (strchr(resolution_x,',') != (char *) 
# 576 "MagickCore/constitute.c" 3 4
                                              ((void *)0)
# 576 "MagickCore/constitute.c"
                                                  )
      ...
      if (strchr(resolution_y,',') != (char *) 
# 583 "MagickCore/constitute.c" 3 4
                                              ((void *)0)
# 583 "MagickCore/constitute.c"
                                                  )
        image->resolution.y=geometry_info.rho+geometry_info.sigma/1000.0;
      if (resolution_units != (char *) 
# 585 "MagickCore/constitute.c" 3 4
                                      ((void *)0)
# 585 "MagickCore/constitute.c"
                                          )
        {
...
__attribute__ ((visibility ("default"))) Image *ReadImage(const ImageInfo *image_info,
  ExceptionInfo *exception)
{
  char
    filename[4096],
...
# 643 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 643 "MagickCore/constitute.c"
 image_info != (ImageInfo *) 
# 643 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 643 "MagickCore/constitute.c"
...
# 643 "MagickCore/constitute.c"
 "image_info != (ImageInfo *) NULL"
# 643 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 643, __extension__ __PRETTY_FUNCTION__); }))
# 643 "MagickCore/constitute.c"
                                         ;
  
# 644 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 644 "MagickCore/constitute.c"
 image_info->signature == 0xabacadabUL
# 644 "MagickCore/constitute.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 644 "MagickCore/constitute.c"
...
# 644 "MagickCore/constitute.c"
 "image_info->signature == MagickCoreSignature"
# 644 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 644, __extension__ __PRETTY_FUNCTION__); }))
# 644 "MagickCore/constitute.c"
                                                     ;
  
# 645 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 645 "MagickCore/constitute.c"
 image_info->filename != (char *) 
# 645 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 645 "MagickCore/constitute.c"
 image_info->filename != (char *) 
...
# 645 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 645, __extension__ __PRETTY_FUNCTION__); }))
# 645 "MagickCore/constitute.c"
                                              ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/constitute.c",__func__,(unsigned long) 647,"%s",
      image_info->filename);
  
# 649 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 649 "MagickCore/constitute.c"
 exception != (ExceptionInfo *) 
# 649 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 649 "MagickCore/constitute.c"
...
# 649 "MagickCore/constitute.c"
 "exception != (ExceptionInfo *) NULL"
# 649 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 649, __extension__ __PRETTY_FUNCTION__); }))
# 649 "MagickCore/constitute.c"
                                            ;
  read_info=CloneImageInfo(image_info);
  (void) CopyMagickString(magick_filename,read_info->filename,4096);
  (void) SetImageInfo(read_info,0,exception);
  (void) CopyMagickString(filename,read_info->filename,4096);
  (void) CopyMagickString(magick,read_info->magick,4096);
...
# 663 "MagickCore/constitute.c" 3 4
                                         ((void *)0)
# 663 "MagickCore/constitute.c"
                                             )
    {
  ...
  if ((magick_info != (const MagickInfo *) 
# 679 "MagickCore/constitute.c" 3 4
                                          ((void *)0)
# 679 "MagickCore/constitute.c"
                                              ) &&
      ...
      if (status == MagickFalse)
        {
          ...
          image=DestroyImage(image);
          return((Image *) 
# 690 "MagickCore/constitute.c" 3 4
                          ((void *)0)
# 690 "MagickCore/constitute.c"
                              );
        }
          ...
          if (status == MagickFalse)
            {
              ...
              image=DestroyImage(image);
              return((Image *) 
# 704 "MagickCore/constitute.c" 3 4
                              ((void *)0)
# 704 "MagickCore/constitute.c"
                                  );
            }
  ...
  if (decoder == (DecodeImageHandler *) 
# 713 "MagickCore/constitute.c" 3 4
                                       ((void *)0)
# 713 "MagickCore/constitute.c"
                                           )
    {
      delegate_info=GetDelegateInfo(read_info->magick,(char *) 
# 715 "MagickCore/constitute.c" 3 4
                                                              ((void *)0)
# 715 "MagickCore/constitute.c"
                                                                  ,exception);
      if (delegate_info == (const DelegateInfo *) 
# 716 "MagickCore/constitute.c" 3 4
                                                 ((void *)0)
# 716 "MagickCore/constitute.c"
                                                     )
        {
          (void) SetImageInfo(read_info,0,exception);
  ...
  if (decoder != (DecodeImageHandler *) 
# 725 "MagickCore/constitute.c" 3 4
                                       ((void *)0)
# 725 "MagickCore/constitute.c"
                                           )
    {
      ...
      if ((magick_info != (const MagickInfo *) 
# 730 "MagickCore/constitute.c" 3 4
                                              ((void *)0)
# 730 "MagickCore/constitute.c"
                                                  ) &&
      ...
      image=(Image *) 
# 734 "MagickCore/constitute.c" 3 4
                     ((void *)0)
# 734 "MagickCore/constitute.c"
                         ;
      if (status != MagickFalse)
        image=decoder(read_info,exception);
      if ((magick_info != (const MagickInfo *) 
# 737 "MagickCore/constitute.c" 3 4
                                              ((void *)0)
# 737 "MagickCore/constitute.c"
                                                  ) &&
          (GetMagickDecoderThreadSupport(magick_info) == MagickFalse))
    ...
    {
      delegate_info=GetDelegateInfo(read_info->magick,(char *) 
# 743 "MagickCore/constitute.c" 3 4
                                                              ((void *)0)
# 743 "MagickCore/constitute.c"
                                                                  ,exception);
      if (delegate_info == (const DelegateInfo *) 
# 744 "MagickCore/constitute.c" 3 4
                                                 ((void *)0)
# 744 "MagickCore/constitute.c"
                                                     )
        {
          (void) ThrowMagickException(exception,"MagickCore/constitute.c",__func__,(unsigned long) 746,
          ...
          read_info=DestroyImageInfo(read_info);
          return((Image *) 
# 752 "MagickCore/constitute.c" 3 4
                          ((void *)0)
# 752 "MagickCore/constitute.c"
                              );
        }
      ...
      image=AcquireImage(read_info,exception);
      if (image == (Image *) 
# 758 "MagickCore/constitute.c" 3 4
                            ((void *)0)
# 758 "MagickCore/constitute.c"
                                )
        {
          read_info=DestroyImageInfo(read_info);
          return((Image *) 
# 761 "MagickCore/constitute.c" 3 4
                          ((void *)0)
# 761 "MagickCore/constitute.c"
                              );
        }
      (void) CopyMagickString(image->filename,read_info->filename,
        4096);
      *read_info->filename='\0';
      ...
      status=InvokeDelegate(read_info,image,read_info->magick,(char *) 
# 768 "MagickCore/constitute.c" 3 4
                                                                      ((void *)0)
# 768 "MagickCore/constitute.c"
                                                                          ,
        exception);
      if (GetDelegateThreadSupport(delegate_info) == MagickFalse)
      ...
      decoder=GetImageDecoder(magick_info);
      if (decoder == (DecodeImageHandler *) 
# 778 "MagickCore/constitute.c" 3 4
                                           ((void *)0)
# 778 "MagickCore/constitute.c"
                                               )
        {
          if (IsPathAccessible(read_info->filename) != MagickFalse)
            (void) ThrowMagickException(exception,"MagickCore/constitute.c",__func__,(unsigned long) 781,
              MissingDelegateError,"NoDecodeDelegateForThisImageFormat","`%s'",
              read_info->magick);
          else
            { char *file_message; file_message=GetExceptionMessage(
# 785 "MagickCore/constitute.c" 3 4
           (*__errno_location ())
# 785 "MagickCore/constitute.c"
           ); (void) ThrowMagickException(exception,"MagickCore/constitute.c",__func__,(unsigned long) 785,FileOpenError,"UnableToOpenFile", "'%s': %s",read_info->filename,file_message); file_message=DestroyString(file_message); }
                                  ;
          read_info=DestroyImageInfo(read_info);
          return((Image *) 
# 788 "MagickCore/constitute.c" 3 4
                          ((void *)0)
# 788 "MagickCore/constitute.c"
                              );
        }
      ...
      status=IsCoderAuthorized(read_info->magick,ReadPolicyRights,exception);
      image=(Image *) 
# 796 "MagickCore/constitute.c" 3 4
                     ((void *)0)
# 796 "MagickCore/constitute.c"
                         ;
      if (status != MagickFalse)
        image=(decoder)(read_info,exception);
      if (GetMagickDecoderThreadSupport(magick_info) == MagickFalse)
  ...
  if (read_info->temporary != MagickFalse)
    {
      ...
      if (image != (Image *) 
# 806 "MagickCore/constitute.c" 3 4
                            ((void *)0)
# 806 "MagickCore/constitute.c"
                                )
        (void) CopyMagickString(image->filename,filename,4096);
    }
  if (image == (Image *) 
# 809 "MagickCore/constitute.c" 3 4
                        ((void *)0)
# 809 "MagickCore/constitute.c"
                            )
    {
      read_info=DestroyImageInfo(read_info);
      return(image);
  ...
  if (exception->severity >= ErrorException)
    (void) LogMagickEvent(ExceptionEvent,"MagickCore/constitute.c",__func__,(unsigned long) 815,
  ...
  if ((IsSceneGeometry(read_info->scenes,MagickFalse) != MagickFalse) &&
      (GetImageListLength(image) != 1))
    {
      ...
      if (clones != (Image *) 
# 827 "MagickCore/constitute.c" 3 4
                             ((void *)0)
# 827 "MagickCore/constitute.c"
                                 )
        {
          image=DestroyImageList(image);
  ...
  for (next=image; next != (Image *) 
# 834 "MagickCore/constitute.c" 3 4
                                    ((void *)0)
# 834 "MagickCore/constitute.c"
                                        ; next=GetNextImageInList(next))
  {
    ...
    static const char
      *source_date_epoch = (const char *) 
# 844 "MagickCore/constitute.c" 3 4
                                         ((void *)0)
# 844 "MagickCore/constitute.c"
                                             ;
    ...
    if ((*magick_path == '\0') && (*next->magick == '\0'))
      (void) CopyMagickString(next->magick,magick,4096);
    (void) CopyMagickString(next->magick_filename,magick_filename,
      4096);
    if (IsBlobTemporary(image) != MagickFalse)
      (void) CopyMagickString(next->filename,filename,4096);
    ...
    if (constitute_info.caption != (const char *) 
# 871 "MagickCore/constitute.c" 3 4
                                                 ((void *)0)
# 871 "MagickCore/constitute.c"
                                                     )
      {
    ...
    if (constitute_info.comment != (const char *) 
# 878 "MagickCore/constitute.c" 3 4
                                                 ((void *)0)
# 878 "MagickCore/constitute.c"
                                                     )
      {
        property=InterpretImageProperties(read_info,next,
    ...
    if (constitute_info.label != (const char *) 
# 885 "MagickCore/constitute.c" 3 4
                                               ((void *)0)
# 885 "MagickCore/constitute.c"
                                                   )
      {
        property=InterpretImageProperties(read_info,next,
    ...
    if ((read_info->extract != (char *) 
# 894 "MagickCore/constitute.c" 3 4
                                       ((void *)0)
# 894 "MagickCore/constitute.c"
                                           ) &&
        (read_info->stream == (StreamHandler) 
# 895 "MagickCore/constitute.c" 3 4
                                             ((void *)0)
# 895 "MagickCore/constitute.c"
                                                 ))
      {
        RectangleInfo
          geometry;
            ...
            if (((flags & XValue) != 0) || ((flags & YValue) != 0))
              {
                ...
                if (crop_image != (Image *) 
# 914 "MagickCore/constitute.c" 3 4
                                           ((void *)0)
# 914 "MagickCore/constitute.c"
                                               )
...
# 926 "MagickCore/constitute.c" 3 4
                                                   ((void *)0)
# 926 "MagickCore/constitute.c"
                                                       )
...
# 933 "MagickCore/constitute.c" 3 4
                                       ((void *)0)
# 933 "MagickCore/constitute.c"
                                           )
      profile=GetImageProfile(next,"icm");
    profile=GetImageProfile(next,"iptc");
    if (profile == (const StringInfo *) 
# 936 "MagickCore/constitute.c" 3 4
                                       ((void *)0)
# 936 "MagickCore/constitute.c"
                                           )
    ...
    if (source_date_epoch == (const char *) 
# 943 "MagickCore/constitute.c" 3 4
                                           ((void *)0)
# 943 "MagickCore/constitute.c"
                                               )
      {
        char
          timestamp[26];
        ...
        (void) FormatMagickTime((time_t) GetBlobProperties(next)->
# 950 "MagickCore/constitute.c" 3 4
                                                                 st_mtim.tv_sec
# 950 "MagickCore/constitute.c"
                                                                         ,
          sizeof(timestamp),timestamp);
        (void) SetImageProperty(next,"date:modify",timestamp,exception);
        (void) FormatMagickTime((time_t) GetBlobProperties(next)->
# 953 "MagickCore/constitute.c" 3 4
                                                                 st_ctim.tv_sec
# 953 "MagickCore/constitute.c"
                                                                         ,
          sizeof(timestamp),timestamp);
    ...
    if (constitute_info.dispose != (const char *) 
# 975 "MagickCore/constitute.c" 3 4
                                                 ((void *)0)
# 975 "MagickCore/constitute.c"
                                                     )
      {
        ssize_t
          option_type;
    ...
    if (read_info->verbose != MagickFalse)
      (void) IdentifyImage(next,
# 986 "MagickCore/constitute.c" 3 4
                               stderr
# 986 "MagickCore/constitute.c"
                                     ,MagickFalse,exception);
    image=next;
  }
  read_info=DestroyImageInfo(read_info);
  if (GetBlobError(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"MagickCore/constitute.c",__func__,(unsigned long) 991,CorruptImageError,"UnableToReadImageData", "`%s'",image_info->filename); if ((image) != (Image *) 
# 991 "MagickCore/constitute.c" 3 4
   ((void *)0)
# 991 "MagickCore/constitute.c"
...
# 1022 "MagickCore/constitute.c"
__attribute__ ((visibility ("default"))) Image *ReadImages(ImageInfo *image_info,const char *filename,
  ExceptionInfo *exception)
{
  char
    read_filename[4096];
...
# 1038 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1038 "MagickCore/constitute.c"
 image_info != (ImageInfo *) 
# 1038 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1038 "MagickCore/constitute.c"
...
# 1038 "MagickCore/constitute.c"
 "image_info != (ImageInfo *) NULL"
# 1038 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1038, __extension__ __PRETTY_FUNCTION__); }))
# 1038 "MagickCore/constitute.c"
                                         ;
  
# 1039 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1039 "MagickCore/constitute.c"
 image_info->signature == 0xabacadabUL
# 1039 "MagickCore/constitute.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1039 "MagickCore/constitute.c"
...
# 1039 "MagickCore/constitute.c"
 "image_info->signature == MagickCoreSignature"
# 1039 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1039, __extension__ __PRETTY_FUNCTION__); }))
# 1039 "MagickCore/constitute.c"
                                                     ;
  
# 1040 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1040 "MagickCore/constitute.c"
 exception != (ExceptionInfo *) 
# 1040 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1040 "MagickCore/constitute.c"
...
# 1040 "MagickCore/constitute.c"
 "exception != (ExceptionInfo *) NULL"
# 1040 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1040, __extension__ __PRETTY_FUNCTION__); }))
# 1040 "MagickCore/constitute.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/constitute.c",__func__,(unsigned long) 1042,"%s",
      image_info->filename);
  read_info=CloneImageInfo(image_info);
  *read_info->magick='\0';
  (void) SetImageOption(read_info,"filename",filename);
  (void) CopyMagickString(read_info->filename,filename,4096);
  (void) InterpretImageFilename(read_info,(Image *) 
# 1048 "MagickCore/constitute.c" 3 4
                                                   ((void *)0)
# 1048 "MagickCore/constitute.c"
                                                       ,filename,
      ...
      if (read_info->number_scenes != 0)
        {
          ...
          {
            (void) InterpretImageFilename(image_info,(Image *) 
# 1074 "MagickCore/constitute.c" 3 4
                                                              ((void *)0)
# 1074 "MagickCore/constitute.c"
                                                                  ,
              read_filename,(int) scene,read_info->filename,exception);
            image=ReadImage(read_info,exception);
            if (image == (Image *) 
# 1077 "MagickCore/constitute.c" 3 4
                                  ((void *)0)
# 1077 "MagickCore/constitute.c"
                                      )
              continue;
            AppendImageToList(&images,image);
          }
...
# 1121 "MagickCore/constitute.c"
__attribute__ ((visibility ("default"))) Image *ReadInlineImage(const ImageInfo *image_info,
  const char *content,ExceptionInfo *exception)
{
  ...
  if (*p == '\0')
    { (void) ThrowMagickException(exception,"MagickCore/constitute.c",__func__,(unsigned long) 1145,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1145 "MagickCore/constitute.c" 3 4
   ((void *)0)
# 1145 "MagickCore/constitute.c"
   ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1145 "MagickCore/constitute.c" 3 4
   ((void *)0)
# 1145 "MagickCore/constitute.c"
  ...
  if (length == 0)
    {
      ...
      { (void) ThrowMagickException(exception,"MagickCore/constitute.c",__func__,(unsigned long) 1150,CorruptImageError,"CorruptImage", "`%s'",image_info->filename); if ((image) != (Image *) 
# 1150 "MagickCore/constitute.c" 3 4
     ((void *)0)
# 1150 "MagickCore/constitute.c"
     ) { (void) CloseBlob(image); image=DestroyImageList(image); } return((Image *) 
# 1150 "MagickCore/constitute.c" 3 4
     ((void *)0)
# 1150 "MagickCore/constitute.c"
...
# 1153 "MagickCore/constitute.c" 3 4
                                                                      ((void *)0)
# 1153 "MagickCore/constitute.c"
                                                                          ,
    (void *) 
# 1154 "MagickCore/constitute.c" 3 4
            ((void *)0)
# 1154 "MagickCore/constitute.c"
                );
  *read_info->filename='\0';
  *read_info->magick='\0';
  for (p=content; (*p != '/') && (*p != '\0'); p++) ;
  if (*p != '\0')
    {
      ...
      if (LocaleNCompare(++p,"x-",2) == 0)
        p+=2;
      (void) CopyMagickString(read_info->filename,"data.",4096);
      q=read_info->filename+5;
      for (i=0; (*p != ';') && (*p != '\0') && (i < (4096 -6)); i++)
        *q++=(*p++);
      *q++='\0';
    }
...
# 1214 "MagickCore/constitute.c"
__attribute__ ((visibility ("default"))) MagickBooleanType WriteImage(const ImageInfo *image_info,
...
# 1245 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1245 "MagickCore/constitute.c"
 image_info != (ImageInfo *) 
# 1245 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1245 "MagickCore/constitute.c"
...
# 1245 "MagickCore/constitute.c"
 "image_info != (ImageInfo *) NULL"
# 1245 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1245, __extension__ __PRETTY_FUNCTION__); }))
# 1245 "MagickCore/constitute.c"
                                         ;
  
# 1246 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1246 "MagickCore/constitute.c"
 image_info->signature == 0xabacadabUL
# 1246 "MagickCore/constitute.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1246 "MagickCore/constitute.c"
...
# 1246 "MagickCore/constitute.c"
 "image_info->signature == MagickCoreSignature"
# 1246 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1246, __extension__ __PRETTY_FUNCTION__); }))
# 1246 "MagickCore/constitute.c"
                                                     ;
  
# 1247 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1247 "MagickCore/constitute.c"
 image != (Image *) 
# 1247 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1247 "MagickCore/constitute.c"
...
# 1247 "MagickCore/constitute.c"
 "image != (Image *) NULL"
# 1247 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1247, __extension__ __PRETTY_FUNCTION__); }))
# 1247 "MagickCore/constitute.c"
                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/constitute.c",__func__,(unsigned long) 1249,"%s",
      image_info->filename);
  
# 1251 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1251 "MagickCore/constitute.c"
...
# 1251 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1251, __extension__ __PRETTY_FUNCTION__); }))
# 1251 "MagickCore/constitute.c"
                                                ;
  
# 1252 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1252 "MagickCore/constitute.c"
 exception != (ExceptionInfo *) 
# 1252 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1252 "MagickCore/constitute.c"
...
# 1252 "MagickCore/constitute.c"
 "exception != (ExceptionInfo *) NULL"
# 1252 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1252, __extension__ __PRETTY_FUNCTION__); }))
# 1252 "MagickCore/constitute.c"
                                            ;
  sans_exception=AcquireExceptionInfo();
  ...
  if (*write_info->magick == '\0')
    (void) CopyMagickString(write_info->magick,image->magick,4096);
  ...
  sans_exception=DestroyExceptionInfo(sans_exception);
  if (magick_info != (const MagickInfo *) 
# 1270 "MagickCore/constitute.c" 3 4
                                         ((void *)0)
# 1270 "MagickCore/constitute.c"
                                             )
    {
      if (GetMagickEndianSupport(magick_info) == MagickFalse)
  ...
  if ((IsStringTrue(option) != MagickFalse) &&
      (write_info->page == (char *) 
# 1289 "MagickCore/constitute.c" 3 4
                                   ((void *)0)
# 1289 "MagickCore/constitute.c"
                                       ) &&
      (GetPreviousImageInList(image) == (Image *) 
# 1290 "MagickCore/constitute.c" 3 4
                                                 ((void *)0)
# 1290 "MagickCore/constitute.c"
                                                     ) &&
      (GetNextImageInList(image) == (Image *) 
# 1291 "MagickCore/constitute.c" 3 4
                                             ((void *)0)
# 1291 "MagickCore/constitute.c"
                                                 ) &&
      (IsTaintImage(image) == MagickFalse) )
    {
      delegate_info=GetDelegateInfo(image->magick,write_info->magick,exception);
      if ((delegate_info != (const DelegateInfo *) 
# 1295 "MagickCore/constitute.c" 3 4
                                                  ((void *)0)
# 1295 "MagickCore/constitute.c"
                                                      ) &&
  ...
  if ((magick_info != (const MagickInfo *) 
# 1313 "MagickCore/constitute.c" 3 4
                                          ((void *)0)
# 1313 "MagickCore/constitute.c"
                                              ) &&
      (GetMagickEncoderSeekableStream(magick_info) != MagickFalse))
    {
      ...
      (void) CopyMagickString(image_filename,image->filename,4096);
      status=OpenBlob(image_info,image,WriteBinaryBlobMode,exception);
      (void) CopyMagickString(image->filename, image_filename,4096);
      if (status != MagickFalse)
        {
          if (IsBlobSeekable(image) == MagickFalse)
            {
  ...
  if (encoder != (EncodeImageHandler *) 
# 1340 "MagickCore/constitute.c" 3 4
                                       ((void *)0)
# 1340 "MagickCore/constitute.c"
                                           )
    {
      ...
      if ((magick_info != (const MagickInfo *) 
# 1345 "MagickCore/constitute.c" 3 4
                                              ((void *)0)
# 1345 "MagickCore/constitute.c"
                                                  ) &&
      ...
      if ((magick_info != (const MagickInfo *) 
# 1351 "MagickCore/constitute.c" 3 4
                                              ((void *)0)
# 1351 "MagickCore/constitute.c"
                                                  ) &&
          (GetMagickEncoderThreadSupport(magick_info) == MagickFalse))
        UnlockSemaphoreInfo(magick_info->semaphore);
    }
    ...
    {
      delegate_info=GetDelegateInfo((char *) 
# 1357 "MagickCore/constitute.c" 3 4
                                            ((void *)0)
# 1357 "MagickCore/constitute.c"
                                                ,write_info->magick,exception);
      if (delegate_info != (DelegateInfo *) 
# 1358 "MagickCore/constitute.c" 3 4
                                           ((void *)0)
# 1358 "MagickCore/constitute.c"
                                               )
        {
          ...
          *write_info->filename='\0';
          if (GetDelegateThreadSupport(delegate_info) == MagickFalse)
            LockSemaphoreInfo(delegate_info->semaphore);
          status=InvokeDelegate(write_info,image,(char *) 
# 1366 "MagickCore/constitute.c" 3 4
                                                         ((void *)0)
# 1366 "MagickCore/constitute.c"
                                                             ,
            write_info->magick,exception);
          if (GetDelegateThreadSupport(delegate_info) == MagickFalse)
            UnlockSemaphoreInfo(delegate_info->semaphore);
...
# 1380 "MagickCore/constitute.c" 3 4
                                                  ((void *)0)
# 1380 "MagickCore/constitute.c"
                                                      ))
            {
          ...
          encoder=GetImageEncoder(magick_info);
          if (encoder == (EncodeImageHandler *) 
# 1387 "MagickCore/constitute.c" 3 4
                                               ((void *)0)
# 1387 "MagickCore/constitute.c"
                                                   )
            {
              char
                extension[4096];
              ...
              (void) CopyMagickString(image->filename,filename,
                4096);
              encoder=GetImageEncoder(magick_info);
              (void) ThrowMagickException(exception,"MagickCore/constitute.c",__func__,(unsigned long) 1400,
                MissingDelegateWarning,"NoEncodeDelegateForThisImageFormat",
                "`%s'",write_info->magick);
            }
          if (encoder == (EncodeImageHandler *) 
# 1404 "MagickCore/constitute.c" 3 4
                                               ((void *)0)
# 1404 "MagickCore/constitute.c"
                                                   )
            {
              magick_info=GetMagickInfo(image->magick,exception);
              encoder=GetImageEncoder(magick_info);
              if (encoder == (EncodeImageHandler *) 
# 1408 "MagickCore/constitute.c" 3 4
                                                   ((void *)0)
# 1408 "MagickCore/constitute.c"
                                                       )
                (void) ThrowMagickException(exception,"MagickCore/constitute.c",__func__,(unsigned long) 1409,
                  MissingDelegateError,"NoEncodeDelegateForThisImageFormat",
                  "`%s'",write_info->magick);
            }
          if (encoder != (EncodeImageHandler *) 
# 1413 "MagickCore/constitute.c" 3 4
                                               ((void *)0)
# 1413 "MagickCore/constitute.c"
                                                   )
            {
  ...
  if ((LocaleCompare(write_info->magick,"info") != 0) &&
    ...
    (void) IdentifyImage(image,
# 1448 "MagickCore/constitute.c" 3 4
                              stdout
# 1448 "MagickCore/constitute.c"
                                    ,MagickFalse,exception);
  write_info=DestroyImageInfo(write_info);
  if (GetBlobError(image) != MagickFalse)
    { (void) ThrowMagickException(exception,"MagickCore/constitute.c",__func__,(unsigned long) 1451,FileOpenError,"UnableToWriteFile", "`%s'",image->filename); if (image_info->adjoin != MagickFalse) while (image->previous != (Image *) 
# 1451 "MagickCore/constitute.c" 3 4
   ((void *)0)
# 1451 "MagickCore/constitute.c"
   ) image=image->previous; (void) CloseBlob(image); return(MagickFalse); };
  return(status);
}
# 1491 "MagickCore/constitute.c"
__attribute__ ((visibility ("default"))) MagickBooleanType WriteImages(const ImageInfo *image_info,
...
# 1520 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1520 "MagickCore/constitute.c"
...
# 1520 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1520, __extension__ __PRETTY_FUNCTION__); }))
# 1520 "MagickCore/constitute.c"
                                               ;
  
# 1521 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1521 "MagickCore/constitute.c"
 image_info->signature == 0xabacadabUL
# 1521 "MagickCore/constitute.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1521 "MagickCore/constitute.c"
...
# 1521 "MagickCore/constitute.c"
 "image_info->signature == MagickCoreSignature"
# 1521 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1521, __extension__ __PRETTY_FUNCTION__); }))
# 1521 "MagickCore/constitute.c"
                                                     ;
  
# 1522 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1522 "MagickCore/constitute.c"
 images != (Image *) 
# 1522 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1522 "MagickCore/constitute.c"
...
# 1522 "MagickCore/constitute.c"
 "images != (Image *) NULL"
# 1522 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1522, __extension__ __PRETTY_FUNCTION__); }))
# 1522 "MagickCore/constitute.c"
                                 ;
  
# 1523 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1523 "MagickCore/constitute.c"
...
# 1523 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1523, __extension__ __PRETTY_FUNCTION__); }))
# 1523 "MagickCore/constitute.c"
                                                 ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/constitute.c",__func__,(unsigned long) 1525,"%s",images->filename);
  
# 1526 "MagickCore/constitute.c" 3 4
 ((void) sizeof ((
# 1526 "MagickCore/constitute.c"
 exception != (ExceptionInfo *) 
# 1526 "MagickCore/constitute.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1526 "MagickCore/constitute.c"
...
# 1526 "MagickCore/constitute.c"
 "exception != (ExceptionInfo *) NULL"
# 1526 "MagickCore/constitute.c" 3 4
 , "MagickCore/constitute.c", 1526, __extension__ __PRETTY_FUNCTION__); }))
# 1526 "MagickCore/constitute.c"
                                            ;
  write_info=CloneImageInfo(image_info);
  *write_info->magick='\0';
  ...
  if (images == (Image *) 
# 1530 "MagickCore/constitute.c" 3 4
                         ((void *)0)
# 1530 "MagickCore/constitute.c"
                             )
    return(MagickFalse);
  if (filename != (const char *) 
# 1532 "MagickCore/constitute.c" 3 4
                                ((void *)0)
# 1532 "MagickCore/constitute.c"
                                    )
    for (p=images; p != (Image *) 
# 1533 "MagickCore/constitute.c" 3 4
                                 ((void *)0)
# 1533 "MagickCore/constitute.c"
                                     ; p=GetNextImageInList(p))
      (void) CopyMagickString(p->filename,filename,4096);
  ...
  sans_exception=DestroyExceptionInfo(sans_exception);
  if (*write_info->magick == '\0')
    (void) CopyMagickString(write_info->magick,images->magick,4096);
  p=images;
  for ( ; GetNextImageInList(p) != (Image *) 
# 1544 "MagickCore/constitute.c" 3 4
                                            ((void *)0)
# 1544 "MagickCore/constitute.c"
                                                ; p=GetNextImageInList(p))
  {
    Image
      *next;
    ...
    if (next == (Image *) 
# 1550 "MagickCore/constitute.c" 3 4
                         ((void *)0)
# 1550 "MagickCore/constitute.c"
                             )
      break;
    if (p->scene >= next->scene)
      {
        ...
        for (p=images; p != (Image *) 
# 1561 "MagickCore/constitute.c" 3 4
                                     ((void *)0)
# 1561 "MagickCore/constitute.c"
                                         ; p=GetNextImageInList(p))
          p->scene=(size_t) i++;
        break;
      }
...
# 1570 "MagickCore/constitute.c" 3 4
                                          ((void *)0)
# 1570 "MagickCore/constitute.c"
                                              ;
  progress=0;
  number_images=GetImageListLength(images);
  for (p=images; p != (Image *) 
# 1573 "MagickCore/constitute.c" 3 4
                               ((void *)0)
# 1573 "MagickCore/constitute.c"
                                   ; p=GetNextImageInList(p))
  {
    if (number_images != 1)
      progress_monitor=SetImageProgressMonitor(p,(MagickProgressMonitor) 
# 1576 "MagickCore/constitute.c" 3 4
                                                                        ((void *)0)
# 1576 "MagickCore/constitute.c"
                                                                            ,
        p->client_data);
