# 0 "MagickCore/paint.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/paint.c"
# 42 "MagickCore/paint.c"
...
# 66 "MagickCore/paint.c" 2
# 112 "MagickCore/paint.c"
__attribute__ ((visibility ("default"))) MagickBooleanType FloodfillPaintImage(Image *image,
  const DrawInfo *draw_info,const PixelInfo *target,const ssize_t x_offset,
  const ssize_t y_offset,const MagickBooleanType invert,
  ExceptionInfo *exception)
{
# 141 "MagickCore/paint.c"
  CacheView
    *floodplane_view,
    *image_view;
...
# 174 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 174 "MagickCore/paint.c"
 image != (Image *) 
# 174 "MagickCore/paint.c" 3 4
...
# 174 "MagickCore/paint.c"
 "image != (Image *) NULL"
# 174 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 174, __extension__ __PRETTY_FUNCTION__); }))
# 174 "MagickCore/paint.c"
                                ;
  
# 175 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 175 "MagickCore/paint.c"
...
# 175 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 175, __extension__ __PRETTY_FUNCTION__); }))
# 175 "MagickCore/paint.c"
                                                ;
  
# 176 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 176 "MagickCore/paint.c"
 draw_info != (DrawInfo *) 
# 176 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 176 "MagickCore/paint.c"
...
# 176 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 176, __extension__ __PRETTY_FUNCTION__); }))
# 176 "MagickCore/paint.c"
                                       ;
  
# 177 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 177 "MagickCore/paint.c"
...
# 177 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 177, __extension__ __PRETTY_FUNCTION__); }))
# 177 "MagickCore/paint.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/paint.c",__func__,(unsigned long) 179,"%s",image->filename);
  ...
  if (floodplane_image == (Image *) 
# 195 "MagickCore/paint.c" 3 4
                                   ((void *)0)
# 195 "MagickCore/paint.c"
                                       )
    return(MagickFalse);
  ...
  segment_info=AcquireVirtualMemory(524288UL,sizeof(*segment_stack));
  if (segment_info == (MemoryInfo *) 
# 203 "MagickCore/paint.c" 3 4
                                    ((void *)0)
# 203 "MagickCore/paint.c"
                                        )
    {
      floodplane_image=DestroyImage(floodplane_image);
      { (void) ThrowMagickException(exception,"MagickCore/paint.c",__func__,(unsigned long) 206,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  ...
  { if (s >= (segment_stack+524288UL)) { segment_info=RelinquishVirtualMemory(segment_info); image_view=DestroyCacheView(image_view); floodplane_view=DestroyCacheView(floodplane_view); floodplane_image=DestroyImage(floodplane_image); { (void) ThrowMagickException(exception,"MagickCore/paint.c",__func__,(unsigned long) 219,DrawError,"SegmentStackOverflow", "`%s'",image->filename); return(MagickFalse); } } else { if ((((y_offset)+(1)) >= 0) && (((y_offset)+(1)) < (ssize_t) image->rows)) { s->x1=(double) (x_offset); s->y1=(double) (y_offset); s->x2=(double) (x_offset); s->y2=(double) (1); s++; } } };
  { if (s >= (segment_stack+524288UL)) { segment_info=RelinquishVirtualMemory(segment_info); image_view=DestroyCacheView(image_view); floodplane_view=DestroyCacheView(floodplane_view); floodplane_image=DestroyImage(floodplane_image); { (void) ThrowMagickException(exception,"MagickCore/paint.c",__func__,(unsigned long) 220,DrawError,"SegmentStackOverflow", "`%s'",image->filename); return(MagickFalse); } } else { if ((((y_offset+1)+(-1)) >= 0) && (((y_offset+1)+(-1)) < (ssize_t) image->rows)) { s->x1=(double) (x_offset); s->y1=(double) (y_offset+1); s->x2=(double) (x_offset); s->y2=(double) (-1); s++; } } };
  while (s > segment_stack)
  {
    ...
    q=GetCacheViewAuthenticPixels(floodplane_view,0,y,(size_t) (x1+1),1,
      exception);
    if ((p == (const Quantum *) 
# 246 "MagickCore/paint.c" 3 4
                               ((void *)0)
# 246 "MagickCore/paint.c"
                                   ) || (q == (Quantum *) 
# 246 "MagickCore/paint.c" 3 4
                                                          ((void *)0)
# 246 "MagickCore/paint.c"
    ...
    for (x=x1; x >= 0; x--)
    {
      ...
      if (IsFuzzyEquivalencePixelInfo(&pixel,target) == invert)
        break;
      SetPixelGray(floodplane_image,((Quantum) 65535.0),q);
    ...
    if (skip == MagickFalse)
      {
        start=x+1;
        if (start < x1)
          { if (s >= (segment_stack+524288UL)) { segment_info=RelinquishVirtualMemory(segment_info); image_view=DestroyCacheView(image_view); floodplane_view=DestroyCacheView(floodplane_view); floodplane_image=DestroyImage(floodplane_image); { (void) ThrowMagickException(exception,"MagickCore/paint.c",__func__,(unsigned long) 268,DrawError,"SegmentStackOverflow", "`%s'",image->filename); return(MagickFalse); } } else { if ((((y)+(-offset)) >= 0) && (((y)+(-offset)) < (ssize_t) image->rows)) { s->x1=(double) (start); s->y1=(double) (y); s->x2=(double) (x1-1); s->y2=(double) (-offset); s++; } } };
        x=x1+1;
      }
    do
    {
          ...
          if (x < (ssize_t) image->columns)
            {
              ...
              q=GetCacheViewAuthenticPixels(floodplane_view,x,y,(size_t)
                ((ssize_t) image->columns-x),1,exception);
              if ((p == (const Quantum *) 
# 281 "MagickCore/paint.c" 3 4
                                         ((void *)0)
# 281 "MagickCore/paint.c"
                                             ) || (q == (Quantum *) 
# 281 "MagickCore/paint.c" 3 4
                                                                    ((void *)0)
# 281 "MagickCore/paint.c"
          ...
          { if (s >= (segment_stack+524288UL)) { segment_info=RelinquishVirtualMemory(segment_info); image_view=DestroyCacheView(image_view); floodplane_view=DestroyCacheView(floodplane_view); floodplane_image=DestroyImage(floodplane_image); { (void) ThrowMagickException(exception,"MagickCore/paint.c",__func__,(unsigned long) 298,DrawError,"SegmentStackOverflow", "`%s'",image->filename); return(MagickFalse); } } else { if ((((y)+(offset)) >= 0) && (((y)+(offset)) < (ssize_t) image->rows)) { s->x1=(double) (start); s->y1=(double) (y); s->x2=(double) (x-1); s->y2=(double) (offset); s++; } } };
          if (x > (x2+1))
            { if (s >= (segment_stack+524288UL)) { segment_info=RelinquishVirtualMemory(segment_info); image_view=DestroyCacheView(image_view); floodplane_view=DestroyCacheView(floodplane_view); floodplane_image=DestroyImage(floodplane_image); { (void) ThrowMagickException(exception,"MagickCore/paint.c",__func__,(unsigned long) 300,DrawError,"SegmentStackOverflow", "`%s'",image->filename); return(MagickFalse); } } else { if ((((y)+(-offset)) >= 0) && (((y)+(-offset)) < (ssize_t) image->rows)) { s->x1=(double) (x2+1); s->y1=(double) (y); s->x2=(double) (x-1); s->y2=(double) (-offset); s++; } } };
        }
      skip=MagickFalse;
      x++;
      if (x <= x2)
        {
          ...
          q=GetCacheViewAuthenticPixels(floodplane_view,x,y,(size_t) (x2-x+1),1,
            exception);
          if ((p == (const Quantum *) 
# 310 "MagickCore/paint.c" 3 4
                                     ((void *)0)
# 310 "MagickCore/paint.c"
                                         ) || (q == (Quantum *) 
# 310 "MagickCore/paint.c" 3 4
                                                                ((void *)0)
# 310 "MagickCore/paint.c"
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if ((p == (const Quantum *) 
# 349 "MagickCore/paint.c" 3 4
                               ((void *)0)
# 349 "MagickCore/paint.c"
                                   ) || (q == (Quantum *) 
# 349 "MagickCore/paint.c" 3 4
                                                          ((void *)0)
# 349 "MagickCore/paint.c"
...
# 425 "MagickCore/paint.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GradientImage(Image *image,
...
# 444 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 444 "MagickCore/paint.c"
 image != (const Image *) 
# 444 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 444 "MagickCore/paint.c"
...
# 444 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 444, __extension__ __PRETTY_FUNCTION__); }))
# 444 "MagickCore/paint.c"
                                      ;
  
# 445 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 445 "MagickCore/paint.c"
 image->signature == 0xabacadabUL
# 445 "MagickCore/paint.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 445 "MagickCore/paint.c"
...
# 445 "MagickCore/paint.c"
 "image->signature == MagickCoreSignature"
# 445 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 445, __extension__ __PRETTY_FUNCTION__); }))
# 445 "MagickCore/paint.c"
                                                ;
  
# 446 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 446 "MagickCore/paint.c"
 stops != (const StopInfo *) 
# 446 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 446 "MagickCore/paint.c"
 stops != (const StopInfo *) 
# 446 "MagickCore/paint.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 446 "MagickCore/paint.c"
 "stops != (const StopInfo *) NULL"
# 446 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 446, __extension__ __PRETTY_FUNCTION__); }))
# 446 "MagickCore/paint.c"
                                         ;
  
# 447 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 447 "MagickCore/paint.c"
 number_stops > 0
# 447 "MagickCore/paint.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 447 "MagickCore/paint.c"
...
# 447 "MagickCore/paint.c"
 "number_stops > 0"
# 447 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 447, __extension__ __PRETTY_FUNCTION__); }))
# 447 "MagickCore/paint.c"
                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/paint.c",__func__,(unsigned long) 449,"%s",image->filename);
...
# 456 "MagickCore/paint.c" 3 4
                                ((void *)0)
# 456 "MagickCore/paint.c"
                                    )
  ...
  if (artifact != (const char *) 
# 461 "MagickCore/paint.c" 3 4
                                ((void *)0)
# 461 "MagickCore/paint.c"
                                    )
    {
      GravityType
        direction;
  ...
  if (artifact != (const char *) 
# 539 "MagickCore/paint.c" 3 4
                                ((void *)0)
# 539 "MagickCore/paint.c"
                                    )
    gradient->angle=StringToDouble(artifact,(char **) 
# 540 "MagickCore/paint.c" 3 4
                                                     ((void *)0)
# 540 "MagickCore/paint.c"
                                                         );
  artifact=GetImageArtifact(image,"gradient:vector");
  if (artifact != (const char *) 
# 542 "MagickCore/paint.c" 3 4
                                ((void *)0)
# 542 "MagickCore/paint.c"
                                    )
  ...
  if ((GetImageArtifact(image,"gradient:angle") == (const char *) 
# 546 "MagickCore/paint.c" 3 4
                                                                 ((void *)0)
# 546 "MagickCore/paint.c"
                                                                     ) &&
      (GetImageArtifact(image,"gradient:direction") == (const char *) 
# 547 "MagickCore/paint.c" 3 4
                                                                     ((void *)0)
# 547 "MagickCore/paint.c"
                                                                         ) &&
      (GetImageArtifact(image,"gradient:extent") == (const char *) 
# 548 "MagickCore/paint.c" 3 4
                                                                  ((void *)0)
# 548 "MagickCore/paint.c"
                                                                      ) &&
      (GetImageArtifact(image,"gradient:vector") == (const char *) 
# 549 "MagickCore/paint.c" 3 4
                                                                  ((void *)0)
# 549 "MagickCore/paint.c"
                                                                      ))
  ...
  if (artifact != (const char *) 
# 555 "MagickCore/paint.c" 3 4
                                ((void *)0)
# 555 "MagickCore/paint.c"
                                    )
    (void) sscanf(artifact,"%lf%*[ ,]%lf",&gradient->center.x,
      &gradient->center.y);
  artifact=GetImageArtifact(image,"gradient:angle");
  if ((type == LinearGradient) && (artifact != (const char *) 
# 559 "MagickCore/paint.c" 3 4
                                                             ((void *)0)
# 559 "MagickCore/paint.c"
                                                                 ))
    {
      double
        sine,
  ...
  gradient->radii.x=(double) ((((image->columns-1.0)) > ((image->rows-1.0))) ? ((image->columns-1.0)) : ((image->rows-1.0)))/
    2.0;
  gradient->radii.y=gradient->radii.x;
  artifact=GetImageArtifact(image,"gradient:extent");
  if (artifact != (const char *) 
# 582 "MagickCore/paint.c" 3 4
                                ((void *)0)
# 582 "MagickCore/paint.c"
                                    )
    {
  ...
  if (artifact != (const char *) 
# 615 "MagickCore/paint.c" 3 4
                                ((void *)0)
# 615 "MagickCore/paint.c"
                                    )
    (void) sscanf(artifact,"%lf%*[ ,]%lf",&gradient->radii.x,
      &gradient->radii.y);
  gradient->radius=(((gradient->radii.x) > (gradient->radii.y)) ? (gradient->radii.x) : (gradient->radii.y));
  ...
  if (gradient->stops == (StopInfo *) 
# 626 "MagickCore/paint.c" 3 4
                                     ((void *)0)
# 626 "MagickCore/paint.c"
                                         )
    { (void) ThrowMagickException(exception,"MagickCore/paint.c",__func__,(unsigned long) 627,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
...
# 675 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 675 "MagickCore/paint.c"
 histogram != (size_t **) 
# 675 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 675 "MagickCore/paint.c"
...
# 675 "MagickCore/paint.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 675 "MagickCore/paint.c"
 "histogram != (size_t **) NULL"
# 675 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 675, __extension__ __PRETTY_FUNCTION__); }))
# 675 "MagickCore/paint.c"
                                      ;
  for (i=0; i < (ssize_t) GetMagickResourceLimit(ThreadResource); i++)
    if (histogram[i] != (size_t *) 
# 677 "MagickCore/paint.c" 3 4
                                  ((void *)0)
# 677 "MagickCore/paint.c"
                                      )
...
static size_t **AcquireHistogramTLS(const size_t count)
{
  ...
  if (histogram == (size_t **) 
# 694 "MagickCore/paint.c" 3 4
                              ((void *)0)
# 694 "MagickCore/paint.c"
                                  )
    return((size_t **) 
# 695 "MagickCore/paint.c" 3 4
                      ((void *)0)
# 695 "MagickCore/paint.c"
                          );
  ...
  for (i=0; i < (ssize_t) number_threads; i++)
  {
    ...
    if (histogram[i] == (size_t *) 
# 700 "MagickCore/paint.c" 3 4
                                  ((void *)0)
# 700 "MagickCore/paint.c"
                                      )
...
__attribute__ ((visibility ("default"))) Image *OilPaintImage(const Image *image,const double radius,
...
# 737 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 737 "MagickCore/paint.c"
 image != (const Image *) 
# 737 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 737 "MagickCore/paint.c"
...
# 737 "MagickCore/paint.c"
 "image != (const Image *) NULL"
# 737 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 737, __extension__ __PRETTY_FUNCTION__); }))
# 737 "MagickCore/paint.c"
                                      ;
  
# 738 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 738 "MagickCore/paint.c"
 image->signature == 0xabacadabUL
# 738 "MagickCore/paint.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 738 "MagickCore/paint.c"
...
# 738 "MagickCore/paint.c"
 "image->signature == MagickCoreSignature"
# 738 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 738, __extension__ __PRETTY_FUNCTION__); }))
# 738 "MagickCore/paint.c"
                                                ;
  
# 739 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 739 "MagickCore/paint.c"
...
# 739 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 739, __extension__ __PRETTY_FUNCTION__); }))
# 739 "MagickCore/paint.c"
                                            ;
  
# 740 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 740 "MagickCore/paint.c"
...
# 740 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 740, __extension__ __PRETTY_FUNCTION__); }))
# 740 "MagickCore/paint.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/paint.c",__func__,(unsigned long) 742,"%s",image->filename);
  width=GetOptimalKernelWidth2D(radius,sigma);
  linear_image=CloneImage(image,0,0,MagickTrue,exception);
  paint_image=CloneImage(image,0,0,MagickTrue,exception);
  if ((linear_image == (Image *) 
# 746 "MagickCore/paint.c" 3 4
                                ((void *)0)
# 746 "MagickCore/paint.c"
                                    ) || (paint_image == (Image *) 
# 746 "MagickCore/paint.c" 3 4
                                                                   ((void *)0)
# 746 "MagickCore/paint.c"
    ...
    {
      if (linear_image != (Image *) 
# 748 "MagickCore/paint.c" 3 4
                                   ((void *)0)
# 748 "MagickCore/paint.c"
                                       )
        linear_image=DestroyImage(linear_image);
      if (paint_image != (Image *) 
# 750 "MagickCore/paint.c" 3 4
                                  ((void *)0)
# 750 "MagickCore/paint.c"
                                      )
        linear_image=DestroyImage(paint_image);
      return((Image *) 
# 752 "MagickCore/paint.c" 3 4
                      ((void *)0)
# 752 "MagickCore/paint.c"
                          );
    }
  if (SetImageStorageClass(paint_image,DirectClass,exception) == MagickFalse)
    {
      ...
      return((Image *) 
# 758 "MagickCore/paint.c" 3 4
                      ((void *)0)
# 758 "MagickCore/paint.c"
                          );
    }
  histograms=AcquireHistogramTLS(256);
  if (histograms == (size_t **) 
# 761 "MagickCore/paint.c" 3 4
                               ((void *)0)
# 761 "MagickCore/paint.c"
                                   )
    {
      linear_image=DestroyImage(linear_image);
      paint_image=DestroyImage(paint_image);
      { (void) ThrowMagickException(exception,"MagickCore/paint.c",__func__,(unsigned long) 765,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 765 "MagickCore/paint.c" 3 4
     ((void *)0)
# 765 "MagickCore/paint.c"
     ); };
    }
  ...
  for (y=0; y < (ssize_t) linear_image->rows; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(paint_view,0,y,paint_image->columns,1,
      exception);
    if ((p == (const Quantum *) 
# 800 "MagickCore/paint.c" 3 4
                               ((void *)0)
# 800 "MagickCore/paint.c"
                                   ) || (q == (Quantum *) 
# 800 "MagickCore/paint.c" 3 4
                                                          ((void *)0)
# 800 "MagickCore/paint.c"
    ...
    for (x=0; x < (ssize_t) linear_image->columns; x++)
    {
      ...
      j=0;
      count=0;
      (void) memset(histogram,0,256* sizeof(*histogram));
    ...
    if (SyncCacheViewAuthenticPixels(paint_view,exception) == MagickFalse)
      status=MagickFalse;
    if (linear_image->progress_monitor != (MagickProgressMonitor) 
# 864 "MagickCore/paint.c" 3 4
                                                                 ((void *)0)
# 864 "MagickCore/paint.c"
                                                                     )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(linear_image,"OilPaint/Image",progress,
          linear_image->rows);
...
# 927 "MagickCore/paint.c"
__attribute__ ((visibility ("default"))) MagickBooleanType OpaquePaintImage(Image *image,
...
# 950 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 950 "MagickCore/paint.c"
 image != (Image *) 
# 950 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 950 "MagickCore/paint.c"
...
# 950 "MagickCore/paint.c"
 "image != (Image *) NULL"
# 950 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 950, __extension__ __PRETTY_FUNCTION__); }))
# 950 "MagickCore/paint.c"
                                ;
  
# 951 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 951 "MagickCore/paint.c"
 image->signature == 0xabacadabUL
# 951 "MagickCore/paint.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 951 "MagickCore/paint.c"
...
# 951 "MagickCore/paint.c"
 "image->signature == MagickCoreSignature"
# 951 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 951, __extension__ __PRETTY_FUNCTION__); }))
# 951 "MagickCore/paint.c"
                                                ;
  
# 952 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 952 "MagickCore/paint.c"
 target != (PixelInfo *) 
# 952 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 952 "MagickCore/paint.c"
...
# 952 "MagickCore/paint.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 952 "MagickCore/paint.c"
 "target != (PixelInfo *) NULL"
# 952 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 952, __extension__ __PRETTY_FUNCTION__); }))
# 952 "MagickCore/paint.c"
                                     ;
  
# 953 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 953 "MagickCore/paint.c"
 fill != (PixelInfo *) 
# 953 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 953 "MagickCore/paint.c"
...
# 953 "MagickCore/paint.c"
 "fill != (PixelInfo *) NULL"
# 953 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 953, __extension__ __PRETTY_FUNCTION__); }))
# 953 "MagickCore/paint.c"
                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/paint.c",__func__,(unsigned long) 955,"%s",image->filename);
  if (SetImageStorageClass(image,DirectClass,exception) == MagickFalse)
    return(MagickFalse);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 985 "MagickCore/paint.c" 3 4
                        ((void *)0)
# 985 "MagickCore/paint.c"
                            )
      {
        status=MagickFalse;
        continue;
...
# 1019 "MagickCore/paint.c" 3 4
                                                          ((void *)0)
# 1019 "MagickCore/paint.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"Opaque/Image",progress,
          image->rows);
        if (proceed == MagickFalse)
          status=MagickFalse;
      }
...
# 1077 "MagickCore/paint.c"
__attribute__ ((visibility ("default"))) MagickBooleanType TransparentPaintImage(Image *image,
...
# 1098 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 1098 "MagickCore/paint.c"
 image != (Image *) 
# 1098 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1098 "MagickCore/paint.c"
...
# 1098 "MagickCore/paint.c"
 "image != (Image *) NULL"
# 1098 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 1098, __extension__ __PRETTY_FUNCTION__); }))
# 1098 "MagickCore/paint.c"
                                ;
  
# 1099 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 1099 "MagickCore/paint.c"
 image->signature == 0xabacadabUL
# 1099 "MagickCore/paint.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1099 "MagickCore/paint.c"
...
# 1099 "MagickCore/paint.c"
 "image->signature == MagickCoreSignature"
# 1099 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 1099, __extension__ __PRETTY_FUNCTION__); }))
# 1099 "MagickCore/paint.c"
                                                ;
  
# 1100 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 1100 "MagickCore/paint.c"
 target != (PixelInfo *) 
# 1100 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1100 "MagickCore/paint.c"
...
# 1100 "MagickCore/paint.c"
 "target != (PixelInfo *) NULL"
# 1100 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 1100, __extension__ __PRETTY_FUNCTION__); }))
# 1100 "MagickCore/paint.c"
                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/paint.c",__func__,(unsigned long) 1102,"%s",image->filename);
  if (SetImageStorageClass(image,DirectClass,exception) == MagickFalse)
    return(MagickFalse);
  if ((image->alpha_trait & BlendPixelTrait) == 0)
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 1132 "MagickCore/paint.c" 3 4
                        ((void *)0)
# 1132 "MagickCore/paint.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1147 "MagickCore/paint.c" 3 4
                                                          ((void *)0)
# 1147 "MagickCore/paint.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"Transparent/Image",progress,
          image->rows);
        if (proceed == MagickFalse)
          status=MagickFalse;
      }
...
# 1208 "MagickCore/paint.c"
__attribute__ ((visibility ("default"))) MagickBooleanType TransparentPaintImageChroma(Image *image,
...
# 1226 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 1226 "MagickCore/paint.c"
 image != (Image *) 
# 1226 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1226 "MagickCore/paint.c"
...
# 1226 "MagickCore/paint.c"
 "image != (Image *) NULL"
# 1226 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 1226, __extension__ __PRETTY_FUNCTION__); }))
# 1226 "MagickCore/paint.c"
                                ;
  
# 1227 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 1227 "MagickCore/paint.c"
 image->signature == 0xabacadabUL
# 1227 "MagickCore/paint.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1227 "MagickCore/paint.c"
...
# 1227 "MagickCore/paint.c"
 "image->signature == MagickCoreSignature"
# 1227 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 1227, __extension__ __PRETTY_FUNCTION__); }))
# 1227 "MagickCore/paint.c"
                                                ;
  
# 1228 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 1228 "MagickCore/paint.c"
 high != (PixelInfo *) 
# 1228 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1228 "MagickCore/paint.c"
...
# 1228 "MagickCore/paint.c"
 "high != (PixelInfo *) NULL"
# 1228 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 1228, __extension__ __PRETTY_FUNCTION__); }))
# 1228 "MagickCore/paint.c"
                                   ;
  
# 1229 "MagickCore/paint.c" 3 4
 ((void) sizeof ((
# 1229 "MagickCore/paint.c"
 low != (PixelInfo *) 
# 1229 "MagickCore/paint.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1229 "MagickCore/paint.c"
...
# 1229 "MagickCore/paint.c"
 "low != (PixelInfo *) NULL"
# 1229 "MagickCore/paint.c" 3 4
 , "MagickCore/paint.c", 1229, __extension__ __PRETTY_FUNCTION__); }))
# 1229 "MagickCore/paint.c"
                                  ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/paint.c",__func__,(unsigned long) 1231,"%s",image->filename);
  if (SetImageStorageClass(image,DirectClass,exception) == MagickFalse)
    return(MagickFalse);
  if ((image->alpha_trait & BlendPixelTrait) == 0)
    (void) SetImageAlphaChannel(image,OpaqueAlphaChannel,exception);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 1263 "MagickCore/paint.c" 3 4
                        ((void *)0)
# 1263 "MagickCore/paint.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1282 "MagickCore/paint.c" 3 4
                                                          ((void *)0)
# 1282 "MagickCore/paint.c"
                                                              )
      {
        MagickBooleanType
          proceed;
