# 0 "MagickCore/transform.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/transform.c"
# 42 "MagickCore/transform.c"
...
# 64 "MagickCore/transform.c" 2

# 1 "./MagickCore/profile-private.h" 1
# 27 "./MagickCore/profile-private.h"
extern __attribute__ ((visibility ("hidden"))) void
  Update8BIMClipPath(const Image *,const size_t,const size_t,
    const RectangleInfo *),
  SyncImageProfiles(Image *);
# 66 "MagickCore/transform.c" 2
...
# 74 "MagickCore/transform.c" 2
# 103 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *AutoOrientImage(const Image *image,
...
# 109 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 109 "MagickCore/transform.c"
 image != (const Image *) 
# 109 "MagickCore/transform.c" 3 4
...
# 109 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 109, __extension__ __PRETTY_FUNCTION__); }))
# 109 "MagickCore/transform.c"
                                      ;
  
# 110 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 110 "MagickCore/transform.c"
...
# 110 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 110, __extension__ __PRETTY_FUNCTION__); }))
# 110 "MagickCore/transform.c"
                                                ;
  
# 111 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 111 "MagickCore/transform.c"
...
# 111 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 111, __extension__ __PRETTY_FUNCTION__); }))
# 111 "MagickCore/transform.c"
                                            ;
  
# 112 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 112 "MagickCore/transform.c"
...
# 112 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 112, __extension__ __PRETTY_FUNCTION__); }))
# 112 "MagickCore/transform.c"
                                                    ;
  orient_image=(Image *) 
# 113 "MagickCore/transform.c" 3 4
                        ((void *)0)
# 113 "MagickCore/transform.c"
                            ;
  switch(orientation)
  {
...
# 159 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 159 "MagickCore/transform.c"
                                   )
    orient_image->orientation=TopLeftOrientation;
  return(orient_image);
}
# 192 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *ChopImage(const Image *image,const RectangleInfo *chop_info,
...
# 219 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 219 "MagickCore/transform.c"
 image != (const Image *) 
# 219 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 219 "MagickCore/transform.c"
...
# 219 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 219 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 219, __extension__ __PRETTY_FUNCTION__); }))
# 219 "MagickCore/transform.c"
                                      ;
  
# 220 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 220 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 220 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 220 "MagickCore/transform.c"
...
# 220 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 220 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 220, __extension__ __PRETTY_FUNCTION__); }))
# 220 "MagickCore/transform.c"
                                                ;
  
# 221 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 221 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 221 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 221 "MagickCore/transform.c"
...
# 221 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 221 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 221, __extension__ __PRETTY_FUNCTION__); }))
# 221 "MagickCore/transform.c"
                                            ;
  
# 222 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 222 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 222 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 222 "MagickCore/transform.c"
...
# 222 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 222 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 222, __extension__ __PRETTY_FUNCTION__); }))
# 222 "MagickCore/transform.c"
                                                    ;
  
# 223 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 223 "MagickCore/transform.c"
 chop_info != (RectangleInfo *) 
# 223 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 223 "MagickCore/transform.c"
 chop_info != (RectangleInfo *) 
# 223 "MagickCore/transform.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 223 "MagickCore/transform.c"
 "chop_info != (RectangleInfo *) NULL"
# 223 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 223, __extension__ __PRETTY_FUNCTION__); }))
# 223 "MagickCore/transform.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 225,"%s",image->filename);
  if (((chop_info->x+(ssize_t) chop_info->width) < 0) ||
    ...
    { (void) ThrowMagickException(exception,"MagickCore/transform.c",__func__,(unsigned long) 230,OptionWarning,"GeometryDoesNotContainImage", "`%s'",image->filename); return((Image *) 
# 230 "MagickCore/transform.c" 3 4
   ((void *)0)
# 230 "MagickCore/transform.c"
   ); };
  extent=(*chop_info);
  ...
  if ((extent.width >= image->columns) || (extent.height >= image->rows))
    { (void) ThrowMagickException(exception,"MagickCore/transform.c",__func__,(unsigned long) 247,OptionWarning,"GeometryDoesNotContainImage", "`%s'",image->filename); return((Image *) 
# 247 "MagickCore/transform.c" 3 4
   ((void *)0)
# 247 "MagickCore/transform.c"
   ); };
  chop_image=CloneImage(image,image->columns-extent.width,image->rows-
    extent.height,MagickTrue,exception);
  if (chop_image == (Image *) 
# 250 "MagickCore/transform.c" 3 4
                             ((void *)0)
# 250 "MagickCore/transform.c"
                                 )
    return((Image *) 
# 251 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 251 "MagickCore/transform.c"
                        );
  ...
  for (y=0; y < (ssize_t) extent.y; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(chop_view,0,y,chop_image->columns,1,
      exception);
    if ((p == (const Quantum *) 
# 279 "MagickCore/transform.c" 3 4
                               ((void *)0)
...
# 307 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 307 "MagickCore/transform.c"
                                                              )
      {
        MagickBooleanType
          proceed;
  ...
  for (y=0; y < (ssize_t) (image->rows-((size_t) extent.y+extent.height)); y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(chop_view,0,extent.y+y,chop_image->columns,
      1,exception);
    if ((p == (const Quantum *) 
# 345 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 345 "MagickCore/transform.c"
                                   ) || (q == (Quantum *) 
# 345 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 345 "MagickCore/transform.c"
    ...
    if (SyncCacheViewAuthenticPixels(chop_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 373 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 373 "MagickCore/transform.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 420 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *ConsolidateCMYKImages(const Image *images,
  ExceptionInfo *exception)
{
  CacheView
    *cmyk_view,
...
# 440 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 440 "MagickCore/transform.c"
 images != (Image *) 
# 440 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 440 "MagickCore/transform.c"
...
# 440 "MagickCore/transform.c"
 "images != (Image *) NULL"
# 440 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 440, __extension__ __PRETTY_FUNCTION__); }))
# 440 "MagickCore/transform.c"
                                 ;
  
# 441 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 441 "MagickCore/transform.c"
...
# 441 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 441, __extension__ __PRETTY_FUNCTION__); }))
# 441 "MagickCore/transform.c"
                                                 ;
  
# 442 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 442 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 442 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 442 "MagickCore/transform.c"
...
# 442 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 442 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 442, __extension__ __PRETTY_FUNCTION__); }))
# 442 "MagickCore/transform.c"
                                            ;
  
# 443 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 443 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 443 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 443 "MagickCore/transform.c"
...
# 443 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 443 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 443, __extension__ __PRETTY_FUNCTION__); }))
# 443 "MagickCore/transform.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 445,"%s",images->filename);
...
# 452 "MagickCore/transform.c" 3 4
   ((void) sizeof ((
# 452 "MagickCore/transform.c"
   images != (Image *) 
# 452 "MagickCore/transform.c" 3 4
   ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 452 "MagickCore/transform.c"
...
# 452 "MagickCore/transform.c"
   "images != (Image *) NULL"
# 452 "MagickCore/transform.c" 3 4
   , "MagickCore/transform.c", 452, __extension__ __PRETTY_FUNCTION__); }))
# 452 "MagickCore/transform.c"
                                   ;
    cmyk_image=CloneImage(images,0,0,MagickTrue,
      exception);
    if (cmyk_image == (Image *) 
# 455 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 455 "MagickCore/transform.c"
                                   )
      break;
    ...
    for (i=0; i < 4; i++)
    {
      ...
      for (y=0; y < (ssize_t) images->rows; y++)
      {
        ...
        q=QueueCacheViewAuthenticPixels(cmyk_view,0,y,cmyk_image->columns,1,
          exception);
        if ((p == (const Quantum *) 
# 478 "MagickCore/transform.c" 3 4
                                   ((void *)0)
# 478 "MagickCore/transform.c"
                                       ) || (q == (Quantum *) 
# 478 "MagickCore/transform.c" 3 4
                                                              ((void *)0)
# 478 "MagickCore/transform.c"
        ...
        for (x=0; x < (ssize_t) images->columns; x++)
        {
          ...
          pixel=ClampToQuantum((double) ((Quantum) 65535.0)-
      ...
      if (images == (Image *) 
# 504 "MagickCore/transform.c" 3 4
                             ((void *)0)
# 504 "MagickCore/transform.c"
                                 )
        break;
    }
...
# 542 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *CropImage(const Image *image,const RectangleInfo *geometry,
  ExceptionInfo *exception)
{
...
# 573 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 573 "MagickCore/transform.c"
 image != (const Image *) 
# 573 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 573 "MagickCore/transform.c"
...
# 573 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 573 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 573, __extension__ __PRETTY_FUNCTION__); }))
# 573 "MagickCore/transform.c"
                                      ;
  
# 574 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 574 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 574 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 574 "MagickCore/transform.c"
...
# 574 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 574 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 574, __extension__ __PRETTY_FUNCTION__); }))
# 574 "MagickCore/transform.c"
                                                ;
  
# 575 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 575 "MagickCore/transform.c"
...
# 575 "MagickCore/transform.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 575 "MagickCore/transform.c"
 "geometry != (const RectangleInfo *) NULL"
# 575 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 575, __extension__ __PRETTY_FUNCTION__); }))
# 575 "MagickCore/transform.c"
                                                 ;
  
# 576 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 576 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 576 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 576 "MagickCore/transform.c"
...
# 576 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 576 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 576, __extension__ __PRETTY_FUNCTION__); }))
# 576 "MagickCore/transform.c"
                                            ;
  
# 577 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 577 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 577 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 577 "MagickCore/transform.c"
...
# 577 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 577 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 577, __extension__ __PRETTY_FUNCTION__); }))
# 577 "MagickCore/transform.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 579,"%s",image->filename);
  ...
  if ((((double) bounding_box.x-page.x) >= (double) page.width) ||
      ...
      (((double) page.y-bounding_box.y) > (double) image->rows))
    {
      ...
      (void) ThrowMagickException(exception,"MagickCore/transform.c",__func__,(unsigned long) 599,OptionWarning,
      ...
      if (crop_image == (Image *) 
# 604 "MagickCore/transform.c" 3 4
                                 ((void *)0)
# 604 "MagickCore/transform.c"
                                     )
        return((Image *) 
# 605 "MagickCore/transform.c" 3 4
                        ((void *)0)
# 605 "MagickCore/transform.c"
                            );
      crop_image->background_color.alpha_trait=BlendPixelTrait;
      crop_image->background_color.alpha=(MagickRealType) ((Quantum) 0);
  ...
  if ((page.width == 0) || (page.height == 0))
    {
      (void) ThrowMagickException(exception,"MagickCore/transform.c",__func__,(unsigned long) 652,OptionWarning,
        "GeometryDoesNotContainImage","`%s'",image->filename);
      return((Image *) 
# 654 "MagickCore/transform.c" 3 4
                      ((void *)0)
# 654 "MagickCore/transform.c"
                          );
    }
  ...
  if (crop_image == (Image *) 
# 660 "MagickCore/transform.c" 3 4
                             ((void *)0)
# 660 "MagickCore/transform.c"
                                 )
    return((Image *) 
# 661 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 661 "MagickCore/transform.c"
                        );
  ...
  for (y=0; y < (ssize_t) crop_image->rows; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(crop_view,0,y,crop_image->columns,1,
      exception);
    if ((p == (const Quantum *) 
# 702 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 702 "MagickCore/transform.c"
                                   ) || (q == (Quantum *) 
# 702 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 702 "MagickCore/transform.c"
    ...
    if (SyncCacheViewAuthenticPixels(crop_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 727 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 727 "MagickCore/transform.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
__attribute__ ((visibility ("default"))) Image *CropImageToTiles(const Image *image,
...
# 800 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 800 "MagickCore/transform.c"
 image != (Image *) 
# 800 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 800 "MagickCore/transform.c"
...
# 800 "MagickCore/transform.c"
 "image != (Image *) NULL"
# 800 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 800, __extension__ __PRETTY_FUNCTION__); }))
# 800 "MagickCore/transform.c"
                                ;
  
# 801 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 801 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 801 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 801 "MagickCore/transform.c"
...
# 801 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 801 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 801, __extension__ __PRETTY_FUNCTION__); }))
# 801 "MagickCore/transform.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 803,"%s",image->filename);
  ...
  if ((flags & AreaValue) != 0)
    {
      ...
      for (offset.y=0; offset.y < (double) height; )
      {
        ...
        for (offset.x=0; offset.x < (double) width; )
        {
          ...
          if (next != (Image *) 
# 887 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 887 "MagickCore/transform.c"
                                   )
  ...
  if (((geometry.width == 0) && (geometry.height == 0)) ||
      ((flags & XValue) != 0) || ((flags & YValue) != 0))
    {
      ...
      if ((crop_image != (Image *) 
# 901 "MagickCore/transform.c" 3 4
                                  ((void *)0)
# 901 "MagickCore/transform.c"
                                      ) && ((flags & AspectValue) != 0))
        {
  ...
  if ((image->columns > geometry.width) || (image->rows > geometry.height))
    {
      ...
      if (height == 0)
        height=page.height;
      next=(Image *) 
# 937 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 937 "MagickCore/transform.c"
                        ;
      crop_image=NewImageList();
      for (y=0; y < (ssize_t) page.height; y+=(ssize_t) height)
      {
        for (x=0; x < (ssize_t) page.width; x+=(ssize_t) width)
        {
          ...
          if (next == (Image *) 
# 948 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 948 "MagickCore/transform.c"
                                   )
            break;
          AppendImageToList(&crop_image,next);
        }
        if (next == (Image *) 
# 952 "MagickCore/transform.c" 3 4
                             ((void *)0)
# 952 "MagickCore/transform.c"
                                 )
          break;
      }
      return(crop_image);
...
# 988 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *ExcerptImage(const Image *image,
...
# 1012 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1012 "MagickCore/transform.c"
 image != (const Image *) 
# 1012 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1012 "MagickCore/transform.c"
...
# 1012 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 1012 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1012, __extension__ __PRETTY_FUNCTION__); }))
# 1012 "MagickCore/transform.c"
                                      ;
  
# 1013 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1013 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 1013 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1013 "MagickCore/transform.c"
...
# 1013 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 1013 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1013, __extension__ __PRETTY_FUNCTION__); }))
# 1013 "MagickCore/transform.c"
                                                ;
  
# 1014 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1014 "MagickCore/transform.c"
 geometry != (const RectangleInfo *) 
# 1014 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1014 "MagickCore/transform.c"
...
# 1014 "MagickCore/transform.c"
 "geometry != (const RectangleInfo *) NULL"
# 1014 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1014, __extension__ __PRETTY_FUNCTION__); }))
# 1014 "MagickCore/transform.c"
                                                 ;
  
# 1015 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1015 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 1015 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1015 "MagickCore/transform.c"
...
# 1015 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 1015 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1015, __extension__ __PRETTY_FUNCTION__); }))
# 1015 "MagickCore/transform.c"
                                            ;
  
# 1016 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1016 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 1016 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1016 "MagickCore/transform.c"
...
# 1016 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 1016 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1016, __extension__ __PRETTY_FUNCTION__); }))
# 1016 "MagickCore/transform.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 1018,"%s",image->filename);
  excerpt_image=CloneImage(image,geometry->width,geometry->height,MagickTrue,
    exception);
  if (excerpt_image == (Image *) 
# 1021 "MagickCore/transform.c" 3 4
                                ((void *)0)
# 1021 "MagickCore/transform.c"
                                    )
    return((Image *) 
# 1022 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 1022 "MagickCore/transform.c"
                        );
  ...
  for (y=0; y < (ssize_t) excerpt_image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(excerpt_view,0,y,excerpt_image->columns,1,
      exception);
    if ((p == (const Quantum *) 
# 1051 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 1051 "MagickCore/transform.c"
                                   ) || (q == (Quantum *) 
# 1051 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1051 "MagickCore/transform.c"
    ...
    if (SyncCacheViewAuthenticPixels(excerpt_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1076 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1076 "MagickCore/transform.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 1128 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *ExtentImage(const Image *image,
  const RectangleInfo *geometry,ExceptionInfo *exception)
{
  Image
    *extent_image;
...
# 1140 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1140 "MagickCore/transform.c"
 image != (const Image *) 
# 1140 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1140 "MagickCore/transform.c"
...
# 1140 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 1140 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1140, __extension__ __PRETTY_FUNCTION__); }))
# 1140 "MagickCore/transform.c"
                                      ;
  
# 1141 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1141 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 1141 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1141 "MagickCore/transform.c"
...
# 1141 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 1141 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1141, __extension__ __PRETTY_FUNCTION__); }))
# 1141 "MagickCore/transform.c"
                                                ;
  
# 1142 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1142 "MagickCore/transform.c"
 geometry != (const RectangleInfo *) 
# 1142 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1142 "MagickCore/transform.c"
...
# 1142 "MagickCore/transform.c"
 "geometry != (const RectangleInfo *) NULL"
# 1142 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1142, __extension__ __PRETTY_FUNCTION__); }))
# 1142 "MagickCore/transform.c"
                                                 ;
  
# 1143 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1143 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 1143 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1143 "MagickCore/transform.c"
...
# 1143 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 1143 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1143, __extension__ __PRETTY_FUNCTION__); }))
# 1143 "MagickCore/transform.c"
                                            ;
  
# 1144 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1144 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 1144 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1144 "MagickCore/transform.c"
...
# 1144 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 1144 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1144, __extension__ __PRETTY_FUNCTION__); }))
# 1144 "MagickCore/transform.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 1146,"%s",image->filename);
  extent_image=CloneImage(image,geometry->width,geometry->height,MagickTrue,
    exception);
  if (extent_image == (Image *) 
# 1149 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 1149 "MagickCore/transform.c"
                                   )
    return((Image *) 
# 1150 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 1150 "MagickCore/transform.c"
                        );
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 1155 "MagickCore/transform.c" 3 4
                      ((void *)0)
# 1155 "MagickCore/transform.c"
                          );
    }
...
# 1190 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *FlipImage(const Image *image,ExceptionInfo *exception)
{
...
# 1213 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1213 "MagickCore/transform.c"
 image != (const Image *) 
# 1213 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1213 "MagickCore/transform.c"
...
# 1213 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 1213 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1213, __extension__ __PRETTY_FUNCTION__); }))
# 1213 "MagickCore/transform.c"
                                      ;
  
# 1214 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1214 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 1214 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1214 "MagickCore/transform.c"
...
# 1214 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 1214 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1214, __extension__ __PRETTY_FUNCTION__); }))
# 1214 "MagickCore/transform.c"
                                                ;
  
# 1215 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1215 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 1215 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1215 "MagickCore/transform.c"
...
# 1215 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 1215 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1215, __extension__ __PRETTY_FUNCTION__); }))
# 1215 "MagickCore/transform.c"
                                            ;
  
# 1216 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1216 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 1216 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1216 "MagickCore/transform.c"
...
# 1216 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 1216 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1216, __extension__ __PRETTY_FUNCTION__); }))
# 1216 "MagickCore/transform.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 1218,"%s",image->filename);
  flip_image=CloneImage(image,0,0,MagickTrue,exception);
  if (flip_image == (Image *) 
# 1220 "MagickCore/transform.c" 3 4
                             ((void *)0)
# 1220 "MagickCore/transform.c"
                                 )
    return((Image *) 
# 1221 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 1221 "MagickCore/transform.c"
                        );
  ...
  for (y=0; y < (ssize_t) flip_image->rows; y++)
  {
    ...
    if ((p == (const Quantum *) 
# 1250 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 1250 "MagickCore/transform.c"
                                   ) || (q == (Quantum *) 
# 1250 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1250 "MagickCore/transform.c"
    ...
    if (SyncCacheViewAuthenticPixels(flip_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1275 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1275 "MagickCore/transform.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 1325 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *FlopImage(const Image *image,ExceptionInfo *exception)
{
...
# 1348 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1348 "MagickCore/transform.c"
 image != (const Image *) 
# 1348 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1348 "MagickCore/transform.c"
...
# 1348 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 1348 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1348, __extension__ __PRETTY_FUNCTION__); }))
# 1348 "MagickCore/transform.c"
                                      ;
  
# 1349 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1349 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 1349 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1349 "MagickCore/transform.c"
...
# 1349 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 1349 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1349, __extension__ __PRETTY_FUNCTION__); }))
# 1349 "MagickCore/transform.c"
                                                ;
  
# 1350 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1350 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 1350 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1350 "MagickCore/transform.c"
...
# 1350 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 1350 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1350, __extension__ __PRETTY_FUNCTION__); }))
# 1350 "MagickCore/transform.c"
                                            ;
  
# 1351 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1351 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 1351 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1351 "MagickCore/transform.c"
...
# 1351 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 1351 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1351, __extension__ __PRETTY_FUNCTION__); }))
# 1351 "MagickCore/transform.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 1353,"%s",image->filename);
  flop_image=CloneImage(image,0,0,MagickTrue,exception);
  if (flop_image == (Image *) 
# 1355 "MagickCore/transform.c" 3 4
                             ((void *)0)
# 1355 "MagickCore/transform.c"
                                 )
    return((Image *) 
# 1356 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 1356 "MagickCore/transform.c"
                        );
  ...
  for (y=0; y < (ssize_t) flop_image->rows; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(flop_view,0,y,flop_image->columns,1,
      exception);
    if ((p == (const Quantum *) 
# 1385 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 1385 "MagickCore/transform.c"
                                   ) || (q == (Quantum *) 
# 1385 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1385 "MagickCore/transform.c"
    ...
    if (SyncCacheViewAuthenticPixels(flop_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1411 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1411 "MagickCore/transform.c"
                                                              )
      {
        MagickBooleanType
          proceed;
  ...
  const ssize_t dx,const ssize_t dy,ExceptionInfo *exception)
{
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    if ((p == (const Quantum *) 
# 1509 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 1509 "MagickCore/transform.c"
                                   ) || (q == (Quantum *) 
# 1509 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1509 "MagickCore/transform.c"
...
__attribute__ ((visibility ("default"))) Image *RollImage(const Image *image,const ssize_t x_offset,
...
# 1559 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1559 "MagickCore/transform.c"
 image != (const Image *) 
# 1559 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1559 "MagickCore/transform.c"
...
# 1559 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 1559 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1559, __extension__ __PRETTY_FUNCTION__); }))
# 1559 "MagickCore/transform.c"
                                      ;
  
# 1560 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1560 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 1560 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1560 "MagickCore/transform.c"
...
# 1560 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 1560 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1560, __extension__ __PRETTY_FUNCTION__); }))
# 1560 "MagickCore/transform.c"
                                                ;
  
# 1561 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1561 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 1561 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1561 "MagickCore/transform.c"
...
# 1561 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 1561 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1561, __extension__ __PRETTY_FUNCTION__); }))
# 1561 "MagickCore/transform.c"
                                            ;
  
# 1562 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1562 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 1562 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1562 "MagickCore/transform.c"
...
# 1562 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 1562 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1562, __extension__ __PRETTY_FUNCTION__); }))
# 1562 "MagickCore/transform.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 1564,"%s",image->filename);
  roll_image=CloneImage(image,0,0,MagickTrue,exception);
  if (roll_image == (Image *) 
# 1566 "MagickCore/transform.c" 3 4
                             ((void *)0)
# 1566 "MagickCore/transform.c"
                                 )
    return((Image *) 
# 1567 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 1567 "MagickCore/transform.c"
                        );
  offset.x=x_offset;
  offset.y=y_offset;
  while (offset.x < 0)
  ...
  (void) SetImageProgress(image,"Roll/Image",0,3);
...
# 1646 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1646 "MagickCore/transform.c"
 image != (const Image *) 
# 1646 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1646 "MagickCore/transform.c"
...
# 1646 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 1646 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1646, __extension__ __PRETTY_FUNCTION__); }))
# 1646 "MagickCore/transform.c"
                                      ;
  
# 1647 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1647 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 1647 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1647 "MagickCore/transform.c"
...
# 1647 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 1647 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1647, __extension__ __PRETTY_FUNCTION__); }))
# 1647 "MagickCore/transform.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 1649,"%s",image->filename);
  if (((2*shave_info->width) >= image->columns) ||
      ((2*shave_info->height) >= image->rows))
    { (void) ThrowMagickException(exception,"MagickCore/transform.c",__func__,(unsigned long) 1652,OptionWarning,"GeometryDoesNotContainImage", "`%s'",image->filename); return((Image *) 
# 1652 "MagickCore/transform.c" 3 4
   ((void *)0)
# 1652 "MagickCore/transform.c"
   ); };
  ...
  if (shave_image == (Image *) 
# 1659 "MagickCore/transform.c" 3 4
                              ((void *)0)
# 1659 "MagickCore/transform.c"
                                  )
    return((Image *) 
# 1660 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 1660 "MagickCore/transform.c"
                        );
...
# 1697 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *SpliceImage(const Image *image,
  const RectangleInfo *geometry,ExceptionInfo *exception)
{
...
# 1725 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1725 "MagickCore/transform.c"
 image != (const Image *) 
# 1725 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1725 "MagickCore/transform.c"
...
# 1725 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 1725 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1725, __extension__ __PRETTY_FUNCTION__); }))
# 1725 "MagickCore/transform.c"
                                      ;
  
# 1726 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1726 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 1726 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1726 "MagickCore/transform.c"
...
# 1726 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 1726 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1726, __extension__ __PRETTY_FUNCTION__); }))
# 1726 "MagickCore/transform.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 1728,"%s",image->filename);
  
# 1729 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1729 "MagickCore/transform.c"
 geometry != (const RectangleInfo *) 
# 1729 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1729 "MagickCore/transform.c"
...
# 1729 "MagickCore/transform.c"
 "geometry != (const RectangleInfo *) NULL"
# 1729 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1729, __extension__ __PRETTY_FUNCTION__); }))
# 1729 "MagickCore/transform.c"
                                                 ;
  
# 1730 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1730 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 1730 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1730 "MagickCore/transform.c"
...
# 1730 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 1730 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1730, __extension__ __PRETTY_FUNCTION__); }))
# 1730 "MagickCore/transform.c"
                                            ;
  
# 1731 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 1731 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 1731 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1731 "MagickCore/transform.c"
...
# 1731 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 1731 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 1731, __extension__ __PRETTY_FUNCTION__); }))
# 1731 "MagickCore/transform.c"
                                                    ;
  splice_geometry=(*geometry);
  splice_image=CloneImage(image,image->columns+splice_geometry.width,
    image->rows+splice_geometry.height,MagickTrue,exception);
  if (splice_image == (Image *) 
# 1735 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 1735 "MagickCore/transform.c"
                                   )
    return((Image *) 
# 1736 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 1736 "MagickCore/transform.c"
                        );
  if (SetImageStorageClass(splice_image,DirectClass,exception) == MagickFalse)
    {
      splice_image=DestroyImage(splice_image);
      return((Image *) 
# 1740 "MagickCore/transform.c" 3 4
                      ((void *)0)
# 1740 "MagickCore/transform.c"
                          );
    }
  ...
  if ((splice_image->background_color.alpha_trait != UndefinedPixelTrait) &&
    ...
    (void) SetImageAlpha(splice_image,((Quantum) ((Quantum) 65535.0)),exception);
  ...
  status=MagickTrue;
  progress=0;
  columns=(((splice_geometry.x) < ((ssize_t) splice_image->columns)) ? (splice_geometry.x) : ((ssize_t) splice_image->columns));
  image_view=AcquireVirtualCacheView(image,exception);
  ...
  for (y=0; y < (ssize_t) splice_geometry.y; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(splice_view,0,y,splice_image->columns,1,
      exception);
    if ((p == (const Quantum *) 
# 1832 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 1832 "MagickCore/transform.c"
                                   ) || (q == (Quantum *) 
# 1832 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1832 "MagickCore/transform.c"
    ...
    if (SyncCacheViewAuthenticPixels(splice_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1885 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1885 "MagickCore/transform.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"Splice/Image",progress,
          splice_image->rows);
        if (proceed == MagickFalse)
          status=MagickFalse;
      }
  ...
  for (y=splice_geometry.y+(ssize_t) splice_geometry.height; y < (ssize_t) splice_image->rows; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(splice_view,0,y,splice_image->columns,1,
      exception);
    if ((p == (const Quantum *) 
# 1923 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 1923 "MagickCore/transform.c"
                                   ) || (q == (Quantum *) 
# 1923 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1923 "MagickCore/transform.c"
    ...
    if (SyncCacheViewAuthenticPixels(splice_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1976 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 1976 "MagickCore/transform.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 2045 "MagickCore/transform.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType TransformImage(Image **image,
...
# 2055 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2055 "MagickCore/transform.c"
 image != (Image **) 
# 2055 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2055 "MagickCore/transform.c"
...
# 2055 "MagickCore/transform.c"
 "image != (Image **) NULL"
# 2055 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2055, __extension__ __PRETTY_FUNCTION__); }))
# 2055 "MagickCore/transform.c"
                                 ;
  
# 2056 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2056 "MagickCore/transform.c"
 (*image)->signature == 0xabacadabUL
# 2056 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2056 "MagickCore/transform.c"
...
# 2056 "MagickCore/transform.c"
 "(*image)->signature == MagickCoreSignature"
# 2056 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2056, __extension__ __PRETTY_FUNCTION__); }))
# 2056 "MagickCore/transform.c"
                                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 2058,"%s",(*image)->filename);
  transform_image=(*image);
  if (crop_geometry != (const char *) 
# 2060 "MagickCore/transform.c" 3 4
                                     ((void *)0)
# 2060 "MagickCore/transform.c"
                                         )
    {
      Image
        *crop_image;
      ...
      if (crop_image == (Image *) 
# 2069 "MagickCore/transform.c" 3 4
                                 ((void *)0)
# 2069 "MagickCore/transform.c"
                                     )
  ...
  if (image_geometry == (const char *) 
# 2078 "MagickCore/transform.c" 3 4
                                      ((void *)0)
# 2078 "MagickCore/transform.c"
                                          )
    return(MagickTrue);
...
# 2090 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 2090 "MagickCore/transform.c"
                                   )
    return(MagickFalse);
  transform_image=DestroyImage(transform_image);
...
# 2123 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *TransposeImage(const Image *image,ExceptionInfo *exception)
{
...
# 2146 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2146 "MagickCore/transform.c"
 image != (const Image *) 
# 2146 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2146 "MagickCore/transform.c"
...
# 2146 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 2146 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2146, __extension__ __PRETTY_FUNCTION__); }))
# 2146 "MagickCore/transform.c"
                                      ;
  
# 2147 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2147 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 2147 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2147 "MagickCore/transform.c"
...
# 2147 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 2147 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2147, __extension__ __PRETTY_FUNCTION__); }))
# 2147 "MagickCore/transform.c"
                                                ;
  
# 2148 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2148 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 2148 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2148 "MagickCore/transform.c"
...
# 2148 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 2148 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2148, __extension__ __PRETTY_FUNCTION__); }))
# 2148 "MagickCore/transform.c"
                                            ;
  
# 2149 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2149 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 2149 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2149 "MagickCore/transform.c"
...
# 2149 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 2149 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2149, __extension__ __PRETTY_FUNCTION__); }))
# 2149 "MagickCore/transform.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 2151,"%s",image->filename);
  transpose_image=CloneImage(image,image->rows,image->columns,MagickTrue,
    exception);
  if (transpose_image == (Image *) 
# 2154 "MagickCore/transform.c" 3 4
                                  ((void *)0)
# 2154 "MagickCore/transform.c"
                                      )
    return((Image *) 
# 2155 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 2155 "MagickCore/transform.c"
                        );
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if ((p == (const Quantum *) 
# 2184 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 2184 "MagickCore/transform.c"
                                   ) || (q == (Quantum *) 
# 2184 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 2184 "MagickCore/transform.c"
    ...
    if (SyncCacheViewAuthenticPixels(transpose_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 2210 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 2210 "MagickCore/transform.c"
                                                              )
      {
        MagickBooleanType
          proceed;
  ...
  ((page.width)^=(page.height), (page.height)^=(page.width), (page.width)^=(page.height));
  ((page.x)^=(page.y), (page.y)^=(page.x), (page.x)^=(page.y));
  transpose_image->page=page;
  if (status == MagickFalse)
    transpose_image=DestroyImage(transpose_image);
  return(transpose_image);
}
# 2261 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *TransverseImage(const Image *image,ExceptionInfo *exception)
{
...
# 2284 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2284 "MagickCore/transform.c"
 image != (const Image *) 
# 2284 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2284 "MagickCore/transform.c"
...
# 2284 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 2284 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2284, __extension__ __PRETTY_FUNCTION__); }))
# 2284 "MagickCore/transform.c"
                                      ;
  
# 2285 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2285 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 2285 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2285 "MagickCore/transform.c"
...
# 2285 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 2285 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2285, __extension__ __PRETTY_FUNCTION__); }))
# 2285 "MagickCore/transform.c"
                                                ;
  
# 2286 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2286 "MagickCore/transform.c"
 exception != (ExceptionInfo *) 
# 2286 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2286 "MagickCore/transform.c"
...
# 2286 "MagickCore/transform.c"
 "exception != (ExceptionInfo *) NULL"
# 2286 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2286, __extension__ __PRETTY_FUNCTION__); }))
# 2286 "MagickCore/transform.c"
                                            ;
  
# 2287 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2287 "MagickCore/transform.c"
 exception->signature == 0xabacadabUL
# 2287 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2287 "MagickCore/transform.c"
...
# 2287 "MagickCore/transform.c"
 "exception->signature == MagickCoreSignature"
# 2287 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2287, __extension__ __PRETTY_FUNCTION__); }))
# 2287 "MagickCore/transform.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 2289,"%s",image->filename);
  transverse_image=CloneImage(image,image->rows,image->columns,MagickTrue,
    exception);
  if (transverse_image == (Image *) 
# 2292 "MagickCore/transform.c" 3 4
                                   ((void *)0)
# 2292 "MagickCore/transform.c"
                                       )
    return((Image *) 
# 2293 "MagickCore/transform.c" 3 4
                    ((void *)0)
# 2293 "MagickCore/transform.c"
                        );
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if ((p == (const Quantum *) 
# 2324 "MagickCore/transform.c" 3 4
                               ((void *)0)
# 2324 "MagickCore/transform.c"
                                   ) || (q == (Quantum *) 
# 2324 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 2324 "MagickCore/transform.c"
    ...
    if (sync == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 2352 "MagickCore/transform.c" 3 4
                                                          ((void *)0)
# 2352 "MagickCore/transform.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 2408 "MagickCore/transform.c"
__attribute__ ((visibility ("default"))) Image *TrimImage(const Image *image,ExceptionInfo *exception)
{
  const char
    *artifact;
...
# 2420 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2420 "MagickCore/transform.c"
 image != (const Image *) 
# 2420 "MagickCore/transform.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2420 "MagickCore/transform.c"
...
# 2420 "MagickCore/transform.c"
 "image != (const Image *) NULL"
# 2420 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2420, __extension__ __PRETTY_FUNCTION__); }))
# 2420 "MagickCore/transform.c"
                                      ;
  
# 2421 "MagickCore/transform.c" 3 4
 ((void) sizeof ((
# 2421 "MagickCore/transform.c"
 image->signature == 0xabacadabUL
# 2421 "MagickCore/transform.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2421 "MagickCore/transform.c"
...
# 2421 "MagickCore/transform.c"
 "image->signature == MagickCoreSignature"
# 2421 "MagickCore/transform.c" 3 4
 , "MagickCore/transform.c", 2421, __extension__ __PRETTY_FUNCTION__); }))
# 2421 "MagickCore/transform.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/transform.c",__func__,(unsigned long) 2423,"%s",image->filename);
  ...
  if ((geometry.width == 0) || (geometry.height == 0))
    {
      ...
      crop_image=CloneImage(image,1,1,MagickTrue,exception);
      if (crop_image == (Image *) 
# 2431 "MagickCore/transform.c" 3 4
                                 ((void *)0)
# 2431 "MagickCore/transform.c"
                                     )
        return((Image *) 
# 2432 "MagickCore/transform.c" 3 4
                        ((void *)0)
# 2432 "MagickCore/transform.c"
                            );
      crop_image->background_color.alpha_trait=BlendPixelTrait;
      crop_image->background_color.alpha=(MagickRealType) ((Quantum) 0);
      (void) SetImageBackgroundColor(crop_image,exception);
...
# 2443 "MagickCore/transform.c" 3 4
                                ((void *)0)
# 2443 "MagickCore/transform.c"
                                    )
  ...
  if (trim_image != (Image *) 
# 2507 "MagickCore/transform.c" 3 4
                             ((void *)0)
# 2507 "MagickCore/transform.c"
                                 )
