# 0 "MagickCore/colormap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/colormap.c"
# 44 "MagickCore/colormap.c"
...
# 74 "MagickCore/colormap.c" 2
# 105 "MagickCore/colormap.c"
__attribute__ ((visibility ("default"))) MagickBooleanType AcquireImageColormap(Image *image,
...
# 114 "MagickCore/colormap.c" 3 4
 ((void) sizeof ((
# 114 "MagickCore/colormap.c"
 image != (Image *) 
# 114 "MagickCore/colormap.c" 3 4
...
# 114 "MagickCore/colormap.c"
 "image != (Image *) NULL"
# 114 "MagickCore/colormap.c" 3 4
 , "MagickCore/colormap.c", 114, __extension__ __PRETTY_FUNCTION__); }))
# 114 "MagickCore/colormap.c"
                                ;
  
# 115 "MagickCore/colormap.c" 3 4
 ((void) sizeof ((
# 115 "MagickCore/colormap.c"
...
# 115 "MagickCore/colormap.c" 3 4
 , "MagickCore/colormap.c", 115, __extension__ __PRETTY_FUNCTION__); }))
# 115 "MagickCore/colormap.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/colormap.c",__func__,(unsigned long) 117,"%s",image->filename);
  if (colors > 65536UL)
    {
      image->colors=0;
      image->storage_class=DirectClass;
      { (void) ThrowMagickException(exception,"MagickCore/colormap.c",__func__,(unsigned long) 122,ResourceLimitError,"UnableToCreateColormap", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  image->colors=(((colors) > (1)) ? (colors) : (1));
  if (image->colormap == (PixelInfo *) 
# 126 "MagickCore/colormap.c" 3 4
                                      ((void *)0)
# 126 "MagickCore/colormap.c"
                                          )
  ...
  if (image->colormap == (PixelInfo *) 
# 132 "MagickCore/colormap.c" 3 4
                                      ((void *)0)
# 132 "MagickCore/colormap.c"
                                          )
    {
      image->colors=0;
      image->storage_class=DirectClass;
      { (void) ThrowMagickException(exception,"MagickCore/colormap.c",__func__,(unsigned long) 136,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  for (i=0; i < (ssize_t) image->colors; i++)
  {
    ...
    pixel=((double) i*(((Quantum) 65535.0)/(((colors-1) > (1)) ? (colors-1) : (1))));
    image->colormap[i].red=pixel;
    image->colormap[i].green=pixel;
    image->colormap[i].blue=pixel;
    image->colormap[i].alpha=(MagickRealType) ((Quantum) ((Quantum) 65535.0));
    image->colormap[i].alpha_trait=BlendPixelTrait;
  }
  image->storage_class=PseudoClass;
  return(MagickTrue);
}
# 188 "MagickCore/colormap.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CycleColormapImage(Image *image,
...
# 200 "MagickCore/colormap.c" 3 4
 ((void) sizeof ((
# 200 "MagickCore/colormap.c"
 image != (Image *) 
# 200 "MagickCore/colormap.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 200 "MagickCore/colormap.c"
...
# 200 "MagickCore/colormap.c"
 "image != (Image *) NULL"
# 200 "MagickCore/colormap.c" 3 4
 , "MagickCore/colormap.c", 200, __extension__ __PRETTY_FUNCTION__); }))
# 200 "MagickCore/colormap.c"
                                ;
  
# 201 "MagickCore/colormap.c" 3 4
 ((void) sizeof ((
# 201 "MagickCore/colormap.c"
 image->signature == 0xabacadabUL
# 201 "MagickCore/colormap.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 201 "MagickCore/colormap.c"
...
# 201 "MagickCore/colormap.c"
 "image->signature == MagickCoreSignature"
# 201 "MagickCore/colormap.c" 3 4
 , "MagickCore/colormap.c", 201, __extension__ __PRETTY_FUNCTION__); }))
# 201 "MagickCore/colormap.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/colormap.c",__func__,(unsigned long) 203,"%s",image->filename);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (q == (Quantum *) 
# 226 "MagickCore/colormap.c" 3 4
                        ((void *)0)
# 226 "MagickCore/colormap.c"
                            )
      {
        status=MagickFalse;
        continue;
...
static int IntensityCompare(const void *x,const void *y)
{
  ...
  intensity=(int) GetPixelInfoIntensity((const Image *) 
# 290 "MagickCore/colormap.c" 3 4
                                                       ((void *)0)
# 290 "MagickCore/colormap.c"
                                                           ,color_2)-(int)
    GetPixelInfoIntensity((const Image *) 
# 291 "MagickCore/colormap.c" 3 4
                                         ((void *)0)
# 291 "MagickCore/colormap.c"
                                             ,color_1);
  return(intensity);
}
...
__attribute__ ((visibility ("default"))) MagickBooleanType SortColormapByIntensity(Image *image,
  ExceptionInfo *exception)
{
  CacheView
    *image_view;
...
# 317 "MagickCore/colormap.c" 3 4
 ((void) sizeof ((
# 317 "MagickCore/colormap.c"
 image != (Image *) 
# 317 "MagickCore/colormap.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 317 "MagickCore/colormap.c"
...
# 317 "MagickCore/colormap.c"
 "image != (Image *) NULL"
# 317 "MagickCore/colormap.c" 3 4
 , "MagickCore/colormap.c", 317, __extension__ __PRETTY_FUNCTION__); }))
# 317 "MagickCore/colormap.c"
                                ;
  
# 318 "MagickCore/colormap.c" 3 4
 ((void) sizeof ((
# 318 "MagickCore/colormap.c"
 image->signature == 0xabacadabUL
# 318 "MagickCore/colormap.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 318 "MagickCore/colormap.c"
...
# 318 "MagickCore/colormap.c"
 "image->signature == MagickCoreSignature"
# 318 "MagickCore/colormap.c" 3 4
 , "MagickCore/colormap.c", 318, __extension__ __PRETTY_FUNCTION__); }))
# 318 "MagickCore/colormap.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/colormap.c",__func__,(unsigned long) 320,"...");
  ...
  pixels=(unsigned short *) AcquireQuantumMemory((size_t) image->colors,
    sizeof(*pixels));
  if (pixels == (unsigned short *) 
# 328 "MagickCore/colormap.c" 3 4
                                  ((void *)0)
# 328 "MagickCore/colormap.c"
                                      )
    { (void) ThrowMagickException(exception,"MagickCore/colormap.c",__func__,(unsigned long) 329,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 363 "MagickCore/colormap.c" 3 4
                        ((void *)0)
# 363 "MagickCore/colormap.c"
                            )
      {
        status=MagickFalse;
        continue;
