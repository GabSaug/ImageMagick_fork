# 0 "MagickCore/threshold.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/threshold.c"
# 43 "MagickCore/threshold.c"
...
# 92 "MagickCore/threshold.c" 2
# 101 "MagickCore/threshold.c"
...
# 182 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) Image *AdaptiveThresholdImage(const Image *image,
...
# 210 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 210 "MagickCore/threshold.c"
 image != (Image *) 
# 210 "MagickCore/threshold.c" 3 4
...
# 210 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 210 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 210, __extension__ __PRETTY_FUNCTION__); }))
# 210 "MagickCore/threshold.c"
                                ;
  
# 211 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 211 "MagickCore/threshold.c"
...
# 211 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 211, __extension__ __PRETTY_FUNCTION__); }))
# 211 "MagickCore/threshold.c"
                                                ;
  
# 212 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 212 "MagickCore/threshold.c"
...
# 212 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 212, __extension__ __PRETTY_FUNCTION__); }))
# 212 "MagickCore/threshold.c"
                                            ;
  
# 213 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 213 "MagickCore/threshold.c"
...
# 213 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 213, __extension__ __PRETTY_FUNCTION__); }))
# 213 "MagickCore/threshold.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 215,"%s",image->filename);
  threshold_image=CloneImage(image,0,0,MagickTrue,exception);
  if (threshold_image == (Image *) 
# 217 "MagickCore/threshold.c" 3 4
                                  ((void *)0)
# 217 "MagickCore/threshold.c"
                                      )
    return((Image *) 
# 218 "MagickCore/threshold.c" 3 4
                    ((void *)0)
# 218 "MagickCore/threshold.c"
                        );
  if ((width == 0) || (height == 0))
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 225 "MagickCore/threshold.c" 3 4
                      ((void *)0)
# 225 "MagickCore/threshold.c"
                          );
    }
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(threshold_view,0,y,threshold_image->columns,
      1,exception);
    if ((p == (const Quantum *) 
# 265 "MagickCore/threshold.c" 3 4
                               ((void *)0)
# 265 "MagickCore/threshold.c"
                                   ) || (q == (Quantum *) 
# 265 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 265 "MagickCore/threshold.c"
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        ...
        SetPixelChannel(threshold_image,channel,(Quantum) ((double)
          p[center+i] <= mean ? 0 : ((Quantum) 65535.0)),q);
      }
...
# 340 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 340 "MagickCore/threshold.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"AdaptiveThreshold/Image",progress,
          image->rows);
  ...
  ExceptionInfo *exception)
{
  ...
  cumulative_histogram=(double *) AcquireQuantumMemory(255 +1UL,
    sizeof(*cumulative_histogram));
  black_entropy=(double *) AcquireQuantumMemory(255 +1UL,
    sizeof(*black_entropy));
  white_entropy=(double *) AcquireQuantumMemory(255 +1UL,
    sizeof(*white_entropy));
  if ((cumulative_histogram == (double *) 
# 421 "MagickCore/threshold.c" 3 4
                                         ((void *)0)
# 421 "MagickCore/threshold.c"
                                             ) ||
      (black_entropy == (double *) 
# 422 "MagickCore/threshold.c" 3 4
                                  ((void *)0)
# 422 "MagickCore/threshold.c"
                                      ) || (white_entropy == (double *) 
# 422 "MagickCore/threshold.c" 3 4
                                                                        ((void *)0)
# 422 "MagickCore/threshold.c"
                                                                            ))
    {
      if (white_entropy != (double *) 
# 424 "MagickCore/threshold.c" 3 4
                                     ((void *)0)
# 424 "MagickCore/threshold.c"
                                         )
        white_entropy=(double *) RelinquishMagickMemory(white_entropy);
      if (black_entropy != (double *) 
# 426 "MagickCore/threshold.c" 3 4
                                     ((void *)0)
# 426 "MagickCore/threshold.c"
                                         )
        black_entropy=(double *) RelinquishMagickMemory(black_entropy);
      if (cumulative_histogram != (double *) 
# 428 "MagickCore/threshold.c" 3 4
                                            ((void *)0)
# 428 "MagickCore/threshold.c"
                                                )
        cumulative_histogram=(double *)
          RelinquishMagickMemory(cumulative_histogram);
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 431,
   ...
   epsilon=2.22507385850720140E-308;
   for (j=0; j <= 255; j++)
   {
  ...
  ExceptionInfo *exception)
{
  ...
  myu=(double *) AcquireQuantumMemory(255 +1UL,sizeof(*myu));
  omega=(double *) AcquireQuantumMemory(255 +1UL,sizeof(*omega));
  probability=(double *) AcquireQuantumMemory(255 +1UL,
    sizeof(*probability));
  sigma=(double *) AcquireQuantumMemory(255 +1UL,sizeof(*sigma));
  if ((myu == (double *) 
# 513 "MagickCore/threshold.c" 3 4
                        ((void *)0)
# 513 "MagickCore/threshold.c"
                            ) || (omega == (double *) 
# 513 "MagickCore/threshold.c" 3 4
                                                      ((void *)0)
# 513 "MagickCore/threshold.c"
      ...
      (probability == (double *) 
# 514 "MagickCore/threshold.c" 3 4
                                ((void *)0)
# 514 "MagickCore/threshold.c"
                                    ) || (sigma == (double *) 
# 514 "MagickCore/threshold.c" 3 4
                                                              ((void *)0)
# 514 "MagickCore/threshold.c"
    ...
    {
      if (sigma != (double *) 
# 516 "MagickCore/threshold.c" 3 4
                             ((void *)0)
# 516 "MagickCore/threshold.c"
                                 )
        sigma=(double *) RelinquishMagickMemory(sigma);
      if (probability != (double *) 
# 518 "MagickCore/threshold.c" 3 4
                                   ((void *)0)
# 518 "MagickCore/threshold.c"
                                       )
        probability=(double *) RelinquishMagickMemory(probability);
      if (omega != (double *) 
# 520 "MagickCore/threshold.c" 3 4
                             ((void *)0)
# 520 "MagickCore/threshold.c"
                                 )
        omega=(double *) RelinquishMagickMemory(omega);
      if (myu != (double *) 
# 522 "MagickCore/threshold.c" 3 4
                           ((void *)0)
# 522 "MagickCore/threshold.c"
                               )
        myu=(double *) RelinquishMagickMemory(myu);
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 524,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",image->filename);
      return(-1.0);
    }
  ...
  for (i=0; i < (ssize_t) 255; i++)
  {
    ...
    if ((omega[i] != 0.0) && (omega[i] != 1.0))
      sigma[i]=pow(myu[255]*omega[i]-myu[i],2.0)/(omega[i]*(1.0-
        omega[i]));
...
__attribute__ ((visibility ("default"))) MagickBooleanType AutoThresholdImage(Image *image,
...
# 687 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 687 "MagickCore/threshold.c"
 image != (Image *) 
# 687 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 687 "MagickCore/threshold.c"
...
# 687 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 687 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 687, __extension__ __PRETTY_FUNCTION__); }))
# 687 "MagickCore/threshold.c"
                                ;
  
# 688 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 688 "MagickCore/threshold.c"
 image->signature == 0xabacadabUL
# 688 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 688 "MagickCore/threshold.c"
...
# 688 "MagickCore/threshold.c"
 "image->signature == MagickCoreSignature"
# 688 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 688, __extension__ __PRETTY_FUNCTION__); }))
# 688 "MagickCore/threshold.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 690,"%s",image->filename);
  histogram=(double *) AcquireQuantumMemory(255 +1UL,
    sizeof(*histogram));
  if (histogram == (double *) 
# 693 "MagickCore/threshold.c" 3 4
                             ((void *)0)
# 693 "MagickCore/threshold.c"
                                 )
    { (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 694,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  status=MagickTrue;
  (void) memset(histogram,0,(255 +1UL)*sizeof(*histogram));
  image_view=AcquireVirtualCacheView(image,exception);
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    const Quantum
    ...
    if (p == (const Quantum *) 
# 708 "MagickCore/threshold.c" 3 4
                              ((void *)0)
# 708 "MagickCore/threshold.c"
                                  )
      break;
    for (x=0; x < (ssize_t) image->columns; x++)
    {
  ...
  (void) FormatLocaleString(property,4096,"%g%%",threshold);
...
# 760 "MagickCore/threshold.c" 3 4
                           stdout
# 760 "MagickCore/threshold.c"
                                 ,"%.*g%%\n",GetMagickPrecision(),threshold);
  return(BilevelImage(image,(double) ((Quantum) 65535.0)*threshold/100.0,exception));
}
# 805 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) MagickBooleanType BilevelImage(Image *image,const double threshold,
  ExceptionInfo *exception)
{
...
# 822 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 822 "MagickCore/threshold.c"
 image != (Image *) 
# 822 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 822 "MagickCore/threshold.c"
...
# 822 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 822 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 822, __extension__ __PRETTY_FUNCTION__); }))
# 822 "MagickCore/threshold.c"
                                ;
  
# 823 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 823 "MagickCore/threshold.c"
 image->signature == 0xabacadabUL
# 823 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 823 "MagickCore/threshold.c"
...
# 823 "MagickCore/threshold.c"
 "image->signature == MagickCoreSignature"
# 823 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 823, __extension__ __PRETTY_FUNCTION__); }))
# 823 "MagickCore/threshold.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 825,"%s",image->filename);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (q == (Quantum *) 
# 851 "MagickCore/threshold.c" 3 4
                        ((void *)0)
# 851 "MagickCore/threshold.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        ...
        if (image->channel_mask != AllChannels)
          pixel=(double) q[i];
        q[i]=(Quantum) (pixel <= threshold ? 0 : ((Quantum) 65535.0));
      }
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 879 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 879 "MagickCore/threshold.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"Threshold/Image",progress++,
          image->rows);
        if (proceed == MagickFalse)
          status=MagickFalse;
      }
...
# 927 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) MagickBooleanType BlackThresholdImage(Image *image,
...
# 953 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 953 "MagickCore/threshold.c"
 image != (Image *) 
# 953 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 953 "MagickCore/threshold.c"
...
# 953 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 953 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 953, __extension__ __PRETTY_FUNCTION__); }))
# 953 "MagickCore/threshold.c"
                                ;
  
# 954 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 954 "MagickCore/threshold.c"
 image->signature == 0xabacadabUL
# 954 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 954 "MagickCore/threshold.c"
...
# 954 "MagickCore/threshold.c"
 "image->signature == MagickCoreSignature"
# 954 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 954, __extension__ __PRETTY_FUNCTION__); }))
# 954 "MagickCore/threshold.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 956,"%s",image->filename);
  if (thresholds == (const char *) 
# 957 "MagickCore/threshold.c" 3 4
                                  ((void *)0)
# 957 "MagickCore/threshold.c"
                                      )
    return(MagickTrue);
  if (SetImageStorageClass(image,DirectClass,exception) == MagickFalse)
    return(MagickFalse);
  ...
  if ((flags & PercentValue) != 0)
    {
      threshold.red*=((MagickRealType) ((Quantum) 65535.0)/100.0);
      threshold.green*=((MagickRealType) ((Quantum) 65535.0)/100.0);
      threshold.blue*=((MagickRealType) ((Quantum) 65535.0)/100.0);
      threshold.black*=((MagickRealType) ((Quantum) 65535.0)/100.0);
      threshold.alpha*=((MagickRealType) ((Quantum) 65535.0)/100.0);
    }
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 1012 "MagickCore/threshold.c" 3 4
                        ((void *)0)
# 1012 "MagickCore/threshold.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1041 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 1041 "MagickCore/threshold.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 1087 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ClampImage(Image *image,ExceptionInfo *exception)
{
...
# 1103 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1103 "MagickCore/threshold.c"
 image != (Image *) 
# 1103 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1103 "MagickCore/threshold.c"
...
# 1103 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 1103 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1103, __extension__ __PRETTY_FUNCTION__); }))
# 1103 "MagickCore/threshold.c"
                                ;
  
# 1104 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1104 "MagickCore/threshold.c"
 image->signature == 0xabacadabUL
# 1104 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1104 "MagickCore/threshold.c"
...
# 1104 "MagickCore/threshold.c"
 "image->signature == MagickCoreSignature"
# 1104 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1104, __extension__ __PRETTY_FUNCTION__); }))
# 1104 "MagickCore/threshold.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 1106,"%s",image->filename);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 1147 "MagickCore/threshold.c" 3 4
                        ((void *)0)
# 1147 "MagickCore/threshold.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1169 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 1169 "MagickCore/threshold.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 1217 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ColorThresholdImage(Image *image,
...
# 1248 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1248 "MagickCore/threshold.c"
 image != (Image *) 
# 1248 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1248 "MagickCore/threshold.c"
...
# 1248 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 1248 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1248, __extension__ __PRETTY_FUNCTION__); }))
# 1248 "MagickCore/threshold.c"
                                ;
  
# 1249 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1249 "MagickCore/threshold.c"
 image->signature == 0xabacadabUL
# 1249 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1249 "MagickCore/threshold.c"
...
# 1249 "MagickCore/threshold.c"
 "image->signature == MagickCoreSignature"
# 1249 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1249, __extension__ __PRETTY_FUNCTION__); }))
# 1249 "MagickCore/threshold.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 1251,"%s",image->filename);
  status=AcquireImageColormap(image,2,exception);
  if (status == MagickFalse)
    return(status);
  artifact=GetImageArtifact(image,"color:illuminant");
  if (artifact != (const char *) 
# 1256 "MagickCore/threshold.c" 3 4
                                ((void *)0)
# 1256 "MagickCore/threshold.c"
                                    )
    {
      ssize_t
        illuminant_type;
  ...
  switch (image->colorspace)
  {
    ...
    default:
    {
      start.red*=((double) 1.0/(double) ((Quantum) 65535.0));
      start.green*=((double) 1.0/(double) ((Quantum) 65535.0));
      start.blue*=((double) 1.0/(double) ((Quantum) 65535.0));
      stop.red*=((double) 1.0/(double) ((Quantum) 65535.0));
      stop.green*=((double) 1.0/(double) ((Quantum) 65535.0));
      stop.blue*=((double) 1.0/(double) ((Quantum) 65535.0));
      break;
    }
  }
  start.red*=(double) ((Quantum) 65535.0);
  start.green*=(double) ((Quantum) 65535.0);
  start.blue*=(double) ((Quantum) 65535.0);
  stop.red*=(double) ((Quantum) 65535.0);
  stop.green*=(double) ((Quantum) 65535.0);
  stop.blue*=(double) ((Quantum) 65535.0);
  progress=0;
  image_view=AcquireAuthenticCacheView(image,exception);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 1354 "MagickCore/threshold.c" 3 4
                        ((void *)0)
# 1354 "MagickCore/threshold.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1382 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 1382 "MagickCore/threshold.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 1424 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) ThresholdMap *DestroyThresholdMap(ThresholdMap *map)
{
  
# 1426 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1426 "MagickCore/threshold.c"
 map != (ThresholdMap *) 
# 1426 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1426 "MagickCore/threshold.c"
...
# 1426 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1426, __extension__ __PRETTY_FUNCTION__); }))
# 1426 "MagickCore/threshold.c"
                                     ;
  if (map->map_id != (char *) 
# 1427 "MagickCore/threshold.c" 3 4
                             ((void *)0)
# 1427 "MagickCore/threshold.c"
                                 )
    map->map_id=DestroyString(map->map_id);
  if (map->description != (char *) 
# 1429 "MagickCore/threshold.c" 3 4
                                  ((void *)0)
# 1429 "MagickCore/threshold.c"
                                      )
    map->description=DestroyString(map->description);
  if (map->levels != (ssize_t *) 
# 1431 "MagickCore/threshold.c" 3 4
                                ((void *)0)
# 1431 "MagickCore/threshold.c"
                                    )
    map->levels=(ssize_t *) RelinquishMagickMemory(map->levels);
  map=(ThresholdMap *) RelinquishMagickMemory(map);
  return(map);
}
# 1463 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) ThresholdMap *GetThresholdMap(const char *map_id,
  ExceptionInfo *exception)
{
  ThresholdMap
    *map;
  ...
  if (map != (ThresholdMap *) 
# 1470 "MagickCore/threshold.c" 3 4
                             ((void *)0)
# 1470 "MagickCore/threshold.c"
                                 )
    return(map);

  {
    ...
    options=GetConfigureOptions("thresholds.xml",exception);
    option=(const StringInfo *) GetNextValueInLinkedList(options);
    while (option != (const StringInfo *) 
# 1482 "MagickCore/threshold.c" 3 4
                                         ((void *)0)
# 1482 "MagickCore/threshold.c"
                                             )
    {
      map=GetThresholdMapFile((const char *) GetStringInfoDatum(option),
        GetStringInfoPath(option),map_id,exception);
      if (map != (ThresholdMap *) 
# 1486 "MagickCore/threshold.c" 3 4
                                 ((void *)0)
# 1486 "MagickCore/threshold.c"
                                     )
        break;
      option=(const StringInfo *) GetNextValueInLinkedList(options);
    }
  ...
  const char *map_id,ExceptionInfo *exception)
{
  ...
  (void) LogMagickEvent(ConfigureEvent,"MagickCore/threshold.c",__func__,(unsigned long) 1551,
    "Loading threshold map file \"%s\" ...",filename);
  map=(ThresholdMap *) 
# 1553 "MagickCore/threshold.c" 3 4
                      ((void *)0)
# 1553 "MagickCore/threshold.c"
                          ;
  thresholds=NewXMLTree(xml,exception);
  if (thresholds == (XMLTreeInfo *) 
# 1555 "MagickCore/threshold.c" 3 4
                                   ((void *)0)
# 1555 "MagickCore/threshold.c"
                                       )
    return(map);
  for (threshold=GetXMLTreeChild(thresholds,"threshold");
       threshold != (XMLTreeInfo *) 
# 1558 "MagickCore/threshold.c" 3 4
                                   ((void *)0)
# 1558 "MagickCore/threshold.c"
                                       ;
       threshold=GetNextXMLTreeTag(threshold))
  {
    attribute=GetXMLTreeAttribute(threshold,"map");
    if ((attribute != (char *) 
# 1562 "MagickCore/threshold.c" 3 4
                              ((void *)0)
# 1562 "MagickCore/threshold.c"
                                  ) && (LocaleCompare(map_id,attribute) == 0))
      break;
    attribute=GetXMLTreeAttribute(threshold,"alias");
    if ((attribute != (char *) 
# 1565 "MagickCore/threshold.c" 3 4
                              ((void *)0)
# 1565 "MagickCore/threshold.c"
                                  ) && (LocaleCompare(map_id,attribute) == 0))
      break;
  }
  if (threshold == (XMLTreeInfo *) 
# 1568 "MagickCore/threshold.c" 3 4
                                  ((void *)0)
# 1568 "MagickCore/threshold.c"
                                      )
    {
  ...
  if (description == (XMLTreeInfo *) 
# 1574 "MagickCore/threshold.c" 3 4
                                    ((void *)0)
# 1574 "MagickCore/threshold.c"
                                        )
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1576,OptionError,
        "XmlMissingElement", "<description>, map \"%s\"",map_id);
      thresholds=DestroyXMLTree(thresholds);
      return(map);
    }
  levels=GetXMLTreeChild(threshold,"levels");
  if (levels == (XMLTreeInfo *) 
# 1582 "MagickCore/threshold.c" 3 4
                               ((void *)0)
# 1582 "MagickCore/threshold.c"
                                   )
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1584,OptionError,
  ...
  map->map_id=(char *) 
# 1590 "MagickCore/threshold.c" 3 4
                      ((void *)0)
# 1590 "MagickCore/threshold.c"
                          ;
  map->description=(char *) 
# 1591 "MagickCore/threshold.c" 3 4
                           ((void *)0)
# 1591 "MagickCore/threshold.c"
                               ;
  map->levels=(ssize_t *) 
# 1592 "MagickCore/threshold.c" 3 4
                         ((void *)0)
# 1592 "MagickCore/threshold.c"
                             ;
  attribute=GetXMLTreeAttribute(threshold,"map");
  if (attribute != (char *) 
# 1594 "MagickCore/threshold.c" 3 4
                           ((void *)0)
# 1594 "MagickCore/threshold.c"
                               )
    map->map_id=ConstantString(attribute);
  content=GetXMLTreeContent(description);
  if (content != (char *) 
# 1597 "MagickCore/threshold.c" 3 4
                         ((void *)0)
# 1597 "MagickCore/threshold.c"
                             )
    map->description=ConstantString(content);
  attribute=GetXMLTreeAttribute(levels,"width");
  if (attribute == (char *) 
# 1600 "MagickCore/threshold.c" 3 4
                           ((void *)0)
# 1600 "MagickCore/threshold.c"
                               )
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1602,OptionError,
  ...
  if (map->width == 0)
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1611,OptionError,
  ...
  if (attribute == (char *) 
# 1618 "MagickCore/threshold.c" 3 4
                           ((void *)0)
# 1618 "MagickCore/threshold.c"
                               )
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1620,OptionError,
  ...
  if (map->height == 0)
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1629,OptionError,
  ...
  if (attribute == (char *) 
# 1636 "MagickCore/threshold.c" 3 4
                           ((void *)0)
# 1636 "MagickCore/threshold.c"
                               )
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1638,OptionError,
  ...
  if (map->divisor < 2)
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1647,OptionError,
  ...
  if (content == (char *) 
# 1654 "MagickCore/threshold.c" 3 4
                         ((void *)0)
# 1654 "MagickCore/threshold.c"
                             )
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1656,OptionError,
  ...
  map->levels=(ssize_t *) AcquireQuantumMemory((size_t) map->width,map->height*
    sizeof(*map->levels));
  if (map->levels == (ssize_t *) 
# 1664 "MagickCore/threshold.c" 3 4
                                ((void *)0)
# 1664 "MagickCore/threshold.c"
                                    )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1665 "MagickCore/threshold.c" 3 4
   (*__errno_location ())
# 1665 "MagickCore/threshold.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/threshold.c",__func__,(unsigned long) 1665,ResourceLimitFatalError,"UnableToAcquireThresholdMap", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  for (i=0; i < (ssize_t) (map->width*map->height); i++)
  {
    map->levels[i]=(ssize_t) strtol(content,&p,10);
    if (p == content)
      {
        (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1671,OptionError,
    ...
    if ((map->levels[i] < 0) || (map->levels[i] > map->divisor))
      {
        (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1679,OptionError,
  ...
  if (p != content)
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1692,OptionError,
...
# 1745 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1745 "MagickCore/threshold.c"
 xml != (char *) 
# 1745 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1745 "MagickCore/threshold.c"
...
# 1745 "MagickCore/threshold.c"
 "xml != (char *) NULL"
# 1745 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1745, __extension__ __PRETTY_FUNCTION__); }))
# 1745 "MagickCore/threshold.c"
                               ;
  
# 1746 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1746 "MagickCore/threshold.c"
 file != (FILE *) 
# 1746 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1746 "MagickCore/threshold.c"
...
# 1746 "MagickCore/threshold.c"
 "file != (FILE *) NULL"
# 1746 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1746, __extension__ __PRETTY_FUNCTION__); }))
# 1746 "MagickCore/threshold.c"
                                ;
  (void) LogMagickEvent(ConfigureEvent,"MagickCore/threshold.c",__func__,(unsigned long) 1747,
    "Loading threshold map file \"%s\" ...",filename);
  thresholds=NewXMLTree(xml,exception);
  if ( thresholds == (XMLTreeInfo *) 
# 1750 "MagickCore/threshold.c" 3 4
                                    ((void *)0) 
# 1750 "MagickCore/threshold.c"
                                         )
    return(MagickFalse);
  ...
  for ( ; threshold != (XMLTreeInfo *) 
# 1756 "MagickCore/threshold.c" 3 4
                                      ((void *)0)
# 1756 "MagickCore/threshold.c"
                                          ;
          threshold=GetNextXMLTreeTag(threshold))
  {
    map=GetXMLTreeAttribute(threshold,"map");
    if (map == (char *) 
# 1760 "MagickCore/threshold.c" 3 4
                       ((void *)0)
# 1760 "MagickCore/threshold.c"
                           )
      {
        (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1762,OptionError,
    ...
    description=GetXMLTreeChild(threshold,"description");
    if (description == (XMLTreeInfo *) 
# 1769 "MagickCore/threshold.c" 3 4
                                      ((void *)0)
# 1769 "MagickCore/threshold.c"
                                          )
      {
        (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1771,OptionError,
    ...
    content=GetXMLTreeContent(description);
    if (content == (char *) 
# 1777 "MagickCore/threshold.c" 3 4
                           ((void *)0)
# 1777 "MagickCore/threshold.c"
                               )
      {
        (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1779,OptionError,
...
# 1816 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListThresholdMaps(FILE *file,
  ExceptionInfo *exception)
{
  const StringInfo
    *option;
  ...
  status=MagickTrue;
  if (file == (FILE *) 
# 1829 "MagickCore/threshold.c" 3 4
                      ((void *)0)
# 1829 "MagickCore/threshold.c"
                          )
    file=
# 1830 "MagickCore/threshold.c" 3 4
        stdout
# 1830 "MagickCore/threshold.c"
              ;
  options=GetConfigureOptions("thresholds.xml",exception);
  (void) FormatLocaleFile(file,
  ...
  option=(const StringInfo *) GetNextValueInLinkedList(options);
  while (option != (const StringInfo *) 
# 1835 "MagickCore/threshold.c" 3 4
                                       ((void *)0)
# 1835 "MagickCore/threshold.c"
                                           )
  {
...
# 1893 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) MagickBooleanType OrderedDitherImage(Image *image,
...
# 1923 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1923 "MagickCore/threshold.c"
 image != (Image *) 
# 1923 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1923 "MagickCore/threshold.c"
...
# 1923 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 1923 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1923, __extension__ __PRETTY_FUNCTION__); }))
# 1923 "MagickCore/threshold.c"
                                ;
  
# 1924 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1924 "MagickCore/threshold.c"
 image->signature == 0xabacadabUL
# 1924 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1924 "MagickCore/threshold.c"
...
# 1924 "MagickCore/threshold.c"
 "image->signature == MagickCoreSignature"
# 1924 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1924, __extension__ __PRETTY_FUNCTION__); }))
# 1924 "MagickCore/threshold.c"
                                                ;
  
# 1925 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1925 "MagickCore/threshold.c"
 exception != (ExceptionInfo *) 
# 1925 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1925 "MagickCore/threshold.c"
...
# 1925 "MagickCore/threshold.c"
 "exception != (ExceptionInfo *) NULL"
# 1925 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1925, __extension__ __PRETTY_FUNCTION__); }))
# 1925 "MagickCore/threshold.c"
                                            ;
  
# 1926 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 1926 "MagickCore/threshold.c"
 exception->signature == 0xabacadabUL
# 1926 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1926 "MagickCore/threshold.c"
...
# 1926 "MagickCore/threshold.c"
 "exception->signature == MagickCoreSignature"
# 1926 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 1926, __extension__ __PRETTY_FUNCTION__); }))
# 1926 "MagickCore/threshold.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 1928,"%s",image->filename);
  if (threshold_map == (const char *) 
# 1929 "MagickCore/threshold.c" 3 4
                                     ((void *)0)
# 1929 "MagickCore/threshold.c"
                                         )
    return(MagickTrue);
  p=(char *) threshold_map;
  while (((
# 1932 "MagickCore/threshold.c" 3 4
          ((*__ctype_b_loc ())[(int) ((
# 1932 "MagickCore/threshold.c"
          (int) ((unsigned char) *p)
# 1932 "MagickCore/threshold.c" 3 4
...
# 1932 "MagickCore/threshold.c"
  ...
  threshold_map=p;
  while (((
# 1936 "MagickCore/threshold.c" 3 4
          ((*__ctype_b_loc ())[(int) ((
# 1936 "MagickCore/threshold.c"
          (int) ((unsigned char) *p)
# 1936 "MagickCore/threshold.c" 3 4
          ))] & (unsigned short int) _ISspace) 
# 1936 "MagickCore/threshold.c"
  ...
  if (map == (ThresholdMap *) 
# 1946 "MagickCore/threshold.c" 3 4
                             ((void *)0)
# 1946 "MagickCore/threshold.c"
                                 )
    {
      (void) ThrowMagickException(exception,"MagickCore/threshold.c",__func__,(unsigned long) 1948,OptionError,
  ...
  if ((p != (char *) 
# 1955 "MagickCore/threshold.c" 3 4
                    ((void *)0)
# 1955 "MagickCore/threshold.c"
                        ) && (
# 1955 "MagickCore/threshold.c" 3 4
                              ((*__ctype_b_loc ())[(int) ((
# 1955 "MagickCore/threshold.c"
...
# 1955 "MagickCore/threshold.c"
                                                                      != 0))
    {
      ...
      for (i=0; (i < 64); i++)
        levels[i]=StringToDouble(token,(char **) 
# 1959 "MagickCore/threshold.c" 3 4
                                                ((void *)0)
# 1959 "MagickCore/threshold.c"
                                                    );
      for (i=0; (*p != '\0') && (i < 64); i++)
      {
        (void) GetNextToken(p,&p,4096,token);
        if (*token == ',')
          (void) GetNextToken(p,&p,4096,token);
        levels[i]=StringToDouble(token,(char **) 
# 1965 "MagickCore/threshold.c" 3 4
                                                ((void *)0)
# 1965 "MagickCore/threshold.c"
                                                    );
      }
    }
  for (i=0; i < 64; i++)
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 1991 "MagickCore/threshold.c" 3 4
                        ((void *)0)
# 1991 "MagickCore/threshold.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      for (j=0; j < (ssize_t) GetPixelChannels(image); j++)
      {
        ...
        if ((traits & UpdatePixelTrait) == 0)
          continue;
        if (fabs(levels[n]) < 1.0e-12)
          {
            n++;
            continue;
          }
        threshold=(ssize_t) (((double) 1.0/(double) ((Quantum) 65535.0))*(double) q[j]*(levels[n]*
          (map->divisor-1)+1));
        ...
        q[j]=ClampToQuantum((double) (level+(threshold >=
          ...
          (y % (ssize_t) map->height)]))*(double) ((Quantum) 65535.0)/levels[n]);
        n++;
      }
      q+=GetPixelChannels(image);
    }
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 2031 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 2031 "MagickCore/threshold.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
__attribute__ ((visibility ("default"))) MagickBooleanType PerceptibleImage(Image *image,
...
# 2109 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 2109 "MagickCore/threshold.c"
 image != (Image *) 
# 2109 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2109 "MagickCore/threshold.c"
...
# 2109 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 2109 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 2109, __extension__ __PRETTY_FUNCTION__); }))
# 2109 "MagickCore/threshold.c"
                                ;
  
# 2110 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 2110 "MagickCore/threshold.c"
 image->signature == 0xabacadabUL
# 2110 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2110 "MagickCore/threshold.c"
...
# 2110 "MagickCore/threshold.c"
 "image->signature == MagickCoreSignature"
# 2110 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 2110, __extension__ __PRETTY_FUNCTION__); }))
# 2110 "MagickCore/threshold.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 2112,"%s",image->filename);
  if (image->storage_class == PseudoClass)
    {
      ssize_t
        i;
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 2161 "MagickCore/threshold.c" 3 4
                        ((void *)0)
# 2161 "MagickCore/threshold.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 2182 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 2182 "MagickCore/threshold.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"Perceptible/Image",progress,
          image->rows);
        if (proceed == MagickFalse)
          status=MagickFalse;
      }
...
# 2231 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) MagickBooleanType RandomThresholdImage(Image *image,
...
# 2256 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 2256 "MagickCore/threshold.c"
 image != (Image *) 
# 2256 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2256 "MagickCore/threshold.c"
...
# 2256 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 2256 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 2256, __extension__ __PRETTY_FUNCTION__); }))
# 2256 "MagickCore/threshold.c"
                                ;
  
# 2257 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 2257 "MagickCore/threshold.c"
 image->signature == 0xabacadabUL
# 2257 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2257 "MagickCore/threshold.c"
...
# 2257 "MagickCore/threshold.c"
 "image->signature == MagickCoreSignature"
# 2257 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 2257, __extension__ __PRETTY_FUNCTION__); }))
# 2257 "MagickCore/threshold.c"
                                                ;
  
# 2258 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 2258 "MagickCore/threshold.c"
 exception != (ExceptionInfo *) 
# 2258 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2258 "MagickCore/threshold.c"
...
# 2258 "MagickCore/threshold.c"
 "exception != (ExceptionInfo *) NULL"
# 2258 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 2258, __extension__ __PRETTY_FUNCTION__); }))
# 2258 "MagickCore/threshold.c"
                                            ;
  
# 2259 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 2259 "MagickCore/threshold.c"
 exception->signature == 0xabacadabUL
# 2259 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2259 "MagickCore/threshold.c"
...
# 2259 "MagickCore/threshold.c"
 "exception->signature == MagickCoreSignature"
# 2259 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 2259, __extension__ __PRETTY_FUNCTION__); }))
# 2259 "MagickCore/threshold.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 2261,"%s",image->filename);
  if (SetImageStorageClass(image,DirectClass,exception) == MagickFalse)
    return(MagickFalse);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 2290 "MagickCore/threshold.c" 3 4
                        ((void *)0)
# 2290 "MagickCore/threshold.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        ...
        q[i]=(double) q[i] <= threshold ? 0 : ((Quantum) 65535.0);
      }
      q+=GetPixelChannels(image);
    }
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 2323 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 2323 "MagickCore/threshold.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 2377 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) MagickBooleanType RangeThresholdImage(Image *image,
...
# 2395 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 2395 "MagickCore/threshold.c"
 image != (Image *) 
# 2395 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2395 "MagickCore/threshold.c"
...
# 2395 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 2395 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 2395, __extension__ __PRETTY_FUNCTION__); }))
# 2395 "MagickCore/threshold.c"
                                ;
  
# 2396 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 2396 "MagickCore/threshold.c"
 image->signature == 0xabacadabUL
# 2396 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2396 "MagickCore/threshold.c"
...
# 2396 "MagickCore/threshold.c"
 "image->signature == MagickCoreSignature"
# 2396 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 2396, __extension__ __PRETTY_FUNCTION__); }))
# 2396 "MagickCore/threshold.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 2398,"%s",image->filename);
  if (SetImageStorageClass(image,DirectClass,exception) == MagickFalse)
    return(MagickFalse);
  if (IsGrayColorspace(image->colorspace) != MagickFalse)
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 2424 "MagickCore/threshold.c" 3 4
                        ((void *)0)
# 2424 "MagickCore/threshold.c"
                            )
      {
        status=MagickFalse;
        continue;
      ...
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        ...
        if (pixel < low_black)
          ...
          if ((pixel >= low_black) && (pixel < low_white))
            q[i]=ClampToQuantum((double) ((Quantum) 65535.0)*
            ...
            if ((pixel >= low_white) && (pixel <= high_white))
              ...
              if ((pixel > high_white) && (pixel <= high_black))
                q[i]=ClampToQuantum((double) ((Quantum) 65535.0)*(double)
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 2470 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 2470 "MagickCore/threshold.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 2518 "MagickCore/threshold.c"
__attribute__ ((visibility ("default"))) MagickBooleanType WhiteThresholdImage(Image *image,
  const char *thresholds,ExceptionInfo *exception)
{
...
# 2544 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 2544 "MagickCore/threshold.c"
 image != (Image *) 
# 2544 "MagickCore/threshold.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2544 "MagickCore/threshold.c"
...
# 2544 "MagickCore/threshold.c"
 "image != (Image *) NULL"
# 2544 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 2544, __extension__ __PRETTY_FUNCTION__); }))
# 2544 "MagickCore/threshold.c"
                                ;
  
# 2545 "MagickCore/threshold.c" 3 4
 ((void) sizeof ((
# 2545 "MagickCore/threshold.c"
 image->signature == 0xabacadabUL
# 2545 "MagickCore/threshold.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2545 "MagickCore/threshold.c"
...
# 2545 "MagickCore/threshold.c"
 "image->signature == MagickCoreSignature"
# 2545 "MagickCore/threshold.c" 3 4
 , "MagickCore/threshold.c", 2545, __extension__ __PRETTY_FUNCTION__); }))
# 2545 "MagickCore/threshold.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/threshold.c",__func__,(unsigned long) 2547,"%s",image->filename);
  if (thresholds == (const char *) 
# 2548 "MagickCore/threshold.c" 3 4
                                  ((void *)0)
# 2548 "MagickCore/threshold.c"
                                      )
    return(MagickTrue);
  if (SetImageStorageClass(image,DirectClass,exception) == MagickFalse)
    return(MagickFalse);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 2603 "MagickCore/threshold.c" 3 4
                        ((void *)0)
# 2603 "MagickCore/threshold.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 2632 "MagickCore/threshold.c" 3 4
                                                          ((void *)0)
# 2632 "MagickCore/threshold.c"
                                                              )
      {
        MagickBooleanType
          proceed;
