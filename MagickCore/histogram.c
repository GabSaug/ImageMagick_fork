# 0 "MagickCore/histogram.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/histogram.c"
# 43 "MagickCore/histogram.c"
...
# 63 "MagickCore/histogram.c" 2
# 74 "MagickCore/histogram.c"
...
# 244 "MagickCore/histogram.c" 3 4
 ((void) sizeof ((
# 244 "MagickCore/histogram.c"
 image != (const Image *) 
# 244 "MagickCore/histogram.c" 3 4
...
# 244 "MagickCore/histogram.c" 3 4
 , "MagickCore/histogram.c", 244, __extension__ __PRETTY_FUNCTION__); }))
# 244 "MagickCore/histogram.c"
                                      ;
  
# 245 "MagickCore/histogram.c" 3 4
 ((void) sizeof ((
# 245 "MagickCore/histogram.c"
...
# 245 "MagickCore/histogram.c" 3 4
 , "MagickCore/histogram.c", 245, __extension__ __PRETTY_FUNCTION__); }))
# 245 "MagickCore/histogram.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/histogram.c",__func__,(unsigned long) 247,"%s",image->filename);
  cube_info=GetHCubeInfo();
  if (cube_info == (HCubeInfo *) 
# 249 "MagickCore/histogram.c" 3 4
                                ((void *)0)
# 249 "MagickCore/histogram.c"
                                    )
    {
      (void) ThrowMagickException(exception,"MagickCore/histogram.c",__func__,(unsigned long) 251,
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 260 "MagickCore/histogram.c" 3 4
                              ((void *)0)
# 260 "MagickCore/histogram.c"
                                  )
      break;
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      for (level=1; level < 8; level++)
      {
        ...
        if (node_info->child[id] == (HNodeInfo *) 
# 273 "MagickCore/histogram.c" 3 4
                                                 ((void *)0)
# 273 "MagickCore/histogram.c"
                                                     )
          {
            node_info->child[id]=GetHNodeInfo(cube_info,level);
            if (node_info->child[id] == (HNodeInfo *) 
# 276 "MagickCore/histogram.c" 3 4
                                                     ((void *)0)
# 276 "MagickCore/histogram.c"
                                                         )
              {
                (void) ThrowMagickException(exception,"MagickCore/histogram.c",__func__,(unsigned long) 278,
      ...
      if (i < (ssize_t) node_info->number_unique)
      ...
      else
        {
          ...
          if (node_info->list == (PixelInfo *) 
# 307 "MagickCore/histogram.c" 3 4
                                              ((void *)0)
# 307 "MagickCore/histogram.c"
                                                  )
            {
              (void) ThrowMagickException(exception,"MagickCore/histogram.c",__func__,(unsigned long) 309,
                ResourceLimitError,"MemoryAllocationFailed","`%s'",
                image->filename);
              return(0);
            }
    ...
    proceed=SetImageProgress(image,"  Compute image colors...  ",(MagickOffsetType) y,
      image->rows);
  ...
  PixelInfo **histogram)
{
  ...
  for (i=0; i < (ssize_t) number_children; i++)
    if (node_info->child[i] != (HNodeInfo *) 
# 380 "MagickCore/histogram.c" 3 4
                                            ((void *)0)
# 380 "MagickCore/histogram.c"
                                                )
      DefineImageHistogram(image,node_info->child[i],histogram);
  if (node_info->level == (8 -1))
    {
      PixelInfo
        *p;
...
static HCubeInfo *DestroyHCubeInfo(const Image *image,HCubeInfo *cube_info)
{
  ...
  } while (cube_info->node_queue != (HNodes *) 
# 436 "MagickCore/histogram.c" 3 4
                                              ((void *)0)
# 436 "MagickCore/histogram.c"
                                                  );
  return((HCubeInfo *) RelinquishMagickMemory(cube_info));
}
# 466 "MagickCore/histogram.c"
static void DestroyColorCube(const Image *image,HNodeInfo *node_info)
{
  ...
  for (i=0; i < (ssize_t) number_children; i++)
    if (node_info->child[i] != (HNodeInfo *) 
# 479 "MagickCore/histogram.c" 3 4
                                            ((void *)0)
# 479 "MagickCore/histogram.c"
                                                )
      DestroyColorCube(image,node_info->child[i]);
  if (node_info->list != (PixelInfo *) 
# 481 "MagickCore/histogram.c" 3 4
                                      ((void *)0)
# 481 "MagickCore/histogram.c"
                                          )
    node_info->list=(PixelInfo *) RelinquishMagickMemory(node_info->list);
}
# 507 "MagickCore/histogram.c"
static HCubeInfo *GetHCubeInfo(void)
{
  ...
  if (cube_info == (HCubeInfo *) 
# 516 "MagickCore/histogram.c" 3 4
                                ((void *)0)
# 516 "MagickCore/histogram.c"
                                    )
    return((HCubeInfo *) 
# 517 "MagickCore/histogram.c" 3 4
                        ((void *)0)
# 517 "MagickCore/histogram.c"
                            );
  ...
  if (cube_info->root == (HNodeInfo *) 
# 523 "MagickCore/histogram.c" 3 4
                                      ((void *)0)
# 523 "MagickCore/histogram.c"
                                          )
    return((HCubeInfo *) 
# 524 "MagickCore/histogram.c" 3 4
                        ((void *)0)
# 524 "MagickCore/histogram.c"
                            );
  return(cube_info);
}
# 555 "MagickCore/histogram.c"
__attribute__ ((visibility ("default"))) PixelInfo *GetImageHistogram(const Image *image,
  size_t *number_colors,ExceptionInfo *exception)
{
  ...
  *number_colors=0;
  histogram=(PixelInfo *) 
# 565 "MagickCore/histogram.c" 3 4
                         ((void *)0)
# 565 "MagickCore/histogram.c"
                             ;
  cube_info=ClassifyImageColors(image,exception);
  if (cube_info != (HCubeInfo *) 
# 567 "MagickCore/histogram.c" 3 4
                                ((void *)0)
# 567 "MagickCore/histogram.c"
                                    )
    {
      histogram=(PixelInfo *) AcquireQuantumMemory((size_t) cube_info->colors+1,
        sizeof(*histogram));
      if (histogram == (PixelInfo *) 
# 571 "MagickCore/histogram.c" 3 4
                                    ((void *)0)
# 571 "MagickCore/histogram.c"
                                        )
        (void) ThrowMagickException(exception,"MagickCore/histogram.c",__func__,(unsigned long) 572,
          ResourceLimitError,"MemoryAllocationFailed","`%s'",image->filename);
      else
        {
          PixelInfo
  ...
  if (cube_info->free_nodes == 0)
    {
      ...
      if (nodes == (HNodes *) 
# 627 "MagickCore/histogram.c" 3 4
                             ((void *)0)
# 627 "MagickCore/histogram.c"
                                 )
        return((HNodeInfo *) 
# 628 "MagickCore/histogram.c" 3 4
                            ((void *)0)
# 628 "MagickCore/histogram.c"
                                );
      nodes->next=cube_info->node_queue;
      cube_info->node_queue=nodes;
      cube_info->node_info=nodes->nodes;
      cube_info->free_nodes=1536;
    }
  ...
  const size_t max_colors,ExceptionInfo *exception)
{
  ...
  cube_info=GetHCubeInfo();
  if (cube_info == (HCubeInfo *) 
# 704 "MagickCore/histogram.c" 3 4
                                ((void *)0)
# 704 "MagickCore/histogram.c"
                                    )
    {
      (void) ThrowMagickException(exception,"MagickCore/histogram.c",__func__,(unsigned long) 706,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",image->filename);
      return(MagickFalse);
    }
  GetPixelInfo(image,&pixel);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    p=GetCacheViewVirtualPixels(image_view,0,y,image->columns,1,exception);
    if (p == (const Quantum *) 
# 719 "MagickCore/histogram.c" 3 4
                              ((void *)0)
# 719 "MagickCore/histogram.c"
                                  )
      break;
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      for (level=1; level < 8; level++)
      {
        ...
        id=ColorToNodeId(&pixel,index);
        if (node_info->child[id] == (HNodeInfo *) 
# 732 "MagickCore/histogram.c" 3 4
                                                 ((void *)0)
# 732 "MagickCore/histogram.c"
                                                     )
          {
            node_info->child[id]=GetHNodeInfo(cube_info,level);
            if (node_info->child[id] == (HNodeInfo *) 
# 735 "MagickCore/histogram.c" 3 4
                                                     ((void *)0)
# 735 "MagickCore/histogram.c"
                                                         )
              {
                (void) ThrowMagickException(exception,"MagickCore/histogram.c",__func__,(unsigned long) 737,
                  ResourceLimitError,"MemoryAllocationFailed","`%s'",
                  image->filename);
                break;
              }
      ...
      if (i < (ssize_t) node_info->number_unique)
      ...
      else
        {
          ...
          if (node_info->list == (PixelInfo *) 
# 761 "MagickCore/histogram.c" 3 4
                                              ((void *)0)
# 761 "MagickCore/histogram.c"
                                                  )
          ...
          if (node_info->list == (PixelInfo *) 
# 767 "MagickCore/histogram.c" 3 4
                                              ((void *)0)
# 767 "MagickCore/histogram.c"
                                                  )
            {
              (void) ThrowMagickException(exception,"MagickCore/histogram.c",__func__,(unsigned long) 769,
                ResourceLimitError,"MemoryAllocationFailed","`%s'",
                image->filename);
              break;
            }
...
__attribute__ ((visibility ("default"))) MagickBooleanType IdentifyPaletteImage(const Image *image,
  ExceptionInfo *exception)
{
  
# 800 "MagickCore/histogram.c" 3 4
 ((void) sizeof ((
# 800 "MagickCore/histogram.c"
 image != (Image *) 
# 800 "MagickCore/histogram.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 800 "MagickCore/histogram.c"
...
# 800 "MagickCore/histogram.c"
 "image != (Image *) NULL"
# 800 "MagickCore/histogram.c" 3 4
 , "MagickCore/histogram.c", 800, __extension__ __PRETTY_FUNCTION__); }))
# 800 "MagickCore/histogram.c"
                                ;
  
# 801 "MagickCore/histogram.c" 3 4
 ((void) sizeof ((
# 801 "MagickCore/histogram.c"
 image->signature == 0xabacadabUL
# 801 "MagickCore/histogram.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 801 "MagickCore/histogram.c"
...
# 801 "MagickCore/histogram.c"
 "image->signature == MagickCoreSignature"
# 801 "MagickCore/histogram.c" 3 4
 , "MagickCore/histogram.c", 801, __extension__ __PRETTY_FUNCTION__); }))
# 801 "MagickCore/histogram.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/histogram.c",__func__,(unsigned long) 803,"%s",image->filename);
  return(CheckImageColors(image,256,exception));
}
# 833 "MagickCore/histogram.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsHistogramImage(const Image *image,
  ExceptionInfo *exception)
{


  
# 838 "MagickCore/histogram.c" 3 4
 ((void) sizeof ((
# 838 "MagickCore/histogram.c"
 image != (Image *) 
# 838 "MagickCore/histogram.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 838 "MagickCore/histogram.c"
...
# 838 "MagickCore/histogram.c"
 "image != (Image *) NULL"
# 838 "MagickCore/histogram.c" 3 4
 , "MagickCore/histogram.c", 838, __extension__ __PRETTY_FUNCTION__); }))
# 838 "MagickCore/histogram.c"
                                ;
  
# 839 "MagickCore/histogram.c" 3 4
 ((void) sizeof ((
# 839 "MagickCore/histogram.c"
 image->signature == 0xabacadabUL
# 839 "MagickCore/histogram.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 839 "MagickCore/histogram.c"
...
# 839 "MagickCore/histogram.c"
 "image->signature == MagickCoreSignature"
# 839 "MagickCore/histogram.c" 3 4
 , "MagickCore/histogram.c", 839, __extension__ __PRETTY_FUNCTION__); }))
# 839 "MagickCore/histogram.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/histogram.c",__func__,(unsigned long) 841,"%s",image->filename);
  return(CheckImageColors(image,1024,exception));
}
# 868 "MagickCore/histogram.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsPaletteImage(const Image *image)
{
  
# 870 "MagickCore/histogram.c" 3 4
 ((void) sizeof ((
# 870 "MagickCore/histogram.c"
 image != (Image *) 
# 870 "MagickCore/histogram.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 870 "MagickCore/histogram.c"
...
# 870 "MagickCore/histogram.c"
 "image != (Image *) NULL"
# 870 "MagickCore/histogram.c" 3 4
 , "MagickCore/histogram.c", 870, __extension__ __PRETTY_FUNCTION__); }))
# 870 "MagickCore/histogram.c"
                                ;
  
# 871 "MagickCore/histogram.c" 3 4
 ((void) sizeof ((
# 871 "MagickCore/histogram.c"
 image->signature == 0xabacadabUL
# 871 "MagickCore/histogram.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 871 "MagickCore/histogram.c"
...
# 871 "MagickCore/histogram.c"
 "image->signature == MagickCoreSignature"
# 871 "MagickCore/histogram.c" 3 4
 , "MagickCore/histogram.c", 871, __extension__ __PRETTY_FUNCTION__); }))
# 871 "MagickCore/histogram.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/histogram.c",__func__,(unsigned long) 873,"%s",image->filename);
  if (image->storage_class != PseudoClass)
    return(MagickFalse);
  return((image->colors <= 256) ? MagickTrue : MagickFalse);
}
# 927 "MagickCore/histogram.c"
__attribute__ ((visibility ("default"))) MagickBooleanType MinMaxStretchImage(Image *image,
...
__attribute__ ((visibility ("default"))) size_t GetNumberColors(const Image *image,FILE *file,
  ExceptionInfo *exception)
{
  ...
  number_colors=0;
  if (file == (FILE *) 
# 1060 "MagickCore/histogram.c" 3 4
                      ((void *)0)
# 1060 "MagickCore/histogram.c"
                          )
    {
      HCubeInfo
        *cube_info;
      ...
      cube_info=ClassifyImageColors(image,exception);
      if (cube_info != (HCubeInfo *) 
# 1066 "MagickCore/histogram.c" 3 4
                                    ((void *)0)
# 1066 "MagickCore/histogram.c"
                                        )
        {
          number_colors=cube_info->colors;
          cube_info=DestroyHCubeInfo(image,cube_info);
  ...
  if (histogram == (PixelInfo *) 
# 1074 "MagickCore/histogram.c" 3 4
                                ((void *)0)
# 1074 "MagickCore/histogram.c"
                                    )
    return(number_colors);
  ...
  for (i=0; i < (ssize_t) number_colors; i++)
  {
    ...
    (void) FormatLocaleString(count,4096,"%10.20g:",(double)
...
# 1108 "MagickCore/histogram.c" 3 4
                                                          ((void *)0)
# 1108 "MagickCore/histogram.c"
                                                              )
      {
        MagickBooleanType
          proceed;

        proceed=SetImageProgress(image,"Histogram/Image",(MagickOffsetType) i,
          number_colors);
        if (proceed == MagickFalse)
          status=MagickFalse;
      }
  ...
  HCubeInfo *cube_info,const HNodeInfo *node_info,ExceptionInfo *exception)
{
  ...
  for (i=0; i < (ssize_t) number_children; i++)
    if (node_info->child[i] != (HNodeInfo *) 
# 1171 "MagickCore/histogram.c" 3 4
                                            ((void *)0)
# 1171 "MagickCore/histogram.c"
                                                )
  ...
  if (node_info->level == (8 -1))
    {
      ...
      for (i=0; i < (ssize_t) node_info->number_unique; i++)
      {
        q=QueueCacheViewAuthenticPixels(unique_view,cube_info->x,0,1,1,
          exception);
        if (q == (Quantum *) 
# 1188 "MagickCore/histogram.c" 3 4
                            ((void *)0)
# 1188 "MagickCore/histogram.c"
                                )
          continue;
      ...
      if (unique_image->progress_monitor != (MagickProgressMonitor) 
# 1201 "MagickCore/histogram.c" 3 4
                                                                   ((void *)0)
# 1201 "MagickCore/histogram.c"
                                                                       )
        {
          MagickBooleanType
            proceed;

          proceed=SetImageProgress(unique_image,"UniqueColors/Image",
...
__attribute__ ((visibility ("default"))) Image *UniqueImageColors(const Image *image,
  ExceptionInfo *exception)
{
  CacheView
    *unique_view;
  ...
  cube_info=ClassifyImageColors(image,exception);
  if (cube_info == (HCubeInfo *) 
# 1230 "MagickCore/histogram.c" 3 4
                                ((void *)0)
# 1230 "MagickCore/histogram.c"
                                    )
    return((Image *) 
# 1231 "MagickCore/histogram.c" 3 4
                    ((void *)0)
# 1231 "MagickCore/histogram.c"
                        );
  unique_image=CloneImage(image,cube_info->colors,1,MagickTrue,exception);
  if (unique_image == (Image *) 
# 1233 "MagickCore/histogram.c" 3 4
                               ((void *)0)
# 1233 "MagickCore/histogram.c"
                                   )
    return(unique_image);
  if (SetImageStorageClass(unique_image,DirectClass,exception) == MagickFalse)
    {
      ...
      return((Image *) 
# 1238 "MagickCore/histogram.c" 3 4
                      ((void *)0)
# 1238 "MagickCore/histogram.c"
                          );
    }
