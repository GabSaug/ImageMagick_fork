# 0 "MagickCore/distribute-cache.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/distribute-cache.c"
# 54 "MagickCore/distribute-cache.c"
...
# 55 "MagickCore/distribute-cache.c" 2
...
# 56 "MagickCore/distribute-cache.c" 2
...
# 57 "MagickCore/distribute-cache.c" 2
...
# 59 "MagickCore/distribute-cache.c" 2
...
# 61 "MagickCore/distribute-cache.c" 2
...
extern __attribute__ ((visibility ("default"))) void
  ...
  SyncImageList(Image *);
# 65 "MagickCore/distribute-cache.c" 2
...
# 68 "MagickCore/distribute-cache.c" 2
...
extern __attribute__ ((visibility ("default"))) MagickBooleanType
  ...
  SetMagickSecurityPolicyValue(const PolicyDomain,const char *,const char *,
    ExceptionInfo *);
# 70 "MagickCore/distribute-cache.c" 2
...
# 72 "MagickCore/distribute-cache.c" 2
...
# 75 "MagickCore/distribute-cache.c" 2
...
# 76 "MagickCore/distribute-cache.c" 2
# 1 "./MagickCore/version-private.h" 1
# 27 "./MagickCore/version-private.h"
extern __attribute__ ((visibility ("default"))) unsigned int
  GetMagickSignature(const StringInfo *);
# 77 "MagickCore/distribute-cache.c" 2
...
# 144 "/usr/include/x86_64-linux-gnu/bits/in.h" 3 4
struct ip_opts
  {
...
# 81 "MagickCore/distribute-cache.c" 2
...
# 82 "MagickCore/distribute-cache.c" 2
...
# 84 "MagickCore/distribute-cache.c" 2
# 157 "MagickCore/distribute-cache.c"

# 157 "MagickCore/distribute-cache.c"
static inline MagickOffsetType dpc_read(int file,const MagickSizeType length,
  unsigned char *__restrict__ message)
{
  MagickOffsetType
    i;
  ...
  {
    count=recv(file,(char *) message+i,(size_t) (((length- (MagickSizeType) i) < ((MagickSizeType) (0x7fffffffffffffffL
# 169 "MagickCore/distribute-cache.c"
                                                    ))) ? (length- (MagickSizeType) i) : ((MagickSizeType) (0x7fffffffffffffffL
# 169 "MagickCore/distribute-cache.c"
                                                    )))
                                                           ,0);
    if (count <= 0)
      {
        count=0;
        if (
# 174 "MagickCore/distribute-cache.c" 3 4
           (*__errno_location ()) 
# 174 "MagickCore/distribute-cache.c"
                 != 
# 174 "MagickCore/distribute-cache.c" 3 4
                    4
# 174 "MagickCore/distribute-cache.c"
...
# 215 "MagickCore/distribute-cache.c"
  ...
  size_t *session_key,ExceptionInfo *exception)
{
  ...
  *session_key=0;
  ...
  hint.ai_family=
# 246 "MagickCore/distribute-cache.c" 3 4
                2
# 246 "MagickCore/distribute-cache.c"
                       ;
  hint.ai_socktype=
# 247 "MagickCore/distribute-cache.c" 3 4
                  SOCK_STREAM
# 247 "MagickCore/distribute-cache.c"
                             ;
  hint.ai_flags=
# 248 "MagickCore/distribute-cache.c" 3 4
               0x0001
# 248 "MagickCore/distribute-cache.c"
                         ;
  (void) FormatLocaleString(service,4096,"%d",port);
  status=getaddrinfo(hostname,service,&hint,&result);
  if (status != 0)
    {
      (void) ThrowMagickException(exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 253,CacheError,
        "DistributedPixelCache","'%s': %s",hostname,GetExceptionMessage(
# 254 "MagickCore/distribute-cache.c" 3 4
                                                                       (*__errno_location ())
# 254 "MagickCore/distribute-cache.c"
                                                                            ));
      return(-1);
    }
  ...
  if (client_socket == -1)
    {
      freeaddrinfo(result);
      (void) ThrowMagickException(exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 262,CacheError,
        "DistributedPixelCache","'%s': %s",hostname,GetExceptionMessage(
# 263 "MagickCore/distribute-cache.c" 3 4
                                                                       (*__errno_location ())
# 263 "MagickCore/distribute-cache.c"
                                                                            ));
      return(-1);
    }
  ...
  if (status == -1)
    {
      ...
      (void) ThrowMagickException(exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 271,CacheError,
        "DistributedPixelCache","'%s': %s",hostname,GetExceptionMessage(
# 272 "MagickCore/distribute-cache.c" 3 4
                                                                       (*__errno_location ())
# 272 "MagickCore/distribute-cache.c"
                                                                            ));
      return(-1);
    }
  ...
  if (count == -1)
    {
      (void) close(client_socket);
      (void) ThrowMagickException(exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 279,CacheError,
        "DistributedPixelCache","'%s': %s",hostname,GetExceptionMessage(
# 280 "MagickCore/distribute-cache.c" 3 4
                                                                       (*__errno_location ())
# 280 "MagickCore/distribute-cache.c"
                                                                            ));
      return(-1);
    }
  ...
  if (shared_secret == (char *) 
# 287 "MagickCore/distribute-cache.c" 3 4
                               ((void *)0)
# 287 "MagickCore/distribute-cache.c"
                                   )
    {
      (void) close(client_socket);
      (void) ThrowMagickException(exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 290,CacheError,
  ...
  if (GetMagickSignature(nonce) != *session_key)
    {
      (void) close(client_socket);
      (void) ThrowMagickException(exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 298,CacheError,
...
static char *GetHostname(int *port,ExceptionInfo *exception)
{
  ...
  if (hosts == (char *) 
# 328 "MagickCore/distribute-cache.c" 3 4
                       ((void *)0)
# 328 "MagickCore/distribute-cache.c"
                           )
    {
      *port=6668;
      return(AcquireString("127.0.0.1"));
    }
  (void) SubstituteString(&hosts,","," ");
  hostlist=StringToArgv(hosts,&argc);
  hosts=DestroyString(hosts);
  if (hostlist == (char **) 
# 336 "MagickCore/distribute-cache.c" 3 4
                           ((void *)0)
# 336 "MagickCore/distribute-cache.c"
                               )
    {
      *port=6668;
      return(AcquireString("127.0.0.1"));
  ...
  hostlist=StringToArgv(hosts,&argc);
  if (hostlist == (char **) 
# 347 "MagickCore/distribute-cache.c" 3 4
                           ((void *)0)
# 347 "MagickCore/distribute-cache.c"
                               )
    {
      *port=6668;
      return(AcquireString("127.0.0.1"));
  ...
  if (hostlist[2] == (char *) 
# 353 "MagickCore/distribute-cache.c" 3 4
                             ((void *)0)
# 353 "MagickCore/distribute-cache.c"
                                 )
    *port=6668;
  else
...
__attribute__ ((visibility ("hidden"))) DistributeCacheInfo *AcquireDistributeCacheInfo(
  ExceptionInfo *exception)
{
  ...
  server_info->signature=0xabacadabUL;
  server_info->port=0;
  ...
  if (server_info->file == -1)
  ...
  else
    {
      ...
      (void) CopyMagickString(server_info->hostname,hostname,4096);
...
# 424 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) DistributeCacheInfo *DestroyDistributeCacheInfo(
  DistributeCacheInfo *server_info)
{
  
# 427 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 427 "MagickCore/distribute-cache.c"
 server_info != (DistributeCacheInfo *) 
# 427 "MagickCore/distribute-cache.c" 3 4
...
# 427 "MagickCore/distribute-cache.c"
 "server_info != (DistributeCacheInfo *) NULL"
# 427 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 427, __extension__ __PRETTY_FUNCTION__); }))
# 427 "MagickCore/distribute-cache.c"
                                                    ;
  
# 428 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 428 "MagickCore/distribute-cache.c"
 server_info->signature == 0xabacadabUL
# 428 "MagickCore/distribute-cache.c" 3 4
...
# 428 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 428, __extension__ __PRETTY_FUNCTION__); }))
# 428 "MagickCore/distribute-cache.c"
                                                      ;
  ...
  const void *__restrict__ message)
{
  ...
  for (i=0; i < (MagickOffsetType) length; i+=count)
  {
    count=(MagickOffsetType) send(file,(char *) message+i,(size_t)
      (((length-(MagickSizeType) i) < ((MagickSizeType) (0x7fffffffffffffffL
# 491 "MagickCore/distribute-cache.c"
     ))) ? (length-(MagickSizeType) i) : ((MagickSizeType) (0x7fffffffffffffffL
# 491 "MagickCore/distribute-cache.c"
     ))),
      
# 492 "MagickCore/distribute-cache.c" 3 4
     MSG_NOSIGNAL
# 492 "MagickCore/distribute-cache.c"
                 );
    if (count <= 0)
      {
        count=0;
        if (
# 496 "MagickCore/distribute-cache.c" 3 4
           (*__errno_location ()) 
# 496 "MagickCore/distribute-cache.c"
                 != 
# 496 "MagickCore/distribute-cache.c" 3 4
                    4
# 496 "MagickCore/distribute-cache.c"
...
# 513 "MagickCore/distribute-cache.c"
...
# 550 "MagickCore/distribute-cache.c" 3 4
                                  ((void *)0)
# 550 "MagickCore/distribute-cache.c"
                                      ,exception);
  if (image == (Image *) 
# 551 "MagickCore/distribute-cache.c" 3 4
                        ((void *)0)
# 551 "MagickCore/distribute-cache.c"
                            )
    return(MagickFalse);
  length=sizeof(image->storage_class)+sizeof(image->colorspace)+
    ...
    sizeof(image->rows)+sizeof(image->number_channels)+64*
  ...
  (void) memcpy(image->channel_map,p,64*
    sizeof(*image->channel_map));
  p+=64*sizeof(*image->channel_map);
  ...
  int file,const size_t session_key,ExceptionInfo *exception)
{
  ...
  if (image == (Image *) 
# 621 "MagickCore/distribute-cache.c" 3 4
                        ((void *)0)
# 621 "MagickCore/distribute-cache.c"
                            )
    return(MagickFalse);
  ...
  p=GetVirtualPixels(image,region.x,region.y,region.width,region.height,
    exception);
  if (p == (const Quantum *) 
# 641 "MagickCore/distribute-cache.c" 3 4
                            ((void *)0)
# 641 "MagickCore/distribute-cache.c"
                                )
    return(MagickFalse);
  ...
  int file,const size_t session_key,ExceptionInfo *exception)
{
  ...
  image=(Image *) GetValueFromSplayTree(registry,(const void *) key);
  if (image == (Image *) 
# 679 "MagickCore/distribute-cache.c" 3 4
                        ((void *)0)
# 679 "MagickCore/distribute-cache.c"
                            )
    return(MagickFalse);
  length=sizeof(region.width)+sizeof(region.height)+sizeof(region.x)+
    sizeof(region.y)+sizeof(length);
  ...
  p=GetVirtualPixels(image,region.x,region.y,region.width,region.height,
    exception);
  if (p == (const Quantum *) 
# 699 "MagickCore/distribute-cache.c" 3 4
                            ((void *)0)
# 699 "MagickCore/distribute-cache.c"
                                )
    return(MagickFalse);
  ...
  ExceptionInfo *exception)
{
  ...
  image=(Image *) GetValueFromSplayTree(registry,(const void *) key);
  if (image == (Image *) 
# 744 "MagickCore/distribute-cache.c" 3 4
                        ((void *)0)
# 744 "MagickCore/distribute-cache.c"
                            )
    return(MagickFalse);
  length=sizeof(region.width)+sizeof(region.height)+sizeof(region.x)+
    sizeof(region.y)+sizeof(length);
  ...
  q=GetAuthenticPixels(image,region.x,region.y,region.width,region.height,
    exception);
  if (q == (Quantum *) 
# 764 "MagickCore/distribute-cache.c" 3 4
                      ((void *)0)
# 764 "MagickCore/distribute-cache.c"
                          )
    return(MagickFalse);
  ...
  int file,const size_t session_key,ExceptionInfo *exception)
{
  ...
  image=(Image *) GetValueFromSplayTree(registry,(const void *) key);
  if (image == (Image *) 
# 802 "MagickCore/distribute-cache.c" 3 4
                        ((void *)0)
# 802 "MagickCore/distribute-cache.c"
                            )
    return(MagickFalse);
  length=sizeof(region.width)+sizeof(region.height)+sizeof(region.x)+
    sizeof(region.y)+sizeof(length);
  ...
  q=GetAuthenticPixels(image,region.x,region.y,region.width,region.height,
    exception);
  if (q == (Quantum *) 
# 822 "MagickCore/distribute-cache.c" 3 4
                      ((void *)0)
# 822 "MagickCore/distribute-cache.c"
                          )
    return(MagickFalse);
...
# 865 "MagickCore/distribute-cache.c"
  ...
  registry=NewSplayTree((int (*)(const void *,const void *)) 
# 874 "MagickCore/distribute-cache.c" 3 4
                                                            ((void *)0)
# 874 "MagickCore/distribute-cache.c"
                                                                ,
    (void *(*)(void *)) 
# 875 "MagickCore/distribute-cache.c" 3 4
                       ((void *)0)
# 875 "MagickCore/distribute-cache.c"
  ...
  return((void *) 
# 936 "MagickCore/distribute-cache.c" 3 4
        ((void *)0)
# 936 "MagickCore/distribute-cache.c"
                            );
}

__attribute__ ((visibility ("default"))) void DistributePixelCacheServer(const int port,
  ExceptionInfo *exception)
{
  char
    service[4096];
...
# 977 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 977 "MagickCore/distribute-cache.c"
...
# 977 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 977, __extension__ __PRETTY_FUNCTION__); }))
# 977 "MagickCore/distribute-cache.c"
                                            ;
  
# 978 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 978 "MagickCore/distribute-cache.c"
...
# 978 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 978, __extension__ __PRETTY_FUNCTION__); }))
# 978 "MagickCore/distribute-cache.c"
                                                    ;
  ;
  ...
  (void) memset(&hint,0,sizeof(hint));
  hint.ai_family=
# 984 "MagickCore/distribute-cache.c" 3 4
                2
# 984 "MagickCore/distribute-cache.c"
                       ;
  hint.ai_socktype=
# 985 "MagickCore/distribute-cache.c" 3 4
                  SOCK_STREAM
# 985 "MagickCore/distribute-cache.c"
                             ;
  hint.ai_flags=
# 986 "MagickCore/distribute-cache.c" 3 4
               0x0001
# 986 "MagickCore/distribute-cache.c"
                         ;
  (void) FormatLocaleString(service,4096,"%d",port);
  status=getaddrinfo((const char *) 
# 988 "MagickCore/distribute-cache.c" 3 4
                                   ((void *)0)
# 988 "MagickCore/distribute-cache.c"
                                       ,service,&hint,&result);
  if (status != 0)
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 990 "MagickCore/distribute-cache.c" 3 4
   (*__errno_location ())
# 990 "MagickCore/distribute-cache.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 990,CacheFatalError,"UnableToListen", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (CacheFatalError-FatalErrorException)+1); };
  server_socket=(int) 0;
  for (p=result; p != (struct addrinfo *) 
# 992 "MagickCore/distribute-cache.c" 3 4
                                         ((void *)0)
# 992 "MagickCore/distribute-cache.c"
                                             ; p=p->ai_next)
  {
    int
      one;
    ...
    if (server_socket == -1)
      continue;
    one=1;
    status=setsockopt(server_socket,
# 1001 "MagickCore/distribute-cache.c" 3 4
                                   1
# 1001 "MagickCore/distribute-cache.c"
                                             ,
# 1001 "MagickCore/distribute-cache.c" 3 4
                                              2
# 1001 "MagickCore/distribute-cache.c"
  ...
  if (p == (struct addrinfo *) 
# 1016 "MagickCore/distribute-cache.c" 3 4
                              ((void *)0)
# 1016 "MagickCore/distribute-cache.c"
                                  )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1017 "MagickCore/distribute-cache.c" 3 4
   (*__errno_location ())
# 1017 "MagickCore/distribute-cache.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 1017,CacheFatalError,"UnableToBind", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (CacheFatalError-FatalErrorException)+1); };
  freeaddrinfo(result);
  status=listen(server_socket,10);
  if (status != 0)
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1021 "MagickCore/distribute-cache.c" 3 4
   (*__errno_location ())
# 1021 "MagickCore/distribute-cache.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 1021,CacheFatalError,"UnableToListen", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (CacheFatalError-FatalErrorException)+1); };
  ...
  for ( ; ; )
  {
    ...
    if (client_socket == -1)
      { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1036 "MagickCore/distribute-cache.c" 3 4
     (*__errno_location ())
# 1036 "MagickCore/distribute-cache.c"
     ); (void) ThrowMagickException(fatal_exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 1036,CacheFatalError,"UnableToEstablishConnection", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (CacheFatalError-FatalErrorException)+1); };

    status=pthread_create(&threads,&attributes,DistributePixelCacheClient,
      (void *) &client_socket);
    if (status == -1)
      { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1041 "MagickCore/distribute-cache.c" 3 4
     (*__errno_location ())
# 1041 "MagickCore/distribute-cache.c"
     ); (void) ThrowMagickException(fatal_exception,"MagickCore/distribute-cache.c",__func__,(unsigned long) 1041,CacheFatalError,"UnableToCreateClientThread", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (CacheFatalError-FatalErrorException)+1); };
...
# 1066 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) void DistributeCacheTerminus(void)
{
# 1080 "MagickCore/distribute-cache.c"
}
# 1105 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) int GetDistributeCacheFile(const DistributeCacheInfo *server_info)
{
  
# 1107 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1107 "MagickCore/distribute-cache.c"
 server_info != (DistributeCacheInfo *) 
# 1107 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1107 "MagickCore/distribute-cache.c"
...
# 1107 "MagickCore/distribute-cache.c"
 "server_info != (DistributeCacheInfo *) NULL"
# 1107 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1107, __extension__ __PRETTY_FUNCTION__); }))
# 1107 "MagickCore/distribute-cache.c"
                                                    ;
  
# 1108 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1108 "MagickCore/distribute-cache.c"
 server_info->signature == 0xabacadabUL
# 1108 "MagickCore/distribute-cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1108 "MagickCore/distribute-cache.c"
...
# 1108 "MagickCore/distribute-cache.c"
 "server_info->signature == MagickCoreSignature"
# 1108 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1108, __extension__ __PRETTY_FUNCTION__); }))
# 1108 "MagickCore/distribute-cache.c"
                                                      ;
  return(server_info->file);
}
# 1136 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) const char *GetDistributeCacheHostname(
  const DistributeCacheInfo *server_info)
{
  
# 1139 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1139 "MagickCore/distribute-cache.c"
 server_info != (DistributeCacheInfo *) 
# 1139 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1139 "MagickCore/distribute-cache.c"
...
# 1139 "MagickCore/distribute-cache.c"
 "server_info != (DistributeCacheInfo *) NULL"
# 1139 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1139, __extension__ __PRETTY_FUNCTION__); }))
# 1139 "MagickCore/distribute-cache.c"
                                                    ;
  
# 1140 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1140 "MagickCore/distribute-cache.c"
 server_info->signature == 0xabacadabUL
# 1140 "MagickCore/distribute-cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1140 "MagickCore/distribute-cache.c"
...
# 1140 "MagickCore/distribute-cache.c"
 "server_info->signature == MagickCoreSignature"
# 1140 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1140, __extension__ __PRETTY_FUNCTION__); }))
# 1140 "MagickCore/distribute-cache.c"
                                                      ;
  return(server_info->hostname);
}
# 1167 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) int GetDistributeCachePort(const DistributeCacheInfo *server_info)
{
  
# 1169 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1169 "MagickCore/distribute-cache.c"
 server_info != (DistributeCacheInfo *) 
# 1169 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1169 "MagickCore/distribute-cache.c"
...
# 1169 "MagickCore/distribute-cache.c"
 "server_info != (DistributeCacheInfo *) NULL"
# 1169 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1169, __extension__ __PRETTY_FUNCTION__); }))
# 1169 "MagickCore/distribute-cache.c"
                                                    ;
  
# 1170 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1170 "MagickCore/distribute-cache.c"
 server_info->signature == 0xabacadabUL
# 1170 "MagickCore/distribute-cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1170 "MagickCore/distribute-cache.c"
...
# 1170 "MagickCore/distribute-cache.c"
 "server_info->signature == MagickCoreSignature"
# 1170 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1170, __extension__ __PRETTY_FUNCTION__); }))
# 1170 "MagickCore/distribute-cache.c"
                                                      ;
  return(server_info->port);
}
# 1199 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType OpenDistributePixelCache(
...
# 1215 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1215 "MagickCore/distribute-cache.c"
 server_info != (DistributeCacheInfo *) 
# 1215 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1215 "MagickCore/distribute-cache.c"
...
# 1215 "MagickCore/distribute-cache.c"
 "server_info != (DistributeCacheInfo *) NULL"
# 1215 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1215, __extension__ __PRETTY_FUNCTION__); }))
# 1215 "MagickCore/distribute-cache.c"
                                                    ;
  
# 1216 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1216 "MagickCore/distribute-cache.c"
 server_info->signature == 0xabacadabUL
# 1216 "MagickCore/distribute-cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1216 "MagickCore/distribute-cache.c"
...
# 1216 "MagickCore/distribute-cache.c"
 "server_info->signature == MagickCoreSignature"
# 1216 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1216, __extension__ __PRETTY_FUNCTION__); }))
# 1216 "MagickCore/distribute-cache.c"
                                                      ;
  
# 1217 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1217 "MagickCore/distribute-cache.c"
 image != (Image *) 
# 1217 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1217 "MagickCore/distribute-cache.c"
...
# 1217 "MagickCore/distribute-cache.c"
 "image != (Image *) NULL"
# 1217 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1217, __extension__ __PRETTY_FUNCTION__); }))
# 1217 "MagickCore/distribute-cache.c"
                                ;
  
# 1218 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1218 "MagickCore/distribute-cache.c"
...
# 1218 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1218, __extension__ __PRETTY_FUNCTION__); }))
# 1218 "MagickCore/distribute-cache.c"
                                                ;
  p=message;
  *p++='o';
  ...
  p+=sizeof(image->number_channels);
  (void) memcpy(p,image->channel_map,64*
    sizeof(*image->channel_map));
  p+=64*sizeof(*image->channel_map);
...
# 1288 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) MagickOffsetType ReadDistributePixelCacheMetacontent(
...
# 1302 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1302 "MagickCore/distribute-cache.c"
 server_info != (DistributeCacheInfo *) 
# 1302 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1302 "MagickCore/distribute-cache.c"
...
# 1302 "MagickCore/distribute-cache.c"
 "server_info != (DistributeCacheInfo *) NULL"
# 1302 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1302, __extension__ __PRETTY_FUNCTION__); }))
# 1302 "MagickCore/distribute-cache.c"
                                                    ;
  
# 1303 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1303 "MagickCore/distribute-cache.c"
 server_info->signature == 0xabacadabUL
# 1303 "MagickCore/distribute-cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1303 "MagickCore/distribute-cache.c"
...
# 1303 "MagickCore/distribute-cache.c"
 "server_info->signature == MagickCoreSignature"
# 1303 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1303, __extension__ __PRETTY_FUNCTION__); }))
# 1303 "MagickCore/distribute-cache.c"
                                                      ;
  
# 1304 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1304 "MagickCore/distribute-cache.c"
...
# 1304 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1304 "MagickCore/distribute-cache.c"
 "region != (RectangleInfo *) NULL"
# 1304 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1304, __extension__ __PRETTY_FUNCTION__); }))
# 1304 "MagickCore/distribute-cache.c"
                                         ;
  
# 1305 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1305 "MagickCore/distribute-cache.c"
 metacontent != (unsigned char *) 
# 1305 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1305 "MagickCore/distribute-cache.c"
 metacontent != (unsigned char *) 
# 1305 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1305 "MagickCore/distribute-cache.c"
 "metacontent != (unsigned char *) NULL"
# 1305 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1305, __extension__ __PRETTY_FUNCTION__); }))
# 1305 "MagickCore/distribute-cache.c"
                                              ;
  if (length > (MagickSizeType) (0x7fffffffffffffffL
# 1306 "MagickCore/distribute-cache.c"
                               ))
    return(-1);
  p=message;
  *p++='R';
...
# 1361 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) MagickOffsetType ReadDistributePixelCachePixels(
  DistributeCacheInfo *server_info,const RectangleInfo *region,
  const MagickSizeType length,unsigned char *__restrict__ pixels)
{
  MagickOffsetType
    count;
...
# 1375 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1375 "MagickCore/distribute-cache.c"
 server_info != (DistributeCacheInfo *) 
# 1375 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1375 "MagickCore/distribute-cache.c"
...
# 1375 "MagickCore/distribute-cache.c"
 "server_info != (DistributeCacheInfo *) NULL"
# 1375 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1375, __extension__ __PRETTY_FUNCTION__); }))
# 1375 "MagickCore/distribute-cache.c"
                                                    ;
  
# 1376 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1376 "MagickCore/distribute-cache.c"
 server_info->signature == 0xabacadabUL
# 1376 "MagickCore/distribute-cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1376 "MagickCore/distribute-cache.c"
...
# 1376 "MagickCore/distribute-cache.c"
 "server_info->signature == MagickCoreSignature"
# 1376 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1376, __extension__ __PRETTY_FUNCTION__); }))
# 1376 "MagickCore/distribute-cache.c"
                                                      ;
  
# 1377 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1377 "MagickCore/distribute-cache.c"
 region != (RectangleInfo *) 
# 1377 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1377 "MagickCore/distribute-cache.c"
...
# 1377 "MagickCore/distribute-cache.c"
 "region != (RectangleInfo *) NULL"
# 1377 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1377, __extension__ __PRETTY_FUNCTION__); }))
# 1377 "MagickCore/distribute-cache.c"
                                         ;
  
# 1378 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1378 "MagickCore/distribute-cache.c"
...
# 1378 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1378, __extension__ __PRETTY_FUNCTION__); }))
# 1378 "MagickCore/distribute-cache.c"
                                         ;
  if (length > (MagickSizeType) (0x7fffffffffffffffL
# 1379 "MagickCore/distribute-cache.c"
                               ))
    return(-1);
  p=message;
  *p++='r';
...
# 1425 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType RelinquishDistributePixelCache(
  DistributeCacheInfo *server_info)
{
  MagickBooleanType
    status;
...
# 1441 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1441 "MagickCore/distribute-cache.c"
 server_info != (DistributeCacheInfo *) 
# 1441 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1441 "MagickCore/distribute-cache.c"
...
# 1441 "MagickCore/distribute-cache.c"
 "server_info != (DistributeCacheInfo *) NULL"
# 1441 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1441, __extension__ __PRETTY_FUNCTION__); }))
# 1441 "MagickCore/distribute-cache.c"
                                                    ;
  
# 1442 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1442 "MagickCore/distribute-cache.c"
 server_info->signature == 0xabacadabUL
# 1442 "MagickCore/distribute-cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1442 "MagickCore/distribute-cache.c"
...
# 1442 "MagickCore/distribute-cache.c"
 "server_info->signature == MagickCoreSignature"
# 1442 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1442, __extension__ __PRETTY_FUNCTION__); }))
# 1442 "MagickCore/distribute-cache.c"
                                                      ;
  p=message;
  *p++='d';
...
# 1490 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) MagickOffsetType WriteDistributePixelCacheMetacontent(
  DistributeCacheInfo *server_info,const RectangleInfo *region,
...
# 1504 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1504 "MagickCore/distribute-cache.c"
 server_info != (DistributeCacheInfo *) 
# 1504 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1504 "MagickCore/distribute-cache.c"
...
# 1504 "MagickCore/distribute-cache.c"
 "server_info != (DistributeCacheInfo *) NULL"
# 1504 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1504, __extension__ __PRETTY_FUNCTION__); }))
# 1504 "MagickCore/distribute-cache.c"
                                                    ;
  
# 1505 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1505 "MagickCore/distribute-cache.c"
 server_info->signature == 0xabacadabUL
# 1505 "MagickCore/distribute-cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1505 "MagickCore/distribute-cache.c"
...
# 1505 "MagickCore/distribute-cache.c"
 "server_info->signature == MagickCoreSignature"
# 1505 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1505, __extension__ __PRETTY_FUNCTION__); }))
# 1505 "MagickCore/distribute-cache.c"
                                                      ;
  
# 1506 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1506 "MagickCore/distribute-cache.c"
 region != (RectangleInfo *) 
# 1506 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1506 "MagickCore/distribute-cache.c"
...
# 1506 "MagickCore/distribute-cache.c"
 "region != (RectangleInfo *) NULL"
# 1506 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1506, __extension__ __PRETTY_FUNCTION__); }))
# 1506 "MagickCore/distribute-cache.c"
                                         ;
  
# 1507 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1507 "MagickCore/distribute-cache.c"
 metacontent != (unsigned char *) 
# 1507 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1507 "MagickCore/distribute-cache.c"
...
# 1507 "MagickCore/distribute-cache.c"
 "metacontent != (unsigned char *) NULL"
# 1507 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1507, __extension__ __PRETTY_FUNCTION__); }))
# 1507 "MagickCore/distribute-cache.c"
                                              ;
  if (length > (MagickSizeType) (0x7fffffffffffffffL
# 1508 "MagickCore/distribute-cache.c"
                               ))
    return(-1);
  p=message;
  *p++='W';
...
# 1564 "MagickCore/distribute-cache.c"
__attribute__ ((visibility ("hidden"))) MagickOffsetType WriteDistributePixelCachePixels(
  DistributeCacheInfo *server_info,const RectangleInfo *region,
  const MagickSizeType length,const unsigned char *__restrict__ pixels)
{
  MagickOffsetType
    count;
...
# 1578 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1578 "MagickCore/distribute-cache.c"
 server_info != (DistributeCacheInfo *) 
# 1578 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1578 "MagickCore/distribute-cache.c"
...
# 1578 "MagickCore/distribute-cache.c"
 "server_info != (DistributeCacheInfo *) NULL"
# 1578 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1578, __extension__ __PRETTY_FUNCTION__); }))
# 1578 "MagickCore/distribute-cache.c"
                                                    ;
  
# 1579 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1579 "MagickCore/distribute-cache.c"
 server_info->signature == 0xabacadabUL
# 1579 "MagickCore/distribute-cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1579 "MagickCore/distribute-cache.c"
...
# 1579 "MagickCore/distribute-cache.c"
 "server_info->signature == MagickCoreSignature"
# 1579 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1579, __extension__ __PRETTY_FUNCTION__); }))
# 1579 "MagickCore/distribute-cache.c"
                                                      ;
  
# 1580 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1580 "MagickCore/distribute-cache.c"
 region != (RectangleInfo *) 
# 1580 "MagickCore/distribute-cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1580 "MagickCore/distribute-cache.c"
...
# 1580 "MagickCore/distribute-cache.c"
 "region != (RectangleInfo *) NULL"
# 1580 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1580, __extension__ __PRETTY_FUNCTION__); }))
# 1580 "MagickCore/distribute-cache.c"
                                         ;
  
# 1581 "MagickCore/distribute-cache.c" 3 4
 ((void) sizeof ((
# 1581 "MagickCore/distribute-cache.c"
...
# 1581 "MagickCore/distribute-cache.c" 3 4
 , "MagickCore/distribute-cache.c", 1581, __extension__ __PRETTY_FUNCTION__); }))
# 1581 "MagickCore/distribute-cache.c"
                                               ;
  if (length > (MagickSizeType) (0x7fffffffffffffffL
# 1582 "MagickCore/distribute-cache.c"
                               ))
    return(-1);
  p=message;
  *p++='w';
