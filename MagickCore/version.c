# 0 "MagickCore/version.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/version.c"
# 39 "MagickCore/version.c"
...
# 40 "MagickCore/version.c" 2
# 1 "./MagickCore/configure.h" 1
# 21 "./MagickCore/configure.h"
...
# 49 "MagickCore/version.c" 2
# 1 "./MagickCore/utility-private.h" 1
# 21 "./MagickCore/utility-private.h"
...
# 22 "./MagickCore/utility-private.h" 2
...
# 52 "MagickCore/version.c" 2
# 76 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) const char *GetMagickCopyright(void)
{
  return("(C) 1999 ImageMagick Studio LLC");
}
# 101 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) const char *GetMagickDelegates(void)
{
  static const char
    *delegates=""
...
# 133 "MagickCore/version.c"
  ...
  " freetype"
# 175 "MagickCore/version.c"
  " lzma"
# 184 "MagickCore/version.c"
  " png"
# 209 "MagickCore/version.c"
  " x"
...
# 249 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) const char *GetMagickFeatures(void)
{
  return ""
  ...
  "HDRI "
# 304 "MagickCore/version.c"
  ;
}
# 325 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) char *GetMagickHomeURL(void)
{
  char
    path[4096];
  ...
  paths=GetConfigurePaths("index.html",exception);
  exception=DestroyExceptionInfo(exception);
  if (paths == (LinkedListInfo *) 
# 342 "MagickCore/version.c" 3 4
                                 ((void *)0)
# 342 "MagickCore/version.c"
                                     )
    return(ConstantString("file:///home/gabriel/ImageMagick/build/share/doc/ImageMagick-7/index.html"));
  element=(const char *) GetNextValueInLinkedList(paths);
  while (element != (const char *) 
# 345 "MagickCore/version.c" 3 4
                                  ((void *)0)
# 345 "MagickCore/version.c"
                                      )
  {
    (void) FormatLocaleString(path,4096,"%s%s%s",element,
      "/","index.html");
...
# 378 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) const char *GetMagickLicense(void)
{
  return("https://imagemagick.org/script/license.php");
}
# 403 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) const char *GetMagickPackageName(void)
{
  return("ImageMagick");
}
# 430 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) const char *GetMagickQuantumDepth(size_t *depth)
{
  if (depth != (size_t *) 
# 432 "MagickCore/version.c" 3 4
                         ((void *)0)
# 432 "MagickCore/version.c"
                             )
    *depth=(size_t) 16;
  return("Q16");
}
# 459 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) const char *GetMagickQuantumRange(size_t *range)
{
  if (range != (size_t *) 
# 461 "MagickCore/version.c" 3 4
                         ((void *)0)
# 461 "MagickCore/version.c"
                             )
    *range=(size_t) ((Quantum) 65535.0);
  return("65535");
}
# 486 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) const char *GetMagickReleaseDate(void)
{
  return("2024-01-07");
}
# 516 "MagickCore/version.c"
...
__attribute__ ((visibility ("default"))) unsigned int GetMagickSignature(const StringInfo *nonce)
{
  unsigned char
    *p;
  ...
  version=AcquireStringInfo(4096);
  ...
  if (nonce != (const StringInfo *) 
# 590 "MagickCore/version.c" 3 4
                                   ((void *)0)
# 590 "MagickCore/version.c"
                                       )
...
# 620 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) const char *GetMagickVersion(size_t *version)
{
  if (version != (size_t *) 
# 622 "MagickCore/version.c" 3 4
                           ((void *)0)
# 622 "MagickCore/version.c"
                               )
    *version=0x711;
  return("ImageMagick" " " "7.1.1" "-27 (Beta)" " " "Q16" "-HDRI" " " "x86_64" " " "83eefaf2a:20240107" " " "https://imagemagick.org");
}
# 651 "MagickCore/version.c"
__attribute__ ((visibility ("default"))) void ListMagickVersion(FILE *file)
{
  (void) FormatLocaleFile(file,"Version: %s\n",
    GetMagickVersion((size_t *) 
# 654 "MagickCore/version.c" 3 4
                               ((void *)0)
# 654 "MagickCore/version.c"
                                   ));;
  ...
  (void) FormatLocaleFile(file,"Compiler: gcc (%d.%d)\n",13,
    2);
# 676 "MagickCore/version.c"
  if (IsEventLogging() != MagickFalse)
    {
      (void) FormatLocaleFile(file,"Wizard attributes: ");
      (void) FormatLocaleFile(file,"QuantumRange=%g; ",(double) ((Quantum) 65535.0));
      (void) FormatLocaleFile(file,"QuantumScale=%.*g; ",GetMagickPrecision(),
        (double) ((double) 1.0/(double) ((Quantum) 65535.0)));
      (void) FormatLocaleFile(file,"MagickEpsilon=%.*g; ",GetMagickPrecision(),
        (double) 1.0e-12);
      (void) FormatLocaleFile(file,"MaxMap=%g; ",(double) 65535UL);
