...
# 61 "MagickCore/log.c" 2
# 1 "./MagickCore/thread-private.h" 1
# 21 "./MagickCore/thread-private.h"
...
# 22 "./MagickCore/thread-private.h" 2
...
static char
  log_name[4096] = "Magick";

static LinkedListInfo
  *log_cache = (LinkedListInfo *) 
# 214 "MagickCore/log.c" 3 4
                                 ((void *)0)
# 214 "MagickCore/log.c"
                                     ;
...
static SemaphoreInfo
  *log_semaphore = (SemaphoreInfo *) 
# 220 "MagickCore/log.c" 3 4
                                    ((void *)0)
# 220 "MagickCore/log.c"
                                        ;
...
static LogHandlerType
  ParseLogHandlers(const char *) __attribute__((__pure__));
...
static MagickBooleanType
  IsLogCacheInstantiated(ExceptionInfo *) __attribute__((__pure__));


static MagickBooleanType
  LoadLogCache(LinkedListInfo *,const char *,const char *,const size_t,
    ExceptionInfo *);
# 268 "MagickCore/log.c"
...
# 295 "MagickCore/log.c" 3 4
                                         ((void *)0)
# 295 "MagickCore/log.c"
                                             )
    {
  ...
  for (i=0; i < (ssize_t) (sizeof(LogMap)/sizeof(*LogMap)); i++)
  {
    ...
    if (log_info == (LogInfo *) 
# 319 "MagickCore/log.c" 3 4
                               ((void *)0)
# 319 "MagickCore/log.c"
                                   )
      {
        (void) ThrowMagickException(exception,"MagickCore/log.c",__func__,(unsigned long) 321,
    ...
    log_info->signature=0xabacadabUL;
    status&=(MagickStatusType) AppendValueToLinkedList(cache,log_info);
    if (status == MagickFalse)
      (void) ThrowMagickException(exception,"MagickCore/log.c",__func__,(unsigned long) 335,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",log_info->name);
  }
  return(cache);
}
# 359 "MagickCore/log.c"
__attribute__ ((visibility ("default"))) void CloseMagickLog(void)
{
  ExceptionInfo
    *exception;
  ...
  if (log_info->file != (FILE *) 
# 373 "MagickCore/log.c" 3 4
                                ((void *)0)
# 373 "MagickCore/log.c"
                                    )
    {
      (void) FormatLocaleFile(log_info->file,"</log>\n");
      (void) fclose(log_info->file);
      log_info->file=(FILE *) 
# 377 "MagickCore/log.c" 3 4
                             ((void *)0)
# 377 "MagickCore/log.c"
                                 ;
    }
  UnlockSemaphoreInfo(log_semaphore);
}
# 400 "MagickCore/log.c"
__attribute__ ((visibility ("default"))) LogEventType GetLogEventMask(void)
{
  ExceptionInfo
    *exception;
  ...
  log_info=GetLogInfo("*",exception);
  exception=DestroyExceptionInfo(exception);
  if (log_info == (const LogInfo *) 
# 411 "MagickCore/log.c" 3 4
                                   ((void *)0)
# 411 "MagickCore/log.c"
                                       )
    return(NoEvents);
  return(log_info->event_mask);
}
# 441 "MagickCore/log.c"
...
# 449 "MagickCore/log.c" 3 4
 ((void) sizeof ((
# 449 "MagickCore/log.c"
...
# 449 "MagickCore/log.c" 3 4
 , "MagickCore/log.c", 449, __extension__ __PRETTY_FUNCTION__); }))
# 449 "MagickCore/log.c"
                                            ;
  if (IsLogCacheInstantiated(exception) == MagickFalse)
    return((LogInfo *) 
# 451 "MagickCore/log.c" 3 4
                      ((void *)0)
# 451 "MagickCore/log.c"
                          );



  log_info=(LogInfo *) 
# 455 "MagickCore/log.c" 3 4
                      ((void *)0)
# 455 "MagickCore/log.c"
                          ;
  LockSemaphoreInfo(log_semaphore);
  p=GetHeadElementInLinkedList(log_cache);
  if ((name == (const char *) 
# 458 "MagickCore/log.c" 3 4
                             ((void *)0)
# 458 "MagickCore/log.c"
                                 ) || (LocaleCompare(name,"*") == 0))
    {
      if (p != (ElementInfo *) 
# 460 "MagickCore/log.c" 3 4
                              ((void *)0)
# 460 "MagickCore/log.c"
                                  )
  ...
  while (p != (ElementInfo *) 
# 465 "MagickCore/log.c" 3 4
                             ((void *)0)
# 465 "MagickCore/log.c"
                                 )
  {
    log_info=(LogInfo* ) p->value;
  ...
  if (p == (ElementInfo *) 
# 472 "MagickCore/log.c" 3 4
                          ((void *)0)
# 472 "MagickCore/log.c"
                              )
    log_info=(LogInfo *) 
# 473 "MagickCore/log.c" 3 4
                        ((void *)0)
# 473 "MagickCore/log.c"
                            ;
  else
...
__attribute__ ((visibility ("default"))) const LogInfo **GetLogInfoList(const char *pattern,
...
# 540 "MagickCore/log.c" 3 4
 ((void) sizeof ((
# 540 "MagickCore/log.c"
 pattern != (char *) 
# 540 "MagickCore/log.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 540 "MagickCore/log.c"
...
# 540 "MagickCore/log.c"
 "pattern != (char *) NULL"
# 540 "MagickCore/log.c" 3 4
 , "MagickCore/log.c", 540, __extension__ __PRETTY_FUNCTION__); }))
# 540 "MagickCore/log.c"
                                 ;
  
# 541 "MagickCore/log.c" 3 4
 ((void) sizeof ((
# 541 "MagickCore/log.c"
 number_preferences != (size_t *) 
# 541 "MagickCore/log.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 541 "MagickCore/log.c"
 number_preferences != (size_t *) 
# 541 "MagickCore/log.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 541 "MagickCore/log.c"
 "number_preferences != (size_t *) NULL"
# 541 "MagickCore/log.c" 3 4
 , "MagickCore/log.c", 541, __extension__ __PRETTY_FUNCTION__); }))
# 541 "MagickCore/log.c"
                                              ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/log.c",__func__,(unsigned long) 543,"%s",pattern);
  *number_preferences=0;
  if (IsLogCacheInstantiated(exception) == MagickFalse)
    return((const LogInfo **) 
# 546 "MagickCore/log.c" 3 4
                             ((void *)0)
# 546 "MagickCore/log.c"
                                 );
  preferences=(const LogInfo **) AcquireQuantumMemory((size_t)
    GetNumberOfElementsInLinkedList(log_cache)+1UL,sizeof(*preferences));
  if (preferences == (const LogInfo **) 
# 549 "MagickCore/log.c" 3 4
                                       ((void *)0)
# 549 "MagickCore/log.c"
                                           )
    return((const LogInfo **) 
# 550 "MagickCore/log.c" 3 4
                             ((void *)0)
# 550 "MagickCore/log.c"
                                 );
  LockSemaphoreInfo(log_semaphore);
  p=GetHeadElementInLinkedList(log_cache);
  for (i=0; p != (ElementInfo *) 
# 553 "MagickCore/log.c" 3 4
                                ((void *)0)
# 553 "MagickCore/log.c"
                                    ; )
  {
    const LogInfo
      *log_info;
  ...
  if (i == 0)
  ...
  else
    {
      ...
      preferences[i]=(LogInfo *) 
# 570 "MagickCore/log.c" 3 4
                                ((void *)0)
# 570 "MagickCore/log.c"
                                    ;
    }
  *number_preferences=(size_t) i;
  return(preferences);
}
# 608 "MagickCore/log.c"
...
__attribute__ ((visibility ("default"))) char **GetLogList(const char *pattern,size_t *number_preferences,
  ExceptionInfo *exception)
{
  char
    **preferences;
...
# 635 "MagickCore/log.c" 3 4
 ((void) sizeof ((
# 635 "MagickCore/log.c"
 pattern != (char *) 
# 635 "MagickCore/log.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 635 "MagickCore/log.c"
...
# 635 "MagickCore/log.c"
 "pattern != (char *) NULL"
# 635 "MagickCore/log.c" 3 4
 , "MagickCore/log.c", 635, __extension__ __PRETTY_FUNCTION__); }))
# 635 "MagickCore/log.c"
                                 ;
  
# 636 "MagickCore/log.c" 3 4
 ((void) sizeof ((
# 636 "MagickCore/log.c"
 number_preferences != (size_t *) 
# 636 "MagickCore/log.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 636 "MagickCore/log.c"
...
# 636 "MagickCore/log.c"
 "number_preferences != (size_t *) NULL"
# 636 "MagickCore/log.c" 3 4
 , "MagickCore/log.c", 636, __extension__ __PRETTY_FUNCTION__); }))
# 636 "MagickCore/log.c"
                                              ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/log.c",__func__,(unsigned long) 638,"%s",pattern);
  *number_preferences=0;
  if (IsLogCacheInstantiated(exception) == MagickFalse)
    return((char **) 
# 641 "MagickCore/log.c" 3 4
                    ((void *)0)
# 641 "MagickCore/log.c"
                        );
  preferences=(char **) AcquireQuantumMemory((size_t)
    GetNumberOfElementsInLinkedList(log_cache)+1UL,sizeof(*preferences));
  if (preferences == (char **) 
# 644 "MagickCore/log.c" 3 4
                              ((void *)0)
# 644 "MagickCore/log.c"
                                  )
    return((char **) 
# 645 "MagickCore/log.c" 3 4
                    ((void *)0)
# 645 "MagickCore/log.c"
                        );
  LockSemaphoreInfo(log_semaphore);
  p=GetHeadElementInLinkedList(log_cache);
  for (i=0; p != (ElementInfo *) 
# 648 "MagickCore/log.c" 3 4
                                ((void *)0)
# 648 "MagickCore/log.c"
                                    ; )
  {
    const LogInfo
      *log_info;
  ...
  if (i == 0)
  ...
  else
    {
      ...
      preferences[i]=(char *) 
# 665 "MagickCore/log.c" 3 4
                             ((void *)0)
# 665 "MagickCore/log.c"
                                 ;
    }
  *number_preferences=(size_t) i;
  return(preferences);
}
# 689 "MagickCore/log.c"
__attribute__ ((visibility ("default"))) const char *GetLogName(void)
{
  return(log_name);
}
# 718 "MagickCore/log.c"
static inline void CheckEventLogging(void)
{
  ...
  if (IsLinkedListEmpty(log_cache) != MagickFalse)
  ...
  else
    {
      ...
      p=GetHeadElementInLinkedList(log_cache);
      event_logging=(p != (ElementInfo *) 
# 731 "MagickCore/log.c" 3 4
                                         ((void *)0)
# 731 "MagickCore/log.c"
                                             ) &&
...
{
  if (log_cache == (LinkedListInfo *) 
# 739 "MagickCore/log.c" 3 4
                                     ((void *)0)
# 739 "MagickCore/log.c"
                                         )
    {
      if (log_semaphore == (SemaphoreInfo *) 
# 741 "MagickCore/log.c" 3 4
                                            ((void *)0)
# 741 "MagickCore/log.c"
                                                )
        ActivateSemaphoreInfo(&log_semaphore);
      LockSemaphoreInfo(log_semaphore);
      if (log_cache == (LinkedListInfo *) 
# 744 "MagickCore/log.c" 3 4
                                         ((void *)0)
# 744 "MagickCore/log.c"
                                             )
        {
          log_cache=AcquireLogCache("log.xml",exception);
          CheckEventLogging();
        }
      UnlockSemaphoreInfo(log_semaphore);
    }
  return(log_cache != (LinkedListInfo *) 
# 751 "MagickCore/log.c" 3 4
                                        ((void *)0) 
# 751 "MagickCore/log.c"
                                             ? MagickTrue : MagickFalse);
}
# 773 "MagickCore/log.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsEventLogging(void)
{
  return(event_logging);
}
# 802 "MagickCore/log.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListLogInfo(FILE *file,ExceptionInfo *exception)
{
  ...
  if (file == (const FILE *) 
# 821 "MagickCore/log.c" 3 4
                            ((void *)0)
# 821 "MagickCore/log.c"
                                )
    file=
# 822 "MagickCore/log.c" 3 4
        stdout
# 822 "MagickCore/log.c"
              ;
  log_info=GetLogInfoList("*",&number_aliases,exception);
  if (log_info == (const LogInfo **) 
# 824 "MagickCore/log.c" 3 4
                                    ((void *)0)
# 824 "MagickCore/log.c"
                                        )
    return(MagickFalse);
  j=0;
  path=(const char *) 
# 827 "MagickCore/log.c" 3 4
                     ((void *)0)
# 827 "MagickCore/log.c"
                         ;
  for (i=0; i < (ssize_t) number_aliases; i++)
  {
    if (log_info[i]->stealth != MagickFalse)
      continue;
    if ((path == (const char *) 
# 832 "MagickCore/log.c" 3 4
                               ((void *)0)
# 832 "MagickCore/log.c"
                                   ) ||
        (LocaleCompare(path,log_info[i]->path) != 0))
      {
        ...
        if (log_info[i]->path != (char *) 
# 838 "MagickCore/log.c" 3 4
                                         ((void *)0)
# 838 "MagickCore/log.c"
                                             )
    ...
    if (log_info[i]->filename != (char *) 
# 863 "MagickCore/log.c" 3 4
                                         ((void *)0)
# 863 "MagickCore/log.c"
                                             )
      {
    ...
    if (log_info[i]->format != (char *) 
# 871 "MagickCore/log.c" 3 4
                                       ((void *)0)
# 871 "MagickCore/log.c"
                                           )
  ...
  const char *filename,const size_t depth,ExceptionInfo *exception)
{
  ...
  LogInfo
    *log_info = (LogInfo *) 
# 922 "MagickCore/log.c" 3 4
                           ((void *)0)
# 922 "MagickCore/log.c"
                               ;
  ...
  if (xml == (const char *) 
# 933 "MagickCore/log.c" 3 4
                           ((void *)0)
# 933 "MagickCore/log.c"
                               )
    return(MagickFalse);
  status=MagickTrue;
    ...
    if (LocaleCompare(keyword,"<include") == 0)
      {
        ...
        while (((*token != '/') && (*(token+1) != '>')) && (*q != '\0'))
        {
          ...
          if (LocaleCompare(keyword,"file") == 0)
            {
              if (depth > 600)
                (void) ThrowMagickException(exception,"MagickCore/log.c",__func__,(unsigned long) 980,
              ...
              else
                {
                  ...
                  if (file_xml != (char *) 
# 997 "MagickCore/log.c" 3 4
                                          ((void *)0)
# 997 "MagickCore/log.c"
                                              )
                    {
    ...
    if (log_info == (LogInfo *) 
# 1020 "MagickCore/log.c" 3 4
                               ((void *)0)
# 1020 "MagickCore/log.c"
                                   )
      continue;
    if (LocaleCompare(keyword,"</logmap>") == 0)
      {
        ...
        if (status == MagickFalse)
          (void) ThrowMagickException(exception,"MagickCore/log.c",__func__,(unsigned long) 1026,
            ResourceLimitError,"MemoryAllocationFailed","`%s'",filename);
        log_info=(LogInfo *) 
# 1028 "MagickCore/log.c" 3 4
                            ((void *)0)
# 1028 "MagickCore/log.c"
                                ;
        continue;
      }
    (void) GetNextToken(q,(const char **) 
# 1031 "MagickCore/log.c" 3 4
                                         ((void *)0)
# 1031 "MagickCore/log.c"
                                             ,extent,token);
    if (*token != '=')
      continue;
    (void) GetNextToken(q,&q,extent,token);
    ...
    switch (*keyword)
    {
      ...
      case 'f':
      {
        if (LocaleCompare((char *) keyword,"filename") == 0)
          {
            if (log_info->filename != (char *) 
# 1054 "MagickCore/log.c" 3 4
                                              ((void *)0)
# 1054 "MagickCore/log.c"
                                                  )
        ...
        if (LocaleCompare((char *) keyword,"format") == 0)
          {
            if (log_info->format != (char *) 
# 1062 "MagickCore/log.c" 3 4
                                            ((void *)0)
# 1062 "MagickCore/log.c"
                                                )
  ...
  if (cache == (LinkedListInfo *) 
# 1116 "MagickCore/log.c" 3 4
                                 ((void *)0)
# 1116 "MagickCore/log.c"
                                     )
    return(MagickFalse);
  return(status != 0 ? MagickTrue : MagickFalse);
}
# 1140 "MagickCore/log.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType LogComponentGenesis(void)
{
  ExceptionInfo
    *exception;

  if (log_semaphore == (SemaphoreInfo *) 
# 1145 "MagickCore/log.c" 3 4
                                        ((void *)0)
# 1145 "MagickCore/log.c"
                                            )
...
static void *DestroyLogElement(void *log_info)
{
  ...
  p=(LogInfo *) log_info;
  if (p->file != (FILE *) 
# 1178 "MagickCore/log.c" 3 4
                         ((void *)0)
# 1178 "MagickCore/log.c"
                             )
    {
      (void) FormatLocaleFile(p->file,"</log>\n");
      (void) fclose(p->file);
      p->file=(FILE *) 
# 1182 "MagickCore/log.c" 3 4
                      ((void *)0)
# 1182 "MagickCore/log.c"
                          ;
    }
  if (p->format != (char *) 
# 1184 "MagickCore/log.c" 3 4
                           ((void *)0)
# 1184 "MagickCore/log.c"
                               )
    p->format=DestroyString(p->format);
  if (p->path != (char *) 
# 1186 "MagickCore/log.c" 3 4
                         ((void *)0)
# 1186 "MagickCore/log.c"
                             )
    p->path=DestroyString(p->path);
  if (p->filename != (char *) 
# 1188 "MagickCore/log.c" 3 4
                             ((void *)0)
# 1188 "MagickCore/log.c"
                                 )
    p->filename=DestroyString(p->filename);
  if (p->event_semaphore != (SemaphoreInfo *) 
# 1190 "MagickCore/log.c" 3 4
                                             ((void *)0)
# 1190 "MagickCore/log.c"
                                                 )
    RelinquishSemaphoreInfo(&p->event_semaphore);
  p=(LogInfo *) RelinquishMagickMemory(p);
  return((void *) 
# 1193 "MagickCore/log.c" 3 4
                 ((void *)0)
# 1193 "MagickCore/log.c"
                     );
}

__attribute__ ((visibility ("hidden"))) void LogComponentTerminus(void)
{
  if (log_semaphore == (SemaphoreInfo *) 
# 1198 "MagickCore/log.c" 3 4
                                        ((void *)0)
# 1198 "MagickCore/log.c"
                                            )
    ActivateSemaphoreInfo(&log_semaphore);
  LockSemaphoreInfo(log_semaphore);
  if (log_cache != (LinkedListInfo *) 
# 1201 "MagickCore/log.c" 3 4
                                     ((void *)0)
# 1201 "MagickCore/log.c"
                                         )
  ...
  const size_t line,const char *domain,const char *event)
{
  ...
  if (log_info->format == (char *) 
# 1277 "MagickCore/log.c" 3 4
                                  ((void *)0)
# 1277 "MagickCore/log.c"
                                      )
    return(text);
  extent=strlen(event)+4096;
  ...
  {
    *q='\0';
    if ((size_t) (q-text+4096) >= extent)
      {
        extent+=4096;
        text=(char *) ResizeQuantumMemory(text,extent+4096,
          sizeof(*text));
        if (text == (char *) 
# 1320 "MagickCore/log.c" 3 4
                            ((void *)0)
# 1320 "MagickCore/log.c"
                                )
          return((char *) 
# 1321 "MagickCore/log.c" 3 4
                         ((void *)0)
# 1321 "MagickCore/log.c"
                             );
        q=text+strlen(text);
      }
# 1345 "MagickCore/log.c"
    if ((*p == '\\') && (*(p+1) == 'r'))
      {
        *q++='\r';
        p++;
    ...
    switch (*p)
    {
      ...
      case 'v':
      {
        q+=CopyMagickString(q,"7.1.1",extent);
        break;
      }
      case '%':
      {
...
# 1490 "MagickCore/log.c" 3 4
 ((void) sizeof ((
# 1490 "MagickCore/log.c"
 log_info != (LogInfo *) 
# 1490 "MagickCore/log.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1490 "MagickCore/log.c"
...
# 1490 "MagickCore/log.c" 3 4
 , "MagickCore/log.c", 1490, __extension__ __PRETTY_FUNCTION__); }))
# 1490 "MagickCore/log.c"
                                     ;
  
# 1491 "MagickCore/log.c" 3 4
 ((void) sizeof ((
# 1491 "MagickCore/log.c"
 log_info->filename != (char *) 
# 1491 "MagickCore/log.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1491 "MagickCore/log.c"
...
# 1491 "MagickCore/log.c" 3 4
 , "MagickCore/log.c", 1491, __extension__ __PRETTY_FUNCTION__); }))
# 1491 "MagickCore/log.c"
                                            ;
  filename=AcquireString((char *) 
# 1492 "MagickCore/log.c" 3 4
                                 ((void *)0)
# 1492 "MagickCore/log.c"
                                     );
  extent=4096;
  q=filename;
  ...
  {
    *q='\0';
    if ((size_t) (q-filename+4096) >= extent)
      {
        extent+=4096;
        filename=(char *) ResizeQuantumMemory(filename,extent+4096,
          sizeof(*filename));
        if (filename == (char *) 
# 1503 "MagickCore/log.c" 3 4
                                ((void *)0)
# 1503 "MagickCore/log.c"
                                    )
          return((char *) 
# 1504 "MagickCore/log.c" 3 4
                         ((void *)0)
# 1504 "MagickCore/log.c"
                             );
        q=filename+strlen(filename);
      }
# 1517 "MagickCore/log.c"
    if (*p != '%')
      {
        *q++=(*p);
        continue;
...
__attribute__ ((visibility ("default"))) MagickBooleanType LogMagickEventList(const LogEventType type,
  ...
  va_list operands)
{
  ...
  exception=DestroyExceptionInfo(exception);
  if (log_info->event_semaphore == (SemaphoreInfo *) 
# 1604 "MagickCore/log.c" 3 4
                                                    ((void *)0)
# 1604 "MagickCore/log.c"
                                                        )
  ...
  n=vsnprintf(event,4096,format,operands);
  ...
  if (text == (char *) 
# 1621 "MagickCore/log.c" 3 4
                      ((void *)0)
# 1621 "MagickCore/log.c"
                          )
    {
...
# 1629 "MagickCore/log.c" 3 4
                             stderr
# 1629 "MagickCore/log.c"
                                   ,"%s\n",text);
      (void) fflush(
# 1630 "MagickCore/log.c" 3 4
                   stderr
# 1630 "MagickCore/log.c"
                         );
    }
  ...
  if ((log_info->handler_mask & FileHandler) != 0)
    {
      ...
      file_info.st_size=0;
      if (log_info->file != (FILE *) 
# 1651 "MagickCore/log.c" 3 4
                                    ((void *)0)
# 1651 "MagickCore/log.c"
                                        )
      ...
      if (file_info.st_size > (MagickOffsetType) (1024*1024*log_info->limit))
        {
          ...
          (void) fclose(log_info->file);
          log_info->file=(FILE *) 
# 1657 "MagickCore/log.c" 3 4
                                 ((void *)0)
# 1657 "MagickCore/log.c"
                                     ;
        }
      if (log_info->file == (FILE *) 
# 1659 "MagickCore/log.c" 3 4
                                    ((void *)0)
# 1659 "MagickCore/log.c"
                                        )
        {
          char
            *filename;
          ...
          if (filename == (char *) 
# 1665 "MagickCore/log.c" 3 4
                                  ((void *)0)
# 1665 "MagickCore/log.c"
                                      )
            {
              (void) ContinueTimer((TimerInfo *) &log_info->timer);
              UnlockSemaphoreInfo(log_info->event_semaphore);
          ...
          if (log_info->file == (FILE *) 
# 1674 "MagickCore/log.c" 3 4
                                        ((void *)0)
# 1674 "MagickCore/log.c"
                                            )
            {
              UnlockSemaphoreInfo(log_info->event_semaphore);
              return(MagickFalse);
  ...
  if ((log_info->handler_mask & MethodHandler) != 0)
    {
      if (log_info->method != (MagickLogMethod) 
# 1690 "MagickCore/log.c" 3 4
                                               ((void *)0)
# 1690 "MagickCore/log.c"
                                                   )
  ...
  if ((log_info->handler_mask & StdoutHandler) != 0)
    {
      (void) FormatLocaleFile(
# 1695 "MagickCore/log.c" 3 4
                             stdout
# 1695 "MagickCore/log.c"
                                   ,"%s\n",text);
      (void) fflush(
# 1696 "MagickCore/log.c" 3 4
                   stdout
# 1696 "MagickCore/log.c"
                         );
    }
  if ((log_info->handler_mask & StderrHandler) != 0)
    {
      (void) FormatLocaleFile(
# 1700 "MagickCore/log.c" 3 4
                             stderr
# 1700 "MagickCore/log.c"
                                   ,"%s\n",text);
      (void) fflush(
# 1701 "MagickCore/log.c" 3 4
                   stderr
# 1701 "MagickCore/log.c"
                         );
    }
...
__attribute__ ((visibility ("default"))) MagickBooleanType LogMagickEvent(const LogEventType type,
...
# 1721 "MagickCore/log.c" 3 4
 __builtin_va_start(
# 1721 "MagickCore/log.c"
 operands
# 1721 "MagickCore/log.c" 3 4
 ,
# 1721 "MagickCore/log.c"
...
# 1723 "MagickCore/log.c" 3 4
 __builtin_va_end(
# 1723 "MagickCore/log.c"
 operands
# 1723 "MagickCore/log.c" 3 4
 )
# 1723 "MagickCore/log.c"
...
static LogHandlerType ParseLogHandlers(const char *handlers)
{
  ...
  for (p=handlers; p != (char *) 
# 1766 "MagickCore/log.c" 3 4
                                ((void *)0)
# 1766 "MagickCore/log.c"
                                    ; p=strchr(p,','))
  {
    while ((*p != '\0') && ((
# 1768 "MagickCore/log.c" 3 4
                            ((*__ctype_b_loc ())[(int) ((
# 1768 "MagickCore/log.c"
                            (int) ((unsigned char) *p)
# 1768 "MagickCore/log.c" 3 4
                            ))] & (unsigned short int) _ISspace) 
# 1768 "MagickCore/log.c"
...
# 1811 "MagickCore/log.c"
__attribute__ ((visibility ("default"))) LogEventType SetLogEventMask(const char *events)
{
  ExceptionInfo
    *exception;
  ...
  exception=DestroyExceptionInfo(exception);
  if (log_info == (LogInfo *) 
# 1829 "MagickCore/log.c" 3 4
                             ((void *)0)
# 1829 "MagickCore/log.c"
                                 )
    return(event_mask);
...
# 1865 "MagickCore/log.c"
__attribute__ ((visibility ("default"))) void SetLogFormat(const char *format)
{
  LogInfo
    *log_info;
  ...
  exception=DestroyExceptionInfo(exception);
  if (log_info == (LogInfo *) 
# 1876 "MagickCore/log.c" 3 4
                             ((void *)0)
# 1876 "MagickCore/log.c"
                                 )
    return;
  LockSemaphoreInfo(log_semaphore);
  if (log_info->format != (char *) 
# 1879 "MagickCore/log.c" 3 4
                                  ((void *)0)
# 1879 "MagickCore/log.c"
                                      )
    log_info->format=DestroyString(log_info->format);
  log_info->format=ConstantString(format);
  UnlockSemaphoreInfo(log_semaphore);
}
# 1908 "MagickCore/log.c"
__attribute__ ((visibility ("default"))) void SetLogMethod(MagickLogMethod method)
{
  ExceptionInfo
    *exception;
...
# 1951 "MagickCore/log.c"
__attribute__ ((visibility ("default"))) const char *SetLogName(const char *name)
{
  if ((name != (char *) 
# 1953 "MagickCore/log.c" 3 4
                       ((void *)0)
# 1953 "MagickCore/log.c"
                           ) && (*name != '\0'))
    (void) CopyMagickString(log_name,name,4096);
  return(log_name);
}
