# 0 "MagickCore/shear.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/shear.c"
# 47 "MagickCore/shear.c"
...
# 82 "MagickCore/shear.c" 2
# 113 "MagickCore/shear.c"
  ...
  const MagickBooleanType rotate,ExceptionInfo *exception)
{
  ...
  if (crop_image == (Image *) 
# 173 "MagickCore/shear.c" 3 4
                             ((void *)0)
# 173 "MagickCore/shear.c"
                                 )
    return(MagickFalse);
  ...
  const double threshold,size_t *projection,ExceptionInfo *exception)
{
  ...
  if ((source_matrices == (MatrixInfo *) 
# 353 "MagickCore/shear.c" 3 4
                                        ((void *)0)
# 353 "MagickCore/shear.c"
                                            ) ||
      (destination_matrices == (MatrixInfo *) 
# 354 "MagickCore/shear.c" 3 4
                                             ((void *)0)
# 354 "MagickCore/shear.c"
                                                 ))
    {
      if (destination_matrices != (MatrixInfo *) 
# 356 "MagickCore/shear.c" 3 4
                                                ((void *)0)
# 356 "MagickCore/shear.c"
                                                    )
        destination_matrices=DestroyMatrixInfo(destination_matrices);
      if (source_matrices != (MatrixInfo *) 
# 358 "MagickCore/shear.c" 3 4
                                           ((void *)0)
# 358 "MagickCore/shear.c"
                                               )
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 400 "MagickCore/shear.c" 3 4
                              ((void *)0)
# 400 "MagickCore/shear.c"
                                  )
      {
        status=MagickFalse;
        continue;
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    p=GetCacheViewVirtualPixels(image_view,0,y,image->columns,1,exception);
    if (p == (const Quantum *) 
# 457 "MagickCore/shear.c" 3 4
                              ((void *)0)
# 457 "MagickCore/shear.c"
                                  )
      {
        status=MagickFalse;
        continue;
  ...
  ExceptionInfo *exception)
{
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    p=GetCacheViewVirtualPixels(image_view,0,y,image->columns,1,exception);
    if (p == (const Quantum *) 
# 530 "MagickCore/shear.c" 3 4
                              ((void *)0)
# 530 "MagickCore/shear.c"
                                  )
      continue;
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      if ((x >= offset) && (x < ((ssize_t) image->columns-offset)))
        continue;
      background.red+=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelRed(image,p);
      background.green+=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelGreen(image,p);
      background.blue+=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelBlue(image,p);
      if ((GetPixelAlphaTraits(image) & UpdatePixelTrait) != 0)
        background.alpha+=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelAlpha(image,p);
      count++;
      p+=GetPixelChannels(image);
    }
  }
  image_view=DestroyCacheView(image_view);
  image->background_color.red=(double) ClampToQuantum((double) ((Quantum) 65535.0)*
    (double) background.red/count);
  image->background_color.green=(double) ClampToQuantum((double) ((Quantum) 65535.0)*
    (double) background.green/count);
  image->background_color.blue=(double) ClampToQuantum((double) ((Quantum) 65535.0)*
    (double) background.blue/count);
  if ((GetPixelAlphaTraits(image) & UpdatePixelTrait) != 0)
    image->background_color.alpha=(double) ClampToQuantum((double) ((Quantum) 65535.0)*
      (double) background.alpha/count);
}

__attribute__ ((visibility ("default"))) Image *DeskewImage(const Image *image,const double threshold,
  ExceptionInfo *exception)
{
  AffineMatrix
    affine_matrix;
  ...
  projection=(size_t *) AcquireQuantumMemory((size_t) (2*width-1),
    sizeof(*projection));
  if (projection == (size_t *) 
# 596 "MagickCore/shear.c" 3 4
                              ((void *)0)
# 596 "MagickCore/shear.c"
                                  )
    { (void) ThrowMagickException(exception,"MagickCore/shear.c",__func__,(unsigned long) 597,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 597 "MagickCore/shear.c" 3 4
   ((void *)0)
# 597 "MagickCore/shear.c"
   ); };
  status=RadonTransform(image,threshold,projection,exception);
  if (status == MagickFalse)
    {
      projection=(size_t *) RelinquishMagickMemory(projection);
      { (void) ThrowMagickException(exception,"MagickCore/shear.c",__func__,(unsigned long) 602,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 602 "MagickCore/shear.c" 3 4
     ((void *)0)
# 602 "MagickCore/shear.c"
     ); };
    }
  max_projection=0;
  skew=0;
  ...
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(TransformEvent,"MagickCore/shear.c",__func__,(unsigned long) 617,
...
# 623 "MagickCore/shear.c" 3 4
                              ((void *)0)
# 623 "MagickCore/shear.c"
                                  )
    return((Image *) 
# 624 "MagickCore/shear.c" 3 4
                    ((void *)0)
# 624 "MagickCore/shear.c"
                        );
  {
    char
      angle[4096];

    (void) FormatLocaleString(angle,4096,"%.20g",degrees);
  ...
  deskew_image=AffineTransformImage(clone_image,&affine_matrix,exception);
  clone_image=DestroyImage(clone_image);
  if (deskew_image == (Image *) 
# 654 "MagickCore/shear.c" 3 4
                               ((void *)0)
# 654 "MagickCore/shear.c"
                                   )
    return((Image *) 
# 655 "MagickCore/shear.c" 3 4
                    ((void *)0)
# 655 "MagickCore/shear.c"
                        );
  median_image=StatisticImage(deskew_image,MedianStatistic,3,3,exception);
  if (median_image == (Image *) 
# 657 "MagickCore/shear.c" 3 4
                               ((void *)0)
# 657 "MagickCore/shear.c"
                                   )
    {
      deskew_image=DestroyImage(deskew_image);
      return((Image *) 
# 660 "MagickCore/shear.c" 3 4
                      ((void *)0)
# 660 "MagickCore/shear.c"
                          );
    }
  geometry=GetImageBoundingBox(median_image,exception);
  median_image=DestroyImage(median_image);
  if (image->debug != MagickFalse)
    (void) LogMagickEvent(TransformEvent,"MagickCore/shear.c",__func__,(unsigned long) 665,"  Deskew geometry: "
...
# 700 "MagickCore/shear.c"
__attribute__ ((visibility ("default"))) Image *IntegralRotateImage(const Image *image,size_t rotations,
  ExceptionInfo *exception)
{
...
# 724 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 724 "MagickCore/shear.c"
 image != (Image *) 
# 724 "MagickCore/shear.c" 3 4
...
# 724 "MagickCore/shear.c"
 "image != (Image *) NULL"
# 724 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 724, __extension__ __PRETTY_FUNCTION__); }))
# 724 "MagickCore/shear.c"
                                ;
  page=image->page;
  rotations%=4;
...
# 749 "MagickCore/shear.c" 3 4
                               ((void *)0)
# 749 "MagickCore/shear.c"
                                   )
    return((Image *) 
# 750 "MagickCore/shear.c" 3 4
                    ((void *)0)
# 750 "MagickCore/shear.c"
                        );
  if (rotations == 0)
    return(rotate_image);
      ...
      for (tile_y=0; tile_y < (ssize_t) image->rows; tile_y+=(ssize_t) tile_height)
      {
        ...
        for ( ; tile_x < (ssize_t) image->columns; tile_x+=(ssize_t) tile_width)
        {
          ...
          p=GetCacheViewVirtualPixels(image_view,tile_x,tile_y,width,height,
            exception);
          if (p == (const Quantum *) 
# 816 "MagickCore/shear.c" 3 4
                                    ((void *)0)
# 816 "MagickCore/shear.c"
                                        )
            {
              status=MagickFalse;
              break;
          ...
          for (y=0; y < (ssize_t) width; y++)
          {
            ...
            q=QueueCacheViewAuthenticPixels(rotate_view,(ssize_t)
              ...
              1,exception);
            if (q == (Quantum *) 
# 834 "MagickCore/shear.c" 3 4
                                ((void *)0)
# 834 "MagickCore/shear.c"
                                    )
              {
                status=MagickFalse;
                continue;
...
# 865 "MagickCore/shear.c" 3 4
                                                              ((void *)0)
# 865 "MagickCore/shear.c"
                                                                  )
          {
            MagickBooleanType
              proceed;

            proceed=SetImageProgress(image,"Rotate/Image",
              progress+=(MagickOffsetType) tile_height,image->rows);
            if (proceed == MagickFalse)
              status=MagickFalse;
          }
      }
      (void) SetImageProgress(image,"Rotate/Image",(MagickOffsetType)
...
# 896 "MagickCore/shear.c"
      for (y=0; y < (ssize_t) image->rows; y++)
      {
        ...
        if ((p == (const Quantum *) 
# 915 "MagickCore/shear.c" 3 4
                                   ((void *)0)
# 915 "MagickCore/shear.c"
                                       ) || (q == (Quantum *) 
# 915 "MagickCore/shear.c" 3 4
                                                              ((void *)0)
# 915 "MagickCore/shear.c"
        ...
        if (sync == MagickFalse)
          status=MagickFalse;
        if (image->progress_monitor != (MagickProgressMonitor) 
# 943 "MagickCore/shear.c" 3 4
                                                              ((void *)0)
# 943 "MagickCore/shear.c"
                                                                  )
          {
            MagickBooleanType
              proceed;

            proceed=SetImageProgress(image,"Rotate/Image",progress++,
              image->rows);
            if (proceed == MagickFalse)
              status=MagickFalse;
          }
      ...
      for (tile_y=0; tile_y < (ssize_t) image->rows; tile_y+=(ssize_t) tile_height)
      {
        ...
        for ( ; tile_x < (ssize_t) image->columns; tile_x+=(ssize_t) tile_width)
        {
          ...
          p=GetCacheViewVirtualPixels(image_view,tile_x,tile_y,width,height,
            exception);
          if (p == (const Quantum *) 
# 1016 "MagickCore/shear.c" 3 4
                                    ((void *)0)
# 1016 "MagickCore/shear.c"
                                        )
            {
              status=MagickFalse;
              break;
          ...
          for (y=0; y < (ssize_t) width; y++)
          {
            ...
            if (q == (Quantum *) 
# 1033 "MagickCore/shear.c" 3 4
                                ((void *)0)
# 1033 "MagickCore/shear.c"
                                    )
              {
                status=MagickFalse;
                continue;
        ...
        if (image->progress_monitor != (MagickProgressMonitor) 
# 1067 "MagickCore/shear.c" 3 4
                                                              ((void *)0)
# 1067 "MagickCore/shear.c"
                                                                  )
          {
            MagickBooleanType
              proceed;
...
# 1164 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1164 "MagickCore/shear.c"
 image != (Image *) 
# 1164 "MagickCore/shear.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1164 "MagickCore/shear.c"
...
# 1164 "MagickCore/shear.c"
 "image != (Image *) NULL"
# 1164 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1164, __extension__ __PRETTY_FUNCTION__); }))
# 1164 "MagickCore/shear.c"
                                ;
  
# 1165 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1165 "MagickCore/shear.c"
...
# 1165 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1165, __extension__ __PRETTY_FUNCTION__); }))
# 1165 "MagickCore/shear.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/shear.c",__func__,(unsigned long) 1167,"%s",image->filename);
  status=MagickTrue;
  ...
  for (y=0; y < (ssize_t) height; y++)
  {
    ...
    p=GetCacheViewAuthenticPixels(image_view,0,y_offset+y,image->columns,1,
      exception);
    if (p == (Quantum *) 
# 1202 "MagickCore/shear.c" 3 4
                        ((void *)0)
# 1202 "MagickCore/shear.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1295 "MagickCore/shear.c" 3 4
                                                          ((void *)0)
# 1295 "MagickCore/shear.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 1379 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1379 "MagickCore/shear.c"
 image != (Image *) 
# 1379 "MagickCore/shear.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1379 "MagickCore/shear.c"
...
# 1379 "MagickCore/shear.c"
 "image != (Image *) NULL"
# 1379 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1379, __extension__ __PRETTY_FUNCTION__); }))
# 1379 "MagickCore/shear.c"
                                ;
  
# 1380 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1380 "MagickCore/shear.c"
 image->signature == 0xabacadabUL
# 1380 "MagickCore/shear.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1380 "MagickCore/shear.c"
...
# 1380 "MagickCore/shear.c"
 "image->signature == MagickCoreSignature"
# 1380 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1380, __extension__ __PRETTY_FUNCTION__); }))
# 1380 "MagickCore/shear.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/shear.c",__func__,(unsigned long) 1382,"%s",image->filename);
  status=MagickTrue;
  progress=0;
  background=image->background_color;
  image_view=AcquireAuthenticCacheView(image,exception);
  ...
  for (x=0; x < (ssize_t) width; x++)
  {
    ...
    p=GetCacheViewAuthenticPixels(image_view,x_offset+x,0,1,image->rows,
      exception);
    if (p == (Quantum *) 
# 1417 "MagickCore/shear.c" 3 4
                        ((void *)0)
# 1417 "MagickCore/shear.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1512 "MagickCore/shear.c" 3 4
                                                          ((void *)0)
# 1512 "MagickCore/shear.c"
                                                              )
      {
        MagickBooleanType
          proceed;
...
# 1569 "MagickCore/shear.c"
__attribute__ ((visibility ("default"))) Image *ShearImage(const Image *image,const double x_shear,
...
# 1586 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1586 "MagickCore/shear.c"
 image != (Image *) 
# 1586 "MagickCore/shear.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1586 "MagickCore/shear.c"
...
# 1586 "MagickCore/shear.c"
 "image != (Image *) NULL"
# 1586 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1586, __extension__ __PRETTY_FUNCTION__); }))
# 1586 "MagickCore/shear.c"
                                ;
  
# 1587 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1587 "MagickCore/shear.c"
 image->signature == 0xabacadabUL
# 1587 "MagickCore/shear.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1587 "MagickCore/shear.c"
...
# 1587 "MagickCore/shear.c"
 "image->signature == MagickCoreSignature"
# 1587 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1587, __extension__ __PRETTY_FUNCTION__); }))
# 1587 "MagickCore/shear.c"
                                                ;
  
# 1588 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1588 "MagickCore/shear.c"
...
# 1588 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1588, __extension__ __PRETTY_FUNCTION__); }))
# 1588 "MagickCore/shear.c"
                                            ;
  
# 1589 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1589 "MagickCore/shear.c"
...
# 1589 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1589, __extension__ __PRETTY_FUNCTION__); }))
# 1589 "MagickCore/shear.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/shear.c",__func__,(unsigned long) 1591,"%s",image->filename);
  if ((x_shear != 0.0) && (fmod(x_shear,90.0) == 0.0))
    { (void) ThrowMagickException(exception,"MagickCore/shear.c",__func__,(unsigned long) 1593,ImageError,"AngleIsDiscontinuous", "`%s'",image->filename); return((Image *) 
# 1593 "MagickCore/shear.c" 3 4
   ((void *)0)
# 1593 "MagickCore/shear.c"
   ); };
  if ((y_shear != 0.0) && (fmod(y_shear,90.0) == 0.0))
    { (void) ThrowMagickException(exception,"MagickCore/shear.c",__func__,(unsigned long) 1595,ImageError,"AngleIsDiscontinuous", "`%s'",image->filename); return((Image *) 
# 1595 "MagickCore/shear.c" 3 4
   ((void *)0)
# 1595 "MagickCore/shear.c"
   ); };



  integral_image=CloneImage(image,0,0,MagickTrue,exception);
  if (integral_image == (Image *) 
# 1600 "MagickCore/shear.c" 3 4
                                 ((void *)0)
# 1600 "MagickCore/shear.c"
                                     )
    { (void) ThrowMagickException(exception,"MagickCore/shear.c",__func__,(unsigned long) 1601,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 1601 "MagickCore/shear.c" 3 4
   ((void *)0)
# 1601 "MagickCore/shear.c"
   ); };
...
# 1631 "MagickCore/shear.c" 3 4
                              ((void *)0)
# 1631 "MagickCore/shear.c"
                                  )
    { (void) ThrowMagickException(exception,"MagickCore/shear.c",__func__,(unsigned long) 1632,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 1632 "MagickCore/shear.c" 3 4
   ((void *)0)
# 1632 "MagickCore/shear.c"
   ); };
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 1643 "MagickCore/shear.c" 3 4
                      ((void *)0)
# 1643 "MagickCore/shear.c"
                          );
    }
  ...
  if (status == MagickFalse)
    {
      shear_image=DestroyImage(shear_image);
      return((Image *) 
# 1650 "MagickCore/shear.c" 3 4
                      ((void *)0)
# 1650 "MagickCore/shear.c"
                          );
    }
...
# 1702 "MagickCore/shear.c"
__attribute__ ((visibility ("default"))) Image *ShearRotateImage(const Image *image,const double degrees,
  ExceptionInfo *exception)
{
  Image
    *integral_image,
...
# 1731 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1731 "MagickCore/shear.c"
 image != (Image *) 
# 1731 "MagickCore/shear.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1731 "MagickCore/shear.c"
...
# 1731 "MagickCore/shear.c"
 "image != (Image *) NULL"
# 1731 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1731, __extension__ __PRETTY_FUNCTION__); }))
# 1731 "MagickCore/shear.c"
                                ;
  
# 1732 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1732 "MagickCore/shear.c"
 image->signature == 0xabacadabUL
# 1732 "MagickCore/shear.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1732 "MagickCore/shear.c"
...
# 1732 "MagickCore/shear.c"
 "image->signature == MagickCoreSignature"
# 1732 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1732, __extension__ __PRETTY_FUNCTION__); }))
# 1732 "MagickCore/shear.c"
                                                ;
  
# 1733 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1733 "MagickCore/shear.c"
 exception != (ExceptionInfo *) 
# 1733 "MagickCore/shear.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1733 "MagickCore/shear.c"
...
# 1733 "MagickCore/shear.c"
 "exception != (ExceptionInfo *) NULL"
# 1733 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1733, __extension__ __PRETTY_FUNCTION__); }))
# 1733 "MagickCore/shear.c"
                                            ;
  
# 1734 "MagickCore/shear.c" 3 4
 ((void) sizeof ((
# 1734 "MagickCore/shear.c"
 exception->signature == 0xabacadabUL
# 1734 "MagickCore/shear.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1734 "MagickCore/shear.c"
...
# 1734 "MagickCore/shear.c"
 "exception->signature == MagickCoreSignature"
# 1734 "MagickCore/shear.c" 3 4
 , "MagickCore/shear.c", 1734, __extension__ __PRETTY_FUNCTION__); }))
# 1734 "MagickCore/shear.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/shear.c",__func__,(unsigned long) 1736,"%s",image->filename);
  ...
  if (integral_image == (Image *) 
# 1747 "MagickCore/shear.c" 3 4
                                 ((void *)0)
# 1747 "MagickCore/shear.c"
                                     )
    { (void) ThrowMagickException(exception,"MagickCore/shear.c",__func__,(unsigned long) 1748,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 1748 "MagickCore/shear.c" 3 4
   ((void *)0)
# 1748 "MagickCore/shear.c"
   ); };
  ...
  integral_image=DestroyImage(integral_image);
  if (rotate_image == (Image *) 
# 1783 "MagickCore/shear.c" 3 4
                               ((void *)0)
# 1783 "MagickCore/shear.c"
                                   )
    { (void) ThrowMagickException(exception,"MagickCore/shear.c",__func__,(unsigned long) 1784,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 1784 "MagickCore/shear.c" 3 4
   ((void *)0)
# 1784 "MagickCore/shear.c"
   ); };
  ...
  if (status == MagickFalse)
    {
      rotate_image=DestroyImage(rotate_image);
      return((Image *) 
# 1793 "MagickCore/shear.c" 3 4
                      ((void *)0)
# 1793 "MagickCore/shear.c"
                          );
    }
  ...
  if (status == MagickFalse)
    {
      rotate_image=DestroyImage(rotate_image);
      return((Image *) 
# 1800 "MagickCore/shear.c" 3 4
                      ((void *)0)
# 1800 "MagickCore/shear.c"
                          );
    }
  ...
  if (status == MagickFalse)
    {
      rotate_image=DestroyImage(rotate_image);
      return((Image *) 
# 1808 "MagickCore/shear.c" 3 4
                      ((void *)0)
# 1808 "MagickCore/shear.c"
                          );
    }
