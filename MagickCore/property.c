# 0 "MagickCore/property.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/property.c"
# 43 "MagickCore/property.c"
...
# 57 "MagickCore/property.c" 2

# 1 "./MagickCore/fx-private.h" 1
# 25 "./MagickCore/fx-private.h"
typedef struct _FxInfo
  FxInfo;

extern __attribute__ ((visibility ("hidden"))) FxInfo
...
# 82 "MagickCore/property.c" 2
# 1 "./MagickCore/token-private.h" 1
# 31 "./MagickCore/token-private.h"
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
  IsGlob(const char *) __attribute__((__pure__));
...
static inline unsigned char *ConvertLatin1ToUTF8(
  const unsigned char *__restrict__ content)
{
  int
    c;
  ...
  for (p=content; *p != '\0'; p++)
    length+=(*p & 0x80) != 0 ? 2 : 1;
  utf8=(unsigned char *) 
# 75 "./MagickCore/token-private.h" 3 4
                        ((void *)0)
# 75 "./MagickCore/token-private.h"
                            ;
  if (~length >= 1)
    utf8=(unsigned char *) AcquireQuantumMemory(length+1UL,sizeof(*utf8));
  if (utf8 == (unsigned char *) 
# 78 "./MagickCore/token-private.h" 3 4
                               ((void *)0)
# 78 "./MagickCore/token-private.h"
                                   )
    return((unsigned char *) 
# 79 "./MagickCore/token-private.h" 3 4
                            ((void *)0)
# 79 "./MagickCore/token-private.h"
                                );
  q=utf8;
  for (p=content; *p != '\0'; p++)
  {
...
static inline int GetNextUTFCode(const char *__restrict__ text,
  unsigned int *__restrict__ octets)
{
  int
    code;
  ...
  *octets=1;
  if (text == (const char *) 
# 110 "./MagickCore/token-private.h" 3 4
                            ((void *)0)
# 110 "./MagickCore/token-private.h"
                                )
    {
      
# 112 "./MagickCore/token-private.h" 3 4
     (*__errno_location ())
# 112 "./MagickCore/token-private.h"
          =
# 112 "./MagickCore/token-private.h" 3 4
           22
# 112 "./MagickCore/token-private.h"
...
# 134 "./MagickCore/token-private.h" 3 4
 (*__errno_location ())
# 134 "./MagickCore/token-private.h"
      =
# 134 "./MagickCore/token-private.h" 3 4
       84
# 134 "./MagickCore/token-private.h"
...
static inline int GetUTFCode(const char *__restrict__ text)
{
  unsigned int
    octets;
...
static inline unsigned int GetUTFOctets(const char *__restrict__ text)
{
  unsigned int
    octets;
...
# 24 "./MagickCore/utility-private.h" 2
...
# 87 "MagickCore/property.c" 2
# 1 "./MagickCore/xml-tree-private.h" 1
# 31 "./MagickCore/xml-tree-private.h"
  ...
  const MagickBooleanType pedantic)
{
  ...
  i=0;
  canonical_content=AcquireString((char *) 
# 50 "./MagickCore/xml-tree-private.h" 3 4
                                          ((void *)0)
# 50 "./MagickCore/xml-tree-private.h"
                                              );
  extent=4096;
  for (p=content; *p != '\0'; p++)
  {
    if ((i+4096) > (ssize_t) extent)
      {
        extent+=4096;
        canonical_content=(char *) ResizeQuantumMemory(canonical_content,extent,
          sizeof(*canonical_content));
        if (canonical_content == (char *) 
# 59 "./MagickCore/xml-tree-private.h" 3 4
                                         ((void *)0)
# 59 "./MagickCore/xml-tree-private.h"
                                             )
...
extern __attribute__ ((visibility ("hidden"))) XMLTreeInfo
...
# 88 "MagickCore/property.c" 2
# 134 "MagickCore/property.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CloneImageProperties(Image *image,
  const Image *clone_image)
{
  
# 137 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 137 "MagickCore/property.c"
 image != (Image *) 
# 137 "MagickCore/property.c" 3 4
...
# 137 "MagickCore/property.c"
 "image != (Image *) NULL"
# 137 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 137, __extension__ __PRETTY_FUNCTION__); }))
# 137 "MagickCore/property.c"
                                ;
  
# 138 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 138 "MagickCore/property.c"
...
# 138 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 138, __extension__ __PRETTY_FUNCTION__); }))
# 138 "MagickCore/property.c"
                                                ;
  
# 139 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 139 "MagickCore/property.c"
...
# 139 "MagickCore/property.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 139 "MagickCore/property.c"
 "clone_image != (const Image *) NULL"
# 139 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 139, __extension__ __PRETTY_FUNCTION__); }))
# 139 "MagickCore/property.c"
                                            ;
  
# 140 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 140 "MagickCore/property.c"
...
# 140 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 140, __extension__ __PRETTY_FUNCTION__); }))
# 140 "MagickCore/property.c"
                                                      ;
  if (IsEventLogging() != MagickFalse)
    {
      (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 143,"%s",image->filename);
      (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 144,"%s",
  ...
  image->montage=(char *) 
# 163 "MagickCore/property.c" 3 4
                         ((void *)0)
# 163 "MagickCore/property.c"
                             ;
  image->directory=(char *) 
# 164 "MagickCore/property.c" 3 4
                           ((void *)0)
# 164 "MagickCore/property.c"
                               ;
  ...
  if (clone_image->properties != (void *) 
# 193 "MagickCore/property.c" 3 4
                                         ((void *)0)
# 193 "MagickCore/property.c"
                                             )
    {
      if (image->properties != (void *) 
# 195 "MagickCore/property.c" 3 4
                                       ((void *)0)
# 195 "MagickCore/property.c"
                                           )
        DestroyImageProperties(image);
...
# 233 "MagickCore/property.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DefineImageProperty(Image *image,
...
# 243 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 243 "MagickCore/property.c"
 image != (Image *) 
# 243 "MagickCore/property.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 243 "MagickCore/property.c"
...
# 243 "MagickCore/property.c"
 "image != (Image *) NULL"
# 243 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 243, __extension__ __PRETTY_FUNCTION__); }))
# 243 "MagickCore/property.c"
                                ;
  
# 244 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 244 "MagickCore/property.c"
 property != (const char *) 
# 244 "MagickCore/property.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 244 "MagickCore/property.c"
...
# 244 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 244, __extension__ __PRETTY_FUNCTION__); }))
# 244 "MagickCore/property.c"
                                        ;
  (void) CopyMagickString(key,property,4096 -1);
  for (p=key; *p != '\0'; p++)
    if (*p == '=')
      break;
  *value='\0';
  if (*p == '=')
    (void) CopyMagickString(value,p+1,4096);
  *p='\0';
  return(SetImageProperty(image,key,value,exception));
}
# 280 "MagickCore/property.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DeleteImageProperty(Image *image,
  const char *property)
{
  
# 283 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 283 "MagickCore/property.c"
 image != (Image *) 
# 283 "MagickCore/property.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 283 "MagickCore/property.c"
...
# 283 "MagickCore/property.c"
 "image != (Image *) NULL"
# 283 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 283, __extension__ __PRETTY_FUNCTION__); }))
# 283 "MagickCore/property.c"
                                ;
  
# 284 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 284 "MagickCore/property.c"
 image->signature == 0xabacadabUL
# 284 "MagickCore/property.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 284 "MagickCore/property.c"
...
# 284 "MagickCore/property.c"
 "image->signature == MagickCoreSignature"
# 284 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 284, __extension__ __PRETTY_FUNCTION__); }))
# 284 "MagickCore/property.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 286,"%s",image->filename);
  if (image->properties == (void *) 
# 287 "MagickCore/property.c" 3 4
                                   ((void *)0)
# 287 "MagickCore/property.c"
                                       )
    return(MagickFalse);
  return(DeleteNodeFromSplayTree((SplayTreeInfo *) image->properties,property));
}
# 315 "MagickCore/property.c"
__attribute__ ((visibility ("default"))) void DestroyImageProperties(Image *image)
{
  
# 317 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 317 "MagickCore/property.c"
 image != (Image *) 
# 317 "MagickCore/property.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 317 "MagickCore/property.c"
...
# 317 "MagickCore/property.c"
 "image != (Image *) NULL"
# 317 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 317, __extension__ __PRETTY_FUNCTION__); }))
# 317 "MagickCore/property.c"
                                ;
  
# 318 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 318 "MagickCore/property.c"
 image->signature == 0xabacadabUL
# 318 "MagickCore/property.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 318 "MagickCore/property.c"
...
# 318 "MagickCore/property.c"
 "image->signature == MagickCoreSignature"
# 318 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 318, __extension__ __PRETTY_FUNCTION__); }))
# 318 "MagickCore/property.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 320,"%s",image->filename);
  if (image->properties != (void *) 
# 321 "MagickCore/property.c" 3 4
                                   ((void *)0)
# 321 "MagickCore/property.c"
                                       )
    image->properties=(void *) DestroySplayTree((SplayTreeInfo *)
      image->properties);
}
# 355 "MagickCore/property.c"
__attribute__ ((visibility ("default"))) MagickBooleanType FormatImageProperty(Image *image,
...
# 373 "MagickCore/property.c" 3 4
 __builtin_va_start(
# 373 "MagickCore/property.c"
 operands
# 373 "MagickCore/property.c" 3 4
 ,
# 373 "MagickCore/property.c"
...
# 373 "MagickCore/property.c"
                          ;
  n=FormatLocaleStringList(value,4096,format,operands);
  (void) n;
  
# 376 "MagickCore/property.c" 3 4
 __builtin_va_end(
# 376 "MagickCore/property.c"
 operands
# 376 "MagickCore/property.c" 3 4
 )
# 376 "MagickCore/property.c"
...
# 445 "MagickCore/property.c" 3 4
                               ((void *)0)
# 445 "MagickCore/property.c"
                                   )
    profile=GetImageProfile(image,"8bim");
  if (profile == (StringInfo *) 
# 447 "MagickCore/property.c" 3 4
                               ((void *)0)
# 447 "MagickCore/property.c"
                                   )
    return;
  ...
  if (count != 2)
    return;
  attribute=(char *) 
# 452 "MagickCore/property.c" 3 4
                    ((void *)0)
# 452 "MagickCore/property.c"
                        ;
  for (i=0; i < (ssize_t) GetStringInfoLength(profile); i+=(ssize_t) length)
  {
    ...
    if (((long) GetStringInfoDatum(profile)[i+1] == dataset) &&
      ...
      {
        message=(char *) 
# 463 "MagickCore/property.c" 3 4
                        ((void *)0)
# 463 "MagickCore/property.c"
                            ;
        if (~length >= 1)
          message=(char *) AcquireQuantumMemory(length+1UL,sizeof(*message));
        if (message != (char *) 
# 466 "MagickCore/property.c" 3 4
                               ((void *)0)
# 466 "MagickCore/property.c"
                                   )
          {
  ...
  if ((attribute == (char *) 
# 477 "MagickCore/property.c" 3 4
                            ((void *)0)
# 477 "MagickCore/property.c"
                                ) || (*attribute == ';'))
    {
      if (attribute != (char *) 
# 479 "MagickCore/property.c" 3 4
                               ((void *)0)
# 479 "MagickCore/property.c"
                                   )
...
static inline int ReadPropertyByte(const unsigned char **p,size_t *length)
{
  ...
  if (*length < 1)
    return(
# 495 "MagickCore/property.c" 3 4
          (-1)
# 495 "MagickCore/property.c"
             );
  c=(int) (*(*p)++);
  (*length)--;
  return(c);
  ...
  ExceptionInfo *exception)
{
  ...
  profile=GetImageProfile(image,"8bim");
  if (profile == (StringInfo *) 
# 614 "MagickCore/property.c" 3 4
                               ((void *)0)
# 614 "MagickCore/property.c"
                                   )
    return;
  ...
  if ((count != 2) && (count != 3) && (count != 4))
    return;
  if (count < 4)
    (void) CopyMagickString(format,"SVG",4096);
  if (count < 3)
    *name='\0';
  sub_number=1;
  if (*name == '#')
    sub_number=(ssize_t) StringToLong(&name[1]);
  sub_number=(((sub_number) > (1L)) ? (sub_number) : (1L));
  resource=(char *) 
# 628 "MagickCore/property.c" 3 4
                   ((void *)0)
# 628 "MagickCore/property.c"
                       ;
  status=MagickFalse;
  ...
  while ((length > 0) && (status == MagickFalse))
  {
    ...
    if (id > (ssize_t) stop)
      continue;
    if (resource != (char *) 
# 647 "MagickCore/property.c" 3 4
                            ((void *)0)
# 647 "MagickCore/property.c"
                                )
    ...
    if ((count != 0) && ((size_t) count <= length))
      {
        resource=(char *) 
# 652 "MagickCore/property.c" 3 4
                         ((void *)0)
# 652 "MagickCore/property.c"
                             ;
        if (~((size_t) count) >= (4096 -1))
          resource=(char *) AcquireQuantumMemory((size_t) count+
            4096,sizeof(*resource));
        if (resource != (char *) 
# 656 "MagickCore/property.c" 3 4
                                ((void *)0)
# 656 "MagickCore/property.c"
                                    )
          {
    ...
    if ((*name != '\0') && (*name != '#'))
      if ((resource == (char *) 
# 672 "MagickCore/property.c" 3 4
                               ((void *)0)
# 672 "MagickCore/property.c"
                                   ) || (LocaleCompare(name,resource) != 0))
        {
          ...
          info+=count;
          length=(size_t) ((ssize_t) length-(((count) < ((ssize_t) length)) ? (count) : ((ssize_t) length)));
          continue;
        }
    ...
    attribute=(char *) 
# 694 "MagickCore/property.c" 3 4
                      ((void *)0)
# 694 "MagickCore/property.c"
                          ;
    if (~((size_t) count) >= (4096 -1))
      attribute=(char *) AcquireQuantumMemory((size_t) count+4096,
        sizeof(*attribute));
    if (attribute != (char *) 
# 698 "MagickCore/property.c" 3 4
                             ((void *)0)
# 698 "MagickCore/property.c"
                                 )
      {
  ...
  if (resource != (char *) 
# 725 "MagickCore/property.c" 3 4
                          ((void *)0)
# 725 "MagickCore/property.c"
                              )
    resource=DestroyString(resource);
}
...
# 1274 "MagickCore/property.c" 3 4
                                     ((void *)0)
# 1274 "MagickCore/property.c"
                                         )
    return;
  if ((property == (const char *) 
# 1276 "MagickCore/property.c" 3 4
                                 ((void *)0)
# 1276 "MagickCore/property.c"
                                     ) || (*property == '\0'))
    return;
  while (
# 1278 "MagickCore/property.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 1278 "MagickCore/property.c"
        (int) ((unsigned char) *property)
# 1278 "MagickCore/property.c" 3 4
...
# 1278 "MagickCore/property.c"
  ...
  entry=0;
  tag_offset=0;
  exif_resources=NewSplayTree((int (*)(const void *,const void *)) 
# 1408 "MagickCore/property.c" 3 4
                                                                  ((void *)0)
# 1408 "MagickCore/property.c"
                                                                      ,
    (void *(*)(void *)) 
# 1409 "MagickCore/property.c" 3 4
                       ((void *)0)
# 1409 "MagickCore/property.c"
                           ,(void *(*)(void *)) 
# 1409 "MagickCore/property.c" 3 4
                                                ((void *)0)
# 1409 "MagickCore/property.c"
      ...
      if ((all != 0) || (tag == (size_t) tag_value))
        {
          ...
          if ((p < exif) || (p > (exif+length-tag_bytes[format])))
            break;
          value=(char *) 
# 1487 "MagickCore/property.c" 3 4
                        ((void *)0)
# 1487 "MagickCore/property.c"
                            ;
          *buffer='\0';
          switch (format)
          {
            ...
            {
              value=(char *) 
# 1493 "MagickCore/property.c" 3 4
                            ((void *)0)
# 1493 "MagickCore/property.c"
                                ;
              if (~((size_t) number_bytes) >= 1)
                value=(char *) AcquireQuantumMemory((size_t) number_bytes+1UL,
                  sizeof(*value));
              if (value != (char *) 
# 1497 "MagickCore/property.c" 3 4
                                   ((void *)0)
# 1497 "MagickCore/property.c"
                                       )
                {
                  for (i=0; i < (ssize_t) number_bytes; i++)
                  {
                    value[i]='.';
                    if (
# 1502 "MagickCore/property.c" 3 4
                       ((*__ctype_b_loc ())[(int) ((
# 1502 "MagickCore/property.c"
                       (int) p[i]
# 1502 "MagickCore/property.c" 3 4
...
# 1502 "MagickCore/property.c"
            ...
            case 6:
            {
              { size_t extent = 0; ssize_t component = 0; for ( ; component < components; component++) { extent=(size_t) ((ssize_t) extent-FormatLocaleString(buffer+extent, 4096 -extent,"%.20g"", ",(double) (*(signed char *) p))); if (extent >= (4096 -1)) extent=4096 -1; } if (extent > 1) buffer[extent-2]='\0'; value=AcquireString(buffer); };
              break;
            }
            case 8:
            {
              { size_t extent = 0; ssize_t component = 0; for ( ; component < components; component++) { extent=(size_t) ((ssize_t) extent-FormatLocaleString(buffer+extent, 4096 -extent,"%hd"", ",ReadPropertySignedShort(endian,p))); if (extent >= (4096 -1)) extent=4096 -1; } if (extent > 1) buffer[extent-2]='\0'; value=AcquireString(buffer); };
              break;
            }
            case 3:
            {
              { size_t extent = 0; ssize_t component = 0; for ( ; component < components; component++) { extent=(size_t) ((ssize_t) extent-FormatLocaleString(buffer+extent, 4096 -extent,"%hu"", ",ReadPropertyUnsignedShort(endian,p))); if (extent >= (4096 -1)) extent=4096 -1; } if (extent > 1) buffer[extent-2]='\0'; value=AcquireString(buffer); };
              break;
            }
            case 4:
            {
              { size_t extent = 0; ssize_t component = 0; for ( ; component < components; component++) { extent=(size_t) ((ssize_t) extent-FormatLocaleString(buffer+extent, 4096 -extent,"%.20g"", ",(double) ReadPropertyUnsignedLong(endian,p))); if (extent >= (4096 -1)) extent=4096 -1; } if (extent > 1) buffer[extent-2]='\0'; value=AcquireString(buffer); }
                                                   ;
              break;
            }
            case 9:
            {
              { size_t extent = 0; ssize_t component = 0; for ( ; component < components; component++) { extent=(size_t) ((ssize_t) extent-FormatLocaleString(buffer+extent, 4096 -extent,"%.20g"", ",(double) ReadPropertySignedLong(endian,p))); if (extent >= (4096 -1)) extent=4096 -1; } if (extent > 1) buffer[extent-2]='\0'; value=AcquireString(buffer); }
                                                 ;
              break;
            }
            case 5:
            {
              if ((tag_value == 0x10002) || (tag_value == 0x10004) ||
                  (tag_value == 0x10007))
                {
                  components=1;
                  { size_t extent = 0; ssize_t component = 0; for ( ; component < components; component++) { extent=(size_t) ((ssize_t) extent+FormatLocaleString(buffer+extent, 4096 -extent,"%.20g/%.20g,%.20g/%.20g,%.20g/%.20g"", ",((double) ReadPropertyUnsignedLong(endian,p)),((double) ReadPropertyUnsignedLong(endian,p+4)),((double) ReadPropertyUnsignedLong(endian,p+8)),((double) ReadPropertyUnsignedLong(endian,p+12)),((double) ReadPropertyUnsignedLong(endian,p+16)), ((double) ReadPropertyUnsignedLong(endian,p+20)))); if (extent >= (4096 -1)) extent=4096 -1; } if (extent > 1) buffer[extent-2]='\0'; value=AcquireString(buffer); }
              ...
              { size_t extent = 0; ssize_t component = 0; for ( ; component < components; component++) { extent=(size_t) ((ssize_t) extent+FormatLocaleString(buffer+extent, 4096 -extent,"%.20g/%.20g"", ",((double) ReadPropertyUnsignedLong(endian,p)),((double) ReadPropertyUnsignedLong(endian,p+4)))); if (extent >= (4096 -1)) extent=4096 -1; } if (extent > 1) buffer[extent-2]='\0'; value=AcquireString(buffer); }
            ...
            case 10:
            {
              { size_t extent = 0; ssize_t component = 0; for ( ; component < components; component++) { extent=(size_t) ((ssize_t) extent+FormatLocaleString(buffer+extent, 4096 -extent,"%.20g/%.20g"", ",((double) ReadPropertySignedLong(endian,p)),((double) ReadPropertySignedLong(endian,p+4)))); if (extent >= (4096 -1)) extent=4096 -1; } if (extent > 1) buffer[extent-2]='\0'; value=AcquireString(buffer); }
            ...
            default:
            {
              if ((p < exif) || (p > (exif+length-number_bytes)))
                break;
              value=(char *) 
# 1581 "MagickCore/property.c" 3 4
                            ((void *)0)
# 1581 "MagickCore/property.c"
                                ;
              if (~((size_t) number_bytes) >= 1)
                value=(char *) AcquireQuantumMemory((size_t) number_bytes+1UL,
                  sizeof(*value));
              if (value != (char *) 
# 1585 "MagickCore/property.c" 3 4
                                   ((void *)0)
# 1585 "MagickCore/property.c"
                                       )
                {
                  for (i=0; i < (ssize_t) number_bytes; i++)
                  {
                    value[i]='.';
                    if ((
# 1590 "MagickCore/property.c" 3 4
                        ((*__ctype_b_loc ())[(int) ((
# 1590 "MagickCore/property.c"
                        (int) p[i]
# 1590 "MagickCore/property.c" 3 4
                        ))] & (unsigned short int) _ISprint) 
# 1590 "MagickCore/property.c"
          ...
          if (value != (char *) 
# 1598 "MagickCore/property.c" 3 4
                               ((void *)0)
# 1598 "MagickCore/property.c"
                                   )
            {
              char
                *key;
              ...
              switch (all)
              {
                case 1:
                {
                  ...
                  (void) FormatLocaleString(key,4096,"%s",
                    description);
                  if (level == 2)
                ...
                case 2:
                {
                  if (tag_value < 0x10000)
                    (void) FormatLocaleString(key,4096,"#%04lx",
                    ...
                    if (tag_value < 0x20000)
                      ...
                      (void) FormatLocaleString(key,4096,"unknown");
                  break;
                }
                default:
                {
              ...
              if ((image->properties == (void *) 
# 1647 "MagickCore/property.c" 3 4
                                                ((void *)0)
# 1647 "MagickCore/property.c"
                                                    ) ||
                  (GetValueFromSplayTree((SplayTreeInfo *) image->properties,key) == (const void *) 
# 1648 "MagickCore/property.c" 3 4
                                                                                                   ((void *)0)
# 1648 "MagickCore/property.c"
                                                                                                       ))
        ...
        if ((tag_value == 0x8769) ||
            (tag_value == 0xa005) || (tag_value == 0x8825))
          {
            ssize_t
              tag_offset1;
            ...
            if (((size_t) tag_offset1 < length) &&
                (level < (16 -2)))
              {
                ...
                tag_offset2=(ssize_t) ((tag_value == 0x8825) ? 0x10000 :
                  0);
...
# 1796 "MagickCore/property.c"
static MagickBooleanType SkipXMPValue(const char *value)
{
  if (value == (const char*) 
# 1798 "MagickCore/property.c" 3 4
                            ((void *)0)
# 1798 "MagickCore/property.c"
                                )
    return(MagickTrue);
  while (*value != '\0')
  {
    if (
# 1802 "MagickCore/property.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 1802 "MagickCore/property.c"
...
static void GetXMPProperty(const Image *image,const char *property)
{
  ...
  if (profile == (StringInfo *) 
# 1834 "MagickCore/property.c" 3 4
                               ((void *)0)
# 1834 "MagickCore/property.c"
                                   )
    return;
  if (GetStringInfoLength(profile) < 17)
    return;
  if ((property == (const char *) 
# 1838 "MagickCore/property.c" 3 4
                                 ((void *)0)
# 1838 "MagickCore/property.c"
                                     ) || (*property == '\0'))
    return;
  xmp_profile=StringInfoToString(profile);
  if (xmp_profile == (char *) 
# 1841 "MagickCore/property.c" 3 4
                             ((void *)0)
# 1841 "MagickCore/property.c"
                                 )
    return;
  ...
  exception=DestroyExceptionInfo(exception);
  if (xmp == (XMLTreeInfo *) 
# 1850 "MagickCore/property.c" 3 4
                            ((void *)0)
# 1850 "MagickCore/property.c"
                                )
    return;
  rdf=GetXMLTreeChild(xmp,"rdf:RDF");
  if (rdf != (XMLTreeInfo *) 
# 1853 "MagickCore/property.c" 3 4
                            ((void *)0)
# 1853 "MagickCore/property.c"
                                )
    {
      if (image->properties == (void *) 
# 1855 "MagickCore/property.c" 3 4
                                       ((void *)0)
# 1855 "MagickCore/property.c"
                                           )
        ((Image *) image)->properties=NewSplayTree(CompareSplayTreeString,
          RelinquishMagickMemory,RelinquishMagickMemory);
      description=GetXMLTreeChild(rdf,"rdf:Description");
      while (description != (XMLTreeInfo *) 
# 1859 "MagickCore/property.c" 3 4
                                           ((void *)0)
# 1859 "MagickCore/property.c"
                                               )
      {
        char
          *xmp_namespace;

        node=GetXMLTreeChild(description,(const char *) 
# 1864 "MagickCore/property.c" 3 4
                                                       ((void *)0)
# 1864 "MagickCore/property.c"
                                                           );
        while (node != (XMLTreeInfo *) 
# 1865 "MagickCore/property.c" 3 4
                                      ((void *)0)
# 1865 "MagickCore/property.c"
                                          )
        {
          child=GetXMLTreeChild(node,(const char *) 
# 1867 "MagickCore/property.c" 3 4
                                                   ((void *)0)
# 1867 "MagickCore/property.c"
                                                       );
          content=GetXMLTreeContent(node);
          if ((child == (XMLTreeInfo *) 
# 1869 "MagickCore/property.c" 3 4
                                       ((void *)0)
# 1869 "MagickCore/property.c"
                                           ) &&
          ...
          while (child != (XMLTreeInfo *) 
# 1877 "MagickCore/property.c" 3 4
                                         ((void *)0)
# 1877 "MagickCore/property.c"
                                             )
          {
...
static char *TracePSClippath(const unsigned char *blob,size_t length)
{
  ...
  path=AcquireString((char *) 
# 1920 "MagickCore/property.c" 3 4
                             ((void *)0)
# 1920 "MagickCore/property.c"
                                 );
  if (path == (char *) 
# 1921 "MagickCore/property.c" 3 4
                      ((void *)0)
# 1921 "MagickCore/property.c"
                          )
    return((char *) 
# 1922 "MagickCore/property.c" 3 4
                   ((void *)0)
# 1922 "MagickCore/property.c"
                       );
  message=AcquireString((char *) 
# 1923 "MagickCore/property.c" 3 4
                                ((void *)0)
# 1923 "MagickCore/property.c"
                                    );
  (void) FormatLocaleString(message,4096,"/ClipImage\n");
  ...
  (void) ConcatenateString(&path,message);
  (void) FormatLocaleString(message,4096,"  newpath\n");
  (void) ConcatenateString(&path,message);
    ...
    switch (selector)
    {
      ...
      case 3:
      {
        if (knot_count != 0)
          {
            blob+=24;
            length=(size_t) ((ssize_t) length-(((24) < ((ssize_t) length)) ? (24) : ((ssize_t) length)));
            break;
          }
        ...
        blob+=22;
        length=(size_t) ((ssize_t) length-(((22) < ((ssize_t) length)) ? (22) : ((ssize_t) length)));
        break;
      }
      case 1:
      case 2:
      ...
      case 5:
      {
        ...
        if (in_subpath == MagickFalse)
          {
            (void) FormatLocaleString(message,4096,"  %g %g m\n",
              point[1].x,point[1].y);
            for (i=0; i < 3; i++)
            {
              first[i]=point[i];
  ...
  (void) FormatLocaleString(message,4096,"  eoclip\n");
  (void) ConcatenateString(&path,message);
  (void) FormatLocaleString(message,4096,"} bind def");
  (void) ConcatenateString(&path,message);
  message=DestroyString(message);
  return(path);
}
  ...
  PointInfo *point)
{
  ...
  if (((last+1)->x == (last+2)->x) && ((last+1)->y == (last+2)->y) &&
    ...
    (void) FormatLocaleString(message,4096,"C %g %g %g %g %g %g\n",
  ...
  const size_t columns,const size_t rows)
{
  ...
  path=AcquireString((char *) 
# 2137 "MagickCore/property.c" 3 4
                             ((void *)0)
# 2137 "MagickCore/property.c"
                                 );
  if (path == (char *) 
# 2138 "MagickCore/property.c" 3 4
                      ((void *)0)
# 2138 "MagickCore/property.c"
                          )
    return((char *) 
# 2139 "MagickCore/property.c" 3 4
                   ((void *)0)
# 2139 "MagickCore/property.c"
                       );
  message=AcquireString((char *) 
# 2140 "MagickCore/property.c" 3 4
                                ((void *)0)
# 2140 "MagickCore/property.c"
                                    );
  (void) FormatLocaleString(message,4096,(
  ...
  while (length != 0)
  {
    ...
    switch (selector)
    {
      ...
      case 5:
      {
        ...
        if (in_subpath == MagickFalse)
          {
            (void) FormatLocaleString(message,4096,"M %g %g\n",
              point[1].x,point[1].y);
            for (i=0; i < 3; i++)
            {
              first[i]=point[i];
...
__attribute__ ((visibility ("default"))) const char *GetImageProperty(const Image *image,
  const char *property,ExceptionInfo *exception)
{
  MagickBooleanType
...
# 2262 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 2262 "MagickCore/property.c"
 image != (Image *) 
# 2262 "MagickCore/property.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2262 "MagickCore/property.c"
...
# 2262 "MagickCore/property.c"
 "image != (Image *) NULL"
# 2262 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 2262, __extension__ __PRETTY_FUNCTION__); }))
# 2262 "MagickCore/property.c"
                                ;
  
# 2263 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 2263 "MagickCore/property.c"
 image->signature == 0xabacadabUL
# 2263 "MagickCore/property.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2263 "MagickCore/property.c"
...
# 2263 "MagickCore/property.c"
 "image->signature == MagickCoreSignature"
# 2263 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 2263, __extension__ __PRETTY_FUNCTION__); }))
# 2263 "MagickCore/property.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 2265,"%s",image->filename);
  if ((property == (const char *) 
# 2266 "MagickCore/property.c" 3 4
                                 ((void *)0)
# 2266 "MagickCore/property.c"
                                     ) || (*property == '\0'))
    return((const char *) 
# 2267 "MagickCore/property.c" 3 4
                         ((void *)0)
# 2267 "MagickCore/property.c"
                             );
  ...
  if (read_from_properties != MagickFalse)
    {
      p=(const char *) 
# 2275 "MagickCore/property.c" 3 4
                      ((void *)0)
# 2275 "MagickCore/property.c"
                          ;
      if (image->properties != (void *) 
# 2276 "MagickCore/property.c" 3 4
                                       ((void *)0)
# 2276 "MagickCore/property.c"
                                           )
        {
          p=(const char *) GetValueFromSplayTree((SplayTreeInfo *)
            image->properties,property);
          if (p != (const char *) 
# 2280 "MagickCore/property.c" 3 4
                                 ((void *)0)
# 2280 "MagickCore/property.c"
                                     )
            return(p);
        }
      if (strchr(property,':') == (char *) 
# 2283 "MagickCore/property.c" 3 4
                                          ((void *)0)
# 2283 "MagickCore/property.c"
                                              )
        return(p);
    }
  switch (*property)
  ...
  if ((image->properties != (void *) 
# 2338 "MagickCore/property.c" 3 4
                                    ((void *)0)
# 2338 "MagickCore/property.c"
                                        ) &&
      (read_from_properties != MagickFalse))
    {
      p=(const char *) GetValueFromSplayTree((SplayTreeInfo *)
...
# 2455 "MagickCore/property.c"
  ...
  if ((image != (Image *) 
# 2461 "MagickCore/property.c" 3 4
                         ((void *)0)
# 2461 "MagickCore/property.c"
                             ) && (IsEventLogging() != MagickFalse))
    (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 2462,"%s",image->filename);
  else
    if ((image_info != (ImageInfo *) 
# 2464 "MagickCore/property.c" 3 4
                                    ((void *)0)
# 2464 "MagickCore/property.c"
                                        ) &&
        (IsEventLogging() != MagickFalse))
      (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 2466,"%s","no-images");
  *value='\0';
  string=(char *) 
# 2468 "MagickCore/property.c" 3 4
                 ((void *)0)
# 2468 "MagickCore/property.c"
                     ;
  ...
  switch (letter)
  {
    ...
    {
      if (image == (Image *) 
# 2476 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2476 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2476,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2476 "MagickCore/property.c" 3 4
     ((void *)0)
# 2476 "MagickCore/property.c"
     ); };
      (void) FormatMagickSize(image->extent,MagickFalse,"B",4096,
        value);
      if (image->extent == 0)
    ...
    {
      if (image == (Image *) 
# 2486 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2486 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2486,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2486 "MagickCore/property.c" 3 4
     ((void *)0)
# 2486 "MagickCore/property.c"
     ); };
      string=GetImageProperty(image,"comment",exception);
      if ( string == (const char *) 
# 2488 "MagickCore/property.c" 3 4
                                   ((void *)0) 
# 2488 "MagickCore/property.c"
                                        )
        string="";
      break;
    }
    ...
    {
      if (image == (Image *) 
# 2494 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2494 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2494,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2494 "MagickCore/property.c" 3 4
     ((void *)0)
# 2494 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2502 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2502 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2502,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2502 "MagickCore/property.c" 3 4
     ((void *)0)
# 2502 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2510 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2510 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2510,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2510 "MagickCore/property.c" 3 4
     ((void *)0)
# 2510 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2518 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2518 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2518,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2518 "MagickCore/property.c" 3 4
     ((void *)0)
# 2518 "MagickCore/property.c"
     ); };
      (void) FormatLocaleString(value,4096,
    ...
    {
      if (image == (Image *) 
# 2526 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2526 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2526,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2526 "MagickCore/property.c" 3 4
     ((void *)0)
# 2526 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2533 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2533 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2533,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2533 "MagickCore/property.c" 3 4
     ((void *)0)
# 2533 "MagickCore/property.c"
     ); };
    ...
    case 'k':
    {
      ...
      if (image == (Image *) 
# 2542 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2542 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2542,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2542 "MagickCore/property.c" 3 4
     ((void *)0)
# 2542 "MagickCore/property.c"
     ); };
...
# 2544 "MagickCore/property.c" 3 4
                                      ((void *)0)
# 2544 "MagickCore/property.c"
                                          ,exception));
      break;
    }
    case 'l':
    {
      if (image == (Image *) 
# 2549 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2549 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2549,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2549 "MagickCore/property.c" 3 4
     ((void *)0)
# 2549 "MagickCore/property.c"
     ); };
      ...
      if (string == (const char *) 
# 2551 "MagickCore/property.c" 3 4
                                  ((void *)0)
# 2551 "MagickCore/property.c"
                                      )
        string="";
      break;
    }
    ...
    {
      if (image == (Image *) 
# 2557 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2557 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2557,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2557 "MagickCore/property.c" 3 4
     ((void *)0)
# 2557 "MagickCore/property.c"
     ); };
    ...
    {
      if ( image != (Image *) 
# 2563 "MagickCore/property.c" 3 4
                             ((void *)0) 
# 2563 "MagickCore/property.c"
                                  )
        (void) FormatLocaleString(value,4096,"%.20g",(double)
    ...
    {
      if (image_info == (ImageInfo *) 
# 2572 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2572 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2572,OptionWarning, "NoImageInfoForProperty","\"%%%c\"",letter); return((const char *) 
# 2572 "MagickCore/property.c" 3 4
     ((void *)0)
# 2572 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2578 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2578 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2578,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2578 "MagickCore/property.c" 3 4
     ((void *)0)
# 2578 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2585 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2585 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2585,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2585 "MagickCore/property.c" 3 4
     ((void *)0)
# 2585 "MagickCore/property.c"
     ); };
    ...
    case 'r':
    {
      ...
      if (image == (Image *) 
# 2595 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2595 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2595,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2595 "MagickCore/property.c" 3 4
     ((void *)0)
# 2595 "MagickCore/property.c"
     ); };
      colorspace=image->colorspace;
      (void) FormatLocaleString(value,4096,"%s %s %s",
    ...
    case 's':
    {
# 2616 "MagickCore/property.c"
      if (image == (Image *) 
# 2616 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2616 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2616,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2616 "MagickCore/property.c" 3 4
     ((void *)0)
# 2616 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2624 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2624 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2624,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2624 "MagickCore/property.c" 3 4
     ((void *)0)
# 2624 "MagickCore/property.c"
     ); };
    ...
    {
      if (image_info == (ImageInfo *) 
# 2632 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2632 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2632,OptionWarning, "NoImageInfoForProperty","\"%%%c\"",letter); return((const char *) 
# 2632 "MagickCore/property.c" 3 4
     ((void *)0)
# 2632 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2638 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2638 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2638,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2638 "MagickCore/property.c" 3 4
     ((void *)0)
# 2638 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2645 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2645 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2645,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2645 "MagickCore/property.c" 3 4
     ((void *)0)
# 2645 "MagickCore/property.c"
     ); };
      (void) FormatLocaleString(value,4096,"%.20g",
        fabs(image->resolution.x) > 1.0e-12 ? image->resolution.x :
        image->units == PixelsPerCentimeterResolution ? 72.0/2.54 :
        72.0);
      break;
    }
    case 'y':
    {
      if (image == (Image *) 
# 2654 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2654 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2654,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2654 "MagickCore/property.c" 3 4
     ((void *)0)
# 2654 "MagickCore/property.c"
     ); };
      (void) FormatLocaleString(value,4096,"%.20g",
        fabs(image->resolution.y) > 1.0e-12 ? image->resolution.y :
        image->units == PixelsPerCentimeterResolution ? 72.0/2.54 :
        72.0);
      break;
    }
    ...
    {
      if (image == (Image *) 
# 2663 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2663 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2663,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2663 "MagickCore/property.c" 3 4
     ((void *)0)
# 2663 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2670 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2670 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2670,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2670 "MagickCore/property.c" 3 4
     ((void *)0)
# 2670 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2677 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2677 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2677,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2677 "MagickCore/property.c" 3 4
     ((void *)0)
# 2677 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2687 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2687 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2687,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2687 "MagickCore/property.c" 3 4
     ((void *)0)
# 2687 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2694 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2694 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2694,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2694 "MagickCore/property.c" 3 4
     ((void *)0)
# 2694 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2701 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2701 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2701,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2701 "MagickCore/property.c" 3 4
     ((void *)0)
# 2701 "MagickCore/property.c"
     ); };
      (void) FormatLocaleString(value,4096,"%.20gx%.20g",(double)
    ...
    {
      if (image == (Image *) 
# 2708 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2708 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2708,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2708 "MagickCore/property.c" 3 4
     ((void *)0)
# 2708 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2715 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2715 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2715,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2715 "MagickCore/property.c" 3 4
     ((void *)0)
# 2715 "MagickCore/property.c"
     ); };
    ...
    {
      if ((image != (Image *) 
# 2721 "MagickCore/property.c" 3 4
                             ((void *)0)
# 2721 "MagickCore/property.c"
                                 ) && (image->next == (Image *) 
# 2721 "MagickCore/property.c" 3 4
                                                                ((void *)0)
# 2721 "MagickCore/property.c"
    ...
    {
      if (image == (Image *) 
# 2730 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2730 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2730,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2730 "MagickCore/property.c" 3 4
     ((void *)0)
# 2730 "MagickCore/property.c"
     ); };
      (void) FormatLocaleString(value,4096,"%+ld%+ld",(long)
    ...
    {
      if (image == (Image *) 
# 2737 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2737 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2737,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2737 "MagickCore/property.c" 3 4
     ((void *)0)
# 2737 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2744 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2744 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2744,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2744 "MagickCore/property.c" 3 4
     ((void *)0)
# 2744 "MagickCore/property.c"
     ); };
    ...
    {
      if (image_info == (ImageInfo *) 
# 2751 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2751 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2751,OptionWarning, "NoImageInfoForProperty","\"%%%c\"",letter); return((const char *) 
# 2751 "MagickCore/property.c" 3 4
     ((void *)0)
# 2751 "MagickCore/property.c"
     ); };
# 2761 "MagickCore/property.c"
      (void) FormatLocaleString(value,4096,"%.20g",(double)
    ...
    {
      if (image == (Image *) 
# 2769 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2769 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2769,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2769 "MagickCore/property.c" 3 4
     ((void *)0)
# 2769 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2776 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2776 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2776,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2776 "MagickCore/property.c" 3 4
     ((void *)0)
# 2776 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2783 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2783 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2783,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2783 "MagickCore/property.c" 3 4
     ((void *)0)
# 2783 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2790 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2790 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2790,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2790 "MagickCore/property.c" 3 4
     ((void *)0)
# 2790 "MagickCore/property.c"
     ); };
    ...
    {
      if (image == (Image *) 
# 2797 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2797 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2797,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2797 "MagickCore/property.c" 3 4
     ((void *)0)
# 2797 "MagickCore/property.c"
     ); };
    ...
    case '@':
    {
      ...
      if (image == (Image *) 
# 2812 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2812 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2812,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2812 "MagickCore/property.c" 3 4
     ((void *)0)
# 2812 "MagickCore/property.c"
     ); };
    ...
    case '#':
    {
      ...
      if (image == (Image *) 
# 2824 "MagickCore/property.c" 3 4
     ((void *)0) 
# 2824 "MagickCore/property.c"
     ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2824,OptionWarning, "NoImageForProperty","\"%%%c\"",letter); return((const char *) 
# 2824 "MagickCore/property.c" 3 4
     ((void *)0)
# 2824 "MagickCore/property.c"
     ); };
  ...
  if (string != (char *) 
# 2831 "MagickCore/property.c" 3 4
                        ((void *)0)
# 2831 "MagickCore/property.c"
                            )
    return(string);
  if (*value != '\0')
    {
      ...
      if (image != (Image *) 
# 2838 "MagickCore/property.c" 3 4
                            ((void *)0)
# 2838 "MagickCore/property.c"
                                )
        {
  ...
  return((char *) 
# 2849 "MagickCore/property.c" 3 4
                 ((void *)0)
# 2849 "MagickCore/property.c"
                     );
}

__attribute__ ((visibility ("default"))) const char *GetMagickProperty(ImageInfo *image_info,
...
# 2861 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 2861 "MagickCore/property.c"
 property != (const char *) 
# 2861 "MagickCore/property.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2861 "MagickCore/property.c"
...
# 2861 "MagickCore/property.c"
 "property != (const char *) NULL"
# 2861 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 2861, __extension__ __PRETTY_FUNCTION__); }))
# 2861 "MagickCore/property.c"
                                        ;
  
# 2862 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 2862 "MagickCore/property.c"
 property[0] != '\0'
# 2862 "MagickCore/property.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2862 "MagickCore/property.c"
...
# 2862 "MagickCore/property.c"
 "property[0] != '\\0'"
# 2862 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 2862, __extension__ __PRETTY_FUNCTION__); }))
# 2862 "MagickCore/property.c"
                            ;
  
# 2863 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 2863 "MagickCore/property.c"
 image != (Image *) 
# 2863 "MagickCore/property.c" 3 4
 ((void *)0) 
# 2863 "MagickCore/property.c"
...
# 2863 "MagickCore/property.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 2863 "MagickCore/property.c"
 "image != (Image *) NULL || image_info != (ImageInfo *) NULL"
# 2863 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 2863, __extension__ __PRETTY_FUNCTION__); }))
# 2863 "MagickCore/property.c"
                                                                     ;
  if (property[1] == '\0')
    return(GetMagickPropertyLetter(image_info,image,*property,exception));
  if ((image != (Image *) 
# 2866 "MagickCore/property.c" 3 4
                         ((void *)0)
# 2866 "MagickCore/property.c"
                             ) && (IsEventLogging() != MagickFalse))
    (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 2867,"%s",image->filename);
  else
    if ((image_info != (ImageInfo *) 
# 2869 "MagickCore/property.c" 3 4
                                    ((void *)0)
# 2869 "MagickCore/property.c"
                                        ) &&
        (IsEventLogging() != MagickFalse))
      (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 2871,"%s","no-images");
  *value='\0';
  string=(char *) 
# 2873 "MagickCore/property.c" 3 4
                 ((void *)0)
# 2873 "MagickCore/property.c"
                     ;
  switch (*property)
  {
    case 'b':
    {
      if (LocaleCompare("basename",property) == 0)
        {
          if (image == (Image *) 
# 2880 "MagickCore/property.c" 3 4
         ((void *)0) 
# 2880 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2880,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 2880 "MagickCore/property.c" 3 4
         ((void *)0)
# 2880 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("bit-depth",property) == 0)
        {
          if (image == (Image *) 
# 2888 "MagickCore/property.c" 3 4
         ((void *)0) 
# 2888 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2888,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 2888 "MagickCore/property.c" 3 4
         ((void *)0)
# 2888 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("bounding-box",property) == 0)
        {
          ...
          if (image == (Image *) 
# 2898 "MagickCore/property.c" 3 4
         ((void *)0) 
# 2898 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2898,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 2898 "MagickCore/property.c" 3 4
         ((void *)0)
# 2898 "MagickCore/property.c"
         ); };
          geometry=GetImageBoundingBox(image,exception);
          (void) FormatLocaleString(value,4096,"%g,%g %g,%g",
    ...
    case 'c':
    {
      if (LocaleCompare("channels",property) == 0)
        {
          if (image == (Image *) 
# 2912 "MagickCore/property.c" 3 4
         ((void *)0) 
# 2912 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2912,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 2912 "MagickCore/property.c" 3 4
         ((void *)0)
# 2912 "MagickCore/property.c"
         ); };
          (void) FormatLocaleString(value,4096,"%s%s %g.%g",
      ...
      if (LocaleCompare("colors",property) == 0)
        {
          if (image == (Image *) 
# 2923 "MagickCore/property.c" 3 4
         ((void *)0) 
# 2923 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2923,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 2923 "MagickCore/property.c" 3 4
         ((void *)0)
# 2923 "MagickCore/property.c"
         ); };
          image->colors=GetNumberColors(image,(FILE *) 
# 2924 "MagickCore/property.c" 3 4
                                                      ((void *)0)
# 2924 "MagickCore/property.c"
                                                          ,exception);
          (void) FormatLocaleString(value,4096,"%.20g",(double)
            image->colors);
          break;
      ...
      if (LocaleCompare("colorspace",property) == 0)
        {
          if (image == (Image *) 
# 2931 "MagickCore/property.c" 3 4
         ((void *)0) 
# 2931 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2931,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 2931 "MagickCore/property.c" 3 4
         ((void *)0)
# 2931 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("compose",property) == 0)
        {
          if (image == (Image *) 
# 2938 "MagickCore/property.c" 3 4
         ((void *)0) 
# 2938 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2938,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 2938 "MagickCore/property.c" 3 4
         ((void *)0)
# 2938 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("compression",property) == 0)
        {
          if (image == (Image *) 
# 2945 "MagickCore/property.c" 3 4
         ((void *)0) 
# 2945 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2945,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 2945 "MagickCore/property.c" 3 4
         ((void *)0)
# 2945 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("convex-hull",property) == 0)
        {
          ...
          if (image == (Image *) 
# 2964 "MagickCore/property.c" 3 4
         ((void *)0) 
# 2964 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2964,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 2964 "MagickCore/property.c" 3 4
         ((void *)0)
# 2964 "MagickCore/property.c"
         ); };
          convex_hull=GetImageConvexHull(image,&number_points,exception);
          if (convex_hull == (PointInfo *) 
# 2966 "MagickCore/property.c" 3 4
                                          ((void *)0)
# 2966 "MagickCore/property.c"
                                              )
            break;
          points=AcquireString("");
          for (n=0; n < (ssize_t) number_points; n++)
          {
            (void) FormatLocaleString(value,4096,"%g,%g ",
      ...
      if (LocaleCompare("convex-hull:extreme-points",property) == 0)
        {
          ...
          if (image == (Image *) 
# 2996 "MagickCore/property.c" 3 4
         ((void *)0) 
# 2996 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 2996,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 2996 "MagickCore/property.c" 3 4
         ((void *)0)
# 2996 "MagickCore/property.c"
         ); };
          convex_hull=GetImageConvexHull(image,&number_points,exception);
          if (convex_hull == (PointInfo *) 
# 2998 "MagickCore/property.c" 3 4
                                          ((void *)0)
# 2998 "MagickCore/property.c"
                                              )
            break;
          points=AcquireString("");
          extreme=convex_hull[0];
          for (n=0; n < (ssize_t) number_points; n++)
          {
      ...
      if (LocaleCompare("copyright",property) == 0)
        {
          (void) CopyMagickString(value,GetMagickCopyright(),4096);
          break;
        }
      break;
    }
    case 'd':
    {
      if (LocaleCompare("depth",property) == 0)
        {
          if (image == (Image *) 
# 3083 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3083 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3083,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3083 "MagickCore/property.c" 3 4
         ((void *)0)
# 3083 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("directory",property) == 0)
        {
          if (image == (Image *) 
# 3090 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3090 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3090,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3090 "MagickCore/property.c" 3 4
         ((void *)0)
# 3090 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("entropy",property) == 0)
        {
          ...
          if (image == (Image *) 
# 3105 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3105 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3105,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3105 "MagickCore/property.c" 3 4
         ((void *)0)
# 3105 "MagickCore/property.c"
         ); };
          (void) GetImageEntropy(image,&entropy,exception);
          (void) FormatLocaleString(value,4096,"%.*g",
      ...
      if (LocaleCompare("extension",property) == 0)
        {
          if (image == (Image *) 
# 3113 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3113 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3113,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3113 "MagickCore/property.c" 3 4
         ((void *)0)
# 3113 "MagickCore/property.c"
         ); };
    ...
    case 'g':
    {
      if (LocaleCompare("gamma",property) == 0)
        {
          if (image == (Image *) 
# 3125 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3125 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3125,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3125 "MagickCore/property.c" 3 4
         ((void *)0)
# 3125 "MagickCore/property.c"
         ); };
    ...
    case 'h':
    {
      if (LocaleCompare("height",property) == 0)
        {
          if (image == (Image *) 
# 3136 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3136 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3136,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3136 "MagickCore/property.c" 3 4
         ((void *)0)
# 3136 "MagickCore/property.c"
         ); };
    ...
    case 'i':
    {
      if (LocaleCompare("input",property) == 0)
        {
          if (image == (Image *) 
# 3147 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3147 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3147,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3147 "MagickCore/property.c" 3 4
         ((void *)0)
# 3147 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("interlace",property) == 0)
        {
          if (image == (Image *) 
# 3153 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3153 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3153,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3153 "MagickCore/property.c" 3 4
         ((void *)0)
# 3153 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("kurtosis",property) == 0)
        {
          ...
          if (image == (Image *) 
# 3168 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3168 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3168,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3168 "MagickCore/property.c" 3 4
         ((void *)0)
# 3168 "MagickCore/property.c"
         ); };
    ...
    case 'm':
    {
      if (LocaleCompare("magick",property) == 0)
        {
          if (image == (Image *) 
# 3180 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3180 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3180,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3180 "MagickCore/property.c" 3 4
         ((void *)0)
# 3180 "MagickCore/property.c"
         ); };
      ...
      if ((LocaleCompare("maxima",property) == 0) ||
          (LocaleCompare("max",property) == 0))
        {
          ...
          if (image == (Image *) 
# 3191 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3191 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3191,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3191 "MagickCore/property.c" 3 4
         ((void *)0)
# 3191 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("mean",property) == 0)
        {
          ...
          if (image == (Image *) 
# 3203 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3203 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3203,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3203 "MagickCore/property.c" 3 4
         ((void *)0)
# 3203 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("median",property) == 0)
        {
          ...
          if (image == (Image *) 
# 3214 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3214 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3214,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3214 "MagickCore/property.c" 3 4
         ((void *)0)
# 3214 "MagickCore/property.c"
         ); };
      ...
      if ((LocaleCompare("minima",property) == 0) ||
          (LocaleCompare("min",property) == 0))
        {
          ...
          if (image == (Image *) 
# 3227 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3227 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3227,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3227 "MagickCore/property.c" 3 4
         ((void *)0)
# 3227 "MagickCore/property.c"
         ); };
      ...
      if (LocaleNCompare("minimum-bounding-box",property,20) == 0)
        {
          ...
          if (image == (Image *) 
# 3247 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3247 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3247,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3247 "MagickCore/property.c" 3 4
         ((void *)0)
# 3247 "MagickCore/property.c"
         ); };
          bounding_box=GetImageMinimumBoundingBox(image,&number_points,
            exception);
          if (bounding_box == (PointInfo *) 
# 3250 "MagickCore/property.c" 3 4
                                           ((void *)0)
# 3250 "MagickCore/property.c"
                                               )
            break;
          points=AcquireString("");
          for (n=0; n < (ssize_t) number_points; n++)
    ...
    case 'o':
    {
      if (LocaleCompare("opaque",property) == 0)
        {
          if (image == (Image *) 
# 3272 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3272 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3272,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3272 "MagickCore/property.c" 3 4
         ((void *)0)
# 3272 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("orientation",property) == 0)
        {
          if (image == (Image *) 
# 3279 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3279 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3279,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3279 "MagickCore/property.c" 3 4
         ((void *)0)
# 3279 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("output",property) == 0)
        {
          if (image_info == (ImageInfo *) 
# 3286 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3286 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3286,OptionWarning, "NoImageInfoForProperty","\"%%[%s]\"",property); return((const char *) 
# 3286 "MagickCore/property.c" 3 4
         ((void *)0)
# 3286 "MagickCore/property.c"
         ); };
          (void) CopyMagickString(value,image_info->filename,4096);
          break;
        }
      break;
    }
    case 'p':
    {
      if (LocaleCompare("page",property) == 0)
        {
          if (image == (Image *) 
# 3296 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3296 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3296,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3296 "MagickCore/property.c" 3 4
         ((void *)0)
# 3296 "MagickCore/property.c"
         ); };
          (void) FormatLocaleString(value,4096,"%.20gx%.20g",
      ...
      if (LocaleNCompare("papersize:",property,10) == 0)
        {
          ...
          if (image == (Image *) 
# 3306 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3306 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3306,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3306 "MagickCore/property.c" 3 4
         ((void *)0)
# 3306 "MagickCore/property.c"
         ); };
          *value='\0';
          ...
          if (papersize != (const char *) 
# 3309 "MagickCore/property.c" 3 4
                                         ((void *)0)
# 3309 "MagickCore/property.c"
                                             )
            {
              RectangleInfo
                page = { 0, 0, 0, 0 };
...
# 3353 "MagickCore/property.c"
      if (LocaleCompare("printsize.x",property) == 0)
        {
          if (image == (Image *) 
# 3355 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3355 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3355,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3355 "MagickCore/property.c" 3 4
         ((void *)0)
# 3355 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("printsize.y",property) == 0)
        {
          if (image == (Image *) 
# 3363 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3363 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3363,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3363 "MagickCore/property.c" 3 4
         ((void *)0)
# 3363 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("profiles",property) == 0)
        {
          ...
          if (image == (Image *) 
# 3374 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3374 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3374,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3374 "MagickCore/property.c" 3 4
         ((void *)0)
# 3374 "MagickCore/property.c"
         ); };
          ...
          if (name != (char *) 
# 3377 "MagickCore/property.c" 3 4
                              ((void *)0)
# 3377 "MagickCore/property.c"
                                  )
            {
              (void) CopyMagickString(value,name,4096);
              name=GetNextImageProfile(image);
              while (name != (char *) 
# 3381 "MagickCore/property.c" 3 4
                                     ((void *)0)
# 3381 "MagickCore/property.c"
                                         )
              {
                ConcatenateMagickString(value,",",4096);
                ConcatenateMagickString(value,name,4096);
                name=GetNextImageProfile(image);
              }
            }
          break;
    ...
    case 'q':
    {
      if (LocaleCompare("quality",property) == 0)
        {
          if (image == (Image *) 
# 3396 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3396 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3396,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3396 "MagickCore/property.c" 3 4
         ((void *)0)
# 3396 "MagickCore/property.c"
         ); };
    ...
    case 'r':
    {
      if (LocaleCompare("resolution.x",property) == 0)
        {
          if (image == (Image *) 
# 3407 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3407 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3407,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3407 "MagickCore/property.c" 3 4
         ((void *)0)
# 3407 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("resolution.y",property) == 0)
        {
          if (image == (Image *) 
# 3414 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3414 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3414,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3414 "MagickCore/property.c" 3 4
         ((void *)0)
# 3414 "MagickCore/property.c"
         ); };
    ...
    case 's':
    {
      if (LocaleCompare("scene",property) == 0)
        {
          if (image_info == (ImageInfo *) 
# 3425 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3425 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3425,OptionWarning, "NoImageInfoForProperty","\"%%[%s]\"",property); return((const char *) 
# 3425 "MagickCore/property.c" 3 4
         ((void *)0)
# 3425 "MagickCore/property.c"
         ); };
          if (image_info->number_scenes != 0)
            ...
            if (image == (Image *) 
# 3430 "MagickCore/property.c" 3 4
           ((void *)0) 
# 3430 "MagickCore/property.c"
           ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3430,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3430 "MagickCore/property.c" 3 4
           ((void *)0)
# 3430 "MagickCore/property.c"
           ); };
      ...
      if (LocaleCompare("scenes",property) == 0)
        {
          ...
          if (image == (Image *) 
# 3439 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3439 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3439,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3439 "MagickCore/property.c" 3 4
         ((void *)0)
# 3439 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("size",property) == 0)
        {
          if (image == (Image *) 
# 3446 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3446 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3446,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3446 "MagickCore/property.c" 3 4
         ((void *)0)
# 3446 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("skewness",property) == 0)
        {
          ...
          if (image == (Image *) 
# 3457 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3457 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3457,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3457 "MagickCore/property.c" 3 4
         ((void *)0)
# 3457 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("standard-deviation",property) == 0)
        {
          ...
          if (image == (Image *) 
# 3469 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3469 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3469,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3469 "MagickCore/property.c" 3 4
         ((void *)0)
# 3469 "MagickCore/property.c"
         ); };
    ...
    case 't':
    {
      if (LocaleCompare("type",property) == 0)
        {
          if (image == (Image *) 
# 3481 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3481 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3481,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3481 "MagickCore/property.c" 3 4
         ((void *)0)
# 3481 "MagickCore/property.c"
         ); };
    ...
    case 'u':
    {
      if (LocaleCompare("unique",property) == 0)
        {
          if (image_info == (ImageInfo *) 
# 3492 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3492 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3492,OptionWarning, "NoImageInfoForProperty","\"%%[%s]\"",property); return((const char *) 
# 3492 "MagickCore/property.c" 3 4
         ((void *)0)
# 3492 "MagickCore/property.c"
         ); };
      ...
      if (LocaleCompare("units",property) == 0)
        {
          if (image == (Image *) 
# 3498 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3498 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3498,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3498 "MagickCore/property.c" 3 4
         ((void *)0)
# 3498 "MagickCore/property.c"
         ); };
    ...
    case 'v':
    {
      if (LocaleCompare("version",property) == 0)
        {
          string=GetMagickVersion((size_t *) 
# 3509 "MagickCore/property.c" 3 4
                                            ((void *)0)
# 3509 "MagickCore/property.c"
                                                );
          break;
        }
      break;
    ...
    case 'w':
    {
      if (LocaleCompare("width",property) == 0)
        {
          if (image == (Image *) 
# 3518 "MagickCore/property.c" 3 4
         ((void *)0) 
# 3518 "MagickCore/property.c"
         ) { (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3518,OptionWarning, "NoImageForProperty","\"%%[%s]\"",property); return((const char *) 
# 3518 "MagickCore/property.c" 3 4
         ((void *)0)
# 3518 "MagickCore/property.c"
         ); };
  ...
  if (string != (char *) 
# 3526 "MagickCore/property.c" 3 4
                        ((void *)0)
# 3526 "MagickCore/property.c"
                            )
    return(string);
  if (*value != '\0')
    {
      ...
      if (image != (Image *) 
# 3533 "MagickCore/property.c" 3 4
                            ((void *)0)
# 3533 "MagickCore/property.c"
                                )
        {
          (void) SetImageArtifact(image,"magick-property",value);
          return(GetImageArtifact(image,"magick-property"));
  ...
  return((char *) 
# 3544 "MagickCore/property.c" 3 4
                 ((void *)0)
# 3544 "MagickCore/property.c"
                     );
}
# 3570 "MagickCore/property.c"
__attribute__ ((visibility ("default"))) const char *GetNextImageProperty(const Image *image)
{
  
# 3572 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 3572 "MagickCore/property.c"
 image != (Image *) 
# 3572 "MagickCore/property.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3572 "MagickCore/property.c"
...
# 3572 "MagickCore/property.c"
 "image != (Image *) NULL"
# 3572 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 3572, __extension__ __PRETTY_FUNCTION__); }))
# 3572 "MagickCore/property.c"
                                ;
  
# 3573 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 3573 "MagickCore/property.c"
 image->signature == 0xabacadabUL
# 3573 "MagickCore/property.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3573 "MagickCore/property.c"
...
# 3573 "MagickCore/property.c"
 "image->signature == MagickCoreSignature"
# 3573 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 3573, __extension__ __PRETTY_FUNCTION__); }))
# 3573 "MagickCore/property.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 3575,"%s",
      image->filename);
  if (image->properties == (void *) 
# 3577 "MagickCore/property.c" 3 4
                                   ((void *)0)
# 3577 "MagickCore/property.c"
                                       )
    return((const char *) 
# 3578 "MagickCore/property.c" 3 4
                         ((void *)0)
# 3578 "MagickCore/property.c"
                             );
  return((const char *) GetNextKeyInSplayTree((SplayTreeInfo *) image->properties));
}
# 3636 "MagickCore/property.c"
__attribute__ ((visibility ("default"))) char *InterpretImageProperties(ImageInfo *image_info,Image *image,
  const char *embed_text,ExceptionInfo *exception)
{
# 3702 "MagickCore/property.c"
  char
    *interpret_text,
    *q;
  ...
  if ((image != (Image *) 
# 3721 "MagickCore/property.c" 3 4
                         ((void *)0)
# 3721 "MagickCore/property.c"
                             ) && (IsEventLogging() != MagickFalse))
    (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 3722,"%s",image->filename);
  else
    if ((image_info != (ImageInfo *) 
# 3724 "MagickCore/property.c" 3 4
                                    ((void *)0)
# 3724 "MagickCore/property.c"
                                        ) && (IsEventLogging() != MagickFalse))
      (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 3725,"%s",
        image_info->filename);
    else
      if (IsEventLogging() != MagickFalse)
        (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 3729,"%s","no image");
  if (embed_text == (const char *) 
# 3730 "MagickCore/property.c" 3 4
                                  ((void *)0)
# 3730 "MagickCore/property.c"
                                      )
    return(ConstantString(""));
  p=embed_text;
  while ((
# 3733 "MagickCore/property.c" 3 4
         ((*__ctype_b_loc ())[(int) ((
# 3733 "MagickCore/property.c"
         (int) ((unsigned char) *p)
# 3733 "MagickCore/property.c" 3 4
         ))] & (unsigned short int) _ISspace) 
# 3733 "MagickCore/property.c"
  ...
  if ((*p == '@') && (IsPathAccessible(p+1) != MagickFalse))
    {
      ...
      if (interpret_text != (char *) 
# 3743 "MagickCore/property.c" 3 4
                                    ((void *)0)
# 3743 "MagickCore/property.c"
                                        )
  ...
  if (image_info != (ImageInfo *) 
# 3749 "MagickCore/property.c" 3 4
                                 ((void *)0)
# 3749 "MagickCore/property.c"
                                     )
    property_info=image_info;
  else
    property_info=CloneImageInfo(image_info);
  if ((image != (Image *) 
# 3753 "MagickCore/property.c" 3 4
                         ((void *)0)
# 3753 "MagickCore/property.c"
  ...
  extent=4096;
  number=MagickFalse;
  for (q=interpret_text; *p!='\0'; number=
# 3764 "MagickCore/property.c" 3 4
                                         ((*__ctype_b_loc ())[(int) ((
# 3764 "MagickCore/property.c"
                                         (int) ((unsigned char) *p)
# 3764 "MagickCore/property.c" 3 4
                                         ))] & (unsigned short int) _ISdigit) 
# 3764 "MagickCore/property.c"
                                                                             ? MagickTrue : MagickFalse,p++)
  {



    *q='\0';
    { size_t length=(4096); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 3770 "MagickCore/property.c" 3 4
   ((void *)0)
# 3770 "MagickCore/property.c"
   ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 3770 "MagickCore/property.c" 3 4
   ((void *)0)
# 3770 "MagickCore/property.c"
    ...
    if (*p != '[')
      {
        ...
        if (string != (char *) 
# 3871 "MagickCore/property.c" 3 4
                              ((void *)0)
# 3871 "MagickCore/property.c"
                                  )
          {
            { size_t length = strlen((string)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 3873 "MagickCore/property.c" 3 4
           ((void *)0)
# 3873 "MagickCore/property.c"
           ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 3873 "MagickCore/property.c" 3 4
           ((void *)0)
# 3873 "MagickCore/property.c"
           ); } q=interpret_text+strlen(interpret_text); } (void) CopyMagickString(q,(string),extent); q+=length; };
            (void) DeleteImageArtifact(property_image,"magick-property");
            (void) DeleteImageOption(property_info,"magick-property");
            continue;
          }
        (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3878,OptionWarning,
      ...
      }
    {
      ...
      if (*p == ']')
        {
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3903,OptionWarning,
            "UnknownImageProperty","\"%%[]\"");
          break;
        }
      for (len=0; len < (4096 -1L) && (*p != '\0'); )
      {
        if ((*p == '\\') && (*(p+1) != '\0'))
          {
      ...
      if (depth != 0)
        {
          ...
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 3939,OptionError,
          ...
          return((char *) 
# 3946 "MagickCore/property.c" 3 4
                         ((void *)0)
# 3946 "MagickCore/property.c"
                             );
        }
      ...
      if (LocaleNCompare("fx:",pattern,3) == 0)
        {
          ...
          if (fx_info == (FxInfo *) 
# 3966 "MagickCore/property.c" 3 4
                                   ((void *)0)
# 3966 "MagickCore/property.c"
                                       )
            continue;
          ...
          if (status != MagickFalse)
            {
              ...
              (void) FormatLocaleString(result,4096,"%.*g",
                GetMagickPrecision(),(double) value);
              { size_t length = strlen((result)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 3978 "MagickCore/property.c" 3 4
             ((void *)0)
# 3978 "MagickCore/property.c"
             ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 3978 "MagickCore/property.c" 3 4
             ((void *)0)
# 3978 "MagickCore/property.c"
             ); } q=interpret_text+strlen(interpret_text); } (void) CopyMagickString(q,(result),extent); q+=length; };
            }
          continue;
        }
          ...
          if (status != MagickFalse)
            {
              ...
              { size_t length = strlen((hex+1)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4028 "MagickCore/property.c" 3 4
             ((void *)0)
# 4028 "MagickCore/property.c"
             ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4028 "MagickCore/property.c" 3 4
             ((void *)0)
# 4028 "MagickCore/property.c"
             ); } q=interpret_text+strlen(interpret_text); } (void) CopyMagickString(q,(hex+1),extent); q+=length; };
            }
          continue;
        }
      if (LocaleNCompare("pixel:",pattern,6) == 0)
        {
          ...
          if (fx_info == (FxInfo *) 
# 4051 "MagickCore/property.c" 3 4
                                   ((void *)0)
# 4051 "MagickCore/property.c"
                                       )
            continue;
          status=FxEvaluateChannelExpression(fx_info,RedPixelChannel,0,0,
            &value,exception);
          ...
          if (status != MagickFalse)
            {
              ...
              if (string != (char *) 
# 4079 "MagickCore/property.c" 3 4
                                    ((void *)0)
# 4079 "MagickCore/property.c"
                                        )
                {
              ...
              { size_t length = strlen((name)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4086 "MagickCore/property.c" 3 4
             ((void *)0)
# 4086 "MagickCore/property.c"
             ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4086 "MagickCore/property.c" 3 4
             ((void *)0)
# 4086 "MagickCore/property.c"
             ); } q=interpret_text+strlen(interpret_text); } (void) CopyMagickString(q,(name),extent); q+=length; };
            }
          continue;
        }
          ...
          if (IsGlob(pattern+7) != MagickFalse)
            {
              ...
              while ((key=GetNextImageOption(property_info)) != (const char *) 
# 4098 "MagickCore/property.c" 3 4
                                                                              ((void *)0)
# 4098 "MagickCore/property.c"
                                                                                  )
                if (GlobExpression(key,pattern+7,MagickTrue) != MagickFalse)
                  {
                    string=GetImageOption(property_info,key);
                    if (string != (const char *) 
# 4102 "MagickCore/property.c" 3 4
                                                ((void *)0)
# 4102 "MagickCore/property.c"
                                                    )
                      { size_t length=strlen(key)+strlen(string)+2; if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4103 "MagickCore/property.c" 3 4
                     ((void *)0)
# 4103 "MagickCore/property.c"
                     ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4103 "MagickCore/property.c" 3 4
                     ((void *)0)
# 4103 "MagickCore/property.c"
                     ); } q=interpret_text+strlen(interpret_text); } q+=FormatLocaleString(q,extent,"%s=%s\n",(key),(string)); };
          ...
          if (string == (char *) 
# 4109 "MagickCore/property.c" 3 4
                                ((void *)0)
# 4109 "MagickCore/property.c"
                                    )
            goto PropertyLookupFailure;
          { size_t length = strlen((string)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4111 "MagickCore/property.c" 3 4
         ((void *)0)
# 4111 "MagickCore/property.c"
         ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4111 "MagickCore/property.c" 3 4
         ((void *)0)
# 4111 "MagickCore/property.c"
          ...
          if (IsGlob(pattern+9) != MagickFalse)
            {
              ...
              while ((key=GetNextImageArtifact(property_image)) != (const char *) 
# 4122 "MagickCore/property.c" 3 4
                                                                                 ((void *)0)
# 4122 "MagickCore/property.c"
                                                                                     )
              if (GlobExpression(key,pattern+9,MagickTrue) != MagickFalse)
                {
                  string=GetImageArtifact(property_image,key);
                  if (string != (const char *) 
# 4126 "MagickCore/property.c" 3 4
                                              ((void *)0)
# 4126 "MagickCore/property.c"
                                                  )
                    { size_t length=strlen(key)+strlen(string)+2; if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4127 "MagickCore/property.c" 3 4
                   ((void *)0)
# 4127 "MagickCore/property.c"
                   ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4127 "MagickCore/property.c" 3 4
                   ((void *)0)
# 4127 "MagickCore/property.c"
          ...
          if (string == (char *) 
# 4133 "MagickCore/property.c" 3 4
                                ((void *)0)
# 4133 "MagickCore/property.c"
                                    )
            goto PropertyLookupFailure;
          { size_t length = strlen((string)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4135 "MagickCore/property.c" 3 4
         ((void *)0)
# 4135 "MagickCore/property.c"
         ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4135 "MagickCore/property.c" 3 4
         ((void *)0)
# 4135 "MagickCore/property.c"
          ...
          if (IsGlob(pattern+9) != MagickFalse)
            {
              ...
              while ((key=GetNextImageProperty(property_image)) != (const char *) 
# 4146 "MagickCore/property.c" 3 4
                                                                                 ((void *)0)
# 4146 "MagickCore/property.c"
                                                                                     )
                if (GlobExpression(key,pattern,MagickTrue) != MagickFalse)
                  {
                    string=GetImageProperty(property_image,key,exception);
                    if (string != (const char *) 
# 4150 "MagickCore/property.c" 3 4
                                                ((void *)0)
# 4150 "MagickCore/property.c"
                                                    )
                      { size_t length=strlen(key)+strlen(string)+2; if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4151 "MagickCore/property.c" 3 4
                     ((void *)0)
# 4151 "MagickCore/property.c"
                     ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4151 "MagickCore/property.c" 3 4
                     ((void *)0)
# 4151 "MagickCore/property.c"
          ...
          if (string == (char *) 
# 4157 "MagickCore/property.c" 3 4
                                ((void *)0)
# 4157 "MagickCore/property.c"
                                    )
            goto PropertyLookupFailure;
          { size_t length = strlen((string)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4159 "MagickCore/property.c" 3 4
         ((void *)0)
# 4159 "MagickCore/property.c"
         ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4159 "MagickCore/property.c" 3 4
         ((void *)0)
# 4159 "MagickCore/property.c"
      ...
      if (string != (const char *) 
# 4168 "MagickCore/property.c" 3 4
                                  ((void *)0)
# 4168 "MagickCore/property.c"
                                      )
        {
          { size_t length = strlen((string)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4170 "MagickCore/property.c" 3 4
         ((void *)0)
# 4170 "MagickCore/property.c"
         ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4170 "MagickCore/property.c" 3 4
         ((void *)0)
# 4170 "MagickCore/property.c"
      ...
      if (IsGlob(pattern) != MagickFalse)
        {
          ...
          ResetImagePropertyIterator(property_image);
          while ((key=GetNextImageProperty(property_image)) != (const char *) 
# 4182 "MagickCore/property.c" 3 4
                                                                             ((void *)0)
# 4182 "MagickCore/property.c"
                                                                                 )
            if (GlobExpression(key,pattern,MagickTrue) != MagickFalse)
              {
                string=GetImageProperty(property_image,key,exception);
                if (string != (const char *) 
# 4186 "MagickCore/property.c" 3 4
                                            ((void *)0)
# 4186 "MagickCore/property.c"
                                                )
                  { size_t length=strlen(key)+strlen(string)+2; if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4187 "MagickCore/property.c" 3 4
                 ((void *)0)
# 4187 "MagickCore/property.c"
                 ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4187 "MagickCore/property.c" 3 4
                 ((void *)0)
# 4187 "MagickCore/property.c"
      ...
      if (string != (const char *) 
# 4198 "MagickCore/property.c" 3 4
                                  ((void *)0)
# 4198 "MagickCore/property.c"
                                      )
        {
          { size_t length = strlen((string)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4200 "MagickCore/property.c" 3 4
         ((void *)0)
# 4200 "MagickCore/property.c"
         ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4200 "MagickCore/property.c" 3 4
         ((void *)0)
# 4200 "MagickCore/property.c"
      ...
      if (string != (char *) 
# 4208 "MagickCore/property.c" 3 4
                            ((void *)0)
# 4208 "MagickCore/property.c"
                                )
        {
          { size_t length = strlen((string)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4210 "MagickCore/property.c" 3 4
         ((void *)0)
# 4210 "MagickCore/property.c"
         ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4210 "MagickCore/property.c" 3 4
         ((void *)0)
# 4210 "MagickCore/property.c"
      ...
      if (string != (char *) 
# 4217 "MagickCore/property.c" 3 4
                            ((void *)0)
# 4217 "MagickCore/property.c"
                                )
        {
          { size_t length = strlen((string)); if ((size_t) (q-interpret_text+(ssize_t) length+1) >= extent) { extent+=length; interpret_text=(char *) ResizeQuantumMemory(interpret_text,extent+ 4096,sizeof(*interpret_text)); if (interpret_text == (char *) 
# 4219 "MagickCore/property.c" 3 4
         ((void *)0)
# 4219 "MagickCore/property.c"
         ) { if (property_image != image) property_image=DestroyImage(property_image); if (property_info != image_info) property_info=DestroyImageInfo(property_info); return((char *) 
# 4219 "MagickCore/property.c" 3 4
         ((void *)0)
# 4219 "MagickCore/property.c"
...
PropertyLookupFailure:
      ...
      (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4233,OptionWarning,
...
# 4273 "MagickCore/property.c"
__attribute__ ((visibility ("default"))) char *RemoveImageProperty(Image *image,const char *property)
{
  char
    *value;

  
# 4278 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 4278 "MagickCore/property.c"
 image != (Image *) 
# 4278 "MagickCore/property.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4278 "MagickCore/property.c"
...
# 4278 "MagickCore/property.c"
 "image != (Image *) NULL"
# 4278 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 4278, __extension__ __PRETTY_FUNCTION__); }))
# 4278 "MagickCore/property.c"
                                ;
  
# 4279 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 4279 "MagickCore/property.c"
 image->signature == 0xabacadabUL
# 4279 "MagickCore/property.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4279 "MagickCore/property.c"
...
# 4279 "MagickCore/property.c"
 "image->signature == MagickCoreSignature"
# 4279 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 4279, __extension__ __PRETTY_FUNCTION__); }))
# 4279 "MagickCore/property.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 4281,"%s",image->filename);
  if (image->properties == (void *) 
# 4282 "MagickCore/property.c" 3 4
                                   ((void *)0)
# 4282 "MagickCore/property.c"
                                       )
    return((char *) 
# 4283 "MagickCore/property.c" 3 4
                   ((void *)0)
# 4283 "MagickCore/property.c"
                       );
  value=(char *) RemoveNodeFromSplayTree((SplayTreeInfo *) image->properties,
    property);
  return(value);
}
# 4313 "MagickCore/property.c"
__attribute__ ((visibility ("default"))) void ResetImagePropertyIterator(const Image *image)
{
  
# 4315 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 4315 "MagickCore/property.c"
 image != (Image *) 
# 4315 "MagickCore/property.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4315 "MagickCore/property.c"
...
# 4315 "MagickCore/property.c"
 "image != (Image *) NULL"
# 4315 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 4315, __extension__ __PRETTY_FUNCTION__); }))
# 4315 "MagickCore/property.c"
                                ;
  
# 4316 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 4316 "MagickCore/property.c"
 image->signature == 0xabacadabUL
# 4316 "MagickCore/property.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4316 "MagickCore/property.c"
...
# 4316 "MagickCore/property.c"
 "image->signature == MagickCoreSignature"
# 4316 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 4316, __extension__ __PRETTY_FUNCTION__); }))
# 4316 "MagickCore/property.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 4318,"%s",image->filename);
  if (image->properties == (void *) 
# 4319 "MagickCore/property.c" 3 4
                                   ((void *)0)
# 4319 "MagickCore/property.c"
                                       )
    return;
  ResetSplayTreeIterator((SplayTreeInfo *) image->properties);
}
# 4357 "MagickCore/property.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageProperty(Image *image,
...
# 4369 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 4369 "MagickCore/property.c"
 image != (Image *) 
# 4369 "MagickCore/property.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4369 "MagickCore/property.c"
...
# 4369 "MagickCore/property.c"
 "image != (Image *) NULL"
# 4369 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 4369, __extension__ __PRETTY_FUNCTION__); }))
# 4369 "MagickCore/property.c"
                                ;
  
# 4370 "MagickCore/property.c" 3 4
 ((void) sizeof ((
# 4370 "MagickCore/property.c"
 image->signature == 0xabacadabUL
# 4370 "MagickCore/property.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4370 "MagickCore/property.c"
...
# 4370 "MagickCore/property.c"
 "image->signature == MagickCoreSignature"
# 4370 "MagickCore/property.c" 3 4
 , "MagickCore/property.c", 4370, __extension__ __PRETTY_FUNCTION__); }))
# 4370 "MagickCore/property.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/property.c",__func__,(unsigned long) 4372,"%s",image->filename);
  if (image->properties == (void *) 
# 4373 "MagickCore/property.c" 3 4
                                   ((void *)0)
# 4373 "MagickCore/property.c"
                                       )
    image->properties=NewSplayTree(CompareSplayTreeString,
      RelinquishMagickMemory,RelinquishMagickMemory);
  if (value == (const char *) 
# 4376 "MagickCore/property.c" 3 4
                             ((void *)0)
# 4376 "MagickCore/property.c"
                                 )
  ...
  if (strlen(property) <= 1)
    {
      ...
      (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4383,OptionWarning,
  ...
  if ((property_length > 2) && (*(property+(property_length-2)) == ':') &&
      (*(property+(property_length-1)) == '*'))
    {
      (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4391,OptionWarning,
        "SetReadOnlyProperty","`%s'",property);
      return(MagickFalse);
    }
...
# 4416 "MagickCore/property.c"
    ...
    case 'c':
    {
      if (LocaleCompare("channels",property) == 0)
        {
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4433,OptionWarning,
            "SetReadOnlyProperty","`%s'",property);
          return(MagickFalse);
        }
      if (LocaleCompare("colorspace",property) == 0)
    ...
    case 'd':
    {
      ...
      if (LocaleCompare("delay_units",property) == 0)
        {
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4503,OptionWarning,
            "SetReadOnlyProperty","`%s'",property);
          return(MagickFalse);
        }
...
# 4563 "MagickCore/property.c"
    case 'G':
    case 'g':
    {
      if (LocaleCompare("gamma",property) == 0)
        {
          image->gamma=StringToDouble(value,(char **) 
# 4568 "MagickCore/property.c" 3 4
                                                     ((void *)0)
# 4568 "MagickCore/property.c"
                                                         );
          return(MagickTrue);
        }
    ...
    case 'h':
    {
      if (LocaleCompare("height",property) == 0)
        {
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4589,OptionWarning,
            "SetReadOnlyProperty","`%s'",property);
          return(MagickFalse);
        }
      break;
...
# 4643 "MagickCore/property.c"
    ...
    case 'k':
      if (LocaleCompare("kurtosis",property) == 0)
        {
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4649,OptionWarning,
            "SetReadOnlyProperty","`%s'",property);
          return(MagickFalse);
        }
      break;
    ...
    case 'm':
      if ((LocaleCompare("magick",property) == 0) ||
          ...
          (LocaleCompare("min",property) == 0))
        {
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4672,OptionWarning,
             "SetReadOnlyProperty","`%s'",property);
          return(MagickFalse);
        }
      break;
    ...
    case 'o':
      if (LocaleCompare("opaque",property) == 0)
        {
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4681,OptionWarning,
            "SetReadOnlyProperty","`%s'",property);
          return(MagickFalse);
        }
      break;
...
# 4708 "MagickCore/property.c"
    ...
    case 's':
      if ((LocaleCompare("size",property) == 0) ||
        ...
        {
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4734,OptionWarning,
            "SetReadOnlyProperty","`%s'",property);
          return(MagickFalse);
        }
      break;
    ...
    case 'v':
    {
      if (LocaleCompare("version",property) == 0)
        {
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4786,OptionWarning,
            "SetReadOnlyProperty","`%s'",property);
          return(MagickFalse);
        }
      break;
    ...
    case 'w':
    {
      if (LocaleCompare("width",property) == 0)
        {
          (void) ThrowMagickException(exception,"MagickCore/property.c",__func__,(unsigned long) 4797,OptionWarning,
            "SetReadOnlyProperty","`%s'",property);
          return(MagickFalse);
        }
      break;
    }
# 4817 "MagickCore/property.c"
  }
