# 0 "MagickCore/memory.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/memory.c"
# 83 "MagickCore/memory.c"
...
# 97 "MagickCore/memory.c" 2
# 120 "MagickCore/memory.c"
typedef enum
{
...
typedef struct _MemoryPool
{
  ...
  void
    *blocks[((1024/(4*sizeof(size_t)))+16 +1)+1];
...
static MagickMemoryMethods
  memory_methods =
  {
    ...
    (AcquireAlignedMemoryHandler) 
# 233 "MagickCore/memory.c" 3 4
                                 ((void *)0)
# 233 "MagickCore/memory.c"
                                     ,
    (RelinquishAlignedMemoryHandler) 
# 234 "MagickCore/memory.c" 3 4
                                    ((void *)0)
  
# 235 "MagickCore/memory.c"
 };
# 294 "MagickCore/memory.c"
static inline void *AcquireAlignedMemory_POSIX(const size_t size)
{
  void
    *memory;

  if (posix_memalign(&memory,(8 * 8),size))
    return(
# 300 "MagickCore/memory.c" 3 4
          ((void *)0)
# 300 "MagickCore/memory.c"
              );
  return(memory);
}
# 365 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *AcquireAlignedMemory(const size_t count,const size_t quantum)
{
  size_t
    size;
...
# 372 "MagickCore/memory.c" 3 4
     (*__errno_location ())
# 372 "MagickCore/memory.c"
          =
# 372 "MagickCore/memory.c" 3 4
           12
# 372 "MagickCore/memory.c"
                 ;
      return(
# 373 "MagickCore/memory.c" 3 4
            ((void *)0)
# 373 "MagickCore/memory.c"
                );
    }
  if (memory_methods.acquire_aligned_memory_handler != (AcquireAlignedMemoryHandler) 
# 375 "MagickCore/memory.c" 3 4
                                                                                    ((void *)0)
# 375 "MagickCore/memory.c"
                                                                                        )
    return(memory_methods.acquire_aligned_memory_handler(size,(8 * 8)));
  return(AcquireAlignedMemory_POSIX(size));
}
# 552 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *AcquireMagickMemory(const size_t size)
{
  void
    *memory;
...
# 595 "MagickCore/memory.c"
  return(memory);
}
# 626 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *AcquireCriticalMemory(const size_t size)
{
  void
    *memory;
  ...
  if (memory == (void *) 
# 635 "MagickCore/memory.c" 3 4
                        ((void *)0)
# 635 "MagickCore/memory.c"
                            )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 636 "MagickCore/memory.c" 3 4
   (*__errno_location ())
# 636 "MagickCore/memory.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/memory.c",__func__,(unsigned long) 636,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  return(memory);
}
# 665 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *AcquireQuantumMemory(const size_t count,const size_t quantum)
{
  size_t
    size;
...
# 673 "MagickCore/memory.c" 3 4
     (*__errno_location ())
# 673 "MagickCore/memory.c"
          =
# 673 "MagickCore/memory.c" 3 4
           12
# 673 "MagickCore/memory.c"
                 ;
      return(
# 674 "MagickCore/memory.c" 3 4
            ((void *)0)
# 674 "MagickCore/memory.c"
                );
    }
  return(AcquireMagickMemory(size));
}
# 705 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) MemoryInfo *AcquireVirtualMemory(const size_t count,
...
# 719 "MagickCore/memory.c" 3 4
     (*__errno_location ())
# 719 "MagickCore/memory.c"
          =
# 719 "MagickCore/memory.c" 3 4
           12
# 719 "MagickCore/memory.c"
                 ;
      return((MemoryInfo *) 
# 720 "MagickCore/memory.c" 3 4
                           ((void *)0)
# 720 "MagickCore/memory.c"
                               );
    }
  ...
  memory_info=(MemoryInfo *) __builtin_assume_aligned((AcquireAlignedMemory(1, sizeof(*memory_info))),(8 * 8))
                          ;
  if (memory_info == (MemoryInfo *) 
# 739 "MagickCore/memory.c" 3 4
                                   ((void *)0)
# 739 "MagickCore/memory.c"
                                       )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 740 "MagickCore/memory.c" 3 4
   (*__errno_location ())
# 740 "MagickCore/memory.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/memory.c",__func__,(unsigned long) 740,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  (void) memset(memory_info,0,sizeof(*memory_info));
  memory_info->length=size;
  memory_info->signature=0xabacadabUL;
  if ((virtual_anonymous_memory == 1) && (size <= GetMaxMemoryRequest()))
    {
      memory_info->blob=AcquireAlignedMemory(1,size);
      if (memory_info->blob != 
# 747 "MagickCore/memory.c" 3 4
                              ((void *)0)
# 747 "MagickCore/memory.c"
                                  )
        memory_info->type=AlignedVirtualMemory;
    }
  if (memory_info->blob == 
# 750 "MagickCore/memory.c" 3 4
                          ((void *)0)
# 750 "MagickCore/memory.c"
                              )
    {
      ...
      memory_info->blob=
# 755 "MagickCore/memory.c" 3 4
                       ((void *)0)
# 755 "MagickCore/memory.c"
                           ;
      if (size <= GetMaxMemoryRequest())
        memory_info->blob=MapBlob(-1,IOMode,0,size);
      if (memory_info->blob != 
# 758 "MagickCore/memory.c" 3 4
                              ((void *)0)
# 758 "MagickCore/memory.c"
                                  )
          ...
          if (file != -1)
            {
              ...
              offset=(MagickOffsetType) lseek(file,(off_t) (size-1),
# 774 "MagickCore/memory.c" 3 4
                                                                   0
# 774 "MagickCore/memory.c"
                                                                           );
              if ((offset == (MagickOffsetType) (size-1)) &&
                  (write(file,"",1) == 1))
                {
                  ...
                  if (memory_info->blob != 
# 784 "MagickCore/memory.c" 3 4
                                          ((void *)0)
# 784 "MagickCore/memory.c"
                                              )
                    memory_info->type=MapVirtualMemory;
                  else
                    {
  ...
  if (memory_info->blob == 
# 797 "MagickCore/memory.c" 3 4
                          ((void *)0)
# 797 "MagickCore/memory.c"
                              )
    {
      memory_info->blob=AcquireQuantumMemory(1,size);
      if (memory_info->blob != 
# 800 "MagickCore/memory.c" 3 4
                              ((void *)0)
# 800 "MagickCore/memory.c"
                                  )
        memory_info->type=UnalignedVirtualMemory;
    }
  if (memory_info->blob == 
# 803 "MagickCore/memory.c" 3 4
                          ((void *)0)
# 803 "MagickCore/memory.c"
                              )
    memory_info=RelinquishVirtualMemory(memory_info);
  return(memory_info);
}
# 837 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *CopyMagickMemory(void *__restrict__ destination,
  const void *__restrict__ source,const size_t size)
{
  const unsigned char
    *p;
...
# 846 "MagickCore/memory.c" 3 4
 ((void) sizeof ((
# 846 "MagickCore/memory.c"
 destination != (void *) 
# 846 "MagickCore/memory.c" 3 4
...
# 846 "MagickCore/memory.c" 3 4
 , "MagickCore/memory.c", 846, __extension__ __PRETTY_FUNCTION__); }))
# 846 "MagickCore/memory.c"
                                     ;
  
# 847 "MagickCore/memory.c" 3 4
 ((void) sizeof ((
# 847 "MagickCore/memory.c"
 source != (const void *) 
# 847 "MagickCore/memory.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 847 "MagickCore/memory.c"
...
# 847 "MagickCore/memory.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 847 "MagickCore/memory.c"
 "source != (const void *) NULL"
# 847 "MagickCore/memory.c" 3 4
 , "MagickCore/memory.c", 847, __extension__ __PRETTY_FUNCTION__); }))
# 847 "MagickCore/memory.c"
                                      ;
  ...
  if (((q+size) < p) || (q > (p+size)))
    switch (size)
    {
      ...
      case 8: *q++=(*p++); __attribute__((fallthrough));
      case 7: *q++=(*p++); __attribute__((fallthrough));
      case 6: *q++=(*p++); __attribute__((fallthrough));
      case 5: *q++=(*p++); __attribute__((fallthrough));
      case 4: *q++=(*p++); __attribute__((fallthrough));
      case 3: *q++=(*p++); __attribute__((fallthrough));
      case 2: *q++=(*p++); __attribute__((fallthrough));
      case 1: *q++=(*p++); __attribute__((fallthrough));
      case 0: return(destination);
    }
  return(memmove(destination,source,size));
}
# 885 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void DestroyMagickMemory(void)
{
# 906 "MagickCore/memory.c"
}
# 1013 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void GetMagickMemoryMethods(
  AcquireMemoryHandler *acquire_memory_handler,
  ResizeMemoryHandler *resize_memory_handler,
  DestroyMemoryHandler *destroy_memory_handler)
{
  
# 1018 "MagickCore/memory.c" 3 4
 ((void) sizeof ((
# 1018 "MagickCore/memory.c"
 acquire_memory_handler != (AcquireMemoryHandler *) 
# 1018 "MagickCore/memory.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1018 "MagickCore/memory.c"
 acquire_memory_handler != (AcquireMemoryHandler *) 
# 1018 "MagickCore/memory.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1018 "MagickCore/memory.c"
 "acquire_memory_handler != (AcquireMemoryHandler *) NULL"
# 1018 "MagickCore/memory.c" 3 4
 , "MagickCore/memory.c", 1018, __extension__ __PRETTY_FUNCTION__); }))
# 1018 "MagickCore/memory.c"
                                                                ;
  
# 1019 "MagickCore/memory.c" 3 4
 ((void) sizeof ((
# 1019 "MagickCore/memory.c"
 resize_memory_handler != (ResizeMemoryHandler *) 
# 1019 "MagickCore/memory.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1019 "MagickCore/memory.c"
 resize_memory_handler != (ResizeMemoryHandler *) 
# 1019 "MagickCore/memory.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1019 "MagickCore/memory.c"
 "resize_memory_handler != (ResizeMemoryHandler *) NULL"
# 1019 "MagickCore/memory.c" 3 4
 , "MagickCore/memory.c", 1019, __extension__ __PRETTY_FUNCTION__); }))
# 1019 "MagickCore/memory.c"
                                                              ;
  
# 1020 "MagickCore/memory.c" 3 4
 ((void) sizeof ((
# 1020 "MagickCore/memory.c"
 destroy_memory_handler != (DestroyMemoryHandler *) 
# 1020 "MagickCore/memory.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1020 "MagickCore/memory.c"
 destroy_memory_handler != (DestroyMemoryHandler *) 
# 1020 "MagickCore/memory.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1020 "MagickCore/memory.c"
 "destroy_memory_handler != (DestroyMemoryHandler *) NULL"
# 1020 "MagickCore/memory.c" 3 4
 , "MagickCore/memory.c", 1020, __extension__ __PRETTY_FUNCTION__); }))
# 1020 "MagickCore/memory.c"
                                                                ;
...
# 1044 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) size_t GetMaxMemoryRequest(void)
{
  ...
  if (max_memory_request == 0)
    {
      ...
      max_memory_request=(size_t) (0x7fffffffffffffffL
# 1053 "MagickCore/memory.c"
                                 );
      value=GetPolicyValue("system:max-memory-request");
      if (value != (char *) 
# 1055 "MagickCore/memory.c" 3 4
                           ((void *)0)
# 1055 "MagickCore/memory.c"
                               )
        {



          max_memory_request=(((StringToSizeType(value,100.0)) > (StringToSizeType("16MiB",100.0))) ? (StringToSizeType(value,100.0)) : (StringToSizeType("16MiB",100.0)))
                                                     ;
          value=DestroyString(value);
        }
    }
  return((((max_memory_request) < ((size_t) (0x7fffffffffffffffL
# 1065 "MagickCore/memory.c"
        ))) ? (max_memory_request) : ((size_t) (0x7fffffffffffffffL
# 1065 "MagickCore/memory.c"
        ))));
}
# 1090 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *GetVirtualMemoryBlob(const MemoryInfo *memory_info)
{
  
# 1092 "MagickCore/memory.c" 3 4
 ((void) sizeof ((
# 1092 "MagickCore/memory.c"
...
# 1092 "MagickCore/memory.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1092 "MagickCore/memory.c"
 "memory_info != (const MemoryInfo *) NULL"
# 1092 "MagickCore/memory.c" 3 4
 , "MagickCore/memory.c", 1092, __extension__ __PRETTY_FUNCTION__); }))
# 1092 "MagickCore/memory.c"
                                                 ;
  
# 1093 "MagickCore/memory.c" 3 4
 ((void) sizeof ((
# 1093 "MagickCore/memory.c"
 memory_info->signature == 0xabacadabUL
# 1093 "MagickCore/memory.c" 3 4
...
# 1093 "MagickCore/memory.c" 3 4
 , "MagickCore/memory.c", 1093, __extension__ __PRETTY_FUNCTION__); }))
# 1093 "MagickCore/memory.c"
                                                      ;
  return(memory_info->blob);
}
# 1120 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *RelinquishAlignedMemory(void *memory)
{
  if (memory == (void *) 
# 1122 "MagickCore/memory.c" 3 4
                        ((void *)0)
# 1122 "MagickCore/memory.c"
                            )
    return((void *) 
# 1123 "MagickCore/memory.c" 3 4
                   ((void *)0)
# 1123 "MagickCore/memory.c"
                       );
  if (memory_methods.relinquish_aligned_memory_handler != (RelinquishAlignedMemoryHandler) 
# 1124 "MagickCore/memory.c" 3 4
                                                                                          ((void *)0)
# 1124 "MagickCore/memory.c"
                                                                                              )
    {
      memory_methods.relinquish_aligned_memory_handler(memory);
      return(
# 1127 "MagickCore/memory.c" 3 4
            ((void *)0)
# 1127 "MagickCore/memory.c"
                );
    }
  ...
  return(
# 1136 "MagickCore/memory.c" 3 4
        ((void *)0)
# 1136 "MagickCore/memory.c"
            );
}
# 1162 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *RelinquishMagickMemory(void *memory)
{
  if (memory == (void *) 
# 1164 "MagickCore/memory.c" 3 4
                        ((void *)0)
# 1164 "MagickCore/memory.c"
                            )
    return((void *) 
# 1165 "MagickCore/memory.c" 3 4
                   ((void *)0)
# 1165 "MagickCore/memory.c"
                       );

  memory_methods.destroy_memory_handler(memory);
# 1204 "MagickCore/memory.c"
  return((void *) 
# 1204 "MagickCore/memory.c" 3 4
                 ((void *)0)
# 1204 "MagickCore/memory.c"
                     );
}
# 1229 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) MemoryInfo *RelinquishVirtualMemory(MemoryInfo *memory_info)
{
  
# 1231 "MagickCore/memory.c" 3 4
 ((void) sizeof ((
# 1231 "MagickCore/memory.c"
...
# 1231 "MagickCore/memory.c" 3 4
 , "MagickCore/memory.c", 1231, __extension__ __PRETTY_FUNCTION__); }))
# 1231 "MagickCore/memory.c"
                                           ;
  
# 1232 "MagickCore/memory.c" 3 4
 ((void) sizeof ((
# 1232 "MagickCore/memory.c"
 memory_info->signature == 0xabacadabUL
# 1232 "MagickCore/memory.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1232 "MagickCore/memory.c"
...
# 1232 "MagickCore/memory.c"
 "memory_info->signature == MagickCoreSignature"
# 1232 "MagickCore/memory.c" 3 4
 , "MagickCore/memory.c", 1232, __extension__ __PRETTY_FUNCTION__); }))
# 1232 "MagickCore/memory.c"
                                                      ;
  if (memory_info->blob != (void *) 
# 1233 "MagickCore/memory.c" 3 4
                                   ((void *)0)
# 1233 "MagickCore/memory.c"
                                       )
    switch (memory_info->type)
    {
      ...
      case MapVirtualMemory:
      {
        ...
        memory_info->blob=
# 1245 "MagickCore/memory.c" 3 4
                         ((void *)0)
# 1245 "MagickCore/memory.c"
                             ;
...
# 1292 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *ResetMagickMemory(void *memory,int c,const size_t size)
{
...
# 1300 "MagickCore/memory.c" 3 4
 ((void) sizeof ((
# 1300 "MagickCore/memory.c"
 memory != (void *) 
# 1300 "MagickCore/memory.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1300 "MagickCore/memory.c"
...
# 1300 "MagickCore/memory.c"
 "memory != (void *) NULL"
# 1300 "MagickCore/memory.c" 3 4
 , "MagickCore/memory.c", 1300, __extension__ __PRETTY_FUNCTION__); }))
# 1300 "MagickCore/memory.c"
                                ;
  while (n-- != 0)
   *p++=(unsigned char) c;
...
# 1324 "MagickCore/memory.c"
__attribute__ ((visibility ("hidden"))) void ResetMaxMemoryRequest(void)
{
  max_memory_request=0;
}
# 1347 "MagickCore/memory.c"
__attribute__ ((visibility ("hidden"))) void ResetVirtualAnonymousMemory(void)
{
  virtual_anonymous_memory=0;
}
# 1399 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *ResizeMagickMemory(void *memory,const size_t size)
{
  void
    *block;

  if (memory == (void *) 
# 1404 "MagickCore/memory.c" 3 4
                        ((void *)0)
# 1404 "MagickCore/memory.c"
                            )
    return(AcquireMagickMemory(size));

  block=memory_methods.resize_memory_handler(memory,size == 0 ? 1UL : size);
  if (block == (void *) 
# 1408 "MagickCore/memory.c" 3 4
                       ((void *)0)
# 1408 "MagickCore/memory.c"
                           )
    memory=RelinquishMagickMemory(memory);
# 1427 "MagickCore/memory.c"
  return(block);
}
# 1459 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void *ResizeQuantumMemory(void *memory,const size_t count,
  const size_t quantum)
{
  size_t
    size;
...
# 1468 "MagickCore/memory.c" 3 4
     (*__errno_location ())
# 1468 "MagickCore/memory.c"
          =
# 1468 "MagickCore/memory.c" 3 4
           12
# 1468 "MagickCore/memory.c"
      ...
      memory=RelinquishMagickMemory(memory);
      return(
# 1470 "MagickCore/memory.c" 3 4
            ((void *)0)
# 1470 "MagickCore/memory.c"
                );
    }
  return(ResizeMagickMemory(memory,size));
}
# 1502 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void SetMagickAlignedMemoryMethods(
...
# 1541 "MagickCore/memory.c"
__attribute__ ((visibility ("default"))) void SetMagickMemoryMethods(
  AcquireMemoryHandler acquire_memory_handler,
  ResizeMemoryHandler resize_memory_handler,
  DestroyMemoryHandler destroy_memory_handler)
{
  ...
  if (acquire_memory_handler != (AcquireMemoryHandler) 
# 1549 "MagickCore/memory.c" 3 4
                                                      ((void *)0)
# 1549 "MagickCore/memory.c"
                                                          )
    memory_methods.acquire_memory_handler=acquire_memory_handler;
  if (resize_memory_handler != (ResizeMemoryHandler) 
# 1551 "MagickCore/memory.c" 3 4
                                                    ((void *)0)
# 1551 "MagickCore/memory.c"
                                                        )
    memory_methods.resize_memory_handler=resize_memory_handler;
  if (destroy_memory_handler != (DestroyMemoryHandler) 
# 1553 "MagickCore/memory.c" 3 4
                                                      ((void *)0)
# 1553 "MagickCore/memory.c"
                                                          )
    memory_methods.destroy_memory_handler=destroy_memory_handler;
}
# 1579 "MagickCore/memory.c"
__attribute__ ((visibility ("hidden"))) void SetMaxMemoryRequest(const MagickSizeType limit)
{
  max_memory_request=(((limit) < (GetMaxMemoryRequest())) ? (limit) : (GetMaxMemoryRequest()));
}
# 1610 "MagickCore/memory.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType ShredMagickMemory(void *memory,
  const size_t length)
{
  RandomInfo
    *random_info;
  ...
  if ((memory == 
# 1628 "MagickCore/memory.c" 3 4
                ((void *)0)
# 1628 "MagickCore/memory.c"
                    ) || (length == 0))
    return(MagickFalse);
  if (passes == -1)
    {
      ...
      if (property != (char *) 
# 1637 "MagickCore/memory.c" 3 4
                              ((void *)0)
# 1637 "MagickCore/memory.c"
                                  )
        {
      ...
      if (property != (char *) 
# 1643 "MagickCore/memory.c" 3 4
                              ((void *)0)
# 1643 "MagickCore/memory.c"
                                  )
        {
          passes=(ssize_t) StringToInteger(property);
          property=DestroyString(property);
  ...
  quantum=(size_t) (((length) < (16384)) ? (length) : (16384));
  ...
  for (i=0; i < passes; i++)
  {
    ...
    for (j=0; j < length; j+=quantum)
    {
      ...
      (void) memcpy(p,GetStringInfoDatum(key),(size_t)
        (((quantum) < (length-j)) ? (quantum) : (length-j)));
      p+=quantum;
    }
    if (j < length)
      break;
