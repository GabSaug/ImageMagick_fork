# 0 "MagickCore/compare.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/compare.c"
# 43 "MagickCore/compare.c"
...
# 79 "MagickCore/compare.c" 2
# 113 "MagickCore/compare.c"
__attribute__ ((visibility ("default"))) Image *CompareImages(Image *image,const Image *reconstruct_image,
...
# 150 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 150 "MagickCore/compare.c"
 image != (Image *) 
# 150 "MagickCore/compare.c" 3 4
...
# 150 "MagickCore/compare.c"
 "image != (Image *) NULL"
# 150 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 150, __extension__ __PRETTY_FUNCTION__); }))
# 150 "MagickCore/compare.c"
                                ;
  
# 151 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 151 "MagickCore/compare.c"
...
# 151 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 151, __extension__ __PRETTY_FUNCTION__); }))
# 151 "MagickCore/compare.c"
                                                ;
  
# 152 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 152 "MagickCore/compare.c"
...
# 152 "MagickCore/compare.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 152 "MagickCore/compare.c"
 "reconstruct_image != (const Image *) NULL"
# 152 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 152, __extension__ __PRETTY_FUNCTION__); }))
# 152 "MagickCore/compare.c"
                                                  ;
  
# 153 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 153 "MagickCore/compare.c"
 reconstruct_image->signature == 0xabacadabUL
# 153 "MagickCore/compare.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 153 "MagickCore/compare.c"
 reconstruct_image->signature == 0xabacadabUL
...
# 153 "MagickCore/compare.c"
 "reconstruct_image->signature == MagickCoreSignature"
# 153 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 153, __extension__ __PRETTY_FUNCTION__); }))
# 153 "MagickCore/compare.c"
                                                            ;
  
# 154 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 154 "MagickCore/compare.c"
 distortion != (double *) 
# 154 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 154 "MagickCore/compare.c"
...
# 154 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 154, __extension__ __PRETTY_FUNCTION__); }))
# 154 "MagickCore/compare.c"
                                      ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/compare.c",__func__,(unsigned long) 156,"%s",image->filename);
  *distortion=0.0;
  status=GetImageDistortion(image,reconstruct_image,metric,distortion,
    exception);
  if (status == MagickFalse)
    return((Image *) 
# 161 "MagickCore/compare.c" 3 4
                    ((void *)0)
# 161 "MagickCore/compare.c"
                        );
  columns=(((image->columns) > (reconstruct_image->columns)) ? (image->columns) : (reconstruct_image->columns));
  rows=(((image->rows) > (reconstruct_image->rows)) ? (image->rows) : (reconstruct_image->rows));
  SetGeometry(image,&geometry);
  geometry.width=columns;
  geometry.height=rows;
  clone_image=CloneImage(image,0,0,MagickTrue,exception);
  if (clone_image == (Image *) 
# 168 "MagickCore/compare.c" 3 4
                              ((void *)0)
# 168 "MagickCore/compare.c"
                                  )
    return((Image *) 
# 169 "MagickCore/compare.c" 3 4
                    ((void *)0)
# 169 "MagickCore/compare.c"
                        );
  (void) SetImageMask(clone_image,ReadPixelMask,(Image *) 
# 170 "MagickCore/compare.c" 3 4
                                                         ((void *)0)
# 170 "MagickCore/compare.c"
                                                             ,exception);
  difference_image=ExtentImage(clone_image,&geometry,exception);
  clone_image=DestroyImage(clone_image);
  if (difference_image == (Image *) 
# 173 "MagickCore/compare.c" 3 4
                                   ((void *)0)
# 173 "MagickCore/compare.c"
                                       )
    return((Image *) 
# 174 "MagickCore/compare.c" 3 4
                    ((void *)0)
# 174 "MagickCore/compare.c"
                        );
  ...
  if (highlight_image == (Image *) 
# 177 "MagickCore/compare.c" 3 4
                                  ((void *)0)
# 177 "MagickCore/compare.c"
                                      )
    {
      difference_image=DestroyImage(difference_image);
      return((Image *) 
# 180 "MagickCore/compare.c" 3 4
                      ((void *)0)
# 180 "MagickCore/compare.c"
                          );
    }
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 187 "MagickCore/compare.c" 3 4
                      ((void *)0)
# 187 "MagickCore/compare.c"
                          );
    }
  (void) SetImageMask(highlight_image,ReadPixelMask,(Image *) 
# 189 "MagickCore/compare.c" 3 4
                                                             ((void *)0)
# 189 "MagickCore/compare.c"
                                                                 ,exception);
...
# 193 "MagickCore/compare.c" 3 4
                                ((void *)0)
# 193 "MagickCore/compare.c"
                                    )
  ...
  if (artifact != (const char *) 
# 197 "MagickCore/compare.c" 3 4
                                ((void *)0)
# 197 "MagickCore/compare.c"
                                    )
  ...
  if (artifact != (const char *) 
# 201 "MagickCore/compare.c" 3 4
                                ((void *)0)
# 201 "MagickCore/compare.c"
                                    )
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    if ((p == (const Quantum *) 
# 235 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 235 "MagickCore/compare.c"
                                   ) || (q == (const Quantum *) 
# 235 "MagickCore/compare.c" 3 4
                                                                ((void *)0)
# 235 "MagickCore/compare.c"
        ...
        (r == (Quantum *) 
# 236 "MagickCore/compare.c" 3 4
                         ((void *)0)
# 236 "MagickCore/compare.c"
                             ))
      {
        status=MagickFalse;
        continue;
    ...
    for (x=0; x < (ssize_t) columns; x++)
    {
      ...
      if ((GetPixelReadMask(image,p) <= (((Quantum) 65535.0)/2)) ||
          (GetPixelReadMask(reconstruct_image,q) <= (((Quantum) 65535.0)/2)))
        {
      ...
      Sa=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelAlpha(image,p);
      Da=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelAlpha(reconstruct_image,q);
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        double
          distance,
  ...
  const Image *reconstruct_image,double *distortion,ExceptionInfo *exception)
{
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    q=GetCacheViewVirtualPixels(reconstruct_view,0,y,columns,1,exception);
    if ((p == (const Quantum *) 
# 399 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 399 "MagickCore/compare.c"
                                   ) || (q == (const Quantum *) 
# 399 "MagickCore/compare.c" 3 4
                                                                ((void *)0)
# 399 "MagickCore/compare.c"
  ...
  const Image *reconstruct_image,double *distortion,ExceptionInfo *exception)
{
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    q=GetCacheViewVirtualPixels(reconstruct_view,0,y,columns,1,exception);
    if ((p == (const Quantum *) 
# 522 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 522 "MagickCore/compare.c"
                                   ) || (q == (Quantum *) 
# 522 "MagickCore/compare.c" 3 4
                                                          ((void *)0)
# 522 "MagickCore/compare.c"
  ...
  const Image *reconstruct_image,double *distortion,ExceptionInfo *exception)
{
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    q=GetCacheViewVirtualPixels(reconstruct_view,0,y,columns,1,exception);
    if ((p == (const Quantum *) 
# 643 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 643 "MagickCore/compare.c"
                                   ) || (q == (const Quantum *) 
# 643 "MagickCore/compare.c" 3 4
                                                                ((void *)0)
# 643 "MagickCore/compare.c"
    ...
    for (x=0; x < (ssize_t) columns; x++)
    {
      ...
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        ...
        if ((traits == UndefinedPixelTrait) ||
          ...
          continue;
        if (channel == AlphaPixelChannel)
          distance=((double) 1.0/(double) ((Quantum) 65535.0))*fabs((double) p[i]-(double)
            GetPixelChannel(reconstruct_image,channel,q));
        else
          distance=((double) 1.0/(double) ((Quantum) 65535.0))*fabs(Sa*(double) p[i]-Da*(double)
            GetPixelChannel(reconstruct_image,channel,q));
  ...
  const Image *reconstruct_image,double *distortion,ExceptionInfo *exception)
{
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    q=GetCacheViewVirtualPixels(reconstruct_view,0,y,columns,1,exception);
    if ((p == (const Quantum *) 
# 752 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 752 "MagickCore/compare.c"
                                   ) || (q == (const Quantum *) 
# 752 "MagickCore/compare.c" 3 4
                                                                ((void *)0)
# 752 "MagickCore/compare.c"
  ...
  image->error.normalized_mean_error=area*((double) 1.0/(double) ((Quantum) 65535.0))*((double) 1.0/(double) ((Quantum) 65535.0))*mean_error;
  image->error.normalized_maximum_error=((double) 1.0/(double) ((Quantum) 65535.0))*maximum_error;
  return(status);
}
  ...
  const Image *reconstruct_image,double *distortion,ExceptionInfo *exception)
{
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    q=GetCacheViewVirtualPixels(reconstruct_view,0,y,columns,1,exception);
    if ((p == (const Quantum *) 
# 864 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 864 "MagickCore/compare.c"
                                   ) || (q == (const Quantum *) 
# 864 "MagickCore/compare.c" 3 4
                                                                ((void *)0)
# 864 "MagickCore/compare.c"
  ...
  ExceptionInfo *exception)
{
  ...
  if ((image_statistics == (ChannelStatistics *) 
# 969 "MagickCore/compare.c" 3 4
                                                ((void *)0)
# 969 "MagickCore/compare.c"
                                                    ) ||
      (reconstruct_statistics == (ChannelStatistics *) 
# 970 "MagickCore/compare.c" 3 4
                                                      ((void *)0)
# 970 "MagickCore/compare.c"
                                                          ))
    {
      if (image_statistics != (ChannelStatistics *) 
# 972 "MagickCore/compare.c" 3 4
                                                   ((void *)0)
# 972 "MagickCore/compare.c"
                                                       )
        image_statistics=(ChannelStatistics *) RelinquishMagickMemory(
          image_statistics);
      if (reconstruct_statistics != (ChannelStatistics *) 
# 975 "MagickCore/compare.c" 3 4
                                                         ((void *)0)
# 975 "MagickCore/compare.c"
                                                             )
        reconstruct_statistics=(ChannelStatistics *) RelinquishMagickMemory(
          reconstruct_statistics);
      return(MagickFalse);
    }
  (void) memset(distortion,0,(64 +1)*sizeof(*distortion));
  (void) memset(alpha_variance,0,(64 +1)*sizeof(*alpha_variance));
  (void) memset(beta_variance,0,(64 +1)*sizeof(*beta_variance));
  status=MagickTrue;
  progress=0;
  columns=(((image->columns) > (reconstruct_image->columns)) ? (image->columns) : (reconstruct_image->columns));
  rows=(((image->rows) > (reconstruct_image->rows)) ? (image->rows) : (reconstruct_image->rows));
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    q=GetCacheViewVirtualPixels(reconstruct_view,0,y,columns,1,exception);
    if ((p == (const Quantum *) 
# 1000 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 1000 "MagickCore/compare.c"
                                   ) || (q == (const Quantum *) 
# 1000 "MagickCore/compare.c" 3 4
                                                                ((void *)0)
# 1000 "MagickCore/compare.c"
    ...
    for (x=0; x < (ssize_t) columns; x++)
    {
      ...
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        ...
        if (channel == AlphaPixelChannel)
          {
            alpha=((double) 1.0/(double) ((Quantum) 65535.0))*((double) p[i]-image_statistics[channel].mean);
            beta=((double) 1.0/(double) ((Quantum) 65535.0))*((double) GetPixelChannel(reconstruct_image,
              channel,q)-reconstruct_statistics[channel].mean);
          }
        else
          {
            alpha=((double) 1.0/(double) ((Quantum) 65535.0))*(Sa*(double) p[i]-
              image_statistics[channel].mean);
            beta=((double) 1.0/(double) ((Quantum) 65535.0))*(Da*(double) GetPixelChannel(reconstruct_image,
              channel,q)-reconstruct_statistics[channel].mean);
          }
...
# 1054 "MagickCore/compare.c" 3 4
                                                          ((void *)0)
# 1054 "MagickCore/compare.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"Similarity/Image",progress,rows);
  ...
  const Image *reconstruct_image,double *distortion,ExceptionInfo *exception)
{
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    q=GetCacheViewVirtualPixels(reconstruct_view,0,y,columns,1,exception);
    if ((p == (const Quantum *) 
# 1137 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 1137 "MagickCore/compare.c"
                                   ) || (q == (const Quantum *) 
# 1137 "MagickCore/compare.c" 3 4
                                                                ((void *)0)
# 1137 "MagickCore/compare.c"
...
# 1233 "MagickCore/compare.c" 3 4
                                                ((void *)0)
# 1233 "MagickCore/compare.c"
                                                    )
    return(MagickFalse);
  reconstruct_phash=GetImagePerceptualHash(reconstruct_image,exception);
  if (reconstruct_phash == (ChannelPerceptualHash *) 
# 1236 "MagickCore/compare.c" 3 4
                                                    ((void *)0)
# 1236 "MagickCore/compare.c"
                                                        )
    {
  ...
  if ((artifact != (const char *) 
# 1277 "MagickCore/compare.c" 3 4
                                 ((void *)0)
# 1277 "MagickCore/compare.c"
                                     ) &&
  ...
  const Image *reconstruct_image,double *distortion,ExceptionInfo *exception)
{
  ...
  if (artifact != (const char *) 
# 1359 "MagickCore/compare.c" 3 4
                                ((void *)0)
# 1359 "MagickCore/compare.c"
                                    )
    radius=StringToDouble(artifact,(char **) 
# 1360 "MagickCore/compare.c" 3 4
                                            ((void *)0)
# 1360 "MagickCore/compare.c"
                                                );
  sigma=1.5;
  artifact=GetImageArtifact(image,"compare:ssim-sigma");
  if (artifact != (const char *) 
# 1363 "MagickCore/compare.c" 3 4
                                ((void *)0)
# 1363 "MagickCore/compare.c"
                                    )
    sigma=StringToDouble(artifact,(char **) 
# 1364 "MagickCore/compare.c" 3 4
                                           ((void *)0)
# 1364 "MagickCore/compare.c"
                                               );
  (void) FormatLocaleString(geometry,4096,"gaussian:%.20gx%.20g",
    radius,sigma);
  kernel_info=AcquireKernelInfo(geometry,exception);
  if (kernel_info == (KernelInfo *) 
# 1368 "MagickCore/compare.c" 3 4
                                   ((void *)0)
# 1368 "MagickCore/compare.c"
                                       )
    { (void) ThrowMagickException(exception,"MagickCore/compare.c",__func__,(unsigned long) 1369,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  c1=pow(0.01*1.0,2.0);
  artifact=GetImageArtifact(image,"compare:ssim-k1");
  if (artifact != (const char *) 
# 1373 "MagickCore/compare.c" 3 4
                                ((void *)0)
# 1373 "MagickCore/compare.c"
                                    )
    c1=pow(StringToDouble(artifact,(char **) 
# 1374 "MagickCore/compare.c" 3 4
                                            ((void *)0)
# 1374 "MagickCore/compare.c"
                                                )*1.0,2.0);
  c2=pow(0.03*1.0,2.0);
  artifact=GetImageArtifact(image,"compare:ssim-k2");
  if (artifact != (const char *) 
# 1377 "MagickCore/compare.c" 3 4
                                ((void *)0)
# 1377 "MagickCore/compare.c"
                                    )
    c2=pow(StringToDouble(artifact,(char **) 
# 1378 "MagickCore/compare.c" 3 4
                                            ((void *)0)
# 1378 "MagickCore/compare.c"
                                                )*1.0,2.0);
  status=MagickTrue;
  area=0.0;
  rows=(((image->rows) > (reconstruct_image->rows)) ? (image->rows) : (reconstruct_image->rows));
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    q=GetCacheViewVirtualPixels(reconstruct_view,-((ssize_t) kernel_info->width/
      ...
      kernel_info->height,exception);
    if ((p == (const Quantum *) 
# 1413 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 1413 "MagickCore/compare.c"
                                   ) || (q == (const Quantum *) 
# 1413 "MagickCore/compare.c" 3 4
                                                                ((void *)0)
# 1413 "MagickCore/compare.c"
    ...
    for (x=0; x < (ssize_t) columns; x++)
    {
      double
        x_pixel_mu[64 +1],
        x_pixel_sigma_squared[64 +1],
        xy_sigma[64 +1],
        y_pixel_mu[64 +1],
        y_pixel_sigma_squared[64 +1];

      const Quantum
        *__restrict__ reference,
        *__restrict__ target;
        ...
        for (u=0; u < (ssize_t) kernel_info->width; u++)
        {
          for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
          {
            ...
            if ((traits == UndefinedPixelTrait) ||
                ...
                ((reconstruct_traits & UpdatePixelTrait) == 0))
              continue;
            x_pixel=((double) 1.0/(double) ((Quantum) 65535.0))*(double) reference[i];
            x_pixel_mu[i]+=(*k)*x_pixel;
            x_pixel_sigma_squared[i]+=(*k)*x_pixel*x_pixel;
            y_pixel=((double) 1.0/(double) ((Quantum) 65535.0))*(double)
...
__attribute__ ((visibility ("default"))) MagickBooleanType GetImageDistortion(Image *image,
...
# 1580 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1580 "MagickCore/compare.c"
 image != (Image *) 
# 1580 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1580 "MagickCore/compare.c"
...
# 1580 "MagickCore/compare.c"
 "image != (Image *) NULL"
# 1580 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1580, __extension__ __PRETTY_FUNCTION__); }))
# 1580 "MagickCore/compare.c"
                                ;
  
# 1581 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1581 "MagickCore/compare.c"
 image->signature == 0xabacadabUL
# 1581 "MagickCore/compare.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1581 "MagickCore/compare.c"
...
# 1581 "MagickCore/compare.c"
 "image->signature == MagickCoreSignature"
# 1581 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1581, __extension__ __PRETTY_FUNCTION__); }))
# 1581 "MagickCore/compare.c"
                                                ;
  
# 1582 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1582 "MagickCore/compare.c"
 reconstruct_image != (const Image *) 
# 1582 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1582 "MagickCore/compare.c"
...
# 1582 "MagickCore/compare.c"
 "reconstruct_image != (const Image *) NULL"
# 1582 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1582, __extension__ __PRETTY_FUNCTION__); }))
# 1582 "MagickCore/compare.c"
                                                  ;
  
# 1583 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1583 "MagickCore/compare.c"
 reconstruct_image->signature == 0xabacadabUL
# 1583 "MagickCore/compare.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1583 "MagickCore/compare.c"
...
# 1583 "MagickCore/compare.c"
 "reconstruct_image->signature == MagickCoreSignature"
# 1583 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1583, __extension__ __PRETTY_FUNCTION__); }))
# 1583 "MagickCore/compare.c"
                                                            ;
  
# 1584 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1584 "MagickCore/compare.c"
 distortion != (double *) 
# 1584 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1584 "MagickCore/compare.c"
...
# 1584 "MagickCore/compare.c"
 "distortion != (double *) NULL"
# 1584 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1584, __extension__ __PRETTY_FUNCTION__); }))
# 1584 "MagickCore/compare.c"
                                      ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/compare.c",__func__,(unsigned long) 1586,"%s",image->filename);
  *distortion=0.0;
...
# 1713 "MagickCore/compare.c"
__attribute__ ((visibility ("default"))) double *GetImageDistortions(Image *image,
...
# 1726 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1726 "MagickCore/compare.c"
 image != (Image *) 
# 1726 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1726 "MagickCore/compare.c"
...
# 1726 "MagickCore/compare.c"
 "image != (Image *) NULL"
# 1726 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1726, __extension__ __PRETTY_FUNCTION__); }))
# 1726 "MagickCore/compare.c"
                                ;
  
# 1727 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1727 "MagickCore/compare.c"
 image->signature == 0xabacadabUL
# 1727 "MagickCore/compare.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1727 "MagickCore/compare.c"
...
# 1727 "MagickCore/compare.c"
 "image->signature == MagickCoreSignature"
# 1727 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1727, __extension__ __PRETTY_FUNCTION__); }))
# 1727 "MagickCore/compare.c"
                                                ;
  
# 1728 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1728 "MagickCore/compare.c"
 reconstruct_image != (const Image *) 
# 1728 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1728 "MagickCore/compare.c"
...
# 1728 "MagickCore/compare.c"
 "reconstruct_image != (const Image *) NULL"
# 1728 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1728, __extension__ __PRETTY_FUNCTION__); }))
# 1728 "MagickCore/compare.c"
                                                  ;
  
# 1729 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1729 "MagickCore/compare.c"
 reconstruct_image->signature == 0xabacadabUL
# 1729 "MagickCore/compare.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1729 "MagickCore/compare.c"
...
# 1729 "MagickCore/compare.c"
 "reconstruct_image->signature == MagickCoreSignature"
# 1729 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1729, __extension__ __PRETTY_FUNCTION__); }))
# 1729 "MagickCore/compare.c"
                                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/compare.c",__func__,(unsigned long) 1731,"%s",image->filename);
  ...
  channel_distortion=(double *) AcquireQuantumMemory(length,
    sizeof(*channel_distortion));
  if (channel_distortion == (double *) 
# 1738 "MagickCore/compare.c" 3 4
                                      ((void *)0)
# 1738 "MagickCore/compare.c"
                                          )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1739 "MagickCore/compare.c" 3 4
   (*__errno_location ())
# 1739 "MagickCore/compare.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/compare.c",__func__,(unsigned long) 1739,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  (void) memset(channel_distortion,0,length*
    sizeof(*channel_distortion));
  status=MagickTrue;
  switch (metric)
  ...
  if (status == MagickFalse)
    {
      channel_distortion=(double *) RelinquishMagickMemory(channel_distortion);
      return((double *) 
# 1822 "MagickCore/compare.c" 3 4
                       ((void *)0)
# 1822 "MagickCore/compare.c"
                           );
    }
  return(channel_distortion);
}
# 1855 "MagickCore/compare.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsImagesEqual(const Image *image,
...
# 1869 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1869 "MagickCore/compare.c"
 image != (Image *) 
# 1869 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1869 "MagickCore/compare.c"
...
# 1869 "MagickCore/compare.c"
 "image != (Image *) NULL"
# 1869 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1869, __extension__ __PRETTY_FUNCTION__); }))
# 1869 "MagickCore/compare.c"
                                ;
  
# 1870 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1870 "MagickCore/compare.c"
 image->signature == 0xabacadabUL
# 1870 "MagickCore/compare.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1870 "MagickCore/compare.c"
...
# 1870 "MagickCore/compare.c"
 "image->signature == MagickCoreSignature"
# 1870 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1870, __extension__ __PRETTY_FUNCTION__); }))
# 1870 "MagickCore/compare.c"
                                                ;
  
# 1871 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1871 "MagickCore/compare.c"
 reconstruct_image != (const Image *) 
# 1871 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1871 "MagickCore/compare.c"
...
# 1871 "MagickCore/compare.c"
 "reconstruct_image != (const Image *) NULL"
# 1871 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1871, __extension__ __PRETTY_FUNCTION__); }))
# 1871 "MagickCore/compare.c"
                                                  ;
  
# 1872 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1872 "MagickCore/compare.c"
 reconstruct_image->signature == 0xabacadabUL
# 1872 "MagickCore/compare.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1872 "MagickCore/compare.c"
...
# 1872 "MagickCore/compare.c"
 "reconstruct_image->signature == MagickCoreSignature"
# 1872 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1872, __extension__ __PRETTY_FUNCTION__); }))
# 1872 "MagickCore/compare.c"
                                                            ;
  rows=(((image->rows) > (reconstruct_image->rows)) ? (image->rows) : (reconstruct_image->rows));
  columns=(((image->columns) > (reconstruct_image->columns)) ? (image->columns) : (reconstruct_image->columns));
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    q=GetCacheViewVirtualPixels(reconstruct_view,0,y,columns,1,exception);
    if ((p == (const Quantum *) 
# 1888 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 1888 "MagickCore/compare.c"
                                   ) || (q == (const Quantum *) 
# 1888 "MagickCore/compare.c" 3 4
                                                                ((void *)0)
# 1888 "MagickCore/compare.c"
...
# 1975 "MagickCore/compare.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageColorMetric(Image *image,
  const Image *reconstruct_image,ExceptionInfo *exception)
{
  CacheView
    *image_view,
...
# 1998 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1998 "MagickCore/compare.c"
 image != (Image *) 
# 1998 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1998 "MagickCore/compare.c"
...
# 1998 "MagickCore/compare.c"
 "image != (Image *) NULL"
# 1998 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1998, __extension__ __PRETTY_FUNCTION__); }))
# 1998 "MagickCore/compare.c"
                                ;
  
# 1999 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 1999 "MagickCore/compare.c"
 image->signature == 0xabacadabUL
# 1999 "MagickCore/compare.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1999 "MagickCore/compare.c"
...
# 1999 "MagickCore/compare.c"
 "image->signature == MagickCoreSignature"
# 1999 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 1999, __extension__ __PRETTY_FUNCTION__); }))
# 1999 "MagickCore/compare.c"
                                                ;
  
# 2000 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 2000 "MagickCore/compare.c"
 reconstruct_image != (const Image *) 
# 2000 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2000 "MagickCore/compare.c"
...
# 2000 "MagickCore/compare.c"
 "reconstruct_image != (const Image *) NULL"
# 2000 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 2000, __extension__ __PRETTY_FUNCTION__); }))
# 2000 "MagickCore/compare.c"
                                                  ;
  
# 2001 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 2001 "MagickCore/compare.c"
 reconstruct_image->signature == 0xabacadabUL
# 2001 "MagickCore/compare.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2001 "MagickCore/compare.c"
...
# 2001 "MagickCore/compare.c"
 "reconstruct_image->signature == MagickCoreSignature"
# 2001 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 2001, __extension__ __PRETTY_FUNCTION__); }))
# 2001 "MagickCore/compare.c"
                                                            ;
  area=0.0;
  maximum_error=0.0;
  ...
  for (y=0; y < (ssize_t) rows; y++)
  {
    ...
    q=GetCacheViewVirtualPixels(reconstruct_view,0,y,columns,1,exception);
    if ((p == (const Quantum *) 
# 2021 "MagickCore/compare.c" 3 4
                               ((void *)0)
# 2021 "MagickCore/compare.c"
                                   ) || (q == (Quantum *) 
# 2021 "MagickCore/compare.c" 3 4
                                                          ((void *)0)
# 2021 "MagickCore/compare.c"
...
# 2852 "MagickCore/compare.c" 3 4
                                   ((void *)0)
# 2852 "MagickCore/compare.c"
                                       )
    return(0.0);
  distortion=0.0;
...
__attribute__ ((visibility ("default"))) Image *SimilarityImage(const Image *image,const Image *reference,
...
# 2884 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 2884 "MagickCore/compare.c"
 image != (const Image *) 
# 2884 "MagickCore/compare.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2884 "MagickCore/compare.c"
...
# 2884 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 2884, __extension__ __PRETTY_FUNCTION__); }))
# 2884 "MagickCore/compare.c"
                                      ;
  
# 2885 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 2885 "MagickCore/compare.c"
 image->signature == 0xabacadabUL
# 2885 "MagickCore/compare.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2885 "MagickCore/compare.c"
...
# 2885 "MagickCore/compare.c"
 "image->signature == MagickCoreSignature"
# 2885 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 2885, __extension__ __PRETTY_FUNCTION__); }))
# 2885 "MagickCore/compare.c"
                                                ;
  
# 2886 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 2886 "MagickCore/compare.c"
...
# 2886 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 2886, __extension__ __PRETTY_FUNCTION__); }))
# 2886 "MagickCore/compare.c"
                                            ;
  
# 2887 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 2887 "MagickCore/compare.c"
...
# 2887 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 2887, __extension__ __PRETTY_FUNCTION__); }))
# 2887 "MagickCore/compare.c"
                                                    ;
  
# 2888 "MagickCore/compare.c" 3 4
 ((void) sizeof ((
# 2888 "MagickCore/compare.c"
...
# 2888 "MagickCore/compare.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 2888 "MagickCore/compare.c"
 "offset != (RectangleInfo *) NULL"
# 2888 "MagickCore/compare.c" 3 4
 , "MagickCore/compare.c", 2888, __extension__ __PRETTY_FUNCTION__); }))
# 2888 "MagickCore/compare.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/compare.c",__func__,(unsigned long) 2890,"%s",image->filename);
  SetGeometry(reference,offset);
  *similarity_metric=1.79769313486231570E+308;
# 2908 "MagickCore/compare.c"
  similarity_image=CloneImage(image,image->columns-reference->columns+1,
    image->rows-reference->rows+1,MagickTrue,exception);
  if (similarity_image == (Image *) 
# 2910 "MagickCore/compare.c" 3 4
                                   ((void *)0)
# 2910 "MagickCore/compare.c"
                                       )
    return((Image *) 
# 2911 "MagickCore/compare.c" 3 4
                    ((void *)0)
# 2911 "MagickCore/compare.c"
                        );
  ...
  if (status == MagickFalse)
    {
      similarity_image=DestroyImage(similarity_image);
      return((Image *) 
# 2916 "MagickCore/compare.c" 3 4
                      ((void *)0)
# 2916 "MagickCore/compare.c"
                          );
    }
  ...
  for (y=0; y < (ssize_t) (image->rows-reference->rows+1); y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(similarity_view,0,y,similarity_image->columns,
      1,exception);
    if (q == (Quantum *) 
# 2951 "MagickCore/compare.c" 3 4
                        ((void *)0)
# 2951 "MagickCore/compare.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    for (x=0; x < (ssize_t) (image->columns-reference->columns+1); x++)
    {
      ...
      if (metric == PerceptualHashErrorMetric)
        similarity=(((0.01*similarity) < (1.0)) ? (0.01*similarity) : (1.0));
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        PixelChannel channel = GetPixelChannelChannel(image,i);
        PixelTrait traits = GetPixelChannelTraits(image,channel);
        ...
        SetPixelChannel(similarity_image,channel,ClampToQuantum((double)
          ((Quantum) 65535.0)-(double) ((Quantum) 65535.0)*similarity),q);
      }
    ...
    if (SyncCacheViewAuthenticPixels(similarity_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 3000 "MagickCore/compare.c" 3 4
                                                          ((void *)0)
# 3000 "MagickCore/compare.c"
                                                              )
      {
        MagickBooleanType
          proceed;
