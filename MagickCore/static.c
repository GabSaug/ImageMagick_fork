# 0 "MagickCore/static.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/static.c"
# 43 "MagickCore/static.c"
...
extern __attribute__ ((visibility ("default"))) void
  ...
  StripString(char *);
# 24 "./MagickCore/exception-private.h" 2
...
# 52 "MagickCore/static.c" 2
# 62 "MagickCore/static.c"
__attribute__ ((visibility ("default"))) size_t RegisterUndefinedImage(void)
{
  return(((size_t) (((10) << 8) | 16)));
}

__attribute__ ((visibility ("default"))) void UnregisterUndefinedImage(void)
{
}
...
{ "ASHLAR", MagickFalse, RegisterASHLARImage, UnregisterASHLARImage },
{ "AVS", MagickFalse, RegisterAVSImage, UnregisterAVSImage },
{ "BAYER", MagickFalse, RegisterBAYERImage, UnregisterBAYERImage },
...
{ "CUBE", MagickFalse, RegisterCUBEImage, UnregisterCUBEImage },
...
{ "FARBFELD", MagickFalse, RegisterFARBFELDImage, UnregisterFARBFELDImage },
{ "FAX", MagickFalse, RegisterFAXImage, UnregisterFAXImage },
{ "FITS", MagickFalse, RegisterFITSImage, UnregisterFITSImage },
{ "FL32", MagickFalse, RegisterFL32Image, UnregisterFL32Image },
...
{ "FTXT", MagickFalse, RegisterFTXTImage, UnregisterFTXTImage },
...
{ "ORA", MagickFalse, RegisterORAImage, UnregisterORAImage },
...
{ "QOI", MagickFalse, RegisterQOIImage, UnregisterQOIImage },
...
{ "STRIMG", MagickFalse, RegisterSTRIMGImage, UnregisterSTRIMGImage },
...
{ "TIM2", MagickFalse, RegisterTIM2Image, UnregisterTIM2Image },
...
{ "YAML", MagickFalse, RegisterYAMLImage, UnregisterYAMLImage },
{ "YCBCR", MagickFalse, RegisterYCBCRImage, UnregisterYCBCRImage },
{ "YUV", MagickFalse, RegisterYUVImage, UnregisterYUVImage },
# 90 "MagickCore/static.c" 2

  { (const char *) 
# 91 "MagickCore/static.c" 3 4
                  ((void *)0)
# 91 "MagickCore/static.c"
                      , MagickFalse, RegisterUndefinedImage, UnregisterUndefinedImage }
};
# 217 "MagickCore/static.c"
__attribute__ ((visibility ("default"))) MagickBooleanType RegisterStaticModule(const char *module,
  ExceptionInfo *exception)
{
  char
    module_name[4096];
...
# 238 "MagickCore/static.c" 3 4
 ((void) sizeof ((
# 238 "MagickCore/static.c"
 module != (const char *) 
# 238 "MagickCore/static.c" 3 4
...
# 238 "MagickCore/static.c"
 "module != (const char *) NULL"
# 238 "MagickCore/static.c" 3 4
 , "MagickCore/static.c", 238, __extension__ __PRETTY_FUNCTION__); }))
# 238 "MagickCore/static.c"
                                      ;
  (void) CopyMagickString(module_name,module,4096);
  p=GetCoderInfo(module,exception);
  if (p != (CoderInfo *) 
# 241 "MagickCore/static.c" 3 4
                        ((void *)0)
# 241 "MagickCore/static.c"
                            )
    (void) CopyMagickString(module_name,p->name,4096);
...
# 246 "MagickCore/static.c" 3 4
     (*__errno_location ())
# 246 "MagickCore/static.c"
          =
# 246 "MagickCore/static.c" 3 4
           1
# 246 "MagickCore/static.c"
                ;
      (void) ThrowMagickException(exception,"MagickCore/static.c",__func__,(unsigned long) 247,PolicyError,
...
# 284 "MagickCore/static.c"
__attribute__ ((visibility ("default"))) void RegisterStaticModules(void)
{
  PolicyRights
    rights;
...
# 331 "MagickCore/static.c"
__attribute__ ((visibility ("default"))) MagickBooleanType UnregisterStaticModule(const char *module)
{
  size_t
    extent;
...
# 372 "MagickCore/static.c"
__attribute__ ((visibility ("default"))) void UnregisterStaticModules(void)
{
  size_t
    extent;
