# 0 "MagickCore/policy.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/policy.c"
# 40 "MagickCore/policy.c"
...
# 70 "MagickCore/policy.c" 2
# 1 "/usr/include/libxml2/libxml/tree.h" 1
# 71 "MagickCore/policy.c" 2
# 81 "MagickCore/policy.c"
struct _PolicyInfo
{
  char
    *path;
...
static const PolicyMapInfo
  PolicyMap[] =
  {
    { UndefinedPolicyDomain, UndefinedPolicyRights, (const char *) 
# 129 "MagickCore/policy.c" 3 4
                                                                  ((void *)0)
# 129 "MagickCore/policy.c"
                                                                      ,
      (const char *) 
# 130 "MagickCore/policy.c" 3 4
                    ((void *)0)
# 130 "MagickCore/policy.c"
                        , (const char *) 
# 130 "MagickCore/policy.c" 3 4
                                         ((void *)0) 
# 130 "MagickCore/policy.c"
...
static LinkedListInfo
  *policy_cache = (LinkedListInfo *) 
# 134 "MagickCore/policy.c" 3 4
                                    ((void *)0)
# 134 "MagickCore/policy.c"
                                        ;

static SemaphoreInfo
  *policy_semaphore = (SemaphoreInfo *) 
# 137 "MagickCore/policy.c" 3 4
                                       ((void *)0)
# 137 "MagickCore/policy.c"
                                           ;
...
# 206 "MagickCore/policy.c" 3 4
                                         ((void *)0)
# 206 "MagickCore/policy.c"
                                             )
    {
  ...
  for (i=0; i < (ssize_t) (sizeof(PolicyMap)/sizeof(*PolicyMap)); i++)
  {
    ...
    if (policy_info == (PolicyInfo *) 
# 230 "MagickCore/policy.c" 3 4
                                     ((void *)0)
# 230 "MagickCore/policy.c"
                                         )
      {
        (void) ThrowMagickException(exception,"MagickCore/policy.c",__func__,(unsigned long) 232,
          ResourceLimitError,"MemoryAllocationFailed","`%s'",
          p->name == (char *) 
# 234 "MagickCore/policy.c" 3 4
                             ((void *)0) 
# 234 "MagickCore/policy.c"
                                  ? "" : p->name);
        CatchException(exception);
        continue;
      }
    ...
    policy_info->signature=0xabacadabUL;
    status=AppendValueToLinkedList(cache,policy_info);
    if (status == MagickFalse)
      {
        (void) ThrowMagickException(exception,"MagickCore/policy.c",__func__,(unsigned long) 250,
          ResourceLimitError,"MemoryAllocationFailed","`%s'",
          p->name == (char *) 
# 252 "MagickCore/policy.c" 3 4
                             ((void *)0) 
# 252 "MagickCore/policy.c"
                                  ? "" : p->name);
        CatchException(exception);
      }
  }
...
# 299 "MagickCore/policy.c" 3 4
 ((void) sizeof ((
# 299 "MagickCore/policy.c"
...
# 299 "MagickCore/policy.c" 3 4
 , "MagickCore/policy.c", 299, __extension__ __PRETTY_FUNCTION__); }))
# 299 "MagickCore/policy.c"
                                            ;
  if (IsPolicyCacheInstantiated(exception) == MagickFalse)
    return((PolicyInfo *) 
# 301 "MagickCore/policy.c" 3 4
                         ((void *)0)
# 301 "MagickCore/policy.c"
                             );
  ...
  *policyname='\0';
  if (name != (const char *) 
# 306 "MagickCore/policy.c" 3 4
                            ((void *)0)
# 306 "MagickCore/policy.c"
                                )
    (void) CopyMagickString(policyname,name,4096);
  for (q=policyname; *q != '\0'; q++)
  {
    if (
# 310 "MagickCore/policy.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 310 "MagickCore/policy.c"
       (int) ((unsigned char) *q)
# 310 "MagickCore/policy.c" 3 4
       ))] & (unsigned short int) _ISspace) 
# 310 "MagickCore/policy.c"
  ...
  for (q=policyname; *q != '\0'; q++)
  {
    ...
    *q='\0';
    ...
    (void) CopyMagickString(policyname,q+1,4096);
    break;
  }
  ...
  policy=(PolicyInfo *) 
# 332 "MagickCore/policy.c" 3 4
                       ((void *)0)
# 332 "MagickCore/policy.c"
                           ;
  LockSemaphoreInfo(policy_semaphore);
  ResetLinkedListIterator(policy_cache);
  p=GetHeadElementInLinkedList(policy_cache);
  if ((name == (const char *) 
# 336 "MagickCore/policy.c" 3 4
                             ((void *)0)
# 336 "MagickCore/policy.c"
                                 ) || (LocaleCompare(name,"*") == 0))
    {
      UnlockSemaphoreInfo(policy_semaphore);
      if (p != (ElementInfo *) 
# 339 "MagickCore/policy.c" 3 4
                              ((void *)0)
# 339 "MagickCore/policy.c"
                                  )
        policy=(PolicyInfo *) p->value;
      return(policy);
    }
  while (p != (ElementInfo *) 
# 343 "MagickCore/policy.c" 3 4
                             ((void *)0)
# 343 "MagickCore/policy.c"
                                 )
  {
    policy=(PolicyInfo *) p->value;
  ...
  if (p == (ElementInfo *) 
# 351 "MagickCore/policy.c" 3 4
                          ((void *)0)
# 351 "MagickCore/policy.c"
                              )
    policy=(PolicyInfo *) 
# 352 "MagickCore/policy.c" 3 4
                         ((void *)0)
# 352 "MagickCore/policy.c"
                             ;
  else
...
# 386 "MagickCore/policy.c"
__attribute__ ((visibility ("default"))) const PolicyInfo **GetPolicyInfoList(const char *pattern,
...
# 398 "MagickCore/policy.c" 3 4
 ((void) sizeof ((
# 398 "MagickCore/policy.c"
 pattern != (char *) 
# 398 "MagickCore/policy.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 398 "MagickCore/policy.c"
...
# 398 "MagickCore/policy.c"
 "pattern != (char *) NULL"
# 398 "MagickCore/policy.c" 3 4
 , "MagickCore/policy.c", 398, __extension__ __PRETTY_FUNCTION__); }))
# 398 "MagickCore/policy.c"
                                 ;
  
# 399 "MagickCore/policy.c" 3 4
 ((void) sizeof ((
# 399 "MagickCore/policy.c"
 number_policies != (size_t *) 
# 399 "MagickCore/policy.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 399 "MagickCore/policy.c"
 number_policies != (size_t *) 
# 399 "MagickCore/policy.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 399 "MagickCore/policy.c"
 "number_policies != (size_t *) NULL"
# 399 "MagickCore/policy.c" 3 4
 , "MagickCore/policy.c", 399, __extension__ __PRETTY_FUNCTION__); }))
# 399 "MagickCore/policy.c"
                                           ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/policy.c",__func__,(unsigned long) 401,"%s",pattern);
  *number_policies=0;
  if (IsPolicyCacheInstantiated(exception) == MagickFalse)
    return((const PolicyInfo **) 
# 404 "MagickCore/policy.c" 3 4
                                ((void *)0)
# 404 "MagickCore/policy.c"
                                    );
  policies=(const PolicyInfo **) AcquireQuantumMemory((size_t)
    GetNumberOfElementsInLinkedList(policy_cache)+1UL,sizeof(*policies));
  if (policies == (const PolicyInfo **) 
# 407 "MagickCore/policy.c" 3 4
                                       ((void *)0)
# 407 "MagickCore/policy.c"
                                           )
    return((const PolicyInfo **) 
# 408 "MagickCore/policy.c" 3 4
                                ((void *)0)
# 408 "MagickCore/policy.c"
                                    );
  LockSemaphoreInfo(policy_semaphore);
  p=GetHeadElementInLinkedList(policy_cache);
  for (i=0; p != (ElementInfo *) 
# 411 "MagickCore/policy.c" 3 4
                                ((void *)0)
# 411 "MagickCore/policy.c"
                                    ; )
  {
    const PolicyInfo
      *policy;
  ...
  if (i == 0)
    ...
    policies[i]=(PolicyInfo *) 
# 426 "MagickCore/policy.c" 3 4
                              ((void *)0)
# 426 "MagickCore/policy.c"
                                  ;
  *number_policies=(size_t) i;
  return(policies);
}
# 459 "MagickCore/policy.c"
static char *AcquirePolicyString(const char *source,const size_t pad)
{
  ...
  length=0;
  if (source != (char *) 
# 468 "MagickCore/policy.c" 3 4
                        ((void *)0)
# 468 "MagickCore/policy.c"
                            )
    length+=strlen(source);
  destination=(char *) 
# 470 "MagickCore/policy.c" 3 4
                      ((void *)0)
# 470 "MagickCore/policy.c"
                          ;

  if (~length >= pad)
    destination=(char *) AcquireMagickMemory((length+pad)*sizeof(*destination));
  if (destination == (char *) 
# 474 "MagickCore/policy.c" 3 4
                             ((void *)0)
# 474 "MagickCore/policy.c"
                                 )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 475 "MagickCore/policy.c" 3 4
   (*__errno_location ())
# 475 "MagickCore/policy.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/policy.c",__func__,(unsigned long) 475,ResourceLimitFatalError,"UnableToAcquireString", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  if (source != (char *) 
# 476 "MagickCore/policy.c" 3 4
                        ((void *)0)
# 476 "MagickCore/policy.c"
                            )
...
__attribute__ ((visibility ("default"))) char **GetPolicyList(const char *pattern,size_t *number_policies,
  ExceptionInfo *exception)
{
  char
    **policies;
...
# 494 "MagickCore/policy.c" 3 4
 ((void) sizeof ((
# 494 "MagickCore/policy.c"
 pattern != (char *) 
# 494 "MagickCore/policy.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 494 "MagickCore/policy.c"
...
# 494 "MagickCore/policy.c"
 "pattern != (char *) NULL"
# 494 "MagickCore/policy.c" 3 4
 , "MagickCore/policy.c", 494, __extension__ __PRETTY_FUNCTION__); }))
# 494 "MagickCore/policy.c"
                                 ;
  
# 495 "MagickCore/policy.c" 3 4
 ((void) sizeof ((
# 495 "MagickCore/policy.c"
 number_policies != (size_t *) 
# 495 "MagickCore/policy.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 495 "MagickCore/policy.c"
...
# 495 "MagickCore/policy.c"
 "number_policies != (size_t *) NULL"
# 495 "MagickCore/policy.c" 3 4
 , "MagickCore/policy.c", 495, __extension__ __PRETTY_FUNCTION__); }))
# 495 "MagickCore/policy.c"
                                           ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/policy.c",__func__,(unsigned long) 497,"%s",pattern);
  *number_policies=0;
  if (IsPolicyCacheInstantiated(exception) == MagickFalse)
    return((char **) 
# 500 "MagickCore/policy.c" 3 4
                    ((void *)0)
# 500 "MagickCore/policy.c"
                        );
  policies=(char **) AcquireQuantumMemory((size_t)
    GetNumberOfElementsInLinkedList(policy_cache)+1UL,sizeof(*policies));
  if (policies == (char **) 
# 503 "MagickCore/policy.c" 3 4
                           ((void *)0)
# 503 "MagickCore/policy.c"
                               )
    return((char **) 
# 504 "MagickCore/policy.c" 3 4
                    ((void *)0)
# 504 "MagickCore/policy.c"
                        );
  LockSemaphoreInfo(policy_semaphore);
  p=GetHeadElementInLinkedList(policy_cache);
  for (i=0; p != (ElementInfo *) 
# 507 "MagickCore/policy.c" 3 4
                                ((void *)0)
# 507 "MagickCore/policy.c"
                                    ; )
  {
    const PolicyInfo
      *policy;
  ...
  if (i == 0)
    ...
    policies[i]=(char *) 
# 522 "MagickCore/policy.c" 3 4
                        ((void *)0)
# 522 "MagickCore/policy.c"
                            ;
  *number_policies=(size_t) i;
  return(policies);
}
# 549 "MagickCore/policy.c"
__attribute__ ((visibility ("default"))) char *GetPolicyValue(const char *name)
{
  const char
    *value;
...
# 560 "MagickCore/policy.c" 3 4
 ((void) sizeof ((
# 560 "MagickCore/policy.c"
 name != (const char *) 
# 560 "MagickCore/policy.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 560 "MagickCore/policy.c"
...
# 560 "MagickCore/policy.c" 3 4
 , "MagickCore/policy.c", 560, __extension__ __PRETTY_FUNCTION__); }))
# 560 "MagickCore/policy.c"
                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/policy.c",__func__,(unsigned long) 562,"%s",name);
  exception=AcquireExceptionInfo();
  policy_info=GetPolicyInfo(name,exception);
  exception=DestroyExceptionInfo(exception);
  if (policy_info == (PolicyInfo *) 
# 566 "MagickCore/policy.c" 3 4
                                   ((void *)0)
# 566 "MagickCore/policy.c"
                                       )
    return((char *) 
# 567 "MagickCore/policy.c" 3 4
                   ((void *)0)
# 567 "MagickCore/policy.c"
                       );
  value=policy_info->value;
  if ((value == (const char *) 
# 569 "MagickCore/policy.c" 3 4
                              ((void *)0)
# 569 "MagickCore/policy.c"
                                  ) || (*value == '\0'))
    return((char *) 
# 570 "MagickCore/policy.c" 3 4
                   ((void *)0)
# 570 "MagickCore/policy.c"
                       );
  return(AcquirePolicyString(value,1));
}
# 597 "MagickCore/policy.c"
static MagickBooleanType IsPolicyCacheInstantiated(ExceptionInfo *exception)
{
  if (policy_cache == (LinkedListInfo *) 
# 599 "MagickCore/policy.c" 3 4
                                        ((void *)0)
# 599 "MagickCore/policy.c"
                                            )
    {
      GetMaxMemoryRequest();
      if (policy_semaphore == (SemaphoreInfo *) 
# 602 "MagickCore/policy.c" 3 4
                                               ((void *)0)
# 602 "MagickCore/policy.c"
                                                   )
        ActivateSemaphoreInfo(&policy_semaphore);
      LockSemaphoreInfo(policy_semaphore);
      if (policy_cache == (LinkedListInfo *) 
# 605 "MagickCore/policy.c" 3 4
                                            ((void *)0)
# 605 "MagickCore/policy.c"
                                                )
        policy_cache=AcquirePolicyCache("policy.xml",exception);
      UnlockSemaphoreInfo(policy_semaphore);
    }
  return(policy_cache != (LinkedListInfo *) 
# 609 "MagickCore/policy.c" 3 4
                                           ((void *)0) 
# 609 "MagickCore/policy.c"
                                                ? MagickTrue : MagickFalse);
}
# 640 "MagickCore/policy.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsRightsAuthorized(const PolicyDomain domain,
  const PolicyRights rights,const char *pattern)
{
  ...
  if ((GetLogEventMask() & PolicyEvent) != 0)
    (void) LogMagickEvent(PolicyEvent,"MagickCore/policy.c",__func__,(unsigned long) 656,
  ...
  exception=DestroyExceptionInfo(exception);
  if (policy_info == (PolicyInfo *) 
# 663 "MagickCore/policy.c" 3 4
                                   ((void *)0)
# 663 "MagickCore/policy.c"
                                       )
    return(MagickTrue);
  ...
  p=GetHeadElementInLinkedList(policy_cache);
  while (p != (ElementInfo *) 
# 668 "MagickCore/policy.c" 3 4
                             ((void *)0)
# 668 "MagickCore/policy.c"
                                 )
  {
    const PolicyInfo
      *policy;
...
# 717 "MagickCore/policy.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListPolicyInfo(FILE *file,
  ExceptionInfo *exception)
{
  const char
    *path,
  ...
  if (file == (const FILE *) 
# 736 "MagickCore/policy.c" 3 4
                            ((void *)0)
# 736 "MagickCore/policy.c"
                                )
    file=
# 737 "MagickCore/policy.c" 3 4
        stdout
# 737 "MagickCore/policy.c"
              ;
  policy_info=GetPolicyInfoList("*",&number_policies,exception);
  if (policy_info == (const PolicyInfo **) 
# 739 "MagickCore/policy.c" 3 4
                                          ((void *)0)
# 739 "MagickCore/policy.c"
                                              )
    return(MagickFalse);
  path=(const char *) 
# 741 "MagickCore/policy.c" 3 4
                     ((void *)0)
# 741 "MagickCore/policy.c"
                         ;
  for (i=0; i < (ssize_t) number_policies; i++)
  {
    if (policy_info[i]->stealth != MagickFalse)
      continue;
    if (((path == (const char *) 
# 746 "MagickCore/policy.c" 3 4
                                ((void *)0)
# 746 "MagickCore/policy.c"
                                    ) ||
         (LocaleCompare(path,policy_info[i]->path) != 0)) &&
         (policy_info[i]->path != (char *) 
# 748 "MagickCore/policy.c" 3 4
                                          ((void *)0)
# 748 "MagickCore/policy.c"
                                              ))
    ...
    if ((policy_info[i]->domain == CachePolicyDomain) ||
      ...
      {
        if (policy_info[i]->name != (char *) 
# 758 "MagickCore/policy.c" 3 4
                                            ((void *)0)
# 758 "MagickCore/policy.c"
                                                )
          (void) FormatLocaleFile(file,"    name: %s\n",policy_info[i]->name);
        if (policy_info[i]->value != (char *) 
# 760 "MagickCore/policy.c" 3 4
                                             ((void *)0)
# 760 "MagickCore/policy.c"
                                                 )
    ...
    else
      {
        ...
        (void) FormatLocaleFile(file,"\n");
        if (policy_info[i]->pattern != (char *) 
# 775 "MagickCore/policy.c" 3 4
                                               ((void *)0)
# 775 "MagickCore/policy.c"
                                                   )
  ...
  ExceptionInfo *exception)
{
  ...
  (void) LogMagickEvent(ConfigureEvent,"MagickCore/policy.c",__func__,(unsigned long) 839,
    "Loading policy file \"%s\" ...",filename);
  if (policy == (char *) 
# 841 "MagickCore/policy.c" 3 4
                        ((void *)0)
# 841 "MagickCore/policy.c"
                            )
    return(MagickFalse);
  status=MagickTrue;
  policy_info=(PolicyInfo *) 
# 844 "MagickCore/policy.c" 3 4
                            ((void *)0)
# 844 "MagickCore/policy.c"
                                ;
  token=AcquirePolicyString(policy,4096);
    ...
    if (LocaleCompare(keyword,"<include") == 0)
      {
        ...
        while (((*token != '/') && (*(token+1) != '>')) && (*q != '\0'))
        {
          ...
          if (LocaleCompare(keyword,"file") == 0)
            {
              if (depth > 600)
                (void) ThrowMagickException(exception,"MagickCore/policy.c",__func__,(unsigned long) 889,
              ...
              else
                {
                  ...
                  if (file_xml != (char *) 
# 906 "MagickCore/policy.c" 3 4
                                          ((void *)0)
# 906 "MagickCore/policy.c"
                                              )
                    {
    ...
    if (policy_info == (PolicyInfo *) 
# 929 "MagickCore/policy.c" 3 4
                                     ((void *)0)
# 929 "MagickCore/policy.c"
                                         )
      continue;
    if ((LocaleCompare(keyword,"/>") == 0) ||
        (LocaleCompare(keyword,"</policy>") == 0))
      {
        status=AppendValueToLinkedList(cache,policy_info);
        if (status == MagickFalse)
          (void) ThrowMagickException(exception,"MagickCore/policy.c",__func__,(unsigned long) 936,
            ResourceLimitError,"MemoryAllocationFailed","`%s'",
            policy_info->name);
        policy_info=(PolicyInfo *) 
# 939 "MagickCore/policy.c" 3 4
                                  ((void *)0)
# 939 "MagickCore/policy.c"
                                      ;
        continue;
      }
    (void) GetNextToken(q,(const char **) 
# 942 "MagickCore/policy.c" 3 4
                                         ((void *)0)
# 942 "MagickCore/policy.c"
                                             ,extent,token);
    if (*token != '=')
      continue;
    (void) GetNextToken(q,&q,extent,token);
...
# 1037 "MagickCore/policy.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType PolicyComponentGenesis(void)
{
  if (policy_semaphore == (SemaphoreInfo *) 
# 1039 "MagickCore/policy.c" 3 4
                                           ((void *)0)
# 1039 "MagickCore/policy.c"
                                               )
    policy_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 1063 "MagickCore/policy.c"
static void *DestroyPolicyElement(void *policy_info)
{
  ...
  if (p->exempt == MagickFalse)
    {
      if (p->value != (char *) 
# 1071 "MagickCore/policy.c" 3 4
                              ((void *)0)
# 1071 "MagickCore/policy.c"
                                  )
        p->value=DestroyString(p->value);
      if (p->pattern != (char *) 
# 1073 "MagickCore/policy.c" 3 4
                                ((void *)0)
# 1073 "MagickCore/policy.c"
                                    )
        p->pattern=DestroyString(p->pattern);
      if (p->name != (char *) 
# 1075 "MagickCore/policy.c" 3 4
                             ((void *)0)
# 1075 "MagickCore/policy.c"
                                 )
        p->name=DestroyString(p->name);
      if (p->path != (char *) 
# 1077 "MagickCore/policy.c" 3 4
                             ((void *)0)
# 1077 "MagickCore/policy.c"
                                 )
        p->path=DestroyString(p->path);
    }
  p=(PolicyInfo *) RelinquishMagickMemory(p);
  return((void *) 
# 1081 "MagickCore/policy.c" 3 4
                 ((void *)0)
# 1081 "MagickCore/policy.c"
                     );
}

__attribute__ ((visibility ("hidden"))) void PolicyComponentTerminus(void)
{
  if (policy_semaphore == (SemaphoreInfo *) 
# 1086 "MagickCore/policy.c" 3 4
                                           ((void *)0)
# 1086 "MagickCore/policy.c"
                                               )
    ActivateSemaphoreInfo(&policy_semaphore);
  LockSemaphoreInfo(policy_semaphore);
  if (policy_cache != (LinkedListInfo *) 
# 1089 "MagickCore/policy.c" 3 4
                                        ((void *)0)
# 1089 "MagickCore/policy.c"
                                            )
    policy_cache=DestroyLinkedList(policy_cache,DestroyPolicyElement);
  UnlockSemaphoreInfo(policy_semaphore);
  RelinquishSemaphoreInfo(&policy_semaphore);
}
# 1122 "MagickCore/policy.c"
  ...
  const char *url,ExceptionInfo *exception)
{
  ...
  document=xmlReadMemory(policy,(int) strlen(policy),url,
# 1132 "MagickCore/policy.c" 3 4
                                                        ((void *)0)
# 1132 "MagickCore/policy.c"
                                                            ,
    XML_PARSE_NOERROR | XML_PARSE_NOWARNING);
  if (document == (xmlDocPtr) 
# 1134 "MagickCore/policy.c" 3 4
                             ((void *)0)
# 1134 "MagickCore/policy.c"
                                 )
    {
      (void) ThrowMagickException(exception,"MagickCore/policy.c",__func__,(unsigned long) 1136,ConfigureError,
...
__attribute__ ((visibility ("default"))) MagickBooleanType SetMagickSecurityPolicy(const char *policy,
  ExceptionInfo *exception)
{
  MagickBooleanType
    status;
...
# 1164 "MagickCore/policy.c" 3 4
 ((void) sizeof ((
# 1164 "MagickCore/policy.c"
 exception != (ExceptionInfo *) 
# 1164 "MagickCore/policy.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1164 "MagickCore/policy.c"
...
# 1164 "MagickCore/policy.c"
 "exception != (ExceptionInfo *) NULL"
# 1164 "MagickCore/policy.c" 3 4
 , "MagickCore/policy.c", 1164, __extension__ __PRETTY_FUNCTION__); }))
# 1164 "MagickCore/policy.c"
                                            ;
  if (policy == (const char *) 
# 1165 "MagickCore/policy.c" 3 4
                              ((void *)0)
# 1165 "MagickCore/policy.c"
                                  )
    return(MagickFalse);
  if (ValidateSecurityPolicy(policy,"policy.xml",exception) == MagickFalse)
    return(MagickFalse);
  ...
  while (p != (PolicyInfo *) 
# 1184 "MagickCore/policy.c" 3 4
                            ((void *)0)
# 1184 "MagickCore/policy.c"
                                )
  {
    if ((p->name != (char *) 
# 1186 "MagickCore/policy.c" 3 4
                            ((void *)0)
# 1186 "MagickCore/policy.c"
                                ) && (p->value != (char *) 
# 1186 "MagickCore/policy.c" 3 4
                                                           ((void *)0)
# 1186 "MagickCore/policy.c"
...
# 1227 "MagickCore/policy.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetMagickSecurityPolicyValue(
  const PolicyDomain domain,const char *name,const char *value,
  ExceptionInfo *exception)
{
  ;
  
# 1232 "MagickCore/policy.c" 3 4
 ((void) sizeof ((
# 1232 "MagickCore/policy.c"
 exception != (ExceptionInfo *) 
# 1232 "MagickCore/policy.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1232 "MagickCore/policy.c"
...
# 1232 "MagickCore/policy.c"
 "exception != (ExceptionInfo *) NULL"
# 1232 "MagickCore/policy.c" 3 4
 , "MagickCore/policy.c", 1232, __extension__ __PRETTY_FUNCTION__); }))
# 1232 "MagickCore/policy.c"
                                            ;
  if ((name == (const char *) 
# 1233 "MagickCore/policy.c" 3 4
                             ((void *)0)
# 1233 "MagickCore/policy.c"
                                 ) || (value == (const char *) 
# 1233 "MagickCore/policy.c" 3 4
                                                               ((void *)0)
# 1233 "MagickCore/policy.c"
