# 0 "MagickCore/option.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/option.c"
# 43 "MagickCore/option.c"
...
# 60 "MagickCore/option.c" 2

# 1 "./MagickCore/mime-private.h" 1
# 25 "./MagickCore/mime-private.h"
typedef enum
{
  UndefinedData,
  StringData,
...
# 67 "MagickCore/option.c" 2
# 1 "./MagickCore/option-private.h" 1
# 68 "MagickCore/option.c" 2
...
# 83 "MagickCore/option.c" 2
# 92 "MagickCore/option.c"
static const OptionInfo
  AlignOptions[] =
  {
    ...
    { (char *) 
# 102 "MagickCore/option.c" 3 4
              ((void *)0)
# 102 "MagickCore/option.c"
                  , UndefinedAlign, UndefinedOptionFlag, MagickFalse }
  },
  AlphaChannelOptions[] =
  {
    ...
    { (char *) 
# 124 "MagickCore/option.c" 3 4
              ((void *)0)
# 124 "MagickCore/option.c"
                  , UndefinedAlphaChannel, UndefinedOptionFlag, MagickFalse }
  },
  AutoThresholdOptions[] =
  {
    ...
    { (char *) 
# 132 "MagickCore/option.c" 3 4
              ((void *)0)
# 132 "MagickCore/option.c"
                  , UndefinedThresholdMethod, UndefinedOptionFlag, MagickFalse }
  },
  BooleanOptions[] =
  {
    ...
    { (char *) 
# 140 "MagickCore/option.c" 3 4
              ((void *)0)
# 140 "MagickCore/option.c"
                  , MagickFalse, UndefinedOptionFlag, MagickFalse }
  },
  CacheOptions[] =
  {
    ...
    { (char *) 
# 149 "MagickCore/option.c" 3 4
              ((void *)0)
# 149 "MagickCore/option.c"
                  , MagickFalse, UndefinedOptionFlag, MagickFalse }
  },
  ChannelOptions[] =
  {
    ...
    { "Meta0", ((ssize_t) 1 << (MetaPixelChannels+0)), UndefinedOptionFlag, MagickFalse },
    { "Meta1", ((ssize_t) 1 << (MetaPixelChannels+1)), UndefinedOptionFlag, MagickFalse },
    { "Meta2", ((ssize_t) 1 << (MetaPixelChannels+2)), UndefinedOptionFlag, MagickFalse },
    { "Meta3", ((ssize_t) 1 << (MetaPixelChannels+3)), UndefinedOptionFlag, MagickFalse },
    { "Meta4", ((ssize_t) 1 << (MetaPixelChannels+4)), UndefinedOptionFlag, MagickFalse },
    { "Meta5", ((ssize_t) 1 << (MetaPixelChannels+5)), UndefinedOptionFlag, MagickFalse },
    { "Meta6", ((ssize_t) 1 << (MetaPixelChannels+6)), UndefinedOptionFlag, MagickFalse },
    { "Meta7", ((ssize_t) 1 << (MetaPixelChannels+7)), UndefinedOptionFlag, MagickFalse },
    { "Meta8", ((ssize_t) 1 << (MetaPixelChannels+8)), UndefinedOptionFlag, MagickFalse },
    { "Meta9", ((ssize_t) 1 << (MetaPixelChannels+9)), UndefinedOptionFlag, MagickFalse },
    { "Meta10", ((ssize_t) 1 << (MetaPixelChannels+10)), UndefinedOptionFlag, MagickFalse },
    { "Meta11", ((ssize_t) 1 << (MetaPixelChannels+11)), UndefinedOptionFlag, MagickFalse },
    { "Meta12", ((ssize_t) 1 << (MetaPixelChannels+12)), UndefinedOptionFlag, MagickFalse },
    { "Meta13", ((ssize_t) 1 << (MetaPixelChannels+13)), UndefinedOptionFlag, MagickFalse },
    { "Meta14", ((ssize_t) 1 << (MetaPixelChannels+14)), UndefinedOptionFlag, MagickFalse },
    { "Meta15", ((ssize_t) 1 << (MetaPixelChannels+15)), UndefinedOptionFlag, MagickFalse },
    { "Meta16", ((ssize_t) 1 << (MetaPixelChannels+16)), UndefinedOptionFlag, MagickFalse },
    { "Meta17", ((ssize_t) 1 << (MetaPixelChannels+17)), UndefinedOptionFlag, MagickFalse },
    { "Meta18", ((ssize_t) 1 << (MetaPixelChannels+18)), UndefinedOptionFlag, MagickFalse },
    { "Meta19", ((ssize_t) 1 << (MetaPixelChannels+19)), UndefinedOptionFlag, MagickFalse },
    { "Meta20", ((ssize_t) 1 << (MetaPixelChannels+20)), UndefinedOptionFlag, MagickFalse },
    { "Meta21", ((ssize_t) 1 << (MetaPixelChannels+21)), UndefinedOptionFlag, MagickFalse },
# 236 "MagickCore/option.c"
    ...
    { "10", ((ssize_t) 1 << (MetaPixelChannels+0)), UndefinedOptionFlag, MagickFalse },
    { "11", ((ssize_t) 1 << (MetaPixelChannels+1)), UndefinedOptionFlag, MagickFalse },
    { "12", ((ssize_t) 1 << (MetaPixelChannels+2)), UndefinedOptionFlag, MagickFalse },
    { "13", ((ssize_t) 1 << (MetaPixelChannels+3)), UndefinedOptionFlag, MagickFalse },
    { "14", ((ssize_t) 1 << (MetaPixelChannels+4)), UndefinedOptionFlag, MagickFalse },
    { "15", ((ssize_t) 1 << (MetaPixelChannels+5)), UndefinedOptionFlag, MagickFalse },
    { "16", ((ssize_t) 1 << (MetaPixelChannels+6)), UndefinedOptionFlag, MagickFalse },
    { "17", ((ssize_t) 1 << (MetaPixelChannels+7)), UndefinedOptionFlag, MagickFalse },
    { "18", ((ssize_t) 1 << (MetaPixelChannels+8)), UndefinedOptionFlag, MagickFalse },
    { "19", ((ssize_t) 1 << (MetaPixelChannels+9)), UndefinedOptionFlag, MagickFalse },
    { "20", ((ssize_t) 1 << (MetaPixelChannels+10)), UndefinedOptionFlag, MagickFalse },
    { "21", ((ssize_t) 1 << (MetaPixelChannels+11)), UndefinedOptionFlag, MagickFalse },
    { "22", ((ssize_t) 1 << (MetaPixelChannels+12)), UndefinedOptionFlag, MagickFalse },
    { "23", ((ssize_t) 1 << (MetaPixelChannels+13)), UndefinedOptionFlag, MagickFalse },
    { "24", ((ssize_t) 1 << (MetaPixelChannels+14)), UndefinedOptionFlag, MagickFalse },
    { "25", ((ssize_t) 1 << (MetaPixelChannels+15)), UndefinedOptionFlag, MagickFalse },
    { "26", ((ssize_t) 1 << (MetaPixelChannels+16)), UndefinedOptionFlag, MagickFalse },
    { "27", ((ssize_t) 1 << (MetaPixelChannels+17)), UndefinedOptionFlag, MagickFalse },
    { "28", ((ssize_t) 1 << (MetaPixelChannels+18)), UndefinedOptionFlag, MagickFalse },
    { "29", ((ssize_t) 1 << (MetaPixelChannels+19)), UndefinedOptionFlag, MagickFalse },
    { "30", ((ssize_t) 1 << (MetaPixelChannels+20)), UndefinedOptionFlag, MagickFalse },
    { "31", ((ssize_t) 1 << (MetaPixelChannels+21)), UndefinedOptionFlag, MagickFalse },
# 310 "MagickCore/option.c"
    { (char *) 
# 310 "MagickCore/option.c" 3 4
              ((void *)0)
# 310 "MagickCore/option.c"
                  , UndefinedChannel, UndefinedOptionFlag, MagickFalse }
  },
  ClassOptions[] =
  {
    ...
    { (char *) 
# 317 "MagickCore/option.c" 3 4
              ((void *)0)
# 317 "MagickCore/option.c"
                  , UndefinedClass, UndefinedOptionFlag, MagickFalse }
  },
  CLIOptions[] =
  {
    ...
    { "  swap", 0, UndefinedOptionFlag, MagickFalse },
    { (char *) 
# 553 "MagickCore/option.c" 3 4
              ((void *)0)
# 553 "MagickCore/option.c"
                  , 0, UndefinedOptionFlag, MagickFalse }
  },
  ClipPathOptions[] =
  {
    ...
    { (char *) 
# 561 "MagickCore/option.c" 3 4
              ((void *)0)
# 561 "MagickCore/option.c"
                  , UndefinedPathUnits, UndefinedOptionFlag, MagickFalse }
  },
  ColorspaceOptions[] =
  {
    ...
    { (char *) 
# 606 "MagickCore/option.c" 3 4
              ((void *)0)
# 606 "MagickCore/option.c"
                  , UndefinedColorspace, UndefinedOptionFlag, MagickFalse }
  },
  ComplexOptions[] =
  {
    ...
    { (char *) 
# 618 "MagickCore/option.c" 3 4
              ((void *)0)
# 618 "MagickCore/option.c"
                  , UndefinedComplexOperator, UndefinedOptionFlag, MagickFalse }
  },
  CommandOptions[] =
  {
    ...
    { (char *) 
# 1256 "MagickCore/option.c" 3 4
              ((void *)0)
# 1256 "MagickCore/option.c"
                  , 0L, UndefinedOptionFlag, MagickFalse }
  },
  ComplianceOptions[] =
  {
    ...
    { (char *) 
# 1267 "MagickCore/option.c" 3 4
              ((void *)0)
# 1267 "MagickCore/option.c"
                  , UndefinedClass, UndefinedOptionFlag, MagickFalse }
  },
  ComposeOptions[] =
  {
    ...
    { (char *) 
# 1357 "MagickCore/option.c" 3 4
              ((void *)0)
# 1357 "MagickCore/option.c"
                  , UndefinedCompositeOp, UndefinedOptionFlag, MagickFalse }
  },
  CompressOptions[] =
  {
    ...
    { (char *) 
# 1391 "MagickCore/option.c" 3 4
              ((void *)0)
# 1391 "MagickCore/option.c"
                  , UndefinedCompression, UndefinedOptionFlag, MagickFalse }
  },
  DataTypeOptions[] =
  {
    ...
    { (char *) 
# 1400 "MagickCore/option.c" 3 4
              ((void *)0)
# 1400 "MagickCore/option.c"
                  , UndefinedData, UndefinedOptionFlag, MagickFalse }
  },
  DecorateOptions[] =
  {
    ...
    { (char *) 
# 1409 "MagickCore/option.c" 3 4
              ((void *)0)
# 1409 "MagickCore/option.c"
                  , UndefinedDecoration, UndefinedOptionFlag, MagickFalse }
  },
  DirectionOptions[] =
  {
    ...
    { (char *) 
# 1420 "MagickCore/option.c" 3 4
              ((void *)0)
# 1420 "MagickCore/option.c"
                  , UndefinedDirection, UndefinedOptionFlag, MagickFalse }
  },
  DisposeOptions[] =
  {
    ...
    { (char *) 
# 1432 "MagickCore/option.c" 3 4
              ((void *)0)
# 1432 "MagickCore/option.c"
                  , UndefinedDispose, UndefinedOptionFlag, MagickFalse }
  },
  DistortOptions[] =
  {
    ...
    { (char *) 
# 1456 "MagickCore/option.c" 3 4
              ((void *)0)
# 1456 "MagickCore/option.c"
                  , UndefinedDistortion, UndefinedOptionFlag, MagickFalse }
  },
  DitherOptions[] =
  {
    ...
    { (char *) 
# 1464 "MagickCore/option.c" 3 4
              ((void *)0)
# 1464 "MagickCore/option.c"
                  , UndefinedEndian, UndefinedOptionFlag, MagickFalse }
  },
  EndianOptions[] =
  {
    ...
    { (char *) 
# 1471 "MagickCore/option.c" 3 4
              ((void *)0)
# 1471 "MagickCore/option.c"
                  , UndefinedEndian, UndefinedOptionFlag, MagickFalse }
  },
  EvaluateOptions[] =
  {
    ...
    { (char *) 
# 1513 "MagickCore/option.c" 3 4
              ((void *)0)
# 1513 "MagickCore/option.c"
                  , UndefinedEvaluateOperator, UndefinedOptionFlag, MagickFalse }
  },
  FillRuleOptions[] =
  {
    ...
    { (char *) 
# 1520 "MagickCore/option.c" 3 4
              ((void *)0)
# 1520 "MagickCore/option.c"
                  , UndefinedRule, UndefinedOptionFlag, MagickFalse }
  },
  FilterOptions[] =
  {
    ...
    { (char *) 
# 1558 "MagickCore/option.c" 3 4
              ((void *)0)
# 1558 "MagickCore/option.c"
                  , UndefinedFilter, UndefinedOptionFlag, MagickFalse }
  },
  FunctionOptions[] =
  {
    ...
    { (char *) 
# 1567 "MagickCore/option.c" 3 4
              ((void *)0)
# 1567 "MagickCore/option.c"
                  , UndefinedFunction, UndefinedOptionFlag, MagickFalse }
  },
  GradientOptions[] =
  {
    ...
    { (char *) 
# 1574 "MagickCore/option.c" 3 4
              ((void *)0)
# 1574 "MagickCore/option.c"
                  , UndefinedRule, UndefinedOptionFlag, MagickFalse }
  },
  GravityOptions[] =
  {
    ...
    { (char *) 
# 1590 "MagickCore/option.c" 3 4
              ((void *)0)
# 1590 "MagickCore/option.c"
                  , UndefinedGravity, UndefinedOptionFlag, MagickFalse }
  },
  IlluminantOptions[] =
  {
    ...
    { (char *) 
# 1606 "MagickCore/option.c" 3 4
              ((void *)0)
# 1606 "MagickCore/option.c"
                  , UndefinedIntent, UndefinedOptionFlag, MagickFalse }
  },
  IntentOptions[] =
  {
    ...
    { (char *) 
# 1615 "MagickCore/option.c" 3 4
              ((void *)0)
# 1615 "MagickCore/option.c"
                  , UndefinedIntent, UndefinedOptionFlag, MagickFalse }
  },
  InterlaceOptions[] =
  {
    ...
    { (char *) 
# 1627 "MagickCore/option.c" 3 4
              ((void *)0)
# 1627 "MagickCore/option.c"
                  , UndefinedInterlace, UndefinedOptionFlag, MagickFalse }
  },
  InterpolateOptions[] =
  {
    ...
    { (char *) 
# 1645 "MagickCore/option.c" 3 4
              ((void *)0)
# 1645 "MagickCore/option.c"
                  , UndefinedInterpolatePixel, UndefinedOptionFlag, MagickFalse }
  },
  KernelOptions[] =
  {
    ...
    { (char *) 
# 1687 "MagickCore/option.c" 3 4
              ((void *)0)
# 1687 "MagickCore/option.c"
                  , UndefinedKernel, UndefinedOptionFlag, MagickFalse }
  },
  LayerOptions[] =
  {
    ...
    { (char *) 
# 1708 "MagickCore/option.c" 3 4
              ((void *)0)
# 1708 "MagickCore/option.c"
                  , UndefinedLayer, UndefinedOptionFlag, MagickFalse }
  },
  LineCapOptions[] =
  {
    ...
    { (char *) 
# 1716 "MagickCore/option.c" 3 4
              ((void *)0)
# 1716 "MagickCore/option.c"
                  , UndefinedCap, UndefinedOptionFlag, MagickFalse }
  },
  LineJoinOptions[] =
  {
    ...
    { (char *) 
# 1724 "MagickCore/option.c" 3 4
              ((void *)0)
# 1724 "MagickCore/option.c"
                  , UndefinedJoin, UndefinedOptionFlag, MagickFalse }
  },
  ListOptions[] =
  {
    ...
    { (char *) 
# 1811 "MagickCore/option.c" 3 4
              ((void *)0)
# 1811 "MagickCore/option.c"
                  , MagickUndefinedOptions, UndefinedOptionFlag, MagickFalse }
  },
  LogEventOptions[] =
  {
    ...
    { (char *) 
# 1838 "MagickCore/option.c" 3 4
              ((void *)0)
# 1838 "MagickCore/option.c"
                  , UndefinedEvents, UndefinedOptionFlag, MagickFalse }
  },
  MetricOptions[] =
  {
    ...
    { (char *) 
# 1855 "MagickCore/option.c" 3 4
              ((void *)0)
# 1855 "MagickCore/option.c"
                  , UndefinedErrorMetric, UndefinedOptionFlag, MagickFalse }
  },
  MethodOptions[] =
  {
    ...
    { (char *) 
# 1865 "MagickCore/option.c" 3 4
              ((void *)0)
# 1865 "MagickCore/option.c"
                  , UndefinedMethod, UndefinedOptionFlag, MagickFalse }
  },
  ModeOptions[] =
  {
    ...
    { (char *) 
# 1873 "MagickCore/option.c" 3 4
              ((void *)0)
# 1873 "MagickCore/option.c"
                  , UndefinedMode, UndefinedOptionFlag, MagickFalse }
  },
  MorphologyOptions[] =
  {
    ...
    { (char *) 
# 1906 "MagickCore/option.c" 3 4
              ((void *)0)
# 1906 "MagickCore/option.c"
                  , UndefinedMorphology, UndefinedOptionFlag, MagickFalse }
  },
  NoiseOptions[] =
  {
    ...
    { (char *) 
# 1918 "MagickCore/option.c" 3 4
              ((void *)0)
# 1918 "MagickCore/option.c"
                  , UndefinedNoise, UndefinedOptionFlag, MagickFalse }
  },
  OrientationOptions[] =
  {
    ...
    { (char *) 
# 1931 "MagickCore/option.c" 3 4
              ((void *)0)
# 1931 "MagickCore/option.c"
                  , UndefinedOrientation, UndefinedOptionFlag, MagickFalse }
  },
  PixelChannelOptions[] =
  {
    ...
    { (char *) 
# 2020 "MagickCore/option.c" 3 4
              ((void *)0)
# 2020 "MagickCore/option.c"
                  , UndefinedPixelChannel, UndefinedOptionFlag, MagickFalse }
  },
  PixelIntensityOptions[] =
  {
    ...
    { (char *) 
# 2035 "MagickCore/option.c" 3 4
              ((void *)0)
# 2035 "MagickCore/option.c"
                  , UndefinedPixelIntensityMethod, UndefinedOptionFlag, MagickFalse }
  },
  PixelMaskOptions[] =
  {
    ...
    { (char *) 
# 2044 "MagickCore/option.c" 3 4
              ((void *)0)
# 2044 "MagickCore/option.c"
                  , UndefinedPixelMask, UndefinedOptionFlag, MagickFalse }
  },
  PixelTraitOptions[] =
  {
    ...
    { (char *) 
# 2052 "MagickCore/option.c" 3 4
              ((void *)0)
# 2052 "MagickCore/option.c"
                  , UndefinedPixelTrait, UndefinedOptionFlag, MagickFalse }
  },
  PolicyDomainOptions[] =
  {
    ...
    { (char *) 
# 2065 "MagickCore/option.c" 3 4
              ((void *)0)
# 2065 "MagickCore/option.c"
                  , UndefinedPolicyDomain, UndefinedOptionFlag, MagickFalse }
  },
  PolicyRightsOptions[] =
  {
    ...
    { (char *) 
# 2075 "MagickCore/option.c" 3 4
              ((void *)0)
# 2075 "MagickCore/option.c"
                  , UndefinedPolicyRights, UndefinedOptionFlag, MagickFalse }
  },
  PreviewOptions[] =
  {
    ...
    { (char *) 
# 2109 "MagickCore/option.c" 3 4
              ((void *)0)
# 2109 "MagickCore/option.c"
                  , UndefinedPreview, UndefinedOptionFlag, MagickFalse }
  },
  PrimitiveOptions[] =
  {
    ...
    { (char *) 
# 2130 "MagickCore/option.c" 3 4
              ((void *)0)
# 2130 "MagickCore/option.c"
                  , UndefinedPrimitive, UndefinedOptionFlag, MagickFalse }
  },
  QuantumFormatOptions[] =
  {
    ...
    { (char *) 
# 2138 "MagickCore/option.c" 3 4
              ((void *)0)
# 2138 "MagickCore/option.c"
                  , FloatingPointQuantumFormat, UndefinedOptionFlag, MagickFalse }
  },
  ResolutionOptions[] =
  {
    ...
    { (char *) 
# 2148 "MagickCore/option.c" 3 4
              ((void *)0)
# 2148 "MagickCore/option.c"
                  , UndefinedResolution, UndefinedOptionFlag, MagickFalse }
  },
  ResourceOptions[] =
  {
    ...
    { (char *) 
# 2164 "MagickCore/option.c" 3 4
              ((void *)0)
# 2164 "MagickCore/option.c"
                  , UndefinedResource, UndefinedOptionFlag, MagickFalse }
  },
  SparseColorOptions[] =
  {
    ...
    { (char *) 
# 2175 "MagickCore/option.c" 3 4
              ((void *)0)
# 2175 "MagickCore/option.c"
                  , UndefinedResource, UndefinedOptionFlag, MagickFalse }
  },
  StatisticOptions[] =
  {
    ...
    { (char *) 
# 2191 "MagickCore/option.c" 3 4
              ((void *)0)
# 2191 "MagickCore/option.c"
                  , UndefinedMethod, UndefinedOptionFlag, MagickFalse }
  },
  StorageOptions[] =
  {
    ...
    { (char *) 
# 2203 "MagickCore/option.c" 3 4
              ((void *)0)
# 2203 "MagickCore/option.c"
                  , UndefinedResource, UndefinedOptionFlag, MagickFalse }
  },
  StretchOptions[] =
  {
    ...
    { (char *) 
# 2218 "MagickCore/option.c" 3 4
              ((void *)0)
# 2218 "MagickCore/option.c"
                  , UndefinedStretch, UndefinedOptionFlag, MagickFalse }
  },
  StyleOptions[] =
  {
    ...
    { (char *) 
# 2227 "MagickCore/option.c" 3 4
              ((void *)0)
# 2227 "MagickCore/option.c"
                  , UndefinedStyle, UndefinedOptionFlag, MagickFalse }
  },
  ToolOptions[] =
  {
    ...
    { (char *) 
# 2242 "MagickCore/option.c" 3 4
              ((void *)0)
# 2242 "MagickCore/option.c"
                  , 0, UndefinedOptionFlag, MagickFalse }
  },
  TypeOptions[] =
  {
    ...
    { (char *) 
# 2263 "MagickCore/option.c" 3 4
              ((void *)0)
# 2263 "MagickCore/option.c"
                  , UndefinedType, UndefinedOptionFlag, MagickFalse }
  },
  ValidateOptions[] =
  {
    ...
    { (char *) 
# 2282 "MagickCore/option.c" 3 4
              ((void *)0)
# 2282 "MagickCore/option.c"
                  , UndefinedValidate, UndefinedOptionFlag, MagickFalse }
  },
  VirtualPixelOptions[] =
  {
    ...
    { (char *) 
# 2304 "MagickCore/option.c" 3 4
              ((void *)0)
# 2304 "MagickCore/option.c"
                  , UndefinedVirtualPixelMethod, UndefinedOptionFlag, MagickFalse }
  },
  WeightOptions[] =
  {
    ...
    { (char *) 
# 2323 "MagickCore/option.c" 3 4
              ((void *)0)
# 2323 "MagickCore/option.c"
                  , 0L, UndefinedOptionFlag, MagickFalse }
  },
  WordBreakOptions[] =
  {
    ...
    { (char *) 
# 2330 "MagickCore/option.c" 3 4
              ((void *)0)
# 2330 "MagickCore/option.c"
                  , UndefinedWordBreakType, UndefinedOptionFlag, MagickFalse }
  };
# 2358 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CloneImageOptions(ImageInfo *image_info,
  const ImageInfo *clone_info)
{
  
# 2361 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2361 "MagickCore/option.c"
...
# 2361 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2361, __extension__ __PRETTY_FUNCTION__); }))
# 2361 "MagickCore/option.c"
                                         ;
  
# 2362 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2362 "MagickCore/option.c"
...
# 2362 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2362, __extension__ __PRETTY_FUNCTION__); }))
# 2362 "MagickCore/option.c"
                                                     ;
  
# 2363 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2363 "MagickCore/option.c"
 clone_info != (const ImageInfo *) 
# 2363 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2363 "MagickCore/option.c"
 clone_info != (const ImageInfo *) 
# 2363 "MagickCore/option.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 2363 "MagickCore/option.c"
 "clone_info != (const ImageInfo *) NULL"
# 2363 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2363, __extension__ __PRETTY_FUNCTION__); }))
# 2363 "MagickCore/option.c"
                                               ;
  
# 2364 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2364 "MagickCore/option.c"
 clone_info->signature == 0xabacadabUL
# 2364 "MagickCore/option.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2364 "MagickCore/option.c"
 clone_info->signature == 0xabacadabUL
...
# 2364 "MagickCore/option.c"
 "clone_info->signature == MagickCoreSignature"
# 2364 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2364, __extension__ __PRETTY_FUNCTION__); }))
# 2364 "MagickCore/option.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/option.c",__func__,(unsigned long) 2366,"%s",
      image_info->filename);
  if (clone_info->options != (void *) 
# 2368 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 2368 "MagickCore/option.c"
                                         )
    {
      if (image_info->options != (void *) 
# 2370 "MagickCore/option.c" 3 4
                                         ((void *)0)
# 2370 "MagickCore/option.c"
                                             )
...
# 2405 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DefineImageOption(ImageInfo *image_info,
  const char *option)
{
  char
    key[4096],
...
# 2415 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2415 "MagickCore/option.c"
 image_info != (ImageInfo *) 
# 2415 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2415 "MagickCore/option.c"
...
# 2415 "MagickCore/option.c"
 "image_info != (ImageInfo *) NULL"
# 2415 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2415, __extension__ __PRETTY_FUNCTION__); }))
# 2415 "MagickCore/option.c"
                                         ;
  
# 2416 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2416 "MagickCore/option.c"
 option != (const char *) 
# 2416 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2416 "MagickCore/option.c"
...
# 2416 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2416, __extension__ __PRETTY_FUNCTION__); }))
# 2416 "MagickCore/option.c"
                                      ;
  (void) CopyMagickString(key,option,4096);
  for (p=key; *p != '\0'; p++)
    if (*p == '=')
      break;
  *value='\0';
...
# 2455 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DeleteImageOption(ImageInfo *image_info,
  const char *option)
{
  
# 2458 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2458 "MagickCore/option.c"
 image_info != (ImageInfo *) 
# 2458 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2458 "MagickCore/option.c"
...
# 2458 "MagickCore/option.c"
 "image_info != (ImageInfo *) NULL"
# 2458 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2458, __extension__ __PRETTY_FUNCTION__); }))
# 2458 "MagickCore/option.c"
                                         ;
  
# 2459 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2459 "MagickCore/option.c"
 image_info->signature == 0xabacadabUL
# 2459 "MagickCore/option.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2459 "MagickCore/option.c"
...
# 2459 "MagickCore/option.c"
 "image_info->signature == MagickCoreSignature"
# 2459 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2459, __extension__ __PRETTY_FUNCTION__); }))
# 2459 "MagickCore/option.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/option.c",__func__,(unsigned long) 2461,"%s",
      image_info->filename);
  if (image_info->options == (void *) 
# 2463 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 2463 "MagickCore/option.c"
                                         )
    return(MagickFalse);
  return(DeleteNodeFromSplayTree((SplayTreeInfo *) image_info->options,option));
}
# 2491 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) void DestroyImageOptions(ImageInfo *image_info)
{
  
# 2493 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2493 "MagickCore/option.c"
 image_info != (ImageInfo *) 
# 2493 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2493 "MagickCore/option.c"
...
# 2493 "MagickCore/option.c"
 "image_info != (ImageInfo *) NULL"
# 2493 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2493, __extension__ __PRETTY_FUNCTION__); }))
# 2493 "MagickCore/option.c"
                                         ;
  
# 2494 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2494 "MagickCore/option.c"
 image_info->signature == 0xabacadabUL
# 2494 "MagickCore/option.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2494 "MagickCore/option.c"
...
# 2494 "MagickCore/option.c"
 "image_info->signature == MagickCoreSignature"
# 2494 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2494, __extension__ __PRETTY_FUNCTION__); }))
# 2494 "MagickCore/option.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/option.c",__func__,(unsigned long) 2496,"%s",
      image_info->filename);
  if (image_info->options != (void *) 
# 2498 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 2498 "MagickCore/option.c"
                                         )
    image_info->options=DestroySplayTree((SplayTreeInfo *) image_info->options);
}
# 2530 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) const char *GetImageOption(const ImageInfo *image_info,
  const char *option)
{
  
# 2533 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2533 "MagickCore/option.c"
 image_info != (ImageInfo *) 
# 2533 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2533 "MagickCore/option.c"
...
# 2533 "MagickCore/option.c"
 "image_info != (ImageInfo *) NULL"
# 2533 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2533, __extension__ __PRETTY_FUNCTION__); }))
# 2533 "MagickCore/option.c"
                                         ;
  
# 2534 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2534 "MagickCore/option.c"
 image_info->signature == 0xabacadabUL
# 2534 "MagickCore/option.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2534 "MagickCore/option.c"
...
# 2534 "MagickCore/option.c"
 "image_info->signature == MagickCoreSignature"
# 2534 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2534, __extension__ __PRETTY_FUNCTION__); }))
# 2534 "MagickCore/option.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/option.c",__func__,(unsigned long) 2536,"%s",
      image_info->filename);
  if (image_info->options == (void *) 
# 2538 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 2538 "MagickCore/option.c"
                                         )
    return((const char *) 
# 2539 "MagickCore/option.c" 3 4
                         ((void *)0)
# 2539 "MagickCore/option.c"
                             );
  return((const char *) GetValueFromSplayTree((SplayTreeInfo *)
    image_info->options,option));
}
# 2574 "MagickCore/option.c"
static const OptionInfo *GetOptionInfo(const CommandOption option)
{
  ...
  return((const OptionInfo *) 
# 2647 "MagickCore/option.c" 3 4
                             ((void *)0)
# 2647 "MagickCore/option.c"
                                 );
}

__attribute__ ((visibility ("default"))) ssize_t GetCommandOptionFlags(const CommandOption option,
  const MagickBooleanType list,const char *options)
{
  ...
  if ((options == (const char *) 
# 2678 "MagickCore/option.c" 3 4
                                ((void *)0)
# 2678 "MagickCore/option.c"
                                    ) || (*options == '\0'))
    return(-1);
  option_info=GetOptionInfo(option);
  if (option_info == (const OptionInfo *) 
# 2681 "MagickCore/option.c" 3 4
                                         ((void *)0)
# 2681 "MagickCore/option.c"
                                             )
    return(UndefinedOptionFlag);
  option_types=0;
  sentinel=',';
  if (strchr(options,'|') != (char *) 
# 2685 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 2685 "MagickCore/option.c"
                                         )
    sentinel='|';
  for (p=options; p != (char *) 
# 2687 "MagickCore/option.c" 3 4
                               ((void *)0)
# 2687 "MagickCore/option.c"
                                   ; p=strchr(p,sentinel))
  {
    while (((
# 2689 "MagickCore/option.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 2689 "MagickCore/option.c"
            (int) ((unsigned char) *p)
# 2689 "MagickCore/option.c" 3 4
...
# 2689 "MagickCore/option.c"
    ...
    q=token;
    while (((
# 2696 "MagickCore/option.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 2696 "MagickCore/option.c"
            (int) ((unsigned char) *p)
# 2696 "MagickCore/option.c" 3 4
            ))] & (unsigned short int) _ISspace) 
# 2696 "MagickCore/option.c"
    ...
    *q='\0';
    for (i=0; option_info[i].mnemonic != (char *) 
# 2704 "MagickCore/option.c" 3 4
                                                 ((void *)0)
# 2704 "MagickCore/option.c"
                                                     ; i++)
      if (LocaleCompare(token,option_info[i].mnemonic) == 0)
        break;
    command_info=option_info+i;
    if ((command_info->mnemonic == (const char *) 
# 2708 "MagickCore/option.c" 3 4
                                                 ((void *)0)
# 2708 "MagickCore/option.c"
                                                     ) && (*token != '\0') &&
        ((strchr(token+1,'-') != (char *) 
# 2709 "MagickCore/option.c" 3 4
                                         ((void *)0)
# 2709 "MagickCore/option.c"
                                             ) ||
         (strchr(token+1,'_') != (char *) 
# 2710 "MagickCore/option.c" 3 4
                                         ((void *)0)
# 2710 "MagickCore/option.c"
                                             )))
      {
        while ((q=strchr(token+1,'-')) != (char *) 
# 2712 "MagickCore/option.c" 3 4
                                                  ((void *)0)
# 2712 "MagickCore/option.c"
                                                      )
          (void) CopyMagickString(q,q+1,4096 -strlen(q));
        while ((q=strchr(token+1,'_')) != (char *) 
# 2714 "MagickCore/option.c" 3 4
                                                  ((void *)0)
# 2714 "MagickCore/option.c"
                                                      )
          (void) CopyMagickString(q,q+1,4096 -strlen(q));
        for (i=0; option_info[i].mnemonic != (char *) 
# 2716 "MagickCore/option.c" 3 4
                                                     ((void *)0)
# 2716 "MagickCore/option.c"
                                                         ; i++)
          if (LocaleCompare(token,option_info[i].mnemonic) == 0)
            break;
        command_info=option_info+i;
    ...
    if (command_info->mnemonic == (const char *) 
# 2721 "MagickCore/option.c" 3 4
                                                ((void *)0)
# 2721 "MagickCore/option.c"
                                                    )
      return(-1);
    if (negate != MagickFalse)
...
# 2757 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) const OptionInfo *GetCommandOptionInfo(const char *option)
{
  ssize_t
    i;

  for (i=0; CommandOptions[i].mnemonic != (char *) 
# 2762 "MagickCore/option.c" 3 4
                                                  ((void *)0)
# 2762 "MagickCore/option.c"
                                                      ; i++)
    if (LocaleCompare(option,CommandOptions[i].mnemonic) == 0)
      break;
  return(CommandOptions+i);
}
# 2790 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) char **GetCommandOptions(const CommandOption option)
{
  char
    **options;
  ...
  option_info=GetOptionInfo(option);
  if (option_info == (const OptionInfo *) 
# 2802 "MagickCore/option.c" 3 4
                                         ((void *)0)
# 2802 "MagickCore/option.c"
                                             )
    return((char **) 
# 2803 "MagickCore/option.c" 3 4
                    ((void *)0)
# 2803 "MagickCore/option.c"
                        );
  for (i=0; option_info[i].mnemonic != (const char *) 
# 2804 "MagickCore/option.c" 3 4
                                                     ((void *)0)
# 2804 "MagickCore/option.c"
                                                         ; i++) ;
  options=(char **) AcquireQuantumMemory((size_t) i+1UL,sizeof(*options));
  if (options == (char **) 
# 2806 "MagickCore/option.c" 3 4
                          ((void *)0)
# 2806 "MagickCore/option.c"
                              )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 2807 "MagickCore/option.c" 3 4
   (*__errno_location ())
# 2807 "MagickCore/option.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/option.c",__func__,(unsigned long) 2807,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  for (i=0; option_info[i].mnemonic != (const char *) 
# 2808 "MagickCore/option.c" 3 4
                                                     ((void *)0)
# 2808 "MagickCore/option.c"
                                                         ; i++)
    options[i]=AcquireString(option_info[i].mnemonic);
  options[i]=(char *) 
# 2810 "MagickCore/option.c" 3 4
                     ((void *)0)
# 2810 "MagickCore/option.c"
                         ;
  return(options);
}
# 2836 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) char *GetNextImageOption(const ImageInfo *image_info)
{
  
# 2838 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2838 "MagickCore/option.c"
 image_info != (ImageInfo *) 
# 2838 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2838 "MagickCore/option.c"
...
# 2838 "MagickCore/option.c"
 "image_info != (ImageInfo *) NULL"
# 2838 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2838, __extension__ __PRETTY_FUNCTION__); }))
# 2838 "MagickCore/option.c"
                                         ;
  
# 2839 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2839 "MagickCore/option.c"
 image_info->signature == 0xabacadabUL
# 2839 "MagickCore/option.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2839 "MagickCore/option.c"
...
# 2839 "MagickCore/option.c"
 "image_info->signature == MagickCoreSignature"
# 2839 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2839, __extension__ __PRETTY_FUNCTION__); }))
# 2839 "MagickCore/option.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/option.c",__func__,(unsigned long) 2841,"%s",
      image_info->filename);
  if (image_info->options == (void *) 
# 2843 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 2843 "MagickCore/option.c"
                                         )
    return((char *) 
# 2844 "MagickCore/option.c" 3 4
                   ((void *)0)
# 2844 "MagickCore/option.c"
                       );
  return((char *) GetNextKeyInSplayTree((SplayTreeInfo *) image_info->options));
}
# 2871 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsCommandOption(const char *option)
{
  char
    *value;
...
# 2882 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 2882 "MagickCore/option.c"
 option != (const char *) 
# 2882 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2882 "MagickCore/option.c"
...
# 2882 "MagickCore/option.c"
 "option != (const char *) NULL"
# 2882 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 2882, __extension__ __PRETTY_FUNCTION__); }))
# 2882 "MagickCore/option.c"
                                      ;
  if ((*option != '-') && (*option != '+'))
    return(MagickFalse);
  ...
  if (value != (char *) 
# 2890 "MagickCore/option.c" 3 4
                       ((void *)0)
# 2890 "MagickCore/option.c"
                           )
  ...
  option++;
  if (
# 2898 "MagickCore/option.c" 3 4
     ((*__ctype_b_loc ())[(int) ((
# 2898 "MagickCore/option.c"
     (int) ((unsigned char) *option)
# 2898 "MagickCore/option.c" 3 4
...
# 2928 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) const char *CommandOptionToMnemonic(const CommandOption option,
  const ssize_t type)
{
  const OptionInfo
    *option_info;
  ...
  option_info=GetOptionInfo(option);
  if (option_info == (const OptionInfo *) 
# 2938 "MagickCore/option.c" 3 4
                                         ((void *)0)
# 2938 "MagickCore/option.c"
                                             )
    return((const char *) 
# 2939 "MagickCore/option.c" 3 4
                         ((void *)0)
# 2939 "MagickCore/option.c"
                             );
  for (i=0; option_info[i].mnemonic != (const char *) 
# 2940 "MagickCore/option.c" 3 4
                                                     ((void *)0)
# 2940 "MagickCore/option.c"
                                                         ; i++)
    if (type == option_info[i].type)
      break;
  if (option_info[i].mnemonic == (const char *) 
# 2943 "MagickCore/option.c" 3 4
                                               ((void *)0)
# 2943 "MagickCore/option.c"
                                                   )
    return("Unrecognized");
  return(option_info[i].mnemonic);
}
# 2974 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsOptionMember(const char *option,
  const char *options)
{
  char
    **option_list,
  ...
  if (options == (const char *) 
# 2993 "MagickCore/option.c" 3 4
                               ((void *)0)
# 2993 "MagickCore/option.c"
                                   )
    return(MagickFalse);
  ...
  if (option_list == (char **) 
# 2999 "MagickCore/option.c" 3 4
                              ((void *)0)
# 2999 "MagickCore/option.c"
                                  )
    return(MagickFalse);
  member=MagickFalse;
...
# 3048 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListCommandOptions(FILE *file,
  const CommandOption option,ExceptionInfo *magick_unused_exception __attribute__((unused)))
{
  const OptionInfo
    *option_info;
  ...
  ;
  if (file == (FILE *) 
# 3058 "MagickCore/option.c" 3 4
                      ((void *)0)
# 3058 "MagickCore/option.c"
                          )
    file=
# 3059 "MagickCore/option.c" 3 4
        stdout
# 3059 "MagickCore/option.c"
              ;
  option_info=GetOptionInfo(option);
  if (option_info == (const OptionInfo *) 
# 3061 "MagickCore/option.c" 3 4
                                         ((void *)0)
# 3061 "MagickCore/option.c"
                                             )
    return(MagickFalse);
  for (i=0; option_info[i].mnemonic != (char *) 
# 3063 "MagickCore/option.c" 3 4
                                               ((void *)0)
# 3063 "MagickCore/option.c"
                                                   ; i++)
  {
...
# 3095 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) ssize_t ParseChannelOption(const char *channels)
{
  ssize_t
    i;
...
# 3219 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) ssize_t ParseCommandOption(const CommandOption option,
  const MagickBooleanType list,const char *options)
{
  char
    token[4096];
  ...
  if ((options == (const char *) 
# 3247 "MagickCore/option.c" 3 4
                                ((void *)0)
# 3247 "MagickCore/option.c"
                                    ) || (*options == '\0'))
    return(-1);
  option_info=GetOptionInfo(option);
  if (option_info == (const OptionInfo *) 
# 3250 "MagickCore/option.c" 3 4
                                         ((void *)0)
# 3250 "MagickCore/option.c"
                                             )
    return(-1);
  option_types=0;
  sentinel=',';
  if (strchr(options,'|') != (char *) 
# 3254 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 3254 "MagickCore/option.c"
                                         )
    sentinel='|';
  for (p=options; p != (char *) 
# 3256 "MagickCore/option.c" 3 4
                               ((void *)0)
# 3256 "MagickCore/option.c"
                                   ; p=strchr(p,sentinel))
  {
    while (((
# 3258 "MagickCore/option.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 3258 "MagickCore/option.c"
            (int) ((unsigned char) *p)
# 3258 "MagickCore/option.c" 3 4
            ))] & (unsigned short int) _ISspace) 
# 3258 "MagickCore/option.c"
    ...
    q=token;
    while (((
# 3265 "MagickCore/option.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 3265 "MagickCore/option.c"
            (int) ((unsigned char) *p)
# 3265 "MagickCore/option.c" 3 4
            ))] & (unsigned short int) _ISspace) 
# 3265 "MagickCore/option.c"
    ...
    *q='\0';
    for (i=0; option_info[i].mnemonic != (char *) 
# 3273 "MagickCore/option.c" 3 4
                                                 ((void *)0)
# 3273 "MagickCore/option.c"
                                                     ; i++)
      if (LocaleCompare(token,option_info[i].mnemonic) == 0)
        break;
    command_info=option_info+i;
    if ((command_info->mnemonic == (const char *) 
# 3277 "MagickCore/option.c" 3 4
                                                 ((void *)0)
# 3277 "MagickCore/option.c"
                                                     ) && (*token != '\0') &&
        ((strchr(token+1,'-') != (char *) 
# 3278 "MagickCore/option.c" 3 4
                                         ((void *)0)
# 3278 "MagickCore/option.c"
                                             ) ||
         (strchr(token+1,'_') != (char *) 
# 3279 "MagickCore/option.c" 3 4
                                         ((void *)0)
# 3279 "MagickCore/option.c"
                                             )))
        {
          while ((q=strchr(token+1,'-')) != (char *) 
# 3281 "MagickCore/option.c" 3 4
                                                    ((void *)0)
# 3281 "MagickCore/option.c"
                                                        )
            (void) CopyMagickString(q,q+1,4096 -strlen(q));
          while ((q=strchr(token+1,'_')) != (char *) 
# 3283 "MagickCore/option.c" 3 4
                                                    ((void *)0)
# 3283 "MagickCore/option.c"
                                                        )
            (void) CopyMagickString(q,q+1,4096 -strlen(q));
          for (i=0; option_info[i].mnemonic != (char *) 
# 3285 "MagickCore/option.c" 3 4
                                                       ((void *)0)
# 3285 "MagickCore/option.c"
                                                           ; i++)
            if (LocaleCompare(token,option_info[i].mnemonic) == 0)
              break;
          command_info=option_info+i;
    ...
    if (command_info->mnemonic == (const char *) 
# 3290 "MagickCore/option.c" 3 4
                                                ((void *)0)
# 3290 "MagickCore/option.c"
                                                    )
      return(-1);
    if (negate != MagickFalse)
...
# 3325 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) ssize_t ParsePixelChannelOption(const char *channels)
{
  char
    *q,
    token[4096];
  ...
  (void) GetNextToken(channels,(const char **) 
# 3334 "MagickCore/option.c" 3 4
                                              ((void *)0)
# 3334 "MagickCore/option.c"
                                                  ,4096,token);
  if ((*token == ';') || (*token == '|'))
  ...
  if ((q == token) || (channel < 0) || (channel >= 64))
    return(-1);
  return(channel);
}
# 3374 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) char *RemoveImageOption(ImageInfo *image_info,const char *option)
{
  char
    *value;

  
# 3379 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 3379 "MagickCore/option.c"
 image_info != (ImageInfo *) 
# 3379 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3379 "MagickCore/option.c"
...
# 3379 "MagickCore/option.c"
 "image_info != (ImageInfo *) NULL"
# 3379 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 3379, __extension__ __PRETTY_FUNCTION__); }))
# 3379 "MagickCore/option.c"
                                         ;
  
# 3380 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 3380 "MagickCore/option.c"
 image_info->signature == 0xabacadabUL
# 3380 "MagickCore/option.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3380 "MagickCore/option.c"
...
# 3380 "MagickCore/option.c"
 "image_info->signature == MagickCoreSignature"
# 3380 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 3380, __extension__ __PRETTY_FUNCTION__); }))
# 3380 "MagickCore/option.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/option.c",__func__,(unsigned long) 3382,"%s",
      image_info->filename);
  if (image_info->options == (void *) 
# 3384 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 3384 "MagickCore/option.c"
                                         )
    return((char *) 
# 3385 "MagickCore/option.c" 3 4
                   ((void *)0)
# 3385 "MagickCore/option.c"
                       );
  value=(char *) RemoveNodeFromSplayTree((SplayTreeInfo *)
    image_info->options,option);
  return(value);
}
# 3414 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) void ResetImageOptions(const ImageInfo *image_info)
{
  
# 3416 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 3416 "MagickCore/option.c"
 image_info != (ImageInfo *) 
# 3416 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3416 "MagickCore/option.c"
...
# 3416 "MagickCore/option.c"
 "image_info != (ImageInfo *) NULL"
# 3416 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 3416, __extension__ __PRETTY_FUNCTION__); }))
# 3416 "MagickCore/option.c"
                                         ;
  
# 3417 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 3417 "MagickCore/option.c"
 image_info->signature == 0xabacadabUL
# 3417 "MagickCore/option.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3417 "MagickCore/option.c"
...
# 3417 "MagickCore/option.c"
 "image_info->signature == MagickCoreSignature"
# 3417 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 3417, __extension__ __PRETTY_FUNCTION__); }))
# 3417 "MagickCore/option.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/option.c",__func__,(unsigned long) 3419,"%s",
      image_info->filename);
  if (image_info->options == (void *) 
# 3421 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 3421 "MagickCore/option.c"
                                         )
    return;
  ResetSplayTree((SplayTreeInfo *) image_info->options);
}
# 3450 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) void ResetImageOptionIterator(const ImageInfo *image_info)
{
  
# 3452 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 3452 "MagickCore/option.c"
 image_info != (ImageInfo *) 
# 3452 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3452 "MagickCore/option.c"
...
# 3452 "MagickCore/option.c"
 "image_info != (ImageInfo *) NULL"
# 3452 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 3452, __extension__ __PRETTY_FUNCTION__); }))
# 3452 "MagickCore/option.c"
                                         ;
  
# 3453 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 3453 "MagickCore/option.c"
 image_info->signature == 0xabacadabUL
# 3453 "MagickCore/option.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3453 "MagickCore/option.c"
...
# 3453 "MagickCore/option.c"
 "image_info->signature == MagickCoreSignature"
# 3453 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 3453, __extension__ __PRETTY_FUNCTION__); }))
# 3453 "MagickCore/option.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/option.c",__func__,(unsigned long) 3455,"%s",
      image_info->filename);
  if (image_info->options == (void *) 
# 3457 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 3457 "MagickCore/option.c"
                                         )
    return;
  ResetSplayTreeIterator((SplayTreeInfo *) image_info->options);
}
# 3489 "MagickCore/option.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageOption(ImageInfo *image_info,
  const char *option,const char *value)
{
  
# 3492 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 3492 "MagickCore/option.c"
 image_info != (ImageInfo *) 
# 3492 "MagickCore/option.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3492 "MagickCore/option.c"
...
# 3492 "MagickCore/option.c"
 "image_info != (ImageInfo *) NULL"
# 3492 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 3492, __extension__ __PRETTY_FUNCTION__); }))
# 3492 "MagickCore/option.c"
                                         ;
  
# 3493 "MagickCore/option.c" 3 4
 ((void) sizeof ((
# 3493 "MagickCore/option.c"
 image_info->signature == 0xabacadabUL
# 3493 "MagickCore/option.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3493 "MagickCore/option.c"
...
# 3493 "MagickCore/option.c"
 "image_info->signature == MagickCoreSignature"
# 3493 "MagickCore/option.c" 3 4
 , "MagickCore/option.c", 3493, __extension__ __PRETTY_FUNCTION__); }))
# 3493 "MagickCore/option.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/option.c",__func__,(unsigned long) 3495,"%s",
      image_info->filename);
  ...
  if (image_info->options == (void *) 
# 3507 "MagickCore/option.c" 3 4
                                     ((void *)0)
# 3507 "MagickCore/option.c"
                                         )
  ...
  if (value == (const char *) 
# 3513 "MagickCore/option.c" 3 4
                             ((void *)0)
# 3513 "MagickCore/option.c"
                                 )
