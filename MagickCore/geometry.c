# 0 "MagickCore/geometry.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/geometry.c"
# 39 "MagickCore/geometry.c"
...
# 40 "MagickCore/geometry.c" 2
# 1 "./MagickCore/constitute.h" 1
# 21 "./MagickCore/constitute.h"
...
# 52 "MagickCore/geometry.c" 2
# 61 "MagickCore/geometry.c"
...
static const PageInfo
  Pagesizes[] =
  {
    { "4x6", sizeof("4x6")-1, "288x432" },
    { "5x7", sizeof("5x7")-1, "360x504" },
    { "7x9", sizeof("7x9")-1, "504x648" },
    { "8x10", sizeof("8x10")-1, "576x720" },
    { "9x11", sizeof("9x11")-1, "648x792" },
    { "9x12", sizeof("9x12")-1, "648x864" },
    { "10x13", sizeof("10x13")-1, "720x936" },
    { "10x14", sizeof("10x14")-1, "720x1008" },
    { "11x17", sizeof("11x17")-1, "792x1224" },
    { "4A0", sizeof("4A0")-1, "4768x6741" },
    { "2A0", sizeof("2A0")-1, "3370x4768" },
    { "a0", sizeof("a0")-1, "2384x3370" },
    { "a10", sizeof("a10")-1, "74x105" },
    { "a1", sizeof("a1")-1, "1684x2384" },
    { "a2", sizeof("a2")-1, "1191x1684" },
    { "a3", sizeof("a3")-1, "842x1191" },
    { "a4small", sizeof("a4small")-1, "595x842" },
    { "a4", sizeof("a4")-1, "595x842" },
    { "a5", sizeof("a5")-1, "420x595" },
    { "a6", sizeof("a6")-1, "298x420" },
    { "a7", sizeof("a7")-1, "210x298" },
    { "a8", sizeof("a8")-1, "147x210" },
    { "a9", sizeof("a9")-1, "105x147" },
    { "archa", sizeof("archa")-1, "648x864" },
    { "archb", sizeof("archb")-1, "864x1296" },
    { "archC", sizeof("archC")-1, "1296x1728" },
    { "archd", sizeof("archd")-1, "1728x2592" },
    { "arche", sizeof("arche")-1, "2592x3456" },
    { "b0", sizeof("b0")-1, "2920x4127" },
    { "b10", sizeof("b10")-1, "91x127" },
    { "b1", sizeof("b1")-1, "2064x2920" },
    { "b2", sizeof("b2")-1, "1460x2064" },
    { "b3", sizeof("b3")-1, "1032x1460" },
    { "b4", sizeof("b4")-1, "729x1032" },
    { "b5", sizeof("b5")-1, "516x729" },
    { "b6", sizeof("b6")-1, "363x516" },
    { "b7", sizeof("b7")-1, "258x363" },
    { "b8", sizeof("b8")-1, "181x258" },
    { "b9", sizeof("b9")-1, "127x181" },
    { "c0", sizeof("c0")-1, "2599x3676" },
    { "c1", sizeof("c1")-1, "1837x2599" },
    { "c2", sizeof("c2")-1, "1298x1837" },
    { "c3", sizeof("c3")-1, "918x1296" },
    { "c4", sizeof("c4")-1, "649x918" },
    { "c5", sizeof("c5")-1, "459x649" },
    { "c6", sizeof("c6")-1, "323x459" },
    { "c7", sizeof("c7")-1, "230x323" },
    { "csheet", sizeof("csheet")-1, "1224x1584" },
    { "dsheet", sizeof("dsheet")-1, "1584x2448" },
    { "esheet", sizeof("esheet")-1, "2448x3168" },
    { "executive", sizeof("executive")-1, "540x720" },
    { "flsa", sizeof("flsa")-1, "612x936" },
    { "flse", sizeof("flse")-1, "612x936" },
    { "folio", sizeof("folio")-1, "612x936" },
    { "halfletter", sizeof("halfletter")-1, "396x612" },
    { "isob0", sizeof("isob0")-1, "2835x4008" },
    { "isob10", sizeof("isob10")-1, "88x125" },
    { "isob1", sizeof("isob1")-1, "2004x2835" },
    { "isob2", sizeof("isob2")-1, "1417x2004" },
    { "isob3", sizeof("isob3")-1, "1001x1417" },
    { "isob4", sizeof("isob4")-1, "709x1001" },
    { "isob5", sizeof("isob5")-1, "499x709" },
    { "isob6", sizeof("isob6")-1, "354x499" },
    { "isob7", sizeof("isob7")-1, "249x354" },
    { "isob8", sizeof("isob8")-1, "176x249" },
    { "isob9", sizeof("isob9")-1, "125x176" },
    { "jisb0", sizeof("jisb0")-1, "1030x1456" },
    { "jisb1", sizeof("jisb1")-1, "728x1030" },
    { "jisb2", sizeof("jisb2")-1, "515x728" },
    { "jisb3", sizeof("jisb3")-1, "364x515" },
    { "jisb4", sizeof("jisb4")-1, "257x364" },
    { "jisb5", sizeof("jisb5")-1, "182x257" },
    { "jisb6", sizeof("jisb6")-1, "128x182" },
    { "ledger", sizeof("ledger")-1, "1224x792" },
    { "legal", sizeof("legal")-1, "612x1008" },
    { "lettersmall", sizeof("lettersmall")-1, "612x792" },
    { "letter", sizeof("letter")-1, "612x792" },
    { "monarch", sizeof("monarch")-1, "279x540" },
    { "quarto", sizeof("quarto")-1, "610x780" },
    { "statement", sizeof("statement")-1, "396x612" },
    { "tabloid", sizeof("tabloid")-1, "792x1224" },
    { "", sizeof("")-1, "" }
  };
# 202 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickStatusType GetGeometry(const char *geometry,ssize_t *x,
  ssize_t *y,size_t *width,size_t *height)
{
  char
    *p,
    pedantic_geometry[4096],
    *q;
  ...
  flags=NoValue;
  if ((geometry == (char *) 
# 223 "MagickCore/geometry.c" 3 4
                           ((void *)0)
# 223 "MagickCore/geometry.c"
                               ) || (*geometry == '\0'))
    return(flags);
  if (strlen(geometry) >= (4096 -1))
    return(flags);
  (void) CopyMagickString(pedantic_geometry,geometry,4096);
  for (p=pedantic_geometry; *p != '\0'; )
  {
    if (
# 230 "MagickCore/geometry.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 230 "MagickCore/geometry.c"
       (int) ((unsigned char) *p)
# 230 "MagickCore/geometry.c" 3 4
...
# 230 "MagickCore/geometry.c"
                                           != 0)
      {
        (void) CopyMagickString(p,p+1,4096);
        continue;
      }
    c=(int) *p;
    switch (c)
  ...
  if ((*p != '+') && (*p != '-'))
    {
      ...
      if ((c == 215) || (*q == 'x') || (*q == 'X') || (*q == ':') ||
          (*q == '\0'))
        {
          ...
          q=p;
          if (width != (size_t *) 
# 350 "MagickCore/geometry.c" 3 4
                                 ((void *)0)
# 350 "MagickCore/geometry.c"
                                     )
            {
              if (LocaleNCompare(p,"0x",2) == 0)
          ...
          if ((*p != '+') && (*p != '-'))
            {
              ...
              q=p;
              if (height != (size_t *) 
# 373 "MagickCore/geometry.c" 3 4
                                      ((void *)0)
# 373 "MagickCore/geometry.c"
                                          )
  ...
  if ((*p == '+') || (*p == '-'))
    {
      ...
      q=p;
      if (x != (ssize_t *) 
# 392 "MagickCore/geometry.c" 3 4
                          ((void *)0)
# 392 "MagickCore/geometry.c"
                              )
        *x=CastDoubleToLong(StringToDouble(p,&p));
      if (p != q)
        {
          flags|=XValue;
          if (((flags & XNegative) != 0) && (x != (ssize_t *) 
# 397 "MagickCore/geometry.c" 3 4
                                                             ((void *)0)
# 397 "MagickCore/geometry.c"
                                                                 ))
  ...
  if ((*p == '+') || (*p == '-'))
    {
      ...
      q=p;
      if (y != (ssize_t *) 
# 413 "MagickCore/geometry.c" 3 4
                          ((void *)0)
# 413 "MagickCore/geometry.c"
                              )
        *y=CastDoubleToLong(StringToDouble(p,&p));
      if (p != q)
        {
          flags|=YValue;
          if (((flags & YNegative) != 0) && (y != (ssize_t *) 
# 418 "MagickCore/geometry.c" 3 4
                                                             ((void *)0)
# 418 "MagickCore/geometry.c"
                                                                 ))
  ...
  if ((flags & PercentValue) != 0)
    {
      if (((flags & SeparatorValue) == 0) && ((flags & HeightValue) == 0))
        {
          if ((height != (size_t *) 
# 426 "MagickCore/geometry.c" 3 4
                                   ((void *)0)
# 426 "MagickCore/geometry.c"
                                       ) && (width != (size_t *) 
# 426 "MagickCore/geometry.c" 3 4
                                                                 ((void *)0)
# 426 "MagickCore/geometry.c"
      ...
      if (((flags & SeparatorValue) != 0) && ((flags & WidthValue) == 0) &&
          (height != (size_t *) 
# 431 "MagickCore/geometry.c" 3 4
                               ((void *)0)
# 431 "MagickCore/geometry.c"
                                   ) && (width != (size_t *) 
# 431 "MagickCore/geometry.c" 3 4
                                                             ((void *)0)
# 431 "MagickCore/geometry.c"
...
# 445 "MagickCore/geometry.c"
  return(flags);
}
# 473 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) char *GetPageGeometry(const char *page_geometry)
{
  char
    page[4096];
...
# 481 "MagickCore/geometry.c" 3 4
 ((void) sizeof ((
# 481 "MagickCore/geometry.c"
 page_geometry != (char *) 
# 481 "MagickCore/geometry.c" 3 4
...
# 481 "MagickCore/geometry.c" 3 4
 , "MagickCore/geometry.c", 481, __extension__ __PRETTY_FUNCTION__); }))
# 481 "MagickCore/geometry.c"
                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/geometry.c",__func__,(unsigned long) 483,"%s",page_geometry);
  (void) CopyMagickString(page,page_geometry,4096);
    ...
    if (status == 0)
      {
        ...
        (void) FormatLocaleString(page,4096,"%s%.80s",
          Pagesizes[i].geometry,page_geometry+Pagesizes[i].extent);
        flags=GetGeometry(page,&geometry.x,&geometry.y,&geometry.width,
          &geometry.height);
        if ((flags & GreaterValue) == 0)
          (void) ConcatenateMagickString(page,">",4096);
        break;
      }
  }
  return(AcquireString(page));
}
# 545 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) void GravityAdjustGeometry(const size_t width,
...
# 624 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsGeometry(const char *geometry)
{
  GeometryInfo
    geometry_info;
...
# 632 "MagickCore/geometry.c" 3 4
                                ((void *)0)
# 632 "MagickCore/geometry.c"
                                    )
    return(MagickFalse);
  flags=ParseGeometry(geometry,&geometry_info);
  return(flags != NoValue ? MagickTrue : MagickFalse);
}
# 665 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsSceneGeometry(const char *geometry,
  const MagickBooleanType pedantic)
{
  ...
  if (geometry == (const char *) 
# 674 "MagickCore/geometry.c" 3 4
                                ((void *)0)
# 674 "MagickCore/geometry.c"
                                    )
    return(MagickFalse);
  p=(char *) geometry;
  value=StringToDouble(geometry,&p);
  if (
# 678 "MagickCore/geometry.c" 3 4
     __builtin_isnan (
# 678 "MagickCore/geometry.c"
     value
# 678 "MagickCore/geometry.c" 3 4
     ) 
# 678 "MagickCore/geometry.c"
                  != 0)
    return(MagickFalse);
  if (value > (double) (0x7fffffffffffffffL
# 680 "MagickCore/geometry.c"
                      ))
    return(MagickFalse);
  if (value < (double) (-0x7fffffffffffffffL 
# 682 "MagickCore/geometry.c"
                      -1))
    return(MagickFalse);
  if (p == geometry)
    return(MagickFalse);
  if (strspn(geometry,"0123456789-, ") != strlen(geometry))
    return(MagickFalse);
  if ((pedantic != MagickFalse) && (strchr(geometry,',') != (char *) 
# 688 "MagickCore/geometry.c" 3 4
                                                                    ((void *)0)
# 688 "MagickCore/geometry.c"
                                                                        ))
    return(MagickFalse);
  return(MagickTrue);
}
# 717 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListPagesizes(FILE *file,
  ExceptionInfo *magick_unused_exception __attribute__((unused)))
{
  ...
  ;
  if (file == (FILE *) 
# 729 "MagickCore/geometry.c" 3 4
                      ((void *)0)
# 729 "MagickCore/geometry.c"
                          )
    file=
# 730 "MagickCore/geometry.c" 3 4
        stdout
# 730 "MagickCore/geometry.c"
              ;
  (void) FormatLocaleFile(file,"\nPagesize    Geometry \n");
  (void) FormatLocaleFile(file,"---------------------\n");
  for (i=0; *Pagesizes[i].name != '\0'; i++)
    (void) FormatLocaleFile(file,"%s%.*s%s\n",Pagesizes[i].name,
      ((int) sizeof(Pagesizes[0].name))-(int) Pagesizes[i].extent,spacer,Pagesizes[i].geometry);
  return(MagickTrue);
}
# 768 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickStatusType ParseAbsoluteGeometry(const char *geometry,
...
# 809 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickStatusType ParseAffineGeometry(const char *geometry,
  AffineMatrix *affine_matrix,ExceptionInfo *exception)
{
  ...
  for (i=0; (*p != '\0') && (i < 6); i++)
  {
    ...
    switch (i)
    {
      case 0:
      {
        affine_matrix->sx=StringToDouble(token,(char **) 
# 839 "MagickCore/geometry.c" 3 4
                                                        ((void *)0)
# 839 "MagickCore/geometry.c"
                                                            );
        break;
      }
      case 1:
      {
        affine_matrix->rx=StringToDouble(token,(char **) 
# 844 "MagickCore/geometry.c" 3 4
                                                        ((void *)0)
# 844 "MagickCore/geometry.c"
                                                            );
        break;
      }
      case 2:
      {
        affine_matrix->ry=StringToDouble(token,(char **) 
# 849 "MagickCore/geometry.c" 3 4
                                                        ((void *)0)
# 849 "MagickCore/geometry.c"
                                                            );
        break;
      }
      case 3:
      {
        affine_matrix->sy=StringToDouble(token,(char **) 
# 854 "MagickCore/geometry.c" 3 4
                                                        ((void *)0)
# 854 "MagickCore/geometry.c"
                                                            );
        break;
      }
      case 4:
      {
        affine_matrix->tx=StringToDouble(token,(char **) 
# 859 "MagickCore/geometry.c" 3 4
                                                        ((void *)0)
# 859 "MagickCore/geometry.c"
                                                            );
        flags|=XValue;
        break;
      }
      case 5:
      {
        affine_matrix->ty=StringToDouble(token,(char **) 
# 865 "MagickCore/geometry.c" 3 4
                                                        ((void *)0)
# 865 "MagickCore/geometry.c"
                                                            );
        flags|=YValue;
        break;
      }
  ...
  if (fabs(determinant) < 1.0e-12)
    (void) ThrowMagickException(exception,"MagickCore/geometry.c",__func__,(unsigned long) 874,OptionError,
      "InvalidArgument","'%s' : 'Indeterminate Matrix'",geometry);
  return(flags);
}
# 918 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickStatusType ParseGeometry(const char *geometry,
...
# 941 "MagickCore/geometry.c" 3 4
 ((void) sizeof ((
# 941 "MagickCore/geometry.c"
...
# 941 "MagickCore/geometry.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 941 "MagickCore/geometry.c"
 "geometry_info != (GeometryInfo *) NULL"
# 941 "MagickCore/geometry.c" 3 4
 , "MagickCore/geometry.c", 941, __extension__ __PRETTY_FUNCTION__); }))
# 941 "MagickCore/geometry.c"
                                               ;
  (void) memset(geometry_info,0,sizeof(*geometry_info));
  flags=NoValue;
  if ((geometry == (char *) 
# 944 "MagickCore/geometry.c" 3 4
                           ((void *)0)
# 944 "MagickCore/geometry.c"
                               ) || (*geometry == '\0'))
    return(flags);
  if (strlen(geometry) >= (4096 -1))
    return(flags);
  ...
  for (p=pedantic_geometry; *p != '\0'; )
  {
    c=(int) ((unsigned char) *p);
    if (
# 966 "MagickCore/geometry.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 966 "MagickCore/geometry.c"
       (int) ((unsigned char) c)
# 966 "MagickCore/geometry.c" 3 4
       ))] & (unsigned short int) _ISspace) 
# 966 "MagickCore/geometry.c"
  ...
  if ((c == 215) || (*p == 'x') || (*p == 'X') || (*p == ':') || (*p == ',') ||
      (*p == '/'))
    {
      ...
      p++;
      while (
# 1108 "MagickCore/geometry.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 1108 "MagickCore/geometry.c"
            (int) ((unsigned char) *p)
# 1108 "MagickCore/geometry.c" 3 4
            ))] & (unsigned short int) _ISspace) 
# 1108 "MagickCore/geometry.c"
  ...
  while (
# 1123 "MagickCore/geometry.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 1123 "MagickCore/geometry.c"
        (int) ((unsigned char) *p)
# 1123 "MagickCore/geometry.c" 3 4
        ))] & (unsigned short int) _ISspace) 
# 1123 "MagickCore/geometry.c"
  ...
  if ((*p == '+') || (*p == '-') || (*p == ',') || (*p == '/') || (*p == ':'))
    {
      ...
      while (
# 1147 "MagickCore/geometry.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 1147 "MagickCore/geometry.c"
            (int) ((unsigned char) *p)
# 1147 "MagickCore/geometry.c" 3 4
            ))] & (unsigned short int) _ISspace) 
# 1147 "MagickCore/geometry.c"
      ...
      while (
# 1173 "MagickCore/geometry.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 1173 "MagickCore/geometry.c"
            (int) ((unsigned char) *p)
# 1173 "MagickCore/geometry.c" 3 4
            ))] & (unsigned short int) _ISspace) 
# 1173 "MagickCore/geometry.c"
  ...
  if (strchr(pedantic_geometry,':') != (char *) 
# 1200 "MagickCore/geometry.c" 3 4
                                               ((void *)0)
# 1200 "MagickCore/geometry.c"
                                                   )
    {
...
# 1269 "MagickCore/geometry.c"
  return(flags);
}
# 1309 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickStatusType ParseGravityGeometry(const Image *image,
  const char *geometry,RectangleInfo *region_info,ExceptionInfo *exception)
{
  ...
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/geometry.c",__func__,(unsigned long) 1320,"%s",geometry);
  if ((geometry == (char *) 
# 1321 "MagickCore/geometry.c" 3 4
                           ((void *)0)
# 1321 "MagickCore/geometry.c"
                               ) || (*geometry == '\0'))
    return(NoValue);
  ...
  if (flags == NoValue)
    {
      (void) ThrowMagickException(exception,"MagickCore/geometry.c",__func__,(unsigned long) 1331,OptionError,
...
# 1469 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickStatusType ParseMetaGeometry(const char *geometry,ssize_t *x,
  ssize_t *y,size_t *width,size_t *height)
{
  GeometryInfo
    geometry_info;
...
# 1485 "MagickCore/geometry.c" 3 4
 ((void) sizeof ((
# 1485 "MagickCore/geometry.c"
 x != (ssize_t *) 
# 1485 "MagickCore/geometry.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1485 "MagickCore/geometry.c"
...
# 1485 "MagickCore/geometry.c"
 "x != (ssize_t *) NULL"
# 1485 "MagickCore/geometry.c" 3 4
 , "MagickCore/geometry.c", 1485, __extension__ __PRETTY_FUNCTION__); }))
# 1485 "MagickCore/geometry.c"
                              ;
  
# 1486 "MagickCore/geometry.c" 3 4
 ((void) sizeof ((
# 1486 "MagickCore/geometry.c"
 y != (ssize_t *) 
# 1486 "MagickCore/geometry.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1486 "MagickCore/geometry.c"
...
# 1486 "MagickCore/geometry.c"
 "y != (ssize_t *) NULL"
# 1486 "MagickCore/geometry.c" 3 4
 , "MagickCore/geometry.c", 1486, __extension__ __PRETTY_FUNCTION__); }))
# 1486 "MagickCore/geometry.c"
                              ;
  
# 1487 "MagickCore/geometry.c" 3 4
 ((void) sizeof ((
# 1487 "MagickCore/geometry.c"
 width != (size_t *) 
# 1487 "MagickCore/geometry.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1487 "MagickCore/geometry.c"
...
# 1487 "MagickCore/geometry.c"
 "width != (size_t *) NULL"
# 1487 "MagickCore/geometry.c" 3 4
 , "MagickCore/geometry.c", 1487, __extension__ __PRETTY_FUNCTION__); }))
# 1487 "MagickCore/geometry.c"
                                 ;
  
# 1488 "MagickCore/geometry.c" 3 4
 ((void) sizeof ((
# 1488 "MagickCore/geometry.c"
 height != (size_t *) 
# 1488 "MagickCore/geometry.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1488 "MagickCore/geometry.c"
...
# 1488 "MagickCore/geometry.c"
 "height != (size_t *) NULL"
# 1488 "MagickCore/geometry.c" 3 4
 , "MagickCore/geometry.c", 1488, __extension__ __PRETTY_FUNCTION__); }))
# 1488 "MagickCore/geometry.c"
                                  ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/geometry.c",__func__,(unsigned long) 1490,"%s",geometry);
  if ((geometry == (char *) 
# 1491 "MagickCore/geometry.c" 3 4
                           ((void *)0)
# 1491 "MagickCore/geometry.c"
                               ) || (*geometry == '\0'))
    return(NoValue);
  ...
  if (((flags & AspectValue) != 0) || ((*width == stasis_width) &&
  ...
  else
    {
      ...
      *width=CastDoubleToUnsigned((((floor(scale_factor*stasis_width+ 0.5)) > (1.0)) ? (floor(scale_factor*stasis_width+ 0.5)) : (1.0))
                 );
      *height=CastDoubleToUnsigned((((floor(scale_factor*stasis_height+ 0.5)) > (1.0)) ? (floor(scale_factor*stasis_height+ 0.5)) : (1.0))
                 );
    }
  if ((flags & GreaterValue) != 0)
    {
  ...
  if ((flags & AreaValue) != 0)
    {
      ...
      (void) ParseGeometry(geometry,&geometry_info);
      area=geometry_info.rho+sqrt(1.0e-12);
...
# 1679 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickStatusType ParsePageGeometry(const Image *image,
  const char *geometry,RectangleInfo *region_info,ExceptionInfo *exception)
{
  MagickStatusType
    flags;
  ...
  if (flags == NoValue)
    {
      (void) ThrowMagickException(exception,"MagickCore/geometry.c",__func__,(unsigned long) 1693,OptionError,
        "InvalidGeometry","`%s'",geometry);
      return(flags);
    }
  if ((flags & PercentValue) != 0)
...
# 1748 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) MagickStatusType ParseRegionGeometry(const Image *image,
  const char *geometry,RectangleInfo *region_info,ExceptionInfo *exception)
{
  MagickStatusType
    flags;
  ...
  flags=ParseMetaGeometry(geometry,&region_info->x,&region_info->y,
    &region_info->width,&region_info->height);
  if (flags == NoValue)
    (void) ThrowMagickException(exception,"MagickCore/geometry.c",__func__,(unsigned long) 1758,OptionError,
      "InvalidGeometry","`%s'",geometry);
  return(flags);
}
# 1787 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) void SetGeometry(const Image *image,RectangleInfo *geometry)
{
  
# 1789 "MagickCore/geometry.c" 3 4
 ((void) sizeof ((
# 1789 "MagickCore/geometry.c"
 image != (Image *) 
# 1789 "MagickCore/geometry.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1789 "MagickCore/geometry.c"
...
# 1789 "MagickCore/geometry.c"
 "image != (Image *) NULL"
# 1789 "MagickCore/geometry.c" 3 4
 , "MagickCore/geometry.c", 1789, __extension__ __PRETTY_FUNCTION__); }))
# 1789 "MagickCore/geometry.c"
                                ;
  
# 1790 "MagickCore/geometry.c" 3 4
 ((void) sizeof ((
# 1790 "MagickCore/geometry.c"
...
# 1790 "MagickCore/geometry.c" 3 4
 , "MagickCore/geometry.c", 1790, __extension__ __PRETTY_FUNCTION__); }))
# 1790 "MagickCore/geometry.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/geometry.c",__func__,(unsigned long) 1792,"%s",image->filename);
  
# 1793 "MagickCore/geometry.c" 3 4
 ((void) sizeof ((
# 1793 "MagickCore/geometry.c"
...
# 1793 "MagickCore/geometry.c" 3 4
 , "MagickCore/geometry.c", 1793, __extension__ __PRETTY_FUNCTION__); }))
# 1793 "MagickCore/geometry.c"
                                           ;
...
# 1821 "MagickCore/geometry.c"
__attribute__ ((visibility ("default"))) void SetGeometryInfo(GeometryInfo *geometry_info)
{
  
# 1823 "MagickCore/geometry.c" 3 4
 ((void) sizeof ((
# 1823 "MagickCore/geometry.c"
 geometry_info != (GeometryInfo *) 
# 1823 "MagickCore/geometry.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1823 "MagickCore/geometry.c"
...
# 1823 "MagickCore/geometry.c"
 "geometry_info != (GeometryInfo *) NULL"
# 1823 "MagickCore/geometry.c" 3 4
 , "MagickCore/geometry.c", 1823, __extension__ __PRETTY_FUNCTION__); }))
# 1823 "MagickCore/geometry.c"
                                               ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/geometry.c",__func__,(unsigned long) 1825,"...");
  (void) memset(geometry_info,0,sizeof(*geometry_info));
}
