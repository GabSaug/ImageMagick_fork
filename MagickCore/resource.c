# 0 "MagickCore/resource.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/resource.c"
# 42 "MagickCore/resource.c"
...
# 69 "MagickCore/resource.c" 2
# 80 "MagickCore/resource.c"
...
# 113 "MagickCore/resource.c" 3 4
                               ((void *)0)
# 113 "MagickCore/resource.c"
                                   ;
...
static ResourceInfo
  resource_info =
  {
    ...
    ((MagickSizeType) (0ULL)),
    ((MagickSizeType) (0ULL)),
    (MagickSizeType) ((0x7fffffffffffffffL
# 129 "MagickCore/resource.c"
                     )/sizeof(Quantum)/64),
    (MagickSizeType) ((0x7fffffffffffffffL
# 130 "MagickCore/resource.c"
                     )/sizeof(Quantum)/64),
    (((MagickSizeType) (~0ULL)) >> 1),
    ((MagickSizeType) (3072ULL))*1024*1024,
    ((MagickSizeType) (1536ULL))*1024*1024,
    ((MagickSizeType) (3072ULL))*1024*1024,
    (((MagickSizeType) (~0ULL)) >> 1),
    ((MagickSizeType) (768ULL)),
    ((MagickSizeType) (1ULL)),
    ((MagickSizeType) (0ULL)),
    ((MagickSizeType) (0ULL)),
  };
...
static SemaphoreInfo
  *resource_semaphore[] = {
     (SemaphoreInfo *) 
# 144 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 144 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 145 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 145 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 146 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 146 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 147 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 147 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 148 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 148 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 149 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 149 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 150 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 150 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 151 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 151 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 152 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 152 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 153 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 153 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 154 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 154 "MagickCore/resource.c"
                          ,
     (SemaphoreInfo *) 
# 155 "MagickCore/resource.c" 3 4
                      ((void *)0)
  
# 156 "MagickCore/resource.c"
 };

static SplayTreeInfo
  *temporary_resources = (SplayTreeInfo *) 
# 159 "MagickCore/resource.c" 3 4
                                          ((void *)0)
# 159 "MagickCore/resource.c"
                                              ;
# 188 "MagickCore/resource.c"
__attribute__ ((visibility ("default"))) MagickBooleanType AcquireMagickResource(const ResourceType type,
  const MagickSizeType size)
{
  ...
  switch (type)
  {
    ...
    case TimeResource:
    {
      if (resource_semaphore[type] == (SemaphoreInfo *) 
# 217 "MagickCore/resource.c" 3 4
                                                       ((void *)0)
# 217 "MagickCore/resource.c"
                                                           )
  ...
  switch (type)
  {
    case AreaResource:
    {
      ...
      if ((limit == (((MagickSizeType) (~0ULL)) >> 1)) || (size < limit))
        status=MagickTrue;
      break;
    }
    case DiskResource:
      ...
      if (((MagickSizeType) resource_info.disk+(MagickSizeType) request) > (MagickSizeType) resource_info.disk)
        {
          ...
          if ((limit == (((MagickSizeType) (~0ULL)) >> 1)) ||
  ...
  if ((GetLogEventMask() & ResourceEvent) != 0)
    {
      ...
      (void) FormatMagickSize(size,bi,(bi != MagickFalse) ? "B" :
        (const char *) 
# 379 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 379 "MagickCore/resource.c"
                          ,64,resource_request);
      (void) FormatMagickSize((MagickSizeType) current,bi,(bi != MagickFalse) ?
        "B" : (const char *) 
# 381 "MagickCore/resource.c" 3 4
                            ((void *)0)
# 381 "MagickCore/resource.c"
                                ,64,resource_current);
      (void) FormatMagickSize(limit,bi,(bi != MagickFalse) ? "B" :
        (const char *) 
# 383 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 383 "MagickCore/resource.c"
                          ,64,resource_limit);
      (void) LogMagickEvent(ResourceEvent,"MagickCore/resource.c",__func__,(unsigned long) 384,"%s: %s/%s/%s",
        CommandOptionToMnemonic(MagickResourceOptions,(ssize_t) type),
        resource_request,resource_current,resource_limit);
    }
  return(status);
}
# 411 "MagickCore/resource.c"
__attribute__ ((visibility ("default"))) void AsynchronousResourceComponentTerminus(void)
{
  const char
    *path;

  if (temporary_resources == (SplayTreeInfo *) 
# 416 "MagickCore/resource.c" 3 4
                                              ((void *)0)
# 416 "MagickCore/resource.c"
                                                  )
    return;
  ...
  while (path != (const char *) 
# 423 "MagickCore/resource.c" 3 4
                               ((void *)0)
# 423 "MagickCore/resource.c"
                                   )
  {
    (void) ShredFile(path);
...
static void *DestroyTemporaryResources(void *temporary_resource)
{
  ...
  return((void *) 
# 461 "MagickCore/resource.c" 3 4
                 ((void *)0)
# 461 "MagickCore/resource.c"
                     );
}

__attribute__ ((visibility ("default"))) MagickBooleanType GetPathTemplate(char *path)
{
  char
    *directory,
    *value;
  ...
  (void) FormatLocaleString(path,4096,"magick-" "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
  exception=AcquireExceptionInfo();
  directory=(char *) GetImageRegistry(StringRegistryType,"temporary-path",
    exception);
  exception=DestroyExceptionInfo(exception);
  if (directory == (char *) 
# 484 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 484 "MagickCore/resource.c"
                               )
    directory=GetEnvironmentValue("MAGICK_TEMPORARY_PATH");
  if (directory == (char *) 
# 486 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 486 "MagickCore/resource.c"
                               )
    directory=GetEnvironmentValue("MAGICK_TMPDIR");
  if (directory == (char *) 
# 488 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 488 "MagickCore/resource.c"
                               )
    directory=GetEnvironmentValue("TMPDIR");
# 501 "MagickCore/resource.c"
  if (directory == (char *) 
# 501 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 501 "MagickCore/resource.c"
                               )
    directory=ConstantString(
# 502 "MagickCore/resource.c" 3 4
                            "/tmp"
# 502 "MagickCore/resource.c"
                                    );

  if (directory == (char *) 
# 504 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 504 "MagickCore/resource.c"
                               )
    return(MagickTrue);
  value=GetPolicyValue("resource:temporary-path");
  if (value != (char *) 
# 507 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 507 "MagickCore/resource.c"
                           )
    {
      (void) CloneString(&directory,value);
      value=DestroyString(value);
    }
  if (strlen(directory) > (4096 -25))
    {
...
# 518 "MagickCore/resource.c" 3 4
                                 ((((
# 518 "MagickCore/resource.c"
                                 attributes.st_mode
# 518 "MagickCore/resource.c" 3 4
                                 )) & 0170000) == (0040000))
# 518 "MagickCore/resource.c"
  ...
  if (directory[strlen(directory)-1] == *"/")
    (void) FormatLocaleString(path,4096,"%smagick-"
      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",directory);
  else
    (void) FormatLocaleString(path,4096,
      "%s%smagick-" "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX",directory,"/");
  directory=DestroyString(directory);
# 544 "MagickCore/resource.c"
  return(MagickTrue);
}

__attribute__ ((visibility ("default"))) int AcquireUniqueFileResource(char *path)
{
...
# 576 "MagickCore/resource.c" 3 4
 ((void) sizeof ((
# 576 "MagickCore/resource.c"
 path != (char *) 
# 576 "MagickCore/resource.c" 3 4
...
# 576 "MagickCore/resource.c"
 "path != (char *) NULL"
# 576 "MagickCore/resource.c" 3 4
 , "MagickCore/resource.c", 576, __extension__ __PRETTY_FUNCTION__); }))
# 576 "MagickCore/resource.c"
                              ;
  if ((GetLogEventMask() & ResourceEvent) != 0)
    (void) LogMagickEvent(ResourceEvent,"MagickCore/resource.c",__func__,(unsigned long) 578,"...");
  if (random_info == (RandomInfo *) 
# 579 "MagickCore/resource.c" 3 4
                                   ((void *)0)
# 579 "MagickCore/resource.c"
                                       )
    {
      if (resource_semaphore[FileResource] == (SemaphoreInfo *) 
# 581 "MagickCore/resource.c" 3 4
                                                               ((void *)0)
# 581 "MagickCore/resource.c"
                                                                   )
        ActivateSemaphoreInfo(&resource_semaphore[FileResource]);
      LockSemaphoreInfo(resource_semaphore[FileResource]);
      if (random_info == (RandomInfo *) 
# 584 "MagickCore/resource.c" 3 4
                                       ((void *)0)
# 584 "MagickCore/resource.c"
                                           )
  ...
  file=(-1);
  for (i=0; i < (ssize_t) 
# 589 "MagickCore/resource.c" 3 4
                         238328
# 589 "MagickCore/resource.c"
                                ; i++)
  {
    ssize_t
      j;
    ...
    key=GetRandomKey(random_info,strlen("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")-6);
    p=path+strlen(path)-strlen("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    ...
    key=GetRandomKey(random_info,strlen("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"));
    p=path+strlen(path)-strlen("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    datum=GetStringInfoDatum(key);
    for (j=0; j < (ssize_t) GetStringInfoLength(key); j++)
    {
    ...
    key=DestroyStringInfo(key);
    file=open_utf8(path,
# 629 "MagickCore/resource.c" 3 4
                       02 
# 629 "MagickCore/resource.c"
                              | 
# 629 "MagickCore/resource.c" 3 4
                                0100 
# 629 "MagickCore/resource.c"
...
# 629 "MagickCore/resource.c"
                                                                        ,
      (
# 630 "MagickCore/resource.c" 3 4
     0400 
# 630 "MagickCore/resource.c"
     | 
# 630 "MagickCore/resource.c" 3 4
     0200
# 630 "MagickCore/resource.c"
    ...
    if ((file >= 0) || (
# 631 "MagickCore/resource.c" 3 4
                       (*__errno_location ()) 
# 631 "MagickCore/resource.c"
                             != 
# 631 "MagickCore/resource.c" 3 4
                                17
# 631 "MagickCore/resource.c"
  ...
  if ((GetLogEventMask() & ResourceEvent) != 0)
    (void) LogMagickEvent(ResourceEvent,"MagickCore/resource.c",__func__,(unsigned long) 635,"%s",path);
  if (file == -1)
    return(file);
  if (resource_semaphore[FileResource] == (SemaphoreInfo *) 
# 638 "MagickCore/resource.c" 3 4
                                                           ((void *)0)
# 638 "MagickCore/resource.c"
                                                               )
    ActivateSemaphoreInfo(&resource_semaphore[FileResource]);
  LockSemaphoreInfo(resource_semaphore[FileResource]);
  if (temporary_resources == (SplayTreeInfo *) 
# 641 "MagickCore/resource.c" 3 4
                                              ((void *)0)
# 641 "MagickCore/resource.c"
                                                  )
    temporary_resources=NewSplayTree(CompareSplayTreeString,
      DestroyTemporaryResources,(void *(*)(void *)) 
# 643 "MagickCore/resource.c" 3 4
                                                   ((void *)0)
# 643 "MagickCore/resource.c"
                                                       );
  UnlockSemaphoreInfo(resource_semaphore[FileResource]);
  (void) AddValueToSplayTree(temporary_resources,ConstantString(path),
    (const void *) 
# 646 "MagickCore/resource.c" 3 4
                  ((void *)0)
# 646 "MagickCore/resource.c"
                      );
  return(file);
}
# 672 "MagickCore/resource.c"
__attribute__ ((visibility ("default"))) MagickSizeType GetMagickResource(const ResourceType type)
{
  MagickSizeType
    resource;
  ...
  switch (type)
  {
    ...
    {
      if (resource_semaphore[type] == (SemaphoreInfo *) 
# 686 "MagickCore/resource.c" 3 4
                                                       ((void *)0)
# 686 "MagickCore/resource.c"
                                                           )
        ActivateSemaphoreInfo(&resource_semaphore[type]);
      LockSemaphoreInfo(resource_semaphore[type]);
      break;
...
# 791 "MagickCore/resource.c"
__attribute__ ((visibility ("default"))) MagickSizeType GetMagickResourceLimit(const ResourceType type)
{
  MagickSizeType
    resource;
  ...
  resource=0;
  if (resource_semaphore[type] == (SemaphoreInfo *) 
# 813 "MagickCore/resource.c" 3 4
                                                   ((void *)0)
# 813 "MagickCore/resource.c"
                                                       )
    ActivateSemaphoreInfo(&resource_semaphore[type]);
  LockSemaphoreInfo(resource_semaphore[type]);
  switch (type)
...
static void FormatTimeToLive(const MagickSizeType ttl,char *timeString)
{
  ...
  if (seconds == 0)
    {
      (void) FormatLocaleString(timeString,4096,"%lld years",years);
      return;
    }
  months=ttl/2628000;
  seconds=ttl % 2628000;
  if (seconds == 0)
    {
      (void) FormatLocaleString(timeString,4096,"%lld months",
        months);
      return;
    }
  weeks=ttl/604800;
  ...
  if (seconds == 0)
    {
      (void) FormatLocaleString(timeString,4096,"%lld weeks",weeks);
      return;
    }
  days=ttl/86400;
  seconds=ttl % 86400;
  if (seconds == 0)
    {
      (void) FormatLocaleString(timeString,4096,"%lld days",days);
      return;
    }
  hours=ttl/3600;
  seconds=ttl % 3600;
  if (seconds == 0)
    {
      (void) FormatLocaleString(timeString,4096,"%lld hours",hours);
      return;
    }
  minutes=ttl/60;
  seconds=ttl % 60;
  if (seconds == 0)
    {
      (void) FormatLocaleString(timeString,4096,"%lld minutes",
        minutes);
      return;
    }
  (void) FormatLocaleString(timeString,4096,"%lld seconds",ttl);
}

__attribute__ ((visibility ("default"))) MagickBooleanType ListMagickResourceInfo(FILE *file,
  ExceptionInfo *magick_unused_exception __attribute__((unused)))
{
  ...
  if (file == (const FILE *) 
# 949 "MagickCore/resource.c" 3 4
                            ((void *)0)
# 949 "MagickCore/resource.c"
                                )
    file=
# 950 "MagickCore/resource.c" 3 4
        stdout
# 950 "MagickCore/resource.c"
              ;
  if (resource_semaphore[FileResource] == (SemaphoreInfo *) 
# 951 "MagickCore/resource.c" 3 4
                                                           ((void *)0)
# 951 "MagickCore/resource.c"
                                                               )
    ActivateSemaphoreInfo(&resource_semaphore[FileResource]);
  LockSemaphoreInfo(resource_semaphore[FileResource]);
  ...
  (void) FormatMagickSize(resource_info.area_limit,MagickFalse,"P",
    64,area_limit);
  (void) CopyMagickString(list_length_limit,"unlimited",64);
  if (resource_info.list_length_limit != (((MagickSizeType) (~0ULL)) >> 1))
    (void) FormatMagickSize(resource_info.list_length_limit,MagickTrue,"B",
      64,list_length_limit);
  (void) FormatMagickSize(resource_info.memory_limit,MagickTrue,"B",
    64,memory_limit);
  (void) FormatMagickSize(resource_info.map_limit,MagickTrue,"B",
    64,map_limit);
  (void) CopyMagickString(disk_limit,"unlimited",64);
  if (resource_info.disk_limit != (((MagickSizeType) (~0ULL)) >> 1))
    (void) FormatMagickSize(resource_info.disk_limit,MagickTrue,"B",
      64,disk_limit);
  (void) CopyMagickString(time_limit,"unlimited",64);
...
# 1020 "MagickCore/resource.c"
__attribute__ ((visibility ("default"))) void RelinquishMagickResource(const ResourceType type,
  const MagickSizeType size)
{
  MagickBooleanType
    bi;
  ...
  switch (type)
  {
    ...
    {
      if (resource_semaphore[type] == (SemaphoreInfo *) 
# 1041 "MagickCore/resource.c" 3 4
                                                       ((void *)0)
# 1041 "MagickCore/resource.c"
                                                           )
        ActivateSemaphoreInfo(&resource_semaphore[type]);
      LockSemaphoreInfo(resource_semaphore[type]);
      break;
...
# 1056 "MagickCore/resource.c" 3 4
     ((void) sizeof ((
# 1056 "MagickCore/resource.c"
...
# 1056 "MagickCore/resource.c"
     "resource_info.disk >= 0"
# 1056 "MagickCore/resource.c" 3 4
     , "MagickCore/resource.c", 1056, __extension__ __PRETTY_FUNCTION__); }))
# 1056 "MagickCore/resource.c"
                                    ;
      break;
    }
...
# 1064 "MagickCore/resource.c" 3 4
     ((void) sizeof ((
# 1064 "MagickCore/resource.c"
...
# 1064 "MagickCore/resource.c"
     "resource_info.file >= 0"
# 1064 "MagickCore/resource.c" 3 4
     , "MagickCore/resource.c", 1064, __extension__ __PRETTY_FUNCTION__); }))
# 1064 "MagickCore/resource.c"
                                    ;
      break;
    }
...
# 1073 "MagickCore/resource.c" 3 4
     ((void) sizeof ((
# 1073 "MagickCore/resource.c"
     resource_info.map >= 0
# 1073 "MagickCore/resource.c" 3 4
     ) ? 1 : 0), __extension__ ({ if (
# 1073 "MagickCore/resource.c"
...
# 1073 "MagickCore/resource.c"
     "resource_info.map >= 0"
# 1073 "MagickCore/resource.c" 3 4
     , "MagickCore/resource.c", 1073, __extension__ __PRETTY_FUNCTION__); }))
# 1073 "MagickCore/resource.c"
                                   ;
      break;
    }
...
# 1082 "MagickCore/resource.c" 3 4
     ((void) sizeof ((
# 1082 "MagickCore/resource.c"
...
# 1082 "MagickCore/resource.c"
     "resource_info.memory >= 0"
# 1082 "MagickCore/resource.c" 3 4
     , "MagickCore/resource.c", 1082, __extension__ __PRETTY_FUNCTION__); }))
# 1082 "MagickCore/resource.c"
                                      ;
      break;
    }
...
# 1091 "MagickCore/resource.c" 3 4
     ((void) sizeof ((
# 1091 "MagickCore/resource.c"
...
# 1091 "MagickCore/resource.c"
     "resource_info.time >= 0"
# 1091 "MagickCore/resource.c" 3 4
     , "MagickCore/resource.c", 1091, __extension__ __PRETTY_FUNCTION__); }))
# 1091 "MagickCore/resource.c"
                                    ;
      break;
    }
  ...
  if ((GetLogEventMask() & ResourceEvent) != 0)
    {
      ...
      (void) FormatMagickSize(size,bi,(bi != MagickFalse) ? "B" :
        (const char *) 
# 1121 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 1121 "MagickCore/resource.c"
                          ,64,resource_request);
      (void) FormatMagickSize(current,bi,(bi != MagickFalse) ? "B" :
        (const char *) 
# 1123 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 1123 "MagickCore/resource.c"
                          ,64,resource_current);
      (void) FormatMagickSize(limit,bi,(bi != MagickFalse) ? "B" :
        (const char *) 
# 1125 "MagickCore/resource.c" 3 4
                      ((void *)0)
# 1125 "MagickCore/resource.c"
                          ,64,resource_limit);
      (void) LogMagickEvent(ResourceEvent,"MagickCore/resource.c",__func__,(unsigned long) 1126,"%s: %s/%s/%s",
        CommandOptionToMnemonic(MagickResourceOptions,(ssize_t) type),
          resource_request,resource_current,resource_limit);
    }
}
# 1154 "MagickCore/resource.c"
__attribute__ ((visibility ("default"))) MagickBooleanType RelinquishUniqueFileResource(const char *path)
{
  char
    cache_path[4096];
...
# 1162 "MagickCore/resource.c" 3 4
 ((void) sizeof ((
# 1162 "MagickCore/resource.c"
 path != (const char *) 
# 1162 "MagickCore/resource.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1162 "MagickCore/resource.c"
...
# 1162 "MagickCore/resource.c" 3 4
 , "MagickCore/resource.c", 1162, __extension__ __PRETTY_FUNCTION__); }))
# 1162 "MagickCore/resource.c"
                                    ;
  status=MagickFalse;
  if ((GetLogEventMask() & ResourceEvent) != 0)
    (void) LogMagickEvent(ResourceEvent,"MagickCore/resource.c",__func__,(unsigned long) 1165,"%s",path);
  if (resource_semaphore[FileResource] == (SemaphoreInfo *) 
# 1166 "MagickCore/resource.c" 3 4
                                                           ((void *)0)
# 1166 "MagickCore/resource.c"
                                                               )
    ActivateSemaphoreInfo(&resource_semaphore[FileResource]);
  LockSemaphoreInfo(resource_semaphore[FileResource]);
  if (temporary_resources != (SplayTreeInfo *) 
# 1169 "MagickCore/resource.c" 3 4
                                              ((void *)0)
# 1169 "MagickCore/resource.c"
                                                  )
    status=DeleteNodeFromSplayTree(temporary_resources,(const void *) path);
  UnlockSemaphoreInfo(resource_semaphore[FileResource]);
  (void) CopyMagickString(cache_path,path,4096);
  AppendImageFormat("cache",cache_path);
  if (access_utf8(cache_path,
# 1174 "MagickCore/resource.c" 3 4
                            0
# 1174 "MagickCore/resource.c"
                                ) == 0)
    {
...
# 1206 "MagickCore/resource.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType ResourceComponentGenesis(void)
{
  char
    *limit;
  ...
  for (i=0; i < (ssize_t) (sizeof(resource_semaphore)/sizeof(*resource_semaphore)); i++)
    if (resource_semaphore[i] == (SemaphoreInfo *) 
# 1225 "MagickCore/resource.c" 3 4
                                                  ((void *)0)
# 1225 "MagickCore/resource.c"
                                                      )
  ...
  if (limit != (char *) 
# 1229 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1229 "MagickCore/resource.c"
                           )
    {
  ...
  if (limit != (char *) 
# 1237 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1237 "MagickCore/resource.c"
                           )
    {
  ...
  pages=(ssize_t) sysconf(
# 1246 "MagickCore/resource.c" 3 4
                         _SC_PHYS_PAGES
# 1246 "MagickCore/resource.c"
                                       );
  ...
  if (limit != (char *) 
# 1259 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1259 "MagickCore/resource.c"
                           )
    {
  ...
  if (limit != (char *) 
# 1267 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1267 "MagickCore/resource.c"
                           )
    {
  ...
  if (limit != (char *) 
# 1275 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1275 "MagickCore/resource.c"
                           )
    {
  ...
  (void) SetMagickResourceLimit(DiskResource,(((MagickSizeType) (~0ULL)) >> 1));
  limit=GetEnvironmentValue("MAGICK_DISK_LIMIT");
  if (limit != (char *) 
# 1283 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1283 "MagickCore/resource.c"
                           )
    {
  ...
  files=(ssize_t) sysconf(
# 1291 "MagickCore/resource.c" 3 4
                         _SC_OPEN_MAX
# 1291 "MagickCore/resource.c"
                                     );
  ...
  if (files < 0)
    {
      ...
      if (getrlimit(
# 1299 "MagickCore/resource.c" 3 4
                   RLIMIT_NOFILE
# 1299 "MagickCore/resource.c"
                                ,&resources) != -1)
  ...
  if (files < 0)
    files=64;
  (void) SetMagickResourceLimit(FileResource,((((size_t) (3*files/4)) > (64)) ? ((size_t) (3*files/4)) : (64))
                   );
  limit=GetEnvironmentValue("MAGICK_FILE_LIMIT");
  if (limit != (char *) 
# 1312 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1312 "MagickCore/resource.c"
                           )
    {
  ...
  if (limit != (char *) 
# 1323 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1323 "MagickCore/resource.c"
                           )
    {
  ...
  if (limit != (char *) 
# 1331 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1331 "MagickCore/resource.c"
                           )
    {
  ...
  if (limit != (char *) 
# 1339 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1339 "MagickCore/resource.c"
                           )
    {
  ...
  (void) SetMagickResourceLimit(ListLengthResource,(((MagickSizeType) (~0ULL)) >> 1));
  limit=GetEnvironmentValue("MAGICK_LIST_LENGTH_LIMIT");
  if (limit != (char *) 
# 1347 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1347 "MagickCore/resource.c"
                           )
    {
...
# 1374 "MagickCore/resource.c"
__attribute__ ((visibility ("hidden"))) void ResourceComponentTerminus(void)
{
  ssize_t
    i;
  ...
  for (i=0; i < (ssize_t) (sizeof(resource_semaphore)/sizeof(*resource_semaphore)); i++)
    if (resource_semaphore[i] == (SemaphoreInfo *) 
# 1380 "MagickCore/resource.c" 3 4
                                                  ((void *)0)
# 1380 "MagickCore/resource.c"
                                                      )
      resource_semaphore[i]=AcquireSemaphoreInfo();
  LockSemaphoreInfo(resource_semaphore[FileResource]);
  if (temporary_resources != (SplayTreeInfo *) 
# 1383 "MagickCore/resource.c" 3 4
                                              ((void *)0)
# 1383 "MagickCore/resource.c"
                                                  )
    temporary_resources=DestroySplayTree(temporary_resources);
  if (random_info != (RandomInfo *) 
# 1385 "MagickCore/resource.c" 3 4
                                   ((void *)0)
# 1385 "MagickCore/resource.c"
                                       )
...
# 1417 "MagickCore/resource.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetMagickResourceLimit(const ResourceType type,
  const MagickSizeType limit)
{
  ...
  status=MagickTrue;
  value=(char *) 
# 1427 "MagickCore/resource.c" 3 4
                ((void *)0)
# 1427 "MagickCore/resource.c"
                    ;
  switch (type)
  {
    case DiskResource:
    ...
    {
      if (resource_semaphore[type] == (SemaphoreInfo *) 
# 1436 "MagickCore/resource.c" 3 4
                                                       ((void *)0)
# 1436 "MagickCore/resource.c"
                                                           )
        ActivateSemaphoreInfo(&resource_semaphore[type]);
      LockSemaphoreInfo(resource_semaphore[type]);
      break;
  ...
  switch (type)
  {
    case AreaResource:
    {
      ...
      if (value == (char *) 
# 1448 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1448 "MagickCore/resource.c"
                               )
        resource_info.area_limit=limit;
      else
        resource_info.area_limit=(((limit) < (StringToMagickSizeType(value, 100.0))) ? (limit) : (StringToMagickSizeType(value, 100.0)))
                 ;
      break;
    }
    case DiskResource:
    {
      ...
      if (value == (char *) 
# 1458 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1458 "MagickCore/resource.c"
                               )
        resource_info.disk_limit=limit;
      else
        resource_info.disk_limit=(((limit) < (StringToMagickSizeType(value, 100.0))) ? (limit) : (StringToMagickSizeType(value, 100.0)))
                 ;
      break;
    }
    case FileResource:
    {
      ...
      if (value == (char *) 
# 1468 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1468 "MagickCore/resource.c"
                               )
        resource_info.file_limit=limit;
      else
        resource_info.file_limit=(((limit) < (StringToMagickSizeType(value, 100.0))) ? (limit) : (StringToMagickSizeType(value, 100.0)))
                 ;
      break;
    }
    case HeightResource:
    {
      ...
      if (value == (char *) 
# 1478 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1478 "MagickCore/resource.c"
                               )
        resource_info.height_limit=limit;
      else
        resource_info.height_limit=(((limit) < (StringToMagickSizeType( value,100.0))) ? (limit) : (StringToMagickSizeType( value,100.0)))
                       ;
      resource_info.height_limit=(((resource_info.height_limit) < ((MagickSizeType) (0x7fffffffffffffffL
# 1483 "MagickCore/resource.c"
                                ))) ? (resource_info.height_limit) : ((MagickSizeType) (0x7fffffffffffffffL
# 1483 "MagickCore/resource.c"
                                )))
                                          ;
      break;
    ...
    case ListLengthResource:
    {
      ...
      if (value == (char *) 
# 1490 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1490 "MagickCore/resource.c"
                               )
        resource_info.list_length_limit=limit;
      else
        resource_info.list_length_limit=(((limit) < (StringToMagickSizeType(value,100.0))) ? (limit) : (StringToMagickSizeType(value,100.0)))
                                              ;
      break;
    }
    case MapResource:
    {
      ...
      if (value == (char *) 
# 1500 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1500 "MagickCore/resource.c"
                               )
        resource_info.map_limit=limit;
      else
        resource_info.map_limit=(((limit) < (StringToMagickSizeType( value,100.0))) ? (limit) : (StringToMagickSizeType( value,100.0)))
                       ;
      break;
    }
    case MemoryResource:
    {
      ...
      if (value == (char *) 
# 1510 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1510 "MagickCore/resource.c"
                               )
        resource_info.memory_limit=limit;
      else
        resource_info.memory_limit=(((limit) < (StringToMagickSizeType( value,100.0))) ? (limit) : (StringToMagickSizeType( value,100.0)))
                       ;
      break;
    }
    case ThreadResource:
    {
      ...
      if (value == (char *) 
# 1520 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1520 "MagickCore/resource.c"
                               )
        resource_info.thread_limit=limit;
      else
        resource_info.thread_limit=(((limit) < (StringToMagickSizeType( value,100.0))) ? (limit) : (StringToMagickSizeType( value,100.0)))
                       ;
    ...
    case ThrottleResource:
    {
      ...
      if (value == (char *) 
# 1535 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1535 "MagickCore/resource.c"
                               )
        resource_info.throttle_limit=limit;
      else
        resource_info.throttle_limit=(((limit) > (StringToMagickSizeType( value,100.0))) ? (limit) : (StringToMagickSizeType( value,100.0)))
                       ;
      break;
    }
    case TimeResource:
    {
      ...
      if (value == (char *) 
# 1545 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1545 "MagickCore/resource.c"
                               )
        resource_info.time_limit=limit;
      else
        resource_info.time_limit=(((limit) < ((MagickSizeType) ParseMagickTimeToLive(value))) ? (limit) : ((MagickSizeType) ParseMagickTimeToLive(value)))
                                       ;
      break;
    }
    case WidthResource:
    {
      ...
      if (value == (char *) 
# 1555 "MagickCore/resource.c" 3 4
                           ((void *)0)
# 1555 "MagickCore/resource.c"
                               )
        resource_info.width_limit=limit;
      else
        resource_info.width_limit=(((limit) < (StringToMagickSizeType(value, 100.0))) ? (limit) : (StringToMagickSizeType(value, 100.0)))
                 ;
      resource_info.width_limit=(((resource_info.width_limit) < ((MagickSizeType) (0x7fffffffffffffffL
# 1560 "MagickCore/resource.c"
                               ))) ? (resource_info.width_limit) : ((MagickSizeType) (0x7fffffffffffffffL
# 1560 "MagickCore/resource.c"
                               )))
                                          ;
      break;
  ...
  if (value != (char *) 
# 1583 "MagickCore/resource.c" 3 4
                       ((void *)0)
# 1583 "MagickCore/resource.c"
                           )
    value=DestroyString(value);
  return(status);
}
