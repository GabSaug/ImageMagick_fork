...
# 54 "MagickCore/type.c" 2
# 1 "./MagickCore/nt-feature.h" 1
# 23 "./MagickCore/nt-feature.h"
...
# 67 "MagickCore/type.c" 2

# 1 "/usr/include/fontconfig/fontconfig.h" 1 3 4
# 31 "/usr/include/fontconfig/fontconfig.h" 3 4
# 1 "/usr/lib/gcc/x86_64-linux-gnu/13/include/limits.h" 1 3 4
...
typedef int FcBool;
# 204 "/usr/include/fontconfig/fontconfig.h" 3 4
...
# 230 "/usr/include/fontconfig/fontconfig.h" 3 4
...
# 326 "/usr/include/fontconfig/fontconfig.h" 3 4
...
# 69 "MagickCore/type.c" 2
# 111 "MagickCore/type.c"
...
static SemaphoreInfo
  *type_semaphore = (SemaphoreInfo *) 
# 123 "MagickCore/type.c" 3 4
                                     ((void *)0)
# 123 "MagickCore/type.c"
                                         ;

static SplayTreeInfo
  *type_cache = (SplayTreeInfo *) 
# 126 "MagickCore/type.c" 3 4
                                 ((void *)0)
# 126 "MagickCore/type.c"
                                     ;
...
static void *DestroyTypeNode(void *type_info)
{
  ...
  if (p->path != (char *) 
# 169 "MagickCore/type.c" 3 4
                         ((void *)0)
# 169 "MagickCore/type.c"
                             )
    p->path=DestroyString(p->path);
  if (p->name != (char *) 
# 171 "MagickCore/type.c" 3 4
                         ((void *)0)
# 171 "MagickCore/type.c"
                             )
    p->name=DestroyString(p->name);
  if (p->description != (char *) 
# 173 "MagickCore/type.c" 3 4
                                ((void *)0)
# 173 "MagickCore/type.c"
                                    )
    p->description=DestroyString(p->description);
  if (p->family != (char *) 
# 175 "MagickCore/type.c" 3 4
                           ((void *)0)
# 175 "MagickCore/type.c"
                               )
    p->family=DestroyString(p->family);
  if (p->encoding != (char *) 
# 177 "MagickCore/type.c" 3 4
                             ((void *)0)
# 177 "MagickCore/type.c"
                                 )
    p->encoding=DestroyString(p->encoding);
  if (p->foundry != (char *) 
# 179 "MagickCore/type.c" 3 4
                            ((void *)0)
# 179 "MagickCore/type.c"
                                )
    p->foundry=DestroyString(p->foundry);
  if (p->format != (char *) 
# 181 "MagickCore/type.c" 3 4
                           ((void *)0)
# 181 "MagickCore/type.c"
                               )
    p->format=DestroyString(p->format);
  if (p->metrics != (char *) 
# 183 "MagickCore/type.c" 3 4
                            ((void *)0)
# 183 "MagickCore/type.c"
                                )
    p->metrics=DestroyString(p->metrics);
  if (p->glyphs != (char *) 
# 185 "MagickCore/type.c" 3 4
                           ((void *)0)
# 185 "MagickCore/type.c"
                               )
...
# 196 "MagickCore/type.c" 3 4
                                                               ((void *)0)
# 196 "MagickCore/type.c"
                                                                   ,
    DestroyTypeNode);
  if (cache == (SplayTreeInfo *) 
# 198 "MagickCore/type.c" 3 4
                                ((void *)0)
# 198 "MagickCore/type.c"
                                    )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 199 "MagickCore/type.c" 3 4
   (*__errno_location ())
# 199 "MagickCore/type.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/type.c",__func__,(unsigned long) 199,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
...
# 215 "MagickCore/type.c" 3 4
                                         ((void *)0)
# 215 "MagickCore/type.c"
                                             )
    {
      (void) CopyMagickString(path,GetStringInfoPath(option),4096);
    ...
    if (font_path != (char *) 
# 224 "MagickCore/type.c" 3 4
                             ((void *)0)
# 224 "MagickCore/type.c"
                                 )
      {
        char
          *xml;
        ...
        (void) FormatLocaleString(path,4096,"%s%s%s",font_path,
          "/",filename);
        xml=FileToString(path,~0UL,exception);
        if (xml != (void *) 
# 235 "MagickCore/type.c" 3 4
                           ((void *)0)
# 235 "MagickCore/type.c"
                               )
          {
...
# 276 "MagickCore/type.c"
__attribute__ ((visibility ("default"))) const TypeInfo *GetTypeInfo(const char *name,
  ExceptionInfo *exception)
{
  
# 279 "MagickCore/type.c" 3 4
 ((void) sizeof ((
# 279 "MagickCore/type.c"
...
# 279 "MagickCore/type.c" 3 4
 , "MagickCore/type.c", 279, __extension__ __PRETTY_FUNCTION__); }))
# 279 "MagickCore/type.c"
                                            ;
  if (IsTypeTreeInstantiated(exception) == MagickFalse)
    return((const TypeInfo *) 
# 281 "MagickCore/type.c" 3 4
                             ((void *)0)
# 281 "MagickCore/type.c"
                                 );
  if ((name == (const char *) 
# 282 "MagickCore/type.c" 3 4
                             ((void *)0)
# 282 "MagickCore/type.c"
...
# 322 "MagickCore/type.c"
__attribute__ ((visibility ("default"))) const TypeInfo *GetTypeInfoByFamily(const char *family,
  ...
  ExceptionInfo *exception)
{
  ...
  if (type_cache == (SplayTreeInfo *) 
# 362 "MagickCore/type.c" 3 4
                                     ((void *)0)
# 362 "MagickCore/type.c"
                                         )
    return((TypeInfo *) 
# 363 "MagickCore/type.c" 3 4
                       ((void *)0)
# 363 "MagickCore/type.c"
                           );
  font_weight=(size_t) (weight == 0 ? 400 : weight);
  LockSemaphoreInfo(type_semaphore);
  ResetSplayTreeIterator(type_cache);
  type_info=(const TypeInfo *) 
# 367 "MagickCore/type.c" 3 4
                              ((void *)0)
# 367 "MagickCore/type.c"
                                  ;
  p=(const TypeInfo *) GetNextValueInSplayTree(type_cache);
  while (p != (const TypeInfo *) 
# 369 "MagickCore/type.c" 3 4
                                ((void *)0)
# 369 "MagickCore/type.c"
                                    )
  {
    if (p->family == (char *) 
# 371 "MagickCore/type.c" 3 4
                             ((void *)0)
# 371 "MagickCore/type.c"
                                 )
      {
        p=(const TypeInfo *) GetNextValueInSplayTree(type_cache);
        continue;
      }
    if (family == (const char *) 
# 376 "MagickCore/type.c" 3 4
                                ((void *)0)
# 376 "MagickCore/type.c"
                                    )
      {
...
# 411 "MagickCore/type.c" 3 4
                                     ((void *)0)
# 411 "MagickCore/type.c"
                                         )
    return(type_info);
  ...
  p=(const TypeInfo *) GetNextValueInSplayTree(type_cache);
  while (p != (const TypeInfo *) 
# 420 "MagickCore/type.c" 3 4
                                ((void *)0)
# 420 "MagickCore/type.c"
                                    )
  {
    if (p->family == (char *) 
# 422 "MagickCore/type.c" 3 4
                             ((void *)0)
# 422 "MagickCore/type.c"
                                 )
      {
        p=(const TypeInfo *) GetNextValueInSplayTree(type_cache);
        continue;
    ...
    if (family == (const char *) 
# 427 "MagickCore/type.c" 3 4
                                ((void *)0)
# 427 "MagickCore/type.c"
                                    )
      {
        if ((LocaleCompare(p->family,"arial") != 0) &&
            (LocaleCompare(p->family,"helvetica") != 0))
    ...
    if ((style == UndefinedStyle) || (style == AnyStyle) || (p->style == style))
      ...
      if (((style == ItalicStyle) || (style == ObliqueStyle)) &&
        ...
        score+=25;
    score+=(size_t) ((16L*(800L-((ssize_t) ((((((font_weight) < (900)) ? (font_weight) : (900))) > (p->weight)) ? ((((font_weight) < (900)) ? (font_weight) : (900))) : (p->weight))
                -(ssize_t) ((((((font_weight) < (900)) ? (font_weight) : (900))) < (p->weight)) ? ((((font_weight) < (900)) ? (font_weight) : (900))) : (p->weight)))))/
      800L);
    if ((stretch == UndefinedStretch) || (stretch == AnyStretch))
      score+=8;
    else
      {
        ...
        score+=(size_t) ((ssize_t) (8L*(range-((ssize_t) (((stretch) > (p->stretch)) ? (stretch) : (p->stretch))
                     -(ssize_t) (((stretch) < (p->stretch)) ? (stretch) : (p->stretch)))))/range);
      }
    if (score > max_score)
      {
        max_score=score;
  ...
  UnlockSemaphoreInfo(type_semaphore);
  if (type_info != (const TypeInfo *) 
# 468 "MagickCore/type.c" 3 4
                                     ((void *)0)
# 468 "MagickCore/type.c"
                                         )
    return(type_info);
  ...
  {
    if (family == (const char *) 
# 475 "MagickCore/type.c" 3 4
                                ((void *)0)
# 475 "MagickCore/type.c"
                                    )
      {
  ...
  if (type_info != (const TypeInfo *) 
# 488 "MagickCore/type.c" 3 4
                                     ((void *)0)
# 488 "MagickCore/type.c"
                                         )
    {
      (void) ThrowMagickException(exception,"MagickCore/type.c",__func__,(unsigned long) 490,TypeWarning,
        "FontSubstitutionRequired","`%s'",type_info->family);
      return(type_info);
    }
  if (family != (const char *) 
# 494 "MagickCore/type.c" 3 4
                              ((void *)0)
# 494 "MagickCore/type.c"
                                  )
    type_info=GetTypeInfoByFamily((const char *) 
# 495 "MagickCore/type.c" 3 4
                                                ((void *)0)
# 495 "MagickCore/type.c"
                                                    ,style,stretch,weight,
      exception);
  return(type_info);
}
# 532 "MagickCore/type.c"
...
__attribute__ ((visibility ("default"))) const TypeInfo **GetTypeInfoList(const char *pattern,
...
# 564 "MagickCore/type.c" 3 4
 ((void) sizeof ((
# 564 "MagickCore/type.c"
 pattern != (char *) 
# 564 "MagickCore/type.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 564 "MagickCore/type.c"
...
# 564 "MagickCore/type.c"
 "pattern != (char *) NULL"
# 564 "MagickCore/type.c" 3 4
 , "MagickCore/type.c", 564, __extension__ __PRETTY_FUNCTION__); }))
# 564 "MagickCore/type.c"
                                 ;
  
# 565 "MagickCore/type.c" 3 4
 ((void) sizeof ((
# 565 "MagickCore/type.c"
 number_fonts != (size_t *) 
# 565 "MagickCore/type.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 565 "MagickCore/type.c"
...
# 565 "MagickCore/type.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 565 "MagickCore/type.c"
 "number_fonts != (size_t *) NULL"
# 565 "MagickCore/type.c" 3 4
 , "MagickCore/type.c", 565, __extension__ __PRETTY_FUNCTION__); }))
# 565 "MagickCore/type.c"
                                        ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/type.c",__func__,(unsigned long) 567,"%s",pattern);
  *number_fonts=0;
  p=GetTypeInfo("*",exception);
  if (p == (const TypeInfo *) 
# 570 "MagickCore/type.c" 3 4
                             ((void *)0)
# 570 "MagickCore/type.c"
                                 )
    return((const TypeInfo **) 
# 571 "MagickCore/type.c" 3 4
                              ((void *)0)
# 571 "MagickCore/type.c"
                                  );
  fonts=(const TypeInfo **) AcquireQuantumMemory((size_t)
    GetNumberOfNodesInSplayTree(type_cache)+1UL,sizeof(*fonts));
  if (fonts == (const TypeInfo **) 
# 574 "MagickCore/type.c" 3 4
                                  ((void *)0)
# 574 "MagickCore/type.c"
                                      )
    return((const TypeInfo **) 
# 575 "MagickCore/type.c" 3 4
                              ((void *)0)
# 575 "MagickCore/type.c"
                                  );
  ...
  ResetSplayTreeIterator(type_cache);
  p=(const TypeInfo *) GetNextValueInSplayTree(type_cache);
  for (i=0; p != (const TypeInfo *) 
# 582 "MagickCore/type.c" 3 4
                                   ((void *)0)
# 582 "MagickCore/type.c"
                                       ; )
  {
  ...
  fonts[i]=(TypeInfo *) 
# 591 "MagickCore/type.c" 3 4
                       ((void *)0)
# 591 "MagickCore/type.c"
                           ;
  *number_fonts=(size_t) i;
  return(fonts);
}
# 628 "MagickCore/type.c"
...
__attribute__ ((visibility ("default"))) char **GetTypeList(const char *pattern,size_t *number_fonts,
  ExceptionInfo *exception)
{
  char
    **fonts;
...
# 658 "MagickCore/type.c" 3 4
 ((void) sizeof ((
# 658 "MagickCore/type.c"
 pattern != (char *) 
# 658 "MagickCore/type.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 658 "MagickCore/type.c"
...
# 658 "MagickCore/type.c"
 "pattern != (char *) NULL"
# 658 "MagickCore/type.c" 3 4
 , "MagickCore/type.c", 658, __extension__ __PRETTY_FUNCTION__); }))
# 658 "MagickCore/type.c"
                                 ;
  
# 659 "MagickCore/type.c" 3 4
 ((void) sizeof ((
# 659 "MagickCore/type.c"
 number_fonts != (size_t *) 
# 659 "MagickCore/type.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 659 "MagickCore/type.c"
...
# 659 "MagickCore/type.c"
 "number_fonts != (size_t *) NULL"
# 659 "MagickCore/type.c" 3 4
 , "MagickCore/type.c", 659, __extension__ __PRETTY_FUNCTION__); }))
# 659 "MagickCore/type.c"
                                        ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/type.c",__func__,(unsigned long) 661,"%s",pattern);
  *number_fonts=0;
  p=GetTypeInfo("*",exception);
  if (p == (const TypeInfo *) 
# 664 "MagickCore/type.c" 3 4
                             ((void *)0)
# 664 "MagickCore/type.c"
                                 )
    return((char **) 
# 665 "MagickCore/type.c" 3 4
                    ((void *)0)
# 665 "MagickCore/type.c"
                        );
  fonts=(char **) AcquireQuantumMemory((size_t)
    GetNumberOfNodesInSplayTree(type_cache)+1UL,sizeof(*fonts));
  if (fonts == (char **) 
# 668 "MagickCore/type.c" 3 4
                        ((void *)0)
# 668 "MagickCore/type.c"
                            )
    return((char **) 
# 669 "MagickCore/type.c" 3 4
                    ((void *)0)
# 669 "MagickCore/type.c"
                        );
  ...
  p=(const TypeInfo *) GetNextValueInSplayTree(type_cache);
  for (i=0; p != (const TypeInfo *) 
# 676 "MagickCore/type.c" 3 4
                                   ((void *)0)
# 676 "MagickCore/type.c"
                                       ; )
  {
    if ((p->stealth == MagickFalse) &&
        (GlobExpression(p->name,pattern,MagickFalse) != MagickFalse))
  ...
  fonts[i]=(char *) 
# 685 "MagickCore/type.c" 3 4
                   ((void *)0)
# 685 "MagickCore/type.c"
                       ;
  *number_fonts=(size_t) i;
  return(fonts);
}
# 715 "MagickCore/type.c"
__attribute__ ((visibility ("default"))) MagickBooleanType LoadFontConfigFonts(SplayTreeInfo *type_cache,
  ExceptionInfo *exception)
{
  ...
  if (font_config == (FcConfig *) 
# 769 "MagickCore/type.c" 3 4
                                 ((void *)0)
# 769 "MagickCore/type.c"
                                     )
    return(MagickFalse);
  FcConfigSetRescanInterval(font_config,0);
  font_set=(FcFontSet *) 
# 772 "MagickCore/type.c" 3 4
                        ((void *)0)
# 772 "MagickCore/type.c"
                            ;
  object_set=FcObjectSetBuild(
# 773 "MagickCore/type.c" 3 4
                             "fullname"
# 773 "MagickCore/type.c"
                                        ,
# 773 "MagickCore/type.c" 3 4
                                         "family"
# 773 "MagickCore/type.c"
...
# 774 "MagickCore/type.c" 3 4
   "width"
# 774 "MagickCore/type.c"
           ,
# 774 "MagickCore/type.c" 3 4
            "weight"
# 774 "MagickCore/type.c"
...
# 774 "MagickCore/type.c"
  ...
  if (object_set != (FcObjectSet *) 
# 775 "MagickCore/type.c" 3 4
                                   ((void *)0)
# 775 "MagickCore/type.c"
                                       )
    {
      pattern=FcPatternCreate();
      if (pattern != (FcPattern *) 
# 778 "MagickCore/type.c" 3 4
                                  ((void *)0)
# 778 "MagickCore/type.c"
                                      )
        {
  ...
  if (font_set == (FcFontSet *) 
# 785 "MagickCore/type.c" 3 4
                               ((void *)0)
# 785 "MagickCore/type.c"
                                   )
    {
  ...
  {
    status=FcPatternGetString(font_set->fonts[i],
# 792 "MagickCore/type.c" 3 4
                                                "family"
# 792 "MagickCore/type.c"
                                                         ,0,&family);
    if (status != FcResultMatch)
      continue;
    status=FcPatternGetString(font_set->fonts[i],
# 795 "MagickCore/type.c" 3 4
                                                "file"
# 795 "MagickCore/type.c"
                                                       ,0,&file);
    if (status != FcResultMatch)
      continue;
    *extension='\0';
    ...
    if (type_info == (TypeInfo *) 
# 803 "MagickCore/type.c" 3 4
                                 ((void *)0)
# 803 "MagickCore/type.c"
                                     )
      continue;
    (void) memset(type_info,0,sizeof(*type_info));
    type_info->path=ConstantString("System Fonts");
    type_info->signature=0xabacadabUL;
    (void) CopyMagickString(name,"Unknown",4096);
    status=FcPatternGetString(font_set->fonts[i],
# 809 "MagickCore/type.c" 3 4
                                                "fullname"
# 809 "MagickCore/type.c"
                                                           ,0,&fullname);
    if ((status == FcResultMatch) && (fullname != (FcChar8 *) 
# 810 "MagickCore/type.c" 3 4
                                                             ((void *)0)
# 810 "MagickCore/type.c"
                                                                 ))
      (void) CopyMagickString(name,(const char *) fullname,4096);
    else
      {
        if (family != (FcChar8 *) 
# 814 "MagickCore/type.c" 3 4
                                 ((void *)0)
# 814 "MagickCore/type.c"
                                     )
          (void) CopyMagickString(name,(const char *) family,4096);
        status=FcPatternGetString(font_set->fonts[i],
# 816 "MagickCore/type.c" 3 4
                                                    "style"
# 816 "MagickCore/type.c"
                                                            ,0,&style);
        if ((status == FcResultMatch) && (style != (FcChar8 *) 
# 817 "MagickCore/type.c" 3 4
                                                              ((void *)0)
# 817 "MagickCore/type.c"
                                                                  ) &&
            (LocaleCompare((const char *) style,"Regular") != 0))
          {
            (void) ConcatenateMagickString(name," ",4096);
    ...
    status=FcPatternGetInteger(font_set->fonts[i],
# 828 "MagickCore/type.c" 3 4
                                                 "slant"
# 828 "MagickCore/type.c"
                                                         ,0,&slant);
    type_info->style=NormalStyle;
    if (slant == 
# 830 "MagickCore/type.c" 3 4
                100
# 830 "MagickCore/type.c"
                               )
      type_info->style=ItalicStyle;
    if (slant == 
# 832 "MagickCore/type.c" 3 4
                110
# 832 "MagickCore/type.c"
                                )
      type_info->style=ObliqueStyle;
    status=FcPatternGetInteger(font_set->fonts[i],
# 834 "MagickCore/type.c" 3 4
                                                 "width"
# 834 "MagickCore/type.c"
                                                         ,0,&width);
    type_info->stretch=NormalStretch;
    if (width >= 
# 836 "MagickCore/type.c" 3 4
                50
# 836 "MagickCore/type.c"
                                       )
      type_info->stretch=UltraCondensedStretch;
    if (width >= 
# 838 "MagickCore/type.c" 3 4
                63
# 838 "MagickCore/type.c"
                                       )
      type_info->stretch=ExtraCondensedStretch;
    if (width >= 
# 840 "MagickCore/type.c" 3 4
                75
# 840 "MagickCore/type.c"
                                  )
      type_info->stretch=CondensedStretch;
    if (width >= 
# 842 "MagickCore/type.c" 3 4
                87
# 842 "MagickCore/type.c"
                                      )
      type_info->stretch=SemiCondensedStretch;
    if (width >= 
# 844 "MagickCore/type.c" 3 4
                100
# 844 "MagickCore/type.c"
                               )
      type_info->stretch=NormalStretch;
    if (width >= 
# 846 "MagickCore/type.c" 3 4
                113
# 846 "MagickCore/type.c"
                                     )
      type_info->stretch=SemiExpandedStretch;
    if (width >= 
# 848 "MagickCore/type.c" 3 4
                125
# 848 "MagickCore/type.c"
                                 )
      type_info->stretch=ExpandedStretch;
    if (width >= 
# 850 "MagickCore/type.c" 3 4
                150
# 850 "MagickCore/type.c"
                                      )
      type_info->stretch=ExtraExpandedStretch;
    if (width >= 
# 852 "MagickCore/type.c" 3 4
                200
# 852 "MagickCore/type.c"
                                      )
      type_info->stretch=UltraExpandedStretch;
    type_info->weight=400;
    status=FcPatternGetInteger(font_set->fonts[i],
# 855 "MagickCore/type.c" 3 4
                                                 "weight"
# 855 "MagickCore/type.c"
                                                          ,0,&weight);
    if (weight >= 
# 856 "MagickCore/type.c" 3 4
                 0
# 856 "MagickCore/type.c"
                               )
      type_info->weight=100;
    if (weight >= 
# 858 "MagickCore/type.c" 3 4
                 40
# 858 "MagickCore/type.c"
                                     )
      type_info->weight=200;
    if (weight >= 
# 860 "MagickCore/type.c" 3 4
                 50
# 860 "MagickCore/type.c"
                                )
      type_info->weight=300;
    if (weight >= 
# 862 "MagickCore/type.c" 3 4
                 80
# 862 "MagickCore/type.c"
                                 )
      type_info->weight=400;
    if (weight >= 
# 864 "MagickCore/type.c" 3 4
                 100
# 864 "MagickCore/type.c"
                                 )
      type_info->weight=500;
    if (weight >= 
# 866 "MagickCore/type.c" 3 4
                 180
# 866 "MagickCore/type.c"
                                   )
      type_info->weight=600;
    if (weight >= 
# 868 "MagickCore/type.c" 3 4
                 200
# 868 "MagickCore/type.c"
                               )
      type_info->weight=700;
    if (weight >= 
# 870 "MagickCore/type.c" 3 4
                 205
# 870 "MagickCore/type.c"
                                    )
      type_info->weight=800;
    if (weight >= 
# 872 "MagickCore/type.c" 3 4
                 210
# 872 "MagickCore/type.c"
                                )
...
{
  if (type_cache == (SplayTreeInfo *) 
# 885 "MagickCore/type.c" 3 4
                                     ((void *)0)
# 885 "MagickCore/type.c"
                                         )
    {
      if (type_semaphore == (SemaphoreInfo *) 
# 887 "MagickCore/type.c" 3 4
                                             ((void *)0)
# 887 "MagickCore/type.c"
                                                 )
        ActivateSemaphoreInfo(&type_semaphore);
      LockSemaphoreInfo(type_semaphore);
      if (type_cache == (SplayTreeInfo *) 
# 890 "MagickCore/type.c" 3 4
                                         ((void *)0)
# 890 "MagickCore/type.c"
                                             )
        {
          SplayTreeInfo
            *splay_tree;

          splay_tree=AcquireTypeCache("type.xml",exception);
  ...
  return(type_cache != (SplayTreeInfo *) 
# 906 "MagickCore/type.c" 3 4
                                        ((void *)0) 
# 906 "MagickCore/type.c"
                                             ? MagickTrue : MagickFalse);
}
# 933 "MagickCore/type.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListTypeInfo(FILE *file,ExceptionInfo *exception)
{
  char
    weight[4096];
  ...
  if (file == (FILE *) 
# 955 "MagickCore/type.c" 3 4
                      ((void *)0)
# 955 "MagickCore/type.c"
                          )
    file=
# 956 "MagickCore/type.c" 3 4
        stdout
# 956 "MagickCore/type.c"
              ;
  number_fonts=0;
  type_info=GetTypeInfoList("*",&number_fonts,exception);
  if (type_info == (const TypeInfo **) 
# 959 "MagickCore/type.c" 3 4
                                      ((void *)0)
# 959 "MagickCore/type.c"
                                          )
    return(MagickFalse);
  *weight='\0';
  path=(const char *) 
# 962 "MagickCore/type.c" 3 4
                     ((void *)0)
# 962 "MagickCore/type.c"
                         ;
  for (i=0; i < (ssize_t) number_fonts; i++)
  {
    if (type_info[i]->stealth != MagickFalse)
      continue;
    if (((path == (const char *) 
# 967 "MagickCore/type.c" 3 4
                                ((void *)0)
# 967 "MagickCore/type.c"
                                    ) ||
         (LocaleCompare(path,type_info[i]->path) != 0)) &&
         (type_info[i]->path != (char *) 
# 969 "MagickCore/type.c" 3 4
                                        ((void *)0)
# 969 "MagickCore/type.c"
                                            ))
      (void) FormatLocaleFile(file,"\nPath: %s\n",type_info[i]->path);
    path=type_info[i]->path;
    name="unknown";
    if (type_info[i]->name != (char *) 
# 973 "MagickCore/type.c" 3 4
                                      ((void *)0)
# 973 "MagickCore/type.c"
                                          )
      name=type_info[i]->name;
    family="unknown";
    if (type_info[i]->family != (char *) 
# 976 "MagickCore/type.c" 3 4
                                        ((void *)0)
# 976 "MagickCore/type.c"
                                            )
    ...
    glyphs="unknown";
    if (type_info[i]->glyphs != (char *) 
# 981 "MagickCore/type.c" 3 4
                                        ((void *)0)
# 981 "MagickCore/type.c"
                                            )
      glyphs=type_info[i]->glyphs;
    (void) FormatLocaleString(weight,4096,"%.20g",(double)
      type_info[i]->weight);
  ...
  if (IsPathAccessible(path) == MagickFalse)
    {
      ...
      (void) ConcatenateMagickString(font_path,"/",
        4096);
      (void) ConcatenateMagickString(font_path,token,4096);
  ...
  const char *filename,const size_t depth,ExceptionInfo *exception)
{
  ...
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(ConfigureEvent,"MagickCore/type.c",__func__,(unsigned long) 1089,
      "Loading type configure file \"%s\" ...",filename);
  if (xml == (const char *) 
# 1091 "MagickCore/type.c" 3 4
                           ((void *)0)
# 1091 "MagickCore/type.c"
                               )
    return(MagickFalse);
  status=MagickTrue;
  type_info=(TypeInfo *) 
# 1094 "MagickCore/type.c" 3 4
                        ((void *)0)
# 1094 "MagickCore/type.c"
                            ;
  token=AcquireString(xml);
  extent=strlen(token)+4096;
# 1106 "MagickCore/type.c"
  for (q=(char *) xml; *q != '\0'; )
  {
    ...
    if (LocaleCompare(keyword,"<include") == 0)
      {
        ...
        while (((*token != '/') && (*(token+1) != '>')) && (*q != '\0'))
        {
          ...
          if (LocaleCompare(keyword,"file") == 0)
            {
              if (depth > 600)
                (void) ThrowMagickException(exception,"MagickCore/type.c",__func__,(unsigned long) 1148,
              ...
              else
                {
                  ...
                  *path='\0';
                  ...
                  if (file_xml != (char *) 
# 1171 "MagickCore/type.c" 3 4
                                          ((void *)0)
# 1171 "MagickCore/type.c"
                                              )
                    {
    ...
    if (type_info == (TypeInfo *) 
# 1193 "MagickCore/type.c" 3 4
                                 ((void *)0)
# 1193 "MagickCore/type.c"
                                     )
      continue;
    if ((LocaleCompare(keyword,"/>") == 0) ||
        (LocaleCompare(keyword,"</policy>") == 0))
      {
        ...
        if (status == MagickFalse)
          (void) ThrowMagickException(exception,"MagickCore/type.c",__func__,(unsigned long) 1200,
            ResourceLimitError,"MemoryAllocationFailed","`%s'",type_info->name);
        type_info=(TypeInfo *) 
# 1202 "MagickCore/type.c" 3 4
                              ((void *)0)
# 1202 "MagickCore/type.c"
                                  ;
        continue;
      }
    (void) GetNextToken(q,(const char **) 
# 1205 "MagickCore/type.c" 3 4
                                         ((void *)0)
# 1205 "MagickCore/type.c"
                                             ,extent,token);
    if (*token != '=')
      continue;
    (void) GetNextToken(q,&q,extent,token);
...
# 1350 "MagickCore/type.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType TypeComponentGenesis(void)
{
  if (type_semaphore == (SemaphoreInfo *) 
# 1352 "MagickCore/type.c" 3 4
                                         ((void *)0)
# 1352 "MagickCore/type.c"
                                             )
    type_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 1375 "MagickCore/type.c"
__attribute__ ((visibility ("hidden"))) void TypeComponentTerminus(void)
{
  if (type_semaphore == (SemaphoreInfo *) 
# 1377 "MagickCore/type.c" 3 4
                                         ((void *)0)
# 1377 "MagickCore/type.c"
                                             )
    ActivateSemaphoreInfo(&type_semaphore);
  LockSemaphoreInfo(type_semaphore);
  if (type_cache != (SplayTreeInfo *) 
# 1380 "MagickCore/type.c" 3 4
                                     ((void *)0)
# 1380 "MagickCore/type.c"
                                         )
