# 0 "MagickCore/accelerate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/accelerate.c"
# 44 "MagickCore/accelerate.c"
...
# 45 "MagickCore/accelerate.c" 2
# 1 "./MagickCore/accelerate-private.h" 1
# 46 "MagickCore/accelerate.c" 2
