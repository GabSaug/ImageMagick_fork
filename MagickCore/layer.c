# 0 "MagickCore/layer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/layer.c"
# 40 "MagickCore/layer.c"
...
# 68 "MagickCore/layer.c" 2
# 102 "MagickCore/layer.c"
  ...
  ExceptionInfo *exception)
{
  ...
  for (y=0; y < (ssize_t) bounds->height; y++)
  {
    ...
    if (q == (Quantum *) 
# 121 "MagickCore/layer.c" 3 4
                        ((void *)0)
# 121 "MagickCore/layer.c"
                            )
      break;
  ...
  const Image *image2,RectangleInfo *bounds,ExceptionInfo *exception)
{
  ...
  for (y=0; y < (ssize_t) bounds->height; y++)
  {
    ...
    if ((p == (const Quantum *) 
# 186 "MagickCore/layer.c" 3 4
                               ((void *)0)
# 186 "MagickCore/layer.c"
                                   ) || (q == (Quantum *) 
# 186 "MagickCore/layer.c" 3 4
                                                          ((void *)0)
# 186 "MagickCore/layer.c"
    ...
    for (x=0; x < (ssize_t) bounds->width; x++)
    {
      if ((GetPixelAlpha(image1,p) >= (Quantum) (((Quantum) 65535.0)/2)) &&
          (GetPixelAlpha(image2,q) < (Quantum) (((Quantum) 65535.0)/2)))
        break;
...
# 231 "MagickCore/layer.c"
__attribute__ ((visibility ("default"))) Image *CoalesceImages(const Image *image,ExceptionInfo *exception)
{
  Image
    *coalesce_image,
    *dispose_image,
...
# 247 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 247 "MagickCore/layer.c"
 image != (Image *) 
# 247 "MagickCore/layer.c" 3 4
...
# 247 "MagickCore/layer.c"
 "image != (Image *) NULL"
# 247 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 247, __extension__ __PRETTY_FUNCTION__); }))
# 247 "MagickCore/layer.c"
                                ;
  
# 248 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 248 "MagickCore/layer.c"
...
# 248 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 248, __extension__ __PRETTY_FUNCTION__); }))
# 248 "MagickCore/layer.c"
                                                ;
  
# 249 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 249 "MagickCore/layer.c"
...
# 249 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 249, __extension__ __PRETTY_FUNCTION__); }))
# 249 "MagickCore/layer.c"
                                            ;
  
# 250 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 250 "MagickCore/layer.c"
...
# 250 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 250, __extension__ __PRETTY_FUNCTION__); }))
# 250 "MagickCore/layer.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/layer.c",__func__,(unsigned long) 252,"%s",image->filename);
...
# 271 "MagickCore/layer.c" 3 4
                                 ((void *)0)
# 271 "MagickCore/layer.c"
                                     )
    return((Image *) 
# 272 "MagickCore/layer.c" 3 4
                    ((void *)0)
# 272 "MagickCore/layer.c"
                        );
  coalesce_image->background_color.alpha_trait=BlendPixelTrait;
  coalesce_image->background_color.alpha=(MagickRealType) ((Quantum) 0);
  ...
  if (dispose_image == (Image *) 
# 283 "MagickCore/layer.c" 3 4
                                ((void *)0)
# 283 "MagickCore/layer.c"
                                    )
    {
      coalesce_image=DestroyImage(coalesce_image);
      return((Image *) 
# 286 "MagickCore/layer.c" 3 4
                      ((void *)0)
# 286 "MagickCore/layer.c"
                          );
    }
  ...
  for ( ; next != (Image *) 
# 292 "MagickCore/layer.c" 3 4
                           ((void *)0)
# 292 "MagickCore/layer.c"
                               ; next=GetNextImageInList(next))
  {
    const char
      *attribute;
    ...
    if (GetPreviousImageInList(next)->dispose != PreviousDispose)
      {
        ...
        dispose_image=CloneImage(coalesce_image,0,0,MagickTrue,exception);
        if (dispose_image == (Image *) 
# 325 "MagickCore/layer.c" 3 4
                                      ((void *)0)
# 325 "MagickCore/layer.c"
                                          )
          {
            coalesce_image=DestroyImageList(coalesce_image);
            return((Image *) 
# 328 "MagickCore/layer.c" 3 4
                            ((void *)0)
# 328 "MagickCore/layer.c"
                                );
          }
        dispose_image->background_color.alpha_trait=BlendPixelTrait;
      }
    ...
    if (coalesce_image->next != (Image *) 
# 341 "MagickCore/layer.c" 3 4
                                         ((void *)0)
# 341 "MagickCore/layer.c"
                                             )
    ...
    if (attribute == (const char *) 
# 347 "MagickCore/layer.c" 3 4
                                   ((void *)0)
# 347 "MagickCore/layer.c"
                                       )
...
# 399 "MagickCore/layer.c"
__attribute__ ((visibility ("default"))) Image *DisposeImages(const Image *images,ExceptionInfo *exception)
{
  Image
    *dispose_image,
    *dispose_images;
...
# 415 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 415 "MagickCore/layer.c"
 images != (Image *) 
# 415 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 415 "MagickCore/layer.c"
...
# 415 "MagickCore/layer.c"
 "images != (Image *) NULL"
# 415 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 415, __extension__ __PRETTY_FUNCTION__); }))
# 415 "MagickCore/layer.c"
                                 ;
  
# 416 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 416 "MagickCore/layer.c"
...
# 416 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 416, __extension__ __PRETTY_FUNCTION__); }))
# 416 "MagickCore/layer.c"
                                                 ;
  
# 417 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 417 "MagickCore/layer.c"
 exception != (ExceptionInfo *) 
# 417 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 417 "MagickCore/layer.c"
...
# 417 "MagickCore/layer.c"
 "exception != (ExceptionInfo *) NULL"
# 417 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 417, __extension__ __PRETTY_FUNCTION__); }))
# 417 "MagickCore/layer.c"
                                            ;
  
# 418 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 418 "MagickCore/layer.c"
 exception->signature == 0xabacadabUL
# 418 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 418 "MagickCore/layer.c"
...
# 418 "MagickCore/layer.c"
 "exception->signature == MagickCoreSignature"
# 418 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 418, __extension__ __PRETTY_FUNCTION__); }))
# 418 "MagickCore/layer.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/layer.c",__func__,(unsigned long) 420,"%s",images->filename);
  image=GetFirstImageInList(images);
  dispose_image=CloneImage(image,image->page.width,image->page.height,
    MagickTrue,exception);
  if (dispose_image == (Image *) 
# 424 "MagickCore/layer.c" 3 4
                                ((void *)0)
# 424 "MagickCore/layer.c"
                                    )
    return((Image *) 
# 425 "MagickCore/layer.c" 3 4
                    ((void *)0)
# 425 "MagickCore/layer.c"
                        );
  ...
  dispose_image->background_color.alpha_trait=BlendPixelTrait;
  dispose_image->background_color.alpha=(MagickRealType) ((Quantum) 0);
  (void) SetImageBackgroundColor(dispose_image,exception);
  dispose_images=NewImageList();
  for (next=image; image != (Image *) 
# 434 "MagickCore/layer.c" 3 4
                                     ((void *)0)
# 434 "MagickCore/layer.c"
...
# 443 "MagickCore/layer.c" 3 4
                                  ((void *)0)
# 443 "MagickCore/layer.c"
                                      )
      {
        dispose_images=DestroyImageList(dispose_images);
        dispose_image=DestroyImage(dispose_image);
        return((Image *) 
# 447 "MagickCore/layer.c" 3 4
                        ((void *)0)
# 447 "MagickCore/layer.c"
                            );
      }
    ...
    if (next->dispose == PreviousDispose)
    ...
    else
      {
        ...
        current_image=(Image *) 
# 486 "MagickCore/layer.c" 3 4
                               ((void *)0)
# 486 "MagickCore/layer.c"
                                   ;
      }
...

    {
      ...
      if (dispose == (Image *) 
# 496 "MagickCore/layer.c" 3 4
                              ((void *)0)
# 496 "MagickCore/layer.c"
                                  )
        {
          dispose_images=DestroyImageList(dispose_images);
          dispose_image=DestroyImage(dispose_image);
          return((Image *) 
# 500 "MagickCore/layer.c" 3 4
                          ((void *)0)
# 500 "MagickCore/layer.c"
                              );
        }
      dispose_image->background_color.alpha_trait=BlendPixelTrait;
  ...
  const PixelInfo *p,const PixelInfo *q)
{
  ...
  if (method == CompareClearLayer)
    return((MagickBooleanType) ( (o1 >= ((double) ((Quantum) 65535.0)/2.0)) &&
      (o2 < ((double) ((Quantum) 65535.0)/2.0)) ) );



  if (method == CompareOverlayLayer)
    {
      if (o2 < ((double) ((Quantum) 65535.0)/2.0))
        return MagickFalse;
  ...
  const Image *beta_image,const LayerMethod method,ExceptionInfo *exception)
{
  ...
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/layer.c",__func__,(unsigned long) 640,"%s",
  ...
  for (x=0; x < (ssize_t) alpha_image->columns; x++)
  {
    ...
    if ((p == (const Quantum *) 
# 648 "MagickCore/layer.c" 3 4
                               ((void *)0)
# 648 "MagickCore/layer.c"
                                   ) || (q == (Quantum *) 
# 648 "MagickCore/layer.c" 3 4
                                                          ((void *)0)
# 648 "MagickCore/layer.c"
  ...
  for (x=(ssize_t) alpha_image->columns-1; x >= 0; x--)
  {
    ...
    q=GetVirtualPixels(beta_image,x,0,1,beta_image->rows,exception);
    if ((p == (const Quantum *) 
# 678 "MagickCore/layer.c" 3 4
                               ((void *)0)
# 678 "MagickCore/layer.c"
                                   ) || (q == (Quantum *) 
# 678 "MagickCore/layer.c" 3 4
                                                          ((void *)0)
# 678 "MagickCore/layer.c"
  ...
  for (y=0; y < (ssize_t) alpha_image->rows; y++)
  {
    ...
    if ((p == (const Quantum *) 
# 697 "MagickCore/layer.c" 3 4
                               ((void *)0)
# 697 "MagickCore/layer.c"
                                   ) || (q == (Quantum *) 
# 697 "MagickCore/layer.c" 3 4
                                                          ((void *)0)
# 697 "MagickCore/layer.c"
  ...
  for (y=(ssize_t) alpha_image->rows-1; y >= 0; y--)
  {
    ...
    q=GetVirtualPixels(beta_image,0,y,beta_image->columns,1,exception);
    if ((p == (const Quantum *) 
# 716 "MagickCore/layer.c" 3 4
                               ((void *)0)
# 716 "MagickCore/layer.c"
                                   ) || (q == (Quantum *) 
# 716 "MagickCore/layer.c" 3 4
                                                          ((void *)0)
# 716 "MagickCore/layer.c"
...
# 772 "MagickCore/layer.c"
__attribute__ ((visibility ("default"))) Image *CompareImagesLayers(const Image *image,
...
# 789 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 789 "MagickCore/layer.c"
 image != (const Image *) 
# 789 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 789 "MagickCore/layer.c"
...
# 789 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 789, __extension__ __PRETTY_FUNCTION__); }))
# 789 "MagickCore/layer.c"
                                      ;
  
# 790 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 790 "MagickCore/layer.c"
 image->signature == 0xabacadabUL
# 790 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 790 "MagickCore/layer.c"
...
# 790 "MagickCore/layer.c"
 "image->signature == MagickCoreSignature"
# 790 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 790, __extension__ __PRETTY_FUNCTION__); }))
# 790 "MagickCore/layer.c"
                                                ;
  
# 791 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 791 "MagickCore/layer.c"
 exception != (ExceptionInfo *) 
# 791 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 791 "MagickCore/layer.c"
...
# 791 "MagickCore/layer.c"
 "exception != (ExceptionInfo *) NULL"
# 791 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 791, __extension__ __PRETTY_FUNCTION__); }))
# 791 "MagickCore/layer.c"
                                            ;
  
# 792 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 792 "MagickCore/layer.c"
 exception->signature == 0xabacadabUL
# 792 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 792 "MagickCore/layer.c"
...
# 792 "MagickCore/layer.c"
 "exception->signature == MagickCoreSignature"
# 792 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 792, __extension__ __PRETTY_FUNCTION__); }))
# 792 "MagickCore/layer.c"
                                                    ;
  
# 793 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 793 "MagickCore/layer.c"
 (method == CompareAnyLayer) || (method == CompareClearLayer) || (method == CompareOverlayLayer)
# 793 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 793 "MagickCore/layer.c"
 (method == CompareAnyLayer) || (method == CompareClearLayer) || (method == CompareOverlayLayer)
...
# 793 "MagickCore/layer.c"
 "(method == CompareAnyLayer) || (method == CompareClearLayer) || (method == CompareOverlayLayer)"
# 793 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 793, __extension__ __PRETTY_FUNCTION__); }))

                                         
# 795 "MagickCore/layer.c"
                                        ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/layer.c",__func__,(unsigned long) 797,"%s",image->filename);
  ...
  if (bounds == (RectangleInfo *) 
# 804 "MagickCore/layer.c" 3 4
                                 ((void *)0)
# 804 "MagickCore/layer.c"
                                     )
    { (void) ThrowMagickException(exception,"MagickCore/layer.c",__func__,(unsigned long) 805,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 805 "MagickCore/layer.c" 3 4
   ((void *)0)
# 805 "MagickCore/layer.c"
   ); };
  ...
  image_a=CloneImage(next,next->page.width,next->page.height,
    MagickTrue,exception);
  if (image_a == (Image *) 
# 811 "MagickCore/layer.c" 3 4
                          ((void *)0)
# 811 "MagickCore/layer.c"
                              )
    {
      bounds=(RectangleInfo *) RelinquishMagickMemory(bounds);
      return((Image *) 
# 814 "MagickCore/layer.c" 3 4
                      ((void *)0)
# 814 "MagickCore/layer.c"
                          );
    }
  image_a->background_color.alpha_trait=BlendPixelTrait;
  image_a->background_color.alpha=(MagickRealType) ((Quantum) 0);
  ...
  i=0;
  next=GetNextImageInList(next);
  for ( ; next != (const Image *) 
# 829 "MagickCore/layer.c" 3 4
                                 ((void *)0)
# 829 "MagickCore/layer.c"
                                     ; next=GetNextImageInList(next))
  {
    image_b=CloneImage(image_a,0,0,MagickTrue,exception);
    if (image_b == (Image *) 
# 832 "MagickCore/layer.c" 3 4
                            ((void *)0)
# 832 "MagickCore/layer.c"
                                )
      {
        image_a=DestroyImage(image_a);
        bounds=(RectangleInfo *) RelinquishMagickMemory(bounds);
        return((Image *) 
# 836 "MagickCore/layer.c" 3 4
                        ((void *)0)
# 836 "MagickCore/layer.c"
                            );
      }
  ...
  if (layers == (Image *) 
# 851 "MagickCore/layer.c" 3 4
                         ((void *)0)
# 851 "MagickCore/layer.c"
                             )
    {
      bounds=(RectangleInfo *) RelinquishMagickMemory(bounds);
      return((Image *) 
# 854 "MagickCore/layer.c" 3 4
                      ((void *)0)
# 854 "MagickCore/layer.c"
                          );
    }
  ...
  next=GetNextImageInList(next);
  for ( ; next != (const Image *) 
# 862 "MagickCore/layer.c" 3 4
                                 ((void *)0)
# 862 "MagickCore/layer.c"
                                     ; next=GetNextImageInList(next))
  {
    ...
    if (image_a == (Image *) 
# 875 "MagickCore/layer.c" 3 4
                            ((void *)0)
# 875 "MagickCore/layer.c"
                                )
      break;
    image_a->background_color.alpha_trait=BlendPixelTrait;
    ...
    image_a=DestroyImage(image_a);
    if (image_b == (Image *) 
# 880 "MagickCore/layer.c" 3 4
                            ((void *)0)
# 880 "MagickCore/layer.c"
                                )
      break;
  ...
  bounds=(RectangleInfo *) RelinquishMagickMemory(bounds);
  if (next != (Image *) 
# 886 "MagickCore/layer.c" 3 4
                       ((void *)0)
# 886 "MagickCore/layer.c"
                           )
    {
      layers=DestroyImageList(layers);
      return((Image *) 
# 889 "MagickCore/layer.c" 3 4
                      ((void *)0)
# 889 "MagickCore/layer.c"
                          );
    }
  return(GetFirstImageInList(layers));
}
# 945 "MagickCore/layer.c"
...
# 977 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 977 "MagickCore/layer.c"
 image != (const Image *) 
# 977 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 977 "MagickCore/layer.c"
...
# 977 "MagickCore/layer.c"
 "image != (const Image *) NULL"
# 977 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 977, __extension__ __PRETTY_FUNCTION__); }))
# 977 "MagickCore/layer.c"
                                      ;
  
# 978 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 978 "MagickCore/layer.c"
 image->signature == 0xabacadabUL
# 978 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 978 "MagickCore/layer.c"
...
# 978 "MagickCore/layer.c"
 "image->signature == MagickCoreSignature"
# 978 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 978, __extension__ __PRETTY_FUNCTION__); }))
# 978 "MagickCore/layer.c"
                                                ;
  
# 979 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 979 "MagickCore/layer.c"
 exception != (ExceptionInfo *) 
# 979 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 979 "MagickCore/layer.c"
...
# 979 "MagickCore/layer.c"
 "exception != (ExceptionInfo *) NULL"
# 979 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 979, __extension__ __PRETTY_FUNCTION__); }))
# 979 "MagickCore/layer.c"
                                            ;
  
# 980 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 980 "MagickCore/layer.c"
 exception->signature == 0xabacadabUL
# 980 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 980 "MagickCore/layer.c"
...
# 980 "MagickCore/layer.c"
 "exception->signature == MagickCoreSignature"
# 980 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 980, __extension__ __PRETTY_FUNCTION__); }))
# 980 "MagickCore/layer.c"
                                                    ;
  
# 981 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 981 "MagickCore/layer.c"
 method == OptimizeLayer || method == OptimizeImageLayer || method == OptimizePlusLayer
# 981 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 981 "MagickCore/layer.c"
 method == OptimizeLayer || method == OptimizeImageLayer || method == OptimizePlusLayer
...
# 981 "MagickCore/layer.c"
 "method == OptimizeLayer || method == OptimizeImageLayer || method == OptimizePlusLayer"
# 981 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 981, __extension__ __PRETTY_FUNCTION__); }))

                                     
# 983 "MagickCore/layer.c"
                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/layer.c",__func__,(unsigned long) 985,"%s",image->filename);
  ...
  for (; curr != (Image *) 
# 994 "MagickCore/layer.c" 3 4
                          ((void *)0)
# 994 "MagickCore/layer.c"
                              ; curr=GetNextImageInList(curr))
  {
    if ((curr->columns != image->columns) || (curr->rows != image->rows))
      { (void) ThrowMagickException(exception,"MagickCore/layer.c",__func__,(unsigned long) 997,OptionError,"ImagesAreNotTheSameSize", "`%s'",image->filename); return((Image *) 
# 997 "MagickCore/layer.c" 3 4
     ((void *)0)
# 997 "MagickCore/layer.c"
     ); };

    if ((curr->page.x != 0) || (curr->page.y != 0) ||
        (curr->page.width != image->page.width) ||
        (curr->page.height != image->page.height))
      { (void) ThrowMagickException(exception,"MagickCore/layer.c",__func__,(unsigned long) 1002,OptionError,"ImagePagesAreNotCoalesced", "`%s'",image->filename); return((Image *) 
# 1002 "MagickCore/layer.c" 3 4
     ((void *)0)
# 1002 "MagickCore/layer.c"
     ); };
  }
  ...
  bounds=(RectangleInfo *) AcquireQuantumMemory((size_t)
    ...
    sizeof(*bounds));
  if (bounds == (RectangleInfo *) 
# 1011 "MagickCore/layer.c" 3 4
                                 ((void *)0)
# 1011 "MagickCore/layer.c"
                                     )
    { (void) ThrowMagickException(exception,"MagickCore/layer.c",__func__,(unsigned long) 1012,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 1012 "MagickCore/layer.c" 3 4
   ((void *)0)
# 1012 "MagickCore/layer.c"
   ); };
  disposals=(DisposeType *) AcquireQuantumMemory((size_t)
    GetImageListLength(image),(add_frames != MagickFalse ? 2UL : 1UL)*
    sizeof(*disposals));
  if (disposals == (DisposeType *) 
# 1016 "MagickCore/layer.c" 3 4
                                  ((void *)0)
# 1016 "MagickCore/layer.c"
                                      )
    {
      bounds=(RectangleInfo *) RelinquishMagickMemory(bounds);
      { (void) ThrowMagickException(exception,"MagickCore/layer.c",__func__,(unsigned long) 1019,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 1019 "MagickCore/layer.c" 3 4
     ((void *)0)
# 1019 "MagickCore/layer.c"
     ); };
    }
  ...
  if (prev_image == (Image *) 
# 1025 "MagickCore/layer.c" 3 4
                             ((void *)0)
# 1025 "MagickCore/layer.c"
                                 )
    {
      bounds=(RectangleInfo *) RelinquishMagickMemory(bounds);
      disposals=(DisposeType *) RelinquishMagickMemory(disposals);
      return((Image *) 
# 1029 "MagickCore/layer.c" 3 4
                      ((void *)0)
# 1029 "MagickCore/layer.c"
                          );
    }
  ...
  prev_image->background_color.alpha=(MagickRealType) ((Quantum) 0);
  (void) SetImageBackgroundColor(prev_image,exception);
# 1046 "MagickCore/layer.c"
  disposals[0]=NoneDispose;
  bounds[0]=CompareImagesBounds(prev_image,curr,CompareAnyLayer,exception);
# 1056 "MagickCore/layer.c"
  i=1;
  bgnd_image=(Image *) 
# 1057 "MagickCore/layer.c" 3 4
                      ((void *)0)
# 1057 "MagickCore/layer.c"
                          ;
  dup_image=(Image *) 
# 1058 "MagickCore/layer.c" 3 4
                     ((void *)0)
# 1058 "MagickCore/layer.c"
                         ;
  dup_bounds.width=0;
  dup_bounds.height=0;
  dup_bounds.x=0;
  dup_bounds.y=0;
  curr=GetNextImageInList(curr);
  for ( ; curr != (const Image *) 
# 1064 "MagickCore/layer.c" 3 4
                                 ((void *)0)
# 1064 "MagickCore/layer.c"
                                     ; curr=GetNextImageInList(curr))
  {
        ...
        if ( add_frames )
          {
            ...
            if (dup_image == (Image *) 
# 1133 "MagickCore/layer.c" 3 4
                                      ((void *)0)
# 1133 "MagickCore/layer.c"
                                          )
              {
                bounds=(RectangleInfo *) RelinquishMagickMemory(bounds);
                disposals=(DisposeType *) RelinquishMagickMemory(disposals);
                ...
                return((Image *) 
# 1138 "MagickCore/layer.c" 3 4
                                ((void *)0)
# 1138 "MagickCore/layer.c"
                                    );
              }
        ...
        if (bgnd_image == (Image *) 
# 1161 "MagickCore/layer.c" 3 4
                                   ((void *)0)
# 1161 "MagickCore/layer.c"
                                       )
          {
            bounds=(RectangleInfo *) RelinquishMagickMemory(bounds);
            disposals=(DisposeType *) RelinquishMagickMemory(disposals);
            prev_image=DestroyImage(prev_image);
            if ( dup_image != (Image *) 
# 1166 "MagickCore/layer.c" 3 4
                                       ((void *)0)
# 1166 "MagickCore/layer.c"
                                           )
              dup_image=DestroyImage(dup_image);
            return((Image *) 
# 1168 "MagickCore/layer.c" 3 4
                            ((void *)0)
# 1168 "MagickCore/layer.c"
                                );
          }
...
# 1259 "MagickCore/layer.c"
        ...
        if ( cleared ||
                  ...
                  +bounds[i].width*bounds[i].height )
          {
            ...
            bounds[i]=try_bounds;
            if ( disposals[i-1] == ((DisposeType)9) )
              dup_image=DestroyImage(dup_image);
    ...
    if ( disposals[i-1] == ((DisposeType)9) )
      {
         if (bgnd_image != (Image *) 
# 1298 "MagickCore/layer.c" 3 4
                                    ((void *)0)
# 1298 "MagickCore/layer.c"
                                        )
           bgnd_image=DestroyImage(bgnd_image);
         prev_image=DestroyImage(prev_image);
         prev_image=dup_image, dup_image=(Image *) 
# 1301 "MagickCore/layer.c" 3 4
                                                  ((void *)0)
# 1301 "MagickCore/layer.c"
                                                      ;
         bounds[i+1]=bounds[i];
         bounds[i]=dup_bounds;
         disposals[i-1]=((DisposeType)9);
      ...
      {
        if ( dup_image != (Image *) 
# 1310 "MagickCore/layer.c" 3 4
                                   ((void *)0)
# 1310 "MagickCore/layer.c"
                                       )
          dup_image=DestroyImage(dup_image);
        if ( disposals[i-1] != PreviousDispose )
          prev_image=DestroyImage(prev_image);
        if ( disposals[i-1] == BackgroundDispose )
          prev_image=bgnd_image, bgnd_image=(Image *) 
# 1315 "MagickCore/layer.c" 3 4
                                                     ((void *)0)
# 1315 "MagickCore/layer.c"
                                                         ;
        if (bgnd_image != (Image *) 
# 1316 "MagickCore/layer.c" 3 4
                                   ((void *)0)
# 1316 "MagickCore/layer.c"
                                       )
          bgnd_image=DestroyImage(bgnd_image);
        if ( disposals[i-1] == NoneDispose )
          {
            ...
            if (prev_image == (Image *) 
# 1321 "MagickCore/layer.c" 3 4
                                       ((void *)0)
# 1321 "MagickCore/layer.c"
                                           )
              {
                bounds=(RectangleInfo *) RelinquishMagickMemory(bounds);
                disposals=(DisposeType *) RelinquishMagickMemory(disposals);
                return((Image *) 
# 1325 "MagickCore/layer.c" 3 4
                                ((void *)0)
# 1325 "MagickCore/layer.c"
                                    );
              }
          }
...
# 1330 "MagickCore/layer.c" 3 4
   ((void) sizeof ((
# 1330 "MagickCore/layer.c"
   prev_image != (Image *) 
# 1330 "MagickCore/layer.c" 3 4
   ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1330 "MagickCore/layer.c"
...
# 1330 "MagickCore/layer.c" 3 4
   , "MagickCore/layer.c", 1330, __extension__ __PRETTY_FUNCTION__); }))
# 1330 "MagickCore/layer.c"
                                       ;
    disposals[i]=disposals[i-1];
# 1347 "MagickCore/layer.c"
    i++;
  }
  prev_image=DestroyImage(prev_image);
  ...
  while ( curr != (const Image *) 
# 1357 "MagickCore/layer.c" 3 4
                                 ((void *)0) 
# 1357 "MagickCore/layer.c"
                                      )
  {
    prev_image=CloneImage(curr,0,0,MagickTrue,exception);
    if (prev_image == (Image *) 
# 1360 "MagickCore/layer.c" 3 4
                               ((void *)0)
# 1360 "MagickCore/layer.c"
                                   )
      break;
    prev_image->background_color.alpha_trait=BlendPixelTrait;
    if ( disposals[i] == ((DisposeType)8) ) {
      size_t time = 0;
      while ( disposals[i] == ((DisposeType)8) ) {
    ...
    prev_image=DestroyImage(prev_image);
    if (bgnd_image == (Image *) 
# 1378 "MagickCore/layer.c" 3 4
                               ((void *)0)
# 1378 "MagickCore/layer.c"
                                   )
      break;
    bgnd_image->dispose=disposals[i];
    if ( disposals[i] == ((DisposeType)9) ) {
      bgnd_image->delay=0;
  ...
  disposals=(DisposeType *) RelinquishMagickMemory(disposals);
  if (curr != (Image *) 
# 1393 "MagickCore/layer.c" 3 4
                       ((void *)0)
# 1393 "MagickCore/layer.c"
                           )
    {
      optimized_image=DestroyImageList(optimized_image);
      return((Image *) 
# 1396 "MagickCore/layer.c" 3 4
                      ((void *)0)
# 1396 "MagickCore/layer.c"
                          );
    }
  return(GetFirstImageInList(optimized_image));
}
# 1429 "MagickCore/layer.c"
__attribute__ ((visibility ("default"))) Image *OptimizeImageLayers(const Image *image,
  ExceptionInfo *exception)
{
  return(OptimizeLayerFrames(image,OptimizeImageLayer,exception));
}
# 1462 "MagickCore/layer.c"
__attribute__ ((visibility ("default"))) Image *OptimizePlusImageLayers(const Image *image,
  ExceptionInfo *exception)
{
  return OptimizeLayerFrames(image,OptimizePlusLayer,exception);
}
# 1499 "MagickCore/layer.c"
__attribute__ ((visibility ("default"))) void OptimizeImageTransparency(const Image *image,
     ExceptionInfo *exception)
{
  Image
    *dispose_image;
...
# 1511 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1511 "MagickCore/layer.c"
 image != (Image *) 
# 1511 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1511 "MagickCore/layer.c"
...
# 1511 "MagickCore/layer.c"
 "image != (Image *) NULL"
# 1511 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1511, __extension__ __PRETTY_FUNCTION__); }))
# 1511 "MagickCore/layer.c"
                                ;
  
# 1512 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1512 "MagickCore/layer.c"
 image->signature == 0xabacadabUL
# 1512 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1512 "MagickCore/layer.c"
...
# 1512 "MagickCore/layer.c"
 "image->signature == MagickCoreSignature"
# 1512 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1512, __extension__ __PRETTY_FUNCTION__); }))
# 1512 "MagickCore/layer.c"
                                                ;
  
# 1513 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1513 "MagickCore/layer.c"
 exception != (ExceptionInfo *) 
# 1513 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1513 "MagickCore/layer.c"
...
# 1513 "MagickCore/layer.c"
 "exception != (ExceptionInfo *) NULL"
# 1513 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1513, __extension__ __PRETTY_FUNCTION__); }))
# 1513 "MagickCore/layer.c"
                                            ;
  
# 1514 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1514 "MagickCore/layer.c"
 exception->signature == 0xabacadabUL
# 1514 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1514 "MagickCore/layer.c"
...
# 1514 "MagickCore/layer.c"
 "exception->signature == MagickCoreSignature"
# 1514 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1514, __extension__ __PRETTY_FUNCTION__); }))
# 1514 "MagickCore/layer.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/layer.c",__func__,(unsigned long) 1516,"%s",image->filename);
  next=GetFirstImageInList(image);
  dispose_image=CloneImage(next,next->page.width,next->page.height,
    MagickTrue,exception);
  if (dispose_image == (Image *) 
# 1520 "MagickCore/layer.c" 3 4
                                ((void *)0)
# 1520 "MagickCore/layer.c"
                                    )
    return;
  ...
  while ( next != (Image *) 
# 1530 "MagickCore/layer.c" 3 4
                           ((void *)0) 
# 1530 "MagickCore/layer.c"
                                )
  {
    Image
      *current_image;
    ...
    current_image=CloneImage(dispose_image,0,0,MagickTrue,exception);
    if (current_image == (Image *) 
# 1539 "MagickCore/layer.c" 3 4
                                  ((void *)0)
# 1539 "MagickCore/layer.c"
                                      )
      {
        dispose_image=DestroyImage(dispose_image);
        return;
    ...
    next=GetNextImageInList(next);
    if (next != (Image *) 
# 1588 "MagickCore/layer.c" 3 4
                         ((void *)0)
# 1588 "MagickCore/layer.c"
                             )
...
# 1627 "MagickCore/layer.c"
__attribute__ ((visibility ("default"))) void RemoveDuplicateLayers(Image **images,ExceptionInfo *exception)
{
  RectangleInfo
    bounds;
...
# 1636 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1636 "MagickCore/layer.c"
 (*images) != (const Image *) 
# 1636 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1636 "MagickCore/layer.c"
...
# 1636 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1636, __extension__ __PRETTY_FUNCTION__); }))
# 1636 "MagickCore/layer.c"
                                          ;
  
# 1637 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1637 "MagickCore/layer.c"
 (*images)->signature == 0xabacadabUL
# 1637 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1637 "MagickCore/layer.c"
...
# 1637 "MagickCore/layer.c"
 "(*images)->signature == MagickCoreSignature"
# 1637 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1637, __extension__ __PRETTY_FUNCTION__); }))
# 1637 "MagickCore/layer.c"
                                                    ;
  
# 1638 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1638 "MagickCore/layer.c"
 exception != (ExceptionInfo *) 
# 1638 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1638 "MagickCore/layer.c"
...
# 1638 "MagickCore/layer.c"
 "exception != (ExceptionInfo *) NULL"
# 1638 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1638, __extension__ __PRETTY_FUNCTION__); }))
# 1638 "MagickCore/layer.c"
                                            ;
  
# 1639 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1639 "MagickCore/layer.c"
 exception->signature == 0xabacadabUL
# 1639 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1639 "MagickCore/layer.c"
...
# 1639 "MagickCore/layer.c"
 "exception->signature == MagickCoreSignature"
# 1639 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1639, __extension__ __PRETTY_FUNCTION__); }))
# 1639 "MagickCore/layer.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/layer.c",__func__,(unsigned long) 1641,"%s",
      (*images)->filename);
  image=GetFirstImageInList(*images);
  for ( ; (next=GetNextImageInList(image)) != (Image *) 
# 1644 "MagickCore/layer.c" 3 4
                                                       ((void *)0)
# 1644 "MagickCore/layer.c"
                                                           ; image=next)
  {
...
# 1712 "MagickCore/layer.c"
__attribute__ ((visibility ("default"))) void RemoveZeroDelayLayers(Image **images,
     ExceptionInfo *exception)
{
  Image
    *i;
...
# 1718 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1718 "MagickCore/layer.c"
 (*images) != (const Image *) 
# 1718 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1718 "MagickCore/layer.c"
...
# 1718 "MagickCore/layer.c"
 "(*images) != (const Image *) NULL"
# 1718 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1718, __extension__ __PRETTY_FUNCTION__); }))
# 1718 "MagickCore/layer.c"
                                          ;
  
# 1719 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1719 "MagickCore/layer.c"
 (*images)->signature == 0xabacadabUL
# 1719 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1719 "MagickCore/layer.c"
...
# 1719 "MagickCore/layer.c"
 "(*images)->signature == MagickCoreSignature"
# 1719 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1719, __extension__ __PRETTY_FUNCTION__); }))
# 1719 "MagickCore/layer.c"
                                                    ;
  
# 1720 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1720 "MagickCore/layer.c"
 exception != (ExceptionInfo *) 
# 1720 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1720 "MagickCore/layer.c"
...
# 1720 "MagickCore/layer.c"
 "exception != (ExceptionInfo *) NULL"
# 1720 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1720, __extension__ __PRETTY_FUNCTION__); }))
# 1720 "MagickCore/layer.c"
                                            ;
  
# 1721 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1721 "MagickCore/layer.c"
 exception->signature == 0xabacadabUL
# 1721 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1721 "MagickCore/layer.c"
...
# 1721 "MagickCore/layer.c"
 "exception->signature == MagickCoreSignature"
# 1721 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1721, __extension__ __PRETTY_FUNCTION__); }))
# 1721 "MagickCore/layer.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/layer.c",__func__,(unsigned long) 1723,"%s",
      (*images)->filename);
  i=GetFirstImageInList(*images);
  for ( ; i != (Image *) 
# 1726 "MagickCore/layer.c" 3 4
                        ((void *)0)
# 1726 "MagickCore/layer.c"
                            ; i=GetNextImageInList(i))
    if ( i->delay != 0L ) break;
  if ( i == (Image *) 
# 1728 "MagickCore/layer.c" 3 4
                     ((void *)0) 
# 1728 "MagickCore/layer.c"
                          ) {
    (void) ThrowMagickException(exception,"MagickCore/layer.c",__func__,(unsigned long) 1729,OptionWarning,
       "ZeroTimeAnimation","`%s'",GetFirstImageInList(*images)->filename);
    return;
  }
  i=GetFirstImageInList(*images);
  while ( i != (Image *) 
# 1734 "MagickCore/layer.c" 3 4
                        ((void *)0) 
# 1734 "MagickCore/layer.c"
                             )
  {
    if ( i->delay == 0L ) {
  ...
  ssize_t y_offset,ExceptionInfo *exception)
{
  ...
  (void) CompositeImage(destination,source,compose,
    (value != (const char *) 
# 1813 "MagickCore/layer.c" 3 4
                            ((void *)0)
# 1813 "MagickCore/layer.c"
                                ) && (IsStringTrue(value) != MagickFalse) ?
    MagickFalse : MagickTrue,x_offset,y_offset,exception);
}

__attribute__ ((visibility ("default"))) void CompositeLayers(Image *destination,
  const CompositeOperator compose, Image *source,const ssize_t x_offset,
  const ssize_t y_offset,ExceptionInfo *exception)
{
  
# 1821 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1821 "MagickCore/layer.c"
 destination != (Image *) 
# 1821 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1821 "MagickCore/layer.c"
...
# 1821 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1821, __extension__ __PRETTY_FUNCTION__); }))
# 1821 "MagickCore/layer.c"
                                      ;
  
# 1822 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1822 "MagickCore/layer.c"
...
# 1822 "MagickCore/layer.c"
 "destination->signature == MagickCoreSignature"
# 1822 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1822, __extension__ __PRETTY_FUNCTION__); }))
# 1822 "MagickCore/layer.c"
                                                      ;
  
# 1823 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1823 "MagickCore/layer.c"
 source != (Image *) 
# 1823 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1823 "MagickCore/layer.c"
...
# 1823 "MagickCore/layer.c"
 "source != (Image *) NULL"
# 1823 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1823, __extension__ __PRETTY_FUNCTION__); }))
# 1823 "MagickCore/layer.c"
                                 ;
  
# 1824 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1824 "MagickCore/layer.c"
...
# 1824 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1824, __extension__ __PRETTY_FUNCTION__); }))
# 1824 "MagickCore/layer.c"
                                                 ;
  
# 1825 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1825 "MagickCore/layer.c"
 exception != (ExceptionInfo *) 
# 1825 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1825 "MagickCore/layer.c"
...
# 1825 "MagickCore/layer.c"
 "exception != (ExceptionInfo *) NULL"
# 1825 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1825, __extension__ __PRETTY_FUNCTION__); }))
# 1825 "MagickCore/layer.c"
                                            ;
  
# 1826 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1826 "MagickCore/layer.c"
 exception->signature == 0xabacadabUL
# 1826 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1826 "MagickCore/layer.c"
...
# 1826 "MagickCore/layer.c"
 "exception->signature == MagickCoreSignature"
# 1826 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1826, __extension__ __PRETTY_FUNCTION__); }))
# 1826 "MagickCore/layer.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/layer.c",__func__,(unsigned long) 1828,"%s - %s",
      source->filename,destination->filename);



  if ( source->next == (Image *) 
# 1833 "MagickCore/layer.c" 3 4
                                ((void *)0) 
# 1833 "MagickCore/layer.c"
                                     )
    while ( destination != (Image *) 
# 1834 "MagickCore/layer.c" 3 4
                                    ((void *)0) 
# 1834 "MagickCore/layer.c"
                                         )
    {
...
# 1848 "MagickCore/layer.c"
  else if ( destination->next == (Image *) 
# 1848 "MagickCore/layer.c" 3 4
                                          ((void *)0) 
# 1848 "MagickCore/layer.c"
                                               )
  {
    ...
    if (dest != (Image *) 
# 1852 "MagickCore/layer.c" 3 4
                         ((void *)0)
# 1852 "MagickCore/layer.c"
                             )
      {
        ...
        if ( source->next != (Image *) 
# 1858 "MagickCore/layer.c" 3 4
                                      ((void *)0) 
# 1858 "MagickCore/layer.c"
                                           )
          {
        ...
        while (source != (Image *) 
# 1864 "MagickCore/layer.c" 3 4
                                  ((void *)0)
# 1864 "MagickCore/layer.c"
                                      )
        {
    ...
    while ( source != (Image *) 
# 1885 "MagickCore/layer.c" 3 4
                               ((void *)0) 
# 1885 "MagickCore/layer.c"
                                    && destination != (Image *) 
# 1885 "MagickCore/layer.c" 3 4
                                                                ((void *)0) 
# 1885 "MagickCore/layer.c"
...
# 1947 "MagickCore/layer.c"
__attribute__ ((visibility ("default"))) Image *MergeImageLayers(Image *image,const LayerMethod method,
  ExceptionInfo *exception)
{
...
# 1972 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1972 "MagickCore/layer.c"
 image != (Image *) 
# 1972 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1972 "MagickCore/layer.c"
...
# 1972 "MagickCore/layer.c"
 "image != (Image *) NULL"
# 1972 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1972, __extension__ __PRETTY_FUNCTION__); }))
# 1972 "MagickCore/layer.c"
                                ;
  
# 1973 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1973 "MagickCore/layer.c"
 image->signature == 0xabacadabUL
# 1973 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1973 "MagickCore/layer.c"
...
# 1973 "MagickCore/layer.c"
 "image->signature == MagickCoreSignature"
# 1973 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1973, __extension__ __PRETTY_FUNCTION__); }))
# 1973 "MagickCore/layer.c"
                                                ;
  
# 1974 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1974 "MagickCore/layer.c"
 exception != (ExceptionInfo *) 
# 1974 "MagickCore/layer.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1974 "MagickCore/layer.c"
...
# 1974 "MagickCore/layer.c"
 "exception != (ExceptionInfo *) NULL"
# 1974 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1974, __extension__ __PRETTY_FUNCTION__); }))
# 1974 "MagickCore/layer.c"
                                            ;
  
# 1975 "MagickCore/layer.c" 3 4
 ((void) sizeof ((
# 1975 "MagickCore/layer.c"
 exception->signature == 0xabacadabUL
# 1975 "MagickCore/layer.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1975 "MagickCore/layer.c"
...
# 1975 "MagickCore/layer.c"
 "exception->signature == MagickCoreSignature"
# 1975 "MagickCore/layer.c" 3 4
 , "MagickCore/layer.c", 1975, __extension__ __PRETTY_FUNCTION__); }))
# 1975 "MagickCore/layer.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/layer.c",__func__,(unsigned long) 1977,"%s",image->filename);
  ...
  switch (method)
  {
    ...
    default:
    {
      ...
      for ( ; next != (Image *) 
# 1991 "MagickCore/layer.c" 3 4
                               ((void *)0)
# 1991 "MagickCore/layer.c"
                                   ; next=GetNextImageInList(next))
      {
...
# 2026 "MagickCore/layer.c" 3 4
                                        ((void *)0)
# 2026 "MagickCore/layer.c"
                                            ; next=GetNextImageInList(next))
      {
  ...
  if (method == TrimBoundsLayer)
    {
      ...
      for (scene=0; scene < (ssize_t) number_images; scene++)
      {
        ...
        proceed=SetImageProgress(image,"Merge/Layers",(MagickOffsetType) scene,
          number_images);
        if (proceed == MagickFalse)
          break;
        image=GetNextImageInList(image);
        if (image == (Image *) 
# 2064 "MagickCore/layer.c" 3 4
                              ((void *)0)
# 2064 "MagickCore/layer.c"
                                  )
          break;
      }
      return((Image *) 
# 2067 "MagickCore/layer.c" 3 4
                      ((void *)0)
# 2067 "MagickCore/layer.c"
                          );
    }
  ...
  if (canvas == (Image *) 
# 2073 "MagickCore/layer.c" 3 4
                         ((void *)0)
# 2073 "MagickCore/layer.c"
                             )
    return((Image *) 
# 2074 "MagickCore/layer.c" 3 4
                    ((void *)0)
# 2074 "MagickCore/layer.c"
                        );
  ...
  for (scene=0; scene < (ssize_t) number_images; scene++)
  {
    ...
    image=GetNextImageInList(image);
    if (image == (Image *) 
# 2092 "MagickCore/layer.c" 3 4
                          ((void *)0)
# 2092 "MagickCore/layer.c"
                              )
      break;
  }
  return(canvas);
