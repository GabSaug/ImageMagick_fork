# 0 "MagickCore/compress.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/compress.c"
# 43 "MagickCore/compress.c"
...
# 100 "MagickCore/compress.c"
static const HuffmanTable
  MBTable[]=
  {
    { 26L, 0x0f, 10, 64 }, { 26L, 0xc8, 12, 128 },
    { 26L, 0xc9, 12, 192 }, { 26L, 0x5b, 12, 256 },
    { 26L, 0x33, 12, 320 }, { 26L, 0x34, 12, 384 },
    { 26L, 0x35, 12, 448 }, { 26L, 0x6c, 13, 512 },
    { 26L, 0x6d, 13, 576 }, { 26L, 0x4a, 13, 640 },
    { 26L, 0x4b, 13, 704 }, { 26L, 0x4c, 13, 768 },
    { 26L, 0x4d, 13, 832 }, { 26L, 0x72, 13, 896 },
    { 26L, 0x73, 13, 960 }, { 26L, 0x74, 13, 1024 },
    { 26L, 0x75, 13, 1088 }, { 26L, 0x76, 13, 1152 },
    { 26L, 0x77, 13, 1216 }, { 26L, 0x52, 13, 1280 },
    { 26L, 0x53, 13, 1344 }, { 26L, 0x54, 13, 1408 },
    { 26L, 0x55, 13, 1472 }, { 26L, 0x5a, 13, 1536 },
    { 26L, 0x5b, 13, 1600 }, { 26L, 0x64, 13, 1664 },
    { 26L, 0x65, 13, 1728 }, { 26L, 0x00, 0, 0 }
  };

static const HuffmanTable
  EXTable[]=
  {
    { 27L, 0x08, 11, 1792 }, { 27L, 0x0c, 11, 1856 },
    { 27L, 0x0d, 11, 1920 }, { 27L, 0x12, 12, 1984 },
    { 27L, 0x13, 12, 2048 }, { 27L, 0x14, 12, 2112 },
    { 27L, 0x15, 12, 2176 }, { 27L, 0x16, 12, 2240 },
    { 27L, 0x17, 12, 2304 }, { 27L, 0x1c, 12, 2368 },
    { 27L, 0x1d, 12, 2432 }, { 27L, 0x1e, 12, 2496 },
    { 27L, 0x1f, 12, 2560 }, { 27L, 0x00, 0, 0 }
  };

static const HuffmanTable
  MWTable[]=
  {
    { 24L, 0x1b, 5, 64 }, { 24L, 0x12, 5, 128 },
    { 24L, 0x17, 6, 192 }, { 24L, 0x37, 7, 256 },
    { 24L, 0x36, 8, 320 }, { 24L, 0x37, 8, 384 },
    { 24L, 0x64, 8, 448 }, { 24L, 0x65, 8, 512 },
    { 24L, 0x68, 8, 576 }, { 24L, 0x67, 8, 640 },
    { 24L, 0xcc, 9, 704 }, { 24L, 0xcd, 9, 768 },
    { 24L, 0xd2, 9, 832 }, { 24L, 0xd3, 9, 896 },
    { 24L, 0xd4, 9, 960 }, { 24L, 0xd5, 9, 1024 },
    { 24L, 0xd6, 9, 1088 }, { 24L, 0xd7, 9, 1152 },
    { 24L, 0xd8, 9, 1216 }, { 24L, 0xd9, 9, 1280 },
    { 24L, 0xda, 9, 1344 }, { 24L, 0xdb, 9, 1408 },
    { 24L, 0x98, 9, 1472 }, { 24L, 0x99, 9, 1536 },
    { 24L, 0x9a, 9, 1600 }, { 24L, 0x18, 6, 1664 },
    { 24L, 0x9b, 9, 1728 }, { 24L, 0x00, 0, 0 }
  };

static const HuffmanTable
  TBTable[]=
  {
    { 25L, 0x37, 10, 0 }, { 25L, 0x02, 3, 1 }, { 25L, 0x03, 2, 2 },
    { 25L, 0x02, 2, 3 }, { 25L, 0x03, 3, 4 }, { 25L, 0x03, 4, 5 },
    { 25L, 0x02, 4, 6 }, { 25L, 0x03, 5, 7 }, { 25L, 0x05, 6, 8 },
    { 25L, 0x04, 6, 9 }, { 25L, 0x04, 7, 10 }, { 25L, 0x05, 7, 11 },
    { 25L, 0x07, 7, 12 }, { 25L, 0x04, 8, 13 }, { 25L, 0x07, 8, 14 },
    { 25L, 0x18, 9, 15 }, { 25L, 0x17, 10, 16 }, { 25L, 0x18, 10, 17 },
    { 25L, 0x08, 10, 18 }, { 25L, 0x67, 11, 19 }, { 25L, 0x68, 11, 20 },
    { 25L, 0x6c, 11, 21 }, { 25L, 0x37, 11, 22 }, { 25L, 0x28, 11, 23 },
    { 25L, 0x17, 11, 24 }, { 25L, 0x18, 11, 25 }, { 25L, 0xca, 12, 26 },
    { 25L, 0xcb, 12, 27 }, { 25L, 0xcc, 12, 28 }, { 25L, 0xcd, 12, 29 },
    { 25L, 0x68, 12, 30 }, { 25L, 0x69, 12, 31 }, { 25L, 0x6a, 12, 32 },
    { 25L, 0x6b, 12, 33 }, { 25L, 0xd2, 12, 34 }, { 25L, 0xd3, 12, 35 },
    { 25L, 0xd4, 12, 36 }, { 25L, 0xd5, 12, 37 }, { 25L, 0xd6, 12, 38 },
    { 25L, 0xd7, 12, 39 }, { 25L, 0x6c, 12, 40 }, { 25L, 0x6d, 12, 41 },
    { 25L, 0xda, 12, 42 }, { 25L, 0xdb, 12, 43 }, { 25L, 0x54, 12, 44 },
    { 25L, 0x55, 12, 45 }, { 25L, 0x56, 12, 46 }, { 25L, 0x57, 12, 47 },
    { 25L, 0x64, 12, 48 }, { 25L, 0x65, 12, 49 }, { 25L, 0x52, 12, 50 },
    { 25L, 0x53, 12, 51 }, { 25L, 0x24, 12, 52 }, { 25L, 0x37, 12, 53 },
    { 25L, 0x38, 12, 54 }, { 25L, 0x27, 12, 55 }, { 25L, 0x28, 12, 56 },
    { 25L, 0x58, 12, 57 }, { 25L, 0x59, 12, 58 }, { 25L, 0x2b, 12, 59 },
    { 25L, 0x2c, 12, 60 }, { 25L, 0x5a, 12, 61 }, { 25L, 0x66, 12, 62 },
    { 25L, 0x67, 12, 63 }, { 25L, 0x00, 0, 0 }
  };

static const HuffmanTable
  TWTable[]=
  {
    { 23L, 0x35, 8, 0 }, { 23L, 0x07, 6, 1 }, { 23L, 0x07, 4, 2 },
    { 23L, 0x08, 4, 3 }, { 23L, 0x0b, 4, 4 }, { 23L, 0x0c, 4, 5 },
    { 23L, 0x0e, 4, 6 }, { 23L, 0x0f, 4, 7 }, { 23L, 0x13, 5, 8 },
    { 23L, 0x14, 5, 9 }, { 23L, 0x07, 5, 10 }, { 23L, 0x08, 5, 11 },
    { 23L, 0x08, 6, 12 }, { 23L, 0x03, 6, 13 }, { 23L, 0x34, 6, 14 },
    { 23L, 0x35, 6, 15 }, { 23L, 0x2a, 6, 16 }, { 23L, 0x2b, 6, 17 },
    { 23L, 0x27, 7, 18 }, { 23L, 0x0c, 7, 19 }, { 23L, 0x08, 7, 20 },
    { 23L, 0x17, 7, 21 }, { 23L, 0x03, 7, 22 }, { 23L, 0x04, 7, 23 },
    { 23L, 0x28, 7, 24 }, { 23L, 0x2b, 7, 25 }, { 23L, 0x13, 7, 26 },
    { 23L, 0x24, 7, 27 }, { 23L, 0x18, 7, 28 }, { 23L, 0x02, 8, 29 },
    { 23L, 0x03, 8, 30 }, { 23L, 0x1a, 8, 31 }, { 23L, 0x1b, 8, 32 },
    { 23L, 0x12, 8, 33 }, { 23L, 0x13, 8, 34 }, { 23L, 0x14, 8, 35 },
    { 23L, 0x15, 8, 36 }, { 23L, 0x16, 8, 37 }, { 23L, 0x17, 8, 38 },
    { 23L, 0x28, 8, 39 }, { 23L, 0x29, 8, 40 }, { 23L, 0x2a, 8, 41 },
    { 23L, 0x2b, 8, 42 }, { 23L, 0x2c, 8, 43 }, { 23L, 0x2d, 8, 44 },
    { 23L, 0x04, 8, 45 }, { 23L, 0x05, 8, 46 }, { 23L, 0x0a, 8, 47 },
    { 23L, 0x0b, 8, 48 }, { 23L, 0x52, 8, 49 }, { 23L, 0x53, 8, 50 },
    { 23L, 0x54, 8, 51 }, { 23L, 0x55, 8, 52 }, { 23L, 0x24, 8, 53 },
    { 23L, 0x25, 8, 54 }, { 23L, 0x58, 8, 55 }, { 23L, 0x59, 8, 56 },
    { 23L, 0x5a, 8, 57 }, { 23L, 0x5b, 8, 58 }, { 23L, 0x4a, 8, 59 },
    { 23L, 0x4b, 8, 60 }, { 23L, 0x32, 8, 61 }, { 23L, 0x33, 8, 62 },
    { 23L, 0x34, 8, 63 }, { 23L, 0x00, 0, 0 }
  };
# 231 "MagickCore/compress.c"
...
__attribute__ ((visibility ("default"))) void Ascii85Initialize(Image *image)
{



  if (image->ascii85 == (Ascii85Info *) 
# 267 "MagickCore/compress.c" 3 4
                                       ((void *)0)
# 267 "MagickCore/compress.c"
                                           )
    image->ascii85=(Ascii85Info *) AcquireMagickMemory(sizeof(*image->ascii85));
  if (image->ascii85 == (Ascii85Info *) 
# 269 "MagickCore/compress.c" 3 4
                                       ((void *)0)
# 269 "MagickCore/compress.c"
                                           )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 270 "MagickCore/compress.c" 3 4
   (*__errno_location ())
# 270 "MagickCore/compress.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/compress.c",__func__,(unsigned long) 270,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  (void) memset(image->ascii85,0,sizeof(*image->ascii85));
  image->ascii85->line_break=(ssize_t) (36L << 1);
  image->ascii85->offset=0;
}

__attribute__ ((visibility ("default"))) void Ascii85Flush(Image *image)
{
  
# 278 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 278 "MagickCore/compress.c"
 image != (Image *) 
# 278 "MagickCore/compress.c" 3 4
...
# 278 "MagickCore/compress.c"
 "image != (Image *) NULL"
# 278 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 278, __extension__ __PRETTY_FUNCTION__); }))
# 278 "MagickCore/compress.c"
                                ;
  
# 279 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 279 "MagickCore/compress.c"
...
# 279 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 279, __extension__ __PRETTY_FUNCTION__); }))
# 279 "MagickCore/compress.c"
                                                ;
  
# 280 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 280 "MagickCore/compress.c"
...
# 280 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 280, __extension__ __PRETTY_FUNCTION__); }))
# 280 "MagickCore/compress.c"
                                               ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/compress.c",__func__,(unsigned long) 282,"%s",image->filename);
...
__attribute__ ((visibility ("default"))) void Ascii85Encode(Image *image,const unsigned char code)
{
  char
    *q;
...
# 309 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 309 "MagickCore/compress.c"
 image != (Image *) 
# 309 "MagickCore/compress.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 309 "MagickCore/compress.c"
...
# 309 "MagickCore/compress.c"
 "image != (Image *) NULL"
# 309 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 309, __extension__ __PRETTY_FUNCTION__); }))
# 309 "MagickCore/compress.c"
                                ;
  
# 310 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 310 "MagickCore/compress.c"
 image->signature == 0xabacadabUL
# 310 "MagickCore/compress.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 310 "MagickCore/compress.c"
...
# 310 "MagickCore/compress.c"
 "image->signature == MagickCoreSignature"
# 310 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 310, __extension__ __PRETTY_FUNCTION__); }))
# 310 "MagickCore/compress.c"
                                                ;
  
# 311 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 311 "MagickCore/compress.c"
 image->ascii85 != (Ascii85Info *) 
# 311 "MagickCore/compress.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 311 "MagickCore/compress.c"
...
# 311 "MagickCore/compress.c"
 "image->ascii85 != (Ascii85Info *) NULL"
# 311 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 311, __extension__ __PRETTY_FUNCTION__); }))
# 311 "MagickCore/compress.c"
                                               ;
  ...
  for (n=image->ascii85->offset; n >= 4; n-=4)
  {
    ...
    for (q=image->ascii85->tuple; *q != '\0'; q++)
    {
      ...
      if ((image->ascii85->line_break < 0) && (*q != '%'))
        {
          (void) WriteBlobByte(image,'\n');
          image->ascii85->line_break=2*36L;
        }
...
# 363 "MagickCore/compress.c"
__attribute__ ((visibility ("default"))) MagickBooleanType HuffmanDecodeImage(Image *image,
  ExceptionInfo *exception)
{
# 398 "MagickCore/compress.c"
  CacheView
    *image_view;
...
# 441 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 441 "MagickCore/compress.c"
 image != (Image *) 
# 441 "MagickCore/compress.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 441 "MagickCore/compress.c"
...
# 441 "MagickCore/compress.c"
 "image != (Image *) NULL"
# 441 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 441, __extension__ __PRETTY_FUNCTION__); }))
# 441 "MagickCore/compress.c"
                                ;
  
# 442 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 442 "MagickCore/compress.c"
 image->signature == 0xabacadabUL
# 442 "MagickCore/compress.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 442 "MagickCore/compress.c"
...
# 442 "MagickCore/compress.c"
 "image->signature == MagickCoreSignature"
# 442 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 442, __extension__ __PRETTY_FUNCTION__); }))
# 442 "MagickCore/compress.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/compress.c",__func__,(unsigned long) 444,"%s",image->filename);
  if (image->blob == (BlobInfo *) 
# 445 "MagickCore/compress.c" 3 4
                                 ((void *)0)
# 445 "MagickCore/compress.c"
                                     )
    { (void) ThrowMagickException(exception,"MagickCore/compress.c",__func__,(unsigned long) 446,BlobError,"UnableToOpenBlob", "`%s'",image->filename); return(MagickFalse); };
  mb_hash=(HuffmanTable **) AcquireQuantumMemory(1021L,sizeof(*mb_hash));
  mw_hash=(HuffmanTable **) AcquireQuantumMemory(1021L,sizeof(*mw_hash));
  scanline=(unsigned char *) AcquireQuantumMemory((size_t) image->columns,
    sizeof(*scanline));
  if ((mb_hash == (HuffmanTable **) 
# 451 "MagickCore/compress.c" 3 4
                                   ((void *)0)
# 451 "MagickCore/compress.c"
                                       ) ||
      (mw_hash == (HuffmanTable **) 
# 452 "MagickCore/compress.c" 3 4
                                   ((void *)0)
# 452 "MagickCore/compress.c"
                                       ) ||
      (scanline == (unsigned char *) 
# 453 "MagickCore/compress.c" 3 4
                                    ((void *)0)
# 453 "MagickCore/compress.c"
                                        ))
    {
      if (mb_hash != (HuffmanTable **) 
# 455 "MagickCore/compress.c" 3 4
                                      ((void *)0)
# 455 "MagickCore/compress.c"
                                          )
        mb_hash=(HuffmanTable **) RelinquishMagickMemory(mb_hash);
      if (mw_hash != (HuffmanTable **) 
# 457 "MagickCore/compress.c" 3 4
                                      ((void *)0)
# 457 "MagickCore/compress.c"
                                          )
        mw_hash=(HuffmanTable **) RelinquishMagickMemory(mw_hash);
      if (scanline != (unsigned char *) 
# 459 "MagickCore/compress.c" 3 4
                                       ((void *)0)
# 459 "MagickCore/compress.c"
                                           )
        scanline=(unsigned char *) RelinquishMagickMemory(scanline);
      { (void) ThrowMagickException(exception,"MagickCore/compress.c",__func__,(unsigned long) 461,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  ...
  for (i=0; i < 1021L; i++)
  {
    mb_hash[i]=(HuffmanTable *) 
# 469 "MagickCore/compress.c" 3 4
                               ((void *)0)
# 469 "MagickCore/compress.c"
                                   ;
    mw_hash[i]=(HuffmanTable *) 
# 470 "MagickCore/compress.c" 3 4
                               ((void *)0)
# 470 "MagickCore/compress.c"
                                   ;
  }
  { entry=TWTable; while (entry->code != 0) { mw_hash[((entry->length+3510L)*(entry->code+1178L)) % 1021L]=(HuffmanTable *) entry; entry++; } };
  { entry=MWTable; while (entry->code != 0) { mw_hash[((entry->length+3510L)*(entry->code+1178L)) % 1021L]=(HuffmanTable *) entry; entry++; } };
  { entry=EXTable; while (entry->code != 0) { mw_hash[((entry->length+3510L)*(entry->code+1178L)) % 1021L]=(HuffmanTable *) entry; entry++; } };
  { entry=TBTable; while (entry->code != 0) { mb_hash[((entry->length+293L)*(entry->code+2695L)) % 1021L]=(HuffmanTable *) entry; entry++; } };
  { entry=MBTable; while (entry->code != 0) { mb_hash[((entry->length+293L)*(entry->code+2695L)) % 1021L]=(HuffmanTable *) entry; entry++; } };
  { entry=EXTable; while (entry->code != 0) { mb_hash[((entry->length+293L)*(entry->code+2695L)) % 1021L]=(HuffmanTable *) entry; entry++; } };
  ...
  runlength=0;
  while (runlength < 11)
   { if ((mask & 0xff) == 0) { byte=ReadBlobByte(image); if (byte == 
# 486 "MagickCore/compress.c" 3 4
  (-1)
# 486 "MagickCore/compress.c"
  ) break; mask=0x80; } runlength++; bit=(size_t) ((byte & mask) != 0 ? 0x01 : 0x00); mask>>=1; if (bit != 0) runlength=0; };
  do { { if ((mask & 0xff) == 0) { byte=ReadBlobByte(image); if (byte == 
# 487 "MagickCore/compress.c" 3 4
      (-1)
# 487 "MagickCore/compress.c"
      ) break; mask=0x80; } runlength++; bit=(size_t) ((byte & mask) != 0 ? 0x01 : 0x00); mask>>=1; if (bit != 0) runlength=0; }; } while ((int) bit == 0);
  ...
  for (y=0; ((y < (ssize_t) image->rows) && (null_lines < 3)); )
  {
    ...
    {
      if (byte == 
# 515 "MagickCore/compress.c" 3 4
                 (-1)
# 515 "MagickCore/compress.c"
                    )
        break;
      if (x >= (ssize_t) image->columns)
        {
          while (runlength < 11)
            { if ((mask & 0xff) == 0) { byte=ReadBlobByte(image); if (byte == 
# 520 "MagickCore/compress.c" 3 4
           (-1)
# 520 "MagickCore/compress.c"
           ) break; mask=0x80; } runlength++; bit=(size_t) ((byte & mask) != 0 ? 0x01 : 0x00); mask>>=1; if (bit != 0) runlength=0; };
          do { { if ((mask & 0xff) == 0) { byte=ReadBlobByte(image); if (byte == 
# 521 "MagickCore/compress.c" 3 4
              (-1)
# 521 "MagickCore/compress.c"
              ) break; mask=0x80; } runlength++; bit=(size_t) ((byte & mask) != 0 ? 0x01 : 0x00); mask>>=1; if (bit != 0) runlength=0; }; } while ((int) bit == 0);
          break;
        }
      bail=MagickFalse;
      do
      {
        if (runlength < 11)
          { if ((mask & 0xff) == 0) { byte=ReadBlobByte(image); if (byte == 
# 528 "MagickCore/compress.c" 3 4
         (-1)
# 528 "MagickCore/compress.c"
         ) break; mask=0x80; } runlength++; bit=(size_t) ((byte & mask) != 0 ? 0x01 : 0x00); mask>>=1; if (bit != 0) runlength=0; }
        else
          {
            { if ((mask & 0xff) == 0) { byte=ReadBlobByte(image); if (byte == 
# 531 "MagickCore/compress.c" 3 4
           (-1)
# 531 "MagickCore/compress.c"
           ) break; mask=0x80; } runlength++; bit=(size_t) ((byte & mask) != 0 ? 0x01 : 0x00); mask>>=1; if (bit != 0) runlength=0; };
            if ((int) bit != 0)
              {
                null_lines++;
      ...
      if (length > 13)
        {
          while (runlength < 11)
            { if ((mask & 0xff) == 0) { byte=ReadBlobByte(image); if (byte == 
# 549 "MagickCore/compress.c" 3 4
           (-1)
# 549 "MagickCore/compress.c"
           ) break; mask=0x80; } runlength++; bit=(size_t) ((byte & mask) != 0 ? 0x01 : 0x00); mask>>=1; if (bit != 0) runlength=0; };
          do { { if ((mask & 0xff) == 0) { byte=ReadBlobByte(image); if (byte == 
# 550 "MagickCore/compress.c" 3 4
              (-1)
# 550 "MagickCore/compress.c"
              ) break; mask=0x80; } runlength++; bit=(size_t) ((byte & mask) != 0 ? 0x01 : 0x00); mask>>=1; if (bit != 0) runlength=0; }; } while ((int) bit == 0);
          break;
        }
      if (color != MagickFalse)
        {
          if (length < 4)
            continue;
          entry=mw_hash[((length+3510L)*(code+1178L)) % 1021L];
        }
      else
        {
          if (length < 2)
            continue;
          entry=mb_hash[((length+293L)*(code+2695L)) % 1021L];
        }
      if (entry == (const HuffmanTable *) 
# 565 "MagickCore/compress.c" 3 4
                                         ((void *)0)
# 565 "MagickCore/compress.c"
                                             )
        continue;
    ...
    if (q == (Quantum *) 
# 611 "MagickCore/compress.c" 3 4
                        ((void *)0)
# 611 "MagickCore/compress.c"
                            )
      break;
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      break;
    proceed=SetImageProgress(image,"Load/Image",(MagickOffsetType) y,
      image->rows);
  ...
  image->rows=(size_t) ((((size_t) y-3) > (1)) ? ((size_t) y-3) : (1));
...
# 669 "MagickCore/compress.c"
__attribute__ ((visibility ("default"))) MagickBooleanType HuffmanEncodeImage(const ImageInfo *image_info,
  Image *image,Image *inject_image,ExceptionInfo *exception)
{
# 700 "MagickCore/compress.c"
  const HuffmanTable
    *entry;
...
# 740 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 740 "MagickCore/compress.c"
...
# 740 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 740, __extension__ __PRETTY_FUNCTION__); }))
# 740 "MagickCore/compress.c"
                                         ;
  
# 741 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 741 "MagickCore/compress.c"
...
# 741 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 741, __extension__ __PRETTY_FUNCTION__); }))
# 741 "MagickCore/compress.c"
                                                     ;
  
# 742 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 742 "MagickCore/compress.c"
 image != (Image *) 
# 742 "MagickCore/compress.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 742 "MagickCore/compress.c"
...
# 742 "MagickCore/compress.c"
 "image != (Image *) NULL"
# 742 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 742, __extension__ __PRETTY_FUNCTION__); }))
# 742 "MagickCore/compress.c"
                                ;
  
# 743 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 743 "MagickCore/compress.c"
 image->signature == 0xabacadabUL
# 743 "MagickCore/compress.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 743 "MagickCore/compress.c"
...
# 743 "MagickCore/compress.c"
 "image->signature == MagickCoreSignature"
# 743 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 743, __extension__ __PRETTY_FUNCTION__); }))
# 743 "MagickCore/compress.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/compress.c",__func__,(unsigned long) 745,"%s",image->filename);
  
# 746 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 746 "MagickCore/compress.c"
 inject_image != (Image *) 
# 746 "MagickCore/compress.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 746 "MagickCore/compress.c"
...
# 746 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 746, __extension__ __PRETTY_FUNCTION__); }))
# 746 "MagickCore/compress.c"
                                       ;
  
# 747 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 747 "MagickCore/compress.c"
...
# 747 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 747, __extension__ __PRETTY_FUNCTION__); }))
# 747 "MagickCore/compress.c"
                                                       ;
  one=1;
  width=inject_image->columns;
  if (LocaleCompare(image_info->magick,"FAX") == 0)
    width=(size_t) (((inject_image->columns) > (1728)) ? (inject_image->columns) : (1728));
  scanline=(unsigned char *) AcquireQuantumMemory((size_t) width+1UL,
    sizeof(*scanline));
  if (scanline == (unsigned char *) 
# 754 "MagickCore/compress.c" 3 4
                                   ((void *)0)
# 754 "MagickCore/compress.c"
                                       )
    { (void) ThrowMagickException(exception,"MagickCore/compress.c",__func__,(unsigned long) 755,ResourceLimitError,"MemoryAllocationFailed", "`%s'",inject_image->filename); return(MagickFalse); }
                             ;
...
# 759 "MagickCore/compress.c" 3 4
                                ((void *)0)
# 759 "MagickCore/compress.c"
                                    )
    {
      scanline=(unsigned char *) RelinquishMagickMemory(scanline);
      return(MagickFalse);
  ...
  if (LocaleCompare(image_info->magick,"FAX") != 0)
  ...
  else
    {
      ...
      for (k=0; k < 11; k++)
        { if (0 > 0) byte=byte | bit; bit>>=1; if ((int) (bit & 0xff) == 0) { if (LocaleCompare(image_info->magick,"FAX") == 0) (void) WriteBlobByte(image,(unsigned char) byte); else Ascii85Encode(image,byte); byte='\0'; bit=(unsigned char) 0x80; } };
      { if (1 > 0) byte=byte | bit; bit>>=1; if ((int) (bit & 0xff) == 0) { if (LocaleCompare(image_info->magick,"FAX") == 0) (void) WriteBlobByte(image,(unsigned char) byte); else Ascii85Encode(image,byte); byte='\0'; bit=(unsigned char) 0x80; } };
    }
...
# 785 "MagickCore/compress.c"
      ...
      if (runlength >= 64)
        {
          if (runlength < 1792)
            ...
            entry=EXTable+(((((size_t) runlength) < (2560)) ? ((size_t) runlength) : (2560))-1792)/64;
          runlength-=(long) entry->count;
          { mask=one << (entry->length-1); while (mask != 0) { { if (((entry->code & mask) != 0 ? 1 : 0) > 0) byte=byte | bit; bit>>=1; if ((int) (bit & 0xff) == 0) { if (LocaleCompare(image_info->magick,"FAX") == 0) (void) WriteBlobByte(image,(unsigned char) byte); else Ascii85Encode(image,byte); byte='\0'; bit=(unsigned char) 0x80; } }; mask>>=1; } };
        }
      entry=TWTable+((((size_t) runlength) < (63)) ? ((size_t) runlength) : (63));
      { mask=one << (entry->length-1); while (mask != 0) { { if (((entry->code & mask) != 0 ? 1 : 0) > 0) byte=byte | bit; bit>>=1; if ((int) (bit & 0xff) == 0) { if (LocaleCompare(image_info->magick,"FAX") == 0) (void) WriteBlobByte(image,(unsigned char) byte); else Ascii85Encode(image,byte); byte='\0'; bit=(unsigned char) 0x80; } }; mask>>=1; } };
      if (n != 0)
        {
          ...
          entry=TBTable+((((size_t) runlength) < (63)) ? ((size_t) runlength) : (63));
          { mask=one << (entry->length-1); while (mask != 0) { { if (((entry->code & mask) != 0 ? 1 : 0) > 0) byte=byte | bit; bit>>=1; if ((int) (bit & 0xff) == 0) { if (LocaleCompare(image_info->magick,"FAX") == 0) (void) WriteBlobByte(image,(unsigned char) byte); else Ascii85Encode(image,byte); byte='\0'; bit=(unsigned char) 0x80; } }; mask>>=1; } };
        }
    }
    ...
    { if (1 > 0) byte=byte | bit; bit>>=1; if ((int) (bit & 0xff) == 0) { if (LocaleCompare(image_info->magick,"FAX") == 0) (void) WriteBlobByte(image,(unsigned char) byte); else Ascii85Encode(image,byte); byte='\0'; bit=(unsigned char) 0x80; } };
    q=scanline;
    if (GetPreviousImageInList(huffman_image) == (Image *) 
# 847 "MagickCore/compress.c" 3 4
                                                          ((void *)0)
# 847 "MagickCore/compress.c"
                                                              )
      {
        proceed=SetImageProgress(huffman_image,"Load/Image",
...
# 912 "MagickCore/compress.c"
__attribute__ ((visibility ("default"))) MagickBooleanType LZWEncodeImage(Image *image,const size_t length,
  unsigned char *__restrict__ pixels,ExceptionInfo *exception)
{
# 929 "MagickCore/compress.c"
...
# 956 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 956 "MagickCore/compress.c"
 image != (Image *) 
# 956 "MagickCore/compress.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 956 "MagickCore/compress.c"
...
# 956 "MagickCore/compress.c"
 "image != (Image *) NULL"
# 956 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 956, __extension__ __PRETTY_FUNCTION__); }))
# 956 "MagickCore/compress.c"
                                ;
  
# 957 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 957 "MagickCore/compress.c"
 image->signature == 0xabacadabUL
# 957 "MagickCore/compress.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 957 "MagickCore/compress.c"
...
# 957 "MagickCore/compress.c"
 "image->signature == MagickCoreSignature"
# 957 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 957, __extension__ __PRETTY_FUNCTION__); }))
# 957 "MagickCore/compress.c"
                                                ;
  
# 958 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 958 "MagickCore/compress.c"
...
# 958 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 958, __extension__ __PRETTY_FUNCTION__); }))
# 958 "MagickCore/compress.c"
                                         ;
  
# 959 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 959 "MagickCore/compress.c"
...
# 959 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 959, __extension__ __PRETTY_FUNCTION__); }))
# 959 "MagickCore/compress.c"
                                            ;
  
# 960 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 960 "MagickCore/compress.c"
...
# 960 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 960, __extension__ __PRETTY_FUNCTION__); }))
# 960 "MagickCore/compress.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/compress.c",__func__,(unsigned long) 962,"%s",image->filename);
  table=(TableType *) AcquireQuantumMemory(1UL << 12,sizeof(*table));
  if (table == (TableType *) 
# 964 "MagickCore/compress.c" 3 4
                            ((void *)0)
# 964 "MagickCore/compress.c"
                                )
    { (void) ThrowMagickException(exception,"MagickCore/compress.c",__func__,(unsigned long) 965,ResourceLimitWarning,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  ...
  number_bits=0;
  last_code=0;
  { accumulator+=256UL << (32-code_width-number_bits); number_bits+=code_width; while (number_bits >= 8) { (void) WriteBlobByte(image,(unsigned char) (accumulator >> 24)); accumulator=accumulator << 8; number_bits-=8; } };
    ...
    if (last_code != (size_t) index)
      {
        ...
        { accumulator+=last_code << (32-code_width-number_bits); number_bits+=code_width; while (number_bits >= 8) { (void) WriteBlobByte(image,(unsigned char) (accumulator >> 24)); accumulator=accumulator << 8; number_bits-=8; } };
  ...
  { accumulator+=last_code << (32-code_width-number_bits); number_bits+=code_width; while (number_bits >= 8) { (void) WriteBlobByte(image,(unsigned char) (accumulator >> 24)); accumulator=accumulator << 8; number_bits-=8; } };
  { accumulator+=257UL << (32-code_width-number_bits); number_bits+=code_width; while (number_bits >= 8) { (void) WriteBlobByte(image,(unsigned char) (accumulator >> 24)); accumulator=accumulator << 8; number_bits-=8; } };
  if (number_bits != 0)
    (void) WriteBlobByte(image,(unsigned char) (accumulator >> 24));
  table=(TableType *) RelinquishMagickMemory(table);
  return(MagickTrue);
}
# 1077 "MagickCore/compress.c"
__attribute__ ((visibility ("default"))) MagickBooleanType PackbitsEncodeImage(Image *image,
  const size_t length,unsigned char *__restrict__ pixels,
  ExceptionInfo *exception)
{
  int
    count;
...
# 1094 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 1094 "MagickCore/compress.c"
 image != (Image *) 
# 1094 "MagickCore/compress.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1094 "MagickCore/compress.c"
...
# 1094 "MagickCore/compress.c"
 "image != (Image *) NULL"
# 1094 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 1094, __extension__ __PRETTY_FUNCTION__); }))
# 1094 "MagickCore/compress.c"
                                ;
  
# 1095 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 1095 "MagickCore/compress.c"
 image->signature == 0xabacadabUL
# 1095 "MagickCore/compress.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1095 "MagickCore/compress.c"
...
# 1095 "MagickCore/compress.c"
 "image->signature == MagickCoreSignature"
# 1095 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 1095, __extension__ __PRETTY_FUNCTION__); }))
# 1095 "MagickCore/compress.c"
                                                ;
  
# 1096 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 1096 "MagickCore/compress.c"
 pixels != (unsigned char *) 
# 1096 "MagickCore/compress.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1096 "MagickCore/compress.c"
...
# 1096 "MagickCore/compress.c"
 "pixels != (unsigned char *) NULL"
# 1096 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 1096, __extension__ __PRETTY_FUNCTION__); }))
# 1096 "MagickCore/compress.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/compress.c",__func__,(unsigned long) 1098,"%s",image->filename);
  packbits=(unsigned char *) AcquireQuantumMemory(128UL,sizeof(*packbits));
  if (packbits == (unsigned char *) 
# 1100 "MagickCore/compress.c" 3 4
                                   ((void *)0)
# 1100 "MagickCore/compress.c"
                                       )
    { (void) ThrowMagickException(exception,"MagickCore/compress.c",__func__,(unsigned long) 1101,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
...
__attribute__ ((visibility ("default"))) MagickBooleanType ZLIBEncodeImage(Image *image,const size_t length,
  unsigned char *__restrict__ pixels,ExceptionInfo *exception)
{
  int
    status;
...
# 1248 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 1248 "MagickCore/compress.c"
 image != (Image *) 
# 1248 "MagickCore/compress.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1248 "MagickCore/compress.c"
...
# 1248 "MagickCore/compress.c"
 "image != (Image *) NULL"
# 1248 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 1248, __extension__ __PRETTY_FUNCTION__); }))
# 1248 "MagickCore/compress.c"
                                ;
  
# 1249 "MagickCore/compress.c" 3 4
 ((void) sizeof ((
# 1249 "MagickCore/compress.c"
 image->signature == 0xabacadabUL
# 1249 "MagickCore/compress.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1249 "MagickCore/compress.c"
...
# 1249 "MagickCore/compress.c"
 "image->signature == MagickCoreSignature"
# 1249 "MagickCore/compress.c" 3 4
 , "MagickCore/compress.c", 1249, __extension__ __PRETTY_FUNCTION__); }))
# 1249 "MagickCore/compress.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/compress.c",__func__,(unsigned long) 1251,"%s",image->filename);
...
# 1255 "MagickCore/compress.c" 3 4
                                          ((void *)0)
# 1255 "MagickCore/compress.c"
                                              )
    { (void) ThrowMagickException(exception,"MagickCore/compress.c",__func__,(unsigned long) 1256,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
...
# 1265 "MagickCore/compress.c" 3 4
                        ((void *)0)
# 1265 "MagickCore/compress.c"
                            ;
  status=
# 1266 "MagickCore/compress.c" 3 4
        deflateInit_((
# 1266 "MagickCore/compress.c"
        &stream
# 1266 "MagickCore/compress.c" 3 4
        ), (
# 1266 "MagickCore/compress.c"
...
# 1267 "MagickCore/compress.c"
                                                                     ;
  if (status == 
# 1268 "MagickCore/compress.c" 3 4
               0
# 1268 "MagickCore/compress.c"
                   )
    {
      status=deflate(&stream,
# 1270 "MagickCore/compress.c" 3 4
                            4
# 1270 "MagickCore/compress.c"
                                    );
      if (status == 
# 1271 "MagickCore/compress.c" 3 4
                   1
# 1271 "MagickCore/compress.c"
                               )
  ...
  if (status != 
# 1277 "MagickCore/compress.c" 3 4
               0
# 1277 "MagickCore/compress.c"
                   )
    { (void) ThrowMagickException(exception,"MagickCore/compress.c",__func__,(unsigned long) 1278,CoderError,"UnableToZipCompressImage", "`%s'",image->filename); return(MagickFalse); }
