# 0 "MagickCore/registry.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/registry.c"
# 43 "MagickCore/registry.c"
...
static SplayTreeInfo
  *registry = (SplayTreeInfo *) 
# 77 "MagickCore/registry.c" 3 4
                               ((void *)0)
# 77 "MagickCore/registry.c"
                                   ;

static SemaphoreInfo
  *registry_semaphore = (SemaphoreInfo *) 
# 80 "MagickCore/registry.c" 3 4
                                         ((void *)0)
# 80 "MagickCore/registry.c"
                                             ;
# 109 "MagickCore/registry.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DefineImageRegistry(const RegistryType type,
...
# 119 "MagickCore/registry.c" 3 4
 ((void) sizeof ((
# 119 "MagickCore/registry.c"
 option != (const char *) 
# 119 "MagickCore/registry.c" 3 4
...
# 119 "MagickCore/registry.c" 3 4
 , "MagickCore/registry.c", 119, __extension__ __PRETTY_FUNCTION__); }))
# 119 "MagickCore/registry.c"
                                      ;
...
# 153 "MagickCore/registry.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DeleteImageRegistry(const char *key)
{
  
# 155 "MagickCore/registry.c" 3 4
 ((void) sizeof ((
# 155 "MagickCore/registry.c"
 key != (const char *) 
# 155 "MagickCore/registry.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 155 "MagickCore/registry.c"
...
# 155 "MagickCore/registry.c"
 "key != (const char *) NULL"
# 155 "MagickCore/registry.c" 3 4
 , "MagickCore/registry.c", 155, __extension__ __PRETTY_FUNCTION__); }))
# 155 "MagickCore/registry.c"
                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/registry.c",__func__,(unsigned long) 157,"%s",key);
  if (registry == (void *) 
# 158 "MagickCore/registry.c" 3 4
                          ((void *)0)
# 158 "MagickCore/registry.c"
                              )
    return(MagickFalse);
  return(DeleteNodeFromSplayTree(registry,key));
}
# 190 "MagickCore/registry.c"
__attribute__ ((visibility ("default"))) void *GetImageRegistry(const RegistryType type,const char *key,
...
# 199 "MagickCore/registry.c" 3 4
 ((void) sizeof ((
# 199 "MagickCore/registry.c"
 key != (const char *) 
# 199 "MagickCore/registry.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 199 "MagickCore/registry.c"
...
# 199 "MagickCore/registry.c"
 "key != (const char *) NULL"
# 199 "MagickCore/registry.c" 3 4
 , "MagickCore/registry.c", 199, __extension__ __PRETTY_FUNCTION__); }))
# 199 "MagickCore/registry.c"
                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/registry.c",__func__,(unsigned long) 201,"%s",key);
  if (registry == (void *) 
# 202 "MagickCore/registry.c" 3 4
                          ((void *)0)
# 202 "MagickCore/registry.c"
                              )
    return((void *) 
# 203 "MagickCore/registry.c" 3 4
                   ((void *)0)
# 203 "MagickCore/registry.c"
                       );
  registry_info=(RegistryInfo *) GetValueFromSplayTree(registry,key);
  if (registry_info == (void *) 
# 205 "MagickCore/registry.c" 3 4
                               ((void *)0)
# 205 "MagickCore/registry.c"
                                   )
    return((void *) 
# 206 "MagickCore/registry.c" 3 4
                   ((void *)0)
# 206 "MagickCore/registry.c"
                       );
  value=(void *) 
# 207 "MagickCore/registry.c" 3 4
                ((void *)0)
# 207 "MagickCore/registry.c"
                    ;
  switch (type)
  {
...
# 272 "MagickCore/registry.c"
__attribute__ ((visibility ("default"))) char *GetNextImageRegistry(void)
{
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/registry.c",__func__,(unsigned long) 275,"...");
  if (registry == (void *) 
# 276 "MagickCore/registry.c" 3 4
                          ((void *)0)
# 276 "MagickCore/registry.c"
                              )
    return((char *) 
# 277 "MagickCore/registry.c" 3 4
                   ((void *)0)
# 277 "MagickCore/registry.c"
                       );
  return((char *) GetNextKeyInSplayTree(registry));
}
# 299 "MagickCore/registry.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType RegistryComponentGenesis(void)
{
  if (registry_semaphore == (SemaphoreInfo *) 
# 301 "MagickCore/registry.c" 3 4
                                             ((void *)0)
# 301 "MagickCore/registry.c"
                                                 )
    registry_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 324 "MagickCore/registry.c"
__attribute__ ((visibility ("hidden"))) void RegistryComponentTerminus(void)
{
  if (registry_semaphore == (SemaphoreInfo *) 
# 326 "MagickCore/registry.c" 3 4
                                             ((void *)0)
# 326 "MagickCore/registry.c"
                                                 )
    ActivateSemaphoreInfo(&registry_semaphore);
  LockSemaphoreInfo(registry_semaphore);
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/registry.c",__func__,(unsigned long) 330,"...");
  if (registry != (void *) 
# 331 "MagickCore/registry.c" 3 4
                          ((void *)0)
# 331 "MagickCore/registry.c"
                              )
    registry=DestroySplayTree(registry);
  UnlockSemaphoreInfo(registry_semaphore);
  RelinquishSemaphoreInfo(&registry_semaphore);
}
# 360 "MagickCore/registry.c"
__attribute__ ((visibility ("default"))) void *RemoveImageRegistry(const char *key)
{
  
# 362 "MagickCore/registry.c" 3 4
 ((void) sizeof ((
# 362 "MagickCore/registry.c"
 key != (const char *) 
# 362 "MagickCore/registry.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 362 "MagickCore/registry.c"
...
# 362 "MagickCore/registry.c"
 "key != (const char *) NULL"
# 362 "MagickCore/registry.c" 3 4
 , "MagickCore/registry.c", 362, __extension__ __PRETTY_FUNCTION__); }))
# 362 "MagickCore/registry.c"
                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/registry.c",__func__,(unsigned long) 364,"%s",key);
  if (registry == (void *) 
# 365 "MagickCore/registry.c" 3 4
                          ((void *)0)
# 365 "MagickCore/registry.c"
                              )
    return((void *) 
# 366 "MagickCore/registry.c" 3 4
                   ((void *)0)
# 366 "MagickCore/registry.c"
                       );
  return(RemoveNodeFromSplayTree(registry,key));
}
# 390 "MagickCore/registry.c"
__attribute__ ((visibility ("default"))) void ResetImageRegistryIterator(void)
{
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/registry.c",__func__,(unsigned long) 393,"...");
  if (registry == (void *) 
# 394 "MagickCore/registry.c" 3 4
                          ((void *)0)
# 394 "MagickCore/registry.c"
                              )
    return;
  ResetSplayTreeIterator(registry);
}
# 429 "MagickCore/registry.c"
...
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageRegistry(const RegistryType type,
...
# 466 "MagickCore/registry.c" 3 4
 ((void) sizeof ((
# 466 "MagickCore/registry.c"
 key != (const char *) 
# 466 "MagickCore/registry.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 466 "MagickCore/registry.c"
...
# 466 "MagickCore/registry.c"
 "key != (const char *) NULL"
# 466 "MagickCore/registry.c" 3 4
 , "MagickCore/registry.c", 466, __extension__ __PRETTY_FUNCTION__); }))
# 466 "MagickCore/registry.c"
                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/registry.c",__func__,(unsigned long) 468,"%s",key);
  if (value == (const void *) 
# 469 "MagickCore/registry.c" 3 4
                             ((void *)0)
# 469 "MagickCore/registry.c"
                                 )
    return(MagickFalse);
  clone_value=(void *) 
# 471 "MagickCore/registry.c" 3 4
                      ((void *)0)
# 471 "MagickCore/registry.c"
                          ;
  switch (type)
  {
    case StringRegistryType:
...
# 492 "MagickCore/registry.c" 3 4
                                   ((void *)0)
# 492 "MagickCore/registry.c"
                                       ) ||
          (image->signature != 0xabacadabUL))
        {
          (void) ThrowMagickException(exception,"MagickCore/registry.c",__func__,(unsigned long) 495,RegistryError,
...
# 508 "MagickCore/registry.c" 3 4
                                            ((void *)0)
# 508 "MagickCore/registry.c"
                                                ) ||
          (image_info->signature != 0xabacadabUL))
        {
          (void) ThrowMagickException(exception,"MagickCore/registry.c",__func__,(unsigned long) 511,RegistryError,
            "UnableToSetRegistry","%s",key);
          return(MagickFalse);
        }
  ...
  if (clone_value == (void *) 
# 519 "MagickCore/registry.c" 3 4
                             ((void *)0)
# 519 "MagickCore/registry.c"
                                 )
    return(MagickFalse);
  ...
  registry_info->signature=0xabacadabUL;
  if (registry == (SplayTreeInfo *) 
# 526 "MagickCore/registry.c" 3 4
                                   ((void *)0)
# 526 "MagickCore/registry.c"
                                       )
    {
      if (registry_semaphore == (SemaphoreInfo *) 
# 528 "MagickCore/registry.c" 3 4
                                                 ((void *)0)
# 528 "MagickCore/registry.c"
                                                     )
        ActivateSemaphoreInfo(&registry_semaphore);
      LockSemaphoreInfo(registry_semaphore);
      if (registry == (SplayTreeInfo *) 
# 531 "MagickCore/registry.c" 3 4
                                       ((void *)0)
# 531 "MagickCore/registry.c"
                                           )
