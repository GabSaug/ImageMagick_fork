# 0 "MagickCore/xml-tree.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/xml-tree.c"
# 50 "MagickCore/xml-tree.c"
...
# 67 "MagickCore/xml-tree.c" 2
# 77 "MagickCore/xml-tree.c"
struct _XMLTreeInfo
{
  char
    *tag,
...
static char
  *sentinel[] = { (char *) 
# 137 "MagickCore/xml-tree.c" 3 4
                          ((void *)0) 
# 137 "MagickCore/xml-tree.c"
                               };
# 167 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("default"))) XMLTreeInfo *AddChildToXMLTree(XMLTreeInfo *xml_info,
...
# 173 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 173 "MagickCore/xml-tree.c"
                                     )
    return((XMLTreeInfo *) 
# 174 "MagickCore/xml-tree.c" 3 4
                          ((void *)0)
# 174 "MagickCore/xml-tree.c"
                              );
  child=(XMLTreeInfo *) AcquireMagickMemory(sizeof(*child));
  if (child == (XMLTreeInfo *) 
# 176 "MagickCore/xml-tree.c" 3 4
                              ((void *)0)
# 176 "MagickCore/xml-tree.c"
                                  )
    return((XMLTreeInfo *) 
# 177 "MagickCore/xml-tree.c" 3 4
                          ((void *)0)
# 177 "MagickCore/xml-tree.c"
                              );
  ...
  child->signature=0xabacadabUL;
  return(InsertTagIntoXMLTree(xml_info,child,offset));
}
# 215 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("hidden"))) XMLTreeInfo *AddPathToXMLTree(XMLTreeInfo *xml_info,
...
# 234 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 234 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 234 "MagickCore/xml-tree.c" 3 4
...
# 234 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 234 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 234, __extension__ __PRETTY_FUNCTION__); }))
# 234 "MagickCore/xml-tree.c"
                                         ;
  
# 235 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 235 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 235 "MagickCore/xml-tree.c" 3 4
...
# 235 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 235 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 235, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 236 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 238,"...");
  node=xml_info;
  components=GetPathComponents(path,&number_components);
  if (components == (char **) 
# 241 "MagickCore/xml-tree.c" 3 4
                             ((void *)0)
# 241 "MagickCore/xml-tree.c"
                                 )
    return((XMLTreeInfo *) 
# 242 "MagickCore/xml-tree.c" 3 4
                          ((void *)0)
# 242 "MagickCore/xml-tree.c"
                              );
  for (i=0; i < (ssize_t) number_components; i++)
  {
    ...
    if (child == (XMLTreeInfo *) 
# 248 "MagickCore/xml-tree.c" 3 4
                                ((void *)0)
# 248 "MagickCore/xml-tree.c"
                                    )
      child=AddChildToXMLTree(node,tag,offset);
    node=child;
    if (node == (XMLTreeInfo *) 
# 251 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 251 "MagickCore/xml-tree.c"
                                   )
      break;
    for (j=(ssize_t) StringToLong(subnode)-1; j > 0; j--)
    {
      ...
      if (node == (XMLTreeInfo *) 
# 256 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 256 "MagickCore/xml-tree.c"
                                     )
        break;
    }
    if (node == (XMLTreeInfo *) 
# 259 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 259 "MagickCore/xml-tree.c"
                                   )
      break;
...
# 297 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("hidden"))) char *CanonicalXMLContent(const char *content,
  const MagickBooleanType pedantic)
{
  char
    *base64,
  ...
  if (utf8 == (unsigned char *) 
# 314 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 314 "MagickCore/xml-tree.c"
                                   )
    return((char *) 
# 315 "MagickCore/xml-tree.c" 3 4
                   ((void *)0)
# 315 "MagickCore/xml-tree.c"
                       );
  for (p=utf8; *p != '\0'; p++)
  ...
  if (*p != '\0')
    {
      ...
      if (base64 == (char *) 
# 326 "MagickCore/xml-tree.c" 3 4
                            ((void *)0)
# 326 "MagickCore/xml-tree.c"
                                )
        return((char *) 
# 327 "MagickCore/xml-tree.c" 3 4
                       ((void *)0)
# 327 "MagickCore/xml-tree.c"
                           );
...
static char **DestroyXMLTreeAttributes(char **attributes)
{
  ...
  if ((attributes == (char **) 
# 370 "MagickCore/xml-tree.c" 3 4
                              ((void *)0)
# 370 "MagickCore/xml-tree.c"
                                  ) || (attributes == sentinel))
    return((char **) 
# 371 "MagickCore/xml-tree.c" 3 4
                    ((void *)0)
# 371 "MagickCore/xml-tree.c"
                        );
  for (i=0; attributes[i] != (char *) 
# 372 "MagickCore/xml-tree.c" 3 4
                                     ((void *)0)
# 372 "MagickCore/xml-tree.c"
                                         ; i+=2)
  {



    if (attributes[i] != (char *) 
# 377 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 377 "MagickCore/xml-tree.c"
                                     )
      attributes[i]=DestroyString(attributes[i]);
    if (attributes[i+1] != (char *) 
# 379 "MagickCore/xml-tree.c" 3 4
                                   ((void *)0)
# 379 "MagickCore/xml-tree.c"
                                       )
      attributes[i+1]=DestroyString(attributes[i+1]);
  }
  attributes=(char **) RelinquishMagickMemory(attributes);
  return((char **) 
# 383 "MagickCore/xml-tree.c" 3 4
                  ((void *)0)
# 383 "MagickCore/xml-tree.c"
                      );
}
...
# 393 "MagickCore/xml-tree.c" 3 4
                                ((void *)0)
# 393 "MagickCore/xml-tree.c"
                                    )
  {
    node=child;
    child=node->child;
    node->child=(XMLTreeInfo *) 
# 397 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 397 "MagickCore/xml-tree.c"
                                   ;
...
static void DestroyXMLTreeOrdered(XMLTreeInfo *xml_info)
{
  ...
  while(ordered != (XMLTreeInfo *) 
# 409 "MagickCore/xml-tree.c" 3 4
                                  ((void *)0)
# 409 "MagickCore/xml-tree.c"
                                      )
  {
    node=ordered;
    ordered=node->ordered;
    node->ordered=(XMLTreeInfo *) 
# 413 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 413 "MagickCore/xml-tree.c"
                                     ;
    (void) DestroyXMLTree(node);
  }
}
...
# 430 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 430 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 430 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 430 "MagickCore/xml-tree.c"
...
# 430 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 430 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 430, __extension__ __PRETTY_FUNCTION__); }))
# 430 "MagickCore/xml-tree.c"
                                         ;
  
# 431 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 431 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 431 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 431 "MagickCore/xml-tree.c"
...
# 431 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 431 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 431, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 432 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 434,"...");
  if (xml_info->parent != (XMLTreeInfo *) 
# 435 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 435 "MagickCore/xml-tree.c"
                                             )
    return;
  ...
  for (i=10; root->entities[i] != (char *) 
# 441 "MagickCore/xml-tree.c" 3 4
                                                                ((void *)0)
# 441 "MagickCore/xml-tree.c"
                                                                    ; i+=2)
    root->entities[i+1]=DestroyString(root->entities[i+1]);
  root->entities=(char **) RelinquishMagickMemory(root->entities);
  for (i=0; root->attributes[i] != (char **) 
# 444 "MagickCore/xml-tree.c" 3 4
                                            ((void *)0)
# 444 "MagickCore/xml-tree.c"
                                                ; i++)
  {
    attributes=root->attributes[i];
    if (attributes[0] != (char *) 
# 447 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 447 "MagickCore/xml-tree.c"
                                     )
      attributes[0]=DestroyString(attributes[0]);
    for (j=1; attributes[j] != (char *) 
# 449 "MagickCore/xml-tree.c" 3 4
                                       ((void *)0)
# 449 "MagickCore/xml-tree.c"
                                           ; j+=3)
    {
      if (attributes[j] != (char *) 
# 451 "MagickCore/xml-tree.c" 3 4
                                   ((void *)0)
# 451 "MagickCore/xml-tree.c"
                                       )
        attributes[j]=DestroyString(attributes[j]);
      if (attributes[j+1] != (char *) 
# 453 "MagickCore/xml-tree.c" 3 4
                                     ((void *)0)
# 453 "MagickCore/xml-tree.c"
                                         )
        attributes[j+1]=DestroyString(attributes[j+1]);
      if (attributes[j+2] != (char *) 
# 455 "MagickCore/xml-tree.c" 3 4
                                     ((void *)0)
# 455 "MagickCore/xml-tree.c"
                                         )
        attributes[j+2]=DestroyString(attributes[j+2]);
    }
    attributes=(char **) RelinquishMagickMemory(attributes);
  }
  if (root->attributes[0] != (char **) 
# 460 "MagickCore/xml-tree.c" 3 4
                                      ((void *)0)
# 460 "MagickCore/xml-tree.c"
                                          )
    root->attributes=(char ***) RelinquishMagickMemory(root->attributes);
  if (root->processing_instructions[0] != (char **) 
# 462 "MagickCore/xml-tree.c" 3 4
                                                   ((void *)0)
# 462 "MagickCore/xml-tree.c"
                                                       )
    {
      for (i=0; root->processing_instructions[i] != (char **) 
# 464 "MagickCore/xml-tree.c" 3 4
                                                             ((void *)0)
# 464 "MagickCore/xml-tree.c"
                                                                 ; i++)
      {
        for (j=0; root->processing_instructions[i][j] != (char *) 
# 466 "MagickCore/xml-tree.c" 3 4
                                                                 ((void *)0)
# 466 "MagickCore/xml-tree.c"
                                                                     ; j++)
...
__attribute__ ((visibility ("default"))) XMLTreeInfo *DestroyXMLTree(XMLTreeInfo *xml_info)
{
  
# 481 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 481 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 481 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 481 "MagickCore/xml-tree.c"
...
# 481 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 481 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 481, __extension__ __PRETTY_FUNCTION__); }))
# 481 "MagickCore/xml-tree.c"
                                         ;
  
# 482 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 482 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 482 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 482 "MagickCore/xml-tree.c"
...
# 482 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 482 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 482, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 483 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 485,"...");
  ...
  return((XMLTreeInfo *) 
# 493 "MagickCore/xml-tree.c" 3 4
                        ((void *)0)
# 493 "MagickCore/xml-tree.c"
                            );
}
# 520 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("hidden"))) char *FileToXML(const char *filename,const size_t extent)
{
  char
    *xml;
...
# 541 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 541 "MagickCore/xml-tree.c"
 filename != (const char *) 
# 541 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 541 "MagickCore/xml-tree.c"
...
# 541 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 541, __extension__ __PRETTY_FUNCTION__); }))
# 541 "MagickCore/xml-tree.c"
                                        ;
  length=0;
  file=fileno(
# 543 "MagickCore/xml-tree.c" 3 4
             stdin
# 543 "MagickCore/xml-tree.c"
                  );
  if (LocaleCompare(filename,"-") != 0)
    file=open_utf8(filename,
# 545 "MagickCore/xml-tree.c" 3 4
                           00 
# 545 "MagickCore/xml-tree.c"
                                    | 0x00,0);
  if (file == -1)
    return((char *) 
# 547 "MagickCore/xml-tree.c" 3 4
                   ((void *)0)
# 547 "MagickCore/xml-tree.c"
                       );
  offset=(MagickOffsetType) lseek(file,0,
# 548 "MagickCore/xml-tree.c" 3 4
                                        2
# 548 "MagickCore/xml-tree.c"
                                                );
  count=0;
  if ((file == fileno(
# 550 "MagickCore/xml-tree.c" 3 4
                     stdin
# 550 "MagickCore/xml-tree.c"
                          )) || (offset < 0) ||
      (offset != (MagickOffsetType) ((ssize_t) offset)))
    {
      ...
      offset=(MagickOffsetType) lseek(file,0,
# 562 "MagickCore/xml-tree.c" 3 4
                                            0
# 562 "MagickCore/xml-tree.c"
                                                    );
      ...
      for (i=0; xml != (char *) 
# 567 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 567 "MagickCore/xml-tree.c"
                                   ; i+=(size_t) count)
      {
        ...
        if (count <= 0)
          {
            count=0;
            if (
# 573 "MagickCore/xml-tree.c" 3 4
               (*__errno_location ()) 
# 573 "MagickCore/xml-tree.c"
                     != 
# 573 "MagickCore/xml-tree.c" 3 4
                        4
# 573 "MagickCore/xml-tree.c"
      ...
      if (LocaleCompare(filename,"-") != 0)
        file=close(file);
      if (xml == (char *) 
# 587 "MagickCore/xml-tree.c" 3 4
                         ((void *)0)
# 587 "MagickCore/xml-tree.c"
                             )
        return((char *) 
# 588 "MagickCore/xml-tree.c" 3 4
                       ((void *)0)
# 588 "MagickCore/xml-tree.c"
                           );
      if (file == -1)
        {
          xml=(char *) RelinquishMagickMemory(xml);
          return((char *) 
# 592 "MagickCore/xml-tree.c" 3 4
                         ((void *)0)
# 592 "MagickCore/xml-tree.c"
                             );
        }
      length=(((i+(size_t) count) < (extent)) ? (i+(size_t) count) : (extent));
      xml[length]='\0';
      return(xml);
    }
  length=(size_t) (((offset) < ((MagickOffsetType) extent)) ? (offset) : ((MagickOffsetType) extent));
  xml=(char *) 
# 599 "MagickCore/xml-tree.c" 3 4
              ((void *)0)
# 599 "MagickCore/xml-tree.c"
                  ;
  if (~length >= (4096 -1))
    xml=(char *) AcquireQuantumMemory(length+4096,sizeof(*xml));
  if (xml == (char *) 
# 602 "MagickCore/xml-tree.c" 3 4
                     ((void *)0)
# 602 "MagickCore/xml-tree.c"
                         )
    {
      file=close(file);
      return((char *) 
# 605 "MagickCore/xml-tree.c" 3 4
                     ((void *)0)
# 605 "MagickCore/xml-tree.c"
                         );
    }
  map=MapBlob(file,ReadMode,0,length);
  if (map != (char *) 
# 608 "MagickCore/xml-tree.c" 3 4
                     ((void *)0)
# 608 "MagickCore/xml-tree.c"
                         )
    {
    ...
    {
      (void) lseek(file,0,
# 615 "MagickCore/xml-tree.c" 3 4
                         0
# 615 "MagickCore/xml-tree.c"
                                 );
      for (i=0; i < length; i+=(size_t) count)
      {
        count=read(file,xml+i,(size_t) (((length-i) < ((size_t) (0x7fffffffffffffffL
# 618 "MagickCore/xml-tree.c"
        ...
        if (count <= 0)
          {
            count=0;
            if (
# 623 "MagickCore/xml-tree.c" 3 4
               (*__errno_location ()) 
# 623 "MagickCore/xml-tree.c"
                     != 
# 623 "MagickCore/xml-tree.c" 3 4
                        4
# 623 "MagickCore/xml-tree.c"
      ...
      if (i < length)
        {
          ...
          xml=(char *) RelinquishMagickMemory(xml);
          return((char *) 
# 631 "MagickCore/xml-tree.c" 3 4
                         ((void *)0)
# 631 "MagickCore/xml-tree.c"
                             );
        }
    }
  xml[length]='\0';
...
# 664 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("default"))) XMLTreeInfo *GetNextXMLTreeTag(XMLTreeInfo *xml_info)
{
  
# 666 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 666 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 666 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 666 "MagickCore/xml-tree.c"
...
# 666 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 666 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 666, __extension__ __PRETTY_FUNCTION__); }))
# 666 "MagickCore/xml-tree.c"
                                         ;
  
# 667 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 667 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 667 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 667 "MagickCore/xml-tree.c"
...
# 667 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 667 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 667, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 668 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 670,"...");
  return(xml_info->next);
}
# 699 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("default"))) const char *GetXMLTreeAttribute(XMLTreeInfo *xml_info,
  const char *tag)
{
  ssize_t
    i,
...
# 709 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 709 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 709 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 709 "MagickCore/xml-tree.c"
...
# 709 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 709 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 709, __extension__ __PRETTY_FUNCTION__); }))
# 709 "MagickCore/xml-tree.c"
                                         ;
  
# 710 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 710 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 710 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 710 "MagickCore/xml-tree.c"
...
# 710 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 710 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 710, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 711 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 713,"...");
  if (xml_info->attributes == (char **) 
# 714 "MagickCore/xml-tree.c" 3 4
                                       ((void *)0)
# 714 "MagickCore/xml-tree.c"
                                           )
    return((const char *) 
# 715 "MagickCore/xml-tree.c" 3 4
                         ((void *)0)
# 715 "MagickCore/xml-tree.c"
                             );
  i=0;
  while ((xml_info->attributes[i] != (char *) 
# 717 "MagickCore/xml-tree.c" 3 4
                                             ((void *)0)
# 717 "MagickCore/xml-tree.c"
                                                 ) &&
         (strcmp(xml_info->attributes[i],tag) != 0))
    i+=2;
  if (xml_info->attributes[i] != (char *) 
# 720 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 720 "MagickCore/xml-tree.c"
                                             )
    return(xml_info->attributes[i+1]);
  root=(XMLTreeRoot*) xml_info;
  while (root->root.parent != (XMLTreeInfo *) 
# 723 "MagickCore/xml-tree.c" 3 4
                                             ((void *)0)
# 723 "MagickCore/xml-tree.c"
                                                 )
    root=(XMLTreeRoot *) root->root.parent;
  i=0;
  while ((root->attributes[i] != (char **) 
# 726 "MagickCore/xml-tree.c" 3 4
                                          ((void *)0)
# 726 "MagickCore/xml-tree.c"
                                              ) &&
         (strcmp(root->attributes[i][0],xml_info->tag) != 0))
    i++;
  if (root->attributes[i] == (char **) 
# 729 "MagickCore/xml-tree.c" 3 4
                                      ((void *)0)
# 729 "MagickCore/xml-tree.c"
                                          )
    return((const char *) 
# 730 "MagickCore/xml-tree.c" 3 4
                         ((void *)0)
# 730 "MagickCore/xml-tree.c"
                             );
  j=1;
  while ((root->attributes[i][j] != (char *) 
# 732 "MagickCore/xml-tree.c" 3 4
                                            ((void *)0)
# 732 "MagickCore/xml-tree.c"
                                                ) &&
         (strcmp(root->attributes[i][j],tag) != 0))
    j+=3;
  if (root->attributes[i][j] == (char *) 
# 735 "MagickCore/xml-tree.c" 3 4
                                        ((void *)0)
# 735 "MagickCore/xml-tree.c"
                                            )
    return((const char *) 
# 736 "MagickCore/xml-tree.c" 3 4
                         ((void *)0)
# 736 "MagickCore/xml-tree.c"
                             );
  return(root->attributes[i][j+1]);
}
# 766 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType GetXMLTreeAttributes(
...
# 772 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 772 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 772 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 772 "MagickCore/xml-tree.c"
...
# 772 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 772 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 772, __extension__ __PRETTY_FUNCTION__); }))
# 772 "MagickCore/xml-tree.c"
                                         ;
  
# 773 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 773 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((const XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 773 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 773 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((const XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
...
# 773 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((const XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 773 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 773, __extension__ __PRETTY_FUNCTION__); }))
                                                                              
# 774 "MagickCore/xml-tree.c"
                                                                             ;
  
# 775 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 775 "MagickCore/xml-tree.c"
 attributes != (SplayTreeInfo *) 
# 775 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 775 "MagickCore/xml-tree.c"
 attributes != (SplayTreeInfo *) 
# 775 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 775 "MagickCore/xml-tree.c"
 "attributes != (SplayTreeInfo *) NULL"
# 775 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 775, __extension__ __PRETTY_FUNCTION__); }))
# 775 "MagickCore/xml-tree.c"
                                             ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 777,"...");
  if (xml_info->attributes == (char **) 
# 778 "MagickCore/xml-tree.c" 3 4
                                       ((void *)0)
# 778 "MagickCore/xml-tree.c"
                                           )
    return(MagickTrue);
  i=0;
  while (xml_info->attributes[i] != (char *) 
# 781 "MagickCore/xml-tree.c" 3 4
                                            ((void *)0)
# 781 "MagickCore/xml-tree.c"
                                                )
  {
...
# 814 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("default"))) XMLTreeInfo *GetXMLTreeChild(XMLTreeInfo *xml_info,const char *tag)
{
  XMLTreeInfo
    *child;

  
# 819 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 819 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 819 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 819 "MagickCore/xml-tree.c"
...
# 819 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 819 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 819, __extension__ __PRETTY_FUNCTION__); }))
# 819 "MagickCore/xml-tree.c"
                                         ;
  
# 820 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 820 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 820 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 820 "MagickCore/xml-tree.c"
...
# 820 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 820 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 820, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 821 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 823,"...");
  child=xml_info->child;
  if (tag != (const char *) 
# 825 "MagickCore/xml-tree.c" 3 4
                           ((void *)0)
# 825 "MagickCore/xml-tree.c"
                               )
    while ((child != (XMLTreeInfo *) 
# 826 "MagickCore/xml-tree.c" 3 4
                                    ((void *)0)
# 826 "MagickCore/xml-tree.c"
                                        ) && (strcmp(child->tag,tag) != 0))
      child=child->sibling;
  return(child);
}
# 854 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("default"))) const char *GetXMLTreeContent(XMLTreeInfo *xml_info)
{
  
# 856 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 856 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 856 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 856 "MagickCore/xml-tree.c"
...
# 856 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 856 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 856, __extension__ __PRETTY_FUNCTION__); }))
# 856 "MagickCore/xml-tree.c"
                                         ;
  
# 857 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 857 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 857 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 857 "MagickCore/xml-tree.c"
...
# 857 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 857 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 857, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 858 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 860,"...");
  return(xml_info->content);
}
# 886 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("hidden"))) XMLTreeInfo *GetXMLTreeOrdered(XMLTreeInfo *xml_info)
{
  
# 888 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 888 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 888 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 888 "MagickCore/xml-tree.c"
...
# 888 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 888 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 888, __extension__ __PRETTY_FUNCTION__); }))
# 888 "MagickCore/xml-tree.c"
                                         ;
  
# 889 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 889 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 889 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 889 "MagickCore/xml-tree.c"
...
# 889 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 889 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 889, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 890 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 892,"...");
  return(xml_info->ordered);
}
# 921 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("hidden"))) XMLTreeInfo *GetXMLTreePath(XMLTreeInfo *xml_info,
  const char *path)
{
  char
    **components,
...
# 939 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 939 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 939 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 939 "MagickCore/xml-tree.c"
...
# 939 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 939 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 939, __extension__ __PRETTY_FUNCTION__); }))
# 939 "MagickCore/xml-tree.c"
                                         ;
  
# 940 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 940 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 940 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 940 "MagickCore/xml-tree.c"
...
# 940 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 940 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 940, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 941 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 943,"...");
  node=xml_info;
  components=GetPathComponents(path,&number_components);
  if (components == (char **) 
# 946 "MagickCore/xml-tree.c" 3 4
                             ((void *)0)
# 946 "MagickCore/xml-tree.c"
                                 )
    return((XMLTreeInfo *) 
# 947 "MagickCore/xml-tree.c" 3 4
                          ((void *)0)
# 947 "MagickCore/xml-tree.c"
                              );
  for (i=0; i < (ssize_t) number_components; i++)
  {
    GetPathComponent(components[i],SubimagePath,subnode);
    ...
    if (node == (XMLTreeInfo *) 
# 953 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 953 "MagickCore/xml-tree.c"
                                   )
      break;
    for (j=(ssize_t) StringToLong(subnode)-1; j > 0; j--)
    {
      node=GetXMLTreeOrdered(node);
      if (node == (XMLTreeInfo *) 
# 958 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 958 "MagickCore/xml-tree.c"
                                     )
        break;
    }
    if (node == (XMLTreeInfo *) 
# 961 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 961 "MagickCore/xml-tree.c"
                                   )
      break;
    components[i]=DestroyString(components[i]);
  }
...
# 995 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("hidden"))) const char **GetXMLTreeProcessingInstructions(
...
# 1004 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 1004 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 1004 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1004 "MagickCore/xml-tree.c"
...
# 1004 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 1004 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 1004, __extension__ __PRETTY_FUNCTION__); }))
# 1004 "MagickCore/xml-tree.c"
                                         ;
  
# 1005 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 1005 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 1005 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1005 "MagickCore/xml-tree.c"
...
# 1005 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 1005 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 1005, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 1006 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 1008,"...");
  root=(XMLTreeRoot *) xml_info;
  while (root->root.parent != (XMLTreeInfo *) 
# 1010 "MagickCore/xml-tree.c" 3 4
                                             ((void *)0)
# 1010 "MagickCore/xml-tree.c"
                                                 )
    root=(XMLTreeRoot *) root->root.parent;
  i=0;
  while ((root->processing_instructions[i] != (char **) 
# 1013 "MagickCore/xml-tree.c" 3 4
                                                       ((void *)0)
# 1013 "MagickCore/xml-tree.c"
                                                           ) &&
         (strcmp(root->processing_instructions[i][0],target) != 0))
    i++;
  if (root->processing_instructions[i] == (char **) 
# 1016 "MagickCore/xml-tree.c" 3 4
                                                   ((void *)0)
# 1016 "MagickCore/xml-tree.c"
                                                       )
    return((const char **) sentinel);
  return((const char **) (root->processing_instructions[i]+1));
}
# 1043 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("default"))) XMLTreeInfo *GetXMLTreeSibling(XMLTreeInfo *xml_info)
{
  
# 1045 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 1045 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 1045 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1045 "MagickCore/xml-tree.c"
...
# 1045 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 1045 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 1045, __extension__ __PRETTY_FUNCTION__); }))
# 1045 "MagickCore/xml-tree.c"
                                         ;
  
# 1046 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 1046 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 1046 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1046 "MagickCore/xml-tree.c"
...
# 1046 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 1046 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 1046, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 1047 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 1049,"...");
  return(xml_info->sibling);
}
# 1075 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("default"))) const char *GetXMLTreeTag(XMLTreeInfo *xml_info)
{
  
# 1077 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 1077 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 1077 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1077 "MagickCore/xml-tree.c"
...
# 1077 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 1077 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 1077, __extension__ __PRETTY_FUNCTION__); }))
# 1077 "MagickCore/xml-tree.c"
                                         ;
  
# 1078 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 1078 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 1078 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1078 "MagickCore/xml-tree.c"
...
# 1078 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 1078 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 1078, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 1079 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 1081,"...");
  return(xml_info->tag);
}
# 1113 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("hidden"))) XMLTreeInfo *InsertTagIntoXMLTree(XMLTreeInfo *xml_info,
  XMLTreeInfo *child,const size_t offset)
{
  ...
  child->ordered=(XMLTreeInfo *) 
# 1121 "MagickCore/xml-tree.c" 3 4
                                ((void *)0)
# 1121 "MagickCore/xml-tree.c"
                                    ;
  child->sibling=(XMLTreeInfo *) 
# 1122 "MagickCore/xml-tree.c" 3 4
                                ((void *)0)
# 1122 "MagickCore/xml-tree.c"
                                    ;
  child->next=(XMLTreeInfo *) 
# 1123 "MagickCore/xml-tree.c" 3 4
                             ((void *)0)
# 1123 "MagickCore/xml-tree.c"
                                 ;
  child->offset=offset;
  child->parent=xml_info;
  if (xml_info->child == (XMLTreeInfo *) 
# 1126 "MagickCore/xml-tree.c" 3 4
                                        ((void *)0)
# 1126 "MagickCore/xml-tree.c"
                                            )
    {
  ...
  if (head->offset > offset)
    ...
    {
      node=head;
      while ((node->ordered != (XMLTreeInfo *) 
# 1140 "MagickCore/xml-tree.c" 3 4
                                              ((void *)0)
# 1140 "MagickCore/xml-tree.c"
                                                  ) &&
  ...
  previous=(XMLTreeInfo *) 
# 1146 "MagickCore/xml-tree.c" 3 4
                          ((void *)0)
# 1146 "MagickCore/xml-tree.c"
                              ;
  node=head;
  while ((node != (XMLTreeInfo *) 
# 1148 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 1148 "MagickCore/xml-tree.c"
                                     ) && (strcmp(node->tag,child->tag) != 0))
  {
    previous=node;
    node=node->sibling;
  }
  if ((node != (XMLTreeInfo *) 
# 1153 "MagickCore/xml-tree.c" 3 4
                              ((void *)0)
# 1153 "MagickCore/xml-tree.c"
                                  ) && (node->offset <= offset))
    {
      while ((node->next != (XMLTreeInfo *) 
# 1155 "MagickCore/xml-tree.c" 3 4
                                           ((void *)0)
# 1155 "MagickCore/xml-tree.c"
                                               ) &&
    ...
    {
      if ((previous != (XMLTreeInfo *) 
# 1163 "MagickCore/xml-tree.c" 3 4
                                      ((void *)0)
# 1163 "MagickCore/xml-tree.c"
                                          ) && (node != (XMLTreeInfo *) 
# 1163 "MagickCore/xml-tree.c" 3 4
                                                                        ((void *)0)
# 1163 "MagickCore/xml-tree.c"
      ...
      child->next=node;
      previous=(XMLTreeInfo *) 
# 1166 "MagickCore/xml-tree.c" 3 4
                              ((void *)0)
# 1166 "MagickCore/xml-tree.c"
                                  ;
      node=head;
      while ((node != (XMLTreeInfo *) 
# 1168 "MagickCore/xml-tree.c" 3 4
                                     ((void *)0)
# 1168 "MagickCore/xml-tree.c"
                                         ) && (node->offset <= offset))
      {
        previous=node;
        node=node->sibling;
      ...
      child->sibling=node;
      if (previous != (XMLTreeInfo *) 
# 1174 "MagickCore/xml-tree.c" 3 4
                                     ((void *)0)
# 1174 "MagickCore/xml-tree.c"
                                         )
        previous->sibling=child;
    }
  return(child);
}
# 1206 "MagickCore/xml-tree.c"
static char *ConvertUTF16ToUTF8(const char *content,size_t *length)
{
  ...
  if (utf8 == (char *) 
# 1225 "MagickCore/xml-tree.c" 3 4
                      ((void *)0)
# 1225 "MagickCore/xml-tree.c"
                          )
    return((char *) 
# 1226 "MagickCore/xml-tree.c" 3 4
                   ((void *)0)
# 1226 "MagickCore/xml-tree.c"
                       );
  ...
  for (i=2; i < (ssize_t) (*length-1); i+=2)
  {
    ...
    if ((size_t) (j+4096) > extent)
      {
        extent=(size_t) j+4096;
        utf8=(char *) ResizeQuantumMemory(utf8,extent,sizeof(*utf8));
        if (utf8 == (char *) 
# 1254 "MagickCore/xml-tree.c" 3 4
                            ((void *)0)
# 1254 "MagickCore/xml-tree.c"
                                )
          return(utf8);
      }
    if (c < 0x80)
  ...
  *length=(size_t) j;
  ...
  if (utf8 != (char *) 
# 1280 "MagickCore/xml-tree.c" 3 4
                      ((void *)0)
# 1280 "MagickCore/xml-tree.c"
                          )
    utf8[*length]='\0';
  return(utf8);
}
...
static char *ParseEntities(char *xml,char **entities,int state)
{
  ...
  for (xml=p; ; )
  {
    while ((*xml != '\0') && (*xml != '&') && ((*xml != '%') ||
           (state != '%')) && (
# 1319 "MagickCore/xml-tree.c" 3 4
                              ((*__ctype_b_loc ())[(int) ((
# 1319 "MagickCore/xml-tree.c"
                              (int) ((unsigned char) *xml)
# 1319 "MagickCore/xml-tree.c" 3 4
    ...
    if ((state != 'c') && (strncmp(xml,"&#",2) == 0))
      ...
      if (((*xml == '&') && ((state == '&') || (state == ' ') ||
          (state == '*'))) || ((state == '%') && (*xml == '%')))
        {
          ...
          i=0;
          while ((entities[i] != (char *) 
# 1378 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 1378 "MagickCore/xml-tree.c"
                                             ) &&
                 (strncmp(xml+1,entities[i],strlen(entities[i])) != 0))
            i+=2;
          if (entities[i++] == (char *) 
# 1381 "MagickCore/xml-tree.c" 3 4
                                       ((void *)0)
# 1381 "MagickCore/xml-tree.c"
                                           )
            xml++;
          else
            if (entities[i] != (char *) 
# 1384 "MagickCore/xml-tree.c" 3 4
                                       ((void *)0)
# 1384 "MagickCore/xml-tree.c"
                                           )
              {
                ...
                entity=strchr(xml,';');
                if ((entity != (char *) 
# 1391 "MagickCore/xml-tree.c" 3 4
                                       ((void *)0)
# 1391 "MagickCore/xml-tree.c"
                                           ) &&
                    ...
                    if (p != q)
                    ...
                    else
                      {
                        ...
                        extent_xml=(char *) AcquireQuantumMemory(extent+1,
                          sizeof(*extent_xml));
                        if (extent_xml != (char *) 
# 1408 "MagickCore/xml-tree.c" 3 4
                                                  ((void *)0)
# 1408 "MagickCore/xml-tree.c"
                                                      )
                          {
                    ...
                    if (p == (char *) 
# 1416 "MagickCore/xml-tree.c" 3 4
                                     ((void *)0)
# 1416 "MagickCore/xml-tree.c"
                                         )
                      { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1417 "MagickCore/xml-tree.c" 3 4
                     (*__errno_location ())
# 1417 "MagickCore/xml-tree.c"
                     ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1417,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                                                 ;
                    xml=p+offset;
                    entity=strchr(xml,';');
                  }
                if (entity != (char *) 
# 1422 "MagickCore/xml-tree.c" 3 4
                                      ((void *)0)
# 1422 "MagickCore/xml-tree.c"
                                          )
        ...
        if (((state == ' ') || (state == '*')) &&
            (
# 1429 "MagickCore/xml-tree.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 1429 "MagickCore/xml-tree.c"
            (int) ((unsigned char) *xml)
# 1429 "MagickCore/xml-tree.c" 3 4
            ))] & (unsigned short int) _ISspace) 
# 1429 "MagickCore/xml-tree.c"
  ...
  const size_t length,const char state)
{
  ...
  xml_info=root->node;
  if ((xml_info == (XMLTreeInfo *) 
# 1466 "MagickCore/xml-tree.c" 3 4
                                  ((void *)0)
# 1466 "MagickCore/xml-tree.c"
                                      ) || (xml_info->tag == (char *) 
# 1466 "MagickCore/xml-tree.c" 3 4
                                                                      ((void *)0)
# 1466 "MagickCore/xml-tree.c"
  ...
  if ((xml_info->content != (char *) 
# 1471 "MagickCore/xml-tree.c" 3 4
                                    ((void *)0)
# 1471 "MagickCore/xml-tree.c"
                                        ) && (*xml_info->content != '\0'))
    {
    ...
    {
      if (xml_info->content != (char *) 
# 1478 "MagickCore/xml-tree.c" 3 4
                                       ((void *)0)
# 1478 "MagickCore/xml-tree.c"
                                           )
        xml_info->content=DestroyString(xml_info->content);
...
{
  if ((root->node == (XMLTreeInfo *) 
# 1487 "MagickCore/xml-tree.c" 3 4
                                    ((void *)0)
# 1487 "MagickCore/xml-tree.c"
                                        ) ||
      (root->node->tag == (char *) 
# 1488 "MagickCore/xml-tree.c" 3 4
                                  ((void *)0)
# 1488 "MagickCore/xml-tree.c"
                                      ) || (strcmp(tag,root->node->tag) != 0))
    {
      (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1490,OptionWarning,
        "ParseError","unexpected closing tag </%s>",tag);
      return(&root->root);
    }
  root->node=root->node->parent;
  return((XMLTreeInfo *) 
# 1495 "MagickCore/xml-tree.c" 3 4
                        ((void *)0)
# 1495 "MagickCore/xml-tree.c"
                            );
}
  ...
  const size_t depth,char **entities)
{
  ...
  for ( ; ; xml++)
  {
    ...
    i=0;
    while ((entities[i] != (char *) 
# 1518 "MagickCore/xml-tree.c" 3 4
                                   ((void *)0)
# 1518 "MagickCore/xml-tree.c"
                                       ) &&
           (strncmp(entities[i],xml+1,strlen(entities[i])) == 0))
      i+=2;
    if ((entities[i] != (char *) 
# 1521 "MagickCore/xml-tree.c" 3 4
                                ((void *)0)
# 1521 "MagickCore/xml-tree.c"
                                    ) &&
  ...
  if (strcmp(target,"xml") == 0)
    {
      ...
      if ((xml != (char *) 
# 1548 "MagickCore/xml-tree.c" 3 4
                          ((void *)0)
# 1548 "MagickCore/xml-tree.c"
                              ) &&
          (strncmp(xml+strspn(xml+10,"\t\r\n " "='\"")+10,"yes",3) == 0))
        root->standalone=MagickTrue;
      return;
    }
  if (root->processing_instructions[0] == (char **) 
# 1553 "MagickCore/xml-tree.c" 3 4
                                                   ((void *)0)
# 1553 "MagickCore/xml-tree.c"
                                                       )
    {
      root->processing_instructions=(char ***) AcquireCriticalMemory(sizeof(
        *root->processing_instructions));
      *root->processing_instructions=(char **) 
# 1557 "MagickCore/xml-tree.c" 3 4
                                              ((void *)0)
# 1557 "MagickCore/xml-tree.c"
                                                  ;
    }
  i=0;
  while ((root->processing_instructions[i] != (char **) 
# 1560 "MagickCore/xml-tree.c" 3 4
                                                       ((void *)0)
# 1560 "MagickCore/xml-tree.c"
                                                           ) &&
         (strcmp(target,root->processing_instructions[i][0]) != 0))
    i++;
  if (root->processing_instructions[i] == (char **) 
# 1563 "MagickCore/xml-tree.c" 3 4
                                                   ((void *)0)
# 1563 "MagickCore/xml-tree.c"
                                                       )
    {
      ...
      if (root->processing_instructions == (char ***) 
# 1568 "MagickCore/xml-tree.c" 3 4
                                                     ((void *)0)
# 1568 "MagickCore/xml-tree.c"
                                                         )
        { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1569 "MagickCore/xml-tree.c" 3 4
       (*__errno_location ())
# 1569 "MagickCore/xml-tree.c"
       ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1569,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
      root->processing_instructions[i]=(char **) AcquireQuantumMemory(3,
        sizeof(**root->processing_instructions));
      if (root->processing_instructions[i] == (char **) 
# 1572 "MagickCore/xml-tree.c" 3 4
                                                       ((void *)0)
# 1572 "MagickCore/xml-tree.c"
                                                           )
        { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1573 "MagickCore/xml-tree.c" 3 4
       (*__errno_location ())
# 1573 "MagickCore/xml-tree.c"
       ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1573,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
      root->processing_instructions[i+1]=(char **) 
# 1574 "MagickCore/xml-tree.c" 3 4
                                                  ((void *)0)
# 1574 "MagickCore/xml-tree.c"
                                                      ;
      root->processing_instructions[i][0]=ConstantString(target);
      root->processing_instructions[i][1]=(char *)
        root->processing_instructions[i+1];
      root->processing_instructions[i+1]=(char **) 
# 1578 "MagickCore/xml-tree.c" 3 4
                                                  ((void *)0)
# 1578 "MagickCore/xml-tree.c"
                                                      ;
      root->processing_instructions[i][2]=ConstantString("");
    }
  j=1;
  while (root->processing_instructions[i][j] != (char *) 
# 1582 "MagickCore/xml-tree.c" 3 4
                                                        ((void *)0)
# 1582 "MagickCore/xml-tree.c"
                                                            )
    j++;
  root->processing_instructions[i]=(char **) ResizeQuantumMemory(
    ...
    sizeof(**root->processing_instructions));
  if (root->processing_instructions[i] == (char **) 
# 1587 "MagickCore/xml-tree.c" 3 4
                                                   ((void *)0)
# 1587 "MagickCore/xml-tree.c"
                                                       )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1588 "MagickCore/xml-tree.c" 3 4
   (*__errno_location ())
# 1588 "MagickCore/xml-tree.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1588,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  root->processing_instructions[i][j+2]=(char *) ResizeQuantumMemory(
    root->processing_instructions[i][j+1],(size_t) (j+1),
    sizeof(***root->processing_instructions));
  if (root->processing_instructions[i][j+2] == (char *) 
# 1592 "MagickCore/xml-tree.c" 3 4
                                                       ((void *)0)
# 1592 "MagickCore/xml-tree.c"
                                                           )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1593 "MagickCore/xml-tree.c" 3 4
   (*__errno_location ())
# 1593 "MagickCore/xml-tree.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1593,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  (void) CopyMagickString(root->processing_instructions[i][j+2]+j-1,
    root->root.tag != (char *) 
# 1595 "MagickCore/xml-tree.c" 3 4
                              ((void *)0) 
# 1595 "MagickCore/xml-tree.c"
                                   ? ">" : "<",2);
  root->processing_instructions[i][j]=ConstantString(xml);
  root->processing_instructions[i][j+1]=(char *) 
# 1597 "MagickCore/xml-tree.c" 3 4
                                                ((void *)0)
# 1597 "MagickCore/xml-tree.c"
                                                    ;
}
  ...
  size_t length,ExceptionInfo *exception)
{
  ...
  n=(char *) 
# 1616 "MagickCore/xml-tree.c" 3 4
            ((void *)0)
# 1616 "MagickCore/xml-tree.c"
                ;
  predefined_entities=(char **) AcquireMagickMemory(sizeof(sentinel));
  if (predefined_entities == (char **) 
# 1618 "MagickCore/xml-tree.c" 3 4
                                      ((void *)0)
# 1618 "MagickCore/xml-tree.c"
                                          )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1619 "MagickCore/xml-tree.c" 3 4
   (*__errno_location ())
# 1619 "MagickCore/xml-tree.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1619,ResourceLimitError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitError-FatalErrorException)+1); };
  (void) memcpy(predefined_entities,sentinel,sizeof(sentinel));
  for (xml[length]='\0'; xml != (char *) 
# 1621 "MagickCore/xml-tree.c" 3 4
                                        ((void *)0)
# 1621 "MagickCore/xml-tree.c"
                                            ; )
  {
    while ((*xml != '\0') && (*xml != '<') && (*xml != '%'))
      xml++;
    ...
    if ((strlen(xml) > 9) && (strncmp(xml,"<!ENTITY",8) == 0))
      {
        ...
        n=xml+strspn(xml,"\t\r\n " "%");
        if ((
# 1637 "MagickCore/xml-tree.c" 3 4
            ((*__ctype_b_loc ())[(int) ((
# 1637 "MagickCore/xml-tree.c"
            (int) ((unsigned char) *n)
# 1637 "MagickCore/xml-tree.c" 3 4
...
# 1637 "MagickCore/xml-tree.c"
        ...
        *xml=';';
        ...
        for (i=0; entities[i] != (char *) 
# 1655 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 1655 "MagickCore/xml-tree.c"
                                             ; i++) ;
        entities=(char **) ResizeQuantumMemory(entities,(size_t) (i+3),
          sizeof(*entities));
        if (entities == (char **) 
# 1658 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 1658 "MagickCore/xml-tree.c"
                                     )
          { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1659 "MagickCore/xml-tree.c" 3 4
         (*__errno_location ())
# 1659 "MagickCore/xml-tree.c"
         ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1659,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
        if (*c == '%')
        ...
        *xml='\0';
        xml=strchr(v,q);
        if (xml != (char *) 
# 1667 "MagickCore/xml-tree.c" 3 4
                           ((void *)0)
# 1667 "MagickCore/xml-tree.c"
                               )
          {
            *xml='\0';
            xml++;
        ...
        entities[i+2]=(char *) 
# 1673 "MagickCore/xml-tree.c" 3 4
                              ((void *)0)
# 1673 "MagickCore/xml-tree.c"
                                  ;
        if (ValidateEntities(n,entities[i+1],0,entities) != MagickFalse)
        ...
        else
          {
            ...
            (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1680,
       ...
       if (strncmp(xml,"<!ATTLIST",9) == 0)
         {
            ...
            if (*t == '\0')
              {
                (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1696,
            ...
            *xml='\0';
            i=0;
            while ((root->attributes[i] != (char **) 
# 1707 "MagickCore/xml-tree.c" 3 4
                                                    ((void *)0)
# 1707 "MagickCore/xml-tree.c"
                                                        ) &&
                   (n != (char *) 
# 1708 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 1708 "MagickCore/xml-tree.c"
                                     ) &&
                   ...
                   (*n != '>'))
            {
              ...
              if (*xml != '\0')
                *xml='\0';
                ...
                {
                  (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1719,
              ...
              xml=(*xml == '(') ? strchr(xml,')') : xml+
                strcspn(xml,"\t\r\n ");
              if (xml == (char *) 
# 1731 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 1731 "MagickCore/xml-tree.c"
                                     )
                {
                  (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1733,
                    OptionWarning,"ParseError","malformed <!ATTLIST");
                  predefined_entities=(char **) RelinquishMagickMemory(
                    predefined_entities);
                  return(MagickFalse);
              ...
              if (*xml == '#')
                {
                  ...
                  if (*c == ' ')
                    continue;
                  v=(char *) 
# 1747 "MagickCore/xml-tree.c" 3 4
                            ((void *)0)
# 1747 "MagickCore/xml-tree.c"
                                ;
                }
              else
                if (((*xml == '"') || (*xml == '\'')) &&
                    ((xml=strchr(v=xml+1,*xml)) != (char *) 
# 1751 "MagickCore/xml-tree.c" 3 4
                                                           ((void *)0)
# 1751 "MagickCore/xml-tree.c"
                                                               ))
                  *xml='\0';
                else
                  {
                    (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1755,
                      OptionWarning,"ParseError","malformed <!ATTLIST");
                    predefined_entities=(char **) RelinquishMagickMemory(
                      predefined_entities);
                    return(MagickFalse);
              ...
              if (root->attributes[i] == (char **) 
# 1761 "MagickCore/xml-tree.c" 3 4
                                                  ((void *)0)
# 1761 "MagickCore/xml-tree.c"
                                                      )
                {
                  ...
                  if (i == 0)
                    ...
                    root->attributes=(char ***) ResizeQuantumMemory(
                      ...
                      sizeof(*root->attributes));
                  if (root->attributes == (char ***) 
# 1773 "MagickCore/xml-tree.c" 3 4
                                                    ((void *)0)
# 1773 "MagickCore/xml-tree.c"
                                                        )
                    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1774 "MagickCore/xml-tree.c" 3 4
                   (*__errno_location ())
# 1774 "MagickCore/xml-tree.c"
                   ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1774,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                                               ;
                  root->attributes[i]=(char **) AcquireQuantumMemory(2,
                    sizeof(**root->attributes));
                  if (root->attributes[i] == (char **) 
# 1778 "MagickCore/xml-tree.c" 3 4
                                                      ((void *)0)
# 1778 "MagickCore/xml-tree.c"
                                                          )
                    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1779 "MagickCore/xml-tree.c" 3 4
                   (*__errno_location ())
# 1779 "MagickCore/xml-tree.c"
                   ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1779,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                                               ;
                  root->attributes[i][0]=ConstantString(t);
                  root->attributes[i][1]=(char *) 
# 1782 "MagickCore/xml-tree.c" 3 4
                                                 ((void *)0)
# 1782 "MagickCore/xml-tree.c"
                                                     ;
                  root->attributes[i+1]=(char **) 
# 1783 "MagickCore/xml-tree.c" 3 4
                                                 ((void *)0)
# 1783 "MagickCore/xml-tree.c"
                                                     ;
                }
              for (j=1; root->attributes[i][j] != (char *) 
# 1785 "MagickCore/xml-tree.c" 3 4
                                                          ((void *)0)
# 1785 "MagickCore/xml-tree.c"
                                                              ; j+=3) ;
              root->attributes[i]=(char **) ResizeQuantumMemory(
                root->attributes[i],(size_t) (j+4),sizeof(**root->attributes));
              if (root->attributes[i] == (char **) 
# 1788 "MagickCore/xml-tree.c" 3 4
                                                  ((void *)0)
# 1788 "MagickCore/xml-tree.c"
                                                      )
                { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1789 "MagickCore/xml-tree.c" 3 4
               (*__errno_location ())
# 1789 "MagickCore/xml-tree.c"
               ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1789,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); }
                                           ;
              root->attributes[i][j+3]=(char *) 
# 1791 "MagickCore/xml-tree.c" 3 4
                                               ((void *)0)
# 1791 "MagickCore/xml-tree.c"
                                                   ;
              root->attributes[i][j+2]=ConstantString(c);
              root->attributes[i][j+1]=(char *) 
# 1793 "MagickCore/xml-tree.c" 3 4
                                               ((void *)0)
# 1793 "MagickCore/xml-tree.c"
                                                   ;
              if (v != (char *) 
# 1794 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 1794 "MagickCore/xml-tree.c"
                                   )
          ...
          if (strncmp(xml,"<?", 2) == 0)
            {
              ...
              xml=strstr(c,"?>");
              if (xml != (char *) 
# 1807 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 1807 "MagickCore/xml-tree.c"
                                     )
                {
...
static void ParseOpenTag(XMLTreeRoot *root,char *tag,char **attributes)
{
  ...
  xml_info=root->node;
  if (xml_info->tag == (char *) 
# 1830 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 1830 "MagickCore/xml-tree.c"
                                   )
    xml_info->tag=ConstantString(tag);
  else
    xml_info=AddChildToXMLTree(xml_info,tag,strlen(xml_info->content));
  if (xml_info != (XMLTreeInfo *) 
# 1834 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 1834 "MagickCore/xml-tree.c"
                                     )
  ...
  *ignore_tags[3] =
  {
    ...
    "rdf:Seq",
    (const char *) 
# 1844 "MagickCore/xml-tree.c" 3 4
                  ((void *)0)
  
# 1845 "MagickCore/xml-tree.c"
 };
...
static inline MagickBooleanType IsSkipTag(const char *tag)
{
  ...
  i=0;
  while (ignore_tags[i] != (const char *) 
# 1853 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 1853 "MagickCore/xml-tree.c"
                                             )
  {
...
__attribute__ ((visibility ("default"))) XMLTreeInfo *NewXMLTree(const char *xml,ExceptionInfo *exception)
{
  char
    **attribute,
    **attributes,
  ...
  if ((xml == (const char *) 
# 1893 "MagickCore/xml-tree.c" 3 4
                            ((void *)0)
# 1893 "MagickCore/xml-tree.c"
                                ) || (strlen(xml) == 0))
    {
      (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1895,OptionWarning,
        "ParseError","root tag missing");
      return((XMLTreeInfo *) 
# 1897 "MagickCore/xml-tree.c" 3 4
                            ((void *)0)
# 1897 "MagickCore/xml-tree.c"
                                );
    }
  root=(XMLTreeRoot *) NewXMLTreeTag((char *) 
# 1899 "MagickCore/xml-tree.c" 3 4
                                             ((void *)0)
# 1899 "MagickCore/xml-tree.c"
                                                 );
  length=strlen(xml);
  utf8=ConvertUTF16ToUTF8(xml,&length);
  if (utf8 == (char *) 
# 1902 "MagickCore/xml-tree.c" 3 4
                      ((void *)0)
# 1902 "MagickCore/xml-tree.c"
                          )
    {
      (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1904,OptionWarning,
        "ParseError","UTF16 to UTF8 failed");
      return((XMLTreeInfo *) 
# 1906 "MagickCore/xml-tree.c" 3 4
                            ((void *)0)
# 1906 "MagickCore/xml-tree.c"
                                );
    }
  ...
  if (*p == '\0')
    {
      (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1915,OptionWarning,
        "ParseError","root tag missing");
      utf8=DestroyString(utf8);
      return((XMLTreeInfo *) 
# 1918 "MagickCore/xml-tree.c" 3 4
                            ((void *)0)
# 1918 "MagickCore/xml-tree.c"
                                );
    }
  attribute=(char **) 
# 1920 "MagickCore/xml-tree.c" 3 4
                     ((void *)0)
# 1920 "MagickCore/xml-tree.c"
                         ;
  l=0;
  ignore_depth=0;
  for (p++; ; p++)
  {
    ...
    c=(*p);
    if ((
# 1928 "MagickCore/xml-tree.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 1928 "MagickCore/xml-tree.c"
        (int) ((unsigned char) *p)
# 1928 "MagickCore/xml-tree.c" 3 4
        ))] & (unsigned short int) _ISalpha) 
# 1928 "MagickCore/xml-tree.c"
        ...
        (*p == ':') || (c < '\0'))
      {
        ...
        if (root->node == (XMLTreeInfo *) 
# 1934 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 1934 "MagickCore/xml-tree.c"
                                             )
          {
            (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1936,
        ...
        p+=strcspn(p,"\t\r\n " "/>");
        while (
# 1942 "MagickCore/xml-tree.c" 3 4
              ((*__ctype_b_loc ())[(int) ((
# 1942 "MagickCore/xml-tree.c"
              (int) ((unsigned char) *p)
# 1942 "MagickCore/xml-tree.c" 3 4
              ))] & (unsigned short int) _ISspace) 
# 1942 "MagickCore/xml-tree.c"
          ...
          *p++='\0';
        if (((
# 1944 "MagickCore/xml-tree.c" 3 4
             ((*__ctype_b_loc ())[(int) ((
# 1944 "MagickCore/xml-tree.c"
             (int) ((unsigned char) *p)
# 1944 "MagickCore/xml-tree.c" 3 4
             ))] & (unsigned short int) _ISalpha) 
# 1944 "MagickCore/xml-tree.c"
            ...
            if ((*p != '\0') && (*p != '/') && (*p != '>'))
              {
                ...
                i=0;
                while ((root->attributes[i] != (char **) 
# 1953 "MagickCore/xml-tree.c" 3 4
                                                        ((void *)0)
# 1953 "MagickCore/xml-tree.c"
                                                            ) &&
            ...
            for (l=0; (*p != '\0') && (*p != '/') && (*p != '>'); l+=2)
            {
              ...
              if (attributes == (char **) 
# 1969 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 1969 "MagickCore/xml-tree.c"
                                             )
                {
                  (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 1971,
                    ResourceLimitError,"MemoryAllocationFailed","`%s'","");
                  utf8=DestroyString(utf8);
                  return(&root->root);
                }
              attributes[l+2]=(char *) 
# 1976 "MagickCore/xml-tree.c" 3 4
                                      ((void *)0)
# 1976 "MagickCore/xml-tree.c"
                                          ;
              attributes[l+1]=(char *) 
# 1977 "MagickCore/xml-tree.c" 3 4
                                      ((void *)0)
# 1977 "MagickCore/xml-tree.c"
                                          ;
              attributes[l]=p;
              p+=strcspn(p,"\t\r\n " "=/>");
              if ((*p != '=') && (
# 1980 "MagickCore/xml-tree.c" 3 4
                                 ((*__ctype_b_loc ())[(int) ((
# 1980 "MagickCore/xml-tree.c"
                                 (int) ((unsigned char) *p)
# 1980 "MagickCore/xml-tree.c" 3 4
                                 ))] & (unsigned short int) _ISspace) 
# 1980 "MagickCore/xml-tree.c"
                        ...
                        *p++='\0';
                      else
                        {
                          ...
                          (void) ThrowMagickException(exception,
                            "MagickCore/xml-tree.c",__func__,(unsigned long) 2004,OptionWarning,"ParseError",
                            "missing %c",c);
                          utf8=DestroyString(utf8);
                          return(&root->root);
                        }
                      j=1;
                      while ((attribute != (char **) 
# 2010 "MagickCore/xml-tree.c" 3 4
                                                    ((void *)0)
# 2010 "MagickCore/xml-tree.c"
                                                        ) &&
                             (attribute[j] != (char *) 
# 2011 "MagickCore/xml-tree.c" 3 4
                                                      ((void *)0)
# 2011 "MagickCore/xml-tree.c"
                                                          ) &&
                             (strcmp(attribute[j],attributes[l]) != 0))
                        j+=3;
                      attributes[l+1]=ParseEntities(attributes[l+1],
                        root->entities,(attribute != (char **) 
# 2015 "MagickCore/xml-tree.c" 3 4
                                                              ((void *)0)
# 2015 "MagickCore/xml-tree.c"
                                                                  ) &&
                        (attribute[j] != (char *) 
# 2016 "MagickCore/xml-tree.c" 3 4
                                                 ((void *)0)
# 2016 "MagickCore/xml-tree.c"
                                                     ) ? *attribute[j+2] :
                        ' ');
                    }
              ...
              while (
# 2021 "MagickCore/xml-tree.c" 3 4
                    ((*__ctype_b_loc ())[(int) ((
# 2021 "MagickCore/xml-tree.c"
                    (int) ((unsigned char) *p)
# 2021 "MagickCore/xml-tree.c" 3 4
                    ))] & (unsigned short int) _ISspace) 
# 2021 "MagickCore/xml-tree.c"
            ...
            *p++='\0';
            if (((*p != '\0') && (*p != '>')) ||
                ((*p == '\0') && (terminal != '>')))
              {
                if (l != 0)
                  (void) DestroyXMLTreeAttributes(attributes);
                (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2041,
        ...
        else
          {
            ...
            if ((*p == '>') || ((*p == '\0') && (terminal == '>')))
            ...
            else
              {
                if (l != 0)
                  (void) DestroyXMLTreeAttributes(attributes);
                (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2073,
                  OptionWarning,"ParseError","missing >");
                utf8=DestroyString(utf8);
                return(&root->root);
              }
      ...
      if (*p == '/')
        {
          ...
          if ((c == '\0') && (terminal != '>'))
            {
              (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2091,
                OptionWarning,"ParseError","missing >");
              utf8=DestroyString(utf8);
              return(&root->root);
            }
          *p='\0';
          if ((ignore_depth == 0) &&
              (ParseCloseTag(root,tag,exception) != (XMLTreeInfo *) 
# 2098 "MagickCore/xml-tree.c" 3 4
                                                                   ((void *)0)
# 2098 "MagickCore/xml-tree.c"
                                                                       ))
            {
              utf8=DestroyString(utf8);
              return(&root->root);
          ...
          *p=c;
          if (
# 2106 "MagickCore/xml-tree.c" 3 4
             ((*__ctype_b_loc ())[(int) ((
# 2106 "MagickCore/xml-tree.c"
             (int) ((unsigned char) *p)
# 2106 "MagickCore/xml-tree.c" 3 4
             ))] & (unsigned short int) _ISspace) 
# 2106 "MagickCore/xml-tree.c"
        ...
        if (strncmp(p,"!--",3) == 0)
          {
            ...
            p=strstr(p+3,"--");
            if ((p == (char *) 
# 2116 "MagickCore/xml-tree.c" 3 4
                              ((void *)0)
# 2116 "MagickCore/xml-tree.c"
                                  ) || ((*(p+=2) != '>') && (*p != '\0')) ||
                ((*p == '\0') && (terminal != '>')))
              {
                (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2119,
          ...
          if (strncmp(p,"![CDATA[",8) == 0)
            {
              ...
              p=strstr(p,"]]>");
              if (p != (char *) 
# 2132 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 2132 "MagickCore/xml-tree.c"
                                   )
                {
                  p+=2;
                  if (ignore_depth == 0)
                ...
                {
                  (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2140,
            ...
            if (strncmp(p,"!DOCTYPE",8) == 0)
              {
                ...
                if ((*p == '\0') && (terminal != '>'))
                  {
                    (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2159,
              ...
              if (*p == '?')
                {
                  ...
                  do
                  {
                    p=strchr(p,'?');
                    if (p == (char *) 
# 2187 "MagickCore/xml-tree.c" 3 4
                                     ((void *)0)
# 2187 "MagickCore/xml-tree.c"
                                         )
                      break;
                    p++;
                  } while ((*p != '\0') && (*p != '>'));
                  if ((p == (char *) 
# 2191 "MagickCore/xml-tree.c" 3 4
                                    ((void *)0)
# 2191 "MagickCore/xml-tree.c"
                                        ) || ((*p == '\0') &&
                      (terminal != '>')))
                    {
                      (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2194,
                        OptionWarning,"ParseError","unclosed <?");
                      utf8=DestroyString(utf8);
                      return(&root->root);
                    }
                ...
                {
                  (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2203,
                    OptionWarning,"ParseError","unexpected <");
                  utf8=DestroyString(utf8);
                  return(&root->root);
                }
     if ((p == (char *) 
# 2208 "MagickCore/xml-tree.c" 3 4
                       ((void *)0)
# 2208 "MagickCore/xml-tree.c"
                           ) || (*p == '\0'))
       break;
     *p++='\0';
     tag=p;
  ...
  utf8=DestroyString(utf8);
  if (root->node == (XMLTreeInfo *) 
# 2229 "MagickCore/xml-tree.c" 3 4
                                   ((void *)0)
# 2229 "MagickCore/xml-tree.c"
                                       )
    return(&root->root);
  if (root->node->tag == (char *) 
# 2231 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 2231 "MagickCore/xml-tree.c"
                                     )
    {
      (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2233,OptionWarning,
        "ParseError","root tag missing");
      return(&root->root);
    }
  (void) ThrowMagickException(exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2237,OptionWarning,
    "ParseError","unclosed tag: '%s'",root->node->tag);
  return(&root->root);
}
# 2264 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("default"))) XMLTreeInfo *NewXMLTreeTag(const char *tag)
{
  static const char
    *predefined_entities[10 +1] =
    {
      "lt;", "&#60;", "gt;", "&#62;", "quot;", "&#34;",
      "apos;", "&#39;", "amp;", "&#38;", (char *) 
# 2270 "MagickCore/xml-tree.c" 3 4
                                                 ((void *)0)
    
# 2271 "MagickCore/xml-tree.c"
   };
  ...
  if (root == (XMLTreeRoot *) 
# 2277 "MagickCore/xml-tree.c" 3 4
                             ((void *)0)
# 2277 "MagickCore/xml-tree.c"
                                 )
    return((XMLTreeInfo *) 
# 2278 "MagickCore/xml-tree.c" 3 4
                          ((void *)0)
# 2278 "MagickCore/xml-tree.c"
                              );
  (void) memset(root,0,sizeof(*root));
  root->root.tag=(char *) 
# 2280 "MagickCore/xml-tree.c" 3 4
                         ((void *)0)
# 2280 "MagickCore/xml-tree.c"
                             ;
  if (tag != (char *) 
# 2281 "MagickCore/xml-tree.c" 3 4
                     ((void *)0)
# 2281 "MagickCore/xml-tree.c"
                         )
  ...
  if (root->entities == (char **) 
# 2286 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 2286 "MagickCore/xml-tree.c"
                                     )
    return((XMLTreeInfo *) 
# 2287 "MagickCore/xml-tree.c" 3 4
                          ((void *)0)
# 2287 "MagickCore/xml-tree.c"
                              );
  ...
  root->signature=0xabacadabUL;
  return(&root->root);
}
# 2320 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("hidden"))) XMLTreeInfo *PruneTagFromXMLTree(XMLTreeInfo *xml_info)
{
  XMLTreeInfo
    *node;

  
# 2325 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 2325 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 2325 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2325 "MagickCore/xml-tree.c"
...
# 2325 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 2325 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 2325, __extension__ __PRETTY_FUNCTION__); }))
# 2325 "MagickCore/xml-tree.c"
                                         ;
  
# 2326 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 2326 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 2326 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2326 "MagickCore/xml-tree.c"
...
# 2326 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 2326 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 2326, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 2327 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 2329,"...");
  if (xml_info->next != (XMLTreeInfo *) 
# 2330 "MagickCore/xml-tree.c" 3 4
                                       ((void *)0)
# 2330 "MagickCore/xml-tree.c"
                                           )
    xml_info->next->sibling=xml_info->sibling;
  if (xml_info->parent != (XMLTreeInfo *) 
# 2332 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 2332 "MagickCore/xml-tree.c"
                                             )
    {
          ...
          if (strcmp(node->tag,xml_info->tag) != 0)
            {
              ...
              if (node->sibling != xml_info)
                ...
                node->sibling=(xml_info->next != (XMLTreeInfo *) 
# 2350 "MagickCore/xml-tree.c" 3 4
                                                                ((void *)0)
# 2350 "MagickCore/xml-tree.c"
                                                                    ) ?
                  xml_info->next : node->sibling->sibling;
            }
          while ((node->next != (XMLTreeInfo *) 
# 2353 "MagickCore/xml-tree.c" 3 4
                                               ((void *)0)
# 2353 "MagickCore/xml-tree.c"
                                                   ) &&
                 (node->next != xml_info))
            node=node->next;
          if (node->next != (XMLTreeInfo *) 
# 2356 "MagickCore/xml-tree.c" 3 4
                                           ((void *)0)
# 2356 "MagickCore/xml-tree.c"
                                               )
            node->next=node->next->next;
        }
    }
  xml_info->ordered=(XMLTreeInfo *) 
# 2360 "MagickCore/xml-tree.c" 3 4
                                   ((void *)0)
# 2360 "MagickCore/xml-tree.c"
                                       ;
  xml_info->sibling=(XMLTreeInfo *) 
# 2361 "MagickCore/xml-tree.c" 3 4
                                   ((void *)0)
# 2361 "MagickCore/xml-tree.c"
                                       ;
  xml_info->next=(XMLTreeInfo *) 
# 2362 "MagickCore/xml-tree.c" 3 4
                                ((void *)0)
# 2362 "MagickCore/xml-tree.c"
                                    ;
  return(xml_info);
}
# 2394 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("hidden"))) XMLTreeInfo *SetXMLTreeAttribute(XMLTreeInfo *xml_info,
...
# 2401 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 2401 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 2401 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2401 "MagickCore/xml-tree.c"
...
# 2401 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 2401 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 2401, __extension__ __PRETTY_FUNCTION__); }))
# 2401 "MagickCore/xml-tree.c"
                                         ;
  
# 2402 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 2402 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 2402 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2402 "MagickCore/xml-tree.c"
...
# 2402 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 2402 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 2402, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 2403 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 2405,"...");
  i=0;
  while ((xml_info->attributes[i] != (char *) 
# 2407 "MagickCore/xml-tree.c" 3 4
                                             ((void *)0)
# 2407 "MagickCore/xml-tree.c"
                                                 ) &&
         (strcmp(xml_info->attributes[i],tag) != 0))
    i+=2;
  if (xml_info->attributes[i] == (char *) 
# 2410 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 2410 "MagickCore/xml-tree.c"
                                             )
    {
      ...
      if (value == (const char *) 
# 2415 "MagickCore/xml-tree.c" 3 4
                                 ((void *)0)
# 2415 "MagickCore/xml-tree.c"
                                     )
        return(xml_info);
      if (xml_info->attributes != sentinel)
      ...
      else
        {
          ...
          if (xml_info->attributes != (char **) 
# 2424 "MagickCore/xml-tree.c" 3 4
                                               ((void *)0)
# 2424 "MagickCore/xml-tree.c"
                                                   )
            xml_info->attributes[1]=ConstantString("");
        }
      if (xml_info->attributes == (char **) 
# 2427 "MagickCore/xml-tree.c" 3 4
                                           ((void *)0)
# 2427 "MagickCore/xml-tree.c"
                                               )
        { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 2428 "MagickCore/xml-tree.c" 3 4
       (*__errno_location ())
# 2428 "MagickCore/xml-tree.c"
       ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2428,ResourceLimitFatalError,"UnableToAcquireString", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
      xml_info->attributes[i]=ConstantString(tag);
      xml_info->attributes[i+2]=(char *) 
# 2430 "MagickCore/xml-tree.c" 3 4
                                        ((void *)0)
# 2430 "MagickCore/xml-tree.c"
                                            ;
  ...
  for (j=i; xml_info->attributes[j] != (char *) 
# 2436 "MagickCore/xml-tree.c" 3 4
                                               ((void *)0)
# 2436 "MagickCore/xml-tree.c"
                                                   ; j+=2) ;
  if (xml_info->attributes[i+1] != (char *) 
# 2437 "MagickCore/xml-tree.c" 3 4
                                           ((void *)0)
# 2437 "MagickCore/xml-tree.c"
                                               )
    xml_info->attributes[i+1]=DestroyString(xml_info->attributes[i+1]);
  if (value != (const char *) 
# 2439 "MagickCore/xml-tree.c" 3 4
                             ((void *)0)
# 2439 "MagickCore/xml-tree.c"
                                 )
    {
  ...
  if (xml_info->attributes[i] != (char *) 
# 2444 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 2444 "MagickCore/xml-tree.c"
                                             )
  ...
  if (xml_info->attributes == (char **) 
# 2450 "MagickCore/xml-tree.c" 3 4
                                       ((void *)0)
# 2450 "MagickCore/xml-tree.c"
                                           )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 2451 "MagickCore/xml-tree.c" 3 4
   (*__errno_location ())
# 2451 "MagickCore/xml-tree.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/xml-tree.c",__func__,(unsigned long) 2451,ResourceLimitFatalError,"UnableToAcquireString", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  j-=2;
  (void) memmove(xml_info->attributes[j+1]+(i/2),xml_info->attributes[j+1]+
    (i/2)+1,(size_t) (((j+2)/2)-(i/2))*sizeof(**xml_info->attributes));
  return(xml_info);
}
# 2484 "MagickCore/xml-tree.c"
__attribute__ ((visibility ("default"))) XMLTreeInfo *SetXMLTreeContent(XMLTreeInfo *xml_info,
  const char *content)
{
  
# 2487 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 2487 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 2487 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2487 "MagickCore/xml-tree.c"
...
# 2487 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 2487 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 2487, __extension__ __PRETTY_FUNCTION__); }))
# 2487 "MagickCore/xml-tree.c"
                                         ;
  
# 2488 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 2488 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 2488 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2488 "MagickCore/xml-tree.c"
...
# 2488 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 2488 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 2488, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 2489 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 2491,"...");
  if (xml_info->content != (char *) 
# 2492 "MagickCore/xml-tree.c" 3 4
                                   ((void *)0)
# 2492 "MagickCore/xml-tree.c"
                                       )
    xml_info->content=DestroyString(xml_info->content);
  xml_info->content=(char *) ConstantString(content);
  return(xml_info);
}
# 2521 "MagickCore/xml-tree.c"
  ...
  char **destination,size_t *length,size_t *extent,MagickBooleanType pedantic)
{
  ...
  if (canonical_content == (char *) 
# 2539 "MagickCore/xml-tree.c" 3 4
                                   ((void *)0)
# 2539 "MagickCore/xml-tree.c"
                                       )
    return(*destination);
  if ((*length+strlen(canonical_content)+4096) > *extent)
    {
      *extent=(*length)+strlen(canonical_content)+4096;
      *destination=(char *) ResizeQuantumMemory(*destination,*extent,
        sizeof(**destination));
      if (*destination == (char *) 
# 2546 "MagickCore/xml-tree.c" 3 4
                                  ((void *)0)
# 2546 "MagickCore/xml-tree.c"
                                      )
        return(*destination);
    }
  ...
  size_t *extent,size_t start,char ***attributes)
{
  ...
  content=(char *) "";
  if (xml_info->parent != (XMLTreeInfo *) 
# 2572 "MagickCore/xml-tree.c" 3 4
                                         ((void *)0)
# 2572 "MagickCore/xml-tree.c"
                                             )
  ...
  *source=EncodePredefinedEntities(content+start,(ssize_t) (xml_info->offset-
  ...
  if ((*length+strlen(xml_info->tag)+4096) > *extent)
    {
      *extent=(*length)+strlen(xml_info->tag)+4096;
      *source=(char *) ResizeQuantumMemory(*source,*extent,sizeof(**source));
      if (*source == (char *) 
# 2581 "MagickCore/xml-tree.c" 3 4
                             ((void *)0)
# 2581 "MagickCore/xml-tree.c"
                                 )
        return(*source);
    }
  *length+=(size_t) FormatLocaleString(*source+(*length),*extent,
  ...
  for (i=0; xml_info->attributes[i]; i+=2)
  {
    ...
    if (attribute != xml_info->attributes[i+1])
      continue;
    if ((*length+strlen(xml_info->attributes[i])+4096) > *extent)
      {
        *extent=(*length)+strlen(xml_info->attributes[i])+4096;
        *source=(char *) ResizeQuantumMemory(*source,*extent,sizeof(**source));
        if (*source == (char *) 
# 2595 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 2595 "MagickCore/xml-tree.c"
                                   )
          return((char *) 
# 2596 "MagickCore/xml-tree.c" 3 4
                         ((void *)0)
# 2596 "MagickCore/xml-tree.c"
                             );
      }
  ...
  i=0;
  while ((attributes[i] != (char **) 
# 2605 "MagickCore/xml-tree.c" 3 4
                                    ((void *)0)
# 2605 "MagickCore/xml-tree.c"
                                        ) &&
         (strcmp(attributes[i][0],xml_info->tag) != 0))
    i++;
  j=1;
  while ((attributes[i] != (char **) 
# 2609 "MagickCore/xml-tree.c" 3 4
                                    ((void *)0)
# 2609 "MagickCore/xml-tree.c"
                                        ) &&
         (attributes[i][j] != (char *) 
# 2610 "MagickCore/xml-tree.c" 3 4
                                      ((void *)0)
# 2610 "MagickCore/xml-tree.c"
                                          ))
  {
    if ((attributes[i][j+1] == (char *) 
# 2612 "MagickCore/xml-tree.c" 3 4
                                       ((void *)0)
# 2612 "MagickCore/xml-tree.c"
                                           ) ||
    ...
    if ((*length+strlen(attributes[i][j])+4096) > *extent)
      {
        *extent=(*length)+strlen(attributes[i][j])+4096;
        *source=(char *) ResizeQuantumMemory(*source,*extent,sizeof(**source));
        if (*source == (char *) 
# 2622 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 2622 "MagickCore/xml-tree.c"
                                   )
          return((char *) 
# 2623 "MagickCore/xml-tree.c" 3 4
                         ((void *)0)
# 2623 "MagickCore/xml-tree.c"
                             );
      }
    *length+=(size_t) FormatLocaleString(*source+(*length),*extent," %s=\"",
      attributes[i][j]);
  ...
  *length+=(size_t) FormatLocaleString(*source+(*length),*extent,
    *xml_info->content ? ">" : "/>");
  if (xml_info->child != (XMLTreeInfo *) 
# 2634 "MagickCore/xml-tree.c" 3 4
                                        ((void *)0)
# 2634 "MagickCore/xml-tree.c"
                                            )
  ...
  if ((*length+strlen(xml_info->tag)+4096) > *extent)
    {
      ...
      *source=(char *) ResizeQuantumMemory(*source,*extent,sizeof(**source));
      if (*source == (char *) 
# 2643 "MagickCore/xml-tree.c" 3 4
                             ((void *)0)
# 2643 "MagickCore/xml-tree.c"
                                 )
        return((char *) 
# 2644 "MagickCore/xml-tree.c" 3 4
                       ((void *)0)
# 2644 "MagickCore/xml-tree.c"
                           );
    }
  ...
  while ((offset < xml_info->offset) && (content[offset] != '\0'))
    offset++;
  if (xml_info->ordered != (XMLTreeInfo *) 
# 2651 "MagickCore/xml-tree.c" 3 4
                                          ((void *)0)
# 2651 "MagickCore/xml-tree.c"
                                              )
...
__attribute__ ((visibility ("default"))) char *XMLTreeInfoToXML(XMLTreeInfo *xml_info)
{
  char
    *p,
    *q,
...
# 2683 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 2683 "MagickCore/xml-tree.c"
 xml_info != (XMLTreeInfo *) 
# 2683 "MagickCore/xml-tree.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2683 "MagickCore/xml-tree.c"
...
# 2683 "MagickCore/xml-tree.c"
 "xml_info != (XMLTreeInfo *) NULL"
# 2683 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 2683, __extension__ __PRETTY_FUNCTION__); }))
# 2683 "MagickCore/xml-tree.c"
                                         ;
  
# 2684 "MagickCore/xml-tree.c" 3 4
 ((void) sizeof ((
# 2684 "MagickCore/xml-tree.c"
 (xml_info->signature == 0xabacadabUL) || (((XMLTreeRoot *) xml_info)->signature == 0xabacadabUL)
# 2684 "MagickCore/xml-tree.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2684 "MagickCore/xml-tree.c"
...
# 2684 "MagickCore/xml-tree.c"
 "(xml_info->signature == MagickCoreSignature) || (((XMLTreeRoot *) xml_info)->signature == MagickCoreSignature)"
# 2684 "MagickCore/xml-tree.c" 3 4
 , "MagickCore/xml-tree.c", 2684, __extension__ __PRETTY_FUNCTION__); }))
                                                                        
# 2685 "MagickCore/xml-tree.c"
                                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/xml-tree.c",__func__,(unsigned long) 2687,"...");
  if (xml_info->tag == (char *) 
# 2688 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 2688 "MagickCore/xml-tree.c"
                                   )
    return((char *) 
# 2689 "MagickCore/xml-tree.c" 3 4
                   ((void *)0)
# 2689 "MagickCore/xml-tree.c"
                       );
  xml=AcquireString((char *) 
# 2690 "MagickCore/xml-tree.c" 3 4
                            ((void *)0)
# 2690 "MagickCore/xml-tree.c"
                                );
  length=0;
  extent=4096;
  root=(XMLTreeRoot *) xml_info;
  while (root->root.parent != (XMLTreeInfo *) 
# 2694 "MagickCore/xml-tree.c" 3 4
                                             ((void *)0)
# 2694 "MagickCore/xml-tree.c"
                                                 )
    root=(XMLTreeRoot *) root->root.parent;
  parent=xml_info->parent;
  if (parent == (XMLTreeInfo *) 
# 2697 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 2697 "MagickCore/xml-tree.c"
                                   )
    for (i=0; root->processing_instructions[i] != (char **) 
# 2698 "MagickCore/xml-tree.c" 3 4
                                                           ((void *)0)
# 2698 "MagickCore/xml-tree.c"
                                                               ; i++)
    {
      ...
      for (j=1; p != (char *) 
# 2705 "MagickCore/xml-tree.c" 3 4
                             ((void *)0)
# 2705 "MagickCore/xml-tree.c"
                                 ; j++)
      {
        ...
        if ((length+strlen(p)+strlen(q)+4096) > extent)
          {
            extent=length+strlen(p)+strlen(q)+4096;
            xml=(char *) ResizeQuantumMemory(xml,extent,sizeof(*xml));
            if (xml == (char *) 
# 2717 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 2717 "MagickCore/xml-tree.c"
                                   )
              return(xml);
          }
  ...
  ordered=xml_info->ordered;
  xml_info->parent=(XMLTreeInfo *) 
# 2726 "MagickCore/xml-tree.c" 3 4
                                  ((void *)0)
# 2726 "MagickCore/xml-tree.c"
                                      ;
  xml_info->ordered=(XMLTreeInfo *) 
# 2727 "MagickCore/xml-tree.c" 3 4
                                   ((void *)0)
# 2727 "MagickCore/xml-tree.c"
                                       ;
  xml=XMLTreeTagToXML(xml_info,&xml,&length,&extent,0,root->attributes);
  xml_info->parent=parent;
  xml_info->ordered=ordered;
  if (parent == (XMLTreeInfo *) 
# 2731 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 2731 "MagickCore/xml-tree.c"
                                   )
    for (i=0; root->processing_instructions[i] != (char **) 
# 2732 "MagickCore/xml-tree.c" 3 4
                                                           ((void *)0)
# 2732 "MagickCore/xml-tree.c"
                                                               ; i++)
    {
      ...
      p=root->processing_instructions[i][1];
      for (j=1; p != (char *) 
# 2739 "MagickCore/xml-tree.c" 3 4
                             ((void *)0)
# 2739 "MagickCore/xml-tree.c"
                                 ; j++)
      {
        if (root->processing_instructions[i][k][j-1] == '<')
          {
        ...
        if ((length+strlen(p)+strlen(q)+4096) > extent)
          {
            ...
            xml=(char *) ResizeQuantumMemory(xml,extent,sizeof(*xml));
            if (xml == (char *) 
# 2751 "MagickCore/xml-tree.c" 3 4
                               ((void *)0)
# 2751 "MagickCore/xml-tree.c"
                                   )
              return(xml);
          }
