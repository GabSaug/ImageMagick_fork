# 0 "MagickCore/client.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/client.c"
# 42 "MagickCore/client.c"
...
extern __attribute__ ((visibility ("default"))) void
  ...
  StripString(char *);
# 46 "MagickCore/client.c" 2
# 65 "MagickCore/client.c"
__attribute__ ((visibility ("default"))) const char *GetClientName(void)
{
  return(SetClientName((const char *) 
# 67 "MagickCore/client.c" 3 4
                                     ((void *)0)
# 67 "MagickCore/client.c"
                                         ));
}
# 88 "MagickCore/client.c"
__attribute__ ((visibility ("default"))) const char *GetClientPath(void)
{
  return(SetClientPath((const char *) 
# 90 "MagickCore/client.c" 3 4
                                     ((void *)0)
# 90 "MagickCore/client.c"
                                         ));
}
# 115 "MagickCore/client.c"
__attribute__ ((visibility ("default"))) const char *SetClientName(const char *name)
{
  static char
    client_name[256] = "";

  if ((name != (char *) 
# 120 "MagickCore/client.c" 3 4
                       ((void *)0)
# 120 "MagickCore/client.c"
                           ) && (*name != '\0'))
    {
      (void) CopyMagickString(client_name,name,sizeof(client_name));
      (void) LogMagickEvent(ConfigureEvent,"MagickCore/client.c",__func__,(unsigned long) 123,"%s",client_name);
    }
  return(*client_name == '\0' ? "Magick" : client_name);
}
# 152 "MagickCore/client.c"
__attribute__ ((visibility ("default"))) const char *SetClientPath(const char *path)
{
  static char
    client_path[4096] = "";

  if ((path != (char *) 
# 157 "MagickCore/client.c" 3 4
                       ((void *)0)
# 157 "MagickCore/client.c"
                           ) && (*path != '\0'))
    {
      (void) CopyMagickString(client_path,path,4096);
      (void) LogMagickEvent(ConfigureEvent,"MagickCore/client.c",__func__,(unsigned long) 160,"%s",path);
    }
  return(client_path);
}
