# 0 "MagickCore/color.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/color.c"
# 43 "MagickCore/color.c"
...
# 75 "MagickCore/color.c" 2
# 84 "MagickCore/color.c"
...
static LinkedListInfo
  *color_cache = (LinkedListInfo *) 
# 791 "MagickCore/color.c" 3 4
                                   ((void *)0)
# 791 "MagickCore/color.c"
                                       ;

static SemaphoreInfo
  *color_semaphore = (SemaphoreInfo *) 
# 794 "MagickCore/color.c" 3 4
                                      ((void *)0)
# 794 "MagickCore/color.c"
                                          ;
...
# 861 "MagickCore/color.c" 3 4
                                         ((void *)0)
# 861 "MagickCore/color.c"
                                             )
    {
  ...
  for (i=0; i < (ssize_t) (sizeof(Colormap)/sizeof(*Colormap)); i++)
  {
    ...
    if (color_info == (ColorInfo *) 
# 885 "MagickCore/color.c" 3 4
                                   ((void *)0)
# 885 "MagickCore/color.c"
                                       )
      {
        (void) ThrowMagickException(exception,"MagickCore/color.c",__func__,(unsigned long) 887,
    ...
    GetPixelInfo((Image *) 
# 894 "MagickCore/color.c" 3 4
                          ((void *)0)
# 894 "MagickCore/color.c"
                              ,&color_info->color);
    ...
    color_info->color.alpha=(double) ((Quantum) 65535.0)*(double) p->alpha;
    color_info->compliance=(ComplianceType) p->compliance;
    color_info->exempt=MagickTrue;
    color_info->signature=0xabacadabUL;
    status&=(MagickStatusType) AppendValueToLinkedList(cache,color_info);
    if (status == MagickFalse)
      (void) ThrowMagickException(exception,"MagickCore/color.c",__func__,(unsigned long) 904,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",color_info->name);
  }
  return(cache);
}
# 928 "MagickCore/color.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType ColorComponentGenesis(void)
{
  if (color_semaphore == (SemaphoreInfo *) 
# 930 "MagickCore/color.c" 3 4
                                          ((void *)0)
# 930 "MagickCore/color.c"
                                              )
    color_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 954 "MagickCore/color.c"
static void *DestroyColorElement(void *color_info)
{
  ...
  if (p->exempt == MagickFalse)
    {
      if (p->path != (char *) 
# 962 "MagickCore/color.c" 3 4
                             ((void *)0)
# 962 "MagickCore/color.c"
                                 )
        p->path=DestroyString(p->path);
      if (p->name != (char *) 
# 964 "MagickCore/color.c" 3 4
                             ((void *)0)
# 964 "MagickCore/color.c"
                                 )
        p->name=DestroyString(p->name);
    }
  p=(ColorInfo *) RelinquishMagickMemory(p);
  return((void *) 
# 968 "MagickCore/color.c" 3 4
                 ((void *)0)
# 968 "MagickCore/color.c"
                     );
}

__attribute__ ((visibility ("hidden"))) void ColorComponentTerminus(void)
{
  if (color_semaphore == (SemaphoreInfo *) 
# 973 "MagickCore/color.c" 3 4
                                          ((void *)0)
# 973 "MagickCore/color.c"
                                              )
    ActivateSemaphoreInfo(&color_semaphore);
  LockSemaphoreInfo(color_semaphore);
  if (color_cache != (LinkedListInfo *) 
# 976 "MagickCore/color.c" 3 4
                                       ((void *)0)
# 976 "MagickCore/color.c"
                                           )
...
# 1010 "MagickCore/color.c"
__attribute__ ((visibility ("default"))) const ColorInfo *GetColorCompliance(const char *name,
...
# 1025 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1025 "MagickCore/color.c"
...
# 1025 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1025, __extension__ __PRETTY_FUNCTION__); }))
# 1025 "MagickCore/color.c"
                                            ;
  if (IsColorCacheInstantiated(exception) == MagickFalse)
    return((const ColorInfo *) 
# 1027 "MagickCore/color.c" 3 4
                              ((void *)0)
# 1027 "MagickCore/color.c"
                                  );
  ...
  *colorname='\0';
  if (name != (const char *) 
# 1032 "MagickCore/color.c" 3 4
                            ((void *)0)
# 1032 "MagickCore/color.c"
                                )
    (void) CopyMagickString(colorname,name,4096);
  for (q=colorname; *q != '\0'; q++)
  {
    if (
# 1036 "MagickCore/color.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 1036 "MagickCore/color.c"
       (int) ((unsigned char) *q)
# 1036 "MagickCore/color.c" 3 4
...
# 1036 "MagickCore/color.c"
                                           == 0)
      continue;
    (void) CopyMagickString(q,q+1,4096);
    q--;
  }



  color=(const ColorInfo *) 
# 1044 "MagickCore/color.c" 3 4
                           ((void *)0)
# 1044 "MagickCore/color.c"
                               ;
  LockSemaphoreInfo(color_semaphore);
  p=GetHeadElementInLinkedList(color_cache);
  if ((name == (const char *) 
# 1047 "MagickCore/color.c" 3 4
                             ((void *)0)
# 1047 "MagickCore/color.c"
                                 ) || (LocaleCompare(name,"*") == 0))
    {
      UnlockSemaphoreInfo(color_semaphore);
      if (p != (ElementInfo *) 
# 1050 "MagickCore/color.c" 3 4
                              ((void *)0)
# 1050 "MagickCore/color.c"
                                  )
        color=(const ColorInfo *) p->value;
      return(color);
    }
  while (p != (ElementInfo *) 
# 1054 "MagickCore/color.c" 3 4
                             ((void *)0)
# 1054 "MagickCore/color.c"
                                 )
  {
    color=(const ColorInfo *) p->value;
  ...
  if (p == (ElementInfo *) 
# 1062 "MagickCore/color.c" 3 4
                          ((void *)0)
# 1062 "MagickCore/color.c"
                              )
    {
      (void) ThrowMagickException(exception,"MagickCore/color.c",__func__,(unsigned long) 1064,OptionWarning,
        "UnrecognizedColor","`%s'",name);
      color=(const ColorInfo *) 
# 1066 "MagickCore/color.c" 3 4
                               ((void *)0)
# 1066 "MagickCore/color.c"
                                   ;
    }
  else
...
# 1103 "MagickCore/color.c"
__attribute__ ((visibility ("default"))) const ColorInfo *GetColorInfo(const char *name,
  ExceptionInfo *exception)
{
  return(GetColorCompliance(name,AllCompliance,exception));
}
# 1140 "MagickCore/color.c"
static inline MagickBooleanType IsSVGCompliant(const PixelInfo *pixel)
{
  ...
  if (fabs((double) (((double) ScaleCharToQuantum(ScaleQuantumToChar(ClampToQuantum(pixel->red))))-pixel->red)) >= 1.0e-6)
    return(MagickFalse);
  if (fabs((double) (((double) ScaleCharToQuantum(ScaleQuantumToChar(ClampToQuantum(pixel->green))))-pixel->green)) >= 1.0e-6)
    return(MagickFalse);
  if (fabs((double) (((double) ScaleCharToQuantum(ScaleQuantumToChar(ClampToQuantum(pixel->blue))))-pixel->blue)) >= 1.0e-6)
    return(MagickFalse);
  if ((pixel->colorspace == CMYKColorspace) &&
      (fabs((double) (((double) ScaleCharToQuantum(ScaleQuantumToChar(ClampToQuantum(pixel->black))))-pixel->black)) >= 1.0e-6))
    return(MagickFalse);
  return(MagickTrue);
}

__attribute__ ((visibility ("default"))) void ConcatenateColorComponent(const PixelInfo *pixel,
  const PixelChannel channel,const ComplianceType compliance,char *tuple)
{
  ...
  if ((scale != 100.0f) || (pixel->colorspace == LabColorspace))
    (void) FormatLocaleString(component,4096,"%.*g",
      GetMagickPrecision(),(double) scale*((double) 1.0/(double) ((Quantum) 65535.0))*(double) color);
  else
    (void) FormatLocaleString(component,4096,"%.*g%%",
      GetMagickPrecision(),(double) scale*((double) 1.0/(double) ((Quantum) 65535.0))*(double) color);
  (void) ConcatenateMagickString(tuple,component,4096);
}
# 1272 "MagickCore/color.c"
...
__attribute__ ((visibility ("default"))) const ColorInfo **GetColorInfoList(const char *pattern,
...
# 1305 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1305 "MagickCore/color.c"
 pattern != (char *) 
# 1305 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1305 "MagickCore/color.c"
...
# 1305 "MagickCore/color.c"
 "pattern != (char *) NULL"
# 1305 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1305, __extension__ __PRETTY_FUNCTION__); }))
# 1305 "MagickCore/color.c"
                                 ;
  
# 1306 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1306 "MagickCore/color.c"
...
# 1306 "MagickCore/color.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1306 "MagickCore/color.c"
 "number_colors != (size_t *) NULL"
# 1306 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1306, __extension__ __PRETTY_FUNCTION__); }))
# 1306 "MagickCore/color.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/color.c",__func__,(unsigned long) 1308,"%s",pattern);
  *number_colors=0;
  if (IsColorCacheInstantiated(exception) == MagickFalse)
    return((const ColorInfo **) 
# 1311 "MagickCore/color.c" 3 4
                               ((void *)0)
# 1311 "MagickCore/color.c"
                                   );
  colors=(const ColorInfo **) AcquireQuantumMemory((size_t)
    GetNumberOfElementsInLinkedList(color_cache)+1UL,sizeof(*colors));
  if (colors == (const ColorInfo **) 
# 1314 "MagickCore/color.c" 3 4
                                    ((void *)0)
# 1314 "MagickCore/color.c"
                                        )
    return((const ColorInfo **) 
# 1315 "MagickCore/color.c" 3 4
                               ((void *)0)
# 1315 "MagickCore/color.c"
                                   );
  LockSemaphoreInfo(color_semaphore);
  p=GetHeadElementInLinkedList(color_cache);
  for (i=0; p != (ElementInfo *) 
# 1318 "MagickCore/color.c" 3 4
                                ((void *)0)
# 1318 "MagickCore/color.c"
                                    ; )
  {
    const ColorInfo
      *color;
  ...
  if (i == 0)
  ...
  else
    {
      ...
      colors[i]=(ColorInfo *) 
# 1335 "MagickCore/color.c" 3 4
                             ((void *)0)
# 1335 "MagickCore/color.c"
                                 ;
    }
  *number_colors=(size_t) i;
  return(colors);
}
# 1373 "MagickCore/color.c"
...
__attribute__ ((visibility ("default"))) char **GetColorList(const char *pattern,
  size_t *number_colors,ExceptionInfo *exception)
{
  char
    **colors;
...
# 1400 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1400 "MagickCore/color.c"
 pattern != (char *) 
# 1400 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1400 "MagickCore/color.c"
...
# 1400 "MagickCore/color.c"
 "pattern != (char *) NULL"
# 1400 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1400, __extension__ __PRETTY_FUNCTION__); }))
# 1400 "MagickCore/color.c"
                                 ;
  
# 1401 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1401 "MagickCore/color.c"
 number_colors != (size_t *) 
# 1401 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1401 "MagickCore/color.c"
...
# 1401 "MagickCore/color.c"
 "number_colors != (size_t *) NULL"
# 1401 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1401, __extension__ __PRETTY_FUNCTION__); }))
# 1401 "MagickCore/color.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/color.c",__func__,(unsigned long) 1403,"%s",pattern);
  *number_colors=0;
  if (IsColorCacheInstantiated(exception) == MagickFalse)
    return((char **) 
# 1406 "MagickCore/color.c" 3 4
                    ((void *)0)
# 1406 "MagickCore/color.c"
                        );
  colors=(char **) AcquireQuantumMemory((size_t)
    GetNumberOfElementsInLinkedList(color_cache)+1UL,sizeof(*colors));
  if (colors == (char **) 
# 1409 "MagickCore/color.c" 3 4
                         ((void *)0)
# 1409 "MagickCore/color.c"
                             )
    return((char **) 
# 1410 "MagickCore/color.c" 3 4
                    ((void *)0)
# 1410 "MagickCore/color.c"
                        );
  LockSemaphoreInfo(color_semaphore);
  p=GetHeadElementInLinkedList(color_cache);
  for (i=0; p != (ElementInfo *) 
# 1413 "MagickCore/color.c" 3 4
                                ((void *)0)
# 1413 "MagickCore/color.c"
                                    ; )
  {
    const ColorInfo
      *color;
  ...
  if (i == 0)
  ...
  else
    {
      ...
      colors[i]=(char *) 
# 1430 "MagickCore/color.c" 3 4
                        ((void *)0)
# 1430 "MagickCore/color.c"
                            ;
    }
  *number_colors=(size_t) i;
  return(colors);
}
# 1465 "MagickCore/color.c"
  ...
  const PixelChannel channel,char *tuple)
{
  ...
  if (pixel->depth > 32)
    {
      (void) FormatLocaleString(component,4096,"%08lX%08lX",
  ...
  if (pixel->depth > 16)
    {
      (void) FormatLocaleString(component,4096,"%08X",
  ...
  if (pixel->depth > 8)
    {
      (void) FormatLocaleString(component,4096,"%04X",
        ScaleQuantumToShort(ClampToQuantum(color)));
      (void) ConcatenateMagickString(tuple,component,4096);
      return;
    }
  (void) FormatLocaleString(component,4096,"%02X",
    ScaleQuantumToChar(ClampToQuantum(color)));
  (void) ConcatenateMagickString(tuple,component,4096);
  return;
}

__attribute__ ((visibility ("default"))) void GetColorTuple(const PixelInfo *pixel,
...
# 1539 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1539 "MagickCore/color.c"
 pixel != (const PixelInfo *) 
# 1539 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1539 "MagickCore/color.c"
 pixel != (const PixelInfo *) 
# 1539 "MagickCore/color.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1539 "MagickCore/color.c"
 "pixel != (const PixelInfo *) NULL"
# 1539 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1539, __extension__ __PRETTY_FUNCTION__); }))
# 1539 "MagickCore/color.c"
                                          ;
  
# 1540 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1540 "MagickCore/color.c"
 tuple != (char *) 
# 1540 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1540 "MagickCore/color.c"
...
# 1540 "MagickCore/color.c"
 "tuple != (char *) NULL"
# 1540 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1540, __extension__ __PRETTY_FUNCTION__); }))
# 1540 "MagickCore/color.c"
                               ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/color.c",__func__,(unsigned long) 1542,"%s",tuple);
  *tuple='\0';
  if (hex != MagickFalse)
    {
  ...
  (void) ConcatenateMagickString(tuple,CommandOptionToMnemonic(
    MagickColorspaceOptions,(ssize_t) color.colorspace),4096);
  if (color.alpha_trait != UndefinedPixelTrait)
    (void) ConcatenateMagickString(tuple,"a",4096);
  (void) ConcatenateMagickString(tuple,"(",4096);
...
# 1619 "MagickCore/color.c"
static MagickBooleanType IsColorCacheInstantiated(ExceptionInfo *exception)
{
  if (color_cache == (LinkedListInfo *) 
# 1621 "MagickCore/color.c" 3 4
                                       ((void *)0)
# 1621 "MagickCore/color.c"
                                           )
    {
      if (color_semaphore == (SemaphoreInfo *) 
# 1623 "MagickCore/color.c" 3 4
                                              ((void *)0)
# 1623 "MagickCore/color.c"
                                                  )
        ActivateSemaphoreInfo(&color_semaphore);
      LockSemaphoreInfo(color_semaphore);
      if (color_cache == (LinkedListInfo *) 
# 1626 "MagickCore/color.c" 3 4
                                           ((void *)0)
# 1626 "MagickCore/color.c"
                                               )
        color_cache=AcquireColorCache("colors.xml",exception);
      UnlockSemaphoreInfo(color_semaphore);
    }
  return(color_cache != (LinkedListInfo *) 
# 1630 "MagickCore/color.c" 3 4
                                          ((void *)0) 
# 1630 "MagickCore/color.c"
                                               ? MagickTrue : MagickFalse);
}
# 1662 "MagickCore/color.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType IsEquivalentAlpha(const Image *image,
  const PixelInfo *p,const PixelInfo *q)
{
  ...
  if (p->alpha == q->alpha)
    return(MagickTrue);
  fuzz=(((image->fuzz) > (0.70710678118654752440084436210484903928483593768847)) ? (image->fuzz) : (0.70710678118654752440084436210484903928483593768847));
  fuzz*=fuzz;
...
# 1720 "MagickCore/color.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsEquivalentImage(const Image *image,
...
# 1749 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1749 "MagickCore/color.c"
 image != (Image *) 
# 1749 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1749 "MagickCore/color.c"
...
# 1749 "MagickCore/color.c"
 "image != (Image *) NULL"
# 1749 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1749, __extension__ __PRETTY_FUNCTION__); }))
# 1749 "MagickCore/color.c"
                                ;
  
# 1750 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1750 "MagickCore/color.c"
...
# 1750 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1750, __extension__ __PRETTY_FUNCTION__); }))
# 1750 "MagickCore/color.c"
                                                ;
  
# 1751 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1751 "MagickCore/color.c"
 target_image != (Image *) 
# 1751 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1751 "MagickCore/color.c"
...
# 1751 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1751, __extension__ __PRETTY_FUNCTION__); }))
# 1751 "MagickCore/color.c"
                                       ;
  
# 1752 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1752 "MagickCore/color.c"
 target_image->signature == 0xabacadabUL
# 1752 "MagickCore/color.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1752 "MagickCore/color.c"
 target_image->signature == 0xabacadabUL
...
# 1752 "MagickCore/color.c"
 "target_image->signature == MagickCoreSignature"
# 1752 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1752, __extension__ __PRETTY_FUNCTION__); }))
# 1752 "MagickCore/color.c"
                                                       ;
  
# 1753 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1753 "MagickCore/color.c"
 x_offset != (ssize_t *) 
# 1753 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1753 "MagickCore/color.c"
...
# 1753 "MagickCore/color.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1753 "MagickCore/color.c"
 "x_offset != (ssize_t *) NULL"
# 1753 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1753, __extension__ __PRETTY_FUNCTION__); }))
# 1753 "MagickCore/color.c"
                                     ;
  
# 1754 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1754 "MagickCore/color.c"
 y_offset != (ssize_t *) 
# 1754 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1754 "MagickCore/color.c"
...
# 1754 "MagickCore/color.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1754 "MagickCore/color.c"
 "y_offset != (ssize_t *) NULL"
# 1754 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1754, __extension__ __PRETTY_FUNCTION__); }))
# 1754 "MagickCore/color.c"
                                     ;
  
# 1755 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 1755 "MagickCore/color.c"
 exception != (ExceptionInfo *) 
# 1755 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1755 "MagickCore/color.c"
...
# 1755 "MagickCore/color.c"
 "exception != (ExceptionInfo *) NULL"
# 1755 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 1755, __extension__ __PRETTY_FUNCTION__); }))
# 1755 "MagickCore/color.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/color.c",__func__,(unsigned long) 1757,"%s",image->filename);
  x=0;
  status=MagickTrue;
    ...
    for (x=y == 0 ? *x_offset : 0; x < (ssize_t) image->columns; x++)
    {
      for (j=0; j < (ssize_t) target_image->rows; j++)
      {
        for (i=0; i < (ssize_t) target_image->columns; i++)
        {
          ...
          if (p == (const Quantum *) 
# 1773 "MagickCore/color.c" 3 4
                                    ((void *)0)
# 1773 "MagickCore/color.c"
                                        )
            break;
          GetPixelInfoPixel(image,p,&pixel);
          q=GetCacheViewVirtualPixels(target_view,i,j,1,1,exception);
          if (q == (const Quantum *) 
# 1777 "MagickCore/color.c" 3 4
                                    ((void *)0)
# 1777 "MagickCore/color.c"
                                        )
            break;
...
# 1791 "MagickCore/color.c" 3 4
                                                          ((void *)0)
# 1791 "MagickCore/color.c"
                                                              )
      {
        MagickBooleanType
          proceed;

        proceed=SetImageProgress(image,"  Searching image...  ",(MagickOffsetType) y,
          image->rows);
...
# 1839 "MagickCore/color.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType IsEquivalentIntensity(const Image *image,
  const PixelInfo *p,const PixelInfo *q)
{
  double
    fuzz,
...
# 1886 "MagickCore/color.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListColorInfo(FILE *file,
  ExceptionInfo *exception)
{
  char
    tuple[4096];
  ...
  if (file == (const FILE *) 
# 1907 "MagickCore/color.c" 3 4
                            ((void *)0)
# 1907 "MagickCore/color.c"
                                )
    file=
# 1908 "MagickCore/color.c" 3 4
        stdout
# 1908 "MagickCore/color.c"
              ;
  color_info=GetColorInfoList("*",&number_colors,exception);
  if (color_info == (const ColorInfo **) 
# 1910 "MagickCore/color.c" 3 4
                                        ((void *)0)
# 1910 "MagickCore/color.c"
                                            )
    return(MagickFalse);
  path=(const char *) 
# 1912 "MagickCore/color.c" 3 4
                     ((void *)0)
# 1912 "MagickCore/color.c"
                         ;
  for (i=0; i < (ssize_t) number_colors; i++)
  {
    if (color_info[i]->stealth != MagickFalse)
      continue;
    if ((path == (const char *) 
# 1917 "MagickCore/color.c" 3 4
                               ((void *)0)
# 1917 "MagickCore/color.c"
                                   ) ||
        (LocaleCompare(path,color_info[i]->path) != 0))
      {
        if (color_info[i]->path != (char *) 
# 1920 "MagickCore/color.c" 3 4
                                           ((void *)0)
# 1920 "MagickCore/color.c"
                                               )
  ...
  const char *filename,const size_t depth,ExceptionInfo *exception)
{
  ...
  (void) LogMagickEvent(ConfigureEvent,"MagickCore/color.c",__func__,(unsigned long) 1999,
    "Loading color file \"%s\" ...",filename);
  if (xml == (char *) 
# 2001 "MagickCore/color.c" 3 4
                     ((void *)0)
# 2001 "MagickCore/color.c"
                         )
    return(MagickFalse);
  status=MagickTrue;
  color_info=(ColorInfo *) 
# 2004 "MagickCore/color.c" 3 4
                          ((void *)0)
# 2004 "MagickCore/color.c"
                              ;
    ...
    if (LocaleCompare(keyword,"<include") == 0)
      {
        ...
        while (((*token != '/') && (*(token+1) != '>')) && (*q != '\0'))
        {
          ...
          if (LocaleCompare(keyword,"file") == 0)
            {
              if (depth > 600)
                (void) ThrowMagickException(exception,"MagickCore/color.c",__func__,(unsigned long) 2049,
              ...
              else
                {
                  ...
                  if (file_xml != (char *) 
# 2066 "MagickCore/color.c" 3 4
                                          ((void *)0)
# 2066 "MagickCore/color.c"
                                              )
                    {
    ...
    if (color_info == (ColorInfo *) 
# 2089 "MagickCore/color.c" 3 4
                                   ((void *)0)
# 2089 "MagickCore/color.c"
                                       )
      continue;
    if ((LocaleCompare(keyword,"/>") == 0) ||
        (LocaleCompare(keyword,"</policy>") == 0))
      {
        ...
        if (status == MagickFalse)
          (void) ThrowMagickException(exception,"MagickCore/color.c",__func__,(unsigned long) 2096,
            ResourceLimitError,"MemoryAllocationFailed","`%s'",
            color_info->name);
        color_info=(ColorInfo *) 
# 2099 "MagickCore/color.c" 3 4
                                ((void *)0)
# 2099 "MagickCore/color.c"
                                    ;
        continue;
      }
    (void) GetNextToken(q,(const char **) 
# 2102 "MagickCore/color.c" 3 4
                                         ((void *)0)
# 2102 "MagickCore/color.c"
                                             ,extent,token);
    if (*token != '=')
      continue;
    (void) GetNextToken(q,&q,extent,token);
        ...
        if (LocaleCompare((char *) keyword,"compliance") == 0)
          {
            ...
            if (StringLocateSubstring(token,"SVG") != (char *) 
# 2124 "MagickCore/color.c" 3 4
                                                              ((void *)0)
# 2124 "MagickCore/color.c"
                                                                  )
              compliance|=SVGCompliance;
            if (StringLocateSubstring(token,"X11") != (char *) 
# 2126 "MagickCore/color.c" 3 4
                                                              ((void *)0)
# 2126 "MagickCore/color.c"
                                                                  )
              compliance|=X11Compliance;
            if (StringLocateSubstring(token,"XPM") != (char *) 
# 2128 "MagickCore/color.c" 3 4
                                                              ((void *)0)
# 2128 "MagickCore/color.c"
                                                                  )
...
# 2197 "MagickCore/color.c"
static MagickStatusType ParseCSSColor(const char *__restrict__ color,
  GeometryInfo *geometry_info)
{
  ...
  flags=NoValue;
  if ((color == (char *) 
# 2211 "MagickCore/color.c" 3 4
                        ((void *)0)
# 2211 "MagickCore/color.c"
                            ) || (*color == '\0'))
    return(flags);
  q=(char *) color;
  if (*q == '(')
  ...
  for (i=0; (i < 5) && (*q != ')') && (*q != '\0'); i++)
  {
    ...
    while (
# 2268 "MagickCore/color.c" 3 4
          ((*__ctype_b_loc ())[(int) ((
# 2268 "MagickCore/color.c"
          (int) ((unsigned char) *q)
# 2268 "MagickCore/color.c" 3 4
          ))] & (unsigned short int) _ISspace) 
# 2268 "MagickCore/color.c"
...
__attribute__ ((visibility ("default"))) MagickBooleanType QueryColorCompliance(const char *name,
...
# 2303 "MagickCore/color.c" 3 4
 ((void) sizeof ((
# 2303 "MagickCore/color.c"
 color != (PixelInfo *) 
# 2303 "MagickCore/color.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2303 "MagickCore/color.c"
...
# 2303 "MagickCore/color.c" 3 4
 , "MagickCore/color.c", 2303, __extension__ __PRETTY_FUNCTION__); }))
# 2303 "MagickCore/color.c"
                                    ;
  if ((name == (char *) 
# 2304 "MagickCore/color.c" 3 4
                       ((void *)0)
# 2304 "MagickCore/color.c"
                           ) || (*name == '\0'))
    name="#ffffff";
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/color.c",__func__,(unsigned long) 2307,"%s",name);
  if (strlen(name) > 4096)
    {
      (void) ThrowMagickException(exception,"MagickCore/color.c",__func__,(unsigned long) 2310,OptionWarning,
        "UnrecognizedColor","`%s'",name);
      return(MagickFalse);
    }
  while (
# 2314 "MagickCore/color.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 2314 "MagickCore/color.c"
...
# 2314 "MagickCore/color.c"
    ...
    name++;
  GetPixelInfo((Image *) 
# 2316 "MagickCore/color.c" 3 4
                        ((void *)0)
# 2316 "MagickCore/color.c"
                            ,color);
  if (*name == '#')
    {
      char
      ...
      name++;
      for (n=0; 
# 2336 "MagickCore/color.c" 3 4
               ((*__ctype_b_loc ())[(int) ((
# 2336 "MagickCore/color.c"
               (int) ((unsigned char) name[n])
# 2336 "MagickCore/color.c" 3 4
...
# 2360 "MagickCore/color.c" 3 4
                  ((*__ctype_b_loc ())[(int) ((
# 2360 "MagickCore/color.c"
                  (int) ((unsigned char) *name)
# 2360 "MagickCore/color.c" 3 4
                  ))] & (unsigned short int) _ISxdigit) 
# 2360 "MagickCore/color.c"
      ...
      else
        {
          if ((n != 4) && (n != 8) && (n != 16) && (n != 32) && (n != 64))
            {
              (void) ThrowMagickException(exception,"MagickCore/color.c",__func__,(unsigned long) 2367,
...
# 2392 "MagickCore/color.c" 3 4
                  ((*__ctype_b_loc ())[(int) ((
# 2392 "MagickCore/color.c"
                  (int) ((unsigned char) *name)
# 2392 "MagickCore/color.c" 3 4
                  ))] & (unsigned short int) _ISxdigit) 
# 2392 "MagickCore/color.c"
      ...
      color->alpha=(double) ((Quantum) ((Quantum) 65535.0));
      if ((n % 3) != 0)
        {
  ...
  if (strchr(name,'(') != (char *) 
# 2411 "MagickCore/color.c" 3 4
                                  ((void *)0)
# 2411 "MagickCore/color.c"
                                      )
    {
      char
        colorspace[2*4096];
      ...
      (void) CopyMagickString(colorspace,name,4096);
      ...
      if (LocaleNCompare(colorspace,"device-",7) == 0)
        {
          (void) CopyMagickString(colorspace,colorspace+7,4096);
          if (strchr(name,'%') == (char *) 
# 2433 "MagickCore/color.c" 3 4
                                          ((void *)0)
# 2433 "MagickCore/color.c"
                                              )
            scale=(double) ((Quantum) 65535.0);
      ...
      if ((LocaleCompare(colorspace,"color") == 0) ||
          (LocaleCompare(colorspace,"icc-color") == 0))
        {
          ...
          (void) CopyMagickString(colorspace,name+i+2,4096);
      ...
      if (type < 0)
        {
          (void) ThrowMagickException(exception,"MagickCore/color.c",__func__,(unsigned long) 2462,
            OptionWarning,"UnrecognizedColor","`%s'",name);
          return(MagickFalse);
        }
      ...
      if (flags == 0)
        {
          ...
          if (*colorname == '\0')
            {
              (void) ThrowMagickException(exception,"MagickCore/color.c",__func__,(unsigned long) 2501,
                OptionWarning,"UnrecognizedColor","`%s'",name);
              status=MagickFalse;
            }
            ...
            if (color->alpha_trait != UndefinedPixelTrait)
              {
                if ((flags & AlphaValue) != 0)
                  ...
                  color->alpha=(double) ClampToQuantum((MagickRealType) (
                    (double) ((Quantum) 65535.0)*geometry_info.psi));
              }
        }
      if (((flags & ChiValue) != 0) &&
          (color->alpha_trait != UndefinedPixelTrait))
        color->alpha=(double) ClampToQuantum((double) ((Quantum) 65535.0)*
          geometry_info.chi);
      if (color->colorspace == LabColorspace)
        {
          color->red=(MagickRealType) ClampToQuantum((MagickRealType)
            ((double) ((Quantum) 65535.0)*geometry_info.rho/100.0));
          if ((flags & SigmaValue) != 0)
            color->green=(MagickRealType) ClampToQuantum((MagickRealType)
              (scale*geometry_info.sigma+((double) ((Quantum) 65535.0)+1)/2.0));
          if ((flags & XiValue) != 0)
            color->blue=(MagickRealType) ClampToQuantum((MagickRealType)
              (scale*geometry_info.xi+((double) ((Quantum) 65535.0)+1)/2.0));
        }
  ...
  if (p == (const ColorInfo *) 
# 2624 "MagickCore/color.c" 3 4
                              ((void *)0)
# 2624 "MagickCore/color.c"
                                  )
    return(MagickFalse);
  color->colorspace=sRGBColorspace;
  if ((LocaleNCompare(name,"gray",4) == 0) ||
    ...
    color->colorspace=GRAYColorspace;
  color->depth=8;
  color->alpha_trait=p->color.alpha != (double) ((Quantum) ((Quantum) 65535.0)) ? BlendPixelTrait :
    UndefinedPixelTrait;
...
# 2680 "MagickCore/color.c"
__attribute__ ((visibility ("default"))) MagickBooleanType QueryColorname(
  const Image *magick_unused_image __attribute__((unused)),const PixelInfo *color,
  const ComplianceType compliance,char *name,ExceptionInfo *exception)
{
  ...
  *name='\0';
  ...
  p=GetHeadElementInLinkedList(color_cache);
  while (p != (ElementInfo *) 
# 2713 "MagickCore/color.c" 3 4
                             ((void *)0)
# 2713 "MagickCore/color.c"
                                 )
  {
    const ColorInfo
      *value;
    ...
    if (((value->compliance & compliance) != 0) &&
        ((fabs((double) (value->color.red-color->red)) < 1.0e-12)) &&
         (fabs((double) (value->color.green-color->green)) < 1.0e-12) &&
         (fabs((double) (value->color.blue-color->blue)) < 1.0e-12) &&
         (fabs((double) (value->color.alpha-alpha)) < 1.0e-12))
      {
        (void) CopyMagickString(name,value->name,4096);
        break;
      }
    p=p->next;
  }
