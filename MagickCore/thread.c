# 0 "MagickCore/thread.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/thread.c"
# 41 "MagickCore/thread.c"
...
# 84 "MagickCore/thread.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CreateMagickThreadKey(MagickThreadKey *key,
  void (*destructor)(void *))
{

  return(pthread_key_create(key,destructor) == 0 ? MagickTrue : MagickFalse);
# 115 "MagickCore/thread.c"
}
# 139 "MagickCore/thread.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DeleteMagickThreadKey(MagickThreadKey key)
{

  return(pthread_key_delete(key) == 0 ? MagickTrue : MagickFalse);
# 165 "MagickCore/thread.c"
}
# 190 "MagickCore/thread.c"
__attribute__ ((visibility ("default"))) void *GetMagickThreadValue(MagickThreadKey key)
{

  return(pthread_getspecific(key));
# 205 "MagickCore/thread.c"
}
# 233 "MagickCore/thread.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetMagickThreadValue(MagickThreadKey key,
  const void *value)
{

  return(pthread_setspecific(key,value) == 0 ? MagickTrue : MagickFalse);
# 250 "MagickCore/thread.c"
}
