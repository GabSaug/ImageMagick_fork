# 0 "MagickCore/token.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/token.c"
# 43 "MagickCore/token.c"
...
# 97 "MagickCore/token.c"
__attribute__ ((visibility ("default"))) TokenInfo *AcquireTokenInfo(void)
{
  TokenInfo
    *token_info;
...
# 130 "MagickCore/token.c"
__attribute__ ((visibility ("default"))) TokenInfo *DestroyTokenInfo(TokenInfo *token_info)
{
  
# 132 "MagickCore/token.c" 3 4
 ((void) sizeof ((
# 132 "MagickCore/token.c"
...
# 132 "MagickCore/token.c" 3 4
 , "MagickCore/token.c", 132, __extension__ __PRETTY_FUNCTION__); }))
# 132 "MagickCore/token.c"
                                         ;
  
# 133 "MagickCore/token.c" 3 4
 ((void) sizeof ((
# 133 "MagickCore/token.c"
 token_info->signature == 0xabacadabUL
# 133 "MagickCore/token.c" 3 4
...
# 133 "MagickCore/token.c" 3 4
 , "MagickCore/token.c", 133, __extension__ __PRETTY_FUNCTION__); }))
# 133 "MagickCore/token.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/token.c",__func__,(unsigned long) 135,"...");
  token_info->signature=(~0xabacadabUL);
  token_info=(TokenInfo *) RelinquishMagickMemory(token_info);
  return(token_info);
}
# 176 "MagickCore/token.c"
__attribute__ ((visibility ("default"))) __attribute__((__hot__)) size_t GetNextToken(
  const char *__restrict__ start,const char **__restrict__ end,
  const size_t extent,char *__restrict__ token)
{
  char
    *__restrict__ q;
...
# 192 "MagickCore/token.c" 3 4
 ((void) sizeof ((
# 192 "MagickCore/token.c"
 start != (const char *) 
# 192 "MagickCore/token.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 192 "MagickCore/token.c"
...
# 192 "MagickCore/token.c" 3 4
 , "MagickCore/token.c", 192, __extension__ __PRETTY_FUNCTION__); }))
# 192 "MagickCore/token.c"
                                     ;
  
# 193 "MagickCore/token.c" 3 4
 ((void) sizeof ((
# 193 "MagickCore/token.c"
 token != (char *) 
# 193 "MagickCore/token.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 193 "MagickCore/token.c"
...
# 193 "MagickCore/token.c"
 "token != (char *) NULL"
# 193 "MagickCore/token.c" 3 4
 , "MagickCore/token.c", 193, __extension__ __PRETTY_FUNCTION__); }))
# 193 "MagickCore/token.c"
                               ;
  i=0;
  p=start;
  while ((
# 196 "MagickCore/token.c" 3 4
         ((*__ctype_b_loc ())[(int) ((
# 196 "MagickCore/token.c"
         (int) ((unsigned char) *p)
# 196 "MagickCore/token.c" 3 4
...
# 196 "MagickCore/token.c"
  ...
  switch (*p)
  {
    ...
    default:
    {
      ...
      if ((*p != '\0') && (
# 269 "MagickCore/token.c" 3 4
                          ((*__ctype_b_loc ())[(int) ((
# 269 "MagickCore/token.c"
                          (int) ((unsigned char) *p)
# 269 "MagickCore/token.c" 3 4
...
# 269 "MagickCore/token.c"
      ...
      {
        if (((
# 279 "MagickCore/token.c" 3 4
             ((*__ctype_b_loc ())[(int) ((
# 279 "MagickCore/token.c"
             (int) ((unsigned char) *p)
# 279 "MagickCore/token.c" 3 4
             ))] & (unsigned short int) _ISspace) 
# 279 "MagickCore/token.c"
  ...
  if (LocaleNCompare(token,"url(#",5) == 0)
    {
      q=strrchr(token,')');
      if (q != (char *) 
# 312 "MagickCore/token.c" 3 4
                       ((void *)0)
# 312 "MagickCore/token.c"
                           )
        {
          *q='\0';
  ...
  while (
# 318 "MagickCore/token.c" 3 4
        ((*__ctype_b_loc ())[(int) ((
# 318 "MagickCore/token.c"
        (int) ((unsigned char) *p)
# 318 "MagickCore/token.c" 3 4
        ))] & (unsigned short int) _ISspace) 
# 318 "MagickCore/token.c"
    ...
    p++;
  if (end != (const char **) 
# 320 "MagickCore/token.c" 3 4
                            ((void *)0)
# 320 "MagickCore/token.c"
                                )
    *end=(const char *) p;
  return((size_t) (p-start+1));
}
# 354 "MagickCore/token.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GlobExpression(
  const char *__restrict__ expression,const char *__restrict__ pattern,
  const MagickBooleanType case_insensitive)
{
  ...
  if (pattern == (char *) 
# 368 "MagickCore/token.c" 3 4
                         ((void *)0)
# 368 "MagickCore/token.c"
                             )
    return(MagickTrue);
          ...
          if ((GetUTFCode(pattern) == ',') || (GetUTFCode(pattern) == '}'))
            {
              *p='\0';
              ...
              if (match != MagickFalse)
                {
                  expression+=(((strlen(expression)) < (strlen(target))) ? (strlen(expression)) : (strlen(target)));
                  break;
                }
              p=target;
              pattern+=GetUTFOctets(pattern);
...
# 579 "MagickCore/token.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType IsGlob(const char *path)
{
  MagickBooleanType
    status = MagickFalse;
...
__attribute__ ((visibility ("default"))) int Tokenizer(TokenInfo *token_info,const unsigned flag,
