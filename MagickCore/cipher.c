# 0 "MagickCore/cipher.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/cipher.c"
# 41 "MagickCore/cipher.c"
...
# 63 "MagickCore/cipher.c" 2
# 73 "MagickCore/cipher.c"
...
static AESInfo *AcquireAESInfo(void)
{
  ...
  if ((aes_info->key == (StringInfo *) 
# 205 "MagickCore/cipher.c" 3 4
                                      ((void *)0)
# 205 "MagickCore/cipher.c"
                                          ) ||
      (aes_info->encipher_key == (unsigned int *) 
# 206 "MagickCore/cipher.c" 3 4
                                                 ((void *)0)
# 206 "MagickCore/cipher.c"
                                                     ) ||
      (aes_info->decipher_key == (unsigned int *) 
# 207 "MagickCore/cipher.c" 3 4
                                                 ((void *)0)
# 207 "MagickCore/cipher.c"
                                                     ))
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 208 "MagickCore/cipher.c" 3 4
   (*__errno_location ())
# 208 "MagickCore/cipher.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/cipher.c",__func__,(unsigned long) 208,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  aes_info->timestamp=GetMagickTime();
  aes_info->signature=0xabacadabUL;
  return(aes_info);
}
# 236 "MagickCore/cipher.c"
static AESInfo *DestroyAESInfo(AESInfo *aes_info)
{
  
# 238 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 238 "MagickCore/cipher.c"
 aes_info != (AESInfo *) 
# 238 "MagickCore/cipher.c" 3 4
...
# 238 "MagickCore/cipher.c"
 "aes_info != (AESInfo *) NULL"
# 238 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 238, __extension__ __PRETTY_FUNCTION__); }))
# 238 "MagickCore/cipher.c"
                                     ;
  
# 239 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 239 "MagickCore/cipher.c"
 aes_info->signature == 0xabacadabUL
# 239 "MagickCore/cipher.c" 3 4
...
# 239 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 239, __extension__ __PRETTY_FUNCTION__); }))
# 239 "MagickCore/cipher.c"
                                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cipher.c",__func__,(unsigned long) 241,"...");
  if (aes_info->decipher_key != (unsigned int *) 
# 242 "MagickCore/cipher.c" 3 4
                                                ((void *)0)
# 242 "MagickCore/cipher.c"
                                                    )
    aes_info->decipher_key=(unsigned int *) RelinquishMagickMemory(
      aes_info->decipher_key);
  if (aes_info->encipher_key != (unsigned int *) 
# 245 "MagickCore/cipher.c" 3 4
                                                ((void *)0)
# 245 "MagickCore/cipher.c"
                                                    )
    aes_info->encipher_key=(unsigned int *) RelinquishMagickMemory(
      aes_info->encipher_key);
  if (aes_info->key != (StringInfo *) 
# 248 "MagickCore/cipher.c" 3 4
                                     ((void *)0)
# 248 "MagickCore/cipher.c"
                                         )
  ...
  unsigned char *nonce)
{
  ...
  { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 539 "MagickCore/cipher.c" 3 4
 (*__errno_location ())
# 539 "MagickCore/cipher.c"
 ); (void) ThrowMagickException(fatal_exception,"MagickCore/cipher.c",__func__,(unsigned long) 539,ResourceLimitFatalError,"Sequence wrap error `%s'", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
}

__attribute__ ((visibility ("default"))) MagickBooleanType DecipherImage(Image *image,
  const char *passphrase,ExceptionInfo *exception)
{
  ...
  if (passphrase == (const char *) 
# 551 "MagickCore/cipher.c" 3 4
                                  ((void *)0)
# 551 "MagickCore/cipher.c"
                                      )
    return(MagickTrue);
  passkey=StringToStringInfo(passphrase);
  if (passkey == (StringInfo *) 
# 554 "MagickCore/cipher.c" 3 4
                               ((void *)0)
# 554 "MagickCore/cipher.c"
                                   )
    return(MagickFalse);
...
__attribute__ ((visibility ("default"))) MagickBooleanType PasskeyDecipherImage(Image *image,
...
# 611 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 611 "MagickCore/cipher.c"
 image != (Image *) 
# 611 "MagickCore/cipher.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 611 "MagickCore/cipher.c"
...
# 611 "MagickCore/cipher.c"
 "image != (Image *) NULL"
# 611 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 611, __extension__ __PRETTY_FUNCTION__); }))
# 611 "MagickCore/cipher.c"
                                ;
  
# 612 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 612 "MagickCore/cipher.c"
...
# 612 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 612, __extension__ __PRETTY_FUNCTION__); }))
# 612 "MagickCore/cipher.c"
                                                ;
  
# 613 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 613 "MagickCore/cipher.c"
...
# 613 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 613, __extension__ __PRETTY_FUNCTION__); }))
# 613 "MagickCore/cipher.c"
                                            ;
  
# 614 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 614 "MagickCore/cipher.c"
...
# 614 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 614, __extension__ __PRETTY_FUNCTION__); }))
# 614 "MagickCore/cipher.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cipher.c",__func__,(unsigned long) 616,"%s",image->filename);
  if (passkey == (const StringInfo *) 
# 617 "MagickCore/cipher.c" 3 4
                                     ((void *)0)
# 617 "MagickCore/cipher.c"
                                         )
    return(MagickTrue);
  aes_info=AcquireAESInfo();
  key=CloneStringInfo(passkey);
  if (key == (StringInfo *) 
# 621 "MagickCore/cipher.c" 3 4
                           ((void *)0)
# 621 "MagickCore/cipher.c"
                               )
    {
      aes_info=DestroyAESInfo(aes_info);
      { (void) ThrowMagickException(exception,"MagickCore/cipher.c",__func__,(unsigned long) 624,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  nonce=SplitStringInfo(key,GetStringInfoLength(key)/2);
  if (nonce == (StringInfo *) 
# 628 "MagickCore/cipher.c" 3 4
                             ((void *)0)
# 628 "MagickCore/cipher.c"
                                 )
    {
      key=DestroyStringInfo(key);
      aes_info=DestroyAESInfo(aes_info);
      { (void) ThrowMagickException(exception,"MagickCore/cipher.c",__func__,(unsigned long) 632,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  ...
  (void) memcpy(input_block,digest,(((16) < (GetSignatureDigestsize(signature_info))) ? (16) : (GetSignatureDigestsize(signature_info)))
                                           *sizeof(*input_block));
...
# 653 "MagickCore/cipher.c" 3 4
                                                     ((void *)0)
# 653 "MagickCore/cipher.c"
                                                         ,image);
  if (quantum_info == (QuantumInfo *) 
# 654 "MagickCore/cipher.c" 3 4
                                     ((void *)0)
# 654 "MagickCore/cipher.c"
                                         )
    {
      aes_info=DestroyAESInfo(aes_info);
      { (void) ThrowMagickException(exception,"MagickCore/cipher.c",__func__,(unsigned long) 657,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (q == (Quantum *) 
# 673 "MagickCore/cipher.c" 3 4
                        ((void *)0)
# 673 "MagickCore/cipher.c"
                            )
      break;
    length=ExportQuantumPixels(image,image_view,quantum_info,quantum_type,
      pixels,exception);
    p=pixels;
    for (x=0; x < (ssize_t) length; x+=16)
    {
      (void) memcpy(output_block,input_block,16*
        sizeof(*output_block));
      IncrementCipherNonce(16,input_block);
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      break;
    proceed=SetImageProgress(image,"Decipher/Image ",(MagickOffsetType) y,
      image->rows);
...
# 752 "MagickCore/cipher.c"
__attribute__ ((visibility ("default"))) MagickBooleanType EncipherImage(Image *image,
  const char *passphrase,ExceptionInfo *exception)
{
  MagickBooleanType
    status;
  ...
  if (passphrase == (const char *) 
# 761 "MagickCore/cipher.c" 3 4
                                  ((void *)0)
# 761 "MagickCore/cipher.c"
                                      )
    return(MagickTrue);
  passkey=StringToStringInfo(passphrase);
  if (passkey == (StringInfo *) 
# 764 "MagickCore/cipher.c" 3 4
                               ((void *)0)
# 764 "MagickCore/cipher.c"
                                   )
    return(MagickFalse);
...
__attribute__ ((visibility ("default"))) MagickBooleanType PasskeyEncipherImage(Image *image,
  const StringInfo *passkey,ExceptionInfo *exception)
{
...
# 824 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 824 "MagickCore/cipher.c"
 image != (Image *) 
# 824 "MagickCore/cipher.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 824 "MagickCore/cipher.c"
...
# 824 "MagickCore/cipher.c"
 "image != (Image *) NULL"
# 824 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 824, __extension__ __PRETTY_FUNCTION__); }))
# 824 "MagickCore/cipher.c"
                                ;
  
# 825 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 825 "MagickCore/cipher.c"
 image->signature == 0xabacadabUL
# 825 "MagickCore/cipher.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 825 "MagickCore/cipher.c"
...
# 825 "MagickCore/cipher.c"
 "image->signature == MagickCoreSignature"
# 825 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 825, __extension__ __PRETTY_FUNCTION__); }))
# 825 "MagickCore/cipher.c"
                                                ;
  
# 826 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 826 "MagickCore/cipher.c"
 exception != (ExceptionInfo *) 
# 826 "MagickCore/cipher.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 826 "MagickCore/cipher.c"
...
# 826 "MagickCore/cipher.c"
 "exception != (ExceptionInfo *) NULL"
# 826 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 826, __extension__ __PRETTY_FUNCTION__); }))
# 826 "MagickCore/cipher.c"
                                            ;
  
# 827 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 827 "MagickCore/cipher.c"
 exception->signature == 0xabacadabUL
# 827 "MagickCore/cipher.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 827 "MagickCore/cipher.c"
...
# 827 "MagickCore/cipher.c"
 "exception->signature == MagickCoreSignature"
# 827 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 827, __extension__ __PRETTY_FUNCTION__); }))
# 827 "MagickCore/cipher.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cipher.c",__func__,(unsigned long) 829,"%s",image->filename);
  if (passkey == (const StringInfo *) 
# 830 "MagickCore/cipher.c" 3 4
                                     ((void *)0)
# 830 "MagickCore/cipher.c"
                                         )
    return(MagickTrue);
  ...
  key=CloneStringInfo(passkey);
  if (key == (StringInfo *) 
# 836 "MagickCore/cipher.c" 3 4
                           ((void *)0)
# 836 "MagickCore/cipher.c"
                               )
    {
      aes_info=DestroyAESInfo(aes_info);
      { (void) ThrowMagickException(exception,"MagickCore/cipher.c",__func__,(unsigned long) 839,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  nonce=SplitStringInfo(key,GetStringInfoLength(key)/2);
  if (nonce == (StringInfo *) 
# 843 "MagickCore/cipher.c" 3 4
                             ((void *)0)
# 843 "MagickCore/cipher.c"
                                 )
    {
      key=DestroyStringInfo(key);
      aes_info=DestroyAESInfo(aes_info);
      { (void) ThrowMagickException(exception,"MagickCore/cipher.c",__func__,(unsigned long) 847,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  SetAESKey(aes_info,key);
  key=DestroyStringInfo(key);
  ...
  quantum_info=AcquireQuantumInfo((const ImageInfo *) 
# 873 "MagickCore/cipher.c" 3 4
                                                     ((void *)0)
# 873 "MagickCore/cipher.c"
                                                         ,image);
  if (quantum_info == (QuantumInfo *) 
# 874 "MagickCore/cipher.c" 3 4
                                     ((void *)0)
# 874 "MagickCore/cipher.c"
                                         )
    {
      aes_info=DestroyAESInfo(aes_info);
      { (void) ThrowMagickException(exception,"MagickCore/cipher.c",__func__,(unsigned long) 877,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  quantum_type=GetQuantumType(image,exception);
  pixels=(unsigned char *) GetQuantumPixels(quantum_info);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 893 "MagickCore/cipher.c" 3 4
                        ((void *)0)
# 893 "MagickCore/cipher.c"
                            )
      break;
    length=ExportQuantumPixels(image,image_view,quantum_info,quantum_type,
      pixels,exception);
    ...
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      break;
    proceed=SetImageProgress(image,"Encipher/Image ",(MagickOffsetType) y,
      image->rows);
    if (proceed == MagickFalse)
      break;
  }
...
# 1017 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 1017 "MagickCore/cipher.c"
 aes_info != (AESInfo *) 
# 1017 "MagickCore/cipher.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1017 "MagickCore/cipher.c"
...
# 1017 "MagickCore/cipher.c"
 "aes_info != (AESInfo *) NULL"
# 1017 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 1017, __extension__ __PRETTY_FUNCTION__); }))
# 1017 "MagickCore/cipher.c"
                                     ;
  
# 1018 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 1018 "MagickCore/cipher.c"
 aes_info->signature == 0xabacadabUL
# 1018 "MagickCore/cipher.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1018 "MagickCore/cipher.c"
...
# 1018 "MagickCore/cipher.c"
 "aes_info->signature == MagickCoreSignature"
# 1018 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 1018, __extension__ __PRETTY_FUNCTION__); }))
# 1018 "MagickCore/cipher.c"
                                                   ;
  
# 1019 "MagickCore/cipher.c" 3 4
 ((void) sizeof ((
# 1019 "MagickCore/cipher.c"
 key != (StringInfo *) 
# 1019 "MagickCore/cipher.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1019 "MagickCore/cipher.c"
...
# 1019 "MagickCore/cipher.c"
 "key != (StringInfo *) NULL"
# 1019 "MagickCore/cipher.c" 3 4
 , "MagickCore/cipher.c", 1019, __extension__ __PRETTY_FUNCTION__); }))
# 1019 "MagickCore/cipher.c"
                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cipher.c",__func__,(unsigned long) 1021,"...");
  n=4;
  aes_info->rounds=10;
  ...
  (void) memcpy(datum,GetStringInfoDatum(key),(((GetStringInfoLength(key)) < (GetStringInfoLength(aes_info->key))) ? (GetStringInfoLength(key)) : (GetStringInfoLength(aes_info->key)))
                                                                );
  for (i=0; i < n; i++)
