# 0 "MagickCore/cache.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/cache.c"
# 43 "MagickCore/cache.c"
...
# 48 "MagickCore/cache.c" 2
# 1 "./MagickCore/color-private.h" 1
# 28 "./MagickCore/color-private.h"
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
...
# 49 "MagickCore/cache.c" 2
# 1 "./MagickCore/colorspace-private.h" 1
# 30 "./MagickCore/colorspace-private.h"
static inline void ConvertCMYKToRGB(PixelInfo *pixel)
{
  pixel->red=(((double) ((Quantum) 65535.0)-(((double) 1.0/(double) ((Quantum) 65535.0))*pixel->red*
    ((double) ((Quantum) 65535.0)-pixel->black)+pixel->black)));
  pixel->green=(((double) ((Quantum) 65535.0)-(((double) 1.0/(double) ((Quantum) 65535.0))*pixel->green*
    ((double) ((Quantum) 65535.0)-pixel->black)+pixel->black)));
  pixel->blue=(((double) ((Quantum) 65535.0)-(((double) 1.0/(double) ((Quantum) 65535.0))*pixel->blue*
    ((double) ((Quantum) 65535.0)-pixel->black)+pixel->black)));
}
...
static inline void ConvertRGBToCMYK(PixelInfo *pixel)
{
  ...
  if (pixel->colorspace != sRGBColorspace)
    {
      red=((double) 1.0/(double) ((Quantum) 65535.0))*pixel->red;
      green=((double) 1.0/(double) ((Quantum) 65535.0))*pixel->green;
      blue=((double) 1.0/(double) ((Quantum) 65535.0))*pixel->blue;
    }
  else
    {
      red=((double) 1.0/(double) ((Quantum) 65535.0))*DecodePixelGamma(pixel->red);
      green=((double) 1.0/(double) ((Quantum) 65535.0))*DecodePixelGamma(pixel->green);
      blue=((double) 1.0/(double) ((Quantum) 65535.0))*DecodePixelGamma(pixel->blue);
    }
  if ((fabs((double) red) < 1.0e-12) &&
      (fabs((double) green) < 1.0e-12) &&
      (fabs((double) blue) < 1.0e-12))
    {
      pixel->black=(MagickRealType) ((Quantum) 65535.0);
      return;
    }
  ...
  pixel->red=(MagickRealType) ((Quantum) 65535.0)*cyan;
  pixel->green=(MagickRealType) ((Quantum) 65535.0)*magenta;
  pixel->blue=(MagickRealType) ((Quantum) 65535.0)*yellow;
  pixel->black=(MagickRealType) ((Quantum) 65535.0)*black;
}
...
# 50 "MagickCore/cache.c" 2
# 1 "./MagickCore/composite-private.h" 1
# 24 "./MagickCore/composite-private.h"
...
# 25 "./MagickCore/composite-private.h" 2
...
# 51 "MagickCore/cache.c" 2
# 1 "./MagickCore/distribute-cache-private.h" 1
# 28 "./MagickCore/distribute-cache-private.h"
...
extern __attribute__ ((visibility ("hidden"))) const char
  *GetDistributeCacheHostname(const DistributeCacheInfo *);

extern __attribute__ ((visibility ("hidden"))) DistributeCacheInfo
...
extern __attribute__ ((visibility ("hidden"))) MagickOffsetType
  ...
  ReadDistributePixelCachePixels(DistributeCacheInfo *,const RectangleInfo *,
    const MagickSizeType,unsigned char *__restrict__),
  ...
  WriteDistributePixelCachePixels(DistributeCacheInfo *,const RectangleInfo *,
    const MagickSizeType,const unsigned char *__restrict__);

extern __attribute__ ((visibility ("hidden"))) void
  DistributeCacheTerminus(void);
# 52 "MagickCore/cache.c" 2
...
extern int gzvprintf(gzFile file,
                                           const char *format,
                                           va_list va);
# 79 "MagickCore/cache.c" 2
# 91 "MagickCore/cache.c"
...
static MagickBooleanType
  ...
  ReadPixelCachePixels(CacheInfo *__restrict__,NexusInfo *__restrict__,
    ExceptionInfo *),
  ReadPixelCacheMetacontent(CacheInfo *__restrict__,
    NexusInfo *__restrict__,ExceptionInfo *),
  SyncAuthenticPixelsCache(Image *,ExceptionInfo *),
  WritePixelCachePixels(CacheInfo *__restrict__,NexusInfo *__restrict__,
    ExceptionInfo *),
  WritePixelCacheMetacontent(CacheInfo *,NexusInfo *__restrict__,
    ExceptionInfo *);
...
static Quantum
  ...
  *QueueAuthenticPixelsCache(Image *,const ssize_t,const ssize_t,const size_t,
    const size_t,ExceptionInfo *),
  *SetPixelCacheNexusPixels(const CacheInfo *__restrict__,const MapMode,
    const ssize_t,const ssize_t,const size_t,const size_t,
    const MagickBooleanType,NexusInfo *__restrict__,ExceptionInfo *)
    __attribute__((__hot__));
# 156 "MagickCore/cache.c"
static SemaphoreInfo
  *cache_semaphore = (SemaphoreInfo *) 
# 157 "MagickCore/cache.c" 3 4
                                      ((void *)0)
# 157 "MagickCore/cache.c"
                                          ;

static ssize_t
  cache_anonymous_memory = (-1);
# 184 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) Cache AcquirePixelCache(const size_t number_threads)
{
  CacheInfo
    *__restrict__ cache_info;

  char
    *value;

  cache_info=(CacheInfo *) AcquireAlignedMemory(1,sizeof(*cache_info));
  if (cache_info == (CacheInfo *) 
# 193 "MagickCore/cache.c" 3 4
                                 ((void *)0)
# 193 "MagickCore/cache.c"
                                     )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 194 "MagickCore/cache.c" 3 4
   (*__errno_location ())
# 194 "MagickCore/cache.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/cache.c",__func__,(unsigned long) 194,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  ...
  if (cache_info->nexus_info == (NexusInfo **) 
# 210 "MagickCore/cache.c" 3 4
                                              ((void *)0)
# 210 "MagickCore/cache.c"
                                                  )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 211 "MagickCore/cache.c" 3 4
   (*__errno_location ())
# 211 "MagickCore/cache.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/cache.c",__func__,(unsigned long) 211,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  value=GetEnvironmentValue("MAGICK_SYNCHRONIZE");
  if (value != (const char *) 
# 213 "MagickCore/cache.c" 3 4
                             ((void *)0)
# 213 "MagickCore/cache.c"
                                 )
    {
  ...
  if (value != (const char *) 
# 219 "MagickCore/cache.c" 3 4
                             ((void *)0)
# 219 "MagickCore/cache.c"
                                 )
    {
      cache_info->synchronize=IsStringTrue(value);
      value=DestroyString(value);
    }
  cache_info->width_limit=(((GetMagickResourceLimit(WidthResource)) < ((MagickSizeType) (0x7fffffffffffffffL
# 224 "MagickCore/cache.c"
                         ))) ? (GetMagickResourceLimit(WidthResource)) : ((MagickSizeType) (0x7fffffffffffffffL
# 224 "MagickCore/cache.c"
                         )))
                                      ;
  cache_info->height_limit=(((GetMagickResourceLimit(HeightResource)) < ((MagickSizeType) (0x7fffffffffffffffL
# 226 "MagickCore/cache.c"
                          ))) ? (GetMagickResourceLimit(HeightResource)) : ((MagickSizeType) (0x7fffffffffffffffL
# 226 "MagickCore/cache.c"
                          )))
                                      ;
  ...
  cache_info->debug=(GetLogEventMask() & CacheEvent) != 0 ? MagickTrue :
    MagickFalse;
  cache_info->signature=0xabacadabUL;
  return((Cache ) cache_info);
}
# 259 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) NexusInfo **AcquirePixelCacheNexus(const size_t number_threads)
{
  NexusInfo
    **__restrict__ nexus_info;

  ssize_t
    i;

  nexus_info=(NexusInfo **) __builtin_assume_aligned((AcquireAlignedMemory(2* number_threads,sizeof(*nexus_info))),(8 * 8))
                                        ;
  if (nexus_info == (NexusInfo **) 
# 269 "MagickCore/cache.c" 3 4
                                  ((void *)0)
# 269 "MagickCore/cache.c"
                                      )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 270 "MagickCore/cache.c" 3 4
   (*__errno_location ())
# 270 "MagickCore/cache.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/cache.c",__func__,(unsigned long) 270,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  *nexus_info=(NexusInfo *) AcquireQuantumMemory(number_threads,
    2*sizeof(**nexus_info));
  if (*nexus_info == (NexusInfo *) 
# 273 "MagickCore/cache.c" 3 4
                                  ((void *)0)
# 273 "MagickCore/cache.c"
                                      )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 274 "MagickCore/cache.c" 3 4
   (*__errno_location ())
# 274 "MagickCore/cache.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/cache.c",__func__,(unsigned long) 274,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
...
# 314 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) void *AcquirePixelCachePixels(const Image *image,size_t *length,
...
# 320 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 320 "MagickCore/cache.c"
 image != (const Image *) 
# 320 "MagickCore/cache.c" 3 4
...
# 320 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 320, __extension__ __PRETTY_FUNCTION__); }))
# 320 "MagickCore/cache.c"
                                      ;
  
# 321 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 321 "MagickCore/cache.c"
...
# 321 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 321, __extension__ __PRETTY_FUNCTION__); }))
# 321 "MagickCore/cache.c"
                                                ;
  
# 322 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 322 "MagickCore/cache.c"
...
# 322 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 322, __extension__ __PRETTY_FUNCTION__); }))
# 322 "MagickCore/cache.c"
                                            ;
  
# 323 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 323 "MagickCore/cache.c"
...
# 323 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 323, __extension__ __PRETTY_FUNCTION__); }))
# 323 "MagickCore/cache.c"
                                                    ;
  
# 324 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 324 "MagickCore/cache.c"
 image->cache != (Cache) 
# 324 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 324 "MagickCore/cache.c"
...
# 324 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 324, __extension__ __PRETTY_FUNCTION__); }))
# 324 "MagickCore/cache.c"
                                     ;
  (void) exception;
  cache_info=(CacheInfo *) image->cache;
  
# 327 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 327 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 327 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 327 "MagickCore/cache.c"
...
# 327 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 327, __extension__ __PRETTY_FUNCTION__); }))
# 327 "MagickCore/cache.c"
                                                     ;
  *length=0;
  if ((cache_info->type != MemoryCache) && (cache_info->type != MapCache))
    return((void *) 
# 330 "MagickCore/cache.c" 3 4
                   ((void *)0)
# 330 "MagickCore/cache.c"
                       );
  *length=(size_t) cache_info->length;
  return(cache_info->pixels);
}
# 353 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType CacheComponentGenesis(void)
{
  if (cache_semaphore == (SemaphoreInfo *) 
# 355 "MagickCore/cache.c" 3 4
                                          ((void *)0)
# 355 "MagickCore/cache.c"
                                              )
    cache_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 378 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) void CacheComponentTerminus(void)
{
  if (cache_semaphore == (SemaphoreInfo *) 
# 380 "MagickCore/cache.c" 3 4
                                          ((void *)0)
# 380 "MagickCore/cache.c"
                                              )
    ActivateSemaphoreInfo(&cache_semaphore);

  RelinquishSemaphoreInfo(&cache_semaphore);
}
# 415 "MagickCore/cache.c"
  ...
  NexusInfo *nexus_info,ExceptionInfo *exception)
{
  ...
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 432,"%s",image->filename);
  ...
  cache_info=(CacheInfo *) image->cache;
  if (cache_info == (Cache) 
# 438 "MagickCore/cache.c" 3 4
                           ((void *)0)
# 438 "MagickCore/cache.c"
                               )
    return(MagickFalse);
  ...
  q=nexus_info->pixels;
  if ((p == (Quantum *) 
# 444 "MagickCore/cache.c" 3 4
                       ((void *)0)
# 444 "MagickCore/cache.c"
                           ) || (q == (Quantum *) 
# 444 "MagickCore/cache.c" 3 4
                                                  ((void *)0)
# 444 "MagickCore/cache.c"
  ...
  for (y=0; y < (ssize_t) nexus_info->region.height; y++)
  {
    ...
    for (x=0; x < (ssize_t) nexus_info->region.width; x++)
    {
      ...
      mask_alpha=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelWriteMask(image,p);
      if (fabs(mask_alpha) >= 1.0e-12)
        {
...
# 503 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) Cache ClonePixelCache(const Cache cache)
{
  CacheInfo
    *__restrict__ clone_info;

  const CacheInfo
    *__restrict__ cache_info;

  
# 511 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 511 "MagickCore/cache.c"
 cache != 
# 511 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 511 "MagickCore/cache.c"
...
# 511 "MagickCore/cache.c"
 "cache != NULL"
# 511 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 511, __extension__ __PRETTY_FUNCTION__); }))
# 511 "MagickCore/cache.c"
                      ;
  cache_info=(const CacheInfo *) cache;
  
# 513 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 513 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 513 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 513 "MagickCore/cache.c"
...
# 513 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 513 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 513, __extension__ __PRETTY_FUNCTION__); }))
# 513 "MagickCore/cache.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 515,"%s",
      cache_info->filename);
...
# 547 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) void ClonePixelCacheMethods(Cache clone,const Cache cache)
{
  CacheInfo
    *__restrict__ cache_info,
    *__restrict__ source_info;

  
# 553 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 553 "MagickCore/cache.c"
 clone != (Cache) 
# 553 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 553 "MagickCore/cache.c"
...
# 553 "MagickCore/cache.c"
 "clone != (Cache) NULL"
# 553 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 553, __extension__ __PRETTY_FUNCTION__); }))
# 553 "MagickCore/cache.c"
                              ;
  source_info=(CacheInfo *) clone;
  
# 555 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 555 "MagickCore/cache.c"
 source_info->signature == 0xabacadabUL
# 555 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 555 "MagickCore/cache.c"
 source_info->signature == 0xabacadabUL
...
# 555 "MagickCore/cache.c"
 "source_info->signature == MagickCoreSignature"
# 555 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 555, __extension__ __PRETTY_FUNCTION__); }))
# 555 "MagickCore/cache.c"
                                                      ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 557,"%s",
      source_info->filename);
  
# 559 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 559 "MagickCore/cache.c"
 cache != (Cache) 
# 559 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 559 "MagickCore/cache.c"
...
# 559 "MagickCore/cache.c"
 "cache != (Cache) NULL"
# 559 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 559, __extension__ __PRETTY_FUNCTION__); }))
# 559 "MagickCore/cache.c"
                              ;
  cache_info=(CacheInfo *) cache;
  
# 561 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 561 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 561 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 561 "MagickCore/cache.c"
...
# 561 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 561 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 561, __extension__ __PRETTY_FUNCTION__); }))
# 561 "MagickCore/cache.c"
                                                     ;
  source_info->methods=cache_info->methods;
}
# 594 "MagickCore/cache.c"
static MagickBooleanType ClonePixelCacheOnDisk(
  CacheInfo *__restrict__ cache_info,CacheInfo *__restrict__ clone_info)
{
  MagickSizeType
    extent;
  ...
  if ((OpenPixelCacheOnDisk(cache_info,ReadMode) == MagickFalse) ||
    ...
    return(MagickFalse);
  if ((lseek(cache_info->file,0,
# 618 "MagickCore/cache.c" 3 4
                               0
# 618 "MagickCore/cache.c"
                                       ) < 0) ||
      (lseek(clone_info->file,0,
# 619 "MagickCore/cache.c" 3 4
                               0
# 619 "MagickCore/cache.c"
                                       ) < 0))
    return(MagickFalse);
  ...
  if ((fstat(cache_info->file,&file_stats) == 0) && (file_stats.st_size > 0))
    {
      ...
      if (cache_info->length < 0x7ffff000)
        {
          count=sendfile(clone_info->file,cache_info->file,(off_t *) 
# 627 "MagickCore/cache.c" 3 4
                                                                    ((void *)0)
# 627 "MagickCore/cache.c"
                                                                        ,
            (size_t) cache_info->length);
          if (count == (ssize_t) cache_info->length)
            return(MagickTrue);
          if ((lseek(cache_info->file,0,
# 631 "MagickCore/cache.c" 3 4
                                       0
# 631 "MagickCore/cache.c"
                                               ) < 0) ||
              (lseek(clone_info->file,0,
# 632 "MagickCore/cache.c" 3 4
                                       0
# 632 "MagickCore/cache.c"
                                               ) < 0))
            return(MagickFalse);
        }
...
# 639 "MagickCore/cache.c" 3 4
                                 ((void *)0)
# 639 "MagickCore/cache.c"
                                     )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 640 "MagickCore/cache.c" 3 4
   (*__errno_location ())
# 640 "MagickCore/cache.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/cache.c",__func__,(unsigned long) 640,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  extent=0;
...
static MagickBooleanType ClonePixelCacheRepository(
  CacheInfo *__restrict__ clone_info,CacheInfo *__restrict__ cache_info,
  ExceptionInfo *exception)
{
# 670 "MagickCore/cache.c"
  MagickBooleanType
    optimize,
    status;

  NexusInfo
    **__restrict__ cache_nexus,
    **__restrict__ clone_nexus;
...
# 684 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 684 "MagickCore/cache.c"
...
# 684 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 684, __extension__ __PRETTY_FUNCTION__); }))
# 684 "MagickCore/cache.c"
                                         ;
  
# 685 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 685 "MagickCore/cache.c"
 clone_info != (CacheInfo *) 
# 685 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 685 "MagickCore/cache.c"
 clone_info != (CacheInfo *) 
# 685 "MagickCore/cache.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 685 "MagickCore/cache.c"
 "clone_info != (CacheInfo *) NULL"
# 685 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 685, __extension__ __PRETTY_FUNCTION__); }))
# 685 "MagickCore/cache.c"
                                         ;
  
# 686 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 686 "MagickCore/cache.c"
 exception != (ExceptionInfo *) 
# 686 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 686 "MagickCore/cache.c"
...
# 686 "MagickCore/cache.c"
 "exception != (ExceptionInfo *) NULL"
# 686 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 686, __extension__ __PRETTY_FUNCTION__); }))
# 686 "MagickCore/cache.c"
                                            ;
  ...
  length=(size_t) (((cache_info->number_channels*cache_info->columns) < (clone_info->number_channels*clone_info->columns)) ? (cache_info->number_channels*cache_info->columns) : (clone_info->number_channels*clone_info->columns))
                                                    ;
  status=MagickTrue;
  ...
  for (y=0; y < (ssize_t) cache_info->rows; y++)
  {
    ...
    if (pixels == (Quantum *) 
# 753 "MagickCore/cache.c" 3 4
                             ((void *)0)
# 753 "MagickCore/cache.c"
                                 )
      continue;
    ...
    if (pixels == (Quantum *) 
# 760 "MagickCore/cache.c" 3 4
                             ((void *)0)
# 760 "MagickCore/cache.c"
                                 )
      continue;
  ...
  if ((cache_info->metacontent_extent != 0) &&
      (clone_info->metacontent_extent != 0))
    {
      ...
      length=(size_t) (((cache_info->metacontent_extent) < (clone_info->metacontent_extent)) ? (cache_info->metacontent_extent) : (clone_info->metacontent_extent))
                                       ;
      ...
      for (y=0; y < (ssize_t) cache_info->rows; y++)
      {
        ...
        pixels=SetPixelCacheNexusPixels(cache_info,ReadMode,0,y,
          cache_info->columns,1,MagickFalse,cache_nexus[id],exception);
        if (pixels == (Quantum *) 
# 831 "MagickCore/cache.c" 3 4
                                 ((void *)0)
# 831 "MagickCore/cache.c"
                                     )
          continue;
        ...
        pixels=SetPixelCacheNexusPixels(clone_info,WriteMode,0,y,
          clone_info->columns,1,MagickFalse,clone_nexus[id],exception);
        if (pixels == (Quantum *) 
# 838 "MagickCore/cache.c" 3 4
                                 ((void *)0)
# 838 "MagickCore/cache.c"
                                     )
          continue;
        if ((clone_nexus[id]->metacontent != (void *) 
# 840 "MagickCore/cache.c" 3 4
                                                     ((void *)0)
# 840 "MagickCore/cache.c"
                                                         ) &&
            (cache_nexus[id]->metacontent != (void *) 
# 841 "MagickCore/cache.c" 3 4
                                                     ((void *)0)
# 841 "MagickCore/cache.c"
                                                         ))
  ...
  if (cache_info->debug != MagickFalse)
    {
      ...
      (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 857,"%s",message);
    }
  return(status);
}
# 884 "MagickCore/cache.c"
static void DestroyImagePixelCache(Image *image)
{
  
# 886 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 886 "MagickCore/cache.c"
 image != (Image *) 
# 886 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 886 "MagickCore/cache.c"
...
# 886 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 886 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 886, __extension__ __PRETTY_FUNCTION__); }))
# 886 "MagickCore/cache.c"
                                ;
  
# 887 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 887 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 887 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 887 "MagickCore/cache.c"
...
# 887 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 887 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 887, __extension__ __PRETTY_FUNCTION__); }))
# 887 "MagickCore/cache.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 889,"%s",image->filename);
  if (image->cache != (void *) 
# 890 "MagickCore/cache.c" 3 4
                              ((void *)0)
# 890 "MagickCore/cache.c"
                                  )
    image->cache=DestroyPixelCache(image->cache);
}
# 916 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) void DestroyImagePixels(Image *image)
{
  CacheInfo
    *__restrict__ cache_info;

  
# 921 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 921 "MagickCore/cache.c"
 image != (const Image *) 
# 921 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 921 "MagickCore/cache.c"
...
# 921 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 921 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 921, __extension__ __PRETTY_FUNCTION__); }))
# 921 "MagickCore/cache.c"
                                      ;
  
# 922 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 922 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 922 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 922 "MagickCore/cache.c"
...
# 922 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 922 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 922, __extension__ __PRETTY_FUNCTION__); }))
# 922 "MagickCore/cache.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 924,"%s",image->filename);
  
# 925 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 925 "MagickCore/cache.c"
 image->cache != (Cache) 
# 925 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 925 "MagickCore/cache.c"
...
# 925 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 925 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 925, __extension__ __PRETTY_FUNCTION__); }))
# 925 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 927 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 927 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 927 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 927 "MagickCore/cache.c"
...
# 927 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 927 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 927, __extension__ __PRETTY_FUNCTION__); }))
# 927 "MagickCore/cache.c"
                                                     ;
  if (cache_info->methods.destroy_pixel_handler != (DestroyPixelHandler) 
# 928 "MagickCore/cache.c" 3 4
                                                                        ((void *)0)
# 928 "MagickCore/cache.c"
                                                                            )
    {
...
# 990 "MagickCore/cache.c"
      if (cache_info->mapped == MagickFalse)
      ...
      else
        {
          ...
          cache_info->pixels=(Quantum *) 
# 996 "MagickCore/cache.c" 3 4
                                        ((void *)0)
# 996 "MagickCore/cache.c"
                                            ;
        }
    ...
    case MapCache:
    {
      (void) UnmapBlob(cache_info->pixels,(size_t) cache_info->length);
      cache_info->pixels=(Quantum *) 
# 1004 "MagickCore/cache.c" 3 4
                                    ((void *)0)
# 1004 "MagickCore/cache.c"
                                        ;
  ...
  cache_info->metacontent=(void *) 
# 1033 "MagickCore/cache.c" 3 4
                                  ((void *)0)
# 1033 "MagickCore/cache.c"
                                      ;
}

__attribute__ ((visibility ("hidden"))) Cache DestroyPixelCache(Cache cache)
{
  CacheInfo
    *__restrict__ cache_info;

  
# 1041 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1041 "MagickCore/cache.c"
 cache != (Cache) 
# 1041 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1041 "MagickCore/cache.c"
...
# 1041 "MagickCore/cache.c"
 "cache != (Cache) NULL"
# 1041 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1041, __extension__ __PRETTY_FUNCTION__); }))
# 1041 "MagickCore/cache.c"
                              ;
  cache_info=(CacheInfo *) cache;
  
# 1043 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1043 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1043 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1043 "MagickCore/cache.c"
...
# 1043 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1043 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1043, __extension__ __PRETTY_FUNCTION__); }))
# 1043 "MagickCore/cache.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 1045,"%s",
      cache_info->filename);
  ...
  if (cache_info->reference_count != 0)
    {
      ...
      return((Cache) 
# 1052 "MagickCore/cache.c" 3 4
                    ((void *)0)
# 1052 "MagickCore/cache.c"
                        );
    }
  UnlockSemaphoreInfo(cache_info->semaphore);
  if (cache_info->debug != MagickFalse)
    {
      ...
      (void) FormatLocaleString(message,4096,"destroy %s",
        cache_info->filename);
      (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 1062,"%s",message);
    }
  RelinquishPixelCachePixels(cache_info);
  if (cache_info->server_info != (DistributeCacheInfo *) 
# 1065 "MagickCore/cache.c" 3 4
                                                        ((void *)0)
# 1065 "MagickCore/cache.c"
                                                            )
    cache_info->server_info=DestroyDistributeCacheInfo((DistributeCacheInfo *)
      cache_info->server_info);
  if (cache_info->nexus_info != (NexusInfo **) 
# 1068 "MagickCore/cache.c" 3 4
                                              ((void *)0)
# 1068 "MagickCore/cache.c"
                                                  )
    cache_info->nexus_info=DestroyPixelCacheNexus(cache_info->nexus_info,
      cache_info->number_threads);
  if (cache_info->random_info != (RandomInfo *) 
# 1071 "MagickCore/cache.c" 3 4
                                               ((void *)0)
# 1071 "MagickCore/cache.c"
                                                   )
    cache_info->random_info=DestroyRandomInfo(cache_info->random_info);
  if (cache_info->file_semaphore != (SemaphoreInfo *) 
# 1073 "MagickCore/cache.c" 3 4
                                                     ((void *)0)
# 1073 "MagickCore/cache.c"
                                                         )
    RelinquishSemaphoreInfo(&cache_info->file_semaphore);
  if (cache_info->semaphore != (SemaphoreInfo *) 
# 1075 "MagickCore/cache.c" 3 4
                                                ((void *)0)
# 1075 "MagickCore/cache.c"
                                                    )
    RelinquishSemaphoreInfo(&cache_info->semaphore);
  cache_info->signature=(~0xabacadabUL);
  cache_info=(CacheInfo *) RelinquishAlignedMemory(cache_info);
  cache=(Cache) 
# 1079 "MagickCore/cache.c" 3 4
               ((void *)0)
# 1079 "MagickCore/cache.c"
                   ;
  return(cache);
}
# 1109 "MagickCore/cache.c"
static inline void RelinquishCacheNexusPixels(NexusInfo *nexus_info)
{
  ...
  nexus_info->cache=(Quantum *) 
# 1115 "MagickCore/cache.c" 3 4
                               ((void *)0)
# 1115 "MagickCore/cache.c"
                                   ;
  nexus_info->pixels=(Quantum *) 
# 1116 "MagickCore/cache.c" 3 4
                                ((void *)0)
# 1116 "MagickCore/cache.c"
                                    ;
  nexus_info->metacontent=(void *) 
# 1117 "MagickCore/cache.c" 3 4
                                  ((void *)0)
# 1117 "MagickCore/cache.c"
                                      ;
  nexus_info->length=0;
  nexus_info->mapped=MagickFalse;
}

__attribute__ ((visibility ("hidden"))) NexusInfo **DestroyPixelCacheNexus(NexusInfo **nexus_info,
...
# 1128 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1128 "MagickCore/cache.c"
...
# 1128 "MagickCore/cache.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1128 "MagickCore/cache.c"
 "nexus_info != (NexusInfo **) NULL"
# 1128 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1128, __extension__ __PRETTY_FUNCTION__); }))
# 1128 "MagickCore/cache.c"
                                          ;
  for (i=0; i < (ssize_t) (2*number_threads); i++)
  {
    if (nexus_info[i]->cache != (Quantum *) 
# 1131 "MagickCore/cache.c" 3 4
                                           ((void *)0)
# 1131 "MagickCore/cache.c"
                                               )
...
# 1165 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) void *GetAuthenticMetacontent(const Image *image)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 1173 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1173 "MagickCore/cache.c"
 image != (const Image *) 
# 1173 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1173 "MagickCore/cache.c"
...
# 1173 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 1173 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1173, __extension__ __PRETTY_FUNCTION__); }))
# 1173 "MagickCore/cache.c"
                                      ;
  
# 1174 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1174 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1174 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1174 "MagickCore/cache.c"
...
# 1174 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1174 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1174, __extension__ __PRETTY_FUNCTION__); }))
# 1174 "MagickCore/cache.c"
                                                ;
  
# 1175 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1175 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1175 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1175 "MagickCore/cache.c"
...
# 1175 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1175 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1175, __extension__ __PRETTY_FUNCTION__); }))
# 1175 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 1177 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1177 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1177 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1177 "MagickCore/cache.c"
...
# 1177 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1177 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1177, __extension__ __PRETTY_FUNCTION__); }))
# 1177 "MagickCore/cache.c"
                                                     ;
  if (cache_info->methods.get_authentic_metacontent_from_handler !=
      (GetAuthenticMetacontentFromHandler) 
# 1179 "MagickCore/cache.c" 3 4
                                          ((void *)0)
# 1179 "MagickCore/cache.c"
                                              )
    {
      void
        *metacontent;
...
# 1188 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1188 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 1188 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1188 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
...
# 1188 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 1188 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1188, __extension__ __PRETTY_FUNCTION__); }))
# 1188 "MagickCore/cache.c"
                                              ;
  return(cache_info->nexus_info[id]->metacontent);
}
# 1216 "MagickCore/cache.c"
...
# 1224 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1224 "MagickCore/cache.c"
 image != (const Image *) 
# 1224 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1224 "MagickCore/cache.c"
...
# 1224 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 1224 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1224, __extension__ __PRETTY_FUNCTION__); }))
# 1224 "MagickCore/cache.c"
                                      ;
  
# 1225 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1225 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1225 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1225 "MagickCore/cache.c"
...
# 1225 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1225 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1225, __extension__ __PRETTY_FUNCTION__); }))
# 1225 "MagickCore/cache.c"
                                                ;
  
# 1226 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1226 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1226 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1226 "MagickCore/cache.c"
...
# 1226 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1226 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1226, __extension__ __PRETTY_FUNCTION__); }))
# 1226 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 1228 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1228 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1228 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1228 "MagickCore/cache.c"
...
# 1228 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1228 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1228, __extension__ __PRETTY_FUNCTION__); }))
# 1228 "MagickCore/cache.c"
                                                     ;
  
# 1229 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1229 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 1229 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1229 "MagickCore/cache.c"
...
# 1229 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 1229 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1229, __extension__ __PRETTY_FUNCTION__); }))
# 1229 "MagickCore/cache.c"
                                              ;
  return(cache_info->nexus_info[id]->metacontent);
}
# 1333 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) Quantum *GetAuthenticPixelCacheNexus(Image *image,const ssize_t x,
...
# 1346 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1346 "MagickCore/cache.c"
 image != (Image *) 
# 1346 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1346 "MagickCore/cache.c"
...
# 1346 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 1346 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1346, __extension__ __PRETTY_FUNCTION__); }))
# 1346 "MagickCore/cache.c"
                                ;
  
# 1347 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1347 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1347 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1347 "MagickCore/cache.c"
...
# 1347 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1347 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1347, __extension__ __PRETTY_FUNCTION__); }))
# 1347 "MagickCore/cache.c"
                                                ;
  pixels=QueueAuthenticPixelCacheNexus(image,x,y,columns,rows,MagickTrue,
    nexus_info,exception);
  if (pixels == (Quantum *) 
# 1350 "MagickCore/cache.c" 3 4
                           ((void *)0)
# 1350 "MagickCore/cache.c"
                               )
    return((Quantum *) 
# 1351 "MagickCore/cache.c" 3 4
                      ((void *)0)
# 1351 "MagickCore/cache.c"
                          );
  cache_info=(CacheInfo *) image->cache;
  
# 1353 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1353 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1353 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1353 "MagickCore/cache.c"
...
# 1353 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1353 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1353, __extension__ __PRETTY_FUNCTION__); }))
# 1353 "MagickCore/cache.c"
                                                     ;
  ...
  if (ReadPixelCachePixels(cache_info,nexus_info,exception) == MagickFalse)
    return((Quantum *) 
# 1357 "MagickCore/cache.c" 3 4
                      ((void *)0)
# 1357 "MagickCore/cache.c"
                          );
  if (cache_info->metacontent_extent != 0)
    if (ReadPixelCacheMetacontent(cache_info,nexus_info,exception) == MagickFalse)
      return((Quantum *) 
# 1360 "MagickCore/cache.c" 3 4
                        ((void *)0)
# 1360 "MagickCore/cache.c"
                            );
  return(pixels);
}
# 1387 "MagickCore/cache.c"
...
# 1395 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1395 "MagickCore/cache.c"
 image != (const Image *) 
# 1395 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1395 "MagickCore/cache.c"
...
# 1395 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 1395 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1395, __extension__ __PRETTY_FUNCTION__); }))
# 1395 "MagickCore/cache.c"
                                      ;
  
# 1396 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1396 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1396 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1396 "MagickCore/cache.c"
...
# 1396 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1396 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1396, __extension__ __PRETTY_FUNCTION__); }))
# 1396 "MagickCore/cache.c"
                                                ;
  
# 1397 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1397 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1397 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1397 "MagickCore/cache.c"
...
# 1397 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1397 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1397, __extension__ __PRETTY_FUNCTION__); }))
# 1397 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 1399 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1399 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1399 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1399 "MagickCore/cache.c"
...
# 1399 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1399 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1399, __extension__ __PRETTY_FUNCTION__); }))
# 1399 "MagickCore/cache.c"
                                                     ;
  
# 1400 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1400 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 1400 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1400 "MagickCore/cache.c"
...
# 1400 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 1400 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1400, __extension__ __PRETTY_FUNCTION__); }))
# 1400 "MagickCore/cache.c"
                                              ;
  return(cache_info->nexus_info[id]->pixels);
}
# 1428 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) Quantum *GetAuthenticPixelQueue(const Image *image)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 1436 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1436 "MagickCore/cache.c"
 image != (const Image *) 
# 1436 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1436 "MagickCore/cache.c"
...
# 1436 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 1436 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1436, __extension__ __PRETTY_FUNCTION__); }))
# 1436 "MagickCore/cache.c"
                                      ;
  
# 1437 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1437 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1437 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1437 "MagickCore/cache.c"
...
# 1437 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1437 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1437, __extension__ __PRETTY_FUNCTION__); }))
# 1437 "MagickCore/cache.c"
                                                ;
  
# 1438 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1438 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1438 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1438 "MagickCore/cache.c"
...
# 1438 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1438 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1438, __extension__ __PRETTY_FUNCTION__); }))
# 1438 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 1440 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1440 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1440 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1440 "MagickCore/cache.c"
...
# 1440 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1440 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1440, __extension__ __PRETTY_FUNCTION__); }))
# 1440 "MagickCore/cache.c"
                                                     ;
  if (cache_info->methods.get_authentic_pixels_from_handler !=
       (GetAuthenticPixelsFromHandler) 
# 1442 "MagickCore/cache.c" 3 4
                                      ((void *)0)
# 1442 "MagickCore/cache.c"
                                          )
    return(cache_info->methods.get_authentic_pixels_from_handler(image));
  
# 1444 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1444 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 1444 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1444 "MagickCore/cache.c"
...
# 1444 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 1444 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1444, __extension__ __PRETTY_FUNCTION__); }))
# 1444 "MagickCore/cache.c"
                                              ;
  return(cache_info->nexus_info[id]->pixels);
}
# 1493 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) Quantum *GetAuthenticPixels(Image *image,const ssize_t x,
...
# 1506 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1506 "MagickCore/cache.c"
 image != (Image *) 
# 1506 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1506 "MagickCore/cache.c"
...
# 1506 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 1506 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1506, __extension__ __PRETTY_FUNCTION__); }))
# 1506 "MagickCore/cache.c"
                                ;
  
# 1507 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1507 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1507 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1507 "MagickCore/cache.c"
...
# 1507 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1507 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1507, __extension__ __PRETTY_FUNCTION__); }))
# 1507 "MagickCore/cache.c"
                                                ;
  
# 1508 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1508 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1508 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1508 "MagickCore/cache.c"
...
# 1508 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1508 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1508, __extension__ __PRETTY_FUNCTION__); }))
# 1508 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 1510 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1510 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1510 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1510 "MagickCore/cache.c"
...
# 1510 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1510 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1510, __extension__ __PRETTY_FUNCTION__); }))
# 1510 "MagickCore/cache.c"
                                                     ;
  if (cache_info->methods.get_authentic_pixels_handler !=
      (GetAuthenticPixelsHandler) 
# 1512 "MagickCore/cache.c" 3 4
                                 ((void *)0)
# 1512 "MagickCore/cache.c"
                                     )
    {
...
# 1518 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1518 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 1518 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1518 "MagickCore/cache.c"
...
# 1518 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 1518 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1518, __extension__ __PRETTY_FUNCTION__); }))
# 1518 "MagickCore/cache.c"
                                              ;
...
# 1568 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1568 "MagickCore/cache.c"
 image != (const Image *) 
# 1568 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1568 "MagickCore/cache.c"
...
# 1568 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 1568 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1568, __extension__ __PRETTY_FUNCTION__); }))
# 1568 "MagickCore/cache.c"
                                      ;
  
# 1569 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1569 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1569 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1569 "MagickCore/cache.c"
...
# 1569 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1569 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1569, __extension__ __PRETTY_FUNCTION__); }))
# 1569 "MagickCore/cache.c"
                                                ;
  
# 1570 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1570 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1570 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1570 "MagickCore/cache.c"
...
# 1570 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1570 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1570, __extension__ __PRETTY_FUNCTION__); }))
# 1570 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  if (cache_info == (Cache) 
# 1572 "MagickCore/cache.c" 3 4
                           ((void *)0)
# 1572 "MagickCore/cache.c"
                               )
    return((Quantum *) 
# 1573 "MagickCore/cache.c" 3 4
                      ((void *)0)
# 1573 "MagickCore/cache.c"
                          );
  
# 1574 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1574 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1574 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1574 "MagickCore/cache.c"
...
# 1574 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1574 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1574, __extension__ __PRETTY_FUNCTION__); }))
# 1574 "MagickCore/cache.c"
                                                     ;
  
# 1575 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1575 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 1575 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1575 "MagickCore/cache.c"
...
# 1575 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 1575 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1575, __extension__ __PRETTY_FUNCTION__); }))
# 1575 "MagickCore/cache.c"
                                              ;
  pixels=GetAuthenticPixelCacheNexus(image,x,y,columns,rows,
    cache_info->nexus_info[id],exception);
...
# 1604 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) MagickSizeType GetImageExtent(const Image *image)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 1612 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1612 "MagickCore/cache.c"
 image != (Image *) 
# 1612 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1612 "MagickCore/cache.c"
...
# 1612 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 1612 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1612, __extension__ __PRETTY_FUNCTION__); }))
# 1612 "MagickCore/cache.c"
                                ;
  
# 1613 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1613 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1613 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1613 "MagickCore/cache.c"
...
# 1613 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1613 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1613, __extension__ __PRETTY_FUNCTION__); }))
# 1613 "MagickCore/cache.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 1615,"%s",image->filename);
  
# 1616 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1616 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1616 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1616 "MagickCore/cache.c"
...
# 1616 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1616 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1616, __extension__ __PRETTY_FUNCTION__); }))
# 1616 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 1618 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1618 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1618 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1618 "MagickCore/cache.c"
...
# 1618 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1618 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1618, __extension__ __PRETTY_FUNCTION__); }))
# 1618 "MagickCore/cache.c"
                                                     ;
  
# 1619 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1619 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 1619 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1619 "MagickCore/cache.c"
...
# 1619 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 1619 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1619, __extension__ __PRETTY_FUNCTION__); }))
# 1619 "MagickCore/cache.c"
                                              ;
  return(GetPixelCacheNexusExtent(cache_info,cache_info->nexus_info[id]));
}
# 1653 "MagickCore/cache.c"
...
# 1678 "MagickCore/cache.c" 3 4
                                               ((void *)0)
# 1678 "MagickCore/cache.c"
                                                   ))
    return(MagickFalse);
  return(MagickTrue);
}
  ...
  ExceptionInfo *exception)
{
  ...
  static MagickSizeType
    cpu_throttle = (((MagickSizeType) (~0ULL)) >> 1),
    cycles = 0;
...
# 1700 "MagickCore/cache.c" 3 4
     (*__errno_location ())
# 1700 "MagickCore/cache.c"
          =
# 1700 "MagickCore/cache.c" 3 4
           116
# 1700 "MagickCore/cache.c"
      ...
      (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 1702,
        ResourceLimitError,"TimeLimitExceeded","`%s'",image->filename);
      return((Cache) 
# 1704 "MagickCore/cache.c" 3 4
                    ((void *)0)
# 1704 "MagickCore/cache.c"
                        );
    }
  if (cpu_throttle == (((MagickSizeType) (~0ULL)) >> 1))
    cpu_throttle=GetMagickResourceLimit(ThrottleResource);
  if ((cpu_throttle != 0) && ((cycles++ % 4096) == 0))
    MagickDelay(cpu_throttle);
  LockSemaphoreInfo(image->semaphore);
  
# 1711 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1711 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1711 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1711 "MagickCore/cache.c"
...
# 1711 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1711 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1711, __extension__ __PRETTY_FUNCTION__); }))
# 1711 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  ...
  if (status == MagickFalse)
    return((Cache) 
# 1775 "MagickCore/cache.c" 3 4
                  ((void *)0)
# 1775 "MagickCore/cache.c"
                      );
  return(image->cache);
}
# 1802 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) CacheType GetImagePixelCacheType(const Image *image)
{
  CacheInfo
    *__restrict__ cache_info;

  
# 1807 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1807 "MagickCore/cache.c"
 image != (Image *) 
# 1807 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1807 "MagickCore/cache.c"
...
# 1807 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 1807 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1807, __extension__ __PRETTY_FUNCTION__); }))
# 1807 "MagickCore/cache.c"
                                ;
  
# 1808 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1808 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1808 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1808 "MagickCore/cache.c"
...
# 1808 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1808 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1808, __extension__ __PRETTY_FUNCTION__); }))
# 1808 "MagickCore/cache.c"
                                                ;
  
# 1809 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1809 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1809 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1809 "MagickCore/cache.c"
...
# 1809 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1809 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1809, __extension__ __PRETTY_FUNCTION__); }))
# 1809 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 1811 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1811 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1811 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1811 "MagickCore/cache.c"
...
# 1811 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1811 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1811, __extension__ __PRETTY_FUNCTION__); }))
# 1811 "MagickCore/cache.c"
                                                     ;
  return(cache_info->type);
}
# 1846 "MagickCore/cache.c"
  ...
  const Quantum *source,Quantum *destination)
{
  ...
  if (source == (const Quantum *) 
# 1852 "MagickCore/cache.c" 3 4
                                 ((void *)0)
# 1852 "MagickCore/cache.c"
                                     )
    {
...
__attribute__ ((visibility ("default"))) MagickBooleanType GetOneAuthenticPixel(Image *image,
...
# 1882 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1882 "MagickCore/cache.c"
 image != (Image *) 
# 1882 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1882 "MagickCore/cache.c"
...
# 1882 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 1882 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1882, __extension__ __PRETTY_FUNCTION__); }))
# 1882 "MagickCore/cache.c"
                                ;
  
# 1883 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1883 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1883 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1883 "MagickCore/cache.c"
...
# 1883 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1883 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1883, __extension__ __PRETTY_FUNCTION__); }))
# 1883 "MagickCore/cache.c"
                                                ;
  
# 1884 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1884 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1884 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1884 "MagickCore/cache.c"
...
# 1884 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1884 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1884, __extension__ __PRETTY_FUNCTION__); }))
# 1884 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 1886 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1886 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1886 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1886 "MagickCore/cache.c"
...
# 1886 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1886 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1886, __extension__ __PRETTY_FUNCTION__); }))
# 1886 "MagickCore/cache.c"
                                                     ;
  (void) memset(pixel,0,64*sizeof(*pixel));
  if (cache_info->methods.get_one_authentic_pixel_from_handler != (GetOneAuthenticPixelFromHandler) 
# 1888 "MagickCore/cache.c" 3 4
                                                                                                   ((void *)0)
# 1888 "MagickCore/cache.c"
                                                                                                       )
...
# 1937 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1937 "MagickCore/cache.c"
 image != (const Image *) 
# 1937 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1937 "MagickCore/cache.c"
...
# 1937 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 1937 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1937, __extension__ __PRETTY_FUNCTION__); }))
# 1937 "MagickCore/cache.c"
                                      ;
  
# 1938 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1938 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1938 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1938 "MagickCore/cache.c"
...
# 1938 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1938 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1938, __extension__ __PRETTY_FUNCTION__); }))
# 1938 "MagickCore/cache.c"
                                                ;
  
# 1939 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1939 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1939 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1939 "MagickCore/cache.c"
...
# 1939 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1939 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1939, __extension__ __PRETTY_FUNCTION__); }))
# 1939 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 1941 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1941 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1941 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1941 "MagickCore/cache.c"
...
# 1941 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1941 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1941, __extension__ __PRETTY_FUNCTION__); }))
# 1941 "MagickCore/cache.c"
                                                     ;
  
# 1942 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1942 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 1942 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1942 "MagickCore/cache.c"
...
# 1942 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 1942 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1942, __extension__ __PRETTY_FUNCTION__); }))
# 1942 "MagickCore/cache.c"
                                              ;
  (void) memset(pixel,0,64*sizeof(*pixel));
...
# 1980 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetOneVirtualPixel(const Image *image,
  const ssize_t x,const ssize_t y,Quantum *pixel,ExceptionInfo *exception)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 1992 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1992 "MagickCore/cache.c"
 image != (const Image *) 
# 1992 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1992 "MagickCore/cache.c"
...
# 1992 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 1992 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1992, __extension__ __PRETTY_FUNCTION__); }))
# 1992 "MagickCore/cache.c"
                                      ;
  
# 1993 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1993 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 1993 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1993 "MagickCore/cache.c"
...
# 1993 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 1993 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1993, __extension__ __PRETTY_FUNCTION__); }))
# 1993 "MagickCore/cache.c"
                                                ;
  
# 1994 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1994 "MagickCore/cache.c"
 image->cache != (Cache) 
# 1994 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1994 "MagickCore/cache.c"
...
# 1994 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 1994 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1994, __extension__ __PRETTY_FUNCTION__); }))
# 1994 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 1996 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 1996 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 1996 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1996 "MagickCore/cache.c"
...
# 1996 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 1996 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 1996, __extension__ __PRETTY_FUNCTION__); }))
# 1996 "MagickCore/cache.c"
                                                     ;
  (void) memset(pixel,0,64*sizeof(*pixel));
  if (cache_info->methods.get_one_virtual_pixel_from_handler !=
       (GetOneVirtualPixelFromHandler) 
# 1999 "MagickCore/cache.c" 3 4
                                      ((void *)0)
# 1999 "MagickCore/cache.c"
                                          )
    return(cache_info->methods.get_one_virtual_pixel_from_handler(image,
      GetPixelCacheVirtualMethod(image),x,y,pixel,exception));
  
# 2002 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2002 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 2002 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2002 "MagickCore/cache.c"
...
# 2002 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 2002 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2002, __extension__ __PRETTY_FUNCTION__); }))
# 2002 "MagickCore/cache.c"
                                              ;
...
# 2055 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2055 "MagickCore/cache.c"
 image != (const Image *) 
# 2055 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2055 "MagickCore/cache.c"
...
# 2055 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 2055 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2055, __extension__ __PRETTY_FUNCTION__); }))
# 2055 "MagickCore/cache.c"
                                      ;
  
# 2056 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2056 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 2056 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2056 "MagickCore/cache.c"
...
# 2056 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 2056 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2056, __extension__ __PRETTY_FUNCTION__); }))
# 2056 "MagickCore/cache.c"
                                                ;
  
# 2057 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2057 "MagickCore/cache.c"
 image->cache != (Cache) 
# 2057 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2057 "MagickCore/cache.c"
...
# 2057 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 2057 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2057, __extension__ __PRETTY_FUNCTION__); }))
# 2057 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 2059 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2059 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2059 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2059 "MagickCore/cache.c"
...
# 2059 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2059 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2059, __extension__ __PRETTY_FUNCTION__); }))
# 2059 "MagickCore/cache.c"
                                                     ;
  
# 2060 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2060 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 2060 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2060 "MagickCore/cache.c"
...
# 2060 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 2060 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2060, __extension__ __PRETTY_FUNCTION__); }))
# 2060 "MagickCore/cache.c"
                                              ;
  (void) memset(pixel,0,64*sizeof(*pixel));
...
# 2101 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetOneVirtualPixelInfo(const Image *image,
  const VirtualPixelMethod virtual_pixel_method,const ssize_t x,const ssize_t y,
...
# 2114 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2114 "MagickCore/cache.c"
 image != (const Image *) 
# 2114 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2114 "MagickCore/cache.c"
...
# 2114 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 2114 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2114, __extension__ __PRETTY_FUNCTION__); }))
# 2114 "MagickCore/cache.c"
                                      ;
  
# 2115 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2115 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 2115 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2115 "MagickCore/cache.c"
...
# 2115 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 2115 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2115, __extension__ __PRETTY_FUNCTION__); }))
# 2115 "MagickCore/cache.c"
                                                ;
  
# 2116 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2116 "MagickCore/cache.c"
 image->cache != (Cache) 
# 2116 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2116 "MagickCore/cache.c"
...
# 2116 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 2116 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2116, __extension__ __PRETTY_FUNCTION__); }))
# 2116 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 2118 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2118 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2118 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2118 "MagickCore/cache.c"
...
# 2118 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2118 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2118, __extension__ __PRETTY_FUNCTION__); }))
# 2118 "MagickCore/cache.c"
                                                     ;
  
# 2119 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2119 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 2119 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2119 "MagickCore/cache.c"
...
# 2119 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 2119 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2119, __extension__ __PRETTY_FUNCTION__); }))
# 2119 "MagickCore/cache.c"
                                              ;
  ...
  p=GetVirtualPixelCacheNexus(image,virtual_pixel_method,x,y,1UL,1UL,
    cache_info->nexus_info[id],exception);
  if (p == (const Quantum *) 
# 2123 "MagickCore/cache.c" 3 4
                            ((void *)0)
# 2123 "MagickCore/cache.c"
                                )
    return(MagickFalse);
  GetPixelInfoPixel(image,p,pixel);
  return(MagickTrue);
}
# 2151 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) ColorspaceType GetPixelCacheColorspace(const Cache cache)
{
  CacheInfo
    *__restrict__ cache_info;

  
# 2156 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2156 "MagickCore/cache.c"
 cache != (Cache) 
# 2156 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2156 "MagickCore/cache.c"
...
# 2156 "MagickCore/cache.c"
 "cache != (Cache) NULL"
# 2156 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2156, __extension__ __PRETTY_FUNCTION__); }))
# 2156 "MagickCore/cache.c"
                              ;
  cache_info=(CacheInfo *) cache;
  
# 2158 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2158 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2158 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2158 "MagickCore/cache.c"
...
# 2158 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2158 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2158, __extension__ __PRETTY_FUNCTION__); }))
# 2158 "MagickCore/cache.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 2160,"%s",
      cache_info->filename);
  return(cache_info->colorspace);
}
# 2188 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) const char *GetPixelCacheFilename(const Image *image)
{
  CacheInfo
    *__restrict__ cache_info;

  
# 2193 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2193 "MagickCore/cache.c"
 image != (const Image *) 
# 2193 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2193 "MagickCore/cache.c"
...
# 2193 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 2193 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2193, __extension__ __PRETTY_FUNCTION__); }))
# 2193 "MagickCore/cache.c"
                                      ;
  
# 2194 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2194 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 2194 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2194 "MagickCore/cache.c"
...
# 2194 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 2194 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2194, __extension__ __PRETTY_FUNCTION__); }))
# 2194 "MagickCore/cache.c"
                                                ;
  
# 2195 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2195 "MagickCore/cache.c"
 image->cache != (Cache) 
# 2195 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2195 "MagickCore/cache.c"
...
# 2195 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 2195 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2195, __extension__ __PRETTY_FUNCTION__); }))
# 2195 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 2197 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2197 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2197 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2197 "MagickCore/cache.c"
...
# 2197 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2197 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2197, __extension__ __PRETTY_FUNCTION__); }))
# 2197 "MagickCore/cache.c"
                                                     ;
  return(cache_info->cache_filename);
}
# 2223 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) void GetPixelCacheMethods(CacheMethods *cache_methods)
{
  
# 2225 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2225 "MagickCore/cache.c"
...
# 2225 "MagickCore/cache.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 2225 "MagickCore/cache.c"
 "cache_methods != (CacheMethods *) NULL"
# 2225 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2225, __extension__ __PRETTY_FUNCTION__); }))
# 2225 "MagickCore/cache.c"
                                               ;
...
# 2268 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) MagickSizeType GetPixelCacheNexusExtent(const Cache cache,
  NexusInfo *__restrict__ nexus_info)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 2277 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2277 "MagickCore/cache.c"
 cache != 
# 2277 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2277 "MagickCore/cache.c"
...
# 2277 "MagickCore/cache.c"
 "cache != NULL"
# 2277 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2277, __extension__ __PRETTY_FUNCTION__); }))
# 2277 "MagickCore/cache.c"
                      ;
  cache_info=(CacheInfo *) cache;
  
# 2279 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2279 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2279 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2279 "MagickCore/cache.c"
...
# 2279 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2279 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2279, __extension__ __PRETTY_FUNCTION__); }))
# 2279 "MagickCore/cache.c"
                                                     ;
...
# 2313 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) void *GetPixelCachePixels(Image *image,MagickSizeType *length,
...
# 2319 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2319 "MagickCore/cache.c"
 image != (const Image *) 
# 2319 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2319 "MagickCore/cache.c"
...
# 2319 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 2319 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2319, __extension__ __PRETTY_FUNCTION__); }))
# 2319 "MagickCore/cache.c"
                                      ;
  
# 2320 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2320 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 2320 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2320 "MagickCore/cache.c"
...
# 2320 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 2320 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2320, __extension__ __PRETTY_FUNCTION__); }))
# 2320 "MagickCore/cache.c"
                                                ;
  
# 2321 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2321 "MagickCore/cache.c"
 image->cache != (Cache) 
# 2321 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2321 "MagickCore/cache.c"
...
# 2321 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 2321 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2321, __extension__ __PRETTY_FUNCTION__); }))
# 2321 "MagickCore/cache.c"
                                     ;
  
# 2322 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2322 "MagickCore/cache.c"
...
# 2322 "MagickCore/cache.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 2322 "MagickCore/cache.c"
 "length != (MagickSizeType *) NULL"
# 2322 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2322, __extension__ __PRETTY_FUNCTION__); }))
# 2322 "MagickCore/cache.c"
                                          ;
  ;
  cache_info=(CacheInfo *) image->cache;
  
# 2325 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2325 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2325 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2325 "MagickCore/cache.c"
...
# 2325 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2325 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2325, __extension__ __PRETTY_FUNCTION__); }))
# 2325 "MagickCore/cache.c"
                                                     ;
  *length=cache_info->length;
  if ((cache_info->type != MemoryCache) && (cache_info->type != MapCache))
    return((void *) 
# 2328 "MagickCore/cache.c" 3 4
                   ((void *)0)
# 2328 "MagickCore/cache.c"
                       );
  return((void *) cache_info->pixels);
}
# 2356 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) ClassType GetPixelCacheStorageClass(const Cache cache)
{
  CacheInfo
    *__restrict__ cache_info;

  
# 2361 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2361 "MagickCore/cache.c"
 cache != (Cache) 
# 2361 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2361 "MagickCore/cache.c"
...
# 2361 "MagickCore/cache.c"
 "cache != (Cache) NULL"
# 2361 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2361, __extension__ __PRETTY_FUNCTION__); }))
# 2361 "MagickCore/cache.c"
                              ;
  cache_info=(CacheInfo *) cache;
  
# 2363 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2363 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2363 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2363 "MagickCore/cache.c"
...
# 2363 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2363 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2363, __extension__ __PRETTY_FUNCTION__); }))
# 2363 "MagickCore/cache.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 2365,"%s",
      cache_info->filename);
  return(cache_info->storage_class);
}
# 2397 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) void GetPixelCacheTileSize(const Image *image,size_t *width,
  size_t *height)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 2403 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2403 "MagickCore/cache.c"
 image != (Image *) 
# 2403 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2403 "MagickCore/cache.c"
...
# 2403 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 2403 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2403, __extension__ __PRETTY_FUNCTION__); }))
# 2403 "MagickCore/cache.c"
                                ;
  
# 2404 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2404 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 2404 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2404 "MagickCore/cache.c"
...
# 2404 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 2404 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2404, __extension__ __PRETTY_FUNCTION__); }))
# 2404 "MagickCore/cache.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 2406,"%s",image->filename);
  cache_info=(CacheInfo *) image->cache;
  
# 2408 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2408 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2408 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2408 "MagickCore/cache.c"
...
# 2408 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2408 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2408, __extension__ __PRETTY_FUNCTION__); }))
# 2408 "MagickCore/cache.c"
                                                     ;
  *width=2048UL/((((cache_info->number_channels) > (1)) ? (cache_info->number_channels) : (1))*sizeof(Quantum));
  if (GetImagePixelCacheType(image) == DiskCache)
    *width=8192UL/((((cache_info->number_channels) > (1)) ? (cache_info->number_channels) : (1))*sizeof(Quantum));
  *height=(*width);
}
# 2439 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) VirtualPixelMethod GetPixelCacheVirtualMethod(const Image *image)
{
  CacheInfo
    *__restrict__ cache_info;

  
# 2444 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2444 "MagickCore/cache.c"
 image != (Image *) 
# 2444 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2444 "MagickCore/cache.c"
...
# 2444 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 2444 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2444, __extension__ __PRETTY_FUNCTION__); }))
# 2444 "MagickCore/cache.c"
                                ;
  
# 2445 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2445 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 2445 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2445 "MagickCore/cache.c"
...
# 2445 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 2445 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2445, __extension__ __PRETTY_FUNCTION__); }))
# 2445 "MagickCore/cache.c"
                                                ;
  
# 2446 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2446 "MagickCore/cache.c"
 image->cache != (Cache) 
# 2446 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2446 "MagickCore/cache.c"
...
# 2446 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 2446 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2446, __extension__ __PRETTY_FUNCTION__); }))
# 2446 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 2448 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2448 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2448 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2448 "MagickCore/cache.c"
...
# 2448 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2448 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2448, __extension__ __PRETTY_FUNCTION__); }))
# 2448 "MagickCore/cache.c"
                                                     ;
  return(cache_info->virtual_pixel_method);
}
# 2475 "MagickCore/cache.c"
static const void *GetVirtualMetacontentFromCache(const Image *image)
{
  ...
  const void
    *__restrict__ metacontent;

  
# 2486 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2486 "MagickCore/cache.c"
 image != (const Image *) 
# 2486 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2486 "MagickCore/cache.c"
...
# 2486 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 2486 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2486, __extension__ __PRETTY_FUNCTION__); }))
# 2486 "MagickCore/cache.c"
                                      ;
  
# 2487 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2487 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 2487 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2487 "MagickCore/cache.c"
...
# 2487 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 2487 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2487, __extension__ __PRETTY_FUNCTION__); }))
# 2487 "MagickCore/cache.c"
                                                ;
  
# 2488 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2488 "MagickCore/cache.c"
 image->cache != (Cache) 
# 2488 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2488 "MagickCore/cache.c"
...
# 2488 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 2488 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2488, __extension__ __PRETTY_FUNCTION__); }))
# 2488 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 2490 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2490 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2490 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2490 "MagickCore/cache.c"
...
# 2490 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2490 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2490, __extension__ __PRETTY_FUNCTION__); }))
# 2490 "MagickCore/cache.c"
                                                     ;
  
# 2491 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2491 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 2491 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2491 "MagickCore/cache.c"
...
# 2491 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 2491 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2491, __extension__ __PRETTY_FUNCTION__); }))
# 2491 "MagickCore/cache.c"
                                              ;
...
# 2523 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) const void *GetVirtualMetacontentFromNexus(const Cache cache,
  NexusInfo *__restrict__ nexus_info)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 2529 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2529 "MagickCore/cache.c"
 cache != (Cache) 
# 2529 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2529 "MagickCore/cache.c"
...
# 2529 "MagickCore/cache.c"
 "cache != (Cache) NULL"
# 2529 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2529, __extension__ __PRETTY_FUNCTION__); }))
# 2529 "MagickCore/cache.c"
                              ;
  cache_info=(CacheInfo *) cache;
  
# 2531 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2531 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2531 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2531 "MagickCore/cache.c"
...
# 2531 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2531 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2531, __extension__ __PRETTY_FUNCTION__); }))
# 2531 "MagickCore/cache.c"
                                                     ;
  if (cache_info->storage_class == UndefinedClass)
    return((void *) 
# 2533 "MagickCore/cache.c" 3 4
                   ((void *)0)
# 2533 "MagickCore/cache.c"
                       );
  return(nexus_info->metacontent);
}
# 2561 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) const void *GetVirtualMetacontent(const Image *image)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 2572 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2572 "MagickCore/cache.c"
 image != (const Image *) 
# 2572 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2572 "MagickCore/cache.c"
...
# 2572 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 2572 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2572, __extension__ __PRETTY_FUNCTION__); }))
# 2572 "MagickCore/cache.c"
                                      ;
  
# 2573 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2573 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 2573 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2573 "MagickCore/cache.c"
...
# 2573 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 2573 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2573, __extension__ __PRETTY_FUNCTION__); }))
# 2573 "MagickCore/cache.c"
                                                ;
  
# 2574 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2574 "MagickCore/cache.c"
 image->cache != (Cache) 
# 2574 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2574 "MagickCore/cache.c"
...
# 2574 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 2574 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2574, __extension__ __PRETTY_FUNCTION__); }))
# 2574 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 2576 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2576 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2576 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2576 "MagickCore/cache.c"
...
# 2576 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2576 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2576, __extension__ __PRETTY_FUNCTION__); }))
# 2576 "MagickCore/cache.c"
                                                     ;
  if (cache_info->methods.get_virtual_metacontent_from_handler != (GetVirtualMetacontentFromHandler) 
# 2577 "MagickCore/cache.c" 3 4
                                                                                                    ((void *)0)
# 2577 "MagickCore/cache.c"
                                                                                                        )
    {
      metacontent=cache_info->methods.get_virtual_metacontent_from_handler(
        image);
      if (metacontent != (const void *) 
# 2581 "MagickCore/cache.c" 3 4
                                       ((void *)0)
# 2581 "MagickCore/cache.c"
                                           )
        return(metacontent);
    }
  
# 2584 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2584 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 2584 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2584 "MagickCore/cache.c"
...
# 2584 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 2584 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2584, __extension__ __PRETTY_FUNCTION__); }))
# 2584 "MagickCore/cache.c"
                                              ;
  metacontent=GetVirtualMetacontentFromNexus(cache_info,
    cache_info->nexus_info[id]);
...
static inline MagickBooleanType IsOffsetOverflow(const ssize_t x,
  const ssize_t y)
{
  if (((y > 0) && (x > ((0x7fffffffffffffffL
# 2687 "MagickCore/cache.c"
                       )-y))) ||
      ((y < 0) && (x < ((-0x7fffffffffffffffL 
# 2688 "MagickCore/cache.c"
                       -1)-y))))
    return(MagickFalse);
  return(MagickTrue);
}
...
__attribute__ ((visibility ("hidden"))) const Quantum *GetVirtualPixelCacheNexus(const Image *image,
  const VirtualPixelMethod virtual_pixel_method,const ssize_t x,const ssize_t y,
  ...
  ExceptionInfo *exception)
{
  ...
  void
    *__restrict__ virtual_metacontent;




  
# 2767 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2767 "MagickCore/cache.c"
 image != (const Image *) 
# 2767 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2767 "MagickCore/cache.c"
...
# 2767 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 2767 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2767, __extension__ __PRETTY_FUNCTION__); }))
# 2767 "MagickCore/cache.c"
                                      ;
  
# 2768 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2768 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 2768 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2768 "MagickCore/cache.c"
...
# 2768 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 2768 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2768, __extension__ __PRETTY_FUNCTION__); }))
# 2768 "MagickCore/cache.c"
                                                ;
  
# 2769 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2769 "MagickCore/cache.c"
 image->cache != (Cache) 
# 2769 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2769 "MagickCore/cache.c"
...
# 2769 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 2769 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2769, __extension__ __PRETTY_FUNCTION__); }))
# 2769 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 2771 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 2771 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 2771 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2771 "MagickCore/cache.c"
...
# 2771 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 2771 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 2771, __extension__ __PRETTY_FUNCTION__); }))
# 2771 "MagickCore/cache.c"
                                                     ;
  if (cache_info->type == UndefinedCache)
    return((const Quantum *) 
# 2773 "MagickCore/cache.c" 3 4
                            ((void *)0)
# 2773 "MagickCore/cache.c"
                                );
  ...
  pixels=SetPixelCacheNexusPixels(cache_info,ReadMode,x,y,columns,rows,
    ...
    nexus_info,exception);
  if (pixels == (Quantum *) 
# 2781 "MagickCore/cache.c" 3 4
                           ((void *)0)
# 2781 "MagickCore/cache.c"
                               )
    return((const Quantum *) 
# 2782 "MagickCore/cache.c" 3 4
                            ((void *)0)
# 2782 "MagickCore/cache.c"
                                );
  if (IsValidPixelOffset(nexus_info->region.y,cache_info->columns) == MagickFalse)
    return((const Quantum *) 
# 2784 "MagickCore/cache.c" 3 4
                            ((void *)0)
# 2784 "MagickCore/cache.c"
                                );
  offset=nexus_info->region.y*(MagickOffsetType) cache_info->columns;
  if (IsOffsetOverflow(offset,nexus_info->region.x) == MagickFalse)
    return((const Quantum *) 
# 2787 "MagickCore/cache.c" 3 4
                            ((void *)0)
# 2787 "MagickCore/cache.c"
                                );
  ...
  if ((offset >= 0) && (((MagickSizeType) offset+length) < number_pixels))
    if ((x >= 0) && ((x+(ssize_t) columns-1) < (ssize_t) cache_info->columns) &&
        (y >= 0) && ((y+(ssize_t) rows-1) < (ssize_t) cache_info->rows))
      {
        ...
        if (status == MagickFalse)
          return((const Quantum *) 
# 2806 "MagickCore/cache.c" 3 4
                                  ((void *)0)
# 2806 "MagickCore/cache.c"
                                      );
        if (cache_info->metacontent_extent != 0)
          {
            ...
            if (status == MagickFalse)
              return((const Quantum *) 
# 2811 "MagickCore/cache.c" 3 4
                                      ((void *)0)
# 2811 "MagickCore/cache.c"
                                          );
          }
        return(pixels);
      }
  ...
  virtual_metacontent=(void *) 
# 2823 "MagickCore/cache.c" 3 4
                              ((void *)0)
# 2823 "MagickCore/cache.c"
                                  ;
      ...
      if (cache_info->metacontent_extent != 0)
        {
          ...
          if (virtual_metacontent == (void *) 
# 2844 "MagickCore/cache.c" 3 4
                                             ((void *)0)
# 2844 "MagickCore/cache.c"
                                                 )
            {
              (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 2846,
                CacheError,"UnableToGetCacheNexus","`%s'",image->filename);
              return((const Quantum *) 
# 2848 "MagickCore/cache.c" 3 4
                                      ((void *)0)
# 2848 "MagickCore/cache.c"
                                          );
            }
      ...
      switch (virtual_pixel_method)
      {
        case BlackVirtualPixelMethod:
        {
          ...
          SetPixelAlpha(image,((Quantum) ((Quantum) 65535.0)),virtual_pixel);
          break;
        }
        case GrayVirtualPixelMethod:
        {
          for (i=0; i < (ssize_t) cache_info->number_channels; i++)
            SetPixelChannel(image,(PixelChannel) i,((Quantum) 65535.0)/2,
              virtual_pixel);
          SetPixelAlpha(image,((Quantum) ((Quantum) 65535.0)),virtual_pixel);
          break;
        }
        case TransparentVirtualPixelMethod:
        {
          for (i=0; i < (ssize_t) cache_info->number_channels; i++)
            SetPixelChannel(image,(PixelChannel) i,(Quantum) 0,virtual_pixel);
          SetPixelAlpha(image,((Quantum) 0),virtual_pixel);
          break;
        }
        case MaskVirtualPixelMethod:
        case WhiteVirtualPixelMethod:
        {
          for (i=0; i < (ssize_t) cache_info->number_channels; i++)
            SetPixelChannel(image,(PixelChannel) i,((Quantum) 65535.0),virtual_pixel);
          SetPixelAlpha(image,((Quantum) ((Quantum) 65535.0)),virtual_pixel);
          break;
        }
        default:
  ...
  for (v=0; v < (ssize_t) rows; v++)
  {
    ...
    for (u=0; u < (ssize_t) columns; u+=(ssize_t) length)
    {
      ...
      x_offset=x+u;
      length=(MagickSizeType) ((((ssize_t) cache_info->columns- x_offset) < ((ssize_t) columns-u)) ? ((ssize_t) cache_info->columns- x_offset) : ((ssize_t) columns-u))
                                     ;
      if (((x_offset < 0) || (x_offset >= (ssize_t) cache_info->columns)) ||
          ...
          (length == 0))
        {
          ...
          switch (virtual_pixel_method)
          {
            ...
            {
              if (cache_info->random_info == (RandomInfo *) 
# 2947 "MagickCore/cache.c" 3 4
                                                           ((void *)0)
# 2947 "MagickCore/cache.c"
                                                               )
          ...
          if (p == (const Quantum *) 
# 3069 "MagickCore/cache.c" 3 4
                                    ((void *)0)
# 3069 "MagickCore/cache.c"
                                        )
            break;
          ...
          if ((s != (void *) 
# 3074 "MagickCore/cache.c" 3 4
                            ((void *)0)
# 3074 "MagickCore/cache.c"
                                ) && (r != (const void *) 
# 3074 "MagickCore/cache.c" 3 4
                                                          ((void *)0)
# 3074 "MagickCore/cache.c"
      ...
      if (p == (const Quantum *) 
# 3086 "MagickCore/cache.c" 3 4
                                ((void *)0)
# 3086 "MagickCore/cache.c"
                                    )
        break;
      r=GetVirtualMetacontentFromNexus(cache_info,virtual_nexus);
      (void) memcpy(q,p,(size_t) (cache_info->number_channels*length*
      ...
      if ((r != (void *) 
# 3092 "MagickCore/cache.c" 3 4
                        ((void *)0)
# 3092 "MagickCore/cache.c"
                            ) && (s != (const void *) 
# 3092 "MagickCore/cache.c" 3 4
                                                      ((void *)0)
# 3092 "MagickCore/cache.c"
  ...
  if (virtual_metacontent != (void *) 
# 3104 "MagickCore/cache.c" 3 4
                                     ((void *)0)
# 3104 "MagickCore/cache.c"
                                         )
    virtual_metacontent=(void *) RelinquishMagickMemory(virtual_metacontent);
  if (v < (ssize_t) rows)
    return((const Quantum *) 
# 3107 "MagickCore/cache.c" 3 4
                            ((void *)0)
# 3107 "MagickCore/cache.c"
                                );
  return(pixels);
}
# 3145 "MagickCore/cache.c"
...
# 3158 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3158 "MagickCore/cache.c"
 image != (const Image *) 
# 3158 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3158 "MagickCore/cache.c"
...
# 3158 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 3158 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3158, __extension__ __PRETTY_FUNCTION__); }))
# 3158 "MagickCore/cache.c"
                                      ;
  
# 3159 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3159 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 3159 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3159 "MagickCore/cache.c"
...
# 3159 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 3159 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3159, __extension__ __PRETTY_FUNCTION__); }))
# 3159 "MagickCore/cache.c"
                                                ;
  
# 3160 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3160 "MagickCore/cache.c"
 image->cache != (Cache) 
# 3160 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3160 "MagickCore/cache.c"
...
# 3160 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 3160 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3160, __extension__ __PRETTY_FUNCTION__); }))
# 3160 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 3162 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3162 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 3162 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3162 "MagickCore/cache.c"
...
# 3162 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 3162 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3162, __extension__ __PRETTY_FUNCTION__); }))
# 3162 "MagickCore/cache.c"
                                                     ;
  
# 3163 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3163 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 3163 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3163 "MagickCore/cache.c"
...
# 3163 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 3163 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3163, __extension__ __PRETTY_FUNCTION__); }))
# 3163 "MagickCore/cache.c"
                                              ;
...
# 3192 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) const Quantum *GetVirtualPixelQueue(const Image *image)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 3200 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3200 "MagickCore/cache.c"
 image != (const Image *) 
# 3200 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3200 "MagickCore/cache.c"
...
# 3200 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 3200 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3200, __extension__ __PRETTY_FUNCTION__); }))
# 3200 "MagickCore/cache.c"
                                      ;
  
# 3201 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3201 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 3201 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3201 "MagickCore/cache.c"
...
# 3201 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 3201 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3201, __extension__ __PRETTY_FUNCTION__); }))
# 3201 "MagickCore/cache.c"
                                                ;
  
# 3202 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3202 "MagickCore/cache.c"
 image->cache != (Cache) 
# 3202 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3202 "MagickCore/cache.c"
...
# 3202 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 3202 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3202, __extension__ __PRETTY_FUNCTION__); }))
# 3202 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 3204 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3204 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 3204 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3204 "MagickCore/cache.c"
...
# 3204 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 3204 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3204, __extension__ __PRETTY_FUNCTION__); }))
# 3204 "MagickCore/cache.c"
                                                     ;
  if (cache_info->methods.get_virtual_pixels_handler !=
       (GetVirtualPixelsHandler) 
# 3206 "MagickCore/cache.c" 3 4
                                ((void *)0)
# 3206 "MagickCore/cache.c"
                                    )
    return(cache_info->methods.get_virtual_pixels_handler(image));
  
# 3208 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3208 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 3208 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3208 "MagickCore/cache.c"
...
# 3208 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 3208 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3208, __extension__ __PRETTY_FUNCTION__); }))
# 3208 "MagickCore/cache.c"
                                              ;
  return(GetVirtualPixelsNexus(cache_info,cache_info->nexus_info[id]));
}
# 3260 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) const Quantum *GetVirtualPixels(const Image *image,
...
# 3273 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3273 "MagickCore/cache.c"
 image != (const Image *) 
# 3273 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3273 "MagickCore/cache.c"
...
# 3273 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 3273 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3273, __extension__ __PRETTY_FUNCTION__); }))
# 3273 "MagickCore/cache.c"
                                      ;
  
# 3274 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3274 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 3274 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3274 "MagickCore/cache.c"
...
# 3274 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 3274 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3274, __extension__ __PRETTY_FUNCTION__); }))
# 3274 "MagickCore/cache.c"
                                                ;
  
# 3275 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3275 "MagickCore/cache.c"
 image->cache != (Cache) 
# 3275 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3275 "MagickCore/cache.c"
...
# 3275 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 3275 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3275, __extension__ __PRETTY_FUNCTION__); }))
# 3275 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 3277 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3277 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 3277 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3277 "MagickCore/cache.c"
...
# 3282 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 3282 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3282, __extension__ __PRETTY_FUNCTION__); }))
# 3282 "MagickCore/cache.c"
                                              ;
  p=GetVirtualPixelCacheNexus(image,GetPixelCacheVirtualMethod(image),x,y,
...
# 3319 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3319 "MagickCore/cache.c"
 image != (const Image *) 
# 3319 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3319 "MagickCore/cache.c"
...
# 3319 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 3319 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3319, __extension__ __PRETTY_FUNCTION__); }))
# 3319 "MagickCore/cache.c"
                                      ;
  
# 3320 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3320 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 3320 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3320 "MagickCore/cache.c"
...
# 3320 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 3320 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3320, __extension__ __PRETTY_FUNCTION__); }))
# 3320 "MagickCore/cache.c"
                                                ;
  
# 3321 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3321 "MagickCore/cache.c"
 image->cache != (Cache) 
# 3321 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3321 "MagickCore/cache.c"
...
# 3321 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 3321 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3321, __extension__ __PRETTY_FUNCTION__); }))
# 3321 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 3323 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3323 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 3323 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3323 "MagickCore/cache.c"
...
# 3323 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 3323 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3323, __extension__ __PRETTY_FUNCTION__); }))
# 3323 "MagickCore/cache.c"
                                                     ;
  
# 3324 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3324 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 3324 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3324 "MagickCore/cache.c"
...
# 3324 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 3324 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3324, __extension__ __PRETTY_FUNCTION__); }))
# 3324 "MagickCore/cache.c"
                                              ;
  return(GetVirtualPixelsNexus(image->cache,cache_info->nexus_info[id]));
}
# 3354 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) const Quantum *GetVirtualPixelsNexus(const Cache cache,
  NexusInfo *__restrict__ nexus_info)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 3360 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3360 "MagickCore/cache.c"
 cache != (Cache) 
# 3360 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3360 "MagickCore/cache.c"
...
# 3360 "MagickCore/cache.c"
 "cache != (Cache) NULL"
# 3360 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3360, __extension__ __PRETTY_FUNCTION__); }))
# 3360 "MagickCore/cache.c"
                              ;
  cache_info=(CacheInfo *) cache;
  
# 3362 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3362 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 3362 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3362 "MagickCore/cache.c"
...
# 3362 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 3362 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3362, __extension__ __PRETTY_FUNCTION__); }))
# 3362 "MagickCore/cache.c"
                                                     ;
  if (cache_info->storage_class == UndefinedClass)
    return((Quantum *) 
# 3364 "MagickCore/cache.c" 3 4
                      ((void *)0)
# 3364 "MagickCore/cache.c"
                          );
  return((const Quantum *) nexus_info->pixels);
}
# 3398 "MagickCore/cache.c"
  ...
  const MagickRealType alpha,const Quantum q,const MagickRealType beta)
{
  ...
  if (fabs((double) (alpha-(double) ((Quantum) 0))) < 1.0e-12)
    return(q);
  gamma=1.0-((double) 1.0/(double) ((Quantum) 65535.0))*((double) 1.0/(double) ((Quantum) 65535.0))*alpha*beta;
  gamma=PerceptibleReciprocal(gamma);
  ...
  ExceptionInfo *exception)
{
  ...
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 3428,"%s",image->filename);
  ...
  cache_info=(CacheInfo *) image->cache;
  if (cache_info == (Cache) 
# 3434 "MagickCore/cache.c" 3 4
                           ((void *)0)
# 3434 "MagickCore/cache.c"
                               )
    return(MagickFalse);
  p=GetAuthenticPixelCacheNexus(image,nexus_info->region.x,nexus_info->region.y,
    nexus_info->region.width,nexus_info->region.height,
  ...
  q=nexus_info->pixels;
  if ((p == (Quantum *) 
# 3440 "MagickCore/cache.c" 3 4
                       ((void *)0)
# 3440 "MagickCore/cache.c"
                           ) || (q == (Quantum *) 
# 3440 "MagickCore/cache.c" 3 4
                                                  ((void *)0)
# 3440 "MagickCore/cache.c"
  ...
  const MapMode mode)
{
  ...
  if (*cache_info->cache_filename == '\0')
    ...
    switch (mode)
    {
      case ReadMode:
      {
        file=open_utf8(cache_info->cache_filename,
# 3520 "MagickCore/cache.c" 3 4
                                                 00 
# 3520 "MagickCore/cache.c"
                                                          | 0x00,0);
        break;
      }
      case WriteMode:
      {
        file=open_utf8(cache_info->cache_filename,
# 3525 "MagickCore/cache.c" 3 4
                                                 01 
# 3525 "MagickCore/cache.c"
                                                          | 
# 3525 "MagickCore/cache.c" 3 4
                                                            0100 
# 3525 "MagickCore/cache.c"
                                                                    |
          0x00 | 
# 3526 "MagickCore/cache.c" 3 4
                    0200
# 3526 "MagickCore/cache.c"
                          ,(
# 3526 "MagickCore/cache.c" 3 4
                           0400 
# 3526 "MagickCore/cache.c"
...
# 3526 "MagickCore/cache.c"
        ...
        if (file == -1)
          file=open_utf8(cache_info->cache_filename,
# 3528 "MagickCore/cache.c" 3 4
                                                   01 
# 3528 "MagickCore/cache.c"
                                                            | 0x00,(
# 3528 "MagickCore/cache.c" 3 4
                                                                       0400 
# 3528 "MagickCore/cache.c"
...
# 3528 "MagickCore/cache.c"
      ...
      {
        file=open_utf8(cache_info->cache_filename,
# 3534 "MagickCore/cache.c" 3 4
                                                 02 
# 3534 "MagickCore/cache.c"
                                                        | 
# 3534 "MagickCore/cache.c" 3 4
                                                          0100 
# 3534 "MagickCore/cache.c"
...
# 3535 "MagickCore/cache.c" 3 4
         0200
# 3535 "MagickCore/cache.c"
               ,(
# 3535 "MagickCore/cache.c" 3 4
                0400 
# 3535 "MagickCore/cache.c"
...
# 3535 "MagickCore/cache.c"
        ...
        if (file == -1)
          file=open_utf8(cache_info->cache_filename,
# 3537 "MagickCore/cache.c" 3 4
                                                   02 
# 3537 "MagickCore/cache.c"
                                                          | 0x00,(
# 3537 "MagickCore/cache.c" 3 4
                                                                     0400 
# 3537 "MagickCore/cache.c"
...
static inline MagickOffsetType WritePixelCacheRegion(
  const CacheInfo *__restrict__ cache_info,const MagickOffsetType offset,
  const MagickSizeType length,const unsigned char *__restrict__ buffer)
{
  MagickOffsetType
    i;
  ...
  for (i=0; i < (MagickOffsetType) length; i+=count)
  {
    ...
    count=pwrite(cache_info->file,buffer+i,(size_t) (((length- (MagickSizeType) i) < ((0x7fffffffffffffffL
# 3571 "MagickCore/cache.c"
                                                   ))) ? (length- (MagickSizeType) i) : ((0x7fffffffffffffffL
# 3571 "MagickCore/cache.c"
                                                   )))
                                          ,offset+i);
    ...
    if (count <= 0)
      {
        count=0;
        if (
# 3577 "MagickCore/cache.c" 3 4
           (*__errno_location ()) 
# 3577 "MagickCore/cache.c"
                 != 
# 3577 "MagickCore/cache.c" 3 4
                    4
# 3577 "MagickCore/cache.c"
  ...
  if (cache_info->debug != MagickFalse)
    {
      ...
      (void) FormatMagickSize(length,MagickFalse,"B",4096,format);
      (void) FormatLocaleString(message,4096,
        "extend %s (%s[%d], disk, %s)",cache_info->filename,
        cache_info->cache_filename,cache_info->file,format);
      (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 3603,"%s",message);
    }
  if (length != (MagickSizeType) ((MagickOffsetType) length))
    return(MagickFalse);
  offset=(MagickOffsetType) lseek(cache_info->file,0,
# 3607 "MagickCore/cache.c" 3 4
                                                    2
# 3607 "MagickCore/cache.c"
                                                            );
  if (offset < 0)
    return(MagickFalse);
  ...
  offset=(MagickOffsetType) lseek(cache_info->file,0,
# 3627 "MagickCore/cache.c" 3 4
                                                    0
# 3627 "MagickCore/cache.c"
                                                            );
  if (offset < 0)
    return(MagickFalse);
  return(MagickTrue);
...
# 3659 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3659 "MagickCore/cache.c"
 image != (const Image *) 
# 3659 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3659 "MagickCore/cache.c"
...
# 3659 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 3659 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3659, __extension__ __PRETTY_FUNCTION__); }))
# 3659 "MagickCore/cache.c"
                                      ;
  
# 3660 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3660 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 3660 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3660 "MagickCore/cache.c"
...
# 3660 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 3660 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3660, __extension__ __PRETTY_FUNCTION__); }))
# 3660 "MagickCore/cache.c"
                                                ;
  
# 3661 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3661 "MagickCore/cache.c"
 image->cache != (Cache) 
# 3661 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3661 "MagickCore/cache.c"
...
# 3661 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 3661 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3661, __extension__ __PRETTY_FUNCTION__); }))
# 3661 "MagickCore/cache.c"
                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 3663,"%s",image->filename);
  if (cache_anonymous_memory < 0)
    {
      ...
      if (value == (char *) 
# 3674 "MagickCore/cache.c" 3 4
                           ((void *)0)
# 3674 "MagickCore/cache.c"
                               )
  ...
  if ((image->columns == 0) || (image->rows == 0))
    { (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3689,CacheError,"NoPixelsDefinedInCache", "`%s'",image->filename); return(MagickFalse); };
  cache_info=(CacheInfo *) image->cache;
  
# 3691 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 3691 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 3691 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3691 "MagickCore/cache.c"
...
# 3691 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 3691 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 3691, __extension__ __PRETTY_FUNCTION__); }))
# 3691 "MagickCore/cache.c"
                                                     ;
  if (((MagickSizeType) image->columns > cache_info->width_limit) ||
      ((MagickSizeType) image->rows > cache_info->height_limit))
    { (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3694,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); return(MagickFalse); }
                      ;
  if (GetPixelChannels(image) >= 64)
    { (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3697,CorruptImageError,"MaximumChannelsExceeded", "`%s'",image->filename); return(MagickFalse); }
                      ;
  if (GetPixelMetaChannels(image) >= (64 -MetaPixelChannels))
    { (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3700,CorruptImageError,"MaximumChannelsExceeded", "`%s'",image->filename); return(MagickFalse); }
                      ;
  if (GetMagickResourceLimit(ListLengthResource) != (((MagickSizeType) (~0ULL)) >> 1))
    {
      length=GetImageListLength(image);
      if (AcquireMagickResource(ListLengthResource,length) == MagickFalse)
        { (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3706,ResourceLimitError,"ListLengthExceedsLimit", "`%s'",image->filename); return(MagickFalse); }
                          ;
    }
  source_info=(*cache_info);
  source_info.file=(-1);
  (void) FormatLocaleString(cache_info->filename,4096,"%s[%.20g]",
  ...
  (void) memcpy(cache_info->channel_map,image->channel_map,64*
    sizeof(*image->channel_map));
  cache_info->metacontent_extent=image->metacontent_extent;
  cache_info->mode=mode;
  number_pixels=(MagickSizeType) cache_info->columns*cache_info->rows;
  packet_size=(((cache_info->number_channels) > (1)) ? (cache_info->number_channels) : (1))*sizeof(Quantum);
  ...
  if ((cache_info->columns != columns) || ((ssize_t) cache_info->columns < 0) ||
    ...
    { (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3733,ResourceLimitError,"PixelCacheAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
      ...
      if (status != MagickFalse)
        {
          ...
          if (cache_anonymous_memory <= 0)
            {
              cache_info->mapped=MagickFalse;
              cache_info->pixels=(Quantum *) __builtin_assume_aligned((AcquireAlignedMemory(1,(size_t) cache_info->length)),(8 * 8))
                                                                    ;
            }
          else
            {
          ...
          if (cache_info->pixels == (Quantum *) 
# 3768 "MagickCore/cache.c" 3 4
                                               ((void *)0)
# 3768 "MagickCore/cache.c"
                                                   )
            {
          ...
          else
            {
              ...
              cache_info->type=MemoryCache;
              cache_info->metacontent=(void *) 
# 3779 "MagickCore/cache.c" 3 4
                                              ((void *)0)
# 3779 "MagickCore/cache.c"
                                                  ;
              if (cache_info->metacontent_extent != 0)
              ...
              if (cache_info->debug != MagickFalse)
                {
                  ...
                  (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 3802,"%s",
                    message);
                }
              cache_info->storage_class=image->storage_class;
              if (status == 0)
  ...
  hosts=(const char *) GetImageRegistry(StringRegistryType,"cache:hosts",
    exception);
  if ((status == MagickFalse) && (hosts != (const char *) 
# 3818 "MagickCore/cache.c" 3 4
                                                         ((void *)0)
# 3818 "MagickCore/cache.c"
                                                             ))
    {
      DistributeCacheInfo
        *server_info;
      ...
      if (server_info != (DistributeCacheInfo *) 
# 3827 "MagickCore/cache.c" 3 4
                                                ((void *)0)
# 3827 "MagickCore/cache.c"
                                                    )
        {
...
# 3832 "MagickCore/cache.c" 3 4
             (*__errno_location ())
# 3832 "MagickCore/cache.c"
             ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3832,CacheError,"UnableToOpenPixelCache", "'%s': %s",GetDistributeCacheHostname(server_info),file_message); file_message=DestroyString(file_message); }
                                                        ;
          ...
          else
            {
              ...
              (void) FormatLocaleString(cache_info->cache_filename,
                4096,"%s:%d",GetDistributeCacheHostname(
              ...
              if (cache_info->debug != MagickFalse)
                {
                  ...
                  (void) FormatLocaleString(message,4096,
                    ...
                    (double) cache_info->rows,(double)
                    cache_info->number_channels,format);
                  (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 3869,"%s",
                    message);
                }
              if (status == 0)
                {
      ...
      cache_info->type=UndefinedCache;
      (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3881,CacheError,
  ...
  if (status == MagickFalse)
    {
      cache_info->type=UndefinedCache;
      (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3891,CacheError,
        "CacheResourcesExhausted","`%s'",image->filename);
      return(MagickFalse);
    }
  ...
  if (OpenPixelCacheOnDisk(cache_info,mode) == MagickFalse)
    {
      cache_info->type=UndefinedCache;
      { char *file_message; file_message=GetExceptionMessage(
# 3904 "MagickCore/cache.c" 3 4
     (*__errno_location ())
# 3904 "MagickCore/cache.c"
     ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3904,CacheError,"UnableToOpenPixelCache", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                        ;
      return(MagickFalse);
    }
  ...
  if (status == MagickFalse)
    {
      cache_info->type=UndefinedCache;
      { char *file_message; file_message=GetExceptionMessage(
# 3913 "MagickCore/cache.c" 3 4
     (*__errno_location ())
# 3913 "MagickCore/cache.c"
     ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 3913,CacheError,"UnableToExtendCache", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                        ;
      return(MagickFalse);
    }
      ...
      if (status != MagickFalse)
        {
          ...
          if (cache_info->pixels == (Quantum *) 
# 3927 "MagickCore/cache.c" 3 4
                                               ((void *)0)
# 3927 "MagickCore/cache.c"
                                                   )
            {
              cache_info->mapped=source_info.mapped;
              cache_info->pixels=source_info.pixels;
          ...
          else
            {
              ...
              cache_info->mapped=MagickTrue;
              cache_info->metacontent=(void *) 
# 3941 "MagickCore/cache.c" 3 4
                                              ((void *)0)
# 3941 "MagickCore/cache.c"
                                                  ;
              if (cache_info->metacontent_extent != 0)
                cache_info->metacontent=(void *) (cache_info->pixels+
                  cache_info->number_channels*number_pixels);
              ...
              if (cache_info->debug != MagickFalse)
                {
                  ...
                  (void) FormatLocaleString(message,4096,
                    ...
                    (double) cache_info->rows,(double)
                    cache_info->number_channels,format);
                  (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 3964,"%s",
                    message);
                }
              if (status == 0)
                {
  ...
  if (cache_info->debug != MagickFalse)
    {
      ...
      (void) FormatLocaleString(message,4096,
        ...
        cache_info->number_channels,format);
      (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 3993,"%s",message);
    }
  if (status == 0)
    {
      cache_info->type=UndefinedCache;
...
# 4040 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) MagickBooleanType PersistPixelCache(Image *image,
...
# 4054 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4054 "MagickCore/cache.c"
 image != (Image *) 
# 4054 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4054 "MagickCore/cache.c"
...
# 4054 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 4054 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4054, __extension__ __PRETTY_FUNCTION__); }))
# 4054 "MagickCore/cache.c"
                                ;
  
# 4055 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4055 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 4055 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4055 "MagickCore/cache.c"
...
# 4055 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 4055 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4055, __extension__ __PRETTY_FUNCTION__); }))
# 4055 "MagickCore/cache.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 4057,"%s",image->filename);
  
# 4058 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4058 "MagickCore/cache.c"
 image->cache != (void *) 
# 4058 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4058 "MagickCore/cache.c"
...
# 4058 "MagickCore/cache.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 4058 "MagickCore/cache.c"
 "image->cache != (void *) NULL"
# 4058 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4058, __extension__ __PRETTY_FUNCTION__); }))
# 4058 "MagickCore/cache.c"
                                      ;
  
# 4059 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4059 "MagickCore/cache.c"
 filename != (const char *) 
# 4059 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4059 "MagickCore/cache.c"
...
# 4059 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4059, __extension__ __PRETTY_FUNCTION__); }))
# 4059 "MagickCore/cache.c"
                                        ;
  
# 4060 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4060 "MagickCore/cache.c"
...
# 4060 "MagickCore/cache.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 4060 "MagickCore/cache.c"
 "offset != (MagickOffsetType *) NULL"
# 4060 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4060, __extension__ __PRETTY_FUNCTION__); }))
# 4060 "MagickCore/cache.c"
                                            ;
  page_size=GetMagickPageSize();
  cache_info=(CacheInfo *) image->cache;
  
# 4063 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4063 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 4063 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4063 "MagickCore/cache.c"
...
# 4063 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 4063 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4063, __extension__ __PRETTY_FUNCTION__); }))
# 4063 "MagickCore/cache.c"
                                                     ;
  ...
  if (attach != MagickFalse)
    {
      ...
      if (cache_info->debug != MagickFalse)
        (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 4073,
  ...
  if (status == MagickFalse)
    {
      (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 4091,CacheError,
        "CacheResourcesExhausted","`%s'",image->filename);
      return(MagickFalse);
    }
  clone_info=(CacheInfo *) ClonePixelCache(cache_info);
  clone_info->type=DiskCache;
  (void) CopyMagickString(clone_info->cache_filename,filename,4096);
  clone_info->file=(-1);
  ...
  (void) memcpy(clone_info->channel_map,cache_info->channel_map,
    64*sizeof(*cache_info->channel_map));
...
# 4159 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) Quantum *QueueAuthenticPixelCacheNexus(Image *image,
  const ssize_t x,const ssize_t y,const size_t columns,const size_t rows,
...
# 4178 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4178 "MagickCore/cache.c"
 image != (const Image *) 
# 4178 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4178 "MagickCore/cache.c"
...
# 4178 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 4178 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4178, __extension__ __PRETTY_FUNCTION__); }))
# 4178 "MagickCore/cache.c"
                                      ;
  
# 4179 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4179 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 4179 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4179 "MagickCore/cache.c"
...
# 4179 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 4179 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4179, __extension__ __PRETTY_FUNCTION__); }))
# 4179 "MagickCore/cache.c"
                                                ;
  
# 4180 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4180 "MagickCore/cache.c"
 image->cache != (Cache) 
# 4180 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4180 "MagickCore/cache.c"
...
# 4180 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 4180 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4180, __extension__ __PRETTY_FUNCTION__); }))
# 4180 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) GetImagePixelCache(image,clone,exception);
  if (cache_info == (Cache) 
# 4182 "MagickCore/cache.c" 3 4
                           ((void *)0)
# 4182 "MagickCore/cache.c"
                               )
    return((Quantum *) 
# 4183 "MagickCore/cache.c" 3 4
                      ((void *)0)
# 4183 "MagickCore/cache.c"
                          );
  
# 4184 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4184 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 4184 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4184 "MagickCore/cache.c"
...
# 4184 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 4184 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4184, __extension__ __PRETTY_FUNCTION__); }))
# 4184 "MagickCore/cache.c"
                                                     ;
  if ((cache_info->columns == 0) || (cache_info->rows == 0) || (x < 0) ||
    ...
    {
      (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 4189,CacheError,
        "PixelsAreNotAuthentic","`%s'",image->filename);
      return((Quantum *) 
# 4191 "MagickCore/cache.c" 3 4
                        ((void *)0)
# 4191 "MagickCore/cache.c"
                            );
    }
  if (IsValidPixelOffset(y,cache_info->columns) == MagickFalse)
    return((Quantum *) 
# 4194 "MagickCore/cache.c" 3 4
                      ((void *)0)
# 4194 "MagickCore/cache.c"
                          );
  offset=y*(MagickOffsetType) cache_info->columns+x;
  if (offset < 0)
    return((Quantum *) 
# 4197 "MagickCore/cache.c" 3 4
                      ((void *)0)
# 4197 "MagickCore/cache.c"
                          );
  number_pixels=(MagickSizeType) cache_info->columns*cache_info->rows;
  ...
  if ((MagickSizeType) offset >= number_pixels)
    return((Quantum *) 
# 4202 "MagickCore/cache.c" 3 4
                      ((void *)0)
# 4202 "MagickCore/cache.c"
                          );
...
# 4259 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4259 "MagickCore/cache.c"
 image != (const Image *) 
# 4259 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4259 "MagickCore/cache.c"
...
# 4259 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 4259 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4259, __extension__ __PRETTY_FUNCTION__); }))
# 4259 "MagickCore/cache.c"
                                      ;
  
# 4260 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4260 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 4260 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4260 "MagickCore/cache.c"
...
# 4260 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 4260 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4260, __extension__ __PRETTY_FUNCTION__); }))
# 4260 "MagickCore/cache.c"
                                                ;
  
# 4261 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4261 "MagickCore/cache.c"
 image->cache != (Cache) 
# 4261 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4261 "MagickCore/cache.c"
...
# 4261 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 4261 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4261, __extension__ __PRETTY_FUNCTION__); }))
# 4261 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 4263 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4263 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 4263 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4263 "MagickCore/cache.c"
...
# 4263 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 4263 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4263, __extension__ __PRETTY_FUNCTION__); }))
# 4263 "MagickCore/cache.c"
                                                     ;
  
# 4264 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4264 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 4264 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4264 "MagickCore/cache.c"
...
# 4264 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 4264 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4264, __extension__ __PRETTY_FUNCTION__); }))
# 4264 "MagickCore/cache.c"
                                              ;
...
# 4326 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) Quantum *QueueAuthenticPixels(Image *image,const ssize_t x,
  const ssize_t y,const size_t columns,const size_t rows,
  ExceptionInfo *exception)
{
  CacheInfo
...
# 4339 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4339 "MagickCore/cache.c"
 image != (Image *) 
# 4339 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4339 "MagickCore/cache.c"
...
# 4339 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 4339 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4339, __extension__ __PRETTY_FUNCTION__); }))
# 4339 "MagickCore/cache.c"
                                ;
  
# 4340 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4340 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 4340 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4340 "MagickCore/cache.c"
...
# 4340 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 4340 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4340, __extension__ __PRETTY_FUNCTION__); }))
# 4340 "MagickCore/cache.c"
                                                ;
  
# 4341 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4341 "MagickCore/cache.c"
 image->cache != (Cache) 
# 4341 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4341 "MagickCore/cache.c"
...
# 4341 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 4341 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4341, __extension__ __PRETTY_FUNCTION__); }))
# 4341 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 4343 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4343 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 4343 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4343 "MagickCore/cache.c"
...
# 4343 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 4343 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4343, __extension__ __PRETTY_FUNCTION__); }))
# 4343 "MagickCore/cache.c"
                                                     ;
  if (cache_info->methods.queue_authentic_pixels_handler !=
      (QueueAuthenticPixelsHandler) 
# 4345 "MagickCore/cache.c" 3 4
                                   ((void *)0)
# 4345 "MagickCore/cache.c"
                                       )
    {
...
# 4351 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4351 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 4351 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4351 "MagickCore/cache.c"
...
# 4351 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 4351 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4351, __extension__ __PRETTY_FUNCTION__); }))
# 4351 "MagickCore/cache.c"
                                              ;
  pixels=QueueAuthenticPixelCacheNexus(image,x,y,columns,rows,MagickFalse,
    cache_info->nexus_info[id],exception);
...
# 4386 "MagickCore/cache.c"
static inline MagickOffsetType ReadPixelCacheRegion(
  const CacheInfo *__restrict__ cache_info,const MagickOffsetType offset,
  const MagickSizeType length,unsigned char *__restrict__ buffer)
{
  MagickOffsetType
    i;
  ...
  for (i=0; i < (MagickOffsetType) length; i+=count)
  {
    ...
    count=pread(cache_info->file,buffer+i,(size_t) (((length- (MagickSizeType) i) < ((size_t) (0x7fffffffffffffffL
# 4406 "MagickCore/cache.c"
                                                  ))) ? (length- (MagickSizeType) i) : ((size_t) (0x7fffffffffffffffL
# 4406 "MagickCore/cache.c"
                                                  )))
                                                   ,offset+i);
    ...
    if (count <= 0)
      {
        count=0;
        if (
# 4412 "MagickCore/cache.c" 3 4
           (*__errno_location ()) 
# 4412 "MagickCore/cache.c"
                 != 
# 4412 "MagickCore/cache.c" 3 4
                    4
# 4412 "MagickCore/cache.c"
...
static MagickBooleanType ReadPixelCacheMetacontent(
  CacheInfo *__restrict__ cache_info,NexusInfo *__restrict__ nexus_info,
  ExceptionInfo *exception)
{
  MagickOffsetType
    count,
  ...
  switch (cache_info->type)
  {
    ...
    case DiskCache:
    {
      ...
      if (OpenPixelCacheOnDisk(cache_info,IOMode) == MagickFalse)
        {
          { char *file_message; file_message=GetExceptionMessage(
# 4489 "MagickCore/cache.c" 3 4
         (*__errno_location ())
# 4489 "MagickCore/cache.c"
         ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 4489,FileOpenError,"UnableToOpenFile", "'%s': %s",cache_info->cache_filename,file_message); file_message=DestroyString(file_message); }
                                       ;
      ...
      if ((GetMagickResource(FileResource) > GetMagickResourceLimit(FileResource) ? MagickTrue : MagickFalse) != MagickFalse)
        (void) ClosePixelCacheOnDisk(cache_info);
      UnlockSemaphoreInfo(cache_info->file_semaphore);
      break;
    }
  ...
  if (y < (ssize_t) rows)
    {
      { char *file_message; file_message=GetExceptionMessage(
# 4553 "MagickCore/cache.c" 3 4
     (*__errno_location ())
# 4553 "MagickCore/cache.c"
     ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 4553,CacheError,"UnableToReadPixelCache", "'%s': %s",cache_info->cache_filename,file_message); file_message=DestroyString(file_message); }
                                   ;
      return(MagickFalse);
    }
  if ((cache_info->debug != MagickFalse) &&
      (QuantumTick((MagickOffsetType) nexus_info->region.y,cache_info->rows) != MagickFalse))
    (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 4559,
      "%s[%.20gx%.20g%+.20g%+.20g]",cache_info->filename,(double)
      nexus_info->region.width,(double) nexus_info->region.height,(double)
      nexus_info->region.x,(double) nexus_info->region.y);
  return(MagickTrue);
}
# 4594 "MagickCore/cache.c"
  ...
  switch (cache_info->type)
  {
    ...
    case DiskCache:
    {
      ...
      if (OpenPixelCacheOnDisk(cache_info,IOMode) == MagickFalse)
        {
          { char *file_message; file_message=GetExceptionMessage(
# 4670 "MagickCore/cache.c" 3 4
         (*__errno_location ())
# 4670 "MagickCore/cache.c"
         ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 4670,FileOpenError,"UnableToOpenFile", "'%s': %s",cache_info->cache_filename,file_message); file_message=DestroyString(file_message); }
                                       ;
          UnlockSemaphoreInfo(cache_info->file_semaphore);
          return(MagickFalse);
        }
  ...
  if (y < (ssize_t) rows)
    {
      { char *file_message; file_message=GetExceptionMessage(
# 4731 "MagickCore/cache.c" 3 4
     (*__errno_location ())
# 4731 "MagickCore/cache.c"
     ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 4731,CacheError,"UnableToReadPixelCache", "'%s': %s",cache_info->cache_filename,file_message); file_message=DestroyString(file_message); }
                                   ;
      return(MagickFalse);
    }
  if ((cache_info->debug != MagickFalse) &&
      (QuantumTick((MagickOffsetType) nexus_info->region.y,cache_info->rows) != MagickFalse))
    (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 4737,
      "%s[%.20gx%.20g%+.20g%+.20g]",cache_info->filename,(double)
      nexus_info->region.width,(double) nexus_info->region.height,(double)
      nexus_info->region.x,(double) nexus_info->region.y);
  return(MagickTrue);
}
# 4767 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) Cache ReferencePixelCache(Cache cache)
{
  CacheInfo
    *__restrict__ cache_info;

  
# 4772 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4772 "MagickCore/cache.c"
 cache != (Cache *) 
# 4772 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4772 "MagickCore/cache.c"
...
# 4772 "MagickCore/cache.c"
 "cache != (Cache *) NULL"
# 4772 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4772, __extension__ __PRETTY_FUNCTION__); }))
# 4772 "MagickCore/cache.c"
                                ;
  cache_info=(CacheInfo *) cache;
  
# 4774 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4774 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 4774 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4774 "MagickCore/cache.c"
...
# 4774 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 4774 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4774, __extension__ __PRETTY_FUNCTION__); }))
# 4774 "MagickCore/cache.c"
                                                     ;
  LockSemaphoreInfo(cache_info->semaphore);
  cache_info->reference_count++;
...
# 4803 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) void ResetPixelCacheChannels(Image *image)
{
  CacheInfo
    *__restrict__ cache_info;

  
# 4808 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4808 "MagickCore/cache.c"
 image != (const Image *) 
# 4808 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4808 "MagickCore/cache.c"
...
# 4808 "MagickCore/cache.c"
 "image != (const Image *) NULL"
# 4808 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4808, __extension__ __PRETTY_FUNCTION__); }))
# 4808 "MagickCore/cache.c"
                                      ;
  
# 4809 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4809 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 4809 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4809 "MagickCore/cache.c"
...
# 4809 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 4809 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4809, __extension__ __PRETTY_FUNCTION__); }))
# 4809 "MagickCore/cache.c"
                                                ;
  
# 4810 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4810 "MagickCore/cache.c"
 image->cache != (Cache) 
# 4810 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4810 "MagickCore/cache.c"
...
# 4810 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 4810 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4810, __extension__ __PRETTY_FUNCTION__); }))
# 4810 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 4812 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4812 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 4812 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4812 "MagickCore/cache.c"
...
# 4812 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 4812 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4812, __extension__ __PRETTY_FUNCTION__); }))
# 4812 "MagickCore/cache.c"
                                                     ;
  cache_info->number_channels=GetPixelChannels(image);
}
# 4834 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) void ResetCacheAnonymousMemory(void)
{
  cache_anonymous_memory=0;
}
# 4868 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ReshapePixelCache(Image *image,
  const size_t columns,const size_t rows,ExceptionInfo *exception)
{
  CacheInfo
    *cache_info;
...
# 4877 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4877 "MagickCore/cache.c"
 image != (Image *) 
# 4877 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4877 "MagickCore/cache.c"
...
# 4877 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 4877 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4877, __extension__ __PRETTY_FUNCTION__); }))
# 4877 "MagickCore/cache.c"
                                ;
  
# 4878 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4878 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 4878 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4878 "MagickCore/cache.c"
...
# 4878 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 4878 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4878, __extension__ __PRETTY_FUNCTION__); }))
# 4878 "MagickCore/cache.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 4880,"%s",image->filename);
  
# 4881 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4881 "MagickCore/cache.c"
 image->cache != (void *) 
# 4881 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4881 "MagickCore/cache.c"
...
# 4881 "MagickCore/cache.c"
 "image->cache != (void *) NULL"
# 4881 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4881, __extension__ __PRETTY_FUNCTION__); }))
# 4881 "MagickCore/cache.c"
                                      ;
  extent=(MagickSizeType) columns*rows;
  if (extent > ((MagickSizeType) image->columns*image->rows))
    { (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 4884,ImageError,"WidthOrHeightExceedsLimit", "`%s'",image->filename); return(MagickFalse); }
                      ;
...
# 4918 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) void SetPixelCacheMethods(Cache cache,CacheMethods *cache_methods)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 4932 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4932 "MagickCore/cache.c"
 cache != (Cache) 
# 4932 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4932 "MagickCore/cache.c"
...
# 4932 "MagickCore/cache.c"
 "cache != (Cache) NULL"
# 4932 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4932, __extension__ __PRETTY_FUNCTION__); }))
# 4932 "MagickCore/cache.c"
                              ;
  
# 4933 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4933 "MagickCore/cache.c"
 cache_methods != (CacheMethods *) 
# 4933 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4933 "MagickCore/cache.c"
...
# 4933 "MagickCore/cache.c"
 "cache_methods != (CacheMethods *) NULL"
# 4933 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4933, __extension__ __PRETTY_FUNCTION__); }))
# 4933 "MagickCore/cache.c"
                                               ;
  cache_info=(CacheInfo *) cache;
  
# 4935 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 4935 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 4935 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4935 "MagickCore/cache.c"
...
# 4935 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 4935 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 4935, __extension__ __PRETTY_FUNCTION__); }))
# 4935 "MagickCore/cache.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 4937,"%s",
      cache_info->filename);
  if (cache_methods->get_virtual_pixel_handler != (GetVirtualPixelHandler) 
# 4939 "MagickCore/cache.c" 3 4
                                                                          ((void *)0)
# 4939 "MagickCore/cache.c"
                                                                              )
    cache_info->methods.get_virtual_pixel_handler=
      cache_methods->get_virtual_pixel_handler;
  if (cache_methods->destroy_pixel_handler != (DestroyPixelHandler) 
# 4942 "MagickCore/cache.c" 3 4
                                                                   ((void *)0)
# 4942 "MagickCore/cache.c"
                                                                       )
  ...
  if (cache_methods->get_virtual_metacontent_from_handler !=
      (GetVirtualMetacontentFromHandler) 
# 4946 "MagickCore/cache.c" 3 4
                                        ((void *)0)
# 4946 "MagickCore/cache.c"
                                            )
    cache_info->methods.get_virtual_metacontent_from_handler=
      cache_methods->get_virtual_metacontent_from_handler;
  if (cache_methods->get_authentic_pixels_handler !=
      (GetAuthenticPixelsHandler) 
# 4950 "MagickCore/cache.c" 3 4
                                 ((void *)0)
# 4950 "MagickCore/cache.c"
                                     )
  ...
  if (cache_methods->queue_authentic_pixels_handler !=
      (QueueAuthenticPixelsHandler) 
# 4954 "MagickCore/cache.c" 3 4
                                   ((void *)0)
# 4954 "MagickCore/cache.c"
                                       )
  ...
  if (cache_methods->sync_authentic_pixels_handler !=
      (SyncAuthenticPixelsHandler) 
# 4958 "MagickCore/cache.c" 3 4
                                  ((void *)0)
# 4958 "MagickCore/cache.c"
                                      )
  ...
  if (cache_methods->get_authentic_pixels_from_handler !=
      (GetAuthenticPixelsFromHandler) 
# 4962 "MagickCore/cache.c" 3 4
                                     ((void *)0)
# 4962 "MagickCore/cache.c"
                                         )
  ...
  if (cache_methods->get_authentic_metacontent_from_handler !=
      (GetAuthenticMetacontentFromHandler) 
# 4966 "MagickCore/cache.c" 3 4
                                          ((void *)0)
# 4966 "MagickCore/cache.c"
                                              )
  ...
  if (get_one_virtual_pixel_from_handler !=
      (GetOneVirtualPixelFromHandler) 
# 4972 "MagickCore/cache.c" 3 4
                                     ((void *)0)
# 4972 "MagickCore/cache.c"
                                         )
    cache_info->methods.get_one_virtual_pixel_from_handler=
  ...
  if (get_one_authentic_pixel_from_handler !=
      (GetOneAuthenticPixelFromHandler) 
# 4978 "MagickCore/cache.c" 3 4
                                       ((void *)0)
# 4978 "MagickCore/cache.c"
                                           )
    cache_info->methods.get_one_authentic_pixel_from_handler=
      cache_methods->get_one_authentic_pixel_from_handler;
}
# 5021 "MagickCore/cache.c"
static inline MagickBooleanType AcquireCacheNexusPixels(
  const CacheInfo *__restrict__ cache_info,const MagickSizeType length,
  NexusInfo *__restrict__ nexus_info,ExceptionInfo *exception)
{
  if (length != (MagickSizeType) ((size_t) length))
    {
      (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 5027,
  ...
  if (cache_anonymous_memory <= 0)
    {
      nexus_info->cache=(Quantum *) __builtin_assume_aligned((AcquireAlignedMemory(1, (size_t) length)),(8 * 8))
                         ;
      if (nexus_info->cache != (Quantum *) 
# 5038 "MagickCore/cache.c" 3 4
                                          ((void *)0)
# 5038 "MagickCore/cache.c"
                                              )
  ...
  else
    {
      ...
      if (nexus_info->cache != (Quantum *) 
# 5044 "MagickCore/cache.c" 3 4
                                          ((void *)0)
# 5044 "MagickCore/cache.c"
                                              )
        nexus_info->mapped=MagickTrue;
    }
  if (nexus_info->cache == (Quantum *) 
# 5047 "MagickCore/cache.c" 3 4
                                      ((void *)0)
# 5047 "MagickCore/cache.c"
                                          )
    {
      (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 5049,
        ResourceLimitError,"PixelCacheAllocationFailed","`%s'",
        cache_info->filename);
      return(MagickFalse);
    }
...
static inline void PrefetchPixelCacheNexusPixels(const NexusInfo *nexus_info,
  const MapMode mode)
{
  if (nexus_info->length < (8 * 8))
    return;
  if (mode == ReadMode)
    {
      __builtin_prefetch((unsigned char *) nexus_info->pixels+(8 * 8),0,1)
            ;
      return;
    }
  __builtin_prefetch((unsigned char *) nexus_info->pixels+(8 * 8),1,1);
}

static Quantum *SetPixelCacheNexusPixels(
  const CacheInfo *__restrict__ cache_info,const MapMode mode,
  const ssize_t x,const ssize_t y,const size_t width,const size_t height,
  const MagickBooleanType buffered,NexusInfo *__restrict__ nexus_info,
  ExceptionInfo *exception)
{
  MagickBooleanType
    status;
...
# 5085 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5085 "MagickCore/cache.c"
 cache_info != (const CacheInfo *) 
# 5085 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5085 "MagickCore/cache.c"
 cache_info != (const CacheInfo *) 
# 5085 "MagickCore/cache.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 5085 "MagickCore/cache.c"
 "cache_info != (const CacheInfo *) NULL"
# 5085 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5085, __extension__ __PRETTY_FUNCTION__); }))
# 5085 "MagickCore/cache.c"
                                               ;
  
# 5086 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5086 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 5086 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5086 "MagickCore/cache.c"
...
# 5086 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 5086 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5086, __extension__ __PRETTY_FUNCTION__); }))
# 5086 "MagickCore/cache.c"
                                                     ;
  if (cache_info->type == UndefinedCache)
    return((Quantum *) 
# 5088 "MagickCore/cache.c" 3 4
                      ((void *)0)
# 5088 "MagickCore/cache.c"
                          );
  
# 5089 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5089 "MagickCore/cache.c"
 nexus_info->signature == 0xabacadabUL
# 5089 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5089 "MagickCore/cache.c"
 nexus_info->signature == 0xabacadabUL
...
# 5089 "MagickCore/cache.c"
 "nexus_info->signature == MagickCoreSignature"
# 5089 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5089, __extension__ __PRETTY_FUNCTION__); }))
# 5089 "MagickCore/cache.c"
                                                     ;
  (void) memset(&nexus_info->region,0,sizeof(nexus_info->region));
  if ((width == 0) || (height == 0))
    {
      (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 5093,CacheError,
        "NoPixelsDefinedInCache","`%s'",cache_info->filename);
      return((Quantum *) 
# 5095 "MagickCore/cache.c" 3 4
                        ((void *)0)
# 5095 "MagickCore/cache.c"
                            );
    }
  if (((MagickSizeType) width > cache_info->width_limit) ||
      ((MagickSizeType) height > cache_info->height_limit))
    {
      (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 5100,ImageError,
        "WidthOrHeightExceedsLimit","`%s'",cache_info->filename);
      return((Quantum *) 
# 5102 "MagickCore/cache.c" 3 4
                        ((void *)0)
# 5102 "MagickCore/cache.c"
                            );
    }
  if ((IsValidPixelOffset(x,width) == MagickFalse) ||
      (IsValidPixelOffset(y,height) == MagickFalse))
    {
      (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 5107,CorruptImageError,
        "InvalidPixel","`%s'",cache_info->filename);
      return((Quantum *) 
# 5109 "MagickCore/cache.c" 3 4
                        ((void *)0)
# 5109 "MagickCore/cache.c"
                            );
    }
  if (((cache_info->type == MemoryCache) || (cache_info->type == MapCache)) &&
      (buffered == MagickFalse))
    {
      if (((x >= 0) && (y >= 0) &&
          ...
          (((ssize_t) width+x-1) < (ssize_t) cache_info->columns))))
        {
          ...
          if (IsValidPixelOffset(y,cache_info->columns) == MagickFalse)
            return((Quantum *) 
# 5126 "MagickCore/cache.c" 3 4
                              ((void *)0)
# 5126 "MagickCore/cache.c"
                                  );
          offset=y*(MagickOffsetType) cache_info->columns+x;
          nexus_info->pixels=cache_info->pixels+(MagickOffsetType)
            cache_info->number_channels*offset;
          nexus_info->metacontent=(void *) 
# 5130 "MagickCore/cache.c" 3 4
                                          ((void *)0)
# 5130 "MagickCore/cache.c"
                                              ;
          if (cache_info->metacontent_extent != 0)
  ...
  length=(((number_pixels) > ((((cache_info->columns) > (cache_info->rows)) ? (cache_info->columns) : (cache_info->rows)))) ? (number_pixels) : ((((cache_info->columns) > (cache_info->rows)) ? (cache_info->columns) : (cache_info->rows))))
                      *cache_info->number_channels*sizeof(*nexus_info->pixels);
  if (cache_info->metacontent_extent != 0)
    length+=number_pixels*cache_info->metacontent_extent;
  status=MagickTrue;
  if (nexus_info->cache == (Quantum *) 
# 5152 "MagickCore/cache.c" 3 4
                                      ((void *)0)
# 5152 "MagickCore/cache.c"
                                          )
  ...
  if (status == MagickFalse)
    return((Quantum *) 
# 5161 "MagickCore/cache.c" 3 4
                      ((void *)0)
# 5161 "MagickCore/cache.c"
                          );
  nexus_info->pixels=nexus_info->cache;
  nexus_info->metacontent=(void *) 
# 5163 "MagickCore/cache.c" 3 4
                                  ((void *)0)
# 5163 "MagickCore/cache.c"
                                      ;
  if (cache_info->metacontent_extent != 0)
...
# 5219 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5219 "MagickCore/cache.c"
 image != (Image *) 
# 5219 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5219 "MagickCore/cache.c"
...
# 5219 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 5219 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5219, __extension__ __PRETTY_FUNCTION__); }))
# 5219 "MagickCore/cache.c"
                                ;
  
# 5220 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5220 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 5220 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5220 "MagickCore/cache.c"
...
# 5220 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 5220 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5220, __extension__ __PRETTY_FUNCTION__); }))
# 5220 "MagickCore/cache.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 5222,"%s",image->filename);
  
# 5223 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5223 "MagickCore/cache.c"
 image->cache != (Cache) 
# 5223 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5223 "MagickCore/cache.c"
...
# 5223 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 5223 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5223, __extension__ __PRETTY_FUNCTION__); }))
# 5223 "MagickCore/cache.c"
                                     ;
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (q == (Quantum *) 
# 5242 "MagickCore/cache.c" 3 4
                        ((void *)0)
# 5242 "MagickCore/cache.c"
                            )
      {
        status=MagickFalse;
        continue;
...
__attribute__ ((visibility ("hidden"))) VirtualPixelMethod SetPixelCacheVirtualMethod(Image *image,
...
# 5267 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5267 "MagickCore/cache.c"
 image != (Image *) 
# 5267 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5267 "MagickCore/cache.c"
...
# 5267 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 5267 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5267, __extension__ __PRETTY_FUNCTION__); }))
# 5267 "MagickCore/cache.c"
                                ;
  
# 5268 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5268 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 5268 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5268 "MagickCore/cache.c"
...
# 5268 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 5268 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5268, __extension__ __PRETTY_FUNCTION__); }))
# 5268 "MagickCore/cache.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/cache.c",__func__,(unsigned long) 5270,"%s",image->filename);
  
# 5271 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5271 "MagickCore/cache.c"
 image->cache != (Cache) 
# 5271 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5271 "MagickCore/cache.c"
...
# 5271 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 5271 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5271, __extension__ __PRETTY_FUNCTION__); }))
# 5271 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 5273 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5273 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 5273 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5273 "MagickCore/cache.c"
...
# 5273 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 5273 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5273, __extension__ __PRETTY_FUNCTION__); }))
# 5273 "MagickCore/cache.c"
                                                     ;
    ...
    switch (virtual_pixel_method)
    {
      case BackgroundVirtualPixelMethod:
      {
        if ((image->background_color.alpha_trait != UndefinedPixelTrait) &&
          ...
          (void) SetCacheAlphaChannel(image,((Quantum) ((Quantum) 65535.0)),exception);
...
# 5381 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType SyncAuthenticPixelCacheNexus(Image *image,
  NexusInfo *__restrict__ nexus_info,ExceptionInfo *exception)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 5393 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5393 "MagickCore/cache.c"
 image != (Image *) 
# 5393 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5393 "MagickCore/cache.c"
...
# 5393 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 5393 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5393, __extension__ __PRETTY_FUNCTION__); }))
# 5393 "MagickCore/cache.c"
                                ;
  
# 5394 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5394 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 5394 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5394 "MagickCore/cache.c"
...
# 5394 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 5394 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5394, __extension__ __PRETTY_FUNCTION__); }))
# 5394 "MagickCore/cache.c"
                                                ;
  if (image->cache == (Cache) 
# 5395 "MagickCore/cache.c" 3 4
                             ((void *)0)
# 5395 "MagickCore/cache.c"
                                 )
    { (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 5396,CacheError,"PixelCacheIsNotOpen", "`%s'",image->filename); return(MagickFalse); };
  cache_info=(CacheInfo *) image->cache;
  
# 5398 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5398 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 5398 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5398 "MagickCore/cache.c"
...
# 5398 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 5398 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5398, __extension__ __PRETTY_FUNCTION__); }))
# 5398 "MagickCore/cache.c"
                                                     ;
  if (cache_info->type == UndefinedCache)
    return(MagickFalse);
...
# 5416 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5416 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 5416 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5416 "MagickCore/cache.c"
...
# 5416 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 5416 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5416, __extension__ __PRETTY_FUNCTION__); }))
# 5416 "MagickCore/cache.c"
                                                     ;
...
# 5465 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5465 "MagickCore/cache.c"
 image != (Image *) 
# 5465 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5465 "MagickCore/cache.c"
...
# 5465 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 5465 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5465, __extension__ __PRETTY_FUNCTION__); }))
# 5465 "MagickCore/cache.c"
                                ;
  
# 5466 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5466 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 5466 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5466 "MagickCore/cache.c"
...
# 5466 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 5466 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5466, __extension__ __PRETTY_FUNCTION__); }))
# 5466 "MagickCore/cache.c"
                                                ;
  
# 5467 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5467 "MagickCore/cache.c"
 image->cache != (Cache) 
# 5467 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5467 "MagickCore/cache.c"
...
# 5467 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 5467 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5467, __extension__ __PRETTY_FUNCTION__); }))
# 5467 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 5469 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5469 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 5469 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5469 "MagickCore/cache.c"
...
# 5469 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 5469 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5469, __extension__ __PRETTY_FUNCTION__); }))
# 5469 "MagickCore/cache.c"
                                                     ;
  
# 5470 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5470 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 5470 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5470 "MagickCore/cache.c"
...
# 5470 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 5470 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5470, __extension__ __PRETTY_FUNCTION__); }))
# 5470 "MagickCore/cache.c"
                                              ;
...
# 5503 "MagickCore/cache.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SyncAuthenticPixels(Image *image,
  ExceptionInfo *exception)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 5515 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5515 "MagickCore/cache.c"
 image != (Image *) 
# 5515 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5515 "MagickCore/cache.c"
...
# 5515 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 5515 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5515, __extension__ __PRETTY_FUNCTION__); }))
# 5515 "MagickCore/cache.c"
                                ;
  
# 5516 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5516 "MagickCore/cache.c"
 image->signature == 0xabacadabUL
# 5516 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5516 "MagickCore/cache.c"
...
# 5516 "MagickCore/cache.c"
 "image->signature == MagickCoreSignature"
# 5516 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5516, __extension__ __PRETTY_FUNCTION__); }))
# 5516 "MagickCore/cache.c"
                                                ;
  
# 5517 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5517 "MagickCore/cache.c"
 image->cache != (Cache) 
# 5517 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5517 "MagickCore/cache.c"
...
# 5517 "MagickCore/cache.c"
 "image->cache != (Cache) NULL"
# 5517 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5517, __extension__ __PRETTY_FUNCTION__); }))
# 5517 "MagickCore/cache.c"
                                     ;
  cache_info=(CacheInfo *) image->cache;
  
# 5519 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5519 "MagickCore/cache.c"
 cache_info->signature == 0xabacadabUL
# 5519 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5519 "MagickCore/cache.c"
...
# 5519 "MagickCore/cache.c"
 "cache_info->signature == MagickCoreSignature"
# 5519 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5519, __extension__ __PRETTY_FUNCTION__); }))
# 5519 "MagickCore/cache.c"
                                                     ;
  if (cache_info->methods.sync_authentic_pixels_handler != (SyncAuthenticPixelsHandler) 
# 5520 "MagickCore/cache.c" 3 4
                                                                                       ((void *)0)
# 5520 "MagickCore/cache.c"
                                                                                           )
    {
...
# 5526 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5526 "MagickCore/cache.c"
 id < (int) cache_info->number_threads
# 5526 "MagickCore/cache.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 5526 "MagickCore/cache.c"
...
# 5526 "MagickCore/cache.c"
 "id < (int) cache_info->number_threads"
# 5526 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5526, __extension__ __PRETTY_FUNCTION__); }))
# 5526 "MagickCore/cache.c"
                                              ;
  status=SyncAuthenticPixelCacheNexus(image,cache_info->nexus_info[id],
    exception);
...
# 5559 "MagickCore/cache.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType SyncImagePixelCache(Image *image,
  ExceptionInfo *exception)
{
  CacheInfo
    *__restrict__ cache_info;
...
# 5565 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5565 "MagickCore/cache.c"
 image != (Image *) 
# 5565 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5565 "MagickCore/cache.c"
...
# 5565 "MagickCore/cache.c"
 "image != (Image *) NULL"
# 5565 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5565, __extension__ __PRETTY_FUNCTION__); }))
# 5565 "MagickCore/cache.c"
                                ;
  
# 5566 "MagickCore/cache.c" 3 4
 ((void) sizeof ((
# 5566 "MagickCore/cache.c"
 exception != (ExceptionInfo *) 
# 5566 "MagickCore/cache.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 5566 "MagickCore/cache.c"
...
# 5566 "MagickCore/cache.c"
 "exception != (ExceptionInfo *) NULL"
# 5566 "MagickCore/cache.c" 3 4
 , "MagickCore/cache.c", 5566, __extension__ __PRETTY_FUNCTION__); }))
# 5566 "MagickCore/cache.c"
                                            ;
  cache_info=(CacheInfo *) GetImagePixelCache(image,MagickTrue,exception);
  return(cache_info == (CacheInfo *) 
# 5568 "MagickCore/cache.c" 3 4
                                    ((void *)0) 
# 5568 "MagickCore/cache.c"
                                         ? MagickFalse : MagickTrue);
}
# 5599 "MagickCore/cache.c"
  ...
  NexusInfo *__restrict__ nexus_info,ExceptionInfo *exception)
{
  ...
  if (nexus_info->authentic_pixel_cache != MagickFalse)
    return(MagickTrue);
  if (nexus_info->metacontent == (unsigned char *) 
# 5623 "MagickCore/cache.c" 3 4
                                                  ((void *)0)
# 5623 "MagickCore/cache.c"
                                                      )
    return(MagickFalse);
  if (IsValidPixelOffset(nexus_info->region.y,cache_info->columns) == MagickFalse)
    return(MagickFalse);
  ...
  switch (cache_info->type)
  {
    ...
    case DiskCache:
    {
      ...
      if (OpenPixelCacheOnDisk(cache_info,IOMode) == MagickFalse)
        {
          { char *file_message; file_message=GetExceptionMessage(
# 5670 "MagickCore/cache.c" 3 4
         (*__errno_location ())
# 5670 "MagickCore/cache.c"
         ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 5670,FileOpenError,"UnableToOpenFile", "'%s': %s",cache_info->cache_filename,file_message); file_message=DestroyString(file_message); }
                                       ;
          UnlockSemaphoreInfo(cache_info->file_semaphore);
          return(MagickFalse);
        }
  ...
  if (y < (ssize_t) rows)
    {
      { char *file_message; file_message=GetExceptionMessage(
# 5734 "MagickCore/cache.c" 3 4
     (*__errno_location ())
# 5734 "MagickCore/cache.c"
     ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 5734,CacheError,"UnableToWritePixelCache", "'%s': %s",cache_info->cache_filename,file_message); file_message=DestroyString(file_message); }
                                   ;
      return(MagickFalse);
    }
  if ((cache_info->debug != MagickFalse) &&
      (QuantumTick((MagickOffsetType) nexus_info->region.y,cache_info->rows) != MagickFalse))
    (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 5740,
      "%s[%.20gx%.20g%+.20g%+.20g]",cache_info->filename,(double)
      nexus_info->region.width,(double) nexus_info->region.height,(double)
      nexus_info->region.x,(double) nexus_info->region.y);
  return(MagickTrue);
}
# 5775 "MagickCore/cache.c"
  ...
  switch (cache_info->type)
  {
    ...
    case DiskCache:
    {
      ...
      if (OpenPixelCacheOnDisk(cache_info,IOMode) == MagickFalse)
        {
          { char *file_message; file_message=GetExceptionMessage(
# 5843 "MagickCore/cache.c" 3 4
         (*__errno_location ())
# 5843 "MagickCore/cache.c"
         ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 5843,FileOpenError,"UnableToOpenFile", "'%s': %s",cache_info->cache_filename,file_message); file_message=DestroyString(file_message); }
                                       ;
          UnlockSemaphoreInfo(cache_info->file_semaphore);
          return(MagickFalse);
        }
  ...
  if (y < (ssize_t) rows)
    {
      { char *file_message; file_message=GetExceptionMessage(
# 5904 "MagickCore/cache.c" 3 4
     (*__errno_location ())
# 5904 "MagickCore/cache.c"
     ); (void) ThrowMagickException(exception,"MagickCore/cache.c",__func__,(unsigned long) 5904,CacheError,"UnableToWritePixelCache", "'%s': %s",cache_info->cache_filename,file_message); file_message=DestroyString(file_message); }
                                   ;
      return(MagickFalse);
    }
  if ((cache_info->debug != MagickFalse) &&
      (QuantumTick((MagickOffsetType) nexus_info->region.y,cache_info->rows) != MagickFalse))
    (void) LogMagickEvent(CacheEvent,"MagickCore/cache.c",__func__,(unsigned long) 5910,
      "%s[%.20gx%.20g%+.20g%+.20g]",cache_info->filename,(double)
      nexus_info->region.width,(double) nexus_info->region.height,(double)
      nexus_info->region.x,(double) nexus_info->region.y);
  return(MagickTrue);
