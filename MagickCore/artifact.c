# 0 "MagickCore/artifact.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/artifact.c"
# 43 "MagickCore/artifact.c"
...
# 53 "MagickCore/artifact.c" 2
# 1 "./MagickCore/fx.h" 1
# 27 "./MagickCore/fx.h"
extern __attribute__ ((visibility ("default"))) Image
  *FxImage(const Image *,const char *,ExceptionInfo *);
# 54 "MagickCore/artifact.c" 2
...
# 74 "MagickCore/artifact.c" 2
# 102 "MagickCore/artifact.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CloneImageArtifacts(Image *image,
  const Image *clone_image)
{
  
# 105 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 105 "MagickCore/artifact.c"
 image != (Image *) 
# 105 "MagickCore/artifact.c" 3 4
...
# 105 "MagickCore/artifact.c"
 "image != (Image *) NULL"
# 105 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 105, __extension__ __PRETTY_FUNCTION__); }))
# 105 "MagickCore/artifact.c"
                                ;
  
# 106 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 106 "MagickCore/artifact.c"
...
# 106 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 106, __extension__ __PRETTY_FUNCTION__); }))
# 106 "MagickCore/artifact.c"
                                                ;
  
# 107 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 107 "MagickCore/artifact.c"
...
# 107 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 107, __extension__ __PRETTY_FUNCTION__); }))
# 107 "MagickCore/artifact.c"
                                            ;
  
# 108 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 108 "MagickCore/artifact.c"
...
# 108 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 108, __extension__ __PRETTY_FUNCTION__); }))
# 108 "MagickCore/artifact.c"
                                                      ;
  if (IsEventLogging() != MagickFalse)
    {
      (void) LogMagickEvent(TraceEvent,"MagickCore/artifact.c",__func__,(unsigned long) 111,"%s",image->filename);
      (void) LogMagickEvent(TraceEvent,"MagickCore/artifact.c",__func__,(unsigned long) 112,"%s",
        clone_image->filename);
    }
  if (clone_image->artifacts != (void *) 
# 115 "MagickCore/artifact.c" 3 4
                                        ((void *)0)
# 115 "MagickCore/artifact.c"
                                            )
    {
      if (image->artifacts != (void *) 
# 117 "MagickCore/artifact.c" 3 4
                                      ((void *)0)
# 117 "MagickCore/artifact.c"
                                          )
        DestroyImageArtifacts(image);
...
# 152 "MagickCore/artifact.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DefineImageArtifact(Image *image,
  const char *artifact)
{
  char
    key[4096],
...
# 162 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 162 "MagickCore/artifact.c"
 image != (Image *) 
# 162 "MagickCore/artifact.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 162 "MagickCore/artifact.c"
...
# 162 "MagickCore/artifact.c"
 "image != (Image *) NULL"
# 162 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 162, __extension__ __PRETTY_FUNCTION__); }))
# 162 "MagickCore/artifact.c"
                                ;
  
# 163 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 163 "MagickCore/artifact.c"
 artifact != (const char *) 
# 163 "MagickCore/artifact.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 163 "MagickCore/artifact.c"
...
# 163 "MagickCore/artifact.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 163 "MagickCore/artifact.c"
 "artifact != (const char *) NULL"
# 163 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 163, __extension__ __PRETTY_FUNCTION__); }))
# 163 "MagickCore/artifact.c"
                                        ;
  (void) CopyMagickString(key,artifact,4096 -1);
  for (p=key; *p != '\0'; p++)
    if (*p == '=')
      break;
  *value='\0';
...
# 199 "MagickCore/artifact.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DeleteImageArtifact(Image *image,
  const char *artifact)
{
  
# 202 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 202 "MagickCore/artifact.c"
 image != (Image *) 
# 202 "MagickCore/artifact.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 202 "MagickCore/artifact.c"
...
# 202 "MagickCore/artifact.c"
 "image != (Image *) NULL"
# 202 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 202, __extension__ __PRETTY_FUNCTION__); }))
# 202 "MagickCore/artifact.c"
                                ;
  
# 203 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 203 "MagickCore/artifact.c"
 image->signature == 0xabacadabUL
# 203 "MagickCore/artifact.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 203 "MagickCore/artifact.c"
...
# 203 "MagickCore/artifact.c"
 "image->signature == MagickCoreSignature"
# 203 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 203, __extension__ __PRETTY_FUNCTION__); }))
# 203 "MagickCore/artifact.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/artifact.c",__func__,(unsigned long) 205,"%s",image->filename);
  if (image->artifacts == (void *) 
# 206 "MagickCore/artifact.c" 3 4
                                  ((void *)0)
# 206 "MagickCore/artifact.c"
                                      )
    return(MagickFalse);
  return(DeleteNodeFromSplayTree((SplayTreeInfo *) image->artifacts,artifact));
}
# 234 "MagickCore/artifact.c"
__attribute__ ((visibility ("default"))) void DestroyImageArtifacts(Image *image)
{
  
# 236 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 236 "MagickCore/artifact.c"
 image != (Image *) 
# 236 "MagickCore/artifact.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 236 "MagickCore/artifact.c"
...
# 236 "MagickCore/artifact.c"
 "image != (Image *) NULL"
# 236 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 236, __extension__ __PRETTY_FUNCTION__); }))
# 236 "MagickCore/artifact.c"
                                ;
  
# 237 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 237 "MagickCore/artifact.c"
 image->signature == 0xabacadabUL
# 237 "MagickCore/artifact.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 237 "MagickCore/artifact.c"
...
# 237 "MagickCore/artifact.c"
 "image->signature == MagickCoreSignature"
# 237 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 237, __extension__ __PRETTY_FUNCTION__); }))
# 237 "MagickCore/artifact.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/artifact.c",__func__,(unsigned long) 239,"%s",image->filename);
  if (image->artifacts != (void *) 
# 240 "MagickCore/artifact.c" 3 4
                                  ((void *)0)
# 240 "MagickCore/artifact.c"
                                      )
    image->artifacts=(void *) DestroySplayTree((SplayTreeInfo *)
      image->artifacts);
}
# 274 "MagickCore/artifact.c"
__attribute__ ((visibility ("default"))) const char *GetImageArtifact(const Image *image,
  const char *artifact)
{
  const char
    *p;
...
# 280 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 280 "MagickCore/artifact.c"
 image != (Image *) 
# 280 "MagickCore/artifact.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 280 "MagickCore/artifact.c"
...
# 280 "MagickCore/artifact.c"
 "image != (Image *) NULL"
# 280 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 280, __extension__ __PRETTY_FUNCTION__); }))
# 280 "MagickCore/artifact.c"
                                ;
  
# 281 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 281 "MagickCore/artifact.c"
 image->signature == 0xabacadabUL
# 281 "MagickCore/artifact.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 281 "MagickCore/artifact.c"
...
# 281 "MagickCore/artifact.c"
 "image->signature == MagickCoreSignature"
# 281 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 281, __extension__ __PRETTY_FUNCTION__); }))
# 281 "MagickCore/artifact.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/artifact.c",__func__,(unsigned long) 283,"%s",image->filename);
  p=(const char *) 
# 284 "MagickCore/artifact.c" 3 4
                  ((void *)0)
# 284 "MagickCore/artifact.c"
                      ;
  if (image->artifacts != (void *) 
# 285 "MagickCore/artifact.c" 3 4
                                  ((void *)0)
# 285 "MagickCore/artifact.c"
                                      )
    {
      if (artifact == (const char *) 
# 287 "MagickCore/artifact.c" 3 4
                                    ((void *)0)
# 287 "MagickCore/artifact.c"
                                        )
      ...
      p=(const char *) GetValueFromSplayTree((SplayTreeInfo *) image->artifacts,
        artifact);
      if (p != (const char *) 
# 292 "MagickCore/artifact.c" 3 4
                             ((void *)0)
# 292 "MagickCore/artifact.c"
                                 )
        return(p);
    }
  if ((image->image_info != (ImageInfo *) 
# 295 "MagickCore/artifact.c" 3 4
                                         ((void *)0)
# 295 "MagickCore/artifact.c"
                                             ) &&
      (image->image_info->options != (void *) 
# 296 "MagickCore/artifact.c" 3 4
                                             ((void *)0)
# 296 "MagickCore/artifact.c"
                                                 ))
    p=(const char *) GetValueFromSplayTree((SplayTreeInfo *)
      image->image_info->options,artifact);
  return(p);
}
# 324 "MagickCore/artifact.c"
__attribute__ ((visibility ("default"))) const char *GetNextImageArtifact(const Image *image)
{
  
# 326 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 326 "MagickCore/artifact.c"
 image != (Image *) 
# 326 "MagickCore/artifact.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 326 "MagickCore/artifact.c"
...
# 326 "MagickCore/artifact.c"
 "image != (Image *) NULL"
# 326 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 326, __extension__ __PRETTY_FUNCTION__); }))
# 326 "MagickCore/artifact.c"
                                ;
  
# 327 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 327 "MagickCore/artifact.c"
 image->signature == 0xabacadabUL
# 327 "MagickCore/artifact.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 327 "MagickCore/artifact.c"
...
# 327 "MagickCore/artifact.c"
 "image->signature == MagickCoreSignature"
# 327 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 327, __extension__ __PRETTY_FUNCTION__); }))
# 327 "MagickCore/artifact.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/artifact.c",__func__,(unsigned long) 329,"%s",image->filename);
  if (image->artifacts == (void *) 
# 330 "MagickCore/artifact.c" 3 4
                                  ((void *)0)
# 330 "MagickCore/artifact.c"
                                      )
    return((const char *) 
# 331 "MagickCore/artifact.c" 3 4
                         ((void *)0)
# 331 "MagickCore/artifact.c"
                             );
  return((const char *) GetNextKeyInSplayTree(
   (SplayTreeInfo *) image->artifacts));
}
# 364 "MagickCore/artifact.c"
__attribute__ ((visibility ("default"))) char *RemoveImageArtifact(Image *image,const char *artifact)
{
  char
    *value;

  
# 369 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 369 "MagickCore/artifact.c"
 image != (Image *) 
# 369 "MagickCore/artifact.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 369 "MagickCore/artifact.c"
...
# 369 "MagickCore/artifact.c"
 "image != (Image *) NULL"
# 369 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 369, __extension__ __PRETTY_FUNCTION__); }))
# 369 "MagickCore/artifact.c"
                                ;
  
# 370 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 370 "MagickCore/artifact.c"
 image->signature == 0xabacadabUL
# 370 "MagickCore/artifact.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 370 "MagickCore/artifact.c"
...
# 370 "MagickCore/artifact.c"
 "image->signature == MagickCoreSignature"
# 370 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 370, __extension__ __PRETTY_FUNCTION__); }))
# 370 "MagickCore/artifact.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/artifact.c",__func__,(unsigned long) 372,"%s",image->filename);
  if (image->artifacts == (void *) 
# 373 "MagickCore/artifact.c" 3 4
                                  ((void *)0)
# 373 "MagickCore/artifact.c"
                                      )
    return((char *) 
# 374 "MagickCore/artifact.c" 3 4
                   ((void *)0)
# 374 "MagickCore/artifact.c"
                       );
  value=(char *) RemoveNodeFromSplayTree((SplayTreeInfo *) image->artifacts,
    artifact);
  return(value);
}
# 407 "MagickCore/artifact.c"
__attribute__ ((visibility ("default"))) void ResetImageArtifactIterator(const Image *image)
{
  
# 409 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 409 "MagickCore/artifact.c"
 image != (Image *) 
# 409 "MagickCore/artifact.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 409 "MagickCore/artifact.c"
...
# 409 "MagickCore/artifact.c"
 "image != (Image *) NULL"
# 409 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 409, __extension__ __PRETTY_FUNCTION__); }))
# 409 "MagickCore/artifact.c"
                                ;
  
# 410 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 410 "MagickCore/artifact.c"
 image->signature == 0xabacadabUL
# 410 "MagickCore/artifact.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 410 "MagickCore/artifact.c"
...
# 410 "MagickCore/artifact.c"
 "image->signature == MagickCoreSignature"
# 410 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 410, __extension__ __PRETTY_FUNCTION__); }))
# 410 "MagickCore/artifact.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/artifact.c",__func__,(unsigned long) 412,"%s",image->filename);
  if (image->artifacts == (void *) 
# 413 "MagickCore/artifact.c" 3 4
                                  ((void *)0)
# 413 "MagickCore/artifact.c"
                                      )
    return;
  ResetSplayTreeIterator((SplayTreeInfo *) image->artifacts);
}
# 449 "MagickCore/artifact.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageArtifact(Image *image,
...
# 455 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 455 "MagickCore/artifact.c"
 image != (Image *) 
# 455 "MagickCore/artifact.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 455 "MagickCore/artifact.c"
...
# 455 "MagickCore/artifact.c"
 "image != (Image *) NULL"
# 455 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 455, __extension__ __PRETTY_FUNCTION__); }))
# 455 "MagickCore/artifact.c"
                                ;
  
# 456 "MagickCore/artifact.c" 3 4
 ((void) sizeof ((
# 456 "MagickCore/artifact.c"
 image->signature == 0xabacadabUL
# 456 "MagickCore/artifact.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 456 "MagickCore/artifact.c"
...
# 456 "MagickCore/artifact.c"
 "image->signature == MagickCoreSignature"
# 456 "MagickCore/artifact.c" 3 4
 , "MagickCore/artifact.c", 456, __extension__ __PRETTY_FUNCTION__); }))
# 456 "MagickCore/artifact.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/artifact.c",__func__,(unsigned long) 458,"%s",image->filename);



  if (image->artifacts == (void *) 
# 462 "MagickCore/artifact.c" 3 4
                                  ((void *)0)
# 462 "MagickCore/artifact.c"
                                      )
  ...
  if (value == (const char *) 
# 468 "MagickCore/artifact.c" 3 4
                             ((void *)0)
# 468 "MagickCore/artifact.c"
                                 )
