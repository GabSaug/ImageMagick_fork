# 0 "MagickCore/utility.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/utility.c"
# 42 "MagickCore/utility.c"
...
# 69 "MagickCore/utility.c" 2
# 79 "MagickCore/utility.c"
static const char
...
# 111 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) MagickBooleanType AcquireUniqueFilename(char *path)
{
  int
    file;
...
# 153 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) MagickBooleanType AcquireUniqueSymbolicLink(const char *source,
  char *destination)
{
  int
    destination_file,
...
# 176 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 176 "MagickCore/utility.c"
 source != (const char *) 
# 176 "MagickCore/utility.c" 3 4
...
# 176 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 176, __extension__ __PRETTY_FUNCTION__); }))
# 176 "MagickCore/utility.c"
                                      ;
  
# 177 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 177 "MagickCore/utility.c"
 destination != (char *) 
# 177 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 177 "MagickCore/utility.c"
...
# 177 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 177, __extension__ __PRETTY_FUNCTION__); }))
# 177 "MagickCore/utility.c"
                                     ;

  {
    ...
    if (passes != (char *) 
# 186 "MagickCore/utility.c" 3 4
                          ((void *)0)
# 186 "MagickCore/utility.c"
                              )
    ...
    else
      {
        if (*source == *"/")
        ...
        else
          {
            ...
            *path='\0';
            if (getcwd(path,4096) == (char *) 
# 201 "MagickCore/utility.c" 3 4
                                                         ((void *)0)
# 201 "MagickCore/utility.c"
                                                             )
              return(MagickFalse);
            (void) ConcatenateMagickString(path,"/",
              4096);
            (void) ConcatenateMagickString(path,source,4096);
...
# 215 "MagickCore/utility.c" 3 4
                              00 
# 215 "MagickCore/utility.c"
                                       | 0x00,0);
  if (source_file == -1)
    {
  ...
  if ((fstat(source_file,&attributes) == 0) && (attributes.st_size > 0))
    quantum=(size_t) (((attributes.st_size) < (81920)) ? (attributes.st_size) : (81920));
  buffer=(unsigned char *) AcquireQuantumMemory(quantum,sizeof(*buffer));
  if (buffer == (unsigned char *) 
# 226 "MagickCore/utility.c" 3 4
                                 ((void *)0)
# 226 "MagickCore/utility.c"
                                     )
    {
...
# 281 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) void AppendImageFormat(const char *format,char *filename)
{
  char
    extension[4096],
    root[4096];
...
# 287 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 287 "MagickCore/utility.c"
 format != (char *) 
# 287 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 287 "MagickCore/utility.c"
...
# 287 "MagickCore/utility.c"
 "format != (char *) NULL"
# 287 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 287, __extension__ __PRETTY_FUNCTION__); }))
# 287 "MagickCore/utility.c"
                                ;
  
# 288 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 288 "MagickCore/utility.c"
 filename != (char *) 
# 288 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 288 "MagickCore/utility.c"
...
# 288 "MagickCore/utility.c"
 "filename != (char *) NULL"
# 288 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 288, __extension__ __PRETTY_FUNCTION__); }))
# 288 "MagickCore/utility.c"
                                  ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/utility.c",__func__,(unsigned long) 290,"%s",filename);
  ...
  if (LocaleCompare(filename,"-") == 0)
    {
      ...
      (void) FormatLocaleString(message,4096,"%s:%s",format,
        filename);
      (void) CopyMagickString(filename,message,4096);
      return;
    }
  ...
  if ((LocaleCompare(extension,"Z") == 0) ||
      ...
      (LocaleCompare(extension,"svgz") == 0))
    {
      ...
      (void) CopyMagickString(filename,root,4096);
      GetPathComponent(filename,RootPath,root);
      (void) FormatLocaleString(filename,4096,"%s.%s.%s",root,
        format,extension);
      return;
    }
  GetPathComponent(filename,RootPath,root);
  (void) FormatLocaleString(filename,4096,"%s.%s",root,format);
}
# 347 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) unsigned char *Base64Decode(const char *source,size_t *length)
{
  int
    state;
...
# 362 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 362 "MagickCore/utility.c"
 source != (char *) 
# 362 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 362 "MagickCore/utility.c"
...
# 362 "MagickCore/utility.c"
 "source != (char *) NULL"
# 362 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 362, __extension__ __PRETTY_FUNCTION__); }))
# 362 "MagickCore/utility.c"
                                ;
  
# 363 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 363 "MagickCore/utility.c"
 length != (size_t *) 
# 363 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 363 "MagickCore/utility.c"
...
# 363 "MagickCore/utility.c"
 "length != (size_t *) NULL"
# 363 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 363, __extension__ __PRETTY_FUNCTION__); }))
# 363 "MagickCore/utility.c"
                                  ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/utility.c",__func__,(unsigned long) 365,"...");
  *length=0;
  decode=(unsigned char *) AcquireQuantumMemory((strlen(source)+3)/4,
    3*sizeof(*decode));
  if (decode == (unsigned char *) 
# 369 "MagickCore/utility.c" 3 4
                                 ((void *)0)
# 369 "MagickCore/utility.c"
                                     )
    return((unsigned char *) 
# 370 "MagickCore/utility.c" 3 4
                            ((void *)0)
# 370 "MagickCore/utility.c"
                                );
  i=0;
  state=0;
  for (p=source; *p != '\0'; p++)
  {
    if (
# 375 "MagickCore/utility.c" 3 4
       ((*__ctype_b_loc ())[(int) ((
# 375 "MagickCore/utility.c"
       (int) ((unsigned char) *p)
# 375 "MagickCore/utility.c" 3 4
...
# 375 "MagickCore/utility.c"
    ...
    q=strchr(Base64,*p);
    if (q == (char *) 
# 380 "MagickCore/utility.c" 3 4
                     ((void *)0)
# 380 "MagickCore/utility.c"
                         )
      {
        decode=(unsigned char *) RelinquishMagickMemory(decode);
        return((unsigned char *) 
# 383 "MagickCore/utility.c" 3 4
                                ((void *)0)
# 383 "MagickCore/utility.c"
                                    );
      }
    switch (state)
    {
      ...
      if (state != 0)
        {
          decode=(unsigned char *) RelinquishMagickMemory(decode);
          return((unsigned char *) 
# 423 "MagickCore/utility.c" 3 4
                                  ((void *)0)
# 423 "MagickCore/utility.c"
                                      );
        }
    }
  else
    {
      ...
      switch (state)
      {
        ...
        case 1:
        {
          ...
          decode=(unsigned char *) RelinquishMagickMemory(decode);
          return((unsigned char *) 
# 438 "MagickCore/utility.c" 3 4
                                  ((void *)0)
# 438 "MagickCore/utility.c"
                                      );
        }
        case 2:
        {
          for ( ; *p != '\0'; p++)
            if (
# 443 "MagickCore/utility.c" 3 4
               ((*__ctype_b_loc ())[(int) ((
# 443 "MagickCore/utility.c"
               (int) ((unsigned char) *p)
# 443 "MagickCore/utility.c" 3 4
               ))] & (unsigned short int) _ISspace) 
# 443 "MagickCore/utility.c"
          ...
          if (*p != '=')
            {
              decode=(unsigned char *) RelinquishMagickMemory(decode);
              return((unsigned char *) 
# 448 "MagickCore/utility.c" 3 4
                                      ((void *)0)
# 448 "MagickCore/utility.c"
                                          );
            }
          p++;
        }
        case 3:
        {
          for ( ; *p != '\0'; p++)
            if (
# 455 "MagickCore/utility.c" 3 4
               ((*__ctype_b_loc ())[(int) ((
# 455 "MagickCore/utility.c"
               (int) ((unsigned char) *p)
# 455 "MagickCore/utility.c" 3 4
               ))] & (unsigned short int) _ISspace) 
# 455 "MagickCore/utility.c"
                                                   == 0)
              {
                decode=(unsigned char *) RelinquishMagickMemory(decode);
                return((unsigned char *) 
# 458 "MagickCore/utility.c" 3 4
                                        ((void *)0)
# 458 "MagickCore/utility.c"
                                            );
              }
          if ((int) decode[i] != 0)
            {
              decode=(unsigned char *) RelinquishMagickMemory(decode);
              return((unsigned char *) 
# 463 "MagickCore/utility.c" 3 4
                                      ((void *)0)
# 463 "MagickCore/utility.c"
                                          );
            }
          break;
        }
...
# 503 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) char *Base64Encode(const unsigned char *blob,
...
# 518 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 518 "MagickCore/utility.c"
 blob != (const unsigned char *) 
# 518 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 518 "MagickCore/utility.c"
 blob != (const unsigned char *) 
# 518 "MagickCore/utility.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 518 "MagickCore/utility.c"
 "blob != (const unsigned char *) NULL"
# 518 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 518, __extension__ __PRETTY_FUNCTION__); }))
# 518 "MagickCore/utility.c"
                                             ;
  
# 519 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 519 "MagickCore/utility.c"
 blob_length != 0
# 519 "MagickCore/utility.c" 3 4
...
# 519 "MagickCore/utility.c"
 "blob_length != 0"
# 519 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 519, __extension__ __PRETTY_FUNCTION__); }))
# 519 "MagickCore/utility.c"
                         ;
  
# 520 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 520 "MagickCore/utility.c"
 encode_length != (size_t *) 
# 520 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 520 "MagickCore/utility.c"
 encode_length != (size_t *) 
# 520 "MagickCore/utility.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 520 "MagickCore/utility.c"
 "encode_length != (size_t *) NULL"
# 520 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 520, __extension__ __PRETTY_FUNCTION__); }))
# 520 "MagickCore/utility.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/utility.c",__func__,(unsigned long) 522,"...");
  *encode_length=0;
  encode=(char *) AcquireQuantumMemory(blob_length/3+4,4*sizeof(*encode));
  if (encode == (char *) 
# 525 "MagickCore/utility.c" 3 4
                        ((void *)0)
# 525 "MagickCore/utility.c"
                            )
    return((char *) 
# 526 "MagickCore/utility.c" 3 4
                   ((void *)0)
# 526 "MagickCore/utility.c"
                       );
  i=0;
...
# 587 "MagickCore/utility.c"
__attribute__ ((visibility ("hidden"))) void ChopPathComponents(char *path,const size_t components)
{
  ssize_t
    i;
...
# 619 "MagickCore/utility.c"
__attribute__ ((visibility ("hidden"))) void ExpandFilename(char *path)
{
  char
    expand_path[4096];

  if (path == (char *) 
# 624 "MagickCore/utility.c" 3 4
                      ((void *)0)
# 624 "MagickCore/utility.c"
                          )
    return;
  if (*path != '~')
    return;
  (void) CopyMagickString(expand_path,path,4096);
  if ((*(path+1) == *"/") || (*(path+1) == '\0'))
    {
      char
        *home;
      ...
      (void) CopyMagickString(expand_path,".",4096);
      (void) ConcatenateMagickString(expand_path,path+1,4096);
      home=GetEnvironmentValue("HOME");
      if (home == (char *) 
# 640 "MagickCore/utility.c" 3 4
                          ((void *)0)
# 640 "MagickCore/utility.c"
                              )
        home=GetEnvironmentValue("USERPROFILE");
      if (home != (char *) 
# 642 "MagickCore/utility.c" 3 4
                          ((void *)0)
# 642 "MagickCore/utility.c"
                              )
        {
          (void) CopyMagickString(expand_path,home,4096);
          (void) ConcatenateMagickString(expand_path,path+1,4096);
  ...
  else
    {
      ...
      (void) CopyMagickString(username,path+1,4096);
      p=strchr(username,'/');
      if (p != (char *) 
# 670 "MagickCore/utility.c" 3 4
                       ((void *)0)
# 670 "MagickCore/utility.c"
                           )
        *p='\0';
      ...
      entry=(struct passwd *) 
# 675 "MagickCore/utility.c" 3 4
                             ((void *)0)
# 675 "MagickCore/utility.c"
                                 ;
      if (getpwnam_r(username,&pwd,buffer,sizeof(buffer),&entry) < 0)
        return;

      if (entry == (struct passwd *) 
# 679 "MagickCore/utility.c" 3 4
                                    ((void *)0)
# 679 "MagickCore/utility.c"
                                        )
        return;
      (void) CopyMagickString(expand_path,entry->pw_dir,4096);
      if (p != (char *) 
# 682 "MagickCore/utility.c" 3 4
                       ((void *)0)
# 682 "MagickCore/utility.c"
                           )
        {
          (void) ConcatenateMagickString(expand_path,"/",4096);
          (void) ConcatenateMagickString(expand_path,p+1,4096);
        }

    }
  (void) CopyMagickString(path,expand_path,4096);
}
# 748 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ExpandFilenames(int *number_arguments,
  char ***arguments)
{
  char
    home_directory[4096],
...
# 769 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 769 "MagickCore/utility.c"
...
# 769 "MagickCore/utility.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 769 "MagickCore/utility.c"
 "number_arguments != (int *) NULL"
# 769 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 769, __extension__ __PRETTY_FUNCTION__); }))
# 769 "MagickCore/utility.c"
                                         ;
  
# 770 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 770 "MagickCore/utility.c"
 arguments != (char ***) 
# 770 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 770 "MagickCore/utility.c"
...
# 770 "MagickCore/utility.c"
 "arguments != (char ***) NULL"
# 770 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 770, __extension__ __PRETTY_FUNCTION__); }))
# 770 "MagickCore/utility.c"
                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/utility.c",__func__,(unsigned long) 772,"...");
  vector=(char **) AcquireQuantumMemory((size_t) (*number_arguments+1),
    sizeof(*vector));
  if (vector == (char **) 
# 775 "MagickCore/utility.c" 3 4
                         ((void *)0)
# 775 "MagickCore/utility.c"
                             )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 776 "MagickCore/utility.c" 3 4
   (*__errno_location ())
# 776 "MagickCore/utility.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/utility.c",__func__,(unsigned long) 776,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
    ...
    if (*option != '@')
      {
        ...
        ExpandFilename(path);
        if (*home_directory == '\0')
          getcwd_utf8(home_directory,4096 -1);
    ...
    else
      {
        ...
        if (files == (char *) 
# 862 "MagickCore/utility.c" 3 4
                             ((void *)0)
# 862 "MagickCore/utility.c"
                                 )
          continue;
        filelist=StringToArgv(files,&length);
        if (filelist == (char **) 
# 865 "MagickCore/utility.c" 3 4
                                 ((void *)0)
# 865 "MagickCore/utility.c"
                                     )
          continue;
    ...
    if (filelist == (char **) 
# 873 "MagickCore/utility.c" 3 4
                             ((void *)0)
# 873 "MagickCore/utility.c"
                                 )
      continue;
    ...
    if (vector == (char **) 
# 890 "MagickCore/utility.c" 3 4
                           ((void *)0)
# 890 "MagickCore/utility.c"
                               )
      {
        for (j=0; j < (ssize_t) number_files; j++)
          filelist[j]=DestroyString(filelist[j]);
    ...
    for (j=0; j < (ssize_t) number_files; j++)
    {
      ...
      (void) CopyMagickString(filename,path,4096);
      if (*path != '\0')
        (void) ConcatenateMagickString(filename,"/",
          4096);
      if (filelist[j] != (char *) 
# 924 "MagickCore/utility.c" 3 4
                                 ((void *)0)
# 924 "MagickCore/utility.c"
                                     )
        (void) ConcatenateMagickString(filename,filelist[j],4096);
      filelist[j]=DestroyString(filelist[j]);
      if (strlen(filename) >= (4096 -1))
        { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 928 "MagickCore/utility.c" 3 4
       (*__errno_location ())
# 928 "MagickCore/utility.c"
       ); (void) ThrowMagickException(fatal_exception,"MagickCore/utility.c",__func__,(unsigned long) 928,OptionFatalError,"FilenameTruncated", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (OptionFatalError-FatalErrorException)+1); };
      if (IsPathDirectory(filename) <= 0)
        {
          ...
          *file_path='\0';
          if (*magick != '\0')
            {
              (void) ConcatenateMagickString(file_path,magick,
                4096);
              (void) ConcatenateMagickString(file_path,":",4096);
            }
          (void) ConcatenateMagickString(file_path,filename,4096);
          if (*subimage != '\0')
            {
              (void) ConcatenateMagickString(file_path,"[",4096);
          ...
          if (strlen(file_path) >= (4096 -1))
            { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 950 "MagickCore/utility.c" 3 4
           (*__errno_location ())
# 950 "MagickCore/utility.c"
           ); (void) ThrowMagickException(fatal_exception,"MagickCore/utility.c",__func__,(unsigned long) 950,OptionFatalError,"FilenameTruncated", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (OptionFatalError-FatalErrorException)+1); };
  ...
  vector[count]=(char *) 
# 962 "MagickCore/utility.c" 3 4
                        ((void *)0)
# 962 "MagickCore/utility.c"
                            ;
  if (IsEventLogging() != MagickFalse)
    {
      char
      ...
      (void) LogMagickEvent(ConfigureEvent,"MagickCore/utility.c",__func__,(unsigned long) 975,
...
# 1009 "MagickCore/utility.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType GetExecutionPath(char *path,const size_t extent)
{
  char
    *directory;
  ...
  *path='\0';
...

  {
    char
      execution_path[
# 1020 "MagickCore/utility.c" 3 4
                    4096
# 1020 "MagickCore/utility.c"
                            +1],
      link_path[4096];
    ...
    (void) FormatLocaleString(link_path,4096,"/proc/%.20g/exe",
      (double) getpid());
    count=readlink(link_path,execution_path,
# 1028 "MagickCore/utility.c" 3 4
                                           4096
# 1028 "MagickCore/utility.c"
                                                   );
    if (count == -1)
      {
        (void) FormatLocaleString(link_path,4096,"/proc/%.20g/file",
          (double) getpid());
        count=readlink(link_path,execution_path,
# 1033 "MagickCore/utility.c" 3 4
                                               4096
# 1033 "MagickCore/utility.c"
                                                       );
      }
    if ((count > 0) && (count <= (ssize_t) 
# 1035 "MagickCore/utility.c" 3 4
                                          4096
# 1035 "MagickCore/utility.c"
                                                  ))
      {
...
# 1117 "MagickCore/utility.c"
  return(IsPathAccessible(path));
}
# 1138 "MagickCore/utility.c"
__attribute__ ((visibility ("hidden"))) ssize_t GetMagickPageSize(void)
{
  static ssize_t
    page_size = -1;
  ...
  page_size=(ssize_t) sysconf(
# 1146 "MagickCore/utility.c" 3 4
                             _SC_PAGESIZE
# 1146 "MagickCore/utility.c"
                                          );
...
# 1179 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetPathAttributes(const char *path,
  void *attributes)
{
  MagickBooleanType
    status;
  ...
  if (path == (const char *) 
# 1185 "MagickCore/utility.c" 3 4
                            ((void *)0)
# 1185 "MagickCore/utility.c"
                                )
    {
      
# 1187 "MagickCore/utility.c" 3 4
     (*__errno_location ())
# 1187 "MagickCore/utility.c"
          =
# 1187 "MagickCore/utility.c" 3 4
           22
# 1187 "MagickCore/utility.c"
...
# 1227 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) void GetPathComponent(const char *path,PathType type,
  char *component)
{
  char
    *q;
...
# 1241 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 1241 "MagickCore/utility.c"
 path != (const char *) 
# 1241 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1241 "MagickCore/utility.c"
...
# 1241 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 1241, __extension__ __PRETTY_FUNCTION__); }))
# 1241 "MagickCore/utility.c"
                                    ;
  
# 1242 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 1242 "MagickCore/utility.c"
 component != (char *) 
# 1242 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1242 "MagickCore/utility.c"
...
# 1242 "MagickCore/utility.c"
 "component != (char *) NULL"
# 1242 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 1242, __extension__ __PRETTY_FUNCTION__); }))
# 1242 "MagickCore/utility.c"
                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/utility.c",__func__,(unsigned long) 1244,"%s",path);
  if (*path == '\0')
    {
      *component='\0';
      return;
    }
  (void) CopyMagickString(component,path,4096);
  subimage_length=0;
  subimage_offset=0;
      ...
      if ((strlen(component) > 2) && (*p == ']'))
        {
          q=strrchr(component,'[');
          if ((q != (char *) 
# 1259 "MagickCore/utility.c" 3 4
                            ((void *)0)
# 1259 "MagickCore/utility.c"
                                ) && ((q == component) || (*(q-1) != ']')) &&
  ...
  if (*p != '\0')
    for (p=component+strlen(component)-1; p > component; p--)
      if (((*p) == '/' ? MagickTrue : MagickFalse) != MagickFalse)
        break;
  switch (type)
  {
    case MagickPath:
    ...
    {
      if (((*p) == '/' ? MagickTrue : MagickFalse) != MagickFalse)
        (void) CopyMagickString(component,p+1,4096);
      break;
    }
    case BasePath:
    {
...
# 1437 "MagickCore/utility.c"
__attribute__ ((visibility ("hidden"))) char **GetPathComponents(const char *path,
  size_t *number_components)
{
  ...
  if (path == (char *) 
# 1450 "MagickCore/utility.c" 3 4
                      ((void *)0)
# 1450 "MagickCore/utility.c"
                          )
    return((char **) 
# 1451 "MagickCore/utility.c" 3 4
                    ((void *)0)
# 1451 "MagickCore/utility.c"
                        );
  *number_components=1;
  for (p=path; *p != '\0'; p++)
    if (((*p) == '/' ? MagickTrue : MagickFalse))
      (*number_components)++;
  components=(char **) AcquireQuantumMemory((size_t) *number_components+1UL,
    sizeof(*components));
  if (components == (char **) 
# 1458 "MagickCore/utility.c" 3 4
                             ((void *)0)
# 1458 "MagickCore/utility.c"
                                 )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1459 "MagickCore/utility.c" 3 4
   (*__errno_location ())
# 1459 "MagickCore/utility.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/utility.c",__func__,(unsigned long) 1459,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  p=path;
  for (i=0; i < (ssize_t) *number_components; i++)
  {
    for (q=p; *q != '\0'; q++)
      if (((*q) == '/' ? MagickTrue : MagickFalse))
        break;
    components[i]=(char *) AcquireQuantumMemory((size_t) (q-p)+4096,
      sizeof(**components));
    if (components[i] == (char *) 
# 1468 "MagickCore/utility.c" 3 4
                                 ((void *)0)
# 1468 "MagickCore/utility.c"
                                     )
      { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1469 "MagickCore/utility.c" 3 4
     (*__errno_location ())
# 1469 "MagickCore/utility.c"
     ); (void) ThrowMagickException(fatal_exception,"MagickCore/utility.c",__func__,(unsigned long) 1469,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
    (void) CopyMagickString(components[i],p,(size_t) (q-p+1));
    p=q+1;
  }
  components[i]=(char *) 
# 1473 "MagickCore/utility.c" 3 4
                        ((void *)0)
# 1473 "MagickCore/utility.c"
                            ;
  return(components);
}
# 1500 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsPathAccessible(const char *path)
{
  MagickBooleanType
    status;
  ...
  if ((path == (const char *) 
# 1508 "MagickCore/utility.c" 3 4
                             ((void *)0)
# 1508 "MagickCore/utility.c"
                                 ) || (*path == '\0'))
    return(MagickFalse);
  ...
  if (status == MagickFalse)
    return(status);
  if (
# 1515 "MagickCore/utility.c" 3 4
     ((((
# 1515 "MagickCore/utility.c"
     attributes.st_mode
# 1515 "MagickCore/utility.c" 3 4
     )) & 0170000) == (0100000)) 
# 1515 "MagickCore/utility.c"
    ...
    return(MagickFalse);
  if (access_utf8(path,
# 1517 "MagickCore/utility.c" 3 4
                      0
# 1517 "MagickCore/utility.c"
                          ) != 0)
    return(MagickFalse);
  return(MagickTrue);
}
# 1545 "MagickCore/utility.c"
static int IsPathDirectory(const char *path)
{
  ...
  if ((path == (const char *) 
# 1553 "MagickCore/utility.c" 3 4
                             ((void *)0)
# 1553 "MagickCore/utility.c"
                                 ) || (*path == '\0'))
    return(MagickFalse);
  status=GetPathAttributes(path,&attributes);
  if (status == MagickFalse)
    return(-1);
  if (
# 1558 "MagickCore/utility.c" 3 4
     ((((
# 1558 "MagickCore/utility.c"
     attributes.st_mode
# 1558 "MagickCore/utility.c" 3 4
     )) & 0170000) == (0040000)) 
# 1558 "MagickCore/utility.c"
...
__attribute__ ((visibility ("hidden"))) char **ListFiles(const char *directory,const char *pattern,
...
# 1636 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 1636 "MagickCore/utility.c"
...
# 1636 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 1636, __extension__ __PRETTY_FUNCTION__); }))
# 1636 "MagickCore/utility.c"
                                         ;
  
# 1637 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 1637 "MagickCore/utility.c"
 pattern != (const char *) 
# 1637 "MagickCore/utility.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1637 "MagickCore/utility.c"
...
# 1637 "MagickCore/utility.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1637 "MagickCore/utility.c"
 "pattern != (const char *) NULL"
# 1637 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 1637, __extension__ __PRETTY_FUNCTION__); }))
# 1637 "MagickCore/utility.c"
                                       ;
  
# 1638 "MagickCore/utility.c" 3 4
 ((void) sizeof ((
# 1638 "MagickCore/utility.c"
...
# 1638 "MagickCore/utility.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1638 "MagickCore/utility.c"
 "number_entries != (size_t *) NULL"
# 1638 "MagickCore/utility.c" 3 4
 , "MagickCore/utility.c", 1638, __extension__ __PRETTY_FUNCTION__); }))
# 1638 "MagickCore/utility.c"
                                          ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/utility.c",__func__,(unsigned long) 1640,"%s",directory);
  *number_entries=0;
  current_directory=opendir(directory);
  if (current_directory == (DIR *) 
# 1643 "MagickCore/utility.c" 3 4
                                  ((void *)0)
# 1643 "MagickCore/utility.c"
                                      )
    return((char **) 
# 1644 "MagickCore/utility.c" 3 4
                    ((void *)0)
# 1644 "MagickCore/utility.c"
                        );
  ...
  filelist=(char **) AcquireQuantumMemory((size_t) max_entries,
    sizeof(*filelist));
  if (filelist == (char **) 
# 1651 "MagickCore/utility.c" 3 4
                           ((void *)0)
# 1651 "MagickCore/utility.c"
                               )
    {
      (void) closedir(current_directory);
      return((char **) 
# 1654 "MagickCore/utility.c" 3 4
                      ((void *)0)
# 1654 "MagickCore/utility.c"
                          );
    }
...
# 1659 "MagickCore/utility.c" 3 4
                                                              4096
# 1659 "MagickCore/utility.c"
                                                                          +1);
  if (buffer == (struct dirent *) 
# 1660 "MagickCore/utility.c" 3 4
                                 ((void *)0)
# 1660 "MagickCore/utility.c"
                                     )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1661 "MagickCore/utility.c" 3 4
   (*__errno_location ())
# 1661 "MagickCore/utility.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/utility.c",__func__,(unsigned long) 1661,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  while ((MagickReadDirectory(current_directory,buffer,&entry) == 0) &&
         (entry != (struct dirent *) 
# 1663 "MagickCore/utility.c" 3 4
                                    ((void *)0)
# 1663 "MagickCore/utility.c"
                                        ))
  {
        ...
        if (*number_entries >= max_entries)
          {
            ...
            if (filelist == (char **) 
# 1683 "MagickCore/utility.c" 3 4
                                     ((void *)0)
# 1683 "MagickCore/utility.c"
                                         )
              break;
          }
# 1699 "MagickCore/utility.c"
  ...
  (void) closedir(current_directory);
  if (filelist == (char **) 
# 1705 "MagickCore/utility.c" 3 4
                           ((void *)0)
# 1705 "MagickCore/utility.c"
                               )
    return((char **) 
# 1706 "MagickCore/utility.c" 3 4
                    ((void *)0)
# 1706 "MagickCore/utility.c"
                        );
...
# 1739 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) void MagickDelay(const MagickSizeType milliseconds)
{
  if (milliseconds == 0)
    return;

  {
    ...
    (void) nanosleep(&timer,(struct timespec *) 
# 1750 "MagickCore/utility.c" 3 4
                                               ((void *)0)
# 1750 "MagickCore/utility.c"
                                                   );
  }
# 1788 "MagickCore/utility.c"
}
# 1813 "MagickCore/utility.c"
__attribute__ ((visibility ("default"))) size_t MultilineCensus(const char *label)
{
  size_t
    number_lines;
  ...
  if (label == (char *) 
# 1821 "MagickCore/utility.c" 3 4
                       ((void *)0)
# 1821 "MagickCore/utility.c"
                           )
    return(0);
...
# 1852 "MagickCore/utility.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType ShredFile(const char *path)
{
  int
    file,
    status;
  ...
  if ((path == (const char *) 
# 1879 "MagickCore/utility.c" 3 4
                             ((void *)0)
# 1879 "MagickCore/utility.c"
                                 ) || (*path == '\0'))
    return(MagickFalse);
  if (passes == -1)
    {
      ...
      if (property != (char *) 
# 1888 "MagickCore/utility.c" 3 4
                              ((void *)0)
# 1888 "MagickCore/utility.c"
                                  )
        {
      ...
      if (property != (char *) 
# 1894 "MagickCore/utility.c" 3 4
                              ((void *)0)
# 1894 "MagickCore/utility.c"
                                  )
        {
          passes=(ssize_t) StringToInteger(property);
          property=DestroyString(property);
  ...
  file=open_utf8(path,
# 1905 "MagickCore/utility.c" 3 4
                     01 
# 1905 "MagickCore/utility.c"
                              | 
# 1905 "MagickCore/utility.c" 3 4
                                0200 
# 1905 "MagickCore/utility.c"
...
# 1905 "MagickCore/utility.c"
  ...
  if (file == -1)
    return(MagickFalse);
  quantum=(size_t) 16384;
  if ((fstat(file,&file_stats) == 0) && (file_stats.st_size > 0))
    quantum=(size_t) (((file_stats.st_size) < (16384)) ? (file_stats.st_size) : (16384));
  ...
  for (i=0; i < passes; i++)
  {
    ...
    if (lseek(file,0,
# 1922 "MagickCore/utility.c" 3 4
                    0
# 1922 "MagickCore/utility.c"
                            ) < 0)
      break;
    for (j=0; j < (MagickOffsetType) length; j+=count)
    {
      ...
      count=write(file,GetStringInfoDatum(key),(size_t)
        ((((MagickOffsetType) quantum) < ((MagickOffsetType) length-j)) ? ((MagickOffsetType) quantum) : ((MagickOffsetType) length-j)));
      if (count <= 0)
        {
          count=0;
          if (
# 1933 "MagickCore/utility.c" 3 4
             (*__errno_location ()) 
# 1933 "MagickCore/utility.c"
                   != 
# 1933 "MagickCore/utility.c" 3 4
                      4
# 1933 "MagickCore/utility.c"
