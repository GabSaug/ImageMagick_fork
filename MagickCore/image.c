# 0 "MagickCore/image.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/image.c"
# 43 "MagickCore/image.c"
...
# 75 "MagickCore/image.c" 2

# 1 "./MagickCore/magick-private.h" 1
# 25 "./MagickCore/magick-private.h"
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
...
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
  XRenderImage(Image *,const DrawInfo *,const PointInfo *,TypeMetric *,
    ExceptionInfo *);
# 106 "MagickCore/image.c" 2
# 134 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) Image *AcquireImage(const ImageInfo *image_info,
  ExceptionInfo *exception)
{
  ...
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 150,"...");
  image=(Image *) AcquireCriticalMemory(sizeof(*image));
  (void) memset(image,0,sizeof(*image));



  (void) CopyMagickString(image->magick,"MIFF",4096);
  ...
  image->ticks_per_second=100L;
  image->compose=OverCompositeOp;
  GetPixelInfoRGBA(((Quantum) 65535.0),((Quantum) 65535.0),((Quantum) 65535.0),((Quantum) ((Quantum) 65535.0)),&image->background_color);
  GetPixelInfoRGBA(ScaleShortToQuantum(0xdfdf), ScaleShortToQuantum(0xdfdf),ScaleShortToQuantum(0xdfdf),((Quantum) ((Quantum) 65535.0)),&image->border_color);
  GetPixelInfoRGBA(ScaleShortToQuantum(0xbdbd), ScaleShortToQuantum(0xbdbd),ScaleShortToQuantum(0xbdbd),((Quantum) ((Quantum) 65535.0)),&image->matte_color);
  GetPixelInfoRGBA(0,0,0,((Quantum) 0),&image->transparent_color);
  GetTimerInfo(&image->timer);
  image->cache=AcquirePixelCache(0);
  image->channel_mask=AllChannels;
  image->channel_map=AcquirePixelChannelMap();
  image->blob=CloneBlobInfo((BlobInfo *) 
# 185 "MagickCore/image.c" 3 4
                                        ((void *)0)
# 185 "MagickCore/image.c"
                                            );
...
# 193 "MagickCore/image.c" 3 4
                                 ((void *)0)
# 193 "MagickCore/image.c"
                                     )
    return(image);



  SetBlobExempt(image,image_info->file != (FILE *) 
# 198 "MagickCore/image.c" 3 4
                                                  ((void *)0) 
# 198 "MagickCore/image.c"
                                                       ? MagickTrue :
    MagickFalse);
  ...
  (void) CopyMagickString(image->magick_filename,image_info->filename,
    4096);
  (void) CopyMagickString(image->magick,image_info->magick,4096);
  if (image_info->size != (char *) 
# 205 "MagickCore/image.c" 3 4
                                  ((void *)0)
# 205 "MagickCore/image.c"
                                      )
    {
  ...
  if (image_info->extract != (char *) 
# 214 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 214 "MagickCore/image.c"
                                         )
    {
      RectangleInfo
        geometry;
      ...
      if (((flags & 
# 221 "MagickCore/image.c" 3 4
                   0x0001
# 221 "MagickCore/image.c"
                         ) != 0) || ((flags & 
# 221 "MagickCore/image.c" 3 4
                                              0x0002
# 221 "MagickCore/image.c"
                                                    ) != 0))
        {
          ...
          ((image->columns)^=(image->extract_info.width), (image->extract_info.width)^=(image->columns), (image->columns)^=(image->extract_info.width));
          ((image->rows)^=(image->extract_info.height), (image->extract_info.height)^=(image->rows), (image->rows)^=(image->extract_info.height));
        }
    }
...
# 233 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 233 "MagickCore/image.c"
                                         )
    {
      GeometryInfo
        geometry_info;
...
# 245 "MagickCore/image.c" 3 4
                                  ((void *)0)
# 245 "MagickCore/image.c"
                                      )
    {
      char
        *geometry;
  ...
  if (image_info->cache != (void *) 
# 265 "MagickCore/image.c" 3 4
                                   ((void *)0)
# 265 "MagickCore/image.c"
                                       )
...
# 275 "MagickCore/image.c" 3 4
                              ((void *)0)
# 275 "MagickCore/image.c"
                                  )
    {
      GeometryInfo
        geometry_info;
  ...
  if (option != (const char *) 
# 301 "MagickCore/image.c" 3 4
                              ((void *)0)
# 301 "MagickCore/image.c"
                                  )
    image->dispose=(DisposeType) ParseCommandOption(MagickDisposeOptions,
      MagickFalse,option);
  return(image);
}
# 325 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) ImageInfo *AcquireImageInfo(void)
{
  ImageInfo
    *image_info;
...
# 366 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) void AcquireNextImage(const ImageInfo *image_info,Image *image,
  ExceptionInfo *exception)
{
...
# 372 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 372 "MagickCore/image.c"
 image != (Image *) 
# 372 "MagickCore/image.c" 3 4
...
# 372 "MagickCore/image.c"
 "image != (Image *) NULL"
# 372 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 372, __extension__ __PRETTY_FUNCTION__); }))
# 372 "MagickCore/image.c"
                                ;
  
# 373 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 373 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 373 "MagickCore/image.c" 3 4
...
# 373 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 373, __extension__ __PRETTY_FUNCTION__); }))
# 373 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 375,"%s",image->filename);
  image->next=AcquireImage(image_info,exception);
  if (GetNextImageInList(image) == (Image *) 
# 377 "MagickCore/image.c" 3 4
                                            ((void *)0)
# 377 "MagickCore/image.c"
                                                )
    return;
  (void) CopyMagickString(GetNextImageInList(image)->filename,image->filename,
    4096);
  if (image_info != (ImageInfo *) 
# 381 "MagickCore/image.c" 3 4
                                 ((void *)0)
# 381 "MagickCore/image.c"
                                     )
...
# 423 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) Image *AppendImages(const Image *images,
...
# 467 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 467 "MagickCore/image.c"
 images != (Image *) 
# 467 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 467 "MagickCore/image.c"
...
# 467 "MagickCore/image.c"
 "images != (Image *) NULL"
# 467 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 467, __extension__ __PRETTY_FUNCTION__); }))
# 467 "MagickCore/image.c"
                                 ;
  
# 468 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 468 "MagickCore/image.c"
...
# 468 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 468, __extension__ __PRETTY_FUNCTION__); }))
# 468 "MagickCore/image.c"
                                                 ;
  
# 469 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 469 "MagickCore/image.c"
...
# 469 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 469, __extension__ __PRETTY_FUNCTION__); }))
# 469 "MagickCore/image.c"
                                            ;
  
# 470 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 470 "MagickCore/image.c"
...
# 470 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 470, __extension__ __PRETTY_FUNCTION__); }))
# 470 "MagickCore/image.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 472,"%s",images->filename);
  ...
  for ( ; next != (Image *) 
# 481 "MagickCore/image.c" 3 4
                           ((void *)0)
# 481 "MagickCore/image.c"
  ...
  if (append_image == (Image *) 
# 507 "MagickCore/image.c" 3 4
                               ((void *)0)
# 507 "MagickCore/image.c"
                                   )
    return((Image *) 
# 508 "MagickCore/image.c" 3 4
                    ((void *)0)
# 508 "MagickCore/image.c"
                        );
      ...
      if (SetImageStorageClass(append_image,DirectClass,exception) == MagickFalse)
        {
          ...
          return((Image *) 
# 514 "MagickCore/image.c" 3 4
                          ((void *)0)
# 514 "MagickCore/image.c"
                              );
        }
  ...
  for (n=0; n < (MagickOffsetType) number_images; n++)
  {
    ...
    for (y=0; y < (ssize_t) next->rows; y++)
    {
      ...
      if ((p == (const Quantum *) 
# 569 "MagickCore/image.c" 3 4
                                 ((void *)0)
# 569 "MagickCore/image.c"
                                     ) || (q == (Quantum *) 
# 569 "MagickCore/image.c" 3 4
                                                            ((void *)0)
# 569 "MagickCore/image.c"
    ...
    proceed=SetImageProgress(append_image,"Append/Image",n,number_images);
...
# 632 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) ExceptionType CatchImageException(Image *image)
{
  ExceptionInfo
    *exception;
...
# 640 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 640 "MagickCore/image.c"
 image != (const Image *) 
# 640 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 640 "MagickCore/image.c"
...
# 640 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 640, __extension__ __PRETTY_FUNCTION__); }))
# 640 "MagickCore/image.c"
                                      ;
  
# 641 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 641 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 641 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 641 "MagickCore/image.c"
...
# 641 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 641 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 641, __extension__ __PRETTY_FUNCTION__); }))
# 641 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 643,"%s",image->filename);
...
# 684 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ClipImage(Image *image,ExceptionInfo *exception)
{
  return(ClipImagePath(image,"#1",MagickTrue,exception));
}

__attribute__ ((visibility ("default"))) MagickBooleanType ClipImagePath(Image *image,const char *pathname,
...
# 706 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 706 "MagickCore/image.c"
 image != (const Image *) 
# 706 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 706 "MagickCore/image.c"
...
# 706 "MagickCore/image.c"
 "image != (const Image *) NULL"
# 706 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 706, __extension__ __PRETTY_FUNCTION__); }))
# 706 "MagickCore/image.c"
                                      ;
  
# 707 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 707 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 707 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 707 "MagickCore/image.c"
...
# 707 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 707 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 707, __extension__ __PRETTY_FUNCTION__); }))
# 707 "MagickCore/image.c"
                                                ;
  
# 708 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 708 "MagickCore/image.c"
 pathname != 
# 708 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 708 "MagickCore/image.c"
...
# 708 "MagickCore/image.c"
 "pathname != NULL"
# 708 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 708, __extension__ __PRETTY_FUNCTION__); }))
# 708 "MagickCore/image.c"
                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 710,"%s",image->filename);
  property=AcquireString(pathname);
  (void) FormatLocaleString(property,4096,"8BIM:1999,2998:%s",
    pathname);
  value=GetImageProperty(image,property,exception);
  property=DestroyString(property);
  if (value == (const char *) 
# 716 "MagickCore/image.c" 3 4
                             ((void *)0)
# 716 "MagickCore/image.c"
                                 )
    {
      { char *file_message; file_message=GetExceptionMessage(
# 718 "MagickCore/image.c" 3 4
     (*__errno_location ())
# 718 "MagickCore/image.c"
     ); (void) ThrowMagickException(exception,"MagickCore/image.c",__func__,(unsigned long) 718,OptionError,"NoClipPathDefined", "'%s': %s",image->filename,file_message); file_message=DestroyString(file_message); }
                        ;
      return(MagickFalse);
    }
  ...
  if (clip_mask == (Image *) 
# 729 "MagickCore/image.c" 3 4
                            ((void *)0)
# 729 "MagickCore/image.c"
                                )
    return(MagickFalse);
  ...
  (void) FormatLocaleString(clip_mask->magick_filename,4096,
    "8BIM:1999,2998:%s\nPS",pathname);
...
# 786 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) Image *CloneImage(const Image *image,const size_t columns,
...
# 802 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 802 "MagickCore/image.c"
 image != (const Image *) 
# 802 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 802 "MagickCore/image.c"
...
# 802 "MagickCore/image.c"
 "image != (const Image *) NULL"
# 802 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 802, __extension__ __PRETTY_FUNCTION__); }))
# 802 "MagickCore/image.c"
                                      ;
  
# 803 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 803 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 803 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 803 "MagickCore/image.c"
...
# 803 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 803 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 803, __extension__ __PRETTY_FUNCTION__); }))
# 803 "MagickCore/image.c"
                                                ;
  
# 804 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 804 "MagickCore/image.c"
 exception != (ExceptionInfo *) 
# 804 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 804 "MagickCore/image.c"
...
# 804 "MagickCore/image.c"
 "exception != (ExceptionInfo *) NULL"
# 804 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 804, __extension__ __PRETTY_FUNCTION__); }))
# 804 "MagickCore/image.c"
                                            ;
  
# 805 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 805 "MagickCore/image.c"
 exception->signature == 0xabacadabUL
# 805 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 805 "MagickCore/image.c"
...
# 805 "MagickCore/image.c"
 "exception->signature == MagickCoreSignature"
# 805 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 805, __extension__ __PRETTY_FUNCTION__); }))
# 805 "MagickCore/image.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 807,"%s",image->filename);
  if ((image->columns == 0) || (image->rows == 0))
    {
      (void) ThrowMagickException(exception,"MagickCore/image.c",__func__,(unsigned long) 810,CorruptImageError,
        "NegativeOrZeroImageSize","`%s'",image->filename);
      return((Image *) 
# 812 "MagickCore/image.c" 3 4
                      ((void *)0)
# 812 "MagickCore/image.c"
                          );
    }
  ...
  if (image->ascii85 != (void *) 
# 833 "MagickCore/image.c" 3 4
                                ((void *)0)
# 833 "MagickCore/image.c"
                                    )
  ...
  (void) CopyMagickString(clone_image->magick_filename,image->magick_filename,
    4096);
  (void) CopyMagickString(clone_image->magick,image->magick,4096);
  ...
  if (detach == MagickFalse)
  ...
  else
    {
      ...
      clone_image->blob=CloneBlobInfo((BlobInfo *) 
# 858 "MagickCore/image.c" 3 4
                                                  ((void *)0)
# 858 "MagickCore/image.c"
                                                      );
    }
  ...
  if (image->colormap != (PixelInfo *) 
# 865 "MagickCore/image.c" 3 4
                                      ((void *)0)
# 865 "MagickCore/image.c"
                                          )
    {
      ...
      if (clone_image->colormap == (PixelInfo *) 
# 874 "MagickCore/image.c" 3 4
                                                ((void *)0)
# 874 "MagickCore/image.c"
                                                    )
        {
          clone_image=DestroyImage(clone_image);
          { (void) ThrowMagickException(exception,"MagickCore/image.c",__func__,(unsigned long) 877,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 877 "MagickCore/image.c" 3 4
         ((void *)0)
# 877 "MagickCore/image.c"
         ); };
        }
...
# 884 "MagickCore/image.c" 3 4
                                    ((void *)0)
# 884 "MagickCore/image.c"
                                        )
        (void) CloneString(&clone_image->montage,image->montage);
      if (image->directory != (char *) 
# 886 "MagickCore/image.c" 3 4
                                      ((void *)0)
# 886 "MagickCore/image.c"
                                          )
  ...
  if (((scale_x-scale_y) < 0 ? -(scale_x-scale_y) : (scale_x-scale_y)) < 2.0)
    scale_x=scale_y=(((scale_x) < (scale_y)) ? (scale_x) : (scale_y));
...
# 939 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) ImageInfo *CloneImageInfo(const ImageInfo *image_info)
{
  ImageInfo
    *clone_info;
  ...
  if (image_info == (ImageInfo *) 
# 945 "MagickCore/image.c" 3 4
                                 ((void *)0)
# 945 "MagickCore/image.c"
                                     )
    return(clone_info);
  ...
  if (image_info->size != (char *) 
# 954 "MagickCore/image.c" 3 4
                                  ((void *)0)
# 954 "MagickCore/image.c"
                                      )
    (void) CloneString(&clone_info->size,image_info->size);
  if (image_info->extract != (char *) 
# 956 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 956 "MagickCore/image.c"
                                         )
    (void) CloneString(&clone_info->extract,image_info->extract);
  if (image_info->scenes != (char *) 
# 958 "MagickCore/image.c" 3 4
                                    ((void *)0)
# 958 "MagickCore/image.c"
                                        )
    (void) CloneString(&clone_info->scenes,image_info->scenes);
  if (image_info->page != (char *) 
# 960 "MagickCore/image.c" 3 4
                                  ((void *)0)
# 960 "MagickCore/image.c"
                                      )
  ...
  if (image_info->sampling_factor != (char *) 
# 966 "MagickCore/image.c" 3 4
                                             ((void *)0)
# 966 "MagickCore/image.c"
                                                 )
    (void) CloneString(&clone_info->sampling_factor,
      image_info->sampling_factor);
  if (image_info->server_name != (char *) 
# 969 "MagickCore/image.c" 3 4
                                         ((void *)0)
# 969 "MagickCore/image.c"
                                             )
    (void) CloneString(&clone_info->server_name,image_info->server_name);
  if (image_info->font != (char *) 
# 971 "MagickCore/image.c" 3 4
                                  ((void *)0)
# 971 "MagickCore/image.c"
                                      )
    (void) CloneString(&clone_info->font,image_info->font);
  if (image_info->texture != (char *) 
# 973 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 973 "MagickCore/image.c"
                                         )
    (void) CloneString(&clone_info->texture,image_info->texture);
  if (image_info->density != (char *) 
# 975 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 975 "MagickCore/image.c"
                                         )
  ...
  if (image_info->cache != (void *) 
# 993 "MagickCore/image.c" 3 4
                                   ((void *)0)
# 993 "MagickCore/image.c"
                                       )
    clone_info->cache=ReferencePixelCache(image_info->cache);
  if (image_info->profile != (void *) 
# 995 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 995 "MagickCore/image.c"
                                         )
...
# 1048 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CopyImagePixels(Image *image,
...
# 1067 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1067 "MagickCore/image.c"
 image != (Image *) 
# 1067 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1067 "MagickCore/image.c"
...
# 1067 "MagickCore/image.c"
 "image != (Image *) NULL"
# 1067 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1067, __extension__ __PRETTY_FUNCTION__); }))
# 1067 "MagickCore/image.c"
                                ;
  
# 1068 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1068 "MagickCore/image.c"
 source_image != (Image *) 
# 1068 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1068 "MagickCore/image.c"
...
# 1068 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1068, __extension__ __PRETTY_FUNCTION__); }))
# 1068 "MagickCore/image.c"
                                       ;
  
# 1069 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1069 "MagickCore/image.c"
 geometry != (RectangleInfo *) 
# 1069 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1069 "MagickCore/image.c"
 geometry != (RectangleInfo *) 
# 1069 "MagickCore/image.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1069 "MagickCore/image.c"
 "geometry != (RectangleInfo *) NULL"
# 1069 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1069, __extension__ __PRETTY_FUNCTION__); }))
# 1069 "MagickCore/image.c"
                                           ;
  
# 1070 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1070 "MagickCore/image.c"
 offset != (OffsetInfo *) 
# 1070 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1070 "MagickCore/image.c"
...
# 1070 "MagickCore/image.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1070 "MagickCore/image.c"
 "offset != (OffsetInfo *) NULL"
# 1070 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1070, __extension__ __PRETTY_FUNCTION__); }))
# 1070 "MagickCore/image.c"
                                      ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1072,"...");
  if ((offset->x < 0) || (offset->y < 0) ||
      ((offset->x+(ssize_t) geometry->width) > (ssize_t) image->columns) ||
      ((offset->y+(ssize_t) geometry->height) > (ssize_t) image->rows))
    { (void) ThrowMagickException(exception,"MagickCore/image.c",__func__,(unsigned long) 1076,OptionError,"GeometryDoesNotContainImage", "`%s'",image->filename); return(MagickFalse); }
                      ;
  ...
  for (y=0; y < (ssize_t) geometry->height; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(image_view,offset->x,y+offset->y,
      geometry->width,1,exception);
    if ((p == (const Quantum *) 
# 1111 "MagickCore/image.c" 3 4
                               ((void *)0)
# 1111 "MagickCore/image.c"
                                   ) || (q == (Quantum *) 
# 1111 "MagickCore/image.c" 3 4
                                                          ((void *)0)
# 1111 "MagickCore/image.c"
...
# 1138 "MagickCore/image.c" 3 4
                                                          ((void *)0)
# 1138 "MagickCore/image.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"Copy/Image",progress,image->rows);
        if (proceed == MagickFalse)
          status=MagickFalse;
      }
  }
...
# 1180 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) Image *DestroyImage(Image *image)
{
  MagickBooleanType
    destroy;
...
# 1188 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1188 "MagickCore/image.c"
 image != (Image *) 
# 1188 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1188 "MagickCore/image.c"
...
# 1188 "MagickCore/image.c"
 "image != (Image *) NULL"
# 1188 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1188, __extension__ __PRETTY_FUNCTION__); }))
# 1188 "MagickCore/image.c"
                                ;
  
# 1189 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1189 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 1189 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1189 "MagickCore/image.c"
...
# 1189 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 1189 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1189, __extension__ __PRETTY_FUNCTION__); }))
# 1189 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1191,"%s",image->filename);
  destroy=MagickFalse;
  ...
  if (destroy == MagickFalse)
    return((Image *) 
# 1199 "MagickCore/image.c" 3 4
                    ((void *)0)
# 1199 "MagickCore/image.c"
                        );
  ...
  if (image->montage != (char *) 
# 1205 "MagickCore/image.c" 3 4
                                ((void *)0)
# 1205 "MagickCore/image.c"
                                    )
    image->montage=DestroyString(image->montage);
  if (image->directory != (char *) 
# 1207 "MagickCore/image.c" 3 4
                                  ((void *)0)
# 1207 "MagickCore/image.c"
                                      )
    image->directory=DestroyString(image->directory);
  if (image->colormap != (PixelInfo *) 
# 1209 "MagickCore/image.c" 3 4
                                      ((void *)0)
# 1209 "MagickCore/image.c"
                                          )
    image->colormap=(PixelInfo *) RelinquishMagickMemory(image->colormap);
  if (image->geometry != (char *) 
# 1211 "MagickCore/image.c" 3 4
                                 ((void *)0)
# 1211 "MagickCore/image.c"
                                     )
...
# 1216 "MagickCore/image.c" 3 4
                                       ((void *)0)
# 1216 "MagickCore/image.c"
                                           )
    image->ascii85=(Ascii85Info *) RelinquishMagickMemory(image->ascii85);
  if (image->image_info != (ImageInfo *) 
# 1218 "MagickCore/image.c" 3 4
                                        ((void *)0)
# 1218 "MagickCore/image.c"
                                            )
    image->image_info=DestroyImageInfo(image->image_info);
  DestroyBlob(image);
  if (image->semaphore != (SemaphoreInfo *) 
# 1221 "MagickCore/image.c" 3 4
                                           ((void *)0)
# 1221 "MagickCore/image.c"
                                               )
...
# 1251 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) ImageInfo *DestroyImageInfo(ImageInfo *image_info)
{
  
# 1253 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1253 "MagickCore/image.c"
...
# 1253 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1253, __extension__ __PRETTY_FUNCTION__); }))
# 1253 "MagickCore/image.c"
                                         ;
  
# 1254 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1254 "MagickCore/image.c"
...
# 1254 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1254, __extension__ __PRETTY_FUNCTION__); }))
# 1254 "MagickCore/image.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1256,"%s",
      image_info->filename);
  if (image_info->size != (char *) 
# 1258 "MagickCore/image.c" 3 4
                                  ((void *)0)
# 1258 "MagickCore/image.c"
                                      )
    image_info->size=DestroyString(image_info->size);
  if (image_info->extract != (char *) 
# 1260 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 1260 "MagickCore/image.c"
                                         )
    image_info->extract=DestroyString(image_info->extract);
  if (image_info->scenes != (char *) 
# 1262 "MagickCore/image.c" 3 4
                                    ((void *)0)
# 1262 "MagickCore/image.c"
                                        )
    image_info->scenes=DestroyString(image_info->scenes);
  if (image_info->page != (char *) 
# 1264 "MagickCore/image.c" 3 4
                                  ((void *)0)
# 1264 "MagickCore/image.c"
                                      )
    image_info->page=DestroyString(image_info->page);
  if (image_info->sampling_factor != (char *) 
# 1266 "MagickCore/image.c" 3 4
                                             ((void *)0)
# 1266 "MagickCore/image.c"
                                                 )
    image_info->sampling_factor=DestroyString(
      image_info->sampling_factor);
  if (image_info->server_name != (char *) 
# 1269 "MagickCore/image.c" 3 4
                                         ((void *)0)
# 1269 "MagickCore/image.c"
                                             )
    image_info->server_name=DestroyString(
      image_info->server_name);
  if (image_info->font != (char *) 
# 1272 "MagickCore/image.c" 3 4
                                  ((void *)0)
# 1272 "MagickCore/image.c"
                                      )
    image_info->font=DestroyString(image_info->font);
  if (image_info->texture != (char *) 
# 1274 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 1274 "MagickCore/image.c"
                                         )
    image_info->texture=DestroyString(image_info->texture);
  if (image_info->density != (char *) 
# 1276 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 1276 "MagickCore/image.c"
                                         )
    image_info->density=DestroyString(image_info->density);
  if (image_info->cache != (void *) 
# 1278 "MagickCore/image.c" 3 4
                                   ((void *)0)
# 1278 "MagickCore/image.c"
                                       )
    image_info->cache=DestroyPixelCache(image_info->cache);
  if (image_info->profile != (StringInfo *) 
# 1280 "MagickCore/image.c" 3 4
                                           ((void *)0)
# 1280 "MagickCore/image.c"
                                               )
...
# 1313 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) void DisassociateImageStream(Image *image)
{
  
# 1315 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1315 "MagickCore/image.c"
 image != (Image *) 
# 1315 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1315 "MagickCore/image.c"
...
# 1315 "MagickCore/image.c"
 "image != (Image *) NULL"
# 1315 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1315, __extension__ __PRETTY_FUNCTION__); }))
# 1315 "MagickCore/image.c"
                                ;
  
# 1316 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1316 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 1316 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1316 "MagickCore/image.c"
...
# 1316 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 1316 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1316, __extension__ __PRETTY_FUNCTION__); }))
# 1316 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1318,"%s",image->filename);
  DisassociateBlob(image);
}
# 1344 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) void GetImageInfo(ImageInfo *image_info)
{
  char
    *synchronize;
...
# 1352 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1352 "MagickCore/image.c"
 image_info != (ImageInfo *) 
# 1352 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1352 "MagickCore/image.c"
...
# 1352 "MagickCore/image.c"
 "image_info != (ImageInfo *) NULL"
# 1352 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1352, __extension__ __PRETTY_FUNCTION__); }))
# 1352 "MagickCore/image.c"
                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1354,"...");
  (void) memset(image_info,0,sizeof(*image_info));
  image_info->adjoin=MagickTrue;
  image_info->interlace=NoInterlace;
  image_info->channel=AllChannels;
  image_info->quality=0UL;
  image_info->antialias=MagickTrue;
  image_info->dither=MagickTrue;
  image_info->depth=0;
  synchronize=GetEnvironmentValue("MAGICK_SYNCHRONIZE");
  if (synchronize != (const char *) 
# 1364 "MagickCore/image.c" 3 4
                                   ((void *)0)
# 1364 "MagickCore/image.c"
                                       )
    {
      image_info->synchronize=IsStringTrue(synchronize);
      synchronize=DestroyString(synchronize);
    }
  GetPixelInfoRGBA(((Quantum) 65535.0),((Quantum) 65535.0),((Quantum) 65535.0),((Quantum) ((Quantum) 65535.0)),&image_info->background_color);
  GetPixelInfoRGBA(ScaleShortToQuantum(0xdfdf), ScaleShortToQuantum(0xdfdf),ScaleShortToQuantum(0xdfdf),((Quantum) ((Quantum) 65535.0)),&image_info->border_color);
  GetPixelInfoRGBA(ScaleShortToQuantum(0xbdbd), ScaleShortToQuantum(0xbdbd),ScaleShortToQuantum(0xbdbd),((Quantum) ((Quantum) 65535.0)),&image_info->matte_color);
  GetPixelInfoRGBA(0,0,0,((Quantum) 0),&image_info->transparent_color);
  image_info->debug=(GetLogEventMask() & ImageEvent) != 0 ? MagickTrue :
    MagickFalse;
  image_info->signature=0xabacadabUL;
}
# 1400 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) FILE *GetImageInfoFile(const ImageInfo *image_info)
{
  return(image_info->file);
}
# 1430 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) Image *GetImageMask(const Image *image,const PixelMask type,
  ExceptionInfo *exception)
{
  CacheView
    *mask_view,
...
# 1449 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1449 "MagickCore/image.c"
 image != (Image *) 
# 1449 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1449 "MagickCore/image.c"
...
# 1449 "MagickCore/image.c"
 "image != (Image *) NULL"
# 1449 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1449, __extension__ __PRETTY_FUNCTION__); }))
# 1449 "MagickCore/image.c"
                                ;
  
# 1450 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1450 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 1450 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1450 "MagickCore/image.c"
...
# 1450 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 1450 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1450, __extension__ __PRETTY_FUNCTION__); }))
# 1450 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1452,"...");
  switch (type)
  {
    case ReadPixelMask:
    {
      if ((image->channels & ReadMaskChannel) == 0)
        return((Image *) 
# 1458 "MagickCore/image.c" 3 4
                        ((void *)0)
# 1458 "MagickCore/image.c"
                            );
      break;
    }
    case WritePixelMask:
    {
      if ((image->channels & WriteMaskChannel) == 0)
        return((Image *) 
# 1464 "MagickCore/image.c" 3 4
                        ((void *)0)
# 1464 "MagickCore/image.c"
                            );
      break;
    }
    default:
    {
      if ((image->channels & CompositeMaskChannel) == 0)
        return((Image *) 
# 1470 "MagickCore/image.c" 3 4
                        ((void *)0)
# 1470 "MagickCore/image.c"
                            );
      break;
    }
  }
  mask_image=AcquireImage((ImageInfo *) 
# 1474 "MagickCore/image.c" 3 4
                                       ((void *)0)
# 1474 "MagickCore/image.c"
                                           ,exception);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(mask_view,0,y,mask_image->columns,1,
      exception);
    if ((p == (const Quantum *) 
# 1503 "MagickCore/image.c" 3 4
                               ((void *)0)
# 1503 "MagickCore/image.c"
                                   ) || (q == (Quantum *) 
# 1503 "MagickCore/image.c" 3 4
                                                          ((void *)0)
# 1503 "MagickCore/image.c"
...
# 1563 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) ssize_t GetImageReferenceCount(Image *image)
{
  ssize_t
    reference_count;

  
# 1568 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1568 "MagickCore/image.c"
 image != (Image *) 
# 1568 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1568 "MagickCore/image.c"
...
# 1568 "MagickCore/image.c"
 "image != (Image *) NULL"
# 1568 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1568, __extension__ __PRETTY_FUNCTION__); }))
# 1568 "MagickCore/image.c"
                                ;
  
# 1569 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1569 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 1569 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1569 "MagickCore/image.c"
...
# 1569 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 1569 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1569, __extension__ __PRETTY_FUNCTION__); }))
# 1569 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1571,"%s",image->filename);
  LockSemaphoreInfo(image->semaphore);
  reference_count=image->reference_count;
  UnlockSemaphoreInfo(image->semaphore);
  return(reference_count);
}
# 1602 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) VirtualPixelMethod GetImageVirtualPixelMethod(const Image *image)
{
  
# 1604 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1604 "MagickCore/image.c"
 image != (Image *) 
# 1604 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1604 "MagickCore/image.c"
...
# 1604 "MagickCore/image.c"
 "image != (Image *) NULL"
# 1604 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1604, __extension__ __PRETTY_FUNCTION__); }))
# 1604 "MagickCore/image.c"
                                ;
  
# 1605 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1605 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 1605 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1605 "MagickCore/image.c"
...
# 1605 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 1605 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1605, __extension__ __PRETTY_FUNCTION__); }))
# 1605 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1607,"%s",image->filename);
  return(GetPixelCacheVirtualMethod(image));
}
# 1646 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) size_t InterpretImageFilename(const ImageInfo *image_info,
  ...
  ExceptionInfo *exception)
{
  ...
  offset=0;
  (void) CopyMagickString(filename,format,4096);
  if (IsStringTrue(GetImageOption(image_info,"filename:literal")) != MagickFalse)
    return(strlen(filename));
  for (p=strchr(format,'%'); p != (char *) 
# 1671 "MagickCore/image.c" 3 4
                                          ((void *)0)
# 1671 "MagickCore/image.c"
                                              ; p=strchr(p+1,'%'))
  {
    q=(char *) p+1;
    if (*q == '%')
    ...
    switch (*q)
    {
      ...
      case 'x':
      {
        ...
        *q='\0';
        (void) FormatLocaleString(filename+(p-format-offset),(size_t)
          (4096 -(p-format-offset)),p,value);
        offset+=(4-field_width);
        *q=c;
        (void) ConcatenateMagickString(filename,q,4096);
      ...
      case '[':
      {
        ...
        if (strchr(p,']') == (char *) 
# 1722 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 1722 "MagickCore/image.c"
                                         )
          break;
        depth=1;
        r=q+1;
        for (i=0; (i < (4096 -1L)) && (*r != '\0'); i++)
        {
          if (*r == '[')
            depth++;
          if (*r == ']')
        ...
        if (LocaleNCompare(pattern,"filename:",9) != 0)
          break;
        option=(const char *) 
# 1739 "MagickCore/image.c" 3 4
                             ((void *)0)
# 1739 "MagickCore/image.c"
                                 ;
        if (image != (Image *) 
# 1740 "MagickCore/image.c" 3 4
                              ((void *)0)
# 1740 "MagickCore/image.c"
                                  )
          option=GetImageProperty(image,pattern,exception);
        if ((option == (const char *) 
# 1742 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 1742 "MagickCore/image.c"
                                         ) && (image != (Image *) 
# 1742 "MagickCore/image.c" 3 4
                                                                  ((void *)0)
# 1742 "MagickCore/image.c"
        ...
        if ((option == (const char *) 
# 1744 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 1744 "MagickCore/image.c"
                                         ) &&
            (image_info != (ImageInfo *) 
# 1745 "MagickCore/image.c" 3 4
                                        ((void *)0)
# 1745 "MagickCore/image.c"
                                            ))
          option=GetImageOption(image_info,pattern);
        if (option == (const char *) 
# 1747 "MagickCore/image.c" 3 4
                                    ((void *)0)
# 1747 "MagickCore/image.c"
                                        )
          break;
        q--;
        c=(*q);
        *q='\0';
        (void) CopyMagickString(filename+(p-format-offset),option,(size_t)
          (4096 -(p-format-offset)));
        offset+=(ssize_t) strlen(pattern)-(ssize_t) strlen(option)+3;
        *q=c;
        (void) ConcatenateMagickString(filename,r+1,4096);
        canonical=MagickTrue;
        if (*(q-1) != '%')
          break;
        p++;
  ...
  if (canonical == MagickFalse)
    ...
    for (q=filename; *q != '\0'; q++)
      if ((*q == '%') && (*(q+1) == '%'))
        (void) CopyMagickString(q,q+1,(size_t) (4096 -(q-filename)));
  return(strlen(filename));
}
# 1803 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsHighDynamicRangeImage(const Image *image,
  ExceptionInfo *exception)
{
...
# 1820 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1820 "MagickCore/image.c"
 image != (Image *) 
# 1820 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1820 "MagickCore/image.c"
...
# 1820 "MagickCore/image.c"
 "image != (Image *) NULL"
# 1820 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1820, __extension__ __PRETTY_FUNCTION__); }))
# 1820 "MagickCore/image.c"
                                ;
  
# 1821 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1821 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 1821 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1821 "MagickCore/image.c"
...
# 1821 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 1821 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1821, __extension__ __PRETTY_FUNCTION__); }))
# 1821 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1823,"%s",image->filename);
  image_view=AcquireVirtualCacheView(image,exception);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    p=GetCacheViewVirtualPixels(image_view,0,y,image->columns,1,exception);
    if (p == (const Quantum *) 
# 1840 "MagickCore/image.c" 3 4
                              ((void *)0)
# 1840 "MagickCore/image.c"
                                  )
      continue;
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        ...
        if (traits == UndefinedPixelTrait)
          continue;
        pixel=(double) p[i];
        if ((pixel < 0.0) || (pixel > (double) ((Quantum) 65535.0)) ||
...
# 1899 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsImageObject(const Image *image)
{
  const Image
    *p;

  
# 1904 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1904 "MagickCore/image.c"
 image != (Image *) 
# 1904 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1904 "MagickCore/image.c"
...
# 1904 "MagickCore/image.c"
 "image != (Image *) NULL"
# 1904 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1904, __extension__ __PRETTY_FUNCTION__); }))
# 1904 "MagickCore/image.c"
                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1906,"...");
  for (p=image; p != (Image *) 
# 1907 "MagickCore/image.c" 3 4
                              ((void *)0)
# 1907 "MagickCore/image.c"
                                  ; p=GetNextImageInList(p))
    if (p->signature != 0xabacadabUL)
      return(MagickFalse);
  return(MagickTrue);
}
# 1936 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsTaintImage(const Image *image)
{
  char
    magick[4096],
    filename[4096];
...
# 1945 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1945 "MagickCore/image.c"
 image != (Image *) 
# 1945 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1945 "MagickCore/image.c"
...
# 1945 "MagickCore/image.c"
 "image != (Image *) NULL"
# 1945 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1945, __extension__ __PRETTY_FUNCTION__); }))
# 1945 "MagickCore/image.c"
                                ;
  
# 1946 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1946 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 1946 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1946 "MagickCore/image.c"
...
# 1946 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 1946 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1946, __extension__ __PRETTY_FUNCTION__); }))
# 1946 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1948,"...");
  (void) CopyMagickString(magick,image->magick,4096);
  (void) CopyMagickString(filename,image->filename,4096);
  for (p=image; p != (Image *) 
# 1951 "MagickCore/image.c" 3 4
                              ((void *)0)
# 1951 "MagickCore/image.c"
                                  ; p=GetNextImageInList(p))
  {
...
# 1989 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ModifyImage(Image **image,
  ExceptionInfo *exception)
{
  Image
    *clone_image;
...
# 1995 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1995 "MagickCore/image.c"
 image != (Image **) 
# 1995 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1995 "MagickCore/image.c"
...
# 1995 "MagickCore/image.c"
 "image != (Image **) NULL"
# 1995 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1995, __extension__ __PRETTY_FUNCTION__); }))
# 1995 "MagickCore/image.c"
                                 ;
  
# 1996 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1996 "MagickCore/image.c"
 *image != (Image *) 
# 1996 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1996 "MagickCore/image.c"
...
# 1996 "MagickCore/image.c"
 "*image != (Image *) NULL"
# 1996 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1996, __extension__ __PRETTY_FUNCTION__); }))
# 1996 "MagickCore/image.c"
                                 ;
  
# 1997 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 1997 "MagickCore/image.c"
 (*image)->signature == 0xabacadabUL
# 1997 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1997 "MagickCore/image.c"
...
# 1997 "MagickCore/image.c"
 "(*image)->signature == MagickCoreSignature"
# 1997 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 1997, __extension__ __PRETTY_FUNCTION__); }))
# 1997 "MagickCore/image.c"
                                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 1999,"%s",(*image)->filename);
...
# 2043 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) Image *NewMagickImage(const ImageInfo *image_info,
...
# 2059 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2059 "MagickCore/image.c"
...
# 2059 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2059, __extension__ __PRETTY_FUNCTION__); }))
# 2059 "MagickCore/image.c"
                                               ;
  
# 2060 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2060 "MagickCore/image.c"
 image_info->signature == 0xabacadabUL
# 2060 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2060 "MagickCore/image.c"
...
# 2060 "MagickCore/image.c"
 "image_info->signature == MagickCoreSignature"
# 2060 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2060, __extension__ __PRETTY_FUNCTION__); }))
# 2060 "MagickCore/image.c"
                                                     ;
  
# 2061 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2061 "MagickCore/image.c"
 background != (const PixelInfo *) 
# 2061 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2061 "MagickCore/image.c"
 background != (const PixelInfo *) 
# 2061 "MagickCore/image.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 2061 "MagickCore/image.c"
 "background != (const PixelInfo *) NULL"
# 2061 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2061, __extension__ __PRETTY_FUNCTION__); }))
# 2061 "MagickCore/image.c"
                                               ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 2063,"...");
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (q == (Quantum *) 
# 2088 "MagickCore/image.c" 3 4
                        ((void *)0)
# 2088 "MagickCore/image.c"
                            )
      {
        status=MagickFalse;
        continue;
...
# 2130 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) Image *ReferenceImage(Image *image)
{
  
# 2132 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2132 "MagickCore/image.c"
 image != (Image *) 
# 2132 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2132 "MagickCore/image.c"
...
# 2132 "MagickCore/image.c"
 "image != (Image *) NULL"
# 2132 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2132, __extension__ __PRETTY_FUNCTION__); }))
# 2132 "MagickCore/image.c"
                                ;
  
# 2133 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2133 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 2133 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2133 "MagickCore/image.c"
...
# 2133 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 2133 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2133, __extension__ __PRETTY_FUNCTION__); }))
# 2133 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 2135,"...");
  LockSemaphoreInfo(image->semaphore);
  image->reference_count++;
  UnlockSemaphoreInfo(image->semaphore);
  return(image);
}
# 2166 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ResetImagePage(Image *image,const char *page)
{
  MagickStatusType
    flags;
...
# 2174 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2174 "MagickCore/image.c"
 image != (Image *) 
# 2174 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2174 "MagickCore/image.c"
...
# 2174 "MagickCore/image.c"
 "image != (Image *) NULL"
# 2174 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2174, __extension__ __PRETTY_FUNCTION__); }))
# 2174 "MagickCore/image.c"
                                ;
  
# 2175 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2175 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 2175 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2175 "MagickCore/image.c"
...
# 2175 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 2175 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2175, __extension__ __PRETTY_FUNCTION__); }))
# 2175 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 2177,"%s",image->filename);
  flags=ParseAbsoluteGeometry(page,&geometry);
  if ((flags & 
# 2179 "MagickCore/image.c" 3 4
              0x0004
# 2179 "MagickCore/image.c"
                        ) != 0)
    {
      if ((flags & 
# 2181 "MagickCore/image.c" 3 4
                  0x0008
# 2181 "MagickCore/image.c"
                             ) == 0)
  ...
  if ((flags & AspectValue) != 0)
    {
      if ((flags & 
# 2188 "MagickCore/image.c" 3 4
                  0x0001
# 2188 "MagickCore/image.c"
                        ) != 0)
        image->page.x+=geometry.x;
      if ((flags & 
# 2190 "MagickCore/image.c" 3 4
                  0x0002
# 2190 "MagickCore/image.c"
                        ) != 0)
    ...
    {
      if ((flags & 
# 2195 "MagickCore/image.c" 3 4
                  0x0001
# 2195 "MagickCore/image.c"
                        ) != 0)
        {
          image->page.x=geometry.x;
      ...
      if ((flags & 
# 2201 "MagickCore/image.c" 3 4
                  0x0002
# 2201 "MagickCore/image.c"
                        ) != 0)
        {
          image->page.y=geometry.y;
...
# 2237 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ResetImagePixels(Image *image,
  ExceptionInfo *exception)
{
  CacheView
    *image_view;
...
# 2255 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2255 "MagickCore/image.c"
 image != (Image *) 
# 2255 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2255 "MagickCore/image.c"
...
# 2255 "MagickCore/image.c"
 "image != (Image *) NULL"
# 2255 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2255, __extension__ __PRETTY_FUNCTION__); }))
# 2255 "MagickCore/image.c"
                                ;
  
# 2256 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2256 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 2256 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2256 "MagickCore/image.c"
...
# 2256 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 2256 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2256, __extension__ __PRETTY_FUNCTION__); }))
# 2256 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 2258,"...");
  pixels=AcquirePixelCachePixels(image,&length,exception);
  if (pixels != (void *) 
# 2260 "MagickCore/image.c" 3 4
                        ((void *)0)
# 2260 "MagickCore/image.c"
                            )
    {
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 2288 "MagickCore/image.c" 3 4
                        ((void *)0)
# 2288 "MagickCore/image.c"
                            )
      {
        status=MagickFalse;
        continue;
...
# 2333 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageAlpha(Image *image,const Quantum alpha,
  ExceptionInfo *exception)
{
  CacheView
    *image_view;
...
# 2345 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2345 "MagickCore/image.c"
 image != (Image *) 
# 2345 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2345 "MagickCore/image.c"
...
# 2345 "MagickCore/image.c"
 "image != (Image *) NULL"
# 2345 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2345, __extension__ __PRETTY_FUNCTION__); }))
# 2345 "MagickCore/image.c"
                                ;
  
# 2346 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2346 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 2346 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2346 "MagickCore/image.c"
...
# 2346 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 2346 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2346, __extension__ __PRETTY_FUNCTION__); }))
# 2346 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 2348,"...");
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (q == (Quantum *) 
# 2367 "MagickCore/image.c" 3 4
                        ((void *)0)
# 2367 "MagickCore/image.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      if (GetPixelWriteMask(image,q) > (((Quantum) 65535.0)/2))
...
# 2412 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageBackgroundColor(Image *image,
  ExceptionInfo *exception)
{
  CacheView
    *image_view;
...
# 2427 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2427 "MagickCore/image.c"
 image != (Image *) 
# 2427 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2427 "MagickCore/image.c"
...
# 2427 "MagickCore/image.c"
 "image != (Image *) NULL"
# 2427 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2427, __extension__ __PRETTY_FUNCTION__); }))
# 2427 "MagickCore/image.c"
                                ;
  
# 2428 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2428 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 2428 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2428 "MagickCore/image.c"
...
# 2428 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 2428 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2428, __extension__ __PRETTY_FUNCTION__); }))
# 2428 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 2430,"...");
  if (SetImageStorageClass(image,DirectClass,exception) == MagickFalse)
    return(MagickFalse);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 2457 "MagickCore/image.c" 3 4
                        ((void *)0)
# 2457 "MagickCore/image.c"
                            )
      {
        status=MagickFalse;
        continue;
...
# 2500 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) ChannelType SetImageChannelMask(Image *image,
  const ChannelType channel_mask)
{
  return(SetPixelChannelMask(image,channel_mask));
}
# 2533 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageColor(Image *image,
...
# 2545 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2545 "MagickCore/image.c"
 image != (Image *) 
# 2545 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2545 "MagickCore/image.c"
...
# 2545 "MagickCore/image.c"
 "image != (Image *) NULL"
# 2545 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2545, __extension__ __PRETTY_FUNCTION__); }))
# 2545 "MagickCore/image.c"
                                ;
  
# 2546 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2546 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 2546 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2546 "MagickCore/image.c"
...
# 2546 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 2546 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2546, __extension__ __PRETTY_FUNCTION__); }))
# 2546 "MagickCore/image.c"
                                                ;
  
# 2547 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2547 "MagickCore/image.c"
...
# 2547 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2547, __extension__ __PRETTY_FUNCTION__); }))
# 2547 "MagickCore/image.c"
                                          ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 2549,"...");
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 2571 "MagickCore/image.c" 3 4
                        ((void *)0)
# 2571 "MagickCore/image.c"
                            )
      {
        status=MagickFalse;
        continue;
...
# 2616 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageStorageClass(Image *image,
  const ClassType storage_class,ExceptionInfo *exception)
{
  
# 2619 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2619 "MagickCore/image.c"
 image != (Image *) 
# 2619 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2619 "MagickCore/image.c"
...
# 2619 "MagickCore/image.c"
 "image != (Image *) NULL"
# 2619 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2619, __extension__ __PRETTY_FUNCTION__); }))
# 2619 "MagickCore/image.c"
                                ;
  
# 2620 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2620 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 2620 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2620 "MagickCore/image.c"
...
# 2620 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 2620 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2620, __extension__ __PRETTY_FUNCTION__); }))
# 2620 "MagickCore/image.c"
                                                ;
  
# 2621 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2621 "MagickCore/image.c"
 exception != (ExceptionInfo *) 
# 2621 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2621 "MagickCore/image.c"
...
# 2621 "MagickCore/image.c"
 "exception != (ExceptionInfo *) NULL"
# 2621 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2621, __extension__ __PRETTY_FUNCTION__); }))
# 2621 "MagickCore/image.c"
                                            ;
  
# 2622 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2622 "MagickCore/image.c"
 exception->signature == 0xabacadabUL
# 2622 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2622 "MagickCore/image.c"
...
# 2622 "MagickCore/image.c"
 "exception->signature == MagickCoreSignature"
# 2622 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2622, __extension__ __PRETTY_FUNCTION__); }))
# 2622 "MagickCore/image.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 2624,"%s",image->filename);
  image->storage_class=storage_class;
  return(SyncImagePixelCache(image,exception));
}
# 2658 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageExtent(Image *image,const size_t columns,
  const size_t rows,ExceptionInfo *exception)
{
  if ((columns == 0) || (rows == 0))
    { (void) ThrowMagickException(exception,"MagickCore/image.c",__func__,(unsigned long) 2662,ImageError,"NegativeOrZeroImageSize", "`%s'",image->filename); return(MagickFalse); };
  image->columns=columns;
  image->rows=rows;
  if (image->depth == 0)
    {
      image->depth=8;
      (void) ThrowMagickException(exception,"MagickCore/image.c",__func__,(unsigned long) 2668,ImageError,
        "ImageDepthNotSupported","`%s'",image->filename);
    }
  if (image->depth > (8*sizeof(MagickSizeType)))
    {
      image->depth=8*sizeof(MagickSizeType);
      (void) ThrowMagickException(exception,"MagickCore/image.c",__func__,(unsigned long) 2674,ImageError,
        "ImageDepthNotSupported","`%s'",image->filename);
    }
  return(SyncImagePixelCache(image,exception));
}
# 2715 "MagickCore/image.c"
    ...
    *format_type_formats[] =
    {
      ...
      "WIN",
      (char *) 
# 2746 "MagickCore/image.c" 3 4
              ((void *)0)
    
# 2747 "MagickCore/image.c"
   };




  (void) CopyMagickString(magic,component,4096);
  LocaleUpper(magic);
...
# 2759 "MagickCore/image.c" 3 4
                                          ((void *)0)
# 2759 "MagickCore/image.c"
                                              ) &&
      (magick_info->format_type != UndefinedFormatType))
    format_type=magick_info->format_type;
  i=0;
  while ((format_type == UndefinedFormatType) &&
         (format_type_formats[i] != (char *) 
# 2764 "MagickCore/image.c" 3 4
                                            ((void *)0)
# 2764 "MagickCore/image.c"
                                                ))
  {
  ...
  if (format_type == UndefinedFormatType)
    (void) CopyMagickString(image_info->magick,magic,4096);
  else
...
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageInfo(ImageInfo *image_info,
...
# 2817 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2817 "MagickCore/image.c"
 image_info != (ImageInfo *) 
# 2817 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2817 "MagickCore/image.c"
...
# 2817 "MagickCore/image.c"
 "image_info != (ImageInfo *) NULL"
# 2817 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2817, __extension__ __PRETTY_FUNCTION__); }))
# 2817 "MagickCore/image.c"
                                         ;
  
# 2818 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 2818 "MagickCore/image.c"
 image_info->signature == 0xabacadabUL
# 2818 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2818 "MagickCore/image.c"
...
# 2818 "MagickCore/image.c"
 "image_info->signature == MagickCoreSignature"
# 2818 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 2818, __extension__ __PRETTY_FUNCTION__); }))
# 2818 "MagickCore/image.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 2820,"%s",
      image_info->filename);
  *component='\0';
  ...
  if (*component != '\0')
    {
      ...
      if (IsSceneGeometry(component,MagickFalse) == MagickFalse)
      ...
      else
        {
          ...
          {
            while ((
# 2846 "MagickCore/image.c" 3 4
                   ((*__ctype_b_loc ())[(int) ((
# 2846 "MagickCore/image.c"
                   (int) ((unsigned char) *p)
# 2846 "MagickCore/image.c" 3 4
                   ))] & (unsigned short int) _ISspace) 
# 2846 "MagickCore/image.c"
            ...
            last=first;
            while (
# 2850 "MagickCore/image.c" 3 4
                  ((*__ctype_b_loc ())[(int) ((
# 2850 "MagickCore/image.c"
                  (int) ((unsigned char) *q)
# 2850 "MagickCore/image.c" 3 4
                  ))] & (unsigned short int) _ISspace) 
# 2850 "MagickCore/image.c"
  ...
  *magic='\0';
  ...
  if (*magic == '\0')
    {
      (void) CopyMagickString(magic,image_info->magick,4096);
      magick_info=GetMagickInfo(magic,sans_exception);
      if ((magick_info != (const MagickInfo *) 
# 2890 "MagickCore/image.c" 3 4
                                              ((void *)0)
# 2890 "MagickCore/image.c"
                                                  ) &&
      ...
      (void) CopyMagickString(image_info->filename,component,4096);
    }
  else
    {
      const DelegateInfo
...
# 2909 "MagickCore/image.c" 3 4
                                          ((void *)0)
# 2909 "MagickCore/image.c"
                                              ;
      if (magick_info == (const MagickInfo *) 
# 2910 "MagickCore/image.c" 3 4
                                             ((void *)0)
# 2910 "MagickCore/image.c"
                                                 )
        {
          delegate_info=GetDelegateInfo(magic,"*",sans_exception);
          if (delegate_info == (const DelegateInfo *) 
# 2913 "MagickCore/image.c" 3 4
                                                     ((void *)0)
# 2913 "MagickCore/image.c"
                                                         )
            delegate_info=GetDelegateInfo("*",magic,sans_exception);
          if ((delegate_info == (const DelegateInfo *) 
# 2915 "MagickCore/image.c" 3 4
                                                      ((void *)0)
# 2915 "MagickCore/image.c"
                                                          ) &&
      ...
      if (((magick_info != (const MagickInfo *) 
# 2925 "MagickCore/image.c" 3 4
                                               ((void *)0)
# 2925 "MagickCore/image.c"
                                                   ) ||
           (delegate_info != (const DelegateInfo *) 
# 2926 "MagickCore/image.c" 3 4
                                                   ((void *)0)
# 2926 "MagickCore/image.c"
                                                       )) &&
  ...
  if ((magick_info == (const MagickInfo *) 
# 2937 "MagickCore/image.c" 3 4
                                          ((void *)0)
# 2937 "MagickCore/image.c"
                                              ) ||
...
# 2945 "MagickCore/image.c" 3 4
                                                        ((void *)0)
# 2945 "MagickCore/image.c"
                                                            ,
        image_info->filename,(int) image_info->scene,component,exception);
      if ((LocaleCompare(component,image_info->filename) != 0) &&
          (strchr(component,'%') == (char *) 
# 2948 "MagickCore/image.c" 3 4
                                            ((void *)0)
# 2948 "MagickCore/image.c"
                                                ))
  ...
  if ((image_info->adjoin != MagickFalse) && (frames > 0))
    {
      ...
      magick_info=GetMagickInfo(magic,exception);
      if (magick_info != (const MagickInfo *) 
# 2957 "MagickCore/image.c" 3 4
                                             ((void *)0)
# 2957 "MagickCore/image.c"
                                                 )
      ...
      if ((IsBlobSeekable(image) == MagickFalse) ||
          (IsBlobExempt(image) != MagickFalse))
        {
          ...
          *component='\0';
          ...
          SetImageInfoFile(image_info,(FILE *) 
# 3002 "MagickCore/image.c" 3 4
                                              ((void *)0)
# 3002 "MagickCore/image.c"
                                                  );
          (void) CopyMagickString(image->filename,component,4096);
          status=OpenBlob(image_info,image,ReadBinaryBlobMode,exception);
          if (status == MagickFalse)
            {
              (void) RelinquishUniqueFileResource(component);
      ...
      if (magick == (unsigned char *) 
# 3016 "MagickCore/image.c" 3 4
                                     ((void *)0)
# 3016 "MagickCore/image.c"
                                         )
        {
      ...
      (void) SeekBlob(image,-((MagickOffsetType) count),
# 3024 "MagickCore/image.c" 3 4
                                                       1
# 3024 "MagickCore/image.c"
                                                               );
      (void) CloseBlob(image);
      image=DestroyImage(image);
...
# 3033 "MagickCore/image.c" 3 4
                                            ((void *)0)
# 3033 "MagickCore/image.c"
                                                ) &&
          (GetMagicName(magic_info) != (char *) 
# 3034 "MagickCore/image.c" 3 4
                                               ((void *)0)
# 3034 "MagickCore/image.c"
                                                   ))
        {
          ...
          if ((magick_info != (const MagickInfo *) 
# 3039 "MagickCore/image.c" 3 4
                                                  ((void *)0)
# 3039 "MagickCore/image.c"
                                                      ) &&
          ...
          if ((magick_info == (const MagickInfo *) 
# 3051 "MagickCore/image.c" 3 4
                                                  ((void *)0)
# 3051 "MagickCore/image.c"
                                                      ) ||
              (GetMagickEndianSupport(magick_info) == MagickFalse))
            image_info->endian=UndefinedEndian;
          sans_exception=DestroyExceptionInfo(sans_exception);
      ...
      magick_info=GetMagickInfo(image_info->magick,sans_exception);
      if ((magick_info == (const MagickInfo *) 
# 3058 "MagickCore/image.c" 3 4
                                              ((void *)0)
# 3058 "MagickCore/image.c"
                                                  ) ||
          (GetMagickEndianSupport(magick_info) == MagickFalse))
        image_info->endian=UndefinedEndian;
      sans_exception=DestroyExceptionInfo(sans_exception);
...
# 3093 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) void SetImageInfoBlob(ImageInfo *image_info,const void *blob,
  const size_t length)
{
  
# 3096 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3096 "MagickCore/image.c"
 image_info != (ImageInfo *) 
# 3096 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3096 "MagickCore/image.c"
...
# 3096 "MagickCore/image.c"
 "image_info != (ImageInfo *) NULL"
# 3096 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3096, __extension__ __PRETTY_FUNCTION__); }))
# 3096 "MagickCore/image.c"
                                         ;
  
# 3097 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3097 "MagickCore/image.c"
 image_info->signature == 0xabacadabUL
# 3097 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3097 "MagickCore/image.c"
...
# 3097 "MagickCore/image.c"
 "image_info->signature == MagickCoreSignature"
# 3097 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3097, __extension__ __PRETTY_FUNCTION__); }))
# 3097 "MagickCore/image.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 3099,"%s",
      image_info->filename);
  image_info->blob=(void *) blob;
  image_info->length=length;
}
# 3130 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) void SetImageInfoCustomStream(ImageInfo *image_info,
  CustomStreamInfo *custom_stream)
{
  
# 3133 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3133 "MagickCore/image.c"
 image_info != (ImageInfo *) 
# 3133 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3133 "MagickCore/image.c"
...
# 3133 "MagickCore/image.c"
 "image_info != (ImageInfo *) NULL"
# 3133 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3133, __extension__ __PRETTY_FUNCTION__); }))
# 3133 "MagickCore/image.c"
                                         ;
  
# 3134 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3134 "MagickCore/image.c"
 image_info->signature == 0xabacadabUL
# 3134 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3134 "MagickCore/image.c"
...
# 3134 "MagickCore/image.c"
 "image_info->signature == MagickCoreSignature"
# 3134 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3134, __extension__ __PRETTY_FUNCTION__); }))
# 3134 "MagickCore/image.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 3136,"%s",
      image_info->filename);
  image_info->custom_stream=(CustomStreamInfo *) custom_stream;
}
# 3165 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) void SetImageInfoFile(ImageInfo *image_info,FILE *file)
{
  
# 3167 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3167 "MagickCore/image.c"
 image_info != (ImageInfo *) 
# 3167 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3167 "MagickCore/image.c"
...
# 3167 "MagickCore/image.c"
 "image_info != (ImageInfo *) NULL"
# 3167 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3167, __extension__ __PRETTY_FUNCTION__); }))
# 3167 "MagickCore/image.c"
                                         ;
  
# 3168 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3168 "MagickCore/image.c"
 image_info->signature == 0xabacadabUL
# 3168 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3168 "MagickCore/image.c"
...
# 3168 "MagickCore/image.c"
 "image_info->signature == MagickCoreSignature"
# 3168 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3168, __extension__ __PRETTY_FUNCTION__); }))
# 3168 "MagickCore/image.c"
                                                     ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 3170,"%s",
      image_info->filename);
  image_info->file=file;
}
# 3205 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageMask(Image *image,const PixelMask type,
...
# 3221 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3221 "MagickCore/image.c"
 image != (Image *) 
# 3221 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3221 "MagickCore/image.c"
...
# 3221 "MagickCore/image.c"
 "image != (Image *) NULL"
# 3221 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3221, __extension__ __PRETTY_FUNCTION__); }))
# 3221 "MagickCore/image.c"
                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 3223,"...");
  
# 3224 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3224 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 3224 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3224 "MagickCore/image.c"
...
# 3224 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 3224 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3224, __extension__ __PRETTY_FUNCTION__); }))
# 3224 "MagickCore/image.c"
                                                ;
  if (mask == (const Image *) 
# 3225 "MagickCore/image.c" 3 4
                             ((void *)0)
# 3225 "MagickCore/image.c"
                                 )
    {
      switch (type)
      {
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if ((p == (const Quantum *) 
# 3293 "MagickCore/image.c" 3 4
                               ((void *)0)
# 3293 "MagickCore/image.c"
                                   ) || (q == (Quantum *) 
# 3293 "MagickCore/image.c" 3 4
                                                          ((void *)0)
# 3293 "MagickCore/image.c"
...
# 3366 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageRegionMask(Image *image,
...
# 3381 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3381 "MagickCore/image.c"
 image != (Image *) 
# 3381 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3381 "MagickCore/image.c"
...
# 3381 "MagickCore/image.c"
 "image != (Image *) NULL"
# 3381 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3381, __extension__ __PRETTY_FUNCTION__); }))
# 3381 "MagickCore/image.c"
                                ;
  
# 3382 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3382 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 3382 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3382 "MagickCore/image.c"
...
# 3382 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 3382 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3382, __extension__ __PRETTY_FUNCTION__); }))
# 3382 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 3384,"...");
  if (region == (const RectangleInfo *) 
# 3385 "MagickCore/image.c" 3 4
                                       ((void *)0)
# 3385 "MagickCore/image.c"
                                           )
    {
      switch (type)
      {
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 3448 "MagickCore/image.c" 3 4
                        ((void *)0)
# 3448 "MagickCore/image.c"
                            )
      {
        status=MagickFalse;
        continue;
...
# 3519 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) VirtualPixelMethod SetImageVirtualPixelMethod(Image *image,
  const VirtualPixelMethod virtual_pixel_method,ExceptionInfo *exception)
{
  
# 3522 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3522 "MagickCore/image.c"
 image != (const Image *) 
# 3522 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3522 "MagickCore/image.c"
...
# 3522 "MagickCore/image.c"
 "image != (const Image *) NULL"
# 3522 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3522, __extension__ __PRETTY_FUNCTION__); }))
# 3522 "MagickCore/image.c"
                                      ;
  
# 3523 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3523 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 3523 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3523 "MagickCore/image.c"
...
# 3523 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 3523 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3523, __extension__ __PRETTY_FUNCTION__); }))
# 3523 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 3525,"%s",image->filename);
  return(SetPixelCacheVirtualMethod(image,virtual_pixel_method,exception));
}
# 3564 "MagickCore/image.c"
...
# 3592 "MagickCore/image.c" 3 4
                                   ((void *)0)
# 3592 "MagickCore/image.c"
                                       )
    return(0);
  right_image=images;
  ...
  for (y=0; y < (ssize_t) smush_image->rows; y++)
  {
    for (x=(ssize_t) left_image->columns-1; x > 0; x--)
    {
      ...
      if ((p == (const Quantum *) 
# 3610 "MagickCore/image.c" 3 4
                                 ((void *)0)
# 3610 "MagickCore/image.c"
                                     ) ||
          (GetPixelAlpha(left_image,p) != ((Quantum) 0)) ||
    ...
    for (x=0; x < (ssize_t) right_image->columns; x++)
    {
      p=GetCacheViewVirtualPixels(right_view,x,right_geometry.y+y,1,1,
        exception);
      if ((p == (const Quantum *) 
# 3620 "MagickCore/image.c" 3 4
                                 ((void *)0)
# 3620 "MagickCore/image.c"
                                     ) ||
          (GetPixelAlpha(right_image,p) != ((Quantum) 0)) ||
          ((x+i) >= (ssize_t) gap))
        break;
    }
    if ((x+i) < (ssize_t) gap)
  ...
  const ssize_t offset,ExceptionInfo *exception)
{
  ...
  if (images->previous == (Image *) 
# 3663 "MagickCore/image.c" 3 4
                                   ((void *)0)
# 3663 "MagickCore/image.c"
                                       )
    return(0);
  bottom_image=images;
  ...
  for (x=0; x < (ssize_t) smush_image->columns; x++)
  {
    for (y=(ssize_t) top_image->rows-1; y > 0; y--)
    {
      ...
      if ((p == (const Quantum *) 
# 3681 "MagickCore/image.c" 3 4
                                 ((void *)0)
# 3681 "MagickCore/image.c"
                                     ) ||
          (GetPixelAlpha(top_image,p) != ((Quantum) 0)) ||
    ...
    for (y=0; y < (ssize_t) bottom_image->rows; y++)
    {
      p=GetCacheViewVirtualPixels(bottom_view,bottom_geometry.x+x,y,1,1,
        exception);
      if ((p == (const Quantum *) 
# 3691 "MagickCore/image.c" 3 4
                                 ((void *)0)
# 3691 "MagickCore/image.c"
                                     ) ||
          (GetPixelAlpha(bottom_image,p) != ((Quantum) 0)) ||
          ((y+i) >= (ssize_t) gap))
        break;
    }
    if ((y+i) < (ssize_t) gap)
...
__attribute__ ((visibility ("default"))) Image *SmushImages(const Image *images,
...
# 3745 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3745 "MagickCore/image.c"
 images != (Image *) 
# 3745 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3745 "MagickCore/image.c"
...
# 3745 "MagickCore/image.c"
 "images != (Image *) NULL"
# 3745 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3745, __extension__ __PRETTY_FUNCTION__); }))
# 3745 "MagickCore/image.c"
                                 ;
  
# 3746 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3746 "MagickCore/image.c"
 images->signature == 0xabacadabUL
# 3746 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3746 "MagickCore/image.c"
...
# 3746 "MagickCore/image.c"
 "images->signature == MagickCoreSignature"
# 3746 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3746, __extension__ __PRETTY_FUNCTION__); }))
# 3746 "MagickCore/image.c"
                                                 ;
  
# 3747 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3747 "MagickCore/image.c"
 exception != (ExceptionInfo *) 
# 3747 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3747 "MagickCore/image.c"
...
# 3747 "MagickCore/image.c"
 "exception != (ExceptionInfo *) NULL"
# 3747 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3747, __extension__ __PRETTY_FUNCTION__); }))
# 3747 "MagickCore/image.c"
                                            ;
  
# 3748 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3748 "MagickCore/image.c"
 exception->signature == 0xabacadabUL
# 3748 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3748 "MagickCore/image.c"
...
# 3748 "MagickCore/image.c"
 "exception->signature == MagickCoreSignature"
# 3748 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3748, __extension__ __PRETTY_FUNCTION__); }))
# 3748 "MagickCore/image.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 3750,"%s",images->filename);
  image=images;
  ...
  for ( ; next != (Image *) 
# 3757 "MagickCore/image.c" 3 4
                           ((void *)0)
# 3757 "MagickCore/image.c"
                               ; next=GetNextImageInList(next))
  {
    if (next->alpha_trait != UndefinedPixelTrait)
      alpha_trait=BlendPixelTrait;
    ...
    if (stack != MagickFalse)
      {
        if (next->columns > width)
          width=next->columns;
        height+=next->rows;
        if (next->previous != (Image *) 
# 3767 "MagickCore/image.c" 3 4
                                       ((void *)0)
# 3767 "MagickCore/image.c"
                                           )
          height=(size_t) ((((ssize_t) height+offset) > (0U)) ? ((ssize_t) height+offset) : (0U));
        continue;
      }
    width+=next->columns;
    if (next->previous != (Image *) 
# 3772 "MagickCore/image.c" 3 4
                                   ((void *)0)
# 3772 "MagickCore/image.c"
                                       )
      width=(size_t) ((((ssize_t) width+offset) > (0U)) ? ((ssize_t) width+offset) : (0U));
    if (next->rows > height)
      height=next->rows;
  }
  ...
  if (smush_image == (Image *) 
# 3781 "MagickCore/image.c" 3 4
                              ((void *)0)
# 3781 "MagickCore/image.c"
                                  )
    return((Image *) 
# 3782 "MagickCore/image.c" 3 4
                    ((void *)0)
# 3782 "MagickCore/image.c"
                        );
  if (SetImageStorageClass(smush_image,DirectClass,exception) == MagickFalse)
    {
      smush_image=DestroyImage(smush_image);
      return((Image *) 
# 3786 "MagickCore/image.c" 3 4
                      ((void *)0)
# 3786 "MagickCore/image.c"
                          );
    }
  ...
  for (n=0; n < (MagickOffsetType) number_images; n++)
  {
    ...
    status=CompositeImage(smush_image,image,OverCompositeOp,MagickTrue,x_offset,
      y_offset,exception);
    proceed=SetImageProgress(image,"Smush/Image",n,number_images);
    if (proceed == MagickFalse)
      break;
    if (stack == MagickFalse)
      {
...
# 3857 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType StripImage(Image *image,
...
# 3864 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3864 "MagickCore/image.c"
 image != (Image *) 
# 3864 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3864 "MagickCore/image.c"
...
# 3864 "MagickCore/image.c"
 "image != (Image *) NULL"
# 3864 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3864, __extension__ __PRETTY_FUNCTION__); }))
# 3864 "MagickCore/image.c"
                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 3866,"...");
  DestroyImageProfiles(image);
...
__attribute__ ((visibility ("default"))) MagickBooleanType SyncImage(Image *image,ExceptionInfo *exception)
{
  CacheView
    *image_view;
...
# 3925 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3925 "MagickCore/image.c"
 image != (Image *) 
# 3925 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3925 "MagickCore/image.c"
...
# 3925 "MagickCore/image.c"
 "image != (Image *) NULL"
# 3925 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3925, __extension__ __PRETTY_FUNCTION__); }))
# 3925 "MagickCore/image.c"
                                ;
  
# 3926 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3926 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 3926 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3926 "MagickCore/image.c"
...
# 3926 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 3926 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3926, __extension__ __PRETTY_FUNCTION__); }))
# 3926 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 3928,"...");
  if (image->ping != MagickFalse)
    return(MagickTrue);
  if (image->storage_class != PseudoClass)
    return(MagickFalse);
  
# 3933 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 3933 "MagickCore/image.c"
...
# 3933 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 3933, __extension__ __PRETTY_FUNCTION__); }))
# 3933 "MagickCore/image.c"
                                              ;
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 3956 "MagickCore/image.c" 3 4
                        ((void *)0)
# 3956 "MagickCore/image.c"
                            )
      {
        status=MagickFalse;
        continue;
  ...
  if ((image->ping == MagickFalse) && (range_exception != MagickFalse))
    (void) ThrowMagickException(exception,"MagickCore/image.c",__func__,(unsigned long) 3973,
      CorruptImageWarning,"InvalidColormapIndex","`%s'",image->filename);
  return(status);
}
# 4015 "MagickCore/image.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SyncImagesSettings(ImageInfo *image_info,
...
# 4021 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 4021 "MagickCore/image.c"
 image_info != (const ImageInfo *) 
# 4021 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4021 "MagickCore/image.c"
...
# 4021 "MagickCore/image.c"
 "image_info != (const ImageInfo *) NULL"
# 4021 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 4021, __extension__ __PRETTY_FUNCTION__); }))
# 4021 "MagickCore/image.c"
                                               ;
  
# 4022 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 4022 "MagickCore/image.c"
 image_info->signature == 0xabacadabUL
# 4022 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4022 "MagickCore/image.c"
...
# 4022 "MagickCore/image.c"
 "image_info->signature == MagickCoreSignature"
# 4022 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 4022, __extension__ __PRETTY_FUNCTION__); }))
# 4022 "MagickCore/image.c"
                                                     ;
  
# 4023 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 4023 "MagickCore/image.c"
 images != (Image *) 
# 4023 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4023 "MagickCore/image.c"
...
# 4023 "MagickCore/image.c"
 "images != (Image *) NULL"
# 4023 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 4023, __extension__ __PRETTY_FUNCTION__); }))
# 4023 "MagickCore/image.c"
                                 ;
  
# 4024 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 4024 "MagickCore/image.c"
 images->signature == 0xabacadabUL
# 4024 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4024 "MagickCore/image.c"
...
# 4024 "MagickCore/image.c"
 "images->signature == MagickCoreSignature"
# 4024 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 4024, __extension__ __PRETTY_FUNCTION__); }))
# 4024 "MagickCore/image.c"
                                                 ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 4026,"%s",images->filename);
  image=images;
  for ( ; image != (Image *) 
# 4028 "MagickCore/image.c" 3 4
                            ((void *)0)
# 4028 "MagickCore/image.c"
                                ; image=GetNextImageInList(image))
    (void) SyncImageSettings(image_info,image,exception);
...
__attribute__ ((visibility ("default"))) MagickBooleanType SyncImageSettings(const ImageInfo *image_info,
...
# 4052 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 4052 "MagickCore/image.c"
 image_info != (const ImageInfo *) 
# 4052 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4052 "MagickCore/image.c"
...
# 4052 "MagickCore/image.c"
 "image_info != (const ImageInfo *) NULL"
# 4052 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 4052, __extension__ __PRETTY_FUNCTION__); }))
# 4052 "MagickCore/image.c"
                                               ;
  
# 4053 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 4053 "MagickCore/image.c"
 image_info->signature == 0xabacadabUL
# 4053 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4053 "MagickCore/image.c"
...
# 4053 "MagickCore/image.c"
 "image_info->signature == MagickCoreSignature"
# 4053 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 4053, __extension__ __PRETTY_FUNCTION__); }))
# 4053 "MagickCore/image.c"
                                                     ;
  
# 4054 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 4054 "MagickCore/image.c"
 image != (Image *) 
# 4054 "MagickCore/image.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 4054 "MagickCore/image.c"
...
# 4054 "MagickCore/image.c"
 "image != (Image *) NULL"
# 4054 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 4054, __extension__ __PRETTY_FUNCTION__); }))
# 4054 "MagickCore/image.c"
                                ;
  
# 4055 "MagickCore/image.c" 3 4
 ((void) sizeof ((
# 4055 "MagickCore/image.c"
 image->signature == 0xabacadabUL
# 4055 "MagickCore/image.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 4055 "MagickCore/image.c"
...
# 4055 "MagickCore/image.c"
 "image->signature == MagickCoreSignature"
# 4055 "MagickCore/image.c" 3 4
 , "MagickCore/image.c", 4055, __extension__ __PRETTY_FUNCTION__); }))
# 4055 "MagickCore/image.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/image.c",__func__,(unsigned long) 4057,"%s",image->filename);
  option=GetImageOption(image_info,"background");
  if (option != (const char *) 
# 4059 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4059 "MagickCore/image.c"
                                  )
    (void) QueryColorCompliance(option,AllCompliance,&image->background_color,
      exception);
  option=GetImageOption(image_info,"black-point-compensation");
  if (option != (const char *) 
# 4063 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4063 "MagickCore/image.c"
                                  )
  ...
  if (option != (const char *) 
# 4067 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4067 "MagickCore/image.c"
                                  )
    {
      flags=ParseGeometry(option,&geometry_info);
      if ((flags & RhoValue) != 0)
  ...
  if (option != (const char *) 
# 4077 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4077 "MagickCore/image.c"
                                  )
  ...
  if (option != (const char *) 
# 4082 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4082 "MagickCore/image.c"
                                  )
  ...
  if (option != (const char *) 
# 4087 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4087 "MagickCore/image.c"
                                  )
  ...
  if (option != (const char *) 
# 4091 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4091 "MagickCore/image.c"
                                  )
    image->debug=(MagickBooleanType) ParseCommandOption(MagickBooleanOptions,
      MagickFalse,option);
  option=GetImageOption(image_info,"density");
  if (option != (const char *) 
# 4095 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4095 "MagickCore/image.c"
                                  )
    {
      flags=ParseGeometry(option,&geometry_info);
      if ((flags & RhoValue) != 0)
...
# 4123 "MagickCore/image.c"
  ...
  if (option != (const char *) 
# 4133 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4133 "MagickCore/image.c"
                                  )
  ...
  if (option != (const char *) 
# 4137 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4137 "MagickCore/image.c"
                                  )
...
# 4156 "MagickCore/image.c"
  ...
  if (option != (const char *) 
# 4160 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4160 "MagickCore/image.c"
                                  )
    {
      char
        *geometry;
  ...
  if (option != (const char *) 
# 4170 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4170 "MagickCore/image.c"
                                  )
    image->quality=StringToUnsignedLong(option);
  option=GetImageOption(image_info,"red-primary");
  if (option != (const char *) 
# 4173 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4173 "MagickCore/image.c"
                                  )
    {
      flags=ParseGeometry(option,&geometry_info);
      if ((flags & RhoValue) != 0)
...
# 4206 "MagickCore/image.c"
  ...
  if (option != (const char *) 
# 4211 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4211 "MagickCore/image.c"
                                  )
  ...
  if (units != UndefinedResolution)
    {
      ...
      option=GetImageOption(image_info,"density");
      if (option != (const char *) 
# 4244 "MagickCore/image.c" 3 4
                                  ((void *)0)
# 4244 "MagickCore/image.c"
                                      )
        {
          flags=ParseGeometry(option,&geometry_info);
          if ((flags & RhoValue) != 0)
  ...
  if (option != (const char *) 
# 4255 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4255 "MagickCore/image.c"
                                  )
  ...
  if (option != (const char *) 
# 4260 "MagickCore/image.c" 3 4
                              ((void *)0)
# 4260 "MagickCore/image.c"
                                  )
    {
      flags=ParseGeometry(option,&geometry_info);
      if ((flags & RhoValue) != 0)
  ...
  if (image->image_info != (ImageInfo *) 
# 4275 "MagickCore/image.c" 3 4
                                        ((void *)0)
# 4275 "MagickCore/image.c"
                                            )
    image->image_info=DestroyImageInfo(image->image_info);
