# 0 "MagickCore/exception.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/exception.c"
# 43 "MagickCore/exception.c"
...
# 57 "MagickCore/exception.c" 2
# 70 "MagickCore/exception.c"
static void
...
static SemaphoreInfo
  *exception_semaphore = (SemaphoreInfo *) 
# 96 "MagickCore/exception.c" 3 4
                                          ((void *)0)
# 96 "MagickCore/exception.c"
                                              ;
# 116 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) ExceptionInfo *AcquireExceptionInfo(void)
{
  ExceptionInfo
    *exception;
...
static void *DestroyExceptionElement(void *exception)
{
  ...
  if (p->reason != (char *) 
# 157 "MagickCore/exception.c" 3 4
                           ((void *)0)
# 157 "MagickCore/exception.c"
                               )
    p->reason=DestroyString(p->reason);
  if (p->description != (char *) 
# 159 "MagickCore/exception.c" 3 4
                                ((void *)0)
# 159 "MagickCore/exception.c"
                                    )
    p->description=DestroyString(p->description);
  p=(ExceptionInfo *) RelinquishMagickMemory(p);
  return((void *) 
# 162 "MagickCore/exception.c" 3 4
                 ((void *)0)
# 162 "MagickCore/exception.c"
                     );
}

__attribute__ ((visibility ("default"))) void ClearMagickException(ExceptionInfo *exception)
{
  
# 167 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 167 "MagickCore/exception.c"
...
# 167 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 167, __extension__ __PRETTY_FUNCTION__); }))
# 167 "MagickCore/exception.c"
                                            ;
  
# 168 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 168 "MagickCore/exception.c"
...
# 168 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 168, __extension__ __PRETTY_FUNCTION__); }))
# 168 "MagickCore/exception.c"
                                                    ;
  if (exception->exceptions == (void *) 
# 169 "MagickCore/exception.c" 3 4
                                       ((void *)0)
# 169 "MagickCore/exception.c"
                                           )
    return;
...
# 175 "MagickCore/exception.c" 3 4
                            ((void *)0)
# 175 "MagickCore/exception.c"
                                ;
  exception->description=(char *) 
# 176 "MagickCore/exception.c" 3 4
                                 ((void *)0)
# 176 "MagickCore/exception.c"
                                     ;
  UnlockSemaphoreInfo(exception->semaphore);
  
# 178 "MagickCore/exception.c" 3 4
 (*__errno_location ())
# 178 "MagickCore/exception.c"
      =0;
}
# 204 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) void CatchException(ExceptionInfo *exception)
{
  LinkedListInfo
    *exceptions;
...
# 212 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 212 "MagickCore/exception.c"
 exception != (ExceptionInfo *) 
# 212 "MagickCore/exception.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 212 "MagickCore/exception.c"
...
# 212 "MagickCore/exception.c"
 "exception != (ExceptionInfo *) NULL"
# 212 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 212, __extension__ __PRETTY_FUNCTION__); }))
# 212 "MagickCore/exception.c"
                                            ;
  
# 213 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 213 "MagickCore/exception.c"
 exception->signature == 0xabacadabUL
# 213 "MagickCore/exception.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 213 "MagickCore/exception.c"
...
# 213 "MagickCore/exception.c"
 "exception->signature == MagickCoreSignature"
# 213 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 213, __extension__ __PRETTY_FUNCTION__); }))
# 213 "MagickCore/exception.c"
                                                    ;
  if (exception->exceptions == (void *) 
# 214 "MagickCore/exception.c" 3 4
                                        ((void *)0)
# 214 "MagickCore/exception.c"
                                            )
    return;
  LockSemaphoreInfo(exception->semaphore);
  ...
  while (p != (const ExceptionInfo *) 
# 220 "MagickCore/exception.c" 3 4
                                     ((void *)0)
# 220 "MagickCore/exception.c"
                                         )
  {
...
# 256 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) ExceptionInfo *CloneExceptionInfo(ExceptionInfo *exception)
{
  ExceptionInfo
    *clone_exception;
...
# 296 "MagickCore/exception.c"
static void DefaultErrorHandler(const ExceptionType magick_unused_severity __attribute__((unused)),
  const char *reason,const char *description)
{
  ;

  if (reason == (char *) 
# 301 "MagickCore/exception.c" 3 4
                        ((void *)0)
# 301 "MagickCore/exception.c"
                            )
    return;
  (void) FormatLocaleFile(
# 303 "MagickCore/exception.c" 3 4
                         stderr
# 303 "MagickCore/exception.c"
                               ,"%s: %s",GetClientName(),reason);
  if (description != (char *) 
# 304 "MagickCore/exception.c" 3 4
                             ((void *)0)
# 304 "MagickCore/exception.c"
                                 )
    (void) FormatLocaleFile(
# 305 "MagickCore/exception.c" 3 4
                           stderr
# 305 "MagickCore/exception.c"
                                 ," (%s)",description);
  (void) FormatLocaleFile(
# 306 "MagickCore/exception.c" 3 4
                         stderr
# 306 "MagickCore/exception.c"
                               ,".\n");
  (void) fflush(
# 307 "MagickCore/exception.c" 3 4
               stderr
# 307 "MagickCore/exception.c"
                     );
}
# 338 "MagickCore/exception.c"
static void DefaultFatalErrorHandler(const ExceptionType severity,
  const char *reason,const char *description)
{
  (void) FormatLocaleFile(
# 341 "MagickCore/exception.c" 3 4
                         stderr
# 341 "MagickCore/exception.c"
                               ,"%s:",GetClientName());
  if (reason != (char *) 
# 342 "MagickCore/exception.c" 3 4
                        ((void *)0)
# 342 "MagickCore/exception.c"
                            )
    (void) FormatLocaleFile(
# 343 "MagickCore/exception.c" 3 4
                           stderr
# 343 "MagickCore/exception.c"
                                 ," %s",reason);
  if (description != (char *) 
# 344 "MagickCore/exception.c" 3 4
                             ((void *)0)
# 344 "MagickCore/exception.c"
                                 )
    (void) FormatLocaleFile(
# 345 "MagickCore/exception.c" 3 4
                           stderr
# 345 "MagickCore/exception.c"
                                 ," (%s)",description);
  (void) FormatLocaleFile(
# 346 "MagickCore/exception.c" 3 4
                         stderr
# 346 "MagickCore/exception.c"
                               ,".\n");
  (void) fflush(
# 347 "MagickCore/exception.c" 3 4
               stderr
# 347 "MagickCore/exception.c"
                     );
  MagickCoreTerminus();
  exit((int) (severity-FatalErrorException)+1);
}
# 380 "MagickCore/exception.c"
static void DefaultWarningHandler(const ExceptionType magick_unused_severity __attribute__((unused)),
  const char *reason,const char *description)
{
  ;

  if (reason == (char *) 
# 385 "MagickCore/exception.c" 3 4
                        ((void *)0)
# 385 "MagickCore/exception.c"
                            )
    return;
  (void) FormatLocaleFile(
# 387 "MagickCore/exception.c" 3 4
                         stderr
# 387 "MagickCore/exception.c"
                               ,"%s: %s",GetClientName(),reason);
  if (description != (char *) 
# 388 "MagickCore/exception.c" 3 4
                             ((void *)0)
# 388 "MagickCore/exception.c"
                                 )
    (void) FormatLocaleFile(
# 389 "MagickCore/exception.c" 3 4
                           stderr
# 389 "MagickCore/exception.c"
                                 ," (%s)",description);
  (void) FormatLocaleFile(
# 390 "MagickCore/exception.c" 3 4
                         stderr
# 390 "MagickCore/exception.c"
                               ,".\n");
  (void) fflush(
# 391 "MagickCore/exception.c" 3 4
               stderr
# 391 "MagickCore/exception.c"
                     );
}
# 416 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) ExceptionInfo *DestroyExceptionInfo(ExceptionInfo *exception)
{
  MagickBooleanType
    relinquish;

  
# 421 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 421 "MagickCore/exception.c"
 exception != (ExceptionInfo *) 
# 421 "MagickCore/exception.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 421 "MagickCore/exception.c"
...
# 421 "MagickCore/exception.c"
 "exception != (ExceptionInfo *) NULL"
# 421 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 421, __extension__ __PRETTY_FUNCTION__); }))
# 421 "MagickCore/exception.c"
                                            ;
  
# 422 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 422 "MagickCore/exception.c"
 exception->signature == 0xabacadabUL
# 422 "MagickCore/exception.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 422 "MagickCore/exception.c"
...
# 422 "MagickCore/exception.c"
 "exception->signature == MagickCoreSignature"
# 422 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 422, __extension__ __PRETTY_FUNCTION__); }))
# 422 "MagickCore/exception.c"
                                                    ;
  if (exception->semaphore == (SemaphoreInfo *) 
# 423 "MagickCore/exception.c" 3 4
                                               ((void *)0)
# 423 "MagickCore/exception.c"
                                                   )
  ...
  if (exception->relinquish != MagickFalse)
    {
      exception->signature=(~0xabacadabUL);
      if (exception->exceptions != (void *) 
# 430 "MagickCore/exception.c" 3 4
                                           ((void *)0)
# 430 "MagickCore/exception.c"
                                               )
    ...
    if (exception->exceptions != (void *) 
# 435 "MagickCore/exception.c" 3 4
                                         ((void *)0)
# 435 "MagickCore/exception.c"
                                             )
      ClearLinkedList((LinkedListInfo *) exception->exceptions,
        DestroyExceptionElement);
...
# 466 "MagickCore/exception.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType ExceptionComponentGenesis(void)
{
  if (exception_semaphore == (SemaphoreInfo *) 
# 468 "MagickCore/exception.c" 3 4
                                              ((void *)0)
# 468 "MagickCore/exception.c"
                                                  )
    exception_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 491 "MagickCore/exception.c"
__attribute__ ((visibility ("hidden"))) void ExceptionComponentTerminus(void)
{
  if (exception_semaphore == (SemaphoreInfo *) 
# 493 "MagickCore/exception.c" 3 4
                                              ((void *)0)
# 493 "MagickCore/exception.c"
                                                  )
...
# 523 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) char *GetExceptionMessage(const int error)
{
  char
    exception[4096];
...
__attribute__ ((visibility ("default"))) const char *GetLocaleExceptionMessage(const ExceptionType severity,
  const char *tag)
{
  char
    message[4096];
...
# 650 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 650 "MagickCore/exception.c"
 tag != (const char *) 
# 650 "MagickCore/exception.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 650 "MagickCore/exception.c"
...
# 650 "MagickCore/exception.c"
 "tag != (const char *) NULL"
# 650 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 650, __extension__ __PRETTY_FUNCTION__); }))
# 650 "MagickCore/exception.c"
                                   ;
  (void) FormatLocaleString(message,4096,"Exception/%s%s",
    ExceptionSeverityToTag(severity),tag);
  locale_message=GetLocaleMessage(message);
  if (locale_message == (const char *) 
# 654 "MagickCore/exception.c" 3 4
                                      ((void *)0)
# 654 "MagickCore/exception.c"
                                          )
    return(tag);
...
# 685 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) void InheritException(ExceptionInfo *exception,
...
# 691 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 691 "MagickCore/exception.c"
 exception != (ExceptionInfo *) 
# 691 "MagickCore/exception.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 691 "MagickCore/exception.c"
...
# 691 "MagickCore/exception.c"
 "exception != (ExceptionInfo *) NULL"
# 691 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 691, __extension__ __PRETTY_FUNCTION__); }))
# 691 "MagickCore/exception.c"
                                            ;
  
# 692 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 692 "MagickCore/exception.c"
 exception->signature == 0xabacadabUL
# 692 "MagickCore/exception.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 692 "MagickCore/exception.c"
...
# 692 "MagickCore/exception.c"
 "exception->signature == MagickCoreSignature"
# 692 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 692, __extension__ __PRETTY_FUNCTION__); }))
# 692 "MagickCore/exception.c"
                                                    ;
  
# 693 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 693 "MagickCore/exception.c"
 relative != (ExceptionInfo *) 
# 693 "MagickCore/exception.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 693 "MagickCore/exception.c"
 relative != (ExceptionInfo *) 
# 693 "MagickCore/exception.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 693 "MagickCore/exception.c"
 "relative != (ExceptionInfo *) NULL"
# 693 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 693, __extension__ __PRETTY_FUNCTION__); }))
# 693 "MagickCore/exception.c"
                                           ;
  
# 694 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 694 "MagickCore/exception.c"
 relative->signature == 0xabacadabUL
# 694 "MagickCore/exception.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 694 "MagickCore/exception.c"
 relative->signature == 0xabacadabUL
...
# 694 "MagickCore/exception.c"
 "relative->signature == MagickCoreSignature"
# 694 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 694, __extension__ __PRETTY_FUNCTION__); }))
# 694 "MagickCore/exception.c"
                                                   ;
  
# 695 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 695 "MagickCore/exception.c"
 exception != relative
# 695 "MagickCore/exception.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 695 "MagickCore/exception.c"
...
# 695 "MagickCore/exception.c"
 "exception != relative"
# 695 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 695, __extension__ __PRETTY_FUNCTION__); }))
# 695 "MagickCore/exception.c"
                              ;
  if (relative->exceptions == (void *) 
# 696 "MagickCore/exception.c" 3 4
                                      ((void *)0)
# 696 "MagickCore/exception.c"
                                          )
    return;
  ...
  p=(const ExceptionInfo *) GetNextValueInLinkedList((LinkedListInfo *)
    relative->exceptions);
  while (p != (const ExceptionInfo *) 
# 702 "MagickCore/exception.c" 3 4
                                     ((void *)0)
# 702 "MagickCore/exception.c"
                                         )
  {
...
# 733 "MagickCore/exception.c"
__attribute__ ((visibility ("hidden"))) void InitializeExceptionInfo(ExceptionInfo *exception)
{
  
# 735 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 735 "MagickCore/exception.c"
 exception != (ExceptionInfo *) 
# 735 "MagickCore/exception.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 735 "MagickCore/exception.c"
...
# 735 "MagickCore/exception.c"
 "exception != (ExceptionInfo *) NULL"
# 735 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 735, __extension__ __PRETTY_FUNCTION__); }))
# 735 "MagickCore/exception.c"
                                            ;
...
# 771 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) void MagickError(const ExceptionType error,const char *reason,
  const char *description)
{
  if (error_handler != (ErrorHandler) 
# 774 "MagickCore/exception.c" 3 4
                                     ((void *)0)
# 774 "MagickCore/exception.c"
                                         )
    (*error_handler)(error,reason,description);
}
# 807 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) void MagickFatalError(const ExceptionType error,const char *reason,
  const char *description)
{
  if (fatal_error_handler != (FatalErrorHandler) 
# 810 "MagickCore/exception.c" 3 4
                                                ((void *)0)
# 810 "MagickCore/exception.c"
                                                    )
    (*fatal_error_handler)(error,reason,description);
  MagickCoreTerminus();
  exit(1);
}
# 843 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) void MagickWarning(const ExceptionType warning,const char *reason,
  const char *description)
{
  if (warning_handler != (WarningHandler) 
# 846 "MagickCore/exception.c" 3 4
                                         ((void *)0)
# 846 "MagickCore/exception.c"
                                             )
    (*warning_handler)(warning,reason,description);
}
# 873 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) ErrorHandler SetErrorHandler(ErrorHandler handler)
{
  ErrorHandler
    previous_handler;

  if (exception_semaphore == (SemaphoreInfo *) 
# 878 "MagickCore/exception.c" 3 4
                                              ((void *)0)
# 878 "MagickCore/exception.c"
                                                  )
    ActivateSemaphoreInfo(&exception_semaphore);
  LockSemaphoreInfo(exception_semaphore);
...
# 910 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) FatalErrorHandler SetFatalErrorHandler(FatalErrorHandler handler)
{
  FatalErrorHandler
    previous_handler;

  if (exception_semaphore == (SemaphoreInfo *) 
# 915 "MagickCore/exception.c" 3 4
                                              ((void *)0)
# 915 "MagickCore/exception.c"
                                                  )
    ActivateSemaphoreInfo(&exception_semaphore);
  LockSemaphoreInfo(exception_semaphore);
...
# 947 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) WarningHandler SetWarningHandler(WarningHandler handler)
{
  WarningHandler
    previous_handler;

  if (exception_semaphore == (SemaphoreInfo *) 
# 952 "MagickCore/exception.c" 3 4
                                              ((void *)0)
# 952 "MagickCore/exception.c"
                                                  )
    ActivateSemaphoreInfo(&exception_semaphore);
  LockSemaphoreInfo(exception_semaphore);
...
# 992 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ThrowException(ExceptionInfo *exception,
...
# 1001 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 1001 "MagickCore/exception.c"
 exception != (ExceptionInfo *) 
# 1001 "MagickCore/exception.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1001 "MagickCore/exception.c"
...
# 1001 "MagickCore/exception.c"
 "exception != (ExceptionInfo *) NULL"
# 1001 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 1001, __extension__ __PRETTY_FUNCTION__); }))
# 1001 "MagickCore/exception.c"
                                            ;
  
# 1002 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 1002 "MagickCore/exception.c"
 exception->signature == 0xabacadabUL
# 1002 "MagickCore/exception.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1002 "MagickCore/exception.c"
...
# 1002 "MagickCore/exception.c"
 "exception->signature == MagickCoreSignature"
# 1002 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 1002, __extension__ __PRETTY_FUNCTION__); }))
# 1002 "MagickCore/exception.c"
                                                    ;
  LockSemaphoreInfo(exception->semaphore);
  exceptions=(LinkedListInfo *) exception->exceptions;
  if (GetNumberOfElementsInLinkedList(exceptions) > 64)
    {
  ...
  p=(ExceptionInfo *) GetLastValueInLinkedList(exceptions);
  if ((p != (ExceptionInfo *) 
# 1020 "MagickCore/exception.c" 3 4
                             ((void *)0)
# 1020 "MagickCore/exception.c"
                                 ) && (p->severity == severity) &&
  ...
  if (p == (ExceptionInfo *) 
# 1028 "MagickCore/exception.c" 3 4
                            ((void *)0)
# 1028 "MagickCore/exception.c"
                                )
    {
      UnlockSemaphoreInfo(exception->semaphore);
      { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 1031 "MagickCore/exception.c" 3 4
     (*__errno_location ())
# 1031 "MagickCore/exception.c"
     ); (void) ThrowMagickException(fatal_exception,"MagickCore/exception.c",__func__,(unsigned long) 1031,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
    }
  (void) memset(p,0,sizeof(*p));
  p->severity=severity;
  if (reason != (const char *) 
# 1035 "MagickCore/exception.c" 3 4
                              ((void *)0)
# 1035 "MagickCore/exception.c"
                                  )
    p->reason=ConstantString(reason);
  if (description != (const char *) 
# 1037 "MagickCore/exception.c" 3 4
                                   ((void *)0)
# 1037 "MagickCore/exception.c"
                                       )
  ...
  UnlockSemaphoreInfo(exception->semaphore);
  if (GetNumberOfElementsInLinkedList(exceptions) == 64)
    (void) ThrowMagickException(exception,"MagickCore/exception.c",__func__,(unsigned long) 1049,
      ResourceLimitWarning,"TooManyExceptions",
      "(exception processing is suspended)");
  return(MagickTrue);
}
# 1094 "MagickCore/exception.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ThrowMagickExceptionList(
...
# 1117 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 1117 "MagickCore/exception.c"
 exception != (ExceptionInfo *) 
# 1117 "MagickCore/exception.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1117 "MagickCore/exception.c"
...
# 1117 "MagickCore/exception.c"
 "exception != (ExceptionInfo *) NULL"
# 1117 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 1117, __extension__ __PRETTY_FUNCTION__); }))
# 1117 "MagickCore/exception.c"
                                            ;
  
# 1118 "MagickCore/exception.c" 3 4
 ((void) sizeof ((
# 1118 "MagickCore/exception.c"
 exception->signature == 0xabacadabUL
# 1118 "MagickCore/exception.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1118 "MagickCore/exception.c"
...
# 1118 "MagickCore/exception.c"
 "exception->signature == MagickCoreSignature"
# 1118 "MagickCore/exception.c" 3 4
 , "MagickCore/exception.c", 1118, __extension__ __PRETTY_FUNCTION__); }))
# 1118 "MagickCore/exception.c"
                                                    ;
  locale=GetLocaleExceptionMessage(severity,tag);
  (void) CopyMagickString(reason,locale,4096);
  (void) ConcatenateMagickString(reason," ",4096);
  length=strlen(reason);

  n=vsnprintf(reason+length,4096 -length,format,operands);
  ...
  if (severity >= FatalErrorException)
    type="fatal";
  (void) FormatLocaleString(message,4096,"%s @ %s/%s/%s/%.20g",
    reason,type,path,function,(double) line);
  (void) ThrowException(exception,severity,message,(char *) 
# 1141 "MagickCore/exception.c" 3 4
                                                           ((void *)0)
# 1141 "MagickCore/exception.c"
                                                               );
  return(status);
}

__attribute__ ((visibility ("default"))) MagickBooleanType ThrowMagickException(ExceptionInfo *exception,
...
# 1155 "MagickCore/exception.c" 3 4
 __builtin_va_start(
# 1155 "MagickCore/exception.c"
 operands
# 1155 "MagickCore/exception.c" 3 4
 ,
# 1155 "MagickCore/exception.c"
...
# 1158 "MagickCore/exception.c" 3 4
 __builtin_va_end(
# 1158 "MagickCore/exception.c"
 operands
# 1158 "MagickCore/exception.c" 3 4
 )
# 1158 "MagickCore/exception.c"
