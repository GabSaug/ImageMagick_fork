# 0 "MagickCore/prepress.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/prepress.c"
# 42 "MagickCore/prepress.c"
...
# 58 "MagickCore/prepress.c" 2
# 86 "MagickCore/prepress.c"
__attribute__ ((visibility ("default"))) double GetImageTotalInkDensity(Image *image,
...
# 101 "MagickCore/prepress.c" 3 4
 ((void) sizeof ((
# 101 "MagickCore/prepress.c"
 image != (Image *) 
# 101 "MagickCore/prepress.c" 3 4
...
# 101 "MagickCore/prepress.c"
 "image != (Image *) NULL"
# 101 "MagickCore/prepress.c" 3 4
 , "MagickCore/prepress.c", 101, __extension__ __PRETTY_FUNCTION__); }))
# 101 "MagickCore/prepress.c"
                                ;
  
# 102 "MagickCore/prepress.c" 3 4
 ((void) sizeof ((
# 102 "MagickCore/prepress.c"
...
# 102 "MagickCore/prepress.c" 3 4
 , "MagickCore/prepress.c", 102, __extension__ __PRETTY_FUNCTION__); }))
# 102 "MagickCore/prepress.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/prepress.c",__func__,(unsigned long) 104,"...");
  if (image->colorspace != CMYKColorspace)
    {
      (void) ThrowMagickException(exception,"MagickCore/prepress.c",__func__,(unsigned long) 107,ImageError,
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 130 "MagickCore/prepress.c" 3 4
                              ((void *)0)
# 130 "MagickCore/prepress.c"
                                  )
      {
        status=MagickFalse;
        continue;
