# 0 "MagickCore/signature.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/signature.c"
# 42 "MagickCore/signature.c"
...
# 57 "MagickCore/signature.c" 2
# 66 "MagickCore/signature.c"
...
# 118 "MagickCore/signature.c"
__attribute__ ((visibility ("hidden"))) SignatureInfo *AcquireSignatureInfo(void)
{
  SignatureInfo
    *signature_info;
  ...
  signature_info->digestsize=32;
  signature_info->blocksize=64;
  signature_info->digest=AcquireStringInfo(32);
  signature_info->message=AcquireStringInfo(64);
  signature_info->accumulator=(unsigned int *) AcquireQuantumMemory(
    64,sizeof(*signature_info->accumulator));
  if (signature_info->accumulator == (unsigned int *) 
# 135 "MagickCore/signature.c" 3 4
                                                     ((void *)0)
# 135 "MagickCore/signature.c"
                                                         )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 136 "MagickCore/signature.c" 3 4
   (*__errno_location ())
# 136 "MagickCore/signature.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/signature.c",__func__,(unsigned long) 136,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  (void) memset(signature_info->accumulator,0,64*
  ...
  signature_info->signature=0xabacadabUL;
  InitializeSignature(signature_info);
  return(signature_info);
}
# 171 "MagickCore/signature.c"
__attribute__ ((visibility ("hidden"))) SignatureInfo *DestroySignatureInfo(SignatureInfo *signature_info)
{
  
# 173 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 173 "MagickCore/signature.c"
...
# 173 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 173, __extension__ __PRETTY_FUNCTION__); }))
# 173 "MagickCore/signature.c"
                                                 ;
  
# 174 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 174 "MagickCore/signature.c"
 signature_info->signature == 0xabacadabUL
# 174 "MagickCore/signature.c" 3 4
...
# 174 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 174, __extension__ __PRETTY_FUNCTION__); }))
# 174 "MagickCore/signature.c"
                                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/signature.c",__func__,(unsigned long) 176,"...");
  if (signature_info->accumulator != (unsigned int *) 
# 177 "MagickCore/signature.c" 3 4
                                                     ((void *)0)
# 177 "MagickCore/signature.c"
                                                         )
    signature_info->accumulator=(unsigned int *) RelinquishMagickMemory(
      signature_info->accumulator);
  if (signature_info->message != (StringInfo *) 
# 180 "MagickCore/signature.c" 3 4
                                               ((void *)0)
# 180 "MagickCore/signature.c"
                                                   )
    signature_info->message=DestroyStringInfo(signature_info->message);
  if (signature_info->digest != (StringInfo *) 
# 182 "MagickCore/signature.c" 3 4
                                              ((void *)0)
# 182 "MagickCore/signature.c"
                                                  )
...
# 211 "MagickCore/signature.c"
__attribute__ ((visibility ("hidden"))) void FinalizeSignature(SignatureInfo *signature_info)
{
  ssize_t
    i;
...
# 235 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 235 "MagickCore/signature.c"
 signature_info != (SignatureInfo *) 
# 235 "MagickCore/signature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 235 "MagickCore/signature.c"
...
# 235 "MagickCore/signature.c"
 "signature_info != (SignatureInfo *) NULL"
# 235 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 235, __extension__ __PRETTY_FUNCTION__); }))
# 235 "MagickCore/signature.c"
                                                 ;
  
# 236 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 236 "MagickCore/signature.c"
 signature_info->signature == 0xabacadabUL
# 236 "MagickCore/signature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 236 "MagickCore/signature.c"
...
# 236 "MagickCore/signature.c"
 "signature_info->signature == MagickCoreSignature"
# 236 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 236, __extension__ __PRETTY_FUNCTION__); }))
# 236 "MagickCore/signature.c"
                                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/signature.c",__func__,(unsigned long) 238,"...");
...
# 298 "MagickCore/signature.c"
__attribute__ ((visibility ("hidden"))) unsigned int GetSignatureBlocksize(
  const SignatureInfo *signature_info)
{
  
# 301 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 301 "MagickCore/signature.c"
 signature_info != (SignatureInfo *) 
# 301 "MagickCore/signature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 301 "MagickCore/signature.c"
...
# 301 "MagickCore/signature.c"
 "signature_info != (SignatureInfo *) NULL"
# 301 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 301, __extension__ __PRETTY_FUNCTION__); }))
# 301 "MagickCore/signature.c"
                                                 ;
  
# 302 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 302 "MagickCore/signature.c"
 signature_info->signature == 0xabacadabUL
# 302 "MagickCore/signature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 302 "MagickCore/signature.c"
...
# 302 "MagickCore/signature.c"
 "signature_info->signature == MagickCoreSignature"
# 302 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 302, __extension__ __PRETTY_FUNCTION__); }))
# 302 "MagickCore/signature.c"
                                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/signature.c",__func__,(unsigned long) 304,"...");
  return(signature_info->blocksize);
}
# 330 "MagickCore/signature.c"
__attribute__ ((visibility ("hidden"))) const StringInfo *GetSignatureDigest(
  const SignatureInfo *signature_info)
{
  
# 333 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 333 "MagickCore/signature.c"
 signature_info != (SignatureInfo *) 
# 333 "MagickCore/signature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 333 "MagickCore/signature.c"
...
# 333 "MagickCore/signature.c"
 "signature_info != (SignatureInfo *) NULL"
# 333 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 333, __extension__ __PRETTY_FUNCTION__); }))
# 333 "MagickCore/signature.c"
                                                 ;
  
# 334 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 334 "MagickCore/signature.c"
 signature_info->signature == 0xabacadabUL
# 334 "MagickCore/signature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 334 "MagickCore/signature.c"
...
# 334 "MagickCore/signature.c"
 "signature_info->signature == MagickCoreSignature"
# 334 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 334, __extension__ __PRETTY_FUNCTION__); }))
# 334 "MagickCore/signature.c"
                                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/signature.c",__func__,(unsigned long) 336,"...");
  return(signature_info->digest);
}
# 362 "MagickCore/signature.c"
__attribute__ ((visibility ("hidden"))) unsigned int GetSignatureDigestsize(
  const SignatureInfo *signature_info)
{
  
# 365 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 365 "MagickCore/signature.c"
 signature_info != (SignatureInfo *) 
# 365 "MagickCore/signature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 365 "MagickCore/signature.c"
...
# 365 "MagickCore/signature.c"
 "signature_info != (SignatureInfo *) NULL"
# 365 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 365, __extension__ __PRETTY_FUNCTION__); }))
# 365 "MagickCore/signature.c"
                                                 ;
  
# 366 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 366 "MagickCore/signature.c"
 signature_info->signature == 0xabacadabUL
# 366 "MagickCore/signature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 366 "MagickCore/signature.c"
...
# 366 "MagickCore/signature.c"
 "signature_info->signature == MagickCoreSignature"
# 366 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 366, __extension__ __PRETTY_FUNCTION__); }))
# 366 "MagickCore/signature.c"
                                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/signature.c",__func__,(unsigned long) 368,"...");
  return(signature_info->digestsize);
}
# 394 "MagickCore/signature.c"
__attribute__ ((visibility ("hidden"))) void InitializeSignature(SignatureInfo *signature_info)
{
  
# 396 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 396 "MagickCore/signature.c"
 signature_info != (SignatureInfo *) 
# 396 "MagickCore/signature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 396 "MagickCore/signature.c"
...
# 396 "MagickCore/signature.c"
 "signature_info != (SignatureInfo *) NULL"
# 396 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 396, __extension__ __PRETTY_FUNCTION__); }))
# 396 "MagickCore/signature.c"
                                                 ;
  
# 397 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 397 "MagickCore/signature.c"
 signature_info->signature == 0xabacadabUL
# 397 "MagickCore/signature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 397 "MagickCore/signature.c"
...
# 397 "MagickCore/signature.c"
 "signature_info->signature == MagickCoreSignature"
# 397 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 397, __extension__ __PRETTY_FUNCTION__); }))
# 397 "MagickCore/signature.c"
                                                         ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/signature.c",__func__,(unsigned long) 399,"...");
...
# 438 "MagickCore/signature.c"
__attribute__ ((visibility ("hidden"))) void SetSignatureDigest(SignatureInfo *signature_info,
...
# 444 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 444 "MagickCore/signature.c"
 signature_info != (SignatureInfo *) 
# 444 "MagickCore/signature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 444 "MagickCore/signature.c"
...
# 444 "MagickCore/signature.c"
 "signature_info != (SignatureInfo *) NULL"
# 444 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 444, __extension__ __PRETTY_FUNCTION__); }))
# 444 "MagickCore/signature.c"
                                                 ;
  
# 445 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 445 "MagickCore/signature.c"
 signature_info->signature == 0xabacadabUL
# 445 "MagickCore/signature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 445 "MagickCore/signature.c"
...
# 445 "MagickCore/signature.c"
 "signature_info->signature == MagickCoreSignature"
# 445 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 445, __extension__ __PRETTY_FUNCTION__); }))
# 445 "MagickCore/signature.c"
                                                         ;
  SetStringInfo(signature_info->digest,digest);
}
# 476 "MagickCore/signature.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SignatureImage(Image *image,
...
# 506 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 506 "MagickCore/signature.c"
 image != (Image *) 
# 506 "MagickCore/signature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 506 "MagickCore/signature.c"
...
# 506 "MagickCore/signature.c"
 "image != (Image *) NULL"
# 506 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 506, __extension__ __PRETTY_FUNCTION__); }))
# 506 "MagickCore/signature.c"
                                ;
  
# 507 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 507 "MagickCore/signature.c"
...
# 507 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 507, __extension__ __PRETTY_FUNCTION__); }))
# 507 "MagickCore/signature.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/signature.c",__func__,(unsigned long) 509,"%s",image->filename);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 523 "MagickCore/signature.c" 3 4
                              ((void *)0)
# 523 "MagickCore/signature.c"
                                  )
      break;
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        ...
        if ((traits & UpdatePixelTrait) == 0)
          continue;
        pixel=(float) (((double) 1.0/(double) ((Quantum) 65535.0))*(double) p[i]);
...
# 608 "MagickCore/signature.c"
  ...
  if (signature_info->lsb_first == MagickFalse)
    {
      ...
      if (sizeof(unsigned int) <= 4)
        ...
        for (i=0; i < 16; i++)
        {
          T=(*((unsigned int *) p));
          p+=4;
          W[i]=((unsigned int) ((T) & 0xffffffffU));
        }
      else
        for (i=0; i < 16; i+=2)
        {
          T=(*((unsigned int *) p));
          p+=8;
          W[i]=((unsigned int) ((T >> shift) & 0xffffffffU));
          W[i+1]=((unsigned int) ((T) & 0xffffffffU));
        }
    }
  else
  ...
  for (i=16; i < 64; i++)
    W[i]=((unsigned int) ((((((unsigned int) ((((W[i-2]) >> 17) | ((W[i-2]) << (32-17))) & 0xffffffffU))) ^ (((unsigned int) ((((W[i-2]) >> 19) | ((W[i-2]) << (32-19))) & 0xffffffffU))) ^ ((unsigned int) (((W[i-2]) >> 10) & 0xffffffffU)))+W[i-7]+((((unsigned int) ((((W[i-15]) >> 7) | ((W[i-15]) << (32-7))) & 0xffffffffU))) ^ (((unsigned int) ((((W[i-15]) >> 18) | ((W[i-15]) << (32-18))) & 0xffffffffU))) ^ ((unsigned int) (((W[i-15]) >> 3) & 0xffffffffU)))+W[i-16]) & 0xffffffffU));
  for (j=0; j < 64; j++)
  {
    T1=((unsigned int) ((H+((((unsigned int) ((((E) >> 6) | ((E) << (32-6))) & 0xffffffffU))) ^ (((unsigned int) ((((E) >> 11) | ((E) << (32-11))) & 0xffffffffU))) ^ (((unsigned int) ((((E) >> 25) | ((E) << (32-25))) & 0xffffffffU))))+(((E) & (F)) ^ (~(E) & (G)))+K[j]+W[j]) & 0xffffffffU));
    T2=((unsigned int) ((((((unsigned int) ((((A) >> 2) | ((A) << (32-2))) & 0xffffffffU))) ^ (((unsigned int) ((((A) >> 13) | ((A) << (32-13))) & 0xffffffffU))) ^ (((unsigned int) ((((A) >> 22) | ((A) << (32-22))) & 0xffffffffU))))+(((A) & (B)) ^ ((A) & (C)) ^ ((B) & (C)))) & 0xffffffffU));
    H=G;
    G=F;
    F=E;
    E=((unsigned int) ((D+T1) & 0xffffffffU));
    D=C;
    C=B;
    B=A;
    A=((unsigned int) ((T1+T2) & 0xffffffffU));
  }



  signature_info->accumulator[0]=((unsigned int) ((signature_info->accumulator[0]+A) & 0xffffffffU));
  signature_info->accumulator[1]=((unsigned int) ((signature_info->accumulator[1]+B) & 0xffffffffU));
  signature_info->accumulator[2]=((unsigned int) ((signature_info->accumulator[2]+C) & 0xffffffffU));
  signature_info->accumulator[3]=((unsigned int) ((signature_info->accumulator[3]+D) & 0xffffffffU));
  signature_info->accumulator[4]=((unsigned int) ((signature_info->accumulator[4]+E) & 0xffffffffU));
  signature_info->accumulator[5]=((unsigned int) ((signature_info->accumulator[5]+F) & 0xffffffffU));
  signature_info->accumulator[6]=((unsigned int) ((signature_info->accumulator[6]+G) & 0xffffffffU));
  signature_info->accumulator[7]=((unsigned int) ((signature_info->accumulator[7]+H) & 0xffffffffU));
...
# 772 "MagickCore/signature.c"
__attribute__ ((visibility ("hidden"))) void UpdateSignature(SignatureInfo *signature_info,
...
# 790 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 790 "MagickCore/signature.c"
 signature_info != (SignatureInfo *) 
# 790 "MagickCore/signature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 790 "MagickCore/signature.c"
...
# 790 "MagickCore/signature.c"
 "signature_info != (SignatureInfo *) NULL"
# 790 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 790, __extension__ __PRETTY_FUNCTION__); }))
# 790 "MagickCore/signature.c"
                                                 ;
  
# 791 "MagickCore/signature.c" 3 4
 ((void) sizeof ((
# 791 "MagickCore/signature.c"
 signature_info->signature == 0xabacadabUL
# 791 "MagickCore/signature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 791 "MagickCore/signature.c"
...
# 791 "MagickCore/signature.c"
 "signature_info->signature == MagickCoreSignature"
# 791 "MagickCore/signature.c" 3 4
 , "MagickCore/signature.c", 791, __extension__ __PRETTY_FUNCTION__); }))
# 791 "MagickCore/signature.c"
                                                         ;
  n=GetStringInfoLength(message);
  length=((unsigned int) (((unsigned int) (signature_info->low_order+(n << 3))) & 0xffffffffU));
