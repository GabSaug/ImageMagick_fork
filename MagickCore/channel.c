# 0 "MagickCore/channel.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/channel.c"
# 43 "MagickCore/channel.c"
...
# 62 "MagickCore/channel.c" 2
# 108 "MagickCore/channel.c"
typedef enum
{
  ExtractChannelOp,
  AssignChannelOp,
  ...
  const Quantum pixel,ExceptionInfo *exception)
{
  ...
  height=(((source_image->rows) < (destination_image->rows)) ? (source_image->rows) : (destination_image->rows));
  width=(((source_image->columns) < (destination_image->columns)) ? (source_image->columns) : (destination_image->columns));
  ...
  for (y=0; y < (ssize_t) height; y++)
  {
    ...
    if ((p == (const Quantum *) 
# 167 "MagickCore/channel.c" 3 4
                               ((void *)0)
# 167 "MagickCore/channel.c"
                                   ) || (q == (Quantum *) 
# 167 "MagickCore/channel.c" 3 4
                                                          ((void *)0)
# 167 "MagickCore/channel.c"
...
__attribute__ ((visibility ("default"))) Image *ChannelFxImage(const Image *image,const char *expression,
...
# 232 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 232 "MagickCore/channel.c"
 image != (Image *) 
# 232 "MagickCore/channel.c" 3 4
...
# 232 "MagickCore/channel.c"
 "image != (Image *) NULL"
# 232 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 232, __extension__ __PRETTY_FUNCTION__); }))
# 232 "MagickCore/channel.c"
                                ;
  
# 233 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 233 "MagickCore/channel.c"
...
# 233 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 233, __extension__ __PRETTY_FUNCTION__); }))
# 233 "MagickCore/channel.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/channel.c",__func__,(unsigned long) 235,"%s",image->filename);
  
# 236 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 236 "MagickCore/channel.c"
...
# 236 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 236, __extension__ __PRETTY_FUNCTION__); }))
# 236 "MagickCore/channel.c"
                                            ;
  
# 237 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 237 "MagickCore/channel.c"
...
# 237 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 237, __extension__ __PRETTY_FUNCTION__); }))
# 237 "MagickCore/channel.c"
                                                    ;
  p=expression;
  source_image=image;
  destination_image=CloneImage(image,0,0,MagickTrue,exception);
  if (destination_image == (Image *) 
# 241 "MagickCore/channel.c" 3 4
                                    ((void *)0)
# 241 "MagickCore/channel.c"
                                        )
    return((Image *) 
# 242 "MagickCore/channel.c" 3 4
                    ((void *)0)
# 242 "MagickCore/channel.c"
                        );
  if (expression == (const char *) 
# 243 "MagickCore/channel.c" 3 4
                                  ((void *)0)
# 243 "MagickCore/channel.c"
                                      )
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 249 "MagickCore/channel.c" 3 4
                      ((void *)0)
# 249 "MagickCore/channel.c"
                          );
    }
  ...
  while (*token != '\0')
  {
    ...
    switch (*token)
    {
      ...
      case '|':
      {
        if (GetNextImageInList(source_image) != (Image *) 
# 273 "MagickCore/channel.c" 3 4
                                                         ((void *)0)
# 273 "MagickCore/channel.c"
                                                             )
      ...
      case ';':
      {
        ...
        if (canvas == (Image *) 
# 291 "MagickCore/channel.c" 3 4
                               ((void *)0)
# 291 "MagickCore/channel.c"
                                   )
          {
        ...
        if (status == MagickFalse)
          {
            destination_image=GetLastImageInList(destination_image);
            return((Image *) 
# 302 "MagickCore/channel.c" 3 4
                            ((void *)0)
# 302 "MagickCore/channel.c"
                                );
          }
        (void) GetNextToken(p,&p,4096,token);
        channels=0;
    ...
    if (traits == UndefinedPixelTrait)
      {
        (void) ThrowMagickException(exception,"MagickCore/channel.c",__func__,(unsigned long) 318,
    ...
    switch (channel_op)
    {
      ...
      {
        if (channel_op == AssignChannelOp)
          pixel=StringToDoubleInterval(token,(double) ((Quantum) 65535.0)+1.0);
        else
          {
            i=ParsePixelChannelOption(token);
            ...
            if (i < 0)
              {
                (void) ThrowMagickException(exception,"MagickCore/channel.c",__func__,(unsigned long) 357,
        ...
        if (image->colorspace != UndefinedColorspace)
          switch (destination_channel)
          {
            ...
            default:
            {
              ...
              if (traits == UndefinedPixelTrait)
                {
                  (void) ThrowMagickException(exception,"MagickCore/channel.c",__func__,(unsigned long) 405,
                    CorruptImageError,"MissingImageChannel","`%s'",token);
                  destination_image=DestroyImageList(destination_image);
                  return(destination_image);
                }
        ...
        channel_mask=(ChannelType) (channel_mask |
          (((MagickOffsetType) (1LL)) << ParseChannelOption(token)));
        (void) GetNextToken(p,&p,4096,token);
        break;
      }
      default:
    ...
    switch (channel_op)
    {
      ...
      {
        channel_mask=(ChannelType) (channel_mask |
          (((MagickOffsetType) (1LL)) << destination_channel));
    ...
    status=SetImageProgress(source_image,"ChannelFx/Image",p-expression,
      strlen(expression));
    if (status == MagickFalse)
      break;
  }
  if (destination_image == (Image *) 
# 457 "MagickCore/channel.c" 3 4
                                    ((void *)0)
# 457 "MagickCore/channel.c"
                                        )
    return(destination_image);
  (void) SetPixelChannelMask(destination_image,channel_mask);
  if ((channel_op == ExtractChannelOp) && (channels == 1))
...
# 498 "MagickCore/channel.c"
__attribute__ ((visibility ("default"))) Image *CombineImages(const Image *image,
...
# 521 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 521 "MagickCore/channel.c"
 image != (const Image *) 
# 521 "MagickCore/channel.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 521 "MagickCore/channel.c"
...
# 521 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 521, __extension__ __PRETTY_FUNCTION__); }))
# 521 "MagickCore/channel.c"
                                      ;
  
# 522 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 522 "MagickCore/channel.c"
 image->signature == 0xabacadabUL
# 522 "MagickCore/channel.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 522 "MagickCore/channel.c"
...
# 522 "MagickCore/channel.c"
 "image->signature == MagickCoreSignature"
# 522 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 522, __extension__ __PRETTY_FUNCTION__); }))
# 522 "MagickCore/channel.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/channel.c",__func__,(unsigned long) 524,"%s",image->filename);
  
# 525 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 525 "MagickCore/channel.c"
 exception != (ExceptionInfo *) 
# 525 "MagickCore/channel.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 525 "MagickCore/channel.c"
...
# 525 "MagickCore/channel.c"
 "exception != (ExceptionInfo *) NULL"
# 525 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 525, __extension__ __PRETTY_FUNCTION__); }))
# 525 "MagickCore/channel.c"
                                            ;
  
# 526 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 526 "MagickCore/channel.c"
 exception->signature == 0xabacadabUL
# 526 "MagickCore/channel.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 526 "MagickCore/channel.c"
...
# 526 "MagickCore/channel.c"
 "exception->signature == MagickCoreSignature"
# 526 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 526, __extension__ __PRETTY_FUNCTION__); }))
# 526 "MagickCore/channel.c"
                                                    ;
  combine_image=CloneImage(image,0,0,MagickTrue,exception);
  if (combine_image == (Image *) 
# 528 "MagickCore/channel.c" 3 4
                                ((void *)0)
# 528 "MagickCore/channel.c"
                                    )
    return((Image *) 
# 529 "MagickCore/channel.c" 3 4
                    ((void *)0)
# 529 "MagickCore/channel.c"
                        );
  if (SetImageStorageClass(combine_image,DirectClass,exception) == MagickFalse)
    {
      combine_image=DestroyImage(combine_image);
      return((Image *) 
# 533 "MagickCore/channel.c" 3 4
                      ((void *)0)
# 533 "MagickCore/channel.c"
                          );
    }
  if (colorspace != UndefinedColorspace)
    (void) SetImageColorspace(combine_image,colorspace,exception);
  else
    if (fabs(image->gamma-1.0) <= 1.0e-12)
  ...
  for (y=0; y < (ssize_t) combine_image->rows; y++)
  {
    ...
    pixels=GetCacheViewAuthenticPixels(combine_view,0,y,combine_image->columns,
      1,exception);
    if (pixels == (Quantum *) 
# 599 "MagickCore/channel.c" 3 4
                             ((void *)0)
# 599 "MagickCore/channel.c"
                                 )
      {
        status=MagickFalse;
        continue;
    ...
    for (i=0; i < (ssize_t) GetPixelChannels(combine_image); i++)
    {
      ...
      if (traits == UndefinedPixelTrait)
        continue;
      if (next == (Image *) 
# 614 "MagickCore/channel.c" 3 4
                           ((void *)0)
# 614 "MagickCore/channel.c"
                               )
        continue;
      image_view=AcquireVirtualCacheView(next,exception);
      p=GetCacheViewVirtualPixels(image_view,0,y,next->columns,1,exception);
      if (p == (const Quantum *) 
# 618 "MagickCore/channel.c" 3 4
                                ((void *)0)
# 618 "MagickCore/channel.c"
                                    )
        continue;
      q=pixels;
...
# 635 "MagickCore/channel.c" 3 4
                                                          ((void *)0)
# 635 "MagickCore/channel.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"Combine/Image",progress,
          combine_image->rows);
...
# 680 "MagickCore/channel.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetImageAlphaChannel(const Image *image)
{
  
# 682 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 682 "MagickCore/channel.c"
 image != (const Image *) 
# 682 "MagickCore/channel.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 682 "MagickCore/channel.c"
...
# 682 "MagickCore/channel.c"
 "image != (const Image *) NULL"
# 682 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 682, __extension__ __PRETTY_FUNCTION__); }))
# 682 "MagickCore/channel.c"
                                      ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/channel.c",__func__,(unsigned long) 684,"...");
  
# 685 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 685 "MagickCore/channel.c"
 image->signature == 0xabacadabUL
# 685 "MagickCore/channel.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 685 "MagickCore/channel.c"
...
# 685 "MagickCore/channel.c"
 "image->signature == MagickCoreSignature"
# 685 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 685, __extension__ __PRETTY_FUNCTION__); }))
# 685 "MagickCore/channel.c"
                                                ;
  return(image->alpha_trait != UndefinedPixelTrait ? MagickTrue : MagickFalse);
}
# 717 "MagickCore/channel.c"
__attribute__ ((visibility ("default"))) Image *SeparateImage(const Image *image,
...
# 742 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 742 "MagickCore/channel.c"
 image != (Image *) 
# 742 "MagickCore/channel.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 742 "MagickCore/channel.c"
...
# 742 "MagickCore/channel.c"
 "image != (Image *) NULL"
# 742 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 742, __extension__ __PRETTY_FUNCTION__); }))
# 742 "MagickCore/channel.c"
                                ;
  
# 743 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 743 "MagickCore/channel.c"
 image->signature == 0xabacadabUL
# 743 "MagickCore/channel.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 743 "MagickCore/channel.c"
...
# 743 "MagickCore/channel.c"
 "image->signature == MagickCoreSignature"
# 743 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 743, __extension__ __PRETTY_FUNCTION__); }))
# 743 "MagickCore/channel.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/channel.c",__func__,(unsigned long) 745,"%s",image->filename);
  
# 746 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 746 "MagickCore/channel.c"
 exception != (ExceptionInfo *) 
# 746 "MagickCore/channel.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 746 "MagickCore/channel.c"
...
# 746 "MagickCore/channel.c"
 "exception != (ExceptionInfo *) NULL"
# 746 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 746, __extension__ __PRETTY_FUNCTION__); }))
# 746 "MagickCore/channel.c"
                                            ;
  
# 747 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 747 "MagickCore/channel.c"
 exception->signature == 0xabacadabUL
# 747 "MagickCore/channel.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 747 "MagickCore/channel.c"
...
# 747 "MagickCore/channel.c"
 "exception->signature == MagickCoreSignature"
# 747 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 747, __extension__ __PRETTY_FUNCTION__); }))
# 747 "MagickCore/channel.c"
                                                    ;
  separate_image=CloneImage(image,0,0,MagickTrue,exception);
  if (separate_image == (Image *) 
# 749 "MagickCore/channel.c" 3 4
                                 ((void *)0)
# 749 "MagickCore/channel.c"
                                     )
    return((Image *) 
# 750 "MagickCore/channel.c" 3 4
                    ((void *)0)
# 750 "MagickCore/channel.c"
                        );
  if (SetImageStorageClass(separate_image,DirectClass,exception) == MagickFalse)
    {
      separate_image=DestroyImage(separate_image);
      return((Image *) 
# 754 "MagickCore/channel.c" 3 4
                      ((void *)0)
# 754 "MagickCore/channel.c"
                          );
    }
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=QueueCacheViewAuthenticPixels(separate_view,0,y,separate_image->columns,1,
      exception);
    if ((p == (const Quantum *) 
# 786 "MagickCore/channel.c" 3 4
                               ((void *)0)
# 786 "MagickCore/channel.c"
                                   ) || (q == (Quantum *) 
# 786 "MagickCore/channel.c" 3 4
                                                          ((void *)0)
# 786 "MagickCore/channel.c"
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
      {
        ...
        PixelTrait traits = GetPixelChannelTraits(image,channel);
        if ((traits == UndefinedPixelTrait) ||
            ((((size_t) (channel_type) >> (size_t) (channel)) & 0x01) == 0))
          continue;
    ...
    if (SyncCacheViewAuthenticPixels(separate_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 811 "MagickCore/channel.c" 3 4
                                                          ((void *)0)
# 811 "MagickCore/channel.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"Separate/Image",progress,image->rows);
        if (proceed == MagickFalse)
          status=MagickFalse;
      }
  }
...
# 858 "MagickCore/channel.c"
__attribute__ ((visibility ("default"))) Image *SeparateImages(const Image *image,ExceptionInfo *exception)
{
  Image
    *images,
    *separate_image;
...
# 867 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 867 "MagickCore/channel.c"
 image != (Image *) 
# 867 "MagickCore/channel.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 867 "MagickCore/channel.c"
...
# 867 "MagickCore/channel.c"
 "image != (Image *) NULL"
# 867 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 867, __extension__ __PRETTY_FUNCTION__); }))
# 867 "MagickCore/channel.c"
                                ;
  
# 868 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 868 "MagickCore/channel.c"
 image->signature == 0xabacadabUL
# 868 "MagickCore/channel.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 868 "MagickCore/channel.c"
...
# 868 "MagickCore/channel.c"
 "image->signature == MagickCoreSignature"
# 868 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 868, __extension__ __PRETTY_FUNCTION__); }))
# 868 "MagickCore/channel.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/channel.c",__func__,(unsigned long) 870,"%s",image->filename);
  images=NewImageList();
  for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
  {
    PixelChannel channel = GetPixelChannelChannel(image,i);
    ...
    separate_image=SeparateImage(image,(ChannelType)
      (((MagickOffsetType) (1LL)) << channel),exception);
    if (separate_image != (Image *) 
# 880 "MagickCore/channel.c" 3 4
                                   ((void *)0)
# 880 "MagickCore/channel.c"
                                       )
      AppendImageToList(&images,separate_image);
  }
  if (images == (Image *) 
# 883 "MagickCore/channel.c" 3 4
                         ((void *)0)
# 883 "MagickCore/channel.c"
                             )
    images=SeparateImage(image,UndefinedChannel,exception);
  return(images);
}
# 921 "MagickCore/channel.c"
  ...
  const double alpha,const Quantum *q,const double beta,Quantum *composite)
{
  ...
  for (i=0; i < (ssize_t) GetPixelChannels(image); i++)
  {
    ...
    switch (channel)
    {
      ...
      case AlphaPixelChannel:
      {
        composite[i]=ClampToQuantum((double) ((Quantum) 65535.0)*(Sa*(-Da)+Sa+Da));
        break;
      }
      default:
        break;
...
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageAlphaChannel(Image *image,
...
# 994 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 994 "MagickCore/channel.c"
 image != (Image *) 
# 994 "MagickCore/channel.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 994 "MagickCore/channel.c"
...
# 994 "MagickCore/channel.c"
 "image != (Image *) NULL"
# 994 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 994, __extension__ __PRETTY_FUNCTION__); }))
# 994 "MagickCore/channel.c"
                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/channel.c",__func__,(unsigned long) 996,"...");
  
# 997 "MagickCore/channel.c" 3 4
 ((void) sizeof ((
# 997 "MagickCore/channel.c"
 image->signature == 0xabacadabUL
# 997 "MagickCore/channel.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 997 "MagickCore/channel.c"
...
# 997 "MagickCore/channel.c"
 "image->signature == MagickCoreSignature"
# 997 "MagickCore/channel.c" 3 4
 , "MagickCore/channel.c", 997, __extension__ __PRETTY_FUNCTION__); }))
# 997 "MagickCore/channel.c"
                                                ;
  status=MagickTrue;
  switch (alpha_type)
    ...
    case AssociateAlphaChannel:
    {
      ...
      for (y=0; y < (ssize_t) image->rows; y++)
      {
        ...
        q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,
          exception);
        if (q == (Quantum *) 
# 1033 "MagickCore/channel.c" 3 4
                            ((void *)0)
# 1033 "MagickCore/channel.c"
                                )
          {
            status=MagickFalse;
            continue;
    ...
    case BackgroundAlphaChannel:
    {
      ...
      for (y=0; y < (ssize_t) image->rows; y++)
      {
        ...
        q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,
          exception);
        if (q == (Quantum *) 
# 1093 "MagickCore/channel.c" 3 4
                            ((void *)0)
# 1093 "MagickCore/channel.c"
                                )
          {
            status=MagickFalse;
            continue;
        ...
        for (x=0; x < (ssize_t) image->columns; x++)
        {
          if (GetPixelAlpha(image,q) == ((Quantum) 0))
            {
              SetPixelViaPixelInfo(image,&image->background_color,q);
              SetPixelChannel(image,AlphaPixelChannel,((Quantum) 0),q);
            }
          q+=GetPixelChannels(image);
        }
        if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
    ...
    {
      if ((image->alpha_trait & BlendPixelTrait) == 0)
        status=SetImageAlpha(image,((Quantum) ((Quantum) 65535.0)),exception);
      image->alpha_trait=CopyPixelTrait;
      break;
    }
    case DisassociateAlphaChannel:
    {
      ...
      for (y=0; y < (ssize_t) image->rows; y++)
      {
        ...
        q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,
          exception);
        if (q == (Quantum *) 
# 1153 "MagickCore/channel.c" 3 4
                            ((void *)0)
# 1153 "MagickCore/channel.c"
                                )
          {
            status=MagickFalse;
            continue;
        ...
        for (x=0; x < (ssize_t) image->columns; x++)
        {
          ...
          Sa=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelAlpha(image,q);
    ...
    case OffIfOpaqueAlphaChannel:
    {
      ...
      for (y=0; y < (ssize_t) image->rows; y++)
      {
        ...
        p=GetCacheViewVirtualPixels(image_view,0,y,image->columns,1,exception);
        if (p == (const Quantum *) 
# 1235 "MagickCore/channel.c" 3 4
                                  ((void *)0)
# 1235 "MagickCore/channel.c"
                                      )
          {
            status=MagickFalse;
            continue;
    ...
    case RemoveAlphaChannel:
    {
      ...
      for (y=0; y < (ssize_t) image->rows; y++)
      {
        ...
        q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,
          exception);
        if (q == (Quantum *) 
# 1294 "MagickCore/channel.c" 3 4
                            ((void *)0)
# 1294 "MagickCore/channel.c"
                                )
          {
            status=MagickFalse;
            continue;
    ...
    case ShapeAlphaChannel:
    {
      ...
      for (y=0; y < (ssize_t) image->rows; y++)
      {
        ...
        q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,
          exception);
        if (q == (Quantum *) 
# 1352 "MagickCore/channel.c" 3 4
                            ((void *)0)
# 1352 "MagickCore/channel.c"
                                )
          {
            status=MagickFalse;
            continue;
    ...
    {
      status=SetImageAlpha(image,((Quantum) 0),exception);
      break;
    }
