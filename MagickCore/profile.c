# 0 "MagickCore/profile.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/profile.c"
# 42 "MagickCore/profile.c"
...
# 57 "MagickCore/profile.c" 2
# 1 "./MagickCore/option-private.h" 1
# 58 "MagickCore/profile.c" 2
...
# 71 "MagickCore/profile.c" 2
# 80 "MagickCore/profile.c"
...
# 81 "MagickCore/profile.c" 2
# 1 "/usr/include/libxml2/libxml/tree.h" 1
# 82 "MagickCore/profile.c" 2
...
# 146 "MagickCore/profile.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CloneImageProfiles(Image *image,
  const Image *clone_image)
{
  
# 149 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 149 "MagickCore/profile.c"
 image != (Image *) 
# 149 "MagickCore/profile.c" 3 4
...
# 149 "MagickCore/profile.c"
 "image != (Image *) NULL"
# 149 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 149, __extension__ __PRETTY_FUNCTION__); }))
# 149 "MagickCore/profile.c"
                                ;
  
# 150 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 150 "MagickCore/profile.c"
...
# 150 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 150, __extension__ __PRETTY_FUNCTION__); }))
# 150 "MagickCore/profile.c"
                                                ;
  
# 151 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 151 "MagickCore/profile.c"
...
# 151 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 151, __extension__ __PRETTY_FUNCTION__); }))
# 151 "MagickCore/profile.c"
                                            ;
  
# 152 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 152 "MagickCore/profile.c"
...
# 152 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 152, __extension__ __PRETTY_FUNCTION__); }))
# 152 "MagickCore/profile.c"
                                                      ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/profile.c",__func__,(unsigned long) 154,"%s",image->filename);
  if (clone_image->profiles != (void *) 
# 155 "MagickCore/profile.c" 3 4
                                       ((void *)0)
# 155 "MagickCore/profile.c"
                                           )
    {
      if (image->profiles != (void *) 
# 157 "MagickCore/profile.c" 3 4
                                     ((void *)0)
# 157 "MagickCore/profile.c"
                                         )
        DestroyImageProfiles(image);
...
# 189 "MagickCore/profile.c"
__attribute__ ((visibility ("default"))) MagickBooleanType DeleteImageProfile(Image *image,const char *name)
{
  
# 191 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 191 "MagickCore/profile.c"
 image != (Image *) 
# 191 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 191 "MagickCore/profile.c"
...
# 191 "MagickCore/profile.c"
 "image != (Image *) NULL"
# 191 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 191, __extension__ __PRETTY_FUNCTION__); }))
# 191 "MagickCore/profile.c"
                                ;
  
# 192 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 192 "MagickCore/profile.c"
 image->signature == 0xabacadabUL
# 192 "MagickCore/profile.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 192 "MagickCore/profile.c"
...
# 192 "MagickCore/profile.c"
 "image->signature == MagickCoreSignature"
# 192 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 192, __extension__ __PRETTY_FUNCTION__); }))
# 192 "MagickCore/profile.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/profile.c",__func__,(unsigned long) 194,"%s",image->filename);
  if (image->profiles == (SplayTreeInfo *) 
# 195 "MagickCore/profile.c" 3 4
                                          ((void *)0)
# 195 "MagickCore/profile.c"
                                              )
    return(MagickFalse);
  WriteTo8BimProfile(image,name,(StringInfo *) 
# 197 "MagickCore/profile.c" 3 4
                                              ((void *)0)
# 197 "MagickCore/profile.c"
                                                  );
  return(DeleteNodeFromSplayTree((SplayTreeInfo *) image->profiles,name));
}
# 223 "MagickCore/profile.c"
__attribute__ ((visibility ("default"))) void DestroyImageProfiles(Image *image)
{
  if (image->profiles != (SplayTreeInfo *) 
# 225 "MagickCore/profile.c" 3 4
                                          ((void *)0)
# 225 "MagickCore/profile.c"
                                              )
    image->profiles=DestroySplayTree((SplayTreeInfo *) image->profiles);
}
# 253 "MagickCore/profile.c"
__attribute__ ((visibility ("default"))) const StringInfo *GetImageProfile(const Image *image,
  const char *name)
{
  const StringInfo
    *profile;
...
# 259 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 259 "MagickCore/profile.c"
 image != (Image *) 
# 259 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 259 "MagickCore/profile.c"
...
# 259 "MagickCore/profile.c"
 "image != (Image *) NULL"
# 259 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 259, __extension__ __PRETTY_FUNCTION__); }))
# 259 "MagickCore/profile.c"
                                ;
  
# 260 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 260 "MagickCore/profile.c"
 image->signature == 0xabacadabUL
# 260 "MagickCore/profile.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 260 "MagickCore/profile.c"
...
# 260 "MagickCore/profile.c"
 "image->signature == MagickCoreSignature"
# 260 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 260, __extension__ __PRETTY_FUNCTION__); }))
# 260 "MagickCore/profile.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/profile.c",__func__,(unsigned long) 262,"%s",image->filename);
  if (image->profiles == (SplayTreeInfo *) 
# 263 "MagickCore/profile.c" 3 4
                                          ((void *)0)
# 263 "MagickCore/profile.c"
                                              )
    return((StringInfo *) 
# 264 "MagickCore/profile.c" 3 4
                         ((void *)0)
# 264 "MagickCore/profile.c"
                             );
  profile=(const StringInfo *) GetValueFromSplayTree((SplayTreeInfo *)
    image->profiles,name);
  return(profile);
}
# 292 "MagickCore/profile.c"
__attribute__ ((visibility ("default"))) char *GetNextImageProfile(const Image *image)
{
  
# 294 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 294 "MagickCore/profile.c"
 image != (Image *) 
# 294 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 294 "MagickCore/profile.c"
...
# 294 "MagickCore/profile.c"
 "image != (Image *) NULL"
# 294 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 294, __extension__ __PRETTY_FUNCTION__); }))
# 294 "MagickCore/profile.c"
                                ;
  
# 295 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 295 "MagickCore/profile.c"
 image->signature == 0xabacadabUL
# 295 "MagickCore/profile.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 295 "MagickCore/profile.c"
...
# 295 "MagickCore/profile.c"
 "image->signature == MagickCoreSignature"
# 295 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 295, __extension__ __PRETTY_FUNCTION__); }))
# 295 "MagickCore/profile.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/profile.c",__func__,(unsigned long) 297,"%s",image->filename);
  if (image->profiles == (SplayTreeInfo *) 
# 298 "MagickCore/profile.c" 3 4
                                          ((void *)0)
# 298 "MagickCore/profile.c"
                                              )
    return((char *) 
# 299 "MagickCore/profile.c" 3 4
                   ((void *)0)
# 299 "MagickCore/profile.c"
                       );
  return((char *) GetNextKeyInSplayTree((SplayTreeInfo *) image->profiles));
}
# 636 "MagickCore/profile.c"
...
# 918 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 918 "MagickCore/profile.c"
 image != (Image *) 
# 918 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 918 "MagickCore/profile.c"
...
# 918 "MagickCore/profile.c"
 "image != (Image *) NULL"
# 918 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 918, __extension__ __PRETTY_FUNCTION__); }))
# 918 "MagickCore/profile.c"
                                ;
  
# 919 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 919 "MagickCore/profile.c"
 image->signature == 0xabacadabUL
# 919 "MagickCore/profile.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 919 "MagickCore/profile.c"
...
# 919 "MagickCore/profile.c"
 "image->signature == MagickCoreSignature"
# 919 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 919, __extension__ __PRETTY_FUNCTION__); }))
# 919 "MagickCore/profile.c"
                                                ;
  if (GetImageProfile(image,"icc") != (const StringInfo *) 
# 920 "MagickCore/profile.c" 3 4
                                                          ((void *)0)
# 920 "MagickCore/profile.c"
                                                              )
    return(MagickFalse);
...
__attribute__ ((visibility ("default"))) MagickBooleanType ProfileImage(Image *image,const char *name,
  const void *datum,const size_t length,ExceptionInfo *exception)
{
# 949 "MagickCore/profile.c"
  MagickBooleanType
    status;
...
# 955 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 955 "MagickCore/profile.c"
 image != (Image *) 
# 955 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 955 "MagickCore/profile.c"
...
# 955 "MagickCore/profile.c"
 "image != (Image *) NULL"
# 955 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 955, __extension__ __PRETTY_FUNCTION__); }))
# 955 "MagickCore/profile.c"
                                ;
  
# 956 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 956 "MagickCore/profile.c"
 image->signature == 0xabacadabUL
# 956 "MagickCore/profile.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 956 "MagickCore/profile.c"
...
# 956 "MagickCore/profile.c"
 "image->signature == MagickCoreSignature"
# 956 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 956, __extension__ __PRETTY_FUNCTION__); }))
# 956 "MagickCore/profile.c"
                                                ;
  
# 957 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 957 "MagickCore/profile.c"
 name != (const char *) 
# 957 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 957 "MagickCore/profile.c"
...
# 957 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 957, __extension__ __PRETTY_FUNCTION__); }))
# 957 "MagickCore/profile.c"
                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/profile.c",__func__,(unsigned long) 959,"%s",image->filename);
  if ((datum == (const void *) 
# 960 "MagickCore/profile.c" 3 4
                              ((void *)0)
# 960 "MagickCore/profile.c"
                                  ) || (length == 0))
    {
      char
        *next;
      ...
      for (next=GetNextImageProfile(image); next != (const char *) 
# 969 "MagickCore/profile.c" 3 4
                                                                  ((void *)0)
# 969 "MagickCore/profile.c"
                                                                      ; )
      {
...
# 994 "MagickCore/profile.c" 3 4
                                              ((void *)0)
# 994 "MagickCore/profile.c"
                                                  ) &&
      ...
      if ((icc_profile != (const StringInfo *) 
# 1009 "MagickCore/profile.c" 3 4
                                              ((void *)0)
# 1009 "MagickCore/profile.c"
                                                  ) &&
          (CompareStringInfo(icc_profile,profile) == 0))
        {
          profile=DestroyStringInfo(profile);
      ...
      (void) ThrowMagickException(exception,"MagickCore/profile.c",__func__,(unsigned long) 1016,
        MissingDelegateWarning,"DelegateLibrarySupportNotBuiltIn",
        "'%s' (LCMS)",image->filename);
# 1443 "MagickCore/profile.c"
    }
  profile=DestroyStringInfo(profile);
  return(status);
}
# 1473 "MagickCore/profile.c"
__attribute__ ((visibility ("default"))) StringInfo *RemoveImageProfile(Image *image,const char *name)
{
  StringInfo
    *profile;

  
# 1478 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 1478 "MagickCore/profile.c"
 image != (Image *) 
# 1478 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1478 "MagickCore/profile.c"
...
# 1478 "MagickCore/profile.c"
 "image != (Image *) NULL"
# 1478 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 1478, __extension__ __PRETTY_FUNCTION__); }))
# 1478 "MagickCore/profile.c"
                                ;
  
# 1479 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 1479 "MagickCore/profile.c"
 image->signature == 0xabacadabUL
# 1479 "MagickCore/profile.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1479 "MagickCore/profile.c"
...
# 1479 "MagickCore/profile.c"
 "image->signature == MagickCoreSignature"
# 1479 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 1479, __extension__ __PRETTY_FUNCTION__); }))
# 1479 "MagickCore/profile.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/profile.c",__func__,(unsigned long) 1481,"%s",image->filename);
  if (image->profiles == (SplayTreeInfo *) 
# 1482 "MagickCore/profile.c" 3 4
                                          ((void *)0)
# 1482 "MagickCore/profile.c"
                                              )
    return((StringInfo *) 
# 1483 "MagickCore/profile.c" 3 4
                         ((void *)0)
# 1483 "MagickCore/profile.c"
                             );
  WriteTo8BimProfile(image,name,(StringInfo *) 
# 1484 "MagickCore/profile.c" 3 4
                                              ((void *)0)
# 1484 "MagickCore/profile.c"
                                                  );
  profile=(StringInfo *) RemoveNodeFromSplayTree((SplayTreeInfo *)
    image->profiles,name);
  return(profile);
}
# 1514 "MagickCore/profile.c"
__attribute__ ((visibility ("default"))) void ResetImageProfileIterator(const Image *image)
{
  
# 1516 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 1516 "MagickCore/profile.c"
 image != (Image *) 
# 1516 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1516 "MagickCore/profile.c"
...
# 1516 "MagickCore/profile.c"
 "image != (Image *) NULL"
# 1516 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 1516, __extension__ __PRETTY_FUNCTION__); }))
# 1516 "MagickCore/profile.c"
                                ;
  
# 1517 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 1517 "MagickCore/profile.c"
 image->signature == 0xabacadabUL
# 1517 "MagickCore/profile.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1517 "MagickCore/profile.c"
...
# 1517 "MagickCore/profile.c"
 "image->signature == MagickCoreSignature"
# 1517 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 1517, __extension__ __PRETTY_FUNCTION__); }))
# 1517 "MagickCore/profile.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/profile.c",__func__,(unsigned long) 1519,"%s",image->filename);
  if (image->profiles == (SplayTreeInfo *) 
# 1520 "MagickCore/profile.c" 3 4
                                          ((void *)0)
# 1520 "MagickCore/profile.c"
                                              )
    return;
  ResetSplayTreeIterator((SplayTreeInfo *) image->profiles);
}
# 1556 "MagickCore/profile.c"
  ...
  const StringInfo *profile)
{
  ...
  profile_8bim=(StringInfo *) GetValueFromSplayTree((SplayTreeInfo *)
    image->profiles,"8bim");
  if (profile_8bim == (StringInfo *) 
# 1640 "MagickCore/profile.c" 3 4
                                    ((void *)0)
# 1640 "MagickCore/profile.c"
                                        )
    return;
...
# 1679 "MagickCore/profile.c" 3 4
                                     ((void *)0)
# 1679 "MagickCore/profile.c"
                                         )
          {
  ...
  if (LocaleCompare(name,"xmp") == 0)
    {
      ...
      if (p != (unsigned char *) 
# 1877 "MagickCore/profile.c" 3 4
                                ((void *)0)
# 1877 "MagickCore/profile.c"
                                    )
        {
          p+=19;
  ...
  if (LocaleCompare(name,"exif") == 0)
    {
      ...
      if ((LocaleNCompare((const char *) p,"MM",2) == 0) ||
          (LocaleNCompare((const char *) p,"II",2) == 0))
        {
          ...
          if (exif_profile != (StringInfo *) 
# 1905 "MagickCore/profile.c" 3 4
                                            ((void *)0)
# 1905 "MagickCore/profile.c"
                                                )
            {
  ...
  const StringInfo *profile,ExceptionInfo *exception)
{
  ...
  document=xmlReadMemory((const char *) GetStringInfoDatum(profile),(int)
    GetStringInfoLength(profile),"xmp.xml",
# 1931 "MagickCore/profile.c" 3 4
                                          ((void *)0)
# 1931 "MagickCore/profile.c"
                                              ,XML_PARSE_NOERROR |
    XML_PARSE_NOWARNING);
  if (document == (xmlDocPtr) 
# 1933 "MagickCore/profile.c" 3 4
                             ((void *)0)
# 1933 "MagickCore/profile.c"
                                 )
    {
      (void) ThrowMagickException(exception,"MagickCore/profile.c",__func__,(unsigned long) 1935,ImageWarning,
...
# 1962 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 1962 "MagickCore/profile.c"
 image != (Image *) 
# 1962 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1962 "MagickCore/profile.c"
...
# 1962 "MagickCore/profile.c"
 "image != (Image *) NULL"
# 1962 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 1962, __extension__ __PRETTY_FUNCTION__); }))
# 1962 "MagickCore/profile.c"
                                ;
  
# 1963 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 1963 "MagickCore/profile.c"
 image->signature == 0xabacadabUL
# 1963 "MagickCore/profile.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1963 "MagickCore/profile.c"
...
# 1963 "MagickCore/profile.c"
 "image->signature == MagickCoreSignature"
# 1963 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 1963, __extension__ __PRETTY_FUNCTION__); }))
# 1963 "MagickCore/profile.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/profile.c",__func__,(unsigned long) 1965,"%s",image->filename);
  ...
  if (image->profiles == (SplayTreeInfo *) 
# 1974 "MagickCore/profile.c" 3 4
                                          ((void *)0)
# 1974 "MagickCore/profile.c"
                                              )
...
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageProfile(Image *image,const char *name,
  const StringInfo *profile,ExceptionInfo *exception)
{
  return(SetImageProfileInternal(image,name,profile,MagickFalse,exception));
}
# 2021 "MagickCore/profile.c"
static inline int ReadProfileByte(unsigned char **p,size_t *length)
{
  ...
  if (*length < 1)
    return(
# 2027 "MagickCore/profile.c" 3 4
          (-1)
# 2027 "MagickCore/profile.c"
             );
  c=(int) (*(*p)++);
  (*length)--;
  return(c);
...
# 2246 "MagickCore/profile.c" 3 4
                                                                  ((void *)0)
# 2246 "MagickCore/profile.c"
                                                                      ,
    (void *(*)(void *)) 
# 2247 "MagickCore/profile.c" 3 4
                       ((void *)0)
# 2247 "MagickCore/profile.c"
                           ,(void *(*)(void *)) 
# 2247 "MagickCore/profile.c" 3 4
                                                ((void *)0)
# 2247 "MagickCore/profile.c"
      ...
      if ((tag_value == 0x8769) || (tag_value == 0xa005))
        {
          ...
          if (((size_t) offset < length) && (level < (16 -2)))
            {
  ...
  const char *tag,size_t *start,size_t *end)
{
  ...
  if ((pos == (char *) 
# 2487 "MagickCore/profile.c" 3 4
                      ((void *)0)
# 2487 "MagickCore/profile.c"
                          ) || ((pos-datum) < 1) || (*(pos-1) != '<') ||
  ...
  *start=(size_t) (pos-datum)+tag_length+1;
  ...
  if (pos == (char *) 
# 2493 "MagickCore/profile.c" 3 4
                     ((void *)0)
# 2493 "MagickCore/profile.c"
                         )
    return(MagickFalse);
...
__attribute__ ((visibility ("hidden"))) void SyncImageProfiles(Image *image)
{
  StringInfo
    *profile;
    ...
    switch (selector)
    {
      ...
      case 3:
      {
        if (knot_count != 0)
          {
            blob+=24;
            length-=(size_t) (((length) < (24U)) ? (length) : (24U));
            break;
          }
        ...
        blob+=22;
        length-=(size_t) (((length) < (22)) ? (length) : (22));
        break;
      }
      case 1:
      case 2:
        ...
        if (knot_count == 0)
          {
            ...
            blob+=24;
            length-=(size_t) (((length) < (24)) ? (length) : (24));
            break;
          }
...
__attribute__ ((visibility ("hidden"))) void Update8BIMClipPath(const Image *image,
  const size_t old_columns,const size_t old_rows,
  const RectangleInfo *new_geometry)
{
  const StringInfo
...
# 2692 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 2692 "MagickCore/profile.c"
 image != (Image *) 
# 2692 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2692 "MagickCore/profile.c"
...
# 2692 "MagickCore/profile.c"
 "image != (Image *) NULL"
# 2692 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 2692, __extension__ __PRETTY_FUNCTION__); }))
# 2692 "MagickCore/profile.c"
                                ;
  
# 2693 "MagickCore/profile.c" 3 4
 ((void) sizeof ((
# 2693 "MagickCore/profile.c"
 new_geometry != (RectangleInfo *) 
# 2693 "MagickCore/profile.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2693 "MagickCore/profile.c"
 new_geometry != (RectangleInfo *) 
# 2693 "MagickCore/profile.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 2693 "MagickCore/profile.c"
 "new_geometry != (RectangleInfo *) NULL"
# 2693 "MagickCore/profile.c" 3 4
 , "MagickCore/profile.c", 2693, __extension__ __PRETTY_FUNCTION__); }))
# 2693 "MagickCore/profile.c"
                                               ;
  profile=GetImageProfile(image,"8bim");
  if (profile == (StringInfo *) 
# 2695 "MagickCore/profile.c" 3 4
                               ((void *)0)
# 2695 "MagickCore/profile.c"
                                   )
    return;
  length=GetStringInfoLength(profile);
  ...
  while (length > 0)
  {
    ...
    info+=count;
    length-=(size_t) (((length) < ((size_t) count)) ? (length) : ((size_t) count));
  }
}
