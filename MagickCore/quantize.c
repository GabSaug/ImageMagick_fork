# 0 "MagickCore/quantize.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/quantize.c"
# 176 "MagickCore/quantize.c"
...
# 378 "MagickCore/quantize.c"
__attribute__ ((visibility ("default"))) QuantizeInfo *AcquireQuantizeInfo(const ImageInfo *image_info)
{
  QuantizeInfo
    *quantize_info;
...
# 385 "MagickCore/quantize.c" 3 4
                                 ((void *)0)
# 385 "MagickCore/quantize.c"
                                     )
    {
      const char
        *option;
...
# 393 "MagickCore/quantize.c" 3 4
                                  ((void *)0)
# 393 "MagickCore/quantize.c"
                                      )
  ...
  DoublePixelPacket *alpha_pixel)
{
  ...
  if ((cube_info->associate_alpha == MagickFalse) ||
      (GetPixelAlpha(image,pixel) == ((Quantum) ((Quantum) 65535.0))))
    {
  ...
  alpha=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelAlpha(image,pixel);
  ...
  const PixelInfo *pixel,DoublePixelPacket *alpha_pixel)
{
  ...
  if ((cube_info->associate_alpha == MagickFalse) ||
      (pixel->alpha == (double) ((Quantum) ((Quantum) 65535.0))))
    {
  ...
  alpha=(double) (((double) 1.0/(double) ((Quantum) 65535.0))*pixel->alpha);
  ...
  else
    {
      ...
      for (y=0; y < (ssize_t) image->rows; y++)
      {
        ...
        q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,
          exception);
        if (q == (Quantum *) 
# 558 "MagickCore/quantize.c" 3 4
                            ((void *)0)
# 558 "MagickCore/quantize.c"
                                )
          {
            status=MagickFalse;
            continue;
        ...
        for (x=0; x < (ssize_t) image->columns; x+=count)
        {
          ...
          for (index=8 -1; (ssize_t) index > 0; index--)
          {
            ...
            if (node_info->child[id] == (QNodeInfo *) 
# 597 "MagickCore/quantize.c" 3 4
                                                     ((void *)0)
# 597 "MagickCore/quantize.c"
                                                         )
              break;
          ...
          cube.target=pixel;
          cube.distance=(double) (4.0*((double) ((Quantum) 65535.0)+1.0)*
            ((double) ((Quantum) 65535.0)+1.0)+1.0);
...
# 630 "MagickCore/quantize.c" 3 4
                                                              ((void *)0)
# 630 "MagickCore/quantize.c"
                                                                  )
          {
            MagickBooleanType
              proceed;

            proceed=SetImageProgress(image,"Assign/Image",(MagickOffsetType) y,
              image->rows);
  ...
  if ((cube_info->quantize_info->number_colors == 2) &&
      (IsGrayColorspace(cube_info->quantize_info->colorspace)))
    {
      ...
      intensity=GetPixelInfoLuma(image->colormap+0) < (double)
        ((Quantum) 65535.0)/2.0 ? 0.0 : (double) ((Quantum) 65535.0);
      if (image->colors > 1)
        {
          intensity=0.0;
          if (GetPixelInfoLuma(image->colormap+0) >
              GetPixelInfoLuma(image->colormap+1))
            intensity=(double) ((Quantum) 65535.0);
        }
      ...
      if (image->colors > 1)
        {
          image->colormap[1].red=(double) ((Quantum) 65535.0)-intensity;
          image->colormap[1].green=(double) ((Quantum) 65535.0)-intensity;
          image->colormap[1].blue=(double) ((Quantum) 65535.0)-intensity;
        }
    }
  ...
  const Image *image,ExceptionInfo *exception)
{
  ...
  midpoint.red=(double) ((Quantum) 65535.0)/2.0;
  midpoint.green=(double) ((Quantum) 65535.0)/2.0;
  midpoint.blue=(double) ((Quantum) 65535.0)/2.0;
  midpoint.alpha=(double) ((Quantum) 65535.0)/2.0;
  error.alpha=0.0;
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (const Quantum *) 
# 817 "MagickCore/quantize.c" 3 4
                              ((void *)0)
# 817 "MagickCore/quantize.c"
                                  )
      break;
    ...
    for (x=0; x < (ssize_t) image->columns; x+=(ssize_t) count)
    {
      ...
      index=8 -1;
      bisect=((double) ((Quantum) 65535.0)+1.0)/2.0;
      mid=midpoint;
      ...
      for (level=1; level <= 8; level++)
      {
        ...
        if (node_info->child[id] == (QNodeInfo *) 
# 858 "MagickCore/quantize.c" 3 4
                                                 ((void *)0)
# 858 "MagickCore/quantize.c"
                                                     )
          {
            ...
            if (node_info->child[id] == (QNodeInfo *) 
# 864 "MagickCore/quantize.c" 3 4
                                                     ((void *)0)
# 864 "MagickCore/quantize.c"
                                                         )
              {
                (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 866,
        ...
        node_info=node_info->child[id];
        error.red=((double) 1.0/(double) ((Quantum) 65535.0))*(pixel.red-mid.red);
        error.green=((double) 1.0/(double) ((Quantum) 65535.0))*(pixel.green-mid.green);
        error.blue=((double) 1.0/(double) ((Quantum) 65535.0))*(pixel.blue-mid.blue);
        if (cube_info->associate_alpha != MagickFalse)
          error.alpha=((double) 1.0/(double) ((Quantum) 65535.0))*(pixel.alpha-mid.alpha);
        distance=(double) (error.red*error.red+error.green*error.green+
          error.blue*error.blue+error.alpha*error.alpha);
        if (
# 885 "MagickCore/quantize.c" 3 4
           __builtin_isnan (
# 885 "MagickCore/quantize.c"
           distance
# 885 "MagickCore/quantize.c" 3 4
           ) 
# 885 "MagickCore/quantize.c"
      ...
      node_info->number_unique=(size_t) ((ssize_t) node_info->number_unique+
        count);
      node_info->total_color.red+=count*((double) 1.0/(double) ((Quantum) 65535.0))*(double)
        ClampPixel(pixel.red);
      node_info->total_color.green+=count*((double) 1.0/(double) ((Quantum) 65535.0))*(double)
        ClampPixel(pixel.green);
      node_info->total_color.blue+=count*((double) 1.0/(double) ((Quantum) 65535.0))*(double)
        ClampPixel(pixel.blue);
      if (cube_info->associate_alpha != MagickFalse)
        node_info->total_color.alpha+=count*((double) 1.0/(double) ((Quantum) 65535.0))*(double)
          ClampPixel(pixel.alpha);
      else
        node_info->total_color.alpha+=count*((double) 1.0/(double) ((Quantum) 65535.0))*(double)
          ClampPixel((double) ((Quantum) ((Quantum) 65535.0)));
    ...
    proceed=SetImageProgress(image,"Classify/Image",(MagickOffsetType) y,
      image->rows);
    if (proceed == MagickFalse)
      break;
  }
  for (y++; y < (ssize_t) image->rows; y++)
  {
    ...
    p=GetCacheViewVirtualPixels(image_view,0,y,image->columns,1,exception);
    if (p == (const Quantum *) 
# 929 "MagickCore/quantize.c" 3 4
                              ((void *)0)
# 929 "MagickCore/quantize.c"
                                  )
      break;
    if (cube_info->nodes > 266817)
      {
    ...
    for (x=0; x < (ssize_t) image->columns; x+=(ssize_t) count)
    {
      ...
      for (level=1; level <= cube_info->depth; level++)
      {
        ...
        mid.alpha+=(id & 8) != 0 ? bisect : -bisect;
        if (node_info->child[id] == (QNodeInfo *) 
# 970 "MagickCore/quantize.c" 3 4
                                                 ((void *)0)
# 970 "MagickCore/quantize.c"
                                                     )
          {
            ...
            node_info->child[id]=GetQNodeInfo(cube_info,id,level,node_info);
            if (node_info->child[id] == (QNodeInfo *) 
# 976 "MagickCore/quantize.c" 3 4
                                                     ((void *)0)
# 976 "MagickCore/quantize.c"
                                                         )
              {
                (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 978,
                  ResourceLimitError,"MemoryAllocationFailed","%s",
                  image->filename);
                continue;
              }
        ...
        distance=(double) (error.red*error.red+error.green*error.green+
          error.blue*error.blue+error.alpha*error.alpha);
        if (
# 997 "MagickCore/quantize.c" 3 4
           __builtin_isnan (
# 997 "MagickCore/quantize.c"
           distance
# 997 "MagickCore/quantize.c" 3 4
           ) 
# 997 "MagickCore/quantize.c"
      ...
      if (cube_info->associate_alpha != MagickFalse)
        ...
        node_info->total_color.alpha+=count*((double) 1.0/(double) ((Quantum) 65535.0))*(double)
          ClampPixel((MagickRealType) ((Quantum) ((Quantum) 65535.0)));
      p+=count*(ssize_t) GetPixelChannels(image);
    }
    proceed=SetImageProgress(image,"Classify/Image",(MagickOffsetType) y,
      image->rows);
...
# 1061 "MagickCore/quantize.c"
__attribute__ ((visibility ("default"))) QuantizeInfo *CloneQuantizeInfo(const QuantizeInfo *quantize_info)
{
  QuantizeInfo
    *clone_info;
  ...
  if (quantize_info == (QuantizeInfo *) 
# 1068 "MagickCore/quantize.c" 3 4
                                       ((void *)0)
# 1068 "MagickCore/quantize.c"
                                           )
    return(clone_info);
  ...
  const QNodeInfo *node_info)
{
  ...
  for (i=0; i < (ssize_t) number_children; i++)
    if (node_info->child[i] != (QNodeInfo *) 
# 1121 "MagickCore/quantize.c" 3 4
                                            ((void *)0)
# 1121 "MagickCore/quantize.c"
                                                )
  ...
  if (node_info->number_unique != 0)
    {
      ...
      if (cube_info->associate_alpha != MagickFalse)
        {
          alpha=(MagickRealType) (((double) 1.0/(double) ((Quantum) 65535.0))*p->alpha);
          beta=(MagickRealType) (((double) 1.0/(double) ((Quantum) 65535.0))*q->alpha);
        }
...
# 1203 "MagickCore/quantize.c"
__attribute__ ((visibility ("default"))) MagickBooleanType CompressImageColormap(Image *image,
  ExceptionInfo *exception)
{
  QuantizeInfo
    quantize_info;
...
# 1209 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 1209 "MagickCore/quantize.c"
 image != (Image *) 
# 1209 "MagickCore/quantize.c" 3 4
...
# 1209 "MagickCore/quantize.c"
 "image != (Image *) NULL"
# 1209 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 1209, __extension__ __PRETTY_FUNCTION__); }))
# 1209 "MagickCore/quantize.c"
                                ;
  
# 1210 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 1210 "MagickCore/quantize.c"
...
# 1210 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 1210, __extension__ __PRETTY_FUNCTION__); }))
# 1210 "MagickCore/quantize.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/quantize.c",__func__,(unsigned long) 1212,"%s",image->filename);
  ...
  QNodeInfo *node_info)
{
  ...
  for (i=0; i < (ssize_t) number_children; i++)
    if (node_info->child[i] != (QNodeInfo *) 
# 1265 "MagickCore/quantize.c" 3 4
                                            ((void *)0)
# 1265 "MagickCore/quantize.c"
                                                )
  ...
  if (node_info->number_unique != 0)
    {
      ...
      if (cube_info->associate_alpha == MagickFalse)
        {
          q->red=(double) ClampToQuantum(alpha*(double) ((Quantum) 65535.0)*
            node_info->total_color.red);
          q->green=(double) ClampToQuantum(alpha*(double) ((Quantum) 65535.0)*
            node_info->total_color.green);
          q->blue=(double) ClampToQuantum(alpha*(double) ((Quantum) 65535.0)*
            node_info->total_color.blue);
          q->alpha=(double) ((Quantum) ((Quantum) 65535.0));
        }
      else
        {
          double
          ...
          opacity=(double) (alpha*(double) ((Quantum) 65535.0)*
            node_info->total_color.alpha);
          q->alpha=(double) ClampToQuantum(opacity);
          if (q->alpha == (double) ((Quantum) ((Quantum) 65535.0)))
            {
              q->red=(double) ClampToQuantum(alpha*(double) ((Quantum) 65535.0)*
                node_info->total_color.red);
              q->green=(double) ClampToQuantum(alpha*(double) ((Quantum) 65535.0)*
          ...
          else
            {
              ...
              gamma=(double) (((double) 1.0/(double) ((Quantum) 65535.0))*q->alpha);
              gamma=PerceptibleReciprocal(gamma);
              q->red=(double) ClampToQuantum(alpha*gamma*(double) ((Quantum) 65535.0)*
                node_info->total_color.red);
              q->green=(double) ClampToQuantum(alpha*gamma*(double)
                ((Quantum) 65535.0)*node_info->total_color.green);
              q->blue=(double) ClampToQuantum(alpha*gamma*(double) ((Quantum) 65535.0)*
                node_info->total_color.blue);
...
static void DestroyQCubeInfo(QCubeInfo *cube_info)
{
  ...
  do
  {
    ...
    cube_info->node_queue=nodes;
  } while (cube_info->node_queue != (QNodes *) 
# 1370 "MagickCore/quantize.c" 3 4
                                              ((void *)0)
# 1370 "MagickCore/quantize.c"
                                                  );
  if (cube_info->memory_info != (MemoryInfo *) 
# 1371 "MagickCore/quantize.c" 3 4
                                              ((void *)0)
# 1371 "MagickCore/quantize.c"
                                                  )
...
# 1400 "MagickCore/quantize.c"
__attribute__ ((visibility ("default"))) QuantizeInfo *DestroyQuantizeInfo(QuantizeInfo *quantize_info)
{
  
# 1402 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 1402 "MagickCore/quantize.c"
...
# 1402 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 1402, __extension__ __PRETTY_FUNCTION__); }))
# 1402 "MagickCore/quantize.c"
                                               ;
  
# 1403 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 1403 "MagickCore/quantize.c"
 quantize_info->signature == 0xabacadabUL
# 1403 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1403 "MagickCore/quantize.c"
 quantize_info->signature == 0xabacadabUL
...
# 1403 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 1403, __extension__ __PRETTY_FUNCTION__); }))
# 1403 "MagickCore/quantize.c"
                                                        ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/quantize.c",__func__,(unsigned long) 1405,"...");
  quantize_info->signature=(~0xabacadabUL);
  quantize_info=(QuantizeInfo *) RelinquishMagickMemory(quantize_info);
  return(quantize_info);
}
# 1442 "MagickCore/quantize.c"
...
# 1447 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 1447 "MagickCore/quantize.c"
...
# 1447 "MagickCore/quantize.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 1447 "MagickCore/quantize.c"
 "pixels != (DoublePixelPacket **) NULL"
# 1447 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 1447, __extension__ __PRETTY_FUNCTION__); }))
# 1447 "MagickCore/quantize.c"
                                              ;
  for (i=0; i < (ssize_t) GetMagickResourceLimit(ThreadResource); i++)
    if (pixels[i] != (DoublePixelPacket *) 
# 1449 "MagickCore/quantize.c" 3 4
                                          ((void *)0)
# 1449 "MagickCore/quantize.c"
                                              )
...
static DoublePixelPacket **AcquirePixelTLS(const size_t count)
{
  ...
  pixels=(DoublePixelPacket **) AcquireQuantumMemory(number_threads,
    sizeof(*pixels));
  if (pixels == (DoublePixelPacket **) 
# 1469 "MagickCore/quantize.c" 3 4
                                      ((void *)0)
# 1469 "MagickCore/quantize.c"
                                          )
    return((DoublePixelPacket **) 
# 1470 "MagickCore/quantize.c" 3 4
                                 ((void *)0)
# 1470 "MagickCore/quantize.c"
                                     );
  ...
  for (i=0; i < (ssize_t) number_threads; i++)
  {
    pixels[i]=(DoublePixelPacket *) AcquireQuantumMemory(count,2*
      sizeof(**pixels));
    if (pixels[i] == (DoublePixelPacket *) 
# 1476 "MagickCore/quantize.c" 3 4
                                          ((void *)0)
# 1476 "MagickCore/quantize.c"
                                              )
  ...
  const DoublePixelPacket *pixel)
{
  ...
  offset=(ssize_t) ((((ScaleQuantumToChar(ClampPixel(pixel->red))) >> 2) << (0*(8-2))) |
    (((ScaleQuantumToChar(ClampPixel(pixel->green))) >> 2) << (1*(8-2))) |
    (((ScaleQuantumToChar(ClampPixel(pixel->blue))) >> 2) << (2*(8-2))));
  if (cube_info->associate_alpha != MagickFalse)
    offset|=(((ScaleQuantumToChar(ClampPixel(pixel->alpha))) >> 2) << (3*(8-2)));
  return(offset);
}
  ...
  ExceptionInfo *exception)
{
  ...
  if (pixels == (DoublePixelPacket **) 
# 1522 "MagickCore/quantize.c" 3 4
                                      ((void *)0)
# 1522 "MagickCore/quantize.c"
                                          )
    return(MagickFalse);
  status=MagickTrue;
  image_view=AcquireAuthenticCacheView(image,exception);
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (q == (Quantum *) 
# 1551 "MagickCore/quantize.c" 3 4
                        ((void *)0)
# 1551 "MagickCore/quantize.c"
                            )
      {
        status=MagickFalse;
        continue;
      ...
      if (cube.cache[i] < 0)
        {
          ...
          for (index=8 -1; (ssize_t) index > 0; index--)
          {
            ...
            if (node_info->child[node_id] == (QNodeInfo *) 
# 1628 "MagickCore/quantize.c" 3 4
                                                          ((void *)0)
# 1628 "MagickCore/quantize.c"
                                                              )
              break;
          ...
          cube.target=pixel;
          cube.distance=(double) (4.0*((double) ((Quantum) 65535.0)+1.0)*((double)
            ((Quantum) 65535.0)+1.0)+1.0);
          ClosestColor(image,&cube,node_info->parent);
      ...
      if (image->progress_monitor != (MagickProgressMonitor) 
# 1671 "MagickCore/quantize.c" 3 4
                                                            ((void *)0)
# 1671 "MagickCore/quantize.c"
                                                                )
        {
          MagickBooleanType
            proceed;

          proceed=SetImageProgress(image,"Dither/Image",(MagickOffsetType) y,
            image->rows);
          if (proceed == MagickFalse)
            status=MagickFalse;
        }
  ...
  QCubeInfo *cube_info,const unsigned int direction,ExceptionInfo *exception)
{
  ...
  if ((p->x >= 0) && (p->x < (ssize_t) image->columns) &&
      (p->y >= 0) && (p->y < (ssize_t) image->rows))
    {
      ...
      if (q == (Quantum *) 
# 1720 "MagickCore/quantize.c" 3 4
                          ((void *)0)
# 1720 "MagickCore/quantize.c"
                              )
        return(MagickFalse);
      AssociateAlphaPixel(image,cube_info,q,&pixel);
      for (i=0; i < 16; i++)
      {
        pixel.red+=PerceptibleReciprocal(16)*cube_info->diffusion*p->weights[i]*
          p->error[i].red;
        pixel.green+=PerceptibleReciprocal(16)*cube_info->diffusion*p->weights[i]*
          p->error[i].green;
        pixel.blue+=PerceptibleReciprocal(16)*cube_info->diffusion*p->weights[i]*
          p->error[i].blue;
        if (cube_info->associate_alpha != MagickFalse)
          pixel.alpha+=PerceptibleReciprocal(16)*cube_info->diffusion*p->weights[i]*
            p->error[i].alpha;
      }
      pixel.red=(double) ClampPixel(pixel.red);
      pixel.green=(double) ClampPixel(pixel.green);
      ...
      if (p->cache[i] < 0)
        {
          ...
          for (index=8 -1; (ssize_t) index > 0; index--)
          {
            id=ColorToQNodeId(cube_info,&pixel,index);
            if (node_info->child[id] == (QNodeInfo *) 
# 1756 "MagickCore/quantize.c" 3 4
                                                     ((void *)0)
# 1756 "MagickCore/quantize.c"
                                                         )
              break;
            node_info=node_info->child[id];
          }
          ...
          p->target=pixel;
          p->distance=(double) (4.0*((double) ((Quantum) 65535.0)+1.0)*((double)
            ((Quantum) 65535.0)+1.0)+1.0);
      ...
      (void) memmove(p->error,p->error+1,(16 -1)*
        sizeof(p->error[0]));
      AssociateAlphaPixelInfo(cube_info,image->colormap+index,&color);
      p->error[16 -1].red=pixel.red-color.red;
      p->error[16 -1].green=pixel.green-color.green;
      p->error[16 -1].blue=pixel.blue-color.blue;
      if (cube_info->associate_alpha != MagickFalse)
        p->error[16 -1].alpha=pixel.alpha-color.alpha;
      proceed=SetImageProgress(image,"Dither/Image",p->offset,p->span);
      if (proceed == MagickFalse)
        return(MagickFalse);
      p->offset++;
    }
...
# 1995 "MagickCore/quantize.c" 3 4
                                ((void *)0)
# 1995 "MagickCore/quantize.c"
                                    )
  ...
  (void) memset(cube_info->error,0,16*sizeof(*cube_info->error));
  cube_info->x=0;
  cube_info->y=0;
  extent=(((image->columns) > (image->rows)) ? (image->columns) : (image->rows));
  ...
  const size_t depth,const size_t maximum_colors)
{
  ...
  if (cube_info == (QCubeInfo *) 
# 2074 "MagickCore/quantize.c" 3 4
                                ((void *)0)
# 2074 "MagickCore/quantize.c"
                                    )
    return((QCubeInfo *) 
# 2075 "MagickCore/quantize.c" 3 4
                        ((void *)0)
# 2075 "MagickCore/quantize.c"
                            );
  (void) memset(cube_info,0,sizeof(*cube_info));
  cube_info->depth=depth;
  if (cube_info->depth > 8)
    cube_info->depth=8;
  ...
  cube_info->root=GetQNodeInfo(cube_info,0,0,(QNodeInfo *) 
# 2086 "MagickCore/quantize.c" 3 4
                                                          ((void *)0)
# 2086 "MagickCore/quantize.c"
                                                              );
  if (cube_info->root == (QNodeInfo *) 
# 2087 "MagickCore/quantize.c" 3 4
                                      ((void *)0)
# 2087 "MagickCore/quantize.c"
                                          )
    return((QCubeInfo *) 
# 2088 "MagickCore/quantize.c" 3 4
                        ((void *)0)
# 2088 "MagickCore/quantize.c"
                            );
  ...
  length=(size_t) (1UL << (4*(8-2)));
  cube_info->memory_info=AcquireVirtualMemory(length,sizeof(*cube_info->cache));
  if (cube_info->memory_info == (MemoryInfo *) 
# 2098 "MagickCore/quantize.c" 3 4
                                              ((void *)0)
# 2098 "MagickCore/quantize.c"
                                                  )
    return((QCubeInfo *) 
# 2099 "MagickCore/quantize.c" 3 4
                        ((void *)0)
# 2099 "MagickCore/quantize.c"
                            );
  ...
  for (i=0; i < 16; i++)
  {
    ...
    weight*=exp(log(1.0/PerceptibleReciprocal(16))/(16 -1.0));
  }
  cube_info->diffusion=1.0;
  return(cube_info);
}
# 2146 "MagickCore/quantize.c"
  ...
  if (cube_info->free_nodes == 0)
    {
      ...
      if (nodes == (QNodes *) 
# 2161 "MagickCore/quantize.c" 3 4
                             ((void *)0)
# 2161 "MagickCore/quantize.c"
                                 )
        return((QNodeInfo *) 
# 2162 "MagickCore/quantize.c" 3 4
                            ((void *)0)
# 2162 "MagickCore/quantize.c"
                                );
      nodes->nodes=(QNodeInfo *) AcquireQuantumMemory(1920,
        sizeof(*nodes->nodes));
      if (nodes->nodes == (QNodeInfo *) 
# 2165 "MagickCore/quantize.c" 3 4
                                       ((void *)0)
# 2165 "MagickCore/quantize.c"
                                           )
        return((QNodeInfo *) 
# 2166 "MagickCore/quantize.c" 3 4
                            ((void *)0)
# 2166 "MagickCore/quantize.c"
                                );
...
# 2224 "MagickCore/quantize.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetImageQuantizeError(Image *image,
  ExceptionInfo *exception)
{
  CacheView
    *image_view;
...
# 2243 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2243 "MagickCore/quantize.c"
 image != (Image *) 
# 2243 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2243 "MagickCore/quantize.c"
...
# 2243 "MagickCore/quantize.c"
 "image != (Image *) NULL"
# 2243 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2243, __extension__ __PRETTY_FUNCTION__); }))
# 2243 "MagickCore/quantize.c"
                                ;
  
# 2244 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2244 "MagickCore/quantize.c"
 image->signature == 0xabacadabUL
# 2244 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2244 "MagickCore/quantize.c"
...
# 2244 "MagickCore/quantize.c"
 "image->signature == MagickCoreSignature"
# 2244 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2244, __extension__ __PRETTY_FUNCTION__); }))
# 2244 "MagickCore/quantize.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/quantize.c",__func__,(unsigned long) 2246,"%s",image->filename);
  image->total_colors=GetNumberColors(image,(FILE *) 
# 2247 "MagickCore/quantize.c" 3 4
                                                    ((void *)0)
# 2247 "MagickCore/quantize.c"
                                                        ,exception);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    p=GetCacheViewVirtualPixels(image_view,0,y,image->columns,1,exception);
    if (p == (const Quantum *) 
# 2267 "MagickCore/quantize.c" 3 4
                              ((void *)0)
# 2267 "MagickCore/quantize.c"
                                  )
      break;
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      ...
      if (image->alpha_trait != UndefinedPixelTrait)
        {
          ...
          beta=(double) (((double) 1.0/(double) ((Quantum) 65535.0))*image->colormap[index].alpha);
        }
  ...
  image->error.normalized_mean_error=(double) ((double) 1.0/(double) ((Quantum) 65535.0))*((double) 1.0/(double) ((Quantum) 65535.0))*
    mean_error/area;
  image->error.normalized_maximum_error=(double) ((double) 1.0/(double) ((Quantum) 65535.0))*maximum_error;
  return(MagickTrue);
}
# 2328 "MagickCore/quantize.c"
__attribute__ ((visibility ("default"))) void GetQuantizeInfo(QuantizeInfo *quantize_info)
{
  
# 2330 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2330 "MagickCore/quantize.c"
 quantize_info != (QuantizeInfo *) 
# 2330 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2330 "MagickCore/quantize.c"
...
# 2330 "MagickCore/quantize.c"
 "quantize_info != (QuantizeInfo *) NULL"
# 2330 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2330, __extension__ __PRETTY_FUNCTION__); }))
# 2330 "MagickCore/quantize.c"
                                               ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/quantize.c",__func__,(unsigned long) 2332,"...");
...
# 2392 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2392 "MagickCore/quantize.c"
...
# 2392 "MagickCore/quantize.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 2392 "MagickCore/quantize.c"
 "kmeans_info != (KmeansInfo **) NULL"
# 2392 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2392, __extension__ __PRETTY_FUNCTION__); }))
# 2392 "MagickCore/quantize.c"
                                            ;
  for (i=0; i < (ssize_t) GetMagickResourceLimit(ThreadResource); i++)
    if (kmeans_info[i] != (KmeansInfo *) 
# 2394 "MagickCore/quantize.c" 3 4
                                        ((void *)0)
# 2394 "MagickCore/quantize.c"
                                            )
...
static KmeansInfo **AcquireKmeansTLS(const size_t number_colors)
{
  ...
  kmeans_info=(KmeansInfo **) AcquireQuantumMemory(number_threads,
    sizeof(*kmeans_info));
  if (kmeans_info == (KmeansInfo **) 
# 2425 "MagickCore/quantize.c" 3 4
                                    ((void *)0)
# 2425 "MagickCore/quantize.c"
                                        )
    return((KmeansInfo **) 
# 2426 "MagickCore/quantize.c" 3 4
                          ((void *)0)
# 2426 "MagickCore/quantize.c"
                              );
  ...
  for (i=0; i < (ssize_t) number_threads; i++)
  {
    kmeans_info[i]=(KmeansInfo *) AcquireQuantumMemory(number_colors,
      sizeof(**kmeans_info));
    if (kmeans_info[i] == (KmeansInfo *) 
# 2432 "MagickCore/quantize.c" 3 4
                                        ((void *)0)
# 2432 "MagickCore/quantize.c"
                                            )
...
static inline double KmeansMetric(const Image *__restrict__ image,
  const Quantum *__restrict__ p,const PixelInfo *__restrict__ q)
{
  double
    gamma,
    metric,
  ...
  if ((image->alpha_trait != UndefinedPixelTrait) ||
      (q->alpha_trait != UndefinedPixelTrait))
    {
      pixel=(double) GetPixelAlpha(image,p)-(q->alpha_trait !=
        UndefinedPixelTrait ? q->alpha : (double) ((Quantum) ((Quantum) 65535.0)));
      metric+=pixel*pixel;
      if (image->alpha_trait != UndefinedPixelTrait)
        gamma*=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelAlpha(image,p);
      if (q->alpha_trait != UndefinedPixelTrait)
        gamma*=((double) 1.0/(double) ((Quantum) 65535.0))*q->alpha;
    }
  if (image->colorspace == CMYKColorspace)
    {
      pixel=((double) 1.0/(double) ((Quantum) 65535.0))*((double) GetPixelBlack(image,p)-q->black);
      metric+=gamma*pixel*pixel;
      gamma*=((double) 1.0/(double) ((Quantum) 65535.0))*((double) ((Quantum) 65535.0)-(double)
        GetPixelBlack(image,p));
      gamma*=((double) 1.0/(double) ((Quantum) 65535.0))*((double) ((Quantum) 65535.0)-q->black);
    }
  metric*=3.0;
  pixel=((double) 1.0/(double) ((Quantum) 65535.0))*((double) GetPixelRed(image,p)-q->red);
  ...
  metric+=gamma*pixel*pixel;
  pixel=((double) 1.0/(double) ((Quantum) 65535.0))*((double) GetPixelGreen(image,p)-q->green);
  metric+=gamma*pixel*pixel;
  pixel=((double) 1.0/(double) ((Quantum) 65535.0))*((double) GetPixelBlue(image,p)-q->blue);
  metric+=gamma*pixel*pixel;
  return(metric);
}

__attribute__ ((visibility ("default"))) MagickBooleanType KmeansImage(Image *image,
...
# 2519 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2519 "MagickCore/quantize.c"
 image != (Image *) 
# 2519 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2519 "MagickCore/quantize.c"
...
# 2519 "MagickCore/quantize.c"
 "image != (Image *) NULL"
# 2519 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2519, __extension__ __PRETTY_FUNCTION__); }))
# 2519 "MagickCore/quantize.c"
                                ;
  
# 2520 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2520 "MagickCore/quantize.c"
 image->signature == 0xabacadabUL
# 2520 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2520 "MagickCore/quantize.c"
...
# 2520 "MagickCore/quantize.c"
 "image->signature == MagickCoreSignature"
# 2520 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2520, __extension__ __PRETTY_FUNCTION__); }))
# 2520 "MagickCore/quantize.c"
                                                ;
  
# 2521 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2521 "MagickCore/quantize.c"
...
# 2521 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2521, __extension__ __PRETTY_FUNCTION__); }))
# 2521 "MagickCore/quantize.c"
                                            ;
  
# 2522 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2522 "MagickCore/quantize.c"
...
# 2522 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2522, __extension__ __PRETTY_FUNCTION__); }))
# 2522 "MagickCore/quantize.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/quantize.c",__func__,(unsigned long) 2524,"%s",image->filename);
  if (max_iterations == 0)
    return(MagickFalse);
  colors=GetImageArtifact(image,"kmeans:seed-colors");
  if (colors == (const char *) 
# 2528 "MagickCore/quantize.c" 3 4
                              ((void *)0)
# 2528 "MagickCore/quantize.c"
                                  )
    {
      QCubeInfo
        *cube_info;
      ...
      quantize_info=AcquireQuantizeInfo((ImageInfo *) 
# 2542 "MagickCore/quantize.c" 3 4
                                                     ((void *)0)
# 2542 "MagickCore/quantize.c"
                                                         );
      ...
      if (cube_info == (QCubeInfo *) 
# 2550 "MagickCore/quantize.c" 3 4
                                    ((void *)0)
# 2550 "MagickCore/quantize.c"
                                        )
        {
          quantize_info=DestroyQuantizeInfo(quantize_info);
          { (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 2553,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                            ;
        }
  ...
  else
    {
      ...
      for (n=0, p=colors; n < (ssize_t) image->colors; n++)
      {
        ...
        for (q=p; *q != '\0'; q++)
          if (*q == ';')
            break;
        (void) CopyMagickString(color,p,(size_t) (((q-p+1) < (4096)) ? (q-p+1) : (4096))
                           );
      ...
      if (n < (ssize_t) image->colors)
        {
          ...
          for ( ; n < (ssize_t) image->colors; n++)
          {
            (void) QueryColorCompliance("#000",AllCompliance,image->colormap+n,
              exception);
            image->colormap[n].red=((double) ((Quantum) 65535.0)*GetPseudoRandomValue(random_info));
            image->colormap[n].green=((double) ((Quantum) 65535.0)*GetPseudoRandomValue(random_info));
            image->colormap[n].blue=((double) ((Quantum) 65535.0)*GetPseudoRandomValue(random_info));
            if (image->alpha_trait != UndefinedPixelTrait)
              image->colormap[n].alpha=((double) ((Quantum) 65535.0)*GetPseudoRandomValue(random_info));
            if (image->colorspace == CMYKColorspace)
              image->colormap[n].black=((double) ((Quantum) 65535.0)*GetPseudoRandomValue(random_info));
          }
  ...
  if (kmeans_pixels == (KmeansInfo **) 
# 2629 "MagickCore/quantize.c" 3 4
                                      ((void *)0)
# 2629 "MagickCore/quantize.c"
                                          )
    { (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 2630,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  ...
  for (n=0; n < (ssize_t) max_iterations; n++)
  {
    ...
    for (y=0; y < (ssize_t) image->rows; y++)
    {
      ...
      q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
      if (q == (Quantum *) 
# 2665 "MagickCore/quantize.c" 3 4
                          ((void *)0)
# 2665 "MagickCore/quantize.c"
                              )
        {
          status=MagickFalse;
          continue;
      ...
      for (x=0; x < (ssize_t) image->columns; x++)
      {
        ...
        kmeans_pixels[id][k].red+=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelRed(image,q);
        kmeans_pixels[id][k].green+=((double) 1.0/(double) ((Quantum) 65535.0))*(double)
          GetPixelGreen(image,q);
        kmeans_pixels[id][k].blue+=((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelBlue(image,q);
        if (image->alpha_trait != UndefinedPixelTrait)
          kmeans_pixels[id][k].alpha+=((double) 1.0/(double) ((Quantum) 65535.0))*(double)
            GetPixelAlpha(image,q);
        if (image->colorspace == CMYKColorspace)
          kmeans_pixels[id][k].black+=((double) 1.0/(double) ((Quantum) 65535.0))*(double)
    ...
    for (j=0; j < (ssize_t) image->colors; j++)
    {
      ...
      image->colormap[j].red=gamma*(double) ((Quantum) 65535.0)*
        kmeans_pixels[0][j].red;
      image->colormap[j].green=gamma*(double) ((Quantum) 65535.0)*
        kmeans_pixels[0][j].green;
      image->colormap[j].blue=gamma*(double) ((Quantum) 65535.0)*
        kmeans_pixels[0][j].blue;
      if (image->alpha_trait != UndefinedPixelTrait)
        image->colormap[j].alpha=gamma*(double) ((Quantum) 65535.0)*
        kmeans_pixels[0][j].alpha;
      if (image->colorspace == CMYKColorspace)
        image->colormap[j].black=gamma*(double) ((Quantum) 65535.0)*
    ...
    if (image->debug != MagickFalse)
      (void) LogMagickEvent(ImageEvent,"MagickCore/quantize.c",__func__,(unsigned long) 2765,
    ...
    if (image->progress_monitor != (MagickProgressMonitor) 
# 2771 "MagickCore/quantize.c" 3 4
                                                          ((void *)0)
# 2771 "MagickCore/quantize.c"
                                                              )
      {
        MagickBooleanType
          proceed;

        proceed=SetImageProgress(image,"Kmeans/Image",(MagickOffsetType) n,
          max_iterations);
        if (proceed == MagickFalse)
          status=MagickFalse;
      }
...
# 2787 "MagickCore/quantize.c" 3 4
                             stderr
# 2787 "MagickCore/quantize.c"
                                   ,"%s %.20g\n",tuple,(double)
        image->colormap[n].count);
    }
  dominant_image=CloneImage(image,0,0,MagickTrue,exception);
  if (dominant_image != (Image *) 
# 2791 "MagickCore/quantize.c" 3 4
                                 ((void *)0)
# 2791 "MagickCore/quantize.c"
                                     )
    {
  ...
  if (image->progress_monitor != (MagickProgressMonitor) 
# 2803 "MagickCore/quantize.c" 3 4
                                                        ((void *)0)
# 2803 "MagickCore/quantize.c"
                                                            )
    (void) SetImageProgress(image,"Kmeans/Image",(MagickOffsetType)
      max_iterations-1,max_iterations);
  if (status == MagickFalse)
    return(status);
  return(SyncImage(image,exception));
}
# 2844 "MagickCore/quantize.c"
...
__attribute__ ((visibility ("default"))) MagickBooleanType PosterizeImage(Image *image,const size_t levels,
...
# 2880 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2880 "MagickCore/quantize.c"
 image != (Image *) 
# 2880 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2880 "MagickCore/quantize.c"
...
# 2880 "MagickCore/quantize.c"
 "image != (Image *) NULL"
# 2880 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2880, __extension__ __PRETTY_FUNCTION__); }))
# 2880 "MagickCore/quantize.c"
                                ;
  
# 2881 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2881 "MagickCore/quantize.c"
 image->signature == 0xabacadabUL
# 2881 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2881 "MagickCore/quantize.c"
...
# 2881 "MagickCore/quantize.c"
 "image->signature == MagickCoreSignature"
# 2881 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2881, __extension__ __PRETTY_FUNCTION__); }))
# 2881 "MagickCore/quantize.c"
                                                ;
  
# 2882 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2882 "MagickCore/quantize.c"
 exception != (ExceptionInfo *) 
# 2882 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2882 "MagickCore/quantize.c"
...
# 2882 "MagickCore/quantize.c"
 "exception != (ExceptionInfo *) NULL"
# 2882 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2882, __extension__ __PRETTY_FUNCTION__); }))
# 2882 "MagickCore/quantize.c"
                                            ;
  
# 2883 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 2883 "MagickCore/quantize.c"
 exception->signature == 0xabacadabUL
# 2883 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2883 "MagickCore/quantize.c"
...
# 2883 "MagickCore/quantize.c"
 "exception->signature == MagickCoreSignature"
# 2883 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 2883, __extension__ __PRETTY_FUNCTION__); }))
# 2883 "MagickCore/quantize.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/quantize.c",__func__,(unsigned long) 2885,"%s",image->filename);
  if (image->storage_class == PseudoClass)
    ...
    for (i=0; i < (ssize_t) image->colors; i++)
    {
      ...
      if ((GetPixelRedTraits(image) & UpdatePixelTrait) != 0)
        image->colormap[i].red=(double)
          ClampToQuantum((MagickRealType) ((Quantum) 65535.0)*( MagickRound(((double) 1.0/(double) ((Quantum) 65535.0))*(double) image->colormap[i].red*(levels-1)))/ ((((ssize_t) levels-1) > (1)) ? ((ssize_t) levels-1) : (1)));
      if ((GetPixelGreenTraits(image) & UpdatePixelTrait) != 0)
        image->colormap[i].green=(double)
          ClampToQuantum((MagickRealType) ((Quantum) 65535.0)*( MagickRound(((double) 1.0/(double) ((Quantum) 65535.0))*(double) image->colormap[i].green*(levels-1)))/ ((((ssize_t) levels-1) > (1)) ? ((ssize_t) levels-1) : (1)));
      if ((GetPixelBlueTraits(image) & UpdatePixelTrait) != 0)
        image->colormap[i].blue=(double)
          ClampToQuantum((MagickRealType) ((Quantum) 65535.0)*( MagickRound(((double) 1.0/(double) ((Quantum) 65535.0))*(double) image->colormap[i].blue*(levels-1)))/ ((((ssize_t) levels-1) > (1)) ? ((ssize_t) levels-1) : (1)));
      if ((GetPixelAlphaTraits(image) & UpdatePixelTrait) != 0)
        image->colormap[i].alpha=(double)
          ClampToQuantum((MagickRealType) ((Quantum) 65535.0)*( MagickRound(((double) 1.0/(double) ((Quantum) 65535.0))*(double) image->colormap[i].alpha*(levels-1)))/ ((((ssize_t) levels-1) > (1)) ? ((ssize_t) levels-1) : (1)));
    }
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 2930 "MagickCore/quantize.c" 3 4
                        ((void *)0)
# 2930 "MagickCore/quantize.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    {
      if ((GetPixelRedTraits(image) & UpdatePixelTrait) != 0)
        SetPixelRed(image,ClampToQuantum((MagickRealType) ((Quantum) 65535.0)*( MagickRound(((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelRed(image,q)*(levels-1)))/ ((((ssize_t) levels-1) > (1)) ? ((ssize_t) levels-1) : (1))),q);
      if ((GetPixelGreenTraits(image) & UpdatePixelTrait) != 0)
        SetPixelGreen(image,ClampToQuantum((MagickRealType) ((Quantum) 65535.0)*( MagickRound(((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelGreen(image,q)*(levels-1)))/ ((((ssize_t) levels-1) > (1)) ? ((ssize_t) levels-1) : (1))),q);
      if ((GetPixelBlueTraits(image) & UpdatePixelTrait) != 0)
        SetPixelBlue(image,ClampToQuantum((MagickRealType) ((Quantum) 65535.0)*( MagickRound(((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelBlue(image,q)*(levels-1)))/ ((((ssize_t) levels-1) > (1)) ? ((ssize_t) levels-1) : (1))),q);
      if (((GetPixelBlackTraits(image) & UpdatePixelTrait) != 0) &&
          (image->colorspace == CMYKColorspace))
        SetPixelBlack(image,ClampToQuantum((MagickRealType) ((Quantum) 65535.0)*( MagickRound(((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelBlack(image,q)*(levels-1)))/ ((((ssize_t) levels-1) > (1)) ? ((ssize_t) levels-1) : (1))),q);
      if (((GetPixelAlphaTraits(image) & UpdatePixelTrait) != 0) &&
          (image->alpha_trait != UndefinedPixelTrait))
        SetPixelAlpha(image,ClampToQuantum((MagickRealType) ((Quantum) 65535.0)*( MagickRound(((double) 1.0/(double) ((Quantum) 65535.0))*(double) GetPixelAlpha(image,q)*(levels-1)))/ ((((ssize_t) levels-1) > (1)) ? ((ssize_t) levels-1) : (1))),q);
      q+=GetPixelChannels(image);
    }
    if (SyncCacheViewAuthenticPixels(image_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 2953 "MagickCore/quantize.c" 3 4
                                                          ((void *)0)
# 2953 "MagickCore/quantize.c"
                                                              )
      {
        MagickBooleanType
          proceed;
  ...
  image_view=DestroyCacheView(image_view);
  quantize_info=AcquireQuantizeInfo((ImageInfo *) 
# 2968 "MagickCore/quantize.c" 3 4
                                                 ((void *)0)
# 2968 "MagickCore/quantize.c"
                                                     );
  quantize_info->number_colors=(size_t) (((levels*levels*levels) < (65536UL +1)) ? (levels*levels*levels) : (65536UL +1))
                      ;
...
static void PruneChild(QCubeInfo *cube_info,const QNodeInfo *node_info)
{
  ...
  for (i=0; i < (ssize_t) number_children; i++)
    if (node_info->child[i] != (QNodeInfo *) 
# 3019 "MagickCore/quantize.c" 3 4
                                            ((void *)0)
# 3019 "MagickCore/quantize.c"
                                                )
  ...
  if (cube_info->nodes > cube_info->maximum_colors)
    {
      ...
      parent->child[node_info->id]=(QNodeInfo *) 
# 3032 "MagickCore/quantize.c" 3 4
                                                ((void *)0)
# 3032 "MagickCore/quantize.c"
                                                    ;
      cube_info->nodes--;
    }
}
# 3062 "MagickCore/quantize.c"
static void PruneLevel(QCubeInfo *cube_info,const QNodeInfo *node_info)
{
  ...
  for (i=0; i < (ssize_t) number_children; i++)
    if (node_info->child[i] != (QNodeInfo *) 
# 3075 "MagickCore/quantize.c" 3 4
                                            ((void *)0)
# 3075 "MagickCore/quantize.c"
                                                )
      PruneLevel(cube_info,node_info->child[i]);
  if (node_info->level == cube_info->depth)
    PruneChild(cube_info,node_info);
}
# 3107 "MagickCore/quantize.c"
static void PruneToCubeDepth(QCubeInfo *cube_info,const QNodeInfo *node_info)
{
  ...
  for (i=0; i < (ssize_t) number_children; i++)
    if (node_info->child[i] != (QNodeInfo *) 
# 3120 "MagickCore/quantize.c" 3 4
                                            ((void *)0)
# 3120 "MagickCore/quantize.c"
                                                )
      PruneToCubeDepth(cube_info,node_info->child[i]);
  if (node_info->level > cube_info->depth)
    PruneChild(cube_info,node_info);
}
# 3156 "MagickCore/quantize.c"
__attribute__ ((visibility ("default"))) MagickBooleanType QuantizeImage(const QuantizeInfo *quantize_info,
...
# 3172 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3172 "MagickCore/quantize.c"
 quantize_info != (const QuantizeInfo *) 
# 3172 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3172 "MagickCore/quantize.c"
 quantize_info != (const QuantizeInfo *) 
# 3172 "MagickCore/quantize.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 3172 "MagickCore/quantize.c"
 "quantize_info != (const QuantizeInfo *) NULL"
# 3172 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3172, __extension__ __PRETTY_FUNCTION__); }))
# 3172 "MagickCore/quantize.c"
                                                     ;
  
# 3173 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3173 "MagickCore/quantize.c"
 quantize_info->signature == 0xabacadabUL
# 3173 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3173 "MagickCore/quantize.c"
...
# 3173 "MagickCore/quantize.c"
 "quantize_info->signature == MagickCoreSignature"
# 3173 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3173, __extension__ __PRETTY_FUNCTION__); }))
# 3173 "MagickCore/quantize.c"
                                                        ;
  
# 3174 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3174 "MagickCore/quantize.c"
 image != (Image *) 
# 3174 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3174 "MagickCore/quantize.c"
...
# 3174 "MagickCore/quantize.c"
 "image != (Image *) NULL"
# 3174 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3174, __extension__ __PRETTY_FUNCTION__); }))
# 3174 "MagickCore/quantize.c"
                                ;
  
# 3175 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3175 "MagickCore/quantize.c"
 image->signature == 0xabacadabUL
# 3175 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3175 "MagickCore/quantize.c"
...
# 3175 "MagickCore/quantize.c"
 "image->signature == MagickCoreSignature"
# 3175 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3175, __extension__ __PRETTY_FUNCTION__); }))
# 3175 "MagickCore/quantize.c"
                                                ;
  
# 3176 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3176 "MagickCore/quantize.c"
 exception != (ExceptionInfo *) 
# 3176 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3176 "MagickCore/quantize.c"
...
# 3176 "MagickCore/quantize.c"
 "exception != (ExceptionInfo *) NULL"
# 3176 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3176, __extension__ __PRETTY_FUNCTION__); }))
# 3176 "MagickCore/quantize.c"
                                            ;
  
# 3177 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3177 "MagickCore/quantize.c"
 exception->signature == 0xabacadabUL
# 3177 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3177 "MagickCore/quantize.c"
...
# 3177 "MagickCore/quantize.c"
 "exception->signature == MagickCoreSignature"
# 3177 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3177, __extension__ __PRETTY_FUNCTION__); }))
# 3177 "MagickCore/quantize.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/quantize.c",__func__,(unsigned long) 3179,"%s",image->filename);
  maximum_colors=quantize_info->number_colors;
  if (maximum_colors == 0)
    maximum_colors=65536UL;
  if (maximum_colors > 65536UL)
    maximum_colors=65536UL;
  ...
  if (cube_info == (QCubeInfo *) 
# 3211 "MagickCore/quantize.c" 3 4
                                ((void *)0)
# 3211 "MagickCore/quantize.c"
                                    )
    { (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 3212,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  status=ClassifyImageColors(cube_info,image,exception);
  if (status != MagickFalse)
    {
...
# 3258 "MagickCore/quantize.c"
__attribute__ ((visibility ("default"))) MagickBooleanType QuantizeImages(const QuantizeInfo *quantize_info,
...
# 3282 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3282 "MagickCore/quantize.c"
 quantize_info != (const QuantizeInfo *) 
# 3282 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3282 "MagickCore/quantize.c"
...
# 3282 "MagickCore/quantize.c"
 "quantize_info != (const QuantizeInfo *) NULL"
# 3282 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3282, __extension__ __PRETTY_FUNCTION__); }))
# 3282 "MagickCore/quantize.c"
                                                     ;
  
# 3283 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3283 "MagickCore/quantize.c"
 quantize_info->signature == 0xabacadabUL
# 3283 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3283 "MagickCore/quantize.c"
...
# 3283 "MagickCore/quantize.c"
 "quantize_info->signature == MagickCoreSignature"
# 3283 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3283, __extension__ __PRETTY_FUNCTION__); }))
# 3283 "MagickCore/quantize.c"
                                                        ;
  
# 3284 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3284 "MagickCore/quantize.c"
 images != (Image *) 
# 3284 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3284 "MagickCore/quantize.c"
...
# 3284 "MagickCore/quantize.c"
 "images != (Image *) NULL"
# 3284 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3284, __extension__ __PRETTY_FUNCTION__); }))
# 3284 "MagickCore/quantize.c"
                                 ;
  
# 3285 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3285 "MagickCore/quantize.c"
...
# 3285 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3285, __extension__ __PRETTY_FUNCTION__); }))
# 3285 "MagickCore/quantize.c"
                                                 ;
  
# 3286 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3286 "MagickCore/quantize.c"
 exception != (ExceptionInfo *) 
# 3286 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3286 "MagickCore/quantize.c"
...
# 3286 "MagickCore/quantize.c"
 "exception != (ExceptionInfo *) NULL"
# 3286 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3286, __extension__ __PRETTY_FUNCTION__); }))
# 3286 "MagickCore/quantize.c"
                                            ;
  
# 3287 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3287 "MagickCore/quantize.c"
 exception->signature == 0xabacadabUL
# 3287 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3287 "MagickCore/quantize.c"
...
# 3287 "MagickCore/quantize.c"
 "exception->signature == MagickCoreSignature"
# 3287 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3287, __extension__ __PRETTY_FUNCTION__); }))
# 3287 "MagickCore/quantize.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/quantize.c",__func__,(unsigned long) 3289,"%s",images->filename);
  if (GetNextImageInList(images) == (Image *) 
# 3290 "MagickCore/quantize.c" 3 4
                                             ((void *)0)
# 3290 "MagickCore/quantize.c"
                                                 )
    {
  ...
  cube_info=GetQCubeInfo(quantize_info,depth,maximum_colors);
  if (cube_info == (QCubeInfo *) 
# 3323 "MagickCore/quantize.c" 3 4
                                ((void *)0)
# 3323 "MagickCore/quantize.c"
                                    )
    {
      (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 3325,
  ...
  image=images;
  for (i=0; image != (Image *) 
# 3331 "MagickCore/quantize.c" 3 4
                              ((void *)0)
# 3331 "MagickCore/quantize.c"
                                  ; i++)
  {
    progress_monitor=SetImageProgressMonitor(image,(MagickProgressMonitor) 
# 3333 "MagickCore/quantize.c" 3 4
                                                                          ((void *)0)
# 3333 "MagickCore/quantize.c"
                                                                              ,
      image->client_data);
    status=ClassifyImageColors(cube_info,image,exception);
    if (status == MagickFalse)
    ...
    proceed=SetImageProgress(image,"Assign/Image",(MagickOffsetType) i,
      number_images);
    if (proceed == MagickFalse)
      break;
  ...
  if (status != MagickFalse)
    {
      ...
      image=images;
      for (i=0; image != (Image *) 
# 3352 "MagickCore/quantize.c" 3 4
                                  ((void *)0)
# 3352 "MagickCore/quantize.c"
                                      ; i++)
      {
        progress_monitor=SetImageProgressMonitor(image,(MagickProgressMonitor)
          
# 3355 "MagickCore/quantize.c" 3 4
         ((void *)0)
# 3355 "MagickCore/quantize.c"
             ,image->client_data);
        status=AssignImageColors(image,cube_info,exception);
        if (status == MagickFalse)
          break;
  ...
  const QNodeInfo *node_info,const ssize_t offset,double *quantize_error)
{
  ...
  for (i=0; i < (ssize_t) number_children ; i++)
    if (node_info->child[i] != (QNodeInfo *) 
# 3421 "MagickCore/quantize.c" 3 4
                                            ((void *)0)
# 3421 "MagickCore/quantize.c"
                                                )
      n+=QuantizeErrorFlatten(cube_info,node_info->child[i],offset+(ssize_t) n,
        quantize_error);
  return(n);
}
# 3452 "MagickCore/quantize.c"
static void Reduce(QCubeInfo *cube_info,const QNodeInfo *node_info)
{
  ...
  for (i=0; i < (ssize_t) number_children; i++)
    if (node_info->child[i] != (QNodeInfo *) 
# 3465 "MagickCore/quantize.c" 3 4
                                            ((void *)0)
# 3465 "MagickCore/quantize.c"
                                                )
  ...
  if (cube_info->colors > cube_info->maximum_colors)
    {
      ...
      if (quantize_error != (double *) 
# 3575 "MagickCore/quantize.c" 3 4
                                      ((void *)0)
# 3575 "MagickCore/quantize.c"
                                          )
        {
  ...
  for (span=cube_info->colors; cube_info->colors > cube_info->maximum_colors; )
  {
    ...
    proceed=SetImageProgress(image,"Reduce/Image",offset,span-
      cube_info->maximum_colors+1);
    if (proceed == MagickFalse)
      break;
  }
}
# 3631 "MagickCore/quantize.c"
__attribute__ ((visibility ("default"))) MagickBooleanType RemapImage(const QuantizeInfo *quantize_info,
...
# 3643 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3643 "MagickCore/quantize.c"
 image != (Image *) 
# 3643 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3643 "MagickCore/quantize.c"
...
# 3643 "MagickCore/quantize.c"
 "image != (Image *) NULL"
# 3643 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3643, __extension__ __PRETTY_FUNCTION__); }))
# 3643 "MagickCore/quantize.c"
                                ;
  
# 3644 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3644 "MagickCore/quantize.c"
 image->signature == 0xabacadabUL
# 3644 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3644 "MagickCore/quantize.c"
...
# 3644 "MagickCore/quantize.c"
 "image->signature == MagickCoreSignature"
# 3644 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3644, __extension__ __PRETTY_FUNCTION__); }))
# 3644 "MagickCore/quantize.c"
                                                ;
  
# 3645 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3645 "MagickCore/quantize.c"
 remap_image != (Image *) 
# 3645 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3645 "MagickCore/quantize.c"
...
# 3645 "MagickCore/quantize.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 3645 "MagickCore/quantize.c"
 "remap_image != (Image *) NULL"
# 3645 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3645, __extension__ __PRETTY_FUNCTION__); }))
# 3645 "MagickCore/quantize.c"
                                      ;
  
# 3646 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3646 "MagickCore/quantize.c"
 remap_image->signature == 0xabacadabUL
# 3646 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3646 "MagickCore/quantize.c"
 remap_image->signature == 0xabacadabUL
...
# 3646 "MagickCore/quantize.c"
 "remap_image->signature == MagickCoreSignature"
# 3646 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3646, __extension__ __PRETTY_FUNCTION__); }))
# 3646 "MagickCore/quantize.c"
                                                      ;
  
# 3647 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3647 "MagickCore/quantize.c"
 exception != (ExceptionInfo *) 
# 3647 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3647 "MagickCore/quantize.c"
...
# 3647 "MagickCore/quantize.c"
 "exception != (ExceptionInfo *) NULL"
# 3647 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3647, __extension__ __PRETTY_FUNCTION__); }))
# 3647 "MagickCore/quantize.c"
                                            ;
  
# 3648 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3648 "MagickCore/quantize.c"
 exception->signature == 0xabacadabUL
# 3648 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3648 "MagickCore/quantize.c"
...
# 3648 "MagickCore/quantize.c"
 "exception->signature == MagickCoreSignature"
# 3648 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3648, __extension__ __PRETTY_FUNCTION__); }))
# 3648 "MagickCore/quantize.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/quantize.c",__func__,(unsigned long) 3650,"%s",image->filename);
  cube_info=GetQCubeInfo(quantize_info,8,
    quantize_info->number_colors);
  if (cube_info == (QCubeInfo *) 
# 3653 "MagickCore/quantize.c" 3 4
                                ((void *)0)
# 3653 "MagickCore/quantize.c"
                                    )
    { (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 3654,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
...
# 3700 "MagickCore/quantize.c"
__attribute__ ((visibility ("default"))) MagickBooleanType RemapImages(const QuantizeInfo *quantize_info,
...
# 3712 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3712 "MagickCore/quantize.c"
 images != (Image *) 
# 3712 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3712 "MagickCore/quantize.c"
...
# 3712 "MagickCore/quantize.c"
 "images != (Image *) NULL"
# 3712 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3712, __extension__ __PRETTY_FUNCTION__); }))
# 3712 "MagickCore/quantize.c"
                                 ;
  
# 3713 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3713 "MagickCore/quantize.c"
 images->signature == 0xabacadabUL
# 3713 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3713 "MagickCore/quantize.c"
...
# 3713 "MagickCore/quantize.c"
 "images->signature == MagickCoreSignature"
# 3713 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3713, __extension__ __PRETTY_FUNCTION__); }))
# 3713 "MagickCore/quantize.c"
                                                 ;
  
# 3714 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3714 "MagickCore/quantize.c"
 exception != (ExceptionInfo *) 
# 3714 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3714 "MagickCore/quantize.c"
...
# 3714 "MagickCore/quantize.c"
 "exception != (ExceptionInfo *) NULL"
# 3714 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3714, __extension__ __PRETTY_FUNCTION__); }))
# 3714 "MagickCore/quantize.c"
                                            ;
  
# 3715 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3715 "MagickCore/quantize.c"
 exception->signature == 0xabacadabUL
# 3715 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3715 "MagickCore/quantize.c"
...
# 3715 "MagickCore/quantize.c"
 "exception->signature == MagickCoreSignature"
# 3715 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3715, __extension__ __PRETTY_FUNCTION__); }))
# 3715 "MagickCore/quantize.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/quantize.c",__func__,(unsigned long) 3717,"%s",images->filename);
  image=images;
  if (remap_image == (Image *) 
# 3719 "MagickCore/quantize.c" 3 4
                              ((void *)0)
# 3719 "MagickCore/quantize.c"
                                  )
    {
  ...
  cube_info=GetQCubeInfo(quantize_info,8,
    quantize_info->number_colors);
  if (cube_info == (QCubeInfo *) 
# 3732 "MagickCore/quantize.c" 3 4
                                ((void *)0)
# 3732 "MagickCore/quantize.c"
                                    )
    { (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 3733,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  status=ClassifyImageColors(cube_info,remap_image,exception);
  if (status != MagickFalse)
    {
      ...
      image=images;
      for ( ; image != (Image *) 
# 3743 "MagickCore/quantize.c" 3 4
                                ((void *)0)
# 3743 "MagickCore/quantize.c"
                                    ; image=GetNextImageInList(image))
      {
        status=AssignImageColors(image,cube_info,exception);
        if (status == MagickFalse)
...
static int IntensityCompare(const void *x,const void *y)
{
  ...
  color_1=(PixelInfo *) x;
  color_2=(PixelInfo *) y;
  intensity=GetPixelInfoIntensity((const Image *) 
# 3795 "MagickCore/quantize.c" 3 4
                                                 ((void *)0)
# 3795 "MagickCore/quantize.c"
                                                     ,color_1)-
    GetPixelInfoIntensity((const Image *) 
# 3796 "MagickCore/quantize.c" 3 4
                                         ((void *)0)
# 3796 "MagickCore/quantize.c"
                                             ,color_2);
  if (intensity < (double) 
# 3797 "MagickCore/quantize.c" 3 4
                          (-0x7fffffff - 1)
# 3797 "MagickCore/quantize.c"
                                 )
    intensity=(double) 
# 3798 "MagickCore/quantize.c" 3 4
                      (-0x7fffffff - 1)
# 3798 "MagickCore/quantize.c"
                             ;
  if (intensity > (double) 0x7fffffff
# 3799 "MagickCore/quantize.c"
                                 )
    intensity=(double) 0x7fffffff
# 3800 "MagickCore/quantize.c"
                             ;
...
# 3829 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3829 "MagickCore/quantize.c"
 image != (Image *) 
# 3829 "MagickCore/quantize.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 3829 "MagickCore/quantize.c"
...
# 3829 "MagickCore/quantize.c"
 "image != (Image *) NULL"
# 3829 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3829, __extension__ __PRETTY_FUNCTION__); }))
# 3829 "MagickCore/quantize.c"
                                ;
  
# 3830 "MagickCore/quantize.c" 3 4
 ((void) sizeof ((
# 3830 "MagickCore/quantize.c"
 image->signature == 0xabacadabUL
# 3830 "MagickCore/quantize.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 3830 "MagickCore/quantize.c"
...
# 3830 "MagickCore/quantize.c"
 "image->signature == MagickCoreSignature"
# 3830 "MagickCore/quantize.c" 3 4
 , "MagickCore/quantize.c", 3830, __extension__ __PRETTY_FUNCTION__); }))
# 3830 "MagickCore/quantize.c"
                                                ;
  if (image->type != GrayscaleType)
    (void) TransformImageColorspace(image,GRAYColorspace,exception);
  extent=(((image->colors+1) > ((((65536UL) > (65535UL +1)) ? (65536UL) : (65535UL +1)))) ? (image->colors+1) : ((((65536UL) > (65535UL +1)) ? (65536UL) : (65535UL +1))));
  colormap_index=(ssize_t *) AcquireQuantumMemory(extent,
    sizeof(*colormap_index));
  if (colormap_index == (ssize_t *) 
# 3836 "MagickCore/quantize.c" 3 4
                                   ((void *)0)
# 3836 "MagickCore/quantize.c"
                                       )
    { (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 3837,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  if (image->storage_class != PseudoClass)
    {
      (void) memset(colormap_index,(-1),extent*sizeof(*colormap_index));
      if (AcquireImageColormap(image,65536UL,exception) == MagickFalse)
        {
          colormap_index=(ssize_t *) RelinquishMagickMemory(colormap_index);
          { (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 3845,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                            ;
        }
      image->colors=0;
      status=MagickTrue;
      ...
      for (y=0; y < (ssize_t) image->rows; y++)
      {
        ...
        q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,
          exception);
        if (q == (Quantum *) 
# 3867 "MagickCore/quantize.c" 3 4
                            ((void *)0)
# 3867 "MagickCore/quantize.c"
                                )
          {
            status=MagickFalse;
            continue;
  ...
  if (colormap == (PixelInfo *) 
# 3909 "MagickCore/quantize.c" 3 4
                               ((void *)0)
# 3909 "MagickCore/quantize.c"
                                   )
    {
      colormap_index=(ssize_t *) RelinquishMagickMemory(colormap_index);
      { (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 3912,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                        ;
    }
  j=0;
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(image_view,0,y,image->columns,1,exception);
    if (q == (Quantum *) 
# 3946 "MagickCore/quantize.c" 3 4
                        ((void *)0)
# 3946 "MagickCore/quantize.c"
                            )
      {
        status=MagickFalse;
        continue;
  ...
  ExceptionInfo *exception)
{
  ...
  number_colors=(((cube_info->maximum_colors) > (cube_info->colors)) ? (cube_info->maximum_colors) : (cube_info->colors));
  if (AcquireImageColormap(image,number_colors,exception) == MagickFalse)
    { (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 4006,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                      ;
  image->colors=0;
...
# 4014 "MagickCore/quantize.c" 3 4
                                          ((void *)0)
# 4014 "MagickCore/quantize.c"
                                              )
        { (void) ThrowMagickException(exception,"MagickCore/quantize.c",__func__,(unsigned long) 4015,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return(MagickFalse); }
                          ;
    }
  return(MagickTrue);
}
