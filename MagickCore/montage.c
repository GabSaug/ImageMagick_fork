# 0 "MagickCore/montage.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/montage.c"
# 43 "MagickCore/montage.c"
...
# 76 "MagickCore/montage.c" 2
# 104 "MagickCore/montage.c"
__attribute__ ((visibility ("default"))) MontageInfo *CloneMontageInfo(const ImageInfo *image_info,
  const MontageInfo *montage_info)
{
  ...
  if (montage_info == (MontageInfo *) 
# 112 "MagickCore/montage.c" 3 4
                                     ((void *)0)
# 112 "MagickCore/montage.c"
                                         )
    return(clone_info);
  if (montage_info->geometry != (char *) 
# 114 "MagickCore/montage.c" 3 4
                                        ((void *)0)
# 114 "MagickCore/montage.c"
                                            )
    clone_info->geometry=AcquireString(montage_info->geometry);
  if (montage_info->tile != (char *) 
# 116 "MagickCore/montage.c" 3 4
                                    ((void *)0)
# 116 "MagickCore/montage.c"
                                        )
    clone_info->tile=AcquireString(montage_info->tile);
  if (montage_info->title != (char *) 
# 118 "MagickCore/montage.c" 3 4
                                     ((void *)0)
# 118 "MagickCore/montage.c"
                                         )
    clone_info->title=AcquireString(montage_info->title);
  if (montage_info->frame != (char *) 
# 120 "MagickCore/montage.c" 3 4
                                     ((void *)0)
# 120 "MagickCore/montage.c"
                                         )
    clone_info->frame=AcquireString(montage_info->frame);
  if (montage_info->texture != (char *) 
# 122 "MagickCore/montage.c" 3 4
                                       ((void *)0)
# 122 "MagickCore/montage.c"
                                           )
    clone_info->texture=AcquireString(montage_info->texture);
  if (montage_info->font != (char *) 
# 124 "MagickCore/montage.c" 3 4
                                    ((void *)0)
# 124 "MagickCore/montage.c"
                                        )
...
# 164 "MagickCore/montage.c"
__attribute__ ((visibility ("default"))) MontageInfo *DestroyMontageInfo(MontageInfo *montage_info)
{
  
# 166 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 166 "MagickCore/montage.c"
 montage_info != (MontageInfo *) 
# 166 "MagickCore/montage.c" 3 4
...
# 166 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 166, __extension__ __PRETTY_FUNCTION__); }))
# 166 "MagickCore/montage.c"
                                             ;
  
# 167 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 167 "MagickCore/montage.c"
 montage_info->signature == 0xabacadabUL
# 167 "MagickCore/montage.c" 3 4
...
# 167 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 167, __extension__ __PRETTY_FUNCTION__); }))
# 167 "MagickCore/montage.c"
                                                       ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/montage.c",__func__,(unsigned long) 169,"...");
  if (montage_info->geometry != (char *) 
# 170 "MagickCore/montage.c" 3 4
                                        ((void *)0)
# 170 "MagickCore/montage.c"
                                            )
    montage_info->geometry=(char *)
      RelinquishMagickMemory(montage_info->geometry);
  if (montage_info->tile != (char *) 
# 173 "MagickCore/montage.c" 3 4
                                    ((void *)0)
# 173 "MagickCore/montage.c"
                                        )
    montage_info->tile=DestroyString(montage_info->tile);
  if (montage_info->title != (char *) 
# 175 "MagickCore/montage.c" 3 4
                                     ((void *)0)
# 175 "MagickCore/montage.c"
                                         )
    montage_info->title=DestroyString(montage_info->title);
  if (montage_info->frame != (char *) 
# 177 "MagickCore/montage.c" 3 4
                                     ((void *)0)
# 177 "MagickCore/montage.c"
                                         )
    montage_info->frame=DestroyString(montage_info->frame);
  if (montage_info->texture != (char *) 
# 179 "MagickCore/montage.c" 3 4
                                       ((void *)0)
# 179 "MagickCore/montage.c"
                                           )
    montage_info->texture=(char *) RelinquishMagickMemory(
      montage_info->texture);
  if (montage_info->font != (char *) 
# 182 "MagickCore/montage.c" 3 4
                                    ((void *)0)
# 182 "MagickCore/montage.c"
                                        )
...
# 214 "MagickCore/montage.c"
__attribute__ ((visibility ("default"))) void GetMontageInfo(const ImageInfo *image_info,
  MontageInfo *montage_info)
{
  
# 217 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 217 "MagickCore/montage.c"
...
# 217 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 217, __extension__ __PRETTY_FUNCTION__); }))
# 217 "MagickCore/montage.c"
                                               ;
  
# 218 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 218 "MagickCore/montage.c"
...
# 218 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 218, __extension__ __PRETTY_FUNCTION__); }))
# 218 "MagickCore/montage.c"
                                                     ;
  
# 219 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 219 "MagickCore/montage.c"
 montage_info != (MontageInfo *) 
# 219 "MagickCore/montage.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 219 "MagickCore/montage.c"
...
# 219 "MagickCore/montage.c"
 "montage_info != (MontageInfo *) NULL"
# 219 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 219, __extension__ __PRETTY_FUNCTION__); }))
# 219 "MagickCore/montage.c"
                                             ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/montage.c",__func__,(unsigned long) 221,"%s",
      image_info->filename);
  (void) memset(montage_info,0,sizeof(*montage_info));
  (void) CopyMagickString(montage_info->filename,image_info->filename,
    4096);
  montage_info->geometry=AcquireString("120x120+4+3>");
  if (image_info->font != (char *) 
# 227 "MagickCore/montage.c" 3 4
                                  ((void *)0)
# 227 "MagickCore/montage.c"
                                      )
  ...
  montage_info->fill.alpha=(MagickRealType) ((Quantum) ((Quantum) 65535.0));
  montage_info->stroke.alpha=(MagickRealType) ((Quantum) 0);
...
__attribute__ ((visibility ("default"))) Image *MontageImages(const Image *images,
...
__attribute__ ((visibility ("default"))) Image *MontageImageList(const ImageInfo *image_info,
...
# 404 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 404 "MagickCore/montage.c"
 images != (Image *) 
# 404 "MagickCore/montage.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 404 "MagickCore/montage.c"
...
# 404 "MagickCore/montage.c"
 "images != (Image *) NULL"
# 404 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 404, __extension__ __PRETTY_FUNCTION__); }))
# 404 "MagickCore/montage.c"
                                 ;
  
# 405 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 405 "MagickCore/montage.c"
...
# 405 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 405, __extension__ __PRETTY_FUNCTION__); }))
# 405 "MagickCore/montage.c"
                                                 ;
  
# 406 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 406 "MagickCore/montage.c"
 montage_info != (MontageInfo *) 
# 406 "MagickCore/montage.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 406 "MagickCore/montage.c"
...
# 406 "MagickCore/montage.c"
 "montage_info != (MontageInfo *) NULL"
# 406 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 406, __extension__ __PRETTY_FUNCTION__); }))
# 406 "MagickCore/montage.c"
                                             ;
  
# 407 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 407 "MagickCore/montage.c"
 montage_info->signature == 0xabacadabUL
# 407 "MagickCore/montage.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 407 "MagickCore/montage.c"
...
# 407 "MagickCore/montage.c"
 "montage_info->signature == MagickCoreSignature"
# 407 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 407, __extension__ __PRETTY_FUNCTION__); }))
# 407 "MagickCore/montage.c"
                                                       ;
  
# 408 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 408 "MagickCore/montage.c"
...
# 408 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 408, __extension__ __PRETTY_FUNCTION__); }))
# 408 "MagickCore/montage.c"
                                            ;
  
# 409 "MagickCore/montage.c" 3 4
 ((void) sizeof ((
# 409 "MagickCore/montage.c"
...
# 409 "MagickCore/montage.c" 3 4
 , "MagickCore/montage.c", 409, __extension__ __PRETTY_FUNCTION__); }))
# 409 "MagickCore/montage.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/montage.c",__func__,(unsigned long) 411,"%s",images->filename);
  number_images=GetImageListLength(images);
  primary_list=ImageListToArray(images,exception);
  if (primary_list == (Image **) 
# 414 "MagickCore/montage.c" 3 4
                                ((void *)0)
# 414 "MagickCore/montage.c"
                                    )
    return((Image *) 
# 415 "MagickCore/montage.c" 3 4
                    ((void *)0)
# 415 "MagickCore/montage.c"
                        );
  ...
  for (i=0; i < (ssize_t) number_images; i++)
  {
    ...
    if (image == (Image *) 
# 422 "MagickCore/montage.c" 3 4
                          ((void *)0)
# 422 "MagickCore/montage.c"
                              )
      break;
    (void) ParseAbsoluteGeometry("0x0+0+0",&image->page);
    progress_monitor=SetImageProgressMonitor(image,(MagickProgressMonitor) 
# 425 "MagickCore/montage.c" 3 4
                                                                          ((void *)0)
# 425 "MagickCore/montage.c"
                                                                              ,
      image->client_data);
    flags=ParseRegionGeometry(image,montage_info->geometry,&geometry,exception);
    thumbnail=ThumbnailImage(image,geometry.width,geometry.height,exception);
    if (thumbnail == (Image *) 
# 429 "MagickCore/montage.c" 3 4
                              ((void *)0)
# 429 "MagickCore/montage.c"
                                  )
      break;
    image_list[i]=thumbnail;
    (void) SetImageProgressMonitor(image,progress_monitor,image->client_data);
    proceed=SetImageProgress(image,"Tile/Image",(MagickOffsetType) i,
      number_images);
  ...
  if (i < (ssize_t) number_images)
    {
      if (image != (Image *) 
# 441 "MagickCore/montage.c" 3 4
                            ((void *)0)
# 441 "MagickCore/montage.c"
                                )
        image=DestroyImage(image);
      if (thumbnail == (Image *) 
# 443 "MagickCore/montage.c" 3 4
                                ((void *)0)
# 443 "MagickCore/montage.c"
                                    )
        i--;
      for (tile=0; (ssize_t) tile <= i; tile++)
        if (image_list[tile] != (Image *) 
# 446 "MagickCore/montage.c" 3 4
                                         ((void *)0)
# 446 "MagickCore/montage.c"
                                             )
          image_list[tile]=DestroyImage(image_list[tile]);
      primary_list=(Image **) RelinquishMagickMemory(primary_list);
      return((Image *) 
# 449 "MagickCore/montage.c" 3 4
                      ((void *)0)
# 449 "MagickCore/montage.c"
                          );
    }
  ...
  y_offset=0;
  if (montage_info->tile != (char *) 
# 467 "MagickCore/montage.c" 3 4
                                    ((void *)0)
# 467 "MagickCore/montage.c"
                                        )
  ...
  if (montage_info->geometry != (char *) 
# 477 "MagickCore/montage.c" 3 4
                                        ((void *)0)
# 477 "MagickCore/montage.c"
                                            )
    {
  ...
  if (montage_info->frame != (char *) 
# 490 "MagickCore/montage.c" 3 4
                                     ((void *)0)
# 490 "MagickCore/montage.c"
                                         )
    {
      char
        absolute_geometry[4096];

      frame_info.width=extract_info.width;
      frame_info.height=extract_info.height;
      (void) FormatLocaleString(absolute_geometry,4096,"%s!",
        montage_info->frame);
      ...
      bevel_width=(ssize_t) (((frame_info.inner_bevel) > (frame_info.outer_bevel)) ? (frame_info.inner_bevel) : (frame_info.outer_bevel))
                               ;
      border_width=(size_t) ((((ssize_t) frame_info.width) > ((ssize_t) frame_info.height)) ? ((ssize_t) frame_info.width) : ((ssize_t) frame_info.height))
                                    ;
    }
  for (i=0; i < (ssize_t) number_images; i++)
  {
  ...
  clone_info->background_color=montage_info->background_color;
  clone_info->border_color=montage_info->border_color;
  draw_info=CloneDrawInfo(clone_info,(DrawInfo *) 
# 527 "MagickCore/montage.c" 3 4
                                                 ((void *)0)
# 527 "MagickCore/montage.c"
                                                     );
  if (montage_info->font != (char *) 
# 528 "MagickCore/montage.c" 3 4
                                    ((void *)0)
# 528 "MagickCore/montage.c"
                                        )
  ...
  if (montage_info->texture != (char *) 
# 538 "MagickCore/montage.c" 3 4
                                       ((void *)0)
# 538 "MagickCore/montage.c"
                                           )
    {
  ...
  title_offset=0;
  if (montage_info->title != (char *) 
# 550 "MagickCore/montage.c" 3 4
                                     ((void *)0)
# 550 "MagickCore/montage.c"
                                         )
  ...
  for (i=0; i < (ssize_t) number_images; i++)
  {
    ...
    if (value == (const char *) 
# 557 "MagickCore/montage.c" 3 4
                               ((void *)0)
# 557 "MagickCore/montage.c"
                                   )
      continue;
  ...
  tile_image=AcquireImage((ImageInfo *) 
# 565 "MagickCore/montage.c" 3 4
                                       ((void *)0)
# 565 "MagickCore/montage.c"
                                           ,exception);
  ...
  for (i=0; i < (ssize_t) images_per_page; i++)
  {
    ...
    y_offset=0;
    if (montage_info->tile != (char *) 
# 580 "MagickCore/montage.c" 3 4
                                      ((void *)0)
# 580 "MagickCore/montage.c"
                                          )
      GetMontageGeometry(montage_info->tile,number_images,&x_offset,&y_offset,
        &sans,&sans);
    tiles_per_page=tiles_per_row*tiles_per_column;
    ...
    for (tile=0; tile < (ssize_t) tiles_per_page; tile++)
    {
      ...
      if (((tile+1) == (ssize_t) tiles_per_page) ||
          (((tile+1) % (ssize_t) tiles_per_row) == 0))
        {
          x_offset=0;
          if (montage_info->tile != (char *) 
# 605 "MagickCore/montage.c" 3 4
                                            ((void *)0)
# 605 "MagickCore/montage.c"
                                                )
    ...
    (void) CopyMagickString(montage->filename,montage_info->filename,
      4096);
    montage->columns=(size_t) ((((ssize_t) bounds.width) > (1)) ? ((ssize_t) bounds.width) : (1));
    montage->rows=(size_t) ((((ssize_t) bounds.height) > (1)) ? ((ssize_t) bounds.height) : (1));
    (void) SetImageBackgroundColor(montage,exception);



    montage->montage=AcquireString((char *) 
# 630 "MagickCore/montage.c" 3 4
                                           ((void *)0)
# 630 "MagickCore/montage.c"
                                               );
    tile=0;
    extent=1;
    while (tile < ((((ssize_t) tiles_per_page) < ((ssize_t) number_images)) ? ((ssize_t) tiles_per_page) : ((ssize_t) number_images)))
    {
    ...
    if ((montage->montage == (char *) 
# 640 "MagickCore/montage.c" 3 4
                                     ((void *)0)
# 640 "MagickCore/montage.c"
                                         ) ||
        (montage->directory == (char *) 
# 641 "MagickCore/montage.c" 3 4
                                       ((void *)0)
# 641 "MagickCore/montage.c"
                                           ))
      {
        if (montage->montage != (char *) 
# 643 "MagickCore/montage.c" 3 4
                                        ((void *)0)
# 643 "MagickCore/montage.c"
                                            )
          montage->montage=(char *) RelinquishMagickMemory(montage->montage);
        if (montage->directory != (char *) 
# 645 "MagickCore/montage.c" 3 4
                                          ((void *)0)
# 645 "MagickCore/montage.c"
                                              )
          montage->directory=(char *) RelinquishMagickMemory(
            montage->directory);
        { (void) ThrowMagickException(exception,"MagickCore/montage.c",__func__,(unsigned long) 648,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 648 "MagickCore/montage.c" 3 4
       ((void *)0)
# 648 "MagickCore/montage.c"
       ); };
      }
    x_offset=0;
    y_offset=0;
    if (montage_info->tile != (char *) 
# 652 "MagickCore/montage.c" 3 4
                                      ((void *)0)
# 652 "MagickCore/montage.c"
                                          )
      GetMontageGeometry(montage_info->tile,number_images,&x_offset,&y_offset,
        &sans,&sans);
    y_offset+=(ssize_t) title_offset;
    (void) FormatLocaleString(montage->montage,4096,
    ...
    *montage->directory='\0';
    ...
    while (tile < ((((ssize_t) tiles_per_page) < ((ssize_t) number_images)) ? ((ssize_t) tiles_per_page) : ((ssize_t) number_images)))
    {
      if (strchr(image_list[tile]->filename,(int) '\xff') == (char *) 
# 667 "MagickCore/montage.c" 3 4
                                                                     ((void *)0)
# 667 "MagickCore/montage.c"
                                                                         )
        (void) ConcatenateMagickString(montage->directory,
          image_list[tile]->filename,extent);
      else
        (void) ThrowMagickException(exception,"MagickCore/montage.c",__func__,(unsigned long) 671,OptionError,
...
# 677 "MagickCore/montage.c" 3 4
     ((void *)0)
# 677 "MagickCore/montage.c"
         ,montage->client_data);
    if (texture != (Image *) 
# 678 "MagickCore/montage.c" 3 4
                            ((void *)0)
# 678 "MagickCore/montage.c"
                                )
      (void) TextureImage(montage,texture,exception);
    if (montage_info->title != (char *) 
# 680 "MagickCore/montage.c" 3 4
                                       ((void *)0)
# 680 "MagickCore/montage.c"
                                           )
      {
        DrawInfo
          *draw_clone_info;
        ...
        (void) GetTypeMetrics(image_list[0],draw_clone_info,&tile_metrics,
          exception);
        (void) FormatLocaleString(tile_geometry,4096,
    ...
    y_offset=0;
    if (montage_info->tile != (char *) 
# 712 "MagickCore/montage.c" 3 4
                                      ((void *)0)
# 712 "MagickCore/montage.c"
                                          )
      GetMontageGeometry(montage_info->tile,number_images,&x_offset,&y_offset,
        &sans,&sans);
    ...
    max_height=0;
    status=MagickTrue;
    for (tile=0; tile < ((((ssize_t) tiles_per_page) < ((ssize_t) number_images)) ? ((ssize_t) tiles_per_page) : ((ssize_t) number_images)); tile++)
    {
      ...
      if (image == (Image *) 
# 725 "MagickCore/montage.c" 3 4
                            ((void *)0)
# 725 "MagickCore/montage.c"
                                )
        { (void) ThrowMagickException(exception,"MagickCore/montage.c",__func__,(unsigned long) 726,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 726 "MagickCore/montage.c" 3 4
       ((void *)0)
# 726 "MagickCore/montage.c"
       ); };
      progress_monitor=SetImageProgressMonitor(image,
        (MagickProgressMonitor) 
# 728 "MagickCore/montage.c" 3 4
                               ((void *)0)
# 728 "MagickCore/montage.c"
                                   ,image->client_data);
      ...
      if (border_width != 0)
        {
          ...
          if (montage_info->frame != (char *) 
# 746 "MagickCore/montage.c" 3 4
                                             ((void *)0)
# 746 "MagickCore/montage.c"
                                                 )
            {
...
# 752 "MagickCore/montage.c" 3 4
                                       ((void *)0)
# 752 "MagickCore/montage.c"
                                           )
            {
              image=DestroyImage(image);
              image=border_image;
          ...
          if ((montage_info->frame != (char *) 
# 757 "MagickCore/montage.c" 3 4
                                              ((void *)0)
# 757 "MagickCore/montage.c"
                                                  ) &&
      ...
      if ((montage_info->frame != (char *) 
# 778 "MagickCore/montage.c" 3 4
                                          ((void *)0)
# 778 "MagickCore/montage.c"
                                              ) && (bevel_width > 0))
        {
          FrameInfo
            frame_clone;
          ...
          if (value != (const char *) 
# 793 "MagickCore/montage.c" 3 4
                                     ((void *)0)
# 793 "MagickCore/montage.c"
                                         )
...
# 797 "MagickCore/montage.c" 3 4
                                      ((void *)0)
# 797 "MagickCore/montage.c"
                                          )
            {
              image=DestroyImage(image);
              image=frame_image;
...
# 821 "MagickCore/montage.c" 3 4
                                           ((void *)0)
# 821 "MagickCore/montage.c"
                                               )
                {
          ...
          value=GetImageProperty(image,"label",exception);
          if (value != (const char *) 
# 832 "MagickCore/montage.c" 3 4
                                     ((void *)0)
# 832 "MagickCore/montage.c"
                                         )
            {
...
# 861 "MagickCore/montage.c" 3 4
                                                             ((void *)0)
# 861 "MagickCore/montage.c"
                                                                 )
        {
    ...
    if ((i+1) < (ssize_t) images_per_page)
      {
        ...
        if (GetNextImageInList(montage) == (Image *) 
# 878 "MagickCore/montage.c" 3 4
                                                    ((void *)0)
# 878 "MagickCore/montage.c"
                                                        )
          {
            montage=DestroyImageList(montage);
            return((Image *) 
# 881 "MagickCore/montage.c" 3 4
                            ((void *)0)
# 881 "MagickCore/montage.c"
                                );
          }
  ...
  if (texture != (Image *) 
# 890 "MagickCore/montage.c" 3 4
                          ((void *)0)
# 890 "MagickCore/montage.c"
                              )
