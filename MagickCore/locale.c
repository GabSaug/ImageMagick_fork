# 0 "MagickCore/locale.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/locale.c"
# 42 "MagickCore/locale.c"
...
# 65 "MagickCore/locale.c" 2
# 77 "MagickCore/locale.c"
static const char
  *LocaleMap =
    "<?xml version=\"1.0\"?>"
    "<localemap>"
...
static SemaphoreInfo
  *locale_semaphore = (SemaphoreInfo *) 
# 90 "MagickCore/locale.c" 3 4
                                       ((void *)0)
# 90 "MagickCore/locale.c"
                                           ;

static SplayTreeInfo
  *locale_cache = (SplayTreeInfo *) 
# 93 "MagickCore/locale.c" 3 4
                                   ((void *)0)
# 93 "MagickCore/locale.c"
                                       ;


static volatile locale_t
  c_locale = (locale_t) 
# 97 "MagickCore/locale.c" 3 4
                       ((void *)0)
# 97 "MagickCore/locale.c"
                           ;
...
static MagickBooleanType
  ...
  LoadLocaleCache(SplayTreeInfo *,const char *,const char *,const char *,
    const size_t,ExceptionInfo *);
# 128 "MagickCore/locale.c"
static locale_t AcquireCLocale(void)
{

  if (c_locale == (locale_t) 
# 131 "MagickCore/locale.c" 3 4
                            ((void *)0)
# 131 "MagickCore/locale.c"
                                )
    c_locale=newlocale(
# 132 "MagickCore/locale.c" 3 4
                      ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5) | (1 << 7) | (1 << 8) | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 12) )
# 132 "MagickCore/locale.c"
                                 ,"C",(locale_t) 0);
...
static void *DestroyLocaleNode(void *locale_info)
{
  ...
  if (p->path != (char *) 
# 176 "MagickCore/locale.c" 3 4
                         ((void *)0)
# 176 "MagickCore/locale.c"
                             )
    p->path=DestroyString(p->path);
  if (p->tag != (char *) 
# 178 "MagickCore/locale.c" 3 4
                        ((void *)0)
# 178 "MagickCore/locale.c"
                            )
    p->tag=DestroyString(p->tag);
  if (p->message != (char *) 
# 180 "MagickCore/locale.c" 3 4
                            ((void *)0)
# 180 "MagickCore/locale.c"
                                )
  ...
  const char *locale,ExceptionInfo *exception)
{
  ...
  cache=NewSplayTree(CompareSplayTreeString,(void *(*)(void *)) 
# 191 "MagickCore/locale.c" 3 4
                                                               ((void *)0)
# 191 "MagickCore/locale.c"
                                                                   ,
    DestroyLocaleNode);
...
# 203 "MagickCore/locale.c" 3 4
                                         ((void *)0)
# 203 "MagickCore/locale.c"
                                             )
    {
    ...
    if (GetNumberOfNodesInSplayTree(cache) == 0)
      {
        ...
        option=(const StringInfo *) GetNextValueInLinkedList(options);
        while (option != (const StringInfo *) 
# 215 "MagickCore/locale.c" 3 4
                                             ((void *)0)
# 215 "MagickCore/locale.c"
                                                 )
        {
          (void) LoadLocaleCache(cache,(const char *)
            GetStringInfoDatum(option),GetStringInfoPath(option),locale,0,
...
# 254 "MagickCore/locale.c"
static void DestroyCLocale(void)
{
  if (c_locale != (locale_t) 
# 256 "MagickCore/locale.c" 3 4
                            ((void *)0)
# 256 "MagickCore/locale.c"
                                )
    freelocale(c_locale);
  c_locale=(locale_t) 
# 258 "MagickCore/locale.c" 3 4
                     ((void *)0)
# 258 "MagickCore/locale.c"
                         ;
}
# 286 "MagickCore/locale.c"
static void *DestroyOptions(void *message)
{
  return(DestroyStringInfo((StringInfo *) message));
}

__attribute__ ((visibility ("default"))) LinkedListInfo *DestroyLocaleOptions(LinkedListInfo *messages)
{
  
# 293 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 293 "MagickCore/locale.c"
 messages != (LinkedListInfo *) 
# 293 "MagickCore/locale.c" 3 4
...
# 293 "MagickCore/locale.c"
 "messages != (LinkedListInfo *) NULL"
# 293 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 293, __extension__ __PRETTY_FUNCTION__); }))
# 293 "MagickCore/locale.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/locale.c",__func__,(unsigned long) 295,"...");
  return(DestroyLinkedList(messages,DestroyOptions));
}
# 326 "MagickCore/locale.c"
__attribute__ ((visibility ("hidden"))) ssize_t FormatLocaleFileList(FILE *file,
  const char *__restrict__ format,va_list operands)
{
  ssize_t
    n;
# 349 "MagickCore/locale.c"
  {
    locale_t
      locale,
      previous_locale;
    ...
    if (locale == (locale_t) 
# 355 "MagickCore/locale.c" 3 4
                            ((void *)0)
# 355 "MagickCore/locale.c"
                                )
...
__attribute__ ((visibility ("default"))) ssize_t FormatLocaleFile(FILE *file,
...
# 380 "MagickCore/locale.c" 3 4
 __builtin_va_start(
# 380 "MagickCore/locale.c"
 operands
# 380 "MagickCore/locale.c" 3 4
 ,
# 380 "MagickCore/locale.c"
...
# 382 "MagickCore/locale.c" 3 4
 __builtin_va_end(
# 382 "MagickCore/locale.c"
 operands
# 382 "MagickCore/locale.c" 3 4
 )
# 382 "MagickCore/locale.c"
...
# 417 "MagickCore/locale.c"
__attribute__ ((visibility ("hidden"))) ssize_t FormatLocaleStringList(char *__restrict__ string,
  const size_t length,const char *__restrict__ format,va_list operands)
{
  ssize_t
    n;
# 440 "MagickCore/locale.c"
  {
    locale_t
      locale,
      previous_locale;
    ...
    locale=AcquireCLocale();
    if (locale == (locale_t) 
# 446 "MagickCore/locale.c" 3 4
                            ((void *)0)
# 446 "MagickCore/locale.c"
                                )
...
__attribute__ ((visibility ("default"))) ssize_t FormatLocaleString(char *__restrict__ string,
  const size_t length,const char *__restrict__ format,...)
{
  ssize_t
    n;
...
# 475 "MagickCore/locale.c" 3 4
 __builtin_va_start(
# 475 "MagickCore/locale.c"
 operands
# 475 "MagickCore/locale.c" 3 4
 ,
# 475 "MagickCore/locale.c"
...
# 477 "MagickCore/locale.c" 3 4
 __builtin_va_end(
# 477 "MagickCore/locale.c"
 operands
# 477 "MagickCore/locale.c" 3 4
 )
# 477 "MagickCore/locale.c"
...
# 507 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) const LocaleInfo *GetLocaleInfo_(const char *tag,
...
# 513 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 513 "MagickCore/locale.c"
...
# 513 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 513, __extension__ __PRETTY_FUNCTION__); }))
# 513 "MagickCore/locale.c"
                                            ;
  if (IsLocaleTreeInstantiated(exception) == MagickFalse)
    return((const LocaleInfo *) 
# 515 "MagickCore/locale.c" 3 4
                               ((void *)0)
# 515 "MagickCore/locale.c"
                                   );
  LockSemaphoreInfo(locale_semaphore);
  if ((tag == (const char *) 
# 517 "MagickCore/locale.c" 3 4
                            ((void *)0)
# 517 "MagickCore/locale.c"
                                ) || (LocaleCompare(tag,"*") == 0))
    {
...
__attribute__ ((visibility ("default"))) const LocaleInfo **GetLocaleInfoList(const char *pattern,
...
# 595 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 595 "MagickCore/locale.c"
 pattern != (char *) 
# 595 "MagickCore/locale.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 595 "MagickCore/locale.c"
...
# 595 "MagickCore/locale.c"
 "pattern != (char *) NULL"
# 595 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 595, __extension__ __PRETTY_FUNCTION__); }))
# 595 "MagickCore/locale.c"
                                 ;
  
# 596 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 596 "MagickCore/locale.c"
 number_messages != (size_t *) 
# 596 "MagickCore/locale.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 596 "MagickCore/locale.c"
 number_messages != (size_t *) 
# 596 "MagickCore/locale.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 596 "MagickCore/locale.c"
 "number_messages != (size_t *) NULL"
# 596 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 596, __extension__ __PRETTY_FUNCTION__); }))
# 596 "MagickCore/locale.c"
                                           ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/locale.c",__func__,(unsigned long) 598,"%s",pattern);
  *number_messages=0;
  p=GetLocaleInfo_("*",exception);
  if (p == (const LocaleInfo *) 
# 601 "MagickCore/locale.c" 3 4
                               ((void *)0)
# 601 "MagickCore/locale.c"
                                   )
    return((const LocaleInfo **) 
# 602 "MagickCore/locale.c" 3 4
                                ((void *)0)
# 602 "MagickCore/locale.c"
                                    );
  messages=(const LocaleInfo **) AcquireQuantumMemory((size_t)
    GetNumberOfNodesInSplayTree(locale_cache)+1UL,sizeof(*messages));
  if (messages == (const LocaleInfo **) 
# 605 "MagickCore/locale.c" 3 4
                                       ((void *)0)
# 605 "MagickCore/locale.c"
                                           )
    return((const LocaleInfo **) 
# 606 "MagickCore/locale.c" 3 4
                                ((void *)0)
# 606 "MagickCore/locale.c"
                                    );
  ...
  for (i=0; p != (const LocaleInfo *) 
# 613 "MagickCore/locale.c" 3 4
                                     ((void *)0)
# 613 "MagickCore/locale.c"
                                         ; )
  {
  ...
  messages[i]=(LocaleInfo *) 
# 622 "MagickCore/locale.c" 3 4
                            ((void *)0)
# 622 "MagickCore/locale.c"
                                ;
  *number_messages=(size_t) i;
  return(messages);
}
# 661 "MagickCore/locale.c"
...
__attribute__ ((visibility ("default"))) char **GetLocaleList(const char *pattern,size_t *number_messages,
  ExceptionInfo *exception)
{
  char
    **messages;
...
# 691 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 691 "MagickCore/locale.c"
 pattern != (char *) 
# 691 "MagickCore/locale.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 691 "MagickCore/locale.c"
...
# 691 "MagickCore/locale.c"
 "pattern != (char *) NULL"
# 691 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 691, __extension__ __PRETTY_FUNCTION__); }))
# 691 "MagickCore/locale.c"
                                 ;
  
# 692 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 692 "MagickCore/locale.c"
 number_messages != (size_t *) 
# 692 "MagickCore/locale.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 692 "MagickCore/locale.c"
...
# 692 "MagickCore/locale.c"
 "number_messages != (size_t *) NULL"
# 692 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 692, __extension__ __PRETTY_FUNCTION__); }))
# 692 "MagickCore/locale.c"
                                           ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/locale.c",__func__,(unsigned long) 694,"%s",pattern);
  *number_messages=0;
  p=GetLocaleInfo_("*",exception);
  if (p == (const LocaleInfo *) 
# 697 "MagickCore/locale.c" 3 4
                               ((void *)0)
# 697 "MagickCore/locale.c"
                                   )
    return((char **) 
# 698 "MagickCore/locale.c" 3 4
                    ((void *)0)
# 698 "MagickCore/locale.c"
                        );
  messages=(char **) AcquireQuantumMemory((size_t)
    GetNumberOfNodesInSplayTree(locale_cache)+1UL,sizeof(*messages));
  if (messages == (char **) 
# 701 "MagickCore/locale.c" 3 4
                           ((void *)0)
# 701 "MagickCore/locale.c"
                               )
    return((char **) 
# 702 "MagickCore/locale.c" 3 4
                    ((void *)0)
# 702 "MagickCore/locale.c"
                        );
  LockSemaphoreInfo(locale_semaphore);
  p=(const LocaleInfo *) GetNextValueInSplayTree(locale_cache);
  for (i=0; p != (const LocaleInfo *) 
# 705 "MagickCore/locale.c" 3 4
                                     ((void *)0)
# 705 "MagickCore/locale.c"
                                         ; )
  {
    if ((p->stealth == MagickFalse) &&
        (GlobExpression(p->tag,pattern,MagickTrue) != MagickFalse))
  ...
  messages[i]=(char *) 
# 714 "MagickCore/locale.c" 3 4
                      ((void *)0)
# 714 "MagickCore/locale.c"
                          ;
  *number_messages=(size_t) i;
  return(messages);
}
# 742 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) const char *GetLocaleMessage(const char *tag)
{
  char
    name[256];
  ...
  if ((tag == (const char *) 
# 753 "MagickCore/locale.c" 3 4
                            ((void *)0)
# 753 "MagickCore/locale.c"
                                ) || (*tag == '\0'))
    return(tag);
  exception=AcquireExceptionInfo();
  (void) FormatLocaleString(name,256,"%s/",tag);
  locale_info=GetLocaleInfo_(name,exception);
  exception=DestroyExceptionInfo(exception);
  if (locale_info != (const LocaleInfo *) 
# 759 "MagickCore/locale.c" 3 4
                                         ((void *)0)
# 759 "MagickCore/locale.c"
                                             )
    return(locale_info->message);
  return(tag);
}
# 790 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) LinkedListInfo *GetLocaleOptions(const char *filename,
  ExceptionInfo *exception)
{
  char
    path[4096];
...
# 806 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 806 "MagickCore/locale.c"
 filename != (const char *) 
# 806 "MagickCore/locale.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 806 "MagickCore/locale.c"
...
# 806 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 806, __extension__ __PRETTY_FUNCTION__); }))
# 806 "MagickCore/locale.c"
                                        ;
  
# 807 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 807 "MagickCore/locale.c"
 exception != (ExceptionInfo *) 
# 807 "MagickCore/locale.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 807 "MagickCore/locale.c"
...
# 807 "MagickCore/locale.c"
 "exception != (ExceptionInfo *) NULL"
# 807 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 807, __extension__ __PRETTY_FUNCTION__); }))
# 807 "MagickCore/locale.c"
                                            ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/locale.c",__func__,(unsigned long) 809,"%s",filename);
  (void) CopyMagickString(path,filename,4096);



  messages=NewLinkedList(0);
  paths=GetConfigurePaths(filename,exception);
  if (paths != (LinkedListInfo *) 
# 816 "MagickCore/locale.c" 3 4
                                 ((void *)0)
# 816 "MagickCore/locale.c"
                                     )
    {
      ResetLinkedListIterator(paths);
      element=(const char *) GetNextValueInLinkedList(paths);
      while (element != (const char *) 
# 820 "MagickCore/locale.c" 3 4
                                      ((void *)0)
# 820 "MagickCore/locale.c"
                                          )
      {
        (void) FormatLocaleString(path,4096,"%s%s",element,
          filename);
        (void) LogMagickEvent(LocaleEvent,"MagickCore/locale.c",__func__,(unsigned long) 824,
          "Searching for locale file: \"%s\"",path);
        xml=ConfigureFileToStringInfo(path);
        if (xml != (StringInfo *) 
# 827 "MagickCore/locale.c" 3 4
                                 ((void *)0)
# 827 "MagickCore/locale.c"
                                     )
...
# 850 "MagickCore/locale.c"
  ResetLinkedListIterator(messages);
  return(messages);
}
# 876 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) const char *GetLocaleValue(const LocaleInfo *locale_info)
{
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/locale.c",__func__,(unsigned long) 879,"...");
  
# 880 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 880 "MagickCore/locale.c"
...
# 880 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 880, __extension__ __PRETTY_FUNCTION__); }))
# 880 "MagickCore/locale.c"
                                           ;
  
# 881 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 881 "MagickCore/locale.c"
 locale_info->signature == 0xabacadabUL
# 881 "MagickCore/locale.c" 3 4
...
# 881 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 881, __extension__ __PRETTY_FUNCTION__); }))
# 881 "MagickCore/locale.c"
                                                      ;
  return(locale_info->message);
}
# 908 "MagickCore/locale.c"
static MagickBooleanType IsLocaleTreeInstantiated(ExceptionInfo *exception)
{
  if (locale_cache == (SplayTreeInfo *) 
# 910 "MagickCore/locale.c" 3 4
                                       ((void *)0)
# 910 "MagickCore/locale.c"
                                           )
    {
      if (locale_semaphore == (SemaphoreInfo *) 
# 912 "MagickCore/locale.c" 3 4
                                               ((void *)0)
# 912 "MagickCore/locale.c"
                                                   )
        ActivateSemaphoreInfo(&locale_semaphore);
      LockSemaphoreInfo(locale_semaphore);
      if (locale_cache == (SplayTreeInfo *) 
# 915 "MagickCore/locale.c" 3 4
                                           ((void *)0)
# 915 "MagickCore/locale.c"
                                               )
        {
          char
            *locale;
          ...
          locale=(char *) 
# 923 "MagickCore/locale.c" 3 4
                         ((void *)0)
# 923 "MagickCore/locale.c"
                             ;
          p=setlocale(
# 924 "MagickCore/locale.c" 3 4
                     0
# 924 "MagickCore/locale.c"
                             ,(const char *) 
# 924 "MagickCore/locale.c" 3 4
                                             ((void *)0)
# 924 "MagickCore/locale.c"
          ...
          if (p != (const char *) 
# 925 "MagickCore/locale.c" 3 4
                                 ((void *)0)
# 925 "MagickCore/locale.c"
                                     )
            locale=ConstantString(p);
          if (locale == (char *) 
# 927 "MagickCore/locale.c" 3 4
                                ((void *)0)
# 927 "MagickCore/locale.c"
                                    )
            locale=GetEnvironmentValue("LC_ALL");
          if (locale == (char *) 
# 929 "MagickCore/locale.c" 3 4
                                ((void *)0)
# 929 "MagickCore/locale.c"
                                    )
            locale=GetEnvironmentValue("LC_MESSAGES");
          if (locale == (char *) 
# 931 "MagickCore/locale.c" 3 4
                                ((void *)0)
# 931 "MagickCore/locale.c"
                                    )
            locale=GetEnvironmentValue("LC_CTYPE");
          if (locale == (char *) 
# 933 "MagickCore/locale.c" 3 4
                                ((void *)0)
# 933 "MagickCore/locale.c"
                                    )
            locale=GetEnvironmentValue("LANG");
          if (locale == (char *) 
# 935 "MagickCore/locale.c" 3 4
                                ((void *)0)
# 935 "MagickCore/locale.c"
                                    )
            locale=ConstantString("C");
          locale_cache=AcquireLocaleSplayTree("locale.xml",locale,exception);
          locale=DestroyString(locale);
        }
      UnlockSemaphoreInfo(locale_semaphore);
    }
  return(locale_cache != (SplayTreeInfo *) 
# 942 "MagickCore/locale.c" 3 4
                                          ((void *)0) 
# 942 "MagickCore/locale.c"
                                               ? MagickTrue : MagickFalse);
}
# 974 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) double InterpretLocaleValue(const char *__restrict__ string,
  char *__restrict__ *sentinel)
{
  char
    *q;
  ...
  if ((*string == '0') && ((string[1] | 0x20)=='x'))
  ...
  else
    {
      ...
      locale=AcquireCLocale();
      if (locale == (locale_t) 
# 992 "MagickCore/locale.c" 3 4
                              ((void *)0)
# 992 "MagickCore/locale.c"
                                  )
  ...
  if (sentinel != (char **) 
# 1000 "MagickCore/locale.c" 3 4
                           ((void *)0)
# 1000 "MagickCore/locale.c"
                               )
    *sentinel=q;
  return(value);
}
# 1029 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListLocaleInfo(FILE *file,
  ExceptionInfo *exception)
{
  const char
    *path;
  ...
  if (file == (const FILE *) 
# 1044 "MagickCore/locale.c" 3 4
                            ((void *)0)
# 1044 "MagickCore/locale.c"
                                )
    file=
# 1045 "MagickCore/locale.c" 3 4
        stdout
# 1045 "MagickCore/locale.c"
              ;
  number_messages=0;
  locale_info=GetLocaleInfoList("*",&number_messages,exception);
  if (locale_info == (const LocaleInfo **) 
# 1048 "MagickCore/locale.c" 3 4
                                          ((void *)0)
# 1048 "MagickCore/locale.c"
                                              )
    return(MagickFalse);
  path=(const char *) 
# 1050 "MagickCore/locale.c" 3 4
                     ((void *)0)
# 1050 "MagickCore/locale.c"
                         ;
  for (i=0; i < (ssize_t) number_messages; i++)
  {
    if (locale_info[i]->stealth != MagickFalse)
      continue;
    if ((path == (const char *) 
# 1055 "MagickCore/locale.c" 3 4
                               ((void *)0)
# 1055 "MagickCore/locale.c"
                                   ) ||
        (LocaleCompare(path,locale_info[i]->path) != 0))
      {
        if (locale_info[i]->path != (char *) 
# 1058 "MagickCore/locale.c" 3 4
                                            ((void *)0)
# 1058 "MagickCore/locale.c"
                                                )
    ...
    if (locale_info[i]->message != (char *) 
# 1067 "MagickCore/locale.c" 3 4
                                           ((void *)0)
# 1067 "MagickCore/locale.c"
                                               )
...
static void LocaleFatalErrorHandler(const ExceptionType severity,
  const char *reason,const char *description) __attribute__((__noreturn__));

static void LocaleFatalErrorHandler(
  const ExceptionType magick_unused_severity __attribute__((unused)),
  const char *reason,const char *description)
{
  ;

  (void) FormatLocaleFile(
# 1141 "MagickCore/locale.c" 3 4
                         stderr
# 1141 "MagickCore/locale.c"
                               ,"%s: ",GetClientName());
  if (reason != (char *) 
# 1142 "MagickCore/locale.c" 3 4
                        ((void *)0)
# 1142 "MagickCore/locale.c"
                            )
    (void) FormatLocaleFile(
# 1143 "MagickCore/locale.c" 3 4
                           stderr
# 1143 "MagickCore/locale.c"
                                 ," %s",reason);
  if (description != (char *) 
# 1144 "MagickCore/locale.c" 3 4
                             ((void *)0)
# 1144 "MagickCore/locale.c"
                                 )
    (void) FormatLocaleFile(
# 1145 "MagickCore/locale.c" 3 4
                           stderr
# 1145 "MagickCore/locale.c"
                                 ," (%s)",description);
  (void) FormatLocaleFile(
# 1146 "MagickCore/locale.c" 3 4
                         stderr
# 1146 "MagickCore/locale.c"
                               ,".\n");
  (void) fflush(
# 1147 "MagickCore/locale.c" 3 4
               stderr
# 1147 "MagickCore/locale.c"
                     );
  exit(1);
}
  ...
  const char *filename,const char *locale,const size_t depth,ExceptionInfo *exception)
{
  ...
  (void) LogMagickEvent(ConfigureEvent,"MagickCore/locale.c",__func__,(unsigned long) 1181,
    "Loading locale configure file \"%s\" ...",filename);
  if (xml == (const char *) 
# 1183 "MagickCore/locale.c" 3 4
                           ((void *)0)
# 1183 "MagickCore/locale.c"
                               )
    return(MagickFalse);
  status=MagickTrue;
  locale_info=(LocaleInfo *) 
# 1186 "MagickCore/locale.c" 3 4
                            ((void *)0)
# 1186 "MagickCore/locale.c"
                                ;
  *tag='\0';
  *message='\0';
  *keyword='\0';
  ...
  for (q=(char *) xml; *q != '\0'; )
  {
    ...
    if (*token == '\0')
      break;
    (void) CopyMagickString(keyword,token,256);
    if (LocaleNCompare(keyword,"<!DOCTYPE",9) == 0)
      {
        ...
        while ((LocaleNCompare(q,"]>",2) != 0) && (*q != '\0'))
        {
          (void) GetNextToken(q,&q,extent,token);
          while (
# 1210 "MagickCore/locale.c" 3 4
                ((*__ctype_b_loc ())[(int) ((
# 1210 "MagickCore/locale.c"
                (int) ((unsigned char) *q)
# 1210 "MagickCore/locale.c" 3 4
    ...
    if (LocaleNCompare(keyword,"<!--",4) == 0)
      {
        ...
        while ((LocaleNCompare(q,"->",2) != 0) && (*q != '\0'))
        {
          (void) GetNextToken(q,&q,extent,token);
          while (
# 1223 "MagickCore/locale.c" 3 4
                ((*__ctype_b_loc ())[(int) ((
# 1223 "MagickCore/locale.c"
                (int) ((unsigned char) *q)
# 1223 "MagickCore/locale.c" 3 4
                ))] & (unsigned short int) _ISspace) 
# 1223 "MagickCore/locale.c"
    ...
    if (LocaleCompare(keyword,"<include") == 0)
      {
        ...
        while (((*token != '/') && (*(token+1) != '>')) && (*q != '\0'))
        {
          ...
          if (LocaleCompare(keyword,"file") == 0)
            {
              if (depth > 600)
                (void) ThrowMagickException(exception,"MagickCore/locale.c",__func__,(unsigned long) 1249,
              ...
              else
                {
                  ...
                  *path='\0';
                  ...
                  if (file_xml != (char *) 
# 1267 "MagickCore/locale.c" 3 4
                                          ((void *)0)
# 1267 "MagickCore/locale.c"
                                              )
                    {
    ...
    if (LocaleCompare(keyword,"</locale>") == 0)
      {
        ...
        (void) ConcatenateMagickString(tag,"/",256);
        continue;
      }
    ...
    if (LocaleCompare(keyword,"<message") == 0)
      {
        ...
        while ((*token != '>') && (*q != '\0'))
        {
          ...
          if (LocaleCompare(keyword,"name") == 0)
            {
              (void) ConcatenateMagickString(tag,token,256);
              (void) ConcatenateMagickString(tag,"/",256);
            }
        }
        for (p=(char *) q; (*q != '<') && (*q != '\0'); q++) ;
        while (
# 1322 "MagickCore/locale.c" 3 4
              ((*__ctype_b_loc ())[(int) ((
# 1322 "MagickCore/locale.c"
              (int) ((unsigned char) *p)
# 1322 "MagickCore/locale.c" 3 4
              ))] & (unsigned short int) _ISspace) 
# 1322 "MagickCore/locale.c"
        ...
        q--;
        while ((
# 1325 "MagickCore/locale.c" 3 4
               ((*__ctype_b_loc ())[(int) ((
# 1325 "MagickCore/locale.c"
               (int) ((unsigned char) *q)
# 1325 "MagickCore/locale.c" 3 4
               ))] & (unsigned short int) _ISspace) 
# 1325 "MagickCore/locale.c"
                                                   != 0) && (q > p))
          q--;
        (void) CopyMagickString(message,p,((((size_t) (q-p+2)) < (256)) ? ((size_t) (q-p+2)) : (256))
                             );
        ...
        if (status == MagickFalse)
          (void) ThrowMagickException(exception,"MagickCore/locale.c",__func__,(unsigned long) 1337,
            ResourceLimitError,"MemoryAllocationFailed","`%s'",
            locale_info->tag);
        (void) ConcatenateMagickString(tag,message,256);
    ...
    if (*keyword == '<')
      {
        ...
        (void) CopyMagickString(token,token+1,256);
        (void) ConcatenateMagickString(tag,token,256);
        (void) ConcatenateMagickString(tag,"/",256);
        continue;
      }
    (void) GetNextToken(q,(const char **) 
# 1371 "MagickCore/locale.c" 3 4
                                         ((void *)0)
# 1371 "MagickCore/locale.c"
                                             ,extent,token);
    if (*token != '=')
      continue;
  }
...
# 1410 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) int LocaleCompare(const char *p,const char *q)
{
  if (p == (char *) 
# 1412 "MagickCore/locale.c" 3 4
                   ((void *)0)
# 1412 "MagickCore/locale.c"
                       )
    {
      if (q == (char *) 
# 1414 "MagickCore/locale.c" 3 4
                       ((void *)0)
# 1414 "MagickCore/locale.c"
                           )
        return(0);
      return(-1);
    }
  if (q == (char *) 
# 1418 "MagickCore/locale.c" 3 4
                   ((void *)0)
# 1418 "MagickCore/locale.c"
                       )
    return(1);
  {
    const unsigned char
...
# 1454 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) void LocaleLower(char *string)
{
  char
    *q;

  
# 1459 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 1459 "MagickCore/locale.c"
 string != (char *) 
# 1459 "MagickCore/locale.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1459 "MagickCore/locale.c"
...
# 1459 "MagickCore/locale.c"
 "string != (char *) NULL"
# 1459 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 1459, __extension__ __PRETTY_FUNCTION__); }))
# 1459 "MagickCore/locale.c"
                                ;
  for (q=string; *q != '\0'; q++)
    *q=(char) LocaleToLowercase((int) *q);
}
# 1486 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) int LocaleLowercase(const int c)
{
  return(LocaleToLowercase(c));
}
# 1528 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) int LocaleNCompare(const char *p,const char *q,const size_t length)
{
  if (p == (char *) 
# 1530 "MagickCore/locale.c" 3 4
                   ((void *)0)
# 1530 "MagickCore/locale.c"
                       )
    {
      if (q == (char *) 
# 1532 "MagickCore/locale.c" 3 4
                       ((void *)0)
# 1532 "MagickCore/locale.c"
                           )
        return(0);
      return(-1);
    }
  if (q == (char *) 
# 1536 "MagickCore/locale.c" 3 4
                   ((void *)0)
# 1536 "MagickCore/locale.c"
                       )
    return(1);
  if (length == 0)
    return(0);
...
# 1577 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) void LocaleUpper(char *string)
{
  char
    *q;

  
# 1582 "MagickCore/locale.c" 3 4
 ((void) sizeof ((
# 1582 "MagickCore/locale.c"
 string != (char *) 
# 1582 "MagickCore/locale.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1582 "MagickCore/locale.c"
...
# 1582 "MagickCore/locale.c"
 "string != (char *) NULL"
# 1582 "MagickCore/locale.c" 3 4
 , "MagickCore/locale.c", 1582, __extension__ __PRETTY_FUNCTION__); }))
# 1582 "MagickCore/locale.c"
                                ;
  for (q=string; *q != '\0'; q++)
    *q=(char) LocaleToUppercase((int) *q);
}
# 1609 "MagickCore/locale.c"
__attribute__ ((visibility ("default"))) int LocaleUppercase(const int c)
{
  return(LocaleToUppercase(c));
}
# 1632 "MagickCore/locale.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType LocaleComponentGenesis(void)
{
  if (locale_semaphore == (SemaphoreInfo *) 
# 1634 "MagickCore/locale.c" 3 4
                                           ((void *)0)
# 1634 "MagickCore/locale.c"
                                               )
...
# 1660 "MagickCore/locale.c"
__attribute__ ((visibility ("hidden"))) void LocaleComponentTerminus(void)
{
  if (locale_semaphore == (SemaphoreInfo *) 
# 1662 "MagickCore/locale.c" 3 4
                                           ((void *)0)
# 1662 "MagickCore/locale.c"
                                               )
    ActivateSemaphoreInfo(&locale_semaphore);
  LockSemaphoreInfo(locale_semaphore);
  if (locale_cache != (SplayTreeInfo *) 
# 1665 "MagickCore/locale.c" 3 4
                                       ((void *)0)
# 1665 "MagickCore/locale.c"
                                           )
