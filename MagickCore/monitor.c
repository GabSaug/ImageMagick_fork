# 0 "MagickCore/monitor.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/monitor.c"
# 43 "MagickCore/monitor.c"
...
# 50 "MagickCore/monitor.c" 2




static SemaphoreInfo
  *monitor_semaphore = (SemaphoreInfo *) 
# 55 "MagickCore/monitor.c" 3 4
                                        ((void *)0)
# 55 "MagickCore/monitor.c"
                                            ;
# 75 "MagickCore/monitor.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType MonitorComponentGenesis(void)
{
  if (monitor_semaphore == (SemaphoreInfo *) 
# 77 "MagickCore/monitor.c" 3 4
                                            ((void *)0)
# 77 "MagickCore/monitor.c"
                                                )
    monitor_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 100 "MagickCore/monitor.c"
__attribute__ ((visibility ("hidden"))) void MonitorComponentTerminus(void)
{
  if (monitor_semaphore == (SemaphoreInfo *) 
# 102 "MagickCore/monitor.c" 3 4
                                            ((void *)0)
# 102 "MagickCore/monitor.c"
                                                )
...
# 141 "MagickCore/monitor.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetImageProgress(const Image *image,
...
# 150 "MagickCore/monitor.c" 3 4
                                                        ((void *)0)
# 150 "MagickCore/monitor.c"
                                                            )
    return(MagickTrue);
  (void) FormatLocaleString(message,4096,"%s/%s",
    tag == (const char *) 
# 153 "MagickCore/monitor.c" 3 4
                         ((void *)0) 
# 153 "MagickCore/monitor.c"
                              ? "null" : tag,image->filename);
  if (monitor_semaphore == (SemaphoreInfo *) 
# 154 "MagickCore/monitor.c" 3 4
                                            ((void *)0)
# 154 "MagickCore/monitor.c"
                                                )
    ActivateSemaphoreInfo(&monitor_semaphore);
  LockSemaphoreInfo(monitor_semaphore);
  status=image->progress_monitor(message,offset,extent,image->client_data);
  (void) FormatLocaleString(message,4096,"%g%%:%s:%s",
    (double) (100.0*offset*PerceptibleReciprocal(extent-1.0)),
    tag == (const char *) 
# 160 "MagickCore/monitor.c" 3 4
                         ((void *)0) 
# 160 "MagickCore/monitor.c"
                              ? "null" : tag,image->filename);
  (void) SetImageArtifact((Image *) image,"monitor:progress",message);
  UnlockSemaphoreInfo(monitor_semaphore);
  return(status);
}
# 203 "MagickCore/monitor.c"
__attribute__ ((visibility ("default"))) MagickProgressMonitor SetImageProgressMonitor(Image *image,
...
# 252 "MagickCore/monitor.c"
__attribute__ ((visibility ("default"))) MagickProgressMonitor SetImageInfoProgressMonitor(
