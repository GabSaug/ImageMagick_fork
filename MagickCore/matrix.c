# 0 "MagickCore/matrix.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/matrix.c"
# 42 "MagickCore/matrix.c"
...
# 125 "MagickCore/matrix.c"
static void MatrixSignalHandler(int magick_unused_status __attribute__((unused)))
{
  ;
  { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 128 "MagickCore/matrix.c" 3 4
 (*__errno_location ())
# 128 "MagickCore/matrix.c"
 ); (void) ThrowMagickException(fatal_exception,"MagickCore/matrix.c",__func__,(unsigned long) 128,CacheFatalError,"UnableToExtendMatrixCache", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (CacheFatalError-FatalErrorException)+1); };
}


static inline MagickOffsetType WriteMatrixElements(
  const MatrixInfo *__restrict__ matrix_info,const MagickOffsetType offset,
...
# 150 "MagickCore/matrix.c"
  ...
  for (i=0; i < (MagickOffsetType) length; i+=count)
  {
    ...
    count=pwrite(matrix_info->file,buffer+i,(size_t) (((length- (MagickSizeType) i) < ((MagickSizeType) (0x7fffffffffffffffL
# 157 "MagickCore/matrix.c"
    ...
    if (count <= 0)
      {
        count=0;
        if (
# 163 "MagickCore/matrix.c" 3 4
           (*__errno_location ()) 
# 163 "MagickCore/matrix.c"
                 != 
# 163 "MagickCore/matrix.c" 3 4
                    4
# 163 "MagickCore/matrix.c"
...
static MagickBooleanType SetMatrixExtent(
  MatrixInfo *__restrict__ matrix_info,MagickSizeType length)
{
  MagickOffsetType
    count,
    extent,
  ...
  if (length != (MagickSizeType) ((MagickOffsetType) length))
    return(MagickFalse);
  offset=(MagickOffsetType) lseek(matrix_info->file,0,
# 183 "MagickCore/matrix.c" 3 4
                                                     2
# 183 "MagickCore/matrix.c"
                                                             );
  if (offset < 0)
    return(MagickFalse);
  ...
  (void) signal(
# 195 "MagickCore/matrix.c" 3 4
               7
# 195 "MagickCore/matrix.c"
                     ,MatrixSignalHandler);

  return(count != (MagickOffsetType) 1 ? MagickFalse : MagickTrue);
}

__attribute__ ((visibility ("default"))) MatrixInfo *AcquireMatrixInfo(const size_t columns,
  const size_t rows,const size_t stride,ExceptionInfo *exception)
{
  ...
  if (matrix_info == (MatrixInfo *) 
# 213 "MagickCore/matrix.c" 3 4
                                   ((void *)0)
# 213 "MagickCore/matrix.c"
                                       )
    return((MatrixInfo *) 
# 214 "MagickCore/matrix.c" 3 4
                         ((void *)0)
# 214 "MagickCore/matrix.c"
                             );
  (void) memset(matrix_info,0,sizeof(*matrix_info));
  matrix_info->signature=0xabacadabUL;
...
# 222 "MagickCore/matrix.c" 3 4
                                   ((void *)0)
# 222 "MagickCore/matrix.c"
                                       )
    {
  ...
  if (matrix_info->columns != (size_t) (matrix_info->length/rows/stride))
    {
      (void) ThrowMagickException(exception,"MagickCore/matrix.c",__func__,(unsigned long) 230,CacheError,
      ...
      if (status != MagickFalse)
        {
          ...
          matrix_info->elements=AcquireMagickMemory((size_t)
            matrix_info->length);
          if (matrix_info->elements == 
# 245 "MagickCore/matrix.c" 3 4
                                      ((void *)0)
# 245 "MagickCore/matrix.c"
                                          )
            {
          ...
          if (matrix_info->elements == (unsigned short *) 
# 251 "MagickCore/matrix.c" 3 4
                                                         ((void *)0)
# 251 "MagickCore/matrix.c"
                                                             )
  ...
  matrix_info->file=(-1);
  if (matrix_info->elements == (unsigned short *) 
# 256 "MagickCore/matrix.c" 3 4
                                                 ((void *)0)
# 256 "MagickCore/matrix.c"
                                                     )
    {
      status=AcquireMagickResource(DiskResource,matrix_info->length);
      if (status == MagickFalse)
        {
          (void) ThrowMagickException(exception,"MagickCore/matrix.c",__func__,(unsigned long) 261,CacheError,
            "CacheResourcesExhausted","`%s'","matrix cache");
          return(DestroyMatrixInfo(matrix_info));
        }
      ...
      if (status != MagickFalse)
        {
          ...
          if (matrix_info->elements != 
# 276 "MagickCore/matrix.c" 3 4
                                      ((void *)0)
# 276 "MagickCore/matrix.c"
                                          )
...
# 317 "MagickCore/matrix.c"
__attribute__ ((visibility ("default"))) double **AcquireMagickMatrix(const size_t number_rows,
  const size_t size)
{
  double
    **matrix;
  ...
  if (matrix == (double **) 
# 328 "MagickCore/matrix.c" 3 4
                           ((void *)0)
# 328 "MagickCore/matrix.c"
                               )
    return((double **) 
# 329 "MagickCore/matrix.c" 3 4
                      ((void *)0)
# 329 "MagickCore/matrix.c"
                          );
  for (i=0; i < (ssize_t) number_rows; i++)
  {
    matrix[i]=(double *) AcquireQuantumMemory(size,sizeof(*matrix[i]));
    if (matrix[i] == (double *) 
# 333 "MagickCore/matrix.c" 3 4
                               ((void *)0)
# 333 "MagickCore/matrix.c"
                                   )
      {
        for (j=0; j < i; j++)
        ...
        return((double **) 
# 338 "MagickCore/matrix.c" 3 4
                          ((void *)0)
# 338 "MagickCore/matrix.c"
                              );
      }
...
# 369 "MagickCore/matrix.c"
__attribute__ ((visibility ("default"))) MatrixInfo *DestroyMatrixInfo(MatrixInfo *matrix_info)
{
  
# 371 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 371 "MagickCore/matrix.c"
...
# 371 "MagickCore/matrix.c"
 "matrix_info != (MatrixInfo *) NULL"
# 371 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 371, __extension__ __PRETTY_FUNCTION__); }))
# 371 "MagickCore/matrix.c"
                                           ;
  
# 372 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 372 "MagickCore/matrix.c"
 matrix_info->signature == 0xabacadabUL
# 372 "MagickCore/matrix.c" 3 4
...
# 372 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 372, __extension__ __PRETTY_FUNCTION__); }))
# 372 "MagickCore/matrix.c"
                                                      ;
    ...
    case MemoryCache:
    {
      if (matrix_info->mapped == MagickFalse)
      ...
      else
        {
          ...
          matrix_info->elements=(unsigned short *) 
# 383 "MagickCore/matrix.c" 3 4
                                                  ((void *)0)
# 383 "MagickCore/matrix.c"
                                                      ;
        }
      RelinquishMagickResource(MemoryResource,matrix_info->length);
      break;
...
# 391 "MagickCore/matrix.c" 3 4
                           ((void *)0)
# 391 "MagickCore/matrix.c"
                               ;
      RelinquishMagickResource(MapResource,matrix_info->length);
...
# 481 "MagickCore/matrix.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType GaussJordanElimination(double **matrix,
  double **vectors,const size_t rank,const size_t number_vectors)
{
# 494 "MagickCore/matrix.c"
  double
    max,
    scale;
  ...
  if ((rows == (ssize_t *) 
# 513 "MagickCore/matrix.c" 3 4
                          ((void *)0)
# 513 "MagickCore/matrix.c"
                              ) || (columns == (ssize_t *) 
# 513 "MagickCore/matrix.c" 3 4
                                                           ((void *)0)
# 513 "MagickCore/matrix.c"
      ...
      (pivots == (ssize_t *) 
# 514 "MagickCore/matrix.c" 3 4
                            ((void *)0)
# 514 "MagickCore/matrix.c"
                                ))
    {
      if (pivots != (ssize_t *) 
# 516 "MagickCore/matrix.c" 3 4
                               ((void *)0)
# 516 "MagickCore/matrix.c"
                                   )
        pivots=(ssize_t *) RelinquishMagickMemory(pivots);
      if (columns != (ssize_t *) 
# 518 "MagickCore/matrix.c" 3 4
                                ((void *)0)
# 518 "MagickCore/matrix.c"
                                    )
        columns=(ssize_t *) RelinquishMagickMemory(columns);
      if (rows != (ssize_t *) 
# 520 "MagickCore/matrix.c" 3 4
                             ((void *)0)
# 520 "MagickCore/matrix.c"
                                 )
  ...
  for (i=0; i < (ssize_t) rank; i++)
  {
    ...
    if (row != column)
      {
        for (k=0; k < (ssize_t) rank; k++)
          { if ((matrix[row][k]) != (matrix[column][k])) { (matrix[row][k])+=(matrix[column][k]); (matrix[column][k])=(matrix[row][k])-(matrix[column][k]); (matrix[row][k])=(matrix[row][k])-(matrix[column][k]); } };
        for (k=0; k < (ssize_t) number_vectors; k++)
          { if ((vectors[k][row]) != (vectors[k][column])) { (vectors[k][row])+=(vectors[k][column]); (vectors[k][column])=(vectors[k][row])-(vectors[k][column]); (vectors[k][row])=(vectors[k][row])-(vectors[k][column]); } };
      }
    rows[i]=row;
    columns[i]=column;
  ...
  for (j=(ssize_t) rank-1; j >= 0; j--)
    if (columns[j] != rows[j])
      for (i=0; i < (ssize_t) rank; i++)
        { if ((matrix[i][rows[j]]) != (matrix[i][columns[j]])) { (matrix[i][rows[j]])+=(matrix[i][columns[j]]); (matrix[i][columns[j]])=(matrix[i][rows[j]])-(matrix[i][columns[j]]); (matrix[i][rows[j]])=(matrix[i][rows[j]])-(matrix[i][columns[j]]); } };
  pivots=(ssize_t *) RelinquishMagickMemory(pivots);
  rows=(ssize_t *) RelinquishMagickMemory(rows);
  columns=(ssize_t *) RelinquishMagickMemory(columns);
  return(MagickTrue);
}
# 610 "MagickCore/matrix.c"
__attribute__ ((visibility ("default"))) size_t GetMatrixColumns(const MatrixInfo *matrix_info)
{
  
# 612 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 612 "MagickCore/matrix.c"
 matrix_info != (MatrixInfo *) 
# 612 "MagickCore/matrix.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 612 "MagickCore/matrix.c"
...
# 612 "MagickCore/matrix.c"
 "matrix_info != (MatrixInfo *) NULL"
# 612 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 612, __extension__ __PRETTY_FUNCTION__); }))
# 612 "MagickCore/matrix.c"
                                           ;
  
# 613 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 613 "MagickCore/matrix.c"
 matrix_info->signature == 0xabacadabUL
# 613 "MagickCore/matrix.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 613 "MagickCore/matrix.c"
...
# 613 "MagickCore/matrix.c"
 "matrix_info->signature == MagickCoreSignature"
# 613 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 613, __extension__ __PRETTY_FUNCTION__); }))
# 613 "MagickCore/matrix.c"
                                                      ;
  return(matrix_info->columns);
}
# 647 "MagickCore/matrix.c"
...
# 683 "MagickCore/matrix.c"
  ...
  for (i=0; i < (MagickOffsetType) length; i+=count)
  {
    ...
    count=pread(matrix_info->file,buffer+i,(size_t) (((length- (MagickSizeType) i) < ((MagickSizeType) (0x7fffffffffffffffL
# 690 "MagickCore/matrix.c"
                                                   ))) ? (length- (MagickSizeType) i) : ((MagickSizeType) (0x7fffffffffffffffL
# 690 "MagickCore/matrix.c"
                                                   )))
                                                           ,offset+i);
    ...
    if (count <= 0)
      {
        count=0;
        if (
# 696 "MagickCore/matrix.c" 3 4
           (*__errno_location ()) 
# 696 "MagickCore/matrix.c"
                 != 
# 696 "MagickCore/matrix.c" 3 4
                    4
# 696 "MagickCore/matrix.c"
...
__attribute__ ((visibility ("default"))) MagickBooleanType GetMatrixElement(const MatrixInfo *matrix_info,
...
# 713 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 713 "MagickCore/matrix.c"
 matrix_info != (const MatrixInfo *) 
# 713 "MagickCore/matrix.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 713 "MagickCore/matrix.c"
 matrix_info != (const MatrixInfo *) 
# 713 "MagickCore/matrix.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 713 "MagickCore/matrix.c"
 "matrix_info != (const MatrixInfo *) NULL"
# 713 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 713, __extension__ __PRETTY_FUNCTION__); }))
# 713 "MagickCore/matrix.c"
                                                 ;
  
# 714 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 714 "MagickCore/matrix.c"
 matrix_info->signature == 0xabacadabUL
# 714 "MagickCore/matrix.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 714 "MagickCore/matrix.c"
...
# 714 "MagickCore/matrix.c"
 "matrix_info->signature == MagickCoreSignature"
# 714 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 714, __extension__ __PRETTY_FUNCTION__); }))
# 714 "MagickCore/matrix.c"
                                                      ;
...
# 752 "MagickCore/matrix.c"
__attribute__ ((visibility ("default"))) size_t GetMatrixRows(const MatrixInfo *matrix_info)
{
  
# 754 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 754 "MagickCore/matrix.c"
 matrix_info != (const MatrixInfo *) 
# 754 "MagickCore/matrix.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 754 "MagickCore/matrix.c"
...
# 754 "MagickCore/matrix.c"
 "matrix_info != (const MatrixInfo *) NULL"
# 754 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 754, __extension__ __PRETTY_FUNCTION__); }))
# 754 "MagickCore/matrix.c"
                                                 ;
  
# 755 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 755 "MagickCore/matrix.c"
 matrix_info->signature == 0xabacadabUL
# 755 "MagickCore/matrix.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 755 "MagickCore/matrix.c"
...
# 755 "MagickCore/matrix.c"
 "matrix_info->signature == MagickCoreSignature"
# 755 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 755, __extension__ __PRETTY_FUNCTION__); }))
# 755 "MagickCore/matrix.c"
                                                      ;
  return(matrix_info->rows);
}
# 830 "MagickCore/matrix.c"
__attribute__ ((visibility ("hidden"))) void LeastSquaresAddTerms(double **matrix,double **vectors,
...
# 873 "MagickCore/matrix.c"
__attribute__ ((visibility ("default"))) Image *MatrixToImage(const MatrixInfo *matrix_info,
...
# 893 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 893 "MagickCore/matrix.c"
 matrix_info != (const MatrixInfo *) 
# 893 "MagickCore/matrix.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 893 "MagickCore/matrix.c"
...
# 893 "MagickCore/matrix.c"
 "matrix_info != (const MatrixInfo *) NULL"
# 893 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 893, __extension__ __PRETTY_FUNCTION__); }))
# 893 "MagickCore/matrix.c"
                                                 ;
  
# 894 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 894 "MagickCore/matrix.c"
 matrix_info->signature == 0xabacadabUL
# 894 "MagickCore/matrix.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 894 "MagickCore/matrix.c"
...
# 894 "MagickCore/matrix.c"
 "matrix_info->signature == MagickCoreSignature"
# 894 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 894, __extension__ __PRETTY_FUNCTION__); }))
# 894 "MagickCore/matrix.c"
                                                      ;
  
# 895 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 895 "MagickCore/matrix.c"
...
# 895 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 895, __extension__ __PRETTY_FUNCTION__); }))
# 895 "MagickCore/matrix.c"
                                            ;
  
# 896 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 896 "MagickCore/matrix.c"
...
# 896 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 896, __extension__ __PRETTY_FUNCTION__); }))
# 896 "MagickCore/matrix.c"
                                                    ;
  if (matrix_info->stride < sizeof(double))
    return((Image *) 
# 898 "MagickCore/matrix.c" 3 4
                    ((void *)0)
# 898 "MagickCore/matrix.c"
                        );
...
# 936 "MagickCore/matrix.c" 3 4
                                  ((void *)0)
# 936 "MagickCore/matrix.c"
                                      ,exception);
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (q == (Quantum *) 
# 960 "MagickCore/matrix.c" 3 4
                        ((void *)0)
# 960 "MagickCore/matrix.c"
                            )
      {
        status=MagickFalse;
        continue;
...
# 1004 "MagickCore/matrix.c"
__attribute__ ((visibility ("default"))) MagickBooleanType NullMatrix(MatrixInfo *matrix_info)
{
  ssize_t
    x;
...
# 1016 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 1016 "MagickCore/matrix.c"
 matrix_info != (const MatrixInfo *) 
# 1016 "MagickCore/matrix.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1016 "MagickCore/matrix.c"
...
# 1016 "MagickCore/matrix.c"
 "matrix_info != (const MatrixInfo *) NULL"
# 1016 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 1016, __extension__ __PRETTY_FUNCTION__); }))
# 1016 "MagickCore/matrix.c"
                                                 ;
  
# 1017 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 1017 "MagickCore/matrix.c"
 matrix_info->signature == 0xabacadabUL
# 1017 "MagickCore/matrix.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1017 "MagickCore/matrix.c"
...
# 1017 "MagickCore/matrix.c"
 "matrix_info->signature == MagickCoreSignature"
# 1017 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 1017, __extension__ __PRETTY_FUNCTION__); }))
# 1017 "MagickCore/matrix.c"
                                                      ;
  if (matrix_info->type != DiskCache)
    {
  ...
  value=0;
  (void) lseek(matrix_info->file,0,
# 1025 "MagickCore/matrix.c" 3 4
                                  0
# 1025 "MagickCore/matrix.c"
                                          );
  for (y=0; y < (ssize_t) matrix_info->rows; y++)
  {
...
# 1067 "MagickCore/matrix.c"
__attribute__ ((visibility ("default"))) double **RelinquishMagickMatrix(double **matrix,
  const size_t number_rows)
{
  ...
  if (matrix == (double **) 
# 1073 "MagickCore/matrix.c" 3 4
                           ((void *)0) 
# 1073 "MagickCore/matrix.c"
                                )
    return(matrix);
  for (i=0; i < (ssize_t) number_rows; i++)
...
# 1111 "MagickCore/matrix.c"
__attribute__ ((visibility ("default"))) MagickBooleanType SetMatrixElement(const MatrixInfo *matrix_info,
...
# 1118 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 1118 "MagickCore/matrix.c"
 matrix_info != (const MatrixInfo *) 
# 1118 "MagickCore/matrix.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1118 "MagickCore/matrix.c"
...
# 1118 "MagickCore/matrix.c"
 "matrix_info != (const MatrixInfo *) NULL"
# 1118 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 1118, __extension__ __PRETTY_FUNCTION__); }))
# 1118 "MagickCore/matrix.c"
                                                 ;
  
# 1119 "MagickCore/matrix.c" 3 4
 ((void) sizeof ((
# 1119 "MagickCore/matrix.c"
 matrix_info->signature == 0xabacadabUL
# 1119 "MagickCore/matrix.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1119 "MagickCore/matrix.c"
...
# 1119 "MagickCore/matrix.c"
 "matrix_info->signature == MagickCoreSignature"
# 1119 "MagickCore/matrix.c" 3 4
 , "MagickCore/matrix.c", 1119, __extension__ __PRETTY_FUNCTION__); }))
# 1119 "MagickCore/matrix.c"
                                                      ;
