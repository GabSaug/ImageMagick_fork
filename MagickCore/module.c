# 0 "MagickCore/module.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/module.c"
# 43 "MagickCore/module.c"
...
# 69 "MagickCore/module.c" 2
# 1640 "MagickCore/module.c"
extern size_t
  analyzeImage(Image **,const int,const char **,ExceptionInfo *);


__attribute__ ((visibility ("default"))) MagickBooleanType ListModuleInfo(FILE *magick_unused_file __attribute__((unused)),
...
__attribute__ ((visibility ("default"))) MagickBooleanType InvokeDynamicImageFilter(const char *tag,
...
# 1658 "MagickCore/module.c" 3 4
 ((void) sizeof ((
# 1658 "MagickCore/module.c"
 image != (Image **) 
# 1658 "MagickCore/module.c" 3 4
...
# 1658 "MagickCore/module.c"
 "image != (Image **) NULL"
# 1658 "MagickCore/module.c" 3 4
 , "MagickCore/module.c", 1658, __extension__ __PRETTY_FUNCTION__); }))
# 1658 "MagickCore/module.c"
                                 ;
  
# 1659 "MagickCore/module.c" 3 4
 ((void) sizeof ((
# 1659 "MagickCore/module.c"
...
# 1659 "MagickCore/module.c" 3 4
 , "MagickCore/module.c", 1659, __extension__ __PRETTY_FUNCTION__); }))
# 1659 "MagickCore/module.c"
                                                   ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/module.c",__func__,(unsigned long) 1661,"%s",(*image)->filename);
  rights=ReadPolicyRights;
  if (IsRightsAuthorized(FilterPolicyDomain,rights,tag) == MagickFalse)
    {
      
# 1665 "MagickCore/module.c" 3 4
     (*__errno_location ())
# 1665 "MagickCore/module.c"
          =
# 1665 "MagickCore/module.c" 3 4
           1
# 1665 "MagickCore/module.c"
                ;
      (void) ThrowMagickException(exception,"MagickCore/module.c",__func__,(unsigned long) 1666,PolicyError,
        "NotAuthorized","`%s'",tag);
      return(MagickFalse);
    }
...
# 1680 "MagickCore/module.c" 3 4
                                       ((void *)0)
# 1680 "MagickCore/module.c"
                                           ;
    if (LocaleCompare("analyze",tag) == 0)
      image_filter=(ImageFilterHandler *) analyzeImage;
    if (image_filter == (ImageFilterHandler *) 
# 1683 "MagickCore/module.c" 3 4
                                              ((void *)0)
# 1683 "MagickCore/module.c"
                                                  )
      (void) ThrowMagickException(exception,"MagickCore/module.c",__func__,(unsigned long) 1684,ModuleError,
    ...
    else
      {
        ...
        if ((*image)->debug != MagickFalse)
          (void) LogMagickEvent(TransformEvent,"MagickCore/module.c",__func__,(unsigned long) 1692,
            "Invoking \"%s\" static image filter",tag);
        signature=image_filter(image,argc,argv,exception);
        if ((*image)->debug != MagickFalse)
          (void) LogMagickEvent(TransformEvent,"MagickCore/module.c",__func__,(unsigned long) 1696,
            "\"%s\" completes",tag);
        if (signature != ((size_t) (((10) << 8) | 16)))
          {
            (void) ThrowMagickException(exception,"MagickCore/module.c",__func__,(unsigned long) 1700,ModuleError,
