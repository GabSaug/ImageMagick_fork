# 0 "MagickCore/feature.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/feature.c"
# 43 "MagickCore/feature.c"
...
# 96 "MagickCore/feature.c" 2
# 134 "MagickCore/feature.c"
  ...
  const double lower_threshold,ExceptionInfo *exception)
{
  ...
  if (q == (Quantum *) 
# 176 "MagickCore/feature.c" 3 4
                      ((void *)0)
# 176 "MagickCore/feature.c"
                          )
    return(MagickFalse);
  *q=((Quantum) 65535.0);
    ...
    for (v=(-1); v <= 1; v++)
    {
      ...
      for (u=(-1); u <= 1; u++)
      {
        ...
        q=GetCacheViewAuthenticPixels(edge_view,edge.x+u,edge.y+v,1,1,
          exception);
        if (q == (Quantum *) 
# 213 "MagickCore/feature.c" 3 4
                            ((void *)0)
# 213 "MagickCore/feature.c"
                                )
          return(MagickFalse);
...
__attribute__ ((visibility ("default"))) Image *CannyEdgeImage(const Image *image,const double radius,
...
# 277 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 277 "MagickCore/feature.c"
 image != (const Image *) 
# 277 "MagickCore/feature.c" 3 4
...
# 277 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 277, __extension__ __PRETTY_FUNCTION__); }))
# 277 "MagickCore/feature.c"
                                      ;
  
# 278 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 278 "MagickCore/feature.c"
...
# 278 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 278, __extension__ __PRETTY_FUNCTION__); }))
# 278 "MagickCore/feature.c"
                                                ;
  
# 279 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 279 "MagickCore/feature.c"
...
# 279 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 279, __extension__ __PRETTY_FUNCTION__); }))
# 279 "MagickCore/feature.c"
                                            ;
  
# 280 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 280 "MagickCore/feature.c"
...
# 280 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 280, __extension__ __PRETTY_FUNCTION__); }))
# 280 "MagickCore/feature.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/feature.c",__func__,(unsigned long) 282,"%s",image->filename);
...
# 289 "MagickCore/feature.c" 3 4
                                   ((void *)0)
# 289 "MagickCore/feature.c"
                                       )
    { (void) ThrowMagickException(exception,"MagickCore/feature.c",__func__,(unsigned long) 290,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 290 "MagickCore/feature.c" 3 4
   ((void *)0)
# 290 "MagickCore/feature.c"
   ); };
  edge_image=MorphologyImage(image,ConvolveMorphology,1,kernel_info,exception);
  kernel_info=DestroyKernelInfo(kernel_info);
  if (edge_image == (Image *) 
# 293 "MagickCore/feature.c" 3 4
                             ((void *)0)
# 293 "MagickCore/feature.c"
                                 )
    return((Image *) 
# 294 "MagickCore/feature.c" 3 4
                    ((void *)0)
# 294 "MagickCore/feature.c"
                        );
  if (TransformImageColorspace(edge_image,GRAYColorspace,exception) == MagickFalse)
    {
      edge_image=DestroyImage(edge_image);
      return((Image *) 
# 298 "MagickCore/feature.c" 3 4
                      ((void *)0)
# 298 "MagickCore/feature.c"
                          );
    }
  ...
  if (canny_cache == (MatrixInfo *) 
# 306 "MagickCore/feature.c" 3 4
                                   ((void *)0)
# 306 "MagickCore/feature.c"
                                       )
    {
      edge_image=DestroyImage(edge_image);
      return((Image *) 
# 309 "MagickCore/feature.c" 3 4
                      ((void *)0)
# 309 "MagickCore/feature.c"
                          );
    }
  status=MagickTrue;
  ...
  for (y=0; y < (ssize_t) edge_image->rows; y++)
  {
    ...
    p=GetCacheViewVirtualPixels(edge_view,0,y,edge_image->columns+1,2,
      exception);
    if (p == (const Quantum *) 
# 329 "MagickCore/feature.c" 3 4
                              ((void *)0)
# 329 "MagickCore/feature.c"
                                  )
      {
        status=MagickFalse;
        continue;
  ...
  for (y=0; y < (ssize_t) edge_image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(edge_view,0,y,edge_image->columns,1,
      exception);
    if (q == (Quantum *) 
# 441 "MagickCore/feature.c" 3 4
                        ((void *)0)
# 441 "MagickCore/feature.c"
                            )
      {
        status=MagickFalse;
        continue;
  ...
  for (y=0; y < (ssize_t) edge_image->rows; y++)
  {
    ...
    for (x=0; x < (ssize_t) edge_image->columns; x++)
    {
      ...
      if (p == (const Quantum *) 
# 543 "MagickCore/feature.c" 3 4
                                ((void *)0)
# 543 "MagickCore/feature.c"
                                    )
        continue;
...
# 553 "MagickCore/feature.c" 3 4
                                                          ((void *)0)
# 553 "MagickCore/feature.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"CannyEdge/Image",progress,image->rows);
...
# 614 "MagickCore/feature.c"
__attribute__ ((visibility ("default"))) ChannelFeatures *GetImageFeatures(const Image *image,
...
# 663 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 663 "MagickCore/feature.c"
 image != (Image *) 
# 663 "MagickCore/feature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 663 "MagickCore/feature.c"
...
# 663 "MagickCore/feature.c"
 "image != (Image *) NULL"
# 663 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 663, __extension__ __PRETTY_FUNCTION__); }))
# 663 "MagickCore/feature.c"
                                ;
  
# 664 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 664 "MagickCore/feature.c"
 image->signature == 0xabacadabUL
# 664 "MagickCore/feature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 664 "MagickCore/feature.c"
...
# 664 "MagickCore/feature.c"
 "image->signature == MagickCoreSignature"
# 664 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 664, __extension__ __PRETTY_FUNCTION__); }))
# 664 "MagickCore/feature.c"
                                                ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/feature.c",__func__,(unsigned long) 666,"%s",image->filename);
  if ((image->columns < (distance+1)) || (image->rows < (distance+1)))
    return((ChannelFeatures *) 
# 668 "MagickCore/feature.c" 3 4
                              ((void *)0)
# 668 "MagickCore/feature.c"
                                  );
  length=64 +1UL;
  channel_features=(ChannelFeatures *) AcquireQuantumMemory(length,
    sizeof(*channel_features));
  if (channel_features == (ChannelFeatures *) 
# 672 "MagickCore/feature.c" 3 4
                                             ((void *)0)
# 672 "MagickCore/feature.c"
                                                 )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 673 "MagickCore/feature.c" 3 4
   (*__errno_location ())
# 673 "MagickCore/feature.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/feature.c",__func__,(unsigned long) 673,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  (void) memset(channel_features,0,length*
    sizeof(*channel_features));



  grays=(PixelPacket *) AcquireQuantumMemory(65535UL +1UL,sizeof(*grays));
  if (grays == (PixelPacket *) 
# 680 "MagickCore/feature.c" 3 4
                              ((void *)0)
# 680 "MagickCore/feature.c"
                                  )
    {
      channel_features=(ChannelFeatures *) RelinquishMagickMemory(
        channel_features);
      (void) ThrowMagickException(exception,"MagickCore/feature.c",__func__,(unsigned long) 684,
  ...
  for (r=0; r < (ssize_t) image->rows; r++)
  {
    ...
    if (p == (const Quantum *) 
# 713 "MagickCore/feature.c" 3 4
                              ((void *)0)
# 713 "MagickCore/feature.c"
                                  )
      {
        status=MagickFalse;
        continue;
  ...
  if ((cooccurrence == (ChannelStatistics **) 
# 783 "MagickCore/feature.c" 3 4
                                             ((void *)0)
# 783 "MagickCore/feature.c"
                                                 ) ||
      (density_x == (ChannelStatistics *) 
# 784 "MagickCore/feature.c" 3 4
                                         ((void *)0)
# 784 "MagickCore/feature.c"
                                             ) ||
      (density_xy == (ChannelStatistics *) 
# 785 "MagickCore/feature.c" 3 4
                                          ((void *)0)
# 785 "MagickCore/feature.c"
                                              ) ||
      (density_y == (ChannelStatistics *) 
# 786 "MagickCore/feature.c" 3 4
                                         ((void *)0)
# 786 "MagickCore/feature.c"
                                             ) ||
      (Q == (ChannelStatistics **) 
# 787 "MagickCore/feature.c" 3 4
                                  ((void *)0)
# 787 "MagickCore/feature.c"
                                      ) ||
      (sum == (ChannelStatistics *) 
# 788 "MagickCore/feature.c" 3 4
                                   ((void *)0)
# 788 "MagickCore/feature.c"
                                       ))
    {
      if (Q != (ChannelStatistics **) 
# 790 "MagickCore/feature.c" 3 4
                                     ((void *)0)
# 790 "MagickCore/feature.c"
                                         )
        {
...
# 796 "MagickCore/feature.c" 3 4
                                      ((void *)0)
# 796 "MagickCore/feature.c"
                                          )
        sum=(ChannelStatistics *) RelinquishMagickMemory(sum);
      if (density_y != (ChannelStatistics *) 
# 798 "MagickCore/feature.c" 3 4
                                            ((void *)0)
# 798 "MagickCore/feature.c"
                                                )
        density_y=(ChannelStatistics *) RelinquishMagickMemory(density_y);
      if (density_xy != (ChannelStatistics *) 
# 800 "MagickCore/feature.c" 3 4
                                             ((void *)0)
# 800 "MagickCore/feature.c"
                                                 )
        density_xy=(ChannelStatistics *) RelinquishMagickMemory(density_xy);
      if (density_x != (ChannelStatistics *) 
# 802 "MagickCore/feature.c" 3 4
                                            ((void *)0)
# 802 "MagickCore/feature.c"
                                                )
        density_x=(ChannelStatistics *) RelinquishMagickMemory(density_x);
      if (cooccurrence != (ChannelStatistics **) 
# 804 "MagickCore/feature.c" 3 4
                                                ((void *)0)
# 804 "MagickCore/feature.c"
                                                    )
        {
          for (i=0; i < (ssize_t) number_grays; i++)
      ...
      channel_features=(ChannelFeatures *) RelinquishMagickMemory(
        channel_features);
      (void) ThrowMagickException(exception,"MagickCore/feature.c",__func__,(unsigned long) 815,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",image->filename);
      return(channel_features);
    }
  ...
  for (i=0; i < (ssize_t) number_grays; i++)
  {
    ...
    if ((cooccurrence[i] == (ChannelStatistics *) 
# 838 "MagickCore/feature.c" 3 4
                                                 ((void *)0)
# 838 "MagickCore/feature.c"
                                                     ) ||
        (Q[i] == (ChannelStatistics *) 
# 839 "MagickCore/feature.c" 3 4
                                      ((void *)0)
# 839 "MagickCore/feature.c"
                                          ))
      break;
  ...
  if (i < (ssize_t) number_grays)
    {
      for (i--; i >= 0; i--)
      {
        if (Q[i] != (ChannelStatistics *) 
# 849 "MagickCore/feature.c" 3 4
                                         ((void *)0)
# 849 "MagickCore/feature.c"
                                             )
          Q[i]=(ChannelStatistics *) RelinquishMagickMemory(Q[i]);
        if (cooccurrence[i] != (ChannelStatistics *) 
# 851 "MagickCore/feature.c" 3 4
                                                    ((void *)0)
# 851 "MagickCore/feature.c"
                                                        )
          cooccurrence[i]=(ChannelStatistics *)
            RelinquishMagickMemory(cooccurrence[i]);
      }
      ...
      channel_features=(ChannelFeatures *) RelinquishMagickMemory(
        channel_features);
      (void) ThrowMagickException(exception,"MagickCore/feature.c",__func__,(unsigned long) 864,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",image->filename);
      return(channel_features);
    }
  ...
  for (r=0; r < (ssize_t) image->rows; r++)
  {
    ...
    if (p == (const Quantum *) 
# 890 "MagickCore/feature.c" 3 4
                              ((void *)0)
# 890 "MagickCore/feature.c"
                                  )
      {
        status=MagickFalse;
        continue;
  ...
  if (status == MagickFalse)
    {
      ...
      channel_features=(ChannelFeatures *) RelinquishMagickMemory(
        channel_features);
      (void) ThrowMagickException(exception,"MagickCore/feature.c",__func__,(unsigned long) 996,
        ResourceLimitError,"MemoryAllocationFailed","`%s'",image->filename);
      return(channel_features);
    }
  ...
  for (i=0; i < 4; i++)
  {
    ...
    for (y=0; y < (ssize_t) number_grays; y++)
    {
      ...
      for (x=0; x < (ssize_t) number_grays; x++)
      {
        ...
        density_xy[((y-x) < 0 ? -(y-x) : (y-x))].direction[i].red+=
          cooccurrence[x][y].direction[i].red;
        density_xy[((y-x) < 0 ? -(y-x) : (y-x))].direction[i].green+=
          cooccurrence[x][y].direction[i].green;
        density_xy[((y-x) < 0 ? -(y-x) : (y-x))].direction[i].blue+=
          cooccurrence[x][y].direction[i].blue;
        if (image->colorspace == CMYKColorspace)
          density_xy[((y-x) < 0 ? -(y-x) : (y-x))].direction[i].black+=
            cooccurrence[x][y].direction[i].black;
        if (image->alpha_trait != UndefinedPixelTrait)
          density_xy[((y-x) < 0 ? -(y-x) : (y-x))].direction[i].alpha+=
            cooccurrence[x][y].direction[i].alpha;
    ...
    for (z=0; z < (ssize_t) number_grays; z++)
    {
      ...
      for (y=0; y < (ssize_t) number_grays; y++)
      {
        ...
        for (x=0; x < (ssize_t) number_grays; x++)
        {
          ...
          if ((fabs(density_x[z].direction[i].red) > 1.0e-12) &&
              (fabs(density_y[x].direction[i].red) > 1.0e-12))
          ...
          if ((fabs(density_x[z].direction[i].green) > 1.0e-12) &&
              (fabs(density_y[x].direction[i].red) > 1.0e-12))
          ...
          if ((fabs(density_x[z].direction[i].blue) > 1.0e-12) &&
              (fabs(density_y[x].direction[i].blue) > 1.0e-12))
          ...
          if (image->colorspace == CMYKColorspace)
            if ((fabs(density_x[z].direction[i].black) > 1.0e-12) &&
                (fabs(density_y[x].direction[i].black) > 1.0e-12))
          ...
          if (image->alpha_trait != UndefinedPixelTrait)
            if ((fabs(density_x[z].direction[i].alpha) > 1.0e-12) &&
                (fabs(density_y[x].direction[i].alpha) > 1.0e-12))
  ...
  if (status == MagickFalse)
    {
      ...
      return((Image *) 
# 1788 "MagickCore/feature.c" 3 4
                      ((void *)0)
# 1788 "MagickCore/feature.c"
                          );
    }
  image->columns=columns;
  image->rows=rows;
  draw_info=CloneDrawInfo(image_info,(DrawInfo *) 
# 1792 "MagickCore/feature.c" 3 4
                                                 ((void *)0)
# 1792 "MagickCore/feature.c"
                                                     );
  ...
  if (SetImageBackgroundColor(image,exception) == MagickFalse)
    {
      image=DestroyImageList(image);
      return((Image *) 
# 1805 "MagickCore/feature.c" 3 4
                      ((void *)0)
# 1805 "MagickCore/feature.c"
                          );
    }



  if (GetBlobStreamData(image) == (unsigned char *) 
# 1810 "MagickCore/feature.c" 3 4
                                                   ((void *)0)
# 1810 "MagickCore/feature.c"
                                                       )
...
# 1816 "MagickCore/feature.c" 3 4
                                          ((void *)0)
# 1816 "MagickCore/feature.c"
                                              )
        {
...
__attribute__ ((visibility ("default"))) Image *HoughLineImage(const Image *image,const size_t width,
  const size_t height,const size_t threshold,ExceptionInfo *exception)
{
  ...
  Image
    *lines_image = 
# 1849 "MagickCore/feature.c" 3 4
                  ((void *)0)
# 1849 "MagickCore/feature.c"
                      ;
...
# 1880 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 1880 "MagickCore/feature.c"
 image != (const Image *) 
# 1880 "MagickCore/feature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1880 "MagickCore/feature.c"
...
# 1880 "MagickCore/feature.c"
 "image != (const Image *) NULL"
# 1880 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 1880, __extension__ __PRETTY_FUNCTION__); }))
# 1880 "MagickCore/feature.c"
                                      ;
  
# 1881 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 1881 "MagickCore/feature.c"
 image->signature == 0xabacadabUL
# 1881 "MagickCore/feature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1881 "MagickCore/feature.c"
...
# 1881 "MagickCore/feature.c"
 "image->signature == MagickCoreSignature"
# 1881 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 1881, __extension__ __PRETTY_FUNCTION__); }))
# 1881 "MagickCore/feature.c"
                                                ;
  
# 1882 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 1882 "MagickCore/feature.c"
 exception != (ExceptionInfo *) 
# 1882 "MagickCore/feature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1882 "MagickCore/feature.c"
...
# 1882 "MagickCore/feature.c"
 "exception != (ExceptionInfo *) NULL"
# 1882 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 1882, __extension__ __PRETTY_FUNCTION__); }))
# 1882 "MagickCore/feature.c"
                                            ;
  
# 1883 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 1883 "MagickCore/feature.c"
 exception->signature == 0xabacadabUL
# 1883 "MagickCore/feature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1883 "MagickCore/feature.c"
...
# 1883 "MagickCore/feature.c"
 "exception->signature == MagickCoreSignature"
# 1883 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 1883, __extension__ __PRETTY_FUNCTION__); }))
# 1883 "MagickCore/feature.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/feature.c",__func__,(unsigned long) 1885,"%s",image->filename);
  ...
  if (accumulator == (MatrixInfo *) 
# 1892 "MagickCore/feature.c" 3 4
                                   ((void *)0)
# 1892 "MagickCore/feature.c"
                                       )
    { (void) ThrowMagickException(exception,"MagickCore/feature.c",__func__,(unsigned long) 1893,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 1893 "MagickCore/feature.c" 3 4
   ((void *)0)
# 1893 "MagickCore/feature.c"
   ); };
  if (NullMatrix(accumulator) == MagickFalse)
    {
      accumulator=DestroyMatrixInfo(accumulator);
      { (void) ThrowMagickException(exception,"MagickCore/feature.c",__func__,(unsigned long) 1897,ResourceLimitError,"MemoryAllocationFailed", "`%s'",image->filename); return((Image *) 
# 1897 "MagickCore/feature.c" 3 4
     ((void *)0)
# 1897 "MagickCore/feature.c"
     ); };
    }
  ...
  for (y=0; y < (ssize_t) image->rows; y++)
  {
    ...
    if (p == (Quantum *) 
# 1918 "MagickCore/feature.c" 3 4
                        ((void *)0)
# 1918 "MagickCore/feature.c"
                            )
      {
        status=MagickFalse;
        continue;
    ...
    for (x=0; x < (ssize_t) image->columns; x++)
    {
      if (GetPixelIntensity(image,p) > ((double) ((Quantum) 65535.0)/2.0))
        {
          ssize_t
            i;
    ...
    if (image->progress_monitor != (MagickProgressMonitor) 
# 1947 "MagickCore/feature.c" 3 4
                                                          ((void *)0)
# 1947 "MagickCore/feature.c"
                                                              )
      {
        MagickBooleanType
          proceed;
  ...
  if (status == MagickFalse)
    {
      accumulator=DestroyMatrixInfo(accumulator);
      return((Image *) 
# 1965 "MagickCore/feature.c" 3 4
                      ((void *)0)
# 1965 "MagickCore/feature.c"
                          );
    }
  ...
  if (file == -1)
    {
      accumulator=DestroyMatrixInfo(accumulator);
      return((Image *) 
# 1974 "MagickCore/feature.c" 3 4
                      ((void *)0)
# 1974 "MagickCore/feature.c"
                          );
    }
...
# 2094 "MagickCore/feature.c"
  ...
  if ((lines_image != (Image *) 
# 2098 "MagickCore/feature.c" 3 4
                               ((void *)0)
# 2098 "MagickCore/feature.c"
                                   ) &&
      (IsStringTrue(artifact) != MagickFalse))
    {
      ...
      if (accumulator_image != (Image *) 
# 2105 "MagickCore/feature.c" 3 4
                                        ((void *)0)
# 2105 "MagickCore/feature.c"
                                            )
...
# 2157 "MagickCore/feature.c"
__attribute__ ((visibility ("default"))) Image *MeanShiftImage(const Image *image,const size_t width,
...
# 2180 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 2180 "MagickCore/feature.c"
 image != (const Image *) 
# 2180 "MagickCore/feature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2180 "MagickCore/feature.c"
...
# 2180 "MagickCore/feature.c"
 "image != (const Image *) NULL"
# 2180 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 2180, __extension__ __PRETTY_FUNCTION__); }))
# 2180 "MagickCore/feature.c"
                                      ;
  
# 2181 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 2181 "MagickCore/feature.c"
 image->signature == 0xabacadabUL
# 2181 "MagickCore/feature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2181 "MagickCore/feature.c"
...
# 2181 "MagickCore/feature.c"
 "image->signature == MagickCoreSignature"
# 2181 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 2181, __extension__ __PRETTY_FUNCTION__); }))
# 2181 "MagickCore/feature.c"
                                                ;
  
# 2182 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 2182 "MagickCore/feature.c"
 exception != (ExceptionInfo *) 
# 2182 "MagickCore/feature.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 2182 "MagickCore/feature.c"
...
# 2182 "MagickCore/feature.c"
 "exception != (ExceptionInfo *) NULL"
# 2182 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 2182, __extension__ __PRETTY_FUNCTION__); }))
# 2182 "MagickCore/feature.c"
                                            ;
  
# 2183 "MagickCore/feature.c" 3 4
 ((void) sizeof ((
# 2183 "MagickCore/feature.c"
 exception->signature == 0xabacadabUL
# 2183 "MagickCore/feature.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 2183 "MagickCore/feature.c"
...
# 2183 "MagickCore/feature.c"
 "exception->signature == MagickCoreSignature"
# 2183 "MagickCore/feature.c" 3 4
 , "MagickCore/feature.c", 2183, __extension__ __PRETTY_FUNCTION__); }))
# 2183 "MagickCore/feature.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/feature.c",__func__,(unsigned long) 2185,"%s",image->filename);
  mean_image=CloneImage(image,0,0,MagickTrue,exception);
  if (mean_image == (Image *) 
# 2187 "MagickCore/feature.c" 3 4
                             ((void *)0)
# 2187 "MagickCore/feature.c"
                                 )
    return((Image *) 
# 2188 "MagickCore/feature.c" 3 4
                    ((void *)0)
# 2188 "MagickCore/feature.c"
                        );
  if (SetImageStorageClass(mean_image,DirectClass,exception) == MagickFalse)
    {
      mean_image=DestroyImage(mean_image);
      return((Image *) 
# 2192 "MagickCore/feature.c" 3 4
                      ((void *)0)
# 2192 "MagickCore/feature.c"
                          );
    }
  status=MagickTrue;
  progress=0;
  ...
  for (y=0; y < (ssize_t) mean_image->rows; y++)
  {
    ...
    q=GetCacheViewAuthenticPixels(mean_view,0,y,mean_image->columns,1,
      exception);
    if ((p == (const Quantum *) 
# 2219 "MagickCore/feature.c" 3 4
                               ((void *)0)
# 2219 "MagickCore/feature.c"
                                   ) || (q == (Quantum *) 
# 2219 "MagickCore/feature.c" 3 4
                                                          ((void *)0)
# 2219 "MagickCore/feature.c"
    ...
    for (x=0; x < (ssize_t) mean_image->columns; x++)
    {
      ...
      for (i=0; i < 100; i++)
      {
        ...
        distance=(mean_location.x-previous_location.x)*
          ...
          (mean_location.y-previous_location.y)+
          255.0*((double) 1.0/(double) ((Quantum) 65535.0))*(mean_pixel.red-previous_pixel.red)*
          255.0*((double) 1.0/(double) ((Quantum) 65535.0))*(mean_pixel.red-previous_pixel.red)+
          255.0*((double) 1.0/(double) ((Quantum) 65535.0))*(mean_pixel.green-previous_pixel.green)*
          255.0*((double) 1.0/(double) ((Quantum) 65535.0))*(mean_pixel.green-previous_pixel.green)+
          255.0*((double) 1.0/(double) ((Quantum) 65535.0))*(mean_pixel.blue-previous_pixel.blue)*
          255.0*((double) 1.0/(double) ((Quantum) 65535.0))*(mean_pixel.blue-previous_pixel.blue);
        if (distance <= 3.0)
          break;
      }
    ...
    if (SyncCacheViewAuthenticPixels(mean_view,exception) == MagickFalse)
      status=MagickFalse;
    if (image->progress_monitor != (MagickProgressMonitor) 
# 2324 "MagickCore/feature.c" 3 4
                                                          ((void *)0)
# 2324 "MagickCore/feature.c"
                                                              )
      {
        MagickBooleanType
          proceed;
        ...
        progress++;
        proceed=SetImageProgress(image,"MeanShift/Image",progress,image->rows);
        if (proceed == MagickFalse)
          status=MagickFalse;
      }
  }
