# 0 "MagickCore/random.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/random.c"
# 50 "MagickCore/random.c"
...
# 67 "MagickCore/random.c" 2

# 1 "/usr/include/x86_64-linux-gnu/sys/random.h" 1 3 4
# 30 "/usr/include/x86_64-linux-gnu/sys/random.h" 3 4





# 34 "/usr/include/x86_64-linux-gnu/sys/random.h" 3 4
...
# 69 "MagickCore/random.c" 2
# 83 "MagickCore/random.c"
...
static SemaphoreInfo
  *random_semaphore = (SemaphoreInfo *) 
# 135 "MagickCore/random.c" 3 4
                                       ((void *)0)
# 135 "MagickCore/random.c"
                                           ;
...
# 167 "MagickCore/random.c"
__attribute__ ((visibility ("default"))) RandomInfo *AcquireRandomInfo(void)
{
  const StringInfo
    *digest;
  ...
  random_info->normalize=(double) (1.0/(((MagickSizeType) (~0ULL)) >> 11));
  random_info->seed[0]=((MagickSizeType) (0x76e15d3efefdcbbfULL));
  random_info->seed[1]=((MagickSizeType) (0xc5004e441c522fb3ULL));
  random_info->seed[2]=((MagickSizeType) (0x77710069854ee241ULL));
  random_info->seed[3]=((MagickSizeType) (0x39109bb02acbe635ULL));
  random_info->secret_key=secret_key;
  random_info->protocol_major=1;
  random_info->protocol_minor=0;
  random_info->semaphore=AcquireSemaphoreInfo();
  random_info->timestamp=GetMagickTime();
  random_info->signature=0xabacadabUL;



  nonce=GenerateEntropicChaos(random_info);
  if (nonce == (StringInfo *) 
# 204 "MagickCore/random.c" 3 4
                             ((void *)0)
# 204 "MagickCore/random.c"
                                 )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 205 "MagickCore/random.c" 3 4
   (*__errno_location ())
# 205 "MagickCore/random.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/random.c",__func__,(unsigned long) 205,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  ...
  if (entropy == (StringInfo *) 
# 218 "MagickCore/random.c" 3 4
                               ((void *)0)
# 218 "MagickCore/random.c"
                                   )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 219 "MagickCore/random.c" 3 4
   (*__errno_location ())
# 219 "MagickCore/random.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/random.c",__func__,(unsigned long) 219,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
  ...
  if (random_info->secret_key == ~0UL)
  ...
  else
    {
      ...
      (void) memcpy(random_info->seed,GetStringInfoDatum(digest),
        ((((size_t) GetSignatureDigestsize(signature_info)) < (sizeof(random_info->seed))) ? ((size_t) GetSignatureDigestsize(signature_info)) : (sizeof(random_info->seed)))
                                  );
      signature_info=DestroySignatureInfo(signature_info);
    }
  return(random_info);
}
# 278 "MagickCore/random.c"
__attribute__ ((visibility ("default"))) RandomInfo *DestroyRandomInfo(RandomInfo *random_info)
{
  
# 280 "MagickCore/random.c" 3 4
 ((void) sizeof ((
# 280 "MagickCore/random.c"
...
# 280 "MagickCore/random.c" 3 4
 , "MagickCore/random.c", 280, __extension__ __PRETTY_FUNCTION__); }))
# 280 "MagickCore/random.c"
                                           ;
  
# 281 "MagickCore/random.c" 3 4
 ((void) sizeof ((
# 281 "MagickCore/random.c"
 random_info->signature == 0xabacadabUL
# 281 "MagickCore/random.c" 3 4
...
# 281 "MagickCore/random.c" 3 4
 , "MagickCore/random.c", 281, __extension__ __PRETTY_FUNCTION__); }))
# 281 "MagickCore/random.c"
                                                      ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/random.c",__func__,(unsigned long) 283,"...");
  LockSemaphoreInfo(random_info->semaphore);
  if (random_info->reservoir != (StringInfo *) 
# 285 "MagickCore/random.c" 3 4
                                              ((void *)0)
# 285 "MagickCore/random.c"
                                                  )
    random_info->reservoir=DestroyStringInfo(random_info->reservoir);
  if (random_info->nonce != (StringInfo *) 
# 287 "MagickCore/random.c" 3 4
                                          ((void *)0)
# 287 "MagickCore/random.c"
                                              )
    random_info->nonce=DestroyStringInfo(random_info->nonce);
  if (random_info->signature_info != (SignatureInfo *) 
# 289 "MagickCore/random.c" 3 4
                                                      ((void *)0)
# 289 "MagickCore/random.c"
                                                          )
    ...
    if (count <= 0)
      {
        count=0;
        if (
# 341 "MagickCore/random.c" 3 4
           (*__errno_location ()) 
# 341 "MagickCore/random.c"
                 == 
# 341 "MagickCore/random.c" 3 4
                    4
# 341 "MagickCore/random.c"
...
static StringInfo *GenerateEntropicChaos(RandomInfo *random_info)
{
...

  {
    ...
    SetStringInfoLength(entropy,64);
    status=getentropy(GetStringInfoDatum(entropy),64);
    if (status == 0)
      {
        UnlockSemaphoreInfo(random_info->semaphore);
        return(entropy);
...
# 407 "MagickCore/random.c" 3 4
                           _SC_PHYS_PAGES
# 407 "MagickCore/random.c"
                                         );
...

  {
    ...
    if (getrusage(
# 418 "MagickCore/random.c" 3 4
                 RUSAGE_SELF
# 418 "MagickCore/random.c"
                            ,&usage) == 0)
      {
...

  {
    ...
    if (gettimeofday(&timer,(struct timezone *) 
# 432 "MagickCore/random.c" 3 4
                                               ((void *)0)
# 432 "MagickCore/random.c"
                                                   ) == 0)
      {
...
# 502 "MagickCore/random.c"
  {
    ...
    if (environ != (char **) 
# 518 "MagickCore/random.c" 3 4
                            ((void *)0)
# 518 "MagickCore/random.c"
                                )
      {
        ssize_t
          i;
        ...
        for (i=0; environ[i] != (char *) 
# 526 "MagickCore/random.c" 3 4
                                        ((void *)0)
# 526 "MagickCore/random.c"
                                            ; i++)
        {
...
# 536 "MagickCore/random.c" 3 4
                           00 
# 536 "MagickCore/random.c"
                                    | 0x00,0);
    filename=DestroyString(filename);
    if (file != -1)
      {
        SetStringInfoLength(chaos,64);
        count=ReadRandom(file,GetStringInfoDatum(chaos),64);
        (void) close(file);
    ...
    if (gather_true_random != MagickFalse)
      {
        ...
        device=DestroyStringInfo(device);
        file=open_utf8(filename,
# 554 "MagickCore/random.c" 3 4
                               00 
# 554 "MagickCore/random.c"
                                        | 0x00,0);
        filename=DestroyString(filename);
        if (file == -1)
          {
            ...
            device=DestroyStringInfo(device);
            file=open_utf8(filename,
# 561 "MagickCore/random.c" 3 4
                                   00 
# 561 "MagickCore/random.c"
                                            | 0x00,0);
          }
        if (file != -1)
          {
...
# 603 "MagickCore/random.c"
__attribute__ ((visibility ("default"))) double GetPseudoRandomValue(
  RandomInfo *__restrict__ random_info)
{
  ...
  random_info->seed[3]=(((random_info->seed[3]) << (45)) | ((random_info->seed[3]) >> (64-(45))));
  return((double) ((value >> 11)*random_info->normalize));
}
# 643 "MagickCore/random.c"
__attribute__ ((visibility ("hidden"))) double GetRandomInfoNormalize(const RandomInfo *random_info)
{
  
# 645 "MagickCore/random.c" 3 4
 ((void) sizeof ((
# 645 "MagickCore/random.c"
 random_info != (const RandomInfo *) 
# 645 "MagickCore/random.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 645 "MagickCore/random.c"
 random_info != (const RandomInfo *) 
# 645 "MagickCore/random.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 645 "MagickCore/random.c"
 "random_info != (const RandomInfo *) NULL"
# 645 "MagickCore/random.c" 3 4
 , "MagickCore/random.c", 645, __extension__ __PRETTY_FUNCTION__); }))
# 645 "MagickCore/random.c"
                                                 ;
  return(random_info->normalize);
}
# 671 "MagickCore/random.c"
__attribute__ ((visibility ("hidden"))) unsigned long *GetRandomInfoSeed(RandomInfo *random_info)
{
  
# 673 "MagickCore/random.c" 3 4
 ((void) sizeof ((
# 673 "MagickCore/random.c"
 random_info != (RandomInfo *) 
# 673 "MagickCore/random.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 673 "MagickCore/random.c"
...
# 673 "MagickCore/random.c"
 "random_info != (RandomInfo *) NULL"
# 673 "MagickCore/random.c" 3 4
 , "MagickCore/random.c", 673, __extension__ __PRETTY_FUNCTION__); }))
# 673 "MagickCore/random.c"
                                           ;
  return((unsigned long *) random_info->seed);
}
# 701 "MagickCore/random.c"
__attribute__ ((visibility ("default"))) StringInfo *GetRandomKey(RandomInfo *random_info,
  const size_t length)
{
  StringInfo
    *key;
...
# 707 "MagickCore/random.c" 3 4
 ((void) sizeof ((
# 707 "MagickCore/random.c"
 random_info != (RandomInfo *) 
# 707 "MagickCore/random.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 707 "MagickCore/random.c"
...
# 707 "MagickCore/random.c"
 "random_info != (RandomInfo *) NULL"
# 707 "MagickCore/random.c" 3 4
 , "MagickCore/random.c", 707, __extension__ __PRETTY_FUNCTION__); }))
# 707 "MagickCore/random.c"
                                           ;
...
# 734 "MagickCore/random.c"
__attribute__ ((visibility ("default"))) unsigned long GetRandomSecretKey(const RandomInfo *random_info)
{
  return(random_info->secret_key);
}
# 759 "MagickCore/random.c"
__attribute__ ((visibility ("default"))) double GetRandomValue(RandomInfo *random_info)
{
  unsigned long
    key,
    range;
...
# 791 "MagickCore/random.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType RandomComponentGenesis(void)
{
  if (random_semaphore == (SemaphoreInfo *) 
# 793 "MagickCore/random.c" 3 4
                                           ((void *)0)
# 793 "MagickCore/random.c"
                                               )
    random_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 816 "MagickCore/random.c"
__attribute__ ((visibility ("hidden"))) void RandomComponentTerminus(void)
{
  if (random_semaphore == (SemaphoreInfo *) 
# 818 "MagickCore/random.c" 3 4
                                           ((void *)0)
# 818 "MagickCore/random.c"
                                               )
    ActivateSemaphoreInfo(&random_semaphore);
  RelinquishSemaphoreInfo(&random_semaphore);
}
# 851 "MagickCore/random.c"
static inline void IncrementRandomNonce(StringInfo *nonce)
{
  ...
  { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 866 "MagickCore/random.c" 3 4
 (*__errno_location ())
# 866 "MagickCore/random.c"
 ); (void) ThrowMagickException(fatal_exception,"MagickCore/random.c",__func__,(unsigned long) 866,RandomFatalError,"SequenceWrapError", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (RandomFatalError-FatalErrorException)+1); };
}

__attribute__ ((visibility ("default"))) void SetRandomKey(RandomInfo *random_info,const size_t length,
  unsigned char *key)
{
  size_t
    i;
...
# 884 "MagickCore/random.c" 3 4
 ((void) sizeof ((
# 884 "MagickCore/random.c"
 random_info != (RandomInfo *) 
# 884 "MagickCore/random.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 884 "MagickCore/random.c"
...
# 884 "MagickCore/random.c"
 "random_info != (RandomInfo *) NULL"
# 884 "MagickCore/random.c" 3 4
 , "MagickCore/random.c", 884, __extension__ __PRETTY_FUNCTION__); }))
# 884 "MagickCore/random.c"
                                           ;
  if (length == 0)
    return;
...
# 946 "MagickCore/random.c"
__attribute__ ((visibility ("default"))) void SetRandomSecretKey(const unsigned long key)
{
  secret_key=key;
}
# 975 "MagickCore/random.c"
__attribute__ ((visibility ("default"))) void SetRandomTrueRandom(const MagickBooleanType true_random)
{
