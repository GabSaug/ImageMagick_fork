# 0 "MagickCore/magick.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/magick.c"
# 43 "MagickCore/magick.c"
...
# 53 "MagickCore/magick.c" 2
# 1 "./MagickCore/constitute-private.h" 1
# 54 "MagickCore/magick.c" 2
...
# 59 "MagickCore/magick.c" 2
# 1 "./MagickCore/log-private.h" 1
# 27 "./MagickCore/log-private.h"
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
  LogComponentGenesis(void);

extern __attribute__ ((visibility ("hidden"))) void
  LogComponentTerminus(void);
# 60 "MagickCore/magick.c" 2
...
# 67 "MagickCore/magick.c" 2
# 1 "./MagickCore/module-private.h" 1
# 25 "./MagickCore/module-private.h"
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
...
# 68 "MagickCore/magick.c" 2
# 1 "./MagickCore/mutex.h" 1
# 40 "./MagickCore/mutex.h"
static pthread_mutex_t
  translation_unit_mutex = 
# 41 "./MagickCore/mutex.h" 3 4
                          { { 0, 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, 0, { 0, 0 } } }
# 41 "./MagickCore/mutex.h"
                                                   ;
...
# 103 "./MagickCore/mutex.h" 3 4
       (*__errno_location ())
# 103 "./MagickCore/mutex.h"
            =status;
        { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 104 "./MagickCore/mutex.h" 3 4
       (*__errno_location ())
# 104 "./MagickCore/mutex.h"
       ); (void) ThrowMagickException(fatal_exception,"./MagickCore/mutex.h",__func__,(unsigned long) 104,ResourceLimitFatalError,"UnableToUnlockSemaphore", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
      }
  }
...
# 69 "MagickCore/magick.c" 2

# 1 "./MagickCore/nt-feature.h" 1
# 31 "./MagickCore/nt-feature.h"
extern __attribute__ ((visibility ("default"))) MagickBooleanType
  NTIsMagickConflict(const char *),
  NTAcquireTypeCache(SplayTreeInfo *,ExceptionInfo *);
# 71 "MagickCore/magick.c" 2

# 1 "./MagickCore/option-private.h" 1
# 73 "MagickCore/magick.c" 2
...
# 75 "MagickCore/magick.c" 2
# 1 "./MagickCore/registry-private.h" 1
# 25 "./MagickCore/registry-private.h"
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
  RegistryComponentGenesis(void);

extern __attribute__ ((visibility ("hidden"))) void
  RegistryComponentTerminus(void);
# 76 "MagickCore/magick.c" 2

# 1 "./MagickCore/resource-private.h" 1
# 29 "./MagickCore/resource-private.h"
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
...
extern __attribute__ ((visibility ("default"))) MagickBooleanType
  ...
  SetMagickSecurityPolicyValue(const PolicyDomain,const char *,const char *,
    ExceptionInfo *);
# 79 "MagickCore/magick.c" 2
# 1 "./MagickCore/policy-private.h" 1
# 36 "./MagickCore/policy-private.h"
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
  PolicyComponentGenesis(void);

extern __attribute__ ((visibility ("hidden"))) void
  PolicyComponentTerminus(void);
# 80 "MagickCore/magick.c" 2


# 1 "./MagickCore/semaphore-private.h" 1
# 25 "./MagickCore/semaphore-private.h"
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
  SemaphoreComponentGenesis(void);

extern __attribute__ ((visibility ("hidden"))) void
  SemaphoreComponentTerminus(void);
# 83 "MagickCore/magick.c" 2
...
# 91 "MagickCore/magick.c" 2
# 1 "./MagickCore/type-private.h" 1
# 25 "./MagickCore/type-private.h"
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
  TypeComponentGenesis(void);

extern __attribute__ ((visibility ("hidden"))) void
  TypeComponentTerminus(void);
# 92 "MagickCore/magick.c" 2
...
extern __attribute__ ((visibility ("hidden"))) MagickBooleanType
  XRenderImage(Image *,const DrawInfo *,const PointInfo *,TypeMetric *,
    ExceptionInfo *);
# 96 "MagickCore/magick.c" 2

# 1 "/usr/include/libxml2/libxml/parser.h" 1
# 13 "/usr/include/libxml2/libxml/parser.h"
...
# 25 "/usr/include/libxml2/libxml/tree.h"
# 1 "/usr/lib/gcc/x86_64-linux-gnu/13/include/limits.h" 1 3 4
# 26 "/usr/include/libxml2/libxml/tree.h" 2
...
# 35 "/usr/include/libxml2/libxml/encoding.h"
typedef enum {
...
# 98 "MagickCore/magick.c" 2
# 116 "MagickCore/magick.c"
...
static SemaphoreInfo
  *magick_semaphore = (SemaphoreInfo *) 
# 122 "MagickCore/magick.c" 3 4
                                       ((void *)0)
# 122 "MagickCore/magick.c"
                                           ;

static SignalHandler
  *signal_handlers[64] = { (SignalHandler *) 
# 125 "MagickCore/magick.c" 3 4
                                                ((void *)0) 
# 125 "MagickCore/magick.c"
                                                     };

static SplayTreeInfo
  *magick_list = (SplayTreeInfo *) 
# 128 "MagickCore/magick.c" 3 4
                                  ((void *)0)
# 128 "MagickCore/magick.c"
                                      ;
...
__attribute__ ((visibility ("default"))) MagickInfo *AcquireMagickInfo(const char *module,
...
# 181 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 181 "MagickCore/magick.c"
 module != (const char *) 
# 181 "MagickCore/magick.c" 3 4
...
# 181 "MagickCore/magick.c"
 "magick_module != (const char *) NULL"
# 181 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 181, __extension__ __PRETTY_FUNCTION__); }))
# 181 "MagickCore/magick.c"
                                             ;
  
# 182 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 182 "MagickCore/magick.c"
 name != (const char *) 
# 182 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 182 "MagickCore/magick.c"
...
# 182 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 182, __extension__ __PRETTY_FUNCTION__); }))
# 182 "MagickCore/magick.c"
                                    ;
  
# 183 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 183 "MagickCore/magick.c"
...
# 183 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 183, __extension__ __PRETTY_FUNCTION__); }))
# 183 "MagickCore/magick.c"
                                           ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/magick.c",__func__,(unsigned long) 185,"%s",name);
  ...
  magick_info->signature=0xabacadabUL;
  return(magick_info);
}
# 220 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) DecodeImageHandler *GetImageDecoder(const MagickInfo *magick_info)
{
  if (magick_info == (MagickInfo *) 
# 222 "MagickCore/magick.c" 3 4
                                   ((void *)0)
# 222 "MagickCore/magick.c"
                                       )
    return((DecodeImageHandler *) 
# 223 "MagickCore/magick.c" 3 4
                                 ((void *)0)
# 223 "MagickCore/magick.c"
                                     );
  
# 224 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 224 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 224 "MagickCore/magick.c" 3 4
...
# 224 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 224, __extension__ __PRETTY_FUNCTION__); }))
# 224 "MagickCore/magick.c"
                                                      ;
  return(magick_info->decoder);
}
# 250 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) EncodeImageHandler *GetImageEncoder(const MagickInfo *magick_info)
{
  if (magick_info == (MagickInfo *) 
# 252 "MagickCore/magick.c" 3 4
                                   ((void *)0)
# 252 "MagickCore/magick.c"
                                       )
    return((EncodeImageHandler *) 
# 253 "MagickCore/magick.c" 3 4
                                 ((void *)0)
# 253 "MagickCore/magick.c"
                                     );
  
# 254 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 254 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 254 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 254 "MagickCore/magick.c"
...
# 254 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 254 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 254, __extension__ __PRETTY_FUNCTION__); }))
# 254 "MagickCore/magick.c"
                                                      ;
  return(magick_info->encoder);
}
# 287 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetImageMagick(const unsigned char *magick,
...
# 299 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 299 "MagickCore/magick.c"
 magick != (const unsigned char *) 
# 299 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 299 "MagickCore/magick.c"
 magick != (const unsigned char *) 
# 299 "MagickCore/magick.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 299 "MagickCore/magick.c"
 "magick != (const unsigned char *) NULL"
# 299 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 299, __extension__ __PRETTY_FUNCTION__); }))
# 299 "MagickCore/magick.c"
                                               ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/magick.c",__func__,(unsigned long) 301,"...");
  exception=AcquireExceptionInfo();
  p=GetMagickInfo("*",exception);
  exception=DestroyExceptionInfo(exception);
  if (p == (const MagickInfo *) 
# 305 "MagickCore/magick.c" 3 4
                               ((void *)0)
# 305 "MagickCore/magick.c"
                                   )
    return(MagickFalse);
  status=MagickFalse;
  ...
  while (p != (const MagickInfo *) 
# 311 "MagickCore/magick.c" 3 4
                                  ((void *)0)
# 311 "MagickCore/magick.c"
                                      )
  {
    if ((p->magick != (IsImageFormatHandler *) 
# 313 "MagickCore/magick.c" 3 4
                                              ((void *)0)
# 313 "MagickCore/magick.c"
                                                  ) &&
        (p->magick(magick,length) != 0))
      {
        status=MagickTrue;
        (void) CopyMagickString(format,p->name,4096);
        break;
      }
    p=(const MagickInfo *) GetNextValueInSplayTree(magick_list);
  }
...
# 348 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetMagickAdjoin(const MagickInfo *magick_info)
{
  
# 350 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 350 "MagickCore/magick.c"
...
# 350 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 350, __extension__ __PRETTY_FUNCTION__); }))
# 350 "MagickCore/magick.c"
                                           ;
  
# 351 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 351 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 351 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 351 "MagickCore/magick.c"
...
# 351 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 351 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 351, __extension__ __PRETTY_FUNCTION__); }))
# 351 "MagickCore/magick.c"
                                                      ;
  return(((magick_info->flags & CoderAdjoinFlag) == 0) ? MagickFalse :
    MagickTrue);
}
# 378 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetMagickBlobSupport(
  const MagickInfo *magick_info)
{
  
# 381 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 381 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 381 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 381 "MagickCore/magick.c"
...
# 381 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 381 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 381, __extension__ __PRETTY_FUNCTION__); }))
# 381 "MagickCore/magick.c"
                                           ;
  
# 382 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 382 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 382 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 382 "MagickCore/magick.c"
...
# 382 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 382 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 382, __extension__ __PRETTY_FUNCTION__); }))
# 382 "MagickCore/magick.c"
                                                      ;
  return(((magick_info->flags & CoderBlobSupportFlag) == 0) ? MagickFalse :
    MagickTrue);
}
# 411 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetMagickDecoderSeekableStream(
  const MagickInfo *magick_info)
{
  
# 414 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 414 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 414 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 414 "MagickCore/magick.c"
...
# 414 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 414 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 414, __extension__ __PRETTY_FUNCTION__); }))
# 414 "MagickCore/magick.c"
                                           ;
  
# 415 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 415 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 415 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 415 "MagickCore/magick.c"
...
# 415 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 415 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 415, __extension__ __PRETTY_FUNCTION__); }))
# 415 "MagickCore/magick.c"
                                                      ;
...
# 445 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetMagickDecoderThreadSupport(
  const MagickInfo *magick_info)
{
  
# 448 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 448 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 448 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 448 "MagickCore/magick.c"
...
# 448 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 448 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 448, __extension__ __PRETTY_FUNCTION__); }))
# 448 "MagickCore/magick.c"
                                           ;
  
# 449 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 449 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 449 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 449 "MagickCore/magick.c"
...
# 449 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 449 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 449, __extension__ __PRETTY_FUNCTION__); }))
# 449 "MagickCore/magick.c"
                                                      ;
  return(((magick_info->flags & CoderDecoderThreadSupportFlag) == 0) ?
    MagickFalse : MagickTrue);
}
# 476 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) const char *GetMagickDescription(const MagickInfo *magick_info)
{
  
# 478 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 478 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 478 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 478 "MagickCore/magick.c"
...
# 478 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 478 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 478, __extension__ __PRETTY_FUNCTION__); }))
# 478 "MagickCore/magick.c"
                                           ;
  
# 479 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 479 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 479 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 479 "MagickCore/magick.c"
...
# 479 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 479 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 479, __extension__ __PRETTY_FUNCTION__); }))
# 479 "MagickCore/magick.c"
                                                      ;
  return(magick_info->description);
}
# 507 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetMagickEncoderSeekableStream(
  const MagickInfo *magick_info)
{
  
# 510 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 510 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 510 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 510 "MagickCore/magick.c"
...
# 510 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 510 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 510, __extension__ __PRETTY_FUNCTION__); }))
# 510 "MagickCore/magick.c"
                                           ;
  
# 511 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 511 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 511 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 511 "MagickCore/magick.c"
...
# 511 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 511 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 511, __extension__ __PRETTY_FUNCTION__); }))
# 511 "MagickCore/magick.c"
                                                      ;
...
# 541 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetMagickEncoderThreadSupport(
  const MagickInfo *magick_info)
{
  
# 544 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 544 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 544 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 544 "MagickCore/magick.c"
...
# 544 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 544 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 544, __extension__ __PRETTY_FUNCTION__); }))
# 544 "MagickCore/magick.c"
                                           ;
  
# 545 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 545 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 545 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 545 "MagickCore/magick.c"
...
# 545 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 545 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 545, __extension__ __PRETTY_FUNCTION__); }))
# 545 "MagickCore/magick.c"
                                                      ;
  return(((magick_info->flags & CoderDecoderThreadSupportFlag) == 0) ?
    MagickFalse : MagickTrue);
}
# 573 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetMagickEndianSupport(
  const MagickInfo *magick_info)
{
  
# 576 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 576 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 576 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 576 "MagickCore/magick.c"
...
# 576 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 576 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 576, __extension__ __PRETTY_FUNCTION__); }))
# 576 "MagickCore/magick.c"
                                           ;
  
# 577 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 577 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 577 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 577 "MagickCore/magick.c"
...
# 577 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 577 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 577, __extension__ __PRETTY_FUNCTION__); }))
# 577 "MagickCore/magick.c"
                                                      ;
  return(((magick_info->flags & CoderEndianSupportFlag) == 0) ? MagickFalse :
    MagickTrue);
}
# 608 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) const MagickInfo *GetMagickInfo(const char *name,
...
# 617 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 617 "MagickCore/magick.c"
...
# 617 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 617, __extension__ __PRETTY_FUNCTION__); }))
# 617 "MagickCore/magick.c"
                                            ;
  if (IsMagickTreeInstantiated(exception) == MagickFalse)
    return((const MagickInfo *) 
# 619 "MagickCore/magick.c" 3 4
                               ((void *)0)
# 619 "MagickCore/magick.c"
                                   );
  magick_info=(const MagickInfo *) 
# 620 "MagickCore/magick.c" 3 4
                                  ((void *)0)
# 620 "MagickCore/magick.c"
                                      ;
  if ((name != (const char *) 
# 621 "MagickCore/magick.c" 3 4
                             ((void *)0)
# 621 "MagickCore/magick.c"
                                 ) && (*name != '\0'))
    {
      LockSemaphoreInfo(magick_semaphore);
...
# 634 "MagickCore/magick.c" 3 4
                                                 ((void *)0)
# 634 "MagickCore/magick.c"
                                                     )
...
__attribute__ ((visibility ("default"))) const MagickInfo **GetMagickInfoList(const char *pattern,
...
# 713 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 713 "MagickCore/magick.c"
 pattern != (char *) 
# 713 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 713 "MagickCore/magick.c"
...
# 713 "MagickCore/magick.c"
 "pattern != (char *) NULL"
# 713 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 713, __extension__ __PRETTY_FUNCTION__); }))
# 713 "MagickCore/magick.c"
                                 ;
  
# 714 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 714 "MagickCore/magick.c"
 number_formats != (size_t *) 
# 714 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 714 "MagickCore/magick.c"
 number_formats != (size_t *) 
# 714 "MagickCore/magick.c" 3 4
 ((void *)0)) ; else __assert_fail (
# 714 "MagickCore/magick.c"
 "number_formats != (size_t *) NULL"
# 714 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 714, __extension__ __PRETTY_FUNCTION__); }))
# 714 "MagickCore/magick.c"
                                          ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/magick.c",__func__,(unsigned long) 716,"%s",pattern);
  *number_formats=0;
  p=GetMagickInfo("*",exception);
  if (p == (const MagickInfo *) 
# 719 "MagickCore/magick.c" 3 4
                               ((void *)0)
# 719 "MagickCore/magick.c"
                                   )
    return((const MagickInfo **) 
# 720 "MagickCore/magick.c" 3 4
                                ((void *)0)
# 720 "MagickCore/magick.c"
                                    );
  formats=(const MagickInfo **) AcquireQuantumMemory((size_t)
    GetNumberOfNodesInSplayTree(magick_list)+1UL,sizeof(*formats));
  if (formats == (const MagickInfo **) 
# 723 "MagickCore/magick.c" 3 4
                                      ((void *)0)
# 723 "MagickCore/magick.c"
                                          )
    return((const MagickInfo **) 
# 724 "MagickCore/magick.c" 3 4
                                ((void *)0)
# 724 "MagickCore/magick.c"
                                    );
  ...
  ResetSplayTreeIterator(magick_list);
  p=(const MagickInfo *) GetNextValueInSplayTree(magick_list);
  for (i=0; p != (const MagickInfo *) 
# 731 "MagickCore/magick.c" 3 4
                                     ((void *)0)
# 731 "MagickCore/magick.c"
                                         ; )
  {
  ...
  formats[i]=(MagickInfo *) 
# 740 "MagickCore/magick.c" 3 4
                           ((void *)0)
# 740 "MagickCore/magick.c"
                               ;
  *number_formats=(size_t) i;
  return(formats);
}
# 777 "MagickCore/magick.c"
...
__attribute__ ((visibility ("default"))) char **GetMagickList(const char *pattern,
  size_t *number_formats,ExceptionInfo *exception)
{
  char
    **formats;
...
# 807 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 807 "MagickCore/magick.c"
 pattern != (char *) 
# 807 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 807 "MagickCore/magick.c"
...
# 807 "MagickCore/magick.c"
 "pattern != (char *) NULL"
# 807 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 807, __extension__ __PRETTY_FUNCTION__); }))
# 807 "MagickCore/magick.c"
                                 ;
  
# 808 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 808 "MagickCore/magick.c"
 number_formats != (size_t *) 
# 808 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 808 "MagickCore/magick.c"
...
# 808 "MagickCore/magick.c"
 "number_formats != (size_t *) NULL"
# 808 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 808, __extension__ __PRETTY_FUNCTION__); }))
# 808 "MagickCore/magick.c"
                                          ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/magick.c",__func__,(unsigned long) 810,"%s",pattern);
  *number_formats=0;
  p=GetMagickInfo("*",exception);
  if (p == (const MagickInfo *) 
# 813 "MagickCore/magick.c" 3 4
                               ((void *)0)
# 813 "MagickCore/magick.c"
                                   )
    return((char **) 
# 814 "MagickCore/magick.c" 3 4
                    ((void *)0)
# 814 "MagickCore/magick.c"
                        );
  formats=(char **) AcquireQuantumMemory((size_t)
    GetNumberOfNodesInSplayTree(magick_list)+1UL,sizeof(*formats));
  if (formats == (char **) 
# 817 "MagickCore/magick.c" 3 4
                          ((void *)0)
# 817 "MagickCore/magick.c"
                              )
    return((char **) 
# 818 "MagickCore/magick.c" 3 4
                    ((void *)0)
# 818 "MagickCore/magick.c"
                        );
  LockSemaphoreInfo(magick_semaphore);
  ResetSplayTreeIterator(magick_list);
  p=(const MagickInfo *) GetNextValueInSplayTree(magick_list);
  for (i=0; p != (const MagickInfo *) 
# 822 "MagickCore/magick.c" 3 4
                                     ((void *)0)
# 822 "MagickCore/magick.c"
                                         ; )
  {
    if ((GetMagickStealth(p) == MagickFalse) &&
        (GlobExpression(p->name,pattern,MagickFalse) != MagickFalse))
  ...
  formats[i]=(char *) 
# 831 "MagickCore/magick.c" 3 4
                     ((void *)0)
# 831 "MagickCore/magick.c"
                         ;
  *number_formats=(size_t) i;
  return(formats);
}
# 858 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) const char *GetMagickMimeType(const MagickInfo *magick_info)
{
  
# 860 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 860 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 860 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 860 "MagickCore/magick.c"
...
# 860 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 860 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 860, __extension__ __PRETTY_FUNCTION__); }))
# 860 "MagickCore/magick.c"
                                           ;
  
# 861 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 861 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 861 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 861 "MagickCore/magick.c"
...
# 861 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 861 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 861, __extension__ __PRETTY_FUNCTION__); }))
# 861 "MagickCore/magick.c"
                                                      ;
  return(magick_info->mime_type);
}
# 887 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) const char *GetMagickModuleName(const MagickInfo *magick_info)
{
  
# 889 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 889 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 889 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 889 "MagickCore/magick.c"
...
# 889 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 889 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 889, __extension__ __PRETTY_FUNCTION__); }))
# 889 "MagickCore/magick.c"
                                           ;
  
# 890 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 890 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 890 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 890 "MagickCore/magick.c"
...
# 890 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 890 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 890, __extension__ __PRETTY_FUNCTION__); }))
# 890 "MagickCore/magick.c"
                                                      ;
  return(magick_info->module);
}
# 916 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) const char *GetMagickName(const MagickInfo *magick_info)
{
  
# 918 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 918 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 918 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 918 "MagickCore/magick.c"
...
# 918 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 918 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 918, __extension__ __PRETTY_FUNCTION__); }))
# 918 "MagickCore/magick.c"
                                           ;
  
# 919 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 919 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 919 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 919 "MagickCore/magick.c"
...
# 919 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 919 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 919, __extension__ __PRETTY_FUNCTION__); }))
# 919 "MagickCore/magick.c"
                                                      ;
  return(magick_info->name);
}
# 942 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) int GetMagickPrecision(void)
{
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/magick.c",__func__,(unsigned long) 945,"...");
  return(SetMagickPrecision(0));
}
# 971 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetMagickRawSupport(
  const MagickInfo *magick_info)
{
  
# 974 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 974 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 974 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 974 "MagickCore/magick.c"
...
# 974 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 974 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 974, __extension__ __PRETTY_FUNCTION__); }))
# 974 "MagickCore/magick.c"
                                           ;
  
# 975 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 975 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 975 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 975 "MagickCore/magick.c"
...
# 975 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 975 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 975, __extension__ __PRETTY_FUNCTION__); }))
# 975 "MagickCore/magick.c"
                                                      ;
  return(((magick_info->flags & CoderRawSupportFlag) == 0) ? MagickFalse :
    MagickTrue);
}
# 1002 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetMagickStealth(const MagickInfo *magick_info)
{
  
# 1004 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 1004 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 1004 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1004 "MagickCore/magick.c"
...
# 1004 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 1004 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 1004, __extension__ __PRETTY_FUNCTION__); }))
# 1004 "MagickCore/magick.c"
                                           ;
  
# 1005 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 1005 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 1005 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1005 "MagickCore/magick.c"
...
# 1005 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 1005 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 1005, __extension__ __PRETTY_FUNCTION__); }))
# 1005 "MagickCore/magick.c"
                                                      ;
  return(((magick_info->flags & CoderStealthFlag) == 0) ? MagickFalse :
    MagickTrue);
}
# 1034 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType GetMagickUseExtension(
  const MagickInfo *magick_info)
{
  
# 1037 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 1037 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 1037 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1037 "MagickCore/magick.c"
...
# 1037 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 1037 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 1037, __extension__ __PRETTY_FUNCTION__); }))
# 1037 "MagickCore/magick.c"
                                           ;
  
# 1038 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 1038 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 1038 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1038 "MagickCore/magick.c"
...
# 1038 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 1038 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 1038, __extension__ __PRETTY_FUNCTION__); }))
# 1038 "MagickCore/magick.c"
                                                      ;
  return(((magick_info->flags & CoderUseExtensionFlag) == 0) ? MagickFalse :
    MagickTrue);
}
# 1067 "MagickCore/magick.c"
static void *DestroyMagickNode(void *magick_info)
{
  ...
  if (p->module != (char *) 
# 1073 "MagickCore/magick.c" 3 4
                                  ((void *)0)
# 1073 "MagickCore/magick.c"
                                      )
    p->module=DestroyString(p->module);
  if (p->note != (char *) 
# 1075 "MagickCore/magick.c" 3 4
                         ((void *)0)
# 1075 "MagickCore/magick.c"
                             )
    p->note=DestroyString(p->note);
  if (p->mime_type != (char *) 
# 1077 "MagickCore/magick.c" 3 4
                              ((void *)0)
# 1077 "MagickCore/magick.c"
                                  )
    p->mime_type=DestroyString(p->mime_type);
  if (p->version != (char *) 
# 1079 "MagickCore/magick.c" 3 4
                            ((void *)0)
# 1079 "MagickCore/magick.c"
                                )
    p->version=DestroyString(p->version);
  if (p->description != (char *) 
# 1081 "MagickCore/magick.c" 3 4
                                ((void *)0)
# 1081 "MagickCore/magick.c"
                                    )
    p->description=DestroyString(p->description);
  if (p->name != (char *) 
# 1083 "MagickCore/magick.c" 3 4
                         ((void *)0)
# 1083 "MagickCore/magick.c"
                             )
    p->name=DestroyString(p->name);
  if (p->semaphore != (SemaphoreInfo *) 
# 1085 "MagickCore/magick.c" 3 4
                                       ((void *)0)
# 1085 "MagickCore/magick.c"
                                           )
...
# 1095 "MagickCore/magick.c" 3 4
                                               ((void *)0)
# 1095 "MagickCore/magick.c"
                                                   )
...
# 1101 "MagickCore/magick.c" 3 4
           ((void *)0)
# 1101 "MagickCore/magick.c"
               ,DestroyMagickNode);
  ...
  return(magick_list != (SplayTreeInfo *) 
# 1109 "MagickCore/magick.c" 3 4
                                         ((void *)0) 
# 1109 "MagickCore/magick.c"
                                              ? MagickTrue : MagickFalse);
}
# 1135 "MagickCore/magick.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType IsMagickConflict(const char *magick)
{
  
# 1137 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 1137 "MagickCore/magick.c"
 magick != (char *) 
# 1137 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1137 "MagickCore/magick.c"
...
# 1137 "MagickCore/magick.c"
 "magick != (char *) NULL"
# 1137 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 1137, __extension__ __PRETTY_FUNCTION__); }))
# 1137 "MagickCore/magick.c"
                                ;
...
# 1171 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListMagickInfo(FILE *file,
  ExceptionInfo *exception)
{
  const MagickInfo
    **magick_info;
  ...
  if (file == (FILE *) 
# 1186 "MagickCore/magick.c" 3 4
                      ((void *)0)
# 1186 "MagickCore/magick.c"
                          )
    file=
# 1187 "MagickCore/magick.c" 3 4
        stdout
# 1187 "MagickCore/magick.c"
              ;
  magick_info=GetMagickInfoList("*",&number_formats,exception);
  if (magick_info == (const MagickInfo **) 
# 1189 "MagickCore/magick.c" 3 4
                                          ((void *)0)
# 1189 "MagickCore/magick.c"
                                              )
    return(MagickFalse);
  ...
  for (i=0; i < (ssize_t) number_formats; i++)
  {
    ...
    (void) FormatLocaleFile(file,"%9s%c ",
      magick_info[i]->name != (char *) 
# 1205 "MagickCore/magick.c" 3 4
                                      ((void *)0) 
# 1205 "MagickCore/magick.c"
                                           ? magick_info[i]->name : "",
      GetMagickBlobSupport(magick_info[i]) != MagickFalse ? '*' : ' ');
# 1222 "MagickCore/magick.c"
    (void) FormatLocaleFile(file,"%c%c%c ",magick_info[i]->decoder ? 'r' : '-',
      magick_info[i]->encoder ? 'w' : '-',magick_info[i]->encoder != 
# 1223 "MagickCore/magick.c" 3 4
                                                                    ((void *)0) 
# 1223 "MagickCore/magick.c"
                                                                         &&
      GetMagickAdjoin(magick_info[i]) != MagickFalse ? '+' : '-');
    if (magick_info[i]->description != (char *) 
# 1225 "MagickCore/magick.c" 3 4
                                               ((void *)0)
# 1225 "MagickCore/magick.c"
                                                   )
      (void) FormatLocaleFile(file,"  %s",magick_info[i]->description);
    if (magick_info[i]->version != (char *) 
# 1227 "MagickCore/magick.c" 3 4
                                           ((void *)0)
# 1227 "MagickCore/magick.c"
                                               )
      (void) FormatLocaleFile(file," (%s)",magick_info[i]->version);
    (void) FormatLocaleFile(file,"\n");
    if (magick_info[i]->note != (char *) 
# 1230 "MagickCore/magick.c" 3 4
                                        ((void *)0)
# 1230 "MagickCore/magick.c"
                                            )
      {
        char
          **text;
        ...
        if (text != (char **) 
# 1236 "MagickCore/magick.c" 3 4
                             ((void *)0)
# 1236 "MagickCore/magick.c"
                                 )
          {
            for (j=0; text[j] != (char *) 
# 1238 "MagickCore/magick.c" 3 4
                                         ((void *)0)
# 1238 "MagickCore/magick.c"
                                             ; j++)
            {
...
# 1278 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType IsMagickCoreInstantiated(void)
{
  return(magickcore_instantiated);
}
# 1301 "MagickCore/magick.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType MagickComponentGenesis(void)
{
  if (magick_semaphore == (SemaphoreInfo *) 
# 1303 "MagickCore/magick.c" 3 4
                                           ((void *)0)
# 1303 "MagickCore/magick.c"
                                               )
    magick_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 1326 "MagickCore/magick.c"
__attribute__ ((visibility ("hidden"))) void MagickComponentTerminus(void)
{
  if (magick_semaphore == (SemaphoreInfo *) 
# 1328 "MagickCore/magick.c" 3 4
                                           ((void *)0)
# 1328 "MagickCore/magick.c"
                                               )
    ActivateSemaphoreInfo(&magick_semaphore);
  LockSemaphoreInfo(magick_semaphore);
  if (magick_list != (SplayTreeInfo *) 
# 1331 "MagickCore/magick.c" 3 4
                                      ((void *)0)
# 1331 "MagickCore/magick.c"
                                          )
    {
  ...
  SignalHandler *handler)
{
  ...
  sigprocmask(
# 1383 "MagickCore/magick.c" 3 4
             0
# 1383 "MagickCore/magick.c"
                      ,&mask,
# 1383 "MagickCore/magick.c" 3 4
                             ((void *)0)
# 1383 "MagickCore/magick.c"
  ...
  action.sa_mask=mask;
  action.
# 1385 "MagickCore/magick.c" 3 4
        __sigaction_handler.sa_handler
# 1385 "MagickCore/magick.c"
                  =handler;
  action.sa_flags=0;

  action.sa_flags|=
# 1388 "MagickCore/magick.c" 3 4
                  0x20000000
# 1388 "MagickCore/magick.c"
                              ;


  action.sa_flags|=
# 1391 "MagickCore/magick.c" 3 4
                  0x08000000
# 1391 "MagickCore/magick.c"
                            ;

  previous_action.
# 1393 "MagickCore/magick.c" 3 4
                 __sigaction_handler.sa_handler
# 1393 "MagickCore/magick.c"
                           =
# 1393 "MagickCore/magick.c" 3 4
                            ((__sighandler_t) 0)
# 1393 "MagickCore/magick.c"
  ...
  if (status < 0)
    return(
# 1396 "MagickCore/magick.c" 3 4
          ((__sighandler_t) -1)
# 1396 "MagickCore/magick.c"
                 );
  sigprocmask(
# 1397 "MagickCore/magick.c" 3 4
             1
# 1397 "MagickCore/magick.c"
                        ,&mask,
# 1397 "MagickCore/magick.c" 3 4
                               ((void *)0)
# 1397 "MagickCore/magick.c"
...
# 1398 "MagickCore/magick.c" 3 4
                        __sigaction_handler.sa_handler
# 1398 "MagickCore/magick.c"
                                  );
...
static void MagickSignalHandler(int signal_number)
{
  ...
  if (signal_number == 
# 1411 "MagickCore/magick.c" 3 4
                      3
# 1411 "MagickCore/magick.c"
                             )
    abort();


  if (signal_number == 
# 1415 "MagickCore/magick.c" 3 4
                      6
# 1415 "MagickCore/magick.c"
                             )
    abort();


  if (signal_number == 
# 1419 "MagickCore/magick.c" 3 4
                      7
# 1419 "MagickCore/magick.c"
                            )
    abort();


  if (signal_number == 
# 1423 "MagickCore/magick.c" 3 4
                      8
# 1423 "MagickCore/magick.c"
                            )
    abort();


  if (signal_number == 
# 1427 "MagickCore/magick.c" 3 4
                      11
# 1427 "MagickCore/magick.c"
                             )
    abort();
  ...
  if (signal_number == 
# 1434 "MagickCore/magick.c" 3 4
                      1
# 1434 "MagickCore/magick.c"
                            )
    _exit(signal_number);


  if (signal_number == 
# 1438 "MagickCore/magick.c" 3 4
                      2
# 1438 "MagickCore/magick.c"
                            )
    _exit(signal_number);
...
static SignalHandler *RegisterMagickSignalHandler(int signal_number)
{
  ...
  if (handler == 
# 1455 "MagickCore/magick.c" 3 4
                ((__sighandler_t) -1)
# 1455 "MagickCore/magick.c"
                       )
    return(handler);
  if (handler != 
# 1457 "MagickCore/magick.c" 3 4
                ((__sighandler_t) 0)
# 1457 "MagickCore/magick.c"
                       )
    handler=SetMagickSignalHandler(signal_number,handler);
  else
    (void) LogMagickEvent(ConfigureEvent,"MagickCore/magick.c",__func__,(unsigned long) 1460,
...
static void SetClientNameAndPath(const char *path)
{
  ...
  if ((path != (const char *) 
# 1474 "MagickCore/magick.c" 3 4
                             ((void *)0)
# 1474 "MagickCore/magick.c"
                                 ) && (*path == *"/") &&
      (IsPathAccessible(path) != MagickFalse))

    (void) CopyMagickString(execution_path,path,4096);
  else
    (void) GetExecutionPath(execution_path,4096);
...
__attribute__ ((visibility ("default"))) void MagickCoreGenesis(const char *path,
  const MagickBooleanType establish_signal_handlers)
{
  char
    *events;
# 1500 "MagickCore/magick.c"
  ...
  if (events != (char *) 
# 1514 "MagickCore/magick.c" 3 4
                        ((void *)0)
# 1514 "MagickCore/magick.c"
                            )
    {
  ...
  if (establish_signal_handlers != MagickFalse)
    {
      ...
      if (signal_handlers[
# 1528 "MagickCore/magick.c" 3 4
                         6
# 1528 "MagickCore/magick.c"
                                ] == (SignalHandler *) 
# 1528 "MagickCore/magick.c" 3 4
                                                       ((void *)0)
# 1528 "MagickCore/magick.c"
        ...
        signal_handlers[
# 1529 "MagickCore/magick.c" 3 4
                       6
# 1529 "MagickCore/magick.c"
...
# 1529 "MagickCore/magick.c"
      ...
      if (signal_handlers[
# 1532 "MagickCore/magick.c" 3 4
                         7
# 1532 "MagickCore/magick.c"
                               ] == (SignalHandler *) 
# 1532 "MagickCore/magick.c" 3 4
                                                      ((void *)0)
# 1532 "MagickCore/magick.c"
        ...
        signal_handlers[
# 1533 "MagickCore/magick.c" 3 4
                       7
# 1533 "MagickCore/magick.c"
                             ]=RegisterMagickSignalHandler(
# 1533 "MagickCore/magick.c" 3 4
                                                           7
# 1533 "MagickCore/magick.c"
      ...
      if (signal_handlers[
# 1536 "MagickCore/magick.c" 3 4
                         11
# 1536 "MagickCore/magick.c"
                                ] == (SignalHandler *) 
# 1536 "MagickCore/magick.c" 3 4
                                                       ((void *)0)
# 1536 "MagickCore/magick.c"
        ...
        signal_handlers[
# 1537 "MagickCore/magick.c" 3 4
                       11
# 1537 "MagickCore/magick.c"
                              ]=RegisterMagickSignalHandler(
# 1537 "MagickCore/magick.c" 3 4
                                                            11
# 1537 "MagickCore/magick.c"
      ...
      if (signal_handlers[
# 1540 "MagickCore/magick.c" 3 4
                         8
# 1540 "MagickCore/magick.c"
                               ] == (SignalHandler *) 
# 1540 "MagickCore/magick.c" 3 4
                                                      ((void *)0)
# 1540 "MagickCore/magick.c"
        ...
        signal_handlers[
# 1541 "MagickCore/magick.c" 3 4
                       8
# 1541 "MagickCore/magick.c"
                             ]=RegisterMagickSignalHandler(
# 1541 "MagickCore/magick.c" 3 4
                                                           8
# 1541 "MagickCore/magick.c"
      ...
      if (signal_handlers[
# 1544 "MagickCore/magick.c" 3 4
                         1
# 1544 "MagickCore/magick.c"
                               ] == (SignalHandler *) 
# 1544 "MagickCore/magick.c" 3 4
                                                      ((void *)0)
# 1544 "MagickCore/magick.c"
        ...
        signal_handlers[
# 1545 "MagickCore/magick.c" 3 4
                       1
# 1545 "MagickCore/magick.c"
                             ]=RegisterMagickSignalHandler(
# 1545 "MagickCore/magick.c" 3 4
                                                           1
# 1545 "MagickCore/magick.c"
      ...
      if (signal_handlers[
# 1548 "MagickCore/magick.c" 3 4
                         2
# 1548 "MagickCore/magick.c"
                               ] == (SignalHandler *) 
# 1548 "MagickCore/magick.c" 3 4
                                                      ((void *)0)
# 1548 "MagickCore/magick.c"
        ...
        signal_handlers[
# 1549 "MagickCore/magick.c" 3 4
                       2
# 1549 "MagickCore/magick.c"
                             ]=RegisterMagickSignalHandler(
# 1549 "MagickCore/magick.c" 3 4
                                                           2
# 1549 "MagickCore/magick.c"
      ...
      if (signal_handlers[
# 1552 "MagickCore/magick.c" 3 4
                         3
# 1552 "MagickCore/magick.c"
                                ] == (SignalHandler *) 
# 1552 "MagickCore/magick.c" 3 4
                                                       ((void *)0)
# 1552 "MagickCore/magick.c"
        ...
        signal_handlers[
# 1553 "MagickCore/magick.c" 3 4
                       3
# 1553 "MagickCore/magick.c"
                              ]=RegisterMagickSignalHandler(
# 1553 "MagickCore/magick.c" 3 4
                                                            3
# 1553 "MagickCore/magick.c"
      ...
      if (signal_handlers[
# 1556 "MagickCore/magick.c" 3 4
                         15
# 1556 "MagickCore/magick.c"
                                ] == (SignalHandler *) 
# 1556 "MagickCore/magick.c" 3 4
                                                       ((void *)0)
# 1556 "MagickCore/magick.c"
        ...
        signal_handlers[
# 1557 "MagickCore/magick.c" 3 4
                       15
# 1557 "MagickCore/magick.c"
                              ]=RegisterMagickSignalHandler(
# 1557 "MagickCore/magick.c" 3 4
                                                            15
# 1557 "MagickCore/magick.c"
      ...
      if (signal_handlers[
# 1560 "MagickCore/magick.c" 3 4
                         24
# 1560 "MagickCore/magick.c"
                                ] == (SignalHandler *) 
# 1560 "MagickCore/magick.c" 3 4
                                                       ((void *)0)
# 1560 "MagickCore/magick.c"
        ...
        signal_handlers[
# 1561 "MagickCore/magick.c" 3 4
                       24
# 1561 "MagickCore/magick.c"
                              ]=RegisterMagickSignalHandler(
# 1561 "MagickCore/magick.c" 3 4
                                                            24
# 1561 "MagickCore/magick.c"
      ...
      if (signal_handlers[
# 1564 "MagickCore/magick.c" 3 4
                         25
# 1564 "MagickCore/magick.c"
                                ] == (SignalHandler *) 
# 1564 "MagickCore/magick.c" 3 4
                                                       ((void *)0)
# 1564 "MagickCore/magick.c"
        ...
        signal_handlers[
# 1565 "MagickCore/magick.c" 3 4
                       25
# 1565 "MagickCore/magick.c"
                              ]=RegisterMagickSignalHandler(
# 1565 "MagickCore/magick.c" 3 4
                                                            25
# 1565 "MagickCore/magick.c"
...
# 1638 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) void MagickCoreTerminus(void)
{
  InitializeMagickMutex();
  LockMagickMutex();
  if (magickcore_instantiated == MagickFalse)
...
# 1714 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType RegisterMagickInfo(MagickInfo *magick_info)
{
  MagickBooleanType
    status;
...
# 1722 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 1722 "MagickCore/magick.c"
 magick_info != (MagickInfo *) 
# 1722 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1722 "MagickCore/magick.c"
...
# 1722 "MagickCore/magick.c"
 "magick_info != (MagickInfo *) NULL"
# 1722 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 1722, __extension__ __PRETTY_FUNCTION__); }))
# 1722 "MagickCore/magick.c"
                                           ;
  
# 1723 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 1723 "MagickCore/magick.c"
 magick_info->signature == 0xabacadabUL
# 1723 "MagickCore/magick.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1723 "MagickCore/magick.c"
...
# 1723 "MagickCore/magick.c"
 "magick_info->signature == MagickCoreSignature"
# 1723 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 1723, __extension__ __PRETTY_FUNCTION__); }))
# 1723 "MagickCore/magick.c"
                                                      ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/magick.c",__func__,(unsigned long) 1725,"%s",magick_info->name);
  if (magick_list == (SplayTreeInfo *) 
# 1726 "MagickCore/magick.c" 3 4
                                      ((void *)0)
# 1726 "MagickCore/magick.c"
                                          )
    return(MagickFalse);
...
# 1753 "MagickCore/magick.c"
__attribute__ ((visibility ("hidden"))) void ResetMagickPrecision(void)
{
  magick_precision=0;
}
# 1787 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) int SetMagickPrecision(const int precision)
{


  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/magick.c",__func__,(unsigned long) 1792,"...");
  if (precision > 0)
  ...
  if ((precision < 0) || (magick_precision == 0))
    {
      ...
      magick_precision=(16/8+4);
      limit=(char *) GetImageRegistry(StringRegistryType,"precision",exception);
      exception=DestroyExceptionInfo(exception);
      if (limit == (char *) 
# 1806 "MagickCore/magick.c" 3 4
                           ((void *)0)
# 1806 "MagickCore/magick.c"
                               )
        limit=GetEnvironmentValue("MAGICK_PRECISION");
      if (limit == (char *) 
# 1808 "MagickCore/magick.c" 3 4
                           ((void *)0)
# 1808 "MagickCore/magick.c"
                               )
        limit=GetPolicyValue("system:precision");
      if (limit != (char *) 
# 1810 "MagickCore/magick.c" 3 4
                           ((void *)0)
# 1810 "MagickCore/magick.c"
                               )
        {
...
# 1843 "MagickCore/magick.c"
__attribute__ ((visibility ("default"))) MagickBooleanType UnregisterMagickInfo(const char *name)
{
  const MagickInfo
    *p;
...
# 1851 "MagickCore/magick.c" 3 4
 ((void) sizeof ((
# 1851 "MagickCore/magick.c"
 name != (const char *) 
# 1851 "MagickCore/magick.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1851 "MagickCore/magick.c"
...
# 1851 "MagickCore/magick.c"
 "name != (const char *) NULL"
# 1851 "MagickCore/magick.c" 3 4
 , "MagickCore/magick.c", 1851, __extension__ __PRETTY_FUNCTION__); }))
# 1851 "MagickCore/magick.c"
                                    ;
  if (magick_list == (SplayTreeInfo *) 
# 1852 "MagickCore/magick.c" 3 4
                                      ((void *)0)
# 1852 "MagickCore/magick.c"
                                          )
    return(MagickFalse);
  ...
  p=(const MagickInfo *) GetNextValueInSplayTree(magick_list);
  while (p != (const MagickInfo *) 
# 1859 "MagickCore/magick.c" 3 4
                                  ((void *)0)
# 1859 "MagickCore/magick.c"
                                      )
  {
