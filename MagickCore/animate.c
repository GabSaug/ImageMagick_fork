# 0 "MagickCore/animate.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/animate.c"
# 42 "MagickCore/animate.c"
...
# 22 "./MagickCore/xwindow-private.h" 2
...
# 26 "./MagickCore/xwindow-private.h" 2
...
# 76 "MagickCore/animate.c" 2
# 1 "./MagickCore/widget.h" 1
# 77 "MagickCore/animate.c" 2
...
# 79 "MagickCore/animate.c" 2
# 95 "MagickCore/animate.c"
static const char
  AnimateHelp[] =
  {
    "BUTTONS\n"
  ...
  *PageSizes[] =
  {
    ...
    "10x14",
    (char *) 
# 182 "MagickCore/animate.c" 3 4
            ((void *)0)
  
# 183 "MagickCore/animate.c"
 };
...
# 281 "MagickCore/animate.c"
__attribute__ ((visibility ("default"))) MagickBooleanType AnimateImages(const ImageInfo *image_info,
...
# 299 "MagickCore/animate.c" 3 4
 ((void) sizeof ((
# 299 "MagickCore/animate.c"
...
# 299 "MagickCore/animate.c" 3 4
 , "MagickCore/animate.c", 299, __extension__ __PRETTY_FUNCTION__); }))
# 299 "MagickCore/animate.c"
                                               ;
  
# 300 "MagickCore/animate.c" 3 4
 ((void) sizeof ((
# 300 "MagickCore/animate.c"
...
# 300 "MagickCore/animate.c" 3 4
 , "MagickCore/animate.c", 300, __extension__ __PRETTY_FUNCTION__); }))
# 300 "MagickCore/animate.c"
                                                     ;
  
# 301 "MagickCore/animate.c" 3 4
 ((void) sizeof ((
# 301 "MagickCore/animate.c"
 images != (Image *) 
# 301 "MagickCore/animate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 301 "MagickCore/animate.c"
...
# 301 "MagickCore/animate.c"
 "images != (Image *) NULL"
# 301 "MagickCore/animate.c" 3 4
 , "MagickCore/animate.c", 301, __extension__ __PRETTY_FUNCTION__); }))
# 301 "MagickCore/animate.c"
                                 ;
  
# 302 "MagickCore/animate.c" 3 4
 ((void) sizeof ((
# 302 "MagickCore/animate.c"
...
# 302 "MagickCore/animate.c" 3 4
 , "MagickCore/animate.c", 302, __extension__ __PRETTY_FUNCTION__); }))
# 302 "MagickCore/animate.c"
                                                 ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/animate.c",__func__,(unsigned long) 304,"%s",images->filename);
  display=XOpenDisplay(image_info->server_name);
  if (display == (Display *) 
# 306 "MagickCore/animate.c" 3 4
                            ((void *)0)
# 306 "MagickCore/animate.c"
                                )
    {
      (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 308,XServerError,
...
# 318 "MagickCore/animate.c" 3 4
                                  ((void *)0)
# 318 "MagickCore/animate.c"
                                      )
...
# 323 "MagickCore/animate.c" 3 4
                                       ((void *)0)
# 323 "MagickCore/animate.c"
                                           );
  (void) SetWarningHandler((WarningHandler) 
# 324 "MagickCore/animate.c" 3 4
                                           ((void *)0)
# 324 "MagickCore/animate.c"
                                               );
  ...
  MagickStatusType *state,ExceptionInfo *exception)
{
  ...
  switch (animate_command)
  {
    case OpenCommand:
    {
      ...
      if (*filenames == '\0')
        return((Image *) 
# 421 "MagickCore/animate.c" 3 4
                        ((void *)0)
# 421 "MagickCore/animate.c"
                            );
      ...
      if (filelist == (char **) 
# 426 "MagickCore/animate.c" 3 4
                               ((void *)0)
# 426 "MagickCore/animate.c"
                                   )
        {
          { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 428,ResourceLimitError,"MemoryAllocationFailed", "'%s': %s",filenames,strerror(
# 428 "MagickCore/animate.c" 3 4
         (*__errno_location ())
# 428 "MagickCore/animate.c"
         )); CatchException(exception); (void) DestroyExceptionInfo(exception); }
                      ;
          return((Image *) 
# 430 "MagickCore/animate.c" 3 4
                          ((void *)0)
# 430 "MagickCore/animate.c"
                              );
        }
      number_files=1;
      ...
      if ((status == MagickFalse) || (number_files == 0))
        {
          ...
          if (number_files == 0)
            {
              { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 442,ImageError,"NoImagesWereLoaded", "'%s': %s",filenames,strerror(
# 442 "MagickCore/animate.c" 3 4
             (*__errno_location ())
# 442 "MagickCore/animate.c"
             )); CatchException(exception); (void) DestroyExceptionInfo(exception); };
              return((Image *) 
# 443 "MagickCore/animate.c" 3 4
                              ((void *)0)
# 443 "MagickCore/animate.c"
                                  );
            }
          { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 445,ResourceLimitError,"MemoryAllocationFailed", "'%s': %s",filenames,strerror(
# 445 "MagickCore/animate.c" 3 4
         (*__errno_location ())
# 445 "MagickCore/animate.c"
         )); CatchException(exception); (void) DestroyExceptionInfo(exception); }
                      ;
          return((Image *) 
# 447 "MagickCore/animate.c" 3 4
                          ((void *)0)
# 447 "MagickCore/animate.c"
                              );
        }
      ...
      for (i=0; i < number_files; i++)
      {
        ...
        *read_info->magick='\0';
        ...
        CatchException(exception);
        if (next != (Image *) 
# 460 "MagickCore/animate.c" 3 4
                             ((void *)0)
# 460 "MagickCore/animate.c"
                                 )
          AppendImageToList(&images,next);
        if (number_files <= 5)
          continue;
        proceed=SetImageProgress(images,"Load/Image",i,(MagickSizeType)
          number_files);
      ...
      if (images == (Image *) 
# 471 "MagickCore/animate.c" 3 4
                             ((void *)0)
# 471 "MagickCore/animate.c"
                                 )
        {
          XSetCursorState(display,windows,MagickFalse);
          { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 474,ImageError,"NoImagesWereLoaded", "'%s': %s",filenames,strerror(
# 474 "MagickCore/animate.c" 3 4
         (*__errno_location ())
# 474 "MagickCore/animate.c"
         )); CatchException(exception); (void) DestroyExceptionInfo(exception); };
          return((Image *) 
# 475 "MagickCore/animate.c" 3 4
                          ((void *)0)
# 475 "MagickCore/animate.c"
                              );
        }
    ...
    case PlayCommand:
    {
      ...
      *state&=(~0x0004U);
      ...
      (void) FormatLocaleString(name,4096,"%s: %s",
        "ImageMagick",basename);
      (void) CloneString(&windows->image.name,name);
      if (resource_info->title != (char *) 
# 499 "MagickCore/animate.c" 3 4
                                          ((void *)0)
# 499 "MagickCore/animate.c"
                                              )
        {
          char
            *title;
...
# 554 "MagickCore/animate.c" 3 4
                                         ((void *)0) 
# 554 "MagickCore/animate.c"
                                              ? exception->reason : "",
            exception->description != (char *) 
# 555 "MagickCore/animate.c" 3 4
                                              ((void *)0) 
# 555 "MagickCore/animate.c"
...
# 588 "MagickCore/animate.c" 3 4
                                                               ((void *)0)
# 588 "MagickCore/animate.c"
                                                                   ,*image,
        exception);
      break;
    }
...
# 616 "MagickCore/animate.c" 3 4
                                    ((void *)0)
# 616 "MagickCore/animate.c"
                                        )
        {
          char
            command[4096];
...
# 628 "MagickCore/animate.c" 3 4
           ((Atom) 31)
# 628 "MagickCore/animate.c"
                    ,8,
# 628 "MagickCore/animate.c" 3 4
                       0
# 628 "MagickCore/animate.c"
      ...
      status=InvokeDelegate(resource_info->image_info,*image,"browse",
        (char *) 
# 636 "MagickCore/animate.c" 3 4
                ((void *)0)
# 636 "MagickCore/animate.c"
                    ,exception);
      if (status == MagickFalse)
        XNoticeWidget(display,windows,"Unable to browse documentation",
          (char *) 
# 639 "MagickCore/animate.c" 3 4
                  ((void *)0)
# 639 "MagickCore/animate.c"
                      );
      XDelay(display,1500);
      XSetCursorState(display,windows,MagickFalse);
      break;
...
# 646 "MagickCore/animate.c" 3 4
                                                               ((void *)0)
# 646 "MagickCore/animate.c"
                                                                   ),
        GetMagickCopyright());
      break;
    }
    case QuitCommand:
    {
      ...
      if (resource_info->confirm_exit == MagickFalse)
        XClientMessage(display,windows->image.id,windows->im_protocols,
          windows->im_exit,
# 657 "MagickCore/animate.c" 3 4
                          0L
# 657 "MagickCore/animate.c"
                                     );
      else
        {
          int
          ...
          if (status != 0)
            XClientMessage(display,windows->image.id,windows->im_protocols,
              windows->im_exit,
# 670 "MagickCore/animate.c" 3 4
                              0L
# 670 "MagickCore/animate.c"
                                         );
        }
      break;
    }
...
__attribute__ ((visibility ("default"))) void XAnimateBackgroundImage(Display *display,
...
# 769 "MagickCore/animate.c" 3 4
                                  ((void *)0)
# 769 "MagickCore/animate.c"
                                      ;
...
# 796 "MagickCore/animate.c" 3 4
 ((void) sizeof ((
# 796 "MagickCore/animate.c"
 images != (Image *) 
# 796 "MagickCore/animate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 796 "MagickCore/animate.c"
...
# 796 "MagickCore/animate.c"
 "images != (Image *) NULL"
# 796 "MagickCore/animate.c" 3 4
 , "MagickCore/animate.c", 796, __extension__ __PRETTY_FUNCTION__); }))
# 796 "MagickCore/animate.c"
                                 ;
  
# 797 "MagickCore/animate.c" 3 4
 ((void) sizeof ((
# 797 "MagickCore/animate.c"
 images->signature == 0xabacadabUL
# 797 "MagickCore/animate.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 797 "MagickCore/animate.c"
...
# 797 "MagickCore/animate.c"
 "images->signature == MagickCoreSignature"
# 797 "MagickCore/animate.c" 3 4
 , "MagickCore/animate.c", 797, __extension__ __PRETTY_FUNCTION__); }))
# 797 "MagickCore/animate.c"
                                                 ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/animate.c",__func__,(unsigned long) 799,"%s",images->filename);
  resources=(*resource_info);
  window_info.id=(Window) 
# 801 "MagickCore/animate.c" 3 4
                         ((void *)0)
# 801 "MagickCore/animate.c"
                             ;
  root_window=XRootWindow(display,XDefaultScreen(display));
  if (LocaleCompare(resources.window_id,"root") == 0)
    ...
    {
      if (
# 807 "MagickCore/animate.c" 3 4
         ((*__ctype_b_loc ())[(int) ((
# 807 "MagickCore/animate.c"
...
# 809 "MagickCore/animate.c" 3 4
                                                                ((void *)0)
# 809 "MagickCore/animate.c"
                                                                    ,0));
      if (window_info.id == (Window) 
# 810 "MagickCore/animate.c" 3 4
                                    ((void *)0)
# 810 "MagickCore/animate.c"
                                        )
        window_info.id=
          XWindowByName(display,root_window,resources.window_id);
    }
  if (window_info.id == (Window) 
# 814 "MagickCore/animate.c" 3 4
                                ((void *)0)
# 814 "MagickCore/animate.c"
                                    )
    {
      { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 816,XServerError,"NoWindowWithSpecifiedIDExists", "'%s': %s",resources.window_id,strerror(
# 816 "MagickCore/animate.c" 3 4
     (*__errno_location ())
# 816 "MagickCore/animate.c"
     )); CatchException(exception); (void) DestroyExceptionInfo(exception); }
                            ;
      return;
    }
...
# 831 "MagickCore/animate.c" 3 4
                                    ((void *)0)
# 831 "MagickCore/animate.c"
                                        )
    {
...
# 837 "MagickCore/animate.c" 3 4
                                           ((void *)0)
# 837 "MagickCore/animate.c"
                                               )
        { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 838,ResourceLimitFatalError,"MemoryAllocationFailed", "'%s': %s",images->filename,strerror(
# 838 "MagickCore/animate.c" 3 4
       (*__errno_location ())
# 838 "MagickCore/animate.c"
       )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                                                    ;
      map_info->colormap=(Colormap) 
# 840 "MagickCore/animate.c" 3 4
                                   ((void *)0)
# 840 "MagickCore/animate.c"
                                       ;
      pixel.pixels=(unsigned long *) 
# 841 "MagickCore/animate.c" 3 4
                                    ((void *)0)
# 841 "MagickCore/animate.c"
                                        ;



      resources.map_type=(char *) 
# 845 "MagickCore/animate.c" 3 4
                                 ((void *)0)
# 845 "MagickCore/animate.c"
                                     ;
      resources.visual_type=visual_type;
      visual_info=XBestVisualInfo(display,map_info,&resources);
      if (visual_info == (XVisualInfo *) 
# 848 "MagickCore/animate.c" 3 4
                                        ((void *)0)
# 848 "MagickCore/animate.c"
                                            )
        { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 849,XServerFatalError,"UnableToGetVisual", "'%s': %s",images->filename,strerror(
# 849 "MagickCore/animate.c" 3 4
       (*__errno_location ())
# 849 "MagickCore/animate.c"
       )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                           ;
...
# 854 "MagickCore/animate.c" 3 4
                                   ((void *)0)
# 854 "MagickCore/animate.c"
                                       ;
      window_info.matte_image=(XImage *) 
# 855 "MagickCore/animate.c" 3 4
                                        ((void *)0)
# 855 "MagickCore/animate.c"
                                            ;
      window_info.pixmap=(Pixmap) 
# 856 "MagickCore/animate.c" 3 4
                                 ((void *)0)
# 856 "MagickCore/animate.c"
                                     ;
      window_info.matte_pixmap=(Pixmap) 
# 857 "MagickCore/animate.c" 3 4
                                       ((void *)0)
# 857 "MagickCore/animate.c"
                                           ;
    }
...
# 865 "MagickCore/animate.c" 3 4
                                 ((void *)0)
# 865 "MagickCore/animate.c"
                                     )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 866,ResourceLimitFatalError,"MemoryAllocationFailed", "'%s': %s",images->filename,strerror(
# 866 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 866 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
  images=coalesce_image;
  if (resources.map_type == (char *) 
# 869 "MagickCore/animate.c" 3 4
                                    ((void *)0)
# 869 "MagickCore/animate.c"
                                        )
    if ((visual_info->class != 
# 870 "MagickCore/animate.c" 3 4
                              4
# 870 "MagickCore/animate.c"
                                       ) &&
        (visual_info->class != 
# 871 "MagickCore/animate.c" 3 4
                              5
# 871 "MagickCore/animate.c"
                                         ))
      {
        Image
          *next;
        ...
        for (next=images; next != (Image *) 
# 879 "MagickCore/animate.c" 3 4
                                           ((void *)0)
# 879 "MagickCore/animate.c"
                                               ; )
        {
        ...
        if (next != (Image *) 
# 893 "MagickCore/animate.c" 3 4
                             ((void *)0)
# 893 "MagickCore/animate.c"
                                 )
          (void) RemapImages(resources.quantize_info,images,(Image *) 
# 894 "MagickCore/animate.c" 3 4
                                                                     ((void *)0)
# 894 "MagickCore/animate.c"
                                                                         ,
            exception);
      }
  ...
  if (image_list == (Image **) 
# 902 "MagickCore/animate.c" 3 4
                              ((void *)0)
# 902 "MagickCore/animate.c"
                                  )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 903,ResourceLimitFatalError,"MemoryAllocationFailed", "'%s': %s",images->filename,strerror(
# 903 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 903 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                                                ;
...
# 917 "MagickCore/animate.c" 3 4
                                            ((void *)0)
# 917 "MagickCore/animate.c"
                                                ) ||
        (visual_info->class == 
# 918 "MagickCore/animate.c" 3 4
                              4
# 918 "MagickCore/animate.c"
                                       ) ||
        (visual_info->class == 
# 919 "MagickCore/animate.c" 3 4
                              5
# 919 "MagickCore/animate.c"
                                         ))
  ...
  if ((resource_info->map_type != (char *) 
# 926 "MagickCore/animate.c" 3 4
                                          ((void *)0)
# 926 "MagickCore/animate.c"
                                              ) ||
      (visual_info->class == 
# 927 "MagickCore/animate.c" 3 4
                            4
# 927 "MagickCore/animate.c"
                                     ) || (visual_info->class == 
# 927 "MagickCore/animate.c" 3 4
                                                                 5
# 927 "MagickCore/animate.c"
  ...
  pixel.annotate_context=XCreateGC(display,window_info.id,(unsigned long)
    (
# 938 "MagickCore/animate.c" 3 4
    (1L<<3) 
# 938 "MagickCore/animate.c"
                 | 
# 938 "MagickCore/animate.c" 3 4
                   (1L<<2)
# 938 "MagickCore/animate.c"
...
# 939 "MagickCore/animate.c" 3 4
                                    ((void *)0)
# 939 "MagickCore/animate.c"
                                        )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 940,XServerFatalError,"UnableToCreateGraphicContext", "'%s': %s",images->filename,strerror(
# 940 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 940 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
...
# 945 "MagickCore/animate.c" 3 4
                                                                    ((void *)0)
# 945 "MagickCore/animate.c"
                                                                        ,
  ...
  if ((image_list[0]->columns != window_info.width) ||
    ...
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 954,XServerFatalError,"UnableToCreateXImage", "'%s': %s",image_list[0]->filename,strerror(
# 954 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 954 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                              ;
  ...
  if (status == MagickFalse)
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 971,XServerFatalError,"UnableToCreateXImage", "'%s': %s",images->filename,strerror(
# 971 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 971 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
  window_info.x=0;
  window_info.y=0;
  if (resource_info->debug != MagickFalse)
    {
      (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 977,
      ...
      if (image_list[0]->colors != 0)
        (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 982,"%.20gc ",(double)
          image_list[0]->colors);
      (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 984,"%s",
        image_list[0]->magick);
    }
...
# 1004 "MagickCore/animate.c" 3 4
                                          ((void *)0)
# 1004 "MagickCore/animate.c"
                                              )
    {
      char
...
# 1020 "MagickCore/animate.c" 3 4
                                      ((void *)0)
# 1020 "MagickCore/animate.c"
                                          )
        { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1021,ResourceLimitFatalError,"MemoryAllocationFailed", "'%s': %s",images->filename,strerror(
# 1021 "MagickCore/animate.c" 3 4
       (*__errno_location ())
# 1021 "MagickCore/animate.c"
       )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                                                    ;
      size_hints->flags=0L;
      (void) FormatLocaleString(default_geometry,4096,"%ux%u",width,
        height);
      ...
      if (((flags & (
# 1029 "MagickCore/animate.c" 3 4
                    0x0001 
# 1029 "MagickCore/animate.c"
                           | 
# 1029 "MagickCore/animate.c" 3 4
                             0x0002
# 1029 "MagickCore/animate.c"
...
# 1041 "MagickCore/animate.c" 3 4
                                    ((void *)0)
# 1041 "MagickCore/animate.c"
                                        )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1042,XServerFatalError,"UnableToCreateXPixmap", "'%s': %s",images->filename,strerror(
# 1042 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 1042 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
  ...
  if ((window_info.pixmaps == (Pixmap *) 
# 1064 "MagickCore/animate.c" 3 4
                                        ((void *)0)
# 1064 "MagickCore/animate.c"
                                            ) ||
      (window_info.matte_pixmaps == (Pixmap *) 
# 1065 "MagickCore/animate.c" 3 4
                                              ((void *)0)
# 1065 "MagickCore/animate.c"
                                                  ))
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1066,ResourceLimitFatalError,"MemoryAllocationFailed", "'%s': %s",images->filename,strerror(
# 1066 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 1066 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
  ...
  for (scene=1; scene < (int) number_scenes; scene++)
  {
    ...
    window_info.pixmap=(Pixmap) 
# 1079 "MagickCore/animate.c" 3 4
                               ((void *)0)
# 1079 "MagickCore/animate.c"
                                   ;
    window_info.matte_pixmap=(Pixmap) 
# 1080 "MagickCore/animate.c" 3 4
                                     ((void *)0)
# 1080 "MagickCore/animate.c"
                                         ;
    if ((resources.map_type != (char *) 
# 1081 "MagickCore/animate.c" 3 4
                                       ((void *)0)
# 1081 "MagickCore/animate.c"
                                           ) ||
        (visual_info->class == 
# 1082 "MagickCore/animate.c" 3 4
                              4
# 1082 "MagickCore/animate.c"
                                       ) ||
        (visual_info->class == 
# 1083 "MagickCore/animate.c" 3 4
                              5
# 1083 "MagickCore/animate.c"
                                         ))
    ...
    if ((image_list[scene]->columns != columns) ||
      ...
      { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1091,XServerFatalError,"UnableToCreateXImage", "'%s': %s",image_list[scene]->filename,strerror(
# 1091 "MagickCore/animate.c" 3 4
     (*__errno_location ())
# 1091 "MagickCore/animate.c"
     )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                                    ;
    status=XMakeImage(display,&resources,&window_info,image_list[scene],
      columns,rows,exception);
    if (status == MagickFalse)
      { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1096,XServerFatalError,"UnableToCreateXImage", "'%s': %s",images->filename,strerror(
# 1096 "MagickCore/animate.c" 3 4
     (*__errno_location ())
# 1096 "MagickCore/animate.c"
     )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                         ;
    if (resource_info->debug != MagickFalse)
      {
        (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1100,
        ...
        if (image_list[scene]->colors != 0)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1104,"%.20gc ",(double)
            image_list[scene]->colors);
        (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1106,"%s",
    ...
    window_info.pixmap=XCreatePixmap(display,window_info.id,width,height,
      window_info.depth);
    if (window_info.pixmap == (Pixmap) 
# 1114 "MagickCore/animate.c" 3 4
                                      ((void *)0)
# 1114 "MagickCore/animate.c"
                                          )
      { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1115,XServerFatalError,"UnableToCreateXPixmap", "'%s': %s",images->filename,strerror(
# 1115 "MagickCore/animate.c" 3 4
     (*__errno_location ())
# 1115 "MagickCore/animate.c"
     )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                         ;
    ...
    if (image_list[scene]->alpha_trait)
      (void) XClearWindow(display,window_info.id);
    delay=1000*image_list[scene]->delay/(size_t) (((image_list[scene]->ticks_per_second) > (1L)) ? (image_list[scene]->ticks_per_second) : (1L))
                                             ;
  ...
  (void) XSelectInput(display,window_info.id,
# 1141 "MagickCore/animate.c" 3 4
                                            (1L<<19)
# 1141 "MagickCore/animate.c"
                                                                  );
  event.type=
# 1142 "MagickCore/animate.c" 3 4
            12
# 1142 "MagickCore/animate.c"
                  ;
  iterations=0;
  do
  {
...
# 1148 "MagickCore/animate.c" 3 4
                               2
# 1148 "MagickCore/animate.c"
                                               ) > 0)
        {
          (void) XNextEvent(display,&event);
          if (event.type == 
# 1151 "MagickCore/animate.c" 3 4
                           17
# 1151 "MagickCore/animate.c"
                                        )
            break;
        }
...
# 1167 "MagickCore/animate.c" 3 4
                        17
# 1167 "MagickCore/animate.c"
                                     );
  (void) XSync(display,MagickFalse);
  image_list=(Image **) RelinquishMagickMemory(image_list);
  images=DestroyImageList(images);
}
# 1207 "MagickCore/animate.c"
__attribute__ ((visibility ("default"))) Image *XAnimateImages(Display *display,
    ...
    *const CommandMenu[]=
    {
      ...
      "Quit",
      (char *) 
# 1224 "MagickCore/animate.c" 3 4
              ((void *)0)
    
# 1225 "MagickCore/animate.c"
   },
    *const AnimateMenu[]=
    {
      "Open...",
      ...
      "Save...",
      (char *) 
# 1234 "MagickCore/animate.c" 3 4
              ((void *)0)
    
# 1235 "MagickCore/animate.c"
   },
    *const SpeedMenu[]=
    {
      "Faster",
      "Slower",
      (char *) 
# 1240 "MagickCore/animate.c" 3 4
              ((void *)0)
    
# 1241 "MagickCore/animate.c"
   },
    *const DirectionMenu[]=
    {
      "Forward",
      "Reverse",
      (char *) 
# 1246 "MagickCore/animate.c" 3 4
              ((void *)0)
    
# 1247 "MagickCore/animate.c"
   },
    *const HelpMenu[]=
    {
      "Overview",
      ...
      "About Animate",
      (char *) 
# 1253 "MagickCore/animate.c" 3 4
              ((void *)0)
    
# 1254 "MagickCore/animate.c"
   };
...
# 1407 "MagickCore/animate.c" 3 4
 ((void) sizeof ((
# 1407 "MagickCore/animate.c"
 images != (Image *) 
# 1407 "MagickCore/animate.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 1407 "MagickCore/animate.c"
...
# 1407 "MagickCore/animate.c"
 "images != (Image *) NULL"
# 1407 "MagickCore/animate.c" 3 4
 , "MagickCore/animate.c", 1407, __extension__ __PRETTY_FUNCTION__); }))
# 1407 "MagickCore/animate.c"
                                 ;
  
# 1408 "MagickCore/animate.c" 3 4
 ((void) sizeof ((
# 1408 "MagickCore/animate.c"
 images->signature == 0xabacadabUL
# 1408 "MagickCore/animate.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 1408 "MagickCore/animate.c"
...
# 1408 "MagickCore/animate.c"
 "images->signature == MagickCoreSignature"
# 1408 "MagickCore/animate.c" 3 4
 , "MagickCore/animate.c", 1408, __extension__ __PRETTY_FUNCTION__); }))
# 1408 "MagickCore/animate.c"
                                                 ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/animate.c",__func__,(unsigned long) 1410,"%s",images->filename);
  warning_handler=(WarningHandler) 
# 1411 "MagickCore/animate.c" 3 4
                                  ((void *)0)
# 1411 "MagickCore/animate.c"
                                      ;
  windows=XSetWindows((XWindows *) ~0);
  if (windows != (XWindows *) 
# 1413 "MagickCore/animate.c" 3 4
                             ((void *)0)
# 1413 "MagickCore/animate.c"
                                 )
    {
      int
        status;
      ...
      if (status == -1)
        (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1422,FileOpenError,
...
# 1425 "MagickCore/animate.c" 3 4
                                                                  ((void *)0)
# 1425 "MagickCore/animate.c"
                                                                      );
      warning_handler=resource_info->display_warnings ?
        SetWarningHandler(XWarning) : SetWarningHandler((WarningHandler) 
# 1427 "MagickCore/animate.c" 3 4
                                                                        ((void *)0)
# 1427 "MagickCore/animate.c"
                                                                            );
    }
  else
    {
      ...
      for (p=images; p != (Image *) 
# 1437 "MagickCore/animate.c" 3 4
                                   ((void *)0)
# 1437 "MagickCore/animate.c"
      ...
      if (windows == (XWindows *) 
# 1448 "MagickCore/animate.c" 3 4
                                 ((void *)0)
# 1448 "MagickCore/animate.c"
                                     )
        { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1449,XServerFatalError,"MemoryAllocationFailed", "'%s': %s",images->filename,strerror(
# 1449 "MagickCore/animate.c" 3 4
       (*__errno_location ())
# 1449 "MagickCore/animate.c"
       )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                           ;
...
# 1463 "MagickCore/animate.c" 3 4
                                      ((void *)0)
# 1463 "MagickCore/animate.c"
                                          ;
    }
...
# 1468 "MagickCore/animate.c" 3 4
                                           ((void *)0)
# 1468 "MagickCore/animate.c"
                                               )
    (void) XFreeFont(display,windows->font_info);
  windows->font_info=XBestFont(display,resource_info,MagickFalse);
  if (windows->font_info == (XFontStruct *) 
# 1471 "MagickCore/animate.c" 3 4
                                           ((void *)0)
# 1471 "MagickCore/animate.c"
                                               )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1472,XServerFatalError,"UnableToLoadFont", "'%s': %s",resource_info->font,strerror(
# 1472 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 1472 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                          ;
  ...
  coalesce_image=CoalesceImages(images,exception);
  if (coalesce_image == (Image *) 
# 1489 "MagickCore/animate.c" 3 4
                                 ((void *)0)
# 1489 "MagickCore/animate.c"
                                     )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1490,XServerFatalError,"MemoryAllocationFailed", "'%s': %s",images->filename,strerror(
# 1490 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 1490 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
  images=coalesce_image;
  if (resource_info->map_type == (char *) 
# 1493 "MagickCore/animate.c" 3 4
                                         ((void *)0)
# 1493 "MagickCore/animate.c"
                                             )
    if ((visual_info->class != 
# 1494 "MagickCore/animate.c" 3 4
                              4
# 1494 "MagickCore/animate.c"
                                       ) &&
        (visual_info->class != 
# 1495 "MagickCore/animate.c" 3 4
                              5
# 1495 "MagickCore/animate.c"
                                         ))
      {
        Image
          *next;
        ...
        for (next=images; next != (Image *) 
# 1503 "MagickCore/animate.c" 3 4
                                           ((void *)0)
# 1503 "MagickCore/animate.c"
                                               ; )
        {
          next->alpha_trait=UndefinedPixelTrait;
          if ((next->storage_class == DirectClass) ||
        ...
        if (next != (Image *) 
# 1517 "MagickCore/animate.c" 3 4
                             ((void *)0)
# 1517 "MagickCore/animate.c"
                                 )
          (void) RemapImages(resource_info->quantize_info,images,
            (Image *) 
# 1519 "MagickCore/animate.c" 3 4
                     ((void *)0)
# 1519 "MagickCore/animate.c"
                         ,exception);
      }
  ...
  image_list=ImageListToArray(images,exception);
  if (image_list == (Image **) 
# 1526 "MagickCore/animate.c" 3 4
                              ((void *)0)
# 1526 "MagickCore/animate.c"
                                  )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1527,ResourceLimitFatalError,"MemoryAllocationFailed", "'%s': %s",images->filename,strerror(
# 1527 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 1527 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
  ...
  {
    if ((resource_info->map_type != (char *) 
# 1541 "MagickCore/animate.c" 3 4
                                            ((void *)0)
# 1541 "MagickCore/animate.c"
                                                ) ||
        (visual_info->class == 
# 1542 "MagickCore/animate.c" 3 4
                              4
# 1542 "MagickCore/animate.c"
                                       ) ||
        (visual_info->class == 
# 1543 "MagickCore/animate.c" 3 4
                              5
# 1543 "MagickCore/animate.c"
                                         ))
      (void) SetImageType(image_list[scene],image_list[scene]->alpha_trait ==
        BlendPixelTrait ? TrueColorType : TrueColorAlphaType,exception);
    if ((display_image->columns < image_list[scene]->columns) &&
  ...
  if (resource_info->debug != MagickFalse)
    {
      (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1552,
      ...
      if (display_image->colors != 0)
        (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1557,"%.20gc ",(double)
          display_image->colors);
      (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1559,"%s",
...
# 1567 "MagickCore/animate.c" 3 4
                              ((void *)0)
# 1567 "MagickCore/animate.c"
                                  ;
  ...
  manager_hints->flags=
# 1574 "MagickCore/animate.c" 3 4
                      (1L << 0) 
# 1574 "MagickCore/animate.c"
                                | 
# 1574 "MagickCore/animate.c" 3 4
                                  (1L << 1)
# 1574 "MagickCore/animate.c"
...
# 1576 "MagickCore/animate.c" 3 4
                              0
# 1576 "MagickCore/animate.c"
                                            ;
  XMakeWindow(display,root_window,argv,argc,class_hints,manager_hints,
    &windows->context);
  if (resource_info->debug != MagickFalse)
    (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1580,
  ...
  context_mask=(MagickStatusType)
    (
# 1587 "MagickCore/animate.c" 3 4
    (1L<<3) 
# 1587 "MagickCore/animate.c"
                 | 
# 1587 "MagickCore/animate.c" 3 4
                   (1L<<14) 
# 1587 "MagickCore/animate.c"
...
# 1587 "MagickCore/animate.c"
  ...
  if (pixel->annotate_context != (GC) 
# 1588 "MagickCore/animate.c" 3 4
                                     ((void *)0)
# 1588 "MagickCore/animate.c"
                                         )
  ...
  if (pixel->annotate_context == (GC) 
# 1592 "MagickCore/animate.c" 3 4
                                     ((void *)0)
# 1592 "MagickCore/animate.c"
                                         )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1593,XServerFatalError,"UnableToCreateGraphicContext", "'%s': %s",images->filename,strerror(
# 1593 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 1593 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
  context_values.background=pixel->depth_color.pixel;
  if (pixel->widget_context != (GC) 
# 1596 "MagickCore/animate.c" 3 4
                                   ((void *)0)
# 1596 "MagickCore/animate.c"
                                       )
    (void) XFreeGC(display,pixel->widget_context);
  pixel->widget_context=
    XCreateGC(display,windows->context.id,context_mask,&context_values);
  if (pixel->widget_context == (GC) 
# 1600 "MagickCore/animate.c" 3 4
                                   ((void *)0)
# 1600 "MagickCore/animate.c"
                                       )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1601,XServerFatalError,"UnableToCreateGraphicContext", "'%s': %s",images->filename,strerror(
# 1601 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 1601 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
...
# 1607 "MagickCore/animate.c" 3 4
                                      ((void *)0)
# 1607 "MagickCore/animate.c"
                                          )
    (void) XFreeGC(display,pixel->highlight_context);
  pixel->highlight_context=XCreateGC(display,windows->context.id,
    (size_t) (context_mask | 
# 1610 "MagickCore/animate.c" 3 4
                            (1L<<1)
# 1610 "MagickCore/animate.c"
                                       ),&context_values);
  if (pixel->highlight_context == (GC) 
# 1611 "MagickCore/animate.c" 3 4
                                      ((void *)0)
# 1611 "MagickCore/animate.c"
                                          )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1612,XServerFatalError,"UnableToCreateGraphicContext", "'%s': %s",images->filename,strerror(
# 1612 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 1612 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
...
# 1618 "MagickCore/animate.c" 3 4
                                                                        ((void *)0)
# 1618 "MagickCore/animate.c"
                                                                            ,
...
# 1624 "MagickCore/animate.c" 3 4
                                     (1L<<15) 
# 1624 "MagickCore/animate.c"
                                                  | 
# 1624 "MagickCore/animate.c" 3 4
                                                    (1L<<17)
# 1624 "MagickCore/animate.c"
                                                                       ;
  manager_hints->flags=
# 1625 "MagickCore/animate.c" 3 4
                      (1L << 0) 
# 1625 "MagickCore/animate.c"
                                | 
# 1625 "MagickCore/animate.c" 3 4
                                  (1L << 1)
# 1625 "MagickCore/animate.c"
  ...
  manager_hints->input=MagickFalse;
  manager_hints->initial_state=
# 1627 "MagickCore/animate.c" 3 4
                              3
# 1627 "MagickCore/animate.c"
                                         ;
  XMakeWindow(display,root_window,argv,argc,class_hints,manager_hints,
    &windows->icon);
  if (resource_info->debug != MagickFalse)
    (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1631,"Window id: 0x%lx (icon)",
      windows->icon.id);



  if (icon_pixel->annotate_context != (GC) 
# 1636 "MagickCore/animate.c" 3 4
                                          ((void *)0)
# 1636 "MagickCore/animate.c"
                                              )
  ...
  icon_pixel->annotate_context=XCreateGC(display,windows->icon.id,
    (size_t) (
# 1641 "MagickCore/animate.c" 3 4
             (1L<<3) 
# 1641 "MagickCore/animate.c"
                          | 
# 1641 "MagickCore/animate.c" 3 4
                            (1L<<2)
# 1641 "MagickCore/animate.c"
  ...
  if (icon_pixel->annotate_context == (GC) 
# 1642 "MagickCore/animate.c" 3 4
                                          ((void *)0)
# 1642 "MagickCore/animate.c"
                                              )
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1643,XServerFatalError,"UnableToCreateGraphicContext", "'%s': %s",images->filename,strerror(
# 1643 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 1643 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
  ...
  if (resource_info->title != (char *) 
# 1654 "MagickCore/animate.c" 3 4
                                      ((void *)0)
# 1654 "MagickCore/animate.c"
                                          )
    {
      char
        *title;
  ...
  else
    {
      ...
      (void) FormatLocaleString(window_name,4096,
        "%s: %s[scene: %.20g frames: %.20g]","ImageMagick",filename,(double)
...
# 1696 "MagickCore/animate.c" 3 4
                                      (1L<<13) 
# 1696 "MagickCore/animate.c"
                                                       | 
# 1696 "MagickCore/animate.c" 3 4
                                                         (1L<<2) 
# 1696 "MagickCore/animate.c"
...
# 1697 "MagickCore/animate.c" 3 4
   (1L<<3) 
# 1697 "MagickCore/animate.c"
                     | 
# 1697 "MagickCore/animate.c" 3 4
                       (1L<<4) 
# 1697 "MagickCore/animate.c"
...
# 1698 "MagickCore/animate.c" 3 4
   (1L<<1) 
# 1698 "MagickCore/animate.c"
                  | 
# 1698 "MagickCore/animate.c" 3 4
                    (1L<<5) 
# 1698 "MagickCore/animate.c"
...
# 1699 "MagickCore/animate.c" 3 4
   (1L<<22) 
# 1699 "MagickCore/animate.c"
                      | 
# 1699 "MagickCore/animate.c" 3 4
                        (1L<<17) 
# 1699 "MagickCore/animate.c"
...
# 1702 "MagickCore/animate.c" 3 4
                                                                    ((void *)0)
# 1702 "MagickCore/animate.c"
                                                                        ))
    {
...
# 1710 "MagickCore/animate.c" 3 4
                                       (1L << 1) 
# 1710 "MagickCore/animate.c"
                                              | 
# 1710 "MagickCore/animate.c" 3 4
                                                (1L << 0)
# 1710 "MagickCore/animate.c"
...
# 1717 "MagickCore/animate.c" 3 4
                                                        (1L<<2) 
# 1717 "MagickCore/animate.c"
                                                                        |
        
# 1718 "MagickCore/animate.c" 3 4
       (1L<<3)
# 1718 "MagickCore/animate.c"
                        ;
      windows->backdrop.attributes.event_mask=
# 1719 "MagickCore/animate.c" 3 4
                                             (1L<<2) 
# 1719 "MagickCore/animate.c"
                                                             | 
# 1719 "MagickCore/animate.c" 3 4
                                                               (1L<<0) 
# 1719 "MagickCore/animate.c"
...
# 1720 "MagickCore/animate.c" 3 4
       (1L<<17)
# 1720 "MagickCore/animate.c"
                          ;
      manager_hints->flags=
# 1721 "MagickCore/animate.c" 3 4
                          (1L << 3) 
# 1721 "MagickCore/animate.c"
                                         | 
# 1721 "MagickCore/animate.c" 3 4
                                           (1L << 0) 
# 1721 "MagickCore/animate.c"
...
# 1721 "MagickCore/animate.c"
      ...
      manager_hints->initial_state=
        resource_info->iconic ? 
# 1725 "MagickCore/animate.c" 3 4
                               3 
# 1725 "MagickCore/animate.c"
                                           : 
# 1725 "MagickCore/animate.c" 3 4
                                             1
# 1725 "MagickCore/animate.c"
      ...
      XMakeWindow(display,root_window,argv,argc,class_hints,manager_hints,
        &windows->backdrop);
      if (resource_info->debug != MagickFalse)
        (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1729,
...
# 1733 "MagickCore/animate.c" 3 4
                                       ((void *)0)
# 1733 "MagickCore/animate.c"
                                           )
        {
          (void) XDestroyWindow(display,windows->image.id);
          windows->image.id=(Window) 
# 1736 "MagickCore/animate.c" 3 4
                                    ((void *)0)
# 1736 "MagickCore/animate.c"
                                        ;
        }
      ...
      windows->image.flags|=
# 1741 "MagickCore/animate.c" 3 4
                           (1L << 0)
# 1741 "MagickCore/animate.c"
                                     ;
  ...
  manager_hints->flags=
# 1747 "MagickCore/animate.c" 3 4
                      (1L << 3) 
# 1747 "MagickCore/animate.c"
                                     | 
# 1747 "MagickCore/animate.c" 3 4
                                       (1L << 0) 
# 1747 "MagickCore/animate.c"
...
# 1747 "MagickCore/animate.c"
  ...
  manager_hints->initial_state=
    resource_info->iconic ? 
# 1751 "MagickCore/animate.c" 3 4
                           3 
# 1751 "MagickCore/animate.c"
                                       : 
# 1751 "MagickCore/animate.c" 3 4
                                         1
# 1751 "MagickCore/animate.c"
...
# 1752 "MagickCore/animate.c" 3 4
                                          ((void *)0)
# 1752 "MagickCore/animate.c"
                                              )
    {



      manager_hints->flags|=(MagickStatusType) 
# 1757 "MagickCore/animate.c" 3 4
                                              (1L << 6)
# 1757 "MagickCore/animate.c"
                                                             ;
      manager_hints->window_group=windows->group_leader.id;
      (void) XSelectInput(display,windows->group_leader.id,
# 1759 "MagickCore/animate.c" 3 4
                                                          (1L<<17)
# 1759 "MagickCore/animate.c"
                                                                             );
      if (resource_info->debug != MagickFalse)
        (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1761,
...
# 1768 "MagickCore/animate.c" 3 4
   ((Atom) 31)
# 1768 "MagickCore/animate.c"
            ,8,
# 1768 "MagickCore/animate.c" 3 4
               0
# 1768 "MagickCore/animate.c"
...
# 1768 "MagickCore/animate.c"
                                                     ,0);
  if (windows->group_leader.id != (Window) 
# 1769 "MagickCore/animate.c" 3 4
                                          ((void *)0)
# 1769 "MagickCore/animate.c"
                                              )
    (void) XSetTransientForHint(display,windows->image.id,
      windows->group_leader.id);
  if (resource_info->debug != MagickFalse)
    (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1773,"Window id: 0x%lx (image)",
      windows->image.id);
  ...
  windows->info.y=2;
  windows->info.flags|=
# 1785 "MagickCore/animate.c" 3 4
                      (1L << 2)
# 1785 "MagickCore/animate.c"
                               ;
  windows->info.attributes.win_gravity=
# 1786 "MagickCore/animate.c" 3 4
                                      0
# 1786 "MagickCore/animate.c"
                                                  ;
  windows->info.attributes.event_mask=
# 1787 "MagickCore/animate.c" 3 4
                                     (1L<<2) 
# 1787 "MagickCore/animate.c"
                                                     | 
# 1787 "MagickCore/animate.c" 3 4
                                                       (1L<<15) 
# 1787 "MagickCore/animate.c"
...
# 1788 "MagickCore/animate.c" 3 4
   (1L<<17)
# 1788 "MagickCore/animate.c"
                      ;
  manager_hints->flags=
# 1789 "MagickCore/animate.c" 3 4
                      (1L << 0) 
# 1789 "MagickCore/animate.c"
                                | 
# 1789 "MagickCore/animate.c" 3 4
                                  (1L << 1) 
# 1789 "MagickCore/animate.c"
...
# 1789 "MagickCore/animate.c"
  ...
  manager_hints->input=MagickFalse;
  manager_hints->initial_state=
# 1791 "MagickCore/animate.c" 3 4
                              1
# 1791 "MagickCore/animate.c"
                                         ;
  ...
  if (resource_info->debug != MagickFalse)
    (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1803,"Window id: 0x%lx (info)",
      windows->info.id);
...
# 1811 "MagickCore/animate.c" 3 4
                                                              ((void *)0)
# 1811 "MagickCore/animate.c"
                                                                  );
...
# 1815 "MagickCore/animate.c" 3 4
                                     ((void *)0)
# 1815 "MagickCore/animate.c"
                                         );
  (void) CloneString(&windows->command.name,"Commands");
  windows->command.border_width=0;
  windows->command.flags|=
# 1818 "MagickCore/animate.c" 3 4
                         (1L << 2)
# 1818 "MagickCore/animate.c"
                                  ;
  windows->command.attributes.event_mask=
# 1819 "MagickCore/animate.c" 3 4
                                        (1L<<13) 
# 1819 "MagickCore/animate.c"
                                                         | 
# 1819 "MagickCore/animate.c" 3 4
                                                           (1L<<2) 
# 1819 "MagickCore/animate.c"
...
# 1820 "MagickCore/animate.c" 3 4
   (1L<<3) 
# 1820 "MagickCore/animate.c"
                     | 
# 1820 "MagickCore/animate.c" 3 4
                       (1L<<4) 
# 1820 "MagickCore/animate.c"
...
# 1821 "MagickCore/animate.c" 3 4
   (1L<<24) 
# 1821 "MagickCore/animate.c"
                       | 
# 1821 "MagickCore/animate.c" 3 4
                         (1L<<17)
# 1821 "MagickCore/animate.c"
                                            ;
  manager_hints->flags=
# 1822 "MagickCore/animate.c" 3 4
                      (1L << 0) 
# 1822 "MagickCore/animate.c"
                                | 
# 1822 "MagickCore/animate.c" 3 4
                                  (1L << 1) 
# 1822 "MagickCore/animate.c"
...
# 1822 "MagickCore/animate.c"
  ...
  manager_hints->input=MagickTrue;
  manager_hints->initial_state=
# 1824 "MagickCore/animate.c" 3 4
                              1
# 1824 "MagickCore/animate.c"
                                         ;
  manager_hints->window_group=windows->image.id;
  XMakeWindow(display,root_window,argv,argc,class_hints,manager_hints,
    &windows->command);
  ...
  if (resource_info->debug != MagickFalse)
    (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1835,
  ...
  windows->widget.geometry=XGetResourceClass(resource_info->resource_database,
    resource_name,"geometry",(char *) 
# 1845 "MagickCore/animate.c" 3 4
                                     ((void *)0)
# 1845 "MagickCore/animate.c"
                                         );
  windows->widget.border_width=0;
  windows->widget.flags|=
# 1847 "MagickCore/animate.c" 3 4
                        (1L << 2)
# 1847 "MagickCore/animate.c"
                                 ;
  windows->widget.attributes.event_mask=
# 1848 "MagickCore/animate.c" 3 4
                                       (1L<<13) 
# 1848 "MagickCore/animate.c"
                                                        | 
# 1848 "MagickCore/animate.c" 3 4
                                                          (1L<<2) 
# 1848 "MagickCore/animate.c"
...
# 1849 "MagickCore/animate.c" 3 4
   (1L<<3) 
# 1849 "MagickCore/animate.c"
                     | 
# 1849 "MagickCore/animate.c" 3 4
                       (1L<<4) 
# 1849 "MagickCore/animate.c"
...
# 1850 "MagickCore/animate.c" 3 4
   (1L<<1) 
# 1850 "MagickCore/animate.c"
                  | 
# 1850 "MagickCore/animate.c" 3 4
                    (1L<<5) 
# 1850 "MagickCore/animate.c"
...
# 1851 "MagickCore/animate.c" 3 4
   (1L<<17)
# 1851 "MagickCore/animate.c"
                      ;
  manager_hints->flags=
# 1852 "MagickCore/animate.c" 3 4
                      (1L << 0) 
# 1852 "MagickCore/animate.c"
                                | 
# 1852 "MagickCore/animate.c" 3 4
                                  (1L << 1) 
# 1852 "MagickCore/animate.c"
...
# 1852 "MagickCore/animate.c"
  ...
  manager_hints->input=MagickTrue;
  manager_hints->initial_state=
# 1854 "MagickCore/animate.c" 3 4
                              1
# 1854 "MagickCore/animate.c"
                                         ;
  manager_hints->window_group=windows->image.id;
  XMakeWindow(display,root_window,argv,argc,class_hints,manager_hints,
    &windows->widget);
  ...
  if (resource_info->debug != MagickFalse)
    (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1864,
  ...
  windows->popup.flags|=
# 1872 "MagickCore/animate.c" 3 4
                       (1L << 2)
# 1872 "MagickCore/animate.c"
                                ;
  windows->popup.attributes.event_mask=
# 1873 "MagickCore/animate.c" 3 4
                                      (1L<<13) 
# 1873 "MagickCore/animate.c"
                                                       | 
# 1873 "MagickCore/animate.c" 3 4
                                                         (1L<<2) 
# 1873 "MagickCore/animate.c"
...
# 1874 "MagickCore/animate.c" 3 4
   (1L<<3) 
# 1874 "MagickCore/animate.c"
                     | 
# 1874 "MagickCore/animate.c" 3 4
                       (1L<<4) 
# 1874 "MagickCore/animate.c"
...
# 1875 "MagickCore/animate.c" 3 4
   (1L<<1) 
# 1875 "MagickCore/animate.c"
                  | 
# 1875 "MagickCore/animate.c" 3 4
                    (1L<<5) 
# 1875 "MagickCore/animate.c"
...
# 1875 "MagickCore/animate.c"
                                                         ;
  manager_hints->flags=
# 1876 "MagickCore/animate.c" 3 4
                      (1L << 0) 
# 1876 "MagickCore/animate.c"
                                | 
# 1876 "MagickCore/animate.c" 3 4
                                  (1L << 1) 
# 1876 "MagickCore/animate.c"
...
# 1876 "MagickCore/animate.c"
  ...
  manager_hints->input=MagickTrue;
  manager_hints->initial_state=
# 1878 "MagickCore/animate.c" 3 4
                              1
# 1878 "MagickCore/animate.c"
                                         ;
  manager_hints->window_group=windows->image.id;
  XMakeWindow(display,root_window,argv,argc,class_hints,manager_hints,
    &windows->popup);
  ...
  if (resource_info->debug != MagickFalse)
    (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1888,
      "Window id: 0x%lx (pop up)",windows->popup.id);



  if (warning_handler == (WarningHandler) 
# 1893 "MagickCore/animate.c" 3 4
                                         ((void *)0)
# 1893 "MagickCore/animate.c"
                                             )
    {
      warning_handler=resource_info->display_warnings ?
        SetErrorHandler(XWarning) : SetErrorHandler((ErrorHandler) 
# 1896 "MagickCore/animate.c" 3 4
                                                                  ((void *)0)
# 1896 "MagickCore/animate.c"
                                                                      );
      warning_handler=resource_info->display_warnings ?
        SetWarningHandler(XWarning) : SetWarningHandler((WarningHandler) 
# 1898 "MagickCore/animate.c" 3 4
                                                                        ((void *)0)
# 1898 "MagickCore/animate.c"
                                                                            );
    }
  ...
  (void) XReconfigureWMWindow(display,windows->image.id,windows->command.screen,
    (unsigned int) (
# 1911 "MagickCore/animate.c" 3 4
                   (1<<2) 
# 1911 "MagickCore/animate.c"
                           | 
# 1911 "MagickCore/animate.c" 3 4
                             (1<<3)
# 1911 "MagickCore/animate.c"
  ...
  windows->image.matte_pixmaps=(Pixmap *) AcquireQuantumMemory(number_scenes,
    sizeof(*windows->image.pixmaps));
  if ((windows->image.pixmaps == (Pixmap *) 
# 1916 "MagickCore/animate.c" 3 4
                                           ((void *)0)
# 1916 "MagickCore/animate.c"
                                               ) ||
      (windows->image.matte_pixmaps == (Pixmap *) 
# 1917 "MagickCore/animate.c" 3 4
                                                 ((void *)0)
# 1917 "MagickCore/animate.c"
                                                     ))
    { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1918,ResourceLimitFatalError,"MemoryAllocationFailed", "'%s': %s",images->filename,strerror(
# 1918 "MagickCore/animate.c" 3 4
   (*__errno_location ())
# 1918 "MagickCore/animate.c"
   )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                       ;
  if ((windows->image.mapped == MagickFalse) ||
      (windows->backdrop.id != (Window) 
# 1921 "MagickCore/animate.c" 3 4
                                       ((void *)0)
# 1921 "MagickCore/animate.c"
                                           ))
  ...
  for (scene=0; scene < (ssize_t) number_scenes; scene++)
  {
    ...
    windows->image.pixmap=(Pixmap) 
# 1933 "MagickCore/animate.c" 3 4
                                  ((void *)0)
# 1933 "MagickCore/animate.c"
                                      ;
    windows->image.matte_pixmap=(Pixmap) 
# 1934 "MagickCore/animate.c" 3 4
                                        ((void *)0)
# 1934 "MagickCore/animate.c"
                                            ;
    if ((resource_info->map_type != (char *) 
# 1935 "MagickCore/animate.c" 3 4
                                            ((void *)0)
# 1935 "MagickCore/animate.c"
                                                ) ||
        (visual_info->class == 
# 1936 "MagickCore/animate.c" 3 4
                              4
# 1936 "MagickCore/animate.c"
                                       ) ||
        (visual_info->class == 
# 1937 "MagickCore/animate.c" 3 4
                              5
# 1937 "MagickCore/animate.c"
                                         ))
      if (image_list[scene]->storage_class == PseudoClass)
    ...
    if ((image_list[scene]->columns != columns) ||
        (image_list[scene]->rows != rows))
      { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1945,XServerFatalError,"UnableToCreateXImage", "'%s': %s",image_list[scene]->filename,strerror(
# 1945 "MagickCore/animate.c" 3 4
     (*__errno_location ())
# 1945 "MagickCore/animate.c"
     )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                                    ;
    status=XMakeImage(display,resource_info,&windows->image,image_list[scene],
      columns,rows,exception) == MagickFalse ? 0 : 1;
    if (status == MagickFalse)
      { { ExceptionInfo *exception; exception=AcquireExceptionInfo(); (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 1950,XServerFatalError,"UnableToCreateXImage", "'%s': %s",images->filename,strerror(
# 1950 "MagickCore/animate.c" 3 4
     (*__errno_location ())
# 1950 "MagickCore/animate.c"
     )); CatchException(exception); (void) DestroyExceptionInfo(exception); }; _exit(1); }
                         ;
    if (image_list[scene]->debug != MagickFalse)
      {
        (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1954,
          "Image: [%.20g] %s %.20gx%.20g ",(double) image_list[scene]->scene,
          image_list[scene]->filename,(double) columns,(double) rows);
        if (image_list[scene]->colors != 0)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1958,"%.20gc ",(double)
            image_list[scene]->colors);
        (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 1960,"%s",
          image_list[scene]->magick);
      }
    ...
    if (resource_info->title != (char *) 
# 1966 "MagickCore/animate.c" 3 4
                                        ((void *)0)
# 1966 "MagickCore/animate.c"
                                            )
      {
        char
          *title;
    ...
    else
      {
        ...
        while ((p > image_list[scene]->magick_filename) && (*(p-1) != '/'))
          p--;
        (void) FormatLocaleString(window_name,4096,
          "%s: %s[%.20g of %.20g]","ImageMagick",p,(double) scene+1,
          (double) number_scenes);
        (void) CloneString(&windows->image.name,window_name);
      }
    status=XStringListToTextProperty(&windows->image.name,1,&window_name);
    if (status != 
# 1991 "MagickCore/animate.c" 3 4
                 0
# 1991 "MagickCore/animate.c"
                        )
      {
        XSetWMName(display,windows->image.id,&window_name);
        (void) XFree((void *) window_name.value);
  ...
  iterations=0;
  image=image_list[0];
  state=(MagickStatusType) (0x0008U | 0x0040U);
  (void) XMagickCommand(display,resource_info,windows,PlayCommand,&images,
    &state,exception);
  do
  {
    if (XEventsQueued(display,
# 2024 "MagickCore/animate.c" 3 4
                             2
# 2024 "MagickCore/animate.c"
                                             ) == 0)
      if ((state & 0x0020U) || (state & 0x0080U))
        {
          MagickBooleanType
            pause;
          ...
          if ((image != (Image *) 
# 2094 "MagickCore/animate.c" 3 4
                                 ((void *)0)
# 2094 "MagickCore/animate.c"
                                     ) && (image->start_loop != 0))
            first_scene=scene;
          if ((state & 0x0080U) ||
              (resource_info->title != (char *) 
# 2097 "MagickCore/animate.c" 3 4
                                               ((void *)0)
# 2097 "MagickCore/animate.c"
                                                   ))
            {
              char
                name[4096];
              ...
              while ((p > image_list[scene]->filename) && (*(p-1) != '/'))
                p--;
              (void) FormatLocaleString(name,4096,
                "%s: %s[%.20g of %.20g]","ImageMagick",p,(double)
                scene+1,(double) number_scenes);
              (void) CloneString(&windows->image.name,name);
              if (resource_info->title != (char *) 
# 2113 "MagickCore/animate.c" 3 4
                                                  ((void *)0)
# 2113 "MagickCore/animate.c"
                                                      )
                {
                  char
                    *title;
              ...
              status=XStringListToTextProperty(&windows->image.name,1,
                &window_name);
              if (status != 
# 2125 "MagickCore/animate.c" 3 4
                           0
# 2125 "MagickCore/animate.c"
                                  )
                {
                  XSetWMName(display,windows->image.id,&window_name);
                  (void) XFree((void *) window_name.value);
          ...
          XGetPixelInfo(display,visual_info,map_info,resource_info,
            image_list[scene],windows->image.pixel_info);
          if (image != (Image *) 
# 2136 "MagickCore/animate.c" 3 4
                                ((void *)0)
# 2136 "MagickCore/animate.c"
                                    )
            {
          ...
          if (pause != MagickFalse)
            for (i=0; i < (ssize_t) resource_info->pause; i++)
            {
              ...
              status=XCheckTypedWindowEvent(display,windows->image.id,
# 2159 "MagickCore/animate.c" 3 4
                                                                     2
# 2159 "MagickCore/animate.c"
                                                                             ,
                &event);
              if (status != 0)
                {
...
# 2167 "MagickCore/animate.c" 3 4
                                                                  ((void *)0)
# 2167 "MagickCore/animate.c"
                                                                      );
                  *(command+length)='\0';
                  if ((key_symbol == 
# 2169 "MagickCore/animate.c" 3 4
                                    0x0071
# 2169 "MagickCore/animate.c"
                                        ) || (key_symbol == 
# 2169 "MagickCore/animate.c" 3 4
                                                            0xff1b
# 2169 "MagickCore/animate.c"
                                                                     ))
                    {
                      XClientMessage(display,windows->image.id,
                        windows->im_protocols,windows->im_exit,
# 2172 "MagickCore/animate.c" 3 4
                                                              0L
# 2172 "MagickCore/animate.c"
                                                                         );
                      break;
                    }
                }
    ...
    {
      case 
# 2223 "MagickCore/animate.c" 3 4
          4
# 2223 "MagickCore/animate.c"
                     :
      {
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2226,
            "Button Press: 0x%lx %u +%d+%d",event.xbutton.window,
            event.xbutton.button,event.xbutton.x,event.xbutton.y);
        if ((event.xbutton.button == 
# 2229 "MagickCore/animate.c" 3 4
                                    3
# 2229 "MagickCore/animate.c"
                                           ) &&
            (event.xbutton.state & 
# 2230 "MagickCore/animate.c" 3 4
                                  (1<<3)
# 2230 "MagickCore/animate.c"
                                          ))
          {
...
# 2235 "MagickCore/animate.c" 3 4
                                2
# 2235 "MagickCore/animate.c"
                                       ;
            event.xbutton.state&=(~(unsigned int) 
# 2236 "MagickCore/animate.c" 3 4
                                                 (1<<3)
# 2236 "MagickCore/animate.c"
                                                         );
          }
        if (event.xbutton.window == windows->backdrop.id)
          {
            (void) XSetInputFocus(display,event.xbutton.window,
# 2240 "MagickCore/animate.c" 3 4
                                                              2
# 2240 "MagickCore/animate.c"
                                                                            ,
              event.xbutton.time);
            break;
          }
            ...
            if (windows->command.mapped)
            ...
            else
              {
                (void) XCommandWidget(display,windows,CommandMenu,
                  (XEvent *) 
# 2260 "MagickCore/animate.c" 3 4
                            ((void *)0)
# 2260 "MagickCore/animate.c"
                                );
                (void) XMapRaised(display,windows->command.id);
              }
          }
      ...
      case 
# 2266 "MagickCore/animate.c" 3 4
          5
# 2266 "MagickCore/animate.c"
                       :
      {
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2269,
            "Button Release: 0x%lx %u +%d+%d",event.xbutton.window,
            event.xbutton.button,event.xbutton.x,event.xbutton.y);
        break;
      }
      case 
# 2274 "MagickCore/animate.c" 3 4
          33
# 2274 "MagickCore/animate.c"
                       :
      {
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2277,
            ...
            if (*event.xclient.data.l == (long) windows->im_update_colormap)
              {
                ...
                for (i=0; i < (ssize_t) number_windows; i++)
                {
                  ...
                  (void) XChangeGC(display,magick_windows[i]->highlight_context,
                    (size_t) (context_mask | 
# 2303 "MagickCore/animate.c" 3 4
                                            (1L<<1)
# 2303 "MagickCore/animate.c"
                                                       ),
                    &context_values);
...
# 2314 "MagickCore/animate.c" 3 4
                                                    ((void *)0)
# 2314 "MagickCore/animate.c"
                                                        )
        ...
        if (event.xclient.message_type == windows->dnd_protocols)
          {
            ...
            status=XGetWindowProperty(display,root_window,selection,0L,2047L,
              MagickFalse,(Atom) 
# 2349 "MagickCore/animate.c" 3 4
                                0L
# 2349 "MagickCore/animate.c"
                                               ,&type,&format,&length,&after,
              &data);
            if ((status != 
# 2351 "MagickCore/animate.c" 3 4
                          0
# 2351 "MagickCore/animate.c"
                                 ) || (length == 0))
              break;
            ...
            CatchException(exception);
            if (nexus != (Image *) 
# 2376 "MagickCore/animate.c" 3 4
                                  ((void *)0)
# 2376 "MagickCore/animate.c"
                                      )
              state|=ExitState;
            (void) XFree((void *) data);
            break;
        ...
        if (*event.xclient.data.l == (long) windows->wm_take_focus)
          {
            (void) XSetInputFocus(display,event.xclient.window,
# 2388 "MagickCore/animate.c" 3 4
                                                              2
# 2388 "MagickCore/animate.c"
                                                                            ,
      ...
      case 
# 2403 "MagickCore/animate.c" 3 4
          22
# 2403 "MagickCore/animate.c"
                         :
      {
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2406,
...
# 2420 "MagickCore/animate.c" 3 4
                                                         ((void *)0)
# 2420 "MagickCore/animate.c"
                                                             )
...
# 2430 "MagickCore/animate.c" 3 4
                                                                 (1<<0) 
# 2430 "MagickCore/animate.c"
                                                                     | 
# 2430 "MagickCore/animate.c" 3 4
                                                                       (1<<1)
# 2430 "MagickCore/animate.c"
...
# 2433 "MagickCore/animate.c" 3 4
                                                        ((void *)0)
# 2433 "MagickCore/animate.c"
                                                            )
...
# 2444 "MagickCore/animate.c" 3 4
                                                              (1<<0) 
# 2444 "MagickCore/animate.c"
                                                                  | 
# 2444 "MagickCore/animate.c" 3 4
                                                                    (1<<1)
# 2444 "MagickCore/animate.c"
      ...
      case 
# 2466 "MagickCore/animate.c" 3 4
          17
# 2466 "MagickCore/animate.c"
                       :
      {
        ...
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2472,
      ...
      case 
# 2481 "MagickCore/animate.c" 3 4
          7
# 2481 "MagickCore/animate.c"
                     :
      {
...
# 2487 "MagickCore/animate.c" 3 4
                                     2
# 2487 "MagickCore/animate.c"
                                                 )
            XInstallColormap(display,map_info->colormap);
        break;
      }
      case 
# 2491 "MagickCore/animate.c" 3 4
          12
# 2491 "MagickCore/animate.c"
                :
      {
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2494,
      ...
      case 
# 2516 "MagickCore/animate.c" 3 4
          2
# 2516 "MagickCore/animate.c"
                  :
      {
        static int
          length;
        ...
        length=XLookupString((XKeyEvent *) &event.xkey,command,(int)
          sizeof(command),&key_symbol,(XComposeStatus *) 
# 2525 "MagickCore/animate.c" 3 4
                                                        ((void *)0)
# 2525 "MagickCore/animate.c"
                                                            );
        *(command+length)='\0';
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2528,
            "Key press: 0x%lx (%c)",(unsigned long) key_symbol,*command);
        animate_command=NullCommand;
        switch (key_symbol)
        {
          case 
# 2533 "MagickCore/animate.c" 3 4
              0x006f
# 2533 "MagickCore/animate.c"
                  :
          {
            if ((event.xkey.state & 
# 2535 "MagickCore/animate.c" 3 4
                                   (1<<2)
# 2535 "MagickCore/animate.c"
                                              ) == MagickFalse)
              break;
          ...
          case 
# 2540 "MagickCore/animate.c" 3 4
              0xff08
# 2540 "MagickCore/animate.c"
                          :
          {
          ...
          case 
# 2545 "MagickCore/animate.c" 3 4
              0x0020
# 2545 "MagickCore/animate.c"
                      :
          {
          ...
          case 
# 2550 "MagickCore/animate.c" 3 4
              0x003c
# 2550 "MagickCore/animate.c"
                     :
          {
          ...
          case 
# 2555 "MagickCore/animate.c" 3 4
              0x003e
# 2555 "MagickCore/animate.c"
                        :
          {
          ...
          case 
# 2560 "MagickCore/animate.c" 3 4
              0xffbe
# 2560 "MagickCore/animate.c"
                   :
          {
          ...
          case 
# 2565 "MagickCore/animate.c" 3 4
              0xff68
# 2565 "MagickCore/animate.c"
                     :
          {
          ...
          case 
# 2570 "MagickCore/animate.c" 3 4
              0x003f
# 2570 "MagickCore/animate.c"
                         :
          {
          ...
          case 
# 2575 "MagickCore/animate.c" 3 4
              0x0071
# 2575 "MagickCore/animate.c"
                  :
          case 
# 2576 "MagickCore/animate.c" 3 4
              0xff1b
# 2576 "MagickCore/animate.c"
                       :
          {
      ...
      case 
# 2589 "MagickCore/animate.c" 3 4
          3
# 2589 "MagickCore/animate.c"
                    :
      {
        ...
        (void) XLookupString((XKeyEvent *) &event.xkey,command,(int)
          sizeof(command),&key_symbol,(XComposeStatus *) 
# 2595 "MagickCore/animate.c" 3 4
                                                        ((void *)0)
# 2595 "MagickCore/animate.c"
                                                            );
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2597,
            "Key release: 0x%lx (%c)",(unsigned long) key_symbol,*command);
        break;
      }
      case 
# 2601 "MagickCore/animate.c" 3 4
          8
# 2601 "MagickCore/animate.c"
                     :
      {
        ...
        if (map_info->colormap != XDefaultColormap(display,visual_info->screen))
          if (event.xcrossing.mode != 
# 2607 "MagickCore/animate.c" 3 4
                                     2
# 2607 "MagickCore/animate.c"
                                                 )
            XUninstallColormap(display,map_info->colormap);
        break;
      }
      case 
# 2611 "MagickCore/animate.c" 3 4
          19
# 2611 "MagickCore/animate.c"
                   :
      {
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2614,"Map Notify: 0x%lx",
            event.xmap.window);
        if (event.xmap.window == windows->backdrop.id)
          {
            (void) XSetInputFocus(display,event.xmap.window,
# 2618 "MagickCore/animate.c" 3 4
                                                           2
# 2618 "MagickCore/animate.c"
                                                                         ,
              
# 2619 "MagickCore/animate.c" 3 4
             0L
# 2619 "MagickCore/animate.c"
                        );
        ...
        if (event.xmap.window == windows->image.id)
          {
            if (windows->backdrop.id != (Window) 
# 2625 "MagickCore/animate.c" 3 4
                                                ((void *)0)
# 2625 "MagickCore/animate.c"
                                                    )
              (void) XInstallColormap(display,map_info->colormap);
      ...
      case 
# 2678 "MagickCore/animate.c" 3 4
          34
# 2678 "MagickCore/animate.c"
                       :
      {
      ...
      case 
# 2683 "MagickCore/animate.c" 3 4
          14
# 2683 "MagickCore/animate.c"
                  :
        break;
      case 
# 2685 "MagickCore/animate.c" 3 4
          28
# 2685 "MagickCore/animate.c"
                        :
      {
        Atom
          type;
        ...
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2702,
...
# 2713 "MagickCore/animate.c" 3 4
         0L
# 2713 "MagickCore/animate.c"
                        ,&type,&format,&length,&after,&data);
        if ((status != 
# 2714 "MagickCore/animate.c" 3 4
                      0
# 2714 "MagickCore/animate.c"
                             ) || (length == 0))
          break;
        (void) CopyMagickString(resource_info->image_info->filename,
          (char *) data,4096);
        ...
        CatchException(exception);
        if (nexus != (Image *) 
# 2720 "MagickCore/animate.c" 3 4
                              ((void *)0)
# 2720 "MagickCore/animate.c"
                                  )
          state|=ExitState;
        (void) XFree((void *) data);
        break;
      ...
      case 
# 2725 "MagickCore/animate.c" 3 4
          21
# 2725 "MagickCore/animate.c"
                        :
      {
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2728,
            "Reparent Notify: 0x%lx=>0x%lx",event.xreparent.parent,
            event.xreparent.window);
        break;
      }
      case 
# 2733 "MagickCore/animate.c" 3 4
          18
# 2733 "MagickCore/animate.c"
                     :
      {
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2736,
        ...
        if (event.xunmap.window == windows->popup.id)
          {
            if (windows->backdrop.id != (Window) 
# 2770 "MagickCore/animate.c" 3 4
                                                ((void *)0)
# 2770 "MagickCore/animate.c"
                                                    )
              (void) XSetInputFocus(display,windows->image.id,
# 2771 "MagickCore/animate.c" 3 4
                                                             2
# 2771 "MagickCore/animate.c"
                                                                           ,
                
# 2772 "MagickCore/animate.c" 3 4
               0L
# 2772 "MagickCore/animate.c"
                          );
        ...
        if (event.xunmap.window == windows->widget.id)
          {
            if (windows->backdrop.id != (Window) 
# 2778 "MagickCore/animate.c" 3 4
                                                ((void *)0)
# 2778 "MagickCore/animate.c"
                                                    )
              (void) XSetInputFocus(display,windows->image.id,
# 2779 "MagickCore/animate.c" 3 4
                                                             2
# 2779 "MagickCore/animate.c"
                                                                           ,
                
# 2780 "MagickCore/animate.c" 3 4
               0L
# 2780 "MagickCore/animate.c"
                          );
      ...
      {
        if (resource_info->debug != MagickFalse)
          (void) LogMagickEvent(X11Event,"MagickCore/animate.c",__func__,(unsigned long) 2789,"Event type: %d",
            event.type);
        break;
      }
    }
...
# 2798 "MagickCore/animate.c" 3 4
                                     1
# 2798 "MagickCore/animate.c"
                                              ) ||
      (windows->visual_info->class == 
# 2799 "MagickCore/animate.c" 3 4
                                     3
# 2799 "MagickCore/animate.c"
                                                ) ||
      (windows->visual_info->class == 
# 2800 "MagickCore/animate.c" 3 4
                                     5
# 2800 "MagickCore/animate.c"
                                                ))
    {
    ...
    if (windows->backdrop.mapped)
      {
        ...
        windows->backdrop.id=(Window) 
# 2817 "MagickCore/animate.c" 3 4
                                     ((void *)0)
# 2817 "MagickCore/animate.c"
                                         ;
        (void) XWithdrawWindow(display,windows->image.id,windows->image.screen);
        (void) XDestroyWindow(display,windows->image.id);
        windows->image.id=(Window) 
# 2820 "MagickCore/animate.c" 3 4
                                  ((void *)0)
# 2820 "MagickCore/animate.c"
                                      ;
      }
  XSetCursorState(display,windows,MagickTrue);
  XCheckRefreshWindows(display,windows);
  ...
  {
    if (windows->image.pixmaps[scene] != (Pixmap) 
# 2826 "MagickCore/animate.c" 3 4
                                                 ((void *)0)
# 2826 "MagickCore/animate.c"
                                                     )
      (void) XFreePixmap(display,windows->image.pixmaps[scene]);
    windows->image.pixmaps[scene]=(Pixmap) 
# 2828 "MagickCore/animate.c" 3 4
                                          ((void *)0)
# 2828 "MagickCore/animate.c"
                                              ;
    if (windows->image.matte_pixmaps[scene] != (Pixmap) 
# 2829 "MagickCore/animate.c" 3 4
                                                       ((void *)0)
# 2829 "MagickCore/animate.c"
                                                           )
      (void) XFreePixmap(display,windows->image.matte_pixmaps[scene]);
    windows->image.matte_pixmaps[scene]=(Pixmap) 
# 2831 "MagickCore/animate.c" 3 4
                                                ((void *)0)
# 2831 "MagickCore/animate.c"
                                                    ;
  }
  XSetCursorState(display,windows,MagickFalse);
  ...
  if (nexus == (Image *) 
# 2838 "MagickCore/animate.c" 3 4
                        ((void *)0)
# 2838 "MagickCore/animate.c"
                            )
    {
      ...
      if (resource_info->map_type == (char *) 
# 2847 "MagickCore/animate.c" 3 4
                                             ((void *)0)
# 2847 "MagickCore/animate.c"
                                                 )
  ...
  if (status == -1)
    (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 2866,FileOpenError,
      "UnableToOpenFile","%s",resource_info->home_directory);
  return(nexus);
}
# 2906 "MagickCore/animate.c"
...
# 2922 "MagickCore/animate.c" 3 4
                                               ((void *)0)
# 2922 "MagickCore/animate.c"
                                                   )
  ...
  else
    {
      ...
      if (*path == '\0')
        (void) CopyMagickString(path,".",4096);
      status=chdir(path);
      if (status == -1)
        (void) ThrowMagickException(exception,"MagickCore/animate.c",__func__,(unsigned long) 2939,FileOpenError,
  ...
  if ((LocaleCompare(image_info->magick,"EPS") == 0) ||
      ...
      (LocaleCompare(image_info->magick,"PS2") == 0))
    {
      ...
      if (LocaleCompare(image_info->magick,"PDF") == 0)
        (void) CopyMagickString(geometry,"612x792",4096);
      if (image_info->page != (char *) 
# 2996 "MagickCore/animate.c" 3 4
                                      ((void *)0)
# 2996 "MagickCore/animate.c"
                                          )
