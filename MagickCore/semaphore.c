# 0 "MagickCore/semaphore.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "MagickCore/semaphore.c"
# 44 "MagickCore/semaphore.c"
...
# 98 "MagickCore/semaphore.c"
__attribute__ ((visibility ("default"))) void ActivateSemaphoreInfo(SemaphoreInfo **semaphore_info)
{
  
# 100 "MagickCore/semaphore.c" 3 4
 ((void) sizeof ((
# 100 "MagickCore/semaphore.c"
...
# 100 "MagickCore/semaphore.c" 3 4
 , "MagickCore/semaphore.c", 100, __extension__ __PRETTY_FUNCTION__); }))
# 100 "MagickCore/semaphore.c"
                                                  ;
  if (*semaphore_info == (SemaphoreInfo *) 
# 101 "MagickCore/semaphore.c" 3 4
                                          ((void *)0)
# 101 "MagickCore/semaphore.c"
                                              )
    {
      LockMagickMutex();
      if (*semaphore_info == (SemaphoreInfo *) 
# 104 "MagickCore/semaphore.c" 3 4
                                              ((void *)0)
# 104 "MagickCore/semaphore.c"
                                                  )
        *semaphore_info=AcquireSemaphoreInfo();
      UnlockMagickMutex();
    }
}
# 129 "MagickCore/semaphore.c"
...
# 145 "MagickCore/semaphore.c" 3 4
     (*__errno_location ())
# 145 "MagickCore/semaphore.c"
          =
# 145 "MagickCore/semaphore.c" 3 4
           12
# 145 "MagickCore/semaphore.c"
                 ;
      return((void *) 
# 146 "MagickCore/semaphore.c" 3 4
                     ((void *)0)
# 146 "MagickCore/semaphore.c"
                         );
    }
  memory=
# 148 "MagickCore/semaphore.c" 3 4
        ((void *)0)
# 148 "MagickCore/semaphore.c"
            ;
  alignment=(8 * 8);
  extent=(((size)+(((8 * 8))-1)) & (size_t) ~(((8 * 8))-1));
  if ((size == 0) || (alignment < sizeof(void *)) || (extent < size))
    return((void *) 
# 152 "MagickCore/semaphore.c" 3 4
                   ((void *)0)
# 152 "MagickCore/semaphore.c"
                       );

  if (posix_memalign(&memory,alignment,extent) != 0)
    memory=
# 155 "MagickCore/semaphore.c" 3 4
          ((void *)0)
# 155 "MagickCore/semaphore.c"
              ;
# 175 "MagickCore/semaphore.c"
  return(memory);
}
...
{
  if (memory == (void *) 
# 180 "MagickCore/semaphore.c" 3 4
                        ((void *)0)
# 180 "MagickCore/semaphore.c"
                            )
    return((void *) 
# 181 "MagickCore/semaphore.c" 3 4
                   ((void *)0)
# 181 "MagickCore/semaphore.c"
                       );
  ...
  return(
# 189 "MagickCore/semaphore.c" 3 4
        ((void *)0)
# 189 "MagickCore/semaphore.c"
            );
}

__attribute__ ((visibility ("default"))) SemaphoreInfo *AcquireSemaphoreInfo(void)
{
  SemaphoreInfo
    *semaphore_info;
  ...
  if (semaphore_info == (SemaphoreInfo *) 
# 202 "MagickCore/semaphore.c" 3 4
                                         ((void *)0)
# 202 "MagickCore/semaphore.c"
                                             )
    { char *fatal_message; ExceptionInfo *fatal_exception; fatal_exception=AcquireExceptionInfo(); fatal_message=GetExceptionMessage(
# 203 "MagickCore/semaphore.c" 3 4
   (*__errno_location ())
# 203 "MagickCore/semaphore.c"
   ); (void) ThrowMagickException(fatal_exception,"MagickCore/semaphore.c",__func__,(unsigned long) 203,ResourceLimitFatalError,"MemoryAllocationFailed", "`%s'",fatal_message); fatal_message=DestroyString(fatal_message); CatchException(fatal_exception); (void) DestroyExceptionInfo(fatal_exception); MagickCoreTerminus(); _exit((int) (ResourceLimitFatalError-FatalErrorException)+1); };
...
# 221 "MagickCore/semaphore.c" 3 4
       (*__errno_location ())
# 221 "MagickCore/semaphore.c"
            =status;
        perror("unable to initialize mutex attributes");
        _exit(1);
      }
# 236 "MagickCore/semaphore.c"
    status=pthread_mutex_init(&semaphore_info->mutex,&mutex_info);
    if (status != 0)
      {
        
# 239 "MagickCore/semaphore.c" 3 4
       (*__errno_location ())
# 239 "MagickCore/semaphore.c"
            =status;
...
# 246 "MagickCore/semaphore.c" 3 4
       (*__errno_location ())
# 246 "MagickCore/semaphore.c"
            =status;
        perror("unable to destroy mutex attributes");
        _exit(1);
      }
  }
# 265 "MagickCore/semaphore.c"
  semaphore_info->id=GetMagickThreadId();
  semaphore_info->reference_count=0;
  semaphore_info->signature=0xabacadabUL;
  return(semaphore_info);
}
# 293 "MagickCore/semaphore.c"
__attribute__ ((visibility ("default"))) void LockSemaphoreInfo(SemaphoreInfo *semaphore_info)
{
  
# 295 "MagickCore/semaphore.c" 3 4
 ((void) sizeof ((
# 295 "MagickCore/semaphore.c"
 semaphore_info != (SemaphoreInfo *) 
# 295 "MagickCore/semaphore.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 295 "MagickCore/semaphore.c"
...
# 295 "MagickCore/semaphore.c"
 "semaphore_info != (SemaphoreInfo *) NULL"
# 295 "MagickCore/semaphore.c" 3 4
 , "MagickCore/semaphore.c", 295, __extension__ __PRETTY_FUNCTION__); }))
# 295 "MagickCore/semaphore.c"
                                                 ;
  
# 296 "MagickCore/semaphore.c" 3 4
 ((void) sizeof ((
# 296 "MagickCore/semaphore.c"
 semaphore_info->signature == 0xabacadabUL
# 296 "MagickCore/semaphore.c" 3 4
...
# 296 "MagickCore/semaphore.c" 3 4
 , "MagickCore/semaphore.c", 296, __extension__ __PRETTY_FUNCTION__); }))
# 296 "MagickCore/semaphore.c"
                                                         ;
# 308 "MagickCore/semaphore.c"
  {
    int
      status;
...
# 315 "MagickCore/semaphore.c" 3 4
       (*__errno_location ())
# 315 "MagickCore/semaphore.c"
            =status;
...
# 351 "MagickCore/semaphore.c"
__attribute__ ((visibility ("default"))) void RelinquishSemaphoreInfo(SemaphoreInfo **semaphore_info)
{
  
# 353 "MagickCore/semaphore.c" 3 4
 ((void) sizeof ((
# 353 "MagickCore/semaphore.c"
 semaphore_info != (SemaphoreInfo **) 
# 353 "MagickCore/semaphore.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 353 "MagickCore/semaphore.c"
...
# 353 "MagickCore/semaphore.c"
 "semaphore_info != (SemaphoreInfo **) NULL"
# 353 "MagickCore/semaphore.c" 3 4
 , "MagickCore/semaphore.c", 353, __extension__ __PRETTY_FUNCTION__); }))
# 353 "MagickCore/semaphore.c"
                                                  ;
  
# 354 "MagickCore/semaphore.c" 3 4
 ((void) sizeof ((
# 354 "MagickCore/semaphore.c"
 (*semaphore_info) != (SemaphoreInfo *) 
# 354 "MagickCore/semaphore.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 354 "MagickCore/semaphore.c"
...
# 354 "MagickCore/semaphore.c"
 "(*semaphore_info) != (SemaphoreInfo *) NULL"
# 354 "MagickCore/semaphore.c" 3 4
 , "MagickCore/semaphore.c", 354, __extension__ __PRETTY_FUNCTION__); }))
# 354 "MagickCore/semaphore.c"
                                                    ;
  
# 355 "MagickCore/semaphore.c" 3 4
 ((void) sizeof ((
# 355 "MagickCore/semaphore.c"
 (*semaphore_info)->signature == 0xabacadabUL
# 355 "MagickCore/semaphore.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 355 "MagickCore/semaphore.c"
...
# 355 "MagickCore/semaphore.c"
 "(*semaphore_info)->signature == MagickCoreSignature"
# 355 "MagickCore/semaphore.c" 3 4
 , "MagickCore/semaphore.c", 355, __extension__ __PRETTY_FUNCTION__); }))
# 355 "MagickCore/semaphore.c"
                                                            ;
  LockMagickMutex();
...
# 367 "MagickCore/semaphore.c" 3 4
       (*__errno_location ())
# 367 "MagickCore/semaphore.c"
            =status;
...
# 398 "MagickCore/semaphore.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType SemaphoreComponentGenesis(void)
{
  InitializeMagickMutex();
  return(MagickTrue);
}
# 422 "MagickCore/semaphore.c"
__attribute__ ((visibility ("hidden"))) void SemaphoreComponentTerminus(void)
{
  DestroyMagickMutex();
}
# 449 "MagickCore/semaphore.c"
__attribute__ ((visibility ("default"))) void UnlockSemaphoreInfo(SemaphoreInfo *semaphore_info)
{
  
# 451 "MagickCore/semaphore.c" 3 4
 ((void) sizeof ((
# 451 "MagickCore/semaphore.c"
 semaphore_info != (SemaphoreInfo *) 
# 451 "MagickCore/semaphore.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 451 "MagickCore/semaphore.c"
...
# 451 "MagickCore/semaphore.c"
 "semaphore_info != (SemaphoreInfo *) NULL"
# 451 "MagickCore/semaphore.c" 3 4
 , "MagickCore/semaphore.c", 451, __extension__ __PRETTY_FUNCTION__); }))
# 451 "MagickCore/semaphore.c"
                                                 ;
  
# 452 "MagickCore/semaphore.c" 3 4
 ((void) sizeof ((
# 452 "MagickCore/semaphore.c"
 semaphore_info->signature == 0xabacadabUL
# 452 "MagickCore/semaphore.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 452 "MagickCore/semaphore.c"
...
# 452 "MagickCore/semaphore.c"
 "semaphore_info->signature == MagickCoreSignature"
# 452 "MagickCore/semaphore.c" 3 4
 , "MagickCore/semaphore.c", 452, __extension__ __PRETTY_FUNCTION__); }))
# 452 "MagickCore/semaphore.c"
                                                         ;
# 467 "MagickCore/semaphore.c"
  {
    int
      status;
...
# 474 "MagickCore/semaphore.c" 3 4
       (*__errno_location ())
# 474 "MagickCore/semaphore.c"
            =status;
