...
# 60 "MagickCore/mime.c" 2
# 69 "MagickCore/mime.c"
struct _MimeInfo
{
  char
    *path,
...
static LinkedListInfo
  *mime_cache = (LinkedListInfo *) 
# 113 "MagickCore/mime.c" 3 4
                                  ((void *)0)
# 113 "MagickCore/mime.c"
                                      ;

static SemaphoreInfo
  *mime_semaphore = (SemaphoreInfo *) 
# 116 "MagickCore/mime.c" 3 4
                                     ((void *)0)
# 116 "MagickCore/mime.c"
                                         ;
...
static MagickBooleanType
 LoadMimeCache(LinkedListInfo *,const char *,const char *,const size_t,
    ExceptionInfo *);
# 156 "MagickCore/mime.c"
__attribute__ ((visibility ("default"))) LinkedListInfo *AcquireMimeCache(const char *filename,
...
# 173 "MagickCore/mime.c" 3 4
                                         ((void *)0)
# 173 "MagickCore/mime.c"
                                             )
    {
...
# 221 "MagickCore/mime.c"
__attribute__ ((visibility ("default"))) const MimeInfo *GetMimeInfo(const char *filename,
...
# 243 "MagickCore/mime.c" 3 4
 ((void) sizeof ((
# 243 "MagickCore/mime.c"
...
# 243 "MagickCore/mime.c" 3 4
 , "MagickCore/mime.c", 243, __extension__ __PRETTY_FUNCTION__); }))
# 243 "MagickCore/mime.c"
                                            ;
  if (IsMimeCacheInstantiated(exception) == MagickFalse)
    return((const MimeInfo *) 
# 245 "MagickCore/mime.c" 3 4
                             ((void *)0)
# 245 "MagickCore/mime.c"
                                 );
...
# 252 "MagickCore/mime.c" 3 4
                                       ((void *)0)
# 252 "MagickCore/mime.c"
                                           ) || (length == 0))
    {
      UnlockSemaphoreInfo(mime_semaphore);
      if (p != (ElementInfo *) 
# 255 "MagickCore/mime.c" 3 4
                              ((void *)0)
# 255 "MagickCore/mime.c"
                                  )
        return((const MimeInfo *) p->value);
      return((const MimeInfo *) 
# 257 "MagickCore/mime.c" 3 4
                               ((void *)0)
# 257 "MagickCore/mime.c"
                                   );
    }
  element_info=(ElementInfo *) 
# 259 "MagickCore/mime.c" 3 4
                              ((void *)0)
# 259 "MagickCore/mime.c"
                                  ;
  while (p != (ElementInfo *) 
# 260 "MagickCore/mime.c" 3 4
                             ((void *)0)
# 260 "MagickCore/mime.c"
                                 )
  {
    const MimeInfo
      *q;
...
# 266 "MagickCore/mime.c" 3 4
   ((void) sizeof ((
# 266 "MagickCore/mime.c"
   q->offset >= 0
# 266 "MagickCore/mime.c" 3 4
...
# 266 "MagickCore/mime.c"
   "q->offset >= 0"
# 266 "MagickCore/mime.c" 3 4
   , "MagickCore/mime.c", 266, __extension__ __PRETTY_FUNCTION__); }))
# 266 "MagickCore/mime.c"
                         ;
    if (element_info != (const ElementInfo *) 
# 267 "MagickCore/mime.c" 3 4
                                             ((void *)0)
# 267 "MagickCore/mime.c"
                                                 )
    ...
    if ((q->pattern != (char *) 
# 273 "MagickCore/mime.c" 3 4
                               ((void *)0)
# 273 "MagickCore/mime.c"
                                   ) && (filename != (char *) 
# 273 "MagickCore/mime.c" 3 4
                                                              ((void *)0)
# 273 "MagickCore/mime.c"
  ...
  if (element_info != (ElementInfo *) 
# 382 "MagickCore/mime.c" 3 4
                                     ((void *)0)
# 382 "MagickCore/mime.c"
                                         )
    SetHeadElementInLinkedList(mime_cache,element_info);
  UnlockSemaphoreInfo(mime_semaphore);
  if (element_info == (ElementInfo *) 
# 385 "MagickCore/mime.c" 3 4
                                     ((void *)0)
# 385 "MagickCore/mime.c"
                                         )
    return((const MimeInfo *) 
# 386 "MagickCore/mime.c" 3 4
                             ((void *)0)
# 386 "MagickCore/mime.c"
                                 );
  return((const MimeInfo *) element_info->value);
}
# 424 "MagickCore/mime.c"
...
__attribute__ ((visibility ("default"))) const MimeInfo **GetMimeInfoList(const char *pattern,
...
# 453 "MagickCore/mime.c" 3 4
 ((void) sizeof ((
# 453 "MagickCore/mime.c"
 pattern != (char *) 
# 453 "MagickCore/mime.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 453 "MagickCore/mime.c"
...
# 453 "MagickCore/mime.c"
 "pattern != (char *) NULL"
# 453 "MagickCore/mime.c" 3 4
 , "MagickCore/mime.c", 453, __extension__ __PRETTY_FUNCTION__); }))
# 453 "MagickCore/mime.c"
                                 ;
  
# 454 "MagickCore/mime.c" 3 4
 ((void) sizeof ((
# 454 "MagickCore/mime.c"
...
# 454 "MagickCore/mime.c" 3 4
 , "MagickCore/mime.c", 454, __extension__ __PRETTY_FUNCTION__); }))
# 454 "MagickCore/mime.c"
                                          ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/mime.c",__func__,(unsigned long) 456,"%s",pattern);
  *number_aliases=0;
  if (IsMimeCacheInstantiated(exception) == MagickFalse)
    return((const MimeInfo **) 
# 459 "MagickCore/mime.c" 3 4
                              ((void *)0)
# 459 "MagickCore/mime.c"
                                  );
  aliases=(const MimeInfo **) AcquireQuantumMemory((size_t)
    GetNumberOfElementsInLinkedList(mime_cache)+1UL,sizeof(*aliases));
  if (aliases == (const MimeInfo **) 
# 462 "MagickCore/mime.c" 3 4
                                    ((void *)0)
# 462 "MagickCore/mime.c"
                                        )
    return((const MimeInfo **) 
# 463 "MagickCore/mime.c" 3 4
                              ((void *)0)
# 463 "MagickCore/mime.c"
                                  );
  LockSemaphoreInfo(mime_semaphore);
  p=GetHeadElementInLinkedList(mime_cache);
  for (i=0; p != (ElementInfo *) 
# 466 "MagickCore/mime.c" 3 4
                                ((void *)0)
# 466 "MagickCore/mime.c"
                                    ; )
  {
    MimeInfo
      *mime_info;
  ...
  if (i == 0)
  ...
  else
    {
      ...
      aliases[i]=(MimeInfo *) 
# 483 "MagickCore/mime.c" 3 4
                             ((void *)0)
# 483 "MagickCore/mime.c"
                                 ;
    }
  *number_aliases=(size_t) i;
  return(aliases);
}
# 523 "MagickCore/mime.c"
...
__attribute__ ((visibility ("default"))) char **GetMimeList(const char *pattern,
  size_t *number_aliases,ExceptionInfo *exception)
{
  char
    **aliases;
...
# 550 "MagickCore/mime.c" 3 4
 ((void) sizeof ((
# 550 "MagickCore/mime.c"
 pattern != (char *) 
# 550 "MagickCore/mime.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 550 "MagickCore/mime.c"
...
# 550 "MagickCore/mime.c"
 "pattern != (char *) NULL"
# 550 "MagickCore/mime.c" 3 4
 , "MagickCore/mime.c", 550, __extension__ __PRETTY_FUNCTION__); }))
# 550 "MagickCore/mime.c"
                                 ;
  
# 551 "MagickCore/mime.c" 3 4
 ((void) sizeof ((
# 551 "MagickCore/mime.c"
 number_aliases != (size_t *) 
# 551 "MagickCore/mime.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 551 "MagickCore/mime.c"
...
# 551 "MagickCore/mime.c"
 "number_aliases != (size_t *) NULL"
# 551 "MagickCore/mime.c" 3 4
 , "MagickCore/mime.c", 551, __extension__ __PRETTY_FUNCTION__); }))
# 551 "MagickCore/mime.c"
                                          ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/mime.c",__func__,(unsigned long) 553,"%s",pattern);
  *number_aliases=0;
  if (IsMimeCacheInstantiated(exception) == MagickFalse)
    return((char **) 
# 556 "MagickCore/mime.c" 3 4
                    ((void *)0)
# 556 "MagickCore/mime.c"
                        );
  aliases=(char **) AcquireQuantumMemory((size_t)
    GetNumberOfElementsInLinkedList(mime_cache)+1UL,sizeof(*aliases));
  if (aliases == (char **) 
# 559 "MagickCore/mime.c" 3 4
                          ((void *)0)
# 559 "MagickCore/mime.c"
                              )
    return((char **) 
# 560 "MagickCore/mime.c" 3 4
                    ((void *)0)
# 560 "MagickCore/mime.c"
                        );
  LockSemaphoreInfo(mime_semaphore);
  p=GetHeadElementInLinkedList(mime_cache);
  for (i=0; p != (ElementInfo *) 
# 563 "MagickCore/mime.c" 3 4
                                ((void *)0)
# 563 "MagickCore/mime.c"
                                    ; )
  {
    const MimeInfo
      *mime_info;
  ...
  if (i == 0)
  ...
  else
    {
      ...
      aliases[i]=(char *) 
# 580 "MagickCore/mime.c" 3 4
                         ((void *)0)
# 580 "MagickCore/mime.c"
                             ;
    }
  *number_aliases=(size_t) i;
  return(aliases);
}
# 608 "MagickCore/mime.c"
__attribute__ ((visibility ("default"))) const char *GetMimeDescription(const MimeInfo *mime_info)
{
  
# 610 "MagickCore/mime.c" 3 4
 ((void) sizeof ((
# 610 "MagickCore/mime.c"
 mime_info != (MimeInfo *) 
# 610 "MagickCore/mime.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 610 "MagickCore/mime.c"
...
# 610 "MagickCore/mime.c" 3 4
 , "MagickCore/mime.c", 610, __extension__ __PRETTY_FUNCTION__); }))
# 610 "MagickCore/mime.c"
                                       ;
  
# 611 "MagickCore/mime.c" 3 4
 ((void) sizeof ((
# 611 "MagickCore/mime.c"
 mime_info->signature == 0xabacadabUL
# 611 "MagickCore/mime.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 611 "MagickCore/mime.c"
 mime_info->signature == 0xabacadabUL
...
# 611 "MagickCore/mime.c" 3 4
 , "MagickCore/mime.c", 611, __extension__ __PRETTY_FUNCTION__); }))
# 611 "MagickCore/mime.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/mime.c",__func__,(unsigned long) 613,"...");
  return(mime_info->description);
}
# 639 "MagickCore/mime.c"
__attribute__ ((visibility ("default"))) const char *GetMimeType(const MimeInfo *mime_info)
{
  
# 641 "MagickCore/mime.c" 3 4
 ((void) sizeof ((
# 641 "MagickCore/mime.c"
 mime_info != (MimeInfo *) 
# 641 "MagickCore/mime.c" 3 4
 ((void *)0)) ? 1 : 0), __extension__ ({ if (
# 641 "MagickCore/mime.c"
...
# 641 "MagickCore/mime.c"
 "mime_info != (MimeInfo *) NULL"
# 641 "MagickCore/mime.c" 3 4
 , "MagickCore/mime.c", 641, __extension__ __PRETTY_FUNCTION__); }))
# 641 "MagickCore/mime.c"
                                       ;
  
# 642 "MagickCore/mime.c" 3 4
 ((void) sizeof ((
# 642 "MagickCore/mime.c"
 mime_info->signature == 0xabacadabUL
# 642 "MagickCore/mime.c" 3 4
 ) ? 1 : 0), __extension__ ({ if (
# 642 "MagickCore/mime.c"
...
# 642 "MagickCore/mime.c"
 "mime_info->signature == MagickCoreSignature"
# 642 "MagickCore/mime.c" 3 4
 , "MagickCore/mime.c", 642, __extension__ __PRETTY_FUNCTION__); }))
# 642 "MagickCore/mime.c"
                                                    ;
  if (IsEventLogging() != MagickFalse)
    (void) LogMagickEvent(TraceEvent,"MagickCore/mime.c",__func__,(unsigned long) 644,"...");
  return(mime_info->type);
}
# 671 "MagickCore/mime.c"
static MagickBooleanType IsMimeCacheInstantiated(ExceptionInfo *exception)
{
  if (mime_cache == (LinkedListInfo *) 
# 673 "MagickCore/mime.c" 3 4
                                      ((void *)0)
# 673 "MagickCore/mime.c"
                                          )
    {
      if (mime_semaphore == (SemaphoreInfo *) 
# 675 "MagickCore/mime.c" 3 4
                                             ((void *)0)
# 675 "MagickCore/mime.c"
                                                 )
        ActivateSemaphoreInfo(&mime_semaphore);
      LockSemaphoreInfo(mime_semaphore);
      if (mime_cache == (LinkedListInfo *) 
# 678 "MagickCore/mime.c" 3 4
                                          ((void *)0)
# 678 "MagickCore/mime.c"
                                              )
        mime_cache=AcquireMimeCache("mime.xml",exception);
      UnlockSemaphoreInfo(mime_semaphore);
    }
  return(mime_cache != (LinkedListInfo *) 
# 682 "MagickCore/mime.c" 3 4
                                         ((void *)0) 
# 682 "MagickCore/mime.c"
                                              ? MagickTrue : MagickFalse);
}
# 709 "MagickCore/mime.c"
__attribute__ ((visibility ("default"))) MagickBooleanType ListMimeInfo(FILE *file,ExceptionInfo *exception)
{
  const char
    *path;
  ...
  if (file == (const FILE *) 
# 726 "MagickCore/mime.c" 3 4
                            ((void *)0)
# 726 "MagickCore/mime.c"
                                )
    file=
# 727 "MagickCore/mime.c" 3 4
        stdout
# 727 "MagickCore/mime.c"
              ;
  mime_info=GetMimeInfoList("*",&number_aliases,exception);
  if (mime_info == (const MimeInfo **) 
# 729 "MagickCore/mime.c" 3 4
                                      ((void *)0)
# 729 "MagickCore/mime.c"
                                          )
    return(MagickFalse);
  j=0;
  path=(const char *) 
# 732 "MagickCore/mime.c" 3 4
                     ((void *)0)
# 732 "MagickCore/mime.c"
                         ;
  for (i=0; i < (ssize_t) number_aliases; i++)
  {
    if (mime_info[i]->stealth != MagickFalse)
      continue;
    if ((path == (const char *) 
# 737 "MagickCore/mime.c" 3 4
                               ((void *)0)
# 737 "MagickCore/mime.c"
                                   ) ||
        (strcasecmp(path,mime_info[i]->path) != 0))
      {
        if (mime_info[i]->path != (char *) 
# 740 "MagickCore/mime.c" 3 4
                                          ((void *)0)
# 740 "MagickCore/mime.c"
                                              )
    ...
    if (mime_info[i]->description != (char *) 
# 760 "MagickCore/mime.c" 3 4
                                             ((void *)0)
# 760 "MagickCore/mime.c"
                                                 )
  ...
  const char *filename,const size_t depth,ExceptionInfo *exception)
{
  ...
  MimeInfo
    *mime_info = (MimeInfo *) 
# 807 "MagickCore/mime.c" 3 4
                             ((void *)0)
# 807 "MagickCore/mime.c"
                                 ;
  ...
  (void) LogMagickEvent(ConfigureEvent,"MagickCore/mime.c",__func__,(unsigned long) 820,
    "Loading mime map \"%s\" ...",filename);
  if (xml == (const char *) 
# 822 "MagickCore/mime.c" 3 4
                           ((void *)0)
# 822 "MagickCore/mime.c"
                               )
    return(MagickFalse);
  mime_map=NewXMLTree(xml,exception);
  if (mime_map == (XMLTreeInfo *) 
# 825 "MagickCore/mime.c" 3 4
                                 ((void *)0)
# 825 "MagickCore/mime.c"
                                     )
    return(MagickFalse);
  status=MagickTrue;
  include=GetXMLTreeChild(mime_map,"include");
  while (include != (XMLTreeInfo *) 
# 829 "MagickCore/mime.c" 3 4
                                   ((void *)0)
# 829 "MagickCore/mime.c"
                                       )
  {
...
# 835 "MagickCore/mime.c" 3 4
                                   ((void *)0)
# 835 "MagickCore/mime.c"
                                       )
      {
        if (depth > 600)
          (void) ThrowMagickException(exception,"MagickCore/mime.c",__func__,(unsigned long) 838,
        ...
        else
          {
            ...
            if (*path != '\0')
              (void) ConcatenateMagickString(path,"/",
                4096);
            if (*attribute == *"/")
              (void) CopyMagickString(path,attribute,4096);
            else
              (void) ConcatenateMagickString(path,attribute,4096);
            file_xml=FileToXML(path,~0UL);
            if (file_xml != (char *) 
# 855 "MagickCore/mime.c" 3 4
                                    ((void *)0)
# 855 "MagickCore/mime.c"
                                        )
              {
  ...
  while (mime != (XMLTreeInfo *) 
# 866 "MagickCore/mime.c" 3 4
                                ((void *)0)
# 866 "MagickCore/mime.c"
                                    )
  {
    ...
    if (attribute != (const char *) 
# 876 "MagickCore/mime.c" 3 4
                                   ((void *)0)
# 876 "MagickCore/mime.c"
                                       )
          ...
          if (*p == '\\')
            {
              p++;
              if (
# 909 "MagickCore/mime.c" 3 4
                 ((*__ctype_b_loc ())[(int) ((
# 909 "MagickCore/mime.c"
                 (int) ((unsigned char) *p)
# 909 "MagickCore/mime.c" 3 4
...
# 909 "MagickCore/mime.c"
        ...
        if (mime_info->data_type != StringData)
          mime_info->value=(ssize_t) strtoul((char *) mime_info->magic,
            (char **) 
# 942 "MagickCore/mime.c" 3 4
                     ((void *)0)
# 942 "MagickCore/mime.c"
                         ,0);
      }
    attribute=GetXMLTreeAttribute(mime,"mask");
    if (attribute != (const char *) 
# 945 "MagickCore/mime.c" 3 4
                                   ((void *)0)
# 945 "MagickCore/mime.c"
                                       )
      mime_info->mask=(ssize_t) strtoul(attribute,(char **) 
# 946 "MagickCore/mime.c" 3 4
                                                           ((void *)0)
# 946 "MagickCore/mime.c"
                                                               ,0);
    attribute=GetXMLTreeAttribute(mime,"offset");
    if (attribute != (const char *) 
# 948 "MagickCore/mime.c" 3 4
                                   ((void *)0)
# 948 "MagickCore/mime.c"
                                       )
      {
        char
          *c;
        ...
        if (*c == ':')
          mime_info->extent=(size_t) strtol(c+1,(char **) 
# 955 "MagickCore/mime.c" 3 4
                                                         ((void *)0)
# 955 "MagickCore/mime.c"
                                                             ,0);
      }
    attribute=GetXMLTreeAttribute(mime,"pattern");
    if (attribute != (const char *) 
# 958 "MagickCore/mime.c" 3 4
                                   ((void *)0)
# 958 "MagickCore/mime.c"
                                       )
      mime_info->pattern=ConstantString(attribute);
    attribute=GetXMLTreeAttribute(mime,"priority");
    if (attribute != (const char *) 
# 961 "MagickCore/mime.c" 3 4
                                   ((void *)0)
# 961 "MagickCore/mime.c"
                                       )
      mime_info->priority=(ssize_t) strtol(attribute,(char **) 
# 962 "MagickCore/mime.c" 3 4
                                                              ((void *)0)
# 962 "MagickCore/mime.c"
                                                                  ,0);
    attribute=GetXMLTreeAttribute(mime,"stealth");
    if (attribute != (const char *) 
# 964 "MagickCore/mime.c" 3 4
                                   ((void *)0)
# 964 "MagickCore/mime.c"
                                       )
      mime_info->stealth=IsStringTrue(attribute);
    attribute=GetXMLTreeAttribute(mime,"type");
    if (attribute != (const char *) 
# 967 "MagickCore/mime.c" 3 4
                                   ((void *)0)
# 967 "MagickCore/mime.c"
                                       )
      mime_info->type=ConstantString(attribute);
    status=AppendValueToLinkedList(cache,mime_info);
    if (status == MagickFalse)
      (void) ThrowMagickException(exception,"MagickCore/mime.c",__func__,(unsigned long) 971,
...
# 1005 "MagickCore/mime.c"
__attribute__ ((visibility ("default"))) char *MagickToMime(const char *magick)
{
  char
    filename[4096],
    media[4096];
  ...
  (void) FormatLocaleString(filename,4096,"file.%s",magick);
  LocaleLower(filename);
  exception=AcquireExceptionInfo();
  mime_info=GetMimeInfo(filename,(unsigned char *) " ",1,exception);
  exception=DestroyExceptionInfo(exception);
  if (mime_info != (const MimeInfo *) 
# 1022 "MagickCore/mime.c" 3 4
                                     ((void *)0)
# 1022 "MagickCore/mime.c"
                                         )
    return(ConstantString(GetMimeType(mime_info)));
  (void) FormatLocaleString(media,4096,"image/x-%s",magick);
  LocaleLower(media+8);
  return(ConstantString(media));
}
# 1047 "MagickCore/mime.c"
__attribute__ ((visibility ("hidden"))) MagickBooleanType MimeComponentGenesis(void)
{
  if (mime_semaphore == (SemaphoreInfo *) 
# 1049 "MagickCore/mime.c" 3 4
                                         ((void *)0)
# 1049 "MagickCore/mime.c"
                                             )
    mime_semaphore=AcquireSemaphoreInfo();
  return(MagickTrue);
}
# 1073 "MagickCore/mime.c"
static void *DestroyMimeElement(void *mime_info)
{
  ...
  if (p->magic != (unsigned char *) 
# 1079 "MagickCore/mime.c" 3 4
                                   ((void *)0)
# 1079 "MagickCore/mime.c"
                                       )
    p->magic=(unsigned char *) RelinquishMagickMemory(p->magic);
  if (p->pattern != (char *) 
# 1081 "MagickCore/mime.c" 3 4
                            ((void *)0)
# 1081 "MagickCore/mime.c"
                                )
    p->pattern=DestroyString(p->pattern);
  if (p->description != (char *) 
# 1083 "MagickCore/mime.c" 3 4
                                ((void *)0)
# 1083 "MagickCore/mime.c"
                                    )
    p->description=DestroyString(p->description);
  if (p->type != (char *) 
# 1085 "MagickCore/mime.c" 3 4
                         ((void *)0)
# 1085 "MagickCore/mime.c"
                             )
    p->type=DestroyString(p->type);
  if (p->path != (char *) 
# 1087 "MagickCore/mime.c" 3 4
                         ((void *)0)
# 1087 "MagickCore/mime.c"
                             )
    p->path=DestroyString(p->path);
  p=(MimeInfo *) RelinquishMagickMemory(p);
  return((void *) 
# 1090 "MagickCore/mime.c" 3 4
                 ((void *)0)
# 1090 "MagickCore/mime.c"
                     );
}

__attribute__ ((visibility ("hidden"))) void MimeComponentTerminus(void)
{
  if (mime_semaphore == (SemaphoreInfo *) 
# 1095 "MagickCore/mime.c" 3 4
                                         ((void *)0)
# 1095 "MagickCore/mime.c"
                                             )
    ActivateSemaphoreInfo(&mime_semaphore);
  LockSemaphoreInfo(mime_semaphore);
  if (mime_cache != (LinkedListInfo *) 
# 1098 "MagickCore/mime.c" 3 4
                                      ((void *)0)
# 1098 "MagickCore/mime.c"
                                          )
